...
import stdgo._internal.bufio.Bufio;
function benchmarkReaderCopyUnoptimal(_b:stdgo.Ref<stdgo._internal.testing.Testing_B.B>):Void {
        ...
        var _src = stdgo._internal.bufio.Bufio_newReader.newReader(stdgo.Go.asInterface((new _internal.bufio_test.Bufio_test_T_onlyReader.T_onlyReader(stdgo.Go.asInterface(_srcBuf)) : _internal.bufio_test.Bufio_test_T_onlyReader.T_onlyReader)));
        ...
        var _dst = (new _internal.bufio_test.Bufio_test_T_onlyWriter.T_onlyWriter(stdgo.Go.asInterface(_dstBuf)) : _internal.bufio_test.Bufio_test_T_onlyWriter.T_onlyWriter);
        {
            ...
            stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
                _srcBuf.reset();
                _src.reset(stdgo.Go.asInterface((new _internal.bufio_test.Bufio_test_T_onlyReader.T_onlyReader(stdgo.Go.asInterface(_srcBuf)) : _internal.bufio_test.Bufio_test_T_onlyReader.T_onlyReader)));
                _dstBuf.reset();
