...
import stdgo._internal.bufio.Bufio;
function benchmarkWriterCopyNoReadFrom(_b:stdgo.Ref<stdgo._internal.testing.Testing_B.B>):Void {
        ...
        var _dstWriter = stdgo._internal.bufio.Bufio_newWriter.newWriter(stdgo.Go.asInterface(_dstBuf));
        var _dst = (new _internal.bufio_test.Bufio_test_T_onlyWriter.T_onlyWriter(stdgo.Go.asInterface(_dstWriter)) : _internal.bufio_test.Bufio_test_T_onlyWriter.T_onlyWriter);
        {
