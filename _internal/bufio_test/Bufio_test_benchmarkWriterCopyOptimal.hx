...
import stdgo._internal.bufio.Bufio;
function benchmarkWriterCopyOptimal(_b:stdgo.Ref<stdgo._internal.testing.Testing_B.B>):Void {
        ...
        var _dst = stdgo._internal.bufio.Bufio_newWriter.newWriter(stdgo.Go.asInterface(_dstBuf));
        {
