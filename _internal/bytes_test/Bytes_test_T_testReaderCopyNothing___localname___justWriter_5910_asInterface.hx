...
class T_testReaderCopyNothing___localname___justWriter_5910_asInterface {
    ...
    var __self__ : stdgo.Pointer<_internal.bytes_test.Bytes_test_T_testReaderCopyNothing___localname___justWriter_5910.T_testReaderCopyNothing___localname___justWriter_5910>;
