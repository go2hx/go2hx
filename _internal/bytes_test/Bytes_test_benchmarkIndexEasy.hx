...
import stdgo._internal.bytes.Bytes;
import stdgo._internal.bytes.Bytes;
function benchmarkIndexEasy(_b:stdgo.Ref<stdgo._internal.testing.Testing_B.B>):Void {
        _internal.bytes_test.Bytes_test__benchBytes._benchBytes(_b, _internal.bytes_test.Bytes_test__indexSizes._indexSizes, function(_b:stdgo.Ref<stdgo._internal.testing.Testing_B.B>, _n:stdgo.GoInt):Void {
            ...
            _buf[(_n - (7 : stdgo.GoInt) : stdgo.GoInt)] = (120 : stdgo.GoUInt8);
            {
                ...
                stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
                    var _j = (stdgo._internal.bytes.Bytes_index.index(_buf, (_buf.__slice__((_n - (7 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.GoInt);
