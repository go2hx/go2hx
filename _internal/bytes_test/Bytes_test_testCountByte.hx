        ...
        var _testCountWindow = (function(_i:stdgo.GoInt, _window:stdgo.GoInt):Void {
            {
                ...
                stdgo.Go.cfor((_j < _window : Bool), _j++, {
                    ...
                    var _p = (stdgo._internal.bytes.Bytes_count.count((_b.__slice__(_i, (_i + _window : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>), (new stdgo.Slice<stdgo.GoUInt8>(1, 1, ...[(100 : stdgo.GoUInt8)]).__setNumber32__() : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.GoInt);
