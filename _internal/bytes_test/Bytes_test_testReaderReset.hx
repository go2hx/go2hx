...
function testReaderReset(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        var _r = stdgo._internal.bytes.Bytes_newReader.newReader((("世界" : stdgo.GoString) : stdgo.Slice<stdgo.GoUInt8>));
        {
        ...
        {};
        _r.reset((("abcdef" : stdgo.GoString) : stdgo.Slice<stdgo.GoUInt8>));
        {
