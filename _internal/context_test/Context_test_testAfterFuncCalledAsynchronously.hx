...
import stdgo._internal.context.Context;
function testAfterFuncCalledAsynchronously(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        try {
            ...
            var _stop = (stdgo._internal.context.Context_afterFunc.afterFunc(_ctx, function():Void {
                _donec.__send__(({  } : _internal.context_test.Context_test_T__struct_1.T__struct_1));
            }) : () -> Bool);
