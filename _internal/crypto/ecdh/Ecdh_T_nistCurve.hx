...
@:structInit @:using(_internal.crypto.ecdh.Ecdh_T_nistCurve_static_extension.T_nistCurve_static_extension) class T_nistCurve<Point> {
    ...
    public function __copy__() {
        return new T_nistCurve<Point>(_name, _newPoint, _scalarOrder);
    }
}
