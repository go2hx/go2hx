...
@:structInit @:using(_internal.crypto.internal.edwards25519.Edwards25519_Point_static_extension.Point_static_extension) class Point {
    @:optional
    public var __4 : _internal.crypto.internal.edwards25519.Edwards25519_T_incomparable.T_incomparable = new _internal.crypto.internal.edwards25519.Edwards25519_T_incomparable.T_incomparable(0, 0, ...[for (i in 0 ... 0) null]);
    ...
    public function __copy__() {
        return new Point(__4, _x, _y, _z, _t);
    }
}
