...
@:keep @:allow(_internal.crypto.internal.nistec.Nistec.T_p256Table_asInterface) class T_p256Table_static_extension {
    @:keep
    static public function select( _table:stdgo.Ref<_internal.crypto.internal.nistec.Nistec_T_p256Table.T_p256Table>, _p:stdgo.Ref<_internal.crypto.internal.nistec.Nistec_P256Point.P256Point>, _n:stdgo.GoUInt8):Void {
        @:recv var _table:stdgo.Ref<_internal.crypto.internal.nistec.Nistec_T_p256Table.T_p256Table> = _table;
