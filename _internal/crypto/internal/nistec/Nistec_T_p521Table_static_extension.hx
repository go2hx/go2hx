...
@:keep @:allow(_internal.crypto.internal.nistec.Nistec.T_p521Table_asInterface) class T_p521Table_static_extension {
    @:keep
    static public function select( _table:stdgo.Ref<_internal.crypto.internal.nistec.Nistec_T_p521Table.T_p521Table>, _p:stdgo.Ref<_internal.crypto.internal.nistec.Nistec_P521Point.P521Point>, _n:stdgo.GoUInt8):Void {
        @:recv var _table:stdgo.Ref<_internal.crypto.internal.nistec.Nistec_T_p521Table.T_p521Table> = _table;
