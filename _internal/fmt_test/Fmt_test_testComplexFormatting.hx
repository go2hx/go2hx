...
function testComplexFormatting(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        for (__2 => _plus in _yesNo) {
            for (__3 => _zero in _yesNo) {
                for (__4 => _space in _yesNo) {
                    for (__5 => _char in ("fFeEgG" : stdgo.GoString)) {
                        ...
                        for (__6 => _realValue in _values) {
                            for (__7 => _imagValue in _values) {
