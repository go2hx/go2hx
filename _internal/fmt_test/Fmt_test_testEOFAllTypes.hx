...
function testEOFAllTypes(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        for (_i => _test in _internal.fmt_test.Fmt_test__eofTests._eofTests) {
            {
                var __tmp__ = stdgo._internal.fmt.Fmt_sscanf.sscanf(stdgo.Go.str()?.__copy__(), _test._format?.__copy__(), _test._v), __2:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
