...
function testScanOverflow(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        for (__3 => _test in _internal.fmt_test.Fmt_test__overflowTests._overflowTests) {
            var __tmp__ = stdgo._internal.fmt.Fmt_sscan.sscan(_test._text?.__copy__(), _test._in), __4:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err == null) {
