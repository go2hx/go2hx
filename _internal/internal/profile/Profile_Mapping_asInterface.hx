...
class Mapping_asInterface {
    @:keep
    public dynamic function _key():_internal.internal.profile.Profile_T_mappingKey.T_mappingKey return __self__.value._key();
    @:keep
    ...
    var __self__ : stdgo.Pointer<_internal.internal.profile.Profile_Mapping.Mapping>;
