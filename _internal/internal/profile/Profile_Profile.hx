...
@:structInit @:using(_internal.internal.profile.Profile_Profile_static_extension.Profile_static_extension) class Profile {
    public var sampleType : stdgo.Slice<stdgo.Ref<_internal.internal.profile.Profile_ValueType_.ValueType_>> = (null : stdgo.Slice<stdgo.Ref<_internal.internal.profile.Profile_ValueType_.ValueType_>>);
    public var defaultSampleType : stdgo.GoString = "";
    public var sample : stdgo.Slice<stdgo.Ref<_internal.internal.profile.Profile_Sample.Sample>> = (null : stdgo.Slice<stdgo.Ref<_internal.internal.profile.Profile_Sample.Sample>>);
    public var mapping : stdgo.Slice<stdgo.Ref<_internal.internal.profile.Profile_Mapping.Mapping>> = (null : stdgo.Slice<stdgo.Ref<_internal.internal.profile.Profile_Mapping.Mapping>>);
    ...
    public var function_ : stdgo.Slice<stdgo.Ref<_internal.internal.profile.Profile_Function.Function>> = (null : stdgo.Slice<stdgo.Ref<_internal.internal.profile.Profile_Function.Function>>);
    ...
    public var periodType : stdgo.Ref<_internal.internal.profile.Profile_ValueType_.ValueType_> = (null : stdgo.Ref<_internal.internal.profile.Profile_ValueType_.ValueType_>);
    ...
    public function new(?sampleType:stdgo.Slice<stdgo.Ref<_internal.internal.profile.Profile_ValueType_.ValueType_>>, ?defaultSampleType:stdgo.GoString, ?sample:stdgo.Slice<stdgo.Ref<_internal.internal.profile.Profile_Sample.Sample>>, ?mapping:stdgo.Slice<stdgo.Ref<_internal.internal.profile.Profile_Mapping.Mapping>>, ?location:stdgo.Slice<stdgo.Ref<_internal.internal.profile.Profile_Location.Location>>, ?function_:stdgo.Slice<stdgo.Ref<_internal.internal.profile.Profile_Function.Function>>, ?comments:stdgo.Slice<stdgo.GoString>, ?dropFrames:stdgo.GoString, ?keepFrames:stdgo.GoString, ?timeNanos:stdgo.GoInt64, ?durationNanos:stdgo.GoInt64, ?periodType:stdgo.Ref<_internal.internal.profile.Profile_ValueType_.ValueType_>, ?period:stdgo.GoInt64, ?_commentX:stdgo.Slice<stdgo.GoInt64>, ?_dropFramesX:stdgo.GoInt64, ?_keepFramesX:stdgo.GoInt64, ?_stringTable:stdgo.Slice<stdgo.GoString>, ?_defaultSampleTypeX:stdgo.GoInt64) {
