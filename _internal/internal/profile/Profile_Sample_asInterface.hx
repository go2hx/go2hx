...
class Sample_asInterface {
    @:keep
    public dynamic function _key():_internal.internal.profile.Profile_T_sampleKey.T_sampleKey return __self__.value._key();
    @:keep
    ...
    var __self__ : stdgo.Pointer<_internal.internal.profile.Profile_Sample.Sample>;
