...
function _encodeUint64s(_b:stdgo.Ref<_internal.internal.profile.Profile_T_buffer.T_buffer>, _tag:stdgo.GoInt, _x:stdgo.Slice<stdgo.GoUInt64>):Void {
        if (((_x.length) > (2 : stdgo.GoInt) : Bool)) {
            var _n1 = (_b._data.length : stdgo.GoInt);
            for (__0 => _u in _x) {
                _internal.internal.profile.Profile__encodeVarint._encodeVarint(_b, _u);
            };
