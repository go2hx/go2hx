...
class T_testMultiWriter_WriteStringSingleAlloc___localname___simpleWriter_2430_asInterface {
    ...
    var __self__ : stdgo.Pointer<_internal.io_test.Io_test_T_testMultiWriter_WriteStringSingleAlloc___localname___simpleWriter_2430.T_testMultiWriter_WriteStringSingleAlloc___localname___simpleWriter_2430>;
