...
import stdgo._internal.io.Io;
import stdgo._internal.io.Io;
function testCopyBuffer(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        stdgo._internal.io.Io_copyBuffer.copyBuffer(stdgo.Go.asInterface(_wb), stdgo.Go.asInterface(_rb), (new stdgo.Slice<stdgo.GoUInt8>((1 : stdgo.GoInt).toBasic(), 0).__setNumber32__() : stdgo.Slice<stdgo.GoUInt8>));
