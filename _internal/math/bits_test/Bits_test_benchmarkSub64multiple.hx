...
function benchmarkSub64multiple(_b:stdgo.Ref<stdgo._internal.testing.Testing_B.B>):Void {
        ...
        var _z3:stdgo.GoUInt64 = (_internal.math.bits_test.Bits_test_input.input : stdgo.GoUInt64);
        {
            ...
            stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
                ...
                {
                    var __tmp__ = stdgo._internal.math.bits.Bits_sub64.sub64(_z0, (_i : stdgo.GoUInt64), _c);
                    _z0 = __tmp__._0;
                    _c = __tmp__._1;
                };
                {
                    var __tmp__ = stdgo._internal.math.bits.Bits_sub64.sub64(_z1, (_i : stdgo.GoUInt64), _c);
                    _z1 = __tmp__._0;
                    _c = __tmp__._1;
                };
                {
                    var __tmp__ = stdgo._internal.math.bits.Bits_sub64.sub64(_z2, (_i : stdgo.GoUInt64), _c);
                    _z2 = __tmp__._0;
                    _c = __tmp__._1;
                };
                {
                    var __tmp__ = stdgo._internal.math.bits.Bits_sub64.sub64(_z3, (_i : stdgo.GoUInt64), _c);
                    _z3 = __tmp__._0;
                };
            });
        };
