...
import stdgo._internal.os.Os;
import stdgo._internal.os.Os;
function testFileChown(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        try {
            ...
            _t.parallel();
            var _f = _internal.os_test.Os_test__newFile._newFile(("TestFileChown" : stdgo.GoString), _t);
            {
                var _a0 = _f.name();
