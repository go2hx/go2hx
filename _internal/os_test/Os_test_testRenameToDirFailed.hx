...
import stdgo._internal.os.Os;
import stdgo._internal.os.Os;
function testRenameToDirFailed(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
...
var _to = __1, _from = __0;
            stdgo._internal.os.Os_mkdir.mkdir(_from?.__copy__(), (511u32 : stdgo._internal.io.fs.Fs_FileMode.FileMode));
