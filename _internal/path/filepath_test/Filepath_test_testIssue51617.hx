...
function testIssue51617(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        try {
            ...
            var _err = (stdgo._internal.path.filepath.Filepath_walkDir.walkDir(_dir?.__copy__(), function(_path:stdgo.GoString, _d:stdgo._internal.io.fs.Fs_DirEntry.DirEntry, _err:stdgo.Error):stdgo.Error {
                var __deferstack__:Array<Void -> Void> = [];
                try {
                    if (_err != null) {
                        {
                    ...
                    if (_d.isDir()) {
                        var __tmp__ = stdgo._internal.path.filepath.Filepath_rel.rel(_dir?.__copy__(), _path?.__copy__()), _rel:stdgo.GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                        if (_err != null) {
                            _t.fatal(stdgo.Go.toInterface(_err));
                        };
