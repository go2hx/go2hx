...
import stdgo._internal.reflect.Reflect;
import stdgo._internal.reflect.Reflect;
function testDeepEqualComplexStructInequality(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        var _m = ({
        ...
        var __0 = ("hello" : stdgo.GoString), __1 = ("helloo" : stdgo.GoString);
...
var _b = __1, _a = __0;
        ...
        if (stdgo._internal.reflect.Reflect_deepEqual.deepEqual(stdgo.Go.toInterface(_a), stdgo.Go.toInterface(_b))) {
            _t.error(stdgo.Go.toInterface(("DeepEqual(complex different) = true, want false" : stdgo.GoString)));
        };
    }
