...
function testFieldByIndexErr(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        var __tmp__ = _v.fieldByIndexErr((new stdgo.Slice<stdgo.GoInt>(2, 2, ...[(0 : stdgo.GoInt), (0 : stdgo.GoInt)]).__setNumber32__() : stdgo.Slice<stdgo.GoInt>)), __6:stdgo._internal.reflect.Reflect_Value.Value = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err == null) {
