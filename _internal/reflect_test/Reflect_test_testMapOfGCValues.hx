...
function testMapOfGCValues(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        {};
        var _tt = (stdgo._internal.reflect.Reflect_typeOf.typeOf(stdgo.Go.toInterface((null : _internal.reflect_test.Reflect_test_T_testMapOfGCValues___localname___T_162647.T_testMapOfGCValues___localname___T_162647))) : stdgo._internal.reflect.Reflect_Type_.Type_);
        var _mt = (stdgo._internal.reflect.Reflect_mapOf.mapOf(stdgo._internal.reflect.Reflect_typeOf.typeOf(stdgo.Go.toInterface((1 : stdgo.GoInt))), _tt) : stdgo._internal.reflect.Reflect_Type_.Type_);
        {};
            ...
            stdgo.Go.cfor((_i < (100 : stdgo.GoInt) : Bool), _i++, {
                var _v = (stdgo._internal.reflect.Reflect_makeMap.makeMap(_mt)?.__copy__() : stdgo._internal.reflect.Reflect_Value.Value);
                {
                    ...
                    stdgo.Go.cfor((_j < (100 : stdgo.GoInt) : Bool), _j++, {
                        ...
                        _v.setMapIndex(stdgo._internal.reflect.Reflect_valueOf.valueOf(stdgo.Go.toInterface(_j))?.__copy__(), stdgo._internal.reflect.Reflect_valueOf.valueOf(stdgo.Go.toInterface(_p)).convert(_tt)?.__copy__());
                    });
                };
        ...
        for (_i => _xi in _x) {
            var _v = (stdgo._internal.reflect.Reflect_valueOf.valueOf(_xi).elem()?.__copy__() : stdgo._internal.reflect.Reflect_Value.Value);
            {
                var _j = (0 : stdgo.GoInt);
                stdgo.Go.cfor((_j < (100 : stdgo.GoInt) : Bool), _j++, {
                    var _k = (stdgo.Go.typeAssert((_v.mapIndex(stdgo._internal.reflect.Reflect_valueOf.valueOf(stdgo.Go.toInterface(_j))?.__copy__()).elem().interface_() : stdgo.GoUIntptr)) : stdgo.GoUIntptr);
                    if (_k != ((((_i * (100 : stdgo.GoInt) : stdgo.GoInt) + _j : stdgo.GoInt) : stdgo.GoUIntptr))) {
