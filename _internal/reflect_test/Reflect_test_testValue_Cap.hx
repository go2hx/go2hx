...
function testValue_Cap(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        try {
            ...
            if (_v.cap() != (_a.capacity)) {
                _t.errorf(("Cap = %d want %d" : stdgo.GoString), stdgo.Go.toInterface(_v.cap()), stdgo.Go.toInterface(_a.capacity));
            };
            ...
            var _e = (_getError(function():Void {
                ...
                try {
                    ...
                    stdgo._internal.reflect.Reflect_valueOf.valueOf(stdgo.Go.toInterface(_ptr)).cap();
                    {
                        for (defer in __deferstack__) {
                            defer();
                        };
            ...
            var _wantStr = ("reflect: call of reflect.Value.Cap on ptr to non-array Value" : stdgo.GoString);
            if (_e != (_wantStr)) {
