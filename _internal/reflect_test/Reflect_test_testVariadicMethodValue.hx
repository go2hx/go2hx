...
function testVariadicMethodValue(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        var _tfunc = (stdgo._internal.reflect.Reflect_typeOf.typeOf(stdgo.Go.toInterface((null : (_internal.reflect_test.Reflect_test_Point.Point, haxe.Rest<_internal.reflect_test.Reflect_test_Point.Point>) -> stdgo.GoInt))) : stdgo._internal.reflect.Reflect_Type_.Type_);
        {
        ...
        _tfunc = stdgo._internal.reflect.Reflect_typeOf.typeOf(stdgo.Go.toInterface((null : haxe.Rest<_internal.reflect_test.Reflect_test_Point.Point> -> stdgo.GoInt)));
        ...
        var _f = (stdgo.Go.typeAssert((_v.interface_() : haxe.Rest<_internal.reflect_test.Reflect_test_Point.Point> -> stdgo.GoInt)) : haxe.Rest<_internal.reflect_test.Reflect_test_Point.Point> -> stdgo.GoInt);
