...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
@:structInit class Node1 {
    public var value : stdgo.GoArray<stdgo.GoUIntptr> = new stdgo.GoArray<stdgo.GoUIntptr>(1, 1, ...[for (i in 0 ... 1) (0 : stdgo.GoUIntptr)]);
    ...
    public function __copy__() {
        return new Node1(value, left, right);
    }
}
