...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
@:structInit class Node124 {
    public var value : stdgo.GoArray<stdgo.GoUIntptr> = new stdgo.GoArray<stdgo.GoUIntptr>(124, 124, ...[for (i in 0 ... 124) (0 : stdgo.GoUIntptr)]);
    ...
    public function __copy__() {
        return new Node124(value, left, right);
    }
}
