...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
@:structInit class Node126 {
    public var value : stdgo.GoArray<stdgo.GoUIntptr> = new stdgo.GoArray<stdgo.GoUIntptr>(126, 126, ...[for (i in 0 ... 126) (0 : stdgo.GoUIntptr)]);
    ...
    public function __copy__() {
        return new Node126(value, left, right);
    }
}
