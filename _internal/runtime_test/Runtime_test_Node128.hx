...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
@:structInit class Node128 {
    public var value : stdgo.GoArray<stdgo.GoUIntptr> = new stdgo.GoArray<stdgo.GoUIntptr>(128, 128, ...[for (i in 0 ... 128) (0 : stdgo.GoUIntptr)]);
    ...
    public function __copy__() {
        return new Node128(value, left, right);
    }
}
