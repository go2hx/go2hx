...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
@:structInit class Node130 {
    public var value : stdgo.GoArray<stdgo.GoUIntptr> = new stdgo.GoArray<stdgo.GoUIntptr>(130, 130, ...[for (i in 0 ... 130) (0 : stdgo.GoUIntptr)]);
    ...
    public function __copy__() {
        return new Node130(value, left, right);
    }
}
