...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
@:structInit class Node8 {
    public var value : stdgo.GoArray<stdgo.GoUIntptr> = new stdgo.GoArray<stdgo.GoUIntptr>(8, 8, ...[for (i in 0 ... 8) (0 : stdgo.GoUIntptr)]);
    ...
    public function __copy__() {
        return new Node8(value, left, right);
    }
}
