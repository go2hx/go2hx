...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
@:structInit class T_testArgsType8b {
    ...
    public function new(?_a:stdgo.GoInt, ?_b:stdgo.GoInt, ?_c:stdgo.GoInt, ?_d:stdgo.GoInt, ?_e:stdgo.GoInt, ?_f:stdgo.GoInt, ?_g:stdgo.GoInt, ?_h:stdgo.GoInt, ?_i:stdgo.GoArray<stdgo.GoInt>) {
    ...
    public function __copy__() {
        return new T_testArgsType8b(_a, _b, _c, _d, _e, _f, _g, _h, _i);
    }
}
