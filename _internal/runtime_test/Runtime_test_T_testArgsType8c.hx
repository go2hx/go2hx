...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
@:structInit class T_testArgsType8c {
    ...
    public var _i : stdgo.GoArray<stdgo.GoInt> = new stdgo.GoArray<stdgo.GoInt>(2, 2, ...[for (i in 0 ... 2) (0 : stdgo.GoInt)]);
    ...
    public function __copy__() {
        return new T_testArgsType8c(_a, _b, _c, _d, _e, _f, _g, _h, _i, _j);
    }
}
