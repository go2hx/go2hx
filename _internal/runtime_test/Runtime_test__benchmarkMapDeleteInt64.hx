...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
function _benchmarkMapDeleteInt64(_b:stdgo.Ref<stdgo._internal.testing.Testing_B.B>, _n:stdgo.GoInt):Void {
        var _a = ({
                ...
                if ((_a.length) == ((0 : stdgo.GoInt))) {
                    _b.stopTimer();
                    {
                        ...
                        stdgo.Go.cfor((_j < (_i + _n : stdgo.GoInt) : Bool), _j++, {
                            _a[(_j : stdgo.GoInt64)] = _j;
                        });
                    };
                    _b.startTimer();
                };
                if (_a != null) _a.remove((_i : stdgo.GoInt64));
            });
        };
    }
