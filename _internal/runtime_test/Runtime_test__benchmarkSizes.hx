...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
function _benchmarkSizes(_b:stdgo.Ref<stdgo._internal.testing.Testing_B.B>, _sizes:stdgo.Slice<stdgo.GoInt>, _fn:(stdgo.Ref<stdgo._internal.testing.Testing_B.B>, stdgo.GoInt) -> Void):Void {
