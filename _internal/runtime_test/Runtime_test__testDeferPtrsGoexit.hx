...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
function _testDeferPtrsGoexit(_c:stdgo.Chan<stdgo.GoInt>, _i:stdgo.GoInt):Void {
        ...
        try {
            ...
            _internal.runtime_test.Runtime_test__useStackAndCall._useStackAndCall(_i, stdgo._internal.runtime.Runtime_goexit.goexit);
            {
                for (defer in __deferstack__) {
                    defer();
                };
