...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
function benchmarkAlignedLoad(_b:stdgo.Ref<stdgo._internal.testing.Testing_B.B>):Void {
        var _buf:stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(16, 16, ...[for (i in 0 ... 16) (0 : stdgo.GoUInt8)]);
        var _p = (stdgo.Go.toInterface(stdgo.Go.pointer(_buf[(0 : stdgo.GoInt)])) : stdgo._internal.unsafe.Unsafe.UnsafePointer);
