...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
function benchmarkClearFat8(_b:stdgo.Ref<stdgo._internal.testing.Testing_B.B>):Void {
        ...
        _b.resetTimer();
        {
            ...
            stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
                _p = (new stdgo.GoArray<stdgo.GoUInt32>(2, 2, ...[]).__setNumber32__() : stdgo.GoArray<stdgo.GoUInt32>)?.__copy__();
            });
        };
    }
