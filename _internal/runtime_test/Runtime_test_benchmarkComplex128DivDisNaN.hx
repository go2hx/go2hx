...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
function benchmarkComplex128DivDisNaN(_b:stdgo.Ref<stdgo._internal.testing.Testing_B.B>):Void {
        var _d = ((15f64 : stdgo.GoFloat64) + new stdgo.GoComplex128(0f64, 2f64) : stdgo.GoComplex128);
        var _n = (stdgo._internal.math.cmplx.Cmplx_naN.naN() : stdgo.GoComplex128);
