...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
function benchmarkComplex128DivNisNaN(_b:stdgo.Ref<stdgo._internal.testing.Testing_B.B>):Void {
        var _d = (stdgo._internal.math.cmplx.Cmplx_naN.naN() : stdgo.GoComplex128);
