...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
function benchmarkHashInt32Speed(_b:stdgo.Ref<stdgo._internal.testing.Testing_B.B>):Void {
        var _ints = (new stdgo.Slice<stdgo.GoInt32>((10 : stdgo.GoInt).toBasic(), 0).__setNumber32__() : stdgo.Slice<stdgo.GoInt32>);
        {
            var _i = (0 : stdgo.GoInt);
            stdgo.Go.cfor((_i < (10 : stdgo.GoInt) : Bool), _i++, {
                _ints[(_i : stdgo.GoInt)] = (_i : stdgo.GoInt32);
            });
        };
