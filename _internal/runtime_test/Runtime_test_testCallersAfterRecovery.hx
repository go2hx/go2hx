...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
function testCallersAfterRecovery(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            var _want = (new stdgo.Slice<stdgo.GoString>(3, 3, ...[("runtime.Callers" : stdgo.GoString), ("runtime_test.TestCallersAfterRecovery.func1" : stdgo.GoString), ("runtime_test.TestCallersAfterRecovery" : stdgo.GoString)]).__setString__() : stdgo.Slice<stdgo.GoString>);
