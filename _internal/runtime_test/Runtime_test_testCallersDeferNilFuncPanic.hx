...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
function testCallersDeferNilFuncPanic(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            var _state = (1 : stdgo.GoInt);
            var _want = (new stdgo.Slice<stdgo.GoString>(5, 5, ...[("runtime.Callers" : stdgo.GoString), ("runtime_test.TestCallersDeferNilFuncPanic.func1" : stdgo.GoString), ("runtime.gopanic" : stdgo.GoString), ("runtime.panicmem" : stdgo.GoString), ("runtime.sigpanic" : stdgo.GoString)]).__setString__() : stdgo.Slice<stdgo.GoString>);
