...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
function testCallersDoublePanic(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            var _want = (new stdgo.Slice<stdgo.GoString>(6, 6, ...[("runtime.Callers" : stdgo.GoString), ("runtime_test.TestCallersDoublePanic.func1.1" : stdgo.GoString), ("runtime.gopanic" : stdgo.GoString), ("runtime_test.TestCallersDoublePanic.func1" : stdgo.GoString), ("runtime.gopanic" : stdgo.GoString), ("runtime_test.TestCallersDoublePanic" : stdgo.GoString)]).__setString__() : stdgo.Slice<stdgo.GoString>);
