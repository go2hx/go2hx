...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
function testConcurrentMapReadWrite(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        var _output = (_internal.runtime_test.Runtime_test__runTestProg._runTestProg(_t, ("testprog" : stdgo.GoString), ("concurrentMapReadWrite" : stdgo.GoString))?.__copy__() : stdgo.GoString);
        var _want = ("fatal error: concurrent map read and map write" : stdgo.GoString);
