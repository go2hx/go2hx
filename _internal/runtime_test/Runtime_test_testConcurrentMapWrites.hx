...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
function testConcurrentMapWrites(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        var _output = (_internal.runtime_test.Runtime_test__runTestProg._runTestProg(_t, ("testprog" : stdgo.GoString), ("concurrentMapWrites" : stdgo.GoString))?.__copy__() : stdgo.GoString);
        var _want = ("fatal error: concurrent map writes" : stdgo.GoString);
