...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
function testGdbInfCallstack(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        if (true) {
            _t.skip(stdgo.Go.toInterface(("skipping infinite callstack test on non-arm64 arches" : stdgo.GoString)));
        };
        _t.parallel();
...
("-ex" : stdgo.GoString),
("break setg_gcc" : stdgo.GoString),
("-ex" : stdgo.GoString),
("run" : stdgo.GoString),
("-ex" : stdgo.GoString),
("backtrace 3" : stdgo.GoString),
("-ex" : stdgo.GoString),
("disable 1" : stdgo.GoString),
("-ex" : stdgo.GoString),
...
stdgo._internal.path.filepath.Filepath_join.join(_dir?.__copy__(), ("a.exe" : stdgo.GoString))?.__copy__()]).__setString__() : stdgo.Slice<stdgo.GoString>);
        ...
        var _bt = (new stdgo.Slice<stdgo.GoString>(3, 3, ...[("setg_gcc" : stdgo.GoString), ("crosscall1" : stdgo.GoString), ("threadentry" : stdgo.GoString)]).__setString__() : stdgo.Slice<stdgo.GoString>);
        for (_i => _name in _bt) {
            var _s = (stdgo._internal.fmt.Fmt_sprintf.sprintf(("#%v.*%v" : stdgo.GoString), stdgo.Go.toInterface(_i), stdgo.Go.toInterface(_name))?.__copy__() : stdgo.GoString);
