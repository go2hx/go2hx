...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
function testIncrementAfterBulkClearKeyStringValueInt(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        {};
        {};
        var _m = ({
        ...
        (_m[("x" : stdgo.GoString)] != null ? _m[("x" : stdgo.GoString)]++ : (0 : stdgo.GoInt));
        {
