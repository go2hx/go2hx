...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
function testPanicFar(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            var _xtree:stdgo.Ref<_internal.runtime_test.Runtime_test_T_xtreeNode.T_xtreeNode> = (null : stdgo.Ref<_internal.runtime_test.Runtime_test_T_xtreeNode.T_xtreeNode>);
            ...
            _internal.runtime_test.Runtime_test__useStackAndCall._useStackAndCall((100 : stdgo.GoInt), function():Void {
                var __deferstack__:Array<Void -> Void> = [];
                try {
                    _xtree = _internal.runtime_test.Runtime_test__makeTree._makeTree((18 : stdgo.GoInt));
