...
import stdgo._internal.unsafe.Unsafe;
import stdgo._internal.unsafe.Unsafe;
function testPinnerCgoCheckPtr2UnsafePtr(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        try {
            ...
            var _p2 = (stdgo.Go.setRef(({ _o : _p } : _internal.runtime_test.Runtime_test_T_objWith.T_objWith<stdgo._internal.unsafe.Unsafe.UnsafePointer>)) : stdgo.Ref<_internal.runtime_test.Runtime_test_T_objWith.T_objWith<stdgo._internal.unsafe.Unsafe.UnsafePointer>>);
