...
import stdgo._internal.sort.Sort;
function benchmarkSortString1K_Slice(_b:stdgo.Ref<stdgo._internal.testing.Testing_B.B>):Void {
        _b.stopTimer();
        ...
        var _data = (new stdgo.Slice<stdgo.GoString>((_unsorted.length : stdgo.GoInt).toBasic(), 0).__setString__() : stdgo.Slice<stdgo.GoString>);
        {
            ...
            stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
                ...
                _b.startTimer();
                stdgo._internal.sort.Sort_slice.slice(stdgo.Go.toInterface(_data), function(_i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
