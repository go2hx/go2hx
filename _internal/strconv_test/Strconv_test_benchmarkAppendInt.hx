...
import stdgo._internal.strconv.Strconv;
import stdgo._internal.strconv.Strconv;
function benchmarkAppendInt(_b:stdgo.Ref<stdgo._internal.testing.Testing_B.B>):Void {
        var _dst = (new stdgo.Slice<stdgo.GoUInt8>((0 : stdgo.GoInt).toBasic(), (30 : stdgo.GoInt)).__setNumber32__() : stdgo.Slice<stdgo.GoUInt8>);
        {
            ...
            stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
                for (__8 => _test in _internal.strconv_test.Strconv_test__itob64tests._itob64tests) {
                    _dst = stdgo._internal.strconv.Strconv_appendInt.appendInt((_dst.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>), _test._in, _test._base);
