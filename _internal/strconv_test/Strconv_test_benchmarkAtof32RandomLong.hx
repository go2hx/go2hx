...
import stdgo._internal.strconv.Strconv;
import stdgo._internal.strconv.Strconv;
function benchmarkAtof32RandomLong(_b:stdgo.Ref<stdgo._internal.testing.Testing_B.B>):Void {
        ...
        for (_i => _ in _float32strings) {
            ...
            _float32strings[(_i : stdgo.GoInt)] = stdgo._internal.strconv.Strconv_formatFloat.formatFloat((stdgo._internal.math.Math_float32frombits.float32frombits(_n) : stdgo.GoFloat64), (103 : stdgo.GoUInt8), (20 : stdgo.GoInt), (32 : stdgo.GoInt))?.__copy__();
        };
        _b.resetTimer();
        {
