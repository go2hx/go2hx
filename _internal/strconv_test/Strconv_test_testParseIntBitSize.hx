...
import stdgo._internal.strconv.Strconv;
import stdgo._internal.strconv.Strconv;
function testParseIntBitSize(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        for (_i => _ in _internal.strconv_test.Strconv_test__parseBitSizeTests._parseBitSizeTests) {
            ...
            var __tmp__ = stdgo._internal.strconv.Strconv_parseInt.parseInt(("0" : stdgo.GoString), (0 : stdgo.GoInt), _test._arg), __0:stdgo.GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
