...
import stdgo._internal.strconv.Strconv;
import stdgo._internal.strconv.Strconv;
function testParseUintBase(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        for (_i => _ in _internal.strconv_test.Strconv_test__parseBaseTests._parseBaseTests) {
            ...
            var __tmp__ = stdgo._internal.strconv.Strconv_parseUint.parseUint(("0" : stdgo.GoString), _test._arg, (0 : stdgo.GoInt)), __0:stdgo.GoUInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
