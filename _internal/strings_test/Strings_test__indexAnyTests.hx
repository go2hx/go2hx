...
import stdgo._internal.strings.Strings;
import stdgo._internal.strings.Strings;
var _indexAnyTests : stdgo.Slice<_internal.strings_test.Strings_test_IndexTest.IndexTest> = (new stdgo.Slice<_internal.strings_test.Strings_test_IndexTest.IndexTest>(17, 17, ...[
...
(new _internal.strings_test.Strings_test_IndexTest.IndexTest(("aaa" : stdgo.GoString), ("a" : stdgo.GoString), (0 : stdgo.GoInt)) : _internal.strings_test.Strings_test_IndexTest.IndexTest),
...
(new _internal.strings_test.Strings_test_IndexTest.IndexTest(("abc" : stdgo.GoString), ("xcz" : stdgo.GoString), (2 : stdgo.GoInt)) : _internal.strings_test.Strings_test_IndexTest.IndexTest),
...
(new _internal.strings_test.Strings_test_IndexTest.IndexTest(("aRegExp*" : stdgo.GoString), (".(|)*+?^$[]" : stdgo.GoString), (7 : stdgo.GoInt)) : _internal.strings_test.Strings_test_IndexTest.IndexTest),
...
(new _internal.strings_test.Strings_test_IndexTest.IndexTest(("012abcba210" : stdgo.GoString), stdgo.Go.str(255, "b")?.__copy__(), (4 : stdgo.GoInt)) : _internal.strings_test.Strings_test_IndexTest.IndexTest),
(new _internal.strings_test.Strings_test_IndexTest.IndexTest(stdgo.Go.str("012", 128, "bcb", 128, "210")?.__copy__(), stdgo.Go.str(255, "b")?.__copy__(), (3 : stdgo.GoInt)) : _internal.strings_test.Strings_test_IndexTest.IndexTest),
