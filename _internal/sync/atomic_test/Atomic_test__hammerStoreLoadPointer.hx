...
import stdgo._internal.sync.atomic_.Atomic_;
function _hammerStoreLoadPointer(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>, _paddr:stdgo._internal.unsafe.Unsafe.UnsafePointer):Void {
        ...
        var _v = (stdgo._internal.sync.atomic_.Atomic__loadPointer.loadPointer(_addr).__convert__(stdgo._internal.internal.reflect.Reflect.GoType.basic(uintptr_kind)) : stdgo.GoUIntptr);
        ...
        stdgo._internal.sync.atomic_.Atomic__storePointer.storePointer(_addr, (stdgo.Go.toInterface(_new) : stdgo._internal.unsafe.Unsafe.UnsafePointer));
    }
