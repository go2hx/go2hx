...
import stdgo._internal.sync.atomic_.Atomic_;
function testAddInt32(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        var _j:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        {
            ...
            stdgo.Go.cfor(((_delta + _delta : stdgo.GoInt32) > _delta : Bool), _delta = (_delta + (_delta) : stdgo.GoInt32), {
                var _k = (stdgo._internal.sync.atomic_.Atomic__addInt32.addInt32(stdgo.Go.pointer(_x._i), _delta) : stdgo.GoInt32);
