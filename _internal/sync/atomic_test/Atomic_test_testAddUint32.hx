...
import stdgo._internal.sync.atomic_.Atomic_;
function testAddUint32(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        var _j:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        {
            ...
            stdgo.Go.cfor(((_delta + _delta : stdgo.GoUInt32) > _delta : Bool), _delta = (_delta + (_delta) : stdgo.GoUInt32), {
                var _k = (stdgo._internal.sync.atomic_.Atomic__addUint32.addUint32(stdgo.Go.pointer(_x._i), _delta) : stdgo.GoUInt32);
