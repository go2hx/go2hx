...
import stdgo._internal.sync.atomic_.Atomic_;
function testAddUint64(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        var _j:stdgo.GoUInt64 = (0 : stdgo.GoUInt64);
        {
            ...
            stdgo.Go.cfor(((_delta + _delta : stdgo.GoUInt64) > _delta : Bool), _delta = (_delta + (_delta) : stdgo.GoUInt64), {
                var _k = (stdgo._internal.sync.atomic_.Atomic__addUint64.addUint64(stdgo.Go.pointer(_x._i), _delta) : stdgo.GoUInt64);
