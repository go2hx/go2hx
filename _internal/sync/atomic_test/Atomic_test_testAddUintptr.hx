...
import stdgo._internal.sync.atomic_.Atomic_;
function testAddUintptr(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        var _j:stdgo.GoUIntptr = (0 : stdgo.GoUIntptr);
        {
            ...
            stdgo.Go.cfor(((_delta + _delta : stdgo.GoUIntptr) > _delta : Bool), _delta = (_delta + (_delta) : stdgo.GoUIntptr), {
                var _k = (stdgo._internal.sync.atomic_.Atomic__addUintptr.addUintptr(stdgo.Go.pointer(_x._i), _delta) : stdgo.GoUIntptr);
