...
import stdgo._internal.sync.atomic_.Atomic_;
function testHammer64(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        try {
            ...
            for (_name => _testf in _internal.sync.atomic_test.Atomic_test__hammer64._hammer64) {
                ...
                if ((!stdgo._internal.strings.Strings_hasPrefix.hasPrefix(_name?.__copy__(), ("Swap" : stdgo.GoString)) && (_val != ((_n : stdgo.GoUInt64) * (4i64 : stdgo.GoUInt64) : stdgo.GoUInt64)) : Bool)) {
