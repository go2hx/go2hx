...
import stdgo._internal.sync.atomic_.Atomic_;
function testLoadInt64(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        _x._after = _magic64;
        {
            ...
            stdgo.Go.cfor(((_delta + _delta : stdgo.GoInt64) > _delta : Bool), _delta = (_delta + (_delta) : stdgo.GoInt64), {
                var _k = (stdgo._internal.sync.atomic_.Atomic__loadInt64.loadInt64(stdgo.Go.pointer(_x._i)) : stdgo.GoInt64);
                if (_k != (_x._i)) {
