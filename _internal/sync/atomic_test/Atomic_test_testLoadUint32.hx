...
import stdgo._internal.sync.atomic_.Atomic_;
function testLoadUint32(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        _x._after = (233684719u32 : stdgo.GoUInt32);
        {
            ...
            stdgo.Go.cfor(((_delta + _delta : stdgo.GoUInt32) > _delta : Bool), _delta = (_delta + (_delta) : stdgo.GoUInt32), {
                var _k = (stdgo._internal.sync.atomic_.Atomic__loadUint32.loadUint32(stdgo.Go.pointer(_x._i)) : stdgo.GoUInt32);
                if (_k != (_x._i)) {
