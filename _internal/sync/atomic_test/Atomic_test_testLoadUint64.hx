...
import stdgo._internal.sync.atomic_.Atomic_;
function testLoadUint64(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        _x._after = _magic64;
        {
            ...
            stdgo.Go.cfor(((_delta + _delta : stdgo.GoUInt64) > _delta : Bool), _delta = (_delta + (_delta) : stdgo.GoUInt64), {
                var _k = (stdgo._internal.sync.atomic_.Atomic__loadUint64.loadUint64(stdgo.Go.pointer(_x._i)) : stdgo.GoUInt64);
                if (_k != (_x._i)) {
