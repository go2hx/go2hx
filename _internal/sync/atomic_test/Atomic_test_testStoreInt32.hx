...
import stdgo._internal.sync.atomic_.Atomic_;
function testStoreInt32(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        var _v = ((0 : stdgo.GoInt32) : stdgo.GoInt32);
        {
            ...
            stdgo.Go.cfor(((_delta + _delta : stdgo.GoInt32) > _delta : Bool), _delta = (_delta + (_delta) : stdgo.GoInt32), {
                stdgo._internal.sync.atomic_.Atomic__storeInt32.storeInt32(stdgo.Go.pointer(_x._i), _v);
                if (_x._i != (_v)) {
