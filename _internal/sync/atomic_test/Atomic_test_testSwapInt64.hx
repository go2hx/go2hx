...
import stdgo._internal.sync.atomic_.Atomic_;
function testSwapInt64(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        var _j:stdgo.GoInt64 = (0 : stdgo.GoInt64);
        {
            ...
            stdgo.Go.cfor(((_delta + _delta : stdgo.GoInt64) > _delta : Bool), _delta = (_delta + (_delta) : stdgo.GoInt64), {
                var _k = (stdgo._internal.sync.atomic_.Atomic__swapInt64.swapInt64(stdgo.Go.pointer(_x._i), _delta) : stdgo.GoInt64);
