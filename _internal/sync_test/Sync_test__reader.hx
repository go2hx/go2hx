...
import stdgo._internal.sync.Sync;
import stdgo._internal.sync.Sync;
function _reader(_rwm:stdgo.Ref<stdgo._internal.sync.Sync_RWMutex.RWMutex>, _num_iterations:stdgo.GoInt, _activity:stdgo.Pointer<stdgo.GoInt32>, _cdone:stdgo.Chan<Bool>):Void {
        {
