...
@:keep var __init_go2hx__ = {
        try {
            var __tmp__0 = _internal.syscall_dot_test.Syscall_dot_test__tests._tests, __tmp__1 = _internal.syscall_dot_test.Syscall_dot_test__benchmarks._benchmarks, __tmp__2 = _internal.syscall_dot_test.Syscall_dot_test__fuzzTargets._fuzzTargets, __tmp__3 = _internal.syscall_dot_test.Syscall_dot_test__examples._examples;
