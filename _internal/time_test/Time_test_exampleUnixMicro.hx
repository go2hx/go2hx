...
function exampleUnixMicro():Void {
        ...
        stdgo._internal.fmt.Fmt_println.println(stdgo.Go.toInterface(_umt.unixMicro()));
        var _t = (stdgo._internal.time.Time_unixMicro.unixMicro(_umt.unixMicro()).utc()?.__copy__() : stdgo._internal.time.Time_Time.Time);
