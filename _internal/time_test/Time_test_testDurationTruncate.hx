...
function testDurationTruncate(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        for (__2 => _tt in _internal.time_test.Time_test__durationTruncateTests._durationTruncateTests) {
            {
                var _got = (_tt._d.truncate(_tt._m) : stdgo._internal.time.Time_Duration.Duration);
                if (_got != (_tt._want)) {
