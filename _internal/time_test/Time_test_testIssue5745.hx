...
function testIssue5745(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            var _ticker = stdgo._internal.time.Time_newTicker.newTicker((3600000000000i64 : stdgo._internal.time.Time_Duration.Duration));
