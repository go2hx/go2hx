...
function newX(_key:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo._internal.crypto.cipher.Cipher_AEAD.AEAD; var _1 : stdgo.Error; } {
        ...
        var _ret = (stdgo.Go.setRef(({} : _internal.vendor.golang_dot_org.x.crypto.chacha20poly1305.Chacha20poly1305_T_xchacha20poly1305.T_xchacha20poly1305)) : stdgo.Ref<_internal.vendor.golang_dot_org.x.crypto.chacha20poly1305.Chacha20poly1305_T_xchacha20poly1305.T_xchacha20poly1305>);
