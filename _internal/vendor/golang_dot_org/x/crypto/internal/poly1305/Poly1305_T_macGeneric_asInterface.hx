...
class T_macGeneric_asInterface {
    @:keep
    ...
    var __self__ : stdgo.Pointer<_internal.vendor.golang_dot_org.x.crypto.internal.poly1305.Poly1305_T_macGeneric.T_macGeneric>;
