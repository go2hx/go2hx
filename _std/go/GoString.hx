...
private class GoStringData {
	...
	public function toString():String {
		#if !nolinkstd
		if (!go._internal.unicode.utf8.Utf8_validstring.validString((this : GoString)))
...
abstract GoString(GoStringData) from GoStringData to GoStringData {
	...
	@:to public function __toSliceByte__():Slice<GoByte> {
		final slice = new go.GoArray.GoArrayData<GoByte>(0, -1);
		if (this == null) {
	...
	@:to public function __toSliceRune__():Slice<GoRune> {
		...
		while (bytes.length > 0) {
			final tmp = go._internal.unicode.utf8.Utf8_decoderune.decodeRune(bytes);
			final rune = tmp._0;
			final size = tmp._1;
