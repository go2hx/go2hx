...
**/
function makeFunc(typ:Type_, fn:(_args:stdgo.Slice<Value>) -> stdgo.Slice<Value>):Value {
        final fn = fn;
...
**/
function typeOf(i:stdgo.AnyInterface):Type_ {
...
**/
function pointerTo(t:Type_):Type_ {
...
**/
function chanOf(dir:ChanDir, t:Type_):Type_ {
...
**/
function mapOf(key:Type_, elem:Type_):Type_ {
...
/**
    ...
    true.
**/
function funcOf(_in:Array<Type_>, out:Array<Type_>, variadic:Bool):Type_ {
...
**/
function sliceOf(t:Type_):Type_ {
...
**/
function structOf(fields:Array<StructField>):Type_ {
...
/**
    ...
    ArrayOf panics.
**/
function arrayOf(_length:StdTypes.Int, elem:Type_):Type_ {
...
**/
function append(s:Value, x:haxe.Rest<Value>):Value {
...
**/
function appendSlice(s:Value, t:Value):Value {
...
**/
function copy(dst:Value, src:Value):StdTypes.Int {
...
**/
function select(cases:Array<SelectCase>):stdgo.Tuple.Tuple3<StdTypes.Int, Value, Bool> {
...
**/
function makeSlice(typ:Type_, len:StdTypes.Int, cap:StdTypes.Int):Value {
        return stdgo._internal.reflect.Reflect.makeSlice(typ, len, cap);
    }
/**
    MakeChan creates a new channel with the specified type and buffer size.
**/
function makeChan(typ:Type_, buffer:StdTypes.Int):Value {
        return stdgo._internal.reflect.Reflect.makeChan(typ, buffer);
    }
/**
    MakeMap creates a new map with the specified type.
**/
function makeMap(typ:Type_):Value {
...
**/
function makeMapWithSize(typ:Type_, n:StdTypes.Int):Value {
...
**/
function valueOf(i:stdgo.AnyInterface):Value {
...
**/
function newAt(typ:Type_, p:stdgo._internal.unsafe.Unsafe.UnsafePointer):Value {
...
**/
function visibleFields(t:Type_):Array<StructField> {
