...
**/
function setCPUProfileRate(hz:StdTypes.Int):Void {
...
**/
function cpuprofile():Array<StdTypes.Int> {
...
**/
function gomaxprocs(n:StdTypes.Int):StdTypes.Int {
...
**/
function numGoroutine():StdTypes.Int {
...
**/
function caller(skip:StdTypes.Int):stdgo.Tuple.Tuple4<stdgo.GoUIntptr, String, StdTypes.Int, Bool> {
        return {
...
**/
function callers(skip:StdTypes.Int, pc:Array<stdgo.GoUIntptr>):StdTypes.Int {
...
**/
function setBlockProfileRate(rate:StdTypes.Int):Void {
...
**/
function setMutexProfileFraction(rate:StdTypes.Int):StdTypes.Int {
...
**/
function memProfile(p:Array<MemProfileRecord>, inuseZero:Bool):stdgo.Tuple<StdTypes.Int, Bool> {
...
**/
function blockProfile(p:Array<BlockProfileRecord>):stdgo.Tuple<StdTypes.Int, Bool> {
...
**/
function mutexProfile(p:Array<BlockProfileRecord>):stdgo.Tuple<StdTypes.Int, Bool> {
        final p = ([for (i in p) i] : stdgo.Slice<BlockProfileRecord>);
        return {
...
**/
function threadCreateProfile(p:Array<StackRecord>):stdgo.Tuple<StdTypes.Int, Bool> {
...
**/
function goroutineProfile(p:Array<StackRecord>):stdgo.Tuple<StdTypes.Int, Bool> {
        final p = ([for (i in p) i] : stdgo.Slice<StackRecord>);
        return {
...
**/
function stack(buf:Array<StdTypes.Int>, all:Bool):StdTypes.Int {
...
/**
    ...
    collection cycle.
**/
function readMemStats(m:MemStats):Void {
...
**/
function callersFrames(callers:Array<stdgo.GoUIntptr>):Frames {
...
**/
function funcForPC(pc:stdgo.GoUIntptr):Func {
...
**/
function readTrace():Array<StdTypes.Int> {
...
**/
function setCgoTraceback(version:StdTypes.Int, traceback:stdgo._internal.unsafe.Unsafe.UnsafePointer, context:stdgo._internal.unsafe.Unsafe.UnsafePointer, symbolizer:stdgo._internal.unsafe.Unsafe.UnsafePointer):Void {
