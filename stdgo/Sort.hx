...
function heapsort(data:Interface):Void {
        stdgo._internal.sort.Sort.heapsort(data);
    }
function reverseRange(data:Interface, a:StdTypes.Int, b:StdTypes.Int):Void {
...
**/
function search(n:StdTypes.Int, f:stdgo.GoInt -> Bool):StdTypes.Int {
        final f = f;
...
**/
function find(n:StdTypes.Int, cmp:stdgo.GoInt -> stdgo.GoInt):stdgo.Tuple<StdTypes.Int, Bool> {
        final cmp = cmp;
        return {
...
**/
function searchInts(a:Array<StdTypes.Int>, x:StdTypes.Int):StdTypes.Int {
...
/**
    ...
    The slice must be sorted in ascending order.
**/
function searchFloat64s(a:Array<StdTypes.Float>, x:StdTypes.Float):StdTypes.Int {
...
/**
    ...
    The slice must be sorted in ascending order.
**/
function searchStrings(a:Array<String>, x:String):StdTypes.Int {
...
/**
    ...
    ergonomic and runs faster.
**/
function isSorted(data:Interface):Bool {
...
**/
function ints(x:Array<StdTypes.Int>):Void {
...
/**
    ...
    Note: consider using the newer slices.Sort function, which runs faster.
**/
function float64s(x:Array<StdTypes.Float>):Void {
...
**/
function intsAreSorted(x:Array<StdTypes.Int>):Bool {
        final x = ([for (i in x) i] : stdgo.Slice<stdgo.GoInt>);
...
/**
    ...
    Note: consider using the newer slices.IsSorted function, which runs faster.
**/
function float64sAreSorted(x:Array<StdTypes.Float>):Bool {
        final x = ([for (i in x) i] : stdgo.Slice<stdgo.GoFloat64>);
