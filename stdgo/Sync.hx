...
abstract Cond(stdgo._internal.sync.Sync.Cond) from stdgo._internal.sync.Sync.Cond to stdgo._internal.sync.Sync.Cond {
...
abstract T_noCopy(stdgo._internal.sync.Sync.T_noCopy) from stdgo._internal.sync.Sync.T_noCopy to stdgo._internal.sync.Sync.T_noCopy {
    public function new() this = new stdgo._internal.sync.Sync.T_noCopy();
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
abstract Map_(stdgo._internal.sync.Sync.Map_) from stdgo._internal.sync.Sync.Map_ to stdgo._internal.sync.Sync.Map_ {
...
abstract T_readOnly(stdgo._internal.sync.Sync.T_readOnly) from stdgo._internal.sync.Sync.T_readOnly to stdgo._internal.sync.Sync.T_readOnly {
...
abstract T_entry(stdgo._internal.sync.Sync.T_entry) from stdgo._internal.sync.Sync.T_entry to stdgo._internal.sync.Sync.T_entry {
...
abstract Mutex(stdgo._internal.sync.Sync.Mutex) from stdgo._internal.sync.Sync.Mutex to stdgo._internal.sync.Sync.Mutex {
...
abstract Once(stdgo._internal.sync.Sync.Once) from stdgo._internal.sync.Sync.Once to stdgo._internal.sync.Sync.Once {
...
abstract Pool(stdgo._internal.sync.Sync.Pool) from stdgo._internal.sync.Sync.Pool to stdgo._internal.sync.Sync.Pool {
    public var _noCopy(get, set) : stdgo._internal.sync.Sync.T_noCopy;
    function get__noCopy():stdgo._internal.sync.Sync.T_noCopy return this._noCopy;
    function set__noCopy(v:stdgo._internal.sync.Sync.T_noCopy):stdgo._internal.sync.Sync.T_noCopy {
        this._noCopy = v;
...
abstract T_poolLocalInternal(stdgo._internal.sync.Sync.T_poolLocalInternal) from stdgo._internal.sync.Sync.T_poolLocalInternal to stdgo._internal.sync.Sync.T_poolLocalInternal {
...
abstract T_poolLocal(stdgo._internal.sync.Sync.T_poolLocal) from stdgo._internal.sync.Sync.T_poolLocal to stdgo._internal.sync.Sync.T_poolLocal {
...
abstract T_poolDequeue(stdgo._internal.sync.Sync.T_poolDequeue) from stdgo._internal.sync.Sync.T_poolDequeue to stdgo._internal.sync.Sync.T_poolDequeue {
...
abstract T_eface(stdgo._internal.sync.Sync.T_eface) from stdgo._internal.sync.Sync.T_eface to stdgo._internal.sync.Sync.T_eface {
...
abstract T_poolChain(stdgo._internal.sync.Sync.T_poolChain) from stdgo._internal.sync.Sync.T_poolChain to stdgo._internal.sync.Sync.T_poolChain {
...
abstract T_poolChainElt(stdgo._internal.sync.Sync.T_poolChainElt) from stdgo._internal.sync.Sync.T_poolChainElt to stdgo._internal.sync.Sync.T_poolChainElt {
...
abstract T_notifyList(stdgo._internal.sync.Sync.T_notifyList) from stdgo._internal.sync.Sync.T_notifyList to stdgo._internal.sync.Sync.T_notifyList {
...
abstract RWMutex(stdgo._internal.sync.Sync.RWMutex) from stdgo._internal.sync.Sync.RWMutex to stdgo._internal.sync.Sync.RWMutex {
...
abstract WaitGroup(stdgo._internal.sync.Sync.WaitGroup) from stdgo._internal.sync.Sync.WaitGroup to stdgo._internal.sync.Sync.WaitGroup {
    public var _noCopy(get, set) : stdgo._internal.sync.Sync.T_noCopy;
    function get__noCopy():stdgo._internal.sync.Sync.T_noCopy return this._noCopy;
    function set__noCopy(v:stdgo._internal.sync.Sync.T_noCopy):stdgo._internal.sync.Sync.T_noCopy {
        this._noCopy = v;
