...
class T_headerSTAR_asInterface {
    @:keep
    public dynamic function _trailer():stdgo.Slice<stdgo.GoUInt8> return __self__.value._trailer();
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.archive.tar.Tar_T_headerSTAR.T_headerSTAR>;
