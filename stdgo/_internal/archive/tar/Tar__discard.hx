...
function _discard(_r:stdgo._internal.io.Io_reader.Reader, _n:stdgo.GoInt64):stdgo.Error {
        ...
        //"file:///home/runner/.go/go1.21.3/src/archive/tar/reader.go#L861"
        {
            var __tmp__ = try {
            ...
            if ((_ok && (_n > (1i64 : stdgo.GoInt64) : Bool) : Bool)) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/archive/tar/reader.go#L867"
                if (((_pos1 >= (0i64 : stdgo.GoInt64) : Bool) && (_err == null) : Bool)) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/archive/tar/reader.go#L870"
                    if (((_pos2 < (0i64 : stdgo.GoInt64) : Bool) || (_err != null) : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/archive/tar/reader.go#L871"
                        return _err;
                    };
        ...
        //"file:///home/runner/.go/go1.21.3/src/archive/tar/reader.go#L878"
        ...
        //"file:///home/runner/.go/go1.21.3/src/archive/tar/reader.go#L881"
        return _err;
    }
