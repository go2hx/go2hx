...
var _nsecs = __1, _secs = __0;
        if (_nsecs == ((0 : stdgo.GoInt))) {
            return stdgo._internal.strconv.Strconv_formatInt.formatInt(_secs, (10 : stdgo.GoInt))?.__copy__();
        };
        ...
        return stdgo._internal.strings.Strings_trimRight.trimRight(stdgo._internal.fmt.Fmt_sprintf.sprintf(("%s%d.%09d" : stdgo.GoString), stdgo.Go.toInterface(_sign), stdgo.Go.toInterface(_secs), stdgo.Go.toInterface(_nsecs))?.__copy__(), ("0" : stdgo.GoString))?.__copy__();
    }
