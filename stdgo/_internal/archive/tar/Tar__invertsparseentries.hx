...
function _invertSparseEntries(_src:stdgo.Slice<stdgo._internal.archive.tar.Tar_t_sparseentry.T_sparseEntry>, _size:stdgo.GoInt64):stdgo.Slice<stdgo._internal.archive.tar.Tar_t_sparseentry.T_sparseEntry> {
        ...
        //"file:///home/runner/.go/go1.21.3/src/archive/tar/common.go#L311"
        for (__1 => _cur in _src) {
            //"file:///home/runner/.go/go1.21.3/src/archive/tar/common.go#L312"
            if (_cur.length_ == ((0i64 : stdgo.GoInt64))) {
                //"file:///home/runner/.go/go1.21.3/src/archive/tar/common.go#L313"
                continue;
            };
            _pre.length_ = (_cur.offset - _pre.offset : stdgo.GoInt64);
            //"file:///home/runner/.go/go1.21.3/src/archive/tar/common.go#L316"
            if ((_pre.length_ > (0i64 : stdgo.GoInt64) : Bool)) {
                _dst = (_dst.__append__(_pre?.__copy__()) : stdgo.Slice<stdgo._internal.archive.tar.Tar_t_sparseentry.T_sparseEntry>);
            };
            _pre.offset = _cur._endOffset();
        };
        _pre.length_ = (_size - _pre.offset : stdgo.GoInt64);
        //"file:///home/runner/.go/go1.21.3/src/archive/tar/common.go#L322"
        return (_dst.__append__(_pre?.__copy__()) : stdgo.Slice<stdgo._internal.archive.tar.Tar_t_sparseentry.T_sparseEntry>);
    }
