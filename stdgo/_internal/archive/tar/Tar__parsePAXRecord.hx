...
function _parsePAXRecord(_s:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : stdgo.GoString; var _2 : stdgo.GoString; var _3 : stdgo.Error; } {
        ...
        if (!_ok) {
            return { _0 : _k = stdgo.Go.str()?.__copy__(), _1 : _v = stdgo.Go.str()?.__copy__(), _2 : _r = _s?.__copy__(), _3 : _err = stdgo._internal.archive.tar.Tar_errHeader.errHeader };
        };
...
var _rem = __2, _nl = __1, _rec = __0;
        ...
        return { _0 : _k = _k?.__copy__(), _1 : _v = _v?.__copy__(), _2 : _r = _rem?.__copy__(), _3 : _err = (null : stdgo.Error) };
    }
