...
function _readGNUSparseMap0x1(_paxHdrs:stdgo.GoMap<stdgo.GoString, stdgo.GoString>):{ var _0 : stdgo._internal.archive.tar.Tar_t_sparsedatas.T_sparseDatas; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/archive/tar/reader.go#L596"
        if (((_err != null || (_numEntries < (0i64 : stdgo.GoInt64) : Bool) : Bool) || ((((2i64 : stdgo.GoInt64) * _numEntries : stdgo.GoInt64) : stdgo.GoInt) < (_numEntries : stdgo.GoInt) : Bool) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/archive/tar/reader.go#L597"
        ...
        //"file:///home/runner/.go/go1.21.3/src/archive/tar/reader.go#L602"
        ...
        //"file:///home/runner/.go/go1.21.3/src/archive/tar/reader.go#L605"
        if ((_sparseMap.length : stdgo.GoInt64) != (((2i64 : stdgo.GoInt64) * _numEntries : stdgo.GoInt64))) {
            //"file:///home/runner/.go/go1.21.3/src/archive/tar/reader.go#L606"
            return { _0 : null, _1 : stdgo._internal.archive.tar.Tar_errheader.errHeader };
        };
        ...
        //"file:///home/runner/.go/go1.21.3/src/archive/tar/reader.go#L612"
        while (((_sparseMap.length) >= (2 : stdgo.GoInt) : Bool)) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/archive/tar/reader.go#L615"
            if (((_err1 != null) || (_err2 != null) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/archive/tar/reader.go#L616"
                return { _0 : null, _1 : stdgo._internal.archive.tar.Tar_errheader.errHeader };
            };
        ...
        //"file:///home/runner/.go/go1.21.3/src/archive/tar/reader.go#L621"
