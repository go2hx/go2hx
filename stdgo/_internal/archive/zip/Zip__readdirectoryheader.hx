            ...
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L358"
                    {
                        ...
                        if (_err_1 != null) {
                            _gotoNext = 3869760i64;
                        } else {
                            _gotoNext = 3869779i64;
                        };
                    };
                } else if (__value__ == (3869760i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L359"
                    return _err_1;
                    _gotoNext = 3869779i64;
                } else if (__value__ == (3869779i64)) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L383"
                    {
                        ...
                        if (_err_8 != null) {
                            _gotoNext = 3870557i64;
                        } else {
                            _gotoNext = 3870576i64;
                        };
                    };
                } else if (__value__ == (3870557i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L384"
                    return _err_8;
                    _gotoNext = 3870576i64;
                } else if (__value__ == (3870576i64)) {
                    ...
                    _gotoNext = 3871745i64;
                } else if (__value__ == (3871745i64)) {
                    ...
                    _gotoNext = 3871759i64;
                } else if (__value__ == (3871759i64)) {
                    //"file://#L0"
                    if (!_parseExtrasBreak && (((_extra_17.length) >= (4 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 3871807i64;
                    } else {
                        _gotoNext = 3873926i64;
                    };
                } else if (__value__ == (3871807i64)) {
                    ...
                    if (((_fieldBuf_20.length) < _attrSize_22 : Bool)) {
                        _gotoNext = 3872953i64;
                    } else {
                        _gotoNext = 3872991i64;
                    };
                } else if (__value__ == (3872953i64)) {
                    _gotoNext = 3871759i64;
                } else if (__value__ == (3872991i64)) {
                    ...
                    if (((_attrTag_21 != (1 : stdgo.GoUInt16)) || (_attrSize_22 != (24 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 3873063i64;
                    } else {
                        _gotoNext = 3873122i64;
                    };
                } else if (__value__ == (3873063i64)) {
                    0i64;
                    _gotoNext = 3872794i64;
                } else if (__value__ == (3873122i64)) {
                    ...
                    _gotoNext = 3872794i64;
                } else if (__value__ == (3873477i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L478"
                    if (((_fieldBuf_20.length) < (8 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3873539i64;
                    } else {
                        _gotoNext = 3873574i64;
                    };
                } else if (__value__ == (3873539i64)) {
                    _gotoNext = 3871759i64;
                } else if (__value__ == (3873574i64)) {
                    ...
                    if ((((_fieldBuf_20.length) < (5 : stdgo.GoInt) : Bool) || ((_fieldBuf_20._uint8() & (1 : stdgo.GoUInt8) : stdgo.GoUInt8) == (0 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 3873792i64;
                    } else {
                        _gotoNext = 3873827i64;
                    };
                } else if (__value__ == (3873792i64)) {
                    _gotoNext = 3871759i64;
                } else if (__value__ == (3873827i64)) {
                    ...
                    if (!_modified_16.isZero()) {
                        _gotoNext = 3874042i64;
                    } else {
                        _gotoNext = 3875180i64;
                    };
                } else if (__value__ == (3874042i64)) {
                    ...
                    if ((((@:checkr _f ?? throw "null pointer dereference").fileHeader.modifiedTime != (0 : stdgo.GoUInt16)) || ((@:checkr _f ?? throw "null pointer dereference").fileHeader.modifiedDate != (0 : stdgo.GoUInt16)) : Bool)) {
                        _gotoNext = 3874578i64;
                    } else {
                        _gotoNext = 3875180i64;
                    };
                } else if (__value__ == (3874578i64)) {
