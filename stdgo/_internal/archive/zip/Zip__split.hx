...
function _split(_name:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : stdgo.GoString; var _2 : Bool; } {
        ...
        if ((_i < (0 : stdgo.GoInt) : Bool)) {
            return { _0 : ("." : stdgo.GoString), _1 : _name?.__copy__(), _2 : _isDir };
        };
        return { _0 : (_name.__slice__(0, _i) : stdgo.GoString)?.__copy__(), _1 : (_name.__slice__((_i + (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.GoString)?.__copy__(), _2 : _isDir };
    }
