...
@:keep @:allow(stdgo._internal.archive.zip.Zip.File_asInterface) class File_static_extension {
    ...
    static public function _findBodyOffset( _f:stdgo.Ref<stdgo._internal.archive.zip.Zip_file.File>):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L340"
        {
            ...
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L341"
        ...
        //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L344"
        {
            var _sig = (_b._uint32() : stdgo.GoUInt32);
            if (_sig != ((67324752u32 : stdgo.GoUInt32))) {
                //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L345"
        ...
        //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L350"
    ...
    static public function openRaw( _f:stdgo.Ref<stdgo._internal.archive.zip.Zip_file.File>):{ var _0 : stdgo._internal.io.Io_reader.Reader; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L262"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L263"
        ...
        //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L266"
    ...
    static public function open( _f:stdgo.Ref<stdgo._internal.archive.zip.Zip_file.File>):{ var _0 : stdgo._internal.io.Io_readcloser.ReadCloser; var _1 : stdgo.Error; } {
        @:recv var _f:stdgo.Ref<stdgo._internal.archive.zip.Zip_file.File> = _f;
        var __tmp__ = _f._findBodyOffset(), _bodyOffset:stdgo.GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L219"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L220"
            return { _0 : (null : stdgo._internal.io.Io_readcloser.ReadCloser), _1 : _err };
        };
        //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L222"
        if (stdgo._internal.strings.Strings_hassuffix.hasSuffix((@:checkr _f ?? throw "null pointer dereference").fileHeader.name?.__copy__(), ("/" : stdgo.GoString))) {
            //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L232"
            if ((@:checkr _f ?? throw "null pointer dereference").fileHeader.uncompressedSize64 != ((0i64 : stdgo.GoUInt64))) {
                //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L233"
                ...
                //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L235"
        ...
        var _dcomp = ((@:checkr _f ?? throw "null pointer dereference")._zip._decompressor((@:checkr _f ?? throw "null pointer dereference").fileHeader.method) : stdgo._internal.archive.zip.Zip_decompressor.Decompressor);
        //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L241"
        if (_dcomp == null) {
            //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L242"
        ...
        //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L246"
        ...
        //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L255"
    ...
    static public function dataOffset( _f:stdgo.Ref<stdgo._internal.archive.zip.Zip_file.File>):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } {
        ...
        var __tmp__ = _f._findBodyOffset(), _bodyOffset:stdgo.GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L209"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L210"
            return { _0 : _offset, _1 : _err };
        };
        //"file:///home/runner/.go/go1.21.3/src/archive/zip/reader.go#L212"
        return {
