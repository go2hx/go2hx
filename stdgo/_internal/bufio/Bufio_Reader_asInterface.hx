...
class Reader_asInterface {
    ...
    @:keep
    public dynamic function peek(_n:stdgo.GoInt):{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } return __self__.value.peek(_n);
    @:keep
    ...
    @:keep
    public dynamic function reset(_r:stdgo._internal.io.Io_Reader.Reader):Void __self__.value.reset(_r);
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.bufio.Bufio_Reader.Reader>;
