...
function scanLines(_data:stdgo.Slice<stdgo.GoUInt8>, _atEOF:Bool):{ var _0 : stdgo.GoInt; var _1 : stdgo.Slice<stdgo.GoUInt8>; var _2 : stdgo.Error; } {
        ...
        };
        {
            ...
            if ((_i >= (0 : stdgo.GoInt) : Bool)) {
                return { _0 : (_i + (1 : stdgo.GoInt) : stdgo.GoInt), _1 : stdgo._internal.bufio.Bufio__dropCR._dropCR((_data.__slice__((0 : stdgo.GoInt), _i) : stdgo.Slice<stdgo.GoUInt8>)), _2 : (null : stdgo.Error) };
            };
        };
        if (_atEOF) {
            return { _0 : (_data.length), _1 : stdgo._internal.bufio.Bufio__dropCR._dropCR(_data), _2 : (null : stdgo.Error) };
        };
        return { _0 : (0 : stdgo.GoInt), _1 : (null : stdgo.Slice<stdgo.GoUInt8>), _2 : (null : stdgo.Error) };
    }
