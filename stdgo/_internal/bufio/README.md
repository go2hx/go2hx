...
[30;41m ERROR [0m [31m(macro) [0mstdgo/_internal/errors/Errors.hx:70: characters 16-228
  ...
  70 | [2m        return [0m[1mstdgo.Go.asInterface((stdgo.Go.setRef((new stdgo._internal.errors.Errors.T_errorString(_text?.__copy__()) : stdgo._internal.errors.Errors.T_errorString)) : stdgo.Ref<stdgo._internal.errors.Errors.T_errorString>))[0m[2m;[0m
     ...
     [30;41m -> [0m stdgo/_internal/bufio/Bufio.hx:369: characters 19-58

       369 | [2m            throw [0m[1mstdgo.Go.toInterface(_errNegativeWrite)[0m[2m;[0m
           |                   [31m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m
           | Called from here
     ...
     [30;41m -> [0m stdgo/_internal/bufio/Bufio.hx:39: characters 45-71

        39 | [2m    public function __underlying__() return [0m[1mstdgo.Go.toInterface(this)[0m[2m;[0m
           |                                             [31m^^^^^^^^^^^^^^^^^^^^^^^^^^[0m
           | Called from here
