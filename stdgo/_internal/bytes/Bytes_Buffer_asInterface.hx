...
class Buffer_asInterface {
    ...
    @:keep
    public dynamic function _readSlice(_delim:stdgo.GoUInt8):{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } return __self__.value._readSlice(_delim);
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.bytes.Bytes_Buffer.Buffer>;
