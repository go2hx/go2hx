...
class Reader_asInterface {
    @:keep
    @:tdfield
    public dynamic function reset(_b:stdgo.Slice<stdgo.GoUInt8>):Void @:_0 __self__.value.reset(_b);
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.bytes.Bytes_ReaderPointer.ReaderPointer;
