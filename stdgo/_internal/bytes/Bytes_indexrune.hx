        ...
        if ((((0 : stdgo.GoInt32) <= _r : Bool) && (_r < (128 : stdgo.GoInt32) : Bool) : Bool)) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/bytes/bytes.go#L165"
            {
                ...
                while ((_i < (_s.length) : Bool)) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/bytes/bytes.go#L167"
                    if (_r1 == ((65533 : stdgo.GoInt32))) {
                        //"file:///home/runner/.go/go1.21.3/src/bytes/bytes.go#L168"
                        return _i;
                    };
                    _i = (_i + (_n) : stdgo.GoInt);
                };
            };
            //"file:///home/runner/.go/go1.21.3/src/bytes/bytes.go#L172"
            return (-1 : stdgo.GoInt);
        } else if (!stdgo._internal.unicode.utf8.Utf8_validrune.validRune(_r)) {
            //"file:///home/runner/.go/go1.21.3/src/bytes/bytes.go#L174"
            return (-1 : stdgo.GoInt);
        } else {
            ...
            //"file:///home/runner/.go/go1.21.3/src/bytes/bytes.go#L178"
