        ...
        var _testCountWindow:(stdgo.GoInt, stdgo.GoInt) -> Void = function(_i:stdgo.GoInt, _window:stdgo.GoInt):Void {
            {
                ...
                stdgo.Go.cfor((_j < _window : Bool), _j++, {
                    ...
                    var _p:stdgo.GoInt = count((_b.__slice__(_i, (_i + _window : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>), (new stdgo.Slice<stdgo.GoUInt8>(1, 1, ...[(100 : stdgo.GoUInt8)]).__setNumber32__() : stdgo.Slice<stdgo.GoUInt8>));
...
(128 : stdgo.GoInt)]).__setNumber32__() : stdgo.Slice<stdgo.GoInt>);
        {
            ...
            stdgo.Go.cfor((_i <= (_b.length) : Bool), _i++, {
                for (__0 => _window in _windows) {
                    ...
                    var _p:stdgo.GoInt = count((_b.__slice__(_i, (_i + _window : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>), (new stdgo.Slice<stdgo.GoUInt8>(1, 1, ...[(0 : stdgo.GoUInt8)]).__setNumber32__() : stdgo.Slice<stdgo.GoUInt8>));
                    if (_p != ((0 : stdgo.GoInt))) {
...
function benchmarkCountSingle(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        _benchBytes(_b, _indexSizes, function(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>, _n:stdgo.GoInt):Void {
            ...
            var _expect:stdgo.GoInt = ((((_buf.length) + ((_step - (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.GoInt)) / _step : stdgo.GoInt);
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
                    var _j:stdgo.GoInt = count(_buf, (new stdgo.Slice<stdgo.GoUInt8>(1, 1, ...[(1 : stdgo.GoUInt8)]).__setNumber32__() : stdgo.Slice<stdgo.GoUInt8>));
                    if (_j != (_expect)) {
