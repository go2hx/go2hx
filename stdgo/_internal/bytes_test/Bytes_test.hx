...
var titleTests : stdgo.Slice<stdgo._internal.bytes_test.Bytes_test.TitleTest> = (new stdgo.Slice<stdgo._internal.bytes_test.Bytes_test.TitleTest>(9, 9, ...[(new stdgo._internal.bytes_test.Bytes_test.TitleTest(stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo._internal.bytes_test.Bytes_test.TitleTest), (new stdgo._internal.bytes_test.Bytes_test.TitleTest(("a" : stdgo.GoString), ("A" : stdgo.GoString)) : stdgo._internal.bytes_test.Bytes_test.TitleTest), (new stdgo._internal.bytes_test.Bytes_test.TitleTest((" aaa aaa aaa " : stdgo.GoString), (" Aaa Aaa Aaa " : stdgo.GoString)) : stdgo._internal.bytes_test.Bytes_test.TitleTest), (new stdgo._internal.bytes_test.Bytes_test.TitleTest((" Aaa Aaa Aaa " : stdgo.GoString), (" Aaa Aaa Aaa " : stdgo.GoString)) : stdgo._internal.bytes_test.Bytes_test.TitleTest), (new stdgo._internal.bytes_test.Bytes_test.TitleTest(("123a456" : stdgo.GoString), ("123a456" : stdgo.GoString)) : stdgo._internal.bytes_test.Bytes_test.TitleTest), (new stdgo._internal.bytes_test.Bytes_test.TitleTest(("double-blind" : stdgo.GoString), ("Double-Blind" : stdgo.GoString)) : stdgo._internal.bytes_test.Bytes_test.TitleTest), (new stdgo._internal.bytes_test.Bytes_test.TitleTest(("ÿøû" : stdgo.GoString), ("Ÿøû" : stdgo.GoString)) : stdgo._internal.bytes_test.Bytes_test.TitleTest), (new stdgo._internal.bytes_test.Bytes_test.TitleTest(("with_underscore" : stdgo.GoString), ("With_underscore" : stdgo.GoString)) : stdgo._internal.bytes_test.Bytes_test.TitleTest), (new stdgo._internal.bytes_test.Bytes_test.TitleTest(("unicode \u2028 line separator" : stdgo.GoString), ("Unicode \u2028 Line Separator" : stdgo.GoString)) : stdgo._internal.bytes_test.Bytes_test.TitleTest)]) : stdgo.Slice<stdgo._internal.bytes_test.Bytes_test.TitleTest>);
...
function benchmarkEqual(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        ...
        var _sizes = (new stdgo.Slice<stdgo.GoInt>(10, 10, ...[(1 : stdgo.GoInt), (6 : stdgo.GoInt), (9 : stdgo.GoInt), (15 : stdgo.GoInt), (16 : stdgo.GoInt), (20 : stdgo.GoInt), (32 : stdgo.GoInt), (4096 : stdgo.GoInt), (4194304 : stdgo.GoInt), (67108864 : stdgo.GoInt)]) : stdgo.Slice<stdgo.GoInt>);
...
function _makeBenchInputHard():stdgo.Slice<stdgo.GoByte> {
        var _tokens = (new stdgo.GoArray<stdgo.GoString>(10, 10, ...[("<a>" : stdgo.GoString), ("<p>" : stdgo.GoString), ("<b>" : stdgo.GoString), ("<strong>" : stdgo.GoString), ("</a>" : stdgo.GoString), ("</p>" : stdgo.GoString), ("</b>" : stdgo.GoString), ("</strong>" : stdgo.GoString), ("hello" : stdgo.GoString), ("world" : stdgo.GoString)]) : stdgo.GoArray<stdgo.GoString>);
...
function testReader(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _tests = (new stdgo.Slice<T__struct_15>(9, 9, ...[({ _off : (0i64 : stdgo.GoInt64), _seek : (0 : stdgo.GoInt), _n : (20 : stdgo.GoInt), _want : ("0123456789" : stdgo.GoString), _wantpos : (0 : stdgo.GoInt64), _readerr : (null : stdgo.Error), _seekerr : ("" : stdgo.GoString) } : T__struct_15), ({ _off : (1i64 : stdgo.GoInt64), _seek : (0 : stdgo.GoInt), _n : (1 : stdgo.GoInt), _want : ("1" : stdgo.GoString), _wantpos : (0 : stdgo.GoInt64), _readerr : (null : stdgo.Error), _seekerr : ("" : stdgo.GoString) } : T__struct_15), ({ _off : (1i64 : stdgo.GoInt64), _seek : (1 : stdgo.GoInt), _n : (2 : stdgo.GoInt), _want : ("34" : stdgo.GoString), _wantpos : (3i64 : stdgo.GoInt64), _readerr : (null : stdgo.Error), _seekerr : ("" : stdgo.GoString) } : T__struct_15), ({ _off : (-1i64 : stdgo.GoInt64), _seek : (0 : stdgo.GoInt), _n : (0 : stdgo.GoInt), _want : ("" : stdgo.GoString), _wantpos : (0 : stdgo.GoInt64), _readerr : (null : stdgo.Error), _seekerr : ("bytes.Reader.Seek: negative position" : stdgo.GoString) } : T__struct_15), ({ _off : (8589934592i64 : stdgo.GoInt64), _seek : (0 : stdgo.GoInt), _n : (0 : stdgo.GoInt), _want : ("" : stdgo.GoString), _wantpos : (8589934592i64 : stdgo.GoInt64), _readerr : stdgo._internal.io.Io.eof, _seekerr : ("" : stdgo.GoString) } : T__struct_15), ({ _off : (1i64 : stdgo.GoInt64), _seek : (1 : stdgo.GoInt), _n : (0 : stdgo.GoInt), _want : ("" : stdgo.GoString), _wantpos : (8589934593i64 : stdgo.GoInt64), _readerr : stdgo._internal.io.Io.eof, _seekerr : ("" : stdgo.GoString) } : T__struct_15), ({ _off : (0 : stdgo.GoInt64), _seek : (0 : stdgo.GoInt), _n : (5 : stdgo.GoInt), _want : ("01234" : stdgo.GoString), _wantpos : (0 : stdgo.GoInt64), _readerr : (null : stdgo.Error), _seekerr : ("" : stdgo.GoString) } : T__struct_15), ({ _off : (0 : stdgo.GoInt64), _seek : (1 : stdgo.GoInt), _n : (5 : stdgo.GoInt), _want : ("56789" : stdgo.GoString), _wantpos : (0 : stdgo.GoInt64), _readerr : (null : stdgo.Error), _seekerr : ("" : stdgo.GoString) } : T__struct_15), ({ _off : (-1i64 : stdgo.GoInt64), _seek : (2 : stdgo.GoInt), _n : (1 : stdgo.GoInt), _want : ("9" : stdgo.GoString), _wantpos : (9i64 : stdgo.GoInt64), _readerr : (null : stdgo.Error), _seekerr : ("" : stdgo.GoString) } : T__struct_15)]) : stdgo.Slice<T__struct_15>);
        for (_i => _tt in _tests) {
