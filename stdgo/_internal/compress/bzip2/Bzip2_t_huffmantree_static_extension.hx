...
@:keep @:allow(stdgo._internal.compress.bzip2.Bzip2.T_huffmanTree_asInterface) class T_huffmanTree_static_extension {
    ...
    static public function decode( _t:stdgo.Ref<stdgo._internal.compress.bzip2.Bzip2_t_huffmantree.T_huffmanTree>, _br:stdgo.Ref<stdgo._internal.compress.bzip2.Bzip2_t_bitreader.T_bitReader>):stdgo.GoUInt16 {
        ...
        //"file:///home/runner/.go/go1.21.3/src/compress/bzip2/huffman.go#L39"
        while (true) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/compress/bzip2/huffman.go#L43"
            if (((@:checkr _br ?? throw "null pointer dereference")._bits > (0u32 : stdgo.GoUInt) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/compress/bzip2/huffman.go#L45"
...
var _r = __1, _l = __0;
            //"file:///home/runner/.go/go1.21.3/src/compress/bzip2/huffman.go#L58"
            if (_bit == ((1 : stdgo.GoUInt16))) {
                _nodeIndex = _l;
            } else {
                _nodeIndex = _r;
            };
            //"file:///home/runner/.go/go1.21.3/src/compress/bzip2/huffman.go#L64"
...
var _r = __1, _l = __0;
                //"file:///home/runner/.go/go1.21.3/src/compress/bzip2/huffman.go#L68"
                if (_bit == ((1 : stdgo.GoUInt16))) {
                    _v = _l;
                } else {
                    _v = _r;
                };
                //"file:///home/runner/.go/go1.21.3/src/compress/bzip2/huffman.go#L73"
                return _v;
            };
        };
    }
