...
function testReader(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        var _vectors:stdgo.Slice<stdgo._internal.compress.bzip2.Bzip2_T__struct_0.T__struct_0> = (new stdgo.Slice<stdgo._internal.compress.bzip2.Bzip2_T__struct_0.T__struct_0>(12, 12, ...[
