...
function testBitReader(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/compress/bzip2/bzip2_test.go#L170"
        for (_i => _v in _vectors) {
            var _val = (_br.readBits(_v._nbits) : stdgo.GoInt);
            //"file:///home/runner/.go/go1.21.3/src/compress/bzip2/bzip2_test.go#L172"
            {
                var _fail = (_br._err != null : Bool);
                if (_fail != (_v._fail)) {
                    //"file:///home/runner/.go/go1.21.3/src/compress/bzip2/bzip2_test.go#L173"
                    if (_fail) {
                        //"file:///home/runner/.go/go1.21.3/src/compress/bzip2/bzip2_test.go#L174"
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/compress/bzip2/bzip2_test.go#L176"
                        _t.errorf(("test %d, unexpected success: ReadBits(%d) = nil" : stdgo.GoString), stdgo.Go.toInterface(_i), stdgo.Go.toInterface(_v._nbits));
                    };
                };
            };
            //"file:///home/runner/.go/go1.21.3/src/compress/bzip2/bzip2_test.go#L179"
            if ((!_v._fail && (_val != _v._value) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/compress/bzip2/bzip2_test.go#L180"
