...
function testMTF(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/compress/bzip2/bzip2_test.go#L198"
        for (_i => _v in _vectors) {
            var _sym = (_mtf.decode(_v._idx) : stdgo.GoUInt8);
            //"file:///home/runner/.go/go1.21.3/src/compress/bzip2/bzip2_test.go#L200"
            _t.log(stdgo.Go.toInterface(stdgo.Go.asInterface(_mtf)));
            //"file:///home/runner/.go/go1.21.3/src/compress/bzip2/bzip2_test.go#L201"
            if (_sym != (_v._sym)) {
                //"file:///home/runner/.go/go1.21.3/src/compress/bzip2/bzip2_test.go#L202"
