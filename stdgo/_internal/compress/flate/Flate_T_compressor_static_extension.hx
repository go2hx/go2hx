        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _lookahead_3681876 = (_d._windowEnd - _d._index : stdgo.GoInt);
                    ...
                    _hash_3682558 = stdgo._internal.compress.flate.Flate__hash4._hash4((_d._window.__slice__(_d._index, (_d._index + (4 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                    _hh_3682619 = stdgo.Go.pointer(_d._hashHead[((_hash_3682558 & (131071u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)]);
                    _d._chainHead = (_hh_3682619.value : stdgo.GoInt);
                    _d._hashPrev[(_d._index & (32767 : stdgo.GoInt) : stdgo.GoInt)] = (_d._chainHead : stdgo.GoUInt32);
                    _hh_3682619.value = ((_d._index + _d._hashOffset : stdgo.GoInt) : stdgo.GoUInt32);
                    _gotoNext = 3682780i32;
                } else if (__value__ == (3682780i32)) {
                    _prevLength_3682780 = _d._length;
                    _prevOffset_3682805 = _d._offset;
                    _d._length = (3 : stdgo.GoInt);
                    _d._offset = (0 : stdgo.GoInt);
                    _minIndex_3682877 = (_d._index - (32768 : stdgo.GoInt) : stdgo.GoInt);
                    ...
                    if ((((_d._chainHead - _d._hashOffset : stdgo.GoInt) >= _minIndex_3682877 : Bool) && (((_d._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt)) && (_lookahead_3681876 > (3 : stdgo.GoInt) : Bool) : Bool) || ((_d._compressionLevel._fastSkipHashing == ((2147483647 : stdgo.GoInt)) && (_lookahead_3681876 > _prevLength_3682780 : Bool) : Bool) && (_prevLength_3682780 < _d._compressionLevel._lazy : Bool) : Bool) : Bool)) : Bool)) {
                    ...
                    {
                        {
                            var __tmp__ = _d._findMatch(_d._index, (_d._chainHead - _d._hashOffset : stdgo.GoInt), (3 : stdgo.GoInt), _lookahead_3681876);
                            _newLength_3683159 = __tmp__._0;
                            _newOffset_3683170 = __tmp__._1;
                            _ok_3683181 = __tmp__._2;
                        };
                        if (_ok_3683181) {
                    ...
                    _d._length = _newLength_3683159;
                    _d._offset = _newOffset_3683170;
                    _gotoNext = 3683330i32;
                } else if (__value__ == (3683330i32)) {
                    if (((_d._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt)) && (_d._length >= (4 : stdgo.GoInt) : Bool) : Bool) || ((_d._compressionLevel._fastSkipHashing == ((2147483647 : stdgo.GoInt)) && (_prevLength_3682780 >= (4 : stdgo.GoInt) : Bool) : Bool) && (_d._length <= _prevLength_3682780 : Bool) : Bool) : Bool)) {
                    ...
                    _gotoNext = 3683768i32;
                    _d._tokens = (_d._tokens.__append__(stdgo._internal.compress.flate.Flate__matchToken._matchToken(((_prevLength_3682780 - (3 : stdgo.GoInt) : stdgo.GoInt) : stdgo.GoUInt32), ((_prevOffset_3682805 - (1 : stdgo.GoInt) : stdgo.GoInt) : stdgo.GoUInt32))));
                    var __blank__ = 0i32;
                    _gotoNext = 3684116i32;
                    ...
                    _newIndex_3684159 = (_d._index + _d._length : stdgo.GoInt);
                    _gotoNext = 3684311i32;
                } else if (__value__ == (3684258i32)) {
                    _gotoNext = 3684258i32;
                    _newIndex_3684159 = ((_d._index + _prevLength_3682780 : stdgo.GoInt) - (1 : stdgo.GoInt) : stdgo.GoInt);
                    var __blank__ = 0i32;
                    _gotoNext = 3684311i32;
                } else if (__value__ == (3684311i32)) {
                    _index_3684311 = _d._index;
                    _index_3684311++;
                    ...
                    if ((_index_3684311 < _d._maxInsertIndex : Bool)) {
                        _gotoNext = 3684406i32;
                    } else {
                        _gotoNext = 3684363i32;
                    };
                } else if (__value__ == (3684406i32)) {
                    _hash_3684414 = stdgo._internal.compress.flate.Flate__hash4._hash4((_d._window.__slice__(_index_3684311, (_index_3684311 + (4 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                    _hh_3684577 = stdgo.Go.pointer(_d._hashHead[((_hash_3684414 & (131071u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)]);
                    _d._hashPrev[(_index_3684311 & (32767 : stdgo.GoInt) : stdgo.GoInt)] = _hh_3684577.value;
                    _hh_3684577.value = ((_index_3684311 + _d._hashOffset : stdgo.GoInt) : stdgo.GoUInt32);
                    _gotoNext = 3684363i32;
                } else if (__value__ == (3684756i32)) {
                    _d._index = _index_3684311;
                    if (_d._compressionLevel._fastSkipHashing == ((2147483647 : stdgo.GoInt))) {
                    ...
                    _i_3685304 = (_d._index - (1 : stdgo.GoInt) : stdgo.GoInt);
                    if (_d._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt))) {
                    ...
                    _i_3685304 = _d._index;
                    _gotoNext = 3685388i32;
                } else if (__value__ == (3685388i32)) {
                    _d._tokens = (_d._tokens.__append__(stdgo._internal.compress.flate.Flate__literalToken._literalToken((_d._window[(_i_3685304 : stdgo.GoInt)] : stdgo.GoUInt32))));
                    if ((_d._tokens.length) == ((16384 : stdgo.GoInt))) {
                    ...
                    {
                        _d._err = _d._writeBlock(_d._tokens, (_i_3685304 + (1 : stdgo.GoInt) : stdgo.GoInt));
                        if (_d._err != null) {
