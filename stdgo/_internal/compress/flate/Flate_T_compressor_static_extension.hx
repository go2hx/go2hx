...
@:keep @:allow(stdgo._internal.compress.flate.Flate.T_compressor_asInterface) class T_compressor_static_extension {
    ...
    static public function _deflate( _d:stdgo.Ref<stdgo._internal.compress.flate.Flate_T_compressor.T_compressor>):Void {
        @:recv var _d:stdgo.Ref<stdgo._internal.compress.flate.Flate_T_compressor.T_compressor> = _d;
        var _newOffset_3683758:stdgo.GoInt = (0 : stdgo.GoInt);
        var _newLength_3683747:stdgo.GoInt = (0 : stdgo.GoInt);
        var _hash_3683146:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var loopBreak = false;
        var _newIndex_3684747:stdgo.GoInt = (0 : stdgo.GoInt);
        var _lookahead_3682464:stdgo.GoInt = (0 : stdgo.GoInt);
        var _index_3684899:stdgo.GoInt = (0 : stdgo.GoInt);
        var _ok_3683769:Bool = false;
        var _prevLength_3683368:stdgo.GoInt = (0 : stdgo.GoInt);
        var _hh_3683207:stdgo.Pointer<stdgo.GoUInt32> = (null : stdgo.Pointer<stdgo.GoUInt32>);
        var _i_3685892:stdgo.GoInt = (0 : stdgo.GoInt);
        var _hh_3685165:stdgo.Pointer<stdgo.GoUInt32> = (null : stdgo.Pointer<stdgo.GoUInt32>);
        var _hash_3685002:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _minIndex_3683465:stdgo.GoInt = (0 : stdgo.GoInt);
        var _prevOffset_3683393:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if (((((@:checkr _d ?? throw "null pointer dereference")._windowEnd - (@:checkr _d ?? throw "null pointer dereference")._index : stdgo.GoInt) < (262 : stdgo.GoInt) : Bool) && !(@:checkr _d ?? throw "null pointer dereference")._sync : Bool)) {
                        _gotoNext = 3682315i32;
                    } else {
                        _gotoNext = 3682331i32;
                    };
                } else if (__value__ == (3682315i32)) {
                    return;
                    _gotoNext = 3682331i32;
                } else if (__value__ == (3682331i32)) {
                    ...
                    _gotoNext = 3682386i32;
                } else if (__value__ == (3682386i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3682393i32;
                } else if (__value__ == (3682393i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3682397i32;
                    } else {
                        _gotoNext = 3686296i32;
                    };
                } else if (__value__ == (3682397i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._index > (@:checkr _d ?? throw "null pointer dereference")._windowEnd : Bool)) {
                        _gotoNext = 3682426i32;
                    } else {
                        _gotoNext = 3682464i32;
                    };
                } else if (__value__ == (3682426i32)) {
                    throw stdgo.Go.toInterface(("index > windowEnd" : stdgo.GoString));
                    _gotoNext = 3682464i32;
                } else if (__value__ == (3682464i32)) {
                    _lookahead_3682464 = ((@:checkr _d ?? throw "null pointer dereference")._windowEnd - (@:checkr _d ?? throw "null pointer dereference")._index : stdgo.GoInt);
                    if ((_lookahead_3682464 < (262 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3682546i32;
                    } else {
                        _gotoNext = 3683089i32;
                    };
                } else if (__value__ == (3682546i32)) {
                    if (!(@:checkr _d ?? throw "null pointer dereference")._sync) {
                        _gotoNext = 3682562i32;
                    } else {
                        _gotoNext = 3682587i32;
                    };
                } else if (__value__ == (3682562i32)) {
                    loopBreak = true;
                    _gotoNext = 3682393i32;
                } else if (__value__ == (3682587i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._index > (@:checkr _d ?? throw "null pointer dereference")._windowEnd : Bool)) {
                        _gotoNext = 3682612i32;
                    } else {
                        _gotoNext = 3682653i32;
                    };
                } else if (__value__ == (3682612i32)) {
                    throw stdgo.Go.toInterface(("index > windowEnd" : stdgo.GoString));
                    _gotoNext = 3682653i32;
                } else if (__value__ == (3682653i32)) {
                    if (_lookahead_3682464 == ((0 : stdgo.GoInt))) {
                    ...
                    if ((@:checkr _d ?? throw "null pointer dereference")._byteAvailable) {
                        _gotoNext = 3682738i32;
                    } else {
                        _gotoNext = 3682921i32;
                    };
                } else if (__value__ == (3682738i32)) {
                    ...
                    _gotoNext = 3682921i32;
                } else if (__value__ == (3682921i32)) {
                    if ((((@:checkr _d ?? throw "null pointer dereference")._tokens.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3682942i32;
                    } else {
                        _gotoNext = 3683067i32;
                    };
                } else if (__value__ == (3682942i32)) {
                    {
                        ...
                        if ((@:checkr _d ?? throw "null pointer dereference")._err != null) {
                            _gotoNext = 3683006i32;
                        } else {
                            _gotoNext = 3683033i32;
                        };
                    };
                } else if (__value__ == (3683006i32)) {
                    return;
                    _gotoNext = 3683033i32;
                } else if (__value__ == (3683033i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._tokens = ((@:checkr _d ?? throw "null pointer dereference")._tokens.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.compress.flate.Flate_T_token.T_token>);
                    _gotoNext = 3683067i32;
                } else if (__value__ == (3683067i32)) {
                    loopBreak = true;
                    _gotoNext = 3682393i32;
                } else if (__value__ == (3683089i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._index < (@:checkr _d ?? throw "null pointer dereference")._maxInsertIndex : Bool)) {
                        _gotoNext = 3683119i32;
                    } else {
                        _gotoNext = 3683368i32;
                    };
                } else if (__value__ == (3683119i32)) {
                    _hash_3683146 = stdgo._internal.compress.flate.Flate__hash4._hash4(((@:checkr _d ?? throw "null pointer dereference")._window.__slice__((@:checkr _d ?? throw "null pointer dereference")._index, ((@:checkr _d ?? throw "null pointer dereference")._index + (4 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                    _hh_3683207 = stdgo.Go.pointer((@:checkr _d ?? throw "null pointer dereference")._hashHead[((_hash_3683146 & (131071u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)]);
                    (@:checkr _d ?? throw "null pointer dereference")._chainHead = (_hh_3683207.value : stdgo.GoInt);
                    ...
                    _hh_3683207.value = (((@:checkr _d ?? throw "null pointer dereference")._index + (@:checkr _d ?? throw "null pointer dereference")._hashOffset : stdgo.GoInt) : stdgo.GoUInt32);
                    _gotoNext = 3683368i32;
                } else if (__value__ == (3683368i32)) {
                    _prevLength_3683368 = (@:checkr _d ?? throw "null pointer dereference")._length;
                    _prevOffset_3683393 = (@:checkr _d ?? throw "null pointer dereference")._offset;
                    (@:checkr _d ?? throw "null pointer dereference")._length = (3 : stdgo.GoInt);
                    (@:checkr _d ?? throw "null pointer dereference")._offset = (0 : stdgo.GoInt);
                    _minIndex_3683465 = ((@:checkr _d ?? throw "null pointer dereference")._index - (32768 : stdgo.GoInt) : stdgo.GoInt);
                    if ((_minIndex_3683465 < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3683516i32;
                    } else {
                        _gotoNext = 3683541i32;
                    };
                } else if (__value__ == (3683516i32)) {
                    _minIndex_3683465 = (0 : stdgo.GoInt);
                    _gotoNext = 3683541i32;
                } else if (__value__ == (3683541i32)) {
                    if (((((@:checkr _d ?? throw "null pointer dereference")._chainHead - (@:checkr _d ?? throw "null pointer dereference")._hashOffset : stdgo.GoInt) >= _minIndex_3683465 : Bool) && ((((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt)) && (_lookahead_3682464 > (3 : stdgo.GoInt) : Bool) : Bool) || (((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing == ((2147483647 : stdgo.GoInt)) && (_lookahead_3682464 > _prevLength_3683368 : Bool) : Bool) && (_prevLength_3683368 < (@:checkr _d ?? throw "null pointer dereference")._compressionLevel._lazy : Bool) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 3683739i32;
                    } else {
                        _gotoNext = 3683918i32;
                    };
                } else if (__value__ == (3683739i32)) {
                    {
                        {
                            var __tmp__ = @:check2r _d._findMatch((@:checkr _d ?? throw "null pointer dereference")._index, ((@:checkr _d ?? throw "null pointer dereference")._chainHead - (@:checkr _d ?? throw "null pointer dereference")._hashOffset : stdgo.GoInt), (3 : stdgo.GoInt), _lookahead_3682464);
                            _newLength_3683747 = @:tmpset0 __tmp__._0;
                            _newOffset_3683758 = @:tmpset0 __tmp__._1;
                            _ok_3683769 = @:tmpset0 __tmp__._2;
                        };
                        if (_ok_3683769) {
                    ...
                    (@:checkr _d ?? throw "null pointer dereference")._length = _newLength_3683747;
                    (@:checkr _d ?? throw "null pointer dereference")._offset = _newOffset_3683758;
                    _gotoNext = 3683918i32;
                } else if (__value__ == (3683918i32)) {
                    if ((((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt)) && ((@:checkr _d ?? throw "null pointer dereference")._length >= (4 : stdgo.GoInt) : Bool) : Bool) || (((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing == ((2147483647 : stdgo.GoInt)) && (_prevLength_3683368 >= (4 : stdgo.GoInt) : Bool) : Bool) && ((@:checkr _d ?? throw "null pointer dereference")._length <= _prevLength_3683368 : Bool) : Bool) : Bool)) {
                        _gotoNext = 3684077i32;
                    } else {
                        _gotoNext = 3685828i32;
                    };
                } else if (__value__ == (3684077i32)) {
                    if ((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt))) {
                        _gotoNext = 3684232i32;
                    } else {
                        _gotoNext = 3684356i32;
                    };
                } else if (__value__ == (3684232i32)) {
                    ...
                    _gotoNext = 3684704i32;
                } else if (__value__ == (3684356i32)) {
                    _gotoNext = 3684356i32;
                    (@:checkr _d ?? throw "null pointer dereference")._tokens = ((@:checkr _d ?? throw "null pointer dereference")._tokens.__append__(stdgo._internal.compress.flate.Flate__matchToken._matchToken(((_prevLength_3683368 - (3 : stdgo.GoInt) : stdgo.GoInt) : stdgo.GoUInt32), ((_prevOffset_3683393 - (1 : stdgo.GoInt) : stdgo.GoInt) : stdgo.GoUInt32))));
                    var __blank__ = 0i32;
                    _gotoNext = 3684704i32;
                } else if (__value__ == (3684704i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._length <= (@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing : Bool)) {
                        _gotoNext = 3684737i32;
                    } else {
                        _gotoNext = 3685481i32;
                    };
                } else if (__value__ == (3684737i32)) {
                    if ((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt))) {
                        _gotoNext = 3684798i32;
                    } else {
                        _gotoNext = 3684846i32;
                    };
                } else if (__value__ == (3684798i32)) {
                    _newIndex_3684747 = ((@:checkr _d ?? throw "null pointer dereference")._index + (@:checkr _d ?? throw "null pointer dereference")._length : stdgo.GoInt);
                    _gotoNext = 3684899i32;
                } else if (__value__ == (3684846i32)) {
                    _gotoNext = 3684846i32;
                    _newIndex_3684747 = (((@:checkr _d ?? throw "null pointer dereference")._index + _prevLength_3683368 : stdgo.GoInt) - (1 : stdgo.GoInt) : stdgo.GoInt);
                    var __blank__ = 0i32;
                    _gotoNext = 3684899i32;
                } else if (__value__ == (3684899i32)) {
                    _index_3684899 = (@:checkr _d ?? throw "null pointer dereference")._index;
                    _index_3684899++;
                    _gotoNext = 3684920i32;
                } else if (__value__ == (3684920i32)) {
                    if ((_index_3684899 < _newIndex_3684747 : Bool)) {
                        _gotoNext = 3684959i32;
                    } else {
                        _gotoNext = 3685344i32;
                    };
                } else if (__value__ == (3684951i32)) {
                    _index_3684899++;
                    _gotoNext = 3684920i32;
                } else if (__value__ == (3684959i32)) {
                    if ((_index_3684899 < (@:checkr _d ?? throw "null pointer dereference")._maxInsertIndex : Bool)) {
                        _gotoNext = 3684994i32;
                    } else {
                        _gotoNext = 3684951i32;
                    };
                } else if (__value__ == (3684994i32)) {
                    _hash_3685002 = stdgo._internal.compress.flate.Flate__hash4._hash4(((@:checkr _d ?? throw "null pointer dereference")._window.__slice__(_index_3684899, (_index_3684899 + (4 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                    _hh_3685165 = stdgo.Go.pointer((@:checkr _d ?? throw "null pointer dereference")._hashHead[((_hash_3685002 & (131071u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)]);
                    (@:checkr _d ?? throw "null pointer dereference")._hashPrev[(_index_3684899 & (32767 : stdgo.GoInt) : stdgo.GoInt)] = _hh_3685165.value;
                    _hh_3685165.value = ((_index_3684899 + (@:checkr _d ?? throw "null pointer dereference")._hashOffset : stdgo.GoInt) : stdgo.GoUInt32);
                    _gotoNext = 3684951i32;
                } else if (__value__ == (3685344i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._index = _index_3684899;
                    if ((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing == ((2147483647 : stdgo.GoInt))) {
                        _gotoNext = 3685399i32;
                    } else {
                        _gotoNext = 3685615i32;
                    };
                } else if (__value__ == (3685399i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._byteAvailable = false;
                    (@:checkr _d ?? throw "null pointer dereference")._length = (3 : stdgo.GoInt);
                    _gotoNext = 3685615i32;
                ...
                } else if (__value__ == (3685655i32)) {
                    {
                        (@:checkr _d ?? throw "null pointer dereference")._err = @:check2r _d._writeBlock((@:checkr _d ?? throw "null pointer dereference")._tokens, (@:checkr _d ?? throw "null pointer dereference")._index);
                        if ((@:checkr _d ?? throw "null pointer dereference")._err != null) {
                            _gotoNext = 3685766i32;
                        } else {
                            _gotoNext = 3685790i32;
                        };
                    };
                } else if (__value__ == (3685766i32)) {
                    return;
                    _gotoNext = 3685790i32;
                } else if (__value__ == (3685790i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._tokens = ((@:checkr _d ?? throw "null pointer dereference")._tokens.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.compress.flate.Flate_T_token.T_token>);
                    _gotoNext = 3682393i32;
                } else if (__value__ == (3685828i32)) {
                    _gotoNext = 3685828i32;
                    if ((((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != (2147483647 : stdgo.GoInt)) || (@:checkr _d ?? throw "null pointer dereference")._byteAvailable : Bool)) {
                        ...
                        _gotoNext = 3686208i32;
                    };
                } else if (__value__ == (3685886i32)) {
                    _i_3685892 = ((@:checkr _d ?? throw "null pointer dereference")._index - (1 : stdgo.GoInt) : stdgo.GoInt);
                    if ((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt))) {
                        _gotoNext = 3685947i32;
                    } else {
                        _gotoNext = 3685976i32;
                    };
                } else if (__value__ == (3685947i32)) {
                    _i_3685892 = (@:checkr _d ?? throw "null pointer dereference")._index;
                    _gotoNext = 3685976i32;
                } else if (__value__ == (3685976i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._tokens = ((@:checkr _d ?? throw "null pointer dereference")._tokens.__append__(stdgo._internal.compress.flate.Flate__literalToken._literalToken(((@:checkr _d ?? throw "null pointer dereference")._window[(_i_3685892 : stdgo.GoInt)] : stdgo.GoUInt32))));
                    if (((@:checkr _d ?? throw "null pointer dereference")._tokens.length) == ((16384 : stdgo.GoInt))) {
                    ...
                    {
                        (@:checkr _d ?? throw "null pointer dereference")._err = @:check2r _d._writeBlock((@:checkr _d ?? throw "null pointer dereference")._tokens, (_i_3685892 + (1 : stdgo.GoInt) : stdgo.GoInt));
                        if ((@:checkr _d ?? throw "null pointer dereference")._err != null) {
                            _gotoNext = 3686143i32;
                        } else {
                            _gotoNext = 3686170i32;
                        };
                    };
                } else if (__value__ == (3686143i32)) {
                    return;
                    _gotoNext = 3686170i32;
                } else if (__value__ == (3686170i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._tokens = ((@:checkr _d ?? throw "null pointer dereference")._tokens.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.compress.flate.Flate_T_token.T_token>);
                    _gotoNext = 3686208i32;
                } else if (__value__ == (3686208i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._index++;
                    if ((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing == ((2147483647 : stdgo.GoInt))) {
                        _gotoNext = 3686255i32;
                    } else {
                        _gotoNext = 3682393i32;
                    };
                } else if (__value__ == (3686255i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._byteAvailable = true;
                    _gotoNext = 3682393i32;
                } else if (__value__ == (3686296i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
