...
@:keep @:allow(stdgo._internal.compress.flate.Flate.T_compressor_asInterface) class T_compressor_static_extension {
    ...
    static public function _deflate( _d:stdgo.Ref<stdgo._internal.compress.flate.Flate_T_compressor.T_compressor>):Void {
        @:recv var _d:stdgo.Ref<stdgo._internal.compress.flate.Flate_T_compressor.T_compressor> = _d;
        var _hh_3663714:stdgo.Pointer<stdgo.GoUInt32> = (null : stdgo.Pointer<stdgo.GoUInt32>);
        var _lookahead_3662971:stdgo.GoInt = (0 : stdgo.GoInt);
        var _hh_3665672:stdgo.Pointer<stdgo.GoUInt32> = (null : stdgo.Pointer<stdgo.GoUInt32>);
        var _index_3665406:stdgo.GoInt = (0 : stdgo.GoInt);
        var _newIndex_3665254:stdgo.GoInt = (0 : stdgo.GoInt);
        var _newOffset_3664265:stdgo.GoInt = (0 : stdgo.GoInt);
        var _minIndex_3663972:stdgo.GoInt = (0 : stdgo.GoInt);
        var _prevOffset_3663900:stdgo.GoInt = (0 : stdgo.GoInt);
        var _newLength_3664254:stdgo.GoInt = (0 : stdgo.GoInt);
        var _hash_3663653:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _i_3666399:stdgo.GoInt = (0 : stdgo.GoInt);
        var _hash_3665509:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _ok_3664276:Bool = false;
        var _prevLength_3663875:stdgo.GoInt = (0 : stdgo.GoInt);
        var loopBreak = false;
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _lookahead_3662971 = ((@:checkr _d ?? throw "null pointer dereference")._windowEnd - (@:checkr _d ?? throw "null pointer dereference")._index : stdgo.GoInt);
                    if ((_lookahead_3662971 < (262 : stdgo.GoInt) : Bool)) {
                    ...
                    if (_lookahead_3662971 == ((0 : stdgo.GoInt))) {
                    ...
                    _hash_3663653 = stdgo._internal.compress.flate.Flate__hash4._hash4(((@:checkr _d ?? throw "null pointer dereference")._window.__slice__((@:checkr _d ?? throw "null pointer dereference")._index, ((@:checkr _d ?? throw "null pointer dereference")._index + (4 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                    _hh_3663714 = stdgo.Go.pointer((@:checkr _d ?? throw "null pointer dereference")._hashHead[((_hash_3663653 & (131071u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)]);
                    (@:checkr _d ?? throw "null pointer dereference")._chainHead = (_hh_3663714.value : stdgo.GoInt);
                    ...
                    _hh_3663714.value = (((@:checkr _d ?? throw "null pointer dereference")._index + (@:checkr _d ?? throw "null pointer dereference")._hashOffset : stdgo.GoInt) : stdgo.GoUInt32);
                    _gotoNext = 3663875i32;
                } else if (__value__ == (3663875i32)) {
                    _prevLength_3663875 = (@:checkr _d ?? throw "null pointer dereference")._length;
                    _prevOffset_3663900 = (@:checkr _d ?? throw "null pointer dereference")._offset;
                    (@:checkr _d ?? throw "null pointer dereference")._length = (3 : stdgo.GoInt);
                    (@:checkr _d ?? throw "null pointer dereference")._offset = (0 : stdgo.GoInt);
                    _minIndex_3663972 = ((@:checkr _d ?? throw "null pointer dereference")._index - (32768 : stdgo.GoInt) : stdgo.GoInt);
                    if ((_minIndex_3663972 < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3664023i32;
                    } else {
                        _gotoNext = 3664048i32;
                    };
                } else if (__value__ == (3664023i32)) {
                    _minIndex_3663972 = (0 : stdgo.GoInt);
                    _gotoNext = 3664048i32;
                } else if (__value__ == (3664048i32)) {
                    if (((((@:checkr _d ?? throw "null pointer dereference")._chainHead - (@:checkr _d ?? throw "null pointer dereference")._hashOffset : stdgo.GoInt) >= _minIndex_3663972 : Bool) && ((((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt)) && (_lookahead_3662971 > (3 : stdgo.GoInt) : Bool) : Bool) || (((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing == ((2147483647 : stdgo.GoInt)) && (_lookahead_3662971 > _prevLength_3663875 : Bool) : Bool) && (_prevLength_3663875 < (@:checkr _d ?? throw "null pointer dereference")._compressionLevel._lazy : Bool) : Bool) : Bool)) : Bool)) {
                    ...
                    {
                        {
                            var __tmp__ = @:check2r _d._findMatch((@:checkr _d ?? throw "null pointer dereference")._index, ((@:checkr _d ?? throw "null pointer dereference")._chainHead - (@:checkr _d ?? throw "null pointer dereference")._hashOffset : stdgo.GoInt), (3 : stdgo.GoInt), _lookahead_3662971);
                            _newLength_3664254 = @:tmpset0 __tmp__._0;
                            _newOffset_3664265 = @:tmpset0 __tmp__._1;
                            _ok_3664276 = @:tmpset0 __tmp__._2;
                        };
                        if (_ok_3664276) {
                    ...
                    (@:checkr _d ?? throw "null pointer dereference")._length = _newLength_3664254;
                    (@:checkr _d ?? throw "null pointer dereference")._offset = _newOffset_3664265;
                    _gotoNext = 3664425i32;
                } else if (__value__ == (3664425i32)) {
                    if ((((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt)) && ((@:checkr _d ?? throw "null pointer dereference")._length >= (4 : stdgo.GoInt) : Bool) : Bool) || (((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing == ((2147483647 : stdgo.GoInt)) && (_prevLength_3663875 >= (4 : stdgo.GoInt) : Bool) : Bool) && ((@:checkr _d ?? throw "null pointer dereference")._length <= _prevLength_3663875 : Bool) : Bool) : Bool)) {
                    ...
                    _gotoNext = 3664863i32;
                    (@:checkr _d ?? throw "null pointer dereference")._tokens = ((@:checkr _d ?? throw "null pointer dereference")._tokens.__append__(stdgo._internal.compress.flate.Flate__matchToken._matchToken(((_prevLength_3663875 - (3 : stdgo.GoInt) : stdgo.GoInt) : stdgo.GoUInt32), ((_prevOffset_3663900 - (1 : stdgo.GoInt) : stdgo.GoInt) : stdgo.GoUInt32))));
                    var __blank__ = 0i32;
                    _gotoNext = 3665211i32;
                    ...
                    _newIndex_3665254 = ((@:checkr _d ?? throw "null pointer dereference")._index + (@:checkr _d ?? throw "null pointer dereference")._length : stdgo.GoInt);
                    _gotoNext = 3665406i32;
                } else if (__value__ == (3665353i32)) {
                    _gotoNext = 3665353i32;
                    _newIndex_3665254 = (((@:checkr _d ?? throw "null pointer dereference")._index + _prevLength_3663875 : stdgo.GoInt) - (1 : stdgo.GoInt) : stdgo.GoInt);
                    var __blank__ = 0i32;
                    _gotoNext = 3665406i32;
                } else if (__value__ == (3665406i32)) {
                    _index_3665406 = (@:checkr _d ?? throw "null pointer dereference")._index;
                    _index_3665406++;
                    _gotoNext = 3665427i32;
                } else if (__value__ == (3665427i32)) {
                    if ((_index_3665406 < _newIndex_3665254 : Bool)) {
                    ...
                    if ((_index_3665406 < (@:checkr _d ?? throw "null pointer dereference")._maxInsertIndex : Bool)) {
                        _gotoNext = 3665501i32;
                    } else {
                        _gotoNext = 3665458i32;
                    };
                } else if (__value__ == (3665501i32)) {
                    _hash_3665509 = stdgo._internal.compress.flate.Flate__hash4._hash4(((@:checkr _d ?? throw "null pointer dereference")._window.__slice__(_index_3665406, (_index_3665406 + (4 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                    _hh_3665672 = stdgo.Go.pointer((@:checkr _d ?? throw "null pointer dereference")._hashHead[((_hash_3665509 & (131071u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)]);
                    (@:checkr _d ?? throw "null pointer dereference")._hashPrev[(_index_3665406 & (32767 : stdgo.GoInt) : stdgo.GoInt)] = _hh_3665672.value;
                    _hh_3665672.value = ((_index_3665406 + (@:checkr _d ?? throw "null pointer dereference")._hashOffset : stdgo.GoInt) : stdgo.GoUInt32);
                    _gotoNext = 3665458i32;
                } else if (__value__ == (3665851i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._index = _index_3665406;
                    if ((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing == ((2147483647 : stdgo.GoInt))) {
                    ...
                    _i_3666399 = ((@:checkr _d ?? throw "null pointer dereference")._index - (1 : stdgo.GoInt) : stdgo.GoInt);
                    if ((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt))) {
                    ...
                    _i_3666399 = (@:checkr _d ?? throw "null pointer dereference")._index;
                    _gotoNext = 3666483i32;
                } else if (__value__ == (3666483i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._tokens = ((@:checkr _d ?? throw "null pointer dereference")._tokens.__append__(stdgo._internal.compress.flate.Flate__literalToken._literalToken(((@:checkr _d ?? throw "null pointer dereference")._window[(_i_3666399 : stdgo.GoInt)] : stdgo.GoUInt32))));
                    if (((@:checkr _d ?? throw "null pointer dereference")._tokens.length) == ((16384 : stdgo.GoInt))) {
                    ...
                    {
                        (@:checkr _d ?? throw "null pointer dereference")._err = @:check2r _d._writeBlock((@:checkr _d ?? throw "null pointer dereference")._tokens, (_i_3666399 + (1 : stdgo.GoInt) : stdgo.GoInt));
                        if ((@:checkr _d ?? throw "null pointer dereference")._err != null) {
