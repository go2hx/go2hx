...
@:structInit @:using(stdgo._internal.compress.flate.Flate_T_decompressor_static_extension.T_decompressor_static_extension) class T_decompressor {
    ...
    public var _bits : stdgo.Ref<stdgo.GoArray<stdgo.GoInt>> = new stdgo.GoArray<stdgo.GoInt>(316, 316, ...[for (i in 0 ... 316) (0 : stdgo.GoInt)]);
    public var _codebits : stdgo.Ref<stdgo.GoArray<stdgo.GoInt>> = new stdgo.GoArray<stdgo.GoInt>(19, 19, ...[for (i in 0 ... 19) (0 : stdgo.GoInt)]);
