        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _candidate_3720580 = _e._table[((_nextHash_3719667 & (16383u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)];
                    _now_3720833 = stdgo._internal.compress.flate.Flate__load32._load32(_src, _nextS_3720563);
                    _e._table[((_nextHash_3719667 & (16383u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)] = ({ _offset : (_s_3719630 + _e._cur : stdgo.GoInt32), _val : _cv_3719645 } : stdgo._internal.compress.flate.Flate_T_tableEntry.T_tableEntry);
                    _nextHash_3719667 = stdgo._internal.compress.flate.Flate__hash._hash(_now_3720833);
                    _offset_3720959 = (_s_3719630 - ((_candidate_3720580._offset - _e._cur : stdgo.GoInt32)) : stdgo.GoInt32);
                    ...
                    _t_3722022 = ((_candidate_3720580._offset - _e._cur : stdgo.GoInt32) + (4 : stdgo.GoInt32) : stdgo.GoInt32);
                    _l_3722059 = _e._matchLen(_s_3719630, _t_3722022, _src);
                    ...
                    _e._table[((_prevHash_3722724 & (16383u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)] = ({ _offset : ((_e._cur + _s_3719630 : stdgo.GoInt32) - (1 : stdgo.GoInt32) : stdgo.GoInt32), _val : (_x_3722699 : stdgo.GoUInt32) } : stdgo._internal.compress.flate.Flate_T_tableEntry.T_tableEntry);
                    ...
                    _candidate_3720580 = _e._table[((_currHash_3722849 & (16383u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)];
                    _e._table[((_currHash_3722849 & (16383u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)] = ({ _offset : (_e._cur + _s_3719630 : stdgo.GoInt32), _val : (_x_3722699 : stdgo.GoUInt32) } : stdgo._internal.compress.flate.Flate_T_tableEntry.T_tableEntry);
                    _offset_3723003 = (_s_3719630 - ((_candidate_3720580._offset - _e._cur : stdgo.GoInt32)) : stdgo.GoInt32);
