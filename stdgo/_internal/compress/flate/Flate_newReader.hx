...
function newReader(_r:stdgo._internal.io.Io_Reader.Reader):stdgo._internal.io.Io_ReadCloser.ReadCloser {
        ...
        var _f__pointer__ = (stdgo.Go.setRef(_f) : stdgo.Ref<stdgo._internal.compress.flate.Flate_T_decompressor.T_decompressor>);
        _f._makeReader(_r);
        ...
        return stdgo.Go.asInterface(_f__pointer__);
    }
