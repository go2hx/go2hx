...
@:structInit @:using(stdgo._internal.compress.flate.Flate_t_compressor_static_extension.T_compressor_static_extension) class T_compressor {
    ...
    public var _hashHead : stdgo.GoArray<stdgo.GoUInt32> = new stdgo.GoArray<stdgo.GoUInt32>(131072, 131072).__setNumber32__().__setNil__();
    public var _hashPrev : stdgo.GoArray<stdgo.GoUInt32> = new stdgo.GoArray<stdgo.GoUInt32>(32768, 32768).__setNumber32__().__setNil__();
    ...
    public var _hashMatch : stdgo.GoArray<stdgo.GoUInt32> = new stdgo.GoArray<stdgo.GoUInt32>(257, 257).__setNumber32__().__setNil__();
