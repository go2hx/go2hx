...
@:keep @:allow(stdgo._internal.compress.flate.Flate.T_compressor_asInterface) class T_compressor_static_extension {
    ...
    static public function _deflate( _d:stdgo.Ref<stdgo._internal.compress.flate.Flate_t_compressor.T_compressor>):Void {
        @:recv var _d:stdgo.Ref<stdgo._internal.compress.flate.Flate_t_compressor.T_compressor> = _d;
        var _hash_3693915:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _index_3693812:stdgo.GoInt = (0 : stdgo.GoInt);
        var _newIndex_3693660:stdgo.GoInt = (0 : stdgo.GoInt);
        var _ok_3692682:Bool = false;
        var _hh_3694078:stdgo.Pointer<stdgo.GoUInt32> = (null : stdgo.Pointer<stdgo.GoUInt32>);
        var _newOffset_3692671:stdgo.GoInt = (0 : stdgo.GoInt);
        var _newLength_3692660:stdgo.GoInt = (0 : stdgo.GoInt);
        var _hh_3692120:stdgo.Pointer<stdgo.GoUInt32> = (null : stdgo.Pointer<stdgo.GoUInt32>);
        var _lookahead_3691377:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_3694805:stdgo.GoInt = (0 : stdgo.GoInt);
        var _minIndex_3692378:stdgo.GoInt = (0 : stdgo.GoInt);
        var _prevOffset_3692306:stdgo.GoInt = (0 : stdgo.GoInt);
        var _prevLength_3692281:stdgo.GoInt = (0 : stdgo.GoInt);
        var _hash_3692059:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var loopBreak = false;
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if (((((@:checkr _d ?? throw "null pointer dereference")._windowEnd - (@:checkr _d ?? throw "null pointer dereference")._index : stdgo.GoInt) < (262 : stdgo.GoInt) : Bool) && !(@:checkr _d ?? throw "null pointer dereference")._sync : Bool)) {
                        _gotoNext = 3691228i32;
                    } else {
                        _gotoNext = 3691244i32;
                    };
                } else if (__value__ == (3691228i32)) {
                    return;
                    _gotoNext = 3691244i32;
                } else if (__value__ == (3691244i32)) {
                    ...
                    _gotoNext = 3691299i32;
                } else if (__value__ == (3691299i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3691306i32;
                } else if (__value__ == (3691306i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3691310i32;
                    } else {
                        _gotoNext = 3695209i32;
                    };
                } else if (__value__ == (3691310i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._index > (@:checkr _d ?? throw "null pointer dereference")._windowEnd : Bool)) {
                        _gotoNext = 3691339i32;
                    } else {
                        _gotoNext = 3691377i32;
                    };
                } else if (__value__ == (3691339i32)) {
                    throw stdgo.Go.toInterface(("index > windowEnd" : stdgo.GoString));
                    _gotoNext = 3691377i32;
                } else if (__value__ == (3691377i32)) {
                    _lookahead_3691377 = ((@:checkr _d ?? throw "null pointer dereference")._windowEnd - (@:checkr _d ?? throw "null pointer dereference")._index : stdgo.GoInt);
                    if ((_lookahead_3691377 < (262 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3691459i32;
                    } else {
                        _gotoNext = 3692002i32;
                    };
                } else if (__value__ == (3691459i32)) {
                    if (!(@:checkr _d ?? throw "null pointer dereference")._sync) {
                        _gotoNext = 3691475i32;
                    } else {
                        _gotoNext = 3691500i32;
                    };
                } else if (__value__ == (3691475i32)) {
                    loopBreak = true;
                    _gotoNext = 3691306i32;
                } else if (__value__ == (3691500i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._index > (@:checkr _d ?? throw "null pointer dereference")._windowEnd : Bool)) {
                        _gotoNext = 3691525i32;
                    } else {
                        _gotoNext = 3691566i32;
                    };
                } else if (__value__ == (3691525i32)) {
                    throw stdgo.Go.toInterface(("index > windowEnd" : stdgo.GoString));
                    _gotoNext = 3691566i32;
                } else if (__value__ == (3691566i32)) {
                    if (_lookahead_3691377 == ((0 : stdgo.GoInt))) {
                        _gotoNext = 3691584i32;
                    } else {
                        _gotoNext = 3692002i32;
                    };
                } else if (__value__ == (3691584i32)) {
                    if ((@:checkr _d ?? throw "null pointer dereference")._byteAvailable) {
                        _gotoNext = 3691651i32;
                    } else {
                        _gotoNext = 3691834i32;
                    };
                } else if (__value__ == (3691651i32)) {
                    ...
                    _gotoNext = 3691834i32;
                } else if (__value__ == (3691834i32)) {
                    if ((((@:checkr _d ?? throw "null pointer dereference")._tokens.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3691855i32;
                    } else {
                        _gotoNext = 3691980i32;
                    };
                } else if (__value__ == (3691855i32)) {
                    {
                        ...
                        if ((@:checkr _d ?? throw "null pointer dereference")._err != null) {
                            _gotoNext = 3691919i32;
                        } else {
                            _gotoNext = 3691946i32;
                        };
                    };
                } else if (__value__ == (3691919i32)) {
                    return;
                    _gotoNext = 3691946i32;
                } else if (__value__ == (3691946i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._tokens = ((@:checkr _d ?? throw "null pointer dereference")._tokens.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.compress.flate.Flate_t_token.T_token>);
                    _gotoNext = 3691980i32;
                } else if (__value__ == (3691980i32)) {
                    loopBreak = true;
                    _gotoNext = 3691306i32;
                } else if (__value__ == (3692002i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._index < (@:checkr _d ?? throw "null pointer dereference")._maxInsertIndex : Bool)) {
                        _gotoNext = 3692032i32;
                    } else {
                        _gotoNext = 3692281i32;
                    };
                } else if (__value__ == (3692032i32)) {
                    _hash_3692059 = stdgo._internal.compress.flate.Flate__hash4._hash4(((@:checkr _d ?? throw "null pointer dereference")._window.__slice__((@:checkr _d ?? throw "null pointer dereference")._index, ((@:checkr _d ?? throw "null pointer dereference")._index + (4 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                    _hh_3692120 = stdgo.Go.pointer((@:checkr _d ?? throw "null pointer dereference")._hashHead[((_hash_3692059 & (131071u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)]);
                    (@:checkr _d ?? throw "null pointer dereference")._chainHead = (_hh_3692120.value : stdgo.GoInt);
                    ...
                    _hh_3692120.value = (((@:checkr _d ?? throw "null pointer dereference")._index + (@:checkr _d ?? throw "null pointer dereference")._hashOffset : stdgo.GoInt) : stdgo.GoUInt32);
                    _gotoNext = 3692281i32;
                } else if (__value__ == (3692281i32)) {
                    _prevLength_3692281 = (@:checkr _d ?? throw "null pointer dereference")._length;
                    _prevOffset_3692306 = (@:checkr _d ?? throw "null pointer dereference")._offset;
                    (@:checkr _d ?? throw "null pointer dereference")._length = (3 : stdgo.GoInt);
                    (@:checkr _d ?? throw "null pointer dereference")._offset = (0 : stdgo.GoInt);
                    _minIndex_3692378 = ((@:checkr _d ?? throw "null pointer dereference")._index - (32768 : stdgo.GoInt) : stdgo.GoInt);
                    if ((_minIndex_3692378 < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3692429i32;
                    } else {
                        _gotoNext = 3692454i32;
                    };
                } else if (__value__ == (3692429i32)) {
                    _minIndex_3692378 = (0 : stdgo.GoInt);
                    _gotoNext = 3692454i32;
                } else if (__value__ == (3692454i32)) {
                    if (((((@:checkr _d ?? throw "null pointer dereference")._chainHead - (@:checkr _d ?? throw "null pointer dereference")._hashOffset : stdgo.GoInt) >= _minIndex_3692378 : Bool) && ((((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt)) && (_lookahead_3691377 > (3 : stdgo.GoInt) : Bool) : Bool) || (((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing == ((2147483647 : stdgo.GoInt)) && (_lookahead_3691377 > _prevLength_3692281 : Bool) : Bool) && (_prevLength_3692281 < (@:checkr _d ?? throw "null pointer dereference")._compressionLevel._lazy : Bool) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 3692652i32;
                    } else {
                        _gotoNext = 3692831i32;
                    };
                } else if (__value__ == (3692652i32)) {
                    {
                        {
                            var __tmp__ = @:check2r _d._findMatch((@:checkr _d ?? throw "null pointer dereference")._index, ((@:checkr _d ?? throw "null pointer dereference")._chainHead - (@:checkr _d ?? throw "null pointer dereference")._hashOffset : stdgo.GoInt), (3 : stdgo.GoInt), _lookahead_3691377);
                            _newLength_3692660 = @:tmpset0 __tmp__._0;
                            _newOffset_3692671 = @:tmpset0 __tmp__._1;
                            _ok_3692682 = @:tmpset0 __tmp__._2;
                        };
                        if (_ok_3692682) {
                            _gotoNext = 3692768i32;
                        } else {
                            _gotoNext = 3692831i32;
                        };
                    };
                } else if (__value__ == (3692768i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._length = _newLength_3692660;
                    (@:checkr _d ?? throw "null pointer dereference")._offset = _newOffset_3692671;
                    _gotoNext = 3692831i32;
                } else if (__value__ == (3692831i32)) {
                    if ((((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt)) && ((@:checkr _d ?? throw "null pointer dereference")._length >= (4 : stdgo.GoInt) : Bool) : Bool) || (((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing == ((2147483647 : stdgo.GoInt)) && (_prevLength_3692281 >= (4 : stdgo.GoInt) : Bool) : Bool) && ((@:checkr _d ?? throw "null pointer dereference")._length <= _prevLength_3692281 : Bool) : Bool) : Bool)) {
                        _gotoNext = 3692990i32;
                    } else {
                        _gotoNext = 3694741i32;
                    };
                    ...
                    if ((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt))) {
                        _gotoNext = 3693145i32;
                    } else {
                        _gotoNext = 3693269i32;
                    };
                } else if (__value__ == (3693145i32)) {
                    ...
                    _gotoNext = 3693617i32;
                } else if (__value__ == (3693269i32)) {
                    _gotoNext = 3693269i32;
                    (@:checkr _d ?? throw "null pointer dereference")._tokens = ((@:checkr _d ?? throw "null pointer dereference")._tokens.__append__(stdgo._internal.compress.flate.Flate__matchtoken._matchToken(((_prevLength_3692281 - (3 : stdgo.GoInt) : stdgo.GoInt) : stdgo.GoUInt32), ((_prevOffset_3692306 - (1 : stdgo.GoInt) : stdgo.GoInt) : stdgo.GoUInt32))));
                    var __blank__ = 0i32;
                    _gotoNext = 3693617i32;
                } else if (__value__ == (3693617i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._length <= (@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing : Bool)) {
                        ...
                        _gotoNext = 3694394i32;
                    };
                } else if (__value__ == (3693650i32)) {
                    if ((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt))) {
                        _gotoNext = 3693711i32;
                    } else {
                        _gotoNext = 3693759i32;
                    };
                } else if (__value__ == (3693711i32)) {
                    _newIndex_3693660 = ((@:checkr _d ?? throw "null pointer dereference")._index + (@:checkr _d ?? throw "null pointer dereference")._length : stdgo.GoInt);
                    _gotoNext = 3693812i32;
                } else if (__value__ == (3693759i32)) {
                    _gotoNext = 3693759i32;
                    _newIndex_3693660 = (((@:checkr _d ?? throw "null pointer dereference")._index + _prevLength_3692281 : stdgo.GoInt) - (1 : stdgo.GoInt) : stdgo.GoInt);
                    var __blank__ = 0i32;
                    _gotoNext = 3693812i32;
                } else if (__value__ == (3693812i32)) {
                    _index_3693812 = (@:checkr _d ?? throw "null pointer dereference")._index;
                    _index_3693812++;
                    _gotoNext = 3693833i32;
                } else if (__value__ == (3693833i32)) {
                    if ((_index_3693812 < _newIndex_3693660 : Bool)) {
                        _gotoNext = 3693872i32;
                    } else {
                        _gotoNext = 3694257i32;
                    };
                } else if (__value__ == (3693864i32)) {
                    _index_3693812++;
                    _gotoNext = 3693833i32;
                } else if (__value__ == (3693872i32)) {
                    if ((_index_3693812 < (@:checkr _d ?? throw "null pointer dereference")._maxInsertIndex : Bool)) {
                        _gotoNext = 3693907i32;
                    } else {
                        _gotoNext = 3693864i32;
                    };
                } else if (__value__ == (3693907i32)) {
                    _hash_3693915 = stdgo._internal.compress.flate.Flate__hash4._hash4(((@:checkr _d ?? throw "null pointer dereference")._window.__slice__(_index_3693812, (_index_3693812 + (4 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                    _hh_3694078 = stdgo.Go.pointer((@:checkr _d ?? throw "null pointer dereference")._hashHead[((_hash_3693915 & (131071u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)]);
                    (@:checkr _d ?? throw "null pointer dereference")._hashPrev[(_index_3693812 & (32767 : stdgo.GoInt) : stdgo.GoInt)] = _hh_3694078.value;
                    _hh_3694078.value = ((_index_3693812 + (@:checkr _d ?? throw "null pointer dereference")._hashOffset : stdgo.GoInt) : stdgo.GoUInt32);
                    _gotoNext = 3693864i32;
                } else if (__value__ == (3694257i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._index = _index_3693812;
                    if ((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing == ((2147483647 : stdgo.GoInt))) {
                        _gotoNext = 3694312i32;
                    } else {
                        _gotoNext = 3694528i32;
                    };
                } else if (__value__ == (3694312i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._byteAvailable = false;
                    (@:checkr _d ?? throw "null pointer dereference")._length = (3 : stdgo.GoInt);
                    _gotoNext = 3694528i32;
                } else if (__value__ == (3694394i32)) {
                    _gotoNext = 3694394i32;
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 3694528i32;
                } else if (__value__ == (3694528i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._tokens.length) == ((16384 : stdgo.GoInt))) {
                        _gotoNext = 3694568i32;
                    } else {
                        _gotoNext = 3691306i32;
                    };
                } else if (__value__ == (3694568i32)) {
                    {
                        (@:checkr _d ?? throw "null pointer dereference")._err = @:check2r _d._writeBlock((@:checkr _d ?? throw "null pointer dereference")._tokens, (@:checkr _d ?? throw "null pointer dereference")._index);
                        if ((@:checkr _d ?? throw "null pointer dereference")._err != null) {
                    ...
                    if ((((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != (2147483647 : stdgo.GoInt)) || (@:checkr _d ?? throw "null pointer dereference")._byteAvailable : Bool)) {
                        ...
                        _gotoNext = 3695121i32;
                    };
                } else if (__value__ == (3694799i32)) {
                    _i_3694805 = ((@:checkr _d ?? throw "null pointer dereference")._index - (1 : stdgo.GoInt) : stdgo.GoInt);
                    if ((@:checkr _d ?? throw "null pointer dereference")._compressionLevel._fastSkipHashing != ((2147483647 : stdgo.GoInt))) {
                        _gotoNext = 3694860i32;
                    } else {
                        _gotoNext = 3694889i32;
                    };
                } else if (__value__ == (3694860i32)) {
                    _i_3694805 = (@:checkr _d ?? throw "null pointer dereference")._index;
                    _gotoNext = 3694889i32;
                } else if (__value__ == (3694889i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._tokens = ((@:checkr _d ?? throw "null pointer dereference")._tokens.__append__(stdgo._internal.compress.flate.Flate__literaltoken._literalToken(((@:checkr _d ?? throw "null pointer dereference")._window[(_i_3694805 : stdgo.GoInt)] : stdgo.GoUInt32))));
                    if (((@:checkr _d ?? throw "null pointer dereference")._tokens.length) == ((16384 : stdgo.GoInt))) {
                        _gotoNext = 3694996i32;
                    } else {
                        _gotoNext = 3695121i32;
                    };
                } else if (__value__ == (3694996i32)) {
                    {
                        (@:checkr _d ?? throw "null pointer dereference")._err = @:check2r _d._writeBlock((@:checkr _d ?? throw "null pointer dereference")._tokens, (_i_3694805 + (1 : stdgo.GoInt) : stdgo.GoInt));
                        if ((@:checkr _d ?? throw "null pointer dereference")._err != null) {
