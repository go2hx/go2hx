...
@:structInit @:using(stdgo._internal.compress.flate.Flate_t_decompressor_static_extension.T_decompressor_static_extension) class T_decompressor {
    ...
    public var _bits : stdgo.Ref<stdgo.GoArray<stdgo.GoInt>> = new stdgo.GoArray<stdgo.GoInt>(316, 316).__setNumber32__().__setNil__().__setNil__();
    public var _codebits : stdgo.Ref<stdgo.GoArray<stdgo.GoInt>> = new stdgo.GoArray<stdgo.GoInt>(19, 19).__setNumber32__().__setNil__().__setNil__();
