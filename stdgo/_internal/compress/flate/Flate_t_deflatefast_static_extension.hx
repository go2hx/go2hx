        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if (((@:checkr _e ?? throw "null pointer dereference")._cur >= (2147352577 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 3685575i32;
                    } else {
                        _gotoNext = 3685719i32;
                    };
                } else if (__value__ == (3685575i32)) {
                    @:check2r _e._shiftOffsets();
                    _gotoNext = 3685719i32;
                } else if (__value__ == (3685719i32)) {
                    if (((_src.length) < (17 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3685756i32;
                    } else {
                        _gotoNext = 3686021i32;
                    };
                } else if (__value__ == (3685756i32)) {
                    ...
                    0i32;
                    _gotoNext = 3686214i32;
                } else if (__value__ == (3686214i32)) {
                    if (true) {
                        _gotoNext = 3686218i32;
                    } else {
                        _gotoNext = 3689709i32;
                    };
                } else if (__value__ == (3686218i32)) {
                    _skip_19 = (32 : stdgo.GoInt32);
                    _nextS_20 = _s_16;
                    0i32;
                    _gotoNext = 3687127i32;
                } else if (__value__ == (3687127i32)) {
                    if (true) {
                        _gotoNext = 3687131i32;
                    } else {
                        _gotoNext = 3687836i32;
                    };
                } else if (__value__ == (3687131i32)) {
                    _s_16 = _nextS_20;
                    ...
                    if ((_nextS_20 > _sLimit_14 : Bool)) {
                        _gotoNext = 3687281i32;
                    } else {
                        _gotoNext = 3687314i32;
                    };
                } else if (__value__ == (3687281i32)) {
                    _gotoNext = 3689709i32;
                } else if (__value__ == (3687314i32)) {
                    ...
                    if (((_offset_24 > (32768 : stdgo.GoInt32) : Bool) || (_cv_17 != _candidate_21._val) : Bool)) {
                        ...
                        _gotoNext = 3687649i32;
                    };
                } else if (__value__ == (3687577i32)) {
                    _cv_17 = _now_23;
                    0i32;
                    _gotoNext = 3687127i32;
                } else if (__value__ == (3687649i32)) {
                    _gotoNext = 3687836i32;
                } else if (__value__ == (3687836i32)) {
                    ...
                    0i32;
                    _gotoNext = 3688367i32;
                } else if (__value__ == (3688367i32)) {
                    if (true) {
                        _gotoNext = 3688371i32;
                    } else {
                        _gotoNext = 3686214i32;
                    };
                } else if (__value__ == (3688371i32)) {
                    ...
                    if ((_s_16 >= _sLimit_14 : Bool)) {
                        _gotoNext = 3688823i32;
                    } else {
                        _gotoNext = 3689223i32;
                    };
                } else if (__value__ == (3688823i32)) {
                    _gotoNext = 3689709i32;
                } else if (__value__ == (3689223i32)) {
                    ...
                    if (((_offset_30 > (32768 : stdgo.GoInt32) : Bool) || ((_x_27 : stdgo.GoUInt32) != _candidate_21._val) : Bool)) {
                        _gotoNext = 3689628i32;
                    } else {
                        _gotoNext = 3688367i32;
                    };
                } else if (__value__ == (3689628i32)) {
                    _cv_17 = ((_x_27 >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt64) : stdgo.GoUInt32);
                    _nextHash_18 = stdgo._internal.compress.flate.Flate__hash._hash(_cv_17);
                    _s_16++;
                    _gotoNext = 3686214i32;
                } else if (__value__ == (3689709i32)) {
                    _gotoNext = 3689709i32;
                    if (((_nextEmit_15 : stdgo.GoInt) < (_src.length) : Bool)) {
                        _gotoNext = 3689753i32;
                    } else {
                        _gotoNext = 3689800i32;
                    };
                } else if (__value__ == (3689753i32)) {
