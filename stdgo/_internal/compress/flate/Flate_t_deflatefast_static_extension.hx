        ...
        while (_gotoNext != ((-1i64 : stdgo.GoInt))) {
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    ...
                    0i64;
                    _gotoNext = 3719690i64;
                } else if (__value__ == (3719690i64)) {
                    //"file://#L0"
                    if (true) {
                        _gotoNext = 3719694i64;
                    } else {
                        _gotoNext = 3723185i64;
                    };
                } else if (__value__ == (3719694i64)) {
                    _skip_19 = (32 : stdgo.GoInt32);
                    _nextS_20 = _s_16;
                    0i64;
                    _gotoNext = 3720603i64;
                } else if (__value__ == (3720603i64)) {
                    //"file://#L0"
                    if (true) {
                        _gotoNext = 3720607i64;
                    } else {
                        _gotoNext = 3721312i64;
                    };
                    ...
                    if ((_nextS_20 > _sLimit_14 : Bool)) {
                        _gotoNext = 3720757i64;
                    } else {
                        _gotoNext = 3720790i64;
                    };
                } else if (__value__ == (3720757i64)) {
                    _gotoNext = 3723185i64;
                } else if (__value__ == (3720790i64)) {
                    ...
                    if (((_offset_24 > (32768 : stdgo.GoInt32) : Bool) || (_cv_17 != _candidate_21._val) : Bool)) {
                        _gotoNext = 3721053i64;
                    } else {
                        _gotoNext = 3721125i64;
                    };
                } else if (__value__ == (3721053i64)) {
                    _cv_17 = _now_23;
                    0i64;
                    _gotoNext = 3720603i64;
                } else if (__value__ == (3721125i64)) {
                    _gotoNext = 3721312i64;
                } else if (__value__ == (3721312i64)) {
                    ...
                    0i64;
                    _gotoNext = 3721843i64;
                } else if (__value__ == (3721843i64)) {
                    //"file://#L0"
                    if (true) {
                        _gotoNext = 3721847i64;
                    } else {
                        _gotoNext = 3719690i64;
                    };
                } else if (__value__ == (3721847i64)) {
                    ...
                    if ((_s_16 >= _sLimit_14 : Bool)) {
                        _gotoNext = 3722299i64;
                    } else {
                        _gotoNext = 3722699i64;
                    };
                } else if (__value__ == (3722299i64)) {
                    _gotoNext = 3723185i64;
                } else if (__value__ == (3722699i64)) {
                    ...
                    if (((_offset_30 > (32768 : stdgo.GoInt32) : Bool) || ((_x_27 : stdgo.GoUInt32) != _candidate_21._val) : Bool)) {
                        _gotoNext = 3723104i64;
                    } else {
                        _gotoNext = 3721843i64;
                    };
                } else if (__value__ == (3723104i64)) {
