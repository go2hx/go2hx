        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if (((@:checkr _e ?? throw "null pointer dereference")._cur >= (2147352577 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 3663808i32;
                    } else {
                        _gotoNext = 3663952i32;
                    };
                } else if (__value__ == (3663808i32)) {
                    @:check2r _e._shiftOffsets();
                    _gotoNext = 3663952i32;
                } else if (__value__ == (3663952i32)) {
                    if (((_src.length) < (17 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3663989i32;
                    } else {
                        _gotoNext = 3664254i32;
                    };
                } else if (__value__ == (3663989i32)) {
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 3664447i32;
                } else if (__value__ == (3664447i32)) {
                    if (true) {
                        _gotoNext = 3664451i32;
                    } else {
                        _gotoNext = 3667942i32;
                    };
                } else if (__value__ == (3664451i32)) {
                    _skip_19 = (32 : stdgo.GoInt32);
                    _nextS_20 = _s_16;
                    var __blank__ = 0i32;
                    _gotoNext = 3665360i32;
                } else if (__value__ == (3665360i32)) {
                    if (true) {
                        _gotoNext = 3665364i32;
                    } else {
                        _gotoNext = 3666069i32;
                    };
                } else if (__value__ == (3665364i32)) {
                    _s_16 = _nextS_20;
                    ...
                    if ((_nextS_20 > _sLimit_14 : Bool)) {
                        _gotoNext = 3665514i32;
                    } else {
                        _gotoNext = 3665547i32;
                    };
                } else if (__value__ == (3665514i32)) {
                    _gotoNext = 3667942i32;
                } else if (__value__ == (3665547i32)) {
                    ...
                    if (((_offset_24 > (32768 : stdgo.GoInt32) : Bool) || (_cv_17 != _candidate_21._val) : Bool)) {
                        _gotoNext = 3665810i32;
                    } else {
                        _gotoNext = 3665882i32;
                    };
                } else if (__value__ == (3665810i32)) {
                    _cv_17 = _now_23;
                    var __blank__ = 0i32;
                    _gotoNext = 3665360i32;
                } else if (__value__ == (3665882i32)) {
                    _gotoNext = 3666069i32;
                } else if (__value__ == (3666069i32)) {
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 3666600i32;
                } else if (__value__ == (3666600i32)) {
                    if (true) {
                        _gotoNext = 3666604i32;
                    } else {
                        _gotoNext = 3664447i32;
                    };
                } else if (__value__ == (3666604i32)) {
                    ...
                    if ((_s_16 >= _sLimit_14 : Bool)) {
                        ...
                        _gotoNext = 3667456i32;
                    };
                } else if (__value__ == (3667056i32)) {
                    _gotoNext = 3667942i32;
                } else if (__value__ == (3667456i32)) {
                    ...
                    if (((_offset_30 > (32768 : stdgo.GoInt32) : Bool) || ((_x_27 : stdgo.GoUInt32) != _candidate_21._val) : Bool)) {
                        _gotoNext = 3667861i32;
                    } else {
                        _gotoNext = 3666600i32;
                    };
                } else if (__value__ == (3667861i32)) {
                    _cv_17 = ((_x_27 >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt64) : stdgo.GoUInt32);
                    _nextHash_18 = stdgo._internal.compress.flate.Flate__hash._hash(_cv_17);
                    _s_16++;
                    _gotoNext = 3664447i32;
                } else if (__value__ == (3667942i32)) {
                    _gotoNext = 3667942i32;
                    if (((_nextEmit_15 : stdgo.GoInt) < (_src.length) : Bool)) {
                        _gotoNext = 3667986i32;
                    } else {
                        _gotoNext = 3668033i32;
                    };
                } else if (__value__ == (3667986i32)) {
