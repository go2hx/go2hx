        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if (((@:checkr _e ?? throw "null pointer dereference")._cur >= (2147352577 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 3700226i32;
                    } else {
                        _gotoNext = 3700370i32;
                    };
                } else if (__value__ == (3700226i32)) {
                    @:check2r _e._shiftOffsets();
                    _gotoNext = 3700370i32;
                } else if (__value__ == (3700370i32)) {
                    if (((_src.length) < (17 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3700407i32;
                    } else {
                        _gotoNext = 3700672i32;
                    };
                } else if (__value__ == (3700407i32)) {
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 3700865i32;
                } else if (__value__ == (3700865i32)) {
                    if (true) {
                        _gotoNext = 3700869i32;
                    } else {
                        _gotoNext = 3704360i32;
                    };
                } else if (__value__ == (3700869i32)) {
                    _skip_19 = (32 : stdgo.GoInt32);
                    _nextS_20 = _s_16;
                    var __blank__ = 0i32;
                    _gotoNext = 3701778i32;
                } else if (__value__ == (3701778i32)) {
                    if (true) {
                        _gotoNext = 3701782i32;
                    } else {
                        _gotoNext = 3702487i32;
                    };
                } else if (__value__ == (3701782i32)) {
                    _s_16 = _nextS_20;
                    ...
                    if ((_nextS_20 > _sLimit_14 : Bool)) {
                        _gotoNext = 3701932i32;
                    } else {
                        _gotoNext = 3701965i32;
                    };
                } else if (__value__ == (3701932i32)) {
                    _gotoNext = 3704360i32;
                } else if (__value__ == (3701965i32)) {
                    ...
                    if (((_offset_24 > (32768 : stdgo.GoInt32) : Bool) || (_cv_17 != _candidate_21._val) : Bool)) {
                        _gotoNext = 3702228i32;
                    } else {
                        _gotoNext = 3702300i32;
                    };
                } else if (__value__ == (3702228i32)) {
                    _cv_17 = _now_23;
                    var __blank__ = 0i32;
                    _gotoNext = 3701778i32;
                } else if (__value__ == (3702300i32)) {
                    _gotoNext = 3702487i32;
                } else if (__value__ == (3702487i32)) {
                    ...
                    if (true) {
                        _gotoNext = 3703022i32;
                    } else {
                        _gotoNext = 3700865i32;
                    };
                } else if (__value__ == (3703022i32)) {
                    ...
                    if ((_s_16 >= _sLimit_14 : Bool)) {
                        _gotoNext = 3703474i32;
                    } else {
                        _gotoNext = 3703874i32;
                    };
                } else if (__value__ == (3703474i32)) {
                    _gotoNext = 3704360i32;
                } else if (__value__ == (3703874i32)) {
                    ...
                    if (((_offset_30 > (32768 : stdgo.GoInt32) : Bool) || ((_x_27 : stdgo.GoUInt32) != _candidate_21._val) : Bool)) {
                        _gotoNext = 3704279i32;
                    } else {
                        _gotoNext = 3703018i32;
                    };
                } else if (__value__ == (3704279i32)) {
                    _cv_17 = ((_x_27 >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt64) : stdgo.GoUInt32);
                    _nextHash_18 = stdgo._internal.compress.flate.Flate__hash._hash(_cv_17);
                    _s_16++;
                    _gotoNext = 3700865i32;
                } else if (__value__ == (3704360i32)) {
                    _gotoNext = 3704360i32;
                    if (((_nextEmit_15 : stdgo.GoInt) < (_src.length) : Bool)) {
                        _gotoNext = 3704404i32;
                    } else {
                        _gotoNext = 3704451i32;
                    };
                } else if (__value__ == (3704404i32)) {
