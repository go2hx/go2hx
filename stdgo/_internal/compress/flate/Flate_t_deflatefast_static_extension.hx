        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _candidate_3650193 = (@:checkr _e ?? throw "null pointer dereference")._table[((_nextHash_3649280 & (16383u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)];
                    _now_3650446 = stdgo._internal.compress.flate.Flate__load32._load32(_src, _nextS_3650176);
                    (@:checkr _e ?? throw "null pointer dereference")._table[((_nextHash_3649280 & (16383u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)] = ({ _offset : (_s_3649243 + (@:checkr _e ?? throw "null pointer dereference")._cur : stdgo.GoInt32), _val : _cv_3649258 } : stdgo._internal.compress.flate.Flate_t_tableentry.T_tableEntry);
                    _nextHash_3649280 = stdgo._internal.compress.flate.Flate__hash._hash(_now_3650446);
                    _offset_3650572 = (_s_3649243 - ((_candidate_3650193._offset - (@:checkr _e ?? throw "null pointer dereference")._cur : stdgo.GoInt32)) : stdgo.GoInt32);
                    ...
                    _t_3651635 = ((_candidate_3650193._offset - (@:checkr _e ?? throw "null pointer dereference")._cur : stdgo.GoInt32) + (4 : stdgo.GoInt32) : stdgo.GoInt32);
                    _l_3651672 = @:check2r _e._matchLen(_s_3649243, _t_3651635, _src);
                    ...
                    (@:checkr _e ?? throw "null pointer dereference")._table[((_prevHash_3652337 & (16383u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)] = ({ _offset : (((@:checkr _e ?? throw "null pointer dereference")._cur + _s_3649243 : stdgo.GoInt32) - (1 : stdgo.GoInt32) : stdgo.GoInt32), _val : (_x_3652312 : stdgo.GoUInt32) } : stdgo._internal.compress.flate.Flate_t_tableentry.T_tableEntry);
                    ...
                    _candidate_3650193 = (@:checkr _e ?? throw "null pointer dereference")._table[((_currHash_3652462 & (16383u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)];
                    (@:checkr _e ?? throw "null pointer dereference")._table[((_currHash_3652462 & (16383u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)] = ({ _offset : ((@:checkr _e ?? throw "null pointer dereference")._cur + _s_3649243 : stdgo.GoInt32), _val : (_x_3652312 : stdgo.GoUInt32) } : stdgo._internal.compress.flate.Flate_t_tableentry.T_tableEntry);
                    _offset_3652616 = (_s_3649243 - ((_candidate_3650193._offset - (@:checkr _e ?? throw "null pointer dereference")._cur : stdgo.GoInt32)) : stdgo.GoInt32);
