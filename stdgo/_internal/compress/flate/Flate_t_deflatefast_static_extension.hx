        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _candidate_3726731 = (@:checkr _e ?? throw "null pointer dereference")._table[((_nextHash_3725818 & (16383u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)];
                    _now_3726984 = stdgo._internal.compress.flate.Flate__load32._load32(_src, _nextS_3726714);
                    (@:checkr _e ?? throw "null pointer dereference")._table[((_nextHash_3725818 & (16383u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)] = ({ _offset : (_s_3725781 + (@:checkr _e ?? throw "null pointer dereference")._cur : stdgo.GoInt32), _val : _cv_3725796 } : stdgo._internal.compress.flate.Flate_t_tableentry.T_tableEntry);
                    _nextHash_3725818 = stdgo._internal.compress.flate.Flate__hash._hash(_now_3726984);
                    _offset_3727110 = (_s_3725781 - ((_candidate_3726731._offset - (@:checkr _e ?? throw "null pointer dereference")._cur : stdgo.GoInt32)) : stdgo.GoInt32);
                    ...
                    _t_3728173 = ((_candidate_3726731._offset - (@:checkr _e ?? throw "null pointer dereference")._cur : stdgo.GoInt32) + (4 : stdgo.GoInt32) : stdgo.GoInt32);
                    _l_3728210 = @:check2r _e._matchLen(_s_3725781, _t_3728173, _src);
                    ...
                    (@:checkr _e ?? throw "null pointer dereference")._table[((_prevHash_3728875 & (16383u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)] = ({ _offset : (((@:checkr _e ?? throw "null pointer dereference")._cur + _s_3725781 : stdgo.GoInt32) - (1 : stdgo.GoInt32) : stdgo.GoInt32), _val : (_x_3728850 : stdgo.GoUInt32) } : stdgo._internal.compress.flate.Flate_t_tableentry.T_tableEntry);
                    ...
                    _candidate_3726731 = (@:checkr _e ?? throw "null pointer dereference")._table[((_currHash_3729000 & (16383u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)];
                    (@:checkr _e ?? throw "null pointer dereference")._table[((_currHash_3729000 & (16383u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)] = ({ _offset : ((@:checkr _e ?? throw "null pointer dereference")._cur + _s_3725781 : stdgo.GoInt32), _val : (_x_3728850 : stdgo.GoUInt32) } : stdgo._internal.compress.flate.Flate_t_tableentry.T_tableEntry);
                    _offset_3729154 = (_s_3725781 - ((_candidate_3726731._offset - (@:checkr _e ?? throw "null pointer dereference")._cur : stdgo.GoInt32)) : stdgo.GoInt32);
