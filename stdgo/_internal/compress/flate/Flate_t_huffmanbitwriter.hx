...
@:structInit @:using(stdgo._internal.compress.flate.Flate_t_huffmanbitwriter_static_extension.T_huffmanBitWriter_static_extension) class T_huffmanBitWriter {
    ...
    public var _bytes : stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(248, 248).__setNumber32__().__setNil__();
    public var _codegenFreq : stdgo.GoArray<stdgo.GoInt32> = new stdgo.GoArray<stdgo.GoInt32>(19, 19).__setNumber32__().__setNil__();
