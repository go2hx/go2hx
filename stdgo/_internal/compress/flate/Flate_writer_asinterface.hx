...
class Writer_asInterface {
    @:keep
    @:tdfield
    public dynamic function reset(_dst:stdgo._internal.io.Io_writer.Writer):Void @:_0 __self__.value.reset(_dst);
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.compress.flate.Flate_writerpointer.WriterPointer;
