...
@:keep @:allow(stdgo._internal.compress.flate.Flate.Writer_asInterface) class Writer_static_extension {
    ...
    static public function reset( _w:stdgo.Ref<stdgo._internal.compress.flate.Flate_writer.Writer>, _dst:stdgo._internal.io.Io_writer.Writer):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/compress/flate/deflate.go#L737"
        {
            var __tmp__ = try {
            ...
            if (_ok) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/compress/flate/deflate.go#L740"
                (@:checkr _w ?? throw "null pointer dereference")._d._reset(stdgo.Go.asInterface(_dw));
                //"file:///home/runner/.go/go1.21.3/src/compress/flate/deflate.go#L741"
                (@:checkr _w ?? throw "null pointer dereference")._d._fillWindow((@:checkr _w ?? throw "null pointer dereference")._dict);
            } else {
                //"file:///home/runner/.go/go1.21.3/src/compress/flate/deflate.go#L744"
                (@:checkr _w ?? throw "null pointer dereference")._d._reset(_dst);
            };
        };
    }
    @:keep
    ...
    static public function close( _w:stdgo.Ref<stdgo._internal.compress.flate.Flate_writer.Writer>):stdgo.Error {
        @:recv var _w:stdgo.Ref<stdgo._internal.compress.flate.Flate_writer.Writer> = _w;
        //"file:///home/runner/.go/go1.21.3/src/compress/flate/deflate.go#L730"
        return (@:checkr _w ?? throw "null pointer dereference")._d._close();
    }
    @:keep
    @:tdfield
    static public function flush( _w:stdgo.Ref<stdgo._internal.compress.flate.Flate_writer.Writer>):stdgo.Error {
        @:recv var _w:stdgo.Ref<stdgo._internal.compress.flate.Flate_writer.Writer> = _w;
        //"file:///home/runner/.go/go1.21.3/src/compress/flate/deflate.go#L725"
        return (@:checkr _w ?? throw "null pointer dereference")._d._syncFlush();
    }
    @:keep
    @:tdfield
    static public function write( _w:stdgo.Ref<stdgo._internal.compress.flate.Flate_writer.Writer>, _data:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/compress/flate/deflate.go#L710"
        return (@:checkr _w ?? throw "null pointer dereference")._d._write(_data);
    }
}
