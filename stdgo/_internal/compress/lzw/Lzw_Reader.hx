...
@:structInit @:using(stdgo._internal.compress.lzw.Lzw_Reader_static_extension.Reader_static_extension) class Reader {
    ...
    public var _suffix : stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(4096, 4096, ...[for (i in 0 ... 4096) (0 : stdgo.GoUInt8)]);
    public var _prefix : stdgo.GoArray<stdgo.GoUInt16> = new stdgo.GoArray<stdgo.GoUInt16>(4096, 4096, ...[for (i in 0 ... 4096) (0 : stdgo.GoUInt16)]);
    public var _output : stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(8192, 8192, ...[for (i in 0 ... 8192) (0 : stdgo.GoUInt8)]);
