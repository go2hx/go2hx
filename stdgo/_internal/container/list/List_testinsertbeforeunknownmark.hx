...
function testInsertBeforeUnknownMark(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        @:check2 _l.insertBefore(stdgo.Go.toInterface((1 : stdgo.GoInt)), (stdgo.Go.setRef(({} : stdgo._internal.container.list.List_element.Element)) : stdgo.Ref<stdgo._internal.container.list.List_element.Element>));
