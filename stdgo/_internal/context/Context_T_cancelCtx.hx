...
@:structInit @:using(stdgo._internal.context.Context_T_cancelCtx_static_extension.T_cancelCtx_static_extension) class T_cancelCtx {
    ...
    public var _done : _internal.sync.atomic_.Atomic__Value.Value = ({} : _internal.sync.atomic_.Atomic__Value.Value);
    ...
    public function new(?context:stdgo._internal.context.Context_Context.Context, ?_mu:stdgo._internal.sync.Sync_Mutex.Mutex, ?_done:_internal.sync.atomic_.Atomic__Value.Value, ?_children:stdgo.GoMap<stdgo._internal.context.Context_T_canceler.T_canceler, stdgo._internal.context.Context_T_deadlineExceededError.T_deadlineExceededError>, ?_err:stdgo.Error, ?_cause:stdgo.Error) {
