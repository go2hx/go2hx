...
function testCTRAble(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/aes/modes_test.go#L105"
        {
            var __tmp__ = try {
            ...
            if (!_ok) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/aes/modes_test.go#L106"
                _t.fatalf(("testBlock does not implement the ctrAble interface" : stdgo.GoString));
            };
        };
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/aes/modes_test.go#L109"
        {
            var __tmp__ = try {
            ...
            if (!_ok) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/aes/modes_test.go#L110"
                _t.fatalf(("cipher.NewCTR did not use ctrAble interface" : stdgo.GoString));
            };
        };
    }
