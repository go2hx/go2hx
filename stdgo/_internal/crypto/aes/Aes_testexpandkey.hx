        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 4730749i32;
                } else if (__value__ == (4730749i32)) {
                    if ((0i32 : stdgo.GoInt) < (stdgo._internal.crypto.aes.Aes__keytests._keyTests.length)) {
                        _gotoNext = 4731416i32;
                    } else {
                        _gotoNext = 4731419i32;
                    };
                } else if (__value__ == (4730757i32)) {
                    _i_0++;
                    _gotoNext = 4731417i32;
                } else if (__value__ == (4730781i32)) {
                    ...
                    _gotoNext = 4731273i32;
                } else if (__value__ == (4731273i32)) {
                    if (_j_4 < (_enc_2.length)) {
                        _gotoNext = 4731158i32;
                    } else {
                        _gotoNext = 4731277i32;
                    };
                } else if (__value__ == (4731277i32)) {
                    if ((0i32 : stdgo.GoInt) < (_dec_3.length)) {
                        _gotoNext = 4731413i32;
                    } else {
                        _gotoNext = 4730757i32;
                    };
                } else if (__value__ == (4731281i32)) {
                    _j_6++;
                    _gotoNext = 4731414i32;
                } else if (__value__ == (4731299i32)) {
                    _v_7 = _dec_3[(_j_6 : stdgo.GoInt)];
                    if (_v_7 != (_tt_1._dec[(_j_6 : stdgo.GoInt)])) {
                        _gotoNext = 4731322i32;
                    } else {
                        _gotoNext = 4731281i32;
                    };
                } else if (__value__ == (4731322i32)) {
                    ...
                    _gotoNext = 4731414i32;
                } else if (__value__ == (4731414i32)) {
                    if (_j_6 < (_dec_3.length)) {
                        _gotoNext = 4731299i32;
                    } else {
                        _gotoNext = 4730757i32;
                    };
                } else if (__value__ == (4731416i32)) {
                    {
                        final __tmp__0 = 0i32;
                    ...
                    _gotoNext = 4731417i32;
                } else if (__value__ == (4731417i32)) {
                    if (_i_0 < (stdgo._internal.crypto.aes.Aes__keytests._keyTests.length)) {
                        _gotoNext = 4730781i32;
                    } else {
                        _gotoNext = 4731419i32;
                    };
                } else if (__value__ == (4731419i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
