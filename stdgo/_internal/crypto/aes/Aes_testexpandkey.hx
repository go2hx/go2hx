...
function testExpandKey(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        while (_gotoNext != ((-1i64 : stdgo.GoInt))) {
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    _gotoNext = 4997420i64;
                } else if (__value__ == (4997420i64)) {
                    ...
                    if ((0i64 : stdgo.GoInt) < (stdgo._internal.crypto.aes.Aes__keytests._keyTests.length)) {
                        _gotoNext = 4998087i64;
                    } else {
                        _gotoNext = 4998090i64;
                    };
                } else if (__value__ == (4997428i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/aes/aes_test.go#L218"
                    _i_0++;
                    _gotoNext = 4998088i64;
                } else if (__value__ == (4997452i64)) {
                    ...
                    if ((0i64 : stdgo.GoInt) < (_enc_2.length)) {
                        _gotoNext = 4997943i64;
                    } else {
                        _gotoNext = 4997948i64;
                    };
                } else if (__value__ == (4997811i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/aes/aes_test.go#L228"
                    _j_4++;
                    _gotoNext = 4997944i64;
                } else if (__value__ == (4997829i64)) {
                    ...
                    if (_v_5 != (_tt_1._enc[(_j_4 : stdgo.GoInt)])) {
                        _gotoNext = 4997852i64;
                    } else {
                        _gotoNext = 4997811i64;
                    };
                } else if (__value__ == (4997852i64)) {
                    ...
                    _gotoNext = 4997944i64;
                } else if (__value__ == (4997944i64)) {
                    //"file://#L0"
                    if (_j_4 < (_enc_2.length)) {
                        _gotoNext = 4997829i64;
                    } else {
                        _gotoNext = 4997948i64;
                    };
                } else if (__value__ == (4997948i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/aes/aes_test.go#L234"
                    if ((0i64 : stdgo.GoInt) < (_dec_3.length)) {
                        _gotoNext = 4998084i64;
                    } else {
                        _gotoNext = 4997428i64;
                    };
                } else if (__value__ == (4997952i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/aes/aes_test.go#L234"
                    _j_6++;
                    _gotoNext = 4998085i64;
                } else if (__value__ == (4997970i64)) {
                    ...
                    if (_v_7 != (_tt_1._dec[(_j_6 : stdgo.GoInt)])) {
                        _gotoNext = 4997993i64;
                    } else {
                        _gotoNext = 4997952i64;
                    };
                } else if (__value__ == (4997993i64)) {
                    ...
                    _gotoNext = 4998085i64;
                } else if (__value__ == (4998085i64)) {
                    //"file://#L0"
                    if (_j_6 < (_dec_3.length)) {
                        _gotoNext = 4997970i64;
                    } else {
                        _gotoNext = 4997428i64;
                    };
                } else if (__value__ == (4998087i64)) {
                    {
                        final __tmp__0 = 0i64;
                    ...
                    _gotoNext = 4998088i64;
                } else if (__value__ == (4998088i64)) {
                    //"file://#L0"
                    if (_i_0 < (stdgo._internal.crypto.aes.Aes__keytests._keyTests.length)) {
                        _gotoNext = 4997452i64;
                    } else {
                        _gotoNext = 4998090i64;
                    };
                } else if (__value__ == (4998090i64)) {
                    _gotoNext = -1i64;
                };
            };
        };
