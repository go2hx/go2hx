        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 5072829i32;
                } else if (__value__ == (5072829i32)) {
                    if ((0i32 : stdgo.GoInt) < (stdgo._internal.crypto.aes.Aes__keytests._keyTests.length)) {
                        _gotoNext = 5073496i32;
                    } else {
                        _gotoNext = 5073499i32;
                    };
                } else if (__value__ == (5072837i32)) {
                    _i_0++;
                    _gotoNext = 5073497i32;
                } else if (__value__ == (5072861i32)) {
                    ...
                    _gotoNext = 5073353i32;
                } else if (__value__ == (5073353i32)) {
                    if (_j_4 < (_enc_2.length)) {
                        _gotoNext = 5073238i32;
                    } else {
                        _gotoNext = 5073357i32;
                    };
                } else if (__value__ == (5073357i32)) {
                    if ((0i32 : stdgo.GoInt) < (_dec_3.length)) {
                        _gotoNext = 5073493i32;
                    } else {
                        _gotoNext = 5072837i32;
                    };
                } else if (__value__ == (5073361i32)) {
                    _j_6++;
                    _gotoNext = 5073494i32;
                } else if (__value__ == (5073379i32)) {
                    _v_7 = _dec_3[(_j_6 : stdgo.GoInt)];
                    if (_v_7 != (_tt_1._dec[(_j_6 : stdgo.GoInt)])) {
                        _gotoNext = 5073402i32;
                    } else {
                        _gotoNext = 5073361i32;
                    };
                } else if (__value__ == (5073402i32)) {
                    ...
                    _gotoNext = 5073494i32;
                } else if (__value__ == (5073494i32)) {
                    if (_j_6 < (_dec_3.length)) {
                        _gotoNext = 5073379i32;
                    } else {
                        _gotoNext = 5072837i32;
                    };
                } else if (__value__ == (5073496i32)) {
                    {
                        final __tmp__0 = 0i32;
                    ...
                    _gotoNext = 5073497i32;
                } else if (__value__ == (5073497i32)) {
                    if (_i_0 < (stdgo._internal.crypto.aes.Aes__keytests._keyTests.length)) {
                        _gotoNext = 5072861i32;
                    } else {
                        _gotoNext = 5073499i32;
                    };
                } else if (__value__ == (5073499i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
