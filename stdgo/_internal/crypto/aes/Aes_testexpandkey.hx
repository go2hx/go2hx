...
function testExpandKey(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        while (_gotoNext != ((-1i64 : stdgo.GoInt))) {
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    _gotoNext = 4828321i64;
                } else if (__value__ == (4828321i64)) {
                    ...
                    if ((0i64 : stdgo.GoInt) < (stdgo._internal.crypto.aes.Aes__keytests._keyTests.length)) {
                        _gotoNext = 4828988i64;
                    } else {
                        _gotoNext = 4828991i64;
                    };
                } else if (__value__ == (4828329i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/aes/aes_test.go#L218"
                    _i_0++;
                    _gotoNext = 4828989i64;
                } else if (__value__ == (4828353i64)) {
                    ...
                    if ((0i64 : stdgo.GoInt) < (_enc_2.length)) {
                        _gotoNext = 4828844i64;
                    } else {
                        _gotoNext = 4828849i64;
                    };
                } else if (__value__ == (4828712i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/aes/aes_test.go#L228"
                    _j_4++;
                    _gotoNext = 4828845i64;
                } else if (__value__ == (4828730i64)) {
                    ...
                    if (_v_5 != (_tt_1._enc[(_j_4 : stdgo.GoInt)])) {
                        _gotoNext = 4828753i64;
                    } else {
                        _gotoNext = 4828712i64;
                    };
                } else if (__value__ == (4828753i64)) {
                    ...
                    _gotoNext = 4828845i64;
                } else if (__value__ == (4828845i64)) {
                    //"file://#L0"
                    if (_j_4 < (_enc_2.length)) {
                        _gotoNext = 4828730i64;
                    } else {
                        _gotoNext = 4828849i64;
                    };
                } else if (__value__ == (4828849i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/aes/aes_test.go#L234"
                    if ((0i64 : stdgo.GoInt) < (_dec_3.length)) {
                        _gotoNext = 4828985i64;
                    } else {
                        _gotoNext = 4828329i64;
                    };
                } else if (__value__ == (4828853i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/aes/aes_test.go#L234"
                    _j_6++;
                    _gotoNext = 4828986i64;
                } else if (__value__ == (4828871i64)) {
                    ...
                    if (_v_7 != (_tt_1._dec[(_j_6 : stdgo.GoInt)])) {
                        _gotoNext = 4828894i64;
                    } else {
                        _gotoNext = 4828853i64;
                    };
                } else if (__value__ == (4828894i64)) {
                    ...
                    _gotoNext = 4828986i64;
                } else if (__value__ == (4828986i64)) {
                    //"file://#L0"
                    if (_j_6 < (_dec_3.length)) {
                        _gotoNext = 4828871i64;
                    } else {
                        _gotoNext = 4828329i64;
                    };
                } else if (__value__ == (4828988i64)) {
                    {
                        final __tmp__0 = 0i64;
                    ...
                    _gotoNext = 4828989i64;
                } else if (__value__ == (4828989i64)) {
                    //"file://#L0"
                    if (_i_0 < (stdgo._internal.crypto.aes.Aes__keytests._keyTests.length)) {
                        _gotoNext = 4828353i64;
                    } else {
                        _gotoNext = 4828991i64;
                    };
                } else if (__value__ == (4828991i64)) {
                    _gotoNext = -1i64;
                };
            };
        };
