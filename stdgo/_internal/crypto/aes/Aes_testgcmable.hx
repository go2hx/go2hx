...
function testGCMAble(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/aes/modes_test.go#L53"
        {
            var __tmp__ = try {
            ...
            if (!_ok) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/aes/modes_test.go#L54"
                _t.fatalf(("testBlock does not implement the gcmAble interface" : stdgo.GoString));
            };
        };
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/aes/modes_test.go#L57"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/aes/modes_test.go#L58"
            _t.fatalf(("%v" : stdgo.GoString), stdgo.Go.toInterface(_err));
        };
        //"file:///home/runner/.go/go1.21.3/src/crypto/aes/modes_test.go#L60"
        {
            var __tmp__ = try {
            ...
            if (!_ok) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/aes/modes_test.go#L61"
                _t.fatalf(("cipher.NewGCM did not use gcmAble interface" : stdgo.GoString));
            };
        };
    }
