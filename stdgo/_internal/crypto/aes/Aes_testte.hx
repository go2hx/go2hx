...
function testTe(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        //"file:///home/runner/.go/go1.21.3/src/crypto/aes/aes_test.go#L89"
        {
...
//"file:///home/runner/.go/go1.21.3/src/crypto/aes/aes_test.go#L95"
                {
                    var _j = (0 : stdgo.GoInt);
                    while ((_j < (4 : stdgo.GoInt) : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/crypto/aes/aes_test.go#L96"
                        {
                            var _x = (_te[(_j : stdgo.GoInt)][(_i : stdgo.GoInt)] : stdgo.GoUInt32);
                            if (_x != (_w)) {
                                //"file:///home/runner/.go/go1.21.3/src/crypto/aes/aes_test.go#L97"
                                _t.fatalf(("te[%d][%d] = %#x, want %#x" : stdgo.GoString), stdgo.Go.toInterface(_j), stdgo.Go.toInterface(_i), stdgo.Go.toInterface(_x), stdgo.Go.toInterface(_w));
                            };
                        };
