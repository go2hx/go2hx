...
function testDESDecryptBlock(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        //"file:///home/runner/.go/go1.21.3/src/crypto/des/des_test.go#L1327"
        for (_i => _tt in stdgo._internal.crypto.des.Des__encryptdestests._encryptDESTests) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/des/des_test.go#L1330"
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/des/des_test.go#L1332"
            if (!stdgo._internal.bytes.Bytes_equal.equal(_plain, _tt._in)) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/des/des_test.go#L1333"
