...
function testInversePermutationKnownAnswer(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        //"file:///home/runner/.go/go1.21.3/src/crypto/des/des_test.go#L1395"
        for (_i => _tt in stdgo._internal.crypto.des.Des__tablea1tests._tableA1Tests) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/des/des_test.go#L1399"
            _c.encrypt(_plain, _tt._out);
            //"file:///home/runner/.go/go1.21.3/src/crypto/des/des_test.go#L1401"
            if (!stdgo._internal.bytes.Bytes_equal.equal(_plain, _tt._in)) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/des/des_test.go#L1402"
