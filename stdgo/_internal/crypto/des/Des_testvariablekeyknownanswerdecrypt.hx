...
function testVariableKeyKnownAnswerDecrypt(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        //"file:///home/runner/.go/go1.21.3/src/crypto/des/des_test.go#L1439"
        for (_i => _tt in stdgo._internal.crypto.des.Des__tablea2tests._tableA2Tests) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/des/des_test.go#L1443"
            _c.decrypt(_out, _tt._out);
            //"file:///home/runner/.go/go1.21.3/src/crypto/des/des_test.go#L1445"
            if (!stdgo._internal.bytes.Bytes_equal.equal(_out, stdgo._internal.crypto.des.Des__tablea2plaintext._tableA2Plaintext)) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/des/des_test.go#L1446"
                _t.errorf(("#%d: result: %x want: %x" : stdgo.GoString), stdgo.Go.toInterface(_i), stdgo.Go.toInterface(_out), stdgo.Go.toInterface(stdgo._internal.crypto.des.Des__tablea2plaintext._tableA2Plaintext));
            };
        };
    }
