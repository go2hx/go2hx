...
function testVariablePlaintextKnownAnswer(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        //"file:///home/runner/.go/go1.21.3/src/crypto/des/des_test.go#L1365"
        for (_i => _tt in stdgo._internal.crypto.des.Des__tablea1tests._tableA1Tests) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/des/des_test.go#L1369"
            _c.encrypt(_out, _tt._in);
            //"file:///home/runner/.go/go1.21.3/src/crypto/des/des_test.go#L1371"
            if (!stdgo._internal.bytes.Bytes_equal.equal(_out, _tt._out)) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/des/des_test.go#L1372"
