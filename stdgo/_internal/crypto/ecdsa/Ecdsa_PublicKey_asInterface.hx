...
class PublicKey_asInterface {
    ...
    @:keep
    public dynamic function ecdh():{ var _0 : stdgo.Ref<_internal.crypto.ecdh.Ecdh_PublicKey.PublicKey>; var _1 : stdgo.Error; } return __self__.value.ecdh();
    @:embedded
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.crypto.ecdsa.Ecdsa_PublicKey.PublicKey>;
