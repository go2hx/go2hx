...
var _s = __3, _r = __2, _kInv = __1, _k = __0;
        ...
        return {
            final __tmp__:{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } = stdgo._internal.crypto.ecdsa.Ecdsa__encodeSignature._encodeSignature(_r.bytes(), _s.bytes());
            _sig = __tmp__._0;
            _err = __tmp__._1;
            __tmp__;
        };
