...
var _publicKey = __1, _seed = __0;
        ...
        var __tmp__ = @:check2r _internal.crypto.internal.edwards25519.Edwards25519_newScalar.newScalar().setUniformBytes(_messageDigest), _r:stdgo.Ref<_internal.crypto.internal.edwards25519.Edwards25519_Scalar.Scalar> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            throw stdgo.Go.toInterface(("ed25519: internal error: setting scalar failed" : stdgo.GoString));
        };
        var r = @:check2r (stdgo.Go.setRef((new _internal.crypto.internal.edwards25519.Edwards25519_Point.Point() : _internal.crypto.internal.edwards25519.Edwards25519_Point.Point)) : stdgo.Ref<_internal.crypto.internal.edwards25519.Edwards25519_Point.Point>).scalarBaseMult(_r);
        ...
        var s = @:check2r _internal.crypto.internal.edwards25519.Edwards25519_newScalar.newScalar().multiplyAdd(_k, _s, _r);
