...
@:keep @:allow(stdgo._internal.crypto.ed25519.Ed25519.PrivateKey_asInterface) class PrivateKey_static_extension {
    ...
    static public function sign( _priv:stdgo._internal.crypto.ed25519.Ed25519_privatekey.PrivateKey, _rand:stdgo._internal.io.Io_reader.Reader, _message:stdgo.Slice<stdgo.GoUInt8>, _opts:stdgo._internal.crypto.Crypto_signeropts.SignerOpts):{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L91"
        {
            var __tmp__ = try {
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L94"
        if (_hash == ((7u32 : stdgo._internal.crypto.Crypto_hash.Hash))) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L96"
            {
                var _l = (_message.length : stdgo.GoInt);
                if (_l != ((64 : stdgo.GoInt))) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L97"
                    return {
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L99"
            {
                var _l = (_context.length : stdgo.GoInt);
                if ((_l > (255 : stdgo.GoInt) : Bool)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L100"
                    return {
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L103"
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L104"
            return {
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L106"
            {
                var _l = (_context.length : stdgo.GoInt);
                if ((_l > (255 : stdgo.GoInt) : Bool)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L107"
                    return {
            ...
            var _signature = (new stdgo.Slice<stdgo.GoUInt8>((64 : stdgo.GoInt).toBasic(), 0).__setNumber32__() : stdgo.Slice<stdgo.GoUInt8>);
            //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L110"
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L111"
            return {
                @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } = { _0 : _signature, _1 : (null : stdgo.Error) };
                _signature = __tmp__._0;
                _err = __tmp__._1;
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L113"
            return {
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L115"
            return {
    ...
    static public function seed( _priv:stdgo._internal.crypto.ed25519.Ed25519_privatekey.PrivateKey):stdgo.Slice<stdgo.GoUInt8> {
        @:recv var _priv:stdgo._internal.crypto.ed25519.Ed25519_privatekey.PrivateKey = _priv;
        //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L76"
    ...
    static public function equal( _priv:stdgo._internal.crypto.ed25519.Ed25519_privatekey.PrivateKey, _x:stdgo._internal.crypto.Crypto_privatekey.PrivateKey):Bool {
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L66"
        if (!_ok) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L67"
            return false;
        };
        //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L69"
    ...
    static public function public_( _priv:stdgo._internal.crypto.ed25519.Ed25519_privatekey.PrivateKey):stdgo._internal.crypto.Crypto_publickey.PublicKey {
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L59"
        _publicKey.__copyTo__((_priv.__slice__((32 : stdgo.GoInt)) : stdgo._internal.crypto.ed25519.Ed25519_privatekey.PrivateKey));
        //"file:///home/runner/.go/go1.21.3/src/crypto/ed25519/ed25519.go#L60"
