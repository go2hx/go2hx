...
@:keep @:allow(stdgo._internal.crypto.elliptic.Elliptic.T_nistCurve_asInterface) class T_nistCurve_static_extension {
    ...
    @:keep
    static public function unmarshal<Dynamic>( _curve:stdgo.Ref<stdgo._internal.crypto.elliptic.Elliptic_T_nistCurve.T_nistCurve<Dynamic>>, _data:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.Ref<stdgo._internal.math.big.Big_Int_.Int_>; var _1 : stdgo.Ref<stdgo._internal.math.big.Big_Int_.Int_>; } throw "generic function";
    @:keep
    ...
    @:keep
    static public function _normalizeScalar<Dynamic>( _curve:stdgo.Ref<stdgo._internal.crypto.elliptic.Elliptic_T_nistCurve.T_nistCurve<Dynamic>>, _scalar:stdgo.Slice<stdgo.GoUInt8>):stdgo.Slice<stdgo.GoUInt8> throw "generic function";
    @:keep
    ...
    @:keep
    static public function _pointToAffine<Dynamic>( _curve:stdgo.Ref<stdgo._internal.crypto.elliptic.Elliptic_T_nistCurve.T_nistCurve<Dynamic>>, _p:Dynamic):{ var _0 : stdgo.Ref<stdgo._internal.math.big.Big_Int_.Int_>; var _1 : stdgo.Ref<stdgo._internal.math.big.Big_Int_.Int_>; } throw "generic function";
    @:keep
    static public function _pointFromAffine<Dynamic>( _curve:stdgo.Ref<stdgo._internal.crypto.elliptic.Elliptic_T_nistCurve.T_nistCurve<Dynamic>>, _x:stdgo.Ref<stdgo._internal.math.big.Big_Int_.Int_>, _y:stdgo.Ref<stdgo._internal.math.big.Big_Int_.Int_>):{ var _0 : Dynamic; var _1 : stdgo.Error; } throw "generic function";
    @:keep
    static public function isOnCurve<Dynamic>( _curve:stdgo.Ref<stdgo._internal.crypto.elliptic.Elliptic_T_nistCurve.T_nistCurve<Dynamic>>, _x:stdgo.Ref<stdgo._internal.math.big.Big_Int_.Int_>, _y:stdgo.Ref<stdgo._internal.math.big.Big_Int_.Int_>):Bool throw "generic function";
    @:keep
    static public function params<Dynamic>( _curve:stdgo.Ref<stdgo._internal.crypto.elliptic.Elliptic_T_nistCurve.T_nistCurve<Dynamic>>):stdgo.Ref<stdgo._internal.crypto.elliptic.Elliptic_CurveParams.CurveParams> throw "generic function";
}
