...
function new_(_h:() -> stdgo._internal.hash.Hash_Hash.Hash, _key:stdgo.Slice<stdgo.GoUInt8>):stdgo._internal.hash.Hash_Hash.Hash {
        ...
        try {
            ...
            {
                final __ret__:stdgo._internal.hash.Hash_Hash.Hash = stdgo.Go.asInterface(_hm);
                for (defer in __deferstack__) {
                    defer();
                };
                return __ret__;
            ...
            {
                final __ret__:stdgo._internal.hash.Hash_Hash.Hash = (null : stdgo._internal.hash.Hash_Hash.Hash);
                for (defer in __deferstack__) {
                    defer();
                };
                if (stdgo.Go.recover_exception != null) throw stdgo.Go.recover_exception;
