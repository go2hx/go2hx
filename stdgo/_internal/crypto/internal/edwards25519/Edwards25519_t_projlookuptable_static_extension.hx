...
@:keep @:allow(stdgo._internal.crypto.internal.edwards25519.Edwards25519.T_projLookupTable_asInterface) class T_projLookupTable_static_extension {
    ...
    static public function selectInto( _v:stdgo.Ref<stdgo._internal.crypto.internal.edwards25519.Edwards25519_t_projlookuptable.T_projLookupTable>, _dest:stdgo.Ref<stdgo._internal.crypto.internal.edwards25519.Edwards25519_t_projcached.T_projCached>, _x:stdgo.GoInt8):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/internal/edwards25519/tables.go#L95"
        _dest.zero();
        //"file:///home/runner/.go/go1.21.3/src/crypto/internal/edwards25519/tables.go#L96"
        {
...
//"file:///home/runner/.go/go1.21.3/src/crypto/internal/edwards25519/tables.go#L99"
                _dest.select((stdgo.Go.setRef((@:checkr _v ?? throw "null pointer dereference")._points[(_j - (1 : stdgo.GoInt) : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.crypto.internal.edwards25519.Edwards25519_t_projcached.T_projCached>), _dest, _cond);
                _j++;
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/crypto/internal/edwards25519/tables.go#L102"
    ...
    static public function fromP3( _v:stdgo.Ref<stdgo._internal.crypto.internal.edwards25519.Edwards25519_t_projlookuptable.T_projLookupTable>, _q:stdgo.Ref<stdgo._internal.crypto.internal.edwards25519.Edwards25519_point.Point>):Void {
        @:recv var _v:stdgo.Ref<stdgo._internal.crypto.internal.edwards25519.Edwards25519_t_projlookuptable.T_projLookupTable> = _v;
        //"file:///home/runner/.go/go1.21.3/src/crypto/internal/edwards25519/tables.go#L37"
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/internal/edwards25519/tables.go#L40"
        {
            var _i = (0 : stdgo.GoInt);
            while ((_i < (7 : stdgo.GoInt) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/internal/edwards25519/tables.go#L44"
                (@:checkr _v ?? throw "null pointer dereference")._points[(_i + (1 : stdgo.GoInt) : stdgo.GoInt)].fromP3(_tmpP3._fromP1xP1(_tmpP1xP1.add(_q, (stdgo.Go.setRef((@:checkr _v ?? throw "null pointer dereference")._points[(_i : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.crypto.internal.edwards25519.Edwards25519_t_projcached.T_projCached>))));
                _i++;
            };
        };
    }
