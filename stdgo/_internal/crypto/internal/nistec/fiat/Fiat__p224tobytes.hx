...
function _p224ToBytes(_out1:stdgo.Ref<stdgo.GoArray<stdgo.GoUInt8>>, _arg1:stdgo.Ref<stdgo.GoArray<stdgo.GoUInt64>>):Void {
        ...
        var _x52 = ((_x50 >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt64) : stdgo.GoUInt8);
