...
function _p521CmovznzU64(_out1:stdgo.Pointer<stdgo.GoUInt64>, _arg1:stdgo._internal.crypto.internal.nistec.fiat.Fiat_t_p521uint1.T_p521Uint1, _arg2:stdgo.GoUInt64, _arg3:stdgo.GoUInt64):Void {
