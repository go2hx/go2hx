...
function maybeReadByte(_r:stdgo._internal.io.Io_reader.Reader):Void {
        //"file:///home/runner/.go/go1.21.3/src/crypto/internal/randutil/randutil.go#L26"
        stdgo._internal.crypto.internal.randutil.Randutil__closedchanonce._closedChanOnce.do_(function():Void {
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/internal/randutil/randutil.go#L28"
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/internal/randutil/randutil.go#L31"
        {
            var __select__ = true;
            var __c__0 = null;
var __c__1 = null;
            while (__select__) {
                if ({
                    ...
                    __select__ = false;
                    {
                        __c__0.__get__();
                        {
                            //"file:///home/runner/.go/go1.21.3/src/crypto/internal/randutil/randutil.go#L33"
                            return;
                        };
                    };
                } else if ({
                    ...
                    __select__ = false;
                    {
                        __c__1.__get__();
                        {
                            ...
                            //"file:///home/runner/.go/go1.21.3/src/crypto/internal/randutil/randutil.go#L36"
