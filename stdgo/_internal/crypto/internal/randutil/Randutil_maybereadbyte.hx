...
function maybeReadByte(_r:stdgo._internal.io.Io_reader.Reader):Void {
        ...
        });
        {
            var __select__ = true;
            while (__select__) {
                if (stdgo._internal.crypto.internal.randutil.Randutil__closedchan._closedChan != null && stdgo._internal.crypto.internal.randutil.Randutil__closedchan._closedChan.__isGet__(true)) {
                    __select__ = false;
                    {
                ...
                } else if (stdgo._internal.crypto.internal.randutil.Randutil__closedchan._closedChan != null && stdgo._internal.crypto.internal.randutil.Randutil__closedchan._closedChan.__isGet__(true)) {
                    __select__ = false;
                    {
                        stdgo._internal.crypto.internal.randutil.Randutil__closedchan._closedChan.__get__();
                        {
                            var _buf:stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(1, 1).__setNumber32__().__setNil__();
            ...
            stdgo._internal.crypto.internal.randutil.Randutil__closedchan._closedChan.__reset__();
stdgo._internal.crypto.internal.randutil.Randutil__closedchan._closedChan.__reset__();
        };
    }
