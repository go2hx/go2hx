...
function _decryptPKCS1v15(_priv:stdgo.Ref<stdgo._internal.crypto.rsa.Rsa_privatekey.PrivateKey>, _ciphertext:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Slice<stdgo.GoUInt8>; var _2 : stdgo.GoInt; var _3 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L186"
        if ((_k < (11 : stdgo.GoInt) : Bool)) {
            _err = stdgo._internal.crypto.rsa.Rsa_errdecryption.errDecryption;
            //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L188"
            return { _0 : _valid, _1 : _em, _2 : _index, _3 : _err };
        };
        //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L191"
        if (false) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L194"
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L195"
                return { _0 : _valid, _1 : _em, _2 : _index, _3 : _err };
            };
            {
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L198"
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L199"
                return { _0 : _valid, _1 : _em, _2 : _index, _3 : _err };
            };
        } else {
            {
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L203"
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L204"
                return { _0 : _valid, _1 : _em, _2 : _index, _3 : _err };
            };
        };
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L217"
        {
...
_lookingForIndex = stdgo._internal.crypto.subtle.Subtle_constanttimeselect.constantTimeSelect(_equals0, (0 : stdgo.GoInt), _lookingForIndex);
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L229"
        return {
