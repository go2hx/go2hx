...
function _pkcs1v15HashInfo(_hash:stdgo._internal.crypto.Crypto_Hash.Hash, _inLen:stdgo.GoInt):{ var _0 : stdgo.GoInt; var _1 : stdgo.Slice<stdgo.GoUInt8>; var _2 : stdgo.Error; } {
        ...
        if (_hash == ((0u32 : stdgo._internal.crypto.Crypto_Hash.Hash))) {
            return { _0 : _hashLen = _inLen, _1 : _prefix = (null : stdgo.Slice<stdgo.GoUInt8>), _2 : _err = (null : stdgo.Error) };
        };
        _hashLen = _hash.size();
        if (_inLen != (_hashLen)) {
            return { _0 : _hashLen = (0 : stdgo.GoInt), _1 : _prefix = (null : stdgo.Slice<stdgo.GoUInt8>), _2 : _err = stdgo._internal.errors.Errors_new_.new_(("crypto/rsa: input must be hashed message" : stdgo.GoString)) };
        };
        ...
        if (!_ok) {
            return { _0 : _hashLen = (0 : stdgo.GoInt), _1 : _prefix = (null : stdgo.Slice<stdgo.GoUInt8>), _2 : _err = stdgo._internal.errors.Errors_new_.new_(("crypto/rsa: unsupported hash function" : stdgo.GoString)) };
        };
