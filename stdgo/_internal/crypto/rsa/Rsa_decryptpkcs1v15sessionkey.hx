...
function decryptPKCS1v15SessionKey(_random:stdgo._internal.io.Io_reader.Reader, _priv:stdgo.Ref<stdgo._internal.crypto.rsa.Rsa_privatekey.PrivateKey>, _ciphertext:stdgo.Slice<stdgo.GoUInt8>, _key:stdgo.Slice<stdgo.GoUInt8>):stdgo.Error {
        //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L154"
        {
            ...
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L155"
                return _err;
            };
        };
        var _k = (_priv.size() : stdgo.GoInt);
        //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L158"
        if (((_k - ((((_key.length) + (3 : stdgo.GoInt) : stdgo.GoInt) + (8 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.GoInt) < (0 : stdgo.GoInt) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L159"
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L163"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L164"
            return _err;
        };
        //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L167"
        if ((_em.length) != (_k)) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L170"
            return stdgo._internal.crypto.rsa.Rsa_errdecryption.errDecryption;
        };
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L174"
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/rsa/pkcs1v15.go#L175"
