...
class T_digest_asInterface {
    @:keep
    public dynamic function _constSum():stdgo.GoArray<stdgo.GoUInt8> return __self__.value._constSum();
    @:keep
    public dynamic function constantTimeSum(_in:stdgo.Slice<stdgo.GoUInt8>):stdgo.Slice<stdgo.GoUInt8> return __self__.value.constantTimeSum(_in);
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.crypto.sha1.Sha1_T_digest.T_digest>;
