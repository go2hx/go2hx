...
function _blockGeneric(_dig:stdgo.Ref<stdgo._internal.crypto.sha512.Sha512_t_digest.T_digest>, _p:stdgo.Slice<stdgo.GoUInt8>):Void {
        var _w:stdgo.GoArray<stdgo.GoUInt64> = new stdgo.GoArray<stdgo.GoUInt64>(80, 80).__setNumber64__().__setNil__();
...
_a = (_t1 + _t2 : stdgo.GoUInt64);
        ...
        };
        {
            ...
            __tmp__8[__tmp__9] = @:binopAssign __tmp__0;
            __tmp__10[__tmp__11] = @:binopAssign __tmp__1;
            __tmp__12[__tmp__13] = @:binopAssign __tmp__2;
            __tmp__14[__tmp__15] = @:binopAssign __tmp__3;
            __tmp__16[__tmp__17] = @:binopAssign __tmp__4;
            __tmp__18[__tmp__19] = @:binopAssign __tmp__5;
            __tmp__20[__tmp__21] = @:binopAssign __tmp__6;
            __tmp__22[__tmp__23] = @:binopAssign __tmp__7;
        };
    }
