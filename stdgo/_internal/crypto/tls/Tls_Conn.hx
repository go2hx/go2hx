...
@:structInit @:using(stdgo._internal.crypto.tls.Tls_Conn_static_extension.Conn_static_extension) class Conn {
    ...
    public var _isHandshakeComplete : _internal.sync.atomic_.Atomic__Bool_.Bool_ = ({} : _internal.sync.atomic_.Atomic__Bool_.Bool_);
