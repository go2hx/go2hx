...
class Conn_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function _makeClientHello():{ var _0 : stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_clientHelloMsg.T_clientHelloMsg>; var _1 : stdgo.Ref<_internal.crypto.ecdh.Ecdh_PrivateKey.PrivateKey>; var _2 : stdgo.Error; } return @:_0 __self__.value._makeClientHello();
    @:keep
    @:tdfield
