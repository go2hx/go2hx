...
@:keep @:allow(stdgo._internal.crypto.tls.Tls.T_serverHandshakeStateTLS13_asInterface) class T_serverHandshakeStateTLS13_static_extension {
    ...
    static public function _processClientHello( _hs:stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_serverHandshakeStateTLS13.T_serverHandshakeStateTLS13>):stdgo.Error {
        @:recv var _hs:stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_serverHandshakeStateTLS13.T_serverHandshakeStateTLS13> = _hs;
        var _i_6001718_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _suiteID_6000816:stdgo.GoUInt16 = (0 : stdgo.GoUInt16);
        var _i_6000827_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _err_5999473:stdgo.Error = (null : stdgo.Error);
        var _key_6002304:stdgo.Ref<_internal.crypto.ecdh.Ecdh_PrivateKey.PrivateKey> = (null : stdgo.Ref<_internal.crypto.ecdh.Ecdh_PrivateKey.PrivateKey>);
        var _ok_6002150:Bool = false;
        var _err_6002014:stdgo.Error = (null : stdgo.Error);
        var _selectedGroup_6001357:stdgo._internal.crypto.tls.Tls_CurveID.CurveID = ((0 : stdgo.GoUInt16) : stdgo._internal.crypto.tls.Tls_CurveID.CurveID);
        var _preferenceList_6000632:stdgo.Slice<stdgo.GoUInt16> = (null : stdgo.Slice<stdgo.GoUInt16>);
        var _id_5998783:stdgo.GoUInt16 = (0 : stdgo.GoUInt16);
        var _c_5997688:stdgo.Ref<stdgo._internal.crypto.tls.Tls_Conn.Conn> = (null : stdgo.Ref<stdgo._internal.crypto.tls.Tls_Conn.Conn>);
        var _group_6001709:stdgo._internal.crypto.tls.Tls_CurveID.CurveID = ((0 : stdgo.GoUInt16) : stdgo._internal.crypto.tls.Tls_CurveID.CurveID);
        var _ks_6001496:stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare = ({} : stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare);
        var _preferredGroup_6001433:stdgo._internal.crypto.tls.Tls_CurveID.CurveID = ((0 : stdgo.GoUInt16) : stdgo._internal.crypto.tls.Tls_CurveID.CurveID);
        var _peerKey_6002519:stdgo.Ref<_internal.crypto.ecdh.Ecdh_PublicKey.PublicKey> = (null : stdgo.Ref<_internal.crypto.ecdh.Ecdh_PublicKey.PublicKey>);
        var _err_6002309:stdgo.Error = (null : stdgo.Error);
        var _clientKeyShare_6001384:stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare> = (null : stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare>);
        var _i_5998789_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _selectedProto_6002842:stdgo.GoString = ("" : stdgo.GoString);
        var _i_6001502_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_6001451_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _hs._hello._supportedVersion = _c_5997688._vers;
                    if ((_hs._clientHello._supportedVersions.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5997983i32;
                    } else {
                        _gotoNext = 5998776i32;
                    };
                } else if (__value__ == (5997983i32)) {
                    _c_5997688._sendAlert((47 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    ...
                    _gotoNext = 5998776i32;
                } else if (__value__ == (5998776i32)) {
                    if ((0i32 : stdgo.GoInt) < (_hs._clientHello._cipherSuites.length)) {
                        _gotoNext = 5999194i32;
                    } else {
                        _gotoNext = 5999199i32;
                    };
                } else if (__value__ == (5998780i32)) {
                    _i_5998789_0++;
                    _gotoNext = 5999195i32;
                } else if (__value__ == (5998823i32)) {
                    _id_5998783 = _hs._clientHello._cipherSuites[(_i_5998789_0 : stdgo.GoInt)];
                    if (_id_5998783 == ((22016 : stdgo.GoUInt16))) {
                        _gotoNext = 5998854i32;
                    } else {
                        _gotoNext = 5998780i32;
                    };
                } else if (__value__ == (5998854i32)) {
                    if ((_c_5997688._vers < _c_5997688._config._maxSupportedVersion(false) : Bool)) {
                        _gotoNext = 5999055i32;
                    } else {
                        _gotoNext = 5999184i32;
                    };
                } else if (__value__ == (5999055i32)) {
                    _c_5997688._sendAlert((86 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: client using inappropriate protocol fallback" : stdgo.GoString));
                    _gotoNext = 5999184i32;
                } else if (__value__ == (5999184i32)) {
                    _gotoNext = 5999199i32;
                } else if (__value__ == (5999194i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _hs._clientHello._cipherSuites[(0i32 : stdgo.GoInt)];
                        _i_5998789_0 = __tmp__0;
                        _id_5998783 = __tmp__1;
                    };
                    _gotoNext = 5999195i32;
                } else if (__value__ == (5999195i32)) {
                    if (_i_5998789_0 < (_hs._clientHello._cipherSuites.length)) {
                        _gotoNext = 5998823i32;
                    } else {
                        _gotoNext = 5999199i32;
                    };
                } else if (__value__ == (5999199i32)) {
                    if (((_hs._clientHello._compressionMethods.length != (1 : stdgo.GoInt)) || (_hs._clientHello._compressionMethods[(0 : stdgo.GoInt)] != (0 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 5999307i32;
                    } else {
                        _gotoNext = 5999431i32;
                    };
                } else if (__value__ == (5999307i32)) {
                    _c_5997688._sendAlert((47 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: TLS 1.3 client supports illegal compression methods" : stdgo.GoString));
                    _gotoNext = 5999431i32;
                } else if (__value__ == (5999431i32)) {
                    _hs._hello._random = (new stdgo.Slice<stdgo.GoUInt8>((32 : stdgo.GoInt).toBasic(), 0).__setNumber32__() : stdgo.Slice<stdgo.GoUInt8>);
                    {
                        {
                            var __tmp__ = stdgo._internal.io.Io_readFull.readFull(_c_5997688._config._rand(), _hs._hello._random);
                            _err_5999473 = __tmp__._1;
                        };
                        if (_err_5999473 != null) {
                            _gotoNext = 5999538i32;
                        } else {
                            _gotoNext = 5999592i32;
                        };
                    };
                } else if (__value__ == (5999538i32)) {
                    _c_5997688._sendAlert((80 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return _err_5999473;
                    _gotoNext = 5999592i32;
                } else if (__value__ == (5999592i32)) {
                    if ((_hs._clientHello._secureRenegotiation.length) != ((0 : stdgo.GoInt))) {
                        _gotoNext = 5999640i32;
                    } else {
                        _gotoNext = 5999768i32;
                    };
                } else if (__value__ == (5999640i32)) {
                    _c_5997688._sendAlert((40 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    ...
                    _gotoNext = 5999768i32;
                } else if (__value__ == (5999768i32)) {
                    if ((_hs._clientHello._earlyData && (_c_5997688._quic != null && ((_c_5997688._quic : Dynamic).__nil__ == null || !(_c_5997688._quic : Dynamic).__nil__)) : Bool)) {
                        _gotoNext = 5999813i32;
                    } else if (_hs._clientHello._earlyData) {
                        _gotoNext = 6000002i32;
                    } else {
                        _gotoNext = 6000538i32;
                    };
                    ...
                    _gotoNext = 6000538i32;
                } else if (__value__ == (6000002i32)) {
                    _c_5997688._sendAlert((110 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: client sent unexpected early data" : stdgo.GoString));
                    _gotoNext = 6000538i32;
                } else if (__value__ == (6000538i32)) {
                    _hs._hello._sessionId = _hs._clientHello._sessionId;
                    _hs._hello._compressionMethod = (0 : stdgo.GoUInt8);
                    _preferenceList_6000632 = stdgo._internal.crypto.tls.Tls__defaultCipherSuitesTLS13._defaultCipherSuitesTLS13;
                    if ((!stdgo._internal.crypto.tls.Tls__hasAESGCMHardwareSupport._hasAESGCMHardwareSupport || !stdgo._internal.crypto.tls.Tls__aesgcmPreferred._aesgcmPreferred(_hs._clientHello._cipherSuites) : Bool)) {
                        _gotoNext = 6000754i32;
                    } else {
                        _gotoNext = 6000809i32;
                    };
                } else if (__value__ == (6000754i32)) {
                    _preferenceList_6000632 = stdgo._internal.crypto.tls.Tls__defaultCipherSuitesTLS13NoAES._defaultCipherSuitesTLS13NoAES;
                    _gotoNext = 6000809i32;
                } else if (__value__ == (6000809i32)) {
                    if ((0i32 : stdgo.GoInt) < (_preferenceList_6000632.length)) {
                        _gotoNext = 6000960i32;
                    } else {
                        _gotoNext = 6000964i32;
                    };
                } else if (__value__ == (6000813i32)) {
                    _i_6000827_0++;
                    _gotoNext = 6000961i32;
                } else if (__value__ == (6000848i32)) {
                    _suiteID_6000816 = _preferenceList_6000632[(_i_6000827_0 : stdgo.GoInt)];
                    _hs._suite = stdgo._internal.crypto.tls.Tls__mutualCipherSuiteTLS13._mutualCipherSuiteTLS13(_hs._clientHello._cipherSuites, _suiteID_6000816);
                    if ((_hs._suite != null && ((_hs._suite : Dynamic).__nil__ == null || !(_hs._suite : Dynamic).__nil__))) {
                        _gotoNext = 6000945i32;
                    } else {
                        _gotoNext = 6000813i32;
                    };
                } else if (__value__ == (6000945i32)) {
                    _gotoNext = 6000964i32;
                } else if (__value__ == (6000960i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _preferenceList_6000632[(0i32 : stdgo.GoInt)];
                        _i_6000827_0 = __tmp__0;
                        _suiteID_6000816 = __tmp__1;
                    };
                    _gotoNext = 6000961i32;
                } else if (__value__ == (6000961i32)) {
                    if (_i_6000827_0 < (_preferenceList_6000632.length)) {
                        _gotoNext = 6000848i32;
                    } else {
                        _gotoNext = 6000964i32;
                    };
                } else if (__value__ == (6000964i32)) {
                    if ((_hs._suite == null || (_hs._suite : Dynamic).__nil__)) {
                        _gotoNext = 6000983i32;
                    } else {
                        _gotoNext = 6001106i32;
                    };
                } else if (__value__ == (6000983i32)) {
                    _c_5997688._sendAlert((40 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: no cipher suite supported by both client and server" : stdgo.GoString));
                    _gotoNext = 6001106i32;
                } else if (__value__ == (6001106i32)) {
                    _c_5997688._cipherSuite = _hs._suite._id;
                    _hs._hello._cipherSuite = _hs._suite._id;
                    _hs._transcript = _hs._suite._hash.new_();
                    _gotoNext = 6001409i32;
                } else if (__value__ == (6001409i32)) {
                    if ((0i32 : stdgo.GoInt) < (_c_5997688._config._curvePreferences().length)) {
                        _gotoNext = 6001834i32;
                    } else {
                        _gotoNext = 6001838i32;
                    };
                } else if (__value__ == (6001430i32)) {
                    _i_6001451_0++;
                    _gotoNext = 6001835i32;
                } else if (__value__ == (6001485i32)) {
                    _preferredGroup_6001433 = _c_5997688._config._curvePreferences()[(_i_6001451_0 : stdgo.GoInt)];
                    if ((0i32 : stdgo.GoInt) < (_hs._clientHello._keyShares.length)) {
                        _gotoNext = 6001655i32;
                    } else {
                        _gotoNext = 6001660i32;
                    };
                } else if (__value__ == (6001493i32)) {
                    _i_6001502_0++;
                    _gotoNext = 6001656i32;
                } else if (__value__ == (6001533i32)) {
                    _ks_6001496 = _hs._clientHello._keyShares[(_i_6001502_0 : stdgo.GoInt)];
                    if (_ks_6001496._group == (_preferredGroup_6001433)) {
                        _gotoNext = 6001568i32;
                    } else {
                        _gotoNext = 6001493i32;
                    };
                } else if (__value__ == (6001568i32)) {
                    _selectedGroup_6001357 = _ks_6001496._group;
                    _clientKeyShare_6001384 = (stdgo.Go.setRef(_ks_6001496) : stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare>);
                    stdgo._internal.crypto.tls.Tls_groupSelectionBreak.groupSelectionBreak = true;
                    _gotoNext = 6001835i32;
                } else if (__value__ == (6001655i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _hs._clientHello._keyShares[(0i32 : stdgo.GoInt)];
                        _i_6001502_0 = __tmp__0;
                        _ks_6001496 = __tmp__1;
                    };
                    _gotoNext = 6001656i32;
                } else if (__value__ == (6001656i32)) {
                    if (_i_6001502_0 < (_hs._clientHello._keyShares.length)) {
                        _gotoNext = 6001533i32;
                    } else {
                        _gotoNext = 6001660i32;
                    };
                } else if (__value__ == (6001660i32)) {
                    if (_selectedGroup_6001357 != ((0 : stdgo._internal.crypto.tls.Tls_CurveID.CurveID))) {
                        _gotoNext = 6001682i32;
                    } else {
                        _gotoNext = 6001702i32;
                    };
                } else if (__value__ == (6001682i32)) {
                    _i_6001451_0++;
                    _gotoNext = 6001835i32;
                } else if (__value__ == (6001702i32)) {
                    if ((0i32 : stdgo.GoInt) < (_hs._clientHello._supportedCurves.length)) {
                        _gotoNext = 6001831i32;
                    } else {
                        _gotoNext = 6001430i32;
                    };
                } else if (__value__ == (6001706i32)) {
                    _i_6001718_0++;
                    _gotoNext = 6001832i32;
                } else if (__value__ == (6001755i32)) {
                    _group_6001709 = _hs._clientHello._supportedCurves[(_i_6001718_0 : stdgo.GoInt)];
                    if (_group_6001709 == (_preferredGroup_6001433)) {
                        _gotoNext = 6001787i32;
                    } else {
                        _gotoNext = 6001706i32;
                    };
                } else if (__value__ == (6001787i32)) {
                    _selectedGroup_6001357 = _group_6001709;
                    _gotoNext = 6001430i32;
                } else if (__value__ == (6001831i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _hs._clientHello._supportedCurves[(0i32 : stdgo.GoInt)];
                        _i_6001718_0 = __tmp__0;
                        _group_6001709 = __tmp__1;
                    };
                    _gotoNext = 6001832i32;
                } else if (__value__ == (6001832i32)) {
                    if (_i_6001718_0 < (_hs._clientHello._supportedCurves.length)) {
                        _gotoNext = 6001755i32;
                    } else {
                        _gotoNext = 6001430i32;
                    };
                } else if (__value__ == (6001834i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _c_5997688._config._curvePreferences()[(0i32 : stdgo.GoInt)];
                        _i_6001451_0 = __tmp__0;
                        _preferredGroup_6001433 = __tmp__1;
                    };
                    _gotoNext = 6001835i32;
                } else if (__value__ == (6001835i32)) {
                    if (_i_6001451_0 < (_c_5997688._config._curvePreferences().length)) {
                        _gotoNext = 6001485i32;
                    } else {
                        _gotoNext = 6001838i32;
                    };
                } else if (__value__ == (6001838i32)) {
                    if (_selectedGroup_6001357 == ((0 : stdgo._internal.crypto.tls.Tls_CurveID.CurveID))) {
                        _gotoNext = 6001860i32;
                    } else {
                        _gotoNext = 6001982i32;
                    };
                } else if (__value__ == (6001860i32)) {
                    _c_5997688._sendAlert((40 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: no ECDHE curve supported by both client and server" : stdgo.GoString));
                    _gotoNext = 6001982i32;
                } else if (__value__ == (6001982i32)) {
                    if ((_clientKeyShare_6001384 == null || (_clientKeyShare_6001384 : Dynamic).__nil__)) {
                        _gotoNext = 6002007i32;
                    } else {
                        _gotoNext = 6002144i32;
                    };
                } else if (__value__ == (6002007i32)) {
                    {
                        _err_6002014 = _hs._doHelloRetryRequest(_selectedGroup_6001357);
                        if (_err_6002014 != null) {
                            _gotoNext = 6002071i32;
                        } else {
                            _gotoNext = 6002093i32;
                        };
                    };
                } else if (__value__ == (6002071i32)) {
                    return _err_6002014;
                    _gotoNext = 6002093i32;
                } else if (__value__ == (6002093i32)) {
                    _clientKeyShare_6001384 = (stdgo.Go.setRef(_hs._clientHello._keyShares[(0 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare>);
                    _gotoNext = 6002144i32;
                } else if (__value__ == (6002144i32)) {
                    {
                        {
                            var __tmp__ = stdgo._internal.crypto.tls.Tls__curveForCurveID._curveForCurveID(_selectedGroup_6001357);
                            _ok_6002150 = __tmp__._1;
                        };
                        if (!_ok_6002150) {
                            _gotoNext = 6002192i32;
                        } else {
                            _gotoNext = 6002304i32;
                        };
                    };
                } else if (__value__ == (6002192i32)) {
                    _c_5997688._sendAlert((80 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: CurvePreferences includes unsupported curve" : stdgo.GoString));
                    _gotoNext = 6002304i32;
                } else if (__value__ == (6002304i32)) {
                    {
                        var __tmp__ = stdgo._internal.crypto.tls.Tls__generateECDHEKey._generateECDHEKey(_c_5997688._config._rand(), _selectedGroup_6001357);
                        _key_6002304 = __tmp__._0;
                        _err_6002309 = __tmp__._1;
                    };
                    if (_err_6002309 != null) {
                        _gotoNext = 6002380i32;
                    } else {
                        _gotoNext = 6002433i32;
                    };
                } else if (__value__ == (6002380i32)) {
                    _c_5997688._sendAlert((80 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return _err_6002309;
                    _gotoNext = 6002433i32;
                } else if (__value__ == (6002433i32)) {
                    _hs._hello._serverShare = ({ _group : _selectedGroup_6001357, _data : _key_6002304.publicKey().bytes() } : stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare);
                    {
                        var __tmp__ = _key_6002304.curve().newPublicKey(_clientKeyShare_6001384._data);
                        _peerKey_6002519 = __tmp__._0;
                        _err_6002309 = __tmp__._1;
                    };
                    if (_err_6002309 != null) {
                        _gotoNext = 6002596i32;
                    } else {
                        _gotoNext = 6002692i32;
                    };
                } else if (__value__ == (6002596i32)) {
                    _c_5997688._sendAlert((47 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: invalid client key share" : stdgo.GoString));
                    _gotoNext = 6002692i32;
                } else if (__value__ == (6002692i32)) {
                    {
                        var __tmp__ = _key_6002304.ecdh(_peerKey_6002519);
                        _hs._sharedKey = __tmp__._0;
                        _err_6002309 = __tmp__._1;
                    };
                    if (_err_6002309 != null) {
                        _gotoNext = 6002745i32;
                    } else {
                        _gotoNext = 6002842i32;
                    };
                } else if (__value__ == (6002745i32)) {
                    _c_5997688._sendAlert((47 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: invalid client key share" : stdgo.GoString));
                    _gotoNext = 6002842i32;
                } else if (__value__ == (6002842i32)) {
                    {
                        var __tmp__ = stdgo._internal.crypto.tls.Tls__negotiateALPN._negotiateALPN(_c_5997688._config.nextProtos, _hs._clientHello._alpnProtocols, (_c_5997688._quic != null && ((_c_5997688._quic : Dynamic).__nil__ == null || !(_c_5997688._quic : Dynamic).__nil__)));
                        _selectedProto_6002842 = __tmp__._0?.__copy__();
                        _err_6002309 = __tmp__._1;
                    };
                    if (_err_6002309 != null) {
                        _gotoNext = 6002959i32;
                    } else {
                        _gotoNext = 6003020i32;
                    };
                } else if (__value__ == (6002959i32)) {
                    _c_5997688._sendAlert((120 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return _err_6002309;
                    _gotoNext = 6003020i32;
                } else if (__value__ == (6003020i32)) {
                    _c_5997688._clientProtocol = _selectedProto_6002842?.__copy__();
                    if ((_c_5997688._quic != null && ((_c_5997688._quic : Dynamic).__nil__ == null || !(_c_5997688._quic : Dynamic).__nil__))) {
                        _gotoNext = 6003072i32;
                    } else {
                        _gotoNext = 6003363i32;
                    };
                } else if (__value__ == (6003072i32)) {
                    if (_hs._clientHello._quicTransportParameters == null) {
                        _gotoNext = 6003125i32;
                    } else {
                        _gotoNext = 6003286i32;
                    };
                } else if (__value__ == (6003125i32)) {
                    _c_5997688._sendAlert((109 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    ...
                    _gotoNext = 6003286i32;
                } else if (__value__ == (6003286i32)) {
                    _c_5997688._quicSetTransportParameters(_hs._clientHello._quicTransportParameters);
                    _gotoNext = 6003560i32;
                } else if (__value__ == (6003363i32)) {
                    _gotoNext = 6003363i32;
                    if (_hs._clientHello._quicTransportParameters != null) {
                        _gotoNext = 6003416i32;
                    } else {
                        _gotoNext = 6003560i32;
                    };
                } else if (__value__ == (6003416i32)) {
                    _c_5997688._sendAlert((110 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    ...
                    _gotoNext = 6003560i32;
                } else if (__value__ == (6003560i32)) {
                    _c_5997688._serverName = _hs._clientHello._serverName?.__copy__();
                    return (null : stdgo.Error);
                    _gotoNext = -1i32;
                };
            };
