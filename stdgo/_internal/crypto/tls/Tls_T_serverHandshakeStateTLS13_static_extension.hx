...
@:keep @:allow(stdgo._internal.crypto.tls.Tls.T_serverHandshakeStateTLS13_asInterface) class T_serverHandshakeStateTLS13_static_extension {
    ...
    static public function _processClientHello( _hs:stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_serverHandshakeStateTLS13.T_serverHandshakeStateTLS13>):stdgo.Error {
        @:recv var _hs:stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_serverHandshakeStateTLS13.T_serverHandshakeStateTLS13> = _hs;
        var _i_5942292_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _selectedGroup_5942198:stdgo._internal.crypto.tls.Tls_CurveID.CurveID = ((0 : stdgo.GoUInt16) : stdgo._internal.crypto.tls.Tls_CurveID.CurveID);
        var _id_5939624:stdgo.GoUInt16 = (0 : stdgo.GoUInt16);
        var _c_5938529:stdgo.Ref<stdgo._internal.crypto.tls.Tls_Conn.Conn> = (null : stdgo.Ref<stdgo._internal.crypto.tls.Tls_Conn.Conn>);
        var _ok_5942991:Bool = false;
        var _i_5942559_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _ks_5942337:stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare = ({} : stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare);
        var _preferredGroup_5942274:stdgo._internal.crypto.tls.Tls_CurveID.CurveID = ((0 : stdgo.GoUInt16) : stdgo._internal.crypto.tls.Tls_CurveID.CurveID);
        var _err_5942855:stdgo.Error = (null : stdgo.Error);
        var _clientKeyShare_5942225:stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare> = (null : stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare>);
        var _i_5941668_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_5939630_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _key_5943145:stdgo.Ref<_internal.crypto.ecdh.Ecdh_PrivateKey.PrivateKey> = (null : stdgo.Ref<_internal.crypto.ecdh.Ecdh_PrivateKey.PrivateKey>);
        var _peerKey_5943360:stdgo.Ref<_internal.crypto.ecdh.Ecdh_PublicKey.PublicKey> = (null : stdgo.Ref<_internal.crypto.ecdh.Ecdh_PublicKey.PublicKey>);
        var _suiteID_5941657:stdgo.GoUInt16 = (0 : stdgo.GoUInt16);
        var _preferenceList_5941473:stdgo.Slice<stdgo.GoUInt16> = (null : stdgo.Slice<stdgo.GoUInt16>);
        var _err_5940314:stdgo.Error = (null : stdgo.Error);
        var _selectedProto_5943683:stdgo.GoString = ("" : stdgo.GoString);
        var _err_5943150:stdgo.Error = (null : stdgo.Error);
        var _group_5942550:stdgo._internal.crypto.tls.Tls_CurveID.CurveID = ((0 : stdgo.GoUInt16) : stdgo._internal.crypto.tls.Tls_CurveID.CurveID);
        var _i_5942343_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _hs._hello._supportedVersion = _c_5938529._vers;
                    if ((_hs._clientHello._supportedVersions.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5938824i32;
                    } else {
                        _gotoNext = 5939617i32;
                    };
                } else if (__value__ == (5938824i32)) {
                    _c_5938529._sendAlert((47 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    ...
                    _gotoNext = 5939617i32;
                } else if (__value__ == (5939617i32)) {
                    if ((0i32 : stdgo.GoInt) < (_hs._clientHello._cipherSuites.length)) {
                        _gotoNext = 5940035i32;
                    } else {
                        _gotoNext = 5940040i32;
                    };
                } else if (__value__ == (5939621i32)) {
                    _i_5939630_0++;
                    _gotoNext = 5940036i32;
                } else if (__value__ == (5939664i32)) {
                    _id_5939624 = _hs._clientHello._cipherSuites[(_i_5939630_0 : stdgo.GoInt)];
                    if (_id_5939624 == ((22016 : stdgo.GoUInt16))) {
                        _gotoNext = 5939695i32;
                    } else {
                        _gotoNext = 5939621i32;
                    };
                } else if (__value__ == (5939695i32)) {
                    if ((_c_5938529._vers < _c_5938529._config._maxSupportedVersion(false) : Bool)) {
                        _gotoNext = 5939896i32;
                    } else {
                        _gotoNext = 5940025i32;
                    };
                } else if (__value__ == (5939896i32)) {
                    _c_5938529._sendAlert((86 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: client using inappropriate protocol fallback" : stdgo.GoString));
                    _gotoNext = 5940025i32;
                } else if (__value__ == (5940025i32)) {
                    _gotoNext = 5940040i32;
                } else if (__value__ == (5940035i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _hs._clientHello._cipherSuites[(0i32 : stdgo.GoInt)];
                        _i_5939630_0 = __tmp__0;
                        _id_5939624 = __tmp__1;
                    };
                    _gotoNext = 5940036i32;
                } else if (__value__ == (5940036i32)) {
                    if (_i_5939630_0 < (_hs._clientHello._cipherSuites.length)) {
                        _gotoNext = 5939664i32;
                    } else {
                        _gotoNext = 5940040i32;
                    };
                } else if (__value__ == (5940040i32)) {
                    if (((_hs._clientHello._compressionMethods.length != (1 : stdgo.GoInt)) || (_hs._clientHello._compressionMethods[(0 : stdgo.GoInt)] != (0 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 5940148i32;
                    } else {
                        _gotoNext = 5940272i32;
                    };
                } else if (__value__ == (5940148i32)) {
                    _c_5938529._sendAlert((47 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: TLS 1.3 client supports illegal compression methods" : stdgo.GoString));
                    _gotoNext = 5940272i32;
                } else if (__value__ == (5940272i32)) {
                    _hs._hello._random = (new stdgo.Slice<stdgo.GoUInt8>((32 : stdgo.GoInt).toBasic(), 0).__setNumber32__() : stdgo.Slice<stdgo.GoUInt8>);
                    {
                        {
                            var __tmp__ = stdgo._internal.io.Io_readFull.readFull(_c_5938529._config._rand(), _hs._hello._random);
                            _err_5940314 = __tmp__._1;
                        };
                        if (_err_5940314 != null) {
                            _gotoNext = 5940379i32;
                        } else {
                            _gotoNext = 5940433i32;
                        };
                    };
                } else if (__value__ == (5940379i32)) {
                    _c_5938529._sendAlert((80 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return _err_5940314;
                    _gotoNext = 5940433i32;
                } else if (__value__ == (5940433i32)) {
                    if ((_hs._clientHello._secureRenegotiation.length) != ((0 : stdgo.GoInt))) {
                        _gotoNext = 5940481i32;
                    } else {
                        _gotoNext = 5940609i32;
                    };
                } else if (__value__ == (5940481i32)) {
                    _c_5938529._sendAlert((40 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    ...
                    if ((_hs._clientHello._earlyData && ((_c_5938529._quic != null) && ((_c_5938529._quic : Dynamic).__nil__ == null || !(_c_5938529._quic : Dynamic).__nil__)) : Bool)) {
                        _gotoNext = 5940654i32;
                    } else if (_hs._clientHello._earlyData) {
                        _gotoNext = 5940843i32;
                    } else {
                        _gotoNext = 5941379i32;
                    };
                } else if (__value__ == (5940654i32)) {
                    if ((_hs._clientHello._pskIdentities.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5940700i32;
                    } else {
                        _gotoNext = 5941379i32;
                    };
                } else if (__value__ == (5940700i32)) {
                    _c_5938529._sendAlert((47 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: early_data without pre_shared_key" : stdgo.GoString));
                    _gotoNext = 5941379i32;
                } else if (__value__ == (5940843i32)) {
                    _c_5938529._sendAlert((110 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: client sent unexpected early data" : stdgo.GoString));
                    _gotoNext = 5941379i32;
                } else if (__value__ == (5941379i32)) {
                    _hs._hello._sessionId = _hs._clientHello._sessionId;
                    _hs._hello._compressionMethod = (0 : stdgo.GoUInt8);
                    _preferenceList_5941473 = stdgo._internal.crypto.tls.Tls__defaultCipherSuitesTLS13._defaultCipherSuitesTLS13;
                    if ((!stdgo._internal.crypto.tls.Tls__hasAESGCMHardwareSupport._hasAESGCMHardwareSupport || !stdgo._internal.crypto.tls.Tls__aesgcmPreferred._aesgcmPreferred(_hs._clientHello._cipherSuites) : Bool)) {
                        _gotoNext = 5941595i32;
                    } else {
                        _gotoNext = 5941650i32;
                    };
                } else if (__value__ == (5941595i32)) {
                    _preferenceList_5941473 = stdgo._internal.crypto.tls.Tls__defaultCipherSuitesTLS13NoAES._defaultCipherSuitesTLS13NoAES;
                    _gotoNext = 5941650i32;
                } else if (__value__ == (5941650i32)) {
                    if ((0i32 : stdgo.GoInt) < (_preferenceList_5941473.length)) {
                        _gotoNext = 5941801i32;
                    } else {
                        _gotoNext = 5941805i32;
                    };
                } else if (__value__ == (5941654i32)) {
                    _i_5941668_0++;
                    _gotoNext = 5941802i32;
                } else if (__value__ == (5941689i32)) {
                    _suiteID_5941657 = _preferenceList_5941473[(_i_5941668_0 : stdgo.GoInt)];
                    _hs._suite = stdgo._internal.crypto.tls.Tls__mutualCipherSuiteTLS13._mutualCipherSuiteTLS13(_hs._clientHello._cipherSuites, _suiteID_5941657);
                    if (_hs._suite != null && ((_hs._suite : Dynamic).__nil__ == null || !(_hs._suite : Dynamic).__nil__)) {
                        _gotoNext = 5941786i32;
                    } else {
                        _gotoNext = 5941654i32;
                    };
                } else if (__value__ == (5941786i32)) {
                    _gotoNext = 5941805i32;
                } else if (__value__ == (5941801i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _preferenceList_5941473[(0i32 : stdgo.GoInt)];
                        _i_5941668_0 = __tmp__0;
                        _suiteID_5941657 = __tmp__1;
                    };
                    _gotoNext = 5941802i32;
                } else if (__value__ == (5941802i32)) {
                    if (_i_5941668_0 < (_preferenceList_5941473.length)) {
                        _gotoNext = 5941689i32;
                    } else {
                        _gotoNext = 5941805i32;
                    };
                } else if (__value__ == (5941805i32)) {
                    if (_hs._suite == null || (_hs._suite : Dynamic).__nil__) {
                        _gotoNext = 5941824i32;
                    } else {
                        _gotoNext = 5941947i32;
                    };
                } else if (__value__ == (5941824i32)) {
                    _c_5938529._sendAlert((40 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: no cipher suite supported by both client and server" : stdgo.GoString));
                    _gotoNext = 5941947i32;
                } else if (__value__ == (5941947i32)) {
                    _c_5938529._cipherSuite = _hs._suite._id;
                    _hs._hello._cipherSuite = _hs._suite._id;
                    _hs._transcript = _hs._suite._hash.new_();
                    _gotoNext = 5942250i32;
                } else if (__value__ == (5942250i32)) {
                    if ((0i32 : stdgo.GoInt) < (_c_5938529._config._curvePreferences().length)) {
                        _gotoNext = 5942675i32;
                    } else {
                        _gotoNext = 5942679i32;
                    };
                } else if (__value__ == (5942271i32)) {
                    _i_5942292_0++;
                    _gotoNext = 5942676i32;
                } else if (__value__ == (5942326i32)) {
                    _preferredGroup_5942274 = _c_5938529._config._curvePreferences()[(_i_5942292_0 : stdgo.GoInt)];
                    if ((0i32 : stdgo.GoInt) < (_hs._clientHello._keyShares.length)) {
                        _gotoNext = 5942496i32;
                    } else {
                        _gotoNext = 5942501i32;
                    };
                } else if (__value__ == (5942334i32)) {
                    _i_5942343_0++;
                    _gotoNext = 5942497i32;
                } else if (__value__ == (5942374i32)) {
                    _ks_5942337 = _hs._clientHello._keyShares[(_i_5942343_0 : stdgo.GoInt)];
                    if (_ks_5942337._group == (_preferredGroup_5942274)) {
                        _gotoNext = 5942409i32;
                    } else {
                        _gotoNext = 5942334i32;
                    };
                } else if (__value__ == (5942409i32)) {
                    _selectedGroup_5942198 = _ks_5942337._group;
                    _clientKeyShare_5942225 = (stdgo.Go.setRef(_ks_5942337) : stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare>);
                    stdgo._internal.crypto.tls.Tls_groupSelectionBreak.groupSelectionBreak = true;
                    _gotoNext = 5942676i32;
                } else if (__value__ == (5942496i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _hs._clientHello._keyShares[(0i32 : stdgo.GoInt)];
                        _i_5942343_0 = __tmp__0;
                        _ks_5942337 = __tmp__1;
                    };
                    _gotoNext = 5942497i32;
                } else if (__value__ == (5942497i32)) {
                    if (_i_5942343_0 < (_hs._clientHello._keyShares.length)) {
                        _gotoNext = 5942374i32;
                    } else {
                        _gotoNext = 5942501i32;
                    };
                } else if (__value__ == (5942501i32)) {
                    if (_selectedGroup_5942198 != ((0 : stdgo._internal.crypto.tls.Tls_CurveID.CurveID))) {
                        _gotoNext = 5942523i32;
                    } else {
                        _gotoNext = 5942543i32;
                    };
                } else if (__value__ == (5942523i32)) {
                    _i_5942292_0++;
                    _gotoNext = 5942676i32;
                } else if (__value__ == (5942543i32)) {
                    if ((0i32 : stdgo.GoInt) < (_hs._clientHello._supportedCurves.length)) {
                        _gotoNext = 5942672i32;
                    } else {
                        _gotoNext = 5942271i32;
                    };
                } else if (__value__ == (5942547i32)) {
                    _i_5942559_0++;
                    _gotoNext = 5942673i32;
                } else if (__value__ == (5942596i32)) {
                    _group_5942550 = _hs._clientHello._supportedCurves[(_i_5942559_0 : stdgo.GoInt)];
                    if (_group_5942550 == (_preferredGroup_5942274)) {
                        _gotoNext = 5942628i32;
                    } else {
                        _gotoNext = 5942547i32;
                    };
                } else if (__value__ == (5942628i32)) {
                    _selectedGroup_5942198 = _group_5942550;
                    _gotoNext = 5942271i32;
                } else if (__value__ == (5942672i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _hs._clientHello._supportedCurves[(0i32 : stdgo.GoInt)];
                        _i_5942559_0 = __tmp__0;
                        _group_5942550 = __tmp__1;
                    };
                    _gotoNext = 5942673i32;
                } else if (__value__ == (5942673i32)) {
                    if (_i_5942559_0 < (_hs._clientHello._supportedCurves.length)) {
                        _gotoNext = 5942596i32;
                    } else {
                        _gotoNext = 5942271i32;
                    };
                } else if (__value__ == (5942675i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _c_5938529._config._curvePreferences()[(0i32 : stdgo.GoInt)];
                        _i_5942292_0 = __tmp__0;
                        _preferredGroup_5942274 = __tmp__1;
                    };
                    _gotoNext = 5942676i32;
                } else if (__value__ == (5942676i32)) {
                    if (_i_5942292_0 < (_c_5938529._config._curvePreferences().length)) {
                        _gotoNext = 5942326i32;
                    } else {
                        _gotoNext = 5942679i32;
                    };
                } else if (__value__ == (5942679i32)) {
                    if (_selectedGroup_5942198 == ((0 : stdgo._internal.crypto.tls.Tls_CurveID.CurveID))) {
                        _gotoNext = 5942701i32;
                    } else {
                        _gotoNext = 5942823i32;
                    };
                } else if (__value__ == (5942701i32)) {
                    _c_5938529._sendAlert((40 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: no ECDHE curve supported by both client and server" : stdgo.GoString));
                    _gotoNext = 5942823i32;
                } else if (__value__ == (5942823i32)) {
                    if (_clientKeyShare_5942225 == null || (_clientKeyShare_5942225 : Dynamic).__nil__) {
                        _gotoNext = 5942848i32;
                    } else {
                        _gotoNext = 5942985i32;
                    };
                } else if (__value__ == (5942848i32)) {
                    {
                        _err_5942855 = _hs._doHelloRetryRequest(_selectedGroup_5942198);
                        if (_err_5942855 != null) {
                            _gotoNext = 5942912i32;
                        } else {
                            _gotoNext = 5942934i32;
                        };
                    };
                } else if (__value__ == (5942912i32)) {
                    return _err_5942855;
                    _gotoNext = 5942934i32;
                } else if (__value__ == (5942934i32)) {
                    _clientKeyShare_5942225 = (stdgo.Go.setRef(_hs._clientHello._keyShares[(0 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare>);
                    _gotoNext = 5942985i32;
                } else if (__value__ == (5942985i32)) {
                    {
                        {
                            var __tmp__ = stdgo._internal.crypto.tls.Tls__curveForCurveID._curveForCurveID(_selectedGroup_5942198);
                            _ok_5942991 = __tmp__._1;
                        };
                        if (!_ok_5942991) {
                            _gotoNext = 5943033i32;
                        } else {
                            _gotoNext = 5943145i32;
                        };
                    };
                } else if (__value__ == (5943033i32)) {
                    _c_5938529._sendAlert((80 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: CurvePreferences includes unsupported curve" : stdgo.GoString));
                    _gotoNext = 5943145i32;
                } else if (__value__ == (5943145i32)) {
                    {
                        var __tmp__ = stdgo._internal.crypto.tls.Tls__generateECDHEKey._generateECDHEKey(_c_5938529._config._rand(), _selectedGroup_5942198);
                        _key_5943145 = __tmp__._0;
                        _err_5943150 = __tmp__._1;
                    };
                    if (_err_5943150 != null) {
                        _gotoNext = 5943221i32;
                    } else {
                        _gotoNext = 5943274i32;
                    };
                } else if (__value__ == (5943221i32)) {
                    _c_5938529._sendAlert((80 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return _err_5943150;
                    _gotoNext = 5943274i32;
                } else if (__value__ == (5943274i32)) {
                    _hs._hello._serverShare = ({ _group : _selectedGroup_5942198, _data : _key_5943145.publicKey().bytes() } : stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare);
                    {
                        var __tmp__ = _key_5943145.curve().newPublicKey(_clientKeyShare_5942225._data);
                        _peerKey_5943360 = __tmp__._0;
                        _err_5943150 = __tmp__._1;
                    };
                    if (_err_5943150 != null) {
                        _gotoNext = 5943437i32;
                    } else {
                        _gotoNext = 5943533i32;
                    };
                } else if (__value__ == (5943437i32)) {
                    _c_5938529._sendAlert((47 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: invalid client key share" : stdgo.GoString));
                    _gotoNext = 5943533i32;
                } else if (__value__ == (5943533i32)) {
                    {
                        var __tmp__ = _key_5943145.ecdh(_peerKey_5943360);
                        _hs._sharedKey = __tmp__._0;
                        _err_5943150 = __tmp__._1;
                    };
                    if (_err_5943150 != null) {
                        _gotoNext = 5943586i32;
                    } else {
                        _gotoNext = 5943683i32;
                    };
                } else if (__value__ == (5943586i32)) {
                    _c_5938529._sendAlert((47 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: invalid client key share" : stdgo.GoString));
                    _gotoNext = 5943683i32;
                } else if (__value__ == (5943683i32)) {
                    {
                        var __tmp__ = stdgo._internal.crypto.tls.Tls__negotiateALPN._negotiateALPN(_c_5938529._config.nextProtos, _hs._clientHello._alpnProtocols, _c_5938529._quic != null && ((_c_5938529._quic : Dynamic).__nil__ == null || !(_c_5938529._quic : Dynamic).__nil__));
                        _selectedProto_5943683 = __tmp__._0?.__copy__();
                        _err_5943150 = __tmp__._1;
                    };
                    if (_err_5943150 != null) {
                        _gotoNext = 5943800i32;
                    } else {
                        _gotoNext = 5943861i32;
                    };
                } else if (__value__ == (5943800i32)) {
                    _c_5938529._sendAlert((120 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return _err_5943150;
                    _gotoNext = 5943861i32;
                } else if (__value__ == (5943861i32)) {
                    _c_5938529._clientProtocol = _selectedProto_5943683?.__copy__();
                    if (_c_5938529._quic != null && ((_c_5938529._quic : Dynamic).__nil__ == null || !(_c_5938529._quic : Dynamic).__nil__)) {
                        _gotoNext = 5943913i32;
                    } else {
                        _gotoNext = 5944204i32;
                    };
                } else if (__value__ == (5943913i32)) {
                    if (_hs._clientHello._quicTransportParameters == null) {
                        _gotoNext = 5943966i32;
                    } else {
                        _gotoNext = 5944127i32;
                    };
                } else if (__value__ == (5943966i32)) {
                    _c_5938529._sendAlert((109 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    ...
                    _gotoNext = 5944127i32;
                } else if (__value__ == (5944127i32)) {
                    _c_5938529._quicSetTransportParameters(_hs._clientHello._quicTransportParameters);
                    _gotoNext = 5944401i32;
                } else if (__value__ == (5944204i32)) {
                    if (_hs._clientHello._quicTransportParameters != null) {
                        _gotoNext = 5944257i32;
                    } else {
                        _gotoNext = 5944401i32;
                    };
                } else if (__value__ == (5944257i32)) {
                    _c_5938529._sendAlert((110 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    ...
                    _gotoNext = 5944401i32;
                } else if (__value__ == (5944401i32)) {
                    _c_5938529._serverName = _hs._clientHello._serverName?.__copy__();
                    return (null : stdgo.Error);
                    _gotoNext = -1i32;
                };
            };
