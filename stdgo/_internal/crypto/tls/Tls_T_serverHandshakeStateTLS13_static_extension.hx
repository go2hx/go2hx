...
@:keep @:allow(stdgo._internal.crypto.tls.Tls.T_serverHandshakeStateTLS13_asInterface) class T_serverHandshakeStateTLS13_static_extension {
    ...
    static public function _processClientHello( _hs:stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_serverHandshakeStateTLS13.T_serverHandshakeStateTLS13>):stdgo.Error {
        @:recv var _hs:stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_serverHandshakeStateTLS13.T_serverHandshakeStateTLS13> = _hs;
        var _id_5935273:stdgo.GoUInt16 = (0 : stdgo.GoUInt16);
        var _selectedProto_5939332:stdgo.GoString = ("" : stdgo.GoString);
        var _peerKey_5939009:stdgo.Ref<_internal.crypto.ecdh.Ecdh_PublicKey.PublicKey> = (null : stdgo.Ref<_internal.crypto.ecdh.Ecdh_PublicKey.PublicKey>);
        var _ok_5938640:Bool = false;
        var _ks_5937986:stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare = ({} : stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare);
        var _i_5937941_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _preferenceList_5937122:stdgo.Slice<stdgo.GoUInt16> = (null : stdgo.Slice<stdgo.GoUInt16>);
        var _suiteID_5937306:stdgo.GoUInt16 = (0 : stdgo.GoUInt16);
        var _i_5937992_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _preferredGroup_5937923:stdgo._internal.crypto.tls.Tls_CurveID.CurveID = ((0 : stdgo.GoUInt16) : stdgo._internal.crypto.tls.Tls_CurveID.CurveID);
        var _clientKeyShare_5937874:stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare> = (null : stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare>);
        var _c_5934178:stdgo.Ref<stdgo._internal.crypto.tls.Tls_Conn.Conn> = (null : stdgo.Ref<stdgo._internal.crypto.tls.Tls_Conn.Conn>);
        var _err_5938799:stdgo.Error = (null : stdgo.Error);
        var _selectedGroup_5937847:stdgo._internal.crypto.tls.Tls_CurveID.CurveID = ((0 : stdgo.GoUInt16) : stdgo._internal.crypto.tls.Tls_CurveID.CurveID);
        var _i_5935279_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _key_5938794:stdgo.Ref<_internal.crypto.ecdh.Ecdh_PrivateKey.PrivateKey> = (null : stdgo.Ref<_internal.crypto.ecdh.Ecdh_PrivateKey.PrivateKey>);
        var _err_5938504:stdgo.Error = (null : stdgo.Error);
        var _group_5938199:stdgo._internal.crypto.tls.Tls_CurveID.CurveID = ((0 : stdgo.GoUInt16) : stdgo._internal.crypto.tls.Tls_CurveID.CurveID);
        var _i_5938208_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_5937317_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _err_5935963:stdgo.Error = (null : stdgo.Error);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _hs._hello._supportedVersion = _c_5934178._vers;
                    if ((_hs._clientHello._supportedVersions.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5934473i32;
                    } else {
                        _gotoNext = 5935266i32;
                    };
                } else if (__value__ == (5934473i32)) {
                    _c_5934178._sendAlert((47 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    ...
                    _gotoNext = 5935266i32;
                } else if (__value__ == (5935266i32)) {
                    if ((0i32 : stdgo.GoInt) < (_hs._clientHello._cipherSuites.length)) {
                        _gotoNext = 5935684i32;
                    } else {
                        _gotoNext = 5935689i32;
                    };
                } else if (__value__ == (5935270i32)) {
                    _i_5935279_0++;
                    _gotoNext = 5935685i32;
                } else if (__value__ == (5935313i32)) {
                    _id_5935273 = _hs._clientHello._cipherSuites[(_i_5935279_0 : stdgo.GoInt)];
                    if (_id_5935273 == ((22016 : stdgo.GoUInt16))) {
                        _gotoNext = 5935344i32;
                    } else {
                        _gotoNext = 5935270i32;
                    };
                } else if (__value__ == (5935344i32)) {
                    if ((_c_5934178._vers < _c_5934178._config._maxSupportedVersion(false) : Bool)) {
                        _gotoNext = 5935545i32;
                    } else {
                        _gotoNext = 5935674i32;
                    };
                } else if (__value__ == (5935545i32)) {
                    _c_5934178._sendAlert((86 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: client using inappropriate protocol fallback" : stdgo.GoString));
                    _gotoNext = 5935674i32;
                } else if (__value__ == (5935674i32)) {
                    _gotoNext = 5935689i32;
                } else if (__value__ == (5935684i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _hs._clientHello._cipherSuites[(0i32 : stdgo.GoInt)];
                        _i_5935279_0 = __tmp__0;
                        _id_5935273 = __tmp__1;
                    };
                    _gotoNext = 5935685i32;
                } else if (__value__ == (5935685i32)) {
                    if (_i_5935279_0 < (_hs._clientHello._cipherSuites.length)) {
                        _gotoNext = 5935313i32;
                    } else {
                        _gotoNext = 5935689i32;
                    };
                } else if (__value__ == (5935689i32)) {
                    if (((_hs._clientHello._compressionMethods.length != (1 : stdgo.GoInt)) || (_hs._clientHello._compressionMethods[(0 : stdgo.GoInt)] != (0 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 5935797i32;
                    } else {
                        _gotoNext = 5935921i32;
                    };
                } else if (__value__ == (5935797i32)) {
                    _c_5934178._sendAlert((47 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: TLS 1.3 client supports illegal compression methods" : stdgo.GoString));
                    _gotoNext = 5935921i32;
                } else if (__value__ == (5935921i32)) {
                    _hs._hello._random = (new stdgo.Slice<stdgo.GoUInt8>((32 : stdgo.GoInt).toBasic(), 0).__setNumber32__() : stdgo.Slice<stdgo.GoUInt8>);
                    {
                        {
                            var __tmp__ = stdgo._internal.io.Io_readFull.readFull(_c_5934178._config._rand(), _hs._hello._random);
                            _err_5935963 = __tmp__._1;
                        };
                        if (_err_5935963 != null) {
                            _gotoNext = 5936028i32;
                        } else {
                            _gotoNext = 5936082i32;
                        };
                    };
                } else if (__value__ == (5936028i32)) {
                    _c_5934178._sendAlert((80 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return _err_5935963;
                    _gotoNext = 5936082i32;
                } else if (__value__ == (5936082i32)) {
                    if ((_hs._clientHello._secureRenegotiation.length) != ((0 : stdgo.GoInt))) {
                        _gotoNext = 5936130i32;
                    } else {
                        _gotoNext = 5936258i32;
                    };
                } else if (__value__ == (5936130i32)) {
                    _c_5934178._sendAlert((40 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    ...
                    _gotoNext = 5936258i32;
                } else if (__value__ == (5936258i32)) {
                    if ((_hs._clientHello._earlyData && (_c_5934178._quic != null && ((_c_5934178._quic : Dynamic).__nil__ == null || !(_c_5934178._quic : Dynamic).__nil__)) : Bool)) {
                        _gotoNext = 5936303i32;
                    } else if (_hs._clientHello._earlyData) {
                        _gotoNext = 5936492i32;
                    } else {
                        _gotoNext = 5937028i32;
                    };
                } else if (__value__ == (5936303i32)) {
                    if ((_hs._clientHello._pskIdentities.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5936349i32;
                    } else {
                        _gotoNext = 5937028i32;
                    };
                } else if (__value__ == (5936349i32)) {
                    _c_5934178._sendAlert((47 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: early_data without pre_shared_key" : stdgo.GoString));
                    _gotoNext = 5937028i32;
                } else if (__value__ == (5936492i32)) {
                    _c_5934178._sendAlert((110 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: client sent unexpected early data" : stdgo.GoString));
                    _gotoNext = 5937028i32;
                } else if (__value__ == (5937028i32)) {
                    _hs._hello._sessionId = _hs._clientHello._sessionId;
                    _hs._hello._compressionMethod = (0 : stdgo.GoUInt8);
                    _preferenceList_5937122 = stdgo._internal.crypto.tls.Tls__defaultCipherSuitesTLS13._defaultCipherSuitesTLS13;
                    if ((!stdgo._internal.crypto.tls.Tls__hasAESGCMHardwareSupport._hasAESGCMHardwareSupport || !stdgo._internal.crypto.tls.Tls__aesgcmPreferred._aesgcmPreferred(_hs._clientHello._cipherSuites) : Bool)) {
                        _gotoNext = 5937244i32;
                    } else {
                        _gotoNext = 5937299i32;
                    };
                } else if (__value__ == (5937244i32)) {
                    _preferenceList_5937122 = stdgo._internal.crypto.tls.Tls__defaultCipherSuitesTLS13NoAES._defaultCipherSuitesTLS13NoAES;
                    _gotoNext = 5937299i32;
                } else if (__value__ == (5937299i32)) {
                    if ((0i32 : stdgo.GoInt) < (_preferenceList_5937122.length)) {
                        _gotoNext = 5937450i32;
                    } else {
                        _gotoNext = 5937454i32;
                    };
                } else if (__value__ == (5937303i32)) {
                    _i_5937317_0++;
                    _gotoNext = 5937451i32;
                } else if (__value__ == (5937338i32)) {
                    _suiteID_5937306 = _preferenceList_5937122[(_i_5937317_0 : stdgo.GoInt)];
                    _hs._suite = stdgo._internal.crypto.tls.Tls__mutualCipherSuiteTLS13._mutualCipherSuiteTLS13(_hs._clientHello._cipherSuites, _suiteID_5937306);
                    if ((_hs._suite != null && ((_hs._suite : Dynamic).__nil__ == null || !(_hs._suite : Dynamic).__nil__))) {
                        _gotoNext = 5937435i32;
                    } else {
                        _gotoNext = 5937303i32;
                    };
                } else if (__value__ == (5937435i32)) {
                    _gotoNext = 5937454i32;
                } else if (__value__ == (5937450i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _preferenceList_5937122[(0i32 : stdgo.GoInt)];
                        _i_5937317_0 = __tmp__0;
                        _suiteID_5937306 = __tmp__1;
                    };
                    _gotoNext = 5937451i32;
                } else if (__value__ == (5937451i32)) {
                    if (_i_5937317_0 < (_preferenceList_5937122.length)) {
                        _gotoNext = 5937338i32;
                    } else {
                        _gotoNext = 5937454i32;
                    };
                } else if (__value__ == (5937454i32)) {
                    if ((_hs._suite == null || (_hs._suite : Dynamic).__nil__)) {
                        _gotoNext = 5937473i32;
                    } else {
                        _gotoNext = 5937596i32;
                    };
                } else if (__value__ == (5937473i32)) {
                    _c_5934178._sendAlert((40 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: no cipher suite supported by both client and server" : stdgo.GoString));
                    _gotoNext = 5937596i32;
                } else if (__value__ == (5937596i32)) {
                    _c_5934178._cipherSuite = _hs._suite._id;
                    _hs._hello._cipherSuite = _hs._suite._id;
                    _hs._transcript = _hs._suite._hash.new_();
                    _gotoNext = 5937899i32;
                } else if (__value__ == (5937899i32)) {
                    if ((0i32 : stdgo.GoInt) < (_c_5934178._config._curvePreferences().length)) {
                        _gotoNext = 5938324i32;
                    } else {
                        _gotoNext = 5938328i32;
                    };
                } else if (__value__ == (5937920i32)) {
                    _i_5937941_0++;
                    _gotoNext = 5938325i32;
                } else if (__value__ == (5937975i32)) {
                    _preferredGroup_5937923 = _c_5934178._config._curvePreferences()[(_i_5937941_0 : stdgo.GoInt)];
                    if ((0i32 : stdgo.GoInt) < (_hs._clientHello._keyShares.length)) {
                        _gotoNext = 5938145i32;
                    } else {
                        _gotoNext = 5938150i32;
                    };
                } else if (__value__ == (5937983i32)) {
                    _i_5937992_0++;
                    _gotoNext = 5938146i32;
                } else if (__value__ == (5938023i32)) {
                    _ks_5937986 = _hs._clientHello._keyShares[(_i_5937992_0 : stdgo.GoInt)];
                    if (_ks_5937986._group == (_preferredGroup_5937923)) {
                        _gotoNext = 5938058i32;
                    } else {
                        _gotoNext = 5937983i32;
                    };
                } else if (__value__ == (5938058i32)) {
                    _selectedGroup_5937847 = _ks_5937986._group;
                    _clientKeyShare_5937874 = (stdgo.Go.setRef(_ks_5937986) : stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare>);
                    stdgo._internal.crypto.tls.Tls_groupSelectionBreak.groupSelectionBreak = true;
                    _gotoNext = 5938325i32;
                } else if (__value__ == (5938145i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _hs._clientHello._keyShares[(0i32 : stdgo.GoInt)];
                        _i_5937992_0 = __tmp__0;
                        _ks_5937986 = __tmp__1;
                    };
                    _gotoNext = 5938146i32;
                } else if (__value__ == (5938146i32)) {
                    if (_i_5937992_0 < (_hs._clientHello._keyShares.length)) {
                        _gotoNext = 5938023i32;
                    } else {
                        _gotoNext = 5938150i32;
                    };
                } else if (__value__ == (5938150i32)) {
                    if (_selectedGroup_5937847 != ((0 : stdgo._internal.crypto.tls.Tls_CurveID.CurveID))) {
                        _gotoNext = 5938172i32;
                    } else {
                        _gotoNext = 5938192i32;
                    };
                } else if (__value__ == (5938172i32)) {
                    _i_5937941_0++;
                    _gotoNext = 5938325i32;
                } else if (__value__ == (5938192i32)) {
                    if ((0i32 : stdgo.GoInt) < (_hs._clientHello._supportedCurves.length)) {
                        _gotoNext = 5938321i32;
                    } else {
                        _gotoNext = 5937920i32;
                    };
                } else if (__value__ == (5938196i32)) {
                    _i_5938208_0++;
                    _gotoNext = 5938322i32;
                } else if (__value__ == (5938245i32)) {
                    _group_5938199 = _hs._clientHello._supportedCurves[(_i_5938208_0 : stdgo.GoInt)];
                    if (_group_5938199 == (_preferredGroup_5937923)) {
                        _gotoNext = 5938277i32;
                    } else {
                        _gotoNext = 5938196i32;
                    };
                } else if (__value__ == (5938277i32)) {
                    _selectedGroup_5937847 = _group_5938199;
                    _gotoNext = 5937920i32;
                } else if (__value__ == (5938321i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _hs._clientHello._supportedCurves[(0i32 : stdgo.GoInt)];
                        _i_5938208_0 = __tmp__0;
                        _group_5938199 = __tmp__1;
                    };
                    _gotoNext = 5938322i32;
                } else if (__value__ == (5938322i32)) {
                    if (_i_5938208_0 < (_hs._clientHello._supportedCurves.length)) {
                        _gotoNext = 5938245i32;
                    } else {
                        _gotoNext = 5937920i32;
                    };
                } else if (__value__ == (5938324i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _c_5934178._config._curvePreferences()[(0i32 : stdgo.GoInt)];
                        _i_5937941_0 = __tmp__0;
                        _preferredGroup_5937923 = __tmp__1;
                    };
                    _gotoNext = 5938325i32;
                } else if (__value__ == (5938325i32)) {
                    if (_i_5937941_0 < (_c_5934178._config._curvePreferences().length)) {
                        _gotoNext = 5937975i32;
                    } else {
                        _gotoNext = 5938328i32;
                    };
                } else if (__value__ == (5938328i32)) {
                    if (_selectedGroup_5937847 == ((0 : stdgo._internal.crypto.tls.Tls_CurveID.CurveID))) {
                        _gotoNext = 5938350i32;
                    } else {
                        _gotoNext = 5938472i32;
                    };
                } else if (__value__ == (5938350i32)) {
                    _c_5934178._sendAlert((40 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: no ECDHE curve supported by both client and server" : stdgo.GoString));
                    _gotoNext = 5938472i32;
                } else if (__value__ == (5938472i32)) {
                    if ((_clientKeyShare_5937874 == null || (_clientKeyShare_5937874 : Dynamic).__nil__)) {
                        _gotoNext = 5938497i32;
                    } else {
                        _gotoNext = 5938634i32;
                    };
                } else if (__value__ == (5938497i32)) {
                    {
                        _err_5938504 = _hs._doHelloRetryRequest(_selectedGroup_5937847);
                        if (_err_5938504 != null) {
                            _gotoNext = 5938561i32;
                        } else {
                            _gotoNext = 5938583i32;
                        };
                    };
                } else if (__value__ == (5938561i32)) {
                    return _err_5938504;
                    _gotoNext = 5938583i32;
                } else if (__value__ == (5938583i32)) {
                    _clientKeyShare_5937874 = (stdgo.Go.setRef(_hs._clientHello._keyShares[(0 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare>);
                    _gotoNext = 5938634i32;
                } else if (__value__ == (5938634i32)) {
                    {
                        {
                            var __tmp__ = stdgo._internal.crypto.tls.Tls__curveForCurveID._curveForCurveID(_selectedGroup_5937847);
                            _ok_5938640 = __tmp__._1;
                        };
                        if (!_ok_5938640) {
                            _gotoNext = 5938682i32;
                        } else {
                            _gotoNext = 5938794i32;
                        };
                    };
                } else if (__value__ == (5938682i32)) {
                    _c_5934178._sendAlert((80 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: CurvePreferences includes unsupported curve" : stdgo.GoString));
                    _gotoNext = 5938794i32;
                } else if (__value__ == (5938794i32)) {
                    {
                        var __tmp__ = stdgo._internal.crypto.tls.Tls__generateECDHEKey._generateECDHEKey(_c_5934178._config._rand(), _selectedGroup_5937847);
                        _key_5938794 = __tmp__._0;
                        _err_5938799 = __tmp__._1;
                    };
                    if (_err_5938799 != null) {
                        _gotoNext = 5938870i32;
                    } else {
                        _gotoNext = 5938923i32;
                    };
                } else if (__value__ == (5938870i32)) {
                    _c_5934178._sendAlert((80 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return _err_5938799;
                    _gotoNext = 5938923i32;
                } else if (__value__ == (5938923i32)) {
                    _hs._hello._serverShare = ({ _group : _selectedGroup_5937847, _data : _key_5938794.publicKey().bytes() } : stdgo._internal.crypto.tls.Tls_T_keyShare.T_keyShare);
                    {
                        var __tmp__ = _key_5938794.curve().newPublicKey(_clientKeyShare_5937874._data);
                        _peerKey_5939009 = __tmp__._0;
                        _err_5938799 = __tmp__._1;
                    };
                    if (_err_5938799 != null) {
                        _gotoNext = 5939086i32;
                    } else {
                        _gotoNext = 5939182i32;
                    };
                } else if (__value__ == (5939086i32)) {
                    _c_5934178._sendAlert((47 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: invalid client key share" : stdgo.GoString));
                    _gotoNext = 5939182i32;
                } else if (__value__ == (5939182i32)) {
                    {
                        var __tmp__ = _key_5938794.ecdh(_peerKey_5939009);
                        _hs._sharedKey = __tmp__._0;
                        _err_5938799 = __tmp__._1;
                    };
                    if (_err_5938799 != null) {
                        _gotoNext = 5939235i32;
                    } else {
                        _gotoNext = 5939332i32;
                    };
                } else if (__value__ == (5939235i32)) {
                    _c_5934178._sendAlert((47 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: invalid client key share" : stdgo.GoString));
                    _gotoNext = 5939332i32;
                } else if (__value__ == (5939332i32)) {
                    {
                        var __tmp__ = stdgo._internal.crypto.tls.Tls__negotiateALPN._negotiateALPN(_c_5934178._config.nextProtos, _hs._clientHello._alpnProtocols, (_c_5934178._quic != null && ((_c_5934178._quic : Dynamic).__nil__ == null || !(_c_5934178._quic : Dynamic).__nil__)));
                        _selectedProto_5939332 = __tmp__._0?.__copy__();
                        _err_5938799 = __tmp__._1;
                    };
                    if (_err_5938799 != null) {
                        _gotoNext = 5939449i32;
                    } else {
                        _gotoNext = 5939510i32;
                    };
                } else if (__value__ == (5939449i32)) {
                    _c_5934178._sendAlert((120 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    return _err_5938799;
                    _gotoNext = 5939510i32;
                } else if (__value__ == (5939510i32)) {
                    _c_5934178._clientProtocol = _selectedProto_5939332?.__copy__();
                    if ((_c_5934178._quic != null && ((_c_5934178._quic : Dynamic).__nil__ == null || !(_c_5934178._quic : Dynamic).__nil__))) {
                        _gotoNext = 5939562i32;
                    } else {
                        _gotoNext = 5939853i32;
                    };
                } else if (__value__ == (5939562i32)) {
                    if (_hs._clientHello._quicTransportParameters == null) {
                        _gotoNext = 5939615i32;
                    } else {
                        _gotoNext = 5939776i32;
                    };
                } else if (__value__ == (5939615i32)) {
                    _c_5934178._sendAlert((109 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    ...
                    _gotoNext = 5939776i32;
                } else if (__value__ == (5939776i32)) {
                    _c_5934178._quicSetTransportParameters(_hs._clientHello._quicTransportParameters);
                    _gotoNext = 5940050i32;
                } else if (__value__ == (5939853i32)) {
                    _gotoNext = 5939853i32;
                    if (_hs._clientHello._quicTransportParameters != null) {
                        _gotoNext = 5939906i32;
                    } else {
                        _gotoNext = 5940050i32;
                    };
                } else if (__value__ == (5939906i32)) {
                    _c_5934178._sendAlert((110 : stdgo._internal.crypto.tls.Tls_T_alert.T_alert));
                    ...
                    _gotoNext = 5940050i32;
                } else if (__value__ == (5940050i32)) {
                    _c_5934178._serverName = _hs._clientHello._serverName?.__copy__();
                    return (null : stdgo.Error);
                    _gotoNext = -1i32;
                };
            };
