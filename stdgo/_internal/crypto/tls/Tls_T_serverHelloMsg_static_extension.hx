...
@:keep @:allow(stdgo._internal.crypto.tls.Tls.T_serverHelloMsg_asInterface) class T_serverHelloMsg_static_extension {
    ...
    static public function _unmarshal( _m:stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg>, _data:stdgo.Slice<stdgo.GoUInt8>):Bool {
        @:recv var _m:stdgo.Ref<stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg> = _m;
        {
            ...
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._raw = __tmp__._raw;
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._vers = __tmp__._vers;
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._random = __tmp__._random;
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._sessionId = __tmp__._sessionId;
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._cipherSuite = __tmp__._cipherSuite;
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._compressionMethod = __tmp__._compressionMethod;
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._ocspStapling = __tmp__._ocspStapling;
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._ticketSupported = __tmp__._ticketSupported;
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._secureRenegotiationSupported = __tmp__._secureRenegotiationSupported;
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._secureRenegotiation = __tmp__._secureRenegotiation;
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._extendedMasterSecret = __tmp__._extendedMasterSecret;
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._alpnProtocol = __tmp__._alpnProtocol;
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._scts = __tmp__._scts;
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._supportedVersion = __tmp__._supportedVersion;
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._serverShare = __tmp__._serverShare;
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._selectedIdentityPresent = __tmp__._selectedIdentityPresent;
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._selectedIdentity = __tmp__._selectedIdentity;
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._supportedPoints = __tmp__._supportedPoints;
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._cookie = __tmp__._cookie;
            (_m : stdgo._internal.crypto.tls.Tls_T_serverHelloMsg.T_serverHelloMsg)._selectedGroup = __tmp__._selectedGroup;
        };
