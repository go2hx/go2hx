...
class T_newSessionTicketMsgTLS13_asInterface {
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.crypto.tls.Tls_t_newsessionticketmsgtls13pointer.T_newSessionTicketMsgTLS13Pointer;
