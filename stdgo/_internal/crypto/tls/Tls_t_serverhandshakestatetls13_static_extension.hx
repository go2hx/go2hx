...
@:keep @:allow(stdgo._internal.crypto.tls.Tls.T_serverHandshakeStateTLS13_asInterface) class T_serverHandshakeStateTLS13_static_extension {
    ...
    static public function _processClientHello( _hs:stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_serverhandshakestatetls13.T_serverHandshakeStateTLS13>):stdgo.Error {
        ...
        var _i_5959604_13:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        var _i_5959388_11:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_5959337_9:stdgo.GoInt = (0 : stdgo.GoInt);
        var _preferenceList_4:stdgo.Slice<stdgo.GoUInt16> = (null : stdgo.Slice<stdgo.GoUInt16>);
        var _i_5956675_1:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        var _i_5958713_5:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._cipherSuites.length)) {
                        _gotoNext = 5957080i32;
                    } else {
                        _gotoNext = 5957085i32;
                    };
                } else if (__value__ == (5956666i32)) {
                    _i_5956675_1++;
                    _gotoNext = 5957081i32;
                } else if (__value__ == (5956709i32)) {
                    _id_2 = (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._cipherSuites[(_i_5956675_1 : stdgo.GoInt)];
                    if (_id_2 == ((22016 : stdgo.GoUInt16))) {
                        _gotoNext = 5956740i32;
                    } else {
                        _gotoNext = 5956666i32;
                    };
                } else if (__value__ == (5956740i32)) {
                    if (((@:checkr _c_0 ?? throw "null pointer dereference")._vers < @:check2r (@:checkr _c_0 ?? throw "null pointer dereference")._config._maxSupportedVersion(false) : Bool)) {
                        _gotoNext = 5956941i32;
                    } else {
                        _gotoNext = 5957070i32;
                    };
                } else if (__value__ == (5956941i32)) {
                    ...
                    _gotoNext = 5957070i32;
                } else if (__value__ == (5957070i32)) {
                    _gotoNext = 5957085i32;
                } else if (__value__ == (5957080i32)) {
                    {
                        final __tmp__0 = 0i32;
                        ...
                        _i_5956675_1 = __tmp__0;
                        _id_2 = __tmp__1;
                    };
                    _gotoNext = 5957081i32;
                } else if (__value__ == (5957081i32)) {
                    if (_i_5956675_1 < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._cipherSuites.length)) {
                        _gotoNext = 5956709i32;
                    } else {
                        _gotoNext = 5957085i32;
                    };
                } else if (__value__ == (5957085i32)) {
                    ...
                    (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._hello ?? throw "null pointer dereference")._random = (new stdgo.Slice<stdgo.GoUInt8>((32 : stdgo.GoInt).toBasic(), 0).__setNumber32__() : stdgo.Slice<stdgo.GoUInt8>);
                    {
                        ...
                        if (_err_3 != null) {
                            _gotoNext = 5957424i32;
                        } else {
                            _gotoNext = 5957478i32;
                        };
                    };
                } else if (__value__ == (5957424i32)) {
                    @:check2r _c_0._sendAlert((80 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return _err_3;
                    _gotoNext = 5957478i32;
                } else if (__value__ == (5957478i32)) {
                    if (((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._secureRenegotiation.length) != ((0 : stdgo.GoInt))) {
                        _gotoNext = 5957526i32;
                    } else {
                        _gotoNext = 5957654i32;
                    };
                } else if (__value__ == (5957526i32)) {
                    ...
                    if (((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._earlyData && ((@:checkr _c_0 ?? throw "null pointer dereference")._quic != null && (((@:checkr _c_0 ?? throw "null pointer dereference")._quic : Dynamic).__nil__ == null || !((@:checkr _c_0 ?? throw "null pointer dereference")._quic : Dynamic).__nil__)) : Bool)) {
                        ...
                        _gotoNext = 5958424i32;
                    };
                } else if (__value__ == (5957699i32)) {
                    if (((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._pskIdentities.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5957745i32;
                    } else {
                        _gotoNext = 5958424i32;
                    };
                } else if (__value__ == (5957745i32)) {
                    @:check2r _c_0._sendAlert((47 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    ...
                    if ((!stdgo._internal.crypto.tls.Tls__hasaesgcmhardwaresupport._hasAESGCMHardwareSupport || !stdgo._internal.crypto.tls.Tls__aesgcmpreferred._aesgcmPreferred((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._cipherSuites) : Bool)) {
                        _gotoNext = 5958640i32;
                    } else {
                        _gotoNext = 5958695i32;
                    };
                } else if (__value__ == (5958640i32)) {
                    _preferenceList_4 = stdgo._internal.crypto.tls.Tls__defaultciphersuitestls13noaes._defaultCipherSuitesTLS13NoAES;
                    _gotoNext = 5958695i32;
                } else if (__value__ == (5958695i32)) {
                    if ((0i32 : stdgo.GoInt) < (_preferenceList_4.length)) {
                        _gotoNext = 5958846i32;
                    } else {
                        _gotoNext = 5958850i32;
                    };
                } else if (__value__ == (5958699i32)) {
                    _i_5958713_5++;
                    _gotoNext = 5958847i32;
                } else if (__value__ == (5958734i32)) {
                    _suiteID_6 = _preferenceList_4[(_i_5958713_5 : stdgo.GoInt)];
                    ...
                    if (((@:checkr _hs ?? throw "null pointer dereference")._suite != null && (((@:checkr _hs ?? throw "null pointer dereference")._suite : Dynamic).__nil__ == null || !((@:checkr _hs ?? throw "null pointer dereference")._suite : Dynamic).__nil__))) {
                        _gotoNext = 5958831i32;
                    } else {
                        _gotoNext = 5958699i32;
                    };
                } else if (__value__ == (5958831i32)) {
                    _gotoNext = 5958850i32;
                } else if (__value__ == (5958846i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _preferenceList_4[(0i32 : stdgo.GoInt)];
                        _i_5958713_5 = __tmp__0;
                        _suiteID_6 = __tmp__1;
                    };
                    _gotoNext = 5958847i32;
                } else if (__value__ == (5958847i32)) {
                    if (_i_5958713_5 < (_preferenceList_4.length)) {
                        _gotoNext = 5958734i32;
                    } else {
                        _gotoNext = 5958850i32;
                    };
                } else if (__value__ == (5958850i32)) {
                    ...
                    _gotoNext = 5959295i32;
                } else if (__value__ == (5959295i32)) {
                    if ((0i32 : stdgo.GoInt) < (@:check2r (@:checkr _c_0 ?? throw "null pointer dereference")._config._curvePreferences().length)) {
                        _gotoNext = 5959720i32;
                    } else {
                        _gotoNext = 5959724i32;
                    };
                } else if (__value__ == (5959316i32)) {
                    _i_5959337_9++;
                    _gotoNext = 5959721i32;
                } else if (__value__ == (5959371i32)) {
                    _preferredGroup_10 = @:check2r (@:checkr _c_0 ?? throw "null pointer dereference")._config._curvePreferences()[(_i_5959337_9 : stdgo.GoInt)];
                    if ((0i32 : stdgo.GoInt) < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._keyShares.length)) {
                        _gotoNext = 5959541i32;
                    } else {
                        _gotoNext = 5959546i32;
                    };
                } else if (__value__ == (5959379i32)) {
                    _i_5959388_11++;
                    _gotoNext = 5959542i32;
                } else if (__value__ == (5959419i32)) {
                    _ks_12 = (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._keyShares[(_i_5959388_11 : stdgo.GoInt)];
                    if (_ks_12._group == (_preferredGroup_10)) {
                        _gotoNext = 5959454i32;
                    } else {
                        _gotoNext = 5959379i32;
                    };
                } else if (__value__ == (5959454i32)) {
                ...
                } else if (__value__ == (5959541i32)) {
                    {
                        ...
                        _i_5959388_11 = __tmp__0;
                        _ks_12 = __tmp__1;
                    };
                    _gotoNext = 5959542i32;
                } else if (__value__ == (5959542i32)) {
                    if (_i_5959388_11 < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._keyShares.length)) {
                        _gotoNext = 5959419i32;
                    } else {
                        _gotoNext = 5959546i32;
                    };
                } else if (__value__ == (5959546i32)) {
                    if (_selectedGroup_7 != ((0 : stdgo._internal.crypto.tls.Tls_curveid.CurveID))) {
                        _gotoNext = 5959568i32;
                    } else {
                        _gotoNext = 5959588i32;
                    };
                } else if (__value__ == (5959568i32)) {
                    _i_5959337_9++;
                    _gotoNext = 5959721i32;
                } else if (__value__ == (5959588i32)) {
                    if ((0i32 : stdgo.GoInt) < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._supportedCurves.length)) {
                        _gotoNext = 5959717i32;
                    } else {
                        _gotoNext = 5959316i32;
                    };
                } else if (__value__ == (5959592i32)) {
                    _i_5959604_13++;
                    _gotoNext = 5959718i32;
                } else if (__value__ == (5959641i32)) {
                    _group_14 = (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._supportedCurves[(_i_5959604_13 : stdgo.GoInt)];
                    if (_group_14 == (_preferredGroup_10)) {
                        _gotoNext = 5959673i32;
                    } else {
                        _gotoNext = 5959592i32;
                    };
                } else if (__value__ == (5959673i32)) {
                    _selectedGroup_7 = _group_14;
                    _gotoNext = 5959316i32;
                } else if (__value__ == (5959717i32)) {
                    {
                        final __tmp__0 = 0i32;
                        ...
                        _i_5959604_13 = __tmp__0;
                        _group_14 = __tmp__1;
                    };
                    _gotoNext = 5959718i32;
                } else if (__value__ == (5959718i32)) {
                    if (_i_5959604_13 < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._supportedCurves.length)) {
                        _gotoNext = 5959641i32;
                    } else {
                        _gotoNext = 5959316i32;
                    };
                } else if (__value__ == (5959720i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = @:check2r (@:checkr _c_0 ?? throw "null pointer dereference")._config._curvePreferences()[(0i32 : stdgo.GoInt)];
                        _i_5959337_9 = __tmp__0;
                        _preferredGroup_10 = __tmp__1;
                    };
                    _gotoNext = 5959721i32;
                } else if (__value__ == (5959721i32)) {
                    if (_i_5959337_9 < (@:check2r (@:checkr _c_0 ?? throw "null pointer dereference")._config._curvePreferences().length)) {
                        _gotoNext = 5959371i32;
                    } else {
                        _gotoNext = 5959724i32;
                    };
                } else if (__value__ == (5959724i32)) {
                    if (_selectedGroup_7 == ((0 : stdgo._internal.crypto.tls.Tls_curveid.CurveID))) {
                        _gotoNext = 5959746i32;
                    } else {
                        _gotoNext = 5959868i32;
                    };
                } else if (__value__ == (5959746i32)) {
                    @:check2r _c_0._sendAlert((40 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: no ECDHE curve supported by both client and server" : stdgo.GoString));
                    _gotoNext = 5959868i32;
                } else if (__value__ == (5959868i32)) {
                    if ((_clientKeyShare_8 == null || (_clientKeyShare_8 : Dynamic).__nil__)) {
                        _gotoNext = 5959893i32;
                    } else {
                        _gotoNext = 5960030i32;
                    };
                } else if (__value__ == (5959893i32)) {
                    {
                        _err_15 = @:check2r _hs._doHelloRetryRequest(_selectedGroup_7);
                        if (_err_15 != null) {
                            _gotoNext = 5959957i32;
                        } else {
                            _gotoNext = 5959979i32;
                        };
                    };
                } else if (__value__ == (5959957i32)) {
                    return _err_15;
                    _gotoNext = 5959979i32;
                } else if (__value__ == (5959979i32)) {
                    ...
                    if (_err_18 != null) {
                        _gotoNext = 5960266i32;
                    } else {
                        _gotoNext = 5960319i32;
                    };
                } else if (__value__ == (5960266i32)) {
                    @:check2r _c_0._sendAlert((80 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return _err_18;
                    _gotoNext = 5960319i32;
                } else if (__value__ == (5960319i32)) {
                    ...
                    if (_err_18 != null) {
                        _gotoNext = 5960482i32;
                    } else {
                        _gotoNext = 5960578i32;
                    };
                } else if (__value__ == (5960482i32)) {
                    @:check2r _c_0._sendAlert((47 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: invalid client key share" : stdgo.GoString));
                    _gotoNext = 5960578i32;
                } else if (__value__ == (5960578i32)) {
                    {
                    ...
                    if (_err_18 != null) {
                        _gotoNext = 5960631i32;
                    } else {
                        _gotoNext = 5960728i32;
                    };
                } else if (__value__ == (5960631i32)) {
                    @:check2r _c_0._sendAlert((47 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: invalid client key share" : stdgo.GoString));
                    _gotoNext = 5960728i32;
                } else if (__value__ == (5960728i32)) {
                    {
                    ...
                    if (_err_18 != null) {
                        _gotoNext = 5960845i32;
                    } else {
                        _gotoNext = 5960906i32;
                    };
                } else if (__value__ == (5960845i32)) {
                    @:check2r _c_0._sendAlert((120 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return _err_18;
                    _gotoNext = 5960906i32;
                } else if (__value__ == (5960906i32)) {
                    ...
                    if (((@:checkr _c_0 ?? throw "null pointer dereference")._quic != null && (((@:checkr _c_0 ?? throw "null pointer dereference")._quic : Dynamic).__nil__ == null || !((@:checkr _c_0 ?? throw "null pointer dereference")._quic : Dynamic).__nil__))) {
                        _gotoNext = 5960958i32;
                    } else {
                        _gotoNext = 5961249i32;
                    };
                } else if (__value__ == (5960958i32)) {
                    if ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._quicTransportParameters == null) {
                        _gotoNext = 5961011i32;
                    } else {
                        _gotoNext = 5961172i32;
                    };
                } else if (__value__ == (5961011i32)) {
                    ...
                    _gotoNext = 5961446i32;
                } else if (__value__ == (5961249i32)) {
                    _gotoNext = 5961249i32;
                    if ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._quicTransportParameters != null) {
                        _gotoNext = 5961302i32;
                    } else {
                        _gotoNext = 5961446i32;
                    };
                } else if (__value__ == (5961302i32)) {
                    @:check2r _c_0._sendAlert((110 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
