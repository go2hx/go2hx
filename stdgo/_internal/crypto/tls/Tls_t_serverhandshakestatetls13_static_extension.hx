...
@:keep @:allow(stdgo._internal.crypto.tls.Tls.T_serverHandshakeStateTLS13_asInterface) class T_serverHandshakeStateTLS13_static_extension {
    ...
    static public function _processClientHello( _hs:stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_serverhandshakestatetls13.T_serverHandshakeStateTLS13>):stdgo.Error {
        @:recv var _hs:stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_serverhandshakestatetls13.T_serverHandshakeStateTLS13> = _hs;
        var _group_5976188:stdgo._internal.crypto.tls.Tls_curveid.CurveID = ((0 : stdgo.GoUInt16) : stdgo._internal.crypto.tls.Tls_curveid.CurveID);
        var _ks_5975975:stdgo._internal.crypto.tls.Tls_t_keyshare.T_keyShare = ({} : stdgo._internal.crypto.tls.Tls_t_keyshare.T_keyShare);
        var _i_5975930_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _selectedGroup_5975836:stdgo._internal.crypto.tls.Tls_curveid.CurveID = ((0 : stdgo.GoUInt16) : stdgo._internal.crypto.tls.Tls_curveid.CurveID);
        var _c_5972167:stdgo.Ref<stdgo._internal.crypto.tls.Tls_conn.Conn> = (null : stdgo.Ref<stdgo._internal.crypto.tls.Tls_conn.Conn>);
        var _selectedProto_5977321:stdgo.GoString = ("" : stdgo.GoString);
        var _i_5975981_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_5975306_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _id_5973262:stdgo.GoUInt16 = (0 : stdgo.GoUInt16);
        var _i_5973268_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _key_5976783:stdgo.Ref<stdgo._internal.crypto.ecdh.Ecdh_privatekey.PrivateKey> = (null : stdgo.Ref<stdgo._internal.crypto.ecdh.Ecdh_privatekey.PrivateKey>);
        var _i_5976197_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _clientKeyShare_5975863:stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_keyshare.T_keyShare> = (null : stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_keyshare.T_keyShare>);
        var _preferenceList_5975111:stdgo.Slice<stdgo.GoUInt16> = (null : stdgo.Slice<stdgo.GoUInt16>);
        var _err_5973952:stdgo.Error = (null : stdgo.Error);
        var _err_5976788:stdgo.Error = (null : stdgo.Error);
        var _peerKey_5976998:stdgo.Ref<stdgo._internal.crypto.ecdh.Ecdh_publickey.PublicKey> = (null : stdgo.Ref<stdgo._internal.crypto.ecdh.Ecdh_publickey.PublicKey>);
        var _ok_5976629:Bool = false;
        var _err_5976493:stdgo.Error = (null : stdgo.Error);
        var _preferredGroup_5975912:stdgo._internal.crypto.tls.Tls_curveid.CurveID = ((0 : stdgo.GoUInt16) : stdgo._internal.crypto.tls.Tls_curveid.CurveID);
        var _suiteID_5975295:stdgo.GoUInt16 = (0 : stdgo.GoUInt16);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _c_5972167 = (@:checkr _hs ?? throw "null pointer dereference")._c;
                    ...
                    (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._hello ?? throw "null pointer dereference")._supportedVersion = (@:checkr _c_5972167 ?? throw "null pointer dereference")._vers;
                    if (((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._supportedVersions.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5972462i32;
                    } else {
                        _gotoNext = 5973255i32;
                    };
                } else if (__value__ == (5972462i32)) {
                    @:check2r _c_5972167._sendAlert((47 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._cipherSuites.length)) {
                        _gotoNext = 5973673i32;
                    } else {
                        _gotoNext = 5973678i32;
                    };
                } else if (__value__ == (5973259i32)) {
                    _i_5973268_0++;
                    _gotoNext = 5973674i32;
                } else if (__value__ == (5973302i32)) {
                    _id_5973262 = (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._cipherSuites[(_i_5973268_0 : stdgo.GoInt)];
                    if (_id_5973262 == ((22016 : stdgo.GoUInt16))) {
                        _gotoNext = 5973333i32;
                    } else {
                        _gotoNext = 5973259i32;
                    };
                } else if (__value__ == (5973333i32)) {
                    if (((@:checkr _c_5972167 ?? throw "null pointer dereference")._vers < @:check2r (@:checkr _c_5972167 ?? throw "null pointer dereference")._config._maxSupportedVersion(false) : Bool)) {
                        _gotoNext = 5973534i32;
                    } else {
                        _gotoNext = 5973663i32;
                    };
                } else if (__value__ == (5973534i32)) {
                    @:check2r _c_5972167._sendAlert((86 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: client using inappropriate protocol fallback" : stdgo.GoString));
                    _gotoNext = 5973663i32;
                } else if (__value__ == (5973663i32)) {
                    _gotoNext = 5973678i32;
                } else if (__value__ == (5973673i32)) {
                    {
                        final __tmp__0 = 0i32;
                        ...
                        _i_5973268_0 = __tmp__0;
                        _id_5973262 = __tmp__1;
                    };
                    _gotoNext = 5973674i32;
                } else if (__value__ == (5973674i32)) {
                    if (_i_5973268_0 < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._cipherSuites.length)) {
                        _gotoNext = 5973302i32;
                    } else {
                        _gotoNext = 5973678i32;
                    };
                } else if (__value__ == (5973678i32)) {
                    ...
                    {
                        {
                            var __tmp__ = stdgo._internal.io.Io_readfull.readFull(@:check2r (@:checkr _c_5972167 ?? throw "null pointer dereference")._config._rand(), (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._hello ?? throw "null pointer dereference")._random);
                            _err_5973952 = @:tmpset0 __tmp__._1;
                        };
                        if (_err_5973952 != null) {
                            _gotoNext = 5974017i32;
                        } else {
                            _gotoNext = 5974071i32;
                        };
                    };
                } else if (__value__ == (5974017i32)) {
                    @:check2r _c_5972167._sendAlert((80 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return _err_5973952;
                    _gotoNext = 5974071i32;
                } else if (__value__ == (5974071i32)) {
                    if (((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._secureRenegotiation.length) != ((0 : stdgo.GoInt))) {
                        _gotoNext = 5974119i32;
                    } else {
                        _gotoNext = 5974247i32;
                    };
                } else if (__value__ == (5974119i32)) {
                    @:check2r _c_5972167._sendAlert((40 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    ...
                    _gotoNext = 5974247i32;
                } else if (__value__ == (5974247i32)) {
                    if (((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._earlyData && ((@:checkr _c_5972167 ?? throw "null pointer dereference")._quic != null && (((@:checkr _c_5972167 ?? throw "null pointer dereference")._quic : Dynamic).__nil__ == null || !((@:checkr _c_5972167 ?? throw "null pointer dereference")._quic : Dynamic).__nil__)) : Bool)) {
                        _gotoNext = 5974292i32;
                    } else if ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._earlyData) {
                        _gotoNext = 5974481i32;
                    } else {
                        _gotoNext = 5975017i32;
                    };
                } else if (__value__ == (5974292i32)) {
                    if (((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._pskIdentities.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5974338i32;
                    } else {
                        _gotoNext = 5975017i32;
                    };
                } else if (__value__ == (5974338i32)) {
                    @:check2r _c_5972167._sendAlert((47 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: early_data without pre_shared_key" : stdgo.GoString));
                    _gotoNext = 5975017i32;
                } else if (__value__ == (5974481i32)) {
                    @:check2r _c_5972167._sendAlert((110 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: client sent unexpected early data" : stdgo.GoString));
                    _gotoNext = 5975017i32;
                } else if (__value__ == (5975017i32)) {
                    ...
                    _preferenceList_5975111 = stdgo._internal.crypto.tls.Tls__defaultciphersuitestls13._defaultCipherSuitesTLS13;
                    if ((!stdgo._internal.crypto.tls.Tls__hasaesgcmhardwaresupport._hasAESGCMHardwareSupport || !stdgo._internal.crypto.tls.Tls__aesgcmpreferred._aesgcmPreferred((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._cipherSuites) : Bool)) {
                        _gotoNext = 5975233i32;
                    } else {
                        _gotoNext = 5975288i32;
                    };
                } else if (__value__ == (5975233i32)) {
                    _preferenceList_5975111 = stdgo._internal.crypto.tls.Tls__defaultciphersuitestls13noaes._defaultCipherSuitesTLS13NoAES;
                    _gotoNext = 5975288i32;
                } else if (__value__ == (5975288i32)) {
                    if ((0i32 : stdgo.GoInt) < (_preferenceList_5975111.length)) {
                        _gotoNext = 5975439i32;
                    } else {
                        _gotoNext = 5975443i32;
                    };
                } else if (__value__ == (5975292i32)) {
                    _i_5975306_0++;
                    _gotoNext = 5975440i32;
                } else if (__value__ == (5975327i32)) {
                    _suiteID_5975295 = _preferenceList_5975111[(_i_5975306_0 : stdgo.GoInt)];
                    (@:checkr _hs ?? throw "null pointer dereference")._suite = stdgo._internal.crypto.tls.Tls__mutualciphersuitetls13._mutualCipherSuiteTLS13((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._cipherSuites, _suiteID_5975295);
                    if (((@:checkr _hs ?? throw "null pointer dereference")._suite != null && (((@:checkr _hs ?? throw "null pointer dereference")._suite : Dynamic).__nil__ == null || !((@:checkr _hs ?? throw "null pointer dereference")._suite : Dynamic).__nil__))) {
                        _gotoNext = 5975424i32;
                    } else {
                        _gotoNext = 5975292i32;
                    };
                } else if (__value__ == (5975424i32)) {
                    _gotoNext = 5975443i32;
                } else if (__value__ == (5975439i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _preferenceList_5975111[(0i32 : stdgo.GoInt)];
                        _i_5975306_0 = __tmp__0;
                        _suiteID_5975295 = __tmp__1;
                    };
                    _gotoNext = 5975440i32;
                } else if (__value__ == (5975440i32)) {
                    if (_i_5975306_0 < (_preferenceList_5975111.length)) {
                        _gotoNext = 5975327i32;
                    } else {
                        _gotoNext = 5975443i32;
                    };
                } else if (__value__ == (5975443i32)) {
                    if (((@:checkr _hs ?? throw "null pointer dereference")._suite == null || ((@:checkr _hs ?? throw "null pointer dereference")._suite : Dynamic).__nil__)) {
                        _gotoNext = 5975462i32;
                    } else {
                        _gotoNext = 5975585i32;
                    };
                } else if (__value__ == (5975462i32)) {
                    @:check2r _c_5972167._sendAlert((40 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: no cipher suite supported by both client and server" : stdgo.GoString));
                    _gotoNext = 5975585i32;
                } else if (__value__ == (5975585i32)) {
                    (@:checkr _c_5972167 ?? throw "null pointer dereference")._cipherSuite = (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._suite ?? throw "null pointer dereference")._id;
                    ...
                    _gotoNext = 5975888i32;
                } else if (__value__ == (5975888i32)) {
                    if ((0i32 : stdgo.GoInt) < (@:check2r (@:checkr _c_5972167 ?? throw "null pointer dereference")._config._curvePreferences().length)) {
                        _gotoNext = 5976313i32;
                    } else {
                        _gotoNext = 5976317i32;
                    };
                } else if (__value__ == (5975909i32)) {
                    _i_5975930_0++;
                    _gotoNext = 5976314i32;
                } else if (__value__ == (5975964i32)) {
                    _preferredGroup_5975912 = @:check2r (@:checkr _c_5972167 ?? throw "null pointer dereference")._config._curvePreferences()[(_i_5975930_0 : stdgo.GoInt)];
                    if ((0i32 : stdgo.GoInt) < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._keyShares.length)) {
                        _gotoNext = 5976134i32;
                    } else {
                        _gotoNext = 5976139i32;
                    };
                } else if (__value__ == (5975972i32)) {
                    _i_5975981_0++;
                    _gotoNext = 5976135i32;
                } else if (__value__ == (5976012i32)) {
                    _ks_5975975 = (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._keyShares[(_i_5975981_0 : stdgo.GoInt)];
                    if (_ks_5975975._group == (_preferredGroup_5975912)) {
                        _gotoNext = 5976047i32;
                    } else {
                        _gotoNext = 5975972i32;
                    };
                } else if (__value__ == (5976047i32)) {
                    _selectedGroup_5975836 = _ks_5975975._group;
                    _clientKeyShare_5975863 = (stdgo.Go.setRef(_ks_5975975) : stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_keyshare.T_keyShare>);
                    stdgo._internal.crypto.tls.Tls_groupselectionbreak.groupSelectionBreak = true;
                    _gotoNext = 5976314i32;
                } else if (__value__ == (5976134i32)) {
                    {
                        final __tmp__0 = 0i32;
                        ...
                        _i_5975981_0 = __tmp__0;
                        _ks_5975975 = __tmp__1;
                    };
                    _gotoNext = 5976135i32;
                } else if (__value__ == (5976135i32)) {
                    if (_i_5975981_0 < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._keyShares.length)) {
                        _gotoNext = 5976012i32;
                    } else {
                        _gotoNext = 5976139i32;
                    };
                } else if (__value__ == (5976139i32)) {
                    if (_selectedGroup_5975836 != ((0 : stdgo._internal.crypto.tls.Tls_curveid.CurveID))) {
                        _gotoNext = 5976161i32;
                    } else {
                        _gotoNext = 5976181i32;
                    };
                } else if (__value__ == (5976161i32)) {
                    _i_5975930_0++;
                    _gotoNext = 5976314i32;
                } else if (__value__ == (5976181i32)) {
                    if ((0i32 : stdgo.GoInt) < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._supportedCurves.length)) {
                        _gotoNext = 5976310i32;
                    } else {
                        _gotoNext = 5975909i32;
                    };
                } else if (__value__ == (5976185i32)) {
                    _i_5976197_0++;
                    _gotoNext = 5976311i32;
                } else if (__value__ == (5976234i32)) {
                    _group_5976188 = (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._supportedCurves[(_i_5976197_0 : stdgo.GoInt)];
                    if (_group_5976188 == (_preferredGroup_5975912)) {
                        _gotoNext = 5976266i32;
                    } else {
                        _gotoNext = 5976185i32;
                    };
                } else if (__value__ == (5976266i32)) {
                    _selectedGroup_5975836 = _group_5976188;
                    _gotoNext = 5975909i32;
                } else if (__value__ == (5976310i32)) {
                    {
                        final __tmp__0 = 0i32;
                        ...
                        _i_5976197_0 = __tmp__0;
                        _group_5976188 = __tmp__1;
                    };
                    _gotoNext = 5976311i32;
                } else if (__value__ == (5976311i32)) {
                    if (_i_5976197_0 < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._supportedCurves.length)) {
                        _gotoNext = 5976234i32;
                    } else {
                        _gotoNext = 5975909i32;
                    };
                } else if (__value__ == (5976313i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = @:check2r (@:checkr _c_5972167 ?? throw "null pointer dereference")._config._curvePreferences()[(0i32 : stdgo.GoInt)];
                        _i_5975930_0 = __tmp__0;
                        _preferredGroup_5975912 = __tmp__1;
                    };
                    _gotoNext = 5976314i32;
                } else if (__value__ == (5976314i32)) {
                    if (_i_5975930_0 < (@:check2r (@:checkr _c_5972167 ?? throw "null pointer dereference")._config._curvePreferences().length)) {
                        _gotoNext = 5975964i32;
                    } else {
                        _gotoNext = 5976317i32;
                    };
                } else if (__value__ == (5976317i32)) {
                    if (_selectedGroup_5975836 == ((0 : stdgo._internal.crypto.tls.Tls_curveid.CurveID))) {
                        _gotoNext = 5976339i32;
                    } else {
                        _gotoNext = 5976461i32;
                    };
                } else if (__value__ == (5976339i32)) {
                    @:check2r _c_5972167._sendAlert((40 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: no ECDHE curve supported by both client and server" : stdgo.GoString));
                    _gotoNext = 5976461i32;
                } else if (__value__ == (5976461i32)) {
                    if ((_clientKeyShare_5975863 == null || (_clientKeyShare_5975863 : Dynamic).__nil__)) {
                        _gotoNext = 5976486i32;
                    } else {
                        _gotoNext = 5976623i32;
                    };
                } else if (__value__ == (5976486i32)) {
                    {
                        _err_5976493 = @:check2r _hs._doHelloRetryRequest(_selectedGroup_5975836);
                        if (_err_5976493 != null) {
                            _gotoNext = 5976550i32;
                        } else {
                            _gotoNext = 5976572i32;
                        };
                    };
                } else if (__value__ == (5976550i32)) {
                    return _err_5976493;
                    _gotoNext = 5976572i32;
                } else if (__value__ == (5976572i32)) {
                    _clientKeyShare_5975863 = (stdgo.Go.setRef((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._keyShares[(0 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_keyshare.T_keyShare>);
                    _gotoNext = 5976623i32;
                } else if (__value__ == (5976623i32)) {
                    {
                        {
                            var __tmp__ = stdgo._internal.crypto.tls.Tls__curveforcurveid._curveForCurveID(_selectedGroup_5975836);
                            _ok_5976629 = @:tmpset0 __tmp__._1;
                        };
                        if (!_ok_5976629) {
                            _gotoNext = 5976671i32;
                        } else {
                            _gotoNext = 5976783i32;
                        };
                    };
                } else if (__value__ == (5976671i32)) {
                    @:check2r _c_5972167._sendAlert((80 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: CurvePreferences includes unsupported curve" : stdgo.GoString));
                    _gotoNext = 5976783i32;
                } else if (__value__ == (5976783i32)) {
                    {
                        var __tmp__ = stdgo._internal.crypto.tls.Tls__generateecdhekey._generateECDHEKey(@:check2r (@:checkr _c_5972167 ?? throw "null pointer dereference")._config._rand(), _selectedGroup_5975836);
                        _key_5976783 = @:tmpset0 __tmp__._0;
                        _err_5976788 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_5976788 != null) {
                        _gotoNext = 5976859i32;
                    } else {
                        _gotoNext = 5976912i32;
                    };
                } else if (__value__ == (5976859i32)) {
                    @:check2r _c_5972167._sendAlert((80 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return _err_5976788;
                    _gotoNext = 5976912i32;
                } else if (__value__ == (5976912i32)) {
                    (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._hello ?? throw "null pointer dereference")._serverShare = ({ _group : _selectedGroup_5975836, _data : @:check2r @:check2r _key_5976783.publicKey().bytes() } : stdgo._internal.crypto.tls.Tls_t_keyshare.T_keyShare);
                    {
                        var __tmp__ = @:check2r _key_5976783.curve().newPublicKey((@:checkr _clientKeyShare_5975863 ?? throw "null pointer dereference")._data);
                        _peerKey_5976998 = @:tmpset0 __tmp__._0;
                        _err_5976788 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_5976788 != null) {
                        _gotoNext = 5977075i32;
                    } else {
                        _gotoNext = 5977171i32;
                    };
                } else if (__value__ == (5977075i32)) {
                    @:check2r _c_5972167._sendAlert((47 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: invalid client key share" : stdgo.GoString));
                    _gotoNext = 5977171i32;
                } else if (__value__ == (5977171i32)) {
                    {
                        var __tmp__ = @:check2r _key_5976783.eCDH(_peerKey_5976998);
                        (@:checkr _hs ?? throw "null pointer dereference")._sharedKey = @:tmpset0 __tmp__._0;
                        _err_5976788 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_5976788 != null) {
                        _gotoNext = 5977224i32;
                    } else {
                        _gotoNext = 5977321i32;
                    };
                } else if (__value__ == (5977224i32)) {
                    @:check2r _c_5972167._sendAlert((47 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: invalid client key share" : stdgo.GoString));
                    _gotoNext = 5977321i32;
                } else if (__value__ == (5977321i32)) {
                    {
                        var __tmp__ = stdgo._internal.crypto.tls.Tls__negotiatealpn._negotiateALPN((@:checkr (@:checkr _c_5972167 ?? throw "null pointer dereference")._config ?? throw "null pointer dereference").nextProtos, (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._alpnProtocols, ((@:checkr _c_5972167 ?? throw "null pointer dereference")._quic != null && (((@:checkr _c_5972167 ?? throw "null pointer dereference")._quic : Dynamic).__nil__ == null || !((@:checkr _c_5972167 ?? throw "null pointer dereference")._quic : Dynamic).__nil__)));
                        _selectedProto_5977321 = @:tmpset0 __tmp__._0?.__copy__();
                        _err_5976788 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_5976788 != null) {
                        _gotoNext = 5977438i32;
                    } else {
                        _gotoNext = 5977499i32;
                    };
                } else if (__value__ == (5977438i32)) {
                    @:check2r _c_5972167._sendAlert((120 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return _err_5976788;
                    _gotoNext = 5977499i32;
                } else if (__value__ == (5977499i32)) {
                    (@:checkr _c_5972167 ?? throw "null pointer dereference")._clientProtocol = _selectedProto_5977321?.__copy__();
                    if (((@:checkr _c_5972167 ?? throw "null pointer dereference")._quic != null && (((@:checkr _c_5972167 ?? throw "null pointer dereference")._quic : Dynamic).__nil__ == null || !((@:checkr _c_5972167 ?? throw "null pointer dereference")._quic : Dynamic).__nil__))) {
                        _gotoNext = 5977551i32;
                    } else {
                        _gotoNext = 5977842i32;
                    };
                } else if (__value__ == (5977551i32)) {
                    if ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._quicTransportParameters == null) {
                        _gotoNext = 5977604i32;
                    } else {
                        _gotoNext = 5977765i32;
                    };
                } else if (__value__ == (5977604i32)) {
                    @:check2r _c_5972167._sendAlert((109 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    ...
                    _gotoNext = 5977765i32;
                } else if (__value__ == (5977765i32)) {
                    @:check2r _c_5972167._quicSetTransportParameters((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._quicTransportParameters);
                    _gotoNext = 5978039i32;
                } else if (__value__ == (5977842i32)) {
                    _gotoNext = 5977842i32;
                    if ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._quicTransportParameters != null) {
                        _gotoNext = 5977895i32;
                    } else {
                        _gotoNext = 5978039i32;
                    };
                } else if (__value__ == (5977895i32)) {
                    @:check2r _c_5972167._sendAlert((110 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    ...
                    _gotoNext = 5978039i32;
                } else if (__value__ == (5978039i32)) {
                    (@:checkr _c_5972167 ?? throw "null pointer dereference")._serverName = (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._serverName?.__copy__();
                    return (null : stdgo.Error);
                    _gotoNext = -1i32;
                };
            };
