...
@:keep @:allow(stdgo._internal.crypto.tls.Tls.T_serverHandshakeStateTLS13_asInterface) class T_serverHandshakeStateTLS13_static_extension {
    ...
    static public function _processClientHello( _hs:stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_serverhandshakestatetls13.T_serverHandshakeStateTLS13>):stdgo.Error {
        ...
        var _i_5836717_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _preferenceList_5836522:stdgo.Slice<stdgo.GoUInt16> = (null : stdgo.Slice<stdgo.GoUInt16>);
        var _err_5835363:stdgo.Error = (null : stdgo.Error);
        var _selectedProto_5838732:stdgo.GoString = ("" : stdgo.GoString);
        var _err_5837904:stdgo.Error = (null : stdgo.Error);
        var _ks_5837386:stdgo._internal.crypto.tls.Tls_t_keyshare.T_keyShare = ({} : stdgo._internal.crypto.tls.Tls_t_keyshare.T_keyShare);
        var _preferredGroup_5837323:stdgo._internal.crypto.tls.Tls_curveid.CurveID = ((0 : stdgo.GoUInt16) : stdgo._internal.crypto.tls.Tls_curveid.CurveID);
        var _id_5834673:stdgo.GoUInt16 = (0 : stdgo.GoUInt16);
        var _peerKey_5838409:stdgo.Ref<stdgo._internal.crypto.ecdh.Ecdh_publickey.PublicKey> = (null : stdgo.Ref<stdgo._internal.crypto.ecdh.Ecdh_publickey.PublicKey>);
        var _key_5838194:stdgo.Ref<stdgo._internal.crypto.ecdh.Ecdh_privatekey.PrivateKey> = (null : stdgo.Ref<stdgo._internal.crypto.ecdh.Ecdh_privatekey.PrivateKey>);
        var _suiteID_5836706:stdgo.GoUInt16 = (0 : stdgo.GoUInt16);
        var _i_5834679_0:stdgo.GoInt = (0 : stdgo.GoInt);
        var _c_5833578:stdgo.Ref<stdgo._internal.crypto.tls.Tls_conn.Conn> = (null : stdgo.Ref<stdgo._internal.crypto.tls.Tls_conn.Conn>);
        var _err_5838199:stdgo.Error = (null : stdgo.Error);
        var _ok_5838040:Bool = false;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._hello ?? throw "null pointer dereference")._supportedVersion = (@:checkr _c_5833578 ?? throw "null pointer dereference")._vers;
                    ...
                    @:check2r _c_5833578._sendAlert((47 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    ...
                    _id_5834673 = (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._cipherSuites[(_i_5834679_0 : stdgo.GoInt)];
                    if (_id_5834673 == ((22016 : stdgo.GoUInt16))) {
                        _gotoNext = 5834744i32;
                    } else {
                        _gotoNext = 5834670i32;
                    };
                } else if (__value__ == (5834744i32)) {
                    if (((@:checkr _c_5833578 ?? throw "null pointer dereference")._vers < @:check2r (@:checkr _c_5833578 ?? throw "null pointer dereference")._config._maxSupportedVersion(false) : Bool)) {
                        _gotoNext = 5834945i32;
                    } else {
                        _gotoNext = 5835074i32;
                    };
                } else if (__value__ == (5834945i32)) {
                    @:check2r _c_5833578._sendAlert((86 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                ...
                } else if (__value__ == (5835084i32)) {
                    {
                        ...
                        _i_5834679_0 = __tmp__0;
                        _id_5834673 = __tmp__1;
                    };
                    _gotoNext = 5835085i32;
                } else if (__value__ == (5835085i32)) {
                    if (_i_5834679_0 < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._cipherSuites.length)) {
                    ...
                    {
                        {
                            var __tmp__ = stdgo._internal.io.Io_readfull.readFull(@:check2r (@:checkr _c_5833578 ?? throw "null pointer dereference")._config._rand(), (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._hello ?? throw "null pointer dereference")._random);
                            _err_5835363 = @:tmpset0 __tmp__._1;
                        };
                        if (_err_5835363 != null) {
                    ...
                    @:check2r _c_5833578._sendAlert((80 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return _err_5835363;
                    _gotoNext = 5835482i32;
                    ...
                    @:check2r _c_5833578._sendAlert((40 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    ...
                    if (((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._earlyData && ((@:checkr _c_5833578 ?? throw "null pointer dereference")._quic != null && (((@:checkr _c_5833578 ?? throw "null pointer dereference")._quic : Dynamic).__nil__ == null || !((@:checkr _c_5833578 ?? throw "null pointer dereference")._quic : Dynamic).__nil__)) : Bool)) {
                    ...
                    @:check2r _c_5833578._sendAlert((110 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    ...
                    _preferenceList_5836522 = stdgo._internal.crypto.tls.Tls__defaultciphersuitestls13._defaultCipherSuitesTLS13;
                    ...
                    _preferenceList_5836522 = stdgo._internal.crypto.tls.Tls__defaultciphersuitestls13noaes._defaultCipherSuitesTLS13NoAES;
                    _gotoNext = 5836699i32;
                } else if (__value__ == (5836699i32)) {
                    if ((0i32 : stdgo.GoInt) < (_preferenceList_5836522.length)) {
                    ...
                    _suiteID_5836706 = _preferenceList_5836522[(_i_5836717_0 : stdgo.GoInt)];
                    (@:checkr _hs ?? throw "null pointer dereference")._suite = stdgo._internal.crypto.tls.Tls__mutualciphersuitetls13._mutualCipherSuiteTLS13((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._cipherSuites, _suiteID_5836706);
                    ...
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _preferenceList_5836522[(0i32 : stdgo.GoInt)];
                        _i_5836717_0 = __tmp__0;
                        _suiteID_5836706 = __tmp__1;
                    };
                    _gotoNext = 5836851i32;
                } else if (__value__ == (5836851i32)) {
                    if (_i_5836717_0 < (_preferenceList_5836522.length)) {
                    ...
                    (@:checkr _c_5833578 ?? throw "null pointer dereference")._cipherSuite = (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._suite ?? throw "null pointer dereference")._id;
                    ...
                    if ((0i32 : stdgo.GoInt) < (@:check2r (@:checkr _c_5833578 ?? throw "null pointer dereference")._config._curvePreferences().length)) {
                    ...
                    _preferredGroup_5837323 = @:check2r (@:checkr _c_5833578 ?? throw "null pointer dereference")._config._curvePreferences()[(_i_5837341_0 : stdgo.GoInt)];
                    ...
                    _ks_5837386 = (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._keyShares[(_i_5837392_0 : stdgo.GoInt)];
                    if (_ks_5837386._group == (_preferredGroup_5837323)) {
                        _gotoNext = 5837458i32;
                    } else {
                        _gotoNext = 5837383i32;
                    };
                } else if (__value__ == (5837458i32)) {
                    _selectedGroup_5837247 = _ks_5837386._group;
                    _clientKeyShare_5837274 = (stdgo.Go.setRef(_ks_5837386) : stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_keyshare.T_keyShare>);
                ...
                } else if (__value__ == (5837545i32)) {
                    {
                        ...
                        _i_5837392_0 = __tmp__0;
                        _ks_5837386 = __tmp__1;
                    };
                    _gotoNext = 5837546i32;
                } else if (__value__ == (5837546i32)) {
                    if (_i_5837392_0 < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._keyShares.length)) {
                        _gotoNext = 5837423i32;
                    } else {
                        _gotoNext = 5837550i32;
                    };
                } else if (__value__ == (5837550i32)) {
                    if (_selectedGroup_5837247 != ((0 : stdgo._internal.crypto.tls.Tls_curveid.CurveID))) {
                    ...
                    _group_5837599 = (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._supportedCurves[(_i_5837608_0 : stdgo.GoInt)];
                    if (_group_5837599 == (_preferredGroup_5837323)) {
                        _gotoNext = 5837677i32;
                    } else {
                        _gotoNext = 5837596i32;
                    };
                } else if (__value__ == (5837677i32)) {
                    _selectedGroup_5837247 = _group_5837599;
                    _gotoNext = 5837320i32;
                } else if (__value__ == (5837721i32)) {
                    {
                        ...
                        _i_5837608_0 = __tmp__0;
                        _group_5837599 = __tmp__1;
                    };
                    _gotoNext = 5837722i32;
                } else if (__value__ == (5837722i32)) {
                    if (_i_5837608_0 < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._supportedCurves.length)) {
                    ...
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = @:check2r (@:checkr _c_5833578 ?? throw "null pointer dereference")._config._curvePreferences()[(0i32 : stdgo.GoInt)];
                        _i_5837341_0 = __tmp__0;
                        _preferredGroup_5837323 = __tmp__1;
                    };
                    _gotoNext = 5837725i32;
                } else if (__value__ == (5837725i32)) {
                    if (_i_5837341_0 < (@:check2r (@:checkr _c_5833578 ?? throw "null pointer dereference")._config._curvePreferences().length)) {
                    ...
                    if ((_clientKeyShare_5837274 == null || (_clientKeyShare_5837274 : Dynamic).__nil__)) {
                    ...
                    {
                        _err_5837904 = @:check2r _hs._doHelloRetryRequest(_selectedGroup_5837247);
                        if (_err_5837904 != null) {
                    ...
                    _clientKeyShare_5837274 = (stdgo.Go.setRef((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._keyShares[(0 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_keyshare.T_keyShare>);
                    _gotoNext = 5838034i32;
                } else if (__value__ == (5838034i32)) {
                    {
                        {
                            var __tmp__ = stdgo._internal.crypto.tls.Tls__curveforcurveid._curveForCurveID(_selectedGroup_5837247);
                            _ok_5838040 = @:tmpset0 __tmp__._1;
                        };
                        if (!_ok_5838040) {
                    ...
                    {
                        var __tmp__ = stdgo._internal.crypto.tls.Tls__generateecdhekey._generateECDHEKey(@:check2r (@:checkr _c_5833578 ?? throw "null pointer dereference")._config._rand(), _selectedGroup_5837247);
                        _key_5838194 = @:tmpset0 __tmp__._0;
                        _err_5838199 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_5838199 != null) {
                    ...
                    (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._hello ?? throw "null pointer dereference")._serverShare = ({ _group : _selectedGroup_5837247, _data : @:check2r @:check2r _key_5838194.publicKey().bytes() } : stdgo._internal.crypto.tls.Tls_t_keyshare.T_keyShare);
                    {
                        var __tmp__ = @:check2r _key_5838194.curve().newPublicKey((@:checkr _clientKeyShare_5837274 ?? throw "null pointer dereference")._data);
                        _peerKey_5838409 = @:tmpset0 __tmp__._0;
                        _err_5838199 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_5838199 != null) {
                    ...
                    {
                        var __tmp__ = @:check2r _key_5838194.eCDH(_peerKey_5838409);
                    ...
                    {
                        var __tmp__ = stdgo._internal.crypto.tls.Tls__negotiatealpn._negotiateALPN((@:checkr (@:checkr _c_5833578 ?? throw "null pointer dereference")._config ?? throw "null pointer dereference").nextProtos, (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._alpnProtocols, ((@:checkr _c_5833578 ?? throw "null pointer dereference")._quic != null && (((@:checkr _c_5833578 ?? throw "null pointer dereference")._quic : Dynamic).__nil__ == null || !((@:checkr _c_5833578 ?? throw "null pointer dereference")._quic : Dynamic).__nil__)));
                        _selectedProto_5838732 = @:tmpset0 __tmp__._0?.__copy__();
                        _err_5838199 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_5838199 != null) {
                    ...
                    @:check2r _c_5833578._sendAlert((120 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return _err_5838199;
                    _gotoNext = 5838910i32;
                } else if (__value__ == (5838910i32)) {
                    (@:checkr _c_5833578 ?? throw "null pointer dereference")._clientProtocol = _selectedProto_5838732?.__copy__();
                    if (((@:checkr _c_5833578 ?? throw "null pointer dereference")._quic != null && (((@:checkr _c_5833578 ?? throw "null pointer dereference")._quic : Dynamic).__nil__ == null || !((@:checkr _c_5833578 ?? throw "null pointer dereference")._quic : Dynamic).__nil__))) {
                    ...
                    @:check2r _c_5833578._sendAlert((109 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    ...
                    @:check2r _c_5833578._quicSetTransportParameters((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._quicTransportParameters);
