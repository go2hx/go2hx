...
@:keep @:allow(stdgo._internal.crypto.tls.Tls.T_serverHandshakeStateTLS13_asInterface) class T_serverHandshakeStateTLS13_static_extension {
    ...
    static public function _processClientHello( _hs:stdgo.Ref<stdgo._internal.crypto.tls.Tls_t_serverhandshakestatetls13.T_serverHandshakeStateTLS13>):stdgo.Error {
        ...
        var _i_5955667_13:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        var _i_5954776_5:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        var _i_5955451_11:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_5955400_9:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_5952738_1:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if (((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._supportedVersions.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5951932i32;
                    } else {
                        _gotoNext = 5952725i32;
                    };
                } else if (__value__ == (5951932i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._cipherSuites.length)) {
                        _gotoNext = 5953143i32;
                    } else {
                        _gotoNext = 5953148i32;
                    };
                } else if (__value__ == (5952729i32)) {
                    _i_5952738_1++;
                    _gotoNext = 5953144i32;
                } else if (__value__ == (5952772i32)) {
                    _id_2 = (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._cipherSuites[(_i_5952738_1 : stdgo.GoInt)];
                    if (_id_2 == ((22016 : stdgo.GoUInt16))) {
                        _gotoNext = 5952803i32;
                    } else {
                        _gotoNext = 5952729i32;
                    };
                } else if (__value__ == (5952803i32)) {
                    if (((@:checkr _c_0 ?? throw "null pointer dereference")._vers < @:check2r (@:checkr _c_0 ?? throw "null pointer dereference")._config._maxSupportedVersion(false) : Bool)) {
                        _gotoNext = 5953004i32;
                    } else {
                        _gotoNext = 5953133i32;
                    };
                } else if (__value__ == (5953004i32)) {
                    ...
                    _gotoNext = 5953133i32;
                } else if (__value__ == (5953133i32)) {
                    _gotoNext = 5953148i32;
                } else if (__value__ == (5953143i32)) {
                    {
                        final __tmp__0 = 0i32;
                        ...
                        _i_5952738_1 = __tmp__0;
                        _id_2 = __tmp__1;
                    };
                    _gotoNext = 5953144i32;
                } else if (__value__ == (5953144i32)) {
                    if (_i_5952738_1 < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._cipherSuites.length)) {
                        _gotoNext = 5952772i32;
                    } else {
                        _gotoNext = 5953148i32;
                    };
                } else if (__value__ == (5953148i32)) {
                    ...
                    (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._hello ?? throw "null pointer dereference")._random = (new stdgo.Slice<stdgo.GoUInt8>((32 : stdgo.GoInt).toBasic(), 0).__setNumber32__() : stdgo.Slice<stdgo.GoUInt8>);
                    {
                        ...
                        if (_err_3 != null) {
                            _gotoNext = 5953487i32;
                        } else {
                            _gotoNext = 5953541i32;
                        };
                    };
                } else if (__value__ == (5953487i32)) {
                    @:check2r _c_0._sendAlert((80 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return _err_3;
                    _gotoNext = 5953541i32;
                } else if (__value__ == (5953541i32)) {
                    if (((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._secureRenegotiation.length) != ((0 : stdgo.GoInt))) {
                        _gotoNext = 5953589i32;
                    } else {
                        _gotoNext = 5953717i32;
                    };
                } else if (__value__ == (5953589i32)) {
                    ...
                    if ((!stdgo._internal.crypto.tls.Tls__hasaesgcmhardwaresupport._hasAESGCMHardwareSupport || !stdgo._internal.crypto.tls.Tls__aesgcmpreferred._aesgcmPreferred((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._cipherSuites) : Bool)) {
                        _gotoNext = 5954703i32;
                    } else {
                        _gotoNext = 5954758i32;
                    };
                } else if (__value__ == (5954703i32)) {
                    _preferenceList_4 = stdgo._internal.crypto.tls.Tls__defaultciphersuitestls13noaes._defaultCipherSuitesTLS13NoAES;
                    _gotoNext = 5954758i32;
                } else if (__value__ == (5954758i32)) {
                    if ((0i32 : stdgo.GoInt) < (_preferenceList_4.length)) {
                        _gotoNext = 5954909i32;
                    } else {
                        _gotoNext = 5954913i32;
                    };
                } else if (__value__ == (5954762i32)) {
                    _i_5954776_5++;
                    _gotoNext = 5954910i32;
                } else if (__value__ == (5954797i32)) {
                    _suiteID_6 = _preferenceList_4[(_i_5954776_5 : stdgo.GoInt)];
                    ...
                    if (((@:checkr _hs ?? throw "null pointer dereference")._suite != null && (((@:checkr _hs ?? throw "null pointer dereference")._suite : Dynamic).__nil__ == null || !((@:checkr _hs ?? throw "null pointer dereference")._suite : Dynamic).__nil__))) {
                        _gotoNext = 5954894i32;
                    } else {
                        _gotoNext = 5954762i32;
                    };
                } else if (__value__ == (5954894i32)) {
                    _gotoNext = 5954913i32;
                } else if (__value__ == (5954909i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _preferenceList_4[(0i32 : stdgo.GoInt)];
                        _i_5954776_5 = __tmp__0;
                        _suiteID_6 = __tmp__1;
                    };
                    _gotoNext = 5954910i32;
                } else if (__value__ == (5954910i32)) {
                    if (_i_5954776_5 < (_preferenceList_4.length)) {
                        _gotoNext = 5954797i32;
                    } else {
                        _gotoNext = 5954913i32;
                    };
                } else if (__value__ == (5954913i32)) {
                    ...
                    _gotoNext = 5955358i32;
                } else if (__value__ == (5955358i32)) {
                    if ((0i32 : stdgo.GoInt) < (@:check2r (@:checkr _c_0 ?? throw "null pointer dereference")._config._curvePreferences().length)) {
                        _gotoNext = 5955783i32;
                    } else {
                        _gotoNext = 5955787i32;
                    };
                } else if (__value__ == (5955379i32)) {
                    _i_5955400_9++;
                    _gotoNext = 5955784i32;
                } else if (__value__ == (5955434i32)) {
                    _preferredGroup_10 = @:check2r (@:checkr _c_0 ?? throw "null pointer dereference")._config._curvePreferences()[(_i_5955400_9 : stdgo.GoInt)];
                    if ((0i32 : stdgo.GoInt) < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._keyShares.length)) {
                        _gotoNext = 5955604i32;
                    } else {
                        _gotoNext = 5955609i32;
                    };
                } else if (__value__ == (5955442i32)) {
                    _i_5955451_11++;
                    _gotoNext = 5955605i32;
                } else if (__value__ == (5955482i32)) {
                    _ks_12 = (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._keyShares[(_i_5955451_11 : stdgo.GoInt)];
                    if (_ks_12._group == (_preferredGroup_10)) {
                        _gotoNext = 5955517i32;
                    } else {
                        _gotoNext = 5955442i32;
                    };
                } else if (__value__ == (5955517i32)) {
                ...
                } else if (__value__ == (5955604i32)) {
                    {
                        ...
                        _i_5955451_11 = __tmp__0;
                        _ks_12 = __tmp__1;
                    };
                    _gotoNext = 5955605i32;
                } else if (__value__ == (5955605i32)) {
                    if (_i_5955451_11 < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._keyShares.length)) {
                        _gotoNext = 5955482i32;
                    } else {
                        _gotoNext = 5955609i32;
                    };
                } else if (__value__ == (5955609i32)) {
                    if (_selectedGroup_7 != ((0 : stdgo._internal.crypto.tls.Tls_curveid.CurveID))) {
                        _gotoNext = 5955631i32;
                    } else {
                        _gotoNext = 5955651i32;
                    };
                } else if (__value__ == (5955631i32)) {
                    _i_5955400_9++;
                    _gotoNext = 5955784i32;
                } else if (__value__ == (5955651i32)) {
                    if ((0i32 : stdgo.GoInt) < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._supportedCurves.length)) {
                        _gotoNext = 5955780i32;
                    } else {
                        _gotoNext = 5955379i32;
                    };
                } else if (__value__ == (5955655i32)) {
                    _i_5955667_13++;
                    _gotoNext = 5955781i32;
                } else if (__value__ == (5955704i32)) {
                    _group_14 = (@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._supportedCurves[(_i_5955667_13 : stdgo.GoInt)];
                    if (_group_14 == (_preferredGroup_10)) {
                        _gotoNext = 5955736i32;
                    } else {
                        _gotoNext = 5955655i32;
                    };
                } else if (__value__ == (5955736i32)) {
                    _selectedGroup_7 = _group_14;
                    _gotoNext = 5955379i32;
                } else if (__value__ == (5955780i32)) {
                    {
                        final __tmp__0 = 0i32;
                        ...
                        _i_5955667_13 = __tmp__0;
                        _group_14 = __tmp__1;
                    };
                    _gotoNext = 5955781i32;
                } else if (__value__ == (5955781i32)) {
                    if (_i_5955667_13 < ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._supportedCurves.length)) {
                        _gotoNext = 5955704i32;
                    } else {
                        _gotoNext = 5955379i32;
                    };
                } else if (__value__ == (5955783i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = @:check2r (@:checkr _c_0 ?? throw "null pointer dereference")._config._curvePreferences()[(0i32 : stdgo.GoInt)];
                        _i_5955400_9 = __tmp__0;
                        _preferredGroup_10 = __tmp__1;
                    };
                    _gotoNext = 5955784i32;
                } else if (__value__ == (5955784i32)) {
                    if (_i_5955400_9 < (@:check2r (@:checkr _c_0 ?? throw "null pointer dereference")._config._curvePreferences().length)) {
                        _gotoNext = 5955434i32;
                    } else {
                        _gotoNext = 5955787i32;
                    };
                } else if (__value__ == (5955787i32)) {
                    if (_selectedGroup_7 == ((0 : stdgo._internal.crypto.tls.Tls_curveid.CurveID))) {
                        _gotoNext = 5955809i32;
                    } else {
                        _gotoNext = 5955931i32;
                    };
                } else if (__value__ == (5955809i32)) {
                    @:check2r _c_0._sendAlert((40 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: no ECDHE curve supported by both client and server" : stdgo.GoString));
                    _gotoNext = 5955931i32;
                } else if (__value__ == (5955931i32)) {
                    if ((_clientKeyShare_8 == null || (_clientKeyShare_8 : Dynamic).__nil__)) {
                        _gotoNext = 5955956i32;
                    } else {
                        _gotoNext = 5956093i32;
                    };
                } else if (__value__ == (5955956i32)) {
                    {
                        _err_15 = @:check2r _hs._doHelloRetryRequest(_selectedGroup_7);
                        if (_err_15 != null) {
                            _gotoNext = 5956020i32;
                        } else {
                            _gotoNext = 5956042i32;
                        };
                    };
                } else if (__value__ == (5956020i32)) {
                    return _err_15;
                    _gotoNext = 5956042i32;
                } else if (__value__ == (5956042i32)) {
                    ...
                    if (_err_18 != null) {
                        _gotoNext = 5956329i32;
                    } else {
                        _gotoNext = 5956382i32;
                    };
                } else if (__value__ == (5956329i32)) {
                    @:check2r _c_0._sendAlert((80 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return _err_18;
                    _gotoNext = 5956382i32;
                } else if (__value__ == (5956382i32)) {
                    ...
                    if (_err_18 != null) {
                        _gotoNext = 5956545i32;
                    } else {
                        _gotoNext = 5956641i32;
                    };
                } else if (__value__ == (5956545i32)) {
                    @:check2r _c_0._sendAlert((47 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: invalid client key share" : stdgo.GoString));
                    _gotoNext = 5956641i32;
                } else if (__value__ == (5956641i32)) {
                    {
                    ...
                    if (_err_18 != null) {
                        _gotoNext = 5956694i32;
                    } else {
                        _gotoNext = 5956791i32;
                    };
                } else if (__value__ == (5956694i32)) {
                    @:check2r _c_0._sendAlert((47 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return stdgo._internal.errors.Errors_new_.new_(("tls: invalid client key share" : stdgo.GoString));
                    _gotoNext = 5956791i32;
                } else if (__value__ == (5956791i32)) {
                    {
                    ...
                    if (_err_18 != null) {
                        _gotoNext = 5956908i32;
                    } else {
                        _gotoNext = 5956969i32;
                    };
                } else if (__value__ == (5956908i32)) {
                    @:check2r _c_0._sendAlert((120 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
                    return _err_18;
                    _gotoNext = 5956969i32;
                } else if (__value__ == (5956969i32)) {
                    ...
                    if ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._quicTransportParameters == null) {
                        _gotoNext = 5957074i32;
                    } else {
                        _gotoNext = 5957235i32;
                    };
                } else if (__value__ == (5957074i32)) {
                    ...
                    _gotoNext = 5957509i32;
                } else if (__value__ == (5957312i32)) {
                    _gotoNext = 5957312i32;
                    if ((@:checkr (@:checkr _hs ?? throw "null pointer dereference")._clientHello ?? throw "null pointer dereference")._quicTransportParameters != null) {
                        _gotoNext = 5957365i32;
                    } else {
                        _gotoNext = 5957509i32;
                    };
                } else if (__value__ == (5957365i32)) {
                    @:check2r _c_0._sendAlert((110 : stdgo._internal.crypto.tls.Tls_t_alert.T_alert));
