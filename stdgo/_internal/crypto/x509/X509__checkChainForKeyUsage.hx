        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _usages_5629166.__copyTo__(_keyUsages);
                    ...
                    if ((((@:checkr _cert_5629531 ?? throw "null pointer dereference").extKeyUsage.length == (0 : stdgo.GoInt)) && ((@:checkr _cert_5629531 ?? throw "null pointer dereference").unknownExtKeyUsage.length == (0 : stdgo.GoInt)) : Bool)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _cert_5629531 ?? throw "null pointer dereference").extKeyUsage.length)) {
                    ...
                    _usage_5629714 = (@:checkr _cert_5629531 ?? throw "null pointer dereference").extKeyUsage[(_i_5629723_0 : stdgo.GoInt)];
                    ...
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (@:checkr _cert_5629531 ?? throw "null pointer dereference").extKeyUsage[(0i32 : stdgo.GoInt)];
                        _i_5629723_0 = __tmp__0;
                        _usage_5629714 = __tmp__1;
                    };
                    _gotoNext = 5629866i32;
                } else if (__value__ == (5629866i32)) {
                    if (_i_5629723_0 < ((@:checkr _cert_5629531 ?? throw "null pointer dereference").extKeyUsage.length)) {
                    ...
                    _usage_5630039 = (@:checkr _cert_5629531 ?? throw "null pointer dereference").extKeyUsage[(_i_5630048_0 : stdgo.GoInt)];
                    ...
                    if (_i_5630048_0 < ((@:checkr _cert_5629531 ?? throw "null pointer dereference").extKeyUsage.length)) {
