        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    stdgo.Go.copySlice(_usages_5552276, _keyUsages);
                    ...
                    if (((_cert_5552641.extKeyUsage.length == (0 : stdgo.GoInt)) && (_cert_5552641.unknownExtKeyUsage.length == (0 : stdgo.GoInt)) : Bool)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < (_cert_5552641.extKeyUsage.length)) {
                    ...
                    _usage_5552824 = _cert_5552641.extKeyUsage[(_i_5552833_0 : stdgo.GoInt)];
                    ...
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _cert_5552641.extKeyUsage[(0i32 : stdgo.GoInt)];
                        _i_5552833_0 = __tmp__0;
                        _usage_5552824 = __tmp__1;
                    };
                    _gotoNext = 5552976i32;
                } else if (__value__ == (5552976i32)) {
                    if (_i_5552833_0 < (_cert_5552641.extKeyUsage.length)) {
                    ...
                    _usage_5553149 = _cert_5552641.extKeyUsage[(_i_5553158_0 : stdgo.GoInt)];
                    ...
                    if (_i_5553158_0 < (_cert_5552641.extKeyUsage.length)) {
