...
function _checkChainForKeyUsage(_chain:stdgo.Slice<stdgo.Ref<stdgo._internal.crypto.x509.X509_Certificate.Certificate>>, _keyUsages:stdgo.Slice<stdgo._internal.crypto.x509.X509_ExtKeyUsage.ExtKeyUsage>):Bool {
        ...
        var _i_5553401_0:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        var _i_5553076_0:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _usage_5553083 = _cert_5552900.extKeyUsage[(_i_5553076_0 : stdgo.GoInt)];
                ...
                } else if (__value__ == (5553234i32)) {
                    {
                        ...
                        _i_5553076_0 = __tmp__0;
                        _usage_5553083 = __tmp__1;
                    };
                    _gotoNext = 5553235i32;
                } else if (__value__ == (5553235i32)) {
                    if (_i_5553076_0 < (_cert_5552900.extKeyUsage.length)) {
                    ...
                    _usage_5553408 = _cert_5552900.extKeyUsage[(_i_5553401_0 : stdgo.GoInt)];
                    ...
                    _gotoNext = 5553300i32;
                } else if (__value__ == (5553516i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _cert_5552900.extKeyUsage[(0i32 : stdgo.GoInt)];
                        _i_5553401_0 = __tmp__0;
                        _usage_5553408 = __tmp__1;
                    };
                    _gotoNext = 5553517i32;
                } else if (__value__ == (5553517i32)) {
                    if (_i_5553401_0 < (_cert_5552900.extKeyUsage.length)) {
