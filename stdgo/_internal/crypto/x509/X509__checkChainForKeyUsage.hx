        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    stdgo.Go.copySlice(_usages_5630325, _keyUsages);
                    ...
                    if (((_cert_5630690.extKeyUsage.length == (0 : stdgo.GoInt)) && (_cert_5630690.unknownExtKeyUsage.length == (0 : stdgo.GoInt)) : Bool)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < (_cert_5630690.extKeyUsage.length)) {
                    ...
                    _usage_5630873 = _cert_5630690.extKeyUsage[(_i_5630882_0 : stdgo.GoInt)];
                    ...
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _cert_5630690.extKeyUsage[(0i32 : stdgo.GoInt)];
                        _i_5630882_0 = __tmp__0;
                        _usage_5630873 = __tmp__1;
                    };
                    _gotoNext = 5631025i32;
                } else if (__value__ == (5631025i32)) {
                    if (_i_5630882_0 < (_cert_5630690.extKeyUsage.length)) {
                    ...
                    _usage_5631198 = _cert_5630690.extKeyUsage[(_i_5631207_0 : stdgo.GoInt)];
                    ...
                    if (_i_5631207_0 < (_cert_5630690.extKeyUsage.length)) {
