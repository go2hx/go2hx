            ...
            while (__run__) {
                __run__ = false;
                {
                    ...
                    if (__switchIndex__ == 0 || (__switchIndex__ == -1 && (__value__ == (0u32 : stdgo._internal.crypto.Crypto_Hash.Hash)))) {
                        ...
                        return stdgo.Go.asInterface((_algo : stdgo._internal.crypto.x509.X509_InsecureAlgorithmError.InsecureAlgorithmError));
                        break;
                        break;
        ...
        };
        {
            ...
            if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo._internal.crypto.rsa.Rsa_PublicKey.PublicKey>))) {
                ...
                if (_pubKeyAlgo != ((1 : stdgo._internal.crypto.x509.X509_PublicKeyAlgorithm.PublicKeyAlgorithm))) {
                    return stdgo._internal.crypto.x509.X509__signaturePublicKeyAlgoMismatchError._signaturePublicKeyAlgoMismatchError(_pubKeyAlgo, stdgo.Go.toInterface(stdgo.Go.asInterface(_pub)));
                };
                if (_algo._isRSAPSS()) {
                    return stdgo._internal.crypto.rsa.Rsa_verifyPSS.verifyPSS(_pub, _hashType, _signed, _signature, (stdgo.Go.setRef(({ saltLength : (-1 : stdgo.GoInt) } : stdgo._internal.crypto.rsa.Rsa_PSSOptions.PSSOptions)) : stdgo.Ref<stdgo._internal.crypto.rsa.Rsa_PSSOptions.PSSOptions>));
                } else {
                    return stdgo._internal.crypto.rsa.Rsa_verifyPKCS1v15.verifyPKCS1v15(_pub, _hashType, _signed, _signature);
                };
                ...
                if (!stdgo._internal.crypto.ecdsa.Ecdsa_verifyASN1.verifyASN1(_pub, _signed, _signature)) {
                    return stdgo._internal.errors.Errors_new_.new_(("x509: ECDSA verification failure" : stdgo.GoString));
                };
                return _err;
                ...
                if (!stdgo._internal.crypto.ed25519.Ed25519_verify.verify(_pub, _signed, _signature)) {
                    return stdgo._internal.errors.Errors_new_.new_(("x509: Ed25519 verification failure" : stdgo.GoString));
                };
                return _err;
            };
        };
