...
function _checkChainForKeyUsage(_chain:stdgo.Slice<stdgo.Ref<stdgo._internal.crypto.x509.X509_certificate.Certificate>>, _keyUsages:stdgo.Slice<stdgo._internal.crypto.x509.X509_extkeyusage.ExtKeyUsage>):Bool {
        ...
        var _iterator_5627838_14:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        var _iterator_5627513_9:stdgo.GoInt = (0 : stdgo.GoInt);
            ...
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    ...
                    if ((_chain.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5627048i64;
                    } else {
                        _gotoNext = 5627070i64;
                    };
                } else if (__value__ == (5627048i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L1129"
                    return false;
                    _gotoNext = 5627070i64;
                } else if (__value__ == (5627070i64)) {
                    _usagesRemaining_6 = (_usages_5.length);
                    _gotoNext = 5627269i64;
                } else if (__value__ == (5627269i64)) {
                    _i_7 = ((_chain.length) - (1 : stdgo.GoInt) : stdgo.GoInt);
                    nextCertBreak = false;
                    _gotoNext = 5627280i64;
                } else if (__value__ == (5627280i64)) {
                    //"file://#L0"
                    if (!nextCertBreak && ((_i_7 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5627317i64;
                    } else {
                        _gotoNext = 5628050i64;
                    };
                } else if (__value__ == (5627313i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L1139"
                    _i_7--;
                    _gotoNext = 5627280i64;
                } else if (__value__ == (5627317i64)) {
                    ...
                    if ((((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length == (0 : stdgo.GoInt)) && ((@:checkr _cert_8 ?? throw "null pointer dereference").unknownExtKeyUsage.length == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 5627407i64;
                    } else {
                        _gotoNext = 5627497i64;
                    };
                } else if (__value__ == (5627407i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L1139"
                    _i_7--;
                    _gotoNext = 5627280i64;
                } else if (__value__ == (5627497i64)) {
                    ...
                    if ((0i64 : stdgo.GoInt) < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
                        _gotoNext = 5627655i64;
                    } else {
                        _gotoNext = 5627661i64;
                    };
                } else if (__value__ == (5627501i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L1146"
                    _iterator_5627513_9++;
                    _gotoNext = 5627656i64;
                } else if (__value__ == (5627536i64)) {
                    _usage_10 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(_iterator_5627513_9 : stdgo.GoInt)];
                    ...
                    if (_usage_10 == ((0 : stdgo._internal.crypto.x509.X509_extkeyusage.ExtKeyUsage))) {
                        _gotoNext = 5627568i64;
                    } else {
                        _gotoNext = 5627501i64;
                    };
                } else if (__value__ == (5627568i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L1139"
                    _i_7--;
                    _gotoNext = 5627280i64;
                } else if (__value__ == (5627655i64)) {
                    {
                        final __tmp__0 = 0i64;
                        final __tmp__1 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(0i64 : stdgo.GoInt)];
                        _iterator_5627513_9 = @:binopAssign __tmp__0;
                        _usage_10 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5627656i64;
                } else if (__value__ == (5627656i64)) {
                    //"file://#L0"
                    if (_iterator_5627513_9 < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
                        _gotoNext = 5627536i64;
                    } else {
                        _gotoNext = 5627661i64;
                    };
                } else if (__value__ == (5627661i64)) {
                    _gotoNext = 5627699i64;
                } else if (__value__ == (5627699i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L1156"
                    if ((0i64 : stdgo.GoInt) < (_usages_5.length)) {
                        _gotoNext = 5628042i64;
                    } else {
                        _gotoNext = 5627313i64;
                    };
                } else if (__value__ == (5627725i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L1156"
                    _i_12++;
                    _gotoNext = 5628043i64;
                } else if (__value__ == (5627759i64)) {
                    ...
                    if (_requestedUsage_13 == ((-1 : stdgo._internal.crypto.x509.X509_extkeyusage.ExtKeyUsage))) {
                        _gotoNext = 5627798i64;
                    } else {
                        _gotoNext = 5627822i64;
                    };
                } else if (__value__ == (5627798i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L1156"
                    _i_12++;
                    _gotoNext = 5628043i64;
                } else if (__value__ == (5627822i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L1161"
                    if ((0i64 : stdgo.GoInt) < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
                        _gotoNext = 5627937i64;
                    } else {
                        _gotoNext = 5627944i64;
                    };
                } else if (__value__ == (5627826i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L1161"
                    _iterator_5627838_14++;
                    _gotoNext = 5627938i64;
                } else if (__value__ == (5627861i64)) {
                    _usage_15 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(_iterator_5627838_14 : stdgo.GoInt)];
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L1162"
                    if (_requestedUsage_13 == (_usage_15)) {
                        _gotoNext = 5627894i64;
                    } else {
                        _gotoNext = 5627826i64;
                    };
                } else if (__value__ == (5627894i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L1156"
                    _i_12++;
                    _gotoNext = 5628043i64;
                } else if (__value__ == (5627937i64)) {
                    {
                        final __tmp__0 = 0i64;
                        final __tmp__1 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(0i64 : stdgo.GoInt)];
                        _iterator_5627838_14 = @:binopAssign __tmp__0;
                        _usage_15 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5627938i64;
                } else if (__value__ == (5627938i64)) {
                    //"file://#L0"
                    if (_iterator_5627838_14 < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
                        _gotoNext = 5627861i64;
                    } else {
                        _gotoNext = 5627944i64;
                    };
                } else if (__value__ == (5627944i64)) {
                    ...
                    if (_usagesRemaining_6 == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5628017i64;
                    } else {
                        _gotoNext = 5627725i64;
                    };
                } else if (__value__ == (5628017i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L1170"
                    return false;
                    _gotoNext = 5627725i64;
                } else if (__value__ == (5628042i64)) {
                    {
                        final __tmp__0 = 0i64;
                    ...
                    _gotoNext = 5628043i64;
                } else if (__value__ == (5628043i64)) {
                    //"file://#L0"
                    if (_i_12 < (_usages_5.length)) {
                        _gotoNext = 5627759i64;
                    } else {
                        _gotoNext = 5627313i64;
                    };
                } else if (__value__ == (5628050i64)) {
