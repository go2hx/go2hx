...
function _checkChainForKeyUsage(_chain:stdgo.Slice<stdgo.Ref<stdgo._internal.crypto.x509.X509_certificate.Certificate>>, _keyUsages:stdgo.Slice<stdgo._internal.crypto.x509.X509_extkeyusage.ExtKeyUsage>):Bool {
        var _i_5578523_14:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        var _i_5578198_9:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _usage_10 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(_i_5578198_9 : stdgo.GoInt)];
                ...
                } else if (__value__ == (5578340i32)) {
                    {
                        ...
                        _i_5578198_9 = @:binopAssign __tmp__0;
                        _usage_10 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5578341i32;
                } else if (__value__ == (5578341i32)) {
                    if (_i_5578198_9 < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
                    ...
                    _usage_15 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(_i_5578523_14 : stdgo.GoInt)];
                ...
                } else if (__value__ == (5578622i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(0i32 : stdgo.GoInt)];
                        _i_5578523_14 = @:binopAssign __tmp__0;
                        _usage_15 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5578623i32;
                } else if (__value__ == (5578623i32)) {
                    if (_i_5578523_14 < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
