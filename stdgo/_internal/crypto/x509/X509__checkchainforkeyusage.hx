...
function _checkChainForKeyUsage(_chain:stdgo.Slice<stdgo.Ref<stdgo._internal.crypto.x509.X509_certificate.Certificate>>, _keyUsages:stdgo.Slice<stdgo._internal.crypto.x509.X509_extkeyusage.ExtKeyUsage>):Bool {
        ...
        var _i_5630948_14:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_5630623_9:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((_chain.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5630158i32;
                    } else {
                        _gotoNext = 5630180i32;
                    };
                } else if (__value__ == (5630158i32)) {
                    return false;
                    _gotoNext = 5630180i32;
                } else if (__value__ == (5630180i32)) {
                    _usagesRemaining_6 = (_usages_5.length);
                    _gotoNext = 5630379i32;
                } else if (__value__ == (5630379i32)) {
                    _i_7 = ((_chain.length) - (1 : stdgo.GoInt) : stdgo.GoInt);
                    nextCertBreak = false;
                    _gotoNext = 5630390i32;
                } else if (__value__ == (5630390i32)) {
                    if (!nextCertBreak && ((_i_7 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5630427i32;
                    } else {
                        _gotoNext = 5631160i32;
                    };
                } else if (__value__ == (5630423i32)) {
                    _i_7--;
                    _gotoNext = 5630390i32;
                } else if (__value__ == (5630427i32)) {
                    ...
                    if ((((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length == (0 : stdgo.GoInt)) && ((@:checkr _cert_8 ?? throw "null pointer dereference").unknownExtKeyUsage.length == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 5630517i32;
                    } else {
                        _gotoNext = 5630607i32;
                    };
                } else if (__value__ == (5630517i32)) {
                    _i_7--;
                    _gotoNext = 5630390i32;
                } else if (__value__ == (5630607i32)) {
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
                        _gotoNext = 5630765i32;
                    } else {
                        _gotoNext = 5630771i32;
                    };
                } else if (__value__ == (5630611i32)) {
                    _i_5630623_9++;
                    _gotoNext = 5630766i32;
                } else if (__value__ == (5630646i32)) {
                    _usage_10 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(_i_5630623_9 : stdgo.GoInt)];
                    if (_usage_10 == ((0 : stdgo._internal.crypto.x509.X509_extkeyusage.ExtKeyUsage))) {
                        _gotoNext = 5630678i32;
                    } else {
                        _gotoNext = 5630611i32;
                    };
                } else if (__value__ == (5630678i32)) {
                    _i_7--;
                    _gotoNext = 5630390i32;
                } else if (__value__ == (5630765i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(0i32 : stdgo.GoInt)];
                        _i_5630623_9 = @:binopAssign __tmp__0;
                        _usage_10 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5630766i32;
                } else if (__value__ == (5630766i32)) {
                    if (_i_5630623_9 < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
                        _gotoNext = 5630646i32;
                    } else {
                        _gotoNext = 5630771i32;
                    };
                } else if (__value__ == (5630771i32)) {
                    _invalidUsage_11 = (-1 : stdgo._internal.crypto.x509.X509_extkeyusage.ExtKeyUsage);
                    _gotoNext = 5630809i32;
                } else if (__value__ == (5630809i32)) {
                    if ((0i32 : stdgo.GoInt) < (_usages_5.length)) {
                        _gotoNext = 5631152i32;
                    } else {
                        _gotoNext = 5630423i32;
                    };
                } else if (__value__ == (5630835i32)) {
                    _i_12++;
                    _gotoNext = 5631153i32;
                } else if (__value__ == (5630869i32)) {
                    ...
                    if (_requestedUsage_13 == ((-1 : stdgo._internal.crypto.x509.X509_extkeyusage.ExtKeyUsage))) {
                        _gotoNext = 5630908i32;
                    } else {
                        _gotoNext = 5630932i32;
                    };
                } else if (__value__ == (5630908i32)) {
                    _i_12++;
                    _gotoNext = 5631153i32;
                } else if (__value__ == (5630932i32)) {
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
                        _gotoNext = 5631047i32;
                    } else {
                        _gotoNext = 5631054i32;
                    };
                } else if (__value__ == (5630936i32)) {
                    _i_5630948_14++;
                    _gotoNext = 5631048i32;
                } else if (__value__ == (5630971i32)) {
                    _usage_15 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(_i_5630948_14 : stdgo.GoInt)];
                    if (_requestedUsage_13 == (_usage_15)) {
                        _gotoNext = 5631004i32;
                    } else {
                        _gotoNext = 5630936i32;
                    };
                } else if (__value__ == (5631004i32)) {
                    _i_12++;
                    _gotoNext = 5631153i32;
                } else if (__value__ == (5631047i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(0i32 : stdgo.GoInt)];
                        _i_5630948_14 = @:binopAssign __tmp__0;
                        _usage_15 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5631048i32;
                } else if (__value__ == (5631048i32)) {
                    if (_i_5630948_14 < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
                        _gotoNext = 5630971i32;
                    } else {
                        _gotoNext = 5631054i32;
                    };
                } else if (__value__ == (5631054i32)) {
                    ...
                    if (_usagesRemaining_6 == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5631127i32;
                    } else {
                        _gotoNext = 5630835i32;
                    };
                } else if (__value__ == (5631127i32)) {
                    return false;
                    _gotoNext = 5630835i32;
                } else if (__value__ == (5631152i32)) {
                    {
                        final __tmp__0 = 0i32;
                    ...
                    _gotoNext = 5631153i32;
                } else if (__value__ == (5631153i32)) {
                    if (_i_12 < (_usages_5.length)) {
                        _gotoNext = 5630869i32;
                    } else {
                        _gotoNext = 5630423i32;
                    };
                } else if (__value__ == (5631160i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
