...
function _checkChainForKeyUsage(_chain:stdgo.Slice<stdgo.Ref<stdgo._internal.crypto.x509.X509_certificate.Certificate>>, _keyUsages:stdgo.Slice<stdgo._internal.crypto.x509.X509_extkeyusage.ExtKeyUsage>):Bool {
        ...
        var _iterator_5598204_9:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        var _iterator_5598529_14:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((_chain.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5597739i32;
                    } else {
                        _gotoNext = 5597761i32;
                    };
                } else if (__value__ == (5597739i32)) {
                    return false;
                    _gotoNext = 5597761i32;
                } else if (__value__ == (5597761i32)) {
                    _usagesRemaining_6 = (_usages_5.length);
                    _gotoNext = 5597960i32;
                } else if (__value__ == (5597960i32)) {
                    _i_7 = ((_chain.length) - (1 : stdgo.GoInt) : stdgo.GoInt);
                    nextCertBreak = false;
                    _gotoNext = 5597971i32;
                } else if (__value__ == (5597971i32)) {
                    if (!nextCertBreak && ((_i_7 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5598008i32;
                    } else {
                        _gotoNext = 5598741i32;
                    };
                } else if (__value__ == (5598004i32)) {
                    _i_7--;
                    _gotoNext = 5597971i32;
                } else if (__value__ == (5598008i32)) {
                    ...
                    if ((((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length == (0 : stdgo.GoInt)) && ((@:checkr _cert_8 ?? throw "null pointer dereference").unknownExtKeyUsage.length == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 5598098i32;
                    } else {
                        _gotoNext = 5598188i32;
                    };
                } else if (__value__ == (5598098i32)) {
                    _i_7--;
                    _gotoNext = 5597971i32;
                } else if (__value__ == (5598188i32)) {
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
                        _gotoNext = 5598346i32;
                    } else {
                        _gotoNext = 5598352i32;
                    };
                } else if (__value__ == (5598192i32)) {
                    _iterator_5598204_9++;
                    _gotoNext = 5598347i32;
                } else if (__value__ == (5598227i32)) {
                    _usage_10 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(_iterator_5598204_9 : stdgo.GoInt)];
                    if (_usage_10 == ((0 : stdgo._internal.crypto.x509.X509_extkeyusage.ExtKeyUsage))) {
                        _gotoNext = 5598259i32;
                    } else {
                        _gotoNext = 5598192i32;
                    };
                } else if (__value__ == (5598259i32)) {
                    _i_7--;
                    _gotoNext = 5597971i32;
                } else if (__value__ == (5598346i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(0i32 : stdgo.GoInt)];
                        _iterator_5598204_9 = @:binopAssign __tmp__0;
                        _usage_10 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5598347i32;
                } else if (__value__ == (5598347i32)) {
                    if (_iterator_5598204_9 < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
                        _gotoNext = 5598227i32;
                    } else {
                        _gotoNext = 5598352i32;
                    };
                } else if (__value__ == (5598352i32)) {
                    _invalidUsage_11 = (-1 : stdgo._internal.crypto.x509.X509_extkeyusage.ExtKeyUsage);
                    _gotoNext = 5598390i32;
                } else if (__value__ == (5598390i32)) {
                    if ((0i32 : stdgo.GoInt) < (_usages_5.length)) {
                        _gotoNext = 5598733i32;
                    } else {
                        _gotoNext = 5598004i32;
                    };
                } else if (__value__ == (5598416i32)) {
                    _i_12++;
                    _gotoNext = 5598734i32;
                    ...
                    if (_requestedUsage_13 == ((-1 : stdgo._internal.crypto.x509.X509_extkeyusage.ExtKeyUsage))) {
                        _gotoNext = 5598489i32;
                    } else {
                        _gotoNext = 5598513i32;
                    };
                } else if (__value__ == (5598489i32)) {
                    _i_12++;
                    _gotoNext = 5598734i32;
                } else if (__value__ == (5598513i32)) {
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
                        _gotoNext = 5598628i32;
                    } else {
                        _gotoNext = 5598635i32;
                    };
                } else if (__value__ == (5598517i32)) {
                    _iterator_5598529_14++;
                    _gotoNext = 5598629i32;
                } else if (__value__ == (5598552i32)) {
                    _usage_15 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(_iterator_5598529_14 : stdgo.GoInt)];
                    if (_requestedUsage_13 == (_usage_15)) {
                        _gotoNext = 5598585i32;
                    } else {
                        _gotoNext = 5598517i32;
                    };
                } else if (__value__ == (5598585i32)) {
                    _i_12++;
                    _gotoNext = 5598734i32;
                } else if (__value__ == (5598628i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(0i32 : stdgo.GoInt)];
                        _iterator_5598529_14 = @:binopAssign __tmp__0;
                        _usage_15 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5598629i32;
                } else if (__value__ == (5598629i32)) {
                    if (_iterator_5598529_14 < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
                        _gotoNext = 5598552i32;
                    } else {
                        _gotoNext = 5598635i32;
                    };
                } else if (__value__ == (5598635i32)) {
                    ...
                    if (_usagesRemaining_6 == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5598708i32;
                    } else {
                        _gotoNext = 5598416i32;
                    };
                } else if (__value__ == (5598708i32)) {
                    return false;
                    _gotoNext = 5598416i32;
                } else if (__value__ == (5598733i32)) {
                    {
                        final __tmp__0 = 0i32;
                    ...
                    _gotoNext = 5598734i32;
                } else if (__value__ == (5598734i32)) {
                    if (_i_12 < (_usages_5.length)) {
                        _gotoNext = 5598450i32;
                    } else {
                        _gotoNext = 5598004i32;
                    };
                } else if (__value__ == (5598741i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
