...
function _checkChainForKeyUsage(_chain:stdgo.Slice<stdgo.Ref<stdgo._internal.crypto.x509.X509_certificate.Certificate>>, _keyUsages:stdgo.Slice<stdgo._internal.crypto.x509.X509_extkeyusage.ExtKeyUsage>):Bool {
        ...
        var _i_5622353_9:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        var _i_5622678_14:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((_chain.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5621888i32;
                    } else {
                        _gotoNext = 5621910i32;
                    };
                } else if (__value__ == (5621888i32)) {
                    return false;
                    _gotoNext = 5621910i32;
                } else if (__value__ == (5621910i32)) {
                    _usagesRemaining_6 = (_usages_5.length);
                    _gotoNext = 5622109i32;
                } else if (__value__ == (5622109i32)) {
                    ...
                    if (!nextCertBreak && ((_i_7 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5622157i32;
                    } else {
                        _gotoNext = 5622890i32;
                    };
                } else if (__value__ == (5622153i32)) {
                    _i_7--;
                    _gotoNext = 5622120i32;
                } else if (__value__ == (5622157i32)) {
                    ...
                    if ((((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length == (0 : stdgo.GoInt)) && ((@:checkr _cert_8 ?? throw "null pointer dereference").unknownExtKeyUsage.length == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 5622247i32;
                    } else {
                        _gotoNext = 5622337i32;
                    };
                } else if (__value__ == (5622247i32)) {
                    _i_7--;
                    _gotoNext = 5622120i32;
                } else if (__value__ == (5622337i32)) {
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
                        _gotoNext = 5622495i32;
                    } else {
                        _gotoNext = 5622501i32;
                    };
                } else if (__value__ == (5622341i32)) {
                    _i_5622353_9++;
                    _gotoNext = 5622496i32;
                } else if (__value__ == (5622376i32)) {
                    _usage_10 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(_i_5622353_9 : stdgo.GoInt)];
                    if (_usage_10 == ((0 : stdgo._internal.crypto.x509.X509_extkeyusage.ExtKeyUsage))) {
                        _gotoNext = 5622408i32;
                    } else {
                        _gotoNext = 5622341i32;
                    };
                } else if (__value__ == (5622408i32)) {
                    _i_7--;
                    _gotoNext = 5622120i32;
                } else if (__value__ == (5622495i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(0i32 : stdgo.GoInt)];
                        _i_5622353_9 = @:binopAssign __tmp__0;
                        _usage_10 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5622496i32;
                } else if (__value__ == (5622496i32)) {
                    if (_i_5622353_9 < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
                        _gotoNext = 5622376i32;
                    } else {
                        _gotoNext = 5622501i32;
                    };
                } else if (__value__ == (5622501i32)) {
                    _invalidUsage_11 = (-1 : stdgo._internal.crypto.x509.X509_extkeyusage.ExtKeyUsage);
                    _gotoNext = 5622539i32;
                } else if (__value__ == (5622539i32)) {
                    if ((0i32 : stdgo.GoInt) < (_usages_5.length)) {
                        _gotoNext = 5622882i32;
                    } else {
                        _gotoNext = 5622153i32;
                    };
                } else if (__value__ == (5622565i32)) {
                    _i_12++;
                    _gotoNext = 5622883i32;
                } else if (__value__ == (5622599i32)) {
                    ...
                    if (_requestedUsage_13 == ((-1 : stdgo._internal.crypto.x509.X509_extkeyusage.ExtKeyUsage))) {
                        _gotoNext = 5622638i32;
                    } else {
                        _gotoNext = 5622662i32;
                    };
                } else if (__value__ == (5622638i32)) {
                    _i_12++;
                    _gotoNext = 5622883i32;
                } else if (__value__ == (5622662i32)) {
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
                        _gotoNext = 5622777i32;
                    } else {
                        _gotoNext = 5622784i32;
                    };
                } else if (__value__ == (5622666i32)) {
                    _i_5622678_14++;
                    _gotoNext = 5622778i32;
                } else if (__value__ == (5622701i32)) {
                    _usage_15 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(_i_5622678_14 : stdgo.GoInt)];
                    if (_requestedUsage_13 == (_usage_15)) {
                        _gotoNext = 5622734i32;
                    } else {
                        _gotoNext = 5622666i32;
                    };
                } else if (__value__ == (5622734i32)) {
                    _i_12++;
                    _gotoNext = 5622883i32;
                } else if (__value__ == (5622777i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(0i32 : stdgo.GoInt)];
                        _i_5622678_14 = @:binopAssign __tmp__0;
                        _usage_15 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5622778i32;
                } else if (__value__ == (5622778i32)) {
                    if (_i_5622678_14 < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
                        _gotoNext = 5622701i32;
                    } else {
                        _gotoNext = 5622784i32;
                    };
                } else if (__value__ == (5622784i32)) {
                    ...
                    if (_usagesRemaining_6 == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5622857i32;
                    } else {
                        _gotoNext = 5622565i32;
                    };
                } else if (__value__ == (5622857i32)) {
                    return false;
                    _gotoNext = 5622565i32;
                } else if (__value__ == (5622882i32)) {
                    {
                        final __tmp__0 = 0i32;
                    ...
                    _gotoNext = 5622883i32;
                } else if (__value__ == (5622883i32)) {
                    if (_i_12 < (_usages_5.length)) {
                        _gotoNext = 5622599i32;
                    } else {
                        _gotoNext = 5622153i32;
                    };
                } else if (__value__ == (5622890i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
