...
function _checkChainForKeyUsage(_chain:stdgo.Slice<stdgo.Ref<stdgo._internal.crypto.x509.X509_certificate.Certificate>>, _keyUsages:stdgo.Slice<stdgo._internal.crypto.x509.X509_extkeyusage.ExtKeyUsage>):Bool {
        ...
        var _i_5548654_14:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        var _i_5548329_9:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _usage_10 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(_i_5548329_9 : stdgo.GoInt)];
                ...
                } else if (__value__ == (5548471i32)) {
                    {
                        ...
                        _i_5548329_9 = __tmp__0;
                        _usage_10 = __tmp__1;
                    };
                    _gotoNext = 5548472i32;
                } else if (__value__ == (5548472i32)) {
                    if (_i_5548329_9 < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
                    ...
                    _usage_15 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(_i_5548654_14 : stdgo.GoInt)];
                ...
                } else if (__value__ == (5548753i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage[(0i32 : stdgo.GoInt)];
                        _i_5548654_14 = __tmp__0;
                        _usage_15 = __tmp__1;
                    };
                    _gotoNext = 5548754i32;
                } else if (__value__ == (5548754i32)) {
                    if (_i_5548654_14 < ((@:checkr _cert_8 ?? throw "null pointer dereference").extKeyUsage.length)) {
