        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _usages_5546613.__copyTo__(_keyUsages);
                    ...
                    if ((((@:checkr _cert_5546978 ?? throw "null pointer dereference").extKeyUsage.length == (0 : stdgo.GoInt)) && ((@:checkr _cert_5546978 ?? throw "null pointer dereference").unknownExtKeyUsage.length == (0 : stdgo.GoInt)) : Bool)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _cert_5546978 ?? throw "null pointer dereference").extKeyUsage.length)) {
                    ...
                    _usage_5547161 = (@:checkr _cert_5546978 ?? throw "null pointer dereference").extKeyUsage[(_i_5547170_0 : stdgo.GoInt)];
                    ...
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (@:checkr _cert_5546978 ?? throw "null pointer dereference").extKeyUsage[(0i32 : stdgo.GoInt)];
                        _i_5547170_0 = __tmp__0;
                        _usage_5547161 = __tmp__1;
                    };
                    _gotoNext = 5547313i32;
                } else if (__value__ == (5547313i32)) {
                    if (_i_5547170_0 < ((@:checkr _cert_5546978 ?? throw "null pointer dereference").extKeyUsage.length)) {
                    ...
                    _usage_5547486 = (@:checkr _cert_5546978 ?? throw "null pointer dereference").extKeyUsage[(_i_5547495_0 : stdgo.GoInt)];
                    ...
                    if (_i_5547495_0 < ((@:checkr _cert_5546978 ?? throw "null pointer dereference").extKeyUsage.length)) {
