...
function _parseECPrivateKey(_namedCurveOID:stdgo.Ref<stdgo._internal.encoding.asn1.Asn1_ObjectIdentifier.ObjectIdentifier>, _der:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.Ref<stdgo._internal.crypto.ecdsa.Ecdsa_PrivateKey.PrivateKey>; var _1 : stdgo.Error; } {
        ...
        var _privKey:stdgo._internal.crypto.x509.X509_T_ecPrivateKey.T_ecPrivateKey = ({} : stdgo._internal.crypto.x509.X509_T_ecPrivateKey.T_ecPrivateKey);
        {
            ...
            if (_err != null) {
                ...
                };
                {
                    ...
                    if (_err == null) {
                        return { _0 : null, _1 : stdgo._internal.errors.Errors_new_.new_(("x509: failed to parse private key (use ParsePKCS1PrivateKey instead for this key format)" : stdgo.GoString)) };
                    };
                };
                return { _0 : null, _1 : stdgo._internal.errors.Errors_new_.new_((("x509: failed to parse EC private key: " : stdgo.GoString) + _err.error()?.__copy__() : stdgo.GoString)?.__copy__()) };
            };
        };
        ...
        if (_curve == null) {
            return { _0 : null, _1 : stdgo._internal.errors.Errors_new_.new_(("x509: unknown elliptic curve" : stdgo.GoString)) };
        };
        ...
        if ((_k.cmp(_curveOrder) >= (0 : stdgo.GoInt) : Bool)) {
            return { _0 : null, _1 : stdgo._internal.errors.Errors_new_.new_(("x509: invalid elliptic curve private key value" : stdgo.GoString)) };
        };
        ...
        while (((_privKey.privateKey.length) > (_privateKey.length) : Bool)) {
            if (_privKey.privateKey[(0 : stdgo.GoInt)] != ((0 : stdgo.GoUInt8))) {
                return { _0 : null, _1 : stdgo._internal.errors.Errors_new_.new_(("x509: invalid private key length" : stdgo.GoString)) };
            };
