...
function _parseCertificateRequest(_in:stdgo.Ref<stdgo._internal.crypto.x509.X509_t_certificaterequest.T_certificateRequest>):{ var _0 : stdgo.Ref<stdgo._internal.crypto.x509.X509_certificaterequest.CertificateRequest>; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2120"
        if ((@:checkr _out ?? throw "null pointer dereference").publicKeyAlgorithm != ((0 : stdgo._internal.crypto.x509.X509_publickeyalgorithm.PublicKeyAlgorithm))) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2122"
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2123"
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2128"
        {
            ...
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2129"
                return { _0 : null, _1 : _err };
            } else if ((_rest.length) != ((0 : stdgo.GoInt))) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2131"
                return { _0 : null, _1 : stdgo._internal.errors.Errors_new_.new_(("x509: trailing data after X.509 Subject" : stdgo.GoString)) };
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2134"
        (@:checkr _out ?? throw "null pointer dereference").subject.fillFromRDNSequence((stdgo.Go.setRef(_subject) : stdgo.Ref<stdgo._internal.crypto.x509.pkix.Pkix_rdnsequence.RDNSequence>));
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2136"
        {
            {
            ...
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2137"
                return { _0 : null, _1 : _err };
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2140"
        for (__1 => _extension in (@:checkr _out ?? throw "null pointer dereference").extensions) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2141"
            if (_extension.id.equal(stdgo._internal.crypto.x509.X509__oidextensionsubjectaltname._oidExtensionSubjectAltName)) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2144"
                if (_err != null) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2145"
                    return { _0 : null, _1 : _err };
                };
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2150"
