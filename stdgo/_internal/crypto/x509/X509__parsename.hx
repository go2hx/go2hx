...
function _parseName(_raw:_internal.vendor.golang_dot_org.x.crypto.cryptobyte.Cryptobyte_string_.String_):{ var _0 : stdgo.Ref<stdgo._internal.crypto.x509.pkix.Pkix_rdnsequence.RDNSequence>; var _1 : stdgo.Error; } {
        ...
        while (!_raw.empty()) {
            ...
            while (!_set.empty()) {
                ...
                var _valueTag:_internal.vendor.golang_dot_org.x.crypto.cryptobyte.asn1.Asn1_tag.Tag = ((0 : stdgo.GoUInt8) : _internal.vendor.golang_dot_org.x.crypto.cryptobyte.asn1.Asn1_tag.Tag), _valueTag__pointer__ = stdgo.Go.pointer(_valueTag);
