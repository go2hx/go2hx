...
function _parseNameConstraintsExtension(_out:stdgo.Ref<stdgo._internal.crypto.x509.X509_certificate.Certificate>, _e:stdgo._internal.crypto.x509.pkix.Pkix_extension.Extension):{ var _0 : Bool; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L502"
        if (((((!_outer.readASN1((stdgo.Go.setRef(_toplevel) : stdgo.Ref<_internal.vendor.golangdotorg.x.crypto.cryptobyte.Cryptobyte_string_.String_>), (48 : _internal.vendor.golangdotorg.x.crypto.cryptobyte.asn1.Asn1_tag.Tag)) || !_outer.empty() : Bool) || !_toplevel.readOptionalASN1((stdgo.Go.setRef(_permitted) : stdgo.Ref<_internal.vendor.golangdotorg.x.crypto.cryptobyte.Cryptobyte_string_.String_>), _havePermitted__pointer__, (0 : _internal.vendor.golangdotorg.x.crypto.cryptobyte.asn1.Asn1_tag.Tag).contextSpecific().constructed()) : Bool) || !_toplevel.readOptionalASN1((stdgo.Go.setRef(_excluded) : stdgo.Ref<_internal.vendor.golangdotorg.x.crypto.cryptobyte.Cryptobyte_string_.String_>), _haveExcluded__pointer__, (1 : _internal.vendor.golangdotorg.x.crypto.cryptobyte.asn1.Asn1_tag.Tag).contextSpecific().constructed()) : Bool) || !_toplevel.empty() : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L507"
            return {
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L510"
        if (((!_havePermitted && !_haveExcluded : Bool) || ((_permitted.length) == ((0 : stdgo.GoInt)) && (_excluded.length) == ((0 : stdgo.GoInt)) : Bool) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L515"
            return {
        ...
        var _getValues = (function(_subtrees:_internal.vendor.golangdotorg.x.crypto.cryptobyte.Cryptobyte_string_.String_):{ var _0 : stdgo.Slice<stdgo.GoString>; var _1 : stdgo.Slice<stdgo.Ref<stdgo._internal.net.Net_ipnet.IPNet>>; var _2 : stdgo.Slice<stdgo.GoString>; var _3 : stdgo.Slice<stdgo.GoString>; var _4 : stdgo.Error; } {
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L519"
            while (!_subtrees.empty()) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L522"
                if ((!_subtrees.readASN1((stdgo.Go.setRef(_seq) : stdgo.Ref<_internal.vendor.golangdotorg.x.crypto.cryptobyte.Cryptobyte_string_.String_>), (48 : _internal.vendor.golangdotorg.x.crypto.cryptobyte.asn1.Asn1_tag.Tag)) || !_seq.readAnyASN1((stdgo.Go.setRef(_value) : stdgo.Ref<_internal.vendor.golangdotorg.x.crypto.cryptobyte.Cryptobyte_string_.String_>), _tag__pointer__) : Bool)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L524"
                    return {
                ...
                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L534"
                {
                    ...
                    if (__value__ == (_dnsTag)) {
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L542"
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L549"
                        {
                            ...
                            if (!_ok) {
                                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L550"
                                return {
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L558"
                        {
                            final __value__ = _l;
                            if (__value__ == ((8 : stdgo.GoInt))) {
                                ...
                                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L568"
                                return {
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L571"
                        if (!stdgo._internal.crypto.x509.X509__isvalidipmask._isValidIPMask(_mask)) {
                            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L572"
                            return {
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L579"
                        {
                            var _err = (stdgo._internal.crypto.x509.X509__isia5string._isIA5String(_constraint?.__copy__()) : stdgo.Error);
                            if (_err != null) {
                                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L580"
                                return {
                                    @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.Slice<stdgo.GoString>; var _1 : stdgo.Slice<stdgo.Ref<stdgo._internal.net.Net_ipnet.IPNet>>; var _2 : stdgo.Slice<stdgo.GoString>; var _3 : stdgo.Slice<stdgo.GoString>; var _4 : stdgo.Error; } = { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : (null : stdgo.Slice<stdgo.Ref<stdgo._internal.net.Net_ipnet.IPNet>>), _2 : (null : stdgo.Slice<stdgo.GoString>), _3 : (null : stdgo.Slice<stdgo.GoString>), _4 : stdgo._internal.errors.Errors_new_.new_((("x509: invalid constraint value: " : stdgo.GoString) + _err.error()?.__copy__() : stdgo.GoString)?.__copy__()) };
                                    _dnsNames = __tmp__._0;
                                    _ips = __tmp__._1;
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L585"
                        if (stdgo._internal.strings.Strings_contains.contains(_constraint?.__copy__(), ("@" : stdgo.GoString))) {
                            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L586"
                            {
                                ...
                                if (!_ok) {
                                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L587"
                                    return {
                            ...
                            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L592"
                            ...
                            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L595"
                            {
                                ...
                                if (!_ok) {
                                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L596"
                                    return {
                                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.Slice<stdgo.GoString>; var _1 : stdgo.Slice<stdgo.Ref<stdgo._internal.net.Net_ipnet.IPNet>>; var _2 : stdgo.Slice<stdgo.GoString>; var _3 : stdgo.Slice<stdgo.GoString>; var _4 : stdgo.Error; } = { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : (null : stdgo.Slice<stdgo.Ref<stdgo._internal.net.Net_ipnet.IPNet>>), _2 : (null : stdgo.Slice<stdgo.GoString>), _3 : (null : stdgo.Slice<stdgo.GoString>), _4 : stdgo._internal.fmt.Fmt_errorf.errorf(("x509: failed to parse rfc822Name constraint %q" : stdgo.GoString), stdgo.Go.toInterface(_constraint)) };
                                        _dnsNames = __tmp__._0;
                                        _ips = __tmp__._1;
                        ...
                        var _domain = ((_value : stdgo.GoString)?.__copy__() : stdgo.GoString);
                        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L603"
                        {
                            var _err = (stdgo._internal.crypto.x509.X509__isia5string._isIA5String(_domain?.__copy__()) : stdgo.Error);
                            if (_err != null) {
                                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L604"
                                return {
                                    @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.Slice<stdgo.GoString>; var _1 : stdgo.Slice<stdgo.Ref<stdgo._internal.net.Net_ipnet.IPNet>>; var _2 : stdgo.Slice<stdgo.GoString>; var _3 : stdgo.Slice<stdgo.GoString>; var _4 : stdgo.Error; } = { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : (null : stdgo.Slice<stdgo.Ref<stdgo._internal.net.Net_ipnet.IPNet>>), _2 : (null : stdgo.Slice<stdgo.GoString>), _3 : (null : stdgo.Slice<stdgo.GoString>), _4 : stdgo._internal.errors.Errors_new_.new_((("x509: invalid constraint value: " : stdgo.GoString) + _err.error()?.__copy__() : stdgo.GoString)?.__copy__()) };
                                    _dnsNames = __tmp__._0;
                                    _ips = __tmp__._1;
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L607"
                        if (stdgo._internal.net.Net_parseip.parseIP(_domain?.__copy__()) != null) {
                            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L608"
                            return {
                        ...
                        var _trimmedDomain = (_domain?.__copy__() : stdgo.GoString);
                        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L612"
                        if ((((_trimmedDomain.length) > (0 : stdgo.GoInt) : Bool) && (_trimmedDomain[(0 : stdgo.GoInt)] == (46 : stdgo.GoUInt8)) : Bool)) {
                            _trimmedDomain = (_trimmedDomain.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        };
                        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L619"
                        {
                            var __tmp__ = stdgo._internal.crypto.x509.X509__domaintoreverselabels._domainToReverseLabels(_trimmedDomain?.__copy__()), __1:stdgo.Slice<stdgo.GoString> = __tmp__._0, _ok:Bool = __tmp__._1;
                            if (!_ok) {
                                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L620"
                                return {
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L629"
            return {
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L632"
        {
            {
            ...
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L633"
                return {
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L635"
        {
            {
            ...
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L636"
                return {
                    @:typeReturnStmt2 final __tmp__:{ var _0 : Bool; var _1 : stdgo.Error; } = { _0 : false, _1 : _err };
                    _unhandled = __tmp__._0;
                    _err = __tmp__._1;
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L640"
        return {
