...
function _parsePublicKey(_keyData:stdgo.Ref<stdgo._internal.crypto.x509.X509_t_publickeyinfo.T_publicKeyInfo>):{ var _0 : stdgo.AnyInterface; var _1 : stdgo.Error; } {
        ...
        if (_oid.equal(stdgo._internal.crypto.x509.X509__oidpublickeyrsa._oidPublicKeyRSA)) {
            ...
            if (!@:check2 _der.readASN1((stdgo.Go.setRef(_der) : stdgo.Ref<_internal.vendor.golangdotorg.x.crypto.cryptobyte.Cryptobyte_string_.String_>), (48 : _internal.vendor.golangdotorg.x.crypto.cryptobyte.asn1.Asn1_tag.Tag))) {
            ...
            var _paramsDer = (_params.fullBytes : _internal.vendor.golangdotorg.x.crypto.cryptobyte.Cryptobyte_string_.String_);
            if ((((!@:check2 _paramsDer.readASN1((stdgo.Go.setRef(_paramsDer) : stdgo.Ref<_internal.vendor.golangdotorg.x.crypto.cryptobyte.Cryptobyte_string_.String_>), (48 : _internal.vendor.golangdotorg.x.crypto.cryptobyte.asn1.Asn1_tag.Tag)) || !@:check2 _paramsDer.readASN1Integer(stdgo.Go.toInterface(stdgo.Go.asInterface((@:checkr _pub ?? throw "null pointer dereference").parameters.p))) : Bool) || !@:check2 _paramsDer.readASN1Integer(stdgo.Go.toInterface(stdgo.Go.asInterface((@:checkr _pub ?? throw "null pointer dereference").parameters.q))) : Bool) || !@:check2 _paramsDer.readASN1Integer(stdgo.Go.toInterface(stdgo.Go.asInterface((@:checkr _pub ?? throw "null pointer dereference").parameters.g))) : Bool)) {
