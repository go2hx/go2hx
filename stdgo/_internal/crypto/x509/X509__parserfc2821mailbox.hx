            ...
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    ...
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5600073i64;
                    } else {
                        _gotoNext = 5600104i64;
                    };
                } else if (__value__ == (5600073i64)) {
                    ...
                    if (_in[(0 : stdgo.GoInt)] == ((34 : stdgo.GoUInt8))) {
                        _gotoNext = 5600167i64;
                    } else {
                        _gotoNext = 5601671i64;
                    };
                } else if (__value__ == (5600167i64)) {
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _gotoNext = 5600656i64;
                } else if (__value__ == (5600656i64)) {
                    0i64;
                    quotedStringBreak = false;
                    _gotoNext = 5600672i64;
                } else if (__value__ == (5600672i64)) {
                    //"file://#L0"
                    if (!quotedStringBreak) {
                        _gotoNext = 5600676i64;
                    } else {
                        _gotoNext = 5603016i64;
                    };
                } else if (__value__ == (5600676i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L244"
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5600697i64;
                    } else {
                        _gotoNext = 5600733i64;
                    };
                } else if (__value__ == (5600697i64)) {
                    ...
                    if (_c_1 == ((34 : stdgo.GoUInt8))) {
                        ...
                        _gotoNext = 5601140i64;
                    } else {
                        _gotoNext = 5601619i64;
                    };
                } else if (__value__ == (5600775i64)) {
                    quotedStringBreak = true;
                    _gotoNext = 5600672i64;
                } else if (__value__ == (5600817i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L256"
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5600872i64;
                    } else {
                        _gotoNext = 5600911i64;
                    };
                } else if (__value__ == (5600872i64)) {
                    ...
                    _gotoNext = 5600672i64;
                } else if (__value__ == (5601671i64)) {
                    _gotoNext = 5601671i64;
                    _gotoNext = 5601696i64;
                } else if (__value__ == (5601696i64)) {
                    0i64;
                    nextCharBreak = false;
                    _gotoNext = 5601708i64;
                } else if (__value__ == (5601708i64)) {
                    //"file://#L0"
                    if (!nextCharBreak && (((_in.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5601724i64;
                    } else {
                        _gotoNext = 5602581i64;
                    };
                } else if (__value__ == (5601724i64)) {
                    _c_2 = _in[(0 : stdgo.GoInt)];
                    _gotoNext = 5601785i64;
                } else if (__value__ == (5601785i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L297"
                    if (_c_2 == ((92 : stdgo.GoUInt8))) {
                        _gotoNext = 5601797i64;
                        ...
                        _gotoNext = 5602120i64;
                    } else {
                        _gotoNext = 5602541i64;
                    };
                } else if (__value__ == (5601797i64)) {
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L305"
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5602065i64;
                    } else {
                        _gotoNext = 5602104i64;
                    };
                } else if (__value__ == (5602065i64)) {
                    ...
                    _gotoNext = 5602104i64;
                } else if (__value__ == (5602104i64)) {
                    _gotoNext = 5602120i64;
                } else if (__value__ == (5602120i64)) {
                    _localPartBytes_0 = (_localPartBytes_0.__append__(_in[(0 : stdgo.GoInt)]) : stdgo.Slice<stdgo.GoUInt8>);
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _gotoNext = 5601708i64;
                } else if (__value__ == (5602541i64)) {
                    nextCharBreak = true;
                    _gotoNext = 5601708i64;
                } else if (__value__ == (5602581i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L326"
                    if ((_localPartBytes_0.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5602609i64;
                    } else {
                        _gotoNext = 5602825i64;
                    };
                } else if (__value__ == (5602609i64)) {
                    ...
                    if (((_localPartBytes_0[(0 : stdgo.GoInt)] == ((46 : stdgo.GoUInt8)) || _localPartBytes_0[((_localPartBytes_0.length) - (1 : stdgo.GoInt) : stdgo.GoInt)] == ((46 : stdgo.GoUInt8)) : Bool) || stdgo._internal.bytes.Bytes_contains.contains(_localPartBytes_0, _twoDots_3) : Bool)) {
                        _gotoNext = 5602980i64;
                    } else {
                        _gotoNext = 5603016i64;
                    };
                } else if (__value__ == (5602980i64)) {
                    ...
                    _gotoNext = 5603016i64;
                } else if (__value__ == (5603016i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L342"
                    if (((_in.length == (0 : stdgo.GoInt)) || (_in[(0 : stdgo.GoInt)] != (64 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 5603048i64;
                    } else {
                        _gotoNext = 5603078i64;
                    };
                } else if (__value__ == (5603048i64)) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L350"
                    {
                        ...
                        if (!_ok_4) {
                            _gotoNext = 5603289i64;
                        } else {
                            _gotoNext = 5603320i64;
                        };
                    };
                } else if (__value__ == (5603289i64)) {
