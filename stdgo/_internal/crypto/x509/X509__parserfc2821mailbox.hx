        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5603183i32;
                    } else {
                        _gotoNext = 5603214i32;
                    };
                } else if (__value__ == (5603183i32)) {
                    return {
                    ...
                    if (_in[(0 : stdgo.GoInt)] == ((34 : stdgo.GoUInt8))) {
                        _gotoNext = 5603277i32;
                    } else {
                        _gotoNext = 5604781i32;
                    };
                } else if (__value__ == (5603277i32)) {
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _gotoNext = 5603766i32;
                } else if (__value__ == (5603766i32)) {
                    var __blank__ = 0i32;
                    quotedStringBreak = false;
                    _gotoNext = 5603782i32;
                } else if (__value__ == (5603782i32)) {
                    if (!quotedStringBreak) {
                        _gotoNext = 5603786i32;
                    } else {
                        _gotoNext = 5606126i32;
                    };
                } else if (__value__ == (5603786i32)) {
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5603807i32;
                    } else {
                        _gotoNext = 5603843i32;
                    };
                    ...
                    _gotoNext = 5603843i32;
                } else if (__value__ == (5603843i32)) {
                    _c_1 = _in[(0 : stdgo.GoInt)];
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _gotoNext = 5603873i32;
                } else if (__value__ == (5603873i32)) {
                    if (_c_1 == ((34 : stdgo.GoUInt8))) {
                        _gotoNext = 5603885i32;
                    } else if (_c_1 == ((92 : stdgo.GoUInt8))) {
                        _gotoNext = 5603927i32;
                        ...
                        _gotoNext = 5604250i32;
                    } else {
                        _gotoNext = 5604729i32;
                    };
                } else if (__value__ == (5603885i32)) {
                    quotedStringBreak = true;
                    _gotoNext = 5603782i32;
                } else if (__value__ == (5603927i32)) {
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5603982i32;
                    } else {
                        _gotoNext = 5604021i32;
                    };
                } else if (__value__ == (5603982i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _gotoNext = 5604021i32;
                } else if (__value__ == (5604021i32)) {
                    if ((((_in[(0 : stdgo.GoInt)] == ((11 : stdgo.GoUInt8)) || _in[(0 : stdgo.GoInt)] == ((12 : stdgo.GoUInt8)) : Bool) || ((((1 : stdgo.GoUInt8) <= _in[(0 : stdgo.GoInt)] : Bool) && (_in[(0 : stdgo.GoInt)] <= (9 : stdgo.GoUInt8) : Bool) : Bool)) : Bool) || ((((14 : stdgo.GoUInt8) <= _in[(0 : stdgo.GoInt)] : Bool) && (_in[(0 : stdgo.GoInt)] <= (127 : stdgo.GoUInt8) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 5604129i32;
                    } else {
                        _gotoNext = 5604211i32;
                    };
                } else if (__value__ == (5604129i32)) {
                    _localPartBytes_0 = (_localPartBytes_0.__append__(_in[(0 : stdgo.GoInt)]));
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _gotoNext = 5603782i32;
                } else if (__value__ == (5604211i32)) {
                    _gotoNext = 5604211i32;
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 5603782i32;
                } else if (__value__ == (5604250i32)) {
                    _localPartBytes_0 = (_localPartBytes_0.__append__(_c_1));
                    _gotoNext = 5603782i32;
                } else if (__value__ == (5604729i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _gotoNext = 5603782i32;
                } else if (__value__ == (5604781i32)) {
                    _gotoNext = 5604781i32;
                    _gotoNext = 5604806i32;
                } else if (__value__ == (5604806i32)) {
                    var __blank__ = 0i32;
                    nextCharBreak = false;
                    _gotoNext = 5604818i32;
                } else if (__value__ == (5604818i32)) {
                    if (!nextCharBreak && (((_in.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5604834i32;
                    } else {
                        _gotoNext = 5605691i32;
                    };
                } else if (__value__ == (5604834i32)) {
                    _c_2 = _in[(0 : stdgo.GoInt)];
                    _gotoNext = 5604895i32;
                } else if (__value__ == (5604895i32)) {
                    if (_c_2 == ((92 : stdgo.GoUInt8))) {
                        _gotoNext = 5604907i32;
                        ...
                        _gotoNext = 5605230i32;
                    } else {
                        _gotoNext = 5605651i32;
                    };
                } else if (__value__ == (5604907i32)) {
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5605175i32;
                    } else {
                        _gotoNext = 5605214i32;
                    };
                } else if (__value__ == (5605175i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _gotoNext = 5605214i32;
                } else if (__value__ == (5605214i32)) {
                    _gotoNext = 5605230i32;
                } else if (__value__ == (5605230i32)) {
                    _localPartBytes_0 = (_localPartBytes_0.__append__(_in[(0 : stdgo.GoInt)]));
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _gotoNext = 5604818i32;
                } else if (__value__ == (5605651i32)) {
                    nextCharBreak = true;
                    _gotoNext = 5604818i32;
                } else if (__value__ == (5605691i32)) {
                    if ((_localPartBytes_0.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5605719i32;
                    } else {
                        _gotoNext = 5605935i32;
                    };
                } else if (__value__ == (5605719i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    if (((_localPartBytes_0[(0 : stdgo.GoInt)] == ((46 : stdgo.GoUInt8)) || _localPartBytes_0[((_localPartBytes_0.length) - (1 : stdgo.GoInt) : stdgo.GoInt)] == ((46 : stdgo.GoUInt8)) : Bool) || stdgo._internal.bytes.Bytes_contains.contains(_localPartBytes_0, _twoDots_3) : Bool)) {
                        _gotoNext = 5606090i32;
                    } else {
                        _gotoNext = 5606126i32;
                    };
                } else if (__value__ == (5606090i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _gotoNext = 5606126i32;
                } else if (__value__ == (5606126i32)) {
                    if (((_in.length == (0 : stdgo.GoInt)) || (_in[(0 : stdgo.GoInt)] != (64 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 5606158i32;
                    } else {
                        _gotoNext = 5606188i32;
                    };
                } else if (__value__ == (5606158i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    {
                        ...
                        if (!_ok_4) {
                            _gotoNext = 5606399i32;
                        } else {
                            _gotoNext = 5606430i32;
                        };
                    };
                } else if (__value__ == (5606399i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
