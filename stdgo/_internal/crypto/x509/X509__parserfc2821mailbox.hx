        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5468205i32;
                    } else {
                        _gotoNext = 5468236i32;
                    };
                } else if (__value__ == (5468205i32)) {
                    return {
                    ...
                    if (_in[(0 : stdgo.GoInt)] == ((34 : stdgo.GoUInt8))) {
                        _gotoNext = 5468299i32;
                    } else {
                        _gotoNext = 5469803i32;
                    };
                } else if (__value__ == (5468299i32)) {
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _gotoNext = 5468788i32;
                } else if (__value__ == (5468788i32)) {
                    0i32;
                    quotedStringBreak = false;
                    _gotoNext = 5468804i32;
                } else if (__value__ == (5468804i32)) {
                    if (!quotedStringBreak) {
                        _gotoNext = 5468808i32;
                    } else {
                        _gotoNext = 5471148i32;
                    };
                } else if (__value__ == (5468808i32)) {
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5468829i32;
                    } else {
                        _gotoNext = 5468865i32;
                    };
                } else if (__value__ == (5468829i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    if (_c_1 == ((34 : stdgo.GoUInt8))) {
                        ...
                        _gotoNext = 5469272i32;
                    } else {
                        _gotoNext = 5469751i32;
                    };
                } else if (__value__ == (5468907i32)) {
                    quotedStringBreak = true;
                    _gotoNext = 5468804i32;
                } else if (__value__ == (5468949i32)) {
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5469004i32;
                    } else {
                        _gotoNext = 5469043i32;
                    };
                } else if (__value__ == (5469004i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _gotoNext = 5469043i32;
                } else if (__value__ == (5469043i32)) {
                    if ((((_in[(0 : stdgo.GoInt)] == ((11 : stdgo.GoUInt8)) || _in[(0 : stdgo.GoInt)] == ((12 : stdgo.GoUInt8)) : Bool) || ((((1 : stdgo.GoUInt8) <= _in[(0 : stdgo.GoInt)] : Bool) && (_in[(0 : stdgo.GoInt)] <= (9 : stdgo.GoUInt8) : Bool) : Bool)) : Bool) || ((((14 : stdgo.GoUInt8) <= _in[(0 : stdgo.GoInt)] : Bool) && (_in[(0 : stdgo.GoInt)] <= (127 : stdgo.GoUInt8) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 5469151i32;
                    } else {
                        _gotoNext = 5469233i32;
                    };
                } else if (__value__ == (5469151i32)) {
                    _localPartBytes_0 = (_localPartBytes_0.__append__(_in[(0 : stdgo.GoInt)]));
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _gotoNext = 5468804i32;
                } else if (__value__ == (5469233i32)) {
                    _gotoNext = 5469233i32;
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                    ...
                    0i32;
                    _gotoNext = 5468804i32;
                } else if (__value__ == (5469272i32)) {
                    _localPartBytes_0 = (_localPartBytes_0.__append__(_c_1));
                    _gotoNext = 5468804i32;
                } else if (__value__ == (5469751i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _gotoNext = 5468804i32;
                } else if (__value__ == (5469803i32)) {
                    _gotoNext = 5469803i32;
                    _gotoNext = 5469828i32;
                } else if (__value__ == (5469828i32)) {
                    0i32;
                    nextCharBreak = false;
                    _gotoNext = 5469840i32;
                } else if (__value__ == (5469840i32)) {
                    if (!nextCharBreak && (((_in.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5469856i32;
                    } else {
                        _gotoNext = 5470713i32;
                    };
                } else if (__value__ == (5469856i32)) {
                    _c_2 = _in[(0 : stdgo.GoInt)];
                    _gotoNext = 5469917i32;
                } else if (__value__ == (5469917i32)) {
                    if (_c_2 == ((92 : stdgo.GoUInt8))) {
                        _gotoNext = 5469929i32;
                        ...
                        _gotoNext = 5470252i32;
                    } else {
                        _gotoNext = 5470673i32;
                    };
                } else if (__value__ == (5469929i32)) {
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5470197i32;
                    } else {
                        _gotoNext = 5470236i32;
                    };
                } else if (__value__ == (5470197i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _gotoNext = 5470236i32;
                } else if (__value__ == (5470236i32)) {
                    _gotoNext = 5470252i32;
                } else if (__value__ == (5470252i32)) {
                    _localPartBytes_0 = (_localPartBytes_0.__append__(_in[(0 : stdgo.GoInt)]));
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _gotoNext = 5469840i32;
                } else if (__value__ == (5470673i32)) {
                    nextCharBreak = true;
                    _gotoNext = 5469840i32;
                } else if (__value__ == (5470713i32)) {
                    if ((_localPartBytes_0.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5470741i32;
                    } else {
                        _gotoNext = 5470957i32;
                    };
                } else if (__value__ == (5470741i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    if (((_localPartBytes_0[(0 : stdgo.GoInt)] == ((46 : stdgo.GoUInt8)) || _localPartBytes_0[((_localPartBytes_0.length) - (1 : stdgo.GoInt) : stdgo.GoInt)] == ((46 : stdgo.GoUInt8)) : Bool) || stdgo._internal.bytes.Bytes_contains.contains(_localPartBytes_0, _twoDots_3) : Bool)) {
                        _gotoNext = 5471112i32;
                    } else {
                        _gotoNext = 5471148i32;
                    };
                } else if (__value__ == (5471112i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _gotoNext = 5471148i32;
                } else if (__value__ == (5471148i32)) {
                    if (((_in.length == (0 : stdgo.GoInt)) || (_in[(0 : stdgo.GoInt)] != (64 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 5471180i32;
                    } else {
                        _gotoNext = 5471210i32;
                    };
                } else if (__value__ == (5471180i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    {
                        ...
                        if (!_ok_4) {
                            _gotoNext = 5471421i32;
                        } else {
                            _gotoNext = 5471452i32;
                        };
                    };
                } else if (__value__ == (5471421i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
