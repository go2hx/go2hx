        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5512360i32;
                    } else {
                        _gotoNext = 5512391i32;
                    };
                } else if (__value__ == (5512360i32)) {
                    return {
                    ...
                    if (_in[(0 : stdgo.GoInt)] == ((34 : stdgo.GoUInt8))) {
                        _gotoNext = 5512454i32;
                    } else {
                        _gotoNext = 5513958i32;
                    };
                } else if (__value__ == (5512454i32)) {
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _gotoNext = 5512943i32;
                } else if (__value__ == (5512943i32)) {
                    var __blank__ = 0i32;
                    quotedStringBreak = false;
                    _gotoNext = 5512959i32;
                } else if (__value__ == (5512959i32)) {
                    if (!quotedStringBreak) {
                        _gotoNext = 5512963i32;
                    } else {
                        _gotoNext = 5515303i32;
                    };
                } else if (__value__ == (5512963i32)) {
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5512984i32;
                    } else {
                        _gotoNext = 5513020i32;
                    };
                } else if (__value__ == (5512984i32)) {
                    return {
                        final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _gotoNext = 5513020i32;
                } else if (__value__ == (5513020i32)) {
                    _c_1 = _in[(0 : stdgo.GoInt)];
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _gotoNext = 5513050i32;
                } else if (__value__ == (5513050i32)) {
                    if (_c_1 == ((34 : stdgo.GoUInt8))) {
                        _gotoNext = 5513062i32;
                    } else if (_c_1 == ((92 : stdgo.GoUInt8))) {
                        _gotoNext = 5513104i32;
                        ...
                        _gotoNext = 5513427i32;
                    } else {
                        _gotoNext = 5513906i32;
                    };
                } else if (__value__ == (5513062i32)) {
                    quotedStringBreak = true;
                    _gotoNext = 5512959i32;
                } else if (__value__ == (5513104i32)) {
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5513159i32;
                    } else {
                        _gotoNext = 5513198i32;
                    };
                } else if (__value__ == (5513159i32)) {
                    return {
                        final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _gotoNext = 5513198i32;
                } else if (__value__ == (5513198i32)) {
                    if ((((_in[(0 : stdgo.GoInt)] == ((11 : stdgo.GoUInt8)) || _in[(0 : stdgo.GoInt)] == ((12 : stdgo.GoUInt8)) : Bool) || ((((1 : stdgo.GoUInt8) <= _in[(0 : stdgo.GoInt)] : Bool) && (_in[(0 : stdgo.GoInt)] <= (9 : stdgo.GoUInt8) : Bool) : Bool)) : Bool) || ((((14 : stdgo.GoUInt8) <= _in[(0 : stdgo.GoInt)] : Bool) && (_in[(0 : stdgo.GoInt)] <= (127 : stdgo.GoUInt8) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 5513306i32;
                    } else {
                        _gotoNext = 5513388i32;
                    };
                } else if (__value__ == (5513306i32)) {
                    _localPartBytes_0 = (_localPartBytes_0.__append__(_in[(0 : stdgo.GoInt)]));
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _gotoNext = 5512959i32;
                } else if (__value__ == (5513388i32)) {
                    _gotoNext = 5513388i32;
                    return {
                        final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 5512959i32;
                } else if (__value__ == (5513427i32)) {
                    _localPartBytes_0 = (_localPartBytes_0.__append__(_c_1));
                    _gotoNext = 5512959i32;
                } else if (__value__ == (5513906i32)) {
                    return {
                        final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _gotoNext = 5512959i32;
                } else if (__value__ == (5513958i32)) {
                    _gotoNext = 5513958i32;
                    _gotoNext = 5513983i32;
                } else if (__value__ == (5513983i32)) {
                    var __blank__ = 0i32;
                    nextCharBreak = false;
                    _gotoNext = 5513995i32;
                } else if (__value__ == (5513995i32)) {
                    if (!nextCharBreak && (((_in.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5514011i32;
                    } else {
                        _gotoNext = 5514868i32;
                    };
                } else if (__value__ == (5514011i32)) {
                    _c_2 = _in[(0 : stdgo.GoInt)];
                    _gotoNext = 5514072i32;
                } else if (__value__ == (5514072i32)) {
                    if (_c_2 == ((92 : stdgo.GoUInt8))) {
                        _gotoNext = 5514084i32;
                        ...
                        _gotoNext = 5514407i32;
                    } else {
                        _gotoNext = 5514828i32;
                    };
                } else if (__value__ == (5514084i32)) {
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5514352i32;
                    } else {
                        _gotoNext = 5514391i32;
                    };
                } else if (__value__ == (5514352i32)) {
                    return {
                        final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _gotoNext = 5514391i32;
                } else if (__value__ == (5514391i32)) {
                    _gotoNext = 5514407i32;
                } else if (__value__ == (5514407i32)) {
                    _localPartBytes_0 = (_localPartBytes_0.__append__(_in[(0 : stdgo.GoInt)]));
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _gotoNext = 5513995i32;
                } else if (__value__ == (5514828i32)) {
                    nextCharBreak = true;
                    _gotoNext = 5513995i32;
                } else if (__value__ == (5514868i32)) {
                    if ((_localPartBytes_0.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5514896i32;
                    } else {
                        _gotoNext = 5515112i32;
                    };
                } else if (__value__ == (5514896i32)) {
                    return {
                        final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    if (((_localPartBytes_0[(0 : stdgo.GoInt)] == ((46 : stdgo.GoUInt8)) || _localPartBytes_0[((_localPartBytes_0.length) - (1 : stdgo.GoInt) : stdgo.GoInt)] == ((46 : stdgo.GoUInt8)) : Bool) || stdgo._internal.bytes.Bytes_contains.contains(_localPartBytes_0, _twoDots_3) : Bool)) {
                        _gotoNext = 5515267i32;
                    } else {
                        _gotoNext = 5515303i32;
                    };
                } else if (__value__ == (5515267i32)) {
                    return {
                        final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _gotoNext = 5515303i32;
                } else if (__value__ == (5515303i32)) {
                    if (((_in.length == (0 : stdgo.GoInt)) || (_in[(0 : stdgo.GoInt)] != (64 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 5515335i32;
                    } else {
                        _gotoNext = 5515365i32;
                    };
                } else if (__value__ == (5515335i32)) {
                    return {
                        final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    {
                        ...
                        if (!_ok_4) {
                            _gotoNext = 5515576i32;
                        } else {
                            _gotoNext = 5515607i32;
                        };
                    };
                } else if (__value__ == (5515576i32)) {
                    return {
                        final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
