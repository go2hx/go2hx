        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5563653i32;
                    } else {
                        _gotoNext = 5563684i32;
                    };
                } else if (__value__ == (5563653i32)) {
                    return {
                    ...
                    if (_in[(0 : stdgo.GoInt)] == ((34 : stdgo.GoUInt8))) {
                        _gotoNext = 5563747i32;
                    } else {
                        _gotoNext = 5565251i32;
                    };
                } else if (__value__ == (5563747i32)) {
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _gotoNext = 5564236i32;
                } else if (__value__ == (5564236i32)) {
                    var __blank__ = 0i32;
                    quotedStringBreak = false;
                    _gotoNext = 5564252i32;
                } else if (__value__ == (5564252i32)) {
                    if (!quotedStringBreak) {
                        _gotoNext = 5564256i32;
                    } else {
                        _gotoNext = 5566596i32;
                    };
                } else if (__value__ == (5564256i32)) {
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5564277i32;
                    } else {
                        _gotoNext = 5564313i32;
                    };
                } else if (__value__ == (5564277i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _gotoNext = 5564313i32;
                } else if (__value__ == (5564313i32)) {
                    _c_1 = _in[(0 : stdgo.GoInt)];
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _gotoNext = 5564343i32;
                } else if (__value__ == (5564343i32)) {
                    if (_c_1 == ((34 : stdgo.GoUInt8))) {
                        _gotoNext = 5564355i32;
                    } else if (_c_1 == ((92 : stdgo.GoUInt8))) {
                        _gotoNext = 5564397i32;
                        ...
                        _gotoNext = 5564720i32;
                    } else {
                        _gotoNext = 5565199i32;
                    };
                } else if (__value__ == (5564355i32)) {
                    quotedStringBreak = true;
                    _gotoNext = 5564252i32;
                } else if (__value__ == (5564397i32)) {
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5564452i32;
                    } else {
                        _gotoNext = 5564491i32;
                    };
                } else if (__value__ == (5564452i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _gotoNext = 5564491i32;
                } else if (__value__ == (5564491i32)) {
                    if ((((_in[(0 : stdgo.GoInt)] == ((11 : stdgo.GoUInt8)) || _in[(0 : stdgo.GoInt)] == ((12 : stdgo.GoUInt8)) : Bool) || ((((1 : stdgo.GoUInt8) <= _in[(0 : stdgo.GoInt)] : Bool) && (_in[(0 : stdgo.GoInt)] <= (9 : stdgo.GoUInt8) : Bool) : Bool)) : Bool) || ((((14 : stdgo.GoUInt8) <= _in[(0 : stdgo.GoInt)] : Bool) && (_in[(0 : stdgo.GoInt)] <= (127 : stdgo.GoUInt8) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 5564599i32;
                    } else {
                        _gotoNext = 5564681i32;
                    };
                } else if (__value__ == (5564599i32)) {
                    _localPartBytes_0 = (_localPartBytes_0.__append__(_in[(0 : stdgo.GoInt)]));
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _gotoNext = 5564252i32;
                } else if (__value__ == (5564681i32)) {
                    _gotoNext = 5564681i32;
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 5564252i32;
                } else if (__value__ == (5564720i32)) {
                    _localPartBytes_0 = (_localPartBytes_0.__append__(_c_1));
                    _gotoNext = 5564252i32;
                } else if (__value__ == (5565199i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _gotoNext = 5564252i32;
                } else if (__value__ == (5565251i32)) {
                    _gotoNext = 5565251i32;
                    _gotoNext = 5565276i32;
                } else if (__value__ == (5565276i32)) {
                    var __blank__ = 0i32;
                    nextCharBreak = false;
                    _gotoNext = 5565288i32;
                } else if (__value__ == (5565288i32)) {
                    if (!nextCharBreak && (((_in.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5565304i32;
                    } else {
                        _gotoNext = 5566161i32;
                    };
                } else if (__value__ == (5565304i32)) {
                    _c_2 = _in[(0 : stdgo.GoInt)];
                    _gotoNext = 5565365i32;
                } else if (__value__ == (5565365i32)) {
                    if (_c_2 == ((92 : stdgo.GoUInt8))) {
                        _gotoNext = 5565377i32;
                        ...
                        _gotoNext = 5566121i32;
                    };
                } else if (__value__ == (5565377i32)) {
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5565645i32;
                    } else {
                        _gotoNext = 5565684i32;
                    };
                } else if (__value__ == (5565645i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _gotoNext = 5565288i32;
                } else if (__value__ == (5566121i32)) {
                    nextCharBreak = true;
                    _gotoNext = 5565288i32;
                } else if (__value__ == (5566161i32)) {
                    if ((_localPartBytes_0.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5566189i32;
                    } else {
                        _gotoNext = 5566405i32;
                    };
                } else if (__value__ == (5566189i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    if (((_localPartBytes_0[(0 : stdgo.GoInt)] == ((46 : stdgo.GoUInt8)) || _localPartBytes_0[((_localPartBytes_0.length) - (1 : stdgo.GoInt) : stdgo.GoInt)] == ((46 : stdgo.GoUInt8)) : Bool) || stdgo._internal.bytes.Bytes_contains.contains(_localPartBytes_0, _twoDots_3) : Bool)) {
                        _gotoNext = 5566560i32;
                    } else {
                        _gotoNext = 5566596i32;
                    };
                } else if (__value__ == (5566560i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _gotoNext = 5566596i32;
                } else if (__value__ == (5566596i32)) {
                    if (((_in.length == (0 : stdgo.GoInt)) || (_in[(0 : stdgo.GoInt)] != (64 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 5566628i32;
                    } else {
                        _gotoNext = 5566658i32;
                    };
                } else if (__value__ == (5566628i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
                    ...
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    {
                        ...
                        if (!_ok_4) {
                            _gotoNext = 5566869i32;
                        } else {
                            _gotoNext = 5566900i32;
                        };
                    };
                } else if (__value__ == (5566869i32)) {
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo._internal.crypto.x509.X509_t_rfc2821mailbox.T_rfc2821Mailbox; var _1 : Bool; } = { _0 : _mailbox?.__copy__(), _1 : false };
                        _mailbox = __tmp__._0;
                        _ok = __tmp__._1;
