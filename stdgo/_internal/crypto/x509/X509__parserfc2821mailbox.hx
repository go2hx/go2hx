            ...
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    ...
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5519730i64;
                    } else {
                        _gotoNext = 5519761i64;
                    };
                } else if (__value__ == (5519730i64)) {
                    ...
                    if (_in[(0 : stdgo.GoInt)] == ((34 : stdgo.GoUInt8))) {
                        _gotoNext = 5519824i64;
                    } else {
                        _gotoNext = 5521328i64;
                    };
                } else if (__value__ == (5519824i64)) {
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _gotoNext = 5520313i64;
                } else if (__value__ == (5520313i64)) {
                    0i64;
                    quotedStringBreak = false;
                    _gotoNext = 5520329i64;
                } else if (__value__ == (5520329i64)) {
                    //"file://#L0"
                    if (!quotedStringBreak) {
                        _gotoNext = 5520333i64;
                    } else {
                        _gotoNext = 5522673i64;
                    };
                } else if (__value__ == (5520333i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L244"
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5520354i64;
                    } else {
                        _gotoNext = 5520390i64;
                    };
                } else if (__value__ == (5520354i64)) {
                    ...
                    if (_c_1 == ((34 : stdgo.GoUInt8))) {
                        ...
                        _gotoNext = 5520797i64;
                    } else {
                        _gotoNext = 5521276i64;
                    };
                } else if (__value__ == (5520432i64)) {
                    quotedStringBreak = true;
                    _gotoNext = 5520329i64;
                } else if (__value__ == (5520474i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L256"
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5520529i64;
                    } else {
                        _gotoNext = 5520568i64;
                    };
                } else if (__value__ == (5520529i64)) {
                    ...
                    _gotoNext = 5520329i64;
                } else if (__value__ == (5521328i64)) {
                    _gotoNext = 5521328i64;
                    _gotoNext = 5521353i64;
                } else if (__value__ == (5521353i64)) {
                    0i64;
                    nextCharBreak = false;
                    _gotoNext = 5521365i64;
                } else if (__value__ == (5521365i64)) {
                    //"file://#L0"
                    if (!nextCharBreak && (((_in.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5521381i64;
                    } else {
                        _gotoNext = 5522238i64;
                    };
                } else if (__value__ == (5521381i64)) {
                    _c_2 = _in[(0 : stdgo.GoInt)];
                    _gotoNext = 5521442i64;
                } else if (__value__ == (5521442i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L297"
                    if (_c_2 == ((92 : stdgo.GoUInt8))) {
                        _gotoNext = 5521454i64;
                        ...
                        _gotoNext = 5521777i64;
                    } else {
                        _gotoNext = 5522198i64;
                    };
                } else if (__value__ == (5521454i64)) {
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L305"
                    if ((_in.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5521722i64;
                    } else {
                        _gotoNext = 5521761i64;
                    };
                } else if (__value__ == (5521722i64)) {
                    ...
                    _gotoNext = 5521761i64;
                } else if (__value__ == (5521761i64)) {
                    _gotoNext = 5521777i64;
                } else if (__value__ == (5521777i64)) {
                    _localPartBytes_0 = (_localPartBytes_0.__append__(_in[(0 : stdgo.GoInt)]) : stdgo.Slice<stdgo.GoUInt8>);
                    _in = (_in.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _gotoNext = 5521365i64;
                } else if (__value__ == (5522198i64)) {
                    nextCharBreak = true;
                    _gotoNext = 5521365i64;
                } else if (__value__ == (5522238i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L326"
                    if ((_localPartBytes_0.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5522266i64;
                    } else {
                        _gotoNext = 5522482i64;
                    };
                } else if (__value__ == (5522266i64)) {
                    ...
                    if (((_localPartBytes_0[(0 : stdgo.GoInt)] == ((46 : stdgo.GoUInt8)) || _localPartBytes_0[((_localPartBytes_0.length) - (1 : stdgo.GoInt) : stdgo.GoInt)] == ((46 : stdgo.GoUInt8)) : Bool) || stdgo._internal.bytes.Bytes_contains.contains(_localPartBytes_0, _twoDots_3) : Bool)) {
                        _gotoNext = 5522637i64;
                    } else {
                        _gotoNext = 5522673i64;
                    };
                } else if (__value__ == (5522637i64)) {
                    ...
                    _gotoNext = 5522673i64;
                } else if (__value__ == (5522673i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L342"
                    if (((_in.length == (0 : stdgo.GoInt)) || (_in[(0 : stdgo.GoInt)] != (64 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 5522705i64;
                    } else {
                        _gotoNext = 5522735i64;
                    };
                } else if (__value__ == (5522705i64)) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/verify.go#L350"
                    {
                        ...
                        if (!_ok_4) {
                            _gotoNext = 5522946i64;
                        } else {
                            _gotoNext = 5522977i64;
                        };
                    };
                } else if (__value__ == (5522946i64)) {
