...
function _parseSANExtension(_der:_internal.vendor.golangdotorg.x.crypto.cryptobyte.Cryptobyte_string_.String_):{ var _0 : stdgo.Slice<stdgo.GoString>; var _1 : stdgo.Slice<stdgo.GoString>; var _2 : stdgo.Slice<stdgo._internal.net.Net_ip.IP>; var _3 : stdgo.Slice<stdgo.Ref<stdgo._internal.net.url.Url_url.URL>>; var _4 : stdgo.Error; } {
        ...
        _err = stdgo._internal.crypto.x509.X509__foreachsan._forEachSAN(_der, function(_tag:stdgo.GoInt, _data:stdgo.Slice<stdgo.GoUInt8>):stdgo.Error {
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L375"
            {
                final __value__ = _tag;
                if (__value__ == ((1 : stdgo.GoInt))) {
                    var _email = ((_data : stdgo.GoString)?.__copy__() : stdgo.GoString);
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L378"
                    {
                        var _err = (stdgo._internal.crypto.x509.X509__isia5string._isIA5String(_email?.__copy__()) : stdgo.Error);
                        if (_err != null) {
                            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L379"
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L384"
                    {
                        var _err = (stdgo._internal.crypto.x509.X509__isia5string._isIA5String(_name?.__copy__()) : stdgo.Error);
                        if (_err != null) {
                            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L385"
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L390"
                    {
                        var _err = (stdgo._internal.crypto.x509.X509__isia5string._isIA5String(_uriStr?.__copy__()) : stdgo.Error);
                        if (_err != null) {
                            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L391"
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L394"
                    if (_err != null) {
                        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L395"
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L397"
                    if ((((@:checkr _uri ?? throw "null pointer dereference").host.length) > (0 : stdgo.GoInt) : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L398"
                        {
                            ...
                            if (!_ok) {
                                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L399"
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L404"
                    {
                        ...
                        if (__value__ == ((4 : stdgo.GoInt)) || __value__ == ((16 : stdgo.GoInt))) {
                            ...
                            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L408"
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L412"
            return (null : stdgo.Error);
        });
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/parser.go#L415"
