        ...
        for (__1 => _e in (@:checkr _out ?? throw "null pointer dereference").extensions) {
            ...
            if (((((_e.id.length) == ((4 : stdgo.GoInt)) && _e.id[(0 : stdgo.GoInt)] == ((2 : stdgo.GoInt)) : Bool) && _e.id[(1 : stdgo.GoInt)] == ((5 : stdgo.GoInt)) : Bool) && (_e.id[(2 : stdgo.GoInt)] == (29 : stdgo.GoInt)) : Bool)) {
                    ...
                    while (__run__) {
                        __run__ = false;
                        {
                            ...
                            if (__value__ == ((15 : stdgo.GoInt))) {
                                ...
                                if (!@:check2 _val.readASN1((stdgo.Go.setRef(_val) : stdgo.Ref<_internal.vendor.golangdotorg.x.crypto.cryptobyte.Cryptobyte_string_.String_>), (48 : _internal.vendor.golangdotorg.x.crypto.cryptobyte.asn1.Asn1_tag.Tag))) {
                                ...
                                while (!_val.empty()) {
                                    ...
                                    if (!@:check2 _val.readASN1((stdgo.Go.setRef(_dpDER) : stdgo.Ref<_internal.vendor.golangdotorg.x.crypto.cryptobyte.Cryptobyte_string_.String_>), (48 : _internal.vendor.golangdotorg.x.crypto.cryptobyte.asn1.Asn1_tag.Tag))) {
                                    ...
                                    if (!@:check2 _dpDER.readOptionalASN1((stdgo.Go.setRef(_dpNameDER) : stdgo.Ref<_internal.vendor.golangdotorg.x.crypto.cryptobyte.Cryptobyte_string_.String_>), _dpNamePresent__pointer__, (0 : _internal.vendor.golangdotorg.x.crypto.cryptobyte.asn1.Asn1_tag.Tag).constructed().contextSpecific())) {
                                        return stdgo._internal.errors.Errors_new_.new_(("x509: invalid CRL distribution point" : stdgo.GoString));
                                    };
                                    if (!_dpNamePresent) {
                                        continue;
                                    };
                                    if (!@:check2 _dpNameDER.readASN1((stdgo.Go.setRef(_dpNameDER) : stdgo.Ref<_internal.vendor.golangdotorg.x.crypto.cryptobyte.Cryptobyte_string_.String_>), (0 : _internal.vendor.golangdotorg.x.crypto.cryptobyte.asn1.Asn1_tag.Tag).constructed().contextSpecific())) {
                                        return stdgo._internal.errors.Errors_new_.new_(("x509: invalid CRL distribution point" : stdgo.GoString));
                                    };
                                ...
                                if (!@:check2 _val.readASN1((stdgo.Go.setRef(_akid) : stdgo.Ref<_internal.vendor.golangdotorg.x.crypto.cryptobyte.Cryptobyte_string_.String_>), (48 : _internal.vendor.golangdotorg.x.crypto.cryptobyte.asn1.Asn1_tag.Tag))) {
                                ...
                                if (_akid.peekASN1Tag((0 : _internal.vendor.golangdotorg.x.crypto.cryptobyte.asn1.Asn1_tag.Tag).contextSpecific())) {
                                    if (!@:check2 _akid.readASN1((stdgo.Go.setRef(_akid) : stdgo.Ref<_internal.vendor.golangdotorg.x.crypto.cryptobyte.Cryptobyte_string_.String_>), (0 : _internal.vendor.golangdotorg.x.crypto.cryptobyte.asn1.Asn1_tag.Tag).contextSpecific())) {
                                        return stdgo._internal.errors.Errors_new_.new_(("x509: invalid authority key identifier" : stdgo.GoString));
                                    };
                                ...
                                if (!@:check2 _val.readASN1((stdgo.Go.setRef(_skid) : stdgo.Ref<_internal.vendor.golangdotorg.x.crypto.cryptobyte.Cryptobyte_string_.String_>), (4 : _internal.vendor.golangdotorg.x.crypto.cryptobyte.asn1.Asn1_tag.Tag))) {
                ...
                while (!_val.empty()) {
                    ...
                    if (!@:check2 _val.readASN1((stdgo.Go.setRef(_aiaDER) : stdgo.Ref<_internal.vendor.golangdotorg.x.crypto.cryptobyte.Cryptobyte_string_.String_>), (48 : _internal.vendor.golangdotorg.x.crypto.cryptobyte.asn1.Asn1_tag.Tag))) {
                        return stdgo._internal.errors.Errors_new_.new_(("x509: invalid authority info access" : stdgo.GoString));
                    };
                    ...
                    if (!@:check2 _aiaDER.readASN1((stdgo.Go.setRef(_aiaDER) : stdgo.Ref<_internal.vendor.golangdotorg.x.crypto.cryptobyte.Cryptobyte_string_.String_>), (6 : _internal.vendor.golangdotorg.x.crypto.cryptobyte.asn1.Asn1_tag.Tag).contextSpecific())) {
                        return stdgo._internal.errors.Errors_new_.new_(("x509: invalid authority info access" : stdgo.GoString));
                    };
