...
function createRevocationList(_rand:stdgo._internal.io.Io_reader.Reader, _template:stdgo.Ref<stdgo._internal.crypto.x509.X509_revocationlist.RevocationList>, _issuer:stdgo.Ref<stdgo._internal.crypto.x509.X509_certificate.Certificate>, _priv:stdgo._internal.crypto.Crypto_signer.Signer):{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } {
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2293"
        if (({
            final value = _template;
            (value == null || (value : Dynamic).__nil__);
        })) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2294"
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2296"
        if (({
            final value = _issuer;
            (value == null || (value : Dynamic).__nil__);
        })) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2297"
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2299"
        if ((((@:checkr _issuer ?? throw "null pointer dereference").keyUsage & (64 : stdgo._internal.crypto.x509.X509_keyusage.KeyUsage) : stdgo._internal.crypto.x509.X509_keyusage.KeyUsage)) == ((0 : stdgo._internal.crypto.x509.X509_keyusage.KeyUsage))) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2300"
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2302"
        if (((@:checkr _issuer ?? throw "null pointer dereference").subjectKeyId.length) == ((0 : stdgo.GoInt))) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2303"
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2305"
        if ((@:checkr _template ?? throw "null pointer dereference").nextUpdate.before((@:checkr _template ?? throw "null pointer dereference").thisUpdate?.__copy__())) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2306"
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2308"
        if (({
            final value = (@:checkr _template ?? throw "null pointer dereference").number;
            (value == null || (value : Dynamic).__nil__);
        })) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2309"
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2313"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2314"
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2320"
        if (((((@:checkr _template ?? throw "null pointer dereference").revokedCertificates.length) > (0 : stdgo.GoInt) : Bool) && ((@:checkr _template ?? throw "null pointer dereference").revokedCertificateEntries.length == (0 : stdgo.GoInt)) : Bool)) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2323"
            ...
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2331"
            for (_i => _rce in (@:checkr _template ?? throw "null pointer dereference").revokedCertificateEntries) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2332"
                if (({
                    final value = _rce.serialNumber;
                    (value == null || (value : Dynamic).__nil__);
                })) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2333"
                ...
                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2335"
                if (_rce.revocationTime.isZero()) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2336"
                ...
                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2347"
                for (__1 => _ext in _rce.extraExtensions) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2348"
                    if (_ext.id.equal(stdgo._internal.crypto.x509.X509__oidextensionreasoncode._oidExtensionReasonCode)) {
                        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2349"
                ...
                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2356"
                if (_rce.reasonCode != ((0 : stdgo.GoInt))) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2358"
                    if (_err != null) {
                        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2359"
                        return { _0 : (null : stdgo.Slice<stdgo.GoUInt8>), _1 : _err };
                    };
                ...
                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2368"
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2376"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2377"
            return { _0 : (null : stdgo.Slice<stdgo.GoUInt8>), _1 : _err };
        };
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2380"
        {
            var _numBytes = (@:checkr _template ?? throw "null pointer dereference").number.bytes();
            if ((((_numBytes.length) > (20 : stdgo.GoInt) : Bool) || (((_numBytes.length == (20 : stdgo.GoInt)) && ((_numBytes[(0 : stdgo.GoInt)] & (128 : stdgo.GoUInt8) : stdgo.GoUInt8) != (0 : stdgo.GoUInt8)) : Bool)) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2381"
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2384"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2385"
            return { _0 : (null : stdgo.Slice<stdgo.GoUInt8>), _1 : _err };
        };
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2390"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2391"
            return { _0 : (null : stdgo.Slice<stdgo.GoUInt8>), _1 : _err };
        };
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2411"
        if (((_revokedCerts.length) > (0 : stdgo.GoInt) : Bool)) {
            _tbsCertList.revokedCertificates = _revokedCerts;
        };
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2415"
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2420"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2421"
            return { _0 : (null : stdgo.Slice<stdgo.GoUInt8>), _1 : _err };
        };
        _tbsCertList.raw = _tbsCertListContents;
        var _input = _tbsCertListContents;
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2429"
        if (_hashFunc != ((0u32 : stdgo._internal.crypto.Crypto_hash.Hash))) {
            var _h = (_hashFunc.new_() : stdgo._internal.hash.Hash_hash.Hash);
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2431"
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2435"
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2443"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2444"
            return { _0 : (null : stdgo.Slice<stdgo.GoUInt8>), _1 : _err };
        };
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L2447"
