...
function newCertPool():stdgo.Ref<stdgo._internal.crypto.x509.X509_CertPool.CertPool> {
        return (stdgo.Go.setRef(({ _byName : ({
            ...
            {};
            x;
        } : stdgo.GoMap<stdgo.GoString, stdgo.Slice<stdgo.GoInt>>), _haveSum : ({
            ...
            {};
            cast x;
        } : stdgo.GoMap<stdgo._internal.crypto.x509.X509_T_sum224.T_sum224, Bool>) } : stdgo._internal.crypto.x509.X509_CertPool.CertPool)) : stdgo.Ref<stdgo._internal.crypto.x509.X509_CertPool.CertPool>);
    }
