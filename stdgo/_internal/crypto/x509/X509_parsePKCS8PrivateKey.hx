...
function parsePKCS8PrivateKey(_der:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.AnyInterface; var _1 : stdgo.Error; } {
            ...
            if (_err != null) {
                {
                    ...
                    if (_err == null) {
                        return { _0 : _key = (null : stdgo.AnyInterface), _1 : _err = stdgo._internal.errors.Errors_new_.new_(("x509: failed to parse private key (use ParseECPrivateKey instead for this key format)" : stdgo.GoString)) };
                    };
                };
                {
                    ...
                    if (_err == null) {
                        return { _0 : _key = (null : stdgo.AnyInterface), _1 : _err = stdgo._internal.errors.Errors_new_.new_(("x509: failed to parse private key (use ParsePKCS1PrivateKey instead for this key format)" : stdgo.GoString)) };
                    };
                };
                return { _0 : _key = (null : stdgo.AnyInterface), _1 : _err };
            };
        };
        if (_privKey.algo.algorithm.equal(stdgo._internal.crypto.x509.X509__oidPublicKeyRSA._oidPublicKeyRSA)) {
            ...
            if (_err != null) {
                return { _0 : _key = (null : stdgo.AnyInterface), _1 : _err = stdgo._internal.errors.Errors_new_.new_((("x509: failed to parse RSA private key embedded in PKCS#8: " : stdgo.GoString) + _err.error()?.__copy__() : stdgo.GoString)?.__copy__()) };
            };
            return { _0 : _key, _1 : _err = (null : stdgo.Error) };
            ...
            if (_err != null) {
                return { _0 : _key = (null : stdgo.AnyInterface), _1 : _err = stdgo._internal.errors.Errors_new_.new_((("x509: failed to parse EC private key embedded in PKCS#8: " : stdgo.GoString) + _err.error()?.__copy__() : stdgo.GoString)?.__copy__()) };
            };
            return { _0 : _key, _1 : _err = (null : stdgo.Error) };
        } else if (_privKey.algo.algorithm.equal(stdgo._internal.crypto.x509.X509__oidPublicKeyEd25519._oidPublicKeyEd25519)) {
            {
                ...
                if (_l != ((0 : stdgo.GoInt))) {
                    return { _0 : _key = (null : stdgo.AnyInterface), _1 : _err = stdgo._internal.errors.Errors_new_.new_(("x509: invalid Ed25519 private key parameters" : stdgo.GoString)) };
                };
            };
            var _curvePrivateKey:stdgo.Slice<stdgo.GoUInt8> = (null : stdgo.Slice<stdgo.GoUInt8>);
            {
                ...
                if (_err != null) {
                    return { _0 : _key = (null : stdgo.AnyInterface), _1 : _err = stdgo._internal.fmt.Fmt_errorf.errorf(("x509: invalid Ed25519 private key: %v" : stdgo.GoString), stdgo.Go.toInterface(_err)) };
                };
            };
            {
                var _l = (_curvePrivateKey.length : stdgo.GoInt);
                if (_l != ((32 : stdgo.GoInt))) {
                    return { _0 : _key = (null : stdgo.AnyInterface), _1 : _err = stdgo._internal.fmt.Fmt_errorf.errorf(("x509: invalid Ed25519 private key length: %d" : stdgo.GoString), stdgo.Go.toInterface(_l)) };
                };
            };
            return { _0 : _key = stdgo.Go.toInterface(stdgo.Go.asInterface(stdgo._internal.crypto.ed25519.Ed25519_newKeyFromSeed.newKeyFromSeed(_curvePrivateKey))), _1 : _err = (null : stdgo.Error) };
        } else if (_privKey.algo.algorithm.equal(stdgo._internal.crypto.x509.X509__oidPublicKeyX25519._oidPublicKeyX25519)) {
            {
                var _l = (_privKey.algo.parameters.fullBytes.length : stdgo.GoInt);
                if (_l != ((0 : stdgo.GoInt))) {
                    return { _0 : _key = (null : stdgo.AnyInterface), _1 : _err = stdgo._internal.errors.Errors_new_.new_(("x509: invalid X25519 private key parameters" : stdgo.GoString)) };
                };
            };
            var _curvePrivateKey:stdgo.Slice<stdgo.GoUInt8> = (null : stdgo.Slice<stdgo.GoUInt8>);
            {
                var __tmp__ = stdgo._internal.encoding.asn1.Asn1_unmarshal.unmarshal(_privKey.privateKey, stdgo.Go.toInterface((stdgo.Go.setRef(_curvePrivateKey) : stdgo.Ref<stdgo.Slice<stdgo.GoUInt8>>))), __2:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    return { _0 : _key = (null : stdgo.AnyInterface), _1 : _err = stdgo._internal.fmt.Fmt_errorf.errorf(("x509: invalid X25519 private key: %v" : stdgo.GoString), stdgo.Go.toInterface(_err)) };
                };
            };
            return {
                var __tmp__ = _internal.crypto.ecdh.Ecdh_x25519.x25519().newPrivateKey(_curvePrivateKey);
                _key = __tmp__._0;
                _err = __tmp__._1;
                __tmp__;
            };
        } else {
            return { _0 : _key = (null : stdgo.AnyInterface), _1 : _err = stdgo._internal.fmt.Fmt_errorf.errorf(("x509: PKCS#8 wrapping contained private key with unknown algorithm: %v" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_privKey.algo.algorithm))) };
        };
    }
