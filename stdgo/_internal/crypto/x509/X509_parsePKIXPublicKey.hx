            ...
            if (_err != null) {
                {
                    ...
                    if (_err == null) {
                        return { _0 : _pub = (null : stdgo.AnyInterface), _1 : _err = stdgo._internal.errors.Errors_new_.new_(("x509: failed to parse public key (use ParsePKCS1PublicKey instead for this key format)" : stdgo.GoString)) };
                    };
                };
                return { _0 : _pub = (null : stdgo.AnyInterface), _1 : _err };
            } else if ((_rest.length) != ((0 : stdgo.GoInt))) {
                return { _0 : _pub = (null : stdgo.AnyInterface), _1 : _err = stdgo._internal.errors.Errors_new_.new_(("x509: trailing data after ASN.1 of public-key" : stdgo.GoString)) };
            };
        };
        return {
            var __tmp__ = stdgo._internal.crypto.x509.X509__parsePublicKey._parsePublicKey((stdgo.Go.setRef(_pki) : stdgo.Ref<stdgo._internal.crypto.x509.X509_T_publicKeyInfo.T_publicKeyInfo>));
            _pub = __tmp__._0;
            _err = __tmp__._1;
            __tmp__;
        };
