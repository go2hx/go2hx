...
function parsePKIXPublicKey(_derBytes:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.AnyInterface; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L73"
        {
            ...
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L74"
                {
                    ...
                    if (_err == null) {
                        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L75"
                        return {
                ...
                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L77"
                return {
                ...
                //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L79"
                return {
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/x509.go#L81"
        return ({
            @:explicitConversion final __tmp__ = stdgo._internal.crypto.x509.X509__parsepublickey._parsePublicKey((stdgo.Go.setRef(_pki) : stdgo.Ref<stdgo._internal.crypto.x509.X509_t_publickeyinfo.T_publicKeyInfo>));
