...
@:keep @:allow(stdgo._internal.crypto.x509.pkix.Pkix.RDNSequence_asInterface) class RDNSequence_static_extension {
    ...
    static public function string( _r:stdgo._internal.crypto.x509.pkix.Pkix_rdnsequence.RDNSequence):stdgo.GoString {
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/pkix/pkix.go#L42"
        {
...
//"file:///home/runner/.go/go1.21.3/src/crypto/x509/pkix/pkix.go#L44"
                if ((_i > (0 : stdgo.GoInt) : Bool)) {
                    _s = (_s + (("," : stdgo.GoString)).__copy__() : stdgo.GoString);
                };
//"file:///home/runner/.go/go1.21.3/src/crypto/x509/pkix/pkix.go#L47"
                for (_j => _tv in _rdn) {
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/pkix/pkix.go#L48"
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/pkix/pkix.go#L54"
                    if (!_ok) {
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/pkix/pkix.go#L56"
                        if (_err == null) {
                            ...
                            //"file:///home/runner/.go/go1.21.3/src/crypto/x509/pkix/pkix.go#L58"
                            continue;
                        };
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/crypto/x509/pkix/pkix.go#L67"
                    for (_k => _c in _valueString) {
                        var _escape = (false : Bool);
                        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/pkix/pkix.go#L70"
                        {
                            final __value__ = _c;
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/pkix/pkix.go#L81"
                        if (_escape) {
        ...
        //"file:///home/runner/.go/go1.21.3/src/crypto/x509/pkix/pkix.go#L92"
        return _s?.__copy__();
    }
}
