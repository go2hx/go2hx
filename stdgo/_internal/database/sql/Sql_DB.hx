...
@:structInit @:using(stdgo._internal.database.sql.Sql_DB_static_extension.DB_static_extension) class DB {
    public var _waitDuration : _internal.sync.atomic_.Atomic__Int64_.Int64_ = ({} : _internal.sync.atomic_.Atomic__Int64_.Int64_);
    ...
    public var _numClosed : _internal.sync.atomic_.Atomic__Uint64.Uint64 = ({} : _internal.sync.atomic_.Atomic__Uint64.Uint64);
