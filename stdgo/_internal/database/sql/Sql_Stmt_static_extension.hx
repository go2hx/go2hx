...
@:keep @:allow(stdgo._internal.database.sql.Sql.Stmt_asInterface) class Stmt_static_extension {
    ...
    static public function _connStmt( _s:stdgo.Ref<stdgo._internal.database.sql.Sql_Stmt.Stmt>, _ctx:stdgo._internal.context.Context_Context.Context, _strategy:stdgo._internal.database.sql.Sql_T_connReuseStrategy.T_connReuseStrategy):{ var _0 : stdgo.Ref<stdgo._internal.database.sql.Sql_T_driverConn.T_driverConn>; var _1 : stdgo.Error -> Void; var _2 : stdgo.Ref<stdgo._internal.database.sql.Sql_T_driverStmt.T_driverStmt>; var _3 : stdgo.Error; } {
        ...
        if (_s._cg != null) {
            ...
            return {
                final __tmp__:{ var _0 : stdgo.Ref<stdgo._internal.database.sql.Sql_T_driverConn.T_driverConn>; var _1 : stdgo.Error -> Void; var _2 : stdgo.Ref<stdgo._internal.database.sql.Sql_T_driverStmt.T_driverStmt>; var _3 : stdgo.Error; } = { _0 : _dc, _1 : _releaseConn, _2 : _s._cgds, _3 : (null : stdgo.Error) };
                _dc = __tmp__._0;
                _releaseConn = __tmp__._1;
                _ds = __tmp__._2;
                _err = __tmp__._3;
        ...
        for (__135 => _v in _s._css) {
            if (_v._dc == (_dc)) {
                _s._mu.unlock();
                return {
                    final __tmp__:{ var _0 : stdgo.Ref<stdgo._internal.database.sql.Sql_T_driverConn.T_driverConn>; var _1 : stdgo.Error -> Void; var _2 : stdgo.Ref<stdgo._internal.database.sql.Sql_T_driverStmt.T_driverStmt>; var _3 : stdgo.Error; } = { _0 : _dc, _1 : _dc._releaseConn, _2 : _v._ds, _3 : (null : stdgo.Error) };
                    _dc = __tmp__._0;
                    _releaseConn = __tmp__._1;
                    _ds = __tmp__._2;
                    _err = __tmp__._3;
        ...
        return {
            final __tmp__:{ var _0 : stdgo.Ref<stdgo._internal.database.sql.Sql_T_driverConn.T_driverConn>; var _1 : stdgo.Error -> Void; var _2 : stdgo.Ref<stdgo._internal.database.sql.Sql_T_driverStmt.T_driverStmt>; var _3 : stdgo.Error; } = { _0 : _dc, _1 : _dc._releaseConn, _2 : _ds, _3 : (null : stdgo.Error) };
            _dc = __tmp__._0;
            _releaseConn = __tmp__._1;
            _ds = __tmp__._2;
            _err = __tmp__._3;
