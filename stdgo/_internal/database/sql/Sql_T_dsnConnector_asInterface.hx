...
class T_dsnConnector_asInterface {
    ...
    @:keep
    public dynamic function connect(__22:stdgo._internal.context.Context_Context.Context):{ var _0 : stdgo._internal.database.sql.driver.Driver_Conn.Conn; var _1 : stdgo.Error; } return __self__.value.connect(__22);
