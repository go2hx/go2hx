        ...
        while (_gotoNext != ((-1i64 : stdgo.GoInt))) {
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/database/sql/convert.go#L118"
                    if (({
                        final value = _ds;
                        (value != null && ((value : Dynamic).__nil__ == null || !(value : Dynamic).__nil__));
                    })) {
                        _gotoNext = 3602619i64;
                    } else {
                        _gotoNext = 3602886i64;
                    };
                } else if (__value__ == (3602619i64)) {
                    _si_2 = (@:checkr _ds ?? throw "null pointer dereference")._si;
                    _want_1 = (@:checkr _ds ?? throw "null pointer dereference")._si.numInput();
                    _cc_3._want = _want_1;
                    _gotoNext = 3602886i64;
                } else if (__value__ == (3602886i64)) {
                    {
                        var __tmp__ = try {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/database/sql/convert.go#L129"
                    if (!_ok_5) {
                        _gotoNext = 3602935i64;
                    } else {
                        _gotoNext = 3602983i64;
                    };
                } else if (__value__ == (3602935i64)) {
                    {
                        var __tmp__ = try {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/database/sql/convert.go#L133"
                    if (_ok_5) {
                        _gotoNext = 3603029i64;
                    } else {
                        _gotoNext = 3603292i64;
                    };
                } else if (__value__ == (3603029i64)) {
                    _cc_3._cci = _cci_6;
                    _gotoNext = 3603292i64;
                } else if (__value__ == (3603292i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/database/sql/convert.go#L144"
                    if ((0i64 : stdgo.GoInt) < (_args.length)) {
                        _gotoNext = 3604671i64;
                    } else {
                        _gotoNext = 3604763i64;
                    };
                } else if (__value__ == (3603322i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/database/sql/convert.go#L144"
                    _iterator_3603332_9++;
                    _gotoNext = 3604672i64;
                } else if (__value__ == (3603343i64)) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/database/sql/convert.go#L146"
                    {
                        {
                            var __tmp__ = try {
                        ...
                        if (_ok_13) {
                            _gotoNext = 3603398i64;
                        } else {
                            _gotoNext = 3603528i64;
                        };
                    };
                } else if (__value__ == (3603398i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/database/sql/convert.go#L147"
                    {
                        _err_7 = stdgo._internal.database.sql.Sql__validatenamedvaluename._validateNamedValueName(_np_12.name?.__copy__());
                        if (_err_7 != null) {
                            _gotoNext = 3603456i64;
                        } else {
                            _gotoNext = 3603486i64;
                        };
                    };
                } else if (__value__ == (3603456i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/database/sql/convert.go#L148"
                    return { _0 : (null : stdgo.Slice<stdgo._internal.database.sql.driver.Driver_namedvalue.NamedValue>), _1 : _err_7 };
                    _gotoNext = 3603486i64;
                } else if (__value__ == (3603486i64)) {
                    _arg_10 = _np_12.value;
                    (@:checkr _nv_11 ?? throw "null pointer dereference").name = _np_12.name?.__copy__();
                    _gotoNext = 3603528i64;
                } else if (__value__ == (3603528i64)) {
                    ...
                    _nextCC_15 = false;
                    _gotoNext = 3604101i64;
                } else if (__value__ == (3604101i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/database/sql/convert.go#L169"
                    if (_nvc_4 != null) {
                        _gotoNext = 3604112i64;
                    } else if (_cci_6 != null) {
                        _gotoNext = 3604187i64;
                    } else {
                        _gotoNext = 3604242i64;
                    };
                } else if (__value__ == (3604112i64)) {
                    _nextCC_15 = _cci_6 != null;
                    _checker_14 = _nvc_4.checkNamedValue;
                    _gotoNext = 3604242i64;
                } else if (__value__ == (3604187i64)) {
                    _checker_14 = _cc_3.checkNamedValue;
                    _gotoNext = 3604242i64;
                } else if (__value__ == (3604242i64)) {
                    _gotoNext = 3604242i64;
                    _err_7 = _checker_14(_nv_11);
                    _gotoNext = 3604275i64;
                } else if (__value__ == (3604275i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/database/sql/convert.go#L179"
                    {
                        final __value__ = _err_7;
                        if (__value__ == null) {
                            _gotoNext = 3604290i64;
                            ...
                            _gotoNext = 3604321i64;
                        } else if (stdgo.Go.toInterface(__value__) == (stdgo.Go.toInterface(stdgo._internal.database.sql.driver.Driver_errskip.errSkip))) {
                            _gotoNext = 3604401i64;
                        } else {
                            _gotoNext = 3604563i64;
                        };
                    };
                } else if (__value__ == (3604290i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/database/sql/convert.go#L181"
                    _n_8++;
                    //"file:///home/runner/.go/go1.21.3/src/database/sql/convert.go#L144"
                    _iterator_3603332_9++;
                    _gotoNext = 3604672i64;
                } else if (__value__ == (3604321i64)) {
                    ...
                    _iterator_3603332_9++;
                    _gotoNext = 3604672i64;
                } else if (__value__ == (3604401i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/database/sql/convert.go#L187"
                    if (_nextCC_15) {
                        _gotoNext = 3604435i64;
                    } else {
                        _gotoNext = 3604499i64;
                    };
                } else if (__value__ == (3604435i64)) {
                    _nextCC_15 = false;
                    _checker_14 = _cc_3.checkNamedValue;
                    _gotoNext = 3604546i64;
                } else if (__value__ == (3604499i64)) {
                    _gotoNext = 3604499i64;
                    _checker_14 = stdgo._internal.database.sql.Sql__defaultchecknamedvalue._defaultCheckNamedValue;
                    0i64;
                    _gotoNext = 3604546i64;
                } else if (__value__ == (3604546i64)) {
                    _gotoNext = 3604242i64;
                } else if (__value__ == (3604563i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/database/sql/convert.go#L195"
                    ...
                    _gotoNext = 3603322i64;
                } else if (__value__ == (3604671i64)) {
                    {
                        final __tmp__0 = 0i64;
                        final __tmp__1 = stdgo.Go.toInterface(_args[(0i64 : stdgo.GoInt)]);
                        _iterator_3603332_9 = @:binopAssign __tmp__0;
                        _arg_10 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 3604672i64;
                } else if (__value__ == (3604672i64)) {
                    //"file://#L0"
                    if (_iterator_3603332_9 < (_args.length)) {
                        _gotoNext = 3603343i64;
                    } else {
                        _gotoNext = 3604763i64;
                    };
                } else if (__value__ == (3604763i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/database/sql/convert.go#L201"
                    if (((_want_1 != (-1 : stdgo.GoInt)) && (_nvargs_0.length != _want_1) : Bool)) {
                        _gotoNext = 3604800i64;
                    } else {
                        _gotoNext = 3604889i64;
                    };
                } else if (__value__ == (3604800i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/database/sql/convert.go#L202"
                    ...
                    _gotoNext = 3604889i64;
                } else if (__value__ == (3604889i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/database/sql/convert.go#L205"
