...
function _rowsColumnInfoSetupConnLocked(_rowsi:stdgo._internal.database.sql.driver.Driver_rows.Rows):stdgo.Slice<stdgo.Ref<stdgo._internal.database.sql.Sql_columntype.ColumnType>> {
        ...
        //"file:///home/runner/.go/go1.21.3/src/database/sql/sql.go#L3205"
        for (_i => _ in _list) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/database/sql/sql.go#L3211"
            {
                var __tmp__ = try {
            ...
            //"file:///home/runner/.go/go1.21.3/src/database/sql/sql.go#L3216"
            {
                var __tmp__ = try {
            ...
            //"file:///home/runner/.go/go1.21.3/src/database/sql/sql.go#L3219"
            {
                var __tmp__ = try {
            ...
            //"file:///home/runner/.go/go1.21.3/src/database/sql/sql.go#L3222"
            {
                var __tmp__ = try {
            ...
            //"file:///home/runner/.go/go1.21.3/src/database/sql/sql.go#L3225"
            {
                var __tmp__ = try {
        ...
        //"file:///home/runner/.go/go1.21.3/src/database/sql/sql.go#L3229"
        return _list;
    }
