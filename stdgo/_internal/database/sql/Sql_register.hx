...
function register(_name:stdgo.GoString, _driver:stdgo._internal.database.sql.driver.Driver_driver.Driver):Void {
        ...
        try {
            //"file:///home/runner/.go/go1.21.3/src/database/sql/sql.go#L45"
            ...
            //"file:///home/runner/.go/go1.21.3/src/database/sql/sql.go#L47"
            if (_driver == null) {
                //"file:///home/runner/.go/go1.21.3/src/database/sql/sql.go#L48"
                throw stdgo.Go.toInterface(("sql: Register driver is nil" : stdgo.GoString));
            };
            //"file:///home/runner/.go/go1.21.3/src/database/sql/sql.go#L50"
            {
                ...
                if (_dup) {
                    //"file:///home/runner/.go/go1.21.3/src/database/sql/sql.go#L51"
