...
function _decodeString(_data:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.GoString; var _1 : stdgo.Slice<stdgo.GoUInt8>; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/debug/buildinfo/buildinfo.go#L237"
        if (((_n <= (0 : stdgo.GoInt) : Bool) || (_u >= (((_data.length) - _n : stdgo.GoInt) : stdgo.GoUInt64) : Bool) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/debug/buildinfo/buildinfo.go#L238"
            return {
        ...
        //"file:///home/runner/.go/go1.21.3/src/debug/buildinfo/buildinfo.go#L240"
        return {
            @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoString; var _1 : stdgo.Slice<stdgo.GoUInt8>; } = { _0 : ((_data.__slice__(_n, ((_n : stdgo.GoUInt64) + _u : stdgo.GoUInt64)) : stdgo.Slice<stdgo.GoUInt8>) : stdgo.GoString)?.__copy__(), _1 : (_data.__slice__(((_n : stdgo.GoUInt64) + _u : stdgo.GoUInt64)) : stdgo.Slice<stdgo.GoUInt8>) };
            _s = __tmp__._0;
            _rest = __tmp__._1;
            __tmp__;
        };
