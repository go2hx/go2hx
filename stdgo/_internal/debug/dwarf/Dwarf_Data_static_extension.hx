            ...
            while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
                {
                    ...
                    if (__value__ == (0i32)) {
                        ...
                        {
                            {
                                ...
                                _t_3731117 = __tmp__._0;
                                _ok_3731120 = __tmp__._1;
                            };
                            if (_ok_3731120) {
                        ...
                        {
                            var __tmp__ = _r.next();
                            _e_3731180 = __tmp__._0;
                            _err_3731183 = __tmp__._1;
                        };
                    ...
                    } else if (__value__ == (3733651i32)) {
                        {
                            ...
                            (@:checkr _t_3733542 ?? throw "null pointer dereference").strideBitSize = __tmp__._0;
                        };
                    ...
                    } else if (__value__ == (3733914i32)) {
                        {
                            ...
                            _count_3733940 = __tmp__._0;
                            _ok_3733947 = __tmp__._1;
                        };
                        if (!_ok_3733947) {
                    ...
                    } else if (__value__ == (3734614i32)) {
                        {
                            ...
                            _name_3735178 = __tmp__._0?.__copy__();
                        };
                        {
                            var __tmp__ = try {
                            ...
                            _enc_3735216 = __tmp__._0;
                            _ok_3735221 = __tmp__._1;
                        };
                        if (!_ok_3735221) {
                        ...
                        (@:checkr _t_3736225 ?? throw "null pointer dereference").commonType.name = _name_3735178?.__copy__();
                        {
                            ...
                            (@:checkr _t_3736225 ?? throw "null pointer dereference").bitSize = __tmp__._0;
                        };
                        ...
                        _haveDataBitOffset_3736369 = false;
                        {
                            ...
                            (@:checkr _t_3736225 ?? throw "null pointer dereference").bitOffset = __tmp__._0;
                            _haveBitOffset_3736344 = __tmp__._1;
                        };
                        {
                            var __tmp__ = try {
                            ...
                            (@:checkr _t_3736225 ?? throw "null pointer dereference").dataBitOffset = __tmp__._0;
                            _haveDataBitOffset_3736369 = __tmp__._1;
                        };
                    ...
                    } else if (__value__ == (3737615i32)) {
                        {
                            ...
                            (@:checkr _t_3737415 ?? throw "null pointer dereference").structName = __tmp__._0?.__copy__();
                        };
                    ...
                    } else if (__value__ == (3738483i32)) {
                        {
                            ...
                            (@:checkr _f_3737929 ?? throw "null pointer dereference").name = __tmp__._0?.__copy__();
                        };
                        {
                            var __tmp__ = try {
                            ...
                            (@:checkr _f_3737929 ?? throw "null pointer dereference").byteSize = __tmp__._0;
                        };
                        ...
                        _haveDataBitOffset_3738600 = false;
                        {
                            ...
                            (@:checkr _f_3737929 ?? throw "null pointer dereference").bitOffset = __tmp__._0;
                            _haveBitOffset_3738574 = __tmp__._1;
                        };
                        {
                            var __tmp__ = try {
                            ...
                            (@:checkr _f_3737929 ?? throw "null pointer dereference").dataBitOffset = __tmp__._0;
                            _haveDataBitOffset_3738600 = __tmp__._1;
                        };
                    ...
                    } else if (__value__ == (3738904i32)) {
                        {
                            ...
                            (@:checkr _f_3737929 ?? throw "null pointer dereference").bitSize = __tmp__._0;
                        };
                    ...
                    } else if (__value__ == (3739369i32)) {
                        {
                            ...
                            _b_3739374 = __tmp__._0;
                            _ok_3739377 = __tmp__._1;
                        };
                        ...
                        _typeCache[_off] = stdgo.Go.asInterface(_t_3740239);
                        {
                            ...
                            (@:checkr _t_3740239 ?? throw "null pointer dereference").enumName = __tmp__._0?.__copy__();
                        };
                        ...
                        _f_3740452 = (stdgo.Go.setRef(({} : stdgo._internal.debug.dwarf.Dwarf_EnumValue_.EnumValue_)) : stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_EnumValue_.EnumValue_>);
                        {
                            ...
                            (@:checkr _f_3740452 ?? throw "null pointer dereference").name = __tmp__._0?.__copy__();
                        };
                        {
                            var __tmp__ = try {
                            ...
                            (@:checkr _f_3740452 ?? throw "null pointer dereference").val = __tmp__._0;
                        };
                        ...
                        _typeCache[_off] = stdgo.Go.asInterface(_t_3742033);
                        {
                            ...
                            (@:checkr _t_3742033 ?? throw "null pointer dereference").commonType.name = __tmp__._0?.__copy__();
                        };
                        ...
                        _typeCache[_off] = stdgo.Go.asInterface(_t_3742251);
                        {
                            ...
                            (@:checkr _t_3742251 ?? throw "null pointer dereference").basicType.commonType.name = __tmp__._0?.__copy__();
                        };
                        _gotoNext = 3742625i32;
                        ...
                        (@:checkr _t_3742508 ?? throw "null pointer dereference").tag = (@:checkr _e_3731180 ?? throw "null pointer dereference").tag;
                        {
                            ...
                            (@:checkr _t_3742508 ?? throw "null pointer dereference").commonType.name = __tmp__._0?.__copy__();
                        };
                        _gotoNext = 3742625i32;
                    ...
                    } else if (__value__ == (3742659i32)) {
                        {
                            ...
                            _b_3742663 = __tmp__._0;
                            _ok_3742666 = __tmp__._1;
                        };
                        if (!_ok_3742666) {
