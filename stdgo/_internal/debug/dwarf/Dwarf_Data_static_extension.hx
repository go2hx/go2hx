            ...
            while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
                {
                    ...
                    if (__value__ == (0i32)) {
                    ...
                    } else if (__value__ == (3737869i32)) {
                        {
                            ...
                            (@:checkr _t_3737760 ?? throw "null pointer dereference").strideBitSize = __tmp__._0;
                        };
                        ...
                        (@:checkr _t_3740443 ?? throw "null pointer dereference").commonType.name = _name_3739396?.__copy__();
                        {
                            ...
                            (@:checkr _t_3740443 ?? throw "null pointer dereference").bitSize = __tmp__._0;
                        };
                        ...
                        _haveDataBitOffset_3740587 = false;
                        {
                            ...
                            (@:checkr _t_3740443 ?? throw "null pointer dereference").bitOffset = __tmp__._0;
                        ...
                        };
                        {
                            ...
                            (@:checkr _t_3740443 ?? throw "null pointer dereference").dataBitOffset = __tmp__._0;
                    ...
                    } else if (__value__ == (3741833i32)) {
                        {
                            ...
                            (@:checkr _t_3741633 ?? throw "null pointer dereference").structName = __tmp__._0?.__copy__();
                        };
                    ...
                    } else if (__value__ == (3742701i32)) {
                        {
                            ...
                            (@:checkr _f_3742147 ?? throw "null pointer dereference").name = __tmp__._0?.__copy__();
                        };
                        {
                            var __tmp__ = try {
                            ...
                            (@:checkr _f_3742147 ?? throw "null pointer dereference").byteSize = __tmp__._0;
                        };
                        ...
                        _haveDataBitOffset_3742818 = false;
                        {
                            ...
                            (@:checkr _f_3742147 ?? throw "null pointer dereference").bitOffset = __tmp__._0;
                        ...
                        };
                        {
                            ...
                            (@:checkr _f_3742147 ?? throw "null pointer dereference").dataBitOffset = __tmp__._0;
                    ...
                    } else if (__value__ == (3743122i32)) {
                        {
                            ...
                            (@:checkr _f_3742147 ?? throw "null pointer dereference").bitSize = __tmp__._0;
                        };
                        ...
                        _typeCache[_off] = stdgo.Go.asInterface(_t_3744457);
                        {
                            ...
                            (@:checkr _t_3744457 ?? throw "null pointer dereference").enumName = __tmp__._0?.__copy__();
                        };
                        ...
                        _f_3744670 = (stdgo.Go.setRef(({} : stdgo._internal.debug.dwarf.Dwarf_EnumValue_.EnumValue_)) : stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_EnumValue_.EnumValue_>);
                        {
                            ...
                            (@:checkr _f_3744670 ?? throw "null pointer dereference").name = __tmp__._0?.__copy__();
                        };
                        {
                            var __tmp__ = try {
                            ...
                            (@:checkr _f_3744670 ?? throw "null pointer dereference").val = __tmp__._0;
                        };
                        ...
                        _typeCache[_off] = stdgo.Go.asInterface(_t_3746251);
                        {
                            ...
                            (@:checkr _t_3746251 ?? throw "null pointer dereference").commonType.name = __tmp__._0?.__copy__();
                        };
                        ...
                        _typeCache[_off] = stdgo.Go.asInterface(_t_3746469);
                        {
                            ...
                            (@:checkr _t_3746469 ?? throw "null pointer dereference").basicType.commonType.name = __tmp__._0?.__copy__();
                        };
                        _gotoNext = 3746843i32;
                        ...
                        (@:checkr _t_3746726 ?? throw "null pointer dereference").tag = (@:checkr _e_3735398 ?? throw "null pointer dereference").tag;
                        {
                            ...
                            (@:checkr _t_3746726 ?? throw "null pointer dereference").commonType.name = __tmp__._0?.__copy__();
                        };
                        _gotoNext = 3746843i32;
