...
@:keep @:allow(stdgo._internal.debug.dwarf.Dwarf.LineReader_asInterface) class LineReader_static_extension {
    ...
    static public function _step( _r:stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_LineReader.LineReader>, _entry:stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_LineEntry.LineEntry>):Bool {
        @:recv var _r:stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_LineReader.LineReader> = _r;
        var _i_3679814:stdgo.GoInt = (0 : stdgo.GoInt);
        var _startOff_3677984:stdgo._internal.debug.dwarf.Dwarf_Offset.Offset = ((0 : stdgo.GoUInt32) : stdgo._internal.debug.dwarf.Dwarf_Offset.Offset);
        var _lineDelta_3677788:stdgo.GoInt = (0 : stdgo.GoInt);
        var _done_3678489:Bool = false;
        var _opcode_3678008:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _length_3677951:stdgo._internal.debug.dwarf.Dwarf_Offset.Offset = ((0 : stdgo.GoUInt32) : stdgo._internal.debug.dwarf.Dwarf_Offset.Offset);
        var _adjustedOpcode_3677702:stdgo.GoInt = (0 : stdgo.GoInt);
        var _opcode_3677588:stdgo.GoInt = (0 : stdgo.GoInt);
        var _err_3678495:stdgo.Error = (null : stdgo.Error);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _opcode_3677588 = (@:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._uint8() : stdgo.GoInt);
                    if ((_opcode_3677588 >= (@:checkr _r ?? throw "null pointer dereference")._opcodeBase : Bool)) {
                        _gotoNext = 3677645i32;
                    } else {
                        _gotoNext = 3677886i32;
                    };
                } else if (__value__ == (3677645i32)) {
                    _adjustedOpcode_3677702 = (_opcode_3677588 - (@:checkr _r ?? throw "null pointer dereference")._opcodeBase : stdgo.GoInt);
                    @:check2r _r._advancePC((_adjustedOpcode_3677702 / (@:checkr _r ?? throw "null pointer dereference")._lineRange : stdgo.GoInt));
                    _lineDelta_3677788 = ((@:checkr _r ?? throw "null pointer dereference")._lineBase + (_adjustedOpcode_3677702 % (@:checkr _r ?? throw "null pointer dereference")._lineRange : stdgo.GoInt) : stdgo.GoInt);
                    (@:checkr _r ?? throw "null pointer dereference")._state.line = ((@:checkr _r ?? throw "null pointer dereference")._state.line + (_lineDelta_3677788) : stdgo.GoInt);
                    _gotoNext = 3679895i32;
                } else if (__value__ == (3677886i32)) {
                    _gotoNext = 3677886i32;
                    {
                        final __value__ = _opcode_3677588;
                        if (__value__ == ((0 : stdgo.GoInt))) {
                            _gotoNext = 3677903i32;
                        } else if (__value__ == ((1 : stdgo.GoInt))) {
                            _gotoNext = 3678962i32;
                        } else if (__value__ == ((2 : stdgo.GoInt))) {
                            _gotoNext = 3678990i32;
                        } else if (__value__ == ((3 : stdgo.GoInt))) {
                            _gotoNext = 3679044i32;
                        } else if (__value__ == ((4 : stdgo.GoInt))) {
                            _gotoNext = 3679102i32;
                        } else if (__value__ == ((5 : stdgo.GoInt))) {
                            _gotoNext = 3679172i32;
                        } else if (__value__ == ((6 : stdgo.GoInt))) {
                            _gotoNext = 3679230i32;
                        } else if (__value__ == ((7 : stdgo.GoInt))) {
                            _gotoNext = 3679287i32;
                        } else if (__value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 3679340i32;
                        } else if (__value__ == ((9 : stdgo.GoInt))) {
                            _gotoNext = 3679412i32;
                        } else if (__value__ == ((10 : stdgo.GoInt))) {
                            _gotoNext = 3679527i32;
                        } else if (__value__ == ((11 : stdgo.GoInt))) {
                            _gotoNext = 3679582i32;
                        } else if (__value__ == ((12 : stdgo.GoInt))) {
                            _gotoNext = 3679641i32;
                        } else {
                            _gotoNext = 3679693i32;
                        };
                    };
                } else if (__value__ == (3677903i32)) {
                    _length_3677951 = (@:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._uint() : stdgo._internal.debug.dwarf.Dwarf_Offset.Offset);
                    _startOff_3677984 = (@:checkr _r ?? throw "null pointer dereference")._buf._off;
                    _opcode_3678008 = @:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._uint8();
                    _gotoNext = 3678035i32;
                } else if (__value__ == (3678035i32)) {
                    {
                        final __value__ = _opcode_3678008;
                        if (__value__ == ((1 : stdgo.GoUInt8))) {
                            _gotoNext = 3678053i32;
                        } else if (__value__ == ((2 : stdgo.GoUInt8))) {
                            _gotoNext = 3678145i32;
                        } else if (__value__ == ((3 : stdgo.GoUInt8))) {
                            _gotoNext = 3678463i32;
                        } else if (__value__ == ((4 : stdgo.GoUInt8))) {
                            _gotoNext = 3678722i32;
                        } else {
                            _gotoNext = 3678823i32;
                        };
                    };
                } else if (__value__ == (3678053i32)) {
                    ...
                    _gotoNext = 3678168i32;
                } else if (__value__ == (3678168i32)) {
                    {
                        final __value__ = (@:checkr _r ?? throw "null pointer dereference")._addrsize;
                        if (__value__ == ((1 : stdgo.GoInt))) {
                            _gotoNext = 3678191i32;
                        } else if (__value__ == ((2 : stdgo.GoInt))) {
                            _gotoNext = 3678246i32;
                        } else if (__value__ == ((4 : stdgo.GoInt))) {
                            _gotoNext = 3678302i32;
                        } else if (__value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 3678358i32;
                        } else {
                            _gotoNext = 3678406i32;
                        };
                    };
                } else if (__value__ == (3678191i32)) {
                    ...
                    _gotoNext = 3678823i32;
                } else if (__value__ == (3678358i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._state.address = @:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._uint64();
                    _gotoNext = 3678823i32;
                } else if (__value__ == (3678406i32)) {
                    @:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._error(("unknown address size" : stdgo.GoString));
                    _gotoNext = 3678823i32;
                } else if (__value__ == (3678463i32)) {
                    {
                        {
                            var __tmp__ = @:check2r _r._readFileEntry();
                            _done_3678489 = @:tmpset0 __tmp__._0;
                            _err_3678495 = @:tmpset0 __tmp__._1;
                        };
                        if (_err_3678495 != null) {
                            _gotoNext = 3678532i32;
                        } else if (_done_3678489) {
                            _gotoNext = 3678589i32;
                        } else {
                            _gotoNext = 3678704i32;
                        };
                    };
                } else if (__value__ == (3678532i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._buf._err = _err_3678495;
                    return false;
                    _gotoNext = 3678704i32;
                } else if (__value__ == (3678589i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._buf._err = stdgo.Go.asInterface((new stdgo._internal.debug.dwarf.Dwarf_DecodeError.DecodeError(("line" : stdgo.GoString), _startOff_3677984, ("malformed DW_LNE_define_file operation" : stdgo.GoString)) : stdgo._internal.debug.dwarf.Dwarf_DecodeError.DecodeError));
                    return false;
                    _gotoNext = 3678704i32;
                } else if (__value__ == (3678704i32)) {
                    @:check2r _r._updateFile();
                    _gotoNext = 3678823i32;
                } else if (__value__ == (3678722i32)) {
                    ...
                    _gotoNext = 3678823i32;
                } else if (__value__ == (3678823i32)) {
                    @:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._skip((((_startOff_3677984 + _length_3677951 : stdgo._internal.debug.dwarf.Dwarf_Offset.Offset) - (@:checkr _r ?? throw "null pointer dereference")._buf._off : stdgo._internal.debug.dwarf.Dwarf_Offset.Offset) : stdgo.GoInt));
                    if (_opcode_3678008 == ((1 : stdgo.GoUInt8))) {
                        _gotoNext = 3678901i32;
                    } else {
                        _gotoNext = 3679881i32;
                    };
                } else if (__value__ == (3678901i32)) {
                    return true;
                    _gotoNext = 3679881i32;
                } else if (__value__ == (3678962i32)) {
                    _gotoNext = 3679895i32;
                } else if (__value__ == (3678990i32)) {
                    ...
                    _i_3679814 = (0 : stdgo.GoInt);
                    _gotoNext = 3679810i32;
                } else if (__value__ == (3679810i32)) {
                    if ((_i_3679814 < (@:checkr _r ?? throw "null pointer dereference")._opcodeLengths[(_opcode_3677588 : stdgo.GoInt)] : Bool)) {
                    ...
                    _i_3679814++;
                    _gotoNext = 3679810i32;
                } else if (__value__ == (3679881i32)) {
                    return false;
                    _gotoNext = 3679895i32;
                } else if (__value__ == (3679895i32)) {
                    {
                        var __tmp__ = (@:checkr _r ?? throw "null pointer dereference")._state?.__copy__();
                        var x = (_entry : stdgo._internal.debug.dwarf.Dwarf_LineEntry.LineEntry);
                        x.address = __tmp__?.address;
