...
@:keep @:allow(stdgo._internal.debug.dwarf.Dwarf.LineReader_asInterface) class LineReader_static_extension {
    ...
    static public function _step( _r:stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_LineReader.LineReader>, _entry:stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_LineEntry.LineEntry>):Bool {
        @:recv var _r:stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_LineReader.LineReader> = _r;
        var _startOff_3646525:stdgo._internal.debug.dwarf.Dwarf_Offset.Offset = ((0 : stdgo.GoUInt32) : stdgo._internal.debug.dwarf.Dwarf_Offset.Offset);
        var _adjustedOpcode_3646243:stdgo.GoInt = (0 : stdgo.GoInt);
        var _opcode_3646129:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_3648355:stdgo.GoInt = (0 : stdgo.GoInt);
        var _err_3647036:stdgo.Error = (null : stdgo.Error);
        var _done_3647030:Bool = false;
        var _opcode_3646549:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _length_3646492:stdgo._internal.debug.dwarf.Dwarf_Offset.Offset = ((0 : stdgo.GoUInt32) : stdgo._internal.debug.dwarf.Dwarf_Offset.Offset);
        var _lineDelta_3646329:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _opcode_3646129 = (_r._buf._uint8() : stdgo.GoInt);
                    if ((_opcode_3646129 >= _r._opcodeBase : Bool)) {
                        _gotoNext = 3646186i32;
                    } else {
                        _gotoNext = 3646427i32;
                    };
                } else if (__value__ == (3646186i32)) {
                    _adjustedOpcode_3646243 = (_opcode_3646129 - _r._opcodeBase : stdgo.GoInt);
                    _r._advancePC((_adjustedOpcode_3646243 / _r._lineRange : stdgo.GoInt));
                    _lineDelta_3646329 = (_r._lineBase + (_adjustedOpcode_3646243 % _r._lineRange : stdgo.GoInt) : stdgo.GoInt);
                    _r._state.line = (_r._state.line + (_lineDelta_3646329) : stdgo.GoInt);
                    _gotoNext = 3648436i32;
                } else if (__value__ == (3646427i32)) {
                    _gotoNext = 3646427i32;
                    {
                        final __value__ = _opcode_3646129;
                        if (__value__ == ((0 : stdgo.GoInt))) {
                            _gotoNext = 3646444i32;
                        } else if (__value__ == ((1 : stdgo.GoInt))) {
                            _gotoNext = 3647503i32;
                        } else if (__value__ == ((2 : stdgo.GoInt))) {
                            _gotoNext = 3647531i32;
                        } else if (__value__ == ((3 : stdgo.GoInt))) {
                            _gotoNext = 3647585i32;
                        } else if (__value__ == ((4 : stdgo.GoInt))) {
                            _gotoNext = 3647643i32;
                        } else if (__value__ == ((5 : stdgo.GoInt))) {
                            _gotoNext = 3647713i32;
                        } else if (__value__ == ((6 : stdgo.GoInt))) {
                            _gotoNext = 3647771i32;
                        } else if (__value__ == ((7 : stdgo.GoInt))) {
                            _gotoNext = 3647828i32;
                        } else if (__value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 3647881i32;
                        } else if (__value__ == ((9 : stdgo.GoInt))) {
                            _gotoNext = 3647953i32;
                        } else if (__value__ == ((10 : stdgo.GoInt))) {
                            _gotoNext = 3648068i32;
                        } else if (__value__ == ((11 : stdgo.GoInt))) {
                            _gotoNext = 3648123i32;
                        } else if (__value__ == ((12 : stdgo.GoInt))) {
                            _gotoNext = 3648182i32;
                        } else {
                            _gotoNext = 3648234i32;
                        };
                    };
                } else if (__value__ == (3646444i32)) {
                    _length_3646492 = (_r._buf._uint() : stdgo._internal.debug.dwarf.Dwarf_Offset.Offset);
                    _startOff_3646525 = _r._buf._off;
                    _opcode_3646549 = _r._buf._uint8();
                    _gotoNext = 3646576i32;
                } else if (__value__ == (3646576i32)) {
                    {
                        final __value__ = _opcode_3646549;
                        if (__value__ == ((1 : stdgo.GoUInt8))) {
                            _gotoNext = 3646594i32;
                        } else if (__value__ == ((2 : stdgo.GoUInt8))) {
                            _gotoNext = 3646686i32;
                        } else if (__value__ == ((3 : stdgo.GoUInt8))) {
                            _gotoNext = 3647004i32;
                        } else if (__value__ == ((4 : stdgo.GoUInt8))) {
                            _gotoNext = 3647263i32;
                        } else {
                            _gotoNext = 3647364i32;
                        };
                    };
                } else if (__value__ == (3646594i32)) {
                    ...
                    _r._resetState();
                    _gotoNext = 3647364i32;
                } else if (__value__ == (3646686i32)) {
                    _gotoNext = 3646709i32;
                } else if (__value__ == (3646709i32)) {
                    {
                        final __value__ = _r._addrsize;
                        if (__value__ == ((1 : stdgo.GoInt))) {
                            _gotoNext = 3646732i32;
                        } else if (__value__ == ((2 : stdgo.GoInt))) {
                            _gotoNext = 3646787i32;
                        } else if (__value__ == ((4 : stdgo.GoInt))) {
                            _gotoNext = 3646843i32;
                        } else if (__value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 3646899i32;
                        } else {
                            _gotoNext = 3646947i32;
                        };
                    };
                } else if (__value__ == (3646732i32)) {
                    _r._state.address = (_r._buf._uint8() : stdgo.GoUInt64);
                    _gotoNext = 3647364i32;
                } else if (__value__ == (3646787i32)) {
                    _r._state.address = (_r._buf._uint16() : stdgo.GoUInt64);
                    _gotoNext = 3647364i32;
                } else if (__value__ == (3646843i32)) {
                    _r._state.address = (_r._buf._uint32() : stdgo.GoUInt64);
                    _gotoNext = 3647364i32;
                } else if (__value__ == (3646899i32)) {
                    _r._state.address = _r._buf._uint64();
                    _gotoNext = 3647364i32;
                } else if (__value__ == (3646947i32)) {
                    _r._buf._error(("unknown address size" : stdgo.GoString));
                    _gotoNext = 3647364i32;
                } else if (__value__ == (3647004i32)) {
                    {
                        {
                            var __tmp__ = _r._readFileEntry();
                            _done_3647030 = __tmp__._0;
                            _err_3647036 = __tmp__._1;
                        };
                        if (_err_3647036 != null) {
                            _gotoNext = 3647073i32;
                        } else if (_done_3647030) {
                            _gotoNext = 3647130i32;
                        } else {
                            _gotoNext = 3647245i32;
                        };
                    };
                } else if (__value__ == (3647073i32)) {
                    _r._buf._err = _err_3647036;
                    return false;
                    _gotoNext = 3647245i32;
                } else if (__value__ == (3647130i32)) {
                    _r._buf._err = stdgo.Go.asInterface((new stdgo._internal.debug.dwarf.Dwarf_DecodeError.DecodeError(("line" : stdgo.GoString), _startOff_3646525, ("malformed DW_LNE_define_file operation" : stdgo.GoString)) : stdgo._internal.debug.dwarf.Dwarf_DecodeError.DecodeError));
                    return false;
                    _gotoNext = 3647245i32;
                } else if (__value__ == (3647245i32)) {
                    _r._updateFile();
                    _gotoNext = 3647364i32;
                } else if (__value__ == (3647263i32)) {
                    _r._state.discriminator = (_r._buf._uint() : stdgo.GoInt);
                    _gotoNext = 3647364i32;
                } else if (__value__ == (3647364i32)) {
                    _r._buf._skip((((_startOff_3646525 + _length_3646492 : stdgo._internal.debug.dwarf.Dwarf_Offset.Offset) - _r._buf._off : stdgo._internal.debug.dwarf.Dwarf_Offset.Offset) : stdgo.GoInt));
                    if (_opcode_3646549 == ((1 : stdgo.GoUInt8))) {
                        _gotoNext = 3647442i32;
                    } else {
                        _gotoNext = 3648422i32;
                    };
                } else if (__value__ == (3647442i32)) {
                    return true;
                    _gotoNext = 3648422i32;
                } else if (__value__ == (3647503i32)) {
                    _gotoNext = 3648436i32;
                } else if (__value__ == (3647531i32)) {
                    _r._advancePC((_r._buf._uint() : stdgo.GoInt));
                    _gotoNext = 3648422i32;
                } else if (__value__ == (3647585i32)) {
                    _r._state.line = (_r._state.line + ((_r._buf._int() : stdgo.GoInt)) : stdgo.GoInt);
                    _gotoNext = 3648422i32;
                } else if (__value__ == (3647643i32)) {
                    _r._fileIndex = (_r._buf._uint() : stdgo.GoInt);
                    _r._updateFile();
                    _gotoNext = 3648422i32;
                } else if (__value__ == (3647713i32)) {
                    _r._state.column = (_r._buf._uint() : stdgo.GoInt);
                    _gotoNext = 3648422i32;
                } else if (__value__ == (3647771i32)) {
                    _r._state.isStmt = !_r._state.isStmt;
                    _gotoNext = 3648422i32;
                } else if (__value__ == (3647828i32)) {
                    _r._state.basicBlock = true;
                    _gotoNext = 3648422i32;
                } else if (__value__ == (3647881i32)) {
                    _r._advancePC(((((255 : stdgo.GoInt) - _r._opcodeBase : stdgo.GoInt)) / _r._lineRange : stdgo.GoInt));
                    _gotoNext = 3648422i32;
                } else if (__value__ == (3647953i32)) {
                    _r._state.address = (_r._state.address + ((_r._buf._uint16() : stdgo.GoUInt64)) : stdgo.GoUInt64);
                    _gotoNext = 3648422i32;
                } else if (__value__ == (3648068i32)) {
                    _r._state.prologueEnd = true;
                    _gotoNext = 3648422i32;
                } else if (__value__ == (3648123i32)) {
                    _r._state.epilogueBegin = true;
                    _gotoNext = 3648422i32;
                } else if (__value__ == (3648182i32)) {
                    _r._state.isa = (_r._buf._uint() : stdgo.GoInt);
                    _gotoNext = 3648422i32;
                } else if (__value__ == (3648234i32)) {
                    _i_3648355 = (0 : stdgo.GoInt);
                    _gotoNext = 3648351i32;
                } else if (__value__ == (3648351i32)) {
                    if ((_i_3648355 < _r._opcodeLengths[(_opcode_3646129 : stdgo.GoInt)] : Bool)) {
                        _gotoNext = 3648396i32;
                    } else {
                        _gotoNext = 3648422i32;
                    };
                } else if (__value__ == (3648396i32)) {
                    _r._buf._uint();
                    _i_3648355++;
                    _gotoNext = 3648351i32;
                } else if (__value__ == (3648422i32)) {
                    return false;
                    _gotoNext = 3648436i32;
