        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _opcode_3684140 = (_r._buf._uint8() : stdgo.GoInt);
                    if ((_opcode_3684140 >= _r._opcodeBase : Bool)) {
                        _gotoNext = 3684197i32;
                    } else {
                        _gotoNext = 3684438i32;
                    };
                } else if (__value__ == (3684197i32)) {
                    _adjustedOpcode_3684254 = (_opcode_3684140 - _r._opcodeBase : stdgo.GoInt);
                    _r._advancePC((_adjustedOpcode_3684254 / _r._lineRange : stdgo.GoInt));
                    _lineDelta_3684340 = (_r._lineBase + (_adjustedOpcode_3684254 % _r._lineRange : stdgo.GoInt) : stdgo.GoInt);
                    _r._state.line = (_r._state.line + (_lineDelta_3684340) : stdgo.GoInt);
                    ...
                    _length_3684503 = (_r._buf._uint() : stdgo._internal.debug.dwarf.Dwarf_Offset.Offset);
                    _startOff_3684536 = _r._buf._off;
                    _opcode_3684560 = _r._buf._uint8();
                    ...
                    {
                        {
                            ...
                            _done_3685041 = __tmp__._0;
                            _err_3685047 = __tmp__._1;
                        };
                    ...
                    _r._buf._err = _err_3685047;
                    return false;
                    _gotoNext = 3685256i32;
                } else if (__value__ == (3685141i32)) {
                    _r._buf._err = stdgo.Go.asInterface((new stdgo._internal.debug.dwarf.Dwarf_DecodeError.DecodeError(("line" : stdgo.GoString), _startOff_3684536, ("malformed DW_LNE_define_file operation" : stdgo.GoString)) : stdgo._internal.debug.dwarf.Dwarf_DecodeError.DecodeError));
                    return false;
                    _gotoNext = 3685256i32;
                    ...
                    _r._buf._skip((((_startOff_3684536 + _length_3684503 : stdgo._internal.debug.dwarf.Dwarf_Offset.Offset) - _r._buf._off : stdgo._internal.debug.dwarf.Dwarf_Offset.Offset) : stdgo.GoInt));
                    ...
                    if ((_i_3686366 < _r._opcodeLengths[(_opcode_3684140 : stdgo.GoInt)] : Bool)) {
