...
class StructType_asInterface {
    @:keep
    public dynamic function defn():stdgo.GoString return __self__.value.defn();
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.debug.dwarf.Dwarf_StructType.StructType>;
