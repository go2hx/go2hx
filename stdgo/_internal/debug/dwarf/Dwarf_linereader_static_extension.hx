        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((_opcode_0 >= (@:checkr _r ?? throw "null pointer dereference")._opcodeBase : Bool)) {
                        _gotoNext = 3697722i32;
                    } else {
                        _gotoNext = 3697963i32;
                    };
                } else if (__value__ == (3697722i32)) {
                    ...
                    @:check2r _r._resetState();
                    _gotoNext = 3698900i32;
                } else if (__value__ == (3698222i32)) {
                    _gotoNext = 3698245i32;
                } else if (__value__ == (3698245i32)) {
                    {
                        final __value__ = (@:checkr _r ?? throw "null pointer dereference")._addrsize;
                        if (__value__ == ((1 : stdgo.GoInt))) {
                            _gotoNext = 3698268i32;
                        } else if (__value__ == ((2 : stdgo.GoInt))) {
                            _gotoNext = 3698323i32;
                        } else if (__value__ == ((4 : stdgo.GoInt))) {
                            _gotoNext = 3698379i32;
                        } else if (__value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 3698435i32;
                        } else {
                            _gotoNext = 3698483i32;
                        };
                    };
                } else if (__value__ == (3698268i32)) {
                ...
                } else if (__value__ == (3698540i32)) {
                    {
                        ...
                        if (_err_7 != null) {
                            _gotoNext = 3698609i32;
                        } else if (_done_6) {
                            _gotoNext = 3698666i32;
                        } else {
                            _gotoNext = 3698781i32;
                        };
                    };
                } else if (__value__ == (3698609i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._buf._err = _err_7;
                    return false;
                    _gotoNext = 3698781i32;
                } else if (__value__ == (3698666i32)) {
