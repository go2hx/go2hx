            ...
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    ...
                    if ((_opcode_0 >= (@:checkr _r ?? throw "null pointer dereference")._opcodeBase : Bool)) {
                        _gotoNext = 3669153i64;
                    } else {
                        _gotoNext = 3669394i64;
                    };
                } else if (__value__ == (3669153i64)) {
                    ...
                    _r._resetState();
                    _gotoNext = 3670331i64;
                } else if (__value__ == (3669653i64)) {
                    _gotoNext = 3669676i64;
                } else if (__value__ == (3669676i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/debug/dwarf/line.go#L549"
                    {
                        ...
                        if (__value__ == ((1 : stdgo.GoInt))) {
                            _gotoNext = 3669699i64;
                        } else if (__value__ == ((2 : stdgo.GoInt))) {
                            _gotoNext = 3669754i64;
                        } else if (__value__ == ((4 : stdgo.GoInt))) {
                            _gotoNext = 3669810i64;
                        } else if (__value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 3669866i64;
                        } else {
                            _gotoNext = 3669914i64;
                        };
                    };
                } else if (__value__ == (3669699i64)) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/debug/dwarf/line.go#L563"
                    {
                        ...
                        if (_err_7 != null) {
                            _gotoNext = 3670040i64;
                        } else if (_done_6) {
                            _gotoNext = 3670097i64;
                        } else {
                            _gotoNext = 3670212i64;
                        };
                    };
                } else if (__value__ == (3670040i64)) {
                    (@:checkr _r ?? throw "null pointer dereference")._buf._err = _err_7;
                    //"file:///home/runner/.go/go1.21.3/src/debug/dwarf/line.go#L565"
                    return false;
                    _gotoNext = 3670212i64;
                } else if (__value__ == (3670097i64)) {
