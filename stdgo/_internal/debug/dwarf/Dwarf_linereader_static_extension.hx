        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((_opcode_0 >= (@:checkr _r ?? throw "null pointer dereference")._opcodeBase : Bool)) {
                        _gotoNext = 3688238i32;
                    } else {
                        _gotoNext = 3688479i32;
                    };
                } else if (__value__ == (3688238i32)) {
                ...
                } else if (__value__ == (3688761i32)) {
                    {
                        ...
                        if (__value__ == ((1 : stdgo.GoInt))) {
                            ...
                            _gotoNext = 3688839i32;
                        } else if (__value__ == ((4 : stdgo.GoInt))) {
                            _gotoNext = 3688895i32;
                        } else if (__value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 3688951i32;
                        } else {
                            _gotoNext = 3688999i32;
                        };
                    };
                ...
                } else if (__value__ == (3689056i32)) {
                    {
                        ...
                        if (_err_7 != null) {
                            _gotoNext = 3689125i32;
                        } else if (_done_6) {
                            _gotoNext = 3689182i32;
                        } else {
                            _gotoNext = 3689297i32;
                        };
                    };
                } else if (__value__ == (3689125i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._buf._err = _err_7;
                    return false;
                    _gotoNext = 3689297i32;
                } else if (__value__ == (3689182i32)) {
                    ...
                    _gotoNext = 3690474i32;
                } else if (__value__ == (3690286i32)) {
                    _i_8 = (0 : stdgo.GoInt);
                    _gotoNext = 3690403i32;
                } else if (__value__ == (3690403i32)) {
                    if ((_i_8 < (@:checkr _r ?? throw "null pointer dereference")._opcodeLengths[(_opcode_0 : stdgo.GoInt)] : Bool)) {
                        _gotoNext = 3690448i32;
                    } else {
                        _gotoNext = 3690474i32;
                    };
                } else if (__value__ == (3690448i32)) {
                    @:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._uint();
                    _i_8++;
                    _gotoNext = 3690403i32;
                } else if (__value__ == (3690474i32)) {
                    return false;
                    _gotoNext = 3690488i32;
                } else if (__value__ == (3690488i32)) {
                    {
                        var __tmp__ = (@:checkr _r ?? throw "null pointer dereference")._state?.__copy__();
                        var x = (_entry : stdgo._internal.debug.dwarf.Dwarf_lineentry.LineEntry);
                        x.address = __tmp__?.address;
