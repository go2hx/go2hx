            ...
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    ...
                    if ((_opcode_0 >= (@:checkr _r ?? throw "null pointer dereference")._opcodeBase : Bool)) {
                        _gotoNext = 3706829i64;
                    } else {
                        _gotoNext = 3707070i64;
                    };
                } else if (__value__ == (3706829i64)) {
                    ...
                    _r._resetState();
                    _gotoNext = 3708007i64;
                } else if (__value__ == (3707329i64)) {
                    _gotoNext = 3707352i64;
                } else if (__value__ == (3707352i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/debug/dwarf/line.go#L549"
                    {
                        ...
                        if (__value__ == ((1 : stdgo.GoInt))) {
                            _gotoNext = 3707375i64;
                        } else if (__value__ == ((2 : stdgo.GoInt))) {
                            _gotoNext = 3707430i64;
                        } else if (__value__ == ((4 : stdgo.GoInt))) {
                            _gotoNext = 3707486i64;
                        } else if (__value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 3707542i64;
                        } else {
                            _gotoNext = 3707590i64;
                        };
                    };
                } else if (__value__ == (3707375i64)) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/debug/dwarf/line.go#L563"
                    {
                        ...
                        if (_err_7 != null) {
                            _gotoNext = 3707716i64;
                        } else if (_done_6) {
                            _gotoNext = 3707773i64;
                        } else {
                            _gotoNext = 3707888i64;
                        };
                    };
                } else if (__value__ == (3707716i64)) {
                    (@:checkr _r ?? throw "null pointer dereference")._buf._err = _err_7;
                    //"file:///home/runner/.go/go1.21.3/src/debug/dwarf/line.go#L565"
                    return false;
                    _gotoNext = 3707888i64;
                } else if (__value__ == (3707773i64)) {
                    ...
                    if (_opcode_5 == ((1 : stdgo.GoUInt8))) {
                        _gotoNext = 3708085i64;
                    } else {
                        _gotoNext = 3709065i64;
                    };
                } else if (__value__ == (3708085i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/debug/dwarf/line.go#L580"
                    return true;
                    _gotoNext = 3709065i64;
                } else if (__value__ == (3708146i64)) {
                    _gotoNext = 3709079i64;
                } else if (__value__ == (3708174i64)) {
