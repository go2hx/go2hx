        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((_opcode_0 >= (@:checkr _r ?? throw "null pointer dereference")._opcodeBase : Bool)) {
                        _gotoNext = 3722333i32;
                    } else {
                        _gotoNext = 3722574i32;
                    };
                } else if (__value__ == (3722333i32)) {
                    ...
                    @:check2r _r._resetState();
                    _gotoNext = 3723511i32;
                } else if (__value__ == (3722833i32)) {
                    _gotoNext = 3722856i32;
                } else if (__value__ == (3722856i32)) {
                    {
                        final __value__ = (@:checkr _r ?? throw "null pointer dereference")._addrsize;
                        if (__value__ == ((1 : stdgo.GoInt))) {
                            _gotoNext = 3722879i32;
                        } else if (__value__ == ((2 : stdgo.GoInt))) {
                            _gotoNext = 3722934i32;
                        } else if (__value__ == ((4 : stdgo.GoInt))) {
                            _gotoNext = 3722990i32;
                        } else if (__value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 3723046i32;
                        } else {
                            _gotoNext = 3723094i32;
                        };
                    };
                } else if (__value__ == (3722879i32)) {
                ...
                } else if (__value__ == (3723151i32)) {
                    {
                        ...
                        if (_err_7 != null) {
                            _gotoNext = 3723220i32;
                        } else if (_done_6) {
                            _gotoNext = 3723277i32;
                        } else {
                            _gotoNext = 3723392i32;
                        };
                    };
                } else if (__value__ == (3723220i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._buf._err = _err_7;
                    return false;
                    _gotoNext = 3723392i32;
                } else if (__value__ == (3723277i32)) {
                    ...
                    return false;
                    _gotoNext = 3723392i32;
                } else if (__value__ == (3723392i32)) {
                    @:check2r _r._updateFile();
                    _gotoNext = 3723511i32;
                } else if (__value__ == (3723410i32)) {
                    ...
                    if (_opcode_5 == ((1 : stdgo.GoUInt8))) {
                        _gotoNext = 3723589i32;
                    } else {
                        _gotoNext = 3724569i32;
                    };
                } else if (__value__ == (3723589i32)) {
                    return true;
                    _gotoNext = 3724569i32;
                } else if (__value__ == (3723650i32)) {
                    _gotoNext = 3724583i32;
                } else if (__value__ == (3723678i32)) {
                    @:check2r _r._advancePC((@:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._uint() : stdgo.GoInt));
                    _gotoNext = 3724569i32;
                } else if (__value__ == (3723732i32)) {
                    ...
                    _gotoNext = 3724569i32;
                } else if (__value__ == (3724381i32)) {
                    _i_8 = (0 : stdgo.GoInt);
                    _gotoNext = 3724498i32;
                } else if (__value__ == (3724498i32)) {
                    if ((_i_8 < (@:checkr _r ?? throw "null pointer dereference")._opcodeLengths[(_opcode_0 : stdgo.GoInt)] : Bool)) {
                        _gotoNext = 3724543i32;
                    } else {
                        _gotoNext = 3724569i32;
                    };
                } else if (__value__ == (3724543i32)) {
