...
@:keep @:allow(stdgo._internal.debug.dwarf.Dwarf.LineReader_asInterface) class LineReader_static_extension {
    ...
    static public function _step( _r:stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_linereader.LineReader>, _entry:stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_lineentry.LineEntry>):Bool {
        @:recv var _r:stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_linereader.LineReader> = _r;
        var _lineDelta_3699289:stdgo.GoInt = (0 : stdgo.GoInt);
        var _adjustedOpcode_3699203:stdgo.GoInt = (0 : stdgo.GoInt);
        var _opcode_3699089:stdgo.GoInt = (0 : stdgo.GoInt);
        var _startOff_3699485:stdgo._internal.debug.dwarf.Dwarf_offset.Offset = ((0 : stdgo.GoUInt32) : stdgo._internal.debug.dwarf.Dwarf_offset.Offset);
        var _done_3699990:Bool = false;
        var _opcode_3699509:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _length_3699452:stdgo._internal.debug.dwarf.Dwarf_offset.Offset = ((0 : stdgo.GoUInt32) : stdgo._internal.debug.dwarf.Dwarf_offset.Offset);
        var _i_3701315:stdgo.GoInt = (0 : stdgo.GoInt);
        var _err_3699996:stdgo.Error = (null : stdgo.Error);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _opcode_3699089 = (@:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._uint8() : stdgo.GoInt);
                    if ((_opcode_3699089 >= (@:checkr _r ?? throw "null pointer dereference")._opcodeBase : Bool)) {
                        _gotoNext = 3699146i32;
                    } else {
                        _gotoNext = 3699387i32;
                    };
                } else if (__value__ == (3699146i32)) {
                    _adjustedOpcode_3699203 = (_opcode_3699089 - (@:checkr _r ?? throw "null pointer dereference")._opcodeBase : stdgo.GoInt);
                    @:check2r _r._advancePC((_adjustedOpcode_3699203 / (@:checkr _r ?? throw "null pointer dereference")._lineRange : stdgo.GoInt));
                    _lineDelta_3699289 = ((@:checkr _r ?? throw "null pointer dereference")._lineBase + (_adjustedOpcode_3699203 % (@:checkr _r ?? throw "null pointer dereference")._lineRange : stdgo.GoInt) : stdgo.GoInt);
                    (@:checkr _r ?? throw "null pointer dereference")._state.line = ((@:checkr _r ?? throw "null pointer dereference")._state.line + (_lineDelta_3699289) : stdgo.GoInt);
                    _gotoNext = 3701396i32;
                } else if (__value__ == (3699387i32)) {
                    _gotoNext = 3699387i32;
                    {
                        final __value__ = _opcode_3699089;
                        if (__value__ == ((0 : stdgo.GoInt))) {
                            _gotoNext = 3699404i32;
                        } else if (__value__ == ((1 : stdgo.GoInt))) {
                            _gotoNext = 3700463i32;
                        } else if (__value__ == ((2 : stdgo.GoInt))) {
                            _gotoNext = 3700491i32;
                        } else if (__value__ == ((3 : stdgo.GoInt))) {
                            _gotoNext = 3700545i32;
                        } else if (__value__ == ((4 : stdgo.GoInt))) {
                            _gotoNext = 3700603i32;
                        } else if (__value__ == ((5 : stdgo.GoInt))) {
                            _gotoNext = 3700673i32;
                        } else if (__value__ == ((6 : stdgo.GoInt))) {
                            _gotoNext = 3700731i32;
                        } else if (__value__ == ((7 : stdgo.GoInt))) {
                            _gotoNext = 3700788i32;
                        } else if (__value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 3700841i32;
                        } else if (__value__ == ((9 : stdgo.GoInt))) {
                            _gotoNext = 3700913i32;
                            ...
                            _gotoNext = 3701142i32;
                        } else {
                            _gotoNext = 3701194i32;
                        };
                    };
                } else if (__value__ == (3699404i32)) {
                    _length_3699452 = (@:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._uint() : stdgo._internal.debug.dwarf.Dwarf_offset.Offset);
                    _startOff_3699485 = (@:checkr _r ?? throw "null pointer dereference")._buf._off;
                    _opcode_3699509 = @:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._uint8();
                    _gotoNext = 3699536i32;
                } else if (__value__ == (3699536i32)) {
                    {
                        final __value__ = _opcode_3699509;
                        if (__value__ == ((1 : stdgo.GoUInt8))) {
                            _gotoNext = 3699554i32;
                        } else if (__value__ == ((2 : stdgo.GoUInt8))) {
                            _gotoNext = 3699646i32;
                        } else if (__value__ == ((3 : stdgo.GoUInt8))) {
                            _gotoNext = 3699964i32;
                        } else if (__value__ == ((4 : stdgo.GoUInt8))) {
                            _gotoNext = 3700223i32;
                        } else {
                            _gotoNext = 3700324i32;
                        };
                    };
                } else if (__value__ == (3699554i32)) {
                    ...
                    @:check2r _r._resetState();
                    _gotoNext = 3700324i32;
                } else if (__value__ == (3699646i32)) {
                    _gotoNext = 3699669i32;
                } else if (__value__ == (3699669i32)) {
                    {
                        final __value__ = (@:checkr _r ?? throw "null pointer dereference")._addrsize;
                        if (__value__ == ((1 : stdgo.GoInt))) {
                            _gotoNext = 3699692i32;
                        } else if (__value__ == ((2 : stdgo.GoInt))) {
                            _gotoNext = 3699747i32;
                        } else if (__value__ == ((4 : stdgo.GoInt))) {
                            _gotoNext = 3699803i32;
                        } else if (__value__ == ((8 : stdgo.GoInt))) {
                    ...
                    _gotoNext = 3700324i32;
                } else if (__value__ == (3699964i32)) {
                    {
                        {
                            var __tmp__ = @:check2r _r._readFileEntry();
                            _done_3699990 = @:tmpset0 __tmp__._0;
                            _err_3699996 = @:tmpset0 __tmp__._1;
                        };
                        if (_err_3699996 != null) {
                            _gotoNext = 3700033i32;
                        } else if (_done_3699990) {
                    ...
                    (@:checkr _r ?? throw "null pointer dereference")._buf._err = _err_3699996;
                    return false;
                    _gotoNext = 3700205i32;
                } else if (__value__ == (3700090i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._buf._err = stdgo.Go.asInterface((new stdgo._internal.debug.dwarf.Dwarf_decodeerror.DecodeError(("line" : stdgo.GoString), _startOff_3699485, ("malformed DW_LNE_define_file operation" : stdgo.GoString)) : stdgo._internal.debug.dwarf.Dwarf_decodeerror.DecodeError));
                    return false;
                    _gotoNext = 3700205i32;
                } else if (__value__ == (3700205i32)) {
                    @:check2r _r._updateFile();
                    _gotoNext = 3700324i32;
                } else if (__value__ == (3700223i32)) {
                    ...
                    @:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._skip((((_startOff_3699485 + _length_3699452 : stdgo._internal.debug.dwarf.Dwarf_offset.Offset) - (@:checkr _r ?? throw "null pointer dereference")._buf._off : stdgo._internal.debug.dwarf.Dwarf_offset.Offset) : stdgo.GoInt));
                    if (_opcode_3699509 == ((1 : stdgo.GoUInt8))) {
                        _gotoNext = 3700402i32;
                    } else {
                        _gotoNext = 3701382i32;
                    };
                } else if (__value__ == (3700402i32)) {
                    return true;
                    _gotoNext = 3701382i32;
                } else if (__value__ == (3700463i32)) {
                    _gotoNext = 3701396i32;
                } else if (__value__ == (3700491i32)) {
                    @:check2r _r._advancePC((@:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._uint() : stdgo.GoInt));
                    _gotoNext = 3701382i32;
                } else if (__value__ == (3700545i32)) {
                    ...
                    _gotoNext = 3701382i32;
                } else if (__value__ == (3701194i32)) {
                    _i_3701315 = (0 : stdgo.GoInt);
                    _gotoNext = 3701311i32;
                } else if (__value__ == (3701311i32)) {
                    if ((_i_3701315 < (@:checkr _r ?? throw "null pointer dereference")._opcodeLengths[(_opcode_3699089 : stdgo.GoInt)] : Bool)) {
                    ...
                    _i_3701315++;
                    _gotoNext = 3701311i32;
                } else if (__value__ == (3701382i32)) {
                    return false;
                    _gotoNext = 3701396i32;
                } else if (__value__ == (3701396i32)) {
                    {
                        var __tmp__ = (@:checkr _r ?? throw "null pointer dereference")._state?.__copy__();
                        var x = (_entry : stdgo._internal.debug.dwarf.Dwarf_lineentry.LineEntry);
                        x.address = __tmp__?.address;
