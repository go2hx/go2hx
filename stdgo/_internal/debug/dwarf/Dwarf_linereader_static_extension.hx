...
@:keep @:allow(stdgo._internal.debug.dwarf.Dwarf.LineReader_asInterface) class LineReader_static_extension {
    ...
    static public function _step( _r:stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_linereader.LineReader>, _entry:stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_lineentry.LineEntry>):Bool {
        @:recv var _r:stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_linereader.LineReader> = _r;
        var _adjustedOpcode_3649037:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_3651149:stdgo.GoInt = (0 : stdgo.GoInt);
        var _lineDelta_3649123:stdgo.GoInt = (0 : stdgo.GoInt);
        var _opcode_3648923:stdgo.GoInt = (0 : stdgo.GoInt);
        var _err_3649830:stdgo.Error = (null : stdgo.Error);
        var _done_3649824:Bool = false;
        var _opcode_3649343:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _startOff_3649319:stdgo._internal.debug.dwarf.Dwarf_offset.Offset = ((0 : stdgo.GoUInt32) : stdgo._internal.debug.dwarf.Dwarf_offset.Offset);
        var _length_3649286:stdgo._internal.debug.dwarf.Dwarf_offset.Offset = ((0 : stdgo.GoUInt32) : stdgo._internal.debug.dwarf.Dwarf_offset.Offset);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _opcode_3648923 = (@:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._uint8() : stdgo.GoInt);
                    if ((_opcode_3648923 >= (@:checkr _r ?? throw "null pointer dereference")._opcodeBase : Bool)) {
                        _gotoNext = 3648980i32;
                    } else {
                        _gotoNext = 3649221i32;
                    };
                } else if (__value__ == (3648980i32)) {
                    _adjustedOpcode_3649037 = (_opcode_3648923 - (@:checkr _r ?? throw "null pointer dereference")._opcodeBase : stdgo.GoInt);
                    @:check2r _r._advancePC((_adjustedOpcode_3649037 / (@:checkr _r ?? throw "null pointer dereference")._lineRange : stdgo.GoInt));
                    _lineDelta_3649123 = ((@:checkr _r ?? throw "null pointer dereference")._lineBase + (_adjustedOpcode_3649037 % (@:checkr _r ?? throw "null pointer dereference")._lineRange : stdgo.GoInt) : stdgo.GoInt);
                    (@:checkr _r ?? throw "null pointer dereference")._state.line = ((@:checkr _r ?? throw "null pointer dereference")._state.line + (_lineDelta_3649123) : stdgo.GoInt);
                    _gotoNext = 3651230i32;
                } else if (__value__ == (3649221i32)) {
                    _gotoNext = 3649221i32;
                    {
                        final __value__ = _opcode_3648923;
                        if (__value__ == ((0 : stdgo.GoInt))) {
                            _gotoNext = 3649238i32;
                        } else if (__value__ == ((1 : stdgo.GoInt))) {
                            _gotoNext = 3650297i32;
                        } else if (__value__ == ((2 : stdgo.GoInt))) {
                            _gotoNext = 3650325i32;
                        } else if (__value__ == ((3 : stdgo.GoInt))) {
                            _gotoNext = 3650379i32;
                        } else if (__value__ == ((4 : stdgo.GoInt))) {
                            _gotoNext = 3650437i32;
                        } else if (__value__ == ((5 : stdgo.GoInt))) {
                            _gotoNext = 3650507i32;
                        } else if (__value__ == ((6 : stdgo.GoInt))) {
                            _gotoNext = 3650565i32;
                        } else if (__value__ == ((7 : stdgo.GoInt))) {
                            _gotoNext = 3650622i32;
                        } else if (__value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 3650675i32;
                        } else if (__value__ == ((9 : stdgo.GoInt))) {
                            _gotoNext = 3650747i32;
                        } else if (__value__ == ((10 : stdgo.GoInt))) {
                            _gotoNext = 3650862i32;
                        } else if (__value__ == ((11 : stdgo.GoInt))) {
                            _gotoNext = 3650917i32;
                        } else if (__value__ == ((12 : stdgo.GoInt))) {
                            _gotoNext = 3650976i32;
                        } else {
                            _gotoNext = 3651028i32;
                        };
                    };
                } else if (__value__ == (3649238i32)) {
                    _length_3649286 = (@:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._uint() : stdgo._internal.debug.dwarf.Dwarf_offset.Offset);
                    _startOff_3649319 = (@:checkr _r ?? throw "null pointer dereference")._buf._off;
                    _opcode_3649343 = @:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._uint8();
                    _gotoNext = 3649370i32;
                } else if (__value__ == (3649370i32)) {
                    {
                        final __value__ = _opcode_3649343;
                        if (__value__ == ((1 : stdgo.GoUInt8))) {
                            _gotoNext = 3649388i32;
                        } else if (__value__ == ((2 : stdgo.GoUInt8))) {
                            _gotoNext = 3649480i32;
                        } else if (__value__ == ((3 : stdgo.GoUInt8))) {
                            _gotoNext = 3649798i32;
                        } else if (__value__ == ((4 : stdgo.GoUInt8))) {
                            _gotoNext = 3650057i32;
                        } else {
                            _gotoNext = 3650158i32;
                        };
                    };
                } else if (__value__ == (3649388i32)) {
                    ...
                    @:check2r _r._resetState();
                    _gotoNext = 3650158i32;
                } else if (__value__ == (3649480i32)) {
                    _gotoNext = 3649503i32;
                } else if (__value__ == (3649503i32)) {
                    {
                        final __value__ = (@:checkr _r ?? throw "null pointer dereference")._addrsize;
                        if (__value__ == ((1 : stdgo.GoInt))) {
                            _gotoNext = 3649526i32;
                        } else if (__value__ == ((2 : stdgo.GoInt))) {
                            _gotoNext = 3649581i32;
                        } else if (__value__ == ((4 : stdgo.GoInt))) {
                            _gotoNext = 3649637i32;
                        } else if (__value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 3649693i32;
                        } else {
                            _gotoNext = 3649741i32;
                        };
                    };
                } else if (__value__ == (3649526i32)) {
                    ...
                    _gotoNext = 3650158i32;
                } else if (__value__ == (3649693i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._state.address = @:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._uint64();
                    _gotoNext = 3650158i32;
                } else if (__value__ == (3649741i32)) {
                    @:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._error(("unknown address size" : stdgo.GoString));
                    _gotoNext = 3650158i32;
                } else if (__value__ == (3649798i32)) {
                    {
                        {
                            var __tmp__ = @:check2r _r._readFileEntry();
                            _done_3649824 = @:tmpset0 __tmp__._0;
                            _err_3649830 = @:tmpset0 __tmp__._1;
                        };
                        if (_err_3649830 != null) {
                            _gotoNext = 3649867i32;
                        } else if (_done_3649824) {
                            _gotoNext = 3649924i32;
                        } else {
                            _gotoNext = 3650039i32;
                        };
                    };
                } else if (__value__ == (3649867i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._buf._err = _err_3649830;
                    return false;
                    _gotoNext = 3650039i32;
                } else if (__value__ == (3649924i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._buf._err = stdgo.Go.asInterface((new stdgo._internal.debug.dwarf.Dwarf_decodeerror.DecodeError(("line" : stdgo.GoString), _startOff_3649319, ("malformed DW_LNE_define_file operation" : stdgo.GoString)) : stdgo._internal.debug.dwarf.Dwarf_decodeerror.DecodeError));
                    return false;
                    _gotoNext = 3650039i32;
                } else if (__value__ == (3650039i32)) {
                    @:check2r _r._updateFile();
                    _gotoNext = 3650158i32;
                } else if (__value__ == (3650057i32)) {
                    ...
                    _gotoNext = 3650158i32;
                } else if (__value__ == (3650158i32)) {
                    @:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._skip((((_startOff_3649319 + _length_3649286 : stdgo._internal.debug.dwarf.Dwarf_offset.Offset) - (@:checkr _r ?? throw "null pointer dereference")._buf._off : stdgo._internal.debug.dwarf.Dwarf_offset.Offset) : stdgo.GoInt));
                    if (_opcode_3649343 == ((1 : stdgo.GoUInt8))) {
                        _gotoNext = 3650236i32;
                    } else {
                        _gotoNext = 3651216i32;
                    };
                } else if (__value__ == (3650236i32)) {
                    return true;
                    _gotoNext = 3651216i32;
                } else if (__value__ == (3650297i32)) {
                    _gotoNext = 3651230i32;
                } else if (__value__ == (3650325i32)) {
                    @:check2r _r._advancePC((@:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._uint() : stdgo.GoInt));
                    _gotoNext = 3651216i32;
                } else if (__value__ == (3650379i32)) {
                    ...
                    _gotoNext = 3651216i32;
                } else if (__value__ == (3651028i32)) {
                    _i_3651149 = (0 : stdgo.GoInt);
                    _gotoNext = 3651145i32;
                } else if (__value__ == (3651145i32)) {
                    if ((_i_3651149 < (@:checkr _r ?? throw "null pointer dereference")._opcodeLengths[(_opcode_3648923 : stdgo.GoInt)] : Bool)) {
                        _gotoNext = 3651190i32;
                    } else {
                        _gotoNext = 3651216i32;
                    };
                } else if (__value__ == (3651190i32)) {
                    @:check2 (@:checkr _r ?? throw "null pointer dereference")._buf._uint();
                    _i_3651149++;
                    _gotoNext = 3651145i32;
                } else if (__value__ == (3651216i32)) {
                    return false;
                    _gotoNext = 3651230i32;
                } else if (__value__ == (3651230i32)) {
                    {
                        var __tmp__ = (@:checkr _r ?? throw "null pointer dereference")._state?.__copy__();
                        var x = (_entry : stdgo._internal.debug.dwarf.Dwarf_lineentry.LineEntry);
                        x.address = __tmp__?.address;
