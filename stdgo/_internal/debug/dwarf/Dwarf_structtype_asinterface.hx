...
class StructType_asInterface {
    @:keep
    @:tdfield
    public dynamic function defn():stdgo.GoString return @:_0 __self__.value.defn();
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.debug.dwarf.Dwarf_structtypepointer.StructTypePointer;
