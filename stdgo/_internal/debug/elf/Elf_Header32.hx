...
@:structInit class Header32 {
    public var ident : stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(16, 16, ...[for (i in 0 ... 16) (0 : stdgo.GoUInt8)]);
    ...
    public var phoff : stdgo.GoUInt32 = 0;
    public var shoff : stdgo.GoUInt32 = 0;
    ...
    public function new(?ident:stdgo.GoArray<stdgo.GoUInt8>, ?type:stdgo.GoUInt16, ?machine:stdgo.GoUInt16, ?version:stdgo.GoUInt32, ?entry:stdgo.GoUInt32, ?phoff:stdgo.GoUInt32, ?shoff:stdgo.GoUInt32, ?flags:stdgo.GoUInt32, ?ehsize:stdgo.GoUInt16, ?phentsize:stdgo.GoUInt16, ?phnum:stdgo.GoUInt16, ?shentsize:stdgo.GoUInt16, ?shnum:stdgo.GoUInt16, ?shstrndx:stdgo.GoUInt16) {
