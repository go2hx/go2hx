...
function newLineTable(_data:stdgo.Slice<stdgo.GoUInt8>, _text:stdgo.GoUInt64):stdgo.Ref<stdgo._internal.debug.gosym.Gosym_LineTable.LineTable> {
        return (stdgo.Go.setRef(({ data : _data, pc : _text, line : (0 : stdgo.GoInt), _funcNames : ({
            ...
            {};
            x;
        } : stdgo.GoMap<stdgo.GoUInt32, stdgo.GoString>), _strings : ({
            final x = new stdgo.GoMap.GoIntMap<stdgo.GoString>();
            x.__defaultValue__ = () -> ("" : stdgo.GoString);
            {};
            x;
        } : stdgo.GoMap<stdgo.GoUInt32, stdgo.GoString>) } : stdgo._internal.debug.gosym.Gosym_LineTable.LineTable)) : stdgo.Ref<stdgo._internal.debug.gosym.Gosym_LineTable.LineTable>);
    }
