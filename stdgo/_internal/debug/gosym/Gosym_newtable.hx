...
var __tmp__ = (_fname_3640487 != null && _fname_3640487.__exists__(_eltIdx) ? { _0 : _fname_3640487[_eltIdx], _1 : true } : { _0 : ("" : stdgo.GoString), _1 : false }), _elt:stdgo.GoString = __tmp__._0, _ok:Bool = __tmp__._1;
if (!_ok) {
