...
var __tmp__ = (_fname_3659535 != null && _fname_3659535.exists(_eltIdx) ? { _0 : _fname_3659535[_eltIdx], _1 : true } : { _0 : ("" : stdgo.GoString), _1 : false }), _elt:stdgo.GoString = __tmp__._0, _ok:Bool = __tmp__._1;
if (!_ok) {
...
_w++;
                        ...
                        };
                        {
                            ...
                            if (__value__ == ((84 : stdgo.GoUInt8)) || __value__ == ((116 : stdgo.GoUInt8)) || __value__ == ((76 : stdgo.GoUInt8)) || __value__ == ((108 : stdgo.GoUInt8))) {
                                ...
                                _fname_3659535[(_s._value : stdgo.GoUInt16)] = (@:checkr _ts ?? throw "null pointer dereference").name?.__copy__();
                            };
                        };
                        _lasttyp_3659615 = _s._typ;
                        return (null : stdgo.Error);
                    });
                    if (_err_3659370 != null) {
