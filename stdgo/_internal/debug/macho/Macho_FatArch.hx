...
@:structInit @:using(stdgo._internal.debug.macho.Macho_FatArch_static_extension.FatArch_static_extension) class FatArch {
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_dWARF():() -> { var _0 : stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_Data.Data>; var _1 : stdgo.Error; } return @:check3 (this.file ?? throw "null pointer derefrence").dWARF;
    public var importedLibraries(get, never) : () -> { var _0 : stdgo.Slice<stdgo.GoString>; var _1 : stdgo.Error; };
    @:embedded
    @:embeddededffieldsffun
    public function get_importedLibraries():() -> { var _0 : stdgo.Slice<stdgo.GoString>; var _1 : stdgo.Error; } return @:check3 (this.file ?? throw "null pointer derefrence").importedLibraries;
    public var importedSymbols(get, never) : () -> { var _0 : stdgo.Slice<stdgo.GoString>; var _1 : stdgo.Error; };
    @:embedded
    @:embeddededffieldsffun
    public function get_importedSymbols():() -> { var _0 : stdgo.Slice<stdgo.GoString>; var _1 : stdgo.Error; } return @:check3 (this.file ?? throw "null pointer derefrence").importedSymbols;
    public var section(get, never) : stdgo.GoString -> stdgo.Ref<stdgo._internal.debug.macho.Macho_Section.Section>;
    @:embedded
    @:embeddededffieldsffun
    public function get_section():stdgo.GoString -> stdgo.Ref<stdgo._internal.debug.macho.Macho_Section.Section> return @:check3 (this.file ?? throw "null pointer derefrence").section;
    public var segment(get, never) : stdgo.GoString -> stdgo.Ref<stdgo._internal.debug.macho.Macho_Segment.Segment>;
    @:embedded
    @:embeddededffieldsffun
    public function get_segment():stdgo.GoString -> stdgo.Ref<stdgo._internal.debug.macho.Macho_Segment.Segment> return @:check3 (this.file ?? throw "null pointer derefrence").segment;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get__parseSymtab():(stdgo.Slice<stdgo.GoUInt8>, stdgo.Slice<stdgo.GoUInt8>, stdgo.Slice<stdgo.GoUInt8>, stdgo.Ref<stdgo._internal.debug.macho.Macho_SymtabCmd.SymtabCmd>, stdgo.GoInt64) -> { var _0 : stdgo.Ref<stdgo._internal.debug.macho.Macho_Symtab.Symtab>; var _1 : stdgo.Error; } return @:check3 (this.file ?? throw "null pointer derefrence")._parseSymtab;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get__pushSection():(stdgo.Ref<stdgo._internal.debug.macho.Macho_Section.Section>, stdgo._internal.io.Io_ReaderAt.ReaderAt) -> stdgo.Error return @:check3 (this.file ?? throw "null pointer derefrence")._pushSection;
