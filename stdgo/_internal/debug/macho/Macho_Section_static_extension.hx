...
@:keep @:allow(stdgo._internal.debug.macho.Macho.Section_asInterface) class Section_static_extension {
    ...
    static public function data( _s:stdgo.Ref<stdgo._internal.debug.macho.Macho_Section.Section>):{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } {
        @:recv var _s:stdgo.Ref<stdgo._internal.debug.macho.Macho_Section.Section> = _s;
        return stdgo._internal.internal.saferio.Saferio_readDataAt.readDataAt(stdgo.Go.asInterface(_s._sr), _s.sectionHeader.size, (0i64 : stdgo.GoInt64));
    }
    @:embedded
    public static function readAt( __self__:stdgo._internal.debug.macho.Macho_Section.Section, _p:stdgo.Slice<stdgo.GoUInt8>, _off:stdgo.GoInt64):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } return __self__.readAt(_p, _off);
}
