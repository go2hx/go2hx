...
@:structInit class OptionalHeader64 {
    ...
    public var dataDirectory : stdgo.GoArray<stdgo._internal.debug.pe.Pe_DataDirectory.DataDirectory> = new stdgo.GoArray<stdgo._internal.debug.pe.Pe_DataDirectory.DataDirectory>(16, 16, ...[for (i in 0 ... 16) ({} : stdgo._internal.debug.pe.Pe_DataDirectory.DataDirectory)]);
