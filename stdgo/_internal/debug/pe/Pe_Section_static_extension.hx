...
@:keep @:allow(stdgo._internal.debug.pe.Pe.Section_asInterface) class Section_static_extension {
    ...
    @:embedded
    public static function readAt( __self__:stdgo._internal.debug.pe.Pe_Section.Section, _p:stdgo.Slice<stdgo.GoUInt8>, _off:stdgo.GoInt64):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } return __self__.readAt(_p, _off);
}
