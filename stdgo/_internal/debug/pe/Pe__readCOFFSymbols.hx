...
var _sym__pointer__ = (stdgo.Go.setRef(_sym) : stdgo.Ref<stdgo._internal.debug.pe.Pe_COFFSymbol.COFFSymbol>);
if (_naux == ((0 : stdgo.GoInt))) {
                    _err = stdgo._internal.encoding.binary.Binary_read.read(_r, stdgo.Go.asInterface(stdgo._internal.encoding.binary.Binary_littleEndian.littleEndian), stdgo.Go.toInterface(stdgo.Go.asInterface(_sym__pointer__)));
                    if (_err != null) {
