...
@:structInit @:using(stdgo._internal.debug.pe.Pe_optionalheader32_static_extension.OptionalHeader32_static_extension) class OptionalHeader32 {
    ...
    public var baseOfData : stdgo.GoUInt32 = 0;
    public var imageBase : stdgo.GoUInt32 = 0;
    ...
    public var sizeOfStackReserve : stdgo.GoUInt32 = 0;
    public var sizeOfStackCommit : stdgo.GoUInt32 = 0;
    public var sizeOfHeapReserve : stdgo.GoUInt32 = 0;
    public var sizeOfHeapCommit : stdgo.GoUInt32 = 0;
    ...
    public function new(?magic:stdgo.GoUInt16, ?majorLinkerVersion:stdgo.GoUInt8, ?minorLinkerVersion:stdgo.GoUInt8, ?sizeOfCode:stdgo.GoUInt32, ?sizeOfInitializedData:stdgo.GoUInt32, ?sizeOfUninitializedData:stdgo.GoUInt32, ?addressOfEntryPoint:stdgo.GoUInt32, ?baseOfCode:stdgo.GoUInt32, ?baseOfData:stdgo.GoUInt32, ?imageBase:stdgo.GoUInt32, ?sectionAlignment:stdgo.GoUInt32, ?fileAlignment:stdgo.GoUInt32, ?majorOperatingSystemVersion:stdgo.GoUInt16, ?minorOperatingSystemVersion:stdgo.GoUInt16, ?majorImageVersion:stdgo.GoUInt16, ?minorImageVersion:stdgo.GoUInt16, ?majorSubsystemVersion:stdgo.GoUInt16, ?minorSubsystemVersion:stdgo.GoUInt16, ?win32VersionValue:stdgo.GoUInt32, ?sizeOfImage:stdgo.GoUInt32, ?sizeOfHeaders:stdgo.GoUInt32, ?checkSum:stdgo.GoUInt32, ?subsystem:stdgo.GoUInt16, ?dllCharacteristics:stdgo.GoUInt16, ?sizeOfStackReserve:stdgo.GoUInt32, ?sizeOfStackCommit:stdgo.GoUInt32, ?sizeOfHeapReserve:stdgo.GoUInt32, ?sizeOfHeapCommit:stdgo.GoUInt32, ?loaderFlags:stdgo.GoUInt32, ?numberOfRvaAndSizes:stdgo.GoUInt32, ?dataDirectory:stdgo.GoArray<stdgo._internal.debug.pe.Pe_datadirectory.DataDirectory>) {
        ...
        if (baseOfData != null) this.baseOfData = baseOfData;
