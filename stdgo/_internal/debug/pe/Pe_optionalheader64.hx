...
@:structInit @:using(stdgo._internal.debug.pe.Pe_optionalheader64_static_extension.OptionalHeader64_static_extension) class OptionalHeader64 {
    ...
    public var dataDirectory : stdgo.GoArray<stdgo._internal.debug.pe.Pe_datadirectory.DataDirectory> = new stdgo.GoArray<stdgo._internal.debug.pe.Pe_datadirectory.DataDirectory>(16, 16, ...[for (i in 0 ... (16 > 16 ? 16 : 16 : stdgo.GoInt).toBasic()) ({} : stdgo._internal.debug.pe.Pe_datadirectory.DataDirectory)]).__setNil__();
