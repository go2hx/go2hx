...
function decode(_dst:stdgo.Slice<stdgo.GoUInt8>, _src:stdgo.Slice<stdgo.GoUInt8>, _flush:Bool):{ var _0 : stdgo.GoInt; var _1 : stdgo.GoInt; var _2 : stdgo.Error; } {
        ...
        for (_i => _b in _src) {
            ...
            if ((_b <= (32 : stdgo.GoUInt8) : Bool)) {
                ...
                return { _0 : (0 : stdgo.GoInt), _1 : (0 : stdgo.GoInt), _2 : stdgo.Go.asInterface((_i : stdgo._internal.encoding.ascii85.Ascii85_CorruptInputError.CorruptInputError)) };
            };
        ...
        if (_flush) {
            ...
            if ((_nb > (0 : stdgo.GoInt) : Bool)) {
                if (_nb == ((1 : stdgo.GoInt))) {
                    return { _0 : (0 : stdgo.GoInt), _1 : (0 : stdgo.GoInt), _2 : stdgo.Go.asInterface((_src.length : stdgo._internal.encoding.ascii85.Ascii85_CorruptInputError.CorruptInputError)) };
                };
                {
