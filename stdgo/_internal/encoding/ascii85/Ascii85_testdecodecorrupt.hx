...
function testDecodeCorrupt(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/ascii85/ascii85_test.go#L160"
        for (__0 => _e in _examples) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/encoding/ascii85/ascii85_test.go#L163"
            {
                final __type__ = _err;
                if (stdgo.Go.typeEquals((__type__ : stdgo._internal.encoding.ascii85.Ascii85_corruptinputerror.CorruptInputError))) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/encoding/ascii85/ascii85_test.go#L165"
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/encoding/ascii85/ascii85_test.go#L167"
                    _t.error(stdgo.Go.toInterface(("Decoder failed to detect corruption in" : stdgo.GoString)), stdgo.Go.toInterface(stdgo.Go.asInterface(_e)));
                };
            };
        };
    }
