...
function _getUniversalType(_t:stdgo._internal.reflect.Reflect_type_.Type_):{ var _0 : Bool; var _1 : stdgo.GoInt; var _2 : Bool; var _3 : Bool; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L152"
        {
            final __value__ = _t;
            if ((__value__.string() : String) == (stdgo._internal.encoding.asn1.Asn1__rawvaluetype._rawValueType.string() : String)) {
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L154"
                return {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L156"
                return {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L158"
                return {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L160"
                return {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L162"
                return {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L164"
                return {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L166"
        {
            final __value__ = _t.kind();
            if (__value__ == ((1u32 : stdgo._internal.reflect.Reflect_kind.Kind))) {
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L168"
                return {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L170"
                return {
                    @:typeReturnStmt2 final __tmp__:{ var _0 : Bool; var _1 : stdgo.GoInt; var _2 : Bool; var _3 : Bool; } = { _0 : false, _1 : (2 : stdgo.GoInt), _2 : false, _3 : true };
                    _matchAny = __tmp__._0;
                    _tagNumber = __tmp__._1;
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L172"
                return {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L174"
                if (_t.elem().kind() == ((8u32 : stdgo._internal.reflect.Reflect_kind.Kind))) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L175"
                    return {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L177"
                if (stdgo._internal.strings.Strings_hassuffix.hasSuffix(_t.name()?.__copy__(), ("SET" : stdgo.GoString))) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L178"
                    return {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L180"
                return {
                    @:typeReturnStmt2 final __tmp__:{ var _0 : Bool; var _1 : stdgo.GoInt; var _2 : Bool; var _3 : Bool; } = { _0 : false, _1 : (16 : stdgo.GoInt), _2 : true, _3 : true };
                    _matchAny = __tmp__._0;
                    _tagNumber = __tmp__._1;
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L182"
                return {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L184"
        return {
