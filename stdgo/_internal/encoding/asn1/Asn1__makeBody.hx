...
function _makeBody(_value:stdgo._internal.reflect.Reflect_Value.Value, _params:stdgo._internal.encoding.asn1.Asn1_T_fieldParameters.T_fieldParameters):{ var _0 : stdgo._internal.encoding.asn1.Asn1_T_encoder.T_encoder; var _1 : stdgo.Error; } {
        var _e = (null : stdgo._internal.encoding.asn1.Asn1_T_encoder.T_encoder), _err = (null : stdgo.Error);
        {
            ...
            if ((__value__.string() : String) == (stdgo._internal.encoding.asn1.Asn1__flagType._flagType.string() : String)) {
                return { _0 : _e = stdgo.Go.asInterface((new stdgo._internal.encoding.asn1.Asn1_T_bytesEncoder.T_bytesEncoder(0, 0) : stdgo._internal.encoding.asn1.Asn1_T_bytesEncoder.T_bytesEncoder)), _1 : _err = (null : stdgo.Error) };
                ...
                if (((_params._timeType == (24 : stdgo.GoInt)) || stdgo._internal.encoding.asn1.Asn1__outsideUTCRange._outsideUTCRange(_t?.__copy__()) : Bool)) {
                    return {
                        var __tmp__ = stdgo._internal.encoding.asn1.Asn1__makeGeneralizedTime._makeGeneralizedTime(_t?.__copy__());
                        _e = __tmp__._0;
                        _err = __tmp__._1;
                        __tmp__;
                    };
                ...
                return {
                    var __tmp__ = stdgo._internal.encoding.asn1.Asn1__makeUTCTime._makeUTCTime(_t?.__copy__());
                    _e = __tmp__._0;
                    _err = __tmp__._1;
                    __tmp__;
                };
            } else if ((__value__.string() : String) == (stdgo._internal.encoding.asn1.Asn1__bitStringType._bitStringType.string() : String)) {
                return { _0 : _e = stdgo.Go.asInterface((({
                ...
                return {
                    var __tmp__ = stdgo._internal.encoding.asn1.Asn1__makeObjectIdentifier._makeObjectIdentifier((stdgo.Go.typeAssert((_value.interface_() : stdgo._internal.encoding.asn1.Asn1_ObjectIdentifier.ObjectIdentifier)) : stdgo._internal.encoding.asn1.Asn1_ObjectIdentifier.ObjectIdentifier));
                    _e = __tmp__._0;
                    _err = __tmp__._1;
                    __tmp__;
                };
                ...
                return {
                    var __tmp__ = stdgo._internal.encoding.asn1.Asn1__makeBigInt._makeBigInt((stdgo.Go.typeAssert((_value.interface_() : stdgo.Ref<stdgo._internal.math.big.Big_Int_.Int_>)) : stdgo.Ref<stdgo._internal.math.big.Big_Int_.Int_>));
                    _e = __tmp__._0;
                    _err = __tmp__._1;
                    __tmp__;
                };
        ...
        };
        {
            var _v = (_value?.__copy__() : stdgo._internal.reflect.Reflect_Value.Value);
            {
                ...
                if (__value__ == ((1u32 : stdgo._internal.reflect.Reflect_Kind.Kind))) {
                    if (_v.bool_()) {
                        return { _0 : _e = stdgo._internal.encoding.asn1.Asn1__byteFFEncoder._byteFFEncoder, _1 : _err = (null : stdgo.Error) };
                    };
                    return { _0 : _e = stdgo._internal.encoding.asn1.Asn1__byte00Encoder._byte00Encoder, _1 : _err = (null : stdgo.Error) };
                    ...
                    return { _0 : _e = stdgo.Go.asInterface((_v.int_() : stdgo._internal.encoding.asn1.Asn1_T_int64Encoder.T_int64Encoder)), _1 : _err = (null : stdgo.Error) };
                    ...
                    var _t = (_v.type() : stdgo._internal.reflect.Reflect_Type_.Type_);
                    {
                        ...
                        while ((_i < _t.numField() : Bool)) {
                            if (!_t.field(_i).isExported()) {
                                return { _0 : _e = (null : stdgo._internal.encoding.asn1.Asn1_T_encoder.T_encoder), _1 : _err = stdgo.Go.asInterface((new stdgo._internal.encoding.asn1.Asn1_StructuralError.StructuralError(("struct contains unexported fields" : stdgo.GoString)) : stdgo._internal.encoding.asn1.Asn1_StructuralError.StructuralError)) };
                            };
                            _i++;
                        };
                    };
                    ...
                    if ((_t.field((0 : stdgo.GoInt)).type.string() : String) == (stdgo._internal.encoding.asn1.Asn1__rawContentsType._rawContentsType.string() : String)) {
                        ...
                        if ((_s.len() > (0 : stdgo.GoInt) : Bool)) {
                            var _bytes = _s.bytes();
                            return { _0 : _e = stdgo.Go.asInterface((stdgo._internal.encoding.asn1.Asn1__stripTagAndLength._stripTagAndLength(_bytes) : stdgo._internal.encoding.asn1.Asn1_T_bytesEncoder.T_bytesEncoder)), _1 : _err = (null : stdgo.Error) };
                        };
                    ...
                    };
                    {
                        var _n1 = (_n - _startingField : stdgo.GoInt);
                        {
                            ...
                            if (__value__ == ((0 : stdgo.GoInt))) {
                                ...
                                return {
                                    var __tmp__ = stdgo._internal.encoding.asn1.Asn1__makeField._makeField(_v.field(_startingField)?.__copy__(), stdgo._internal.encoding.asn1.Asn1__parseFieldParameters._parseFieldParameters(_t.field(_startingField).tag.get(("asn1" : stdgo.GoString))?.__copy__())?.__copy__());
                                    _e = __tmp__._0;
                                    _err = __tmp__._1;
                                    __tmp__;
                                };
...
if (_err != null) {
                                ...
                                return { _0 : _e = stdgo.Go.asInterface((_m : stdgo._internal.encoding.asn1.Asn1_T_multiEncoder.T_multiEncoder)), _1 : _err = (null : stdgo.Error) };
                            };
                        };
                    };
                    ...
                    if (_sliceType.elem().kind() == ((8u32 : stdgo._internal.reflect.Reflect_Kind.Kind))) {
                        return { _0 : _e = stdgo.Go.asInterface((_v.bytes() : stdgo._internal.encoding.asn1.Asn1_T_bytesEncoder.T_bytesEncoder)), _1 : _err = (null : stdgo.Error) };
                    };
                    var _fp:stdgo._internal.encoding.asn1.Asn1_T_fieldParameters.T_fieldParameters = ({} : stdgo._internal.encoding.asn1.Asn1_T_fieldParameters.T_fieldParameters);
                    {
                        var _l = (_v.len() : stdgo.GoInt);
                        {
                            ...
                            if (__value__ == ((0 : stdgo.GoInt))) {
                                ...
                                return {
                                    var __tmp__ = stdgo._internal.encoding.asn1.Asn1__makeField._makeField(_v.index((0 : stdgo.GoInt))?.__copy__(), _fp?.__copy__());
                                    _e = __tmp__._0;
                                    _err = __tmp__._1;
                                    __tmp__;
                                };
...
if (_err != null) {
                                ...
                                if (_params._set) {
                                    return { _0 : _e = stdgo.Go.asInterface((_m : stdgo._internal.encoding.asn1.Asn1_T_setEncoder.T_setEncoder)), _1 : _err = (null : stdgo.Error) };
                                };
                                return { _0 : _e = stdgo.Go.asInterface((_m : stdgo._internal.encoding.asn1.Asn1_T_multiEncoder.T_multiEncoder)), _1 : _err = (null : stdgo.Error) };
                            };
                        };
                ...
                } else if (__value__ == ((24u32 : stdgo._internal.reflect.Reflect_Kind.Kind))) {
                    {
                        ...
                        if (__value__ == ((22 : stdgo.GoInt))) {
                            return {
                                var __tmp__ = stdgo._internal.encoding.asn1.Asn1__makeIA5String._makeIA5String((_v.string() : stdgo.GoString)?.__copy__());
                                _e = __tmp__._0;
                                _err = __tmp__._1;
                                __tmp__;
                            };
                            ...
                            return {
                                var __tmp__ = stdgo._internal.encoding.asn1.Asn1__makePrintableString._makePrintableString((_v.string() : stdgo.GoString)?.__copy__());
                                _e = __tmp__._0;
                                _err = __tmp__._1;
                                __tmp__;
                            };
                            ...
                            return {
                                var __tmp__ = stdgo._internal.encoding.asn1.Asn1__makeNumericString._makeNumericString((_v.string() : stdgo.GoString)?.__copy__());
                                _e = __tmp__._0;
                                _err = __tmp__._1;
                                __tmp__;
                            };
                        } else {
                            return { _0 : _e = stdgo._internal.encoding.asn1.Asn1__makeUTF8String._makeUTF8String((_v.string() : stdgo.GoString)?.__copy__()), _1 : _err = (null : stdgo.Error) };
                        };
                    };
                };
            };
        };
        return { _0 : _e = (null : stdgo._internal.encoding.asn1.Asn1_T_encoder.T_encoder), _1 : _err = stdgo.Go.asInterface((new stdgo._internal.encoding.asn1.Asn1_StructuralError.StructuralError(("unknown Go type" : stdgo.GoString)) : stdgo._internal.encoding.asn1.Asn1_StructuralError.StructuralError)) };
    }
