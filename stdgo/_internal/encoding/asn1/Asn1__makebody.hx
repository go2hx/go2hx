        ...
        var _e = (null : stdgo._internal.encoding.asn1.Asn1_t_encoder.T_encoder), _err = (null : stdgo.Error);
        {
            ...
            if ((__value__.string() : String) == (stdgo._internal.encoding.asn1.Asn1__flagtype._flagType.string() : String)) {
                ...
                if (((_params._timeType == (24 : stdgo.GoInt)) || stdgo._internal.encoding.asn1.Asn1__outsideutcrange._outsideUTCRange(_t?.__copy__()) : Bool)) {
                    return ({
                        @:assignTranslate final __tmp__ = stdgo._internal.encoding.asn1.Asn1__makegeneralizedtime._makeGeneralizedTime(_t?.__copy__());
                        { _0 : __tmp__._0, _1 : __tmp__._1 };
                    });
                };
                return ({
                    @:assignTranslate final __tmp__ = stdgo._internal.encoding.asn1.Asn1__makeutctime._makeUTCTime(_t?.__copy__());
                    { _0 : __tmp__._0, _1 : __tmp__._1 };
                });
                ...
                return ({
                    @:assignTranslate final __tmp__ = stdgo._internal.encoding.asn1.Asn1__makeobjectidentifier._makeObjectIdentifier((stdgo.Go.typeAssert((_value.interface_() : stdgo._internal.encoding.asn1.Asn1_objectidentifier.ObjectIdentifier)) : stdgo._internal.encoding.asn1.Asn1_objectidentifier.ObjectIdentifier));
                    { _0 : __tmp__._0, _1 : __tmp__._1 };
                });
            } else if ((__value__.string() : String) == (stdgo._internal.encoding.asn1.Asn1__biginttype._bigIntType.string() : String)) {
                return ({
                    @:assignTranslate final __tmp__ = stdgo._internal.encoding.asn1.Asn1__makebigint._makeBigInt((stdgo.Go.typeAssert((_value.interface_() : stdgo.Ref<stdgo._internal.math.big.Big_int_.Int_>)) : stdgo.Ref<stdgo._internal.math.big.Big_int_.Int_>));
                    { _0 : __tmp__._0, _1 : __tmp__._1 };
                });
            };
        };
                    ...
                    };
                    {
                        var _n1 = (_n - _startingField : stdgo.GoInt);
                        {
                            ...
                            if (__value__ == ((0 : stdgo.GoInt))) {
                                ...
                                return ({
                                    @:assignTranslate final __tmp__ = stdgo._internal.encoding.asn1.Asn1__makefield._makeField(_v.field(_startingField)?.__copy__(), stdgo._internal.encoding.asn1.Asn1__parsefieldparameters._parseFieldParameters(_t.field(_startingField).tag.get(("asn1" : stdgo.GoString))?.__copy__())?.__copy__());
                                    { _0 : __tmp__._0, _1 : __tmp__._1 };
                                });
                            } else {
                    ...
                    var _fp:stdgo._internal.encoding.asn1.Asn1_t_fieldparameters.T_fieldParameters = ({} : stdgo._internal.encoding.asn1.Asn1_t_fieldparameters.T_fieldParameters);
                    {
                        var _l = (_v.len() : stdgo.GoInt);
                        {
                            ...
                            if (__value__ == ((0 : stdgo.GoInt))) {
                                ...
                                return ({
                                    @:assignTranslate final __tmp__ = stdgo._internal.encoding.asn1.Asn1__makefield._makeField(_v.index((0 : stdgo.GoInt))?.__copy__(), _fp?.__copy__());
                                    { _0 : __tmp__._0, _1 : __tmp__._1 };
                                });
                            } else {
...
if (_err != null) {
                ...
                } else if (__value__ == ((24u32 : stdgo._internal.reflect.Reflect_kind.Kind))) {
                    {
                        ...
                        if (__value__ == ((22 : stdgo.GoInt))) {
                            return ({
                                @:assignTranslate final __tmp__ = stdgo._internal.encoding.asn1.Asn1__makeia5string._makeIA5String((_v.string() : stdgo.GoString)?.__copy__());
                                { _0 : __tmp__._0, _1 : __tmp__._1 };
                            });
                        } else if (__value__ == ((19 : stdgo.GoInt))) {
                            return ({
                                @:assignTranslate final __tmp__ = stdgo._internal.encoding.asn1.Asn1__makeprintablestring._makePrintableString((_v.string() : stdgo.GoString)?.__copy__());
                                { _0 : __tmp__._0, _1 : __tmp__._1 };
                            });
                        } else if (__value__ == ((18 : stdgo.GoInt))) {
                            return ({
                                @:assignTranslate final __tmp__ = stdgo._internal.encoding.asn1.Asn1__makenumericstring._makeNumericString((_v.string() : stdgo.GoString)?.__copy__());
                                { _0 : __tmp__._0, _1 : __tmp__._1 };
                            });
                        } else {
                            return {
