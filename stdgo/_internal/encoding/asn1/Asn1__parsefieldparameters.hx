...
function _parseFieldParameters(_str:stdgo.GoString):stdgo._internal.encoding.asn1.Asn1_t_fieldparameters.T_fieldParameters {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L96"
        while (((_str.length) > (0 : stdgo.GoInt) : Bool)) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L98"
            if (_part == (("optional" : stdgo.GoString))) {
                _ret._optional = true;
            } else if (_part == (("explicit" : stdgo.GoString))) {
                _ret._explicit = true;
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L103"
                if (_ret._tag == null) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L120"
                if (_err == null) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L126"
                if (_err == null) {
                    _ret._tag = stdgo.Go.pointer((0 : stdgo.GoInt));
                    _ret._tag.value = _i;
                };
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L134"
                if (_ret._tag == null) {
                    _ret._tag = stdgo.Go.pointer((0 : stdgo.GoInt));
                };
            } else if (_part == (("private" : stdgo.GoString))) {
                _ret._private = true;
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L139"
                if (_ret._tag == null) {
                    _ret._tag = stdgo.Go.pointer((0 : stdgo.GoInt));
                };
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/common.go#L146"
        return _ret;
    }
