...
function _parseSequenceOf(_bytes:stdgo.Slice<stdgo.GoUInt8>, _sliceType:stdgo._internal.reflect.Reflect_type_.Type_, _elemType:stdgo._internal.reflect.Reflect_type_.Type_):{ var _0 : stdgo._internal.reflect.Reflect_value.Value; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/asn1.go#L610"
        if (!_ok) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/asn1.go#L612"
            return { _0 : _ret, _1 : _err };
        };
        var _numElements = (0 : stdgo.GoInt);
        //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/asn1.go#L618"
        {
            ...
            while ((_offset < (_bytes.length) : Bool)) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/asn1.go#L621"
                if (_err != null) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/asn1.go#L622"
                    return { _0 : _ret, _1 : _err };
                };
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/asn1.go#L624"
                {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/asn1.go#L635"
                if ((!_matchAny && (((_t._class != ((0 : stdgo.GoInt)) || _t._isCompound != (_compoundType) : Bool) || (_t._tag != _expectedTag) : Bool)) : Bool)) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/asn1.go#L637"
                    return { _0 : _ret, _1 : _err };
                };
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/asn1.go#L639"
                if (stdgo._internal.encoding.asn1.Asn1__invalidlength._invalidLength(_offset, _t._length, (_bytes.length))) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/asn1.go#L641"
                    return { _0 : _ret, _1 : _err };
                };
                _offset = (_offset + (_t._length) : stdgo.GoInt);
                //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/asn1.go#L644"
                _numElements++;
            };
        };
        ...
        var _offset = (0 : stdgo.GoInt);
        //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/asn1.go#L649"
        {
...
//"file:///home/runner/.go/go1.21.3/src/encoding/asn1/asn1.go#L651"
                if (_err != null) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/asn1.go#L652"
                    return { _0 : _ret, _1 : _err };
                };
                _i++;
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/encoding/asn1/asn1.go#L655"
        return { _0 : _ret, _1 : _err };
    }
