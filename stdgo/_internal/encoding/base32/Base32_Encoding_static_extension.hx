...
@:keep @:allow(stdgo._internal.encoding.base32.Base32.Encoding_asInterface) class Encoding_static_extension {
    ...
    static public function _decode( _enc:stdgo.Ref<stdgo._internal.encoding.base32.Base32_Encoding.Encoding>, _dst:stdgo.Slice<stdgo.GoUInt8>, _src:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.GoInt; var _1 : Bool; var _2 : stdgo.Error; } {
        ...
        while ((((_src.length) > (0 : stdgo.GoInt) : Bool) && !_end : Bool)) {
            var _dbuf:stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(8, 8, ...[for (i in 0 ... 8) (0 : stdgo.GoUInt8)]);
    ...
    static public function encode( _enc:stdgo.Ref<stdgo._internal.encoding.base32.Base32_Encoding.Encoding>, _dst:stdgo.Slice<stdgo.GoUInt8>, _src:stdgo.Slice<stdgo.GoUInt8>):Void {
        ...
        while (((_src.length) > (0 : stdgo.GoInt) : Bool)) {
            ...
            if ((_size >= (8 : stdgo.GoInt) : Bool)) {
                _dst[(0 : stdgo.GoInt)] = _enc._encode[((_b[(0 : stdgo.GoInt)] & (31 : stdgo.GoUInt8) : stdgo.GoUInt8) : stdgo.GoInt)];
                _dst[(1 : stdgo.GoInt)] = _enc._encode[((_b[(1 : stdgo.GoInt)] & (31 : stdgo.GoUInt8) : stdgo.GoUInt8) : stdgo.GoInt)];
                _dst[(2 : stdgo.GoInt)] = _enc._encode[((_b[(2 : stdgo.GoInt)] & (31 : stdgo.GoUInt8) : stdgo.GoUInt8) : stdgo.GoInt)];
                _dst[(3 : stdgo.GoInt)] = _enc._encode[((_b[(3 : stdgo.GoInt)] & (31 : stdgo.GoUInt8) : stdgo.GoUInt8) : stdgo.GoInt)];
                _dst[(4 : stdgo.GoInt)] = _enc._encode[((_b[(4 : stdgo.GoInt)] & (31 : stdgo.GoUInt8) : stdgo.GoUInt8) : stdgo.GoInt)];
                _dst[(5 : stdgo.GoInt)] = _enc._encode[((_b[(5 : stdgo.GoInt)] & (31 : stdgo.GoUInt8) : stdgo.GoUInt8) : stdgo.GoInt)];
                _dst[(6 : stdgo.GoInt)] = _enc._encode[((_b[(6 : stdgo.GoInt)] & (31 : stdgo.GoUInt8) : stdgo.GoUInt8) : stdgo.GoInt)];
                _dst[(7 : stdgo.GoInt)] = _enc._encode[((_b[(7 : stdgo.GoInt)] & (31 : stdgo.GoUInt8) : stdgo.GoUInt8) : stdgo.GoInt)];
            } else {
                {
            ...
            if (((_src.length) < (5 : stdgo.GoInt) : Bool)) {
                ...
                _dst[(7 : stdgo.GoInt)] = (_enc._padChar : stdgo.GoUInt8);
                if (((_src.length) < (4 : stdgo.GoInt) : Bool)) {
                    _dst[(6 : stdgo.GoInt)] = (_enc._padChar : stdgo.GoUInt8);
                    _dst[(5 : stdgo.GoInt)] = (_enc._padChar : stdgo.GoUInt8);
                    if (((_src.length) < (3 : stdgo.GoInt) : Bool)) {
                        _dst[(4 : stdgo.GoInt)] = (_enc._padChar : stdgo.GoUInt8);
                        if (((_src.length) < (2 : stdgo.GoInt) : Bool)) {
                            _dst[(3 : stdgo.GoInt)] = (_enc._padChar : stdgo.GoUInt8);
                            _dst[(2 : stdgo.GoInt)] = (_enc._padChar : stdgo.GoUInt8);
                        };
                    };
                };
                break;
