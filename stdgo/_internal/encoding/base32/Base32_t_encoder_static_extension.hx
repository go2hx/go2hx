...
@:keep @:allow(stdgo._internal.encoding.base32.Base32.T_encoder_asInterface) class T_encoder_static_extension {
    ...
    static public function close( _e:stdgo.Ref<stdgo._internal.encoding.base32.Base32_t_encoder.T_encoder>):stdgo.Error {
        ...
        if ((((@:checkr _e ?? throw "null pointer dereference")._err == null) && ((@:checkr _e ?? throw "null pointer dereference")._nbuf > (0 : stdgo.GoInt) : Bool) : Bool)) {
            @:check2r (@:checkr _e ?? throw "null pointer dereference")._enc.encode(((@:checkr _e ?? throw "null pointer dereference")._out.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>), ((@:checkr _e ?? throw "null pointer dereference")._buf.__slice__((0 : stdgo.GoInt), (@:checkr _e ?? throw "null pointer dereference")._nbuf) : stdgo.Slice<stdgo.GoUInt8>));
            var _encodedLen = (@:check2r (@:checkr _e ?? throw "null pointer dereference")._enc.encodedLen((@:checkr _e ?? throw "null pointer dereference")._nbuf) : stdgo.GoInt);
...
(@:checkr _e ?? throw "null pointer dereference")._nbuf++;
            ...
            @:check2r (@:checkr _e ?? throw "null pointer dereference")._enc.encode(((@:checkr _e ?? throw "null pointer dereference")._out.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>), ((@:checkr _e ?? throw "null pointer dereference")._buf.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
            {
                {
        ...
        while (((_p.length) >= (5 : stdgo.GoInt) : Bool)) {
            ...
            @:check2r (@:checkr _e ?? throw "null pointer dereference")._enc.encode(((@:checkr _e ?? throw "null pointer dereference")._out.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>), (_p.__slice__((0 : stdgo.GoInt), _nn) : stdgo.Slice<stdgo.GoUInt8>));
            {
                {
