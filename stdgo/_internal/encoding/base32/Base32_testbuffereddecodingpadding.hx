...
function testBufferedDecodingPadding(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/base32/base32_test.go#L661"
        for (__0 => _testcase in _testcases) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/encoding/base32/base32_test.go#L664"
            stdgo.Go.routine(() -> ({
                var a = function():Void {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/base32/base32_test.go#L665"
                    for (__1 => _chunk in _testcase._chunks) {
                        _pw.write((_chunk : stdgo.Slice<stdgo.GoUInt8>));
                    };
                    _pw.close();
                };
                a();
            ...
            //"file:///home/runner/.go/go1.21.3/src/encoding/base32/base32_test.go#L674"
            if (((_err == null) && (_testcase._expectedError.length != (0 : stdgo.GoInt)) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/encoding/base32/base32_test.go#L675"
                _t.errorf(("case %q: got nil error, want %v" : stdgo.GoString), stdgo.Go.toInterface(_testcase._chunks), stdgo.Go.toInterface(_testcase._expectedError));
            } else if (_err.error() != (_testcase._expectedError)) {
                //"file:///home/runner/.go/go1.21.3/src/encoding/base32/base32_test.go#L677"
                _t.errorf(("case %q: got %v, want %v" : stdgo.GoString), stdgo.Go.toInterface(_testcase._chunks), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(_testcase._expectedError));
            };
        };
    }
