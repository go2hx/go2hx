...
({ _input : ("AAAAAAAA" : stdgo.GoString), _offset : (-1 : stdgo.GoInt) } : stdgo._internal.encoding.base32.Base32_t__struct_1.T__struct_1)].concat([for (i in 23 ... (23 > 23 ? 23 : 23 : stdgo.GoInt).toBasic()) ({ _input : ("" : stdgo.GoString), _offset : (0 : stdgo.GoInt) } : stdgo._internal.encoding.base32.Base32_t__struct_1.T__struct_1)])) : stdgo.Slice<stdgo._internal.encoding.base32.Base32_t__struct_1.T__struct_1>);
        //"file:///home/runner/.go/go1.21.3/src/encoding/base32/base32_test.go#L328"
        for (__0 => _tc in _testCases) {
            var _dbuf = (new stdgo.Slice<stdgo.GoUInt8>((stdgo._internal.encoding.base32.Base32_stdencoding.stdEncoding.decodedLen((_tc._input.length)) : stdgo.GoInt).toBasic(), 0).__setNumber32__() : stdgo.Slice<stdgo.GoUInt8>);
            var __tmp__ = stdgo._internal.encoding.base32.Base32_stdencoding.stdEncoding.decode(_dbuf, (_tc._input : stdgo.Slice<stdgo.GoUInt8>)), __1:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            //"file:///home/runner/.go/go1.21.3/src/encoding/base32/base32_test.go#L331"
            if (_tc._offset == ((-1 : stdgo.GoInt))) {
                //"file:///home/runner/.go/go1.21.3/src/encoding/base32/base32_test.go#L332"
                if (_err != null) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/base32/base32_test.go#L333"
                    _t.error(stdgo.Go.toInterface(("Decoder wrongly detected corruption in" : stdgo.GoString)), stdgo.Go.toInterface(_tc._input));
                };
                //"file:///home/runner/.go/go1.21.3/src/encoding/base32/base32_test.go#L335"
                continue;
            };
            //"file:///home/runner/.go/go1.21.3/src/encoding/base32/base32_test.go#L337"
            {
                final __type__ = _err;
                if (stdgo.Go.typeEquals((__type__ : stdgo._internal.encoding.base32.Base32_corruptinputerror.CorruptInputError))) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/encoding/base32/base32_test.go#L339"
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/encoding/base32/base32_test.go#L341"
