...
function testDecoderError(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        //"file:///home/runner/.go/go1.21.3/src/encoding/base32/base32_test.go#L249"
        for (__0 => _readErr in (new stdgo.Slice<stdgo.Error>(2, 2, ...[stdgo._internal.io.Io_eof.eOF, (null : stdgo.Error)]) : stdgo.Slice<stdgo.Error>)) {
            ...
            var _dbuf = (new stdgo.Slice<stdgo.GoUInt8>((stdgo._internal.encoding.base32.Base32_stdencoding.stdEncoding.decodedLen((_input.length)) : stdgo.GoInt).toBasic(), 0).__setNumber32__() : stdgo.Slice<stdgo.GoUInt8>);
            ...
            //"file:///home/runner/.go/go1.21.3/src/encoding/base32/base32_test.go#L255"
            ...
            //"file:///home/runner/.go/go1.21.3/src/encoding/base32/base32_test.go#L256"
            {
                var __tmp__ = try {
                ...
                if (!_ok) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/base32/base32_test.go#L257"
                    _t.errorf(("Corrupt input error expected.  Found %T" : stdgo.GoString), stdgo.Go.toInterface(_err));
                };
            };
        };
    }
