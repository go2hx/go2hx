...
function testWithCustomPadding(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        for (__0 => _testcase in stdgo._internal.encoding.base32.Base32__pairs._pairs) {
            ...
            var _customPadding = (@:check2r (@:checkr stdgo._internal.encoding.base32.Base32_stdencoding.stdEncoding ?? throw "null pointer dereference").withPadding((64 : stdgo.GoInt32)).encodeToString((_testcase._decoded : stdgo.Slice<stdgo.GoUInt8>))?.__copy__() : stdgo.GoString);
