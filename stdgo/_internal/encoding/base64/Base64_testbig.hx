...
function testBig(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        {};
        //"file:///home/runner/.go/go1.21.3/src/encoding/base64/base64_test.go#L313"
        {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/base64/base64_test.go#L319"
        if (((_nn != _n) || (_err != null) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/encoding/base64/base64_test.go#L320"
        ...
        _err = _w.close();
        //"file:///home/runner/.go/go1.21.3/src/encoding/base64/base64_test.go#L323"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/encoding/base64/base64_test.go#L324"
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/base64/base64_test.go#L327"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/encoding/base64/base64_test.go#L328"
            _t.fatalf(("io.ReadAll(NewDecoder(...)): %v" : stdgo.GoString), stdgo.Go.toInterface(_err));
        };
        //"file:///home/runner/.go/go1.21.3/src/encoding/base64/base64_test.go#L331"
        if (!stdgo._internal.bytes.Bytes_equal.equal(_raw, _decoded)) {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            //"file:///home/runner/.go/go1.21.3/src/encoding/base64/base64_test.go#L333"
            {
                _i = (0 : stdgo.GoInt);
                while (((_i < (_decoded.length) : Bool) && (_i < (_raw.length) : Bool) : Bool)) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/base64/base64_test.go#L334"
                    if (_decoded[(_i : stdgo.GoInt)] != (_raw[(_i : stdgo.GoInt)])) {
                        //"file:///home/runner/.go/go1.21.3/src/encoding/base64/base64_test.go#L335"
                        break;
                    };
                    _i++;
                };
            };
            //"file:///home/runner/.go/go1.21.3/src/encoding/base64/base64_test.go#L338"
