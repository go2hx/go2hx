...
function testDecoder(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        //"file:///home/runner/.go/go1.21.3/src/encoding/base64/base64_test.go#L168"
        for (__0 => _p in stdgo._internal.encoding.base64.Base64__pairs._pairs) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/encoding/base64/base64_test.go#L172"
            if (((_err != null) && (stdgo.Go.toInterface(_err) != stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF)) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/encoding/base64/base64_test.go#L173"
                _t.fatal(stdgo.Go.toInterface(("Read failed" : stdgo.GoString)), stdgo.Go.toInterface(_err));
            };
            //"file:///home/runner/.go/go1.21.3/src/encoding/base64/base64_test.go#L175"
            ...
            //"file:///home/runner/.go/go1.21.3/src/encoding/base64/base64_test.go#L176"
            ...
            //"file:///home/runner/.go/go1.21.3/src/encoding/base64/base64_test.go#L177"
            ...
            //"file:///home/runner/.go/go1.21.3/src/encoding/base64/base64_test.go#L180"
