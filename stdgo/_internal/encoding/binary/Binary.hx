...
(new stdgo.GoArray<stdgo.GoUInt8>(4, 4, ...[(67 : stdgo.GoUInt8), (68 : stdgo.GoUInt8), (69 : stdgo.GoUInt8), (70 : stdgo.GoUInt8)]) : stdgo.GoArray<stdgo.GoUInt8>),
true,
...
var _intArrays : stdgo.Slice<stdgo.AnyInterface> = (new stdgo.Slice<stdgo.AnyInterface>(8, 8, ...[stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo.GoArray<stdgo.GoInt8>(100, 100, ...([].concat([for (i in 0 ... 100) (0 : stdgo.GoInt8)]))) : stdgo.GoArray<stdgo.GoInt8>)) : stdgo.Ref<stdgo.GoArray<stdgo.GoInt8>>)), stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo.GoArray<stdgo.GoInt16>(100, 100, ...([].concat([for (i in 0 ... 100) (0 : stdgo.GoInt16)]))) : stdgo.GoArray<stdgo.GoInt16>)) : stdgo.Ref<stdgo.GoArray<stdgo.GoInt16>>)), stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo.GoArray<stdgo.GoInt32>(100, 100, ...([].concat([for (i in 0 ... 100) (0 : stdgo.GoInt32)]))) : stdgo.GoArray<stdgo.GoInt32>)) : stdgo.Ref<stdgo.GoArray<stdgo.GoInt32>>)), stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo.GoArray<stdgo.GoInt64>(100, 100, ...([].concat([for (i in 0 ... 100) (0 : stdgo.GoInt64)]))) : stdgo.GoArray<stdgo.GoInt64>)) : stdgo.Ref<stdgo.GoArray<stdgo.GoInt64>>)), stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo.GoArray<stdgo.GoUInt8>(100, 100, ...([].concat([for (i in 0 ... 100) (0 : stdgo.GoUInt8)]))) : stdgo.GoArray<stdgo.GoUInt8>)) : stdgo.Ref<stdgo.GoArray<stdgo.GoUInt8>>)), stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo.GoArray<stdgo.GoUInt16>(100, 100, ...([].concat([for (i in 0 ... 100) (0 : stdgo.GoUInt16)]))) : stdgo.GoArray<stdgo.GoUInt16>)) : stdgo.Ref<stdgo.GoArray<stdgo.GoUInt16>>)), stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo.GoArray<stdgo.GoUInt32>(100, 100, ...([].concat([for (i in 0 ... 100) (0 : stdgo.GoUInt32)]))) : stdgo.GoArray<stdgo.GoUInt32>)) : stdgo.Ref<stdgo.GoArray<stdgo.GoUInt32>>)), stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo.GoArray<stdgo.GoUInt64>(100, 100, ...([].concat([for (i in 0 ... 100) (0 : stdgo.GoUInt64)]))) : stdgo.GoArray<stdgo.GoUInt64>)) : stdgo.Ref<stdgo.GoArray<stdgo.GoUInt64>>))]) : stdgo.Slice<stdgo.AnyInterface>);
...
function read(_r:stdgo._internal.io.Io.Reader, _order:ByteOrder, _data:stdgo.AnyInterface):stdgo.Error {
        ...
        var _v:stdgo._internal.reflect.Reflect.Value = stdgo._internal.reflect.Reflect.valueOf(_data)?.__copy__();
        ...
        var _d = (stdgo.Go.setRef(({ _order : _order, _buf : new stdgo.Slice<stdgo.GoUInt8>((_size : stdgo.GoInt).toBasic(), 0).__setNumber32__() } : stdgo._internal.encoding.binary.Binary.T_decoder)) : stdgo.Ref<stdgo._internal.encoding.binary.Binary.T_decoder>);
        {
...
function write(_w:stdgo._internal.io.Io.Writer, _order:ByteOrder, _data:stdgo.AnyInterface):stdgo.Error {
        ...
        var _v:stdgo._internal.reflect.Reflect.Value = stdgo._internal.reflect.Reflect.indirect(stdgo._internal.reflect.Reflect.valueOf(_data)?.__copy__())?.__copy__();
...
function _testRead(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>, _order:ByteOrder, _b:stdgo.Slice<stdgo.GoByte>, _s1:stdgo.AnyInterface):Void {
        ...
        var _err:stdgo.Error = read(stdgo.Go.asInterface(stdgo._internal.bytes.Bytes.newReader(_b)), _order, stdgo.Go.toInterface((stdgo.Go.setRef(_s2) : stdgo.Ref<stdgo._internal.encoding.binary.Binary.Struct>)));
...
function testReadSlice(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _err:stdgo.Error = read(stdgo.Go.asInterface(stdgo._internal.bytes.Bytes.newReader(_src)), stdgo.Go.asInterface(bigEndian), stdgo.Go.toInterface(_slice));
...
function testReadBool(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        _err = read(stdgo.Go.asInterface(stdgo._internal.bytes.Bytes.newReader((new stdgo.Slice<stdgo.GoUInt8>(1, 1, ...[(0 : stdgo.GoUInt8)]) : stdgo.Slice<stdgo.GoUInt8>))), stdgo.Go.asInterface(bigEndian), stdgo.Go.toInterface(stdgo.Go.pointer(_res)));
        ...
        _res = false;
        _err = read(stdgo.Go.asInterface(stdgo._internal.bytes.Bytes.newReader((new stdgo.Slice<stdgo.GoUInt8>(1, 1, ...[(1 : stdgo.GoUInt8)]) : stdgo.Slice<stdgo.GoUInt8>))), stdgo.Go.asInterface(bigEndian), stdgo.Go.toInterface(stdgo.Go.pointer(_res)));
        ...
        _res = false;
        _err = read(stdgo.Go.asInterface(stdgo._internal.bytes.Bytes.newReader((new stdgo.Slice<stdgo.GoUInt8>(1, 1, ...[(2 : stdgo.GoUInt8)]) : stdgo.Slice<stdgo.GoUInt8>))), stdgo.Go.asInterface(bigEndian), stdgo.Go.toInterface(stdgo.Go.pointer(_res)));
        _checkResult(_t, ("ReadBool" : stdgo.GoString), stdgo.Go.asInterface(bigEndian), _err, stdgo.Go.toInterface(_res), stdgo.Go.toInterface(true));
    }
function testReadBoolSlice(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _err:stdgo.Error = read(stdgo.Go.asInterface(stdgo._internal.bytes.Bytes.newReader((new stdgo.Slice<stdgo.GoUInt8>(4, 4, ...[(0 : stdgo.GoUInt8), (1 : stdgo.GoUInt8), (2 : stdgo.GoUInt8), (255 : stdgo.GoUInt8)]) : stdgo.Slice<stdgo.GoUInt8>))), stdgo.Go.asInterface(bigEndian), stdgo.Go.toInterface(_slice));
...
function testSliceRoundTrip(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        for (__8 => _array in _intArrays) {
            var _src:stdgo._internal.reflect.Reflect.Value = stdgo._internal.reflect.Reflect.valueOf(_array).elem()?.__copy__();
            ...
            _buf.reset();
            var _srcSlice:stdgo._internal.reflect.Reflect.Value = _src.slice((0 : stdgo.GoInt), _src.len())?.__copy__();
            var _err:stdgo.Error = write(stdgo.Go.asInterface(_buf), stdgo.Go.asInterface(bigEndian), _srcSlice.interface_());
            if (_err != null) {
                _t.fatal(stdgo.Go.toInterface(_err));
            };
            var _dst:stdgo._internal.reflect.Reflect.Value = stdgo._internal.reflect.Reflect.new_(_src.type()).elem()?.__copy__();
            var _dstSlice:stdgo._internal.reflect.Reflect.Value = _dst.slice((0 : stdgo.GoInt), _dst.len())?.__copy__();
...
function testWriteT(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        var _buf = (stdgo.Go.setRef(({} : stdgo._internal.bytes.Bytes.Buffer)) : stdgo.Ref<stdgo._internal.bytes.Bytes.Buffer>);
        var _ts:stdgo._internal.encoding.binary.Binary.T_ = (new stdgo._internal.encoding.binary.Binary.T_() : stdgo._internal.encoding.binary.Binary.T_);
        {
        ...
        var _tv:stdgo._internal.reflect.Reflect.Value = stdgo._internal.reflect.Reflect.indirect(stdgo._internal.reflect.Reflect.valueOf(stdgo.Go.toInterface(_ts))?.__copy__())?.__copy__();
        {
...
function testBlankFields(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        var _buf = (stdgo.Go.setRef(({} : stdgo._internal.bytes.Bytes.Buffer)) : stdgo.Ref<stdgo._internal.bytes.Bytes.Buffer>);
        var _b1:stdgo._internal.encoding.binary.Binary.BlankFields = ({ a : (1234567890u32 : stdgo.GoUInt32), b : (2.718281828 : stdgo.GoFloat64), c : (42 : stdgo.GoUInt8) } : stdgo._internal.encoding.binary.Binary.BlankFields);
        {
            var _err:stdgo.Error = write(stdgo.Go.asInterface(_buf), stdgo.Go.asInterface(littleEndian), stdgo.Go.toInterface((stdgo.Go.setRef(_b1) : stdgo.Ref<stdgo._internal.encoding.binary.Binary.BlankFields>)));
            if (_err != null) {
        ...
        {
            var _err:stdgo.Error = read(stdgo.Go.asInterface(_buf), stdgo.Go.asInterface(littleEndian), stdgo.Go.toInterface((stdgo.Go.setRef(_p) : stdgo.Ref<stdgo._internal.encoding.binary.Binary.BlankFieldsProbe>)));
            if (_err != null) {
                _t.error(stdgo.Go.toInterface(_err));
            };
        };
        ...
        {
            var _err:stdgo.Error = write(stdgo.Go.asInterface(_buf), stdgo.Go.asInterface(littleEndian), stdgo.Go.toInterface((stdgo.Go.setRef(_p) : stdgo.Ref<stdgo._internal.encoding.binary.Binary.BlankFieldsProbe>)));
            if (_err != null) {
                _t.error(stdgo.Go.toInterface(_err));
            };
        };
        ...
        {
            var _err:stdgo.Error = read(stdgo.Go.asInterface(_buf), stdgo.Go.asInterface(littleEndian), stdgo.Go.toInterface((stdgo.Go.setRef(_b2) : stdgo.Ref<stdgo._internal.encoding.binary.Binary.BlankFields>)));
            if (_err != null) {
                _t.error(stdgo.Go.toInterface(_err));
            };
        };
...
@:structInit class T_testSizeStructCache_12___localname___bar {
    ...
    public var b : stdgo._internal.encoding.binary.Binary.T_testSizeStructCache_11___localname___foo = ({} : stdgo._internal.encoding.binary.Binary.T_testSizeStructCache_11___localname___foo);
    public var c : stdgo._internal.encoding.binary.Binary.Struct = ({} : stdgo._internal.encoding.binary.Binary.Struct);
    public function new(?a:stdgo._internal.encoding.binary.Binary.Struct, ?b:stdgo._internal.encoding.binary.Binary.T_testSizeStructCache_11___localname___foo, ?c:stdgo._internal.encoding.binary.Binary.Struct) {
        if (a != null) this.a = a;
        if (b != null) this.b = b;
        if (c != null) this.c = c;
    }
...
function testSizeInvalid(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        var _testcases = (new stdgo.Slice<stdgo.AnyInterface>(10, 10, ...[stdgo.Go.toInterface((0 : stdgo.GoInt)), stdgo.Go.toInterface(stdgo.Go.pointer((0 : stdgo.GoInt))), stdgo.Go.toInterface((null : stdgo.Pointer<stdgo.GoInt>)), stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoUInt>(1, 1, ...([].concat([for (i in 0 ... 1) (0 : stdgo.GoUInt)]))) : stdgo.GoArray<stdgo.GoUInt>)), stdgo.Go.toInterface((stdgo.Go.setRef(new stdgo.GoArray<stdgo.GoUInt>(1, 1, ...[for (i in 0 ... 1) (0 : stdgo.GoUInt)])) : stdgo.Ref<stdgo.GoArray<stdgo.GoUInt>>)), stdgo.Go.toInterface((null : stdgo.Ref<stdgo.GoArray<stdgo.GoUInt>>)), stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoInt>(0, 0, ...[]) : stdgo.Slice<stdgo.GoInt>)), stdgo.Go.toInterface((null : stdgo.Slice<stdgo.GoInt>)), stdgo.Go.toInterface((stdgo.Go.setRef((null : stdgo.Slice<stdgo.GoInt>)) : stdgo.Ref<stdgo.Slice<stdgo.GoInt>>)), stdgo.Go.toInterface((null : stdgo.Ref<stdgo.Slice<stdgo.GoInt>>))]) : stdgo.Slice<stdgo.AnyInterface>);
        for (__8 => _tc in _testcases) {
            {
...
function testUnexportedRead(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        try {
            ...
            var _u1:stdgo._internal.encoding.binary.Binary.Unexported = ({ _a : (1 : stdgo.GoInt32) } : stdgo._internal.encoding.binary.Binary.Unexported);
            {
                var _err:stdgo.Error = write(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo._internal.bytes.Bytes.Buffer>)), stdgo.Go.asInterface(littleEndian), stdgo.Go.toInterface((stdgo.Go.setRef(_u1) : stdgo.Ref<stdgo._internal.encoding.binary.Binary.Unexported>)));
                if (_err != null) {
                    _t.fatal(stdgo.Go.toInterface(_err));
                };
            };
...
function testReadErrorMsg(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _read:stdgo.AnyInterface -> Void = function(_data:stdgo.AnyInterface):Void {
            var _err:stdgo.Error = read(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo._internal.bytes.Bytes.Buffer>)), stdgo.Go.asInterface(littleEndian), _data);
            var _want:stdgo.GoString = (("binary.Read: invalid type " : stdgo.GoString) + (stdgo._internal.reflect.Reflect.typeOf(_data).string() : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__();
            if (_err == null) {
...
function testReadTruncated(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _b2:T__struct_5 = ({ a : (0 : stdgo.GoUInt8), b : (0 : stdgo.GoUInt8), c : (0 : stdgo.GoUInt8), d : (0 : stdgo.GoUInt8), e : (0 : stdgo.GoInt32), f : (0 : stdgo.GoFloat64) } : T__struct_5);
        {
            ...
            stdgo.Go.cfor((_i <= (("0123456789abcdef" : stdgo.GoString).length) : Bool), _i++, {
                ...
                {
                    var _err:stdgo.Error = read(stdgo.Go.asInterface(stdgo._internal.strings.Strings.newReader((("0123456789abcdef" : stdgo.GoString).__slice__(0, _i) : stdgo.GoString)?.__copy__())), stdgo.Go.asInterface(littleEndian), stdgo.Go.toInterface((stdgo.Go.setRef(_b1) : stdgo.Ref<stdgo.Slice<stdgo.GoInt32>>)));
                ...
                {
                    var _err:stdgo.Error = read(stdgo.Go.asInterface(stdgo._internal.strings.Strings.newReader((("0123456789abcdef" : stdgo.GoString).__slice__(0, _i) : stdgo.GoString)?.__copy__())), stdgo.Go.asInterface(littleEndian), stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_b2) : stdgo.Ref<T__struct_5>))));
                    if (stdgo.Go.toInterface(_err) != (stdgo.Go.toInterface(_errWant))) {
...
function _testUint64SmallSliceLengthPanics():Bool {
        ...
        try {
            ...
            var _b = (new stdgo.GoArray<stdgo.GoUInt8>(8, 8, ...[(1 : stdgo.GoUInt8), (2 : stdgo.GoUInt8), (3 : stdgo.GoUInt8), (4 : stdgo.GoUInt8), (5 : stdgo.GoUInt8), (6 : stdgo.GoUInt8), (7 : stdgo.GoUInt8), (8 : stdgo.GoUInt8)]) : stdgo.GoArray<stdgo.GoUInt8>);
...
function _testPutUint64SmallSliceLengthPanics():Bool {
        ...
        try {
            ...
            var _b = (new stdgo.GoArray<stdgo.GoUInt8>(8, 8, ...([].concat([for (i in 0 ... 8) (0 : stdgo.GoUInt8)]))) : stdgo.GoArray<stdgo.GoUInt8>);
...
function testByteOrder(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        for (__8 => _order in (new stdgo.Slice<stdgo._internal.encoding.binary.Binary.T_testByteOrder_13___localname___byteOrder>(2, 2, ...[stdgo.Go.asInterface(littleEndian), stdgo.Go.asInterface(bigEndian)]) : stdgo.Slice<stdgo._internal.encoding.binary.Binary.T_testByteOrder_13___localname___byteOrder>)) {
            {};
...
function _testReadInvalidDestination(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>, _order:ByteOrder):Void {
        ...
        for (__8 => _dst in _destinations) {
            var _err:stdgo.Error = read(stdgo.Go.asInterface(stdgo._internal.bytes.Bytes.newReader((new stdgo.Slice<stdgo.GoUInt8>(8, 8, ...[(1 : stdgo.GoUInt8), (2 : stdgo.GoUInt8), (3 : stdgo.GoUInt8), (4 : stdgo.GoUInt8), (5 : stdgo.GoUInt8), (6 : stdgo.GoUInt8), (7 : stdgo.GoUInt8), (8 : stdgo.GoUInt8)]) : stdgo.Slice<stdgo.GoUInt8>))), _order, _dst);
            var _want:stdgo.GoString = stdgo._internal.fmt.Fmt.sprintf(("binary.Read: invalid type %T" : stdgo.GoString), _dst)?.__copy__();
...
function testNoFixedSize(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        {};
        var _person:stdgo._internal.encoding.binary.Binary.T_testNoFixedSize_14___localname___Person = ({ age : (27 : stdgo.GoInt), weight : (67.3 : stdgo.GoFloat64), height : (177.8 : stdgo.GoFloat64) } : stdgo._internal.encoding.binary.Binary.T_testNoFixedSize_14___localname___Person);
        var _buf = (stdgo.Go.setRef(({} : stdgo._internal.bytes.Bytes.Buffer)) : stdgo.Ref<stdgo._internal.bytes.Bytes.Buffer>);
        var _err:stdgo.Error = write(stdgo.Go.asInterface(_buf), stdgo.Go.asInterface(littleEndian), stdgo.Go.toInterface((stdgo.Go.setRef(_person) : stdgo.Ref<stdgo._internal.encoding.binary.Binary.T_testNoFixedSize_14___localname___Person>)));
        if (_err == null) {
...
function benchmarkReadStruct(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        ...
        var _t:stdgo._internal.encoding.binary.Binary.Struct = _s?.__copy__();
        _b.resetTimer();
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
...
function benchmarkReadInts(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        ...
        _b.stopTimer();
        var _want:stdgo._internal.encoding.binary.Binary.Struct = _s?.__copy__();
        ...
        _want.array = (new stdgo.GoArray<stdgo.GoUInt8>(4, 4, ...[(0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8)]) : stdgo.GoArray<stdgo.GoUInt8>);
        _want.bool_ = false;
...
function appendVarint(_buf:stdgo.Slice<stdgo.GoByte>, _x:stdgo.GoInt64):stdgo.Slice<stdgo.GoByte> {
        var _ux:stdgo.GoUInt64 = ((_x : stdgo.GoUInt64) << (1i64 : stdgo.GoUInt64) : stdgo.GoUInt64);
...
function varint(_buf:stdgo.Slice<stdgo.GoByte>):{ var _0 : stdgo.GoInt64; var _1 : stdgo.GoInt; } {
        ...
        var _x:stdgo.GoInt64 = ((_ux >> (1i64 : stdgo.GoUInt64) : stdgo.GoUInt64) : stdgo.GoInt64);
...
function _testConstant(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>, _w:stdgo.GoUInt, _max:stdgo.GoInt):Void {
        ...
        var _n:stdgo.GoInt = putUvarint(_buf, (((1i64 : stdgo.GoUInt64) << _w : stdgo.GoUInt64) - (1i64 : stdgo.GoUInt64) : stdgo.GoUInt64));
        if (_n != (_max)) {
...
function testBufferTooSmall(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        var _buf = (new stdgo.Slice<stdgo.GoUInt8>(4, 4, ...[(128 : stdgo.GoUInt8), (128 : stdgo.GoUInt8), (128 : stdgo.GoUInt8), (128 : stdgo.GoUInt8)]) : stdgo.Slice<stdgo.GoUInt8>);
        {
            ...
            stdgo.Go.cfor((_i <= (_buf.length) : Bool), _i++, {
                ...
                var _wantErr:stdgo.Error = stdgo._internal.io.Io.eof;
...
(255 : stdgo.GoUInt8),
(255 : stdgo.GoUInt8),
(1 : stdgo.GoUInt8)]) : stdgo.Slice<stdgo.GoUInt8>), _name : ("invalid: with more than MaxVarintLen64 bytes" : stdgo.GoString), _wantN : (-11 : stdgo.GoInt), _wantValue : (0i64 : stdgo.GoUInt64) } : T__struct_6), ({ _in : (new stdgo.Slice<stdgo.GoUInt8>(10, 10, ...[(215 : stdgo.GoUInt8), (255 : stdgo.GoUInt8), (255 : stdgo.GoUInt8), (255 : stdgo.GoUInt8), (255 : stdgo.GoUInt8), (255 : stdgo.GoUInt8), (255 : stdgo.GoUInt8), (255 : stdgo.GoUInt8), (255 : stdgo.GoUInt8), (127 : stdgo.GoUInt8)]) : stdgo.Slice<stdgo.GoUInt8>), _name : ("invalid: 10th byte" : stdgo.GoString), _wantN : (-10 : stdgo.GoInt), _wantValue : (0i64 : stdgo.GoUInt64) } : T__struct_6)]) : stdgo.Slice<T__struct_6>);
...
function _testOverflow(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>, _buf:stdgo.Slice<stdgo.GoByte>, _x0:stdgo.GoUInt64, _n0:stdgo.GoInt, _err0:stdgo.Error):Void {
        ...
        {
            var _read:stdgo.GoInt = (_len - _r.len() : stdgo.GoInt);
...
function testOverflow(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        _testOverflow(_t, (new stdgo.Slice<stdgo.GoUInt8>(10, 10, ...[(128 : stdgo.GoUInt8), (128 : stdgo.GoUInt8), (128 : stdgo.GoUInt8), (128 : stdgo.GoUInt8), (128 : stdgo.GoUInt8), (128 : stdgo.GoUInt8), (128 : stdgo.GoUInt8), (128 : stdgo.GoUInt8), (128 : stdgo.GoUInt8), (2 : stdgo.GoUInt8)]) : stdgo.Slice<stdgo.GoUInt8>), (0i64 : stdgo.GoUInt64), (-10 : stdgo.GoInt), _errOverflow);
...
@:keep @:allow(stdgo._internal.encoding.binary.Binary.T_decoder_asInterface) class T_decoder_static_extension {
        ...
        @:recv var _d:stdgo.Ref<T_decoder> = _d;
        {
            ...
            if (__value__ == ((17u32 : stdgo._internal.reflect.Reflect.Kind))) {
                ...
                var _l:stdgo.GoInt = _v.numField();
                {
                    ...
                    stdgo.Go.cfor((_i < _l : Bool), _i++, {
                        {
                            var _v:stdgo._internal.reflect.Reflect.Value = _v.field(_i)?.__copy__();
    ...
    static public function _uint64( _d:stdgo.Ref<T_decoder>):stdgo.GoUInt64 {
        @:recv var _d:stdgo.Ref<T_decoder> = _d;
        var _x:stdgo.GoUInt64 = _d._order.uint64((_d._buf.__slice__(_d._offset, (_d._offset + (8 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
    ...
    static public function _uint32( _d:stdgo.Ref<T_decoder>):stdgo.GoUInt32 {
        @:recv var _d:stdgo.Ref<T_decoder> = _d;
        var _x:stdgo.GoUInt32 = _d._order.uint32((_d._buf.__slice__(_d._offset, (_d._offset + (4 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
    ...
    static public function _uint16( _d:stdgo.Ref<T_decoder>):stdgo.GoUInt16 {
        @:recv var _d:stdgo.Ref<T_decoder> = _d;
        var _x:stdgo.GoUInt16 = _d._order.uint16((_d._buf.__slice__(_d._offset, (_d._offset + (2 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
