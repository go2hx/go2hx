...
function benchmarkReadStruct(_b:stdgo.Ref<stdgo._internal.testing.Testing_B.B>):Void {
        ...
        @:check2r _b.setBytes((stdgo._internal.encoding.binary.Binary__dataSize._dataSize(stdgo._internal.reflect.Reflect_valueOf.valueOf(stdgo.Go.toInterface(stdgo._internal.encoding.binary.Binary__s._s))?.__copy__()) : stdgo.GoInt64));
...
stdgo._internal.encoding.binary.Binary_read.read(stdgo.Go.asInterface(_bsr), stdgo.Go.asInterface(stdgo._internal.encoding.binary.Binary_bigEndian.bigEndian), stdgo.Go.toInterface((stdgo.Go.setRef(_t) : stdgo.Ref<stdgo._internal.encoding.binary.Binary_Struct.Struct>)));
        ...
        if ((((@:checkr _b ?? throw "null pointer dereference").n > (0 : stdgo.GoInt) : Bool) && !stdgo._internal.reflect.Reflect_deepEqual.deepEqual(stdgo.Go.toInterface(stdgo._internal.encoding.binary.Binary__s._s), stdgo.Go.toInterface(_t)) : Bool)) {
