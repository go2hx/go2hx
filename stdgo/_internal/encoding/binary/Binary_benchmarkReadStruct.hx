...
function benchmarkReadStruct(_b:stdgo.Ref<stdgo._internal.testing.Testing_B.B>):Void {
        ...
        var _t__pointer__ = (stdgo.Go.setRef(_t) : stdgo.Ref<stdgo._internal.encoding.binary.Binary_Struct.Struct>);
        var _t__pointer__ = (stdgo.Go.setRef(_t) : stdgo.Ref<stdgo._internal.encoding.binary.Binary_Struct.Struct>);
        var _t__pointer__ = (stdgo.Go.setRef(_t) : stdgo.Ref<stdgo._internal.encoding.binary.Binary_Struct.Struct>);
        var _t__pointer__ = (stdgo.Go.setRef(_t) : stdgo.Ref<stdgo._internal.encoding.binary.Binary_Struct.Struct>);
        _b.resetTimer();
...
stdgo._internal.encoding.binary.Binary_read.read(stdgo.Go.asInterface(_bsr), stdgo.Go.asInterface(stdgo._internal.encoding.binary.Binary_bigEndian.bigEndian), stdgo.Go.toInterface(_t__pointer__));
                _i++;
            };
        };
        _b.stopTimer();
