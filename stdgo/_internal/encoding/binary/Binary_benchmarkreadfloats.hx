...
function benchmarkReadFloats(_b:stdgo.Ref<stdgo._internal.testing.Testing_b.B>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary_test.go#L788"
        _b.setBytes((12i64 : stdgo.GoInt64));
        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary_test.go#L789"
        _b.resetTimer();
        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary_test.go#L790"
        {
...
//"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary_test.go#L792"
...
//"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary_test.go#L793"
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary_test.go#L795"
        _b.stopTimer();
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary_test.go#L810"
        if ((((@:checkr _b ?? throw "null pointer dereference").n > (0 : stdgo.GoInt) : Bool) && !stdgo._internal.reflect.Reflect_deepequal.deepEqual(stdgo.Go.toInterface(stdgo.Go.asInterface(_ls)), stdgo.Go.toInterface(stdgo.Go.asInterface(_want))) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary_test.go#L811"
