...
function read(_r:stdgo._internal.io.Io_reader.Reader, _order:stdgo._internal.encoding.binary.Binary_byteorder.ByteOrder, _data:stdgo.AnyInterface):stdgo.Error {
        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L235"
        {
            ...
            if (_n != ((0 : stdgo.GoInt))) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L237"
                {
                    var __tmp__ = stdgo._internal.io.Io_readfull.readFull(_r, _bs), __8:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                    if (_err != null) {
                        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L238"
                        return _err;
                    };
                };
                //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L240"
                {
                    ...
                    if (stdgo.Go.typeEquals((__type__ : stdgo.Pointer<Bool>))) {
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L264"
                        for (_i => _x in _bs) {
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L268"
                        for (_i => _x in _bs) {
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L272"
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L274"
                        for (_i => _ in _data) {
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L278"
                        for (_i => _ in _data) {
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L282"
                        for (_i => _ in _data) {
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L286"
                        for (_i => _ in _data) {
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L290"
                        for (_i => _ in _data) {
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L294"
                        for (_i => _ in _data) {
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L298"
                        for (_i => _ in _data) {
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L302"
                        for (_i => _ in _data) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L308"
                if (_n != ((0 : stdgo.GoInt))) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L309"
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L316"
        {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L323"
        if ((_size < (0 : stdgo.GoInt) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L324"
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L327"
        {
            ...
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L328"
                return _err;
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L330"
        _d._value(_v?.__copy__());
        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary.go#L331"
        return (null : stdgo.Error);
    }
