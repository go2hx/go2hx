...
function testReadTruncated(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary_test.go#L428"
        {
            var _i = (0 : stdgo.GoInt);
            while ((_i <= ((("0123456789abcdef" : stdgo.GoString) : stdgo.GoString).length) : Bool)) {
                var _errWant:stdgo.Error = (null : stdgo.Error);
//"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary_test.go#L430"
                {
                    final __value__ = _i;
...
//"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary_test.go#L439"
                {
                    ...
                    if (stdgo.Go.toInterface(_err) != (stdgo.Go.toInterface(_errWant))) {
                        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary_test.go#L440"
...
//"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary_test.go#L442"
                {
                    ...
                    if (stdgo.Go.toInterface(_err) != (stdgo.Go.toInterface(_errWant))) {
                        //"file:///home/runner/.go/go1.21.3/src/encoding/binary/binary_test.go#L443"
