        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((((@:checkr _r ?? throw "null pointer dereference").comma == ((@:checkr _r ?? throw "null pointer dereference").comment) || !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comma) : Bool) || ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) : Bool)) {
                        _gotoNext = 4185316i32;
                    } else {
                        _gotoNext = 4185427i32;
                    };
                } else if (__value__ == (4185316i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : stdgo._internal.encoding.csv.Csv__errinvaliddelim._errInvalidDelim };
                    _gotoNext = 4185427i32;
                } else if (__value__ == (4185427i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 4185463i32;
                } else if (__value__ == (4185463i32)) {
                    if (_errRead_1 == null) {
                        _gotoNext = 4185482i32;
                    } else {
                        _gotoNext = 4185735i32;
                    };
                } else if (__value__ == (4185482i32)) {
                    {
                    ...
                    if ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && (stdgo._internal.encoding.csv.Csv__nextrune._nextRune(_line_0) == (@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) {
                        _gotoNext = 4185566i32;
                    } else {
                        _gotoNext = 4185622i32;
                    };
                } else if (__value__ == (4185566i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    var __blank__ = 0i32;
                    _gotoNext = 4185463i32;
                } else if (__value__ == (4185622i32)) {
                    if (((_errRead_1 == null) && (_line_0.length == stdgo._internal.encoding.csv.Csv__lengthnl._lengthNL(_line_0)) : Bool)) {
                        _gotoNext = 4185671i32;
                    } else {
                        _gotoNext = 4185725i32;
                    };
                } else if (__value__ == (4185671i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    var __blank__ = 0i32;
                    _gotoNext = 4185463i32;
                } else if (__value__ == (4185725i32)) {
                    _gotoNext = 4185735i32;
                } else if (__value__ == (4185735i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4185756i32;
                    } else {
                        _gotoNext = 4185821i32;
                    };
                } else if (__value__ == (4185756i32)) {
                    ...
                    _gotoNext = 4186104i32;
                } else if (__value__ == (4186104i32)) {
                    var __blank__ = 0i32;
                    _parseFieldBreak = false;
                    _gotoNext = 4186117i32;
                } else if (__value__ == (4186117i32)) {
                    if (!_parseFieldBreak) {
                        _gotoNext = 4186121i32;
                    } else {
                        _gotoNext = 4189213i32;
                    };
                } else if (__value__ == (4186121i32)) {
                    if ((@:checkr _r ?? throw "null pointer dereference").trimLeadingSpace) {
                        _gotoNext = 4186147i32;
                    } else {
                        _gotoNext = 4186344i32;
                    };
                } else if (__value__ == (4186147i32)) {
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4186481i32;
                    } else {
                        _gotoNext = 4186515i32;
                    };
                } else if (__value__ == (4186481i32)) {
                    _field_9 = (_field_9.__slice__(0, _i_8) : stdgo.Slice<stdgo.GoUInt8>);
                    _gotoNext = 4186631i32;
                } else if (__value__ == (4186515i32)) {
                    _gotoNext = 4186515i32;
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4187031i32;
                    } else {
                        _gotoNext = 4187122i32;
                    };
                } else if (__value__ == (4187031i32)) {
                    ...
                    _gotoNext = 4186117i32;
                } else if (__value__ == (4187122i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4186117i32;
                } else if (__value__ == (4187148i32)) {
                    _gotoNext = 4187148i32;
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 4187247i32;
                } else if (__value__ == (4187247i32)) {
                    if (true) {
                        _gotoNext = 4187251i32;
                    } else {
                        _gotoNext = 4186117i32;
                    };
                } else if (__value__ == (4187251i32)) {
                    _i_13 = stdgo._internal.bytes.Bytes_indexbyte.indexByte(_line_0, (34 : stdgo.GoUInt8));
                    if ((_i_13 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4187303i32;
                    } else if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4188487i32;
                    } else {
                        _gotoNext = 4188838i32;
                    };
                } else if (__value__ == (4187303i32)) {
                    ...
                    _gotoNext = 4186117i32;
                } else if (__value__ == (4187925i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4186117i32;
                } else if (__value__ == (4188153i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._recordBuffer = ((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.__append__((34 : stdgo.GoUInt8)));
                    _gotoNext = 4187247i32;
                    ...
                    if (_errRead_1 != null) {
                        _gotoNext = 4188614i32;
                    } else {
                        _gotoNext = 4188651i32;
                    };
                } else if (__value__ == (4188614i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4186117i32;
                } else if (__value__ == (4188651i32)) {
                    ...
                    if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4188728i32;
                    } else {
                        _gotoNext = 4188777i32;
                    };
                } else if (__value__ == (4188728i32)) {
                    _pos_6._line++;
                    _pos_6._col = (1 : stdgo.GoInt);
                    _gotoNext = 4188777i32;
                } else if (__value__ == (4188777i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4188798i32;
                    } else {
                        _gotoNext = 4187247i32;
                    };
                } else if (__value__ == (4188798i32)) {
                    _errRead_1 = (null : stdgo.Error);
                    _gotoNext = 4187247i32;
                } else if (__value__ == (4188838i32)) {
                    _gotoNext = 4188838i32;
                    if ((!(@:checkr _r ?? throw "null pointer dereference").lazyQuotes && (_errRead_1 == null) : Bool)) {
                        _gotoNext = 4188923i32;
                    } else {
                        _gotoNext = 4189052i32;
                    };
                } else if (__value__ == (4188923i32)) {
                    ...
                    _parseFieldBreak = true;
                    _gotoNext = 4186117i32;
                } else if (__value__ == (4189052i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4186117i32;
                } else if (__value__ == (4189213i32)) {
                    if (_err_2 == null) {
                        _gotoNext = 4189227i32;
                    } else {
                        _gotoNext = 4189375i32;
                    };
                } else if (__value__ == (4189227i32)) {
                    _err_2 = _errRead_1;
                    _gotoNext = 4189375i32;
                } else if (__value__ == (4189375i32)) {
                    ...
                    if ((_dst.capacity < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length) : Bool)) {
                        _gotoNext = 4189502i32;
                    } else {
                        _gotoNext = 4189552i32;
                    };
                } else if (__value__ == (4189502i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length)) {
                        _gotoNext = 4189680i32;
                    } else {
                        _gotoNext = 4189737i32;
                    };
                } else if (__value__ == (4189636i32)) {
                    ...
                    _preIdx_16 = _idx_18;
                    _i_17++;
                    _gotoNext = 4189681i32;
                } else if (__value__ == (4189680i32)) {
                    {
                        final __tmp__0 = 0i32;
