        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((((@:checkr _r ?? throw "null pointer dereference").comma == ((@:checkr _r ?? throw "null pointer dereference").comment) || !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comma) : Bool) || ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) : Bool)) {
                        _gotoNext = 4405741i32;
                    } else {
                        _gotoNext = 4405852i32;
                    };
                } else if (__value__ == (4405741i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : stdgo._internal.encoding.csv.Csv__errinvaliddelim._errInvalidDelim };
                    _gotoNext = 4405852i32;
                } else if (__value__ == (4405852i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 4405888i32;
                } else if (__value__ == (4405888i32)) {
                    if (_errRead_1 == null) {
                        _gotoNext = 4405907i32;
                    } else {
                        _gotoNext = 4406160i32;
                    };
                } else if (__value__ == (4405907i32)) {
                    {
                    ...
                    if ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && (stdgo._internal.encoding.csv.Csv__nextrune._nextRune(_line_0) == (@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) {
                        _gotoNext = 4405991i32;
                    } else {
                        _gotoNext = 4406047i32;
                    };
                } else if (__value__ == (4405991i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    var __blank__ = 0i32;
                    _gotoNext = 4405888i32;
                } else if (__value__ == (4406047i32)) {
                    if (((_errRead_1 == null) && (_line_0.length == stdgo._internal.encoding.csv.Csv__lengthnl._lengthNL(_line_0)) : Bool)) {
                        _gotoNext = 4406096i32;
                    } else {
                        _gotoNext = 4406150i32;
                    };
                } else if (__value__ == (4406096i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    var __blank__ = 0i32;
                    _gotoNext = 4405888i32;
                } else if (__value__ == (4406150i32)) {
                    _gotoNext = 4406160i32;
                } else if (__value__ == (4406160i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4406181i32;
                    } else {
                        _gotoNext = 4406246i32;
                    };
                } else if (__value__ == (4406181i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : _errRead_1 };
                    _gotoNext = 4406246i32;
                } else if (__value__ == (4406246i32)) {
                    ...
                    _gotoNext = 4406529i32;
                } else if (__value__ == (4406529i32)) {
                    var __blank__ = 0i32;
                    _parseFieldBreak = false;
                    _gotoNext = 4406542i32;
                } else if (__value__ == (4406542i32)) {
                    if (!_parseFieldBreak) {
                        _gotoNext = 4406546i32;
                    } else {
                        _gotoNext = 4409638i32;
                    };
                } else if (__value__ == (4406546i32)) {
                    if ((@:checkr _r ?? throw "null pointer dereference").trimLeadingSpace) {
                        _gotoNext = 4406572i32;
                    } else {
                        _gotoNext = 4406769i32;
                    };
                } else if (__value__ == (4406572i32)) {
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4406906i32;
                    } else {
                        _gotoNext = 4406940i32;
                    };
                } else if (__value__ == (4406906i32)) {
                    _field_9 = (_field_9.__slice__(0, _i_8) : stdgo.Slice<stdgo.GoUInt8>);
                    _gotoNext = 4407056i32;
                } else if (__value__ == (4406940i32)) {
                    _gotoNext = 4406940i32;
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4407456i32;
                    } else {
                        _gotoNext = 4407547i32;
                    };
                } else if (__value__ == (4407456i32)) {
                    ...
                    _gotoNext = 4406542i32;
                } else if (__value__ == (4407547i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4406542i32;
                } else if (__value__ == (4407573i32)) {
                    _gotoNext = 4407573i32;
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 4407672i32;
                } else if (__value__ == (4407672i32)) {
                    if (true) {
                        _gotoNext = 4407676i32;
                    } else {
                        _gotoNext = 4406542i32;
                    };
                } else if (__value__ == (4407676i32)) {
                    _i_13 = stdgo._internal.bytes.Bytes_indexbyte.indexByte(_line_0, (34 : stdgo.GoUInt8));
                    if ((_i_13 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4407728i32;
                    } else if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4408912i32;
                    } else {
                        _gotoNext = 4409263i32;
                    };
                } else if (__value__ == (4407728i32)) {
                    ...
                    _gotoNext = 4406542i32;
                } else if (__value__ == (4408350i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4406542i32;
                } else if (__value__ == (4408578i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._recordBuffer = ((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.__append__((34 : stdgo.GoUInt8)));
                    _gotoNext = 4407672i32;
                } else if (__value__ == (4408689i32)) {
                    ...
                    if (_errRead_1 != null) {
                        _gotoNext = 4409039i32;
                    } else {
                        _gotoNext = 4409076i32;
                    };
                } else if (__value__ == (4409039i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4406542i32;
                } else if (__value__ == (4409076i32)) {
                    ...
                    if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4409153i32;
                    } else {
                        _gotoNext = 4409202i32;
                    };
                } else if (__value__ == (4409153i32)) {
                    _pos_6._line++;
                    _pos_6._col = (1 : stdgo.GoInt);
                    _gotoNext = 4409202i32;
                } else if (__value__ == (4409202i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4409223i32;
                    } else {
                        _gotoNext = 4407672i32;
                    };
                } else if (__value__ == (4409223i32)) {
                    _errRead_1 = (null : stdgo.Error);
                    _gotoNext = 4407672i32;
                } else if (__value__ == (4409263i32)) {
                    _gotoNext = 4409263i32;
                    if ((!(@:checkr _r ?? throw "null pointer dereference").lazyQuotes && (_errRead_1 == null) : Bool)) {
                        _gotoNext = 4409348i32;
                    } else {
                        _gotoNext = 4409477i32;
                    };
                } else if (__value__ == (4409348i32)) {
                    ...
                    _parseFieldBreak = true;
                    _gotoNext = 4406542i32;
                } else if (__value__ == (4409477i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4406542i32;
                } else if (__value__ == (4409638i32)) {
                    if (_err_2 == null) {
                        _gotoNext = 4409652i32;
                    } else {
                        _gotoNext = 4409800i32;
                    };
                } else if (__value__ == (4409652i32)) {
                    _err_2 = _errRead_1;
                    _gotoNext = 4409800i32;
                } else if (__value__ == (4409800i32)) {
                    ...
                    if ((_dst.capacity < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length) : Bool)) {
                        _gotoNext = 4409927i32;
                    } else {
                        _gotoNext = 4409977i32;
                    };
                } else if (__value__ == (4409927i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length)) {
                        _gotoNext = 4410105i32;
                    } else {
                        _gotoNext = 4410162i32;
                    };
                } else if (__value__ == (4410061i32)) {
                    ...
                    _preIdx_16 = _idx_18;
                    _i_17++;
                    _gotoNext = 4410106i32;
                } else if (__value__ == (4410105i32)) {
                    {
                        final __tmp__0 = 0i32;
