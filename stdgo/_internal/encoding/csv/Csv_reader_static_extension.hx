        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((((@:checkr _r ?? throw "null pointer dereference").comma == ((@:checkr _r ?? throw "null pointer dereference").comment) || !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comma) : Bool) || ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) : Bool)) {
                        _gotoNext = 4309079i32;
                    } else {
                        _gotoNext = 4309190i32;
                    };
                } else if (__value__ == (4309079i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : stdgo._internal.encoding.csv.Csv__errinvaliddelim._errInvalidDelim };
                    _gotoNext = 4309190i32;
                } else if (__value__ == (4309190i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 4309226i32;
                } else if (__value__ == (4309226i32)) {
                    if (_errRead_1 == null) {
                        _gotoNext = 4309245i32;
                    } else {
                        _gotoNext = 4309498i32;
                    };
                } else if (__value__ == (4309245i32)) {
                    {
                    ...
                    if ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && (stdgo._internal.encoding.csv.Csv__nextrune._nextRune(_line_0) == (@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) {
                        _gotoNext = 4309329i32;
                    } else {
                        _gotoNext = 4309385i32;
                    };
                } else if (__value__ == (4309329i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    var __blank__ = 0i32;
                    _gotoNext = 4309226i32;
                } else if (__value__ == (4309385i32)) {
                    if (((_errRead_1 == null) && (_line_0.length == stdgo._internal.encoding.csv.Csv__lengthnl._lengthNL(_line_0)) : Bool)) {
                        _gotoNext = 4309434i32;
                    } else {
                        _gotoNext = 4309488i32;
                    };
                } else if (__value__ == (4309434i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    var __blank__ = 0i32;
                    _gotoNext = 4309226i32;
                } else if (__value__ == (4309488i32)) {
                    _gotoNext = 4309498i32;
                } else if (__value__ == (4309498i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4309519i32;
                    } else {
                        _gotoNext = 4309584i32;
                    };
                } else if (__value__ == (4309519i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : _errRead_1 };
                    _gotoNext = 4309584i32;
                } else if (__value__ == (4309584i32)) {
                    ...
                    _gotoNext = 4309867i32;
                } else if (__value__ == (4309867i32)) {
                    var __blank__ = 0i32;
                    _parseFieldBreak = false;
                    _gotoNext = 4309880i32;
                } else if (__value__ == (4309880i32)) {
                    if (!_parseFieldBreak) {
                        _gotoNext = 4309884i32;
                    } else {
                        _gotoNext = 4312976i32;
                    };
                } else if (__value__ == (4309884i32)) {
                    if ((@:checkr _r ?? throw "null pointer dereference").trimLeadingSpace) {
                        _gotoNext = 4309910i32;
                    } else {
                        _gotoNext = 4310107i32;
                    };
                } else if (__value__ == (4309910i32)) {
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4310244i32;
                    } else {
                        _gotoNext = 4310278i32;
                    };
                } else if (__value__ == (4310244i32)) {
                    _field_9 = (_field_9.__slice__(0, _i_8) : stdgo.Slice<stdgo.GoUInt8>);
                    _gotoNext = 4310394i32;
                } else if (__value__ == (4310278i32)) {
                    _gotoNext = 4310278i32;
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4310794i32;
                    } else {
                        _gotoNext = 4310885i32;
                    };
                } else if (__value__ == (4310794i32)) {
                    ...
                    _gotoNext = 4309880i32;
                } else if (__value__ == (4310885i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4309880i32;
                } else if (__value__ == (4310911i32)) {
                    _gotoNext = 4310911i32;
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 4311010i32;
                } else if (__value__ == (4311010i32)) {
                    if (true) {
                        _gotoNext = 4311014i32;
                    } else {
                        _gotoNext = 4309880i32;
                    };
                } else if (__value__ == (4311014i32)) {
                    _i_13 = stdgo._internal.bytes.Bytes_indexbyte.indexByte(_line_0, (34 : stdgo.GoUInt8));
                    if ((_i_13 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4311066i32;
                    } else if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4312250i32;
                    } else {
                        _gotoNext = 4312601i32;
                    };
                } else if (__value__ == (4311066i32)) {
                    ...
                    _gotoNext = 4309880i32;
                } else if (__value__ == (4311688i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4309880i32;
                } else if (__value__ == (4311916i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._recordBuffer = ((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.__append__((34 : stdgo.GoUInt8)));
                    _gotoNext = 4311010i32;
                } else if (__value__ == (4312027i32)) {
                    ...
                    if (_errRead_1 != null) {
                        _gotoNext = 4312377i32;
                    } else {
                        _gotoNext = 4312414i32;
                    };
                } else if (__value__ == (4312377i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4309880i32;
                } else if (__value__ == (4312414i32)) {
                    ...
                    if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4312491i32;
                    } else {
                        _gotoNext = 4312540i32;
                    };
                } else if (__value__ == (4312491i32)) {
                    _pos_6._line++;
                    _pos_6._col = (1 : stdgo.GoInt);
                    _gotoNext = 4312540i32;
                } else if (__value__ == (4312540i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4312561i32;
                    } else {
                        _gotoNext = 4311010i32;
                    };
                } else if (__value__ == (4312561i32)) {
                    _errRead_1 = (null : stdgo.Error);
                    _gotoNext = 4311010i32;
                } else if (__value__ == (4312601i32)) {
                    _gotoNext = 4312601i32;
                    if ((!(@:checkr _r ?? throw "null pointer dereference").lazyQuotes && (_errRead_1 == null) : Bool)) {
                        _gotoNext = 4312686i32;
                    } else {
                        _gotoNext = 4312815i32;
                    };
                } else if (__value__ == (4312686i32)) {
                    ...
                    _parseFieldBreak = true;
                    _gotoNext = 4309880i32;
                } else if (__value__ == (4312815i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4309880i32;
                } else if (__value__ == (4312976i32)) {
                    if (_err_2 == null) {
                        _gotoNext = 4312990i32;
                    } else {
                        _gotoNext = 4313138i32;
                    };
                } else if (__value__ == (4312990i32)) {
                    _err_2 = _errRead_1;
                    _gotoNext = 4313138i32;
                } else if (__value__ == (4313138i32)) {
                    ...
                    if ((_dst.capacity < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length) : Bool)) {
                        _gotoNext = 4313265i32;
                    } else {
                        _gotoNext = 4313315i32;
                    };
                } else if (__value__ == (4313265i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length)) {
                        _gotoNext = 4313443i32;
                    } else {
                        _gotoNext = 4313500i32;
                    };
                } else if (__value__ == (4313399i32)) {
                    ...
                    _preIdx_16 = _idx_18;
                    _i_17++;
                    _gotoNext = 4313444i32;
                } else if (__value__ == (4313443i32)) {
                    {
                        final __tmp__0 = 0i32;
