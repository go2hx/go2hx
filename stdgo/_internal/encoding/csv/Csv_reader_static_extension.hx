        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((((@:checkr _r ?? throw "null pointer dereference").comma == ((@:checkr _r ?? throw "null pointer dereference").comment) || !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comma) : Bool) || ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) : Bool)) {
                        _gotoNext = 4272551i32;
                    } else {
                        _gotoNext = 4272662i32;
                    };
                } else if (__value__ == (4272551i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : stdgo._internal.encoding.csv.Csv__errinvaliddelim._errInvalidDelim };
                    _gotoNext = 4272662i32;
                } else if (__value__ == (4272662i32)) {
                    0i32;
                    _gotoNext = 4272698i32;
                } else if (__value__ == (4272698i32)) {
                    if (_errRead_1 == null) {
                        _gotoNext = 4272717i32;
                    } else {
                        _gotoNext = 4272970i32;
                    };
                    ...
                    if ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && (stdgo._internal.encoding.csv.Csv__nextrune._nextRune(_line_0) == (@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) {
                        _gotoNext = 4272801i32;
                    } else {
                        _gotoNext = 4272857i32;
                    };
                } else if (__value__ == (4272801i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    0i32;
                    _gotoNext = 4272698i32;
                } else if (__value__ == (4272857i32)) {
                    if (((_errRead_1 == null) && (_line_0.length == stdgo._internal.encoding.csv.Csv__lengthnl._lengthNL(_line_0)) : Bool)) {
                        _gotoNext = 4272906i32;
                    } else {
                        _gotoNext = 4272960i32;
                    };
                } else if (__value__ == (4272906i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    0i32;
                    _gotoNext = 4272698i32;
                } else if (__value__ == (4272960i32)) {
                    _gotoNext = 4272970i32;
                } else if (__value__ == (4272970i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4272991i32;
                    } else {
                        _gotoNext = 4273056i32;
                    };
                } else if (__value__ == (4272991i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : _errRead_1 };
                    _gotoNext = 4273056i32;
                } else if (__value__ == (4273056i32)) {
                    ...
                    _gotoNext = 4273339i32;
                } else if (__value__ == (4273339i32)) {
                    0i32;
                    _parseFieldBreak = false;
                    _gotoNext = 4273352i32;
                } else if (__value__ == (4273352i32)) {
                    if (!_parseFieldBreak) {
                        _gotoNext = 4273356i32;
                    } else {
                        _gotoNext = 4276448i32;
                    };
                } else if (__value__ == (4273356i32)) {
                    if ((@:checkr _r ?? throw "null pointer dereference").trimLeadingSpace) {
                        _gotoNext = 4273382i32;
                    } else {
                        _gotoNext = 4273579i32;
                    };
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4273716i32;
                    } else {
                        _gotoNext = 4273750i32;
                    };
                } else if (__value__ == (4273716i32)) {
                    _field_9 = (_field_9.__slice__(0, _i_8) : stdgo.Slice<stdgo.GoUInt8>);
                    _gotoNext = 4273866i32;
                } else if (__value__ == (4273750i32)) {
                    _gotoNext = 4273750i32;
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4274266i32;
                    } else {
                        _gotoNext = 4274357i32;
                    };
                } else if (__value__ == (4274266i32)) {
                    ...
                    _gotoNext = 4273352i32;
                } else if (__value__ == (4274357i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4273352i32;
                } else if (__value__ == (4274383i32)) {
                    _gotoNext = 4274383i32;
                    ...
                    0i32;
                    _gotoNext = 4274482i32;
                } else if (__value__ == (4274482i32)) {
                    if (true) {
                        _gotoNext = 4274486i32;
                    } else {
                        _gotoNext = 4273352i32;
                    };
                } else if (__value__ == (4274486i32)) {
                    ...
                    if ((_i_13 >= (0 : stdgo.GoInt) : Bool)) {
                        ...
                        _gotoNext = 4275722i32;
                    } else {
                        _gotoNext = 4276073i32;
                    };
                    ...
                    _gotoNext = 4273352i32;
                } else if (__value__ == (4275160i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__(((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length)) : stdgo.Slice<stdgo.GoInt>);
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()) : stdgo.Slice<stdgo._internal.encoding.csv.Csv_t_position.T_position>);
                    _parseFieldBreak = true;
                    _gotoNext = 4273352i32;
                } else if (__value__ == (4275388i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._recordBuffer = ((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.__append__((34 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>);
                    _gotoNext = 4274482i32;
                } else if (__value__ == (4275499i32)) {
                    ...
                    if (_errRead_1 != null) {
                        _gotoNext = 4275849i32;
                    } else {
                        _gotoNext = 4275886i32;
                    };
                } else if (__value__ == (4275849i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4273352i32;
                } else if (__value__ == (4275886i32)) {
                    ...
                    if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4275963i32;
                    } else {
                        _gotoNext = 4276012i32;
                    };
                } else if (__value__ == (4275963i32)) {
                    _pos_6._line++;
                    _pos_6._col = (1 : stdgo.GoInt);
                    _gotoNext = 4276012i32;
                } else if (__value__ == (4276012i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4276033i32;
                    } else {
                        _gotoNext = 4274482i32;
                    };
                } else if (__value__ == (4276033i32)) {
                    _errRead_1 = (null : stdgo.Error);
                    _gotoNext = 4274482i32;
                } else if (__value__ == (4276073i32)) {
                    _gotoNext = 4276073i32;
                    if ((!(@:checkr _r ?? throw "null pointer dereference").lazyQuotes && (_errRead_1 == null) : Bool)) {
                        _gotoNext = 4276158i32;
                    } else {
                        _gotoNext = 4276287i32;
                    };
                } else if (__value__ == (4276158i32)) {
                    ...
                    _parseFieldBreak = true;
                    _gotoNext = 4273352i32;
                } else if (__value__ == (4276287i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__(((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length)) : stdgo.Slice<stdgo.GoInt>);
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()) : stdgo.Slice<stdgo._internal.encoding.csv.Csv_t_position.T_position>);
                    _parseFieldBreak = true;
                    _gotoNext = 4273352i32;
                } else if (__value__ == (4276448i32)) {
                    if (_err_2 == null) {
                        _gotoNext = 4276462i32;
                    } else {
                        _gotoNext = 4276610i32;
                    };
                } else if (__value__ == (4276462i32)) {
                    _err_2 = _errRead_1;
                    _gotoNext = 4276610i32;
                } else if (__value__ == (4276610i32)) {
                    ...
                    if ((_dst.capacity < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length) : Bool)) {
                        _gotoNext = 4276737i32;
                    } else {
                        _gotoNext = 4276787i32;
                    };
                } else if (__value__ == (4276737i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length)) {
                        _gotoNext = 4276915i32;
                    } else {
                        _gotoNext = 4276972i32;
                    };
                } else if (__value__ == (4276871i32)) {
                    ...
                    _preIdx_16 = _idx_18;
                    _i_17++;
                    _gotoNext = 4276916i32;
                } else if (__value__ == (4276915i32)) {
                    {
                        final __tmp__0 = 0i32;
