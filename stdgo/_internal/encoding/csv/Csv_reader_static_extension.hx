        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((((@:checkr _r ?? throw "null pointer dereference").comma == ((@:checkr _r ?? throw "null pointer dereference").comment) || !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comma) : Bool) || ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) : Bool)) {
                        _gotoNext = 4380436i32;
                    } else {
                        _gotoNext = 4380547i32;
                    };
                } else if (__value__ == (4380436i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : stdgo._internal.encoding.csv.Csv__errinvaliddelim._errInvalidDelim };
                    _gotoNext = 4380547i32;
                } else if (__value__ == (4380547i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 4380583i32;
                } else if (__value__ == (4380583i32)) {
                    if (_errRead_1 == null) {
                        _gotoNext = 4380602i32;
                    } else {
                        _gotoNext = 4380855i32;
                    };
                } else if (__value__ == (4380602i32)) {
                    {
                    ...
                    if ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && (stdgo._internal.encoding.csv.Csv__nextrune._nextRune(_line_0) == (@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) {
                        _gotoNext = 4380686i32;
                    } else {
                        _gotoNext = 4380742i32;
                    };
                } else if (__value__ == (4380686i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    var __blank__ = 0i32;
                    _gotoNext = 4380583i32;
                } else if (__value__ == (4380742i32)) {
                    if (((_errRead_1 == null) && (_line_0.length == stdgo._internal.encoding.csv.Csv__lengthnl._lengthNL(_line_0)) : Bool)) {
                        _gotoNext = 4380791i32;
                    } else {
                        _gotoNext = 4380845i32;
                    };
                } else if (__value__ == (4380791i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    var __blank__ = 0i32;
                    _gotoNext = 4380583i32;
                } else if (__value__ == (4380845i32)) {
                    _gotoNext = 4380855i32;
                } else if (__value__ == (4380855i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4380876i32;
                    } else {
                        _gotoNext = 4380941i32;
                    };
                } else if (__value__ == (4380876i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : _errRead_1 };
                    _gotoNext = 4380941i32;
                } else if (__value__ == (4380941i32)) {
                    ...
                    _gotoNext = 4381224i32;
                } else if (__value__ == (4381224i32)) {
                    var __blank__ = 0i32;
                    _parseFieldBreak = false;
                    _gotoNext = 4381237i32;
                } else if (__value__ == (4381237i32)) {
                    if (!_parseFieldBreak) {
                        _gotoNext = 4381241i32;
                    } else {
                        _gotoNext = 4384333i32;
                    };
                } else if (__value__ == (4381241i32)) {
                    if ((@:checkr _r ?? throw "null pointer dereference").trimLeadingSpace) {
                        _gotoNext = 4381267i32;
                    } else {
                        _gotoNext = 4381464i32;
                    };
                } else if (__value__ == (4381267i32)) {
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4381601i32;
                    } else {
                        _gotoNext = 4381635i32;
                    };
                } else if (__value__ == (4381601i32)) {
                    _field_9 = (_field_9.__slice__(0, _i_8) : stdgo.Slice<stdgo.GoUInt8>);
                    _gotoNext = 4381751i32;
                } else if (__value__ == (4381635i32)) {
                    _gotoNext = 4381635i32;
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4382151i32;
                    } else {
                        _gotoNext = 4382242i32;
                    };
                } else if (__value__ == (4382151i32)) {
                    ...
                    _gotoNext = 4381237i32;
                } else if (__value__ == (4382242i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4381237i32;
                } else if (__value__ == (4382268i32)) {
                    _gotoNext = 4382268i32;
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 4382367i32;
                } else if (__value__ == (4382367i32)) {
                    if (true) {
                        _gotoNext = 4382371i32;
                    } else {
                        _gotoNext = 4381237i32;
                    };
                } else if (__value__ == (4382371i32)) {
                    _i_13 = stdgo._internal.bytes.Bytes_indexbyte.indexByte(_line_0, (34 : stdgo.GoUInt8));
                    if ((_i_13 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4382423i32;
                    } else if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4383607i32;
                    } else {
                        _gotoNext = 4383958i32;
                    };
                } else if (__value__ == (4382423i32)) {
                    ...
                    _gotoNext = 4381237i32;
                } else if (__value__ == (4383045i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4381237i32;
                } else if (__value__ == (4383273i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._recordBuffer = ((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.__append__((34 : stdgo.GoUInt8)));
                    _gotoNext = 4382367i32;
                } else if (__value__ == (4383384i32)) {
                    ...
                    if (_errRead_1 != null) {
                        _gotoNext = 4383734i32;
                    } else {
                        _gotoNext = 4383771i32;
                    };
                } else if (__value__ == (4383734i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4381237i32;
                } else if (__value__ == (4383771i32)) {
                    ...
                    if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4383848i32;
                    } else {
                        _gotoNext = 4383897i32;
                    };
                } else if (__value__ == (4383848i32)) {
                    _pos_6._line++;
                    _pos_6._col = (1 : stdgo.GoInt);
                    _gotoNext = 4383897i32;
                } else if (__value__ == (4383897i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                    ...
                    _gotoNext = 4382367i32;
                } else if (__value__ == (4383958i32)) {
                    _gotoNext = 4383958i32;
                    if ((!(@:checkr _r ?? throw "null pointer dereference").lazyQuotes && (_errRead_1 == null) : Bool)) {
                        _gotoNext = 4384043i32;
                    } else {
                        _gotoNext = 4384172i32;
                    };
                } else if (__value__ == (4384043i32)) {
                    ...
                    _parseFieldBreak = true;
                    _gotoNext = 4381237i32;
                } else if (__value__ == (4384172i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4381237i32;
                } else if (__value__ == (4384333i32)) {
                    if (_err_2 == null) {
                        _gotoNext = 4384347i32;
                    } else {
                        _gotoNext = 4384495i32;
                    };
                } else if (__value__ == (4384347i32)) {
                    _err_2 = _errRead_1;
                    _gotoNext = 4384495i32;
                } else if (__value__ == (4384495i32)) {
                    ...
                    if ((_dst.capacity < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length) : Bool)) {
                        _gotoNext = 4384622i32;
                    } else {
                        _gotoNext = 4384672i32;
                    };
                } else if (__value__ == (4384622i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length)) {
                        _gotoNext = 4384800i32;
                    } else {
                        _gotoNext = 4384857i32;
                    };
                } else if (__value__ == (4384756i32)) {
                    ...
                    _preIdx_16 = _idx_18;
                    _i_17++;
                    _gotoNext = 4384801i32;
                } else if (__value__ == (4384800i32)) {
                    {
                        final __tmp__0 = 0i32;
