        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((((@:checkr _r ?? throw "null pointer dereference").comma == ((@:checkr _r ?? throw "null pointer dereference").comment) || !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comma) : Bool) || ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) : Bool)) {
                        _gotoNext = 4464689i32;
                    } else {
                        _gotoNext = 4464800i32;
                    };
                } else if (__value__ == (4464689i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : stdgo._internal.encoding.csv.Csv__errinvaliddelim._errInvalidDelim };
                    _gotoNext = 4464800i32;
                } else if (__value__ == (4464800i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 4464836i32;
                } else if (__value__ == (4464836i32)) {
                    if (_errRead_1 == null) {
                        _gotoNext = 4464855i32;
                    } else {
                        _gotoNext = 4465108i32;
                    };
                } else if (__value__ == (4464855i32)) {
                    {
                    ...
                    if ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && (stdgo._internal.encoding.csv.Csv__nextrune._nextRune(_line_0) == (@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) {
                        _gotoNext = 4464939i32;
                    } else {
                        _gotoNext = 4464995i32;
                    };
                } else if (__value__ == (4464939i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    var __blank__ = 0i32;
                    _gotoNext = 4464836i32;
                } else if (__value__ == (4464995i32)) {
                    if (((_errRead_1 == null) && (_line_0.length == stdgo._internal.encoding.csv.Csv__lengthnl._lengthNL(_line_0)) : Bool)) {
                        _gotoNext = 4465044i32;
                    } else {
                        _gotoNext = 4465098i32;
                    };
                } else if (__value__ == (4465044i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    var __blank__ = 0i32;
                    _gotoNext = 4464836i32;
                } else if (__value__ == (4465098i32)) {
                    _gotoNext = 4465108i32;
                } else if (__value__ == (4465108i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4465129i32;
                    } else {
                        _gotoNext = 4465194i32;
                    };
                } else if (__value__ == (4465129i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : _errRead_1 };
                    _gotoNext = 4465194i32;
                } else if (__value__ == (4465194i32)) {
                    ...
                    _gotoNext = 4465477i32;
                } else if (__value__ == (4465477i32)) {
                    var __blank__ = 0i32;
                    _parseFieldBreak = false;
                    _gotoNext = 4465490i32;
                } else if (__value__ == (4465490i32)) {
                    if (!_parseFieldBreak) {
                        _gotoNext = 4465494i32;
                    } else {
                        _gotoNext = 4468586i32;
                    };
                } else if (__value__ == (4465494i32)) {
                    if ((@:checkr _r ?? throw "null pointer dereference").trimLeadingSpace) {
                        _gotoNext = 4465520i32;
                    } else {
                        _gotoNext = 4465717i32;
                    };
                } else if (__value__ == (4465520i32)) {
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4465854i32;
                    } else {
                        _gotoNext = 4465888i32;
                    };
                } else if (__value__ == (4465854i32)) {
                    _field_9 = (_field_9.__slice__(0, _i_8) : stdgo.Slice<stdgo.GoUInt8>);
                    _gotoNext = 4466004i32;
                } else if (__value__ == (4465888i32)) {
                    _gotoNext = 4465888i32;
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4466404i32;
                    } else {
                        _gotoNext = 4466495i32;
                    };
                } else if (__value__ == (4466404i32)) {
                    ...
                    _gotoNext = 4465490i32;
                } else if (__value__ == (4466495i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4465490i32;
                } else if (__value__ == (4466521i32)) {
                    _gotoNext = 4466521i32;
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 4466620i32;
                } else if (__value__ == (4466620i32)) {
                    if (true) {
                        _gotoNext = 4466624i32;
                    } else {
                        _gotoNext = 4465490i32;
                    };
                } else if (__value__ == (4466624i32)) {
                    _i_13 = stdgo._internal.bytes.Bytes_indexbyte.indexByte(_line_0, (34 : stdgo.GoUInt8));
                    if ((_i_13 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4466676i32;
                    } else if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4467860i32;
                    } else {
                        _gotoNext = 4468211i32;
                    };
                } else if (__value__ == (4466676i32)) {
                    ...
                    _gotoNext = 4465490i32;
                } else if (__value__ == (4467298i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4465490i32;
                } else if (__value__ == (4467526i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._recordBuffer = ((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.__append__((34 : stdgo.GoUInt8)));
                    _gotoNext = 4466620i32;
                } else if (__value__ == (4467637i32)) {
                    ...
                    if (_errRead_1 != null) {
                        _gotoNext = 4467987i32;
                    } else {
                        _gotoNext = 4468024i32;
                    };
                } else if (__value__ == (4467987i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4465490i32;
                } else if (__value__ == (4468024i32)) {
                    ...
                    if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4468101i32;
                    } else {
                        _gotoNext = 4468150i32;
                    };
                } else if (__value__ == (4468101i32)) {
                    _pos_6._line++;
                    _pos_6._col = (1 : stdgo.GoInt);
                    _gotoNext = 4468150i32;
                } else if (__value__ == (4468150i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4468171i32;
                    } else {
                        _gotoNext = 4466620i32;
                    };
                } else if (__value__ == (4468171i32)) {
                    _errRead_1 = (null : stdgo.Error);
                    _gotoNext = 4466620i32;
                } else if (__value__ == (4468211i32)) {
                    _gotoNext = 4468211i32;
                    if ((!(@:checkr _r ?? throw "null pointer dereference").lazyQuotes && (_errRead_1 == null) : Bool)) {
                        _gotoNext = 4468296i32;
                    } else {
                        _gotoNext = 4468425i32;
                    };
                } else if (__value__ == (4468296i32)) {
                    ...
                    _parseFieldBreak = true;
                    _gotoNext = 4465490i32;
                } else if (__value__ == (4468425i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4465490i32;
                } else if (__value__ == (4468586i32)) {
                    if (_err_2 == null) {
                        _gotoNext = 4468600i32;
                    } else {
                        _gotoNext = 4468748i32;
                    };
                } else if (__value__ == (4468600i32)) {
                    _err_2 = _errRead_1;
                    _gotoNext = 4468748i32;
                } else if (__value__ == (4468748i32)) {
                    ...
                    if ((_dst.capacity < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length) : Bool)) {
                        _gotoNext = 4468875i32;
                    } else {
                        _gotoNext = 4468925i32;
                    };
                } else if (__value__ == (4468875i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length)) {
                        _gotoNext = 4469053i32;
                    } else {
                        _gotoNext = 4469110i32;
                    };
                } else if (__value__ == (4469009i32)) {
                    ...
                    _preIdx_16 = _idx_18;
                    _i_17++;
                    _gotoNext = 4469054i32;
                } else if (__value__ == (4469053i32)) {
                    {
                        final __tmp__0 = 0i32;
