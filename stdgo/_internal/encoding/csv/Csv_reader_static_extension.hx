        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((((@:checkr _r ?? throw "null pointer dereference").comma == ((@:checkr _r ?? throw "null pointer dereference").comment) || !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comma) : Bool) || ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) : Bool)) {
                        _gotoNext = 4240605i32;
                    } else {
                        _gotoNext = 4240716i32;
                    };
                } else if (__value__ == (4240605i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : stdgo._internal.encoding.csv.Csv__errinvaliddelim._errInvalidDelim };
                    _gotoNext = 4240716i32;
                } else if (__value__ == (4240716i32)) {
                    0i32;
                    _gotoNext = 4240752i32;
                } else if (__value__ == (4240752i32)) {
                    if (_errRead_1 == null) {
                        _gotoNext = 4240771i32;
                    } else {
                        _gotoNext = 4241024i32;
                    };
                } else if (__value__ == (4240771i32)) {
                    {
                    ...
                    if ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && (stdgo._internal.encoding.csv.Csv__nextrune._nextRune(_line_0) == (@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) {
                        _gotoNext = 4240855i32;
                    } else {
                        _gotoNext = 4240911i32;
                    };
                } else if (__value__ == (4240855i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    0i32;
                    _gotoNext = 4240752i32;
                } else if (__value__ == (4240911i32)) {
                    if (((_errRead_1 == null) && (_line_0.length == stdgo._internal.encoding.csv.Csv__lengthnl._lengthNL(_line_0)) : Bool)) {
                        _gotoNext = 4240960i32;
                    } else {
                        _gotoNext = 4241014i32;
                    };
                } else if (__value__ == (4240960i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    0i32;
                    _gotoNext = 4240752i32;
                } else if (__value__ == (4241014i32)) {
                    _gotoNext = 4241024i32;
                } else if (__value__ == (4241024i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4241045i32;
                    } else {
                        _gotoNext = 4241110i32;
                    };
                } else if (__value__ == (4241045i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : _errRead_1 };
                    _gotoNext = 4241110i32;
                } else if (__value__ == (4241110i32)) {
                    ...
                    _gotoNext = 4241393i32;
                } else if (__value__ == (4241393i32)) {
                    0i32;
                    _parseFieldBreak = false;
                    _gotoNext = 4241406i32;
                } else if (__value__ == (4241406i32)) {
                    if (!_parseFieldBreak) {
                        _gotoNext = 4241410i32;
                    } else {
                        _gotoNext = 4244502i32;
                    };
                } else if (__value__ == (4241410i32)) {
                    if ((@:checkr _r ?? throw "null pointer dereference").trimLeadingSpace) {
                        _gotoNext = 4241436i32;
                    } else {
                        _gotoNext = 4241633i32;
                    };
                } else if (__value__ == (4241436i32)) {
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4241770i32;
                    } else {
                        _gotoNext = 4241804i32;
                    };
                } else if (__value__ == (4241770i32)) {
                    _field_9 = (_field_9.__slice__(0, _i_8) : stdgo.Slice<stdgo.GoUInt8>);
                    _gotoNext = 4241920i32;
                } else if (__value__ == (4241804i32)) {
                    _gotoNext = 4241804i32;
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4242320i32;
                    } else {
                        _gotoNext = 4242411i32;
                    };
                } else if (__value__ == (4242320i32)) {
                    ...
                    _gotoNext = 4241406i32;
                } else if (__value__ == (4242411i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4241406i32;
                } else if (__value__ == (4242437i32)) {
                    _gotoNext = 4242437i32;
                    ...
                    0i32;
                    _gotoNext = 4242536i32;
                } else if (__value__ == (4242536i32)) {
                    if (true) {
                        _gotoNext = 4242540i32;
                    } else {
                        _gotoNext = 4241406i32;
                    };
                } else if (__value__ == (4242540i32)) {
                    _i_13 = stdgo._internal.bytes.Bytes_indexbyte.indexByte(_line_0, (34 : stdgo.GoUInt8));
                    if ((_i_13 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4242592i32;
                    } else if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4243776i32;
                    } else {
                        _gotoNext = 4244127i32;
                    };
                } else if (__value__ == (4242592i32)) {
                    ...
                    _gotoNext = 4241406i32;
                } else if (__value__ == (4243214i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4241406i32;
                } else if (__value__ == (4243442i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._recordBuffer = ((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.__append__((34 : stdgo.GoUInt8)));
                    _gotoNext = 4242536i32;
                } else if (__value__ == (4243553i32)) {
                    ...
                    if (_errRead_1 != null) {
                        _gotoNext = 4243903i32;
                    } else {
                        _gotoNext = 4243940i32;
                    };
                } else if (__value__ == (4243903i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4241406i32;
                } else if (__value__ == (4243940i32)) {
                    ...
                    if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4244017i32;
                    } else {
                        _gotoNext = 4244066i32;
                    };
                } else if (__value__ == (4244017i32)) {
                    _pos_6._line++;
                    _pos_6._col = (1 : stdgo.GoInt);
                    _gotoNext = 4244066i32;
                } else if (__value__ == (4244066i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4244087i32;
                    } else {
                        _gotoNext = 4242536i32;
                    };
                } else if (__value__ == (4244087i32)) {
                    _errRead_1 = (null : stdgo.Error);
                    _gotoNext = 4242536i32;
                } else if (__value__ == (4244127i32)) {
                    _gotoNext = 4244127i32;
                    if ((!(@:checkr _r ?? throw "null pointer dereference").lazyQuotes && (_errRead_1 == null) : Bool)) {
                        _gotoNext = 4244212i32;
                    } else {
                        _gotoNext = 4244341i32;
                    };
                } else if (__value__ == (4244212i32)) {
                    ...
                    _parseFieldBreak = true;
                    _gotoNext = 4241406i32;
                } else if (__value__ == (4244341i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4241406i32;
                } else if (__value__ == (4244502i32)) {
                    if (_err_2 == null) {
                        _gotoNext = 4244516i32;
                    } else {
                        _gotoNext = 4244664i32;
                    };
                } else if (__value__ == (4244516i32)) {
                    _err_2 = _errRead_1;
                    _gotoNext = 4244664i32;
                } else if (__value__ == (4244664i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length)) {
                        _gotoNext = 4244969i32;
                    } else {
                        _gotoNext = 4245026i32;
                    };
                } else if (__value__ == (4244925i32)) {
