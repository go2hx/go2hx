        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((((@:checkr _r ?? throw "null pointer dereference").comma == ((@:checkr _r ?? throw "null pointer dereference").comment) || !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comma) : Bool) || ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) : Bool)) {
                        _gotoNext = 4182608i32;
                    } else {
                        _gotoNext = 4182719i32;
                    };
                } else if (__value__ == (4182608i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : stdgo._internal.encoding.csv.Csv__errinvaliddelim._errInvalidDelim };
                    _gotoNext = 4182719i32;
                } else if (__value__ == (4182719i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 4182755i32;
                } else if (__value__ == (4182755i32)) {
                    if (_errRead_1 == null) {
                        _gotoNext = 4182774i32;
                    } else {
                        _gotoNext = 4183027i32;
                    };
                } else if (__value__ == (4182774i32)) {
                    {
                    ...
                    _gotoNext = 4183396i32;
                } else if (__value__ == (4183396i32)) {
                    var __blank__ = 0i32;
                    _parseFieldBreak = false;
                    _gotoNext = 4183409i32;
                } else if (__value__ == (4183409i32)) {
                    if (!_parseFieldBreak) {
                        _gotoNext = 4183413i32;
                    } else {
                        _gotoNext = 4186505i32;
                    };
                } else if (__value__ == (4183413i32)) {
                    if ((@:checkr _r ?? throw "null pointer dereference").trimLeadingSpace) {
                        _gotoNext = 4183439i32;
                    } else {
                        _gotoNext = 4183636i32;
                    };
                } else if (__value__ == (4183439i32)) {
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4183773i32;
                    } else {
                        _gotoNext = 4183807i32;
                    };
                } else if (__value__ == (4183773i32)) {
                    _field_9 = (_field_9.__slice__(0, _i_8) : stdgo.Slice<stdgo.GoUInt8>);
                    _gotoNext = 4183923i32;
                } else if (__value__ == (4183807i32)) {
                    _gotoNext = 4183807i32;
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4184323i32;
                    } else {
                        _gotoNext = 4184414i32;
                    };
                } else if (__value__ == (4184323i32)) {
                    ...
                    _gotoNext = 4183409i32;
                } else if (__value__ == (4184414i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4183409i32;
                } else if (__value__ == (4184440i32)) {
                    _gotoNext = 4184440i32;
                    ...
                    if (_errRead_1 != null) {
                        _gotoNext = 4185906i32;
                    } else {
                        _gotoNext = 4185943i32;
                    };
                } else if (__value__ == (4185906i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4183409i32;
                } else if (__value__ == (4185943i32)) {
                    ...
                    if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4186020i32;
                    } else {
                        _gotoNext = 4186069i32;
                    };
                } else if (__value__ == (4186020i32)) {
                    _pos_6._line++;
                    _pos_6._col = (1 : stdgo.GoInt);
                    _gotoNext = 4186069i32;
                } else if (__value__ == (4186069i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4186090i32;
                    } else {
                        _gotoNext = 4184539i32;
                    };
                } else if (__value__ == (4186090i32)) {
                    ...
                    if ((!(@:checkr _r ?? throw "null pointer dereference").lazyQuotes && (_errRead_1 == null) : Bool)) {
                        _gotoNext = 4186215i32;
                    } else {
                        _gotoNext = 4186344i32;
                    };
                } else if (__value__ == (4186215i32)) {
                    ...
                    _parseFieldBreak = true;
                    _gotoNext = 4183409i32;
                } else if (__value__ == (4186505i32)) {
                    if (_err_2 == null) {
                        _gotoNext = 4186519i32;
                    } else {
                        _gotoNext = 4186667i32;
                    };
                } else if (__value__ == (4186519i32)) {
                    _err_2 = _errRead_1;
                    _gotoNext = 4186667i32;
                } else if (__value__ == (4186667i32)) {
                    ...
                    if ((_dst.capacity < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length) : Bool)) {
                        _gotoNext = 4186794i32;
                    } else {
                        _gotoNext = 4186844i32;
                    };
                } else if (__value__ == (4186794i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length)) {
                        _gotoNext = 4186972i32;
                    } else {
                        _gotoNext = 4187029i32;
                    };
                } else if (__value__ == (4186928i32)) {
