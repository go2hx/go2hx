        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((((@:checkr _r ?? throw "null pointer dereference").comma == ((@:checkr _r ?? throw "null pointer dereference").comment) || !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comma) : Bool) || ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) : Bool)) {
                        _gotoNext = 4185823i32;
                    } else {
                        _gotoNext = 4185934i32;
                    };
                } else if (__value__ == (4185823i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : stdgo._internal.encoding.csv.Csv__errinvaliddelim._errInvalidDelim };
                    _gotoNext = 4185934i32;
                } else if (__value__ == (4185934i32)) {
                    0i32;
                    _gotoNext = 4185970i32;
                } else if (__value__ == (4185970i32)) {
                    if (_errRead_1 == null) {
                        _gotoNext = 4185989i32;
                    } else {
                        _gotoNext = 4186242i32;
                    };
                } else if (__value__ == (4185989i32)) {
                    {
                    ...
                    if ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && (stdgo._internal.encoding.csv.Csv__nextrune._nextRune(_line_0) == (@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) {
                        _gotoNext = 4186073i32;
                    } else {
                        _gotoNext = 4186129i32;
                    };
                } else if (__value__ == (4186073i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    0i32;
                    _gotoNext = 4185970i32;
                } else if (__value__ == (4186129i32)) {
                    if (((_errRead_1 == null) && (_line_0.length == stdgo._internal.encoding.csv.Csv__lengthnl._lengthNL(_line_0)) : Bool)) {
                        _gotoNext = 4186178i32;
                    } else {
                        _gotoNext = 4186232i32;
                    };
                } else if (__value__ == (4186178i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    0i32;
                    _gotoNext = 4185970i32;
                } else if (__value__ == (4186232i32)) {
                    _gotoNext = 4186242i32;
                } else if (__value__ == (4186242i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4186263i32;
                    } else {
                        _gotoNext = 4186328i32;
                    };
                } else if (__value__ == (4186263i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : _errRead_1 };
                    _gotoNext = 4186328i32;
                } else if (__value__ == (4186328i32)) {
                    ...
                    _gotoNext = 4186611i32;
                } else if (__value__ == (4186611i32)) {
                    0i32;
                    _parseFieldBreak = false;
                    _gotoNext = 4186624i32;
                } else if (__value__ == (4186624i32)) {
                    if (!_parseFieldBreak) {
                        _gotoNext = 4186628i32;
                    } else {
                        _gotoNext = 4189720i32;
                    };
                } else if (__value__ == (4186628i32)) {
                    if ((@:checkr _r ?? throw "null pointer dereference").trimLeadingSpace) {
                        _gotoNext = 4186654i32;
                    } else {
                        _gotoNext = 4186851i32;
                    };
                } else if (__value__ == (4186654i32)) {
                    ...
                    if ((_i_7 < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4186755i32;
                    } else {
                        _gotoNext = 4186813i32;
                    };
                } else if (__value__ == (4186755i32)) {
                    _i_7 = (_line_0.length);
                    _pos_6._col = (_pos_6._col - (stdgo._internal.encoding.csv.Csv__lengthnl._lengthNL(_line_0)) : stdgo.GoInt);
                    _gotoNext = 4186813i32;
                } else if (__value__ == (4186813i32)) {
                    ...
                    if (((_line_0.length == (0 : stdgo.GoInt)) || (_line_0[(0 : stdgo.GoInt)] != (34 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4186887i32;
                    } else {
                        _gotoNext = 4187655i32;
                    };
                } else if (__value__ == (4186887i32)) {
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4186988i32;
                    } else {
                        _gotoNext = 4187022i32;
                    };
                } else if (__value__ == (4186988i32)) {
                    _field_9 = (_field_9.__slice__(0, _i_8) : stdgo.Slice<stdgo.GoUInt8>);
                    _gotoNext = 4187138i32;
                } else if (__value__ == (4187022i32)) {
                    _gotoNext = 4187022i32;
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4187538i32;
                    } else {
                        _gotoNext = 4187629i32;
                    };
                } else if (__value__ == (4187538i32)) {
                    ...
                    _gotoNext = 4186624i32;
                } else if (__value__ == (4187629i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4186624i32;
                } else if (__value__ == (4187655i32)) {
                    _gotoNext = 4187655i32;
                    ...
                    0i32;
                    _gotoNext = 4187754i32;
                } else if (__value__ == (4187754i32)) {
                    if (true) {
                    ...
                    if ((_i_13 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4187810i32;
                    } else if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4188994i32;
                    } else {
                        _gotoNext = 4189345i32;
                    };
                } else if (__value__ == (4187810i32)) {
                    ...
                    _gotoNext = 4186624i32;
                } else if (__value__ == (4188432i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4186624i32;
                } else if (__value__ == (4188660i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._recordBuffer = ((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.__append__((34 : stdgo.GoUInt8)));
                    _gotoNext = 4187754i32;
                } else if (__value__ == (4188771i32)) {
                    ...
                    if (_errRead_1 != null) {
                        _gotoNext = 4189121i32;
                    } else {
                        _gotoNext = 4189158i32;
                    };
                } else if (__value__ == (4189121i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4186624i32;
                } else if (__value__ == (4189158i32)) {
                    ...
                    if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4189235i32;
                    } else {
                        _gotoNext = 4189284i32;
                    };
                } else if (__value__ == (4189235i32)) {
                    _pos_6._line++;
                    _pos_6._col = (1 : stdgo.GoInt);
                    _gotoNext = 4189284i32;
                } else if (__value__ == (4189284i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4189305i32;
                    } else {
                        _gotoNext = 4187754i32;
                    };
                } else if (__value__ == (4189305i32)) {
                    _errRead_1 = (null : stdgo.Error);
                    _gotoNext = 4187754i32;
                } else if (__value__ == (4189345i32)) {
                    _gotoNext = 4189345i32;
                    if ((!(@:checkr _r ?? throw "null pointer dereference").lazyQuotes && (_errRead_1 == null) : Bool)) {
                        _gotoNext = 4189430i32;
                    } else {
                        _gotoNext = 4189559i32;
                    };
                } else if (__value__ == (4189430i32)) {
                    ...
                    if (_err_2 == null) {
                        _gotoNext = 4189734i32;
                    } else {
                        _gotoNext = 4189882i32;
                    };
                } else if (__value__ == (4189734i32)) {
                    _err_2 = _errRead_1;
                    _gotoNext = 4189882i32;
                } else if (__value__ == (4189882i32)) {
                    ...
                    if ((_dst.capacity < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length) : Bool)) {
                        _gotoNext = 4190009i32;
                    } else {
                        _gotoNext = 4190059i32;
                    };
                } else if (__value__ == (4190009i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length)) {
                        _gotoNext = 4190187i32;
                    } else {
                        _gotoNext = 4190244i32;
                    };
                } else if (__value__ == (4190143i32)) {
                    ...
                    _preIdx_16 = _idx_18;
                    _i_17++;
                    _gotoNext = 4190188i32;
                } else if (__value__ == (4190187i32)) {
                    {
                        final __tmp__0 = 0i32;
