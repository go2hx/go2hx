        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((((@:checkr _r ?? throw "null pointer dereference").comma == ((@:checkr _r ?? throw "null pointer dereference").comment) || !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comma) : Bool) || ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) : Bool)) {
                        _gotoNext = 4199999i32;
                    } else {
                        _gotoNext = 4200110i32;
                    };
                } else if (__value__ == (4199999i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : stdgo._internal.encoding.csv.Csv__errinvaliddelim._errInvalidDelim };
                    _gotoNext = 4200110i32;
                } else if (__value__ == (4200110i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 4200146i32;
                } else if (__value__ == (4200146i32)) {
                    if (_errRead_1 == null) {
                        _gotoNext = 4200165i32;
                    } else {
                        _gotoNext = 4200418i32;
                    };
                } else if (__value__ == (4200165i32)) {
                    {
                    ...
                    _gotoNext = 4200787i32;
                } else if (__value__ == (4200787i32)) {
                    var __blank__ = 0i32;
                    _parseFieldBreak = false;
                    _gotoNext = 4200800i32;
                } else if (__value__ == (4200800i32)) {
                    if (!_parseFieldBreak) {
                        _gotoNext = 4200804i32;
                    } else {
                        _gotoNext = 4203896i32;
                    };
                } else if (__value__ == (4200804i32)) {
                    if ((@:checkr _r ?? throw "null pointer dereference").trimLeadingSpace) {
                        _gotoNext = 4200830i32;
                    } else {
                        _gotoNext = 4201027i32;
                    };
                } else if (__value__ == (4200830i32)) {
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4201164i32;
                    } else {
                        _gotoNext = 4201198i32;
                    };
                } else if (__value__ == (4201164i32)) {
                    _field_9 = (_field_9.__slice__(0, _i_8) : stdgo.Slice<stdgo.GoUInt8>);
                    _gotoNext = 4201314i32;
                } else if (__value__ == (4201198i32)) {
                    _gotoNext = 4201198i32;
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4201714i32;
                    } else {
                        _gotoNext = 4201805i32;
                    };
                } else if (__value__ == (4201714i32)) {
                    ...
                    _gotoNext = 4200800i32;
                } else if (__value__ == (4201805i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4200800i32;
                } else if (__value__ == (4201831i32)) {
                    _gotoNext = 4201831i32;
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 4201930i32;
                } else if (__value__ == (4201930i32)) {
                    if (true) {
                        _gotoNext = 4201934i32;
                    } else {
                        _gotoNext = 4200800i32;
                    };
                } else if (__value__ == (4201934i32)) {
                    _i_13 = stdgo._internal.bytes.Bytes_indexbyte.indexByte(_line_0, (34 : stdgo.GoUInt8));
                    if ((_i_13 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4201986i32;
                    } else if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4203170i32;
                    } else {
                        _gotoNext = 4203521i32;
                    };
                } else if (__value__ == (4201986i32)) {
                    ...
                    _gotoNext = 4200800i32;
                } else if (__value__ == (4202608i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4200800i32;
                } else if (__value__ == (4202836i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._recordBuffer = ((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.__append__((34 : stdgo.GoUInt8)));
                    _gotoNext = 4201930i32;
                } else if (__value__ == (4202947i32)) {
                    ...
                    if (_errRead_1 != null) {
                        _gotoNext = 4203297i32;
                    } else {
                        _gotoNext = 4203334i32;
                    };
                } else if (__value__ == (4203297i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4200800i32;
                } else if (__value__ == (4203334i32)) {
                    ...
                    if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4203411i32;
                    } else {
                        _gotoNext = 4203460i32;
                    };
                } else if (__value__ == (4203411i32)) {
                    _pos_6._line++;
                    _pos_6._col = (1 : stdgo.GoInt);
                    _gotoNext = 4203460i32;
                } else if (__value__ == (4203460i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4203481i32;
                    } else {
                        _gotoNext = 4201930i32;
                    };
                } else if (__value__ == (4203481i32)) {
                    _errRead_1 = (null : stdgo.Error);
                    _gotoNext = 4201930i32;
                } else if (__value__ == (4203521i32)) {
                    _gotoNext = 4203521i32;
                    if ((!(@:checkr _r ?? throw "null pointer dereference").lazyQuotes && (_errRead_1 == null) : Bool)) {
                        _gotoNext = 4203606i32;
                    } else {
                        _gotoNext = 4203735i32;
                    };
                } else if (__value__ == (4203606i32)) {
                    ...
                    _parseFieldBreak = true;
                    _gotoNext = 4200800i32;
                } else if (__value__ == (4203735i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4200800i32;
                } else if (__value__ == (4203896i32)) {
                    if (_err_2 == null) {
                        _gotoNext = 4203910i32;
                    } else {
                        _gotoNext = 4204058i32;
                    };
                } else if (__value__ == (4203910i32)) {
                    _err_2 = _errRead_1;
                    _gotoNext = 4204058i32;
                } else if (__value__ == (4204058i32)) {
                    ...
                    if ((_dst.capacity < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length) : Bool)) {
                        _gotoNext = 4204185i32;
                    } else {
                        _gotoNext = 4204235i32;
                    };
                } else if (__value__ == (4204185i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length)) {
                        _gotoNext = 4204363i32;
                    } else {
                        _gotoNext = 4204420i32;
                    };
                } else if (__value__ == (4204319i32)) {
                    ...
                    _preIdx_16 = _idx_18;
                    _i_17++;
                    _gotoNext = 4204364i32;
                } else if (__value__ == (4204363i32)) {
                    {
                        final __tmp__0 = 0i32;
