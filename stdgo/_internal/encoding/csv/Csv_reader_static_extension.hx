        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((((@:checkr _r ?? throw "null pointer dereference").comma == ((@:checkr _r ?? throw "null pointer dereference").comment) || !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comma) : Bool) || ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) : Bool)) {
                        _gotoNext = 4304598i32;
                    } else {
                        _gotoNext = 4304709i32;
                    };
                } else if (__value__ == (4304598i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : stdgo._internal.encoding.csv.Csv__errinvaliddelim._errInvalidDelim };
                    _gotoNext = 4304709i32;
                } else if (__value__ == (4304709i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 4304745i32;
                } else if (__value__ == (4304745i32)) {
                    if (_errRead_1 == null) {
                        _gotoNext = 4304764i32;
                    } else {
                        _gotoNext = 4305017i32;
                    };
                } else if (__value__ == (4304764i32)) {
                    {
                    ...
                    if ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && (stdgo._internal.encoding.csv.Csv__nextrune._nextRune(_line_0) == (@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) {
                        _gotoNext = 4304848i32;
                    } else {
                        _gotoNext = 4304904i32;
                    };
                } else if (__value__ == (4304848i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    var __blank__ = 0i32;
                    _gotoNext = 4304745i32;
                } else if (__value__ == (4304904i32)) {
                    if (((_errRead_1 == null) && (_line_0.length == stdgo._internal.encoding.csv.Csv__lengthnl._lengthNL(_line_0)) : Bool)) {
                        _gotoNext = 4304953i32;
                    } else {
                        _gotoNext = 4305007i32;
                    };
                } else if (__value__ == (4304953i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    var __blank__ = 0i32;
                    _gotoNext = 4304745i32;
                } else if (__value__ == (4305007i32)) {
                    _gotoNext = 4305017i32;
                } else if (__value__ == (4305017i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4305038i32;
                    } else {
                        _gotoNext = 4305103i32;
                    };
                } else if (__value__ == (4305038i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : _errRead_1 };
                    _gotoNext = 4305103i32;
                } else if (__value__ == (4305103i32)) {
                    ...
                    _gotoNext = 4305386i32;
                } else if (__value__ == (4305386i32)) {
                    var __blank__ = 0i32;
                    _parseFieldBreak = false;
                    _gotoNext = 4305399i32;
                } else if (__value__ == (4305399i32)) {
                    if (!_parseFieldBreak) {
                        _gotoNext = 4305403i32;
                    } else {
                        _gotoNext = 4308495i32;
                    };
                } else if (__value__ == (4305403i32)) {
                    if ((@:checkr _r ?? throw "null pointer dereference").trimLeadingSpace) {
                        _gotoNext = 4305429i32;
                    } else {
                        _gotoNext = 4305626i32;
                    };
                } else if (__value__ == (4305429i32)) {
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4305763i32;
                    } else {
                        _gotoNext = 4305797i32;
                    };
                } else if (__value__ == (4305763i32)) {
                    _field_9 = (_field_9.__slice__(0, _i_8) : stdgo.Slice<stdgo.GoUInt8>);
                    _gotoNext = 4305913i32;
                } else if (__value__ == (4305797i32)) {
                    _gotoNext = 4305797i32;
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4306313i32;
                    } else {
                        _gotoNext = 4306404i32;
                    };
                } else if (__value__ == (4306313i32)) {
                    ...
                    _gotoNext = 4305399i32;
                } else if (__value__ == (4306404i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4305399i32;
                } else if (__value__ == (4306430i32)) {
                    _gotoNext = 4306430i32;
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 4306529i32;
                } else if (__value__ == (4306529i32)) {
                    if (true) {
                        _gotoNext = 4306533i32;
                    } else {
                        _gotoNext = 4305399i32;
                    };
                } else if (__value__ == (4306533i32)) {
                    _i_13 = stdgo._internal.bytes.Bytes_indexbyte.indexByte(_line_0, (34 : stdgo.GoUInt8));
                    if ((_i_13 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4306585i32;
                    } else if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4307769i32;
                    } else {
                        _gotoNext = 4308120i32;
                    };
                } else if (__value__ == (4306585i32)) {
                    ...
                    _gotoNext = 4305399i32;
                } else if (__value__ == (4307207i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4305399i32;
                } else if (__value__ == (4307435i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._recordBuffer = ((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.__append__((34 : stdgo.GoUInt8)));
                    _gotoNext = 4306529i32;
                } else if (__value__ == (4307546i32)) {
                    ...
                    if (_errRead_1 != null) {
                        _gotoNext = 4307896i32;
                    } else {
                        _gotoNext = 4307933i32;
                    };
                } else if (__value__ == (4307896i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4305399i32;
                } else if (__value__ == (4307933i32)) {
                    ...
                    if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4308010i32;
                    } else {
                        _gotoNext = 4308059i32;
                    };
                } else if (__value__ == (4308010i32)) {
                    _pos_6._line++;
                    _pos_6._col = (1 : stdgo.GoInt);
                    _gotoNext = 4308059i32;
                } else if (__value__ == (4308059i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4308080i32;
                    } else {
                        _gotoNext = 4306529i32;
                    };
                } else if (__value__ == (4308080i32)) {
                    _errRead_1 = (null : stdgo.Error);
                    _gotoNext = 4306529i32;
                } else if (__value__ == (4308120i32)) {
                    _gotoNext = 4308120i32;
                    if ((!(@:checkr _r ?? throw "null pointer dereference").lazyQuotes && (_errRead_1 == null) : Bool)) {
                        _gotoNext = 4308205i32;
                    } else {
                        _gotoNext = 4308334i32;
                    };
                } else if (__value__ == (4308205i32)) {
                    ...
                    _parseFieldBreak = true;
                    _gotoNext = 4305399i32;
                } else if (__value__ == (4308334i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4305399i32;
                } else if (__value__ == (4308495i32)) {
                    if (_err_2 == null) {
                        _gotoNext = 4308509i32;
                    } else {
                        _gotoNext = 4308657i32;
                    };
                } else if (__value__ == (4308509i32)) {
                    _err_2 = _errRead_1;
                    _gotoNext = 4308657i32;
                } else if (__value__ == (4308657i32)) {
                    ...
                    if ((_dst.capacity < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length) : Bool)) {
                        _gotoNext = 4308784i32;
                    } else {
                        _gotoNext = 4308834i32;
                    };
                } else if (__value__ == (4308784i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length)) {
                        ...
                        _gotoNext = 4309019i32;
                    };
                } else if (__value__ == (4308918i32)) {
