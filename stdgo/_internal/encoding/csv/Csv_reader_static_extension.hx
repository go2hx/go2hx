        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((((@:checkr _r ?? throw "null pointer dereference").comma == ((@:checkr _r ?? throw "null pointer dereference").comment) || !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comma) : Bool) || ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) : Bool)) {
                        _gotoNext = 4288875i32;
                    } else {
                        _gotoNext = 4288986i32;
                    };
                } else if (__value__ == (4288875i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : stdgo._internal.encoding.csv.Csv__errinvaliddelim._errInvalidDelim };
                    _gotoNext = 4288986i32;
                } else if (__value__ == (4288986i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 4289022i32;
                } else if (__value__ == (4289022i32)) {
                    if (_errRead_1 == null) {
                        _gotoNext = 4289041i32;
                    } else {
                        _gotoNext = 4289294i32;
                    };
                } else if (__value__ == (4289041i32)) {
                    {
                    ...
                    if ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && (stdgo._internal.encoding.csv.Csv__nextrune._nextRune(_line_0) == (@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) {
                        _gotoNext = 4289125i32;
                    } else {
                        _gotoNext = 4289181i32;
                    };
                } else if (__value__ == (4289125i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    var __blank__ = 0i32;
                    _gotoNext = 4289022i32;
                } else if (__value__ == (4289181i32)) {
                    if (((_errRead_1 == null) && (_line_0.length == stdgo._internal.encoding.csv.Csv__lengthnl._lengthNL(_line_0)) : Bool)) {
                        _gotoNext = 4289230i32;
                    } else {
                        _gotoNext = 4289284i32;
                    };
                } else if (__value__ == (4289230i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    var __blank__ = 0i32;
                    _gotoNext = 4289022i32;
                } else if (__value__ == (4289284i32)) {
                    _gotoNext = 4289294i32;
                } else if (__value__ == (4289294i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4289315i32;
                    } else {
                        _gotoNext = 4289380i32;
                    };
                } else if (__value__ == (4289315i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : _errRead_1 };
                    _gotoNext = 4289380i32;
                } else if (__value__ == (4289380i32)) {
                    ...
                    _gotoNext = 4289663i32;
                } else if (__value__ == (4289663i32)) {
                    var __blank__ = 0i32;
                    _parseFieldBreak = false;
                    _gotoNext = 4289676i32;
                } else if (__value__ == (4289676i32)) {
                    if (!_parseFieldBreak) {
                        _gotoNext = 4289680i32;
                    } else {
                        _gotoNext = 4292772i32;
                    };
                } else if (__value__ == (4289680i32)) {
                    if ((@:checkr _r ?? throw "null pointer dereference").trimLeadingSpace) {
                        _gotoNext = 4289706i32;
                    } else {
                        _gotoNext = 4289903i32;
                    };
                } else if (__value__ == (4289706i32)) {
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4290040i32;
                    } else {
                        _gotoNext = 4290074i32;
                    };
                } else if (__value__ == (4290040i32)) {
                    _field_9 = (_field_9.__slice__(0, _i_8) : stdgo.Slice<stdgo.GoUInt8>);
                    _gotoNext = 4290190i32;
                } else if (__value__ == (4290074i32)) {
                    _gotoNext = 4290074i32;
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4290590i32;
                    } else {
                        _gotoNext = 4290681i32;
                    };
                } else if (__value__ == (4290590i32)) {
                    ...
                    _gotoNext = 4289676i32;
                } else if (__value__ == (4290681i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4289676i32;
                } else if (__value__ == (4290707i32)) {
                    _gotoNext = 4290707i32;
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 4290806i32;
                } else if (__value__ == (4290806i32)) {
                    if (true) {
                        _gotoNext = 4290810i32;
                    } else {
                        _gotoNext = 4289676i32;
                    };
                } else if (__value__ == (4290810i32)) {
                    _i_13 = stdgo._internal.bytes.Bytes_indexbyte.indexByte(_line_0, (34 : stdgo.GoUInt8));
                    if ((_i_13 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4290862i32;
                    } else if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4292046i32;
                    } else {
                        _gotoNext = 4292397i32;
                    };
                } else if (__value__ == (4290862i32)) {
                    ...
                    _gotoNext = 4289676i32;
                } else if (__value__ == (4291484i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4289676i32;
                } else if (__value__ == (4291712i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._recordBuffer = ((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.__append__((34 : stdgo.GoUInt8)));
                    _gotoNext = 4290806i32;
                } else if (__value__ == (4291823i32)) {
                    ...
                    if (_errRead_1 != null) {
                        _gotoNext = 4292173i32;
                    } else {
                        _gotoNext = 4292210i32;
                    };
                } else if (__value__ == (4292173i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4289676i32;
                } else if (__value__ == (4292210i32)) {
                    ...
                    if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4292287i32;
                    } else {
                        _gotoNext = 4292336i32;
                    };
                } else if (__value__ == (4292287i32)) {
                    _pos_6._line++;
                    _pos_6._col = (1 : stdgo.GoInt);
                    _gotoNext = 4292336i32;
                } else if (__value__ == (4292336i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4292357i32;
                    } else {
                        _gotoNext = 4290806i32;
                    };
                } else if (__value__ == (4292357i32)) {
                    _errRead_1 = (null : stdgo.Error);
                    _gotoNext = 4290806i32;
                } else if (__value__ == (4292397i32)) {
                    _gotoNext = 4292397i32;
                    if ((!(@:checkr _r ?? throw "null pointer dereference").lazyQuotes && (_errRead_1 == null) : Bool)) {
                        _gotoNext = 4292482i32;
                    } else {
                        _gotoNext = 4292611i32;
                    };
                } else if (__value__ == (4292482i32)) {
                    ...
                    _parseFieldBreak = true;
                    _gotoNext = 4289676i32;
                } else if (__value__ == (4292611i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4289676i32;
                } else if (__value__ == (4292772i32)) {
                    if (_err_2 == null) {
                        _gotoNext = 4292786i32;
                    } else {
                        _gotoNext = 4292934i32;
                    };
                } else if (__value__ == (4292786i32)) {
                    _err_2 = _errRead_1;
                    _gotoNext = 4292934i32;
                } else if (__value__ == (4292934i32)) {
                    ...
                    if ((_dst.capacity < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length) : Bool)) {
                        _gotoNext = 4293061i32;
                    } else {
                        _gotoNext = 4293111i32;
                    };
                } else if (__value__ == (4293061i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length)) {
                        _gotoNext = 4293239i32;
                    } else {
                        _gotoNext = 4293296i32;
                    };
                } else if (__value__ == (4293195i32)) {
                    ...
                    _preIdx_16 = _idx_18;
                    _i_17++;
                    _gotoNext = 4293240i32;
                } else if (__value__ == (4293239i32)) {
                    {
                        final __tmp__0 = 0i32;
