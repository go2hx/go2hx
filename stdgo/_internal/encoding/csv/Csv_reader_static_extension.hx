        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((((@:checkr _r ?? throw "null pointer dereference").comma == ((@:checkr _r ?? throw "null pointer dereference").comment) || !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comma) : Bool) || ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) : Bool)) {
                        _gotoNext = 4248613i32;
                    } else {
                        _gotoNext = 4248724i32;
                    };
                } else if (__value__ == (4248613i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : stdgo._internal.encoding.csv.Csv__errinvaliddelim._errInvalidDelim };
                    _gotoNext = 4248724i32;
                } else if (__value__ == (4248724i32)) {
                    0i32;
                    _gotoNext = 4248760i32;
                } else if (__value__ == (4248760i32)) {
                    if (_errRead_1 == null) {
                        _gotoNext = 4248779i32;
                    } else {
                        _gotoNext = 4249032i32;
                    };
                } else if (__value__ == (4248779i32)) {
                    {
                    ...
                    if ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && (stdgo._internal.encoding.csv.Csv__nextrune._nextRune(_line_0) == (@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) {
                        _gotoNext = 4248863i32;
                    } else {
                        _gotoNext = 4248919i32;
                    };
                } else if (__value__ == (4248863i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    0i32;
                    _gotoNext = 4248760i32;
                } else if (__value__ == (4248919i32)) {
                    if (((_errRead_1 == null) && (_line_0.length == stdgo._internal.encoding.csv.Csv__lengthnl._lengthNL(_line_0)) : Bool)) {
                        _gotoNext = 4248968i32;
                    } else {
                        _gotoNext = 4249022i32;
                    };
                } else if (__value__ == (4248968i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    0i32;
                    _gotoNext = 4248760i32;
                } else if (__value__ == (4249022i32)) {
                    _gotoNext = 4249032i32;
                } else if (__value__ == (4249032i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4249053i32;
                    } else {
                        _gotoNext = 4249118i32;
                    };
                } else if (__value__ == (4249053i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : _errRead_1 };
                    _gotoNext = 4249118i32;
                } else if (__value__ == (4249118i32)) {
                    ...
                    _gotoNext = 4249401i32;
                } else if (__value__ == (4249401i32)) {
                    0i32;
                    _parseFieldBreak = false;
                    _gotoNext = 4249414i32;
                } else if (__value__ == (4249414i32)) {
                    if (!_parseFieldBreak) {
                        _gotoNext = 4249418i32;
                    } else {
                        _gotoNext = 4252510i32;
                    };
                } else if (__value__ == (4249418i32)) {
                    if ((@:checkr _r ?? throw "null pointer dereference").trimLeadingSpace) {
                        _gotoNext = 4249444i32;
                    } else {
                        _gotoNext = 4249641i32;
                    };
                } else if (__value__ == (4249444i32)) {
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4249778i32;
                    } else {
                        _gotoNext = 4249812i32;
                    };
                } else if (__value__ == (4249778i32)) {
                    _field_9 = (_field_9.__slice__(0, _i_8) : stdgo.Slice<stdgo.GoUInt8>);
                    _gotoNext = 4249928i32;
                } else if (__value__ == (4249812i32)) {
                    _gotoNext = 4249812i32;
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4250328i32;
                    } else {
                        _gotoNext = 4250419i32;
                    };
                } else if (__value__ == (4250328i32)) {
                    ...
                    _gotoNext = 4249414i32;
                } else if (__value__ == (4250419i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4249414i32;
                } else if (__value__ == (4250445i32)) {
                    _gotoNext = 4250445i32;
                    ...
                    0i32;
                    _gotoNext = 4250544i32;
                } else if (__value__ == (4250544i32)) {
                    if (true) {
                        _gotoNext = 4250548i32;
                    } else {
                        _gotoNext = 4249414i32;
                    };
                } else if (__value__ == (4250548i32)) {
                    _i_13 = stdgo._internal.bytes.Bytes_indexbyte.indexByte(_line_0, (34 : stdgo.GoUInt8));
                    if ((_i_13 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4250600i32;
                    } else if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4251784i32;
                    } else {
                        _gotoNext = 4252135i32;
                    };
                } else if (__value__ == (4250600i32)) {
                    ...
                    _gotoNext = 4249414i32;
                } else if (__value__ == (4251222i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__(((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length)) : stdgo.Slice<stdgo.GoInt>);
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()) : stdgo.Slice<stdgo._internal.encoding.csv.Csv_t_position.T_position>);
                    _parseFieldBreak = true;
                    _gotoNext = 4249414i32;
                } else if (__value__ == (4251450i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._recordBuffer = ((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.__append__((34 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>);
                    _gotoNext = 4250544i32;
                } else if (__value__ == (4251561i32)) {
                    ...
                    if (_errRead_1 != null) {
                        _gotoNext = 4251911i32;
                    } else {
                        _gotoNext = 4251948i32;
                    };
                } else if (__value__ == (4251911i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4249414i32;
                } else if (__value__ == (4251948i32)) {
                    ...
                    if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4252025i32;
                    } else {
                        _gotoNext = 4252074i32;
                    };
                } else if (__value__ == (4252025i32)) {
                    _pos_6._line++;
                    _pos_6._col = (1 : stdgo.GoInt);
                    _gotoNext = 4252074i32;
                } else if (__value__ == (4252074i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4252095i32;
                    } else {
                        _gotoNext = 4250544i32;
                    };
                } else if (__value__ == (4252095i32)) {
                    _errRead_1 = (null : stdgo.Error);
                    _gotoNext = 4250544i32;
                } else if (__value__ == (4252135i32)) {
                    _gotoNext = 4252135i32;
                    if ((!(@:checkr _r ?? throw "null pointer dereference").lazyQuotes && (_errRead_1 == null) : Bool)) {
                        _gotoNext = 4252220i32;
                    } else {
                        _gotoNext = 4252349i32;
                    };
                } else if (__value__ == (4252220i32)) {
                    ...
                    _parseFieldBreak = true;
                    _gotoNext = 4249414i32;
                } else if (__value__ == (4252349i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__(((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length)) : stdgo.Slice<stdgo.GoInt>);
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()) : stdgo.Slice<stdgo._internal.encoding.csv.Csv_t_position.T_position>);
                    _parseFieldBreak = true;
                    _gotoNext = 4249414i32;
                } else if (__value__ == (4252510i32)) {
                    if (_err_2 == null) {
                        _gotoNext = 4252524i32;
                    } else {
                        _gotoNext = 4252672i32;
                    };
                } else if (__value__ == (4252524i32)) {
                    _err_2 = _errRead_1;
                    _gotoNext = 4252672i32;
                } else if (__value__ == (4252672i32)) {
                    ...
                    if ((_dst.capacity < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length) : Bool)) {
                        _gotoNext = 4252799i32;
                    } else {
                        _gotoNext = 4252849i32;
                    };
                } else if (__value__ == (4252799i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length)) {
                        _gotoNext = 4252977i32;
                    } else {
                        _gotoNext = 4253034i32;
                    };
                } else if (__value__ == (4252933i32)) {
                    ...
                    _preIdx_16 = _idx_18;
                    _i_17++;
                    _gotoNext = 4252978i32;
                } else if (__value__ == (4252977i32)) {
                    {
                        final __tmp__0 = 0i32;
