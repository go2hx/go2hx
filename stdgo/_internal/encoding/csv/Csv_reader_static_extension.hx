        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((((@:checkr _r ?? throw "null pointer dereference").comma == ((@:checkr _r ?? throw "null pointer dereference").comment) || !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comma) : Bool) || ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) : Bool)) {
                        _gotoNext = 4292899i32;
                    } else {
                        _gotoNext = 4293010i32;
                    };
                } else if (__value__ == (4292899i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : stdgo._internal.encoding.csv.Csv__errinvaliddelim._errInvalidDelim };
                    _gotoNext = 4293010i32;
                } else if (__value__ == (4293010i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 4293046i32;
                } else if (__value__ == (4293046i32)) {
                    if (_errRead_1 == null) {
                        _gotoNext = 4293065i32;
                    } else {
                        _gotoNext = 4293318i32;
                    };
                } else if (__value__ == (4293065i32)) {
                    {
                    ...
                    if ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && (stdgo._internal.encoding.csv.Csv__nextrune._nextRune(_line_0) == (@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) {
                        _gotoNext = 4293149i32;
                    } else {
                        _gotoNext = 4293205i32;
                    };
                } else if (__value__ == (4293149i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    var __blank__ = 0i32;
                    _gotoNext = 4293046i32;
                } else if (__value__ == (4293205i32)) {
                    if (((_errRead_1 == null) && (_line_0.length == stdgo._internal.encoding.csv.Csv__lengthnl._lengthNL(_line_0)) : Bool)) {
                        _gotoNext = 4293254i32;
                    } else {
                        _gotoNext = 4293308i32;
                    };
                } else if (__value__ == (4293254i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    var __blank__ = 0i32;
                    _gotoNext = 4293046i32;
                } else if (__value__ == (4293308i32)) {
                    _gotoNext = 4293318i32;
                } else if (__value__ == (4293318i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4293339i32;
                    } else {
                        _gotoNext = 4293404i32;
                    };
                } else if (__value__ == (4293339i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : _errRead_1 };
                    _gotoNext = 4293404i32;
                } else if (__value__ == (4293404i32)) {
                    ...
                    _gotoNext = 4293687i32;
                } else if (__value__ == (4293687i32)) {
                    var __blank__ = 0i32;
                    _parseFieldBreak = false;
                    _gotoNext = 4293700i32;
                } else if (__value__ == (4293700i32)) {
                    if (!_parseFieldBreak) {
                        _gotoNext = 4293704i32;
                    } else {
                        _gotoNext = 4296796i32;
                    };
                } else if (__value__ == (4293704i32)) {
                    if ((@:checkr _r ?? throw "null pointer dereference").trimLeadingSpace) {
                        _gotoNext = 4293730i32;
                    } else {
                        _gotoNext = 4293927i32;
                    };
                } else if (__value__ == (4293730i32)) {
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4294064i32;
                    } else {
                        _gotoNext = 4294098i32;
                    };
                } else if (__value__ == (4294064i32)) {
                    _field_9 = (_field_9.__slice__(0, _i_8) : stdgo.Slice<stdgo.GoUInt8>);
                    _gotoNext = 4294214i32;
                } else if (__value__ == (4294098i32)) {
                    _gotoNext = 4294098i32;
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4294614i32;
                    } else {
                        _gotoNext = 4294705i32;
                    };
                } else if (__value__ == (4294614i32)) {
                    ...
                    _gotoNext = 4293700i32;
                } else if (__value__ == (4294705i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4293700i32;
                } else if (__value__ == (4294731i32)) {
                    _gotoNext = 4294731i32;
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 4294830i32;
                } else if (__value__ == (4294830i32)) {
                    if (true) {
                        _gotoNext = 4294834i32;
                    } else {
                        _gotoNext = 4293700i32;
                    };
                } else if (__value__ == (4294834i32)) {
                    _i_13 = stdgo._internal.bytes.Bytes_indexbyte.indexByte(_line_0, (34 : stdgo.GoUInt8));
                    if ((_i_13 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4294886i32;
                    } else if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4296070i32;
                    } else {
                        _gotoNext = 4296421i32;
                    };
                } else if (__value__ == (4294886i32)) {
                    ...
                    _gotoNext = 4293700i32;
                } else if (__value__ == (4295508i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4293700i32;
                } else if (__value__ == (4295736i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._recordBuffer = ((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.__append__((34 : stdgo.GoUInt8)));
                    _gotoNext = 4294830i32;
                } else if (__value__ == (4295847i32)) {
                    ...
                    if (_errRead_1 != null) {
                        _gotoNext = 4296197i32;
                    } else {
                        _gotoNext = 4296234i32;
                    };
                } else if (__value__ == (4296197i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4293700i32;
                } else if (__value__ == (4296234i32)) {
                    ...
                    if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4296311i32;
                    } else {
                        _gotoNext = 4296360i32;
                    };
                } else if (__value__ == (4296311i32)) {
                    _pos_6._line++;
                    _pos_6._col = (1 : stdgo.GoInt);
                    _gotoNext = 4296360i32;
                } else if (__value__ == (4296360i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4296381i32;
                    } else {
                        _gotoNext = 4294830i32;
                    };
                } else if (__value__ == (4296381i32)) {
                    _errRead_1 = (null : stdgo.Error);
                    _gotoNext = 4294830i32;
                } else if (__value__ == (4296421i32)) {
                    _gotoNext = 4296421i32;
                    if ((!(@:checkr _r ?? throw "null pointer dereference").lazyQuotes && (_errRead_1 == null) : Bool)) {
                        _gotoNext = 4296506i32;
                    } else {
                        _gotoNext = 4296635i32;
                    };
                } else if (__value__ == (4296506i32)) {
                    ...
                    _parseFieldBreak = true;
                    _gotoNext = 4293700i32;
                } else if (__value__ == (4296635i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4293700i32;
                } else if (__value__ == (4296796i32)) {
                    if (_err_2 == null) {
                        _gotoNext = 4296810i32;
                    } else {
                        _gotoNext = 4296958i32;
                    };
                } else if (__value__ == (4296810i32)) {
                    _err_2 = _errRead_1;
                    _gotoNext = 4296958i32;
                } else if (__value__ == (4296958i32)) {
                    ...
                    if ((_dst.capacity < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length) : Bool)) {
                        _gotoNext = 4297085i32;
                    } else {
                        _gotoNext = 4297135i32;
                    };
                } else if (__value__ == (4297085i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length)) {
                        _gotoNext = 4297263i32;
                    } else {
                        _gotoNext = 4297320i32;
                    };
                } else if (__value__ == (4297219i32)) {
                    ...
                    _preIdx_16 = _idx_18;
                    _i_17++;
                    _gotoNext = 4297264i32;
                } else if (__value__ == (4297263i32)) {
                    {
                        final __tmp__0 = 0i32;
