        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((((@:checkr _r ?? throw "null pointer dereference").comma == ((@:checkr _r ?? throw "null pointer dereference").comment) || !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comma) : Bool) || ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && !stdgo._internal.encoding.csv.Csv__validdelim._validDelim((@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) : Bool)) {
                        _gotoNext = 4207174i32;
                    } else {
                        _gotoNext = 4207285i32;
                    };
                } else if (__value__ == (4207174i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : stdgo._internal.encoding.csv.Csv__errinvaliddelim._errInvalidDelim };
                    _gotoNext = 4207285i32;
                } else if (__value__ == (4207285i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 4207321i32;
                } else if (__value__ == (4207321i32)) {
                    if (_errRead_1 == null) {
                        _gotoNext = 4207340i32;
                    } else {
                        _gotoNext = 4207593i32;
                    };
                } else if (__value__ == (4207340i32)) {
                    {
                    ...
                    if ((((@:checkr _r ?? throw "null pointer dereference").comment != (0 : stdgo.GoInt32)) && (stdgo._internal.encoding.csv.Csv__nextrune._nextRune(_line_0) == (@:checkr _r ?? throw "null pointer dereference").comment) : Bool)) {
                        _gotoNext = 4207424i32;
                    } else {
                        _gotoNext = 4207480i32;
                    };
                } else if (__value__ == (4207424i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    var __blank__ = 0i32;
                    _gotoNext = 4207321i32;
                } else if (__value__ == (4207480i32)) {
                    if (((_errRead_1 == null) && (_line_0.length == stdgo._internal.encoding.csv.Csv__lengthnl._lengthNL(_line_0)) : Bool)) {
                        _gotoNext = 4207529i32;
                    } else {
                        _gotoNext = 4207583i32;
                    };
                } else if (__value__ == (4207529i32)) {
                    _line_0 = (null : stdgo.Slice<stdgo.GoUInt8>);
                    var __blank__ = 0i32;
                    _gotoNext = 4207321i32;
                } else if (__value__ == (4207583i32)) {
                    _gotoNext = 4207593i32;
                } else if (__value__ == (4207593i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4207614i32;
                    } else {
                        _gotoNext = 4207679i32;
                    };
                } else if (__value__ == (4207614i32)) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : _errRead_1 };
                    _gotoNext = 4207679i32;
                } else if (__value__ == (4207679i32)) {
                    ...
                    _gotoNext = 4207962i32;
                } else if (__value__ == (4207962i32)) {
                    var __blank__ = 0i32;
                    _parseFieldBreak = false;
                    _gotoNext = 4207975i32;
                } else if (__value__ == (4207975i32)) {
                    if (!_parseFieldBreak) {
                        _gotoNext = 4207979i32;
                    } else {
                        _gotoNext = 4211071i32;
                    };
                } else if (__value__ == (4207979i32)) {
                    if ((@:checkr _r ?? throw "null pointer dereference").trimLeadingSpace) {
                        _gotoNext = 4208005i32;
                    } else {
                        _gotoNext = 4208202i32;
                    };
                } else if (__value__ == (4208005i32)) {
                    ...
                    if ((_i_8 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4208889i32;
                    } else {
                        _gotoNext = 4208980i32;
                    };
                } else if (__value__ == (4208889i32)) {
                    ...
                    _gotoNext = 4207975i32;
                } else if (__value__ == (4208980i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4207975i32;
                } else if (__value__ == (4209006i32)) {
                    _gotoNext = 4209006i32;
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 4209105i32;
                } else if (__value__ == (4209105i32)) {
                    if (true) {
                        _gotoNext = 4209109i32;
                    } else {
                        _gotoNext = 4207975i32;
                    };
                } else if (__value__ == (4209109i32)) {
                    _i_13 = stdgo._internal.bytes.Bytes_indexbyte.indexByte(_line_0, (34 : stdgo.GoUInt8));
                    if ((_i_13 >= (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4209161i32;
                    } else if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4210345i32;
                    } else {
                        _gotoNext = 4210696i32;
                    };
                } else if (__value__ == (4209161i32)) {
                    ...
                    _gotoNext = 4207975i32;
                } else if (__value__ == (4209783i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._fieldIndexes = ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.__append__((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.length));
                    (@:checkr _r ?? throw "null pointer dereference")._fieldPositions = ((@:checkr _r ?? throw "null pointer dereference")._fieldPositions.__append__(_fieldPos_12?.__copy__()));
                    _parseFieldBreak = true;
                    _gotoNext = 4207975i32;
                } else if (__value__ == (4210011i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._recordBuffer = ((@:checkr _r ?? throw "null pointer dereference")._recordBuffer.__append__((34 : stdgo.GoUInt8)));
                    _gotoNext = 4209105i32;
                } else if (__value__ == (4210122i32)) {
                    ...
                    if (_errRead_1 != null) {
                        _gotoNext = 4210472i32;
                    } else {
                        _gotoNext = 4210509i32;
                    };
                } else if (__value__ == (4210472i32)) {
                    _parseFieldBreak = true;
                    _gotoNext = 4207975i32;
                } else if (__value__ == (4210509i32)) {
                    ...
                    if (((_line_0.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4210586i32;
                    } else {
                        _gotoNext = 4210635i32;
                    };
                } else if (__value__ == (4210586i32)) {
                    _pos_6._line++;
                    _pos_6._col = (1 : stdgo.GoInt);
                    _gotoNext = 4210635i32;
                } else if (__value__ == (4210635i32)) {
                    if (stdgo.Go.toInterface(_errRead_1) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 4210656i32;
                    } else {
                        _gotoNext = 4209105i32;
                    };
                } else if (__value__ == (4210656i32)) {
                    _errRead_1 = (null : stdgo.Error);
                    _gotoNext = 4209105i32;
                } else if (__value__ == (4210696i32)) {
                    _gotoNext = 4210696i32;
                    if ((!(@:checkr _r ?? throw "null pointer dereference").lazyQuotes && (_errRead_1 == null) : Bool)) {
                        _gotoNext = 4210781i32;
                    } else {
                        _gotoNext = 4210910i32;
                    };
                } else if (__value__ == (4210781i32)) {
                    ...
                    if (_err_2 == null) {
                        _gotoNext = 4211085i32;
                    } else {
                        _gotoNext = 4211233i32;
                    };
                } else if (__value__ == (4211085i32)) {
                    _err_2 = _errRead_1;
                    _gotoNext = 4211233i32;
                } else if (__value__ == (4211233i32)) {
                    ...
                    if ((_dst.capacity < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length) : Bool)) {
                        _gotoNext = 4211360i32;
                    } else {
                        _gotoNext = 4211410i32;
                    };
                } else if (__value__ == (4211360i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _r ?? throw "null pointer dereference")._fieldIndexes.length)) {
                        _gotoNext = 4211538i32;
                    } else {
                        _gotoNext = 4211595i32;
                    };
                } else if (__value__ == (4211494i32)) {
                    ...
                    _preIdx_16 = _idx_18;
                    _i_17++;
                    _gotoNext = 4211539i32;
                } else if (__value__ == (4211538i32)) {
                    {
                        final __tmp__0 = 0i32;
