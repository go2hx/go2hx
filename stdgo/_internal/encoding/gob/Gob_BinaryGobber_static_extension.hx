...
@:keep @:allow(stdgo._internal.encoding.gob.Gob.BinaryGobber_asInterface) class BinaryGobber_static_extension {
    @:keep
    @:pointer
    static public function unmarshalBinary(____:stdgo._internal.encoding.gob.Gob_BinaryGobber.BinaryGobber,  _g:stdgo.Pointer<stdgo._internal.encoding.gob.Gob_BinaryGobber.BinaryGobber>, _data:stdgo.Slice<stdgo.GoUInt8>):stdgo.Error {
    ...
    @:keep
    @:pointer
    static public function marshalBinary(____:stdgo._internal.encoding.gob.Gob_BinaryGobber.BinaryGobber,  _g:stdgo.Pointer<stdgo._internal.encoding.gob.Gob_BinaryGobber.BinaryGobber>):{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } {
