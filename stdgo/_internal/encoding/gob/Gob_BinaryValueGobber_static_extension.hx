...
@:keep @:allow(stdgo._internal.encoding.gob.Gob.BinaryValueGobber_asInterface) class BinaryValueGobber_static_extension {
    @:keep
    @:pointer
    static public function unmarshalBinary(____:stdgo._internal.encoding.gob.Gob_BinaryValueGobber.BinaryValueGobber,  _v:stdgo.Pointer<stdgo._internal.encoding.gob.Gob_BinaryValueGobber.BinaryValueGobber>, _data:stdgo.Slice<stdgo.GoUInt8>):stdgo.Error {
