...
@:keep @:allow(stdgo._internal.encoding.gob.Gob.Gobber_asInterface) class Gobber_static_extension {
    @:keep
    @:pointer
    static public function gobDecode(____:stdgo._internal.encoding.gob.Gob_Gobber.Gobber,  _g:stdgo.Pointer<stdgo._internal.encoding.gob.Gob_Gobber.Gobber>, _data:stdgo.Slice<stdgo.GoUInt8>):stdgo.Error {
    ...
    @:keep
    @:pointer
    static public function gobEncode(____:stdgo._internal.encoding.gob.Gob_Gobber.Gobber,  _g:stdgo.Pointer<stdgo._internal.encoding.gob.Gob_Gobber.Gobber>):{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } {
