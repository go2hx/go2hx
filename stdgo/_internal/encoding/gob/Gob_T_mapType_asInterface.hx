...
class T_mapType_asInterface {
    ...
    @:keep
    public dynamic function _init(_key:stdgo._internal.encoding.gob.Gob_T_gobType.T_gobType, _elem:stdgo._internal.encoding.gob.Gob_T_gobType.T_gobType):Void __self__.value._init(_key, _elem);
    @:embedded
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.encoding.gob.Gob_T_mapType.T_mapType>;
