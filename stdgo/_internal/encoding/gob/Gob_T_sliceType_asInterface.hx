...
class T_sliceType_asInterface {
    ...
    @:keep
    public dynamic function _init(_elem:stdgo._internal.encoding.gob.Gob_T_gobType.T_gobType):Void __self__.value._init(_elem);
    @:embedded
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.encoding.gob.Gob_T_sliceType.T_sliceType>;
