...
@:keep @:allow(stdgo._internal.encoding.gob.Gob.TextGobber_asInterface) class TextGobber_static_extension {
    @:keep
    @:pointer
    static public function unmarshalText(____:stdgo._internal.encoding.gob.Gob_TextGobber.TextGobber,  _g:stdgo.Pointer<stdgo._internal.encoding.gob.Gob_TextGobber.TextGobber>, _data:stdgo.Slice<stdgo.GoUInt8>):stdgo.Error {
    ...
    @:keep
    @:pointer
    static public function marshalText(____:stdgo._internal.encoding.gob.Gob_TextGobber.TextGobber,  _g:stdgo.Pointer<stdgo._internal.encoding.gob.Gob_TextGobber.TextGobber>):{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } {
