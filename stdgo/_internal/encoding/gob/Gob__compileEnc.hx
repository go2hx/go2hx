...
function _compileEnc(_ut:stdgo.Ref<stdgo._internal.encoding.gob.Gob_T_userTypeInfo.T_userTypeInfo>, _building:stdgo.GoMap<stdgo.Ref<stdgo._internal.encoding.gob.Gob_T_typeInfo.T_typeInfo>, Bool>):stdgo.Ref<stdgo._internal.encoding.gob.Gob_T_encEngine.T_encEngine> {
        ...
        var _seen = ({
            ...
            {};
            cast x;
        } : stdgo.GoMap<stdgo._internal.reflect.Reflect_Type_.Type_, stdgo.Pointer<stdgo._internal.encoding.gob.Gob_T_encOp.T_encOp>>);
...
_engine._instr = (_engine._instr.__append__((new stdgo._internal.encoding.gob.Gob_T_encInstr.T_encInstr(_op.value, _wireFieldNum, _f.index, _indir) : stdgo._internal.encoding.gob.Gob_T_encInstr.T_encInstr)));
_wireFieldNum++;
                    _fieldNum++;
                };
            };
            ...
            _engine._instr[(0 : stdgo.GoInt)] = (new stdgo._internal.encoding.gob.Gob_T_encInstr.T_encInstr(_op.value, (0 : stdgo.GoInt), (null : stdgo.Slice<stdgo.GoInt>), _indir) : stdgo._internal.encoding.gob.Gob_T_encInstr.T_encInstr);
        };
        return _engine;
    }
