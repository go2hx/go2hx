...
function _encComplex64Slice(_state:stdgo.Ref<stdgo._internal.encoding.gob.Gob_t_encoderstate.T_encoderState>, _v:stdgo._internal.reflect.Reflect_value.Value):Bool {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/gob/enc_helpers.go#L87"
        if (!_ok) {
            //"file:///home/runner/.go/go1.21.3/src/encoding/gob/enc_helpers.go#L89"
            return false;
        };
        //"file:///home/runner/.go/go1.21.3/src/encoding/gob/enc_helpers.go#L91"
        for (__8 => _x in _slice) {
            //"file:///home/runner/.go/go1.21.3/src/encoding/gob/enc_helpers.go#L92"
            if (((_x != ((0f64 : stdgo.GoFloat64) + new stdgo.GoComplex128(0f64, 0f64))) || (@:checkr _state ?? throw "null pointer dereference")._sendZero : Bool)) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/gob/enc_helpers.go#L95"
                _state._encodeUint(_rpart);
                //"file:///home/runner/.go/go1.21.3/src/encoding/gob/enc_helpers.go#L96"
                _state._encodeUint(_ipart);
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/encoding/gob/enc_helpers.go#L99"
        return true;
    }
