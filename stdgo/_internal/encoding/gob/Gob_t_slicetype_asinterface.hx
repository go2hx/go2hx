...
class T_sliceType_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function _init(_elem:stdgo._internal.encoding.gob.Gob_t_gobtype.T_gobType):Void @:_0 __self__.value._init(_elem);
    @:embedded
    ...
    var __self__ : stdgo._internal.encoding.gob.Gob_t_slicetypepointer.T_sliceTypePointer;
