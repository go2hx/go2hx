...
@:structInit @:using(stdgo._internal.encoding.gob.Gob_t_testarray___localname___type5_7494_static_extension.T_testArray___localname___Type5_7494_static_extension) class T_testArray___localname___Type5_7494 {
    public var a : stdgo.GoArray<stdgo.GoString> = new stdgo.GoArray<stdgo.GoString>(3, 3).__setString__().__setNil__();
    public var b : stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(3, 3).__setNumber32__().__setNil__();
