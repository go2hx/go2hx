...
@:structInit @:using(stdgo._internal.encoding.gob.Gob_t_testarray___localname___type5_7503_static_extension.T_testArray___localname___Type5_7503_static_extension) class T_testArray___localname___Type5_7503 {
    ...
    public function __copy__() {
        return new T_testArray___localname___Type5_7503(a, b);
    }
}
