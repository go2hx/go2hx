...
@:structInit @:using(stdgo._internal.encoding.gob.Gob_t_testdefaultsinarray___localname___type7_8455_static_extension.T_testDefaultsInArray___localname___Type7_8455_static_extension) class T_testDefaultsInArray___localname___Type7_8455 {
    ...
    public function __copy__() {
        return new T_testDefaultsInArray___localname___Type7_8455(b, i, s, f);
    }
}
