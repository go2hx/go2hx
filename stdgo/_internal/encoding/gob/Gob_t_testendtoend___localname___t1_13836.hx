...
@:structInit @:using(stdgo._internal.encoding.gob.Gob_t_testendtoend___localname___t1_13836_static_extension.T_testEndToEnd___localname___T1_13836_static_extension) class T_testEndToEnd___localname___T1_13836 {
    ...
    public var n : stdgo.Ref<stdgo.GoArray<stdgo.GoFloat64>> = new stdgo.GoArray<stdgo.GoFloat64>(3, 3).__setNumber32__().__setNil__().__setNil__();
    public var strs : stdgo.Ref<stdgo.GoArray<stdgo.GoString>> = new stdgo.GoArray<stdgo.GoString>(2, 2).__setString__().__setNil__().__setNil__();
