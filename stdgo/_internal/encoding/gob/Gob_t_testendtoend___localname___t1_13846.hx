...
@:structInit @:using(stdgo._internal.encoding.gob.Gob_t_testendtoend___localname___t1_13846_static_extension.T_testEndToEnd___localname___T1_13846_static_extension) class T_testEndToEnd___localname___T1_13846 {
    ...
    public var m2 : stdgo.GoMap<stdgo.GoInt, stdgo._internal.encoding.gob.Gob_t_testendtoend___localname___t3_13804.T_testEndToEnd___localname___T3_13804> = (null : stdgo.GoMap<stdgo.GoInt, stdgo._internal.encoding.gob.Gob_t_testendtoend___localname___t3_13804.T_testEndToEnd___localname___T3_13804>);
    ...
    public var t : stdgo.Ref<stdgo._internal.encoding.gob.Gob_t_testendtoend___localname___t2_13772.T_testEndToEnd___localname___T2_13772> = (null : stdgo.Ref<stdgo._internal.encoding.gob.Gob_t_testendtoend___localname___t2_13772.T_testEndToEnd___localname___T2_13772>);
    public function new(?a:stdgo.GoInt, ?b:stdgo.GoInt, ?c:stdgo.GoInt, ?m:stdgo.GoMap<stdgo.GoString, stdgo.Pointer<stdgo.GoFloat64>>, ?m2:stdgo.GoMap<stdgo.GoInt, stdgo._internal.encoding.gob.Gob_t_testendtoend___localname___t3_13804.T_testEndToEnd___localname___T3_13804>, ?mstring:stdgo.GoMap<stdgo.GoString, stdgo.GoString>, ?mintptr:stdgo.GoMap<stdgo.GoInt, stdgo.Pointer<stdgo.GoInt>>, ?mcomp:stdgo.GoMap<stdgo.GoComplex128, stdgo.GoComplex128>, ?marr:stdgo.GoMap<stdgo.GoArray<stdgo.GoString>, stdgo.GoArray<stdgo.Pointer<stdgo.GoFloat64>>>, ?emptyMap:stdgo.GoMap<stdgo.GoString, stdgo.GoInt>, ?n:stdgo.Ref<stdgo.GoArray<stdgo.GoFloat64>>, ?strs:stdgo.Ref<stdgo.GoArray<stdgo.GoString>>, ?int64s:stdgo.Ref<stdgo.Slice<stdgo.GoInt64>>, ?rI:stdgo.GoComplex64, ?s:stdgo.GoString, ?y:stdgo.Slice<stdgo.GoUInt8>, ?t:stdgo.Ref<stdgo._internal.encoding.gob.Gob_t_testendtoend___localname___t2_13772.T_testEndToEnd___localname___T2_13772>) {
        if (a != null) this.a = a;
        if (b != null) this.b = b;
        if (c != null) this.c = c;
        if (m != null) this.m = m;
    ...
    public function __copy__() {
        return new T_testEndToEnd___localname___T1_13846(
a,
b,
c,
m,
