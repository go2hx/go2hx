...
@:structInit @:using(stdgo._internal.encoding.gob.Gob_t_testoverflow___localname___inputt_15895_static_extension.T_testOverflow___localname___inputT_15895_static_extension) class T_testOverflow___localname___inputT_15895 {
    ...
    public function __copy__() {
        return new T_testOverflow___localname___inputT_15895(maxi, mini, maxu, maxf, minf, maxc, minc);
    }
}
