...
function testAutoIndirection(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        @:check2r _enc.encode(stdgo.Go.toInterface(_t1));
        var _dec = stdgo._internal.encoding.gob.Gob_newDecoder.newDecoder(stdgo.Go.asInterface(_b));
        var _t0:stdgo._internal.encoding.gob.Gob_T0.T0 = ({} : stdgo._internal.encoding.gob.Gob_T0.T0);
        @:check2r _dec.decode(stdgo.Go.toInterface((stdgo.Go.setRef(_t0) : stdgo.Ref<stdgo._internal.encoding.gob.Gob_T0.T0>)));
        if ((((_t0.a != ((17 : stdgo.GoInt)) || _t0.b != ((177 : stdgo.GoInt)) : Bool) || _t0.c != ((1777 : stdgo.GoInt)) : Bool) || (_t0.d != (17777 : stdgo.GoInt)) : Bool)) {
            @:check2r _t.errorf(("t1->t0: expected {17 177 1777 17777}; got %v" : stdgo.GoString), stdgo.Go.toInterface(_t0));
        };
        ...
        @:check2r _b.reset();
        @:check2r _enc.encode(stdgo.Go.toInterface(_t2));
        _t0 = (new stdgo._internal.encoding.gob.Gob_T0.T0() : stdgo._internal.encoding.gob.Gob_T0.T0);
        @:check2r _dec.decode(stdgo.Go.toInterface((stdgo.Go.setRef(_t0) : stdgo.Ref<stdgo._internal.encoding.gob.Gob_T0.T0>)));
        if ((((_t0.a != ((17 : stdgo.GoInt)) || _t0.b != ((177 : stdgo.GoInt)) : Bool) || _t0.c != ((1777 : stdgo.GoInt)) : Bool) || (_t0.d != (17777 : stdgo.GoInt)) : Bool)) {
            @:check2r _t.errorf(("t2->t0 expected {17 177 1777 17777}; got %v" : stdgo.GoString), stdgo.Go.toInterface(_t0));
        };
        ...
        @:check2r _b.reset();
        @:check2r _enc.encode(stdgo.Go.toInterface(_t0));
        _t1 = (new stdgo._internal.encoding.gob.Gob_T1.T1() : stdgo._internal.encoding.gob.Gob_T1.T1);
        @:check2r _dec.decode(stdgo.Go.toInterface((stdgo.Go.setRef(_t1) : stdgo.Ref<stdgo._internal.encoding.gob.Gob_T1.T1>)));
        ...
        @:check2r _dec.decode(stdgo.Go.toInterface((stdgo.Go.setRef(_t2) : stdgo.Ref<stdgo._internal.encoding.gob.Gob_T2.T2>)));
