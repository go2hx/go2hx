...
function testChanFuncIgnored(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        var _b0 = (new stdgo._internal.encoding.gob.Gob_Bug2.Bug2((23 : stdgo.GoInt), _c, (stdgo.Go.setRef(_c) : stdgo.Ref<stdgo.Chan<stdgo.GoInt>>), _f, (stdgo.Go.setRef(_fp) : stdgo.Ref<stdgo.Ref<() -> Void>>)) : stdgo._internal.encoding.gob.Gob_Bug2.Bug2);
