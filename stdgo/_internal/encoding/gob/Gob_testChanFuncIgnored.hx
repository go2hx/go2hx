...
function testChanFuncIgnored(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        {
            var _err = (@:check2r _enc.encode(stdgo.Go.toInterface(_b0)) : stdgo.Error);
            if (_err != null) {
        ...
        var _err = (@:check2r stdgo._internal.encoding.gob.Gob_newDecoder.newDecoder(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo._internal.bytes.Bytes_Buffer.Buffer>))).decode(stdgo.Go.toInterface((stdgo.Go.setRef(_b1) : stdgo.Ref<stdgo._internal.encoding.gob.Gob_Bug2.Bug2>))) : stdgo.Error);
        if (_err != null) {
