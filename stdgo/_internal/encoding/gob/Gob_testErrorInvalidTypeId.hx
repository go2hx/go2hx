...
var _foo__pointer__ = (stdgo.Go.setRef(_foo) : stdgo.Ref<stdgo._internal.encoding.gob.Gob_T_emptyStruct.T_emptyStruct>);
var _foo__pointer__ = (stdgo.Go.setRef(_foo) : stdgo.Ref<stdgo._internal.encoding.gob.Gob_T_emptyStruct.T_emptyStruct>);
var _foo__pointer__ = (stdgo.Go.setRef(_foo) : stdgo.Ref<stdgo._internal.encoding.gob.Gob_T_emptyStruct.T_emptyStruct>);
var _foo__pointer__ = (stdgo.Go.setRef(_foo) : stdgo.Ref<stdgo._internal.encoding.gob.Gob_T_emptyStruct.T_emptyStruct>);
var _err = (_d.decode(stdgo.Go.toInterface(_foo__pointer__)) : stdgo.Error);
