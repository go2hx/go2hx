...
var _err = (@:check2r _d.decode(stdgo.Go.toInterface((stdgo.Go.setRef(_foo) : stdgo.Ref<stdgo._internal.encoding.gob.Gob_T_emptyStruct.T_emptyStruct>))) : stdgo.Error);
