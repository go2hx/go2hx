...
function testGobEncodeIsZero(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        _err = @:check2r _dec.decode(stdgo.Go.toInterface((stdgo.Go.setRef(_y) : stdgo.Ref<stdgo._internal.encoding.gob.Gob_T_isZeroBug.T_isZeroBug>)));
        if (_err != null) {
        ...
        if (stdgo.Go.toInterface(_x) != stdgo.Go.toInterface(_y)) {
            @:check2r _t.fatalf(("%v != %v" : stdgo.GoString), stdgo.Go.toInterface(_x), stdgo.Go.toInterface(_y));
        };
    }
