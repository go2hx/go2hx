...
function testGobEncodePtrError(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        _err = _enc.encode(stdgo.Go.toInterface(_err__pointer__));
        if (_err != null) {
        ...
        var _err2__pointer__ = (stdgo.Go.setRef(_err2) : stdgo.Ref<stdgo.Error>);
        var _err2__pointer__ = (stdgo.Go.setRef(_err2) : stdgo.Ref<stdgo.Error>);
        var _err2__pointer__ = (stdgo.Go.setRef(_err2) : stdgo.Ref<stdgo.Error>);
        var _err2__pointer__ = (stdgo.Go.setRef(_err2) : stdgo.Ref<stdgo.Error>);
        _err = _dec.decode(stdgo.Go.toInterface(_err2__pointer__));
        if (_err != null) {
