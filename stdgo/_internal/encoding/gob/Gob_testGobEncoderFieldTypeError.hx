...
function testGobEncoderFieldTypeError(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        @:check2r _b.reset();
        _err = @:check2r _enc.encode(stdgo.Go.toInterface((new stdgo._internal.encoding.gob.Gob_GobTest2.GobTest2((17 : stdgo.GoInt), ("ABC" : stdgo.GoString)) : stdgo._internal.encoding.gob.Gob_GobTest2.GobTest2)));
        if (_err != null) {
            @:check2r _t.fatal(stdgo.Go.toInterface(("encode error:" : stdgo.GoString)), stdgo.Go.toInterface(_err));
        };
