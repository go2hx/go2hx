...
function testGobEncoderValueThenPointer(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        {
            var _err = (@:check2r _enc.encode(stdgo.Go.toInterface((new stdgo._internal.encoding.gob.Gob_GobTest6.GobTest6((42 : stdgo.GoInt), _v, _w__pointer__, _bv, _bw__pointer__, _tv, _tw__pointer__) : stdgo._internal.encoding.gob.Gob_GobTest6.GobTest6))) : stdgo.Error);
            if (_err != null) {
