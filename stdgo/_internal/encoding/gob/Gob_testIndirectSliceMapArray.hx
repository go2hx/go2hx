...
x.set(("three" : stdgo.GoString), (3 : stdgo.GoInt));
        ...
        @:check2r stdgo._internal.encoding.gob.Gob_newEncoder.newEncoder(stdgo.Go.asInterface(_b)).encode(stdgo.Go.toInterface(_i));
        var _dec = stdgo._internal.encoding.gob.Gob_newDecoder.newDecoder(stdgo.Go.asInterface(_b));
        var _d:stdgo._internal.encoding.gob.Gob_Direct.Direct = ({} : stdgo._internal.encoding.gob.Gob_Direct.Direct);
        var _err = (@:check2r _dec.decode(stdgo.Go.toInterface((stdgo.Go.setRef(_d) : stdgo.Ref<stdgo._internal.encoding.gob.Gob_Direct.Direct>))) : stdgo.Error);
        if (_err != null) {
...
x.set(("six" : stdgo.GoString), (6 : stdgo.GoInt));
        ...
        @:check2r _b.reset();
        @:check2r stdgo._internal.encoding.gob.Gob_newEncoder.newEncoder(stdgo.Go.asInterface(_b)).encode(stdgo.Go.toInterface(_d));
