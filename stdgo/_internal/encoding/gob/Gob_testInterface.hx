...
function testInterface(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        _err = @:check2r stdgo._internal.encoding.gob.Gob_newDecoder.newDecoder(stdgo.Go.asInterface(_b)).decode(stdgo.Go.toInterface((stdgo.Go.setRef(_item2) : stdgo.Ref<stdgo._internal.encoding.gob.Gob_InterfaceItem.InterfaceItem>)));
        if (_err != null) {
