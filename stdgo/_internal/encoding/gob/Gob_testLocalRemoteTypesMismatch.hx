...
(0 : stdgo.GoUInt8)]).__setNumber32__() : stdgo.Slice<stdgo.GoUInt8>);
        ...
        var _v__pointer__ = (stdgo.Go.setRef(_v) : stdgo.Ref<stdgo.Slice<stdgo.Ref<stdgo._internal.encoding.gob.Gob_T_emptyStruct.T_emptyStruct>>>);
        var _v__pointer__ = (stdgo.Go.setRef(_v) : stdgo.Ref<stdgo.Slice<stdgo.Ref<stdgo._internal.encoding.gob.Gob_T_emptyStruct.T_emptyStruct>>>);
        var _v__pointer__ = (stdgo.Go.setRef(_v) : stdgo.Ref<stdgo.Slice<stdgo.Ref<stdgo._internal.encoding.gob.Gob_T_emptyStruct.T_emptyStruct>>>);
        var _v__pointer__ = (stdgo.Go.setRef(_v) : stdgo.Ref<stdgo.Slice<stdgo.Ref<stdgo._internal.encoding.gob.Gob_T_emptyStruct.T_emptyStruct>>>);
        var _buf = stdgo._internal.bytes.Bytes_newBuffer.newBuffer(_testData);
        var _err = (stdgo._internal.encoding.gob.Gob_newDecoder.newDecoder(stdgo.Go.asInterface(_buf)).decode(stdgo.Go.toInterface(_v__pointer__)) : stdgo.Error);
        if (_err == null) {
