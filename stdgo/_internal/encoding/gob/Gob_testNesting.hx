...
function testNesting(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        @:check2r stdgo._internal.encoding.gob.Gob_newEncoder.newEncoder(stdgo.Go.asInterface(_b)).encode(stdgo.Go.toInterface(_rt));
        ...
        var _err = (@:check2r _dec.decode(stdgo.Go.toInterface((stdgo.Go.setRef(_drt) : stdgo.Ref<stdgo._internal.encoding.gob.Gob_T_testNesting___localname___RT_19135.T_testNesting___localname___RT_19135>))) : stdgo.Error);
        if (_err != null) {
        ...
        if (_drt.a != ((@:checkr _rt ?? throw "null pointer dereference").a)) {
            @:check2r _t.errorf(("nesting: encode expected %v got %v" : stdgo.GoString), stdgo.Go.toInterface((_rt : stdgo._internal.encoding.gob.Gob_T_testNesting___localname___RT_19135.T_testNesting___localname___RT_19135)), stdgo.Go.toInterface(_drt));
        };
