...
function testNetIP(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        var _ip__pointer__ = (stdgo.Go.setRef(_ip) : stdgo.Ref<stdgo._internal.net.Net_IP.IP>);
        var _ip__pointer__ = (stdgo.Go.setRef(_ip) : stdgo.Ref<stdgo._internal.net.Net_IP.IP>);
        var _ip__pointer__ = (stdgo.Go.setRef(_ip) : stdgo.Ref<stdgo._internal.net.Net_IP.IP>);
        var _ip__pointer__ = (stdgo.Go.setRef(_ip) : stdgo.Ref<stdgo._internal.net.Net_IP.IP>);
        var _err = (stdgo._internal.encoding.gob.Gob_newDecoder.newDecoder(stdgo.Go.asInterface(stdgo._internal.bytes.Bytes_newReader.newReader(_enc))).decode(stdgo.Go.toInterface(stdgo.Go.asInterface(_ip__pointer__))) : stdgo.Error);
        if (_err != null) {
