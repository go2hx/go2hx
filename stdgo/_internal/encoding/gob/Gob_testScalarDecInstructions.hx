...
function testScalarDecInstructions(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        var _ovfl = (stdgo._internal.errors.Errors_new_.new_(("overflow" : stdgo.GoString)) : stdgo.Error);
        {
            ...
            stdgo._internal.encoding.gob.Gob__execDec._execDec(_instr, _state, _t, stdgo._internal.reflect.Reflect_valueOf.valueOf(stdgo.Go.toInterface(stdgo.Go.pointer(_data)))?.__copy__());
            if (_data != (true)) {
