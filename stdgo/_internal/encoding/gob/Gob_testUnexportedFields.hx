...
function testUnexportedFields(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        @:check2r stdgo._internal.encoding.gob.Gob_newEncoder.newEncoder(stdgo.Go.asInterface(_b)).encode(stdgo.Go.toInterface(_u0));
        ...
        var _err = (@:check2r _dec.decode(stdgo.Go.toInterface((stdgo.Go.setRef(_u1) : stdgo.Ref<stdgo._internal.encoding.gob.Gob_U.U>))) : stdgo.Error);
        if (_err != null) {
        ...
        if (((_u0.a != (_u1.a) || _u0.b != (_u1.b) : Bool) || (_u0.d != _u1.d) : Bool)) {
            @:check2r _t.errorf(("u1->u0: expected %v; got %v" : stdgo.GoString), stdgo.Go.toInterface(_u0), stdgo.Go.toInterface(_u1));
        };
