...
function testArrayType(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        var _a3:stdgo.GoArray<stdgo.GoInt> = new stdgo.GoArray<stdgo.GoInt>(3, 3).__setNumber32__().__setNil__();
        ...
        var _a4:stdgo.GoArray<stdgo.GoInt> = new stdgo.GoArray<stdgo.GoInt>(4, 4).__setNumber32__().__setNil__();
        ...
        var _b3:stdgo.GoArray<Bool> = new stdgo.GoArray<Bool>(3, 3).__setNil__();
