...
function testIndirectSliceMapArray(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        (@:checkr _i ?? throw "null pointer dereference").a.value = (stdgo.Go.setRef(new stdgo.GoArray<stdgo.GoInt>(3, 3).__setNumber32__().__setNil__().__setNil__()) : stdgo.Ref<stdgo.Ref<stdgo.GoArray<stdgo.GoInt>>>);
        (@:checkr _i ?? throw "null pointer dereference").a.value = (stdgo.Go.setRef(new stdgo.GoArray<stdgo.GoInt>(3, 3).__setNumber32__().__setNil__()) : stdgo.Ref<stdgo.GoArray<stdgo.GoInt>>);
