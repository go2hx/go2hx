...
function testNilPointerPanics(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/gob/encoder_test.go#L977"
        for (__8 => _tt in _testCases) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/encoding/gob/encoder_test.go#L979"
            if (_tt._mustPanic) {
                //"file:///home/runner/.go/go1.21.3/src/encoding/gob/encoder_test.go#L980"
                if (_panicErr == null) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/gob/encoder_test.go#L981"
                    _t.errorf(("expected panic with input %#v, did not panic" : stdgo.GoString), _tt._value);
                };
                //"file:///home/runner/.go/go1.21.3/src/encoding/gob/encoder_test.go#L983"
                continue;
            };
            //"file:///home/runner/.go/go1.21.3/src/encoding/gob/encoder_test.go#L985"
            if (_panicErr != null) {
                //"file:///home/runner/.go/go1.21.3/src/encoding/gob/encoder_test.go#L986"
