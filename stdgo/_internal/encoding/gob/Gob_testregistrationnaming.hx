...
function testRegistrationNaming(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        for (__4 => _tc in _testCases) {
            ...
            var __tmp__ = @:check2 stdgo._internal.encoding.gob.Gob__nametoconcretetype._nameToConcreteType.load(stdgo.Go.toInterface(_tc._name)), _ct:stdgo.AnyInterface = __tmp__._0, __5:Bool = __tmp__._1;
            ...
            {
                var __tmp__ = @:check2 stdgo._internal.encoding.gob.Gob__concretetypetoname._concreteTypeToName.load(stdgo.Go.toInterface(_tct)), _n:stdgo.AnyInterface = __tmp__._0, __6:Bool = __tmp__._1;
