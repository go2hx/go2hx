...
@:keep @:allow(stdgo._internal.encoding.hex.Hex.T_dumper_asInterface) class T_dumper_static_extension {
    ...
    static public function close( _h:stdgo.Ref<stdgo._internal.encoding.hex.Hex_t_dumper.T_dumper>):stdgo.Error {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L305"
        if ((@:checkr _h ?? throw "null pointer dereference")._closed) {
            //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L306"
            return _err;
        };
        (@:checkr _h ?? throw "null pointer dereference")._closed = true;
        //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L309"
        if ((@:checkr _h ?? throw "null pointer dereference")._used == ((0 : stdgo.GoInt))) {
            //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L310"
            return _err;
        };
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L318"
        while (((@:checkr _h ?? throw "null pointer dereference")._used < (16 : stdgo.GoInt) : Bool)) {
            var _l = (3 : stdgo.GoInt);
            //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L320"
            ...
            //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L326"
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L327"
                return _err;
            };
            //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L329"
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L334"
        return _err;
    }
    @:keep
    @:tdfield
    static public function write( _h:stdgo.Ref<stdgo._internal.encoding.hex.Hex_t_dumper.T_dumper>, _data:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L245"
        if ((@:checkr _h ?? throw "null pointer dereference")._closed) {
            //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L246"
            return {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L252"
        for (_i => _ in _data) {
            //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L253"
            if ((@:checkr _h ?? throw "null pointer dereference")._used == ((0 : stdgo.GoInt))) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L260"
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L264"
                if (_err != null) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L265"
                    return { _0 : _n, _1 : _err };
                };
            };
            //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L268"
            ...
            (@:checkr _h ?? throw "null pointer dereference")._buf[(2 : stdgo.GoInt)] = (32 : stdgo.GoUInt8);
            var _l = (3 : stdgo.GoInt);
            //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L271"
            if ((@:checkr _h ?? throw "null pointer dereference")._used == ((7 : stdgo.GoInt))) {
                (@:checkr _h ?? throw "null pointer dereference")._buf[(3 : stdgo.GoInt)] = (32 : stdgo.GoUInt8);
                _l = (4 : stdgo.GoInt);
            } else if ((@:checkr _h ?? throw "null pointer dereference")._used == ((15 : stdgo.GoInt))) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L283"
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L284"
                return { _0 : _n, _1 : _err };
            };
            //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L286"
            _n++;
            ...
            //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L288"
            (@:checkr _h ?? throw "null pointer dereference")._used++;
            //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L289"
            (@:checkr _h ?? throw "null pointer dereference")._n++;
            //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L290"
            if ((@:checkr _h ?? throw "null pointer dereference")._used == ((16 : stdgo.GoInt))) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L294"
                if (_err != null) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L295"
                    return { _0 : _n, _1 : _err };
                };
                (@:checkr _h ?? throw "null pointer dereference")._used = (0 : stdgo.GoInt);
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/encoding/hex/hex.go#L300"
        return { _0 : _n, _1 : _err };
    }
}
