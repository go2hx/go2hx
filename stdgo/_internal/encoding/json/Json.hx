...
function testInvalidStringOption(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _item:T__struct_13 = ({ m : ({
            ...
            @:mergeBlock {};
            x;
        } : stdgo.GoMap<stdgo.GoString, stdgo.GoString>), s : new stdgo.Slice<stdgo.GoString>((0 : stdgo.GoInt).toBasic(), 0).__setString__(), i : stdgo.Go.toInterface(_num), p : stdgo.Go.pointer(_num), t : ({} : stdgo._internal.time.Time.Time), a : new stdgo.GoArray<stdgo.GoString>(1, 1, ...[for (i in 0 ... 1) ("" : stdgo.GoString)]) } : T__struct_13);
