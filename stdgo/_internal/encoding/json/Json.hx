...
var _numberTests : stdgo.Slice<T__struct_7> = (new stdgo.Slice<T__struct_7>(3, 3, ...[({ _in : ("-1.23e1" : stdgo.GoString), _i : (0 : stdgo.GoInt64), _intErr : ("strconv.ParseInt: parsing \"-1.23e1\": invalid syntax" : stdgo.GoString), _f : (-12.3 : stdgo.GoFloat64), _floatErr : ("" : stdgo.GoString) } : T__struct_7), ({ _in : ("-12" : stdgo.GoString), _i : (-12i64 : stdgo.GoInt64), _intErr : ("" : stdgo.GoString), _f : (-12 : stdgo.GoFloat64), _floatErr : ("" : stdgo.GoString) } : T__struct_7), ({ _in : ("1e1000" : stdgo.GoString), _i : (0 : stdgo.GoInt64), _intErr : ("strconv.ParseInt: parsing \"1e1000\": invalid syntax" : stdgo.GoString), _f : (0 : stdgo.GoFloat64), _floatErr : ("strconv.ParseFloat: parsing \"1e1000\": value out of range" : stdgo.GoString) } : T__struct_7)].concat([for (i in 3 ... (3 > 3 ? 3 : 3 : stdgo.GoInt).toBasic()) ({ _in : ("" : stdgo.GoString), _i : (0 : stdgo.GoInt64), _intErr : ("" : stdgo.GoString), _f : (0 : stdgo.GoFloat64), _floatErr : ("" : stdgo.GoString) } : T__struct_7)])) : stdgo.Slice<T__struct_7>);
