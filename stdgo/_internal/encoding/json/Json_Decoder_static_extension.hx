...
return { _0 : _c, _1 : (null : stdgo.Error) };
    ...
    static public function _readValue( _dec:stdgo.Ref<stdgo._internal.encoding.json.Json_Decoder.Decoder>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        @:recv var _dec:stdgo.Ref<stdgo._internal.encoding.json.Json_Decoder.Decoder> = _dec;
        var _n_5446314:stdgo.GoInt = (0 : stdgo.GoInt);
        var _c_5445378:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var inputBreak = false;
        var _err_5445155:stdgo.Error = (null : stdgo.Error);
        var _scanp_5445131:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _scanp_5445131 = (@:checkr _dec ?? throw "null pointer dereference")._scanp;
                    _gotoNext = 5445165i32;
                } else if (__value__ == (5445165i32)) {
                    var __blank__ = 0i32;
                    inputBreak = false;
                    _gotoNext = 5445276i32;
                } else if (__value__ == (5445276i32)) {
                    if (!inputBreak && ((_scanp_5445131 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5445291i32;
                    } else {
                        _gotoNext = 5446386i32;
                    };
                } else if (__value__ == (5445291i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5445337i32;
                } else if (__value__ == (5445337i32)) {
                    if ((_scanp_5445131 < ((@:checkr _dec ?? throw "null pointer dereference")._buf.length) : Bool)) {
                        _gotoNext = 5445373i32;
                    } else {
                        _gotoNext = 5446093i32;
                    };
                } else if (__value__ == (5445365i32)) {
                    _scanp_5445131++;
                    _gotoNext = 5445337i32;
                } else if (__value__ == (5445373i32)) {
                    _c_5445378 = (@:checkr _dec ?? throw "null pointer dereference")._buf[(_scanp_5445131 : stdgo.GoInt)];
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes++;
                    _gotoNext = 5445421i32;
                } else if (__value__ == (5445421i32)) {
                    {
                        final __value__ = (@:checkr _dec ?? throw "null pointer dereference")._scan._step((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_scanner.T_scanner>), _c_5445378);
                        if (__value__ == ((10 : stdgo.GoInt))) {
                            _gotoNext = 5445461i32;
                        } else if (__value__ == ((5 : stdgo.GoInt)) || __value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 5445674i32;
                        } else if (__value__ == ((11 : stdgo.GoInt))) {
                            _gotoNext = 5445928i32;
                        } else {
                            _gotoNext = 5445365i32;
                        };
                    };
                } else if (__value__ == (5445461i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes--;
                    inputBreak = true;
                    _gotoNext = 5445276i32;
                } else if (__value__ == (5445674i32)) {
                    if (stdgo._internal.encoding.json.Json__stateEndValue._stateEndValue((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 5445887i32;
                    } else {
                        _gotoNext = 5445365i32;
                    };
                } else if (__value__ == (5445887i32)) {
                    _scanp_5445131++;
                    inputBreak = true;
                    _gotoNext = 5445276i32;
                } else if (__value__ == (5445928i32)) {
                    ...
                    _gotoNext = 5445365i32;
                } else if (__value__ == (5446093i32)) {
                    if (_err_5445155 != null) {
                        _gotoNext = 5446107i32;
                    } else {
                        _gotoNext = 5446314i32;
                    };
                } else if (__value__ == (5446107i32)) {
                    if (stdgo.Go.toInterface(_err_5445155) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eOF.eOF))) {
                        _gotoNext = 5446129i32;
                    } else {
                        _gotoNext = 5446276i32;
                    };
                } else if (__value__ == (5446129i32)) {
                    if ((@:checkr _dec ?? throw "null pointer dereference")._scan._step((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 5446179i32;
                    } else {
                        _gotoNext = 5446208i32;
                    };
                } else if (__value__ == (5446179i32)) {
                    inputBreak = true;
                    _gotoNext = 5445276i32;
                } else if (__value__ == (5446208i32)) {
                    if (stdgo._internal.encoding.json.Json__nonSpace._nonSpace((@:checkr _dec ?? throw "null pointer dereference")._buf)) {
                        _gotoNext = 5446229i32;
                    } else {
                        _gotoNext = 5446276i32;
                    };
                } else if (__value__ == (5446229i32)) {
                    _err_5445155 = stdgo._internal.io.Io_errUnexpectedEOF.errUnexpectedEOF;
                    _gotoNext = 5446276i32;
                } else if (__value__ == (5446276i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._err = _err_5445155;
                    return { _0 : (0 : stdgo.GoInt), _1 : _err_5445155 };
                    _gotoNext = 5446314i32;
                } else if (__value__ == (5446314i32)) {
                    _n_5446314 = (_scanp_5445131 - (@:checkr _dec ?? throw "null pointer dereference")._scanp : stdgo.GoInt);
                    _err_5445155 = @:check2r _dec._refill();
                    _scanp_5445131 = ((@:checkr _dec ?? throw "null pointer dereference")._scanp + _n_5446314 : stdgo.GoInt);
                    _gotoNext = 5445276i32;
                } else if (__value__ == (5446386i32)) {
                    return { _0 : (_scanp_5445131 - (@:checkr _dec ?? throw "null pointer dereference")._scanp : stdgo.GoInt), _1 : (null : stdgo.Error) };
                    _gotoNext = -1i32;
                };
            };
        };
