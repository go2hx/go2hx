...
return { _0 : _c, _1 : (null : stdgo.Error) };
    ...
    static public function _readValue( _dec:stdgo.Ref<stdgo._internal.encoding.json.Json_Decoder.Decoder>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        ...
        var _err_7126242:stdgo.Error = (null : stdgo.Error);
        var _scanp_7126218:stdgo.GoInt = (0 : stdgo.GoInt);
        var _n_7127401:stdgo.GoInt = (0 : stdgo.GoInt);
        var _c_7126465:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _dec._scan._reset();
                    _scanp_7126218 = _dec._scanp;
                    _gotoNext = 7126252i32;
                } else if (__value__ == (7126252i32)) {
                    var __blank__ = 0i32;
                    inputBreak = false;
                    _gotoNext = 7126363i32;
                } else if (__value__ == (7126363i32)) {
                    if (!inputBreak && ((_scanp_7126218 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 7126378i32;
                    } else {
                        _gotoNext = 7127473i32;
                    };
                } else if (__value__ == (7126378i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 7126424i32;
                } else if (__value__ == (7126424i32)) {
                    if ((_scanp_7126218 < (_dec._buf.length) : Bool)) {
                        _gotoNext = 7126460i32;
                    } else {
                        _gotoNext = 7127180i32;
                    };
                } else if (__value__ == (7126452i32)) {
                    _scanp_7126218++;
                    _gotoNext = 7126424i32;
                } else if (__value__ == (7126460i32)) {
                    _c_7126465 = _dec._buf[(_scanp_7126218 : stdgo.GoInt)];
                    _dec._scan._bytes++;
                    _gotoNext = 7126508i32;
                } else if (__value__ == (7126508i32)) {
                    {
                        final __value__ = _dec._scan._step((stdgo.Go.setRef(_dec._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_scanner.T_scanner>), _c_7126465);
                        if (__value__ == ((10 : stdgo.GoInt))) {
                            _gotoNext = 7126548i32;
                        } else if (__value__ == ((5 : stdgo.GoInt)) || __value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 7126761i32;
                        } else if (__value__ == ((11 : stdgo.GoInt))) {
                            _gotoNext = 7127015i32;
                        } else {
                            _gotoNext = 7126452i32;
                        };
                    };
                } else if (__value__ == (7126548i32)) {
                    _dec._scan._bytes--;
                    inputBreak = true;
                    _gotoNext = 7126363i32;
                } else if (__value__ == (7126761i32)) {
                    if (stdgo._internal.encoding.json.Json__stateEndValue._stateEndValue((stdgo.Go.setRef(_dec._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 7126974i32;
                    } else {
                        _gotoNext = 7126452i32;
                    };
                } else if (__value__ == (7126974i32)) {
                    _scanp_7126218++;
                    inputBreak = true;
                    _gotoNext = 7126363i32;
                } else if (__value__ == (7127015i32)) {
                    _dec._err = _dec._scan._err;
                    return { _0 : (0 : stdgo.GoInt), _1 : _dec._scan._err };
                    _gotoNext = 7126452i32;
                } else if (__value__ == (7127180i32)) {
                    if (_err_7126242 != null) {
                        _gotoNext = 7127194i32;
                    } else {
                        _gotoNext = 7127401i32;
                    };
                } else if (__value__ == (7127194i32)) {
                    if (stdgo.Go.toInterface(_err_7126242) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eof))) {
                        _gotoNext = 7127216i32;
                    } else {
                        _gotoNext = 7127363i32;
                    };
                } else if (__value__ == (7127216i32)) {
                    if (_dec._scan._step((stdgo.Go.setRef(_dec._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 7127266i32;
                    } else {
                        _gotoNext = 7127295i32;
                    };
                } else if (__value__ == (7127266i32)) {
                    inputBreak = true;
                    _gotoNext = 7126363i32;
                } else if (__value__ == (7127295i32)) {
                    if (stdgo._internal.encoding.json.Json__nonSpace._nonSpace(_dec._buf)) {
                        _gotoNext = 7127316i32;
                    } else {
                        _gotoNext = 7127363i32;
                    };
                } else if (__value__ == (7127316i32)) {
                    _err_7126242 = stdgo._internal.io.Io_errUnexpectedEOF.errUnexpectedEOF;
                    _gotoNext = 7127363i32;
                } else if (__value__ == (7127363i32)) {
                    _dec._err = _err_7126242;
                    return { _0 : (0 : stdgo.GoInt), _1 : _err_7126242 };
                    _gotoNext = 7127401i32;
                } else if (__value__ == (7127401i32)) {
                    _n_7127401 = (_scanp_7126218 - _dec._scanp : stdgo.GoInt);
                    _err_7126242 = _dec._refill();
                    _scanp_7126218 = (_dec._scanp + _n_7127401 : stdgo.GoInt);
                    _gotoNext = 7126363i32;
                } else if (__value__ == (7127473i32)) {
                    return { _0 : (_scanp_7126218 - _dec._scanp : stdgo.GoInt), _1 : (null : stdgo.Error) };
                    _gotoNext = -1i32;
                };
            };
        };
