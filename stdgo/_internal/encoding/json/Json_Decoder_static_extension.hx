...
return { _0 : _c, _1 : (null : stdgo.Error) };
    ...
    static public function _readValue( _dec:stdgo.Ref<stdgo._internal.encoding.json.Json_Decoder.Decoder>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        @:recv var _dec:stdgo.Ref<stdgo._internal.encoding.json.Json_Decoder.Decoder> = _dec;
        var _err_5158109:stdgo.Error = (null : stdgo.Error);
        var _scanp_5158085:stdgo.GoInt = (0 : stdgo.GoInt);
        var _n_5159268:stdgo.GoInt = (0 : stdgo.GoInt);
        var _c_5158332:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _scanp_5158085 = (@:checkr _dec ?? throw "null pointer dereference")._scanp;
                    _gotoNext = 5158119i32;
                } else if (__value__ == (5158119i32)) {
                    var __blank__ = 0i32;
                    inputBreak = false;
                    _gotoNext = 5158230i32;
                } else if (__value__ == (5158230i32)) {
                    if (!inputBreak && ((_scanp_5158085 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5158245i32;
                    } else {
                        _gotoNext = 5159340i32;
                    };
                } else if (__value__ == (5158245i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5158291i32;
                } else if (__value__ == (5158291i32)) {
                    if ((_scanp_5158085 < ((@:checkr _dec ?? throw "null pointer dereference")._buf.length) : Bool)) {
                        _gotoNext = 5158327i32;
                    } else {
                        _gotoNext = 5159047i32;
                    };
                } else if (__value__ == (5158319i32)) {
                    _scanp_5158085++;
                    _gotoNext = 5158291i32;
                } else if (__value__ == (5158327i32)) {
                    _c_5158332 = (@:checkr _dec ?? throw "null pointer dereference")._buf[(_scanp_5158085 : stdgo.GoInt)];
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes++;
                    _gotoNext = 5158375i32;
                } else if (__value__ == (5158375i32)) {
                    {
                        final __value__ = (@:checkr _dec ?? throw "null pointer dereference")._scan._step((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_scanner.T_scanner>), _c_5158332);
                        if (__value__ == ((10 : stdgo.GoInt))) {
                            _gotoNext = 5158415i32;
                        } else if (__value__ == ((5 : stdgo.GoInt)) || __value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 5158628i32;
                        } else if (__value__ == ((11 : stdgo.GoInt))) {
                            _gotoNext = 5158882i32;
                        } else {
                            _gotoNext = 5158319i32;
                        };
                    };
                } else if (__value__ == (5158415i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes--;
                    inputBreak = true;
                    _gotoNext = 5158230i32;
                } else if (__value__ == (5158628i32)) {
                    if (stdgo._internal.encoding.json.Json__stateEndValue._stateEndValue((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 5158841i32;
                    } else {
                        _gotoNext = 5158319i32;
                    };
                } else if (__value__ == (5158841i32)) {
                    _scanp_5158085++;
                    inputBreak = true;
                    _gotoNext = 5158230i32;
                } else if (__value__ == (5158882i32)) {
                    ...
                    _gotoNext = 5158319i32;
                } else if (__value__ == (5159047i32)) {
                    if (_err_5158109 != null) {
                        _gotoNext = 5159061i32;
                    } else {
                        _gotoNext = 5159268i32;
                    };
                } else if (__value__ == (5159061i32)) {
                    if (stdgo.Go.toInterface(_err_5158109) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eOF.eOF))) {
                        _gotoNext = 5159083i32;
                    } else {
                        _gotoNext = 5159230i32;
                    };
                } else if (__value__ == (5159083i32)) {
                    if ((@:checkr _dec ?? throw "null pointer dereference")._scan._step((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 5159133i32;
                    } else {
                        _gotoNext = 5159162i32;
                    };
                } else if (__value__ == (5159133i32)) {
                    inputBreak = true;
                    _gotoNext = 5158230i32;
                } else if (__value__ == (5159162i32)) {
                    if (stdgo._internal.encoding.json.Json__nonSpace._nonSpace((@:checkr _dec ?? throw "null pointer dereference")._buf)) {
                        _gotoNext = 5159183i32;
                    } else {
                        _gotoNext = 5159230i32;
                    };
                } else if (__value__ == (5159183i32)) {
                    _err_5158109 = stdgo._internal.io.Io_errUnexpectedEOF.errUnexpectedEOF;
                    _gotoNext = 5159230i32;
                } else if (__value__ == (5159230i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._err = _err_5158109;
                    return { _0 : (0 : stdgo.GoInt), _1 : _err_5158109 };
                    _gotoNext = 5159268i32;
                } else if (__value__ == (5159268i32)) {
                    _n_5159268 = (_scanp_5158085 - (@:checkr _dec ?? throw "null pointer dereference")._scanp : stdgo.GoInt);
                    _err_5158109 = @:check2r _dec._refill();
                    _scanp_5158085 = ((@:checkr _dec ?? throw "null pointer dereference")._scanp + _n_5159268 : stdgo.GoInt);
                    _gotoNext = 5158230i32;
                } else if (__value__ == (5159340i32)) {
                    return { _0 : (_scanp_5158085 - (@:checkr _dec ?? throw "null pointer dereference")._scanp : stdgo.GoInt), _1 : (null : stdgo.Error) };
                    _gotoNext = -1i32;
                };
            };
        };
