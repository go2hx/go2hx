...
return { _0 : _c, _1 : (null : stdgo.Error) };
    ...
    static public function _readValue( _dec:stdgo.Ref<stdgo._internal.encoding.json.Json_Decoder.Decoder>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        @:recv var _dec:stdgo.Ref<stdgo._internal.encoding.json.Json_Decoder.Decoder> = _dec;
        var _n_5462477:stdgo.GoInt = (0 : stdgo.GoInt);
        var _c_5461541:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var inputBreak = false;
        var _err_5461318:stdgo.Error = (null : stdgo.Error);
        var _scanp_5461294:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _scanp_5461294 = (@:checkr _dec ?? throw "null pointer dereference")._scanp;
                    _gotoNext = 5461328i32;
                } else if (__value__ == (5461328i32)) {
                    var __blank__ = 0i32;
                    inputBreak = false;
                    _gotoNext = 5461439i32;
                } else if (__value__ == (5461439i32)) {
                    if (!inputBreak && ((_scanp_5461294 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5461454i32;
                    } else {
                        _gotoNext = 5462549i32;
                    };
                } else if (__value__ == (5461454i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5461500i32;
                } else if (__value__ == (5461500i32)) {
                    if ((_scanp_5461294 < ((@:checkr _dec ?? throw "null pointer dereference")._buf.length) : Bool)) {
                        _gotoNext = 5461536i32;
                    } else {
                        _gotoNext = 5462256i32;
                    };
                } else if (__value__ == (5461528i32)) {
                    _scanp_5461294++;
                    _gotoNext = 5461500i32;
                } else if (__value__ == (5461536i32)) {
                    _c_5461541 = (@:checkr _dec ?? throw "null pointer dereference")._buf[(_scanp_5461294 : stdgo.GoInt)];
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes++;
                    _gotoNext = 5461584i32;
                } else if (__value__ == (5461584i32)) {
                    {
                        final __value__ = (@:checkr _dec ?? throw "null pointer dereference")._scan._step((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_scanner.T_scanner>), _c_5461541);
                        if (__value__ == ((10 : stdgo.GoInt))) {
                            _gotoNext = 5461624i32;
                        } else if (__value__ == ((5 : stdgo.GoInt)) || __value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 5461837i32;
                        } else if (__value__ == ((11 : stdgo.GoInt))) {
                            _gotoNext = 5462091i32;
                        } else {
                            _gotoNext = 5461528i32;
                        };
                    };
                } else if (__value__ == (5461624i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes--;
                    inputBreak = true;
                    _gotoNext = 5461439i32;
                } else if (__value__ == (5461837i32)) {
                    if (stdgo._internal.encoding.json.Json__stateEndValue._stateEndValue((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 5462050i32;
                    } else {
                        _gotoNext = 5461528i32;
                    };
                } else if (__value__ == (5462050i32)) {
                    _scanp_5461294++;
                    inputBreak = true;
                    _gotoNext = 5461439i32;
                } else if (__value__ == (5462091i32)) {
                    ...
                    _gotoNext = 5461528i32;
                } else if (__value__ == (5462256i32)) {
                    if (_err_5461318 != null) {
                        _gotoNext = 5462270i32;
                    } else {
                        _gotoNext = 5462477i32;
                    };
                } else if (__value__ == (5462270i32)) {
                    if (stdgo.Go.toInterface(_err_5461318) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eOF.eOF))) {
                        _gotoNext = 5462292i32;
                    } else {
                        _gotoNext = 5462439i32;
                    };
                } else if (__value__ == (5462292i32)) {
                    if ((@:checkr _dec ?? throw "null pointer dereference")._scan._step((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 5462342i32;
                    } else {
                        _gotoNext = 5462371i32;
                    };
                } else if (__value__ == (5462342i32)) {
                    inputBreak = true;
                    _gotoNext = 5461439i32;
                } else if (__value__ == (5462371i32)) {
                    if (stdgo._internal.encoding.json.Json__nonSpace._nonSpace((@:checkr _dec ?? throw "null pointer dereference")._buf)) {
                        _gotoNext = 5462392i32;
                    } else {
                        _gotoNext = 5462439i32;
                    };
                } else if (__value__ == (5462392i32)) {
                    _err_5461318 = stdgo._internal.io.Io_errUnexpectedEOF.errUnexpectedEOF;
                    _gotoNext = 5462439i32;
                } else if (__value__ == (5462439i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._err = _err_5461318;
                    return { _0 : (0 : stdgo.GoInt), _1 : _err_5461318 };
                    _gotoNext = 5462477i32;
                } else if (__value__ == (5462477i32)) {
                    _n_5462477 = (_scanp_5461294 - (@:checkr _dec ?? throw "null pointer dereference")._scanp : stdgo.GoInt);
                    _err_5461318 = @:check2r _dec._refill();
                    _scanp_5461294 = ((@:checkr _dec ?? throw "null pointer dereference")._scanp + _n_5462477 : stdgo.GoInt);
                    _gotoNext = 5461439i32;
                } else if (__value__ == (5462549i32)) {
                    return { _0 : (_scanp_5461294 - (@:checkr _dec ?? throw "null pointer dereference")._scanp : stdgo.GoInt), _1 : (null : stdgo.Error) };
                    _gotoNext = -1i32;
                };
            };
        };
