...
@:keep @:allow(stdgo._internal.encoding.json.Json.T_decodeState_asInterface) class T_decodeState_static_extension {
    ...
    static public function _rescanLiteral( _d:stdgo.Ref<stdgo._internal.encoding.json.Json_T_decodeState.T_decodeState>):Void {
        ...
        var _i_5228394:stdgo.GoInt = (0 : stdgo.GoInt);
        var _data_5228388:stdgo.Slice<stdgo.GoUInt8> = (null : stdgo.Slice<stdgo.GoUInt8>);
        var _gotoNext = 0i32;
                ...
                if (__value__ == (0i32)) {
                    {
                        ...
                        _data_5228388 = __tmp__0;
                        _i_5228394 = __tmp__1;
                    };
                    _gotoNext = 5228413i32;
                } else if (__value__ == (5228413i32)) {
                    var __blank__ = 0i32;
                    switchBreak = false;
                    _gotoNext = 5228422i32;
                } else if (__value__ == (5228422i32)) {
                    if (!switchBreak) {
                        {
                            final __value__ = _data_5228388[(_i_5228394 - (1 : stdgo.GoInt) : stdgo.GoInt)];
                            if (__value__ == ((34 : stdgo.GoUInt8))) {
                                _gotoNext = 5228442i32;
                                ...
                                _gotoNext = 5228631i32;
                            } else if (__value__ == ((116 : stdgo.GoUInt8))) {
                                _gotoNext = 5228876i32;
                            } else if (__value__ == ((102 : stdgo.GoUInt8))) {
                                _gotoNext = 5228913i32;
                            } else if (__value__ == ((110 : stdgo.GoUInt8))) {
                                _gotoNext = 5228952i32;
                            } else {
                                _gotoNext = 5228992i32;
                            };
                        };
                    } else {
                        _gotoNext = 5228992i32;
                    };
                } else if (__value__ == (5228442i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5228464i32;
                } else if (__value__ == (5228464i32)) {
                    if ((_i_5228394 < (_data_5228388.length) : Bool)) {
                        _gotoNext = 5228489i32;
                    } else {
                        _gotoNext = 5228992i32;
                    };
                } else if (__value__ == (5228485i32)) {
                    _i_5228394++;
                    _gotoNext = 5228464i32;
                } else if (__value__ == (5228489i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5228494i32;
                } else if (__value__ == (5228494i32)) {
                    {
                        final __value__ = _data_5228388[(_i_5228394 : stdgo.GoInt)];
                        if (__value__ == ((92 : stdgo.GoUInt8))) {
                            _gotoNext = 5228514i32;
                        } else if (__value__ == ((34 : stdgo.GoUInt8))) {
                            _gotoNext = 5228552i32;
                        } else {
                            _gotoNext = 5228485i32;
                        };
                    };
                } else if (__value__ == (5228514i32)) {
                    _i_5228394++;
                    _gotoNext = 5228485i32;
                } else if (__value__ == (5228552i32)) {
                    _i_5228394++;
                    switchBreak = true;
                    _gotoNext = 5228422i32;
                } else if (__value__ == (5228631i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5228703i32;
                } else if (__value__ == (5228703i32)) {
                    if ((_i_5228394 < (_data_5228388.length) : Bool)) {
                        _gotoNext = 5228728i32;
                    } else {
                        _gotoNext = 5228992i32;
                    };
                } else if (__value__ == (5228724i32)) {
                    _i_5228394++;
                    _gotoNext = 5228703i32;
                } else if (__value__ == (5228728i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5228733i32;
                } else if (__value__ == (5228733i32)) {
                    {
                        final __value__ = _data_5228388[(_i_5228394 : stdgo.GoInt)];
                        if (__value__ == ((48 : stdgo.GoUInt8)) || __value__ == ((49 : stdgo.GoUInt8)) || __value__ == ((50 : stdgo.GoUInt8)) || __value__ == ((51 : stdgo.GoUInt8)) || __value__ == ((52 : stdgo.GoUInt8)) || __value__ == ((53 : stdgo.GoUInt8)) || __value__ == ((54 : stdgo.GoUInt8)) || __value__ == ((55 : stdgo.GoUInt8)) || __value__ == ((56 : stdgo.GoUInt8)) || __value__ == ((57 : stdgo.GoUInt8)) || __value__ == ((46 : stdgo.GoUInt8)) || __value__ == ((101 : stdgo.GoUInt8)) || __value__ == ((69 : stdgo.GoUInt8)) || __value__ == ((43 : stdgo.GoUInt8)) || __value__ == ((45 : stdgo.GoUInt8))) {
                            _gotoNext = 5228753i32;
                        } else {
                            _gotoNext = 5228840i32;
                        };
                    };
                } else if (__value__ == (5228753i32)) {
                    _gotoNext = 5228724i32;
                } else if (__value__ == (5228840i32)) {
                    switchBreak = true;
                    _gotoNext = 5228422i32;
                } else if (__value__ == (5228876i32)) {
                    _i_5228394 = (_i_5228394 + ((("rue" : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5228992i32;
                } else if (__value__ == (5228913i32)) {
                    _i_5228394 = (_i_5228394 + ((("alse" : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5228992i32;
                } else if (__value__ == (5228952i32)) {
                    _i_5228394 = (_i_5228394 + ((("ull" : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5228992i32;
                } else if (__value__ == (5228992i32)) {
                    if ((_i_5228394 < (_data_5228388.length) : Bool)) {
                        _gotoNext = 5229009i32;
                    } else {
                        _gotoNext = 5229064i32;
                    };
                } else if (__value__ == (5229009i32)) {
                    _d._opcode = stdgo._internal.encoding.json.Json__stateEndValue._stateEndValue((stdgo.Go.setRef(_d._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_scanner.T_scanner>), _data_5228388[(_i_5228394 : stdgo.GoInt)]);
                    _gotoNext = 5229091i32;
                } else if (__value__ == (5229064i32)) {
                    _d._opcode = (10 : stdgo.GoInt);
                    _gotoNext = 5229091i32;
                } else if (__value__ == (5229091i32)) {
                    _d._off = (_i_5228394 + (1 : stdgo.GoInt) : stdgo.GoInt);
                    _gotoNext = -1i32;
                };
            };
        };
