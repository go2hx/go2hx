        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _d._opcode = stdgo._internal.encoding.json.Json__stateEndValue._stateEndValue((stdgo.Go.setRef(_d._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_scanner.T_scanner>), _data_5325603[(_i_5325609 : stdgo.GoInt)]);
                    _gotoNext = 5326306i32;
                } else if (__value__ == (5326279i32)) {
                    _d._opcode = (10 : stdgo.GoInt);
                    _gotoNext = 5326306i32;
                } else if (__value__ == (5326306i32)) {
                    _d._off = (_i_5325609 + (1 : stdgo.GoInt) : stdgo.GoInt);
                    _gotoNext = -1i32;
                };
            };
        };
