...
@:keep @:allow(stdgo._internal.encoding.json.Json.T_decodeState_asInterface) class T_decodeState_static_extension {
    ...
    static public function _rescanLiteral( _d:stdgo.Ref<stdgo._internal.encoding.json.Json_T_decodeState.T_decodeState>):Void {
        @:recv var _d:stdgo.Ref<stdgo._internal.encoding.json.Json_T_decodeState.T_decodeState> = _d;
        var _i_5367552:stdgo.GoInt = (0 : stdgo.GoInt);
        var _data_5367546:stdgo.Slice<stdgo.GoUInt8> = (null : stdgo.Slice<stdgo.GoUInt8>);
                ...
                if (__value__ == (0i32)) {
                    {
                        ...
                        _data_5367546 = __tmp__0;
                        _i_5367552 = __tmp__1;
                    };
                    _gotoNext = 5367571i32;
                } else if (__value__ == (5367571i32)) {
                    switchBreak = false;
                    _gotoNext = 5367580i32;
                } else if (__value__ == (5367580i32)) {
                    if (!switchBreak) {
                        {
                            final __value__ = _data_5367546[(_i_5367552 - (1 : stdgo.GoInt) : stdgo.GoInt)];
                            if (__value__ == ((34 : stdgo.GoUInt8))) {
                                _gotoNext = 5367600i32;
                                ...
                                _gotoNext = 5367789i32;
                            } else if (__value__ == ((116 : stdgo.GoUInt8))) {
                                _gotoNext = 5368034i32;
                            } else if (__value__ == ((102 : stdgo.GoUInt8))) {
                                _gotoNext = 5368071i32;
                            } else if (__value__ == ((110 : stdgo.GoUInt8))) {
                                _gotoNext = 5368110i32;
                            } else {
                                _gotoNext = 5368150i32;
                            };
                        };
                    } else {
                        _gotoNext = 5368150i32;
                    };
                } else if (__value__ == (5367600i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5367622i32;
                } else if (__value__ == (5367622i32)) {
                    if ((_i_5367552 < (_data_5367546.length) : Bool)) {
                        _gotoNext = 5367647i32;
                    } else {
                        _gotoNext = 5368150i32;
                    };
                } else if (__value__ == (5367643i32)) {
                    _i_5367552++;
                    _gotoNext = 5367622i32;
                } else if (__value__ == (5367647i32)) {
                    _gotoNext = 5367652i32;
                } else if (__value__ == (5367652i32)) {
                    {
                        final __value__ = _data_5367546[(_i_5367552 : stdgo.GoInt)];
                        if (__value__ == ((92 : stdgo.GoUInt8))) {
                            _gotoNext = 5367672i32;
                        } else if (__value__ == ((34 : stdgo.GoUInt8))) {
                            _gotoNext = 5367710i32;
                        } else {
                            _gotoNext = 5367643i32;
                        };
                    };
                } else if (__value__ == (5367672i32)) {
                    _i_5367552++;
                    _gotoNext = 5367643i32;
                } else if (__value__ == (5367710i32)) {
                    _i_5367552++;
                    switchBreak = true;
                    _gotoNext = 5367580i32;
                } else if (__value__ == (5367789i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5367861i32;
                } else if (__value__ == (5367861i32)) {
                    if ((_i_5367552 < (_data_5367546.length) : Bool)) {
                        _gotoNext = 5367886i32;
                    } else {
                        _gotoNext = 5368150i32;
                    };
                } else if (__value__ == (5367882i32)) {
                    _i_5367552++;
                    _gotoNext = 5367861i32;
                } else if (__value__ == (5367886i32)) {
                    _gotoNext = 5367891i32;
                } else if (__value__ == (5367891i32)) {
                    {
                        final __value__ = _data_5367546[(_i_5367552 : stdgo.GoInt)];
                        if (__value__ == ((48 : stdgo.GoUInt8)) || __value__ == ((49 : stdgo.GoUInt8)) || __value__ == ((50 : stdgo.GoUInt8)) || __value__ == ((51 : stdgo.GoUInt8)) || __value__ == ((52 : stdgo.GoUInt8)) || __value__ == ((53 : stdgo.GoUInt8)) || __value__ == ((54 : stdgo.GoUInt8)) || __value__ == ((55 : stdgo.GoUInt8)) || __value__ == ((56 : stdgo.GoUInt8)) || __value__ == ((57 : stdgo.GoUInt8)) || __value__ == ((46 : stdgo.GoUInt8)) || __value__ == ((101 : stdgo.GoUInt8)) || __value__ == ((69 : stdgo.GoUInt8)) || __value__ == ((43 : stdgo.GoUInt8)) || __value__ == ((45 : stdgo.GoUInt8))) {
                            _gotoNext = 5367911i32;
                        } else {
                            _gotoNext = 5367998i32;
                        };
                    };
                } else if (__value__ == (5367911i32)) {
                    _gotoNext = 5367882i32;
                } else if (__value__ == (5367998i32)) {
                    switchBreak = true;
                    _gotoNext = 5367580i32;
                } else if (__value__ == (5368034i32)) {
                    _i_5367552 = (_i_5367552 + ((("rue" : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5368150i32;
                } else if (__value__ == (5368071i32)) {
                    _i_5367552 = (_i_5367552 + ((("alse" : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5368150i32;
                } else if (__value__ == (5368110i32)) {
                    _i_5367552 = (_i_5367552 + ((("ull" : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5368150i32;
                } else if (__value__ == (5368150i32)) {
                    if ((_i_5367552 < (_data_5367546.length) : Bool)) {
                        _gotoNext = 5368167i32;
                    } else {
                        _gotoNext = 5368222i32;
                    };
                } else if (__value__ == (5368167i32)) {
                    _d._opcode = stdgo._internal.encoding.json.Json__stateEndValue._stateEndValue((stdgo.Go.setRef(_d._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_scanner.T_scanner>), _data_5367546[(_i_5367552 : stdgo.GoInt)]);
                    _gotoNext = 5368249i32;
                } else if (__value__ == (5368222i32)) {
                    _gotoNext = 5368222i32;
                    _d._opcode = (10 : stdgo.GoInt);
                    var __blank__ = 0i32;
                    _gotoNext = 5368249i32;
                } else if (__value__ == (5368249i32)) {
                    _d._off = (_i_5367552 + (1 : stdgo.GoInt) : stdgo.GoInt);
                    _gotoNext = -1i32;
                };
            };
        };
