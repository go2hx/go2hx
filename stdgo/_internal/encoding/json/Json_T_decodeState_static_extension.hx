...
@:keep @:allow(stdgo._internal.encoding.json.Json.T_decodeState_asInterface) class T_decodeState_static_extension {
    ...
    static public function _rescanLiteral( _d:stdgo.Ref<stdgo._internal.encoding.json.Json_T_decodeState.T_decodeState>):Void {
        ...
        var _i_5095160:stdgo.GoInt = (0 : stdgo.GoInt);
        var _data_5095154:stdgo.Slice<stdgo.GoUInt8> = (null : stdgo.Slice<stdgo.GoUInt8>);
        var _gotoNext = 0i32;
                ...
                if (__value__ == (0i32)) {
                    {
                        ...
                        _data_5095154 = __tmp__0;
                        _i_5095160 = __tmp__1;
                    };
                    _gotoNext = 5095179i32;
                } else if (__value__ == (5095179i32)) {
                    switchBreak = false;
                    _gotoNext = 5095188i32;
                } else if (__value__ == (5095188i32)) {
                    if (!switchBreak) {
                        {
                            final __value__ = _data_5095154[(_i_5095160 - (1 : stdgo.GoInt) : stdgo.GoInt)];
                            if (__value__ == ((34 : stdgo.GoUInt8))) {
                                _gotoNext = 5095208i32;
                                ...
                                _gotoNext = 5095397i32;
                            } else if (__value__ == ((116 : stdgo.GoUInt8))) {
                                _gotoNext = 5095642i32;
                            } else if (__value__ == ((102 : stdgo.GoUInt8))) {
                                _gotoNext = 5095679i32;
                            } else if (__value__ == ((110 : stdgo.GoUInt8))) {
                                _gotoNext = 5095718i32;
                            } else {
                                _gotoNext = 5095758i32;
                            };
                        };
                    } else {
                        _gotoNext = 5095758i32;
                    };
                } else if (__value__ == (5095208i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5095230i32;
                } else if (__value__ == (5095230i32)) {
                    if ((_i_5095160 < (_data_5095154.length) : Bool)) {
                        _gotoNext = 5095255i32;
                    } else {
                        _gotoNext = 5095758i32;
                    };
                } else if (__value__ == (5095251i32)) {
                    _i_5095160++;
                    _gotoNext = 5095230i32;
                } else if (__value__ == (5095255i32)) {
                    _gotoNext = 5095260i32;
                } else if (__value__ == (5095260i32)) {
                    {
                        final __value__ = _data_5095154[(_i_5095160 : stdgo.GoInt)];
                        if (__value__ == ((92 : stdgo.GoUInt8))) {
                            _gotoNext = 5095280i32;
                        } else if (__value__ == ((34 : stdgo.GoUInt8))) {
                            _gotoNext = 5095318i32;
                        } else {
                            _gotoNext = 5095251i32;
                        };
                    };
                } else if (__value__ == (5095280i32)) {
                    _i_5095160++;
                    _gotoNext = 5095251i32;
                } else if (__value__ == (5095318i32)) {
                    _i_5095160++;
                    switchBreak = true;
                    _gotoNext = 5095188i32;
                } else if (__value__ == (5095397i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5095469i32;
                } else if (__value__ == (5095469i32)) {
                    if ((_i_5095160 < (_data_5095154.length) : Bool)) {
                        _gotoNext = 5095494i32;
                    } else {
                        _gotoNext = 5095758i32;
                    };
                } else if (__value__ == (5095490i32)) {
                    _i_5095160++;
                    _gotoNext = 5095469i32;
                } else if (__value__ == (5095494i32)) {
                    _gotoNext = 5095499i32;
                } else if (__value__ == (5095499i32)) {
                    {
                        final __value__ = _data_5095154[(_i_5095160 : stdgo.GoInt)];
                        if (__value__ == ((48 : stdgo.GoUInt8)) || __value__ == ((49 : stdgo.GoUInt8)) || __value__ == ((50 : stdgo.GoUInt8)) || __value__ == ((51 : stdgo.GoUInt8)) || __value__ == ((52 : stdgo.GoUInt8)) || __value__ == ((53 : stdgo.GoUInt8)) || __value__ == ((54 : stdgo.GoUInt8)) || __value__ == ((55 : stdgo.GoUInt8)) || __value__ == ((56 : stdgo.GoUInt8)) || __value__ == ((57 : stdgo.GoUInt8)) || __value__ == ((46 : stdgo.GoUInt8)) || __value__ == ((101 : stdgo.GoUInt8)) || __value__ == ((69 : stdgo.GoUInt8)) || __value__ == ((43 : stdgo.GoUInt8)) || __value__ == ((45 : stdgo.GoUInt8))) {
                            _gotoNext = 5095519i32;
                        } else {
                            _gotoNext = 5095606i32;
                        };
                    };
                } else if (__value__ == (5095519i32)) {
                    _gotoNext = 5095490i32;
                } else if (__value__ == (5095606i32)) {
                    switchBreak = true;
                    _gotoNext = 5095188i32;
                } else if (__value__ == (5095642i32)) {
                    _i_5095160 = (_i_5095160 + ((("rue" : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5095758i32;
                } else if (__value__ == (5095679i32)) {
                    _i_5095160 = (_i_5095160 + ((("alse" : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5095758i32;
                } else if (__value__ == (5095718i32)) {
                    _i_5095160 = (_i_5095160 + ((("ull" : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5095758i32;
                } else if (__value__ == (5095758i32)) {
                    if ((_i_5095160 < (_data_5095154.length) : Bool)) {
                        _gotoNext = 5095775i32;
                    } else {
                        _gotoNext = 5095830i32;
                    };
                } else if (__value__ == (5095775i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._opcode = stdgo._internal.encoding.json.Json__stateEndValue._stateEndValue((stdgo.Go.setRef((@:checkr _d ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_scanner.T_scanner>), _data_5095154[(_i_5095160 : stdgo.GoInt)]);
                    _gotoNext = 5095857i32;
                } else if (__value__ == (5095830i32)) {
                    _gotoNext = 5095830i32;
                    (@:checkr _d ?? throw "null pointer dereference")._opcode = (10 : stdgo.GoInt);
                    var __blank__ = 0i32;
                    _gotoNext = 5095857i32;
                } else if (__value__ == (5095857i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._off = (_i_5095160 + (1 : stdgo.GoInt) : stdgo.GoInt);
                    _gotoNext = -1i32;
                };
            };
        };
