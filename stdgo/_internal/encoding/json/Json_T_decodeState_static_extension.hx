...
@:keep @:allow(stdgo._internal.encoding.json.Json.T_decodeState_asInterface) class T_decodeState_static_extension {
    ...
    static public function _rescanLiteral( _d:stdgo.Ref<stdgo._internal.encoding.json.Json_T_decodeState.T_decodeState>):Void {
        ...
        var _i_5231147:stdgo.GoInt = (0 : stdgo.GoInt);
        var _data_5231141:stdgo.Slice<stdgo.GoUInt8> = (null : stdgo.Slice<stdgo.GoUInt8>);
        var _gotoNext = 0i32;
                ...
                if (__value__ == (0i32)) {
                    {
                        ...
                        _data_5231141 = __tmp__0;
                        _i_5231147 = __tmp__1;
                    };
                    _gotoNext = 5231166i32;
                } else if (__value__ == (5231166i32)) {
                    switchBreak = false;
                    _gotoNext = 5231175i32;
                } else if (__value__ == (5231175i32)) {
                    if (!switchBreak) {
                        {
                            final __value__ = _data_5231141[(_i_5231147 - (1 : stdgo.GoInt) : stdgo.GoInt)];
                            if (__value__ == ((34 : stdgo.GoUInt8))) {
                                _gotoNext = 5231195i32;
                                ...
                                _gotoNext = 5231384i32;
                            } else if (__value__ == ((116 : stdgo.GoUInt8))) {
                                _gotoNext = 5231629i32;
                            } else if (__value__ == ((102 : stdgo.GoUInt8))) {
                                _gotoNext = 5231666i32;
                            } else if (__value__ == ((110 : stdgo.GoUInt8))) {
                                _gotoNext = 5231705i32;
                            } else {
                                _gotoNext = 5231745i32;
                            };
                        };
                    } else {
                        _gotoNext = 5231745i32;
                    };
                } else if (__value__ == (5231195i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5231217i32;
                } else if (__value__ == (5231217i32)) {
                    if ((_i_5231147 < (_data_5231141.length) : Bool)) {
                        _gotoNext = 5231242i32;
                    } else {
                        _gotoNext = 5231745i32;
                    };
                } else if (__value__ == (5231238i32)) {
                    _i_5231147++;
                    _gotoNext = 5231217i32;
                } else if (__value__ == (5231242i32)) {
                    _gotoNext = 5231247i32;
                } else if (__value__ == (5231247i32)) {
                    {
                        final __value__ = _data_5231141[(_i_5231147 : stdgo.GoInt)];
                        if (__value__ == ((92 : stdgo.GoUInt8))) {
                            _gotoNext = 5231267i32;
                        } else if (__value__ == ((34 : stdgo.GoUInt8))) {
                            _gotoNext = 5231305i32;
                        } else {
                            _gotoNext = 5231238i32;
                        };
                    };
                } else if (__value__ == (5231267i32)) {
                    _i_5231147++;
                    _gotoNext = 5231238i32;
                } else if (__value__ == (5231305i32)) {
                    _i_5231147++;
                    switchBreak = true;
                    _gotoNext = 5231175i32;
                } else if (__value__ == (5231384i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5231456i32;
                } else if (__value__ == (5231456i32)) {
                    if ((_i_5231147 < (_data_5231141.length) : Bool)) {
                        _gotoNext = 5231481i32;
                    } else {
                        _gotoNext = 5231745i32;
                    };
                } else if (__value__ == (5231477i32)) {
                    _i_5231147++;
                    _gotoNext = 5231456i32;
                } else if (__value__ == (5231481i32)) {
                    _gotoNext = 5231486i32;
                } else if (__value__ == (5231486i32)) {
                    {
                        final __value__ = _data_5231141[(_i_5231147 : stdgo.GoInt)];
                        if (__value__ == ((48 : stdgo.GoUInt8)) || __value__ == ((49 : stdgo.GoUInt8)) || __value__ == ((50 : stdgo.GoUInt8)) || __value__ == ((51 : stdgo.GoUInt8)) || __value__ == ((52 : stdgo.GoUInt8)) || __value__ == ((53 : stdgo.GoUInt8)) || __value__ == ((54 : stdgo.GoUInt8)) || __value__ == ((55 : stdgo.GoUInt8)) || __value__ == ((56 : stdgo.GoUInt8)) || __value__ == ((57 : stdgo.GoUInt8)) || __value__ == ((46 : stdgo.GoUInt8)) || __value__ == ((101 : stdgo.GoUInt8)) || __value__ == ((69 : stdgo.GoUInt8)) || __value__ == ((43 : stdgo.GoUInt8)) || __value__ == ((45 : stdgo.GoUInt8))) {
                            _gotoNext = 5231506i32;
                        } else {
                            _gotoNext = 5231593i32;
                        };
                    };
                } else if (__value__ == (5231506i32)) {
                    _gotoNext = 5231477i32;
                } else if (__value__ == (5231593i32)) {
                    switchBreak = true;
                    _gotoNext = 5231175i32;
                } else if (__value__ == (5231629i32)) {
                    _i_5231147 = (_i_5231147 + ((("rue" : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5231745i32;
                } else if (__value__ == (5231666i32)) {
                    _i_5231147 = (_i_5231147 + ((("alse" : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5231745i32;
                } else if (__value__ == (5231705i32)) {
                    _i_5231147 = (_i_5231147 + ((("ull" : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5231745i32;
                } else if (__value__ == (5231745i32)) {
                    if ((_i_5231147 < (_data_5231141.length) : Bool)) {
                        _gotoNext = 5231762i32;
                    } else {
                        _gotoNext = 5231817i32;
                    };
                } else if (__value__ == (5231762i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._opcode = stdgo._internal.encoding.json.Json__stateEndValue._stateEndValue((stdgo.Go.setRef((@:checkr _d ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_scanner.T_scanner>), _data_5231141[(_i_5231147 : stdgo.GoInt)]);
                    _gotoNext = 5231844i32;
                } else if (__value__ == (5231817i32)) {
                    _gotoNext = 5231817i32;
                    (@:checkr _d ?? throw "null pointer dereference")._opcode = (10 : stdgo.GoInt);
                    var __blank__ = 0i32;
                    _gotoNext = 5231844i32;
                } else if (__value__ == (5231844i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._off = (_i_5231147 + (1 : stdgo.GoInt) : stdgo.GoInt);
                    _gotoNext = -1i32;
                };
            };
        };
