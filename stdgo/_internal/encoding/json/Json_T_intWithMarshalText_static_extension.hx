...
@:keep @:allow(stdgo._internal.encoding.json.Json.T_intWithMarshalText_asInterface) class T_intWithMarshalText_static_extension {
    @:keep
    @:pointer
    static public function unmarshalText(____:stdgo._internal.encoding.json.Json_T_intWithMarshalText.T_intWithMarshalText,  _b:stdgo.Pointer<stdgo._internal.encoding.json.Json_T_intWithMarshalText.T_intWithMarshalText>, _data:stdgo.Slice<stdgo.GoUInt8>):stdgo.Error {
