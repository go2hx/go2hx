        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < (_f_5348953._index.length)) {
                        _gotoNext = 5349206i32;
                    } else {
                        _gotoNext = 5349212i32;
                    };
                } else if (__value__ == (5349072i32)) {
                    _i_5349053 = _f_5348953._index[(_i_5349058_0 : stdgo.GoInt)];
                    ...
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _f_5348953._index[(0i32 : stdgo.GoInt)];
                        _i_5349058_0 = __tmp__0;
                        _i_5349053 = __tmp__1;
                    };
                    _gotoNext = 5349207i32;
                } else if (__value__ == (5349207i32)) {
                    if (_i_5349058_0 < (_f_5348953._index.length)) {
                        _gotoNext = 5349072i32;
                    } else {
                        _gotoNext = 5349212i32;
                    };
                } else if (__value__ == (5349212i32)) {
                    if ((_f_5348953._omitEmpty && stdgo._internal.encoding.json.Json__isEmptyValue._isEmptyValue(_fv_5349036?.__copy__()) : Bool)) {
                    ...
                    _e.writeString(_f_5348953._nameEscHTML?.__copy__());
                    _gotoNext = 5349401i32;
                } else if (__value__ == (5349362i32)) {
                    _gotoNext = 5349362i32;
                    _e.writeString(_f_5348953._nameNonEsc?.__copy__());
                    var __blank__ = 0i32;
                    _gotoNext = 5349401i32;
                } else if (__value__ == (5349401i32)) {
                    _opts._quoted = _f_5348953._quoted;
                    _f_5348953._encoder(_e, _fv_5349036?.__copy__(), _opts?.__copy__());
                    _i_5348923++;
                    _gotoNext = 5349450i32;
