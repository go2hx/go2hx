...
function _benchMarshalBytes(_n:stdgo.GoInt):stdgo.Ref<stdgo._internal.testing.Testing_b.B> -> Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/json/bench_test.go#L188"
        return function(_b:stdgo.Ref<stdgo._internal.testing.Testing_b.B>):Void {
            //"file:///home/runner/.go/go1.21.3/src/encoding/json/bench_test.go#L189"
            {
                var _i = (0 : stdgo.GoInt);
                while ((_i < (@:checkr _b ?? throw "null pointer dereference").n : Bool)) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/json/bench_test.go#L190"
                    {
                        ...
                        if (_err != null) {
                            //"file:///home/runner/.go/go1.21.3/src/encoding/json/bench_test.go#L191"
