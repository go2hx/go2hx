...
function _benchMarshalBytesError(_n:stdgo.GoInt):stdgo.Ref<stdgo._internal.testing.Testing_b.B> -> Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/json/bench_test.go#L215"
        return function(_b:stdgo.Ref<stdgo._internal.testing.Testing_b.B>):Void {
            //"file:///home/runner/.go/go1.21.3/src/encoding/json/bench_test.go#L216"
            {
                var _i = (0 : stdgo.GoInt);
                while ((_i < (@:checkr _b ?? throw "null pointer dereference").n : Bool)) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/json/bench_test.go#L217"
                    {
                        ...
                        if (_err != null) {
                            //"file:///home/runner/.go/go1.21.3/src/encoding/json/bench_test.go#L218"
                            _b.fatal(stdgo.Go.toInterface(("Marshal:" : stdgo.GoString)), stdgo.Go.toInterface(_err));
                        };
                    };
//"file:///home/runner/.go/go1.21.3/src/encoding/json/bench_test.go#L220"
                    {
                        ...
                        if (_err == null) {
                            //"file:///home/runner/.go/go1.21.3/src/encoding/json/bench_test.go#L221"
