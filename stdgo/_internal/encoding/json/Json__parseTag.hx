...
function _parseTag(_tag:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : stdgo._internal.encoding.json.Json_T_tagOptions.T_tagOptions; } {
        var __tmp__ = stdgo._internal.strings.Strings_cut.cut(_tag?.__copy__(), ("," : stdgo.GoString)), _tag:stdgo.GoString = __tmp__._0, _opt:stdgo.GoString = __tmp__._1, __8:Bool = __tmp__._2;
