...
function _stateBeginValue(_s:stdgo.Ref<stdgo._internal.encoding.json.Json_t_scanner.T_scanner>, _c:stdgo.GoUInt8):stdgo.GoInt {
        //"file:///home/runner/.go/go1.21.3/src/encoding/json/scanner.go#L216"
        if (stdgo._internal.encoding.json.Json__isspace._isSpace(_c)) {
            //"file:///home/runner/.go/go1.21.3/src/encoding/json/scanner.go#L217"
            return (9 : stdgo.GoInt);
        };
        //"file:///home/runner/.go/go1.21.3/src/encoding/json/scanner.go#L219"
        {
            final __value__ = _c;
            if (__value__ == ((123 : stdgo.GoUInt8))) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/json/scanner.go#L222"
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/json/scanner.go#L225"
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/json/scanner.go#L228"
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/json/scanner.go#L231"
                return (1 : stdgo.GoInt);
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/json/scanner.go#L234"
                return (1 : stdgo.GoInt);
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/json/scanner.go#L237"
                return (1 : stdgo.GoInt);
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/json/scanner.go#L240"
                return (1 : stdgo.GoInt);
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/json/scanner.go#L243"
                return (1 : stdgo.GoInt);
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/encoding/json/scanner.go#L245"
        if ((((49 : stdgo.GoUInt8) <= _c : Bool) && (_c <= (57 : stdgo.GoUInt8) : Bool) : Bool)) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/encoding/json/scanner.go#L247"
            return (1 : stdgo.GoInt);
        };
        //"file:///home/runner/.go/go1.21.3/src/encoding/json/scanner.go#L249"
