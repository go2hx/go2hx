...
function _unsupportedTypeEncoder(_e:stdgo.Ref<stdgo._internal.encoding.json.Json_T_encodeState.T_encodeState>, _v:stdgo._internal.reflect.Reflect_Value.Value, __8:stdgo._internal.encoding.json.Json_T_encOpts.T_encOpts):Void {
