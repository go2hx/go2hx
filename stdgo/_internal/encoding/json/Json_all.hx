...
@:structInit @:using(stdgo._internal.encoding.json.Json_all_static_extension.All_static_extension) class All {
    ...
    public var pPSmall : stdgo.Pointer<stdgo.Ref<stdgo._internal.encoding.json.Json_small.Small>> = (null : stdgo.Pointer<stdgo.Ref<stdgo._internal.encoding.json.Json_small.Small>>);
