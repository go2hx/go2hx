...
function benchmarkEncodeMarshaler(_b:stdgo.Ref<stdgo._internal.testing.Testing_B.B>):Void {
        ...
        var _m__pointer__ = (stdgo.Go.setRef(_m) : stdgo.Ref<stdgo._internal.encoding.json.Json_T__struct_3.T__struct_3>);
        var _m__pointer__ = (stdgo.Go.setRef(_m) : stdgo.Ref<stdgo._internal.encoding.json.Json_T__struct_3.T__struct_3>);
        var _m__pointer__ = (stdgo.Go.setRef(_m) : stdgo.Ref<stdgo._internal.encoding.json.Json_T__struct_3.T__struct_3>);
        var _m__pointer__ = (stdgo.Go.setRef(_m) : stdgo.Ref<stdgo._internal.encoding.json.Json_T__struct_3.T__struct_3>);
        _b.runParallel(function(_pb:stdgo.Ref<stdgo._internal.testing.Testing_PB.PB>):Void {
            ...
            while (_pb.next()) {
                {
                    var _err = (_enc.encode(stdgo.Go.toInterface(stdgo.Go.asInterface(_m__pointer__))) : stdgo.Error);
                    if (_err != null) {
