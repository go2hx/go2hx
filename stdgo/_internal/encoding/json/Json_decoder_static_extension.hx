        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5381150i32;
                } else if (__value__ == (5381150i32)) {
                    0i32;
                    inputBreak = false;
                    _gotoNext = 5381261i32;
                } else if (__value__ == (5381261i32)) {
                    if (!inputBreak && ((_scanp_8 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5381276i32;
                    } else {
                        _gotoNext = 5382371i32;
                    };
                } else if (__value__ == (5381276i32)) {
                    0i32;
                    _gotoNext = 5381322i32;
                } else if (__value__ == (5381322i32)) {
                    if ((_scanp_8 < ((@:checkr _dec ?? throw "null pointer dereference")._buf.length) : Bool)) {
                        _gotoNext = 5381358i32;
                    } else {
                        _gotoNext = 5382078i32;
                    };
                } else if (__value__ == (5381350i32)) {
                    _scanp_8++;
                    _gotoNext = 5381322i32;
                } else if (__value__ == (5381358i32)) {
                    ...
                    _gotoNext = 5381406i32;
                } else if (__value__ == (5381406i32)) {
                    {
                        ...
                        if (__value__ == ((10 : stdgo.GoInt))) {
                            _gotoNext = 5381446i32;
                        } else if (__value__ == ((5 : stdgo.GoInt)) || __value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 5381659i32;
                        } else if (__value__ == ((11 : stdgo.GoInt))) {
                            _gotoNext = 5381913i32;
                        } else {
                            _gotoNext = 5381350i32;
                        };
                    };
                } else if (__value__ == (5381446i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes--;
                    inputBreak = true;
                    _gotoNext = 5381261i32;
                } else if (__value__ == (5381659i32)) {
                    if (stdgo._internal.encoding.json.Json__stateendvalue._stateEndValue((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 5381872i32;
                    } else {
                        _gotoNext = 5381350i32;
                    };
                } else if (__value__ == (5381872i32)) {
                    _scanp_8++;
                    inputBreak = true;
                    _gotoNext = 5381261i32;
                } else if (__value__ == (5381913i32)) {
