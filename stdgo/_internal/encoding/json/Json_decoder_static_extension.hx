...
return { _0 : _c, _1 : (null : stdgo.Error) };
    ...
    static public function _readValue( _dec:stdgo.Ref<stdgo._internal.encoding.json.Json_decoder.Decoder>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        @:recv var _dec:stdgo.Ref<stdgo._internal.encoding.json.Json_decoder.Decoder> = _dec;
        var _n_5515830:stdgo.GoInt = (0 : stdgo.GoInt);
        var _c_5514894:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var inputBreak = false;
        var _err_5514671:stdgo.Error = (null : stdgo.Error);
        var _scanp_5514647:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _scanp_5514647 = (@:checkr _dec ?? throw "null pointer dereference")._scanp;
                    _gotoNext = 5514681i32;
                } else if (__value__ == (5514681i32)) {
                    var __blank__ = 0i32;
                    inputBreak = false;
                    _gotoNext = 5514792i32;
                } else if (__value__ == (5514792i32)) {
                    if (!inputBreak && ((_scanp_5514647 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5514807i32;
                    } else {
                        _gotoNext = 5515902i32;
                    };
                } else if (__value__ == (5514807i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5514853i32;
                } else if (__value__ == (5514853i32)) {
                    if ((_scanp_5514647 < ((@:checkr _dec ?? throw "null pointer dereference")._buf.length) : Bool)) {
                        _gotoNext = 5514889i32;
                    } else {
                        _gotoNext = 5515609i32;
                    };
                } else if (__value__ == (5514881i32)) {
                    _scanp_5514647++;
                    _gotoNext = 5514853i32;
                } else if (__value__ == (5514889i32)) {
                    _c_5514894 = (@:checkr _dec ?? throw "null pointer dereference")._buf[(_scanp_5514647 : stdgo.GoInt)];
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes++;
                    _gotoNext = 5514937i32;
                } else if (__value__ == (5514937i32)) {
                    {
                        final __value__ = (@:checkr _dec ?? throw "null pointer dereference")._scan._step((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_scanner.T_scanner>), _c_5514894);
                        if (__value__ == ((10 : stdgo.GoInt))) {
                            _gotoNext = 5514977i32;
                        } else if (__value__ == ((5 : stdgo.GoInt)) || __value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 5515190i32;
                        } else if (__value__ == ((11 : stdgo.GoInt))) {
                            _gotoNext = 5515444i32;
                        } else {
                            _gotoNext = 5514881i32;
                        };
                    };
                } else if (__value__ == (5514977i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes--;
                    inputBreak = true;
                    _gotoNext = 5514792i32;
                } else if (__value__ == (5515190i32)) {
                    if (stdgo._internal.encoding.json.Json__stateendvalue._stateEndValue((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 5515403i32;
                    } else {
                        _gotoNext = 5514881i32;
                    };
                } else if (__value__ == (5515403i32)) {
                    _scanp_5514647++;
                    inputBreak = true;
                    _gotoNext = 5514792i32;
                } else if (__value__ == (5515444i32)) {
                    ...
                    _gotoNext = 5514881i32;
                } else if (__value__ == (5515609i32)) {
                    if (_err_5514671 != null) {
                        _gotoNext = 5515623i32;
                    } else {
                        _gotoNext = 5515830i32;
                    };
                } else if (__value__ == (5515623i32)) {
                    if (stdgo.Go.toInterface(_err_5514671) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 5515645i32;
                    } else {
                        _gotoNext = 5515792i32;
                    };
                } else if (__value__ == (5515645i32)) {
                    if ((@:checkr _dec ?? throw "null pointer dereference")._scan._step((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 5515695i32;
                    } else {
                        _gotoNext = 5515724i32;
                    };
                } else if (__value__ == (5515695i32)) {
                    inputBreak = true;
                    _gotoNext = 5514792i32;
                } else if (__value__ == (5515724i32)) {
                    if (stdgo._internal.encoding.json.Json__nonspace._nonSpace((@:checkr _dec ?? throw "null pointer dereference")._buf)) {
                        _gotoNext = 5515745i32;
                    } else {
                        _gotoNext = 5515792i32;
                    };
                } else if (__value__ == (5515745i32)) {
                    _err_5514671 = stdgo._internal.io.Io_errunexpectedeof.errUnexpectedEOF;
                    _gotoNext = 5515792i32;
                } else if (__value__ == (5515792i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._err = _err_5514671;
                    return { _0 : (0 : stdgo.GoInt), _1 : _err_5514671 };
                    _gotoNext = 5515830i32;
                } else if (__value__ == (5515830i32)) {
                    _n_5515830 = (_scanp_5514647 - (@:checkr _dec ?? throw "null pointer dereference")._scanp : stdgo.GoInt);
                    _err_5514671 = @:check2r _dec._refill();
                    _scanp_5514647 = ((@:checkr _dec ?? throw "null pointer dereference")._scanp + _n_5515830 : stdgo.GoInt);
                    _gotoNext = 5514792i32;
                } else if (__value__ == (5515902i32)) {
                    return { _0 : (_scanp_5514647 - (@:checkr _dec ?? throw "null pointer dereference")._scanp : stdgo.GoInt), _1 : (null : stdgo.Error) };
                    _gotoNext = -1i32;
                };
            };
        };
