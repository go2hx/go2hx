        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5685830i32;
                } else if (__value__ == (5685830i32)) {
                    var __blank__ = 0i32;
                    inputBreak = false;
                    _gotoNext = 5685941i32;
                } else if (__value__ == (5685941i32)) {
                    if (!inputBreak && ((_scanp_8 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5685956i32;
                    } else {
                        _gotoNext = 5687051i32;
                    };
                } else if (__value__ == (5685956i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5686002i32;
                } else if (__value__ == (5686002i32)) {
                    if ((_scanp_8 < ((@:checkr _dec ?? throw "null pointer dereference")._buf.length) : Bool)) {
                        _gotoNext = 5686038i32;
                    } else {
                        _gotoNext = 5686758i32;
                    };
                } else if (__value__ == (5686030i32)) {
                    _scanp_8++;
                    _gotoNext = 5686002i32;
                } else if (__value__ == (5686038i32)) {
                    ...
                    _gotoNext = 5686086i32;
                } else if (__value__ == (5686086i32)) {
                    {
                        ...
                        if (__value__ == ((10 : stdgo.GoInt))) {
                            _gotoNext = 5686126i32;
                        } else if (__value__ == ((5 : stdgo.GoInt)) || __value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 5686339i32;
                        } else if (__value__ == ((11 : stdgo.GoInt))) {
                            _gotoNext = 5686593i32;
                        } else {
                            _gotoNext = 5686030i32;
                        };
                    };
                } else if (__value__ == (5686126i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes--;
                    inputBreak = true;
                    _gotoNext = 5685941i32;
                } else if (__value__ == (5686339i32)) {
                    if (stdgo._internal.encoding.json.Json__stateendvalue._stateEndValue((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 5686552i32;
                    } else {
                        _gotoNext = 5686030i32;
                    };
                } else if (__value__ == (5686552i32)) {
                    _scanp_8++;
                    inputBreak = true;
                    _gotoNext = 5685941i32;
                } else if (__value__ == (5686593i32)) {
                    ...
                    _gotoNext = 5686030i32;
                } else if (__value__ == (5686758i32)) {
                    if (_err_9 != null) {
                        _gotoNext = 5686772i32;
                    } else {
                        _gotoNext = 5686979i32;
                    };
                } else if (__value__ == (5686772i32)) {
                    if (stdgo.Go.toInterface(_err_9) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 5686794i32;
                    } else {
                        _gotoNext = 5686941i32;
                    };
                } else if (__value__ == (5686794i32)) {
