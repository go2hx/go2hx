        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5762363i32;
                } else if (__value__ == (5762363i32)) {
                    var __blank__ = 0i32;
                    inputBreak = false;
                    _gotoNext = 5762474i32;
                } else if (__value__ == (5762474i32)) {
                    if (!inputBreak && ((_scanp_8 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5762489i32;
                    } else {
                        _gotoNext = 5763584i32;
                    };
                } else if (__value__ == (5762489i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5762535i32;
                } else if (__value__ == (5762535i32)) {
                    if ((_scanp_8 < ((@:checkr _dec ?? throw "null pointer dereference")._buf.length) : Bool)) {
                        _gotoNext = 5762571i32;
                    } else {
                        _gotoNext = 5763291i32;
                    };
                } else if (__value__ == (5762563i32)) {
                    _scanp_8++;
                    _gotoNext = 5762535i32;
                } else if (__value__ == (5762571i32)) {
                    ...
                    _gotoNext = 5762619i32;
                } else if (__value__ == (5762619i32)) {
                    {
                        ...
                        if (__value__ == ((10 : stdgo.GoInt))) {
                            _gotoNext = 5762659i32;
                        } else if (__value__ == ((5 : stdgo.GoInt)) || __value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 5762872i32;
                        } else if (__value__ == ((11 : stdgo.GoInt))) {
                            _gotoNext = 5763126i32;
                        } else {
                            _gotoNext = 5762563i32;
                        };
                    };
                } else if (__value__ == (5762659i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes--;
                    inputBreak = true;
                    _gotoNext = 5762474i32;
                } else if (__value__ == (5762872i32)) {
                    if (stdgo._internal.encoding.json.Json__stateendvalue._stateEndValue((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 5763085i32;
                    } else {
                        _gotoNext = 5762563i32;
                    };
                } else if (__value__ == (5763085i32)) {
                    _scanp_8++;
                    inputBreak = true;
                    _gotoNext = 5762474i32;
                } else if (__value__ == (5763126i32)) {
                    ...
                    _gotoNext = 5762563i32;
                } else if (__value__ == (5763291i32)) {
                    if (_err_9 != null) {
                        _gotoNext = 5763305i32;
                    } else {
                        _gotoNext = 5763512i32;
                    };
                } else if (__value__ == (5763305i32)) {
                    if (stdgo.Go.toInterface(_err_9) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 5763327i32;
                    } else {
                        _gotoNext = 5763474i32;
                    };
                } else if (__value__ == (5763327i32)) {
