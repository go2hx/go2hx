        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5291728i32;
                } else if (__value__ == (5291728i32)) {
                    var __blank__ = 0i32;
                    inputBreak = false;
                    _gotoNext = 5291839i32;
                } else if (__value__ == (5291839i32)) {
                    if (!inputBreak && ((_scanp_8 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5291854i32;
                    } else {
                        _gotoNext = 5292949i32;
                    };
                } else if (__value__ == (5291854i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5291900i32;
                } else if (__value__ == (5291900i32)) {
                    if ((_scanp_8 < ((@:checkr _dec ?? throw "null pointer dereference")._buf.length) : Bool)) {
                        _gotoNext = 5291936i32;
                    } else {
                        _gotoNext = 5292656i32;
                    };
                } else if (__value__ == (5291928i32)) {
                    _scanp_8++;
                    _gotoNext = 5291900i32;
                } else if (__value__ == (5291936i32)) {
                    ...
                    _gotoNext = 5291984i32;
                } else if (__value__ == (5291984i32)) {
                    {
                        ...
                        if (__value__ == ((10 : stdgo.GoInt))) {
                            _gotoNext = 5292024i32;
                        } else if (__value__ == ((5 : stdgo.GoInt)) || __value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 5292237i32;
                        } else if (__value__ == ((11 : stdgo.GoInt))) {
                            _gotoNext = 5292491i32;
                        } else {
                            _gotoNext = 5291928i32;
                        };
                    };
                } else if (__value__ == (5292024i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes--;
                    inputBreak = true;
                    _gotoNext = 5291839i32;
                } else if (__value__ == (5292237i32)) {
                    if (stdgo._internal.encoding.json.Json__stateendvalue._stateEndValue((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 5292450i32;
                    } else {
                        _gotoNext = 5291928i32;
                    };
                } else if (__value__ == (5292450i32)) {
                    _scanp_8++;
                    inputBreak = true;
                    _gotoNext = 5291839i32;
                } else if (__value__ == (5292491i32)) {
                    ...
                    _gotoNext = 5291928i32;
                } else if (__value__ == (5292656i32)) {
                    if (_err_9 != null) {
                        _gotoNext = 5292670i32;
                    } else {
                        _gotoNext = 5292877i32;
                    };
                } else if (__value__ == (5292670i32)) {
                    if (stdgo.Go.toInterface(_err_9) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 5292692i32;
                    } else {
                        _gotoNext = 5292839i32;
                    };
                } else if (__value__ == (5292692i32)) {
