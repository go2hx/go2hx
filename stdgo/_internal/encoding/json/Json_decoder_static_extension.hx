        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 6487413i32;
                } else if (__value__ == (6487413i32)) {
                    0i32;
                    inputBreak = false;
                    _gotoNext = 6487524i32;
                } else if (__value__ == (6487524i32)) {
                    if (!inputBreak && ((_scanp_8 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 6487539i32;
                    } else {
                        _gotoNext = 6488634i32;
                    };
                } else if (__value__ == (6487539i32)) {
                    0i32;
                    _gotoNext = 6487585i32;
                } else if (__value__ == (6487585i32)) {
                    if ((_scanp_8 < ((@:checkr _dec ?? throw "null pointer dereference")._buf.length) : Bool)) {
                        _gotoNext = 6487621i32;
                    } else {
                        _gotoNext = 6488341i32;
                    };
                } else if (__value__ == (6487613i32)) {
                    _scanp_8++;
                    _gotoNext = 6487585i32;
                } else if (__value__ == (6487621i32)) {
                    ...
                    _gotoNext = 6487669i32;
                } else if (__value__ == (6487669i32)) {
                    {
                        ...
                        if (__value__ == ((10 : stdgo.GoInt))) {
                            _gotoNext = 6487709i32;
                        } else if (__value__ == ((5 : stdgo.GoInt)) || __value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 6487922i32;
                        } else if (__value__ == ((11 : stdgo.GoInt))) {
                            _gotoNext = 6488176i32;
                        } else {
                            _gotoNext = 6487613i32;
                        };
                    };
                } else if (__value__ == (6487709i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes--;
                    inputBreak = true;
                    _gotoNext = 6487524i32;
                } else if (__value__ == (6487922i32)) {
                    if (stdgo._internal.encoding.json.Json__stateendvalue._stateEndValue((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 6488135i32;
                    } else {
                        _gotoNext = 6487613i32;
                    };
                } else if (__value__ == (6488135i32)) {
                    _scanp_8++;
                    inputBreak = true;
                    _gotoNext = 6487524i32;
                } else if (__value__ == (6488176i32)) {
                    ...
                    _gotoNext = 6487613i32;
                } else if (__value__ == (6488341i32)) {
                    if (_err_9 != null) {
                        _gotoNext = 6488355i32;
                    } else {
                        _gotoNext = 6488562i32;
                    };
                } else if (__value__ == (6488355i32)) {
                    if (stdgo.Go.toInterface(_err_9) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 6488377i32;
                    } else {
                        _gotoNext = 6488524i32;
                    };
                } else if (__value__ == (6488377i32)) {
