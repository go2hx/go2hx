        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 6050284i32;
                } else if (__value__ == (6050284i32)) {
                    var __blank__ = 0i32;
                    inputBreak = false;
                    _gotoNext = 6050395i32;
                } else if (__value__ == (6050395i32)) {
                    if (!inputBreak && ((_scanp_8 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 6050410i32;
                    } else {
                        _gotoNext = 6051505i32;
                    };
                } else if (__value__ == (6050410i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 6050456i32;
                } else if (__value__ == (6050456i32)) {
                    if ((_scanp_8 < ((@:checkr _dec ?? throw "null pointer dereference")._buf.length) : Bool)) {
                        _gotoNext = 6050492i32;
                    } else {
                        _gotoNext = 6051212i32;
                    };
                } else if (__value__ == (6050484i32)) {
                    _scanp_8++;
                    _gotoNext = 6050456i32;
                } else if (__value__ == (6050492i32)) {
                    ...
                    _gotoNext = 6050540i32;
                } else if (__value__ == (6050540i32)) {
                    {
                        ...
                        if (__value__ == ((10 : stdgo.GoInt))) {
                            _gotoNext = 6050580i32;
                        } else if (__value__ == ((5 : stdgo.GoInt)) || __value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 6050793i32;
                        } else if (__value__ == ((11 : stdgo.GoInt))) {
                            _gotoNext = 6051047i32;
                        } else {
                            _gotoNext = 6050484i32;
                        };
                    };
                } else if (__value__ == (6050580i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes--;
                    inputBreak = true;
                    _gotoNext = 6050395i32;
                } else if (__value__ == (6050793i32)) {
                    if (stdgo._internal.encoding.json.Json__stateendvalue._stateEndValue((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 6051006i32;
                    } else {
                        _gotoNext = 6050484i32;
                    };
                } else if (__value__ == (6051006i32)) {
                    _scanp_8++;
                    inputBreak = true;
                    _gotoNext = 6050395i32;
                } else if (__value__ == (6051047i32)) {
                    ...
                    _gotoNext = 6050484i32;
                } else if (__value__ == (6051212i32)) {
                    if (_err_9 != null) {
                        _gotoNext = 6051226i32;
                    } else {
                        _gotoNext = 6051433i32;
                    };
                } else if (__value__ == (6051226i32)) {
                    if (stdgo.Go.toInterface(_err_9) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 6051248i32;
                    } else {
                        _gotoNext = 6051395i32;
                    };
                } else if (__value__ == (6051248i32)) {
