        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5300703i32;
                } else if (__value__ == (5300703i32)) {
                    var __blank__ = 0i32;
                    inputBreak = false;
                    _gotoNext = 5300814i32;
                } else if (__value__ == (5300814i32)) {
                    if (!inputBreak && ((_scanp_8 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5300829i32;
                    } else {
                        _gotoNext = 5301924i32;
                    };
                } else if (__value__ == (5300829i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5300875i32;
                } else if (__value__ == (5300875i32)) {
                    if ((_scanp_8 < ((@:checkr _dec ?? throw "null pointer dereference")._buf.length) : Bool)) {
                        _gotoNext = 5300911i32;
                    } else {
                        _gotoNext = 5301631i32;
                    };
                } else if (__value__ == (5300903i32)) {
                    _scanp_8++;
                    _gotoNext = 5300875i32;
                } else if (__value__ == (5300911i32)) {
                    ...
                    _gotoNext = 5300959i32;
                } else if (__value__ == (5300959i32)) {
                    {
                        ...
                        if (__value__ == ((10 : stdgo.GoInt))) {
                            _gotoNext = 5300999i32;
                        } else if (__value__ == ((5 : stdgo.GoInt)) || __value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 5301212i32;
                        } else if (__value__ == ((11 : stdgo.GoInt))) {
                            _gotoNext = 5301466i32;
                        } else {
                            _gotoNext = 5300903i32;
                        };
                    };
                } else if (__value__ == (5300999i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes--;
                    inputBreak = true;
                    _gotoNext = 5300814i32;
                } else if (__value__ == (5301212i32)) {
                    if (stdgo._internal.encoding.json.Json__stateendvalue._stateEndValue((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 5301425i32;
                    } else {
                        _gotoNext = 5300903i32;
                    };
                } else if (__value__ == (5301425i32)) {
                    _scanp_8++;
                    inputBreak = true;
                    _gotoNext = 5300814i32;
                } else if (__value__ == (5301466i32)) {
                    ...
                    _gotoNext = 5300903i32;
                } else if (__value__ == (5301631i32)) {
                    if (_err_9 != null) {
                        _gotoNext = 5301645i32;
                    } else {
                        _gotoNext = 5301852i32;
                    };
                } else if (__value__ == (5301645i32)) {
                    if (stdgo.Go.toInterface(_err_9) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 5301667i32;
                    } else {
                        _gotoNext = 5301814i32;
                    };
                } else if (__value__ == (5301667i32)) {
