        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5502359i32;
                } else if (__value__ == (5502359i32)) {
                    var __blank__ = 0i32;
                    inputBreak = false;
                    _gotoNext = 5502470i32;
                } else if (__value__ == (5502470i32)) {
                    if (!inputBreak && ((_scanp_8 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5502485i32;
                    } else {
                        _gotoNext = 5503580i32;
                    };
                } else if (__value__ == (5502485i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5502531i32;
                } else if (__value__ == (5502531i32)) {
                    if ((_scanp_8 < ((@:checkr _dec ?? throw "null pointer dereference")._buf.length) : Bool)) {
                        _gotoNext = 5502567i32;
                    } else {
                        _gotoNext = 5503287i32;
                    };
                } else if (__value__ == (5502559i32)) {
                    _scanp_8++;
                    _gotoNext = 5502531i32;
                } else if (__value__ == (5502567i32)) {
                    ...
                    _gotoNext = 5502615i32;
                } else if (__value__ == (5502615i32)) {
                    {
                    ...
                    if (stdgo._internal.encoding.json.Json__stateendvalue._stateEndValue((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 5503081i32;
                    } else {
                        _gotoNext = 5502559i32;
                    };
                } else if (__value__ == (5503081i32)) {
                    _scanp_8++;
                    inputBreak = true;
                    _gotoNext = 5502470i32;
                    ...
                    _gotoNext = 5502559i32;
                } else if (__value__ == (5503287i32)) {
                    if (_err_9 != null) {
                        _gotoNext = 5503301i32;
                    } else {
                        _gotoNext = 5503508i32;
                    };
                } else if (__value__ == (5503301i32)) {
                    if (stdgo.Go.toInterface(_err_9) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 5503323i32;
                    } else {
                        _gotoNext = 5503470i32;
                    };
                } else if (__value__ == (5503323i32)) {
