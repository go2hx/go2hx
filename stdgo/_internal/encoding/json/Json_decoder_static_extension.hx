        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5466464i32;
                } else if (__value__ == (5466464i32)) {
                    var __blank__ = 0i32;
                    inputBreak = false;
                    _gotoNext = 5466575i32;
                } else if (__value__ == (5466575i32)) {
                    if (!inputBreak && ((_scanp_8 >= (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5466590i32;
                    } else {
                        _gotoNext = 5467685i32;
                    };
                } else if (__value__ == (5466590i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5466636i32;
                } else if (__value__ == (5466636i32)) {
                    if ((_scanp_8 < ((@:checkr _dec ?? throw "null pointer dereference")._buf.length) : Bool)) {
                        _gotoNext = 5466672i32;
                    } else {
                        _gotoNext = 5467392i32;
                    };
                } else if (__value__ == (5466664i32)) {
                    _scanp_8++;
                    _gotoNext = 5466636i32;
                } else if (__value__ == (5466672i32)) {
                    ...
                    _gotoNext = 5466720i32;
                } else if (__value__ == (5466720i32)) {
                    {
                        ...
                        if (__value__ == ((10 : stdgo.GoInt))) {
                            _gotoNext = 5466760i32;
                        } else if (__value__ == ((5 : stdgo.GoInt)) || __value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 5466973i32;
                        } else if (__value__ == ((11 : stdgo.GoInt))) {
                            _gotoNext = 5467227i32;
                        } else {
                            _gotoNext = 5466664i32;
                        };
                    };
                } else if (__value__ == (5466760i32)) {
                    (@:checkr _dec ?? throw "null pointer dereference")._scan._bytes--;
                    inputBreak = true;
                    _gotoNext = 5466575i32;
                } else if (__value__ == (5466973i32)) {
                    if (stdgo._internal.encoding.json.Json__stateendvalue._stateEndValue((stdgo.Go.setRef((@:checkr _dec ?? throw "null pointer dereference")._scan) : stdgo.Ref<stdgo._internal.encoding.json.Json_t_scanner.T_scanner>), (32 : stdgo.GoUInt8)) == ((10 : stdgo.GoInt))) {
                        _gotoNext = 5467186i32;
                    } else {
                        _gotoNext = 5466664i32;
                    };
                } else if (__value__ == (5467186i32)) {
                    _scanp_8++;
                    inputBreak = true;
                    _gotoNext = 5466575i32;
                } else if (__value__ == (5467227i32)) {
                    ...
                    _gotoNext = 5466664i32;
                } else if (__value__ == (5467392i32)) {
                    if (_err_9 != null) {
                        _gotoNext = 5467406i32;
                    } else {
                        _gotoNext = 5467613i32;
                    };
                } else if (__value__ == (5467406i32)) {
                    if (stdgo.Go.toInterface(_err_9) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                        _gotoNext = 5467428i32;
                    } else {
                        _gotoNext = 5467575i32;
                    };
                } else if (__value__ == (5467428i32)) {
