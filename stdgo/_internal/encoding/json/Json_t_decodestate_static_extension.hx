        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5373925i32;
                } else if (__value__ == (5373925i32)) {
                    switchBreak = false;
                    _gotoNext = 5373934i32;
                } else if (__value__ == (5373934i32)) {
                    if (!switchBreak) {
                        {
                            final __value__ = _data_0[(_i_1 - (1 : stdgo.GoInt) : stdgo.GoInt)];
                            if (__value__ == ((34 : stdgo.GoUInt8))) {
                                _gotoNext = 5373954i32;
                                ...
                                _gotoNext = 5374143i32;
                            } else if (__value__ == ((116 : stdgo.GoUInt8))) {
                                _gotoNext = 5374388i32;
                            } else if (__value__ == ((102 : stdgo.GoUInt8))) {
                                _gotoNext = 5374425i32;
                            } else if (__value__ == ((110 : stdgo.GoUInt8))) {
                                _gotoNext = 5374464i32;
                            } else {
                                _gotoNext = 5374504i32;
                            };
                        };
                    } else {
                        _gotoNext = 5374504i32;
                    };
                } else if (__value__ == (5373954i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5373976i32;
                } else if (__value__ == (5373976i32)) {
                    if ((_i_1 < (_data_0.length) : Bool)) {
                        _gotoNext = 5374001i32;
                    } else {
                        _gotoNext = 5374504i32;
                    };
                } else if (__value__ == (5373997i32)) {
                    _i_1++;
                    _gotoNext = 5373976i32;
                } else if (__value__ == (5374001i32)) {
                    _gotoNext = 5374006i32;
                } else if (__value__ == (5374006i32)) {
                    {
                        final __value__ = _data_0[(_i_1 : stdgo.GoInt)];
                        if (__value__ == ((92 : stdgo.GoUInt8))) {
                            _gotoNext = 5374026i32;
                        } else if (__value__ == ((34 : stdgo.GoUInt8))) {
                            _gotoNext = 5374064i32;
                        } else {
                            _gotoNext = 5373997i32;
                        };
                    };
                } else if (__value__ == (5374026i32)) {
                    _i_1++;
                    _gotoNext = 5373997i32;
                } else if (__value__ == (5374064i32)) {
                    _i_1++;
                    switchBreak = true;
                    _gotoNext = 5373934i32;
                } else if (__value__ == (5374143i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 5374215i32;
                } else if (__value__ == (5374215i32)) {
                    if ((_i_1 < (_data_0.length) : Bool)) {
                        _gotoNext = 5374240i32;
                    } else {
                        _gotoNext = 5374504i32;
                    };
                } else if (__value__ == (5374236i32)) {
                    _i_1++;
                    _gotoNext = 5374215i32;
                } else if (__value__ == (5374240i32)) {
                    _gotoNext = 5374245i32;
                } else if (__value__ == (5374245i32)) {
                    {
                        final __value__ = _data_0[(_i_1 : stdgo.GoInt)];
                        if (__value__ == ((48 : stdgo.GoUInt8)) || __value__ == ((49 : stdgo.GoUInt8)) || __value__ == ((50 : stdgo.GoUInt8)) || __value__ == ((51 : stdgo.GoUInt8)) || __value__ == ((52 : stdgo.GoUInt8)) || __value__ == ((53 : stdgo.GoUInt8)) || __value__ == ((54 : stdgo.GoUInt8)) || __value__ == ((55 : stdgo.GoUInt8)) || __value__ == ((56 : stdgo.GoUInt8)) || __value__ == ((57 : stdgo.GoUInt8)) || __value__ == ((46 : stdgo.GoUInt8)) || __value__ == ((101 : stdgo.GoUInt8)) || __value__ == ((69 : stdgo.GoUInt8)) || __value__ == ((43 : stdgo.GoUInt8)) || __value__ == ((45 : stdgo.GoUInt8))) {
                            _gotoNext = 5374265i32;
                        } else {
                            _gotoNext = 5374352i32;
                        };
                    };
                } else if (__value__ == (5374265i32)) {
                    _gotoNext = 5374236i32;
                } else if (__value__ == (5374352i32)) {
                    switchBreak = true;
                    _gotoNext = 5373934i32;
                } else if (__value__ == (5374388i32)) {
                    _i_1 = (_i_1 + (((("rue" : stdgo.GoString) : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5374504i32;
                } else if (__value__ == (5374425i32)) {
                    _i_1 = (_i_1 + (((("alse" : stdgo.GoString) : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5374504i32;
                } else if (__value__ == (5374464i32)) {
                    _i_1 = (_i_1 + (((("ull" : stdgo.GoString) : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5374504i32;
                } else if (__value__ == (5374504i32)) {
                    if ((_i_1 < (_data_0.length) : Bool)) {
                        _gotoNext = 5374521i32;
                    } else {
                        _gotoNext = 5374576i32;
                    };
                } else if (__value__ == (5374521i32)) {
                    ...
                    _gotoNext = 5374603i32;
                } else if (__value__ == (5374576i32)) {
                    _gotoNext = 5374576i32;
                    (@:checkr _d ?? throw "null pointer dereference")._opcode = (10 : stdgo.GoInt);
                    var __blank__ = 0i32;
                    _gotoNext = 5374603i32;
                } else if (__value__ == (5374603i32)) {
