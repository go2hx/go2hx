        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5127870i32;
                } else if (__value__ == (5127870i32)) {
                    switchBreak = false;
                    _gotoNext = 5127879i32;
                } else if (__value__ == (5127879i32)) {
                    if (!switchBreak) {
                        {
                    ...
                    0i32;
                    _gotoNext = 5127921i32;
                } else if (__value__ == (5127921i32)) {
                    if ((_i_1 < (_data_0.length) : Bool)) {
                        _gotoNext = 5127946i32;
                    } else {
                        _gotoNext = 5128449i32;
                    };
                } else if (__value__ == (5127942i32)) {
                    _i_1++;
                    _gotoNext = 5127921i32;
                } else if (__value__ == (5127946i32)) {
                    _gotoNext = 5127951i32;
                } else if (__value__ == (5127951i32)) {
                    {
                        final __value__ = _data_0[(_i_1 : stdgo.GoInt)];
                        if (__value__ == ((92 : stdgo.GoUInt8))) {
                            _gotoNext = 5127971i32;
                        } else if (__value__ == ((34 : stdgo.GoUInt8))) {
                            _gotoNext = 5128009i32;
                        } else {
                            _gotoNext = 5127942i32;
                        };
                    };
                } else if (__value__ == (5127971i32)) {
                    _i_1++;
                    _gotoNext = 5127942i32;
                } else if (__value__ == (5128009i32)) {
                    _i_1++;
                    switchBreak = true;
                    _gotoNext = 5127879i32;
                } else if (__value__ == (5128088i32)) {
                    0i32;
                    _gotoNext = 5128160i32;
                } else if (__value__ == (5128160i32)) {
                    if ((_i_1 < (_data_0.length) : Bool)) {
                        _gotoNext = 5128185i32;
                    } else {
                        _gotoNext = 5128449i32;
                    };
                } else if (__value__ == (5128181i32)) {
                    _i_1++;
                    _gotoNext = 5128160i32;
                } else if (__value__ == (5128185i32)) {
                    _gotoNext = 5128190i32;
                } else if (__value__ == (5128190i32)) {
                    {
                        final __value__ = _data_0[(_i_1 : stdgo.GoInt)];
                        if (__value__ == ((48 : stdgo.GoUInt8)) || __value__ == ((49 : stdgo.GoUInt8)) || __value__ == ((50 : stdgo.GoUInt8)) || __value__ == ((51 : stdgo.GoUInt8)) || __value__ == ((52 : stdgo.GoUInt8)) || __value__ == ((53 : stdgo.GoUInt8)) || __value__ == ((54 : stdgo.GoUInt8)) || __value__ == ((55 : stdgo.GoUInt8)) || __value__ == ((56 : stdgo.GoUInt8)) || __value__ == ((57 : stdgo.GoUInt8)) || __value__ == ((46 : stdgo.GoUInt8)) || __value__ == ((101 : stdgo.GoUInt8)) || __value__ == ((69 : stdgo.GoUInt8)) || __value__ == ((43 : stdgo.GoUInt8)) || __value__ == ((45 : stdgo.GoUInt8))) {
                            _gotoNext = 5128210i32;
                        } else {
                            _gotoNext = 5128297i32;
                        };
                    };
                } else if (__value__ == (5128210i32)) {
                    _gotoNext = 5128181i32;
                } else if (__value__ == (5128297i32)) {
                    switchBreak = true;
                    _gotoNext = 5127879i32;
                } else if (__value__ == (5128333i32)) {
                    _i_1 = (_i_1 + (((("rue" : stdgo.GoString) : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5128449i32;
                } else if (__value__ == (5128370i32)) {
                    _i_1 = (_i_1 + (((("alse" : stdgo.GoString) : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5128449i32;
                } else if (__value__ == (5128409i32)) {
                    _i_1 = (_i_1 + (((("ull" : stdgo.GoString) : stdgo.GoString).length)) : stdgo.GoInt);
                    _gotoNext = 5128449i32;
                } else if (__value__ == (5128449i32)) {
                    if ((_i_1 < (_data_0.length) : Bool)) {
                        _gotoNext = 5128466i32;
                    } else {
                        _gotoNext = 5128521i32;
                    };
                } else if (__value__ == (5128466i32)) {
                    ...
                    _gotoNext = 5128548i32;
                } else if (__value__ == (5128521i32)) {
                    _gotoNext = 5128521i32;
                    (@:checkr _d ?? throw "null pointer dereference")._opcode = (10 : stdgo.GoInt);
                    0i32;
                    _gotoNext = 5128548i32;
                } else if (__value__ == (5128548i32)) {
