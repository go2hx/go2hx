...
@:keep @:allow(stdgo._internal.encoding.json.Json.T_structEncoder_asInterface) class T_structEncoder_static_extension {
    ...
    static public function _encode( _se:stdgo._internal.encoding.json.Json_t_structencoder.T_structEncoder, _e:stdgo.Ref<stdgo._internal.encoding.json.Json_t_encodestate.T_encodeState>, _v:stdgo._internal.reflect.Reflect_value.Value, _opts:stdgo._internal.encoding.json.Json_t_encopts.T_encOpts):Void {
        ...
        var _i_5476802_6:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5476651i32;
                } else if (__value__ == (5476651i32)) {
                    if ((0i32 : stdgo.GoInt) < (_se._fields._list.length)) {
                        _gotoNext = 5477193i32;
                    } else {
                        _gotoNext = 5477197i32;
                    };
                } else if (__value__ == (5476693i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5476950i32;
                    } else {
                        _gotoNext = 5476956i32;
                    };
                } else if (__value__ == (5476816i32)) {
                    _i_7 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(_i_5476802_6 : stdgo.GoInt)];
                    if (_fv_5.kind() == ((22u32 : stdgo._internal.reflect.Reflect_kind.Kind))) {
                        _gotoNext = 5476853i32;
                    } else {
                        _gotoNext = 5476932i32;
                    };
                } else if (__value__ == (5476853i32)) {
                    if (_fv_5.isNil()) {
                        _gotoNext = 5476873i32;
                    } else {
                        _gotoNext = 5476909i32;
                    };
                } else if (__value__ == (5476873i32)) {
                    _i_3++;
                    _gotoNext = 5477194i32;
                } else if (__value__ == (5476909i32)) {
                    _fv_5 = _fv_5.elem()?.__copy__();
                    _gotoNext = 5476932i32;
                } else if (__value__ == (5476932i32)) {
                    _fv_5 = _fv_5.field(_i_7)?.__copy__();
                    _i_5476802_6++;
                    _gotoNext = 5476951i32;
                } else if (__value__ == (5476950i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(0i32 : stdgo.GoInt)];
                        _i_5476802_6 = @:binopAssign __tmp__0;
                        _i_7 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5476951i32;
                } else if (__value__ == (5476951i32)) {
                    if (_i_5476802_6 < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5476816i32;
                    } else {
                        _gotoNext = 5476956i32;
                    };
                } else if (__value__ == (5476956i32)) {
                    if (((@:checkr _f_4 ?? throw "null pointer dereference")._omitEmpty && stdgo._internal.encoding.json.Json__isemptyvalue._isEmptyValue(_fv_5?.__copy__()) : Bool)) {
                        _gotoNext = 5476991i32;
                    } else {
                        _gotoNext = 5477011i32;
                    };
                } else if (__value__ == (5476991i32)) {
                    _i_3++;
                    _gotoNext = 5477194i32;
                } else if (__value__ == (5477011i32)) {
                    @:check2r _e.writeByte(_next_2);
                    _next_2 = (44 : stdgo.GoUInt8);
                    if (_opts._escapeHTML) {
                        _gotoNext = 5477063i32;
                    } else {
                        _gotoNext = 5477106i32;
                    };
                } else if (__value__ == (5477063i32)) {
                    ...
                    _i_3++;
                    _gotoNext = 5477194i32;
                } else if (__value__ == (5477193i32)) {
                    _i_3 = 0i32;
                    _gotoNext = 5477194i32;
                } else if (__value__ == (5477194i32)) {
                    if (_i_3 < (_se._fields._list.length)) {
                        _gotoNext = 5476693i32;
                    } else {
                        _gotoNext = 5477197i32;
                    };
                } else if (__value__ == (5477197i32)) {
                    if (_next_2 == ((123 : stdgo.GoUInt8))) {
                        _gotoNext = 5477212i32;
                    } else {
                        _gotoNext = 5477244i32;
                    };
                } else if (__value__ == (5477212i32)) {
                    @:check2r _e.writeString(("{}" : stdgo.GoString));
                    _gotoNext = 5477268i32;
                } else if (__value__ == (5477244i32)) {
                    _gotoNext = 5477244i32;
                    @:check2r _e.writeByte((125 : stdgo.GoUInt8));
                    var __blank__ = 0i32;
                    _gotoNext = 5477268i32;
                } else if (__value__ == (5477268i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
