...
@:keep @:allow(stdgo._internal.encoding.json.Json.T_structEncoder_asInterface) class T_structEncoder_static_extension {
    ...
    static public function _encode( _se:stdgo._internal.encoding.json.Json_t_structencoder.T_structEncoder, _e:stdgo.Ref<stdgo._internal.encoding.json.Json_t_encodestate.T_encodeState>, _v:stdgo._internal.reflect.Reflect_value.Value, _opts:stdgo._internal.encoding.json.Json_t_encopts.T_encOpts):Void {
        ...
        var _i_5122696_6:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5122545i32;
                } else if (__value__ == (5122545i32)) {
                    if ((0i32 : stdgo.GoInt) < (_se._fields._list.length)) {
                        _gotoNext = 5123087i32;
                    } else {
                        _gotoNext = 5123091i32;
                    };
                } else if (__value__ == (5122587i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5122844i32;
                    } else {
                        _gotoNext = 5122850i32;
                    };
                } else if (__value__ == (5122710i32)) {
                    _i_7 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(_i_5122696_6 : stdgo.GoInt)];
                    if (_fv_5.kind() == ((22u32 : stdgo._internal.reflect.Reflect_kind.Kind))) {
                        _gotoNext = 5122747i32;
                    } else {
                        _gotoNext = 5122826i32;
                    };
                } else if (__value__ == (5122747i32)) {
                    if (_fv_5.isNil()) {
                        _gotoNext = 5122767i32;
                    } else {
                        _gotoNext = 5122803i32;
                    };
                } else if (__value__ == (5122767i32)) {
                    _i_3++;
                    _gotoNext = 5123088i32;
                } else if (__value__ == (5122803i32)) {
                    _fv_5 = _fv_5.elem()?.__copy__();
                    _gotoNext = 5122826i32;
                } else if (__value__ == (5122826i32)) {
                    _fv_5 = _fv_5.field(_i_7)?.__copy__();
                    _i_5122696_6++;
                    _gotoNext = 5122845i32;
                } else if (__value__ == (5122844i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(0i32 : stdgo.GoInt)];
                        _i_5122696_6 = @:binopAssign __tmp__0;
                        _i_7 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5122845i32;
                } else if (__value__ == (5122845i32)) {
                    if (_i_5122696_6 < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5122710i32;
                    } else {
                        _gotoNext = 5122850i32;
                    };
                } else if (__value__ == (5122850i32)) {
                    ...
                    _i_3 = 0i32;
                    _gotoNext = 5123088i32;
                } else if (__value__ == (5123088i32)) {
                    if (_i_3 < (_se._fields._list.length)) {
                        _gotoNext = 5122587i32;
                    } else {
                        _gotoNext = 5123091i32;
                    };
                } else if (__value__ == (5123091i32)) {
                    if (_next_2 == ((123 : stdgo.GoUInt8))) {
                        _gotoNext = 5123106i32;
                    } else {
                        _gotoNext = 5123138i32;
                    };
                } else if (__value__ == (5123106i32)) {
                    @:check2r _e.writeString(("{}" : stdgo.GoString));
                    _gotoNext = 5123162i32;
                } else if (__value__ == (5123138i32)) {
                    _gotoNext = 5123138i32;
                    @:check2r _e.writeByte((125 : stdgo.GoUInt8));
                    var __blank__ = 0i32;
                    _gotoNext = 5123162i32;
                } else if (__value__ == (5123162i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
