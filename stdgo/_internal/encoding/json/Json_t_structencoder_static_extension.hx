...
@:keep @:allow(stdgo._internal.encoding.json.Json.T_structEncoder_asInterface) class T_structEncoder_static_extension {
    ...
    static public function _encode( _se:stdgo._internal.encoding.json.Json_t_structencoder.T_structEncoder, _e:stdgo.Ref<stdgo._internal.encoding.json.Json_t_encodestate.T_encodeState>, _v:stdgo._internal.reflect.Reflect_value.Value, _opts:stdgo._internal.encoding.json.Json_t_encopts.T_encOpts):Void {
        ...
        var _iterator_5224508_6:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5224357i32;
                } else if (__value__ == (5224357i32)) {
                    if ((0i32 : stdgo.GoInt) < (_se._fields._list.length)) {
                        _gotoNext = 5224899i32;
                    } else {
                        _gotoNext = 5224903i32;
                    };
                } else if (__value__ == (5224399i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5224656i32;
                    } else {
                        _gotoNext = 5224662i32;
                    };
                } else if (__value__ == (5224522i32)) {
                    _i_7 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(_iterator_5224508_6 : stdgo.GoInt)];
                    if (_fv_5.kind() == ((22u32 : stdgo._internal.reflect.Reflect_kind.Kind))) {
                        _gotoNext = 5224559i32;
                    } else {
                        _gotoNext = 5224638i32;
                    };
                } else if (__value__ == (5224559i32)) {
                    if (_fv_5.isNil()) {
                        _gotoNext = 5224579i32;
                    } else {
                        _gotoNext = 5224615i32;
                    };
                } else if (__value__ == (5224579i32)) {
                    _i_3++;
                    _gotoNext = 5224900i32;
                } else if (__value__ == (5224615i32)) {
                    _fv_5 = _fv_5.elem()?.__copy__();
                    _gotoNext = 5224638i32;
                } else if (__value__ == (5224638i32)) {
                    _fv_5 = _fv_5.field(_i_7)?.__copy__();
                    _iterator_5224508_6++;
                    _gotoNext = 5224657i32;
                } else if (__value__ == (5224656i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(0i32 : stdgo.GoInt)];
                        _iterator_5224508_6 = @:binopAssign __tmp__0;
                        _i_7 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5224657i32;
                } else if (__value__ == (5224657i32)) {
                    if (_iterator_5224508_6 < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5224522i32;
                    } else {
                        _gotoNext = 5224662i32;
                    };
                } else if (__value__ == (5224662i32)) {
                    if (((@:checkr _f_4 ?? throw "null pointer dereference")._omitEmpty && stdgo._internal.encoding.json.Json__isemptyvalue._isEmptyValue(_fv_5?.__copy__()) : Bool)) {
                        _gotoNext = 5224697i32;
                    } else {
                        _gotoNext = 5224717i32;
                    };
                } else if (__value__ == (5224697i32)) {
                    _i_3++;
                    _gotoNext = 5224900i32;
                } else if (__value__ == (5224717i32)) {
                    @:check2r _e.writeByte(_next_2);
                    _next_2 = (44 : stdgo.GoUInt8);
                    if (_opts._escapeHTML) {
                        _gotoNext = 5224769i32;
                    } else {
                        _gotoNext = 5224812i32;
                    };
                } else if (__value__ == (5224769i32)) {
                    @:check2r _e.writeString((@:checkr _f_4 ?? throw "null pointer dereference")._nameEscHTML?.__copy__());
                    _gotoNext = 5224851i32;
                } else if (__value__ == (5224812i32)) {
                    _gotoNext = 5224812i32;
                    @:check2r _e.writeString((@:checkr _f_4 ?? throw "null pointer dereference")._nameNonEsc?.__copy__());
                    0i32;
                    _gotoNext = 5224851i32;
                } else if (__value__ == (5224851i32)) {
                    ...
                    _i_3++;
                    _gotoNext = 5224900i32;
                } else if (__value__ == (5224899i32)) {
                    _i_3 = 0i32;
                    _gotoNext = 5224900i32;
                } else if (__value__ == (5224900i32)) {
                    if (_i_3 < (_se._fields._list.length)) {
                        _gotoNext = 5224399i32;
                    } else {
                        _gotoNext = 5224903i32;
                    };
                } else if (__value__ == (5224903i32)) {
                    if (_next_2 == ((123 : stdgo.GoUInt8))) {
                        _gotoNext = 5224918i32;
                    } else {
                        _gotoNext = 5224950i32;
                    };
                } else if (__value__ == (5224918i32)) {
                    @:check2r _e.writeString(("{}" : stdgo.GoString));
                    _gotoNext = 5224974i32;
                } else if (__value__ == (5224950i32)) {
                    _gotoNext = 5224950i32;
                    @:check2r _e.writeByte((125 : stdgo.GoUInt8));
                    0i32;
                    _gotoNext = 5224974i32;
                } else if (__value__ == (5224974i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
