...
@:keep @:allow(stdgo._internal.encoding.json.Json.T_structEncoder_asInterface) class T_structEncoder_static_extension {
    ...
    static public function _encode( _se:stdgo._internal.encoding.json.Json_t_structencoder.T_structEncoder, _e:stdgo.Ref<stdgo._internal.encoding.json.Json_t_encodestate.T_encodeState>, _v:stdgo._internal.reflect.Reflect_value.Value, _opts:stdgo._internal.encoding.json.Json_t_encopts.T_encOpts):Void {
        ...
        var _iterator_5286596_6:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5286445i32;
                } else if (__value__ == (5286445i32)) {
                    if ((0i32 : stdgo.GoInt) < (_se._fields._list.length)) {
                        _gotoNext = 5286987i32;
                    } else {
                        _gotoNext = 5286991i32;
                    };
                } else if (__value__ == (5286487i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5286744i32;
                    } else {
                        _gotoNext = 5286750i32;
                    };
                } else if (__value__ == (5286610i32)) {
                    _i_7 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(_iterator_5286596_6 : stdgo.GoInt)];
                    if (_fv_5.kind() == ((22u32 : stdgo._internal.reflect.Reflect_kind.Kind))) {
                        _gotoNext = 5286647i32;
                    } else {
                        _gotoNext = 5286726i32;
                    };
                } else if (__value__ == (5286647i32)) {
                    if (_fv_5.isNil()) {
                        _gotoNext = 5286667i32;
                    } else {
                        _gotoNext = 5286703i32;
                    };
                } else if (__value__ == (5286667i32)) {
                    _i_3++;
                    _gotoNext = 5286988i32;
                } else if (__value__ == (5286703i32)) {
                    _fv_5 = _fv_5.elem()?.__copy__();
                    _gotoNext = 5286726i32;
                } else if (__value__ == (5286726i32)) {
                    _fv_5 = _fv_5.field(_i_7)?.__copy__();
                    _iterator_5286596_6++;
                    _gotoNext = 5286745i32;
                } else if (__value__ == (5286744i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(0i32 : stdgo.GoInt)];
                        _iterator_5286596_6 = @:binopAssign __tmp__0;
                        _i_7 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5286745i32;
                } else if (__value__ == (5286745i32)) {
                    if (_iterator_5286596_6 < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5286610i32;
                    } else {
                        _gotoNext = 5286750i32;
                    };
                } else if (__value__ == (5286750i32)) {
                    if (((@:checkr _f_4 ?? throw "null pointer dereference")._omitEmpty && stdgo._internal.encoding.json.Json__isemptyvalue._isEmptyValue(_fv_5?.__copy__()) : Bool)) {
                        _gotoNext = 5286785i32;
                    } else {
                        _gotoNext = 5286805i32;
                    };
                } else if (__value__ == (5286785i32)) {
                    _i_3++;
                    _gotoNext = 5286988i32;
                } else if (__value__ == (5286805i32)) {
                    @:check2r _e.writeByte(_next_2);
                    _next_2 = (44 : stdgo.GoUInt8);
                    if (_opts._escapeHTML) {
                        _gotoNext = 5286857i32;
                    } else {
                        _gotoNext = 5286900i32;
                    };
                } else if (__value__ == (5286857i32)) {
                    @:check2r _e.writeString((@:checkr _f_4 ?? throw "null pointer dereference")._nameEscHTML?.__copy__());
                    _gotoNext = 5286939i32;
                } else if (__value__ == (5286900i32)) {
                    _gotoNext = 5286900i32;
                    @:check2r _e.writeString((@:checkr _f_4 ?? throw "null pointer dereference")._nameNonEsc?.__copy__());
                    0i32;
                    _gotoNext = 5286939i32;
                } else if (__value__ == (5286939i32)) {
                    ...
                    _i_3++;
                    _gotoNext = 5286988i32;
                } else if (__value__ == (5286987i32)) {
                    _i_3 = 0i32;
                    _gotoNext = 5286988i32;
                } else if (__value__ == (5286988i32)) {
                    if (_i_3 < (_se._fields._list.length)) {
                        _gotoNext = 5286487i32;
                    } else {
                        _gotoNext = 5286991i32;
                    };
                } else if (__value__ == (5286991i32)) {
                    if (_next_2 == ((123 : stdgo.GoUInt8))) {
                        _gotoNext = 5287006i32;
                    } else {
                        _gotoNext = 5287038i32;
                    };
                } else if (__value__ == (5287006i32)) {
                    @:check2r _e.writeString(("{}" : stdgo.GoString));
                    _gotoNext = 5287062i32;
                } else if (__value__ == (5287038i32)) {
                    _gotoNext = 5287038i32;
                    @:check2r _e.writeByte((125 : stdgo.GoUInt8));
                    0i32;
                    _gotoNext = 5287062i32;
                } else if (__value__ == (5287062i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
