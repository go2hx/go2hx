...
@:keep @:allow(stdgo._internal.encoding.json.Json.T_structEncoder_asInterface) class T_structEncoder_static_extension {
    ...
    static public function _encode( _se:stdgo._internal.encoding.json.Json_t_structencoder.T_structEncoder, _e:stdgo.Ref<stdgo._internal.encoding.json.Json_t_encodestate.T_encodeState>, _v:stdgo._internal.reflect.Reflect_value.Value, _opts:stdgo._internal.encoding.json.Json_t_encopts.T_encOpts):Void {
        ...
        var _i_5423444_6:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5423293i32;
                } else if (__value__ == (5423293i32)) {
                    if ((0i32 : stdgo.GoInt) < (_se._fields._list.length)) {
                        _gotoNext = 5423835i32;
                    } else {
                        _gotoNext = 5423839i32;
                    };
                } else if (__value__ == (5423335i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5423592i32;
                    } else {
                        _gotoNext = 5423598i32;
                    };
                } else if (__value__ == (5423458i32)) {
                    _i_7 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(_i_5423444_6 : stdgo.GoInt)];
                    if (_fv_5.kind() == ((22u32 : stdgo._internal.reflect.Reflect_kind.Kind))) {
                        _gotoNext = 5423495i32;
                    } else {
                        _gotoNext = 5423574i32;
                    };
                } else if (__value__ == (5423495i32)) {
                    if (_fv_5.isNil()) {
                        _gotoNext = 5423515i32;
                    } else {
                        _gotoNext = 5423551i32;
                    };
                } else if (__value__ == (5423515i32)) {
                    _i_3++;
                    _gotoNext = 5423836i32;
                } else if (__value__ == (5423551i32)) {
                    _fv_5 = _fv_5.elem()?.__copy__();
                    _gotoNext = 5423574i32;
                } else if (__value__ == (5423574i32)) {
                    _fv_5 = _fv_5.field(_i_7)?.__copy__();
                    _i_5423444_6++;
                    _gotoNext = 5423593i32;
                } else if (__value__ == (5423592i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(0i32 : stdgo.GoInt)];
                        _i_5423444_6 = __tmp__0;
                        _i_7 = __tmp__1;
                    };
                    _gotoNext = 5423593i32;
                } else if (__value__ == (5423593i32)) {
                    if (_i_5423444_6 < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5423458i32;
                    } else {
                        _gotoNext = 5423598i32;
                    };
                } else if (__value__ == (5423598i32)) {
                    if (((@:checkr _f_4 ?? throw "null pointer dereference")._omitEmpty && stdgo._internal.encoding.json.Json__isemptyvalue._isEmptyValue(_fv_5?.__copy__()) : Bool)) {
                        _gotoNext = 5423633i32;
                    } else {
                        _gotoNext = 5423653i32;
                    };
                } else if (__value__ == (5423633i32)) {
                    _i_3++;
                    _gotoNext = 5423836i32;
                } else if (__value__ == (5423653i32)) {
                    @:check2r _e.writeByte(_next_2);
                    _next_2 = (44 : stdgo.GoUInt8);
                    if (_opts._escapeHTML) {
                        _gotoNext = 5423705i32;
                    } else {
                        _gotoNext = 5423748i32;
                    };
                } else if (__value__ == (5423705i32)) {
                    @:check2r _e.writeString((@:checkr _f_4 ?? throw "null pointer dereference")._nameEscHTML?.__copy__());
                    _gotoNext = 5423787i32;
                } else if (__value__ == (5423748i32)) {
                    _gotoNext = 5423748i32;
                    @:check2r _e.writeString((@:checkr _f_4 ?? throw "null pointer dereference")._nameNonEsc?.__copy__());
                    var __blank__ = 0i32;
                    _gotoNext = 5423787i32;
                } else if (__value__ == (5423787i32)) {
                    ...
                    _i_3++;
                    _gotoNext = 5423836i32;
                } else if (__value__ == (5423835i32)) {
                    _i_3 = 0i32;
                    _gotoNext = 5423836i32;
                } else if (__value__ == (5423836i32)) {
                    if (_i_3 < (_se._fields._list.length)) {
                        _gotoNext = 5423335i32;
                    } else {
                        _gotoNext = 5423839i32;
                    };
                } else if (__value__ == (5423839i32)) {
                    if (_next_2 == ((123 : stdgo.GoUInt8))) {
                        _gotoNext = 5423854i32;
                    } else {
                        _gotoNext = 5423886i32;
                    };
                } else if (__value__ == (5423854i32)) {
                    @:check2r _e.writeString(("{}" : stdgo.GoString));
                    _gotoNext = 5423910i32;
                } else if (__value__ == (5423886i32)) {
                    _gotoNext = 5423886i32;
                    @:check2r _e.writeByte((125 : stdgo.GoUInt8));
                    var __blank__ = 0i32;
                    _gotoNext = 5423910i32;
                } else if (__value__ == (5423910i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
