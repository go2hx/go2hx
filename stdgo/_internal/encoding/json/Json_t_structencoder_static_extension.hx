...
@:keep @:allow(stdgo._internal.encoding.json.Json.T_structEncoder_asInterface) class T_structEncoder_static_extension {
    ...
    static public function _encode( _se:stdgo._internal.encoding.json.Json_t_structencoder.T_structEncoder, _e:stdgo.Ref<stdgo._internal.encoding.json.Json_t_encodestate.T_encodeState>, _v:stdgo._internal.reflect.Reflect_value.Value, _opts:stdgo._internal.encoding.json.Json_t_encopts.T_encOpts):Void {
        ...
        var _iterator_5818151_6:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5818000i32;
                } else if (__value__ == (5818000i32)) {
                    if ((0i32 : stdgo.GoInt) < (_se._fields._list.length)) {
                        _gotoNext = 5818542i32;
                    } else {
                        _gotoNext = 5818546i32;
                    };
                } else if (__value__ == (5818042i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5818299i32;
                    } else {
                        _gotoNext = 5818305i32;
                    };
                } else if (__value__ == (5818165i32)) {
                    _i_7 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(_iterator_5818151_6 : stdgo.GoInt)];
                    if (_fv_5.kind() == ((22u32 : stdgo._internal.reflect.Reflect_kind.Kind))) {
                        _gotoNext = 5818202i32;
                    } else {
                        _gotoNext = 5818281i32;
                    };
                } else if (__value__ == (5818202i32)) {
                    if (_fv_5.isNil()) {
                        _gotoNext = 5818222i32;
                    } else {
                        _gotoNext = 5818258i32;
                    };
                } else if (__value__ == (5818222i32)) {
                    _i_3++;
                    _gotoNext = 5818543i32;
                } else if (__value__ == (5818258i32)) {
                    _fv_5 = _fv_5.elem()?.__copy__();
                    _gotoNext = 5818281i32;
                } else if (__value__ == (5818281i32)) {
                    _fv_5 = _fv_5.field(_i_7)?.__copy__();
                    _iterator_5818151_6++;
                    _gotoNext = 5818300i32;
                } else if (__value__ == (5818299i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(0i32 : stdgo.GoInt)];
                        _iterator_5818151_6 = @:binopAssign __tmp__0;
                        _i_7 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5818300i32;
                } else if (__value__ == (5818300i32)) {
                    if (_iterator_5818151_6 < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5818165i32;
                    } else {
                        _gotoNext = 5818305i32;
                    };
                } else if (__value__ == (5818305i32)) {
                    if (((@:checkr _f_4 ?? throw "null pointer dereference")._omitEmpty && stdgo._internal.encoding.json.Json__isemptyvalue._isEmptyValue(_fv_5?.__copy__()) : Bool)) {
                        _gotoNext = 5818340i32;
                    } else {
                        _gotoNext = 5818360i32;
                    };
                } else if (__value__ == (5818340i32)) {
                    _i_3++;
                    _gotoNext = 5818543i32;
                } else if (__value__ == (5818360i32)) {
                    @:check2r _e.writeByte(_next_2);
                    _next_2 = (44 : stdgo.GoUInt8);
                    if (_opts._escapeHTML) {
                        _gotoNext = 5818412i32;
                    } else {
                        _gotoNext = 5818455i32;
                    };
                } else if (__value__ == (5818412i32)) {
                    @:check2r _e.writeString((@:checkr _f_4 ?? throw "null pointer dereference")._nameEscHTML?.__copy__());
                    _gotoNext = 5818494i32;
                } else if (__value__ == (5818455i32)) {
                    _gotoNext = 5818455i32;
                    @:check2r _e.writeString((@:checkr _f_4 ?? throw "null pointer dereference")._nameNonEsc?.__copy__());
                    0i32;
                    _gotoNext = 5818494i32;
                } else if (__value__ == (5818494i32)) {
                    ...
                    _i_3++;
                    _gotoNext = 5818543i32;
                } else if (__value__ == (5818542i32)) {
                    _i_3 = 0i32;
                    _gotoNext = 5818543i32;
                } else if (__value__ == (5818543i32)) {
                    if (_i_3 < (_se._fields._list.length)) {
                        _gotoNext = 5818042i32;
                    } else {
                        _gotoNext = 5818546i32;
                    };
                } else if (__value__ == (5818546i32)) {
                    if (_next_2 == ((123 : stdgo.GoUInt8))) {
                        _gotoNext = 5818561i32;
                    } else {
                        _gotoNext = 5818593i32;
                    };
                } else if (__value__ == (5818561i32)) {
                    @:check2r _e.writeString(("{}" : stdgo.GoString));
                    _gotoNext = 5818617i32;
                } else if (__value__ == (5818593i32)) {
                    _gotoNext = 5818593i32;
                    @:check2r _e.writeByte((125 : stdgo.GoUInt8));
                    0i32;
                    _gotoNext = 5818617i32;
                } else if (__value__ == (5818617i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
