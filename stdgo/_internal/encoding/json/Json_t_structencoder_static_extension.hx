...
@:keep @:allow(stdgo._internal.encoding.json.Json.T_structEncoder_asInterface) class T_structEncoder_static_extension {
    ...
    static public function _encode( _se:stdgo._internal.encoding.json.Json_t_structencoder.T_structEncoder, _e:stdgo.Ref<stdgo._internal.encoding.json.Json_t_encodestate.T_encodeState>, _v:stdgo._internal.reflect.Reflect_value.Value, _opts:stdgo._internal.encoding.json.Json_t_encopts.T_encOpts):Void {
        ...
        var _i_5434337_6:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5434186i32;
                } else if (__value__ == (5434186i32)) {
                    if ((0i32 : stdgo.GoInt) < (_se._fields._list.length)) {
                        _gotoNext = 5434728i32;
                    } else {
                        _gotoNext = 5434732i32;
                    };
                } else if (__value__ == (5434228i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5434485i32;
                    } else {
                        _gotoNext = 5434491i32;
                    };
                } else if (__value__ == (5434351i32)) {
                    _i_7 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(_i_5434337_6 : stdgo.GoInt)];
                    if (_fv_5.kind() == ((22u32 : stdgo._internal.reflect.Reflect_kind.Kind))) {
                        _gotoNext = 5434388i32;
                    } else {
                        _gotoNext = 5434467i32;
                    };
                } else if (__value__ == (5434388i32)) {
                    if (_fv_5.isNil()) {
                        _gotoNext = 5434408i32;
                    } else {
                        _gotoNext = 5434444i32;
                    };
                } else if (__value__ == (5434408i32)) {
                    _i_3++;
                    _gotoNext = 5434729i32;
                } else if (__value__ == (5434444i32)) {
                    _fv_5 = _fv_5.elem()?.__copy__();
                    _gotoNext = 5434467i32;
                } else if (__value__ == (5434467i32)) {
                    _fv_5 = _fv_5.field(_i_7)?.__copy__();
                    _i_5434337_6++;
                    _gotoNext = 5434486i32;
                } else if (__value__ == (5434485i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(0i32 : stdgo.GoInt)];
                        _i_5434337_6 = __tmp__0;
                        _i_7 = __tmp__1;
                    };
                    _gotoNext = 5434486i32;
                } else if (__value__ == (5434486i32)) {
                    if (_i_5434337_6 < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5434351i32;
                    } else {
                        _gotoNext = 5434491i32;
                    };
                } else if (__value__ == (5434491i32)) {
                    if (((@:checkr _f_4 ?? throw "null pointer dereference")._omitEmpty && stdgo._internal.encoding.json.Json__isemptyvalue._isEmptyValue(_fv_5?.__copy__()) : Bool)) {
                        _gotoNext = 5434526i32;
                    } else {
                        _gotoNext = 5434546i32;
                    };
                } else if (__value__ == (5434526i32)) {
                    _i_3++;
                    _gotoNext = 5434729i32;
                    ...
                    _i_3++;
                    _gotoNext = 5434729i32;
                } else if (__value__ == (5434728i32)) {
                    _i_3 = 0i32;
                    _gotoNext = 5434729i32;
                } else if (__value__ == (5434729i32)) {
                    if (_i_3 < (_se._fields._list.length)) {
                        _gotoNext = 5434228i32;
                    } else {
                        _gotoNext = 5434732i32;
                    };
                } else if (__value__ == (5434732i32)) {
                    if (_next_2 == ((123 : stdgo.GoUInt8))) {
                        _gotoNext = 5434747i32;
                    } else {
                        _gotoNext = 5434779i32;
                    };
                } else if (__value__ == (5434747i32)) {
                    @:check2r _e.writeString(("{}" : stdgo.GoString));
                    _gotoNext = 5434803i32;
                } else if (__value__ == (5434779i32)) {
                    _gotoNext = 5434779i32;
                    @:check2r _e.writeByte((125 : stdgo.GoUInt8));
                    var __blank__ = 0i32;
                    _gotoNext = 5434803i32;
                } else if (__value__ == (5434803i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
