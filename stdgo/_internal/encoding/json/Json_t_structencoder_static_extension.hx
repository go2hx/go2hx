...
@:keep @:allow(stdgo._internal.encoding.json.Json.T_structEncoder_asInterface) class T_structEncoder_static_extension {
    ...
    static public function _encode( _se:stdgo._internal.encoding.json.Json_t_structencoder.T_structEncoder, _e:stdgo.Ref<stdgo._internal.encoding.json.Json_t_encodestate.T_encodeState>, _v:stdgo._internal.reflect.Reflect_value.Value, _opts:stdgo._internal.encoding.json.Json_t_encopts.T_encOpts):Void {
        ...
        var _iterator_5220650_6:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5220499i32;
                } else if (__value__ == (5220499i32)) {
                    if ((0i32 : stdgo.GoInt) < (_se._fields._list.length)) {
                        _gotoNext = 5221041i32;
                    } else {
                        _gotoNext = 5221045i32;
                    };
                } else if (__value__ == (5220541i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5220798i32;
                    } else {
                        _gotoNext = 5220804i32;
                    };
                } else if (__value__ == (5220664i32)) {
                    _i_7 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(_iterator_5220650_6 : stdgo.GoInt)];
                    if (_fv_5.kind() == ((22u32 : stdgo._internal.reflect.Reflect_kind.Kind))) {
                        _gotoNext = 5220701i32;
                    } else {
                        _gotoNext = 5220780i32;
                    };
                } else if (__value__ == (5220701i32)) {
                    if (_fv_5.isNil()) {
                        _gotoNext = 5220721i32;
                    } else {
                        _gotoNext = 5220757i32;
                    };
                } else if (__value__ == (5220721i32)) {
                    _i_3++;
                    _gotoNext = 5221042i32;
                } else if (__value__ == (5220757i32)) {
                    _fv_5 = _fv_5.elem()?.__copy__();
                    _gotoNext = 5220780i32;
                } else if (__value__ == (5220780i32)) {
                    _fv_5 = _fv_5.field(_i_7)?.__copy__();
                    _iterator_5220650_6++;
                    _gotoNext = 5220799i32;
                } else if (__value__ == (5220798i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(0i32 : stdgo.GoInt)];
                        _iterator_5220650_6 = @:binopAssign __tmp__0;
                        _i_7 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5220799i32;
                } else if (__value__ == (5220799i32)) {
                    if (_iterator_5220650_6 < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5220664i32;
                    } else {
                        _gotoNext = 5220804i32;
                    };
                } else if (__value__ == (5220804i32)) {
                    ...
                    _i_3++;
                    _gotoNext = 5221042i32;
                } else if (__value__ == (5221041i32)) {
                    _i_3 = 0i32;
                    _gotoNext = 5221042i32;
                } else if (__value__ == (5221042i32)) {
                    if (_i_3 < (_se._fields._list.length)) {
                        _gotoNext = 5220541i32;
                    } else {
                        _gotoNext = 5221045i32;
                    };
                } else if (__value__ == (5221045i32)) {
                    if (_next_2 == ((123 : stdgo.GoUInt8))) {
                        _gotoNext = 5221060i32;
                    } else {
                        _gotoNext = 5221092i32;
                    };
                } else if (__value__ == (5221060i32)) {
                    @:check2r _e.writeString(("{}" : stdgo.GoString));
                    _gotoNext = 5221116i32;
                } else if (__value__ == (5221092i32)) {
                    _gotoNext = 5221092i32;
                    @:check2r _e.writeByte((125 : stdgo.GoUInt8));
                    0i32;
                    _gotoNext = 5221116i32;
                } else if (__value__ == (5221116i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
