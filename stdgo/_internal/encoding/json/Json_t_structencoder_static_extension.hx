...
@:keep @:allow(stdgo._internal.encoding.json.Json.T_structEncoder_asInterface) class T_structEncoder_static_extension {
    ...
    static public function _encode( _se:stdgo._internal.encoding.json.Json_t_structencoder.T_structEncoder, _e:stdgo.Ref<stdgo._internal.encoding.json.Json_t_encodestate.T_encodeState>, _v:stdgo._internal.reflect.Reflect_value.Value, _opts:stdgo._internal.encoding.json.Json_t_encopts.T_encOpts):Void {
        ...
        var _iterator_5428916_6:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i64 : stdgo.GoInt))) {
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    ...
                    _gotoNext = 5428765i64;
                } else if (__value__ == (5428765i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/json/encode.go#L680"
                    if ((0i64 : stdgo.GoInt) < (_se._fields._list.length)) {
                        _gotoNext = 5429307i64;
                    } else {
                        _gotoNext = 5429311i64;
                    };
                } else if (__value__ == (5428807i64)) {
                    ...
                    if ((0i64 : stdgo.GoInt) < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5429064i64;
                    } else {
                        _gotoNext = 5429070i64;
                    };
                } else if (__value__ == (5428930i64)) {
                    _i_7 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(_iterator_5428916_6 : stdgo.GoInt)];
                    ...
                    if (_fv_5.kind() == ((22u32 : stdgo._internal.reflect.Reflect_kind.Kind))) {
                        _gotoNext = 5428967i64;
                    } else {
                        _gotoNext = 5429046i64;
                    };
                } else if (__value__ == (5428967i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/json/encode.go#L687"
                    if (_fv_5.isNil()) {
                        _gotoNext = 5428987i64;
                    } else {
                        _gotoNext = 5429023i64;
                    };
                } else if (__value__ == (5428987i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/json/encode.go#L680"
                    _i_3++;
                    _gotoNext = 5429308i64;
                } else if (__value__ == (5429023i64)) {
                    _fv_5 = _fv_5.elem()?.__copy__();
                    _gotoNext = 5429046i64;
                } else if (__value__ == (5429046i64)) {
                    _fv_5 = _fv_5.field(_i_7)?.__copy__();
                    //"file:///home/runner/.go/go1.21.3/src/encoding/json/encode.go#L685"
                    _iterator_5428916_6++;
                    _gotoNext = 5429065i64;
                } else if (__value__ == (5429064i64)) {
                    {
                        final __tmp__0 = 0i64;
                        final __tmp__1 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(0i64 : stdgo.GoInt)];
                        _iterator_5428916_6 = @:binopAssign __tmp__0;
                        _i_7 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5429065i64;
                } else if (__value__ == (5429065i64)) {
                    //"file://#L0"
                    if (_iterator_5428916_6 < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5428930i64;
                    } else {
                        _gotoNext = 5429070i64;
                    };
                } else if (__value__ == (5429070i64)) {
                    ...
                    if (((@:checkr _f_4 ?? throw "null pointer dereference")._omitEmpty && stdgo._internal.encoding.json.Json__isemptyvalue._isEmptyValue(_fv_5?.__copy__()) : Bool)) {
                        _gotoNext = 5429105i64;
                    } else {
                        _gotoNext = 5429125i64;
                    };
                } else if (__value__ == (5429105i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/json/encode.go#L680"
                    _i_3++;
                    _gotoNext = 5429308i64;
                } else if (__value__ == (5429125i64)) {
                    ...
                    if (_opts._escapeHTML) {
                        _gotoNext = 5429177i64;
                    } else {
                        _gotoNext = 5429220i64;
                    };
                } else if (__value__ == (5429177i64)) {
                    ...
                    _gotoNext = 5429259i64;
                } else if (__value__ == (5429220i64)) {
                    _gotoNext = 5429220i64;
