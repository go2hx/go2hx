...
@:keep @:allow(stdgo._internal.encoding.json.Json.T_structEncoder_asInterface) class T_structEncoder_static_extension {
    ...
    static public function _encode( _se:stdgo._internal.encoding.json.Json_t_structencoder.T_structEncoder, _e:stdgo.Ref<stdgo._internal.encoding.json.Json_t_encodestate.T_encodeState>, _v:stdgo._internal.reflect.Reflect_value.Value, _opts:stdgo._internal.encoding.json.Json_t_encopts.T_encOpts):Void {
        ...
        var _iterator_5307236_6:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5307085i32;
                } else if (__value__ == (5307085i32)) {
                    if ((0i32 : stdgo.GoInt) < (_se._fields._list.length)) {
                        _gotoNext = 5307627i32;
                    } else {
                        _gotoNext = 5307631i32;
                    };
                } else if (__value__ == (5307127i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5307384i32;
                    } else {
                        _gotoNext = 5307390i32;
                    };
                } else if (__value__ == (5307250i32)) {
                    _i_7 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(_iterator_5307236_6 : stdgo.GoInt)];
                    if (_fv_5.kind() == ((22u32 : stdgo._internal.reflect.Reflect_kind.Kind))) {
                        _gotoNext = 5307287i32;
                    } else {
                        _gotoNext = 5307366i32;
                    };
                } else if (__value__ == (5307287i32)) {
                    if (_fv_5.isNil()) {
                        _gotoNext = 5307307i32;
                    } else {
                        _gotoNext = 5307343i32;
                    };
                } else if (__value__ == (5307307i32)) {
                    _i_3++;
                    _gotoNext = 5307628i32;
                } else if (__value__ == (5307343i32)) {
                    _fv_5 = _fv_5.elem()?.__copy__();
                    _gotoNext = 5307366i32;
                } else if (__value__ == (5307366i32)) {
                    _fv_5 = _fv_5.field(_i_7)?.__copy__();
                    _iterator_5307236_6++;
                    _gotoNext = 5307385i32;
                } else if (__value__ == (5307384i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (@:checkr _f_4 ?? throw "null pointer dereference")._index[(0i32 : stdgo.GoInt)];
                        _iterator_5307236_6 = @:binopAssign __tmp__0;
                        _i_7 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5307385i32;
                } else if (__value__ == (5307385i32)) {
                    if (_iterator_5307236_6 < ((@:checkr _f_4 ?? throw "null pointer dereference")._index.length)) {
                        _gotoNext = 5307250i32;
                    } else {
                        _gotoNext = 5307390i32;
                    };
                } else if (__value__ == (5307390i32)) {
                    if (((@:checkr _f_4 ?? throw "null pointer dereference")._omitEmpty && stdgo._internal.encoding.json.Json__isemptyvalue._isEmptyValue(_fv_5?.__copy__()) : Bool)) {
                        _gotoNext = 5307425i32;
                    } else {
                        _gotoNext = 5307445i32;
                    };
                } else if (__value__ == (5307425i32)) {
                    _i_3++;
                    _gotoNext = 5307628i32;
                } else if (__value__ == (5307445i32)) {
                    @:check2r _e.writeByte(_next_2);
                    _next_2 = (44 : stdgo.GoUInt8);
                    if (_opts._escapeHTML) {
                        _gotoNext = 5307497i32;
                    } else {
                        _gotoNext = 5307540i32;
                    };
                } else if (__value__ == (5307497i32)) {
                    @:check2r _e.writeString((@:checkr _f_4 ?? throw "null pointer dereference")._nameEscHTML?.__copy__());
                    _gotoNext = 5307579i32;
                } else if (__value__ == (5307540i32)) {
                    _gotoNext = 5307540i32;
                    @:check2r _e.writeString((@:checkr _f_4 ?? throw "null pointer dereference")._nameNonEsc?.__copy__());
                    0i32;
                    _gotoNext = 5307579i32;
                } else if (__value__ == (5307579i32)) {
                    ...
                    _i_3++;
                    _gotoNext = 5307628i32;
                } else if (__value__ == (5307627i32)) {
                    _i_3 = 0i32;
                    _gotoNext = 5307628i32;
                } else if (__value__ == (5307628i32)) {
                    if (_i_3 < (_se._fields._list.length)) {
                        _gotoNext = 5307127i32;
                    } else {
                        _gotoNext = 5307631i32;
                    };
                } else if (__value__ == (5307631i32)) {
                    if (_next_2 == ((123 : stdgo.GoUInt8))) {
                        _gotoNext = 5307646i32;
                    } else {
                        _gotoNext = 5307678i32;
                    };
                } else if (__value__ == (5307646i32)) {
                    @:check2r _e.writeString(("{}" : stdgo.GoString));
                    _gotoNext = 5307702i32;
                } else if (__value__ == (5307678i32)) {
                    _gotoNext = 5307678i32;
                    @:check2r _e.writeByte((125 : stdgo.GoUInt8));
                    0i32;
                    _gotoNext = 5307702i32;
                } else if (__value__ == (5307702i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
