...
function testEmptyString(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        var _err = (@:check2r _dec.decode(stdgo.Go.toInterface((stdgo.Go.setRef(_t2) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_testEmptyString___localname___T2_40735.T_testEmptyString___localname___T2_40735>))) : stdgo.Error);
        if (_err == null) {
