...
function testErrorMessageFromMisusedString(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        for (_n => _tt in stdgo._internal.encoding.json.Json__wrongStringTests._wrongStringTests) {
            ...
            var _s__pointer__ = (stdgo.Go.setRef(_s) : stdgo.Ref<stdgo._internal.encoding.json.Json_WrongString.WrongString>);
            var _s__pointer__ = (stdgo.Go.setRef(_s) : stdgo.Ref<stdgo._internal.encoding.json.Json_WrongString.WrongString>);
            var _s__pointer__ = (stdgo.Go.setRef(_s) : stdgo.Ref<stdgo._internal.encoding.json.Json_WrongString.WrongString>);
            var _s__pointer__ = (stdgo.Go.setRef(_s) : stdgo.Ref<stdgo._internal.encoding.json.Json_WrongString.WrongString>);
            var _err = (stdgo._internal.encoding.json.Json_newDecoder.newDecoder(stdgo.Go.asInterface(_r)).decode(stdgo.Go.toInterface(_s__pointer__)) : stdgo.Error);
