...
function testIndent(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        for (__4 => _tt in stdgo._internal.encoding.json.Json__examples._examples) {
            _buf.reset();
            {
                var _err = (stdgo._internal.encoding.json.Json_indent.indent(_buf__pointer__, (_tt._indent : stdgo.Slice<stdgo.GoUInt8>), stdgo.Go.str()?.__copy__(), ("\t" : stdgo.GoString)) : stdgo.Error);
                if (_err != null) {
            ...
            _buf.reset();
            {
                var _err = (stdgo._internal.encoding.json.Json_indent.indent(_buf__pointer__, (_tt._compact : stdgo.Slice<stdgo.GoUInt8>), stdgo.Go.str()?.__copy__(), ("\t" : stdgo.GoString)) : stdgo.Error);
                if (_err != null) {
