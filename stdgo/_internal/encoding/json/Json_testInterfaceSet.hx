...
function testInterfaceSet(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        for (__4 => _tt in stdgo._internal.encoding.json.Json__interfaceSetTests._interfaceSetTests) {
            ...
            var _b__pointer__ = (stdgo.Go.setRef(_b) : stdgo.Ref<stdgo._internal.encoding.json.Json_T__struct_9.T__struct_9>);
            var _b__pointer__ = (stdgo.Go.setRef(_b) : stdgo.Ref<stdgo._internal.encoding.json.Json_T__struct_9.T__struct_9>);
            var _b__pointer__ = (stdgo.Go.setRef(_b) : stdgo.Ref<stdgo._internal.encoding.json.Json_T__struct_9.T__struct_9>);
            var _b__pointer__ = (stdgo.Go.setRef(_b) : stdgo.Ref<stdgo._internal.encoding.json.Json_T__struct_9.T__struct_9>);
            ...
            {
                var _err = (stdgo._internal.encoding.json.Json_unmarshal.unmarshal((_blob : stdgo.Slice<stdgo.GoUInt8>), stdgo.Go.toInterface(stdgo.Go.asInterface(_b__pointer__))) : stdgo.Error);
                if (_err != null) {
