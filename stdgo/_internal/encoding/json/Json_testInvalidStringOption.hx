...
function testInvalidStringOption(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        var _item = ({ m : ({
            ...
            {};
            x;
        } : stdgo.GoMap<stdgo.GoString, stdgo.GoString>), s : (new stdgo.Slice<stdgo.GoString>((0 : stdgo.GoInt).toBasic(), 0).__setString__() : stdgo.Slice<stdgo.GoString>), i : stdgo.Go.toInterface(_num), p : _num__pointer__, t : ({} : stdgo._internal.time.Time_Time.Time), a : new stdgo.GoArray<stdgo.GoString>(1, 1, ...[for (i in 0 ... 1) ("" : stdgo.GoString)]) } : stdgo._internal.encoding.json.Json_T__struct_13.T__struct_13);
        var _item__pointer__ = (stdgo.Go.setRef(_item) : stdgo.Ref<stdgo._internal.encoding.json.Json_T__struct_13.T__struct_13>);
        var _item__pointer__ = (stdgo.Go.setRef(_item) : stdgo.Ref<stdgo._internal.encoding.json.Json_T__struct_13.T__struct_13>);
        var _item__pointer__ = (stdgo.Go.setRef(_item) : stdgo.Ref<stdgo._internal.encoding.json.Json_T__struct_13.T__struct_13>);
        var _item__pointer__ = (stdgo.Go.setRef(_item) : stdgo.Ref<stdgo._internal.encoding.json.Json_T__struct_13.T__struct_13>);
        ...
        _err = stdgo._internal.encoding.json.Json_unmarshal.unmarshal(_data, stdgo.Go.toInterface(stdgo.Go.asInterface(_item__pointer__)));
        if (_err != null) {
