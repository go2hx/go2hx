...
var _rawText = __2, _rawEmpty = __1, _rawNil = __0;
        var _rawText__pointer__ = (stdgo.Go.setRef(_rawText) : stdgo.Ref<stdgo._internal.encoding.json.Json_RawMessage.RawMessage>);
        var _rawEmpty__pointer__ = (stdgo.Go.setRef(_rawEmpty) : stdgo.Ref<stdgo._internal.encoding.json.Json_RawMessage.RawMessage>);
        var _rawNil__pointer__ = (stdgo.Go.setRef(_rawNil) : stdgo.Ref<stdgo._internal.encoding.json.Json_RawMessage.RawMessage>);
        var _rawText__pointer__ = (stdgo.Go.setRef(_rawText) : stdgo.Ref<stdgo._internal.encoding.json.Json_RawMessage.RawMessage>);
        var _rawEmpty__pointer__ = (stdgo.Go.setRef(_rawEmpty) : stdgo.Ref<stdgo._internal.encoding.json.Json_RawMessage.RawMessage>);
        var _rawNil__pointer__ = (stdgo.Go.setRef(_rawNil) : stdgo.Ref<stdgo._internal.encoding.json.Json_RawMessage.RawMessage>);
        var _rawText__pointer__ = (stdgo.Go.setRef(_rawText) : stdgo.Ref<stdgo._internal.encoding.json.Json_RawMessage.RawMessage>);
...
({ _in : stdgo.Go.toInterface(stdgo.Go.asInterface(_rawNil__pointer__)), _want : ("null" : stdgo.GoString), _ok : true } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
...
({ _in : stdgo.Go.toInterface((new stdgo.Slice<stdgo.AnyInterface>(1, 1, ...[stdgo.Go.toInterface(stdgo.Go.asInterface(_rawNil__pointer__))]) : stdgo.Slice<stdgo.AnyInterface>)), _want : ("[null]" : stdgo.GoString), _ok : true } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo.Slice<stdgo.AnyInterface>(1, 1, ...[stdgo.Go.toInterface(stdgo.Go.asInterface(_rawNil__pointer__))]) : stdgo.Slice<stdgo.AnyInterface>)) : stdgo.Ref<stdgo.Slice<stdgo.AnyInterface>>)), _want : ("[null]" : stdgo.GoString), _ok : true } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
...
({ _in : stdgo.Go.toInterface(stdgo.Go.asInterface(({ m : _rawNil__pointer__ } : stdgo._internal.encoding.json.Json_T__struct_31.T__struct_31))), _want : ("{\"M\":null}" : stdgo.GoString), _ok : true } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(({ m : _rawNil__pointer__ } : stdgo._internal.encoding.json.Json_T__struct_31.T__struct_31)) : stdgo.Ref<stdgo._internal.encoding.json.Json_T__struct_31.T__struct_31>))), _want : ("{\"M\":null}" : stdgo.GoString), _ok : true } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
...
({ _in : stdgo.Go.toInterface(({
            final x = new stdgo.GoMap.GoStringMap<stdgo.AnyInterface>();
            x.__defaultValue__ = () -> (null : stdgo.AnyInterface);
            x.set(("M" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_rawNil__pointer__)));
            x;
        } : stdgo.GoMap<stdgo.GoString, stdgo.AnyInterface>)), _want : ("{\"M\":null}" : stdgo.GoString), _ok : true } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface((stdgo.Go.setRef(({
            final x = new stdgo.GoMap.GoStringMap<stdgo.AnyInterface>();
...
({ _in : stdgo.Go.toInterface(stdgo.Go.asInterface(_rawEmpty)), _want : stdgo.Go.str()?.__copy__(), _ok : false } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface(stdgo.Go.asInterface(_rawEmpty__pointer__)), _want : stdgo.Go.str()?.__copy__(), _ok : false } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface((new stdgo.Slice<stdgo.AnyInterface>(1, 1, ...[stdgo.Go.toInterface(stdgo.Go.asInterface(_rawEmpty))]) : stdgo.Slice<stdgo.AnyInterface>)), _want : stdgo.Go.str()?.__copy__(), _ok : false } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo.Slice<stdgo.AnyInterface>(1, 1, ...[stdgo.Go.toInterface(stdgo.Go.asInterface(_rawEmpty))]) : stdgo.Slice<stdgo.AnyInterface>)) : stdgo.Ref<stdgo.Slice<stdgo.AnyInterface>>)), _want : stdgo.Go.str()?.__copy__(), _ok : false } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface((new stdgo.Slice<stdgo.AnyInterface>(1, 1, ...[stdgo.Go.toInterface(stdgo.Go.asInterface(_rawEmpty__pointer__))]) : stdgo.Slice<stdgo.AnyInterface>)), _want : stdgo.Go.str()?.__copy__(), _ok : false } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo.Slice<stdgo.AnyInterface>(1, 1, ...[stdgo.Go.toInterface(stdgo.Go.asInterface(_rawEmpty__pointer__))]) : stdgo.Slice<stdgo.AnyInterface>)) : stdgo.Ref<stdgo.Slice<stdgo.AnyInterface>>)), _want : stdgo.Go.str()?.__copy__(), _ok : false } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface(stdgo.Go.asInterface(({ x : _rawEmpty } : stdgo._internal.encoding.json.Json_T__struct_32.T__struct_32))), _want : stdgo.Go.str()?.__copy__(), _ok : false } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(({ x : _rawEmpty } : stdgo._internal.encoding.json.Json_T__struct_32.T__struct_32)) : stdgo.Ref<stdgo._internal.encoding.json.Json_T__struct_32.T__struct_32>))), _want : stdgo.Go.str()?.__copy__(), _ok : false } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface(stdgo.Go.asInterface(({ x : _rawEmpty__pointer__ } : stdgo._internal.encoding.json.Json_T__struct_33.T__struct_33))), _want : stdgo.Go.str()?.__copy__(), _ok : false } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(({ x : _rawEmpty__pointer__ } : stdgo._internal.encoding.json.Json_T__struct_33.T__struct_33)) : stdgo.Ref<stdgo._internal.encoding.json.Json_T__struct_33.T__struct_33>))), _want : stdgo.Go.str()?.__copy__(), _ok : false } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface(({
            final x = new stdgo.GoMap.GoStringMap<stdgo.AnyInterface>();
            x.__defaultValue__ = () -> (null : stdgo.AnyInterface);
            x.set(("nil" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_rawEmpty)));
            x;
        } : stdgo.GoMap<stdgo.GoString, stdgo.AnyInterface>)), _want : stdgo.Go.str()?.__copy__(), _ok : false } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface((stdgo.Go.setRef(({
            final x = new stdgo.GoMap.GoStringMap<stdgo.AnyInterface>();
            x.__defaultValue__ = () -> (null : stdgo.AnyInterface);
            x.set(("nil" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_rawEmpty)));
            x;
        } : stdgo.GoMap<stdgo.GoString, stdgo.AnyInterface>)) : stdgo.Ref<stdgo.GoMap<stdgo.GoString, stdgo.AnyInterface>>)), _want : stdgo.Go.str()?.__copy__(), _ok : false } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface(({
            final x = new stdgo.GoMap.GoStringMap<stdgo.AnyInterface>();
            x.__defaultValue__ = () -> (null : stdgo.AnyInterface);
            x.set(("nil" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_rawEmpty__pointer__)));
            x;
        } : stdgo.GoMap<stdgo.GoString, stdgo.AnyInterface>)), _want : stdgo.Go.str()?.__copy__(), _ok : false } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface((stdgo.Go.setRef(({
            final x = new stdgo.GoMap.GoStringMap<stdgo.AnyInterface>();
...
({ _in : stdgo.Go.toInterface((new stdgo._internal.encoding.json.Json_T_testMarshalRawMessageValue___localname___T2_23573.T_testMarshalRawMessageValue___localname___T2_23573(_rawEmpty__pointer__) : stdgo._internal.encoding.json.Json_T_testMarshalRawMessageValue___localname___T2_23573.T_testMarshalRawMessageValue___localname___T2_23573)), _want : stdgo.Go.str()?.__copy__(), _ok : false } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo._internal.encoding.json.Json_T_testMarshalRawMessageValue___localname___T1_23519.T_testMarshalRawMessageValue___localname___T1_23519(_rawEmpty) : stdgo._internal.encoding.json.Json_T_testMarshalRawMessageValue___localname___T1_23519.T_testMarshalRawMessageValue___localname___T1_23519)) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_testMarshalRawMessageValue___localname___T1_23519.T_testMarshalRawMessageValue___localname___T1_23519>)), _want : ("{}" : stdgo.GoString), _ok : true } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo._internal.encoding.json.Json_T_testMarshalRawMessageValue___localname___T2_23573.T_testMarshalRawMessageValue___localname___T2_23573(_rawEmpty__pointer__) : stdgo._internal.encoding.json.Json_T_testMarshalRawMessageValue___localname___T2_23573.T_testMarshalRawMessageValue___localname___T2_23573)) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_testMarshalRawMessageValue___localname___T2_23573.T_testMarshalRawMessageValue___localname___T2_23573>)), _want : stdgo.Go.str()?.__copy__(), _ok : false } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
...
({ _in : stdgo.Go.toInterface(stdgo.Go.asInterface(_rawText__pointer__)), _want : ("\"foo\"" : stdgo.GoString), _ok : true } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
...
({ _in : stdgo.Go.toInterface((new stdgo.Slice<stdgo.AnyInterface>(1, 1, ...[stdgo.Go.toInterface(stdgo.Go.asInterface(_rawText__pointer__))]) : stdgo.Slice<stdgo.AnyInterface>)), _want : ("[\"foo\"]" : stdgo.GoString), _ok : true } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo.Slice<stdgo.AnyInterface>(1, 1, ...[stdgo.Go.toInterface(stdgo.Go.asInterface(_rawText__pointer__))]) : stdgo.Slice<stdgo.AnyInterface>)) : stdgo.Ref<stdgo.Slice<stdgo.AnyInterface>>)), _want : ("[\"foo\"]" : stdgo.GoString), _ok : true } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
...
({ _in : stdgo.Go.toInterface(stdgo.Go.asInterface(({ m : _rawText__pointer__ } : stdgo._internal.encoding.json.Json_T__struct_31.T__struct_31))), _want : ("{\"M\":\"foo\"}" : stdgo.GoString), _ok : true } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(({ m : _rawText__pointer__ } : stdgo._internal.encoding.json.Json_T__struct_31.T__struct_31)) : stdgo.Ref<stdgo._internal.encoding.json.Json_T__struct_31.T__struct_31>))), _want : ("{\"M\":\"foo\"}" : stdgo.GoString), _ok : true } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface(({
            final x = new stdgo.GoMap.GoStringMap<stdgo.AnyInterface>();
            x.__defaultValue__ = () -> (null : stdgo.AnyInterface);
...
({ _in : stdgo.Go.toInterface(({
            final x = new stdgo.GoMap.GoStringMap<stdgo.AnyInterface>();
            x.__defaultValue__ = () -> (null : stdgo.AnyInterface);
            x.set(("M" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_rawText__pointer__)));
            x;
        } : stdgo.GoMap<stdgo.GoString, stdgo.AnyInterface>)), _want : ("{\"M\":\"foo\"}" : stdgo.GoString), _ok : true } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface((stdgo.Go.setRef(({
            final x = new stdgo.GoMap.GoStringMap<stdgo.AnyInterface>();
...
({ _in : stdgo.Go.toInterface((new stdgo._internal.encoding.json.Json_T_testMarshalRawMessageValue___localname___T2_23573.T_testMarshalRawMessageValue___localname___T2_23573(_rawText__pointer__) : stdgo._internal.encoding.json.Json_T_testMarshalRawMessageValue___localname___T2_23573.T_testMarshalRawMessageValue___localname___T2_23573)), _want : ("{\"M\":\"foo\"}" : stdgo.GoString), _ok : true } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo._internal.encoding.json.Json_T_testMarshalRawMessageValue___localname___T1_23519.T_testMarshalRawMessageValue___localname___T1_23519(_rawText) : stdgo._internal.encoding.json.Json_T_testMarshalRawMessageValue___localname___T1_23519.T_testMarshalRawMessageValue___localname___T1_23519)) : stdgo.Ref<stdgo._internal.encoding.json.Json_T_testMarshalRawMessageValue___localname___T1_23519.T_testMarshalRawMessageValue___localname___T1_23519>)), _want : ("{\"M\":\"foo\"}" : stdgo.GoString), _ok : true } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
