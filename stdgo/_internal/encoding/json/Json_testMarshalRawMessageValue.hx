...
({ _in : stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_rawEmpty) : stdgo.Ref<stdgo._internal.encoding.json.Json_RawMessage.RawMessage>))), _want : stdgo.Go.str()?.__copy__(), _ok : false } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
...
({ _in : stdgo.Go.toInterface((new stdgo.Slice<stdgo.AnyInterface>(1, 1, ...[stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_rawEmpty) : stdgo.Ref<stdgo._internal.encoding.json.Json_RawMessage.RawMessage>)))]) : stdgo.Slice<stdgo.AnyInterface>)), _want : stdgo.Go.str()?.__copy__(), _ok : false } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
({ _in : stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo.Slice<stdgo.AnyInterface>(1, 1, ...[stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_rawEmpty) : stdgo.Ref<stdgo._internal.encoding.json.Json_RawMessage.RawMessage>)))]) : stdgo.Slice<stdgo.AnyInterface>)) : stdgo.Ref<stdgo.Slice<stdgo.AnyInterface>>)), _want : stdgo.Go.str()?.__copy__(), _ok : false } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
...
({ _in : stdgo.Go.toInterface(stdgo.Go.asInterface(({ x : (stdgo.Go.setRef(_rawEmpty) : stdgo.Ref<stdgo._internal.encoding.json.Json_RawMessage.RawMessage>) } : stdgo._internal.encoding.json.Json_T__struct_33.T__struct_33))), _want : stdgo.Go.str()?.__copy__(), _ok : false } : stdgo._internal.encoding.json.Json_T__struct_29.T__struct_29),
