...
function testSkipArrayObjects(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        var _dest__pointer__ = (stdgo.Go.setRef(_dest) : stdgo.Ref<stdgo.GoArray<stdgo.AnyInterface>>);
        var _dest__pointer__ = (stdgo.Go.setRef(_dest) : stdgo.Ref<stdgo.GoArray<stdgo.AnyInterface>>);
        var _dest__pointer__ = (stdgo.Go.setRef(_dest) : stdgo.Ref<stdgo.GoArray<stdgo.AnyInterface>>);
        var _dest__pointer__ = (stdgo.Go.setRef(_dest) : stdgo.Ref<stdgo.GoArray<stdgo.AnyInterface>>);
        var _err = (stdgo._internal.encoding.json.Json_unmarshal.unmarshal((_json : stdgo.Slice<stdgo.GoUInt8>), stdgo.Go.toInterface(_dest__pointer__)) : stdgo.Error);
        if (_err != null) {
