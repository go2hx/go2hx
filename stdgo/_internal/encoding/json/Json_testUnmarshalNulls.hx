...
function testUnmarshalNulls(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        var _nulls__pointer__ = (stdgo.Go.setRef(_nulls) : stdgo.Ref<stdgo._internal.encoding.json.Json_NullTest.NullTest>);
        var _nulls__pointer__ = (stdgo.Go.setRef(_nulls) : stdgo.Ref<stdgo._internal.encoding.json.Json_NullTest.NullTest>);
        var _nulls__pointer__ = (stdgo.Go.setRef(_nulls) : stdgo.Ref<stdgo._internal.encoding.json.Json_NullTest.NullTest>);
        var _nulls__pointer__ = (stdgo.Go.setRef(_nulls) : stdgo.Ref<stdgo._internal.encoding.json.Json_NullTest.NullTest>);
        var _before = ((_nulls.time.string() : stdgo.GoString)?.__copy__() : stdgo.GoString);
        var _err = (stdgo._internal.encoding.json.Json_unmarshal.unmarshal(_jsonData, stdgo.Go.toInterface(_nulls__pointer__)) : stdgo.Error);
        if (_err != null) {
