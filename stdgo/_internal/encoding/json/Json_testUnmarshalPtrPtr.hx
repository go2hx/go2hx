...
function testUnmarshalPtrPtr(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        var _xint__pointer__ = (stdgo.Go.setRef(_xint) : stdgo.Ref<stdgo._internal.encoding.json.Json_Xint.Xint>);
        var _xint__pointer__ = (stdgo.Go.setRef(_xint) : stdgo.Ref<stdgo._internal.encoding.json.Json_Xint.Xint>);
        var _pxint = _xint__pointer__;
        var _pxint__pointer__ = (stdgo.Go.setRef(_pxint) : stdgo.Ref<stdgo.Ref<stdgo._internal.encoding.json.Json_Xint.Xint>>);
        var _pxint__pointer__ = (stdgo.Go.setRef(_pxint) : stdgo.Ref<stdgo.Ref<stdgo._internal.encoding.json.Json_Xint.Xint>>);
        var _pxint__pointer__ = (stdgo.Go.setRef(_pxint) : stdgo.Ref<stdgo.Ref<stdgo._internal.encoding.json.Json_Xint.Xint>>);
        var _pxint__pointer__ = (stdgo.Go.setRef(_pxint) : stdgo.Ref<stdgo.Ref<stdgo._internal.encoding.json.Json_Xint.Xint>>);
        {
            var _err = (stdgo._internal.encoding.json.Json_unmarshal.unmarshal((("{\"X\":1}" : stdgo.GoString) : stdgo.Slice<stdgo.GoUInt8>), stdgo.Go.toInterface(_pxint__pointer__)) : stdgo.Error);
            if (_err != null) {
