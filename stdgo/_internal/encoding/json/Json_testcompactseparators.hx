...
function testCompactSeparators(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/json/scanner_test.go#L96"
        for (__4 => _tt in _tests) {
            var _buf:stdgo._internal.bytes.Bytes_buffer.Buffer = ({} : stdgo._internal.bytes.Bytes_buffer.Buffer);
            //"file:///home/runner/.go/go1.21.3/src/encoding/json/scanner_test.go#L98"
            {
                ...
                if (_err != null) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/json/scanner_test.go#L99"
                    ...
                    if (_s != (_tt._compact)) {
                        //"file:///home/runner/.go/go1.21.3/src/encoding/json/scanner_test.go#L101"
