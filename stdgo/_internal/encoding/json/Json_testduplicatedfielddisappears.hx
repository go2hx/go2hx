...
function testDuplicatedFieldDisappears(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/json/encode_test.go#L693"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/encoding/json/encode_test.go#L694"
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/json/encode_test.go#L698"
        if (_got != (_want)) {
            //"file:///home/runner/.go/go1.21.3/src/encoding/json/encode_test.go#L699"
