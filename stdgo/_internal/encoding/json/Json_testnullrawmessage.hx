...
function testNullRawMessage(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/json/stream_test.go#L311"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/encoding/json/stream_test.go#L312"
            _t.fatalf(("Unmarshal: %v" : stdgo.GoString), stdgo.Go.toInterface(_err));
        };
        //"file:///home/runner/.go/go1.21.3/src/encoding/json/stream_test.go#L314"
        {
            var __0 = (("null" : stdgo.GoString) : stdgo.GoString), __1 = ((_data.id : stdgo.GoString)?.__copy__() : stdgo.GoString);
var _got = __1, _want = __0;
            if (_want != (_got)) {
                //"file:///home/runner/.go/go1.21.3/src/encoding/json/stream_test.go#L315"
                _t.fatalf(("Raw mismatch: have %q, want %q" : stdgo.GoString), stdgo.Go.toInterface(_got), stdgo.Go.toInterface(_want));
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/encoding/json/stream_test.go#L317"
        if (({
            final value = _data.idPtr;
            (value != null && ((value : Dynamic).__nil__ == null || !(value : Dynamic).__nil__));
        })) {
            //"file:///home/runner/.go/go1.21.3/src/encoding/json/stream_test.go#L318"
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/json/stream_test.go#L321"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/encoding/json/stream_test.go#L322"
            _t.fatalf(("Marshal: %v" : stdgo.GoString), stdgo.Go.toInterface(_err));
        };
        //"file:///home/runner/.go/go1.21.3/src/encoding/json/stream_test.go#L324"
        if ((_b : stdgo.GoString) != (("{\"X\":0.1,\"Id\":null,\"IdPtr\":null,\"Y\":0.2}" : stdgo.GoString))) {
            //"file:///home/runner/.go/go1.21.3/src/encoding/json/stream_test.go#L325"
