...
x.set(("Z" : stdgo.GoString), stdgo.Go.toInterface((1.5 : stdgo.GoFloat64)));
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/json/decode_test.go#L2140"
        for (__4 => _tt in _prefillTests) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/encoding/json/decode_test.go#L2143"
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/encoding/json/decode_test.go#L2144"
                _t.errorf(("Unmarshal: %v" : stdgo.GoString), stdgo.Go.toInterface(_err));
            };
            //"file:///home/runner/.go/go1.21.3/src/encoding/json/decode_test.go#L2146"
            if (!stdgo._internal.reflect.Reflect_deepequal.deepEqual(_tt._ptr, _tt._out)) {
                //"file:///home/runner/.go/go1.21.3/src/encoding/json/decode_test.go#L2147"
