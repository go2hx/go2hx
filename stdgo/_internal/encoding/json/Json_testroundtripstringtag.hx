...
function testRoundtripStringTag(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/json/encode_test.go#L121"
        for (__4 => _test in _tests) {
            //"file:///home/runner/.go/go1.21.3/src/encoding/json/encode_test.go#L122"
            _t.run(_test._name?.__copy__(), function(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/json/encode_test.go#L126"
                if (_err != null) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/json/encode_test.go#L127"
                    _t.fatal(stdgo.Go.toInterface(_err));
                };
                //"file:///home/runner/.go/go1.21.3/src/encoding/json/encode_test.go#L129"
                {
                    var _got = ((_got : stdgo.GoString)?.__copy__() : stdgo.GoString);
                    if (_got != (_test._want)) {
                        //"file:///home/runner/.go/go1.21.3/src/encoding/json/encode_test.go#L130"
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/json/encode_test.go#L135"
                {
                    ...
                    if (_err != null) {
                        //"file:///home/runner/.go/go1.21.3/src/encoding/json/encode_test.go#L136"
                        _t.fatalf(("Decode: %v" : stdgo.GoString), stdgo.Go.toInterface(_err));
                    };
                };
                //"file:///home/runner/.go/go1.21.3/src/encoding/json/encode_test.go#L138"
                if (!stdgo._internal.reflect.Reflect_deepequal.deepEqual(stdgo.Go.toInterface(stdgo.Go.asInterface(_test._in)), stdgo.Go.toInterface(stdgo.Go.asInterface(_s2)))) {
                    //"file:///home/runner/.go/go1.21.3/src/encoding/json/encode_test.go#L139"
