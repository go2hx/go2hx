...
function testUnmarshalErrorAfterMultipleJSON(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/json/decode_test.go#L2374"
        for (_i => _tt in _tests) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/encoding/json/decode_test.go#L2377"
            while (true) {
                var _v:stdgo.AnyInterface = (null : stdgo.AnyInterface);
                //"file:///home/runner/.go/go1.21.3/src/encoding/json/decode_test.go#L2379"
                {
                    _err = _dec.decode(stdgo.Go.toInterface((stdgo.Go.setRef(_v) : stdgo.Ref<stdgo.AnyInterface>)));
                    if (_err != null) {
                        //"file:///home/runner/.go/go1.21.3/src/encoding/json/decode_test.go#L2380"
                        break;
                    };
                };
            };
            //"file:///home/runner/.go/go1.21.3/src/encoding/json/decode_test.go#L2383"
            if (!stdgo._internal.reflect.Reflect_deepequal.deepEqual(stdgo.Go.toInterface(_err), stdgo.Go.toInterface(_tt._err))) {
                //"file:///home/runner/.go/go1.21.3/src/encoding/json/decode_test.go#L2384"
