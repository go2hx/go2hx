...
@:structInit @:using(stdgo._internal.encoding.json.Json_unsupportedtypeerror_static_extension.UnsupportedTypeError_static_extension) class UnsupportedTypeError {
