...
function _getLine(_data:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Slice<stdgo.GoUInt8>; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/encoding/pem/pem.go#L43"
        if ((_i < (0 : stdgo.GoInt) : Bool)) {
            _i = (_data.length);
            _j = _i;
        } else {
            _j = (_i + (1 : stdgo.GoInt) : stdgo.GoInt);
            //"file:///home/runner/.go/go1.21.3/src/encoding/pem/pem.go#L48"
            if (((_i > (0 : stdgo.GoInt) : Bool) && (_data[(_i - (1 : stdgo.GoInt) : stdgo.GoInt)] == (13 : stdgo.GoUInt8)) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/encoding/pem/pem.go#L49"
                _i--;
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/encoding/pem/pem.go#L52"
        return {
