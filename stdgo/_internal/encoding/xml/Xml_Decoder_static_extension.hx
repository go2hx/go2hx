        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if (((((@:checkr _finfo_3755518 ?? throw "null pointer dereference")._flags & (1 : stdgo._internal.encoding.xml.Xml_T_fieldFlags.T_fieldFlags) : stdgo._internal.encoding.xml.Xml_T_fieldFlags.T_fieldFlags) == ((0 : stdgo._internal.encoding.xml.Xml_T_fieldFlags.T_fieldFlags)) || (((@:checkr _finfo_3755518 ?? throw "null pointer dereference")._parents.length) < (_parents.length) : Bool) : Bool) || ((@:checkr _finfo_3755518 ?? throw "null pointer dereference")._xmlns != (stdgo.Go.str()) && (@:checkr _finfo_3755518 ?? throw "null pointer dereference")._xmlns != ((@:checkr _start ?? throw "null pointer dereference").name.space) : Bool) : Bool)) {
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((((@:checkr _finfo_3749214 ?? throw "null pointer dereference")._name != stdgo.Go.str()) && ((@:checkr _finfo_3749214 ?? throw "null pointer dereference")._name != (@:checkr _start ?? throw "null pointer dereference").name.local) : Bool)) {
                    ...
                    if ((((@:checkr _finfo_3749214 ?? throw "null pointer dereference")._xmlns != stdgo.Go.str()) && ((@:checkr _finfo_3749214 ?? throw "null pointer dereference")._xmlns != (@:checkr _start ?? throw "null pointer dereference").name.space) : Bool)) {
                    ...
                    if (((_a_3749869.name.local == (@:checkr _finfo_3749963 ?? throw "null pointer dereference")._name) && ((((@:checkr _finfo_3749963 ?? throw "null pointer dereference")._xmlns == stdgo.Go.str()) || ((@:checkr _finfo_3749963 ?? throw "null pointer dereference")._xmlns == _a_3749869.name.space) : Bool)) : Bool)) {
