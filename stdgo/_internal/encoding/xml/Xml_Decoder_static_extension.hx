        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    return { _0 : true, _1 : _d._unmarshal(_finfo_3697475._value(_sv?.__copy__(), true)?.__copy__(), _start, (_depth + (1 : stdgo.GoInt) : stdgo.GoInt)) };
                    _gotoNext = 3697945i32;
                    ...
                    return { _0 : true, _1 : _err_3698900 };
                    _gotoNext = 3699002i32;
                    ...
                    return { _0 : true, _1 : _err_3699025 };
                    _gotoNext = 0i32;
