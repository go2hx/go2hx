        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _v_3738185.set(stdgo._internal.reflect.Reflect_valueOf.valueOf(stdgo.Go.toInterface((@:checkr _start ?? throw "null pointer dereference").name))?.__copy__());
                    _gotoNext = 3741500i32;
                    ...
                    if ((((@:checkr _finfo_3739352 ?? throw "null pointer dereference")._name != stdgo.Go.str()) && ((@:checkr _finfo_3739352 ?? throw "null pointer dereference")._name != (@:checkr _start ?? throw "null pointer dereference").name.local) : Bool)) {
                    ...
                    if ((((@:checkr _finfo_3739352 ?? throw "null pointer dereference")._xmlns != stdgo.Go.str()) && ((@:checkr _finfo_3739352 ?? throw "null pointer dereference")._xmlns != (@:checkr _start ?? throw "null pointer dereference").name.space) : Bool)) {
                    ...
                    _fv_3739842.set(stdgo._internal.reflect.Reflect_valueOf.valueOf(stdgo.Go.toInterface((@:checkr _start ?? throw "null pointer dereference").name))?.__copy__());
                    _gotoNext = 3740000i32;
                    ...
                    if (((_a_3740007.name.local == (@:checkr _finfo_3740101 ?? throw "null pointer dereference")._name) && ((((@:checkr _finfo_3740101 ?? throw "null pointer dereference")._xmlns == stdgo.Go.str()) || ((@:checkr _finfo_3740101 ?? throw "null pointer dereference")._xmlns == _a_3740007.name.space) : Bool)) : Bool)) {
