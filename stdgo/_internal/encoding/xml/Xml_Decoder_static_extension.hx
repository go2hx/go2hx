...
@:keep @:allow(stdgo._internal.encoding.xml.Xml.Decoder_asInterface) class Decoder_static_extension {
    ...
    static public function token( _d:stdgo.Ref<stdgo._internal.encoding.xml.Xml_Decoder.Decoder>):{ var _0 : stdgo._internal.encoding.xml.Xml_Token.Token; var _1 : stdgo.Error; } {
        ...
        };
        {
            ...
            if (stdgo.Go.typeEquals((__type__ : stdgo._internal.encoding.xml.Xml_StartElement.StartElement))) {
                ...
                var _t1__pointer__ = stdgo.Go.pointer(_t1);
                ...
                var _t1__pointer__ = stdgo.Go.pointer(_t1);
                if (!_d._popElement(_t1__pointer__)) {
                    return { _0 : (null : stdgo._internal.encoding.xml.Xml_Token.Token), _1 : _d._err };
                };
    ...
    static public function _unmarshalPath( _d:stdgo.Ref<stdgo._internal.encoding.xml.Xml_Decoder.Decoder>, _tinfo:stdgo.Ref<stdgo._internal.encoding.xml.Xml_T_typeInfo.T_typeInfo>, _sv:stdgo._internal.reflect.Reflect_Value.Value, _parents:stdgo.Slice<stdgo.GoString>, _start:stdgo.Ref<stdgo._internal.encoding.xml.Xml_StartElement.StartElement>, _depth:stdgo.GoInt):{ var _0 : Bool; var _1 : stdgo.Error; } {
        ...
        var _t__pointer___0 = @:invalid_type null;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _finfo_3713605 = (stdgo.Go.setRef(_tinfo._fields[(_i_3713577 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.encoding.xml.Xml_T_fieldInfo.T_fieldInfo>);
                    if ((((_finfo_3713605._flags & (1 : stdgo._internal.encoding.xml.Xml_T_fieldFlags.T_fieldFlags) : stdgo._internal.encoding.xml.Xml_T_fieldFlags.T_fieldFlags) == ((0 : stdgo._internal.encoding.xml.Xml_T_fieldFlags.T_fieldFlags)) || ((_finfo_3713605._parents.length) < (_parents.length) : Bool) : Bool) || (_finfo_3713605._xmlns != (stdgo.Go.str()) && _finfo_3713605._xmlns != (_start.name.space) : Bool) : Bool)) {
                    ...
                    if (_parents[(_j_3713779 : stdgo.GoInt)] != (_finfo_3713605._parents[(_j_3713779 : stdgo.GoInt)])) {
                    ...
                    if (((_finfo_3713605._parents.length == (_parents.length)) && (_finfo_3713605._name == _start.name.local) : Bool)) {
                    ...
                    return {
                        final __tmp__:{ var _0 : Bool; var _1 : stdgo.Error; } = { _0 : true, _1 : _d._unmarshal(_finfo_3713605._value(_sv?.__copy__(), true)?.__copy__(), _start, (_depth + (1 : stdgo.GoInt) : stdgo.GoInt)) };
                    ...
                    if ((((_finfo_3713605._parents.length) > (_parents.length) : Bool) && (_finfo_3713605._parents[(_parents.length : stdgo.GoInt)] == _start.name.local) : Bool)) {
                    ...
                    _parents = (_finfo_3713605._parents.__slice__(0, ((_parents.length) + (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoString>);
                    _gotoNext = 3714476i32;
                } else if (__value__ == (3714472i32)) {
                    _i_3713577 = 0i32;
                    _gotoNext = 3714473i32;
                } else if (__value__ == (3714473i32)) {
                    if (_i_3713577 < (_tinfo._fields.length)) {
                    ...
                    _gotoNext = 3714818i32;
                    {
                        ...
                        if (stdgo.Go.typeEquals((__type__ : stdgo._internal.encoding.xml.Xml_StartElement.StartElement))) {
                            var _t__pointer___0:stdgo._internal.encoding.xml.Xml_StartElement.StartElement = __type__ == null ? ({} : stdgo._internal.encoding.xml.Xml_StartElement.StartElement) : __type__.__underlying__() == null ? ({} : stdgo._internal.encoding.xml.Xml_StartElement.StartElement) : __type__ == null ? ({} : stdgo._internal.encoding.xml.Xml_StartElement.StartElement) : __type__.__underlying__().value;
                            _t_3714862 = _t__pointer___0;
                            _gotoNext = 3714845i32;
                        } else if (stdgo.Go.typeEquals((__type__ : stdgo._internal.encoding.xml.Xml_EndElement.EndElement))) {
                            var _t__pointer___0:stdgo._internal.encoding.xml.Xml_EndElement.EndElement = __type__ == null ? ({} : stdgo._internal.encoding.xml.Xml_EndElement.EndElement) : __type__.__underlying__() == null ? ({} : stdgo._internal.encoding.xml.Xml_EndElement.EndElement) : __type__ == null ? ({} : stdgo._internal.encoding.xml.Xml_EndElement.EndElement) : __type__.__underlying__().value;
                            _t_3715235 = _t__pointer___0;
                            _gotoNext = 3715220i32;
                        } else {
                            var _t__pointer___0:stdgo._internal.encoding.xml.Xml_Token.Token = __type__?.__underlying__();
                            _gotoNext = 3715264i32;
                        };
                    };
                    _gotoNext = 3714729i32;
                } else if (__value__ == (3714845i32)) {
                    _t__pointer___0 = stdgo.Go.pointer(_t__pointer___0);
                    {
                        var __tmp__ = _d._unmarshalPath(_tinfo, _sv?.__copy__(), _parents, _t__pointer___0, _depth);
                        _consumed2_3715019 = __tmp__._0;
                        _err_3715030 = __tmp__._1;
                    };
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    {
                        var __tmp__ = _d.token();
                        _tok_3704558 = __tmp__._0;
                        _err_3704563 = __tmp__._1;
                    };
                    ...
                    {
                        {
                            ...
                            _t_3704625 = __tmp__._0?.__copy__();
                            _ok_3704628 = __tmp__._1;
                        };
                        if (_ok_3704628) {
                    ...
                    _t_3704625 = (stdgo.Go.setRef(_t_3704625) : stdgo.Ref<stdgo._internal.encoding.xml.Xml_StartElement.StartElement>)?.__copy__();
                    _start = _t_3704625;
                    _gotoNext = 3704786i32;
                    ...
                    return _d._unmarshalInterface((stdgo.Go.typeAssert((_pv_3705332.interface_() : stdgo._internal.encoding.xml.Xml_Unmarshaler.Unmarshaler)) : stdgo._internal.encoding.xml.Xml_Unmarshaler.Unmarshaler), _start);
                    _gotoNext = 3705492i32;
                    ...
                    return _d._unmarshalTextInterface((stdgo.Go.typeAssert((_pv_3705666.interface_() : stdgo._internal.encoding.Encoding_TextUnmarshaler.TextUnmarshaler)) : stdgo._internal.encoding.Encoding_TextUnmarshaler.TextUnmarshaler));
                    _gotoNext = 3705840i32;
                    ...
                    {
                        _err_3706678 = _d._unmarshal(_v_3706134.index(_n_3706590)?.__copy__(), _start, (_depth + (1 : stdgo.GoInt) : stdgo.GoInt));
                    ...
                    _v_3706134.set(stdgo._internal.reflect.Reflect_valueOf.valueOf(stdgo.Go.toInterface(_start.name))?.__copy__());
                    _gotoNext = 3709449i32;
                    ...
                    _sv_3706049 = _v_3706134?.__copy__();
                    {
                        ...
                        _tinfo_3706078 = __tmp__._0;
                        _err_3706103 = __tmp__._1;
                    };
                    ...
                    if ((_tinfo_3706078._xmlname != null && ((_tinfo_3706078._xmlname : Dynamic).__nil__ == null || !(_tinfo_3706078._xmlname : Dynamic).__nil__))) {
                        _gotoNext = 3707296i32;
                    } else {
                        _gotoNext = 3707949i32;
                    };
                } else if (__value__ == (3707296i32)) {
                    _finfo_3707301 = _tinfo_3706078._xmlname;
                    if (((_finfo_3707301._name != stdgo.Go.str()) && (_finfo_3707301._name != _start.name.local) : Bool)) {
                        _gotoNext = 3707381i32;
                    } else {
                        _gotoNext = 3707499i32;
                    };
                } else if (__value__ == (3707381i32)) {
                    return stdgo.Go.asInterface((((((("expected element type <" : stdgo.GoString) + _finfo_3707301._name?.__copy__() : stdgo.GoString) + ("> but have <" : stdgo.GoString)?.__copy__() : stdgo.GoString) + _start.name.local?.__copy__() : stdgo.GoString) + (">" : stdgo.GoString)?.__copy__() : stdgo.GoString) : stdgo._internal.encoding.xml.Xml_UnmarshalError.UnmarshalError));
                    _gotoNext = 3707499i32;
                } else if (__value__ == (3707499i32)) {
                    if (((_finfo_3707301._xmlns != stdgo.Go.str()) && (_finfo_3707301._xmlns != _start.name.space) : Bool)) {
                        _gotoNext = 3707555i32;
                    } else {
                        _gotoNext = 3707791i32;
                    };
                } else if (__value__ == (3707555i32)) {
                    _e_3707561 = ((((("expected element <" : stdgo.GoString) + _finfo_3707301._name?.__copy__() : stdgo.GoString) + ("> in name space " : stdgo.GoString)?.__copy__() : stdgo.GoString) + _finfo_3707301._xmlns?.__copy__() : stdgo.GoString) + (" but have " : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__();
                    ...
                    _gotoNext = 3707719i32;
                    _e_3707561 = (_e_3707561 + (_start.name.space)?.__copy__() : stdgo.GoString);
                    var __blank__ = 0i32;
                    _gotoNext = 3707758i32;
                    ...
                    _fv_3707791 = _finfo_3707301._value(_sv_3706049?.__copy__(), true)?.__copy__();
                    {
                        {
                            var __tmp__ = try {
                    ...
                    _fv_3707791.set(stdgo._internal.reflect.Reflect_valueOf.valueOf(stdgo.Go.toInterface(_start.name))?.__copy__());
                    _gotoNext = 3707949i32;
                    ...
                    _a_3707956 = _start.attr[(_i_3707961_0 : stdgo.GoInt)];
                    _handled_3707983 = false;
                    _any_3708003 = (-1 : stdgo.GoInt);
                    if ((0i32 : stdgo.GoInt) < (_tinfo_3706078._fields.length)) {
                    ...
                    _finfo_3708050 = (stdgo.Go.setRef(_tinfo_3706078._fields[(_i_3708020 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.encoding.xml.Xml_T_fieldInfo.T_fieldInfo>);
                    _gotoNext = 3708080i32;
                } else if (__value__ == (3708080i32)) {
                    {
                        final __value__ = (_finfo_3708050._flags & (127 : stdgo._internal.encoding.xml.Xml_T_fieldFlags.T_fieldFlags) : stdgo._internal.encoding.xml.Xml_T_fieldFlags.T_fieldFlags);
                    ...
                    _strv_3708130 = _finfo_3708050._value(_sv_3706049?.__copy__(), true)?.__copy__();
                    if (((_a_3707956.name.local == _finfo_3708050._name) && (((_finfo_3708050._xmlns == stdgo.Go.str()) || (_finfo_3708050._xmlns == _a_3707956.name.space) : Bool)) : Bool)) {
                    ...
                    {
                        _err_3708271 = _d._unmarshalAttr(_strv_3708130?.__copy__(), _a_3707956?.__copy__());
                    ...
                    if (_i_3708020 < (_tinfo_3706078._fields.length)) {
                    ...
                    _finfo_3708480 = (stdgo.Go.setRef(_tinfo_3706078._fields[(_any_3708003 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.encoding.xml.Xml_T_fieldInfo.T_fieldInfo>);
                    _strv_3708512 = _finfo_3708480._value(_sv_3706049?.__copy__(), true)?.__copy__();
                    {
                        _err_3708560 = _d._unmarshalAttr(_strv_3708512?.__copy__(), _a_3707956?.__copy__());
                    ...
                    if (_i_3707961_0 < (_start.attr.length)) {
                    ...
                    _finfo_3708740 = (stdgo.Go.setRef(_tinfo_3706078._fields[(_i_3708711 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.encoding.xml.Xml_T_fieldInfo.T_fieldInfo>);
                    _gotoNext = 3708769i32;
                } else if (__value__ == (3708769i32)) {
                    {
                        final __value__ = (_finfo_3708740._flags & (127 : stdgo._internal.encoding.xml.Xml_T_fieldFlags.T_fieldFlags) : stdgo._internal.encoding.xml.Xml_T_fieldFlags.T_fieldFlags);
                    ...
                    _saveData_3705870 = _finfo_3708740._value(_sv_3706049?.__copy__(), true)?.__copy__();
                    _gotoNext = 3708711i32;
                    ...
                    _saveComment_3705921 = _finfo_3708740._value(_sv_3706049?.__copy__(), true)?.__copy__();
                    _gotoNext = 3708711i32;
                    ...
                    _saveAny_3706020 = _finfo_3708740._value(_sv_3706049?.__copy__(), true)?.__copy__();
                    _gotoNext = 3708711i32;
                    ...
                    _saveXML_3705950 = _finfo_3708740._value(_sv_3706049?.__copy__(), true)?.__copy__();
                    ...
                    _gotoNext = 3709322i32;
                    _saveXMLIndex_3705979 = _d._savedOffset();
                    var __blank__ = 0i32;
                    _gotoNext = 3708711i32;
                    ...
                    if (_i_3708711 < (_tinfo_3706078._fields.length)) {
                    ...
                    _savedOffset_3709468 = _d._savedOffset();
                    _gotoNext = 3709548i32;
                } else if (__value__ == (3709548i32)) {
                    {
                        var __tmp__ = _d.token();
                        _tok_3709548 = __tmp__._0;
                        _err_3709553 = __tmp__._1;
                    };
                    ...
                    _gotoNext = 3709608i32;
                    {
                        ...
                        if (stdgo.Go.typeEquals((__type__ : stdgo._internal.encoding.xml.Xml_StartElement.StartElement))) {
                            var _t__pointer___0:stdgo._internal.encoding.xml.Xml_StartElement.StartElement = __type__ == null ? ({} : stdgo._internal.encoding.xml.Xml_StartElement.StartElement) : __type__.__underlying__() == null ? ({} : stdgo._internal.encoding.xml.Xml_StartElement.StartElement) : __type__ == null ? ({} : stdgo._internal.encoding.xml.Xml_StartElement.StartElement) : __type__.__underlying__().value;
                            _t_3709652 = _t__pointer___0;
                            _gotoNext = 3709635i32;
                        } else if (stdgo.Go.typeEquals((__type__ : stdgo._internal.encoding.xml.Xml_EndElement.EndElement))) {
                            var _t__pointer___0:stdgo._internal.encoding.xml.Xml_EndElement.EndElement = __type__ == null ? ({} : stdgo._internal.encoding.xml.Xml_EndElement.EndElement) : __type__.__underlying__() == null ? ({} : stdgo._internal.encoding.xml.Xml_EndElement.EndElement) : __type__ == null ? ({} : stdgo._internal.encoding.xml.Xml_EndElement.EndElement) : __type__.__underlying__().value;
                            _t_3710209 = _t__pointer___0;
                    ...
                    {
                        var __tmp__ = _d._unmarshalPath(_tinfo_3706078, _sv_3706049?.__copy__(), (null : stdgo.Slice<stdgo.GoString>), _t__pointer___0, _depth);
                        _consumed_3709657 = __tmp__._0;
                        _err_3709553 = __tmp__._1;
                    };
                    if (_err_3709553 != null) {
                    ...
                    {
                        _err_3710019 = _d._unmarshal(_saveAny_3706020?.__copy__(), _t__pointer___0, (_depth + (1 : stdgo.GoInt) : stdgo.GoInt));
                    ...
                    _saveXMLData_3705998 = (_d._saved.bytes().__slice__(_saveXMLIndex_3705979, _savedOffset_3709468) : stdgo.Slice<stdgo.GoUInt8>);
                    ...
                    _data_3705848 = (_data_3705848.__append__(...(_t__pointer___0 : Array<stdgo.GoUInt8>)));
                    _gotoNext = 0i32;
                    ...
                    _comment_3705899 = (_comment_3705899.__append__(...(_t__pointer___0 : Array<stdgo.GoUInt8>)));
                    _gotoNext = 0i32;
