...
@:keep @:allow(stdgo._internal.encoding.xml.Xml.Decoder_asInterface) class Decoder_static_extension {
    ...
    static public function _unmarshal( _d:stdgo.Ref<stdgo._internal.encoding.xml.Xml_Decoder.Decoder>, _val:stdgo._internal.reflect.Reflect_Value.Value, _start:stdgo.Ref<stdgo._internal.encoding.xml.Xml_StartElement.StartElement>, _depth:stdgo.GoInt):stdgo.Error {
        ...
        var _i_3659768_0:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _a_3659775 = _start.attr[(_i_3659768_0 : stdgo.GoInt)];
                ...
                } else if (__value__ == (3660453i32)) {
                    {
                        ...
                        _i_3659768_0 = __tmp__0;
                        _a_3659775 = __tmp__1;
                    };
                    _gotoNext = 3660454i32;
                } else if (__value__ == (3660454i32)) {
                    if (_i_3659768_0 < (_start.attr.length)) {
                ...
                } else if (__value__ == (3661427i32)) {
                    {
                        ...
                        if (stdgo.Go.typeEquals((__type__ : stdgo._internal.encoding.xml.Xml_StartElement.StartElement))) {
                            ...
                            if (stdgo._internal.encoding.xml.Xml__sv._sv.isValid()) {
                                {
                                    var __tmp__ = _d._unmarshalPath(stdgo._internal.encoding.xml.Xml__tinfo._tinfo, stdgo._internal.encoding.xml.Xml__sv._sv?.__copy__(), (null : stdgo.Slice<stdgo.GoString>), (stdgo.Go.setRef(_t) : stdgo.Ref<stdgo._internal.encoding.xml.Xml_StartElement.StartElement>), _depth);
                                    _consumed = __tmp__._0;
                                    stdgo._internal.encoding.xml.Xml__err._err = __tmp__._1;
                                };
                                if (stdgo._internal.encoding.xml.Xml__err._err != null) {
                                    return stdgo._internal.encoding.xml.Xml__err._err;
                                };
                            };
                        } else if (stdgo.Go.typeEquals((__type__ : stdgo._internal.encoding.xml.Xml_EndElement.EndElement))) {
                            var _t:stdgo._internal.encoding.xml.Xml_EndElement.EndElement = __type__ == null ? ({} : stdgo._internal.encoding.xml.Xml_EndElement.EndElement) : __type__.__underlying__() == null ? ({} : stdgo._internal.encoding.xml.Xml_EndElement.EndElement) : __type__ == null ? ({} : stdgo._internal.encoding.xml.Xml_EndElement.EndElement) : __type__.__underlying__().value;
                            if (stdgo._internal.encoding.xml.Xml__saveXML._saveXML.isValid()) {
                                stdgo._internal.encoding.xml.Xml__saveXMLData._saveXMLData = (_d._saved.bytes().__slice__(stdgo._internal.encoding.xml.Xml__saveXMLIndex._saveXMLIndex, stdgo._internal.encoding.xml.Xml__savedOffset._savedOffset) : stdgo.Slice<stdgo.GoUInt8>);
                                if (stdgo._internal.encoding.xml.Xml__saveXMLIndex._saveXMLIndex == ((0 : stdgo.GoInt))) {
                                    _d._saved = null;
                                };
                            };
                            ...
                            if (stdgo._internal.encoding.xml.Xml__saveData._saveData.isValid()) {
                                stdgo._internal.encoding.xml.Xml__data._data = (stdgo._internal.encoding.xml.Xml__data._data.__append__(...(_t : Array<stdgo.GoUInt8>)));
                            };
                            ...
                            if (stdgo._internal.encoding.xml.Xml__saveComment._saveComment.isValid()) {
                                stdgo._internal.encoding.xml.Xml__comment._comment = (stdgo._internal.encoding.xml.Xml__comment._comment.__append__(...(_t : Array<stdgo.GoUInt8>)));
                            };
                        };
                    };
                    _gotoNext = 3661275i32;
