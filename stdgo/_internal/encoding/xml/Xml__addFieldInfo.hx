        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _oldf_3651551 = (stdgo.Go.setRef(_tinfo._fields[(_i_3651523 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.encoding.xml.Xml_T_fieldInfo.T_fieldInfo>);
                    if ((_oldf_3651551._flags & (127 : stdgo._internal.encoding.xml.Xml_T_fieldFlags.T_fieldFlags) : stdgo._internal.encoding.xml.Xml_T_fieldFlags.T_fieldFlags) != ((_newf._flags & (127 : stdgo._internal.encoding.xml.Xml_T_fieldFlags.T_fieldFlags) : stdgo._internal.encoding.xml.Xml_T_fieldFlags.T_fieldFlags))) {
                    ...
                    if (((_oldf_3651551._xmlns != (stdgo.Go.str()) && _newf._xmlns != (stdgo.Go.str()) : Bool) && (_oldf_3651551._xmlns != _newf._xmlns) : Bool)) {
                    ...
                    _minl_3651726 = stdgo._internal.encoding.xml.Xml__min._min((_newf._parents.length), (_oldf_3651551._parents.length));
                    ...
                    if (_oldf_3651551._parents[(_p_3651782 : stdgo.GoInt)] != (_newf._parents[(_p_3651782 : stdgo.GoInt)])) {
                    ...
                    if (((_oldf_3651551._parents.length) > (_newf._parents.length) : Bool)) {
                        _gotoNext = 3651919i32;
                    } else if (((_oldf_3651551._parents.length) < (_newf._parents.length) : Bool)) {
                        _gotoNext = 3652066i32;
                    } else {
                        _gotoNext = 3652172i32;
                    };
                } else if (__value__ == (3651919i32)) {
                    if (_oldf_3651551._parents[(_newf._parents.length : stdgo.GoInt)] == (_newf._name)) {
                    ...
                    if (_newf._parents[(_oldf_3651551._parents.length : stdgo.GoInt)] == (_oldf_3651551._name)) {
                    ...
                    _gotoNext = 3652172i32;
                    if (((_newf._name == _oldf_3651551._name) && (_newf._xmlns == _oldf_3651551._xmlns) : Bool)) {
                    ...
                    if (_i_3651523 < (_tinfo._fields.length)) {
                    ...
                    if (((_tinfo._fields[(_i_3652539 : stdgo.GoInt)]._idx.length) < (_newf._idx.length) : Bool)) {
                    ...
                    _oldf_3652738 = (stdgo.Go.setRef(_tinfo._fields[(_i_3652713 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.encoding.xml.Xml_T_fieldInfo.T_fieldInfo>);
                    if ((_oldf_3652738._idx.length) == ((_newf._idx.length))) {
                        _gotoNext = 3652799i32;
                    } else {
                        _gotoNext = 3652710i32;
                    };
                } else if (__value__ == (3652799i32)) {
                    _f1_3652804 = _typ.fieldByIndex(_oldf_3652738._idx)?.__copy__();
                    _f2_3652840 = _typ.fieldByIndex(_newf._idx)?.__copy__();
                    ...
                    stdgo.Go.copySlice((_tinfo._fields.__slice__(_i_3653152) : stdgo.Slice<stdgo._internal.encoding.xml.Xml_T_fieldInfo.T_fieldInfo>), (_tinfo._fields.__slice__((_i_3653152 + (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.encoding.xml.Xml_T_fieldInfo.T_fieldInfo>));
