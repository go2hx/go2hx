...
function copyToken(_t:stdgo._internal.encoding.xml.Xml_token.Token):stdgo._internal.encoding.xml.Xml_token.Token {
        //"file:///home/runner/.go/go1.21.3/src/encoding/xml/xml.go#L114"
        {
            final __type__ = _t;
            if (stdgo.Go.typeEquals((__type__ : stdgo._internal.encoding.xml.Xml_chardata.CharData))) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/xml/xml.go#L116"
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/xml/xml.go#L118"
                return stdgo.Go.toInterface(stdgo.Go.asInterface(_v.copy()));
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/xml/xml.go#L120"
                return stdgo.Go.toInterface(stdgo.Go.asInterface(_v.copy()));
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/xml/xml.go#L122"
                return stdgo.Go.toInterface(stdgo.Go.asInterface(_v.copy()));
                ...
                //"file:///home/runner/.go/go1.21.3/src/encoding/xml/xml.go#L124"
                return stdgo.Go.toInterface(stdgo.Go.asInterface(_v.copy()));
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/encoding/xml/xml.go#L126"
        return _t;
    }
