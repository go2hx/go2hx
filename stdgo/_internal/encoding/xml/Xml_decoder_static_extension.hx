...
@:keep @:allow(stdgo._internal.encoding.xml.Xml.Decoder_asInterface) class Decoder_static_extension {
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                ...
                } else if (__value__ == (3701693i32)) {
                    {
                        ...
                        _b_3701697 = @:tmpset0 __tmp__._0;
                        _ok_3701700 = @:tmpset0 __tmp__._1;
                    };
                    if (!_ok_3701700) {
                    ...
                    _before_3702719 = @:check2 (@:checkr _d ?? throw "null pointer dereference")._buf.len();
                    @:check2 (@:checkr _d ?? throw "null pointer dereference")._buf.writeByte((38 : stdgo.GoUInt8));
                    {
                        {
                            var __tmp__ = @:check2r _d._mustgetc();
                            _b_3701697 = @:tmpset0 __tmp__._0;
                            _ok_3702772 = @:tmpset0 __tmp__._1;
                        };
                        if (!_ok_3702772) {
                    ...
                    @:check2 (@:checkr _d ?? throw "null pointer dereference")._buf.writeByte(_b_3701697);
                    {
                        {
                            var __tmp__ = @:check2r _d._mustgetc();
                            _b_3701697 = @:tmpset0 __tmp__._0;
                    ...
                    _start_3703113 = @:check2 (@:checkr _d ?? throw "null pointer dereference")._buf.len();
                    var __blank__ = 0i32;
                    ...
                    @:check2r _d._ungetc(_b_3701697);
                    _gotoNext = 3704111i32;
                } else if (__value__ == (3703387i32)) {
                    _gotoNext = 3703387i32;
                    _s_3703394 = ((@:check2 (@:checkr _d ?? throw "null pointer dereference")._buf.bytes().__slice__(_start_3703113) : stdgo.Slice<stdgo.GoUInt8>) : stdgo.GoString)?.__copy__();
                    @:check2 (@:checkr _d ?? throw "null pointer dereference")._buf.writeByte((59 : stdgo.GoUInt8));
                    {
                        ...
                        _n_3703460 = @:tmpset0 __tmp__._0;
                        _err_3703463 = @:tmpset0 __tmp__._1;
                    };
                    ...
                    _gotoNext = 3703817i32;
                    _name_3703824 = (@:check2 (@:checkr _d ?? throw "null pointer dereference")._buf.bytes().__slice__((_before_3702719 + (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>);
                    @:check2 (@:checkr _d ?? throw "null pointer dereference")._buf.writeByte((59 : stdgo.GoUInt8));
                    ...
                    {
                        {
                            var __tmp__ = (stdgo._internal.encoding.xml.Xml__entity._entity != null && stdgo._internal.encoding.xml.Xml__entity._entity.__exists__(_s_3703912?.__copy__()) ? { _0 : stdgo._internal.encoding.xml.Xml__entity._entity[_s_3703912?.__copy__()], _1 : true } : { _0 : (0 : stdgo.GoInt32), _1 : false });
                            _r_3703939 = @:tmpset0 __tmp__._0;
                            _ok_3703942 = @:tmpset0 __tmp__._1;
                        };
                        if (_ok_3703942) {
                    ...
                    {
                        var __tmp__ = ((@:checkr _d ?? throw "null pointer dereference").entity != null && (@:checkr _d ?? throw "null pointer dereference").entity.__exists__(_s_3703912?.__copy__()) ? { _0 : (@:checkr _d ?? throw "null pointer dereference").entity[_s_3703912?.__copy__()], _1 : true } : { _0 : ("" : stdgo.GoString), _1 : false });
                        _text_3702787 = @:tmpset0 __tmp__._0?.__copy__();
                        _haveText_3702806 = @:tmpset0 __tmp__._1;
                    };
                    _gotoNext = 3704111i32;
                    ...
                    @:check2 (@:checkr _d ?? throw "null pointer dereference")._buf.truncate(_before_3702719);
                    @:check2 (@:checkr _d ?? throw "null pointer dereference")._buf.writeString(_text_3702787?.__copy__());
                    {
                    ...
                    _ent_3704285 = ((@:check2 (@:checkr _d ?? throw "null pointer dereference")._buf.bytes().__slice__(_before_3702719) : stdgo.Slice<stdgo.GoUInt8>) : stdgo.GoString)?.__copy__();
                    ...
                    (@:checkr _d ?? throw "null pointer dereference")._err = @:check2r _d._syntaxError((("invalid character entity " : stdgo.GoString) + _ent_3704285?.__copy__() : stdgo.GoString)?.__copy__());
                    return (null : stdgo.Slice<stdgo.GoUInt8>);
                    _gotoNext = 3704521i32;
                    ...
                    _data_3704696 = @:check2 (@:checkr _d ?? throw "null pointer dereference")._buf.bytes();
                ...
                } else if (__value__ == (3704840i32)) {
                    {
                        ...
                        _r_3704844 = @:tmpset0 __tmp__._0;
                        _size_3704847 = @:tmpset0 __tmp__._1;
                    };
                    ...
                    (@:checkr _d ?? throw "null pointer dereference")._err = @:check2r _d._syntaxError(stdgo._internal.fmt.Fmt_sprintf.sprintf(("illegal character code %U" : stdgo.GoString), stdgo.Go.toInterface(_r_3704844))?.__copy__());
                    return (null : stdgo.Slice<stdgo.GoUInt8>);
                    _gotoNext = 3704823i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    {
                        var __tmp__ = @:check2r _d._getc();
                        _b_3692581 = @:tmpset0 __tmp__._0;
                        _ok_3692584 = @:tmpset0 __tmp__._1;
                    };
                    if (!_ok_3692584) {
                    ...
                    @:check2r _d._ungetc(_b_3692581);
                    _data_3692683 = @:check2r _d._text((-1 : stdgo.GoInt), false);
                    ...
                    {
                        {
                            ...
                            _name_3692891 = @:tmpset0 __tmp__._0?.__copy__();
                            _ok_3692584 = @:tmpset0 __tmp__._1;
                        };
                        if (!_ok_3692584) {
                    ...
                    (@:checkr _d ?? throw "null pointer dereference")._err = @:check2r _d._syntaxError(((("invalid characters between </" : stdgo.GoString) + _name_3692891.local?.__copy__() : stdgo.GoString) + (" and >" : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__());
                    return { _0 : (null : stdgo._internal.encoding.xml.Xml_token.Token), _1 : (@:checkr _d ?? throw "null pointer dereference")._err };
                    _gotoNext = 3693241i32;
                } else if (__value__ == (3693241i32)) {
                    return { _0 : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo._internal.encoding.xml.Xml_endelement.EndElement(_name_3692891?.__copy__()) : stdgo._internal.encoding.xml.Xml_endelement.EndElement))), _1 : (null : stdgo.Error) };
                    _gotoNext = 3697409i32;
                } else if (__value__ == (3693272i32)) {
                    {
                        {
                            var __tmp__ = @:check2r _d._name();
                            _target_3693321 = @:tmpset0 __tmp__._0?.__copy__();
                            _ok_3692584 = @:tmpset0 __tmp__._1;
                        };
                        if (!_ok_3692584) {
                    ...
                    @:check2 (@:checkr _d ?? throw "null pointer dereference")._buf.writeByte(_b_3692581);
                    ...
                    _data_3693673 = @:check2 (@:checkr _d ?? throw "null pointer dereference")._buf.bytes();
                    ...
                    if (((_ver_3693791 != (stdgo.Go.str() : stdgo.GoString)) && (_ver_3693791 != ("1.0" : stdgo.GoString)) : Bool)) {
                        _gotoNext = 3693859i32;
                    } else {
                        _gotoNext = 3693981i32;
                    };
                } else if (__value__ == (3693859i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._err = stdgo._internal.fmt.Fmt_errorf.errorf(("xml: unsupported version %q; only version 1.0 is supported" : stdgo.GoString), stdgo.Go.toInterface(_ver_3693791));
                    return { _0 : (null : stdgo._internal.encoding.xml.Xml_token.Token), _1 : (@:checkr _d ?? throw "null pointer dereference")._err };
                    _gotoNext = 3693981i32;
                    ...
                    if ((((_enc_3693981 != ((stdgo.Go.str() : stdgo.GoString)) && _enc_3693981 != (("utf-8" : stdgo.GoString)) : Bool) && _enc_3693981 != (("UTF-8" : stdgo.GoString)) : Bool) && !stdgo._internal.strings.Strings_equalfold.equalFold(_enc_3693981?.__copy__(), ("utf-8" : stdgo.GoString)) : Bool)) {
                    ...
                    (@:checkr _d ?? throw "null pointer dereference")._err = stdgo._internal.fmt.Fmt_errorf.errorf(("xml: encoding %q declared but Decoder.CharsetReader is nil" : stdgo.GoString), stdgo.Go.toInterface(_enc_3693981));
                    return { _0 : (null : stdgo._internal.encoding.xml.Xml_token.Token), _1 : (@:checkr _d ?? throw "null pointer dereference")._err };
                    _gotoNext = 3694264i32;
                } else if (__value__ == (3694264i32)) {
                    {
                        var __tmp__ = (@:checkr _d ?? throw "null pointer dereference").charsetReader(_enc_3693981?.__copy__(), (stdgo.Go.typeAssert((stdgo.Go.toInterface((@:checkr _d ?? throw "null pointer dereference")._r) : stdgo._internal.io.Io_reader.Reader)) : stdgo._internal.io.Io_reader.Reader));
                        _newr_3694264 = @:tmpset0 __tmp__._0;
                        _err_3694270 = @:tmpset0 __tmp__._1;
                    };
                    ...
                    (@:checkr _d ?? throw "null pointer dereference")._err = stdgo._internal.fmt.Fmt_errorf.errorf(("xml: opening charset %q: %w" : stdgo.GoString), stdgo.Go.toInterface(_enc_3693981), stdgo.Go.toInterface(_err_3694270));
                    return { _0 : (null : stdgo._internal.encoding.xml.Xml_token.Token), _1 : (@:checkr _d ?? throw "null pointer dereference")._err };
                    _gotoNext = 3694433i32;
                    ...
                    @:check2r _d._switchToReader(_newr_3694264);
                    _gotoNext = 3694563i32;
                    ...
                    _data_3695314 = @:check2 (@:checkr _d ?? throw "null pointer dereference")._buf.bytes();
                    ...
                    if (_b_3692581 != ((("CDATA[" : stdgo.GoString) : stdgo.GoString)[(_i_3695462 : stdgo.GoInt)])) {
                    ...
                    _data_3695705 = @:check2r _d._text((-1 : stdgo.GoInt), true);
                    ...
                    @:check2 (@:checkr _d ?? throw "null pointer dereference")._buf.writeByte(_s_3696493[(_j_3696635 : stdgo.GoInt)]);
                    _j_3696635++;
                    _gotoNext = 3696631i32;
                    ...
                    @:check2r _d._ungetc(_b_3692581);
                    {
                        {
                            var __tmp__ = @:check2r _d._nsname();
                            _name_3697431 = @:tmpset0 __tmp__._0?.__copy__();
                            _ok_3692584 = @:tmpset0 __tmp__._1;
                        };
                        if (!_ok_3692584) {
                    ...
                    _a_3697954 = (new stdgo._internal.encoding.xml.Xml_attr.Attr() : stdgo._internal.encoding.xml.Xml_attr.Attr);
                    {
                        {
                            var __tmp__ = @:check2r _d._nsname();
                            _a_3697954.name = @:tmpset0 __tmp__._0?.__copy__();
                            _ok_3692584 = @:tmpset0 __tmp__._1;
                        };
                        if (!_ok_3692584) {
                    ...
                    _gotoNext = 3698362i32;
                    @:check2r _d._space();
                    _data_3698380 = @:check2r _d._attrval();
                    ...
                    (@:checkr _d ?? throw "null pointer dereference")._toClose = _name_3697431?.__copy__();
                    _gotoNext = 3698561i32;
    ...
    static public function _unmarshal( _d:stdgo.Ref<stdgo._internal.encoding.xml.Xml_decoder.Decoder>, _val:stdgo._internal.reflect.Reflect_value.Value, _start:stdgo.Ref<stdgo._internal.encoding.xml.Xml_startelement.StartElement>, _depth:stdgo.GoInt):stdgo.Error {
        ...
        var _t_3662203:stdgo._internal.encoding.xml.Xml_chardata.CharData = (new stdgo._internal.encoding.xml.Xml_chardata.CharData(0, 0) : stdgo._internal.encoding.xml.Xml_chardata.CharData);
        ...
        var _t_3662282:stdgo._internal.encoding.xml.Xml_comment.Comment = (new stdgo._internal.encoding.xml.Xml_comment.Comment(0, 0) : stdgo._internal.encoding.xml.Xml_comment.Comment);
