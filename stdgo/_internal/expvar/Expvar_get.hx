...
function get(_name:stdgo.GoString):stdgo._internal.expvar.Expvar_var.Var {
        var __tmp__ = @:check2 stdgo._internal.expvar.Expvar__vars._vars.load(stdgo.Go.toInterface(_name)), _i:stdgo.AnyInterface = __tmp__._0, __4:Bool = __tmp__._1;
        var __tmp__ = try {
