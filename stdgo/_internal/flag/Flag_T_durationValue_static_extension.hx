...
@:keep @:allow(stdgo._internal.flag.Flag.T_durationValue_asInterface) class T_durationValue_static_extension {
    @:keep
    @:pointer
    static public function string(____:stdgo._internal.flag.Flag_T_durationValue.T_durationValue,  _d:stdgo.Pointer<stdgo._internal.flag.Flag_T_durationValue.T_durationValue>):stdgo.GoString {
    ...
    @:keep
    @:pointer
    static public function get(____:stdgo._internal.flag.Flag_T_durationValue.T_durationValue,  _d:stdgo.Pointer<stdgo._internal.flag.Flag_T_durationValue.T_durationValue>):stdgo.AnyInterface {
        return stdgo.Go.toInterface(stdgo.Go.asInterface((_d.value : stdgo._internal.time.Time_Duration.Duration)));
    }
    @:keep
    @:pointer
    static public function set(____:stdgo._internal.flag.Flag_T_durationValue.T_durationValue,  _d:stdgo.Pointer<stdgo._internal.flag.Flag_T_durationValue.T_durationValue>, _s:stdgo.GoString):stdgo.Error {
