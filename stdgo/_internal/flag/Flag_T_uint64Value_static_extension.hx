...
@:keep @:allow(stdgo._internal.flag.Flag.T_uint64Value_asInterface) class T_uint64Value_static_extension {
    @:keep
    @:pointer
    static public function string(____:stdgo._internal.flag.Flag_T_uint64Value.T_uint64Value,  _i:stdgo.Pointer<stdgo._internal.flag.Flag_T_uint64Value.T_uint64Value>):stdgo.GoString {
        return stdgo._internal.strconv.Strconv_formatUint.formatUint((_i.value : stdgo.GoUInt64), (10 : stdgo.GoInt))?.__copy__();
    }
    @:keep
    @:pointer
    static public function get(____:stdgo._internal.flag.Flag_T_uint64Value.T_uint64Value,  _i:stdgo.Pointer<stdgo._internal.flag.Flag_T_uint64Value.T_uint64Value>):stdgo.AnyInterface {
        return stdgo.Go.toInterface((_i.value : stdgo.GoUInt64));
    }
    @:keep
    @:pointer
    static public function set(____:stdgo._internal.flag.Flag_T_uint64Value.T_uint64Value,  _i:stdgo.Pointer<stdgo._internal.flag.Flag_T_uint64Value.T_uint64Value>, _s:stdgo.GoString):stdgo.Error {
