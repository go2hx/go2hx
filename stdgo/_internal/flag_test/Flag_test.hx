...
function testExitCode(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _tests = (new stdgo.Slice<T__struct_0>(5, 5, ...[({ _flag : ("-h" : stdgo.GoString), _flagHandle : ("" : stdgo.GoString), _expectExit : (0 : stdgo.GoInt) } : T__struct_0), ({ _flag : ("-help" : stdgo.GoString), _flagHandle : ("" : stdgo.GoString), _expectExit : (0 : stdgo.GoInt) } : T__struct_0), ({ _flag : ("-undefined" : stdgo.GoString), _flagHandle : ("" : stdgo.GoString), _expectExit : (2 : stdgo.GoInt) } : T__struct_0), ({ _flag : ("-h" : stdgo.GoString), _flagHandle : ("h" : stdgo.GoString), _expectExit : _magic } : T__struct_0), ({ _flag : ("-help" : stdgo.GoString), _flagHandle : ("help" : stdgo.GoString), _expectExit : _magic } : T__struct_0)].concat([for (i in 5 ... (5 > 5 ? 5 : 5 : stdgo.GoInt).toBasic()) ({ _flag : ("" : stdgo.GoString), _flagHandle : ("" : stdgo.GoString), _expectExit : (0 : stdgo.GoInt) } : T__struct_0)])) : stdgo.Slice<T__struct_0>);
