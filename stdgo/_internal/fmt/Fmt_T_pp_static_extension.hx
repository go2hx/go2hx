...
@:keep @:allow(stdgo._internal.fmt.Fmt.T_pp_asInterface) class T_pp_static_extension {
    ...
    static public function _doPrintf( _p:stdgo.Ref<stdgo._internal.fmt.Fmt_T_pp.T_pp>, _format:stdgo.GoString, _a:stdgo.Slice<stdgo.AnyInterface>):Void {
        @:recv var _p:stdgo.Ref<stdgo._internal.fmt.Fmt_T_pp.T_pp> = _p;
        var _size_4017056:stdgo.GoInt = (0 : stdgo.GoInt);
        var _verb_4017050:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _lasti_4014182:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_4014139:stdgo.GoInt = (0 : stdgo.GoInt);
        var _end_4013940:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_4018063:stdgo.GoInt = (0 : stdgo.GoInt);
        var _c_4014479:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _simpleFormatBreak = false;
        var _formatLoopBreak = false;
        var _afterIndex_4014031:Bool = false;
        var _argNum_4013960:stdgo.GoInt = (0 : stdgo.GoInt);
        var _arg_4018066:stdgo.AnyInterface = (null : stdgo.AnyInterface);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _end_4013940 = (_format.length);
                    _argNum_4013960 = (0 : stdgo.GoInt);
                    _afterIndex_4014031 = false;
                    (@:checkr _p ?? throw "null pointer dereference")._reordered = false;
                    _gotoNext = 4014122i32;
                } else if (__value__ == (4014122i32)) {
                    _i_4014139 = (0 : stdgo.GoInt);
                    _formatLoopBreak = false;
                    _gotoNext = 4014135i32;
                } else if (__value__ == (4014135i32)) {
                    if (!_formatLoopBreak && ((_i_4014139 < _end_4013940 : Bool))) {
                        _gotoNext = 4014156i32;
                    } else {
                        _gotoNext = 4017966i32;
                    };
                } else if (__value__ == (4014156i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = true;
                    _lasti_4014182 = _i_4014139;
                    var __blank__ = 0i32;
                    _gotoNext = 4014195i32;
                } else if (__value__ == (4014195i32)) {
                    if (((_i_4014139 < _end_4013940 : Bool) && (_format[(_i_4014139 : stdgo.GoInt)] != (37 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4014227i32;
                    } else {
                        _gotoNext = 4014242i32;
                    };
                } else if (__value__ == (4014227i32)) {
                    _i_4014139++;
                    _gotoNext = 4014195i32;
                } else if (__value__ == (4014242i32)) {
                    if ((_i_4014139 > _lasti_4014182 : Bool)) {
                        _gotoNext = 4014255i32;
                    } else {
                        _gotoNext = 4014301i32;
                    };
                } else if (__value__ == (4014255i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString((_format.__slice__(_lasti_4014182, _i_4014139) : stdgo.GoString)?.__copy__());
                    _gotoNext = 4014301i32;
                } else if (__value__ == (4014301i32)) {
                    if ((_i_4014139 >= _end_4013940 : Bool)) {
                        _gotoNext = 4014313i32;
                    } else {
                        _gotoNext = 4014389i32;
                    };
                } else if (__value__ == (4014313i32)) {
                    _gotoNext = 4017966i32;
                } else if (__value__ == (4014389i32)) {
                    _i_4014139++;
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._fmt._clearflags();
                    _gotoNext = 4014439i32;
                } else if (__value__ == (4014439i32)) {
                    var __blank__ = 0i32;
                    _simpleFormatBreak = false;
                    _gotoNext = 4014455i32;
                } else if (__value__ == (4014455i32)) {
                    if (!_simpleFormatBreak && ((_i_4014139 < _end_4013940 : Bool))) {
                        _gotoNext = 4014474i32;
                    } else {
                        _gotoNext = 4015509i32;
                    };
                } else if (__value__ == (4014470i32)) {
                    _i_4014139++;
                    _gotoNext = 4014455i32;
                } else if (__value__ == (4014474i32)) {
                    _c_4014479 = _format[(_i_4014139 : stdgo.GoInt)];
                    _gotoNext = 4014497i32;
                } else if (__value__ == (4014497i32)) {
                    {
                        final __value__ = _c_4014479;
                        if (__value__ == ((35 : stdgo.GoUInt8))) {
                            _gotoNext = 4014511i32;
                        } else if (__value__ == ((48 : stdgo.GoUInt8))) {
                            _gotoNext = 4014547i32;
                        } else if (__value__ == ((43 : stdgo.GoUInt8))) {
                            _gotoNext = 4014630i32;
                        } else if (__value__ == ((45 : stdgo.GoUInt8))) {
                            _gotoNext = 4014665i32;
                        } else if (__value__ == ((32 : stdgo.GoUInt8))) {
                            _gotoNext = 4014763i32;
                        } else {
                            _gotoNext = 4014799i32;
                        };
                    };
                } else if (__value__ == (4014511i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._sharp = true;
                    _gotoNext = 4014470i32;
                } else if (__value__ == (4014547i32)) {
                    ...
                    _gotoNext = 4014470i32;
                } else if (__value__ == (4014763i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._space = true;
                    _gotoNext = 4014470i32;
                } else if (__value__ == (4014799i32)) {
                    if (((((97 : stdgo.GoUInt8) <= _c_4014479 : Bool) && (_c_4014479 <= (122 : stdgo.GoUInt8) : Bool) : Bool) && (_argNum_4013960 < (_a.length) : Bool) : Bool)) {
                        _gotoNext = 4014976i32;
                    } else {
                        _gotoNext = 4015434i32;
                    };
                } else if (__value__ == (4014976i32)) {
                    _gotoNext = 4014983i32;
                } else if (__value__ == (4014983i32)) {
                    {
                        final __value__ = _c_4014479;
                        if (__value__ == ((119 : stdgo.GoUInt8))) {
                            _gotoNext = 4014999i32;
                        } else if (__value__ == ((118 : stdgo.GoUInt8))) {
                            _gotoNext = 4015084i32;
                        } else {
                            _gotoNext = 4015269i32;
                        };
                    };
                } else if (__value__ == (4014999i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._wrappedErrs = ((@:checkr _p ?? throw "null pointer dereference")._wrappedErrs.__append__(_argNum_4013960));
                    _gotoNext = 4015084i32;
                } else if (__value__ == (4015084i32)) {
                    ...
                    _gotoNext = 4015269i32;
                } else if (__value__ == (4015269i32)) {
                    @:check2r _p._printArg(_a[(_argNum_4013960 : stdgo.GoInt)], (_c_4014479 : stdgo.GoInt32));
                    _argNum_4013960++;
                    _i_4014139++;
                    _gotoNext = 4014135i32;
                } else if (__value__ == (4015434i32)) {
                    _simpleFormatBreak = true;
                    _gotoNext = 4014455i32;
                } else if (__value__ == (4015509i32)) {
                    {
                        var __tmp__ = @:check2r _p._argNumber(_argNum_4013960, _format?.__copy__(), _i_4014139, (_a.length));
                        _argNum_4013960 = @:tmpset0 __tmp__._0;
                        _i_4014139 = @:tmpset0 __tmp__._1;
                        _afterIndex_4014031 = @:tmpset0 __tmp__._2;
                    };
                    if (((_i_4014139 < _end_4013940 : Bool) && (_format[(_i_4014139 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4015629i32;
                    } else {
                        _gotoNext = 4016036i32;
                    };
                } else if (__value__ == (4015629i32)) {
                    _i_4014139++;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__intFromArg._intFromArg(_a, _argNum_4013960);
                        ...
                        _argNum_4013960 = @:tmpset0 __tmp__._2;
                    };
                    if (!(@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._widPresent) {
                        _gotoNext = 4015726i32;
                    } else {
                        _gotoNext = 4015869i32;
                    };
                } else if (__value__ == (4015726i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("%!(BADWIDTH)" : stdgo.GoString));
                    _gotoNext = 4015869i32;
                } else if (__value__ == (4015869i32)) {
                    if (((@:checkr _p ?? throw "null pointer dereference")._fmt._wid < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4015886i32;
                    } else {
                        _gotoNext = 4016008i32;
                    };
                } else if (__value__ == (4015886i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._wid = -(@:checkr _p ?? throw "null pointer dereference")._fmt._wid;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._minus = true;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._zero = false;
                    _gotoNext = 4016008i32;
                } else if (__value__ == (4016008i32)) {
                    _afterIndex_4014031 = false;
                    _gotoNext = 4016214i32;
                } else if (__value__ == (4016036i32)) {
                    _gotoNext = 4016036i32;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__parsenum._parsenum(_format?.__copy__(), _i_4014139, _end_4013940);
                        (@:checkr _p ?? throw "null pointer dereference")._fmt._wid = @:tmpset0 __tmp__._0;
                        (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._widPresent = @:tmpset0 __tmp__._1;
                        _i_4014139 = @:tmpset0 __tmp__._2;
                    };
                    if ((_afterIndex_4014031 && (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._widPresent : Bool)) {
                        _gotoNext = 4016136i32;
                    } else {
                        _gotoNext = 4016214i32;
                    };
                } else if (__value__ == (4016136i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = false;
                    _gotoNext = 4016214i32;
                } else if (__value__ == (4016214i32)) {
                    if ((((_i_4014139 + (1 : stdgo.GoInt) : stdgo.GoInt) < _end_4013940 : Bool) && (_format[(_i_4014139 : stdgo.GoInt)] == (46 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4016247i32;
                    } else {
                        _gotoNext = 4016895i32;
                    };
                } else if (__value__ == (4016247i32)) {
                    _i_4014139++;
                    if (_afterIndex_4014031) {
                        _gotoNext = 4016273i32;
                    } else {
                        _gotoNext = 4016321i32;
                    };
                } else if (__value__ == (4016273i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = false;
                    _gotoNext = 4016321i32;
                } else if (__value__ == (4016321i32)) {
                    {
                        var __tmp__ = @:check2r _p._argNumber(_argNum_4013960, _format?.__copy__(), _i_4014139, (_a.length));
                        _argNum_4013960 = @:tmpset0 __tmp__._0;
                        _i_4014139 = @:tmpset0 __tmp__._1;
                    ...
                    if (((_i_4014139 < _end_4013940 : Bool) && (_format[(_i_4014139 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4016418i32;
                    } else {
                        _gotoNext = 4016733i32;
                    };
                } else if (__value__ == (4016418i32)) {
                    _i_4014139++;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__intFromArg._intFromArg(_a, _argNum_4013960);
                    ...
                    if (((@:checkr _p ?? throw "null pointer dereference")._fmt._prec < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4016569i32;
                    } else {
                        _gotoNext = 4016632i32;
                    };
                } else if (__value__ == (4016569i32)) {
                    ...
                    if (!(@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._precPresent) {
                        _gotoNext = 4016825i32;
                    } else {
                        _gotoNext = 4016895i32;
                    };
                } else if (__value__ == (4016825i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._prec = (0 : stdgo.GoInt);
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._precPresent = true;
                    _gotoNext = 4016895i32;
                } else if (__value__ == (4016895i32)) {
                    if (!_afterIndex_4014031) {
                        _gotoNext = 4016910i32;
                    } else {
                        _gotoNext = 4016985i32;
                    };
                } else if (__value__ == (4016910i32)) {
                    {
                        var __tmp__ = @:check2r _p._argNumber(_argNum_4013960, _format?.__copy__(), _i_4014139, (_a.length));
                        _argNum_4013960 = @:tmpset0 __tmp__._0;
                        _i_4014139 = @:tmpset0 __tmp__._1;
                    ...
                    _gotoNext = 4016985i32;
                } else if (__value__ == (4016985i32)) {
                    if ((_i_4014139 >= _end_4013940 : Bool)) {
                        _gotoNext = 4016997i32;
                    } else {
                        _gotoNext = 4017050i32;
                    };
                } else if (__value__ == (4016997i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("%!(NOVERB)" : stdgo.GoString));
                    _gotoNext = 4017966i32;
                } else if (__value__ == (4017050i32)) {
                    {
                        final __tmp__0 = (_format[(_i_4014139 : stdgo.GoInt)] : stdgo.GoInt32);
                        final __tmp__1 = (1 : stdgo.GoInt);
                        _verb_4017050 = __tmp__0;
                        _size_4017056 = __tmp__1;
                    };
                    if ((_verb_4017050 >= (128 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 4017110i32;
                    } else {
                        _gotoNext = 4017170i32;
                    };
                } else if (__value__ == (4017110i32)) {
                    {
                        var __tmp__ = stdgo._internal.unicode.utf8.Utf8_decodeRuneInString.decodeRuneInString((_format.__slice__(_i_4014139) : stdgo.GoString)?.__copy__());
                        _verb_4017050 = @:tmpset0 __tmp__._0;
                        _size_4017056 = @:tmpset0 __tmp__._1;
                    };
                    _gotoNext = 4017170i32;
                } else if (__value__ == (4017170i32)) {
                    _i_4014139 = (_i_4014139 + (_size_4017056) : stdgo.GoInt);
                    _gotoNext = 4017183i32;
                } else if (__value__ == (4017183i32)) {
                    if (_verb_4017050 == ((37 : stdgo.GoInt32))) {
                        _gotoNext = 4017194i32;
                    } else if (!(@:checkr _p ?? throw "null pointer dereference")._goodArgNum) {
                        _gotoNext = 4017304i32;
                    } else if ((_argNum_4013960 >= (_a.length) : Bool)) {
                        _gotoNext = 4017347i32;
                    } else if (_verb_4017050 == ((119 : stdgo.GoInt32))) {
                        _gotoNext = 4017450i32;
                    } else if (_verb_4017050 == ((118 : stdgo.GoInt32))) {
                        _gotoNext = 4017534i32;
                    } else {
                        _gotoNext = 4017714i32;
                    };
                } else if (__value__ == (4017194i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeByte((37 : stdgo.GoUInt8));
                    _gotoNext = 4014135i32;
                } else if (__value__ == (4017304i32)) {
                    @:check2r _p._badArgNum(_verb_4017050);
                    _gotoNext = 4014135i32;
                } else if (__value__ == (4017347i32)) {
                    @:check2r _p._missingArg(_verb_4017050);
                    _gotoNext = 4014135i32;
                } else if (__value__ == (4017450i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._wrappedErrs = ((@:checkr _p ?? throw "null pointer dereference")._wrappedErrs.__append__(_argNum_4013960));
                    _gotoNext = 4017534i32;
                } else if (__value__ == (4017534i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._sharpV = (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._sharp;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._sharp = false;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._plusV = (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._plus;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._plus = false;
                    _gotoNext = 4017714i32;
                } else if (__value__ == (4017714i32)) {
                    @:check2r _p._printArg(_a[(_argNum_4013960 : stdgo.GoInt)], _verb_4017050);
                    _argNum_4013960++;
                    _gotoNext = 4014135i32;
                } else if (__value__ == (4017966i32)) {
                    if ((!(@:checkr _p ?? throw "null pointer dereference")._reordered && (_argNum_4013960 < (_a.length) : Bool) : Bool)) {
                        _gotoNext = 4018001i32;
                    } else {
                        _gotoNext = 4018357i32;
                    };
                } else if (__value__ == (4018001i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._fmt._clearflags();
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("%!(EXTRA " : stdgo.GoString));
                    if ((0i32 : stdgo.GoInt) < ((_a.__slice__(_argNum_4013960) : stdgo.Slice<stdgo.AnyInterface>).length)) {
                        _gotoNext = 4018328i32;
                    } else {
                        _gotoNext = 4018333i32;
                    };
                } else if (__value__ == (4018063i32)) {
                    _i_4018063++;
                    _gotoNext = 4018329i32;
                } else if (__value__ == (4018090i32)) {
                    _arg_4018066 = stdgo.Go.toInterface((_a.__slice__(_argNum_4013960) : stdgo.Slice<stdgo.AnyInterface>)[(_i_4018063 : stdgo.GoInt)]);
                    if ((_i_4018063 > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4018104i32;
                    } else {
                        _gotoNext = 4018154i32;
                    };
                } else if (__value__ == (4018104i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString((", " : stdgo.GoString));
                    _gotoNext = 4018154i32;
                } else if (__value__ == (4018154i32)) {
                    if (_arg_4018066 == null) {
                        _gotoNext = 4018168i32;
                    } else {
                        _gotoNext = 4018218i32;
                    };
                } else if (__value__ == (4018168i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("<nil>" : stdgo.GoString));
                    _gotoNext = 4018063i32;
                } else if (__value__ == (4018218i32)) {
                    _gotoNext = 4018218i32;
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString((stdgo._internal.reflect.Reflect_typeOf.typeOf(_arg_4018066).string() : stdgo.GoString)?.__copy__());
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeByte((61 : stdgo.GoUInt8));
                    @:check2r _p._printArg(_arg_4018066, (118 : stdgo.GoInt32));
                    var __blank__ = 0i32;
                    _gotoNext = 4018063i32;
                } else if (__value__ == (4018328i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = stdgo.Go.toInterface((_a.__slice__(_argNum_4013960) : stdgo.Slice<stdgo.AnyInterface>)[(0i32 : stdgo.GoInt)]);
                        _i_4018063 = __tmp__0;
                        _arg_4018066 = __tmp__1;
                    };
                    _gotoNext = 4018329i32;
                } else if (__value__ == (4018329i32)) {
                    if (_i_4018063 < ((_a.__slice__(_argNum_4013960) : stdgo.Slice<stdgo.AnyInterface>).length)) {
                        _gotoNext = 4018090i32;
                    } else {
                        _gotoNext = 4018333i32;
                    };
                } else if (__value__ == (4018333i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeByte((41 : stdgo.GoUInt8));
                    _gotoNext = 4018357i32;
                } else if (__value__ == (4018357i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
