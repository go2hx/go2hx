...
@:keep @:allow(stdgo._internal.fmt.Fmt.T_pp_asInterface) class T_pp_static_extension {
    ...
    static public function _doPrintf( _p:stdgo.Ref<stdgo._internal.fmt.Fmt_T_pp.T_pp>, _format:stdgo.GoString, _a:stdgo.Slice<stdgo.AnyInterface>):Void {
        @:recv var _p:stdgo.Ref<stdgo._internal.fmt.Fmt_T_pp.T_pp> = _p;
        var _arg_4045345:stdgo.AnyInterface = (null : stdgo.AnyInterface);
        var _i_4045342:stdgo.GoInt = (0 : stdgo.GoInt);
        var _verb_4044329:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _lasti_4041461:stdgo.GoInt = (0 : stdgo.GoInt);
        var _argNum_4041239:stdgo.GoInt = (0 : stdgo.GoInt);
        var _end_4041219:stdgo.GoInt = (0 : stdgo.GoInt);
        var _size_4044335:stdgo.GoInt = (0 : stdgo.GoInt);
        var _c_4041758:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _simpleFormatBreak = false;
        var _formatLoopBreak = false;
        var _i_4041418:stdgo.GoInt = (0 : stdgo.GoInt);
        var _afterIndex_4041310:Bool = false;
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _end_4041219 = (_format.length);
                    _argNum_4041239 = (0 : stdgo.GoInt);
                    _afterIndex_4041310 = false;
                    _p._reordered = false;
                    _gotoNext = 4041401i32;
                } else if (__value__ == (4041401i32)) {
                    _i_4041418 = (0 : stdgo.GoInt);
                    _formatLoopBreak = false;
                    _gotoNext = 4041414i32;
                } else if (__value__ == (4041414i32)) {
                    if (!_formatLoopBreak && ((_i_4041418 < _end_4041219 : Bool))) {
                        _gotoNext = 4041435i32;
                    } else {
                        _gotoNext = 4045245i32;
                    };
                } else if (__value__ == (4041435i32)) {
                    _p._goodArgNum = true;
                    _lasti_4041461 = _i_4041418;
                    var __blank__ = 0i32;
                    _gotoNext = 4041474i32;
                } else if (__value__ == (4041474i32)) {
                    if (((_i_4041418 < _end_4041219 : Bool) && (_format[(_i_4041418 : stdgo.GoInt)] != (37 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4041506i32;
                    } else {
                        _gotoNext = 4041521i32;
                    };
                } else if (__value__ == (4041506i32)) {
                    _i_4041418++;
                    _gotoNext = 4041474i32;
                } else if (__value__ == (4041521i32)) {
                    if ((_i_4041418 > _lasti_4041461 : Bool)) {
                        _gotoNext = 4041534i32;
                    } else {
                        _gotoNext = 4041580i32;
                    };
                } else if (__value__ == (4041534i32)) {
                    _p._buf._writeString((_format.__slice__(_lasti_4041461, _i_4041418) : stdgo.GoString)?.__copy__());
                    _gotoNext = 4041580i32;
                } else if (__value__ == (4041580i32)) {
                    if ((_i_4041418 >= _end_4041219 : Bool)) {
                        _gotoNext = 4041592i32;
                    } else {
                        _gotoNext = 4041668i32;
                    };
                } else if (__value__ == (4041592i32)) {
                    _gotoNext = 4045245i32;
                } else if (__value__ == (4041668i32)) {
                    _i_4041418++;
                    _p._fmt._clearflags();
                    _gotoNext = 4041718i32;
                } else if (__value__ == (4041718i32)) {
                    var __blank__ = 0i32;
                    _simpleFormatBreak = false;
                    _gotoNext = 4041734i32;
                } else if (__value__ == (4041734i32)) {
                    if (!_simpleFormatBreak && ((_i_4041418 < _end_4041219 : Bool))) {
                        _gotoNext = 4041753i32;
                    } else {
                        _gotoNext = 4042788i32;
                    };
                } else if (__value__ == (4041749i32)) {
                    _i_4041418++;
                    _gotoNext = 4041734i32;
                } else if (__value__ == (4041753i32)) {
                    _c_4041758 = _format[(_i_4041418 : stdgo.GoInt)];
                    _gotoNext = 4041776i32;
                } else if (__value__ == (4041776i32)) {
                    {
                        final __value__ = _c_4041758;
                        if (__value__ == ((35 : stdgo.GoUInt8))) {
                            _gotoNext = 4041790i32;
                        } else if (__value__ == ((48 : stdgo.GoUInt8))) {
                            _gotoNext = 4041826i32;
                        } else if (__value__ == ((43 : stdgo.GoUInt8))) {
                            _gotoNext = 4041909i32;
                        } else if (__value__ == ((45 : stdgo.GoUInt8))) {
                            _gotoNext = 4041944i32;
                        } else if (__value__ == ((32 : stdgo.GoUInt8))) {
                            _gotoNext = 4042042i32;
                        } else {
                            _gotoNext = 4042078i32;
                        };
                    };
                } else if (__value__ == (4041790i32)) {
                    _p._fmt._fmtFlags._sharp = true;
                    _gotoNext = 4041749i32;
                } else if (__value__ == (4041826i32)) {
                    _p._fmt._fmtFlags._zero = !_p._fmt._fmtFlags._minus;
                    _gotoNext = 4041749i32;
                } else if (__value__ == (4041909i32)) {
                    _p._fmt._fmtFlags._plus = true;
                    _gotoNext = 4041749i32;
                } else if (__value__ == (4041944i32)) {
                    _p._fmt._fmtFlags._minus = true;
                    _p._fmt._fmtFlags._zero = false;
                    _gotoNext = 4041749i32;
                } else if (__value__ == (4042042i32)) {
                    _p._fmt._fmtFlags._space = true;
                    _gotoNext = 4041749i32;
                } else if (__value__ == (4042078i32)) {
                    if (((((97 : stdgo.GoUInt8) <= _c_4041758 : Bool) && (_c_4041758 <= (122 : stdgo.GoUInt8) : Bool) : Bool) && (_argNum_4041239 < (_a.length) : Bool) : Bool)) {
                        _gotoNext = 4042255i32;
                    } else {
                        _gotoNext = 4042713i32;
                    };
                } else if (__value__ == (4042255i32)) {
                    _gotoNext = 4042262i32;
                } else if (__value__ == (4042262i32)) {
                    {
                        final __value__ = _c_4041758;
                        if (__value__ == ((119 : stdgo.GoUInt8))) {
                            _gotoNext = 4042278i32;
                        } else if (__value__ == ((118 : stdgo.GoUInt8))) {
                            _gotoNext = 4042363i32;
                        } else {
                            _gotoNext = 4042548i32;
                        };
                    };
                } else if (__value__ == (4042278i32)) {
                    _p._wrappedErrs = (_p._wrappedErrs.__append__(_argNum_4041239));
                    _gotoNext = 4042363i32;
                } else if (__value__ == (4042363i32)) {
                    ...
                    _gotoNext = 4042548i32;
                } else if (__value__ == (4042548i32)) {
                    _p._printArg(_a[(_argNum_4041239 : stdgo.GoInt)], (_c_4041758 : stdgo.GoInt32));
                    _argNum_4041239++;
                    _i_4041418++;
                    _gotoNext = 4041414i32;
                } else if (__value__ == (4042713i32)) {
                    _simpleFormatBreak = true;
                    _gotoNext = 4041734i32;
                } else if (__value__ == (4042788i32)) {
                    {
                        var __tmp__ = _p._argNumber(_argNum_4041239, _format?.__copy__(), _i_4041418, (_a.length));
                        _argNum_4041239 = __tmp__._0;
                        _i_4041418 = __tmp__._1;
                        _afterIndex_4041310 = __tmp__._2;
                    };
                    if (((_i_4041418 < _end_4041219 : Bool) && (_format[(_i_4041418 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4042908i32;
                    } else {
                        _gotoNext = 4043315i32;
                    };
                } else if (__value__ == (4042908i32)) {
                    _i_4041418++;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__intFromArg._intFromArg(_a, _argNum_4041239);
                        _p._fmt._wid = __tmp__._0;
                        _p._fmt._fmtFlags._widPresent = __tmp__._1;
                        _argNum_4041239 = __tmp__._2;
                    };
                    if (!_p._fmt._fmtFlags._widPresent) {
                        _gotoNext = 4043005i32;
                    } else {
                        _gotoNext = 4043148i32;
                    };
                } else if (__value__ == (4043005i32)) {
                    _p._buf._writeString(("%!(BADWIDTH)" : stdgo.GoString));
                    _gotoNext = 4043148i32;
                } else if (__value__ == (4043148i32)) {
                    if ((_p._fmt._wid < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4043165i32;
                    } else {
                        _gotoNext = 4043287i32;
                    };
                } else if (__value__ == (4043165i32)) {
                    _p._fmt._wid = -_p._fmt._wid;
                    _p._fmt._fmtFlags._minus = true;
                    _p._fmt._fmtFlags._zero = false;
                    _gotoNext = 4043287i32;
                } else if (__value__ == (4043287i32)) {
                    _afterIndex_4041310 = false;
                    _gotoNext = 4043493i32;
                } else if (__value__ == (4043315i32)) {
                    _gotoNext = 4043315i32;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__parsenum._parsenum(_format?.__copy__(), _i_4041418, _end_4041219);
                        _p._fmt._wid = __tmp__._0;
                        _p._fmt._fmtFlags._widPresent = __tmp__._1;
                        _i_4041418 = __tmp__._2;
                    };
                    if ((_afterIndex_4041310 && _p._fmt._fmtFlags._widPresent : Bool)) {
                        _gotoNext = 4043415i32;
                    } else {
                        _gotoNext = 4043493i32;
                    };
                } else if (__value__ == (4043415i32)) {
                    _p._goodArgNum = false;
                    _gotoNext = 4043493i32;
                } else if (__value__ == (4043493i32)) {
                    if ((((_i_4041418 + (1 : stdgo.GoInt) : stdgo.GoInt) < _end_4041219 : Bool) && (_format[(_i_4041418 : stdgo.GoInt)] == (46 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4043526i32;
                    } else {
                        _gotoNext = 4044174i32;
                    };
                } else if (__value__ == (4043526i32)) {
                    _i_4041418++;
                    if (_afterIndex_4041310) {
                        _gotoNext = 4043552i32;
                    } else {
                        _gotoNext = 4043600i32;
                    };
                } else if (__value__ == (4043552i32)) {
                    _p._goodArgNum = false;
                    _gotoNext = 4043600i32;
                } else if (__value__ == (4043600i32)) {
                    {
                        var __tmp__ = _p._argNumber(_argNum_4041239, _format?.__copy__(), _i_4041418, (_a.length));
                        _argNum_4041239 = __tmp__._0;
                        _i_4041418 = __tmp__._1;
                    ...
                    if (((_i_4041418 < _end_4041219 : Bool) && (_format[(_i_4041418 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4043697i32;
                    } else {
                        _gotoNext = 4044012i32;
                    };
                } else if (__value__ == (4043697i32)) {
                    _i_4041418++;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__intFromArg._intFromArg(_a, _argNum_4041239);
                    ...
                    if ((_p._fmt._prec < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4043848i32;
                    } else {
                        _gotoNext = 4043911i32;
                    };
                } else if (__value__ == (4043848i32)) {
                    _p._fmt._prec = (0 : stdgo.GoInt);
                    _p._fmt._fmtFlags._precPresent = false;
                    _gotoNext = 4043911i32;
                } else if (__value__ == (4043911i32)) {
                    if (!_p._fmt._fmtFlags._precPresent) {
                        _gotoNext = 4043933i32;
                    } else {
                        _gotoNext = 4043983i32;
                    };
                } else if (__value__ == (4043933i32)) {
                    _p._buf._writeString(("%!(BADPREC)" : stdgo.GoString));
                    _gotoNext = 4043983i32;
                } else if (__value__ == (4043983i32)) {
                    _afterIndex_4041310 = false;
                    _gotoNext = 4044174i32;
                } else if (__value__ == (4044012i32)) {
                    _gotoNext = 4044012i32;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__parsenum._parsenum(_format?.__copy__(), _i_4041418, _end_4041219);
                        _p._fmt._prec = __tmp__._0;
                    ...
                    if (!_p._fmt._fmtFlags._precPresent) {
                        _gotoNext = 4044104i32;
                    } else {
                        _gotoNext = 4044174i32;
                    };
                } else if (__value__ == (4044104i32)) {
                    _p._fmt._prec = (0 : stdgo.GoInt);
                    _p._fmt._fmtFlags._precPresent = true;
                    _gotoNext = 4044174i32;
                } else if (__value__ == (4044174i32)) {
                    if (!_afterIndex_4041310) {
                        _gotoNext = 4044189i32;
                    } else {
                        _gotoNext = 4044264i32;
                    };
                } else if (__value__ == (4044189i32)) {
                    {
                        var __tmp__ = _p._argNumber(_argNum_4041239, _format?.__copy__(), _i_4041418, (_a.length));
                        _argNum_4041239 = __tmp__._0;
                        _i_4041418 = __tmp__._1;
                    ...
                    _gotoNext = 4044264i32;
                } else if (__value__ == (4044264i32)) {
                    if ((_i_4041418 >= _end_4041219 : Bool)) {
                        _gotoNext = 4044276i32;
                    } else {
                        _gotoNext = 4044329i32;
                    };
                } else if (__value__ == (4044276i32)) {
                    _p._buf._writeString(("%!(NOVERB)" : stdgo.GoString));
                    _gotoNext = 4045245i32;
                } else if (__value__ == (4044329i32)) {
                    {
                        final __tmp__0 = (_format[(_i_4041418 : stdgo.GoInt)] : stdgo.GoInt32);
                        final __tmp__1 = (1 : stdgo.GoInt);
                        _verb_4044329 = __tmp__0;
                        _size_4044335 = __tmp__1;
                    };
                    if ((_verb_4044329 >= (128 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 4044389i32;
                    } else {
                        _gotoNext = 4044449i32;
                    };
                } else if (__value__ == (4044389i32)) {
                    {
                        var __tmp__ = stdgo._internal.unicode.utf8.Utf8_decodeRuneInString.decodeRuneInString((_format.__slice__(_i_4041418) : stdgo.GoString)?.__copy__());
                        _verb_4044329 = __tmp__._0;
                        _size_4044335 = __tmp__._1;
                    };
                    _gotoNext = 4044449i32;
                } else if (__value__ == (4044449i32)) {
                    _i_4041418 = (_i_4041418 + (_size_4044335) : stdgo.GoInt);
                    _gotoNext = 4044462i32;
                } else if (__value__ == (4044462i32)) {
                    if (_verb_4044329 == ((37 : stdgo.GoInt32))) {
                        _gotoNext = 4044473i32;
                    } else if (!_p._goodArgNum) {
                        _gotoNext = 4044583i32;
                    } else if ((_argNum_4041239 >= (_a.length) : Bool)) {
                        _gotoNext = 4044626i32;
                    } else if (_verb_4044329 == ((119 : stdgo.GoInt32))) {
                        _gotoNext = 4044729i32;
                    } else if (_verb_4044329 == ((118 : stdgo.GoInt32))) {
                        _gotoNext = 4044813i32;
                    } else {
                        _gotoNext = 4044993i32;
                    };
                } else if (__value__ == (4044473i32)) {
                    _p._buf._writeByte((37 : stdgo.GoUInt8));
                    _gotoNext = 4045245i32;
                } else if (__value__ == (4044583i32)) {
                    _p._badArgNum(_verb_4044329);
                    _gotoNext = 4045245i32;
                } else if (__value__ == (4044626i32)) {
                    _p._missingArg(_verb_4044329);
                    _gotoNext = 4045245i32;
                } else if (__value__ == (4044729i32)) {
                    _p._wrappedErrs = (_p._wrappedErrs.__append__(_argNum_4041239));
                    _gotoNext = 4044813i32;
                } else if (__value__ == (4044813i32)) {
                    _p._fmt._fmtFlags._sharpV = _p._fmt._fmtFlags._sharp;
                    _p._fmt._fmtFlags._sharp = false;
                    _p._fmt._fmtFlags._plusV = _p._fmt._fmtFlags._plus;
                    _p._fmt._fmtFlags._plus = false;
                    _gotoNext = 4044993i32;
                } else if (__value__ == (4044993i32)) {
                    _p._printArg(_a[(_argNum_4041239 : stdgo.GoInt)], _verb_4044329);
                    _argNum_4041239++;
                    _gotoNext = 4045245i32;
                } else if (__value__ == (4045245i32)) {
                    if ((!_p._reordered && (_argNum_4041239 < (_a.length) : Bool) : Bool)) {
                        _gotoNext = 4045280i32;
                    } else {
                        _gotoNext = 4045636i32;
                    };
                } else if (__value__ == (4045280i32)) {
                    _p._fmt._clearflags();
                    _p._buf._writeString(("%!(EXTRA " : stdgo.GoString));
                    if ((0i32 : stdgo.GoInt) < ((_a.__slice__(_argNum_4041239) : stdgo.Slice<stdgo.AnyInterface>).length)) {
                        _gotoNext = 4045607i32;
                    } else {
                        _gotoNext = 4045612i32;
                    };
                } else if (__value__ == (4045342i32)) {
                    _i_4045342++;
                    _gotoNext = 4045608i32;
                } else if (__value__ == (4045369i32)) {
                    _arg_4045345 = stdgo.Go.toInterface((_a.__slice__(_argNum_4041239) : stdgo.Slice<stdgo.AnyInterface>)[(_i_4045342 : stdgo.GoInt)]);
                    if ((_i_4045342 > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4045383i32;
                    } else {
                        _gotoNext = 4045433i32;
                    };
                } else if (__value__ == (4045383i32)) {
                    _p._buf._writeString((", " : stdgo.GoString));
                    _gotoNext = 4045433i32;
                } else if (__value__ == (4045433i32)) {
                    if (_arg_4045345 == null) {
                        _gotoNext = 4045447i32;
                    } else {
                        _gotoNext = 4045497i32;
                    };
                } else if (__value__ == (4045447i32)) {
                    _p._buf._writeString(("<nil>" : stdgo.GoString));
                    _gotoNext = 4045342i32;
                } else if (__value__ == (4045497i32)) {
                    _gotoNext = 4045497i32;
                    _p._buf._writeString((stdgo._internal.reflect.Reflect_typeOf.typeOf(_arg_4045345).string() : stdgo.GoString)?.__copy__());
                    _p._buf._writeByte((61 : stdgo.GoUInt8));
                    _p._printArg(_arg_4045345, (118 : stdgo.GoInt32));
                    var __blank__ = 0i32;
                    _gotoNext = 4045342i32;
                } else if (__value__ == (4045607i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = stdgo.Go.toInterface((_a.__slice__(_argNum_4041239) : stdgo.Slice<stdgo.AnyInterface>)[(0i32 : stdgo.GoInt)]);
                        _i_4045342 = __tmp__0;
                        _arg_4045345 = __tmp__1;
                    };
                    _gotoNext = 4045608i32;
                } else if (__value__ == (4045608i32)) {
                    if (_i_4045342 < ((_a.__slice__(_argNum_4041239) : stdgo.Slice<stdgo.AnyInterface>).length)) {
                        _gotoNext = 4045369i32;
                    } else {
                        _gotoNext = 4045612i32;
                    };
                } else if (__value__ == (4045612i32)) {
                    _p._buf._writeByte((41 : stdgo.GoUInt8));
                    _gotoNext = 4045636i32;
                } else if (__value__ == (4045636i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
