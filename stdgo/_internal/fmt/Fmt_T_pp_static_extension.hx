...
@:keep @:allow(stdgo._internal.fmt.Fmt.T_pp_asInterface) class T_pp_static_extension {
    ...
    static public function _doPrintf( _p:stdgo.Ref<stdgo._internal.fmt.Fmt_T_pp.T_pp>, _format:stdgo.GoString, _a:stdgo.Slice<stdgo.AnyInterface>):Void {
        @:recv var _p:stdgo.Ref<stdgo._internal.fmt.Fmt_T_pp.T_pp> = _p;
        var _i_4086602:stdgo.GoInt = (0 : stdgo.GoInt);
        var _simpleFormatBreak = false;
        var _formatLoopBreak = false;
        var _i_4082678:stdgo.GoInt = (0 : stdgo.GoInt);
        var _argNum_4082499:stdgo.GoInt = (0 : stdgo.GoInt);
        var _end_4082479:stdgo.GoInt = (0 : stdgo.GoInt);
        var _arg_4086605:stdgo.AnyInterface = (null : stdgo.AnyInterface);
        var _size_4085595:stdgo.GoInt = (0 : stdgo.GoInt);
        var _verb_4085589:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _c_4083018:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _lasti_4082721:stdgo.GoInt = (0 : stdgo.GoInt);
        var _afterIndex_4082570:Bool = false;
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _end_4082479 = (_format.length);
                    _argNum_4082499 = (0 : stdgo.GoInt);
                    _afterIndex_4082570 = false;
                    _p._reordered = false;
                    _gotoNext = 4082661i32;
                } else if (__value__ == (4082661i32)) {
                    _i_4082678 = (0 : stdgo.GoInt);
                    _formatLoopBreak = false;
                    _gotoNext = 4082674i32;
                } else if (__value__ == (4082674i32)) {
                    if (!_formatLoopBreak && ((_i_4082678 < _end_4082479 : Bool))) {
                        _gotoNext = 4082695i32;
                    } else {
                        _gotoNext = 4086505i32;
                    };
                } else if (__value__ == (4082695i32)) {
                    _p._goodArgNum = true;
                    _lasti_4082721 = _i_4082678;
                    var __blank__ = 0i32;
                    _gotoNext = 4082734i32;
                } else if (__value__ == (4082734i32)) {
                    if (((_i_4082678 < _end_4082479 : Bool) && (_format[(_i_4082678 : stdgo.GoInt)] != (37 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4082766i32;
                    } else {
                        _gotoNext = 4082781i32;
                    };
                } else if (__value__ == (4082766i32)) {
                    _i_4082678++;
                    _gotoNext = 4082734i32;
                } else if (__value__ == (4082781i32)) {
                    if ((_i_4082678 > _lasti_4082721 : Bool)) {
                        _gotoNext = 4082794i32;
                    } else {
                        _gotoNext = 4082840i32;
                    };
                } else if (__value__ == (4082794i32)) {
                    _p._buf._writeString((_format.__slice__(_lasti_4082721, _i_4082678) : stdgo.GoString)?.__copy__());
                    _gotoNext = 4082840i32;
                } else if (__value__ == (4082840i32)) {
                    if ((_i_4082678 >= _end_4082479 : Bool)) {
                        _gotoNext = 4082852i32;
                    } else {
                        _gotoNext = 4082928i32;
                    };
                } else if (__value__ == (4082852i32)) {
                    _gotoNext = 4086505i32;
                } else if (__value__ == (4082928i32)) {
                    _i_4082678++;
                    _p._fmt._clearflags();
                    _gotoNext = 4082978i32;
                } else if (__value__ == (4082978i32)) {
                    var __blank__ = 0i32;
                    _simpleFormatBreak = false;
                    _gotoNext = 4082994i32;
                } else if (__value__ == (4082994i32)) {
                    if (!_simpleFormatBreak && ((_i_4082678 < _end_4082479 : Bool))) {
                        _gotoNext = 4083013i32;
                    } else {
                        _gotoNext = 4084048i32;
                    };
                } else if (__value__ == (4083009i32)) {
                    _i_4082678++;
                    _gotoNext = 4082994i32;
                } else if (__value__ == (4083013i32)) {
                    _c_4083018 = _format[(_i_4082678 : stdgo.GoInt)];
                    _gotoNext = 4083036i32;
                } else if (__value__ == (4083036i32)) {
                    {
                        final __value__ = _c_4083018;
                        if (__value__ == ((35 : stdgo.GoUInt8))) {
                            _gotoNext = 4083050i32;
                        } else if (__value__ == ((48 : stdgo.GoUInt8))) {
                            _gotoNext = 4083086i32;
                        } else if (__value__ == ((43 : stdgo.GoUInt8))) {
                            _gotoNext = 4083169i32;
                        } else if (__value__ == ((45 : stdgo.GoUInt8))) {
                            _gotoNext = 4083204i32;
                        } else if (__value__ == ((32 : stdgo.GoUInt8))) {
                            _gotoNext = 4083302i32;
                        } else {
                            _gotoNext = 4083338i32;
                        };
                    };
                } else if (__value__ == (4083050i32)) {
                    _p._fmt._fmtFlags._sharp = true;
                    _gotoNext = 4083009i32;
                    ...
                    _gotoNext = 4083009i32;
                } else if (__value__ == (4083204i32)) {
                    _p._fmt._fmtFlags._minus = true;
                    _p._fmt._fmtFlags._zero = false;
                    _gotoNext = 4083009i32;
                } else if (__value__ == (4083302i32)) {
                    _p._fmt._fmtFlags._space = true;
                    _gotoNext = 4083009i32;
                } else if (__value__ == (4083338i32)) {
                    if (((((97 : stdgo.GoUInt8) <= _c_4083018 : Bool) && (_c_4083018 <= (122 : stdgo.GoUInt8) : Bool) : Bool) && (_argNum_4082499 < (_a.length) : Bool) : Bool)) {
                        _gotoNext = 4083515i32;
                    } else {
                        _gotoNext = 4083973i32;
                    };
                } else if (__value__ == (4083515i32)) {
                    _gotoNext = 4083522i32;
                } else if (__value__ == (4083522i32)) {
                    {
                        final __value__ = _c_4083018;
                        if (__value__ == ((119 : stdgo.GoUInt8))) {
                            _gotoNext = 4083538i32;
                        } else if (__value__ == ((118 : stdgo.GoUInt8))) {
                            _gotoNext = 4083623i32;
                        } else {
                            _gotoNext = 4083808i32;
                        };
                    };
                } else if (__value__ == (4083538i32)) {
                    _p._wrappedErrs = (_p._wrappedErrs.__append__(_argNum_4082499));
                    _gotoNext = 4083623i32;
                } else if (__value__ == (4083623i32)) {
                    ...
                    _gotoNext = 4083808i32;
                } else if (__value__ == (4083808i32)) {
                    _p._printArg(_a[(_argNum_4082499 : stdgo.GoInt)], (_c_4083018 : stdgo.GoInt32));
                    _argNum_4082499++;
                    _i_4082678++;
                    _gotoNext = 4082674i32;
                } else if (__value__ == (4083973i32)) {
                    _simpleFormatBreak = true;
                    _gotoNext = 4082994i32;
                } else if (__value__ == (4084048i32)) {
                    {
                        var __tmp__ = _p._argNumber(_argNum_4082499, _format?.__copy__(), _i_4082678, (_a.length));
                        _argNum_4082499 = __tmp__._0;
                        _i_4082678 = __tmp__._1;
                        _afterIndex_4082570 = __tmp__._2;
                    };
                    if (((_i_4082678 < _end_4082479 : Bool) && (_format[(_i_4082678 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4084168i32;
                    } else {
                        _gotoNext = 4084575i32;
                    };
                } else if (__value__ == (4084168i32)) {
                    _i_4082678++;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__intFromArg._intFromArg(_a, _argNum_4082499);
                        _p._fmt._wid = __tmp__._0;
                        _p._fmt._fmtFlags._widPresent = __tmp__._1;
                        _argNum_4082499 = __tmp__._2;
                    };
                    if (!_p._fmt._fmtFlags._widPresent) {
                        _gotoNext = 4084265i32;
                    } else {
                        _gotoNext = 4084408i32;
                    };
                } else if (__value__ == (4084265i32)) {
                    _p._buf._writeString(("%!(BADWIDTH)" : stdgo.GoString));
                    _gotoNext = 4084408i32;
                } else if (__value__ == (4084408i32)) {
                    if ((_p._fmt._wid < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4084425i32;
                    } else {
                        _gotoNext = 4084547i32;
                    };
                } else if (__value__ == (4084425i32)) {
                    _p._fmt._wid = -_p._fmt._wid;
                    _p._fmt._fmtFlags._minus = true;
                    _p._fmt._fmtFlags._zero = false;
                    _gotoNext = 4084547i32;
                } else if (__value__ == (4084547i32)) {
                    _afterIndex_4082570 = false;
                    _gotoNext = 4084753i32;
                } else if (__value__ == (4084575i32)) {
                    _gotoNext = 4084575i32;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__parsenum._parsenum(_format?.__copy__(), _i_4082678, _end_4082479);
                        _p._fmt._wid = __tmp__._0;
                        _p._fmt._fmtFlags._widPresent = __tmp__._1;
                        _i_4082678 = __tmp__._2;
                    };
                    if ((_afterIndex_4082570 && _p._fmt._fmtFlags._widPresent : Bool)) {
                        _gotoNext = 4084675i32;
                    } else {
                        _gotoNext = 4084753i32;
                    };
                } else if (__value__ == (4084675i32)) {
                    _p._goodArgNum = false;
                    _gotoNext = 4084753i32;
                } else if (__value__ == (4084753i32)) {
                    if ((((_i_4082678 + (1 : stdgo.GoInt) : stdgo.GoInt) < _end_4082479 : Bool) && (_format[(_i_4082678 : stdgo.GoInt)] == (46 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4084786i32;
                    } else {
                        _gotoNext = 4085434i32;
                    };
                } else if (__value__ == (4084786i32)) {
                    _i_4082678++;
                    if (_afterIndex_4082570) {
                        _gotoNext = 4084812i32;
                    } else {
                        _gotoNext = 4084860i32;
                    };
                } else if (__value__ == (4084812i32)) {
                    _p._goodArgNum = false;
                    _gotoNext = 4084860i32;
                } else if (__value__ == (4084860i32)) {
                    {
                        var __tmp__ = _p._argNumber(_argNum_4082499, _format?.__copy__(), _i_4082678, (_a.length));
                        _argNum_4082499 = __tmp__._0;
                        _i_4082678 = __tmp__._1;
                    ...
                    if (((_i_4082678 < _end_4082479 : Bool) && (_format[(_i_4082678 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4084957i32;
                    } else {
                        _gotoNext = 4085272i32;
                    };
                } else if (__value__ == (4084957i32)) {
                    _i_4082678++;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__intFromArg._intFromArg(_a, _argNum_4082499);
                    ...
                    if ((_p._fmt._prec < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4085108i32;
                    } else {
                        _gotoNext = 4085171i32;
                    };
                } else if (__value__ == (4085108i32)) {
                    _p._fmt._prec = (0 : stdgo.GoInt);
                    _p._fmt._fmtFlags._precPresent = false;
                    _gotoNext = 4085171i32;
                } else if (__value__ == (4085171i32)) {
                    if (!_p._fmt._fmtFlags._precPresent) {
                        _gotoNext = 4085193i32;
                    } else {
                        _gotoNext = 4085243i32;
                    };
                } else if (__value__ == (4085193i32)) {
                    _p._buf._writeString(("%!(BADPREC)" : stdgo.GoString));
                    _gotoNext = 4085243i32;
                } else if (__value__ == (4085243i32)) {
                    _afterIndex_4082570 = false;
                    _gotoNext = 4085434i32;
                    ...
                    if (!_p._fmt._fmtFlags._precPresent) {
                        _gotoNext = 4085364i32;
                    } else {
                        _gotoNext = 4085434i32;
                    };
                } else if (__value__ == (4085364i32)) {
                    _p._fmt._prec = (0 : stdgo.GoInt);
                    _p._fmt._fmtFlags._precPresent = true;
                    _gotoNext = 4085434i32;
                } else if (__value__ == (4085434i32)) {
                    if (!_afterIndex_4082570) {
                        _gotoNext = 4085449i32;
                    } else {
                        _gotoNext = 4085524i32;
                    };
                } else if (__value__ == (4085449i32)) {
                    {
                        var __tmp__ = _p._argNumber(_argNum_4082499, _format?.__copy__(), _i_4082678, (_a.length));
                        _argNum_4082499 = __tmp__._0;
                        _i_4082678 = __tmp__._1;
                    ...
                    _gotoNext = 4085524i32;
                } else if (__value__ == (4085524i32)) {
                    if ((_i_4082678 >= _end_4082479 : Bool)) {
                        _gotoNext = 4085536i32;
                    } else {
                        _gotoNext = 4085589i32;
                    };
                } else if (__value__ == (4085536i32)) {
                    _p._buf._writeString(("%!(NOVERB)" : stdgo.GoString));
                    _gotoNext = 4086505i32;
                } else if (__value__ == (4085589i32)) {
                    {
                        final __tmp__0 = (_format[(_i_4082678 : stdgo.GoInt)] : stdgo.GoInt32);
                        final __tmp__1 = (1 : stdgo.GoInt);
                        _verb_4085589 = __tmp__0;
                        _size_4085595 = __tmp__1;
                    };
                    if ((_verb_4085589 >= (128 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 4085649i32;
                    } else {
                        _gotoNext = 4085709i32;
                    };
                } else if (__value__ == (4085649i32)) {
                    {
                        var __tmp__ = stdgo._internal.unicode.utf8.Utf8_decodeRuneInString.decodeRuneInString((_format.__slice__(_i_4082678) : stdgo.GoString)?.__copy__());
                        _verb_4085589 = __tmp__._0;
                        _size_4085595 = __tmp__._1;
                    };
                    _gotoNext = 4085709i32;
                } else if (__value__ == (4085709i32)) {
                    _i_4082678 = (_i_4082678 + (_size_4085595) : stdgo.GoInt);
                    _gotoNext = 4085722i32;
                } else if (__value__ == (4085722i32)) {
                    if (_verb_4085589 == ((37 : stdgo.GoInt32))) {
                        _gotoNext = 4085733i32;
                    } else if (!_p._goodArgNum) {
                        _gotoNext = 4085843i32;
                    } else if ((_argNum_4082499 >= (_a.length) : Bool)) {
                        _gotoNext = 4085886i32;
                    } else if (_verb_4085589 == ((119 : stdgo.GoInt32))) {
                        _gotoNext = 4085989i32;
                    } else if (_verb_4085589 == ((118 : stdgo.GoInt32))) {
                        _gotoNext = 4086073i32;
                    } else {
                        _gotoNext = 4086253i32;
                    };
                } else if (__value__ == (4085733i32)) {
                    _p._buf._writeByte((37 : stdgo.GoUInt8));
                    _gotoNext = 4082674i32;
                } else if (__value__ == (4085843i32)) {
                    _p._badArgNum(_verb_4085589);
                    _gotoNext = 4082674i32;
                } else if (__value__ == (4085886i32)) {
                    _p._missingArg(_verb_4085589);
                    _gotoNext = 4082674i32;
                } else if (__value__ == (4085989i32)) {
                    _p._wrappedErrs = (_p._wrappedErrs.__append__(_argNum_4082499));
                    _gotoNext = 4086073i32;
                } else if (__value__ == (4086073i32)) {
                    _p._fmt._fmtFlags._sharpV = _p._fmt._fmtFlags._sharp;
                    _p._fmt._fmtFlags._sharp = false;
                    _p._fmt._fmtFlags._plusV = _p._fmt._fmtFlags._plus;
                    _p._fmt._fmtFlags._plus = false;
                    _gotoNext = 4086253i32;
                } else if (__value__ == (4086253i32)) {
                    _p._printArg(_a[(_argNum_4082499 : stdgo.GoInt)], _verb_4085589);
                    _argNum_4082499++;
                    _gotoNext = 4082674i32;
                } else if (__value__ == (4086505i32)) {
                    if ((!_p._reordered && (_argNum_4082499 < (_a.length) : Bool) : Bool)) {
                        _gotoNext = 4086540i32;
                    } else {
                        _gotoNext = 4086896i32;
                    };
                } else if (__value__ == (4086540i32)) {
                    _p._fmt._clearflags();
                    _p._buf._writeString(("%!(EXTRA " : stdgo.GoString));
                    if ((0i32 : stdgo.GoInt) < ((_a.__slice__(_argNum_4082499) : stdgo.Slice<stdgo.AnyInterface>).length)) {
                        _gotoNext = 4086867i32;
                    } else {
                        _gotoNext = 4086872i32;
                    };
                } else if (__value__ == (4086602i32)) {
                    _i_4086602++;
                    _gotoNext = 4086868i32;
                } else if (__value__ == (4086629i32)) {
                    _arg_4086605 = stdgo.Go.toInterface((_a.__slice__(_argNum_4082499) : stdgo.Slice<stdgo.AnyInterface>)[(_i_4086602 : stdgo.GoInt)]);
                    if ((_i_4086602 > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4086643i32;
                    } else {
                        _gotoNext = 4086693i32;
                    };
                } else if (__value__ == (4086643i32)) {
                    _p._buf._writeString((", " : stdgo.GoString));
                    _gotoNext = 4086693i32;
                } else if (__value__ == (4086693i32)) {
                    if (_arg_4086605 == null) {
                        _gotoNext = 4086707i32;
                    } else {
                        _gotoNext = 4086757i32;
                    };
                } else if (__value__ == (4086707i32)) {
                    _p._buf._writeString(("<nil>" : stdgo.GoString));
                    _gotoNext = 4086602i32;
                } else if (__value__ == (4086757i32)) {
                    _gotoNext = 4086757i32;
                    _p._buf._writeString((stdgo._internal.reflect.Reflect_typeOf.typeOf(_arg_4086605).string() : stdgo.GoString)?.__copy__());
                    _p._buf._writeByte((61 : stdgo.GoUInt8));
                    _p._printArg(_arg_4086605, (118 : stdgo.GoInt32));
                    var __blank__ = 0i32;
                    _gotoNext = 4086602i32;
                } else if (__value__ == (4086867i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = stdgo.Go.toInterface((_a.__slice__(_argNum_4082499) : stdgo.Slice<stdgo.AnyInterface>)[(0i32 : stdgo.GoInt)]);
                        _i_4086602 = __tmp__0;
                        _arg_4086605 = __tmp__1;
                    };
                    _gotoNext = 4086868i32;
                } else if (__value__ == (4086868i32)) {
                    if (_i_4086602 < ((_a.__slice__(_argNum_4082499) : stdgo.Slice<stdgo.AnyInterface>).length)) {
                        _gotoNext = 4086629i32;
                    } else {
                        _gotoNext = 4086872i32;
                    };
                } else if (__value__ == (4086872i32)) {
                    _p._buf._writeByte((41 : stdgo.GoUInt8));
                    _gotoNext = 4086896i32;
                } else if (__value__ == (4086896i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
