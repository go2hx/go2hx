...
@:keep @:allow(stdgo._internal.fmt.Fmt.T_pp_asInterface) class T_pp_static_extension {
    ...
    static public function _doPrintf( _p:stdgo.Ref<stdgo._internal.fmt.Fmt_T_pp.T_pp>, _format:stdgo.GoString, _a:stdgo.Slice<stdgo.AnyInterface>):Void {
        @:recv var _p:stdgo.Ref<stdgo._internal.fmt.Fmt_T_pp.T_pp> = _p;
        var _i_4036415:stdgo.GoInt = (0 : stdgo.GoInt);
        var _size_4035408:stdgo.GoInt = (0 : stdgo.GoInt);
        var _argNum_4032312:stdgo.GoInt = (0 : stdgo.GoInt);
        var _end_4032292:stdgo.GoInt = (0 : stdgo.GoInt);
        var _lasti_4032534:stdgo.GoInt = (0 : stdgo.GoInt);
        var _formatLoopBreak = false;
        var _i_4032491:stdgo.GoInt = (0 : stdgo.GoInt);
        var _afterIndex_4032383:Bool = false;
        var _arg_4036418:stdgo.AnyInterface = (null : stdgo.AnyInterface);
        var _verb_4035402:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _c_4032831:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _end_4032292 = (_format.length);
                    _argNum_4032312 = (0 : stdgo.GoInt);
                    _afterIndex_4032383 = false;
                    _p._reordered = false;
                    _gotoNext = 4032474i32;
                } else if (__value__ == (4032474i32)) {
                    _i_4032491 = (0 : stdgo.GoInt);
                    _formatLoopBreak = false;
                    _gotoNext = 4032487i32;
                } else if (__value__ == (4032487i32)) {
                    if (!_formatLoopBreak && ((_i_4032491 < _end_4032292 : Bool))) {
                        _gotoNext = 4032508i32;
                    } else {
                        _gotoNext = 4036318i32;
                    };
                } else if (__value__ == (4032508i32)) {
                    _p._goodArgNum = true;
                    _lasti_4032534 = _i_4032491;
                    var __blank__ = 0i32;
                    _gotoNext = 4032547i32;
                } else if (__value__ == (4032547i32)) {
                    if (((_i_4032491 < _end_4032292 : Bool) && (_format[(_i_4032491 : stdgo.GoInt)] != (37 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4032579i32;
                    } else {
                        _gotoNext = 4032594i32;
                    };
                } else if (__value__ == (4032579i32)) {
                    _i_4032491++;
                    _gotoNext = 4032547i32;
                } else if (__value__ == (4032594i32)) {
                    if ((_i_4032491 > _lasti_4032534 : Bool)) {
                        _gotoNext = 4032607i32;
                    } else {
                        _gotoNext = 4032653i32;
                    };
                } else if (__value__ == (4032607i32)) {
                    _p._buf._writeString((_format.__slice__(_lasti_4032534, _i_4032491) : stdgo.GoString)?.__copy__());
                    _gotoNext = 4032653i32;
                } else if (__value__ == (4032653i32)) {
                    if ((_i_4032491 >= _end_4032292 : Bool)) {
                        _gotoNext = 4032665i32;
                    } else {
                        _gotoNext = 4032741i32;
                    };
                } else if (__value__ == (4032665i32)) {
                    _gotoNext = 4036318i32;
                } else if (__value__ == (4032741i32)) {
                    _i_4032491++;
                    _p._fmt._clearflags();
                    _gotoNext = 4032791i32;
                } else if (__value__ == (4032791i32)) {
                    var __blank__ = 0i32;
                    _simpleFormatBreak = false;
                    _gotoNext = 4032807i32;
                } else if (__value__ == (4032807i32)) {
                    if (!_simpleFormatBreak && ((_i_4032491 < _end_4032292 : Bool))) {
                        _gotoNext = 4032826i32;
                    } else {
                        _gotoNext = 4033861i32;
                    };
                } else if (__value__ == (4032822i32)) {
                    _i_4032491++;
                    _gotoNext = 4032807i32;
                } else if (__value__ == (4032826i32)) {
                    _c_4032831 = _format[(_i_4032491 : stdgo.GoInt)];
                    var __blank__ = 0i32;
                    _gotoNext = 4032849i32;
                } else if (__value__ == (4032849i32)) {
                    {
                        final __value__ = _c_4032831;
                        if (__value__ == ((35 : stdgo.GoUInt8))) {
                            _gotoNext = 4032863i32;
                        } else if (__value__ == ((48 : stdgo.GoUInt8))) {
                            _gotoNext = 4032899i32;
                        } else if (__value__ == ((43 : stdgo.GoUInt8))) {
                            _gotoNext = 4032982i32;
                        } else if (__value__ == ((45 : stdgo.GoUInt8))) {
                            _gotoNext = 4033017i32;
                        } else if (__value__ == ((32 : stdgo.GoUInt8))) {
                            _gotoNext = 4033115i32;
                        } else {
                            _gotoNext = 4033151i32;
                        };
                    };
                } else if (__value__ == (4032863i32)) {
                    _p._fmt._fmtFlags._sharp = true;
                    _gotoNext = 4032822i32;
                } else if (__value__ == (4032899i32)) {
                    _p._fmt._fmtFlags._zero = !_p._fmt._fmtFlags._minus;
                    _gotoNext = 4032822i32;
                } else if (__value__ == (4032982i32)) {
                    _p._fmt._fmtFlags._plus = true;
                    _gotoNext = 4032822i32;
                } else if (__value__ == (4033017i32)) {
                    _p._fmt._fmtFlags._minus = true;
                    _p._fmt._fmtFlags._zero = false;
                    _gotoNext = 4032822i32;
                } else if (__value__ == (4033115i32)) {
                    _p._fmt._fmtFlags._space = true;
                    _gotoNext = 4032822i32;
                } else if (__value__ == (4033151i32)) {
                    if (((((97 : stdgo.GoUInt8) <= _c_4032831 : Bool) && (_c_4032831 <= (122 : stdgo.GoUInt8) : Bool) : Bool) && (_argNum_4032312 < (_a.length) : Bool) : Bool)) {
                        _gotoNext = 4033328i32;
                    } else {
                        _gotoNext = 4033786i32;
                    };
                } else if (__value__ == (4033328i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 4033335i32;
                } else if (__value__ == (4033335i32)) {
                    {
                        final __value__ = _c_4032831;
                        if (__value__ == ((119 : stdgo.GoUInt8))) {
                            _gotoNext = 4033351i32;
                        } else if (__value__ == ((118 : stdgo.GoUInt8))) {
                            _gotoNext = 4033436i32;
                        } else {
                            _gotoNext = 4033621i32;
                        };
                    };
                } else if (__value__ == (4033351i32)) {
                    _p._wrappedErrs = (_p._wrappedErrs.__append__(_argNum_4032312));
                    _gotoNext = 4033436i32;
                } else if (__value__ == (4033436i32)) {
                    ...
                    _gotoNext = 4033621i32;
                } else if (__value__ == (4033621i32)) {
                    _p._printArg(_a[(_argNum_4032312 : stdgo.GoInt)], (_c_4032831 : stdgo.GoInt32));
                    _argNum_4032312++;
                    _i_4032491++;
                    _gotoNext = 4032487i32;
                } else if (__value__ == (4033786i32)) {
                    _simpleFormatBreak = true;
                    _gotoNext = 4032807i32;
                } else if (__value__ == (4033861i32)) {
                    {
                        var __tmp__ = _p._argNumber(_argNum_4032312, _format?.__copy__(), _i_4032491, (_a.length));
                        _argNum_4032312 = __tmp__._0;
                        _i_4032491 = __tmp__._1;
                        _afterIndex_4032383 = __tmp__._2;
                    };
                    if (((_i_4032491 < _end_4032292 : Bool) && (_format[(_i_4032491 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4033981i32;
                    } else {
                        _gotoNext = 4034388i32;
                    };
                } else if (__value__ == (4033981i32)) {
                    _i_4032491++;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__intFromArg._intFromArg(_a, _argNum_4032312);
                        _p._fmt._wid = __tmp__._0;
                        _p._fmt._fmtFlags._widPresent = __tmp__._1;
                        _argNum_4032312 = __tmp__._2;
                    };
                    if (!_p._fmt._fmtFlags._widPresent) {
                        _gotoNext = 4034078i32;
                    } else {
                        _gotoNext = 4034221i32;
                    };
                } else if (__value__ == (4034078i32)) {
                    _p._buf._writeString(("%!(BADWIDTH)" : stdgo.GoString));
                    _gotoNext = 4034221i32;
                } else if (__value__ == (4034221i32)) {
                    if ((_p._fmt._wid < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4034238i32;
                    } else {
                        _gotoNext = 4034360i32;
                    };
                } else if (__value__ == (4034238i32)) {
                    _p._fmt._wid = -_p._fmt._wid;
                    _p._fmt._fmtFlags._minus = true;
                    _p._fmt._fmtFlags._zero = false;
                    _gotoNext = 4034360i32;
                } else if (__value__ == (4034360i32)) {
                    _afterIndex_4032383 = false;
                    _gotoNext = 4034566i32;
                } else if (__value__ == (4034388i32)) {
                    _gotoNext = 4034388i32;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__parsenum._parsenum(_format?.__copy__(), _i_4032491, _end_4032292);
                        _p._fmt._wid = __tmp__._0;
                        _p._fmt._fmtFlags._widPresent = __tmp__._1;
                        _i_4032491 = __tmp__._2;
                    };
                    if ((_afterIndex_4032383 && _p._fmt._fmtFlags._widPresent : Bool)) {
                        _gotoNext = 4034488i32;
                    } else {
                        _gotoNext = 4034566i32;
                    };
                } else if (__value__ == (4034488i32)) {
                    _p._goodArgNum = false;
                    _gotoNext = 4034566i32;
                } else if (__value__ == (4034566i32)) {
                    if ((((_i_4032491 + (1 : stdgo.GoInt) : stdgo.GoInt) < _end_4032292 : Bool) && (_format[(_i_4032491 : stdgo.GoInt)] == (46 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4034599i32;
                    } else {
                        _gotoNext = 4035247i32;
                    };
                } else if (__value__ == (4034599i32)) {
                    _i_4032491++;
                    if (_afterIndex_4032383) {
                        _gotoNext = 4034625i32;
                    } else {
                        _gotoNext = 4034673i32;
                    };
                } else if (__value__ == (4034625i32)) {
                    _p._goodArgNum = false;
                    _gotoNext = 4034673i32;
                } else if (__value__ == (4034673i32)) {
                    {
                        var __tmp__ = _p._argNumber(_argNum_4032312, _format?.__copy__(), _i_4032491, (_a.length));
                        _argNum_4032312 = __tmp__._0;
                        _i_4032491 = __tmp__._1;
                    ...
                    if (((_i_4032491 < _end_4032292 : Bool) && (_format[(_i_4032491 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4034770i32;
                    } else {
                        _gotoNext = 4035085i32;
                    };
                } else if (__value__ == (4034770i32)) {
                    _i_4032491++;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__intFromArg._intFromArg(_a, _argNum_4032312);
                    ...
                    if ((_p._fmt._prec < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4034921i32;
                    } else {
                        _gotoNext = 4034984i32;
                    };
                } else if (__value__ == (4034921i32)) {
                    _p._fmt._prec = (0 : stdgo.GoInt);
                    _p._fmt._fmtFlags._precPresent = false;
                    _gotoNext = 4034984i32;
                } else if (__value__ == (4034984i32)) {
                    if (!_p._fmt._fmtFlags._precPresent) {
                        _gotoNext = 4035006i32;
                    } else {
                        _gotoNext = 4035056i32;
                    };
                } else if (__value__ == (4035006i32)) {
                    _p._buf._writeString(("%!(BADPREC)" : stdgo.GoString));
                    _gotoNext = 4035056i32;
                } else if (__value__ == (4035056i32)) {
                    _afterIndex_4032383 = false;
                    _gotoNext = 4035247i32;
                } else if (__value__ == (4035085i32)) {
                    _gotoNext = 4035085i32;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__parsenum._parsenum(_format?.__copy__(), _i_4032491, _end_4032292);
                        _p._fmt._prec = __tmp__._0;
                    ...
                    if (!_p._fmt._fmtFlags._precPresent) {
                        _gotoNext = 4035177i32;
                    } else {
                        _gotoNext = 4035247i32;
                    };
                } else if (__value__ == (4035177i32)) {
                    _p._fmt._prec = (0 : stdgo.GoInt);
                    _p._fmt._fmtFlags._precPresent = true;
                    _gotoNext = 4035247i32;
                } else if (__value__ == (4035247i32)) {
                    if (!_afterIndex_4032383) {
                        _gotoNext = 4035262i32;
                    } else {
                        _gotoNext = 4035337i32;
                    };
                } else if (__value__ == (4035262i32)) {
                    {
                        var __tmp__ = _p._argNumber(_argNum_4032312, _format?.__copy__(), _i_4032491, (_a.length));
                        _argNum_4032312 = __tmp__._0;
                        _i_4032491 = __tmp__._1;
                    ...
                    _gotoNext = 4035337i32;
                } else if (__value__ == (4035337i32)) {
                    if ((_i_4032491 >= _end_4032292 : Bool)) {
                        _gotoNext = 4035349i32;
                    } else {
                        _gotoNext = 4035402i32;
                    };
                } else if (__value__ == (4035349i32)) {
                    _p._buf._writeString(("%!(NOVERB)" : stdgo.GoString));
                    _gotoNext = 4036318i32;
                } else if (__value__ == (4035402i32)) {
                    {
                        final __tmp__0 = (_format[(_i_4032491 : stdgo.GoInt)] : stdgo.GoInt32);
                        final __tmp__1 = (1 : stdgo.GoInt);
                        _verb_4035402 = __tmp__0;
                        _size_4035408 = __tmp__1;
                    };
                    if ((_verb_4035402 >= (128 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 4035462i32;
                    } else {
                        _gotoNext = 4035522i32;
                    };
                } else if (__value__ == (4035462i32)) {
                    {
                        var __tmp__ = stdgo._internal.unicode.utf8.Utf8_decodeRuneInString.decodeRuneInString((_format.__slice__(_i_4032491) : stdgo.GoString)?.__copy__());
                        _verb_4035402 = __tmp__._0;
                        _size_4035408 = __tmp__._1;
                    };
                    _gotoNext = 4035522i32;
                } else if (__value__ == (4035522i32)) {
                    _i_4032491 = (_i_4032491 + (_size_4035408) : stdgo.GoInt);
                    var __blank__ = 0i32;
                    _gotoNext = 4035535i32;
                } else if (__value__ == (4035535i32)) {
                    if (_verb_4035402 == ((37 : stdgo.GoInt32))) {
                        _gotoNext = 4035546i32;
                    } else if (!_p._goodArgNum) {
                        _gotoNext = 4035656i32;
                    } else if ((_argNum_4032312 >= (_a.length) : Bool)) {
                        _gotoNext = 4035699i32;
                    } else if (_verb_4035402 == ((119 : stdgo.GoInt32))) {
                        _gotoNext = 4035802i32;
                    } else if (_verb_4035402 == ((118 : stdgo.GoInt32))) {
                        _gotoNext = 4035886i32;
                    } else {
                        _gotoNext = 4036066i32;
                    };
                } else if (__value__ == (4035546i32)) {
                    _p._buf._writeByte((37 : stdgo.GoUInt8));
                    _gotoNext = 4036318i32;
                } else if (__value__ == (4035656i32)) {
                    _p._badArgNum(_verb_4035402);
                    _gotoNext = 4036318i32;
                } else if (__value__ == (4035699i32)) {
                    _p._missingArg(_verb_4035402);
                    _gotoNext = 4036318i32;
                } else if (__value__ == (4035802i32)) {
                    _p._wrappedErrs = (_p._wrappedErrs.__append__(_argNum_4032312));
                    _gotoNext = 4035886i32;
                    ...
                    _p._fmt._fmtFlags._plus = false;
                    _gotoNext = 4036066i32;
                } else if (__value__ == (4036066i32)) {
                    _p._printArg(_a[(_argNum_4032312 : stdgo.GoInt)], _verb_4035402);
                    _argNum_4032312++;
                    _gotoNext = 4036318i32;
                } else if (__value__ == (4036318i32)) {
                    if ((!_p._reordered && (_argNum_4032312 < (_a.length) : Bool) : Bool)) {
                        _gotoNext = 4036353i32;
                    } else {
                        _gotoNext = 4036709i32;
                    };
                } else if (__value__ == (4036353i32)) {
                    _p._fmt._clearflags();
                    _p._buf._writeString(("%!(EXTRA " : stdgo.GoString));
                    if ((0i32 : stdgo.GoInt) < ((_a.__slice__(_argNum_4032312) : stdgo.Slice<stdgo.AnyInterface>).length)) {
                        _gotoNext = 4036680i32;
                    } else {
                        _gotoNext = 4036685i32;
                    };
                } else if (__value__ == (4036415i32)) {
                    _i_4036415++;
                    _gotoNext = 4036681i32;
                } else if (__value__ == (4036442i32)) {
                    _arg_4036418 = stdgo.Go.toInterface((_a.__slice__(_argNum_4032312) : stdgo.Slice<stdgo.AnyInterface>)[(_i_4036415 : stdgo.GoInt)]);
                    if ((_i_4036415 > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4036456i32;
                    } else {
                        _gotoNext = 4036506i32;
                    };
                } else if (__value__ == (4036456i32)) {
                    _p._buf._writeString((", " : stdgo.GoString));
                    _gotoNext = 4036506i32;
                } else if (__value__ == (4036506i32)) {
                    if (_arg_4036418 == null) {
                        _gotoNext = 4036520i32;
                    } else {
                        _gotoNext = 4036570i32;
                    };
                } else if (__value__ == (4036520i32)) {
                    _p._buf._writeString(("<nil>" : stdgo.GoString));
                    _gotoNext = 4036415i32;
                } else if (__value__ == (4036570i32)) {
                    _gotoNext = 4036570i32;
                    _p._buf._writeString((stdgo._internal.reflect.Reflect_typeOf.typeOf(_arg_4036418).string() : stdgo.GoString)?.__copy__());
                    _p._buf._writeByte((61 : stdgo.GoUInt8));
                    _p._printArg(_arg_4036418, (118 : stdgo.GoInt32));
                    var __blank__ = 0i32;
                    _gotoNext = 4036415i32;
                } else if (__value__ == (4036680i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = stdgo.Go.toInterface((_a.__slice__(_argNum_4032312) : stdgo.Slice<stdgo.AnyInterface>)[(0i32 : stdgo.GoInt)]);
                        _i_4036415 = __tmp__0;
                        _arg_4036418 = __tmp__1;
                    };
                    _gotoNext = 4036681i32;
                } else if (__value__ == (4036681i32)) {
                    if (_i_4036415 < ((_a.__slice__(_argNum_4032312) : stdgo.Slice<stdgo.AnyInterface>).length)) {
                        _gotoNext = 4036442i32;
                    } else {
                        _gotoNext = 4036685i32;
                    };
                } else if (__value__ == (4036685i32)) {
                    _p._buf._writeByte((41 : stdgo.GoUInt8));
                    _gotoNext = 4036709i32;
                } else if (__value__ == (4036709i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
