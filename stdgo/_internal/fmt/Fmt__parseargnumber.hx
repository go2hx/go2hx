...
function _parseArgNumber(_format:stdgo.GoString):{ var _0 : stdgo.GoInt; var _1 : stdgo.GoInt; var _2 : Bool; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/fmt/print.go#L976"
        if (((_format.length) < (3 : stdgo.GoInt) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/fmt/print.go#L977"
            return {
        ...
        //"file:///home/runner/.go/go1.21.3/src/fmt/print.go#L981"
        {
            var _i = (1 : stdgo.GoInt);
            while ((_i < (_format.length) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/fmt/print.go#L982"
                if (_format[(_i : stdgo.GoInt)] == ((93 : stdgo.GoUInt8))) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/fmt/print.go#L984"
                    if ((!_ok || (_newi != _i) : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/fmt/print.go#L985"
                        return {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/fmt/print.go#L987"
                    return {
        ...
        //"file:///home/runner/.go/go1.21.3/src/fmt/print.go#L990"
        return {
            @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoInt; var _1 : stdgo.GoInt; var _2 : Bool; } = { _0 : (0 : stdgo.GoInt), _1 : (1 : stdgo.GoInt), _2 : false };
            _index = __tmp__._0;
            _wid = __tmp__._1;
