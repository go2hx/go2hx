...
function formatString(_state:stdgo._internal.fmt.Fmt_state.State, _verb:stdgo.GoInt32):stdgo.GoString {
        ...
        //"file:///home/runner/.go/go1.21.3/src/fmt/print.go#L84"
        for (__0 => _c in (" +-#0" : stdgo.GoString)) {
            //"file:///home/runner/.go/go1.21.3/src/fmt/print.go#L85"
            if (_state.flag((_c : stdgo.GoInt))) {
                _b = (_b.__append__((_c : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>);
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/fmt/print.go#L89"
        {
        ...
        //"file:///home/runner/.go/go1.21.3/src/fmt/print.go#L92"
        {
        ...
        //"file:///home/runner/.go/go1.21.3/src/fmt/print.go#L97"
