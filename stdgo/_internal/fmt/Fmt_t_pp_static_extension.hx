        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4033481i32;
                } else if (__value__ == (4033481i32)) {
                    if ((_i_3 >= _end_0 : Bool)) {
                        _gotoNext = 4033493i32;
                    } else {
                        _gotoNext = 4033569i32;
                    };
                } else if (__value__ == (4033493i32)) {
                    _gotoNext = 4037146i32;
                } else if (__value__ == (4033569i32)) {
                    _i_3++;
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._fmt._clearflags();
                    _gotoNext = 4033619i32;
                } else if (__value__ == (4033619i32)) {
                    var __blank__ = 0i32;
                    _simpleFormatBreak = false;
                    _gotoNext = 4033635i32;
                } else if (__value__ == (4033635i32)) {
                    if (!_simpleFormatBreak && ((_i_3 < _end_0 : Bool))) {
                        _gotoNext = 4033654i32;
                    } else {
                        _gotoNext = 4034689i32;
                    };
                } else if (__value__ == (4033650i32)) {
                    _i_3++;
                    _gotoNext = 4033635i32;
                } else if (__value__ == (4033654i32)) {
                    ...
                    _gotoNext = 4033650i32;
                } else if (__value__ == (4033979i32)) {
                    if (((((97 : stdgo.GoUInt8) <= _c_5 : Bool) && (_c_5 <= (122 : stdgo.GoUInt8) : Bool) : Bool) && (_argNum_1 < (_a.length) : Bool) : Bool)) {
                        _gotoNext = 4034156i32;
                    } else {
                        _gotoNext = 4034614i32;
                    };
                } else if (__value__ == (4034156i32)) {
                    _gotoNext = 4034163i32;
                } else if (__value__ == (4034163i32)) {
                    {
                        final __value__ = _c_5;
                        if (__value__ == ((119 : stdgo.GoUInt8))) {
                            _gotoNext = 4034179i32;
                        } else if (__value__ == ((118 : stdgo.GoUInt8))) {
                            _gotoNext = 4034264i32;
                        } else {
                            _gotoNext = 4034449i32;
                        };
                    };
                    ...
                    if (((_i_3 < _end_0 : Bool) && (_format[(_i_3 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4034809i32;
                    } else {
                        _gotoNext = 4035216i32;
                    };
                } else if (__value__ == (4034809i32)) {
                    _i_3++;
                    {
                    ...
                    if (!(@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._widPresent) {
                        _gotoNext = 4034906i32;
                    } else {
                        _gotoNext = 4035049i32;
                    };
                } else if (__value__ == (4034906i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("%!(BADWIDTH)" : stdgo.GoString));
                    _gotoNext = 4035049i32;
                } else if (__value__ == (4035049i32)) {
                    ...
                    _afterIndex_2 = false;
                    _gotoNext = 4035394i32;
                } else if (__value__ == (4035216i32)) {
                    _gotoNext = 4035216i32;
                    {
                    ...
                    if ((_afterIndex_2 && (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._widPresent : Bool)) {
                        _gotoNext = 4035316i32;
                    } else {
                        _gotoNext = 4035394i32;
                    };
                } else if (__value__ == (4035316i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = false;
                    _gotoNext = 4035394i32;
                } else if (__value__ == (4035394i32)) {
                    if ((((_i_3 + (1 : stdgo.GoInt) : stdgo.GoInt) < _end_0 : Bool) && (_format[(_i_3 : stdgo.GoInt)] == (46 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4035427i32;
                    } else {
                        _gotoNext = 4036075i32;
                    };
                } else if (__value__ == (4035427i32)) {
                    _i_3++;
                    if (_afterIndex_2) {
                        _gotoNext = 4035453i32;
                    } else {
                        _gotoNext = 4035501i32;
                    };
                } else if (__value__ == (4035453i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = false;
                    _gotoNext = 4035501i32;
                } else if (__value__ == (4035501i32)) {
                    {
                        var __tmp__ = @:check2r _p._argNumber(_argNum_1, _format?.__copy__(), _i_3, (_a.length));
                        _argNum_1 = @:tmpset0 __tmp__._0;
                        _i_3 = @:tmpset0 __tmp__._1;
                    ...
                    if (((@:checkr _p ?? throw "null pointer dereference")._fmt._prec < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4035749i32;
                    } else {
                        _gotoNext = 4035812i32;
                    };
                } else if (__value__ == (4035749i32)) {
                    ...
                    if (!(@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._precPresent) {
                        _gotoNext = 4036005i32;
                    } else {
                        _gotoNext = 4036075i32;
                    };
                } else if (__value__ == (4036005i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._prec = (0 : stdgo.GoInt);
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._precPresent = true;
                    _gotoNext = 4036075i32;
                } else if (__value__ == (4036075i32)) {
                    if (!_afterIndex_2) {
                        _gotoNext = 4036090i32;
                    } else {
                        _gotoNext = 4036165i32;
                    };
                } else if (__value__ == (4036090i32)) {
                    {
                        var __tmp__ = @:check2r _p._argNumber(_argNum_1, _format?.__copy__(), _i_3, (_a.length));
                        _argNum_1 = @:tmpset0 __tmp__._0;
                        _i_3 = @:tmpset0 __tmp__._1;
                    ...
                    _gotoNext = 4036165i32;
                } else if (__value__ == (4036165i32)) {
                    if ((_i_3 >= _end_0 : Bool)) {
                        _gotoNext = 4036177i32;
                    } else {
                        _gotoNext = 4036230i32;
                    };
                } else if (__value__ == (4036177i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("%!(NOVERB)" : stdgo.GoString));
                    _gotoNext = 4037146i32;
                } else if (__value__ == (4036230i32)) {
                    {
                    ...
                    if ((_verb_6 >= (128 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 4036290i32;
                    } else {
                        _gotoNext = 4036350i32;
                    };
                } else if (__value__ == (4036290i32)) {
                    {
                    ...
                    if ((!(@:checkr _p ?? throw "null pointer dereference")._reordered && (_argNum_1 < (_a.length) : Bool) : Bool)) {
                        _gotoNext = 4037181i32;
                    } else {
                        _gotoNext = 4037537i32;
                    };
                } else if (__value__ == (4037181i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._fmt._clearflags();
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_a.__slice__(_argNum_1) : stdgo.Slice<stdgo.AnyInterface>).length)) {
                        _gotoNext = 4037508i32;
                    } else {
                        _gotoNext = 4037513i32;
                    };
                } else if (__value__ == (4037243i32)) {
                    _i_8++;
                    _gotoNext = 4037509i32;
                } else if (__value__ == (4037270i32)) {
                    ...
                    if ((_i_8 > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4037284i32;
                    } else {
                        _gotoNext = 4037334i32;
                    };
                } else if (__value__ == (4037284i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString((", " : stdgo.GoString));
                    _gotoNext = 4037334i32;
                } else if (__value__ == (4037334i32)) {
                    if (_arg_9 == null) {
                        _gotoNext = 4037348i32;
                    } else {
                        _gotoNext = 4037398i32;
                    };
                } else if (__value__ == (4037348i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("<nil>" : stdgo.GoString));
                    _gotoNext = 4037243i32;
                } else if (__value__ == (4037398i32)) {
                    _gotoNext = 4037398i32;
