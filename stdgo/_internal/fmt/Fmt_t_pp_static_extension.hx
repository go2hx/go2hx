        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4029674i32;
                } else if (__value__ == (4029674i32)) {
                    _i_3 = (0 : stdgo.GoInt);
                    _formatLoopBreak = false;
                    _gotoNext = 4029687i32;
                } else if (__value__ == (4029687i32)) {
                    if (!_formatLoopBreak && ((_i_3 < _end_0 : Bool))) {
                        _gotoNext = 4029708i32;
                    } else {
                        _gotoNext = 4033518i32;
                    };
                } else if (__value__ == (4029708i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = true;
                    _lasti_4 = _i_3;
                    0i32;
                    _gotoNext = 4029747i32;
                } else if (__value__ == (4029747i32)) {
                    if (((_i_3 < _end_0 : Bool) && (_format[(_i_3 : stdgo.GoInt)] != (37 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4029779i32;
                    } else {
                        _gotoNext = 4029794i32;
                    };
                } else if (__value__ == (4029779i32)) {
                    _i_3++;
                    _gotoNext = 4029747i32;
                } else if (__value__ == (4029794i32)) {
                    if ((_i_3 > _lasti_4 : Bool)) {
                        _gotoNext = 4029807i32;
                    } else {
                        _gotoNext = 4029853i32;
                    };
                } else if (__value__ == (4029807i32)) {
                    ...
                    _gotoNext = 4029853i32;
                } else if (__value__ == (4029853i32)) {
                    if ((_i_3 >= _end_0 : Bool)) {
                        _gotoNext = 4029865i32;
                    } else {
                        _gotoNext = 4029941i32;
                    };
                } else if (__value__ == (4029865i32)) {
                    _gotoNext = 4033518i32;
                } else if (__value__ == (4029941i32)) {
                    _i_3++;
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._fmt._clearflags();
                    _gotoNext = 4029991i32;
                } else if (__value__ == (4029991i32)) {
                    0i32;
                    _simpleFormatBreak = false;
                    _gotoNext = 4030007i32;
                } else if (__value__ == (4030007i32)) {
                    if (!_simpleFormatBreak && ((_i_3 < _end_0 : Bool))) {
                        _gotoNext = 4030026i32;
                    } else {
                        _gotoNext = 4031061i32;
                    };
                } else if (__value__ == (4030022i32)) {
                    _i_3++;
                    _gotoNext = 4030007i32;
                } else if (__value__ == (4030026i32)) {
                    _c_5 = _format[(_i_3 : stdgo.GoInt)];
                    _gotoNext = 4030049i32;
                } else if (__value__ == (4030049i32)) {
                    {
                        final __value__ = _c_5;
                        if (__value__ == ((35 : stdgo.GoUInt8))) {
                            _gotoNext = 4030063i32;
                        } else if (__value__ == ((48 : stdgo.GoUInt8))) {
                            _gotoNext = 4030099i32;
                        } else if (__value__ == ((43 : stdgo.GoUInt8))) {
                            _gotoNext = 4030182i32;
                        } else if (__value__ == ((45 : stdgo.GoUInt8))) {
                            _gotoNext = 4030217i32;
                        } else if (__value__ == ((32 : stdgo.GoUInt8))) {
                            _gotoNext = 4030315i32;
                        } else {
                            _gotoNext = 4030351i32;
                        };
                    };
                } else if (__value__ == (4030063i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._sharp = true;
                    _gotoNext = 4030022i32;
                } else if (__value__ == (4030099i32)) {
                    ...
                    if (((_i_3 < _end_0 : Bool) && (_format[(_i_3 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4031181i32;
                    } else {
                        _gotoNext = 4031588i32;
                    };
                } else if (__value__ == (4031181i32)) {
                    _i_3++;
                    {
                    ...
                    if ((_afterIndex_2 && (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._widPresent : Bool)) {
                        _gotoNext = 4031688i32;
                    } else {
                        _gotoNext = 4031766i32;
                    };
                } else if (__value__ == (4031688i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = false;
                    _gotoNext = 4031766i32;
                } else if (__value__ == (4031766i32)) {
                    if ((((_i_3 + (1 : stdgo.GoInt) : stdgo.GoInt) < _end_0 : Bool) && (_format[(_i_3 : stdgo.GoInt)] == (46 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4031799i32;
                    } else {
                        _gotoNext = 4032447i32;
                    };
                } else if (__value__ == (4031799i32)) {
                    _i_3++;
                    if (_afterIndex_2) {
                        _gotoNext = 4031825i32;
                    } else {
                        _gotoNext = 4031873i32;
                    };
                } else if (__value__ == (4031825i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = false;
                    _gotoNext = 4031873i32;
                } else if (__value__ == (4031873i32)) {
                    {
                        var __tmp__ = @:check2r _p._argNumber(_argNum_1, _format?.__copy__(), _i_3, (_a.length));
                        _argNum_1 = @:tmpset0 __tmp__._0;
                        _i_3 = @:tmpset0 __tmp__._1;
                    ...
                    if (((_i_3 < _end_0 : Bool) && (_format[(_i_3 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4031970i32;
                    } else {
                        _gotoNext = 4032285i32;
                    };
                } else if (__value__ == (4031970i32)) {
                    _i_3++;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__intfromarg._intFromArg(_a, _argNum_1);
                    ...
                    if (((@:checkr _p ?? throw "null pointer dereference")._fmt._prec < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4032121i32;
                    } else {
                        _gotoNext = 4032184i32;
                    };
                } else if (__value__ == (4032121i32)) {
                    ...
                    if (!(@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._precPresent) {
                        _gotoNext = 4032377i32;
                    } else {
                        _gotoNext = 4032447i32;
                    };
                } else if (__value__ == (4032377i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._prec = (0 : stdgo.GoInt);
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._precPresent = true;
                    _gotoNext = 4032447i32;
                } else if (__value__ == (4032447i32)) {
                    if (!_afterIndex_2) {
                        _gotoNext = 4032462i32;
                    } else {
                        _gotoNext = 4032537i32;
                    };
                } else if (__value__ == (4032462i32)) {
                    {
                        var __tmp__ = @:check2r _p._argNumber(_argNum_1, _format?.__copy__(), _i_3, (_a.length));
                        _argNum_1 = @:tmpset0 __tmp__._0;
                        _i_3 = @:tmpset0 __tmp__._1;
                    ...
                    _gotoNext = 4032537i32;
                } else if (__value__ == (4032537i32)) {
                    if ((_i_3 >= _end_0 : Bool)) {
                        _gotoNext = 4032549i32;
                    } else {
                        _gotoNext = 4032602i32;
                    };
                } else if (__value__ == (4032549i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("%!(NOVERB)" : stdgo.GoString));
                    _gotoNext = 4033518i32;
                } else if (__value__ == (4032602i32)) {
                    {
                    ...
                    if ((_verb_6 >= (128 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 4032662i32;
                    } else {
                        _gotoNext = 4032722i32;
                    };
                } else if (__value__ == (4032662i32)) {
                    {
                    ...
                    if ((!(@:checkr _p ?? throw "null pointer dereference")._reordered && (_argNum_1 < (_a.length) : Bool) : Bool)) {
                        _gotoNext = 4033553i32;
                    } else {
                        _gotoNext = 4033909i32;
                    };
                } else if (__value__ == (4033553i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._fmt._clearflags();
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_a.__slice__(_argNum_1) : stdgo.Slice<stdgo.AnyInterface>).length)) {
                        _gotoNext = 4033880i32;
                    } else {
                        _gotoNext = 4033885i32;
                    };
                } else if (__value__ == (4033615i32)) {
                    _i_8++;
                    _gotoNext = 4033881i32;
                    ...
                    if ((_i_8 > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4033656i32;
                    } else {
                        _gotoNext = 4033706i32;
                    };
                } else if (__value__ == (4033656i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString((", " : stdgo.GoString));
                    _gotoNext = 4033706i32;
                } else if (__value__ == (4033706i32)) {
                    if (_arg_9 == null) {
                        _gotoNext = 4033720i32;
                    } else {
                        _gotoNext = 4033770i32;
                    };
                } else if (__value__ == (4033720i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("<nil>" : stdgo.GoString));
                    _gotoNext = 4033615i32;
                } else if (__value__ == (4033770i32)) {
                    _gotoNext = 4033770i32;
