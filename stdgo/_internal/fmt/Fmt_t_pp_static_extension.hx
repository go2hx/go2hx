        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4047558i32;
                } else if (__value__ == (4047558i32)) {
                    _i_3 = (0 : stdgo.GoInt);
                    _formatLoopBreak = false;
                    _gotoNext = 4047571i32;
                } else if (__value__ == (4047571i32)) {
                    if (!_formatLoopBreak && ((_i_3 < _end_0 : Bool))) {
                        _gotoNext = 4047592i32;
                    } else {
                        _gotoNext = 4051402i32;
                    };
                } else if (__value__ == (4047592i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = true;
                    _lasti_4 = _i_3;
                    var __blank__ = 0i32;
                    _gotoNext = 4047631i32;
                } else if (__value__ == (4047631i32)) {
                    if (((_i_3 < _end_0 : Bool) && (_format[(_i_3 : stdgo.GoInt)] != (37 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4047663i32;
                    } else {
                        _gotoNext = 4047678i32;
                    };
                } else if (__value__ == (4047663i32)) {
                    _i_3++;
                    _gotoNext = 4047631i32;
                } else if (__value__ == (4047678i32)) {
                    if ((_i_3 > _lasti_4 : Bool)) {
                        _gotoNext = 4047691i32;
                    } else {
                        _gotoNext = 4047737i32;
                    };
                } else if (__value__ == (4047691i32)) {
                    ...
                    _gotoNext = 4047737i32;
                } else if (__value__ == (4047737i32)) {
                    if ((_i_3 >= _end_0 : Bool)) {
                        _gotoNext = 4047749i32;
                    } else {
                        _gotoNext = 4047825i32;
                    };
                } else if (__value__ == (4047749i32)) {
                    _gotoNext = 4051402i32;
                } else if (__value__ == (4047825i32)) {
                    _i_3++;
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._fmt._clearflags();
                    _gotoNext = 4047875i32;
                } else if (__value__ == (4047875i32)) {
                    var __blank__ = 0i32;
                    _simpleFormatBreak = false;
                    _gotoNext = 4047891i32;
                } else if (__value__ == (4047891i32)) {
                    if (!_simpleFormatBreak && ((_i_3 < _end_0 : Bool))) {
                        _gotoNext = 4047910i32;
                    } else {
                        _gotoNext = 4048945i32;
                    };
                } else if (__value__ == (4047906i32)) {
                    _i_3++;
                    _gotoNext = 4047891i32;
                } else if (__value__ == (4047910i32)) {
                    _c_5 = _format[(_i_3 : stdgo.GoInt)];
                    _gotoNext = 4047933i32;
                } else if (__value__ == (4047933i32)) {
                    {
                        final __value__ = _c_5;
                        if (__value__ == ((35 : stdgo.GoUInt8))) {
                            _gotoNext = 4047947i32;
                        } else if (__value__ == ((48 : stdgo.GoUInt8))) {
                            _gotoNext = 4047983i32;
                        } else if (__value__ == ((43 : stdgo.GoUInt8))) {
                            _gotoNext = 4048066i32;
                        } else if (__value__ == ((45 : stdgo.GoUInt8))) {
                            _gotoNext = 4048101i32;
                        } else if (__value__ == ((32 : stdgo.GoUInt8))) {
                            _gotoNext = 4048199i32;
                        } else {
                            _gotoNext = 4048235i32;
                        };
                    };
                } else if (__value__ == (4047947i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._sharp = true;
                    _gotoNext = 4047906i32;
                } else if (__value__ == (4047983i32)) {
                    ...
                    _gotoNext = 4047906i32;
                } else if (__value__ == (4048199i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._space = true;
                    _gotoNext = 4047906i32;
                } else if (__value__ == (4048235i32)) {
                    if (((((97 : stdgo.GoUInt8) <= _c_5 : Bool) && (_c_5 <= (122 : stdgo.GoUInt8) : Bool) : Bool) && (_argNum_1 < (_a.length) : Bool) : Bool)) {
                        _gotoNext = 4048412i32;
                    } else {
                        _gotoNext = 4048870i32;
                    };
                } else if (__value__ == (4048412i32)) {
                    _gotoNext = 4048419i32;
                } else if (__value__ == (4048419i32)) {
                    {
                        final __value__ = _c_5;
                        if (__value__ == ((119 : stdgo.GoUInt8))) {
                            _gotoNext = 4048435i32;
                        } else if (__value__ == ((118 : stdgo.GoUInt8))) {
                            _gotoNext = 4048520i32;
                        } else {
                            _gotoNext = 4048705i32;
                        };
                    };
                } else if (__value__ == (4048435i32)) {
                    ...
                    if (((_i_3 < _end_0 : Bool) && (_format[(_i_3 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4049065i32;
                    } else {
                        _gotoNext = 4049472i32;
                    };
                } else if (__value__ == (4049065i32)) {
                    _i_3++;
                    {
                    ...
                    if ((_afterIndex_2 && (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._widPresent : Bool)) {
                        _gotoNext = 4049572i32;
                    } else {
                        _gotoNext = 4049650i32;
                    };
                } else if (__value__ == (4049572i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = false;
                    _gotoNext = 4049650i32;
                } else if (__value__ == (4049650i32)) {
                    if ((((_i_3 + (1 : stdgo.GoInt) : stdgo.GoInt) < _end_0 : Bool) && (_format[(_i_3 : stdgo.GoInt)] == (46 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4049683i32;
                    } else {
                        _gotoNext = 4050331i32;
                    };
                } else if (__value__ == (4049683i32)) {
                    _i_3++;
                    if (_afterIndex_2) {
                        _gotoNext = 4049709i32;
                    } else {
                        _gotoNext = 4049757i32;
                    };
                } else if (__value__ == (4049709i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = false;
                    _gotoNext = 4049757i32;
                } else if (__value__ == (4049757i32)) {
                    {
                        var __tmp__ = @:check2r _p._argNumber(_argNum_1, _format?.__copy__(), _i_3, (_a.length));
                        _argNum_1 = @:tmpset0 __tmp__._0;
                        _i_3 = @:tmpset0 __tmp__._1;
                    ...
                    if (((_i_3 < _end_0 : Bool) && (_format[(_i_3 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4049854i32;
                    } else {
                        _gotoNext = 4050169i32;
                    };
                } else if (__value__ == (4049854i32)) {
                    _i_3++;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__intfromarg._intFromArg(_a, _argNum_1);
                    ...
                    if (((@:checkr _p ?? throw "null pointer dereference")._fmt._prec < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4050005i32;
                    } else {
                        _gotoNext = 4050068i32;
                    };
                } else if (__value__ == (4050005i32)) {
                    ...
                    if (!(@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._precPresent) {
                        _gotoNext = 4050261i32;
                    } else {
                        _gotoNext = 4050331i32;
                    };
                } else if (__value__ == (4050261i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._prec = (0 : stdgo.GoInt);
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._precPresent = true;
                    _gotoNext = 4050331i32;
                } else if (__value__ == (4050331i32)) {
                    if (!_afterIndex_2) {
                        _gotoNext = 4050346i32;
                    } else {
                        _gotoNext = 4050421i32;
                    };
                } else if (__value__ == (4050346i32)) {
                    {
                        var __tmp__ = @:check2r _p._argNumber(_argNum_1, _format?.__copy__(), _i_3, (_a.length));
                        _argNum_1 = @:tmpset0 __tmp__._0;
                        _i_3 = @:tmpset0 __tmp__._1;
                    ...
                    if ((_i_3 >= _end_0 : Bool)) {
                        _gotoNext = 4050433i32;
                    } else {
                        _gotoNext = 4050486i32;
                    };
                } else if (__value__ == (4050433i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("%!(NOVERB)" : stdgo.GoString));
                    _gotoNext = 4051402i32;
                } else if (__value__ == (4050486i32)) {
                    {
                    ...
                    if ((_verb_6 >= (128 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 4050546i32;
                    } else {
                        _gotoNext = 4050606i32;
                    };
                } else if (__value__ == (4050546i32)) {
                    {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_a.__slice__(_argNum_1) : stdgo.Slice<stdgo.AnyInterface>).length)) {
                        _gotoNext = 4051764i32;
                    } else {
                        _gotoNext = 4051769i32;
                    };
                } else if (__value__ == (4051499i32)) {
                    _i_8++;
                    _gotoNext = 4051765i32;
                } else if (__value__ == (4051526i32)) {
                    ...
                    if ((_i_8 > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4051540i32;
                    } else {
                        _gotoNext = 4051590i32;
                    };
                } else if (__value__ == (4051540i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString((", " : stdgo.GoString));
                    _gotoNext = 4051590i32;
                } else if (__value__ == (4051590i32)) {
                    if (_arg_9 == null) {
                        _gotoNext = 4051604i32;
                    } else {
                        _gotoNext = 4051654i32;
                    };
                } else if (__value__ == (4051604i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("<nil>" : stdgo.GoString));
                    _gotoNext = 4051499i32;
                } else if (__value__ == (4051654i32)) {
                    _gotoNext = 4051654i32;
