...
@:keep @:allow(stdgo._internal.fmt.Fmt.T_pp_asInterface) class T_pp_static_extension {
    ...
    static public function _doPrintf( _p:stdgo.Ref<stdgo._internal.fmt.Fmt_t_pp.T_pp>, _format:stdgo.GoString, _a:stdgo.Slice<stdgo.AnyInterface>):Void {
        @:recv var _p:stdgo.Ref<stdgo._internal.fmt.Fmt_t_pp.T_pp> = _p;
        var _i_4075980:stdgo.GoInt = (0 : stdgo.GoInt);
        var _size_4074973:stdgo.GoInt = (0 : stdgo.GoInt);
        var _simpleFormatBreak = false;
        var _lasti_4072099:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_4072056:stdgo.GoInt = (0 : stdgo.GoInt);
        var _afterIndex_4071948:Bool = false;
        var _argNum_4071877:stdgo.GoInt = (0 : stdgo.GoInt);
        var _end_4071857:stdgo.GoInt = (0 : stdgo.GoInt);
        var _verb_4074967:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _c_4072396:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _arg_4075983:stdgo.AnyInterface = (null : stdgo.AnyInterface);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _end_4071857 = (_format.length);
                    _argNum_4071877 = (0 : stdgo.GoInt);
                    _afterIndex_4071948 = false;
                    (@:checkr _p ?? throw "null pointer dereference")._reordered = false;
                    _gotoNext = 4072039i32;
                } else if (__value__ == (4072039i32)) {
                    _i_4072056 = (0 : stdgo.GoInt);
                    _formatLoopBreak = false;
                    _gotoNext = 4072052i32;
                } else if (__value__ == (4072052i32)) {
                    if (!_formatLoopBreak && ((_i_4072056 < _end_4071857 : Bool))) {
                        _gotoNext = 4072073i32;
                    } else {
                        _gotoNext = 4075883i32;
                    };
                } else if (__value__ == (4072073i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = true;
                    _lasti_4072099 = _i_4072056;
                    var __blank__ = 0i32;
                    _gotoNext = 4072112i32;
                } else if (__value__ == (4072112i32)) {
                    if (((_i_4072056 < _end_4071857 : Bool) && (_format[(_i_4072056 : stdgo.GoInt)] != (37 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4072144i32;
                    } else {
                        _gotoNext = 4072159i32;
                    };
                } else if (__value__ == (4072144i32)) {
                    _i_4072056++;
                    _gotoNext = 4072112i32;
                } else if (__value__ == (4072159i32)) {
                    if ((_i_4072056 > _lasti_4072099 : Bool)) {
                        _gotoNext = 4072172i32;
                    } else {
                        _gotoNext = 4072218i32;
                    };
                } else if (__value__ == (4072172i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString((_format.__slice__(_lasti_4072099, _i_4072056) : stdgo.GoString)?.__copy__());
                    _gotoNext = 4072218i32;
                } else if (__value__ == (4072218i32)) {
                    if ((_i_4072056 >= _end_4071857 : Bool)) {
                        _gotoNext = 4072230i32;
                    } else {
                        _gotoNext = 4072306i32;
                    };
                } else if (__value__ == (4072230i32)) {
                    _gotoNext = 4075883i32;
                } else if (__value__ == (4072306i32)) {
                    _i_4072056++;
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._fmt._clearflags();
                    _gotoNext = 4072356i32;
                } else if (__value__ == (4072356i32)) {
                    var __blank__ = 0i32;
                    _simpleFormatBreak = false;
                    _gotoNext = 4072372i32;
                } else if (__value__ == (4072372i32)) {
                    if (!_simpleFormatBreak && ((_i_4072056 < _end_4071857 : Bool))) {
                        _gotoNext = 4072391i32;
                    } else {
                        _gotoNext = 4073426i32;
                    };
                } else if (__value__ == (4072387i32)) {
                    _i_4072056++;
                    _gotoNext = 4072372i32;
                } else if (__value__ == (4072391i32)) {
                    _c_4072396 = _format[(_i_4072056 : stdgo.GoInt)];
                    _gotoNext = 4072414i32;
                } else if (__value__ == (4072414i32)) {
                    {
                        final __value__ = _c_4072396;
                        if (__value__ == ((35 : stdgo.GoUInt8))) {
                            _gotoNext = 4072428i32;
                        } else if (__value__ == ((48 : stdgo.GoUInt8))) {
                            _gotoNext = 4072464i32;
                        } else if (__value__ == ((43 : stdgo.GoUInt8))) {
                            _gotoNext = 4072547i32;
                        } else if (__value__ == ((45 : stdgo.GoUInt8))) {
                            _gotoNext = 4072582i32;
                        } else if (__value__ == ((32 : stdgo.GoUInt8))) {
                            _gotoNext = 4072680i32;
                        } else {
                            _gotoNext = 4072716i32;
                        };
                    };
                } else if (__value__ == (4072428i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._sharp = true;
                    _gotoNext = 4072387i32;
                } else if (__value__ == (4072464i32)) {
                    ...
                    _gotoNext = 4072387i32;
                } else if (__value__ == (4072680i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._space = true;
                    _gotoNext = 4072387i32;
                } else if (__value__ == (4072716i32)) {
                    if (((((97 : stdgo.GoUInt8) <= _c_4072396 : Bool) && (_c_4072396 <= (122 : stdgo.GoUInt8) : Bool) : Bool) && (_argNum_4071877 < (_a.length) : Bool) : Bool)) {
                        _gotoNext = 4072893i32;
                    } else {
                        _gotoNext = 4073351i32;
                    };
                } else if (__value__ == (4072893i32)) {
                    _gotoNext = 4072900i32;
                } else if (__value__ == (4072900i32)) {
                    {
                        final __value__ = _c_4072396;
                        if (__value__ == ((119 : stdgo.GoUInt8))) {
                            _gotoNext = 4072916i32;
                        } else if (__value__ == ((118 : stdgo.GoUInt8))) {
                            _gotoNext = 4073001i32;
                        } else {
                            _gotoNext = 4073186i32;
                        };
                    };
                } else if (__value__ == (4072916i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._wrappedErrs = ((@:checkr _p ?? throw "null pointer dereference")._wrappedErrs.__append__(_argNum_4071877));
                    _gotoNext = 4073001i32;
                } else if (__value__ == (4073001i32)) {
                    ...
                    _gotoNext = 4073186i32;
                } else if (__value__ == (4073186i32)) {
                    @:check2r _p._printArg(_a[(_argNum_4071877 : stdgo.GoInt)], (_c_4072396 : stdgo.GoInt32));
                    _argNum_4071877++;
                    _i_4072056++;
                    _gotoNext = 4072052i32;
                } else if (__value__ == (4073351i32)) {
                    _simpleFormatBreak = true;
                    _gotoNext = 4072372i32;
                } else if (__value__ == (4073426i32)) {
                    {
                        var __tmp__ = @:check2r _p._argNumber(_argNum_4071877, _format?.__copy__(), _i_4072056, (_a.length));
                        _argNum_4071877 = @:tmpset0 __tmp__._0;
                        _i_4072056 = @:tmpset0 __tmp__._1;
                        _afterIndex_4071948 = @:tmpset0 __tmp__._2;
                    };
                    if (((_i_4072056 < _end_4071857 : Bool) && (_format[(_i_4072056 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4073546i32;
                    } else {
                        _gotoNext = 4073953i32;
                    };
                } else if (__value__ == (4073546i32)) {
                    _i_4072056++;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__intfromarg._intFromArg(_a, _argNum_4071877);
                        ...
                        _argNum_4071877 = @:tmpset0 __tmp__._2;
                    };
                    if (!(@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._widPresent) {
                        _gotoNext = 4073643i32;
                    } else {
                        _gotoNext = 4073786i32;
                    };
                } else if (__value__ == (4073643i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("%!(BADWIDTH)" : stdgo.GoString));
                    _gotoNext = 4073786i32;
                } else if (__value__ == (4073786i32)) {
                    if (((@:checkr _p ?? throw "null pointer dereference")._fmt._wid < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4073803i32;
                    } else {
                        _gotoNext = 4073925i32;
                    };
                } else if (__value__ == (4073803i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._wid = -(@:checkr _p ?? throw "null pointer dereference")._fmt._wid;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._minus = true;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._zero = false;
                    _gotoNext = 4073925i32;
                } else if (__value__ == (4073925i32)) {
                    _afterIndex_4071948 = false;
                    _gotoNext = 4074131i32;
                } else if (__value__ == (4073953i32)) {
                    _gotoNext = 4073953i32;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__parsenum._parsenum(_format?.__copy__(), _i_4072056, _end_4071857);
                        (@:checkr _p ?? throw "null pointer dereference")._fmt._wid = @:tmpset0 __tmp__._0;
                        (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._widPresent = @:tmpset0 __tmp__._1;
                        _i_4072056 = @:tmpset0 __tmp__._2;
                    };
                    if ((_afterIndex_4071948 && (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._widPresent : Bool)) {
                        _gotoNext = 4074053i32;
                    } else {
                        _gotoNext = 4074131i32;
                    };
                } else if (__value__ == (4074053i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = false;
                    _gotoNext = 4074131i32;
                } else if (__value__ == (4074131i32)) {
                    if ((((_i_4072056 + (1 : stdgo.GoInt) : stdgo.GoInt) < _end_4071857 : Bool) && (_format[(_i_4072056 : stdgo.GoInt)] == (46 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4074164i32;
                    } else {
                        _gotoNext = 4074812i32;
                    };
                } else if (__value__ == (4074164i32)) {
                    _i_4072056++;
                    if (_afterIndex_4071948) {
                        _gotoNext = 4074190i32;
                    } else {
                        _gotoNext = 4074238i32;
                    };
                } else if (__value__ == (4074190i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = false;
                    _gotoNext = 4074238i32;
                } else if (__value__ == (4074238i32)) {
                    {
                        var __tmp__ = @:check2r _p._argNumber(_argNum_4071877, _format?.__copy__(), _i_4072056, (_a.length));
                        _argNum_4071877 = @:tmpset0 __tmp__._0;
                        _i_4072056 = @:tmpset0 __tmp__._1;
                    ...
                    if (((_i_4072056 < _end_4071857 : Bool) && (_format[(_i_4072056 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4074335i32;
                    } else {
                        _gotoNext = 4074650i32;
                    };
                } else if (__value__ == (4074335i32)) {
                    _i_4072056++;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__intfromarg._intFromArg(_a, _argNum_4071877);
                    ...
                    if (((@:checkr _p ?? throw "null pointer dereference")._fmt._prec < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4074486i32;
                    } else {
                        _gotoNext = 4074549i32;
                    };
                } else if (__value__ == (4074486i32)) {
                    ...
                    if (!(@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._precPresent) {
                        _gotoNext = 4074742i32;
                    } else {
                        _gotoNext = 4074812i32;
                    };
                } else if (__value__ == (4074742i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._prec = (0 : stdgo.GoInt);
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._precPresent = true;
                    _gotoNext = 4074812i32;
                } else if (__value__ == (4074812i32)) {
                    if (!_afterIndex_4071948) {
                        _gotoNext = 4074827i32;
                    } else {
                        _gotoNext = 4074902i32;
                    };
                } else if (__value__ == (4074827i32)) {
                    {
                        var __tmp__ = @:check2r _p._argNumber(_argNum_4071877, _format?.__copy__(), _i_4072056, (_a.length));
                        _argNum_4071877 = @:tmpset0 __tmp__._0;
                        _i_4072056 = @:tmpset0 __tmp__._1;
                    ...
                    _gotoNext = 4074902i32;
                } else if (__value__ == (4074902i32)) {
                    if ((_i_4072056 >= _end_4071857 : Bool)) {
                        _gotoNext = 4074914i32;
                    } else {
                        _gotoNext = 4074967i32;
                    };
                } else if (__value__ == (4074914i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("%!(NOVERB)" : stdgo.GoString));
                    _gotoNext = 4075883i32;
                } else if (__value__ == (4074967i32)) {
                    {
                        final __tmp__0 = (_format[(_i_4072056 : stdgo.GoInt)] : stdgo.GoInt32);
                        final __tmp__1 = (1 : stdgo.GoInt);
                        _verb_4074967 = __tmp__0;
                        _size_4074973 = __tmp__1;
                    };
                    if ((_verb_4074967 >= (128 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 4075027i32;
                    } else {
                        _gotoNext = 4075087i32;
                    };
                } else if (__value__ == (4075027i32)) {
                    {
                        var __tmp__ = stdgo._internal.unicode.utf8.Utf8_decoderuneinstring.decodeRuneInString((_format.__slice__(_i_4072056) : stdgo.GoString)?.__copy__());
                        _verb_4074967 = @:tmpset0 __tmp__._0;
                        _size_4074973 = @:tmpset0 __tmp__._1;
                    };
                    _gotoNext = 4075087i32;
                } else if (__value__ == (4075087i32)) {
                    _i_4072056 = (_i_4072056 + (_size_4074973) : stdgo.GoInt);
                    _gotoNext = 4075100i32;
                } else if (__value__ == (4075100i32)) {
                    if (_verb_4074967 == ((37 : stdgo.GoInt32))) {
                        _gotoNext = 4075111i32;
                    } else if (!(@:checkr _p ?? throw "null pointer dereference")._goodArgNum) {
                        _gotoNext = 4075221i32;
                    } else if ((_argNum_4071877 >= (_a.length) : Bool)) {
                        _gotoNext = 4075264i32;
                    } else if (_verb_4074967 == ((119 : stdgo.GoInt32))) {
                        _gotoNext = 4075367i32;
                    } else if (_verb_4074967 == ((118 : stdgo.GoInt32))) {
                        _gotoNext = 4075451i32;
                    } else {
                        _gotoNext = 4075631i32;
                    };
                } else if (__value__ == (4075111i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeByte((37 : stdgo.GoUInt8));
                    _gotoNext = 4072052i32;
                } else if (__value__ == (4075221i32)) {
                    @:check2r _p._badArgNum(_verb_4074967);
                    _gotoNext = 4072052i32;
                } else if (__value__ == (4075264i32)) {
                    @:check2r _p._missingArg(_verb_4074967);
                    _gotoNext = 4072052i32;
                } else if (__value__ == (4075367i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._wrappedErrs = ((@:checkr _p ?? throw "null pointer dereference")._wrappedErrs.__append__(_argNum_4071877));
                    _gotoNext = 4075451i32;
                } else if (__value__ == (4075451i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._sharpV = (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._sharp;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._sharp = false;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._plusV = (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._plus;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._plus = false;
                    _gotoNext = 4075631i32;
                } else if (__value__ == (4075631i32)) {
                    @:check2r _p._printArg(_a[(_argNum_4071877 : stdgo.GoInt)], _verb_4074967);
                    _argNum_4071877++;
                    _gotoNext = 4072052i32;
                } else if (__value__ == (4075883i32)) {
                    if ((!(@:checkr _p ?? throw "null pointer dereference")._reordered && (_argNum_4071877 < (_a.length) : Bool) : Bool)) {
                        _gotoNext = 4075918i32;
                    } else {
                        _gotoNext = 4076274i32;
                    };
                } else if (__value__ == (4075918i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._fmt._clearflags();
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("%!(EXTRA " : stdgo.GoString));
                    if ((0i32 : stdgo.GoInt) < ((_a.__slice__(_argNum_4071877) : stdgo.Slice<stdgo.AnyInterface>).length)) {
                        _gotoNext = 4076245i32;
                    } else {
                        _gotoNext = 4076250i32;
                    };
                } else if (__value__ == (4075980i32)) {
                    _i_4075980++;
                    _gotoNext = 4076246i32;
                } else if (__value__ == (4076007i32)) {
                    _arg_4075983 = stdgo.Go.toInterface((_a.__slice__(_argNum_4071877) : stdgo.Slice<stdgo.AnyInterface>)[(_i_4075980 : stdgo.GoInt)]);
                    if ((_i_4075980 > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4076021i32;
                    } else {
                        _gotoNext = 4076071i32;
                    };
                } else if (__value__ == (4076021i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString((", " : stdgo.GoString));
                    _gotoNext = 4076071i32;
                } else if (__value__ == (4076071i32)) {
                    if (_arg_4075983 == null) {
                        _gotoNext = 4076085i32;
                    } else {
                        _gotoNext = 4076135i32;
                    };
                } else if (__value__ == (4076085i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("<nil>" : stdgo.GoString));
                    _gotoNext = 4075980i32;
                } else if (__value__ == (4076135i32)) {
                    _gotoNext = 4076135i32;
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString((stdgo._internal.reflect.Reflect_typeof.typeOf(_arg_4075983).string() : stdgo.GoString)?.__copy__());
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeByte((61 : stdgo.GoUInt8));
                    @:check2r _p._printArg(_arg_4075983, (118 : stdgo.GoInt32));
                    var __blank__ = 0i32;
                    _gotoNext = 4075980i32;
                } else if (__value__ == (4076245i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = stdgo.Go.toInterface((_a.__slice__(_argNum_4071877) : stdgo.Slice<stdgo.AnyInterface>)[(0i32 : stdgo.GoInt)]);
                        _i_4075980 = __tmp__0;
                        _arg_4075983 = __tmp__1;
                    };
                    _gotoNext = 4076246i32;
                } else if (__value__ == (4076246i32)) {
                    if (_i_4075980 < ((_a.__slice__(_argNum_4071877) : stdgo.Slice<stdgo.AnyInterface>).length)) {
                        _gotoNext = 4076007i32;
                    } else {
                        _gotoNext = 4076250i32;
                    };
                } else if (__value__ == (4076250i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeByte((41 : stdgo.GoUInt8));
                    _gotoNext = 4076274i32;
                } else if (__value__ == (4076274i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
