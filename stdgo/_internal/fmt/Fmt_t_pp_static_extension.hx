...
@:keep @:allow(stdgo._internal.fmt.Fmt.T_pp_asInterface) class T_pp_static_extension {
    ...
    static public function _doPrintf( _p:stdgo.Ref<stdgo._internal.fmt.Fmt_t_pp.T_pp>, _format:stdgo.GoString, _a:stdgo.Slice<stdgo.AnyInterface>):Void {
        @:recv var _p:stdgo.Ref<stdgo._internal.fmt.Fmt_t_pp.T_pp> = _p;
        var _i_4025995:stdgo.GoInt = (0 : stdgo.GoInt);
        var _end_4025796:stdgo.GoInt = (0 : stdgo.GoInt);
        var _size_4028912:stdgo.GoInt = (0 : stdgo.GoInt);
        var _verb_4028906:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _c_4026335:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _afterIndex_4025887:Bool = false;
        var _argNum_4025816:stdgo.GoInt = (0 : stdgo.GoInt);
        var _arg_4029922:stdgo.AnyInterface = (null : stdgo.AnyInterface);
        var _i_4029919:stdgo.GoInt = (0 : stdgo.GoInt);
        var _simpleFormatBreak = false;
        var _lasti_4026038:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _end_4025796 = (_format.length);
                    _argNum_4025816 = (0 : stdgo.GoInt);
                    _afterIndex_4025887 = false;
                    (@:checkr _p ?? throw "null pointer dereference")._reordered = false;
                    _gotoNext = 4025978i32;
                } else if (__value__ == (4025978i32)) {
                    _i_4025995 = (0 : stdgo.GoInt);
                    _formatLoopBreak = false;
                    _gotoNext = 4025991i32;
                } else if (__value__ == (4025991i32)) {
                    if (!_formatLoopBreak && ((_i_4025995 < _end_4025796 : Bool))) {
                        _gotoNext = 4026012i32;
                    } else {
                        _gotoNext = 4029822i32;
                    };
                } else if (__value__ == (4026012i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = true;
                    _lasti_4026038 = _i_4025995;
                    var __blank__ = 0i32;
                    _gotoNext = 4026051i32;
                } else if (__value__ == (4026051i32)) {
                    if (((_i_4025995 < _end_4025796 : Bool) && (_format[(_i_4025995 : stdgo.GoInt)] != (37 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4026083i32;
                    } else {
                        _gotoNext = 4026098i32;
                    };
                } else if (__value__ == (4026083i32)) {
                    _i_4025995++;
                    _gotoNext = 4026051i32;
                } else if (__value__ == (4026098i32)) {
                    if ((_i_4025995 > _lasti_4026038 : Bool)) {
                        _gotoNext = 4026111i32;
                    } else {
                        _gotoNext = 4026157i32;
                    };
                } else if (__value__ == (4026111i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString((_format.__slice__(_lasti_4026038, _i_4025995) : stdgo.GoString)?.__copy__());
                    _gotoNext = 4026157i32;
                } else if (__value__ == (4026157i32)) {
                    if ((_i_4025995 >= _end_4025796 : Bool)) {
                        _gotoNext = 4026169i32;
                    } else {
                        _gotoNext = 4026245i32;
                    };
                } else if (__value__ == (4026169i32)) {
                    _gotoNext = 4029822i32;
                } else if (__value__ == (4026245i32)) {
                    _i_4025995++;
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._fmt._clearflags();
                    _gotoNext = 4026295i32;
                } else if (__value__ == (4026295i32)) {
                    var __blank__ = 0i32;
                    _simpleFormatBreak = false;
                    _gotoNext = 4026311i32;
                } else if (__value__ == (4026311i32)) {
                    if (!_simpleFormatBreak && ((_i_4025995 < _end_4025796 : Bool))) {
                        _gotoNext = 4026330i32;
                    } else {
                        _gotoNext = 4027365i32;
                    };
                } else if (__value__ == (4026326i32)) {
                    _i_4025995++;
                    _gotoNext = 4026311i32;
                } else if (__value__ == (4026330i32)) {
                    _c_4026335 = _format[(_i_4025995 : stdgo.GoInt)];
                    _gotoNext = 4026353i32;
                } else if (__value__ == (4026353i32)) {
                    {
                        final __value__ = _c_4026335;
                        if (__value__ == ((35 : stdgo.GoUInt8))) {
                            _gotoNext = 4026367i32;
                        } else if (__value__ == ((48 : stdgo.GoUInt8))) {
                            _gotoNext = 4026403i32;
                        } else if (__value__ == ((43 : stdgo.GoUInt8))) {
                            _gotoNext = 4026486i32;
                        } else if (__value__ == ((45 : stdgo.GoUInt8))) {
                            _gotoNext = 4026521i32;
                        } else if (__value__ == ((32 : stdgo.GoUInt8))) {
                            _gotoNext = 4026619i32;
                        } else {
                            _gotoNext = 4026655i32;
                        };
                    };
                } else if (__value__ == (4026367i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._sharp = true;
                    _gotoNext = 4026326i32;
                } else if (__value__ == (4026403i32)) {
                    ...
                    _gotoNext = 4026326i32;
                } else if (__value__ == (4026619i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._space = true;
                    _gotoNext = 4026326i32;
                } else if (__value__ == (4026655i32)) {
                    if (((((97 : stdgo.GoUInt8) <= _c_4026335 : Bool) && (_c_4026335 <= (122 : stdgo.GoUInt8) : Bool) : Bool) && (_argNum_4025816 < (_a.length) : Bool) : Bool)) {
                        _gotoNext = 4026832i32;
                    } else {
                        _gotoNext = 4027290i32;
                    };
                } else if (__value__ == (4026832i32)) {
                    _gotoNext = 4026839i32;
                } else if (__value__ == (4026839i32)) {
                    {
                        final __value__ = _c_4026335;
                        if (__value__ == ((119 : stdgo.GoUInt8))) {
                            _gotoNext = 4026855i32;
                        } else if (__value__ == ((118 : stdgo.GoUInt8))) {
                            _gotoNext = 4026940i32;
                        } else {
                            _gotoNext = 4027125i32;
                        };
                    };
                } else if (__value__ == (4026855i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._wrappedErrs = ((@:checkr _p ?? throw "null pointer dereference")._wrappedErrs.__append__(_argNum_4025816));
                    _gotoNext = 4026940i32;
                } else if (__value__ == (4026940i32)) {
                    ...
                    _gotoNext = 4027125i32;
                } else if (__value__ == (4027125i32)) {
                    @:check2r _p._printArg(_a[(_argNum_4025816 : stdgo.GoInt)], (_c_4026335 : stdgo.GoInt32));
                    _argNum_4025816++;
                    _i_4025995++;
                    _gotoNext = 4025991i32;
                } else if (__value__ == (4027290i32)) {
                    _simpleFormatBreak = true;
                    _gotoNext = 4026311i32;
                } else if (__value__ == (4027365i32)) {
                    {
                        var __tmp__ = @:check2r _p._argNumber(_argNum_4025816, _format?.__copy__(), _i_4025995, (_a.length));
                        _argNum_4025816 = @:tmpset0 __tmp__._0;
                        _i_4025995 = @:tmpset0 __tmp__._1;
                        _afterIndex_4025887 = @:tmpset0 __tmp__._2;
                    };
                    if (((_i_4025995 < _end_4025796 : Bool) && (_format[(_i_4025995 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4027485i32;
                    } else {
                        _gotoNext = 4027892i32;
                    };
                } else if (__value__ == (4027485i32)) {
                    _i_4025995++;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__intfromarg._intFromArg(_a, _argNum_4025816);
                        ...
                        _argNum_4025816 = @:tmpset0 __tmp__._2;
                    };
                    if (!(@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._widPresent) {
                        _gotoNext = 4027582i32;
                    } else {
                        _gotoNext = 4027725i32;
                    };
                } else if (__value__ == (4027582i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("%!(BADWIDTH)" : stdgo.GoString));
                    _gotoNext = 4027725i32;
                } else if (__value__ == (4027725i32)) {
                    if (((@:checkr _p ?? throw "null pointer dereference")._fmt._wid < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4027742i32;
                    } else {
                        _gotoNext = 4027864i32;
                    };
                } else if (__value__ == (4027742i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._wid = -(@:checkr _p ?? throw "null pointer dereference")._fmt._wid;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._minus = true;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._zero = false;
                    _gotoNext = 4027864i32;
                } else if (__value__ == (4027864i32)) {
                    _afterIndex_4025887 = false;
                    _gotoNext = 4028070i32;
                } else if (__value__ == (4027892i32)) {
                    _gotoNext = 4027892i32;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__parsenum._parsenum(_format?.__copy__(), _i_4025995, _end_4025796);
                        (@:checkr _p ?? throw "null pointer dereference")._fmt._wid = @:tmpset0 __tmp__._0;
                        (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._widPresent = @:tmpset0 __tmp__._1;
                        _i_4025995 = @:tmpset0 __tmp__._2;
                    };
                    if ((_afterIndex_4025887 && (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._widPresent : Bool)) {
                        _gotoNext = 4027992i32;
                    } else {
                        _gotoNext = 4028070i32;
                    };
                } else if (__value__ == (4027992i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = false;
                    _gotoNext = 4028070i32;
                } else if (__value__ == (4028070i32)) {
                    if ((((_i_4025995 + (1 : stdgo.GoInt) : stdgo.GoInt) < _end_4025796 : Bool) && (_format[(_i_4025995 : stdgo.GoInt)] == (46 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4028103i32;
                    } else {
                        _gotoNext = 4028751i32;
                    };
                } else if (__value__ == (4028103i32)) {
                    _i_4025995++;
                    if (_afterIndex_4025887) {
                        _gotoNext = 4028129i32;
                    } else {
                        _gotoNext = 4028177i32;
                    };
                } else if (__value__ == (4028129i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = false;
                    _gotoNext = 4028177i32;
                } else if (__value__ == (4028177i32)) {
                    {
                        var __tmp__ = @:check2r _p._argNumber(_argNum_4025816, _format?.__copy__(), _i_4025995, (_a.length));
                        _argNum_4025816 = @:tmpset0 __tmp__._0;
                        _i_4025995 = @:tmpset0 __tmp__._1;
                    ...
                    if (((_i_4025995 < _end_4025796 : Bool) && (_format[(_i_4025995 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4028274i32;
                    } else {
                        _gotoNext = 4028589i32;
                    };
                } else if (__value__ == (4028274i32)) {
                    _i_4025995++;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__intfromarg._intFromArg(_a, _argNum_4025816);
                    ...
                    if (((@:checkr _p ?? throw "null pointer dereference")._fmt._prec < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4028425i32;
                    } else {
                        _gotoNext = 4028488i32;
                    };
                } else if (__value__ == (4028425i32)) {
                    ...
                    if (!(@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._precPresent) {
                        _gotoNext = 4028681i32;
                    } else {
                        _gotoNext = 4028751i32;
                    };
                } else if (__value__ == (4028681i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._prec = (0 : stdgo.GoInt);
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._precPresent = true;
                    _gotoNext = 4028751i32;
                } else if (__value__ == (4028751i32)) {
                    if (!_afterIndex_4025887) {
                        _gotoNext = 4028766i32;
                    } else {
                        _gotoNext = 4028841i32;
                    };
                } else if (__value__ == (4028766i32)) {
                    {
                        var __tmp__ = @:check2r _p._argNumber(_argNum_4025816, _format?.__copy__(), _i_4025995, (_a.length));
                        _argNum_4025816 = @:tmpset0 __tmp__._0;
                        _i_4025995 = @:tmpset0 __tmp__._1;
                    ...
                    _gotoNext = 4028841i32;
                } else if (__value__ == (4028841i32)) {
                    if ((_i_4025995 >= _end_4025796 : Bool)) {
                        _gotoNext = 4028853i32;
                    } else {
                        _gotoNext = 4028906i32;
                    };
                } else if (__value__ == (4028853i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("%!(NOVERB)" : stdgo.GoString));
                    _gotoNext = 4029822i32;
                } else if (__value__ == (4028906i32)) {
                    {
                        final __tmp__0 = (_format[(_i_4025995 : stdgo.GoInt)] : stdgo.GoInt32);
                        final __tmp__1 = (1 : stdgo.GoInt);
                        _verb_4028906 = __tmp__0;
                        _size_4028912 = __tmp__1;
                    };
                    if ((_verb_4028906 >= (128 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 4028966i32;
                    } else {
                        _gotoNext = 4029026i32;
                    };
                } else if (__value__ == (4028966i32)) {
                    {
                        var __tmp__ = stdgo._internal.unicode.utf8.Utf8_decoderuneinstring.decodeRuneInString((_format.__slice__(_i_4025995) : stdgo.GoString)?.__copy__());
                        _verb_4028906 = @:tmpset0 __tmp__._0;
                        _size_4028912 = @:tmpset0 __tmp__._1;
                    };
                    _gotoNext = 4029026i32;
                } else if (__value__ == (4029026i32)) {
                    _i_4025995 = (_i_4025995 + (_size_4028912) : stdgo.GoInt);
                    _gotoNext = 4029039i32;
                } else if (__value__ == (4029039i32)) {
                    if (_verb_4028906 == ((37 : stdgo.GoInt32))) {
                        _gotoNext = 4029050i32;
                    } else if (!(@:checkr _p ?? throw "null pointer dereference")._goodArgNum) {
                        _gotoNext = 4029160i32;
                    } else if ((_argNum_4025816 >= (_a.length) : Bool)) {
                        _gotoNext = 4029203i32;
                    } else if (_verb_4028906 == ((119 : stdgo.GoInt32))) {
                        _gotoNext = 4029306i32;
                    } else if (_verb_4028906 == ((118 : stdgo.GoInt32))) {
                        _gotoNext = 4029390i32;
                    } else {
                        _gotoNext = 4029570i32;
                    };
                } else if (__value__ == (4029050i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeByte((37 : stdgo.GoUInt8));
                    _gotoNext = 4025991i32;
                } else if (__value__ == (4029160i32)) {
                    @:check2r _p._badArgNum(_verb_4028906);
                    _gotoNext = 4025991i32;
                } else if (__value__ == (4029203i32)) {
                    @:check2r _p._missingArg(_verb_4028906);
                    _gotoNext = 4025991i32;
                } else if (__value__ == (4029306i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._wrappedErrs = ((@:checkr _p ?? throw "null pointer dereference")._wrappedErrs.__append__(_argNum_4025816));
                    _gotoNext = 4029390i32;
                } else if (__value__ == (4029390i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._sharpV = (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._sharp;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._sharp = false;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._plusV = (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._plus;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._plus = false;
                    _gotoNext = 4029570i32;
                } else if (__value__ == (4029570i32)) {
                    @:check2r _p._printArg(_a[(_argNum_4025816 : stdgo.GoInt)], _verb_4028906);
                    _argNum_4025816++;
                    _gotoNext = 4025991i32;
                } else if (__value__ == (4029822i32)) {
                    if ((!(@:checkr _p ?? throw "null pointer dereference")._reordered && (_argNum_4025816 < (_a.length) : Bool) : Bool)) {
                        _gotoNext = 4029857i32;
                    } else {
                        _gotoNext = 4030213i32;
                    };
                } else if (__value__ == (4029857i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._fmt._clearflags();
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("%!(EXTRA " : stdgo.GoString));
                    if ((0i32 : stdgo.GoInt) < ((_a.__slice__(_argNum_4025816) : stdgo.Slice<stdgo.AnyInterface>).length)) {
                        _gotoNext = 4030184i32;
                    } else {
                        _gotoNext = 4030189i32;
                    };
                } else if (__value__ == (4029919i32)) {
                    _i_4029919++;
                    _gotoNext = 4030185i32;
                } else if (__value__ == (4029946i32)) {
                    _arg_4029922 = stdgo.Go.toInterface((_a.__slice__(_argNum_4025816) : stdgo.Slice<stdgo.AnyInterface>)[(_i_4029919 : stdgo.GoInt)]);
                    if ((_i_4029919 > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4029960i32;
                    } else {
                        _gotoNext = 4030010i32;
                    };
                } else if (__value__ == (4029960i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString((", " : stdgo.GoString));
                    _gotoNext = 4030010i32;
                } else if (__value__ == (4030010i32)) {
                    if (_arg_4029922 == null) {
                        _gotoNext = 4030024i32;
                    } else {
                        _gotoNext = 4030074i32;
                    };
                } else if (__value__ == (4030024i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("<nil>" : stdgo.GoString));
                    _gotoNext = 4029919i32;
                } else if (__value__ == (4030074i32)) {
                    _gotoNext = 4030074i32;
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString((stdgo._internal.reflect.Reflect_typeof.typeOf(_arg_4029922).string() : stdgo.GoString)?.__copy__());
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeByte((61 : stdgo.GoUInt8));
                    @:check2r _p._printArg(_arg_4029922, (118 : stdgo.GoInt32));
                    var __blank__ = 0i32;
                    _gotoNext = 4029919i32;
                } else if (__value__ == (4030184i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = stdgo.Go.toInterface((_a.__slice__(_argNum_4025816) : stdgo.Slice<stdgo.AnyInterface>)[(0i32 : stdgo.GoInt)]);
                        _i_4029919 = __tmp__0;
                        _arg_4029922 = __tmp__1;
                    };
                    _gotoNext = 4030185i32;
                } else if (__value__ == (4030185i32)) {
                    if (_i_4029919 < ((_a.__slice__(_argNum_4025816) : stdgo.Slice<stdgo.AnyInterface>).length)) {
                        _gotoNext = 4029946i32;
                    } else {
                        _gotoNext = 4030189i32;
                    };
                } else if (__value__ == (4030189i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeByte((41 : stdgo.GoUInt8));
                    _gotoNext = 4030213i32;
                } else if (__value__ == (4030213i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
