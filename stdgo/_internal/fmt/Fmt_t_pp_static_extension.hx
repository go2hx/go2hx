        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4085694i32;
                } else if (__value__ == (4085694i32)) {
                    _i_3 = (0 : stdgo.GoInt);
                    _formatLoopBreak = false;
                    _gotoNext = 4085707i32;
                } else if (__value__ == (4085707i32)) {
                    if (!_formatLoopBreak && ((_i_3 < _end_0 : Bool))) {
                        _gotoNext = 4085728i32;
                    } else {
                        _gotoNext = 4089538i32;
                    };
                } else if (__value__ == (4085728i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._goodArgNum = true;
                    _lasti_4 = _i_3;
                    var __blank__ = 0i32;
                    _gotoNext = 4085767i32;
                } else if (__value__ == (4085767i32)) {
                    if (((_i_3 < _end_0 : Bool) && (_format[(_i_3 : stdgo.GoInt)] != (37 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4085799i32;
                    } else {
                        _gotoNext = 4085814i32;
                    };
                } else if (__value__ == (4085799i32)) {
                    _i_3++;
                    _gotoNext = 4085767i32;
                } else if (__value__ == (4085814i32)) {
                    if ((_i_3 > _lasti_4 : Bool)) {
                        _gotoNext = 4085827i32;
                    } else {
                        _gotoNext = 4085873i32;
                    };
                } else if (__value__ == (4085827i32)) {
                    ...
                    _gotoNext = 4085873i32;
                } else if (__value__ == (4085873i32)) {
                    if ((_i_3 >= _end_0 : Bool)) {
                        _gotoNext = 4085885i32;
                    } else {
                        _gotoNext = 4085961i32;
                    };
                } else if (__value__ == (4085885i32)) {
                    _gotoNext = 4089538i32;
                } else if (__value__ == (4085961i32)) {
                    _i_3++;
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._fmt._clearflags();
                    _gotoNext = 4086011i32;
                } else if (__value__ == (4086011i32)) {
                    var __blank__ = 0i32;
                    _simpleFormatBreak = false;
                    _gotoNext = 4086027i32;
                } else if (__value__ == (4086027i32)) {
                    if (!_simpleFormatBreak && ((_i_3 < _end_0 : Bool))) {
                        _gotoNext = 4086046i32;
                    } else {
                        _gotoNext = 4087081i32;
                    };
                } else if (__value__ == (4086042i32)) {
                    _i_3++;
                    _gotoNext = 4086027i32;
                } else if (__value__ == (4086046i32)) {
                    _c_5 = _format[(_i_3 : stdgo.GoInt)];
                    _gotoNext = 4086069i32;
                } else if (__value__ == (4086069i32)) {
                    {
                        final __value__ = _c_5;
                        if (__value__ == ((35 : stdgo.GoUInt8))) {
                            _gotoNext = 4086083i32;
                        } else if (__value__ == ((48 : stdgo.GoUInt8))) {
                            _gotoNext = 4086119i32;
                        } else if (__value__ == ((43 : stdgo.GoUInt8))) {
                            _gotoNext = 4086202i32;
                        } else if (__value__ == ((45 : stdgo.GoUInt8))) {
                            _gotoNext = 4086237i32;
                        } else if (__value__ == ((32 : stdgo.GoUInt8))) {
                            _gotoNext = 4086335i32;
                        } else {
                            _gotoNext = 4086371i32;
                        };
                    };
                } else if (__value__ == (4086083i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._sharp = true;
                    _gotoNext = 4086042i32;
                } else if (__value__ == (4086119i32)) {
                    ...
                    if (((((97 : stdgo.GoUInt8) <= _c_5 : Bool) && (_c_5 <= (122 : stdgo.GoUInt8) : Bool) : Bool) && (_argNum_1 < (_a.length) : Bool) : Bool)) {
                        _gotoNext = 4086548i32;
                    } else {
                        _gotoNext = 4087006i32;
                    };
                } else if (__value__ == (4086548i32)) {
                    _gotoNext = 4086555i32;
                } else if (__value__ == (4086555i32)) {
                    {
                        final __value__ = _c_5;
                        if (__value__ == ((119 : stdgo.GoUInt8))) {
                            _gotoNext = 4086571i32;
                        } else if (__value__ == ((118 : stdgo.GoUInt8))) {
                            _gotoNext = 4086656i32;
                        } else {
                            _gotoNext = 4086841i32;
                        };
                    };
                } else if (__value__ == (4086571i32)) {
                    ...
                    _i_3++;
                    _gotoNext = 4085707i32;
                } else if (__value__ == (4087006i32)) {
                    _simpleFormatBreak = true;
                    _gotoNext = 4086027i32;
                } else if (__value__ == (4087081i32)) {
                    {
                    ...
                    if (((_i_3 < _end_0 : Bool) && (_format[(_i_3 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4087201i32;
                    } else {
                        _gotoNext = 4087608i32;
                    };
                } else if (__value__ == (4087201i32)) {
                    _i_3++;
                    {
                    ...
                    if (((@:checkr _p ?? throw "null pointer dereference")._fmt._wid < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4087458i32;
                    } else {
                        _gotoNext = 4087580i32;
                    };
                } else if (__value__ == (4087458i32)) {
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._wid = -(@:checkr _p ?? throw "null pointer dereference")._fmt._wid;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._minus = true;
                    (@:checkr _p ?? throw "null pointer dereference")._fmt._fmtFlags._zero = false;
                    _gotoNext = 4087580i32;
                } else if (__value__ == (4087580i32)) {
                    _afterIndex_2 = false;
                    _gotoNext = 4087786i32;
                } else if (__value__ == (4087608i32)) {
                    _gotoNext = 4087608i32;
                    {
                    ...
                    if (((_i_3 < _end_0 : Bool) && (_format[(_i_3 : stdgo.GoInt)] == (42 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4087990i32;
                    } else {
                        _gotoNext = 4088305i32;
                    };
                } else if (__value__ == (4087990i32)) {
                    _i_3++;
                    {
                        var __tmp__ = stdgo._internal.fmt.Fmt__intfromarg._intFromArg(_a, _argNum_1);
                    ...
                    if (((@:checkr _p ?? throw "null pointer dereference")._fmt._prec < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4088141i32;
                    } else {
                        _gotoNext = 4088204i32;
                    };
                } else if (__value__ == (4088141i32)) {
                    ...
                    _gotoNext = 4088467i32;
                } else if (__value__ == (4088467i32)) {
                    if (!_afterIndex_2) {
                        _gotoNext = 4088482i32;
                    } else {
                        _gotoNext = 4088557i32;
                    };
                } else if (__value__ == (4088482i32)) {
                    {
                        var __tmp__ = @:check2r _p._argNumber(_argNum_1, _format?.__copy__(), _i_3, (_a.length));
                        _argNum_1 = @:tmpset0 __tmp__._0;
                        _i_3 = @:tmpset0 __tmp__._1;
                    ...
                    _gotoNext = 4088557i32;
                } else if (__value__ == (4088557i32)) {
                    if ((_i_3 >= _end_0 : Bool)) {
                        _gotoNext = 4088569i32;
                    } else {
                        _gotoNext = 4088622i32;
                    };
                } else if (__value__ == (4088569i32)) {
                    @:check2 (@:checkr _p ?? throw "null pointer dereference")._buf._writeString(("%!(NOVERB)" : stdgo.GoString));
                    _gotoNext = 4089538i32;
                } else if (__value__ == (4088622i32)) {
                    {
                    ...
                    if ((_verb_6 >= (128 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 4088682i32;
                    } else {
                        _gotoNext = 4088742i32;
                    };
                } else if (__value__ == (4088682i32)) {
                    {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_a.__slice__(_argNum_1) : stdgo.Slice<stdgo.AnyInterface>).length)) {
                        _gotoNext = 4089900i32;
                    } else {
                        _gotoNext = 4089905i32;
                    };
                } else if (__value__ == (4089635i32)) {
                    _i_8++;
                    _gotoNext = 4089901i32;
                } else if (__value__ == (4089662i32)) {
