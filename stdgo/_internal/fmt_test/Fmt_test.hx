...
var _array : stdgo.GoArray<stdgo.GoInt> = (new stdgo.GoArray<stdgo.GoInt>((1 : stdgo.GoInt), (2 : stdgo.GoInt), (3 : stdgo.GoInt), (4 : stdgo.GoInt), (5 : stdgo.GoInt)) : stdgo.GoArray<stdgo.GoInt>);
var _iarray : stdgo.GoArray<stdgo.AnyInterface> = (new stdgo.GoArray<stdgo.AnyInterface>(stdgo.Go.toInterface((1 : stdgo.GoInt)), stdgo.Go.toInterface(("hello" : stdgo.GoString)), stdgo.Go.toInterface((2.5 : stdgo.GoFloat64)), (null : stdgo.AnyInterface)) : stdgo.GoArray<stdgo.AnyInterface>);
...
var _barray : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_renamedUint8> = (new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_renamedUint8>((1 : stdgo._internal.fmt_test.Fmt_test.T_renamedUint8), (2 : stdgo._internal.fmt_test.Fmt_test.T_renamedUint8), (3 : stdgo._internal.fmt_test.Fmt_test.T_renamedUint8), (4 : stdgo._internal.fmt_test.Fmt_test.T_renamedUint8), (5 : stdgo._internal.fmt_test.Fmt_test.T_renamedUint8)) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_renamedUint8>);
...
({ _fmt : ("%s" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoUInt8>((97 : stdgo.GoUInt8), (98 : stdgo.GoUInt8), (99 : stdgo.GoUInt8)) : stdgo.GoArray<stdgo.GoUInt8>)), _out : ("abc" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%s" : stdgo.GoString), _val : stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo.GoArray<stdgo.GoUInt8>((97 : stdgo.GoUInt8), (98 : stdgo.GoUInt8), (99 : stdgo.GoUInt8)) : stdgo.GoArray<stdgo.GoUInt8>)) : stdgo.Ref<stdgo.GoArray<stdgo.GoUInt8>>)), _out : ("&abc" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%#.68U" : stdgo.GoString), _val : stdgo.Go.toInterface((26085 : stdgo.GoInt32)), _out : _zeroFill(("U+" : stdgo.GoString), (68 : stdgo.GoInt), ("65E5" : stdgo.GoString)) + (" \'日\'" : stdgo.GoString)?.__copy__()?.__copy__() } : T__struct_2),
...
({ _fmt : ("%b" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoUInt8>((65 : stdgo.GoUInt8), (66 : stdgo.GoUInt8), (67 : stdgo.GoUInt8)) : stdgo.GoArray<stdgo.GoUInt8>)), _out : ("[1000001 1000010 1000011]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%c" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoUInt8>((65 : stdgo.GoUInt8), (66 : stdgo.GoUInt8), (67 : stdgo.GoUInt8)) : stdgo.GoArray<stdgo.GoUInt8>)), _out : ("[A B C]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%d" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoUInt8>((65 : stdgo.GoUInt8), (66 : stdgo.GoUInt8), (67 : stdgo.GoUInt8)) : stdgo.GoArray<stdgo.GoUInt8>)), _out : ("[65 66 67]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%o" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoUInt8>((65 : stdgo.GoUInt8), (66 : stdgo.GoUInt8), (67 : stdgo.GoUInt8)) : stdgo.GoArray<stdgo.GoUInt8>)), _out : ("[101 102 103]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%U" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoUInt8>((65 : stdgo.GoUInt8), (66 : stdgo.GoUInt8), (67 : stdgo.GoUInt8)) : stdgo.GoArray<stdgo.GoUInt8>)), _out : ("[U+0041 U+0042 U+0043]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoUInt8>((65 : stdgo.GoUInt8), (66 : stdgo.GoUInt8), (67 : stdgo.GoUInt8)) : stdgo.GoArray<stdgo.GoUInt8>)), _out : ("[65 66 67]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoUInt8>((123 : stdgo.GoUInt8)) : stdgo.GoArray<stdgo.GoUInt8>)), _out : ("[123]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%012v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(0, 0) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#012v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(0, 0) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[]byte{}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%6v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(3, 3, (1 : stdgo.GoUInt8), (11 : stdgo.GoUInt8), (111 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[     1     11    111]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%06v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(3, 3, (1 : stdgo.GoUInt8), (11 : stdgo.GoUInt8), (111 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[000001 000011 000111]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%-6v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(3, 3, (1 : stdgo.GoUInt8), (11 : stdgo.GoUInt8), (111 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[1      11     111   ]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%-06v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(3, 3, (1 : stdgo.GoUInt8), (11 : stdgo.GoUInt8), (111 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[1      11     111   ]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(3, 3, (1 : stdgo.GoUInt8), (11 : stdgo.GoUInt8), (111 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[]byte{0x1, 0xb, 0x6f}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#6v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(3, 3, (1 : stdgo.GoUInt8), (11 : stdgo.GoUInt8), (111 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[]byte{   0x1,    0xb,   0x6f}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#06v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(3, 3, (1 : stdgo.GoUInt8), (11 : stdgo.GoUInt8), (111 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[]byte{0x000001, 0x00000b, 0x00006f}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#-6v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(3, 3, (1 : stdgo.GoUInt8), (11 : stdgo.GoUInt8), (111 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[]byte{0x1   , 0xb   , 0x6f  }" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#-06v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(3, 3, (1 : stdgo.GoUInt8), (11 : stdgo.GoUInt8), (111 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[]byte{0x1   , 0xb   , 0x6f  }" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("% v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(3, 3, (1 : stdgo.GoUInt8), (11 : stdgo.GoUInt8), (111 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[ 1  11  111]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%+v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoUInt8>((1 : stdgo.GoUInt8), (11 : stdgo.GoUInt8), (111 : stdgo.GoUInt8)) : stdgo.GoArray<stdgo.GoUInt8>)), _out : ("[1 11 111]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%# -6v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(3, 3, (1 : stdgo.GoUInt8), (11 : stdgo.GoUInt8), (111 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[]byte{ 0x1  ,  0xb  ,  0x6f }" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#+-6v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoUInt8>((1 : stdgo.GoUInt8), (11 : stdgo.GoUInt8), (111 : stdgo.GoUInt8)) : stdgo.GoArray<stdgo.GoUInt8>)), _out : ("[3]uint8{0x1   , 0xb   , 0x6f  }" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("% d" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(3, 3, (1 : stdgo.GoUInt8), (11 : stdgo.GoUInt8), (111 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[ 1  11  111]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%+d" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoUInt8>((1 : stdgo.GoUInt8), (11 : stdgo.GoUInt8), (111 : stdgo.GoUInt8)) : stdgo.GoArray<stdgo.GoUInt8>)), _out : ("[+1 +11 +111]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%# -6d" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(3, 3, (1 : stdgo.GoUInt8), (11 : stdgo.GoUInt8), (111 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[ 1      11     111  ]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#+-6d" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoUInt8>((1 : stdgo.GoUInt8), (11 : stdgo.GoUInt8), (111 : stdgo.GoUInt8)) : stdgo.GoArray<stdgo.GoUInt8>)), _out : ("[+1     +11    +111  ]" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo._internal.fmt_test.Fmt_test.A((1 : stdgo.GoInt), (2u32 : stdgo.GoUInt), ("a" : stdgo.GoString), (new stdgo.Slice<stdgo.GoInt>(2, 2, (1 : stdgo.GoInt), (2 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>)) : stdgo._internal.fmt_test.Fmt_test.A)), _out : ("{1 2 a [1 2]}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%+v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo._internal.fmt_test.Fmt_test.A((1 : stdgo.GoInt), (2u32 : stdgo.GoUInt), ("a" : stdgo.GoString), (new stdgo.Slice<stdgo.GoInt>(2, 2, (1 : stdgo.GoInt), (2 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>)) : stdgo._internal.fmt_test.Fmt_test.A)), _out : ("{i:1 j:2 s:a x:[1 2]}" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo._internal.fmt_test.Fmt_test.A((1 : stdgo.GoInt), (2u32 : stdgo.GoUInt), ("a" : stdgo.GoString), (new stdgo.Slice<stdgo.GoInt>(2, 2, (1 : stdgo.GoInt), (2 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>)) : stdgo._internal.fmt_test.Fmt_test.A)), _out : ("fmt_test.A{i:1, j:0x2, s:\"a\", x:[]int{1, 2}}" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface(new stdgo.Chan<stdgo.GoInt>(0, () -> (0 : stdgo.GoInt))), _out : ("(chan int)(0xPTR)" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoInt>(0, 0) : stdgo.Slice<stdgo.GoInt>)), _out : ("[]int{}" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(0, 0) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[]byte{}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(0, 0) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[]byte{}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface(stdgo._internal.reflect.Reflect.valueOf(stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(0, 0) : stdgo.Slice<stdgo.GoUInt8>))))), _out : ("[]uint8{}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface(stdgo._internal.reflect.Reflect.valueOf(stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(0, 0) : stdgo.Slice<stdgo.GoUInt8>))))), _out : ("[]uint8{}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo.Slice<stdgo.GoUInt8>(0, 0) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.Ref<stdgo.Slice<stdgo.GoUInt8>>)), _out : ("&[]uint8{}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo.Slice<stdgo.GoUInt8>(0, 0) : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.Ref<stdgo.Slice<stdgo.GoUInt8>>)), _out : ("&[]uint8{}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoUInt8>(...([].concat([for (i in 0 ... 3) (0 : stdgo.GoUInt8)]))) : stdgo.GoArray<stdgo.GoUInt8>)), _out : ("[3]uint8{0x0, 0x0, 0x0}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoUInt8>(...([].concat([for (i in 0 ... 3) (0 : stdgo.GoUInt8)]))) : stdgo.GoArray<stdgo.GoUInt8>)), _out : ("[3]uint8{0x0, 0x0, 0x0}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoInt>(3, 3, (1 : stdgo.GoInt), (2 : stdgo.GoInt), (15 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>)), _out : ("[0x1 0x2 0xf]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoInt>(3, 3, (1 : stdgo.GoInt), (2 : stdgo.GoInt), (15 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>)), _out : ("[1 2 f]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%d" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoInt>(3, 3, (1 : stdgo.GoInt), (2 : stdgo.GoInt), (15 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>)), _out : ("[1 2 15]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%d" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(3, 3, (1 : stdgo.GoUInt8), (2 : stdgo.GoUInt8), (15 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[1 2 15]" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("% 02x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(1, 1, (1 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("01" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("% 02x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(3, 3, (1 : stdgo.GoUInt8), (2 : stdgo.GoUInt8), (3 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("01 02 03" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%2x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(0, 0) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("  " : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#2x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(0, 0) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("  " : stdgo.GoString) } : T__struct_2),
({ _fmt : ("% 02x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(0, 0) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("00" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%# 02x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(0, 0) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("00" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%-2x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(0, 0) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("  " : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%-02x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(0, 0) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("  " : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%8x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(1, 1, (171 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("      ab" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("% 8x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(1, 1, (171 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("      ab" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#8x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(1, 1, (171 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("    0xab" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%# 8x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(1, 1, (171 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("    0xab" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%08x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(1, 1, (171 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("000000ab" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("% 08x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(1, 1, (171 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("000000ab" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#08x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(1, 1, (171 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("00000xab" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%# 08x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(1, 1, (171 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("00000xab" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%10x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(2, 2, (171 : stdgo.GoUInt8), (205 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("      abcd" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("% 10x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(2, 2, (171 : stdgo.GoUInt8), (205 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("     ab cd" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#10x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(2, 2, (171 : stdgo.GoUInt8), (205 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("    0xabcd" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%# 10x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(2, 2, (171 : stdgo.GoUInt8), (205 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : (" 0xab 0xcd" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%010x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(2, 2, (171 : stdgo.GoUInt8), (205 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("000000abcd" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("% 010x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(2, 2, (171 : stdgo.GoUInt8), (205 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("00000ab cd" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#010x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(2, 2, (171 : stdgo.GoUInt8), (205 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("00000xabcd" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%# 010x" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(2, 2, (171 : stdgo.GoUInt8), (205 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("00xab 0xcd" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%-10X" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(1, 1, (171 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("AB        " : stdgo.GoString) } : T__struct_2),
({ _fmt : ("% -010X" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(1, 1, (171 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("AB        " : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#-10X" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(2, 2, (171 : stdgo.GoUInt8), (205 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("0XABCD    " : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%# -010X" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(2, 2, (171 : stdgo.GoUInt8), (205 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("0XAB 0XCD " : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%d" : stdgo.GoString), _val : stdgo.Go.toInterface(((new stdgo.Slice<stdgo.GoUInt8>(3, 3, (1 : stdgo.GoUInt8), (2 : stdgo.GoUInt8), (15 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>) : T_renamedBytes)), _out : ("[1 2 15]" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%p" : stdgo.GoString), _val : stdgo.Go.toInterface(new stdgo.Chan<stdgo.GoInt>(0, () -> (0 : stdgo.GoInt))), _out : ("0xPTR" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%☠" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(2, 2, (0 : stdgo.GoUInt8), (1 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[%!☠(uint8=0) %!☠(uint8=1)]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%☠" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(2, 2, (0 : stdgo.GoUInt8), (1 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[%!☠(uint8=0) %!☠(uint8=1)]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%☠" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoUInt8>((0 : stdgo.GoUInt8)) : stdgo.GoArray<stdgo.GoUInt8>)), _out : ("[%!☠(uint8=0)]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%☠" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoUInt8>((0 : stdgo.GoUInt8)) : stdgo.GoArray<stdgo.GoUInt8>)), _out : ("[%!☠(uint8=0)]" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%☠" : stdgo.GoString), _val : stdgo.Go.toInterface(new stdgo.Chan<stdgo.GoInt>(0, () -> (0 : stdgo.GoInt))), _out : ("%!☠(chan int=0xPTR)" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%☠" : stdgo.GoString), _val : stdgo.Go.toInterface(({
        ...
        x;
    } : stdgo.GoMap<stdgo.GoFloat64, stdgo.GoInt>)), _out : ("map[%!☠(float64=NaN):%!☠(int=1)]" : stdgo.GoString) } : T__struct_2)) : stdgo.Slice<T__struct_2>);
...
({ _fmt : ("%-2147483648d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(1, 1, stdgo.Go.toInterface((42 : stdgo.GoInt))) : stdgo._internal.fmt_test.Fmt_test.SE), _out : ("%!(NOVERB)%!(EXTRA int=42)" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%.2147483648d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(1, 1, stdgo.Go.toInterface((42 : stdgo.GoInt))) : stdgo._internal.fmt_test.Fmt_test.SE), _out : ("%!(NOVERB)%!(EXTRA int=42)" : stdgo.GoString) } : T__struct_3)) : stdgo.Slice<T__struct_3>);
...
({ _fmt : ("%*" : stdgo.GoString), _in : _args(stdgo.Go.toInterface((4 : stdgo.GoInt))), _out : ("%!(NOVERB)" : stdgo.GoString) } : T__struct_7)) : stdgo.Slice<T__struct_7>);
var _panictests : stdgo.Slice<T__struct_8> = (new stdgo.Slice<T__struct_8>(
10,
10,
({ _fmt : ("%s" : stdgo.GoString), _in : stdgo.Go.toInterface(stdgo.Go.asInterface(((null : stdgo.Ref<stdgo._internal.fmt_test.Fmt_test.PanicS>) : stdgo.Ref<PanicS>))), _out : ("<nil>" : stdgo.GoString) } : T__struct_8),
({ _fmt : ("%s" : stdgo.GoString), _in : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo._internal.fmt_test.Fmt_test.PanicS(stdgo.Go.toInterface(stdgo._internal.io.Io.errUnexpectedEOF)) : stdgo._internal.fmt_test.Fmt_test.PanicS))), _out : ("%!s(PANIC=String method: unexpected EOF)" : stdgo.GoString) } : T__struct_8),
({ _fmt : ("%s" : stdgo.GoString), _in : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo._internal.fmt_test.Fmt_test.PanicS(stdgo.Go.toInterface((3 : stdgo.GoInt))) : stdgo._internal.fmt_test.Fmt_test.PanicS))), _out : ("%!s(PANIC=String method: 3)" : stdgo.GoString) } : T__struct_8),
({ _fmt : ("%#v" : stdgo.GoString), _in : stdgo.Go.toInterface(stdgo.Go.asInterface(((null : stdgo.Ref<stdgo._internal.fmt_test.Fmt_test.PanicGo>) : stdgo.Ref<PanicGo>))), _out : ("<nil>" : stdgo.GoString) } : T__struct_8),
({ _fmt : ("%#v" : stdgo.GoString), _in : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo._internal.fmt_test.Fmt_test.PanicGo(stdgo.Go.toInterface(stdgo._internal.io.Io.errUnexpectedEOF)) : stdgo._internal.fmt_test.Fmt_test.PanicGo))), _out : ("%!v(PANIC=GoString method: unexpected EOF)" : stdgo.GoString) } : T__struct_8),
({ _fmt : ("%#v" : stdgo.GoString), _in : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo._internal.fmt_test.Fmt_test.PanicGo(stdgo.Go.toInterface((3 : stdgo.GoInt))) : stdgo._internal.fmt_test.Fmt_test.PanicGo))), _out : ("%!v(PANIC=GoString method: 3)" : stdgo.GoString) } : T__struct_8),
({ _fmt : ("%#v" : stdgo.GoString), _in : stdgo.Go.toInterface((new stdgo.Slice<stdgo.AnyInterface>(2, 2, stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo._internal.fmt_test.Fmt_test.PanicGo(stdgo.Go.toInterface((3 : stdgo.GoInt))) : stdgo._internal.fmt_test.Fmt_test.PanicGo))), stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo._internal.fmt_test.Fmt_test.PanicGo(stdgo.Go.toInterface((3 : stdgo.GoInt))) : stdgo._internal.fmt_test.Fmt_test.PanicGo)))) : stdgo.Slice<stdgo.AnyInterface>)), _out : ("[]interface {}{%!v(PANIC=GoString method: 3), %!v(PANIC=GoString method: 3)}" : stdgo.GoString) } : T__struct_8),
({ _fmt : ("%s" : stdgo.GoString), _in : stdgo.Go.toInterface(stdgo.Go.asInterface(((null : stdgo.Ref<stdgo._internal.fmt_test.Fmt_test.PanicF>) : stdgo.Ref<PanicF>))), _out : ("<nil>" : stdgo.GoString) } : T__struct_8),
({ _fmt : ("%s" : stdgo.GoString), _in : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo._internal.fmt_test.Fmt_test.PanicF(stdgo.Go.toInterface(stdgo._internal.io.Io.errUnexpectedEOF)) : stdgo._internal.fmt_test.Fmt_test.PanicF))), _out : ("%!s(PANIC=Format method: unexpected EOF)" : stdgo.GoString) } : T__struct_8),
({ _fmt : ("%s" : stdgo.GoString), _in : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo._internal.fmt_test.Fmt_test.PanicF(stdgo.Go.toInterface((3 : stdgo.GoInt))) : stdgo._internal.fmt_test.Fmt_test.PanicF))), _out : ("%!s(PANIC=Format method: 3)" : stdgo.GoString) } : T__struct_8)) : stdgo.Slice<T__struct_8>);
...
({ _in : ("%-1.2abc" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo._internal.fmt_test.Fmt_test.T_flagPrinter() : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%-1.2a]bc" : stdgo.GoString) } : T__struct_9),
({ _in : ("%a" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%a]]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-a" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%-a]]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%+a" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%+a]]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%#a" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%#a]]" : stdgo.GoString) } : T__struct_9),
({ _in : ("% a" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[% a]]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%0a" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%0a]]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%1.2a" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%1.2a]]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-1.2a" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%-1.2a]]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%+1.2a" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%+1.2a]]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-+1.2a" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%+-1.2a]]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-+1.2abc" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%+-1.2a]]bc" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-1.2abc" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%-1.2a]]bc" : stdgo.GoString) } : T__struct_9),
...
({ _in : ("%-1.2vbc" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo._internal.fmt_test.Fmt_test.T_flagPrinter() : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%-1.2v]bc" : stdgo.GoString) } : T__struct_9),
({ _in : ("%v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%v]]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%-v]]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%+v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%+v]]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[1]fmt_test.flagPrinter{[%#v]}" : stdgo.GoString) } : T__struct_9),
({ _in : ("% v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[% v]]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%0v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%0v]]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%1.2v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%1.2v]]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-1.2v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%-1.2v]]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%+1.2v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%+1.2v]]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-+1.2v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%+-1.2v]]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-+1.2vbc" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%+-1.2v]]bc" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-1.2vbc" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo._internal.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo._internal.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%-1.2v]]bc" : stdgo.GoString) } : T__struct_9)) : stdgo.Slice<T__struct_9>);
var _scanTests : stdgo.Slice<stdgo._internal.fmt_test.Fmt_test.ScanTest> = (new stdgo.Slice<stdgo._internal.fmt_test.Fmt_test.ScanTest>(
86,
86,
...
(new stdgo._internal.fmt_test.Fmt_test.ScanTest(("2147483648\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int64Val)), stdgo.Go.toInterface((2147483648i64 : stdgo.GoInt64))) : stdgo._internal.fmt_test.Fmt_test.ScanTest)) : stdgo.Slice<stdgo._internal.fmt_test.Fmt_test.ScanTest>);
var _scanfTests : stdgo.Slice<stdgo._internal.fmt_test.Fmt_test.ScanfTest> = (new stdgo.Slice<stdgo._internal.fmt_test.Fmt_test.ScanfTest>(
168,
168,
...
(new stdgo._internal.fmt_test.Fmt_test.ScanfTest(("%dX\n X" : stdgo.GoString), ("27X\n X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo._internal.fmt_test.Fmt_test.ScanfTest)) : stdgo.Slice<stdgo._internal.fmt_test.Fmt_test.ScanfTest>);
var _overflowTests : stdgo.Slice<stdgo._internal.fmt_test.Fmt_test.ScanTest> = (new stdgo.Slice<stdgo._internal.fmt_test.Fmt_test.ScanTest>(
11,
11,
...
(new stdgo._internal.fmt_test.Fmt_test.ScanTest(("(1-1e500i)" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_complex128Val)), stdgo.Go.toInterface((0 : stdgo.GoInt))) : stdgo._internal.fmt_test.Fmt_test.ScanTest)) : stdgo.Slice<stdgo._internal.fmt_test.Fmt_test.ScanTest>);
var _multiTests : stdgo.Slice<stdgo._internal.fmt_test.Fmt_test.ScanfMultiTest> = (new stdgo.Slice<stdgo._internal.fmt_test.Fmt_test.ScanfMultiTest>(
26,
26,
...
function testErrorf(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        for (__3 => _test in (new stdgo.Slice<T__struct_0>(
16,
16,
...
({ _err : _noVetErrorf(("wrapped two errors: %w %w" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(((("1" : stdgo.GoString) : stdgo._internal.fmt_test.Fmt_test.T_errString) : T_errString))), stdgo.Go.toInterface(stdgo.Go.asInterface(((("2" : stdgo.GoString) : stdgo._internal.fmt_test.Fmt_test.T_errString) : T_errString)))), _wantText : ("wrapped two errors: 1 2" : stdgo.GoString), _wantUnwrap : (null : stdgo.Error), _wantSplit : (new stdgo.Slice<stdgo.Error>(2, 2, stdgo.Go.asInterface(((("1" : stdgo.GoString) : stdgo._internal.fmt_test.Fmt_test.T_errString) : T_errString)), stdgo.Go.asInterface(((("2" : stdgo.GoString) : stdgo._internal.fmt_test.Fmt_test.T_errString) : T_errString))) : stdgo.Slice<stdgo.Error>) } : T__struct_0),
({ _err : _noVetErrorf(("wrapped three errors: %w %w %w" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(((("1" : stdgo.GoString) : stdgo._internal.fmt_test.Fmt_test.T_errString) : T_errString))), stdgo.Go.toInterface(stdgo.Go.asInterface(((("2" : stdgo.GoString) : stdgo._internal.fmt_test.Fmt_test.T_errString) : T_errString))), stdgo.Go.toInterface(stdgo.Go.asInterface(((("3" : stdgo.GoString) : stdgo._internal.fmt_test.Fmt_test.T_errString) : T_errString)))), _wantText : ("wrapped three errors: 1 2 3" : stdgo.GoString), _wantUnwrap : (null : stdgo.Error), _wantSplit : (new stdgo.Slice<stdgo.Error>(3, 3, stdgo.Go.asInterface(((("1" : stdgo.GoString) : stdgo._internal.fmt_test.Fmt_test.T_errString) : T_errString)), stdgo.Go.asInterface(((("2" : stdgo.GoString) : stdgo._internal.fmt_test.Fmt_test.T_errString) : T_errString)), stdgo.Go.asInterface(((("3" : stdgo.GoString) : stdgo._internal.fmt_test.Fmt_test.T_errString) : T_errString))) : stdgo.Slice<stdgo.Error>) } : T__struct_0),
({ _err : _noVetErrorf(("wrapped nil error: %w %w %w" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(((("1" : stdgo.GoString) : stdgo._internal.fmt_test.Fmt_test.T_errString) : T_errString))), (null : stdgo.AnyInterface), stdgo.Go.toInterface(stdgo.Go.asInterface(((("2" : stdgo.GoString) : stdgo._internal.fmt_test.Fmt_test.T_errString) : T_errString)))), _wantText : ("wrapped nil error: 1 %!w(<nil>) 2" : stdgo.GoString), _wantUnwrap : (null : stdgo.Error), _wantSplit : (new stdgo.Slice<stdgo.Error>(2, 2, stdgo.Go.asInterface(((("1" : stdgo.GoString) : stdgo._internal.fmt_test.Fmt_test.T_errString) : T_errString)), stdgo.Go.asInterface(((("2" : stdgo.GoString) : stdgo._internal.fmt_test.Fmt_test.T_errString) : T_errString))) : stdgo.Slice<stdgo.Error>) } : T__struct_0),
...
({ _err : stdgo._internal.fmt.Fmt.errorf(("%w" : stdgo.GoString), (null : stdgo.AnyInterface)), _wantText : ("%!w(<nil>)" : stdgo.GoString), _wantUnwrap : (null : stdgo.Error), _wantSplit : (null : stdgo.Slice<stdgo.Error>) } : T__struct_0)) : stdgo.Slice<T__struct_0>)) {
            {
...
function _zeroFill(_prefix:stdgo.GoString, _width:stdgo.GoInt, _suffix:stdgo.GoString):stdgo.GoString {
        return _prefix + stdgo._internal.strings.Strings.repeat(("0" : stdgo.GoString), _width - (_suffix.length))?.__copy__() + _suffix?.__copy__()?.__copy__();
    }
function testSprintf(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        for (__3 => _tt in _fmtTests) {
            ...
            if ((_i >= (0 : stdgo.GoInt)) && (_i < _s.length)) {
                ...
                var _p:stdgo.GoString = (_s.__slice__(0, _i) : stdgo.GoString) + _pattern?.__copy__()?.__copy__();
                {
                    ...
                    stdgo.Go.cfor(_j < (_s.length), _j++, {
                        if (!stdgo._internal.strings.Strings.containsRune(_chars?.__copy__(), (_s[(_j : stdgo.GoInt)] : stdgo.GoRune))) {
                            _p = _p + ((_s.__slice__(_j) : stdgo.GoString))?.__copy__();
                            break;
                        };
                    });
                };
...
function testComplexFormatting(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _values:stdgo.Slice<stdgo.GoFloat64> = (new stdgo.Slice<stdgo.GoFloat64>(6, 6, (1 : stdgo.GoFloat64), (0 : stdgo.GoFloat64), (-1 : stdgo.GoFloat64), _posInf, _negInf, naN) : stdgo.Slice<stdgo.GoFloat64>);
            ...
            for (__4 => _zero in _yesNo) {
                for (__5 => _space in _yesNo) {
                    for (__6 => _char in ("fFeEgG" : stdgo.GoString)) {
                        ...
                        if (_zero) {
                            _realFmt = _realFmt + (("0" : stdgo.GoString))?.__copy__();
                        };
                        if (_space) {
                            _realFmt = _realFmt + ((" " : stdgo.GoString))?.__copy__();
                        };
                        if (_plus) {
                            _realFmt = _realFmt + (("+" : stdgo.GoString))?.__copy__();
                        };
                        _realFmt = _realFmt + (("10.2" : stdgo.GoString))?.__copy__();
                        _realFmt = _realFmt + ((_char : stdgo.GoString))?.__copy__();
                        var _imagFmt:stdgo.GoString = ("%" : stdgo.GoString);
                        if (_zero) {
                            _imagFmt = _imagFmt + (("0" : stdgo.GoString))?.__copy__();
                        };
                        _imagFmt = _imagFmt + (("+" : stdgo.GoString))?.__copy__();
                        _imagFmt = _imagFmt + (("10.2" : stdgo.GoString))?.__copy__();
                        _imagFmt = _imagFmt + ((_char : stdgo.GoString))?.__copy__();
                        for (__7 => _realValue in _values) {
                            for (__8 => _imagValue in _values) {
                                ...
                                var _two:stdgo.GoString = sprintf(("(" : stdgo.GoString) + _realFmt?.__copy__() + _imagFmt?.__copy__() + ("i)" : stdgo.GoString)?.__copy__()?.__copy__(), stdgo.Go.toInterface(_realValue), stdgo.Go.toInterface(_imagValue))?.__copy__();
                                if (_one != (_two)) {
...
function testCountMallocs(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        } else if (stdgo._internal.runtime.Runtime.gomaxprocs((0 : stdgo.GoInt)) > (1 : stdgo.GoInt)) {
...
function testStructPrinter(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        {};
        var _s:T_testStructPrinter_37___localname___T = ({} : stdgo._internal.fmt_test.Fmt_test.T_testStructPrinter_37___localname___T);
        ...
        for (__3 => _tt in _tests) {
            ...
            _out = sprintf(_tt._fmt?.__copy__(), stdgo.Go.toInterface((stdgo.Go.setRef(_s) : stdgo.Ref<stdgo._internal.fmt_test.Fmt_test.T_testStructPrinter_37___localname___T>)))?.__copy__();
...
function testSlicePrinter(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        var _slice = (new stdgo.Slice<stdgo.GoInt>(0, 0) : stdgo.Slice<stdgo.GoInt>);
        ...
        _slice = (new stdgo.Slice<stdgo.GoInt>(3, 3, (1 : stdgo.GoInt), (2 : stdgo.GoInt), (3 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>);
...
function _presentInMap(_s:stdgo.GoString, _a:stdgo.Slice<stdgo.GoString>, _t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        {
            ...
            stdgo.Go.cfor(_i < (_a.length), _i++, {
                ...
                _loc = _loc + ((_a[(_i : stdgo.GoInt)].length));
                if ((_loc >= _s.length) || ((_s[(_loc : stdgo.GoInt)] != (32 : stdgo.GoUInt8)) && (_s[(_loc : stdgo.GoInt)] != (93 : stdgo.GoUInt8)))) {
...
function testIsSpace(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        {
            ...
            stdgo.Go.cfor(_i <= (1114111 : stdgo.GoInt32), _i++, {
...
function testNilDoesNotBecomeTyped(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _b:B = (new stdgo._internal.fmt_test.Fmt_test.B() : stdgo._internal.fmt_test.Fmt_test.B);
...
function _verifyNaN(_str:stdgo.GoString, _t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _text:stdgo.GoString = _str + (" " : stdgo.GoString)?.__copy__() + _str?.__copy__() + (" " : stdgo.GoString)?.__copy__() + _str?.__copy__()?.__copy__();
        ...
        if ((!stdgo._internal.math.Math.isNaN((_f : stdgo.GoFloat64)) || !stdgo._internal.math.Math.isNaN((_f32 : stdgo.GoFloat64))) || !stdgo._internal.math.Math.isNaN(_f64)) {
...
function testNaN(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        for (__3 => _s in (new stdgo.Slice<stdgo.GoString>(3, 3, ("nan" : stdgo.GoString), ("NAN" : stdgo.GoString), ("NaN" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) {
...
function _verifyInf(_str:stdgo.GoString, _t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        if ((!stdgo._internal.math.Math.isInf((_f : stdgo.GoFloat64), _sign) || !stdgo._internal.math.Math.isInf((_f32 : stdgo.GoFloat64), _sign)) || !stdgo._internal.math.Math.isInf(_f64, _sign)) {
...
function testInf(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        for (__3 => _s in (new stdgo.Slice<stdgo.GoString>(
9,
9,
("inf" : stdgo.GoString),
("+inf" : stdgo.GoString),
...
function testScanMultiple(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        if ((_a != (123 : stdgo.GoInt)) || (_s != ("abc" : stdgo.GoString))) {
...
function testEOFAtEndOfInput(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        if ((_n != (1 : stdgo.GoInt)) || (_i != (23 : stdgo.GoInt))) {
        ...
        if ((_n != (1 : stdgo.GoInt)) || (_i != (234 : stdgo.GoInt))) {
...
function testLineByLineFscanf(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        if ((_i != (1 : stdgo.GoInt)) || (_j != (2 : stdgo.GoInt))) {
...
function testScanStateCount(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        if (((_a._rune != (49 : stdgo.GoInt32)) || (_b._rune != (50 : stdgo.GoInt32))) || (_c._rune != (10114 : stdgo.GoInt32))) {
        ...
        if (((_a._size != (1 : stdgo.GoInt)) || (_b._size != (1 : stdgo.GoInt))) || (_c._size != (3 : stdgo.GoInt))) {
...
function _makeInts(_n:stdgo.GoInt):stdgo.Slice<stdgo.GoByte> {
        ...
        fprintf(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo._internal.bytes.Bytes.Buffer>)), ("1" : stdgo.GoString));
        {
            ...
            stdgo.Go.cfor(_i < _n, _i++, {
                fprintf(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo._internal.bytes.Bytes.Buffer>)), (".%d" : stdgo.GoString), stdgo.Go.toInterface(_i + (1 : stdgo.GoInt)));
            });
        };
        return _buf.bytes();
    }
...
function _testScanInts(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>, _scan:(stdgo.Ref<RecursiveInt>, stdgo.Ref<stdgo._internal.bytes.Bytes.Buffer>) -> stdgo.Error):Void {
        ...
        if (_i - (1 : stdgo.GoInt) != ((800 : stdgo.GoInt))) {
            _t.fatalf(("bad scan count: expected %d got %d" : stdgo.GoString), stdgo.Go.toInterface((800 : stdgo.GoInt)), stdgo.Go.toInterface(_i - (1 : stdgo.GoInt)));
        };
    }
...
({ _name : ("space vs newline no-percent 1111" : stdgo.GoString), _text : ("1 \n 2" : stdgo.GoString), _format : ("1 \n 2" : stdgo.GoString), _count : (0 : stdgo.GoInt), _ok : true } : T__struct_16)) : stdgo.Slice<T__struct_16>);
        for (__3 => _test in _tests) {
...
function testHexByte(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        var _h:T_hexBytes = new stdgo._internal.fmt_test.Fmt_test.T_hexBytes(...[for (i in 0 ... 2) (0 : stdgo.GoUInt8)]);
        ...
        if ((_h[(0 : stdgo.GoInt)] != (1 : stdgo.GoUInt8)) || (_h[(1 : stdgo.GoInt)] != (35 : stdgo.GoUInt8))) {
...
10,
10,
({ _width : (-1000 : stdgo.GoInt), _prec : (-1000 : stdgo.GoInt), _flags : stdgo.Go.str()?.__copy__(), _result : ("%x" : stdgo.GoString) } : T__struct_17),
({ _width : (-1000 : stdgo.GoInt), _prec : (3 : stdgo.GoInt), _flags : stdgo.Go.str()?.__copy__(), _result : ("%.3x" : stdgo.GoString) } : T__struct_17),
({ _width : (3 : stdgo.GoInt), _prec : (-1000 : stdgo.GoInt), _flags : stdgo.Go.str()?.__copy__(), _result : ("%3x" : stdgo.GoString) } : T__struct_17),
({ _width : (7 : stdgo.GoInt), _prec : (3 : stdgo.GoInt), _flags : stdgo.Go.str()?.__copy__(), _result : ("%7.3x" : stdgo.GoString) } : T__struct_17),
({ _width : (-1000 : stdgo.GoInt), _prec : (-1000 : stdgo.GoInt), _flags : (" +-#0" : stdgo.GoString), _result : ("% +-#0x" : stdgo.GoString) } : T__struct_17),
({ _width : (7 : stdgo.GoInt), _prec : (3 : stdgo.GoInt), _flags : ("+" : stdgo.GoString), _result : ("%+7.3x" : stdgo.GoString) } : T__struct_17),
({ _width : (7 : stdgo.GoInt), _prec : (-3 : stdgo.GoInt), _flags : ("-" : stdgo.GoString), _result : ("%-7.-3x" : stdgo.GoString) } : T__struct_17),
({ _width : (7 : stdgo.GoInt), _prec : (3 : stdgo.GoInt), _flags : (" " : stdgo.GoString), _result : ("% 7.3x" : stdgo.GoString) } : T__struct_17),
({ _width : (7 : stdgo.GoInt), _prec : (3 : stdgo.GoInt), _flags : ("#" : stdgo.GoString), _result : ("%#7.3x" : stdgo.GoString) } : T__struct_17),
({ _width : (7 : stdgo.GoInt), _prec : (3 : stdgo.GoInt), _flags : ("0" : stdgo.GoString), _result : ("%07.3x" : stdgo.GoString) } : T__struct_17)) : stdgo.Slice<T__struct_17>);
        for (__3 => _test in _tests) {
    ...
    static public function format( _:T_flagPrinter, _f:State, _c:stdgo.GoRune):Void {
        ...
        var _s:stdgo.GoString = ("%" : stdgo.GoString);
        {
            ...
            stdgo.Go.cfor(_i < (128 : stdgo.GoInt), _i++, {
                if (_f.flag(_i)) {
                    _s = _s + (((_i : stdgo.GoRune) : stdgo.GoString))?.__copy__();
                };
            });
        };
        {
            ...
            if (_ok) {
                _s = _s + (sprintf(("%d" : stdgo.GoString), stdgo.Go.toInterface(_w)))?.__copy__();
            };
        };
        {
            var __tmp__ = _f.precision(), _p:stdgo.GoInt = __tmp__._0, _ok:Bool = __tmp__._1;
            if (_ok) {
                _s = _s + (sprintf((".%d" : stdgo.GoString), stdgo.Go.toInterface(_p)))?.__copy__();
            };
        };
        _s = _s + ((_c : stdgo.GoString))?.__copy__();
        stdgo._internal.io.Io.writeString(_f, ("[" : stdgo.GoString) + _s?.__copy__() + ("]" : stdgo.GoString)?.__copy__()?.__copy__());
    }
}
...
@:keep @:allow(stdgo._internal.fmt_test.Fmt_test.T_writeStringFormatter_asInterface) class T_writeStringFormatter_static_extension {
    ...
    static public function format( _sf:T_writeStringFormatter, _f:State, _c:stdgo.GoRune):Void {
        @:recv var _sf:T_writeStringFormatter = _sf;
        {
            ...
            if (_ok) {
                _sw.writeString(("***" : stdgo.GoString) + (_sf : stdgo.GoString)?.__copy__() + ("***" : stdgo.GoString)?.__copy__()?.__copy__());
            };
        };
    }
}
...
@:keep @:allow(stdgo._internal.fmt_test.Fmt_test.Xs_asInterface) class Xs_static_extension {
    ...
    static public function scan(____:Xs,  _x:stdgo.Pointer<Xs>, _state:ScanState, _verb:stdgo.GoRune):stdgo.Error {
        ...
        if (!stdgo._internal.regexp.Regexp.mustCompile(("^" : stdgo.GoString) + (_verb : stdgo.GoString)?.__copy__() + ("+$" : stdgo.GoString)?.__copy__()?.__copy__()).matchString(_s?.__copy__())) {
...
@:keep @:allow(stdgo._internal.fmt_test.Fmt_test.TwoLines_asInterface) class TwoLines_static_extension {
    ...
    static public function scan(____:TwoLines,  _t:stdgo.Pointer<TwoLines>, _state:ScanState, _verb:stdgo.GoRune):stdgo.Error {
        var _chars = new stdgo.Slice<stdgo.GoInt32>((0 : stdgo.GoInt).toBasic(), (100 : stdgo.GoInt)).__setNumber32__();
        {
            var _nlCount:stdgo.GoInt = (0 : stdgo.GoInt);
            while (_nlCount < (2 : stdgo.GoInt)) {
