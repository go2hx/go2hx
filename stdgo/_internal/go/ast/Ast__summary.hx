...
function _summary(_list:stdgo.Slice<stdgo.Ref<stdgo._internal.go.ast.Ast_commentgroup.CommentGroup>>):stdgo.GoString {
        var _iterator_4599661_2:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        var _iterator_4599850_4:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i64;
        ...
        while (_gotoNext != ((-1i64 : stdgo.GoInt))) {
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    _gotoNext = 4599638i64;
                } else if (__value__ == (4599638i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/ast/commentmap.go#L277"
                    if ((0i64 : stdgo.GoInt) < (_list.length)) {
                        _gotoNext = 4599954i64;
                    } else {
                        _gotoNext = 4599984i64;
                    };
                } else if (__value__ == (4599649i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/ast/commentmap.go#L277"
                    _iterator_4599661_2++;
                    _gotoNext = 4599955i64;
                } else if (__value__ == (4599672i64)) {
                    _group_3 = _list[(_iterator_4599661_2 : stdgo.GoInt)];
                    ...
                    if ((0i64 : stdgo.GoInt) < ((@:checkr _group_3 ?? throw "null pointer dereference").list.length)) {
                        _gotoNext = 4599951i64;
                    } else {
                        _gotoNext = 4599649i64;
                    };
                } else if (__value__ == (4599867i64)) {
                    _comment_5 = (@:checkr _group_3 ?? throw "null pointer dereference").list[(_iterator_4599850_4 : stdgo.GoInt)];
                    //"file:///home/runner/.go/go1.21.3/src/go/ast/commentmap.go#L282"
                    if ((_buf_1.len() >= (40 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4599895i64;
                    } else {
                        _gotoNext = 4599920i64;
                    };
                } else if (__value__ == (4599895i64)) {
                    stdgo._internal.go.ast.Ast__loopbreak._loopBreak = true;
                    _gotoNext = 4599955i64;
                } else if (__value__ == (4599920i64)) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/go/ast/commentmap.go#L281"
                    _iterator_4599850_4++;
                    _gotoNext = 4599952i64;
                } else if (__value__ == (4599951i64)) {
                    {
                        final __tmp__0 = 0i64;
                        final __tmp__1 = (@:checkr _group_3 ?? throw "null pointer dereference").list[(0i64 : stdgo.GoInt)];
                        _iterator_4599850_4 = @:binopAssign __tmp__0;
                        _comment_5 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4599952i64;
                } else if (__value__ == (4599952i64)) {
                    //"file://#L0"
                    if (_iterator_4599850_4 < ((@:checkr _group_3 ?? throw "null pointer dereference").list.length)) {
                        _gotoNext = 4599867i64;
                    } else {
                        _gotoNext = 4599649i64;
                    };
                } else if (__value__ == (4599954i64)) {
                    {
                        final __tmp__0 = 0i64;
                        final __tmp__1 = _list[(0i64 : stdgo.GoInt)];
                        _iterator_4599661_2 = @:binopAssign __tmp__0;
                        _group_3 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4599955i64;
                } else if (__value__ == (4599955i64)) {
                    //"file://#L0"
                    if (_iterator_4599661_2 < (_list.length)) {
                        _gotoNext = 4599672i64;
                    } else {
                        _gotoNext = 4599984i64;
                    };
                } else if (__value__ == (4599984i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/ast/commentmap.go#L290"
                    if ((_buf_1.len() > (40 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4600006i64;
                    } else {
                        _gotoNext = 4600104i64;
                    };
                } else if (__value__ == (4600006i64)) {
                    ...
                    _gotoNext = 4600104i64;
                } else if (__value__ == (4600104i64)) {
                    _bytes_6 = _buf_1.bytes();
                    //"file:///home/runner/.go/go1.21.3/src/go/ast/commentmap.go#L297"
                    if ((0i64 : stdgo.GoInt) < (_bytes_6.length)) {
                        _gotoNext = 4600212i64;
                    } else {
                        _gotoNext = 4600217i64;
                    };
                } else if (__value__ == (4600130i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/ast/commentmap.go#L297"
                    _i_7++;
                    _gotoNext = 4600213i64;
                } else if (__value__ == (4600150i64)) {
                    _b_8 = _bytes_6[(_i_7 : stdgo.GoInt)];
                    _gotoNext = 4600154i64;
                } else if (__value__ == (4600154i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/ast/commentmap.go#L298"
                    {
                        ...
                        if (__value__ == ((9 : stdgo.GoUInt8)) || __value__ == ((10 : stdgo.GoUInt8)) || __value__ == ((13 : stdgo.GoUInt8))) {
                            _gotoNext = 4600167i64;
                        } else {
                            _gotoNext = 4600130i64;
                        };
                    };
                } else if (__value__ == (4600167i64)) {
                    _bytes_6[(_i_7 : stdgo.GoInt)] = (32 : stdgo.GoUInt8);
                    _gotoNext = 4600130i64;
                } else if (__value__ == (4600212i64)) {
                    {
                        final __tmp__0 = 0i64;
                    ...
                    _gotoNext = 4600213i64;
                } else if (__value__ == (4600213i64)) {
                    //"file://#L0"
                    if (_i_7 < (_bytes_6.length)) {
                        _gotoNext = 4600150i64;
                    } else {
                        _gotoNext = 4600217i64;
                    };
                } else if (__value__ == (4600217i64)) {
