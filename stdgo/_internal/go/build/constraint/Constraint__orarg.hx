...
function _orArg(_x:stdgo._internal.go.build.constraint.Constraint_expr.Expr):stdgo.GoString {
        var _s = ((_x.string() : stdgo.GoString)?.__copy__() : stdgo.GoString);
        //"file:///home/runner/.go/go1.21.3/src/go/build/constraint/expr.go#L125"
        {
            var __tmp__ = try {
        ...
        //"file:///home/runner/.go/go1.21.3/src/go/build/constraint/expr.go#L128"
        return _s?.__copy__();
    }
