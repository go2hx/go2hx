        ...
        while (_gotoNext != ((-1i64 : stdgo.GoInt))) {
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    ...
                    0i64;
                    _gotoNext = 5211497i64;
                } else if (__value__ == (5211497i64)) {
                    ...
                    if ((!stdgo._internal.go.constant.Constant__is63bit._is63bit(_a_27) || !stdgo._internal.go.constant.Constant__is63bit._is63bit(_b_28) : Bool)) {
                        _gotoNext = 5211812i64;
                    } else {
                        _gotoNext = 5211885i64;
                    };
                } else if (__value__ == (5211812i64)) {
                    ...
                    _gotoNext = 5211885i64;
                } else if (__value__ == (5211885i64)) {
                    _c_29 = (_a_27 + _b_28 : stdgo.GoInt64);
                    _gotoNext = 5212471i64;
                } else if (__value__ == (5211897i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/constant/value.go#L1130"
                    if ((!stdgo._internal.go.constant.Constant__is63bit._is63bit(_a_27) || !stdgo._internal.go.constant.Constant__is63bit._is63bit(_b_28) : Bool)) {
                        _gotoNext = 5211946i64;
                    } else {
                        _gotoNext = 5212019i64;
                    };
                } else if (__value__ == (5211946i64)) {
                    ...
                    _gotoNext = 5212019i64;
                } else if (__value__ == (5212019i64)) {
                    _c_29 = (_a_27 - _b_28 : stdgo.GoInt64);
                    _gotoNext = 5212471i64;
                } else if (__value__ == (5212031i64)) {
                    ...
                    if ((!stdgo._internal.go.constant.Constant__is32bit._is32bit(_a_27) || !stdgo._internal.go.constant.Constant__is32bit._is32bit(_b_28) : Bool)) {
                        _gotoNext = 5212080i64;
                    } else {
                        _gotoNext = 5212153i64;
                    };
                } else if (__value__ == (5212080i64)) {
                    ...
                    _gotoNext = 5212153i64;
                } else if (__value__ == (5212153i64)) {
                    _c_29 = (_a_27 * _b_28 : stdgo.GoInt64);
                    _gotoNext = 5212471i64;
                } else if (__value__ == (5212165i64)) {
                    ...
                    _gotoNext = 5212471i64;
                } else if (__value__ == (5212219i64)) {
                    _c_29 = (_a_27 / _b_28 : stdgo.GoInt64);
                    _gotoNext = 5212471i64;
                } else if (__value__ == (5212283i64)) {
                    _c_29 = (_a_27 % _b_28 : stdgo.GoInt64);
                    _gotoNext = 5212471i64;
                } else if (__value__ == (5212314i64)) {
                    _c_29 = (_a_27 & _b_28 : stdgo.GoInt64);
                    _gotoNext = 5212471i64;
                } else if (__value__ == (5212345i64)) {
                    _c_29 = (_a_27 | _b_28 : stdgo.GoInt64);
                    _gotoNext = 5212471i64;
                } else if (__value__ == (5212375i64)) {
                    _c_29 = (_a_27 ^ _b_28 : stdgo.GoInt64);
                    _gotoNext = 5212471i64;
                } else if (__value__ == (5212406i64)) {
                    _c_29 = (_a_27 & ((_b_28 ^ (-1i64 : stdgo.GoInt32) : stdgo.GoInt64)) : stdgo.GoInt64);
                    _gotoNext = 5212471i64;
                } else if (__value__ == (5212442i64)) {
                    _gotoNext = 5214400i64;
                } else if (__value__ == (5212471i64)) {
                    ...
                    _gotoNext = 5212558i64;
                } else if (__value__ == (5212558i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/constant/value.go#L1162"
                    {
                        final __value__ = _op;
                        if (__value__ == ((12 : stdgo._internal.go.token.Token_token.Token))) {
                            _gotoNext = 5212572i64;
                        } else if (__value__ == ((13 : stdgo._internal.go.token.Token_token.Token))) {
                            _gotoNext = 5212605i64;
                        } else if (__value__ == ((14 : stdgo._internal.go.token.Token_token.Token))) {
                            _gotoNext = 5212638i64;
                        } else if (__value__ == ((15 : stdgo._internal.go.token.Token_token.Token))) {
                            _gotoNext = 5212671i64;
                        } else if (__value__ == ((26 : stdgo._internal.go.token.Token_token.Token))) {
                            _gotoNext = 5212731i64;
                        } else if (__value__ == ((16 : stdgo._internal.go.token.Token_token.Token))) {
                            _gotoNext = 5212797i64;
                        } else if (__value__ == ((17 : stdgo._internal.go.token.Token_token.Token))) {
                            _gotoNext = 5212830i64;
                        } else if (__value__ == ((18 : stdgo._internal.go.token.Token_token.Token))) {
                            _gotoNext = 5212863i64;
                        } else if (__value__ == ((19 : stdgo._internal.go.token.Token_token.Token))) {
                            _gotoNext = 5212894i64;
                        } else if (__value__ == ((22 : stdgo._internal.go.token.Token_token.Token))) {
                            _gotoNext = 5212927i64;
                        } else {
                            _gotoNext = 5212967i64;
                        };
                    };
                } else if (__value__ == (5212572i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/constant/value.go#L1164"
                    _c_32.add(_a_30, _b_31);
                    _gotoNext = 5212996i64;
                } else if (__value__ == (5212605i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/constant/value.go#L1166"
                    _c_32.sub(_a_30, _b_31);
                    _gotoNext = 5212996i64;
                } else if (__value__ == (5212638i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/constant/value.go#L1168"
                    _c_32.mul(_a_30, _b_31);
                    _gotoNext = 5212996i64;
                } else if (__value__ == (5212671i64)) {
                    ...
                    _gotoNext = 5213648i64;
                } else if (__value__ == (5213648i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/constant/value.go#L1229"
                    {
                        final __value__ = _op;
                        if (__value__ == ((12 : stdgo._internal.go.token.Token_token.Token))) {
                            _gotoNext = 5213662i64;
                        } else if (__value__ == ((13 : stdgo._internal.go.token.Token_token.Token))) {
                            _gotoNext = 5213737i64;
                        } else if (__value__ == ((14 : stdgo._internal.go.token.Token_token.Token))) {
                            _gotoNext = 5213812i64;
                        } else if (__value__ == ((15 : stdgo._internal.go.token.Token_token.Token))) {
                            _gotoNext = 5213971i64;
                        } else {
                            _gotoNext = 5214248i64;
                        };
                    };
                } else if (__value__ == (5213662i64)) {
                    ...
                    _gotoNext = 5214277i64;
                } else if (__value__ == (5213737i64)) {
                    ...
                    _gotoNext = 5214277i64;
                } else if (__value__ == (5214248i64)) {
                    _gotoNext = 5214400i64;
                } else if (__value__ == (5214277i64)) {
