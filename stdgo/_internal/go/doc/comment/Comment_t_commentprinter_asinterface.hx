...
class T_commentPrinter_asInterface {
    @:keep
    @:tdfield
    public dynamic function _indent(_out:stdgo.Ref<stdgo._internal.bytes.Bytes_buffer.Buffer>, _indent:stdgo.GoString, _s:stdgo.GoString):Void @:_0 __self__.value._indent(_out, _indent, _s);
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.go.doc.comment.Comment_t_commentprinterpointer.T_commentPrinterPointer;
