...
//"file:///home/runner/.go/go1.21.3/src/go/doc/comment/parse.go#L826"
    ...
    static public function _paragraph( _d:stdgo.Ref<stdgo._internal.go.doc.comment.Comment_t_parsedoc.T_parseDoc>, _lines:stdgo.Slice<stdgo.GoString>):stdgo._internal.go.doc.comment.Comment_block.Block {
        ...
        var _iterator_3647158_9:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        var _iterator_3647276_13:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i64;
            ...
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    ...
                    if ((0i64 : stdgo.GoInt) < (_lines.length)) {
                        _gotoNext = 3647258i64;
                    } else {
                        _gotoNext = 3647262i64;
                    };
                } else if (__value__ == (3647170i64)) {
                    _line_10 = _lines[(_iterator_3647158_9 : stdgo.GoInt)]?.__copy__();
                    {
                    ...
                    if (!_ok_12) {
                        _gotoNext = 3647210i64;
                    } else {
                        _gotoNext = 3647233i64;
                    };
                } else if (__value__ == (3647210i64)) {
                    _gotoNext = 3647400i64;
                } else if (__value__ == (3647233i64)) {
                    _defs_8 = (_defs_8.__append__(_def_11) : stdgo.Slice<stdgo.Ref<stdgo._internal.go.doc.comment.Comment_linkdef.LinkDef>>);
                    //"file:///home/runner/.go/go1.21.3/src/go/doc/comment/parse.go#L649"
                    _iterator_3647158_9++;
                    _gotoNext = 3647259i64;
                } else if (__value__ == (3647258i64)) {
                    {
                        final __tmp__0 = 0i64;
                        final __tmp__1 = _lines[(0i64 : stdgo.GoInt)]?.__copy__();
                        _iterator_3647158_9 = @:binopAssign __tmp__0;
                        _line_10 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 3647259i64;
                } else if (__value__ == (3647259i64)) {
                    //"file://#L0"
                    if (_iterator_3647158_9 < (_lines.length)) {
                        _gotoNext = 3647170i64;
                    } else {
                        _gotoNext = 3647262i64;
                    };
                } else if (__value__ == (3647262i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/doc/comment/parse.go#L656"
                    if ((0i64 : stdgo.GoInt) < (_defs_8.length)) {
                        _gotoNext = 3647385i64;
                    } else {
                        _gotoNext = 3647389i64;
                    };
                } else if (__value__ == (3647266i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/doc/comment/parse.go#L656"
                    _iterator_3647276_13++;
                    _gotoNext = 3647386i64;
                } else if (__value__ == (3647287i64)) {
                    _def_14 = _defs_8[(_iterator_3647276_13 : stdgo.GoInt)];
                    ...
                    if (({
                        ...
                        _gotoNext = 3647352i64;
                    } else {
                        _gotoNext = 3647266i64;
                    };
                } else if (__value__ == (3647352i64)) {
                    (@:checkr _d ?? throw "null pointer dereference")._links[(@:checkr _def_14 ?? throw "null pointer dereference").text] = _def_14;
                    _gotoNext = 3647266i64;
                } else if (__value__ == (3647385i64)) {
                    {
                        final __tmp__0 = 0i64;
                        final __tmp__1 = _defs_8[(0i64 : stdgo.GoInt)];
                        _iterator_3647276_13 = @:binopAssign __tmp__0;
                        _def_14 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 3647386i64;
                } else if (__value__ == (3647386i64)) {
                    //"file://#L0"
                    if (_iterator_3647276_13 < (_defs_8.length)) {
                        _gotoNext = 3647287i64;
                    } else {
                        _gotoNext = 3647389i64;
                    };
                } else if (__value__ == (3647389i64)) {
