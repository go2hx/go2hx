...
//"file:///home/runner/.go/go1.21.3/src/go/doc/comment/parse.go#L826"
    ...
    static public function _paragraph( _d:stdgo.Ref<stdgo._internal.go.doc.comment.Comment_t_parsedoc.T_parseDoc>, _lines:stdgo.Slice<stdgo.GoString>):stdgo._internal.go.doc.comment.Comment_block.Block {
        ...
        var _iterator_3649220_13:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        var _iterator_3649102_9:stdgo.GoInt = (0 : stdgo.GoInt);
            ...
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    ...
                    if ((0i64 : stdgo.GoInt) < (_lines.length)) {
                        _gotoNext = 3649202i64;
                    } else {
                        _gotoNext = 3649206i64;
                    };
                } else if (__value__ == (3649114i64)) {
                    _line_10 = _lines[(_iterator_3649102_9 : stdgo.GoInt)]?.__copy__();
                    {
                    ...
                    if (!_ok_12) {
                        _gotoNext = 3649154i64;
                    } else {
                        _gotoNext = 3649177i64;
                    };
                } else if (__value__ == (3649154i64)) {
                    _gotoNext = 3649344i64;
                } else if (__value__ == (3649177i64)) {
                    _defs_8 = (_defs_8.__append__(_def_11) : stdgo.Slice<stdgo.Ref<stdgo._internal.go.doc.comment.Comment_linkdef.LinkDef>>);
                    //"file:///home/runner/.go/go1.21.3/src/go/doc/comment/parse.go#L649"
                    _iterator_3649102_9++;
                    _gotoNext = 3649203i64;
                } else if (__value__ == (3649202i64)) {
                    {
                        final __tmp__0 = 0i64;
                        final __tmp__1 = _lines[(0i64 : stdgo.GoInt)]?.__copy__();
                        _iterator_3649102_9 = @:binopAssign __tmp__0;
                        _line_10 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 3649203i64;
                } else if (__value__ == (3649203i64)) {
                    //"file://#L0"
                    if (_iterator_3649102_9 < (_lines.length)) {
                        _gotoNext = 3649114i64;
                    } else {
                        _gotoNext = 3649206i64;
                    };
                } else if (__value__ == (3649206i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/doc/comment/parse.go#L656"
                    if ((0i64 : stdgo.GoInt) < (_defs_8.length)) {
                        _gotoNext = 3649329i64;
                    } else {
                        _gotoNext = 3649333i64;
                    };
                } else if (__value__ == (3649210i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/doc/comment/parse.go#L656"
                    _iterator_3649220_13++;
                    _gotoNext = 3649330i64;
                } else if (__value__ == (3649231i64)) {
                    _def_14 = _defs_8[(_iterator_3649220_13 : stdgo.GoInt)];
                    ...
                    if (({
                        ...
                        _gotoNext = 3649296i64;
                    } else {
                        _gotoNext = 3649210i64;
                    };
                } else if (__value__ == (3649296i64)) {
                    (@:checkr _d ?? throw "null pointer dereference")._links[(@:checkr _def_14 ?? throw "null pointer dereference").text] = _def_14;
                    _gotoNext = 3649210i64;
                } else if (__value__ == (3649329i64)) {
                    {
                        final __tmp__0 = 0i64;
                        final __tmp__1 = _defs_8[(0i64 : stdgo.GoInt)];
                        _iterator_3649220_13 = @:binopAssign __tmp__0;
                        _def_14 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 3649330i64;
                } else if (__value__ == (3649330i64)) {
                    //"file://#L0"
                    if (_iterator_3649220_13 < (_defs_8.length)) {
                        _gotoNext = 3649231i64;
                    } else {
                        _gotoNext = 3649333i64;
                    };
                } else if (__value__ == (3649333i64)) {
