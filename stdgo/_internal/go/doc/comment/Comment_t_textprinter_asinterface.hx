...
class T_textPrinter_asInterface {
    @:keep
    @:tdfield
    public dynamic function _oneLongLine(_out:stdgo.Ref<stdgo._internal.strings.Strings_builder.Builder>, _x:stdgo.Slice<stdgo._internal.go.doc.comment.Comment_text.Text>):Void @:_0 __self__.value._oneLongLine(_out, _x);
    @:keep
    @:tdfield
    public dynamic function _text(_out:stdgo.Ref<stdgo._internal.bytes.Bytes_buffer.Buffer>, _indent:stdgo.GoString, _x:stdgo.Slice<stdgo._internal.go.doc.comment.Comment_text.Text>):Void @:_0 __self__.value._text(_out, _indent, _x);
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.go.doc.comment.Comment_t_textprinterpointer.T_textPrinterPointer;
