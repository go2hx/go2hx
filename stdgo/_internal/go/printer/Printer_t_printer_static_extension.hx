...
@:keep @:allow(stdgo._internal.go.printer.Printer.T_printer_asInterface) class T_printer_static_extension {
    ...
    static public function _printNode( _p:stdgo.Ref<stdgo._internal.go.printer.Printer_t_printer.T_printer>, _node:stdgo.AnyInterface):stdgo.Error {
        ...
        var _iterator_4841593_23:stdgo.GoInt = (0 : stdgo.GoInt);
            ...
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1097"
                    {
                        ...
                        if (_ok_2) {
                            _gotoNext = 4839972i64;
                        } else {
                            _gotoNext = 4840027i64;
                        };
                    };
                } else if (__value__ == (4839972i64)) {
                    ...
                    if (_comments_0 != null) {
                        ...
                        if (_ok_13) {
                            _gotoNext = 4840860i64;
                        } else {
                            _gotoNext = 4840976i64;
                        };
                    };
                } else if (__value__ == (4840046i64)) {
                    {
                        var __tmp__ = try {
                    ...
                    if (!_ok_4) {
                        _gotoNext = 4840146i64;
                    } else {
                        _gotoNext = 4840174i64;
                    };
                } else if (__value__ == (4840146i64)) {
                    _gotoNext = 4841817i64;
                } else if (__value__ == (4840174i64)) {
                    _beg_5 = _n_3.pos();
                    _end_6 = _n_3.end();
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1114"
                    {
                        ...
                        if (({
                            ...
                            _gotoNext = 4840428i64;
                        } else {
                            _gotoNext = 4840455i64;
                        };
                    };
                } else if (__value__ == (4840428i64)) {
                    _beg_5 = _doc_7.pos();
                    _gotoNext = 4840455i64;
                } else if (__value__ == (4840455i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1117"
                    {
                        ...
                        if (({
                            ...
                            _gotoNext = 4840495i64;
                        } else {
                            _gotoNext = 4840628i64;
                        };
                    };
                } else if (__value__ == (4840495i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1118"
                    {
                        _e_9 = _com_8.end();
                        if ((_e_9 > _end_6 : Bool)) {
                            _gotoNext = 4840527i64;
                        } else {
                            _gotoNext = 4840628i64;
                        };
                    };
                } else if (__value__ == (4840527i64)) {
                    _end_6 = _e_9;
                    _gotoNext = 4840628i64;
                } else if (__value__ == (4840628i64)) {
                    _i_10 = (0 : stdgo.GoInt);
                    0i64;
                    _gotoNext = 4840637i64;
                } else if (__value__ == (4840637i64)) {
                    //"file://#L0"
                    if (((_i_10 < (_comments_0.length) : Bool) && (_comments_0[(_i_10 : stdgo.GoInt)].end() < _beg_5 : Bool) : Bool)) {
                        _gotoNext = 4840686i64;
                    } else {
                        _gotoNext = 4840701i64;
                    };
                } else if (__value__ == (4840686i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1126"
                    _i_10++;
                    _gotoNext = 4840637i64;
                } else if (__value__ == (4840701i64)) {
                    _j_11 = _i_10;
                    0i64;
                    _gotoNext = 4840710i64;
                } else if (__value__ == (4840710i64)) {
                    //"file://#L0"
                    if (((_j_11 < (_comments_0.length) : Bool) && (_comments_0[(_j_11 : stdgo.GoInt)].pos() < _end_6 : Bool) : Bool)) {
                        _gotoNext = 4840759i64;
                    } else {
                        _gotoNext = 4840774i64;
                    };
                } else if (__value__ == (4840759i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1130"
                    _j_11++;
                    _gotoNext = 4840710i64;
                } else if (__value__ == (4840774i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1132"
                    if ((_i_10 < _j_11 : Bool)) {
                        _gotoNext = 4840783i64;
                    } else {
                        _gotoNext = 4840976i64;
                    };
                } else if (__value__ == (4840783i64)) {
                    ...
                    0i64;
                    _gotoNext = 4841101i64;
                } else if (__value__ == (4841101i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1149"
                    {
                        ...
                        if (stdgo.Go.typeEquals((__type__ : stdgo._internal.go.ast.Ast_expr.Expr))) {
                            ...
                            _n_20 = _n;
                            _gotoNext = 4841732i64;
                        } else {
                            var _n:stdgo.AnyInterface = __type__?.__underlying__();
                            _n_21 = _n;
                            _gotoNext = 4841761i64;
                        };
                    };
                } else if (__value__ == (4841128i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1151"
                    _p._expr(_n_14);
                    _n_14;
                    _gotoNext = 4841794i64;
                } else if (__value__ == (4841156i64)) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1167"
                    {
                        ...
                        if (_ok_25) {
                            _gotoNext = 4841643i64;
                        } else {
                            _gotoNext = 4841585i64;
                        };
                    };
                } else if (__value__ == (4841643i64)) {
                    (@:checkr _p ?? throw "null pointer dereference")._indent = (1 : stdgo.GoInt);
                    _gotoNext = 4841585i64;
                } else if (__value__ == (4841668i64)) {
                    {
                        final __tmp__0 = 0i64;
                        final __tmp__1 = _n_18[(0i64 : stdgo.GoInt)];
                        _iterator_4841593_23 = @:binopAssign __tmp__0;
                        _s_24 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4841669i64;
                } else if (__value__ == (4841669i64)) {
                    //"file://#L0"
                    if (_iterator_4841593_23 < (_n_18.length)) {
                        _gotoNext = 4841601i64;
                    } else {
                        _gotoNext = 4841673i64;
                    };
                } else if (__value__ == (4841673i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1171"
                    _p._stmtList(_n_18, (0 : stdgo.GoInt), false);
                    _n_18;
                    _gotoNext = 4841794i64;
                } else if (__value__ == (4841698i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1173"
                    _p._declList(_n_19);
                    _n_19;
                    _gotoNext = 4841794i64;
                } else if (__value__ == (4841732i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1175"
                    _p._file(_n_20);
                    _n_20;
                    _gotoNext = 4841794i64;
                } else if (__value__ == (4841761i64)) {
                    _gotoNext = 4841817i64;
                } else if (__value__ == (4841794i64)) {
