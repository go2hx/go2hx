...
@:keep @:allow(stdgo._internal.go.printer.Printer.T_printer_asInterface) class T_printer_static_extension {
    ...
    static public function _printNode( _p:stdgo.Ref<stdgo._internal.go.printer.Printer_t_printer.T_printer>, _node:stdgo.AnyInterface):stdgo.Error {
        ...
        var _iterator_4933029_23:stdgo.GoInt = (0 : stdgo.GoInt);
            ...
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1097"
                    {
                        ...
                        if (_ok_2) {
                            _gotoNext = 4931408i64;
                        } else {
                            _gotoNext = 4931463i64;
                        };
                    };
                } else if (__value__ == (4931408i64)) {
                    ...
                    if (_comments_0 != null) {
                        ...
                        if (_ok_13) {
                            _gotoNext = 4932296i64;
                        } else {
                            _gotoNext = 4932412i64;
                        };
                    };
                } else if (__value__ == (4931482i64)) {
                    {
                        var __tmp__ = try {
                    ...
                    if (!_ok_4) {
                        _gotoNext = 4931582i64;
                    } else {
                        _gotoNext = 4931610i64;
                    };
                } else if (__value__ == (4931582i64)) {
                    _gotoNext = 4933253i64;
                } else if (__value__ == (4931610i64)) {
                    _beg_5 = _n_3.pos();
                    _end_6 = _n_3.end();
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1114"
                    {
                        ...
                        if (({
                            ...
                            _gotoNext = 4931864i64;
                        } else {
                            _gotoNext = 4931891i64;
                        };
                    };
                } else if (__value__ == (4931864i64)) {
                    _beg_5 = _doc_7.pos();
                    _gotoNext = 4931891i64;
                } else if (__value__ == (4931891i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1117"
                    {
                        ...
                        if (({
                            ...
                            _gotoNext = 4931931i64;
                        } else {
                            _gotoNext = 4932064i64;
                        };
                    };
                } else if (__value__ == (4931931i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1118"
                    {
                        _e_9 = _com_8.end();
                        if ((_e_9 > _end_6 : Bool)) {
                            _gotoNext = 4931963i64;
                        } else {
                            _gotoNext = 4932064i64;
                        };
                    };
                } else if (__value__ == (4931963i64)) {
                    _end_6 = _e_9;
                    _gotoNext = 4932064i64;
                } else if (__value__ == (4932064i64)) {
                    _i_10 = (0 : stdgo.GoInt);
                    0i64;
                    _gotoNext = 4932073i64;
                } else if (__value__ == (4932073i64)) {
                    //"file://#L0"
                    if (((_i_10 < (_comments_0.length) : Bool) && (_comments_0[(_i_10 : stdgo.GoInt)].end() < _beg_5 : Bool) : Bool)) {
                        _gotoNext = 4932122i64;
                    } else {
                        _gotoNext = 4932137i64;
                    };
                } else if (__value__ == (4932122i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1126"
                    _i_10++;
                    _gotoNext = 4932073i64;
                } else if (__value__ == (4932137i64)) {
                    _j_11 = _i_10;
                    0i64;
                    _gotoNext = 4932146i64;
                } else if (__value__ == (4932146i64)) {
                    //"file://#L0"
                    if (((_j_11 < (_comments_0.length) : Bool) && (_comments_0[(_j_11 : stdgo.GoInt)].pos() < _end_6 : Bool) : Bool)) {
                        _gotoNext = 4932195i64;
                    } else {
                        _gotoNext = 4932210i64;
                    };
                } else if (__value__ == (4932195i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1130"
                    _j_11++;
                    _gotoNext = 4932146i64;
                } else if (__value__ == (4932210i64)) {
                    ...
                    0i64;
                    _gotoNext = 4932537i64;
                } else if (__value__ == (4932537i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1149"
                    {
                        ...
                        if (stdgo.Go.typeEquals((__type__ : stdgo._internal.go.ast.Ast_expr.Expr))) {
                            ...
                            _n_20 = _n;
                            _gotoNext = 4933168i64;
                        } else {
                            var _n:stdgo.AnyInterface = __type__?.__underlying__();
                            _n_21 = _n;
                            _gotoNext = 4933197i64;
                        };
                    };
                } else if (__value__ == (4932564i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1151"
                    _p._expr(_n_14);
                    _n_14;
                    _gotoNext = 4933230i64;
                } else if (__value__ == (4932592i64)) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1167"
                    {
                        ...
                        if (_ok_25) {
                            _gotoNext = 4933079i64;
                        } else {
                            _gotoNext = 4933021i64;
                        };
                    };
                } else if (__value__ == (4933079i64)) {
                    (@:checkr _p ?? throw "null pointer dereference")._indent = (1 : stdgo.GoInt);
                    _gotoNext = 4933021i64;
                } else if (__value__ == (4933104i64)) {
                    {
                        final __tmp__0 = 0i64;
                        final __tmp__1 = _n_18[(0i64 : stdgo.GoInt)];
                        _iterator_4933029_23 = @:binopAssign __tmp__0;
                        _s_24 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4933105i64;
                } else if (__value__ == (4933105i64)) {
                    //"file://#L0"
                    if (_iterator_4933029_23 < (_n_18.length)) {
                        _gotoNext = 4933037i64;
                    } else {
                        _gotoNext = 4933109i64;
                    };
                } else if (__value__ == (4933109i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1171"
                    _p._stmtList(_n_18, (0 : stdgo.GoInt), false);
                    _n_18;
                    _gotoNext = 4933230i64;
                } else if (__value__ == (4933134i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1173"
                    _p._declList(_n_19);
                    _n_19;
                    _gotoNext = 4933230i64;
                } else if (__value__ == (4933168i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/go/printer/printer.go#L1175"
                    _p._file(_n_20);
                    _n_20;
                    _gotoNext = 4933230i64;
                } else if (__value__ == (4933197i64)) {
                    _gotoNext = 4933253i64;
                } else if (__value__ == (4933230i64)) {
