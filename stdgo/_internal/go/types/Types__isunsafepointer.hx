...
function _isUnsafePointer(_typ:stdgo._internal.go.types.Types_type_.Type_):Bool {
        var __tmp__ = try {
        ...
        //"file:///home/runner/.go/go1.21.3/src/go/types/conversions.go#L282"
        return (({
            final value = _t;
            (value != null && ((value : Dynamic).__nil__ == null || !(value : Dynamic).__nil__));
        }) && ((@:checkr _t ?? throw "null pointer dereference")._kind == (18 : stdgo._internal.go.types.Types_basickind.BasicKind)) : Bool);
    }
