...
@:structInit @:using(stdgo._internal.go.types.Types_builtin_static_extension.Builtin_static_extension) class Builtin {
    @:embedded
    ...
    public function new(?_object:stdgo._internal.go.types.Types_t_object.T_object, ?_id:stdgo._internal.go.types.Types_t_builtinid.T_builtinId) {
