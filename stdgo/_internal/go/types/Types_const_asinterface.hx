...
class Const_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function val():stdgo._internal.go.constant.Constant_value.Value return @:_0 __self__.value.val();
    @:embedded
    ...
    var __self__ : stdgo._internal.go.types.Types_constpointer.ConstPointer;
