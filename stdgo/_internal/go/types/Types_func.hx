...
@:structInit @:using(stdgo._internal.go.types.Types_func_static_extension.Func_static_extension) class Func {
    @:embedded
    ...
    public var _origin : stdgo.Ref<stdgo._internal.go.types.Types_func.Func> = (null : stdgo.Ref<stdgo._internal.go.types.Types_func.Func>);
    public function new(?_object:stdgo._internal.go.types.Types_t_object.T_object, ?_hasPtrRecv_:Bool, ?_origin:stdgo.Ref<stdgo._internal.go.types.Types_func.Func>) {
