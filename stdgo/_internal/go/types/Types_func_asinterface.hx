...
class Func_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function _isDependency():Void @:_0 __self__.value._isDependency();
    @:keep
    @:tdfield
    public dynamic function _hasPtrRecv():Bool return @:_0 __self__.value._hasPtrRecv();
    @:keep
    @:tdfield
    public dynamic function origin():stdgo.Ref<stdgo._internal.go.types.Types_func.Func> return @:_0 __self__.value.origin();
    @:keep
    @:tdfield
    public dynamic function scope():stdgo.Ref<stdgo._internal.go.types.Types_scope.Scope> return @:_0 __self__.value.scope();
    @:keep
    @:tdfield
    public dynamic function fullName():stdgo.GoString return @:_0 __self__.value.fullName();
    @:embedded
    ...
    var __self__ : stdgo._internal.go.types.Types_funcpointer.FuncPointer;
