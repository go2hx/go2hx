...
@:structInit @:using(stdgo._internal.go.types.Types_label_static_extension.Label_static_extension) class Label {
    @:embedded
    ...
    public function new(?_object:stdgo._internal.go.types.Types_t_object.T_object, ?_used:Bool) {
