...
@:structInit @:using(stdgo._internal.go.types.Types_pkgname_static_extension.PkgName_static_extension) class PkgName {
    @:embedded
    public var _object : stdgo._internal.go.types.Types_t_object.T_object = ({} : stdgo._internal.go.types.Types_t_object.T_object);
    public var _imported : stdgo.Ref<stdgo._internal.go.types.Types_package.Package> = (null : stdgo.Ref<stdgo._internal.go.types.Types_package.Package>);
    public var _used : Bool = false;
    public function new(?_object:stdgo._internal.go.types.Types_t_object.T_object, ?_imported:stdgo.Ref<stdgo._internal.go.types.Types_package.Package>, ?_used:Bool) {
