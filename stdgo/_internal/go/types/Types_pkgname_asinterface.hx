...
class PkgName_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function imported():stdgo.Ref<stdgo._internal.go.types.Types_package.Package> return @:_0 __self__.value.imported();
    @:embedded
    ...
    var __self__ : stdgo._internal.go.types.Types_pkgnamepointer.PkgNamePointer;
