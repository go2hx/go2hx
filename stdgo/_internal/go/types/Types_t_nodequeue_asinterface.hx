...
class T_nodeQueue_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function push(_x:stdgo.AnyInterface):Void @:_0 __self__.value.push(_x);
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.go.types.Types_t_nodequeuepointer.T_nodeQueuePointer;
