...
class Tuple_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function at(_i:stdgo.GoInt):stdgo.Ref<stdgo._internal.go.types.Types_var.Var> return @:_0 __self__.value.at(_i);
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.go.types.Types_tuplepointer.TuplePointer;
