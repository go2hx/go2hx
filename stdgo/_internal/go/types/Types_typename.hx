...
@:structInit @:using(stdgo._internal.go.types.Types_typename_static_extension.TypeName_static_extension) class TypeName {
    @:embedded
    public var _object : stdgo._internal.go.types.Types_t_object.T_object = ({} : stdgo._internal.go.types.Types_t_object.T_object);
    public function new(?_object:stdgo._internal.go.types.Types_t_object.T_object) {
