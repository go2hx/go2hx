...
class Var_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function origin():stdgo.Ref<stdgo._internal.go.types.Types_var.Var> return @:_0 __self__.value.origin();
    @:keep
    @:tdfield
    public dynamic function isField():Bool return @:_0 __self__.value.isField();
    @:keep
    @:tdfield
    public dynamic function embedded():Bool return @:_0 __self__.value.embedded();
    @:keep
    @:tdfield
    public dynamic function anonymous():Bool return @:_0 __self__.value.anonymous();
    @:embedded
    ...
    var __self__ : stdgo._internal.go.types.Types_varpointer.VarPointer;
