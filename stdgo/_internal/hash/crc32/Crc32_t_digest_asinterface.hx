...
class T_digest_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function sum32():stdgo.GoUInt32 return @:_0 __self__.value.sum32();
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.hash.crc32.Crc32_t_digestpointer.T_digestPointer;
