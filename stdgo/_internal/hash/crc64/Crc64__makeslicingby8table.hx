...
function _makeSlicingBy8Table(_t:stdgo.Ref<stdgo._internal.hash.crc64.Crc64_table.Table>):stdgo.Ref<stdgo.GoArray<stdgo._internal.hash.crc64.Crc64_table.Table>> {
        var _helperTable:stdgo.GoArray<stdgo._internal.hash.crc64.Crc64_table.Table> = new stdgo.GoArray<stdgo._internal.hash.crc64.Crc64_table.Table>(8, 8, ...[for (i in 0 ... (8 > 8 ? 8 : 8 : stdgo.GoInt).toBasic()) new stdgo._internal.hash.crc64.Crc64_table.Table(256, 256, ...[for (i in 0 ... 256) (0 : stdgo.GoUInt64)])]).__setNil__();
