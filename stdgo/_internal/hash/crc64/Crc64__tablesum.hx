...
function _tableSum(_t:stdgo.Ref<stdgo._internal.hash.crc64.Crc64_table.Table>):stdgo.GoUInt64 {
        ...
        //"file:///home/runner/.go/go1.21.3/src/hash/crc64/crc64.go#L220"
        if (({
            final value = _t;
            (value != null && ((value : Dynamic).__nil__ == null || !(value : Dynamic).__nil__));
        })) {
            //"file:///home/runner/.go/go1.21.3/src/hash/crc64/crc64.go#L221"
            for (__0 => _x in _t) {
                _b = stdgo._internal.hash.crc64.Crc64__appenduint64._appendUint64(_b, _x);
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/hash/crc64/crc64.go#L225"
