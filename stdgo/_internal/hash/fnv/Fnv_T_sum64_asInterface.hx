...
class T_sum64_asInterface {
    ...
    @:keep
    @:pointer
    public dynamic function sum64():stdgo.GoUInt64 return __self__.value.sum64(__self__);
    @:keep
    @:pointer
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.hash.fnv.Fnv_T_sum64.T_sum64>;
