# Module stdgo._internal.html.template has compilation errors, please do not use:
```
[30;41m ERROR [0m stdgo/_internal/text/template/Template_Template_static_extension.hx:23: characters 23-68
...
[30;41m ERROR [0m [31m(macro) [0mstdgo/_internal/text/template/Template__errRecover.hx:3: characters 19-66

  3 | [2m        var _e = ([0m[1mstdgo._internal.text.template.Template__recover[0m[2m._recover() : stdgo.AnyInterface);[0m
    |                   [31m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m
    | Type not found : stdgo._internal.text.template.Template__recover
