...
function _tTag(_c:stdgo._internal.html.template.Template_t_context.T_context, _s:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo._internal.html.template.Template_t_context.T_context; var _1 : stdgo.GoInt; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/html/template/transition.go#L92"
        if (_i == ((_s.length))) {
            //"file:///home/runner/.go/go1.21.3/src/html/template/transition.go#L93"
            return { _0 : _c?.__copy__(), _1 : (_s.length) };
        };
        //"file:///home/runner/.go/go1.21.3/src/html/template/transition.go#L95"
        if (_s[(_i : stdgo.GoInt)] == ((62 : stdgo.GoUInt8))) {
            //"file:///home/runner/.go/go1.21.3/src/html/template/transition.go#L96"
        ...
        //"file:///home/runner/.go/go1.21.3/src/html/template/transition.go#L102"
        if (({
            final value = _err;
            (value != null && ((value : Dynamic).__nil__ == null || !(value : Dynamic).__nil__));
        })) {
            //"file:///home/runner/.go/go1.21.3/src/html/template/transition.go#L103"
...
var _attr = __1, _state = __0;
        //"file:///home/runner/.go/go1.21.3/src/html/template/transition.go#L106"
        if (_i == (_j)) {
            //"file:///home/runner/.go/go1.21.3/src/html/template/transition.go#L107"
        ...
        //"file:///home/runner/.go/go1.21.3/src/html/template/transition.go#L114"
        if (((_c._element == (1 : stdgo._internal.html.template.Template_t_element.T_element)) && (_attrName == ("type" : stdgo.GoString)) : Bool)) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/html/template/transition.go#L117"
            {
        ...
        //"file:///home/runner/.go/go1.21.3/src/html/template/transition.go#L129"
        if (_j == ((_s.length))) {
        ...
        //"file:///home/runner/.go/go1.21.3/src/html/template/transition.go#L134"
