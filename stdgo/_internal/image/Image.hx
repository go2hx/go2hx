...
function decode(_r:stdgo._internal.io.Io.Reader):{ var _0 : Image; var _1 : stdgo.GoString; var _2 : stdgo.Error; } {
        var _rr = (_asReader(_r) : stdgo._internal.image.Image.T_reader);
        var _f = (_sniff(_rr)?.__copy__() : stdgo._internal.image.Image.T_format);
        if (_f._decode == null) {
...
function testRectangle(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        var _in = (function(_f:Rectangle, _g:Rectangle):stdgo.Error {
                ...
                stdgo.Go.cfor((_y < _f.max.y : Bool), _y++, {
                    {
                        ...
                        stdgo.Go.cfor((_x < _f.max.x : Bool), _x++, {
                            var _p = (new stdgo._internal.image.Image.Point(_x, _y) : stdgo._internal.image.Image.Point);
        ...
        } : (stdgo._internal.image.Image.Rectangle, stdgo._internal.image.Image.Rectangle) -> stdgo.Error);
...
rect((6 : stdgo.GoInt), (5 : stdgo.GoInt), (4 : stdgo.GoInt), (3 : stdgo.GoInt))?.__copy__()].concat([for (i in 11 ... (11 > 11 ? 11 : 11 : stdgo.GoInt).toBasic()) ({} : stdgo._internal.image.Image.Rectangle)])) : stdgo.Slice<stdgo._internal.image.Image.Rectangle>);
        ...
        for (__10 => _r in _rects) {
            for (__11 => _s in _rects) {
                var _a = (_r.intersect(_s?.__copy__())?.__copy__() : stdgo._internal.image.Image.Rectangle);
                {
                ...
                {
                    var __0 = (stdgo.Go.toInterface(_a) == stdgo.Go.toInterface(((new stdgo._internal.image.Image.Rectangle() : stdgo._internal.image.Image.Rectangle))) : Bool), __1 = (_r.overlaps(_s?.__copy__()) : Bool);
var _overlaps = __1, _isZero = __0;
        ...
        for (__44 => _r in _rects) {
            for (__45 => _s in _rects) {
                var _a = (_r.union(_s?.__copy__())?.__copy__() : stdgo._internal.image.Image.Rectangle);
                {
...
function _pixelBufferLength(_bytesPerPixel:stdgo.GoInt, _r:Rectangle, _imageTypeName:stdgo.GoString):stdgo.GoInt {
        var _totalLength = (_mul3NonNeg(_bytesPerPixel, _r.dx(), _r.dy()) : stdgo.GoInt);
...
function testImage(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        for (__0 => _tc in _testImages) {
            var _m = (_tc._image() : stdgo._internal.image.Image.T_image);
...
function testNewXxxBadRectangle(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        var _call = (function(_f:Rectangle -> Void, _r:Rectangle):Bool {
        ...
        } : (stdgo._internal.image.Image.Rectangle -> Void, stdgo._internal.image.Image.Rectangle) -> Bool);
        ...
        for (__0 => _tc in _testCases) {
            for (__1 => _negDx in (new stdgo.Slice<Bool>(2, 2, ...[false, true]) : stdgo.Slice<Bool>)) {
                for (__2 => _negDy in (new stdgo.Slice<Bool>(2, 2, ...[false, true]) : stdgo.Slice<Bool>)) {
                    var _r = ({ min : (new stdgo._internal.image.Image.Point((15 : stdgo.GoInt), (28 : stdgo.GoInt)) : stdgo._internal.image.Image.Point), max : (new stdgo._internal.image.Image.Point((16 : stdgo.GoInt), (29 : stdgo.GoInt)) : stdgo._internal.image.Image.Point) } : stdgo._internal.image.Image.Rectangle);
                    if (_negDx) {
            ...
            };
            {
                ...
                var _got = (_call(_tc._f, ({ min : (new stdgo._internal.image.Image.Point((0 : stdgo.GoInt), (0 : stdgo.GoInt)) : stdgo._internal.image.Image.Point), max : (new stdgo._internal.image.Image.Point(_maxInt, _maxInt) : stdgo._internal.image.Image.Point) } : stdgo._internal.image.Image.Rectangle)) : Bool);
                if (_got) {
...
function test16BitsPerColorChannel(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        for (__0 => _cm in _testColorModel) {
            var _c = (_cm.convert(stdgo.Go.asInterface((new stdgo._internal.image.color.Color.RGBA64((4660 : stdgo.GoUInt16), (4660 : stdgo.GoUInt16), (4660 : stdgo.GoUInt16), (4660 : stdgo.GoUInt16)) : stdgo._internal.image.color.Color.RGBA64))) : stdgo._internal.image.color.Color.Color);
...
function testRGBA64Image(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _r = (rect((0 : stdgo.GoInt), (0 : stdgo.GoInt), (3 : stdgo.GoInt), (2 : stdgo.GoInt))?.__copy__() : stdgo._internal.image.Image.Rectangle);
...
stdgo.Go.asInterface(_r)]) : stdgo.Slice<stdgo._internal.image.Image.Image>);
        for (__0 => _tc in _testCases) {
            ...
            var _got = (_rgba64Image.rgba64at((1 : stdgo.GoInt), (1 : stdgo.GoInt))?.__copy__() : stdgo._internal.image.color.Color.RGBA64);
...
function benchmarkSet(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        var _c = (new stdgo._internal.image.color.Color.Gray((255 : stdgo.GoUInt8)) : stdgo._internal.image.color.Color.Gray);
        for (__0 => _tc in _testImages) {
            _b.run(_tc._name?.__copy__(), function(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
                var _m = (_tc._image() : stdgo._internal.image.Image.T_image);
                _b.reportAllocs();
...
function benchmarkRGBASetRGBA(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        var _m = newRGBA(rect((0 : stdgo.GoInt), (0 : stdgo.GoInt), (10 : stdgo.GoInt), (10 : stdgo.GoInt))?.__copy__());
        var _c = (new stdgo._internal.image.color.Color.RGBA((255 : stdgo.GoUInt8), (255 : stdgo.GoUInt8), (255 : stdgo.GoUInt8), (19 : stdgo.GoUInt8)) : stdgo._internal.image.color.Color.RGBA);
        _b.resetTimer();
        {
            var _i = (0 : stdgo.GoInt);
            stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
...
function benchmarkRGBA64SetRGBA64(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        var _m = newRGBA64(rect((0 : stdgo.GoInt), (0 : stdgo.GoInt), (10 : stdgo.GoInt), (10 : stdgo.GoInt))?.__copy__());
        var _c = (new stdgo._internal.image.color.Color.RGBA64((65535 : stdgo.GoUInt16), (65535 : stdgo.GoUInt16), (65535 : stdgo.GoUInt16), (4951 : stdgo.GoUInt16)) : stdgo._internal.image.color.Color.RGBA64);
        _b.resetTimer();
        {
            var _i = (0 : stdgo.GoInt);
            stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
...
function benchmarkNRGBASetNRGBA(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        var _m = newNRGBA(rect((0 : stdgo.GoInt), (0 : stdgo.GoInt), (10 : stdgo.GoInt), (10 : stdgo.GoInt))?.__copy__());
        var _c = (new stdgo._internal.image.color.Color.NRGBA((255 : stdgo.GoUInt8), (255 : stdgo.GoUInt8), (255 : stdgo.GoUInt8), (19 : stdgo.GoUInt8)) : stdgo._internal.image.color.Color.NRGBA);
        _b.resetTimer();
        {
            var _i = (0 : stdgo.GoInt);
            stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
...
function benchmarkNRGBA64SetNRGBA64(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        var _m = newNRGBA64(rect((0 : stdgo.GoInt), (0 : stdgo.GoInt), (10 : stdgo.GoInt), (10 : stdgo.GoInt))?.__copy__());
        var _c = (new stdgo._internal.image.color.Color.NRGBA64((65535 : stdgo.GoUInt16), (65535 : stdgo.GoUInt16), (65535 : stdgo.GoUInt16), (4951 : stdgo.GoUInt16)) : stdgo._internal.image.color.Color.NRGBA64);
        _b.resetTimer();
        {
            var _i = (0 : stdgo.GoInt);
            stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
...
function benchmarkAlphaSetAlpha(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        var _m = newAlpha(rect((0 : stdgo.GoInt), (0 : stdgo.GoInt), (10 : stdgo.GoInt), (10 : stdgo.GoInt))?.__copy__());
        var _c = (new stdgo._internal.image.color.Color.Alpha((19 : stdgo.GoUInt8)) : stdgo._internal.image.color.Color.Alpha);
        _b.resetTimer();
        {
            var _i = (0 : stdgo.GoInt);
            stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
...
function benchmarkAlphaSetAlpha16(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        var _m = newAlpha16(rect((0 : stdgo.GoInt), (0 : stdgo.GoInt), (10 : stdgo.GoInt), (10 : stdgo.GoInt))?.__copy__());
        var _c = (new stdgo._internal.image.color.Color.Alpha16((19 : stdgo.GoUInt16)) : stdgo._internal.image.color.Color.Alpha16);
        _b.resetTimer();
        {
            var _i = (0 : stdgo.GoInt);
            stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
...
function benchmarkGraySetGray(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        var _m = newGray(rect((0 : stdgo.GoInt), (0 : stdgo.GoInt), (10 : stdgo.GoInt), (10 : stdgo.GoInt))?.__copy__());
        var _c = (new stdgo._internal.image.color.Color.Gray((19 : stdgo.GoUInt8)) : stdgo._internal.image.color.Color.Gray);
        _b.resetTimer();
        {
            var _i = (0 : stdgo.GoInt);
            stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
...
function benchmarkGraySetGray16(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        var _m = newGray16(rect((0 : stdgo.GoInt), (0 : stdgo.GoInt), (10 : stdgo.GoInt), (10 : stdgo.GoInt))?.__copy__());
        var _c = (new stdgo._internal.image.color.Color.Gray16((19 : stdgo.GoUInt16)) : stdgo._internal.image.color.Color.Gray16);
        _b.resetTimer();
        {
            var _i = (0 : stdgo.GoInt);
            stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
...
function newYCbCr(_r:Rectangle, _subsampleRatio:YCbCrSubsampleRatio):stdgo.Ref<YCbCr> {
        ...
        var _totalLength = (_add2NonNeg(_mul3NonNeg((1 : stdgo.GoInt), _w, _h), _mul3NonNeg((2 : stdgo.GoInt), _cw, _ch)) : stdgo.GoInt);
        if ((_totalLength < (0 : stdgo.GoInt) : Bool)) {
...
function newNYCbCrA(_r:Rectangle, _subsampleRatio:YCbCrSubsampleRatio):stdgo.Ref<NYCbCrA> {
        var __tmp__ = _yCbCrSize(_r?.__copy__(), _subsampleRatio), _w:stdgo.GoInt = __tmp__._0, _h:stdgo.GoInt = __tmp__._1, _cw:stdgo.GoInt = __tmp__._2, _ch:stdgo.GoInt = __tmp__._3;
        var _totalLength = (_add2NonNeg(_mul3NonNeg((2 : stdgo.GoInt), _w, _h), _mul3NonNeg((2 : stdgo.GoInt), _cw, _ch)) : stdgo.GoInt);
        if ((_totalLength < (0 : stdgo.GoInt) : Bool)) {
...
function _testYCbCr(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>, _r:Rectangle, _subsampleRatio:YCbCrSubsampleRatio, _delta:Point):Void {
        var _r1 = (_r.add(_delta?.__copy__())?.__copy__() : stdgo._internal.image.Image.Rectangle);
                            ...
                            stdgo.Go.cfor((_x0 < (_delta.x + (7 : stdgo.GoInt) : stdgo.GoInt) : Bool), _x0++, {
                                {
                                    ...
                                    stdgo.Go.cfor((_x1 < (_delta.x + (13 : stdgo.GoInt) : stdgo.GoInt) : Bool), _x1++, {
                                        var _subRect = (rect(_x0, _y0, _x1, _y1)?.__copy__() : stdgo._internal.image.Image.Rectangle);
                                            ...
                                            stdgo.Go.cfor((_y < _sub.rect.max.y : Bool), _y++, {
                                                {
                                                    ...
                                                    stdgo.Go.cfor((_x < _sub.rect.max.x : Bool), _x++, {
                                                        var _color0 = ((stdgo.Go.typeAssert((stdgo.Go.toInterface(_m.at(_x, _y)) : stdgo._internal.image.color.Color.YCbCr)) : stdgo._internal.image.color.Color.YCbCr)?.__copy__() : stdgo._internal.image.color.Color.YCbCr);
                                                        var _color1 = ((stdgo.Go.typeAssert((stdgo.Go.toInterface(_sub.at(_x, _y)) : stdgo._internal.image.color.Color.YCbCr)) : stdgo._internal.image.color.Color.YCbCr)?.__copy__() : stdgo._internal.image.color.Color.YCbCr);
...
var _i1 = __1, _i0 = __0;
    ...
    static public function set( _p:stdgo.Ref<RGBA>, _x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color.Color):Void {
        ...
        var _i = (_p.pixOffset(_x, _y) : stdgo.GoInt);
        var _c1 = ((stdgo.Go.typeAssert((stdgo.Go.toInterface(stdgo._internal.image.color.Color.rgbamodel.convert(_c)) : stdgo._internal.image.color.Color.RGBA)) : stdgo._internal.image.color.Color.RGBA)?.__copy__() : stdgo._internal.image.color.Color.RGBA);
        var _s = (_p.pix.__slice__(_i, (_i + (4 : stdgo.GoInt) : stdgo.GoInt), (_i + (4 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>);
...
var _i1 = __1, _i0 = __0;
    ...
    static public function set( _p:stdgo.Ref<RGBA64>, _x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color.Color):Void {
        ...
        var _i = (_p.pixOffset(_x, _y) : stdgo.GoInt);
        var _c1 = ((stdgo.Go.typeAssert((stdgo.Go.toInterface(stdgo._internal.image.color.Color.rgba64model.convert(_c)) : stdgo._internal.image.color.Color.RGBA64)) : stdgo._internal.image.color.Color.RGBA64)?.__copy__() : stdgo._internal.image.color.Color.RGBA64);
        var _s = (_p.pix.__slice__(_i, (_i + (8 : stdgo.GoInt) : stdgo.GoInt), (_i + (8 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>);
...
var _a = __3, _b = __2, _g = __1, _r = __0;
    ...
    static public function set( _p:stdgo.Ref<NRGBA>, _x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color.Color):Void {
        ...
        var _i = (_p.pixOffset(_x, _y) : stdgo.GoInt);
        var _c1 = ((stdgo.Go.typeAssert((stdgo.Go.toInterface(stdgo._internal.image.color.Color.nrgbamodel.convert(_c)) : stdgo._internal.image.color.Color.NRGBA)) : stdgo._internal.image.color.Color.NRGBA)?.__copy__() : stdgo._internal.image.color.Color.NRGBA);
        var _s = (_p.pix.__slice__(_i, (_i + (4 : stdgo.GoInt) : stdgo.GoInt), (_i + (4 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>);
        _s[(0 : stdgo.GoInt)] = _c1.r;
        _s[(1 : stdgo.GoInt)] = _c1.g;
        _s[(2 : stdgo.GoInt)] = _c1.b;
...
var _a = __3, _b = __2, _g = __1, _r = __0;
    ...
    static public function set( _p:stdgo.Ref<NRGBA64>, _x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color.Color):Void {
        ...
        var _i = (_p.pixOffset(_x, _y) : stdgo.GoInt);
        var _c1 = ((stdgo.Go.typeAssert((stdgo.Go.toInterface(stdgo._internal.image.color.Color.nrgba64model.convert(_c)) : stdgo._internal.image.color.Color.NRGBA64)) : stdgo._internal.image.color.Color.NRGBA64)?.__copy__() : stdgo._internal.image.color.Color.NRGBA64);
        var _s = (_p.pix.__slice__(_i, (_i + (8 : stdgo.GoInt) : stdgo.GoInt), (_i + (8 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>);
        _s[(0 : stdgo.GoInt)] = ((_c1.r >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt16) : stdgo.GoUInt8);
        _s[(1 : stdgo.GoInt)] = (_c1.r : stdgo.GoUInt8);
        _s[(2 : stdgo.GoInt)] = ((_c1.g >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt16) : stdgo.GoUInt8);
...
var _i1 = __1, _i0 = __0;
    ...
    static public function set( _p:stdgo.Ref<Alpha16>, _x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color.Color):Void {
        ...
        var _i = (_p.pixOffset(_x, _y) : stdgo.GoInt);
        var _c1 = ((stdgo.Go.typeAssert((stdgo.Go.toInterface(stdgo._internal.image.color.Color.alpha16Model.convert(_c)) : stdgo._internal.image.color.Color.Alpha16)) : stdgo._internal.image.color.Color.Alpha16)?.__copy__() : stdgo._internal.image.color.Color.Alpha16);
...
@:keep @:allow(stdgo._internal.image.Image.Gray16_asInterface) class Gray16_static_extension {
    ...
    static public function set( _p:stdgo.Ref<Gray16>, _x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color.Color):Void {
        ...
        var _i = (_p.pixOffset(_x, _y) : stdgo.GoInt);
        var _c1 = ((stdgo.Go.typeAssert((stdgo.Go.toInterface(stdgo._internal.image.color.Color.gray16Model.convert(_c)) : stdgo._internal.image.color.Color.Gray16)) : stdgo._internal.image.color.Color.Gray16)?.__copy__() : stdgo._internal.image.color.Color.Gray16);
...
@:keep @:allow(stdgo._internal.image.Image.CMYK_asInterface) class CMYK_static_extension {
    ...
    static public function set( _p:stdgo.Ref<CMYK>, _x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color.Color):Void {
        ...
        var _i = (_p.pixOffset(_x, _y) : stdgo.GoInt);
        var _c1 = ((stdgo.Go.typeAssert((stdgo.Go.toInterface(stdgo._internal.image.color.Color.cmykmodel.convert(_c)) : stdgo._internal.image.color.Color.CMYK)) : stdgo._internal.image.color.Color.CMYK)?.__copy__() : stdgo._internal.image.color.Color.CMYK);
        var _s = (_p.pix.__slice__(_i, (_i + (4 : stdgo.GoInt) : stdgo.GoInt), (_i + (4 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>);
...
var _i1 = __1, _i0 = __0;
    ...
    static public function rgba64at( _p:stdgo.Ref<Paletted>, _x:stdgo.GoInt, _y:stdgo.GoInt):stdgo._internal.image.color.Color.RGBA64 {
        ...
        var _c = ((null : stdgo._internal.image.color.Color.Color) : stdgo._internal.image.color.Color.Color);
        if (!((new stdgo._internal.image.Image.Point(_x, _y) : stdgo._internal.image.Image.Point).in_(_p.rect?.__copy__()))) {
