...
class Alpha_asInterface {
    ...
    @:keep
    public dynamic function setAlpha(_x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color_Alpha.Alpha):Void __self__.value.setAlpha(_x, _y, _c);
    @:keep
    ...
    @:keep
    public dynamic function alphaAt(_x:stdgo.GoInt, _y:stdgo.GoInt):stdgo._internal.image.color.Color_Alpha.Alpha return __self__.value.alphaAt(_x, _y);
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.image.Image_Alpha.Alpha>;
