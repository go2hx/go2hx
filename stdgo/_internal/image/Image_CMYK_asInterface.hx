...
class CMYK_asInterface {
    ...
    @:keep
    public dynamic function setCMYK(_x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color_CMYK.CMYK):Void __self__.value.setCMYK(_x, _y, _c);
    @:keep
    ...
    @:keep
    public dynamic function cmykat(_x:stdgo.GoInt, _y:stdgo.GoInt):stdgo._internal.image.color.Color_CMYK.CMYK return __self__.value.cmykat(_x, _y);
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.image.Image_CMYK.CMYK>;
