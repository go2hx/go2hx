...
class Gray16_asInterface {
    ...
    @:keep
    public dynamic function setGray16(_x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color_Gray16.Gray16):Void __self__.value.setGray16(_x, _y, _c);
    @:keep
    ...
    @:keep
    public dynamic function gray16At(_x:stdgo.GoInt, _y:stdgo.GoInt):stdgo._internal.image.color.Color_Gray16.Gray16 return __self__.value.gray16At(_x, _y);
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.image.Image_Gray16.Gray16>;
