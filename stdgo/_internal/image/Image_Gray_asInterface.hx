...
class Gray_asInterface {
    ...
    @:keep
    public dynamic function setGray(_x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color_Gray.Gray):Void __self__.value.setGray(_x, _y, _c);
    @:keep
    ...
    @:keep
    public dynamic function grayAt(_x:stdgo.GoInt, _y:stdgo.GoInt):stdgo._internal.image.color.Color_Gray.Gray return __self__.value.grayAt(_x, _y);
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.image.Image_Gray.Gray>;
