...
class NRGBA64_asInterface {
    ...
    @:keep
    public dynamic function setNRGBA64(_x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color_NRGBA64.NRGBA64):Void __self__.value.setNRGBA64(_x, _y, _c);
    @:keep
    ...
    @:keep
    public dynamic function nrgba64at(_x:stdgo.GoInt, _y:stdgo.GoInt):stdgo._internal.image.color.Color_NRGBA64.NRGBA64 return __self__.value.nrgba64at(_x, _y);
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.image.Image_NRGBA64.NRGBA64>;
