...
class NRGBA_asInterface {
    ...
    @:keep
    public dynamic function setNRGBA(_x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color_NRGBA.NRGBA):Void __self__.value.setNRGBA(_x, _y, _c);
    @:keep
    ...
    @:keep
    public dynamic function nrgbaat(_x:stdgo.GoInt, _y:stdgo.GoInt):stdgo._internal.image.color.Color_NRGBA.NRGBA return __self__.value.nrgbaat(_x, _y);
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.image.Image_NRGBA.NRGBA>;
