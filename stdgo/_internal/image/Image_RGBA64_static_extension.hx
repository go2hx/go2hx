...
_i1 = (_i1 + (_p.stride) : stdgo.GoInt);
    ...
    static public function subImage( _p:stdgo.Ref<stdgo._internal.image.Image_RGBA64.RGBA64>, _r:stdgo._internal.image.Image_Rectangle.Rectangle):stdgo._internal.image.Image_Image.Image {
        ...
        return stdgo.Go.asInterface((stdgo.Go.setRef(({ pix : (_p.pix.__slice__(_i) : stdgo.Slice<stdgo.GoUInt8>), stride : _p.stride, rect : _r?.__copy__() } : stdgo._internal.image.Image_RGBA64.RGBA64)) : stdgo.Ref<stdgo._internal.image.Image_RGBA64.RGBA64>));
    }
    @:keep
