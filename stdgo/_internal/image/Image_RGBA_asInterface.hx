...
class RGBA_asInterface {
    ...
    @:keep
    public dynamic function setRGBA(_x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color_RGBA.RGBA):Void __self__.value.setRGBA(_x, _y, _c);
    @:keep
    ...
    @:keep
    public dynamic function rgbaat(_x:stdgo.GoInt, _y:stdgo.GoInt):stdgo._internal.image.color.Color_RGBA.RGBA return __self__.value.rgbaat(_x, _y);
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.image.Image_RGBA.RGBA>;
