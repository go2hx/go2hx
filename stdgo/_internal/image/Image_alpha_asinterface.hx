...
class Alpha_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function setAlpha(_x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color_alpha.Alpha):Void @:_0 __self__.value.setAlpha(_x, _y, _c);
    @:keep
    @:tdfield
    ...
    @:keep
    @:tdfield
    public dynamic function alphaAt(_x:stdgo.GoInt, _y:stdgo.GoInt):stdgo._internal.image.color.Color_alpha.Alpha return @:_0 __self__.value.alphaAt(_x, _y);
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.image.Image_alphapointer.AlphaPointer;
