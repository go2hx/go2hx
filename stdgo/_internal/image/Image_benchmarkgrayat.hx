...
function benchmarkGrayAt(_b:stdgo.Ref<stdgo._internal.testing.Testing_b.B>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L424"
        _b.resetTimer();
        //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L426"
        {
            var _i = (0 : stdgo.GoInt);
            while ((_i < (@:checkr _b ?? throw "null pointer dereference").n : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L427"
