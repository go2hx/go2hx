...
class Gray16_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function setGray16(_x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color_gray16.Gray16):Void @:_0 __self__.value.setGray16(_x, _y, _c);
    @:keep
    @:tdfield
    ...
    @:keep
    @:tdfield
    public dynamic function gray16At(_x:stdgo.GoInt, _y:stdgo.GoInt):stdgo._internal.image.color.Color_gray16.Gray16 return @:_0 __self__.value.gray16At(_x, _y);
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.image.Image_gray16pointer.Gray16Pointer;
