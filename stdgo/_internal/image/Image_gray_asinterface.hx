...
class Gray_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function setGray(_x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color_gray.Gray):Void @:_0 __self__.value.setGray(_x, _y, _c);
    @:keep
    @:tdfield
    ...
    @:keep
    @:tdfield
    public dynamic function grayAt(_x:stdgo.GoInt, _y:stdgo.GoInt):stdgo._internal.image.color.Color_gray.Gray return @:_0 __self__.value.grayAt(_x, _y);
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.image.Image_graypointer.GrayPointer;
