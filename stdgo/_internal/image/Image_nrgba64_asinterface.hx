...
class NRGBA64_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function setNRGBA64(_x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color_nrgba64.NRGBA64):Void @:_0 __self__.value.setNRGBA64(_x, _y, _c);
    @:keep
    @:tdfield
    ...
    @:keep
    @:tdfield
    public dynamic function nRGBA64At(_x:stdgo.GoInt, _y:stdgo.GoInt):stdgo._internal.image.color.Color_nrgba64.NRGBA64 return @:_0 __self__.value.nRGBA64At(_x, _y);
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.image.Image_nrgba64pointer.NRGBA64Pointer;
