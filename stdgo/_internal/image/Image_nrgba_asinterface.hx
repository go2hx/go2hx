...
class NRGBA_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function setNRGBA(_x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color_nrgba.NRGBA):Void @:_0 __self__.value.setNRGBA(_x, _y, _c);
    @:keep
    @:tdfield
    ...
    @:keep
    @:tdfield
    public dynamic function nRGBAAt(_x:stdgo.GoInt, _y:stdgo.GoInt):stdgo._internal.image.color.Color_nrgba.NRGBA return @:_0 __self__.value.nRGBAAt(_x, _y);
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.image.Image_nrgbapointer.NRGBAPointer;
