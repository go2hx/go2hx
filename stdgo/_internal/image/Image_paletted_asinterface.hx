...
class Paletted_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function setColorIndex(_x:stdgo.GoInt, _y:stdgo.GoInt, _index:stdgo.GoUInt8):Void @:_0 __self__.value.setColorIndex(_x, _y, _index);
    @:keep
    @:tdfield
    public dynamic function colorIndexAt(_x:stdgo.GoInt, _y:stdgo.GoInt):stdgo.GoUInt8 return @:_0 __self__.value.colorIndexAt(_x, _y);
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.image.Image_palettedpointer.PalettedPointer;
