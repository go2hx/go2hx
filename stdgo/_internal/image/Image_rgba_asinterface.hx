...
class RGBA_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function setRGBA(_x:stdgo.GoInt, _y:stdgo.GoInt, _c:stdgo._internal.image.color.Color_rgba.RGBA):Void @:_0 __self__.value.setRGBA(_x, _y, _c);
    @:keep
    @:tdfield
    ...
    @:keep
    @:tdfield
    public dynamic function rGBAAt(_x:stdgo.GoInt, _y:stdgo.GoInt):stdgo._internal.image.color.Color_rgba.RGBA return @:_0 __self__.value.rGBAAt(_x, _y);
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.image.Image_rgbapointer.RGBAPointer;
