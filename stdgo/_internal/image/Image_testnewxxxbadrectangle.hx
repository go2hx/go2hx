            ...
            try {
                {
                    __deferstack__.unshift({ ran : false, f : () -> ({
                        var a = function():Void {
                            //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L96"
                            if (({
                ...
                //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L100"
                _f(_r?.__copy__());
                //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L101"
                {
...
({ _name : ("RGBA" : stdgo.GoString), _f : function(_r:stdgo._internal.image.Image_rectangle.Rectangle):Void {
            //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L108"
...
({ _name : ("RGBA64" : stdgo.GoString), _f : function(_r:stdgo._internal.image.Image_rectangle.Rectangle):Void {
            //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L109"
...
({ _name : ("NRGBA" : stdgo.GoString), _f : function(_r:stdgo._internal.image.Image_rectangle.Rectangle):Void {
            //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L110"
...
({ _name : ("NRGBA64" : stdgo.GoString), _f : function(_r:stdgo._internal.image.Image_rectangle.Rectangle):Void {
            //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L111"
...
({ _name : ("Alpha" : stdgo.GoString), _f : function(_r:stdgo._internal.image.Image_rectangle.Rectangle):Void {
            //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L112"
...
({ _name : ("Alpha16" : stdgo.GoString), _f : function(_r:stdgo._internal.image.Image_rectangle.Rectangle):Void {
            //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L113"
...
({ _name : ("Gray" : stdgo.GoString), _f : function(_r:stdgo._internal.image.Image_rectangle.Rectangle):Void {
            //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L114"
...
({ _name : ("Gray16" : stdgo.GoString), _f : function(_r:stdgo._internal.image.Image_rectangle.Rectangle):Void {
            //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L115"
...
({ _name : ("CMYK" : stdgo.GoString), _f : function(_r:stdgo._internal.image.Image_rectangle.Rectangle):Void {
            //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L116"
...
({ _name : ("Paletted" : stdgo.GoString), _f : function(_r:stdgo._internal.image.Image_rectangle.Rectangle):Void {
            //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L117"
...
({ _name : ("YCbCr" : stdgo.GoString), _f : function(_r:stdgo._internal.image.Image_rectangle.Rectangle):Void {
            //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L118"
...
({ _name : ("NYCbCrA" : stdgo.GoString), _f : function(_r:stdgo._internal.image.Image_rectangle.Rectangle):Void {
            //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L119"
        ...
        //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L122"
        for (__0 => _tc in _testCases) {
            //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L125"
            for (__1 => _negDx in (new stdgo.Slice<Bool>(2, 2, ...[false, true]) : stdgo.Slice<Bool>)) {
                //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L126"
                for (__2 => _negDy in (new stdgo.Slice<Bool>(2, 2, ...[false, true]) : stdgo.Slice<Bool>)) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L131"
                    if (_negDx) {
                        _r.max.x = (14 : stdgo.GoInt);
                    };
                    //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L134"
                    if (_negDy) {
                        _r.max.y = (27 : stdgo.GoInt);
                    };
                    var _got = (_call(_tc._f, _r?.__copy__()) : Bool);
                    var _want = (!_negDx && !_negDy : Bool);
                    //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L140"
                    if (_got != (_want)) {
                        //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L141"
            ...
            //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L149"
            {
                ...
                //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L157"
                if (_got) {
                    //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L158"
