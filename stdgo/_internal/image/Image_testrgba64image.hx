...
function testRGBA64Image(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        var _memset = function(_s:stdgo.Slice<stdgo.GoUInt8>, _v:stdgo.GoUInt8):Void {
            //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L198"
            for (_i => _ in _s) {
...
stdgo.Go.asInterface(_r)]) : stdgo.Slice<stdgo._internal.image.Image_image.Image>);
        //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L220"
        for (__0 => _tc in _testCases) {
            //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L221"
            {
                final __type__ = _tc;
                if (stdgo.Go.typeEquals((__type__ : stdgo._internal.image.Image_t__interface_0.T__interface_0))) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L237"
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L249"
                    _memset((@:checkr _tc ?? throw "null pointer dereference").y, (119 : stdgo.GoUInt8));
                    //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L250"
                    _memset((@:checkr _tc ?? throw "null pointer dereference").cb, (136 : stdgo.GoUInt8));
                    //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L251"
                    ...
                    var _tc:stdgo._internal.image.Image_rectangle.Rectangle = __type__ == null ? ({} : stdgo._internal.image.Image_rectangle.Rectangle) : __type__.__underlying__() == null ? ({} : stdgo._internal.image.Image_rectangle.Rectangle) : stdgo.Go.fromAsInterfaceToValue(__type__ == null ? ({} : stdgo._internal.image.Image_rectangle.Rectangle) : __type__.__underlying__().value);
                } else {
                    var _tc:stdgo._internal.image.Image_image.Image = __type__ == null ? (null : stdgo._internal.image.Image_image.Image) : cast __type__;
                    //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L258"
                    _t.errorf(("could not initialize pixels for %T" : stdgo.GoString), stdgo.Go.toInterface(_tc));
                    //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L259"
                    continue;
                };
            };
            var __tmp__ = try {
            ...
            //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L264"
            if (!_ok) {
                //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L265"
                _t.errorf(("%T is not an RGBA64Image" : stdgo.GoString), stdgo.Go.toInterface(_tc));
                //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L266"
                continue;
            };
            ...
            //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L270"
            if ((((((_got.r : stdgo.GoUInt32) != _wantR) || ((_got.g : stdgo.GoUInt32) != _wantG) : Bool) || ((_got.b : stdgo.GoUInt32) != _wantB) : Bool) || ((_got.a : stdgo.GoUInt32) != _wantA) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L272"
                ...
                //"file:///home/runner/.go/go1.21.3/src/image/image_test.go#L276"
                continue;
            };
        };
    }
