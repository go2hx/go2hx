...
function _yCbCrModel(_c:stdgo._internal.image.color.Color_color.Color):stdgo._internal.image.color.Color_color.Color {
        //"file:///home/runner/.go/go1.21.3/src/image/color/ycbcr.go#L232"
        {
            var __tmp__ = try {
            ...
            if (_ok) {
                //"file:///home/runner/.go/go1.21.3/src/image/color/ycbcr.go#L233"
                return _c;
            };
        };
        ...
        //"file:///home/runner/.go/go1.21.3/src/image/color/ycbcr.go#L237"
