...
function benchmarkNYCbCrAToRGBA(_b:stdgo.Ref<stdgo._internal.testing.Testing_b.B>):Void {
        //"file:///home/runner/.go/go1.21.3/src/image/color/ycbcr_test.go#L248"
        _b.run(("0" : stdgo.GoString), function(_b:stdgo.Ref<stdgo._internal.testing.Testing_b.B>):Void {
            ...
            //"file:///home/runner/.go/go1.21.3/src/image/color/ycbcr_test.go#L250"
            {
        ...
        //"file:///home/runner/.go/go1.21.3/src/image/color/ycbcr_test.go#L254"
        _b.run(("128" : stdgo.GoString), function(_b:stdgo.Ref<stdgo._internal.testing.Testing_b.B>):Void {
            ...
            //"file:///home/runner/.go/go1.21.3/src/image/color/ycbcr_test.go#L256"
            {
                var _i = (0 : stdgo.GoInt);
                while ((_i < (@:checkr _b ?? throw "null pointer dereference").n : Bool)) {
                    {
        ...
        //"file:///home/runner/.go/go1.21.3/src/image/color/ycbcr_test.go#L260"
        _b.run(("255" : stdgo.GoString), function(_b:stdgo.Ref<stdgo._internal.testing.Testing_b.B>):Void {
            ...
            //"file:///home/runner/.go/go1.21.3/src/image/color/ycbcr_test.go#L262"
            {
                var _i = (0 : stdgo.GoInt);
                while ((_i < (@:checkr _b ?? throw "null pointer dereference").n : Bool)) {
                    {
