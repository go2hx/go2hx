...
function testSqDiff(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        var _orig = (function(_x:stdgo.GoUInt32, _y:stdgo.GoUInt32):stdgo.GoUInt32 {
            ...
            //"file:///home/runner/.go/go1.21.3/src/image/color/color_test.go#L16"
            if ((_x > _y : Bool)) {
                _d = (_x - _y : stdgo.GoUInt32);
            } else {
                _d = (_y - _x : stdgo.GoUInt32);
            };
            //"file:///home/runner/.go/go1.21.3/src/image/color/color_test.go#L21"
...
(-1u32 : stdgo.GoUInt32)]).__setNumber32__() : stdgo.Slice<stdgo.GoUInt32>);
        //"file:///home/runner/.go/go1.21.3/src/image/color/color_test.go#L37"
        for (__0 => _x in _testCases) {
            //"file:///home/runner/.go/go1.21.3/src/image/color/color_test.go#L38"
            for (__1 => _y in _testCases) {
                //"file:///home/runner/.go/go1.21.3/src/image/color/color_test.go#L39"
                {
                    var __0 = (stdgo._internal.image.color.Color__sqdiff._sqDiff(_x, _y) : stdgo.GoUInt32), __1 = (_orig(_x, _y) : stdgo.GoUInt32);
var _want = __1, _got = __0;
                    if (_got != (_want)) {
                        //"file:///home/runner/.go/go1.21.3/src/image/color/color_test.go#L40"
        ...
        //"file:///home/runner/.go/go1.21.3/src/image/color/color_test.go#L44"
        {
            ...
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/image/color/color_test.go#L45"
