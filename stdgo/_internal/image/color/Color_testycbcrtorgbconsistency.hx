...
function testYCbCrToRGBConsistency(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        //"file:///home/runner/.go/go1.21.3/src/image/color/ycbcr_test.go#L51"
        {
            var _y = (0 : stdgo.GoInt);
            while ((_y < (256 : stdgo.GoInt) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/image/color/ycbcr_test.go#L52"
                {
                    var _cb = (0 : stdgo.GoInt);
                    while ((_cb < (256 : stdgo.GoInt) : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/image/color/ycbcr_test.go#L53"
                        {
...
//"file:///home/runner/.go/go1.21.3/src/image/color/ycbcr_test.go#L58"
                                if (((_r1 != (_r2) || _g1 != (_g2) : Bool) || (_b1 != _b2) : Bool)) {
                                    //"file:///home/runner/.go/go1.21.3/src/image/color/ycbcr_test.go#L59"
