...
function _bench(_b:stdgo.Ref<stdgo._internal.testing.Testing_b.B>, _dcm:stdgo._internal.image.color.Color_model.Model, _scm:stdgo._internal.image.color.Color_model.Model, _mcm:stdgo._internal.image.color.Color_model.Model, _op:stdgo._internal.image.draw.Draw_op.Op):Void {
        //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L28"
        _b.stopTimer();
        var _dst:stdgo._internal.image.draw.Draw_image.Image = (null : stdgo._internal.image.draw.Draw_image.Image);
        //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L31"
        {
            ...
            if (stdgo.Go.toInterface(__value__) == (stdgo.Go.toInterface(stdgo._internal.image.color.Color_rgbamodel.rGBAModel))) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L34"
                {
                    var _y = (0 : stdgo.GoInt);
                    while ((_y < (480 : stdgo.GoInt) : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L35"
                        {
                            var _x = (0 : stdgo.GoInt);
                            while ((_x < (640 : stdgo.GoInt) : Bool)) {
                                //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L36"
                ...
                //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L47"
                {
                    var _y = (0 : stdgo.GoInt);
                    while ((_y < (480 : stdgo.GoInt) : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L48"
                        {
                            var _x = (0 : stdgo.GoInt);
                            while ((_x < (640 : stdgo.GoInt) : Bool)) {
                                //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L49"
                ...
                //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L61"
                if (stdgo._internal.reflect.Reflect_deepequal.deepEqual(stdgo.Go.toInterface(_dcm), stdgo.Go.toInterface(stdgo.Go.asInterface(stdgo._internal.image.draw.Draw__palette._palette)))) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L63"
                    {
                        var _y = (0 : stdgo.GoInt);
                        while ((_y < (480 : stdgo.GoInt) : Bool)) {
                            //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L64"
                            {
                                var _x = (0 : stdgo.GoInt);
                                while ((_x < (640 : stdgo.GoInt) : Bool)) {
                                    //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L65"
                                    _dst1.setColorIndex(_x, _y, (((_x ^ _y : stdgo.GoInt) : stdgo.GoUInt8) & (1 : stdgo.GoUInt8) : stdgo.GoUInt8));
                                    _x++;
                                };
                            };
                            _y++;
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L70"
                    _b.fatal(stdgo.Go.toInterface(("unknown destination color model" : stdgo.GoString)), stdgo.Go.toInterface(_dcm));
                };
            };
        };
        var _src:stdgo._internal.image.Image_image.Image = (null : stdgo._internal.image.Image_image.Image);
        //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L75"
        {
            ...
            if (__value__ == null) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L80"
                {
                    var _y = (0 : stdgo.GoInt);
                    while ((_y < (300 : stdgo.GoInt) : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L81"
                        {
                            var _x = (0 : stdgo.GoInt);
                            while ((_x < (400 : stdgo.GoInt) : Bool)) {
                                //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L82"
                ...
                //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L93"
                {
                    var _y = (0 : stdgo.GoInt);
                    while ((_y < (300 : stdgo.GoInt) : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L94"
                        {
                            var _x = (0 : stdgo.GoInt);
                            while ((_x < (400 : stdgo.GoInt) : Bool)) {
                                //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L95"
                                _src1.setGray(_x, _y, (new stdgo._internal.image.color.Color_gray.Gray(((((((11 : stdgo.GoInt) * _x : stdgo.GoInt) + ((13 : stdgo.GoInt) * _y : stdgo.GoInt) : stdgo.GoInt)) % (256 : stdgo.GoInt) : stdgo.GoInt) : stdgo.GoUInt8)) : stdgo._internal.image.color.Color_gray.Gray));
                                _x++;
                            };
                        };
                        _y++;
                ...
                //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L103"
                {
                    var _y = (0 : stdgo.GoInt);
                    while ((_y < (300 : stdgo.GoInt) : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L104"
                        {
                            var _x = (0 : stdgo.GoInt);
                            while ((_x < (400 : stdgo.GoInt) : Bool)) {
                                //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L105"
                ...
                //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L116"
                {
                    var _y = (0 : stdgo.GoInt);
                    while ((_y < (300 : stdgo.GoInt) : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L117"
                        {
                            var _x = (0 : stdgo.GoInt);
                            while ((_x < (400 : stdgo.GoInt) : Bool)) {
                                //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L118"
                ...
                //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L129"
                {
                    var _y = (0 : stdgo.GoInt);
                    while ((_y < (300 : stdgo.GoInt) : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L130"
                        {
                            var _x = (0 : stdgo.GoInt);
                            while ((_x < (400 : stdgo.GoInt) : Bool)) {
                                //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L131"
                ...
                //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L144"
                for (_i => _ in _yy) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L159"
                _b.fatal(stdgo.Go.toInterface(("unknown source color model" : stdgo.GoString)), stdgo.Go.toInterface(_scm));
            };
        };
        var _mask:stdgo._internal.image.Image_image.Image = (null : stdgo._internal.image.Image_image.Image);
        //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L163"
        {
            ...
            if (__value__ == null) {} else if (stdgo.Go.toInterface(__value__) == (stdgo.Go.toInterface(stdgo._internal.image.color.Color_alphamodel.alphaModel))) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L168"
                {
                    var _y = (0 : stdgo.GoInt);
                    while ((_y < (300 : stdgo.GoInt) : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L169"
                        {
                            var _x = (0 : stdgo.GoInt);
                            while ((_x < (400 : stdgo.GoInt) : Bool)) {
                                var _a = ((((((23 : stdgo.GoInt) * _x : stdgo.GoInt) + ((29 : stdgo.GoInt) * _y : stdgo.GoInt) : stdgo.GoInt)) % (256 : stdgo.GoInt) : stdgo.GoInt) : stdgo.GoUInt8);
//"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L173"
                                if ((_a >= (192 : stdgo.GoUInt8) : Bool)) {
                                    //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L174"
                                    _mask1.setAlpha(_x, _y, (new stdgo._internal.image.color.Color_alpha.Alpha(_a) : stdgo._internal.image.color.Color_alpha.Alpha));
                                };
                                _x++;
                            };
                        };
                ...
                //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L180"
                _b.fatal(stdgo.Go.toInterface(("unknown mask color model" : stdgo.GoString)), stdgo.Go.toInterface(_mcm));
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L183"
        _b.startTimer();
        //"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L184"
        {
...
//"file:///home/runner/.go/go1.21.3/src/image/draw/bench_test.go#L189"
