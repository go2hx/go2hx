...
function _convertToSlowestRGBA(_m:stdgo._internal.image.Image_image.Image):stdgo.Ref<stdgo._internal.image.draw.Draw_t_slowestrgba.T_slowestRGBA> {
        //"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L70"
        {
            var __tmp__ = try {
            ...
            if (_ok) {
                //"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L71"
        ...
        //"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L78"
        ...
        //"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L79"
        return (stdgo.Go.setRef(({ pix : (@:checkr _rgba ?? throw "null pointer dereference").pix, stride : (@:checkr _rgba ?? throw "null pointer dereference").stride, rect : (@:checkr _rgba ?? throw "null pointer dereference").rect?.__copy__() } : stdgo._internal.image.draw.Draw_t_slowestrgba.T_slowestRGBA)) : stdgo.Ref<stdgo._internal.image.draw.Draw_t_slowestrgba.T_slowestRGBA>);
    }
