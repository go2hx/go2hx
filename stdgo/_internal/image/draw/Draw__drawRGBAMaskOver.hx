...
var _sr = (_src.pix[(_si + (0 : stdgo.GoInt) : stdgo.GoInt)] : stdgo.GoUInt32);
var _sg = (_src.pix[(_si + (1 : stdgo.GoInt) : stdgo.GoInt)] : stdgo.GoUInt32);
var _sb = (_src.pix[(_si + (2 : stdgo.GoInt) : stdgo.GoInt)] : stdgo.GoUInt32);
var _sa = (_src.pix[(_si + (3 : stdgo.GoInt) : stdgo.GoInt)] : stdgo.GoUInt32);
