...
function _makeGolden(_dst:stdgo._internal.image.Image_image.Image, _r:stdgo._internal.image.Image_rectangle.Rectangle, _src:stdgo._internal.image.Image_image.Image, _sp:stdgo._internal.image.Image_point.Point, _mask:stdgo._internal.image.Image_image.Image, _mp:stdgo._internal.image.Image_point.Point, _op:stdgo._internal.image.draw.Draw_op.Op):stdgo._internal.image.Image_image.Image {
        ...
        //"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L417"
        if (_mask != null) {
        ...
        //"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L421"
        {
...
//"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L424"
                {
                    var _x = (_r.min.x : stdgo.GoInt);
                    while ((_x < _r.max.x : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L425"
                        if (!(stdgo._internal.image.Image_pt.pt(_x, _y).in_(_b.__copy__()))) {
                            //"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L426"
                            {
                                _x++;
                                continue;
                            };
...
//"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L429"
                        if (!(stdgo._internal.image.Image_pt.pt(_sx, _sy).in_(_sb.__copy__()))) {
                            //"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L430"
                            {
                                _x++;
                                continue;
                            };
...
//"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L433"
                        if (!(stdgo._internal.image.Image_pt.pt(_mx, _my).in_(_mb.__copy__()))) {
                            //"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L434"
                            {
                                _x++;
                                continue;
                            };
...
//"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L439"
...
//"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L444"
                        if (_mask != null) {
                            {
...
//"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L448"
        ...
        //"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L456"
        return _golden.subImage(_b?.__copy__());
    }
