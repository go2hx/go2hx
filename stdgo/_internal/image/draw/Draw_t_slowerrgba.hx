...
@:structInit @:using(stdgo._internal.image.draw.Draw_t_slowerrgba_static_extension.T_slowerRGBA_static_extension) class T_slowerRGBA {
    ...
    public function __copy__() {
        return new T_slowerRGBA(pix, stride, rect);
    }
}
