...
function testDraw(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        var _i_5011986_1:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        var _i_5012021_3:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _r_2 = _rr_0[(_i_5011986_1 : stdgo.GoInt)];
                    ...
                    _test_4 = stdgo._internal.image.draw.Draw__drawtests._drawTests[(_i_5012021_3 : stdgo.GoInt)];
                    _i_5 = (0 : stdgo.GoInt);
                ...
                } else if (__value__ == (5013740i32)) {
                    {
                        ...
                        _i_5011986_1 = @:binopAssign __tmp__0;
                        _r_2 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5013741i32;
                } else if (__value__ == (5013741i32)) {
                    if (_i_5011986_1 < (_rr_0.length)) {
