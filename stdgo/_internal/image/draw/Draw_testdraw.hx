        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _r_2 = _rr_0[(_iterator_5226965_1 : stdgo.GoInt)];
                    ...
                    _test_4 = stdgo._internal.image.draw.Draw__drawtests._drawTests[(_iterator_5227000_3 : stdgo.GoInt)];
                    _i_5 = (0 : stdgo.GoInt);
                    ...
                    stdgo._internal.image.draw.Draw__iterator_5227000._iterator_5227000++;
                    _gotoNext = 5228717i32;
                } else if (__value__ == (5228716i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = stdgo._internal.image.draw.Draw__drawtests._drawTests[(0i32 : stdgo.GoInt)];
                        _iterator_5227000_3 = @:binopAssign __tmp__0;
                        _test_4 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5228717i32;
                } else if (__value__ == (5228717i32)) {
                    if (_iterator_5227000_3 < (stdgo._internal.image.draw.Draw__drawtests._drawTests.length)) {
                ...
                } else if (__value__ == (5228719i32)) {
                    {
                        ...
                        _iterator_5226965_1 = @:binopAssign __tmp__0;
                        _r_2 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5228720i32;
                } else if (__value__ == (5228720i32)) {
                    if (_iterator_5226965_1 < (_rr_0.length)) {
