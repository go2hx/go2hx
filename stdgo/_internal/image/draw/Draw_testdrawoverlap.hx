...
function testDrawOverlap(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        var _i_5239824_11:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((0i32 : stdgo.GoInt) < ((new stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>(2, 2, ...[(0 : stdgo._internal.image.draw.Draw_op.Op), (1 : stdgo._internal.image.draw.Draw_op.Op)]).__setNumber32__() : stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>).length)) {
                        _gotoNext = 5241016i32;
                    } else {
                        _gotoNext = 5241019i32;
                    };
                } else if (__value__ == (5239815i32)) {
                    _i_5239824_11++;
                    _gotoNext = 5241017i32;
                } else if (__value__ == (5239846i32)) {
                    _op_12 = (new stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>(2, 2, ...[(0 : stdgo._internal.image.draw.Draw_op.Op), (1 : stdgo._internal.image.draw.Draw_op.Op)]).__setNumber32__() : stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>)[(_i_5239824_11 : stdgo.GoInt)];
                    _yoff_13 = (-2 : stdgo.GoInt);
                    _gotoNext = 5239850i32;
                } else if (__value__ == (5239850i32)) {
                    if ((_yoff_13 <= (2 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 5239884i32;
                    } else {
                        _gotoNext = 5239815i32;
                    };
                } else if (__value__ == (5239877i32)) {
                    _yoff_13++;
                    _gotoNext = 5239850i32;
                } else if (__value__ == (5239884i32)) {
                    _gotoNext = 5239888i32;
                } else if (__value__ == (5239888i32)) {
                    _xoff_14 = (-2 : stdgo.GoInt);
                    _loopBreak = false;
                    _gotoNext = 5239897i32;
                } else if (__value__ == (5239897i32)) {
                    if (!_loopBreak && ((_xoff_14 <= (2 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5239931i32;
                    } else {
                        _gotoNext = 5239877i32;
                    };
                } else if (__value__ == (5239924i32)) {
                    _xoff_14++;
                    _gotoNext = 5239897i32;
                } else if (__value__ == (5239931i32)) {
                    ...
                    if (!_b_18.eq(_golden_19.bounds()?.__copy__())) {
                        _gotoNext = 5240345i32;
                    } else {
                        _gotoNext = 5240578i32;
                    };
                } else if (__value__ == (5240345i32)) {
                    ...
                    _y_20 = _b_18.min.y;
                    _gotoNext = 5240710i32;
                } else if (__value__ == (5240710i32)) {
                    if ((_y_20 < _b_18.max.y : Bool)) {
                        _gotoNext = 5240745i32;
                    } else {
                        _gotoNext = 5239924i32;
                    };
                } else if (__value__ == (5240741i32)) {
                    _y_20++;
                    _gotoNext = 5240710i32;
                } else if (__value__ == (5240745i32)) {
                    _x_21 = _b_18.min.x;
                    _gotoNext = 5240752i32;
                } else if (__value__ == (5240752i32)) {
                    if ((_x_21 < _b_18.max.x : Bool)) {
                        _gotoNext = 5240787i32;
                    } else {
                        _gotoNext = 5240741i32;
                    };
                } else if (__value__ == (5240783i32)) {
                    _x_21++;
                    _gotoNext = 5240752i32;
                } else if (__value__ == (5240787i32)) {
                    if (!stdgo._internal.image.draw.Draw__eq._eq(@:check2r _dst_16.at(_x_21, _y_20), _golden_19.at(_x_21, _y_20))) {
                        _gotoNext = 5240833i32;
                    } else {
                        _gotoNext = 5240783i32;
                    };
                } else if (__value__ == (5240833i32)) {
                ...
                } else if (__value__ == (5241016i32)) {
                    {
                        ...
                        _i_5239824_11 = @:binopAssign __tmp__0;
                        _op_12 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5241017i32;
                } else if (__value__ == (5241017i32)) {
                    if (_i_5239824_11 < ((new stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>(2, 2, ...[(0 : stdgo._internal.image.draw.Draw_op.Op), (1 : stdgo._internal.image.draw.Draw_op.Op)]).__setNumber32__() : stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>).length)) {
                        _gotoNext = 5239846i32;
                    } else {
                        _gotoNext = 5241019i32;
                    };
                } else if (__value__ == (5241019i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
