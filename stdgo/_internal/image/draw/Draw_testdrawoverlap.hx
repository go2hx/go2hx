...
function testDrawOverlap(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        var _iterator_5115471_11:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((0i32 : stdgo.GoInt) < ((new stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>(2, 2, ...[(0 : stdgo._internal.image.draw.Draw_op.Op), (1 : stdgo._internal.image.draw.Draw_op.Op)]).__setNumber32__() : stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>).length)) {
                        _gotoNext = 5116663i32;
                    } else {
                        _gotoNext = 5116666i32;
                    };
                } else if (__value__ == (5115462i32)) {
                    _iterator_5115471_11++;
                    _gotoNext = 5116664i32;
                } else if (__value__ == (5115493i32)) {
                    _op_12 = (new stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>(2, 2, ...[(0 : stdgo._internal.image.draw.Draw_op.Op), (1 : stdgo._internal.image.draw.Draw_op.Op)]).__setNumber32__() : stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>)[(_iterator_5115471_11 : stdgo.GoInt)];
                    _yoff_13 = (-2 : stdgo.GoInt);
                    _gotoNext = 5115497i32;
                } else if (__value__ == (5115497i32)) {
                    if ((_yoff_13 <= (2 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 5115531i32;
                    } else {
                        _gotoNext = 5115462i32;
                    };
                } else if (__value__ == (5115524i32)) {
                    _yoff_13++;
                    _gotoNext = 5115497i32;
                } else if (__value__ == (5115531i32)) {
                    _gotoNext = 5115535i32;
                } else if (__value__ == (5115535i32)) {
                    _xoff_14 = (-2 : stdgo.GoInt);
                    _loopBreak = false;
                    _gotoNext = 5115544i32;
                } else if (__value__ == (5115544i32)) {
                    if (!_loopBreak && ((_xoff_14 <= (2 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5115578i32;
                    } else {
                        _gotoNext = 5115524i32;
                    };
                } else if (__value__ == (5115571i32)) {
                    _xoff_14++;
                    _gotoNext = 5115544i32;
                } else if (__value__ == (5115578i32)) {
                    ...
                    if (!_b_18.eq(_golden_19.bounds()?.__copy__())) {
                        _gotoNext = 5115992i32;
                    } else {
                        _gotoNext = 5116225i32;
                    };
                } else if (__value__ == (5115992i32)) {
                    ...
                    _y_20 = _b_18.min.y;
                    _gotoNext = 5116357i32;
                } else if (__value__ == (5116357i32)) {
                    if ((_y_20 < _b_18.max.y : Bool)) {
                        _gotoNext = 5116392i32;
                    } else {
                        _gotoNext = 5115571i32;
                    };
                } else if (__value__ == (5116388i32)) {
                    _y_20++;
                    _gotoNext = 5116357i32;
                } else if (__value__ == (5116392i32)) {
                    _x_21 = _b_18.min.x;
                    _gotoNext = 5116399i32;
                } else if (__value__ == (5116399i32)) {
                    if ((_x_21 < _b_18.max.x : Bool)) {
                        _gotoNext = 5116434i32;
                    } else {
                        _gotoNext = 5116388i32;
                    };
                } else if (__value__ == (5116430i32)) {
                    _x_21++;
                    _gotoNext = 5116399i32;
                } else if (__value__ == (5116434i32)) {
                    if (!stdgo._internal.image.draw.Draw__eq._eq(@:check2r _dst_16.at(_x_21, _y_20), _golden_19.at(_x_21, _y_20))) {
                        _gotoNext = 5116480i32;
                    } else {
                        _gotoNext = 5116430i32;
                    };
                } else if (__value__ == (5116480i32)) {
                ...
                } else if (__value__ == (5116663i32)) {
                    {
                        ...
                        _iterator_5115471_11 = @:binopAssign __tmp__0;
                        _op_12 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5116664i32;
                } else if (__value__ == (5116664i32)) {
                    if (_iterator_5115471_11 < ((new stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>(2, 2, ...[(0 : stdgo._internal.image.draw.Draw_op.Op), (1 : stdgo._internal.image.draw.Draw_op.Op)]).__setNumber32__() : stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>).length)) {
                        _gotoNext = 5115493i32;
                    } else {
                        _gotoNext = 5116666i32;
                    };
                } else if (__value__ == (5116666i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
