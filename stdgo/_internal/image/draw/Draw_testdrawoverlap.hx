...
function testDrawOverlap(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        var _iterator_5122201_11:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((0i32 : stdgo.GoInt) < ((new stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>(2, 2, ...[(0 : stdgo._internal.image.draw.Draw_op.Op), (1 : stdgo._internal.image.draw.Draw_op.Op)]).__setNumber32__() : stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>).length)) {
                        _gotoNext = 5123393i32;
                    } else {
                        _gotoNext = 5123396i32;
                    };
                } else if (__value__ == (5122192i32)) {
                    _iterator_5122201_11++;
                    _gotoNext = 5123394i32;
                } else if (__value__ == (5122223i32)) {
                    _op_12 = (new stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>(2, 2, ...[(0 : stdgo._internal.image.draw.Draw_op.Op), (1 : stdgo._internal.image.draw.Draw_op.Op)]).__setNumber32__() : stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>)[(_iterator_5122201_11 : stdgo.GoInt)];
                    _yoff_13 = (-2 : stdgo.GoInt);
                    _gotoNext = 5122227i32;
                } else if (__value__ == (5122227i32)) {
                    if ((_yoff_13 <= (2 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 5122261i32;
                    } else {
                        _gotoNext = 5122192i32;
                    };
                } else if (__value__ == (5122254i32)) {
                    _yoff_13++;
                    _gotoNext = 5122227i32;
                } else if (__value__ == (5122261i32)) {
                    _gotoNext = 5122265i32;
                } else if (__value__ == (5122265i32)) {
                    _xoff_14 = (-2 : stdgo.GoInt);
                    _loopBreak = false;
                    _gotoNext = 5122274i32;
                } else if (__value__ == (5122274i32)) {
                    if (!_loopBreak && ((_xoff_14 <= (2 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 5122308i32;
                    } else {
                        _gotoNext = 5122254i32;
                    };
                } else if (__value__ == (5122301i32)) {
                    _xoff_14++;
                    _gotoNext = 5122274i32;
                } else if (__value__ == (5122308i32)) {
                    ...
                    if (!_b_18.eq(_golden_19.bounds()?.__copy__())) {
                        _gotoNext = 5122722i32;
                    } else {
                        _gotoNext = 5122955i32;
                    };
                } else if (__value__ == (5122722i32)) {
                    ...
                    _y_20 = _b_18.min.y;
                    _gotoNext = 5123087i32;
                } else if (__value__ == (5123087i32)) {
                    if ((_y_20 < _b_18.max.y : Bool)) {
                        _gotoNext = 5123122i32;
                    } else {
                        _gotoNext = 5122301i32;
                    };
                } else if (__value__ == (5123118i32)) {
                    _y_20++;
                    _gotoNext = 5123087i32;
                } else if (__value__ == (5123122i32)) {
                    _x_21 = _b_18.min.x;
                    _gotoNext = 5123129i32;
                } else if (__value__ == (5123129i32)) {
                    if ((_x_21 < _b_18.max.x : Bool)) {
                        _gotoNext = 5123164i32;
                    } else {
                        _gotoNext = 5123118i32;
                    };
                } else if (__value__ == (5123160i32)) {
                    _x_21++;
                    _gotoNext = 5123129i32;
                } else if (__value__ == (5123164i32)) {
                    if (!stdgo._internal.image.draw.Draw__eq._eq(@:check2r _dst_16.at(_x_21, _y_20), _golden_19.at(_x_21, _y_20))) {
                        _gotoNext = 5123210i32;
                    } else {
                        _gotoNext = 5123160i32;
                    };
                } else if (__value__ == (5123210i32)) {
                ...
                } else if (__value__ == (5123393i32)) {
                    {
                        ...
                        _iterator_5122201_11 = @:binopAssign __tmp__0;
                        _op_12 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 5123394i32;
                } else if (__value__ == (5123394i32)) {
                    if (_iterator_5122201_11 < ((new stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>(2, 2, ...[(0 : stdgo._internal.image.draw.Draw_op.Op), (1 : stdgo._internal.image.draw.Draw_op.Op)]).__setNumber32__() : stdgo.Slice<stdgo._internal.image.draw.Draw_op.Op>).length)) {
                        _gotoNext = 5122223i32;
                    } else {
                        _gotoNext = 5123396i32;
                    };
                } else if (__value__ == (5123396i32)) {
                    _gotoNext = -1i32;
                };
            };
        };
