...
function testFloydSteinbergCheckerboard(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L697"
        ...
        //"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L699"
        {
            var _y = (_b.min.y : stdgo.GoInt);
            while ((_y < _b.max.y : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L700"
                {
                    var _x = (_b.min.x : stdgo.GoInt);
                    while ((_x < _b.max.x : Bool)) {
                        var _got = ((@:checkr _dst ?? throw "null pointer dereference").pix[(_dst.pixOffset(_x, _y) : stdgo.GoInt)] : stdgo.GoUInt8);
var _want = (((_x + _y : stdgo.GoInt) : stdgo.GoUInt8) % (2 : stdgo.GoUInt8) : stdgo.GoUInt8);
//"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L703"
                        if (_got != (_want)) {
                            //"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L704"
                            _t.errorf(("at (%d, %d): got %d, want %d" : stdgo.GoString), stdgo.Go.toInterface(_x), stdgo.Go.toInterface(_y), stdgo.Go.toInterface(_got), stdgo.Go.toInterface(_want));
                            //"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L705"
                            {
                                _nErr++;
                                if (_nErr == ((10 : stdgo.GoInt))) {
                                    //"file:///home/runner/.go/go1.21.3/src/image/draw/draw_test.go#L706"
                                    _t.fatal(stdgo.Go.toInterface(("there may be more errors" : stdgo.GoString)));
                                };
                            };
                        };
                        _x++;
