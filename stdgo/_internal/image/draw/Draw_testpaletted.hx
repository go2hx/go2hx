...
function testPaletted(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        try {
            ...
            var _keys_5123358:stdgo.Slice<Dynamic> = (new stdgo.Slice<stdgo.GoString>(0, 0, ...[]).__setString__() : stdgo.Slice<stdgo.GoString>);
            var _iterator_5123374 = 0i32;
            var _x_36:stdgo.GoInt = (0 : stdgo.GoInt);
            var _iterator_5123417 = 0i32;
            ...
            var _keys_5123399:stdgo.Slice<Dynamic> = (new stdgo.Slice<stdgo.GoString>(0, 0, ...[]).__setString__() : stdgo.Slice<stdgo.GoString>);
            ...
            while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
                {
                    ...
                    if (__value__ == (0i32)) {
                        ...
                        if (_err_23 != null) {
                            _gotoNext = 5122788i32;
                        } else {
                            _gotoNext = 5122822i32;
                        };
                    } else if (__value__ == (5122788i32)) {
                        @:check2r _t.fatalf(("open: %v" : stdgo.GoString), stdgo.Go.toInterface(_err_23));
                        _gotoNext = 5122822i32;
                    } else if (__value__ == (5122822i32)) {
                        {
                        ...
                        if (_err_23 != null) {
                            _gotoNext = 5122885i32;
                        } else {
                            _gotoNext = 5122921i32;
                        };
                    } else if (__value__ == (5122885i32)) {
                        @:check2r _t.fatalf(("decode: %v" : stdgo.GoString), stdgo.Go.toInterface(_err_23));
                        _gotoNext = 5122921i32;
                    } else if (__value__ == (5122921i32)) {
...
x.set(("video001" : stdgo.GoString), _video001_24);
                        ...
                        _keys_5123358 = (new stdgo.Slice<stdgo.GoString>(0, 0, ...[]).__setString__() : stdgo.Slice<stdgo.GoString>);
                        for (_key => _ in _drawers_27) {
                            _keys_5123358 = _keys_5123358.__append__(_key);
                        };
                        if ((0i32 : stdgo.GoInt) < (_drawers_27.length)) {
                            _gotoNext = 5123894i32;
                        } else {
                            _gotoNext = 5123897i32;
                        };
                    } else if (__value__ == (5123374i32)) {
                        _iterator_5123374++;
                        _gotoNext = 5123895i32;
                    } else if (__value__ == (5123388i32)) {
                        _d_29 = (_drawers_27[_keys_5123358[@:invalid_index_invalid_type _iterator_5123374]] ?? (null : stdgo._internal.image.draw.Draw_drawer.Drawer));
                        _dName_30 = _keys_5123358[@:invalid_index_invalid_type _iterator_5123374]?.__copy__();
                        _gotoNext = 5123391i32;
                    } else if (__value__ == (5123391i32)) {
                        _keys_5123399 = (new stdgo.Slice<stdgo.GoString>(0, 0, ...[]).__setString__() : stdgo.Slice<stdgo.GoString>);
                        for (_key => _ in _sources_28) {
                            _keys_5123399 = _keys_5123399.__append__(_key);
                        };
                        if ((0i32 : stdgo.GoInt) < (_sources_28.length)) {
                            _gotoNext = 5123891i32;
                        } else {
                            _gotoNext = 5123374i32;
                        };
                    } else if (__value__ == (5123417i32)) {
                        _iterator_5123417++;
                        _gotoNext = 5123892i32;
                    } else if (__value__ == (5123431i32)) {
                        _src_31 = (_sources_28[_keys_5123399[@:invalid_index_invalid_type _iterator_5123417]] ?? (null : stdgo._internal.image.Image_image.Image));
                        _sName_32 = _keys_5123399[@:invalid_index_invalid_type _iterator_5123417]?.__copy__();
                        ...
                        _y_35 = _b_25.min.y;
                        _gotoNext = 5123620i32;
                    } else if (__value__ == (5123620i32)) {
                        if ((_y_35 < _b_25.max.y : Bool)) {
                            _gotoNext = 5123655i32;
                        } else {
                            _gotoNext = 5123417i32;
                        };
                    } else if (__value__ == (5123651i32)) {
                        _y_35++;
                        _gotoNext = 5123620i32;
                    } else if (__value__ == (5123655i32)) {
                        _x_36 = _b_25.min.x;
                        _gotoNext = 5123661i32;
                    } else if (__value__ == (5123661i32)) {
                        if ((_x_36 < _b_25.max.x : Bool)) {
                            _gotoNext = 5123696i32;
                        } else {
                            _gotoNext = 5123651i32;
                        };
                    } else if (__value__ == (5123692i32)) {
                        _x_36++;
                        _gotoNext = 5123661i32;
                    } else if (__value__ == (5123696i32)) {
                        if (!stdgo._internal.image.draw.Draw__eq._eq(@:check2r _dst0_33.at(_x_36, _y_35), @:check2r _dst1_34.at(_x_36, _y_35))) {
                            _gotoNext = 5123740i32;
                        } else {
                            _gotoNext = 5123692i32;
                        };
                    } else if (__value__ == (5123740i32)) {
                        ...
                        _iterator_5123417++;
                        _gotoNext = 5123892i32;
                    } else if (__value__ == (5123891i32)) {
                        _iterator_5123417 = 0i32;
                        _gotoNext = 5123892i32;
                    } else if (__value__ == (5123892i32)) {
                        if (_iterator_5123417 < (_keys_5123399.length)) {
                            _gotoNext = 5123431i32;
                        } else {
                            _gotoNext = 5123374i32;
                        };
                    } else if (__value__ == (5123894i32)) {
                        _iterator_5123374 = 0i32;
                        _gotoNext = 5123895i32;
                    } else if (__value__ == (5123895i32)) {
                        if (_iterator_5123374 < (_keys_5123358.length)) {
                            _gotoNext = 5123388i32;
                        } else {
                            _gotoNext = 5123897i32;
                        };
                    } else if (__value__ == (5123897i32)) {
                        _gotoNext = -1i32;
                    };
                };
            };
