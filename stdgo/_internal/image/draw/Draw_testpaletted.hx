...
function testPaletted(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        try {
            ...
            var _iterator_5236722 = 0i32;
            var _keys_5236663:stdgo.Slice<Dynamic> = (new stdgo.Slice<stdgo.GoString>(0, 0, ...[]).__setString__() : stdgo.Slice<stdgo.GoString>);
            ...
            var _keys_5236704:stdgo.Slice<Dynamic> = (new stdgo.Slice<stdgo.GoString>(0, 0, ...[]).__setString__() : stdgo.Slice<stdgo.GoString>);
...
x.set(("video001" : stdgo.GoString), _video001_24);
                        ...
                        _d_29 = (_drawers_27[_keys_5236663[@:invalid_index_invalid_type _iterator_5236679]] ?? (null : stdgo._internal.image.draw.Draw_drawer.Drawer));
                        _dName_30 = _keys_5236663[@:invalid_index_invalid_type _iterator_5236679]?.__copy__();
                        ...
                        _src_31 = (_sources_28[_keys_5236704[@:invalid_index_invalid_type _iterator_5236722]] ?? (null : stdgo._internal.image.Image_image.Image));
                        _sName_32 = _keys_5236704[@:invalid_index_invalid_type _iterator_5236722]?.__copy__();
                        ...
                        _iterator_5236722 = 0i32;
                        _gotoNext = 5237197i32;
                    } else if (__value__ == (5237197i32)) {
                        if (_iterator_5236722 < (_keys_5236704.length)) {
                            _gotoNext = 5236736i32;
                        } else {
                            _gotoNext = 5236679i32;
                        };
                    } else if (__value__ == (5237199i32)) {
                        _iterator_5236679 = 0i32;
                        _gotoNext = 5237200i32;
                    } else if (__value__ == (5237200i32)) {
                        if (_iterator_5236679 < (_keys_5236663.length)) {
