...
function testPaletted(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        try {
            ...
            var _keys_5021725:stdgo.Slice<#NULL_TYPE> = (new stdgo.Slice<stdgo.GoString>(0, 0, ...[]).__setString__() : stdgo.Slice<stdgo.GoString>);
            var _i_5021743 = 0i32;
            var _d_29:stdgo._internal.image.draw.Draw_drawer.Drawer = (null : stdgo._internal.image.draw.Draw_drawer.Drawer);
            var _keys_5021684:stdgo.Slice<#NULL_TYPE> = (new stdgo.Slice<stdgo.GoString>(0, 0, ...[]).__setString__() : stdgo.Slice<stdgo.GoString>);
...
x.set(("video001" : stdgo.GoString), _video001_24);
                        ...
                        _d_29 = (_drawers_27[_keys_5021684[@:invalid_index_invalid_type _i_5021700]] ?? (null : stdgo._internal.image.draw.Draw_drawer.Drawer));
                        _dName_30 = _keys_5021684[@:invalid_index_invalid_type _i_5021700]?.__copy__();
                        ...
                        _src_31 = (_sources_28[_keys_5021725[@:invalid_index_invalid_type _i_5021743]] ?? (null : stdgo._internal.image.Image_image.Image));
                        _sName_32 = _keys_5021725[@:invalid_index_invalid_type _i_5021743]?.__copy__();
                        ...
                        if (_i_5021743 < (_keys_5021725.length)) {
                        ...
                        if (_i_5021700 < (_keys_5021684.length)) {
