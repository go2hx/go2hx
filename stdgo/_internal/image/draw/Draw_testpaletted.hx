...
function testPaletted(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        try {
            ...
            var _keys_5130129:stdgo.Slice<#NULL_TYPE> = (new stdgo.Slice<stdgo.GoString>(0, 0, ...[]).__setString__() : stdgo.Slice<stdgo.GoString>);
            var _keys_5130088:stdgo.Slice<#NULL_TYPE> = (new stdgo.Slice<stdgo.GoString>(0, 0, ...[]).__setString__() : stdgo.Slice<stdgo.GoString>);
...
x.set(("video001" : stdgo.GoString), _video001_24);
                        ...
                        _d_29 = (_drawers_27[_keys_5130088[@:invalid_index_invalid_type _i_5130104]] ?? (null : stdgo._internal.image.draw.Draw_drawer.Drawer));
                        _dName_30 = _keys_5130088[@:invalid_index_invalid_type _i_5130104]?.__copy__();
                        ...
                        _src_31 = (_sources_28[_keys_5130129[@:invalid_index_invalid_type _i_5130147]] ?? (null : stdgo._internal.image.Image_image.Image));
                        _sName_32 = _keys_5130129[@:invalid_index_invalid_type _i_5130147]?.__copy__();
                        ...
                        if (_i_5130147 < (_keys_5130129.length)) {
                        ...
                        if (_i_5130104 < (_keys_5130088.length)) {
