...
@:structInit @:using(stdgo._internal.image.jpeg.Jpeg_T_decoder_static_extension.T_decoder_static_extension) class T_decoder {
    ...
    public var _bytes : { var _buf : stdgo.GoArray<stdgo.GoUInt8>; var _i : stdgo.GoInt; var _j : stdgo.GoInt; var _nUnreadable : stdgo.GoInt; } = { _buf : new stdgo.GoArray<stdgo.GoUInt8>(4096, 4096, ...[for (i in 0 ... 4096) (0 : stdgo.GoUInt8)]), _i : (0 : stdgo.GoInt), _j : (0 : stdgo.GoInt), _nUnreadable : (0 : stdgo.GoInt) };
    ...
    public var _comp : stdgo.GoArray<stdgo._internal.image.jpeg.Jpeg_T_component.T_component> = new stdgo.GoArray<stdgo._internal.image.jpeg.Jpeg_T_component.T_component>(4, 4, ...[for (i in 0 ... 4) ({} : stdgo._internal.image.jpeg.Jpeg_T_component.T_component)]);
    public var _progCoeffs : stdgo.GoArray<stdgo.Slice<stdgo._internal.image.jpeg.Jpeg_T_block.T_block>> = new stdgo.GoArray<stdgo.Slice<stdgo._internal.image.jpeg.Jpeg_T_block.T_block>>(4, 4, ...[for (i in 0 ... 4) (null : stdgo.Slice<stdgo._internal.image.jpeg.Jpeg_T_block.T_block>)]);
    public var _huff : stdgo.GoArray<stdgo.GoArray<stdgo._internal.image.jpeg.Jpeg_T_huffman.T_huffman>> = new stdgo.GoArray<stdgo.GoArray<stdgo._internal.image.jpeg.Jpeg_T_huffman.T_huffman>>(2, 2, ...[for (i in 0 ... 2) new stdgo.GoArray<stdgo._internal.image.jpeg.Jpeg_T_huffman.T_huffman>(4, 4, ...[for (i in 0 ... 4) ({} : stdgo._internal.image.jpeg.Jpeg_T_huffman.T_huffman)])]);
    public var _quant : stdgo.GoArray<stdgo._internal.image.jpeg.Jpeg_T_block.T_block> = new stdgo.GoArray<stdgo._internal.image.jpeg.Jpeg_T_block.T_block>(4, 4, ...[for (i in 0 ... 4) new stdgo._internal.image.jpeg.Jpeg_T_block.T_block(64, 64, ...[for (i in 0 ... 64) (0 : stdgo.GoInt32)])]);
    public var _tmp : stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(128, 128, ...[for (i in 0 ... 128) (0 : stdgo.GoUInt8)]);
