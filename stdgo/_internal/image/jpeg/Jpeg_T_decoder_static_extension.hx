        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    {
                        _err_2937512 = _d._ensureNBits((8 : stdgo.GoInt32));
                    ...
                    {
                        _v_2937935 = _h._lut[((((_d._bits._a >> ((_d._bits._n - (8 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoUInt32) : stdgo.GoUInt32)) & (255u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)];
                    ...
                    _d._bits._n = (_d._bits._n - ((_n_2938001 : stdgo.GoInt32)) : stdgo.GoInt32);
                    _d._bits._m = (_d._bits._m >> (_n_2938001) : stdgo.GoUInt32);
                    ...
                    {
                        _err_2938184 = _d._ensureNBits((1 : stdgo.GoInt32));
                    ...
                    _d._bits._n--;
                    _d._bits._m = (_d._bits._m >> ((1i64 : stdgo.GoUInt64)) : stdgo.GoUInt32);
                    if ((_code_2938111 <= _h._maxCodes[(_i_2938108 : stdgo.GoInt)] : Bool)) {
                        _gotoNext = 2938353i32;
                    } else {
                        _gotoNext = 2938420i32;
                    };
                } else if (__value__ == (2938353i32)) {
                    return { _0 : _h._vals[(((_h._valsIndices[(_i_2938108 : stdgo.GoInt)] + _code_2938111 : stdgo.GoInt32) - _h._minCodes[(_i_2938108 : stdgo.GoInt)] : stdgo.GoInt32) : stdgo.GoInt)], _1 : (null : stdgo.Error) };
                    _gotoNext = 2938420i32;
