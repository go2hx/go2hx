        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    {
                        _err_2968762 = @:check2r _d._readFull(((@:checkr _d ?? throw "null pointer dereference")._tmp.__slice__(0, (64 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2968544 : stdgo.GoInt)].length)) {
                        _gotoNext = 2968904i32;
                    } else {
                        _gotoNext = 2968463i32;
                    };
                } else if (__value__ == (2968863i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2968544 : stdgo.GoInt)][(_i_2968840 : stdgo.GoInt)] = ((@:checkr _d ?? throw "null pointer dereference")._tmp[(_i_2968840 : stdgo.GoInt)] : stdgo.GoInt32);
                    _i_2968840++;
                    ...
                    if (_i_2968840 < ((@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2968544 : stdgo.GoInt)].length)) {
                    ...
                    {
                        _err_2968989 = @:check2r _d._readFull(((@:checkr _d ?? throw "null pointer dereference")._tmp.__slice__(0, (128 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                    ...
                    (@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2968544 : stdgo.GoInt)][(_i_2969069 : stdgo.GoInt)] = ((((@:checkr _d ?? throw "null pointer dereference")._tmp[((2 : stdgo.GoInt) * _i_2969069 : stdgo.GoInt)] : stdgo.GoInt32) << (8i64 : stdgo.GoUInt64) : stdgo.GoInt32) | ((@:checkr _d ?? throw "null pointer dereference")._tmp[(((2 : stdgo.GoInt) * _i_2969069 : stdgo.GoInt) + (1 : stdgo.GoInt) : stdgo.GoInt)] : stdgo.GoInt32) : stdgo.GoInt32);
                    _i_2969069++;
                    ...
                    if (_i_2969069 < ((@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2968544 : stdgo.GoInt)].length)) {
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    {
                        _err_2984280 = @:check2r _d._ensureNBits((8 : stdgo.GoInt32));
                    ...
                    {
                        _v_2984703 = (@:checkr _h ?? throw "null pointer dereference")._lut[(((((@:checkr _d ?? throw "null pointer dereference")._bits._a >> (((@:checkr _d ?? throw "null pointer dereference")._bits._n - (8 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoUInt32) : stdgo.GoUInt32)) & (255u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)];
                    ...
                    (@:checkr _d ?? throw "null pointer dereference")._bits._n = ((@:checkr _d ?? throw "null pointer dereference")._bits._n - ((_n_2984769 : stdgo.GoInt32)) : stdgo.GoInt32);
                    (@:checkr _d ?? throw "null pointer dereference")._bits._m = ((@:checkr _d ?? throw "null pointer dereference")._bits._m >> (_n_2984769) : stdgo.GoUInt32);
                    ...
                    {
                        _err_2984952 = @:check2r _d._ensureNBits((1 : stdgo.GoInt32));
                    ...
                    (@:checkr _d ?? throw "null pointer dereference")._bits._n--;
                    (@:checkr _d ?? throw "null pointer dereference")._bits._m = ((@:checkr _d ?? throw "null pointer dereference")._bits._m >> ((1i64 : stdgo.GoUInt64)) : stdgo.GoUInt32);
                    if ((_code_2984879 <= (@:checkr _h ?? throw "null pointer dereference")._maxCodes[(_i_2984876 : stdgo.GoInt)] : Bool)) {
                        _gotoNext = 2985121i32;
                    } else {
                        _gotoNext = 2985188i32;
                    };
                } else if (__value__ == (2985121i32)) {
                    return { _0 : (@:checkr _h ?? throw "null pointer dereference")._vals[((((@:checkr _h ?? throw "null pointer dereference")._valsIndices[(_i_2984876 : stdgo.GoInt)] + _code_2984879 : stdgo.GoInt32) - (@:checkr _h ?? throw "null pointer dereference")._minCodes[(_i_2984876 : stdgo.GoInt)] : stdgo.GoInt32) : stdgo.GoInt)], _1 : (null : stdgo.Error) };
                    _gotoNext = 2985188i32;
