        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                ...
                } else if (__value__ == (2997441i32)) {
                    {
                        ...
                        _bit_2997441 = __tmp__._0;
                        _err_2997446 = __tmp__._1;
                    };
                    ...
                    _z_2997712 = (0 : stdgo.GoInt32);
                    {
                        ...
                        _value_2997729 = __tmp__._0;
                        _err_2997736 = __tmp__._1;
                    };
                    ...
                    _d._eobRun = ((1 : stdgo.GoUInt16) << _val0_2997804 : stdgo.GoUInt16);
                    ...
                    {
                        var __tmp__ = _d._decodeBits((_val0_2997804 : stdgo.GoInt32));
                        _bits_2997958 = __tmp__._0;
                        _err_2997964 = __tmp__._1;
                    };
                    ...
                    _d._eobRun = (_d._eobRun | ((_bits_2997958 : stdgo.GoUInt16)) : stdgo.GoUInt16);
                    _gotoNext = 2998088i32;
                    ...
                    {
                        var __tmp__ = _d._decodeBit();
                        _bit_2998134 = __tmp__._0;
                        _err_2998139 = __tmp__._1;
                    };
                    ...
                    {
                        var __tmp__ = _d._refineNonZeroes(_b, _zig_2997635, _zigEnd, (_val0_2997804 : stdgo.GoInt32), _delta);
                        _zig_2997635 = __tmp__._0;
                        _err_2997736 = __tmp__._1;
                    };
                    if (_err_2997736 != null) {
                    ...
                    {
                        {
                            var __tmp__ = _d._refineNonZeroes(_b, _zig_2997635, _zigEnd, (-1 : stdgo.GoInt32), _delta);
                            _err_2998572 = __tmp__._1;
                        };
...
_d._comp[(_i : stdgo.GoInt)]._v = _v;
    ...
    static public function _decodeHuffman( _d:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_T_decoder.T_decoder>, _h:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_T_huffman.T_huffman>):{ var _0 : stdgo.GoUInt8; var _1 : stdgo.Error; } {
        @:recv var _d:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_T_decoder.T_decoder> = _d;
        var _err_2984952:stdgo.Error = (null : stdgo.Error);
        var _slowPathBreak = false;
        var _code_2984879:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _i_2984876:stdgo.GoInt = (0 : stdgo.GoInt);
        var _n_2984769:stdgo.GoUInt16 = (0 : stdgo.GoUInt16);
        var _v_2984703:stdgo.GoUInt16 = (0 : stdgo.GoUInt16);
        var _err_2984280:stdgo.Error = (null : stdgo.Error);
        var _gotoNext = 0i32;
        var __blank__ = _gotoNext == ((0i32 : stdgo.GoInt));
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if (_h._nCodes == ((0 : stdgo.GoInt32))) {
                        _gotoNext = 2984195i32;
                    } else {
                        _gotoNext = 2984257i32;
                    };
                } else if (__value__ == (2984195i32)) {
                    ...
                    _gotoNext = 2984257i32;
                } else if (__value__ == (2984257i32)) {
                    if ((_d._bits._n < (8 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 2984273i32;
                    } else {
                        _gotoNext = 2984700i32;
                    };
                } else if (__value__ == (2984273i32)) {
                    {
                        _err_2984280 = _d._ensureNBits((8 : stdgo.GoInt32));
                        if (_err_2984280 != null) {
                            _gotoNext = 2984316i32;
                        } else {
                            _gotoNext = 2984700i32;
                        };
                    };
                } else if (__value__ == (2984316i32)) {
                    if (((stdgo.Go.toInterface(_err_2984280) != stdgo.Go.toInterface(stdgo.Go.asInterface(stdgo._internal.image.jpeg.Jpeg__errMissingFF00._errMissingFF00))) && (stdgo.Go.toInterface(_err_2984280) != stdgo.Go.toInterface(stdgo.Go.asInterface(stdgo._internal.image.jpeg.Jpeg__errShortHuffmanData._errShortHuffmanData))) : Bool)) {
                        _gotoNext = 2984376i32;
                    } else {
                        _gotoNext = 2984610i32;
                    };
                } else if (__value__ == (2984376i32)) {
                    return { _0 : (0 : stdgo.GoUInt8), _1 : _err_2984280 };
                    _gotoNext = 2984610i32;
                } else if (__value__ == (2984610i32)) {
                    if (_d._bytes._nUnreadable != ((0 : stdgo.GoInt))) {
                        _gotoNext = 2984638i32;
                    } else {
                        _gotoNext = 2984678i32;
                    };
                } else if (__value__ == (2984638i32)) {
                    _d._unreadByteStuffedByte();
                    _gotoNext = 2984678i32;
                } else if (__value__ == (2984678i32)) {
                    _gotoNext = 2984861i32;
                } else if (__value__ == (2984700i32)) {
                    {
                        _v_2984703 = _h._lut[((((_d._bits._a >> ((_d._bits._n - (8 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoUInt32) : stdgo.GoUInt32)) & (255u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)];
                        if (_v_2984703 != ((0 : stdgo.GoUInt16))) {
                            _gotoNext = 2984765i32;
                        } else {
                            _gotoNext = 2984861i32;
                        };
                    };
                } else if (__value__ == (2984765i32)) {
                    _n_2984769 = (((_v_2984703 & (255 : stdgo.GoUInt16) : stdgo.GoUInt16)) - (1 : stdgo.GoUInt16) : stdgo.GoUInt16);
                    _d._bits._n = (_d._bits._n - ((_n_2984769 : stdgo.GoInt32)) : stdgo.GoInt32);
                    _d._bits._m = (_d._bits._m >> (_n_2984769) : stdgo.GoUInt32);
                    return { _0 : ((_v_2984703 >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt16) : stdgo.GoUInt8), _1 : (null : stdgo.Error) };
                    _gotoNext = 2984861i32;
                } else if (__value__ == (2984861i32)) {
                    _gotoNext = 2984861i32;
                    {
                        final __tmp__0 = (0 : stdgo.GoInt);
                        final __tmp__1 = (0 : stdgo.GoInt32);
                        _i_2984876 = __tmp__0;
                        _code_2984879 = __tmp__1;
                    };
                    _slowPathBreak = false;
                    _gotoNext = 2984872i32;
                } else if (__value__ == (2984872i32)) {
                    if (!_slowPathBreak && ((_i_2984876 < (16 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2984923i32;
                    } else {
                        _gotoNext = 2985203i32;
                    };
                } else if (__value__ == (2984923i32)) {
                    if (_d._bits._n == ((0 : stdgo.GoInt32))) {
                        _gotoNext = 2984944i32;
                    } else {
                        _gotoNext = 2985019i32;
                    };
                } else if (__value__ == (2984944i32)) {
                    {
                        _err_2984952 = _d._ensureNBits((1 : stdgo.GoInt32));
                        if (_err_2984952 != null) {
                            _gotoNext = 2984988i32;
                        } else {
                            _gotoNext = 2985019i32;
                        };
                    };
                } else if (__value__ == (2984988i32)) {
                    return { _0 : (0 : stdgo.GoUInt8), _1 : _err_2984952 };
                    _gotoNext = 2985019i32;
                } else if (__value__ == (2985019i32)) {
                    if ((_d._bits._a & _d._bits._m : stdgo.GoUInt32) != ((0u32 : stdgo.GoUInt32))) {
                        _gotoNext = 2985045i32;
                    } else {
                        _gotoNext = 2985066i32;
                    };
                } else if (__value__ == (2985045i32)) {
                    _code_2984879 = (_code_2984879 | ((1 : stdgo.GoInt32)) : stdgo.GoInt32);
                    _gotoNext = 2985066i32;
                } else if (__value__ == (2985066i32)) {
                    _d._bits._n--;
                    _d._bits._m = (_d._bits._m >> ((1i64 : stdgo.GoUInt64)) : stdgo.GoUInt32);
                    if ((_code_2984879 <= _h._maxCodes[(_i_2984876 : stdgo.GoInt)] : Bool)) {
                        _gotoNext = 2985121i32;
                    } else {
                        _gotoNext = 2985188i32;
                    };
                } else if (__value__ == (2985121i32)) {
                    return { _0 : _h._vals[(((_h._valsIndices[(_i_2984876 : stdgo.GoInt)] + _code_2984879 : stdgo.GoInt32) - _h._minCodes[(_i_2984876 : stdgo.GoInt)] : stdgo.GoInt32) : stdgo.GoInt)], _1 : (null : stdgo.Error) };
                    _gotoNext = 2985188i32;
                } else if (__value__ == (2985188i32)) {
                    _code_2984879 = (_code_2984879 << ((1i64 : stdgo.GoUInt64)) : stdgo.GoInt32);
                    _i_2984876++;
                    _gotoNext = 2984872i32;
