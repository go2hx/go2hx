...
@:structInit @:using(stdgo._internal.image.jpeg.Jpeg_t_decoder_static_extension.T_decoder_static_extension) class T_decoder {
    ...
    public var _bytes : { var _buf : stdgo.GoArray<stdgo.GoUInt8>; var _i : stdgo.GoInt; var _j : stdgo.GoInt; var _nUnreadable : stdgo.GoInt; } = { _buf : new stdgo.GoArray<stdgo.GoUInt8>(4096, 4096).__setNumber32__().__setNil__(), _i : (0 : stdgo.GoInt), _j : (0 : stdgo.GoInt), _nUnreadable : (0 : stdgo.GoInt) };
    ...
    public var _comp : stdgo.GoArray<stdgo._internal.image.jpeg.Jpeg_t_component.T_component> = new stdgo.GoArray<stdgo._internal.image.jpeg.Jpeg_t_component.T_component>(4, 4, ...[for (i in 0 ... (4 > 4 ? 4 : 4 : stdgo.GoInt).toBasic()) ({} : stdgo._internal.image.jpeg.Jpeg_t_component.T_component)]).__setNil__();
    public var _progCoeffs : stdgo.GoArray<stdgo.Slice<stdgo._internal.image.jpeg.Jpeg_t_block.T_block>> = new stdgo.GoArray<stdgo.Slice<stdgo._internal.image.jpeg.Jpeg_t_block.T_block>>(4, 4).__setNil__();
    public var _huff : stdgo.GoArray<stdgo.GoArray<stdgo._internal.image.jpeg.Jpeg_t_huffman.T_huffman>> = new stdgo.GoArray<stdgo.GoArray<stdgo._internal.image.jpeg.Jpeg_t_huffman.T_huffman>>(2, 2, ...[for (i in 0 ... (2 > 2 ? 2 : 2 : stdgo.GoInt).toBasic()) new stdgo.GoArray<stdgo._internal.image.jpeg.Jpeg_t_huffman.T_huffman>(4, 4, ...[for (i in 0 ... (4 > 4 ? 4 : 4 : stdgo.GoInt).toBasic()) ({} : stdgo._internal.image.jpeg.Jpeg_t_huffman.T_huffman)]).__setNil__()]).__setNil__();
    public var _quant : stdgo.GoArray<stdgo._internal.image.jpeg.Jpeg_t_block.T_block> = new stdgo.GoArray<stdgo._internal.image.jpeg.Jpeg_t_block.T_block>(4, 4, ...[for (i in 0 ... (4 > 4 ? 4 : 4 : stdgo.GoInt).toBasic()) new stdgo._internal.image.jpeg.Jpeg_t_block.T_block(64, 64, ...[for (i in 0 ... 64) (0 : stdgo.GoInt32)])]).__setNil__();
    public var _tmp : stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(128, 128).__setNumber32__().__setNil__();
