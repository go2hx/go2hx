        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                ...
                } else if (__value__ == (2984868i32)) {
                    {
                        ...
                        _bit_2984868 = @:tmpset0 __tmp__._0;
                        _err_2984873 = @:tmpset0 __tmp__._1;
                    };
                    ...
                    _z_2985139 = (0 : stdgo.GoInt32);
                    {
                        ...
                        _value_2985156 = @:tmpset0 __tmp__._0;
                        _err_2985163 = @:tmpset0 __tmp__._1;
                    };
                    ...
                    (@:checkr _d ?? throw "null pointer dereference")._eobRun = ((1 : stdgo.GoUInt16) << _val0_2985231 : stdgo.GoUInt16);
                    ...
                    {
                        var __tmp__ = @:check2r _d._decodeBits((_val0_2985231 : stdgo.GoInt32));
                        _bits_2985385 = @:tmpset0 __tmp__._0;
                        _err_2985391 = @:tmpset0 __tmp__._1;
                    };
                    ...
                    (@:checkr _d ?? throw "null pointer dereference")._eobRun = ((@:checkr _d ?? throw "null pointer dereference")._eobRun | ((_bits_2985385 : stdgo.GoUInt16)) : stdgo.GoUInt16);
                    _gotoNext = 2985515i32;
                    ...
                    {
                        var __tmp__ = @:check2r _d._decodeBit();
                        _bit_2985561 = @:tmpset0 __tmp__._0;
                        _err_2985566 = @:tmpset0 __tmp__._1;
                    };
                    ...
                    {
                        var __tmp__ = @:check2r _d._refineNonZeroes(_b, _zig_2985062, _zigEnd, (_val0_2985231 : stdgo.GoInt32), _delta);
                        _zig_2985062 = @:tmpset0 __tmp__._0;
                        _err_2985163 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_2985163 != null) {
                    ...
                    {
                        {
                            var __tmp__ = @:check2r _d._refineNonZeroes(_b, _zig_2985062, _zigEnd, (-1 : stdgo.GoInt32), _delta);
                            _err_2985999 = @:tmpset0 __tmp__._1;
                        };
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    {
                        var __tmp__ = @:check2r _d._readByte();
                        _x_2962362 = @:tmpset0 __tmp__._0;
                        _err_2962365 = @:tmpset0 __tmp__._1;
                    };
                    ...
                    {
                        _err_2962641 = @:check2r _d._readFull(((@:checkr _d ?? throw "null pointer dereference")._tmp.__slice__(0, (64 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2962423 : stdgo.GoInt)].length)) {
                        _gotoNext = 2962783i32;
                    } else {
                        _gotoNext = 2962342i32;
                    };
                } else if (__value__ == (2962742i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2962423 : stdgo.GoInt)][(_i_2962719 : stdgo.GoInt)] = ((@:checkr _d ?? throw "null pointer dereference")._tmp[(_i_2962719 : stdgo.GoInt)] : stdgo.GoInt32);
                    _i_2962719++;
                    ...
                    if (_i_2962719 < ((@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2962423 : stdgo.GoInt)].length)) {
                    ...
                    {
                        _err_2962868 = @:check2r _d._readFull(((@:checkr _d ?? throw "null pointer dereference")._tmp.__slice__(0, (128 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                    ...
                    (@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2962423 : stdgo.GoInt)][(_i_2962948 : stdgo.GoInt)] = ((((@:checkr _d ?? throw "null pointer dereference")._tmp[((2 : stdgo.GoInt) * _i_2962948 : stdgo.GoInt)] : stdgo.GoInt32) << (8i64 : stdgo.GoUInt64) : stdgo.GoInt32) | ((@:checkr _d ?? throw "null pointer dereference")._tmp[(((2 : stdgo.GoInt) * _i_2962948 : stdgo.GoInt) + (1 : stdgo.GoInt) : stdgo.GoInt)] : stdgo.GoInt32) : stdgo.GoInt32);
                    _i_2962948++;
                    ...
                    if (_i_2962948 < ((@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2962423 : stdgo.GoInt)].length)) {
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    {
                        _err_2999483 = @:check2r _d._ensureNBits((8 : stdgo.GoInt32));
                    ...
                    {
                        _v_2999906 = (@:checkr _h ?? throw "null pointer dereference")._lut[(((((@:checkr _d ?? throw "null pointer dereference")._bits._a >> (((@:checkr _d ?? throw "null pointer dereference")._bits._n - (8 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoUInt32) : stdgo.GoUInt32)) & (255u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)];
                    ...
                    (@:checkr _d ?? throw "null pointer dereference")._bits._n = ((@:checkr _d ?? throw "null pointer dereference")._bits._n - ((_n_2999972 : stdgo.GoInt32)) : stdgo.GoInt32);
                    (@:checkr _d ?? throw "null pointer dereference")._bits._m = ((@:checkr _d ?? throw "null pointer dereference")._bits._m >> (_n_2999972) : stdgo.GoUInt32);
                    ...
                    {
                        _err_3000155 = @:check2r _d._ensureNBits((1 : stdgo.GoInt32));
                    ...
                    (@:checkr _d ?? throw "null pointer dereference")._bits._n--;
                    (@:checkr _d ?? throw "null pointer dereference")._bits._m = ((@:checkr _d ?? throw "null pointer dereference")._bits._m >> ((1i64 : stdgo.GoUInt64)) : stdgo.GoUInt32);
                    if ((_code_3000082 <= (@:checkr _h ?? throw "null pointer dereference")._maxCodes[(_i_3000079 : stdgo.GoInt)] : Bool)) {
                        _gotoNext = 3000324i32;
                    } else {
                        _gotoNext = 3000391i32;
                    };
                } else if (__value__ == (3000324i32)) {
                    return { _0 : (@:checkr _h ?? throw "null pointer dereference")._vals[((((@:checkr _h ?? throw "null pointer dereference")._valsIndices[(_i_3000079 : stdgo.GoInt)] + _code_3000082 : stdgo.GoInt32) - (@:checkr _h ?? throw "null pointer dereference")._minCodes[(_i_3000079 : stdgo.GoInt)] : stdgo.GoInt32) : stdgo.GoInt)], _1 : (null : stdgo.Error) };
                    _gotoNext = 3000391i32;
