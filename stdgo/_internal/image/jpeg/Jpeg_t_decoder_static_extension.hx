...
if ((_b[(_u : stdgo.GoInt)] >= (0 : stdgo.GoInt32) : Bool)) {
    ...
    static public function _refine( _d:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_decoder.T_decoder>, _b:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_block.T_block>, _h:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_huffman.T_huffman>, _zigStart:stdgo.GoInt32, _zigEnd:stdgo.GoInt32, _delta:stdgo.GoInt32):stdgo.Error {
        @:recv var _d:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_decoder.T_decoder> = _d;
        var _err_2979781:stdgo.Error = (null : stdgo.Error);
        var _err_2980184:stdgo.Error = (null : stdgo.Error);
        var _zig_2979680:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _bits_2980003:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _val1_2979871:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _err_2980009:stdgo.Error = (null : stdgo.Error);
        var _err_2980617:stdgo.Error = (null : stdgo.Error);
        var _bit_2979486:Bool = false;
        var _bit_2980179:Bool = false;
        var _val0_2979849:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _value_2979774:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _z_2979757:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _loopBreak = false;
        var _err_2979491:stdgo.Error = (null : stdgo.Error);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if (_zigStart == ((0 : stdgo.GoInt32))) {
                        _gotoNext = 2979435i32;
                    } else {
                        _gotoNext = 2979680i32;
                    };
                } else if (__value__ == (2979435i32)) {
                    if (_zigEnd != ((0 : stdgo.GoInt32))) {
                        _gotoNext = 2979454i32;
                    } else {
                        _gotoNext = 2979486i32;
                    };
                } else if (__value__ == (2979454i32)) {
                    throw stdgo.Go.toInterface(("unreachable" : stdgo.GoString));
                    _gotoNext = 2979486i32;
                } else if (__value__ == (2979486i32)) {
                    {
                        var __tmp__ = @:check2r _d._decodeBit();
                        _bit_2979486 = @:tmpset0 __tmp__._0;
                        _err_2979491 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_2979491 != null) {
                        _gotoNext = 2979528i32;
                    } else {
                        _gotoNext = 2979550i32;
                    };
                } else if (__value__ == (2979528i32)) {
                    return _err_2979491;
                    _gotoNext = 2979550i32;
                } else if (__value__ == (2979550i32)) {
                    if (_bit_2979486) {
                        _gotoNext = 2979557i32;
                    } else {
                        _gotoNext = 2979582i32;
                    };
                } else if (__value__ == (2979557i32)) {
                    _b[(0 : stdgo.GoInt)] = (_b[(0 : stdgo.GoInt)] | (_delta) : stdgo.GoInt32);
                    _gotoNext = 2979582i32;
                } else if (__value__ == (2979582i32)) {
                    return (null : stdgo.Error);
                    _gotoNext = 2979680i32;
                } else if (__value__ == (2979680i32)) {
                    _zig_2979680 = _zigStart;
                    if ((@:checkr _d ?? throw "null pointer dereference")._eobRun == ((0 : stdgo.GoUInt16))) {
                        _gotoNext = 2979714i32;
                    } else {
                        _gotoNext = 2980578i32;
                    };
                } else if (__value__ == (2979714i32)) {
                    _gotoNext = 2979717i32;
                } else if (__value__ == (2979717i32)) {
                    var __blank__ = 0i32;
                    _loopBreak = false;
                    _gotoNext = 2979725i32;
                } else if (__value__ == (2979725i32)) {
                    if (!_loopBreak && ((_zig_2979680 <= _zigEnd : Bool))) {
                        _gotoNext = 2979752i32;
                    } else {
                        _gotoNext = 2980578i32;
                    };
                } else if (__value__ == (2979746i32)) {
                    _zig_2979680++;
                    _gotoNext = 2979725i32;
                } else if (__value__ == (2979752i32)) {
                    _z_2979757 = (0 : stdgo.GoInt32);
                    {
                        var __tmp__ = @:check2r _d._decodeHuffman(_h);
                        _value_2979774 = @:tmpset0 __tmp__._0;
                        _err_2979781 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_2979781 != null) {
                        _gotoNext = 2979824i32;
                    } else {
                        _gotoNext = 2979849i32;
                    };
                } else if (__value__ == (2979824i32)) {
                    return _err_2979781;
                    _gotoNext = 2979849i32;
                } else if (__value__ == (2979849i32)) {
                    _val0_2979849 = (_value_2979774 >> (4i64 : stdgo.GoUInt64) : stdgo.GoUInt8);
                    _val1_2979871 = (_value_2979774 & (15 : stdgo.GoUInt8) : stdgo.GoUInt8);
                    _gotoNext = 2979896i32;
                } else if (__value__ == (2979896i32)) {
                    {
                        final __value__ = _val1_2979871;
                        if (__value__ == ((0 : stdgo.GoUInt8))) {
                            _gotoNext = 2979913i32;
                        } else if (__value__ == ((1 : stdgo.GoUInt8))) {
                            _gotoNext = 2980153i32;
                        } else {
                            _gotoNext = 2980282i32;
                        };
                    };
                } else if (__value__ == (2979913i32)) {
                    if (_val0_2979849 != ((15 : stdgo.GoUInt8))) {
                        _gotoNext = 2979941i32;
                    } else {
                        _gotoNext = 2980350i32;
                    };
                } else if (__value__ == (2979941i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._eobRun = ((1 : stdgo.GoUInt16) << _val0_2979849 : stdgo.GoUInt16);
                    if (_val0_2979849 != ((0 : stdgo.GoUInt8))) {
                        _gotoNext = 2979995i32;
                    } else {
                        _gotoNext = 2980133i32;
                    };
                } else if (__value__ == (2979995i32)) {
                    {
                        var __tmp__ = @:check2r _d._decodeBits((_val0_2979849 : stdgo.GoInt32));
                        _bits_2980003 = @:tmpset0 __tmp__._0;
                        _err_2980009 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_2980009 != null) {
                        _gotoNext = 2980062i32;
                    } else {
                        _gotoNext = 2980096i32;
                    };
                } else if (__value__ == (2980062i32)) {
                    return _err_2980009;
                    _gotoNext = 2980096i32;
                } else if (__value__ == (2980096i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._eobRun = ((@:checkr _d ?? throw "null pointer dereference")._eobRun | ((_bits_2980003 : stdgo.GoUInt16)) : stdgo.GoUInt16);
                    _gotoNext = 2980133i32;
                } else if (__value__ == (2980133i32)) {
                    _loopBreak = true;
                    _gotoNext = 2979725i32;
                } else if (__value__ == (2980153i32)) {
                    _z_2979757 = _delta;
                    {
                        var __tmp__ = @:check2r _d._decodeBit();
                        _bit_2980179 = @:tmpset0 __tmp__._0;
                        _err_2980184 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_2980184 != null) {
                        _gotoNext = 2980223i32;
                    } else {
                        _gotoNext = 2980251i32;
                    };
                } else if (__value__ == (2980223i32)) {
                    return _err_2980184;
                    _gotoNext = 2980251i32;
                } else if (__value__ == (2980251i32)) {
                    if (!_bit_2980179) {
                        _gotoNext = 2980259i32;
                    } else {
                        _gotoNext = 2980350i32;
                    };
                } else if (__value__ == (2980259i32)) {
                    _z_2979757 = -_z_2979757;
                    _gotoNext = 2980350i32;
                } else if (__value__ == (2980282i32)) {
                    ...
                    _gotoNext = 2980350i32;
                } else if (__value__ == (2980350i32)) {
                    {
                        var __tmp__ = @:check2r _d._refineNonZeroes(_b, _zig_2979680, _zigEnd, (_val0_2979849 : stdgo.GoInt32), _delta);
                        _zig_2979680 = @:tmpset0 __tmp__._0;
                        _err_2979781 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_2979781 != null) {
                        _gotoNext = 2980432i32;
                    } else {
                        _gotoNext = 2980457i32;
                    };
                } else if (__value__ == (2980432i32)) {
                    return _err_2979781;
                    _gotoNext = 2980457i32;
                } else if (__value__ == (2980457i32)) {
                    if ((_zig_2979680 > _zigEnd : Bool)) {
                        _gotoNext = 2980473i32;
                    } else {
                        _gotoNext = 2980531i32;
                    };
                } else if (__value__ == (2980473i32)) {
                    return stdgo.Go.asInterface((("too many coefficients" : stdgo.GoString) : stdgo._internal.image.jpeg.Jpeg_formaterror.FormatError));
                    _gotoNext = 2980531i32;
                } else if (__value__ == (2980531i32)) {
                    if (_z_2979757 != ((0 : stdgo.GoInt32))) {
                        _gotoNext = 2980541i32;
                    } else {
                        _gotoNext = 2979746i32;
                    };
                } else if (__value__ == (2980541i32)) {
                    _b[(stdgo._internal.image.jpeg.Jpeg__unzig._unzig[(_zig_2979680 : stdgo.GoInt)] : stdgo.GoInt)] = _z_2979757;
                    _gotoNext = 2979746i32;
                } else if (__value__ == (2980578i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._eobRun > (0 : stdgo.GoUInt16) : Bool)) {
                        _gotoNext = 2980594i32;
                    } else {
                        _gotoNext = 2980705i32;
                    };
                } else if (__value__ == (2980594i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._eobRun--;
                    {
                        {
                            var __tmp__ = @:check2r _d._refineNonZeroes(_b, _zig_2979680, _zigEnd, (-1 : stdgo.GoInt32), _delta);
                            _err_2980617 = @:tmpset0 __tmp__._1;
                        };
                        if (_err_2980617 != null) {
                            _gotoNext = 2980681i32;
                        } else {
                            _gotoNext = 2980705i32;
                        };
                    };
                } else if (__value__ == (2980681i32)) {
                    return _err_2980617;
                    _gotoNext = 2980705i32;
                } else if (__value__ == (2980705i32)) {
                    return (null : stdgo.Error);
                    _gotoNext = -1i32;
                };
            };
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    {
                        var __tmp__ = @:check2r _d._readByte();
                        _x_2995235 = @:tmpset0 __tmp__._0;
                        _err_2995238 = @:tmpset0 __tmp__._1;
                    };
                    ...
                    {
                        _err_2995514 = @:check2r _d._readFull(((@:checkr _d ?? throw "null pointer dereference")._tmp.__slice__(0, (64 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                    ...
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2995296 : stdgo.GoInt)].length)) {
                        _gotoNext = 2995656i32;
                    } else {
                        _gotoNext = 2995215i32;
                    };
                } else if (__value__ == (2995615i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2995296 : stdgo.GoInt)][(_i_2995592 : stdgo.GoInt)] = ((@:checkr _d ?? throw "null pointer dereference")._tmp[(_i_2995592 : stdgo.GoInt)] : stdgo.GoInt32);
                    _i_2995592++;
                    ...
                    if (_i_2995592 < ((@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2995296 : stdgo.GoInt)].length)) {
                    ...
                    {
                        _err_2995741 = @:check2r _d._readFull(((@:checkr _d ?? throw "null pointer dereference")._tmp.__slice__(0, (128 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                    ...
                    (@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2995296 : stdgo.GoInt)][(_i_2995821 : stdgo.GoInt)] = ((((@:checkr _d ?? throw "null pointer dereference")._tmp[((2 : stdgo.GoInt) * _i_2995821 : stdgo.GoInt)] : stdgo.GoInt32) << (8i64 : stdgo.GoUInt64) : stdgo.GoInt32) | ((@:checkr _d ?? throw "null pointer dereference")._tmp[(((2 : stdgo.GoInt) * _i_2995821 : stdgo.GoInt) + (1 : stdgo.GoInt) : stdgo.GoInt)] : stdgo.GoInt32) : stdgo.GoInt32);
                    _i_2995821++;
                    ...
                    if (_i_2995821 < ((@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2995296 : stdgo.GoInt)].length)) {
