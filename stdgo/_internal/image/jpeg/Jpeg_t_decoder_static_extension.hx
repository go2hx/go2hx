...
if ((_b[(_u : stdgo.GoInt)] >= (0 : stdgo.GoInt32) : Bool)) {
    ...
    static public function _refine( _d:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_decoder.T_decoder>, _b:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_block.T_block>, _h:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_huffman.T_huffman>, _zigStart:stdgo.GoInt32, _zigEnd:stdgo.GoInt32, _delta:stdgo.GoInt32):stdgo.Error {
        @:recv var _d:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_decoder.T_decoder> = _d;
        var _val0_2979185:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _bit_2979515:Bool = false;
        var _err_2979345:stdgo.Error = (null : stdgo.Error);
        var _bits_2979339:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _value_2979110:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _loopBreak = false;
        var _zig_2979016:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _err_2979953:stdgo.Error = (null : stdgo.Error);
        var _val1_2979207:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _err_2979117:stdgo.Error = (null : stdgo.Error);
        var _z_2979093:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _err_2978827:stdgo.Error = (null : stdgo.Error);
        var _bit_2978822:Bool = false;
        var _err_2979520:stdgo.Error = (null : stdgo.Error);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if (_zigStart == ((0 : stdgo.GoInt32))) {
                        _gotoNext = 2978771i32;
                    } else {
                        _gotoNext = 2979016i32;
                    };
                } else if (__value__ == (2978771i32)) {
                    if (_zigEnd != ((0 : stdgo.GoInt32))) {
                        _gotoNext = 2978790i32;
                    } else {
                        _gotoNext = 2978822i32;
                    };
                } else if (__value__ == (2978790i32)) {
                    throw stdgo.Go.toInterface(("unreachable" : stdgo.GoString));
                    _gotoNext = 2978822i32;
                } else if (__value__ == (2978822i32)) {
                    {
                        var __tmp__ = @:check2r _d._decodeBit();
                        _bit_2978822 = @:tmpset0 __tmp__._0;
                        _err_2978827 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_2978827 != null) {
                        _gotoNext = 2978864i32;
                    } else {
                        _gotoNext = 2978886i32;
                    };
                } else if (__value__ == (2978864i32)) {
                    return _err_2978827;
                    _gotoNext = 2978886i32;
                } else if (__value__ == (2978886i32)) {
                    if (_bit_2978822) {
                        _gotoNext = 2978893i32;
                    } else {
                        _gotoNext = 2978918i32;
                    };
                } else if (__value__ == (2978893i32)) {
                    _b[(0 : stdgo.GoInt)] = (_b[(0 : stdgo.GoInt)] | (_delta) : stdgo.GoInt32);
                    _gotoNext = 2978918i32;
                } else if (__value__ == (2978918i32)) {
                    return (null : stdgo.Error);
                    _gotoNext = 2979016i32;
                } else if (__value__ == (2979016i32)) {
                    _zig_2979016 = _zigStart;
                    if ((@:checkr _d ?? throw "null pointer dereference")._eobRun == ((0 : stdgo.GoUInt16))) {
                        _gotoNext = 2979050i32;
                    } else {
                        _gotoNext = 2979914i32;
                    };
                } else if (__value__ == (2979050i32)) {
                    _gotoNext = 2979053i32;
                } else if (__value__ == (2979053i32)) {
                    var __blank__ = 0i32;
                    _loopBreak = false;
                    _gotoNext = 2979061i32;
                } else if (__value__ == (2979061i32)) {
                    if (!_loopBreak && ((_zig_2979016 <= _zigEnd : Bool))) {
                        _gotoNext = 2979088i32;
                    } else {
                        _gotoNext = 2979914i32;
                    };
                    ...
                    _zig_2979016++;
                    _gotoNext = 2979061i32;
                } else if (__value__ == (2979088i32)) {
                    _z_2979093 = (0 : stdgo.GoInt32);
                    {
                        var __tmp__ = @:check2r _d._decodeHuffman(_h);
                        _value_2979110 = @:tmpset0 __tmp__._0;
                        _err_2979117 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_2979117 != null) {
                        _gotoNext = 2979160i32;
                    } else {
                        _gotoNext = 2979185i32;
                    };
                } else if (__value__ == (2979160i32)) {
                    return _err_2979117;
                    _gotoNext = 2979185i32;
                } else if (__value__ == (2979185i32)) {
                    _val0_2979185 = (_value_2979110 >> (4i64 : stdgo.GoUInt64) : stdgo.GoUInt8);
                    _val1_2979207 = (_value_2979110 & (15 : stdgo.GoUInt8) : stdgo.GoUInt8);
                    _gotoNext = 2979232i32;
                } else if (__value__ == (2979232i32)) {
                    {
                        final __value__ = _val1_2979207;
                        if (__value__ == ((0 : stdgo.GoUInt8))) {
                            _gotoNext = 2979249i32;
                        } else if (__value__ == ((1 : stdgo.GoUInt8))) {
                            _gotoNext = 2979489i32;
                        } else {
                            _gotoNext = 2979618i32;
                        };
                    };
                } else if (__value__ == (2979249i32)) {
                    if (_val0_2979185 != ((15 : stdgo.GoUInt8))) {
                        _gotoNext = 2979277i32;
                    } else {
                        _gotoNext = 2979686i32;
                    };
                } else if (__value__ == (2979277i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._eobRun = ((1 : stdgo.GoUInt16) << _val0_2979185 : stdgo.GoUInt16);
                    if (_val0_2979185 != ((0 : stdgo.GoUInt8))) {
                        _gotoNext = 2979331i32;
                    } else {
                        _gotoNext = 2979469i32;
                    };
                } else if (__value__ == (2979331i32)) {
                    {
                        var __tmp__ = @:check2r _d._decodeBits((_val0_2979185 : stdgo.GoInt32));
                        _bits_2979339 = @:tmpset0 __tmp__._0;
                        _err_2979345 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_2979345 != null) {
                        _gotoNext = 2979398i32;
                    } else {
                        _gotoNext = 2979432i32;
                    };
                } else if (__value__ == (2979398i32)) {
                    return _err_2979345;
                    _gotoNext = 2979432i32;
                } else if (__value__ == (2979432i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._eobRun = ((@:checkr _d ?? throw "null pointer dereference")._eobRun | ((_bits_2979339 : stdgo.GoUInt16)) : stdgo.GoUInt16);
                    _gotoNext = 2979469i32;
                } else if (__value__ == (2979469i32)) {
                    _loopBreak = true;
                    _gotoNext = 2979061i32;
                } else if (__value__ == (2979489i32)) {
                    _z_2979093 = _delta;
                    {
                        var __tmp__ = @:check2r _d._decodeBit();
                        _bit_2979515 = @:tmpset0 __tmp__._0;
                        _err_2979520 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_2979520 != null) {
                        _gotoNext = 2979559i32;
                    } else {
                        _gotoNext = 2979587i32;
                    };
                } else if (__value__ == (2979559i32)) {
                    return _err_2979520;
                    _gotoNext = 2979587i32;
                } else if (__value__ == (2979587i32)) {
                    if (!_bit_2979515) {
                        _gotoNext = 2979595i32;
                    } else {
                        _gotoNext = 2979686i32;
                    };
                } else if (__value__ == (2979595i32)) {
                    _z_2979093 = -_z_2979093;
                    _gotoNext = 2979686i32;
                } else if (__value__ == (2979618i32)) {
                    ...
                    _gotoNext = 2979686i32;
                } else if (__value__ == (2979686i32)) {
                    {
                        var __tmp__ = @:check2r _d._refineNonZeroes(_b, _zig_2979016, _zigEnd, (_val0_2979185 : stdgo.GoInt32), _delta);
                        _zig_2979016 = @:tmpset0 __tmp__._0;
                        _err_2979117 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_2979117 != null) {
                        _gotoNext = 2979768i32;
                    } else {
                        _gotoNext = 2979793i32;
                    };
                } else if (__value__ == (2979768i32)) {
                    return _err_2979117;
                    _gotoNext = 2979793i32;
                } else if (__value__ == (2979793i32)) {
                    if ((_zig_2979016 > _zigEnd : Bool)) {
                        _gotoNext = 2979809i32;
                    } else {
                        _gotoNext = 2979867i32;
                    };
                } else if (__value__ == (2979809i32)) {
                    return stdgo.Go.asInterface((("too many coefficients" : stdgo.GoString) : stdgo._internal.image.jpeg.Jpeg_formaterror.FormatError));
                    _gotoNext = 2979867i32;
                } else if (__value__ == (2979867i32)) {
                    if (_z_2979093 != ((0 : stdgo.GoInt32))) {
                        _gotoNext = 2979877i32;
                    } else {
                        _gotoNext = 2979082i32;
                    };
                } else if (__value__ == (2979877i32)) {
                    _b[(stdgo._internal.image.jpeg.Jpeg__unzig._unzig[(_zig_2979016 : stdgo.GoInt)] : stdgo.GoInt)] = _z_2979093;
                    _gotoNext = 2979082i32;
                } else if (__value__ == (2979914i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._eobRun > (0 : stdgo.GoUInt16) : Bool)) {
                        _gotoNext = 2979930i32;
                    } else {
                        _gotoNext = 2980041i32;
                    };
                } else if (__value__ == (2979930i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._eobRun--;
                    {
                        {
                            var __tmp__ = @:check2r _d._refineNonZeroes(_b, _zig_2979016, _zigEnd, (-1 : stdgo.GoInt32), _delta);
                            _err_2979953 = @:tmpset0 __tmp__._1;
                        };
                        if (_err_2979953 != null) {
                            _gotoNext = 2980017i32;
                        } else {
                            _gotoNext = 2980041i32;
                        };
                    };
                } else if (__value__ == (2980017i32)) {
                    return _err_2979953;
                    _gotoNext = 2980041i32;
                } else if (__value__ == (2980041i32)) {
                    return (null : stdgo.Error);
                    _gotoNext = -1i32;
                };
            };
...
(@:checkr _img ?? throw "null pointer dereference").pix[(_i : stdgo.GoInt)] = ((255 : stdgo.GoUInt8) - _translation._src[((_sy * _translation._stride : stdgo.GoInt) + _sx : stdgo.GoInt)] : stdgo.GoUInt8);
    ...
    static public function _processDQT( _d:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_decoder.T_decoder>, _n:stdgo.GoInt):stdgo.Error {
        @:recv var _d:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_decoder.T_decoder> = _d;
        var _i_2956673:stdgo.GoInt = (0 : stdgo.GoInt);
        var _err_2956595:stdgo.Error = (null : stdgo.Error);
        var _tq_2956377:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _err_2956319:stdgo.Error = (null : stdgo.Error);
        var _x_2956316:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _loopBreak = false;
        var _i_2956902:stdgo.GoInt = (0 : stdgo.GoInt);
        var _err_2956822:stdgo.Error = (null : stdgo.Error);
        var _gotoNext = 0i32;
        var __blank__ = _gotoNext == ((0i32 : stdgo.GoInt));
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                final __value__ = _gotoNext;
                if (__value__ == (0i32)) {
                    _gotoNext = 2956289i32;
                } else if (__value__ == (2956289i32)) {
                    var __blank__ = 0i32;
                    _loopBreak = false;
                    _gotoNext = 2956296i32;
                } else if (__value__ == (2956296i32)) {
                    if (!_loopBreak && ((_n > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2956306i32;
                    } else {
                        _gotoNext = 2957004i32;
                    };
                } else if (__value__ == (2956306i32)) {
                    _n--;
                    {
                        var __tmp__ = @:check2r _d._readByte();
                        _x_2956316 = @:tmpset0 __tmp__._0;
                        _err_2956319 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_2956319 != null) {
                        _gotoNext = 2956355i32;
                    } else {
                        _gotoNext = 2956377i32;
                    };
                } else if (__value__ == (2956355i32)) {
                    return _err_2956319;
                    _gotoNext = 2956377i32;
                } else if (__value__ == (2956377i32)) {
                    _tq_2956377 = (_x_2956316 & (15 : stdgo.GoUInt8) : stdgo.GoUInt8);
                    if ((_tq_2956377 > (3 : stdgo.GoUInt8) : Bool)) {
                        _gotoNext = 2956408i32;
                    } else {
                        _gotoNext = 2956454i32;
                    };
                } else if (__value__ == (2956408i32)) {
                    return stdgo.Go.asInterface((("bad Tq value" : stdgo.GoString) : stdgo._internal.image.jpeg.Jpeg_formaterror.FormatError));
                    _gotoNext = 2956454i32;
                } else if (__value__ == (2956454i32)) {
                    _gotoNext = 2956454i32;
                    {
                        final __value__ = (_x_2956316 >> (4i64 : stdgo.GoUInt64) : stdgo.GoUInt8);
                        if (__value__ == ((0 : stdgo.GoUInt8))) {
                            _gotoNext = 2956521i32;
                        } else if (__value__ == ((1 : stdgo.GoUInt8))) {
                            _gotoNext = 2956742i32;
                        } else {
                            _gotoNext = 2956472i32;
                        };
                    };
                } else if (__value__ == (2956472i32)) {
                    return stdgo.Go.asInterface((("bad Pq value" : stdgo.GoString) : stdgo._internal.image.jpeg.Jpeg_formaterror.FormatError));
                    _gotoNext = 2956296i32;
                } else if (__value__ == (2956521i32)) {
                    if ((_n < (64 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2956549i32;
                    } else {
                        _gotoNext = 2956574i32;
                    };
                } else if (__value__ == (2956549i32)) {
                    _loopBreak = true;
                    _gotoNext = 2956296i32;
                } else if (__value__ == (2956574i32)) {
                    _n = (_n - ((64 : stdgo.GoInt)) : stdgo.GoInt);
                    {
                        _err_2956595 = @:check2r _d._readFull(((@:checkr _d ?? throw "null pointer dereference")._tmp.__slice__(0, (64 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                        if (_err_2956595 != null) {
                            _gotoNext = 2956644i32;
                        } else {
                            _gotoNext = 2956669i32;
                        };
                    };
                } else if (__value__ == (2956644i32)) {
                    return _err_2956595;
                    _gotoNext = 2956669i32;
                } else if (__value__ == (2956669i32)) {
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2956377 : stdgo.GoInt)].length)) {
                        _gotoNext = 2956737i32;
                    } else {
                        _gotoNext = 2956296i32;
                    };
                } else if (__value__ == (2956696i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2956377 : stdgo.GoInt)][(_i_2956673 : stdgo.GoInt)] = ((@:checkr _d ?? throw "null pointer dereference")._tmp[(_i_2956673 : stdgo.GoInt)] : stdgo.GoInt32);
                    _i_2956673++;
                    _gotoNext = 2956738i32;
                } else if (__value__ == (2956737i32)) {
                    _i_2956673 = 0i32;
                    _gotoNext = 2956738i32;
                } else if (__value__ == (2956738i32)) {
                    if (_i_2956673 < ((@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2956377 : stdgo.GoInt)].length)) {
                        _gotoNext = 2956696i32;
                    } else {
                        _gotoNext = 2956296i32;
                    };
                } else if (__value__ == (2956742i32)) {
                    if ((_n < (128 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2956772i32;
                    } else {
                        _gotoNext = 2956797i32;
                    };
                } else if (__value__ == (2956772i32)) {
                    _loopBreak = true;
                    _gotoNext = 2956296i32;
                } else if (__value__ == (2956797i32)) {
                    _n = (_n - ((128 : stdgo.GoInt)) : stdgo.GoInt);
                    {
                        _err_2956822 = @:check2r _d._readFull(((@:checkr _d ?? throw "null pointer dereference")._tmp.__slice__(0, (128 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                        if (_err_2956822 != null) {
                            _gotoNext = 2956873i32;
                        } else {
                            _gotoNext = 2956898i32;
                        };
                    };
                } else if (__value__ == (2956873i32)) {
                    return _err_2956822;
                    _gotoNext = 2956898i32;
                } else if (__value__ == (2956898i32)) {
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2956377 : stdgo.GoInt)].length)) {
                        _gotoNext = 2956993i32;
                    } else {
                        _gotoNext = 2956296i32;
                    };
                } else if (__value__ == (2956925i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2956377 : stdgo.GoInt)][(_i_2956902 : stdgo.GoInt)] = ((((@:checkr _d ?? throw "null pointer dereference")._tmp[((2 : stdgo.GoInt) * _i_2956902 : stdgo.GoInt)] : stdgo.GoInt32) << (8i64 : stdgo.GoUInt64) : stdgo.GoInt32) | ((@:checkr _d ?? throw "null pointer dereference")._tmp[(((2 : stdgo.GoInt) * _i_2956902 : stdgo.GoInt) + (1 : stdgo.GoInt) : stdgo.GoInt)] : stdgo.GoInt32) : stdgo.GoInt32);
                    _i_2956902++;
                    _gotoNext = 2956994i32;
                } else if (__value__ == (2956993i32)) {
                    _i_2956902 = 0i32;
                    _gotoNext = 2956994i32;
                } else if (__value__ == (2956994i32)) {
                    if (_i_2956902 < ((@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2956377 : stdgo.GoInt)].length)) {
                        _gotoNext = 2956925i32;
                    } else {
                        _gotoNext = 2956296i32;
                    };
                } else if (__value__ == (2957004i32)) {
                    if (_n != ((0 : stdgo.GoInt))) {
                        _gotoNext = 2957014i32;
                    } else {
                        _gotoNext = 2957065i32;
                    };
...
(@:checkr _d ?? throw "null pointer dereference")._comp[(_i : stdgo.GoInt)]._v = _v;
    ...
    static public function _decodeHuffman( _d:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_decoder.T_decoder>, _h:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_huffman.T_huffman>):{ var _0 : stdgo.GoUInt8; var _1 : stdgo.Error; } {
        @:recv var _d:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_decoder.T_decoder> = _d;
        var _err_2943281:stdgo.Error = (null : stdgo.Error);
        var _slowPathBreak = false;
        var _code_2943208:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _i_2943205:stdgo.GoInt = (0 : stdgo.GoInt);
        var _n_2943098:stdgo.GoUInt16 = (0 : stdgo.GoUInt16);
        var _v_2943032:stdgo.GoUInt16 = (0 : stdgo.GoUInt16);
        var _err_2942609:stdgo.Error = (null : stdgo.Error);
        var _gotoNext = 0i32;
        var __blank__ = _gotoNext == ((0i32 : stdgo.GoInt));
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((@:checkr _h ?? throw "null pointer dereference")._nCodes == ((0 : stdgo.GoInt32))) {
                        _gotoNext = 2942524i32;
                    } else {
                        _gotoNext = 2942586i32;
                    };
                } else if (__value__ == (2942524i32)) {
                    ...
                    if (((@:checkr _d ?? throw "null pointer dereference")._bits._n < (8 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 2942602i32;
                    } else {
                        _gotoNext = 2943029i32;
                    };
                } else if (__value__ == (2942602i32)) {
                    {
                        _err_2942609 = @:check2r _d._ensureNBits((8 : stdgo.GoInt32));
                        if (_err_2942609 != null) {
                            _gotoNext = 2942645i32;
                        } else {
                            _gotoNext = 2943029i32;
                        };
                    };
                } else if (__value__ == (2942645i32)) {
                    if (((stdgo.Go.toInterface(_err_2942609) != stdgo.Go.toInterface(stdgo.Go.asInterface(stdgo._internal.image.jpeg.Jpeg__errmissingff00._errMissingFF00))) && (stdgo.Go.toInterface(_err_2942609) != stdgo.Go.toInterface(stdgo.Go.asInterface(stdgo._internal.image.jpeg.Jpeg__errshorthuffmandata._errShortHuffmanData))) : Bool)) {
                        _gotoNext = 2942705i32;
                    } else {
                        _gotoNext = 2942939i32;
                    };
                } else if (__value__ == (2942705i32)) {
                    return { _0 : (0 : stdgo.GoUInt8), _1 : _err_2942609 };
                    _gotoNext = 2942939i32;
                } else if (__value__ == (2942939i32)) {
                    if ((@:checkr _d ?? throw "null pointer dereference")._bytes._nUnreadable != ((0 : stdgo.GoInt))) {
                        _gotoNext = 2942967i32;
                    } else {
                        _gotoNext = 2943007i32;
                    };
                } else if (__value__ == (2942967i32)) {
                    @:check2r _d._unreadByteStuffedByte();
                    _gotoNext = 2943007i32;
                } else if (__value__ == (2943007i32)) {
                    _gotoNext = 2943190i32;
                } else if (__value__ == (2943029i32)) {
                    {
                        _v_2943032 = (@:checkr _h ?? throw "null pointer dereference")._lut[(((((@:checkr _d ?? throw "null pointer dereference")._bits._a >> (((@:checkr _d ?? throw "null pointer dereference")._bits._n - (8 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoUInt32) : stdgo.GoUInt32)) & (255u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)];
                        if (_v_2943032 != ((0 : stdgo.GoUInt16))) {
                    ...
                    _n_2943098 = (((_v_2943032 & (255 : stdgo.GoUInt16) : stdgo.GoUInt16)) - (1 : stdgo.GoUInt16) : stdgo.GoUInt16);
                    (@:checkr _d ?? throw "null pointer dereference")._bits._n = ((@:checkr _d ?? throw "null pointer dereference")._bits._n - ((_n_2943098 : stdgo.GoInt32)) : stdgo.GoInt32);
                    (@:checkr _d ?? throw "null pointer dereference")._bits._m = ((@:checkr _d ?? throw "null pointer dereference")._bits._m >> (_n_2943098) : stdgo.GoUInt32);
                    return { _0 : ((_v_2943032 >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt16) : stdgo.GoUInt8), _1 : (null : stdgo.Error) };
                    _gotoNext = 2943190i32;
                } else if (__value__ == (2943190i32)) {
                    _gotoNext = 2943190i32;
                    {
                        final __tmp__0 = (0 : stdgo.GoInt);
                        final __tmp__1 = (0 : stdgo.GoInt32);
                        _i_2943205 = __tmp__0;
                        _code_2943208 = __tmp__1;
                    };
                    _slowPathBreak = false;
                    _gotoNext = 2943201i32;
                } else if (__value__ == (2943201i32)) {
                    if (!_slowPathBreak && ((_i_2943205 < (16 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2943252i32;
                    } else {
                        _gotoNext = 2943532i32;
                    };
                } else if (__value__ == (2943252i32)) {
                    if ((@:checkr _d ?? throw "null pointer dereference")._bits._n == ((0 : stdgo.GoInt32))) {
                        _gotoNext = 2943273i32;
                    } else {
                        _gotoNext = 2943348i32;
                    };
                } else if (__value__ == (2943273i32)) {
                    {
                        _err_2943281 = @:check2r _d._ensureNBits((1 : stdgo.GoInt32));
                        if (_err_2943281 != null) {
                            _gotoNext = 2943317i32;
                        } else {
                            _gotoNext = 2943348i32;
                        };
                    };
                } else if (__value__ == (2943317i32)) {
                    return { _0 : (0 : stdgo.GoUInt8), _1 : _err_2943281 };
                    _gotoNext = 2943348i32;
                } else if (__value__ == (2943348i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._bits._a & (@:checkr _d ?? throw "null pointer dereference")._bits._m : stdgo.GoUInt32) != ((0u32 : stdgo.GoUInt32))) {
                        _gotoNext = 2943374i32;
                    } else {
                        _gotoNext = 2943395i32;
                    };
                } else if (__value__ == (2943374i32)) {
                    _code_2943208 = (_code_2943208 | ((1 : stdgo.GoInt32)) : stdgo.GoInt32);
                    _gotoNext = 2943395i32;
                } else if (__value__ == (2943395i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._bits._n--;
                    (@:checkr _d ?? throw "null pointer dereference")._bits._m = ((@:checkr _d ?? throw "null pointer dereference")._bits._m >> ((1i64 : stdgo.GoUInt64)) : stdgo.GoUInt32);
                    if ((_code_2943208 <= (@:checkr _h ?? throw "null pointer dereference")._maxCodes[(_i_2943205 : stdgo.GoInt)] : Bool)) {
                        _gotoNext = 2943450i32;
                    } else {
                        _gotoNext = 2943517i32;
                    };
                } else if (__value__ == (2943450i32)) {
                    return { _0 : (@:checkr _h ?? throw "null pointer dereference")._vals[((((@:checkr _h ?? throw "null pointer dereference")._valsIndices[(_i_2943205 : stdgo.GoInt)] + _code_2943208 : stdgo.GoInt32) - (@:checkr _h ?? throw "null pointer dereference")._minCodes[(_i_2943205 : stdgo.GoInt)] : stdgo.GoInt32) : stdgo.GoInt)], _1 : (null : stdgo.Error) };
                    _gotoNext = 2943517i32;
                } else if (__value__ == (2943517i32)) {
                    _code_2943208 = (_code_2943208 << ((1i64 : stdgo.GoUInt64)) : stdgo.GoInt32);
                    _i_2943205++;
                    _gotoNext = 2943201i32;
                } else if (__value__ == (2943532i32)) {
