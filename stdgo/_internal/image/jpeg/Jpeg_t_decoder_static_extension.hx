        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if (_zigStart == ((0 : stdgo.GoInt32))) {
                        _gotoNext = 2991269i32;
                    } else {
                        _gotoNext = 2991514i32;
                    };
                } else if (__value__ == (2991269i32)) {
                    if (_zigEnd != ((0 : stdgo.GoInt32))) {
                        _gotoNext = 2991288i32;
                    } else {
                        _gotoNext = 2991320i32;
                    };
                } else if (__value__ == (2991288i32)) {
                    throw stdgo.Go.toInterface(("unreachable" : stdgo.GoString));
                    _gotoNext = 2991320i32;
                } else if (__value__ == (2991320i32)) {
                    {
                    ...
                    if (_err_14 != null) {
                        _gotoNext = 2991362i32;
                    } else {
                        _gotoNext = 2991384i32;
                    };
                } else if (__value__ == (2991362i32)) {
                    return _err_14;
                    _gotoNext = 2991384i32;
                } else if (__value__ == (2991384i32)) {
                    if (_bit_13) {
                        _gotoNext = 2991391i32;
                    } else {
                        _gotoNext = 2991416i32;
                    };
                } else if (__value__ == (2991391i32)) {
                    _b[(0 : stdgo.GoInt)] = (_b[(0 : stdgo.GoInt)] | (_delta) : stdgo.GoInt32);
                    _gotoNext = 2991416i32;
                } else if (__value__ == (2991416i32)) {
                    return (null : stdgo.Error);
                    _gotoNext = 2991514i32;
                } else if (__value__ == (2991514i32)) {
                    _zig_15 = _zigStart;
                    if ((@:checkr _d ?? throw "null pointer dereference")._eobRun == ((0 : stdgo.GoUInt16))) {
                        _gotoNext = 2991548i32;
                    } else {
                        _gotoNext = 2992412i32;
                    };
                } else if (__value__ == (2991548i32)) {
                    _gotoNext = 2991551i32;
                } else if (__value__ == (2991551i32)) {
                    var __blank__ = 0i32;
                    _loopBreak = false;
                    _gotoNext = 2991559i32;
                } else if (__value__ == (2991559i32)) {
                    if (!_loopBreak && ((_zig_15 <= _zigEnd : Bool))) {
                        _gotoNext = 2991586i32;
                    } else {
                        _gotoNext = 2992412i32;
                    };
                } else if (__value__ == (2991580i32)) {
                    _zig_15++;
                    _gotoNext = 2991559i32;
                } else if (__value__ == (2991586i32)) {
                    ...
                    if (_err_18 != null) {
                        _gotoNext = 2991658i32;
                    } else {
                        _gotoNext = 2991683i32;
                    };
                } else if (__value__ == (2991658i32)) {
                    return _err_18;
                    _gotoNext = 2991683i32;
                } else if (__value__ == (2991683i32)) {
                    _val0_19 = (_value_17 >> (4i64 : stdgo.GoUInt64) : stdgo.GoUInt8);
                    _val1_20 = (_value_17 & (15 : stdgo.GoUInt8) : stdgo.GoUInt8);
                    _gotoNext = 2991730i32;
                } else if (__value__ == (2991730i32)) {
                    {
                        final __value__ = _val1_20;
                        if (__value__ == ((0 : stdgo.GoUInt8))) {
                            _gotoNext = 2991747i32;
                        } else if (__value__ == ((1 : stdgo.GoUInt8))) {
                            _gotoNext = 2991987i32;
                        } else {
                            _gotoNext = 2992116i32;
                        };
                    };
                } else if (__value__ == (2991747i32)) {
                    if (_val0_19 != ((15 : stdgo.GoUInt8))) {
                        _gotoNext = 2991775i32;
                    } else {
                        _gotoNext = 2992184i32;
                    };
                } else if (__value__ == (2991775i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._eobRun = ((1 : stdgo.GoUInt16) << _val0_19 : stdgo.GoUInt16);
                    if (_val0_19 != ((0 : stdgo.GoUInt8))) {
                        _gotoNext = 2991829i32;
                    } else {
                        _gotoNext = 2991967i32;
                    };
                } else if (__value__ == (2991829i32)) {
                    {
                    ...
                    if (_err_22 != null) {
                        _gotoNext = 2991896i32;
                    } else {
                        _gotoNext = 2991930i32;
                    };
                } else if (__value__ == (2991896i32)) {
                    return _err_22;
                    _gotoNext = 2991930i32;
                } else if (__value__ == (2991930i32)) {
                    ...
                    _gotoNext = 2991967i32;
                } else if (__value__ == (2991967i32)) {
                    _loopBreak = true;
                    _gotoNext = 2991559i32;
                } else if (__value__ == (2991987i32)) {
                    _z_16 = _delta;
                    {
                        var __tmp__ = @:check2r _d._decodeBit();
                    ...
                    if (_err_24 != null) {
                        _gotoNext = 2992057i32;
                    } else {
                        _gotoNext = 2992085i32;
                    };
                } else if (__value__ == (2992057i32)) {
                    return _err_24;
                    _gotoNext = 2992085i32;
                } else if (__value__ == (2992085i32)) {
                    if (!_bit_23) {
                        _gotoNext = 2992093i32;
                    } else {
                        _gotoNext = 2992184i32;
                    };
                } else if (__value__ == (2992093i32)) {
                    _z_16 = -_z_16;
                    _gotoNext = 2992184i32;
                } else if (__value__ == (2992116i32)) {
                    ...
                    if (_err_18 != null) {
                        _gotoNext = 2992266i32;
                    } else {
                        _gotoNext = 2992291i32;
                    };
                } else if (__value__ == (2992266i32)) {
                    return _err_18;
                    _gotoNext = 2992291i32;
                } else if (__value__ == (2992291i32)) {
                    if ((_zig_15 > _zigEnd : Bool)) {
                        _gotoNext = 2992307i32;
                    } else {
                        _gotoNext = 2992365i32;
                    };
                } else if (__value__ == (2992307i32)) {
                    return stdgo.Go.asInterface((("too many coefficients" : stdgo.GoString) : stdgo._internal.image.jpeg.Jpeg_formaterror.FormatError));
                    _gotoNext = 2992365i32;
                } else if (__value__ == (2992365i32)) {
                    if (_z_16 != ((0 : stdgo.GoInt32))) {
                        _gotoNext = 2992375i32;
                    } else {
                        _gotoNext = 2991580i32;
                    };
                } else if (__value__ == (2992375i32)) {
                    _b[(stdgo._internal.image.jpeg.Jpeg__unzig._unzig[(_zig_15 : stdgo.GoInt)] : stdgo.GoInt)] = _z_16;
                    _gotoNext = 2991580i32;
                } else if (__value__ == (2992412i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._eobRun > (0 : stdgo.GoUInt16) : Bool)) {
                        _gotoNext = 2992428i32;
                    } else {
                        _gotoNext = 2992539i32;
                    };
                } else if (__value__ == (2992428i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._eobRun--;
                    {
                        ...
                        if (_err_25 != null) {
                            _gotoNext = 2992515i32;
                        } else {
                            _gotoNext = 2992539i32;
                        };
                    };
                } else if (__value__ == (2992515i32)) {
                    return _err_25;
                    _gotoNext = 2992539i32;
                } else if (__value__ == (2992539i32)) {
                    return (null : stdgo.Error);
                    _gotoNext = -1i32;
                };
            };
...
var _expectedRST = __1, _mcu = __0;
        var _b:stdgo._internal.image.jpeg.Jpeg_t_block.T_block = new stdgo._internal.image.jpeg.Jpeg_t_block.T_block(64, 64, ...[for (i in 0 ... 64) (0 : stdgo.GoInt32)]), _dc:stdgo.GoArray<stdgo.GoInt32> = new stdgo.GoArray<stdgo.GoInt32>(4, 4).__setNumber32__().__setNil__(), _bx:stdgo.GoInt = (0 : stdgo.GoInt), _by:stdgo.GoInt = (0 : stdgo.GoInt), _blockCount:stdgo.GoInt = (0 : stdgo.GoInt);
        {
...
(@:checkr _d ?? throw "null pointer dereference")._comp[(_i : stdgo.GoInt)]._v = _v;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((@:checkr _h ?? throw "null pointer dereference")._nCodes == ((0 : stdgo.GoInt32))) {
                        _gotoNext = 2978074i32;
                    } else {
                        _gotoNext = 2978136i32;
                    };
                } else if (__value__ == (2978074i32)) {
                    ...
                    _gotoNext = 2978136i32;
                } else if (__value__ == (2978136i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._bits._n < (8 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 2978152i32;
                    } else {
                        _gotoNext = 2978579i32;
                    };
                } else if (__value__ == (2978152i32)) {
                    {
                        _err_0 = @:check2r _d._ensureNBits((8 : stdgo.GoInt32));
                        if (_err_0 != null) {
                            _gotoNext = 2978195i32;
                        } else {
                            _gotoNext = 2978579i32;
                        };
                    };
                } else if (__value__ == (2978195i32)) {
                    if (((stdgo.Go.toInterface(_err_0) != stdgo.Go.toInterface(stdgo.Go.asInterface(stdgo._internal.image.jpeg.Jpeg__errmissingff00._errMissingFF00))) && (stdgo.Go.toInterface(_err_0) != stdgo.Go.toInterface(stdgo.Go.asInterface(stdgo._internal.image.jpeg.Jpeg__errshorthuffmandata._errShortHuffmanData))) : Bool)) {
                        _gotoNext = 2978255i32;
                    } else {
                        _gotoNext = 2978489i32;
                    };
                } else if (__value__ == (2978255i32)) {
                    return { _0 : (0 : stdgo.GoUInt8), _1 : _err_0 };
                    _gotoNext = 2978489i32;
                } else if (__value__ == (2978489i32)) {
                    if ((@:checkr _d ?? throw "null pointer dereference")._bytes._nUnreadable != ((0 : stdgo.GoInt))) {
                        _gotoNext = 2978517i32;
                    } else {
                        _gotoNext = 2978557i32;
                    };
                } else if (__value__ == (2978517i32)) {
                    @:check2r _d._unreadByteStuffedByte();
                    _gotoNext = 2978557i32;
                } else if (__value__ == (2978557i32)) {
                    _gotoNext = 2978740i32;
                } else if (__value__ == (2978579i32)) {
                    {
                        ...
                        if (_v_1 != ((0 : stdgo.GoUInt16))) {
                            _gotoNext = 2978644i32;
                        } else {
                            _gotoNext = 2978740i32;
                        };
                    };
                } else if (__value__ == (2978644i32)) {
                    ...
                    if (!_slowPathBreak && ((_i_3 < (16 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2978802i32;
                    } else {
                        _gotoNext = 2979082i32;
                    };
                } else if (__value__ == (2978802i32)) {
                    if ((@:checkr _d ?? throw "null pointer dereference")._bits._n == ((0 : stdgo.GoInt32))) {
                        _gotoNext = 2978823i32;
                    } else {
                        _gotoNext = 2978898i32;
                    };
                } else if (__value__ == (2978823i32)) {
                    {
                        _err_5 = @:check2r _d._ensureNBits((1 : stdgo.GoInt32));
                        if (_err_5 != null) {
                            _gotoNext = 2978867i32;
                        } else {
                            _gotoNext = 2978898i32;
                        };
                    };
                } else if (__value__ == (2978867i32)) {
                    return { _0 : (0 : stdgo.GoUInt8), _1 : _err_5 };
                    _gotoNext = 2978898i32;
                } else if (__value__ == (2978898i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._bits._a & (@:checkr _d ?? throw "null pointer dereference")._bits._m : stdgo.GoUInt32) != ((0u32 : stdgo.GoUInt32))) {
                        _gotoNext = 2978924i32;
                    } else {
                        _gotoNext = 2978945i32;
                    };
                } else if (__value__ == (2978924i32)) {
                    _code_4 = (_code_4 | ((1 : stdgo.GoInt32)) : stdgo.GoInt32);
                    _gotoNext = 2978945i32;
                } else if (__value__ == (2978945i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._bits._n--;
                    (@:checkr _d ?? throw "null pointer dereference")._bits._m = ((@:checkr _d ?? throw "null pointer dereference")._bits._m >> ((1i64 : stdgo.GoUInt64)) : stdgo.GoUInt32);
    ...
    static public function _processDHT( _d:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_decoder.T_decoder>, _n:stdgo.GoInt):stdgo.Error {
        ...
        while ((_n > (0 : stdgo.GoInt) : Bool)) {
            ...
            var _nCodes:stdgo.GoArray<stdgo.GoInt32> = new stdgo.GoArray<stdgo.GoInt32>(16, 16).__setNumber32__().__setNil__();
            for (_i => _ in _nCodes) {
