...
(@:checkr _img ?? throw "null pointer dereference").pix[(_i : stdgo.GoInt)] = ((255 : stdgo.GoUInt8) - _translation._src[((_sy * _translation._stride : stdgo.GoInt) + _sx : stdgo.GoInt)] : stdgo.GoUInt8);
    ...
    static public function _processDQT( _d:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_decoder.T_decoder>, _n:stdgo.GoInt):stdgo.Error {
        @:recv var _d:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_decoder.T_decoder> = _d;
        var _x_2968814:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _loopBreak = false;
        var _i_2969400:stdgo.GoInt = (0 : stdgo.GoInt);
        var _err_2969320:stdgo.Error = (null : stdgo.Error);
        var _i_2969171:stdgo.GoInt = (0 : stdgo.GoInt);
        var _err_2969093:stdgo.Error = (null : stdgo.Error);
        var _tq_2968875:stdgo.GoUInt8 = (0 : stdgo.GoUInt8);
        var _err_2968817:stdgo.Error = (null : stdgo.Error);
        var _gotoNext = 0i32;
        var __blank__ = _gotoNext == ((0i32 : stdgo.GoInt));
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                final __value__ = _gotoNext;
                if (__value__ == (0i32)) {
                    _gotoNext = 2968787i32;
                } else if (__value__ == (2968787i32)) {
                    var __blank__ = 0i32;
                    _loopBreak = false;
                    _gotoNext = 2968794i32;
                } else if (__value__ == (2968794i32)) {
                    if (!_loopBreak && ((_n > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2968804i32;
                    } else {
                        _gotoNext = 2969502i32;
                    };
                } else if (__value__ == (2968804i32)) {
                    _n--;
                    {
                        var __tmp__ = @:check2r _d._readByte();
                        _x_2968814 = @:tmpset0 __tmp__._0;
                        _err_2968817 = @:tmpset0 __tmp__._1;
                    };
                    if (_err_2968817 != null) {
                        _gotoNext = 2968853i32;
                    } else {
                        _gotoNext = 2968875i32;
                    };
                } else if (__value__ == (2968853i32)) {
                    return _err_2968817;
                    _gotoNext = 2968875i32;
                } else if (__value__ == (2968875i32)) {
                    _tq_2968875 = (_x_2968814 & (15 : stdgo.GoUInt8) : stdgo.GoUInt8);
                    if ((_tq_2968875 > (3 : stdgo.GoUInt8) : Bool)) {
                        _gotoNext = 2968906i32;
                    } else {
                        _gotoNext = 2968952i32;
                    };
                } else if (__value__ == (2968906i32)) {
                    return stdgo.Go.asInterface((("bad Tq value" : stdgo.GoString) : stdgo._internal.image.jpeg.Jpeg_formaterror.FormatError));
                    _gotoNext = 2968952i32;
                } else if (__value__ == (2968952i32)) {
                    _gotoNext = 2968952i32;
                    {
                        final __value__ = (_x_2968814 >> (4i64 : stdgo.GoUInt64) : stdgo.GoUInt8);
                        if (__value__ == ((0 : stdgo.GoUInt8))) {
                            _gotoNext = 2969019i32;
                        } else if (__value__ == ((1 : stdgo.GoUInt8))) {
                            _gotoNext = 2969240i32;
                        } else {
                            _gotoNext = 2968970i32;
                        };
                    };
                } else if (__value__ == (2968970i32)) {
                    return stdgo.Go.asInterface((("bad Pq value" : stdgo.GoString) : stdgo._internal.image.jpeg.Jpeg_formaterror.FormatError));
                    _gotoNext = 2968794i32;
                } else if (__value__ == (2969019i32)) {
                    if ((_n < (64 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2969047i32;
                    } else {
                        _gotoNext = 2969072i32;
                    };
                } else if (__value__ == (2969047i32)) {
                    _loopBreak = true;
                    _gotoNext = 2968794i32;
                } else if (__value__ == (2969072i32)) {
                    _n = (_n - ((64 : stdgo.GoInt)) : stdgo.GoInt);
                    {
                        _err_2969093 = @:check2r _d._readFull(((@:checkr _d ?? throw "null pointer dereference")._tmp.__slice__(0, (64 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                        if (_err_2969093 != null) {
                            _gotoNext = 2969142i32;
                        } else {
                            _gotoNext = 2969167i32;
                        };
                    };
                } else if (__value__ == (2969142i32)) {
                    return _err_2969093;
                    _gotoNext = 2969167i32;
                } else if (__value__ == (2969167i32)) {
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2968875 : stdgo.GoInt)].length)) {
                        _gotoNext = 2969235i32;
                    } else {
                        _gotoNext = 2968794i32;
                    };
                } else if (__value__ == (2969194i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2968875 : stdgo.GoInt)][(_i_2969171 : stdgo.GoInt)] = ((@:checkr _d ?? throw "null pointer dereference")._tmp[(_i_2969171 : stdgo.GoInt)] : stdgo.GoInt32);
                    _i_2969171++;
                    _gotoNext = 2969236i32;
                } else if (__value__ == (2969235i32)) {
                    _i_2969171 = 0i32;
                    _gotoNext = 2969236i32;
                } else if (__value__ == (2969236i32)) {
                    if (_i_2969171 < ((@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2968875 : stdgo.GoInt)].length)) {
                        _gotoNext = 2969194i32;
                    } else {
                        _gotoNext = 2968794i32;
                    };
                } else if (__value__ == (2969240i32)) {
                    if ((_n < (128 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2969270i32;
                    } else {
                        _gotoNext = 2969295i32;
                    };
                } else if (__value__ == (2969270i32)) {
                    _loopBreak = true;
                    _gotoNext = 2968794i32;
                } else if (__value__ == (2969295i32)) {
                    _n = (_n - ((128 : stdgo.GoInt)) : stdgo.GoInt);
                    {
                        _err_2969320 = @:check2r _d._readFull(((@:checkr _d ?? throw "null pointer dereference")._tmp.__slice__(0, (128 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                        if (_err_2969320 != null) {
                            _gotoNext = 2969371i32;
                        } else {
                            _gotoNext = 2969396i32;
                        };
                    };
                } else if (__value__ == (2969371i32)) {
                    return _err_2969320;
                    _gotoNext = 2969396i32;
                } else if (__value__ == (2969396i32)) {
                    if ((0i32 : stdgo.GoInt) < ((@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2968875 : stdgo.GoInt)].length)) {
                        _gotoNext = 2969491i32;
                    } else {
                        _gotoNext = 2968794i32;
                    };
                } else if (__value__ == (2969423i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2968875 : stdgo.GoInt)][(_i_2969400 : stdgo.GoInt)] = ((((@:checkr _d ?? throw "null pointer dereference")._tmp[((2 : stdgo.GoInt) * _i_2969400 : stdgo.GoInt)] : stdgo.GoInt32) << (8i64 : stdgo.GoUInt64) : stdgo.GoInt32) | ((@:checkr _d ?? throw "null pointer dereference")._tmp[(((2 : stdgo.GoInt) * _i_2969400 : stdgo.GoInt) + (1 : stdgo.GoInt) : stdgo.GoInt)] : stdgo.GoInt32) : stdgo.GoInt32);
                    _i_2969400++;
                    _gotoNext = 2969492i32;
                } else if (__value__ == (2969491i32)) {
                    _i_2969400 = 0i32;
                    _gotoNext = 2969492i32;
                } else if (__value__ == (2969492i32)) {
                    if (_i_2969400 < ((@:checkr _d ?? throw "null pointer dereference")._quant[(_tq_2968875 : stdgo.GoInt)].length)) {
                        _gotoNext = 2969423i32;
                    } else {
                        _gotoNext = 2968794i32;
                    };
                } else if (__value__ == (2969502i32)) {
                    if (_n != ((0 : stdgo.GoInt))) {
                        _gotoNext = 2969512i32;
                    } else {
                        _gotoNext = 2969563i32;
                    };
                } else if (__value__ == (2969512i32)) {
                    return stdgo.Go.asInterface((("DQT has wrong length" : stdgo.GoString) : stdgo._internal.image.jpeg.Jpeg_formaterror.FormatError));
                    _gotoNext = 2969563i32;
                } else if (__value__ == (2969563i32)) {
                    return (null : stdgo.Error);
                    _gotoNext = -1i32;
                };
            };
...
(@:checkr _d ?? throw "null pointer dereference")._comp[(_i : stdgo.GoInt)]._v = _v;
    ...
    static public function _decodeHuffman( _d:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_decoder.T_decoder>, _h:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_huffman.T_huffman>):{ var _0 : stdgo.GoUInt8; var _1 : stdgo.Error; } {
        @:recv var _d:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_decoder.T_decoder> = _d;
        var _err_2955779:stdgo.Error = (null : stdgo.Error);
        var _slowPathBreak = false;
        var _code_2955706:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _i_2955703:stdgo.GoInt = (0 : stdgo.GoInt);
        var _n_2955596:stdgo.GoUInt16 = (0 : stdgo.GoUInt16);
        var _v_2955530:stdgo.GoUInt16 = (0 : stdgo.GoUInt16);
        var _err_2955107:stdgo.Error = (null : stdgo.Error);
        var _gotoNext = 0i32;
        var __blank__ = _gotoNext == ((0i32 : stdgo.GoInt));
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((@:checkr _h ?? throw "null pointer dereference")._nCodes == ((0 : stdgo.GoInt32))) {
                        _gotoNext = 2955022i32;
                    } else {
                        _gotoNext = 2955084i32;
                    };
                } else if (__value__ == (2955022i32)) {
                    ...
                    _gotoNext = 2955084i32;
                } else if (__value__ == (2955084i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._bits._n < (8 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 2955100i32;
                    } else {
                        _gotoNext = 2955527i32;
                    };
                } else if (__value__ == (2955100i32)) {
                    {
                        _err_2955107 = @:check2r _d._ensureNBits((8 : stdgo.GoInt32));
                        if (_err_2955107 != null) {
                            _gotoNext = 2955143i32;
                        } else {
                            _gotoNext = 2955527i32;
                        };
                    };
                } else if (__value__ == (2955143i32)) {
                    if (((stdgo.Go.toInterface(_err_2955107) != stdgo.Go.toInterface(stdgo.Go.asInterface(stdgo._internal.image.jpeg.Jpeg__errmissingff00._errMissingFF00))) && (stdgo.Go.toInterface(_err_2955107) != stdgo.Go.toInterface(stdgo.Go.asInterface(stdgo._internal.image.jpeg.Jpeg__errshorthuffmandata._errShortHuffmanData))) : Bool)) {
                        _gotoNext = 2955203i32;
                    } else {
                        _gotoNext = 2955437i32;
                    };
                } else if (__value__ == (2955203i32)) {
                    return { _0 : (0 : stdgo.GoUInt8), _1 : _err_2955107 };
                    _gotoNext = 2955437i32;
                } else if (__value__ == (2955437i32)) {
                    if ((@:checkr _d ?? throw "null pointer dereference")._bytes._nUnreadable != ((0 : stdgo.GoInt))) {
                        _gotoNext = 2955465i32;
                    } else {
                        _gotoNext = 2955505i32;
                    };
                } else if (__value__ == (2955465i32)) {
                    @:check2r _d._unreadByteStuffedByte();
                    _gotoNext = 2955505i32;
                } else if (__value__ == (2955505i32)) {
                    _gotoNext = 2955688i32;
                } else if (__value__ == (2955527i32)) {
                    {
                        _v_2955530 = (@:checkr _h ?? throw "null pointer dereference")._lut[(((((@:checkr _d ?? throw "null pointer dereference")._bits._a >> (((@:checkr _d ?? throw "null pointer dereference")._bits._n - (8 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoUInt32) : stdgo.GoUInt32)) & (255u32 : stdgo.GoUInt32) : stdgo.GoUInt32) : stdgo.GoInt)];
                        if (_v_2955530 != ((0 : stdgo.GoUInt16))) {
                            _gotoNext = 2955592i32;
                        } else {
                            _gotoNext = 2955688i32;
                        };
                    };
                } else if (__value__ == (2955592i32)) {
                    _n_2955596 = (((_v_2955530 & (255 : stdgo.GoUInt16) : stdgo.GoUInt16)) - (1 : stdgo.GoUInt16) : stdgo.GoUInt16);
                    (@:checkr _d ?? throw "null pointer dereference")._bits._n = ((@:checkr _d ?? throw "null pointer dereference")._bits._n - ((_n_2955596 : stdgo.GoInt32)) : stdgo.GoInt32);
                    (@:checkr _d ?? throw "null pointer dereference")._bits._m = ((@:checkr _d ?? throw "null pointer dereference")._bits._m >> (_n_2955596) : stdgo.GoUInt32);
                    return { _0 : ((_v_2955530 >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt16) : stdgo.GoUInt8), _1 : (null : stdgo.Error) };
                    _gotoNext = 2955688i32;
                } else if (__value__ == (2955688i32)) {
                    _gotoNext = 2955688i32;
                    {
                        final __tmp__0 = (0 : stdgo.GoInt);
                        final __tmp__1 = (0 : stdgo.GoInt32);
                        _i_2955703 = __tmp__0;
                        _code_2955706 = __tmp__1;
                    };
                    _slowPathBreak = false;
                    _gotoNext = 2955699i32;
                } else if (__value__ == (2955699i32)) {
                    if (!_slowPathBreak && ((_i_2955703 < (16 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2955750i32;
                    } else {
                        _gotoNext = 2956030i32;
                    };
                } else if (__value__ == (2955750i32)) {
                    if ((@:checkr _d ?? throw "null pointer dereference")._bits._n == ((0 : stdgo.GoInt32))) {
                        _gotoNext = 2955771i32;
                    } else {
                        _gotoNext = 2955846i32;
                    };
                } else if (__value__ == (2955771i32)) {
                    {
                        _err_2955779 = @:check2r _d._ensureNBits((1 : stdgo.GoInt32));
                        if (_err_2955779 != null) {
                            _gotoNext = 2955815i32;
                        } else {
                            _gotoNext = 2955846i32;
                        };
                    };
                } else if (__value__ == (2955815i32)) {
                    return { _0 : (0 : stdgo.GoUInt8), _1 : _err_2955779 };
                    _gotoNext = 2955846i32;
                } else if (__value__ == (2955846i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._bits._a & (@:checkr _d ?? throw "null pointer dereference")._bits._m : stdgo.GoUInt32) != ((0u32 : stdgo.GoUInt32))) {
                        _gotoNext = 2955872i32;
                    } else {
                        _gotoNext = 2955893i32;
                    };
                } else if (__value__ == (2955872i32)) {
                    _code_2955706 = (_code_2955706 | ((1 : stdgo.GoInt32)) : stdgo.GoInt32);
                    _gotoNext = 2955893i32;
                } else if (__value__ == (2955893i32)) {
                    (@:checkr _d ?? throw "null pointer dereference")._bits._n--;
                    (@:checkr _d ?? throw "null pointer dereference")._bits._m = ((@:checkr _d ?? throw "null pointer dereference")._bits._m >> ((1i64 : stdgo.GoUInt64)) : stdgo.GoUInt32);
                    if ((_code_2955706 <= (@:checkr _h ?? throw "null pointer dereference")._maxCodes[(_i_2955703 : stdgo.GoInt)] : Bool)) {
                        _gotoNext = 2955948i32;
                    } else {
                        _gotoNext = 2956015i32;
                    };
                } else if (__value__ == (2955948i32)) {
                    return { _0 : (@:checkr _h ?? throw "null pointer dereference")._vals[((((@:checkr _h ?? throw "null pointer dereference")._valsIndices[(_i_2955703 : stdgo.GoInt)] + _code_2955706 : stdgo.GoInt32) - (@:checkr _h ?? throw "null pointer dereference")._minCodes[(_i_2955703 : stdgo.GoInt)] : stdgo.GoInt32) : stdgo.GoInt)], _1 : (null : stdgo.Error) };
                    _gotoNext = 2956015i32;
                } else if (__value__ == (2956015i32)) {
                    _code_2955706 = (_code_2955706 << ((1i64 : stdgo.GoUInt64)) : stdgo.GoInt32);
                    _i_2955703++;
                    _gotoNext = 2955699i32;
                } else if (__value__ == (2956030i32)) {
