...
@:structInit @:using(stdgo._internal.image.jpeg.Jpeg_t_encoder_static_extension.T_encoder_static_extension) class T_encoder {
    ...
    public var _buf : stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(16, 16).__setNumber32__().__setNil__();
    public var _bits : stdgo.GoUInt32 = 0;
    public var _nBits : stdgo.GoUInt32 = 0;
    public var _quant : stdgo.GoArray<stdgo.GoArray<stdgo.GoUInt8>> = new stdgo.GoArray<stdgo.GoArray<stdgo.GoUInt8>>(2, 2, ...[for (i in 0 ... (2 > 2 ? 2 : 2 : stdgo.GoInt).toBasic()) new stdgo.GoArray<stdgo.GoUInt8>(64, 64).__setNumber32__().__setNil__()]).__setNil__();
