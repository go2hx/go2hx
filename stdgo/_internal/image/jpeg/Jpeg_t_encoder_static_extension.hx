...
@:keep @:allow(stdgo._internal.image.jpeg.Jpeg.T_encoder_asInterface) class T_encoder_static_extension {
    ...
    static public function _writeSOS( _e:stdgo.Ref<stdgo._internal.image.jpeg.Jpeg_t_encoder.T_encoder>, _m:stdgo._internal.image.Image_image.Image):Void {
        ...
        var _b:stdgo._internal.image.jpeg.Jpeg_t_block.T_block = new stdgo._internal.image.jpeg.Jpeg_t_block.T_block(64, 64, ...[for (i in 0 ... 64) (0 : stdgo.GoInt32)]), _cb:stdgo.GoArray<stdgo._internal.image.jpeg.Jpeg_t_block.T_block> = new stdgo.GoArray<stdgo._internal.image.jpeg.Jpeg_t_block.T_block>(4, 4, ...[for (i in 0 ... (4 > 4 ? 4 : 4 : stdgo.GoInt).toBasic()) new stdgo._internal.image.jpeg.Jpeg_t_block.T_block(64, 64, ...[for (i in 0 ... 64) (0 : stdgo.GoInt32)])]).__setNil__(), _cr:stdgo.GoArray<stdgo._internal.image.jpeg.Jpeg_t_block.T_block> = new stdgo.GoArray<stdgo._internal.image.jpeg.Jpeg_t_block.T_block>(4, 4, ...[for (i in 0 ... (4 > 4 ? 4 : 4 : stdgo.GoInt).toBasic()) new stdgo._internal.image.jpeg.Jpeg_t_block.T_block(64, 64, ...[for (i in 0 ... 64) (0 : stdgo.GoInt32)])]).__setNil__(), _prevDCY:stdgo.GoInt32 = (0 : stdgo.GoInt32), _prevDCCb:stdgo.GoInt32 = (0 : stdgo.GoInt32), _prevDCCr:stdgo.GoInt32 = (0 : stdgo.GoInt32);
