...
@:structInit @:using(stdgo._internal.image.jpeg.Jpeg_t_huffman_static_extension.T_huffman_static_extension) class T_huffman {
    ...
    public var _lut : stdgo.GoArray<stdgo.GoUInt16> = new stdgo.GoArray<stdgo.GoUInt16>(256, 256).__setNumber32__().__setNil__();
    public var _vals : stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(256, 256).__setNumber32__().__setNil__();
    public var _minCodes : stdgo.GoArray<stdgo.GoInt32> = new stdgo.GoArray<stdgo.GoInt32>(16, 16).__setNumber32__().__setNil__();
    public var _maxCodes : stdgo.GoArray<stdgo.GoInt32> = new stdgo.GoArray<stdgo.GoInt32>(16, 16).__setNumber32__().__setNil__();
    public var _valsIndices : stdgo.GoArray<stdgo.GoInt32> = new stdgo.GoArray<stdgo.GoInt32>(16, 16).__setNumber32__().__setNil__();
