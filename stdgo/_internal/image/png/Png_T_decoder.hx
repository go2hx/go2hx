...
@:structInit @:using(stdgo._internal.image.png.Png_T_decoder_static_extension.T_decoder_static_extension) class T_decoder {
    ...
    public var _tmp : stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(768, 768, ...[for (i in 0 ... 768) (0 : stdgo.GoUInt8)]);
    public var _interlace : stdgo.GoInt = 0;
    public var _useTransparent : Bool = false;
    public var _transparent : stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(6, 6, ...[for (i in 0 ... 6) (0 : stdgo.GoUInt8)]);
