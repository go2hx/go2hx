...
@:structInit @:using(stdgo._internal.image.png.Png_t_decoder_static_extension.T_decoder_static_extension) class T_decoder {
    ...
    public var _tmp : stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(768, 768).__setNumber32__().__setNil__();
    public var _interlace : stdgo.GoInt = 0;
    public var _useTransparent : Bool = false;
    public var _transparent : stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(6, 6).__setNumber32__().__setNil__();
