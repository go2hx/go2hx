...
function example():Void {
        ...
        var _bounds = (_m.bounds()?.__copy__() : stdgo._internal.image.Image.Rectangle);
...
function _withinTolerance(_c0:stdgo._internal.image.color.Color.Color, _c1:stdgo._internal.image.color.Color.Color, _tolerance:stdgo.GoInt):Bool {
        ...
        var _r = (_delta(_r0, _r1) : stdgo.GoInt);
        var _g = (_delta(_g0, _g1) : stdgo.GoInt);
        var _b = (_delta(_b0, _b1) : stdgo.GoInt);
        var _a = (_delta(_a0, _a1) : stdgo.GoInt);
...
function testDecode(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        stdgo._internal.internal.Macro.controlFlow({
            ...
            } : stdgo._internal.image.color.Color.Color -> stdgo.GoString);
            var _golden = ({
            ...
            @:label("loop") for (__0 => _it in _imageTests) {
                var _g = (_golden[_it._goldenFilename] ?? (null : stdgo._internal.image.Image.Image) : stdgo._internal.image.Image.Image);
                if (_g == null) {
                ...
                var _b = (_g.bounds()?.__copy__() : stdgo._internal.image.Image.Rectangle);
