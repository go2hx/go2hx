...
function _assignID_64(_text:stdgo.Slice<stdgo.GoInt64>, _sa:stdgo.Slice<stdgo.GoInt64>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _i_3362710_0:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _j_3362717 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(_i_3362710_0 : stdgo.GoInt)];
                ...
                } else if (__value__ == (3363273i32)) {
                    {
                        ...
                        _i_3362710_0 = __tmp__0;
                        _j_3362717 = __tmp__1;
                    };
                    _gotoNext = 3363274i32;
                } else if (__value__ == (3363274i32)) {
                    if (_i_3362710_0 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
