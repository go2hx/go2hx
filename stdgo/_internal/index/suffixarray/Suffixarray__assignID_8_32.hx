...
function _assignID_8_32(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt32>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _i_3315062_0:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _j_3315069 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(_i_3315062_0 : stdgo.GoInt)];
                ...
                } else if (__value__ == (3315625i32)) {
                    {
                        ...
                        _i_3315062_0 = __tmp__0;
                        _j_3315069 = __tmp__1;
                    };
                    _gotoNext = 3315626i32;
                } else if (__value__ == (3315626i32)) {
                    if (_i_3315062_0 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
