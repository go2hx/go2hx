...
function _assignID_32(_text:stdgo.Slice<stdgo.GoInt32>, _sa:stdgo.Slice<stdgo.GoInt32>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _iterator_3868683_23:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 3869234i32;
                    } else {
                        _gotoNext = 3869238i32;
                    };
                } else if (__value__ == (3868709i32)) {
                    _j_24 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(_iterator_3868683_23 : stdgo.GoInt)];
                    _n_25 = _sa[((_j_24 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)];
                    if (_n_25 != (_lastLen_21)) {
                        _gotoNext = 3868828i32;
                    } else {
                        _gotoNext = 3868848i32;
                    };
                } else if (__value__ == (3868828i32)) {
                    _gotoNext = 3869165i32;
                } else if (__value__ == (3868848i32)) {
                    if (((_n_25 : stdgo.GoUInt32) >= (_text.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 3868882i32;
                    } else {
                        _gotoNext = 3868967i32;
                    };
                } else if (__value__ == (3868882i32)) {
                    _gotoNext = 3869206i32;
                } else if (__value__ == (3868967i32)) {
                    ...
                    _i_29 = (0 : stdgo.GoInt);
                    _gotoNext = 3869069i32;
                    {
                        _gotoNext = 3868967i32;
                    };
                } else if (__value__ == (3869069i32)) {
                    if ((_i_29 < _n_26 : Bool)) {
                        _gotoNext = 3869092i32;
                    } else {
                        _gotoNext = 3869150i32;
                    };
                } else if (__value__ == (3869088i32)) {
                    _i_29++;
                    _gotoNext = 3869069i32;
                } else if (__value__ == (3869092i32)) {
                    if (_this_27[(_i_29 : stdgo.GoInt)] != (_last_28[(_i_29 : stdgo.GoInt)])) {
                        _gotoNext = 3869120i32;
                    } else {
                        _gotoNext = 3869088i32;
                    };
                } else if (__value__ == (3869120i32)) {
                    _gotoNext = 3869165i32;
                } else if (__value__ == (3869150i32)) {
                    _gotoNext = 3869206i32;
                } else if (__value__ == (3869165i32)) {
                    _gotoNext = 3869165i32;
                    _id_20++;
                    _lastPos_22 = _j_24;
                    _lastLen_21 = _n_25;
                    _gotoNext = 3869206i32;
                } else if (__value__ == (3869206i32)) {
                    _sa[((_j_24 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)] = (_id_20 : stdgo.GoInt32);
                    _iterator_3868683_23++;
                    _gotoNext = 3869235i32;
                } else if (__value__ == (3869234i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(0i32 : stdgo.GoInt)];
                        _iterator_3868683_23 = @:binopAssign __tmp__0;
                        _j_24 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 3869235i32;
                } else if (__value__ == (3869235i32)) {
                    if (_iterator_3868683_23 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 3868709i32;
                    } else {
                        _gotoNext = 3869238i32;
                    };
                } else if (__value__ == (3869238i32)) {
                    return _id_20;
                    _gotoNext = -1i32;
                };
            };
