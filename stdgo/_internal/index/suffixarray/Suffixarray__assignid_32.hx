...
function _assignID_32(_text:stdgo.Slice<stdgo.GoInt32>, _sa:stdgo.Slice<stdgo.GoInt32>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _iterator_4246662_23:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4247213i32;
                    } else {
                        _gotoNext = 4247217i32;
                    };
                } else if (__value__ == (4246688i32)) {
                    _j_24 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(_iterator_4246662_23 : stdgo.GoInt)];
                    _n_25 = _sa[((_j_24 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)];
                    if (_n_25 != (_lastLen_21)) {
                        _gotoNext = 4246807i32;
                    } else {
                        _gotoNext = 4246827i32;
                    };
                } else if (__value__ == (4246807i32)) {
                    _gotoNext = 4247144i32;
                } else if (__value__ == (4246827i32)) {
                    if (((_n_25 : stdgo.GoUInt32) >= (_text.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 4246861i32;
                    } else {
                        _gotoNext = 4246946i32;
                    };
                } else if (__value__ == (4246861i32)) {
                    _gotoNext = 4247185i32;
                } else if (__value__ == (4246946i32)) {
                    ...
                    _i_29 = (0 : stdgo.GoInt);
                    _gotoNext = 4247048i32;
                    {
                        _gotoNext = 4246946i32;
                    };
                } else if (__value__ == (4247048i32)) {
                    if ((_i_29 < _n_26 : Bool)) {
                        _gotoNext = 4247071i32;
                    } else {
                        _gotoNext = 4247129i32;
                    };
                } else if (__value__ == (4247067i32)) {
                    _i_29++;
                    _gotoNext = 4247048i32;
                } else if (__value__ == (4247071i32)) {
                    if (_this_27[(_i_29 : stdgo.GoInt)] != (_last_28[(_i_29 : stdgo.GoInt)])) {
                        _gotoNext = 4247099i32;
                    } else {
                        _gotoNext = 4247067i32;
                    };
                } else if (__value__ == (4247099i32)) {
                    _gotoNext = 4247144i32;
                } else if (__value__ == (4247129i32)) {
                    _gotoNext = 4247185i32;
                } else if (__value__ == (4247144i32)) {
                    _gotoNext = 4247144i32;
                    _id_20++;
                    _lastPos_22 = _j_24;
                    _lastLen_21 = _n_25;
                    _gotoNext = 4247185i32;
                } else if (__value__ == (4247185i32)) {
                    _sa[((_j_24 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)] = (_id_20 : stdgo.GoInt32);
                    _iterator_4246662_23++;
                    _gotoNext = 4247214i32;
                } else if (__value__ == (4247213i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(0i32 : stdgo.GoInt)];
                        _iterator_4246662_23 = @:binopAssign __tmp__0;
                        _j_24 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4247214i32;
                } else if (__value__ == (4247214i32)) {
                    if (_iterator_4246662_23 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4246688i32;
                    } else {
                        _gotoNext = 4247217i32;
                    };
                } else if (__value__ == (4247217i32)) {
                    return _id_20;
                    _gotoNext = -1i32;
                };
            };
