...
function _assignID_32(_text:stdgo.Slice<stdgo.GoInt32>, _sa:stdgo.Slice<stdgo.GoInt32>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _iterator_4152435_23:stdgo.GoInt = (0 : stdgo.GoInt);
            ...
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    ...
                    if ((0i64 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4152986i64;
                    } else {
                        _gotoNext = 4152990i64;
                    };
                } else if (__value__ == (4152461i64)) {
                    _j_24 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(_iterator_4152435_23 : stdgo.GoInt)];
                    ...
                    if (_n_25 != (_lastLen_21)) {
                        _gotoNext = 4152580i64;
                    } else {
                        _gotoNext = 4152600i64;
                    };
                } else if (__value__ == (4152580i64)) {
                    _gotoNext = 4152917i64;
                } else if (__value__ == (4152600i64)) {
                    ...
                    if (((_n_25 : stdgo.GoUInt32) >= (_text.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 4152634i64;
                    } else {
                        _gotoNext = 4152719i64;
                    };
                } else if (__value__ == (4152634i64)) {
                    _gotoNext = 4152958i64;
                } else if (__value__ == (4152719i64)) {
                    ...
                    _i_29 = (0 : stdgo.GoInt);
                    _gotoNext = 4152821i64;
                    //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais2.go#L1124"
                    {
                        _gotoNext = 4152719i64;
                    };
                } else if (__value__ == (4152821i64)) {
                    //"file://#L0"
                    if ((_i_29 < _n_26 : Bool)) {
                        _gotoNext = 4152844i64;
                    } else {
                        _gotoNext = 4152902i64;
                    };
                } else if (__value__ == (4152840i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais2.go#L1129"
                    _i_29++;
                    _gotoNext = 4152821i64;
                } else if (__value__ == (4152844i64)) {
                    ...
                    if (_this_27[(_i_29 : stdgo.GoInt)] != (_last_28[(_i_29 : stdgo.GoInt)])) {
                        _gotoNext = 4152872i64;
                    } else {
                        _gotoNext = 4152840i64;
                    };
                } else if (__value__ == (4152872i64)) {
                    _gotoNext = 4152917i64;
                } else if (__value__ == (4152902i64)) {
                    _gotoNext = 4152958i64;
                } else if (__value__ == (4152917i64)) {
                    _gotoNext = 4152917i64;
                    ...
                    _lastLen_21 = _n_25;
                    _gotoNext = 4152958i64;
                } else if (__value__ == (4152958i64)) {
                    _sa[((_j_24 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)] = (_id_20 : stdgo.GoInt32);
                    //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais2.go#L1114"
                    _iterator_4152435_23++;
                    _gotoNext = 4152987i64;
                } else if (__value__ == (4152986i64)) {
                    {
                        final __tmp__0 = 0i64;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(0i64 : stdgo.GoInt)];
                        _iterator_4152435_23 = @:binopAssign __tmp__0;
                        _j_24 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4152987i64;
                } else if (__value__ == (4152987i64)) {
                    //"file://#L0"
                    if (_iterator_4152435_23 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4152461i64;
                    } else {
                        _gotoNext = 4152990i64;
                    };
                } else if (__value__ == (4152990i64)) {
