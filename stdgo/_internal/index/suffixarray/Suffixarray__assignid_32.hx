...
function _assignID_32(_text:stdgo.Slice<stdgo.GoInt32>, _sa:stdgo.Slice<stdgo.GoInt32>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _i_4194024_23:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4194575i32;
                    } else {
                        _gotoNext = 4194579i32;
                    };
                } else if (__value__ == (4194050i32)) {
                    _j_24 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(_i_4194024_23 : stdgo.GoInt)];
                    _n_25 = _sa[((_j_24 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)];
                    if (_n_25 != (_lastLen_21)) {
                        _gotoNext = 4194169i32;
                    } else {
                        _gotoNext = 4194189i32;
                    };
                } else if (__value__ == (4194169i32)) {
                    _gotoNext = 4194506i32;
                } else if (__value__ == (4194189i32)) {
                    if (((_n_25 : stdgo.GoUInt32) >= (_text.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 4194223i32;
                    } else {
                        _gotoNext = 4194308i32;
                    };
                } else if (__value__ == (4194223i32)) {
                    _gotoNext = 4194547i32;
                } else if (__value__ == (4194308i32)) {
                    ...
                    _i_29 = (0 : stdgo.GoInt);
                    _gotoNext = 4194410i32;
                    {
                        _gotoNext = 4194308i32;
                    };
                } else if (__value__ == (4194410i32)) {
                    if ((_i_29 < _n_26 : Bool)) {
                        _gotoNext = 4194433i32;
                    } else {
                        _gotoNext = 4194491i32;
                    };
                } else if (__value__ == (4194429i32)) {
                    _i_29++;
                    _gotoNext = 4194410i32;
                } else if (__value__ == (4194433i32)) {
                    if (_this_27[(_i_29 : stdgo.GoInt)] != (_last_28[(_i_29 : stdgo.GoInt)])) {
                        _gotoNext = 4194461i32;
                    } else {
                        _gotoNext = 4194429i32;
                    };
                } else if (__value__ == (4194461i32)) {
                    _gotoNext = 4194506i32;
                } else if (__value__ == (4194491i32)) {
                    _gotoNext = 4194547i32;
                } else if (__value__ == (4194506i32)) {
                    _gotoNext = 4194506i32;
                    _id_20++;
                    _lastPos_22 = _j_24;
                    _lastLen_21 = _n_25;
                    _gotoNext = 4194547i32;
                } else if (__value__ == (4194547i32)) {
                    _sa[((_j_24 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)] = (_id_20 : stdgo.GoInt32);
                    _i_4194024_23++;
                    _gotoNext = 4194576i32;
                } else if (__value__ == (4194575i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(0i32 : stdgo.GoInt)];
                        _i_4194024_23 = @:binopAssign __tmp__0;
                        _j_24 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4194576i32;
                } else if (__value__ == (4194576i32)) {
                    if (_i_4194024_23 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4194050i32;
                    } else {
                        _gotoNext = 4194579i32;
                    };
                } else if (__value__ == (4194579i32)) {
                    return _id_20;
                    _gotoNext = -1i32;
                };
            };
