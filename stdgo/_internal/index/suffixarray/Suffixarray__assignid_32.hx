...
function _assignID_32(_text:stdgo.Slice<stdgo.GoInt32>, _sa:stdgo.Slice<stdgo.GoInt32>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _i_4185695_23:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _j_24 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(_i_4185695_23 : stdgo.GoInt)];
                ...
                } else if (__value__ == (4186246i32)) {
                    {
                        ...
                        _i_4185695_23 = __tmp__0;
                        _j_24 = __tmp__1;
                    };
                    _gotoNext = 4186247i32;
                } else if (__value__ == (4186247i32)) {
                    if (_i_4185695_23 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
