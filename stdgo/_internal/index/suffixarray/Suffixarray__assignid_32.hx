...
function _assignID_32(_text:stdgo.Slice<stdgo.GoInt32>, _sa:stdgo.Slice<stdgo.GoInt32>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        var _i_3950961_23:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 3951512i32;
                    } else {
                        _gotoNext = 3951516i32;
                    };
                } else if (__value__ == (3950987i32)) {
                    _j_24 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(_i_3950961_23 : stdgo.GoInt)];
                    _n_25 = _sa[((_j_24 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)];
                    if (_n_25 != (_lastLen_21)) {
                        _gotoNext = 3951106i32;
                    } else {
                        _gotoNext = 3951126i32;
                    };
                } else if (__value__ == (3951106i32)) {
                    _gotoNext = 3951443i32;
                } else if (__value__ == (3951126i32)) {
                    if (((_n_25 : stdgo.GoUInt32) >= (_text.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 3951160i32;
                    } else {
                        _gotoNext = 3951245i32;
                    };
                } else if (__value__ == (3951160i32)) {
                    _gotoNext = 3951484i32;
                } else if (__value__ == (3951245i32)) {
                    ...
                    _i_29 = (0 : stdgo.GoInt);
                    _gotoNext = 3951347i32;
                    {
                        _gotoNext = 3951245i32;
                    };
                } else if (__value__ == (3951347i32)) {
                    if ((_i_29 < _n_26 : Bool)) {
                        _gotoNext = 3951370i32;
                    } else {
                        _gotoNext = 3951428i32;
                    };
                } else if (__value__ == (3951366i32)) {
                    _i_29++;
                    _gotoNext = 3951347i32;
                } else if (__value__ == (3951370i32)) {
                    if (_this_27[(_i_29 : stdgo.GoInt)] != (_last_28[(_i_29 : stdgo.GoInt)])) {
                        _gotoNext = 3951398i32;
                    } else {
                        _gotoNext = 3951366i32;
                    };
                } else if (__value__ == (3951398i32)) {
                    _gotoNext = 3951443i32;
                } else if (__value__ == (3951428i32)) {
                    _gotoNext = 3951484i32;
                } else if (__value__ == (3951443i32)) {
                    _gotoNext = 3951443i32;
                    _id_20++;
                    _lastPos_22 = _j_24;
                    _lastLen_21 = _n_25;
                    _gotoNext = 3951484i32;
                } else if (__value__ == (3951484i32)) {
                    _sa[((_j_24 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)] = (_id_20 : stdgo.GoInt32);
                    _i_3950961_23++;
                    _gotoNext = 3951513i32;
                } else if (__value__ == (3951512i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(0i32 : stdgo.GoInt)];
                        _i_3950961_23 = @:binopAssign __tmp__0;
                        _j_24 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 3951513i32;
                } else if (__value__ == (3951513i32)) {
                    if (_i_3950961_23 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 3950987i32;
                    } else {
                        _gotoNext = 3951516i32;
                    };
                } else if (__value__ == (3951516i32)) {
                    return _id_20;
                    _gotoNext = -1i32;
                };
            };
