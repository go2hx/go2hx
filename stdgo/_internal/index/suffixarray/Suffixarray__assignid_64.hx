...
function _assignID_64(_text:stdgo.Slice<stdgo.GoInt64>, _sa:stdgo.Slice<stdgo.GoInt64>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _i_4140603_33:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4141154i32;
                    } else {
                        _gotoNext = 4141158i32;
                    };
                } else if (__value__ == (4140629i32)) {
                    _j_34 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(_i_4140603_33 : stdgo.GoInt)];
                    _n_35 = _sa[((_j_34 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)];
                    if (_n_35 != (_lastLen_31)) {
                        _gotoNext = 4140748i32;
                    } else {
                        _gotoNext = 4140768i32;
                    };
                } else if (__value__ == (4140748i32)) {
                    _gotoNext = 4141085i32;
                } else if (__value__ == (4140768i32)) {
                    if (((_n_35 : stdgo.GoUInt64) >= (_text.length : stdgo.GoUInt64) : Bool)) {
                        _gotoNext = 4140802i32;
                    } else {
                        _gotoNext = 4140887i32;
                    };
                } else if (__value__ == (4140802i32)) {
                    _gotoNext = 4141126i32;
                    ...
                    _i_39 = (0 : stdgo.GoInt);
                    _gotoNext = 4140989i32;
                    {
                        _gotoNext = 4140887i32;
                    };
                } else if (__value__ == (4140989i32)) {
                    if ((_i_39 < _n_36 : Bool)) {
                        _gotoNext = 4141012i32;
                    } else {
                        _gotoNext = 4141070i32;
                    };
                } else if (__value__ == (4141008i32)) {
                    _i_39++;
                    _gotoNext = 4140989i32;
                } else if (__value__ == (4141012i32)) {
                    if (_this_37[(_i_39 : stdgo.GoInt)] != (_last_38[(_i_39 : stdgo.GoInt)])) {
                        _gotoNext = 4141040i32;
                    } else {
                        _gotoNext = 4141008i32;
                    };
                } else if (__value__ == (4141040i32)) {
                    _gotoNext = 4141085i32;
                } else if (__value__ == (4141070i32)) {
                    _gotoNext = 4141126i32;
                } else if (__value__ == (4141085i32)) {
                    _gotoNext = 4141085i32;
                    _id_30++;
                    _lastPos_32 = _j_34;
                    _lastLen_31 = _n_35;
                    _gotoNext = 4141126i32;
                } else if (__value__ == (4141126i32)) {
                    _sa[((_j_34 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)] = (_id_30 : stdgo.GoInt64);
                    _i_4140603_33++;
                    _gotoNext = 4141155i32;
                } else if (__value__ == (4141154i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(0i32 : stdgo.GoInt)];
                        _i_4140603_33 = @:binopAssign __tmp__0;
                        _j_34 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4141155i32;
                } else if (__value__ == (4141155i32)) {
                    if (_i_4140603_33 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4140629i32;
                    } else {
                        _gotoNext = 4141158i32;
                    };
                } else if (__value__ == (4141158i32)) {
                    return _id_30;
                    _gotoNext = -1i32;
                };
            };
