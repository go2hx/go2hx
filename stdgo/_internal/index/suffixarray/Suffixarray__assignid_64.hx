...
function _assignID_64(_text:stdgo.Slice<stdgo.GoInt64>, _sa:stdgo.Slice<stdgo.GoInt64>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _i_4188068_33:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4188619i32;
                    } else {
                        _gotoNext = 4188623i32;
                    };
                } else if (__value__ == (4188094i32)) {
                    _j_34 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(_i_4188068_33 : stdgo.GoInt)];
                    _n_35 = _sa[((_j_34 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)];
                    if (_n_35 != (_lastLen_31)) {
                        _gotoNext = 4188213i32;
                    } else {
                        _gotoNext = 4188233i32;
                    };
                } else if (__value__ == (4188213i32)) {
                    _gotoNext = 4188550i32;
                } else if (__value__ == (4188233i32)) {
                    if (((_n_35 : stdgo.GoUInt64) >= (_text.length : stdgo.GoUInt64) : Bool)) {
                        _gotoNext = 4188267i32;
                    } else {
                        _gotoNext = 4188352i32;
                    };
                } else if (__value__ == (4188267i32)) {
                    _gotoNext = 4188591i32;
                } else if (__value__ == (4188352i32)) {
                    ...
                    _i_39 = (0 : stdgo.GoInt);
                    _gotoNext = 4188454i32;
                    {
                        _gotoNext = 4188352i32;
                    };
                } else if (__value__ == (4188454i32)) {
                    if ((_i_39 < _n_36 : Bool)) {
                        _gotoNext = 4188477i32;
                    } else {
                        _gotoNext = 4188535i32;
                    };
                } else if (__value__ == (4188473i32)) {
                    _i_39++;
                    _gotoNext = 4188454i32;
                } else if (__value__ == (4188477i32)) {
                    if (_this_37[(_i_39 : stdgo.GoInt)] != (_last_38[(_i_39 : stdgo.GoInt)])) {
                        _gotoNext = 4188505i32;
                    } else {
                        _gotoNext = 4188473i32;
                    };
                } else if (__value__ == (4188505i32)) {
                    _gotoNext = 4188550i32;
                } else if (__value__ == (4188535i32)) {
                    _gotoNext = 4188591i32;
                } else if (__value__ == (4188550i32)) {
                    _gotoNext = 4188550i32;
                    _id_30++;
                    _lastPos_32 = _j_34;
                    _lastLen_31 = _n_35;
                    _gotoNext = 4188591i32;
                } else if (__value__ == (4188591i32)) {
                    _sa[((_j_34 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)] = (_id_30 : stdgo.GoInt64);
                    _i_4188068_33++;
                    _gotoNext = 4188620i32;
                } else if (__value__ == (4188619i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(0i32 : stdgo.GoInt)];
                        _i_4188068_33 = @:binopAssign __tmp__0;
                        _j_34 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4188620i32;
                } else if (__value__ == (4188620i32)) {
                    if (_i_4188068_33 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4188094i32;
                    } else {
                        _gotoNext = 4188623i32;
                    };
                } else if (__value__ == (4188623i32)) {
                    return _id_30;
                    _gotoNext = -1i32;
                };
            };
