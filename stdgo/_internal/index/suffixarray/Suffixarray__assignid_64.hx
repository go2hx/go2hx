...
function _assignID_64(_text:stdgo.Slice<stdgo.GoInt64>, _sa:stdgo.Slice<stdgo.GoInt64>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _iterator_4143036_33:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4143587i32;
                    } else {
                        _gotoNext = 4143591i32;
                    };
                } else if (__value__ == (4143062i32)) {
                    _j_34 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(_iterator_4143036_33 : stdgo.GoInt)];
                    _n_35 = _sa[((_j_34 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)];
                    if (_n_35 != (_lastLen_31)) {
                        _gotoNext = 4143181i32;
                    } else {
                        _gotoNext = 4143201i32;
                    };
                } else if (__value__ == (4143181i32)) {
                    _gotoNext = 4143518i32;
                } else if (__value__ == (4143201i32)) {
                    if (((_n_35 : stdgo.GoUInt64) >= (_text.length : stdgo.GoUInt64) : Bool)) {
                        _gotoNext = 4143235i32;
                    } else {
                        _gotoNext = 4143320i32;
                    };
                } else if (__value__ == (4143235i32)) {
                    _gotoNext = 4143559i32;
                } else if (__value__ == (4143320i32)) {
                    ...
                    _i_39 = (0 : stdgo.GoInt);
                    _gotoNext = 4143422i32;
                    {
                        _gotoNext = 4143320i32;
                    };
                } else if (__value__ == (4143422i32)) {
                    if ((_i_39 < _n_36 : Bool)) {
                        _gotoNext = 4143445i32;
                    } else {
                        _gotoNext = 4143503i32;
                    };
                } else if (__value__ == (4143441i32)) {
                    _i_39++;
                    _gotoNext = 4143422i32;
                } else if (__value__ == (4143445i32)) {
                    if (_this_37[(_i_39 : stdgo.GoInt)] != (_last_38[(_i_39 : stdgo.GoInt)])) {
                        _gotoNext = 4143473i32;
                    } else {
                        _gotoNext = 4143441i32;
                    };
                } else if (__value__ == (4143473i32)) {
                    _gotoNext = 4143518i32;
                } else if (__value__ == (4143503i32)) {
                    _gotoNext = 4143559i32;
                } else if (__value__ == (4143518i32)) {
                    _gotoNext = 4143518i32;
                    _id_30++;
                    _lastPos_32 = _j_34;
                    _lastLen_31 = _n_35;
                    _gotoNext = 4143559i32;
                } else if (__value__ == (4143559i32)) {
                    _sa[((_j_34 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)] = (_id_30 : stdgo.GoInt64);
                    _iterator_4143036_33++;
                    _gotoNext = 4143588i32;
                } else if (__value__ == (4143587i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(0i32 : stdgo.GoInt)];
                        _iterator_4143036_33 = @:binopAssign __tmp__0;
                        _j_34 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4143588i32;
                } else if (__value__ == (4143588i32)) {
                    if (_iterator_4143036_33 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4143062i32;
                    } else {
                        _gotoNext = 4143591i32;
                    };
                } else if (__value__ == (4143591i32)) {
                    return _id_30;
                    _gotoNext = -1i32;
                };
            };
