...
function _assignID_64(_text:stdgo.Slice<stdgo.GoInt64>, _sa:stdgo.Slice<stdgo.GoInt64>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _iterator_4161865_33:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4162416i32;
                    } else {
                        _gotoNext = 4162420i32;
                    };
                } else if (__value__ == (4161891i32)) {
                    _j_34 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(_iterator_4161865_33 : stdgo.GoInt)];
                    _n_35 = _sa[((_j_34 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)];
                    if (_n_35 != (_lastLen_31)) {
                        _gotoNext = 4162010i32;
                    } else {
                        _gotoNext = 4162030i32;
                    };
                } else if (__value__ == (4162010i32)) {
                    _gotoNext = 4162347i32;
                } else if (__value__ == (4162030i32)) {
                    if (((_n_35 : stdgo.GoUInt64) >= (_text.length : stdgo.GoUInt64) : Bool)) {
                        _gotoNext = 4162064i32;
                    } else {
                        _gotoNext = 4162149i32;
                    };
                } else if (__value__ == (4162064i32)) {
                    _gotoNext = 4162388i32;
                } else if (__value__ == (4162149i32)) {
                    ...
                    _i_39 = (0 : stdgo.GoInt);
                    _gotoNext = 4162251i32;
                    {
                        _gotoNext = 4162149i32;
                    };
                } else if (__value__ == (4162251i32)) {
                    if ((_i_39 < _n_36 : Bool)) {
                        _gotoNext = 4162274i32;
                    } else {
                        _gotoNext = 4162332i32;
                    };
                } else if (__value__ == (4162270i32)) {
                    _i_39++;
                    _gotoNext = 4162251i32;
                } else if (__value__ == (4162274i32)) {
                    if (_this_37[(_i_39 : stdgo.GoInt)] != (_last_38[(_i_39 : stdgo.GoInt)])) {
                        _gotoNext = 4162302i32;
                    } else {
                        _gotoNext = 4162270i32;
                    };
                } else if (__value__ == (4162302i32)) {
                    _gotoNext = 4162347i32;
                } else if (__value__ == (4162332i32)) {
                    _gotoNext = 4162388i32;
                } else if (__value__ == (4162347i32)) {
                    _gotoNext = 4162347i32;
                    _id_30++;
                    _lastPos_32 = _j_34;
                    _lastLen_31 = _n_35;
                    _gotoNext = 4162388i32;
                } else if (__value__ == (4162388i32)) {
                    _sa[((_j_34 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)] = (_id_30 : stdgo.GoInt64);
                    _iterator_4161865_33++;
                    _gotoNext = 4162417i32;
                } else if (__value__ == (4162416i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(0i32 : stdgo.GoInt)];
                        _iterator_4161865_33 = @:binopAssign __tmp__0;
                        _j_34 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4162417i32;
                } else if (__value__ == (4162417i32)) {
                    if (_iterator_4161865_33 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4161891i32;
                    } else {
                        _gotoNext = 4162420i32;
                    };
                } else if (__value__ == (4162420i32)) {
                    return _id_30;
                    _gotoNext = -1i32;
                };
            };
