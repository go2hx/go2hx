...
function _assignID_64(_text:stdgo.Slice<stdgo.GoInt64>, _sa:stdgo.Slice<stdgo.GoInt64>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _i_3951669_33:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 3952220i32;
                    } else {
                        _gotoNext = 3952224i32;
                    };
                } else if (__value__ == (3951695i32)) {
                    _j_34 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(_i_3951669_33 : stdgo.GoInt)];
                    _n_35 = _sa[((_j_34 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)];
                    if (_n_35 != (_lastLen_31)) {
                        _gotoNext = 3951814i32;
                    } else {
                        _gotoNext = 3951834i32;
                    };
                } else if (__value__ == (3951814i32)) {
                    _gotoNext = 3952151i32;
                } else if (__value__ == (3951834i32)) {
                    if (((_n_35 : stdgo.GoUInt64) >= (_text.length : stdgo.GoUInt64) : Bool)) {
                        _gotoNext = 3951868i32;
                    } else {
                        _gotoNext = 3951953i32;
                    };
                } else if (__value__ == (3951868i32)) {
                    _gotoNext = 3952192i32;
                } else if (__value__ == (3951953i32)) {
                    ...
                    _i_39 = (0 : stdgo.GoInt);
                    _gotoNext = 3952055i32;
                    {
                        _gotoNext = 3951953i32;
                    };
                } else if (__value__ == (3952055i32)) {
                    if ((_i_39 < _n_36 : Bool)) {
                        _gotoNext = 3952078i32;
                    } else {
                        _gotoNext = 3952136i32;
                    };
                } else if (__value__ == (3952074i32)) {
                    _i_39++;
                    _gotoNext = 3952055i32;
                } else if (__value__ == (3952078i32)) {
                    if (_this_37[(_i_39 : stdgo.GoInt)] != (_last_38[(_i_39 : stdgo.GoInt)])) {
                        _gotoNext = 3952106i32;
                    } else {
                        _gotoNext = 3952074i32;
                    };
                } else if (__value__ == (3952106i32)) {
                    _gotoNext = 3952151i32;
                } else if (__value__ == (3952136i32)) {
                    _gotoNext = 3952192i32;
                } else if (__value__ == (3952151i32)) {
                    _gotoNext = 3952151i32;
                    _id_30++;
                    _lastPos_32 = _j_34;
                    _lastLen_31 = _n_35;
                    _gotoNext = 3952192i32;
                } else if (__value__ == (3952192i32)) {
                    _sa[((_j_34 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)] = (_id_30 : stdgo.GoInt64);
                    _i_3951669_33++;
                    _gotoNext = 3952221i32;
                } else if (__value__ == (3952220i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(0i32 : stdgo.GoInt)];
                        _i_3951669_33 = @:binopAssign __tmp__0;
                        _j_34 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 3952221i32;
                } else if (__value__ == (3952221i32)) {
                    if (_i_3951669_33 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 3951695i32;
                    } else {
                        _gotoNext = 3952224i32;
                    };
                } else if (__value__ == (3952224i32)) {
                    return _id_30;
                    _gotoNext = -1i32;
                };
            };
