...
function _assignID_64(_text:stdgo.Slice<stdgo.GoInt64>, _sa:stdgo.Slice<stdgo.GoInt64>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _i_4194732_33:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4195283i32;
                    } else {
                        _gotoNext = 4195287i32;
                    };
                } else if (__value__ == (4194758i32)) {
                    _j_34 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(_i_4194732_33 : stdgo.GoInt)];
                    _n_35 = _sa[((_j_34 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)];
                    if (_n_35 != (_lastLen_31)) {
                        _gotoNext = 4194877i32;
                    } else {
                        _gotoNext = 4194897i32;
                    };
                } else if (__value__ == (4194877i32)) {
                    _gotoNext = 4195214i32;
                } else if (__value__ == (4194897i32)) {
                    if (((_n_35 : stdgo.GoUInt64) >= (_text.length : stdgo.GoUInt64) : Bool)) {
                        _gotoNext = 4194931i32;
                    } else {
                        _gotoNext = 4195016i32;
                    };
                } else if (__value__ == (4194931i32)) {
                    _gotoNext = 4195255i32;
                } else if (__value__ == (4195016i32)) {
                    ...
                    _i_39 = (0 : stdgo.GoInt);
                    _gotoNext = 4195118i32;
                    {
                        _gotoNext = 4195016i32;
                    };
                } else if (__value__ == (4195118i32)) {
                    if ((_i_39 < _n_36 : Bool)) {
                        _gotoNext = 4195141i32;
                    } else {
                        _gotoNext = 4195199i32;
                    };
                } else if (__value__ == (4195137i32)) {
                    _i_39++;
                    _gotoNext = 4195118i32;
                } else if (__value__ == (4195141i32)) {
                    if (_this_37[(_i_39 : stdgo.GoInt)] != (_last_38[(_i_39 : stdgo.GoInt)])) {
                        _gotoNext = 4195169i32;
                    } else {
                        _gotoNext = 4195137i32;
                    };
                } else if (__value__ == (4195169i32)) {
                    _gotoNext = 4195214i32;
                } else if (__value__ == (4195199i32)) {
                    _gotoNext = 4195255i32;
                } else if (__value__ == (4195214i32)) {
                    _gotoNext = 4195214i32;
                    _id_30++;
                    _lastPos_32 = _j_34;
                    _lastLen_31 = _n_35;
                    _gotoNext = 4195255i32;
                } else if (__value__ == (4195255i32)) {
                    _sa[((_j_34 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)] = (_id_30 : stdgo.GoInt64);
                    _i_4194732_33++;
                    _gotoNext = 4195284i32;
                } else if (__value__ == (4195283i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(0i32 : stdgo.GoInt)];
                        _i_4194732_33 = @:binopAssign __tmp__0;
                        _j_34 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4195284i32;
                } else if (__value__ == (4195284i32)) {
                    if (_i_4194732_33 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4194758i32;
                    } else {
                        _gotoNext = 4195287i32;
                    };
                } else if (__value__ == (4195287i32)) {
                    return _id_30;
                    _gotoNext = -1i32;
                };
            };
