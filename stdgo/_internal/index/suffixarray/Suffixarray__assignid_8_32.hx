...
function _assignID_8_32(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt32>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _i_4309872_3:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4310423i32;
                    } else {
                        _gotoNext = 4310427i32;
                    };
                } else if (__value__ == (4309898i32)) {
                    _j_4 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(_i_4309872_3 : stdgo.GoInt)];
                    _n_5 = _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)];
                    if (_n_5 != (_lastLen_1)) {
                        _gotoNext = 4310017i32;
                    } else {
                        _gotoNext = 4310037i32;
                    };
                } else if (__value__ == (4310017i32)) {
                    _gotoNext = 4310354i32;
                } else if (__value__ == (4310037i32)) {
                    if (((_n_5 : stdgo.GoUInt32) >= (_text.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 4310071i32;
                    } else {
                        _gotoNext = 4310156i32;
                    };
                } else if (__value__ == (4310071i32)) {
                    _gotoNext = 4310395i32;
                } else if (__value__ == (4310156i32)) {
                    ...
                    _i_9 = (0 : stdgo.GoInt);
                    _gotoNext = 4310258i32;
                    {
                        _gotoNext = 4310156i32;
                    };
                } else if (__value__ == (4310258i32)) {
                    if ((_i_9 < _n_6 : Bool)) {
                        _gotoNext = 4310281i32;
                    } else {
                        _gotoNext = 4310339i32;
                    };
                } else if (__value__ == (4310277i32)) {
                    _i_9++;
                    _gotoNext = 4310258i32;
                } else if (__value__ == (4310281i32)) {
                    if (_this_7[(_i_9 : stdgo.GoInt)] != (_last_8[(_i_9 : stdgo.GoInt)])) {
                        _gotoNext = 4310309i32;
                    } else {
                        _gotoNext = 4310277i32;
                    };
                } else if (__value__ == (4310309i32)) {
                    _gotoNext = 4310354i32;
                } else if (__value__ == (4310339i32)) {
                    _gotoNext = 4310395i32;
                } else if (__value__ == (4310354i32)) {
                    _gotoNext = 4310354i32;
                    _id_0++;
                    _lastPos_2 = _j_4;
                    _lastLen_1 = _n_5;
                    _gotoNext = 4310395i32;
                } else if (__value__ == (4310395i32)) {
                    _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)] = (_id_0 : stdgo.GoInt32);
                    _i_4309872_3++;
                    _gotoNext = 4310424i32;
                } else if (__value__ == (4310423i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(0i32 : stdgo.GoInt)];
                        _i_4309872_3 = @:binopAssign __tmp__0;
                        _j_4 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4310424i32;
                } else if (__value__ == (4310424i32)) {
                    if (_i_4309872_3 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4309898i32;
                    } else {
                        _gotoNext = 4310427i32;
                    };
                } else if (__value__ == (4310427i32)) {
                    return _id_0;
                    _gotoNext = -1i32;
                };
            };
