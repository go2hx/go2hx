...
function _assignID_8_32(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt32>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _i_4156832_3:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4157383i32;
                    } else {
                        _gotoNext = 4157387i32;
                    };
                } else if (__value__ == (4156858i32)) {
                    _j_4 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(_i_4156832_3 : stdgo.GoInt)];
                    _n_5 = _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)];
                    if (_n_5 != (_lastLen_1)) {
                        _gotoNext = 4156977i32;
                    } else {
                        _gotoNext = 4156997i32;
                    };
                } else if (__value__ == (4156977i32)) {
                    _gotoNext = 4157314i32;
                } else if (__value__ == (4156997i32)) {
                    if (((_n_5 : stdgo.GoUInt32) >= (_text.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 4157031i32;
                    } else {
                        _gotoNext = 4157116i32;
                    };
                } else if (__value__ == (4157031i32)) {
                    _gotoNext = 4157355i32;
                } else if (__value__ == (4157116i32)) {
                    ...
                    _i_9 = (0 : stdgo.GoInt);
                    _gotoNext = 4157218i32;
                    {
                        _gotoNext = 4157116i32;
                    };
                } else if (__value__ == (4157218i32)) {
                    if ((_i_9 < _n_6 : Bool)) {
                        _gotoNext = 4157241i32;
                    } else {
                        _gotoNext = 4157299i32;
                    };
                } else if (__value__ == (4157237i32)) {
                    _i_9++;
                    _gotoNext = 4157218i32;
                } else if (__value__ == (4157241i32)) {
                    if (_this_7[(_i_9 : stdgo.GoInt)] != (_last_8[(_i_9 : stdgo.GoInt)])) {
                        _gotoNext = 4157269i32;
                    } else {
                        _gotoNext = 4157237i32;
                    };
                } else if (__value__ == (4157269i32)) {
                    _gotoNext = 4157314i32;
                } else if (__value__ == (4157299i32)) {
                    _gotoNext = 4157355i32;
                } else if (__value__ == (4157314i32)) {
                    _gotoNext = 4157314i32;
                    _id_0++;
                    _lastPos_2 = _j_4;
                    _lastLen_1 = _n_5;
                    _gotoNext = 4157355i32;
                } else if (__value__ == (4157355i32)) {
                    _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)] = (_id_0 : stdgo.GoInt32);
                    _i_4156832_3++;
                    _gotoNext = 4157384i32;
                } else if (__value__ == (4157383i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(0i32 : stdgo.GoInt)];
                        _i_4156832_3 = @:binopAssign __tmp__0;
                        _j_4 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4157384i32;
                } else if (__value__ == (4157384i32)) {
                    if (_i_4156832_3 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4156858i32;
                    } else {
                        _gotoNext = 4157387i32;
                    };
                } else if (__value__ == (4157387i32)) {
                    return _id_0;
                    _gotoNext = -1i32;
                };
            };
