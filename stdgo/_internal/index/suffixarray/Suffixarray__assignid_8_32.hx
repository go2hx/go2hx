        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4155993i32;
                    } else {
                        _gotoNext = 4155997i32;
                    };
                } else if (__value__ == (4155468i32)) {
                    ...
                    if (_n_5 != (_lastLen_1)) {
                        _gotoNext = 4155587i32;
                    } else {
                        _gotoNext = 4155607i32;
                    };
                } else if (__value__ == (4155587i32)) {
                    _gotoNext = 4155924i32;
                } else if (__value__ == (4155607i32)) {
                    if (((_n_5 : stdgo.GoUInt32) >= (_text.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 4155641i32;
                    } else {
                        _gotoNext = 4155726i32;
                    };
                } else if (__value__ == (4155641i32)) {
                    _gotoNext = 4155965i32;
                } else if (__value__ == (4155726i32)) {
                    ...
                    _i_9 = (0 : stdgo.GoInt);
                    _gotoNext = 4155828i32;
                    {
                        _gotoNext = 4155726i32;
                    };
                } else if (__value__ == (4155828i32)) {
                    if ((_i_9 < _n_6 : Bool)) {
                        _gotoNext = 4155851i32;
                    } else {
                        _gotoNext = 4155909i32;
                    };
                } else if (__value__ == (4155847i32)) {
                    _i_9++;
                    _gotoNext = 4155828i32;
                } else if (__value__ == (4155851i32)) {
                    if (_this_7[(_i_9 : stdgo.GoInt)] != (_last_8[(_i_9 : stdgo.GoInt)])) {
                        _gotoNext = 4155879i32;
                    } else {
                        _gotoNext = 4155847i32;
                    };
                } else if (__value__ == (4155879i32)) {
                    _gotoNext = 4155924i32;
                } else if (__value__ == (4155909i32)) {
                    _gotoNext = 4155965i32;
                } else if (__value__ == (4155924i32)) {
                    _gotoNext = 4155924i32;
                    _id_0++;
                    _lastPos_2 = _j_4;
                    _lastLen_1 = _n_5;
                    _gotoNext = 4155965i32;
                } else if (__value__ == (4155965i32)) {
                    _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)] = (_id_0 : stdgo.GoInt32);
                    _iterator_4155442_3++;
                    _gotoNext = 4155994i32;
                } else if (__value__ == (4155993i32)) {
                    {
                        final __tmp__0 = 0i32;
