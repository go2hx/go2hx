...
function _assignID_8_32(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt32>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _iterator_4194257_3:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        ...
                        _gotoNext = 4194812i32;
                    };
                } else if (__value__ == (4194283i32)) {
                    _j_4 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(_iterator_4194257_3 : stdgo.GoInt)];
                    _n_5 = _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)];
                    if (_n_5 != (_lastLen_1)) {
                        _gotoNext = 4194402i32;
                    } else {
                        _gotoNext = 4194422i32;
                    };
                } else if (__value__ == (4194402i32)) {
                    _gotoNext = 4194739i32;
                } else if (__value__ == (4194422i32)) {
                    if (((_n_5 : stdgo.GoUInt32) >= (_text.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 4194456i32;
                    } else {
                        _gotoNext = 4194541i32;
                    };
                } else if (__value__ == (4194456i32)) {
                    _gotoNext = 4194780i32;
                } else if (__value__ == (4194541i32)) {
                    ...
                    _i_9 = (0 : stdgo.GoInt);
                    _gotoNext = 4194643i32;
                    {
                        _gotoNext = 4194541i32;
                    };
                } else if (__value__ == (4194643i32)) {
                    if ((_i_9 < _n_6 : Bool)) {
                        _gotoNext = 4194666i32;
                    } else {
                        _gotoNext = 4194724i32;
                    };
                } else if (__value__ == (4194662i32)) {
                    _i_9++;
                    _gotoNext = 4194643i32;
                } else if (__value__ == (4194666i32)) {
                    if (_this_7[(_i_9 : stdgo.GoInt)] != (_last_8[(_i_9 : stdgo.GoInt)])) {
                        _gotoNext = 4194694i32;
                    } else {
                        _gotoNext = 4194662i32;
                    };
                } else if (__value__ == (4194694i32)) {
                    _gotoNext = 4194739i32;
                } else if (__value__ == (4194724i32)) {
                    _gotoNext = 4194780i32;
                } else if (__value__ == (4194739i32)) {
                    _gotoNext = 4194739i32;
                    _id_0++;
                    _lastPos_2 = _j_4;
                    _lastLen_1 = _n_5;
                    _gotoNext = 4194780i32;
                } else if (__value__ == (4194780i32)) {
                    _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)] = (_id_0 : stdgo.GoInt32);
                    _iterator_4194257_3++;
                    _gotoNext = 4194809i32;
                } else if (__value__ == (4194808i32)) {
                    {
                        ...
                        _iterator_4194257_3 = @:binopAssign __tmp__0;
                        _j_4 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4194809i32;
                } else if (__value__ == (4194809i32)) {
                    if (_iterator_4194257_3 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4194283i32;
                    } else {
                        _gotoNext = 4194812i32;
                    };
                } else if (__value__ == (4194812i32)) {
                    return _id_0;
                    _gotoNext = -1i32;
                };
            };
