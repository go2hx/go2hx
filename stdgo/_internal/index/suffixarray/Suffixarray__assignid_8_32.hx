...
function _assignID_8_32(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt32>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _i_4166262_3:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4166813i32;
                    } else {
                        _gotoNext = 4166817i32;
                    };
                } else if (__value__ == (4166288i32)) {
                    _j_4 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(_i_4166262_3 : stdgo.GoInt)];
                    _n_5 = _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)];
                    if (_n_5 != (_lastLen_1)) {
                        _gotoNext = 4166407i32;
                    } else {
                        _gotoNext = 4166427i32;
                    };
                } else if (__value__ == (4166407i32)) {
                    _gotoNext = 4166744i32;
                } else if (__value__ == (4166427i32)) {
                    if (((_n_5 : stdgo.GoUInt32) >= (_text.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 4166461i32;
                    } else {
                        _gotoNext = 4166546i32;
                    };
                } else if (__value__ == (4166461i32)) {
                    _gotoNext = 4166785i32;
                } else if (__value__ == (4166546i32)) {
                    ...
                    _i_9 = (0 : stdgo.GoInt);
                    _gotoNext = 4166648i32;
                    {
                        _gotoNext = 4166546i32;
                    };
                } else if (__value__ == (4166648i32)) {
                    if ((_i_9 < _n_6 : Bool)) {
                        _gotoNext = 4166671i32;
                    } else {
                        _gotoNext = 4166729i32;
                    };
                } else if (__value__ == (4166667i32)) {
                    _i_9++;
                    _gotoNext = 4166648i32;
                } else if (__value__ == (4166671i32)) {
                    if (_this_7[(_i_9 : stdgo.GoInt)] != (_last_8[(_i_9 : stdgo.GoInt)])) {
                        _gotoNext = 4166699i32;
                    } else {
                        _gotoNext = 4166667i32;
                    };
                } else if (__value__ == (4166699i32)) {
                    _gotoNext = 4166744i32;
                } else if (__value__ == (4166729i32)) {
                    _gotoNext = 4166785i32;
                } else if (__value__ == (4166744i32)) {
                    _gotoNext = 4166744i32;
                    _id_0++;
                    _lastPos_2 = _j_4;
                    _lastLen_1 = _n_5;
                    _gotoNext = 4166785i32;
                } else if (__value__ == (4166785i32)) {
                    _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)] = (_id_0 : stdgo.GoInt32);
                    _i_4166262_3++;
                    _gotoNext = 4166814i32;
                } else if (__value__ == (4166813i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(0i32 : stdgo.GoInt)];
                        _i_4166262_3 = @:binopAssign __tmp__0;
                        _j_4 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4166814i32;
                } else if (__value__ == (4166814i32)) {
                    if (_i_4166262_3 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4166288i32;
                    } else {
                        _gotoNext = 4166817i32;
                    };
                } else if (__value__ == (4166817i32)) {
                    return _id_0;
                    _gotoNext = -1i32;
                };
            };
