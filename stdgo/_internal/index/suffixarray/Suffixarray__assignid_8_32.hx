...
function _assignID_8_32(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt32>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _iterator_4114217_3:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4114768i32;
                    } else {
                        _gotoNext = 4114772i32;
                    };
                } else if (__value__ == (4114243i32)) {
                    _j_4 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(_iterator_4114217_3 : stdgo.GoInt)];
                    _n_5 = _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)];
                    if (_n_5 != (_lastLen_1)) {
                        _gotoNext = 4114362i32;
                    } else {
                        _gotoNext = 4114382i32;
                    };
                } else if (__value__ == (4114362i32)) {
                    _gotoNext = 4114699i32;
                } else if (__value__ == (4114382i32)) {
                    if (((_n_5 : stdgo.GoUInt32) >= (_text.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 4114416i32;
                    } else {
                        _gotoNext = 4114501i32;
                    };
                } else if (__value__ == (4114416i32)) {
                    _gotoNext = 4114740i32;
                } else if (__value__ == (4114501i32)) {
                    ...
                    _i_9 = (0 : stdgo.GoInt);
                    _gotoNext = 4114603i32;
                    {
                        _gotoNext = 4114501i32;
                    };
                } else if (__value__ == (4114603i32)) {
                    if ((_i_9 < _n_6 : Bool)) {
                        _gotoNext = 4114626i32;
                    } else {
                        _gotoNext = 4114684i32;
                    };
                } else if (__value__ == (4114622i32)) {
                    _i_9++;
                    _gotoNext = 4114603i32;
                } else if (__value__ == (4114626i32)) {
                    if (_this_7[(_i_9 : stdgo.GoInt)] != (_last_8[(_i_9 : stdgo.GoInt)])) {
                        _gotoNext = 4114654i32;
                    } else {
                        _gotoNext = 4114622i32;
                    };
                } else if (__value__ == (4114654i32)) {
                    _gotoNext = 4114699i32;
                } else if (__value__ == (4114684i32)) {
                    _gotoNext = 4114740i32;
                } else if (__value__ == (4114699i32)) {
                    _gotoNext = 4114699i32;
                    _id_0++;
                    _lastPos_2 = _j_4;
                    _lastLen_1 = _n_5;
                    _gotoNext = 4114740i32;
                } else if (__value__ == (4114740i32)) {
                    _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)] = (_id_0 : stdgo.GoInt32);
                    _iterator_4114217_3++;
                    _gotoNext = 4114769i32;
                } else if (__value__ == (4114768i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(0i32 : stdgo.GoInt)];
                        _iterator_4114217_3 = @:binopAssign __tmp__0;
                        _j_4 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4114769i32;
                } else if (__value__ == (4114769i32)) {
                    if (_iterator_4114217_3 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4114243i32;
                    } else {
                        _gotoNext = 4114772i32;
                    };
                } else if (__value__ == (4114772i32)) {
                    return _id_0;
                    _gotoNext = -1i32;
                };
            };
