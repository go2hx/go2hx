...
function _assignID_8_32(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt32>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _i_4209152_3:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4209703i32;
                    } else {
                        _gotoNext = 4209707i32;
                    };
                } else if (__value__ == (4209178i32)) {
                    _j_4 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(_i_4209152_3 : stdgo.GoInt)];
                    _n_5 = _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)];
                    if (_n_5 != (_lastLen_1)) {
                        _gotoNext = 4209297i32;
                    } else {
                        _gotoNext = 4209317i32;
                    };
                } else if (__value__ == (4209297i32)) {
                    _gotoNext = 4209634i32;
                } else if (__value__ == (4209317i32)) {
                    if (((_n_5 : stdgo.GoUInt32) >= (_text.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 4209351i32;
                    } else {
                        _gotoNext = 4209436i32;
                    };
                } else if (__value__ == (4209351i32)) {
                    _gotoNext = 4209675i32;
                    ...
                    _i_9 = (0 : stdgo.GoInt);
                    _gotoNext = 4209538i32;
                    {
                        _gotoNext = 4209436i32;
                    };
                } else if (__value__ == (4209538i32)) {
                    if ((_i_9 < _n_6 : Bool)) {
                        _gotoNext = 4209561i32;
                    } else {
                        _gotoNext = 4209619i32;
                    };
                } else if (__value__ == (4209557i32)) {
                    _i_9++;
                    _gotoNext = 4209538i32;
                } else if (__value__ == (4209561i32)) {
                    if (_this_7[(_i_9 : stdgo.GoInt)] != (_last_8[(_i_9 : stdgo.GoInt)])) {
                        _gotoNext = 4209589i32;
                    } else {
                        _gotoNext = 4209557i32;
                    };
                } else if (__value__ == (4209589i32)) {
                    _gotoNext = 4209634i32;
                } else if (__value__ == (4209619i32)) {
                    _gotoNext = 4209675i32;
                } else if (__value__ == (4209634i32)) {
                    _gotoNext = 4209634i32;
                    _id_0++;
                    _lastPos_2 = _j_4;
                    _lastLen_1 = _n_5;
                    _gotoNext = 4209675i32;
                } else if (__value__ == (4209675i32)) {
                    _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)] = (_id_0 : stdgo.GoInt32);
                    _i_4209152_3++;
                    _gotoNext = 4209704i32;
                } else if (__value__ == (4209703i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(0i32 : stdgo.GoInt)];
                        _i_4209152_3 = @:binopAssign __tmp__0;
                        _j_4 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4209704i32;
                } else if (__value__ == (4209704i32)) {
                    if (_i_4209152_3 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4209178i32;
                    } else {
                        _gotoNext = 4209707i32;
                    };
                } else if (__value__ == (4209707i32)) {
                    return _id_0;
                    _gotoNext = -1i32;
                };
            };
