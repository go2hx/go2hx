...
function _assignID_8_32(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt32>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _iterator_4169303_3:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4169854i32;
                    } else {
                        _gotoNext = 4169858i32;
                    };
                } else if (__value__ == (4169329i32)) {
                    _j_4 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(_iterator_4169303_3 : stdgo.GoInt)];
                    _n_5 = _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)];
                    if (_n_5 != (_lastLen_1)) {
                        _gotoNext = 4169448i32;
                    } else {
                        _gotoNext = 4169468i32;
                    };
                } else if (__value__ == (4169448i32)) {
                    _gotoNext = 4169785i32;
                } else if (__value__ == (4169468i32)) {
                    if (((_n_5 : stdgo.GoUInt32) >= (_text.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 4169502i32;
                    } else {
                        _gotoNext = 4169587i32;
                    };
                } else if (__value__ == (4169502i32)) {
                    _gotoNext = 4169826i32;
                } else if (__value__ == (4169587i32)) {
                    ...
                    _i_9 = (0 : stdgo.GoInt);
                    _gotoNext = 4169689i32;
                    {
                        _gotoNext = 4169587i32;
                    };
                } else if (__value__ == (4169689i32)) {
                    if ((_i_9 < _n_6 : Bool)) {
                        _gotoNext = 4169712i32;
                    } else {
                        _gotoNext = 4169770i32;
                    };
                } else if (__value__ == (4169708i32)) {
                    _i_9++;
                    _gotoNext = 4169689i32;
                } else if (__value__ == (4169712i32)) {
                    if (_this_7[(_i_9 : stdgo.GoInt)] != (_last_8[(_i_9 : stdgo.GoInt)])) {
                        _gotoNext = 4169740i32;
                    } else {
                        _gotoNext = 4169708i32;
                    };
                } else if (__value__ == (4169740i32)) {
                    _gotoNext = 4169785i32;
                } else if (__value__ == (4169770i32)) {
                    _gotoNext = 4169826i32;
                } else if (__value__ == (4169785i32)) {
                    _gotoNext = 4169785i32;
                    _id_0++;
                    _lastPos_2 = _j_4;
                    _lastLen_1 = _n_5;
                    _gotoNext = 4169826i32;
                } else if (__value__ == (4169826i32)) {
                    _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)] = (_id_0 : stdgo.GoInt32);
                    _iterator_4169303_3++;
                    _gotoNext = 4169855i32;
                } else if (__value__ == (4169854i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(0i32 : stdgo.GoInt)];
                        _iterator_4169303_3 = @:binopAssign __tmp__0;
                        _j_4 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4169855i32;
                } else if (__value__ == (4169855i32)) {
                    if (_iterator_4169303_3 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4169329i32;
                    } else {
                        _gotoNext = 4169858i32;
                    };
                } else if (__value__ == (4169858i32)) {
                    return _id_0;
                    _gotoNext = -1i32;
                };
            };
