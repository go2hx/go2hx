...
function _assignID_8_32(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt32>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _iterator_4045252_3:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4045803i32;
                    } else {
                        _gotoNext = 4045807i32;
                    };
                } else if (__value__ == (4045278i32)) {
                    _j_4 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(_iterator_4045252_3 : stdgo.GoInt)];
                    _n_5 = _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)];
                    if (_n_5 != (_lastLen_1)) {
                        _gotoNext = 4045397i32;
                    } else {
                        _gotoNext = 4045417i32;
                    };
                } else if (__value__ == (4045397i32)) {
                    _gotoNext = 4045734i32;
                } else if (__value__ == (4045417i32)) {
                    if (((_n_5 : stdgo.GoUInt32) >= (_text.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 4045451i32;
                    } else {
                        _gotoNext = 4045536i32;
                    };
                } else if (__value__ == (4045451i32)) {
                    _gotoNext = 4045775i32;
                } else if (__value__ == (4045536i32)) {
                    ...
                    _i_9 = (0 : stdgo.GoInt);
                    _gotoNext = 4045638i32;
                    {
                        _gotoNext = 4045536i32;
                    };
                } else if (__value__ == (4045638i32)) {
                    if ((_i_9 < _n_6 : Bool)) {
                        _gotoNext = 4045661i32;
                    } else {
                        _gotoNext = 4045719i32;
                    };
                } else if (__value__ == (4045657i32)) {
                    _i_9++;
                    _gotoNext = 4045638i32;
                } else if (__value__ == (4045661i32)) {
                    if (_this_7[(_i_9 : stdgo.GoInt)] != (_last_8[(_i_9 : stdgo.GoInt)])) {
                        _gotoNext = 4045689i32;
                    } else {
                        _gotoNext = 4045657i32;
                    };
                } else if (__value__ == (4045689i32)) {
                    _gotoNext = 4045734i32;
                } else if (__value__ == (4045719i32)) {
                    _gotoNext = 4045775i32;
                    ...
                    _lastLen_1 = _n_5;
                    _gotoNext = 4045775i32;
                } else if (__value__ == (4045775i32)) {
                    _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)] = (_id_0 : stdgo.GoInt32);
                    _iterator_4045252_3++;
                    _gotoNext = 4045804i32;
                } else if (__value__ == (4045803i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(0i32 : stdgo.GoInt)];
                        _iterator_4045252_3 = @:binopAssign __tmp__0;
                        _j_4 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4045804i32;
                } else if (__value__ == (4045804i32)) {
                    if (_iterator_4045252_3 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4045278i32;
                    } else {
                        _gotoNext = 4045807i32;
                    };
                } else if (__value__ == (4045807i32)) {
                    return _id_0;
                    _gotoNext = -1i32;
                };
            };
