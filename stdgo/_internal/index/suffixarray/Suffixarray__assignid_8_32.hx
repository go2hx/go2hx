            ...
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    ...
                    if ((0i64 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4139306i64;
                    } else {
                        _gotoNext = 4139310i64;
                    };
                } else if (__value__ == (4138781i64)) {
                    ...
                    if (_n_5 != (_lastLen_1)) {
                        _gotoNext = 4138900i64;
                    } else {
                        _gotoNext = 4138920i64;
                    };
                } else if (__value__ == (4138900i64)) {
                    _gotoNext = 4139237i64;
                } else if (__value__ == (4138920i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L603"
                    if (((_n_5 : stdgo.GoUInt32) >= (_text.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 4138954i64;
                    } else {
                        _gotoNext = 4139039i64;
                    };
                } else if (__value__ == (4138954i64)) {
                    _gotoNext = 4139278i64;
                } else if (__value__ == (4139039i64)) {
                    ...
                    _i_9 = (0 : stdgo.GoInt);
                    _gotoNext = 4139141i64;
                    //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L607"
                    {
                        _gotoNext = 4139039i64;
                    };
                } else if (__value__ == (4139141i64)) {
                    //"file://#L0"
                    if ((_i_9 < _n_6 : Bool)) {
                        _gotoNext = 4139164i64;
                    } else {
                        _gotoNext = 4139222i64;
                    };
                } else if (__value__ == (4139160i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L612"
                    _i_9++;
                    _gotoNext = 4139141i64;
                } else if (__value__ == (4139164i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L613"
                    if (_this_7[(_i_9 : stdgo.GoInt)] != (_last_8[(_i_9 : stdgo.GoInt)])) {
                        _gotoNext = 4139192i64;
                    } else {
                        _gotoNext = 4139160i64;
                    };
                } else if (__value__ == (4139192i64)) {
                    _gotoNext = 4139237i64;
                } else if (__value__ == (4139222i64)) {
                    _gotoNext = 4139278i64;
                } else if (__value__ == (4139237i64)) {
                    _gotoNext = 4139237i64;
                    ...
                    _lastLen_1 = _n_5;
                    _gotoNext = 4139278i64;
                } else if (__value__ == (4139278i64)) {
                    _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)] = (_id_0 : stdgo.GoInt32);
                    //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L597"
                    _iterator_4138755_3++;
                    _gotoNext = 4139307i64;
                } else if (__value__ == (4139306i64)) {
                    {
                        final __tmp__0 = 0i64;
