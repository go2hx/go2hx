...
function _assignID_8_32(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt32>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _iterator_3926595_3:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 3927146i32;
                    } else {
                        _gotoNext = 3927150i32;
                    };
                } else if (__value__ == (3926621i32)) {
                    _j_4 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(_iterator_3926595_3 : stdgo.GoInt)];
                    _n_5 = _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)];
                    if (_n_5 != (_lastLen_1)) {
                        _gotoNext = 3926740i32;
                    } else {
                        _gotoNext = 3926760i32;
                    };
                } else if (__value__ == (3926740i32)) {
                    _gotoNext = 3927077i32;
                } else if (__value__ == (3926760i32)) {
                    if (((_n_5 : stdgo.GoUInt32) >= (_text.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 3926794i32;
                    } else {
                        _gotoNext = 3926879i32;
                    };
                } else if (__value__ == (3926794i32)) {
                    _gotoNext = 3927118i32;
                } else if (__value__ == (3926879i32)) {
                    ...
                    _i_9 = (0 : stdgo.GoInt);
                    _gotoNext = 3926981i32;
                    {
                        _gotoNext = 3926879i32;
                    };
                } else if (__value__ == (3926981i32)) {
                    if ((_i_9 < _n_6 : Bool)) {
                        _gotoNext = 3927004i32;
                    } else {
                        _gotoNext = 3927062i32;
                    };
                } else if (__value__ == (3927000i32)) {
                    _i_9++;
                    _gotoNext = 3926981i32;
                } else if (__value__ == (3927004i32)) {
                    if (_this_7[(_i_9 : stdgo.GoInt)] != (_last_8[(_i_9 : stdgo.GoInt)])) {
                        _gotoNext = 3927032i32;
                    } else {
                        _gotoNext = 3927000i32;
                    };
                } else if (__value__ == (3927032i32)) {
                    _gotoNext = 3927077i32;
                } else if (__value__ == (3927062i32)) {
                    _gotoNext = 3927118i32;
                } else if (__value__ == (3927077i32)) {
                    _gotoNext = 3927077i32;
                    _id_0++;
                    _lastPos_2 = _j_4;
                    _lastLen_1 = _n_5;
                    _gotoNext = 3927118i32;
                } else if (__value__ == (3927118i32)) {
                    _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)] = (_id_0 : stdgo.GoInt32);
                    _iterator_3926595_3++;
                    _gotoNext = 3927147i32;
                } else if (__value__ == (3927146i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(0i32 : stdgo.GoInt)];
                        _iterator_3926595_3 = @:binopAssign __tmp__0;
                        _j_4 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 3927147i32;
                } else if (__value__ == (3927147i32)) {
                    if (_iterator_3926595_3 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 3926621i32;
                    } else {
                        _gotoNext = 3927150i32;
                    };
