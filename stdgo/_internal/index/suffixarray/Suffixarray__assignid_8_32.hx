...
function _assignID_8_32(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt32>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _i_4095865_3:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4096416i32;
                    } else {
                        _gotoNext = 4096420i32;
                    };
                } else if (__value__ == (4095891i32)) {
                    _j_4 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(_i_4095865_3 : stdgo.GoInt)];
                    _n_5 = _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)];
                    if (_n_5 != (_lastLen_1)) {
                        _gotoNext = 4096010i32;
                    } else {
                        _gotoNext = 4096030i32;
                    };
                } else if (__value__ == (4096010i32)) {
                    _gotoNext = 4096347i32;
                } else if (__value__ == (4096030i32)) {
                    if (((_n_5 : stdgo.GoUInt32) >= (_text.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 4096064i32;
                    } else {
                        _gotoNext = 4096149i32;
                    };
                } else if (__value__ == (4096064i32)) {
                    _gotoNext = 4096388i32;
                } else if (__value__ == (4096149i32)) {
                    ...
                    _i_9 = (0 : stdgo.GoInt);
                    _gotoNext = 4096251i32;
                    {
                        _gotoNext = 4096149i32;
                    };
                } else if (__value__ == (4096251i32)) {
                    if ((_i_9 < _n_6 : Bool)) {
                        _gotoNext = 4096274i32;
                    } else {
                        _gotoNext = 4096332i32;
                    };
                } else if (__value__ == (4096270i32)) {
                    _i_9++;
                    _gotoNext = 4096251i32;
                } else if (__value__ == (4096274i32)) {
                    if (_this_7[(_i_9 : stdgo.GoInt)] != (_last_8[(_i_9 : stdgo.GoInt)])) {
                        _gotoNext = 4096302i32;
                    } else {
                        _gotoNext = 4096270i32;
                    };
                } else if (__value__ == (4096302i32)) {
                    _gotoNext = 4096347i32;
                } else if (__value__ == (4096332i32)) {
                    _gotoNext = 4096388i32;
                } else if (__value__ == (4096347i32)) {
                    _gotoNext = 4096347i32;
                    _id_0++;
                    _lastPos_2 = _j_4;
                    _lastLen_1 = _n_5;
                    _gotoNext = 4096388i32;
                } else if (__value__ == (4096388i32)) {
                    _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)] = (_id_0 : stdgo.GoInt32);
                    _i_4095865_3++;
                    _gotoNext = 4096417i32;
                } else if (__value__ == (4096416i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(0i32 : stdgo.GoInt)];
                        _i_4095865_3 = @:binopAssign __tmp__0;
                        _j_4 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4096417i32;
                } else if (__value__ == (4096417i32)) {
                    if (_i_4095865_3 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 4095891i32;
                    } else {
                        _gotoNext = 4096420i32;
                    };
                } else if (__value__ == (4096420i32)) {
                    return _id_0;
                    _gotoNext = -1i32;
                };
            };
