...
function _assignID_8_32(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt32>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _i_3972035_3:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 3972586i32;
                    } else {
                        _gotoNext = 3972590i32;
                    };
                } else if (__value__ == (3972061i32)) {
                    _j_4 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(_i_3972035_3 : stdgo.GoInt)];
                    _n_5 = _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)];
                    if (_n_5 != (_lastLen_1)) {
                        _gotoNext = 3972180i32;
                    } else {
                        _gotoNext = 3972200i32;
                    };
                } else if (__value__ == (3972180i32)) {
                    _gotoNext = 3972517i32;
                } else if (__value__ == (3972200i32)) {
                    if (((_n_5 : stdgo.GoUInt32) >= (_text.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 3972234i32;
                    } else {
                        _gotoNext = 3972319i32;
                    };
                } else if (__value__ == (3972234i32)) {
                    _gotoNext = 3972558i32;
                } else if (__value__ == (3972319i32)) {
                    ...
                    _i_9 = (0 : stdgo.GoInt);
                    _gotoNext = 3972421i32;
                    {
                        _gotoNext = 3972319i32;
                    };
                } else if (__value__ == (3972421i32)) {
                    if ((_i_9 < _n_6 : Bool)) {
                        _gotoNext = 3972444i32;
                    } else {
                        _gotoNext = 3972502i32;
                    };
                } else if (__value__ == (3972440i32)) {
                    _i_9++;
                    _gotoNext = 3972421i32;
                } else if (__value__ == (3972444i32)) {
                    if (_this_7[(_i_9 : stdgo.GoInt)] != (_last_8[(_i_9 : stdgo.GoInt)])) {
                        _gotoNext = 3972472i32;
                    } else {
                        _gotoNext = 3972440i32;
                    };
                } else if (__value__ == (3972472i32)) {
                    _gotoNext = 3972517i32;
                } else if (__value__ == (3972502i32)) {
                    _gotoNext = 3972558i32;
                } else if (__value__ == (3972517i32)) {
                    _gotoNext = 3972517i32;
                    _id_0++;
                    _lastPos_2 = _j_4;
                    _lastLen_1 = _n_5;
                    _gotoNext = 3972558i32;
                } else if (__value__ == (3972558i32)) {
                    _sa[((_j_4 / (2 : stdgo.GoInt32) : stdgo.GoInt32) : stdgo.GoInt)] = (_id_0 : stdgo.GoInt32);
                    _i_3972035_3++;
                    _gotoNext = 3972587i32;
                } else if (__value__ == (3972586i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>)[(0i32 : stdgo.GoInt)];
                        _i_3972035_3 = @:binopAssign __tmp__0;
                        _j_4 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 3972587i32;
                } else if (__value__ == (3972587i32)) {
                    if (_i_3972035_3 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>).length)) {
                        _gotoNext = 3972061i32;
                    } else {
                        _gotoNext = 3972590i32;
                    };
                } else if (__value__ == (3972590i32)) {
                    return _id_0;
                    _gotoNext = -1i32;
                };
            };
