...
function _assignID_8_64(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt64>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _iterator_3867975_13:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 3868526i32;
                    } else {
                        _gotoNext = 3868530i32;
                    };
                } else if (__value__ == (3868001i32)) {
                    _j_14 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(_iterator_3867975_13 : stdgo.GoInt)];
                    _n_15 = _sa[((_j_14 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)];
                    if (_n_15 != (_lastLen_11)) {
                        _gotoNext = 3868120i32;
                    } else {
                        _gotoNext = 3868140i32;
                    };
                } else if (__value__ == (3868120i32)) {
                    _gotoNext = 3868457i32;
                } else if (__value__ == (3868140i32)) {
                    if (((_n_15 : stdgo.GoUInt64) >= (_text.length : stdgo.GoUInt64) : Bool)) {
                        _gotoNext = 3868174i32;
                    } else {
                        _gotoNext = 3868259i32;
                    };
                } else if (__value__ == (3868174i32)) {
                    _gotoNext = 3868498i32;
                } else if (__value__ == (3868259i32)) {
                    ...
                    if ((_i_19 < _n_16 : Bool)) {
                        _gotoNext = 3868384i32;
                    } else {
                        _gotoNext = 3868442i32;
                    };
                } else if (__value__ == (3868380i32)) {
                    _i_19++;
                    _gotoNext = 3868361i32;
                } else if (__value__ == (3868384i32)) {
                    if (_this_17[(_i_19 : stdgo.GoInt)] != (_last_18[(_i_19 : stdgo.GoInt)])) {
                        _gotoNext = 3868412i32;
                    } else {
                        _gotoNext = 3868380i32;
                    };
                } else if (__value__ == (3868412i32)) {
                    _gotoNext = 3868457i32;
                } else if (__value__ == (3868442i32)) {
                    _gotoNext = 3868498i32;
                } else if (__value__ == (3868457i32)) {
                    _gotoNext = 3868457i32;
                    _id_10++;
                    _lastPos_12 = _j_14;
                    _lastLen_11 = _n_15;
                    _gotoNext = 3868498i32;
                } else if (__value__ == (3868498i32)) {
                    _sa[((_j_14 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)] = (_id_10 : stdgo.GoInt64);
                    _iterator_3867975_13++;
                    _gotoNext = 3868527i32;
                } else if (__value__ == (3868526i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(0i32 : stdgo.GoInt)];
                        _iterator_3867975_13 = @:binopAssign __tmp__0;
                        _j_14 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 3868527i32;
                } else if (__value__ == (3868527i32)) {
                    if (_iterator_3867975_13 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 3868001i32;
                    } else {
                        _gotoNext = 3868530i32;
                    };
                } else if (__value__ == (3868530i32)) {
                    return _id_10;
                    _gotoNext = -1i32;
                };
            };
