...
function _assignID_8_64(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt64>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _iterator_4231165_13:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4231716i32;
                    } else {
                        _gotoNext = 4231720i32;
                    };
                } else if (__value__ == (4231191i32)) {
                    _j_14 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(_iterator_4231165_13 : stdgo.GoInt)];
                    _n_15 = _sa[((_j_14 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)];
                    if (_n_15 != (_lastLen_11)) {
                        _gotoNext = 4231310i32;
                    } else {
                        _gotoNext = 4231330i32;
                    };
                } else if (__value__ == (4231310i32)) {
                    _gotoNext = 4231647i32;
                } else if (__value__ == (4231330i32)) {
                    if (((_n_15 : stdgo.GoUInt64) >= (_text.length : stdgo.GoUInt64) : Bool)) {
                        _gotoNext = 4231364i32;
                    } else {
                        _gotoNext = 4231449i32;
                    };
                } else if (__value__ == (4231364i32)) {
                    _gotoNext = 4231688i32;
                    ...
                    _i_19 = (0 : stdgo.GoInt);
                    _gotoNext = 4231551i32;
                    {
                        _gotoNext = 4231449i32;
                    };
                } else if (__value__ == (4231551i32)) {
                    if ((_i_19 < _n_16 : Bool)) {
                        _gotoNext = 4231574i32;
                    } else {
                        _gotoNext = 4231632i32;
                    };
                } else if (__value__ == (4231570i32)) {
                    _i_19++;
                    _gotoNext = 4231551i32;
                } else if (__value__ == (4231574i32)) {
                    if (_this_17[(_i_19 : stdgo.GoInt)] != (_last_18[(_i_19 : stdgo.GoInt)])) {
                        _gotoNext = 4231602i32;
                    } else {
                        _gotoNext = 4231570i32;
                    };
                } else if (__value__ == (4231602i32)) {
                    _gotoNext = 4231647i32;
                } else if (__value__ == (4231632i32)) {
                    _gotoNext = 4231688i32;
                } else if (__value__ == (4231647i32)) {
                    _gotoNext = 4231647i32;
                    _id_10++;
                    _lastPos_12 = _j_14;
                    _lastLen_11 = _n_15;
                    _gotoNext = 4231688i32;
                } else if (__value__ == (4231688i32)) {
                    _sa[((_j_14 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)] = (_id_10 : stdgo.GoInt64);
                    _iterator_4231165_13++;
                    _gotoNext = 4231717i32;
                } else if (__value__ == (4231716i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(0i32 : stdgo.GoInt)];
                        _iterator_4231165_13 = @:binopAssign __tmp__0;
                        _j_14 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4231717i32;
                } else if (__value__ == (4231717i32)) {
                    if (_iterator_4231165_13 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4231191i32;
                    } else {
                        _gotoNext = 4231720i32;
                    };
                } else if (__value__ == (4231720i32)) {
                    return _id_10;
                    _gotoNext = -1i32;
                };
            };
