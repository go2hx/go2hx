...
function _assignID_8_64(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt64>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _iterator_4092872_13:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4093423i32;
                    } else {
                        _gotoNext = 4093427i32;
                    };
                } else if (__value__ == (4092898i32)) {
                    _j_14 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(_iterator_4092872_13 : stdgo.GoInt)];
                    _n_15 = _sa[((_j_14 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)];
                    if (_n_15 != (_lastLen_11)) {
                        _gotoNext = 4093017i32;
                    } else {
                        _gotoNext = 4093037i32;
                    };
                } else if (__value__ == (4093017i32)) {
                    _gotoNext = 4093354i32;
                } else if (__value__ == (4093037i32)) {
                    if (((_n_15 : stdgo.GoUInt64) >= (_text.length : stdgo.GoUInt64) : Bool)) {
                        _gotoNext = 4093071i32;
                    } else {
                        _gotoNext = 4093156i32;
                    };
                } else if (__value__ == (4093071i32)) {
                    _gotoNext = 4093395i32;
                } else if (__value__ == (4093156i32)) {
                    ...
                    _i_19 = (0 : stdgo.GoInt);
                    _gotoNext = 4093258i32;
                    {
                        _gotoNext = 4093156i32;
                    };
                } else if (__value__ == (4093258i32)) {
                    if ((_i_19 < _n_16 : Bool)) {
                        _gotoNext = 4093281i32;
                    } else {
                        _gotoNext = 4093339i32;
                    };
                } else if (__value__ == (4093277i32)) {
                    _i_19++;
                    _gotoNext = 4093258i32;
                } else if (__value__ == (4093281i32)) {
                    if (_this_17[(_i_19 : stdgo.GoInt)] != (_last_18[(_i_19 : stdgo.GoInt)])) {
                        _gotoNext = 4093309i32;
                    } else {
                        _gotoNext = 4093277i32;
                    };
                } else if (__value__ == (4093309i32)) {
                    _gotoNext = 4093354i32;
                } else if (__value__ == (4093339i32)) {
                    _gotoNext = 4093395i32;
                } else if (__value__ == (4093354i32)) {
                    _gotoNext = 4093354i32;
                    _id_10++;
                    _lastPos_12 = _j_14;
                    _lastLen_11 = _n_15;
                    _gotoNext = 4093395i32;
                } else if (__value__ == (4093395i32)) {
                    _sa[((_j_14 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)] = (_id_10 : stdgo.GoInt64);
                    _iterator_4092872_13++;
                    _gotoNext = 4093424i32;
                } else if (__value__ == (4093423i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(0i32 : stdgo.GoInt)];
                        _iterator_4092872_13 = @:binopAssign __tmp__0;
                        _j_14 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4093424i32;
                } else if (__value__ == (4093424i32)) {
                    if (_iterator_4092872_13 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4092898i32;
                    } else {
                        _gotoNext = 4093427i32;
                    };
                } else if (__value__ == (4093427i32)) {
                    return _id_10;
                    _gotoNext = -1i32;
                };
            };
