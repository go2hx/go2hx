...
function _assignID_8_64(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt64>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _i_3976688_13:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 3977239i32;
                    } else {
                        _gotoNext = 3977243i32;
                    };
                } else if (__value__ == (3976714i32)) {
                    _j_14 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(_i_3976688_13 : stdgo.GoInt)];
                    _n_15 = _sa[((_j_14 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)];
                    if (_n_15 != (_lastLen_11)) {
                        _gotoNext = 3976833i32;
                    } else {
                        _gotoNext = 3976853i32;
                    };
                } else if (__value__ == (3976833i32)) {
                    _gotoNext = 3977170i32;
                } else if (__value__ == (3976853i32)) {
                    if (((_n_15 : stdgo.GoUInt64) >= (_text.length : stdgo.GoUInt64) : Bool)) {
                        _gotoNext = 3976887i32;
                    } else {
                        _gotoNext = 3976972i32;
                    };
                } else if (__value__ == (3976887i32)) {
                    _gotoNext = 3977211i32;
                } else if (__value__ == (3976972i32)) {
                    ...
                    _i_19 = (0 : stdgo.GoInt);
                    _gotoNext = 3977074i32;
                    {
                        _gotoNext = 3976972i32;
                    };
                } else if (__value__ == (3977074i32)) {
                    if ((_i_19 < _n_16 : Bool)) {
                        _gotoNext = 3977097i32;
                    } else {
                        _gotoNext = 3977155i32;
                    };
                } else if (__value__ == (3977093i32)) {
                    _i_19++;
                    _gotoNext = 3977074i32;
                } else if (__value__ == (3977097i32)) {
                    if (_this_17[(_i_19 : stdgo.GoInt)] != (_last_18[(_i_19 : stdgo.GoInt)])) {
                        _gotoNext = 3977125i32;
                    } else {
                        _gotoNext = 3977093i32;
                    };
                } else if (__value__ == (3977125i32)) {
                    _gotoNext = 3977170i32;
                } else if (__value__ == (3977155i32)) {
                    _gotoNext = 3977211i32;
                } else if (__value__ == (3977170i32)) {
                    _gotoNext = 3977170i32;
                    _id_10++;
                    _lastPos_12 = _j_14;
                    _lastLen_11 = _n_15;
                    _gotoNext = 3977211i32;
                } else if (__value__ == (3977211i32)) {
                    _sa[((_j_14 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)] = (_id_10 : stdgo.GoInt64);
                    _i_3976688_13++;
                    _gotoNext = 3977240i32;
                } else if (__value__ == (3977239i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(0i32 : stdgo.GoInt)];
                        _i_3976688_13 = __tmp__0;
                        _j_14 = __tmp__1;
                    };
                    _gotoNext = 3977240i32;
                } else if (__value__ == (3977240i32)) {
                    if (_i_3976688_13 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 3976714i32;
                    } else {
                        _gotoNext = 3977243i32;
                    };
                } else if (__value__ == (3977243i32)) {
                    return _id_10;
                    _gotoNext = -1i32;
                };
            };
