...
function _assignID_8_64(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt64>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _i_4230529_13:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4231080i32;
                    } else {
                        _gotoNext = 4231084i32;
                    };
                } else if (__value__ == (4230555i32)) {
                    _j_14 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(_i_4230529_13 : stdgo.GoInt)];
                    _n_15 = _sa[((_j_14 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)];
                    if (_n_15 != (_lastLen_11)) {
                        _gotoNext = 4230674i32;
                    } else {
                        _gotoNext = 4230694i32;
                    };
                } else if (__value__ == (4230674i32)) {
                    _gotoNext = 4231011i32;
                } else if (__value__ == (4230694i32)) {
                    if (((_n_15 : stdgo.GoUInt64) >= (_text.length : stdgo.GoUInt64) : Bool)) {
                        _gotoNext = 4230728i32;
                    } else {
                        _gotoNext = 4230813i32;
                    };
                } else if (__value__ == (4230728i32)) {
                    _gotoNext = 4231052i32;
                } else if (__value__ == (4230813i32)) {
                    ...
                    _i_19 = (0 : stdgo.GoInt);
                    _gotoNext = 4230915i32;
                    {
                        _gotoNext = 4230813i32;
                    };
                } else if (__value__ == (4230915i32)) {
                    if ((_i_19 < _n_16 : Bool)) {
                        _gotoNext = 4230938i32;
                    } else {
                        _gotoNext = 4230996i32;
                    };
                } else if (__value__ == (4230934i32)) {
                    _i_19++;
                    _gotoNext = 4230915i32;
                } else if (__value__ == (4230938i32)) {
                    if (_this_17[(_i_19 : stdgo.GoInt)] != (_last_18[(_i_19 : stdgo.GoInt)])) {
                        _gotoNext = 4230966i32;
                    } else {
                        _gotoNext = 4230934i32;
                    };
                } else if (__value__ == (4230966i32)) {
                    _gotoNext = 4231011i32;
                } else if (__value__ == (4230996i32)) {
                    _gotoNext = 4231052i32;
                } else if (__value__ == (4231011i32)) {
                    _gotoNext = 4231011i32;
                    _id_10++;
                    _lastPos_12 = _j_14;
                    _lastLen_11 = _n_15;
                    _gotoNext = 4231052i32;
                } else if (__value__ == (4231052i32)) {
                    _sa[((_j_14 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)] = (_id_10 : stdgo.GoInt64);
                    _i_4230529_13++;
                    _gotoNext = 4231081i32;
                } else if (__value__ == (4231080i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(0i32 : stdgo.GoInt)];
                        _i_4230529_13 = @:binopAssign __tmp__0;
                        _j_14 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4231081i32;
                } else if (__value__ == (4231081i32)) {
                    if (_i_4230529_13 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4230555i32;
                    } else {
                        _gotoNext = 4231084i32;
                    };
                } else if (__value__ == (4231084i32)) {
                    return _id_10;
                    _gotoNext = -1i32;
                };
            };
