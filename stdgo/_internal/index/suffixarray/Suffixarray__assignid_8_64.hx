            ...
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    ...
                    if ((0i64 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 3975574i64;
                    } else {
                        _gotoNext = 3975578i64;
                    };
                } else if (__value__ == (3975049i64)) {
                    ...
                    if (_n_15 != (_lastLen_11)) {
                        _gotoNext = 3975168i64;
                    } else {
                        _gotoNext = 3975188i64;
                    };
                } else if (__value__ == (3975168i64)) {
                    _gotoNext = 3975505i64;
                } else if (__value__ == (3975188i64)) {
                    ...
                    if (((_n_15 : stdgo.GoUInt64) >= (_text.length : stdgo.GoUInt64) : Bool)) {
                        _gotoNext = 3975222i64;
                    } else {
                        _gotoNext = 3975307i64;
                    };
                } else if (__value__ == (3975222i64)) {
                    _gotoNext = 3975546i64;
                } else if (__value__ == (3975307i64)) {
                    ...
                    _i_19 = (0 : stdgo.GoInt);
                    _gotoNext = 3975409i64;
                    //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais2.go#L1088"
                    {
                        _gotoNext = 3975307i64;
                    };
                } else if (__value__ == (3975409i64)) {
                    //"file://#L0"
                    if ((_i_19 < _n_16 : Bool)) {
                        _gotoNext = 3975432i64;
                    } else {
                        _gotoNext = 3975490i64;
                    };
                } else if (__value__ == (3975428i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais2.go#L1093"
                    _i_19++;
                    _gotoNext = 3975409i64;
                } else if (__value__ == (3975432i64)) {
                    ...
                    if (_this_17[(_i_19 : stdgo.GoInt)] != (_last_18[(_i_19 : stdgo.GoInt)])) {
                        _gotoNext = 3975460i64;
                    } else {
                        _gotoNext = 3975428i64;
                    };
                } else if (__value__ == (3975460i64)) {
                    _gotoNext = 3975505i64;
                } else if (__value__ == (3975490i64)) {
                    _gotoNext = 3975546i64;
                } else if (__value__ == (3975505i64)) {
                    _gotoNext = 3975505i64;
