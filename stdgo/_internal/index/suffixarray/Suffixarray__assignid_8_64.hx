...
function _assignID_8_64(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt64>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _i_4184987_13:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4185538i32;
                    } else {
                        _gotoNext = 4185542i32;
                    };
                } else if (__value__ == (4185013i32)) {
                    _j_14 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(_i_4184987_13 : stdgo.GoInt)];
                    _n_15 = _sa[((_j_14 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)];
                    if (_n_15 != (_lastLen_11)) {
                        _gotoNext = 4185132i32;
                    } else {
                        _gotoNext = 4185152i32;
                    };
                } else if (__value__ == (4185132i32)) {
                    _gotoNext = 4185469i32;
                } else if (__value__ == (4185152i32)) {
                    if (((_n_15 : stdgo.GoUInt64) >= (_text.length : stdgo.GoUInt64) : Bool)) {
                        _gotoNext = 4185186i32;
                    } else {
                        _gotoNext = 4185271i32;
                    };
                } else if (__value__ == (4185186i32)) {
                    _gotoNext = 4185510i32;
                } else if (__value__ == (4185271i32)) {
                    ...
                    _i_19 = (0 : stdgo.GoInt);
                    _gotoNext = 4185373i32;
                    {
                        _gotoNext = 4185271i32;
                    };
                } else if (__value__ == (4185373i32)) {
                    if ((_i_19 < _n_16 : Bool)) {
                        _gotoNext = 4185396i32;
                    } else {
                        _gotoNext = 4185454i32;
                    };
                } else if (__value__ == (4185392i32)) {
                    _i_19++;
                    _gotoNext = 4185373i32;
                } else if (__value__ == (4185396i32)) {
                    if (_this_17[(_i_19 : stdgo.GoInt)] != (_last_18[(_i_19 : stdgo.GoInt)])) {
                        _gotoNext = 4185424i32;
                    } else {
                        _gotoNext = 4185392i32;
                    };
                } else if (__value__ == (4185424i32)) {
                    _gotoNext = 4185469i32;
                } else if (__value__ == (4185454i32)) {
                    _gotoNext = 4185510i32;
                } else if (__value__ == (4185469i32)) {
                    _gotoNext = 4185469i32;
                    _id_10++;
                    _lastPos_12 = _j_14;
                    _lastLen_11 = _n_15;
                    _gotoNext = 4185510i32;
                } else if (__value__ == (4185510i32)) {
                    _sa[((_j_14 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)] = (_id_10 : stdgo.GoInt64);
                    _i_4184987_13++;
                    _gotoNext = 4185539i32;
                } else if (__value__ == (4185538i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(0i32 : stdgo.GoInt)];
                        _i_4184987_13 = __tmp__0;
                        _j_14 = __tmp__1;
                    };
                    _gotoNext = 4185539i32;
                } else if (__value__ == (4185539i32)) {
                    if (_i_4184987_13 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4185013i32;
                    } else {
                        _gotoNext = 4185542i32;
                    };
                } else if (__value__ == (4185542i32)) {
                    return _id_10;
                    _gotoNext = -1i32;
                };
            };
