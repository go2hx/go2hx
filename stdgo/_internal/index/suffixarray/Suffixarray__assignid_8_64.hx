...
function _assignID_8_64(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt64>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _iterator_4188033_13:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i64;
            ...
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    ...
                    if ((0i64 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4188584i64;
                    } else {
                        _gotoNext = 4188588i64;
                    };
                } else if (__value__ == (4188059i64)) {
                    _j_14 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(_iterator_4188033_13 : stdgo.GoInt)];
                    ...
                    if (_n_15 != (_lastLen_11)) {
                        _gotoNext = 4188178i64;
                    } else {
                        _gotoNext = 4188198i64;
                    };
                } else if (__value__ == (4188178i64)) {
                    _gotoNext = 4188515i64;
                } else if (__value__ == (4188198i64)) {
                    ...
                    if (((_n_15 : stdgo.GoUInt64) >= (_text.length : stdgo.GoUInt64) : Bool)) {
                        _gotoNext = 4188232i64;
                    } else {
                        _gotoNext = 4188317i64;
                    };
                } else if (__value__ == (4188232i64)) {
                    _gotoNext = 4188556i64;
                } else if (__value__ == (4188317i64)) {
                    ...
                    _i_19 = (0 : stdgo.GoInt);
                    _gotoNext = 4188419i64;
                    //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais2.go#L1088"
                    {
                        _gotoNext = 4188317i64;
                    };
                } else if (__value__ == (4188419i64)) {
                    //"file://#L0"
                    if ((_i_19 < _n_16 : Bool)) {
                        _gotoNext = 4188442i64;
                    } else {
                        _gotoNext = 4188500i64;
                    };
                } else if (__value__ == (4188438i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais2.go#L1093"
                    _i_19++;
                    _gotoNext = 4188419i64;
                } else if (__value__ == (4188442i64)) {
                    ...
                    if (_this_17[(_i_19 : stdgo.GoInt)] != (_last_18[(_i_19 : stdgo.GoInt)])) {
                        _gotoNext = 4188470i64;
                    } else {
                        _gotoNext = 4188438i64;
                    };
                } else if (__value__ == (4188470i64)) {
                    _gotoNext = 4188515i64;
                } else if (__value__ == (4188500i64)) {
                    _gotoNext = 4188556i64;
                } else if (__value__ == (4188515i64)) {
                    _gotoNext = 4188515i64;
                    ...
                    _lastLen_11 = _n_15;
                    _gotoNext = 4188556i64;
                } else if (__value__ == (4188556i64)) {
                    _sa[((_j_14 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)] = (_id_10 : stdgo.GoInt64);
                    //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais2.go#L1078"
                    _iterator_4188033_13++;
                    _gotoNext = 4188585i64;
                } else if (__value__ == (4188584i64)) {
                    {
                        final __tmp__0 = 0i64;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(0i64 : stdgo.GoInt)];
                        _iterator_4188033_13 = @:binopAssign __tmp__0;
                        _j_14 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4188585i64;
                } else if (__value__ == (4188585i64)) {
                    //"file://#L0"
                    if (_iterator_4188033_13 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4188059i64;
                    } else {
                        _gotoNext = 4188588i64;
                    };
                } else if (__value__ == (4188588i64)) {
