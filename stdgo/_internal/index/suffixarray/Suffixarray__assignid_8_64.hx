...
function _assignID_8_64(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt64>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _i_4203064_13:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4203615i32;
                    } else {
                        _gotoNext = 4203619i32;
                    };
                } else if (__value__ == (4203090i32)) {
                    _j_14 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(_i_4203064_13 : stdgo.GoInt)];
                    _n_15 = _sa[((_j_14 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)];
                    if (_n_15 != (_lastLen_11)) {
                        _gotoNext = 4203209i32;
                    } else {
                        _gotoNext = 4203229i32;
                    };
                } else if (__value__ == (4203209i32)) {
                    _gotoNext = 4203546i32;
                } else if (__value__ == (4203229i32)) {
                    if (((_n_15 : stdgo.GoUInt64) >= (_text.length : stdgo.GoUInt64) : Bool)) {
                        _gotoNext = 4203263i32;
                    } else {
                        _gotoNext = 4203348i32;
                    };
                } else if (__value__ == (4203263i32)) {
                    _gotoNext = 4203587i32;
                } else if (__value__ == (4203348i32)) {
                    ...
                    _i_19 = (0 : stdgo.GoInt);
                    _gotoNext = 4203450i32;
                    {
                        _gotoNext = 4203348i32;
                    };
                } else if (__value__ == (4203450i32)) {
                    if ((_i_19 < _n_16 : Bool)) {
                        _gotoNext = 4203473i32;
                    } else {
                        _gotoNext = 4203531i32;
                    };
                } else if (__value__ == (4203469i32)) {
                    _i_19++;
                    _gotoNext = 4203450i32;
                } else if (__value__ == (4203473i32)) {
                    if (_this_17[(_i_19 : stdgo.GoInt)] != (_last_18[(_i_19 : stdgo.GoInt)])) {
                        _gotoNext = 4203501i32;
                    } else {
                        _gotoNext = 4203469i32;
                    };
                } else if (__value__ == (4203501i32)) {
                    _gotoNext = 4203546i32;
                } else if (__value__ == (4203531i32)) {
                    _gotoNext = 4203587i32;
                } else if (__value__ == (4203546i32)) {
                    _gotoNext = 4203546i32;
                    _id_10++;
                    _lastPos_12 = _j_14;
                    _lastLen_11 = _n_15;
                    _gotoNext = 4203587i32;
                } else if (__value__ == (4203587i32)) {
                    _sa[((_j_14 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)] = (_id_10 : stdgo.GoInt64);
                    _i_4203064_13++;
                    _gotoNext = 4203616i32;
                } else if (__value__ == (4203615i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(0i32 : stdgo.GoInt)];
                        _i_4203064_13 = @:binopAssign __tmp__0;
                        _j_14 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4203616i32;
                } else if (__value__ == (4203616i32)) {
                    if (_i_4203064_13 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4203090i32;
                    } else {
                        _gotoNext = 4203619i32;
                    };
                } else if (__value__ == (4203619i32)) {
                    return _id_10;
                    _gotoNext = -1i32;
                };
            };
