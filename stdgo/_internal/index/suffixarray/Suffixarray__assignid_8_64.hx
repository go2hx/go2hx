...
function _assignID_8_64(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt64>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        var _i_3993261_13:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        ...
                        _gotoNext = 3993816i32;
                    };
                } else if (__value__ == (3993287i32)) {
                    _j_14 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(_i_3993261_13 : stdgo.GoInt)];
                    _n_15 = _sa[((_j_14 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)];
                    if (_n_15 != (_lastLen_11)) {
                        _gotoNext = 3993406i32;
                    } else {
                        _gotoNext = 3993426i32;
                    };
                } else if (__value__ == (3993406i32)) {
                    _gotoNext = 3993743i32;
                } else if (__value__ == (3993426i32)) {
                    if (((_n_15 : stdgo.GoUInt64) >= (_text.length : stdgo.GoUInt64) : Bool)) {
                        _gotoNext = 3993460i32;
                    } else {
                        _gotoNext = 3993545i32;
                    };
                } else if (__value__ == (3993460i32)) {
                    _gotoNext = 3993784i32;
                } else if (__value__ == (3993545i32)) {
                    ...
                    _i_19 = (0 : stdgo.GoInt);
                    _gotoNext = 3993647i32;
                    {
                        _gotoNext = 3993545i32;
                    };
                } else if (__value__ == (3993647i32)) {
                    if ((_i_19 < _n_16 : Bool)) {
                        _gotoNext = 3993670i32;
                    } else {
                        _gotoNext = 3993728i32;
                    };
                } else if (__value__ == (3993666i32)) {
                    _i_19++;
                    _gotoNext = 3993647i32;
                } else if (__value__ == (3993670i32)) {
                    if (_this_17[(_i_19 : stdgo.GoInt)] != (_last_18[(_i_19 : stdgo.GoInt)])) {
                        _gotoNext = 3993698i32;
                    } else {
                        _gotoNext = 3993666i32;
                    };
                } else if (__value__ == (3993698i32)) {
                    _gotoNext = 3993743i32;
                } else if (__value__ == (3993728i32)) {
                    _gotoNext = 3993784i32;
                } else if (__value__ == (3993743i32)) {
                    _gotoNext = 3993743i32;
                    _id_10++;
                    _lastPos_12 = _j_14;
                    _lastLen_11 = _n_15;
                    _gotoNext = 3993784i32;
                } else if (__value__ == (3993784i32)) {
                    _sa[((_j_14 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)] = (_id_10 : stdgo.GoInt64);
                    _i_3993261_13++;
                    _gotoNext = 3993813i32;
                } else if (__value__ == (3993812i32)) {
                    {
                        ...
                        _i_3993261_13 = @:binopAssign __tmp__0;
                        _j_14 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 3993813i32;
                } else if (__value__ == (3993813i32)) {
                    if (_i_3993261_13 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 3993287i32;
                    } else {
                        _gotoNext = 3993816i32;
                    };
                } else if (__value__ == (3993816i32)) {
                    return _id_10;
                    _gotoNext = -1i32;
                };
            };
