            ...
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    ...
                    if ((0i64 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4202225i64;
                    } else {
                        _gotoNext = 4202229i64;
                    };
                } else if (__value__ == (4201700i64)) {
                    ...
                    if (_n_15 != (_lastLen_11)) {
                        _gotoNext = 4201819i64;
                    } else {
                        _gotoNext = 4201839i64;
                    };
                } else if (__value__ == (4201819i64)) {
                    _gotoNext = 4202156i64;
                } else if (__value__ == (4201839i64)) {
                    ...
                    if (((_n_15 : stdgo.GoUInt64) >= (_text.length : stdgo.GoUInt64) : Bool)) {
                        _gotoNext = 4201873i64;
                    } else {
                        _gotoNext = 4201958i64;
                    };
                } else if (__value__ == (4201873i64)) {
                    _gotoNext = 4202197i64;
                } else if (__value__ == (4201958i64)) {
                    ...
                    _i_19 = (0 : stdgo.GoInt);
                    _gotoNext = 4202060i64;
                    //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais2.go#L1088"
                    {
                        _gotoNext = 4201958i64;
                    };
                } else if (__value__ == (4202060i64)) {
                    //"file://#L0"
                    if ((_i_19 < _n_16 : Bool)) {
                        _gotoNext = 4202083i64;
                    } else {
                        _gotoNext = 4202141i64;
                    };
                } else if (__value__ == (4202079i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais2.go#L1093"
                    _i_19++;
                    _gotoNext = 4202060i64;
                } else if (__value__ == (4202083i64)) {
                    ...
                    if (_this_17[(_i_19 : stdgo.GoInt)] != (_last_18[(_i_19 : stdgo.GoInt)])) {
                        _gotoNext = 4202111i64;
                    } else {
                        _gotoNext = 4202079i64;
                    };
                } else if (__value__ == (4202111i64)) {
                    _gotoNext = 4202156i64;
                } else if (__value__ == (4202141i64)) {
                    _gotoNext = 4202197i64;
                } else if (__value__ == (4202156i64)) {
                    _gotoNext = 4202156i64;
