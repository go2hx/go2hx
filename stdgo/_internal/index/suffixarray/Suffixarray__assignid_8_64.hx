...
function _assignID_8_64(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt64>, _numLMS:stdgo.GoInt):stdgo.GoInt {
        ...
        var _i_4000200_13:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4000751i32;
                    } else {
                        _gotoNext = 4000755i32;
                    };
                } else if (__value__ == (4000226i32)) {
                    _j_14 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(_i_4000200_13 : stdgo.GoInt)];
                    _n_15 = _sa[((_j_14 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)];
                    if (_n_15 != (_lastLen_11)) {
                        _gotoNext = 4000345i32;
                    } else {
                        _gotoNext = 4000365i32;
                    };
                } else if (__value__ == (4000345i32)) {
                    _gotoNext = 4000682i32;
                } else if (__value__ == (4000365i32)) {
                    if (((_n_15 : stdgo.GoUInt64) >= (_text.length : stdgo.GoUInt64) : Bool)) {
                        _gotoNext = 4000399i32;
                    } else {
                        _gotoNext = 4000484i32;
                    };
                } else if (__value__ == (4000399i32)) {
                    _gotoNext = 4000723i32;
                } else if (__value__ == (4000484i32)) {
                    ...
                    _i_19 = (0 : stdgo.GoInt);
                    _gotoNext = 4000586i32;
                    {
                        _gotoNext = 4000484i32;
                    };
                } else if (__value__ == (4000586i32)) {
                    if ((_i_19 < _n_16 : Bool)) {
                        _gotoNext = 4000609i32;
                    } else {
                        _gotoNext = 4000667i32;
                    };
                } else if (__value__ == (4000605i32)) {
                    _i_19++;
                    _gotoNext = 4000586i32;
                } else if (__value__ == (4000609i32)) {
                    if (_this_17[(_i_19 : stdgo.GoInt)] != (_last_18[(_i_19 : stdgo.GoInt)])) {
                        _gotoNext = 4000637i32;
                    } else {
                        _gotoNext = 4000605i32;
                    };
                } else if (__value__ == (4000637i32)) {
                    _gotoNext = 4000682i32;
                } else if (__value__ == (4000667i32)) {
                    _gotoNext = 4000723i32;
                } else if (__value__ == (4000682i32)) {
                    _gotoNext = 4000682i32;
                    _id_10++;
                    _lastPos_12 = _j_14;
                    _lastLen_11 = _n_15;
                    _gotoNext = 4000723i32;
                } else if (__value__ == (4000723i32)) {
                    _sa[((_j_14 / (2i64 : stdgo.GoInt64) : stdgo.GoInt64) : stdgo.GoInt)] = (_id_10 : stdgo.GoInt64);
                    _i_4000200_13++;
                    _gotoNext = 4000752i32;
                } else if (__value__ == (4000751i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = (_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>)[(0i32 : stdgo.GoInt)];
                        _i_4000200_13 = @:binopAssign __tmp__0;
                        _j_14 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 4000752i32;
                } else if (__value__ == (4000752i32)) {
                    if (_i_4000200_13 < ((_sa.__slice__(((_sa.length) - _numLMS : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt64>).length)) {
                        _gotoNext = 4000226i32;
                    } else {
                        _gotoNext = 4000755i32;
                    };
                } else if (__value__ == (4000755i32)) {
                    return _id_10;
                    _gotoNext = -1i32;
                };
            };
