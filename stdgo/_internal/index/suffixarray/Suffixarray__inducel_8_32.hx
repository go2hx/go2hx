...
function _induceL_8_32(_text:stdgo.Slice<stdgo.GoUInt8>, _sa:stdgo.Slice<stdgo.GoInt32>, _freq:stdgo.Slice<stdgo.GoInt32>, _bucket:stdgo.Slice<stdgo.GoInt32>):Void {
        //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L797"
...
var _c1 = __1, _c0 = __0;
        //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L812"
        if ((_c0 < _c1 : Bool)) {
            _k = -_k;
        };
        ...
        //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L820"
        _b++;
        //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L822"
        {
            var _i = (0 : stdgo.GoInt);
            while ((_i < (_sa.length) : Bool)) {
                var _j = (_sa[(_i : stdgo.GoInt)] : stdgo.GoInt);
//"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L824"
                if ((_j <= (0 : stdgo.GoInt) : Bool)) {
                    //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L826"
                    {
                        _i++;
                        continue;
                    };
...
//"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L840"
                if ((_k > (0 : stdgo.GoInt) : Bool)) {
                    //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L841"
                    {
...
//"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L846"
                if (_cB != (_c1)) {
...
_sa[(_b : stdgo.GoInt)] = (_k : stdgo.GoInt32);
//"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L852"
                _b++;
                _i++;
            };
        };
