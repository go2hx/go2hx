...
var _text = __2, _saTmp = __1, _dst = __0;
        var _tmp = _oldTmp;
        //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L698"
        if (((_tmp.length) < (_saTmp.length) : Bool)) {
            _tmp = _saTmp;
        };
        //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L701"
        if (((_tmp.length) < _numLMS : Bool)) {
            var _n = (_maxID : stdgo.GoInt);
            //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L704"
        ...
        //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L713"
        for (_i => _ in _dst) {
            _dst[(_i : stdgo.GoInt)] = (0 : stdgo.GoInt32);
        };
        //"file:///home/runner/.go/go1.21.3/src/index/suffixarray/sais.go#L716"
