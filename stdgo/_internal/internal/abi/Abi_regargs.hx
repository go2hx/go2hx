...
@:structInit @:using(stdgo._internal.internal.abi.Abi_regargs_static_extension.RegArgs_static_extension) class RegArgs {
    public var ints : stdgo.GoArray<stdgo.GoUIntptr> = new stdgo.GoArray<stdgo.GoUIntptr>(0, 0).__setNil__();
    public var floats : stdgo.GoArray<stdgo.GoUInt64> = new stdgo.GoArray<stdgo.GoUInt64>(0, 0).__setNumber64__().__setNil__();
    public var ptrs : stdgo.GoArray<stdgo._internal.unsafe.Unsafe.UnsafePointer> = new stdgo.GoArray<stdgo._internal.unsafe.Unsafe.UnsafePointer>(0, 0).__setNil__();
