...
@:structInit @:using(stdgo._internal.internal.bisect.Bisect_t_dedup_static_extension.T_dedup_static_extension) class T_dedup {
    public var _recent : stdgo.GoArray<stdgo.GoArray<stdgo.GoUInt64>> = new stdgo.GoArray<stdgo.GoArray<stdgo.GoUInt64>>(128, 128, ...[for (i in 0 ... (128 > 128 ? 128 : 128 : stdgo.GoInt).toBasic()) new stdgo.GoArray<stdgo.GoUInt64>(4, 4).__setNumber64__().__setNil__()]).__setNil__();
