...
function hashFuncDesc(_f:stdgo.Ref<stdgo._internal.internal.coverage.Coverage_funcdesc.FuncDesc>):stdgo.GoArray<stdgo.GoUInt8> {
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/coverage/encodemeta/encode.go#L193"
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/coverage/encodemeta/encode.go#L195"
        (_r.__slice__(0) : stdgo.Slice<stdgo.GoUInt8>).__copyTo__(_h.sum((null : stdgo.Slice<stdgo.GoUInt8>)));
        //"file:///home/runner/.go/go1.21.3/src/internal/coverage/encodemeta/encode.go#L196"
        return _r?.__copy__();
    }
