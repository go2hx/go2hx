...
function _collectPodsImpl(_files:stdgo.Slice<stdgo.GoString>, _dirIndices:stdgo.Slice<stdgo.GoInt>, _warn:Bool):stdgo.Slice<stdgo._internal.internal.coverage.pods.Pods_pod.Pod> {
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L122"
        for (__0 => _f in _files) {
            var _base = (stdgo._internal.path.filepath.Filepath_base.base(_f?.__copy__())?.__copy__() : stdgo.GoString);
            //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L124"
            {
                var _m = _metaRE.findStringSubmatch(_base?.__copy__());
                if (_m != null) {
                    var _tag = (_m[(1 : stdgo.GoInt)]?.__copy__() : stdgo.GoString);
                    //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L129"
                    {
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L137"
        for (_k => _f in _files) {
            var _base = (stdgo._internal.path.filepath.Filepath_base.base(_f?.__copy__())?.__copy__() : stdgo.GoString);
            //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L139"
            {
                var _m = _counterRE.findStringSubmatch(_base?.__copy__());
                if (_m != null) {
                    var _tag = (_m[(1 : stdgo.GoInt)]?.__copy__() : stdgo.GoString);
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L142"
                    if (_err != null) {
                        //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L143"
                        continue;
                    };
                    //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L145"
                    {
                        ...
                        if (_ok) {
                            ...
                            //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L147"
                            if (_dirIndices != null) {
                            ...
                            //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L154"
                            if (_warn) {
                                //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L155"
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L160"
        if ((_mm.length) == ((0 : stdgo.GoInt))) {
            //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L161"
            if (_warn) {
                //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L162"
                stdgo._internal.internal.coverage.pods.Pods__warning._warning(("no coverage data files found" : stdgo.GoString));
            };
            //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L164"
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L167"
        for (__1 => _p in _mm) {
            //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L168"
            stdgo._internal.sort.Sort_slice.slice(stdgo.Go.toInterface(_p._elements), function(_i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
                //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L169"
                if (_p._elements[(_i : stdgo.GoInt)]._origin != (_p._elements[(_j : stdgo.GoInt)]._origin)) {
                    //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L170"
                    return (_p._elements[(_i : stdgo.GoInt)]._origin < _p._elements[(_j : stdgo.GoInt)]._origin : Bool);
                };
                //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L172"
            ...
            //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L180"
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L187"
        stdgo._internal.sort.Sort_slice.slice(stdgo.Go.toInterface(_pods), function(_i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
            //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L188"
            return (_pods[(_i : stdgo.GoInt)].metaFile < _pods[(_j : stdgo.GoInt)].metaFile : Bool);
        });
        //"file:///home/runner/.go/go1.21.3/src/internal/coverage/pods/pods.go#L190"
        return _pods;
    }
