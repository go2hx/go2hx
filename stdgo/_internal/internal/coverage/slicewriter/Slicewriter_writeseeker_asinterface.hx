...
class WriteSeeker_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function bytesWritten():stdgo.Slice<stdgo.GoUInt8> return @:_0 __self__.value.bytesWritten();
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.internal.coverage.slicewriter.Slicewriter_writeseekerpointer.WriteSeekerPointer;
