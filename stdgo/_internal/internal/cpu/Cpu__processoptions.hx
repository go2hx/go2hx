...
function _processOptions(_env:stdgo.GoString):Void {
        var _i_6345_7:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _o_8 = stdgo._internal.internal.cpu.Cpu__options._options[(_i_6345_7 : stdgo.GoInt)];
                    if (!_o_8.specified) {
                        _gotoNext = 6379i32;
                    } else {
                        _gotoNext = 6400i32;
                ...
                } else if (__value__ == (6546i32)) {
                    {
                        ...
                        _i_6345_7 = @:binopAssign __tmp__0;
                        _o_8 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 6547i32;
                } else if (__value__ == (6547i32)) {
                    if (_i_6345_7 < (stdgo._internal.internal.cpu.Cpu__options._options.length)) {
                        _gotoNext = 6359i32;
                    } else {
                        _gotoNext = 6549i32;
                    };
