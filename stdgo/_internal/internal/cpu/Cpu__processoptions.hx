        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _o_8 = stdgo._internal.internal.cpu.Cpu__options._options[(_i_6566_7 : stdgo.GoInt)];
                    if (!_o_8.specified) {
                        _gotoNext = 6600i32;
                    } else {
                        _gotoNext = 6621i32;
                ...
                } else if (__value__ == (6767i32)) {
                    {
                        ...
                        _i_6566_7 = @:binopAssign __tmp__0;
                        _o_8 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 6768i32;
                } else if (__value__ == (6768i32)) {
                    if (_i_6566_7 < (stdgo._internal.internal.cpu.Cpu__options._options.length)) {
                        _gotoNext = 6580i32;
                    } else {
                        _gotoNext = 6770i32;
                    };
