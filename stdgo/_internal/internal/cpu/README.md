...
- [`function _indexByte(_s:stdgo.GoString, _c:stdgo.GoUInt8):stdgo.GoInt`](<#function-_indexbyte>)
...
```haxe
import stdgo._internal.internal.cpu.Cpu_x86
```
...
[\(view code\)](<./Cpu_CacheLinePad.hx#L5>)
