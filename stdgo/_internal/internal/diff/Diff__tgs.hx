...
function _tgs(_x:stdgo.Slice<stdgo.GoString>, _y:stdgo.Slice<stdgo.GoString>):stdgo.Slice<stdgo._internal.internal.diff.Diff_t_pair.T_pair> {
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/diff/diff.go#L195"
        for (__0 => _s in _x) {
            //"file:///home/runner/.go/go1.21.3/src/internal/diff/diff.go#L196"
            {
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/diff/diff.go#L200"
        for (__1 => _s in _y) {
            //"file:///home/runner/.go/go1.21.3/src/internal/diff/diff.go#L201"
            {
                var _c = (_m[_s] ?? (0 : stdgo.GoInt) : stdgo.GoInt);
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/diff/diff.go#L213"
        for (_i => _s in _y) {
            //"file:///home/runner/.go/go1.21.3/src/internal/diff/diff.go#L214"
            if ((_m[_s] ?? (0 : stdgo.GoInt)) == ((-5 : stdgo.GoInt))) {
                _m[_s] = (_yi.length);
                _yi = (_yi.__append__(_i) : stdgo.Slice<stdgo.GoInt>);
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/internal/diff/diff.go#L219"
        for (_i => _s in _x) {
            //"file:///home/runner/.go/go1.21.3/src/internal/diff/diff.go#L220"
            {
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/diff/diff.go#L234"
        for (_i => _ in t) {
            t[(_i : stdgo.GoInt)] = (_n + (1 : stdgo.GoInt) : stdgo.GoInt);
        };
        //"file:///home/runner/.go/go1.21.3/src/internal/diff/diff.go#L237"
        {
            var _i = (0 : stdgo.GoInt);
            while ((_i < _n : Bool)) {
                var _k = (stdgo._internal.sort.Sort_search.search(_n, function(_k:stdgo.GoInt):Bool {
                    //"file:///home/runner/.go/go1.21.3/src/internal/diff/diff.go#L239"
...
l[(_i : stdgo.GoInt)] = (_k + (1 : stdgo.GoInt) : stdgo.GoInt);
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/diff/diff.go#L245"
        for (__2 => _v in l) {
            //"file:///home/runner/.go/go1.21.3/src/internal/diff/diff.go#L246"
            if ((_k < _v : Bool)) {
                _k = _v;
            };
        };
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/diff/diff.go#L253"
        {
            var _i = (_n - (1 : stdgo.GoInt) : stdgo.GoInt);
            while ((_i >= (0 : stdgo.GoInt) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/internal/diff/diff.go#L254"
                if (((l[(_i : stdgo.GoInt)] == _k) && (j[(_i : stdgo.GoInt)] < _lastj : Bool) : Bool)) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/internal/diff/diff.go#L256"
                    _k--;
                };
                _i--;
            };
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/diff/diff.go#L260"
        return _seq;
    }
