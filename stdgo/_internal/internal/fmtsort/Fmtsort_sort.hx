...
function sort(_mapValue:stdgo._internal.reflect.Reflect_value.Value):stdgo.Ref<stdgo._internal.internal.fmtsort.Fmtsort_sortedmap.SortedMap> {
        ...
        while (@:check2r _iter.next()) {
            _key = (_key.__append__(@:check2r _iter.key()?.__copy__()) : stdgo.Slice<stdgo._internal.reflect.Reflect_value.Value>);
            _value = (_value.__append__(@:check2r _iter.value()?.__copy__()) : stdgo.Slice<stdgo._internal.reflect.Reflect_value.Value>);
        };
