...
var _sortTests : stdgo.Slice<stdgo._internal.internal.fmtsort_test.Fmtsort_test.T_sortTest> = (new stdgo.Slice<stdgo._internal.internal.fmtsort_test.Fmtsort_test.T_sortTest>(
11,
11,
...
(new stdgo._internal.internal.fmtsort_test.Fmtsort_test.T_sortTest(stdgo.Go.toInterface(({
        ...
        x.__defaultValue__ = () -> ("" : stdgo.GoString);
        @:mergeBlock {
            x.set((new stdgo.GoArray<stdgo.GoInt>((7 : stdgo.GoInt), (2 : stdgo.GoInt)) : stdgo.GoArray<stdgo.GoInt>), ("72" : stdgo.GoString));
            x.set((new stdgo.GoArray<stdgo.GoInt>((7 : stdgo.GoInt), (1 : stdgo.GoInt)) : stdgo.GoArray<stdgo.GoInt>), ("71" : stdgo.GoString));
            x.set((new stdgo.GoArray<stdgo.GoInt>((3 : stdgo.GoInt), (4 : stdgo.GoInt)) : stdgo.GoArray<stdgo.GoInt>), ("34" : stdgo.GoString));
        };
        cast x;
...
function testCompare(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        for (__0 => _test in _compareTests) {
            for (_i => _v0 in _test) {
                for (_j => _v1 in _test) {
                    var _c:stdgo.GoInt = stdgo._internal.internal.fmtsort.Fmtsort.compare(_v0?.__copy__(), _v1?.__copy__());
                    var _expect:stdgo.GoInt = (0 : stdgo.GoInt);
                    if (_i == (_j)) {
                        _expect = (0 : stdgo.GoInt);
                        {
                            var _typ:stdgo._internal.reflect.Reflect.Type_ = _v0.type();
                            if (((_typ.kind() == (13u32 : stdgo._internal.reflect.Reflect.Kind)) || (_typ.kind() == (14u32 : stdgo._internal.reflect.Reflect.Kind))) && stdgo._internal.math.Math.isNaN(_v0.float_())) {
...
function _sprintKey(_key:stdgo._internal.reflect.Reflect.Value):stdgo.GoString {
        {
            var _str:stdgo.GoString = (_key.type().string() : stdgo.GoString)?.__copy__();
            {
                ...
                if (__value__ == (("*int" : stdgo.GoString))) {
                    ...
                    var _ptr:stdgo._internal.unsafe.Unsafe.UnsafePointer = (stdgo.Go.typeAssert((_key.interface_() : stdgo._internal.unsafe.Unsafe.UnsafePointer)) : stdgo._internal.unsafe.Unsafe.UnsafePointer);
                    for (_i => _ in _ints) {
...
function testInterface(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        var _m = ({
            ...
            x.__defaultValue__ = () -> ("" : stdgo.GoString);
            @:mergeBlock {
                x.set(stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoInt>((1 : stdgo.GoInt), (0 : stdgo.GoInt)) : stdgo.GoArray<stdgo.GoInt>)), stdgo.Go.str());
                x.set(stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoInt>((0 : stdgo.GoInt), (1 : stdgo.GoInt)) : stdgo.GoArray<stdgo.GoInt>)), stdgo.Go.str());
