...
function _get(_k:stdgo._internal.internal.intern.Intern_t_key.T_key):stdgo.Ref<stdgo._internal.internal.intern.Intern_value.Value> {
        ...
        try {
            ...
            if (stdgo._internal.internal.intern.Intern__valsafe._valSafe != null) {
                ...
                var __tmp__ = (stdgo._internal.internal.intern.Intern__valmap._valMap != null && stdgo._internal.internal.intern.Intern__valmap._valMap.exists(_k?.__copy__()) ? { _0 : stdgo._internal.internal.intern.Intern__valmap._valMap[_k?.__copy__()], _1 : true } : { _0 : new stdgo.GoUIntptr(0), _1 : false }), _addr:stdgo.GoUIntptr = __tmp__._0, _ok:Bool = __tmp__._1;
                if (_ok) {
