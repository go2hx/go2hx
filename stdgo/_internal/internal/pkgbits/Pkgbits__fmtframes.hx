...
function _fmtFrames(_pcs:haxe.Rest<stdgo.GoUIntptr>):stdgo.Slice<stdgo.GoString> {
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/pkgbits/sync.go#L16"
        stdgo._internal.internal.pkgbits.Pkgbits__walkframes._walkFrames(_pcs, function(_file:stdgo.GoString, _line:stdgo.GoInt, _name:stdgo.GoString, _offset:stdgo.GoUIntptr):Void {
            ...
            _res = (_res.__append__(stdgo._internal.fmt.Fmt_sprintf.sprintf(("%s:%v: %s +0x%v" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_line), stdgo.Go.toInterface(_name), stdgo.Go.toInterface(_offset))?.__copy__()) : stdgo.Slice<stdgo.GoString>);
        });
        //"file:///home/runner/.go/go1.21.3/src/internal/pkgbits/sync.go#L22"
        return _res;
    }
