...
function newPkgEncoder(_syncFrames:stdgo.GoInt):stdgo._internal.internal.pkgbits.Pkgbits_PkgEncoder.PkgEncoder {
        return ({ _stringsIdx : ({
            ...
            {};
            x;
        } : stdgo.GoMap<stdgo.GoString, stdgo._internal.internal.pkgbits.Pkgbits_Index.Index>), _syncFrames : _syncFrames } : stdgo._internal.internal.pkgbits.Pkgbits_PkgEncoder.PkgEncoder);
    }
