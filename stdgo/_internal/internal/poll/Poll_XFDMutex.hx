...
@:structInit @:using(stdgo._internal.internal.poll.Poll_XFDMutex_static_extension.XFDMutex_static_extension) class XFDMutex {
    ...
    public function get__decref():() -> Bool return @:check3 this._fdMutex._decref;
    public var _incref(get, never) : () -> Bool;
    @:embedded
    @:embeddededffieldsffun
    public function get__incref():() -> Bool return @:check3 this._fdMutex._incref;
    public var _increfAndClose(get, never) : () -> Bool;
    @:embedded
    @:embeddededffieldsffun
    public function get__increfAndClose():() -> Bool return @:check3 this._fdMutex._increfAndClose;
    public var _rwlock(get, never) : Bool -> Bool;
    @:embedded
    @:embeddededffieldsffun
    public function get__rwlock():Bool -> Bool return @:check3 this._fdMutex._rwlock;
    public var _rwunlock(get, never) : Bool -> Bool;
    @:embedded
    @:embeddededffieldsffun
    public function get__rwunlock():Bool -> Bool return @:check3 this._fdMutex._rwunlock;
