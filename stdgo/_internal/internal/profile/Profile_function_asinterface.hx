...
class Function_asInterface {
    @:keep
    @:tdfield
    public dynamic function _key():stdgo._internal.internal.profile.Profile_t_functionkey.T_functionKey return @:_0 __self__.value._key();
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.internal.profile.Profile_functionpointer.FunctionPointer;
