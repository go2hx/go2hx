...
class Mapping_asInterface {
    @:keep
    @:tdfield
    public dynamic function _key():stdgo._internal.internal.profile.Profile_t_mappingkey.T_mappingKey return @:_0 __self__.value._key();
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.internal.profile.Profile_mappingpointer.MappingPointer;
