...
@:keep @:allow(stdgo._internal.internal.profile.Profile.T_profileMerger_asInterface) class T_profileMerger_static_extension {
    ...
    static public function _mapFunction( _pm:stdgo.Ref<stdgo._internal.internal.profile.Profile_t_profilemerger.T_profileMerger>, _src:stdgo.Ref<stdgo._internal.internal.profile.Profile_function.Function>):stdgo.Ref<stdgo._internal.internal.profile.Profile_function.Function> {
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L348"
        if (({
            final value = _src;
            (value == null || (value : Dynamic).__nil__);
        })) {
            //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L349"
            return null;
        };
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L351"
        {
            ...
            if (_ok) {
                //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L352"
                return _f;
            };
        };
        var _k = (_src._key()?.__copy__() : stdgo._internal.internal.profile.Profile_t_functionkey.T_functionKey);
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L355"
        {
            ...
            if (_ok) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L357"
                return _f;
            };
        };
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L369"
        return _f;
    }
    @:keep
    @:tdfield
    static public function _mapLine( _pm:stdgo.Ref<stdgo._internal.internal.profile.Profile_t_profilemerger.T_profileMerger>, _src:stdgo._internal.internal.profile.Profile_line.Line):stdgo._internal.internal.profile.Profile_line.Line {
        @:recv var _pm:stdgo.Ref<stdgo._internal.internal.profile.Profile_t_profilemerger.T_profileMerger> = _pm;
        var _ln = ({ function_ : _pm._mapFunction(_src.function_), line : _src.line } : stdgo._internal.internal.profile.Profile_line.Line);
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L344"
        return _ln?.__copy__();
    }
    @:keep
    @:tdfield
    static public function _mapMapping( _pm:stdgo.Ref<stdgo._internal.internal.profile.Profile_t_profilemerger.T_profileMerger>, _src:stdgo.Ref<stdgo._internal.internal.profile.Profile_mapping.Mapping>):stdgo._internal.internal.profile.Profile_t_mapinfo.T_mapInfo {
        @:recv var _pm:stdgo.Ref<stdgo._internal.internal.profile.Profile_t_profilemerger.T_profileMerger> = _pm;
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L270"
        if (({
            final value = _src;
            (value == null || (value : Dynamic).__nil__);
        })) {
            //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L271"
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L274"
        {
            ...
            if (_ok) {
                //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L275"
                return _mi?.__copy__();
            };
        };
        var _mk = (_src._key()?.__copy__() : stdgo._internal.internal.profile.Profile_t_mappingkey.T_mappingKey);
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L280"
        {
            ...
            if (_ok) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L283"
                return _mi?.__copy__();
            };
        };
        ...
        (@:checkr _pm ?? throw "null pointer dereference")._mappingsByID[(@:checkr _src ?? throw "null pointer dereference").iD] = _mi?.__copy__();
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L303"
        return _mi?.__copy__();
    }
    @:keep
    @:tdfield
    static public function _mapLocation( _pm:stdgo.Ref<stdgo._internal.internal.profile.Profile_t_profilemerger.T_profileMerger>, _src:stdgo.Ref<stdgo._internal.internal.profile.Profile_location.Location>):stdgo.Ref<stdgo._internal.internal.profile.Profile_location.Location> {
        @:recv var _pm:stdgo.Ref<stdgo._internal.internal.profile.Profile_t_profilemerger.T_profileMerger> = _pm;
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L208"
        if (({
            final value = _src;
            (value == null || (value : Dynamic).__nil__);
        })) {
            //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L209"
            return null;
        };
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L212"
        {
            ...
            if (_ok) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L214"
                return _l;
            };
        };
        var _mi = (_pm._mapMapping((@:checkr _src ?? throw "null pointer dereference").mapping)?.__copy__() : stdgo._internal.internal.profile.Profile_t_mapinfo.T_mapInfo);
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L225"
        for (_i => _ln in (@:checkr _src ?? throw "null pointer dereference").line) {
            (@:checkr _l ?? throw "null pointer dereference").line[(_i : stdgo.GoInt)] = _pm._mapLine(_ln?.__copy__())?.__copy__();
        };
        var _k = (_l._key()?.__copy__() : stdgo._internal.internal.profile.Profile_t_locationkey.T_locationKey);
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L231"
        {
            ...
            if (_ok) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L233"
                return _ll;
            };
        };
        (@:checkr _pm ?? throw "null pointer dereference")._locationsByID[(@:checkr _src ?? throw "null pointer dereference").iD] = _l;
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L238"
        return _l;
    }
    @:keep
    @:tdfield
    static public function _mapSample( _pm:stdgo.Ref<stdgo._internal.internal.profile.Profile_t_profilemerger.T_profileMerger>, _src:stdgo.Ref<stdgo._internal.internal.profile.Profile_sample.Sample>):stdgo.Ref<stdgo._internal.internal.profile.Profile_sample.Sample> {
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L142"
        for (_i => _l in (@:checkr _src ?? throw "null pointer dereference").location) {
            (@:checkr _s ?? throw "null pointer dereference").location[(_i : stdgo.GoInt)] = _pm._mapLocation(_l);
        };
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L145"
        for (_k => _v in (@:checkr _src ?? throw "null pointer dereference").label) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L147"
            _vv.__copyTo__(_v);
            (@:checkr _s ?? throw "null pointer dereference").label[_k] = _vv;
        };
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L150"
        for (_k => _v in (@:checkr _src ?? throw "null pointer dereference").numLabel) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L154"
            _vv.__copyTo__(_v);
            //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L155"
            _uu.__copyTo__(_u);
            (@:checkr _s ?? throw "null pointer dereference").numLabel[_k] = _vv;
            (@:checkr _s ?? throw "null pointer dereference").numUnit[_k] = _uu;
        };
        var _k = (_s._key()?.__copy__() : stdgo._internal.internal.profile.Profile_t_samplekey.T_sampleKey);
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L163"
        {
            ...
            if (_ok) {
                //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L164"
                ...
                //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L167"
                return _ss;
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L169"
        ...
        //"file:///home/runner/.go/go1.21.3/src/internal/profile/merge.go#L172"
        return _s;
    }
}
