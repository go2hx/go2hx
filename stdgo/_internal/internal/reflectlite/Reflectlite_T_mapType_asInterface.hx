...
class T_mapType_asInterface {
    ...
    public dynamic function _uncommon():stdgo.Ref<stdgo._internal.internal.abi.Abi_UncommonType.UncommonType> return @:_0 __self__.value._uncommon();
    @:embedded
    @:embeddededffieldsffun
    public dynamic function _typeOff(_0:stdgo._internal.internal.abi.Abi_TypeOff.TypeOff):stdgo.Ref<stdgo._internal.internal.abi.Abi_Type_.Type_> return @:_0 __self__.value._typeOff(_0);
    @:embedded
    @:embeddededffieldsffun
    public dynamic function _nameOff(_0:stdgo._internal.internal.abi.Abi_NameOff.NameOff):stdgo._internal.internal.abi.Abi_Name.Name return @:_0 __self__.value._nameOff(_0);
    @:embedded
    @:embeddededffieldsffun
    public dynamic function _exportedMethods():stdgo.Slice<stdgo._internal.internal.abi.Abi_Method.Method> return @:_0 __self__.value._exportedMethods();
    @:embedded
    @:embeddededffieldsffun
    public dynamic function _common():stdgo.Ref<stdgo._internal.internal.abi.Abi_Type_.Type_> return @:_0 __self__.value._common();
    @:embedded
    @:embeddededffieldsffun
    ...
    @:embedded
    @:embeddededffieldsffun
    public dynamic function out(_0:stdgo.GoInt):stdgo._internal.internal.reflectlite.Reflectlite_Type_.Type_ return @:_0 __self__.value.out(_0);
    @:embedded
    @:embeddededffieldsffun
    ...
    @:embedded
    @:embeddededffieldsffun
    public dynamic function in_(_0:stdgo.GoInt):stdgo._internal.internal.reflectlite.Reflectlite_Type_.Type_ return @:_0 __self__.value.in_(_0);
    @:embedded
    @:embeddededffieldsffun
    public dynamic function implements_(_0:stdgo._internal.internal.reflectlite.Reflectlite_Type_.Type_):Bool return @:_0 __self__.value.implements_(_0);
    @:embedded
    @:embeddededffieldsffun
    ...
    @:embedded
    @:embeddededffieldsffun
    public dynamic function assignableTo(_0:stdgo._internal.internal.reflectlite.Reflectlite_Type_.Type_):Bool return @:_0 __self__.value.assignableTo(_0);
    @:embedded
    @:embeddededffieldsffun
    ...
    var __self__ : stdgo._internal.internal.reflectlite.Reflectlite_T_mapTypePointer.T_mapTypePointer;
