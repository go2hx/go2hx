...
@:structInit @:using(stdgo._internal.internal.reflectlite.Reflectlite_t_maptype_static_extension.T_mapType_static_extension) class T_mapType {
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_assignableTo():stdgo._internal.internal.reflectlite.Reflectlite_type_.Type_ -> Bool return @:check31 (this._rtype ?? throw "null pointer dereference").assignableTo;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_comparable_():() -> Bool return @:check31 (this._rtype ?? throw "null pointer dereference").comparable_;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_implements_():stdgo._internal.internal.reflectlite.Reflectlite_type_.Type_ -> Bool return @:check31 (this._rtype ?? throw "null pointer dereference").implements_;
    public var in_(get, never) : stdgo.GoInt -> stdgo._internal.internal.reflectlite.Reflectlite_type_.Type_;
    @:embedded
    @:embeddededffieldsffun
    public function get_in_():stdgo.GoInt -> stdgo._internal.internal.reflectlite.Reflectlite_type_.Type_ return @:check31 (this._rtype ?? throw "null pointer dereference").in_;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_len():() -> stdgo.GoInt return @:check31 (this._rtype ?? throw "null pointer dereference").len;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_name():() -> stdgo.GoString return @:check31 (this._rtype ?? throw "null pointer dereference").name;
    public var numField(get, never) : () -> stdgo.GoInt;
    @:embedded
    @:embeddededffieldsffun
    public function get_numField():() -> stdgo.GoInt return @:check31 (this._rtype ?? throw "null pointer dereference").numField;
    public var numIn(get, never) : () -> stdgo.GoInt;
    @:embedded
    @:embeddededffieldsffun
    public function get_numIn():() -> stdgo.GoInt return @:check31 (this._rtype ?? throw "null pointer dereference").numIn;
    public var numMethod(get, never) : () -> stdgo.GoInt;
    @:embedded
    @:embeddededffieldsffun
    public function get_numMethod():() -> stdgo.GoInt return @:check31 (this._rtype ?? throw "null pointer dereference").numMethod;
    public var numOut(get, never) : () -> stdgo.GoInt;
    @:embedded
    @:embeddededffieldsffun
    public function get_numOut():() -> stdgo.GoInt return @:check31 (this._rtype ?? throw "null pointer dereference").numOut;
    public var out(get, never) : stdgo.GoInt -> stdgo._internal.internal.reflectlite.Reflectlite_type_.Type_;
    @:embedded
    @:embeddededffieldsffun
    public function get_out():stdgo.GoInt -> stdgo._internal.internal.reflectlite.Reflectlite_type_.Type_ return @:check31 (this._rtype ?? throw "null pointer dereference").out;
    public var pkgPath(get, never) : () -> stdgo.GoString;
    @:embedded
    @:embeddededffieldsffun
    public function get_pkgPath():() -> stdgo.GoString return @:check31 (this._rtype ?? throw "null pointer dereference").pkgPath;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_string():() -> stdgo.GoString return @:check31 (this._rtype ?? throw "null pointer dereference").string;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get__common():() -> stdgo.Ref<stdgo._internal.internal.abi.Abi_type_.Type_> return @:check31 (this._rtype ?? throw "null pointer dereference")._common;
    public var _exportedMethods(get, never) : () -> stdgo.Slice<stdgo._internal.internal.abi.Abi_method.Method>;
    @:embedded
    @:embeddededffieldsffun
    public function get__exportedMethods():() -> stdgo.Slice<stdgo._internal.internal.abi.Abi_method.Method> return @:check31 (this._rtype ?? throw "null pointer dereference")._exportedMethods;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get__nameOff():stdgo._internal.internal.abi.Abi_nameoff.NameOff -> stdgo._internal.internal.abi.Abi_name.Name return @:check31 (this._rtype ?? throw "null pointer dereference")._nameOff;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get__typeOff():stdgo._internal.internal.abi.Abi_typeoff.TypeOff -> stdgo.Ref<stdgo._internal.internal.abi.Abi_type_.Type_> return @:check31 (this._rtype ?? throw "null pointer dereference")._typeOff;
    public var _uncommon(get, never) : () -> stdgo.Ref<stdgo._internal.internal.abi.Abi_uncommontype.UncommonType>;
    @:embedded
    @:embeddededffieldsffun
    public function get__uncommon():() -> stdgo.Ref<stdgo._internal.internal.abi.Abi_uncommontype.UncommonType> return @:check31 (this._rtype ?? throw "null pointer dereference")._uncommon;
