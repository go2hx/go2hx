...
@:structInit @:using(stdgo._internal.internal.reflectlite.Reflectlite_t_rtype_static_extension.T_rtype_static_extension) class T_rtype {
    @:embedded
    public var type : stdgo.Ref<stdgo._internal.internal.abi.Abi_type_.Type_> = (null : stdgo.Ref<stdgo._internal.internal.abi.Abi_type_.Type_>);
    public function new(?type:stdgo.Ref<stdgo._internal.internal.abi.Abi_type_.Type_>) {
