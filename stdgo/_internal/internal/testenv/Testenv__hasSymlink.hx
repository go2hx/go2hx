                    ...
                    };
                    {
                        ...
                        if (_err != null) {
                            if (stdgo._internal.internal.testenv.Testenv_syscallIsNotSupported.syscallIsNotSupported(_err)) {
                                {
                                    final __ret__:{ var _0 : Bool; var _1 : stdgo.GoString; } = { _0 : false, _1 : stdgo._internal.fmt.Fmt_sprintf.sprintf(("symlinks unsupported: %s" : stdgo.GoString), stdgo.Go.toInterface(_err.error()))?.__copy__() };
                                    for (defer in __deferstack__) {
                                        defer();
                                    };
                                    return __ret__;
