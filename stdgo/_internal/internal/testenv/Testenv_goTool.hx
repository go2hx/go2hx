        ...
        @:check2 stdgo._internal.internal.testenv.Testenv__goToolOnce._goToolOnce.do_(function():Void {
            {
                ...
                stdgo._internal.internal.testenv.Testenv__goToolPath._goToolPath = __tmp__._0?.__copy__();
                stdgo._internal.internal.testenv.Testenv__goToolErr._goToolErr = __tmp__._1;
            };
        });
