...
function _findFileMarker(_data:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.GoString; var _2 : stdgo.Slice<stdgo.GoUInt8>; } {
        ...
        while (true) {
            ...
            if ((_j < (0 : stdgo.GoInt) : Bool)) {
                return {
                    final __tmp__:{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.GoString; var _2 : stdgo.Slice<stdgo.GoUInt8>; } = { _0 : stdgo._internal.internal.txtar.Txtar__fixNL._fixNL(_data), _1 : stdgo.Go.str()?.__copy__(), _2 : (null : stdgo.Slice<stdgo.GoUInt8>) };
                    _before = __tmp__._0;
                    _name = __tmp__._1;
                    _after = __tmp__._2;
                    __tmp__;
