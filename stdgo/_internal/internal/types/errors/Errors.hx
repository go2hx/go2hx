...
@:keep @:allow(stdgo._internal.internal.types.errors.Errors.Code_asInterface) class Code_static_extension {
    ...
    static public function string( _i:Code):stdgo.GoString {
        ...
        } else if (((81 : stdgo._internal.internal.types.errors.Errors.Code) <= _i) && (_i <= (106 : stdgo._internal.internal.types.errors.Errors.Code))) {
            _i = _i - ((81 : stdgo._internal.internal.types.errors.Errors.Code));
        ...
        } else if (((108 : stdgo._internal.internal.types.errors.Errors.Code) <= _i) && (_i <= (146 : stdgo._internal.internal.types.errors.Errors.Code))) {
            _i = _i - ((108 : stdgo._internal.internal.types.errors.Errors.Code));
        ...
        } else if (((148 : stdgo._internal.internal.types.errors.Errors.Code) <= _i) && (_i <= (150 : stdgo._internal.internal.types.errors.Errors.Code))) {
            _i = _i - ((148 : stdgo._internal.internal.types.errors.Errors.Code));
            return (("InvalidClearTypeTooLargeInvalidMinMaxOperand" : stdgo.GoString).__slice__(__Code_index_5[(_i : stdgo.GoInt)], __Code_index_5[(_i + (1 : stdgo._internal.internal.types.errors.Errors.Code) : stdgo.GoInt)]) : stdgo.GoString)?.__copy__();
        } else {
            return ("Code(" : stdgo.GoString) + stdgo._internal.strconv.Strconv.formatInt((_i : stdgo.GoInt64), (10 : stdgo.GoInt))?.__copy__() + (")" : stdgo.GoString)?.__copy__()?.__copy__();
        };
    }
}
