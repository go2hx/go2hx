...
@:local @:using(stdgo._internal.internal.types.errors.Errors.T__struct_0_static_extension) typedef T__struct_0 = {};
@:named @:using(stdgo._internal.internal.types.errors.Errors.Code_static_extension) typedef Code = stdgo.GoInt;
...
@:keep @:allow(stdgo._internal.internal.types.errors.Errors.Code_asInterface) class Code_static_extension {
    ...
    static public function string( _i:Code):stdgo.GoString {
        @:recv var _i:Code = _i;
        if (_i == ((-1 : stdgo._internal.internal.types.errors.Errors.Code))) {
            return ("InvalidSyntaxTree" : stdgo.GoString);
        } else if ((((1 : stdgo._internal.internal.types.errors.Errors.Code) <= _i : Bool) && (_i <= (28 : stdgo._internal.internal.types.errors.Errors.Code) : Bool) : Bool)) {
            _i = (_i - ((1 : stdgo._internal.internal.types.errors.Errors.Code)) : stdgo._internal.internal.types.errors.Errors.Code);
            return (("" : stdgo.GoString).__slice__(__Code_index_1[(_i : stdgo.GoInt)], __Code_index_1[((_i + (1 : stdgo._internal.internal.types.errors.Errors.Code) : stdgo._internal.internal.types.errors.Errors.Code) : stdgo.GoInt)]) : stdgo.GoString)?.__copy__();
        } else if ((((30 : stdgo._internal.internal.types.errors.Errors.Code) <= _i : Bool) && (_i <= (79 : stdgo._internal.internal.types.errors.Errors.Code) : Bool) : Bool)) {
            _i = (_i - ((30 : stdgo._internal.internal.types.errors.Errors.Code)) : stdgo._internal.internal.types.errors.Errors.Code);
        ...
        } else if ((((81 : stdgo._internal.internal.types.errors.Errors.Code) <= _i : Bool) && (_i <= (106 : stdgo._internal.internal.types.errors.Errors.Code) : Bool) : Bool)) {
            _i = (_i - ((81 : stdgo._internal.internal.types.errors.Errors.Code)) : stdgo._internal.internal.types.errors.Errors.Code);
        ...
        } else if ((((108 : stdgo._internal.internal.types.errors.Errors.Code) <= _i : Bool) && (_i <= (146 : stdgo._internal.internal.types.errors.Errors.Code) : Bool) : Bool)) {
            _i = (_i - ((108 : stdgo._internal.internal.types.errors.Errors.Code)) : stdgo._internal.internal.types.errors.Errors.Code);
        ...
        } else if ((((148 : stdgo._internal.internal.types.errors.Errors.Code) <= _i : Bool) && (_i <= (150 : stdgo._internal.internal.types.errors.Errors.Code) : Bool) : Bool)) {
            _i = (_i - ((148 : stdgo._internal.internal.types.errors.Errors.Code)) : stdgo._internal.internal.types.errors.Errors.Code);
            return (("InvalidClearTypeTooLargeInvalidMinMaxOperand" : stdgo.GoString).__slice__(__Code_index_5[(_i : stdgo.GoInt)], __Code_index_5[((_i + (1 : stdgo._internal.internal.types.errors.Errors.Code) : stdgo._internal.internal.types.errors.Errors.Code) : stdgo.GoInt)]) : stdgo.GoString)?.__copy__();
        } else {
            return ((("Code(" : stdgo.GoString) + stdgo._internal.strconv.Strconv.formatInt((_i : stdgo.GoInt64), (10 : stdgo.GoInt))?.__copy__() : stdgo.GoString) + (")" : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__();
        };
    }
}
