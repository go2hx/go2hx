        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    {
                        _err_3764394 = stdgo._internal.encoding.binary.Binary_read.read(stdgo.Go.asInterface(_sr_3764301), stdgo.Go.asInterface(stdgo._internal.encoding.binary.Binary_bigEndian.bigEndian), stdgo.Go.toInterface(stdgo.Go.pointer(_magic_3764377)));
                    ...
                    {
                        _err_3765705 = stdgo._internal.encoding.binary.Binary_read.read(stdgo.Go.asInterface(_sr_3764301), stdgo.Go.asInterface(stdgo._internal.encoding.binary.Binary_bigEndian.bigEndian), stdgo.Go.toInterface(stdgo.Go.pointer(_l_3765692)));
