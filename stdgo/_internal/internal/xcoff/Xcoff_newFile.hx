        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _offset_3768045 = stdgo._internal.encoding.binary.Binary_bigEndian.bigEndian.uint32(((@:checkr _se_3767617 ?? throw "null pointer dereference").nname.__slice__((4 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                    {
                        ...
                        (@:checkr _sym_3767547 ?? throw "null pointer dereference").name = __tmp__._0?.__copy__();
                    ...
                    _c_3770925 = stdgo._internal.internal.saferio.Saferio_sliceCap.sliceCap(stdgo.Go.toInterface((null : stdgo.Ref<stdgo._internal.internal.xcoff.Xcoff_Reloc.Reloc>)), ((@:checkr _sect_3770784 ?? throw "null pointer dereference").sectionHeader.nreloc : stdgo.GoUInt64));
