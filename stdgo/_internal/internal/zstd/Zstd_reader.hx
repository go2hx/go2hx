...
@:structInit @:using(stdgo._internal.internal.zstd.Zstd_reader_static_extension.Reader_static_extension) class Reader {
    ...
    public var _seqTables : stdgo.GoArray<stdgo.Slice<stdgo._internal.internal.zstd.Zstd_t_fsebaselineentry.T_fseBaselineEntry>> = new stdgo.GoArray<stdgo.Slice<stdgo._internal.internal.zstd.Zstd_t_fsebaselineentry.T_fseBaselineEntry>>(3, 3).__setNil__();
    public var _seqTableBits : stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(3, 3).__setNumber32__().__setNil__();
    public var _seqTableBuffers : stdgo.GoArray<stdgo.Slice<stdgo._internal.internal.zstd.Zstd_t_fsebaselineentry.T_fseBaselineEntry>> = new stdgo.GoArray<stdgo.Slice<stdgo._internal.internal.zstd.Zstd_t_fsebaselineentry.T_fseBaselineEntry>>(3, 3).__setNil__();
    public var _scratch : stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(16, 16).__setNumber32__().__setNil__();
