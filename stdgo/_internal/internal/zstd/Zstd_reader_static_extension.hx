        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 3523296i32;
                } else if (__value__ == (3523296i32)) {
                    _relativeOffset_0 = (0 : stdgo.GoInt);
                    {
                        ...
                        if (_err_1 != null) {
                            _gotoNext = 3523417i32;
                        } else {
                            _gotoNext = 3523599i32;
                        };
                    };
                } else if (__value__ == (3523417i32)) {
                    if (((stdgo.Go.toInterface(_err_1) == stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF)) && !(@:checkr _r ?? throw "null pointer dereference")._readOneFrame : Bool)) {
                        _gotoNext = 3523517i32;
                    } else {
                        _gotoNext = 3523554i32;
                    };
                } else if (__value__ == (3523517i32)) {
                    _err_1 = stdgo._internal.io.Io_errunexpectedeof.errUnexpectedEOF;
                    _gotoNext = 3523554i32;
                } else if (__value__ == (3523554i32)) {
                    return @:check2r _r._wrapError(_relativeOffset_0, _err_1);
                    _gotoNext = 3523599i32;
                } else if (__value__ == (3523599i32)) {
                    {
                        ...
                        if (_magic_2 != ((-47205080u32 : stdgo.GoUInt32))) {
                            _gotoNext = 3523674i32;
                        } else {
                            _gotoNext = 3523951i32;
                        };
                    };
                } else if (__value__ == (3523674i32)) {
                    if (((_magic_2 >= (407710288u32 : stdgo.GoUInt32) : Bool) && (_magic_2 <= (407710303u32 : stdgo.GoUInt32) : Bool) : Bool)) {
                        _gotoNext = 3523724i32;
                    } else {
                        _gotoNext = 3523887i32;
                    };
                } else if (__value__ == (3523724i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._blockOffset = ((@:checkr _r ?? throw "null pointer dereference")._blockOffset + (((_relativeOffset_0 : stdgo.GoInt64) + (4i64 : stdgo.GoInt64) : stdgo.GoInt64)) : stdgo.GoInt64);
                    {
                        ...
                        if (_err_3 != null) {
                            _gotoNext = 3523844i32;
                        } else {
                            _gotoNext = 3523869i32;
                        };
                    };
                } else if (__value__ == (3523844i32)) {
                    return _err_3;
                    _gotoNext = 3523869i32;
                } else if (__value__ == (3523869i32)) {
                    _gotoNext = 3523296i32;
                } else if (__value__ == (3523887i32)) {
                    return @:check2r _r._makeError(_relativeOffset_0, ("invalid magic number" : stdgo.GoString));
                    _gotoNext = 3523951i32;
                } else if (__value__ == (3523951i32)) {
                    _relativeOffset_0 = (_relativeOffset_0 + ((4 : stdgo.GoInt)) : stdgo.GoInt);
                    {
                        ...
                        if (_err_4 != null) {
                            _gotoNext = 3524079i32;
                        } else {
                            _gotoNext = 3524133i32;
                        };
                    };
                } else if (__value__ == (3524079i32)) {
                    return @:check2r _r._wrapNonEOFError(_relativeOffset_0, _err_4);
                    _gotoNext = 3524133i32;
                } else if (__value__ == (3524133i32)) {
                    ...
                    _headerSize_9 = (_windowDescriptorSize_8 + _fcsFieldSize_7 : stdgo.GoInt);
                    {
                        ...
                        if (_err_10 != null) {
                            _gotoNext = 3524865i32;
                        } else {
                            _gotoNext = 3525005i32;
                        };
                    };
                } else if (__value__ == (3524865i32)) {
                    return @:check2r _r._wrapNonEOFError(_relativeOffset_0, _err_10);
                    _gotoNext = 3525005i32;
                } else if (__value__ == (3525005i32)) {
                    if (_singleSegment_6) {
                        _gotoNext = 3525022i32;
                    } else {
                        _gotoNext = 3525115i32;
                    };
                } else if (__value__ == (3525022i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._windowSize = (0 : stdgo.GoInt);
                    _gotoNext = 3525791i32;
                } else if (__value__ == (3525115i32)) {
                    _gotoNext = 3525115i32;
                    ...
                    _gotoNext = 3525885i32;
                } else if (__value__ == (3525885i32)) {
                    {
                        final __value__ = _fcsFieldSize_7;
                        if (__value__ == ((0 : stdgo.GoInt))) {
                            _gotoNext = 3525908i32;
                        } else if (__value__ == ((1 : stdgo.GoInt))) {
                            _gotoNext = 3525945i32;
                        } else if (__value__ == ((2 : stdgo.GoInt))) {
                            _gotoNext = 3525993i32;
                        } else if (__value__ == ((4 : stdgo.GoInt))) {
                            _gotoNext = 3526072i32;
                        } else if (__value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 3526145i32;
                        } else {
                            _gotoNext = 3526210i32;
                        };
                    };
                } else if (__value__ == (3525908i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._frameSizeUnknown = true;
                    _gotoNext = 3526247i32;
                } else if (__value__ == (3525945i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._remainingFrameSize = (_fb_18[(0 : stdgo.GoInt)] : stdgo.GoUInt64);
                    _gotoNext = 3526247i32;
                } else if (__value__ == (3525993i32)) {
                    ...
                    _gotoNext = 3526247i32;
                } else if (__value__ == (3526210i32)) {
                    throw stdgo.Go.toInterface(("unreachable" : stdgo.GoString));
                    _gotoNext = 3526247i32;
                } else if (__value__ == (3526247i32)) {
