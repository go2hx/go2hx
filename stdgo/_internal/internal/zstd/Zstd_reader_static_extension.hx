        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _relativeOffset_0 = (0 : stdgo.GoInt);
                    {
                        ...
                        if (_err_1 != null) {
                            _gotoNext = 3532482i32;
                        } else {
                            _gotoNext = 3532664i32;
                        };
                    };
                } else if (__value__ == (3532482i32)) {
                    if (((stdgo.Go.toInterface(_err_1) == stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF)) && !(@:checkr _r ?? throw "null pointer dereference")._readOneFrame : Bool)) {
                        _gotoNext = 3532582i32;
                    } else {
                        _gotoNext = 3532619i32;
                    };
                } else if (__value__ == (3532582i32)) {
                    _err_1 = stdgo._internal.io.Io_errunexpectedeof.errUnexpectedEOF;
                    _gotoNext = 3532619i32;
                } else if (__value__ == (3532619i32)) {
                    return @:check2r _r._wrapError(_relativeOffset_0, _err_1);
                    _gotoNext = 3532664i32;
                } else if (__value__ == (3532664i32)) {
                    {
                        ...
                        if (_magic_2 != ((-47205080u32 : stdgo.GoUInt32))) {
                            _gotoNext = 3532739i32;
                        } else {
                            _gotoNext = 3533016i32;
                        };
                    };
                } else if (__value__ == (3532739i32)) {
                    if (((_magic_2 >= (407710288u32 : stdgo.GoUInt32) : Bool) && (_magic_2 <= (407710303u32 : stdgo.GoUInt32) : Bool) : Bool)) {
                        _gotoNext = 3532789i32;
                    } else {
                        _gotoNext = 3532952i32;
                    };
                } else if (__value__ == (3532789i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._blockOffset = ((@:checkr _r ?? throw "null pointer dereference")._blockOffset + (((_relativeOffset_0 : stdgo.GoInt64) + (4i64 : stdgo.GoInt64) : stdgo.GoInt64)) : stdgo.GoInt64);
                    {
                        ...
                        if (_err_3 != null) {
                            _gotoNext = 3532909i32;
                        } else {
                            _gotoNext = 3532934i32;
                        };
                    };
                } else if (__value__ == (3532909i32)) {
                    return _err_3;
                    _gotoNext = 3532934i32;
                } else if (__value__ == (3532934i32)) {
                    _gotoNext = 3532361i32;
                } else if (__value__ == (3532952i32)) {
                    ...
                    _relativeOffset_0 = (_relativeOffset_0 + ((4 : stdgo.GoInt)) : stdgo.GoInt);
                    {
                        ...
                        if (_err_4 != null) {
                            _gotoNext = 3533144i32;
                        } else {
                            _gotoNext = 3533198i32;
                        };
                    };
                } else if (__value__ == (3533144i32)) {
                    return @:check2r _r._wrapNonEOFError(_relativeOffset_0, _err_4);
                    _gotoNext = 3533198i32;
                } else if (__value__ == (3533198i32)) {
                    ...
                    _headerSize_9 = (_windowDescriptorSize_8 + _fcsFieldSize_7 : stdgo.GoInt);
                    {
                        ...
                        if (_err_10 != null) {
                            _gotoNext = 3533930i32;
                        } else {
                            _gotoNext = 3534070i32;
                        };
                    };
                } else if (__value__ == (3533930i32)) {
                    return @:check2r _r._wrapNonEOFError(_relativeOffset_0, _err_10);
                    _gotoNext = 3534070i32;
                } else if (__value__ == (3534070i32)) {
                    if (_singleSegment_6) {
                        _gotoNext = 3534087i32;
                    } else {
                        _gotoNext = 3534180i32;
                    };
                } else if (__value__ == (3534087i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._windowSize = (0 : stdgo.GoInt);
                    _gotoNext = 3534856i32;
                } else if (__value__ == (3534180i32)) {
                    _gotoNext = 3534180i32;
                    ...
                    _gotoNext = 3535312i32;
                } else if (__value__ == (3535275i32)) {
                    throw stdgo.Go.toInterface(("unreachable" : stdgo.GoString));
                    _gotoNext = 3535312i32;
                } else if (__value__ == (3535312i32)) {
