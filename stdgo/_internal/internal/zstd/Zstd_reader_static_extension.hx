                ...
                if (__value__ == (0i32)) {
                ...
                } else if (__value__ == (3546710i32)) {
                    {
                        ...
                        if (_magic_2 != ((-47205080u32 : stdgo.GoUInt32))) {
                            _gotoNext = 3546785i32;
                        } else {
                            _gotoNext = 3547062i32;
                        };
                    };
                } else if (__value__ == (3546785i32)) {
                    if (((_magic_2 >= (407710288u32 : stdgo.GoUInt32) : Bool) && (_magic_2 <= (407710303u32 : stdgo.GoUInt32) : Bool) : Bool)) {
                        _gotoNext = 3546835i32;
                    } else {
                        _gotoNext = 3546998i32;
                    };
                } else if (__value__ == (3546835i32)) {
                    ...
                    _relativeOffset_0 = (_relativeOffset_0 + ((4 : stdgo.GoInt)) : stdgo.GoInt);
                    {
                        ...
                        if (_err_4 != null) {
                            _gotoNext = 3547190i32;
                        } else {
                            _gotoNext = 3547244i32;
                        };
                    };
                } else if (__value__ == (3547190i32)) {
                    ...
                    _headerSize_9 = (_windowDescriptorSize_8 + _fcsFieldSize_7 : stdgo.GoInt);
                    {
                        ...
                        if (_err_10 != null) {
                            ...
                            _gotoNext = 3548116i32;
                        };
                    };
                } else if (__value__ == (3547976i32)) {
                    return @:check2r _r._wrapNonEOFError(_relativeOffset_0, _err_10);
                    _gotoNext = 3548116i32;
                } else if (__value__ == (3548116i32)) {
                    if (_singleSegment_6) {
                        _gotoNext = 3548133i32;
                    } else {
                        _gotoNext = 3548226i32;
                    };
                } else if (__value__ == (3548133i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._windowSize = (0 : stdgo.GoInt);
                    _gotoNext = 3548902i32;
                } else if (__value__ == (3548226i32)) {
                    _gotoNext = 3548226i32;
                    ...
                    _gotoNext = 3548996i32;
                } else if (__value__ == (3548996i32)) {
                    {
                        final __value__ = _fcsFieldSize_7;
                        if (__value__ == ((0 : stdgo.GoInt))) {
                            _gotoNext = 3549019i32;
                        } else if (__value__ == ((1 : stdgo.GoInt))) {
                            _gotoNext = 3549056i32;
                        } else if (__value__ == ((2 : stdgo.GoInt))) {
                            _gotoNext = 3549104i32;
                        } else if (__value__ == ((4 : stdgo.GoInt))) {
                            _gotoNext = 3549183i32;
                        } else if (__value__ == ((8 : stdgo.GoInt))) {
                            _gotoNext = 3549256i32;
                        } else {
                            _gotoNext = 3549321i32;
                        };
                    };
                } else if (__value__ == (3549019i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._frameSizeUnknown = true;
                    _gotoNext = 3549358i32;
                } else if (__value__ == (3549056i32)) {
                    (@:checkr _r ?? throw "null pointer dereference")._remainingFrameSize = (_fb_18[(0 : stdgo.GoInt)] : stdgo.GoUInt64);
                    _gotoNext = 3549358i32;
                } else if (__value__ == (3549104i32)) {
                    ...
                    _gotoNext = 3549358i32;
                } else if (__value__ == (3549321i32)) {
                    throw stdgo.Go.toInterface(("unreachable" : stdgo.GoString));
                    _gotoNext = 3549358i32;
                } else if (__value__ == (3549358i32)) {
