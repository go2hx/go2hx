...
@:structInit @:using(stdgo._internal.internal.zstd.Zstd_t_reversebitreader_static_extension.T_reverseBitReader_static_extension) class T_reverseBitReader {
    ...
    public function new(?_r:stdgo.Ref<stdgo._internal.internal.zstd.Zstd_reader.Reader>, ?_data:stdgo._internal.internal.zstd.Zstd_t_block.T_block, ?_off:stdgo.GoUInt32, ?_start:stdgo.GoUInt32, ?_bits:stdgo.GoUInt32, ?_cnt:stdgo.GoUInt32) {
