...
@:structInit @:using(stdgo._internal.internal.zstd.Zstd_t_xxhash64_static_extension.T_xxhash64_static_extension) class T_xxhash64 {
    ...
    public var _v : stdgo.GoArray<stdgo.GoUInt64> = new stdgo.GoArray<stdgo.GoUInt64>(4, 4).__setNumber64__().__setNil__();
    public var _buf : stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(32, 32).__setNumber32__().__setNil__();
