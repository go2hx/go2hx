...
class OffsetWriter_asInterface {
    ...
    @:keep
    public dynamic function writeAt(_p:stdgo.Slice<stdgo.GoUInt8>, _off:stdgo.GoInt64):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } return __self__.value.writeAt(_p, _off);
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.io.Io_OffsetWriter.OffsetWriter>;
