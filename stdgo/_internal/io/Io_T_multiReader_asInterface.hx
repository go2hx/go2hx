...
class T_multiReader_asInterface {
    @:keep
    public dynamic function _writeToWithBuffer(_w:stdgo._internal.io.Io_Writer.Writer, _buf:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } return __self__.value._writeToWithBuffer(_w, _buf);
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.io.Io_T_multiReader.T_multiReader>;
