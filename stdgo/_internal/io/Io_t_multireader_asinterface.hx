...
class T_multiReader_asInterface {
    @:keep
    @:tdfield
    public dynamic function _writeToWithBuffer(_w:stdgo._internal.io.Io_writer.Writer, _buf:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } return @:_0 __self__.value._writeToWithBuffer(_w, _buf);
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.io.Io_t_multireaderpointer.T_multiReaderPointer;
