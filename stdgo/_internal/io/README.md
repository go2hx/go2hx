...
```
[30;41m ERROR [0m stdgo/_internal/io_test/Io_test.hx:29: characters 7-13

 29 | [2m    > [0m[1mWriter[0m[2m,[0m
    |       [31m^^^^^^[0m
...
[30;41m ERROR [0m stdgo/_internal/io_test/Io.hx:4: characters 26-70

  4 | [2mvar _tests : stdgo.Slice<[0m[1mstdgo._internal.testing.Testing.InternalTest[0m[2m> = (new stdgo.Slice<stdgo._internal.testing.Testing.InternalTest>(53, 53, ...[[0m
    |                          [31m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m
