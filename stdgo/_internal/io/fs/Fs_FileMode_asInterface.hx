...
class FileMode_asInterface {
    ...
    @:keep
    public dynamic function perm():stdgo._internal.io.fs.Fs_FileMode.FileMode return __self__.value.perm();
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.io.fs.Fs_FileMode.FileMode>;
