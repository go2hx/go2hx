...
function _globWithLimit(_fsys:stdgo._internal.io.fs.Fs_fs.FS, _pattern:stdgo.GoString, _depth:stdgo.GoInt):{ var _0 : stdgo.Slice<stdgo.GoString>; var _1 : stdgo.Error; } {
        ...
        };
        {
            ...
            if (_ok) {
                return ({
                    @:assignTranslate final __tmp__ = _fsys.glob(_pattern?.__copy__());
        ...
        if (!stdgo._internal.io.fs.Fs__hasmeta._hasMeta(_dir?.__copy__())) {
            return ({
                @:assignTranslate final __tmp__ = stdgo._internal.io.fs.Fs__glob._glob(_fsys, _dir?.__copy__(), _file?.__copy__(), (null : stdgo.Slice<stdgo.GoString>));
                { _0 : __tmp__._0, _1 : __tmp__._1 };
            });
        };
        if (_dir == (_pattern)) {
