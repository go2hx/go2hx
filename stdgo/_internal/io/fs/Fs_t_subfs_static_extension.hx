...
@:keep @:allow(stdgo._internal.io.fs.Fs.T_subFS_asInterface) class T_subFS_static_extension {
    ...
    static public function sub( _f:stdgo.Ref<stdgo._internal.io.fs.Fs_t_subfs.T_subFS>, _dir:stdgo.GoString):{ var _0 : stdgo._internal.io.fs.Fs_fs.FS; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L130"
        if (_dir == (("." : stdgo.GoString))) {
            //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L131"
        ...
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L134"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L135"
            return { _0 : (null : stdgo._internal.io.fs.Fs_fs.FS), _1 : _err };
        };
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L137"
    ...
    static public function glob( _f:stdgo.Ref<stdgo._internal.io.fs.Fs_t_subfs.T_subFS>, _pattern:stdgo.GoString):{ var _0 : stdgo.Slice<stdgo.GoString>; var _1 : stdgo.Error; } {
        @:recv var _f:stdgo.Ref<stdgo._internal.io.fs.Fs_t_subfs.T_subFS> = _f;
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L110"
        {
            ...
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L111"
                return { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : _err };
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L113"
        if (_pattern == (("." : stdgo.GoString))) {
            //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L114"
        ...
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L119"
        for (_i => _name in _list) {
            var __tmp__ = _f._shorten(_name?.__copy__()), _name:stdgo.GoString = __tmp__._0, _ok:Bool = __tmp__._1;
            //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L121"
            if (!_ok) {
                //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L122"
        ...
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L126"
    ...
    static public function readFile( _f:stdgo.Ref<stdgo._internal.io.fs.Fs_t_subfs.T_subFS>, _name:stdgo.GoString):{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L101"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L102"
        ...
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L105"
    ...
    static public function readDir( _f:stdgo.Ref<stdgo._internal.io.fs.Fs_t_subfs.T_subFS>, _name:stdgo.GoString):{ var _0 : stdgo.Slice<stdgo._internal.io.fs.Fs_direntry.DirEntry>; var _1 : stdgo.Error; } {
        @:recv var _f:stdgo.Ref<stdgo._internal.io.fs.Fs_t_subfs.T_subFS> = _f;
        var __tmp__ = _f._fullName(("read" : stdgo.GoString), _name?.__copy__()), _full:stdgo.GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L92"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L93"
        ...
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L96"
    ...
    static public function open( _f:stdgo.Ref<stdgo._internal.io.fs.Fs_t_subfs.T_subFS>, _name:stdgo.GoString):{ var _0 : stdgo._internal.io.fs.Fs_file.File; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L83"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L84"
        ...
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L87"
    ...
    static public function _fixErr( _f:stdgo.Ref<stdgo._internal.io.fs.Fs_t_subfs.T_subFS>, _err:stdgo.Error):stdgo.Error {
        @:recv var _f:stdgo.Ref<stdgo._internal.io.fs.Fs_t_subfs.T_subFS> = _f;
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L73"
        {
            var __tmp__ = try {
            ...
            if (_ok) {
                //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L74"
                {
                    var __tmp__ = _f._shorten((@:checkr _e ?? throw "null pointer dereference").path?.__copy__()), _short:stdgo.GoString = __tmp__._0, _ok:Bool = __tmp__._1;
                    if (_ok) {
        ...
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L78"
        return _err;
    }
    @:keep
    @:tdfield
    static public function _shorten( _f:stdgo.Ref<stdgo._internal.io.fs.Fs_t_subfs.T_subFS>, _name:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : Bool; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L62"
        if (_name == ((@:checkr _f ?? throw "null pointer dereference")._dir)) {
            //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L63"
            return {
        ...
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L65"
        if (((((_name.length) >= (((@:checkr _f ?? throw "null pointer dereference")._dir.length) + (2 : stdgo.GoInt) : stdgo.GoInt) : Bool) && _name[((@:checkr _f ?? throw "null pointer dereference")._dir.length : stdgo.GoInt)] == ((47 : stdgo.GoUInt8)) : Bool) && ((_name.__slice__(0, ((@:checkr _f ?? throw "null pointer dereference")._dir.length)) : stdgo.GoString) == (@:checkr _f ?? throw "null pointer dereference")._dir) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L66"
            return {
        ...
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L68"
        return {
    ...
    static public function _fullName( _f:stdgo.Ref<stdgo._internal.io.fs.Fs_t_subfs.T_subFS>, _op:stdgo.GoString, _name:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : stdgo.Error; } {
        @:recv var _f:stdgo.Ref<stdgo._internal.io.fs.Fs_t_subfs.T_subFS> = _f;
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L54"
        if (!stdgo._internal.io.fs.Fs_validpath.validPath(_name?.__copy__())) {
            //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L55"
        ...
        //"file:///home/runner/.go/go1.21.3/src/io/fs/sub.go#L57"
