...
@:keep var __init_go2hx__ = {
        try {
            ...
            //"file:///home/runner/.go/go1.21.3/src/log/slog/logger.go#L20"
            stdgo._internal.log.slog.Slog__defaultlogger._defaultLogger.store(stdgo.Go.toInterface(stdgo.Go.asInterface(stdgo._internal.log.slog.Slog_new_.new_(stdgo.Go.asInterface(stdgo._internal.log.slog.Slog__newdefaulthandler._newDefaultHandler(stdgo._internal.log.internal.Internal_defaultoutput.defaultOutput))))));
