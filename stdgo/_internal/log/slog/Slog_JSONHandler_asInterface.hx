...
class JSONHandler_asInterface {
    @:keep
    @:tdfield
    public dynamic function handle(__787:stdgo._internal.context.Context_Context.Context, _r:stdgo._internal.log.slog.Slog_Record.Record):stdgo.Error return @:_0 __self__.value.handle(__787, _r);
    @:keep
    @:tdfield
    ...
    @:keep
    @:tdfield
    public dynamic function enabled(__787:stdgo._internal.context.Context_Context.Context, _level:stdgo._internal.log.slog.Slog_Level.Level):Bool return @:_0 __self__.value.enabled(__787, _level);
    @:embedded
