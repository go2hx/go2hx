...
@:keep @:allow(stdgo._internal.log.slog.Slog.T_defaultHandler_asInterface) class T_defaultHandler_static_extension {
    ...
    @:keep
    @:tdfield
    static public function enabled( _:stdgo.Ref<stdgo._internal.log.slog.Slog_T_defaultHandler.T_defaultHandler>, __703:stdgo._internal.context.Context_Context.Context, _l:stdgo._internal.log.slog.Slog_Level.Level):Bool {
