...
function _appendJSONValue(_s:stdgo.Ref<stdgo._internal.log.slog.Slog_t_handlestate.T_handleState>, _v:stdgo._internal.log.slog.Slog_value.Value):stdgo.Error {
        //"file:///home/runner/.go/go1.21.3/src/log/slog/json_handler.go#L107"
        {
            final __value__ = _v.kind();
            if (__value__ == ((5 : stdgo._internal.log.slog.Slog_kind.Kind))) {
                //"file:///home/runner/.go/go1.21.3/src/log/slog/json_handler.go#L109"
                ...
                //"file:///home/runner/.go/go1.21.3/src/log/slog/json_handler.go#L118"
                {
                    ...
                    if (_err != null) {
                        //"file:///home/runner/.go/go1.21.3/src/log/slog/json_handler.go#L119"
                        return _err;
                    };
                };
                ...
                //"file:///home/runner/.go/go1.21.3/src/log/slog/json_handler.go#L127"
                _s._appendTime(_v.time()?.__copy__());
                ...
                //"file:///home/runner/.go/go1.21.3/src/log/slog/json_handler.go#L131"
                {
                    var __tmp__ = try {
                    ...
                    if ((_ok && !_jm : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/log/slog/json_handler.go#L132"
                        _s._appendString(_err.error()?.__copy__());
                    } else {
                        //"file:///home/runner/.go/go1.21.3/src/log/slog/json_handler.go#L134"
                ...
                //"file:///home/runner/.go/go1.21.3/src/log/slog/json_handler.go#L137"
        ...
        //"file:///home/runner/.go/go1.21.3/src/log/slog/json_handler.go#L139"
