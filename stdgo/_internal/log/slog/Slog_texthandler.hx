...
@:structInit @:using(stdgo._internal.log.slog.Slog_texthandler_static_extension.TextHandler_static_extension) class TextHandler {
    @:embedded
    ...
    public function __copy__() {
        return new TextHandler(_commonHandler);
    }
}
