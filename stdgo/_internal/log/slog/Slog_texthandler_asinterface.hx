...
class TextHandler_asInterface {
    @:keep
    @:tdfield
    public dynamic function handle(__892:stdgo._internal.context.Context_context.Context, _r:stdgo._internal.log.slog.Slog_record.Record):stdgo.Error return @:_0 __self__.value.handle(__892, _r);
    @:keep
    @:tdfield
    ...
    @:keep
    @:tdfield
    public dynamic function enabled(__892:stdgo._internal.context.Context_context.Context, _level:stdgo._internal.log.slog.Slog_level.Level):Bool return @:_0 __self__.value.enabled(__892, _level);
    @:embedded
