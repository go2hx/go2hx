...
@:structInit @:using(stdgo._internal.log.slog.internal.benchmarks.Benchmarks_t_asynchandler_static_extension.T_asyncHandler_static_extension) class T_asyncHandler {
    public var _ringBuffer : stdgo.GoArray<stdgo._internal.log.slog.Slog_record.Record> = new stdgo.GoArray<stdgo._internal.log.slog.Slog_record.Record>(100, 100, ...[for (i in 0 ... (100 > 100 ? 100 : 100 : stdgo.GoInt).toBasic()) ({} : stdgo._internal.log.slog.Slog_record.Record)]).__setNil__();
