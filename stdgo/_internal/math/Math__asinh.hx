...
function _asinh(_x:stdgo.GoFloat64):stdgo.GoFloat64 {
        {};
        //"file:///home/runner/.go/go1.21.3/src/math/asinh.go#L54"
        if ((stdgo._internal.math.Math_isnan.isNaN(_x) || stdgo._internal.math.Math_isinf.isInf(_x, (0 : stdgo.GoInt)) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/math/asinh.go#L55"
            return _x;
        };
        var _sign = (false : Bool);
        //"file:///home/runner/.go/go1.21.3/src/math/asinh.go#L58"
        if ((_x < (0 : stdgo.GoFloat64) : Bool)) {
            _x = -_x;
            _sign = true;
        };
        var _temp:stdgo.GoFloat64 = (0 : stdgo.GoFloat64);
        //"file:///home/runner/.go/go1.21.3/src/math/asinh.go#L63"
        ...
        //"file:///home/runner/.go/go1.21.3/src/math/asinh.go#L73"
        if (_sign) {
            _temp = -_temp;
        };
        //"file:///home/runner/.go/go1.21.3/src/math/asinh.go#L76"
        return _temp;
    }
