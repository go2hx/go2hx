...
function _expm1(_x:stdgo.GoFloat64):stdgo.GoFloat64 {
        {};
        //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L152"
        if ((stdgo._internal.math.Math_isinf.isInf(_x, (1 : stdgo.GoInt)) || stdgo._internal.math.Math_isnan.isNaN(_x) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L154"
            return _x;
        } else if (stdgo._internal.math.Math_isinf.isInf(_x, (-1 : stdgo.GoInt))) {
            //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L156"
            return (-1 : stdgo.GoFloat64);
        };
        var _absx = (_x : stdgo.GoFloat64);
        var _sign = (false : Bool);
        //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L161"
        if ((_x < (0 : stdgo.GoFloat64) : Bool)) {
            _absx = -_absx;
            _sign = true;
        };
        //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L167"
        if ((_absx >= (38.816242111356935 : stdgo.GoFloat64) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L168"
            if (_sign) {
                //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L169"
                return (-1 : stdgo.GoFloat64);
            };
            //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L171"
            if ((_absx >= (709.782712893384 : stdgo.GoFloat64) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L172"
                return stdgo._internal.math.Math_inf.inf((1 : stdgo.GoInt));
            };
        };
        var _c:stdgo.GoFloat64 = (0 : stdgo.GoFloat64);
        var _k:stdgo.GoInt = (0 : stdgo.GoInt);
        //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L179"
        if ((_absx > (0.34657359027997264 : stdgo.GoFloat64) : Bool)) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L181"
            if ((_absx < (1.0397207708399179 : stdgo.GoFloat64) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L182"
                if (!_sign) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L192"
                if (!_sign) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L204"
            return _x;
        } else {
            _k = (0 : stdgo.GoInt);
        };
        ...
        //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L215"
        if (_k == ((0 : stdgo.GoInt))) {
            //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L216"
        ...
        //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L220"
        if (_k == ((-1 : stdgo.GoInt))) {
            //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L222"
            ...
            //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L224"
            if ((_x < (-0.25 : stdgo.GoFloat64) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L225"
                return ((-2 : stdgo.GoFloat64) * ((_e - ((_x + (0.5 : stdgo.GoFloat64) : stdgo.GoFloat64)) : stdgo.GoFloat64)) : stdgo.GoFloat64);
            };
            //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L227"
            ...
            //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L231"
            return (_y - (1 : stdgo.GoFloat64) : stdgo.GoFloat64);
        };
        //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L233"
        if ((_k < (20 : stdgo.GoInt) : Bool)) {
            ...
            _y = stdgo._internal.math.Math_float64frombits.float64frombits((stdgo._internal.math.Math_float64bits.float64bits(_y) + ((_k : stdgo.GoUInt64) << (52i64 : stdgo.GoUInt64) : stdgo.GoUInt64) : stdgo.GoUInt64));
            //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L237"
            return _y;
        };
        ...
        //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L241"
        _y++;
        _y = stdgo._internal.math.Math_float64frombits.float64frombits((stdgo._internal.math.Math_float64bits.float64bits(_y) + ((_k : stdgo.GoUInt64) << (52i64 : stdgo.GoUInt64) : stdgo.GoUInt64) : stdgo.GoUInt64));
        //"file:///home/runner/.go/go1.21.3/src/math/expm1.go#L243"
        return _y;
    }
