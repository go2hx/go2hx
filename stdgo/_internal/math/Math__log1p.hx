...
function _log1p(_x:stdgo.GoFloat64):stdgo.GoFloat64 {
        {};
        //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L122"
        if (((_x < (-1 : stdgo.GoFloat64) : Bool) || stdgo._internal.math.Math_isnan.isNaN(_x) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L124"
            return stdgo._internal.math.Math_nan.naN();
        } else if (_x == ((-1 : stdgo.GoFloat64))) {
            //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L126"
            return stdgo._internal.math.Math_inf.inf((-1 : stdgo.GoInt));
        } else if (stdgo._internal.math.Math_isinf.isInf(_x, (1 : stdgo.GoInt))) {
            //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L128"
            return stdgo._internal.math.Math_inf.inf((1 : stdgo.GoInt));
        };
        ...
        //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L136"
        if ((_absx < (0.41421356237309503 : stdgo.GoFloat64) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L137"
            if ((_absx < (1.862645149230957e-09 : stdgo.GoFloat64) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L138"
                if ((_absx < (5.551115123125783e-17 : stdgo.GoFloat64) : Bool)) {
                    //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L139"
                    return _x;
                };
                //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L141"
                return (_x - ((_x * _x : stdgo.GoFloat64) * (0.5 : stdgo.GoFloat64) : stdgo.GoFloat64) : stdgo.GoFloat64);
            };
            //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L143"
        ...
        //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L151"
        if (_k != ((0 : stdgo.GoInt))) {
            var _u:stdgo.GoFloat64 = (0 : stdgo.GoFloat64);
            //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L153"
            if ((_absx < (9.007199254740992e+15 : stdgo.GoFloat64) : Bool)) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L158"
            ...
            //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L171"
            if ((_iu < (1865452045155277i64 : stdgo.GoUInt64) : Bool)) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L174"
                _k++;
        ...
        //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L182"
        if (_iu == ((0i64 : stdgo.GoUInt64))) {
            //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L183"
            if (_f == ((0 : stdgo.GoFloat64))) {
                //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L184"
                if (_k == ((0 : stdgo.GoInt))) {
                    //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L185"
                    return (0 : stdgo.GoFloat64);
                };
                _c = (_c + (((_k : stdgo.GoFloat64) * (1.9082149292705877e-10 : stdgo.GoFloat64) : stdgo.GoFloat64)) : stdgo.GoFloat64);
                //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L188"
            ...
            //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L191"
            if (_k == ((0 : stdgo.GoInt))) {
                //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L192"
                return (_f - r : stdgo.GoFloat64);
            };
            //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L194"
        ...
        //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L199"
        if (_k == ((0 : stdgo.GoInt))) {
            //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L200"
            return (_f - ((_hfsq - (_s * ((_hfsq + r : stdgo.GoFloat64)) : stdgo.GoFloat64) : stdgo.GoFloat64)) : stdgo.GoFloat64);
        };
        //"file:///home/runner/.go/go1.21.3/src/math/log1p.go#L202"
