...
function _shrcompress(_u1:stdgo.GoUInt64, _u2:stdgo.GoUInt64, _n:stdgo.GoUInt):{ var _0 : stdgo.GoUInt64; var _1 : stdgo.GoUInt64; } {
        ...
        if (_n == ((0u32 : stdgo.GoUInt))) {
            return { _0 : _r1 = _u1, _1 : _r2 = _u2 };
        } else if (_n == ((64u32 : stdgo.GoUInt))) {
            return { _0 : _r1 = (0i64 : stdgo.GoUInt64), _1 : _r2 = (_u1 | stdgo._internal.math.Math__nonzero._nonzero(_u2) : stdgo.GoUInt64) };
        } else if ((_n >= (128u32 : stdgo.GoUInt) : Bool)) {
            return { _0 : _r1 = (0i64 : stdgo.GoUInt64), _1 : _r2 = stdgo._internal.math.Math__nonzero._nonzero((_u1 | _u2 : stdgo.GoUInt64)) };
