...
function _sinh(_x:stdgo.GoFloat64):stdgo.GoFloat64 {
        ...
        //"file:///home/runner/.go/go1.21.3/src/math/sinh.go#L46"
        if ((_x < (0 : stdgo.GoFloat64) : Bool)) {
            _x = -_x;
            _sign = true;
        };
        var _temp:stdgo.GoFloat64 = (0 : stdgo.GoFloat64);
        //"file:///home/runner/.go/go1.21.3/src/math/sinh.go#L52"
        ...
        //"file:///home/runner/.go/go1.21.3/src/math/sinh.go#L66"
        if (_sign) {
            _temp = -_temp;
        };
        //"file:///home/runner/.go/go1.21.3/src/math/sinh.go#L69"
        return _temp;
    }
