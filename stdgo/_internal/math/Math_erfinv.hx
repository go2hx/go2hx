...
function erfinv(_x:stdgo.GoFloat64):stdgo.GoFloat64 {
        //"file:///home/runner/.go/go1.21.3/src/math/erfinv.go#L79"
        if (((stdgo._internal.math.Math_isnan.isNaN(_x) || (_x <= (-1 : stdgo.GoFloat64) : Bool) : Bool) || (_x >= (1 : stdgo.GoFloat64) : Bool) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/math/erfinv.go#L80"
            if (((_x == (-1 : stdgo.GoFloat64)) || (_x == (1 : stdgo.GoFloat64)) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/math/erfinv.go#L81"
                return stdgo._internal.math.Math_inf.inf((_x : stdgo.GoInt));
            };
            //"file:///home/runner/.go/go1.21.3/src/math/erfinv.go#L83"
            return stdgo._internal.math.Math_nan.naN();
        };
        var _sign = (false : Bool);
        //"file:///home/runner/.go/go1.21.3/src/math/erfinv.go#L87"
        if ((_x < (0 : stdgo.GoFloat64) : Bool)) {
            _x = -_x;
            _sign = true;
        };
        var _ans:stdgo.GoFloat64 = (0 : stdgo.GoFloat64);
        //"file:///home/runner/.go/go1.21.3/src/math/erfinv.go#L93"
        if ((_x <= (0.85 : stdgo.GoFloat64) : Bool)) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/math/erfinv.go#L101"
        ...
        //"file:///home/runner/.go/go1.21.3/src/math/erfinv.go#L113"
        if (_sign) {
            //"file:///home/runner/.go/go1.21.3/src/math/erfinv.go#L114"
            return -_ans;
        };
        //"file:///home/runner/.go/go1.21.3/src/math/erfinv.go#L116"
        return _ans;
    }
