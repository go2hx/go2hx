...
[30;41m ERROR [0m [31m(macro) [0mstdgo/_internal/unsafe/Unsafe.hx:61: character 1

  61 | [0m[1m[0m[2mfunction sizeof(x:AnyInterface):GoUIntptr {[0m
     | [31m^[0m
     | stdgo._internal.unsafe._Unsafe.Unsafe_Fields_ is not ready to be accessed, separate your type declarations in several files
