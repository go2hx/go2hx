...
_t1 = _t1._sub(_t1, stdgo._internal.math.big.Big__natTwo._natTwo);
{
    ...
    static public function _probablyPrimeMillerRabin( _n:stdgo._internal.math.big.Big_T_nat.T_nat, _reps:stdgo.GoInt, _force2:Bool):Bool {
        @:recv var _n:stdgo._internal.math.big.Big_T_nat.T_nat = _n;
        var _y_4513663:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _rand_4513608:stdgo.Ref<stdgo._internal.math.rand.Rand_Rand.Rand> = (null : stdgo.Ref<stdgo._internal.math.rand.Rand_Rand.Rand>);
        var _nm3_4513574:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _q_4513546:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _nm1_4513443:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var nextRandomBreak = false;
        var _quotient_4513666:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _j_4513966:stdgo.GoUInt = (0 : stdgo.GoUInt);
        var _i_4513721:stdgo.GoInt = (0 : stdgo.GoInt);
        var _nm3Len_4513680:stdgo.GoInt = (0 : stdgo.GoInt);
        var _x_4513660:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _k_4513517:stdgo.GoUInt = (0 : stdgo.GoUInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _nm1_4513443 = (new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0) : stdgo._internal.math.big.Big_T_nat.T_nat)._sub(_n, stdgo._internal.math.big.Big__natOne._natOne);
                    _k_4513517 = _nm1_4513443._trailingZeroBits();
                    _q_4513546 = (new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0) : stdgo._internal.math.big.Big_T_nat.T_nat)._shr(_nm1_4513443, _k_4513517);
                    _nm3_4513574 = (new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0) : stdgo._internal.math.big.Big_T_nat.T_nat)._sub(_nm1_4513443, stdgo._internal.math.big.Big__natTwo._natTwo);
                    _rand_4513608 = stdgo._internal.math.rand.Rand_new_.new_(stdgo._internal.math.rand.Rand_newSource.newSource((_n[(0 : stdgo.GoInt)] : stdgo.GoInt64)));
                    _nm3Len_4513680 = _nm3_4513574._bitLen();
                    _gotoNext = 4513704i32;
                } else if (__value__ == (4513704i32)) {
                    _i_4513721 = (0 : stdgo.GoInt);
                    nextRandomBreak = false;
                    _gotoNext = 4513717i32;
                } else if (__value__ == (4513717i32)) {
                    if (!nextRandomBreak && ((_i_4513721 < _reps : Bool))) {
                        _gotoNext = 4513743i32;
                    } else {
                        _gotoNext = 4514174i32;
                    };
                } else if (__value__ == (4513743i32)) {
                    if (((_i_4513721 == (_reps - (1 : stdgo.GoInt) : stdgo.GoInt)) && _force2 : Bool)) {
                        _gotoNext = 4513772i32;
                    } else {
                        _gotoNext = 4513804i32;
                    };
                } else if (__value__ == (4513772i32)) {
                    _x_4513660 = _x_4513660._set(stdgo._internal.math.big.Big__natTwo._natTwo);
                    _gotoNext = 4513871i32;
                } else if (__value__ == (4513804i32)) {
                    _gotoNext = 4513804i32;
                    _x_4513660 = _x_4513660._random(_rand_4513608, _nm3_4513574, _nm3Len_4513680);
                    _x_4513660 = _x_4513660._add(_x_4513660, stdgo._internal.math.big.Big__natTwo._natTwo);
                    var __blank__ = 0i32;
                    _gotoNext = 4513871i32;
                } else if (__value__ == (4513871i32)) {
                    _y_4513663 = _y_4513663._expNN(_x_4513660, _q_4513546, _n, false);
                    if (((_y_4513663._cmp(stdgo._internal.math.big.Big__natOne._natOne) == (0 : stdgo.GoInt)) || (_y_4513663._cmp(_nm1_4513443) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 4513942i32;
                    } else {
                        _gotoNext = 4513962i32;
                    };
                } else if (__value__ == (4513942i32)) {
                    _i_4513721++;
                    _gotoNext = 4513717i32;
                } else if (__value__ == (4513962i32)) {
                    _j_4513966 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 4513962i32;
                    if ((_j_4513966 < _k_4513517 : Bool)) {
                        _gotoNext = 4513991i32;
                    } else {
                        _gotoNext = 4514156i32;
                    };
                } else if (__value__ == (4513987i32)) {
                    _j_4513966++;
                    _gotoNext = 4513962i32;
                } else if (__value__ == (4513991i32)) {
                    _y_4513663 = _y_4513663._sqr(_y_4513663);
                    {
                        var __tmp__ = _quotient_4513666._div(_y_4513663, _y_4513663, _n);
                        _quotient_4513666 = __tmp__._0;
                        _y_4513663 = __tmp__._1;
                    };
                    if (_y_4513663._cmp(_nm1_4513443) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4514070i32;
                    } else {
                        _gotoNext = 4514104i32;
                    };
                } else if (__value__ == (4514070i32)) {
                    _i_4513721++;
                    _gotoNext = 4513717i32;
                } else if (__value__ == (4514104i32)) {
                    if (_y_4513663._cmp(stdgo._internal.math.big.Big__natOne._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4514126i32;
                    } else {
                        _gotoNext = 4513987i32;
                    };
                } else if (__value__ == (4514126i32)) {
                    return false;
                    _gotoNext = 4513987i32;
                } else if (__value__ == (4514156i32)) {
                    return false;
                    _i_4513721++;
                    _gotoNext = 4513717i32;
                } else if (__value__ == (4514174i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
    ...
    static public function _divRecursiveStep( _z:stdgo._internal.math.big.Big_T_nat.T_nat, _u:stdgo._internal.math.big.Big_T_nat.T_nat, _v:stdgo._internal.math.big.Big_T_nat.T_nat, _depth:stdgo.GoInt, _tmp:stdgo.Ref<stdgo._internal.math.big.Big_T_nat.T_nat>, _temps:stdgo.Slice<stdgo.Ref<stdgo._internal.math.big.Big_T_nat.T_nat>>):Void {
        ...
        if ((_temps[(_depth : stdgo.GoInt)] == null || (_temps[(_depth : stdgo.GoInt)] : Dynamic).__nil__)) {
            ...
            (_temps[(_depth : stdgo.GoInt)] : stdgo._internal.math.big.Big_T_nat.T_nat).__setData__(_temps[(_depth : stdgo.GoInt)]._make((b + (1 : stdgo.GoInt) : stdgo.GoInt)));
        };
        ...
        while ((_j > b : Bool)) {
            ...
            _qhat = _qhat._norm();
            var _qhatv = (_tmp._make(((3 : stdgo.GoInt) * _n : stdgo.GoInt)) : stdgo._internal.math.big.Big_T_nat.T_nat);
            _qhatv._clear();
...
_q[(_j : stdgo.GoInt)] = _qhat;
    ...
    static public function _modW( _x:stdgo._internal.math.big.Big_T_nat.T_nat, _d:stdgo._internal.math.big.Big_Word.Word):stdgo._internal.math.big.Big_Word.Word {
        ...
        return stdgo._internal.math.big.Big__divWVW._divWVW(_q, (0u32 : stdgo._internal.math.big.Big_Word.Word), _x, _d);
    }
    @:keep
    ...
    static public function _rem( _z:stdgo._internal.math.big.Big_T_nat.T_nat, _u:stdgo._internal.math.big.Big_T_nat.T_nat, _v:stdgo._internal.math.big.Big_T_nat.T_nat):stdgo._internal.math.big.Big_T_nat.T_nat {
        ...
        var __tmp__ = _qp._div(_z, _u, _v), _q:stdgo._internal.math.big.Big_T_nat.T_nat = __tmp__._0, _r:stdgo._internal.math.big.Big_T_nat.T_nat = __tmp__._1;
...
var _prefix = __1, _b = __0;
        ...
        if (_count == ((0 : stdgo.GoInt))) {
            if (_prefix == ((48 : stdgo.GoInt))) {
                return { _0 : (_z.__slice__(0, (0 : stdgo.GoInt)) : stdgo._internal.math.big.Big_T_nat.T_nat), _1 : (10 : stdgo.GoInt), _2 : (1 : stdgo.GoInt), _3 : _err };
            };
...
_k0 = (_k0 * ((_t + (1u32 : stdgo._internal.math.big.Big_Word.Word) : stdgo._internal.math.big.Big_Word.Word)) : stdgo._internal.math.big.Big_Word.Word);
        ...
        {};
        var _powers:stdgo.GoArray<stdgo._internal.math.big.Big_T_nat.T_nat> = new stdgo.GoArray<stdgo._internal.math.big.Big_T_nat.T_nat>(16, 16, ...[for (i in 0 ... 16) new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0)]);
...
_yi = (_yi << ((4i64 : stdgo.GoUInt64)) : stdgo._internal.math.big.Big_Word.Word);
    ...
    static public function _expNNWindowed( _z:stdgo._internal.math.big.Big_T_nat.T_nat, _x:stdgo._internal.math.big.Big_T_nat.T_nat, _y:stdgo._internal.math.big.Big_T_nat.T_nat, _logM:stdgo.GoUInt):stdgo._internal.math.big.Big_T_nat.T_nat {
        ...
        {};
        var _powers:stdgo.GoArray<stdgo.Ref<stdgo._internal.math.big.Big_T_nat.T_nat>> = new stdgo.GoArray<stdgo.Ref<stdgo._internal.math.big.Big_T_nat.T_nat>>(16, 16, ...[for (i in 0 ... 16) (null : stdgo.Ref<stdgo._internal.math.big.Big_T_nat.T_nat>)]);
        for (_i => _ in _powers) {
            _powers[(_i : stdgo.GoInt)] = stdgo._internal.math.big.Big__getNat._getNat(_w);
        };
        (_powers[(0 : stdgo.GoInt)] : stdgo._internal.math.big.Big_T_nat.T_nat).__setData__(_powers[(0 : stdgo.GoInt)]._set(stdgo._internal.math.big.Big__natOne._natOne));
    ...
    static public function _setBit( _z:stdgo._internal.math.big.Big_T_nat.T_nat, _x:stdgo._internal.math.big.Big_T_nat.T_nat, _i:stdgo.GoUInt, _b:stdgo.GoUInt):stdgo._internal.math.big.Big_T_nat.T_nat {
        ...
        var _n = (_x.length : stdgo.GoInt);
        {
            ...
            if (__value__ == ((0u32 : stdgo.GoUInt))) {
                ...
                _z[(_j : stdgo.GoInt)] = (_z[(_j : stdgo.GoInt)] & (((_m) ^ (-1i32 : stdgo.GoInt) : stdgo._internal.math.big.Big_Word.Word)) : stdgo._internal.math.big.Big_Word.Word);
                return _z._norm();
...
if (((_cx < _c2 : Bool) || (_cy < _c3 : Bool) : Bool)) {
        ...
        if (_c != ((0u32 : stdgo._internal.math.big.Big_Word.Word))) {
            ...
            stdgo.Go.copySlice((_z.__slice__(0, _n) : stdgo._internal.math.big.Big_T_nat.T_nat), (_z.__slice__(_n) : stdgo._internal.math.big.Big_T_nat.T_nat));
        };
