...
_t1 = _t1._sub(_t1, stdgo._internal.math.big.Big__natTwo._natTwo);
{
    ...
    static public function _probablyPrimeMillerRabin( _n:stdgo._internal.math.big.Big_T_nat.T_nat, _reps:stdgo.GoInt, _force2:Bool):Bool {
        @:recv var _n:stdgo._internal.math.big.Big_T_nat.T_nat = _n;
        var _nm3Len_4442631:stdgo.GoInt = (0 : stdgo.GoInt);
        var _quotient_4442617:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _y_4442614:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _rand_4442559:stdgo.Ref<stdgo._internal.math.rand.Rand_Rand.Rand> = (null : stdgo.Ref<stdgo._internal.math.rand.Rand_Rand.Rand>);
        var _k_4442468:stdgo.GoUInt = (0 : stdgo.GoUInt);
        var _i_4442672:stdgo.GoInt = (0 : stdgo.GoInt);
        var _x_4442611:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _nm3_4442525:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _q_4442497:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _nm1_4442394:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _j_4442917:stdgo.GoUInt = (0 : stdgo.GoUInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _nm1_4442394 = (new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0) : stdgo._internal.math.big.Big_T_nat.T_nat)._sub(_n, stdgo._internal.math.big.Big__natOne._natOne);
                    _k_4442468 = _nm1_4442394._trailingZeroBits();
                    _q_4442497 = (new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0) : stdgo._internal.math.big.Big_T_nat.T_nat)._shr(_nm1_4442394, _k_4442468);
                    _nm3_4442525 = (new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0) : stdgo._internal.math.big.Big_T_nat.T_nat)._sub(_nm1_4442394, stdgo._internal.math.big.Big__natTwo._natTwo);
                    _rand_4442559 = stdgo._internal.math.rand.Rand_new_.new_(stdgo._internal.math.rand.Rand_newSource.newSource((_n[(0 : stdgo.GoInt)] : stdgo.GoInt64)));
                    _nm3Len_4442631 = _nm3_4442525._bitLen();
                    _gotoNext = 4442655i32;
                } else if (__value__ == (4442655i32)) {
                    _i_4442672 = (0 : stdgo.GoInt);
                    nextRandomBreak = false;
                    _gotoNext = 4442668i32;
                } else if (__value__ == (4442668i32)) {
                    if (!nextRandomBreak && ((_i_4442672 < _reps : Bool))) {
                        _gotoNext = 4442694i32;
                    } else {
                        _gotoNext = 4443125i32;
                    };
                } else if (__value__ == (4442694i32)) {
                    if (((_i_4442672 == (_reps - (1 : stdgo.GoInt) : stdgo.GoInt)) && _force2 : Bool)) {
                        _gotoNext = 4442723i32;
                    } else {
                        _gotoNext = 4442755i32;
                    };
                } else if (__value__ == (4442723i32)) {
                    _x_4442611 = _x_4442611._set(stdgo._internal.math.big.Big__natTwo._natTwo);
                    _gotoNext = 4442822i32;
                } else if (__value__ == (4442755i32)) {
                    _gotoNext = 4442755i32;
                    _x_4442611 = _x_4442611._random(_rand_4442559, _nm3_4442525, _nm3Len_4442631);
                    _x_4442611 = _x_4442611._add(_x_4442611, stdgo._internal.math.big.Big__natTwo._natTwo);
                    var __blank__ = 0i32;
                    _gotoNext = 4442822i32;
                } else if (__value__ == (4442822i32)) {
                    _y_4442614 = _y_4442614._expNN(_x_4442611, _q_4442497, _n, false);
                    if (((_y_4442614._cmp(stdgo._internal.math.big.Big__natOne._natOne) == (0 : stdgo.GoInt)) || (_y_4442614._cmp(_nm1_4442394) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 4442893i32;
                    } else {
                        _gotoNext = 4442913i32;
                    };
                } else if (__value__ == (4442893i32)) {
                    _i_4442672++;
                    _gotoNext = 4442668i32;
                } else if (__value__ == (4442913i32)) {
                    _j_4442917 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 4442913i32;
                    if ((_j_4442917 < _k_4442468 : Bool)) {
                        _gotoNext = 4442942i32;
                    } else {
                        _gotoNext = 4443107i32;
                    };
                } else if (__value__ == (4442938i32)) {
                    _j_4442917++;
                    _gotoNext = 4442913i32;
                } else if (__value__ == (4442942i32)) {
                    _y_4442614 = _y_4442614._sqr(_y_4442614);
                    {
                        var __tmp__ = _quotient_4442617._div(_y_4442614, _y_4442614, _n);
                        _quotient_4442617 = __tmp__._0;
                        _y_4442614 = __tmp__._1;
                    };
                    if (_y_4442614._cmp(_nm1_4442394) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4443021i32;
                    } else {
                        _gotoNext = 4443055i32;
                    };
                } else if (__value__ == (4443021i32)) {
                    _i_4442672++;
                    _gotoNext = 4442668i32;
                } else if (__value__ == (4443055i32)) {
                    if (_y_4442614._cmp(stdgo._internal.math.big.Big__natOne._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4443077i32;
                    } else {
                        _gotoNext = 4442938i32;
                    };
                } else if (__value__ == (4443077i32)) {
                    return false;
                    _gotoNext = 4442938i32;
                } else if (__value__ == (4443107i32)) {
                    return false;
                    _i_4442672++;
                    _gotoNext = 4442668i32;
                } else if (__value__ == (4443125i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
