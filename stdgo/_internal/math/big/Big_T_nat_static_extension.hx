...
_t1 = _t1._sub(_t1, stdgo._internal.math.big.Big__natTwo._natTwo);
{
    ...
    static public function _probablyPrimeMillerRabin( _n:stdgo._internal.math.big.Big_T_nat.T_nat, _reps:stdgo.GoInt, _force2:Bool):Bool {
        @:recv var _n:stdgo._internal.math.big.Big_T_nat.T_nat = _n;
        var _x_4463301:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _q_4463187:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _nm1_4463084:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _j_4463607:stdgo.GoUInt = (0 : stdgo.GoUInt);
        var _nm3Len_4463321:stdgo.GoInt = (0 : stdgo.GoInt);
        var _quotient_4463307:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _rand_4463249:stdgo.Ref<stdgo._internal.math.rand.Rand_Rand.Rand> = (null : stdgo.Ref<stdgo._internal.math.rand.Rand_Rand.Rand>);
        var _nm3_4463215:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _k_4463158:stdgo.GoUInt = (0 : stdgo.GoUInt);
        var nextRandomBreak = false;
        var _i_4463362:stdgo.GoInt = (0 : stdgo.GoInt);
        var _y_4463304:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _nm1_4463084 = (new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0) : stdgo._internal.math.big.Big_T_nat.T_nat)._sub(_n, stdgo._internal.math.big.Big__natOne._natOne);
                    _k_4463158 = _nm1_4463084._trailingZeroBits();
                    _q_4463187 = (new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0) : stdgo._internal.math.big.Big_T_nat.T_nat)._shr(_nm1_4463084, _k_4463158);
                    _nm3_4463215 = (new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0) : stdgo._internal.math.big.Big_T_nat.T_nat)._sub(_nm1_4463084, stdgo._internal.math.big.Big__natTwo._natTwo);
                    _rand_4463249 = stdgo._internal.math.rand.Rand_new_.new_(stdgo._internal.math.rand.Rand_newSource.newSource((_n[(0 : stdgo.GoInt)] : stdgo.GoInt64)));
                    _nm3Len_4463321 = _nm3_4463215._bitLen();
                    _gotoNext = 4463345i32;
                } else if (__value__ == (4463345i32)) {
                    _i_4463362 = (0 : stdgo.GoInt);
                    nextRandomBreak = false;
                    _gotoNext = 4463358i32;
                } else if (__value__ == (4463358i32)) {
                    if (!nextRandomBreak && ((_i_4463362 < _reps : Bool))) {
                        _gotoNext = 4463384i32;
                    } else {
                        _gotoNext = 4463815i32;
                    };
                } else if (__value__ == (4463384i32)) {
                    if (((_i_4463362 == (_reps - (1 : stdgo.GoInt) : stdgo.GoInt)) && _force2 : Bool)) {
                        _gotoNext = 4463413i32;
                    } else {
                        _gotoNext = 4463445i32;
                    };
                } else if (__value__ == (4463413i32)) {
                    _x_4463301 = _x_4463301._set(stdgo._internal.math.big.Big__natTwo._natTwo);
                    _gotoNext = 4463512i32;
                } else if (__value__ == (4463445i32)) {
                    _gotoNext = 4463445i32;
                    _x_4463301 = _x_4463301._random(_rand_4463249, _nm3_4463215, _nm3Len_4463321);
                    _x_4463301 = _x_4463301._add(_x_4463301, stdgo._internal.math.big.Big__natTwo._natTwo);
                    var __blank__ = 0i32;
                    _gotoNext = 4463512i32;
                } else if (__value__ == (4463512i32)) {
                    _y_4463304 = _y_4463304._expNN(_x_4463301, _q_4463187, _n, false);
                    if (((_y_4463304._cmp(stdgo._internal.math.big.Big__natOne._natOne) == (0 : stdgo.GoInt)) || (_y_4463304._cmp(_nm1_4463084) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 4463583i32;
                    } else {
                        _gotoNext = 4463603i32;
                    };
                } else if (__value__ == (4463583i32)) {
                    _i_4463362++;
                    _gotoNext = 4463358i32;
                } else if (__value__ == (4463603i32)) {
                    _j_4463607 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 4463603i32;
                    if ((_j_4463607 < _k_4463158 : Bool)) {
                        _gotoNext = 4463632i32;
                    } else {
                        _gotoNext = 4463797i32;
                    };
                } else if (__value__ == (4463628i32)) {
                    _j_4463607++;
                    _gotoNext = 4463603i32;
                } else if (__value__ == (4463632i32)) {
                    _y_4463304 = _y_4463304._sqr(_y_4463304);
                    {
                        var __tmp__ = _quotient_4463307._div(_y_4463304, _y_4463304, _n);
                        _quotient_4463307 = __tmp__._0;
                        _y_4463304 = __tmp__._1;
                    };
                    if (_y_4463304._cmp(_nm1_4463084) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4463711i32;
                    } else {
                        _gotoNext = 4463745i32;
                    };
                } else if (__value__ == (4463711i32)) {
                    _i_4463362++;
                    _gotoNext = 4463358i32;
                } else if (__value__ == (4463745i32)) {
                    if (_y_4463304._cmp(stdgo._internal.math.big.Big__natOne._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4463767i32;
                    } else {
                        _gotoNext = 4463628i32;
                    };
                } else if (__value__ == (4463767i32)) {
                    return false;
                    _gotoNext = 4463628i32;
                } else if (__value__ == (4463797i32)) {
                    return false;
                    _i_4463362++;
                    _gotoNext = 4463358i32;
                } else if (__value__ == (4463815i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
