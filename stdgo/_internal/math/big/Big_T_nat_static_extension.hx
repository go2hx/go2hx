...
_t1 = _t1._sub(_t1, stdgo._internal.math.big.Big__natTwo._natTwo);
{
    ...
    static public function _probablyPrimeMillerRabin( _n:stdgo._internal.math.big.Big_T_nat.T_nat, _reps:stdgo.GoInt, _force2:Bool):Bool {
        @:recv var _n:stdgo._internal.math.big.Big_T_nat.T_nat = _n;
        var _nm1_4313328:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _j_4313851:stdgo.GoUInt = (0 : stdgo.GoUInt);
        var _i_4313606:stdgo.GoInt = (0 : stdgo.GoInt);
        var _nm3Len_4313565:stdgo.GoInt = (0 : stdgo.GoInt);
        var _x_4313545:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _rand_4313493:stdgo.Ref<stdgo._internal.math.rand.Rand_Rand.Rand> = (null : stdgo.Ref<stdgo._internal.math.rand.Rand_Rand.Rand>);
        var _nm3_4313459:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _k_4313402:stdgo.GoUInt = (0 : stdgo.GoUInt);
        var nextRandomBreak = false;
        var _quotient_4313551:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _y_4313548:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _q_4313431:stdgo._internal.math.big.Big_T_nat.T_nat = new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _nm1_4313328 = (new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0) : stdgo._internal.math.big.Big_T_nat.T_nat)._sub(_n, stdgo._internal.math.big.Big__natOne._natOne);
                    _k_4313402 = _nm1_4313328._trailingZeroBits();
                    _q_4313431 = (new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0) : stdgo._internal.math.big.Big_T_nat.T_nat)._shr(_nm1_4313328, _k_4313402);
                    _nm3_4313459 = (new stdgo._internal.math.big.Big_T_nat.T_nat(0, 0) : stdgo._internal.math.big.Big_T_nat.T_nat)._sub(_nm1_4313328, stdgo._internal.math.big.Big__natTwo._natTwo);
                    _rand_4313493 = stdgo._internal.math.rand.Rand_new_.new_(stdgo._internal.math.rand.Rand_newSource.newSource((_n[(0 : stdgo.GoInt)] : stdgo.GoInt64)));
                    _nm3Len_4313565 = _nm3_4313459._bitLen();
                    _gotoNext = 4313589i32;
                } else if (__value__ == (4313589i32)) {
                    _i_4313606 = (0 : stdgo.GoInt);
                    nextRandomBreak = false;
                    _gotoNext = 4313602i32;
                } else if (__value__ == (4313602i32)) {
                    if (!nextRandomBreak && ((_i_4313606 < _reps : Bool))) {
                        _gotoNext = 4313628i32;
                    } else {
                        _gotoNext = 4314059i32;
                    };
                } else if (__value__ == (4313628i32)) {
                    if (((_i_4313606 == (_reps - (1 : stdgo.GoInt) : stdgo.GoInt)) && _force2 : Bool)) {
                        _gotoNext = 4313657i32;
                    } else {
                        _gotoNext = 4313689i32;
                    };
                } else if (__value__ == (4313657i32)) {
                    _x_4313545 = _x_4313545._set(stdgo._internal.math.big.Big__natTwo._natTwo);
                    _gotoNext = 4313756i32;
                } else if (__value__ == (4313689i32)) {
                    _x_4313545 = _x_4313545._random(_rand_4313493, _nm3_4313459, _nm3Len_4313565);
                    _x_4313545 = _x_4313545._add(_x_4313545, stdgo._internal.math.big.Big__natTwo._natTwo);
                    _gotoNext = 4313756i32;
                } else if (__value__ == (4313756i32)) {
                    _y_4313548 = _y_4313548._expNN(_x_4313545, _q_4313431, _n, false);
                    if (((_y_4313548._cmp(stdgo._internal.math.big.Big__natOne._natOne) == (0 : stdgo.GoInt)) || (_y_4313548._cmp(_nm1_4313328) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 4313827i32;
                    } else {
                        _gotoNext = 4313847i32;
                    };
                } else if (__value__ == (4313827i32)) {
                    _i_4313606++;
                    _gotoNext = 4313602i32;
                } else if (__value__ == (4313847i32)) {
                    _j_4313851 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 4313847i32;
                    if ((_j_4313851 < _k_4313402 : Bool)) {
                        _gotoNext = 4313876i32;
                    } else {
                        _gotoNext = 4314041i32;
                    };
                } else if (__value__ == (4313872i32)) {
                    _j_4313851++;
                    _gotoNext = 4313847i32;
                } else if (__value__ == (4313876i32)) {
                    _y_4313548 = _y_4313548._sqr(_y_4313548);
                    {
                        var __tmp__ = _quotient_4313551._div(_y_4313548, _y_4313548, _n);
                        _quotient_4313551 = __tmp__._0;
                        _y_4313548 = __tmp__._1;
                    };
                    if (_y_4313548._cmp(_nm1_4313328) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4313955i32;
                    } else {
                        _gotoNext = 4313989i32;
                    };
                } else if (__value__ == (4313955i32)) {
                    _i_4313606++;
                    _gotoNext = 4313602i32;
                } else if (__value__ == (4313989i32)) {
                    if (_y_4313548._cmp(stdgo._internal.math.big.Big__natOne._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4314011i32;
                    } else {
                        _gotoNext = 4313872i32;
                    };
                } else if (__value__ == (4314011i32)) {
                    return false;
                    _gotoNext = 4313872i32;
                } else if (__value__ == (4314041i32)) {
                    return false;
                    _i_4313606++;
                    _gotoNext = 4313602i32;
