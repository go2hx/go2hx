...
function _checkLehmerGcd(_aBytes:stdgo.Slice<stdgo.GoUInt8>, _bBytes:stdgo.Slice<stdgo.GoUInt8>):Bool {
        ...
        //"file:///home/runner/.go/go1.21.3/src/math/big/int_test.go#L766"
        if (((_a.sign() <= (0 : stdgo.GoInt) : Bool) || (_b.sign() <= (0 : stdgo.GoInt) : Bool) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/math/big/int_test.go#L767"
            return true;
        };
        ...
        //"file:///home/runner/.go/go1.21.3/src/math/big/int_test.go#L773"
