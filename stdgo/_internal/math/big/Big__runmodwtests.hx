...
function _runModWTests(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>, _tests:stdgo.Slice<stdgo._internal.math.big.Big_t_modwtest.T_modWTest>):Void {
        //"file:///home/runner/.go/go1.21.3/src/math/big/nat_test.go#L348"
        for (_i => _test in _tests) {
            ...
            var __tmp__ = (stdgo.Go.setRef(({} : stdgo._internal.math.big.Big_int_.Int_)) : stdgo.Ref<stdgo._internal.math.big.Big_int_.Int_>).setString(_test._dividend?.__copy__(), (10 : stdgo.GoInt)), _d:stdgo.Ref<stdgo._internal.math.big.Big_int_.Int_> = __tmp__._0, __9:Bool = __tmp__._1;
            var __tmp__ = (stdgo.Go.setRef(({} : stdgo._internal.math.big.Big_int_.Int_)) : stdgo.Ref<stdgo._internal.math.big.Big_int_.Int_>).setString(_test._out?.__copy__(), (10 : stdgo.GoInt)), _out:stdgo.Ref<stdgo._internal.math.big.Big_int_.Int_> = __tmp__._0, __10:Bool = __tmp__._1;
            ...
            //"file:///home/runner/.go/go1.21.3/src/math/big/nat_test.go#L354"
            if (_r != ((@:checkr _out ?? throw "null pointer dereference")._abs[((0 : stdgo.GoInt) : stdgo.GoInt)])) {
                //"file:///home/runner/.go/go1.21.3/src/math/big/nat_test.go#L355"
