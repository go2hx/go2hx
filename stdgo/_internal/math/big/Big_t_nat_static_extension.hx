        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4566538i32;
                } else if (__value__ == (4566538i32)) {
                    _i_9 = (0 : stdgo.GoInt);
                    nextRandomBreak = false;
                    _gotoNext = 4566551i32;
                } else if (__value__ == (4566551i32)) {
                    if (!nextRandomBreak && ((_i_9 < _reps : Bool))) {
                        _gotoNext = 4566577i32;
                    } else {
                        _gotoNext = 4567008i32;
                    };
                } else if (__value__ == (4566577i32)) {
                    if (((_i_9 == (_reps - (1 : stdgo.GoInt) : stdgo.GoInt)) && _force2 : Bool)) {
                        _gotoNext = 4566606i32;
                    } else {
                        _gotoNext = 4566638i32;
                    };
                } else if (__value__ == (4566606i32)) {
                    _x_5 = _x_5._set(stdgo._internal.math.big.Big__nattwo._natTwo);
                    _gotoNext = 4566705i32;
                } else if (__value__ == (4566638i32)) {
                    _gotoNext = 4566638i32;
                    _x_5 = _x_5._random(_rand_4, _nm3_3, _nm3Len_8);
                    _x_5 = _x_5._add(_x_5, stdgo._internal.math.big.Big__nattwo._natTwo);
                    var __blank__ = 0i32;
                    _gotoNext = 4566705i32;
                } else if (__value__ == (4566705i32)) {
                    ...
                    if (((_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == (0 : stdgo.GoInt)) || (_y_6._cmp(_nm1_0) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 4566776i32;
                    } else {
                        _gotoNext = 4566796i32;
                    };
                } else if (__value__ == (4566776i32)) {
                    _i_9++;
                    _gotoNext = 4566551i32;
                    ...
                    _gotoNext = 4566796i32;
                    if ((_j_10 < _k_1 : Bool)) {
                        _gotoNext = 4566825i32;
                    } else {
                        _gotoNext = 4566990i32;
                    };
                } else if (__value__ == (4566821i32)) {
                    _j_10++;
                    _gotoNext = 4566796i32;
                } else if (__value__ == (4566825i32)) {
                    _y_6 = _y_6._sqr(_y_6);
                    {
                    ...
                    if (_y_6._cmp(_nm1_0) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4566904i32;
                    } else {
                        _gotoNext = 4566938i32;
                    };
                } else if (__value__ == (4566904i32)) {
                    _i_9++;
                    _gotoNext = 4566551i32;
                } else if (__value__ == (4566938i32)) {
                    if (_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4566960i32;
                    } else {
                        _gotoNext = 4566821i32;
                    };
                } else if (__value__ == (4566960i32)) {
                    return false;
                    _gotoNext = 4566821i32;
                } else if (__value__ == (4566990i32)) {
                    return false;
                    _i_9++;
                    _gotoNext = 4566551i32;
                } else if (__value__ == (4567008i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
