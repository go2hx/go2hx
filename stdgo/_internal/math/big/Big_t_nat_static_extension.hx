        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5174087i32;
                } else if (__value__ == (5174087i32)) {
                    _i_9 = (0 : stdgo.GoInt);
                    nextRandomBreak = false;
                    _gotoNext = 5174100i32;
                } else if (__value__ == (5174100i32)) {
                    if (!nextRandomBreak && ((_i_9 < _reps : Bool))) {
                        _gotoNext = 5174126i32;
                    } else {
                        _gotoNext = 5174557i32;
                    };
                } else if (__value__ == (5174126i32)) {
                    if (((_i_9 == (_reps - (1 : stdgo.GoInt) : stdgo.GoInt)) && _force2 : Bool)) {
                        _gotoNext = 5174155i32;
                    } else {
                        _gotoNext = 5174187i32;
                    };
                } else if (__value__ == (5174155i32)) {
                    _x_5 = _x_5._set(stdgo._internal.math.big.Big__nattwo._natTwo);
                    _gotoNext = 5174254i32;
                } else if (__value__ == (5174187i32)) {
                    _gotoNext = 5174187i32;
                    _x_5 = _x_5._random(_rand_4, _nm3_3, _nm3Len_8);
                    _x_5 = _x_5._add(_x_5, stdgo._internal.math.big.Big__nattwo._natTwo);
                    var __blank__ = 0i32;
                    _gotoNext = 5174254i32;
                } else if (__value__ == (5174254i32)) {
                    ...
                    if (((_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == (0 : stdgo.GoInt)) || (_y_6._cmp(_nm1_0) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 5174325i32;
                    } else {
                        _gotoNext = 5174345i32;
                    };
                } else if (__value__ == (5174325i32)) {
                    _i_9++;
                    _gotoNext = 5174100i32;
                } else if (__value__ == (5174345i32)) {
                    _j_10 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 5174345i32;
                    if ((_j_10 < _k_1 : Bool)) {
                        _gotoNext = 5174374i32;
                    } else {
                        _gotoNext = 5174539i32;
                    };
                } else if (__value__ == (5174370i32)) {
                    _j_10++;
                    _gotoNext = 5174345i32;
                } else if (__value__ == (5174374i32)) {
                    _y_6 = _y_6._sqr(_y_6);
                    {
                    ...
                    if (_y_6._cmp(_nm1_0) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5174453i32;
                    } else {
                        _gotoNext = 5174487i32;
                    };
                } else if (__value__ == (5174453i32)) {
                    _i_9++;
                    _gotoNext = 5174100i32;
                } else if (__value__ == (5174487i32)) {
                    if (_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5174509i32;
                    } else {
                        _gotoNext = 5174370i32;
                    };
                } else if (__value__ == (5174509i32)) {
                    return false;
                    _gotoNext = 5174370i32;
                } else if (__value__ == (5174539i32)) {
                    return false;
                    _i_9++;
                    _gotoNext = 5174100i32;
                } else if (__value__ == (5174557i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
