        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if (((_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == (0 : stdgo.GoInt)) || (_y_6._cmp(_nm1_0) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 4474943i32;
                    } else {
                        _gotoNext = 4474963i32;
                    };
                } else if (__value__ == (4474943i32)) {
                    _i_9++;
                    _gotoNext = 4474718i32;
                } else if (__value__ == (4474963i32)) {
                    _j_10 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 4474963i32;
                    if ((_j_10 < _k_1 : Bool)) {
                        _gotoNext = 4474992i32;
                    } else {
                        _gotoNext = 4475157i32;
                    };
                } else if (__value__ == (4474988i32)) {
                    _j_10++;
                    _gotoNext = 4474963i32;
                } else if (__value__ == (4474992i32)) {
                    _y_6 = _y_6._sqr(_y_6);
                    {
                    ...
                    if (_y_6._cmp(_nm1_0) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4475071i32;
                    } else {
                        _gotoNext = 4475105i32;
                    };
                } else if (__value__ == (4475071i32)) {
                    _i_9++;
                    _gotoNext = 4474718i32;
                } else if (__value__ == (4475105i32)) {
                    if (_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4475127i32;
                    } else {
                        _gotoNext = 4474988i32;
                    };
                } else if (__value__ == (4475127i32)) {
                    return false;
                    _gotoNext = 4474988i32;
                } else if (__value__ == (4475157i32)) {
                    return false;
                    _i_9++;
                    _gotoNext = 4474718i32;
                } else if (__value__ == (4475175i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
