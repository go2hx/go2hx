        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4428181i32;
                } else if (__value__ == (4428181i32)) {
                    _i_9 = (0 : stdgo.GoInt);
                    nextRandomBreak = false;
                    _gotoNext = 4428194i32;
                } else if (__value__ == (4428194i32)) {
                    if (!nextRandomBreak && ((_i_9 < _reps : Bool))) {
                        _gotoNext = 4428220i32;
                    } else {
                        _gotoNext = 4428651i32;
                    };
                } else if (__value__ == (4428220i32)) {
                    if (((_i_9 == (_reps - (1 : stdgo.GoInt) : stdgo.GoInt)) && _force2 : Bool)) {
                        _gotoNext = 4428249i32;
                    } else {
                        _gotoNext = 4428281i32;
                    };
                } else if (__value__ == (4428249i32)) {
                    _x_5 = _x_5._set(stdgo._internal.math.big.Big__nattwo._natTwo);
                    _gotoNext = 4428348i32;
                } else if (__value__ == (4428281i32)) {
                    _gotoNext = 4428281i32;
                    _x_5 = _x_5._random(_rand_4, _nm3_3, _nm3Len_8);
                    _x_5 = _x_5._add(_x_5, stdgo._internal.math.big.Big__nattwo._natTwo);
                    0i32;
                    _gotoNext = 4428348i32;
                } else if (__value__ == (4428348i32)) {
                    ...
                    if (((_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == (0 : stdgo.GoInt)) || (_y_6._cmp(_nm1_0) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 4428419i32;
                    } else {
                        _gotoNext = 4428439i32;
                    };
                } else if (__value__ == (4428419i32)) {
                    _i_9++;
                    _gotoNext = 4428194i32;
                } else if (__value__ == (4428439i32)) {
                    _j_10 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 4428439i32;
                    if ((_j_10 < _k_1 : Bool)) {
                        _gotoNext = 4428468i32;
                    } else {
                        _gotoNext = 4428633i32;
                    };
                } else if (__value__ == (4428464i32)) {
                    _j_10++;
                    _gotoNext = 4428439i32;
                } else if (__value__ == (4428468i32)) {
                    _y_6 = _y_6._sqr(_y_6);
                    {
                    ...
                    if (_y_6._cmp(_nm1_0) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4428547i32;
                    } else {
                        _gotoNext = 4428581i32;
                    };
                } else if (__value__ == (4428547i32)) {
                    _i_9++;
                    _gotoNext = 4428194i32;
                } else if (__value__ == (4428581i32)) {
                    if (_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4428603i32;
                    } else {
                        _gotoNext = 4428464i32;
                    };
                } else if (__value__ == (4428603i32)) {
                    return false;
                    _gotoNext = 4428464i32;
                } else if (__value__ == (4428633i32)) {
                    return false;
                    _i_9++;
                    _gotoNext = 4428194i32;
                } else if (__value__ == (4428651i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
