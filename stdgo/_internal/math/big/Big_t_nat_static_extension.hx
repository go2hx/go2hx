        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4403505i32;
                } else if (__value__ == (4403505i32)) {
                    _i_9 = (0 : stdgo.GoInt);
                    nextRandomBreak = false;
                    _gotoNext = 4403518i32;
                } else if (__value__ == (4403518i32)) {
                    if (!nextRandomBreak && ((_i_9 < _reps : Bool))) {
                        _gotoNext = 4403544i32;
                    } else {
                        _gotoNext = 4403975i32;
                    };
                } else if (__value__ == (4403544i32)) {
                    if (((_i_9 == (_reps - (1 : stdgo.GoInt) : stdgo.GoInt)) && _force2 : Bool)) {
                        _gotoNext = 4403573i32;
                    } else {
                        _gotoNext = 4403605i32;
                    };
                } else if (__value__ == (4403573i32)) {
                    _x_5 = _x_5._set(stdgo._internal.math.big.Big__nattwo._natTwo);
                    _gotoNext = 4403672i32;
                } else if (__value__ == (4403605i32)) {
                    _gotoNext = 4403605i32;
                    _x_5 = _x_5._random(_rand_4, _nm3_3, _nm3Len_8);
                    _x_5 = _x_5._add(_x_5, stdgo._internal.math.big.Big__nattwo._natTwo);
                    0i32;
                    _gotoNext = 4403672i32;
                } else if (__value__ == (4403672i32)) {
                    ...
                    if (((_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == (0 : stdgo.GoInt)) || (_y_6._cmp(_nm1_0) == (0 : stdgo.GoInt)) : Bool)) {
                        ...
                        _gotoNext = 4403763i32;
                    };
                } else if (__value__ == (4403743i32)) {
                    _i_9++;
                    _gotoNext = 4403518i32;
                } else if (__value__ == (4403763i32)) {
                    _j_10 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 4403763i32;
                    if ((_j_10 < _k_1 : Bool)) {
                        _gotoNext = 4403792i32;
                    } else {
                        _gotoNext = 4403957i32;
                    };
                } else if (__value__ == (4403788i32)) {
                    _j_10++;
                    _gotoNext = 4403763i32;
                } else if (__value__ == (4403792i32)) {
                    _y_6 = _y_6._sqr(_y_6);
                    {
                    ...
                    if (_y_6._cmp(_nm1_0) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4403871i32;
                    } else {
                        _gotoNext = 4403905i32;
                    };
                } else if (__value__ == (4403871i32)) {
                    _i_9++;
                    _gotoNext = 4403518i32;
                } else if (__value__ == (4403905i32)) {
                    if (_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4403927i32;
                    } else {
                        _gotoNext = 4403788i32;
                    };
                } else if (__value__ == (4403927i32)) {
                    return false;
                    _gotoNext = 4403788i32;
                } else if (__value__ == (4403957i32)) {
                    return false;
                    _i_9++;
                    _gotoNext = 4403518i32;
                } else if (__value__ == (4403975i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
