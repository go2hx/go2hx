        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 5200992i32;
                } else if (__value__ == (5200992i32)) {
                    _i_9 = (0 : stdgo.GoInt);
                    nextRandomBreak = false;
                    _gotoNext = 5201005i32;
                } else if (__value__ == (5201005i32)) {
                    if (!nextRandomBreak && ((_i_9 < _reps : Bool))) {
                        _gotoNext = 5201031i32;
                    } else {
                        _gotoNext = 5201462i32;
                    };
                } else if (__value__ == (5201031i32)) {
                    if (((_i_9 == (_reps - (1 : stdgo.GoInt) : stdgo.GoInt)) && _force2 : Bool)) {
                        _gotoNext = 5201060i32;
                    } else {
                        _gotoNext = 5201092i32;
                    };
                } else if (__value__ == (5201060i32)) {
                    _x_5 = _x_5._set(stdgo._internal.math.big.Big__nattwo._natTwo);
                    _gotoNext = 5201159i32;
                } else if (__value__ == (5201092i32)) {
                    _gotoNext = 5201092i32;
                    _x_5 = _x_5._random(_rand_4, _nm3_3, _nm3Len_8);
                    _x_5 = _x_5._add(_x_5, stdgo._internal.math.big.Big__nattwo._natTwo);
                    0i32;
                    _gotoNext = 5201159i32;
                } else if (__value__ == (5201159i32)) {
                    ...
                    if (((_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == (0 : stdgo.GoInt)) || (_y_6._cmp(_nm1_0) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 5201230i32;
                    } else {
                        _gotoNext = 5201250i32;
                    };
                } else if (__value__ == (5201230i32)) {
                    _i_9++;
                    _gotoNext = 5201005i32;
                } else if (__value__ == (5201250i32)) {
                    _j_10 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 5201250i32;
                    if ((_j_10 < _k_1 : Bool)) {
                        _gotoNext = 5201279i32;
                    } else {
                        _gotoNext = 5201444i32;
                    };
                } else if (__value__ == (5201275i32)) {
                    _j_10++;
                    _gotoNext = 5201250i32;
                } else if (__value__ == (5201279i32)) {
                    _y_6 = _y_6._sqr(_y_6);
                    {
                    ...
                    if (_y_6._cmp(_nm1_0) == ((0 : stdgo.GoInt))) {
                        ...
                        _gotoNext = 5201392i32;
                    };
                } else if (__value__ == (5201358i32)) {
                    _i_9++;
                    _gotoNext = 5201005i32;
                } else if (__value__ == (5201392i32)) {
                    if (_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 5201414i32;
                    } else {
                        _gotoNext = 5201275i32;
                    };
                } else if (__value__ == (5201414i32)) {
                    return false;
                    _gotoNext = 5201275i32;
                } else if (__value__ == (5201444i32)) {
                    return false;
                    _i_9++;
                    _gotoNext = 5201005i32;
                } else if (__value__ == (5201462i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
