        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4408614i32;
                } else if (__value__ == (4408614i32)) {
                    _i_9 = (0 : stdgo.GoInt);
                    nextRandomBreak = false;
                    _gotoNext = 4408627i32;
                } else if (__value__ == (4408627i32)) {
                    if (!nextRandomBreak && ((_i_9 < _reps : Bool))) {
                        _gotoNext = 4408653i32;
                    } else {
                        _gotoNext = 4409084i32;
                    };
                } else if (__value__ == (4408653i32)) {
                    if (((_i_9 == (_reps - (1 : stdgo.GoInt) : stdgo.GoInt)) && _force2 : Bool)) {
                        _gotoNext = 4408682i32;
                    } else {
                        _gotoNext = 4408714i32;
                    };
                } else if (__value__ == (4408682i32)) {
                    _x_5 = _x_5._set(stdgo._internal.math.big.Big__nattwo._natTwo);
                    _gotoNext = 4408781i32;
                } else if (__value__ == (4408714i32)) {
                    _gotoNext = 4408714i32;
                    _x_5 = _x_5._random(_rand_4, _nm3_3, _nm3Len_8);
                    _x_5 = _x_5._add(_x_5, stdgo._internal.math.big.Big__nattwo._natTwo);
                    0i32;
                    _gotoNext = 4408781i32;
                } else if (__value__ == (4408781i32)) {
                    ...
                    if (((_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == (0 : stdgo.GoInt)) || (_y_6._cmp(_nm1_0) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 4408852i32;
                    } else {
                        _gotoNext = 4408872i32;
                    };
                } else if (__value__ == (4408852i32)) {
                    _i_9++;
                    _gotoNext = 4408627i32;
                } else if (__value__ == (4408872i32)) {
                    _j_10 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 4408872i32;
                    if ((_j_10 < _k_1 : Bool)) {
                        _gotoNext = 4408901i32;
                    } else {
                        _gotoNext = 4409066i32;
                    };
                } else if (__value__ == (4408897i32)) {
                    _j_10++;
                    _gotoNext = 4408872i32;
                } else if (__value__ == (4408901i32)) {
                    _y_6 = _y_6._sqr(_y_6);
                    {
                    ...
                    if (_y_6._cmp(_nm1_0) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4408980i32;
                    } else {
                        _gotoNext = 4409014i32;
                    };
                } else if (__value__ == (4408980i32)) {
                    _i_9++;
                    _gotoNext = 4408627i32;
                } else if (__value__ == (4409014i32)) {
                    if (_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4409036i32;
                    } else {
                        _gotoNext = 4408897i32;
                    };
                } else if (__value__ == (4409036i32)) {
                    return false;
                    _gotoNext = 4408897i32;
                } else if (__value__ == (4409066i32)) {
                    return false;
                    _i_9++;
                    _gotoNext = 4408627i32;
                } else if (__value__ == (4409084i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
