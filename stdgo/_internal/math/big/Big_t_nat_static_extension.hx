        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if (((_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == (0 : stdgo.GoInt)) || (_y_6._cmp(_nm1_0) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 4263165i32;
                    } else {
                        _gotoNext = 4263185i32;
                    };
                } else if (__value__ == (4263165i32)) {
                    _i_9++;
                    _gotoNext = 4262940i32;
                } else if (__value__ == (4263185i32)) {
                    _j_10 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 4263185i32;
                    if ((_j_10 < _k_1 : Bool)) {
                        _gotoNext = 4263214i32;
                    } else {
                        _gotoNext = 4263379i32;
                    };
                } else if (__value__ == (4263210i32)) {
                    _j_10++;
                    _gotoNext = 4263185i32;
                } else if (__value__ == (4263214i32)) {
                    _y_6 = _y_6._sqr(_y_6);
                    {
                    ...
                    if (_y_6._cmp(_nm1_0) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4263293i32;
                    } else {
                        _gotoNext = 4263327i32;
                    };
                } else if (__value__ == (4263293i32)) {
                    _i_9++;
                    _gotoNext = 4262940i32;
                } else if (__value__ == (4263327i32)) {
                    if (_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4263349i32;
                    } else {
                        _gotoNext = 4263210i32;
                    };
                } else if (__value__ == (4263349i32)) {
                    return false;
                    _gotoNext = 4263210i32;
                } else if (__value__ == (4263379i32)) {
                    return false;
                    _i_9++;
                    _gotoNext = 4262940i32;
                } else if (__value__ == (4263397i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
