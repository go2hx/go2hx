        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4272564i32;
                } else if (__value__ == (4272564i32)) {
                    if (!nextRandomBreak && ((_i_9 < _reps : Bool))) {
                        _gotoNext = 4272590i32;
                    } else {
                        _gotoNext = 4273021i32;
                    };
                } else if (__value__ == (4272590i32)) {
                    if (((_i_9 == (_reps - (1 : stdgo.GoInt) : stdgo.GoInt)) && _force2 : Bool)) {
                        _gotoNext = 4272619i32;
                    } else {
                        _gotoNext = 4272651i32;
                    };
                } else if (__value__ == (4272619i32)) {
                    _x_5 = _x_5._set(stdgo._internal.math.big.Big__nattwo._natTwo);
                    _gotoNext = 4272718i32;
                } else if (__value__ == (4272651i32)) {
                    _gotoNext = 4272651i32;
                    _x_5 = _x_5._random(_rand_4, _nm3_3, _nm3Len_8);
                    _x_5 = _x_5._add(_x_5, stdgo._internal.math.big.Big__nattwo._natTwo);
                    var __blank__ = 0i32;
                    _gotoNext = 4272718i32;
                } else if (__value__ == (4272718i32)) {
                    ...
                    if (((_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == (0 : stdgo.GoInt)) || (_y_6._cmp(_nm1_0) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 4272789i32;
                    } else {
                        _gotoNext = 4272809i32;
                    };
                } else if (__value__ == (4272789i32)) {
                    _i_9++;
                    _gotoNext = 4272564i32;
                } else if (__value__ == (4272809i32)) {
                    _j_10 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 4272809i32;
                    if ((_j_10 < _k_1 : Bool)) {
                        _gotoNext = 4272838i32;
                    } else {
                        _gotoNext = 4273003i32;
                    };
                } else if (__value__ == (4272834i32)) {
                    _j_10++;
                    _gotoNext = 4272809i32;
                } else if (__value__ == (4272838i32)) {
                    _y_6 = _y_6._sqr(_y_6);
                    {
                    ...
                    if (_y_6._cmp(_nm1_0) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4272917i32;
                    } else {
                        _gotoNext = 4272951i32;
                    };
                } else if (__value__ == (4272917i32)) {
                    _i_9++;
                    _gotoNext = 4272564i32;
                } else if (__value__ == (4272951i32)) {
                    if (_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4272973i32;
                    } else {
                        _gotoNext = 4272834i32;
                    };
                } else if (__value__ == (4272973i32)) {
                    return false;
                    _gotoNext = 4272834i32;
                } else if (__value__ == (4273003i32)) {
                    return false;
                    _i_9++;
                    _gotoNext = 4272564i32;
                } else if (__value__ == (4273021i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
