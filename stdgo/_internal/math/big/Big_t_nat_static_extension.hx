...
_t1 = _t1._sub(_t1, stdgo._internal.math.big.Big__nattwo._natTwo);
{
    ...
    static public function _probablyPrimeMillerRabin( _n:stdgo._internal.math.big.Big_t_nat.T_nat, _reps:stdgo.GoInt, _force2:Bool):Bool {
        @:recv var _n:stdgo._internal.math.big.Big_t_nat.T_nat = _n;
        var _nm3Len_4231216:stdgo.GoInt = (0 : stdgo.GoInt);
        var _quotient_4231202:stdgo._internal.math.big.Big_t_nat.T_nat = new stdgo._internal.math.big.Big_t_nat.T_nat(0, 0);
        var _rand_4231144:stdgo.Ref<stdgo._internal.math.rand.Rand_rand.Rand> = (null : stdgo.Ref<stdgo._internal.math.rand.Rand_rand.Rand>);
        var _k_4231053:stdgo.GoUInt = (0 : stdgo.GoUInt);
        var nextRandomBreak = false;
        var _x_4231196:stdgo._internal.math.big.Big_t_nat.T_nat = new stdgo._internal.math.big.Big_t_nat.T_nat(0, 0);
        var _nm3_4231110:stdgo._internal.math.big.Big_t_nat.T_nat = new stdgo._internal.math.big.Big_t_nat.T_nat(0, 0);
        var _q_4231082:stdgo._internal.math.big.Big_t_nat.T_nat = new stdgo._internal.math.big.Big_t_nat.T_nat(0, 0);
        var _nm1_4230979:stdgo._internal.math.big.Big_t_nat.T_nat = new stdgo._internal.math.big.Big_t_nat.T_nat(0, 0);
        var _j_4231502:stdgo.GoUInt = (0 : stdgo.GoUInt);
        var _i_4231257:stdgo.GoInt = (0 : stdgo.GoInt);
        var _y_4231199:stdgo._internal.math.big.Big_t_nat.T_nat = new stdgo._internal.math.big.Big_t_nat.T_nat(0, 0);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _nm1_4230979 = (new stdgo._internal.math.big.Big_t_nat.T_nat(0, 0) : stdgo._internal.math.big.Big_t_nat.T_nat)._sub(_n, stdgo._internal.math.big.Big__natone._natOne);
                    _k_4231053 = _nm1_4230979._trailingZeroBits();
                    _q_4231082 = (new stdgo._internal.math.big.Big_t_nat.T_nat(0, 0) : stdgo._internal.math.big.Big_t_nat.T_nat)._shr(_nm1_4230979, _k_4231053);
                    _nm3_4231110 = (new stdgo._internal.math.big.Big_t_nat.T_nat(0, 0) : stdgo._internal.math.big.Big_t_nat.T_nat)._sub(_nm1_4230979, stdgo._internal.math.big.Big__nattwo._natTwo);
                    _rand_4231144 = stdgo._internal.math.rand.Rand_new_.new_(stdgo._internal.math.rand.Rand_newsource.newSource((_n[(0 : stdgo.GoInt)] : stdgo.GoInt64)));
                    _nm3Len_4231216 = _nm3_4231110._bitLen();
                    _gotoNext = 4231240i32;
                } else if (__value__ == (4231240i32)) {
                    _i_4231257 = (0 : stdgo.GoInt);
                    nextRandomBreak = false;
                    _gotoNext = 4231253i32;
                } else if (__value__ == (4231253i32)) {
                    if (!nextRandomBreak && ((_i_4231257 < _reps : Bool))) {
                        _gotoNext = 4231279i32;
                    } else {
                        _gotoNext = 4231710i32;
                    };
                } else if (__value__ == (4231279i32)) {
                    if (((_i_4231257 == (_reps - (1 : stdgo.GoInt) : stdgo.GoInt)) && _force2 : Bool)) {
                        _gotoNext = 4231308i32;
                    } else {
                        _gotoNext = 4231340i32;
                    };
                } else if (__value__ == (4231308i32)) {
                    _x_4231196 = _x_4231196._set(stdgo._internal.math.big.Big__nattwo._natTwo);
                    _gotoNext = 4231407i32;
                } else if (__value__ == (4231340i32)) {
                    _gotoNext = 4231340i32;
                    _x_4231196 = _x_4231196._random(_rand_4231144, _nm3_4231110, _nm3Len_4231216);
                    _x_4231196 = _x_4231196._add(_x_4231196, stdgo._internal.math.big.Big__nattwo._natTwo);
                    var __blank__ = 0i32;
                    _gotoNext = 4231407i32;
                } else if (__value__ == (4231407i32)) {
                    _y_4231199 = _y_4231199._expNN(_x_4231196, _q_4231082, _n, false);
                    if (((_y_4231199._cmp(stdgo._internal.math.big.Big__natone._natOne) == (0 : stdgo.GoInt)) || (_y_4231199._cmp(_nm1_4230979) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 4231478i32;
                    } else {
                        _gotoNext = 4231498i32;
                    };
                } else if (__value__ == (4231478i32)) {
                    _i_4231257++;
                    _gotoNext = 4231253i32;
                } else if (__value__ == (4231498i32)) {
                    _j_4231502 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 4231498i32;
                    if ((_j_4231502 < _k_4231053 : Bool)) {
                        _gotoNext = 4231527i32;
                    } else {
                        _gotoNext = 4231692i32;
                    };
                } else if (__value__ == (4231523i32)) {
                    _j_4231502++;
                    _gotoNext = 4231498i32;
                } else if (__value__ == (4231527i32)) {
                    _y_4231199 = _y_4231199._sqr(_y_4231199);
                    {
                        var __tmp__ = _quotient_4231202._div(_y_4231199, _y_4231199, _n);
                        _quotient_4231202 = @:tmpset0 __tmp__._0;
                        _y_4231199 = @:tmpset0 __tmp__._1;
                    };
                    if (_y_4231199._cmp(_nm1_4230979) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4231606i32;
                    } else {
                        _gotoNext = 4231640i32;
                    };
                } else if (__value__ == (4231606i32)) {
                    _i_4231257++;
                    _gotoNext = 4231253i32;
                } else if (__value__ == (4231640i32)) {
                    if (_y_4231199._cmp(stdgo._internal.math.big.Big__natone._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4231662i32;
                    } else {
                        _gotoNext = 4231523i32;
                    };
                } else if (__value__ == (4231662i32)) {
                    return false;
                    _gotoNext = 4231523i32;
                } else if (__value__ == (4231692i32)) {
                    return false;
                    _i_4231257++;
                    _gotoNext = 4231253i32;
                } else if (__value__ == (4231710i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
