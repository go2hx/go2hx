            ...
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    ...
                    if (((_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == (0 : stdgo.GoInt)) || (_y_6._cmp(_nm1_0) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 4564984i64;
                    } else {
                        _gotoNext = 4565004i64;
                    };
                } else if (__value__ == (4564984i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/math/big/prime.go#L99"
                    _i_9++;
                    _gotoNext = 4564759i64;
                } else if (__value__ == (4565004i64)) {
                    _j_10 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 4565004i64;
                    //"file://#L0"
                    if ((_j_10 < _k_1 : Bool)) {
                        _gotoNext = 4565033i64;
                    } else {
                        _gotoNext = 4565198i64;
                    };
                } else if (__value__ == (4565029i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/math/big/prime.go#L110"
                    _j_10++;
                    _gotoNext = 4565004i64;
                } else if (__value__ == (4565033i64)) {
                    _y_6 = _y_6._sqr(_y_6);
                    {
                    ...
                    if (_y_6._cmp(_nm1_0) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4565112i64;
                    } else {
                        _gotoNext = 4565146i64;
                    };
                } else if (__value__ == (4565112i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/math/big/prime.go#L99"
                    _i_9++;
                    _gotoNext = 4564759i64;
                } else if (__value__ == (4565146i64)) {
                    ...
                    if (_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4565168i64;
                    } else {
                        _gotoNext = 4565029i64;
                    };
                } else if (__value__ == (4565168i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/math/big/prime.go#L117"
                    return false;
                    _gotoNext = 4565029i64;
                } else if (__value__ == (4565198i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/math/big/prime.go#L120"
                    return false;
                    //"file:///home/runner/.go/go1.21.3/src/math/big/prime.go#L99"
                    _i_9++;
                    _gotoNext = 4564759i64;
                } else if (__value__ == (4565216i64)) {
