        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if (((_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == (0 : stdgo.GoInt)) || (_y_6._cmp(_nm1_0) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 4263941i32;
                    } else {
                        _gotoNext = 4263961i32;
                    };
                } else if (__value__ == (4263941i32)) {
                    _i_9++;
                    _gotoNext = 4263716i32;
                } else if (__value__ == (4263961i32)) {
                    _j_10 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 4263961i32;
                    if ((_j_10 < _k_1 : Bool)) {
                        _gotoNext = 4263990i32;
                    } else {
                        _gotoNext = 4264155i32;
                    };
                } else if (__value__ == (4263986i32)) {
                    _j_10++;
                    _gotoNext = 4263961i32;
                } else if (__value__ == (4263990i32)) {
                    _y_6 = _y_6._sqr(_y_6);
                    {
                    ...
                    if (_y_6._cmp(_nm1_0) == ((0 : stdgo.GoInt))) {
                        ...
                        _gotoNext = 4264103i32;
                    };
                } else if (__value__ == (4264069i32)) {
                    _i_9++;
                    _gotoNext = 4263716i32;
                } else if (__value__ == (4264103i32)) {
                    if (_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4264125i32;
                    } else {
                        _gotoNext = 4263986i32;
                    };
                } else if (__value__ == (4264125i32)) {
                    return false;
                    _gotoNext = 4263986i32;
                } else if (__value__ == (4264155i32)) {
                    return false;
                    _i_9++;
                    _gotoNext = 4263716i32;
                } else if (__value__ == (4264173i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
