        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4818518i32;
                } else if (__value__ == (4818518i32)) {
                    _i_9 = (0 : stdgo.GoInt);
                    nextRandomBreak = false;
                    _gotoNext = 4818531i32;
                } else if (__value__ == (4818531i32)) {
                    if (!nextRandomBreak && ((_i_9 < _reps : Bool))) {
                        _gotoNext = 4818557i32;
                    } else {
                        _gotoNext = 4818988i32;
                    };
                } else if (__value__ == (4818557i32)) {
                    if (((_i_9 == (_reps - (1 : stdgo.GoInt) : stdgo.GoInt)) && _force2 : Bool)) {
                        _gotoNext = 4818586i32;
                    } else {
                        _gotoNext = 4818618i32;
                    };
                } else if (__value__ == (4818586i32)) {
                    _x_5 = _x_5._set(stdgo._internal.math.big.Big__nattwo._natTwo);
                    _gotoNext = 4818685i32;
                } else if (__value__ == (4818618i32)) {
                    _gotoNext = 4818618i32;
                    _x_5 = _x_5._random(_rand_4, _nm3_3, _nm3Len_8);
                    _x_5 = _x_5._add(_x_5, stdgo._internal.math.big.Big__nattwo._natTwo);
                    var __blank__ = 0i32;
                    _gotoNext = 4818685i32;
                } else if (__value__ == (4818685i32)) {
                    ...
                    if (((_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == (0 : stdgo.GoInt)) || (_y_6._cmp(_nm1_0) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 4818756i32;
                    } else {
                        _gotoNext = 4818776i32;
                    };
                } else if (__value__ == (4818756i32)) {
                    _i_9++;
                    _gotoNext = 4818531i32;
                } else if (__value__ == (4818776i32)) {
                    _j_10 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 4818776i32;
                    if ((_j_10 < _k_1 : Bool)) {
                        _gotoNext = 4818805i32;
                    } else {
                        _gotoNext = 4818970i32;
                    };
                } else if (__value__ == (4818801i32)) {
                    _j_10++;
                    _gotoNext = 4818776i32;
                } else if (__value__ == (4818805i32)) {
                    _y_6 = _y_6._sqr(_y_6);
                    {
                    ...
                    if (_y_6._cmp(_nm1_0) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4818884i32;
                    } else {
                        _gotoNext = 4818918i32;
                    };
                } else if (__value__ == (4818884i32)) {
                    _i_9++;
                    _gotoNext = 4818531i32;
                } else if (__value__ == (4818918i32)) {
                    if (_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4818940i32;
                    } else {
                        _gotoNext = 4818801i32;
                    };
                } else if (__value__ == (4818940i32)) {
                    return false;
                    _gotoNext = 4818801i32;
                } else if (__value__ == (4818970i32)) {
                    return false;
                    _i_9++;
                    _gotoNext = 4818531i32;
                } else if (__value__ == (4818988i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
...
_k0 = (_k0 * ((_t + (1u32 : stdgo._internal.math.big.Big_word.Word) : stdgo._internal.math.big.Big_word.Word)) : stdgo._internal.math.big.Big_word.Word);
        ...
        {};
        var _powers:stdgo.GoArray<stdgo._internal.math.big.Big_t_nat.T_nat> = new stdgo.GoArray<stdgo._internal.math.big.Big_t_nat.T_nat>(16, 16).__setNil__();
...
_yi = (_yi << ((4i64 : stdgo.GoUInt64)) : stdgo._internal.math.big.Big_word.Word);
    ...
    static public function _expNNWindowed( _z:stdgo._internal.math.big.Big_t_nat.T_nat, _x:stdgo._internal.math.big.Big_t_nat.T_nat, _y:stdgo._internal.math.big.Big_t_nat.T_nat, _logM:stdgo.GoUInt):stdgo._internal.math.big.Big_t_nat.T_nat {
        ...
        {};
        var _powers:stdgo.GoArray<stdgo.Ref<stdgo._internal.math.big.Big_t_nat.T_nat>> = new stdgo.GoArray<stdgo.Ref<stdgo._internal.math.big.Big_t_nat.T_nat>>(16, 16).__setNil__();
        for (_i => _ in _powers) {
