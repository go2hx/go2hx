        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4734534i32;
                } else if (__value__ == (4734534i32)) {
                    _i_9 = (0 : stdgo.GoInt);
                    nextRandomBreak = false;
                    _gotoNext = 4734547i32;
                } else if (__value__ == (4734547i32)) {
                    if (!nextRandomBreak && ((_i_9 < _reps : Bool))) {
                        _gotoNext = 4734573i32;
                    } else {
                        _gotoNext = 4735004i32;
                    };
                } else if (__value__ == (4734573i32)) {
                    if (((_i_9 == (_reps - (1 : stdgo.GoInt) : stdgo.GoInt)) && _force2 : Bool)) {
                        _gotoNext = 4734602i32;
                    } else {
                        _gotoNext = 4734634i32;
                    };
                } else if (__value__ == (4734602i32)) {
                    _x_5 = _x_5._set(stdgo._internal.math.big.Big__nattwo._natTwo);
                    _gotoNext = 4734701i32;
                } else if (__value__ == (4734634i32)) {
                    _gotoNext = 4734634i32;
                    _x_5 = _x_5._random(_rand_4, _nm3_3, _nm3Len_8);
                    _x_5 = _x_5._add(_x_5, stdgo._internal.math.big.Big__nattwo._natTwo);
                    0i32;
                    _gotoNext = 4734701i32;
                } else if (__value__ == (4734701i32)) {
                    ...
                    if (((_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == (0 : stdgo.GoInt)) || (_y_6._cmp(_nm1_0) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 4734772i32;
                    } else {
                        _gotoNext = 4734792i32;
                    };
                } else if (__value__ == (4734772i32)) {
                    _i_9++;
                    _gotoNext = 4734547i32;
                } else if (__value__ == (4734792i32)) {
                    _j_10 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 4734792i32;
                    if ((_j_10 < _k_1 : Bool)) {
                        _gotoNext = 4734821i32;
                    } else {
                        _gotoNext = 4734986i32;
                    };
                } else if (__value__ == (4734817i32)) {
                    _j_10++;
                    _gotoNext = 4734792i32;
                } else if (__value__ == (4734821i32)) {
                    _y_6 = _y_6._sqr(_y_6);
                    {
                    ...
                    if (_y_6._cmp(_nm1_0) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4734900i32;
                    } else {
                        _gotoNext = 4734934i32;
                    };
                } else if (__value__ == (4734900i32)) {
                    _i_9++;
                    _gotoNext = 4734547i32;
                } else if (__value__ == (4734934i32)) {
                    if (_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4734956i32;
                    } else {
                        _gotoNext = 4734817i32;
                    };
                } else if (__value__ == (4734956i32)) {
                    return false;
                    _gotoNext = 4734817i32;
                } else if (__value__ == (4734986i32)) {
                    return false;
                    _i_9++;
                    _gotoNext = 4734547i32;
                } else if (__value__ == (4735004i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
