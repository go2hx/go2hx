        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4719783i32;
                } else if (__value__ == (4719783i32)) {
                    _i_9 = (0 : stdgo.GoInt);
                    nextRandomBreak = false;
                    _gotoNext = 4719796i32;
                } else if (__value__ == (4719796i32)) {
                    if (!nextRandomBreak && ((_i_9 < _reps : Bool))) {
                        _gotoNext = 4719822i32;
                    } else {
                        _gotoNext = 4720253i32;
                    };
                } else if (__value__ == (4719822i32)) {
                    if (((_i_9 == (_reps - (1 : stdgo.GoInt) : stdgo.GoInt)) && _force2 : Bool)) {
                        _gotoNext = 4719851i32;
                    } else {
                        _gotoNext = 4719883i32;
                    };
                } else if (__value__ == (4719851i32)) {
                    _x_5 = _x_5._set(stdgo._internal.math.big.Big__nattwo._natTwo);
                    _gotoNext = 4719950i32;
                } else if (__value__ == (4719883i32)) {
                    _gotoNext = 4719883i32;
                    _x_5 = _x_5._random(_rand_4, _nm3_3, _nm3Len_8);
                    _x_5 = _x_5._add(_x_5, stdgo._internal.math.big.Big__nattwo._natTwo);
                    var __blank__ = 0i32;
                    _gotoNext = 4719950i32;
                } else if (__value__ == (4719950i32)) {
                    ...
                    if (((_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == (0 : stdgo.GoInt)) || (_y_6._cmp(_nm1_0) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 4720021i32;
                    } else {
                        _gotoNext = 4720041i32;
                    };
                } else if (__value__ == (4720021i32)) {
                    _i_9++;
                    _gotoNext = 4719796i32;
                } else if (__value__ == (4720041i32)) {
                    _j_10 = (1u32 : stdgo.GoUInt);
                    _gotoNext = 4720041i32;
                    if ((_j_10 < _k_1 : Bool)) {
                        _gotoNext = 4720070i32;
                    } else {
                        _gotoNext = 4720235i32;
                    };
                } else if (__value__ == (4720066i32)) {
                    _j_10++;
                    _gotoNext = 4720041i32;
                } else if (__value__ == (4720070i32)) {
                    _y_6 = _y_6._sqr(_y_6);
                    {
                    ...
                    if (_y_6._cmp(_nm1_0) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4720149i32;
                    } else {
                        _gotoNext = 4720183i32;
                    };
                } else if (__value__ == (4720149i32)) {
                    _i_9++;
                    _gotoNext = 4719796i32;
                } else if (__value__ == (4720183i32)) {
                    if (_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4720205i32;
                    } else {
                        _gotoNext = 4720066i32;
                    };
                } else if (__value__ == (4720205i32)) {
                    return false;
                    _gotoNext = 4720066i32;
                } else if (__value__ == (4720235i32)) {
                    return false;
                    _i_9++;
                    _gotoNext = 4719796i32;
                } else if (__value__ == (4720253i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
