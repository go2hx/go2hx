        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4448163i32;
                } else if (__value__ == (4448163i32)) {
                    _i_9 = (0 : stdgo.GoInt);
                    nextRandomBreak = false;
                    _gotoNext = 4448176i32;
                } else if (__value__ == (4448176i32)) {
                    if (!nextRandomBreak && ((_i_9 < _reps : Bool))) {
                        _gotoNext = 4448202i32;
                    } else {
                        _gotoNext = 4448633i32;
                    };
                } else if (__value__ == (4448202i32)) {
                    if (((_i_9 == (_reps - (1 : stdgo.GoInt) : stdgo.GoInt)) && _force2 : Bool)) {
                        _gotoNext = 4448231i32;
                    } else {
                        _gotoNext = 4448263i32;
                    };
                } else if (__value__ == (4448231i32)) {
                    _x_5 = _x_5._set(stdgo._internal.math.big.Big__nattwo._natTwo);
                    _gotoNext = 4448330i32;
                } else if (__value__ == (4448263i32)) {
                    _gotoNext = 4448263i32;
                    _x_5 = _x_5._random(_rand_4, _nm3_3, _nm3Len_8);
                    _x_5 = _x_5._add(_x_5, stdgo._internal.math.big.Big__nattwo._natTwo);
                    var __blank__ = 0i32;
                    _gotoNext = 4448330i32;
                } else if (__value__ == (4448330i32)) {
                    ...
                    if (((_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == (0 : stdgo.GoInt)) || (_y_6._cmp(_nm1_0) == (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 4448401i32;
                    } else {
                        _gotoNext = 4448421i32;
                    };
                } else if (__value__ == (4448401i32)) {
                    _i_9++;
                    _gotoNext = 4448176i32;
                    ...
                    _gotoNext = 4448421i32;
                    if ((_j_10 < _k_1 : Bool)) {
                        _gotoNext = 4448450i32;
                    } else {
                        _gotoNext = 4448615i32;
                    };
                } else if (__value__ == (4448446i32)) {
                    _j_10++;
                    _gotoNext = 4448421i32;
                } else if (__value__ == (4448450i32)) {
                    _y_6 = _y_6._sqr(_y_6);
                    {
                    ...
                    if (_y_6._cmp(_nm1_0) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4448529i32;
                    } else {
                        _gotoNext = 4448563i32;
                    };
                } else if (__value__ == (4448529i32)) {
                    _i_9++;
                    _gotoNext = 4448176i32;
                } else if (__value__ == (4448563i32)) {
                    if (_y_6._cmp(stdgo._internal.math.big.Big__natone._natOne) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 4448585i32;
                    } else {
                        _gotoNext = 4448446i32;
                    };
                } else if (__value__ == (4448585i32)) {
                    return false;
                    _gotoNext = 4448446i32;
                } else if (__value__ == (4448615i32)) {
                    return false;
                    _i_9++;
                    _gotoNext = 4448176i32;
                } else if (__value__ == (4448633i32)) {
                    return true;
                    _gotoNext = -1i32;
                };
            };
