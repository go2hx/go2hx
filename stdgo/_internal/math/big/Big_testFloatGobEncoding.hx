            ...
            for (__15 => _sign in (new stdgo.Slice<stdgo.GoString>(3, 3, ...[stdgo.Go.str()?.__copy__(), ("+" : stdgo.GoString), ("-" : stdgo.GoString)]).__setString__() : stdgo.Slice<stdgo.GoString>)) {
                for (__16 => _prec in (new stdgo.Slice<stdgo.GoUInt>(8, 8, ...[(0u32 : stdgo.GoUInt), (1u32 : stdgo.GoUInt), (2u32 : stdgo.GoUInt), (10u32 : stdgo.GoUInt), (53u32 : stdgo.GoUInt), (64u32 : stdgo.GoUInt), (100u32 : stdgo.GoUInt), (1000u32 : stdgo.GoUInt)]).__setNumber32__() : stdgo.Slice<stdgo.GoUInt>)) {
                    for (__17 => _mode in (new stdgo.Slice<stdgo._internal.math.big.Big_RoundingMode.RoundingMode>(6, 6, ...[(0 : stdgo._internal.math.big.Big_RoundingMode.RoundingMode), (1 : stdgo._internal.math.big.Big_RoundingMode.RoundingMode), (2 : stdgo._internal.math.big.Big_RoundingMode.RoundingMode), (3 : stdgo._internal.math.big.Big_RoundingMode.RoundingMode), (4 : stdgo._internal.math.big.Big_RoundingMode.RoundingMode), (5 : stdgo._internal.math.big.Big_RoundingMode.RoundingMode)]).__setNumber32__() : stdgo.Slice<stdgo._internal.math.big.Big_RoundingMode.RoundingMode>)) {
                        ...
                        var __tmp__ = _tx.setPrec(_prec).setMode(_mode).parse(_x?.__copy__(), (0 : stdgo.GoInt)), __18:stdgo.Ref<stdgo._internal.math.big.Big_Float_.Float_> = __tmp__._0, __19:stdgo.GoInt = __tmp__._1, _err:stdgo.Error = __tmp__._2;
                        if (_err != null) {
