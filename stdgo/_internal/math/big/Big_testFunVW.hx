...
function testFunVW(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        for (__14 => _a in stdgo._internal.math.big.Big__sumVW._sumVW) {
        ...
        for (__15 => _a in stdgo._internal.math.big.Big__lshVW._lshVW) {
            var _arg = (_a?.__copy__() : stdgo._internal.math.big.Big_T_argVW.T_argVW);
        ...
        for (__16 => _a in stdgo._internal.math.big.Big__rshVW._rshVW) {
            var _arg = (_a?.__copy__() : stdgo._internal.math.big.Big_T_argVW.T_argVW);
