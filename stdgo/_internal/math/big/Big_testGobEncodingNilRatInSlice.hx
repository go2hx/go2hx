...
function testGobEncodingNilRatInSlice(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        var _in__pointer__ = (stdgo.Go.setRef(_in) : stdgo.Ref<stdgo.Slice<stdgo.Ref<stdgo._internal.math.big.Big_Rat.Rat>>>);
        var _in__pointer__ = (stdgo.Go.setRef(_in) : stdgo.Ref<stdgo.Slice<stdgo.Ref<stdgo._internal.math.big.Big_Rat.Rat>>>);
        var _in__pointer__ = (stdgo.Go.setRef(_in) : stdgo.Ref<stdgo.Slice<stdgo.Ref<stdgo._internal.math.big.Big_Rat.Rat>>>);
        var _in__pointer__ = (stdgo.Go.setRef(_in) : stdgo.Ref<stdgo.Slice<stdgo.Ref<stdgo._internal.math.big.Big_Rat.Rat>>>);
        var _err = (_enc.encode(stdgo.Go.toInterface(_in__pointer__)) : stdgo.Error);
        if (_err != null) {
        ...
        var _out__pointer__ = (stdgo.Go.setRef(_out) : stdgo.Ref<stdgo.Slice<stdgo.Ref<stdgo._internal.math.big.Big_Rat.Rat>>>);
        var _out__pointer__ = (stdgo.Go.setRef(_out) : stdgo.Ref<stdgo.Slice<stdgo.Ref<stdgo._internal.math.big.Big_Rat.Rat>>>);
        var _out__pointer__ = (stdgo.Go.setRef(_out) : stdgo.Ref<stdgo.Slice<stdgo.Ref<stdgo._internal.math.big.Big_Rat.Rat>>>);
        var _out__pointer__ = (stdgo.Go.setRef(_out) : stdgo.Ref<stdgo.Slice<stdgo.Ref<stdgo._internal.math.big.Big_Rat.Rat>>>);
        ...
        var _zero__pointer__ = (stdgo.Go.setRef(_zero) : stdgo.Ref<stdgo._internal.math.big.Big_Rat.Rat>);
        var _zero__pointer__ = (stdgo.Go.setRef(_zero) : stdgo.Ref<stdgo._internal.math.big.Big_Rat.Rat>);
        var _zero__pointer__ = (stdgo.Go.setRef(_zero) : stdgo.Ref<stdgo._internal.math.big.Big_Rat.Rat>);
        var _zero__pointer__ = (stdgo.Go.setRef(_zero) : stdgo.Ref<stdgo._internal.math.big.Big_Rat.Rat>);
        if (_out[(0 : stdgo.GoInt)].cmp(_zero__pointer__) != ((0 : stdgo.GoInt))) {
