...
function testRatScan(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        for (_i => _test in stdgo._internal.math.big.Big__setStringTests._setStringTests) {
            ...
            var __tmp__ = stdgo._internal.fmt.Fmt_fscanf.fscanf(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo._internal.bytes.Bytes_Buffer.Buffer>)), ("%v" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_x))), __14:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
