...
function testScan(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        for (_i => _test in stdgo._internal.math.big.Big__scanTests._scanTests) {
            ...
            {
                var __tmp__ = stdgo._internal.fmt.Fmt_fscanf.fscanf(stdgo.Go.asInterface(_buf__pointer__), _test._format?.__copy__(), stdgo.Go.toInterface(stdgo.Go.asInterface(_x))), __8:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
