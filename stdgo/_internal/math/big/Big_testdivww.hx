...
function testDivWW(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/math/big/arith_test.go#L600"
        for (_i => _test in stdgo._internal.math.big.Big__divwwtests._divWWTests) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/math/big/arith_test.go#L603"
            if (((_q != _test._q) || (_r != _test._r) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/math/big/arith_test.go#L604"
        ...
        //"file:///home/runner/.go/go1.21.3/src/math/big/arith_test.go#L608"
...
//"file:///home/runner/.go/go1.21.3/src/math/big/arith_test.go#L612"
            if ((_x1 >= _y : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/math/big/arith_test.go#L613"
                {
                    _i++;
                    continue;
                };
...
//"file:///home/runner/.go/go1.21.3/src/math/big/arith_test.go#L618"
            if ((((_qGot : stdgo.GoUInt) != _qWant) || ((_rGot : stdgo.GoUInt) != _rWant) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/math/big/arith_test.go#L619"
