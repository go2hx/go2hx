...
var _y0 = __1, _x0 = __0;
                    ...
                    var _z = @:check2r (stdgo.Go.setRef(({} : stdgo._internal.math.big.Big_float_.Float_)) : stdgo.Ref<stdgo._internal.math.big.Big_float_.Float_>).setPrec((24u32 : stdgo.GoUInt));
                    @:check2r _z.add(_x, _y);
                    var __tmp__ = @:check2r _z.float32(), _got:stdgo.GoFloat32 = __tmp__._0, _acc:stdgo._internal.math.big.Big_accuracy.Accuracy = __tmp__._1;
