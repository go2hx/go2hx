...
function testFromBits(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        //"file:///home/runner/.go/go1.21.3/src/math/big/bits_test.go#L200"
...
({ _bits : ((new stdgo.Slice<stdgo.GoInt>(3, 3, ...[(2 : stdgo.GoInt), (1 : stdgo.GoInt), (0 : stdgo.GoInt)]).__setNumber32__() : stdgo._internal.math.big.Big_bits.Bits).__append__(...((new stdgo.Slice<stdgo.GoInt>(2, 2, ...[(3 : stdgo.GoInt), (1 : stdgo.GoInt)]).__setNumber32__() : stdgo._internal.math.big.Big_bits.Bits) : Array<stdgo.GoInt>)) : stdgo._internal.math.big.Big_bits.Bits), _want : ("0x.88p+5" : stdgo.GoString) } : stdgo._internal.math.big.Big_t__struct_6.T__struct_6)].concat([for (i in 11 ... (11 > 11 ? 11 : 11 : stdgo.GoInt).toBasic()) ({ _bits : (new stdgo._internal.math.big.Big_bits.Bits(0, 0) : stdgo._internal.math.big.Big_bits.Bits), _want : ("" : stdgo.GoString) } : stdgo._internal.math.big.Big_t__struct_6.T__struct_6)])) : stdgo.Slice<stdgo._internal.math.big.Big_t__struct_6.T__struct_6>)) {
            var _f = _test._bits.float_();
            //"file:///home/runner/.go/go1.21.3/src/math/big/bits_test.go#L220"
            {
                var _got = (_f.text((112 : stdgo.GoUInt8), (0 : stdgo.GoInt))?.__copy__() : stdgo.GoString);
                if (_got != (_test._want)) {
                    //"file:///home/runner/.go/go1.21.3/src/math/big/bits_test.go#L221"
