...
function testIssue37499(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/math/big/nat_test.go#L871"
        _q._divBasic(_u, _v);
        _q = _q._norm();
        //"file:///home/runner/.go/go1.21.3/src/math/big/nat_test.go#L873"
        {
            ...
            if (_s != (("fffffffffffffffffffffffffffffffffffffffffffffffb" : stdgo.GoString))) {
                //"file:///home/runner/.go/go1.21.3/src/math/big/nat_test.go#L874"
