...
function testRsh(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        //"file:///home/runner/.go/go1.21.3/src/math/big/int_test.go#L948"
        for (_i => _test in stdgo._internal.math.big.Big__rshtests._rshTests) {
            ...
            var _out = (stdgo.Go.setRef(({} : stdgo._internal.math.big.Big_int_.Int_)) : stdgo.Ref<stdgo._internal.math.big.Big_int_.Int_>).rsh(_in, _test._shift);
            //"file:///home/runner/.go/go1.21.3/src/math/big/int_test.go#L953"
            if (!stdgo._internal.math.big.Big__isnormalized._isNormalized(_out)) {
                //"file:///home/runner/.go/go1.21.3/src/math/big/int_test.go#L954"
            ...
            //"file:///home/runner/.go/go1.21.3/src/math/big/int_test.go#L956"
            if (_out.cmp(_expected) != ((0 : stdgo.GoInt))) {
                //"file:///home/runner/.go/go1.21.3/src/math/big/int_test.go#L957"
