...
function testShiftLeft(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        //"file:///home/runner/.go/go1.21.3/src/math/big/nat_test.go#L270"
        for (_i => _test in stdgo._internal.math.big.Big__leftshifttests._leftShiftTests) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/math/big/nat_test.go#L273"
            for (_j => _d in _test._out) {
                //"file:///home/runner/.go/go1.21.3/src/math/big/nat_test.go#L274"
                if (((_j >= (_z.length) : Bool) || (_z[(_j : stdgo.GoInt)] != _d) : Bool)) {
                    //"file:///home/runner/.go/go1.21.3/src/math/big/nat_test.go#L275"
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/math/big/nat_test.go#L276"
                    break;
                };
            };
        };
