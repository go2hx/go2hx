...
function mul(_x:stdgo.GoUInt, _y:stdgo.GoUInt):{ var _0 : stdgo.GoUInt; var _1 : stdgo.GoUInt; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/math/bits/bits.go#L446"
        if (true) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/math/bits/bits.go#L448"
            return {
        ...
        //"file:///home/runner/.go/go1.21.3/src/math/bits/bits.go#L451"
        return {
            @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoUInt; var _1 : stdgo.GoUInt; } = { _0 : (_h : stdgo.GoUInt), _1 : (_l : stdgo.GoUInt) };
            _hi = __tmp__._0;
            _lo = __tmp__._1;
