...
function pow(_x:stdgo.GoComplex128, _y:stdgo.GoComplex128):stdgo.GoComplex128 {
        if (_x == (((0f64 : stdgo.GoFloat64) + new stdgo.GoComplex128(0f64, 0f64)))) {
            ...
            var __0 = (_y.real : stdgo.GoFloat64), __1 = (_y.imag : stdgo.GoFloat64);
var _i = __1, _r = __0;
        ...
        var _r = (stdgo._internal.math.Math_pow.pow(_modulus, _y.real) : stdgo.GoFloat64);
        var _arg = (stdgo._internal.math.cmplx.Cmplx_phase.phase(_x) : stdgo.GoFloat64);
        var _theta = (_y.real * _arg : stdgo.GoFloat64);
        if (_y.imag != (0 : stdgo.GoFloat64)) {
            _r = (_r * (stdgo._internal.math.Math_exp.exp((-_y.imag * _arg : stdgo.GoFloat64))) : stdgo.GoFloat64);
            _theta = (_theta + ((_y.imag * stdgo._internal.math.Math_log.log(_modulus) : stdgo.GoFloat64)) : stdgo.GoFloat64);
        };
