...
var _im = __1, _re = __0;
        ...
        var _d = (stdgo._internal.math.Math_cos.cos(((2 : stdgo.GoFloat64) * _x.real : stdgo.GoFloat64)) + stdgo._internal.math.Math_cosh.cosh(((2 : stdgo.GoFloat64) * _x.imag : stdgo.GoFloat64)) : stdgo.GoFloat64);
        ...
        return new stdgo.GoComplex128((stdgo._internal.math.Math_sin.sin(((2 : stdgo.GoFloat64) * _x.real : stdgo.GoFloat64)) / _d : stdgo.GoFloat64), (stdgo._internal.math.Math_sinh.sinh(((2 : stdgo.GoFloat64) * _x.imag : stdgo.GoFloat64)) / _d : stdgo.GoFloat64));
    }
