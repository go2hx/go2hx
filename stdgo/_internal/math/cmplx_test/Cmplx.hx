...
(new stdgo._internal.testing.Testing.InternalTest(("TestTanHuge" : stdgo.GoString), stdgo._internal.math.cmplx.Cmplx.testTanHuge) : stdgo._internal.testing.Testing.InternalTest)]) : stdgo.Slice<stdgo._internal.testing.Testing.InternalTest>);
...
(new stdgo._internal.testing.Testing.InternalBenchmark(("BenchmarkTanh" : stdgo.GoString), stdgo._internal.math.cmplx.Cmplx.benchmarkTanh) : stdgo._internal.testing.Testing.InternalBenchmark)]) : stdgo.Slice<stdgo._internal.testing.Testing.InternalBenchmark>);
