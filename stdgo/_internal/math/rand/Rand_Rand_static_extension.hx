...
_m[(_j : stdgo.GoInt)] = _i;
    ...
    static public function float32( _r:stdgo.Ref<stdgo._internal.math.rand.Rand_Rand.Rand>):stdgo.GoFloat32 {
        @:recv var _r:stdgo.Ref<stdgo._internal.math.rand.Rand_Rand.Rand> = _r;
        var _f_2627719:stdgo.GoFloat32 = (0 : stdgo.GoFloat32);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2627711i32;
                } else if (__value__ == (2627711i32)) {
                    _f_2627719 = (@:check2r _r.float64() : stdgo.GoFloat32);
                    if (_f_2627719 == (1 : stdgo.GoFloat64)) {
                        _gotoNext = 2627756i32;
                    } else {
                        _gotoNext = 2627824i32;
                    };
                } else if (__value__ == (2627756i32)) {
                    _gotoNext = 2627711i32;
                } else if (__value__ == (2627824i32)) {
                    return _f_2627719;
                    _gotoNext = -1i32;
                };
            };
    ...
    static public function float64( _r:stdgo.Ref<stdgo._internal.math.rand.Rand_Rand.Rand>):stdgo.GoFloat64 {
        @:recv var _r:stdgo.Ref<stdgo._internal.math.rand.Rand_Rand.Rand> = _r;
        var _f_2627251:stdgo.GoFloat64 = (0 : stdgo.GoFloat64);
        var _gotoNext = 0i32;
        var __blank__ = _gotoNext == ((0i32 : stdgo.GoInt));
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                final __value__ = _gotoNext;
                if (__value__ == (0i32)) {
                    _gotoNext = 2627243i32;
                } else if (__value__ == (2627243i32)) {
                    _f_2627251 = ((@:check2r _r.int63() : stdgo.GoFloat64) / (9.223372036854776e+18 : stdgo.GoFloat64) : stdgo.GoFloat64);
                    if (_f_2627251 == (1 : stdgo.GoFloat64)) {
                        _gotoNext = 2627298i32;
                    } else {
                        _gotoNext = 2627360i32;
                    };
                } else if (__value__ == (2627298i32)) {
                    _gotoNext = 2627243i32;
                } else if (__value__ == (2627360i32)) {
                    return _f_2627251;
                    _gotoNext = -1i32;
                };
            };
