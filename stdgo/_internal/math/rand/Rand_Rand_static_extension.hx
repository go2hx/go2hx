...
_m[(_j : stdgo.GoInt)] = _i;
    ...
    static public function float32( _r:stdgo.Ref<stdgo._internal.math.rand.Rand_Rand.Rand>):stdgo.GoFloat32 {
        @:recv var _r:stdgo.Ref<stdgo._internal.math.rand.Rand_Rand.Rand> = _r;
        var _f_3015756:stdgo.GoFloat32 = (0 : stdgo.GoFloat32);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 3015748i32;
                } else if (__value__ == (3015748i32)) {
                    _f_3015756 = (_r.float64() : stdgo.GoFloat32);
                    if (_f_3015756 == (1 : stdgo.GoFloat64)) {
                        _gotoNext = 3015793i32;
                    } else {
                        _gotoNext = 3015861i32;
                    };
                } else if (__value__ == (3015793i32)) {
                    _gotoNext = 3015748i32;
                } else if (__value__ == (3015861i32)) {
                    return _f_3015756;
                    _gotoNext = -1i32;
                };
            };
    ...
    static public function float64( _r:stdgo.Ref<stdgo._internal.math.rand.Rand_Rand.Rand>):stdgo.GoFloat64 {
        @:recv var _r:stdgo.Ref<stdgo._internal.math.rand.Rand_Rand.Rand> = _r;
        var _f_3015288:stdgo.GoFloat64 = (0 : stdgo.GoFloat64);
        var _gotoNext = 0i32;
        var __blank__ = _gotoNext == ((0i32 : stdgo.GoInt));
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                final __value__ = _gotoNext;
                if (__value__ == (0i32)) {
                    _gotoNext = 3015280i32;
                } else if (__value__ == (3015280i32)) {
                    _f_3015288 = ((_r.int63() : stdgo.GoFloat64) / (9.223372036854776e+18 : stdgo.GoFloat64) : stdgo.GoFloat64);
                    if (_f_3015288 == (1 : stdgo.GoFloat64)) {
                        _gotoNext = 3015335i32;
                    } else {
                        _gotoNext = 3015397i32;
                    };
                } else if (__value__ == (3015335i32)) {
                    _gotoNext = 3015280i32;
                } else if (__value__ == (3015397i32)) {
                    return _f_3015288;
                    _gotoNext = -1i32;
                };
            };
