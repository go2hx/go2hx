        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2846685i32;
                } else if (__value__ == (2846685i32)) {
                    _f_1 = (@:check2r _r.float64() : stdgo.GoFloat32);
                    if (_f_1 == (1 : stdgo.GoFloat64)) {
                        _gotoNext = 2846730i32;
                    } else {
                        _gotoNext = 2846798i32;
                    };
                } else if (__value__ == (2846730i32)) {
                    _gotoNext = 2846685i32;
                } else if (__value__ == (2846798i32)) {
                    return _f_1;
                    _gotoNext = -1i32;
                };
            };
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                final __value__ = _gotoNext;
                if (__value__ == (0i32)) {
                    _gotoNext = 2846217i32;
                } else if (__value__ == (2846217i32)) {
                    ...
                    if (_f_0 == (1 : stdgo.GoFloat64)) {
                        ...
                        _gotoNext = 2846334i32;
                    };
                } else if (__value__ == (2846272i32)) {
                    _gotoNext = 2846217i32;
                } else if (__value__ == (2846334i32)) {
                    return _f_0;
                    _gotoNext = -1i32;
                };
            };
