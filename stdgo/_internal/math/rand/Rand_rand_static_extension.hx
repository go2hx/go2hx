        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                final __value__ = _gotoNext;
                if (__value__ == (0i32)) {
                    _gotoNext = 3025674i32;
                } else if (__value__ == (3025674i32)) {
                    _f_0 = ((@:check2r _r.int63() : stdgo.GoFloat64) / (9.223372036854776e+18 : stdgo.GoFloat64) : stdgo.GoFloat64);
                    if (_f_0 == (1 : stdgo.GoFloat64)) {
                        _gotoNext = 3025729i32;
                    } else {
                        _gotoNext = 3025791i32;
                    };
                } else if (__value__ == (3025729i32)) {
                    _gotoNext = 3025674i32;
                } else if (__value__ == (3025791i32)) {
                    return _f_0;
                    _gotoNext = -1i32;
                };
            };
