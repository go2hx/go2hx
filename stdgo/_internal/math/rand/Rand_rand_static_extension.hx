...
_m[(_j : stdgo.GoInt)] = _i;
    ...
    static public function float32( _r:stdgo.Ref<stdgo._internal.math.rand.Rand_rand.Rand>):stdgo.GoFloat32 {
        @:recv var _r:stdgo.Ref<stdgo._internal.math.rand.Rand_rand.Rand> = _r;
        var _f_2842740:stdgo.GoFloat32 = (0 : stdgo.GoFloat32);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2842732i32;
                } else if (__value__ == (2842732i32)) {
                    _f_2842740 = (@:check2r _r.float64() : stdgo.GoFloat32);
                    if (_f_2842740 == (1 : stdgo.GoFloat64)) {
                        _gotoNext = 2842777i32;
                    } else {
                        _gotoNext = 2842845i32;
                    };
                } else if (__value__ == (2842777i32)) {
                    _gotoNext = 2842732i32;
                } else if (__value__ == (2842845i32)) {
                    return _f_2842740;
                    _gotoNext = -1i32;
                };
            };
    ...
    static public function float64( _r:stdgo.Ref<stdgo._internal.math.rand.Rand_rand.Rand>):stdgo.GoFloat64 {
        @:recv var _r:stdgo.Ref<stdgo._internal.math.rand.Rand_rand.Rand> = _r;
        var _f_2842272:stdgo.GoFloat64 = (0 : stdgo.GoFloat64);
        var _gotoNext = 0i32;
        var __blank__ = _gotoNext == ((0i32 : stdgo.GoInt));
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _f_2842272 = ((@:check2r _r.int63() : stdgo.GoFloat64) / (9.223372036854776e+18 : stdgo.GoFloat64) : stdgo.GoFloat64);
                    if (_f_2842272 == (1 : stdgo.GoFloat64)) {
                        _gotoNext = 2842319i32;
                    } else {
                        _gotoNext = 2842381i32;
                    };
                } else if (__value__ == (2842319i32)) {
                    _gotoNext = 2842264i32;
                } else if (__value__ == (2842381i32)) {
                    return _f_2842272;
                    _gotoNext = -1i32;
                };
            };
