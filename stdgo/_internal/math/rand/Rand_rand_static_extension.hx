        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2866309i32;
                } else if (__value__ == (2866309i32)) {
                    _f_1 = (@:check2r _r.float64() : stdgo.GoFloat32);
                    if (_f_1 == (1 : stdgo.GoFloat64)) {
                        _gotoNext = 2866354i32;
                    } else {
                        _gotoNext = 2866422i32;
                    };
                } else if (__value__ == (2866354i32)) {
                    _gotoNext = 2866309i32;
                } else if (__value__ == (2866422i32)) {
                    return _f_1;
                    _gotoNext = -1i32;
                };
            };
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if (_f_0 == (1 : stdgo.GoFloat64)) {
                        _gotoNext = 2865896i32;
                    } else {
                        _gotoNext = 2865958i32;
                    };
                } else if (__value__ == (2865896i32)) {
                    _gotoNext = 2865841i32;
                } else if (__value__ == (2865958i32)) {
                    return _f_0;
                    _gotoNext = -1i32;
                };
            };
