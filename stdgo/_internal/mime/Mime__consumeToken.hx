...
function _consumeToken(_v:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : stdgo.GoString; } {
        ...
        if (_notPos == ((-1 : stdgo.GoInt))) {
            return { _0 : _v?.__copy__(), _1 : stdgo.Go.str()?.__copy__() };
        };
        if (_notPos == ((0 : stdgo.GoInt))) {
            return { _0 : stdgo.Go.str()?.__copy__(), _1 : _v?.__copy__() };
        };
        return { _0 : (_v.__slice__((0 : stdgo.GoInt), _notPos) : stdgo.GoString)?.__copy__(), _1 : (_v.__slice__(_notPos) : stdgo.GoString)?.__copy__() };
    }
