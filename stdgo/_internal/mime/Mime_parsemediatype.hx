...
function parseMediaType(_v:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : stdgo.GoMap<stdgo.GoString, stdgo.GoString>; var _2 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L144"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L145"
            return {
        ...
        //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L156"
        while (((_v.length) > (0 : stdgo.GoInt) : Bool)) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L158"
            if ((_v.length) == ((0 : stdgo.GoInt))) {
                //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L159"
                break;
            };
            ...
            //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L162"
            if (_key == ((stdgo.Go.str() : stdgo.GoString))) {
                //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L163"
                if (stdgo._internal.strings.Strings_trimspace.trimSpace(_rest?.__copy__()) == ((";" : stdgo.GoString))) {
                    //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L166"
                    break;
                };
                //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L169"
                return {
            ...
            var _pmap = _params;
            //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L173"
            {
                ...
                if (_ok) {
                    //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L174"
                    ...
                    var _ok:Bool = false;
                    //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L178"
                    {
                        {
            ...
            //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L183"
            {
                ...
                if ((_exists && (_v != _value) : Bool)) {
                    //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L185"
                    return {
        ...
        //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L194"
        for (_key => _pieceMap in _continuation) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L196"
            {
                ...
                if (_ok) {
                    //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L197"
                    {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L200"
                    continue;
                };
            };
            //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L203"
            _buf.reset();
            var _valid = (false : Bool);
            //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L205"
            {
...
//"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L207"
                    {
                        ...
                        if (_ok) {
                            _valid = true;
                            //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L209"
                            _buf.writeString(_v.__copy__());
                            //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L210"
                            {
                                _n++;
                                continue;
                            };
...
//"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L214"
                    if (!_ok) {
                        //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L215"
                        break;
                    };
_valid = true;
//"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L218"
                    if (_n == ((0 : stdgo.GoInt))) {
                        //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L219"
                        {
                            var __tmp__ = stdgo._internal.mime.Mime__decode2231enc._decode2231Enc(_v.__copy__()), _decv:stdgo.GoString = __tmp__._0, _ok:Bool = __tmp__._1;
                            if (_ok) {
                                //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L220"
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L224"
                        _buf.writeString(_decv.__copy__());
                    };
                    _n++;
                };
            };
            //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L227"
            if (_valid) {
                _params[_key] = (_buf.string() : stdgo.GoString)?.__copy__();
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/mime/mediatype.go#L232"
