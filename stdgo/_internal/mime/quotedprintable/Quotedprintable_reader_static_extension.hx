...
@:keep @:allow(stdgo._internal.mime.quotedprintable.Quotedprintable.Reader_asInterface) class Reader_static_extension {
    ...
    static public function read( _r:stdgo.Ref<stdgo._internal.mime.quotedprintable.Quotedprintable_reader.Reader>, _p:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/mime/quotedprintable/reader.go#L82"
        while (((_p.length) > (0 : stdgo.GoInt) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/mime/quotedprintable/reader.go#L83"
            if (((@:checkr _r ?? throw "null pointer dereference")._line.length) == ((0 : stdgo.GoInt))) {
                //"file:///home/runner/.go/go1.21.3/src/mime/quotedprintable/reader.go#L84"
                if ((@:checkr _r ?? throw "null pointer dereference")._rerr != null) {
                    //"file:///home/runner/.go/go1.21.3/src/mime/quotedprintable/reader.go#L85"
                    return {
                ...
                {
                    var __tmp__ = (@:checkr _r ?? throw "null pointer dereference")._br.readSlice((10 : stdgo.GoUInt8));
                ...
                //"file:///home/runner/.go/go1.21.3/src/mime/quotedprintable/reader.go#L94"
                if (stdgo._internal.bytes.Bytes_hassuffix.hasSuffix((@:checkr _r ?? throw "null pointer dereference")._line, stdgo._internal.mime.quotedprintable.Quotedprintable__softsuffix._softSuffix)) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/mime/quotedprintable/reader.go#L97"
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/mime/quotedprintable/reader.go#L102"
                    if (_hasCR) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/mime/quotedprintable/reader.go#L108"
                continue;
            };
            var _b = ((@:checkr _r ?? throw "null pointer dereference")._line[(0 : stdgo.GoInt)] : stdgo.GoUInt8);
            //"file:///home/runner/.go/go1.21.3/src/mime/quotedprintable/reader.go#L112"
            {
                ...
                while (__run__) {
                    ...
                    if (_b == ((61 : stdgo.GoUInt8))) {
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/mime/quotedprintable/reader.go#L115"
                        if (_err != null) {
                            //"file:///home/runner/.go/go1.21.3/src/mime/quotedprintable/reader.go#L116"
                            if ((((((@:checkr _r ?? throw "null pointer dereference")._line.length) >= (2 : stdgo.GoInt) : Bool) && (@:checkr _r ?? throw "null pointer dereference")._line[(1 : stdgo.GoInt)] != ((13 : stdgo.GoUInt8)) : Bool) && ((@:checkr _r ?? throw "null pointer dereference")._line[(1 : stdgo.GoInt)] != (10 : stdgo.GoUInt8)) : Bool)) {
                                _b = (61 : stdgo.GoUInt8);
                                //"file:///home/runner/.go/go1.21.3/src/mime/quotedprintable/reader.go#L119"
                                break;
                            };
                            //"file:///home/runner/.go/go1.21.3/src/mime/quotedprintable/reader.go#L121"
                            return {
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/mime/quotedprintable/reader.go#L125"
                        break;
                        break;
                    } else if ((_b >= (128 : stdgo.GoUInt8) : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/mime/quotedprintable/reader.go#L129"
                        break;
                        break;
                    } else if (((_b < (32 : stdgo.GoUInt8) : Bool) || (_b > (126 : stdgo.GoUInt8) : Bool) : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/mime/quotedprintable/reader.go#L131"
                        return {
            ...
            //"file:///home/runner/.go/go1.21.3/src/mime/quotedprintable/reader.go#L136"
            _n++;
        };
        //"file:///home/runner/.go/go1.21.3/src/mime/quotedprintable/reader.go#L138"
        return {
