...
class UnixConn_asInterface {
    @:keep
    public dynamic function writeMsgUnix(_b:stdgo.Slice<stdgo.GoUInt8>, _oob:stdgo.Slice<stdgo.GoUInt8>, _addr:stdgo.Ref<stdgo._internal.net.Net_UnixAddr.UnixAddr>):{ var _0 : stdgo.GoInt; var _1 : stdgo.GoInt; var _2 : stdgo.Error; } return __self__.value.writeMsgUnix(_b, _oob, _addr);
    @:keep
    ...
    @:keep
    public dynamic function writeToUnix(_b:stdgo.Slice<stdgo.GoUInt8>, _addr:stdgo.Ref<stdgo._internal.net.Net_UnixAddr.UnixAddr>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } return __self__.value.writeToUnix(_b, _addr);
    @:keep
    public dynamic function readMsgUnix(_b:stdgo.Slice<stdgo.GoUInt8>, _oob:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.GoInt; var _1 : stdgo.GoInt; var _2 : stdgo.GoInt; var _3 : stdgo.Ref<stdgo._internal.net.Net_UnixAddr.UnixAddr>; var _4 : stdgo.Error; } return __self__.value.readMsgUnix(_b, _oob);
    @:keep
    ...
    @:keep
    public dynamic function readFromUnix(_b:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Ref<stdgo._internal.net.Net_UnixAddr.UnixAddr>; var _2 : stdgo.Error; } return __self__.value.readFromUnix(_b);
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.net.Net_UnixConn.UnixConn>;
