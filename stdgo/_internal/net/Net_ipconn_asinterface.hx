...
class IPConn_asInterface {
    @:keep
    @:tdfield
    public dynamic function writeMsgIP(_b:stdgo.Slice<stdgo.GoUInt8>, _oob:stdgo.Slice<stdgo.GoUInt8>, _addr:stdgo.Ref<stdgo._internal.net.Net_ipaddr.IPAddr>):{ var _0 : stdgo.GoInt; var _1 : stdgo.GoInt; var _2 : stdgo.Error; } return @:_0 __self__.value.writeMsgIP(_b, _oob, _addr);
    @:keep
    @:tdfield
    ...
    @:keep
    @:tdfield
    public dynamic function writeToIP(_b:stdgo.Slice<stdgo.GoUInt8>, _addr:stdgo.Ref<stdgo._internal.net.Net_ipaddr.IPAddr>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } return @:_0 __self__.value.writeToIP(_b, _addr);
    @:keep
    @:tdfield
    public dynamic function readMsgIP(_b:stdgo.Slice<stdgo.GoUInt8>, _oob:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.GoInt; var _1 : stdgo.GoInt; var _2 : stdgo.GoInt; var _3 : stdgo.Ref<stdgo._internal.net.Net_ipaddr.IPAddr>; var _4 : stdgo.Error; } return @:_0 __self__.value.readMsgIP(_b, _oob);
    @:keep
    @:tdfield
    ...
    @:keep
    @:tdfield
    public dynamic function readFromIP(_b:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Ref<stdgo._internal.net.Net_ipaddr.IPAddr>; var _2 : stdgo.Error; } return @:_0 __self__.value.readFromIP(_b);
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.net.Net_ipconnpointer.IPConnPointer;
