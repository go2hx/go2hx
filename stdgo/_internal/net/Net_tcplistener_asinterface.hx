...
class TCPListener_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function acceptTCP():{ var _0 : stdgo.Ref<stdgo._internal.net.Net_tcpconn.TCPConn>; var _1 : stdgo.Error; } return @:_0 __self__.value.acceptTCP();
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.net.Net_tcplistenerpointer.TCPListenerPointer;
