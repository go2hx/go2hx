...
@:keep @:allow(stdgo._internal.net.http.Http.Header_asInterface) class Header_static_extension {
    ...
    static public function _writeSubset( _h:stdgo._internal.net.http.Http_Header.Header, _w:stdgo._internal.io.Io_Writer.Writer, _exclude:stdgo.GoMap<stdgo.GoString, Bool>, _trace:stdgo.Ref<stdgo._internal.net.http.httptrace.Httptrace_ClientTrace.ClientTrace>):stdgo.Error {
        ...
        for (__37817 => _kv in _kvs) {
            if (!_internal.golang_dot_org.x.net.http.httpguts.Httpguts_validHeaderFieldName.validHeaderFieldName(_kv._key?.__copy__())) {
                continue;
            };
            for (__37818 => _v in _kv._values) {
                _v = @:check2r stdgo._internal.net.http.Http__headerNewlineToSpace._headerNewlineToSpace.replace(_v?.__copy__())?.__copy__();
                _v = stdgo._internal.net.textproto.Textproto_trimString.trimString(_v?.__copy__())?.__copy__();
                for (__37819 => _s in (new stdgo.Slice<stdgo.GoString>(4, 4, ...[_kv._key?.__copy__(), (": " : stdgo.GoString), _v?.__copy__(), ("\r\n" : stdgo.GoString)]).__setString__() : stdgo.Slice<stdgo.GoString>)) {
                    {
                        var __tmp__ = _ws.writeString(_s?.__copy__()), __37820:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                        if (_err != null) {
                            @:check2 stdgo._internal.net.http.Http__headerSorterPool._headerSorterPool.put(stdgo.Go.toInterface(stdgo.Go.asInterface(_sorter)));
                            return _err;
                        };
                    };
                };
            ...
            if (((_trace != null && ((_trace : Dynamic).__nil__ == null || !(_trace : Dynamic).__nil__)) && ((@:checkr _trace ?? throw "null pointer dereference").wroteHeaderField != null) : Bool)) {
                (@:checkr _trace ?? throw "null pointer dereference").wroteHeaderField(_kv._key?.__copy__(), _formattedVals);
    ...
    static public function _sortedKeyValues( _h:stdgo._internal.net.http.Http_Header.Header, _exclude:stdgo.GoMap<stdgo.GoString, Bool>):{ var _0 : stdgo.Slice<stdgo._internal.net.http.Http_T_keyValues.T_keyValues>; var _1 : stdgo.Ref<stdgo._internal.net.http.Http_T_headerSorter.T_headerSorter>; } {
        ...
        _hs = (stdgo.Go.typeAssert((@:check2 stdgo._internal.net.http.Http__headerSorterPool._headerSorterPool.get() : stdgo.Ref<stdgo._internal.net.http.Http_T_headerSorter.T_headerSorter>)) : stdgo.Ref<stdgo._internal.net.http.Http_T_headerSorter.T_headerSorter>);
        if (((@:checkr _hs ?? throw "null pointer dereference")._kvs.capacity < (_h.length) : Bool)) {
            (@:checkr _hs ?? throw "null pointer dereference")._kvs = (new stdgo.Slice<stdgo._internal.net.http.Http_T_keyValues.T_keyValues>((0 : stdgo.GoInt).toBasic(), (_h.length), ...[for (i in 0 ... ((0 : stdgo.GoInt).toBasic() > (_h.length) ? (0 : stdgo.GoInt).toBasic() : (_h.length) : stdgo.GoInt).toBasic()) ({} : stdgo._internal.net.http.Http_T_keyValues.T_keyValues)]) : stdgo.Slice<stdgo._internal.net.http.Http_T_keyValues.T_keyValues>);
        };
        _kvs = ((@:checkr _hs ?? throw "null pointer dereference")._kvs.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.net.http.Http_T_keyValues.T_keyValues>);
        for (_k => _vv in _h) {
        ...
        (@:checkr _hs ?? throw "null pointer dereference")._kvs = _kvs;
    ...
    static public function _has( _h:stdgo._internal.net.http.Http_Header.Header, _key:stdgo.GoString):Bool {
        @:recv var _h:stdgo._internal.net.http.Http_Header.Header = _h;
        var __tmp__ = (_h != null && _h.exists(_key?.__copy__()) ? { _0 : _h[_key?.__copy__()], _1 : true } : { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : false }), __37817:stdgo.Slice<stdgo.GoString> = __tmp__._0, _ok:Bool = __tmp__._1;
        return _ok;
    }
    @:keep
    @:tdfield
