...
@:keep @:allow(stdgo._internal.net.http.Http.Response_asInterface) class Response_static_extension {
    ...
    static public function write( _r:stdgo.Ref<stdgo._internal.net.http.Http_Response.Response>, _w:stdgo._internal.io.Io_Writer.Writer):stdgo.Error {
        ...
        var _r1 = (stdgo.Go.setRef(({} : stdgo._internal.net.http.Http_Response.Response)) : stdgo.Ref<stdgo._internal.net.http.Http_Response.Response>);
        {
            ...
            (_r1 : stdgo._internal.net.http.Http_Response.Response).status = __tmp__.status;
            (_r1 : stdgo._internal.net.http.Http_Response.Response).statusCode = __tmp__.statusCode;
            (_r1 : stdgo._internal.net.http.Http_Response.Response).proto = __tmp__.proto;
            (_r1 : stdgo._internal.net.http.Http_Response.Response).protoMajor = __tmp__.protoMajor;
            (_r1 : stdgo._internal.net.http.Http_Response.Response).protoMinor = __tmp__.protoMinor;
            (_r1 : stdgo._internal.net.http.Http_Response.Response).header = __tmp__.header;
            (_r1 : stdgo._internal.net.http.Http_Response.Response).body = __tmp__.body;
            (_r1 : stdgo._internal.net.http.Http_Response.Response).contentLength = __tmp__.contentLength;
            (_r1 : stdgo._internal.net.http.Http_Response.Response).transferEncoding = __tmp__.transferEncoding;
            (_r1 : stdgo._internal.net.http.Http_Response.Response).close = __tmp__.close;
            (_r1 : stdgo._internal.net.http.Http_Response.Response).uncompressed = __tmp__.uncompressed;
            (_r1 : stdgo._internal.net.http.Http_Response.Response).trailer = __tmp__.trailer;
            (_r1 : stdgo._internal.net.http.Http_Response.Response).request = __tmp__.request;
            (_r1 : stdgo._internal.net.http.Http_Response.Response).tls = __tmp__.tls;
        };
