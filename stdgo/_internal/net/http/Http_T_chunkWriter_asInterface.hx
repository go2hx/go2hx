...
class T_chunkWriter_asInterface {
    @:keep
    @:tdfield
    public dynamic function _writeHeader(_p:stdgo.Slice<stdgo.GoUInt8>):Void @:_0 __self__.value._writeHeader(_p);
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.net.http.Http_T_chunkWriterPointer.T_chunkWriterPointer;
