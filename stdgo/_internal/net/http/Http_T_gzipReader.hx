...
@:structInit @:using(stdgo._internal.net.http.Http_T_gzipReader_static_extension.T_gzipReader_static_extension) class T_gzipReader {
    @:optional
    public var __99 : stdgo._internal.net.http.Http_T_incomparable.T_incomparable = new stdgo._internal.net.http.Http_T_incomparable.T_incomparable(0, 0, ...[for (i in 0 ... 0) null]);
    ...
    public function new(?__99:stdgo._internal.net.http.Http_T_incomparable.T_incomparable, ?_body:stdgo.Ref<stdgo._internal.net.http.Http_T_bodyEOFSignal.T_bodyEOFSignal>, ?_zr:stdgo.Ref<stdgo._internal.compress.gzip.Gzip_Reader.Reader>, ?_zerr:stdgo.Error) {
        if (__99 != null) this.__99 = __99;
    ...
    public function __copy__() {
        return new T_gzipReader(__99, _body, _zr, _zerr);
    }
}
