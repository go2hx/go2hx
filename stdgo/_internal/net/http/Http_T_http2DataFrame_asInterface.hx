...
class T_http2DataFrame_asInterface {
    @:keep
    public dynamic function data():stdgo.Slice<stdgo.GoUInt8> return __self__.value.data();
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.net.http.Http_T_http2DataFrame.T_http2DataFrame>;
