...
@:structInit @:using(stdgo._internal.net.http.Http_T_http2Framer_static_extension.T_http2Framer_static_extension) class T_http2Framer {
    ...
    public var _debugReadLoggerf : (stdgo.GoString, stdgo.Slice<stdgo.AnyInterface>) -> Void = null;
    public var _debugWriteLoggerf : (stdgo.GoString, stdgo.Slice<stdgo.AnyInterface>) -> Void = null;
