...
class T_http2GoAwayFrame_asInterface {
    @:keep
    public dynamic function debugData():stdgo.Slice<stdgo.GoUInt8> return __self__.value.debugData();
    @:embedded
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.net.http.Http_T_http2GoAwayFrame.T_http2GoAwayFrame>;
