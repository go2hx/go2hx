...
@:structInit @:using(stdgo._internal.net.http.Http_T_http2MetaHeadersFrame_static_extension.T_http2MetaHeadersFrame_static_extension) class T_http2MetaHeadersFrame {
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_header():() -> stdgo._internal.net.http.Http_T_http2FrameHeader.T_http2FrameHeader return @:check3 (this._http2HeadersFrame ?? throw "null pointer derefrence").header;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_string():() -> stdgo.GoString return @:check3 (this._http2HeadersFrame ?? throw "null pointer derefrence").string;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get__writeDebug():stdgo.Ref<stdgo._internal.bytes.Bytes_Buffer.Buffer> -> Void return @:check3 (this._http2HeadersFrame ?? throw "null pointer derefrence")._writeDebug;
