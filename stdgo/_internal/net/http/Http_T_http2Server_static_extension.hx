            ...
            _sc._framer = _fr;
            {
                ...
                if (_ok) {
                    _sc._tlsState = (stdgo.Go.setRef(({} : stdgo._internal.crypto.tls.Tls_ConnectionState.ConnectionState)) : stdgo.Ref<stdgo._internal.crypto.tls.Tls_ConnectionState.ConnectionState>);
                    {
                        ...
                        (_sc._tlsState : stdgo._internal.crypto.tls.Tls_ConnectionState.ConnectionState).version = __tmp__.version;
                        (_sc._tlsState : stdgo._internal.crypto.tls.Tls_ConnectionState.ConnectionState).handshakeComplete = __tmp__.handshakeComplete;
                        (_sc._tlsState : stdgo._internal.crypto.tls.Tls_ConnectionState.ConnectionState).didResume = __tmp__.didResume;
                        (_sc._tlsState : stdgo._internal.crypto.tls.Tls_ConnectionState.ConnectionState).cipherSuite = __tmp__.cipherSuite;
                        (_sc._tlsState : stdgo._internal.crypto.tls.Tls_ConnectionState.ConnectionState).negotiatedProtocol = __tmp__.negotiatedProtocol;
                        (_sc._tlsState : stdgo._internal.crypto.tls.Tls_ConnectionState.ConnectionState).negotiatedProtocolIsMutual = __tmp__.negotiatedProtocolIsMutual;
                        (_sc._tlsState : stdgo._internal.crypto.tls.Tls_ConnectionState.ConnectionState).serverName = __tmp__.serverName;
                        (_sc._tlsState : stdgo._internal.crypto.tls.Tls_ConnectionState.ConnectionState).peerCertificates = __tmp__.peerCertificates;
                        (_sc._tlsState : stdgo._internal.crypto.tls.Tls_ConnectionState.ConnectionState).verifiedChains = __tmp__.verifiedChains;
                        (_sc._tlsState : stdgo._internal.crypto.tls.Tls_ConnectionState.ConnectionState).signedCertificateTimestamps = __tmp__.signedCertificateTimestamps;
                        (_sc._tlsState : stdgo._internal.crypto.tls.Tls_ConnectionState.ConnectionState).ocspresponse = __tmp__.ocspresponse;
                        (_sc._tlsState : stdgo._internal.crypto.tls.Tls_ConnectionState.ConnectionState).tlsunique = __tmp__.tlsunique;
                        (_sc._tlsState : stdgo._internal.crypto.tls.Tls_ConnectionState.ConnectionState)._ekm = __tmp__._ekm;
                    };
