...
class T_http2StreamError_asInterface {
    @:keep
    public dynamic function as(_target:stdgo.AnyInterface):Bool return __self__.value.as(_target);
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.net.http.Http_T_http2StreamError.T_http2StreamError>;
