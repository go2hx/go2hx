...
class T_http2UnknownFrame_asInterface {
    @:keep
    public dynamic function payload():stdgo.Slice<stdgo.GoUInt8> return __self__.value.payload();
    @:embedded
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.net.http.Http_T_http2UnknownFrame.T_http2UnknownFrame>;
