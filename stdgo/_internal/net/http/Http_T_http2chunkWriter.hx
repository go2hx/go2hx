...
@:structInit @:using(stdgo._internal.net.http.Http_T_http2chunkWriter_static_extension.T_http2chunkWriter_static_extension) class T_http2chunkWriter {
    ...
    public function __copy__() {
        return new T_http2chunkWriter(_rws);
    }
}
