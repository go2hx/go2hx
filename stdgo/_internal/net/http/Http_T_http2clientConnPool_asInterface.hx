...
class T_http2clientConnPool_asInterface {
    ...
    @:keep
    public dynamic function markDead(_cc:stdgo.Ref<stdgo._internal.net.http.Http_T_http2ClientConn.T_http2ClientConn>):Void __self__.value.markDead(_cc);
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.net.http.Http_T_http2clientConnPool.T_http2clientConnPool>;
