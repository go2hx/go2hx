...
@:structInit @:using(stdgo._internal.net.http.Http_T_http2dialCall_static_extension.T_http2dialCall_static_extension) class T_http2dialCall {
    @:optional
    public var __5 : stdgo._internal.net.http.Http_T_http2incomparable.T_http2incomparable = new stdgo._internal.net.http.Http_T_http2incomparable.T_http2incomparable(0, 0, ...[for (i in 0 ... 0) null]);
    ...
    public function __copy__() {
        return new T_http2dialCall(__5, _p, _ctx, _done, _res, _err);
    }
}
