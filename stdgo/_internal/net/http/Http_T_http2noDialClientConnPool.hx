...
@:structInit @:using(stdgo._internal.net.http.Http_T_http2noDialClientConnPool_static_extension.T_http2noDialClientConnPool_static_extension) class T_http2noDialClientConnPool {
    ...
    public function get_markDead():stdgo.Ref<stdgo._internal.net.http.Http_T_http2ClientConn.T_http2ClientConn> -> Void return @:check3 this._http2clientConnPool.markDead;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get__addConnIfNeeded():(stdgo.GoString, stdgo.Ref<stdgo._internal.net.http.Http_T_http2Transport.T_http2Transport>, stdgo.Ref<stdgo._internal.crypto.tls.Tls_Conn.Conn>) -> { var _0 : Bool; var _1 : stdgo.Error; } return @:check3 this._http2clientConnPool._addConnIfNeeded;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get__addConnLocked():(stdgo.GoString, stdgo.Ref<stdgo._internal.net.http.Http_T_http2ClientConn.T_http2ClientConn>) -> Void return @:check3 this._http2clientConnPool._addConnLocked;
    public var _closeIdleConnections(get, never) : () -> Void;
    @:embedded
    @:embeddededffieldsffun
    public function get__closeIdleConnections():() -> Void return @:check3 this._http2clientConnPool._closeIdleConnections;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get__getClientConn():(stdgo.Ref<stdgo._internal.net.http.Http_Request.Request>, stdgo.GoString, Bool) -> { var _0 : stdgo.Ref<stdgo._internal.net.http.Http_T_http2ClientConn.T_http2ClientConn>; var _1 : stdgo.Error; } return @:check3 this._http2clientConnPool._getClientConn;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get__getStartDialLocked():(stdgo._internal.context.Context_Context.Context, stdgo.GoString) -> stdgo.Ref<stdgo._internal.net.http.Http_T_http2dialCall.T_http2dialCall> return @:check3 this._http2clientConnPool._getStartDialLocked;
