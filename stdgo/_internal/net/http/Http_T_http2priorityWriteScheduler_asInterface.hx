...
class T_http2priorityWriteScheduler_asInterface {
    @:keep
    public dynamic function _removeNode(_n:stdgo.Ref<stdgo._internal.net.http.Http_T_http2priorityNode.T_http2priorityNode>):Void __self__.value._removeNode(_n);
    @:keep
    public dynamic function _addClosedOrIdleNode(_list:stdgo.Ref<stdgo.Slice<stdgo.Ref<stdgo._internal.net.http.Http_T_http2priorityNode.T_http2priorityNode>>>, _maxSize:stdgo.GoInt, _n:stdgo.Ref<stdgo._internal.net.http.Http_T_http2priorityNode.T_http2priorityNode>):Void __self__.value._addClosedOrIdleNode(_list, _maxSize, _n);
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.net.http.Http_T_http2priorityWriteScheduler.T_http2priorityWriteScheduler>;
