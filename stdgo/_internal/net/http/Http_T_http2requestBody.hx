...
@:structInit @:using(stdgo._internal.net.http.Http_T_http2requestBody_static_extension.T_http2requestBody_static_extension) class T_http2requestBody {
    @:optional
    public var __40 : stdgo._internal.net.http.Http_T_http2incomparable.T_http2incomparable = new stdgo._internal.net.http.Http_T_http2incomparable.T_http2incomparable(0, 0, ...[for (i in 0 ... 0) null]);
    ...
    public function __copy__() {
        return new T_http2requestBody(__40, _stream, _conn, _closeOnce, _sawEOF, _pipe, _needsContinue);
    }
}
