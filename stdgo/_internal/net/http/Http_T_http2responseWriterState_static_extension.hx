...
@:keep @:allow(stdgo._internal.net.http.Http.T_http2responseWriterState_asInterface) class T_http2responseWriterState_static_extension {
    ...
    static public function _writeHeader( _rws:stdgo.Ref<stdgo._internal.net.http.Http_T_http2responseWriterState.T_http2responseWriterState>, _code:stdgo.GoInt):Void {
        ...
        if (((_code >= (100 : stdgo.GoInt) : Bool) && (_code <= (199 : stdgo.GoInt) : Bool) : Bool)) {
            ...
            var __tmp__ = (_h != null && _h.exists(("Content-Length" : stdgo.GoString)) ? { _0 : _h[("Content-Length" : stdgo.GoString)], _1 : true } : { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : false }), __32043:stdgo.Slice<stdgo.GoString> = __tmp__._0, _cl:Bool = __tmp__._1;
            var __tmp__ = (_h != null && _h.exists(("Transfer-Encoding" : stdgo.GoString)) ? { _0 : _h[("Transfer-Encoding" : stdgo.GoString)], _1 : true } : { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : false }), __32044:stdgo.Slice<stdgo.GoString> = __tmp__._0, _te:Bool = __tmp__._1;
            if ((_cl || _te : Bool)) {
                _h = _h.clone();
...
var _clen = __1, _ctype = __0;
            ...
            var __tmp__ = (_rws._snapHeader != null && _rws._snapHeader.exists(("Content-Length" : stdgo.GoString)) ? { _0 : _rws._snapHeader[("Content-Length" : stdgo.GoString)], _1 : true } : { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : false }), __32343:stdgo.Slice<stdgo.GoString> = __tmp__._0, _hasContentLength:Bool = __tmp__._1;
            ...
            var __tmp__ = (_rws._snapHeader != null && _rws._snapHeader.exists(("Content-Type" : stdgo.GoString)) ? { _0 : _rws._snapHeader[("Content-Type" : stdgo.GoString)], _1 : true } : { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : false }), __32544:stdgo.Slice<stdgo.GoString> = __tmp__._0, _hasContentType:Bool = __tmp__._1;
            ...
            {
                var __tmp__ = (_rws._snapHeader != null && _rws._snapHeader.exists(("Date" : stdgo.GoString)) ? { _0 : _rws._snapHeader[("Date" : stdgo.GoString)], _1 : true } : { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : false }), __32745:stdgo.Slice<stdgo.GoString> = __tmp__._0, _ok:Bool = __tmp__._1;
                if (!_ok) {
                    _date = stdgo._internal.time.Time_now.now().utc().format(("Mon, 02 Jan 2006 15:04:05 GMT" : stdgo.GoString))?.__copy__();
                };
            };
            for (__32796 => _v in (_rws._snapHeader[("Trailer" : stdgo.GoString)] ?? (null : stdgo.Slice<stdgo.GoString>))) {
                stdgo._internal.net.http.Http__http2foreachHeaderElement._http2foreachHeaderElement(_v?.__copy__(), _rws._declareTrailer);
            };
            {
                var __tmp__ = (_rws._snapHeader != null && _rws._snapHeader.exists(("Connection" : stdgo.GoString)) ? { _0 : _rws._snapHeader[("Connection" : stdgo.GoString)], _1 : true } : { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : false }), __32897:stdgo.Slice<stdgo.GoString> = __tmp__._0, _ok:Bool = __tmp__._1;
                if (_ok) {
    ...
    static public function _hasNonemptyTrailers( _rws:stdgo.Ref<stdgo._internal.net.http.Http_T_http2responseWriterState.T_http2responseWriterState>):Bool {
        @:recv var _rws:stdgo.Ref<stdgo._internal.net.http.Http_T_http2responseWriterState.T_http2responseWriterState> = _rws;
        for (__31993 => _trailer in _rws._trailers) {
            {
                var __tmp__ = (_rws._handlerHeader != null && _rws._handlerHeader.exists(_trailer?.__copy__()) ? { _0 : _rws._handlerHeader[_trailer?.__copy__()], _1 : true } : { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : false }), __32094:stdgo.Slice<stdgo.GoString> = __tmp__._0, _ok:Bool = __tmp__._1;
                if (_ok) {
                    return true;
                };
            };
