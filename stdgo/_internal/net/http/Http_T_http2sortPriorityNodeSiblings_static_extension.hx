...
@:keep @:allow(stdgo._internal.net.http.Http.T_http2sortPriorityNodeSiblings_asInterface) class T_http2sortPriorityNodeSiblings_static_extension {
    ...
    static public function less( _z:stdgo._internal.net.http.Http_T_http2sortPriorityNodeSiblings.T_http2sortPriorityNodeSiblings, _i:stdgo.GoInt, _k:stdgo.GoInt):Bool {
        ...
        var __0 = ((_z[(_i : stdgo.GoInt)]._weight + (1 : stdgo.GoUInt8) : stdgo.GoUInt8) : stdgo.GoFloat64), __1 = (_z[(_i : stdgo.GoInt)]._subtreeBytes : stdgo.GoFloat64);
var _bi = __1, _wi = __0;
        var __0 = ((_z[(_k : stdgo.GoInt)]._weight + (1 : stdgo.GoUInt8) : stdgo.GoUInt8) : stdgo.GoFloat64), __1 = (_z[(_k : stdgo.GoInt)]._subtreeBytes : stdgo.GoFloat64);
var _bk = __1, _wk = __0;
