...
@:keep @:allow(stdgo._internal.net.http.Http.T_http2stream_asInterface) class T_http2stream_static_extension {
    ...
    static public function _processTrailerHeaders( _st:stdgo.Ref<stdgo._internal.net.http.Http_T_http2stream.T_http2stream>, _f:stdgo.Ref<stdgo._internal.net.http.Http_T_http2MetaHeadersFrame.T_http2MetaHeadersFrame>):stdgo.Error {
        ...
        if (_st._gotTrailerHeader) {
            return _sc._framer._countError(("dup_trailers" : stdgo.GoString), stdgo.Go.asInterface(((1u32 : stdgo._internal.net.http.Http_T_http2ErrCode.T_http2ErrCode) : stdgo._internal.net.http.Http_T_http2ConnectionError.T_http2ConnectionError)));
        };
        _st._gotTrailerHeader = true;
        if (!_f.streamEnded()) {
            return _sc._framer._countError(("trailers_not_ended" : stdgo.GoString), stdgo.Go.asInterface(stdgo._internal.net.http.Http__http2streamError._http2streamError(_st._id, (1u32 : stdgo._internal.net.http.Http_T_http2ErrCode.T_http2ErrCode))));
        };
