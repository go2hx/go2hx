...
@:keep @:allow(stdgo._internal.net.http.Http.T_socksDialer_asInterface) class T_socksDialer_static_extension {
    ...
    static public function dial( _d:stdgo.Ref<stdgo._internal.net.http.Http_T_socksDialer.T_socksDialer>, _network:stdgo.GoString, _address:stdgo.GoString):{ var _0 : stdgo._internal.net.Net_Conn.Conn; var _1 : stdgo.Error; } {
        @:recv var _d:stdgo.Ref<stdgo._internal.net.http.Http_T_socksDialer.T_socksDialer> = _d;
        {
            ...
            if (_err != null) {
                var __tmp__ = @:check2r _d._pathAddrs(_address?.__copy__()), _proxy:stdgo._internal.net.Net_Addr.Addr = __tmp__._0, _dst:stdgo._internal.net.Net_Addr.Addr = __tmp__._1, __3657:stdgo.Error = __tmp__._2;
        ...
        {
            var __tmp__ = @:check2r _d.dialWithConn(stdgo._internal.net.http.Http__context._context.background(), _c, _network?.__copy__(), _address?.__copy__()), __3657:stdgo._internal.net.Net_Addr.Addr = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                _c.close();
