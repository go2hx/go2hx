...
@:structInit @:using(stdgo._internal.net.http.Http_T_transportRequest_static_extension.T_transportRequest_static_extension) class T_transportRequest {
    ...
    public function get_addCookie():stdgo.Ref<stdgo._internal.net.http.Http_Cookie.Cookie> -> Void return @:check3 this.request.addCookie;
    public var basicAuth(get, never) : () -> { var _0 : stdgo.GoString; var _1 : stdgo.GoString; var _2 : Bool; };
    @:embedded
    @:embeddededffieldsffun
    public function get_basicAuth():() -> { var _0 : stdgo.GoString; var _1 : stdgo.GoString; var _2 : Bool; } return @:check3 this.request.basicAuth;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_clone():stdgo._internal.context.Context_Context.Context -> stdgo.Ref<stdgo._internal.net.http.Http_Request.Request> return @:check3 this.request.clone;
    public var context(get, never) : () -> stdgo._internal.context.Context_Context.Context;
    @:embedded
    @:embeddededffieldsffun
    public function get_context():() -> stdgo._internal.context.Context_Context.Context return @:check3 this.request.context;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_cookie():stdgo.GoString -> { var _0 : stdgo.Ref<stdgo._internal.net.http.Http_Cookie.Cookie>; var _1 : stdgo.Error; } return @:check3 this.request.cookie;
    public var cookies(get, never) : () -> stdgo.Slice<stdgo.Ref<stdgo._internal.net.http.Http_Cookie.Cookie>>;
    @:embedded
    @:embeddededffieldsffun
    public function get_cookies():() -> stdgo.Slice<stdgo.Ref<stdgo._internal.net.http.Http_Cookie.Cookie>> return @:check3 this.request.cookies;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_formFile():stdgo.GoString -> { var _0 : stdgo._internal.mime.multipart.Multipart_File.File; var _1 : stdgo.Ref<stdgo._internal.mime.multipart.Multipart_FileHeader.FileHeader>; var _2 : stdgo.Error; } return @:check3 this.request.formFile;
    public var formValue(get, never) : stdgo.GoString -> stdgo.GoString;
    @:embedded
    @:embeddededffieldsffun
    public function get_formValue():stdgo.GoString -> stdgo.GoString return @:check3 this.request.formValue;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_multipartReader():() -> { var _0 : stdgo.Ref<stdgo._internal.mime.multipart.Multipart_Reader.Reader>; var _1 : stdgo.Error; } return @:check3 this.request.multipartReader;
    public var parseForm(get, never) : () -> stdgo.Error;
    @:embedded
    @:embeddededffieldsffun
    public function get_parseForm():() -> stdgo.Error return @:check3 this.request.parseForm;
    public var parseMultipartForm(get, never) : stdgo.GoInt64 -> stdgo.Error;
    @:embedded
    @:embeddededffieldsffun
    public function get_parseMultipartForm():stdgo.GoInt64 -> stdgo.Error return @:check3 this.request.parseMultipartForm;
    public var postFormValue(get, never) : stdgo.GoString -> stdgo.GoString;
    @:embedded
    @:embeddededffieldsffun
    public function get_postFormValue():stdgo.GoString -> stdgo.GoString return @:check3 this.request.postFormValue;
    public var protoAtLeast(get, never) : (stdgo.GoInt, stdgo.GoInt) -> Bool;
    @:embedded
    @:embeddededffieldsffun
    public function get_protoAtLeast():(stdgo.GoInt, stdgo.GoInt) -> Bool return @:check3 this.request.protoAtLeast;
    public var referer(get, never) : () -> stdgo.GoString;
    @:embedded
    @:embeddededffieldsffun
    public function get_referer():() -> stdgo.GoString return @:check3 this.request.referer;
    public var setBasicAuth(get, never) : (stdgo.GoString, stdgo.GoString) -> Void;
    @:embedded
    @:embeddededffieldsffun
    public function get_setBasicAuth():(stdgo.GoString, stdgo.GoString) -> Void return @:check3 this.request.setBasicAuth;
    public var userAgent(get, never) : () -> stdgo.GoString;
    @:embedded
    @:embeddededffieldsffun
    public function get_userAgent():() -> stdgo.GoString return @:check3 this.request.userAgent;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_withContext():stdgo._internal.context.Context_Context.Context -> stdgo.Ref<stdgo._internal.net.http.Http_Request.Request> return @:check3 this.request.withContext;
    public var write(get, never) : stdgo._internal.io.Io_Writer.Writer -> stdgo.Error;
    @:embedded
    @:embeddededffieldsffun
    public function get_write():stdgo._internal.io.Io_Writer.Writer -> stdgo.Error return @:check3 this.request.write;
    public var writeProxy(get, never) : stdgo._internal.io.Io_Writer.Writer -> stdgo.Error;
    @:embedded
    @:embeddededffieldsffun
    public function get_writeProxy():stdgo._internal.io.Io_Writer.Writer -> stdgo.Error return @:check3 this.request.writeProxy;
    public var _closeBody(get, never) : () -> stdgo.Error;
    @:embedded
    @:embeddededffieldsffun
    public function get__closeBody():() -> stdgo.Error return @:check3 this.request._closeBody;
    public var _expectsContinue(get, never) : () -> Bool;
    @:embedded
    @:embeddededffieldsffun
    public function get__expectsContinue():() -> Bool return @:check3 this.request._expectsContinue;
    public var _isH2Upgrade(get, never) : () -> Bool;
    @:embedded
    @:embeddededffieldsffun
    public function get__isH2Upgrade():() -> Bool return @:check3 this.request._isH2Upgrade;
    public var _isReplayable(get, never) : () -> Bool;
    @:embedded
    @:embeddededffieldsffun
    public function get__isReplayable():() -> Bool return @:check3 this.request._isReplayable;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get__multipartReader():Bool -> { var _0 : stdgo.Ref<stdgo._internal.mime.multipart.Multipart_Reader.Reader>; var _1 : stdgo.Error; } return @:check3 this.request._multipartReader;
    public var _outgoingLength(get, never) : () -> stdgo.GoInt64;
    @:embedded
    @:embeddededffieldsffun
    public function get__outgoingLength():() -> stdgo.GoInt64 return @:check3 this.request._outgoingLength;
    public var _requiresHTTP1(get, never) : () -> Bool;
    @:embedded
    @:embeddededffieldsffun
    public function get__requiresHTTP1():() -> Bool return @:check3 this.request._requiresHTTP1;
    public var _wantsClose(get, never) : () -> Bool;
    @:embedded
    @:embeddededffieldsffun
    public function get__wantsClose():() -> Bool return @:check3 this.request._wantsClose;
    public var _wantsHttp10KeepAlive(get, never) : () -> Bool;
    @:embedded
    @:embeddededffieldsffun
    public function get__wantsHttp10KeepAlive():() -> Bool return @:check3 this.request._wantsHttp10KeepAlive;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get__write():(stdgo._internal.io.Io_Writer.Writer, Bool, stdgo._internal.net.http.Http_Header.Header, () -> Bool) -> stdgo.Error return @:check3 this.request._write;
