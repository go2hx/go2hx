...
function _fixPragmaCacheControl(_header:stdgo._internal.net.http.Http_Header.Header):Void {
        {
            ...
            if (((_ok && ((_hp.length) > (0 : stdgo.GoInt) : Bool) : Bool) && (_hp[(0 : stdgo.GoInt)] == ("no-cache" : stdgo.GoString)) : Bool)) {
                {
                    var __tmp__ = (_header != null && _header.exists(("Cache-Control" : stdgo.GoString)) ? { _0 : _header[("Cache-Control" : stdgo.GoString)], _1 : true } : { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : false }), __143:stdgo.Slice<stdgo.GoString> = __tmp__._0, _presentcc:Bool = __tmp__._1;
                    if (!_presentcc) {
