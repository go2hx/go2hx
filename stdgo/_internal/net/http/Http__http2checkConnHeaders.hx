...
function _http2checkConnHeaders(_req:stdgo.Ref<stdgo._internal.net.http.Http_Request.Request>):stdgo.Error {
        {
            var _v = ((@:checkr _req ?? throw "null pointer dereference").header.get(("Upgrade" : stdgo.GoString))?.__copy__() : stdgo.GoString);
            if (_v != (stdgo.Go.str())) {
                return stdgo._internal.fmt.Fmt_errorf.errorf(("http2: invalid Upgrade request header: %q" : stdgo.GoString), stdgo.Go.toInterface(((@:checkr _req ?? throw "null pointer dereference").header[("Upgrade" : stdgo.GoString)] ?? (null : stdgo.Slice<stdgo.GoString>))));
            };
        };
        {
            var _vv = ((@:checkr _req ?? throw "null pointer dereference").header[("Transfer-Encoding" : stdgo.GoString)] ?? (null : stdgo.Slice<stdgo.GoString>));
        ...
        {
            var _vv = ((@:checkr _req ?? throw "null pointer dereference").header[("Connection" : stdgo.GoString)] ?? (null : stdgo.Slice<stdgo.GoString>));
