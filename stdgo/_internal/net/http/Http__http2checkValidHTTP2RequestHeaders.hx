...
function _http2checkValidHTTP2RequestHeaders(_h:stdgo._internal.net.http.Http_Header.Header):stdgo.Error {
        for (__132 => _k in stdgo._internal.net.http.Http__http2connHeaders._http2connHeaders) {
            {
                var __tmp__ = (_h != null && _h.exists(_k?.__copy__()) ? { _0 : _h[_k?.__copy__()], _1 : true } : { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : false }), __133:stdgo.Slice<stdgo.GoString> = __tmp__._0, _ok:Bool = __tmp__._1;
                if (_ok) {
