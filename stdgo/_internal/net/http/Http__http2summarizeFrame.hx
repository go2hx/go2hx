        ...
        _f.header()._writeDebug((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo._internal.bytes.Bytes_Buffer.Buffer>));
        {
            ...
            if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo._internal.net.http.Http_T_http2SettingsFrame.T_http2SettingsFrame>))) {
                ...
                if (((_f.data().length) > (256 : stdgo.GoInt) : Bool)) {
                    stdgo._internal.fmt.Fmt_fprintf.fprintf(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo._internal.bytes.Bytes_Buffer.Buffer>)), (" (%d bytes omitted)" : stdgo.GoString), stdgo.Go.toInterface(((_f.data().length) - (256 : stdgo.GoInt) : stdgo.GoInt)));
                };
                ...
                stdgo._internal.fmt.Fmt_fprintf.fprintf(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo._internal.bytes.Bytes_Buffer.Buffer>)), (" incr=%v" : stdgo.GoString), stdgo.Go.toInterface(_f.increment));
                ...
                stdgo._internal.fmt.Fmt_fprintf.fprintf(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo._internal.bytes.Bytes_Buffer.Buffer>)), (" ping=%q" : stdgo.GoString), stdgo.Go.toInterface((_f.data.__slice__(0) : stdgo.Slice<stdgo.GoUInt8>)));
                ...
                stdgo._internal.fmt.Fmt_fprintf.fprintf(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo._internal.bytes.Bytes_Buffer.Buffer>)), (" LastStreamID=%v ErrCode=%v Debug=%q" : stdgo.GoString), stdgo.Go.toInterface(_f.lastStreamID), stdgo.Go.toInterface(stdgo.Go.asInterface(_f.errCode)), stdgo.Go.toInterface(_f._debugData));
                ...
                stdgo._internal.fmt.Fmt_fprintf.fprintf(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo._internal.bytes.Bytes_Buffer.Buffer>)), (" ErrCode=%v" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_f.errCode)));
            };
        };
