...
var _multipartByReader : stdgo.Ref<stdgo._internal.mime.multipart.Multipart_Form.Form> = (stdgo.Go.setRef(({ value : (({
        final x = new stdgo.GoMap.GoStringMap<stdgo.Slice<stdgo.GoString>>();
        x.__defaultValue__ = () -> (null : stdgo.Slice<stdgo.GoString>);
        {};
        x;
    } : stdgo.GoMap<stdgo.GoString, stdgo.Slice<stdgo.GoString>>) : stdgo.GoMap<stdgo.GoString, stdgo.Slice<stdgo.GoString>>), file : (({
