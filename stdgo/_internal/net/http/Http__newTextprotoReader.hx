...
function _newTextprotoReader(_br:stdgo.Ref<stdgo._internal.bufio.Bufio_Reader.Reader>):stdgo.Ref<stdgo._internal.net.textproto.Textproto_Reader.Reader> {
        {
            var _v = (@:check2 stdgo._internal.net.http.Http__textprotoReaderPool._textprotoReaderPool.get() : stdgo.AnyInterface);
            if (_v != null) {
                ...
                (@:checkr _tr ?? throw "null pointer dereference").r = _br;
                return _tr;
            };
        };
