...
function _parseRequestLine(_line:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : stdgo.GoString; var _2 : stdgo.GoString; var _3 : Bool; } {
        ...
        if ((!_ok1 || !_ok2 : Bool)) {
            return { _0 : stdgo.Go.str()?.__copy__(), _1 : stdgo.Go.str()?.__copy__(), _2 : stdgo.Go.str()?.__copy__(), _3 : false };
        };
        return { _0 : _method?.__copy__(), _1 : _requestURI?.__copy__(), _2 : _proto?.__copy__(), _3 : true };
    }
