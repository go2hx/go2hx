...
function _readSetCookies(_h:stdgo._internal.net.http.Http_Header.Header):stdgo.Slice<stdgo.Ref<stdgo._internal.net.http.Http_Cookie.Cookie>> {
        ...
        for (__137 => _line in (_h[("Set-Cookie" : stdgo.GoString)] ?? (null : stdgo.Slice<stdgo.GoString>))) {
...
var __tmp__ = stdgo._internal.strings.Strings_cut.cut(_parts[(_i : stdgo.GoInt)].__copy__(), ("=" : stdgo.GoString)), _attr:stdgo.GoString = __tmp__._0, _val:stdgo.GoString = __tmp__._1, __138:Bool = __tmp__._2;
                        ...
                        while (__run__) {
                            __run__ = false;
                            {
                                ...
                                if (__value__ == (("samesite" : stdgo.GoString))) {
                                    ...
                                    if (!_ascii) {
                                        (@:checkr _c ?? throw "null pointer dereference").sameSite = (1 : stdgo._internal.net.http.Http_SameSite.SameSite);
                                        {
                                            __continue__ = true;
                                            break;
                                        };
                                    };
                                    {
                                        ...
                                        if (__value__ == (("lax" : stdgo.GoString))) {
                                            (@:checkr _c ?? throw "null pointer dereference").sameSite = (2 : stdgo._internal.net.http.Http_SameSite.SameSite);
                                        } else if (__value__ == (("strict" : stdgo.GoString))) {
                                            (@:checkr _c ?? throw "null pointer dereference").sameSite = (3 : stdgo._internal.net.http.Http_SameSite.SameSite);
                                        } else if (__value__ == (("none" : stdgo.GoString))) {
                                            (@:checkr _c ?? throw "null pointer dereference").sameSite = (4 : stdgo._internal.net.http.Http_SameSite.SameSite);
                                        } else {
                                            (@:checkr _c ?? throw "null pointer dereference").sameSite = (1 : stdgo._internal.net.http.Http_SameSite.SameSite);
                                        };
                                    };
                                    ...
                                    (@:checkr _c ?? throw "null pointer dereference").secure = true;
                                    {
                                        __continue__ = true;
                                        break;
                                    };
                                    ...
                                    (@:checkr _c ?? throw "null pointer dereference").httpOnly = true;
                                    {
                                        __continue__ = true;
                                        break;
                                    };
                                    ...
                                    (@:checkr _c ?? throw "null pointer dereference").domain = _val?.__copy__();
                                    {
                                        __continue__ = true;
                                        break;
                                    };
                                    ...
                                    (@:checkr _c ?? throw "null pointer dereference").maxAge = _secs;
                                    {
                                        __continue__ = true;
                                        break;
                                    };
                                    ...
                                    (@:checkr _c ?? throw "null pointer dereference").rawExpires = _val?.__copy__();
                                    ...
                                    (@:checkr _c ?? throw "null pointer dereference").expires = _exptime.uTC()?.__copy__();
                                    {
                                        __continue__ = true;
                                        break;
                                    };
                                    ...
                                    (@:checkr _c ?? throw "null pointer dereference").path = _val?.__copy__();
                                    {
                                        __continue__ = true;
                                        break;
                                    };
