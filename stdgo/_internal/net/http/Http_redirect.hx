...
function redirect(_w:stdgo._internal.net.http.Http_ResponseWriter.ResponseWriter, _r:stdgo.Ref<stdgo._internal.net.http.Http_Request.Request>, _url:stdgo.GoString, _code:stdgo.GoInt):Void {
            ...
            if (_err == null) {
                if ((((@:checkr _u ?? throw "null pointer dereference").scheme == stdgo.Go.str()) && ((@:checkr _u ?? throw "null pointer dereference").host == stdgo.Go.str()) : Bool)) {
                    ...
                    if (((_url == stdgo.Go.str()) || (_url[(0 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        var __tmp__ = stdgo._internal.path.Path_split.split(_oldpath?.__copy__()), _olddir:stdgo.GoString = __tmp__._0, __137:stdgo.GoString = __tmp__._1;
        ...
        var __tmp__ = (_h != null && _h.exists(("Content-Type" : stdgo.GoString)) ? { _0 : _h[("Content-Type" : stdgo.GoString)], _1 : true } : { _0 : (null : stdgo.Slice<stdgo.GoString>), _1 : false }), __137:stdgo.Slice<stdgo.GoString> = __tmp__._0, _hadCT:Bool = __tmp__._1;
