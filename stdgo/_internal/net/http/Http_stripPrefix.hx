...
function stripPrefix(_prefix:stdgo.GoString, _h:stdgo._internal.net.http.Http_Handler.Handler):stdgo._internal.net.http.Http_Handler.Handler {
        ...
        return stdgo.Go.asInterface((function(_w:stdgo._internal.net.http.Http_ResponseWriter.ResponseWriter, _r:stdgo.Ref<stdgo._internal.net.http.Http_Request.Request>):Void {
            var _p = (stdgo._internal.strings.Strings_trimPrefix.trimPrefix(_r.url.path?.__copy__(), _prefix?.__copy__())?.__copy__() : stdgo.GoString);
            var _rp = (stdgo._internal.strings.Strings_trimPrefix.trimPrefix(_r.url.rawPath?.__copy__(), _prefix?.__copy__())?.__copy__() : stdgo.GoString);
            if ((((_p.length) < (_r.url.path.length) : Bool) && (((_r.url.rawPath == stdgo.Go.str()) || ((_rp.length) < (_r.url.rawPath.length) : Bool) : Bool)) : Bool)) {
                ...
                _r2.url = (stdgo.Go.setRef(({} : stdgo._internal.net.url.Url_URL.URL)) : stdgo.Ref<stdgo._internal.net.url.Url_URL.URL>);
                {
                    ...
                    var x = (_r2.url : stdgo._internal.net.url.Url_URL.URL);
                ...
                _r2.url.path = _p?.__copy__();
                _r2.url.rawPath = _rp?.__copy__();
                _h.serveHTTP(_w, _r2);
            } else {
