...
class T_http2DataFrame_asInterface {
    @:keep
    @:tdfield
    public dynamic function data():stdgo.Slice<stdgo.GoUInt8> return @:_0 __self__.value.data();
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.net.http.Http_t_http2dataframepointer.T_http2DataFramePointer;
