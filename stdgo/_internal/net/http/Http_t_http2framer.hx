...
@:structInit @:using(stdgo._internal.net.http.Http_t_http2framer_static_extension.T_http2Framer_static_extension) class T_http2Framer {
    ...
    public var readMetaHeaders : stdgo.Ref<_internal.vendor.golangdotorg.x.net.http2.hpack.Hpack_decoder.Decoder> = (null : stdgo.Ref<_internal.vendor.golangdotorg.x.net.http2.hpack.Hpack_decoder.Decoder>);
    public var maxHeaderListSize : stdgo.GoUInt32 = 0;
    public function new(?allowIllegalWrites:Bool, ?allowIllegalReads:Bool, ?readMetaHeaders:stdgo.Ref<_internal.vendor.golangdotorg.x.net.http2.hpack.Hpack_decoder.Decoder>, ?maxHeaderListSize:stdgo.GoUInt32) {
