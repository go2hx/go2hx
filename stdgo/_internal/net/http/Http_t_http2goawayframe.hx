...
@:structInit @:using(stdgo._internal.net.http.Http_t_http2goawayframe_static_extension.T_http2GoAwayFrame_static_extension) class T_http2GoAwayFrame {
    ...
    public function new(?_http2FrameHeader:stdgo._internal.net.http.Http_t_http2frameheader.T_http2FrameHeader, ?lastStreamID:stdgo.GoUInt32, ?errCode:stdgo._internal.net.http.Http_t_http2errcode.T_http2ErrCode) {
    ...
    public function __copy__() {
        return new T_http2GoAwayFrame(_http2FrameHeader, lastStreamID, errCode);
    }
}
