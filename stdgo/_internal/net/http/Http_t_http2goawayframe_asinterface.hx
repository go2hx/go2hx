...
class T_http2GoAwayFrame_asInterface {
    @:keep
    @:tdfield
    public dynamic function debugData():stdgo.Slice<stdgo.GoUInt8> return @:_0 __self__.value.debugData();
    @:embedded
    ...
    var __self__ : stdgo._internal.net.http.Http_t_http2goawayframepointer.T_http2GoAwayFramePointer;
