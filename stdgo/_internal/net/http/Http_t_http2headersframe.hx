...
@:structInit @:using(stdgo._internal.net.http.Http_t_http2headersframe_static_extension.T_http2HeadersFrame_static_extension) class T_http2HeadersFrame {
    ...
    public function new(?_http2FrameHeader:stdgo._internal.net.http.Http_t_http2frameheader.T_http2FrameHeader, ?priority:stdgo._internal.net.http.Http_t_http2priorityparam.T_http2PriorityParam) {
    ...
    public function __copy__() {
        return new T_http2HeadersFrame(_http2FrameHeader, priority);
    }
}
