...
@:structInit @:using(stdgo._internal.net.http.Http_t_http2metaheadersframe_static_extension.T_http2MetaHeadersFrame_static_extension) class T_http2MetaHeadersFrame {
    ...
    public function new(?_http2HeadersFrame:stdgo.Ref<stdgo._internal.net.http.Http_t_http2headersframe.T_http2HeadersFrame>, ?fields:stdgo.Slice<_internal.vendor.golangdotorg.x.net.http2.hpack.Hpack_headerfield.HeaderField>, ?truncated:Bool) {
