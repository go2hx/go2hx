...
@:keep @:allow(stdgo._internal.net.http.Http.T_http2PingFrame_asInterface) class T_http2PingFrame_static_extension {
    @:keep
    @:tdfield
    static public function isAck( _f:stdgo.Ref<stdgo._internal.net.http.Http_t_http2pingframe.T_http2PingFrame>):Bool throw "T_http2PingFrame:net.http.isAck is not yet implemented";
    @:embedded
