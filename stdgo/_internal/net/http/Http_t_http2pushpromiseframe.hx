...
@:structInit @:using(stdgo._internal.net.http.Http_t_http2pushpromiseframe_static_extension.T_http2PushPromiseFrame_static_extension) class T_http2PushPromiseFrame {
    ...
    public function new(?_http2FrameHeader:stdgo._internal.net.http.Http_t_http2frameheader.T_http2FrameHeader, ?promiseID:stdgo.GoUInt32) {
    ...
    public function __copy__() {
        return new T_http2PushPromiseFrame(_http2FrameHeader, promiseID);
    }
}
