...
class T_http2UnknownFrame_asInterface {
    @:keep
    @:tdfield
    public dynamic function payload():stdgo.Slice<stdgo.GoUInt8> return @:_0 __self__.value.payload();
    @:embedded
    ...
    var __self__ : stdgo._internal.net.http.Http_t_http2unknownframepointer.T_http2UnknownFramePointer;
