...
@:keep @:allow(stdgo._internal.net.http.Http.T_socksConn_asInterface) class T_socksConn_static_extension {
    @:keep
    @:tdfield
    static public function boundAddr( _c:stdgo.Ref<stdgo._internal.net.http.Http_t_socksconn.T_socksConn>):stdgo._internal.net.Net_addr.Addr throw "T_socksConn:net.http.boundAddr is not yet implemented";
    @:embedded
