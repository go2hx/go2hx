...
class T_tlsHandshakeTimeoutError_asInterface {
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.net.http.Http_t_tlshandshaketimeouterrorpointer.T_tlsHandshakeTimeoutErrorPointer;
