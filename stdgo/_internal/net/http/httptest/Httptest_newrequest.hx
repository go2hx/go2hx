...
function newRequest(_method:stdgo.GoString, _target:stdgo.GoString, _body:stdgo._internal.io.Io_reader.Reader):stdgo.Ref<stdgo._internal.net.http.Http_request.Request> {
        //"file:///home/runner/.go/go1.21.3/src/net/http/httptest/httptest.go#L41"
        ...
        //"file:///home/runner/.go/go1.21.3/src/net/http/httptest/httptest.go#L45"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/net/http/httptest/httptest.go#L46"
        ...
        //"file:///home/runner/.go/go1.21.3/src/net/http/httptest/httptest.go#L54"
        if (_body != null) {
            //"file:///home/runner/.go/go1.21.3/src/net/http/httptest/httptest.go#L55"
            {
                ...
                if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo._internal.bytes.Bytes_buffer.Buffer>))) {
                    ...
                    (@:checkr _req ?? throw "null pointer dereference").contentLength = (_v.len() : stdgo.GoInt64);
            ...
            //"file:///home/runner/.go/go1.21.3/src/net/http/httptest/httptest.go#L65"
            {
                var __tmp__ = try {
        ...
        //"file:///home/runner/.go/go1.21.3/src/net/http/httptest/httptest.go#L77"
        ...
        //"file:///home/runner/.go/go1.21.3/src/net/http/httptest/httptest.go#L81"
        ...
        //"file:///home/runner/.go/go1.21.3/src/net/http/httptest/httptest.go#L89"
        return _req;
    }
