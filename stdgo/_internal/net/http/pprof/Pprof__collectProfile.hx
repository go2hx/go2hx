...
function _collectProfile(_p:stdgo.Ref<stdgo._internal.runtime.pprof.Pprof_Profile.Profile>):{ var _0 : stdgo.Ref<_internal.internal.profile.Profile_Profile.Profile>; var _1 : stdgo.Error; } {
        ...
        var __tmp__ = _internal.internal.profile.Profile_parse.parse(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo._internal.bytes.Bytes_Buffer.Buffer>))), _p0:stdgo.Ref<_internal.internal.profile.Profile_Profile.Profile> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : null, _1 : _err };
        };
        _p0.timeNanos = _ts;
