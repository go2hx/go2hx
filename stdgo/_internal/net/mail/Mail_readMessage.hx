...
function readMessage(_r:stdgo._internal.io.Io_Reader.Reader):{ var _0 : stdgo.Ref<stdgo._internal.net.mail.Mail_Message.Message>; var _1 : stdgo.Error; } {
        ...
        return { _0 : (stdgo.Go.setRef(({ header : (_hdr : stdgo._internal.net.mail.Mail_Header.Header), body : stdgo.Go.asInterface(_tp.r) } : stdgo._internal.net.mail.Mail_Message.Message)) : stdgo.Ref<stdgo._internal.net.mail.Mail_Message.Message>), _1 : (null : stdgo.Error) };
    }
