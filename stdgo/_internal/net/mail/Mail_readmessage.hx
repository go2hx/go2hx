...
function readMessage(_r:stdgo._internal.io.Io_reader.Reader):{ var _0 : stdgo.Ref<stdgo._internal.net.mail.Mail_message.Message>; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/net/mail/message.go#L58"
        if (((_err != null) && (((stdgo.Go.toInterface(_err) != stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF)) || (_hdr.length == (0 : stdgo.GoInt)) : Bool)) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/net/mail/message.go#L59"
            return {
                @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.Ref<stdgo._internal.net.mail.Mail_message.Message>; var _1 : stdgo.Error; } = { _0 : null, _1 : _err };
                _msg = __tmp__._0;
                _err = __tmp__._1;
                __tmp__;
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/net/mail/message.go#L62"
        return {
