...
function _splitAddrPort(_s:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : stdgo.GoString; var _2 : Bool; var _3 : stdgo.Error; } {
        ...
        if (_i == ((-1 : stdgo.GoInt))) {
            return {
                final __tmp__:{ var _0 : stdgo.GoString; var _1 : stdgo.GoString; var _2 : Bool; var _3 : stdgo.Error; } = { _0 : stdgo.Go.str()?.__copy__(), _1 : stdgo.Go.str()?.__copy__(), _2 : false, _3 : stdgo._internal.errors.Errors_new_.new_(("not an ip:port" : stdgo.GoString)) };
                _ip = __tmp__._0;
                _port = __tmp__._1;
                _v6 = __tmp__._2;
                _err = __tmp__._3;
        ...
        if ((_ip.length) == ((0 : stdgo.GoInt))) {
            return {
                final __tmp__:{ var _0 : stdgo.GoString; var _1 : stdgo.GoString; var _2 : Bool; var _3 : stdgo.Error; } = { _0 : stdgo.Go.str()?.__copy__(), _1 : stdgo.Go.str()?.__copy__(), _2 : false, _3 : stdgo._internal.errors.Errors_new_.new_(("no IP" : stdgo.GoString)) };
                _ip = __tmp__._0;
                _port = __tmp__._1;
                _v6 = __tmp__._2;
                _err = __tmp__._3;
        ...
        if ((_port.length) == ((0 : stdgo.GoInt))) {
            return {
                final __tmp__:{ var _0 : stdgo.GoString; var _1 : stdgo.GoString; var _2 : Bool; var _3 : stdgo.Error; } = { _0 : stdgo.Go.str()?.__copy__(), _1 : stdgo.Go.str()?.__copy__(), _2 : false, _3 : stdgo._internal.errors.Errors_new_.new_(("no port" : stdgo.GoString)) };
                _ip = __tmp__._0;
                _port = __tmp__._1;
                _v6 = __tmp__._2;
                _err = __tmp__._3;
        ...
        if (_ip[(0 : stdgo.GoInt)] == ((91 : stdgo.GoUInt8))) {
            if ((((_ip.length) < (2 : stdgo.GoInt) : Bool) || (_ip[((_ip.length) - (1 : stdgo.GoInt) : stdgo.GoInt)] != (93 : stdgo.GoUInt8)) : Bool)) {
                return {
                    final __tmp__:{ var _0 : stdgo.GoString; var _1 : stdgo.GoString; var _2 : Bool; var _3 : stdgo.Error; } = { _0 : stdgo.Go.str()?.__copy__(), _1 : stdgo.Go.str()?.__copy__(), _2 : false, _3 : stdgo._internal.errors.Errors_new_.new_(("missing ]" : stdgo.GoString)) };
                    _ip = __tmp__._0;
                    _port = __tmp__._1;
                    _v6 = __tmp__._2;
                    _err = __tmp__._3;
