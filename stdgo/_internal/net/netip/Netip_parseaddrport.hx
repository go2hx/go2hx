...
function parseAddrPort(_s:stdgo.GoString):{ var _0 : stdgo._internal.net.netip.Netip_addrport.AddrPort; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/net/netip/netip.go#L1076"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/net/netip/netip.go#L1077"
        ...
        //"file:///home/runner/.go/go1.21.3/src/net/netip/netip.go#L1080"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/net/netip/netip.go#L1081"
        ...
        //"file:///home/runner/.go/go1.21.3/src/net/netip/netip.go#L1085"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/net/netip/netip.go#L1086"
        ...
        //"file:///home/runner/.go/go1.21.3/src/net/netip/netip.go#L1088"
        if ((_v6 && _ipp._ip.is4() : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/net/netip/netip.go#L1089"
            ...
            //"file:///home/runner/.go/go1.21.3/src/net/netip/netip.go#L1091"
            return { _0 : (new stdgo._internal.net.netip.Netip_addrport.AddrPort() : stdgo._internal.net.netip.Netip_addrport.AddrPort), _1 : stdgo._internal.errors.Errors_new_.new_(((("invalid ip:port " : stdgo.GoString) + stdgo._internal.strconv.Strconv_quote.quote(_s?.__copy__())?.__copy__() : stdgo.GoString) + (", IPv6 addresses must be surrounded by square brackets" : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__()) };
        };
        //"file:///home/runner/.go/go1.21.3/src/net/netip/netip.go#L1093"
