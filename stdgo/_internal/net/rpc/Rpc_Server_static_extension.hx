    ...
    static public function _getResponse( _server:stdgo.Ref<stdgo._internal.net.rpc.Rpc_Server.Server>):stdgo.Ref<stdgo._internal.net.rpc.Rpc_Response.Response> {
        ...
        if ((_resp == null || (_resp : Dynamic).__nil__)) {
            ...
            _server._freeResp = _resp._next;
            {
                ...
                (_resp : stdgo._internal.net.rpc.Rpc_Response.Response).serviceMethod = __tmp__.serviceMethod;
                (_resp : stdgo._internal.net.rpc.Rpc_Response.Response).seq = __tmp__.seq;
                (_resp : stdgo._internal.net.rpc.Rpc_Response.Response).error = __tmp__.error;
                (_resp : stdgo._internal.net.rpc.Rpc_Response.Response)._next = __tmp__._next;
            };
        };
        _server._respLock.unlock();
        return _resp;
    ...
    static public function _getRequest( _server:stdgo.Ref<stdgo._internal.net.rpc.Rpc_Server.Server>):stdgo.Ref<stdgo._internal.net.rpc.Rpc_Request.Request> {
        ...
        if ((_req == null || (_req : Dynamic).__nil__)) {
            ...
            _server._freeReq = _req._next;
            {
                ...
                (_req : stdgo._internal.net.rpc.Rpc_Request.Request).serviceMethod = __tmp__.serviceMethod;
                (_req : stdgo._internal.net.rpc.Rpc_Request.Request).seq = __tmp__.seq;
                (_req : stdgo._internal.net.rpc.Rpc_Request.Request)._next = __tmp__._next;
            };
        };
        _server._reqLock.unlock();
        return _req;
