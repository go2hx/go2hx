...
@:keep @:allow(stdgo._internal.net.smtp.Smtp.T_cramMD5Auth_asInterface) class T_cramMD5Auth_static_extension {
    ...
    static public function next( _a:stdgo.Ref<stdgo._internal.net.smtp.Smtp_T_cramMD5Auth.T_cramMD5Auth>, _fromServer:stdgo.Slice<stdgo.GoUInt8>, _more:Bool):{ var _0 : stdgo.Slice<stdgo.GoUInt8>; var _1 : stdgo.Error; } {
        ...
        if (_more) {
            var _d = (stdgo._internal.crypto.hmac.Hmac_new_.new_(stdgo._internal.crypto.md5.Md5_new_.new_, (_a._secret : stdgo.Slice<stdgo.GoUInt8>)) : stdgo._internal.hash.Hash_Hash.Hash);
            ...
            return { _0 : stdgo._internal.fmt.Fmt_appendf.appendf((null : stdgo.Slice<stdgo.GoUInt8>), ("%s %x" : stdgo.GoString), stdgo.Go.toInterface(_a._username), stdgo.Go.toInterface(_d.sum(_s))), _1 : (null : stdgo.Error) };
        };
