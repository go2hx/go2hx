...
function _readMIMEHeader(_r:stdgo.Ref<stdgo._internal.net.textproto.Textproto_reader.Reader>, _maxMemory:stdgo.GoInt64, _maxHeaders:stdgo.GoInt64):{ var _0 : stdgo._internal.net.textproto.Textproto_mimeheader.MIMEHeader; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L493"
        if ((_hint > (0 : stdgo.GoInt) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L494"
        ...
        {};
        //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L509"
        {
            ...
            if (((_err == null) && (((_buf[(0 : stdgo.GoInt)] == (32 : stdgo.GoUInt8)) || (_buf[(0 : stdgo.GoInt)] == (9 : stdgo.GoUInt8)) : Bool)) : Bool)) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L511"
                if (_err != null) {
                    //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L512"
                    return { _0 : _m, _1 : _err };
                };
                //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L514"
        ...
        //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L517"
        while (true) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L519"
            if ((_kv.length) == ((0 : stdgo.GoInt))) {
                //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L520"
                return { _0 : _m, _1 : _err };
            };
            ...
            //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L525"
            if (!_ok) {
                //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L526"
            ...
            //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L529"
            if (!_ok) {
                //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L530"
                return { _0 : _m, _1 : stdgo.Go.asInterface(((("malformed MIME header line: " : stdgo.GoString) + (_kv : stdgo.GoString)?.__copy__() : stdgo.GoString) : stdgo._internal.net.textproto.Textproto_protocolerror.ProtocolError)) };
            };
            //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L532"
            for (__0 => _c in _v) {
                //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L533"
                if (!stdgo._internal.net.textproto.Textproto__validheadervaluebyte._validHeaderValueByte(_c)) {
                    //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L534"
                    return { _0 : _m, _1 : stdgo.Go.asInterface(((("malformed MIME header line: " : stdgo.GoString) + (_kv : stdgo.GoString)?.__copy__() : stdgo.GoString) : stdgo._internal.net.textproto.Textproto_protocolerror.ProtocolError)) };
                };
            };
            //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L541"
            if (_key == ((stdgo.Go.str() : stdgo.GoString))) {
                //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L542"
                continue;
            };
            //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L545"
            _maxHeaders--;
            //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L546"
            if ((_maxHeaders < (0i64 : stdgo.GoInt64) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L547"
            ...
            //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L554"
            if (_vv == null) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L559"
            if ((_maxMemory < (0i64 : stdgo.GoInt64) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L562"
                return { _0 : _m, _1 : stdgo._internal.errors.Errors_new_.new_(("message too large" : stdgo.GoString)) };
            };
            //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L564"
            ...
            //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L576"
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/net/textproto/reader.go#L577"
                return { _0 : _m, _1 : _err };
            };
        };
    }
