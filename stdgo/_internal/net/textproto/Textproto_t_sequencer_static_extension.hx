...
@:keep @:allow(stdgo._internal.net.textproto.Textproto.T_sequencer_asInterface) class T_sequencer_static_extension {
    ...
    static public function end( _s:stdgo.Ref<stdgo._internal.net.textproto.Textproto_t_sequencer.T_sequencer>, _id:stdgo.GoUInt):Void {
        ...
        var __tmp__ = ((@:checkr _s ?? throw "null pointer dereference")._wait != null && (@:checkr _s ?? throw "null pointer dereference")._wait.exists(_id) ? { _0 : (@:checkr _s ?? throw "null pointer dereference")._wait[_id], _1 : true } : { _0 : (null : stdgo.Chan<stdgo._internal.net.textproto.Textproto_t__struct_0.T__struct_0>), _1 : false }), _c:stdgo.Chan<stdgo._internal.net.textproto.Textproto_t__struct_0.T__struct_0> = __tmp__._0, _ok:Bool = __tmp__._1;
        if (_ok) {
            if ((@:checkr _s ?? throw "null pointer dereference")._wait != null) (@:checkr _s ?? throw "null pointer dereference")._wait.remove(_id);
        };
        @:check2 (@:checkr _s ?? throw "null pointer dereference")._mu.unlock();
        if (_ok) {
