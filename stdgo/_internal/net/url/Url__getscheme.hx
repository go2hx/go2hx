...
function _getScheme(_rawURL:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : stdgo.GoString; var _2 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/net/url/url.go#L437"
        {
            var _i = (0 : stdgo.GoInt);
            while ((_i < (_rawURL.length) : Bool)) {
                var _c = (_rawURL[(_i : stdgo.GoInt)] : stdgo.GoUInt8);
//"file:///home/runner/.go/go1.21.3/src/net/url/url.go#L439"
                if (((((97 : stdgo.GoUInt8) <= _c : Bool) && (_c <= (122 : stdgo.GoUInt8) : Bool) : Bool) || (((65 : stdgo.GoUInt8) <= _c : Bool) && (_c <= (90 : stdgo.GoUInt8) : Bool) : Bool) : Bool)) {} else if (((((((48 : stdgo.GoUInt8) <= _c : Bool) && (_c <= (57 : stdgo.GoUInt8) : Bool) : Bool) || _c == ((43 : stdgo.GoUInt8)) : Bool) || _c == ((45 : stdgo.GoUInt8)) : Bool) || (_c == (46 : stdgo.GoUInt8)) : Bool)) {
                    //"file:///home/runner/.go/go1.21.3/src/net/url/url.go#L443"
                    if (_i == ((0 : stdgo.GoInt))) {
                        //"file:///home/runner/.go/go1.21.3/src/net/url/url.go#L444"
                        return {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/net/url/url.go#L447"
                    if (_i == ((0 : stdgo.GoInt))) {
                        //"file:///home/runner/.go/go1.21.3/src/net/url/url.go#L448"
                        return {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/net/url/url.go#L450"
                    return {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/net/url/url.go#L454"
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoString; var _1 : stdgo.GoString; var _2 : stdgo.Error; } = { _0 : (stdgo.Go.str() : stdgo.GoString).__copy__(), _1 : _rawURL.__copy__(), _2 : (null : stdgo.Error) };
                        _scheme = __tmp__._0;
                        _path = __tmp__._1;
        ...
        //"file:///home/runner/.go/go1.21.3/src/net/url/url.go#L457"
        return {
            @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoString; var _1 : stdgo.GoString; var _2 : stdgo.Error; } = { _0 : (stdgo.Go.str() : stdgo.GoString)?.__copy__(), _1 : _rawURL?.__copy__(), _2 : (null : stdgo.Error) };
            _scheme = __tmp__._0;
            _path = __tmp__._1;
