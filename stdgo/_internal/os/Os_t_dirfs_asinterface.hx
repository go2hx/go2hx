...
class T_dirFS_asInterface {
    @:keep
    @:tdfield
    public dynamic function _join(_name:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : stdgo.Error; } return @:_0 __self__.value._join(_name);
    @:keep
    @:tdfield
    ...
    var __self__ : stdgo._internal.os.Os_t_dirfspointer.T_dirFSPointer;
