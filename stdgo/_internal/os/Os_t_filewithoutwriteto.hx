...
@:structInit @:using(stdgo._internal.os.Os_t_filewithoutwriteto_static_extension.T_fileWithoutWriteTo_static_extension) class T_fileWithoutWriteTo {
    @:embedded
    public var _noWriteTo : stdgo._internal.os.Os_t_nowriteto.T_noWriteTo = ({} : stdgo._internal.os.Os_t_nowriteto.T_noWriteTo);
    @:embedded
    public var file : stdgo.Ref<stdgo._internal.os.Os_file.File> = (null : stdgo.Ref<stdgo._internal.os.Os_file.File>);
    public function new(?_noWriteTo:stdgo._internal.os.Os_t_nowriteto.T_noWriteTo, ?file:stdgo.Ref<stdgo._internal.os.Os_file.File>) {
        if (_noWriteTo != null) this._noWriteTo = _noWriteTo;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_readFrom():stdgo._internal.io.Io_reader.Reader -> { var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } return @:check32 this.file.readFrom;
    ...
    public var _writeTo(get, never) : stdgo._internal.io.Io_writer.Writer -> { var _0 : stdgo.GoInt64; var _1 : Bool; var _2 : stdgo.Error; };
    @:embedded
    @:embeddededffieldsffun
    public function get__writeTo():stdgo._internal.io.Io_writer.Writer -> { var _0 : stdgo.GoInt64; var _1 : Bool; var _2 : stdgo.Error; } return @:check32 this.file._writeTo;
    public function __copy__() {
        return new T_fileWithoutWriteTo(_noWriteTo, file);
    }
}
