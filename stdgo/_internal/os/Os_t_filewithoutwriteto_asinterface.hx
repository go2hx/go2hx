...
class T_fileWithoutWriteTo_asInterface {
    @:embedded
    @:embeddededffieldsffun
    public dynamic function _writeTo(_0:stdgo._internal.io.Io_writer.Writer):{ var _0 : stdgo.GoInt64; var _1 : Bool; var _2 : stdgo.Error; } return @:_0 __self__.value._writeTo(_0);
    @:embedded
    @:embeddededffieldsffun
    ...
    var __self__ : stdgo._internal.os.Os_t_filewithoutwritetopointer.T_fileWithoutWriteToPointer;
