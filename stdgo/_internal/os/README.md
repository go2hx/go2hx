...
[30;41m ERROR [0m stdgo/_internal/os_test/Os_test.hx:271: characters 25-55

 271 | [2m    public var _aTime : [0m[1mstdgo._internal.time.Time.Time[0m[2m;[0m
     |                         [31m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m
...
[30;41m ERROR [0m stdgo/_internal/os_test/Os.hx:4: characters 26-70

   4 | [2mvar _tests : stdgo.Slice<[0m[1mstdgo._internal.testing.Testing.InternalTest[0m[2m> = (new stdgo.Slice<stdgo._internal.testing.Testing.InternalTest>(127, 127, ...[[0m
     |                          [31m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m
