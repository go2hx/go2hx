...
function _listGroupsFromReader(_u:stdgo.Ref<stdgo._internal.os.user.User_user.User>, _r:stdgo._internal.io.Io_reader.Reader):{ var _0 : stdgo.Slice<stdgo.GoString>; var _1 : stdgo.Error; } {
        //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L20"
        if ((@:checkr _u ?? throw "null pointer dereference").username == ((stdgo.Go.str() : stdgo.GoString))) {
            //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L21"
        ...
        //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L24"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L25"
        ...
        //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L38"
        while (!_done) {
            var __tmp__ = _rd.readBytes((10 : stdgo.GoUInt8)), _line:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L40"
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L41"
                if (stdgo.Go.toInterface(_err) == (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                    _done = true;
                } else {
                    //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L44"
                    return { _0 : _groups, _1 : _err };
                };
            };
            _line = stdgo._internal.bytes.Bytes_trimspace.trimSpace(_line);
            //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L55"
            if (((((_line.length) == ((0 : stdgo.GoInt)) || _line[(0 : stdgo.GoInt)] == ((35 : stdgo.GoUInt8)) : Bool) || _line[(0 : stdgo.GoInt)] == ((43 : stdgo.GoUInt8)) : Bool) || (_line[(0 : stdgo.GoInt)] == (45 : stdgo.GoUInt8)) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L60"
                continue;
            };
            var _listIdx = (stdgo._internal.bytes.Bytes_lastindexbyte.lastIndexByte(_line, (58 : stdgo.GoUInt8)) : stdgo.GoInt);
            //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L69"
            if (((_listIdx == (-1 : stdgo.GoInt)) || (_listIdx == ((_line.length) - (1 : stdgo.GoInt) : stdgo.GoInt)) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L71"
                continue;
            };
            //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L73"
            if (stdgo._internal.bytes.Bytes_count.count((_line.__slice__(0, _listIdx) : stdgo.Slice<stdgo.GoUInt8>), stdgo._internal.os.user.User__colon._colon) != ((2 : stdgo.GoInt))) {
                //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L75"
                continue;
            };
            var _list = (_line.__slice__((_listIdx + (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>);
            //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L79"
            if (!((((stdgo._internal.bytes.Bytes_equal.equal(_list, _userOnly) || stdgo._internal.bytes.Bytes_hasprefix.hasPrefix(_list, _userFirst) : Bool) || stdgo._internal.bytes.Bytes_hassuffix.hasSuffix(_list, _userLast) : Bool) || stdgo._internal.bytes.Bytes_contains.contains(_list, _userCommas) : Bool))) {
                //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L80"
                continue;
            };
            ...
            //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L85"
            if (((_parts.length != (3 : stdgo.GoInt)) || (_parts[(0 : stdgo.GoInt)].length == (0 : stdgo.GoInt)) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L86"
                continue;
            };
            ...
            //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L91"
            if (((_err != null) || (_numGid == _primaryGid) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L92"
                continue;
            };
            _groups = (_groups.__append__(_gid?.__copy__()) : stdgo.Slice<stdgo.GoString>);
        };
        //"file:///home/runner/.go/go1.21.3/src/os/user/listgroups_unix.go#L98"
