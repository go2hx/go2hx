...
function _lookupGroup(_groupname:stdgo.GoString):{ var _0 : stdgo.Ref<stdgo._internal.os.user.User_Group.Group>; var _1 : stdgo.Error; } {
        ...
        try {
            ...
            {
                final __ret__:{ var _0 : stdgo.Ref<stdgo._internal.os.user.User_Group.Group>; var _1 : stdgo.Error; } = { _0 : (null : stdgo.Ref<stdgo._internal.os.user.User_Group.Group>), _1 : (null : stdgo.Error) };
                for (defer in __deferstack__) {
                    defer();
                };
