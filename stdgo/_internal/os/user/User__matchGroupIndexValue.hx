...
function _matchGroupIndexValue(_value:stdgo.GoString, _idx:stdgo.GoInt):stdgo._internal.os.user.User_T_lineFunc.T_lineFunc {
        ...
        return function(_line:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.AnyInterface; var _1 : stdgo.Error; } {
            ...
            if (((((((_parts.length) < (4 : stdgo.GoInt) : Bool) || _parts[(0 : stdgo.GoInt)] == (stdgo.Go.str()) : Bool) || _parts[(_idx : stdgo.GoInt)] != (_value) : Bool) || _parts[(0 : stdgo.GoInt)][(0 : stdgo.GoInt)] == ((43 : stdgo.GoUInt8)) : Bool) || (_parts[(0 : stdgo.GoInt)][(0 : stdgo.GoInt)] == (45 : stdgo.GoUInt8)) : Bool)) {
                return { _0 : _v, _1 : _err };
            };
            {
            ...
            return { _0 : stdgo.Go.toInterface((stdgo.Go.setRef(({ name : _parts[(0 : stdgo.GoInt)]?.__copy__(), gid : _parts[(2 : stdgo.GoInt)]?.__copy__() } : stdgo._internal.os.user.User_Group.Group)) : stdgo.Ref<stdgo._internal.os.user.User_Group.Group>)), _1 : (null : stdgo.Error) };
        };
    }
