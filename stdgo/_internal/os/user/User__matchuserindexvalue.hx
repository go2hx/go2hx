...
function _matchUserIndexValue(_value:stdgo.GoString, _idx:stdgo.GoInt):stdgo._internal.os.user.User_t_linefunc.T_lineFunc {
        ...
        //"file:///home/runner/.go/go1.21.3/src/os/user/lookup_unix.go#L142"
        ...
        //"file:///home/runner/.go/go1.21.3/src/os/user/lookup_unix.go#L146"
        return function(_line:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : stdgo.AnyInterface; var _1 : stdgo.Error; } {
            ...
            //"file:///home/runner/.go/go1.21.3/src/os/user/lookup_unix.go#L147"
            if ((!stdgo._internal.bytes.Bytes_contains.contains(_line, _substr) || (stdgo._internal.bytes.Bytes_count.count(_line, stdgo._internal.os.user.User__colon._colon) < (6 : stdgo.GoInt) : Bool) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/os/user/lookup_unix.go#L148"
            ...
            //"file:///home/runner/.go/go1.21.3/src/os/user/lookup_unix.go#L152"
            if (((((((_parts.length) < (6 : stdgo.GoInt) : Bool) || _parts[(_idx : stdgo.GoInt)] != (_value) : Bool) || _parts[(0 : stdgo.GoInt)] == ((stdgo.Go.str() : stdgo.GoString)) : Bool) || _parts[(0 : stdgo.GoInt)][(0 : stdgo.GoInt)] == ((43 : stdgo.GoUInt8)) : Bool) || (_parts[(0 : stdgo.GoInt)][(0 : stdgo.GoInt)] == (45 : stdgo.GoUInt8)) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/os/user/lookup_unix.go#L154"
                return { _0 : _v, _1 : _err };
            };
            //"file:///home/runner/.go/go1.21.3/src/os/user/lookup_unix.go#L156"
            {
                ...
                if (_err != null) {
                    //"file:///home/runner/.go/go1.21.3/src/os/user/lookup_unix.go#L157"
                    return {
            ...
            //"file:///home/runner/.go/go1.21.3/src/os/user/lookup_unix.go#L159"
            {
                ...
                if (_err != null) {
                    //"file:///home/runner/.go/go1.21.3/src/os/user/lookup_unix.go#L160"
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.AnyInterface; var _1 : stdgo.Error; } = { _0 : (null : stdgo.AnyInterface), _1 : (null : stdgo.Error) };
                        _v = __tmp__._0;
                        _err = __tmp__._1;
            ...
            //"file:///home/runner/.go/go1.21.3/src/os/user/lookup_unix.go#L174"
            return {
