        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    0i32;
                    _gotoNext = 2631246i32;
                } else if (__value__ == (2631246i32)) {
                    ...
                    if (!scanBreak && ((_i_11 < (_pattern.length) : Bool))) {
                        _gotoNext = 2631400i32;
                    } else {
                        _gotoNext = 2631649i32;
                    };
                } else if (__value__ == (2631396i32)) {
                    _i_11++;
                    _gotoNext = 2631367i32;
                } else if (__value__ == (2631400i32)) {
                    _gotoNext = 2631404i32;
                } else if (__value__ == (2631404i32)) {
                    {
                        final __value__ = _pattern[(_i_11 : stdgo.GoInt)];
                        if (__value__ == ((92 : stdgo.GoUInt8))) {
                            _gotoNext = 2631426i32;
                        } else if (__value__ == ((91 : stdgo.GoUInt8))) {
                            _gotoNext = 2631533i32;
                        } else if (__value__ == ((93 : stdgo.GoUInt8))) {
                            _gotoNext = 2631563i32;
                        } else if (__value__ == ((42 : stdgo.GoUInt8))) {
                            _gotoNext = 2631594i32;
                        } else {
                            _gotoNext = 2631396i32;
                        };
                    };
                } else if (__value__ == (2631426i32)) {
                    if (((_i_11 + (1 : stdgo.GoInt) : stdgo.GoInt) < (_pattern.length) : Bool)) {
                        _gotoNext = 2631516i32;
                    } else {
                        _gotoNext = 2631396i32;
                    };
                } else if (__value__ == (2631516i32)) {
                    _i_11++;
                    _gotoNext = 2631396i32;
                } else if (__value__ == (2631533i32)) {
                    _inrange_10 = true;
                    _gotoNext = 2631396i32;
                } else if (__value__ == (2631563i32)) {
                    _inrange_10 = false;
                    _gotoNext = 2631396i32;
                } else if (__value__ == (2631594i32)) {
                    if (!_inrange_10) {
                        _gotoNext = 2631619i32;
                    } else {
                        _gotoNext = 2631396i32;
                    };
                } else if (__value__ == (2631619i32)) {
                    scanBreak = true;
                    _gotoNext = 2631367i32;
                } else if (__value__ == (2631649i32)) {
                    return {
