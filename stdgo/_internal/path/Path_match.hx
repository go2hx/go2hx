        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2962761i32;
                } else if (__value__ == (2962761i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 2962771i32;
                } else if (__value__ == (2962771i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2962792i32;
                    } else {
                        _gotoNext = 2964077i32;
                    };
                } else if (__value__ == (2962792i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2962898i32;
                    } else {
                        _gotoNext = 2963060i32;
                    };
                } else if (__value__ == (2962898i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2963298i32;
                    } else {
                        _gotoNext = 2963330i32;
                    };
                } else if (__value__ == (2963298i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 2962771i32;
                } else if (__value__ == (2963330i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2963344i32;
                    } else {
                        _gotoNext = 2963373i32;
                    };
                } else if (__value__ == (2963344i32)) {
                    return {
                    ...
                    _gotoNext = 2963373i32;
                } else if (__value__ == (2963373i32)) {
                    if (_star_0) {
                        _gotoNext = 2963381i32;
                    } else {
                        _gotoNext = 2963902i32;
                    };
                } else if (__value__ == (2963381i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2963448i32;
                } else if (__value__ == (2963448i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2963497i32;
                    } else {
                        _gotoNext = 2963902i32;
                    };
                } else if (__value__ == (2963493i32)) {
                    _i_5++;
                    _gotoNext = 2963448i32;
                } else if (__value__ == (2963497i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 2963557i32;
                    } else {
                        _gotoNext = 2963734i32;
                    };
                } else if (__value__ == (2963557i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2963664i32;
                    } else {
                        _gotoNext = 2963693i32;
                    };
                } else if (__value__ == (2963664i32)) {
                    _i_5++;
                    _gotoNext = 2963448i32;
                } else if (__value__ == (2963693i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2962771i32;
                } else if (__value__ == (2963734i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2963748i32;
                    } else {
                        _gotoNext = 2963493i32;
                    };
                } else if (__value__ == (2963748i32)) {
                    return {
                    ...
                    _gotoNext = 2963493i32;
                } else if (__value__ == (2963902i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 2963902i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2963923i32;
                    } else {
                        _gotoNext = 2964055i32;
                    };
                } else if (__value__ == (2963923i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2964020i32;
                        } else {
                            _gotoNext = 2963902i32;
                        };
                    };
                } else if (__value__ == (2964020i32)) {
                    return {
