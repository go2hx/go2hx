        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2640464i32;
                } else if (__value__ == (2640464i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 2640474i32;
                } else if (__value__ == (2640474i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2640495i32;
                    } else {
                        _gotoNext = 2641780i32;
                    };
                } else if (__value__ == (2640495i32)) {
                    {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        ...
                        _gotoNext = 2641033i32;
                    };
                } else if (__value__ == (2641001i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 2640474i32;
                } else if (__value__ == (2641033i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2641047i32;
                    } else {
                        _gotoNext = 2641076i32;
                    };
                } else if (__value__ == (2641047i32)) {
                    return {
                    ...
                    _gotoNext = 2641076i32;
                } else if (__value__ == (2641076i32)) {
                    if (_star_0) {
                        _gotoNext = 2641084i32;
                    } else {
                        _gotoNext = 2641605i32;
                    };
                } else if (__value__ == (2641084i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2641151i32;
                } else if (__value__ == (2641151i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2641200i32;
                    } else {
                        _gotoNext = 2641605i32;
                    };
                } else if (__value__ == (2641196i32)) {
                    _i_5++;
                    _gotoNext = 2641151i32;
                } else if (__value__ == (2641200i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 2641260i32;
                    } else {
                        _gotoNext = 2641437i32;
                    };
                } else if (__value__ == (2641260i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2641367i32;
                    } else {
                        _gotoNext = 2641396i32;
                    };
                } else if (__value__ == (2641367i32)) {
                    _i_5++;
                    _gotoNext = 2641151i32;
                } else if (__value__ == (2641396i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2640474i32;
                } else if (__value__ == (2641437i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2641451i32;
                    } else {
                        _gotoNext = 2641196i32;
                    };
                } else if (__value__ == (2641451i32)) {
                    return {
                    ...
                    _gotoNext = 2641196i32;
                } else if (__value__ == (2641605i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 2641605i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2641626i32;
                    } else {
                        _gotoNext = 2641758i32;
                    };
                } else if (__value__ == (2641626i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2641723i32;
                        } else {
                            _gotoNext = 2641605i32;
                        };
                    };
                } else if (__value__ == (2641723i32)) {
                    return {
