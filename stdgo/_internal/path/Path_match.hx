...
function match(_pattern:stdgo.GoString, _name:stdgo.GoString):{ var _0 : Bool; var _1 : stdgo.Error; } {
        ...
        while (_gotoNext != ((-1i64 : stdgo.GoInt))) {
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    _gotoNext = 2645088i64;
                } else if (__value__ == (2645088i64)) {
                    0i64;
                    patternBreak = false;
                    _gotoNext = 2645098i64;
                } else if (__value__ == (2645098i64)) {
                    //"file://#L0"
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2645119i64;
                    } else {
                        _gotoNext = 2646404i64;
                    };
                } else if (__value__ == (2645119i64)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2645225i64;
                    } else {
                        _gotoNext = 2645387i64;
                    };
                } else if (__value__ == (2645225i64)) {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2645625i64;
                    } else {
                        _gotoNext = 2645657i64;
                    };
                } else if (__value__ == (2645625i64)) {
                    _name = _t_2?.__copy__();
                    0i64;
                    _gotoNext = 2645098i64;
                } else if (__value__ == (2645657i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/match.go#L56"
                    if (_err_4 != null) {
                        _gotoNext = 2645671i64;
                    } else {
                        _gotoNext = 2645700i64;
                    };
                } else if (__value__ == (2645671i64)) {
                    ...
                    _gotoNext = 2645700i64;
                } else if (__value__ == (2645700i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/match.go#L59"
                    if (_star_0) {
                        _gotoNext = 2645708i64;
                    } else {
                        _gotoNext = 2646229i64;
                    };
                } else if (__value__ == (2645708i64)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2645775i64;
                } else if (__value__ == (2645775i64)) {
                    //"file://#L0"
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2645824i64;
                    } else {
                        _gotoNext = 2646229i64;
                    };
                } else if (__value__ == (2645820i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/match.go#L62"
                    _i_5++;
                    _gotoNext = 2645775i64;
                } else if (__value__ == (2645824i64)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 2645884i64;
                    } else {
                        _gotoNext = 2646061i64;
                    };
                } else if (__value__ == (2645884i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/match.go#L66"
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2645991i64;
                    } else {
                        _gotoNext = 2646020i64;
                    };
                } else if (__value__ == (2645991i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/match.go#L62"
                    _i_5++;
                    _gotoNext = 2645775i64;
                } else if (__value__ == (2646020i64)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2645098i64;
                } else if (__value__ == (2646061i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/match.go#L72"
                    if (_err_8 != null) {
                        _gotoNext = 2646075i64;
                    } else {
                        _gotoNext = 2645820i64;
                    };
                } else if (__value__ == (2646075i64)) {
                    ...
                    _gotoNext = 2645820i64;
                } else if (__value__ == (2646229i64)) {
                    0i64;
                    _gotoNext = 2646229i64;
                    //"file://#L0"
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2646250i64;
                    } else {
                        _gotoNext = 2646382i64;
                    };
                } else if (__value__ == (2646250i64)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/path/match.go#L81"
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2646347i64;
                        } else {
                            _gotoNext = 2646229i64;
                        };
                    };
                } else if (__value__ == (2646347i64)) {
