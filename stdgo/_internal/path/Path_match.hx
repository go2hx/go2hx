        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 2602730i32;
                } else if (__value__ == (2602730i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2602751i32;
                    } else {
                        _gotoNext = 2604036i32;
                    };
                } else if (__value__ == (2602751i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2602857i32;
                    } else {
                        _gotoNext = 2603019i32;
                    };
                } else if (__value__ == (2602857i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2603257i32;
                    } else {
                        _gotoNext = 2603289i32;
                    };
                } else if (__value__ == (2603257i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 2602730i32;
                } else if (__value__ == (2603289i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2603303i32;
                    } else {
                        _gotoNext = 2603332i32;
                    };
                } else if (__value__ == (2603303i32)) {
                    return {
                    ...
                    _gotoNext = 2603332i32;
                } else if (__value__ == (2603332i32)) {
                    if (_star_0) {
                        _gotoNext = 2603340i32;
                    } else {
                        _gotoNext = 2603861i32;
                    };
                } else if (__value__ == (2603340i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2603407i32;
                } else if (__value__ == (2603407i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2603456i32;
                    } else {
                        _gotoNext = 2603861i32;
                    };
                } else if (__value__ == (2603452i32)) {
                    _i_5++;
                    _gotoNext = 2603407i32;
                } else if (__value__ == (2603456i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 2603516i32;
                    } else {
                        _gotoNext = 2603693i32;
                    };
                } else if (__value__ == (2603516i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2603623i32;
                    } else {
                        _gotoNext = 2603652i32;
                    };
                } else if (__value__ == (2603623i32)) {
                    _i_5++;
                    _gotoNext = 2603407i32;
                } else if (__value__ == (2603652i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2602730i32;
                } else if (__value__ == (2603693i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2603707i32;
                    } else {
                        _gotoNext = 2603452i32;
                    };
                } else if (__value__ == (2603707i32)) {
                    return {
                    ...
                    _gotoNext = 2603452i32;
                } else if (__value__ == (2603861i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 2603861i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2603882i32;
                    } else {
                        _gotoNext = 2604014i32;
                    };
                } else if (__value__ == (2603882i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
