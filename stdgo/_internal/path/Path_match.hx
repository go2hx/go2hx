        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2605677i32;
                } else if (__value__ == (2605677i32)) {
                    0i32;
                    patternBreak = false;
                    _gotoNext = 2605687i32;
                } else if (__value__ == (2605687i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2605708i32;
                    } else {
                        _gotoNext = 2606993i32;
                    };
                } else if (__value__ == (2605708i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2605814i32;
                    } else {
                        _gotoNext = 2605976i32;
                    };
                } else if (__value__ == (2605814i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2606214i32;
                    } else {
                        _gotoNext = 2606246i32;
                    };
                } else if (__value__ == (2606214i32)) {
                    _name = _t_2?.__copy__();
                    0i32;
                    _gotoNext = 2605687i32;
                } else if (__value__ == (2606246i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2606260i32;
                    } else {
                        _gotoNext = 2606289i32;
                    };
                } else if (__value__ == (2606260i32)) {
                    return {
                    ...
                    _gotoNext = 2606289i32;
                } else if (__value__ == (2606289i32)) {
                    if (_star_0) {
                        _gotoNext = 2606297i32;
                    } else {
                        _gotoNext = 2606818i32;
                    };
                } else if (__value__ == (2606297i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2606364i32;
                } else if (__value__ == (2606364i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2606413i32;
                    } else {
                        _gotoNext = 2606818i32;
                    };
                } else if (__value__ == (2606409i32)) {
                    _i_5++;
                    _gotoNext = 2606364i32;
                } else if (__value__ == (2606413i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 2606473i32;
                    } else {
                        _gotoNext = 2606650i32;
                    };
                } else if (__value__ == (2606473i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2606580i32;
                    } else {
                        _gotoNext = 2606609i32;
                    };
                } else if (__value__ == (2606580i32)) {
                    _i_5++;
                    _gotoNext = 2606364i32;
                } else if (__value__ == (2606609i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2605687i32;
                } else if (__value__ == (2606650i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2606664i32;
                    } else {
                        _gotoNext = 2606409i32;
                    };
                    ...
                    _gotoNext = 2606409i32;
                } else if (__value__ == (2606818i32)) {
                    0i32;
                    _gotoNext = 2606818i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2606839i32;
                    } else {
                        _gotoNext = 2606971i32;
                    };
                } else if (__value__ == (2606839i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2606936i32;
                        } else {
                            _gotoNext = 2606818i32;
                        };
                    };
                } else if (__value__ == (2606936i32)) {
                    return {
