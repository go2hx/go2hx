        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2890976i32;
                } else if (__value__ == (2890976i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 2890986i32;
                } else if (__value__ == (2890986i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2891007i32;
                    } else {
                        _gotoNext = 2892292i32;
                    };
                } else if (__value__ == (2891007i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2891113i32;
                    } else {
                        _gotoNext = 2891275i32;
                    };
                } else if (__value__ == (2891113i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2891513i32;
                    } else {
                        _gotoNext = 2891545i32;
                    };
                } else if (__value__ == (2891513i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 2890986i32;
                } else if (__value__ == (2891545i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2891559i32;
                    } else {
                        _gotoNext = 2891588i32;
                    };
                } else if (__value__ == (2891559i32)) {
                    return {
                    ...
                    _gotoNext = 2891588i32;
                } else if (__value__ == (2891588i32)) {
                    if (_star_0) {
                        _gotoNext = 2891596i32;
                    } else {
                        _gotoNext = 2892117i32;
                    };
                } else if (__value__ == (2891596i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2891663i32;
                } else if (__value__ == (2891663i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2891712i32;
                    } else {
                        _gotoNext = 2892117i32;
                    };
                } else if (__value__ == (2891708i32)) {
                    _i_5++;
                    _gotoNext = 2891663i32;
                } else if (__value__ == (2891712i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 2891772i32;
                    } else {
                        _gotoNext = 2891949i32;
                    };
                } else if (__value__ == (2891772i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2891879i32;
                    } else {
                        _gotoNext = 2891908i32;
                    };
                } else if (__value__ == (2891879i32)) {
                    _i_5++;
                    _gotoNext = 2891663i32;
                } else if (__value__ == (2891908i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2890986i32;
                } else if (__value__ == (2891949i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2891963i32;
                    } else {
                        _gotoNext = 2891708i32;
                    };
                } else if (__value__ == (2891963i32)) {
                    return {
                    ...
                    _gotoNext = 2891708i32;
                } else if (__value__ == (2892117i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 2892117i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2892138i32;
                    } else {
                        _gotoNext = 2892270i32;
                    };
                } else if (__value__ == (2892138i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2892235i32;
                        } else {
                            _gotoNext = 2892117i32;
                        };
                    };
                } else if (__value__ == (2892235i32)) {
                    return {
