        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2682464i32;
                } else if (__value__ == (2682464i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 2682474i32;
                } else if (__value__ == (2682474i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2682495i32;
                    } else {
                        _gotoNext = 2683780i32;
                    };
                } else if (__value__ == (2682495i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2682601i32;
                    } else {
                        _gotoNext = 2682763i32;
                    };
                } else if (__value__ == (2682601i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        ...
                        _gotoNext = 2683033i32;
                    };
                } else if (__value__ == (2683001i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 2682474i32;
                } else if (__value__ == (2683033i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2683047i32;
                    } else {
                        _gotoNext = 2683076i32;
                    };
                } else if (__value__ == (2683047i32)) {
                    return {
                    ...
                    _gotoNext = 2683076i32;
                } else if (__value__ == (2683076i32)) {
                    if (_star_0) {
                        _gotoNext = 2683084i32;
                    } else {
                        _gotoNext = 2683605i32;
                    };
                } else if (__value__ == (2683084i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2683151i32;
                } else if (__value__ == (2683151i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2683200i32;
                    } else {
                        _gotoNext = 2683605i32;
                    };
                } else if (__value__ == (2683196i32)) {
                    _i_5++;
                    _gotoNext = 2683151i32;
                } else if (__value__ == (2683200i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 2683260i32;
                    } else {
                        _gotoNext = 2683437i32;
                    };
                } else if (__value__ == (2683260i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2683367i32;
                    } else {
                        _gotoNext = 2683396i32;
                    };
                } else if (__value__ == (2683367i32)) {
                    _i_5++;
                    _gotoNext = 2683151i32;
                } else if (__value__ == (2683396i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2682474i32;
                } else if (__value__ == (2683437i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2683451i32;
                    } else {
                        _gotoNext = 2683196i32;
                    };
                } else if (__value__ == (2683451i32)) {
                    return {
                    ...
                    _gotoNext = 2683196i32;
                } else if (__value__ == (2683605i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 2683605i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2683626i32;
                    } else {
                        _gotoNext = 2683758i32;
                    };
                } else if (__value__ == (2683626i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2683723i32;
                        } else {
                            _gotoNext = 2683605i32;
                        };
                    };
                } else if (__value__ == (2683723i32)) {
                    return {
