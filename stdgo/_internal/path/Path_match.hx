        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                ...
                } else if (__value__ == (2594818i32)) {
                    {
                        ...
                        _star_2594826 = @:tmpset0 __tmp__._0;
                        _chunk_2594842 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    if ((_star_2594826 && (_chunk_2594842 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                ...
                } else if (__value__ == (2595086i32)) {
                    {
                        ...
                        _t_2595086 = @:tmpset0 __tmp__._0?.__copy__();
                        _ok_2595089 = @:tmpset0 __tmp__._1;
                        _err_2595093 = @:tmpset0 __tmp__._2;
                    };
                    ...
                    return {
                        final __tmp__:{ var _0 : Bool; var _1 : stdgo.Error; } = { _0 : false, _1 : _err_2595093 };
                        _matched = __tmp__._0;
                        _err = __tmp__._1;
                        __tmp__;
                    };
                ...
                } else if (__value__ == (2595523i32)) {
                    {
                        ...
                        _t_2595529 = @:tmpset0 __tmp__._0?.__copy__();
                        _ok_2595532 = @:tmpset0 __tmp__._1;
                        _err_2595536 = @:tmpset0 __tmp__._2;
                    };
                    if (_ok_2595532) {
                    ...
                    return {
                        final __tmp__:{ var _0 : Bool; var _1 : stdgo.Error; } = { _0 : false, _1 : _err_2595536 };
                        _matched = __tmp__._0;
                        _err = __tmp__._1;
                        __tmp__;
                    };
                    ...
                    {
                        {
                            var __tmp__ = stdgo._internal.path.Path__matchchunk._matchChunk(_chunk_2594842?.__copy__(), (stdgo.Go.str() : stdgo.GoString)?.__copy__());
                            _err_2596005 = @:tmpset0 __tmp__._2;
                        };
                    ...
                    return {
                        final __tmp__:{ var _0 : Bool; var _1 : stdgo.Error; } = { _0 : false, _1 : _err_2596005 };
                        _matched = __tmp__._0;
                        _err = __tmp__._1;
                        __tmp__;
                    };
