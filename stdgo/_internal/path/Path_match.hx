        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2599842i32;
                } else if (__value__ == (2599842i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 2599852i32;
                } else if (__value__ == (2599852i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2599873i32;
                    } else {
                        _gotoNext = 2601158i32;
                    };
                } else if (__value__ == (2599873i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2599979i32;
                    } else {
                        _gotoNext = 2600141i32;
                    };
                } else if (__value__ == (2599979i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2600379i32;
                    } else {
                        _gotoNext = 2600411i32;
                    };
                } else if (__value__ == (2600379i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 2599852i32;
                } else if (__value__ == (2600411i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2600425i32;
                    } else {
                        _gotoNext = 2600454i32;
                    };
                } else if (__value__ == (2600425i32)) {
                    return {
                    ...
                    _gotoNext = 2600454i32;
                } else if (__value__ == (2600454i32)) {
                    if (_star_0) {
                        _gotoNext = 2600462i32;
                    } else {
                        _gotoNext = 2600983i32;
                    };
                } else if (__value__ == (2600462i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2600529i32;
                } else if (__value__ == (2600529i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2600578i32;
                    } else {
                        _gotoNext = 2600983i32;
                    };
                } else if (__value__ == (2600574i32)) {
                    _i_5++;
                    _gotoNext = 2600529i32;
                } else if (__value__ == (2600578i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 2600638i32;
                    } else {
                        _gotoNext = 2600815i32;
                    };
                } else if (__value__ == (2600638i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2600745i32;
                    } else {
                        _gotoNext = 2600774i32;
                    };
                } else if (__value__ == (2600745i32)) {
                    _i_5++;
                    _gotoNext = 2600529i32;
                } else if (__value__ == (2600774i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2599852i32;
                } else if (__value__ == (2600815i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2600829i32;
                    } else {
                        _gotoNext = 2600574i32;
                    };
                } else if (__value__ == (2600829i32)) {
                    return {
                    ...
                    _gotoNext = 2600574i32;
                } else if (__value__ == (2600983i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 2600983i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2601004i32;
                    } else {
                        _gotoNext = 2601136i32;
                    };
                } else if (__value__ == (2601004i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2601101i32;
                        } else {
                            _gotoNext = 2600983i32;
                        };
                    };
                } else if (__value__ == (2601101i32)) {
                    return {
