        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2595887i32;
                } else if (__value__ == (2595887i32)) {
                    0i32;
                    patternBreak = false;
                    _gotoNext = 2595897i32;
                } else if (__value__ == (2595897i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2595918i32;
                    } else {
                        _gotoNext = 2597203i32;
                    };
                } else if (__value__ == (2595918i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2596024i32;
                    } else {
                        _gotoNext = 2596186i32;
                    };
                } else if (__value__ == (2596024i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2596424i32;
                    } else {
                        _gotoNext = 2596456i32;
                    };
                } else if (__value__ == (2596424i32)) {
                    _name = _t_2?.__copy__();
                    0i32;
                    _gotoNext = 2595897i32;
                } else if (__value__ == (2596456i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2596470i32;
                    } else {
                        _gotoNext = 2596499i32;
                    };
                } else if (__value__ == (2596470i32)) {
                    return {
                    ...
                    if (_star_0) {
                        _gotoNext = 2596507i32;
                    } else {
                        _gotoNext = 2597028i32;
                    };
                } else if (__value__ == (2596507i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2596574i32;
                } else if (__value__ == (2596574i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2596623i32;
                    } else {
                        _gotoNext = 2597028i32;
                    };
                } else if (__value__ == (2596619i32)) {
                    _i_5++;
                    _gotoNext = 2596574i32;
                } else if (__value__ == (2596623i32)) {
                    {
                    ...
                    if (_ok_7) {
                        ...
                        _gotoNext = 2596860i32;
                    };
                } else if (__value__ == (2596683i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2596790i32;
                    } else {
                        _gotoNext = 2596819i32;
                    };
                } else if (__value__ == (2596790i32)) {
                    _i_5++;
                    _gotoNext = 2596574i32;
                } else if (__value__ == (2596819i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2595897i32;
                } else if (__value__ == (2596860i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2596874i32;
                    } else {
                        _gotoNext = 2596619i32;
                    };
                } else if (__value__ == (2596874i32)) {
                    return {
                    ...
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2597049i32;
                    } else {
                        _gotoNext = 2597181i32;
                    };
                } else if (__value__ == (2597049i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2597146i32;
                        } else {
                            _gotoNext = 2597028i32;
                        };
                    };
                } else if (__value__ == (2597146i32)) {
                    return {
