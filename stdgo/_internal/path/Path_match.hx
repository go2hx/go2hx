        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2593908i32;
                } else if (__value__ == (2593908i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 2593918i32;
                } else if (__value__ == (2593918i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2593939i32;
                    } else {
                        _gotoNext = 2595224i32;
                    };
                } else if (__value__ == (2593939i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2594045i32;
                    } else {
                        _gotoNext = 2594207i32;
                    };
                } else if (__value__ == (2594045i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2594445i32;
                    } else {
                        _gotoNext = 2594477i32;
                    };
                } else if (__value__ == (2594445i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 2593918i32;
                } else if (__value__ == (2594477i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2594491i32;
                    } else {
                        _gotoNext = 2594520i32;
                    };
                } else if (__value__ == (2594491i32)) {
                    return {
                    ...
                    _gotoNext = 2594520i32;
                } else if (__value__ == (2594520i32)) {
                    if (_star_0) {
                        _gotoNext = 2594528i32;
                    } else {
                        _gotoNext = 2595049i32;
                    };
                } else if (__value__ == (2594528i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2594595i32;
                } else if (__value__ == (2594595i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2594644i32;
                    } else {
                        _gotoNext = 2595049i32;
                    };
                } else if (__value__ == (2594640i32)) {
                    _i_5++;
                    _gotoNext = 2594595i32;
                } else if (__value__ == (2594644i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 2594704i32;
                    } else {
                        _gotoNext = 2594881i32;
                    };
                } else if (__value__ == (2594704i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2594811i32;
                    } else {
                        _gotoNext = 2594840i32;
                    };
                } else if (__value__ == (2594811i32)) {
                    _i_5++;
                    _gotoNext = 2594595i32;
                } else if (__value__ == (2594840i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2593918i32;
                } else if (__value__ == (2594881i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2594895i32;
                    } else {
                        _gotoNext = 2594640i32;
                    };
                } else if (__value__ == (2594895i32)) {
                    return {
                    ...
                    _gotoNext = 2594640i32;
                } else if (__value__ == (2595049i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 2595049i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2595070i32;
                    } else {
                        _gotoNext = 2595202i32;
                    };
                } else if (__value__ == (2595070i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2595167i32;
                        } else {
                            _gotoNext = 2595049i32;
                        };
                    };
                } else if (__value__ == (2595167i32)) {
                    return {
