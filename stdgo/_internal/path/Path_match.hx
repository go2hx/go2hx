        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 3068117i32;
                } else if (__value__ == (3068117i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 3068127i32;
                } else if (__value__ == (3068127i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 3068148i32;
                    } else {
                        _gotoNext = 3069433i32;
                    };
                } else if (__value__ == (3068148i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 3068254i32;
                    } else {
                        _gotoNext = 3068416i32;
                    };
                } else if (__value__ == (3068254i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 3068654i32;
                    } else {
                        _gotoNext = 3068686i32;
                    };
                } else if (__value__ == (3068654i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 3068127i32;
                } else if (__value__ == (3068686i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 3068700i32;
                    } else {
                        _gotoNext = 3068729i32;
                    };
                } else if (__value__ == (3068700i32)) {
                    return {
                    ...
                    _gotoNext = 3068729i32;
                } else if (__value__ == (3068729i32)) {
                    if (_star_0) {
                        _gotoNext = 3068737i32;
                    } else {
                        _gotoNext = 3069258i32;
                    };
                } else if (__value__ == (3068737i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 3068804i32;
                } else if (__value__ == (3068804i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 3068853i32;
                    } else {
                        _gotoNext = 3069258i32;
                    };
                } else if (__value__ == (3068849i32)) {
                    _i_5++;
                    _gotoNext = 3068804i32;
                } else if (__value__ == (3068853i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 3068913i32;
                    } else {
                        _gotoNext = 3069090i32;
                    };
                } else if (__value__ == (3068913i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 3069020i32;
                    } else {
                        _gotoNext = 3069049i32;
                    };
                } else if (__value__ == (3069020i32)) {
                    _i_5++;
                    _gotoNext = 3068804i32;
                } else if (__value__ == (3069049i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 3068127i32;
                } else if (__value__ == (3069090i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 3069104i32;
                    } else {
                        _gotoNext = 3068849i32;
                    };
                } else if (__value__ == (3069104i32)) {
                    return {
                    ...
                    _gotoNext = 3068849i32;
                } else if (__value__ == (3069258i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3069258i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3069279i32;
                    } else {
                        _gotoNext = 3069411i32;
                    };
                } else if (__value__ == (3069279i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 3069376i32;
                        } else {
                            _gotoNext = 3069258i32;
                        };
                    };
                } else if (__value__ == (3069376i32)) {
                    return {
