        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2735602i32;
                } else if (__value__ == (2735602i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 2735612i32;
                } else if (__value__ == (2735612i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2735633i32;
                    } else {
                        _gotoNext = 2736918i32;
                    };
                } else if (__value__ == (2735633i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2735739i32;
                    } else {
                        _gotoNext = 2735901i32;
                    };
                } else if (__value__ == (2735739i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2736139i32;
                    } else {
                        _gotoNext = 2736171i32;
                    };
                } else if (__value__ == (2736139i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 2735612i32;
                } else if (__value__ == (2736171i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2736185i32;
                    } else {
                        _gotoNext = 2736214i32;
                    };
                } else if (__value__ == (2736185i32)) {
                    return {
                    ...
                    _gotoNext = 2736214i32;
                } else if (__value__ == (2736214i32)) {
                    if (_star_0) {
                        _gotoNext = 2736222i32;
                    } else {
                        _gotoNext = 2736743i32;
                    };
                } else if (__value__ == (2736222i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2736289i32;
                } else if (__value__ == (2736289i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2736338i32;
                    } else {
                        _gotoNext = 2736743i32;
                    };
                } else if (__value__ == (2736334i32)) {
                    _i_5++;
                    _gotoNext = 2736289i32;
                    ...
                    if (_ok_7) {
                        _gotoNext = 2736398i32;
                    } else {
                        _gotoNext = 2736575i32;
                    };
                } else if (__value__ == (2736398i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2736505i32;
                    } else {
                        _gotoNext = 2736534i32;
                    };
                } else if (__value__ == (2736505i32)) {
                    _i_5++;
                    _gotoNext = 2736289i32;
                } else if (__value__ == (2736534i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2735612i32;
                } else if (__value__ == (2736575i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2736589i32;
                    } else {
                        _gotoNext = 2736334i32;
                    };
                } else if (__value__ == (2736589i32)) {
                    return {
                    ...
                    _gotoNext = 2736334i32;
                } else if (__value__ == (2736743i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 2736743i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2736764i32;
                    } else {
                        _gotoNext = 2736896i32;
                    };
                } else if (__value__ == (2736764i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2736861i32;
                        } else {
                            _gotoNext = 2736743i32;
                        };
                    };
                } else if (__value__ == (2736861i32)) {
                    return {
