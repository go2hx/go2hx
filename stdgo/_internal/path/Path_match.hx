        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2694966i32;
                } else if (__value__ == (2694966i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 2694976i32;
                } else if (__value__ == (2694976i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2694997i32;
                    } else {
                        _gotoNext = 2696282i32;
                    };
                } else if (__value__ == (2694997i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2695103i32;
                    } else {
                        _gotoNext = 2695265i32;
                    };
                } else if (__value__ == (2695103i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2695503i32;
                    } else {
                        _gotoNext = 2695535i32;
                    };
                } else if (__value__ == (2695503i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 2694976i32;
                } else if (__value__ == (2695535i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2695549i32;
                    } else {
                        _gotoNext = 2695578i32;
                    };
                } else if (__value__ == (2695549i32)) {
                    return {
                    ...
                    _gotoNext = 2695578i32;
                } else if (__value__ == (2695578i32)) {
                    if (_star_0) {
                        _gotoNext = 2695586i32;
                    } else {
                        _gotoNext = 2696107i32;
                    };
                } else if (__value__ == (2695586i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2695653i32;
                } else if (__value__ == (2695653i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2695702i32;
                    } else {
                        _gotoNext = 2696107i32;
                    };
                    ...
                    if (_ok_7) {
                        _gotoNext = 2695762i32;
                    } else {
                        _gotoNext = 2695939i32;
                    };
                } else if (__value__ == (2695762i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2695869i32;
                    } else {
                        _gotoNext = 2695898i32;
                    };
                } else if (__value__ == (2695869i32)) {
                    _i_5++;
                    _gotoNext = 2695653i32;
                } else if (__value__ == (2695898i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2694976i32;
                } else if (__value__ == (2695939i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2695953i32;
                    } else {
                        _gotoNext = 2695698i32;
                    };
                } else if (__value__ == (2695953i32)) {
                    return {
                    ...
                    _gotoNext = 2695698i32;
                } else if (__value__ == (2696107i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 2696107i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2696128i32;
                    } else {
                        _gotoNext = 2696260i32;
                    };
                } else if (__value__ == (2696128i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2696225i32;
                        } else {
                            _gotoNext = 2696107i32;
                        };
                    };
                } else if (__value__ == (2696225i32)) {
                    return {
