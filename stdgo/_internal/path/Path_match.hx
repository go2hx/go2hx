        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2896149i32;
                } else if (__value__ == (2896149i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 2896159i32;
                } else if (__value__ == (2896159i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2896180i32;
                    } else {
                        _gotoNext = 2897465i32;
                    };
                } else if (__value__ == (2896180i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2896286i32;
                    } else {
                        _gotoNext = 2896448i32;
                    };
                } else if (__value__ == (2896286i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2896686i32;
                    } else {
                        _gotoNext = 2896718i32;
                    };
                } else if (__value__ == (2896686i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 2896159i32;
                } else if (__value__ == (2896718i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2896732i32;
                    } else {
                        _gotoNext = 2896761i32;
                    };
                } else if (__value__ == (2896732i32)) {
                    return {
                    ...
                    _gotoNext = 2896761i32;
                } else if (__value__ == (2896761i32)) {
                    if (_star_0) {
                        _gotoNext = 2896769i32;
                    } else {
                        _gotoNext = 2897290i32;
                    };
                } else if (__value__ == (2896769i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2896836i32;
                } else if (__value__ == (2896836i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2896885i32;
                    } else {
                        _gotoNext = 2897290i32;
                    };
                } else if (__value__ == (2896881i32)) {
                    _i_5++;
                    _gotoNext = 2896836i32;
                } else if (__value__ == (2896885i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 2896945i32;
                    } else {
                        _gotoNext = 2897122i32;
                    };
                } else if (__value__ == (2896945i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2897052i32;
                    } else {
                        _gotoNext = 2897081i32;
                    };
                } else if (__value__ == (2897052i32)) {
                    _i_5++;
                    _gotoNext = 2896836i32;
                } else if (__value__ == (2897081i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2896159i32;
                } else if (__value__ == (2897122i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2897136i32;
                    } else {
                        _gotoNext = 2896881i32;
                    };
                    ...
                    _gotoNext = 2896881i32;
                } else if (__value__ == (2897290i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 2897290i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2897311i32;
                    } else {
                        _gotoNext = 2897443i32;
                    };
                } else if (__value__ == (2897311i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
