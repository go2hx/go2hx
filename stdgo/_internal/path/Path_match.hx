        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2787358i32;
                } else if (__value__ == (2787358i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 2787368i32;
                } else if (__value__ == (2787368i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2787389i32;
                    } else {
                        _gotoNext = 2788674i32;
                    };
                } else if (__value__ == (2787389i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2787495i32;
                    } else {
                        _gotoNext = 2787657i32;
                    };
                } else if (__value__ == (2787495i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2787895i32;
                    } else {
                        _gotoNext = 2787927i32;
                    };
                } else if (__value__ == (2787895i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 2787368i32;
                } else if (__value__ == (2787927i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2787941i32;
                    } else {
                        _gotoNext = 2787970i32;
                    };
                } else if (__value__ == (2787941i32)) {
                    return {
                    ...
                    _gotoNext = 2787970i32;
                } else if (__value__ == (2787970i32)) {
                    if (_star_0) {
                        _gotoNext = 2787978i32;
                    } else {
                        _gotoNext = 2788499i32;
                    };
                } else if (__value__ == (2787978i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2788045i32;
                } else if (__value__ == (2788045i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2788094i32;
                    } else {
                        _gotoNext = 2788499i32;
                    };
                } else if (__value__ == (2788090i32)) {
                    _i_5++;
                    _gotoNext = 2788045i32;
                } else if (__value__ == (2788094i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 2788154i32;
                    } else {
                        _gotoNext = 2788331i32;
                    };
                } else if (__value__ == (2788154i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2788261i32;
                    } else {
                        _gotoNext = 2788290i32;
                    };
                } else if (__value__ == (2788261i32)) {
                    _i_5++;
                    _gotoNext = 2788045i32;
                } else if (__value__ == (2788290i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2787368i32;
                } else if (__value__ == (2788331i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2788345i32;
                    } else {
                        _gotoNext = 2788090i32;
                    };
                } else if (__value__ == (2788345i32)) {
                    return {
                    ...
                    _gotoNext = 2788090i32;
                } else if (__value__ == (2788499i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 2788499i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2788520i32;
                    } else {
                        _gotoNext = 2788652i32;
                    };
                } else if (__value__ == (2788520i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2788617i32;
                        } else {
                            _gotoNext = 2788499i32;
                        };
                    };
                } else if (__value__ == (2788617i32)) {
                    return {
