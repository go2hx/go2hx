...
function match(_pattern:stdgo.GoString, _name:stdgo.GoString):{ var _0 : Bool; var _1 : stdgo.Error; } {
        ...
        while (_gotoNext != ((-1i64 : stdgo.GoInt))) {
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    _gotoNext = 2806048i64;
                } else if (__value__ == (2806048i64)) {
                    0i64;
                    patternBreak = false;
                    _gotoNext = 2806058i64;
                } else if (__value__ == (2806058i64)) {
                    //"file://#L0"
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2806079i64;
                    } else {
                        _gotoNext = 2807364i64;
                    };
                } else if (__value__ == (2806079i64)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2806185i64;
                    } else {
                        _gotoNext = 2806347i64;
                    };
                } else if (__value__ == (2806185i64)) {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2806585i64;
                    } else {
                        _gotoNext = 2806617i64;
                    };
                } else if (__value__ == (2806585i64)) {
                    _name = _t_2?.__copy__();
                    0i64;
                    _gotoNext = 2806058i64;
                } else if (__value__ == (2806617i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/match.go#L56"
                    if (_err_4 != null) {
                        _gotoNext = 2806631i64;
                    } else {
                        _gotoNext = 2806660i64;
                    };
                } else if (__value__ == (2806631i64)) {
                    ...
                    _gotoNext = 2806660i64;
                } else if (__value__ == (2806660i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/match.go#L59"
                    if (_star_0) {
                        _gotoNext = 2806668i64;
                    } else {
                        _gotoNext = 2807189i64;
                    };
                } else if (__value__ == (2806668i64)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2806735i64;
                } else if (__value__ == (2806735i64)) {
                    //"file://#L0"
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2806784i64;
                    } else {
                        _gotoNext = 2807189i64;
                    };
                } else if (__value__ == (2806780i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/match.go#L62"
                    _i_5++;
                    _gotoNext = 2806735i64;
                } else if (__value__ == (2806784i64)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 2806844i64;
                    } else {
                        _gotoNext = 2807021i64;
                    };
                } else if (__value__ == (2806844i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/match.go#L66"
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2806951i64;
                    } else {
                        _gotoNext = 2806980i64;
                    };
                } else if (__value__ == (2806951i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/match.go#L62"
                    _i_5++;
                    _gotoNext = 2806735i64;
                } else if (__value__ == (2806980i64)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2806058i64;
                } else if (__value__ == (2807021i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/match.go#L72"
                    if (_err_8 != null) {
                        _gotoNext = 2807035i64;
                    } else {
                        _gotoNext = 2806780i64;
                    };
                } else if (__value__ == (2807035i64)) {
                    ...
                    _gotoNext = 2806780i64;
                } else if (__value__ == (2807189i64)) {
                    0i64;
                    _gotoNext = 2807189i64;
                    //"file://#L0"
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2807210i64;
                    } else {
                        _gotoNext = 2807342i64;
                    };
                } else if (__value__ == (2807210i64)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/path/match.go#L81"
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2807307i64;
                        } else {
                            _gotoNext = 2807189i64;
                        };
                    };
                } else if (__value__ == (2807307i64)) {
