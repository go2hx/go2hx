        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2585577i32;
                } else if (__value__ == (2585577i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 2585587i32;
                } else if (__value__ == (2585587i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2585608i32;
                    } else {
                        _gotoNext = 2586893i32;
                    };
                } else if (__value__ == (2585608i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2585714i32;
                    } else {
                        _gotoNext = 2585876i32;
                    };
                } else if (__value__ == (2585714i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2586114i32;
                    } else {
                        _gotoNext = 2586146i32;
                    };
                } else if (__value__ == (2586114i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 2585587i32;
                } else if (__value__ == (2586146i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2586160i32;
                    } else {
                        _gotoNext = 2586189i32;
                    };
                } else if (__value__ == (2586160i32)) {
                    return {
                    ...
                    _gotoNext = 2586189i32;
                } else if (__value__ == (2586189i32)) {
                    if (_star_0) {
                        _gotoNext = 2586197i32;
                    } else {
                        _gotoNext = 2586718i32;
                    };
                } else if (__value__ == (2586197i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2586264i32;
                } else if (__value__ == (2586264i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2586313i32;
                    } else {
                        _gotoNext = 2586718i32;
                    };
                    ...
                    if (_ok_7) {
                        _gotoNext = 2586373i32;
                    } else {
                        _gotoNext = 2586550i32;
                    };
                } else if (__value__ == (2586373i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2586480i32;
                    } else {
                        _gotoNext = 2586509i32;
                    };
                } else if (__value__ == (2586480i32)) {
                    _i_5++;
                    _gotoNext = 2586264i32;
                } else if (__value__ == (2586509i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2585587i32;
                } else if (__value__ == (2586550i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2586564i32;
                    } else {
                        _gotoNext = 2586309i32;
                    };
                } else if (__value__ == (2586564i32)) {
                    return {
                    ...
                    _gotoNext = 2586309i32;
                } else if (__value__ == (2586718i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 2586718i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2586739i32;
                    } else {
                        _gotoNext = 2586871i32;
                    };
                } else if (__value__ == (2586739i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
