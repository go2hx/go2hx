        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2602419i32;
                } else if (__value__ == (2602419i32)) {
                    0i32;
                    patternBreak = false;
                    _gotoNext = 2602429i32;
                } else if (__value__ == (2602429i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2602450i32;
                    } else {
                        _gotoNext = 2603735i32;
                    };
                } else if (__value__ == (2602450i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2602556i32;
                    } else {
                        _gotoNext = 2602718i32;
                    };
                } else if (__value__ == (2602556i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2602956i32;
                    } else {
                        _gotoNext = 2602988i32;
                    };
                } else if (__value__ == (2602956i32)) {
                    _name = _t_2?.__copy__();
                    0i32;
                    _gotoNext = 2602429i32;
                } else if (__value__ == (2602988i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2603002i32;
                    } else {
                        _gotoNext = 2603031i32;
                    };
                } else if (__value__ == (2603002i32)) {
                    return {
                    ...
                    _gotoNext = 2603031i32;
                } else if (__value__ == (2603031i32)) {
                    if (_star_0) {
                        _gotoNext = 2603039i32;
                    } else {
                        _gotoNext = 2603560i32;
                    };
                } else if (__value__ == (2603039i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2603106i32;
                } else if (__value__ == (2603106i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2603155i32;
                    } else {
                        _gotoNext = 2603560i32;
                    };
                } else if (__value__ == (2603151i32)) {
                    _i_5++;
                    _gotoNext = 2603106i32;
                } else if (__value__ == (2603155i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 2603215i32;
                    } else {
                        _gotoNext = 2603392i32;
                    };
                } else if (__value__ == (2603215i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2603322i32;
                    } else {
                        _gotoNext = 2603351i32;
                    };
                } else if (__value__ == (2603322i32)) {
                    _i_5++;
                    _gotoNext = 2603106i32;
                } else if (__value__ == (2603351i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2602429i32;
                } else if (__value__ == (2603392i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2603406i32;
                    } else {
                        _gotoNext = 2603151i32;
                    };
                } else if (__value__ == (2603406i32)) {
                    return {
                    ...
                    _gotoNext = 2603151i32;
                } else if (__value__ == (2603560i32)) {
                    0i32;
                    _gotoNext = 2603560i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2603581i32;
                    } else {
                        _gotoNext = 2603713i32;
                    };
                } else if (__value__ == (2603581i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2603678i32;
                        } else {
                            _gotoNext = 2603560i32;
                        };
                    };
                } else if (__value__ == (2603678i32)) {
                    return {
