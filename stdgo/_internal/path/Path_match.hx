        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                ...
                } else if (__value__ == (2577945i32)) {
                    {
                        ...
                        _star_2577953 = __tmp__._0;
                        _chunk_2577969 = __tmp__._1?.__copy__();
                        _pattern = __tmp__._2?.__copy__();
                    };
                    if ((_star_2577953 && (_chunk_2577969 == stdgo.Go.str()) : Bool)) {
                ...
                } else if (__value__ == (2578213i32)) {
                    {
                        ...
                        _t_2578213 = __tmp__._0?.__copy__();
                        _ok_2578216 = __tmp__._1;
                        _err_2578220 = __tmp__._2;
                    };
                    ...
                    return { _0 : false, _1 : _err_2578220 };
                    _gotoNext = 2578526i32;
                ...
                } else if (__value__ == (2578650i32)) {
                    {
                        ...
                        _t_2578656 = __tmp__._0?.__copy__();
                        _ok_2578659 = __tmp__._1;
                        _err_2578663 = __tmp__._2;
                    };
                    if (_ok_2578659) {
                    ...
                    return { _0 : false, _1 : _err_2578663 };
                    _gotoNext = 2578646i32;
                    ...
                    {
                        {
                            var __tmp__ = stdgo._internal.path.Path__matchChunk._matchChunk(_chunk_2577969?.__copy__(), stdgo.Go.str()?.__copy__());
                            _err_2579132 = __tmp__._2;
                        };
                    ...
                    return { _0 : false, _1 : _err_2579132 };
                    _gotoNext = 2579208i32;
