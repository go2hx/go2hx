        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2724902i32;
                } else if (__value__ == (2724902i32)) {
                    0i32;
                    patternBreak = false;
                    _gotoNext = 2724912i32;
                } else if (__value__ == (2724912i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2724933i32;
                    } else {
                        _gotoNext = 2726218i32;
                    };
                } else if (__value__ == (2724933i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2725039i32;
                    } else {
                        _gotoNext = 2725201i32;
                    };
                } else if (__value__ == (2725039i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2725439i32;
                    } else {
                        _gotoNext = 2725471i32;
                    };
                } else if (__value__ == (2725439i32)) {
                    _name = _t_2?.__copy__();
                    0i32;
                    _gotoNext = 2724912i32;
                } else if (__value__ == (2725471i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2725485i32;
                    } else {
                        _gotoNext = 2725514i32;
                    };
                } else if (__value__ == (2725485i32)) {
                    return {
                    ...
                    _gotoNext = 2725514i32;
                } else if (__value__ == (2725514i32)) {
                    if (_star_0) {
                        _gotoNext = 2725522i32;
                    } else {
                        _gotoNext = 2726043i32;
                    };
                } else if (__value__ == (2725522i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2725589i32;
                } else if (__value__ == (2725589i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2725638i32;
                    } else {
                        _gotoNext = 2726043i32;
                    };
                } else if (__value__ == (2725634i32)) {
                    _i_5++;
                    _gotoNext = 2725589i32;
                } else if (__value__ == (2725638i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 2725698i32;
                    } else {
                        _gotoNext = 2725875i32;
                    };
                } else if (__value__ == (2725698i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2725805i32;
                    } else {
                        _gotoNext = 2725834i32;
                    };
                } else if (__value__ == (2725805i32)) {
                    _i_5++;
                    _gotoNext = 2725589i32;
                } else if (__value__ == (2725834i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2724912i32;
                } else if (__value__ == (2725875i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2725889i32;
                    } else {
                        _gotoNext = 2725634i32;
                    };
                } else if (__value__ == (2725889i32)) {
                    return {
                    ...
                    _gotoNext = 2725634i32;
                } else if (__value__ == (2726043i32)) {
                    0i32;
                    _gotoNext = 2726043i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2726064i32;
                    } else {
                        _gotoNext = 2726196i32;
                    };
                } else if (__value__ == (2726064i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2726161i32;
                        } else {
                            _gotoNext = 2726043i32;
                        };
                    };
                } else if (__value__ == (2726161i32)) {
                    return {
