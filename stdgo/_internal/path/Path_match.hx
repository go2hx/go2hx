        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2729547i32;
                } else if (__value__ == (2729547i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 2729557i32;
                } else if (__value__ == (2729557i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2729578i32;
                    } else {
                        _gotoNext = 2730863i32;
                    };
                } else if (__value__ == (2729578i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2729684i32;
                    } else {
                        _gotoNext = 2729846i32;
                    };
                } else if (__value__ == (2729684i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2730084i32;
                    } else {
                        _gotoNext = 2730116i32;
                    };
                } else if (__value__ == (2730084i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 2729557i32;
                } else if (__value__ == (2730116i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2730130i32;
                    } else {
                        _gotoNext = 2730159i32;
                    };
                } else if (__value__ == (2730130i32)) {
                    return {
                    ...
                    _gotoNext = 2730159i32;
                } else if (__value__ == (2730159i32)) {
                    if (_star_0) {
                        _gotoNext = 2730167i32;
                    } else {
                        _gotoNext = 2730688i32;
                    };
                } else if (__value__ == (2730167i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2730234i32;
                } else if (__value__ == (2730234i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2730283i32;
                    } else {
                        _gotoNext = 2730688i32;
                    };
                } else if (__value__ == (2730279i32)) {
                    _i_5++;
                    _gotoNext = 2730234i32;
                } else if (__value__ == (2730283i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 2730343i32;
                    } else {
                        _gotoNext = 2730520i32;
                    };
                } else if (__value__ == (2730343i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2730450i32;
                    } else {
                        _gotoNext = 2730479i32;
                    };
                } else if (__value__ == (2730450i32)) {
                    _i_5++;
                    _gotoNext = 2730234i32;
                } else if (__value__ == (2730479i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2729557i32;
                } else if (__value__ == (2730520i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2730534i32;
                    } else {
                        _gotoNext = 2730279i32;
                    };
                } else if (__value__ == (2730534i32)) {
                    return {
                    ...
                    _gotoNext = 2730279i32;
                } else if (__value__ == (2730688i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 2730688i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2730709i32;
                    } else {
                        _gotoNext = 2730841i32;
                    };
                    ...
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2730806i32;
                        } else {
                            _gotoNext = 2730688i32;
                        };
                    };
                } else if (__value__ == (2730806i32)) {
                    return {
