        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2919037i32;
                } else if (__value__ == (2919037i32)) {
                    0i32;
                    patternBreak = false;
                    _gotoNext = 2919047i32;
                } else if (__value__ == (2919047i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2919068i32;
                    } else {
                        _gotoNext = 2920353i32;
                    };
                } else if (__value__ == (2919068i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2919174i32;
                    } else {
                        _gotoNext = 2919336i32;
                    };
                } else if (__value__ == (2919174i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        ...
                        _gotoNext = 2919606i32;
                    };
                } else if (__value__ == (2919574i32)) {
                    _name = _t_2?.__copy__();
                    0i32;
                    _gotoNext = 2919047i32;
                } else if (__value__ == (2919606i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2919620i32;
                    } else {
                        _gotoNext = 2919649i32;
                    };
                } else if (__value__ == (2919620i32)) {
                    return {
                    ...
                    if (_star_0) {
                        _gotoNext = 2919657i32;
                    } else {
                        _gotoNext = 2920178i32;
                    };
                } else if (__value__ == (2919657i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2919724i32;
                } else if (__value__ == (2919724i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2919773i32;
                    } else {
                        _gotoNext = 2920178i32;
                    };
                    ...
                    if (_ok_7) {
                        _gotoNext = 2919833i32;
                    } else {
                        _gotoNext = 2920010i32;
                    };
                } else if (__value__ == (2919833i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2919940i32;
                    } else {
                        _gotoNext = 2919969i32;
                    };
                } else if (__value__ == (2919940i32)) {
                    _i_5++;
                    _gotoNext = 2919724i32;
                } else if (__value__ == (2919969i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2919047i32;
                } else if (__value__ == (2920010i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2920024i32;
                    } else {
                        _gotoNext = 2919769i32;
                    };
                } else if (__value__ == (2920024i32)) {
                    return {
                    ...
                    _gotoNext = 2919769i32;
                } else if (__value__ == (2920178i32)) {
                    0i32;
                    _gotoNext = 2920178i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2920199i32;
                    } else {
                        _gotoNext = 2920331i32;
                    };
                } else if (__value__ == (2920199i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2920296i32;
                        } else {
                            _gotoNext = 2920178i32;
                        };
                    };
                } else if (__value__ == (2920296i32)) {
                    return {
