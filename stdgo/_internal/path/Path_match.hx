        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2920292i32;
                } else if (__value__ == (2920292i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 2920302i32;
                } else if (__value__ == (2920302i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2920323i32;
                    } else {
                        _gotoNext = 2921608i32;
                    };
                } else if (__value__ == (2920323i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2920429i32;
                    } else {
                        _gotoNext = 2920591i32;
                    };
                } else if (__value__ == (2920429i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2920829i32;
                    } else {
                        _gotoNext = 2920861i32;
                    };
                } else if (__value__ == (2920829i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 2920302i32;
                } else if (__value__ == (2920861i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2920875i32;
                    } else {
                        _gotoNext = 2920904i32;
                    };
                } else if (__value__ == (2920875i32)) {
                    return {
                    ...
                    _gotoNext = 2920904i32;
                } else if (__value__ == (2920904i32)) {
                    if (_star_0) {
                        _gotoNext = 2920912i32;
                    } else {
                        _gotoNext = 2921433i32;
                    };
                } else if (__value__ == (2920912i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2920979i32;
                } else if (__value__ == (2920979i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2921028i32;
                    } else {
                        _gotoNext = 2921433i32;
                    };
                } else if (__value__ == (2921024i32)) {
                    _i_5++;
                    _gotoNext = 2920979i32;
                } else if (__value__ == (2921028i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 2921088i32;
                    } else {
                        _gotoNext = 2921265i32;
                    };
                } else if (__value__ == (2921088i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2921195i32;
                    } else {
                        _gotoNext = 2921224i32;
                    };
                } else if (__value__ == (2921195i32)) {
                    _i_5++;
                    _gotoNext = 2920979i32;
                } else if (__value__ == (2921224i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2920302i32;
                } else if (__value__ == (2921265i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2921279i32;
                    } else {
                        _gotoNext = 2921024i32;
                    };
                } else if (__value__ == (2921279i32)) {
                    return {
                    ...
                    _gotoNext = 2921024i32;
                } else if (__value__ == (2921433i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 2921433i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2921454i32;
                    } else {
                        _gotoNext = 2921586i32;
                    };
                } else if (__value__ == (2921454i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2921551i32;
                        } else {
                            _gotoNext = 2921433i32;
                        };
                    };
                } else if (__value__ == (2921551i32)) {
                    return {
