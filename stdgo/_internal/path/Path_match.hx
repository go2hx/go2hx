        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2590131i32;
                } else if (__value__ == (2590131i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 2590141i32;
                } else if (__value__ == (2590141i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2590162i32;
                    } else {
                        _gotoNext = 2591447i32;
                    };
                } else if (__value__ == (2590162i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2590268i32;
                    } else {
                        _gotoNext = 2590430i32;
                    };
                } else if (__value__ == (2590268i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2590668i32;
                    } else {
                        _gotoNext = 2590700i32;
                    };
                } else if (__value__ == (2590668i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 2590141i32;
                } else if (__value__ == (2590700i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2590714i32;
                    } else {
                        _gotoNext = 2590743i32;
                    };
                } else if (__value__ == (2590714i32)) {
                    return {
                    ...
                    _gotoNext = 2590743i32;
                } else if (__value__ == (2590743i32)) {
                    if (_star_0) {
                        _gotoNext = 2590751i32;
                    } else {
                        _gotoNext = 2591272i32;
                    };
                } else if (__value__ == (2590751i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2590818i32;
                } else if (__value__ == (2590818i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2590867i32;
                    } else {
                        _gotoNext = 2591272i32;
                    };
                } else if (__value__ == (2590863i32)) {
                    _i_5++;
                    _gotoNext = 2590818i32;
                } else if (__value__ == (2590867i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 2590927i32;
                    } else {
                        _gotoNext = 2591104i32;
                    };
                } else if (__value__ == (2590927i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2591034i32;
                    } else {
                        _gotoNext = 2591063i32;
                    };
                } else if (__value__ == (2591034i32)) {
                    _i_5++;
                    _gotoNext = 2590818i32;
                } else if (__value__ == (2591063i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2590141i32;
                } else if (__value__ == (2591104i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2591118i32;
                    } else {
                        _gotoNext = 2590863i32;
                    };
                } else if (__value__ == (2591118i32)) {
                    return {
                    ...
                    _gotoNext = 2590863i32;
                } else if (__value__ == (2591272i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 2591272i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2591293i32;
                    } else {
                        _gotoNext = 2591425i32;
                    };
                } else if (__value__ == (2591293i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2591390i32;
                        } else {
                            _gotoNext = 2591272i32;
                        };
                    };
                } else if (__value__ == (2591390i32)) {
                    return {
