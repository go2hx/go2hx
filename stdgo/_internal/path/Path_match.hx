        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                ...
                } else if (__value__ == (2578078i32)) {
                    {
                        ...
                        _star_2578086 = __tmp__._0;
                        _chunk_2578102 = __tmp__._1?.__copy__();
                        _pattern = __tmp__._2?.__copy__();
                    };
                    if ((_star_2578086 && (_chunk_2578102 == stdgo.Go.str()) : Bool)) {
                ...
                } else if (__value__ == (2578346i32)) {
                    {
                        ...
                        _t_2578346 = __tmp__._0?.__copy__();
                        _ok_2578349 = __tmp__._1;
                        _err_2578353 = __tmp__._2;
                    };
                    ...
                    return { _0 : false, _1 : _err_2578353 };
                    _gotoNext = 2578659i32;
                ...
                } else if (__value__ == (2578783i32)) {
                    {
                        ...
                        _t_2578789 = __tmp__._0?.__copy__();
                        _ok_2578792 = __tmp__._1;
                        _err_2578796 = __tmp__._2;
                    };
                    if (_ok_2578792) {
                    ...
                    return { _0 : false, _1 : _err_2578796 };
                    _gotoNext = 2578779i32;
                    ...
                    {
                        {
                            var __tmp__ = stdgo._internal.path.Path__matchChunk._matchChunk(_chunk_2578102?.__copy__(), stdgo.Go.str()?.__copy__());
                    ...
                    return { _0 : false, _1 : _err_2579265 };
                    _gotoNext = 2579341i32;
