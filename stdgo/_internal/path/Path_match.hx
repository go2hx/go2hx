        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2627100i32;
                } else if (__value__ == (2627100i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 2627110i32;
                } else if (__value__ == (2627110i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2627131i32;
                    } else {
                        _gotoNext = 2628416i32;
                    };
                } else if (__value__ == (2627131i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2627237i32;
                    } else {
                        _gotoNext = 2627399i32;
                    };
                } else if (__value__ == (2627237i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2627637i32;
                    } else {
                        _gotoNext = 2627669i32;
                    };
                } else if (__value__ == (2627637i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 2627110i32;
                } else if (__value__ == (2627669i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2627683i32;
                    } else {
                        _gotoNext = 2627712i32;
                    };
                } else if (__value__ == (2627683i32)) {
                    return {
                    ...
                    _gotoNext = 2627712i32;
                } else if (__value__ == (2627712i32)) {
                    if (_star_0) {
                        _gotoNext = 2627720i32;
                    } else {
                        _gotoNext = 2628241i32;
                    };
                } else if (__value__ == (2627720i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2627787i32;
                } else if (__value__ == (2627787i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2627836i32;
                    } else {
                        _gotoNext = 2628241i32;
                    };
                } else if (__value__ == (2627832i32)) {
                    _i_5++;
                    _gotoNext = 2627787i32;
                } else if (__value__ == (2627836i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 2627896i32;
                    } else {
                        _gotoNext = 2628073i32;
                    };
                } else if (__value__ == (2627896i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2628003i32;
                    } else {
                        _gotoNext = 2628032i32;
                    };
                } else if (__value__ == (2628003i32)) {
                    _i_5++;
                    _gotoNext = 2627787i32;
                } else if (__value__ == (2628032i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2627110i32;
                } else if (__value__ == (2628073i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2628087i32;
                    } else {
                        _gotoNext = 2627832i32;
                    };
                } else if (__value__ == (2628087i32)) {
                    return {
                    ...
                    _gotoNext = 2627832i32;
                } else if (__value__ == (2628241i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 2628241i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2628262i32;
                    } else {
                        _gotoNext = 2628394i32;
                    };
                } else if (__value__ == (2628262i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2628359i32;
                        } else {
                            _gotoNext = 2628241i32;
                        };
                    };
                } else if (__value__ == (2628359i32)) {
                    return {
