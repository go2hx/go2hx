        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                ...
                } else if (__value__ == (2566309i32)) {
                    {
                        ...
                        _star_2566317 = __tmp__._0;
                        _chunk_2566333 = __tmp__._1?.__copy__();
                        _pattern = __tmp__._2?.__copy__();
                    };
                    if ((_star_2566317 && (_chunk_2566333 == stdgo.Go.str()) : Bool)) {
                ...
                } else if (__value__ == (2566577i32)) {
                    {
                        ...
                        _t_2566577 = __tmp__._0?.__copy__();
                        _ok_2566580 = __tmp__._1;
                        _err_2566584 = __tmp__._2;
                    };
                ...
                } else if (__value__ == (2567014i32)) {
                    {
                        ...
                        _t_2567020 = __tmp__._0?.__copy__();
                        _ok_2567023 = __tmp__._1;
                        _err_2567027 = __tmp__._2;
                    };
                    if (_ok_2567023) {
                    ...
                    {
                        {
                            var __tmp__ = stdgo._internal.path.Path__matchChunk._matchChunk(_chunk_2566333?.__copy__(), stdgo.Go.str()?.__copy__());
                            _err_2567496 = __tmp__._2;
                        };
