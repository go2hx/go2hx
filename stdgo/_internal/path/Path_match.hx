        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 2743577i32;
                } else if (__value__ == (2743577i32)) {
                    0i32;
                    patternBreak = false;
                    _gotoNext = 2743587i32;
                } else if (__value__ == (2743587i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 2743608i32;
                    } else {
                        _gotoNext = 2744893i32;
                    };
                } else if (__value__ == (2743608i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 2743714i32;
                    } else {
                        _gotoNext = 2743876i32;
                    };
                } else if (__value__ == (2743714i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 2744114i32;
                    } else {
                        _gotoNext = 2744146i32;
                    };
                } else if (__value__ == (2744114i32)) {
                    _name = _t_2?.__copy__();
                    0i32;
                    _gotoNext = 2743587i32;
                } else if (__value__ == (2744146i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 2744160i32;
                    } else {
                        _gotoNext = 2744189i32;
                    };
                } else if (__value__ == (2744160i32)) {
                    return {
                    ...
                    _gotoNext = 2744189i32;
                } else if (__value__ == (2744189i32)) {
                    if (_star_0) {
                        _gotoNext = 2744197i32;
                    } else {
                        _gotoNext = 2744718i32;
                    };
                } else if (__value__ == (2744197i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 2744264i32;
                } else if (__value__ == (2744264i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 2744313i32;
                    } else {
                        _gotoNext = 2744718i32;
                    };
                } else if (__value__ == (2744309i32)) {
                    _i_5++;
                    _gotoNext = 2744264i32;
                } else if (__value__ == (2744313i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 2744373i32;
                    } else {
                        _gotoNext = 2744550i32;
                    };
                } else if (__value__ == (2744373i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 2744480i32;
                    } else {
                        _gotoNext = 2744509i32;
                    };
                } else if (__value__ == (2744480i32)) {
                    _i_5++;
                    _gotoNext = 2744264i32;
                } else if (__value__ == (2744509i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 2743587i32;
                } else if (__value__ == (2744550i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 2744564i32;
                    } else {
                        _gotoNext = 2744309i32;
                    };
                } else if (__value__ == (2744564i32)) {
                    return {
                    ...
                    _gotoNext = 2744309i32;
                } else if (__value__ == (2744718i32)) {
                    0i32;
                    _gotoNext = 2744718i32;
                    if (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2744739i32;
                    } else {
                        _gotoNext = 2744871i32;
                    };
                } else if (__value__ == (2744739i32)) {
                    {
                        var __tmp__ = stdgo._internal.path.Path__scanchunk._scanChunk(_pattern?.__copy__());
                        _chunk_1 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    {
                        ...
                        if (_err_9 != null) {
                            _gotoNext = 2744836i32;
                        } else {
                            _gotoNext = 2744718i32;
                        };
                    };
                } else if (__value__ == (2744836i32)) {
                    return {
