...
function _cleanGlobPathWindows(_path:stdgo.GoString):{ var _0 : stdgo.GoInt; var _1 : stdgo.GoString; } {
        ...
        if (_path == (stdgo.Go.str())) {
            return { _0 : _prefixLen = (0 : stdgo.GoInt), _1 : _cleaned = ("." : stdgo.GoString) };
            ...
            return { _0 : _prefixLen = (_vollen + (1 : stdgo.GoInt) : stdgo.GoInt), _1 : _cleaned = _path?.__copy__() };
        } else if (((_vollen == (_path.length)) && (_path.length == (2 : stdgo.GoInt)) : Bool)) {
            return { _0 : _prefixLen = _vollen, _1 : _cleaned = (_path + ("." : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__() };
        } else {
            if ((_vollen >= (_path.length) : Bool)) {
                _vollen = ((_path.length) - (1 : stdgo.GoInt) : stdgo.GoInt);
            };
            return { _0 : _prefixLen = _vollen, _1 : _cleaned = (_path.__slice__((0 : stdgo.GoInt), ((_path.length) - (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.GoString)?.__copy__() };
        };
    }
