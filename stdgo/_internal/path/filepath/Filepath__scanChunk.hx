        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    return { _0 : _star, _1 : _chunk = (_pattern.__slice__((0 : stdgo.GoInt), _i_3943971) : stdgo.GoString)?.__copy__(), _2 : _rest = (_pattern.__slice__(_i_3943971) : stdgo.GoString)?.__copy__() };
                    _gotoNext = -1i32;
                };
            };
        };
