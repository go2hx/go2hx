        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 3953519i32;
                } else if (__value__ == (3953519i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 3953529i32;
                } else if (__value__ == (3953529i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 3953550i32;
                    } else {
                        _gotoNext = 3954580i32;
                    };
                } else if (__value__ == (3953550i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 3953656i32;
                    } else {
                        _gotoNext = 3953822i32;
                    };
                } else if (__value__ == (3953656i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 3954060i32;
                    } else {
                        _gotoNext = 3954092i32;
                    };
                } else if (__value__ == (3954060i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 3953529i32;
                } else if (__value__ == (3954092i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 3954106i32;
                    } else {
                        _gotoNext = 3954135i32;
                    };
                } else if (__value__ == (3954106i32)) {
                    return {
                    ...
                    _gotoNext = 3954135i32;
                } else if (__value__ == (3954135i32)) {
                    if (_star_0) {
                        _gotoNext = 3954143i32;
                    } else {
                        _gotoNext = 3954558i32;
                    };
                } else if (__value__ == (3954143i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 3954210i32;
                } else if (__value__ == (3954210i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 3954265i32;
                    } else {
                        _gotoNext = 3954558i32;
                    };
                } else if (__value__ == (3954261i32)) {
                    _i_5++;
                    _gotoNext = 3954210i32;
                } else if (__value__ == (3954265i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 3954325i32;
                    } else {
                        _gotoNext = 3954502i32;
                    };
                } else if (__value__ == (3954325i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 3954432i32;
                    } else {
                        _gotoNext = 3954461i32;
                    };
                } else if (__value__ == (3954432i32)) {
                    _i_5++;
                    _gotoNext = 3954210i32;
                } else if (__value__ == (3954461i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 3953529i32;
                } else if (__value__ == (3954502i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 3954516i32;
                    } else {
                        _gotoNext = 3954261i32;
                    };
                } else if (__value__ == (3954516i32)) {
                    return {
