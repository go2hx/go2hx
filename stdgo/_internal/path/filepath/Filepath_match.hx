        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                ...
                } else if (__value__ == (4018345i32)) {
                    {
                        ...
                        _star_4018353 = __tmp__._0;
                        _chunk_4018369 = __tmp__._1?.__copy__();
                        _pattern = __tmp__._2?.__copy__();
                    };
                    if ((_star_4018353 && (_chunk_4018369 == stdgo.Go.str()) : Bool)) {
                ...
                } else if (__value__ == (4018617i32)) {
                    {
                        ...
                        _t_4018617 = __tmp__._0?.__copy__();
                        _ok_4018620 = __tmp__._1;
                        _err_4018624 = __tmp__._2;
                    };
                    ...
                    return { _0 : false, _1 : _err_4018624 };
                    _gotoNext = 4018930i32;
                ...
                } else if (__value__ == (4019060i32)) {
                    {
                        ...
                        _t_4019066 = __tmp__._0?.__copy__();
                        _ok_4019069 = __tmp__._1;
                        _err_4019073 = __tmp__._2;
                    };
                    if (_ok_4019069) {
                    ...
                    return { _0 : false, _1 : _err_4019073 };
                    _gotoNext = 4019056i32;
