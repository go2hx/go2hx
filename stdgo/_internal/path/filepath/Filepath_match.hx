        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                ...
                } else if (__value__ == (3942631i32)) {
                    {
                        ...
                        _star_3942639 = @:tmpset0 __tmp__._0;
                        _chunk_3942655 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    if ((_star_3942639 && (_chunk_3942655 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                ...
                } else if (__value__ == (3942903i32)) {
                    {
                        ...
                        _t_3942903 = @:tmpset0 __tmp__._0?.__copy__();
                        _ok_3942906 = @:tmpset0 __tmp__._1;
                        _err_3942910 = @:tmpset0 __tmp__._2;
                    };
                ...
                } else if (__value__ == (3943346i32)) {
                    {
                        ...
                        _t_3943352 = @:tmpset0 __tmp__._0?.__copy__();
                        _ok_3943355 = @:tmpset0 __tmp__._1;
                        _err_3943359 = @:tmpset0 __tmp__._2;
                    };
                    if (_ok_3943355) {
