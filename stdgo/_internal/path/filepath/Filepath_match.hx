        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 4043656i32;
                } else if (__value__ == (4043656i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 4043666i32;
                } else if (__value__ == (4043666i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 4043687i32;
                    } else {
                        _gotoNext = 4044717i32;
                    };
                } else if (__value__ == (4043687i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 4043793i32;
                    } else {
                        _gotoNext = 4043959i32;
                    };
                } else if (__value__ == (4043793i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 4044197i32;
                    } else {
                        _gotoNext = 4044229i32;
                    };
                } else if (__value__ == (4044197i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 4043666i32;
                } else if (__value__ == (4044229i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 4044243i32;
                    } else {
                        _gotoNext = 4044272i32;
                    };
                    ...
                    _gotoNext = 4044272i32;
                } else if (__value__ == (4044272i32)) {
                    if (_star_0) {
                        _gotoNext = 4044280i32;
                    } else {
                        _gotoNext = 4044695i32;
                    };
                } else if (__value__ == (4044280i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 4044347i32;
                } else if (__value__ == (4044347i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4044402i32;
                    } else {
                        _gotoNext = 4044695i32;
                    };
                } else if (__value__ == (4044398i32)) {
                    _i_5++;
                    _gotoNext = 4044347i32;
                } else if (__value__ == (4044402i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 4044462i32;
                    } else {
                        _gotoNext = 4044639i32;
                    };
                } else if (__value__ == (4044462i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 4044569i32;
                    } else {
                        _gotoNext = 4044598i32;
                    };
                } else if (__value__ == (4044569i32)) {
                    _i_5++;
                    _gotoNext = 4044347i32;
                } else if (__value__ == (4044598i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 4043666i32;
                } else if (__value__ == (4044639i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 4044653i32;
                    } else {
                        _gotoNext = 4044398i32;
                    };
                } else if (__value__ == (4044653i32)) {
                    return {
