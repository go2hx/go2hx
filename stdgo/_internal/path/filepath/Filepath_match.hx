        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                ...
                } else if (__value__ == (4019841i32)) {
                    {
                        ...
                        _star_4019849 = @:tmpset0 __tmp__._0;
                        _chunk_4019865 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    if ((_star_4019849 && (_chunk_4019865 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                ...
                } else if (__value__ == (4020113i32)) {
                    {
                        ...
                        _t_4020113 = @:tmpset0 __tmp__._0?.__copy__();
                        _ok_4020116 = @:tmpset0 __tmp__._1;
                        _err_4020120 = @:tmpset0 __tmp__._2;
                    };
                    ...
                    return {
                        final __tmp__:{ var _0 : Bool; var _1 : stdgo.Error; } = { _0 : false, _1 : _err_4020120 };
                        _matched = __tmp__._0;
                        _err = __tmp__._1;
                        __tmp__;
                    };
                ...
                } else if (__value__ == (4020556i32)) {
                    {
                        ...
                        _t_4020562 = @:tmpset0 __tmp__._0?.__copy__();
                        _ok_4020565 = @:tmpset0 __tmp__._1;
                        _err_4020569 = @:tmpset0 __tmp__._2;
                    };
                    if (_ok_4020565) {
                    ...
                    return {
                        final __tmp__:{ var _0 : Bool; var _1 : stdgo.Error; } = { _0 : false, _1 : _err_4020569 };
                        _matched = __tmp__._0;
                        _err = __tmp__._1;
                        __tmp__;
                    };
