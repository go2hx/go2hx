        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 4082563i32;
                } else if (__value__ == (4082563i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 4082584i32;
                    } else {
                        _gotoNext = 4083614i32;
                    };
                } else if (__value__ == (4082584i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 4082690i32;
                    } else {
                        _gotoNext = 4082856i32;
                    };
                } else if (__value__ == (4082690i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 4083094i32;
                    } else {
                        _gotoNext = 4083126i32;
                    };
                } else if (__value__ == (4083094i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 4082563i32;
                } else if (__value__ == (4083126i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 4083140i32;
                    } else {
                        _gotoNext = 4083169i32;
                    };
                } else if (__value__ == (4083140i32)) {
                    return {
                    ...
                    _gotoNext = 4083169i32;
                } else if (__value__ == (4083169i32)) {
                    if (_star_0) {
                        _gotoNext = 4083177i32;
                    } else {
                        _gotoNext = 4083592i32;
                    };
                } else if (__value__ == (4083177i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 4083244i32;
                } else if (__value__ == (4083244i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4083299i32;
                    } else {
                        _gotoNext = 4083592i32;
                    };
                } else if (__value__ == (4083295i32)) {
                    _i_5++;
                    _gotoNext = 4083244i32;
                } else if (__value__ == (4083299i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 4083359i32;
                    } else {
                        _gotoNext = 4083536i32;
                    };
                } else if (__value__ == (4083359i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 4083466i32;
                    } else {
                        _gotoNext = 4083495i32;
                    };
                } else if (__value__ == (4083466i32)) {
                    _i_5++;
                    _gotoNext = 4083244i32;
                } else if (__value__ == (4083495i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 4082563i32;
                } else if (__value__ == (4083536i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 4083550i32;
                    } else {
                        _gotoNext = 4083295i32;
                    };
                } else if (__value__ == (4083550i32)) {
                    return {
