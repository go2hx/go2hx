        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 3943634i32;
                } else if (__value__ == (3943634i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 3943644i32;
                } else if (__value__ == (3943644i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 3943665i32;
                    } else {
                        _gotoNext = 3944695i32;
                    };
                } else if (__value__ == (3943665i32)) {
                    {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        ...
                        _gotoNext = 3944207i32;
                    };
                } else if (__value__ == (3944175i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 3943644i32;
                } else if (__value__ == (3944207i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 3944221i32;
                    } else {
                        _gotoNext = 3944250i32;
                    };
                } else if (__value__ == (3944221i32)) {
                    return {
                    ...
                    _gotoNext = 3944250i32;
                } else if (__value__ == (3944250i32)) {
                    if (_star_0) {
                        _gotoNext = 3944258i32;
                    } else {
                        _gotoNext = 3944673i32;
                    };
                } else if (__value__ == (3944258i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 3944325i32;
                } else if (__value__ == (3944325i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 3944380i32;
                    } else {
                        _gotoNext = 3944673i32;
                    };
                } else if (__value__ == (3944376i32)) {
                    _i_5++;
                    _gotoNext = 3944325i32;
                } else if (__value__ == (3944380i32)) {
                    {
                    ...
                    if (_ok_7) {
                        ...
                        _gotoNext = 3944617i32;
                    };
                } else if (__value__ == (3944440i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 3944547i32;
                    } else {
                        _gotoNext = 3944576i32;
                    };
                } else if (__value__ == (3944547i32)) {
                    _i_5++;
                    _gotoNext = 3944325i32;
                } else if (__value__ == (3944576i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 3943644i32;
                } else if (__value__ == (3944617i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 3944631i32;
                    } else {
                        _gotoNext = 3944376i32;
                    };
                } else if (__value__ == (3944631i32)) {
                    return {
