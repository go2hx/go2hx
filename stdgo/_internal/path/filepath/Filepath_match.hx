        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 3992773i32;
                } else if (__value__ == (3992773i32)) {
                    0i32;
                    patternBreak = false;
                    _gotoNext = 3992783i32;
                } else if (__value__ == (3992783i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 3992804i32;
                    } else {
                        _gotoNext = 3993834i32;
                    };
                } else if (__value__ == (3992804i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 3992910i32;
                    } else {
                        _gotoNext = 3993076i32;
                    };
                } else if (__value__ == (3992910i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 3993314i32;
                    } else {
                        _gotoNext = 3993346i32;
                    };
                } else if (__value__ == (3993314i32)) {
                    _name = _t_2?.__copy__();
                    0i32;
                    _gotoNext = 3992783i32;
                } else if (__value__ == (3993346i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 3993360i32;
                    } else {
                        _gotoNext = 3993389i32;
                    };
                } else if (__value__ == (3993360i32)) {
                    return {
                    ...
                    _gotoNext = 3993389i32;
                } else if (__value__ == (3993389i32)) {
                    if (_star_0) {
                        _gotoNext = 3993397i32;
                    } else {
                        _gotoNext = 3993812i32;
                    };
                } else if (__value__ == (3993397i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 3993464i32;
                } else if (__value__ == (3993464i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 3993519i32;
                    } else {
                        _gotoNext = 3993812i32;
                    };
                } else if (__value__ == (3993515i32)) {
                    _i_5++;
                    _gotoNext = 3993464i32;
                } else if (__value__ == (3993519i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 3993579i32;
                    } else {
                        _gotoNext = 3993756i32;
                    };
                } else if (__value__ == (3993579i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 3993686i32;
                    } else {
                        _gotoNext = 3993715i32;
                    };
                } else if (__value__ == (3993686i32)) {
                    _i_5++;
                    _gotoNext = 3993464i32;
                } else if (__value__ == (3993715i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 3992783i32;
                } else if (__value__ == (3993756i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 3993770i32;
                    } else {
                        _gotoNext = 3993515i32;
                    };
                } else if (__value__ == (3993770i32)) {
                    return {
