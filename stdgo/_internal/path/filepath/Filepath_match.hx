        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                ...
                } else if (__value__ == (3973663i32)) {
                    {
                        ...
                        _star_3973671 = __tmp__._0;
                        _chunk_3973687 = __tmp__._1?.__copy__();
                        _pattern = __tmp__._2?.__copy__();
                    };
                    if ((_star_3973671 && (_chunk_3973687 == stdgo.Go.str()) : Bool)) {
                ...
                } else if (__value__ == (3973935i32)) {
                    {
                        ...
                        _t_3973935 = __tmp__._0?.__copy__();
                        _ok_3973938 = __tmp__._1;
                        _err_3973942 = __tmp__._2;
                    };
                    ...
                    return { _0 : false, _1 : _err_3973942 };
                    _gotoNext = 3974248i32;
                ...
                } else if (__value__ == (3974378i32)) {
                    {
                        ...
                        _t_3974384 = __tmp__._0?.__copy__();
                        _ok_3974387 = __tmp__._1;
                        _err_3974391 = __tmp__._2;
                    };
                    if (_ok_3974387) {
                    ...
                    return { _0 : false, _1 : _err_3974391 };
                    _gotoNext = 3974374i32;
