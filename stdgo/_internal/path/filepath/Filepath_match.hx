        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 3942113i32;
                } else if (__value__ == (3942113i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 3942123i32;
                } else if (__value__ == (3942123i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 3942144i32;
                    } else {
                        _gotoNext = 3943174i32;
                    };
                } else if (__value__ == (3942144i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 3942250i32;
                    } else {
                        _gotoNext = 3942416i32;
                    };
                } else if (__value__ == (3942250i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 3942654i32;
                    } else {
                        _gotoNext = 3942686i32;
                    };
                } else if (__value__ == (3942654i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 3942123i32;
                } else if (__value__ == (3942686i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 3942700i32;
                    } else {
                        _gotoNext = 3942729i32;
                    };
                } else if (__value__ == (3942700i32)) {
                    return {
                    ...
                    _gotoNext = 3942729i32;
                } else if (__value__ == (3942729i32)) {
                    if (_star_0) {
                        _gotoNext = 3942737i32;
                    } else {
                        _gotoNext = 3943152i32;
                    };
                } else if (__value__ == (3942737i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 3942804i32;
                } else if (__value__ == (3942804i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 3942859i32;
                    } else {
                        _gotoNext = 3943152i32;
                    };
                } else if (__value__ == (3942855i32)) {
                    _i_5++;
                    _gotoNext = 3942804i32;
                } else if (__value__ == (3942859i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 3942919i32;
                    } else {
                        _gotoNext = 3943096i32;
                    };
                } else if (__value__ == (3942919i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 3943026i32;
                    } else {
                        _gotoNext = 3943055i32;
                    };
                } else if (__value__ == (3943026i32)) {
                    _i_5++;
                    _gotoNext = 3942804i32;
                } else if (__value__ == (3943055i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 3942123i32;
                } else if (__value__ == (3943096i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 3943110i32;
                    } else {
                        _gotoNext = 3942855i32;
                    };
                } else if (__value__ == (3943110i32)) {
                    return {
