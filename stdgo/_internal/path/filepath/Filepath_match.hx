        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 3888140i32;
                } else if (__value__ == (3888140i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 3888150i32;
                } else if (__value__ == (3888150i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 3888171i32;
                    } else {
                        _gotoNext = 3889201i32;
                    };
                } else if (__value__ == (3888171i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 3888277i32;
                    } else {
                        _gotoNext = 3888443i32;
                    };
                } else if (__value__ == (3888277i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 3888681i32;
                    } else {
                        _gotoNext = 3888713i32;
                    };
                } else if (__value__ == (3888681i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 3888150i32;
                } else if (__value__ == (3888713i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 3888727i32;
                    } else {
                        _gotoNext = 3888756i32;
                    };
                } else if (__value__ == (3888727i32)) {
                    return {
                    ...
                    _gotoNext = 3888756i32;
                } else if (__value__ == (3888756i32)) {
                    if (_star_0) {
                        _gotoNext = 3888764i32;
                    } else {
                        _gotoNext = 3889179i32;
                    };
                } else if (__value__ == (3888764i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 3888831i32;
                } else if (__value__ == (3888831i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 3888886i32;
                    } else {
                        _gotoNext = 3889179i32;
                    };
                } else if (__value__ == (3888882i32)) {
                    _i_5++;
                    _gotoNext = 3888831i32;
                } else if (__value__ == (3888886i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 3888946i32;
                    } else {
                        _gotoNext = 3889123i32;
                    };
                } else if (__value__ == (3888946i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 3889053i32;
                    } else {
                        _gotoNext = 3889082i32;
                    };
                } else if (__value__ == (3889053i32)) {
                    _i_5++;
                    _gotoNext = 3888831i32;
                } else if (__value__ == (3889082i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 3888150i32;
                } else if (__value__ == (3889123i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 3889137i32;
                    } else {
                        _gotoNext = 3888882i32;
                    };
