        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 3974467i32;
                } else if (__value__ == (3974467i32)) {
                    0i32;
                    patternBreak = false;
                    _gotoNext = 3974477i32;
                } else if (__value__ == (3974477i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 3974498i32;
                    } else {
                        _gotoNext = 3975528i32;
                    };
                } else if (__value__ == (3974498i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 3974604i32;
                    } else {
                        _gotoNext = 3974770i32;
                    };
                } else if (__value__ == (3974604i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 3975008i32;
                    } else {
                        _gotoNext = 3975040i32;
                    };
                } else if (__value__ == (3975008i32)) {
                    _name = _t_2?.__copy__();
                    0i32;
                    _gotoNext = 3974477i32;
                } else if (__value__ == (3975040i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 3975054i32;
                    } else {
                        _gotoNext = 3975083i32;
                    };
                } else if (__value__ == (3975054i32)) {
                    return {
                    ...
                    _gotoNext = 3975083i32;
                } else if (__value__ == (3975083i32)) {
                    if (_star_0) {
                        _gotoNext = 3975091i32;
                    } else {
                        _gotoNext = 3975506i32;
                    };
                } else if (__value__ == (3975091i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 3975158i32;
                } else if (__value__ == (3975158i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 3975213i32;
                    } else {
                        _gotoNext = 3975506i32;
                    };
                } else if (__value__ == (3975209i32)) {
                    _i_5++;
                    _gotoNext = 3975158i32;
                } else if (__value__ == (3975213i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 3975273i32;
                    } else {
                        _gotoNext = 3975450i32;
                    };
                } else if (__value__ == (3975273i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 3975380i32;
                    } else {
                        _gotoNext = 3975409i32;
                    };
                } else if (__value__ == (3975380i32)) {
                    _i_5++;
                    _gotoNext = 3975158i32;
                } else if (__value__ == (3975409i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 3974477i32;
                } else if (__value__ == (3975450i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 3975464i32;
                    } else {
                        _gotoNext = 3975209i32;
                    };
                } else if (__value__ == (3975464i32)) {
                    return {
