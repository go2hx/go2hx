        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 4035633i32;
                } else if (__value__ == (4035633i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 4035643i32;
                } else if (__value__ == (4035643i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 4035664i32;
                    } else {
                        _gotoNext = 4036694i32;
                    };
                } else if (__value__ == (4035664i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 4035770i32;
                    } else {
                        _gotoNext = 4035936i32;
                    };
                } else if (__value__ == (4035770i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 4036174i32;
                    } else {
                        _gotoNext = 4036206i32;
                    };
                } else if (__value__ == (4036174i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 4035643i32;
                } else if (__value__ == (4036206i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 4036220i32;
                    } else {
                        _gotoNext = 4036249i32;
                    };
                } else if (__value__ == (4036220i32)) {
                    return {
                    ...
                    _gotoNext = 4036249i32;
                } else if (__value__ == (4036249i32)) {
                    if (_star_0) {
                        _gotoNext = 4036257i32;
                    } else {
                        _gotoNext = 4036672i32;
                    };
                } else if (__value__ == (4036257i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 4036324i32;
                } else if (__value__ == (4036324i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4036379i32;
                    } else {
                        _gotoNext = 4036672i32;
                    };
                } else if (__value__ == (4036375i32)) {
                    _i_5++;
                    _gotoNext = 4036324i32;
                } else if (__value__ == (4036379i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 4036439i32;
                    } else {
                        _gotoNext = 4036616i32;
                    };
                } else if (__value__ == (4036439i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 4036546i32;
                    } else {
                        _gotoNext = 4036575i32;
                    };
                } else if (__value__ == (4036546i32)) {
                    _i_5++;
                    _gotoNext = 4036324i32;
                } else if (__value__ == (4036575i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 4035643i32;
                } else if (__value__ == (4036616i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 4036630i32;
                    } else {
                        _gotoNext = 4036375i32;
                    };
                } else if (__value__ == (4036630i32)) {
                    return {
