...
function match(_pattern:stdgo.GoString, _name:stdgo.GoString):{ var _0 : Bool; var _1 : stdgo.Error; } {
        ...
        while (_gotoNext != ((-1i64 : stdgo.GoInt))) {
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    _gotoNext = 3942600i64;
                } else if (__value__ == (3942600i64)) {
                    0i64;
                    patternBreak = false;
                    _gotoNext = 3942610i64;
                } else if (__value__ == (3942610i64)) {
                    //"file://#L0"
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 3942631i64;
                    } else {
                        _gotoNext = 3943661i64;
                    };
                } else if (__value__ == (3942631i64)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 3942737i64;
                    } else {
                        _gotoNext = 3942903i64;
                    };
                } else if (__value__ == (3942737i64)) {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 3943141i64;
                    } else {
                        _gotoNext = 3943173i64;
                    };
                } else if (__value__ == (3943141i64)) {
                    _name = _t_2?.__copy__();
                    0i64;
                    _gotoNext = 3942610i64;
                } else if (__value__ == (3943173i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/filepath/match.go#L62"
                    if (_err_4 != null) {
                        _gotoNext = 3943187i64;
                    } else {
                        _gotoNext = 3943216i64;
                    };
                } else if (__value__ == (3943187i64)) {
                    ...
                    _gotoNext = 3943216i64;
                } else if (__value__ == (3943216i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/filepath/match.go#L65"
                    if (_star_0) {
                        _gotoNext = 3943224i64;
                    } else {
                        _gotoNext = 3943639i64;
                    };
                } else if (__value__ == (3943224i64)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 3943291i64;
                } else if (__value__ == (3943291i64)) {
                    //"file://#L0"
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 3943346i64;
                    } else {
                        _gotoNext = 3943639i64;
                    };
                } else if (__value__ == (3943342i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/filepath/match.go#L68"
                    _i_5++;
                    _gotoNext = 3943291i64;
                } else if (__value__ == (3943346i64)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 3943406i64;
                    } else {
                        _gotoNext = 3943583i64;
                    };
                } else if (__value__ == (3943406i64)) {
                    ...
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 3943513i64;
                    } else {
                        _gotoNext = 3943542i64;
                    };
                } else if (__value__ == (3943513i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/filepath/match.go#L68"
                    _i_5++;
                    _gotoNext = 3943291i64;
                } else if (__value__ == (3943542i64)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 3942610i64;
                } else if (__value__ == (3943583i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/filepath/match.go#L78"
                    if (_err_8 != null) {
                        _gotoNext = 3943597i64;
                    } else {
                        _gotoNext = 3943342i64;
                    };
                } else if (__value__ == (3943597i64)) {
