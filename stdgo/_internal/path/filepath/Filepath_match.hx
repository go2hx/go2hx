        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                ...
                } else if (__value__ == (4034630i32)) {
                    {
                        ...
                        _star_4034638 = __tmp__._0;
                        _chunk_4034654 = __tmp__._1?.__copy__();
                        _pattern = __tmp__._2?.__copy__();
                    };
                    if ((_star_4034638 && (_chunk_4034654 == stdgo.Go.str()) : Bool)) {
                ...
                } else if (__value__ == (4034902i32)) {
                    {
                        ...
                        _t_4034902 = __tmp__._0?.__copy__();
                        _ok_4034905 = __tmp__._1;
                        _err_4034909 = __tmp__._2;
                    };
                    ...
                    return { _0 : false, _1 : _err_4034909 };
                    _gotoNext = 4035215i32;
                ...
                } else if (__value__ == (4035345i32)) {
                    {
                        ...
                        _t_4035351 = __tmp__._0?.__copy__();
                        _ok_4035354 = __tmp__._1;
                        _err_4035358 = __tmp__._2;
                    };
                    if (_ok_4035354) {
                    ...
                    return { _0 : false, _1 : _err_4035358 };
                    _gotoNext = 4035341i32;
