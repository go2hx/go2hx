        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 4092572i32;
                } else if (__value__ == (4092572i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 4092582i32;
                } else if (__value__ == (4092582i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 4092603i32;
                    } else {
                        _gotoNext = 4093633i32;
                    };
                } else if (__value__ == (4092603i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 4092709i32;
                    } else {
                        _gotoNext = 4092875i32;
                    };
                } else if (__value__ == (4092709i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 4093113i32;
                    } else {
                        _gotoNext = 4093145i32;
                    };
                } else if (__value__ == (4093113i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 4092582i32;
                } else if (__value__ == (4093145i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 4093159i32;
                    } else {
                        _gotoNext = 4093188i32;
                    };
                } else if (__value__ == (4093159i32)) {
                    return {
                    ...
                    _gotoNext = 4093188i32;
                } else if (__value__ == (4093188i32)) {
                    if (_star_0) {
                        _gotoNext = 4093196i32;
                    } else {
                        _gotoNext = 4093611i32;
                    };
                } else if (__value__ == (4093196i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 4093263i32;
                } else if (__value__ == (4093263i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4093318i32;
                    } else {
                        _gotoNext = 4093611i32;
                    };
                } else if (__value__ == (4093314i32)) {
                    _i_5++;
                    _gotoNext = 4093263i32;
                } else if (__value__ == (4093318i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 4093378i32;
                    } else {
                        _gotoNext = 4093555i32;
                    };
                } else if (__value__ == (4093378i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 4093485i32;
                    } else {
                        _gotoNext = 4093514i32;
                    };
                } else if (__value__ == (4093485i32)) {
                    _i_5++;
                    _gotoNext = 4093263i32;
                } else if (__value__ == (4093514i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 4092582i32;
                } else if (__value__ == (4093555i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 4093569i32;
                    } else {
                        _gotoNext = 4093314i32;
                    };
                } else if (__value__ == (4093569i32)) {
                    return {
