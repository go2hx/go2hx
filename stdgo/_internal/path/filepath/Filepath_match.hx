        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 4069897i32;
                } else if (__value__ == (4069897i32)) {
                    0i32;
                    patternBreak = false;
                    _gotoNext = 4069907i32;
                } else if (__value__ == (4069907i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 4069928i32;
                    } else {
                        _gotoNext = 4070958i32;
                    };
                } else if (__value__ == (4069928i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 4070034i32;
                    } else {
                        _gotoNext = 4070200i32;
                    };
                } else if (__value__ == (4070034i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 4070438i32;
                    } else {
                        _gotoNext = 4070470i32;
                    };
                } else if (__value__ == (4070438i32)) {
                    _name = _t_2?.__copy__();
                    0i32;
                    _gotoNext = 4069907i32;
                } else if (__value__ == (4070470i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 4070484i32;
                    } else {
                        _gotoNext = 4070513i32;
                    };
                } else if (__value__ == (4070484i32)) {
                    return {
                    ...
                    _gotoNext = 4070513i32;
                } else if (__value__ == (4070513i32)) {
                    if (_star_0) {
                        _gotoNext = 4070521i32;
                    } else {
                        _gotoNext = 4070936i32;
                    };
                } else if (__value__ == (4070521i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 4070588i32;
                } else if (__value__ == (4070588i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4070643i32;
                    } else {
                        _gotoNext = 4070936i32;
                    };
                } else if (__value__ == (4070639i32)) {
                    _i_5++;
                    _gotoNext = 4070588i32;
                } else if (__value__ == (4070643i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 4070703i32;
                    } else {
                        _gotoNext = 4070880i32;
                    };
                } else if (__value__ == (4070703i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 4070810i32;
                    } else {
                        _gotoNext = 4070839i32;
                    };
                } else if (__value__ == (4070810i32)) {
                    _i_5++;
                    _gotoNext = 4070588i32;
                } else if (__value__ == (4070839i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 4069907i32;
                } else if (__value__ == (4070880i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 4070894i32;
                    } else {
                        _gotoNext = 4070639i32;
                    };
                } else if (__value__ == (4070894i32)) {
                    return {
