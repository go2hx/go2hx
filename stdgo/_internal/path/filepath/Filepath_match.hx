        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 4067253i32;
                } else if (__value__ == (4067253i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 4067263i32;
                } else if (__value__ == (4067263i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 4067284i32;
                    } else {
                        _gotoNext = 4068314i32;
                    };
                } else if (__value__ == (4067284i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 4067390i32;
                    } else {
                        _gotoNext = 4067556i32;
                    };
                } else if (__value__ == (4067390i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 4067794i32;
                    } else {
                        _gotoNext = 4067826i32;
                    };
                } else if (__value__ == (4067794i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 4067263i32;
                } else if (__value__ == (4067826i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 4067840i32;
                    } else {
                        _gotoNext = 4067869i32;
                    };
                } else if (__value__ == (4067840i32)) {
                    return {
                    ...
                    _gotoNext = 4067869i32;
                } else if (__value__ == (4067869i32)) {
                    if (_star_0) {
                        _gotoNext = 4067877i32;
                    } else {
                        _gotoNext = 4068292i32;
                    };
                } else if (__value__ == (4067877i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 4067944i32;
                } else if (__value__ == (4067944i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4067999i32;
                    } else {
                        _gotoNext = 4068292i32;
                    };
                } else if (__value__ == (4067995i32)) {
                    _i_5++;
                    _gotoNext = 4067944i32;
                    ...
                    if (_ok_7) {
                        _gotoNext = 4068059i32;
                    } else {
                        _gotoNext = 4068236i32;
                    };
                } else if (__value__ == (4068059i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 4068166i32;
                    } else {
                        _gotoNext = 4068195i32;
                    };
                } else if (__value__ == (4068166i32)) {
                    _i_5++;
                    _gotoNext = 4067944i32;
                } else if (__value__ == (4068195i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 4067263i32;
                } else if (__value__ == (4068236i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 4068250i32;
                    } else {
                        _gotoNext = 4067995i32;
                    };
                } else if (__value__ == (4068250i32)) {
                    return {
