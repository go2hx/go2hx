        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 3962797i32;
                } else if (__value__ == (3962797i32)) {
                    0i32;
                    patternBreak = false;
                    _gotoNext = 3962807i32;
                } else if (__value__ == (3962807i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 3962828i32;
                    } else {
                        _gotoNext = 3963858i32;
                    };
                } else if (__value__ == (3962828i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 3962934i32;
                    } else {
                        _gotoNext = 3963100i32;
                    };
                } else if (__value__ == (3962934i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 3963338i32;
                    } else {
                        _gotoNext = 3963370i32;
                    };
                } else if (__value__ == (3963338i32)) {
                    _name = _t_2?.__copy__();
                    0i32;
                    _gotoNext = 3962807i32;
                } else if (__value__ == (3963370i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 3963384i32;
                    } else {
                        _gotoNext = 3963413i32;
                    };
                } else if (__value__ == (3963384i32)) {
                    return {
                    ...
                    _gotoNext = 3963413i32;
                } else if (__value__ == (3963413i32)) {
                    if (_star_0) {
                        _gotoNext = 3963421i32;
                    } else {
                        _gotoNext = 3963836i32;
                    };
                } else if (__value__ == (3963421i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 3963488i32;
                } else if (__value__ == (3963488i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 3963543i32;
                    } else {
                        _gotoNext = 3963836i32;
                    };
                } else if (__value__ == (3963539i32)) {
                    _i_5++;
                    _gotoNext = 3963488i32;
                    ...
                    if (_ok_7) {
                        _gotoNext = 3963603i32;
                    } else {
                        _gotoNext = 3963780i32;
                    };
                } else if (__value__ == (3963603i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 3963710i32;
                    } else {
                        _gotoNext = 3963739i32;
                    };
                } else if (__value__ == (3963710i32)) {
                    _i_5++;
                    _gotoNext = 3963488i32;
                } else if (__value__ == (3963739i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 3962807i32;
                } else if (__value__ == (3963780i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 3963794i32;
                    } else {
                        _gotoNext = 3963539i32;
                    };
                } else if (__value__ == (3963794i32)) {
                    return {
