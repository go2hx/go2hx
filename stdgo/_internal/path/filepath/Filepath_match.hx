        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 3984894i32;
                } else if (__value__ == (3984894i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 3984904i32;
                } else if (__value__ == (3984904i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 3984925i32;
                    } else {
                        _gotoNext = 3985955i32;
                    };
                } else if (__value__ == (3984925i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 3985031i32;
                    } else {
                        _gotoNext = 3985197i32;
                    };
                } else if (__value__ == (3985031i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 3985435i32;
                    } else {
                        _gotoNext = 3985467i32;
                    };
                } else if (__value__ == (3985435i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 3984904i32;
                } else if (__value__ == (3985467i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 3985481i32;
                    } else {
                        _gotoNext = 3985510i32;
                    };
                } else if (__value__ == (3985481i32)) {
                    return {
                    ...
                    _gotoNext = 3985510i32;
                } else if (__value__ == (3985510i32)) {
                    if (_star_0) {
                        _gotoNext = 3985518i32;
                    } else {
                        _gotoNext = 3985933i32;
                    };
                } else if (__value__ == (3985518i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 3985585i32;
                } else if (__value__ == (3985585i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 3985640i32;
                    } else {
                        _gotoNext = 3985933i32;
                    };
                } else if (__value__ == (3985636i32)) {
                    _i_5++;
                    _gotoNext = 3985585i32;
                } else if (__value__ == (3985640i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 3985700i32;
                    } else {
                        _gotoNext = 3985877i32;
                    };
                } else if (__value__ == (3985700i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 3985807i32;
                    } else {
                        _gotoNext = 3985836i32;
                    };
                } else if (__value__ == (3985807i32)) {
                    _i_5++;
                    _gotoNext = 3985585i32;
                } else if (__value__ == (3985836i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 3984904i32;
                } else if (__value__ == (3985877i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 3985891i32;
                    } else {
                        _gotoNext = 3985636i32;
                    };
                } else if (__value__ == (3985891i32)) {
                    return {
