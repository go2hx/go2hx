        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                ...
                } else if (__value__ == (4022915i32)) {
                    {
                        ...
                        _star_4022923 = @:tmpset0 __tmp__._0;
                        _chunk_4022939 = @:tmpset0 __tmp__._1?.__copy__();
                ...
                } else if (__value__ == (4023187i32)) {
                    {
                        ...
                        _t_4023187 = @:tmpset0 __tmp__._0?.__copy__();
                        _ok_4023190 = @:tmpset0 __tmp__._1;
                        _err_4023194 = @:tmpset0 __tmp__._2;
                    };
                ...
                } else if (__value__ == (4023630i32)) {
                    {
                        ...
                        _t_4023636 = @:tmpset0 __tmp__._0?.__copy__();
                        _ok_4023639 = @:tmpset0 __tmp__._1;
                        _err_4023643 = @:tmpset0 __tmp__._2;
                    };
                    if (_ok_4023639) {
