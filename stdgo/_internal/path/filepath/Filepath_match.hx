        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                ...
                } else if (__value__ == (3988175i32)) {
                    {
                        ...
                        _star_3988183 = __tmp__._0;
                        _chunk_3988199 = __tmp__._1?.__copy__();
                        _pattern = __tmp__._2?.__copy__();
                    };
                    if ((_star_3988183 && (_chunk_3988199 == stdgo.Go.str()) : Bool)) {
                ...
                } else if (__value__ == (3988447i32)) {
                    {
                        ...
                        _t_3988447 = __tmp__._0?.__copy__();
                        _ok_3988450 = __tmp__._1;
                        _err_3988454 = __tmp__._2;
                    };
                ...
                } else if (__value__ == (3988890i32)) {
                    {
                        ...
                        _t_3988896 = __tmp__._0?.__copy__();
                        _ok_3988899 = __tmp__._1;
                        _err_3988903 = __tmp__._2;
                    };
                    if (_ok_3988899) {
