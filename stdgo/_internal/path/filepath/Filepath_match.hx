...
function match(_pattern:stdgo.GoString, _name:stdgo.GoString):{ var _0 : Bool; var _1 : stdgo.Error; } {
        ...
        while (_gotoNext != ((-1i64 : stdgo.GoInt))) {
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    _gotoNext = 4019810i64;
                } else if (__value__ == (4019810i64)) {
                    0i64;
                    patternBreak = false;
                    _gotoNext = 4019820i64;
                } else if (__value__ == (4019820i64)) {
                    //"file://#L0"
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 4019841i64;
                    } else {
                        _gotoNext = 4020871i64;
                    };
                } else if (__value__ == (4019841i64)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 4019947i64;
                    } else {
                        _gotoNext = 4020113i64;
                    };
                } else if (__value__ == (4019947i64)) {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 4020351i64;
                    } else {
                        _gotoNext = 4020383i64;
                    };
                } else if (__value__ == (4020351i64)) {
                    _name = _t_2?.__copy__();
                    0i64;
                    _gotoNext = 4019820i64;
                } else if (__value__ == (4020383i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/filepath/match.go#L62"
                    if (_err_4 != null) {
                        _gotoNext = 4020397i64;
                    } else {
                        _gotoNext = 4020426i64;
                    };
                } else if (__value__ == (4020397i64)) {
                    ...
                    _gotoNext = 4020426i64;
                } else if (__value__ == (4020426i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/filepath/match.go#L65"
                    if (_star_0) {
                        _gotoNext = 4020434i64;
                    } else {
                        _gotoNext = 4020849i64;
                    };
                } else if (__value__ == (4020434i64)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 4020501i64;
                } else if (__value__ == (4020501i64)) {
                    //"file://#L0"
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 4020556i64;
                    } else {
                        _gotoNext = 4020849i64;
                    };
                } else if (__value__ == (4020552i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/filepath/match.go#L68"
                    _i_5++;
                    _gotoNext = 4020501i64;
                } else if (__value__ == (4020556i64)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 4020616i64;
                    } else {
                        _gotoNext = 4020793i64;
                    };
                } else if (__value__ == (4020616i64)) {
                    ...
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 4020723i64;
                    } else {
                        _gotoNext = 4020752i64;
                    };
                } else if (__value__ == (4020723i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/filepath/match.go#L68"
                    _i_5++;
                    _gotoNext = 4020501i64;
                } else if (__value__ == (4020752i64)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 4019820i64;
                } else if (__value__ == (4020793i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/path/filepath/match.go#L78"
                    if (_err_8 != null) {
                        _gotoNext = 4020807i64;
                    } else {
                        _gotoNext = 4020552i64;
                    };
                } else if (__value__ == (4020807i64)) {
