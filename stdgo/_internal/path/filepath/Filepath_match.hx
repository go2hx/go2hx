        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 3928231i32;
                } else if (__value__ == (3928231i32)) {
                    var __blank__ = 0i32;
                    patternBreak = false;
                    _gotoNext = 3928241i32;
                } else if (__value__ == (3928241i32)) {
                    if (!patternBreak && (((_pattern.length) > (0 : stdgo.GoInt) : Bool))) {
                        _gotoNext = 3928262i32;
                    } else {
                        _gotoNext = 3929292i32;
                    };
                } else if (__value__ == (3928262i32)) {
                    {
                    ...
                    if ((_star_0 && (_chunk_1 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                        _gotoNext = 3928368i32;
                    } else {
                        _gotoNext = 3928534i32;
                    };
                } else if (__value__ == (3928368i32)) {
                    return {
                    ...
                    if ((_ok_3 && (((_t_2.length == (0 : stdgo.GoInt)) || ((_pattern.length) > (0 : stdgo.GoInt) : Bool) : Bool)) : Bool)) {
                        _gotoNext = 3928772i32;
                    } else {
                        _gotoNext = 3928804i32;
                    };
                } else if (__value__ == (3928772i32)) {
                    _name = _t_2?.__copy__();
                    var __blank__ = 0i32;
                    _gotoNext = 3928241i32;
                } else if (__value__ == (3928804i32)) {
                    if (_err_4 != null) {
                        _gotoNext = 3928818i32;
                    } else {
                        _gotoNext = 3928847i32;
                    };
                } else if (__value__ == (3928818i32)) {
                    return {
                    ...
                    _gotoNext = 3928847i32;
                } else if (__value__ == (3928847i32)) {
                    if (_star_0) {
                        _gotoNext = 3928855i32;
                    } else {
                        _gotoNext = 3929270i32;
                    };
                } else if (__value__ == (3928855i32)) {
                    _i_5 = (0 : stdgo.GoInt);
                    _gotoNext = 3928922i32;
                } else if (__value__ == (3928922i32)) {
                    if (((_i_5 < (_name.length) : Bool) && (_name[(_i_5 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 3928977i32;
                    } else {
                        _gotoNext = 3929270i32;
                    };
                } else if (__value__ == (3928973i32)) {
                    _i_5++;
                    _gotoNext = 3928922i32;
                } else if (__value__ == (3928977i32)) {
                    {
                    ...
                    if (_ok_7) {
                        _gotoNext = 3929037i32;
                    } else {
                        _gotoNext = 3929214i32;
                    };
                } else if (__value__ == (3929037i32)) {
                    if (((_pattern.length == (0 : stdgo.GoInt)) && ((_t_6.length) > (0 : stdgo.GoInt) : Bool) : Bool)) {
                        _gotoNext = 3929144i32;
                    } else {
                        _gotoNext = 3929173i32;
                    };
                } else if (__value__ == (3929144i32)) {
                    _i_5++;
                    _gotoNext = 3928922i32;
                } else if (__value__ == (3929173i32)) {
                    _name = _t_6?.__copy__();
                    _gotoNext = 3928241i32;
                } else if (__value__ == (3929214i32)) {
                    if (_err_8 != null) {
                        _gotoNext = 3929228i32;
                    } else {
                        _gotoNext = 3928973i32;
                    };
                } else if (__value__ == (3929228i32)) {
                    return {
