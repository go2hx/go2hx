...
function match(_pattern:stdgo.GoString, _name:stdgo.GoString):{ var _0 : Bool; var _1 : stdgo.Error; } {
        stdgo._internal.internal.Macro.controlFlow({
            ...
            @:label("Pattern") while (((_pattern.length) > (0 : stdgo.GoInt) : Bool)) {
                ...
                var __tmp__ = stdgo._internal.path.filepath.Filepath__matchChunk._matchChunk(_chunk?.__copy__(), _name?.__copy__()), _t:stdgo.GoString = __tmp__._0, _ok:Bool = __tmp__._1, _err:stdgo.Error = __tmp__._2;
                ...
                if (_star) {
                    {
                        ...
                        while (((_i < (_name.length) : Bool) && (_name[(_i : stdgo.GoInt)] != (47 : stdgo.GoUInt8)) : Bool)) {
                            var __tmp__ = stdgo._internal.path.filepath.Filepath__matchChunk._matchChunk(_chunk.__copy__(), (_name.__slice__((_i + (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.GoString).__copy__()), _t:stdgo.GoString = __tmp__._0, _ok:Bool = __tmp__._1, _err:stdgo.Error = __tmp__._2;
if (_ok) {
