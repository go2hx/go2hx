        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                ...
                } else if (__value__ == (3943466i32)) {
                    {
                        ...
                        _star_3943474 = @:tmpset0 __tmp__._0;
                        _chunk_3943490 = @:tmpset0 __tmp__._1?.__copy__();
                        _pattern = @:tmpset0 __tmp__._2?.__copy__();
                    };
                    if ((_star_3943474 && (_chunk_3943490 == (stdgo.Go.str() : stdgo.GoString)) : Bool)) {
                ...
                } else if (__value__ == (3943738i32)) {
                    {
                        ...
                        _t_3943738 = @:tmpset0 __tmp__._0?.__copy__();
                        _ok_3943741 = @:tmpset0 __tmp__._1;
                        _err_3943745 = @:tmpset0 __tmp__._2;
                    };
                ...
                } else if (__value__ == (3944181i32)) {
                    {
                        ...
                        _t_3944187 = @:tmpset0 __tmp__._0?.__copy__();
                        _ok_3944190 = @:tmpset0 __tmp__._1;
                        _err_3944194 = @:tmpset0 __tmp__._2;
                    };
                    if (_ok_3944190) {
