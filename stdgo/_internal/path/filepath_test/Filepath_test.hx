...
(new stdgo._internal.path.filepath_test.Filepath_test.MatchTest(("*x" : stdgo.GoString), ("xxx" : stdgo.GoString), true, (null : stdgo.Error)) : stdgo._internal.path.filepath_test.Filepath_test.MatchTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.MatchTest>);
...
var _cleantests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest>(
35,
35,
...
(new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("abc//./../def" : stdgo.GoString), ("def" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest),
(new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("abc/../../././../def" : stdgo.GoString), ("../../def" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest>);
var _nonwincleantests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest>(3, 3, (new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("//abc" : stdgo.GoString), ("/abc" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest), (new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("///abc" : stdgo.GoString), ("/abc" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest), (new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("//abc//" : stdgo.GoString), ("/abc" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest>);
var _wincleantests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest>(
31,
31,
...
(new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("a/../../c:" : stdgo.GoString), ("..\\c:" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest),
(new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("foo:bar" : stdgo.GoString), ("foo:bar" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest>);
var _islocaltests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.IsLocalTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.IsLocalTest>(
13,
13,
...
(new stdgo._internal.path.filepath_test.Filepath_test.IsLocalTest(("a/../b:/../../c" : stdgo.GoString), false) : stdgo._internal.path.filepath_test.Filepath_test.IsLocalTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.IsLocalTest>);
var _winislocaltests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.IsLocalTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.IsLocalTest>(
16,
16,
...
(new stdgo._internal.path.filepath_test.Filepath_test.IsLocalTest(("conout$" : stdgo.GoString), false) : stdgo._internal.path.filepath_test.Filepath_test.IsLocalTest),
(new stdgo._internal.path.filepath_test.Filepath_test.IsLocalTest(("dollar$" : stdgo.GoString), true) : stdgo._internal.path.filepath_test.Filepath_test.IsLocalTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.IsLocalTest>);
...
var _slashtests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest>(4, 4, (new stdgo._internal.path.filepath_test.Filepath_test.PathTest(stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo._internal.path.filepath_test.Filepath_test.PathTest), (new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("/" : stdgo.GoString), ((47 : stdgo.GoInt32) : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest), (new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("/a/b" : stdgo.GoString), ((new stdgo.Slice<stdgo.GoUInt8>(4, 4, (47 : stdgo.GoUInt8), (97 : stdgo.GoUInt8), (47 : stdgo.GoUInt8), (98 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>) : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest), (new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("a//b" : stdgo.GoString), ((new stdgo.Slice<stdgo.GoUInt8>(4, 4, (97 : stdgo.GoUInt8), (47 : stdgo.GoUInt8), (47 : stdgo.GoUInt8), (98 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>) : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest>);
var _splitlisttests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.SplitListTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.SplitListTest>(3, 3, (new stdgo._internal.path.filepath_test.Filepath_test.SplitListTest(stdgo.Go.str()?.__copy__(), (new stdgo.Slice<stdgo.GoString>(0, 0) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.SplitListTest), (new stdgo._internal.path.filepath_test.Filepath_test.SplitListTest(((new stdgo.Slice<stdgo.GoUInt8>(3, 3, (97 : stdgo.GoUInt8), (58 : stdgo.GoUInt8), (98 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>) : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(2, 2, ("a" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.SplitListTest), (new stdgo._internal.path.filepath_test.Filepath_test.SplitListTest(((new stdgo.Slice<stdgo.GoUInt8>(4, 4, (58 : stdgo.GoUInt8), (97 : stdgo.GoUInt8), (58 : stdgo.GoUInt8), (98 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>) : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(3, 3, stdgo.Go.str()?.__copy__(), ("a" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.SplitListTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.SplitListTest>);
var _winsplitlisttests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.SplitListTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.SplitListTest>(
14,
14,
(new stdgo._internal.path.filepath_test.Filepath_test.SplitListTest(("\"a\"" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("a" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitListTest(("\";\"" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, (";" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitListTest(("\"a;b\"" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("a;b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitListTest(("\";\";" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(2, 2, (";" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitListTest((";\";\"" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(2, 2, stdgo.Go.str()?.__copy__(), (";" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitListTest(("a\";\"b" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("a;b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitListTest(("a; \"\"b" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(2, 2, ("a" : stdgo.GoString), (" b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitListTest(("\"a;b" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("a;b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitListTest(("\"\"a;b" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(2, 2, ("a" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitListTest(("\"\"\"a;b" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("a;b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitListTest(("\"\"\"\"a;b" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(2, 2, ("a" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitListTest(("a\";b" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("a;b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitListTest(("a;b\";c" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(2, 2, ("a" : stdgo.GoString), ("b;c" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.SplitListTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitListTest(("\"a\";b\";c" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(2, 2, ("a" : stdgo.GoString), ("b;c" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.SplitListTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.SplitListTest>);
...
var _winsplittests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.SplitTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.SplitTest>(
10,
10,
(new stdgo._internal.path.filepath_test.Filepath_test.SplitTest(("c:" : stdgo.GoString), ("c:" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo._internal.path.filepath_test.Filepath_test.SplitTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitTest(("c:/" : stdgo.GoString), ("c:/" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo._internal.path.filepath_test.Filepath_test.SplitTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitTest(("c:/foo" : stdgo.GoString), ("c:/" : stdgo.GoString), ("foo" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.SplitTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitTest(("c:/foo/bar" : stdgo.GoString), ("c:/foo/" : stdgo.GoString), ("bar" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.SplitTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitTest(("//host/share" : stdgo.GoString), ("//host/share" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo._internal.path.filepath_test.Filepath_test.SplitTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitTest(("//host/share/" : stdgo.GoString), ("//host/share/" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo._internal.path.filepath_test.Filepath_test.SplitTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitTest(("//host/share/foo" : stdgo.GoString), ("//host/share/" : stdgo.GoString), ("foo" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.SplitTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitTest(("\\\\host\\share" : stdgo.GoString), ("\\\\host\\share" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo._internal.path.filepath_test.Filepath_test.SplitTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitTest(("\\\\host\\share\\" : stdgo.GoString), ("\\\\host\\share\\" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo._internal.path.filepath_test.Filepath_test.SplitTest),
(new stdgo._internal.path.filepath_test.Filepath_test.SplitTest(("\\\\host\\share\\foo" : stdgo.GoString), ("\\\\host\\share\\" : stdgo.GoString), ("foo" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.SplitTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.SplitTest>);
var _jointests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.JoinTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.JoinTest>(
17,
17,
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(0, 0) : stdgo.Slice<stdgo.GoString>), stdgo.Go.str()?.__copy__()) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(1, 1, stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), stdgo.Go.str()?.__copy__()) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(1, 1, ("/" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("/" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(1, 1, ("a" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("a" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("a" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("a/b" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("a" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), ("a" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, stdgo.Go.str()?.__copy__(), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("b" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("/" : stdgo.GoString), ("a" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("/a" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("/" : stdgo.GoString), ("a/b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("/a/b" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("/" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), ("/" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("/a" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("/a/b" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("a" : stdgo.GoString), ("/b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("a/b" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("/a" : stdgo.GoString), ("/b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("/a/b" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("a/" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("a/b" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("a/" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), ("a" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), stdgo.Go.str()?.__copy__()) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(3, 3, ("/" : stdgo.GoString), ("a" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("/a/b" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.JoinTest>);
var _nonwinjointests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.JoinTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.JoinTest>(1, 1, (new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("//" : stdgo.GoString), ("a" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("/a" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.JoinTest>);
var _winjointests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.JoinTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.JoinTest>(
30,
30,
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("directory" : stdgo.GoString), ("file" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("directory\\file" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("C:\\Windows\\" : stdgo.GoString), ("System32" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("C:\\Windows\\System32" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("C:\\Windows\\" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), ("C:\\Windows" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("C:\\" : stdgo.GoString), ("Windows" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("C:\\Windows" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("C:" : stdgo.GoString), ("a" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("C:a" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("C:" : stdgo.GoString), ("a\\b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("C:a\\b" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(3, 3, ("C:" : stdgo.GoString), ("a" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("C:a\\b" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(3, 3, ("C:" : stdgo.GoString), stdgo.Go.str()?.__copy__(), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("C:b" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(4, 4, ("C:" : stdgo.GoString), stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__(), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("C:b" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("C:" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), ("C:." : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(3, 3, ("C:" : stdgo.GoString), stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), ("C:." : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("C:" : stdgo.GoString), ("\\a" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("C:\\a" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(3, 3, ("C:" : stdgo.GoString), stdgo.Go.str()?.__copy__(), ("\\a" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("C:\\a" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("C:." : stdgo.GoString), ("a" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("C:a" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("C:a" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("C:a\\b" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(3, 3, ("C:a" : stdgo.GoString), ("b" : stdgo.GoString), ("d" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("C:a\\b\\d" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("\\\\host\\share" : stdgo.GoString), ("foo" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("\\\\host\\share\\foo" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(1, 1, ("\\\\host\\share\\foo" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("\\\\host\\share\\foo" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("//host/share" : stdgo.GoString), ("foo/bar" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("\\\\host\\share\\foo\\bar" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(1, 1, ("\\" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("\\" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("\\" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), ("\\" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("\\" : stdgo.GoString), ("a" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("\\a" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("\\\\" : stdgo.GoString), ("a" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("\\\\a" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(3, 3, ("\\" : stdgo.GoString), ("a" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("\\a\\b" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(3, 3, ("\\\\" : stdgo.GoString), ("a" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("\\\\a\\b" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(3, 3, ("\\" : stdgo.GoString), ("\\\\a\\b" : stdgo.GoString), ("c" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("\\a\\b\\c" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(3, 3, ("\\\\a" : stdgo.GoString), ("b" : stdgo.GoString), ("c" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("\\\\a\\b\\c" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(3, 3, ("\\\\a\\" : stdgo.GoString), ("b" : stdgo.GoString), ("c" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("\\\\a\\b\\c" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("//" : stdgo.GoString), ("a" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("\\\\a" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest),
(new stdgo._internal.path.filepath_test.Filepath_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("a:\\b\\c" : stdgo.GoString), ("x\\..\\y:\\..\\..\\z" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("a:\\b\\z" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.JoinTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.JoinTest>);
var _exttests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.ExtTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.ExtTest>(5, 5, (new stdgo._internal.path.filepath_test.Filepath_test.ExtTest(("path.go" : stdgo.GoString), (".go" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.ExtTest), (new stdgo._internal.path.filepath_test.Filepath_test.ExtTest(("path.pb.go" : stdgo.GoString), (".go" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.ExtTest), (new stdgo._internal.path.filepath_test.Filepath_test.ExtTest(("a.dir/b" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo._internal.path.filepath_test.Filepath_test.ExtTest), (new stdgo._internal.path.filepath_test.Filepath_test.ExtTest(("a.dir/b.go" : stdgo.GoString), (".go" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.ExtTest), (new stdgo._internal.path.filepath_test.Filepath_test.ExtTest(("a.dir/" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo._internal.path.filepath_test.Filepath_test.ExtTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.ExtTest>);
...
var _basetests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest>(
11,
11,
(new stdgo._internal.path.filepath_test.Filepath_test.PathTest(stdgo.Go.str()?.__copy__(), ("." : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest),
(new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("." : stdgo.GoString), ("." : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest),
...
(new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("a/b/c.x" : stdgo.GoString), ("a/b" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest>);
var _nonwindirtests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest>(1, 1, (new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("////" : stdgo.GoString), ("/" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest>);
var _windirtests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest>(
10,
10,
(new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("c:\\" : stdgo.GoString), ("c:\\" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest),
(new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("c:." : stdgo.GoString), ("c:." : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest),
(new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("c:\\a\\b" : stdgo.GoString), ("c:\\a" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest),
(new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("c:a\\b" : stdgo.GoString), ("c:a" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest),
(new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("c:a\\b\\c" : stdgo.GoString), ("c:a\\b" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest),
(new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("\\\\host\\share" : stdgo.GoString), ("\\\\host\\share" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest),
(new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("\\\\host\\share\\" : stdgo.GoString), ("\\\\host\\share\\" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest),
(new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("\\\\host\\share\\a" : stdgo.GoString), ("\\\\host\\share\\" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest),
(new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("\\\\host\\share\\a\\b" : stdgo.GoString), ("\\\\host\\share\\a" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest),
(new stdgo._internal.path.filepath_test.Filepath_test.PathTest(("\\\\\\\\" : stdgo.GoString), ("\\\\\\\\" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.PathTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.PathTest>);
var _isabstests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest>(8, 8, (new stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest(stdgo.Go.str()?.__copy__(), false) : stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest), (new stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest(("/" : stdgo.GoString), true) : stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest), (new stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest(("/usr/bin/gcc" : stdgo.GoString), true) : stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest), (new stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest((".." : stdgo.GoString), false) : stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest), (new stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest(("/a/../bb" : stdgo.GoString), true) : stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest), (new stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest(("." : stdgo.GoString), false) : stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest), (new stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest(("./" : stdgo.GoString), false) : stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest), (new stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest(("lala" : stdgo.GoString), false) : stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest>);
var _winisabstests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest>(
14,
14,
...
(new stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest(("//host/share/foo/bar" : stdgo.GoString), true) : stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest>);
var evalSymlinksTestDirs : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.EvalSymlinksTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.EvalSymlinksTest>(
17,
17,
...
(new stdgo._internal.path.filepath_test.Filepath_test.EvalSymlinksTest(("version" : stdgo.GoString), ("src/versions/v1" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.EvalSymlinksTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.EvalSymlinksTest>);
var evalSymlinksTests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.EvalSymlinksTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.EvalSymlinksTest>(
12,
12,
...
(new stdgo._internal.path.filepath_test.Filepath_test.EvalSymlinksTest(("src/versions/current/modules/test" : stdgo.GoString), ("src/pool/test" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.EvalSymlinksTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.EvalSymlinksTest>);
...
var _reltests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.RelTests> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.RelTests>(
39,
39,
...
(new stdgo._internal.path.filepath_test.Filepath_test.RelTests(("/a" : stdgo.GoString), ("a" : stdgo.GoString), ("err" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.RelTests)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.RelTests>);
var _winreltests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.RelTests> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.RelTests>(7, 7, (new stdgo._internal.path.filepath_test.Filepath_test.RelTests(("C:a\\b\\c" : stdgo.GoString), ("C:a/b/d" : stdgo.GoString), ("..\\d" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.RelTests), (new stdgo._internal.path.filepath_test.Filepath_test.RelTests(("C:\\" : stdgo.GoString), ("D:\\" : stdgo.GoString), ("err" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.RelTests), (new stdgo._internal.path.filepath_test.Filepath_test.RelTests(("C:" : stdgo.GoString), ("D:" : stdgo.GoString), ("err" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.RelTests), (new stdgo._internal.path.filepath_test.Filepath_test.RelTests(("C:\\Projects" : stdgo.GoString), ("c:\\projects\\src" : stdgo.GoString), ("src" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.RelTests), (new stdgo._internal.path.filepath_test.Filepath_test.RelTests(("C:\\Projects" : stdgo.GoString), ("c:\\projects" : stdgo.GoString), ("." : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.RelTests), (new stdgo._internal.path.filepath_test.Filepath_test.RelTests(("C:\\Projects\\a\\.." : stdgo.GoString), ("c:\\projects" : stdgo.GoString), ("." : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.RelTests), (new stdgo._internal.path.filepath_test.Filepath_test.RelTests(("\\\\host\\share" : stdgo.GoString), ("\\\\host\\share\\file.txt" : stdgo.GoString), ("file.txt" : stdgo.GoString)) : stdgo._internal.path.filepath_test.Filepath_test.RelTests)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.RelTests>);
var _volumenametests : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.VolumeNameTest> = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.VolumeNameTest>(
28,
28,
...
function testCVE202230632(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        var __tmp__ = glob(("/*" : stdgo.GoString) + stdgo._internal.strings.Strings.repeat(("/" : stdgo.GoString), (10001 : stdgo.GoInt))?.__copy__()?.__copy__()), __0:stdgo.Slice<stdgo.GoString> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
...
function testWindowsGlob(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        try {
            ...
            var _tests = (new stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.T_globTest>(
10,
10,
(new stdgo._internal.path.filepath_test.Filepath_test.T_globTest(("a" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("a" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.T_globTest),
(new stdgo._internal.path.filepath_test.Filepath_test.T_globTest(("b" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.T_globTest),
(new stdgo._internal.path.filepath_test.Filepath_test.T_globTest(("c" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(0, 0) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.T_globTest),
(new stdgo._internal.path.filepath_test.Filepath_test.T_globTest(("*" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(3, 3, ("a" : stdgo.GoString), ("b" : stdgo.GoString), ("dir" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.T_globTest),
(new stdgo._internal.path.filepath_test.Filepath_test.T_globTest(("d*" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("dir" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.T_globTest),
(new stdgo._internal.path.filepath_test.Filepath_test.T_globTest(("*i*" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("dir" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.T_globTest),
(new stdgo._internal.path.filepath_test.Filepath_test.T_globTest(("*r" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("dir" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.T_globTest),
(new stdgo._internal.path.filepath_test.Filepath_test.T_globTest(("?ir" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("dir" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.T_globTest),
(new stdgo._internal.path.filepath_test.Filepath_test.T_globTest(("?r" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(0, 0) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.T_globTest),
(new stdgo._internal.path.filepath_test.Filepath_test.T_globTest(("d*/*/bin/git.exe" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("dir/d/bin/git.exe" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) : stdgo._internal.path.filepath_test.Filepath_test.T_globTest)) : stdgo.Slice<stdgo._internal.path.filepath_test.Filepath_test.T_globTest>);
...
function testWalkSkipAllOnFile(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _walker:stdgo.GoString -> stdgo.Error = function(_path:stdgo.GoString):stdgo.Error {
            ...
            if (((stdgo._internal.strings.Strings.hasSuffix(_path?.__copy__(), ("foo3" : stdgo.GoString)) || stdgo._internal.strings.Strings.hasSuffix(_path?.__copy__(), ("foo4" : stdgo.GoString))) || stdgo._internal.strings.Strings.hasSuffix(_path?.__copy__(), ("bar" : stdgo.GoString))) || stdgo._internal.strings.Strings.hasSuffix(_path?.__copy__(), ("last" : stdgo.GoString))) {
...
function testIsAbs(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        if (false) {
            ...
            for (__1 => _test in _isabstests) {
                _tests = (_tests.__append__((new stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest(("c:" : stdgo.GoString) + _test._path?.__copy__()?.__copy__(), _test._isAbs) : stdgo._internal.path.filepath_test.Filepath_test.IsAbsTest)));
            };
        } else {
            _tests = _isabstests;
        };
...
function testEvalSymlinks(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        for (__25 => _test in evalSymlinksTests) {
            ...
            if (stdgo._internal.path.filepath.Filepath.isAbs(_test._dest?.__copy__()) || stdgo._internal.os.Os.isPathSeparator(_test._dest[(0 : stdgo.GoInt)])) {
            ...
            if (false) {
                var _volDot:stdgo.GoString = stdgo._internal.path.filepath.Filepath.volumeName(_tmpDir?.__copy__()) + ("." : stdgo.GoString)?.__copy__()?.__copy__();
...
function testAbs(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        try {
            ...
            for (__42 => _path in _absTests) {
                ...
                if ((_err != null) || !stdgo._internal.os.Os.sameFile(_absinfo, _info)) {
                ...
                if (stdgo._internal.path.filepath.Filepath.isAbs(_abspath?.__copy__()) && (_abspath != stdgo._internal.path.filepath.Filepath.clean(_abspath?.__copy__()))) {
...
function testEvalSymlinksAboveRoot(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _wantSuffix:stdgo.GoString = stdgo._internal.strings.Strings.join((new stdgo.Slice<stdgo.GoString>(2, 2, ("a" : stdgo.GoString), ("file" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ((47 : stdgo.GoInt32) : stdgo.GoString))?.__copy__();
        for (__48 => _i in (new stdgo.Slice<stdgo.GoInt>(3, 3, _c, _c + (1 : stdgo.GoInt), _c + (2 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>)) {
            ...
            if (false && stdgo._internal.errors.Errors.is_(_err, stdgo._internal.io.fs.Fs.errNotExist)) {
...
function testIssue51617(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        try {
            var _dir:stdgo.GoString = _t.tempDir()?.__copy__();
            for (__8 => _sub in (new stdgo.Slice<stdgo.GoString>(3, 3, ("a" : stdgo.GoString), stdgo._internal.path.filepath.Filepath.join(("a" : stdgo.GoString), ("bad" : stdgo.GoString))?.__copy__(), stdgo._internal.path.filepath.Filepath.join(("a" : stdgo.GoString), ("next" : stdgo.GoString))?.__copy__()) : stdgo.Slice<stdgo.GoString>)) {
                {
            ...
            var _want = (new stdgo.Slice<stdgo.GoString>(4, 4, ("." : stdgo.GoString), ("a" : stdgo.GoString), stdgo._internal.path.filepath.Filepath.join(("a" : stdgo.GoString), ("bad" : stdgo.GoString))?.__copy__(), stdgo._internal.path.filepath.Filepath.join(("a" : stdgo.GoString), ("next" : stdgo.GoString))?.__copy__()) : stdgo.Slice<stdgo.GoString>);
