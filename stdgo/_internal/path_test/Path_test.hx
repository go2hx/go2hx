...
import stdgo._internal.path.Path;
import stdgo._internal.path.Path;
var _matchTests : stdgo.Slice<stdgo._internal.path_test.Path_test.MatchTest> = (new stdgo.Slice<stdgo._internal.path_test.Path_test.MatchTest>(
56,
56,
...
(new stdgo._internal.path_test.Path_test.MatchTest(("*x" : stdgo.GoString), ("xxx" : stdgo.GoString), true, (null : stdgo.Error)) : stdgo._internal.path_test.Path_test.MatchTest)) : stdgo.Slice<stdgo._internal.path_test.Path_test.MatchTest>);
var _cleantests : stdgo.Slice<stdgo._internal.path_test.Path_test.PathTest> = (new stdgo.Slice<stdgo._internal.path_test.Path_test.PathTest>(
36,
36,
...
(new stdgo._internal.path_test.Path_test.PathTest(("abc//./../def" : stdgo.GoString), ("def" : stdgo.GoString)) : stdgo._internal.path_test.Path_test.PathTest),
(new stdgo._internal.path_test.Path_test.PathTest(("abc/../../././../def" : stdgo.GoString), ("../../def" : stdgo.GoString)) : stdgo._internal.path_test.Path_test.PathTest)) : stdgo.Slice<stdgo._internal.path_test.Path_test.PathTest>);
var _splittests : stdgo.Slice<stdgo._internal.path_test.Path_test.SplitTest> = (new stdgo.Slice<stdgo._internal.path_test.Path_test.SplitTest>(5, 5, (new stdgo._internal.path_test.Path_test.SplitTest(("a/b" : stdgo.GoString), ("a/" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo._internal.path_test.Path_test.SplitTest), (new stdgo._internal.path_test.Path_test.SplitTest(("a/b/" : stdgo.GoString), ("a/b/" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo._internal.path_test.Path_test.SplitTest), (new stdgo._internal.path_test.Path_test.SplitTest(("a/" : stdgo.GoString), ("a/" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo._internal.path_test.Path_test.SplitTest), (new stdgo._internal.path_test.Path_test.SplitTest(("a" : stdgo.GoString), stdgo.Go.str()?.__copy__(), ("a" : stdgo.GoString)) : stdgo._internal.path_test.Path_test.SplitTest), (new stdgo._internal.path_test.Path_test.SplitTest(("/" : stdgo.GoString), ("/" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo._internal.path_test.Path_test.SplitTest)) : stdgo.Slice<stdgo._internal.path_test.Path_test.SplitTest>);
var _jointests : stdgo.Slice<stdgo._internal.path_test.Path_test.JoinTest> = (new stdgo.Slice<stdgo._internal.path_test.Path_test.JoinTest>(
11,
11,
(new stdgo._internal.path_test.Path_test.JoinTest((new stdgo.Slice<stdgo.GoString>(0, 0) : stdgo.Slice<stdgo.GoString>), stdgo.Go.str()?.__copy__()) : stdgo._internal.path_test.Path_test.JoinTest),
(new stdgo._internal.path_test.Path_test.JoinTest((new stdgo.Slice<stdgo.GoString>(1, 1, stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), stdgo.Go.str()?.__copy__()) : stdgo._internal.path_test.Path_test.JoinTest),
(new stdgo._internal.path_test.Path_test.JoinTest((new stdgo.Slice<stdgo.GoString>(1, 1, ("a" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("a" : stdgo.GoString)) : stdgo._internal.path_test.Path_test.JoinTest),
(new stdgo._internal.path_test.Path_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("a" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("a/b" : stdgo.GoString)) : stdgo._internal.path_test.Path_test.JoinTest),
(new stdgo._internal.path_test.Path_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("a" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), ("a" : stdgo.GoString)) : stdgo._internal.path_test.Path_test.JoinTest),
(new stdgo._internal.path_test.Path_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, stdgo.Go.str()?.__copy__(), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("b" : stdgo.GoString)) : stdgo._internal.path_test.Path_test.JoinTest),
(new stdgo._internal.path_test.Path_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("/" : stdgo.GoString), ("a" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("/a" : stdgo.GoString)) : stdgo._internal.path_test.Path_test.JoinTest),
(new stdgo._internal.path_test.Path_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("/" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), ("/" : stdgo.GoString)) : stdgo._internal.path_test.Path_test.JoinTest),
(new stdgo._internal.path_test.Path_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("a/" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("a/b" : stdgo.GoString)) : stdgo._internal.path_test.Path_test.JoinTest),
(new stdgo._internal.path_test.Path_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("a/" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), ("a" : stdgo.GoString)) : stdgo._internal.path_test.Path_test.JoinTest),
(new stdgo._internal.path_test.Path_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), stdgo.Go.str()?.__copy__()) : stdgo._internal.path_test.Path_test.JoinTest)) : stdgo.Slice<stdgo._internal.path_test.Path_test.JoinTest>);
var _exttests : stdgo.Slice<stdgo._internal.path_test.Path_test.ExtTest> = (new stdgo.Slice<stdgo._internal.path_test.Path_test.ExtTest>(5, 5, (new stdgo._internal.path_test.Path_test.ExtTest(("path.go" : stdgo.GoString), (".go" : stdgo.GoString)) : stdgo._internal.path_test.Path_test.ExtTest), (new stdgo._internal.path_test.Path_test.ExtTest(("path.pb.go" : stdgo.GoString), (".go" : stdgo.GoString)) : stdgo._internal.path_test.Path_test.ExtTest), (new stdgo._internal.path_test.Path_test.ExtTest(("a.dir/b" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo._internal.path_test.Path_test.ExtTest), (new stdgo._internal.path_test.Path_test.ExtTest(("a.dir/b.go" : stdgo.GoString), (".go" : stdgo.GoString)) : stdgo._internal.path_test.Path_test.ExtTest), (new stdgo._internal.path_test.Path_test.ExtTest(("a.dir/" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo._internal.path_test.Path_test.ExtTest)) : stdgo.Slice<stdgo._internal.path_test.Path_test.ExtTest>);
var _basetests : stdgo.Slice<stdgo._internal.path_test.Path_test.PathTest> = (new stdgo.Slice<stdgo._internal.path_test.Path_test.PathTest>(
11,
11,
(new stdgo._internal.path_test.Path_test.PathTest(stdgo.Go.str()?.__copy__(), ("." : stdgo.GoString)) : stdgo._internal.path_test.Path_test.PathTest),
(new stdgo._internal.path_test.Path_test.PathTest(("." : stdgo.GoString), ("." : stdgo.GoString)) : stdgo._internal.path_test.Path_test.PathTest),
...
(new stdgo._internal.path_test.Path_test.PathTest(("a/b/c.x" : stdgo.GoString), ("c.x" : stdgo.GoString)) : stdgo._internal.path_test.Path_test.PathTest)) : stdgo.Slice<stdgo._internal.path_test.Path_test.PathTest>);
var _dirtests : stdgo.Slice<stdgo._internal.path_test.Path_test.PathTest> = (new stdgo.Slice<stdgo._internal.path_test.Path_test.PathTest>(
13,
13,
(new stdgo._internal.path_test.Path_test.PathTest(stdgo.Go.str()?.__copy__(), ("." : stdgo.GoString)) : stdgo._internal.path_test.Path_test.PathTest),
(new stdgo._internal.path_test.Path_test.PathTest(("." : stdgo.GoString), ("." : stdgo.GoString)) : stdgo._internal.path_test.Path_test.PathTest),
...
(new stdgo._internal.path_test.Path_test.PathTest(("a/b/c.x" : stdgo.GoString), ("a/b" : stdgo.GoString)) : stdgo._internal.path_test.Path_test.PathTest)) : stdgo.Slice<stdgo._internal.path_test.Path_test.PathTest>);
var _isAbsTests : stdgo.Slice<stdgo._internal.path_test.Path_test.IsAbsTest> = (new stdgo.Slice<stdgo._internal.path_test.Path_test.IsAbsTest>(8, 8, (new stdgo._internal.path_test.Path_test.IsAbsTest(stdgo.Go.str()?.__copy__(), false) : stdgo._internal.path_test.Path_test.IsAbsTest), (new stdgo._internal.path_test.Path_test.IsAbsTest(("/" : stdgo.GoString), true) : stdgo._internal.path_test.Path_test.IsAbsTest), (new stdgo._internal.path_test.Path_test.IsAbsTest(("/usr/bin/gcc" : stdgo.GoString), true) : stdgo._internal.path_test.Path_test.IsAbsTest), (new stdgo._internal.path_test.Path_test.IsAbsTest((".." : stdgo.GoString), false) : stdgo._internal.path_test.Path_test.IsAbsTest), (new stdgo._internal.path_test.Path_test.IsAbsTest(("/a/../bb" : stdgo.GoString), true) : stdgo._internal.path_test.Path_test.IsAbsTest), (new stdgo._internal.path_test.Path_test.IsAbsTest(("." : stdgo.GoString), false) : stdgo._internal.path_test.Path_test.IsAbsTest), (new stdgo._internal.path_test.Path_test.IsAbsTest(("./" : stdgo.GoString), false) : stdgo._internal.path_test.Path_test.IsAbsTest), (new stdgo._internal.path_test.Path_test.IsAbsTest(("lala" : stdgo.GoString), false) : stdgo._internal.path_test.Path_test.IsAbsTest)) : stdgo.Slice<stdgo._internal.path_test.Path_test.IsAbsTest>);
...
function exampleClean():Void {
        var _paths = (new stdgo.Slice<stdgo.GoString>(7, 7, ("a/c" : stdgo.GoString), ("a//c" : stdgo.GoString), ("a/c/." : stdgo.GoString), ("a/c/b/.." : stdgo.GoString), ("/../a/c" : stdgo.GoString), ("/../a/b/../././/c" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>);
