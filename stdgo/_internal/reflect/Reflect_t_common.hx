...
@:structInit @:using(stdgo._internal.reflect.Reflect_t_common_static_extension.T_common_static_extension) class T_common {
    @:embedded
    public var type : stdgo._internal.internal.abi.Abi_type_.Type_ = ({} : stdgo._internal.internal.abi.Abi_type_.Type_);
    public function new(?type:stdgo._internal.internal.abi.Abi_type_.Type_) {
