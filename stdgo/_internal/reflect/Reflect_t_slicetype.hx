...
@:structInit @:using(stdgo._internal.reflect.Reflect_t_slicetype_static_extension.T_sliceType_static_extension) class T_sliceType {
    @:embedded
    ...
    public function new(?sliceType:stdgo._internal.internal.abi.Abi_slicetype.SliceType) {
    ...
    public function __copy__() {
        return new T_sliceType(sliceType);
    }
}
