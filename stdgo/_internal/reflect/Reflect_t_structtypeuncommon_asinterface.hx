...
class T_structTypeUncommon_asInterface {
    ...
    @:embedded
    @:embeddededffieldsffun
    public dynamic function fieldByNameFunc(_0:stdgo.GoString -> Bool):{ var _0 : stdgo._internal.reflect.Reflect_structfield.StructField; var _1 : Bool; } return @:_0 __self__.value.fieldByNameFunc(_0);
    @:embedded
    @:embeddededffieldsffun
    public dynamic function fieldByName(_0:stdgo.GoString):{ var _0 : stdgo._internal.reflect.Reflect_structfield.StructField; var _1 : Bool; } return @:_0 __self__.value.fieldByName(_0);
    @:embedded
    @:embeddededffieldsffun
    public dynamic function fieldByIndex(_0:stdgo.Slice<stdgo.GoInt>):stdgo._internal.reflect.Reflect_structfield.StructField return @:_0 __self__.value.fieldByIndex(_0);
    @:embedded
    @:embeddededffieldsffun
    public dynamic function fieldAlign():stdgo.GoInt return @:_0 __self__.value.fieldAlign();
    @:embedded
    @:embeddededffieldsffun
    public dynamic function field(_0:stdgo.GoInt):stdgo._internal.reflect.Reflect_structfield.StructField return @:_0 __self__.value.field(_0);
    @:embedded
    @:embeddededffieldsffun
    ...
    var __self__ : stdgo._internal.reflect.Reflect_t_structtypeuncommonpointer.T_structTypeUncommonPointer;
