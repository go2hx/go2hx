...
var _badRe : stdgo.Slice<stdgo._internal.regexp.Regexp.T_stringError> = (new stdgo.Slice<stdgo._internal.regexp.Regexp.T_stringError>(
12,
12,
...
(new stdgo._internal.regexp.Regexp.T_stringError(stdgo._internal.strings.Strings.repeat(("\\pL" : stdgo.GoString), (27000 : stdgo.GoInt))?.__copy__(), ("expression too large" : stdgo.GoString)) : stdgo._internal.regexp.Regexp.T_stringError)) : stdgo.Slice<stdgo._internal.regexp.Regexp.T_stringError>);
var _replaceTests : stdgo.Slice<stdgo._internal.regexp.Regexp.ReplaceTest> = (new stdgo.Slice<stdgo._internal.regexp.Regexp.ReplaceTest>(
72,
72,
...
(new stdgo._internal.regexp.Regexp.ReplaceTest(("((a(b){0}){3}){5}h" : stdgo.GoString), ("y caramb$2" : stdgo.GoString), ("say aaaaaaaaaaaaaaaah" : stdgo.GoString), ("say ay caramba" : stdgo.GoString)) : stdgo._internal.regexp.Regexp.ReplaceTest)) : stdgo.Slice<stdgo._internal.regexp.Regexp.ReplaceTest>);
var _replaceLiteralTests : stdgo.Slice<stdgo._internal.regexp.Regexp.ReplaceTest> = (new stdgo.Slice<stdgo._internal.regexp.Regexp.ReplaceTest>(
15,
15,
...
(new stdgo._internal.regexp.Regexp.ReplaceTest(("a+" : stdgo.GoString), ("${oops" : stdgo.GoString), ("aaa" : stdgo.GoString), ("${oops" : stdgo.GoString)) : stdgo._internal.regexp.Regexp.ReplaceTest),
(new stdgo._internal.regexp.Regexp.ReplaceTest(("a+" : stdgo.GoString), ("$$" : stdgo.GoString), ("aaa" : stdgo.GoString), ("$$" : stdgo.GoString)) : stdgo._internal.regexp.Regexp.ReplaceTest),
(new stdgo._internal.regexp.Regexp.ReplaceTest(("a+" : stdgo.GoString), ("$" : stdgo.GoString), ("aaa" : stdgo.GoString), ("$" : stdgo.GoString)) : stdgo._internal.regexp.Regexp.ReplaceTest)) : stdgo.Slice<stdgo._internal.regexp.Regexp.ReplaceTest>);
...
(new stdgo._internal.regexp.Regexp.MetaTest(("�" : stdgo.GoString), stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__(), false) : stdgo._internal.regexp.Regexp.MetaTest)) : stdgo.Slice<stdgo._internal.regexp.Regexp.MetaTest>);
var _emptySubexpIndices : stdgo.Slice<stdgo._internal.regexp.Regexp.T_subexpIndex> = (new stdgo.Slice<stdgo._internal.regexp.Regexp.T_subexpIndex>(2, 2, (new stdgo._internal.regexp.Regexp.T_subexpIndex(stdgo.Go.str()?.__copy__(), (-1 : stdgo.GoInt)) : stdgo._internal.regexp.Regexp.T_subexpIndex), (new stdgo._internal.regexp.Regexp.T_subexpIndex(("missing" : stdgo.GoString), (-1 : stdgo.GoInt)) : stdgo._internal.regexp.Regexp.T_subexpIndex)) : stdgo.Slice<stdgo._internal.regexp.Regexp.T_subexpIndex>);
var _subexpCases : stdgo.Slice<stdgo._internal.regexp.Regexp.T_subexpCase> = (new stdgo.Slice<stdgo._internal.regexp.Regexp.T_subexpCase>(
11,
11,
...
(new stdgo._internal.regexp.Regexp.T_subexpCase(("ab(b)a" : stdgo.GoString), (1 : stdgo.GoInt), (new stdgo.Slice<stdgo.GoString>(2, 2, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), _emptySubexpIndices) : stdgo._internal.regexp.Regexp.T_subexpCase),
(new stdgo._internal.regexp.Regexp.T_subexpCase(("ab(.*)a" : stdgo.GoString), (1 : stdgo.GoInt), (new stdgo.Slice<stdgo.GoString>(2, 2, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), _emptySubexpIndices) : stdgo._internal.regexp.Regexp.T_subexpCase),
(new stdgo._internal.regexp.Regexp.T_subexpCase(("(.*)ab(.*)a" : stdgo.GoString), (2 : stdgo.GoInt), (new stdgo.Slice<stdgo.GoString>(3, 3, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), _emptySubexpIndices) : stdgo._internal.regexp.Regexp.T_subexpCase),
(new stdgo._internal.regexp.Regexp.T_subexpCase(("(.*)(ab)(.*)a" : stdgo.GoString), (3 : stdgo.GoInt), (new stdgo.Slice<stdgo.GoString>(4, 4, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), _emptySubexpIndices) : stdgo._internal.regexp.Regexp.T_subexpCase),
(new stdgo._internal.regexp.Regexp.T_subexpCase(("(.*)((a)b)(.*)a" : stdgo.GoString), (4 : stdgo.GoInt), (new stdgo.Slice<stdgo.GoString>(5, 5, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), _emptySubexpIndices) : stdgo._internal.regexp.Regexp.T_subexpCase),
(new stdgo._internal.regexp.Regexp.T_subexpCase(("(.*)(\\(ab)(.*)a" : stdgo.GoString), (3 : stdgo.GoInt), (new stdgo.Slice<stdgo.GoString>(4, 4, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), _emptySubexpIndices) : stdgo._internal.regexp.Regexp.T_subexpCase),
(new stdgo._internal.regexp.Regexp.T_subexpCase(("(.*)(\\(a\\)b)(.*)a" : stdgo.GoString), (3 : stdgo.GoInt), (new stdgo.Slice<stdgo.GoString>(4, 4, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), _emptySubexpIndices) : stdgo._internal.regexp.Regexp.T_subexpCase),
(new stdgo._internal.regexp.Regexp.T_subexpCase(("(?P<foo>.*)(?P<bar>(a)b)(?P<foo>.*)a" : stdgo.GoString), (4 : stdgo.GoInt), (new stdgo.Slice<stdgo.GoString>(5, 5, stdgo.Go.str()?.__copy__(), ("foo" : stdgo.GoString), ("bar" : stdgo.GoString), stdgo.Go.str()?.__copy__(), ("foo" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), (new stdgo.Slice<stdgo._internal.regexp.Regexp.T_subexpIndex>(4, 4, (new stdgo._internal.regexp.Regexp.T_subexpIndex(stdgo.Go.str()?.__copy__(), (-1 : stdgo.GoInt)) : stdgo._internal.regexp.Regexp.T_subexpIndex), (new stdgo._internal.regexp.Regexp.T_subexpIndex(("missing" : stdgo.GoString), (-1 : stdgo.GoInt)) : stdgo._internal.regexp.Regexp.T_subexpIndex), (new stdgo._internal.regexp.Regexp.T_subexpIndex(("foo" : stdgo.GoString), (1 : stdgo.GoInt)) : stdgo._internal.regexp.Regexp.T_subexpIndex), (new stdgo._internal.regexp.Regexp.T_subexpIndex(("bar" : stdgo.GoString), (2 : stdgo.GoInt)) : stdgo._internal.regexp.Regexp.T_subexpIndex)) : stdgo.Slice<stdgo._internal.regexp.Regexp.T_subexpIndex>)) : stdgo._internal.regexp.Regexp.T_subexpCase)) : stdgo.Slice<stdgo._internal.regexp.Regexp.T_subexpCase>);
var _splitTests : stdgo.Slice<T__struct_0> = (new stdgo.Slice<T__struct_0>(
23,
23,
({ _s : ("foo:and:bar" : stdgo.GoString), _r : (":" : stdgo.GoString), _n : (-1 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(3, 3, ("foo" : stdgo.GoString), ("and" : stdgo.GoString), ("bar" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("foo:and:bar" : stdgo.GoString), _r : (":" : stdgo.GoString), _n : (1 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(1, 1, ("foo:and:bar" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("foo:and:bar" : stdgo.GoString), _r : (":" : stdgo.GoString), _n : (2 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(2, 2, ("foo" : stdgo.GoString), ("and:bar" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("foo:and:bar" : stdgo.GoString), _r : ("foo" : stdgo.GoString), _n : (-1 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(2, 2, stdgo.Go.str()?.__copy__(), (":and:bar" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("foo:and:bar" : stdgo.GoString), _r : ("bar" : stdgo.GoString), _n : (-1 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(2, 2, ("foo:and:" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("foo:and:bar" : stdgo.GoString), _r : ("baz" : stdgo.GoString), _n : (-1 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(1, 1, ("foo:and:bar" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("baabaab" : stdgo.GoString), _r : ("a" : stdgo.GoString), _n : (-1 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(5, 5, ("b" : stdgo.GoString), stdgo.Go.str()?.__copy__(), ("b" : stdgo.GoString), stdgo.Go.str()?.__copy__(), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("baabaab" : stdgo.GoString), _r : ("a*" : stdgo.GoString), _n : (-1 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(3, 3, ("b" : stdgo.GoString), ("b" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("baabaab" : stdgo.GoString), _r : ("ba*" : stdgo.GoString), _n : (-1 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(4, 4, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("foobar" : stdgo.GoString), _r : ("f*b*" : stdgo.GoString), _n : (-1 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(5, 5, stdgo.Go.str()?.__copy__(), ("o" : stdgo.GoString), ("o" : stdgo.GoString), ("a" : stdgo.GoString), ("r" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("foobar" : stdgo.GoString), _r : ("f+.*b+" : stdgo.GoString), _n : (-1 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(2, 2, stdgo.Go.str()?.__copy__(), ("ar" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("foobooboar" : stdgo.GoString), _r : ("o{2}" : stdgo.GoString), _n : (-1 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(3, 3, ("f" : stdgo.GoString), ("b" : stdgo.GoString), ("boar" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("a,b,c,d,e,f" : stdgo.GoString), _r : ("," : stdgo.GoString), _n : (3 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(3, 3, ("a" : stdgo.GoString), ("b" : stdgo.GoString), ("c,d,e,f" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("a,b,c,d,e,f" : stdgo.GoString), _r : ("," : stdgo.GoString), _n : (0 : stdgo.GoInt), _out : (null : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("," : stdgo.GoString), _r : ("," : stdgo.GoString), _n : (-1 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(2, 2, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : (",,," : stdgo.GoString), _r : ("," : stdgo.GoString), _n : (-1 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(4, 4, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : stdgo.Go.str()?.__copy__(), _r : ("," : stdgo.GoString), _n : (-1 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(1, 1, stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : stdgo.Go.str()?.__copy__(), _r : (".*" : stdgo.GoString), _n : (-1 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(1, 1, stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : stdgo.Go.str()?.__copy__(), _r : (".+" : stdgo.GoString), _n : (-1 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(1, 1, stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : stdgo.Go.str()?.__copy__(), _r : stdgo.Go.str()?.__copy__(), _n : (-1 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(0, 0) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("foobar" : stdgo.GoString), _r : stdgo.Go.str()?.__copy__(), _n : (-1 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(6, 6, ("f" : stdgo.GoString), ("o" : stdgo.GoString), ("o" : stdgo.GoString), ("b" : stdgo.GoString), ("a" : stdgo.GoString), ("r" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("abaabaccadaaae" : stdgo.GoString), _r : ("a*" : stdgo.GoString), _n : (5 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(5, 5, stdgo.Go.str()?.__copy__(), ("b" : stdgo.GoString), ("b" : stdgo.GoString), ("c" : stdgo.GoString), ("cadaaae" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : (":x:y:z:" : stdgo.GoString), _r : (":" : stdgo.GoString), _n : (-1 : stdgo.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(5, 5, stdgo.Go.str()?.__copy__(), ("x" : stdgo.GoString), ("y" : stdgo.GoString), ("z" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>) } : T__struct_0)) : stdgo.Slice<T__struct_0>);
var _compileBenchData : stdgo.Slice<T__struct_2> = (new stdgo.Slice<T__struct_2>(3, 3, ({ _name : ("Onepass" : stdgo.GoString), _re : ("^a.[l-nA-Cg-j]?e$" : stdgo.GoString) } : T__struct_2), ({ _name : ("Medium" : stdgo.GoString), _re : ("^((a|b|[d-z0-9])*(日){4,5}.)+$" : stdgo.GoString) } : T__struct_2), ({ _name : ("Hard" : stdgo.GoString), _re : stdgo._internal.strings.Strings.repeat(("((abc)*|" : stdgo.GoString), (50 : stdgo.GoInt)) + stdgo._internal.strings.Strings.repeat((")" : stdgo.GoString), (50 : stdgo.GoInt))?.__copy__()?.__copy__() } : T__struct_2)) : stdgo.Slice<T__struct_2>);
...
({ regexp : ("日" : stdgo.GoString), _min : (3 : stdgo.GoInt) } : T__struct_3)) : stdgo.Slice<T__struct_3>);
...
var _benchSizes : stdgo.Slice<T__struct_4> = (new stdgo.Slice<T__struct_4>(6, 6, ({ _name : ("16" : stdgo.GoString), _n : (16 : stdgo.GoInt) } : T__struct_4), ({ _name : ("32" : stdgo.GoString), _n : (32 : stdgo.GoInt) } : T__struct_4), ({ _name : ("1K" : stdgo.GoString), _n : (1024 : stdgo.GoInt) } : T__struct_4), ({ _name : ("32K" : stdgo.GoString), _n : (32768 : stdgo.GoInt) } : T__struct_4), ({ _name : ("1M" : stdgo.GoString), _n : (1048576 : stdgo.GoInt) } : T__struct_4), ({ _name : ("32M" : stdgo.GoString), _n : (33554432 : stdgo.GoInt) } : T__struct_4)) : stdgo.Slice<T__struct_4>);
var _findTests : stdgo.Slice<stdgo._internal.regexp.Regexp.FindTest> = (new stdgo.Slice<stdgo._internal.regexp.Regexp.FindTest>(
85,
85,
...
(35 : stdgo.GoInt),
(35 : stdgo.GoInt),
(36 : stdgo.GoInt))) : stdgo._internal.regexp.Regexp.FindTest)) : stdgo.Slice<stdgo._internal.regexp.Regexp.FindTest>);
var _runeMergeTests : stdgo.Slice<T__struct_5> = (new stdgo.Slice<T__struct_5>(
13,
13,
({ _left : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (69 : stdgo.GoInt32), (69 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _right : (new stdgo.Slice<stdgo.GoInt32>(0, 0) : stdgo.Slice<stdgo.GoInt32>), _merged : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (69 : stdgo.GoInt32), (69 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _next : (new stdgo.Slice<stdgo.GoUInt32>(1, 1, (1u32 : stdgo.GoUInt32)) : stdgo.Slice<stdgo.GoUInt32>), _leftPC : (1u32 : stdgo.GoUInt32), _rightPC : (2u32 : stdgo.GoUInt32) } : T__struct_5),
({ _left : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (69 : stdgo.GoInt32), (69 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _right : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (69 : stdgo.GoInt32), (69 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _merged : (new stdgo.Slice<stdgo.GoInt32>(0, 0) : stdgo.Slice<stdgo.GoInt32>), _next : (new stdgo.Slice<stdgo.GoUInt32>(1, 1, (-1u32 : stdgo.GoUInt32)) : stdgo.Slice<stdgo.GoUInt32>), _leftPC : (1u32 : stdgo.GoUInt32), _rightPC : (1u32 : stdgo.GoUInt32) } : T__struct_5),
({ _left : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (69 : stdgo.GoInt32), (69 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _right : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (69 : stdgo.GoInt32), (69 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _merged : (new stdgo.Slice<stdgo.GoInt32>(0, 0) : stdgo.Slice<stdgo.GoInt32>), _next : (new stdgo.Slice<stdgo.GoUInt32>(1, 1, (-1u32 : stdgo.GoUInt32)) : stdgo.Slice<stdgo.GoUInt32>), _leftPC : (1u32 : stdgo.GoUInt32), _rightPC : (2u32 : stdgo.GoUInt32) } : T__struct_5),
({ _left : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (69 : stdgo.GoInt32), (69 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _right : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (71 : stdgo.GoInt32), (71 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _merged : (new stdgo.Slice<stdgo.GoInt32>(4, 4, (69 : stdgo.GoInt32), (69 : stdgo.GoInt32), (71 : stdgo.GoInt32), (71 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _next : (new stdgo.Slice<stdgo.GoUInt32>(2, 2, (1u32 : stdgo.GoUInt32), (2u32 : stdgo.GoUInt32)) : stdgo.Slice<stdgo.GoUInt32>), _leftPC : (1u32 : stdgo.GoUInt32), _rightPC : (2u32 : stdgo.GoUInt32) } : T__struct_5),
({ _left : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (71 : stdgo.GoInt32), (71 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _right : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (69 : stdgo.GoInt32), (69 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _merged : (new stdgo.Slice<stdgo.GoInt32>(4, 4, (69 : stdgo.GoInt32), (69 : stdgo.GoInt32), (71 : stdgo.GoInt32), (71 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _next : (new stdgo.Slice<stdgo.GoUInt32>(2, 2, (2u32 : stdgo.GoUInt32), (1u32 : stdgo.GoUInt32)) : stdgo.Slice<stdgo.GoUInt32>), _leftPC : (1u32 : stdgo.GoUInt32), _rightPC : (2u32 : stdgo.GoUInt32) } : T__struct_5),
({ _left : (new stdgo.Slice<stdgo.GoInt32>(6, 6, (60 : stdgo.GoInt32), (60 : stdgo.GoInt32), (71 : stdgo.GoInt32), (71 : stdgo.GoInt32), (101 : stdgo.GoInt32), (101 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _right : (new stdgo.Slice<stdgo.GoInt32>(4, 4, (69 : stdgo.GoInt32), (69 : stdgo.GoInt32), (88 : stdgo.GoInt32), (88 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _merged : (new stdgo.Slice<stdgo.GoInt32>(
10,
10,
(60 : stdgo.GoInt32),
(60 : stdgo.GoInt32),
...
(88 : stdgo.GoInt32),
(101 : stdgo.GoInt32),
(101 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _next : (new stdgo.Slice<stdgo.GoUInt32>(5, 5, (1u32 : stdgo.GoUInt32), (2u32 : stdgo.GoUInt32), (1u32 : stdgo.GoUInt32), (2u32 : stdgo.GoUInt32), (1u32 : stdgo.GoUInt32)) : stdgo.Slice<stdgo.GoUInt32>), _leftPC : (1u32 : stdgo.GoUInt32), _rightPC : (2u32 : stdgo.GoUInt32) } : T__struct_5),
({ _left : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (69 : stdgo.GoInt32), (74 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _right : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (71 : stdgo.GoInt32), (71 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _merged : (new stdgo.Slice<stdgo.GoInt32>(0, 0) : stdgo.Slice<stdgo.GoInt32>), _next : (new stdgo.Slice<stdgo.GoUInt32>(1, 1, (-1u32 : stdgo.GoUInt32)) : stdgo.Slice<stdgo.GoUInt32>), _leftPC : (1u32 : stdgo.GoUInt32), _rightPC : (2u32 : stdgo.GoUInt32) } : T__struct_5),
({ _left : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (69 : stdgo.GoInt32), (74 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _right : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (68 : stdgo.GoInt32), (75 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _merged : (new stdgo.Slice<stdgo.GoInt32>(0, 0) : stdgo.Slice<stdgo.GoInt32>), _next : (new stdgo.Slice<stdgo.GoUInt32>(1, 1, (-1u32 : stdgo.GoUInt32)) : stdgo.Slice<stdgo.GoUInt32>), _leftPC : (1u32 : stdgo.GoUInt32), _rightPC : (2u32 : stdgo.GoUInt32) } : T__struct_5),
({ _left : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (69 : stdgo.GoInt32), (74 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _right : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (74 : stdgo.GoInt32), (75 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _merged : (new stdgo.Slice<stdgo.GoInt32>(0, 0) : stdgo.Slice<stdgo.GoInt32>), _next : (new stdgo.Slice<stdgo.GoUInt32>(1, 1, (-1u32 : stdgo.GoUInt32)) : stdgo.Slice<stdgo.GoUInt32>), _leftPC : (1u32 : stdgo.GoUInt32), _rightPC : (2u32 : stdgo.GoUInt32) } : T__struct_5),
({ _left : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (69 : stdgo.GoInt32), (74 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _right : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (65 : stdgo.GoInt32), (69 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _merged : (new stdgo.Slice<stdgo.GoInt32>(0, 0) : stdgo.Slice<stdgo.GoInt32>), _next : (new stdgo.Slice<stdgo.GoUInt32>(1, 1, (-1u32 : stdgo.GoUInt32)) : stdgo.Slice<stdgo.GoUInt32>), _leftPC : (1u32 : stdgo.GoUInt32), _rightPC : (2u32 : stdgo.GoUInt32) } : T__struct_5),
({ _left : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (69 : stdgo.GoInt32), (74 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _right : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (71 : stdgo.GoInt32), (74 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _merged : (new stdgo.Slice<stdgo.GoInt32>(0, 0) : stdgo.Slice<stdgo.GoInt32>), _next : (new stdgo.Slice<stdgo.GoUInt32>(1, 1, (-1u32 : stdgo.GoUInt32)) : stdgo.Slice<stdgo.GoUInt32>), _leftPC : (1u32 : stdgo.GoUInt32), _rightPC : (2u32 : stdgo.GoUInt32) } : T__struct_5),
({ _left : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (69 : stdgo.GoInt32), (74 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _right : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (65 : stdgo.GoInt32), (71 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _merged : (new stdgo.Slice<stdgo.GoInt32>(0, 0) : stdgo.Slice<stdgo.GoInt32>), _next : (new stdgo.Slice<stdgo.GoUInt32>(1, 1, (-1u32 : stdgo.GoUInt32)) : stdgo.Slice<stdgo.GoUInt32>), _leftPC : (1u32 : stdgo.GoUInt32), _rightPC : (2u32 : stdgo.GoUInt32) } : T__struct_5),
({ _left : (new stdgo.Slice<stdgo.GoInt32>(4, 4, (69 : stdgo.GoInt32), (74 : stdgo.GoInt32), (60 : stdgo.GoInt32), (65 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _right : (new stdgo.Slice<stdgo.GoInt32>(2, 2, (66 : stdgo.GoInt32), (67 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>), _merged : (new stdgo.Slice<stdgo.GoInt32>(0, 0) : stdgo.Slice<stdgo.GoInt32>), _next : (new stdgo.Slice<stdgo.GoUInt32>(1, 1, (-1u32 : stdgo.GoUInt32)) : stdgo.Slice<stdgo.GoUInt32>), _leftPC : (1u32 : stdgo.GoUInt32), _rightPC : (2u32 : stdgo.GoUInt32) } : T__struct_5)) : stdgo.Slice<T__struct_5>);
...
({ _re : ("^l" : stdgo.GoString) + stdgo._internal.strings.Strings.repeat(("o" : stdgo.GoString), (512 : stdgo.GoInt))?.__copy__() + ("ng$" : stdgo.GoString)?.__copy__()?.__copy__(), _isOnePass : true } : T__struct_6)) : stdgo.Slice<T__struct_6>);
...
function _compileTest(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>, _expr:stdgo.GoString, _error:stdgo.GoString):stdgo.Ref<Regexp> {
        ...
        } else if ((_error != stdgo.Go.str()) && !stdgo._internal.strings.Strings.contains(_err.error()?.__copy__(), _error?.__copy__())) {
...
function _matchTest(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>, _test:stdgo.Ref<FindTest>):Void {
        ...
        if (_m != ((_test._matches.length > (0 : stdgo.GoInt)))) {
            _t.errorf(("MatchString failure on %s: %t should be %t" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_test)), stdgo.Go.toInterface(_m), stdgo.Go.toInterface((_test._matches.length) > (0 : stdgo.GoInt)));
        };
        _m = _re.match((_test._text : stdgo.Slice<stdgo.GoByte>));
        if (_m != ((_test._matches.length > (0 : stdgo.GoInt)))) {
            _t.errorf(("Match failure on %s: %t should be %t" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_test)), stdgo.Go.toInterface(_m), stdgo.Go.toInterface((_test._matches.length) > (0 : stdgo.GoInt)));
        };
    }
function testMatch(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        for (__1 => _test in _findTests) {
...
function _copyMatchTest(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>, _test:stdgo.Ref<FindTest>):Void {
        ...
        if (_m1 != (_m2)) {
            _t.errorf(("Copied Regexp match failure on %s: original gave %t; copy gave %t; should be %t" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_test)), stdgo.Go.toInterface(_m1), stdgo.Go.toInterface(_m2), stdgo.Go.toInterface((_test._matches.length) > (0 : stdgo.GoInt)));
        };
    }
...
function testReplaceAllLiteral(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        for (__26 => _tc in _replaceLiteralTests) {
            var __tmp__ = compile(_tc._pattern?.__copy__()), _re:stdgo.Ref<stdgo._internal.regexp.Regexp.Regexp> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                _t.errorf(("Unexpected error compiling %q: %v" : stdgo.GoString), stdgo.Go.toInterface(_tc._pattern), stdgo.Go.toInterface(_err));
                continue;
...
function testReplaceAllFunc(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        for (__1 => _tc in _replaceFuncTests) {
            var __tmp__ = compile(_tc._pattern?.__copy__()), _re:stdgo.Ref<stdgo._internal.regexp.Regexp.Regexp> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                _t.errorf(("Unexpected error compiling %q: %v" : stdgo.GoString), stdgo.Go.toInterface(_tc._pattern), stdgo.Go.toInterface(_err));
                continue;
...
function testLiteralPrefix(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        for (__1 => _tc in (_metaTests.__append__(..._literalPrefixTests.__toArray__()))) {
...
function testSubexp(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        for (__1 => _c in _subexpCases) {
            ...
            if ((_names.length) != ((1 : stdgo.GoInt) + _n)) {
            ...
            if (_c._names != null) {
                {
                    var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                    stdgo.Go.cfor(_i < ((1 : stdgo.GoInt) + _n), _i++, {
            ...
            for (__26 => _subexp in _c._indices) {
...
function testParseAndCompile(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        for (_i => _tc in (new stdgo.Slice<T__struct_1>(2, 2, ({ _reFlags : (212 : stdgo._internal.regexp.syntax.Syntax.Flags), _expMatch : false } : T__struct_1), ({ _reFlags : (196 : stdgo._internal.regexp.syntax.Syntax.Flags), _expMatch : true } : T__struct_1)) : stdgo.Slice<T__struct_1>)) {
...
function testSwitchBacktrack(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _long = new stdgo.Slice<stdgo.GoUInt8>((262145 : stdgo.GoInt).toBasic(), 0).__setNumber32__();
        _re.match(_long);
...
function benchmarkFind(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        ...
        var _s = (("acbb" : stdgo.GoString) + _wantSubs?.__copy__() + ("dd" : stdgo.GoString)?.__copy__() : stdgo.Slice<stdgo.GoByte>);
        _b.startTimer();
        _b.reportAllocs();
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
...
function benchmarkLiteral(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        var _x:stdgo.GoString = stdgo._internal.strings.Strings.repeat(("x" : stdgo.GoString), (50 : stdgo.GoInt)) + ("y" : stdgo.GoString)?.__copy__()?.__copy__();
        _b.stopTimer();
...
function benchmarkMatchClass(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        _b.stopTimer();
        var _x:stdgo.GoString = stdgo._internal.strings.Strings.repeat(("xxxx" : stdgo.GoString), (20 : stdgo.GoInt)) + ("w" : stdgo.GoString)?.__copy__()?.__copy__();
...
function benchmarkMatchClass_InRange(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        _b.stopTimer();
        var _x:stdgo.GoString = stdgo._internal.strings.Strings.repeat(("bbbb" : stdgo.GoString), (20 : stdgo.GoInt)) + ("c" : stdgo.GoString)?.__copy__()?.__copy__();
...
function benchmarkQuoteMetaAll(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        var _specials = new stdgo.Slice<stdgo.GoUInt8>((0 : stdgo.GoInt).toBasic(), 0).__setNumber32__();
        {
            var _i:stdgo.GoUInt8 = ((0 : stdgo.GoUInt8) : stdgo.GoByte);
            stdgo.Go.cfor(_i < (128 : stdgo.GoUInt8), _i++, {
                if (_special(_i)) {
...
function benchmarkCompile(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        for (__1 => _data in _compileBenchData) {
            _b.run(_data._name?.__copy__(), function(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
                _b.reportAllocs();
                {
                    ...
                    stdgo.Go.cfor(_i < _b.n, _i++, {
                        {
                            var __tmp__ = compile(_data._re?.__copy__()), __26:stdgo.Ref<stdgo._internal.regexp.Regexp.Regexp> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                            if (_err != null) {
...
function testMinInputLen(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        for (__1 => _tt in _minInputLenTests) {
            var __tmp__ = stdgo._internal.regexp.syntax.Syntax.parse(_tt.regexp?.__copy__(), (212 : stdgo._internal.regexp.syntax.Syntax.Flags)), _re:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax.Regexp> = __tmp__._0, __2:stdgo.Error = __tmp__._1;
...
function _maxBitStateLen(_prog:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax.Prog>):stdgo.GoInt {
        ...
        return (262144 : stdgo.GoInt) / (_prog.inst.length);
    }
function _shouldBacktrack(_prog:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax.Prog>):Bool {
        return (_prog.inst.length) <= (500 : stdgo.GoInt);
    }
function _newLazyFlag(_r1:stdgo.GoRune, _r2:stdgo.GoRune):T_lazyFlag {
        return (((_r1 : stdgo.GoUInt64) << (32i64 : stdgo.GoUInt64)) | ((_r2 : stdgo.GoUInt32) : stdgo.GoUInt64) : T_lazyFlag);
    }
            ...
            var __0:stdgo.Slice<stdgo.GoString> = (null : stdgo.Slice<stdgo.GoString>), __1:stdgo.Slice<stdgo.GoString> = (null : stdgo.Slice<stdgo.GoString>), __2:Bool = false, __3:stdgo.Ref<Regexp> = (null : stdgo.Ref<stdgo._internal.regexp.Regexp.Regexp>), __4:stdgo.Ref<Regexp> = (null : stdgo.Ref<stdgo._internal.regexp.Regexp.Regexp>), __5:stdgo.GoInt = (0 : stdgo.GoInt), __6:stdgo.GoInt = (0 : stdgo.GoInt), _ncase:stdgo.GoInt = __6, _nfail:stdgo.GoInt = __5, _refull:stdgo.Ref<Regexp> = __4, _re:stdgo.Ref<Regexp> = __3, _inStrings:Bool = __2, _input:stdgo.Slice<stdgo.GoString> = __1, _str:stdgo.Slice<stdgo.GoString> = __0;
            {
                ...
                stdgo.Go.cfor(_scanner.scan(), _lineno++, {
                    ...
                    if (_line == (stdgo.Go.str())) {
                        ...
                        continue;
                    } else if (((65 : stdgo.GoUInt8) <= _line[(0 : stdgo.GoInt)]) && (_line[(0 : stdgo.GoInt)] <= (90 : stdgo.GoUInt8))) {
                        ...
                        _input = _str;
                    } else if ((_line[(0 : stdgo.GoInt)] == (45 : stdgo.GoUInt8)) || (((48 : stdgo.GoUInt8) <= _line[(0 : stdgo.GoInt)]) && (_line[(0 : stdgo.GoInt)] <= (57 : stdgo.GoUInt8)))) {
                        _ncase++;
                        if (_re == null || (_re : Dynamic).__nil__) {
                            continue;
                        };
                        ...
                        if (!_isSingleBytes(_text?.__copy__()) && stdgo._internal.strings.Strings.contains((_re.string() : stdgo.GoString)?.__copy__(), ("\\B" : stdgo.GoString))) {
                            continue;
                        };
...
function _parseResult(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>, _file:stdgo.GoString, _lineno:stdgo.GoInt, _res:stdgo.GoString):stdgo.Slice<stdgo.GoInt> {
        ...
        var _out = new stdgo.Slice<stdgo.GoInt>(((2 : stdgo.GoInt) * _n : stdgo.GoInt).toBasic(), 0).__setNumber32__();
        var _i:stdgo.GoInt = (0 : stdgo.GoInt);
        _n = (0 : stdgo.GoInt);
        {
            var _j:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_j <= (_res.length), _j++, {
                if ((_j == (_res.length)) || (_res[(_j : stdgo.GoInt)] == (32 : stdgo.GoUInt8))) {
                    ...
                    if (_pair == (("-" : stdgo.GoString))) {
                        ...
                        var __tmp__ = stdgo._internal.strings.Strings.cut(_pair?.__copy__(), ("-" : stdgo.GoString)), _loStr:stdgo.GoString = __tmp__._0, _hiStr:stdgo.GoString = __tmp__._1, __1:Bool = __tmp__._2;
        ...
        stdgo._internal.internal.Macro.controlFlow({
            ...
            try {
                ...
                @:label("Reading") while (true) {
                    ...
                    if ((_line[(0 : stdgo.GoInt)] == (35 : stdgo.GoUInt8)) || (_line[(0 : stdgo.GoInt)] == (10 : stdgo.GoUInt8))) {
                        @:jump("Reading") continue;
                    };
                    _line = (_line.__slice__(0, (_line.length) - (1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    ...
                    if ((_field.length) < (4 : stdgo.GoInt)) {
                    ...
                    if (stdgo._internal.strings.Strings.contains(_flag?.__copy__(), ("$" : stdgo.GoString))) {
                        var _f:stdgo.GoString = ("\"" : stdgo.GoString) + _field[(1 : stdgo.GoInt)]?.__copy__() + ("\"" : stdgo.GoString)?.__copy__()?.__copy__();
                        {
                            {
                        ...
                        _f = ("\"" : stdgo.GoString) + _field[(2 : stdgo.GoInt)]?.__copy__() + ("\"" : stdgo.GoString)?.__copy__()?.__copy__();
                        {
                            {
                                var __tmp__ = stdgo._internal.strconv.Strconv.unquote(_f?.__copy__());
                    ...
                    @:label("Testing") for (__73 => _c in _flag) {
                        ...
                        for (__74 => _c in _flag) {
                            {
                                final __value__ = _c;
                                if (__value__ == ((105 : stdgo.GoInt32))) {
                                    _syn = _syn | ((1 : stdgo._internal.regexp.syntax.Syntax.Flags));
                                };
                            };
                        };
                        ...
                        if ((_have.length > (0 : stdgo.GoInt)) != (_match)) {
...
function _parseFowlerResult(_s:stdgo.GoString):{ var _0 : Bool; var _1 : Bool; var _2 : Bool; var _3 : stdgo.Slice<stdgo.GoInt>; } {
        ...
        if (_s == (stdgo.Go.str())) {
            ...
            _matched = false;
            return { _0 : _ok, _1 : _compiled, _2 : _matched, _3 : _pos };
        } else if (((65 : stdgo.GoUInt8) <= _s[(0 : stdgo.GoInt)]) && (_s[(0 : stdgo.GoInt)] <= (90 : stdgo.GoUInt8))) {
            _ok = true;
            _compiled = false;
            return { _0 : _ok, _1 : _compiled, _2 : _matched, _3 : _pos };
        };
        ...
        while (_s != (stdgo.Go.str())) {
            ...
            if ((_x.length) % (2 : stdgo.GoInt) == ((0 : stdgo.GoInt))) {
            ...
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            while ((_i < _s.length) && (_s[(_i : stdgo.GoInt)] != _end)) {
                _i++;
            };
...
function _makeText(_n:stdgo.GoInt):stdgo.Slice<stdgo.GoByte> {
        ...
        for (_i => _ in _text) {
            ...
            if ((_x : stdgo.GoInt32) < (0 : stdgo.GoInt32)) {
                _x = _x ^ ((-2004316433u32 : stdgo.GoUInt32));
            };
            if (_x % (31u32 : stdgo.GoUInt32) == ((0u32 : stdgo.GoUInt32))) {
                _text[(_i : stdgo.GoInt)] = (10 : stdgo.GoUInt8);
            } else {
                _text[(_i : stdgo.GoInt)] = ((_x % (95u32 : stdgo.GoUInt32)) + (32u32 : stdgo.GoUInt32) : stdgo.GoByte);
            };
        };
        return _text;
    }
function benchmarkMatch(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        ...
        for (__1 => _data in _benchData) {
            var _r = mustCompile(_data._re?.__copy__());
            for (__2 => _size in _benchSizes) {
                if ((_isRaceBuilder || stdgo._internal.testing.Testing.short()) && (_size._n > (1024 : stdgo.GoInt))) {
                    continue;
                };
                var _t = _makeText(_size._n);
                _b.run(_data._name + ("/" : stdgo.GoString)?.__copy__() + _size._name?.__copy__()?.__copy__(), function(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
...
function testFind(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        for (__1 => _test in _findTests) {
            ...
            if ((_test._matches.length == (0 : stdgo.GoInt)) && (_result.length == (0 : stdgo.GoInt))) {} else if ((_test._matches == null) && (_result != null)) {
...
function testFindString(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        for (__1 => _test in _findTests) {
            ...
            if ((_test._matches.length == (0 : stdgo.GoInt)) && (_result.length == (0 : stdgo.GoInt))) {} else if ((_test._matches == null) && (_result != stdgo.Go.str())) {
                _t.errorf(("expected no match; got one: %s" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_test)));
...
function _testFindIndex(_test:stdgo.Ref<FindTest>, _result:stdgo.Slice<stdgo.GoInt>, _t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        if ((_test._matches.length == (0 : stdgo.GoInt)) && (_result.length == (0 : stdgo.GoInt))) {} else if ((_test._matches == null) && (_result != null)) {
            ...
            if ((_expect[(0 : stdgo.GoInt)] != _result[(0 : stdgo.GoInt)]) || (_expect[(1 : stdgo.GoInt)] != _result[(1 : stdgo.GoInt)])) {
...
function _testFindAllIndex(_test:stdgo.Ref<FindTest>, _result:stdgo.Slice<stdgo.Slice<stdgo.GoInt>>, _t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        if ((_test._matches == null) && (_result == null)) {} else if ((_test._matches == null) && (_result != null)) {
            ...
            for (_k => _e in _test._matches) {
                if ((_e[(0 : stdgo.GoInt)] != _result[(_k : stdgo.GoInt)][(0 : stdgo.GoInt)]) || (_e[(1 : stdgo.GoInt)] != _result[(_k : stdgo.GoInt)][(1 : stdgo.GoInt)])) {
...
function _testSubmatchBytes(_test:stdgo.Ref<FindTest>, _n:stdgo.GoInt, _submatches:stdgo.Slice<stdgo.GoInt>, _result:stdgo.Slice<stdgo.Slice<stdgo.GoByte>>, _t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        if ((_submatches.length) != (_result.length * (2 : stdgo.GoInt))) {
            _t.errorf(("match %d: expected %d submatches; got %d: %s" : stdgo.GoString), stdgo.Go.toInterface(_n), stdgo.Go.toInterface((_submatches.length) / (2 : stdgo.GoInt)), stdgo.Go.toInterface((_result.length)), stdgo.Go.toInterface(stdgo.Go.asInterface(_test)));
            return;
        };
        {
            var _k:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_k < (_submatches.length), _k = _k + ((2 : stdgo.GoInt)), {
...
function _testSubmatchString(_test:stdgo.Ref<FindTest>, _n:stdgo.GoInt, _submatches:stdgo.Slice<stdgo.GoInt>, _result:stdgo.Slice<stdgo.GoString>, _t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        };
        {
            ...
            stdgo.Go.cfor(_k < (_submatches.length), _k = _k + ((2 : stdgo.GoInt)), {
                ...
                var _expect:stdgo.GoString = (_test._text.__slice__(_submatches[(_k : stdgo.GoInt)], _submatches[(_k + (1 : stdgo.GoInt) : stdgo.GoInt)]) : stdgo.GoString)?.__copy__();
                if (_expect != (_result[(_k / (2 : stdgo.GoInt) : stdgo.GoInt)])) {
...
function _testSubmatchIndices(_test:stdgo.Ref<FindTest>, _n:stdgo.GoInt, _expect:stdgo.Slice<stdgo.GoInt>, _result:stdgo.Slice<stdgo.GoInt>, _t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        if ((_expect.length) != ((_result.length))) {
            _t.errorf(("match %d: expected %d matches; got %d: %s" : stdgo.GoString), stdgo.Go.toInterface(_n), stdgo.Go.toInterface((_expect.length) / (2 : stdgo.GoInt)), stdgo.Go.toInterface((_result.length) / (2 : stdgo.GoInt)), stdgo.Go.toInterface(stdgo.Go.asInterface(_test)));
            return;
        };
...
function _onePassPrefix(_p:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax.Prog>):{ var _0 : stdgo.GoString; var _1 : Bool; var _2 : stdgo.GoUInt32; } {
        ...
        if ((_i.op != (3 : stdgo._internal.regexp.syntax.Syntax.InstOp)) || (((_i.arg : stdgo._internal.regexp.syntax.Syntax.EmptyOp) & (4 : stdgo._internal.regexp.syntax.Syntax.EmptyOp)) == (0 : stdgo._internal.regexp.syntax.Syntax.EmptyOp))) {
        ...
        if ((_iop(_i) != (7 : stdgo._internal.regexp.syntax.Syntax.InstOp)) || (_i.rune.length != (1 : stdgo.GoInt))) {
            return { _0 : stdgo.Go.str()?.__copy__(), _1 : _i.op == ((4 : stdgo._internal.regexp.syntax.Syntax.InstOp)), _2 : (_p.start : stdgo.GoUInt32) };
        };
        var _buf:stdgo._internal.strings.Strings.Builder = ({} : stdgo._internal.strings.Strings.Builder);
        while ((((_iop(_i) == (7 : stdgo._internal.regexp.syntax.Syntax.InstOp)) && (_i.rune.length == (1 : stdgo.GoInt))) && (((_i.arg : stdgo._internal.regexp.syntax.Syntax.Flags) & (1 : stdgo._internal.regexp.syntax.Syntax.Flags)) == (0 : stdgo._internal.regexp.syntax.Syntax.Flags))) && (_i.rune[(0 : stdgo.GoInt)] != (65533 : stdgo.GoInt32))) {
        ...
        if (((_i.op == (3 : stdgo._internal.regexp.syntax.Syntax.InstOp)) && (((_i.arg : stdgo._internal.regexp.syntax.Syntax.EmptyOp) & (8 : stdgo._internal.regexp.syntax.Syntax.EmptyOp)) != (0 : stdgo._internal.regexp.syntax.Syntax.EmptyOp))) && (_p.inst[(_i.out : stdgo.GoInt)].op == (4 : stdgo._internal.regexp.syntax.Syntax.InstOp))) {
            _complete = true;
        };
...
function _newQueue(_size:stdgo.GoInt):stdgo.Ref<T_queueOnePass> {
        ...
        return (stdgo.Go.setRef(({ _sparse : new stdgo.Slice<stdgo.GoUInt32>((_size : stdgo.GoInt).toBasic(), 0).__setNumber32__(), _dense : new stdgo.Slice<stdgo.GoUInt32>((_size : stdgo.GoInt).toBasic(), 0).__setNumber32__() } : stdgo._internal.regexp.Regexp.T_queueOnePass)) : stdgo.Ref<stdgo._internal.regexp.Regexp.T_queueOnePass>);
    }
function _mergeRuneSets(_leftRunes:stdgo.Ref<stdgo.Slice<stdgo.GoRune>>, _rightRunes:stdgo.Ref<stdgo.Slice<stdgo.GoRune>>, _leftPC:stdgo.GoUInt32, _rightPC:stdgo.GoUInt32):{ var _0 : stdgo.Slice<stdgo.GoRune>; var _1 : stdgo.Slice<stdgo.GoUInt32>; } {
        ...
        try {
            ...
            if (((_leftLen & (1 : stdgo.GoInt)) != (0 : stdgo.GoInt)) || ((_rightLen & (1 : stdgo.GoInt)) != (0 : stdgo.GoInt))) {
            ...
            var _merged = new stdgo.Slice<stdgo.GoInt32>((0 : stdgo.GoInt).toBasic(), 0).__setNumber32__();
            var _next = new stdgo.Slice<stdgo.GoUInt32>((0 : stdgo.GoInt).toBasic(), 0).__setNumber32__();
            var _ok:Bool = true;
            __deferstack__.unshift(() -> {
                var a = function():Void {
                    if (!_ok) {
            ...
            var _extend = function(_newLow:stdgo.Pointer<stdgo.GoInt>, _newArray:stdgo.Ref<stdgo.Slice<stdgo.GoRune>>, _pc:stdgo.GoUInt32):Bool {
                if ((_ix > (0 : stdgo.GoInt)) && (((_newArray : stdgo.Slice<stdgo.GoInt32>))[(_newLow.value : stdgo.GoInt)] <= _merged[(_ix : stdgo.GoInt)])) {
                    return false;
                };
                ...
                _newLow.value = _newLow.value + ((2 : stdgo.GoInt));
                _ix = _ix + ((2 : stdgo.GoInt));
            ...
            while ((_lx < _leftLen) || (_rx < _rightLen)) {
                ...
                } else if (((_rightRunes : stdgo.Slice<stdgo.GoInt32>))[(_rx : stdgo.GoInt)] < ((_leftRunes : stdgo.Slice<stdgo.GoInt32>))[(_lx : stdgo.GoInt)]) {
                    _ok = _extend(stdgo.Go.pointer(_rx), _rightRunes, _rightPC);
                } else {
                    _ok = _extend(stdgo.Go.pointer(_lx), _leftRunes, _leftPC);
                };
        ...
        for (_pc => _ in _p.inst) {
            {
                ...
                if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax.InstOp)) || __value__ == ((1 : stdgo._internal.regexp.syntax.Syntax.InstOp))) {
                    ...
                    if (!((_instAlt.inst.op == (0 : stdgo._internal.regexp.syntax.Syntax.InstOp)) || (_instAlt.inst.op == (1 : stdgo._internal.regexp.syntax.Syntax.InstOp)))) {
                        {
                    ...
                    if ((_instOther.inst.op == (0 : stdgo._internal.regexp.syntax.Syntax.InstOp)) || (_instOther.inst.op == (1 : stdgo._internal.regexp.syntax.Syntax.InstOp))) {
                        continue;
                    };
...
function _makeOnePass(_p:stdgo.Ref<T_onePassProg>):stdgo.Ref<T_onePassProg> {
        if ((_p.inst.length) >= (1000 : stdgo.GoInt)) {
            return null;
        };
        var __0:stdgo.Ref<stdgo._internal.regexp.Regexp.T_queueOnePass> = _newQueue((_p.inst.length)), __1:stdgo.Ref<stdgo._internal.regexp.Regexp.T_queueOnePass> = _newQueue((_p.inst.length)), __2:(stdgo.GoUInt32, stdgo.Slice<Bool>) -> Bool = null, __3:stdgo.Slice<stdgo.Slice<stdgo.GoInt32>> = new stdgo.Slice<stdgo.Slice<stdgo.GoInt32>>((_p.inst.length : stdgo.GoInt).toBasic(), 0), _onePassRunes:stdgo.Slice<stdgo.Slice<stdgo.GoInt32>> = __3, _check:(stdgo.GoUInt32, stdgo.Slice<Bool>) -> Bool = __2, _visitQueue:stdgo.Ref<stdgo._internal.regexp.Regexp.T_queueOnePass> = __1, _instQueue:stdgo.Ref<stdgo._internal.regexp.Regexp.T_queueOnePass> = __0;
                ...
                while (__run__) {
                    __run__ = false;
                    {
                        ...
                        if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax.InstOp)) || __value__ == ((1 : stdgo._internal.regexp.syntax.Syntax.InstOp))) {
                            ...
                            if ((_inst.next.length > (0 : stdgo.GoInt)) && (_inst.next[(0 : stdgo.GoInt)] == (-1u32 : stdgo.GoUInt32))) {
                                _ok = false;
                                break;
                            };
                            break;
                            ...
                            if ((_inst.next.length) > (0 : stdgo.GoInt)) {
                                break;
                            };
                            _instQueue._insert(_inst.inst.out);
                            if ((_inst.inst.rune.length) == ((0 : stdgo.GoInt))) {
                                _onePassRunes[(_pc : stdgo.GoInt)] = (new stdgo.Slice<stdgo.GoInt32>(0, 0) : stdgo.Slice<stdgo.GoInt32>);
                                _inst.next = (new stdgo.Slice<stdgo.GoUInt32>(1, 1, _inst.inst.out) : stdgo.Slice<stdgo.GoUInt32>);
                                break;
                            };
                            var _runes = new stdgo.Slice<stdgo.GoInt32>((0 : stdgo.GoInt).toBasic(), 0).__setNumber32__();
                            if ((_inst.inst.rune.length == (1 : stdgo.GoInt)) && (((_inst.inst.arg : stdgo._internal.regexp.syntax.Syntax.Flags) & (1 : stdgo._internal.regexp.syntax.Syntax.Flags)) != (0 : stdgo._internal.regexp.syntax.Syntax.Flags))) {
                            ...
                            _instQueue._insert(_inst.inst.out);
                            var _runes = (new stdgo.Slice<stdgo.GoInt32>(0, 0) : stdgo.Slice<stdgo.GoInt32>);
                            if ((_inst.inst.arg : stdgo._internal.regexp.syntax.Syntax.Flags) & (1 : stdgo._internal.regexp.syntax.Syntax.Flags) != ((0 : stdgo._internal.regexp.syntax.Syntax.Flags))) {
                                var _r0:stdgo.GoInt32 = _inst.inst.rune[(0 : stdgo.GoInt)];
                                _runes = (_runes.__append__(_r0, _r0));
                                {
                                    var _r1:stdgo.GoInt32 = stdgo._internal.unicode.Unicode.simpleFold(_r0);
                            ...
                            _instQueue._insert(_inst.inst.out);
                            _onePassRunes[(_pc : stdgo.GoInt)] = ((new stdgo.Slice<stdgo.GoInt32>(0, 0) : stdgo.Slice<stdgo.GoInt32>).__append__(..._anyRune.__toArray__()));
                            _inst.next = (new stdgo.Slice<stdgo.GoUInt32>(1, 1, _inst.inst.out) : stdgo.Slice<stdgo.GoUInt32>);
                            break;
        ...
        var _m = new stdgo.Slice<Bool>((_p.inst.length : stdgo.GoInt).toBasic(), 0);
...
function _compileOnePass(_prog:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax.Prog>):stdgo.Ref<T_onePassProg> {
        ...
        if ((_prog.inst[(_prog.start : stdgo.GoInt)].op != (3 : stdgo._internal.regexp.syntax.Syntax.InstOp)) || (((_prog.inst[(_prog.start : stdgo.GoInt)].arg : stdgo._internal.regexp.syntax.Syntax.EmptyOp) & (4 : stdgo._internal.regexp.syntax.Syntax.EmptyOp)) != (4 : stdgo._internal.regexp.syntax.Syntax.EmptyOp))) {
            return null;
        };
        for (__1 => _inst in _prog.inst) {
            var _opOut:stdgo._internal.regexp.syntax.Syntax.InstOp = _prog.inst[(_inst.out : stdgo.GoInt)].op;
            {
                ...
                if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax.InstOp)) || __value__ == ((1 : stdgo._internal.regexp.syntax.Syntax.InstOp))) {
                    if ((_opOut == (4 : stdgo._internal.regexp.syntax.Syntax.InstOp)) || (_prog.inst[(_inst.arg : stdgo.GoInt)].op == (4 : stdgo._internal.regexp.syntax.Syntax.InstOp))) {
                        return null;
                    };
                } else if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax.InstOp))) {
                    if (_opOut == ((4 : stdgo._internal.regexp.syntax.Syntax.InstOp))) {
                        if ((_inst.arg : stdgo._internal.regexp.syntax.Syntax.EmptyOp) & (8 : stdgo._internal.regexp.syntax.Syntax.EmptyOp) == ((8 : stdgo._internal.regexp.syntax.Syntax.EmptyOp))) {
                            continue;
                        };
                        return null;
                    };
...
function testCompileOnePass(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        for (__1 => _test in _onePassTests) {
            {
                {
...
function testRunOnePass(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        for (__1 => _test in _onePassTests1) {
...
function _compile(_expr:stdgo.GoString, _mode:stdgo._internal.regexp.syntax.Syntax.Flags, _longest:Bool):{ var _0 : stdgo.Ref<Regexp>; var _1 : stdgo.Error; } {
        ...
        var _i:stdgo.GoInt = (0 : stdgo.GoInt);
        while ((_matchSize[(_i : stdgo.GoInt)] != (0 : stdgo.GoInt)) && (_matchSize[(_i : stdgo.GoInt)] < _n)) {
            _i++;
        };
        _regexp._mpool = _i;
            ...
            if (__value__ == ((6 : stdgo._internal.regexp.syntax.Syntax.Op)) || __value__ == ((5 : stdgo._internal.regexp.syntax.Syntax.Op)) || __value__ == ((4 : stdgo._internal.regexp.syntax.Syntax.Op))) {
                ...
                for (__1 => _r in _re.rune) {
                    if (_r == ((65533 : stdgo.GoInt32))) {
                        ...
                        _l = _l + (stdgo._internal.unicode.utf8.Utf8.runeLen(_r));
                    };
                };
                return _l;
                ...
                return _re.min * _minInputLen(_re.sub[(0 : stdgo.GoInt)]);
                ...
                for (__3 => _sub in (_re.sub.__slice__((1 : stdgo.GoInt)) : stdgo.Slice<stdgo.Ref<stdgo._internal.regexp.syntax.Syntax.Regexp>>)) {
...
function _special(_b:stdgo.GoByte):Bool {
        return (_b < (128 : stdgo.GoUInt8)) && ((_specialBytes[(_b % (16 : stdgo.GoUInt8) : stdgo.GoInt)] & ((1 : stdgo.GoUInt8) << (_b / (16 : stdgo.GoUInt8)))) != (0 : stdgo.GoUInt8));
    }
function quoteMeta(_s:stdgo.GoString):stdgo.GoString {
        ...
        var _b = new stdgo.Slice<stdgo.GoUInt8>((((2 : stdgo.GoInt) * _s.length) - _i : stdgo.GoInt).toBasic(), 0).__setNumber32__();
...
function _extract(_str:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : stdgo.GoInt; var _2 : stdgo.GoString; var _3 : Bool; } {
        ...
        while (_i < (_str.length)) {
            ...
            if ((!stdgo._internal.unicode.Unicode.isLetter(_rune) && !stdgo._internal.unicode.Unicode.isDigit(_rune)) && (_rune != (95 : stdgo.GoInt32))) {
                break;
            };
            _i = _i + (_size);
        };
        ...
        if (_brace) {
            if ((_i >= _str.length) || (_str[(_i : stdgo.GoInt)] != (125 : stdgo.GoUInt8))) {
                return { _0 : _name, _1 : _num, _2 : _rest, _3 : _ok };
            };
            _i++;
        };
        _num = (0 : stdgo.GoInt);
        {
            ...
            stdgo.Go.cfor(_i < (_name.length), _i++, {
                if (((_name[(_i : stdgo.GoInt)] < (48 : stdgo.GoUInt8)) || ((57 : stdgo.GoUInt8) < _name[(_i : stdgo.GoInt)])) || (_num >= (100000000 : stdgo.GoInt))) {
                    _num = (-1 : stdgo.GoInt);
                    break;
                };
                _num = ((_num * (10 : stdgo.GoInt)) + (_name[(_i : stdgo.GoInt)] : stdgo.GoInt)) - (48 : stdgo.GoInt);
            });
        };
        if ((_name[(0 : stdgo.GoInt)] == (48 : stdgo.GoUInt8)) && (_name.length > (1 : stdgo.GoInt))) {
            _num = (-1 : stdgo.GoInt);
        };
...
@:keep var _ = {
        try {
            for (__1 => _b in (("\\.+*?()|[]{}^$" : stdgo.GoString) : stdgo.Slice<stdgo.GoByte>)) {
                _specialBytes[(_b % (16 : stdgo.GoUInt8) : stdgo.GoInt)] = _specialBytes[(_b % (16 : stdgo.GoUInt8) : stdgo.GoInt)] | ((1 : stdgo.GoUInt8) << (_b / (16 : stdgo.GoUInt8)));
            };
...
@:keep @:allow(stdgo._internal.regexp.Regexp.T_bitState_asInterface) class T_bitState_static_extension {
    ...
    static public function _push( _b:stdgo.Ref<T_bitState>, _re:stdgo.Ref<Regexp>, _pc:stdgo.GoUInt32, _pos:stdgo.GoInt, _arg:Bool):Void {
        ...
        if ((_re._prog.inst[(_pc : stdgo.GoInt)].op != (5 : stdgo._internal.regexp.syntax.Syntax.InstOp)) && (_arg || _b._shouldVisit(_pc, _pos))) {
    ...
    static public function _shouldVisit( _b:stdgo.Ref<T_bitState>, _pc:stdgo.GoUInt32, _pos:stdgo.GoInt):Bool {
        @:recv var _b:stdgo.Ref<T_bitState> = _b;
        var _n:stdgo.GoUInt = (((_pc : stdgo.GoInt) * (_b._end + (1 : stdgo.GoInt))) + _pos : stdgo.GoUInt);
        if (_b._visited[(_n / (32u32 : stdgo.GoUInt) : stdgo.GoInt)] & ((1u32 : stdgo.GoUInt32) << (_n & (31u32 : stdgo.GoUInt))) != ((0u32 : stdgo.GoUInt32))) {
            return false;
        };
        _b._visited[(_n / (32u32 : stdgo.GoUInt) : stdgo.GoInt)] = _b._visited[(_n / (32u32 : stdgo.GoUInt) : stdgo.GoInt)] | ((1u32 : stdgo.GoUInt32) << (_n & (31u32 : stdgo.GoUInt)));
        return true;
    }
    @:keep
    static public function _reset( _b:stdgo.Ref<T_bitState>, _prog:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax.Prog>, _end:stdgo.GoInt, _ncap:stdgo.GoInt):Void {
        ...
        if (_b._jobs.capacity == ((0 : stdgo.GoInt))) {
            _b._jobs = new stdgo.Slice<stdgo._internal.regexp.Regexp.T_job>((0 : stdgo.GoInt).toBasic(), (256 : stdgo.GoInt), ...[for (i in 0 ... ((0 : stdgo.GoInt).toBasic() > (256 : stdgo.GoInt) ? (0 : stdgo.GoInt).toBasic() : (256 : stdgo.GoInt) : stdgo.GoInt).toBasic()) ({} : stdgo._internal.regexp.Regexp.T_job)]);
        } else {
            _b._jobs = (_b._jobs.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.regexp.Regexp.T_job>);
        };
        var _visitedSize:stdgo.GoInt = (((_prog.inst.length * (_end + (1 : stdgo.GoInt))) + (32 : stdgo.GoInt)) - (1 : stdgo.GoInt)) / (32 : stdgo.GoInt);
        ...
        if (_b._cap.capacity < _ncap) {
            _b._cap = new stdgo.Slice<stdgo.GoInt>((_ncap : stdgo.GoInt).toBasic(), 0).__setNumber32__();
        } else {
        ...
        if (_b._matchcap.capacity < _ncap) {
            _b._matchcap = new stdgo.Slice<stdgo.GoInt>((_ncap : stdgo.GoInt).toBasic(), 0).__setNumber32__();
        } else {
    ...
    static public function _add( _m:stdgo.Ref<T_machine>, _q:stdgo.Ref<T_queue>, _pc:stdgo.GoUInt32, _pos:stdgo.GoInt, _cap:stdgo.Slice<stdgo.GoInt>, _cond:stdgo.Pointer<T_lazyFlag>, _t:stdgo.Ref<T_thread>):stdgo.Ref<T_thread> {
        stdgo._internal.internal.Macro.controlFlow({
            ...
            };
            {
                ...
                if ((_j < (_q._dense.length : stdgo.GoUInt32)) && (_q._dense[(_j : stdgo.GoInt)]._pc == _pc)) {
                    return _t;
                };
            };
            var _j:stdgo.GoInt = (_q._dense.length);
            _q._dense = (_q._dense.__slice__(0, _j + (1 : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.regexp.Regexp.T_entry>);
            ...
            var _i = (stdgo.Go.setRef(_m._p.inst[(_pc : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax.Inst>);
            {
                ...
                if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax.InstOp))) {} else if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax.InstOp)) || __value__ == ((1 : stdgo._internal.regexp.syntax.Syntax.InstOp))) {
                    ...
                    if ((_i.arg : stdgo.GoInt) < (_cap.length)) {
                    ...
                    if ((_cap.length > (0 : stdgo.GoInt)) && (stdgo.Go.pointer(_t._cap[(0 : stdgo.GoInt)]) != stdgo.Go.pointer(_cap[(0 : stdgo.GoInt)]))) {
    ...
    static public function _step( _m:stdgo.Ref<T_machine>, _runq:stdgo.Ref<T_queue>, _nextq:stdgo.Ref<T_queue>, _pos:stdgo.GoInt, _nextPos:stdgo.GoInt, _c:stdgo.GoRune, _nextCond:stdgo.Pointer<T_lazyFlag>):Void {
        ...
        var _longest:Bool = _m._re._longest;
        {
            ...
            stdgo.Go.cfor(_j < (_runq._dense.length), _j++, {
                ...
                if (((_longest && _m._matched) && (_t._cap.length > (0 : stdgo.GoInt))) && (_m._matchcap[(0 : stdgo.GoInt)] < _t._cap[(0 : stdgo.GoInt)])) {
                ...
                var _add:Bool = false;
                {
                    ...
                    if (__value__ == ((4 : stdgo._internal.regexp.syntax.Syntax.InstOp))) {
                        if ((_t._cap.length > (0 : stdgo.GoInt)) && ((!_longest || !_m._matched) || (_m._matchcap[(1 : stdgo.GoInt)] < _pos))) {
                            _t._cap[(1 : stdgo.GoInt)] = _pos;
                            stdgo.Go.copySlice(_m._matchcap, _t._cap);
                        };
                        if (!_longest) {
                            for (__1 => _d in (_runq._dense.__slice__(_j + (1 : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.regexp.Regexp.T_entry>)) {
    ...
    static public function _match( _m:stdgo.Ref<T_machine>, _i:T_input, _pos:stdgo.GoInt):Bool {
        ...
        while (true) {
            if ((_runq._dense.length) == ((0 : stdgo.GoInt))) {
                if (((_startCond & (4 : stdgo._internal.regexp.syntax.Syntax.EmptyOp)) != (0 : stdgo._internal.regexp.syntax.Syntax.EmptyOp)) && (_pos != (0 : stdgo.GoInt))) {
                    break;
                };
                if (_m._matched) {
                    break;
                };
                if (((_m._re._prefix.length > (0 : stdgo.GoInt)) && (_r1 != _m._re._prefixRune)) && _i._canCheckPrefix()) {
                    var _advance:stdgo.GoInt = _i._index(_m._re, _pos);
                    if (_advance < (0 : stdgo.GoInt)) {
                        break;
                    };
                    _pos = _pos + (_advance);
                    {
            ...
            if (!_m._matched) {
                if ((_m._matchcap.length) > (0 : stdgo.GoInt)) {
            ...
            if ((_m._matchcap.length == (0 : stdgo.GoInt)) && _m._matched) {
                break;
            };
            _pos = _pos + (_width);
            {
    ...
    static public function _alloc( _m:stdgo.Ref<T_machine>, _i:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax.Inst>):stdgo.Ref<T_thread> {
        ...
        var _t:stdgo.Ref<T_thread> = (null : stdgo.Ref<stdgo._internal.regexp.Regexp.T_thread>);
        {
            ...
            if (_n > (0 : stdgo.GoInt)) {
                ...
                _m._pool = (_m._pool.__slice__(0, _n - (1 : stdgo.GoInt)) : stdgo.Slice<stdgo.Ref<stdgo._internal.regexp.Regexp.T_thread>>);
            } else {
                _t = (stdgo.Go.setRef(({} : stdgo._internal.regexp.Regexp.T_thread)) : stdgo.Ref<stdgo._internal.regexp.Regexp.T_thread>);
                _t._cap = new stdgo.Slice<stdgo.GoInt>((_m._matchcap.length : stdgo.GoInt).toBasic(), _m._matchcap.capacity).__setNumber32__();
            };
        };
        _t._inst = _i;
        return _t;
...
@:keep @:allow(stdgo._internal.regexp.Regexp.T_queueOnePass_asInterface) class T_queueOnePass_static_extension {
    ...
    static public function _insertNew( _q:stdgo.Ref<T_queueOnePass>, _u:stdgo.GoUInt32):Void {
        ...
        if (_u >= (_q._sparse.length : stdgo.GoUInt32)) {
            return;
        };
    ...
    static public function _contains( _q:stdgo.Ref<T_queueOnePass>, _u:stdgo.GoUInt32):Bool {
        ...
        return (_q._sparse[(_u : stdgo.GoInt)] < _q._size) && (_q._dense[(_q._sparse[(_u : stdgo.GoInt)] : stdgo.GoInt)] == _u);
    }
    @:keep
...
@:keep @:allow(stdgo._internal.regexp.Regexp.Regexp_asInterface) class Regexp_static_extension {
    ...
    static public function split( _re:stdgo.Ref<Regexp>, _s:stdgo.GoString, _n:stdgo.GoInt):stdgo.Slice<stdgo.GoString> {
        ...
        if ((_re._expr.length > (0 : stdgo.GoInt)) && (_s.length == (0 : stdgo.GoInt))) {
        ...
        var _strings = new stdgo.Slice<stdgo.GoString>((0 : stdgo.GoInt).toBasic(), (_matches.length)).__setString__();
        var _beg:stdgo.GoInt = (0 : stdgo.GoInt);
        var _end:stdgo.GoInt = (0 : stdgo.GoInt);
        for (__1 => _match in _matches) {
            if ((_n > (0 : stdgo.GoInt)) && (_strings.length >= (_n - (1 : stdgo.GoInt)))) {
                break;
            };
    ...
    static public function findAllStringSubmatchIndex( _re:stdgo.Ref<Regexp>, _s:stdgo.GoString, _n:stdgo.GoInt):stdgo.Slice<stdgo.Slice<stdgo.GoInt>> {
        ...
        _re._allMatches(_s?.__copy__(), (null : stdgo.Slice<stdgo.GoUInt8>), _n, function(_match:stdgo.Slice<stdgo.GoInt>):Void {
            if (_result == null) {
                _result = new stdgo.Slice<stdgo.Slice<stdgo.GoInt>>((0 : stdgo.GoInt).toBasic(), (10 : stdgo.GoInt));
            };
    ...
    static public function findAll( _re:stdgo.Ref<Regexp>, _b:stdgo.Slice<stdgo.GoByte>, _n:stdgo.GoInt):stdgo.Slice<stdgo.Slice<stdgo.GoByte>> {
        ...
        _re._allMatches(stdgo.Go.str()?.__copy__(), _b, _n, function(_match:stdgo.Slice<stdgo.GoInt>):Void {
            if (_result == null) {
                _result = new stdgo.Slice<stdgo.Slice<stdgo.GoUInt8>>((0 : stdgo.GoInt).toBasic(), (10 : stdgo.GoInt));
            };
    ...
    static public function findStringSubmatch( _re:stdgo.Ref<Regexp>, _s:stdgo.GoString):stdgo.Slice<stdgo.GoString> {
        @:recv var _re:stdgo.Ref<Regexp> = _re;
        var _dstCap:stdgo.GoArray<stdgo.GoInt> = new stdgo.GoArray<stdgo.GoInt>(...[for (i in 0 ... 4) (0 : stdgo.GoInt)]);
    ...
    static public function _expand( _re:stdgo.Ref<Regexp>, _dst:stdgo.Slice<stdgo.GoByte>, _template:stdgo.GoString, _bsrc:stdgo.Slice<stdgo.GoByte>, _src:stdgo.GoString, _match:stdgo.Slice<stdgo.GoInt>):stdgo.Slice<stdgo.GoByte> {
        @:recv var _re:stdgo.Ref<Regexp> = _re;
        while ((_template.length) > (0 : stdgo.GoInt)) {
            ...
            if ((_template != stdgo.Go.str()) && (_template[(0 : stdgo.GoInt)] == (36 : stdgo.GoUInt8))) {
            ...
            if (_num >= (0 : stdgo.GoInt)) {
                if (((((2 : stdgo.GoInt) * _num) + (1 : stdgo.GoInt)) < _match.length) && (_match[((2 : stdgo.GoInt) * _num : stdgo.GoInt)] >= (0 : stdgo.GoInt))) {
                    if (_bsrc != null) {
                        _dst = (_dst.__append__(...(_bsrc.__slice__(_match[((2 : stdgo.GoInt) * _num : stdgo.GoInt)], _match[(((2 : stdgo.GoInt) * _num) + (1 : stdgo.GoInt) : stdgo.GoInt)]) : stdgo.Slice<stdgo.GoUInt8>).__toArray__()));
                    } else {
                        _dst = (_dst.__append__(...(_src.__slice__(_match[((2 : stdgo.GoInt) * _num : stdgo.GoInt)], _match[(((2 : stdgo.GoInt) * _num) + (1 : stdgo.GoInt) : stdgo.GoInt)]) : stdgo.GoString).__toArray__()));
                    };
                };
            } else {
                for (_i => _namei in _re._subexpNames) {
                    if (((_name == _namei) && ((((2 : stdgo.GoInt) * _i) + (1 : stdgo.GoInt)) < _match.length)) && (_match[((2 : stdgo.GoInt) * _i : stdgo.GoInt)] >= (0 : stdgo.GoInt))) {
                        if (_bsrc != null) {
                            _dst = (_dst.__append__(...(_bsrc.__slice__(_match[((2 : stdgo.GoInt) * _i : stdgo.GoInt)], _match[(((2 : stdgo.GoInt) * _i) + (1 : stdgo.GoInt) : stdgo.GoInt)]) : stdgo.Slice<stdgo.GoUInt8>).__toArray__()));
                        } else {
                            _dst = (_dst.__append__(...(_src.__slice__(_match[((2 : stdgo.GoInt) * _i : stdgo.GoInt)], _match[(((2 : stdgo.GoInt) * _i) + (1 : stdgo.GoInt) : stdgo.GoInt)]) : stdgo.GoString).__toArray__()));
                        };
                        break;
                    };
                };
    ...
    static public function findString( _re:stdgo.Ref<Regexp>, _s:stdgo.GoString):stdgo.GoString {
        @:recv var _re:stdgo.Ref<Regexp> = _re;
        var _dstCap:stdgo.GoArray<stdgo.GoInt> = new stdgo.GoArray<stdgo.GoInt>(...[for (i in 0 ... 2) (0 : stdgo.GoInt)]);
    ...
    static public function _pad( _re:stdgo.Ref<Regexp>, _a:stdgo.Slice<stdgo.GoInt>):stdgo.Slice<stdgo.GoInt> {
        ...
        var _n:stdgo.GoInt = ((1 : stdgo.GoInt) + _re._numSubexp) * (2 : stdgo.GoInt);
        while ((_a.length) < _n) {
    ...
    static public function replaceAllFunc( _re:stdgo.Ref<Regexp>, _src:stdgo.Slice<stdgo.GoByte>, _repl:stdgo.Slice<stdgo.GoByte> -> stdgo.Slice<stdgo.GoByte>):stdgo.Slice<stdgo.GoByte> {
        ...
        return _re._replaceAll(_src, stdgo.Go.str()?.__copy__(), (2 : stdgo.GoInt), function(_dst:stdgo.Slice<stdgo.GoByte>, _match:stdgo.Slice<stdgo.GoInt>):stdgo.Slice<stdgo.GoByte> {
            return (_dst.__append__(..._repl((_src.__slice__(_match[(0 : stdgo.GoInt)], _match[(1 : stdgo.GoInt)]) : stdgo.Slice<stdgo.GoUInt8>)).__toArray__()));
        });
    }
    @:keep
    ...
    static public function replaceAll( _re:stdgo.Ref<Regexp>, _src:stdgo.Slice<stdgo.GoByte>, _repl:stdgo.Slice<stdgo.GoByte>):stdgo.Slice<stdgo.GoByte> {
        ...
        if (stdgo._internal.bytes.Bytes.indexByte(_repl, (36 : stdgo.GoUInt8)) >= (0 : stdgo.GoInt)) {
            _n = (2 : stdgo.GoInt) * (_re._numSubexp + (1 : stdgo.GoInt));
        };
    ...
    static public function _replaceAll( _re:stdgo.Ref<Regexp>, _bsrc:stdgo.Slice<stdgo.GoByte>, _src:stdgo.GoString, _nmatch:stdgo.GoInt, _repl:(_dst:stdgo.Slice<stdgo.GoByte>, _m:stdgo.Slice<stdgo.GoInt>) -> stdgo.Slice<stdgo.GoByte>):stdgo.Slice<stdgo.GoByte> {
        ...
        while (_searchPos <= _endPos) {
            ...
            if (_bsrc != null) {
                _buf = (_buf.__append__(...(_bsrc.__slice__(_lastMatchEnd, _a[(0 : stdgo.GoInt)]) : stdgo.Slice<stdgo.GoUInt8>).__toArray__()));
            } else {
                _buf = (_buf.__append__(...(_src.__slice__(_lastMatchEnd, _a[(0 : stdgo.GoInt)]) : stdgo.GoString).__toArray__()));
            };
            if ((_a[(1 : stdgo.GoInt)] > _lastMatchEnd) || (_a[(0 : stdgo.GoInt)] == (0 : stdgo.GoInt))) {
                _buf = _repl(_buf, _a);
            };
            ...
            if ((_searchPos + _width) > _a[(1 : stdgo.GoInt)]) {
                _searchPos = _searchPos + (_width);
            } else if ((_searchPos + (1 : stdgo.GoInt)) > _a[(1 : stdgo.GoInt)]) {
                _searchPos++;
            } else {
        ...
        if (_bsrc != null) {
            _buf = (_buf.__append__(...(_bsrc.__slice__(_lastMatchEnd) : stdgo.Slice<stdgo.GoUInt8>).__toArray__()));
        } else {
    ...
    static public function replaceAllStringFunc( _re:stdgo.Ref<Regexp>, _src:stdgo.GoString, _repl:stdgo.GoString -> stdgo.GoString):stdgo.GoString {
        ...
        var _b = _re._replaceAll((null : stdgo.Slice<stdgo.GoUInt8>), _src?.__copy__(), (2 : stdgo.GoInt), function(_dst:stdgo.Slice<stdgo.GoByte>, _match:stdgo.Slice<stdgo.GoInt>):stdgo.Slice<stdgo.GoByte> {
            return (_dst.__append__(..._repl((_src.__slice__(_match[(0 : stdgo.GoInt)], _match[(1 : stdgo.GoInt)]) : stdgo.GoString)?.__copy__()).__toArray__()));
        });
    ...
    static public function _get( _re:stdgo.Ref<Regexp>):stdgo.Ref<T_machine> {
        ...
        if (_m._matchcap.capacity < _re._matchcap) {
            _m._matchcap = new stdgo.Slice<stdgo.GoInt>((_re._matchcap : stdgo.GoInt).toBasic(), 0).__setNumber32__();
            for (__1 => _t in _m._pool) {
                _t._cap = new stdgo.Slice<stdgo.GoInt>((_re._matchcap : stdgo.GoInt).toBasic(), 0).__setNumber32__();
            };
        };
        ...
        if ((_m._q0._sparse.length) < _n) {
            _m._q0 = (new stdgo._internal.regexp.Regexp.T_queue(new stdgo.Slice<stdgo.GoUInt32>((_n : stdgo.GoInt).toBasic(), 0).__setNumber32__(), new stdgo.Slice<stdgo._internal.regexp.Regexp.T_entry>((0 : stdgo.GoInt).toBasic(), _n, ...[for (i in 0 ... ((0 : stdgo.GoInt).toBasic() > _n ? (0 : stdgo.GoInt).toBasic() : _n : stdgo.GoInt).toBasic()) ({} : stdgo._internal.regexp.Regexp.T_entry)])) : stdgo._internal.regexp.Regexp.T_queue);
            _m._q1 = (new stdgo._internal.regexp.Regexp.T_queue(new stdgo.Slice<stdgo.GoUInt32>((_n : stdgo.GoInt).toBasic(), 0).__setNumber32__(), new stdgo.Slice<stdgo._internal.regexp.Regexp.T_entry>((0 : stdgo.GoInt).toBasic(), _n, ...[for (i in 0 ... ((0 : stdgo.GoInt).toBasic() > _n ? (0 : stdgo.GoInt).toBasic() : _n : stdgo.GoInt).toBasic()) ({} : stdgo._internal.regexp.Regexp.T_entry)])) : stdgo._internal.regexp.Regexp.T_queue);
        };
        return _m;
    }
    @:keep
    ...
    static public function _doExecute( _re:stdgo.Ref<Regexp>, _r:stdgo._internal.io.Io.RuneReader, _b:stdgo.Slice<stdgo.GoByte>, _s:stdgo.GoString, _pos:stdgo.GoInt, _ncap:stdgo.GoInt, _dstCap:stdgo.Slice<stdgo.GoInt>):stdgo.Slice<stdgo.GoInt> {
        ...
        var _m = _re._get();
        var __tmp__ = _m._inputs._init(_r, _b, _s?.__copy__()), _i:stdgo._internal.regexp.Regexp.T_input = __tmp__._0, __1:stdgo.GoInt = __tmp__._1;
        _m._init(_ncap);
    ...
    static public function _doOnePass( _re:stdgo.Ref<Regexp>, _ir:stdgo._internal.io.Io.RuneReader, _ib:stdgo.Slice<stdgo.GoByte>, _is:stdgo.GoString, _pos:stdgo.GoInt, _ncap:stdgo.GoInt, _dstCap:stdgo.Slice<stdgo.GoInt>):stdgo.Slice<stdgo.GoInt> {
        stdgo._internal.internal.Macro.controlFlow({
            ...
            if (_m._matchcap.capacity < _ncap) {
                _m._matchcap = new stdgo.Slice<stdgo.GoInt>((_ncap : stdgo.GoInt).toBasic(), 0).__setNumber32__();
            } else {
                _m._matchcap = (_m._matchcap.__slice__(0, _ncap) : stdgo.Slice<stdgo.GoInt>);
            };
            ...
            var __tmp__ = _m._inputs._init(_ir, _ib, _is?.__copy__()), _i:stdgo._internal.regexp.Regexp.T_input = __tmp__._0, __1:stdgo.GoInt = __tmp__._1;
            var __0:stdgo.GoInt32 = (-1 : stdgo.GoInt32), __1:stdgo.GoInt32 = (-1 : stdgo.GoInt32), _r1:stdgo.GoInt32 = __1, _r:stdgo.GoInt32 = __0;
            var __0:stdgo.GoInt = (0 : stdgo.GoInt), __1:stdgo.GoInt = (0 : stdgo.GoInt), _width1:stdgo.GoInt = __1, _width:stdgo.GoInt = __0;
            {
                var __tmp__ = _i._step(_pos);
            ...
            if ((((_pos == (0 : stdgo.GoInt)) && _flag._match((_inst.inst.arg : stdgo._internal.regexp.syntax.Syntax.EmptyOp))) && (_re._prefix.length > (0 : stdgo.GoInt))) && _i._canCheckPrefix()) {
            ...
            while (true) {
                ...
                _pc = (_inst.inst.out : stdgo.GoInt);
                {
                    ...
                    if (__value__ == ((4 : stdgo._internal.regexp.syntax.Syntax.InstOp))) {
                        ...
                        if ((_inst.inst.arg : stdgo.GoInt) < (_m._matchcap.length)) {
    ...
    static public function _backtrack( _re:stdgo.Ref<Regexp>, _ib:stdgo.Slice<stdgo.GoByte>, _is:stdgo.GoString, _pos:stdgo.GoInt, _ncap:stdgo.GoInt, _dstCap:stdgo.Slice<stdgo.GoInt>):stdgo.Slice<stdgo.GoInt> {
        stdgo._internal.internal.Macro.controlFlow({
            ...
            if (_startCond & (4 : stdgo._internal.regexp.syntax.Syntax.EmptyOp) != ((0 : stdgo._internal.regexp.syntax.Syntax.EmptyOp))) {
                ...
                stdgo.Go.cfor((_pos <= _end) && (_width != (0 : stdgo.GoInt)), _pos = _pos + (_width), {
                    if ((_re._prefix.length) > (0 : stdgo.GoInt)) {
    ...
    static public function _tryBacktrack( _re:stdgo.Ref<Regexp>, _b:stdgo.Ref<T_bitState>, _i:T_input, _pc:stdgo.GoUInt32, _pos:stdgo.GoInt):Bool {
        stdgo._internal.internal.Macro.controlFlow({
            ...
            while ((_b._jobs.length) > (0 : stdgo.GoInt)) {
                var _l:stdgo.GoInt = (_b._jobs.length) - (1 : stdgo.GoInt);
                ...
                @:label("Skip") var _inst = (stdgo.Go.setRef(_re._prog.inst[(_pc : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax.Inst>);
                {
                    ...
                    if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax.InstOp))) {
                        ...
                        var __tmp__ = _i._step(_pos), _r:stdgo.GoInt32 = __tmp__._0, _width:stdgo.GoInt = __tmp__._1;
                        if ((_r == (10 : stdgo.GoInt32)) || (_r == (-1 : stdgo.GoInt32))) {
                            continue;
                        };
                        _pos = _pos + (_width);
                        _pc = _inst.out;
                        ...
                        if (_arg) {
                            ...
                            if (_inst.arg < (_b._cap.length : stdgo.GoUInt32)) {
                        ...
                        if ((_b._cap.length) > (1 : stdgo.GoInt)) {
                            _b._cap[(1 : stdgo.GoInt)] = _pos;
                        };
                        {
                            var _old:stdgo.GoInt = _b._matchcap[(1 : stdgo.GoInt)];
                            if ((_old == (-1 : stdgo.GoInt)) || ((_longest && (_pos > (0 : stdgo.GoInt))) && (_pos > _old))) {
            ...
            return (_longest && (_b._matchcap.length > (1 : stdgo.GoInt))) && (_b._matchcap[(1 : stdgo.GoInt)] >= (0 : stdgo.GoInt));
        });
        throw "controlFlow did not return";
    }
}
...
@:keep @:allow(stdgo._internal.regexp.Regexp.T_inputString_asInterface) class T_inputString_static_extension {
    ...
    static public function _context( _i:stdgo.Ref<T_inputString>, _pos:stdgo.GoInt):T_lazyFlag {
        ...
        if ((_pos - (1 : stdgo.GoInt) : stdgo.GoUInt) < (_i._str.length : stdgo.GoUInt)) {
            _r1 = (_i._str[(_pos - (1 : stdgo.GoInt) : stdgo.GoInt)] : stdgo.GoRune);
            if (_r1 >= (128 : stdgo.GoInt32)) {
                {
        ...
        if ((_pos : stdgo.GoUInt) < (_i._str.length : stdgo.GoUInt)) {
            _r2 = (_i._str[(_pos : stdgo.GoInt)] : stdgo.GoRune);
            if (_r2 >= (128 : stdgo.GoInt32)) {
                {
...
@:keep @:allow(stdgo._internal.regexp.Regexp.T_lazyFlag_asInterface) class T_lazyFlag_static_extension {
    ...
    static public function _match( _f:T_lazyFlag, _op:stdgo._internal.regexp.syntax.Syntax.EmptyOp):Bool {
        ...
        var _r1:stdgo.GoInt32 = (_f >> (32i64 : stdgo.GoUInt64) : stdgo.GoRune);
        if (_op & (1 : stdgo._internal.regexp.syntax.Syntax.EmptyOp) != ((0 : stdgo._internal.regexp.syntax.Syntax.EmptyOp))) {
            if ((_r1 != (10 : stdgo.GoInt32)) && (_r1 >= (0 : stdgo.GoInt32))) {
                return false;
            };
            _op = _op & ((1 : stdgo._internal.regexp.syntax.Syntax.EmptyOp) ^ (-1i32 : stdgo.GoInt));
        };
        if (_op & (4 : stdgo._internal.regexp.syntax.Syntax.EmptyOp) != ((0 : stdgo._internal.regexp.syntax.Syntax.EmptyOp))) {
            if (_r1 >= (0 : stdgo.GoInt32)) {
                return false;
            };
            _op = _op & ((4 : stdgo._internal.regexp.syntax.Syntax.EmptyOp) ^ (-1i32 : stdgo.GoInt));
        };
        if (_op == ((0 : stdgo._internal.regexp.syntax.Syntax.EmptyOp))) {
            return true;
        };
        var _r2:stdgo.GoInt32 = (_f : stdgo.GoRune);
        if (_op & (2 : stdgo._internal.regexp.syntax.Syntax.EmptyOp) != ((0 : stdgo._internal.regexp.syntax.Syntax.EmptyOp))) {
            if ((_r2 != (10 : stdgo.GoInt32)) && (_r2 >= (0 : stdgo.GoInt32))) {
                return false;
            };
            _op = _op & ((2 : stdgo._internal.regexp.syntax.Syntax.EmptyOp) ^ (-1i32 : stdgo.GoInt));
        };
        if (_op & (8 : stdgo._internal.regexp.syntax.Syntax.EmptyOp) != ((0 : stdgo._internal.regexp.syntax.Syntax.EmptyOp))) {
            if (_r2 >= (0 : stdgo.GoInt32)) {
                return false;
            };
            _op = _op & ((8 : stdgo._internal.regexp.syntax.Syntax.EmptyOp) ^ (-1i32 : stdgo.GoInt));
        };
        if (_op == ((0 : stdgo._internal.regexp.syntax.Syntax.EmptyOp))) {
            return true;
        };
        if (stdgo._internal.regexp.syntax.Syntax.isWordChar(_r1) != (stdgo._internal.regexp.syntax.Syntax.isWordChar(_r2))) {
            _op = _op & ((16 : stdgo._internal.regexp.syntax.Syntax.EmptyOp) ^ (-1i32 : stdgo.GoInt));
        } else {
            _op = _op & ((32 : stdgo._internal.regexp.syntax.Syntax.EmptyOp) ^ (-1i32 : stdgo.GoInt));
        };
...
@:keep @:allow(stdgo._internal.regexp.Regexp.T_runeSlice_asInterface) class T_runeSlice_static_extension {
    ...
    static public function less( _p:T_runeSlice, _i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
        @:recv var _p:T_runeSlice = _p;
        return _p[(_i : stdgo.GoInt)] < _p[(_j : stdgo.GoInt)];
    }
    @:keep
