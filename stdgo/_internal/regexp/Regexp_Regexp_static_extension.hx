...
var _prevMatchEnd = __2, _i = __1, _pos = __0;
    ...
    static public function _doOnePass( _re:stdgo.Ref<stdgo._internal.regexp.Regexp_Regexp.Regexp>, _ir:stdgo._internal.io.Io_RuneReader.RuneReader, _ib:stdgo.Slice<stdgo.GoUInt8>, _is:stdgo.GoString, _pos:stdgo.GoInt, _ncap:stdgo.GoInt, _dstCap:stdgo.Slice<stdgo.GoInt>):stdgo.Slice<stdgo.GoInt> {
        @:recv var _re:stdgo.Ref<stdgo._internal.regexp.Regexp_Regexp.Regexp> = _re;
        var _width1_3946245:stdgo.GoInt = (0 : stdgo.GoInt);
        var _width_3946238:stdgo.GoInt = (0 : stdgo.GoInt);
        var _r_3946207:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _matched_3946099:Bool = false;
        var _m_3945964:stdgo.Ref<stdgo._internal.regexp.Regexp_T_onePassMachine.T_onePassMachine> = (null : stdgo.Ref<stdgo._internal.regexp.Regexp_T_onePassMachine.T_onePassMachine>);
        var _inst_3946467:stdgo.Ref<stdgo._internal.regexp.Regexp_T_onePassInst.T_onePassInst> = (null : stdgo.Ref<stdgo._internal.regexp.Regexp_T_onePassInst.T_onePassInst>);
        var _pc_3946443:stdgo.GoInt = (0 : stdgo.GoInt);
        var _flag_3946348:stdgo._internal.regexp.Regexp_T_lazyFlag.T_lazyFlag = ((0 : stdgo.GoUInt64) : stdgo._internal.regexp.Regexp_T_lazyFlag.T_lazyFlag);
        var _r1_3946210:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _i_3946171:stdgo._internal.regexp.Regexp_T_input.T_input = (null : stdgo._internal.regexp.Regexp_T_input.T_input);
        var _i_3946121:stdgo.GoInt = (0 : stdgo.GoInt);
        var _startCond_3945873:stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp = ((0 : stdgo.GoUInt8) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _startCond_3945873 = _re._cond;
                    if (_startCond_3945873 == ((255 : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp))) {
                        _gotoNext = 3945930i32;
                    } else {
                        _gotoNext = 3945964i32;
                    };
                } else if (__value__ == (3945930i32)) {
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3945964i32;
                } else if (__value__ == (3945964i32)) {
                    _m_3945964 = stdgo._internal.regexp.Regexp__newOnePassMachine._newOnePassMachine();
                    if ((_m_3945964._matchcap.capacity < _ncap : Bool)) {
                        _gotoNext = 3946016i32;
                    } else {
                        _gotoNext = 3946059i32;
                    };
                } else if (__value__ == (3946016i32)) {
                    _m_3945964._matchcap = (new stdgo.Slice<stdgo.GoInt>((_ncap : stdgo.GoInt).toBasic(), 0).__setNumber32__() : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3946099i32;
                } else if (__value__ == (3946059i32)) {
                    _gotoNext = 3946059i32;
                    _m_3945964._matchcap = (_m_3945964._matchcap.__slice__(0, _ncap) : stdgo.Slice<stdgo.GoInt>);
                    var __blank__ = 0i32;
                    _gotoNext = 3946099i32;
                } else if (__value__ == (3946099i32)) {
                    _matched_3946099 = false;
                    if ((0i32 : stdgo.GoInt) < (_m_3945964._matchcap.length)) {
                        _gotoNext = 3946166i32;
                    } else {
                        _gotoNext = 3946171i32;
                    };
                } else if (__value__ == (3946143i32)) {
                    _m_3945964._matchcap[(_i_3946121 : stdgo.GoInt)] = (-1 : stdgo.GoInt);
                    _i_3946121++;
                    _gotoNext = 3946167i32;
                } else if (__value__ == (3946166i32)) {
                    _i_3946121 = 0i32;
                    _gotoNext = 3946167i32;
                } else if (__value__ == (3946167i32)) {
                    if (_i_3946121 < (_m_3945964._matchcap.length)) {
                        _gotoNext = 3946143i32;
                    } else {
                        _gotoNext = 3946171i32;
                    };
                } else if (__value__ == (3946171i32)) {
                    {
                        var __tmp__ = _m_3945964._inputs._init(_ir, _ib, _is?.__copy__());
                        _i_3946171 = __tmp__._0;
                    };
                    {
                        final __tmp__0 = (-1 : stdgo.GoInt32);
                        final __tmp__1 = (-1 : stdgo.GoInt32);
                        _r_3946207 = __tmp__0;
                        _r1_3946210 = __tmp__1;
                    };
                    {
                        final __tmp__0 = (0 : stdgo.GoInt);
                        final __tmp__1 = (0 : stdgo.GoInt);
                        _width_3946238 = __tmp__0;
                        _width1_3946245 = __tmp__1;
                    };
                    {
                        var __tmp__ = _i_3946171._step(_pos);
                        _r_3946207 = __tmp__._0;
                        _width_3946238 = __tmp__._1;
                    };
                    if (_r_3946207 != ((-1 : stdgo.GoInt32))) {
                        _gotoNext = 3946303i32;
                    } else {
                        _gotoNext = 3946344i32;
                    };
                } else if (__value__ == (3946303i32)) {
                    {
                        var __tmp__ = _i_3946171._step((_pos + _width_3946238 : stdgo.GoInt));
                        _r1_3946210 = __tmp__._0;
                        _width1_3946245 = __tmp__._1;
                    };
                    _gotoNext = 3946344i32;
                } else if (__value__ == (3946344i32)) {
                    if (_pos == ((0 : stdgo.GoInt))) {
                        _gotoNext = 3946375i32;
                    } else {
                        _gotoNext = 3946413i32;
                    };
                } else if (__value__ == (3946375i32)) {
                    _flag_3946348 = stdgo._internal.regexp.Regexp__newLazyFlag._newLazyFlag((-1 : stdgo.GoInt32), _r_3946207);
                    _gotoNext = 3946443i32;
                } else if (__value__ == (3946413i32)) {
                    _gotoNext = 3946413i32;
                    _flag_3946348 = _i_3946171._context(_pos);
                    var __blank__ = 0i32;
                    _gotoNext = 3946443i32;
                } else if (__value__ == (3946443i32)) {
                    _pc_3946443 = _re._onepass.start;
                    _inst_3946467 = (stdgo.Go.setRef(_re._onepass.inst[(_pc_3946443 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.Regexp_T_onePassInst.T_onePassInst>);
                    if ((((_pos == ((0 : stdgo.GoInt)) && _flag_3946348._match((_inst_3946467.inst.arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp)) : Bool) && ((_re._prefix.length) > (0 : stdgo.GoInt) : Bool) : Bool) && _i_3946171._canCheckPrefix() : Bool)) {
                        _gotoNext = 3946650i32;
                    } else {
                        _gotoNext = 3946888i32;
                    };
                } else if (__value__ == (3946650i32)) {
                    if (!_i_3946171._hasPrefix(_re)) {
                        _gotoNext = 3946730i32;
                    } else {
                        _gotoNext = 3946753i32;
                    };
                } else if (__value__ == (3946730i32)) {
                    _gotoNext = 3948012i32;
                } else if (__value__ == (3946753i32)) {
                    ...
                    _flag_3946348 = _i_3946171._context(_pos);
                    _pc_3946443 = (_re._prefixEnd : stdgo.GoInt);
                    _gotoNext = 3946888i32;
                } else if (__value__ == (3946888i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3946888i32;
                    if (true) {
                        _gotoNext = 3946892i32;
                    } else {
                        _gotoNext = 3948012i32;
                    };
                } else if (__value__ == (3946892i32)) {
                    _inst_3946467 = (stdgo.Go.setRef(_re._onepass.inst[(_pc_3946443 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.Regexp_T_onePassInst.T_onePassInst>);
                    _pc_3946443 = (_inst_3946467.inst.out : stdgo.GoInt);
                    var __blank__ = 0i32;
                    _gotoNext = 3946947i32;
                } else if (__value__ == (3946947i32)) {
                    {
                        final __value__ = _inst_3946467.inst.op;
                        if (__value__ == ((4 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3946998i32;
                        } else if (__value__ == ((7 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3947135i32;
                        } else if (__value__ == ((8 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3947207i32;
                        } else if (__value__ == ((9 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3947279i32;
                        } else if (__value__ == ((10 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3947320i32;
                        } else if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp)) || __value__ == ((1 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3947458i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3947548i32;
                        } else if (__value__ == ((6 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3947587i32;
                        } else if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3947622i32;
                        } else if (__value__ == ((2 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3947731i32;
                        } else {
                            _gotoNext = 3946966i32;
                        };
                    };
                } else if (__value__ == (3946966i32)) {
                    throw stdgo.Go.toInterface(("bad inst" : stdgo.GoString));
                    _gotoNext = 3947850i32;
                } else if (__value__ == (3946998i32)) {
                    _matched_3946099 = true;
                    if (((_m_3945964._matchcap.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3947065i32;
                    } else {
                        _gotoNext = 3947121i32;
                    };
                } else if (__value__ == (3947065i32)) {
                    _m_3945964._matchcap[(0 : stdgo.GoInt)] = (0 : stdgo.GoInt);
                    _m_3945964._matchcap[(1 : stdgo.GoInt)] = _pos;
                    _gotoNext = 3947121i32;
                } else if (__value__ == (3947121i32)) {
                    _gotoNext = 3948012i32;
                } else if (__value__ == (3947135i32)) {
                    if (!_inst_3946467.matchRune(_r_3946207)) {
                        _gotoNext = 3947182i32;
                    } else {
                        _gotoNext = 3947850i32;
                    };
                } else if (__value__ == (3947182i32)) {
                    _gotoNext = 3948012i32;
                } else if (__value__ == (3947207i32)) {
                    if (_r_3946207 != (_inst_3946467.inst.rune[((0 : stdgo.GoInt) : stdgo.GoInt)])) {
                        _gotoNext = 3947254i32;
                    } else {
                        _gotoNext = 3947850i32;
                    };
                } else if (__value__ == (3947254i32)) {
                    _gotoNext = 3948012i32;
                } else if (__value__ == (3947279i32)) {
                    _gotoNext = 3947850i32;
                } else if (__value__ == (3947320i32)) {
                    if (_r_3946207 == ((10 : stdgo.GoInt32))) {
                        _gotoNext = 3947366i32;
                    } else {
                        _gotoNext = 3947850i32;
                    };
                } else if (__value__ == (3947366i32)) {
                    _gotoNext = 3948012i32;
                } else if (__value__ == (3947458i32)) {
                    _pc_3946443 = (stdgo._internal.regexp.Regexp__onePassNext._onePassNext(_inst_3946467, _r_3946207) : stdgo.GoInt);
                    var __blank__ = 0i32;
                    _gotoNext = 3946888i32;
                } else if (__value__ == (3947548i32)) {
                    _gotoNext = 3948012i32;
                } else if (__value__ == (3947587i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3946888i32;
                } else if (__value__ == (3947622i32)) {
                    if (!_flag_3946348._match((_inst_3946467.inst.arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp))) {
                        _gotoNext = 3947694i32;
                    } else {
                        _gotoNext = 3947720i32;
                    };
                } else if (__value__ == (3947694i32)) {
                    _gotoNext = 3948012i32;
                } else if (__value__ == (3947720i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3946888i32;
                } else if (__value__ == (3947731i32)) {
                    if (((_inst_3946467.inst.arg : stdgo.GoInt) < (_m_3945964._matchcap.length) : Bool)) {
                        _gotoNext = 3947794i32;
                    } else {
                        _gotoNext = 3947835i32;
                    };
                } else if (__value__ == (3947794i32)) {
                    _m_3945964._matchcap[(_inst_3946467.inst.arg : stdgo.GoInt)] = _pos;
                    _gotoNext = 3947835i32;
                } else if (__value__ == (3947835i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3946888i32;
                } else if (__value__ == (3947850i32)) {
                    if (_width_3946238 == ((0 : stdgo.GoInt))) {
                        _gotoNext = 3947864i32;
                    } else {
                        _gotoNext = 3947881i32;
                    };
                } else if (__value__ == (3947864i32)) {
                    _gotoNext = 3948012i32;
                } else if (__value__ == (3947881i32)) {
                    _flag_3946348 = stdgo._internal.regexp.Regexp__newLazyFlag._newLazyFlag(_r_3946207, _r1_3946210);
                    _pos = (_pos + (_width_3946238) : stdgo.GoInt);
                    {
                        final __tmp__0 = _r1_3946210;
                        final __tmp__1 = _width1_3946245;
                        _r_3946207 = __tmp__0;
                        _width_3946238 = __tmp__1;
                    };
                    if (_r_3946207 != ((-1 : stdgo.GoInt32))) {
                        _gotoNext = 3947966i32;
                    } else {
                        _gotoNext = 3948012i32;
                    };
                } else if (__value__ == (3947966i32)) {
                    {
                        var __tmp__ = _i_3946171._step((_pos + _width_3946238 : stdgo.GoInt));
                        _r1_3946210 = __tmp__._0;
                        _width1_3946245 = __tmp__._1;
                    ...
                    _gotoNext = 3948012i32;
                } else if (__value__ == (3948012i32)) {
                    _gotoNext = 3948012i32;
                    if (!_matched_3946099) {
                        _gotoNext = 3948033i32;
                    } else {
                        _gotoNext = 3948077i32;
                    };
                } else if (__value__ == (3948033i32)) {
                    stdgo._internal.regexp.Regexp__freeOnePassMachine._freeOnePassMachine(_m_3945964);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3948077i32;
                } else if (__value__ == (3948077i32)) {
                    _dstCap = (_dstCap.__append__(...(_m_3945964._matchcap : Array<stdgo.GoInt>)));
                    stdgo._internal.regexp.Regexp__freeOnePassMachine._freeOnePassMachine(_m_3945964);
                    return _dstCap;
                    _gotoNext = -1i32;
                };
    ...
    static public function _backtrack( _re:stdgo.Ref<stdgo._internal.regexp.Regexp_Regexp.Regexp>, _ib:stdgo.Slice<stdgo.GoUInt8>, _is:stdgo.GoString, _pos:stdgo.GoInt, _ncap:stdgo.GoInt, _dstCap:stdgo.Slice<stdgo.GoInt>):stdgo.Slice<stdgo.GoInt> {
        @:recv var _re:stdgo.Ref<stdgo._internal.regexp.Regexp_Regexp.Regexp> = _re;
        var _advance_3957869:stdgo.GoInt = (0 : stdgo.GoInt);
        var _width_3957719:stdgo.GoInt = (0 : stdgo.GoInt);
        var _end_3957011:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_3957008:stdgo._internal.regexp.Regexp_T_input.T_input = (null : stdgo._internal.regexp.Regexp_T_input.T_input);
        var _b_3956988:stdgo.Ref<stdgo._internal.regexp.Regexp_T_bitState.T_bitState> = (null : stdgo.Ref<stdgo._internal.regexp.Regexp_T_bitState.T_bitState>);
        var _startCond_3956781:stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp = ((0 : stdgo.GoUInt8) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
        var _gotoNext = 0i32;
        var __blank__ = _gotoNext == ((0i32 : stdgo.GoInt));
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                final __value__ = _gotoNext;
                if (__value__ == (0i32)) {
                    _startCond_3956781 = _re._cond;
                    if (_startCond_3956781 == ((255 : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp))) {
                        _gotoNext = 3956838i32;
                    } else {
                        _gotoNext = 3956871i32;
                    };
                } else if (__value__ == (3956838i32)) {
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3956871i32;
                } else if (__value__ == (3956871i32)) {
                    if ((((_startCond_3956781 & (4 : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp) != (0 : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp)) && (_pos != (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 3956923i32;
                    } else {
                        _gotoNext = 3956988i32;
                    };
                } else if (__value__ == (3956923i32)) {
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3956988i32;
                } else if (__value__ == (3956988i32)) {
                    _b_3956988 = stdgo._internal.regexp.Regexp__newBitState._newBitState();
                    {
                        var __tmp__ = _b_3956988._inputs._init((null : stdgo._internal.io.Io_RuneReader.RuneReader), _ib, _is?.__copy__());
                        _i_3957008 = __tmp__._0;
                        _end_3957011 = __tmp__._1;
                    };
                    _b_3956988._reset(_re._prog, _end_3957011, _ncap);
                    if ((_startCond_3956781 & (4 : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp) != ((0 : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp))) {
                        _gotoNext = 3957177i32;
                    } else {
                        _gotoNext = 3957326i32;
                    };
                } else if (__value__ == (3957177i32)) {
                    if (((_b_3956988._cap.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3957199i32;
                    } else {
                        _gotoNext = 3957225i32;
                    };
                } else if (__value__ == (3957199i32)) {
                    _b_3956988._cap[(0 : stdgo.GoInt)] = _pos;
                    _gotoNext = 3957225i32;
                } else if (__value__ == (3957225i32)) {
                    if (!_re._tryBacktrack(_b_3956988, _i_3957008, (_re._prog.start : stdgo.GoUInt32), _pos)) {
                        _gotoNext = 3957279i32;
                    } else {
                        _gotoNext = 3958213i32;
                    };
                } else if (__value__ == (3957279i32)) {
                    stdgo._internal.regexp.Regexp__freeBitState._freeBitState(_b_3956988);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3958213i32;
                } else if (__value__ == (3957326i32)) {
                    _gotoNext = 3957326i32;
                    _width_3957719 = (-1 : stdgo.GoInt);
                    var __blank__ = 0i32;
                    _gotoNext = 3957733i32;
                } else if (__value__ == (3957733i32)) {
                    if (((_pos <= _end_3957011 : Bool) && (_width_3957719 != (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 3957778i32;
                    } else {
                        _gotoNext = 3958180i32;
                    };
                } else if (__value__ == (3957778i32)) {
                    if (((_re._prefix.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3957805i32;
                    } else {
                        _gotoNext = 3957989i32;
                    };
                } else if (__value__ == (3957805i32)) {
                    _advance_3957869 = _i_3957008._index(_re, _pos);
                    if ((_advance_3957869 < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3957916i32;
                    } else {
                        _gotoNext = 3957965i32;
                    };
                } else if (__value__ == (3957916i32)) {
                    stdgo._internal.regexp.Regexp__freeBitState._freeBitState(_b_3956988);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3957965i32;
                } else if (__value__ == (3957965i32)) {
                    _pos = (_pos + (_advance_3957869) : stdgo.GoInt);
                    _gotoNext = 3957989i32;
                } else if (__value__ == (3957989i32)) {
                    if (((_b_3956988._cap.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3958007i32;
                    } else {
                        _gotoNext = 3958036i32;
                    };
                } else if (__value__ == (3958007i32)) {
                    _b_3956988._cap[(0 : stdgo.GoInt)] = _pos;
                    _gotoNext = 3958036i32;
                } else if (__value__ == (3958036i32)) {
                    if (_re._tryBacktrack(_b_3956988, _i_3957008, (_re._prog.start : stdgo.GoUInt32), _pos)) {
                        _gotoNext = 3958089i32;
                    } else {
                        _gotoNext = 3958151i32;
                    };
                } else if (__value__ == (3958089i32)) {
                    _gotoNext = 3958213i32;
                } else if (__value__ == (3958151i32)) {
                    {
                        var __tmp__ = _i_3957008._step(_pos);
                        _width_3957719 = __tmp__._1;
                    };
                    _pos = (_pos + (_width_3957719) : stdgo.GoInt);
                    _gotoNext = 3957733i32;
                } else if (__value__ == (3958180i32)) {
                    stdgo._internal.regexp.Regexp__freeBitState._freeBitState(_b_3956988);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    var __blank__ = 0i32;
                    _gotoNext = 3958213i32;
                } else if (__value__ == (3958213i32)) {
                    _gotoNext = 3958213i32;
                    _dstCap = (_dstCap.__append__(...(_b_3956988._matchcap : Array<stdgo.GoInt>)));
                    stdgo._internal.regexp.Regexp__freeBitState._freeBitState(_b_3956988);
                    return _dstCap;
                    _gotoNext = -1i32;
                };
    ...
    static public function _tryBacktrack( _re:stdgo.Ref<stdgo._internal.regexp.Regexp_Regexp.Regexp>, _b:stdgo.Ref<stdgo._internal.regexp.Regexp_T_bitState.T_bitState>, _i:stdgo._internal.regexp.Regexp_T_input.T_input, _pc:stdgo.GoUInt32, _pos:stdgo.GoInt):Bool {
        @:recv var _re:stdgo.Ref<stdgo._internal.regexp.Regexp_Regexp.Regexp> = _re;
        var _r_3954926:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _pos_3953008:stdgo.GoInt = (0 : stdgo.GoInt);
        var _r_3955089:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _l_3952936:stdgo.GoInt = (0 : stdgo.GoInt);
        var _longest_3952860:Bool = false;
        var _old_3956177:stdgo.GoInt = (0 : stdgo.GoInt);
        var _width_3954771:stdgo.GoInt = (0 : stdgo.GoInt);
        var _arg_3953031:Bool = false;
        var _flag_3955625:stdgo._internal.regexp.Regexp_T_lazyFlag.T_lazyFlag = ((0 : stdgo.GoUInt64) : stdgo._internal.regexp.Regexp_T_lazyFlag.T_lazyFlag);
        var _width_3954619:stdgo.GoInt = (0 : stdgo.GoInt);
        var _inst_3953435:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
        var _pc_3952987:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _width_3955092:stdgo.GoInt = (0 : stdgo.GoInt);
        var _width_3954929:stdgo.GoInt = (0 : stdgo.GoInt);
        var _r_3954768:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _r_3954616:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _gotoNext = 0i32;
        var __blank__ = _gotoNext == ((0i32 : stdgo.GoInt));
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                final __value__ = _gotoNext;
                if (__value__ == (0i32)) {
                    _longest_3952860 = _re._longest;
                    _b._push(_re, _pc, _pos, false);
                    var __blank__ = 0i32;
                    _gotoNext = 3952912i32;
                } else if (__value__ == (3952912i32)) {
                    if (((_b._jobs.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3952932i32;
                    } else {
                        _gotoNext = 3956548i32;
                    };
                } else if (__value__ == (3952932i32)) {
                    _l_3952936 = ((_b._jobs.length) - (1 : stdgo.GoInt) : stdgo.GoInt);
                    _pc_3952987 = _b._jobs[(_l_3952936 : stdgo.GoInt)]._pc;
                    _pos_3953008 = _b._jobs[(_l_3952936 : stdgo.GoInt)]._pos;
                    _arg_3953031 = _b._jobs[(_l_3952936 : stdgo.GoInt)]._arg;
                    _b._jobs = (_b._jobs.__slice__(0, _l_3952936) : stdgo.Slice<stdgo._internal.regexp.Regexp_T_job.T_job>);
                    _gotoNext = 3953426i32;
                } else if (__value__ == (3953364i32)) {
                    if (!_b._shouldVisit(_pc_3952987, _pos_3953008)) {
                        _gotoNext = 3953407i32;
                    } else {
                        _gotoNext = 3953426i32;
                    };
                } else if (__value__ == (3953407i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3952912i32;
                } else if (__value__ == (3953426i32)) {
                    _gotoNext = 3953426i32;
                    _inst_3953435 = (stdgo.Go.setRef(_re._prog.inst[(_pc_3952987 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    var __blank__ = 0i32;
                    _gotoNext = 3953464i32;
                } else if (__value__ == (3953464i32)) {
                    {
                        final __value__ = _inst_3953435.op;
                        if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3953515i32;
                        } else if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3953571i32;
                        } else if (__value__ == ((1 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3954132i32;
                        } else if (__value__ == ((7 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3954591i32;
                        } else if (__value__ == ((8 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3954742i32;
                        } else if (__value__ == ((10 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3954893i32;
                        } else if (__value__ == ((9 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3955061i32;
                        } else if (__value__ == ((2 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3955211i32;
                        } else if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3955594i32;
                        } else if (__value__ == ((6 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3955753i32;
                        } else if (__value__ == ((4 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3955815i32;
                        } else {
                            _gotoNext = 3953483i32;
                        };
                    };
                } else if (__value__ == (3953483i32)) {
                    throw stdgo.Go.toInterface(("bad inst" : stdgo.GoString));
                    _gotoNext = 3956548i32;
                } else if (__value__ == (3953515i32)) {
                    throw stdgo.Go.toInterface(("unexpected InstFail" : stdgo.GoString));
                    _gotoNext = 3956548i32;
                } else if (__value__ == (3953571i32)) {
                    if (_arg_3953031) {
                        _gotoNext = 3953944i32;
                    } else {
                        _gotoNext = 3954052i32;
                    };
                } else if (__value__ == (3953944i32)) {
                    _arg_3953031 = false;
                    _pc_3952987 = _inst_3953435.arg;
                    _gotoNext = 3953364i32;
                } else if (__value__ == (3954052i32)) {
                    _gotoNext = 3954052i32;
                    _b._push(_re, _pc_3952987, _pos_3953008, true);
                    _pc_3952987 = _inst_3953435.out;
                    _gotoNext = 3953364i32;
                } else if (__value__ == (3954132i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3954220i32;
                } else if (__value__ == (3954220i32)) {
                    {
                        final __value__ = _re._prog.inst[(_inst_3953435.out : stdgo.GoInt)].op;
                        if (__value__ == ((7 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp)) || __value__ == ((8 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp)) || __value__ == ((9 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp)) || __value__ == ((10 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3954258i32;
                        } else {
                            _gotoNext = 3954515i32;
                        };
                    };
                } else if (__value__ == (3954258i32)) {
                    _b._push(_re, _inst_3953435.arg, _pos_3953008, false);
                    _pc_3952987 = _inst_3953435.arg;
                    _pos_3953008 = _b._end;
                    _gotoNext = 3953364i32;
                } else if (__value__ == (3954515i32)) {
                    _b._push(_re, _inst_3953435.out, _b._end, false);
                    _pc_3952987 = _inst_3953435.out;
                    _gotoNext = 3953364i32;
                } else if (__value__ == (3954591i32)) {
                    {
                        var __tmp__ = _i._step(_pos_3953008);
                        _r_3954616 = __tmp__._0;
                        _width_3954619 = __tmp__._1;
                    };
                    if (!_inst_3953435.matchRune(_r_3954616)) {
                        _gotoNext = 3954665i32;
                    } else {
                        _gotoNext = 3954688i32;
                    };
                } else if (__value__ == (3954665i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3952912i32;
                } else if (__value__ == (3954688i32)) {
                    _pos_3953008 = (_pos_3953008 + (_width_3954619) : stdgo.GoInt);
                    _pc_3952987 = _inst_3953435.out;
                    _gotoNext = 3953364i32;
                } else if (__value__ == (3954742i32)) {
                    {
                        var __tmp__ = _i._step(_pos_3953008);
                        _r_3954768 = __tmp__._0;
                        _width_3954771 = __tmp__._1;
                    };
                    if (_r_3954768 != (_inst_3953435.rune[((0 : stdgo.GoInt) : stdgo.GoInt)])) {
                        _gotoNext = 3954816i32;
                    } else {
                        _gotoNext = 3954839i32;
                    };
                } else if (__value__ == (3954816i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3952912i32;
                } else if (__value__ == (3954839i32)) {
                    _pos_3953008 = (_pos_3953008 + (_width_3954771) : stdgo.GoInt);
                    _pc_3952987 = _inst_3953435.out;
                    _gotoNext = 3953364i32;
                } else if (__value__ == (3954893i32)) {
                    {
                        var __tmp__ = _i._step(_pos_3953008);
                        _r_3954926 = __tmp__._0;
                        _width_3954929 = __tmp__._1;
                    };
                    if (((_r_3954926 == (10 : stdgo.GoInt32)) || (_r_3954926 == (-1 : stdgo.GoInt32)) : Bool)) {
                        _gotoNext = 3954984i32;
                    } else {
                        _gotoNext = 3955007i32;
                    };
                } else if (__value__ == (3954984i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3952912i32;
                } else if (__value__ == (3955007i32)) {
                    _pos_3953008 = (_pos_3953008 + (_width_3954929) : stdgo.GoInt);
                    _pc_3952987 = _inst_3953435.out;
                    _gotoNext = 3953364i32;
                } else if (__value__ == (3955061i32)) {
                    {
                        var __tmp__ = _i._step(_pos_3953008);
                        _r_3955089 = __tmp__._0;
                        _width_3955092 = __tmp__._1;
                    };
                    if (_r_3955089 == ((-1 : stdgo.GoInt32))) {
                        _gotoNext = 3955134i32;
                    } else {
                        _gotoNext = 3955157i32;
                    };
                } else if (__value__ == (3955134i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3952912i32;
                } else if (__value__ == (3955157i32)) {
                    _pos_3953008 = (_pos_3953008 + (_width_3955092) : stdgo.GoInt);
                    _pc_3952987 = _inst_3953435.out;
                    _gotoNext = 3953364i32;
                } else if (__value__ == (3955211i32)) {
                    if (_arg_3953031) {
                        _gotoNext = 3955246i32;
                    } else {
                        _gotoNext = 3955346i32;
                    };
                } else if (__value__ == (3955246i32)) {
                    _b._cap[(_inst_3953435.arg : stdgo.GoInt)] = _pos_3953008;
                    var __blank__ = 0i32;
                    _gotoNext = 3952912i32;
                } else if (__value__ == (3955346i32)) {
                    _gotoNext = 3955346i32;
                    if ((_inst_3953435.arg < (_b._cap.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 3955385i32;
                    } else {
                        _gotoNext = 3955550i32;
                    };
                } else if (__value__ == (3955385i32)) {
                    _b._push(_re, _pc_3952987, _b._cap[(_inst_3953435.arg : stdgo.GoInt)], true);
                    _b._cap[(_inst_3953435.arg : stdgo.GoInt)] = _pos_3953008;
                    _gotoNext = 3955550i32;
                } else if (__value__ == (3955550i32)) {
                    _pc_3952987 = _inst_3953435.out;
                    _gotoNext = 3953364i32;
                } else if (__value__ == (3955594i32)) {
                    _flag_3955625 = _i._context(_pos_3953008);
                    if (!_flag_3955625._match((_inst_3953435.arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp))) {
                        _gotoNext = 3955692i32;
                    } else {
                        _gotoNext = 3955715i32;
                    };
                } else if (__value__ == (3955692i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3952912i32;
                } else if (__value__ == (3955715i32)) {
                    _pc_3952987 = _inst_3953435.out;
                    _gotoNext = 3953364i32;
                } else if (__value__ == (3955753i32)) {
                    _pc_3952987 = _inst_3953435.out;
                    _gotoNext = 3953364i32;
                } else if (__value__ == (3955815i32)) {
                    if ((_b._cap.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 3955961i32;
                    } else {
                        _gotoNext = 3956127i32;
                    };
                } else if (__value__ == (3955961i32)) {
                    return true;
                    _gotoNext = 3956127i32;
                } else if (__value__ == (3956127i32)) {
                    if (((_b._cap.length) > (1 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3956145i32;
                    } else {
                        _gotoNext = 3956174i32;
                    };
                } else if (__value__ == (3956145i32)) {
                    _b._cap[(1 : stdgo.GoInt)] = _pos_3953008;
                    _gotoNext = 3956174i32;
                } else if (__value__ == (3956174i32)) {
                    {
                        _old_3956177 = _b._matchcap[(1 : stdgo.GoInt)];
                        if (((_old_3956177 == (-1 : stdgo.GoInt)) || (((_longest_3952860 && (_pos_3953008 > (0 : stdgo.GoInt) : Bool) : Bool) && (_pos_3953008 > _old_3956177 : Bool) : Bool)) : Bool)) {
                            _gotoNext = 3956246i32;
                        } else {
                            _gotoNext = 3956329i32;
                        };
                    };
                } else if (__value__ == (3956246i32)) {
                    stdgo.Go.copySlice(_b._matchcap, _b._cap);
                    _gotoNext = 3956329i32;
                } else if (__value__ == (3956329i32)) {
                    if (!_longest_3952860) {
                        _gotoNext = 3956341i32;
                    } else {
                        _gotoNext = 3956431i32;
                    };
                } else if (__value__ == (3956341i32)) {
                    return true;
                    _gotoNext = 3956431i32;
                } else if (__value__ == (3956431i32)) {
                    if (_pos_3953008 == (_b._end)) {
                        _gotoNext = 3956447i32;
                    } else {
                        _gotoNext = 3956530i32;
                    };
                } else if (__value__ == (3956447i32)) {
                    return true;
                    _gotoNext = 3956530i32;
                } else if (__value__ == (3956530i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3952912i32;
                } else if (__value__ == (3956548i32)) {
                    return ((_longest_3952860 && ((_b._matchcap.length) > (1 : stdgo.GoInt) : Bool) : Bool) && (_b._matchcap[(1 : stdgo.GoInt)] >= (0 : stdgo.GoInt) : Bool) : Bool);
                    _gotoNext = -1i32;
                };
            };
        };
