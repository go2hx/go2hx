...
@:local @:using(stdgo._internal.regexp.Regexp_T__struct_5_static_extension.T__struct_5_static_extension) @:using(stdgo._internal.regexp.Regexp_T__struct_5_static_extension.T__struct_5_static_extension) typedef T__struct_5 = {
