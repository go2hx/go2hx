...
@:keep @:allow(stdgo._internal.regexp.Regexp.T_machine_asInterface) class T_machine_static_extension {
    ...
    static public function _add( _m:stdgo.Ref<stdgo._internal.regexp.Regexp_T_machine.T_machine>, _q:stdgo.Ref<stdgo._internal.regexp.Regexp_T_queue.T_queue>, _pc:stdgo.GoUInt32, _pos:stdgo.GoInt, _cap:stdgo.Slice<stdgo.GoInt>, _cond:stdgo.Pointer<stdgo._internal.regexp.Regexp_T_lazyFlag.T_lazyFlag>, _t:stdgo.Ref<stdgo._internal.regexp.Regexp_T_thread.T_thread>):stdgo.Ref<stdgo._internal.regexp.Regexp_T_thread.T_thread> {
        ...
        var _i_3670337:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
        var _d_3670270:stdgo.Ref<stdgo._internal.regexp.Regexp_T_entry.T_entry> = (null : stdgo.Ref<stdgo._internal.regexp.Regexp_T_entry.T_entry>);
        var _j_3670226:stdgo.GoInt = (0 : stdgo.GoInt);
        var _j_3670141:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _opos_3670756:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 3670102i32;
                } else if (__value__ == (3670102i32)) {
                    if (_pc == ((0u32 : stdgo.GoUInt32))) {
                        _gotoNext = 3670121i32;
                    } else {
                        _gotoNext = 3670138i32;
                    };
                } else if (__value__ == (3670121i32)) {
                    return _t;
                    _gotoNext = 3670138i32;
                } else if (__value__ == (3670138i32)) {
                    {
                        _j_3670141 = _q._sparse[(_pc : stdgo.GoInt)];
                        if (((_j_3670141 < (_q._dense.length : stdgo.GoUInt32) : Bool) && (_q._dense[(_j_3670141 : stdgo.GoInt)]._pc == _pc) : Bool)) {
                            _gotoNext = 3670208i32;
                        } else {
                            _gotoNext = 3670226i32;
                        };
                    };
                } else if (__value__ == (3670208i32)) {
                    return _t;
                    _gotoNext = 3670226i32;
                } else if (__value__ == (3670226i32)) {
                    _j_3670226 = (_q._dense.length);
                    _q._dense = (_q._dense.__slice__(0, (_j_3670226 + (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.regexp.Regexp_T_entry.T_entry>);
                    _d_3670270 = (stdgo.Go.setRef(_q._dense[(_j_3670226 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.Regexp_T_entry.T_entry>);
                    _d_3670270._t = null;
                    _d_3670270._pc = _pc;
                    _q._sparse[(_pc : stdgo.GoInt)] = (_j_3670226 : stdgo.GoUInt32);
                    _i_3670337 = (stdgo.Go.setRef(_m._p.inst[(_pc : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3670357i32;
                } else if (__value__ == (3670357i32)) {
                    {
                        final __value__ = _i_3670337.op;
                        if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3670403i32;
                        } else if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp)) || __value__ == ((1 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3670439i32;
                        } else if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3670549i32;
                        } else if (__value__ == ((6 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3670651i32;
                        } else if (__value__ == ((2 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3670699i32;
                            ...
                            _gotoNext = 3670900i32;
                        } else {
                            _gotoNext = 3670372i32;
                        };
                    };
                } else if (__value__ == (3670372i32)) {
                    throw stdgo.Go.toInterface(("unhandled" : stdgo.GoString));
                    _gotoNext = 3671158i32;
                } else if (__value__ == (3670403i32)) {
                    _gotoNext = 3671158i32;
                } else if (__value__ == (3670439i32)) {
                    _t = _m._add(_q, _i_3670337.out, _pos, _cap, _cond, _t);
                    _pc = _i_3670337.arg;
                    _gotoNext = 3670102i32;
                } else if (__value__ == (3670549i32)) {
                    if (_cond.value._match((_i_3670337.arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp))) {
                        _gotoNext = 3670616i32;
                    } else {
                        _gotoNext = 3671158i32;
                    };
                } else if (__value__ == (3670616i32)) {
                    _pc = _i_3670337.out;
                    _gotoNext = 3670102i32;
                } else if (__value__ == (3670651i32)) {
                    _pc = _i_3670337.out;
                    _gotoNext = 3670102i32;
                } else if (__value__ == (3670699i32)) {
                    if (((_i_3670337.arg : stdgo.GoInt) < (_cap.length) : Bool)) {
                        _gotoNext = 3670751i32;
                    } else {
                        _gotoNext = 3670865i32;
                    };
                } else if (__value__ == (3670751i32)) {
                    _opos_3670756 = _cap[(_i_3670337.arg : stdgo.GoInt)];
                    _cap[(_i_3670337.arg : stdgo.GoInt)] = _pos;
                    _m._add(_q, _i_3670337.out, _pos, _cap, _cond, null);
                    _cap[(_i_3670337.arg : stdgo.GoInt)] = _opos_3670756;
                    _gotoNext = 3671158i32;
                } else if (__value__ == (3670865i32)) {
                    _gotoNext = 3670865i32;
                    _pc = _i_3670337.out;
                    _gotoNext = 3670102i32;
                } else if (__value__ == (3670900i32)) {
                    if ((_t == null || (_t : Dynamic).__nil__)) {
                        _gotoNext = 3671017i32;
                    } else {
                        _gotoNext = 3671046i32;
                    };
                } else if (__value__ == (3671017i32)) {
                    _t = _m._alloc(_i_3670337);
                    _gotoNext = 3671068i32;
                } else if (__value__ == (3671046i32)) {
                    _gotoNext = 3671046i32;
                    _t._inst = _i_3670337;
                    var __blank__ = 0i32;
                    _gotoNext = 3671068i32;
                } else if (__value__ == (3671068i32)) {
                    if ((((_cap.length) > (0 : stdgo.GoInt) : Bool) && (stdgo.Go.pointer(_t._cap[(0 : stdgo.GoInt)]) != stdgo.Go.pointer(_cap[(0 : stdgo.GoInt)])) : Bool)) {
                        _gotoNext = 3671108i32;
                    } else {
                        _gotoNext = 3671136i32;
                    };
                } else if (__value__ == (3671108i32)) {
                    _t._cap.__copyTo__(_cap);
                    _gotoNext = 3671136i32;
                } else if (__value__ == (3671136i32)) {
                    _d_3670270._t = _t;
                    _t = null;
                    _gotoNext = 3671158i32;
                } else if (__value__ == (3671158i32)) {
                    return _t;
                    _gotoNext = -1i32;
                };
            };
