...
@:keep @:allow(stdgo._internal.regexp.Regexp.T_machine_asInterface) class T_machine_static_extension {
    ...
    static public function _add( _m:stdgo.Ref<stdgo._internal.regexp.Regexp_T_machine.T_machine>, _q:stdgo.Ref<stdgo._internal.regexp.Regexp_T_queue.T_queue>, _pc:stdgo.GoUInt32, _pos:stdgo.GoInt, _cap:stdgo.Slice<stdgo.GoInt>, _cond:stdgo.Pointer<stdgo._internal.regexp.Regexp_T_lazyFlag.T_lazyFlag>, _t:stdgo.Ref<stdgo._internal.regexp.Regexp_T_thread.T_thread>):stdgo.Ref<stdgo._internal.regexp.Regexp_T_thread.T_thread> {
        ...
        var _j_3929701:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _opos_3930316:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_3929897:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
        var _d_3929830:stdgo.Ref<stdgo._internal.regexp.Regexp_T_entry.T_entry> = (null : stdgo.Ref<stdgo._internal.regexp.Regexp_T_entry.T_entry>);
        var _j_3929786:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 3929662i32;
                } else if (__value__ == (3929662i32)) {
                    if (_pc == ((0u32 : stdgo.GoUInt32))) {
                        _gotoNext = 3929681i32;
                    } else {
                        _gotoNext = 3929698i32;
                    };
                } else if (__value__ == (3929681i32)) {
                    return _t;
                    _gotoNext = 3929698i32;
                } else if (__value__ == (3929698i32)) {
                    {
                        _j_3929701 = (@:checkr _q ?? throw "null pointer dereference")._sparse[(_pc : stdgo.GoInt)];
                        if (((_j_3929701 < ((@:checkr _q ?? throw "null pointer dereference")._dense.length : stdgo.GoUInt32) : Bool) && ((@:checkr _q ?? throw "null pointer dereference")._dense[(_j_3929701 : stdgo.GoInt)]._pc == _pc) : Bool)) {
                            _gotoNext = 3929768i32;
                        } else {
                            _gotoNext = 3929786i32;
                        };
                    };
                } else if (__value__ == (3929768i32)) {
                    return _t;
                    _gotoNext = 3929786i32;
                } else if (__value__ == (3929786i32)) {
                    _j_3929786 = ((@:checkr _q ?? throw "null pointer dereference")._dense.length);
                    (@:checkr _q ?? throw "null pointer dereference")._dense = ((@:checkr _q ?? throw "null pointer dereference")._dense.__slice__(0, (_j_3929786 + (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.regexp.Regexp_T_entry.T_entry>);
                    _d_3929830 = (stdgo.Go.setRef((@:checkr _q ?? throw "null pointer dereference")._dense[(_j_3929786 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.Regexp_T_entry.T_entry>);
                    (@:checkr _d_3929830 ?? throw "null pointer dereference")._t = null;
                    (@:checkr _d_3929830 ?? throw "null pointer dereference")._pc = _pc;
                    (@:checkr _q ?? throw "null pointer dereference")._sparse[(_pc : stdgo.GoInt)] = (_j_3929786 : stdgo.GoUInt32);
                    _i_3929897 = (stdgo.Go.setRef((@:checkr (@:checkr _m ?? throw "null pointer dereference")._p ?? throw "null pointer dereference").inst[(_pc : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3929917i32;
                } else if (__value__ == (3929917i32)) {
                    {
                        final __value__ = (@:checkr _i_3929897 ?? throw "null pointer dereference").op;
                        if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3929963i32;
                        } else if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp)) || __value__ == ((1 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3929999i32;
                        } else if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3930109i32;
                        } else if (__value__ == ((6 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3930211i32;
                        } else if (__value__ == ((2 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3930259i32;
                            ...
                            _gotoNext = 3930460i32;
                        } else {
                            _gotoNext = 3929932i32;
                        };
                    };
                } else if (__value__ == (3929932i32)) {
                    throw stdgo.Go.toInterface(("unhandled" : stdgo.GoString));
                    _gotoNext = 3930718i32;
                } else if (__value__ == (3929963i32)) {
                    _gotoNext = 3930718i32;
                } else if (__value__ == (3929999i32)) {
                    _t = @:check2r _m._add(_q, (@:checkr _i_3929897 ?? throw "null pointer dereference").out, _pos, _cap, _cond, _t);
                    _pc = (@:checkr _i_3929897 ?? throw "null pointer dereference").arg;
                    _gotoNext = 3929662i32;
                } else if (__value__ == (3930109i32)) {
                    if (_cond.value._match(((@:checkr _i_3929897 ?? throw "null pointer dereference").arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp))) {
                        _gotoNext = 3930176i32;
                    } else {
                        _gotoNext = 3930718i32;
                    };
                } else if (__value__ == (3930176i32)) {
                    _pc = (@:checkr _i_3929897 ?? throw "null pointer dereference").out;
                    _gotoNext = 3929662i32;
                } else if (__value__ == (3930211i32)) {
                    _pc = (@:checkr _i_3929897 ?? throw "null pointer dereference").out;
                    _gotoNext = 3929662i32;
                } else if (__value__ == (3930259i32)) {
                    if ((((@:checkr _i_3929897 ?? throw "null pointer dereference").arg : stdgo.GoInt) < (_cap.length) : Bool)) {
                        _gotoNext = 3930311i32;
                    } else {
                        _gotoNext = 3930425i32;
                    };
                } else if (__value__ == (3930311i32)) {
                    _opos_3930316 = _cap[((@:checkr _i_3929897 ?? throw "null pointer dereference").arg : stdgo.GoInt)];
                    _cap[((@:checkr _i_3929897 ?? throw "null pointer dereference").arg : stdgo.GoInt)] = _pos;
                    @:check2r _m._add(_q, (@:checkr _i_3929897 ?? throw "null pointer dereference").out, _pos, _cap, _cond, null);
                    _cap[((@:checkr _i_3929897 ?? throw "null pointer dereference").arg : stdgo.GoInt)] = _opos_3930316;
                    _gotoNext = 3930718i32;
                } else if (__value__ == (3930425i32)) {
                    _gotoNext = 3930425i32;
                    _pc = (@:checkr _i_3929897 ?? throw "null pointer dereference").out;
                    _gotoNext = 3929662i32;
                } else if (__value__ == (3930460i32)) {
                    if ((_t == null || (_t : Dynamic).__nil__)) {
                        _gotoNext = 3930577i32;
                    } else {
                        _gotoNext = 3930606i32;
                    };
                } else if (__value__ == (3930577i32)) {
                    _t = @:check2r _m._alloc(_i_3929897);
                    _gotoNext = 3930628i32;
                } else if (__value__ == (3930606i32)) {
                    _gotoNext = 3930606i32;
                    (@:checkr _t ?? throw "null pointer dereference")._inst = _i_3929897;
                    var __blank__ = 0i32;
                    _gotoNext = 3930628i32;
                } else if (__value__ == (3930628i32)) {
                    if ((((_cap.length) > (0 : stdgo.GoInt) : Bool) && (stdgo.Go.pointer((@:checkr _t ?? throw "null pointer dereference")._cap[(0 : stdgo.GoInt)]) != stdgo.Go.pointer(_cap[(0 : stdgo.GoInt)])) : Bool)) {
                        _gotoNext = 3930668i32;
                    } else {
                        _gotoNext = 3930696i32;
                    };
                } else if (__value__ == (3930668i32)) {
                    (@:checkr _t ?? throw "null pointer dereference")._cap.__copyTo__(_cap);
                    _gotoNext = 3930696i32;
                } else if (__value__ == (3930696i32)) {
                    (@:checkr _d_3929830 ?? throw "null pointer dereference")._t = _t;
                    _t = null;
                    _gotoNext = 3930718i32;
                } else if (__value__ == (3930718i32)) {
                    return _t;
                    _gotoNext = -1i32;
                };
            };
