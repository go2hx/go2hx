        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    {
                        _j_3766521 = _q._sparse[(_pc : stdgo.GoInt)];
                        if (((_j_3766521 < (_q._dense.length : stdgo.GoUInt32) : Bool) && (_q._dense[(_j_3766521 : stdgo.GoInt)]._pc == _pc) : Bool)) {
                    ...
                    _j_3766606 = (_q._dense.length);
                    _q._dense = (_q._dense.__slice__(0, (_j_3766606 + (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.regexp.Regexp_T_entry.T_entry>);
                    _d_3766650 = (stdgo.Go.setRef(_q._dense[(_j_3766606 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.Regexp_T_entry.T_entry>);
                    _d_3766650._t = null;
                    _d_3766650._pc = _pc;
                    _q._sparse[(_pc : stdgo.GoInt)] = (_j_3766606 : stdgo.GoUInt32);
                    _i_3766717 = (stdgo.Go.setRef(_m._p.inst[(_pc : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3766737i32;
                } else if (__value__ == (3766737i32)) {
                    {
                        final __value__ = _i_3766717.op;
                    ...
                    _t = _m._add(_q, _i_3766717.out, _pos, _cap, _cond, _t);
                    _pc = _i_3766717.arg;
                    _gotoNext = 3766482i32;
                } else if (__value__ == (3766929i32)) {
                    if (_cond.value._match((_i_3766717.arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp))) {
                    ...
                    if (((_i_3766717.arg : stdgo.GoInt) < (_cap.length) : Bool)) {
                        _gotoNext = 3767131i32;
                    } else {
                        _gotoNext = 3767245i32;
                    };
                } else if (__value__ == (3767131i32)) {
                    _opos_3767136 = _cap[(_i_3766717.arg : stdgo.GoInt)];
                    _cap[(_i_3766717.arg : stdgo.GoInt)] = _pos;
                    _m._add(_q, _i_3766717.out, _pos, _cap, _cond, null);
                    _cap[(_i_3766717.arg : stdgo.GoInt)] = _opos_3767136;
                    _gotoNext = 3767538i32;
