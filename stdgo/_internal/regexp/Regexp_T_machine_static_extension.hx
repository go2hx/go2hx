        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    {
                        _j_3718434 = _q._sparse[(_pc : stdgo.GoInt)];
                        if (((_j_3718434 < (_q._dense.length : stdgo.GoUInt32) : Bool) && (_q._dense[(_j_3718434 : stdgo.GoInt)]._pc == _pc) : Bool)) {
                    ...
                    _j_3718519 = (_q._dense.length);
                    _q._dense = (_q._dense.__slice__(0, (_j_3718519 + (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.regexp.Regexp_T_entry.T_entry>);
                    _d_3718563 = (stdgo.Go.setRef(_q._dense[(_j_3718519 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.Regexp_T_entry.T_entry>);
                    _d_3718563._t = null;
                    _d_3718563._pc = _pc;
                    _q._sparse[(_pc : stdgo.GoInt)] = (_j_3718519 : stdgo.GoUInt32);
                    _i_3718630 = (stdgo.Go.setRef(_m._p.inst[(_pc : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3718650i32;
                } else if (__value__ == (3718650i32)) {
                    {
                        final __value__ = _i_3718630.op;
                    ...
                    _t = _m._add(_q, _i_3718630.out, _pos, _cap, _cond, _t);
                    _pc = _i_3718630.arg;
                    _gotoNext = 3718395i32;
                } else if (__value__ == (3718842i32)) {
                    if (_cond.value._match((_i_3718630.arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp))) {
                    ...
                    if (((_i_3718630.arg : stdgo.GoInt) < (_cap.length) : Bool)) {
                        _gotoNext = 3719044i32;
                    } else {
                        _gotoNext = 3719158i32;
                    };
                } else if (__value__ == (3719044i32)) {
                    _opos_3719049 = _cap[(_i_3718630.arg : stdgo.GoInt)];
                    _cap[(_i_3718630.arg : stdgo.GoInt)] = _pos;
                    _m._add(_q, _i_3718630.out, _pos, _cap, _cond, null);
                    _cap[(_i_3718630.arg : stdgo.GoInt)] = _opos_3719049;
                    _gotoNext = 3719451i32;
