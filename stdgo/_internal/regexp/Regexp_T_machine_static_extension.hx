...
@:keep @:allow(stdgo._internal.regexp.Regexp.T_machine_asInterface) class T_machine_static_extension {
    ...
    static public function _add( _m:stdgo.Ref<stdgo._internal.regexp.Regexp_T_machine.T_machine>, _q:stdgo.Ref<stdgo._internal.regexp.Regexp_T_queue.T_queue>, _pc:stdgo.GoUInt32, _pos:stdgo.GoInt, _cap:stdgo.Slice<stdgo.GoInt>, _cond:stdgo.Pointer<stdgo._internal.regexp.Regexp_T_lazyFlag.T_lazyFlag>, _t:stdgo.Ref<stdgo._internal.regexp.Regexp_T_thread.T_thread>):stdgo.Ref<stdgo._internal.regexp.Regexp_T_thread.T_thread> {
        ...
        var _opos_3772823:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_3772404:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
        var _d_3772337:stdgo.Ref<stdgo._internal.regexp.Regexp_T_entry.T_entry> = (null : stdgo.Ref<stdgo._internal.regexp.Regexp_T_entry.T_entry>);
        var _j_3772293:stdgo.GoInt = (0 : stdgo.GoInt);
        var _j_3772208:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 3772169i32;
                } else if (__value__ == (3772169i32)) {
                    if (_pc == ((0u32 : stdgo.GoUInt32))) {
                        _gotoNext = 3772188i32;
                    } else {
                        _gotoNext = 3772205i32;
                    };
                } else if (__value__ == (3772188i32)) {
                    return _t;
                    _gotoNext = 3772205i32;
                } else if (__value__ == (3772205i32)) {
                    {
                        _j_3772208 = _q._sparse[(_pc : stdgo.GoInt)];
                        if (((_j_3772208 < (_q._dense.length : stdgo.GoUInt32) : Bool) && (_q._dense[(_j_3772208 : stdgo.GoInt)]._pc == _pc) : Bool)) {
                            _gotoNext = 3772275i32;
                        } else {
                            _gotoNext = 3772293i32;
                        };
                    };
                } else if (__value__ == (3772275i32)) {
                    return _t;
                    _gotoNext = 3772293i32;
                } else if (__value__ == (3772293i32)) {
                    _j_3772293 = (_q._dense.length);
                    _q._dense = (_q._dense.__slice__(0, (_j_3772293 + (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.regexp.Regexp_T_entry.T_entry>);
                    _d_3772337 = (stdgo.Go.setRef(_q._dense[(_j_3772293 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.Regexp_T_entry.T_entry>);
                    _d_3772337._t = null;
                    _d_3772337._pc = _pc;
                    _q._sparse[(_pc : stdgo.GoInt)] = (_j_3772293 : stdgo.GoUInt32);
                    _i_3772404 = (stdgo.Go.setRef(_m._p.inst[(_pc : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3772424i32;
                } else if (__value__ == (3772424i32)) {
                    {
                        final __value__ = _i_3772404.op;
                        if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3772470i32;
                        } else if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp)) || __value__ == ((1 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3772506i32;
                        } else if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3772616i32;
                        } else if (__value__ == ((6 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3772718i32;
                        } else if (__value__ == ((2 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3772766i32;
                            ...
                            _gotoNext = 3772967i32;
                        } else {
                            _gotoNext = 3772439i32;
                        };
                    };
                } else if (__value__ == (3772439i32)) {
                    throw stdgo.Go.toInterface(("unhandled" : stdgo.GoString));
                    _gotoNext = 3773225i32;
                } else if (__value__ == (3772470i32)) {
                    _gotoNext = 3773225i32;
                } else if (__value__ == (3772506i32)) {
                    _t = _m._add(_q, _i_3772404.out, _pos, _cap, _cond, _t);
                    _pc = _i_3772404.arg;
                    _gotoNext = 3772169i32;
                } else if (__value__ == (3772616i32)) {
                    if (_cond.value._match((_i_3772404.arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp))) {
                        _gotoNext = 3772683i32;
                    } else {
                        _gotoNext = 3773225i32;
                    };
                } else if (__value__ == (3772683i32)) {
                    _pc = _i_3772404.out;
                    _gotoNext = 3772169i32;
                } else if (__value__ == (3772718i32)) {
                    _pc = _i_3772404.out;
                    _gotoNext = 3772169i32;
                } else if (__value__ == (3772766i32)) {
                    if (((_i_3772404.arg : stdgo.GoInt) < (_cap.length) : Bool)) {
                        _gotoNext = 3772818i32;
                    } else {
                        _gotoNext = 3772932i32;
                    };
                } else if (__value__ == (3772818i32)) {
                    _opos_3772823 = _cap[(_i_3772404.arg : stdgo.GoInt)];
                    _cap[(_i_3772404.arg : stdgo.GoInt)] = _pos;
                    _m._add(_q, _i_3772404.out, _pos, _cap, _cond, null);
                    _cap[(_i_3772404.arg : stdgo.GoInt)] = _opos_3772823;
                    _gotoNext = 3773225i32;
                } else if (__value__ == (3772932i32)) {
                    _gotoNext = 3772932i32;
                    _pc = _i_3772404.out;
                    _gotoNext = 3772169i32;
                } else if (__value__ == (3772967i32)) {
                    if ((_t == null || (_t : Dynamic).__nil__)) {
                        _gotoNext = 3773084i32;
                    } else {
                        _gotoNext = 3773113i32;
                    };
                } else if (__value__ == (3773084i32)) {
                    _t = _m._alloc(_i_3772404);
                    _gotoNext = 3773135i32;
                } else if (__value__ == (3773113i32)) {
                    _gotoNext = 3773113i32;
                    _t._inst = _i_3772404;
                    var __blank__ = 0i32;
                    _gotoNext = 3773135i32;
                } else if (__value__ == (3773135i32)) {
                    if ((((_cap.length) > (0 : stdgo.GoInt) : Bool) && (stdgo.Go.pointer(_t._cap[(0 : stdgo.GoInt)]) != stdgo.Go.pointer(_cap[(0 : stdgo.GoInt)])) : Bool)) {
                        _gotoNext = 3773175i32;
                    } else {
                        _gotoNext = 3773203i32;
                    };
                } else if (__value__ == (3773175i32)) {
                    stdgo.Go.copySlice(_t._cap, _cap);
                    _gotoNext = 3773203i32;
                } else if (__value__ == (3773203i32)) {
                    _d_3772337._t = _t;
                    _t = null;
                    _gotoNext = 3773225i32;
                } else if (__value__ == (3773225i32)) {
                    return _t;
                    _gotoNext = -1i32;
                };
            };
