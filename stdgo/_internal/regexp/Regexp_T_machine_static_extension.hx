...
@:keep @:allow(stdgo._internal.regexp.Regexp.T_machine_asInterface) class T_machine_static_extension {
    ...
    static public function _add( _m:stdgo.Ref<stdgo._internal.regexp.Regexp_T_machine.T_machine>, _q:stdgo.Ref<stdgo._internal.regexp.Regexp_T_queue.T_queue>, _pc:stdgo.GoUInt32, _pos:stdgo.GoInt, _cap:stdgo.Slice<stdgo.GoInt>, _cond:stdgo.Pointer<stdgo._internal.regexp.Regexp_T_lazyFlag.T_lazyFlag>, _t:stdgo.Ref<stdgo._internal.regexp.Regexp_T_thread.T_thread>):stdgo.Ref<stdgo._internal.regexp.Regexp_T_thread.T_thread> {
        ...
        var _opos_3886663:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_3886244:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
        var _d_3886177:stdgo.Ref<stdgo._internal.regexp.Regexp_T_entry.T_entry> = (null : stdgo.Ref<stdgo._internal.regexp.Regexp_T_entry.T_entry>);
        var _j_3886133:stdgo.GoInt = (0 : stdgo.GoInt);
        var _j_3886048:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 3886009i32;
                } else if (__value__ == (3886009i32)) {
                    if (_pc == ((0u32 : stdgo.GoUInt32))) {
                        _gotoNext = 3886028i32;
                    } else {
                        _gotoNext = 3886045i32;
                    };
                } else if (__value__ == (3886028i32)) {
                    return _t;
                    _gotoNext = 3886045i32;
                } else if (__value__ == (3886045i32)) {
                    {
                        _j_3886048 = _q._sparse[(_pc : stdgo.GoInt)];
                        if (((_j_3886048 < (_q._dense.length : stdgo.GoUInt32) : Bool) && (_q._dense[(_j_3886048 : stdgo.GoInt)]._pc == _pc) : Bool)) {
                            _gotoNext = 3886115i32;
                        } else {
                            _gotoNext = 3886133i32;
                        };
                    };
                } else if (__value__ == (3886115i32)) {
                    return _t;
                    _gotoNext = 3886133i32;
                } else if (__value__ == (3886133i32)) {
                    _j_3886133 = (_q._dense.length);
                    _q._dense = (_q._dense.__slice__(0, (_j_3886133 + (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.regexp.Regexp_T_entry.T_entry>);
                    _d_3886177 = (stdgo.Go.setRef(_q._dense[(_j_3886133 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.Regexp_T_entry.T_entry>);
                    _d_3886177._t = null;
                    _d_3886177._pc = _pc;
                    _q._sparse[(_pc : stdgo.GoInt)] = (_j_3886133 : stdgo.GoUInt32);
                    _i_3886244 = (stdgo.Go.setRef(_m._p.inst[(_pc : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3886264i32;
                } else if (__value__ == (3886264i32)) {
                    {
                        final __value__ = _i_3886244.op;
                        if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3886310i32;
                        } else if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp)) || __value__ == ((1 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3886346i32;
                        } else if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3886456i32;
                        } else if (__value__ == ((6 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3886558i32;
                        } else if (__value__ == ((2 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3886606i32;
                    ...
                    _gotoNext = 3887065i32;
                } else if (__value__ == (3886310i32)) {
                    _gotoNext = 3887065i32;
                } else if (__value__ == (3886346i32)) {
                    _t = _m._add(_q, _i_3886244.out, _pos, _cap, _cond, _t);
                    _pc = _i_3886244.arg;
                    _gotoNext = 3886009i32;
                } else if (__value__ == (3886456i32)) {
                    if (_cond.value._match((_i_3886244.arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp))) {
                        _gotoNext = 3886523i32;
                    } else {
                        _gotoNext = 3887065i32;
                    };
                } else if (__value__ == (3886523i32)) {
                    _pc = _i_3886244.out;
                    _gotoNext = 3886009i32;
                } else if (__value__ == (3886558i32)) {
                    _pc = _i_3886244.out;
                    _gotoNext = 3886009i32;
                } else if (__value__ == (3886606i32)) {
                    if (((_i_3886244.arg : stdgo.GoInt) < (_cap.length) : Bool)) {
                        _gotoNext = 3886658i32;
                    } else {
                        _gotoNext = 3886772i32;
                    };
                } else if (__value__ == (3886658i32)) {
                    _opos_3886663 = _cap[(_i_3886244.arg : stdgo.GoInt)];
                    _cap[(_i_3886244.arg : stdgo.GoInt)] = _pos;
                    _m._add(_q, _i_3886244.out, _pos, _cap, _cond, null);
                    _cap[(_i_3886244.arg : stdgo.GoInt)] = _opos_3886663;
                    _gotoNext = 3887065i32;
                } else if (__value__ == (3886772i32)) {
                    _gotoNext = 3886772i32;
                    _pc = _i_3886244.out;
                    _gotoNext = 3886009i32;
                } else if (__value__ == (3886807i32)) {
                    if ((_t == null || (_t : Dynamic).__nil__)) {
                        _gotoNext = 3886924i32;
                    } else {
                        _gotoNext = 3886953i32;
                    };
                } else if (__value__ == (3886924i32)) {
                    _t = _m._alloc(_i_3886244);
                    _gotoNext = 3886975i32;
                } else if (__value__ == (3886953i32)) {
                    _gotoNext = 3886953i32;
                    _t._inst = _i_3886244;
                    var __blank__ = 0i32;
                    _gotoNext = 3886975i32;
                } else if (__value__ == (3886975i32)) {
                    if ((((_cap.length) > (0 : stdgo.GoInt) : Bool) && (stdgo.Go.pointer(_t._cap[(0 : stdgo.GoInt)]) != stdgo.Go.pointer(_cap[(0 : stdgo.GoInt)])) : Bool)) {
                        _gotoNext = 3887015i32;
                    } else {
                        _gotoNext = 3887043i32;
                    };
                } else if (__value__ == (3887015i32)) {
                    stdgo.Go.copySlice(_t._cap, _cap);
                    _gotoNext = 3887043i32;
                } else if (__value__ == (3887043i32)) {
                    _d_3886177._t = _t;
                    _t = null;
                    _gotoNext = 3887065i32;
                } else if (__value__ == (3887065i32)) {
                    return _t;
                    _gotoNext = -1i32;
                };
            };
