        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    {
                        _j_3768998 = _q._sparse[(_pc : stdgo.GoInt)];
                        if (((_j_3768998 < (_q._dense.length : stdgo.GoUInt32) : Bool) && (_q._dense[(_j_3768998 : stdgo.GoInt)]._pc == _pc) : Bool)) {
                    ...
                    _j_3769083 = (_q._dense.length);
                    _q._dense = (_q._dense.__slice__(0, (_j_3769083 + (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.regexp.Regexp_T_entry.T_entry>);
                    _d_3769127 = (stdgo.Go.setRef(_q._dense[(_j_3769083 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.Regexp_T_entry.T_entry>);
                    _d_3769127._t = null;
                    _d_3769127._pc = _pc;
                    _q._sparse[(_pc : stdgo.GoInt)] = (_j_3769083 : stdgo.GoUInt32);
                    _i_3769194 = (stdgo.Go.setRef(_m._p.inst[(_pc : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3769214i32;
                } else if (__value__ == (3769214i32)) {
                    {
                        final __value__ = _i_3769194.op;
                    ...
                    _t = _m._add(_q, _i_3769194.out, _pos, _cap, _cond, _t);
                    _pc = _i_3769194.arg;
                    _gotoNext = 3768959i32;
                } else if (__value__ == (3769406i32)) {
                    if (_cond.value._match((_i_3769194.arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp))) {
                    ...
                    if (((_i_3769194.arg : stdgo.GoInt) < (_cap.length) : Bool)) {
                        _gotoNext = 3769608i32;
                    } else {
                        _gotoNext = 3769722i32;
                    };
                } else if (__value__ == (3769608i32)) {
                    _opos_3769613 = _cap[(_i_3769194.arg : stdgo.GoInt)];
                    _cap[(_i_3769194.arg : stdgo.GoInt)] = _pos;
                    _m._add(_q, _i_3769194.out, _pos, _cap, _cond, null);
                    _cap[(_i_3769194.arg : stdgo.GoInt)] = _opos_3769613;
                    _gotoNext = 3770015i32;
