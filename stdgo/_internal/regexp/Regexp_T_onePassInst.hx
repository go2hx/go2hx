...
@:structInit @:using(stdgo._internal.regexp.Regexp_T_onePassInst_static_extension.T_onePassInst_static_extension) class T_onePassInst {
    ...
    public function get_matchEmptyWidth():(stdgo.GoInt32, stdgo.GoInt32) -> Bool return @:check3 this.inst.matchEmptyWidth;
    public var matchRune(get, never) : stdgo.GoInt32 -> Bool;
    @:embedded
    @:embeddededffieldsffun
    public function get_matchRune():stdgo.GoInt32 -> Bool return @:check3 this.inst.matchRune;
    public var matchRunePos(get, never) : stdgo.GoInt32 -> stdgo.GoInt;
    @:embedded
    @:embeddededffieldsffun
    public function get_matchRunePos():stdgo.GoInt32 -> stdgo.GoInt return @:check3 this.inst.matchRunePos;
    public var string(get, never) : () -> stdgo.GoString;
    @:embedded
    @:embeddededffieldsffun
    public function get_string():() -> stdgo.GoString return @:check3 this.inst.string;
    public var _op(get, never) : () -> stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp;
    @:embedded
    @:embeddededffieldsffun
    public function get__op():() -> stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp return @:check3 this.inst._op;
