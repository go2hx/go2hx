                    ...
                    if (__value__ == (0i32)) {
                        {
                            ...
                            _f_4913288 = __tmp__._0;
                            _err_4913291 = __tmp__._1;
                        };
                        ...
                        _lineno_4913399++;
                        {
                            var __tmp__ = _b_4913374.readString((10 : stdgo.GoUInt8));
                            _line_4913458 = __tmp__._0?.__copy__();
                            _err_4913464 = __tmp__._1;
                        };
                        ...
                        _t.errorf(("%s:%d: %v" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4913399), stdgo.Go.toInterface(_err_4913464));
                        _gotoNext = 4913583i32;
                        ...
                        _field_4914017 = stdgo._internal.regexp.Regexp__notab._notab.findAllString(_line_4913458?.__copy__(), (-1 : stdgo.GoInt));
                        ...
                        _field_4914017[(_i_4914062 : stdgo.GoInt)] = stdgo.Go.str()?.__copy__();
                        _gotoNext = 4914130i32;
                        ...
                        _t.logf(("%s:%d: skip: %s" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4913399), stdgo.Go.toInterface(_line_4913458));
                        _gotoNext = 4913439i32;
                        ...
                        {
                            {
                                ...
                                _flag_4917001 = __tmp__._1?.__copy__();
                                _ok_4917224 = __tmp__._2;
                            };
                            if (!_ok_4917224) {
                        ...
                        _t.logf(("skip: %s" : stdgo.GoString), stdgo.Go.toInterface(_line_4913458));
                        _gotoNext = 4913439i32;
                        ...
                        _t.errorf(("%s:%d: too few fields: %s" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4913399), stdgo.Go.toInterface(_line_4913458));
                        _gotoNext = 4913439i32;
                        ...
                        {
                            {
                                ...
                                _field_4914017[(1 : stdgo.GoInt)] = __tmp__._0?.__copy__();
                                _err_4913464 = __tmp__._1;
                            };
                            if (_err_4913464 != null) {
                        ...
                        _t.errorf(("%s:%d: cannot unquote %s" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4913399), stdgo.Go.toInterface(_f_4917733));
                        _gotoNext = 4917880i32;
                        ...
                        _f_4917733 = ((("\"" : stdgo.GoString) + _field_4914017[(2 : stdgo.GoInt)]?.__copy__() : stdgo.GoString) + ("\"" : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__();
                        {
                            {
                                var __tmp__ = stdgo._internal.strconv.Strconv_unquote.unquote(_f_4917733?.__copy__());
                                _field_4914017[(2 : stdgo.GoInt)] = __tmp__._0?.__copy__();
                                _err_4913464 = __tmp__._1;
                            };
                            if (_err_4913464 != null) {
                        ...
                        _text_4918264 = _field_4914017[(2 : stdgo.GoInt)]?.__copy__();
                        {
                            ...
                            _ok_4918320 = __tmp__._0;
                            _shouldCompile_4918324 = __tmp__._1;
                            _shouldMatch_4918339 = __tmp__._2;
                            _pos_4918352 = __tmp__._3;
                        };
                        if (!_ok_4918320) {
                        ...
                        _t.errorf(("%s:%d: cannot parse result %#q" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4913399), stdgo.Go.toInterface(_field_4914017[(3 : stdgo.GoInt)]));
                        _gotoNext = 4913439i32;
                    ...
                    } else if (__value__ == (4918994i32)) {
                        {
                            ...
                            _re_4918994 = __tmp__._0;
                            _err_4918998 = __tmp__._1;
                        };
                        ...
                        _t.errorf(("%s:%d: %#q did not compile" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4913399), stdgo.Go.toInterface(_pattern_4918666));
                        _gotoNext = 4919152i32;
                        ...
                        _t.errorf(("%s:%d: %#q should not compile" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4913399), stdgo.Go.toInterface(_pattern_4918666));
                        _i_4918650++;
                        _gotoNext = 4919918i32;
                    } else if (__value__ == (4919295i32)) {
                        _match_4919295 = _re_4918994.matchString(_text_4918264?.__copy__());
                        ...
                        _t.errorf(("%s:%d: %#q.Match(%#q) = %v, want %v" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4913399), stdgo.Go.toInterface(_pattern_4918666), stdgo.Go.toInterface(_text_4918264), stdgo.Go.toInterface(_match_4919295), stdgo.Go.toInterface(_shouldMatch_4918339));
                        _i_4918650++;
                        _gotoNext = 4919918i32;
                    } else if (__value__ == (4919484i32)) {
                        _have_4919484 = _re_4918994.findStringSubmatchIndex(_text_4918264?.__copy__());
                        ...
                        _t.errorf(("%s:%d: %#q.FindSubmatchIndex(%#q) = %v, want %v" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4913399), stdgo.Go.toInterface(_pattern_4918666), stdgo.Go.toInterface(_text_4918264), stdgo.Go.toInterface(_have_4919484), stdgo.Go.toInterface(_pos_4918352));
                        _gotoNext = 4918650i32;
