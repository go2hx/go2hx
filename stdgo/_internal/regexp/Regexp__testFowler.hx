            ...
            while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
                {
                    ...
                    if (__value__ == (0i32)) {
                        ...
                        _lastRegexp_4841635 = (stdgo.Go.str() : stdgo.GoString)?.__copy__();
                        ...
                        _field_4842240[(_i_4842285 : stdgo.GoInt)] = (stdgo.Go.str() : stdgo.GoString)?.__copy__();
                        _gotoNext = 4842353i32;
                        ...
                        if (_flag_4845224 == ((stdgo.Go.str() : stdgo.GoString))) {
