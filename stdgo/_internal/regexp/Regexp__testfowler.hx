            ...
            while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
                {
                    ...
                    if (__value__ == (0i32)) {
                        ...
                        _lastRegexp_4826164 = (stdgo.Go.str() : stdgo.GoString)?.__copy__();
                        ...
                        _field_4826769[(_i_4826814 : stdgo.GoInt)] = (stdgo.Go.str() : stdgo.GoString)?.__copy__();
                        _gotoNext = 4826882i32;
                        ...
                        if (_flag_4829753 == ((stdgo.Go.str() : stdgo.GoString))) {
