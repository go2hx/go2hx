...
function _testFowler(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>, _file:stdgo.GoString):Void {
        ...
        try {
            ...
            var _keys_5133367 = (new stdgo.Slice<stdgo.GoInt>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt>);
            var _c_57:stdgo.GoInt32 = (0 : stdgo.GoInt32);
            var _keys_5133108 = (new stdgo.Slice<stdgo.GoInt>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt>);
            var _i_5133120 = @:invalid_type null;
            ...
            var _values_5133108 = (new stdgo.Slice<stdgo.GoInt32>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt32>);
            ...
            var _values_5133367 = (new stdgo.Slice<stdgo.GoInt32>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt32>);
            var _f_48:stdgo.GoString = ("" : stdgo.GoString);
            var _text_52:stdgo.GoString = ("" : stdgo.GoString);
            var _i_5133379 = @:invalid_type null;
            ...
            while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
                {
                    ...
                    if (__value__ == (0i32)) {
                        ...
                        if (_err_40 != null) {
                            _gotoNext = 5127797i32;
                        } else {
                            _gotoNext = 5127827i32;
                        };
                    } else if (__value__ == (5127797i32)) {
                        @:check2r _t.error(stdgo.Go.toInterface(_err_40));
                        return;
                        _gotoNext = 5127827i32;
                    } else if (__value__ == (5127827i32)) {
                        {
                        ...
                        _gotoNext = 5127899i32;
                    } else if (__value__ == (5127899i32)) {
                        var __blank__ = 0i32;
                        readingBreak = false;
                        _gotoNext = 5127909i32;
                    } else if (__value__ == (5127909i32)) {
                        if (!readingBreak) {
                            _gotoNext = 5127913i32;
                        } else {
                            _gotoNext = 5134393i32;
                        };
                    } else if (__value__ == (5127913i32)) {
                        _lineno_42++;
                        {
                        ...
                        if (_err_45 != null) {
                            _gotoNext = 5127976i32;
                        } else {
                            _gotoNext = 5128394i32;
                        };
                    } else if (__value__ == (5127976i32)) {
                        if (stdgo.Go.toInterface(_err_45) != (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                            _gotoNext = 5127998i32;
                        } else {
                            _gotoNext = 5128053i32;
                        };
                    } else if (__value__ == (5127998i32)) {
                        ...
                        readingBreak = true;
                        _gotoNext = 5127909i32;
                    } else if (__value__ == (5128394i32)) {
                        if (((_line_44[(0 : stdgo.GoInt)] == (35 : stdgo.GoUInt8)) || (_line_44[(0 : stdgo.GoInt)] == (10 : stdgo.GoUInt8)) : Bool)) {
                            _gotoNext = 5128431i32;
                        } else {
                            _gotoNext = 5128459i32;
                        };
                    } else if (__value__ == (5128431i32)) {
                        _gotoNext = 5127909i32;
                    } else if (__value__ == (5128459i32)) {
                        ...
                        if ((0i32 : stdgo.GoInt) < (_field_46.length)) {
                            _gotoNext = 5128693i32;
                        } else {
                            _gotoNext = 5128698i32;
                        };
                    } else if (__value__ == (5128532i32)) {
                        _i_47++;
                        _gotoNext = 5128694i32;
                    } else if (__value__ == (5128552i32)) {
                        _f_48 = _field_46[(_i_47 : stdgo.GoInt)]?.__copy__();
                        if (_f_48 == (("NULL" : stdgo.GoString))) {
                            _gotoNext = 5128572i32;
                        } else {
                            _gotoNext = 5128600i32;
                        };
                    } else if (__value__ == (5128572i32)) {
                        _field_46[(_i_47 : stdgo.GoInt)] = (stdgo.Go.str() : stdgo.GoString)?.__copy__();
                        _gotoNext = 5128600i32;
                    } else if (__value__ == (5128600i32)) {
                        if (_f_48 == (("NIL" : stdgo.GoString))) {
                            _gotoNext = 5128614i32;
                        } else {
                            _gotoNext = 5128532i32;
                        };
                    } else if (__value__ == (5128614i32)) {
                        ...
                        _gotoNext = 5128694i32;
                    } else if (__value__ == (5128694i32)) {
                        if (_i_47 < (_field_46.length)) {
                            _gotoNext = 5128552i32;
                        } else {
                            _gotoNext = 5128698i32;
                        };
                    } else if (__value__ == (5128698i32)) {
                        if ((_field_46.length) == ((0 : stdgo.GoInt))) {
                            _gotoNext = 5128717i32;
                        } else {
                            _gotoNext = 5131471i32;
                        };
                    } else if (__value__ == (5128717i32)) {
                        _gotoNext = 5127909i32;
                    } else if (__value__ == (5131471i32)) {
                        _flag_49 = _field_46[(0 : stdgo.GoInt)]?.__copy__();
                        _gotoNext = 5131490i32;
                    } else if (__value__ == (5131490i32)) {
                        {
                            ...
                            if (__value__ == ((63 : stdgo.GoUInt8)) || __value__ == ((38 : stdgo.GoUInt8)) || __value__ == ((124 : stdgo.GoUInt8)) || __value__ == ((59 : stdgo.GoUInt8)) || __value__ == ((123 : stdgo.GoUInt8)) || __value__ == ((125 : stdgo.GoUInt8))) {
                                _gotoNext = 5131509i32;
                            } else if (__value__ == ((58 : stdgo.GoUInt8))) {
                                _gotoNext = 5131677i32;
                                ...
                                _gotoNext = 5131813i32;
                            } else {
                                _gotoNext = 5132016i32;
                            };
                        };
                    } else if (__value__ == (5131509i32)) {
                        _flag_49 = (_flag_49.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        if (_flag_49 == ((stdgo.Go.str() : stdgo.GoString))) {
                            _gotoNext = 5131647i32;
                        } else {
                            _gotoNext = 5132016i32;
                        };
                    } else if (__value__ == (5131647i32)) {
                        _gotoNext = 5127909i32;
                    } else if (__value__ == (5131677i32)) {
                        {
                            {
                            ...
                            if (!_ok_50) {
                                _gotoNext = 5131754i32;
                            } else {
                                _gotoNext = 5132016i32;
                            };
                        };
                    } else if (__value__ == (5131754i32)) {
                        @:check2r _t.logf(("skip: %s" : stdgo.GoString), stdgo.Go.toInterface(_line_44));
                        _gotoNext = 5127909i32;
                    } else if (__value__ == (5131813i32)) {
                        @:check2r _t.logf(("skip: %s" : stdgo.GoString), stdgo.Go.toInterface(_line_44));
                        _gotoNext = 5127909i32;
                    } else if (__value__ == (5132016i32)) {
                        if (((_field_46.length) < (4 : stdgo.GoInt) : Bool)) {
                            _gotoNext = 5132034i32;
                        } else {
                            _gotoNext = 5132167i32;
                        };
                    } else if (__value__ == (5132034i32)) {
                        ...
                        _gotoNext = 5127909i32;
                    } else if (__value__ == (5132167i32)) {
                        if (stdgo._internal.strings.Strings_contains.contains(_flag_49?.__copy__(), ("$" : stdgo.GoString))) {
                            _gotoNext = 5132198i32;
                        } else {
                            _gotoNext = 5132617i32;
                        };
                    } else if (__value__ == (5132198i32)) {
                        _f_51 = ((("\"" : stdgo.GoString) + _field_46[(1 : stdgo.GoInt)]?.__copy__() : stdgo.GoString) + ("\"" : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__();
                        {
                            ...
                            if (_err_45 != null) {
                                _gotoNext = 5132282i32;
                            } else {
                                _gotoNext = 5132350i32;
                            };
                        };
                    } else if (__value__ == (5132282i32)) {
                        ...
                        _f_51 = ((("\"" : stdgo.GoString) + _field_46[(2 : stdgo.GoInt)]?.__copy__() : stdgo.GoString) + ("\"" : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__();
                        {
                            ...
                            if (_err_45 != null) {
                                _gotoNext = 5132428i32;
                            } else {
                                _gotoNext = 5132617i32;
                            };
                        };
                    } else if (__value__ == (5132428i32)) {
                        @:check2r _t.errorf(("%s:%d: cannot unquote %s" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_42), stdgo.Go.toInterface(_f_51));
                        _gotoNext = 5132617i32;
                    } else if (__value__ == (5132617i32)) {
                        if (_field_46[(1 : stdgo.GoInt)] == (("SAME" : stdgo.GoString))) {
                            _gotoNext = 5132639i32;
                        } else {
                            _gotoNext = 5132672i32;
                        };
                    } else if (__value__ == (5132639i32)) {
                        _field_46[(1 : stdgo.GoInt)] = _lastRegexp_43?.__copy__();
                        _gotoNext = 5132672i32;
                    } else if (__value__ == (5132672i32)) {
                        ...
                        if (!_ok_53) {
                            _gotoNext = 5132866i32;
                        } else {
                            _gotoNext = 5133022i32;
                        };
                    } else if (__value__ == (5132866i32)) {
                        ...
                        _gotoNext = 5127909i32;
                    } else if (__value__ == (5133022i32)) {
                        _gotoNext = 5133022i32;
                        _keys_5133108 = (new stdgo.Slice<stdgo.GoInt>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt>);
                        _values_5133108 = (new stdgo.Slice<stdgo.GoInt32>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt32>);
                        for (_key => _value in _flag_49) {
                            _keys_5133108 = (_keys_5133108.__append__(_key));
                            _values_5133108 = (_values_5133108.__append__(_value));
                        };
                        if ((0i32 : stdgo.GoInt) < (_keys_5133108.length)) {
                            _gotoNext = 5134387i32;
                        } else {
                            _gotoNext = 5127909i32;
                        };
                    } else if (__value__ == (5133120i32)) {
                        _i_5133120++;
                        _gotoNext = 5134388i32;
                    } else if (__value__ == (5133131i32)) {
                        _c_57 = _values_5133108[@:invalid_index_invalid_type _i_5133120];
                        var __blank__ = _keys_5133108[@:invalid_index_invalid_type _i_5133120];
                        _pattern_58 = _field_46[(1 : stdgo.GoInt)]?.__copy__();
                        _syn_59 = (4 : stdgo._internal.regexp.syntax.Syntax_flags.Flags);
                        _gotoNext = 5133199i32;
                    } else if (__value__ == (5133199i32)) {
                        {
                            final __value__ = _c_57;
                            if (__value__ == ((69 : stdgo.GoInt32))) {
                                _gotoNext = 5133246i32;
                            } else if (__value__ == ((76 : stdgo.GoInt32))) {
                                _gotoNext = 5133300i32;
                            } else {
                                _gotoNext = 5133213i32;
                            };
                        };
                    } else if (__value__ == (5133213i32)) {
                        _i_5133120++;
                        _gotoNext = 5134388i32;
                    } else if (__value__ == (5133246i32)) {
                        _gotoNext = 5133367i32;
                    } else if (__value__ == (5133300i32)) {
                        _pattern_58 = stdgo._internal.regexp.Regexp_quotemeta.quoteMeta(_pattern_58?.__copy__())?.__copy__();
                        _gotoNext = 5133367i32;
                    } else if (__value__ == (5133367i32)) {
                        _keys_5133367 = (new stdgo.Slice<stdgo.GoInt>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt>);
                        _values_5133367 = (new stdgo.Slice<stdgo.GoInt32>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt32>);
                        for (_key => _value in _flag_49) {
                            _keys_5133367 = (_keys_5133367.__append__(_key));
                            _values_5133367 = (_values_5133367.__append__(_value));
                        };
                        if ((0i32 : stdgo.GoInt) < (_keys_5133367.length)) {
                            _gotoNext = 5133457i32;
                        } else {
                            _gotoNext = 5133464i32;
                        };
                    } else if (__value__ == (5133379i32)) {
                        _i_5133379++;
                        _gotoNext = 5133458i32;
                    } else if (__value__ == (5133390i32)) {
                        _c_60 = _values_5133367[@:invalid_index_invalid_type _i_5133379];
                        var __blank__ = _keys_5133367[@:invalid_index_invalid_type _i_5133379];
                        _gotoNext = 5133396i32;
                    } else if (__value__ == (5133396i32)) {
                        {
                            final __value__ = _c_60;
                            if (__value__ == ((105 : stdgo.GoInt32))) {
                                _gotoNext = 5133411i32;
                            } else {
                                _gotoNext = 5133379i32;
                            };
                        };
                    } else if (__value__ == (5133411i32)) {
                        _syn_59 = (_syn_59 | ((1 : stdgo._internal.regexp.syntax.Syntax_flags.Flags)) : stdgo._internal.regexp.syntax.Syntax_flags.Flags);
                        _gotoNext = 5133379i32;
                    } else if (__value__ == (5133457i32)) {
                        _i_5133379 = 0i32;
                        _gotoNext = 5133458i32;
                    } else if (__value__ == (5133458i32)) {
                        if (_i_5133379 < (_keys_5133367.length)) {
                            _gotoNext = 5133390i32;
                        } else {
                            _gotoNext = 5133464i32;
                        };
                    } else if (__value__ == (5133464i32)) {
                        {
                        ...
                        if (_err_62 != null) {
                            _gotoNext = 5133520i32;
                        } else {
                            _gotoNext = 5133647i32;
                        };
                    } else if (__value__ == (5133520i32)) {
                        if (_shouldCompile_54) {
                            _gotoNext = 5133543i32;
                        } else {
                            _gotoNext = 5133622i32;
                        };
                    } else if (__value__ == (5133543i32)) {
                        ...
                        _gotoNext = 5133622i32;
                    } else if (__value__ == (5133622i32)) {
                        _i_5133120++;
                        _gotoNext = 5134388i32;
                    } else if (__value__ == (5133647i32)) {
                        if (!_shouldCompile_54) {
                            _gotoNext = 5133665i32;
                        } else {
                            _gotoNext = 5133765i32;
                        };
                    } else if (__value__ == (5133665i32)) {
                        ...
                        _i_5133120++;
                        _gotoNext = 5134388i32;
                    } else if (__value__ == (5133765i32)) {
                        _match_63 = @:check2r _re_61.matchString(_text_52?.__copy__());
                        if (_match_63 != (_shouldMatch_55)) {
                            _gotoNext = 5133822i32;
                        } else {
                            _gotoNext = 5133954i32;
                        };
                    } else if (__value__ == (5133822i32)) {
                        ...
                        _i_5133120++;
                        _gotoNext = 5134388i32;
                    } else if (__value__ == (5134194i32)) {
                        if (((_have_64.length) > (_pos_56.length) : Bool)) {
                            _gotoNext = 5134218i32;
                        } else {
                            _gotoNext = 5134255i32;
                        };
                    } else if (__value__ == (5134218i32)) {
                        _have_64 = (_have_64.__slice__(0, (_pos_56.length)) : stdgo.Slice<stdgo.GoInt>);
                        _gotoNext = 5134255i32;
                    } else if (__value__ == (5134255i32)) {
                        if (!stdgo._internal.regexp.Regexp__same._same(_have_64, _pos_56)) {
                            _gotoNext = 5134275i32;
                        } else {
                            _gotoNext = 5133120i32;
                        };
                    } else if (__value__ == (5134275i32)) {
                        ...
                        _gotoNext = 5133120i32;
                    } else if (__value__ == (5134387i32)) {
                        _i_5133120 = 0i32;
                        _gotoNext = 5134388i32;
                    } else if (__value__ == (5134388i32)) {
                        if (_i_5133120 < (_keys_5133108.length)) {
                            _gotoNext = 5133131i32;
                        } else {
                            _gotoNext = 5127909i32;
                        };
                    } else if (__value__ == (5134393i32)) {
                        _gotoNext = -1i32;
                    };
                };
            };
