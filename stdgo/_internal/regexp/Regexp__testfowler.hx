                    ...
                    if (__value__ == (0i32)) {
                        {
                            ...
                            _f_4908580 = @:tmpset0 __tmp__._0;
                            _err_4908583 = @:tmpset0 __tmp__._1;
                        };
                        ...
                        @:check2r _t.error(stdgo.Go.toInterface(_err_4908583));
                        return;
                        _gotoNext = 4908649i32;
                    } else if (__value__ == (4908649i32)) {
                        {
                            final __f__ = @:check2r _f_4908580.close;
                        ...
                        _lastRegexp_4908704 = (stdgo.Go.str() : stdgo.GoString)?.__copy__();
                        ...
                        _lineno_4908691++;
                        {
                            var __tmp__ = @:check2r _b_4908666.readString((10 : stdgo.GoUInt8));
                            _line_4908750 = @:tmpset0 __tmp__._0?.__copy__();
                            _err_4908756 = @:tmpset0 __tmp__._1;
                        };
                        ...
                        @:check2r _t.errorf(("%s:%d: %v" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4908691), stdgo.Go.toInterface(_err_4908756));
                        _gotoNext = 4908875i32;
                        ...
                        _field_4909309 = @:check2r stdgo._internal.regexp.Regexp__notab._notab.findAllString(_line_4908750?.__copy__(), (-1 : stdgo.GoInt));
                        ...
                        _field_4909309[(_i_4909354 : stdgo.GoInt)] = (stdgo.Go.str() : stdgo.GoString)?.__copy__();
                        _gotoNext = 4909422i32;
                        ...
                        @:check2r _t.logf(("%s:%d: skip: %s" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4908691), stdgo.Go.toInterface(_line_4908750));
                        _gotoNext = 4908731i32;
                        ...
                        if (_flag_4912293 == ((stdgo.Go.str() : stdgo.GoString))) {
                        ...
                        {
                            {
                                ...
                                _flag_4912293 = @:tmpset0 __tmp__._1?.__copy__();
                                _ok_4912516 = @:tmpset0 __tmp__._2;
                            };
                            if (!_ok_4912516) {
                        ...
                        @:check2r _t.logf(("skip: %s" : stdgo.GoString), stdgo.Go.toInterface(_line_4908750));
                        _gotoNext = 4908731i32;
                        ...
                        @:check2r _t.errorf(("%s:%d: too few fields: %s" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4908691), stdgo.Go.toInterface(_line_4908750));
                        _gotoNext = 4908731i32;
                        ...
                        {
                            {
                                ...
                                _field_4909309[(1 : stdgo.GoInt)] = @:tmpset0 __tmp__._0?.__copy__();
                                _err_4908756 = @:tmpset0 __tmp__._1;
                            };
                            if (_err_4908756 != null) {
                        ...
                        @:check2r _t.errorf(("%s:%d: cannot unquote %s" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4908691), stdgo.Go.toInterface(_f_4913025));
                        _gotoNext = 4913172i32;
                        ...
                        _f_4913025 = ((("\"" : stdgo.GoString) + _field_4909309[(2 : stdgo.GoInt)]?.__copy__() : stdgo.GoString) + ("\"" : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__();
                        {
                            {
                                var __tmp__ = stdgo._internal.strconv.Strconv_unquote.unquote(_f_4913025?.__copy__());
                                _field_4909309[(2 : stdgo.GoInt)] = @:tmpset0 __tmp__._0?.__copy__();
                                _err_4908756 = @:tmpset0 __tmp__._1;
                            };
                            if (_err_4908756 != null) {
                        ...
                        _text_4913556 = _field_4909309[(2 : stdgo.GoInt)]?.__copy__();
                        {
                            ...
                            _ok_4913612 = @:tmpset0 __tmp__._0;
                            _shouldCompile_4913616 = @:tmpset0 __tmp__._1;
                            _shouldMatch_4913631 = @:tmpset0 __tmp__._2;
                            _pos_4913644 = @:tmpset0 __tmp__._3;
                        };
                        if (!_ok_4913612) {
                        ...
                        @:check2r _t.errorf(("%s:%d: cannot parse result %#q" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4908691), stdgo.Go.toInterface(_field_4909309[(3 : stdgo.GoInt)]));
                        _gotoNext = 4908731i32;
                    ...
                    } else if (__value__ == (4914286i32)) {
                        {
                            ...
                            _re_4914286 = @:tmpset0 __tmp__._0;
                            _err_4914290 = @:tmpset0 __tmp__._1;
                        };
                        ...
                        @:check2r _t.errorf(("%s:%d: %#q did not compile" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4908691), stdgo.Go.toInterface(_pattern_4913958));
                        _gotoNext = 4914444i32;
                        ...
                        @:check2r _t.errorf(("%s:%d: %#q should not compile" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4908691), stdgo.Go.toInterface(_pattern_4913958));
                        _i_4913942++;
                        _gotoNext = 4915210i32;
                    } else if (__value__ == (4914587i32)) {
                        _match_4914587 = @:check2r _re_4914286.matchString(_text_4913556?.__copy__());
                        ...
                        @:check2r _t.errorf(("%s:%d: %#q.Match(%#q) = %v, want %v" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4908691), stdgo.Go.toInterface(_pattern_4913958), stdgo.Go.toInterface(_text_4913556), stdgo.Go.toInterface(_match_4914587), stdgo.Go.toInterface(_shouldMatch_4913631));
                        _i_4913942++;
                        _gotoNext = 4915210i32;
                    } else if (__value__ == (4914776i32)) {
                        _have_4914776 = @:check2r _re_4914286.findStringSubmatchIndex(_text_4913556?.__copy__());
                        ...
                        @:check2r _t.errorf(("%s:%d: %#q.FindSubmatchIndex(%#q) = %v, want %v" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4908691), stdgo.Go.toInterface(_pattern_4913958), stdgo.Go.toInterface(_text_4913556), stdgo.Go.toInterface(_have_4914776), stdgo.Go.toInterface(_pos_4913644));
                        _gotoNext = 4913942i32;
