...
function _testFowler(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>, _file:stdgo.GoString):Void {
        ...
        try {
            var _values_5069626 = (new stdgo.Slice<stdgo.GoInt32>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt32>);
            var _shouldCompile_54:Bool = false;
            var _err_40:stdgo.Error = (null : stdgo.Error);
            var _keys_5069885 = (new stdgo.Slice<stdgo.GoInt>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt>);
            ...
            var _iterator_5069638 = @:invalid_type null;
            ...
            var _values_5069885 = (new stdgo.Slice<stdgo.GoInt32>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt32>);
            ...
            var _iterator_5069897 = @:invalid_type null;
            ...
            var _keys_5069626 = (new stdgo.Slice<stdgo.GoInt>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt>);
            ...
            while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
                {
                    ...
                    if (__value__ == (0i32)) {
                        ...
                        if (_err_40 != null) {
                            _gotoNext = 5064315i32;
                        } else {
                            _gotoNext = 5064345i32;
                        };
                    } else if (__value__ == (5064315i32)) {
                        @:check2r _t.error(stdgo.Go.toInterface(_err_40));
                        return;
                        _gotoNext = 5064345i32;
                    } else if (__value__ == (5064345i32)) {
                        {
                        ...
                        _gotoNext = 5064417i32;
                    } else if (__value__ == (5064417i32)) {
                        0i32;
                        readingBreak = false;
                        _gotoNext = 5064427i32;
                    } else if (__value__ == (5064427i32)) {
                        if (!readingBreak) {
                            _gotoNext = 5064431i32;
                        } else {
                            _gotoNext = 5070911i32;
                        };
                    } else if (__value__ == (5064431i32)) {
                        _lineno_42++;
                        {
                        ...
                        if (_err_45 != null) {
                            _gotoNext = 5064494i32;
                        } else {
                            _gotoNext = 5064912i32;
                        };
                    } else if (__value__ == (5064494i32)) {
                        if (stdgo.Go.toInterface(_err_45) != (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                            _gotoNext = 5064516i32;
                        } else {
                            _gotoNext = 5064571i32;
                        };
                    } else if (__value__ == (5064516i32)) {
                        ...
                        _gotoNext = 5064571i32;
                    } else if (__value__ == (5064571i32)) {
                        readingBreak = true;
                        _gotoNext = 5064427i32;
                    } else if (__value__ == (5064912i32)) {
                        if (((_line_44[(0 : stdgo.GoInt)] == (35 : stdgo.GoUInt8)) || (_line_44[(0 : stdgo.GoInt)] == (10 : stdgo.GoUInt8)) : Bool)) {
                            _gotoNext = 5064949i32;
                        } else {
                            _gotoNext = 5064977i32;
                        };
                    } else if (__value__ == (5064949i32)) {
                        _gotoNext = 5064427i32;
                    } else if (__value__ == (5064977i32)) {
                        ...
                        if ((0i32 : stdgo.GoInt) < (_field_46.length)) {
                            _gotoNext = 5065211i32;
                        } else {
                            _gotoNext = 5065216i32;
                        };
                    } else if (__value__ == (5065050i32)) {
                        _i_47++;
                        _gotoNext = 5065212i32;
                    } else if (__value__ == (5065070i32)) {
                        _f_48 = _field_46[(_i_47 : stdgo.GoInt)]?.__copy__();
                        if (_f_48 == (("NULL" : stdgo.GoString))) {
                            _gotoNext = 5065090i32;
                        } else {
                            _gotoNext = 5065118i32;
                        };
                    } else if (__value__ == (5065090i32)) {
                        _field_46[(_i_47 : stdgo.GoInt)] = (stdgo.Go.str() : stdgo.GoString)?.__copy__();
                        _gotoNext = 5065118i32;
                    } else if (__value__ == (5065118i32)) {
                        if (_f_48 == (("NIL" : stdgo.GoString))) {
                            _gotoNext = 5065132i32;
                        } else {
                            _gotoNext = 5065050i32;
                        };
                    } else if (__value__ == (5065132i32)) {
                        ...
                        _gotoNext = 5065212i32;
                    } else if (__value__ == (5065212i32)) {
                        if (_i_47 < (_field_46.length)) {
                            _gotoNext = 5065070i32;
                        } else {
                            _gotoNext = 5065216i32;
                        };
                    } else if (__value__ == (5065216i32)) {
                        if ((_field_46.length) == ((0 : stdgo.GoInt))) {
                            _gotoNext = 5065235i32;
                        } else {
                            _gotoNext = 5067989i32;
                        };
                    } else if (__value__ == (5065235i32)) {
                        _gotoNext = 5064427i32;
                    } else if (__value__ == (5067989i32)) {
                        _flag_49 = _field_46[(0 : stdgo.GoInt)]?.__copy__();
                        _gotoNext = 5068008i32;
                    } else if (__value__ == (5068008i32)) {
                        {
                            ...
                            if (__value__ == ((63 : stdgo.GoUInt8)) || __value__ == ((38 : stdgo.GoUInt8)) || __value__ == ((124 : stdgo.GoUInt8)) || __value__ == ((59 : stdgo.GoUInt8)) || __value__ == ((123 : stdgo.GoUInt8)) || __value__ == ((125 : stdgo.GoUInt8))) {
                                _gotoNext = 5068027i32;
                            } else if (__value__ == ((58 : stdgo.GoUInt8))) {
                                _gotoNext = 5068195i32;
                                ...
                                _gotoNext = 5068331i32;
                            } else {
                                _gotoNext = 5068534i32;
                            };
                        };
                    } else if (__value__ == (5068027i32)) {
                        _flag_49 = (_flag_49.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        if (_flag_49 == ((stdgo.Go.str() : stdgo.GoString))) {
                            _gotoNext = 5068165i32;
                        } else {
                            _gotoNext = 5068534i32;
                        };
                    } else if (__value__ == (5068165i32)) {
                        _gotoNext = 5064427i32;
                    } else if (__value__ == (5068195i32)) {
                        {
                            {
                            ...
                            if (!_ok_50) {
                                _gotoNext = 5068272i32;
                            } else {
                                _gotoNext = 5068534i32;
                            };
                        };
                    } else if (__value__ == (5068272i32)) {
                        @:check2r _t.logf(("skip: %s" : stdgo.GoString), stdgo.Go.toInterface(_line_44));
                        _gotoNext = 5064427i32;
                    } else if (__value__ == (5068331i32)) {
                        @:check2r _t.logf(("skip: %s" : stdgo.GoString), stdgo.Go.toInterface(_line_44));
                        _gotoNext = 5064427i32;
                    } else if (__value__ == (5068534i32)) {
                        if (((_field_46.length) < (4 : stdgo.GoInt) : Bool)) {
                            _gotoNext = 5068552i32;
                        } else {
                            _gotoNext = 5068685i32;
                        };
                    } else if (__value__ == (5068552i32)) {
                        ...
                        _gotoNext = 5064427i32;
                    } else if (__value__ == (5068685i32)) {
                        if (stdgo._internal.strings.Strings_contains.contains(_flag_49?.__copy__(), ("$" : stdgo.GoString))) {
                            _gotoNext = 5068716i32;
                        } else {
                            _gotoNext = 5069135i32;
                        };
                    } else if (__value__ == (5068716i32)) {
                        _f_51 = ((("\"" : stdgo.GoString) + _field_46[(1 : stdgo.GoInt)]?.__copy__() : stdgo.GoString) + ("\"" : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__();
                        {
                            ...
                            if (_err_45 != null) {
                                _gotoNext = 5068800i32;
                            } else {
                                _gotoNext = 5068868i32;
                            };
                        };
                    } else if (__value__ == (5068800i32)) {
                        ...
                        _f_51 = ((("\"" : stdgo.GoString) + _field_46[(2 : stdgo.GoInt)]?.__copy__() : stdgo.GoString) + ("\"" : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__();
                        {
                            ...
                            if (_err_45 != null) {
                                _gotoNext = 5068946i32;
                            } else {
                                _gotoNext = 5069135i32;
                            };
                        };
                    } else if (__value__ == (5068946i32)) {
                        @:check2r _t.errorf(("%s:%d: cannot unquote %s" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_42), stdgo.Go.toInterface(_f_51));
                        _gotoNext = 5069135i32;
                    } else if (__value__ == (5069135i32)) {
                        if (_field_46[(1 : stdgo.GoInt)] == (("SAME" : stdgo.GoString))) {
                            _gotoNext = 5069157i32;
                        } else {
                            _gotoNext = 5069190i32;
                        };
                    } else if (__value__ == (5069157i32)) {
                        _field_46[(1 : stdgo.GoInt)] = _lastRegexp_43?.__copy__();
                        _gotoNext = 5069190i32;
                    } else if (__value__ == (5069190i32)) {
                        ...
                        if (!_ok_53) {
                            _gotoNext = 5069384i32;
                        } else {
                            _gotoNext = 5069540i32;
                        };
                    } else if (__value__ == (5069384i32)) {
                        ...
                        _gotoNext = 5064427i32;
                    } else if (__value__ == (5069540i32)) {
                        _gotoNext = 5069540i32;
                        _keys_5069626 = (new stdgo.Slice<stdgo.GoInt>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt>);
                        _values_5069626 = (new stdgo.Slice<stdgo.GoInt32>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt32>);
                        for (_key => _value in _flag_49) {
                            _keys_5069626 = (_keys_5069626.__append__(_key));
                            _values_5069626 = (_values_5069626.__append__(_value));
                        };
                        if ((0i32 : stdgo.GoInt) < (_keys_5069626.length)) {
                            _gotoNext = 5070905i32;
                        } else {
                            _gotoNext = 5064427i32;
                        };
                    } else if (__value__ == (5069638i32)) {
                        _iterator_5069638++;
                        _gotoNext = 5070906i32;
                    } else if (__value__ == (5069649i32)) {
                        _c_57 = _values_5069626[@:invalid_index_invalid_type _iterator_5069638];
                        _keys_5069626[@:invalid_index_invalid_type _iterator_5069638];
                        _pattern_58 = _field_46[(1 : stdgo.GoInt)]?.__copy__();
                        _syn_59 = (4 : stdgo._internal.regexp.syntax.Syntax_flags.Flags);
                        _gotoNext = 5069717i32;
                    } else if (__value__ == (5069717i32)) {
                        {
                            final __value__ = _c_57;
                            if (__value__ == ((69 : stdgo.GoInt32))) {
                                _gotoNext = 5069764i32;
                            } else if (__value__ == ((76 : stdgo.GoInt32))) {
                                _gotoNext = 5069818i32;
                            } else {
                                _gotoNext = 5069731i32;
                            };
                        };
                    } else if (__value__ == (5069731i32)) {
                        _iterator_5069638++;
                        _gotoNext = 5070906i32;
                    } else if (__value__ == (5069764i32)) {
                        _gotoNext = 5069885i32;
                    } else if (__value__ == (5069818i32)) {
                        _pattern_58 = stdgo._internal.regexp.Regexp_quotemeta.quoteMeta(_pattern_58?.__copy__())?.__copy__();
                        _gotoNext = 5069885i32;
                    } else if (__value__ == (5069885i32)) {
                        _keys_5069885 = (new stdgo.Slice<stdgo.GoInt>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt>);
                        _values_5069885 = (new stdgo.Slice<stdgo.GoInt32>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt32>);
                        for (_key => _value in _flag_49) {
                            _keys_5069885 = (_keys_5069885.__append__(_key));
                            _values_5069885 = (_values_5069885.__append__(_value));
                        };
                        if ((0i32 : stdgo.GoInt) < (_keys_5069885.length)) {
                            _gotoNext = 5069975i32;
                        } else {
                            _gotoNext = 5069982i32;
                        };
                    } else if (__value__ == (5069897i32)) {
                        _iterator_5069897++;
                        _gotoNext = 5069976i32;
                    } else if (__value__ == (5069908i32)) {
                        _c_60 = _values_5069885[@:invalid_index_invalid_type _iterator_5069897];
                        _keys_5069885[@:invalid_index_invalid_type _iterator_5069897];
                        _gotoNext = 5069914i32;
                    } else if (__value__ == (5069914i32)) {
                        {
                            final __value__ = _c_60;
                            if (__value__ == ((105 : stdgo.GoInt32))) {
                                _gotoNext = 5069929i32;
                            } else {
                                _gotoNext = 5069897i32;
                            };
                        };
                    } else if (__value__ == (5069929i32)) {
                        _syn_59 = (_syn_59 | ((1 : stdgo._internal.regexp.syntax.Syntax_flags.Flags)) : stdgo._internal.regexp.syntax.Syntax_flags.Flags);
                        _gotoNext = 5069897i32;
                    } else if (__value__ == (5069975i32)) {
                        _iterator_5069897 = 0i32;
                        _gotoNext = 5069976i32;
                    } else if (__value__ == (5069976i32)) {
                        if (_iterator_5069897 < (_keys_5069885.length)) {
                            _gotoNext = 5069908i32;
                        } else {
                            _gotoNext = 5069982i32;
                        };
                    } else if (__value__ == (5069982i32)) {
                        {
                        ...
                        if (_err_62 != null) {
                            _gotoNext = 5070038i32;
                        } else {
                            _gotoNext = 5070165i32;
                        };
                    } else if (__value__ == (5070038i32)) {
                        if (_shouldCompile_54) {
                            _gotoNext = 5070061i32;
                        } else {
                            _gotoNext = 5070140i32;
                        };
                    } else if (__value__ == (5070061i32)) {
                        ...
                        _gotoNext = 5070140i32;
                    } else if (__value__ == (5070140i32)) {
                        _iterator_5069638++;
                        _gotoNext = 5070906i32;
                    } else if (__value__ == (5070165i32)) {
                        if (!_shouldCompile_54) {
                            _gotoNext = 5070183i32;
                        } else {
                            _gotoNext = 5070283i32;
                        };
                    } else if (__value__ == (5070183i32)) {
                        ...
                        _iterator_5069638++;
                        _gotoNext = 5070906i32;
                    } else if (__value__ == (5070283i32)) {
                        _match_63 = @:check2r _re_61.matchString(_text_52?.__copy__());
                        if (_match_63 != (_shouldMatch_55)) {
                            _gotoNext = 5070340i32;
                        } else {
                            _gotoNext = 5070472i32;
                        };
                    } else if (__value__ == (5070340i32)) {
                        ...
                        _iterator_5069638++;
                        _gotoNext = 5070906i32;
                    } else if (__value__ == (5070712i32)) {
                        if (((_have_64.length) > (_pos_56.length) : Bool)) {
                            _gotoNext = 5070736i32;
                        } else {
                            _gotoNext = 5070773i32;
                        };
                    } else if (__value__ == (5070736i32)) {
                        _have_64 = (_have_64.__slice__(0, (_pos_56.length)) : stdgo.Slice<stdgo.GoInt>);
                        _gotoNext = 5070773i32;
                    } else if (__value__ == (5070773i32)) {
                        if (!stdgo._internal.regexp.Regexp__same._same(_have_64, _pos_56)) {
                            _gotoNext = 5070793i32;
                        } else {
                            _gotoNext = 5069638i32;
                        };
                    } else if (__value__ == (5070793i32)) {
                        ...
                        _gotoNext = 5069638i32;
                    } else if (__value__ == (5070905i32)) {
                        _iterator_5069638 = 0i32;
                        _gotoNext = 5070906i32;
                    } else if (__value__ == (5070906i32)) {
                        if (_iterator_5069638 < (_keys_5069626.length)) {
                            _gotoNext = 5069649i32;
                        } else {
                            _gotoNext = 5064427i32;
                        };
                    } else if (__value__ == (5070911i32)) {
                        _gotoNext = -1i32;
                    };
                };
            };
