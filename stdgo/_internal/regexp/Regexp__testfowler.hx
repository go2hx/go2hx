...
function _testFowler(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>, _file:stdgo.GoString):Void {
        ...
        try {
            ...
            var _keys_5104521 = (new stdgo.Slice<stdgo.GoInt>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt>);
            ...
            var _values_5104780 = (new stdgo.Slice<stdgo.GoInt32>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt32>);
            var _keys_5104780 = (new stdgo.Slice<stdgo.GoInt>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt>);
            var _gotoNext = 0i32;
            ...
            while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
                {
                    ...
                    if (__value__ == (0i32)) {
                        ...
                        if (_err_40 != null) {
                            _gotoNext = 5099210i32;
                        } else {
                            _gotoNext = 5099240i32;
                        };
                    } else if (__value__ == (5099210i32)) {
                        @:check2r _t.error(stdgo.Go.toInterface(_err_40));
                        return;
                        _gotoNext = 5099240i32;
                    } else if (__value__ == (5099240i32)) {
                        {
                        ...
                        _gotoNext = 5099312i32;
                    } else if (__value__ == (5099312i32)) {
                        0i32;
                        readingBreak = false;
                        _gotoNext = 5099322i32;
                    } else if (__value__ == (5099322i32)) {
                        if (!readingBreak) {
                            _gotoNext = 5099326i32;
                        } else {
                            _gotoNext = 5105806i32;
                        };
                    } else if (__value__ == (5099326i32)) {
                        _lineno_42++;
                        {
                        ...
                        if (_err_45 != null) {
                            _gotoNext = 5099389i32;
                        } else {
                            _gotoNext = 5099807i32;
                        };
                    } else if (__value__ == (5099389i32)) {
                        if (stdgo.Go.toInterface(_err_45) != (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                            _gotoNext = 5099411i32;
                        } else {
                            _gotoNext = 5099466i32;
                        };
                    } else if (__value__ == (5099411i32)) {
                        ...
                        _gotoNext = 5099466i32;
                    } else if (__value__ == (5099466i32)) {
                        readingBreak = true;
                        _gotoNext = 5099322i32;
                    } else if (__value__ == (5099807i32)) {
                        if (((_line_44[(0 : stdgo.GoInt)] == (35 : stdgo.GoUInt8)) || (_line_44[(0 : stdgo.GoInt)] == (10 : stdgo.GoUInt8)) : Bool)) {
                            _gotoNext = 5099844i32;
                        } else {
                            _gotoNext = 5099872i32;
                        };
                    } else if (__value__ == (5099844i32)) {
                        _gotoNext = 5099322i32;
                    } else if (__value__ == (5099872i32)) {
                        ...
                        if ((0i32 : stdgo.GoInt) < (_field_46.length)) {
                            _gotoNext = 5100106i32;
                        } else {
                            _gotoNext = 5100111i32;
                        };
                    } else if (__value__ == (5099945i32)) {
                        _i_47++;
                        _gotoNext = 5100107i32;
                    } else if (__value__ == (5099965i32)) {
                        _f_48 = _field_46[(_i_47 : stdgo.GoInt)]?.__copy__();
                        if (_f_48 == (("NULL" : stdgo.GoString))) {
                            _gotoNext = 5099985i32;
                        } else {
                            _gotoNext = 5100013i32;
                        };
                    } else if (__value__ == (5099985i32)) {
                        _field_46[(_i_47 : stdgo.GoInt)] = (stdgo.Go.str() : stdgo.GoString)?.__copy__();
                        _gotoNext = 5100013i32;
                    } else if (__value__ == (5100013i32)) {
                        if (_f_48 == (("NIL" : stdgo.GoString))) {
                            _gotoNext = 5100027i32;
                        } else {
                            _gotoNext = 5099945i32;
                        };
                    } else if (__value__ == (5100027i32)) {
                        ...
                        _gotoNext = 5100107i32;
                    } else if (__value__ == (5100107i32)) {
                        if (_i_47 < (_field_46.length)) {
                            _gotoNext = 5099965i32;
                        } else {
                            _gotoNext = 5100111i32;
                        };
                    } else if (__value__ == (5100111i32)) {
                        if ((_field_46.length) == ((0 : stdgo.GoInt))) {
                            _gotoNext = 5100130i32;
                        } else {
                            _gotoNext = 5102884i32;
                        };
                    } else if (__value__ == (5100130i32)) {
                        _gotoNext = 5099322i32;
                    } else if (__value__ == (5102884i32)) {
                        _flag_49 = _field_46[(0 : stdgo.GoInt)]?.__copy__();
                        _gotoNext = 5102903i32;
                    } else if (__value__ == (5102903i32)) {
                        {
                            ...
                            if (__value__ == ((63 : stdgo.GoUInt8)) || __value__ == ((38 : stdgo.GoUInt8)) || __value__ == ((124 : stdgo.GoUInt8)) || __value__ == ((59 : stdgo.GoUInt8)) || __value__ == ((123 : stdgo.GoUInt8)) || __value__ == ((125 : stdgo.GoUInt8))) {
                                _gotoNext = 5102922i32;
                            } else if (__value__ == ((58 : stdgo.GoUInt8))) {
                                _gotoNext = 5103090i32;
                                ...
                                _gotoNext = 5103226i32;
                            } else {
                                _gotoNext = 5103429i32;
                            };
                        };
                    } else if (__value__ == (5102922i32)) {
                        _flag_49 = (_flag_49.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        if (_flag_49 == ((stdgo.Go.str() : stdgo.GoString))) {
                            _gotoNext = 5103060i32;
                        } else {
                            _gotoNext = 5103429i32;
                        };
                    } else if (__value__ == (5103060i32)) {
                        _gotoNext = 5099322i32;
                    } else if (__value__ == (5103090i32)) {
                        {
                            {
                            ...
                            if (!_ok_50) {
                                _gotoNext = 5103167i32;
                            } else {
                                _gotoNext = 5103429i32;
                            };
                        };
                    } else if (__value__ == (5103167i32)) {
                        @:check2r _t.logf(("skip: %s" : stdgo.GoString), stdgo.Go.toInterface(_line_44));
                        _gotoNext = 5099322i32;
                    } else if (__value__ == (5103226i32)) {
                        @:check2r _t.logf(("skip: %s" : stdgo.GoString), stdgo.Go.toInterface(_line_44));
                        _gotoNext = 5099322i32;
                    } else if (__value__ == (5103429i32)) {
                        if (((_field_46.length) < (4 : stdgo.GoInt) : Bool)) {
                            _gotoNext = 5103447i32;
                        } else {
                            _gotoNext = 5103580i32;
                        };
                    } else if (__value__ == (5103447i32)) {
                        ...
                        _gotoNext = 5099322i32;
                    } else if (__value__ == (5103580i32)) {
                        if (stdgo._internal.strings.Strings_contains.contains(_flag_49?.__copy__(), ("$" : stdgo.GoString))) {
                            _gotoNext = 5103611i32;
                        } else {
                            _gotoNext = 5104030i32;
                        };
                    } else if (__value__ == (5103611i32)) {
                        _f_51 = ((("\"" : stdgo.GoString) + _field_46[(1 : stdgo.GoInt)]?.__copy__() : stdgo.GoString) + ("\"" : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__();
                        {
                            ...
                            if (_err_45 != null) {
                                _gotoNext = 5103695i32;
                            } else {
                                _gotoNext = 5103763i32;
                            };
                        };
                    } else if (__value__ == (5103695i32)) {
                        ...
                        _f_51 = ((("\"" : stdgo.GoString) + _field_46[(2 : stdgo.GoInt)]?.__copy__() : stdgo.GoString) + ("\"" : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__();
                        {
                            ...
                            if (_err_45 != null) {
                                _gotoNext = 5103841i32;
                            } else {
                                _gotoNext = 5104030i32;
                            };
                        };
                    } else if (__value__ == (5103841i32)) {
                        @:check2r _t.errorf(("%s:%d: cannot unquote %s" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_42), stdgo.Go.toInterface(_f_51));
                        _gotoNext = 5104030i32;
                    } else if (__value__ == (5104030i32)) {
                        if (_field_46[(1 : stdgo.GoInt)] == (("SAME" : stdgo.GoString))) {
                            _gotoNext = 5104052i32;
                        } else {
                            _gotoNext = 5104085i32;
                        };
                    } else if (__value__ == (5104052i32)) {
                        _field_46[(1 : stdgo.GoInt)] = _lastRegexp_43?.__copy__();
                        _gotoNext = 5104085i32;
                    } else if (__value__ == (5104085i32)) {
                        ...
                        if (!_ok_53) {
                            _gotoNext = 5104279i32;
                        } else {
                            _gotoNext = 5104435i32;
                        };
                    } else if (__value__ == (5104279i32)) {
                        ...
                        _gotoNext = 5099322i32;
                    } else if (__value__ == (5104435i32)) {
                        _gotoNext = 5104435i32;
                        _keys_5104521 = (new stdgo.Slice<stdgo.GoInt>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt>);
                        _values_5104521 = (new stdgo.Slice<stdgo.GoInt32>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt32>);
                        for (_key => _value in _flag_49) {
                            _keys_5104521 = (_keys_5104521.__append__(_key));
                            _values_5104521 = (_values_5104521.__append__(_value));
                        };
                        if ((0i32 : stdgo.GoInt) < (_keys_5104521.length)) {
                            _gotoNext = 5105800i32;
                        } else {
                            _gotoNext = 5099322i32;
                        };
                    } else if (__value__ == (5104533i32)) {
                        _iterator_5104533++;
                        _gotoNext = 5105801i32;
                    } else if (__value__ == (5104544i32)) {
                        _c_57 = _values_5104521[@:invalid_index_invalid_type _iterator_5104533];
                        _keys_5104521[@:invalid_index_invalid_type _iterator_5104533];
                        _pattern_58 = _field_46[(1 : stdgo.GoInt)]?.__copy__();
                        _syn_59 = (4 : stdgo._internal.regexp.syntax.Syntax_flags.Flags);
                        _gotoNext = 5104612i32;
                    } else if (__value__ == (5104612i32)) {
                        {
                            final __value__ = _c_57;
                            if (__value__ == ((69 : stdgo.GoInt32))) {
                                _gotoNext = 5104659i32;
                            } else if (__value__ == ((76 : stdgo.GoInt32))) {
                                _gotoNext = 5104713i32;
                            } else {
                                _gotoNext = 5104626i32;
                            };
                        };
                    } else if (__value__ == (5104626i32)) {
                        _iterator_5104533++;
                        _gotoNext = 5105801i32;
                    } else if (__value__ == (5104659i32)) {
                        _gotoNext = 5104780i32;
                    } else if (__value__ == (5104713i32)) {
                        _pattern_58 = stdgo._internal.regexp.Regexp_quotemeta.quoteMeta(_pattern_58?.__copy__())?.__copy__();
                        _gotoNext = 5104780i32;
                    } else if (__value__ == (5104780i32)) {
                        _keys_5104780 = (new stdgo.Slice<stdgo.GoInt>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt>);
                        _values_5104780 = (new stdgo.Slice<stdgo.GoInt32>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt32>);
                        for (_key => _value in _flag_49) {
                            _keys_5104780 = (_keys_5104780.__append__(_key));
                            _values_5104780 = (_values_5104780.__append__(_value));
                        };
                        if ((0i32 : stdgo.GoInt) < (_keys_5104780.length)) {
                            _gotoNext = 5104870i32;
                        } else {
                            _gotoNext = 5104877i32;
                        };
                    } else if (__value__ == (5104792i32)) {
                        _iterator_5104792++;
                        _gotoNext = 5104871i32;
                    } else if (__value__ == (5104803i32)) {
                        _c_60 = _values_5104780[@:invalid_index_invalid_type _iterator_5104792];
                        _keys_5104780[@:invalid_index_invalid_type _iterator_5104792];
                        _gotoNext = 5104809i32;
                    } else if (__value__ == (5104809i32)) {
                        {
                            final __value__ = _c_60;
                            if (__value__ == ((105 : stdgo.GoInt32))) {
                                _gotoNext = 5104824i32;
                            } else {
                                _gotoNext = 5104792i32;
                            };
                        };
                    } else if (__value__ == (5104824i32)) {
                        _syn_59 = (_syn_59 | ((1 : stdgo._internal.regexp.syntax.Syntax_flags.Flags)) : stdgo._internal.regexp.syntax.Syntax_flags.Flags);
                        _gotoNext = 5104792i32;
                    } else if (__value__ == (5104870i32)) {
                        _iterator_5104792 = 0i32;
                        _gotoNext = 5104871i32;
                    } else if (__value__ == (5104871i32)) {
                        if (_iterator_5104792 < (_keys_5104780.length)) {
                            _gotoNext = 5104803i32;
                        } else {
                            _gotoNext = 5104877i32;
                        };
                    } else if (__value__ == (5104877i32)) {
                        {
                        ...
                        if (_err_62 != null) {
                            _gotoNext = 5104933i32;
                        } else {
                            _gotoNext = 5105060i32;
                        };
                    } else if (__value__ == (5104933i32)) {
                        if (_shouldCompile_54) {
                            _gotoNext = 5104956i32;
                        } else {
                            _gotoNext = 5105035i32;
                        };
                    } else if (__value__ == (5104956i32)) {
                        ...
                        _gotoNext = 5105035i32;
                    } else if (__value__ == (5105035i32)) {
                        _iterator_5104533++;
                        _gotoNext = 5105801i32;
                    } else if (__value__ == (5105060i32)) {
                        if (!_shouldCompile_54) {
                            _gotoNext = 5105078i32;
                        } else {
                            _gotoNext = 5105178i32;
                        };
                    } else if (__value__ == (5105078i32)) {
                        ...
                        _iterator_5104533++;
                        _gotoNext = 5105801i32;
                    } else if (__value__ == (5105178i32)) {
                        _match_63 = @:check2r _re_61.matchString(_text_52?.__copy__());
                        if (_match_63 != (_shouldMatch_55)) {
                            _gotoNext = 5105235i32;
                        } else {
                            _gotoNext = 5105367i32;
                        };
                    } else if (__value__ == (5105235i32)) {
                        ...
                        _iterator_5104533++;
                        _gotoNext = 5105801i32;
                    } else if (__value__ == (5105607i32)) {
                        if (((_have_64.length) > (_pos_56.length) : Bool)) {
                            _gotoNext = 5105631i32;
                        } else {
                            _gotoNext = 5105668i32;
                        };
                    } else if (__value__ == (5105631i32)) {
                        _have_64 = (_have_64.__slice__(0, (_pos_56.length)) : stdgo.Slice<stdgo.GoInt>);
                        _gotoNext = 5105668i32;
                    } else if (__value__ == (5105668i32)) {
                        if (!stdgo._internal.regexp.Regexp__same._same(_have_64, _pos_56)) {
                            _gotoNext = 5105688i32;
                        } else {
                            _gotoNext = 5104533i32;
                        };
                    } else if (__value__ == (5105688i32)) {
                        ...
                        _gotoNext = 5104533i32;
                    } else if (__value__ == (5105800i32)) {
                        _iterator_5104533 = 0i32;
                        _gotoNext = 5105801i32;
                    } else if (__value__ == (5105801i32)) {
                        if (_iterator_5104533 < (_keys_5104521.length)) {
                            _gotoNext = 5104544i32;
                        } else {
                            _gotoNext = 5099322i32;
                        };
                    } else if (__value__ == (5105806i32)) {
                        _gotoNext = -1i32;
                    };
                };
            };
