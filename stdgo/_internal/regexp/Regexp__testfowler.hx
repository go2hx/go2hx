                    ...
                    if (__value__ == (0i32)) {
                        {
                            ...
                            _f_4826549 = @:tmpset0 __tmp__._0;
                            _err_4826552 = @:tmpset0 __tmp__._1;
                        };
                        ...
                        @:check2r _t.error(stdgo.Go.toInterface(_err_4826552));
                        return;
                        _gotoNext = 4826618i32;
                    } else if (__value__ == (4826618i32)) {
                        {
                            final __f__ = @:check2r _f_4826549.close;
                        ...
                        _lastRegexp_4826673 = (stdgo.Go.str() : stdgo.GoString)?.__copy__();
                        ...
                        _lineno_4826660++;
                        {
                            var __tmp__ = @:check2r _b_4826635.readString((10 : stdgo.GoUInt8));
                            _line_4826719 = @:tmpset0 __tmp__._0?.__copy__();
                            _err_4826725 = @:tmpset0 __tmp__._1;
                        };
                        ...
                        @:check2r _t.errorf(("%s:%d: %v" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4826660), stdgo.Go.toInterface(_err_4826725));
                        _gotoNext = 4826844i32;
                        ...
                        _field_4827278 = @:check2r stdgo._internal.regexp.Regexp__notab._notab.findAllString(_line_4826719?.__copy__(), (-1 : stdgo.GoInt));
                        ...
                        _field_4827278[(_i_4827323 : stdgo.GoInt)] = (stdgo.Go.str() : stdgo.GoString)?.__copy__();
                        _gotoNext = 4827391i32;
                        ...
                        @:check2r _t.logf(("%s:%d: skip: %s" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4826660), stdgo.Go.toInterface(_line_4826719));
                        _gotoNext = 4826700i32;
                        ...
                        if (_flag_4830262 == ((stdgo.Go.str() : stdgo.GoString))) {
                        ...
                        {
                            {
                                ...
                                _flag_4830262 = @:tmpset0 __tmp__._1?.__copy__();
                                _ok_4830485 = @:tmpset0 __tmp__._2;
                            };
                            if (!_ok_4830485) {
                        ...
                        @:check2r _t.logf(("skip: %s" : stdgo.GoString), stdgo.Go.toInterface(_line_4826719));
                        _gotoNext = 4826700i32;
                        ...
                        @:check2r _t.errorf(("%s:%d: too few fields: %s" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4826660), stdgo.Go.toInterface(_line_4826719));
                        _gotoNext = 4826700i32;
                        ...
                        {
                            {
                                ...
                                _field_4827278[(1 : stdgo.GoInt)] = @:tmpset0 __tmp__._0?.__copy__();
                                _err_4826725 = @:tmpset0 __tmp__._1;
                            };
                            if (_err_4826725 != null) {
                        ...
                        @:check2r _t.errorf(("%s:%d: cannot unquote %s" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4826660), stdgo.Go.toInterface(_f_4830994));
                        _gotoNext = 4831141i32;
                        ...
                        _f_4830994 = ((("\"" : stdgo.GoString) + _field_4827278[(2 : stdgo.GoInt)]?.__copy__() : stdgo.GoString) + ("\"" : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__();
                        {
                            {
                                var __tmp__ = stdgo._internal.strconv.Strconv_unquote.unquote(_f_4830994?.__copy__());
                                _field_4827278[(2 : stdgo.GoInt)] = @:tmpset0 __tmp__._0?.__copy__();
                                _err_4826725 = @:tmpset0 __tmp__._1;
                            };
                            if (_err_4826725 != null) {
                        ...
                        _text_4831525 = _field_4827278[(2 : stdgo.GoInt)]?.__copy__();
                        {
                            ...
                            _ok_4831581 = @:tmpset0 __tmp__._0;
                            _shouldCompile_4831585 = @:tmpset0 __tmp__._1;
                            _shouldMatch_4831600 = @:tmpset0 __tmp__._2;
                            _pos_4831613 = @:tmpset0 __tmp__._3;
                        };
                        if (!_ok_4831581) {
                        ...
                        @:check2r _t.errorf(("%s:%d: cannot parse result %#q" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4826660), stdgo.Go.toInterface(_field_4827278[(3 : stdgo.GoInt)]));
                        _gotoNext = 4826700i32;
                    ...
                    } else if (__value__ == (4832255i32)) {
                        {
                            ...
                            _re_4832255 = @:tmpset0 __tmp__._0;
                            _err_4832259 = @:tmpset0 __tmp__._1;
                        };
                        ...
                        @:check2r _t.errorf(("%s:%d: %#q did not compile" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4826660), stdgo.Go.toInterface(_pattern_4831927));
                        _gotoNext = 4832413i32;
                        ...
                        @:check2r _t.errorf(("%s:%d: %#q should not compile" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4826660), stdgo.Go.toInterface(_pattern_4831927));
                        _i_4831911++;
                        _gotoNext = 4833179i32;
                    } else if (__value__ == (4832556i32)) {
                        _match_4832556 = @:check2r _re_4832255.matchString(_text_4831525?.__copy__());
                        ...
                        @:check2r _t.errorf(("%s:%d: %#q.Match(%#q) = %v, want %v" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4826660), stdgo.Go.toInterface(_pattern_4831927), stdgo.Go.toInterface(_text_4831525), stdgo.Go.toInterface(_match_4832556), stdgo.Go.toInterface(_shouldMatch_4831600));
                        _i_4831911++;
                        _gotoNext = 4833179i32;
                    } else if (__value__ == (4832745i32)) {
                        _have_4832745 = @:check2r _re_4832255.findStringSubmatchIndex(_text_4831525?.__copy__());
                        ...
                        @:check2r _t.errorf(("%s:%d: %#q.FindSubmatchIndex(%#q) = %v, want %v" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_4826660), stdgo.Go.toInterface(_pattern_4831927), stdgo.Go.toInterface(_text_4831525), stdgo.Go.toInterface(_have_4832745), stdgo.Go.toInterface(_pos_4831613));
                        _gotoNext = 4831911i32;
