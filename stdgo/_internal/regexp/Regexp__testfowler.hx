...
function _testFowler(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>, _file:stdgo.GoString):Void {
        ...
        try {
            ...
            var _values_5104271 = (new stdgo.Slice<stdgo.GoInt32>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt32>);
            var _i_5104283 = @:invalid_type null;
            ...
            var _keys_5104012 = (new stdgo.Slice<stdgo.GoInt>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt>);
            var _shouldMatch_55:Bool = false;
            var _text_52:stdgo.GoString = ("" : stdgo.GoString);
            var _keys_5104271 = (new stdgo.Slice<stdgo.GoInt>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt>);
            ...
            var _i_5104024 = @:invalid_type null;
            ...
            var _values_5104012 = (new stdgo.Slice<stdgo.GoInt32>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt32>);
            ...
            while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
                {
                    ...
                    if (__value__ == (0i32)) {
                        ...
                        if (_err_40 != null) {
                            _gotoNext = 5098701i32;
                        } else {
                            _gotoNext = 5098731i32;
                        };
                    } else if (__value__ == (5098701i32)) {
                        @:check2r _t.error(stdgo.Go.toInterface(_err_40));
                        return;
                        _gotoNext = 5098731i32;
                    } else if (__value__ == (5098731i32)) {
                        {
                        ...
                        _gotoNext = 5098803i32;
                    } else if (__value__ == (5098803i32)) {
                        var __blank__ = 0i32;
                        readingBreak = false;
                        _gotoNext = 5098813i32;
                    } else if (__value__ == (5098813i32)) {
                        if (!readingBreak) {
                            _gotoNext = 5098817i32;
                        } else {
                            _gotoNext = 5105297i32;
                        };
                    } else if (__value__ == (5098817i32)) {
                        _lineno_42++;
                        {
                        ...
                        if (_err_45 != null) {
                            _gotoNext = 5098880i32;
                        } else {
                            _gotoNext = 5099298i32;
                        };
                    } else if (__value__ == (5098880i32)) {
                        if (stdgo.Go.toInterface(_err_45) != (stdgo.Go.toInterface(stdgo._internal.io.Io_eof.eOF))) {
                            _gotoNext = 5098902i32;
                        } else {
                            _gotoNext = 5098957i32;
                        };
                    } else if (__value__ == (5098902i32)) {
                        ...
                        _gotoNext = 5098957i32;
                    } else if (__value__ == (5098957i32)) {
                        readingBreak = true;
                        _gotoNext = 5098813i32;
                    } else if (__value__ == (5099298i32)) {
                        if (((_line_44[(0 : stdgo.GoInt)] == (35 : stdgo.GoUInt8)) || (_line_44[(0 : stdgo.GoInt)] == (10 : stdgo.GoUInt8)) : Bool)) {
                            _gotoNext = 5099335i32;
                        } else {
                            _gotoNext = 5099363i32;
                        };
                    } else if (__value__ == (5099335i32)) {
                        _gotoNext = 5098813i32;
                    } else if (__value__ == (5099363i32)) {
                        ...
                        if ((0i32 : stdgo.GoInt) < (_field_46.length)) {
                            _gotoNext = 5099597i32;
                        } else {
                            _gotoNext = 5099602i32;
                        };
                    } else if (__value__ == (5099436i32)) {
                        _i_47++;
                        _gotoNext = 5099598i32;
                    } else if (__value__ == (5099456i32)) {
                        _f_48 = _field_46[(_i_47 : stdgo.GoInt)]?.__copy__();
                        if (_f_48 == (("NULL" : stdgo.GoString))) {
                            _gotoNext = 5099476i32;
                        } else {
                            _gotoNext = 5099504i32;
                        };
                    } else if (__value__ == (5099476i32)) {
                        _field_46[(_i_47 : stdgo.GoInt)] = (stdgo.Go.str() : stdgo.GoString)?.__copy__();
                        _gotoNext = 5099504i32;
                    } else if (__value__ == (5099504i32)) {
                        if (_f_48 == (("NIL" : stdgo.GoString))) {
                            _gotoNext = 5099518i32;
                        } else {
                            _gotoNext = 5099436i32;
                        };
                    } else if (__value__ == (5099518i32)) {
                        ...
                        _gotoNext = 5099598i32;
                    } else if (__value__ == (5099598i32)) {
                        if (_i_47 < (_field_46.length)) {
                            _gotoNext = 5099456i32;
                        } else {
                            _gotoNext = 5099602i32;
                        };
                    } else if (__value__ == (5099602i32)) {
                        if ((_field_46.length) == ((0 : stdgo.GoInt))) {
                            _gotoNext = 5099621i32;
                        } else {
                            _gotoNext = 5102375i32;
                        };
                    } else if (__value__ == (5099621i32)) {
                        _gotoNext = 5098813i32;
                    } else if (__value__ == (5102375i32)) {
                        _flag_49 = _field_46[(0 : stdgo.GoInt)]?.__copy__();
                        _gotoNext = 5102394i32;
                    } else if (__value__ == (5102394i32)) {
                        {
                            ...
                            if (__value__ == ((63 : stdgo.GoUInt8)) || __value__ == ((38 : stdgo.GoUInt8)) || __value__ == ((124 : stdgo.GoUInt8)) || __value__ == ((59 : stdgo.GoUInt8)) || __value__ == ((123 : stdgo.GoUInt8)) || __value__ == ((125 : stdgo.GoUInt8))) {
                                _gotoNext = 5102413i32;
                            } else if (__value__ == ((58 : stdgo.GoUInt8))) {
                                _gotoNext = 5102581i32;
                                ...
                                _gotoNext = 5102717i32;
                            } else {
                                _gotoNext = 5102920i32;
                            };
                        };
                    } else if (__value__ == (5102413i32)) {
                        _flag_49 = (_flag_49.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        if (_flag_49 == ((stdgo.Go.str() : stdgo.GoString))) {
                            _gotoNext = 5102551i32;
                        } else {
                            _gotoNext = 5102920i32;
                        };
                    } else if (__value__ == (5102551i32)) {
                        _gotoNext = 5098813i32;
                    } else if (__value__ == (5102581i32)) {
                        {
                            {
                            ...
                            if (!_ok_50) {
                                _gotoNext = 5102658i32;
                            } else {
                                _gotoNext = 5102920i32;
                            };
                        };
                    } else if (__value__ == (5102658i32)) {
                        @:check2r _t.logf(("skip: %s" : stdgo.GoString), stdgo.Go.toInterface(_line_44));
                        _gotoNext = 5098813i32;
                    } else if (__value__ == (5102717i32)) {
                        @:check2r _t.logf(("skip: %s" : stdgo.GoString), stdgo.Go.toInterface(_line_44));
                        _gotoNext = 5098813i32;
                    } else if (__value__ == (5102920i32)) {
                        if (((_field_46.length) < (4 : stdgo.GoInt) : Bool)) {
                            _gotoNext = 5102938i32;
                        } else {
                            _gotoNext = 5103071i32;
                        };
                    } else if (__value__ == (5102938i32)) {
                        ...
                        _gotoNext = 5098813i32;
                    } else if (__value__ == (5103071i32)) {
                        if (stdgo._internal.strings.Strings_contains.contains(_flag_49?.__copy__(), ("$" : stdgo.GoString))) {
                            _gotoNext = 5103102i32;
                        } else {
                            _gotoNext = 5103521i32;
                        };
                    } else if (__value__ == (5103102i32)) {
                        _f_51 = ((("\"" : stdgo.GoString) + _field_46[(1 : stdgo.GoInt)]?.__copy__() : stdgo.GoString) + ("\"" : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__();
                        {
                            ...
                            if (_err_45 != null) {
                                _gotoNext = 5103186i32;
                            } else {
                                _gotoNext = 5103254i32;
                            };
                        };
                    } else if (__value__ == (5103186i32)) {
                        ...
                        _f_51 = ((("\"" : stdgo.GoString) + _field_46[(2 : stdgo.GoInt)]?.__copy__() : stdgo.GoString) + ("\"" : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__();
                        {
                            ...
                            if (_err_45 != null) {
                                _gotoNext = 5103332i32;
                            } else {
                                _gotoNext = 5103521i32;
                            };
                        };
                    } else if (__value__ == (5103332i32)) {
                        @:check2r _t.errorf(("%s:%d: cannot unquote %s" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno_42), stdgo.Go.toInterface(_f_51));
                        _gotoNext = 5103521i32;
                    } else if (__value__ == (5103521i32)) {
                        if (_field_46[(1 : stdgo.GoInt)] == (("SAME" : stdgo.GoString))) {
                            _gotoNext = 5103543i32;
                        } else {
                            _gotoNext = 5103576i32;
                        };
                    } else if (__value__ == (5103543i32)) {
                        _field_46[(1 : stdgo.GoInt)] = _lastRegexp_43?.__copy__();
                        _gotoNext = 5103576i32;
                    } else if (__value__ == (5103576i32)) {
                        ...
                        if (!_ok_53) {
                            _gotoNext = 5103770i32;
                        } else {
                            _gotoNext = 5103926i32;
                        };
                    } else if (__value__ == (5103770i32)) {
                        ...
                        _gotoNext = 5098813i32;
                    } else if (__value__ == (5103926i32)) {
                        _gotoNext = 5103926i32;
                        _keys_5104012 = (new stdgo.Slice<stdgo.GoInt>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt>);
                        _values_5104012 = (new stdgo.Slice<stdgo.GoInt32>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt32>);
                        for (_key => _value in _flag_49) {
                            _keys_5104012 = (_keys_5104012.__append__(_key));
                            _values_5104012 = (_values_5104012.__append__(_value));
                        };
                        if ((0i32 : stdgo.GoInt) < (_keys_5104012.length)) {
                            _gotoNext = 5105291i32;
                        } else {
                            _gotoNext = 5098813i32;
                        };
                    } else if (__value__ == (5104024i32)) {
                        _i_5104024++;
                        _gotoNext = 5105292i32;
                    } else if (__value__ == (5104035i32)) {
                        _c_57 = _values_5104012[@:invalid_index_invalid_type _i_5104024];
                        var __blank__ = _keys_5104012[@:invalid_index_invalid_type _i_5104024];
                        _pattern_58 = _field_46[(1 : stdgo.GoInt)]?.__copy__();
                        _syn_59 = (4 : stdgo._internal.regexp.syntax.Syntax_flags.Flags);
                        _gotoNext = 5104103i32;
                    } else if (__value__ == (5104103i32)) {
                        {
                            final __value__ = _c_57;
                            if (__value__ == ((69 : stdgo.GoInt32))) {
                                _gotoNext = 5104150i32;
                            } else if (__value__ == ((76 : stdgo.GoInt32))) {
                                _gotoNext = 5104204i32;
                            } else {
                                _gotoNext = 5104117i32;
                            };
                        };
                    } else if (__value__ == (5104117i32)) {
                        _i_5104024++;
                        _gotoNext = 5105292i32;
                    } else if (__value__ == (5104150i32)) {
                        _gotoNext = 5104271i32;
                    } else if (__value__ == (5104204i32)) {
                        _pattern_58 = stdgo._internal.regexp.Regexp_quotemeta.quoteMeta(_pattern_58?.__copy__())?.__copy__();
                        _gotoNext = 5104271i32;
                    } else if (__value__ == (5104271i32)) {
                        _keys_5104271 = (new stdgo.Slice<stdgo.GoInt>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt>);
                        _values_5104271 = (new stdgo.Slice<stdgo.GoInt32>(0, 0, ...[]).__setNumber32__() : stdgo.Slice<stdgo.GoInt32>);
                        for (_key => _value in _flag_49) {
                            _keys_5104271 = (_keys_5104271.__append__(_key));
                            _values_5104271 = (_values_5104271.__append__(_value));
                        };
                        if ((0i32 : stdgo.GoInt) < (_keys_5104271.length)) {
                            _gotoNext = 5104361i32;
                        } else {
                            _gotoNext = 5104368i32;
                        };
                    } else if (__value__ == (5104283i32)) {
                        _i_5104283++;
                        _gotoNext = 5104362i32;
                    } else if (__value__ == (5104294i32)) {
                        _c_60 = _values_5104271[@:invalid_index_invalid_type _i_5104283];
                        var __blank__ = _keys_5104271[@:invalid_index_invalid_type _i_5104283];
                        _gotoNext = 5104300i32;
                    } else if (__value__ == (5104300i32)) {
                        {
                            final __value__ = _c_60;
                            if (__value__ == ((105 : stdgo.GoInt32))) {
                                _gotoNext = 5104315i32;
                            } else {
                                _gotoNext = 5104283i32;
                            };
                        };
                    } else if (__value__ == (5104315i32)) {
                        _syn_59 = (_syn_59 | ((1 : stdgo._internal.regexp.syntax.Syntax_flags.Flags)) : stdgo._internal.regexp.syntax.Syntax_flags.Flags);
                        _gotoNext = 5104283i32;
                    } else if (__value__ == (5104361i32)) {
                        _i_5104283 = 0i32;
                        _gotoNext = 5104362i32;
                    } else if (__value__ == (5104362i32)) {
                        if (_i_5104283 < (_keys_5104271.length)) {
                            _gotoNext = 5104294i32;
                        } else {
                            _gotoNext = 5104368i32;
                        };
                    } else if (__value__ == (5104368i32)) {
                        {
                        ...
                        if (_err_62 != null) {
                            _gotoNext = 5104424i32;
                        } else {
                            _gotoNext = 5104551i32;
                        };
                    } else if (__value__ == (5104424i32)) {
                        if (_shouldCompile_54) {
                            _gotoNext = 5104447i32;
                        } else {
                            _gotoNext = 5104526i32;
                        };
                    } else if (__value__ == (5104447i32)) {
                        ...
                        _gotoNext = 5104526i32;
                    } else if (__value__ == (5104526i32)) {
                        _i_5104024++;
                        _gotoNext = 5105292i32;
                    } else if (__value__ == (5104551i32)) {
                        if (!_shouldCompile_54) {
                            _gotoNext = 5104569i32;
                        } else {
                            _gotoNext = 5104669i32;
                        };
                    } else if (__value__ == (5104569i32)) {
                        ...
                        _i_5104024++;
                        _gotoNext = 5105292i32;
                    } else if (__value__ == (5104669i32)) {
                        _match_63 = @:check2r _re_61.matchString(_text_52?.__copy__());
                        if (_match_63 != (_shouldMatch_55)) {
                            _gotoNext = 5104726i32;
                        } else {
                            _gotoNext = 5104858i32;
                        };
                    } else if (__value__ == (5104726i32)) {
                        ...
                        _i_5104024++;
                        _gotoNext = 5105292i32;
                    } else if (__value__ == (5105098i32)) {
                        if (((_have_64.length) > (_pos_56.length) : Bool)) {
                            _gotoNext = 5105122i32;
                        } else {
                            _gotoNext = 5105159i32;
                        };
                    } else if (__value__ == (5105122i32)) {
                        _have_64 = (_have_64.__slice__(0, (_pos_56.length)) : stdgo.Slice<stdgo.GoInt>);
                        _gotoNext = 5105159i32;
                    } else if (__value__ == (5105159i32)) {
                        if (!stdgo._internal.regexp.Regexp__same._same(_have_64, _pos_56)) {
                            _gotoNext = 5105179i32;
                        } else {
                            _gotoNext = 5104024i32;
                        };
                    } else if (__value__ == (5105179i32)) {
                        ...
                        _gotoNext = 5104024i32;
                    } else if (__value__ == (5105291i32)) {
                        _i_5104024 = 0i32;
                        _gotoNext = 5105292i32;
                    } else if (__value__ == (5105292i32)) {
                        if (_i_5104024 < (_keys_5104012.length)) {
                            _gotoNext = 5104035i32;
                        } else {
                            _gotoNext = 5098813i32;
                        };
                    } else if (__value__ == (5105297i32)) {
                        _gotoNext = -1i32;
                    };
                };
            };
