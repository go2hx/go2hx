...
function benchmarkNotOnePassShortA(_b:stdgo.Ref<stdgo._internal.testing.Testing_b.B>):Void {
        //"file:///home/runner/.go/go1.21.3/src/regexp/all_test.go#L783"
        _b.stopTimer();
        ...
        //"file:///home/runner/.go/go1.21.3/src/regexp/all_test.go#L786"
        _b.startTimer();
        //"file:///home/runner/.go/go1.21.3/src/regexp/all_test.go#L787"
        {
            var _i = (0 : stdgo.GoInt);
            while ((_i < (@:checkr _b ?? throw "null pointer dereference").n : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/regexp/all_test.go#L788"
                _re.match(_x);
                _i++;
            };
        };
