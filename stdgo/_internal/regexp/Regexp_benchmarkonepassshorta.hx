...
function benchmarkOnePassShortA(_b:stdgo.Ref<stdgo._internal.testing.Testing_b.B>):Void {
        //"file:///home/runner/.go/go1.21.3/src/regexp/all_test.go#L773"
        _b.stopTimer();
        ...
        //"file:///home/runner/.go/go1.21.3/src/regexp/all_test.go#L776"
        _b.startTimer();
        //"file:///home/runner/.go/go1.21.3/src/regexp/all_test.go#L777"
        {
            var _i = (0 : stdgo.GoInt);
            while ((_i < (@:checkr _b ?? throw "null pointer dereference").n : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/regexp/all_test.go#L778"
                _re.match(_x);
                _i++;
            };
        };
