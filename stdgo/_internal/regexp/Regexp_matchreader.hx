...
function matchReader(_pattern:stdgo.GoString, _r:stdgo._internal.io.Io_runereader.RuneReader):{ var _0 : Bool; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/regexp/regexp.go#L547"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/regexp/regexp.go#L548"
            return {
        ...
        //"file:///home/runner/.go/go1.21.3/src/regexp/regexp.go#L550"
        return {
