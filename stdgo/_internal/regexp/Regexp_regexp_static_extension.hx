        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if (_startCond_27 == ((255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3803909i32;
                    } else {
                        _gotoNext = 3803943i32;
                    };
                } else if (__value__ == (3803909i32)) {
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3803943i32;
                } else if (__value__ == (3803943i32)) {
                    ...
                    if (((@:checkr _m_28 ?? throw "null pointer dereference")._matchcap.capacity < _ncap : Bool)) {
                        _gotoNext = 3803995i32;
                    } else {
                        _gotoNext = 3804038i32;
                    };
                } else if (__value__ == (3803995i32)) {
                    ...
                    _gotoNext = 3804078i32;
                } else if (__value__ == (3804038i32)) {
                    _gotoNext = 3804038i32;
                    ...
                    if (_r_32 != ((-1 : stdgo.GoInt32))) {
                        _gotoNext = 3804282i32;
                    } else {
                        _gotoNext = 3804323i32;
                    };
                } else if (__value__ == (3804282i32)) {
                    {
                    ...
                    if ((((_pos == ((0 : stdgo.GoInt)) && _flag_36._match(((@:checkr _inst_38 ?? throw "null pointer dereference").inst.arg : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp)) : Bool) && (((@:checkr _re ?? throw "null pointer dereference")._prefix.length) > (0 : stdgo.GoInt) : Bool) : Bool) && _i_31._canCheckPrefix() : Bool)) {
                        _gotoNext = 3804629i32;
                    } else {
                        _gotoNext = 3804867i32;
                    };
                } else if (__value__ == (3804629i32)) {
                    if (!_i_31._hasPrefix(_re)) {
                        _gotoNext = 3804709i32;
                    } else {
                        _gotoNext = 3804732i32;
                    };
                } else if (__value__ == (3804709i32)) {
                    _gotoNext = 3805991i32;
                    ...
                    _gotoNext = 3804867i32;
                } else if (__value__ == (3804867i32)) {
                    0i32;
                    _gotoNext = 3804867i32;
                    if (true) {
                        _gotoNext = 3804871i32;
                    } else {
                        _gotoNext = 3805991i32;
                    };
                } else if (__value__ == (3804871i32)) {
                    _inst_38 = (stdgo.Go.setRef((@:checkr (@:checkr _re ?? throw "null pointer dereference")._onepass ?? throw "null pointer dereference").inst[(_pc_37 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.Regexp_t_onepassinst.T_onePassInst>);
                    _pc_37 = ((@:checkr _inst_38 ?? throw "null pointer dereference").inst.out : stdgo.GoInt);
                    _gotoNext = 3804926i32;
                } else if (__value__ == (3804926i32)) {
                    {
                        final __value__ = (@:checkr _inst_38 ?? throw "null pointer dereference").inst.op;
                        if (__value__ == ((4 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3804977i32;
                        } else if (__value__ == ((7 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3805114i32;
                        } else if (__value__ == ((8 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3805186i32;
                        } else if (__value__ == ((9 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3805258i32;
                        } else if (__value__ == ((10 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3805299i32;
                        } else if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((1 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3805437i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3805527i32;
                        } else if (__value__ == ((6 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3805566i32;
                        } else if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3805601i32;
                        } else if (__value__ == ((2 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3805710i32;
                        } else {
                            _gotoNext = 3804945i32;
                        };
                    };
                } else if (__value__ == (3804945i32)) {
                    throw stdgo.Go.toInterface(("bad inst" : stdgo.GoString));
                    _gotoNext = 3805829i32;
                } else if (__value__ == (3804977i32)) {
                    _matched_29 = true;
                    if ((((@:checkr _m_28 ?? throw "null pointer dereference")._matchcap.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3805044i32;
                    } else {
                        _gotoNext = 3805100i32;
                    };
                } else if (__value__ == (3805044i32)) {
                    ...
                    _gotoNext = 3805100i32;
                } else if (__value__ == (3805100i32)) {
                    _gotoNext = 3805991i32;
                } else if (__value__ == (3805114i32)) {
                    if (!@:check2r _inst_38.matchRune(_r_32)) {
                        _gotoNext = 3805161i32;
                    } else {
                        _gotoNext = 3805829i32;
                    };
                } else if (__value__ == (3805161i32)) {
                    _gotoNext = 3805991i32;
                } else if (__value__ == (3805186i32)) {
                    if (_r_32 != ((@:checkr _inst_38 ?? throw "null pointer dereference").inst.rune[((0 : stdgo.GoInt) : stdgo.GoInt)])) {
                        _gotoNext = 3805233i32;
                    } else {
                        _gotoNext = 3805829i32;
                    };
                } else if (__value__ == (3805233i32)) {
                    _gotoNext = 3805991i32;
                } else if (__value__ == (3805258i32)) {
                    _gotoNext = 3805829i32;
                } else if (__value__ == (3805299i32)) {
                    if (_r_32 == ((10 : stdgo.GoInt32))) {
                        _gotoNext = 3805345i32;
                    } else {
                        _gotoNext = 3805829i32;
                    };
                } else if (__value__ == (3805345i32)) {
                    _gotoNext = 3805991i32;
                } else if (__value__ == (3805437i32)) {
                    _pc_37 = (stdgo._internal.regexp.Regexp__onepassnext._onePassNext(_inst_38, _r_32) : stdgo.GoInt);
                    0i32;
                    _gotoNext = 3804867i32;
                } else if (__value__ == (3805527i32)) {
                    _gotoNext = 3805991i32;
                } else if (__value__ == (3805566i32)) {
                    0i32;
                    _gotoNext = 3804867i32;
                } else if (__value__ == (3805601i32)) {
                    if (!_flag_36._match(((@:checkr _inst_38 ?? throw "null pointer dereference").inst.arg : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3805673i32;
                    } else {
                        _gotoNext = 3805699i32;
                    };
                } else if (__value__ == (3805673i32)) {
                    _gotoNext = 3805991i32;
                } else if (__value__ == (3805699i32)) {
                    0i32;
                    _gotoNext = 3804867i32;
                } else if (__value__ == (3805710i32)) {
                    if ((((@:checkr _inst_38 ?? throw "null pointer dereference").inst.arg : stdgo.GoInt) < ((@:checkr _m_28 ?? throw "null pointer dereference")._matchcap.length) : Bool)) {
                        _gotoNext = 3805773i32;
                    } else {
                        _gotoNext = 3805814i32;
                    };
                } else if (__value__ == (3805773i32)) {
                    ...
                    _gotoNext = 3805814i32;
                } else if (__value__ == (3805814i32)) {
                    0i32;
                    _gotoNext = 3804867i32;
                } else if (__value__ == (3805829i32)) {
                    if (_width_34 == ((0 : stdgo.GoInt))) {
                        _gotoNext = 3805843i32;
                    } else {
                        _gotoNext = 3805860i32;
                    };
                } else if (__value__ == (3805843i32)) {
                    _gotoNext = 3805991i32;
                } else if (__value__ == (3805860i32)) {
                    ...
                    if (_r_32 != ((-1 : stdgo.GoInt32))) {
                        _gotoNext = 3805945i32;
                    } else {
                        _gotoNext = 3804867i32;
                    };
                } else if (__value__ == (3805945i32)) {
                    {
                        var __tmp__ = _i_31._step((_pos + _width_34 : stdgo.GoInt));
                        _r1_33 = @:tmpset0 __tmp__._0;
                        _width1_35 = @:tmpset0 __tmp__._1;
                    ...
                    _gotoNext = 3804867i32;
                } else if (__value__ == (3805991i32)) {
                    _gotoNext = 3805991i32;
                    if (!_matched_29) {
                        _gotoNext = 3806012i32;
                    } else {
                        _gotoNext = 3806056i32;
                    };
                } else if (__value__ == (3806012i32)) {
                    stdgo._internal.regexp.Regexp__freeonepassmachine._freeOnePassMachine(_m_28);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3806056i32;
                } else if (__value__ == (3806056i32)) {
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if (_startCond_16 == ((255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3783375i32;
                    } else {
                        _gotoNext = 3783408i32;
                    };
                } else if (__value__ == (3783375i32)) {
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3783408i32;
                    ...
                    if ((((_startCond_16 & (4 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp) : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp) != (0 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp)) && (_pos != (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 3783460i32;
                    } else {
                        _gotoNext = 3783525i32;
                    };
                } else if (__value__ == (3783460i32)) {
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3783525i32;
                } else if (__value__ == (3783525i32)) {
                    ...
                    if (!@:check2r _re._tryBacktrack(_b_17, _i_18, ((@:checkr (@:checkr _re ?? throw "null pointer dereference")._prog ?? throw "null pointer dereference").start : stdgo.GoUInt32), _pos)) {
                        _gotoNext = 3783816i32;
                    } else {
                        _gotoNext = 3784750i32;
                    };
                } else if (__value__ == (3783816i32)) {
                    stdgo._internal.regexp.Regexp__freebitstate._freeBitState(_b_17);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3784750i32;
                } else if (__value__ == (3783863i32)) {
                    _gotoNext = 3783863i32;
                    ...
                    if (((_pos <= _end_19 : Bool) && (_width_20 != (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 3784315i32;
                    } else {
                        _gotoNext = 3784717i32;
                    };
                } else if (__value__ == (3784315i32)) {
                    if ((((@:checkr _re ?? throw "null pointer dereference")._prefix.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3784342i32;
                    } else {
                        _gotoNext = 3784526i32;
                    };
                } else if (__value__ == (3784342i32)) {
                    _advance_21 = _i_18._index(_re, _pos);
                    if ((_advance_21 < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3784453i32;
                    } else {
                        _gotoNext = 3784502i32;
                    };
                } else if (__value__ == (3784453i32)) {
                    stdgo._internal.regexp.Regexp__freebitstate._freeBitState(_b_17);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3784502i32;
                } else if (__value__ == (3784502i32)) {
                    _pos = (_pos + (_advance_21) : stdgo.GoInt);
                    _gotoNext = 3784526i32;
                } else if (__value__ == (3784526i32)) {
                    if ((((@:checkr _b_17 ?? throw "null pointer dereference")._cap.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3784544i32;
                    } else {
                        _gotoNext = 3784573i32;
                    };
                } else if (__value__ == (3784544i32)) {
                    (@:checkr _b_17 ?? throw "null pointer dereference")._cap[(0 : stdgo.GoInt)] = _pos;
                    _gotoNext = 3784573i32;
                } else if (__value__ == (3784573i32)) {
                    if (@:check2r _re._tryBacktrack(_b_17, _i_18, ((@:checkr (@:checkr _re ?? throw "null pointer dereference")._prog ?? throw "null pointer dereference").start : stdgo.GoUInt32), _pos)) {
                        _gotoNext = 3784626i32;
                    } else {
                        _gotoNext = 3784688i32;
                    };
                } else if (__value__ == (3784626i32)) {
                    _gotoNext = 3784750i32;
                    ...
                    _gotoNext = 3784270i32;
                } else if (__value__ == (3784717i32)) {
                    stdgo._internal.regexp.Regexp__freebitstate._freeBitState(_b_17);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    0i32;
                    _gotoNext = 3784750i32;
                } else if (__value__ == (3784750i32)) {
                    _gotoNext = 3784750i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    0i32;
                    _gotoNext = 3779449i32;
                } else if (__value__ == (3779449i32)) {
                    if ((((@:checkr _b ?? throw "null pointer dereference")._jobs.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3779469i32;
                    } else {
                        _gotoNext = 3783085i32;
                    };
                } else if (__value__ == (3779469i32)) {
                ...
                } else if (__value__ == (3779901i32)) {
                    if (!@:check2r _b._shouldVisit(_pc_2, _pos_3)) {
                        _gotoNext = 3779944i32;
                    } else {
                        _gotoNext = 3779963i32;
                    };
                } else if (__value__ == (3779944i32)) {
                    0i32;
                    _gotoNext = 3779449i32;
                    ...
                    _gotoNext = 3780001i32;
                } else if (__value__ == (3780001i32)) {
                    {
                        final __value__ = (@:checkr _inst_5 ?? throw "null pointer dereference").op;
                        if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3780052i32;
                        } else if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3780108i32;
                        } else if (__value__ == ((1 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3780669i32;
                        } else if (__value__ == ((7 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3781128i32;
                        } else if (__value__ == ((8 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3781279i32;
                        } else if (__value__ == ((10 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3781430i32;
                        } else if (__value__ == ((9 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3781598i32;
                        } else if (__value__ == ((2 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3781748i32;
                        } else if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3782131i32;
                        } else if (__value__ == ((6 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3782290i32;
                        } else if (__value__ == ((4 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3782352i32;
                        } else {
                            _gotoNext = 3780020i32;
                        };
                    };
                } else if (__value__ == (3780020i32)) {
                    throw stdgo.Go.toInterface(("bad inst" : stdgo.GoString));
                    _gotoNext = 3779449i32;
                } else if (__value__ == (3780052i32)) {
                    throw stdgo.Go.toInterface(("unexpected InstFail" : stdgo.GoString));
                    _gotoNext = 3779449i32;
                } else if (__value__ == (3780108i32)) {
                    if (_arg_4) {
                        _gotoNext = 3780481i32;
                    } else {
                        _gotoNext = 3780589i32;
                    };
                } else if (__value__ == (3780481i32)) {
                    _arg_4 = false;
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").arg;
                    _gotoNext = 3779901i32;
                } else if (__value__ == (3780589i32)) {
                    _gotoNext = 3780589i32;
                    @:check2r _b._push(_re, _pc_2, _pos_3, true);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3779901i32;
                } else if (__value__ == (3780669i32)) {
                    _gotoNext = 3780757i32;
                } else if (__value__ == (3780757i32)) {
                    {
                        ...
                        if (__value__ == ((7 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((8 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((9 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((10 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3780795i32;
                        } else {
                            _gotoNext = 3781052i32;
                        };
                    };
                } else if (__value__ == (3780795i32)) {
                    ...
                    if (!@:check2r _inst_5.matchRune(_r_6)) {
                        _gotoNext = 3781202i32;
                    } else {
                        _gotoNext = 3781225i32;
                    };
                } else if (__value__ == (3781202i32)) {
                    0i32;
                    _gotoNext = 3779449i32;
                } else if (__value__ == (3781225i32)) {
                    _pos_3 = (_pos_3 + (_width_7) : stdgo.GoInt);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3779901i32;
                } else if (__value__ == (3781279i32)) {
                    {
                        var __tmp__ = _i._step(_pos_3);
                    ...
                    if (_r_8 != ((@:checkr _inst_5 ?? throw "null pointer dereference").rune[((0 : stdgo.GoInt) : stdgo.GoInt)])) {
                        _gotoNext = 3781353i32;
                    } else {
                        _gotoNext = 3781376i32;
                    };
                } else if (__value__ == (3781353i32)) {
                    0i32;
                    _gotoNext = 3779449i32;
                } else if (__value__ == (3781376i32)) {
                    _pos_3 = (_pos_3 + (_width_9) : stdgo.GoInt);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3779901i32;
                } else if (__value__ == (3781430i32)) {
                    {
                        var __tmp__ = _i._step(_pos_3);
                    ...
                    if (((_r_10 == (10 : stdgo.GoInt32)) || (_r_10 == (-1 : stdgo.GoInt32)) : Bool)) {
                        _gotoNext = 3781521i32;
                    } else {
                        _gotoNext = 3781544i32;
                    };
                } else if (__value__ == (3781521i32)) {
                    0i32;
                    _gotoNext = 3779449i32;
                } else if (__value__ == (3781544i32)) {
                    ...
                    if (_r_12 == ((-1 : stdgo.GoInt32))) {
                        _gotoNext = 3781671i32;
                    } else {
                        _gotoNext = 3781694i32;
                    };
                } else if (__value__ == (3781671i32)) {
                    0i32;
                    _gotoNext = 3779449i32;
                } else if (__value__ == (3781694i32)) {
                    _pos_3 = (_pos_3 + (_width_13) : stdgo.GoInt);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3779901i32;
                } else if (__value__ == (3781748i32)) {
                    if (_arg_4) {
                        _gotoNext = 3781783i32;
                    } else {
                        _gotoNext = 3781883i32;
                    };
                } else if (__value__ == (3781783i32)) {
                    (@:checkr _b ?? throw "null pointer dereference")._cap[((@:checkr _inst_5 ?? throw "null pointer dereference").arg : stdgo.GoInt)] = _pos_3;
                    0i32;
                    _gotoNext = 3779449i32;
                } else if (__value__ == (3781883i32)) {
                    _gotoNext = 3781883i32;
                    ...
                    (@:checkr _b ?? throw "null pointer dereference")._cap[((@:checkr _inst_5 ?? throw "null pointer dereference").arg : stdgo.GoInt)] = _pos_3;
                    _gotoNext = 3782087i32;
                } else if (__value__ == (3782087i32)) {
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3779901i32;
                } else if (__value__ == (3782131i32)) {
                ...
                } else if (__value__ == (3782711i32)) {
                    {
                        ...
                        if (((_old_15 == (-1 : stdgo.GoInt)) || (((_longest_0 && (_pos_3 > (0 : stdgo.GoInt) : Bool) : Bool) && (_pos_3 > _old_15 : Bool) : Bool)) : Bool)) {
                            _gotoNext = 3782783i32;
                        } else {
                            _gotoNext = 3782866i32;
                        };
                    };
                } else if (__value__ == (3782783i32)) {
