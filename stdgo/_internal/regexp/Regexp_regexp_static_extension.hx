        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                final __value__ = _gotoNext;
                if (__value__ == (0i32)) {
                    _startCond_3795056 = (@:checkr _re ?? throw "null pointer dereference")._cond;
                    ...
                    {
                        var __tmp__ = @:check2 (@:checkr _b_3795263 ?? throw "null pointer dereference")._inputs._init((null : stdgo._internal.io.Io_runereader.RuneReader), _ib, _is?.__copy__());
                        _i_3795283 = @:tmpset0 __tmp__._0;
                        _end_3795286 = @:tmpset0 __tmp__._1;
                    };
                    @:check2r _b_3795263._reset((@:checkr _re ?? throw "null pointer dereference")._prog, _end_3795286, _ncap);
                    ...
                    if ((((@:checkr _b_3795263 ?? throw "null pointer dereference")._cap.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3795474i32;
                    } else {
                        _gotoNext = 3795500i32;
                    };
                } else if (__value__ == (3795474i32)) {
                    (@:checkr _b_3795263 ?? throw "null pointer dereference")._cap[(0 : stdgo.GoInt)] = _pos;
                    _gotoNext = 3795500i32;
                } else if (__value__ == (3795500i32)) {
                    if (!@:check2r _re._tryBacktrack(_b_3795263, _i_3795283, ((@:checkr (@:checkr _re ?? throw "null pointer dereference")._prog ?? throw "null pointer dereference").start : stdgo.GoUInt32), _pos)) {
                ...
                } else if (__value__ == (3796426i32)) {
                    {
                        ...
                        _width_3795994 = @:tmpset0 __tmp__._1;
                    };
                    ...
                    _gotoNext = 3796488i32;
                    _dstCap = (_dstCap.__append__(...((@:checkr _b_3795263 ?? throw "null pointer dereference")._matchcap : Array<stdgo.GoInt>)));
                    stdgo._internal.regexp.Regexp__freebitstate._freeBitState(_b_3795263);
                    return _dstCap;
                    _gotoNext = -1i32;
                };
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                final __value__ = _gotoNext;
                if (__value__ == (0i32)) {
                    _longest_3791135 = (@:checkr _re ?? throw "null pointer dereference")._longest;
                    ...
                    _l_3791211 = (((@:checkr _b ?? throw "null pointer dereference")._jobs.length) - (1 : stdgo.GoInt) : stdgo.GoInt);
                    _pc_3791262 = (@:checkr _b ?? throw "null pointer dereference")._jobs[(_l_3791211 : stdgo.GoInt)]._pc;
                    _pos_3791283 = (@:checkr _b ?? throw "null pointer dereference")._jobs[(_l_3791211 : stdgo.GoInt)]._pos;
                    _arg_3791306 = (@:checkr _b ?? throw "null pointer dereference")._jobs[(_l_3791211 : stdgo.GoInt)]._arg;
                    (@:checkr _b ?? throw "null pointer dereference")._jobs = ((@:checkr _b ?? throw "null pointer dereference")._jobs.__slice__(0, _l_3791211) : stdgo.Slice<stdgo._internal.regexp.Regexp_t_job.T_job>);
                    _gotoNext = 3791701i32;
                } else if (__value__ == (3791639i32)) {
                    if (!@:check2r _b._shouldVisit(_pc_3791262, _pos_3791283)) {
                    ...
                    _gotoNext = 3791701i32;
                    _inst_3791710 = (stdgo.Go.setRef((@:checkr (@:checkr _re ?? throw "null pointer dereference")._prog ?? throw "null pointer dereference").inst[(_pc_3791262 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_inst.Inst>);
                    _gotoNext = 3791739i32;
                } else if (__value__ == (3791739i32)) {
                    {
                        final __value__ = (@:checkr _inst_3791710 ?? throw "null pointer dereference").op;
                    ...
                    _arg_3791306 = false;
                    _pc_3791262 = (@:checkr _inst_3791710 ?? throw "null pointer dereference").arg;
                    _gotoNext = 3791639i32;
                } else if (__value__ == (3792327i32)) {
                    _gotoNext = 3792327i32;
                    @:check2r _b._push(_re, _pc_3791262, _pos_3791283, true);
                    _pc_3791262 = (@:checkr _inst_3791710 ?? throw "null pointer dereference").out;
                    _gotoNext = 3791639i32;
                } else if (__value__ == (3792407i32)) {
                    _gotoNext = 3792495i32;
                } else if (__value__ == (3792495i32)) {
                    {
                        final __value__ = (@:checkr (@:checkr _re ?? throw "null pointer dereference")._prog ?? throw "null pointer dereference").inst[((@:checkr _inst_3791710 ?? throw "null pointer dereference").out : stdgo.GoInt)].op;
                    ...
                    @:check2r _b._push(_re, (@:checkr _inst_3791710 ?? throw "null pointer dereference").arg, _pos_3791283, false);
                    _pc_3791262 = (@:checkr _inst_3791710 ?? throw "null pointer dereference").arg;
                    _pos_3791283 = (@:checkr _b ?? throw "null pointer dereference")._end;
                    _gotoNext = 3791639i32;
                } else if (__value__ == (3792790i32)) {
                    @:check2r _b._push(_re, (@:checkr _inst_3791710 ?? throw "null pointer dereference").out, (@:checkr _b ?? throw "null pointer dereference")._end, false);
                    _pc_3791262 = (@:checkr _inst_3791710 ?? throw "null pointer dereference").out;
                    _gotoNext = 3791639i32;
                } else if (__value__ == (3792866i32)) {
                    {
                        var __tmp__ = _i._step(_pos_3791283);
                        _r_3792891 = @:tmpset0 __tmp__._0;
                        _width_3792894 = @:tmpset0 __tmp__._1;
                    };
                    if (!@:check2r _inst_3791710.matchRune(_r_3792891)) {
                    ...
                    {
                        var __tmp__ = _i._step(_pos_3791283);
                        _r_3793043 = @:tmpset0 __tmp__._0;
                        _width_3793046 = @:tmpset0 __tmp__._1;
                    };
                    if (_r_3793043 != ((@:checkr _inst_3791710 ?? throw "null pointer dereference").rune[((0 : stdgo.GoInt) : stdgo.GoInt)])) {
                    ...
                    {
                        var __tmp__ = _i._step(_pos_3791283);
                        _r_3793201 = @:tmpset0 __tmp__._0;
                        _width_3793204 = @:tmpset0 __tmp__._1;
                    };
                    ...
                    {
                        var __tmp__ = _i._step(_pos_3791283);
                        _r_3793364 = @:tmpset0 __tmp__._0;
                        _width_3793367 = @:tmpset0 __tmp__._1;
                    };
                    ...
                    (@:checkr _b ?? throw "null pointer dereference")._cap[((@:checkr _inst_3791710 ?? throw "null pointer dereference").arg : stdgo.GoInt)] = _pos_3791283;
                    var __blank__ = 0i32;
                    _gotoNext = 3791187i32;
                } else if (__value__ == (3793621i32)) {
                    _gotoNext = 3793621i32;
                    if (((@:checkr _inst_3791710 ?? throw "null pointer dereference").arg < ((@:checkr _b ?? throw "null pointer dereference")._cap.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 3793660i32;
                    } else {
                        _gotoNext = 3793825i32;
                    };
                } else if (__value__ == (3793660i32)) {
                    @:check2r _b._push(_re, _pc_3791262, (@:checkr _b ?? throw "null pointer dereference")._cap[((@:checkr _inst_3791710 ?? throw "null pointer dereference").arg : stdgo.GoInt)], true);
                    (@:checkr _b ?? throw "null pointer dereference")._cap[((@:checkr _inst_3791710 ?? throw "null pointer dereference").arg : stdgo.GoInt)] = _pos_3791283;
                    _gotoNext = 3793825i32;
                    ...
                    if (!_flag_3793900._match(((@:checkr _inst_3791710 ?? throw "null pointer dereference").arg : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                    ...
                    (@:checkr _b ?? throw "null pointer dereference")._cap[(1 : stdgo.GoInt)] = _pos_3791283;
                    _gotoNext = 3794449i32;
                } else if (__value__ == (3794449i32)) {
                    {
                        _old_3794452 = (@:checkr _b ?? throw "null pointer dereference")._matchcap[(1 : stdgo.GoInt)];
                    ...
                    if (_pos_3791283 == ((@:checkr _b ?? throw "null pointer dereference")._end)) {
                    ...
                    return ((_longest_3791135 && (((@:checkr _b ?? throw "null pointer dereference")._matchcap.length) > (1 : stdgo.GoInt) : Bool) : Bool) && ((@:checkr _b ?? throw "null pointer dereference")._matchcap[(1 : stdgo.GoInt)] >= (0 : stdgo.GoInt) : Bool) : Bool);
                    _gotoNext = -1i32;
                };
            };
        };
