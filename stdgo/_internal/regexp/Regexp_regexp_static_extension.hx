        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if (_startCond_16 == ((255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3675168i32;
                    } else {
                        _gotoNext = 3675201i32;
                    };
                } else if (__value__ == (3675168i32)) {
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3675201i32;
                } else if (__value__ == (3675201i32)) {
                    if ((((_startCond_16 & (4 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp) : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp) != (0 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp)) && (_pos != (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 3675253i32;
                    } else {
                        _gotoNext = 3675318i32;
                    };
                } else if (__value__ == (3675253i32)) {
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3675318i32;
                    ...
                    if ((_startCond_16 & (4 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp) : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp) != ((0 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3675507i32;
                    } else {
                        _gotoNext = 3675656i32;
                    };
                } else if (__value__ == (3675507i32)) {
                    if ((((@:checkr _b_17 ?? throw "null pointer dereference")._cap.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3675529i32;
                    } else {
                        _gotoNext = 3675555i32;
                    };
                } else if (__value__ == (3675529i32)) {
                    (@:checkr _b_17 ?? throw "null pointer dereference")._cap[(0 : stdgo.GoInt)] = _pos;
                    _gotoNext = 3675555i32;
                } else if (__value__ == (3675555i32)) {
                    if (!@:check2r _re._tryBacktrack(_b_17, _i_18, ((@:checkr (@:checkr _re ?? throw "null pointer dereference")._prog ?? throw "null pointer dereference").start : stdgo.GoUInt32), _pos)) {
                        _gotoNext = 3675609i32;
                    } else {
                        _gotoNext = 3676543i32;
                    };
                } else if (__value__ == (3675609i32)) {
                    stdgo._internal.regexp.Regexp__freebitstate._freeBitState(_b_17);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3676543i32;
                } else if (__value__ == (3675656i32)) {
                    _gotoNext = 3675656i32;
                    ...
                    if (((_pos <= _end_19 : Bool) && (_width_20 != (0 : stdgo.GoInt)) : Bool)) {
                        ...
                        _gotoNext = 3676510i32;
                    };
                } else if (__value__ == (3676108i32)) {
                    if ((((@:checkr _re ?? throw "null pointer dereference")._prefix.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3676135i32;
                    } else {
                        _gotoNext = 3676319i32;
                    };
                } else if (__value__ == (3676135i32)) {
                    _advance_21 = _i_18._index(_re, _pos);
                    if ((_advance_21 < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3676246i32;
                    } else {
                        _gotoNext = 3676295i32;
                    };
                } else if (__value__ == (3676246i32)) {
                    stdgo._internal.regexp.Regexp__freebitstate._freeBitState(_b_17);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3676295i32;
                } else if (__value__ == (3676295i32)) {
                    _pos = (_pos + (_advance_21) : stdgo.GoInt);
                    _gotoNext = 3676319i32;
                } else if (__value__ == (3676319i32)) {
                    if ((((@:checkr _b_17 ?? throw "null pointer dereference")._cap.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3676337i32;
                    } else {
                        _gotoNext = 3676366i32;
                    };
                } else if (__value__ == (3676337i32)) {
                    (@:checkr _b_17 ?? throw "null pointer dereference")._cap[(0 : stdgo.GoInt)] = _pos;
                    _gotoNext = 3676366i32;
                } else if (__value__ == (3676366i32)) {
                    if (@:check2r _re._tryBacktrack(_b_17, _i_18, ((@:checkr (@:checkr _re ?? throw "null pointer dereference")._prog ?? throw "null pointer dereference").start : stdgo.GoUInt32), _pos)) {
                        _gotoNext = 3676419i32;
                    } else {
                        _gotoNext = 3676481i32;
                    };
                } else if (__value__ == (3676419i32)) {
                    _gotoNext = 3676543i32;
                } else if (__value__ == (3676481i32)) {
                    {
                    ...
                    _gotoNext = 3676063i32;
                } else if (__value__ == (3676510i32)) {
                    stdgo._internal.regexp.Regexp__freebitstate._freeBitState(_b_17);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    var __blank__ = 0i32;
                    _gotoNext = 3676543i32;
                } else if (__value__ == (3676543i32)) {
                    _gotoNext = 3676543i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 3671242i32;
                } else if (__value__ == (3671242i32)) {
                    if ((((@:checkr _b ?? throw "null pointer dereference")._jobs.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3671262i32;
                    } else {
                        _gotoNext = 3674878i32;
                    };
                } else if (__value__ == (3671262i32)) {
                    ...
                    _gotoNext = 3671756i32;
                } else if (__value__ == (3671694i32)) {
                    if (!@:check2r _b._shouldVisit(_pc_2, _pos_3)) {
                        _gotoNext = 3671737i32;
                    } else {
                        _gotoNext = 3671756i32;
                    };
                } else if (__value__ == (3671737i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3671242i32;
                } else if (__value__ == (3671756i32)) {
                    _gotoNext = 3671756i32;
                    ...
                    _gotoNext = 3671794i32;
                } else if (__value__ == (3671794i32)) {
                    {
                        final __value__ = (@:checkr _inst_5 ?? throw "null pointer dereference").op;
                        if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3671845i32;
                        } else if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3671901i32;
                        } else if (__value__ == ((1 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3672462i32;
                        } else if (__value__ == ((7 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3672921i32;
                        } else if (__value__ == ((8 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3673072i32;
                        } else if (__value__ == ((10 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3673223i32;
                        } else if (__value__ == ((9 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3673391i32;
                        } else if (__value__ == ((2 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3673541i32;
                        } else if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3673924i32;
                        } else if (__value__ == ((6 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3674083i32;
                        } else if (__value__ == ((4 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3674145i32;
                        } else {
                            _gotoNext = 3671813i32;
                        };
                    };
                } else if (__value__ == (3671813i32)) {
                    throw stdgo.Go.toInterface(("bad inst" : stdgo.GoString));
                    _gotoNext = 3671242i32;
                } else if (__value__ == (3671845i32)) {
                    throw stdgo.Go.toInterface(("unexpected InstFail" : stdgo.GoString));
                    _gotoNext = 3671242i32;
                } else if (__value__ == (3671901i32)) {
                    if (_arg_4) {
                        _gotoNext = 3672274i32;
                    } else {
                        _gotoNext = 3672382i32;
                    };
                } else if (__value__ == (3672274i32)) {
                    _arg_4 = false;
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").arg;
                    _gotoNext = 3671694i32;
                    ...
                    _gotoNext = 3671694i32;
                } else if (__value__ == (3672462i32)) {
                    _gotoNext = 3672550i32;
                } else if (__value__ == (3672550i32)) {
                    {
                        ...
                        if (__value__ == ((7 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((8 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((9 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((10 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3672588i32;
                        } else {
                            _gotoNext = 3672845i32;
                        };
                    };
                } else if (__value__ == (3672588i32)) {
                    ...
                    if (!@:check2r _inst_5.matchRune(_r_6)) {
                        _gotoNext = 3672995i32;
                    } else {
                        _gotoNext = 3673018i32;
                    };
                } else if (__value__ == (3672995i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3671242i32;
                } else if (__value__ == (3673018i32)) {
                    ...
                    if (_r_8 != ((@:checkr _inst_5 ?? throw "null pointer dereference").rune[((0 : stdgo.GoInt) : stdgo.GoInt)])) {
                        _gotoNext = 3673146i32;
                    } else {
                        _gotoNext = 3673169i32;
                    };
                } else if (__value__ == (3673146i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3671242i32;
                } else if (__value__ == (3673169i32)) {
                    _pos_3 = (_pos_3 + (_width_9) : stdgo.GoInt);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3671694i32;
                } else if (__value__ == (3673223i32)) {
                    {
                        var __tmp__ = _i._step(_pos_3);
                    ...
                    if (((_r_10 == (10 : stdgo.GoInt32)) || (_r_10 == (-1 : stdgo.GoInt32)) : Bool)) {
                        _gotoNext = 3673314i32;
                    } else {
                        _gotoNext = 3673337i32;
                    };
                } else if (__value__ == (3673314i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3671242i32;
                } else if (__value__ == (3673337i32)) {
                    _pos_3 = (_pos_3 + (_width_11) : stdgo.GoInt);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3671694i32;
                } else if (__value__ == (3673391i32)) {
                    {
                        var __tmp__ = _i._step(_pos_3);
                    ...
                    if (_r_12 == ((-1 : stdgo.GoInt32))) {
                        _gotoNext = 3673464i32;
                    } else {
                        _gotoNext = 3673487i32;
                    };
                } else if (__value__ == (3673464i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3671242i32;
                } else if (__value__ == (3673487i32)) {
                    _pos_3 = (_pos_3 + (_width_13) : stdgo.GoInt);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3671694i32;
                } else if (__value__ == (3673541i32)) {
                    if (_arg_4) {
                        _gotoNext = 3673576i32;
                    } else {
                        _gotoNext = 3673676i32;
                    };
                } else if (__value__ == (3673576i32)) {
                    ...
                    if (((@:checkr _inst_5 ?? throw "null pointer dereference").arg < ((@:checkr _b ?? throw "null pointer dereference")._cap.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 3673715i32;
                    } else {
                        _gotoNext = 3673880i32;
                    };
                } else if (__value__ == (3673715i32)) {
                    ...
                    (@:checkr _b ?? throw "null pointer dereference")._cap[((@:checkr _inst_5 ?? throw "null pointer dereference").arg : stdgo.GoInt)] = _pos_3;
                    _gotoNext = 3673880i32;
                } else if (__value__ == (3673880i32)) {
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3671694i32;
                } else if (__value__ == (3673924i32)) {
                    ...
                    if (!_flag_14._match(((@:checkr _inst_5 ?? throw "null pointer dereference").arg : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3674022i32;
                    } else {
                        _gotoNext = 3674045i32;
                    };
                } else if (__value__ == (3674022i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3671242i32;
                } else if (__value__ == (3674045i32)) {
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3671694i32;
                } else if (__value__ == (3674083i32)) {
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3671694i32;
                } else if (__value__ == (3674145i32)) {
                    if (((@:checkr _b ?? throw "null pointer dereference")._cap.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 3674291i32;
                    } else {
                        _gotoNext = 3674457i32;
                    };
                } else if (__value__ == (3674291i32)) {
                    return true;
                    _gotoNext = 3674457i32;
                } else if (__value__ == (3674457i32)) {
                    if ((((@:checkr _b ?? throw "null pointer dereference")._cap.length) > (1 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3674475i32;
                    } else {
                        _gotoNext = 3674504i32;
                    };
                } else if (__value__ == (3674475i32)) {
                    ...
                    _gotoNext = 3674659i32;
                } else if (__value__ == (3674659i32)) {
                    if (!_longest_0) {
                        _gotoNext = 3674671i32;
                    } else {
                        _gotoNext = 3674761i32;
                    };
                } else if (__value__ == (3674671i32)) {
                    return true;
                    _gotoNext = 3674761i32;
                } else if (__value__ == (3674761i32)) {
                    if (_pos_3 == ((@:checkr _b ?? throw "null pointer dereference")._end)) {
                        _gotoNext = 3674777i32;
                    } else {
                        _gotoNext = 3674860i32;
                    };
                } else if (__value__ == (3674777i32)) {
                    return true;
                    _gotoNext = 3674860i32;
                } else if (__value__ == (3674860i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3671242i32;
                } else if (__value__ == (3674878i32)) {
