        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if (_startCond_27 == ((255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        ...
                        _gotoNext = 3770841i32;
                    };
                } else if (__value__ == (3770807i32)) {
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3770841i32;
                } else if (__value__ == (3770841i32)) {
                    ...
                    if (((@:checkr _m_28 ?? throw "null pointer dereference")._matchcap.capacity < _ncap : Bool)) {
                        _gotoNext = 3770893i32;
                    } else {
                        _gotoNext = 3770936i32;
                    };
                } else if (__value__ == (3770893i32)) {
                    ...
                    _gotoNext = 3770976i32;
                } else if (__value__ == (3770936i32)) {
                    _gotoNext = 3770936i32;
                    ...
                    if (_r_32 != ((-1 : stdgo.GoInt32))) {
                        _gotoNext = 3771180i32;
                    } else {
                        _gotoNext = 3771221i32;
                    };
                } else if (__value__ == (3771180i32)) {
                    {
                    ...
                    _gotoNext = 3771221i32;
                } else if (__value__ == (3771221i32)) {
                    if (_pos == ((0 : stdgo.GoInt))) {
                        _gotoNext = 3771252i32;
                    } else {
                        _gotoNext = 3771290i32;
                    };
                } else if (__value__ == (3771252i32)) {
                    _flag_36 = stdgo._internal.regexp.Regexp__newlazyflag._newLazyFlag((-1 : stdgo.GoInt32), _r_32);
                    _gotoNext = 3771320i32;
                } else if (__value__ == (3771290i32)) {
                    _gotoNext = 3771290i32;
                    ...
                    if ((((_pos == ((0 : stdgo.GoInt)) && _flag_36._match(((@:checkr _inst_38 ?? throw "null pointer dereference").inst.arg : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp)) : Bool) && (((@:checkr _re ?? throw "null pointer dereference")._prefix.length) > (0 : stdgo.GoInt) : Bool) : Bool) && _i_31._canCheckPrefix() : Bool)) {
                        _gotoNext = 3771527i32;
                    } else {
                        _gotoNext = 3771765i32;
                    };
                } else if (__value__ == (3771527i32)) {
                    if (!_i_31._hasPrefix(_re)) {
                        _gotoNext = 3771607i32;
                    } else {
                        _gotoNext = 3771630i32;
                    };
                } else if (__value__ == (3771607i32)) {
                    _gotoNext = 3772889i32;
                } else if (__value__ == (3771630i32)) {
                    ...
                    _gotoNext = 3771765i32;
                } else if (__value__ == (3771765i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3771765i32;
                    if (true) {
                        _gotoNext = 3771769i32;
                    } else {
                        _gotoNext = 3772889i32;
                    };
                } else if (__value__ == (3771769i32)) {
                    _inst_38 = (stdgo.Go.setRef((@:checkr (@:checkr _re ?? throw "null pointer dereference")._onepass ?? throw "null pointer dereference").inst[(_pc_37 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.Regexp_t_onepassinst.T_onePassInst>);
                    _pc_37 = ((@:checkr _inst_38 ?? throw "null pointer dereference").inst.out : stdgo.GoInt);
                    _gotoNext = 3771824i32;
                } else if (__value__ == (3771824i32)) {
                    {
                        final __value__ = (@:checkr _inst_38 ?? throw "null pointer dereference").inst.op;
                        if (__value__ == ((4 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3771875i32;
                        } else if (__value__ == ((7 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3772012i32;
                        } else if (__value__ == ((8 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3772084i32;
                        } else if (__value__ == ((9 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3772156i32;
                        } else if (__value__ == ((10 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3772197i32;
                        } else if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((1 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3772335i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3772425i32;
                        } else if (__value__ == ((6 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3772464i32;
                        } else if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3772499i32;
                        } else if (__value__ == ((2 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3772608i32;
                        } else {
                            _gotoNext = 3771843i32;
                        };
                    };
                } else if (__value__ == (3771843i32)) {
                    throw stdgo.Go.toInterface(("bad inst" : stdgo.GoString));
                    _gotoNext = 3772727i32;
                } else if (__value__ == (3771875i32)) {
                    _matched_29 = true;
                    if ((((@:checkr _m_28 ?? throw "null pointer dereference")._matchcap.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3771942i32;
                    } else {
                        _gotoNext = 3771998i32;
                    };
                } else if (__value__ == (3771942i32)) {
                    ...
                    _gotoNext = 3772889i32;
                } else if (__value__ == (3772012i32)) {
                    if (!@:check2r _inst_38.matchRune(_r_32)) {
                        _gotoNext = 3772059i32;
                    } else {
                        _gotoNext = 3772727i32;
                    };
                } else if (__value__ == (3772059i32)) {
                    _gotoNext = 3772889i32;
                } else if (__value__ == (3772084i32)) {
                    ...
                    _gotoNext = 3772889i32;
                } else if (__value__ == (3772335i32)) {
                    _pc_37 = (stdgo._internal.regexp.Regexp__onepassnext._onePassNext(_inst_38, _r_32) : stdgo.GoInt);
                    var __blank__ = 0i32;
                    _gotoNext = 3771765i32;
                } else if (__value__ == (3772425i32)) {
                    _gotoNext = 3772889i32;
                } else if (__value__ == (3772464i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3771765i32;
                } else if (__value__ == (3772499i32)) {
                    if (!_flag_36._match(((@:checkr _inst_38 ?? throw "null pointer dereference").inst.arg : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3772571i32;
                    } else {
                        _gotoNext = 3772597i32;
                    };
                } else if (__value__ == (3772571i32)) {
                    _gotoNext = 3772889i32;
                } else if (__value__ == (3772597i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3771765i32;
                } else if (__value__ == (3772608i32)) {
                    if ((((@:checkr _inst_38 ?? throw "null pointer dereference").inst.arg : stdgo.GoInt) < ((@:checkr _m_28 ?? throw "null pointer dereference")._matchcap.length) : Bool)) {
                        _gotoNext = 3772671i32;
                    } else {
                        _gotoNext = 3772712i32;
                    };
                } else if (__value__ == (3772671i32)) {
                    ...
                    _gotoNext = 3772712i32;
                } else if (__value__ == (3772712i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3771765i32;
                } else if (__value__ == (3772727i32)) {
                    if (_width_34 == ((0 : stdgo.GoInt))) {
                        _gotoNext = 3772741i32;
                    } else {
                        _gotoNext = 3772758i32;
                    };
                } else if (__value__ == (3772741i32)) {
                    _gotoNext = 3772889i32;
                } else if (__value__ == (3772758i32)) {
                    ...
                    if (_r_32 != ((-1 : stdgo.GoInt32))) {
                        _gotoNext = 3772843i32;
                    } else {
                        _gotoNext = 3771765i32;
                    };
                } else if (__value__ == (3772843i32)) {
                    {
                        var __tmp__ = _i_31._step((_pos + _width_34 : stdgo.GoInt));
                        _r1_33 = @:tmpset0 __tmp__._0;
                        _width1_35 = @:tmpset0 __tmp__._1;
                    ...
                    _gotoNext = 3771765i32;
                } else if (__value__ == (3772889i32)) {
                    _gotoNext = 3772889i32;
                    if (!_matched_29) {
                        _gotoNext = 3772910i32;
                    } else {
                        _gotoNext = 3772954i32;
                    };
                } else if (__value__ == (3772910i32)) {
                    stdgo._internal.regexp.Regexp__freeonepassmachine._freeOnePassMachine(_m_28);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3772954i32;
                } else if (__value__ == (3772954i32)) {
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if (_startCond_16 == ((255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3760145i32;
                    } else {
                        _gotoNext = 3760178i32;
                    };
                } else if (__value__ == (3760145i32)) {
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3760178i32;
                } else if (__value__ == (3760178i32)) {
                    if ((((_startCond_16 & (4 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp) : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp) != (0 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp)) && (_pos != (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 3760230i32;
                    } else {
                        _gotoNext = 3760295i32;
                    };
                } else if (__value__ == (3760230i32)) {
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3760295i32;
                } else if (__value__ == (3760295i32)) {
                    ...
                    if ((_startCond_16 & (4 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp) : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp) != ((0 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3760484i32;
                    } else {
                        _gotoNext = 3760633i32;
                    };
                } else if (__value__ == (3760484i32)) {
                    if ((((@:checkr _b_17 ?? throw "null pointer dereference")._cap.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3760506i32;
                    } else {
                        _gotoNext = 3760532i32;
                    };
                } else if (__value__ == (3760506i32)) {
                    (@:checkr _b_17 ?? throw "null pointer dereference")._cap[(0 : stdgo.GoInt)] = _pos;
                    _gotoNext = 3760532i32;
                } else if (__value__ == (3760532i32)) {
                    if (!@:check2r _re._tryBacktrack(_b_17, _i_18, ((@:checkr (@:checkr _re ?? throw "null pointer dereference")._prog ?? throw "null pointer dereference").start : stdgo.GoUInt32), _pos)) {
                        _gotoNext = 3760586i32;
                    } else {
                        _gotoNext = 3761520i32;
                    };
                } else if (__value__ == (3760586i32)) {
                    stdgo._internal.regexp.Regexp__freebitstate._freeBitState(_b_17);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3761520i32;
                } else if (__value__ == (3760633i32)) {
                    _gotoNext = 3760633i32;
                    _width_20 = (-1 : stdgo.GoInt);
                    var __blank__ = 0i32;
                    _gotoNext = 3761040i32;
                } else if (__value__ == (3761040i32)) {
                    if (((_pos <= _end_19 : Bool) && (_width_20 != (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 3761085i32;
                    } else {
                        _gotoNext = 3761487i32;
                    };
                } else if (__value__ == (3761085i32)) {
                    if ((((@:checkr _re ?? throw "null pointer dereference")._prefix.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3761112i32;
                    } else {
                        _gotoNext = 3761296i32;
                    };
                } else if (__value__ == (3761112i32)) {
                    _advance_21 = _i_18._index(_re, _pos);
                    if ((_advance_21 < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3761223i32;
                    } else {
                        _gotoNext = 3761272i32;
                    };
                } else if (__value__ == (3761223i32)) {
                    stdgo._internal.regexp.Regexp__freebitstate._freeBitState(_b_17);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3761272i32;
                } else if (__value__ == (3761272i32)) {
                    _pos = (_pos + (_advance_21) : stdgo.GoInt);
                    _gotoNext = 3761296i32;
                } else if (__value__ == (3761296i32)) {
                    if ((((@:checkr _b_17 ?? throw "null pointer dereference")._cap.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3761314i32;
                    } else {
                        _gotoNext = 3761343i32;
                    };
                } else if (__value__ == (3761314i32)) {
                    (@:checkr _b_17 ?? throw "null pointer dereference")._cap[(0 : stdgo.GoInt)] = _pos;
                    _gotoNext = 3761343i32;
                } else if (__value__ == (3761343i32)) {
                    if (@:check2r _re._tryBacktrack(_b_17, _i_18, ((@:checkr (@:checkr _re ?? throw "null pointer dereference")._prog ?? throw "null pointer dereference").start : stdgo.GoUInt32), _pos)) {
                        _gotoNext = 3761396i32;
                    } else {
                        _gotoNext = 3761458i32;
                    };
                } else if (__value__ == (3761396i32)) {
                    _gotoNext = 3761520i32;
                } else if (__value__ == (3761458i32)) {
                    {
                    ...
                    _gotoNext = 3761040i32;
                } else if (__value__ == (3761487i32)) {
                    stdgo._internal.regexp.Regexp__freebitstate._freeBitState(_b_17);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    var __blank__ = 0i32;
                    _gotoNext = 3761520i32;
                } else if (__value__ == (3761520i32)) {
                    _gotoNext = 3761520i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 3756219i32;
                } else if (__value__ == (3756219i32)) {
                    if ((((@:checkr _b ?? throw "null pointer dereference")._jobs.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3756239i32;
                    } else {
                        _gotoNext = 3759855i32;
                    };
                } else if (__value__ == (3756239i32)) {
                    ...
                    _gotoNext = 3756733i32;
                } else if (__value__ == (3756671i32)) {
                    if (!@:check2r _b._shouldVisit(_pc_2, _pos_3)) {
                        _gotoNext = 3756714i32;
                    } else {
                        _gotoNext = 3756733i32;
                    };
                } else if (__value__ == (3756714i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3756219i32;
                } else if (__value__ == (3756733i32)) {
                    _gotoNext = 3756733i32;
                    ...
                    _gotoNext = 3756771i32;
                } else if (__value__ == (3756771i32)) {
                    {
                        final __value__ = (@:checkr _inst_5 ?? throw "null pointer dereference").op;
                        if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3756822i32;
                        } else if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3756878i32;
                        } else if (__value__ == ((1 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3757439i32;
                        } else if (__value__ == ((7 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3757898i32;
                        } else if (__value__ == ((8 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3758049i32;
                        } else if (__value__ == ((10 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3758200i32;
                        } else if (__value__ == ((9 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3758368i32;
                        } else if (__value__ == ((2 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3758518i32;
                        } else if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3758901i32;
                        } else if (__value__ == ((6 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3759060i32;
                        } else if (__value__ == ((4 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3759122i32;
                        } else {
                            _gotoNext = 3756790i32;
                        };
                    };
                } else if (__value__ == (3756790i32)) {
                    throw stdgo.Go.toInterface(("bad inst" : stdgo.GoString));
                    _gotoNext = 3756219i32;
                } else if (__value__ == (3756822i32)) {
                    throw stdgo.Go.toInterface(("unexpected InstFail" : stdgo.GoString));
                    _gotoNext = 3756219i32;
                } else if (__value__ == (3756878i32)) {
                    if (_arg_4) {
                        _gotoNext = 3757251i32;
                    } else {
                        _gotoNext = 3757359i32;
                    };
                } else if (__value__ == (3757251i32)) {
                    _arg_4 = false;
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").arg;
                    _gotoNext = 3756671i32;
                } else if (__value__ == (3757359i32)) {
                    _gotoNext = 3757359i32;
                    @:check2r _b._push(_re, _pc_2, _pos_3, true);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3756671i32;
                } else if (__value__ == (3757439i32)) {
                ...
                } else if (__value__ == (3757527i32)) {
                    {
                        ...
                        if (__value__ == ((7 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((8 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((9 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((10 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3757565i32;
                        } else {
                            _gotoNext = 3757822i32;
                        };
                    };
                } else if (__value__ == (3757565i32)) {
                    ...
                    if (!@:check2r _inst_5.matchRune(_r_6)) {
                        _gotoNext = 3757972i32;
                    } else {
                        _gotoNext = 3757995i32;
                    };
                } else if (__value__ == (3757972i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3756219i32;
                } else if (__value__ == (3757995i32)) {
                    _pos_3 = (_pos_3 + (_width_7) : stdgo.GoInt);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3756671i32;
                } else if (__value__ == (3758049i32)) {
                    {
                        var __tmp__ = _i._step(_pos_3);
                    ...
                    if (_r_8 != ((@:checkr _inst_5 ?? throw "null pointer dereference").rune[((0 : stdgo.GoInt) : stdgo.GoInt)])) {
                        _gotoNext = 3758123i32;
                    } else {
                        _gotoNext = 3758146i32;
                    };
                } else if (__value__ == (3758123i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3756219i32;
                } else if (__value__ == (3758146i32)) {
                    _pos_3 = (_pos_3 + (_width_9) : stdgo.GoInt);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3756671i32;
                } else if (__value__ == (3758200i32)) {
                    {
                        var __tmp__ = _i._step(_pos_3);
                    ...
                    if (((_r_10 == (10 : stdgo.GoInt32)) || (_r_10 == (-1 : stdgo.GoInt32)) : Bool)) {
                        ...
                        _gotoNext = 3758314i32;
                    };
                } else if (__value__ == (3758291i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3756219i32;
                } else if (__value__ == (3758314i32)) {
                    _pos_3 = (_pos_3 + (_width_11) : stdgo.GoInt);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3756671i32;
                } else if (__value__ == (3758368i32)) {
                    {
                        var __tmp__ = _i._step(_pos_3);
                    ...
                    if (((@:checkr _inst_5 ?? throw "null pointer dereference").arg < ((@:checkr _b ?? throw "null pointer dereference")._cap.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 3758692i32;
                    } else {
                        _gotoNext = 3758857i32;
                    };
                } else if (__value__ == (3758692i32)) {
                    ...
                    (@:checkr _b ?? throw "null pointer dereference")._cap[((@:checkr _inst_5 ?? throw "null pointer dereference").arg : stdgo.GoInt)] = _pos_3;
                    _gotoNext = 3758857i32;
                } else if (__value__ == (3758857i32)) {
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3756671i32;
                } else if (__value__ == (3758901i32)) {
                    ...
                    if (!_flag_14._match(((@:checkr _inst_5 ?? throw "null pointer dereference").arg : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3758999i32;
                    } else {
                        _gotoNext = 3759022i32;
                    };
                } else if (__value__ == (3758999i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3756219i32;
                } else if (__value__ == (3759022i32)) {
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3756671i32;
                } else if (__value__ == (3759060i32)) {
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3756671i32;
                } else if (__value__ == (3759122i32)) {
                    if (((@:checkr _b ?? throw "null pointer dereference")._cap.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 3759268i32;
                    } else {
                        _gotoNext = 3759434i32;
                    };
                } else if (__value__ == (3759268i32)) {
                    return true;
                    _gotoNext = 3759434i32;
                } else if (__value__ == (3759434i32)) {
                    if ((((@:checkr _b ?? throw "null pointer dereference")._cap.length) > (1 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3759452i32;
                    } else {
                        _gotoNext = 3759481i32;
                    };
                } else if (__value__ == (3759452i32)) {
                    (@:checkr _b ?? throw "null pointer dereference")._cap[(1 : stdgo.GoInt)] = _pos_3;
                    _gotoNext = 3759481i32;
                } else if (__value__ == (3759481i32)) {
                    {
                        ...
                        if (((_old_15 == (-1 : stdgo.GoInt)) || (((_longest_0 && (_pos_3 > (0 : stdgo.GoInt) : Bool) : Bool) && (_pos_3 > _old_15 : Bool) : Bool)) : Bool)) {
                            _gotoNext = 3759553i32;
                        } else {
                            _gotoNext = 3759636i32;
                        };
                    };
                } else if (__value__ == (3759553i32)) {
                    (@:checkr _b ?? throw "null pointer dereference")._matchcap.__copyTo__((@:checkr _b ?? throw "null pointer dereference")._cap);
                    _gotoNext = 3759636i32;
                } else if (__value__ == (3759636i32)) {
                    if (!_longest_0) {
                        _gotoNext = 3759648i32;
                    } else {
                        _gotoNext = 3759738i32;
                    };
                } else if (__value__ == (3759648i32)) {
                    return true;
                    _gotoNext = 3759738i32;
                } else if (__value__ == (3759738i32)) {
                    if (_pos_3 == ((@:checkr _b ?? throw "null pointer dereference")._end)) {
                        _gotoNext = 3759754i32;
                    } else {
                        _gotoNext = 3759837i32;
                    };
                } else if (__value__ == (3759754i32)) {
                    return true;
                    _gotoNext = 3759837i32;
                } else if (__value__ == (3759837i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3756219i32;
                } else if (__value__ == (3759855i32)) {
