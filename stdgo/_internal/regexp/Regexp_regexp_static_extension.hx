        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if (_startCond_27 == ((255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3783757i32;
                    } else {
                        _gotoNext = 3783791i32;
                    };
                } else if (__value__ == (3783757i32)) {
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3783791i32;
                } else if (__value__ == (3783791i32)) {
                    ...
                    if (((@:checkr _m_28 ?? throw "null pointer dereference")._matchcap.capacity < _ncap : Bool)) {
                        _gotoNext = 3783843i32;
                    } else {
                        _gotoNext = 3783886i32;
                    };
                } else if (__value__ == (3783843i32)) {
                    ...
                    _gotoNext = 3783926i32;
                } else if (__value__ == (3783886i32)) {
                    _gotoNext = 3783886i32;
                    ...
                    if (_r_32 != ((-1 : stdgo.GoInt32))) {
                        _gotoNext = 3784130i32;
                    } else {
                        _gotoNext = 3784171i32;
                    };
                } else if (__value__ == (3784130i32)) {
                    {
                    ...
                    _gotoNext = 3784171i32;
                } else if (__value__ == (3784171i32)) {
                    if (_pos == ((0 : stdgo.GoInt))) {
                        _gotoNext = 3784202i32;
                    } else {
                        _gotoNext = 3784240i32;
                    };
                } else if (__value__ == (3784202i32)) {
                    _flag_36 = stdgo._internal.regexp.Regexp__newlazyflag._newLazyFlag((-1 : stdgo.GoInt32), _r_32);
                    _gotoNext = 3784270i32;
                } else if (__value__ == (3784240i32)) {
                    _gotoNext = 3784240i32;
                    _flag_36 = _i_31._context(_pos);
                    0i32;
                    _gotoNext = 3784270i32;
                } else if (__value__ == (3784270i32)) {
                    ...
                    if ((((_pos == ((0 : stdgo.GoInt)) && _flag_36._match(((@:checkr _inst_38 ?? throw "null pointer dereference").inst.arg : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp)) : Bool) && (((@:checkr _re ?? throw "null pointer dereference")._prefix.length) > (0 : stdgo.GoInt) : Bool) : Bool) && _i_31._canCheckPrefix() : Bool)) {
                        _gotoNext = 3784477i32;
                    } else {
                        _gotoNext = 3784715i32;
                    };
                } else if (__value__ == (3784477i32)) {
                    if (!_i_31._hasPrefix(_re)) {
                        _gotoNext = 3784557i32;
                    } else {
                        _gotoNext = 3784580i32;
                    };
                } else if (__value__ == (3784557i32)) {
                    _gotoNext = 3785839i32;
                    ...
                    _gotoNext = 3784715i32;
                } else if (__value__ == (3784715i32)) {
                    0i32;
                    _gotoNext = 3784715i32;
                    if (true) {
                        _gotoNext = 3784719i32;
                    } else {
                        _gotoNext = 3785839i32;
                    };
                } else if (__value__ == (3784719i32)) {
                    _inst_38 = (stdgo.Go.setRef((@:checkr (@:checkr _re ?? throw "null pointer dereference")._onepass ?? throw "null pointer dereference").inst[(_pc_37 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.Regexp_t_onepassinst.T_onePassInst>);
                    _pc_37 = ((@:checkr _inst_38 ?? throw "null pointer dereference").inst.out : stdgo.GoInt);
                    _gotoNext = 3784774i32;
                } else if (__value__ == (3784774i32)) {
                    {
                        final __value__ = (@:checkr _inst_38 ?? throw "null pointer dereference").inst.op;
                        if (__value__ == ((4 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3784825i32;
                        } else if (__value__ == ((7 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3784962i32;
                        } else if (__value__ == ((8 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3785034i32;
                        } else if (__value__ == ((9 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3785106i32;
                        } else if (__value__ == ((10 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3785147i32;
                        } else if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((1 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3785285i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3785375i32;
                        } else if (__value__ == ((6 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3785414i32;
                        } else if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3785449i32;
                        } else if (__value__ == ((2 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3785558i32;
                        } else {
                            _gotoNext = 3784793i32;
                        };
                    };
                } else if (__value__ == (3784793i32)) {
                    throw stdgo.Go.toInterface(("bad inst" : stdgo.GoString));
                    _gotoNext = 3785677i32;
                } else if (__value__ == (3784825i32)) {
                    _matched_29 = true;
                    if ((((@:checkr _m_28 ?? throw "null pointer dereference")._matchcap.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3784892i32;
                    } else {
                        _gotoNext = 3784948i32;
                    };
                } else if (__value__ == (3784892i32)) {
                    ...
                    _gotoNext = 3784948i32;
                } else if (__value__ == (3784948i32)) {
                    _gotoNext = 3785839i32;
                } else if (__value__ == (3784962i32)) {
                    ...
                    _gotoNext = 3785839i32;
                } else if (__value__ == (3785034i32)) {
                    if (_r_32 != ((@:checkr _inst_38 ?? throw "null pointer dereference").inst.rune[((0 : stdgo.GoInt) : stdgo.GoInt)])) {
                        _gotoNext = 3785081i32;
                    } else {
                        _gotoNext = 3785677i32;
                    };
                } else if (__value__ == (3785081i32)) {
                    _gotoNext = 3785839i32;
                } else if (__value__ == (3785106i32)) {
                    _gotoNext = 3785677i32;
                } else if (__value__ == (3785147i32)) {
                    if (_r_32 == ((10 : stdgo.GoInt32))) {
                        _gotoNext = 3785193i32;
                    } else {
                        _gotoNext = 3785677i32;
                    };
                } else if (__value__ == (3785193i32)) {
                    _gotoNext = 3785839i32;
                } else if (__value__ == (3785285i32)) {
                    _pc_37 = (stdgo._internal.regexp.Regexp__onepassnext._onePassNext(_inst_38, _r_32) : stdgo.GoInt);
                    0i32;
                    _gotoNext = 3784715i32;
                } else if (__value__ == (3785375i32)) {
                    _gotoNext = 3785839i32;
                } else if (__value__ == (3785414i32)) {
                    0i32;
                    _gotoNext = 3784715i32;
                } else if (__value__ == (3785449i32)) {
                    if (!_flag_36._match(((@:checkr _inst_38 ?? throw "null pointer dereference").inst.arg : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3785521i32;
                    } else {
                        _gotoNext = 3785547i32;
                    };
                } else if (__value__ == (3785521i32)) {
                    _gotoNext = 3785839i32;
                } else if (__value__ == (3785547i32)) {
                    0i32;
                    _gotoNext = 3784715i32;
                } else if (__value__ == (3785558i32)) {
                    if ((((@:checkr _inst_38 ?? throw "null pointer dereference").inst.arg : stdgo.GoInt) < ((@:checkr _m_28 ?? throw "null pointer dereference")._matchcap.length) : Bool)) {
                        _gotoNext = 3785621i32;
                    } else {
                        _gotoNext = 3785662i32;
                    };
                } else if (__value__ == (3785621i32)) {
                    ...
                    _gotoNext = 3785662i32;
                } else if (__value__ == (3785662i32)) {
                    0i32;
                    _gotoNext = 3784715i32;
                } else if (__value__ == (3785677i32)) {
                    if (_width_34 == ((0 : stdgo.GoInt))) {
                        _gotoNext = 3785691i32;
                    } else {
                        _gotoNext = 3785708i32;
                    };
                } else if (__value__ == (3785691i32)) {
                    _gotoNext = 3785839i32;
                } else if (__value__ == (3785708i32)) {
                    ...
                    if (_r_32 != ((-1 : stdgo.GoInt32))) {
                        _gotoNext = 3785793i32;
                    } else {
                        _gotoNext = 3784715i32;
                    };
                } else if (__value__ == (3785793i32)) {
                    {
                        var __tmp__ = _i_31._step((_pos + _width_34 : stdgo.GoInt));
                        _r1_33 = @:tmpset0 __tmp__._0;
                        _width1_35 = @:tmpset0 __tmp__._1;
                    ...
                    _gotoNext = 3784715i32;
                } else if (__value__ == (3785839i32)) {
                    _gotoNext = 3785839i32;
                    if (!_matched_29) {
                        _gotoNext = 3785860i32;
                    } else {
                        _gotoNext = 3785904i32;
                    };
                } else if (__value__ == (3785860i32)) {
                    stdgo._internal.regexp.Regexp__freeonepassmachine._freeOnePassMachine(_m_28);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3785904i32;
                } else if (__value__ == (3785904i32)) {
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if (_startCond_16 == ((255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3794665i32;
                    } else {
                        _gotoNext = 3794698i32;
                    };
                } else if (__value__ == (3794665i32)) {
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3794698i32;
                } else if (__value__ == (3794698i32)) {
                    if ((((_startCond_16 & (4 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp) : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp) != (0 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp)) && (_pos != (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 3794750i32;
                    } else {
                        _gotoNext = 3794815i32;
                    };
                } else if (__value__ == (3794750i32)) {
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3794815i32;
                    ...
                    if ((_startCond_16 & (4 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp) : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp) != ((0 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3795004i32;
                    } else {
                        _gotoNext = 3795153i32;
                    };
                } else if (__value__ == (3795004i32)) {
                    if ((((@:checkr _b_17 ?? throw "null pointer dereference")._cap.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3795026i32;
                    } else {
                        _gotoNext = 3795052i32;
                    };
                } else if (__value__ == (3795026i32)) {
                    (@:checkr _b_17 ?? throw "null pointer dereference")._cap[(0 : stdgo.GoInt)] = _pos;
                    _gotoNext = 3795052i32;
                } else if (__value__ == (3795052i32)) {
                    if (!@:check2r _re._tryBacktrack(_b_17, _i_18, ((@:checkr (@:checkr _re ?? throw "null pointer dereference")._prog ?? throw "null pointer dereference").start : stdgo.GoUInt32), _pos)) {
                        _gotoNext = 3795106i32;
                    } else {
                        _gotoNext = 3796040i32;
                    };
                } else if (__value__ == (3795106i32)) {
                    stdgo._internal.regexp.Regexp__freebitstate._freeBitState(_b_17);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3796040i32;
                } else if (__value__ == (3795153i32)) {
                    _gotoNext = 3795153i32;
                    _width_20 = (-1 : stdgo.GoInt);
                    0i32;
                    _gotoNext = 3795560i32;
                } else if (__value__ == (3795560i32)) {
                    if (((_pos <= _end_19 : Bool) && (_width_20 != (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 3795605i32;
                    } else {
                        _gotoNext = 3796007i32;
                    };
                } else if (__value__ == (3795605i32)) {
                    if ((((@:checkr _re ?? throw "null pointer dereference")._prefix.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3795632i32;
                    } else {
                        _gotoNext = 3795816i32;
                    };
                } else if (__value__ == (3795632i32)) {
                    _advance_21 = _i_18._index(_re, _pos);
                    if ((_advance_21 < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3795743i32;
                    } else {
                        _gotoNext = 3795792i32;
                    };
                } else if (__value__ == (3795743i32)) {
                    stdgo._internal.regexp.Regexp__freebitstate._freeBitState(_b_17);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3795792i32;
                } else if (__value__ == (3795792i32)) {
                    _pos = (_pos + (_advance_21) : stdgo.GoInt);
                    _gotoNext = 3795816i32;
                } else if (__value__ == (3795816i32)) {
                    if ((((@:checkr _b_17 ?? throw "null pointer dereference")._cap.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3795834i32;
                    } else {
                        _gotoNext = 3795863i32;
                    };
                } else if (__value__ == (3795834i32)) {
                    (@:checkr _b_17 ?? throw "null pointer dereference")._cap[(0 : stdgo.GoInt)] = _pos;
                    _gotoNext = 3795863i32;
                } else if (__value__ == (3795863i32)) {
                    if (@:check2r _re._tryBacktrack(_b_17, _i_18, ((@:checkr (@:checkr _re ?? throw "null pointer dereference")._prog ?? throw "null pointer dereference").start : stdgo.GoUInt32), _pos)) {
                        _gotoNext = 3795916i32;
                    } else {
                        _gotoNext = 3795978i32;
                    };
                } else if (__value__ == (3795916i32)) {
                    _gotoNext = 3796040i32;
                } else if (__value__ == (3795978i32)) {
                    {
                    ...
                    _gotoNext = 3795560i32;
                } else if (__value__ == (3796007i32)) {
                    stdgo._internal.regexp.Regexp__freebitstate._freeBitState(_b_17);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    0i32;
                    _gotoNext = 3796040i32;
                } else if (__value__ == (3796040i32)) {
                    _gotoNext = 3796040i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((((@:checkr _b ?? throw "null pointer dereference")._jobs.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3790759i32;
                    } else {
                        _gotoNext = 3794375i32;
                    };
                } else if (__value__ == (3790759i32)) {
                ...
                } else if (__value__ == (3791191i32)) {
                    if (!@:check2r _b._shouldVisit(_pc_2, _pos_3)) {
                        _gotoNext = 3791234i32;
                    } else {
                        _gotoNext = 3791253i32;
                    };
                } else if (__value__ == (3791234i32)) {
                    0i32;
                    _gotoNext = 3790739i32;
                    ...
                    _gotoNext = 3791291i32;
                } else if (__value__ == (3791291i32)) {
                    {
                        final __value__ = (@:checkr _inst_5 ?? throw "null pointer dereference").op;
                        if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3791342i32;
                        } else if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3791398i32;
                        } else if (__value__ == ((1 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3791959i32;
                        } else if (__value__ == ((7 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3792418i32;
                        } else if (__value__ == ((8 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3792569i32;
                        } else if (__value__ == ((10 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3792720i32;
                        } else if (__value__ == ((9 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3792888i32;
                        } else if (__value__ == ((2 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3793038i32;
                        } else if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3793421i32;
                        } else if (__value__ == ((6 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3793580i32;
                        } else if (__value__ == ((4 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3793642i32;
                        } else {
                            _gotoNext = 3791310i32;
                        };
                    };
                } else if (__value__ == (3791310i32)) {
                    throw stdgo.Go.toInterface(("bad inst" : stdgo.GoString));
                    _gotoNext = 3790739i32;
                } else if (__value__ == (3791342i32)) {
                    throw stdgo.Go.toInterface(("unexpected InstFail" : stdgo.GoString));
                    _gotoNext = 3790739i32;
                } else if (__value__ == (3791398i32)) {
                    if (_arg_4) {
                        _gotoNext = 3791771i32;
                    } else {
                        _gotoNext = 3791879i32;
                    };
                } else if (__value__ == (3791771i32)) {
                    _arg_4 = false;
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").arg;
                    _gotoNext = 3791191i32;
                } else if (__value__ == (3791879i32)) {
                    _gotoNext = 3791879i32;
                    @:check2r _b._push(_re, _pc_2, _pos_3, true);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3791191i32;
                } else if (__value__ == (3791959i32)) {
                    _gotoNext = 3792047i32;
                } else if (__value__ == (3792047i32)) {
                    {
                        ...
                        if (__value__ == ((7 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((8 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((9 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((10 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3792085i32;
                        } else {
                            _gotoNext = 3792342i32;
                        };
                    };
                } else if (__value__ == (3792085i32)) {
                    ...
                    if (!@:check2r _inst_5.matchRune(_r_6)) {
                        _gotoNext = 3792492i32;
                    } else {
                        _gotoNext = 3792515i32;
                    };
                } else if (__value__ == (3792492i32)) {
                    0i32;
                    _gotoNext = 3790739i32;
                } else if (__value__ == (3792515i32)) {
                    _pos_3 = (_pos_3 + (_width_7) : stdgo.GoInt);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3791191i32;
                } else if (__value__ == (3792569i32)) {
                    {
                        var __tmp__ = _i._step(_pos_3);
                    ...
                    if (_r_8 != ((@:checkr _inst_5 ?? throw "null pointer dereference").rune[((0 : stdgo.GoInt) : stdgo.GoInt)])) {
                        _gotoNext = 3792643i32;
                    } else {
                        _gotoNext = 3792666i32;
                    };
                } else if (__value__ == (3792643i32)) {
                    0i32;
                    _gotoNext = 3790739i32;
                } else if (__value__ == (3792666i32)) {
                    _pos_3 = (_pos_3 + (_width_9) : stdgo.GoInt);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3791191i32;
                } else if (__value__ == (3792720i32)) {
                    {
                        var __tmp__ = _i._step(_pos_3);
                    ...
                    if (((_r_10 == (10 : stdgo.GoInt32)) || (_r_10 == (-1 : stdgo.GoInt32)) : Bool)) {
                        _gotoNext = 3792811i32;
                    } else {
                        _gotoNext = 3792834i32;
                    };
                } else if (__value__ == (3792811i32)) {
                    0i32;
                    _gotoNext = 3790739i32;
                } else if (__value__ == (3792834i32)) {
                    _pos_3 = (_pos_3 + (_width_11) : stdgo.GoInt);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3791191i32;
                } else if (__value__ == (3792888i32)) {
                    {
                        var __tmp__ = _i._step(_pos_3);
                    ...
                    if (_r_12 == ((-1 : stdgo.GoInt32))) {
                        _gotoNext = 3792961i32;
                    } else {
                        _gotoNext = 3792984i32;
                    };
                } else if (__value__ == (3792961i32)) {
                    0i32;
                    _gotoNext = 3790739i32;
                } else if (__value__ == (3792984i32)) {
                    _pos_3 = (_pos_3 + (_width_13) : stdgo.GoInt);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3791191i32;
                } else if (__value__ == (3793038i32)) {
                    if (_arg_4) {
                        _gotoNext = 3793073i32;
                    } else {
                        _gotoNext = 3793173i32;
                    };
                } else if (__value__ == (3793073i32)) {
                    (@:checkr _b ?? throw "null pointer dereference")._cap[((@:checkr _inst_5 ?? throw "null pointer dereference").arg : stdgo.GoInt)] = _pos_3;
                    0i32;
                    _gotoNext = 3790739i32;
                } else if (__value__ == (3793173i32)) {
                    _gotoNext = 3793173i32;
                    ...
                    (@:checkr _b ?? throw "null pointer dereference")._cap[((@:checkr _inst_5 ?? throw "null pointer dereference").arg : stdgo.GoInt)] = _pos_3;
                    _gotoNext = 3793377i32;
                } else if (__value__ == (3793377i32)) {
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3791191i32;
                } else if (__value__ == (3793421i32)) {
                    ...
                    if (!_flag_14._match(((@:checkr _inst_5 ?? throw "null pointer dereference").arg : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3793519i32;
                    } else {
                        _gotoNext = 3793542i32;
                    };
                } else if (__value__ == (3793519i32)) {
                    0i32;
                    _gotoNext = 3790739i32;
                } else if (__value__ == (3793542i32)) {
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3791191i32;
                } else if (__value__ == (3793580i32)) {
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3791191i32;
                } else if (__value__ == (3793642i32)) {
                    if (((@:checkr _b ?? throw "null pointer dereference")._cap.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 3793788i32;
                    } else {
                        _gotoNext = 3793954i32;
                    };
                } else if (__value__ == (3793788i32)) {
                    return true;
                    _gotoNext = 3793954i32;
                } else if (__value__ == (3793954i32)) {
                    if ((((@:checkr _b ?? throw "null pointer dereference")._cap.length) > (1 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3793972i32;
                    } else {
                        _gotoNext = 3794001i32;
                    };
                } else if (__value__ == (3793972i32)) {
                    (@:checkr _b ?? throw "null pointer dereference")._cap[(1 : stdgo.GoInt)] = _pos_3;
                    _gotoNext = 3794001i32;
                } else if (__value__ == (3794001i32)) {
                    {
                        ...
                        if (((_old_15 == (-1 : stdgo.GoInt)) || (((_longest_0 && (_pos_3 > (0 : stdgo.GoInt) : Bool) : Bool) && (_pos_3 > _old_15 : Bool) : Bool)) : Bool)) {
                            _gotoNext = 3794073i32;
                        } else {
                            _gotoNext = 3794156i32;
                        };
                    };
                } else if (__value__ == (3794073i32)) {
                    (@:checkr _b ?? throw "null pointer dereference")._matchcap.__copyTo__((@:checkr _b ?? throw "null pointer dereference")._cap);
                    _gotoNext = 3794156i32;
                } else if (__value__ == (3794156i32)) {
                    if (!_longest_0) {
                        _gotoNext = 3794168i32;
                    } else {
                        _gotoNext = 3794258i32;
                    };
                } else if (__value__ == (3794168i32)) {
                    return true;
                    _gotoNext = 3794258i32;
                } else if (__value__ == (3794258i32)) {
                    if (_pos_3 == ((@:checkr _b ?? throw "null pointer dereference")._end)) {
                        _gotoNext = 3794274i32;
                    } else {
                        _gotoNext = 3794357i32;
                    };
                } else if (__value__ == (3794274i32)) {
                    return true;
                    _gotoNext = 3794357i32;
                } else if (__value__ == (3794357i32)) {
                    0i32;
                    _gotoNext = 3790739i32;
                } else if (__value__ == (3794375i32)) {
