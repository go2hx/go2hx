        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if (_startCond_27 == ((255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3788705i32;
                    } else {
                        _gotoNext = 3788739i32;
                    };
                } else if (__value__ == (3788705i32)) {
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3788739i32;
                } else if (__value__ == (3788739i32)) {
                    ...
                    if (((@:checkr _m_28 ?? throw "null pointer dereference")._matchcap.capacity < _ncap : Bool)) {
                        _gotoNext = 3788791i32;
                    } else {
                        _gotoNext = 3788834i32;
                    };
                } else if (__value__ == (3788791i32)) {
                    ...
                    if (_r_32 != ((-1 : stdgo.GoInt32))) {
                        _gotoNext = 3789078i32;
                    } else {
                        _gotoNext = 3789119i32;
                    };
                } else if (__value__ == (3789078i32)) {
                    {
                    ...
                    _gotoNext = 3789119i32;
                } else if (__value__ == (3789119i32)) {
                    if (_pos == ((0 : stdgo.GoInt))) {
                        _gotoNext = 3789150i32;
                    } else {
                        _gotoNext = 3789188i32;
                    };
                } else if (__value__ == (3789150i32)) {
                    _flag_36 = stdgo._internal.regexp.Regexp__newlazyflag._newLazyFlag((-1 : stdgo.GoInt32), _r_32);
                    _gotoNext = 3789218i32;
                } else if (__value__ == (3789188i32)) {
                    _gotoNext = 3789188i32;
                    _flag_36 = _i_31._context(_pos);
                    var __blank__ = 0i32;
                    _gotoNext = 3789218i32;
                } else if (__value__ == (3789218i32)) {
                    ...
                    if ((((_pos == ((0 : stdgo.GoInt)) && _flag_36._match(((@:checkr _inst_38 ?? throw "null pointer dereference").inst.arg : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp)) : Bool) && (((@:checkr _re ?? throw "null pointer dereference")._prefix.length) > (0 : stdgo.GoInt) : Bool) : Bool) && _i_31._canCheckPrefix() : Bool)) {
                        _gotoNext = 3789425i32;
                    } else {
                        _gotoNext = 3789663i32;
                    };
                } else if (__value__ == (3789425i32)) {
                    if (!_i_31._hasPrefix(_re)) {
                        _gotoNext = 3789505i32;
                    } else {
                        _gotoNext = 3789528i32;
                    };
                } else if (__value__ == (3789505i32)) {
                    _gotoNext = 3790787i32;
                    ...
                    _gotoNext = 3789663i32;
                } else if (__value__ == (3789663i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3789663i32;
                    if (true) {
                        _gotoNext = 3789667i32;
                    } else {
                        _gotoNext = 3790787i32;
                    };
                } else if (__value__ == (3789667i32)) {
                    _inst_38 = (stdgo.Go.setRef((@:checkr (@:checkr _re ?? throw "null pointer dereference")._onepass ?? throw "null pointer dereference").inst[(_pc_37 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.Regexp_t_onepassinst.T_onePassInst>);
                    _pc_37 = ((@:checkr _inst_38 ?? throw "null pointer dereference").inst.out : stdgo.GoInt);
                    _gotoNext = 3789722i32;
                } else if (__value__ == (3789722i32)) {
                    {
                        final __value__ = (@:checkr _inst_38 ?? throw "null pointer dereference").inst.op;
                        if (__value__ == ((4 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3789773i32;
                        } else if (__value__ == ((7 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3789910i32;
                        } else if (__value__ == ((8 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3789982i32;
                        } else if (__value__ == ((9 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3790054i32;
                        } else if (__value__ == ((10 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3790095i32;
                        } else if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((1 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3790233i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3790323i32;
                        } else if (__value__ == ((6 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3790362i32;
                        } else if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3790397i32;
                        } else if (__value__ == ((2 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3790506i32;
                        } else {
                            _gotoNext = 3789741i32;
                        };
                    };
                } else if (__value__ == (3789741i32)) {
                    throw stdgo.Go.toInterface(("bad inst" : stdgo.GoString));
                    _gotoNext = 3790625i32;
                } else if (__value__ == (3789773i32)) {
                    _matched_29 = true;
                    if ((((@:checkr _m_28 ?? throw "null pointer dereference")._matchcap.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3789840i32;
                    } else {
                        _gotoNext = 3789896i32;
                    };
                } else if (__value__ == (3789840i32)) {
                    ...
                    _gotoNext = 3789896i32;
                } else if (__value__ == (3789896i32)) {
                    _gotoNext = 3790787i32;
                } else if (__value__ == (3789910i32)) {
                    if (!@:check2r _inst_38.matchRune(_r_32)) {
                        _gotoNext = 3789957i32;
                    } else {
                        _gotoNext = 3790625i32;
                    };
                } else if (__value__ == (3789957i32)) {
                    _gotoNext = 3790787i32;
                } else if (__value__ == (3789982i32)) {
                    if (_r_32 != ((@:checkr _inst_38 ?? throw "null pointer dereference").inst.rune[((0 : stdgo.GoInt) : stdgo.GoInt)])) {
                        _gotoNext = 3790029i32;
                    } else {
                        _gotoNext = 3790625i32;
                    };
                } else if (__value__ == (3790029i32)) {
                    _gotoNext = 3790787i32;
                } else if (__value__ == (3790054i32)) {
                    _gotoNext = 3790625i32;
                } else if (__value__ == (3790095i32)) {
                    if (_r_32 == ((10 : stdgo.GoInt32))) {
                        _gotoNext = 3790141i32;
                    } else {
                        _gotoNext = 3790625i32;
                    };
                } else if (__value__ == (3790141i32)) {
                    _gotoNext = 3790787i32;
                } else if (__value__ == (3790233i32)) {
                    _pc_37 = (stdgo._internal.regexp.Regexp__onepassnext._onePassNext(_inst_38, _r_32) : stdgo.GoInt);
                    var __blank__ = 0i32;
                    _gotoNext = 3789663i32;
                } else if (__value__ == (3790323i32)) {
                    _gotoNext = 3790787i32;
                } else if (__value__ == (3790362i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3789663i32;
                } else if (__value__ == (3790397i32)) {
                    if (!_flag_36._match(((@:checkr _inst_38 ?? throw "null pointer dereference").inst.arg : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3790469i32;
                    } else {
                        _gotoNext = 3790495i32;
                    };
                } else if (__value__ == (3790469i32)) {
                    _gotoNext = 3790787i32;
                } else if (__value__ == (3790495i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3789663i32;
                } else if (__value__ == (3790506i32)) {
                    ...
                    _gotoNext = 3790610i32;
                } else if (__value__ == (3790610i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3789663i32;
                } else if (__value__ == (3790625i32)) {
                    if (_width_34 == ((0 : stdgo.GoInt))) {
                        _gotoNext = 3790639i32;
                    } else {
                        _gotoNext = 3790656i32;
                    };
                } else if (__value__ == (3790639i32)) {
                    _gotoNext = 3790787i32;
                } else if (__value__ == (3790656i32)) {
                    ...
                    if (_r_32 != ((-1 : stdgo.GoInt32))) {
                        _gotoNext = 3790741i32;
                    } else {
                        _gotoNext = 3789663i32;
                    };
                } else if (__value__ == (3790741i32)) {
                    {
                        var __tmp__ = _i_31._step((_pos + _width_34 : stdgo.GoInt));
                        _r1_33 = @:tmpset0 __tmp__._0;
                        _width1_35 = @:tmpset0 __tmp__._1;
                    ...
                    _gotoNext = 3789663i32;
                } else if (__value__ == (3790787i32)) {
                    _gotoNext = 3790787i32;
                    if (!_matched_29) {
                        _gotoNext = 3790808i32;
                    } else {
                        _gotoNext = 3790852i32;
                    };
                } else if (__value__ == (3790808i32)) {
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if (_startCond_16 == ((255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3774314i32;
                    } else {
                        _gotoNext = 3774347i32;
                    };
                } else if (__value__ == (3774314i32)) {
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3774347i32;
                } else if (__value__ == (3774347i32)) {
                    if ((((_startCond_16 & (4 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp) : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp) != (0 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp)) && (_pos != (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 3774399i32;
                    } else {
                        _gotoNext = 3774464i32;
                    };
                } else if (__value__ == (3774399i32)) {
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3774464i32;
                } else if (__value__ == (3774464i32)) {
                    ...
                    if ((_startCond_16 & (4 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp) : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp) != ((0 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3774653i32;
                    } else {
                        _gotoNext = 3774802i32;
                    };
                } else if (__value__ == (3774653i32)) {
                    if ((((@:checkr _b_17 ?? throw "null pointer dereference")._cap.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3774675i32;
                    } else {
                        _gotoNext = 3774701i32;
                    };
                } else if (__value__ == (3774675i32)) {
                    (@:checkr _b_17 ?? throw "null pointer dereference")._cap[(0 : stdgo.GoInt)] = _pos;
                    _gotoNext = 3774701i32;
                } else if (__value__ == (3774701i32)) {
                    if (!@:check2r _re._tryBacktrack(_b_17, _i_18, ((@:checkr (@:checkr _re ?? throw "null pointer dereference")._prog ?? throw "null pointer dereference").start : stdgo.GoUInt32), _pos)) {
                        _gotoNext = 3774755i32;
                    } else {
                        _gotoNext = 3775689i32;
                    };
                } else if (__value__ == (3774755i32)) {
                    stdgo._internal.regexp.Regexp__freebitstate._freeBitState(_b_17);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3775689i32;
                } else if (__value__ == (3774802i32)) {
                    _gotoNext = 3774802i32;
                    _width_20 = (-1 : stdgo.GoInt);
                    var __blank__ = 0i32;
                    _gotoNext = 3775209i32;
                } else if (__value__ == (3775209i32)) {
                    if (((_pos <= _end_19 : Bool) && (_width_20 != (0 : stdgo.GoInt)) : Bool)) {
                        _gotoNext = 3775254i32;
                    } else {
                        _gotoNext = 3775656i32;
                    };
                } else if (__value__ == (3775254i32)) {
                    if ((((@:checkr _re ?? throw "null pointer dereference")._prefix.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3775281i32;
                    } else {
                        _gotoNext = 3775465i32;
                    };
                } else if (__value__ == (3775281i32)) {
                    _advance_21 = _i_18._index(_re, _pos);
                    if ((_advance_21 < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3775392i32;
                    } else {
                        _gotoNext = 3775441i32;
                    };
                } else if (__value__ == (3775392i32)) {
                    stdgo._internal.regexp.Regexp__freebitstate._freeBitState(_b_17);
                    return (null : stdgo.Slice<stdgo.GoInt>);
                    _gotoNext = 3775441i32;
                } else if (__value__ == (3775441i32)) {
                    _pos = (_pos + (_advance_21) : stdgo.GoInt);
                    _gotoNext = 3775465i32;
                } else if (__value__ == (3775465i32)) {
                    if ((((@:checkr _b_17 ?? throw "null pointer dereference")._cap.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3775483i32;
                    } else {
                        _gotoNext = 3775512i32;
                    };
                } else if (__value__ == (3775483i32)) {
                    (@:checkr _b_17 ?? throw "null pointer dereference")._cap[(0 : stdgo.GoInt)] = _pos;
                    _gotoNext = 3775512i32;
                } else if (__value__ == (3775512i32)) {
                    if (@:check2r _re._tryBacktrack(_b_17, _i_18, ((@:checkr (@:checkr _re ?? throw "null pointer dereference")._prog ?? throw "null pointer dereference").start : stdgo.GoUInt32), _pos)) {
                        _gotoNext = 3775565i32;
                    } else {
                        _gotoNext = 3775627i32;
                    };
                } else if (__value__ == (3775565i32)) {
                    _gotoNext = 3775689i32;
                } else if (__value__ == (3775627i32)) {
                    {
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 3770388i32;
                } else if (__value__ == (3770388i32)) {
                    if ((((@:checkr _b ?? throw "null pointer dereference")._jobs.length) > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3770408i32;
                    } else {
                        _gotoNext = 3774024i32;
                    };
                } else if (__value__ == (3770408i32)) {
                    ...
                    _gotoNext = 3770902i32;
                } else if (__value__ == (3770840i32)) {
                    if (!@:check2r _b._shouldVisit(_pc_2, _pos_3)) {
                        _gotoNext = 3770883i32;
                    } else {
                        _gotoNext = 3770902i32;
                    };
                } else if (__value__ == (3770883i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3770388i32;
                } else if (__value__ == (3770902i32)) {
                    _gotoNext = 3770902i32;
                    ...
                    _gotoNext = 3770940i32;
                } else if (__value__ == (3770940i32)) {
                    {
                        final __value__ = (@:checkr _inst_5 ?? throw "null pointer dereference").op;
                        if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3770991i32;
                        } else if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3771047i32;
                        } else if (__value__ == ((1 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3771608i32;
                        } else if (__value__ == ((7 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3772067i32;
                        } else if (__value__ == ((8 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3772218i32;
                        } else if (__value__ == ((10 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3772369i32;
                        } else if (__value__ == ((9 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3772537i32;
                        } else if (__value__ == ((2 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3772687i32;
                        } else if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3773070i32;
                        } else if (__value__ == ((6 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3773229i32;
                        } else if (__value__ == ((4 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3773291i32;
                        } else {
                            _gotoNext = 3770959i32;
                        };
                    };
                } else if (__value__ == (3770959i32)) {
                    throw stdgo.Go.toInterface(("bad inst" : stdgo.GoString));
                    _gotoNext = 3770388i32;
                } else if (__value__ == (3770991i32)) {
                    throw stdgo.Go.toInterface(("unexpected InstFail" : stdgo.GoString));
                    _gotoNext = 3770388i32;
                } else if (__value__ == (3771047i32)) {
                    if (_arg_4) {
                        _gotoNext = 3771420i32;
                    } else {
                        _gotoNext = 3771528i32;
                    };
                } else if (__value__ == (3771420i32)) {
                    _arg_4 = false;
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").arg;
                    _gotoNext = 3770840i32;
                } else if (__value__ == (3771528i32)) {
                    _gotoNext = 3771528i32;
                    @:check2r _b._push(_re, _pc_2, _pos_3, true);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3770840i32;
                } else if (__value__ == (3771608i32)) {
                    _gotoNext = 3771696i32;
                } else if (__value__ == (3771696i32)) {
                    {
                        ...
                        if (__value__ == ((7 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((8 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((9 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((10 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3771734i32;
                        } else {
                            _gotoNext = 3771991i32;
                        };
                    };
                } else if (__value__ == (3771734i32)) {
                    ...
                    if (!@:check2r _inst_5.matchRune(_r_6)) {
                        _gotoNext = 3772141i32;
                    } else {
                        _gotoNext = 3772164i32;
                    };
                } else if (__value__ == (3772141i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3770388i32;
                } else if (__value__ == (3772164i32)) {
                    _pos_3 = (_pos_3 + (_width_7) : stdgo.GoInt);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3770840i32;
                } else if (__value__ == (3772218i32)) {
                    {
                        var __tmp__ = _i._step(_pos_3);
                    ...
                    if (_r_8 != ((@:checkr _inst_5 ?? throw "null pointer dereference").rune[((0 : stdgo.GoInt) : stdgo.GoInt)])) {
                        _gotoNext = 3772292i32;
                    } else {
                        _gotoNext = 3772315i32;
                    };
                } else if (__value__ == (3772292i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3770388i32;
                } else if (__value__ == (3772315i32)) {
                    _pos_3 = (_pos_3 + (_width_9) : stdgo.GoInt);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3770840i32;
                } else if (__value__ == (3772369i32)) {
                    {
                        var __tmp__ = _i._step(_pos_3);
                    ...
                    if (((_r_10 == (10 : stdgo.GoInt32)) || (_r_10 == (-1 : stdgo.GoInt32)) : Bool)) {
                        ...
                        _gotoNext = 3772483i32;
                    };
                } else if (__value__ == (3772460i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3770388i32;
                } else if (__value__ == (3772483i32)) {
                    _pos_3 = (_pos_3 + (_width_11) : stdgo.GoInt);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3770840i32;
                } else if (__value__ == (3772537i32)) {
                    {
                        var __tmp__ = _i._step(_pos_3);
                    ...
                    if (_r_12 == ((-1 : stdgo.GoInt32))) {
                        _gotoNext = 3772610i32;
                    } else {
                        _gotoNext = 3772633i32;
                    };
                } else if (__value__ == (3772610i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3770388i32;
                } else if (__value__ == (3772633i32)) {
                    _pos_3 = (_pos_3 + (_width_13) : stdgo.GoInt);
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3770840i32;
                } else if (__value__ == (3772687i32)) {
                    if (_arg_4) {
                        _gotoNext = 3772722i32;
                    } else {
                        _gotoNext = 3772822i32;
                    };
                } else if (__value__ == (3772722i32)) {
                    (@:checkr _b ?? throw "null pointer dereference")._cap[((@:checkr _inst_5 ?? throw "null pointer dereference").arg : stdgo.GoInt)] = _pos_3;
                    var __blank__ = 0i32;
                    _gotoNext = 3770388i32;
                } else if (__value__ == (3772822i32)) {
                    _gotoNext = 3772822i32;
                    if (((@:checkr _inst_5 ?? throw "null pointer dereference").arg < ((@:checkr _b ?? throw "null pointer dereference")._cap.length : stdgo.GoUInt32) : Bool)) {
                        _gotoNext = 3772861i32;
                    } else {
                        _gotoNext = 3773026i32;
                    };
                } else if (__value__ == (3772861i32)) {
                    ...
                    (@:checkr _b ?? throw "null pointer dereference")._cap[((@:checkr _inst_5 ?? throw "null pointer dereference").arg : stdgo.GoInt)] = _pos_3;
                    _gotoNext = 3773026i32;
                } else if (__value__ == (3773026i32)) {
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3770840i32;
                } else if (__value__ == (3773070i32)) {
                    ...
                    if (!_flag_14._match(((@:checkr _inst_5 ?? throw "null pointer dereference").arg : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3773168i32;
                    } else {
                        _gotoNext = 3773191i32;
                    };
                } else if (__value__ == (3773168i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3770388i32;
                } else if (__value__ == (3773191i32)) {
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3770840i32;
                } else if (__value__ == (3773229i32)) {
                    _pc_2 = (@:checkr _inst_5 ?? throw "null pointer dereference").out;
                    _gotoNext = 3770840i32;
                } else if (__value__ == (3773291i32)) {
                    if (((@:checkr _b ?? throw "null pointer dereference")._cap.length) == ((0 : stdgo.GoInt))) {
                        _gotoNext = 3773437i32;
                    } else {
                        _gotoNext = 3773603i32;
                    };
                } else if (__value__ == (3773437i32)) {
                    return true;
                    _gotoNext = 3773603i32;
                } else if (__value__ == (3773603i32)) {
                    if ((((@:checkr _b ?? throw "null pointer dereference")._cap.length) > (1 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3773621i32;
                    } else {
                        _gotoNext = 3773650i32;
                    };
                } else if (__value__ == (3773621i32)) {
                    (@:checkr _b ?? throw "null pointer dereference")._cap[(1 : stdgo.GoInt)] = _pos_3;
                    _gotoNext = 3773650i32;
                } else if (__value__ == (3773650i32)) {
                    {
                    ...
                    _gotoNext = 3773805i32;
                } else if (__value__ == (3773805i32)) {
                    if (!_longest_0) {
                        _gotoNext = 3773817i32;
                    } else {
                        _gotoNext = 3773907i32;
                    };
                } else if (__value__ == (3773817i32)) {
                    return true;
                    _gotoNext = 3773907i32;
                } else if (__value__ == (3773907i32)) {
                    if (_pos_3 == ((@:checkr _b ?? throw "null pointer dereference")._end)) {
                        _gotoNext = 3773923i32;
                    } else {
                        _gotoNext = 3774006i32;
                    };
                } else if (__value__ == (3773923i32)) {
                    return true;
                    _gotoNext = 3774006i32;
                } else if (__value__ == (3774006i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3770388i32;
                } else if (__value__ == (3774024i32)) {
