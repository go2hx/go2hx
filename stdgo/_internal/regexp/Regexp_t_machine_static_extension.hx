        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 3740480i32;
                } else if (__value__ == (3740480i32)) {
                    if (_pc == ((0u32 : stdgo.GoUInt32))) {
                        _gotoNext = 3740499i32;
                    } else {
                        _gotoNext = 3740516i32;
                    };
                } else if (__value__ == (3740499i32)) {
                    return _t;
                    _gotoNext = 3740516i32;
                } else if (__value__ == (3740516i32)) {
                    {
                        ...
                        if (((_j_22 < ((@:checkr _q ?? throw "null pointer dereference")._dense.length : stdgo.GoUInt32) : Bool) && ((@:checkr _q ?? throw "null pointer dereference")._dense[(_j_22 : stdgo.GoInt)]._pc == _pc) : Bool)) {
                            _gotoNext = 3740586i32;
                        } else {
                            _gotoNext = 3740604i32;
                        };
                    };
                } else if (__value__ == (3740586i32)) {
                    return _t;
                    _gotoNext = 3740604i32;
                } else if (__value__ == (3740604i32)) {
                ...
                } else if (__value__ == (3740735i32)) {
                    {
                        ...
                        if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            ...
                            _gotoNext = 3741278i32;
                        } else {
                            _gotoNext = 3740750i32;
                        };
                    };
                } else if (__value__ == (3740750i32)) {
                    throw stdgo.Go.toInterface(("unhandled" : stdgo.GoString));
                    _gotoNext = 3741536i32;
                } else if (__value__ == (3740781i32)) {
                    _gotoNext = 3741536i32;
                } else if (__value__ == (3740817i32)) {
                    ...
                    _gotoNext = 3741536i32;
                } else if (__value__ == (3741243i32)) {
                    _gotoNext = 3741243i32;
                    _pc = (@:checkr _i_25 ?? throw "null pointer dereference").out;
                    _gotoNext = 3740480i32;
                } else if (__value__ == (3741278i32)) {
                    if (({
                        final value = _t;
                        (value == null || (value : Dynamic).__nil__);
                    })) {
                        _gotoNext = 3741395i32;
                    } else {
                        _gotoNext = 3741424i32;
                    };
                } else if (__value__ == (3741395i32)) {
                    _t = @:check2r _m._alloc(_i_25);
                    _gotoNext = 3741446i32;
                } else if (__value__ == (3741424i32)) {
                    _gotoNext = 3741424i32;
                    (@:checkr _t ?? throw "null pointer dereference")._inst = _i_25;
                    0i32;
                    _gotoNext = 3741446i32;
                } else if (__value__ == (3741446i32)) {
                    if ((((_cap.length) > (0 : stdgo.GoInt) : Bool) && (stdgo.Go.pointer((@:checkr _t ?? throw "null pointer dereference")._cap[(0 : stdgo.GoInt)]) != stdgo.Go.pointer(_cap[(0 : stdgo.GoInt)])) : Bool)) {
                        _gotoNext = 3741486i32;
                    } else {
                        _gotoNext = 3741514i32;
                    };
                } else if (__value__ == (3741486i32)) {
                    (@:checkr _t ?? throw "null pointer dereference")._cap.__copyTo__(_cap);
                    _gotoNext = 3741514i32;
                } else if (__value__ == (3741514i32)) {
                    (@:checkr _d_24 ?? throw "null pointer dereference")._t = _t;
                    _t = null;
                    _gotoNext = 3741536i32;
                } else if (__value__ == (3741536i32)) {
                    return _t;
                    _gotoNext = -1i32;
                };
            };
