        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 3813614i32;
                } else if (__value__ == (3813614i32)) {
                    if (_pc == ((0u32 : stdgo.GoUInt32))) {
                        _gotoNext = 3813633i32;
                    } else {
                        _gotoNext = 3813650i32;
                    };
                } else if (__value__ == (3813633i32)) {
                    return _t;
                    _gotoNext = 3813650i32;
                } else if (__value__ == (3813650i32)) {
                    {
                        ...
                        if (((_j_22 < ((@:checkr _q ?? throw "null pointer dereference")._dense.length : stdgo.GoUInt32) : Bool) && ((@:checkr _q ?? throw "null pointer dereference")._dense[(_j_22 : stdgo.GoInt)]._pc == _pc) : Bool)) {
                            ...
                            _gotoNext = 3813738i32;
                        };
                    };
                } else if (__value__ == (3813720i32)) {
                    return _t;
                    _gotoNext = 3813738i32;
                } else if (__value__ == (3813738i32)) {
                    ...
                    _gotoNext = 3813869i32;
                } else if (__value__ == (3813869i32)) {
                    {
                        final __value__ = (@:checkr _i_25 ?? throw "null pointer dereference").op;
                        if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3813915i32;
                        } else if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((1 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3813951i32;
                        } else if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3814061i32;
                        } else if (__value__ == ((6 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3814163i32;
                        } else if (__value__ == ((2 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3814211i32;
                            ...
                            _gotoNext = 3814412i32;
                        } else {
                            _gotoNext = 3813884i32;
                        };
                    };
                } else if (__value__ == (3813884i32)) {
                    throw stdgo.Go.toInterface(("unhandled" : stdgo.GoString));
                    _gotoNext = 3814670i32;
                } else if (__value__ == (3813915i32)) {
                    _gotoNext = 3814670i32;
                } else if (__value__ == (3813951i32)) {
                    ...
                    if (_cond.value._match(((@:checkr _i_25 ?? throw "null pointer dereference").arg : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3814128i32;
                    } else {
                        _gotoNext = 3814670i32;
                    };
                } else if (__value__ == (3814128i32)) {
                    _pc = (@:checkr _i_25 ?? throw "null pointer dereference").out;
                    _gotoNext = 3813614i32;
                } else if (__value__ == (3814163i32)) {
                    _pc = (@:checkr _i_25 ?? throw "null pointer dereference").out;
                    _gotoNext = 3813614i32;
                } else if (__value__ == (3814211i32)) {
                    if ((((@:checkr _i_25 ?? throw "null pointer dereference").arg : stdgo.GoInt) < (_cap.length) : Bool)) {
                        _gotoNext = 3814263i32;
                    } else {
                        _gotoNext = 3814377i32;
                    };
                } else if (__value__ == (3814263i32)) {
                    ...
                    _gotoNext = 3814670i32;
                } else if (__value__ == (3814377i32)) {
                    _gotoNext = 3814377i32;
                    _pc = (@:checkr _i_25 ?? throw "null pointer dereference").out;
                    _gotoNext = 3813614i32;
                } else if (__value__ == (3814412i32)) {
                    if ((_t == null || (_t : Dynamic).__nil__)) {
                        _gotoNext = 3814529i32;
                    } else {
                        _gotoNext = 3814558i32;
                    };
                } else if (__value__ == (3814529i32)) {
                    _t = @:check2r _m._alloc(_i_25);
                    _gotoNext = 3814580i32;
                } else if (__value__ == (3814558i32)) {
                    _gotoNext = 3814558i32;
                    (@:checkr _t ?? throw "null pointer dereference")._inst = _i_25;
                    var __blank__ = 0i32;
                    _gotoNext = 3814580i32;
                } else if (__value__ == (3814580i32)) {
                    if ((((_cap.length) > (0 : stdgo.GoInt) : Bool) && (stdgo.Go.pointer((@:checkr _t ?? throw "null pointer dereference")._cap[(0 : stdgo.GoInt)]) != stdgo.Go.pointer(_cap[(0 : stdgo.GoInt)])) : Bool)) {
                        _gotoNext = 3814620i32;
                    } else {
                        _gotoNext = 3814648i32;
                    };
                } else if (__value__ == (3814620i32)) {
                    (@:checkr _t ?? throw "null pointer dereference")._cap.__copyTo__(_cap);
                    _gotoNext = 3814648i32;
                } else if (__value__ == (3814648i32)) {
                    (@:checkr _d_24 ?? throw "null pointer dereference")._t = _t;
                    _t = null;
                    _gotoNext = 3814670i32;
                } else if (__value__ == (3814670i32)) {
                    return _t;
                    _gotoNext = -1i32;
                };
            };
