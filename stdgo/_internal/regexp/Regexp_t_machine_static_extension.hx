...
@:keep @:allow(stdgo._internal.regexp.Regexp.T_machine_asInterface) class T_machine_static_extension {
    ...
    static public function _add( _m:stdgo.Ref<stdgo._internal.regexp.Regexp_t_machine.T_machine>, _q:stdgo.Ref<stdgo._internal.regexp.Regexp_t_queue.T_queue>, _pc:stdgo.GoUInt32, _pos:stdgo.GoInt, _cap:stdgo.Slice<stdgo.GoInt>, _cond:stdgo.Pointer<stdgo._internal.regexp.Regexp_t_lazyflag.T_lazyFlag>, _t:stdgo.Ref<stdgo._internal.regexp.Regexp_t_thread.T_thread>):stdgo.Ref<stdgo._internal.regexp.Regexp_t_thread.T_thread> {
        ...
        var _d_3858007:stdgo.Ref<stdgo._internal.regexp.Regexp_t_entry.T_entry> = (null : stdgo.Ref<stdgo._internal.regexp.Regexp_t_entry.T_entry>);
        var _j_3857963:stdgo.GoInt = (0 : stdgo.GoInt);
        var _j_3857878:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _opos_3858493:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_3858074:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_inst.Inst>);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _gotoNext = 3857839i32;
                } else if (__value__ == (3857839i32)) {
                    if (_pc == ((0u32 : stdgo.GoUInt32))) {
                        _gotoNext = 3857858i32;
                    } else {
                        _gotoNext = 3857875i32;
                    };
                } else if (__value__ == (3857858i32)) {
                    return _t;
                    _gotoNext = 3857875i32;
                } else if (__value__ == (3857875i32)) {
                    {
                        _j_3857878 = (@:checkr _q ?? throw "null pointer dereference")._sparse[(_pc : stdgo.GoInt)];
                        if (((_j_3857878 < ((@:checkr _q ?? throw "null pointer dereference")._dense.length : stdgo.GoUInt32) : Bool) && ((@:checkr _q ?? throw "null pointer dereference")._dense[(_j_3857878 : stdgo.GoInt)]._pc == _pc) : Bool)) {
                            _gotoNext = 3857945i32;
                        } else {
                            _gotoNext = 3857963i32;
                        };
                    };
                } else if (__value__ == (3857945i32)) {
                    return _t;
                    _gotoNext = 3857963i32;
                } else if (__value__ == (3857963i32)) {
                    _j_3857963 = ((@:checkr _q ?? throw "null pointer dereference")._dense.length);
                    (@:checkr _q ?? throw "null pointer dereference")._dense = ((@:checkr _q ?? throw "null pointer dereference")._dense.__slice__(0, (_j_3857963 + (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.Slice<stdgo._internal.regexp.Regexp_t_entry.T_entry>);
                    _d_3858007 = (stdgo.Go.setRef((@:checkr _q ?? throw "null pointer dereference")._dense[(_j_3857963 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.Regexp_t_entry.T_entry>);
                    (@:checkr _d_3858007 ?? throw "null pointer dereference")._t = null;
                    (@:checkr _d_3858007 ?? throw "null pointer dereference")._pc = _pc;
                    (@:checkr _q ?? throw "null pointer dereference")._sparse[(_pc : stdgo.GoInt)] = (_j_3857963 : stdgo.GoUInt32);
                    _i_3858074 = (stdgo.Go.setRef((@:checkr (@:checkr _m ?? throw "null pointer dereference")._p ?? throw "null pointer dereference").inst[(_pc : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_inst.Inst>);
                    _gotoNext = 3858094i32;
                } else if (__value__ == (3858094i32)) {
                    {
                        final __value__ = (@:checkr _i_3858074 ?? throw "null pointer dereference").op;
                        if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3858140i32;
                        } else if (__value__ == ((0 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp)) || __value__ == ((1 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3858176i32;
                        } else if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3858286i32;
                        } else if (__value__ == ((6 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3858388i32;
                        } else if (__value__ == ((2 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3858436i32;
                            ...
                            _gotoNext = 3858109i32;
                        };
                    };
                } else if (__value__ == (3858109i32)) {
                    throw stdgo.Go.toInterface(("unhandled" : stdgo.GoString));
                    _gotoNext = 3858895i32;
                } else if (__value__ == (3858140i32)) {
                    _gotoNext = 3858895i32;
                } else if (__value__ == (3858176i32)) {
                    _t = @:check2r _m._add(_q, (@:checkr _i_3858074 ?? throw "null pointer dereference").out, _pos, _cap, _cond, _t);
                    _pc = (@:checkr _i_3858074 ?? throw "null pointer dereference").arg;
                    _gotoNext = 3857839i32;
                } else if (__value__ == (3858286i32)) {
                    if (_cond.value._match(((@:checkr _i_3858074 ?? throw "null pointer dereference").arg : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp))) {
                        _gotoNext = 3858353i32;
                    } else {
                        _gotoNext = 3858895i32;
                    };
                } else if (__value__ == (3858353i32)) {
                    _pc = (@:checkr _i_3858074 ?? throw "null pointer dereference").out;
                    _gotoNext = 3857839i32;
                } else if (__value__ == (3858388i32)) {
                    _pc = (@:checkr _i_3858074 ?? throw "null pointer dereference").out;
                    _gotoNext = 3857839i32;
                } else if (__value__ == (3858436i32)) {
                    if ((((@:checkr _i_3858074 ?? throw "null pointer dereference").arg : stdgo.GoInt) < (_cap.length) : Bool)) {
                        _gotoNext = 3858488i32;
                    } else {
                        _gotoNext = 3858602i32;
                    };
                } else if (__value__ == (3858488i32)) {
                    _opos_3858493 = _cap[((@:checkr _i_3858074 ?? throw "null pointer dereference").arg : stdgo.GoInt)];
                    _cap[((@:checkr _i_3858074 ?? throw "null pointer dereference").arg : stdgo.GoInt)] = _pos;
                    @:check2r _m._add(_q, (@:checkr _i_3858074 ?? throw "null pointer dereference").out, _pos, _cap, _cond, null);
                    _cap[((@:checkr _i_3858074 ?? throw "null pointer dereference").arg : stdgo.GoInt)] = _opos_3858493;
                    _gotoNext = 3858895i32;
                } else if (__value__ == (3858602i32)) {
                    _gotoNext = 3858602i32;
                    _pc = (@:checkr _i_3858074 ?? throw "null pointer dereference").out;
                    _gotoNext = 3857839i32;
                } else if (__value__ == (3858637i32)) {
                    if ((_t == null || (_t : Dynamic).__nil__)) {
                        _gotoNext = 3858754i32;
                    } else {
                        _gotoNext = 3858783i32;
                    };
                } else if (__value__ == (3858754i32)) {
                    _t = @:check2r _m._alloc(_i_3858074);
                    _gotoNext = 3858805i32;
                } else if (__value__ == (3858783i32)) {
                    _gotoNext = 3858783i32;
                    (@:checkr _t ?? throw "null pointer dereference")._inst = _i_3858074;
                    var __blank__ = 0i32;
                    _gotoNext = 3858805i32;
                } else if (__value__ == (3858805i32)) {
                    if ((((_cap.length) > (0 : stdgo.GoInt) : Bool) && (stdgo.Go.pointer((@:checkr _t ?? throw "null pointer dereference")._cap[(0 : stdgo.GoInt)]) != stdgo.Go.pointer(_cap[(0 : stdgo.GoInt)])) : Bool)) {
                        _gotoNext = 3858845i32;
                    } else {
                        _gotoNext = 3858873i32;
                    };
                } else if (__value__ == (3858845i32)) {
                    (@:checkr _t ?? throw "null pointer dereference")._cap.__copyTo__(_cap);
                    _gotoNext = 3858873i32;
                } else if (__value__ == (3858873i32)) {
                    (@:checkr _d_3858007 ?? throw "null pointer dereference")._t = _t;
                    _t = null;
                    _gotoNext = 3858895i32;
                } else if (__value__ == (3858895i32)) {
                    return _t;
                    _gotoNext = -1i32;
                };
            };
