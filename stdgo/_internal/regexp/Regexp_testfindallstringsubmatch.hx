...
function testFindAllStringSubmatch(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        //"file:///home/runner/.go/go1.21.3/src/regexp/find_test.go#L472"
        for (__0 => _test in stdgo._internal.regexp.Regexp__findtests._findTests) {
            var _result = stdgo._internal.regexp.Regexp_mustcompile.mustCompile(_test._pat?.__copy__()).findAllStringSubmatch(_test._text?.__copy__(), (-1 : stdgo.GoInt));
            //"file:///home/runner/.go/go1.21.3/src/regexp/find_test.go#L474"
            if (((_test._matches == null) && (_result == null) : Bool)) {} else if (((_test._matches == null) && (_result != null) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/regexp/find_test.go#L478"
                ...
                //"file:///home/runner/.go/go1.21.3/src/regexp/find_test.go#L480"
                ...
                //"file:///home/runner/.go/go1.21.3/src/regexp/find_test.go#L482"
                ...
                //"file:///home/runner/.go/go1.21.3/src/regexp/find_test.go#L484"
                for (_k => _match in _test._matches) {
                    //"file:///home/runner/.go/go1.21.3/src/regexp/find_test.go#L485"
