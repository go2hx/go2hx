...
@:keep @:allow(stdgo._internal.regexp.syntax.Syntax.Prog_asInterface) class Prog_static_extension {
    ...
    static public function startCond( _p:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Prog.Prog>):stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp {
        ...
        var _i_3586138:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
        var _pc_3586115:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _flag_3586101:stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp = ((0 : stdgo.GoUInt8) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
        var loopBreak = false;
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _pc_3586115 = ((@:checkr _p ?? throw "null pointer dereference").start : stdgo.GoUInt32);
                    _i_3586138 = (stdgo.Go.setRef((@:checkr _p ?? throw "null pointer dereference").inst[(_pc_3586115 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3586155i32;
                } else if (__value__ == (3586155i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3586162i32;
                } else if (__value__ == (3586162i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3586166i32;
                    } else {
                        _gotoNext = 3586376i32;
                    };
                } else if (__value__ == (3586166i32)) {
                    _gotoNext = 3586170i32;
                } else if (__value__ == (3586170i32)) {
                    {
                        final __value__ = (@:checkr _i_3586138 ?? throw "null pointer dereference").op;
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3586186i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3586235i32;
                            ...
                            _gotoNext = 3586274i32;
                        } else {
                            _gotoNext = 3586314i32;
                        };
                    };
                } else if (__value__ == (3586186i32)) {
                    _flag_3586101 = (_flag_3586101 | (((@:checkr _i_3586138 ?? throw "null pointer dereference").arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp)) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3586343i32;
                } else if (__value__ == (3586235i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3586343i32;
                } else if (__value__ == (3586274i32)) {
                    _gotoNext = 3586343i32;
                } else if (__value__ == (3586314i32)) {
                    loopBreak = true;
                    _gotoNext = 3586162i32;
                } else if (__value__ == (3586343i32)) {
                    _pc_3586115 = (@:checkr _i_3586138 ?? throw "null pointer dereference").out;
                    _i_3586138 = (stdgo.Go.setRef((@:checkr _p ?? throw "null pointer dereference").inst[(_pc_3586115 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3586162i32;
                } else if (__value__ == (3586376i32)) {
                    return _flag_3586101;
                    _gotoNext = -1i32;
                };
            };
        };
