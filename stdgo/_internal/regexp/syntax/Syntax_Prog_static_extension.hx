...
@:keep @:allow(stdgo._internal.regexp.syntax.Syntax.Prog_asInterface) class Prog_static_extension {
    ...
    static public function startCond( _p:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Prog.Prog>):stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp {
        ...
        var loopBreak = false;
        var _i_3380409:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
        var _pc_3380386:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _flag_3380372:stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp = ((0 : stdgo.GoUInt8) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _pc_3380386 = (_p.start : stdgo.GoUInt32);
                    _i_3380409 = (stdgo.Go.setRef(_p.inst[(_pc_3380386 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3380426i32;
                } else if (__value__ == (3380426i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3380433i32;
                } else if (__value__ == (3380433i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3380437i32;
                    } else {
                        _gotoNext = 3380647i32;
                    };
                } else if (__value__ == (3380437i32)) {
                    _gotoNext = 3380441i32;
                } else if (__value__ == (3380441i32)) {
                    {
                        final __value__ = _i_3380409.op;
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3380457i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3380506i32;
                            ...
                            _gotoNext = 3380545i32;
                        } else {
                            _gotoNext = 3380585i32;
                        };
                    };
                } else if (__value__ == (3380457i32)) {
                    _flag_3380372 = (_flag_3380372 | ((_i_3380409.arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp)) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3380614i32;
                } else if (__value__ == (3380506i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3380614i32;
                } else if (__value__ == (3380545i32)) {
                    _gotoNext = 3380614i32;
                } else if (__value__ == (3380585i32)) {
                    loopBreak = true;
                    _gotoNext = 3380433i32;
                } else if (__value__ == (3380614i32)) {
                    _pc_3380386 = _i_3380409.out;
                    _i_3380409 = (stdgo.Go.setRef(_p.inst[(_pc_3380386 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3380433i32;
                } else if (__value__ == (3380647i32)) {
                    return _flag_3380372;
                    _gotoNext = -1i32;
                };
            };
        };
