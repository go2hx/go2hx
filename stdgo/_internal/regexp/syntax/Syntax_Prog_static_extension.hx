...
@:keep @:allow(stdgo._internal.regexp.syntax.Syntax.Prog_asInterface) class Prog_static_extension {
    ...
    static public function startCond( _p:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Prog.Prog>):stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp {
        ...
        var _pc_3291691:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _flag_3291677:stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp = ((0 : stdgo.GoUInt8) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
        var loopBreak = false;
        var _i_3291714:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _pc_3291691 = (_p.start : stdgo.GoUInt32);
                    _i_3291714 = (stdgo.Go.setRef(_p.inst[(_pc_3291691 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3291731i32;
                } else if (__value__ == (3291731i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3291738i32;
                } else if (__value__ == (3291738i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3291742i32;
                    } else {
                        _gotoNext = 3291952i32;
                    };
                } else if (__value__ == (3291742i32)) {
                    _gotoNext = 3291746i32;
                } else if (__value__ == (3291746i32)) {
                    {
                        final __value__ = _i_3291714.op;
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3291762i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3291811i32;
                            ...
                            _gotoNext = 3291850i32;
                        } else {
                            _gotoNext = 3291890i32;
                        };
                    };
                } else if (__value__ == (3291762i32)) {
                    _flag_3291677 = (_flag_3291677 | ((_i_3291714.arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp)) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3291919i32;
                } else if (__value__ == (3291811i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3291919i32;
                } else if (__value__ == (3291850i32)) {
                    _gotoNext = 3291919i32;
                } else if (__value__ == (3291890i32)) {
                    loopBreak = true;
                    _gotoNext = 3291738i32;
                } else if (__value__ == (3291919i32)) {
                    _pc_3291691 = _i_3291714.out;
                    _i_3291714 = (stdgo.Go.setRef(_p.inst[(_pc_3291691 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3291738i32;
                } else if (__value__ == (3291952i32)) {
                    return _flag_3291677;
                    _gotoNext = -1i32;
                };
            };
        };
