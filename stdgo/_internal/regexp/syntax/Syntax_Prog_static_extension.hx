...
@:keep @:allow(stdgo._internal.regexp.syntax.Syntax.Prog_asInterface) class Prog_static_extension {
    ...
    static public function startCond( _p:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Prog.Prog>):stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp {
        ...
        var loopBreak = false;
        var _i_3458293:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
        var _pc_3458270:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _flag_3458256:stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp = ((0 : stdgo.GoUInt8) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _pc_3458270 = (_p.start : stdgo.GoUInt32);
                    _i_3458293 = (stdgo.Go.setRef(_p.inst[(_pc_3458270 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3458310i32;
                } else if (__value__ == (3458310i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3458317i32;
                } else if (__value__ == (3458317i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3458321i32;
                    } else {
                        _gotoNext = 3458531i32;
                    };
                } else if (__value__ == (3458321i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3458325i32;
                } else if (__value__ == (3458325i32)) {
                    {
                        final __value__ = _i_3458293.op;
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3458341i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3458390i32;
                            ...
                            _gotoNext = 3458429i32;
                        } else {
                            _gotoNext = 3458469i32;
                        };
                    };
                } else if (__value__ == (3458341i32)) {
                    _flag_3458256 = (_flag_3458256 | ((_i_3458293.arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp)) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3458498i32;
                } else if (__value__ == (3458390i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3458498i32;
                } else if (__value__ == (3458429i32)) {
                    _gotoNext = 3458498i32;
                } else if (__value__ == (3458469i32)) {
                    loopBreak = true;
                    _gotoNext = 3458317i32;
                } else if (__value__ == (3458498i32)) {
                    _pc_3458270 = _i_3458293.out;
                    _i_3458293 = (stdgo.Go.setRef(_p.inst[(_pc_3458270 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3458317i32;
                } else if (__value__ == (3458531i32)) {
                    return _flag_3458256;
                    _gotoNext = -1i32;
                };
            };
        };
