...
@:keep @:allow(stdgo._internal.regexp.syntax.Syntax.Prog_asInterface) class Prog_static_extension {
    ...
    static public function startCond( _p:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Prog.Prog>):stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp {
        ...
        var _flag_3421808:stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp = ((0 : stdgo.GoUInt8) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
        var loopBreak = false;
        var _i_3421845:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
        var _pc_3421822:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _pc_3421822 = (_p.start : stdgo.GoUInt32);
                    _i_3421845 = (stdgo.Go.setRef(_p.inst[(_pc_3421822 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3421862i32;
                } else if (__value__ == (3421862i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3421869i32;
                } else if (__value__ == (3421869i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3421873i32;
                    } else {
                        _gotoNext = 3422083i32;
                    };
                } else if (__value__ == (3421873i32)) {
                    _gotoNext = 3421877i32;
                } else if (__value__ == (3421877i32)) {
                    {
                        final __value__ = _i_3421845.op;
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3421893i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3421942i32;
                            ...
                            _gotoNext = 3421981i32;
                        } else {
                            _gotoNext = 3422021i32;
                        };
                    };
                } else if (__value__ == (3421893i32)) {
                    _flag_3421808 = (_flag_3421808 | ((_i_3421845.arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp)) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3422050i32;
                } else if (__value__ == (3421942i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3422050i32;
                } else if (__value__ == (3421981i32)) {
                    _gotoNext = 3422050i32;
                } else if (__value__ == (3422021i32)) {
                    loopBreak = true;
                    _gotoNext = 3421869i32;
                } else if (__value__ == (3422050i32)) {
                    _pc_3421822 = _i_3421845.out;
                    _i_3421845 = (stdgo.Go.setRef(_p.inst[(_pc_3421822 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3421869i32;
                } else if (__value__ == (3422083i32)) {
                    return _flag_3421808;
                    _gotoNext = -1i32;
                };
            };
        };
