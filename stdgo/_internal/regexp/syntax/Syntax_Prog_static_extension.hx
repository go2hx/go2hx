...
@:keep @:allow(stdgo._internal.regexp.syntax.Syntax.Prog_asInterface) class Prog_static_extension {
    ...
    static public function startCond( _p:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Prog.Prog>):stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp {
        ...
        var loopBreak = false;
        var _i_3423227:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
        var _pc_3423204:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _flag_3423190:stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp = ((0 : stdgo.GoUInt8) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _pc_3423204 = (_p.start : stdgo.GoUInt32);
                    _i_3423227 = (stdgo.Go.setRef(_p.inst[(_pc_3423204 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3423244i32;
                } else if (__value__ == (3423244i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3423251i32;
                } else if (__value__ == (3423251i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3423255i32;
                    } else {
                        _gotoNext = 3423465i32;
                    };
                } else if (__value__ == (3423255i32)) {
                    _gotoNext = 3423259i32;
                } else if (__value__ == (3423259i32)) {
                    {
                        final __value__ = _i_3423227.op;
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3423275i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3423324i32;
                            ...
                            _gotoNext = 3423363i32;
                        } else {
                            _gotoNext = 3423403i32;
                        };
                    };
                } else if (__value__ == (3423275i32)) {
                    _flag_3423190 = (_flag_3423190 | ((_i_3423227.arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp)) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3423432i32;
                } else if (__value__ == (3423324i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3423432i32;
                } else if (__value__ == (3423363i32)) {
                    _gotoNext = 3423432i32;
                } else if (__value__ == (3423403i32)) {
                    loopBreak = true;
                    _gotoNext = 3423251i32;
                } else if (__value__ == (3423432i32)) {
                    _pc_3423204 = _i_3423227.out;
                    _i_3423227 = (stdgo.Go.setRef(_p.inst[(_pc_3423204 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3423251i32;
                } else if (__value__ == (3423465i32)) {
                    return _flag_3423190;
                    _gotoNext = -1i32;
                };
            };
        };
