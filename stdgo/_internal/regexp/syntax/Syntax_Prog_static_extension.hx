...
@:keep @:allow(stdgo._internal.regexp.syntax.Syntax.Prog_asInterface) class Prog_static_extension {
    ...
    static public function startCond( _p:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Prog.Prog>):stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp {
        ...
        var loopBreak = false;
        var _i_3480750:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
        var _pc_3480727:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _flag_3480713:stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp = ((0 : stdgo.GoUInt8) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _pc_3480727 = ((@:checkr _p ?? throw "null pointer dereference").start : stdgo.GoUInt32);
                    _i_3480750 = (stdgo.Go.setRef((@:checkr _p ?? throw "null pointer dereference").inst[(_pc_3480727 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3480767i32;
                } else if (__value__ == (3480767i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3480774i32;
                } else if (__value__ == (3480774i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3480778i32;
                    } else {
                        _gotoNext = 3480988i32;
                    };
                } else if (__value__ == (3480778i32)) {
                    _gotoNext = 3480782i32;
                } else if (__value__ == (3480782i32)) {
                    {
                        final __value__ = (@:checkr _i_3480750 ?? throw "null pointer dereference").op;
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3480798i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3480847i32;
                            ...
                            _gotoNext = 3480886i32;
                        } else {
                            _gotoNext = 3480926i32;
                        };
                    };
                } else if (__value__ == (3480798i32)) {
                    _flag_3480713 = (_flag_3480713 | (((@:checkr _i_3480750 ?? throw "null pointer dereference").arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp)) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3480955i32;
                } else if (__value__ == (3480847i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3480955i32;
                } else if (__value__ == (3480886i32)) {
                    _gotoNext = 3480955i32;
                } else if (__value__ == (3480926i32)) {
                    loopBreak = true;
                    _gotoNext = 3480774i32;
                } else if (__value__ == (3480955i32)) {
                    _pc_3480727 = (@:checkr _i_3480750 ?? throw "null pointer dereference").out;
                    _i_3480750 = (stdgo.Go.setRef((@:checkr _p ?? throw "null pointer dereference").inst[(_pc_3480727 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3480774i32;
                } else if (__value__ == (3480988i32)) {
                    return _flag_3480713;
                    _gotoNext = -1i32;
                };
            };
        };
