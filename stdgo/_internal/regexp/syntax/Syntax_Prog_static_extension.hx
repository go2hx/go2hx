...
@:keep @:allow(stdgo._internal.regexp.syntax.Syntax.Prog_asInterface) class Prog_static_extension {
    ...
    static public function startCond( _p:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Prog.Prog>):stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp {
        ...
        var loopBreak = false;
        var _i_3151414:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
        var _pc_3151391:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _flag_3151377:stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp = ((0 : stdgo.GoUInt8) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _pc_3151391 = ((@:checkr _p ?? throw "null pointer dereference").start : stdgo.GoUInt32);
                    _i_3151414 = (stdgo.Go.setRef((@:checkr _p ?? throw "null pointer dereference").inst[(_pc_3151391 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3151431i32;
                } else if (__value__ == (3151431i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3151438i32;
                } else if (__value__ == (3151438i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3151442i32;
                    } else {
                        _gotoNext = 3151652i32;
                    };
                } else if (__value__ == (3151442i32)) {
                    _gotoNext = 3151446i32;
                } else if (__value__ == (3151446i32)) {
                    {
                        final __value__ = (@:checkr _i_3151414 ?? throw "null pointer dereference").op;
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3151462i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3151511i32;
                            ...
                            _gotoNext = 3151550i32;
                        } else {
                            _gotoNext = 3151590i32;
                        };
                    };
                } else if (__value__ == (3151462i32)) {
                    _flag_3151377 = (_flag_3151377 | (((@:checkr _i_3151414 ?? throw "null pointer dereference").arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp)) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3151619i32;
                } else if (__value__ == (3151511i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3151619i32;
                } else if (__value__ == (3151550i32)) {
                    _gotoNext = 3151619i32;
                } else if (__value__ == (3151590i32)) {
                    loopBreak = true;
                    _gotoNext = 3151438i32;
                } else if (__value__ == (3151619i32)) {
                    _pc_3151391 = (@:checkr _i_3151414 ?? throw "null pointer dereference").out;
                    _i_3151414 = (stdgo.Go.setRef((@:checkr _p ?? throw "null pointer dereference").inst[(_pc_3151391 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3151438i32;
                } else if (__value__ == (3151652i32)) {
                    return _flag_3151377;
                    _gotoNext = -1i32;
                };
            };
        };
