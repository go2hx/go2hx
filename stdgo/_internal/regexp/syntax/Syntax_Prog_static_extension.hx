...
@:keep @:allow(stdgo._internal.regexp.syntax.Syntax.Prog_asInterface) class Prog_static_extension {
    ...
    static public function startCond( _p:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Prog.Prog>):stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp {
        ...
        var loopBreak = false;
        var _i_3501091:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
        var _pc_3501068:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _flag_3501054:stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp = ((0 : stdgo.GoUInt8) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _pc_3501068 = (_p.start : stdgo.GoUInt32);
                    _i_3501091 = (stdgo.Go.setRef(_p.inst[(_pc_3501068 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3501108i32;
                } else if (__value__ == (3501108i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3501115i32;
                } else if (__value__ == (3501115i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3501119i32;
                    } else {
                        _gotoNext = 3501329i32;
                    };
                } else if (__value__ == (3501119i32)) {
                    _gotoNext = 3501123i32;
                } else if (__value__ == (3501123i32)) {
                    {
                        final __value__ = _i_3501091.op;
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3501139i32;
                            ...
                            _gotoNext = 3501227i32;
                        } else {
                            _gotoNext = 3501267i32;
                        };
                    };
                } else if (__value__ == (3501139i32)) {
                    _flag_3501054 = (_flag_3501054 | ((_i_3501091.arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp)) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3501296i32;
                } else if (__value__ == (3501188i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3501296i32;
                } else if (__value__ == (3501227i32)) {
                    _gotoNext = 3501296i32;
                } else if (__value__ == (3501267i32)) {
                    loopBreak = true;
                    _gotoNext = 3501115i32;
                } else if (__value__ == (3501296i32)) {
                    _pc_3501068 = _i_3501091.out;
                    _i_3501091 = (stdgo.Go.setRef(_p.inst[(_pc_3501068 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3501115i32;
                } else if (__value__ == (3501329i32)) {
                    return _flag_3501054;
                    _gotoNext = -1i32;
                };
            };
        };
