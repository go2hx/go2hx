...
@:keep @:allow(stdgo._internal.regexp.syntax.Syntax.Prog_asInterface) class Prog_static_extension {
    ...
    static public function startCond( _p:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Prog.Prog>):stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp {
        ...
        var loopBreak = false;
        var _i_3356675:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
        var _pc_3356652:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _flag_3356638:stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp = ((0 : stdgo.GoUInt8) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _pc_3356652 = (_p.start : stdgo.GoUInt32);
                    _i_3356675 = (stdgo.Go.setRef(_p.inst[(_pc_3356652 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3356692i32;
                } else if (__value__ == (3356692i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3356699i32;
                } else if (__value__ == (3356699i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3356703i32;
                    } else {
                        _gotoNext = 3356913i32;
                    };
                } else if (__value__ == (3356703i32)) {
                    _gotoNext = 3356707i32;
                } else if (__value__ == (3356707i32)) {
                    {
                        final __value__ = _i_3356675.op;
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3356723i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3356772i32;
                            ...
                            _gotoNext = 3356811i32;
                        } else {
                            _gotoNext = 3356851i32;
                        };
                    };
                } else if (__value__ == (3356723i32)) {
                    _flag_3356638 = (_flag_3356638 | ((_i_3356675.arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp)) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3356880i32;
                } else if (__value__ == (3356772i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3356880i32;
                } else if (__value__ == (3356811i32)) {
                    _gotoNext = 3356880i32;
                } else if (__value__ == (3356851i32)) {
                    loopBreak = true;
                    _gotoNext = 3356699i32;
                } else if (__value__ == (3356880i32)) {
                    _pc_3356652 = _i_3356675.out;
                    _i_3356675 = (stdgo.Go.setRef(_p.inst[(_pc_3356652 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3356699i32;
                } else if (__value__ == (3356913i32)) {
                    return _flag_3356638;
                    _gotoNext = -1i32;
                };
            };
        };
