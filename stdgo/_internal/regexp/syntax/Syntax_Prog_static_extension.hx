...
@:keep @:allow(stdgo._internal.regexp.syntax.Syntax.Prog_asInterface) class Prog_static_extension {
    ...
    static public function startCond( _p:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Prog.Prog>):stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp {
        ...
        var _flag_3545655:stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp = ((0 : stdgo.GoUInt8) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
        var loopBreak = false;
        var _i_3545692:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
        var _pc_3545669:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _pc_3545669 = (_p.start : stdgo.GoUInt32);
                    _i_3545692 = (stdgo.Go.setRef(_p.inst[(_pc_3545669 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3545709i32;
                } else if (__value__ == (3545709i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3545716i32;
                } else if (__value__ == (3545716i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3545720i32;
                    } else {
                        _gotoNext = 3545930i32;
                    };
                } else if (__value__ == (3545720i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3545724i32;
                } else if (__value__ == (3545724i32)) {
                    {
                        final __value__ = _i_3545692.op;
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3545740i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3545789i32;
                            ...
                            _gotoNext = 3545828i32;
                        } else {
                            _gotoNext = 3545868i32;
                        };
                    };
                } else if (__value__ == (3545740i32)) {
                    _flag_3545655 = (_flag_3545655 | ((_i_3545692.arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp)) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3545897i32;
                } else if (__value__ == (3545789i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3545897i32;
                } else if (__value__ == (3545828i32)) {
                    _gotoNext = 3545897i32;
                } else if (__value__ == (3545868i32)) {
                    loopBreak = true;
                    _gotoNext = 3545716i32;
                } else if (__value__ == (3545897i32)) {
                    _pc_3545669 = _i_3545692.out;
                    _i_3545692 = (stdgo.Go.setRef(_p.inst[(_pc_3545669 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3545716i32;
                } else if (__value__ == (3545930i32)) {
                    return _flag_3545655;
                    _gotoNext = -1i32;
                };
            };
        };
