...
@:keep @:allow(stdgo._internal.regexp.syntax.Syntax.Prog_asInterface) class Prog_static_extension {
    ...
    static public function startCond( _p:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Prog.Prog>):stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp {
        ...
        var _i_3535664:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
        var _pc_3535641:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _flag_3535627:stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp = ((0 : stdgo.GoUInt8) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
        var loopBreak = false;
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _pc_3535641 = (_p.start : stdgo.GoUInt32);
                    _i_3535664 = (stdgo.Go.setRef(_p.inst[(_pc_3535641 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3535681i32;
                } else if (__value__ == (3535681i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3535688i32;
                } else if (__value__ == (3535688i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3535692i32;
                    } else {
                        _gotoNext = 3535902i32;
                    };
                } else if (__value__ == (3535692i32)) {
                    _gotoNext = 3535696i32;
                } else if (__value__ == (3535696i32)) {
                    {
                        final __value__ = _i_3535664.op;
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3535712i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3535761i32;
                            ...
                            _gotoNext = 3535800i32;
                        } else {
                            _gotoNext = 3535840i32;
                        };
                    };
                } else if (__value__ == (3535712i32)) {
                    _flag_3535627 = (_flag_3535627 | ((_i_3535664.arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp)) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3535869i32;
                } else if (__value__ == (3535761i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3535869i32;
                } else if (__value__ == (3535800i32)) {
                    _gotoNext = 3535869i32;
                } else if (__value__ == (3535840i32)) {
                    loopBreak = true;
                    _gotoNext = 3535688i32;
                } else if (__value__ == (3535869i32)) {
                    _pc_3535641 = _i_3535664.out;
                    _i_3535664 = (stdgo.Go.setRef(_p.inst[(_pc_3535641 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3535688i32;
                } else if (__value__ == (3535902i32)) {
                    return _flag_3535627;
                    _gotoNext = -1i32;
                };
            };
        };
    ...
    static public function prefix( _p:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Prog.Prog>):{ var _0 : stdgo.GoString; var _1 : Bool; } {
        ...
        if (((_i._op() != (7 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp)) || (_i.rune.length != (1 : stdgo.GoInt)) : Bool)) {
            return { _0 : _prefix = stdgo.Go.str()?.__copy__(), _1 : _complete = _i.op == ((4 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp)) };
        };
        ...
        return { _0 : _prefix = (_buf.string() : stdgo.GoString)?.__copy__(), _1 : _complete = _i.op == ((4 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp)) };
    }
    @:keep
