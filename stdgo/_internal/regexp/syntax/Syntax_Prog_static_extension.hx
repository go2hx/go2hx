...
@:keep @:allow(stdgo._internal.regexp.syntax.Syntax.Prog_asInterface) class Prog_static_extension {
    ...
    static public function startCond( _p:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Prog.Prog>):stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp {
        ...
        var _i_3326550:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
        var _pc_3326527:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _flag_3326513:stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp = ((0 : stdgo.GoUInt8) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
        var loopBreak = false;
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _pc_3326527 = (_p.start : stdgo.GoUInt32);
                    _i_3326550 = (stdgo.Go.setRef(_p.inst[(_pc_3326527 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3326567i32;
                } else if (__value__ == (3326567i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3326574i32;
                } else if (__value__ == (3326574i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3326578i32;
                    } else {
                        _gotoNext = 3326788i32;
                    };
                } else if (__value__ == (3326578i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3326582i32;
                } else if (__value__ == (3326582i32)) {
                    {
                        final __value__ = _i_3326550.op;
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3326598i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_InstOp.InstOp))) {
                            _gotoNext = 3326647i32;
                            ...
                            _gotoNext = 3326686i32;
                        } else {
                            _gotoNext = 3326726i32;
                        };
                    };
                } else if (__value__ == (3326598i32)) {
                    _flag_3326513 = (_flag_3326513 | ((_i_3326550.arg : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp)) : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3326755i32;
                } else if (__value__ == (3326647i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_EmptyOp.EmptyOp);
                    _gotoNext = 3326755i32;
                } else if (__value__ == (3326686i32)) {
                    _gotoNext = 3326755i32;
                } else if (__value__ == (3326726i32)) {
                    loopBreak = true;
                    _gotoNext = 3326574i32;
                } else if (__value__ == (3326755i32)) {
                    _pc_3326527 = _i_3326550.out;
                    _i_3326550 = (stdgo.Go.setRef(_p.inst[(_pc_3326527 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Inst.Inst>);
                    _gotoNext = 3326574i32;
                } else if (__value__ == (3326788i32)) {
                    return _flag_3326513;
                    _gotoNext = -1i32;
                };
            };
        };
