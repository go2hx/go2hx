                ...
                for (_i => _sub in _re.sub) {
                    ...
                    if (((_nre == _re) && (_nsub != _sub) : Bool)) {
                        _nre = (stdgo.Go.setRef(({} : stdgo._internal.regexp.syntax.Syntax_Regexp.Regexp)) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Regexp.Regexp>);
                        {
                            ...
                            (_nre : stdgo._internal.regexp.syntax.Syntax_Regexp.Regexp).op = __tmp__.op;
                            (_nre : stdgo._internal.regexp.syntax.Syntax_Regexp.Regexp).flags = __tmp__.flags;
                            (_nre : stdgo._internal.regexp.syntax.Syntax_Regexp.Regexp).sub = __tmp__.sub;
                            (_nre : stdgo._internal.regexp.syntax.Syntax_Regexp.Regexp).sub0 = __tmp__.sub0;
                            (_nre : stdgo._internal.regexp.syntax.Syntax_Regexp.Regexp).rune = __tmp__.rune;
                            (_nre : stdgo._internal.regexp.syntax.Syntax_Regexp.Regexp).rune0 = __tmp__.rune0;
                            (_nre : stdgo._internal.regexp.syntax.Syntax_Regexp.Regexp).min = __tmp__.min;
                            (_nre : stdgo._internal.regexp.syntax.Syntax_Regexp.Regexp).max = __tmp__.max;
                            (_nre : stdgo._internal.regexp.syntax.Syntax_Regexp.Regexp).cap = __tmp__.cap;
                            (_nre : stdgo._internal.regexp.syntax.Syntax_Regexp.Regexp).name = __tmp__.name;
                        };
