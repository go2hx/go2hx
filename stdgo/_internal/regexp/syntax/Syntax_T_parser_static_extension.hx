        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _p._numCap++;
                    _re_3330952 = _p._op((128 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                    _re_3330952.cap = _p._numCap;
                    _re_3330952.name = _name_3330712?.__copy__();
                    return {
