...
var _s = __1, _name = __0;
    ...
    static public function _parseEscape( _p:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_T_parser.T_parser>, _s:stdgo.GoString):{ var _0 : stdgo.GoInt32; var _1 : stdgo.GoString; var _2 : stdgo.Error; } {
        ...
        var _y_3429269:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _v_3428947:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _err_3427518:stdgo.Error = (null : stdgo.Error);
        var _c_3427610:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _t_3427532:stdgo.GoString = ("" : stdgo.GoString);
        var _x_3429185:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _nhex_3428765:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i_3428284:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _t_3427532 = (_s.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    if (_t_3427532 == (stdgo.Go.str())) {
                        _gotoNext = 3427555i32;
                    } else {
                        _gotoNext = 3427610i32;
                    };
                } else if (__value__ == (3427555i32)) {
                    ...
                    _gotoNext = 3427610i32;
                } else if (__value__ == (3427610i32)) {
                    {
                        var __tmp__ = stdgo._internal.regexp.syntax.Syntax__nextRune._nextRune(_t_3427532?.__copy__());
                        _c_3427610 = __tmp__._0;
                        _t_3427532 = __tmp__._1?.__copy__();
                        _err_3427518 = __tmp__._2;
                    };
                    if (_err_3427518 != null) {
                        _gotoNext = 3427650i32;
                    } else {
                        _gotoNext = 3427676i32;
                    };
                } else if (__value__ == (3427650i32)) {
                    return { _0 : (0 : stdgo.GoInt32), _1 : stdgo.Go.str()?.__copy__(), _2 : _err_3427518 };
                    _gotoNext = 3427676i32;
                } else if (__value__ == (3427676i32)) {
                    _gotoNext = 3427676i32;
                    var __blank__ = 0i32;
                    switchBreak = false;
                    _gotoNext = 3427685i32;
                } else if (__value__ == (3427685i32)) {
                    if (!switchBreak) {
                        {
                            final __value__ = _c_3427610;
                            if (__value__ == ((49 : stdgo.GoInt32)) || __value__ == ((50 : stdgo.GoInt32)) || __value__ == ((51 : stdgo.GoInt32)) || __value__ == ((52 : stdgo.GoInt32)) || __value__ == ((53 : stdgo.GoInt32)) || __value__ == ((54 : stdgo.GoInt32)) || __value__ == ((55 : stdgo.GoInt32))) {
                                _gotoNext = 3428025i32;
                            } else if (__value__ == ((48 : stdgo.GoInt32))) {
                                _gotoNext = 3428197i32;
                            } else if (__value__ == ((120 : stdgo.GoInt32))) {
                                _gotoNext = 3428457i32;
                            } else if (__value__ == ((97 : stdgo.GoInt32))) {
                                _gotoNext = 3429650i32;
                            } else if (__value__ == ((102 : stdgo.GoInt32))) {
                                _gotoNext = 3429683i32;
                            } else if (__value__ == ((110 : stdgo.GoInt32))) {
                                _gotoNext = 3429716i32;
                            } else if (__value__ == ((114 : stdgo.GoInt32))) {
                                _gotoNext = 3429749i32;
                            } else if (__value__ == ((116 : stdgo.GoInt32))) {
                                _gotoNext = 3429782i32;
                            } else if (__value__ == ((118 : stdgo.GoInt32))) {
                                _gotoNext = 3429815i32;
                            } else {
                                _gotoNext = 3427697i32;
                            };
                        };
                    } else {
                        _gotoNext = 3429851i32;
                    };
                } else if (__value__ == (3427697i32)) {
                    if (((_c_3427610 < (128 : stdgo.GoInt32) : Bool) && !stdgo._internal.regexp.syntax.Syntax__isalnum._isalnum(_c_3427610) : Bool)) {
                        _gotoNext = 3427744i32;
                    } else {
                        _gotoNext = 3429851i32;
                    };
                } else if (__value__ == (3427744i32)) {
                    return { _0 : _c_3427610, _1 : _t_3427532?.__copy__(), _2 : (null : stdgo.Error) };
                    _gotoNext = 3429851i32;
                } else if (__value__ == (3428025i32)) {
                    if (((_t_3427532 == (stdgo.Go.str()) || (_t_3427532[(0 : stdgo.GoInt)] < (48 : stdgo.GoUInt8) : Bool) : Bool) || (_t_3427532[(0 : stdgo.GoInt)] > (55 : stdgo.GoUInt8) : Bool) : Bool)) {
                        _gotoNext = 3428167i32;
                    } else {
                        _gotoNext = 3428184i32;
                    };
                } else if (__value__ == (3428167i32)) {
                    _gotoNext = 3429851i32;
                } else if (__value__ == (3428184i32)) {
                    _gotoNext = 3428197i32;
                } else if (__value__ == (3428197i32)) {
                    _r = (_c_3427610 - (48 : stdgo.GoInt32) : stdgo.GoInt32);
                    _i_3428284 = (1 : stdgo.GoInt);
                    _gotoNext = 3428280i32;
                } else if (__value__ == (3428280i32)) {
                    if ((_i_3428284 < (3 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3428303i32;
                    } else {
                        _gotoNext = 3428413i32;
                    };
                } else if (__value__ == (3428303i32)) {
                    if (((_t_3427532 == (stdgo.Go.str()) || (_t_3427532[(0 : stdgo.GoInt)] < (48 : stdgo.GoUInt8) : Bool) : Bool) || (_t_3427532[(0 : stdgo.GoInt)] > (55 : stdgo.GoUInt8) : Bool) : Bool)) {
                        _gotoNext = 3428347i32;
                    } else {
                        _gotoNext = 3428367i32;
                    };
                } else if (__value__ == (3428347i32)) {
                    _gotoNext = 3428413i32;
                } else if (__value__ == (3428367i32)) {
                    _r = (((_r * (8 : stdgo.GoInt32) : stdgo.GoInt32) + (_t_3427532[(0 : stdgo.GoInt)] : stdgo.GoInt32) : stdgo.GoInt32) - (48 : stdgo.GoInt32) : stdgo.GoInt32);
                    _t_3427532 = (_t_3427532.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _i_3428284++;
                    _gotoNext = 3428280i32;
                } else if (__value__ == (3428413i32)) {
                    return { _0 : _r, _1 : _t_3427532?.__copy__(), _2 : (null : stdgo.Error) };
                    _gotoNext = 3429851i32;
                } else if (__value__ == (3428457i32)) {
                    if (_t_3427532 == (stdgo.Go.str())) {
                        _gotoNext = 3428480i32;
                    } else {
                        _gotoNext = 3428497i32;
                    };
                } else if (__value__ == (3428480i32)) {
                    _gotoNext = 3429851i32;
                } else if (__value__ == (3428497i32)) {
                    {
                        {
                            var __tmp__ = stdgo._internal.regexp.syntax.Syntax__nextRune._nextRune(_t_3427532?.__copy__());
                            _c_3427610 = __tmp__._0;
                        ...
                        if (_err_3427518 != null) {
                            _gotoNext = 3428536i32;
                        } else {
                            _gotoNext = 3428565i32;
                        };
                    };
                } else if (__value__ == (3428536i32)) {
                    return { _0 : (0 : stdgo.GoInt32), _1 : stdgo.Go.str()?.__copy__(), _2 : _err_3427518 };
                    _gotoNext = 3428565i32;
                } else if (__value__ == (3428565i32)) {
                    if (_c_3427610 == ((123 : stdgo.GoInt32))) {
                        _gotoNext = 3428577i32;
                    } else {
                        _gotoNext = 3429185i32;
                    };
                } else if (__value__ == (3428577i32)) {
                    _nhex_3428765 = (0 : stdgo.GoInt);
                    _r = (0 : stdgo.GoInt32);
                    var __blank__ = 0i32;
                    _gotoNext = 3428787i32;
                } else if (__value__ == (3428787i32)) {
                    if (true) {
                        _gotoNext = 3428791i32;
                    } else {
                        _gotoNext = 3429089i32;
                    };
                } else if (__value__ == (3428791i32)) {
                    if (_t_3427532 == (stdgo.Go.str())) {
                        _gotoNext = 3428808i32;
                    } else {
                        _gotoNext = 3428838i32;
                    };
                } else if (__value__ == (3428808i32)) {
                    switchBreak = true;
                    _gotoNext = 3427685i32;
                } else if (__value__ == (3428838i32)) {
                    {
                        {
                            var __tmp__ = stdgo._internal.regexp.syntax.Syntax__nextRune._nextRune(_t_3427532?.__copy__());
                            _c_3427610 = __tmp__._0;
                        ...
                        if (_err_3427518 != null) {
                            ...
                            _gotoNext = 3428912i32;
                        };
                    };
                } else if (__value__ == (3428877i32)) {
                    return { _0 : (0 : stdgo.GoInt32), _1 : stdgo.Go.str()?.__copy__(), _2 : _err_3427518 };
                    _gotoNext = 3428912i32;
                } else if (__value__ == (3428912i32)) {
                    if (_c_3427610 == ((125 : stdgo.GoInt32))) {
                        _gotoNext = 3428924i32;
                    } else {
                        _gotoNext = 3428947i32;
                    };
                } else if (__value__ == (3428924i32)) {
                    _gotoNext = 3429089i32;
                } else if (__value__ == (3428947i32)) {
                    _v_3428947 = stdgo._internal.regexp.syntax.Syntax__unhex._unhex(_c_3427610);
                    if ((_v_3428947 < (0 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 3428974i32;
                    } else {
                        _gotoNext = 3429004i32;
                    };
                } else if (__value__ == (3428974i32)) {
                    switchBreak = true;
                    _gotoNext = 3427685i32;
                } else if (__value__ == (3429004i32)) {
                    _r = ((_r * (16 : stdgo.GoInt32) : stdgo.GoInt32) + _v_3428947 : stdgo.GoInt32);
                    if ((_r > (1114111 : stdgo.GoInt32) : Bool)) {
                        _gotoNext = 3429044i32;
                    } else {
                        _gotoNext = 3429074i32;
                    };
                } else if (__value__ == (3429044i32)) {
                    switchBreak = true;
                    _gotoNext = 3427685i32;
                } else if (__value__ == (3429074i32)) {
                    _nhex_3428765++;
                    _gotoNext = 3428787i32;
                } else if (__value__ == (3429089i32)) {
                    if (_nhex_3428765 == ((0 : stdgo.GoInt))) {
                        _gotoNext = 3429102i32;
                    } else {
                        _gotoNext = 3429129i32;
                    };
                } else if (__value__ == (3429102i32)) {
                    switchBreak = true;
                    _gotoNext = 3427685i32;
                } else if (__value__ == (3429129i32)) {
                    return { _0 : _r, _1 : _t_3427532?.__copy__(), _2 : (null : stdgo.Error) };
                    _gotoNext = 3429185i32;
                } else if (__value__ == (3429185i32)) {
                    _x_3429185 = stdgo._internal.regexp.syntax.Syntax__unhex._unhex(_c_3427610);
                    {
                        {
                            var __tmp__ = stdgo._internal.regexp.syntax.Syntax__nextRune._nextRune(_t_3427532?.__copy__());
                            _c_3427610 = __tmp__._0;
                        ...
                        if (_err_3427518 != null) {
                            _gotoNext = 3429240i32;
                        } else {
                            _gotoNext = 3429269i32;
                        };
                    };
                } else if (__value__ == (3429240i32)) {
                    return { _0 : (0 : stdgo.GoInt32), _1 : stdgo.Go.str()?.__copy__(), _2 : _err_3427518 };
                    _gotoNext = 3429269i32;
                } else if (__value__ == (3429269i32)) {
                    _y_3429269 = stdgo._internal.regexp.syntax.Syntax__unhex._unhex(_c_3427610);
                    if (((_x_3429185 < (0 : stdgo.GoInt32) : Bool) || (_y_3429269 < (0 : stdgo.GoInt32) : Bool) : Bool)) {
                        _gotoNext = 3429303i32;
                    } else {
                        _gotoNext = 3429320i32;
                    };
                } else if (__value__ == (3429303i32)) {
                    _gotoNext = 3429851i32;
                } else if (__value__ == (3429320i32)) {
                    return { _0 : ((_x_3429185 * (16 : stdgo.GoInt32) : stdgo.GoInt32) + _y_3429269 : stdgo.GoInt32), _1 : _t_3427532?.__copy__(), _2 : (null : stdgo.Error) };
                    _gotoNext = 3429851i32;
                } else if (__value__ == (3429650i32)) {
                    return { _0 : (7 : stdgo.GoInt32), _1 : _t_3427532?.__copy__(), _2 : _err_3427518 };
                    _gotoNext = 3429851i32;
                } else if (__value__ == (3429683i32)) {
                    return { _0 : (12 : stdgo.GoInt32), _1 : _t_3427532?.__copy__(), _2 : _err_3427518 };
                    _gotoNext = 3429851i32;
                } else if (__value__ == (3429716i32)) {
                    return { _0 : (10 : stdgo.GoInt32), _1 : _t_3427532?.__copy__(), _2 : _err_3427518 };
                    _gotoNext = 3429851i32;
                } else if (__value__ == (3429749i32)) {
                    return { _0 : (13 : stdgo.GoInt32), _1 : _t_3427532?.__copy__(), _2 : _err_3427518 };
                    _gotoNext = 3429851i32;
                } else if (__value__ == (3429782i32)) {
                    return { _0 : (9 : stdgo.GoInt32), _1 : _t_3427532?.__copy__(), _2 : _err_3427518 };
                    _gotoNext = 3429851i32;
                } else if (__value__ == (3429815i32)) {
                    return { _0 : (11 : stdgo.GoInt32), _1 : _t_3427532?.__copy__(), _2 : _err_3427518 };
                    _gotoNext = 3429851i32;
                } else if (__value__ == (3429851i32)) {
                    return { _0 : (0 : stdgo.GoInt32), _1 : stdgo.Go.str()?.__copy__(), _2 : stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo._internal.regexp.syntax.Syntax_Error.Error((("invalid escape sequence" : stdgo.GoString) : stdgo._internal.regexp.syntax.Syntax_ErrorCode.ErrorCode), (_s.__slice__(0, ((_s.length) - (_t_3427532.length) : stdgo.GoInt)) : stdgo.GoString)?.__copy__()) : stdgo._internal.regexp.syntax.Syntax_Error.Error)) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Error.Error>)) };
                    _gotoNext = -1i32;
                };
            };
        };
...
_n = (((_n * (10 : stdgo.GoInt) : stdgo.GoInt) + (_t[(_i : stdgo.GoInt)] : stdgo.GoInt) : stdgo.GoInt) - (48 : stdgo.GoInt) : stdgo.GoInt);
    ...
    static public function _parsePerlFlags( _p:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_T_parser.T_parser>, _s:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : stdgo.Error; } {
        @:recv var _p:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_T_parser.T_parser> = _p;
        var _rest = ("" : stdgo.GoString), _err = (null : stdgo.Error);
        var _sawFlag_3422094:Bool = false;
        var _sign_3422082:stdgo.GoInt = (0 : stdgo.GoInt);
        var _name_3421644:stdgo.GoString = ("" : stdgo.GoString);
        var _end_3421440:stdgo.GoInt = (0 : stdgo.GoInt);
        var _flags_3422064:stdgo._internal.regexp.syntax.Syntax_Flags.Flags = ((0 : stdgo.GoUInt16) : stdgo._internal.regexp.syntax.Syntax_Flags.Flags);
        var _c_3422034:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _re_3421884:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Regexp.Regexp> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Regexp.Regexp>);
        var _capture_3421606:stdgo.GoString = ("" : stdgo.GoString);
        var _t_3420594:stdgo.GoString = ("" : stdgo.GoString);
        var loopBreak = false;
        var _gotoNext = 0i32;
        var __blank__ = _gotoNext == ((0i32 : stdgo.GoInt));
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                final __value__ = _gotoNext;
                if (__value__ == (0i32)) {
                    _t_3420594 = _s?.__copy__();
                    if (((((_t_3420594.length) > (4 : stdgo.GoInt) : Bool) && _t_3420594[(2 : stdgo.GoInt)] == ((80 : stdgo.GoUInt8)) : Bool) && (_t_3420594[(3 : stdgo.GoInt)] == (60 : stdgo.GoUInt8)) : Bool)) {
                        _gotoNext = 3421416i32;
                    } else {
                        _gotoNext = 3422030i32;
                    };
                } else if (__value__ == (3421416i32)) {
                    _end_3421440 = stdgo._internal.strings.Strings_indexRune.indexRune(_t_3420594?.__copy__(), (62 : stdgo.GoInt32));
                    if ((_end_3421440 < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3421486i32;
                    } else {
                        _gotoNext = 3421606i32;
                    };
                } else if (__value__ == (3421486i32)) {
                    {
                        _err = stdgo._internal.regexp.syntax.Syntax__checkUTF8._checkUTF8(_t_3420594?.__copy__());
                        if (_err != null) {
                            _gotoNext = 3421525i32;
                        } else {
                            _gotoNext = 3421554i32;
                        };
                    };
                } else if (__value__ == (3421525i32)) {
                    return { _0 : stdgo.Go.str()?.__copy__(), _1 : _err };
                    _gotoNext = 3421554i32;
                } else if (__value__ == (3421554i32)) {
                    ...
                    _gotoNext = 3421606i32;
                } else if (__value__ == (3421606i32)) {
                    _capture_3421606 = (_t_3420594.__slice__(0, (_end_3421440 + (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _name_3421644 = (_t_3420594.__slice__((4 : stdgo.GoInt), _end_3421440) : stdgo.GoString)?.__copy__();
                    {
                        _err = stdgo._internal.regexp.syntax.Syntax__checkUTF8._checkUTF8(_name_3421644?.__copy__());
                        if (_err != null) {
                            _gotoNext = 3421714i32;
                        } else {
                            _gotoNext = 3421740i32;
                        };
                    };
                } else if (__value__ == (3421714i32)) {
                    return { _0 : stdgo.Go.str()?.__copy__(), _1 : _err };
                    _gotoNext = 3421740i32;
                } else if (__value__ == (3421740i32)) {
                    if (!stdgo._internal.regexp.syntax.Syntax__isValidCaptureName._isValidCaptureName(_name_3421644?.__copy__())) {
                        _gotoNext = 3421769i32;
                    } else {
                        _gotoNext = 3421871i32;
                    };
                } else if (__value__ == (3421769i32)) {
                    return { _0 : stdgo.Go.str()?.__copy__(), _1 : stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo._internal.regexp.syntax.Syntax_Error.Error((("invalid named capture" : stdgo.GoString) : stdgo._internal.regexp.syntax.Syntax_ErrorCode.ErrorCode), _capture_3421606?.__copy__()) : stdgo._internal.regexp.syntax.Syntax_Error.Error)) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Error.Error>)) };
                    _gotoNext = 3421871i32;
                } else if (__value__ == (3421871i32)) {
                    _p._numCap++;
                    _re_3421884 = _p._op((128 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                    _re_3421884.cap = _p._numCap;
                    _re_3421884.name = _name_3421644?.__copy__();
                    return { _0 : (_t_3420594.__slice__((_end_3421440 + (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.GoString)?.__copy__(), _1 : (null : stdgo.Error) };
                    _gotoNext = 3422030i32;
                } else if (__value__ == (3422030i32)) {
                    _t_3420594 = (_t_3420594.__slice__((2 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _flags_3422064 = _p._flags;
                    _sign_3422082 = (1 : stdgo.GoInt);
                    _sawFlag_3422094 = false;
                    _gotoNext = 3422111i32;
                } else if (__value__ == (3422111i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3422118i32;
                } else if (__value__ == (3422118i32)) {
                    if (!loopBreak && (_t_3420594 != stdgo.Go.str())) {
                        _gotoNext = 3422130i32;
                    } else {
                        _gotoNext = 3422945i32;
                    };
                } else if (__value__ == (3422130i32)) {
                    {
                        {
                            var __tmp__ = stdgo._internal.regexp.syntax.Syntax__nextRune._nextRune(_t_3420594?.__copy__());
                            _c_3422034 = __tmp__._0;
                            _t_3420594 = __tmp__._1?.__copy__();
                            _err = __tmp__._2;
                        };
                        if (_err != null) {
                            _gotoNext = 3422173i32;
                        } else {
                            _gotoNext = 3422199i32;
                        };
                    };
                } else if (__value__ == (3422173i32)) {
                    return { _0 : stdgo.Go.str()?.__copy__(), _1 : _err };
                    _gotoNext = 3422199i32;
                } else if (__value__ == (3422199i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 3422199i32;
                    {
                        final __value__ = _c_3422034;
                        if (__value__ == ((105 : stdgo.GoInt32))) {
                            _gotoNext = 3422250i32;
                        } else if (__value__ == ((109 : stdgo.GoInt32))) {
                            _gotoNext = 3422301i32;
                        } else if (__value__ == ((115 : stdgo.GoInt32))) {
                            _gotoNext = 3422352i32;
                        } else if (__value__ == ((85 : stdgo.GoInt32))) {
                            _gotoNext = 3422400i32;
                        } else if (__value__ == ((45 : stdgo.GoInt32))) {
                            _gotoNext = 3422478i32;
                        } else if (__value__ == ((58 : stdgo.GoInt32)) || __value__ == ((41 : stdgo.GoInt32))) {
                            _gotoNext = 3422738i32;
                        } else {
                            _gotoNext = 3422212i32;
                        };
                    };
                } else if (__value__ == (3422212i32)) {
                    loopBreak = true;
                    _gotoNext = 3422118i32;
                } else if (__value__ == (3422250i32)) {
                    _flags_3422064 = (_flags_3422064 | ((1 : stdgo._internal.regexp.syntax.Syntax_Flags.Flags)) : stdgo._internal.regexp.syntax.Syntax_Flags.Flags);
                    _sawFlag_3422094 = true;
                    _gotoNext = 3422945i32;
                } else if (__value__ == (3422301i32)) {
                    _flags_3422064 = (_flags_3422064 & ((((16 : stdgo._internal.regexp.syntax.Syntax_Flags.Flags)) ^ (-1i32 : stdgo.GoInt) : stdgo._internal.regexp.syntax.Syntax_Flags.Flags)) : stdgo._internal.regexp.syntax.Syntax_Flags.Flags);
                    _sawFlag_3422094 = true;
                    _gotoNext = 3422945i32;
                } else if (__value__ == (3422352i32)) {
                    _flags_3422064 = (_flags_3422064 | ((8 : stdgo._internal.regexp.syntax.Syntax_Flags.Flags)) : stdgo._internal.regexp.syntax.Syntax_Flags.Flags);
                    _sawFlag_3422094 = true;
                    _gotoNext = 3422945i32;
                } else if (__value__ == (3422400i32)) {
                    _flags_3422064 = (_flags_3422064 | ((32 : stdgo._internal.regexp.syntax.Syntax_Flags.Flags)) : stdgo._internal.regexp.syntax.Syntax_Flags.Flags);
                    _sawFlag_3422094 = true;
                    _gotoNext = 3422945i32;
                } else if (__value__ == (3422478i32)) {
                    if ((_sign_3422082 < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3422503i32;
                    } else {
                        _gotoNext = 3422528i32;
                    };
                } else if (__value__ == (3422503i32)) {
                    loopBreak = true;
                    _gotoNext = 3422118i32;
                } else if (__value__ == (3422528i32)) {
                    _sign_3422082 = (-1 : stdgo.GoInt);
                    _flags_3422064 = (-1 ^ _flags_3422064);
                    _sawFlag_3422094 = false;
                    _gotoNext = 3422945i32;
                } else if (__value__ == (3422738i32)) {
                    if ((_sign_3422082 < (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3422768i32;
                    } else {
                        _gotoNext = 3422837i32;
                    };
                } else if (__value__ == (3422768i32)) {
                    if (!_sawFlag_3422094) {
                        _gotoNext = 3422786i32;
                    } else {
                        _gotoNext = 3422814i32;
                    };
                } else if (__value__ == (3422786i32)) {
                    loopBreak = true;
                    _gotoNext = 3422118i32;
                } else if (__value__ == (3422814i32)) {
                    _flags_3422064 = (-1 ^ _flags_3422064);
                    _gotoNext = 3422837i32;
                } else if (__value__ == (3422837i32)) {
                    if (_c_3422034 == ((58 : stdgo.GoInt32))) {
                        _gotoNext = 3422849i32;
                    } else {
                        _gotoNext = 3422903i32;
                    };
                } else if (__value__ == (3422849i32)) {
                    _p._op((128 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                    _gotoNext = 3422903i32;
                } else if (__value__ == (3422903i32)) {
                    _p._flags = _flags_3422064;
                    return { _0 : _t_3420594?.__copy__(), _1 : (null : stdgo.Error) };
                    _gotoNext = 3422945i32;
                } else if (__value__ == (3422945i32)) {
                    return { _0 : stdgo.Go.str()?.__copy__(), _1 : stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo._internal.regexp.syntax.Syntax_Error.Error((("invalid or unsupported Perl syntax" : stdgo.GoString) : stdgo._internal.regexp.syntax.Syntax_ErrorCode.ErrorCode), (_s.__slice__(0, ((_s.length) - (_t_3420594.length) : stdgo.GoInt)) : stdgo.GoString)?.__copy__()) : stdgo._internal.regexp.syntax.Syntax_Error.Error)) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Error.Error>)) };
                    _gotoNext = -1i32;
                };
            };
        };
