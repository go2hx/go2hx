        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if (_t_3325600 == ((stdgo.Go.str() : stdgo.GoString))) {
                ...
                } else if (__value__ == (3325678i32)) {
                    {
                        ...
                        _c_3325678 = @:tmpset0 __tmp__._0;
                        _t_3325600 = @:tmpset0 __tmp__._1?.__copy__();
                        _err_3325586 = @:tmpset0 __tmp__._2;
                    };
                    ...
                    return {
                        final __tmp__:{ var _0 : stdgo.GoInt32; var _1 : stdgo.GoString; var _2 : stdgo.Error; } = { _0 : (0 : stdgo.GoInt32), _1 : (stdgo.Go.str() : stdgo.GoString)?.__copy__(), _2 : _err_3325586 };
                        _r = __tmp__._0;
                        _rest = __tmp__._1;
                        _err = __tmp__._2;
                        __tmp__;
                    ...
                    if (((_t_3325600 == ((stdgo.Go.str() : stdgo.GoString)) || (_t_3325600[(0 : stdgo.GoInt)] < (48 : stdgo.GoUInt8) : Bool) : Bool) || (_t_3325600[(0 : stdgo.GoInt)] > (55 : stdgo.GoUInt8) : Bool) : Bool)) {
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _re_3319952 = @:check2r _p._op((128 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                    (@:checkr _re_3319952 ?? throw "null pointer dereference").cap = (@:checkr _p ?? throw "null pointer dereference")._numCap;
                    (@:checkr _re_3319952 ?? throw "null pointer dereference").name = _name_3319712?.__copy__();
                    return {
                    ...
                    _flags_3320132 = (@:checkr _p ?? throw "null pointer dereference")._flags;
                    ...
                    if (!loopBreak && (_t_3318662 != (stdgo.Go.str() : stdgo.GoString))) {
                    ...
                    {
                        {
                            ...
                            _c_3320102 = @:tmpset0 __tmp__._0;
                            _t_3318662 = @:tmpset0 __tmp__._1?.__copy__();
                            _err = @:tmpset0 __tmp__._2;
                        };
                        if (_err != null) {
                    ...
                    _flags_3320132 = (_flags_3320132 & ((((16 : stdgo._internal.regexp.syntax.Syntax_Flags.Flags)) ^ (-1i32 : stdgo.GoInt32) : stdgo._internal.regexp.syntax.Syntax_Flags.Flags)) : stdgo._internal.regexp.syntax.Syntax_Flags.Flags);
                    _sawFlag_3320162 = true;
                    _gotoNext = 3320186i32;
                    ...
                    (@:checkr _p ?? throw "null pointer dereference")._flags = _flags_3320132;
                    return {
