        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                ...
                } else if (__value__ == (3562901i32)) {
                    {
                        ...
                        _c_3562901 = __tmp__._0;
                        _t_3562823 = __tmp__._1?.__copy__();
                        _err_3562809 = __tmp__._2;
                    };
                    ...
                    return { _0 : (0 : stdgo.GoInt32), _1 : stdgo.Go.str()?.__copy__(), _2 : _err_3562809 };
                    _gotoNext = 3562967i32;
                    ...
                    return { _0 : _c_3562901, _1 : _t_3562823?.__copy__(), _2 : (null : stdgo.Error) };
                    _gotoNext = 3565142i32;
                    ...
                    return { _0 : _r, _1 : _t_3562823?.__copy__(), _2 : (null : stdgo.Error) };
                    _gotoNext = 3565142i32;
                    ...
                    return { _0 : ((_x_3564476 * (16 : stdgo.GoInt32) : stdgo.GoInt32) + _y_3564560 : stdgo.GoInt32), _1 : _t_3562823?.__copy__(), _2 : (null : stdgo.Error) };
                    _gotoNext = 3565142i32;
                } else if (__value__ == (3564941i32)) {
                    return { _0 : (7 : stdgo.GoInt32), _1 : _t_3562823?.__copy__(), _2 : _err_3562809 };
                    _gotoNext = 3565142i32;
                } else if (__value__ == (3564974i32)) {
                    return { _0 : (12 : stdgo.GoInt32), _1 : _t_3562823?.__copy__(), _2 : _err_3562809 };
                    _gotoNext = 3565142i32;
                } else if (__value__ == (3565007i32)) {
                    return { _0 : (10 : stdgo.GoInt32), _1 : _t_3562823?.__copy__(), _2 : _err_3562809 };
                    _gotoNext = 3565142i32;
                } else if (__value__ == (3565040i32)) {
                    return { _0 : (13 : stdgo.GoInt32), _1 : _t_3562823?.__copy__(), _2 : _err_3562809 };
                    _gotoNext = 3565142i32;
                } else if (__value__ == (3565073i32)) {
                    return { _0 : (9 : stdgo.GoInt32), _1 : _t_3562823?.__copy__(), _2 : _err_3562809 };
                    _gotoNext = 3565142i32;
                } else if (__value__ == (3565106i32)) {
                    return { _0 : (11 : stdgo.GoInt32), _1 : _t_3562823?.__copy__(), _2 : _err_3562809 };
                    _gotoNext = 3565142i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _p._numCap++;
                    _re_3557175 = _p._op((128 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                    _re_3557175.cap = _p._numCap;
                    _re_3557175.name = _name_3556935?.__copy__();
                    return { _0 : (_t_3555885.__slice__((_end_3556731 + (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.GoString)?.__copy__(), _1 : (null : stdgo.Error) };
                    _gotoNext = 3557321i32;
                } else if (__value__ == (3557321i32)) {
                    _t_3555885 = (_t_3555885.__slice__((2 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                    _flags_3557355 = _p._flags;
                    ...
                    {
                        {
                            ...
                            _c_3557325 = __tmp__._0;
                            _t_3555885 = __tmp__._1?.__copy__();
                            _err = __tmp__._2;
                        };
                        if (_err != null) {
                    ...
                    _p._flags = _flags_3557355;
                    return { _0 : _t_3555885?.__copy__(), _1 : (null : stdgo.Error) };
                    _gotoNext = 3558236i32;
