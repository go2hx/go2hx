...
function _nextRune(_s:stdgo.GoString):{ var _0 : stdgo.GoInt32; var _1 : stdgo.GoString; var _2 : stdgo.Error; } {
        ...
        if (((_c == (65533 : stdgo.GoInt32)) && (_size == (1 : stdgo.GoInt)) : Bool)) {
            return { _0 : _c = (0 : stdgo.GoInt32), _1 : _t = stdgo.Go.str()?.__copy__(), _2 : _err = stdgo.Go.asInterface((stdgo.Go.setRef(({ code : (("invalid UTF-8" : stdgo.GoString) : stdgo._internal.regexp.syntax.Syntax_ErrorCode.ErrorCode), expr : _s?.__copy__() } : stdgo._internal.regexp.syntax.Syntax_Error.Error)) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Error.Error>)) };
        };
        return { _0 : _c, _1 : _t = (_s.__slice__(_size) : stdgo.GoString)?.__copy__(), _2 : _err = (null : stdgo.Error) };
    }
