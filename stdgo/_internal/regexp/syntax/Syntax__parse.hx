            ...
            while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
                {
                    ...
                    if (__value__ == (0i32)) {
                        ...
                        {
                            final __ret__:{ var _0 : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Regexp.Regexp>; var _1 : stdgo.Error; } = { _0 : null, _1 : _err_3306817 };
                            for (defer in __deferstack__) {
                                defer();
                            };
                            return __ret__;
                        ...
                        {
                            {
                                ...
                                _c_3306979 = __tmp__._0;
                                _t_3307071 = __tmp__._1?.__copy__();
                                _err = __tmp__._2;
                            };
                            if (_err != null) {
                        ...
                        _p_3306959._literal(_c_3306979);
                        _gotoNext = 3310456i32;
                        ...
                        {
                            {
                                var __tmp__ = _p_3306959._parsePerlFlags(_t_3307071?.__copy__());
                                _t_3307071 = __tmp__._0?.__copy__();
                                _err = __tmp__._1;
                            };
                            if (_err != null) {
                        ...
                        _p_3306959._numCap++;
                        _p_3306959._op((128 : stdgo._internal.regexp.syntax.Syntax_Op.Op)).cap = _p_3306959._numCap;
                        _t_3307071 = (_t_3307071.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        _gotoNext = 3310456i32;
                    } else if (__value__ == (3307505i32)) {
                        {
                            _err = _p_3306959._parseVerticalBar();
                            if (_err != null) {
                        ...
                        {
                            _err = _p_3306959._parseRightParen();
                            if (_err != null) {
                        ...
                        _p_3306959._op((9 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _gotoNext = 3307801i32;
                    } else if (__value__ == (3307769i32)) {
                        _p_3306959._op((7 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _gotoNext = 3307801i32;
                        ...
                        _p_3306959._op((10 : stdgo._internal.regexp.syntax.Syntax_Op.Op)).flags = (_p_3306959._op((10 : stdgo._internal.regexp.syntax.Syntax_Op.Op)).flags | ((256 : stdgo._internal.regexp.syntax.Syntax_Flags.Flags)) : stdgo._internal.regexp.syntax.Syntax_Flags.Flags);
                        _gotoNext = 3307931i32;
                    } else if (__value__ == (3307901i32)) {
                        _p_3306959._op((8 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _gotoNext = 3307931i32;
                        ...
                        _p_3306959._op((6 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _gotoNext = 3308045i32;
                    } else if (__value__ == (3308010i32)) {
                        _p_3306959._op((5 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _gotoNext = 3308045i32;
                        ...
                        {
                            {
                                var __tmp__ = _p_3306959._parseClass(_t_3307071?.__copy__());
                                _t_3307071 = __tmp__._0?.__copy__();
                                _err = __tmp__._1;
                            };
                            if (_err != null) {
                        ...
                        {
                            {
                                var __tmp__ = _p_3306959._repeat(_op_3306997, (0 : stdgo.GoInt), (0 : stdgo.GoInt), _before_3308162?.__copy__(), _after_3308287?.__copy__(), _lastRepeat_3307013?.__copy__());
                                _after_3308287 = __tmp__._0?.__copy__();
                                _err = __tmp__._1;
                            };
                            if (_err != null) {
                        ...
                        {
                            var __tmp__ = _p_3306959._parseRepeat(_t_3307071?.__copy__());
                            _min_3308485 = __tmp__._0;
                            _max_3308490 = __tmp__._1;
                            _after_3308495 = __tmp__._2?.__copy__();
                            _ok_3308502 = __tmp__._3;
                        };
                        if (!_ok_3308502) {
                        ...
                        _p_3306959._literal((123 : stdgo.GoInt32));
                        _t_3307071 = (_t_3307071.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        _gotoNext = 3310456i32;
                        ...
                        {
                            {
                                var __tmp__ = _p_3306959._repeat(_op_3306997, _min_3308485, _max_3308490, _before_3308470?.__copy__(), _after_3308495?.__copy__(), _lastRepeat_3307013?.__copy__());
                                _after_3308495 = __tmp__._0?.__copy__();
                                _err = __tmp__._1;
                            };
                            if (_err != null) {
                        ...
                        _p_3306959._op((11 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _t_3307071 = (_t_3307071.__slice__((2 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        bigSwitchBreak = true;
                        _gotoNext = 3307122i32;
                    } else if (__value__ == (3309220i32)) {
                        _p_3306959._op((12 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _t_3307071 = (_t_3307071.__slice__((2 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        bigSwitchBreak = true;
                        _gotoNext = 3307122i32;
                    ...
                    } else if (__value__ == (3309393i32)) {
                        {
                            ...
                            _lit_3309458 = __tmp__._0?.__copy__();
                            _t_3307071 = __tmp__._1?.__copy__();
                        };
                        var __blank__ = 0i32;
                        _gotoNext = 3309516i32;
                    } else if (__value__ == (3309516i32)) {
                        if (_lit_3309458 != (stdgo.Go.str())) {
                    ...
                    } else if (__value__ == (3309530i32)) {
                        {
                            ...
                            _c_3309538 = __tmp__._0;
                            _rest_3309541 = __tmp__._1?.__copy__();
                            _err_3309547 = __tmp__._2;
                        };
                        ...
                        {
                            final __ret__:{ var _0 : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Regexp.Regexp>; var _1 : stdgo.Error; } = { _0 : null, _1 : _err_3309547 };
                            for (defer in __deferstack__) {
                                defer();
                            };
                            return __ret__;
                        ...
                        _p_3306959._literal(_c_3309538);
                        ...
                        _p_3306959._op((10 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _t_3307071 = (_t_3307071.__slice__((2 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        bigSwitchBreak = true;
                        _gotoNext = 3307122i32;
                    } else if (__value__ == (3309771i32)) {
                        _re_3309771 = _p_3306959._newRegexp((4 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _re_3309771.flags = _p_3306959._flags;
                        ...
                        {
                            var __tmp__ = _p_3306959._parseUnicodeClass(_t_3307071?.__copy__(), (_re_3309771.rune0.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>));
                            _r_3309933 = __tmp__._0;
                            _rest_3309936 = __tmp__._1?.__copy__();
                            _err_3309942 = __tmp__._2;
                        };
                        ...
                        {
                            final __ret__:{ var _0 : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Regexp.Regexp>; var _1 : stdgo.Error; } = { _0 : null, _1 : _err_3309942 };
                            for (defer in __deferstack__) {
                                defer();
                            };
                            return __ret__;
                        ...
                        _re_3309771.rune = _r_3309933;
                        _t_3307071 = _rest_3309936?.__copy__();
                        _p_3306959._push(_re_3309771);
                        bigSwitchBreak = true;
                        _gotoNext = 3307122i32;
                    } else if (__value__ == (3310169i32)) {
                        {
                            {
                                var __tmp__ = _p_3306959._parsePerlClassEscape(_t_3307071?.__copy__(), (_re_3309771.rune0.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>));
                                _r_3310172 = __tmp__._0;
                                _rest_3310175 = __tmp__._1?.__copy__();
                            };
                            if (_r_3310172 != null) {
                        ...
                        _re_3309771.rune = _r_3310172;
                        _t_3307071 = _rest_3310175?.__copy__();
                        _p_3306959._push(_re_3309771);
                        bigSwitchBreak = true;
                        _gotoNext = 3307122i32;
                    } else if (__value__ == (3310307i32)) {
                        _p_3306959._reuse(_re_3309771);
                        {
                            {
                                var __tmp__ = _p_3306959._parseEscape(_t_3307071?.__copy__());
                                _c_3306979 = __tmp__._0;
                                _t_3307071 = __tmp__._1?.__copy__();
                                _err = __tmp__._2;
                            };
                        ...
                        _p_3306959._concat();
                        if (_p_3306959._swapVerticalBar()) {
                        ...
                        {
                            final __ret__:{ var _0 : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_Regexp.Regexp>; var _1 : stdgo.Error; } = { _0 : _p_3306959._stack[(0 : stdgo.GoInt)], _1 : (null : stdgo.Error) };
                            for (defer in __deferstack__) {
                                defer();
                            };
                            return __ret__;
