            ...
            while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
                {
                    ...
                    if (__value__ == (0i32)) {
                        ...
                        {
                            {
                                ...
                                _c_3313889 = __tmp__._0;
                                _t_3313981 = __tmp__._1?.__copy__();
                                _err = __tmp__._2;
                            };
                            if (_err != null) {
                        ...
                        _p_3313869._literal(_c_3313889);
                        _gotoNext = 3317366i32;
                        ...
                        {
                            {
                                var __tmp__ = _p_3313869._parsePerlFlags(_t_3313981?.__copy__());
                                _t_3313981 = __tmp__._0?.__copy__();
                                _err = __tmp__._1;
                            };
                            if (_err != null) {
                        ...
                        _p_3313869._numCap++;
                        _p_3313869._op((128 : stdgo._internal.regexp.syntax.Syntax_Op.Op)).cap = _p_3313869._numCap;
                        _t_3313981 = (_t_3313981.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        _gotoNext = 3317366i32;
                    } else if (__value__ == (3314415i32)) {
                        {
                            _err = _p_3313869._parseVerticalBar();
                            if (_err != null) {
                        ...
                        {
                            _err = _p_3313869._parseRightParen();
                            if (_err != null) {
                        ...
                        _p_3313869._op((9 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _gotoNext = 3314711i32;
                    } else if (__value__ == (3314679i32)) {
                        _gotoNext = 3314679i32;
                        _p_3313869._op((7 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        var __blank__ = 0i32;
                        _gotoNext = 3314711i32;
                        ...
                        {
                            final __t__ = _p_3313869._op((10 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                            __t__.flags = __t__.flags | ((256 : stdgo._internal.regexp.syntax.Syntax_Flags.Flags));
                        };
                        _gotoNext = 3314841i32;
                    } else if (__value__ == (3314811i32)) {
                        _gotoNext = 3314811i32;
                        _p_3313869._op((8 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        var __blank__ = 0i32;
                        _gotoNext = 3314841i32;
                        ...
                        _p_3313869._op((6 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _gotoNext = 3314955i32;
                    } else if (__value__ == (3314920i32)) {
                        _gotoNext = 3314920i32;
                        _p_3313869._op((5 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        var __blank__ = 0i32;
                        _gotoNext = 3314955i32;
                        ...
                        {
                            {
                                var __tmp__ = _p_3313869._parseClass(_t_3313981?.__copy__());
                                _t_3313981 = __tmp__._0?.__copy__();
                                _err = __tmp__._1;
                            };
                            if (_err != null) {
                        ...
                        {
                            {
                                var __tmp__ = _p_3313869._repeat(_op_3313907, (0 : stdgo.GoInt), (0 : stdgo.GoInt), _before_3315072?.__copy__(), _after_3315197?.__copy__(), _lastRepeat_3313923?.__copy__());
                                _after_3315197 = __tmp__._0?.__copy__();
                                _err = __tmp__._1;
                            };
                            if (_err != null) {
                        ...
                        {
                            var __tmp__ = _p_3313869._parseRepeat(_t_3313981?.__copy__());
                            _min_3315395 = __tmp__._0;
                            _max_3315400 = __tmp__._1;
                            _after_3315405 = __tmp__._2?.__copy__();
                            _ok_3315412 = __tmp__._3;
                        };
                        if (!_ok_3315412) {
                        ...
                        _p_3313869._literal((123 : stdgo.GoInt32));
                        _t_3313981 = (_t_3313981.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        _gotoNext = 3317366i32;
                        ...
                        {
                            {
                                var __tmp__ = _p_3313869._repeat(_op_3313907, _min_3315395, _max_3315400, _before_3315380?.__copy__(), _after_3315405?.__copy__(), _lastRepeat_3313923?.__copy__());
                                _after_3315405 = __tmp__._0?.__copy__();
                                _err = __tmp__._1;
                            };
                            if (_err != null) {
                        ...
                        _p_3313869._op((11 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _t_3313981 = (_t_3313981.__slice__((2 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        bigSwitchBreak = true;
                        _gotoNext = 3314032i32;
                    } else if (__value__ == (3316130i32)) {
                        _p_3313869._op((12 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _t_3313981 = (_t_3313981.__slice__((2 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        bigSwitchBreak = true;
                        _gotoNext = 3314032i32;
                    ...
                    } else if (__value__ == (3316303i32)) {
                        {
                            ...
                            _lit_3316368 = __tmp__._0?.__copy__();
                            _t_3313981 = __tmp__._1?.__copy__();
                        };
                        var __blank__ = 0i32;
                        _gotoNext = 3316426i32;
                    } else if (__value__ == (3316426i32)) {
                        if (_lit_3316368 != (stdgo.Go.str())) {
                    ...
                    } else if (__value__ == (3316440i32)) {
                        {
                            ...
                            _c_3316448 = __tmp__._0;
                            _rest_3316451 = __tmp__._1?.__copy__();
                            _err_3316457 = __tmp__._2;
                        };
                        ...
                        _p_3313869._literal(_c_3316448);
                        ...
                        _p_3313869._op((10 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _t_3313981 = (_t_3313981.__slice__((2 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        bigSwitchBreak = true;
                        _gotoNext = 3314032i32;
                    } else if (__value__ == (3316681i32)) {
                        _re_3316681 = _p_3313869._newRegexp((4 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _re_3316681.flags = _p_3313869._flags;
                        ...
                        {
                            var __tmp__ = _p_3313869._parseUnicodeClass(_t_3313981?.__copy__(), (_re_3316681.rune0.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>));
                            _r_3316843 = __tmp__._0;
                            _rest_3316846 = __tmp__._1?.__copy__();
                            _err_3316852 = __tmp__._2;
                        };
                        ...
                        _re_3316681.rune = _r_3316843;
                        _t_3313981 = _rest_3316846?.__copy__();
                        _p_3313869._push(_re_3316681);
                        bigSwitchBreak = true;
                        _gotoNext = 3314032i32;
                    } else if (__value__ == (3317079i32)) {
                        {
                            {
                                var __tmp__ = _p_3313869._parsePerlClassEscape(_t_3313981?.__copy__(), (_re_3316681.rune0.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>));
                                _r_3317082 = __tmp__._0;
                                _rest_3317085 = __tmp__._1?.__copy__();
                            };
                            if (_r_3317082 != null) {
                        ...
                        _re_3316681.rune = _r_3317082;
                        _t_3313981 = _rest_3317085?.__copy__();
                        _p_3313869._push(_re_3316681);
                        bigSwitchBreak = true;
                        _gotoNext = 3314032i32;
                    } else if (__value__ == (3317217i32)) {
                        _p_3313869._reuse(_re_3316681);
                        {
                            {
                                var __tmp__ = _p_3313869._parseEscape(_t_3313981?.__copy__());
                                _c_3313889 = __tmp__._0;
                                _t_3313981 = __tmp__._1?.__copy__();
                                _err = __tmp__._2;
                            };
                        ...
                        _p_3313869._concat();
                        if (_p_3313869._swapVerticalBar()) {
