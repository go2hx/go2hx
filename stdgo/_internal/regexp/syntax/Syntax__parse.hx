            ...
            while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
                {
                    ...
                    if (__value__ == (0i32)) {
                        ...
                        _p_3324869._literal(_c_3324889);
                        _gotoNext = 3328366i32;
                        ...
                        {
                            {
                                var __tmp__ = _p_3324869._parsePerlFlags(_t_3324981?.__copy__());
                        ...
                        _p_3324869._numCap++;
                        _p_3324869._op((128 : stdgo._internal.regexp.syntax.Syntax_Op.Op)).cap = _p_3324869._numCap;
                        _t_3324981 = (_t_3324981.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        _gotoNext = 3328366i32;
                    } else if (__value__ == (3325415i32)) {
                        {
                            _err = _p_3324869._parseVerticalBar();
                            if (_err != null) {
                        ...
                        {
                            _err = _p_3324869._parseRightParen();
                            if (_err != null) {
                        ...
                        _p_3324869._op((9 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _gotoNext = 3325711i32;
                    } else if (__value__ == (3325679i32)) {
                        _gotoNext = 3325679i32;
                        _p_3324869._op((7 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        var __blank__ = 0i32;
                        _gotoNext = 3325711i32;
                        ...
                        _p_3324869._op((10 : stdgo._internal.regexp.syntax.Syntax_Op.Op)).flags = (_p_3324869._op((10 : stdgo._internal.regexp.syntax.Syntax_Op.Op)).flags | ((256 : stdgo._internal.regexp.syntax.Syntax_Flags.Flags)) : stdgo._internal.regexp.syntax.Syntax_Flags.Flags);
                        _gotoNext = 3325841i32;
                    } else if (__value__ == (3325811i32)) {
                        _gotoNext = 3325811i32;
                        _p_3324869._op((8 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        var __blank__ = 0i32;
                        _gotoNext = 3325841i32;
                        ...
                        _p_3324869._op((6 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _gotoNext = 3325955i32;
                    } else if (__value__ == (3325920i32)) {
                        _gotoNext = 3325920i32;
                        _p_3324869._op((5 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        var __blank__ = 0i32;
                        _gotoNext = 3325955i32;
                        ...
                        {
                            {
                                var __tmp__ = _p_3324869._parseClass(_t_3324981?.__copy__());
                                _t_3324981 = __tmp__._0?.__copy__();
                                _err = __tmp__._1;
                            };
                            if (_err != null) {
                        ...
                        {
                            {
                                var __tmp__ = _p_3324869._repeat(_op_3324907, (0 : stdgo.GoInt), (0 : stdgo.GoInt), _before_3326072?.__copy__(), _after_3326197?.__copy__(), _lastRepeat_3324923?.__copy__());
                        ...
                        {
                            var __tmp__ = _p_3324869._parseRepeat(_t_3324981?.__copy__());
                        ...
                        _p_3324869._literal((123 : stdgo.GoInt32));
                        _t_3324981 = (_t_3324981.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        _gotoNext = 3328366i32;
                        ...
                        {
                            {
                                var __tmp__ = _p_3324869._repeat(_op_3324907, _min_3326395, _max_3326400, _before_3326380?.__copy__(), _after_3326405?.__copy__(), _lastRepeat_3324923?.__copy__());
                        ...
                        _p_3324869._op((11 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _t_3324981 = (_t_3324981.__slice__((2 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        bigSwitchBreak = true;
                        _gotoNext = 3325032i32;
                    } else if (__value__ == (3327130i32)) {
                        _p_3324869._op((12 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _t_3324981 = (_t_3324981.__slice__((2 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        bigSwitchBreak = true;
                        _gotoNext = 3325032i32;
                        ...
                        _p_3324869._literal(_c_3327448);
                        ...
                        _p_3324869._op((10 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _t_3324981 = (_t_3324981.__slice__((2 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        bigSwitchBreak = true;
                        _gotoNext = 3325032i32;
                    } else if (__value__ == (3327681i32)) {
                        _re_3327681 = _p_3324869._newRegexp((4 : stdgo._internal.regexp.syntax.Syntax_Op.Op));
                        _re_3327681.flags = _p_3324869._flags;
                        ...
                        {
                            var __tmp__ = _p_3324869._parseUnicodeClass(_t_3324981?.__copy__(), (_re_3327681.rune0.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>));
                        ...
                        _re_3327681.rune = _r_3327843;
                        _t_3324981 = _rest_3327846?.__copy__();
                        _p_3324869._push(_re_3327681);
                        bigSwitchBreak = true;
                        _gotoNext = 3325032i32;
                    } else if (__value__ == (3328079i32)) {
                        {
                            {
                                var __tmp__ = _p_3324869._parsePerlClassEscape(_t_3324981?.__copy__(), (_re_3327681.rune0.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt32>));
                        ...
                        _re_3327681.rune = _r_3328082;
                        _t_3324981 = _rest_3328085?.__copy__();
                        _p_3324869._push(_re_3327681);
                        bigSwitchBreak = true;
                        _gotoNext = 3325032i32;
                    } else if (__value__ == (3328217i32)) {
                        _p_3324869._reuse(_re_3327681);
                        {
                            {
                                var __tmp__ = _p_3324869._parseEscape(_t_3324981?.__copy__());
                                _c_3324889 = __tmp__._0;
                                _t_3324981 = __tmp__._1?.__copy__();
                                _err = __tmp__._2;
                            };
                        ...
                        _p_3324869._concat();
                        if (_p_3324869._swapVerticalBar()) {
