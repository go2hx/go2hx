        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 3449105i32;
                } else if (__value__ == (3449105i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3449112i32;
                } else if (__value__ == (3449112i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3449116i32;
                    } else {
                        _gotoNext = 3449326i32;
                    };
                } else if (__value__ == (3449116i32)) {
                    _gotoNext = 3449120i32;
                } else if (__value__ == (3449120i32)) {
                    {
                        ...
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3449136i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3449185i32;
                            ...
                            _gotoNext = 3449224i32;
                        } else {
                            _gotoNext = 3449264i32;
                        };
                    };
                } else if (__value__ == (3449136i32)) {
                    ...
                    _gotoNext = 3449293i32;
                } else if (__value__ == (3449185i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp);
                    _gotoNext = 3449293i32;
                } else if (__value__ == (3449224i32)) {
                    _gotoNext = 3449293i32;
                } else if (__value__ == (3449264i32)) {
                    loopBreak = true;
                    _gotoNext = 3449112i32;
                } else if (__value__ == (3449293i32)) {
                    _pc_43 = (@:checkr _i_44 ?? throw "null pointer dereference").out;
                    _i_44 = (stdgo.Go.setRef((@:checkr _p ?? throw "null pointer dereference").inst[(_pc_43 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_inst.Inst>);
                    _gotoNext = 3449112i32;
                } else if (__value__ == (3449326i32)) {
                    return _flag_42;
                    _gotoNext = -1i32;
                };
            };
