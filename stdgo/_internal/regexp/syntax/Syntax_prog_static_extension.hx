        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 3403104i32;
                } else if (__value__ == (3403104i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3403111i32;
                } else if (__value__ == (3403111i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3403115i32;
                    } else {
                        _gotoNext = 3403325i32;
                    };
                } else if (__value__ == (3403115i32)) {
                    _gotoNext = 3403119i32;
                } else if (__value__ == (3403119i32)) {
                    {
                        ...
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3403135i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3403184i32;
                            ...
                            _gotoNext = 3403223i32;
                        } else {
                            _gotoNext = 3403263i32;
                        };
                    };
                } else if (__value__ == (3403135i32)) {
                    ...
                    _gotoNext = 3403292i32;
                } else if (__value__ == (3403184i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp);
                    _gotoNext = 3403292i32;
                } else if (__value__ == (3403223i32)) {
                    _gotoNext = 3403292i32;
                } else if (__value__ == (3403263i32)) {
                    loopBreak = true;
                    _gotoNext = 3403111i32;
                } else if (__value__ == (3403292i32)) {
                    _pc_43 = (@:checkr _i_44 ?? throw "null pointer dereference").out;
                    _i_44 = (stdgo.Go.setRef((@:checkr _p ?? throw "null pointer dereference").inst[(_pc_43 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_inst.Inst>);
                    _gotoNext = 3403111i32;
                } else if (__value__ == (3403325i32)) {
                    return _flag_42;
                    _gotoNext = -1i32;
                };
            };
