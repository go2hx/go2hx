        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 3422210i32;
                } else if (__value__ == (3422210i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3422217i32;
                } else if (__value__ == (3422217i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3422221i32;
                    } else {
                        _gotoNext = 3422431i32;
                    };
                } else if (__value__ == (3422221i32)) {
                    _gotoNext = 3422225i32;
                } else if (__value__ == (3422225i32)) {
                    {
                        ...
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3422241i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3422290i32;
                            ...
                            _gotoNext = 3422329i32;
                        } else {
                            _gotoNext = 3422369i32;
                        };
                    };
                } else if (__value__ == (3422241i32)) {
                    ...
                    _gotoNext = 3422398i32;
                } else if (__value__ == (3422290i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp);
                    _gotoNext = 3422398i32;
                } else if (__value__ == (3422329i32)) {
                    _gotoNext = 3422398i32;
                } else if (__value__ == (3422369i32)) {
                    loopBreak = true;
                    _gotoNext = 3422217i32;
                } else if (__value__ == (3422398i32)) {
                    _pc_43 = (@:checkr _i_44 ?? throw "null pointer dereference").out;
                    _i_44 = (stdgo.Go.setRef((@:checkr _p ?? throw "null pointer dereference").inst[(_pc_43 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_inst.Inst>);
                    _gotoNext = 3422217i32;
                } else if (__value__ == (3422431i32)) {
                    return _flag_42;
                    _gotoNext = -1i32;
                };
            };
