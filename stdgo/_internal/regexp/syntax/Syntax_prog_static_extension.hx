        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 3494116i32;
                } else if (__value__ == (3494116i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3494123i32;
                } else if (__value__ == (3494123i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3494127i32;
                    } else {
                        _gotoNext = 3494337i32;
                    };
                } else if (__value__ == (3494127i32)) {
                    _gotoNext = 3494131i32;
                } else if (__value__ == (3494131i32)) {
                    {
                        ...
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3494147i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3494196i32;
                            ...
                            _gotoNext = 3494235i32;
                        } else {
                            _gotoNext = 3494275i32;
                        };
                    };
                } else if (__value__ == (3494147i32)) {
                    ...
                    _gotoNext = 3494304i32;
                } else if (__value__ == (3494196i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp);
                    _gotoNext = 3494304i32;
                } else if (__value__ == (3494235i32)) {
                    _gotoNext = 3494304i32;
                } else if (__value__ == (3494275i32)) {
                    loopBreak = true;
                    _gotoNext = 3494123i32;
                } else if (__value__ == (3494304i32)) {
                    _pc_43 = (@:checkr _i_44 ?? throw "null pointer dereference").out;
                    _i_44 = (stdgo.Go.setRef((@:checkr _p ?? throw "null pointer dereference").inst[(_pc_43 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_inst.Inst>);
                    _gotoNext = 3494123i32;
                } else if (__value__ == (3494337i32)) {
                    return _flag_42;
                    _gotoNext = -1i32;
                };
            };
