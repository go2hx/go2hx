        ...
        while (_gotoNext != ((-1i64 : stdgo.GoInt))) {
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    ...
                    _gotoNext = 3585210i64;
                } else if (__value__ == (3585210i64)) {
                    0i64;
                    loopBreak = false;
                    _gotoNext = 3585217i64;
                } else if (__value__ == (3585217i64)) {
                    //"file://#L0"
                    if (!loopBreak) {
                        _gotoNext = 3585221i64;
                    } else {
                        _gotoNext = 3585431i64;
                    };
                } else if (__value__ == (3585221i64)) {
                    _gotoNext = 3585225i64;
                } else if (__value__ == (3585225i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/regexp/syntax/prog.go#L175"
                    {
                        ...
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3585241i64;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3585290i64;
                            ...
                            _gotoNext = 3585329i64;
                        } else {
                            _gotoNext = 3585369i64;
                        };
                    };
                } else if (__value__ == (3585241i64)) {
                    ...
                    _gotoNext = 3585398i64;
                } else if (__value__ == (3585290i64)) {
                    ...
                    _gotoNext = 3585398i64;
                } else if (__value__ == (3585329i64)) {
                    _gotoNext = 3585398i64;
                } else if (__value__ == (3585369i64)) {
                    loopBreak = true;
                    _gotoNext = 3585217i64;
                } else if (__value__ == (3585398i64)) {
                    _pc_43 = (@:checkr _i_44 ?? throw "null pointer dereference").out;
                    _i_44 = (stdgo.Go.setRef((@:checkr _p ?? throw "null pointer dereference").inst[(_pc_43 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_inst.Inst>);
                    _gotoNext = 3585217i64;
                } else if (__value__ == (3585431i64)) {
