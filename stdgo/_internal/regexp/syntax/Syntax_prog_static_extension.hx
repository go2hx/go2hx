        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 3516825i32;
                } else if (__value__ == (3516825i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3516832i32;
                } else if (__value__ == (3516832i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3516836i32;
                    } else {
                        _gotoNext = 3517046i32;
                    };
                } else if (__value__ == (3516836i32)) {
                    _gotoNext = 3516840i32;
                } else if (__value__ == (3516840i32)) {
                    {
                        ...
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3516856i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3516905i32;
                            ...
                            _gotoNext = 3516944i32;
                        } else {
                            _gotoNext = 3516984i32;
                        };
                    };
                } else if (__value__ == (3516856i32)) {
                    ...
                    _gotoNext = 3517013i32;
                } else if (__value__ == (3516905i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp);
                    _gotoNext = 3517013i32;
                } else if (__value__ == (3516944i32)) {
                    _gotoNext = 3517013i32;
                } else if (__value__ == (3516984i32)) {
                    loopBreak = true;
                    _gotoNext = 3516832i32;
                } else if (__value__ == (3517013i32)) {
                    _pc_43 = (@:checkr _i_44 ?? throw "null pointer dereference").out;
                    _i_44 = (stdgo.Go.setRef((@:checkr _p ?? throw "null pointer dereference").inst[(_pc_43 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_inst.Inst>);
                    _gotoNext = 3516832i32;
                } else if (__value__ == (3517046i32)) {
                    return _flag_42;
                    _gotoNext = -1i32;
                };
            };
