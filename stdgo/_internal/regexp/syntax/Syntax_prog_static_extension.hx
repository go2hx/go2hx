        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 3579497i32;
                } else if (__value__ == (3579497i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3579504i32;
                } else if (__value__ == (3579504i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3579508i32;
                    } else {
                        _gotoNext = 3579718i32;
                    };
                } else if (__value__ == (3579508i32)) {
                    _gotoNext = 3579512i32;
                } else if (__value__ == (3579512i32)) {
                    {
                        ...
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3579528i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3579577i32;
                            ...
                            _gotoNext = 3579656i32;
                        };
                    };
                } else if (__value__ == (3579528i32)) {
                    ...
                    _gotoNext = 3579685i32;
                } else if (__value__ == (3579577i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp);
                    _gotoNext = 3579685i32;
                } else if (__value__ == (3579616i32)) {
                    _gotoNext = 3579685i32;
                } else if (__value__ == (3579656i32)) {
                    loopBreak = true;
                    _gotoNext = 3579504i32;
                } else if (__value__ == (3579685i32)) {
