        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 3375280i32;
                } else if (__value__ == (3375280i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3375287i32;
                } else if (__value__ == (3375287i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3375291i32;
                    } else {
                        _gotoNext = 3375501i32;
                    };
                } else if (__value__ == (3375291i32)) {
                ...
                } else if (__value__ == (3375295i32)) {
                    {
                        ...
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            ...
                            _gotoNext = 3375399i32;
                        } else {
                            _gotoNext = 3375439i32;
                        };
                    };
                } else if (__value__ == (3375311i32)) {
                    ...
                    _gotoNext = 3375468i32;
                } else if (__value__ == (3375399i32)) {
                    _gotoNext = 3375468i32;
                } else if (__value__ == (3375439i32)) {
                    loopBreak = true;
                    _gotoNext = 3375287i32;
