        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 3361396i32;
                } else if (__value__ == (3361396i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3361403i32;
                } else if (__value__ == (3361403i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3361407i32;
                    } else {
                        _gotoNext = 3361617i32;
                    };
                } else if (__value__ == (3361407i32)) {
                    _gotoNext = 3361411i32;
                } else if (__value__ == (3361411i32)) {
                    {
                        ...
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3361427i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3361476i32;
                            ...
                            _gotoNext = 3361515i32;
                        } else {
                            _gotoNext = 3361555i32;
                        };
                    };
                } else if (__value__ == (3361427i32)) {
                    ...
                    _gotoNext = 3361584i32;
                } else if (__value__ == (3361476i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp);
                    _gotoNext = 3361584i32;
                } else if (__value__ == (3361515i32)) {
                    _gotoNext = 3361584i32;
                } else if (__value__ == (3361555i32)) {
                    loopBreak = true;
                    _gotoNext = 3361403i32;
                } else if (__value__ == (3361584i32)) {
                    _pc_43 = (@:checkr _i_44 ?? throw "null pointer dereference").out;
                    _i_44 = (stdgo.Go.setRef((@:checkr _p ?? throw "null pointer dereference").inst[(_pc_43 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_inst.Inst>);
                    _gotoNext = 3361403i32;
                } else if (__value__ == (3361617i32)) {
                    return _flag_42;
                    _gotoNext = -1i32;
                };
            };
