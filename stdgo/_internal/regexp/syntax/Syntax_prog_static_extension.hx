        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 3312323i32;
                } else if (__value__ == (3312323i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3312330i32;
                } else if (__value__ == (3312330i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3312334i32;
                    } else {
                        _gotoNext = 3312544i32;
                    };
                } else if (__value__ == (3312334i32)) {
                    _gotoNext = 3312338i32;
                } else if (__value__ == (3312338i32)) {
                    {
                        ...
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3312354i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3312403i32;
                            ...
                            _gotoNext = 3312442i32;
                        } else {
                            _gotoNext = 3312482i32;
                        };
                    };
                } else if (__value__ == (3312354i32)) {
                    ...
                    _gotoNext = 3312511i32;
                } else if (__value__ == (3312403i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp);
                    _gotoNext = 3312511i32;
                } else if (__value__ == (3312442i32)) {
                    _gotoNext = 3312511i32;
                } else if (__value__ == (3312482i32)) {
                    loopBreak = true;
                    _gotoNext = 3312330i32;
                } else if (__value__ == (3312511i32)) {
                    _pc_43 = (@:checkr _i_44 ?? throw "null pointer dereference").out;
                    _i_44 = (stdgo.Go.setRef((@:checkr _p ?? throw "null pointer dereference").inst[(_pc_43 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_inst.Inst>);
                    _gotoNext = 3312330i32;
                } else if (__value__ == (3312544i32)) {
                    return _flag_42;
                    _gotoNext = -1i32;
                };
            };
