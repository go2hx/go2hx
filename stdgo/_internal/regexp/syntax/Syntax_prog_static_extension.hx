        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 3336777i32;
                } else if (__value__ == (3336777i32)) {
                    0i32;
                    loopBreak = false;
                    _gotoNext = 3336784i32;
                } else if (__value__ == (3336784i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3336788i32;
                    } else {
                        _gotoNext = 3336998i32;
                    };
                } else if (__value__ == (3336788i32)) {
                    _gotoNext = 3336792i32;
                } else if (__value__ == (3336792i32)) {
                    {
                        ...
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3336808i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3336857i32;
                            ...
                            _gotoNext = 3336896i32;
                        } else {
                            _gotoNext = 3336936i32;
                        };
                    };
                } else if (__value__ == (3336808i32)) {
                ...
                } else if (__value__ == (3336857i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp);
                    _gotoNext = 3336965i32;
                } else if (__value__ == (3336896i32)) {
                    _gotoNext = 3336965i32;
                } else if (__value__ == (3336936i32)) {
                    loopBreak = true;
                    _gotoNext = 3336784i32;
