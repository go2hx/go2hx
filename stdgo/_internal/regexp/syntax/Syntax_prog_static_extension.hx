        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 3279757i32;
                } else if (__value__ == (3279757i32)) {
                    0i32;
                    loopBreak = false;
                    _gotoNext = 3279764i32;
                } else if (__value__ == (3279764i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3279768i32;
                    } else {
                        _gotoNext = 3279978i32;
                    };
                } else if (__value__ == (3279768i32)) {
                    _gotoNext = 3279772i32;
                } else if (__value__ == (3279772i32)) {
                    {
                        ...
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            ...
                            _gotoNext = 3279876i32;
                        } else {
                            _gotoNext = 3279916i32;
                        };
                    };
                } else if (__value__ == (3279788i32)) {
