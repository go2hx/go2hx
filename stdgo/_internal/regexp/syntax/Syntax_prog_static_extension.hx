...
@:keep @:allow(stdgo._internal.regexp.syntax.Syntax.Prog_asInterface) class Prog_static_extension {
    ...
    static public function startCond( _p:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_prog.Prog>):stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp {
        ...
        var _pc_3520658:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        var _flag_3520644:stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp = ((0 : stdgo.GoUInt8) : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp);
        var loopBreak = false;
        var _i_3520681:stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_inst.Inst> = (null : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_inst.Inst>);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _pc_3520658 = ((@:checkr _p ?? throw "null pointer dereference").start : stdgo.GoUInt32);
                    _i_3520681 = (stdgo.Go.setRef((@:checkr _p ?? throw "null pointer dereference").inst[(_pc_3520658 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_inst.Inst>);
                    _gotoNext = 3520698i32;
                } else if (__value__ == (3520698i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3520705i32;
                } else if (__value__ == (3520705i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3520709i32;
                    } else {
                        _gotoNext = 3520919i32;
                    };
                } else if (__value__ == (3520709i32)) {
                    _gotoNext = 3520713i32;
                } else if (__value__ == (3520713i32)) {
                    {
                        final __value__ = (@:checkr _i_3520681 ?? throw "null pointer dereference").op;
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3520729i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3520778i32;
                            ...
                            _gotoNext = 3520817i32;
                        } else {
                            _gotoNext = 3520857i32;
                        };
                    };
                } else if (__value__ == (3520729i32)) {
                    _flag_3520644 = (_flag_3520644 | (((@:checkr _i_3520681 ?? throw "null pointer dereference").arg : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp)) : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp);
                    _gotoNext = 3520886i32;
                } else if (__value__ == (3520778i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp);
                    _gotoNext = 3520886i32;
                } else if (__value__ == (3520817i32)) {
                    _gotoNext = 3520886i32;
                } else if (__value__ == (3520857i32)) {
                    loopBreak = true;
                    _gotoNext = 3520705i32;
                } else if (__value__ == (3520886i32)) {
                    _pc_3520658 = (@:checkr _i_3520681 ?? throw "null pointer dereference").out;
                    _i_3520681 = (stdgo.Go.setRef((@:checkr _p ?? throw "null pointer dereference").inst[(_pc_3520658 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_inst.Inst>);
                    _gotoNext = 3520705i32;
                } else if (__value__ == (3520919i32)) {
                    return _flag_3520644;
                    _gotoNext = -1i32;
                };
            };
        };
