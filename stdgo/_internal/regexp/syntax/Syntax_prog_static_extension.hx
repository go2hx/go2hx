        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 3460287i32;
                } else if (__value__ == (3460287i32)) {
                    var __blank__ = 0i32;
                    loopBreak = false;
                    _gotoNext = 3460294i32;
                } else if (__value__ == (3460294i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3460298i32;
                    } else {
                        _gotoNext = 3460508i32;
                    };
                } else if (__value__ == (3460298i32)) {
                    _gotoNext = 3460302i32;
                } else if (__value__ == (3460302i32)) {
                    {
                        ...
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3460318i32;
                        } else if (__value__ == ((5 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            _gotoNext = 3460367i32;
                            ...
                            _gotoNext = 3460406i32;
                        } else {
                            _gotoNext = 3460446i32;
                        };
                    };
                } else if (__value__ == (3460318i32)) {
