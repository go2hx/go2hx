        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 3593650i32;
                } else if (__value__ == (3593650i32)) {
                    0i32;
                    loopBreak = false;
                    _gotoNext = 3593657i32;
                } else if (__value__ == (3593657i32)) {
                    if (!loopBreak) {
                        _gotoNext = 3593661i32;
                    } else {
                        _gotoNext = 3593871i32;
                    };
                } else if (__value__ == (3593661i32)) {
                    _gotoNext = 3593665i32;
                } else if (__value__ == (3593665i32)) {
                    {
                        ...
                        if (__value__ == ((3 : stdgo._internal.regexp.syntax.Syntax_instop.InstOp))) {
                            ...
                            _gotoNext = 3593769i32;
                        } else {
                            _gotoNext = 3593809i32;
                        };
                    };
                    ...
                    _gotoNext = 3593838i32;
                } else if (__value__ == (3593730i32)) {
                    return (255 : stdgo._internal.regexp.syntax.Syntax_emptyop.EmptyOp);
                    _gotoNext = 3593838i32;
                } else if (__value__ == (3593769i32)) {
                    _gotoNext = 3593838i32;
                } else if (__value__ == (3593809i32)) {
                    loopBreak = true;
                    _gotoNext = 3593657i32;
                } else if (__value__ == (3593838i32)) {
                    _pc_43 = (@:checkr _i_44 ?? throw "null pointer dereference").out;
                    _i_44 = (stdgo.Go.setRef((@:checkr _p ?? throw "null pointer dereference").inst[(_pc_43 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.regexp.syntax.Syntax_inst.Inst>);
                    _gotoNext = 3593657i32;
                } else if (__value__ == (3593871i32)) {
                    return _flag_42;
                    _gotoNext = -1i32;
                };
            };
