...
(new stdgo._internal.testing.Testing.InternalTest(("TestSimplify" : stdgo.GoString), stdgo._internal.regexp.syntax.Syntax.testSimplify) : stdgo._internal.testing.Testing.InternalTest)]) : stdgo.Slice<stdgo._internal.testing.Testing.InternalTest>);
var _benchmarks : stdgo.Slice<stdgo._internal.testing.Testing.InternalBenchmark> = (new stdgo.Slice<stdgo._internal.testing.Testing.InternalBenchmark>(2, 2, ...[(new stdgo._internal.testing.Testing.InternalBenchmark(("BenchmarkEmptyOpContext" : stdgo.GoString), stdgo._internal.regexp.syntax.Syntax.benchmarkEmptyOpContext) : stdgo._internal.testing.Testing.InternalBenchmark), (new stdgo._internal.testing.Testing.InternalBenchmark(("BenchmarkIsWordChar" : stdgo.GoString), stdgo._internal.regexp.syntax.Syntax.benchmarkIsWordChar) : stdgo._internal.testing.Testing.InternalBenchmark)]) : stdgo.Slice<stdgo._internal.testing.Testing.InternalBenchmark>);
