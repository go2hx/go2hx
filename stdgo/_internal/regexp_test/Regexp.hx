...
(new stdgo._internal.testing.Testing.InternalTest(("TestRunOnePass" : stdgo.GoString), stdgo._internal.regexp.Regexp.testRunOnePass) : stdgo._internal.testing.Testing.InternalTest)) : stdgo.Slice<stdgo._internal.testing.Testing.InternalTest>);
...
(new stdgo._internal.testing.Testing.InternalBenchmark(("BenchmarkMatch_onepass_regex" : stdgo.GoString), stdgo._internal.regexp.Regexp.benchmarkMatch_onepass_regex) : stdgo._internal.testing.Testing.InternalBenchmark)) : stdgo.Slice<stdgo._internal.testing.Testing.InternalBenchmark>);
