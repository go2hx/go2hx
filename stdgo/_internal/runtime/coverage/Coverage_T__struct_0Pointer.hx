...
@:keep @:follow @:using(stdgo._internal.runtime.coverage.Coverage_T__struct_0_static_extension.T__struct_0_static_extension) @:using(stdgo._internal.runtime.coverage.Coverage_T__struct_0Pointer_static_extension.T__struct_0Pointer_static_extension) typedef T__struct_0Pointer = stdgo.Pointer<stdgo._internal.runtime.coverage.Coverage_T__struct_0.T__struct_0>;
