...
@:keep @:allow(stdgo._internal.runtime.coverage.Coverage.T_emitState_asInterface) class T_emitState_static_extension {
    ...
    static public function _emitCounterDataFile( _s:stdgo.Ref<stdgo._internal.runtime.coverage.Coverage_t_emitstate.T_emitState>, _finalHash:stdgo.GoArray<stdgo.GoUInt8>, _w:stdgo._internal.io.Io_writer.Writer):stdgo.Error {
        ...
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L584"
        {
            var _err = (_cfw.write(_finalHash?.__copy__(), stdgo._internal.runtime.coverage.Coverage__capturedosargs._capturedOsArgs, stdgo.Go.asInterface(_s)) : stdgo.Error);
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L585"
                return _err;
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L587"
    ...
    static public function visitFuncs( _s:stdgo.Ref<stdgo._internal.runtime.coverage.Coverage_t_emitstate.T_emitState>, _f:stdgo._internal.internal.coverage.encodecounter.Encodecounter_countervisitorfn.CounterVisitorFn):stdgo.Error {
        ...
        var _rdCounters = function(_actrs:stdgo.Slice<stdgo._internal.sync.atomic_.Atomic__uint32.Uint32>, _ctrs:stdgo.Slice<stdgo.GoUInt32>):stdgo.Slice<stdgo.GoUInt32> {
            ...
            //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L473"
            for (_i => _ in _actrs) {
                _ctrs = (_ctrs.__append__(_actrs[(_i : stdgo.GoInt)].load()) : stdgo.Slice<stdgo.GoUInt32>);
            };
            //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L476"
            return _ctrs;
        };
        var _dpkg = ((0u32 : stdgo.GoUInt32) : stdgo.GoUInt32);
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L480"
        for (__7 => _c in (@:checkr _s ?? throw "null pointer dereference")._counterlist) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L484"
            {
                var _i = (0 : stdgo.GoInt);
                while ((_i < (_sd.length) : Bool)) {
                    var _sdi = (_sd[(_i : stdgo.GoInt)].load() : stdgo.GoUInt32);
//"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L487"
                    if (_sdi == ((0u32 : stdgo.GoUInt32))) {
                        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L488"
                        {
                            _i++;
                            continue;
                        };
...
var _pkgId = (_sd[(_i + (1 : stdgo.GoInt) : stdgo.GoInt)].load() : stdgo.GoUInt32);
var _funcId = (_sd[(_i + (2 : stdgo.GoInt) : stdgo.GoInt)].load() : stdgo.GoUInt32);
...
//"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L502"
                    {
                        var _i = (0 : stdgo.GoInt);
                        while ((_i < (_counters.length) : Bool)) {
                            //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L503"
                            if (_counters[(_i : stdgo.GoInt)].load() != ((0u32 : stdgo.GoUInt32))) {
                                _isLive = true;
                                //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L505"
                                break;
                            };
                            _i++;
                        };
                    };
//"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L508"
                    if (!_isLive) {
                        _i = (_i + ((((3 : stdgo.GoInt) + (_nCtrs : stdgo.GoInt) : stdgo.GoInt) - (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.GoInt);
                        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L511"
                        {
                            _i++;
                            continue;
                        };
                    };
//"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L514"
                    if ((@:checkr _s ?? throw "null pointer dereference")._debug) {
                        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L515"
                        if (_pkgId != (_dpkg)) {
                            _dpkg = _pkgId;
                            //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L517"
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L520"
...
//"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L530"
                    if (_ipk == ((0 : stdgo.GoInt32))) {
                        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L531"
                        stdgo._internal.fmt.Fmt_fprintf.fprintf(stdgo.Go.asInterface(stdgo._internal.os.Os_stderr.stderr), ("\n" : stdgo.GoString));
                        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L532"
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L534"
                        {
                            ...
                            if (_ok) {
                                ...
                                //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L537"
                                stdgo._internal.fmt.Fmt_fprintf.fprintf(stdgo.Go.asInterface(stdgo._internal.os.Os_stderr.stderr), ("\n" : stdgo.GoString));
                                //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L538"
                                stdgo._internal.runtime.coverage.Coverage__reporterrorinhardcodedlist._reportErrorInHardcodedList((_i : stdgo.GoInt32), _ipk, _funcId, _nCtrs);
                            };
                        };
                    } else {
                        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L546"
                        _pkgId--;
                    };
_tcounters = _rdCounters(_counters, _tcounters);
//"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L550"
                    {
                        var _err = (_f(_pkgId, _funcId, _tcounters) : stdgo.Error);
                        if (_err != null) {
                            //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L551"
                            return _err;
                        };
                    };
_i = (_i + ((((3 : stdgo.GoInt) + (_nCtrs : stdgo.GoInt) : stdgo.GoInt) - (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.GoInt);
            ...
            //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L557"
            if ((@:checkr _s ?? throw "null pointer dereference")._debug) {
                //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L558"
                stdgo._internal.fmt.Fmt_fprintf.fprintf(stdgo.Go.asInterface(stdgo._internal.os.Os_stderr.stderr), ("\n" : stdgo.GoString));
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L561"
        return (null : stdgo.Error);
    }
    @:keep
    @:tdfield
    static public function _needMetaDataFile( _s:stdgo.Ref<stdgo._internal.runtime.coverage.Coverage_t_emitstate.T_emitState>):Bool {
        @:recv var _s:stdgo.Ref<stdgo._internal.runtime.coverage.Coverage_t_emitstate.T_emitState> = _s;
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L444"
        return ({
    ...
    static public function _emitMetaDataFile( _s:stdgo.Ref<stdgo._internal.runtime.coverage.Coverage_t_emitstate.T_emitState>, _finalHash:stdgo.GoArray<stdgo.GoUInt8>, _tlen:stdgo.GoUInt64):stdgo.Error {
        @:recv var _s:stdgo.Ref<stdgo._internal.runtime.coverage.Coverage_t_emitstate.T_emitState> = _s;
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L424"
        {
            ...
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L425"
        ...
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L427"
        {
            var _err = ((@:checkr _s ?? throw "null pointer dereference")._mf.close() : stdgo.Error);
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L428"
                return stdgo._internal.fmt.Fmt_errorf.errorf(("closing meta data temp file: %v" : stdgo.GoString), stdgo.Go.toInterface(_err));
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L433"
        {
            ...
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L434"
        ...
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L437"
        return (null : stdgo.Error);
    }
    @:keep
    @:tdfield
    static public function _openOutputFiles( _s:stdgo.Ref<stdgo._internal.runtime.coverage.Coverage_t_emitstate.T_emitState>, _metaHash:stdgo.GoArray<stdgo.GoUInt8>, _metaLen:stdgo.GoUInt64, _which:stdgo._internal.runtime.coverage.Coverage_t_filetype.T_fileType):stdgo.Error {
        ...
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L400"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L401"
        ...
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L403"
        if (!_fi.isDir()) {
            //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L404"
        ...
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L407"
        if (((_which & (2 : stdgo._internal.runtime.coverage.Coverage_t_filetype.T_fileType) : stdgo._internal.runtime.coverage.Coverage_t_filetype.T_fileType)) != ((0 : stdgo._internal.runtime.coverage.Coverage_t_filetype.T_fileType))) {
            //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L408"
            {
                var _err = (_s._openMetaFile(_metaHash?.__copy__(), _metaLen) : stdgo.Error);
                if (_err != null) {
                    //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L409"
                    return _err;
                };
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L412"
        if (((_which & (4 : stdgo._internal.runtime.coverage.Coverage_t_filetype.T_fileType) : stdgo._internal.runtime.coverage.Coverage_t_filetype.T_fileType)) != ((0 : stdgo._internal.runtime.coverage.Coverage_t_filetype.T_fileType))) {
            //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L413"
            {
                var _err = (_s._openCounterFile(_metaHash?.__copy__()) : stdgo.Error);
                if (_err != null) {
                    //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L414"
                    return _err;
                };
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L417"
        return (null : stdgo.Error);
    }
    @:keep
    @:tdfield
    static public function _openCounterFile( _s:stdgo.Ref<stdgo._internal.runtime.coverage.Coverage_t_emitstate.T_emitState>, _metaHash:stdgo.GoArray<stdgo.GoUInt8>):stdgo.Error {
        ...
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L381"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L382"
        ...
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L384"
        return (null : stdgo.Error);
    }
    @:keep
    @:tdfield
    static public function _openMetaFile( _s:stdgo.Ref<stdgo._internal.runtime.coverage.Coverage_t_emitstate.T_emitState>, _metaHash:stdgo.GoArray<stdgo.GoUInt8>, _metaLen:stdgo.GoUInt64):stdgo.Error {
        ...
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L359"
        if (((_err != null) || (_fi.size() != (_metaLen : stdgo.GoInt64)) : Bool)) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L364"
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L365"
        ...
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L368"
        return (null : stdgo.Error);
    }
    @:keep
    @:tdfield
    static public function _emitCounterDataToWriter( _s:stdgo.Ref<stdgo._internal.runtime.coverage.Coverage_t_emitstate.T_emitState>, _w:stdgo._internal.io.Io_writer.Writer):stdgo.Error {
        @:recv var _s:stdgo.Ref<stdgo._internal.runtime.coverage.Coverage_t_emitstate.T_emitState> = _s;
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L342"
        {
            var _err = (_s._emitCounterDataFile(stdgo._internal.runtime.coverage.Coverage__finalhash._finalHash?.__copy__(), _w) : stdgo.Error);
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L343"
                return _err;
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/runtime/coverage/emit.go#L345"
        return (null : stdgo.Error);
    }
}
