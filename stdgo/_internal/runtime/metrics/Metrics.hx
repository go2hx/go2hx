...
@:keep var __init_go2hx__ = {
        try {
            ...
            //"file:///home/runner/.go/go1.21.3/src/runtime/metrics/description.go#L430"
            while (((_i < (stdgo._internal.runtime.metrics.Metrics__alldesc._allDesc.length) : Bool) && (stdgo._internal.runtime.metrics.Metrics__alldesc._allDesc[(_i : stdgo.GoInt)].name < ("/godebug/" : stdgo.GoString) : Bool) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/runtime/metrics/description.go#L431"
                _i++;
            };
            ...
            //"file:///home/runner/.go/go1.21.3/src/runtime/metrics/description.go#L434"
            _more.__copyTo__(stdgo._internal.runtime.metrics.Metrics__alldesc._allDesc);
            //"file:///home/runner/.go/go1.21.3/src/runtime/metrics/description.go#L435"
            for (__0 => _info in stdgo._internal.internal.godebugs.Godebugs_all.all) {
                //"file:///home/runner/.go/go1.21.3/src/runtime/metrics/description.go#L436"
                if (!_info.opaque) {
                    _more = (_more.__append__(({ name : ((("/godebug/non-default-behavior/" : stdgo.GoString) + _info.name?.__copy__() : stdgo.GoString) + (":events" : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__(), description : ((((((("The number of non-default behaviors executed by the " : stdgo.GoString) + _info.package_?.__copy__() : stdgo.GoString) + (" package " : stdgo.GoString)?.__copy__() : stdgo.GoString) + ("due to a non-default " : stdgo.GoString)?.__copy__() : stdgo.GoString) + ("GODEBUG=" : stdgo.GoString)?.__copy__() : stdgo.GoString) + _info.name?.__copy__() : stdgo.GoString) + ("=... setting." : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__(), kind : (1 : stdgo._internal.runtime.metrics.Metrics_valuekind.ValueKind), cumulative : true } : stdgo._internal.runtime.metrics.Metrics_description.Description)) : stdgo.Slice<stdgo._internal.runtime.metrics.Metrics_description.Description>);
                };
            };
            stdgo._internal.runtime.metrics.Metrics__alldesc._allDesc = (_more.__append__(...((stdgo._internal.runtime.metrics.Metrics__alldesc._allDesc.__slice__(_i) : stdgo.Slice<stdgo._internal.runtime.metrics.Metrics_description.Description>) : Array<stdgo._internal.runtime.metrics.Metrics_description.Description>)) : stdgo.Slice<stdgo._internal.runtime.metrics.Metrics_description.Description>);
