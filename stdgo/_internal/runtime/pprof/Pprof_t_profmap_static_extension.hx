...
@:keep @:allow(stdgo._internal.runtime.pprof.Pprof.T_profMap_asInterface) class T_profMap_static_extension {
    ...
    static public function _lookup( _m:stdgo.Ref<stdgo._internal.runtime.pprof.Pprof_t_profmap.T_profMap>, _stk:stdgo.Slice<stdgo.GoUInt64>, _tag:stdgo._internal.unsafe.Unsafe.UnsafePointer):stdgo.Ref<stdgo._internal.runtime.pprof.Pprof_t_profmapentry.T_profMapEntry> {
        ...
        var _h_3830208:stdgo.GoUIntptr = new stdgo.GoUIntptr(0);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _h_3830208 = (new stdgo.GoUIntptr((new stdgo.GoUIntptr(0) : stdgo.GoUIntptr)) : stdgo.GoUIntptr);
                    ...
                    _h_3830208 = ((_h_3830208 << (8i64 : stdgo.GoUInt64) : stdgo.GoUIntptr) | ((_h_3830208 >> (new stdgo.GoUIntptr(24) : stdgo.GoUIntptr) : stdgo.GoUIntptr)) : stdgo.GoUIntptr);
                    _h_3830208 = (_h_3830208 + (((new stdgo.GoUIntptr(_x_3830232) : stdgo.GoUIntptr) * (new stdgo.GoUIntptr(41) : stdgo.GoUIntptr) : stdgo.GoUIntptr)) : stdgo.GoUIntptr);
                    _i_3830237_0++;
                    ...
                    _h_3830208 = ((_h_3830208 << (8i64 : stdgo.GoUInt64) : stdgo.GoUIntptr) | ((_h_3830208 >> (new stdgo.GoUIntptr(24) : stdgo.GoUIntptr) : stdgo.GoUIntptr)) : stdgo.GoUIntptr);
                    _h_3830208 = (_h_3830208 + (((new stdgo.GoUIntptr(_tag) : stdgo.GoUIntptr) * (new stdgo.GoUIntptr(41) : stdgo.GoUIntptr) : stdgo.GoUIntptr)) : stdgo.GoUIntptr);
                    _gotoNext = 3830448i32;
                } else if (__value__ == (3830448i32)) {
                    _e_3830461 = ((@:checkr _m ?? throw "null pointer dereference")._hash[_h_3830208] ?? (null : stdgo.Ref<stdgo._internal.runtime.pprof.Pprof_t_profmapentry.T_profMapEntry>));
                    searchBreak = false;
                    ...
                    if ((((@:checkr _e_3830461 ?? throw "null pointer dereference")._stk.length != (_stk.length)) || ((@:checkr _e_3830461 ?? throw "null pointer dereference")._tag != _tag) : Bool)) {
                ...
                } else if (__value__ == (3830557i32)) {
                    {
                        ...
                        final __tmp__1 = (@:checkr _e_3830461 ?? throw "null pointer dereference")._nextHash;
                    ...
                    if ((@:checkr _e_3830461 ?? throw "null pointer dereference")._stk[(_j_3830581 : stdgo.GoInt)] != ((new stdgo.GoUIntptr(_stk[(_j_3830581 : stdgo.GoInt)]) : stdgo.GoUIntptr))) {
                    ...
                    (@:checkr _last_3830429 ?? throw "null pointer dereference")._nextHash = (@:checkr _e_3830461 ?? throw "null pointer dereference")._nextHash;
                    (@:checkr _e_3830461 ?? throw "null pointer dereference")._nextHash = ((@:checkr _m ?? throw "null pointer dereference")._hash[_h_3830208] ?? (null : stdgo.Ref<stdgo._internal.runtime.pprof.Pprof_t_profmapentry.T_profMapEntry>));
                    (@:checkr _m ?? throw "null pointer dereference")._hash[_h_3830208] = _e_3830461;
                    _gotoNext = 3830781i32;
                    ...
                    _e_3830876 = (stdgo.Go.setRef((@:checkr _m ?? throw "null pointer dereference")._free[(0 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.runtime.pprof.Pprof_t_profmapentry.T_profMapEntry>);
                    ...
                    (@:checkr _e_3830876 ?? throw "null pointer dereference")._nextHash = ((@:checkr _m ?? throw "null pointer dereference")._hash[_h_3830208] ?? (null : stdgo.Ref<stdgo._internal.runtime.pprof.Pprof_t_profmapentry.T_profMapEntry>));
                    (@:checkr _e_3830876 ?? throw "null pointer dereference")._tag = _tag;
                    ...
                    (@:checkr _e_3830876 ?? throw "null pointer dereference")._stk = ((@:checkr _m ?? throw "null pointer dereference")._freeStk.__slice__(0, (_stk.length), (_stk.length)) : stdgo.Slice<stdgo.GoUIntptr>);
                    ...
                    (@:checkr _e_3830876 ?? throw "null pointer dereference")._stk[(_j_3831158 : stdgo.GoInt)] = (new stdgo.GoUIntptr(_stk[(_j_3831158 : stdgo.GoInt)]) : stdgo.GoUIntptr);
                    _j_3831158++;
                    ...
                    (@:checkr _m ?? throw "null pointer dereference")._hash[_h_3830208] = _e_3830876;
                    ...
                    (@:checkr _m ?? throw "null pointer dereference")._all = _e_3830876;
                    (@:checkr _m ?? throw "null pointer dereference")._last = _e_3830876;
                    _gotoNext = 3831380i32;
                } else if (__value__ == (3831340i32)) {
                    _gotoNext = 3831340i32;
                    (@:checkr (@:checkr _m ?? throw "null pointer dereference")._last ?? throw "null pointer dereference")._nextAll = _e_3830876;
                    (@:checkr _m ?? throw "null pointer dereference")._last = _e_3830876;
                    var __blank__ = 0i32;
                    _gotoNext = 3831380i32;
