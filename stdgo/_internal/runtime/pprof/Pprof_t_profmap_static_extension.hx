...
@:keep @:allow(stdgo._internal.runtime.pprof.Pprof.T_profMap_asInterface) class T_profMap_static_extension {
    ...
    static public function _lookup( _m:stdgo.Ref<stdgo._internal.runtime.pprof.Pprof_t_profmap.T_profMap>, _stk:stdgo.Slice<stdgo.GoUInt64>, _tag:stdgo._internal.unsafe.Unsafe.UnsafePointer):stdgo.Ref<stdgo._internal.runtime.pprof.Pprof_t_profmapentry.T_profMapEntry> {
        ...
        var _i_3861557_1:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < (_stk.length)) {
                        _gotoNext = 3861641i32;
                    } else {
                        _gotoNext = 3861645i32;
                    };
                } else if (__value__ == (3861567i32)) {
                    _x_2 = _stk[(_i_3861557_1 : stdgo.GoInt)];
                    ...
                    _i_3861557_1++;
                    _gotoNext = 3861642i32;
                } else if (__value__ == (3861641i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _stk[(0i32 : stdgo.GoInt)];
                        _i_3861557_1 = __tmp__0;
                        _x_2 = __tmp__1;
                    };
                    _gotoNext = 3861642i32;
                } else if (__value__ == (3861642i32)) {
                    if (_i_3861557_1 < (_stk.length)) {
                        _gotoNext = 3861567i32;
                    } else {
                        _gotoNext = 3861645i32;
                    };
                } else if (__value__ == (3861645i32)) {
                    _h_0 = ((_h_0 << (8i64 : stdgo.GoUInt64) : stdgo.GoUIntptr) | ((_h_0 >> (new stdgo.GoUIntptr(24) : stdgo.GoUIntptr) : stdgo.GoUIntptr)) : stdgo.GoUIntptr);
                    ...
                    _gotoNext = 3861768i32;
                } else if (__value__ == (3861768i32)) {
                    ...
                    searchBreak = false;
                    _gotoNext = 3861777i32;
                } else if (__value__ == (3861777i32)) {
                    if (!searchBreak && ((_e_4 != null && ((_e_4 : Dynamic).__nil__ == null || !(_e_4 : Dynamic).__nil__)))) {
                        _gotoNext = 3861831i32;
                    } else {
                        _gotoNext = 3862134i32;
                    };
                } else if (__value__ == (3861831i32)) {
                    if ((((@:checkr _e_4 ?? throw "null pointer dereference")._stk.length != (_stk.length)) || ((@:checkr _e_4 ?? throw "null pointer dereference")._tag != _tag) : Bool)) {
                        _gotoNext = 3861877i32;
                    } else {
                        _gotoNext = 3861897i32;
                    };
                } else if (__value__ == (3861877i32)) {
                    {
                        final __tmp__0 = _e_4;
                    ...
                    _gotoNext = 3861777i32;
                } else if (__value__ == (3861897i32)) {
                    if ((0i32 : stdgo.GoInt) < (_stk.length)) {
                        _gotoNext = 3861980i32;
                    } else {
                        _gotoNext = 3862005i32;
                    };
                } else if (__value__ == (3861901i32)) {
                    _j_5++;
                    _gotoNext = 3861981i32;
                } else if (__value__ == (3861916i32)) {
                    if ((@:checkr _e_4 ?? throw "null pointer dereference")._stk[(_j_5 : stdgo.GoInt)] != ((new stdgo.GoUIntptr(_stk[(_j_5 : stdgo.GoInt)]) : stdgo.GoUIntptr))) {
                        _gotoNext = 3861952i32;
                    } else {
                        _gotoNext = 3861901i32;
                    };
                } else if (__value__ == (3861952i32)) {
                    {
                        final __tmp__0 = _e_4;
                        final __tmp__1 = (@:checkr _e_4 ?? throw "null pointer dereference")._nextHash;
                        _last_3 = __tmp__0;
                    ...
                    _j_5 = 0i32;
                    _gotoNext = 3861981i32;
                } else if (__value__ == (3861981i32)) {
                    if (_j_5 < (_stk.length)) {
                        _gotoNext = 3861916i32;
                    } else {
                        _gotoNext = 3862005i32;
                    };
                } else if (__value__ == (3862005i32)) {
                    if ((_last_3 != null && ((_last_3 : Dynamic).__nil__ == null || !(_last_3 : Dynamic).__nil__))) {
                        _gotoNext = 3862020i32;
                    } else {
                        _gotoNext = 3862101i32;
                    };
                } else if (__value__ == (3862020i32)) {
                    ...
                    _gotoNext = 3861777i32;
                } else if (__value__ == (3862134i32)) {
                    if ((((@:checkr _m ?? throw "null pointer dereference")._free.length) < (1 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3862153i32;
                    } else {
                        _gotoNext = 3862196i32;
                    };
                } else if (__value__ == (3862153i32)) {
                    ...
                    if ((((@:checkr _m ?? throw "null pointer dereference")._freeStk.length) < (_stk.length) : Bool)) {
                        _gotoNext = 3862301i32;
                    } else {
                        _gotoNext = 3862400i32;
                    };
                } else if (__value__ == (3862301i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < (_stk.length)) {
                        _gotoNext = 3862524i32;
                    } else {
                        _gotoNext = 3862528i32;
                    };
                } else if (__value__ == (3862493i32)) {
                    ...
                    _j_7++;
                    _gotoNext = 3862525i32;
                } else if (__value__ == (3862524i32)) {
                    _j_7 = 0i32;
                    _gotoNext = 3862525i32;
                } else if (__value__ == (3862525i32)) {
                    if (_j_7 < (_stk.length)) {
                        _gotoNext = 3862493i32;
                    } else {
                        _gotoNext = 3862528i32;
                    };
                } else if (__value__ == (3862528i32)) {
                    if ((@:checkr _m ?? throw "null pointer dereference")._hash == null) {
                        _gotoNext = 3862545i32;
                    } else {
                        _gotoNext = 3862594i32;
                    };
                } else if (__value__ == (3862545i32)) {
