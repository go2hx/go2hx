...
@:keep @:allow(stdgo._internal.runtime.pprof.Pprof.T_profMap_asInterface) class T_profMap_static_extension {
    ...
    static public function _lookup( _m:stdgo.Ref<stdgo._internal.runtime.pprof.Pprof_t_profmap.T_profMap>, _stk:stdgo.Slice<stdgo.GoUInt64>, _tag:stdgo._internal.unsafe.Unsafe.UnsafePointer):stdgo.Ref<stdgo._internal.runtime.pprof.Pprof_t_profmapentry.T_profMapEntry> {
        ...
        var _h_3890312:stdgo.GoUIntptr = new stdgo.GoUIntptr(0);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _h_3890312 = (new stdgo.GoUIntptr((new stdgo.GoUIntptr(0) : stdgo.GoUIntptr)) : stdgo.GoUIntptr);
                    ...
                    _h_3890312 = ((_h_3890312 << (8i64 : stdgo.GoUInt64) : stdgo.GoUIntptr) | ((_h_3890312 >> (new stdgo.GoUIntptr(24) : stdgo.GoUIntptr) : stdgo.GoUIntptr)) : stdgo.GoUIntptr);
                    _h_3890312 = (_h_3890312 + (((new stdgo.GoUIntptr(_x_3890336) : stdgo.GoUIntptr) * (new stdgo.GoUIntptr(41) : stdgo.GoUIntptr) : stdgo.GoUIntptr)) : stdgo.GoUIntptr);
                    _i_3890341_0++;
                    ...
                    _h_3890312 = ((_h_3890312 << (8i64 : stdgo.GoUInt64) : stdgo.GoUIntptr) | ((_h_3890312 >> (new stdgo.GoUIntptr(24) : stdgo.GoUIntptr) : stdgo.GoUIntptr)) : stdgo.GoUIntptr);
                    _h_3890312 = (_h_3890312 + (((new stdgo.GoUIntptr(_tag) : stdgo.GoUIntptr) * (new stdgo.GoUIntptr(41) : stdgo.GoUIntptr) : stdgo.GoUIntptr)) : stdgo.GoUIntptr);
                    _gotoNext = 3890552i32;
                } else if (__value__ == (3890552i32)) {
                    _e_3890565 = ((@:checkr _m ?? throw "null pointer dereference")._hash[_h_3890312] ?? (null : stdgo.Ref<stdgo._internal.runtime.pprof.Pprof_t_profmapentry.T_profMapEntry>));
                    searchBreak = false;
                    ...
                    if ((((@:checkr _e_3890565 ?? throw "null pointer dereference")._stk.length != (_stk.length)) || ((@:checkr _e_3890565 ?? throw "null pointer dereference")._tag != _tag) : Bool)) {
                ...
                } else if (__value__ == (3890661i32)) {
                    {
                        ...
                        final __tmp__1 = (@:checkr _e_3890565 ?? throw "null pointer dereference")._nextHash;
                    ...
                    if ((@:checkr _e_3890565 ?? throw "null pointer dereference")._stk[(_j_3890685 : stdgo.GoInt)] != ((new stdgo.GoUIntptr(_stk[(_j_3890685 : stdgo.GoInt)]) : stdgo.GoUIntptr))) {
                    ...
                    (@:checkr _last_3890533 ?? throw "null pointer dereference")._nextHash = (@:checkr _e_3890565 ?? throw "null pointer dereference")._nextHash;
                    (@:checkr _e_3890565 ?? throw "null pointer dereference")._nextHash = ((@:checkr _m ?? throw "null pointer dereference")._hash[_h_3890312] ?? (null : stdgo.Ref<stdgo._internal.runtime.pprof.Pprof_t_profmapentry.T_profMapEntry>));
                    (@:checkr _m ?? throw "null pointer dereference")._hash[_h_3890312] = _e_3890565;
                    _gotoNext = 3890885i32;
                    ...
                    _e_3890980 = (stdgo.Go.setRef((@:checkr _m ?? throw "null pointer dereference")._free[(0 : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.runtime.pprof.Pprof_t_profmapentry.T_profMapEntry>);
                    ...
                    (@:checkr _e_3890980 ?? throw "null pointer dereference")._nextHash = ((@:checkr _m ?? throw "null pointer dereference")._hash[_h_3890312] ?? (null : stdgo.Ref<stdgo._internal.runtime.pprof.Pprof_t_profmapentry.T_profMapEntry>));
                    (@:checkr _e_3890980 ?? throw "null pointer dereference")._tag = _tag;
                    ...
                    (@:checkr _e_3890980 ?? throw "null pointer dereference")._stk = ((@:checkr _m ?? throw "null pointer dereference")._freeStk.__slice__(0, (_stk.length), (_stk.length)) : stdgo.Slice<stdgo.GoUIntptr>);
                    ...
                    (@:checkr _e_3890980 ?? throw "null pointer dereference")._stk[(_j_3891262 : stdgo.GoInt)] = (new stdgo.GoUIntptr(_stk[(_j_3891262 : stdgo.GoInt)]) : stdgo.GoUIntptr);
                    _j_3891262++;
                    ...
                    (@:checkr _m ?? throw "null pointer dereference")._hash[_h_3890312] = _e_3890980;
                    ...
                    (@:checkr _m ?? throw "null pointer dereference")._all = _e_3890980;
                    (@:checkr _m ?? throw "null pointer dereference")._last = _e_3890980;
                    _gotoNext = 3891484i32;
                } else if (__value__ == (3891444i32)) {
                    _gotoNext = 3891444i32;
                    (@:checkr (@:checkr _m ?? throw "null pointer dereference")._last ?? throw "null pointer dereference")._nextAll = _e_3890980;
                    (@:checkr _m ?? throw "null pointer dereference")._last = _e_3890980;
                    var __blank__ = 0i32;
                    _gotoNext = 3891484i32;
