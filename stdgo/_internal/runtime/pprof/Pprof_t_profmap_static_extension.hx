...
@:keep @:allow(stdgo._internal.runtime.pprof.Pprof.T_profMap_asInterface) class T_profMap_static_extension {
    ...
    static public function _lookup( _m:stdgo.Ref<stdgo._internal.runtime.pprof.Pprof_t_profmap.T_profMap>, _stk:stdgo.Slice<stdgo.GoUInt64>, _tag:stdgo._internal.unsafe.Unsafe.UnsafePointer):stdgo.Ref<stdgo._internal.runtime.pprof.Pprof_t_profmapentry.T_profMapEntry> {
        ...
        var _h_3891226:stdgo.GoUIntptr = new stdgo.GoUIntptr(0);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _h_3891226 = (new stdgo.GoUIntptr((new stdgo.GoUIntptr(0) : stdgo.GoUIntptr)) : stdgo.GoUIntptr);
                    ...
                    _h_3891226 = ((_h_3891226 << (8i64 : stdgo.GoUInt64) : stdgo.GoUIntptr) | ((_h_3891226 >> (new stdgo.GoUIntptr(24) : stdgo.GoUIntptr) : stdgo.GoUIntptr)) : stdgo.GoUIntptr);
                    _h_3891226 = (_h_3891226 + (((new stdgo.GoUIntptr(_x_3891250) : stdgo.GoUIntptr) * (new stdgo.GoUIntptr(41) : stdgo.GoUIntptr) : stdgo.GoUIntptr)) : stdgo.GoUIntptr);
                    _i_3891255_0++;
                    ...
                    _h_3891226 = ((_h_3891226 << (8i64 : stdgo.GoUInt64) : stdgo.GoUIntptr) | ((_h_3891226 >> (new stdgo.GoUIntptr(24) : stdgo.GoUIntptr) : stdgo.GoUIntptr)) : stdgo.GoUIntptr);
                    _h_3891226 = (_h_3891226 + (((new stdgo.GoUIntptr(_tag) : stdgo.GoUIntptr) * (new stdgo.GoUIntptr(41) : stdgo.GoUIntptr) : stdgo.GoUIntptr)) : stdgo.GoUIntptr);
                    ...
                    if ((@:checkr _e_3891479 ?? throw "null pointer dereference")._stk[(_j_3891599 : stdgo.GoInt)] != ((new stdgo.GoUIntptr(_stk[(_j_3891599 : stdgo.GoInt)]) : stdgo.GoUIntptr))) {
                    ...
                    (@:checkr _e_3891894 ?? throw "null pointer dereference")._stk[(_j_3892176 : stdgo.GoInt)] = (new stdgo.GoUIntptr(_stk[(_j_3892176 : stdgo.GoInt)]) : stdgo.GoUIntptr);
                    _j_3892176++;
