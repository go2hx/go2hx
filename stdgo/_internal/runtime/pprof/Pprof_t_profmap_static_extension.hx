...
@:keep @:allow(stdgo._internal.runtime.pprof.Pprof.T_profMap_asInterface) class T_profMap_static_extension {
    ...
    static public function _lookup( _m:stdgo.Ref<stdgo._internal.runtime.pprof.Pprof_t_profmap.T_profMap>, _stk:stdgo.Slice<stdgo.GoUInt64>, _tag:stdgo._internal.unsafe.Unsafe.UnsafePointer):stdgo.Ref<stdgo._internal.runtime.pprof.Pprof_t_profmapentry.T_profMapEntry> {
        ...
        var _i_3861731_1:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < (_stk.length)) {
                        _gotoNext = 3861815i32;
                    } else {
                        _gotoNext = 3861819i32;
                    };
                } else if (__value__ == (3861741i32)) {
                    _x_2 = _stk[(_i_3861731_1 : stdgo.GoInt)];
                    ...
                    _i_3861731_1++;
                    _gotoNext = 3861816i32;
                } else if (__value__ == (3861815i32)) {
                    {
                        final __tmp__0 = 0i32;
                        final __tmp__1 = _stk[(0i32 : stdgo.GoInt)];
                        _i_3861731_1 = @:binopAssign __tmp__0;
                        _x_2 = @:binopAssign __tmp__1;
                    };
                    _gotoNext = 3861816i32;
                } else if (__value__ == (3861816i32)) {
                    if (_i_3861731_1 < (_stk.length)) {
                        _gotoNext = 3861741i32;
                    } else {
                        _gotoNext = 3861819i32;
                    };
                } else if (__value__ == (3861819i32)) {
                    _h_0 = ((_h_0 << (8i64 : stdgo.GoUInt64) : stdgo.GoUIntptr) | ((_h_0 >> (new stdgo.GoUIntptr(24) : stdgo.GoUIntptr) : stdgo.GoUIntptr)) : stdgo.GoUIntptr);
                    ...
                    _gotoNext = 3861942i32;
                } else if (__value__ == (3861942i32)) {
                    ...
                    if ((((@:checkr _e_4 ?? throw "null pointer dereference")._stk.length != (_stk.length)) || ((@:checkr _e_4 ?? throw "null pointer dereference")._tag != _tag) : Bool)) {
                        _gotoNext = 3862051i32;
                    } else {
                        _gotoNext = 3862071i32;
                    };
                } else if (__value__ == (3862051i32)) {
                    {
                        final __tmp__0 = _e_4;
                    ...
                    _gotoNext = 3861951i32;
                } else if (__value__ == (3862071i32)) {
                    if ((0i32 : stdgo.GoInt) < (_stk.length)) {
                        _gotoNext = 3862154i32;
                    } else {
                        _gotoNext = 3862179i32;
                    };
                } else if (__value__ == (3862075i32)) {
                    _j_5++;
                    _gotoNext = 3862155i32;
                } else if (__value__ == (3862090i32)) {
                    ...
                    _gotoNext = 3861951i32;
                } else if (__value__ == (3862154i32)) {
                    _j_5 = 0i32;
                    _gotoNext = 3862155i32;
                } else if (__value__ == (3862155i32)) {
                    if (_j_5 < (_stk.length)) {
                        _gotoNext = 3862090i32;
                    } else {
                        _gotoNext = 3862179i32;
                    };
                } else if (__value__ == (3862179i32)) {
                    if ((_last_3 != null && ((_last_3 : Dynamic).__nil__ == null || !(_last_3 : Dynamic).__nil__))) {
                        _gotoNext = 3862194i32;
                    } else {
                        _gotoNext = 3862275i32;
                    };
                } else if (__value__ == (3862194i32)) {
                    ...
                    _gotoNext = 3861951i32;
                } else if (__value__ == (3862308i32)) {
                    if ((((@:checkr _m ?? throw "null pointer dereference")._free.length) < (1 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 3862327i32;
                    } else {
                        _gotoNext = 3862370i32;
                    };
                } else if (__value__ == (3862327i32)) {
                    ...
                    if ((((@:checkr _m ?? throw "null pointer dereference")._freeStk.length) < (_stk.length) : Bool)) {
                        _gotoNext = 3862475i32;
                    } else {
                        _gotoNext = 3862574i32;
                    };
                } else if (__value__ == (3862475i32)) {
                    ...
                    if ((0i32 : stdgo.GoInt) < (_stk.length)) {
                        _gotoNext = 3862698i32;
                    } else {
                        _gotoNext = 3862702i32;
                    };
                } else if (__value__ == (3862667i32)) {
                    ...
                    _j_7++;
                    _gotoNext = 3862699i32;
                } else if (__value__ == (3862698i32)) {
                    _j_7 = 0i32;
                    _gotoNext = 3862699i32;
                } else if (__value__ == (3862699i32)) {
                    if (_j_7 < (_stk.length)) {
                        _gotoNext = 3862667i32;
                    } else {
                        _gotoNext = 3862702i32;
                    };
                } else if (__value__ == (3862702i32)) {
                    if ((@:checkr _m ?? throw "null pointer dereference")._hash == null) {
                        _gotoNext = 3862719i32;
                    } else {
                        _gotoNext = 3862768i32;
                    };
                } else if (__value__ == (3862719i32)) {
                    ...
                    if (((@:checkr _m ?? throw "null pointer dereference")._all == null || ((@:checkr _m ?? throw "null pointer dereference")._all : Dynamic).__nil__)) {
                        _gotoNext = 3862799i32;
                    } else {
                        _gotoNext = 3862834i32;
                    };
                } else if (__value__ == (3862799i32)) {
