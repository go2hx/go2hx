...
function benchmarkIndexFunc_Large(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        ...
        var _ss = new stdgo.Slice<stdgo._internal.slices.Slices.T_benchmarkIndexFunc_Large_25___localname___Large>((1024 : stdgo.GoInt).toBasic(), 0);
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
                var __blank__ = indexFunc((null : stdgo.Slice<stdgo._internal.slices.Slices.T_benchmarkIndexFunc_Large_25___localname___Large>), new stdgo._internal.slices.Slices.T_benchmarkIndexFunc_Large_25___localname___Large(...[for (i in 0 ... 4096) (0 : stdgo.GoUInt8)]), _ss, function(_e:T_benchmarkIndexFunc_Large_25___localname___Large):Bool {
...
function benchmarkCompact_Large(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        ...
        var _ss = new stdgo.Slice<stdgo._internal.slices.Slices.T_benchmarkCompact_Large_26___localname___Large>((1024 : stdgo.GoInt).toBasic(), 0);
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
                var __blank__ = compact((null : stdgo.Slice<stdgo._internal.slices.Slices.T_benchmarkCompact_Large_26___localname___Large>), new stdgo._internal.slices.Slices.T_benchmarkCompact_Large_26___localname___Large(...[for (i in 0 ... 4096) (0 : stdgo.GoUInt8)]), _ss);
            });
        };
    }
