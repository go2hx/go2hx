...
({ _s1 : (new stdgo.Slice<stdgo.GoFloat64>(1, 1, stdgo._internal.math.Math.naN()) : stdgo.Slice<stdgo.GoFloat64>), _s2 : (new stdgo.Slice<stdgo.GoFloat64>(1, 1, stdgo._internal.math.Math.naN()) : stdgo.Slice<stdgo.GoFloat64>), _want : (0 : stdgo.GoInt) } : T__struct_3),
({ _s1 : (new stdgo.Slice<stdgo.GoFloat64>(3, 3, (1 : stdgo.GoFloat64), (2 : stdgo.GoFloat64), stdgo._internal.math.Math.naN()) : stdgo.Slice<stdgo.GoFloat64>), _s2 : (new stdgo.Slice<stdgo.GoFloat64>(3, 3, (1 : stdgo.GoFloat64), (2 : stdgo.GoFloat64), stdgo._internal.math.Math.naN()) : stdgo.Slice<stdgo.GoFloat64>), _want : (0 : stdgo.GoInt) } : T__struct_3),
({ _s1 : (new stdgo.Slice<stdgo.GoFloat64>(3, 3, (1 : stdgo.GoFloat64), stdgo._internal.math.Math.naN(), (3 : stdgo.GoFloat64)) : stdgo.Slice<stdgo.GoFloat64>), _s2 : (new stdgo.Slice<stdgo.GoFloat64>(3, 3, (1 : stdgo.GoFloat64), stdgo._internal.math.Math.naN(), (4 : stdgo.GoFloat64)) : stdgo.Slice<stdgo.GoFloat64>), _want : (-1 : stdgo.GoInt) } : T__struct_3),
({ _s1 : (new stdgo.Slice<stdgo.GoFloat64>(3, 3, (1 : stdgo.GoFloat64), stdgo._internal.math.Math.naN(), (3 : stdgo.GoFloat64)) : stdgo.Slice<stdgo.GoFloat64>), _s2 : (new stdgo.Slice<stdgo.GoFloat64>(3, 3, (1 : stdgo.GoFloat64), (2 : stdgo.GoFloat64), (4 : stdgo.GoFloat64)) : stdgo.Slice<stdgo.GoFloat64>), _want : (-1 : stdgo.GoInt) } : T__struct_3),
({ _s1 : (new stdgo.Slice<stdgo.GoFloat64>(3, 3, (1 : stdgo.GoFloat64), stdgo._internal.math.Math.naN(), (3 : stdgo.GoFloat64)) : stdgo.Slice<stdgo.GoFloat64>), _s2 : (new stdgo.Slice<stdgo.GoFloat64>(3, 3, (1 : stdgo.GoFloat64), (2 : stdgo.GoFloat64), stdgo._internal.math.Math.naN()) : stdgo.Slice<stdgo.GoFloat64>), _want : (-1 : stdgo.GoInt) } : T__struct_3),
({ _s1 : (new stdgo.Slice<stdgo.GoFloat64>(3, 3, (1 : stdgo.GoFloat64), (2 : stdgo.GoFloat64), (3 : stdgo.GoFloat64)) : stdgo.Slice<stdgo.GoFloat64>), _s2 : (new stdgo.Slice<stdgo.GoFloat64>(3, 3, (1 : stdgo.GoFloat64), (2 : stdgo.GoFloat64), stdgo._internal.math.Math.naN()) : stdgo.Slice<stdgo.GoFloat64>), _want : (1 : stdgo.GoInt) } : T__struct_3),
({ _s1 : (new stdgo.Slice<stdgo.GoFloat64>(3, 3, (1 : stdgo.GoFloat64), (2 : stdgo.GoFloat64), (3 : stdgo.GoFloat64)) : stdgo.Slice<stdgo.GoFloat64>), _s2 : (new stdgo.Slice<stdgo.GoFloat64>(3, 3, (1 : stdgo.GoFloat64), stdgo._internal.math.Math.naN(), (3 : stdgo.GoFloat64)) : stdgo.Slice<stdgo.GoFloat64>), _want : (1 : stdgo.GoInt) } : T__struct_3),
...
function benchmarkIndexFunc_Large(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        ...
        var _ss = new stdgo.Slice<stdgo._internal.slices.Slices.T_benchmarkIndexFunc_Large_20___localname___Large>((1024 : stdgo.GoInt).toBasic(), 0);
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
                var __blank__ = indexFunc((null : stdgo.Slice<stdgo._internal.slices.Slices.T_benchmarkIndexFunc_Large_20___localname___Large>), new stdgo._internal.slices.Slices.T_benchmarkIndexFunc_Large_20___localname___Large(...[for (i in 0 ... 4096) (0 : stdgo.GoUInt8)]), _ss, function(_e:T_benchmarkIndexFunc_Large_20___localname___Large):Bool {
                    return stdgo.Go.toInterface(_e) == stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoUInt8>(...([(1 : stdgo.GoUInt8)].concat([for (i in 0 ... 4095) (0 : stdgo.GoUInt8)]))) : stdgo._internal.slices.Slices.T_benchmarkIndexFunc_Large_20___localname___Large));
                });
            });
        };
    }
...
function benchmarkCompact_Large(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        ...
        var _ss = new stdgo.Slice<stdgo._internal.slices.Slices.T_benchmarkCompact_Large_21___localname___Large>((1024 : stdgo.GoInt).toBasic(), 0);
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
                var __blank__ = compact((null : stdgo.Slice<stdgo._internal.slices.Slices.T_benchmarkCompact_Large_21___localname___Large>), new stdgo._internal.slices.Slices.T_benchmarkCompact_Large_21___localname___Large(...[for (i in 0 ... 4096) (0 : stdgo.GoUInt8)]), _ss);
            });
        };
    }
