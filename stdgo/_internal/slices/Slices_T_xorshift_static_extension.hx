...
@:keep @:allow(stdgo._internal.slices.Slices.T_xorshift_asInterface) class T_xorshift_static_extension {
    @:keep
    @:pointer
    static public function next(____:stdgo._internal.slices.Slices_T_xorshift.T_xorshift,  _r:stdgo.Pointer<stdgo._internal.slices.Slices_T_xorshift.T_xorshift>):stdgo.GoUInt64 {
