...
function benchmarkIndexFunc_Large(_b:stdgo.Ref<stdgo._internal.testing.Testing_b.B>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/slices/slices_test.go#L420"
        {
            var _i = (0 : stdgo.GoInt);
            while ((_i < (@:checkr _b ?? throw "null pointer dereference").n : Bool)) {
                stdgo._internal.slices.Slices_indexfunc.indexFunc(_ss, function(_e:stdgo._internal.slices.Slices_t_benchmarkindexfunc_large___localname___large_8766.T_benchmarkIndexFunc_Large___localname___Large_8766):Bool {
                    //"file:///home/runner/.go/go1.21.3/src/slices/slices_test.go#L422"
