...
function testBinarySearchFloats(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L421"
        for (__0 => _tt in _tests) {
            //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L422"
            _t.run(stdgo._internal.fmt.Fmt_sprintf.sprintf(("%v" : stdgo.GoString), stdgo.Go.toInterface(_tt._target))?.__copy__(), function(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
                //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L423"
                {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L425"
                    if (((_pos != _tt._wantPos) || (_found != _tt._wantFound) : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L426"
