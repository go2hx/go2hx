...
function testCompactFunc(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        //"file:///home/runner/.go/go1.21.3/src/slices/slices_test.go#L746"
        for (__0 => _test in stdgo._internal.slices.Slices__compacttests._compactTests) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/slices/slices_test.go#L748"
            {
                ...
                if (!stdgo._internal.slices.Slices_equal.equal(_got, _test._want)) {
                    //"file:///home/runner/.go/go1.21.3/src/slices/slices_test.go#L749"
        ...
        //"file:///home/runner/.go/go1.21.3/src/slices/slices_test.go#L756"
        {
            ...
            if (!stdgo._internal.slices.Slices_equal.equal(_got, _want)) {
                //"file:///home/runner/.go/go1.21.3/src/slices/slices_test.go#L757"
