...
function testMinMax(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        var _intCmp = (function(_a:stdgo.GoInt, _b:stdgo.GoInt):stdgo.GoInt {
            //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L186"
        ...
        //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L203"
        for (__0 => _tt in _tests) {
            //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L204"
            _t.run(stdgo._internal.fmt.Fmt_sprintf.sprintf(("%v" : stdgo.GoString), stdgo.Go.toInterface(_tt._data))?.__copy__(), function(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
                var _gotMin = (stdgo._internal.slices.Slices_min.min(_tt._data) : stdgo.GoInt);
                //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L206"
                if (_gotMin != (_tt._wantMin)) {
                    //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L207"
                ...
                //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L211"
                if (_gotMinFunc != (_tt._wantMin)) {
                    //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L212"
                ...
                //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L216"
                if (_gotMax != (_tt._wantMax)) {
                    //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L217"
                ...
                //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L221"
                if (_gotMaxFunc != (_tt._wantMax)) {
                    //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L222"
        ...
        //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L236"
        if (stdgo.Go.toInterface(_gotMin) != stdgo.Go.toInterface(_wantMin)) {
            //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L237"
            _t.errorf(("MinFunc(%v) = %v, want %v" : stdgo.GoString), stdgo.Go.toInterface(_svals), stdgo.Go.toInterface(stdgo.Go.asInterface(_gotMin)), stdgo.Go.toInterface(stdgo.Go.asInterface(_wantMin)));
        };
        ...
        //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L242"
        if (stdgo.Go.toInterface(_gotMax) != stdgo.Go.toInterface(_wantMax)) {
            //"file:///home/runner/.go/go1.21.3/src/slices/sort_test.go#L243"
            _t.errorf(("MaxFunc(%v) = %v, want %v" : stdgo.GoString), stdgo.Go.toInterface(_svals), stdgo.Go.toInterface(stdgo.Go.asInterface(_gotMax)), stdgo.Go.toInterface(stdgo.Go.asInterface(_wantMax)));
        };
    }
