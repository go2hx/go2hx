...
function exampleMinFunc():Void {
        {};
        var _people = (new stdgo.Slice<stdgo._internal.slices_test.Slices_test.T_exampleMinFunc_26___localname___Person>(4, 4, ...[(new stdgo._internal.slices_test.Slices_test.T_exampleMinFunc_26___localname___Person(("Gopher" : stdgo.GoString), (13 : stdgo.GoInt)) : stdgo._internal.slices_test.Slices_test.T_exampleMinFunc_26___localname___Person), (new stdgo._internal.slices_test.Slices_test.T_exampleMinFunc_26___localname___Person(("Bob" : stdgo.GoString), (5 : stdgo.GoInt)) : stdgo._internal.slices_test.Slices_test.T_exampleMinFunc_26___localname___Person), (new stdgo._internal.slices_test.Slices_test.T_exampleMinFunc_26___localname___Person(("Vera" : stdgo.GoString), (24 : stdgo.GoInt)) : stdgo._internal.slices_test.Slices_test.T_exampleMinFunc_26___localname___Person), (new stdgo._internal.slices_test.Slices_test.T_exampleMinFunc_26___localname___Person(("Bill" : stdgo.GoString), (5 : stdgo.GoInt)) : stdgo._internal.slices_test.Slices_test.T_exampleMinFunc_26___localname___Person)].concat([for (i in 4 ... (4 > 4 ? 4 : 4 : stdgo.GoInt).toBasic()) ({} : stdgo._internal.slices_test.Slices_test.T_exampleMinFunc_26___localname___Person)])) : stdgo.Slice<stdgo._internal.slices_test.Slices_test.T_exampleMinFunc_26___localname___Person>);
