...
@:keep @:allow(stdgo._internal.sort.Sort.T_xorshift_asInterface) class T_xorshift_static_extension {
    @:keep
    @:pointer
    static public function next(____:stdgo._internal.sort.Sort_T_xorshift.T_xorshift,  _r:stdgo.Pointer<stdgo._internal.sort.Sort_T_xorshift.T_xorshift>):stdgo.GoUInt64 {
