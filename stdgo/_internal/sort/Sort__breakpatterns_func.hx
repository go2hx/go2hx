...
function _breakPatterns_func(_data:stdgo._internal.sort.Sort_t_lessswap.T_lessSwap, _a:stdgo.GoInt, _b:stdgo.GoInt):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L242"
        if ((_length >= (8 : stdgo.GoInt) : Bool)) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L246"
            {
...
//"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L248"
                    if ((_other >= _length : Bool)) {
                        _other = (_other - (_length) : stdgo.GoInt);
                    };
//"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L251"
