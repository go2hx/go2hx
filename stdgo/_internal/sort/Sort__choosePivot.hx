...
var _k = __3, _j = __2, _i = __1, _swaps = __0;
        if ((_l >= (8 : stdgo.GoInt) : Bool)) {
            if ((_l >= (50 : stdgo.GoInt) : Bool)) {
                _i = stdgo._internal.sort.Sort__medianAdjacent._medianAdjacent(_data, _i, stdgo.Go.pointer(_swaps));
                _j = stdgo._internal.sort.Sort__medianAdjacent._medianAdjacent(_data, _j, stdgo.Go.pointer(_swaps));
                _k = stdgo._internal.sort.Sort__medianAdjacent._medianAdjacent(_data, _k, stdgo.Go.pointer(_swaps));
            };
            _j = stdgo._internal.sort.Sort__median._median(_data, _i, _j, _k, stdgo.Go.pointer(_swaps));
        };
        {
