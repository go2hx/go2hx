...
function _pdqsort_func(_data:stdgo._internal.sort.Sort_t_lessswap.T_lessSwap, _a:stdgo.GoInt, _b:stdgo.GoInt, _limit:stdgo.GoInt):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L69"
        while (true) {
            var _length = (_b - _a : stdgo.GoInt);
            //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L72"
            if ((_length <= (12 : stdgo.GoInt) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L73"
                stdgo._internal.sort.Sort__insertionsort_func._insertionSort_func(_data?.__copy__(), _a, _b);
                //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L74"
                return;
            };
            //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L78"
            if (_limit == ((0 : stdgo.GoInt))) {
                //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L79"
                stdgo._internal.sort.Sort__heapsort_func._heapSort_func(_data?.__copy__(), _a, _b);
                //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L80"
                return;
            };
            //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L84"
            if (!_wasBalanced) {
                //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L85"
                stdgo._internal.sort.Sort__breakpatterns_func._breakPatterns_func(_data?.__copy__(), _a, _b);
                //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L86"
                _limit--;
            };
            ...
            //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L90"
            if (_hint == ((2 : stdgo._internal.sort.Sort_t_sortedhint.T_sortedHint))) {
                //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L91"
            ...
            //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L100"
            if (((_wasBalanced && _wasPartitioned : Bool) && (_hint == (1 : stdgo._internal.sort.Sort_t_sortedhint.T_sortedHint)) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L101"
                if (stdgo._internal.sort.Sort__partialinsertionsort_func._partialInsertionSort_func(_data?.__copy__(), _a, _b)) {
                    //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L102"
                    return;
                };
            };
            //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L108"
            if (((_a > (0 : stdgo.GoInt) : Bool) && !_data.less((_a - (1 : stdgo.GoInt) : stdgo.GoInt), _pivot) : Bool)) {
                ...
                _a = _mid;
                //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L111"
                continue;
            };
...
var _rightLen = __1, _leftLen = __0;
            ...
            //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L119"
            if ((_leftLen < _rightLen : Bool)) {
                _wasBalanced = (_leftLen >= _balanceThreshold : Bool);
                //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L121"
                ...
                //"file:///home/runner/.go/go1.21.3/src/sort/zsortfunc.go#L125"
