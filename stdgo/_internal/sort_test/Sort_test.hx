...
9,
9,
(new stdgo._internal.sort_test.Sort_test.Change(("gri" : stdgo.GoString), ("Go" : stdgo.GoString), (100 : stdgo.GoInt)) : stdgo._internal.sort_test.Sort_test.Change),
(new stdgo._internal.sort_test.Sort_test.Change(("ken" : stdgo.GoString), ("C" : stdgo.GoString), (150 : stdgo.GoInt)) : stdgo._internal.sort_test.Sort_test.Change),
(new stdgo._internal.sort_test.Sort_test.Change(("glenda" : stdgo.GoString), ("Go" : stdgo.GoString), (200 : stdgo.GoInt)) : stdgo._internal.sort_test.Sort_test.Change),
(new stdgo._internal.sort_test.Sort_test.Change(("rsc" : stdgo.GoString), ("Go" : stdgo.GoString), (200 : stdgo.GoInt)) : stdgo._internal.sort_test.Sort_test.Change),
(new stdgo._internal.sort_test.Sort_test.Change(("r" : stdgo.GoString), ("Go" : stdgo.GoString), (100 : stdgo.GoInt)) : stdgo._internal.sort_test.Sort_test.Change),
(new stdgo._internal.sort_test.Sort_test.Change(("ken" : stdgo.GoString), ("Go" : stdgo.GoString), (200 : stdgo.GoInt)) : stdgo._internal.sort_test.Sort_test.Change),
(new stdgo._internal.sort_test.Sort_test.Change(("dmr" : stdgo.GoString), ("C" : stdgo.GoString), (100 : stdgo.GoInt)) : stdgo._internal.sort_test.Sort_test.Change),
(new stdgo._internal.sort_test.Sort_test.Change(("r" : stdgo.GoString), ("C" : stdgo.GoString), (150 : stdgo.GoInt)) : stdgo._internal.sort_test.Sort_test.Change),
(new stdgo._internal.sort_test.Sort_test.Change(("gri" : stdgo.GoString), ("Smalltalk" : stdgo.GoString), (80 : stdgo.GoInt)) : stdgo._internal.sort_test.Sort_test.Change)) : stdgo.Slice<stdgo._internal.sort_test.Sort_test.Change>);
...
function testSearchWrappersDontAlloc(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _allocs:stdgo.GoFloat64 = stdgo._internal.testing.Testing.allocsPerRun((100 : stdgo.GoInt), _runSearchWrappers);
...
function testSortIntSlice(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _a:stdgo._internal.sort.Sort.IntSlice = ((_data.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>) : IntSlice);
...
function testSortFloat64Slice(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _a:stdgo._internal.sort.Sort.Float64Slice = ((_data.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoFloat64>) : Float64Slice);
        sort(stdgo.Go.asInterface(_a));
        if (!isSorted(stdgo.Go.asInterface(_a))) {
...
function testSortStringSlice(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _a:stdgo._internal.sort.Sort.StringSlice = ((_data.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoString>) : StringSlice);
        sort(stdgo.Go.asInterface(_a));
        if (!isSorted(stdgo.Go.asInterface(_a))) {
...
function testReverseSortIntSlice(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _a:stdgo._internal.sort.Sort.IntSlice = ((_data.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>) : IntSlice);
        sort(stdgo.Go.asInterface(_a));
        var _r:stdgo._internal.sort.Sort.IntSlice = ((_data1.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>) : IntSlice);
...
function benchmarkSortString1K(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        ...
        for (_i => _ in _unsorted) {
            _unsorted[(_i : stdgo.GoInt)] = stdgo._internal.strconv.Strconv.itoa(_i ^ (716 : stdgo.GoInt))?.__copy__();
        };
                        ...
                        stdgo.Go.cfor(_dist < (5 : stdgo.GoInt), _dist++, {
                            ...
                            var _mdata = (_tmp2.__slice__((0 : stdgo.GoInt), _n) : stdgo.Slice<stdgo.GoInt>);
                            {
                                ...
                                stdgo.Go.cfor(_mode < (6 : stdgo.GoInt), _mode++, {
                                    ...
                                    var _desc:stdgo.GoString = stdgo._internal.fmt.Fmt.sprintf(("n=%d m=%d dist=%s mode=%s" : stdgo.GoString), stdgo.Go.toInterface(_n), stdgo.Go.toInterface(_m), stdgo.Go.toInterface(_dists[(_dist : stdgo.GoInt)]), stdgo.Go.toInterface(_modes[(_mode : stdgo.GoInt)]))?.__copy__();
...
function testStability(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _data:stdgo._internal.sort_test.Sort_test.T_intPairs = new stdgo.Slice<T__struct_4>((_n : stdgo.GoInt).toBasic(), 0, ...[for (i in 0 ... ((_n : stdgo.GoInt).toBasic() > 0 ? (_n : stdgo.GoInt).toBasic() : 0 : stdgo.GoInt).toBasic()) ({ _a : (0 : stdgo.GoInt), _b : (0 : stdgo.GoInt) } : T__struct_4)]);
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < (_data.length), _i++, {
...
function _countOps(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>, _algo:Interface -> Void, _name:stdgo.GoString):Void {
        ...
        for (__8 => _n in _sizes) {
            var _td:stdgo._internal.sort_test.Sort_test.T_testingData = ({ _desc : _name?.__copy__(), _t : _t, _data : new stdgo.Slice<stdgo.GoInt>((_n : stdgo.GoInt).toBasic(), 0).__setNumber32__(), _maxswap : (2147483647 : stdgo.GoInt) } : stdgo._internal.sort_test.Sort_test.T_testingData);
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_i < _n, _i++, {
                    _td._data[(_i : stdgo.GoInt)] = stdgo._internal.math.rand.Rand.intn(_n / (5 : stdgo.GoInt));
                });
            };
...
function _bench(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>, _size:stdgo.GoInt, _algo:Interface -> Void, _name:stdgo.GoString):Void {
        if (stdgo._internal.strings.Strings.hasSuffix(stdgo._internal.internal.testenv.Testenv.builder()?.__copy__(), ("-race" : stdgo.GoString)) && (_size > (10000 : stdgo.GoInt))) {
            _b.skip(stdgo.Go.toInterface(("skipping slow benchmark on race builder" : stdgo.GoString)));
        };
        _b.stopTimer();
        var _data:stdgo._internal.sort_test.Sort_test.T_intPairs = new stdgo.Slice<T__struct_4>((_size : stdgo.GoInt).toBasic(), 0, ...[for (i in 0 ... ((_size : stdgo.GoInt).toBasic() > 0 ? (_size : stdgo.GoInt).toBasic() : 0 : stdgo.GoInt).toBasic()) ({ _a : (0 : stdgo.GoInt), _b : (0 : stdgo.GoInt) } : T__struct_4)]);
...
@:keep @:allow(stdgo._internal.sort_test.Sort_test.T_multiSorter_asInterface) class T_multiSorter_static_extension {
    ...
    static public function less( _ms:stdgo.Ref<T_multiSorter>, _i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
        ...
        var __0 = (stdgo.Go.setRef(_ms._changes[(_i : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.sort_test.Sort_test.Change>), __1 = (stdgo.Go.setRef(_ms._changes[(_j : stdgo.GoInt)]) : stdgo.Ref<stdgo._internal.sort_test.Sort_test.Change>), _q = __1, _p = __0;
        var _k:stdgo.GoInt = (0 : stdgo.GoInt);
        {
            _k = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_k < (_ms._less.length - (1 : stdgo.GoInt)), _k++, {
                var _less:stdgo._internal.sort_test.Sort_test.T_lessFunc = _ms._less[(_k : stdgo.GoInt)];
                if (_less(_p, _q)) {
                    return true;
                } else if (_less(_q, _p)) {
                    return false;
