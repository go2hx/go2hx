...
_a._nd++;
    ...
    static public function _floatBits( _d:stdgo.Ref<stdgo._internal.strconv.Strconv_T_decimal.T_decimal>, _flt:stdgo.Ref<stdgo._internal.strconv.Strconv_T_floatInfo.T_floatInfo>):{ var _0 : stdgo.GoUInt64; var _1 : Bool; } {
        ...
        var _bits_2719682:stdgo.GoUInt64 = (0 : stdgo.GoUInt64);
        var _n_2719119:stdgo.GoInt = (0 : stdgo.GoInt);
        var _n_2718795:stdgo.GoInt = (0 : stdgo.GoInt);
        var _n_2718638:stdgo.GoInt = (0 : stdgo.GoInt);
        var _mant_2718193:stdgo.GoUInt64 = (0 : stdgo.GoUInt64);
        var _exp_2718180:stdgo.GoInt = (0 : stdgo.GoInt);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if (_d._nd == ((0 : stdgo.GoInt))) {
                        _gotoNext = 2718255i32;
                    } else {
                        _gotoNext = 2718448i32;
                    };
                } else if (__value__ == (2718255i32)) {
                    _mant_2718193 = (0i64 : stdgo.GoUInt64);
                    _exp_2718180 = _flt._bias;
                    _gotoNext = 2719657i32;
                } else if (__value__ == (2718448i32)) {
                    if ((_d._dp > (310 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2718462i32;
                    } else {
                        _gotoNext = 2718484i32;
                    };
                } else if (__value__ == (2718462i32)) {
                    _gotoNext = 2719572i32;
                } else if (__value__ == (2718484i32)) {
                    if ((_d._dp < (-330 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2718499i32;
                    } else {
                        _gotoNext = 2718608i32;
                    };
                } else if (__value__ == (2718499i32)) {
                    _mant_2718193 = (0i64 : stdgo.GoUInt64);
                    _exp_2718180 = _flt._bias;
                    _gotoNext = 2719657i32;
                } else if (__value__ == (2718608i32)) {
                    _exp_2718180 = (0 : stdgo.GoInt);
                    var __blank__ = 0i32;
                    _gotoNext = 2718617i32;
                } else if (__value__ == (2718617i32)) {
                    if ((_d._dp > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2718630i32;
                    } else {
                        _gotoNext = 2718745i32;
                    };
                } else if (__value__ == (2718630i32)) {
                    if ((_d._dp >= (stdgo._internal.strconv.Strconv__powtab._powtab.length) : Bool)) {
                        _gotoNext = 2718669i32;
                    } else {
                        _gotoNext = 2718690i32;
                    };
                } else if (__value__ == (2718669i32)) {
                    _n_2718638 = (27 : stdgo.GoInt);
                    _gotoNext = 2718718i32;
                } else if (__value__ == (2718690i32)) {
                    _gotoNext = 2718690i32;
                    _n_2718638 = stdgo._internal.strconv.Strconv__powtab._powtab[(_d._dp : stdgo.GoInt)];
                    var __blank__ = 0i32;
                    _gotoNext = 2718718i32;
                } else if (__value__ == (2718718i32)) {
                    _d.shift(-_n_2718638);
                    _exp_2718180 = (_exp_2718180 + (_n_2718638) : stdgo.GoInt);
                    _gotoNext = 2718617i32;
                } else if (__value__ == (2718745i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 2718745i32;
                    if (((_d._dp < (0 : stdgo.GoInt) : Bool) || (_d._dp == ((0 : stdgo.GoInt)) && (_d._d[(0 : stdgo.GoInt)] < (53 : stdgo.GoUInt8) : Bool) : Bool) : Bool)) {
                        _gotoNext = 2718787i32;
                    } else {
                        _gotoNext = 2718964i32;
                    };
                } else if (__value__ == (2718787i32)) {
                    if ((-_d._dp >= (stdgo._internal.strconv.Strconv__powtab._powtab.length) : Bool)) {
                        _gotoNext = 2718827i32;
                    } else {
                        _gotoNext = 2718848i32;
                    };
                } else if (__value__ == (2718827i32)) {
                    _n_2718795 = (27 : stdgo.GoInt);
                    _gotoNext = 2718877i32;
                } else if (__value__ == (2718848i32)) {
                    _gotoNext = 2718848i32;
                    _n_2718795 = stdgo._internal.strconv.Strconv__powtab._powtab[(-_d._dp : stdgo.GoInt)];
                    var __blank__ = 0i32;
                    _gotoNext = 2718877i32;
                } else if (__value__ == (2718877i32)) {
                    _d.shift(_n_2718795);
                    _exp_2718180 = (_exp_2718180 - (_n_2718795) : stdgo.GoInt);
                    _gotoNext = 2718745i32;
                } else if (__value__ == (2718964i32)) {
                    _exp_2718180--;
                    if ((_exp_2718180 < (_flt._bias + (1 : stdgo.GoInt) : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2719115i32;
                    } else {
                        _gotoNext = 2719173i32;
                    };
                } else if (__value__ == (2719115i32)) {
                    _n_2719119 = ((_flt._bias + (1 : stdgo.GoInt) : stdgo.GoInt) - _exp_2718180 : stdgo.GoInt);
                    _d.shift(-_n_2719119);
                    _exp_2718180 = (_exp_2718180 + (_n_2719119) : stdgo.GoInt);
                    _gotoNext = 2719173i32;
                } else if (__value__ == (2719173i32)) {
                    if (((_exp_2718180 - _flt._bias : stdgo.GoInt) >= (((1 : stdgo.GoInt) << _flt._expbits : stdgo.GoInt) - (1 : stdgo.GoInt) : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2719209i32;
                    } else {
                        _gotoNext = 2719265i32;
                    };
                } else if (__value__ == (2719209i32)) {
                    _gotoNext = 2719572i32;
                } else if (__value__ == (2719265i32)) {
                    _d.shift((((1u32 : stdgo.GoUInt) + _flt._mantbits : stdgo.GoUInt) : stdgo.GoInt));
                    _mant_2718193 = _d.roundedInteger();
                    if (_mant_2718193 == (((2i64 : stdgo.GoUInt64) << _flt._mantbits : stdgo.GoUInt64))) {
                        _gotoNext = 2719401i32;
                    } else {
                        _gotoNext = 2719508i32;
                    };
                } else if (__value__ == (2719401i32)) {
                    _mant_2718193 = (_mant_2718193 >> ((1i64 : stdgo.GoUInt64)) : stdgo.GoUInt64);
                    _exp_2718180++;
                    if (((_exp_2718180 - _flt._bias : stdgo.GoInt) >= (((1 : stdgo.GoInt) << _flt._expbits : stdgo.GoInt) - (1 : stdgo.GoInt) : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2719462i32;
                    } else {
                        _gotoNext = 2719508i32;
                    };
                } else if (__value__ == (2719462i32)) {
                    _gotoNext = 2719572i32;
                } else if (__value__ == (2719508i32)) {
                    if ((_mant_2718193 & (((1i64 : stdgo.GoUInt64) << _flt._mantbits : stdgo.GoUInt64)) : stdgo.GoUInt64) == ((0i64 : stdgo.GoUInt64))) {
                        _gotoNext = 2719539i32;
                    } else {
                        _gotoNext = 2719562i32;
                    };
                } else if (__value__ == (2719539i32)) {
                    _exp_2718180 = _flt._bias;
                    _gotoNext = 2719562i32;
                } else if (__value__ == (2719562i32)) {
                    _gotoNext = 2719657i32;
                } else if (__value__ == (2719572i32)) {
                    _mant_2718193 = (0i64 : stdgo.GoUInt64);
                    _exp_2718180 = ((((1 : stdgo.GoInt) << _flt._expbits : stdgo.GoInt) - (1 : stdgo.GoInt) : stdgo.GoInt) + _flt._bias : stdgo.GoInt);
                    _overflow = true;
                    _gotoNext = 2719657i32;
                } else if (__value__ == (2719657i32)) {
                    _bits_2719682 = (_mant_2718193 & ((((1i64 : stdgo.GoUInt64) << _flt._mantbits : stdgo.GoUInt64) - (1i64 : stdgo.GoUInt64) : stdgo.GoUInt64)) : stdgo.GoUInt64);
                    _bits_2719682 = (_bits_2719682 | ((((((_exp_2718180 - _flt._bias : stdgo.GoInt)) & ((((1 : stdgo.GoInt) << _flt._expbits : stdgo.GoInt) - (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo.GoInt) : stdgo.GoUInt64) << _flt._mantbits : stdgo.GoUInt64)) : stdgo.GoUInt64);
                    if (_d._neg) {
                        _gotoNext = 2719804i32;
                    } else {
                        _gotoNext = 2719853i32;
                    };
                } else if (__value__ == (2719804i32)) {
                    _bits_2719682 = (_bits_2719682 | ((((1i64 : stdgo.GoUInt64) << _flt._mantbits : stdgo.GoUInt64) << _flt._expbits : stdgo.GoUInt64)) : stdgo.GoUInt64);
                    _gotoNext = 2719853i32;
                } else if (__value__ == (2719853i32)) {
                    return { _0 : _bits_2719682, _1 : _overflow };
                    _gotoNext = -1i32;
                };
            };
        };
