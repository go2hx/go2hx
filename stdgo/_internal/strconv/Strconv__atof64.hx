...
function _atof64(_s:stdgo.GoString):{ var _0 : stdgo.GoFloat64; var _1 : stdgo.GoInt; var _2 : stdgo.Error; } {
        var _f = (0 : stdgo.GoFloat64), _n = (0 : stdgo.GoInt), _err = (null : stdgo.Error);
        {
            ...
            if (_ok) {
                return { _0 : _f = _val, _1 : _n, _2 : _err = (null : stdgo.Error) };
            };
        };
        ...
        if (!_ok) {
            return { _0 : _f = (0 : stdgo.GoFloat64), _1 : _n, _2 : _err = stdgo.Go.asInterface(stdgo._internal.strconv.Strconv__syntaxError._syntaxError(("ParseFloat" : stdgo.GoString), _s?.__copy__())) };
        };
        if (_hex) {
            ...
            if (!_trunc) {
                {
                    ...
                    if (_ok) {
                        return { _0 : _f, _1 : _n, _2 : _err = (null : stdgo.Error) };
                    };
                };
            };
