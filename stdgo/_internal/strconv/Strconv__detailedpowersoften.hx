...
(new stdgo.GoArray<stdgo.GoUInt64>(2, 2, ...[(5436291095364479483i64 : stdgo.GoUInt64), (-3369057127870728857i64 : stdgo.GoUInt64)]).__setNumber64__() : stdgo.GoArray<stdgo.GoUInt64>)?.__copy__()].concat([for (i in 696 ... (696 > 696 ? 696 : 696 : stdgo.GoInt).toBasic()) new stdgo.GoArray<stdgo.GoUInt64>(2, 2).__setNumber64__().__setNil__()])) : stdgo.GoArray<stdgo.GoArray<stdgo.GoUInt64>>);
