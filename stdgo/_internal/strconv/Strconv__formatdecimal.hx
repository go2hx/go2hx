...
function _formatDecimal(_d:stdgo.Ref<stdgo._internal.strconv.Strconv_t_decimalslice.T_decimalSlice>, _m:stdgo.GoUInt64, _trunc:Bool, _roundUp:Bool, _prec:stdgo.GoInt):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L170"
        while ((_m >= _max : Bool)) {
            var __0 = (_m / (10i64 : stdgo.GoUInt64) : stdgo.GoUInt64), __1 = (_m % (10i64 : stdgo.GoUInt64) : stdgo.GoUInt64);
var _b = __1, _a = __0;
            _m = _a;
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L173"
            _trimmed++;
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L174"
            ...
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L183"
            if (_b != ((0i64 : stdgo.GoUInt64))) {
                _trunc = true;
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L187"
        if (_roundUp) {
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L188"
            _m++;
        };
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L190"
        if ((_m >= _max : Bool)) {
            _m = (_m / ((10i64 : stdgo.GoUInt64)) : stdgo.GoUInt64);
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L193"
            _trimmed++;
        };
        var _n = (_prec : stdgo.GoUInt);
        (@:checkr _d ?? throw "null pointer dereference")._nd = _prec;
        var _v = (_m : stdgo.GoUInt64);
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L199"
        while ((_v >= (100i64 : stdgo.GoUInt64) : Bool)) {
            var _v1:stdgo.GoUInt64 = (0 : stdgo.GoUInt64), _v2:stdgo.GoUInt64 = (0 : stdgo.GoUInt64);
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L201"
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L211"
        if ((_v > (0i64 : stdgo.GoUInt64) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L212"
            _n--;
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L215"
        if ((_v >= (10i64 : stdgo.GoUInt64) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L216"
            _n--;
            (@:checkr _d ?? throw "null pointer dereference")._d[(_n : stdgo.GoInt)] = ("00010203040506070809101112131415161718192021222324252627282930313233343536373839404142434445464748495051525354555657585960616263646566676869707172737475767778798081828384858687888990919293949596979899" : stdgo.GoString)[(((2i64 : stdgo.GoUInt64) * _v : stdgo.GoUInt64) : stdgo.GoInt)];
        };
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L219"
        while ((@:checkr _d ?? throw "null pointer dereference")._d[((@:checkr _d ?? throw "null pointer dereference")._nd - (1 : stdgo.GoInt) : stdgo.GoInt)] == ((48 : stdgo.GoUInt8))) {
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L220"
            (@:checkr _d ?? throw "null pointer dereference")._nd--;
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L221"
            _trimmed++;
        };
