...
function _genericFtoa(_dst:stdgo.Slice<stdgo.GoUInt8>, _val:stdgo.GoFloat64, _fmt:stdgo.GoUInt8, _prec:stdgo.GoInt, _bitSize:stdgo.GoInt):stdgo.Slice<stdgo.GoUInt8> {
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L60"
        {
            ...
            if (__value__ == ((32 : stdgo.GoInt))) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L68"
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L75"
        {
            ...
            if (__value__ == ((((1 : stdgo.GoInt) << (@:checkr _flt ?? throw "null pointer dereference")._expbits : stdgo.GoInt) - (1 : stdgo.GoInt) : stdgo.GoInt))) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L79"
                ...
                //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L87"
                return (_dst.__append__(...(_s : Array<stdgo.GoUInt8>)) : stdgo.Slice<stdgo.GoUInt8>);
            } else if (__value__ == ((0 : stdgo.GoInt))) {
                //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L91"
                _exp++;
            } else {
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L100"
        if (_fmt == ((98 : stdgo.GoUInt8))) {
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L101"
            return stdgo._internal.strconv.Strconv__fmtb._fmtB(_dst, _neg, _mant, _exp, _flt);
        };
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L103"
        if (((_fmt == (120 : stdgo.GoUInt8)) || (_fmt == (88 : stdgo.GoUInt8)) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L104"
            return stdgo._internal.strconv.Strconv__fmtx._fmtX(_dst, _prec, _fmt, _neg, _mant, _exp, _flt);
        };
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L107"
        if (!stdgo._internal.strconv.Strconv__optimize._optimize) {
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L108"
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L115"
        if (_shortest) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L119"
            ...
            _ok = true;
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L122"
            {
            ...
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L133"
            {
                final __value__ = _fmt;
                if (__value__ == ((101 : stdgo.GoUInt8)) || __value__ == ((69 : stdgo.GoUInt8))) {
                    //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L135"
                    _digits++;
                } else if (__value__ == ((103 : stdgo.GoUInt8)) || __value__ == ((71 : stdgo.GoUInt8))) {
                    //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L137"
            ...
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L146"
            if (((_bitSize == (32 : stdgo.GoInt)) && (_digits <= (9 : stdgo.GoInt) : Bool) : Bool)) {
                _digs._d = (_buf.__slice__(0) : stdgo.Slice<stdgo.GoUInt8>);
                //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L148"
                ...
                _digs._d = (_buf.__slice__(0) : stdgo.Slice<stdgo.GoUInt8>);
                //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L152"
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L156"
        if (!_ok) {
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L157"
            return stdgo._internal.strconv.Strconv__bigftoa._bigFtoa(_dst, _prec, _fmt, _neg, _mant, _exp, _flt);
        };
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoa.go#L159"
