...
function _ryuFtoaFixed32(_d:stdgo.Ref<stdgo._internal.strconv.Strconv_t_decimalslice.T_decimalSlice>, _mant:stdgo.GoUInt32, _exp:stdgo.GoInt, _prec:stdgo.GoInt):Void {
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L21"
        if ((_prec < (0 : stdgo.GoInt) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L22"
            throw stdgo.Go.toInterface(("ryuFtoaFixed32 called with negative prec" : stdgo.GoString));
        };
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L24"
        if ((_prec > (9 : stdgo.GoInt) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L25"
            throw stdgo.Go.toInterface(("ryuFtoaFixed32 called with prec > 9" : stdgo.GoString));
        };
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L28"
        if (_mant == ((0u32 : stdgo.GoUInt32))) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L30"
            return;
        };
        var _e2 = (_exp : stdgo.GoInt);
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L34"
        {
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L52"
        if ((_dexp2 >= (0 : stdgo.GoInt) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L53"
            throw stdgo.Go.toInterface(("not enough significant bits after mult64bitPow10" : stdgo.GoString));
        };
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L59"
...
var _dfrac = __1, _di = __0;
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L69"
        if (_exact) {
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L80"
        if (_dfrac != ((0u32 : stdgo.GoUInt32))) {
            _d0 = false;
        };
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L84"
