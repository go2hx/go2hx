...
function _ryuFtoaFixed64(_d:stdgo.Ref<stdgo._internal.strconv.Strconv_t_decimalslice.T_decimalSlice>, _mant:stdgo.GoUInt64, _exp:stdgo.GoInt, _prec:stdgo.GoInt):Void {
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L91"
        if ((_prec > (18 : stdgo.GoInt) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L92"
            throw stdgo.Go.toInterface(("ryuFtoaFixed64 called with prec > 18" : stdgo.GoString));
        };
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L95"
        if (_mant == ((0i64 : stdgo.GoUInt64))) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L97"
            return;
        };
        var _e2 = (_exp : stdgo.GoInt);
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L101"
        {
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L122"
        if ((_dexp2 >= (0 : stdgo.GoInt) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L123"
            throw stdgo.Go.toInterface(("not enough significant bits after mult128bitPow10" : stdgo.GoString));
        };
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L129"
...
var _dfrac = __1, _di = __0;
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L139"
        if (_exact) {
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L150"
        if (_dfrac != ((0i64 : stdgo.GoUInt64))) {
            _d0 = false;
        };
        //"file:///home/runner/.go/go1.21.3/src/strconv/ftoaryu.go#L154"
