...
function _special(_s:stdgo.GoString):{ var _0 : stdgo.GoFloat64; var _1 : stdgo.GoInt; var _2 : Bool; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/atof.go#L43"
        if ((_s.length) == ((0 : stdgo.GoInt))) {
            //"file:///home/runner/.go/go1.21.3/src/strconv/atof.go#L44"
            return {
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/atof.go#L48"
        {
            ...
            while (__run__) {
                __run__ = false;
                {
                    ...
                    if (__switchIndex__ == 0 || (__switchIndex__ == -1 && (__value__ == ((43 : stdgo.GoUInt8)) || __value__ == ((45 : stdgo.GoUInt8))))) {
                        //"file:///home/runner/.go/go1.21.3/src/strconv/atof.go#L50"
                        if (_s[(0 : stdgo.GoInt)] == ((45 : stdgo.GoUInt8))) {
                            _sign = (-1 : stdgo.GoInt);
                        };
                        _nsign = (1 : stdgo.GoInt);
                        _s = (_s.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                        //"file:///home/runner/.go/go1.21.3/src/strconv/atof.go#L55"
                        @:fallthrough {
                            __switchIndex__ = 1;
                            __run__ = true;
                            continue;
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/strconv/atof.go#L60"
                        if ((((3 : stdgo.GoInt) < _n : Bool) && (_n < (8 : stdgo.GoInt) : Bool) : Bool)) {
                            _n = (3 : stdgo.GoInt);
                        };
                        //"file:///home/runner/.go/go1.21.3/src/strconv/atof.go#L63"
                        if (((_n == (3 : stdgo.GoInt)) || (_n == (8 : stdgo.GoInt)) : Bool)) {
                            //"file:///home/runner/.go/go1.21.3/src/strconv/atof.go#L64"
                            return {
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/strconv/atof.go#L67"
                        if (stdgo._internal.strconv.Strconv__commonprefixlenignorecase._commonPrefixLenIgnoreCase(_s?.__copy__(), ("nan" : stdgo.GoString)) == ((3 : stdgo.GoInt))) {
                            //"file:///home/runner/.go/go1.21.3/src/strconv/atof.go#L68"
                            return {
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/atof.go#L71"
        return {
            @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoFloat64; var _1 : stdgo.GoInt; var _2 : Bool; } = { _0 : (0 : stdgo.GoFloat64), _1 : (0 : stdgo.GoInt), _2 : false };
            _f = __tmp__._0;
            _n = __tmp__._1;
