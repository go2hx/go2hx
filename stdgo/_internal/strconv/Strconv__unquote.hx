...
function _unquote(_in:stdgo.GoString, _unescape:Bool):{ var _0 : stdgo.GoString; var _1 : stdgo.GoString; var _2 : stdgo.Error; } {
        ...
        if (((_in.length) < (2 : stdgo.GoInt) : Bool)) {
            return { _0 : stdgo.Go.str()?.__copy__(), _1 : _in?.__copy__(), _2 : stdgo._internal.strconv.Strconv_errSyntax.errSyntax };
        };
                    ...
                    if (__value__ == ((96 : stdgo.GoUInt8))) {
                        ...
                        if ((!stdgo._internal.strconv.Strconv__contains._contains((_in.__slice__(0, _end) : stdgo.GoString)?.__copy__(), (92 : stdgo.GoUInt8)) && !stdgo._internal.strconv.Strconv__contains._contains((_in.__slice__(0, _end) : stdgo.GoString)?.__copy__(), (10 : stdgo.GoUInt8)) : Bool)) {
                            var _valid:Bool = false;
                            {
                                ...
                                if (__value__ == ((34 : stdgo.GoUInt8))) {
                                    _valid = stdgo._internal.unicode.utf8.Utf8_validString.validString((_in.__slice__((("\"" : stdgo.GoString).length), (_end - (("\"" : stdgo.GoString).length) : stdgo.GoInt)) : stdgo.GoString)?.__copy__());
                                } else if (__value__ == ((39 : stdgo.GoUInt8))) {
                                    var __tmp__ = stdgo._internal.unicode.utf8.Utf8_decodeRuneInString.decodeRuneInString((_in.__slice__((("\'" : stdgo.GoString).length), (_end - (("\'" : stdgo.GoString).length) : stdgo.GoInt)) : stdgo.GoString)?.__copy__()), _r:stdgo.GoInt32 = __tmp__._0, _n:stdgo.GoInt = __tmp__._1;
                        ...
                        while ((((_in.length) > (0 : stdgo.GoInt) : Bool) && (_in[(0 : stdgo.GoInt)] != _quote) : Bool)) {
                            ...
                            if (((_in[(0 : stdgo.GoInt)] == (10 : stdgo.GoUInt8)) || (_err != null) : Bool)) {
                                return { _0 : stdgo.Go.str()?.__copy__(), _1 : _in0?.__copy__(), _2 : stdgo._internal.strconv.Strconv_errSyntax.errSyntax };
                            };
                            _in = _rem?.__copy__();
                            if (_unescape) {
                                if (((_r < (128 : stdgo.GoInt32) : Bool) || !_multibyte : Bool)) {
                                    ...
                                    var _arr:stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(4, 4, ...[for (i in 0 ... 4) (0 : stdgo.GoUInt8)]);
