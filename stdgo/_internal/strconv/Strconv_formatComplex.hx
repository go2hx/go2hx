...
function formatComplex(_c:stdgo.GoComplex128, _fmt:stdgo.GoUInt8, _prec:stdgo.GoInt, _bitSize:stdgo.GoInt):stdgo.GoString {
        ...
        var _im = (stdgo._internal.strconv.Strconv_formatFloat.formatFloat(_c.imag, _fmt, _prec, _bitSize)?.__copy__() : stdgo.GoString);
        ...
        return (((("(" : stdgo.GoString) + stdgo._internal.strconv.Strconv_formatFloat.formatFloat(_c.real, _fmt, _prec, _bitSize)?.__copy__() : stdgo.GoString) + _im?.__copy__() : stdgo.GoString) + ("i)" : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__();
    }
