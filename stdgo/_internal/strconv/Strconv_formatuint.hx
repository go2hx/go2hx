...
function formatUint(_i:stdgo.GoUInt64, _base:stdgo.GoInt):stdgo.GoString {
        //"file:///home/runner/.go/go1.21.3/src/strconv/itoa.go#L15"
        if (((true && (_i < (100i64 : stdgo.GoUInt64) : Bool) : Bool) && (_base == (10 : stdgo.GoInt)) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/strconv/itoa.go#L16"
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/itoa.go#L19"
        return _s?.__copy__();
    }
