...
function parseFloat(_s:stdgo.GoString, _bitSize:stdgo.GoInt):{ var _0 : stdgo.GoFloat64; var _1 : stdgo.Error; } {
        ...
        if (((_n != (_s.length)) && (((_err == null) || (stdgo.Go.toInterface((stdgo.Go.typeAssert((stdgo.Go.toInterface(_err) : stdgo.Ref<stdgo._internal.strconv.Strconv_NumError.NumError>)) : stdgo.Ref<stdgo._internal.strconv.Strconv_NumError.NumError>).err) != stdgo.Go.toInterface(stdgo._internal.strconv.Strconv_errSyntax.errSyntax)) : Bool)) : Bool)) {
