...
function parseComplex(_s:stdgo.GoString, _bitSize:stdgo.GoInt):{ var _0 : stdgo.GoComplex128; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/atoc.go#L44"
        if (_bitSize == ((64 : stdgo.GoInt))) {
            _size = (32 : stdgo.GoInt);
        };
        var _orig = (_s?.__copy__() : stdgo.GoString);
        //"file:///home/runner/.go/go1.21.3/src/strconv/atoc.go#L51"
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/atoc.go#L59"
        if (_err != null) {
            {
            ...
            //"file:///home/runner/.go/go1.21.3/src/strconv/atoc.go#L61"
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/strconv/atoc.go#L62"
                return { _0 : ((0f64 : stdgo.GoFloat64) + new stdgo.GoComplex128(0f64, 0f64)), _1 : _err };
            };
        };
        _s = (_s.__slice__(_n) : stdgo.GoString)?.__copy__();
        //"file:///home/runner/.go/go1.21.3/src/strconv/atoc.go#L68"
        if ((_s.length) == ((0 : stdgo.GoInt))) {
            //"file:///home/runner/.go/go1.21.3/src/strconv/atoc.go#L69"
            return { _0 : new stdgo.GoComplex128(_re, (0 : stdgo.GoFloat64)), _1 : _pending };
        };
        //"file:///home/runner/.go/go1.21.3/src/strconv/atoc.go#L73"
        {
            ...
            while (__run__) {
                __run__ = false;
                {
                    ...
                    if (__switchIndex__ == 0 || (__switchIndex__ == -1 && (__value__ == (43 : stdgo.GoUInt8)))) {
                        //"file:///home/runner/.go/go1.21.3/src/strconv/atoc.go#L77"
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/strconv/atoc.go#L84"
                        if ((_s.length) == ((1 : stdgo.GoInt))) {
                            //"file:///home/runner/.go/go1.21.3/src/strconv/atoc.go#L85"
                            return { _0 : new stdgo.GoComplex128((0 : stdgo.GoFloat64), _re), _1 : _pending };
                        };
                        //"file:///home/runner/.go/go1.21.3/src/strconv/atoc.go#L87"
                        @:fallthrough {
                            __switchIndex__ = 3;
                            __run__ = true;
                            continue;
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/strconv/atoc.go#L89"
        ...
        //"file:///home/runner/.go/go1.21.3/src/strconv/atoc.go#L94"
        if (_err != null) {
            {
                var __tmp__ = stdgo._internal.strconv.Strconv__converr._convErr(_err, _orig?.__copy__());
                _err = @:tmpset0 __tmp__._0;
            ...
            //"file:///home/runner/.go/go1.21.3/src/strconv/atoc.go#L96"
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/strconv/atoc.go#L97"
                return { _0 : ((0f64 : stdgo.GoFloat64) + new stdgo.GoComplex128(0f64, 0f64)), _1 : _err };
            };
        };
        _s = (_s.__slice__(_n) : stdgo.GoString)?.__copy__();
        //"file:///home/runner/.go/go1.21.3/src/strconv/atoc.go#L101"
        if (_s != (("i" : stdgo.GoString))) {
            //"file:///home/runner/.go/go1.21.3/src/strconv/atoc.go#L102"
            return { _0 : ((0f64 : stdgo.GoFloat64) + new stdgo.GoComplex128(0f64, 0f64)), _1 : stdgo.Go.asInterface(stdgo._internal.strconv.Strconv__syntaxerror._syntaxError(("ParseComplex" : stdgo.GoString), _orig?.__copy__())) };
        };
        //"file:///home/runner/.go/go1.21.3/src/strconv/atoc.go#L104"
