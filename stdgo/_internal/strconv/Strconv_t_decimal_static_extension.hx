        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((@:checkr _d ?? throw "null pointer dereference")._nd == ((0 : stdgo.GoInt))) {
                        _gotoNext = 2606318i32;
                    } else {
                        _gotoNext = 2606511i32;
                    };
                } else if (__value__ == (2606318i32)) {
                    _mant_13 = (0i64 : stdgo.GoUInt64);
                    _exp_12 = (@:checkr _flt ?? throw "null pointer dereference")._bias;
                    _gotoNext = 2607720i32;
                } else if (__value__ == (2606511i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._dp > (310 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2606525i32;
                    } else {
                        _gotoNext = 2606547i32;
                    };
                } else if (__value__ == (2606525i32)) {
                    _gotoNext = 2607635i32;
                } else if (__value__ == (2606547i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._dp < (-330 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2606562i32;
                    } else {
                        _gotoNext = 2606671i32;
                    };
                } else if (__value__ == (2606562i32)) {
                    _mant_13 = (0i64 : stdgo.GoUInt64);
                    _exp_12 = (@:checkr _flt ?? throw "null pointer dereference")._bias;
                    _gotoNext = 2607720i32;
                } else if (__value__ == (2606671i32)) {
                    _exp_12 = (0 : stdgo.GoInt);
                    0i32;
                    _gotoNext = 2606680i32;
                } else if (__value__ == (2606680i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._dp > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2606693i32;
                    } else {
                        _gotoNext = 2606808i32;
                    };
                    ...
                    if (((_exp_12 - (@:checkr _flt ?? throw "null pointer dereference")._bias : stdgo.GoInt) >= (((1 : stdgo.GoInt) << (@:checkr _flt ?? throw "null pointer dereference")._expbits : stdgo.GoInt) - (1 : stdgo.GoInt) : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2607272i32;
                    } else {
                        _gotoNext = 2607328i32;
                    };
                } else if (__value__ == (2607272i32)) {
                    _gotoNext = 2607635i32;
                } else if (__value__ == (2607328i32)) {
                    ...
                    if (_mant_13 == (((2i64 : stdgo.GoUInt64) << (@:checkr _flt ?? throw "null pointer dereference")._mantbits : stdgo.GoUInt64))) {
                        _gotoNext = 2607464i32;
                    } else {
                        _gotoNext = 2607571i32;
                    };
                } else if (__value__ == (2607464i32)) {
                    _mant_13 = (_mant_13 >> ((1i64 : stdgo.GoUInt64)) : stdgo.GoUInt64);
                    _exp_12++;
                    if (((_exp_12 - (@:checkr _flt ?? throw "null pointer dereference")._bias : stdgo.GoInt) >= (((1 : stdgo.GoInt) << (@:checkr _flt ?? throw "null pointer dereference")._expbits : stdgo.GoInt) - (1 : stdgo.GoInt) : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2607525i32;
                    } else {
                        _gotoNext = 2607571i32;
                    };
                } else if (__value__ == (2607525i32)) {
                    _gotoNext = 2607635i32;
                } else if (__value__ == (2607571i32)) {
                    if ((_mant_13 & (((1i64 : stdgo.GoUInt64) << (@:checkr _flt ?? throw "null pointer dereference")._mantbits : stdgo.GoUInt64)) : stdgo.GoUInt64) == ((0i64 : stdgo.GoUInt64))) {
                        _gotoNext = 2607602i32;
                    } else {
                        _gotoNext = 2607625i32;
                    };
                } else if (__value__ == (2607602i32)) {
                    _exp_12 = (@:checkr _flt ?? throw "null pointer dereference")._bias;
                    _gotoNext = 2607625i32;
                } else if (__value__ == (2607625i32)) {
                    _gotoNext = 2607720i32;
                } else if (__value__ == (2607635i32)) {
                    _mant_13 = (0i64 : stdgo.GoUInt64);
                    ...
                    if ((@:checkr _d ?? throw "null pointer dereference")._neg) {
                        _gotoNext = 2607867i32;
                    } else {
                        _gotoNext = 2607916i32;
                    };
                } else if (__value__ == (2607867i32)) {
