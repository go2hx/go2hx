        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((@:checkr _d ?? throw "null pointer dereference")._nd == ((0 : stdgo.GoInt))) {
                        _gotoNext = 2633304i32;
                    } else {
                        _gotoNext = 2633497i32;
                    };
                } else if (__value__ == (2633304i32)) {
                    _mant_13 = (0i64 : stdgo.GoUInt64);
                    _exp_12 = (@:checkr _flt ?? throw "null pointer dereference")._bias;
                    _gotoNext = 2634706i32;
                } else if (__value__ == (2633497i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._dp > (310 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2633511i32;
                    } else {
                        _gotoNext = 2633533i32;
                    };
                } else if (__value__ == (2633511i32)) {
                    _gotoNext = 2634621i32;
                } else if (__value__ == (2633533i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._dp < (-330 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2633548i32;
                    } else {
                        _gotoNext = 2633657i32;
                    };
                } else if (__value__ == (2633548i32)) {
                    _mant_13 = (0i64 : stdgo.GoUInt64);
                    _exp_12 = (@:checkr _flt ?? throw "null pointer dereference")._bias;
                    _gotoNext = 2634706i32;
                } else if (__value__ == (2633657i32)) {
                    _exp_12 = (0 : stdgo.GoInt);
                    0i32;
                    _gotoNext = 2633666i32;
                } else if (__value__ == (2633666i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._dp > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2633679i32;
                    } else {
                        _gotoNext = 2633794i32;
                    };
                } else if (__value__ == (2633679i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._dp >= (stdgo._internal.strconv.Strconv__powtab._powtab.length) : Bool)) {
                        _gotoNext = 2633718i32;
                    } else {
                        _gotoNext = 2633739i32;
                    };
                } else if (__value__ == (2633718i32)) {
                    _n_14 = (27 : stdgo.GoInt);
                    _gotoNext = 2633767i32;
                    ...
                    0i32;
                    _gotoNext = 2633767i32;
                } else if (__value__ == (2633767i32)) {
                    @:check2r _d.shift(-_n_14);
                    _exp_12 = (_exp_12 + (_n_14) : stdgo.GoInt);
                    _gotoNext = 2633666i32;
                } else if (__value__ == (2633794i32)) {
                    0i32;
                    _gotoNext = 2633794i32;
                    ...
                    if (((_exp_12 - (@:checkr _flt ?? throw "null pointer dereference")._bias : stdgo.GoInt) >= (((1 : stdgo.GoInt) << (@:checkr _flt ?? throw "null pointer dereference")._expbits : stdgo.GoInt) - (1 : stdgo.GoInt) : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2634258i32;
                    } else {
                        _gotoNext = 2634314i32;
                    };
                } else if (__value__ == (2634258i32)) {
                    _gotoNext = 2634621i32;
                } else if (__value__ == (2634314i32)) {
                    ...
                    if (_mant_13 == (((2i64 : stdgo.GoUInt64) << (@:checkr _flt ?? throw "null pointer dereference")._mantbits : stdgo.GoUInt64))) {
                        _gotoNext = 2634450i32;
                    } else {
                        _gotoNext = 2634557i32;
                    };
                } else if (__value__ == (2634450i32)) {
                    _mant_13 = (_mant_13 >> ((1i64 : stdgo.GoUInt64)) : stdgo.GoUInt64);
                    _exp_12++;
                    if (((_exp_12 - (@:checkr _flt ?? throw "null pointer dereference")._bias : stdgo.GoInt) >= (((1 : stdgo.GoInt) << (@:checkr _flt ?? throw "null pointer dereference")._expbits : stdgo.GoInt) - (1 : stdgo.GoInt) : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2634511i32;
                    } else {
                        _gotoNext = 2634557i32;
                    };
                } else if (__value__ == (2634511i32)) {
                    _gotoNext = 2634621i32;
                } else if (__value__ == (2634557i32)) {
                    if ((_mant_13 & (((1i64 : stdgo.GoUInt64) << (@:checkr _flt ?? throw "null pointer dereference")._mantbits : stdgo.GoUInt64)) : stdgo.GoUInt64) == ((0i64 : stdgo.GoUInt64))) {
                        _gotoNext = 2634588i32;
                    } else {
                        _gotoNext = 2634611i32;
                    };
                } else if (__value__ == (2634588i32)) {
                    _exp_12 = (@:checkr _flt ?? throw "null pointer dereference")._bias;
                    _gotoNext = 2634611i32;
                } else if (__value__ == (2634611i32)) {
                    _gotoNext = 2634706i32;
                } else if (__value__ == (2634621i32)) {
                    _mant_13 = (0i64 : stdgo.GoUInt64);
                    ...
                    if ((@:checkr _d ?? throw "null pointer dereference")._neg) {
                        _gotoNext = 2634853i32;
                    } else {
                        _gotoNext = 2634902i32;
                    };
                } else if (__value__ == (2634853i32)) {
