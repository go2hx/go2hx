        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    if ((@:checkr _d ?? throw "null pointer dereference")._nd == ((0 : stdgo.GoInt))) {
                        _gotoNext = 2659733i32;
                    } else {
                        _gotoNext = 2659926i32;
                    };
                } else if (__value__ == (2659733i32)) {
                    _mant_13 = (0i64 : stdgo.GoUInt64);
                    _exp_12 = (@:checkr _flt ?? throw "null pointer dereference")._bias;
                    _gotoNext = 2661135i32;
                } else if (__value__ == (2659926i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._dp > (310 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2659940i32;
                    } else {
                        _gotoNext = 2659962i32;
                    };
                } else if (__value__ == (2659940i32)) {
                    _gotoNext = 2661050i32;
                } else if (__value__ == (2659962i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._dp < (-330 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2659977i32;
                    } else {
                        _gotoNext = 2660086i32;
                    };
                } else if (__value__ == (2659977i32)) {
                    _mant_13 = (0i64 : stdgo.GoUInt64);
                    _exp_12 = (@:checkr _flt ?? throw "null pointer dereference")._bias;
                    _gotoNext = 2661135i32;
                } else if (__value__ == (2660086i32)) {
                    _exp_12 = (0 : stdgo.GoInt);
                    var __blank__ = 0i32;
                    _gotoNext = 2660095i32;
                } else if (__value__ == (2660095i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._dp > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2660108i32;
                    } else {
                        _gotoNext = 2660223i32;
                    };
                } else if (__value__ == (2660108i32)) {
                    if (((@:checkr _d ?? throw "null pointer dereference")._dp >= (stdgo._internal.strconv.Strconv__powtab._powtab.length) : Bool)) {
                        _gotoNext = 2660147i32;
                    } else {
                        _gotoNext = 2660168i32;
                    };
                } else if (__value__ == (2660147i32)) {
                    _n_14 = (27 : stdgo.GoInt);
                    _gotoNext = 2660196i32;
                } else if (__value__ == (2660168i32)) {
                    _gotoNext = 2660168i32;
                    ...
                    if ((-(@:checkr _d ?? throw "null pointer dereference")._dp >= (stdgo._internal.strconv.Strconv__powtab._powtab.length) : Bool)) {
                        _gotoNext = 2660305i32;
                    } else {
                        _gotoNext = 2660326i32;
                    };
                } else if (__value__ == (2660305i32)) {
                    _n_15 = (27 : stdgo.GoInt);
                    _gotoNext = 2660355i32;
                } else if (__value__ == (2660326i32)) {
                    _gotoNext = 2660326i32;
                    _n_15 = stdgo._internal.strconv.Strconv__powtab._powtab[(-(@:checkr _d ?? throw "null pointer dereference")._dp : stdgo.GoInt)];
                    var __blank__ = 0i32;
                    _gotoNext = 2660355i32;
                } else if (__value__ == (2660355i32)) {
                    ...
                    if ((_exp_12 < ((@:checkr _flt ?? throw "null pointer dereference")._bias + (1 : stdgo.GoInt) : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2660593i32;
                    } else {
                        _gotoNext = 2660651i32;
                    };
                } else if (__value__ == (2660593i32)) {
                    ...
                    if (((_exp_12 - (@:checkr _flt ?? throw "null pointer dereference")._bias : stdgo.GoInt) >= (((1 : stdgo.GoInt) << (@:checkr _flt ?? throw "null pointer dereference")._expbits : stdgo.GoInt) - (1 : stdgo.GoInt) : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2660687i32;
                    } else {
                        _gotoNext = 2660743i32;
                    };
                } else if (__value__ == (2660687i32)) {
                    _gotoNext = 2661050i32;
                } else if (__value__ == (2660743i32)) {
                    ...
                    if (_mant_13 == (((2i64 : stdgo.GoUInt64) << (@:checkr _flt ?? throw "null pointer dereference")._mantbits : stdgo.GoUInt64))) {
                        _gotoNext = 2660879i32;
                    } else {
                        _gotoNext = 2660986i32;
                    };
                } else if (__value__ == (2660879i32)) {
                    _mant_13 = (_mant_13 >> ((1i64 : stdgo.GoUInt64)) : stdgo.GoUInt64);
                    _exp_12++;
                    if (((_exp_12 - (@:checkr _flt ?? throw "null pointer dereference")._bias : stdgo.GoInt) >= (((1 : stdgo.GoInt) << (@:checkr _flt ?? throw "null pointer dereference")._expbits : stdgo.GoInt) - (1 : stdgo.GoInt) : stdgo.GoInt) : Bool)) {
                        _gotoNext = 2660940i32;
                    } else {
                        _gotoNext = 2660986i32;
                    };
                } else if (__value__ == (2660940i32)) {
                    _gotoNext = 2661050i32;
                } else if (__value__ == (2660986i32)) {
                    if ((_mant_13 & (((1i64 : stdgo.GoUInt64) << (@:checkr _flt ?? throw "null pointer dereference")._mantbits : stdgo.GoUInt64)) : stdgo.GoUInt64) == ((0i64 : stdgo.GoUInt64))) {
                        _gotoNext = 2661017i32;
                    } else {
                        _gotoNext = 2661040i32;
                    };
                } else if (__value__ == (2661017i32)) {
                    _exp_12 = (@:checkr _flt ?? throw "null pointer dereference")._bias;
                    _gotoNext = 2661040i32;
                } else if (__value__ == (2661040i32)) {
                    _gotoNext = 2661135i32;
                } else if (__value__ == (2661050i32)) {
                    _mant_13 = (0i64 : stdgo.GoUInt64);
                    ...
                    if ((@:checkr _d ?? throw "null pointer dereference")._neg) {
                        _gotoNext = 2661282i32;
                    } else {
                        _gotoNext = 2661331i32;
                    };
                } else if (__value__ == (2661282i32)) {
