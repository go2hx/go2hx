...
@:keep @:allow(stdgo._internal.strings.Strings.T_byteReplacer_asInterface) class T_byteReplacer_static_extension {
    ...
    static public function writeString( _r:stdgo.Ref<stdgo._internal.strings.Strings_t_bytereplacer.T_byteReplacer>, _w:stdgo._internal.io.Io_writer.Writer, _s:stdgo.GoString):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L460"
        {
            var _i = (0 : stdgo.GoInt);
            while ((_i < (_s.length) : Bool)) {
                var _b = (_s[(_i : stdgo.GoInt)] : stdgo.GoUInt8);
//"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L462"
                if (_r[(_b : stdgo.GoInt)] == (_b)) {
                    //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L463"
                    {
                        _i++;
                        continue;
                    };
                };
//"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L465"
                if (_last != (_i)) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L468"
                    if (_err != null) {
                        //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L469"
                        return {
...
//"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L475"
                if (_err != null) {
                    //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L476"
                    return {
                        @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } = { _0 : _n, _1 : _err };
                        _n = __tmp__._0;
                        _err = __tmp__._1;
        ...
        //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L479"
        if (_last != ((_s.length))) {
            ...
            _n = (_n + (_nw) : stdgo.GoInt);
            //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L482"
            if (_err != null) {
                //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L483"
                return {
                    @:typeReturnStmt2 final __tmp__:{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } = { _0 : _n, _1 : _err };
                    _n = __tmp__._0;
                    _err = __tmp__._1;
        ...
        //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L486"
        return {
    ...
    static public function replace( _r:stdgo.Ref<stdgo._internal.strings.Strings_t_bytereplacer.T_byteReplacer>, _s:stdgo.GoString):stdgo.GoString {
        ...
        //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L442"
        {
            var _i = (0 : stdgo.GoInt);
            while ((_i < (_s.length) : Bool)) {
                var _b = (_s[(_i : stdgo.GoInt)] : stdgo.GoUInt8);
//"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L444"
                if (_r[(_b : stdgo.GoInt)] != (_b)) {
                    //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L445"
                    if (_buf == null) {
        ...
        //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L451"
        if (_buf == null) {
            //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L452"
            return _s?.__copy__();
        };
        //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L454"
