...
@:keep @:allow(stdgo._internal.strings.Strings.T_genericReplacer_asInterface) class T_genericReplacer_static_extension {
    ...
    static public function writeString( _r:stdgo.Ref<stdgo._internal.strings.Strings_t_genericreplacer.T_genericReplacer>, _w:stdgo._internal.io.Io_writer.Writer, _s:stdgo.GoString):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L340"
        {
            var _i = (0 : stdgo.GoInt);
            while ((_i <= (_s.length) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L342"
                if (((_i != (_s.length)) && ((@:checkr _r ?? throw "null pointer dereference")._root._priority == (0 : stdgo.GoInt)) : Bool)) {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L344"
                    if (((_index == (@:checkr _r ?? throw "null pointer dereference")._tableSize) || ({
                        ...
                        //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L345"
                        _i++;
                        //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L346"
                        continue;
                    };
                };
                ...
                //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L353"
                if (_match) {
                    {
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L356"
                    if (_err != null) {
                        //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L357"
                    ...
                    _n = (_n + (_wn) : stdgo.GoInt);
                    //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L361"
                    if (_err != null) {
                        //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L362"
                        return { _0 : _n, _1 : _err };
                    };
                    _i = (_i + (_keylen) : stdgo.GoInt);
                    _last = _i;
                    //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L366"
                    continue;
                };
                //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L368"
                _i++;
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L370"
        if (_last != ((_s.length))) {
            {
        ...
        //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L374"
        return { _0 : _n, _1 : _err };
    }
    @:keep
    @:tdfield
    static public function replace( _r:stdgo.Ref<stdgo._internal.strings.Strings_t_genericreplacer.T_genericReplacer>, _s:stdgo.GoString):stdgo.GoString {
        ...
        //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L332"
        ...
        //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L333"
    ...
    static public function _lookup( _r:stdgo.Ref<stdgo._internal.strings.Strings_t_genericreplacer.T_genericReplacer>, _s:stdgo.GoString, _ignoreRoot:Bool):{ var _0 : stdgo.GoString; var _1 : stdgo.GoInt; var _2 : Bool; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L227"
        while (({
            final value = _node;
            (value != null && ((value : Dynamic).__nil__ == null || !(value : Dynamic).__nil__));
        })) {
            //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L228"
            ...
            //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L235"
            if (_s == ((stdgo.Go.str() : stdgo.GoString))) {
                //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L236"
                break;
            };
            //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L238"
            if ((@:checkr _node ?? throw "null pointer dereference")._table != null) {
                ...
                //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L240"
                if ((_index : stdgo.GoInt) == ((@:checkr _r ?? throw "null pointer dereference")._tableSize)) {
                    //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L241"
                    break;
                };
                _node = (@:checkr _node ?? throw "null pointer dereference")._table[(_index : stdgo.GoInt)];
                _s = (_s.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L245"
                _n++;
                ...
                //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L251"
                break;
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/strings/replace.go#L254"
    ...
    static public function _printNode( _r:stdgo.Ref<stdgo._internal.strings.Strings_t_genericreplacer.T_genericReplacer>, _t:stdgo.Ref<stdgo._internal.strings.Strings_t_trienode.T_trieNode>, _depth:stdgo.GoInt):stdgo.GoString {
        ...
        //"file:///home/runner/.go/go1.21.3/src/strings/export_test.go#L19"
        ...
        //"file:///home/runner/.go/go1.21.3/src/strings/export_test.go#L26"
        if ((@:checkr _t ?? throw "null pointer dereference")._prefix != ((stdgo.Go.str() : stdgo.GoString))) {
            ...
            _s = (_s + (_r._printNode((@:checkr _t ?? throw "null pointer dereference")._next, (_depth + ((@:checkr _t ?? throw "null pointer dereference")._prefix.length) : stdgo.GoInt)))?.__copy__() : stdgo.GoString);
        } else if ((@:checkr _t ?? throw "null pointer dereference")._table != null) {
            //"file:///home/runner/.go/go1.21.3/src/strings/export_test.go#L30"
            for (_b => _m in (@:checkr _r ?? throw "null pointer dereference")._mapping.__copy__()) {
                //"file:///home/runner/.go/go1.21.3/src/strings/export_test.go#L31"
                if ((((_m : stdgo.GoInt) != (@:checkr _r ?? throw "null pointer dereference")._tableSize) && ({
                    ...
                    _s = (_s + (_r._printNode((@:checkr _t ?? throw "null pointer dereference")._table[(_m : stdgo.GoInt)], (_depth + (1 : stdgo.GoInt) : stdgo.GoInt)))?.__copy__() : stdgo.GoString);
                };
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/strings/export_test.go#L37"
        return _s;
    }
}
