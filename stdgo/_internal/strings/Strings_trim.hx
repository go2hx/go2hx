...
function trim(_s:stdgo.GoString, _cutset:stdgo.GoString):stdgo.GoString {
        ...
        };
        {
            ...
            if (_ok) {
                ...
                var _as__pointer__ = (stdgo.Go.setRef(_as) : stdgo.Ref<stdgo._internal.strings.Strings_T_asciiSet.T_asciiSet>);
                var _as__pointer__ = (stdgo.Go.setRef(_as) : stdgo.Ref<stdgo._internal.strings.Strings_T_asciiSet.T_asciiSet>);
                return stdgo._internal.strings.Strings__trimLeftASCII._trimLeftASCII(stdgo._internal.strings.Strings__trimRightASCII._trimRightASCII(_s?.__copy__(), _as__pointer__)?.__copy__(), _as__pointer__)?.__copy__();
            };
        };
