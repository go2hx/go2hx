...
@:structInit class T_testReplacer_5___localname___testCase {
    ...
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() {
        return new T_testReplacer_5___localname___testCase(_r, _in, _out);
    }
}
function testReplacer(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        return;
        {};
        var _testCases:stdgo.Slice<T_testReplacer_5___localname___testCase> = (null : stdgo.Slice<stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase>);
        ...
        _s = (null : stdgo.Slice<stdgo.GoString>);
        {
            ...
            stdgo.Go.cfor((_i < (256 : stdgo.GoInt) : Bool), _i++, {
                _s = (_s.__append__(_str((_i : stdgo.GoByte)), _str(((_i + (1 : stdgo.GoInt) : stdgo.GoInt) : stdgo.GoByte))));
            });
        };
        var _inc = newReplacer(...(_s : Array<stdgo.GoString>));
        _testCases = (_testCases.__append__((new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_capitalLetters, ("brad" : stdgo.GoString), ("BrAd" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_capitalLetters, repeat(("a" : stdgo.GoString), (32891 : stdgo.GoInt))?.__copy__(), repeat(("A" : stdgo.GoString), (32891 : stdgo.GoInt))?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_capitalLetters, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_inc, ("brad" : stdgo.GoString), ("csbe" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_inc, stdgo.Go.str(0, 255)?.__copy__(), stdgo.Go.str(1, 0)?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_inc, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(newReplacer(("a" : stdgo.GoString), ("1" : stdgo.GoString), ("a" : stdgo.GoString), ("2" : stdgo.GoString)), ("brad" : stdgo.GoString), ("br1d" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase)));
        _s = (null : stdgo.Slice<stdgo.GoString>);
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor((_i < (256 : stdgo.GoInt) : Bool), _i++, {
                var _n:stdgo.GoInt = ((_i + (1 : stdgo.GoInt) : stdgo.GoInt) - (97 : stdgo.GoInt) : stdgo.GoInt);
                if ((_n < (1 : stdgo.GoInt) : Bool)) {
                    _n = (1 : stdgo.GoInt);
                };
                _s = (_s.__append__(_str((_i : stdgo.GoByte)), repeat(_str((_i : stdgo.GoByte))?.__copy__(), _n)));
            });
        };
        var _repeat = newReplacer(...(_s : Array<stdgo.GoString>));
        _testCases = (_testCases.__append__((new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_htmlEscaper, ("No changes" : stdgo.GoString), ("No changes" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_htmlEscaper, ("I <3 escaping & stuff" : stdgo.GoString), ("I &lt;3 escaping &amp; stuff" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_htmlEscaper, ("&&&" : stdgo.GoString), ("&amp;&amp;&amp;" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_htmlEscaper, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_repeat, ("brad" : stdgo.GoString), ("bbrrrrrrrrrrrrrrrrrradddd" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_repeat, ("abba" : stdgo.GoString), ("abbbba" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_repeat, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(newReplacer(("a" : stdgo.GoString), ("11" : stdgo.GoString), ("a" : stdgo.GoString), ("22" : stdgo.GoString)), ("brad" : stdgo.GoString), ("br11d" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase)));
        _testCases = (_testCases.__append__((new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_htmlUnescaper, ("&amp;amp;" : stdgo.GoString), ("&amp;" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_htmlUnescaper, ("&lt;b&gt;HTML&apos;s neat&lt;/b&gt;" : stdgo.GoString), ("<b>HTML\'s neat</b>" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_htmlUnescaper, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(newReplacer(("a" : stdgo.GoString), ("1" : stdgo.GoString), ("a" : stdgo.GoString), ("2" : stdgo.GoString), ("xxx" : stdgo.GoString), ("xxx" : stdgo.GoString)), ("brad" : stdgo.GoString), ("br1d" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(newReplacer(("a" : stdgo.GoString), ("1" : stdgo.GoString), ("aa" : stdgo.GoString), ("2" : stdgo.GoString), ("aaa" : stdgo.GoString), ("3" : stdgo.GoString)), ("aaaa" : stdgo.GoString), ("1111" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(newReplacer(("aaa" : stdgo.GoString), ("3" : stdgo.GoString), ("aa" : stdgo.GoString), ("2" : stdgo.GoString), ("a" : stdgo.GoString), ("1" : stdgo.GoString)), ("aaaa" : stdgo.GoString), ("31" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase)));
...
("Y" : stdgo.GoString),
("Z" : stdgo.GoString));
        _testCases = (_testCases.__append__((new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_gen1, ("fooaaabar" : stdgo.GoString), ("foo3[aaa]b1[a]r" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_gen1, ("long, longerst, longer" : stdgo.GoString), ("short, most long, medium" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_gen1, ("xxxxx" : stdgo.GoString), ("xxxxX" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_gen1, ("XiX" : stdgo.GoString), ("YiY" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_gen1, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase)));
        ...
        _testCases = (_testCases.__append__((new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_gen2, ("roses are red, violets are blue..." : stdgo.GoString), ("red are red, blue are blue..." : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_gen2, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase)));
        ...
        _testCases = (_testCases.__append__((new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_gen3, ("abracadabrakazam abraham" : stdgo.GoString), ("poofkazam lincoln" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_gen3, ("abrasion abracad" : stdgo.GoString), ("scrape abracad" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_gen3, ("abba abram abrasive" : stdgo.GoString), ("abba abram abrasive" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_gen3, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase)));
        ...
        _testCases = (_testCases.__append__((new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_foo1, ("fofoofoo12foo32oo" : stdgo.GoString), ("fofooA2C2oo" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_foo1, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_foo2, ("fofoofoo12foo32oo" : stdgo.GoString), ("fofooA2Doo" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_foo2, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_foo3, ("fofoofoo12foo32oo" : stdgo.GoString), ("fofooBDoo" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_foo3, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_foo4, ("fofoofoo12foo32oo" : stdgo.GoString), ("fofooBDoo" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_foo4, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase)));
        ...
        _testCases = (_testCases.__append__((new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_genAll, _allString?.__copy__(), ("[all]" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_genAll, ((stdgo.Go.str("a", 255) + _allString?.__copy__() : stdgo.GoString) + stdgo.Go.str(0)?.__copy__() : stdgo.GoString)?.__copy__(), ("a[ff][all][00]" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_genAll, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase)));
        ...
        _testCases = (_testCases.__append__((new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankToX1, ("foo" : stdgo.GoString), ("XfXoXoX" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankToX1, stdgo.Go.str()?.__copy__(), ("X" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankToX2, ("foo" : stdgo.GoString), ("XfXoXoX" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankToX2, stdgo.Go.str()?.__copy__(), ("X" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankHighPriority, ("oo" : stdgo.GoString), ("XOXOX" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankHighPriority, ("ii" : stdgo.GoString), ("XiXiX" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankHighPriority, ("oiio" : stdgo.GoString), ("XOXiXiXOX" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankHighPriority, ("iooi" : stdgo.GoString), ("XiXOXOXiX" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankHighPriority, stdgo.Go.str()?.__copy__(), ("X" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankLowPriority, ("oo" : stdgo.GoString), ("OOX" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankLowPriority, ("ii" : stdgo.GoString), ("XiXiX" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankLowPriority, ("oiio" : stdgo.GoString), ("OXiXiOX" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankLowPriority, ("iooi" : stdgo.GoString), ("XiOOXiX" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankLowPriority, stdgo.Go.str()?.__copy__(), ("X" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankNoOp1, ("foo" : stdgo.GoString), ("foo" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankNoOp1, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankNoOp2, ("foo" : stdgo.GoString), ("foo" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankNoOp2, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankFoo, ("foobarfoobaz" : stdgo.GoString), ("XRXZX" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankFoo, ("foobar-foobaz" : stdgo.GoString), ("XRX-XZX" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase),
(new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_blankFoo, stdgo.Go.str()?.__copy__(), ("X" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase)));
        var _abcMatcher = newReplacer(("abc" : stdgo.GoString), ("[match]" : stdgo.GoString));
        _testCases = (_testCases.__append__((new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_abcMatcher, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_abcMatcher, ("ab" : stdgo.GoString), ("ab" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_abcMatcher, ("abc" : stdgo.GoString), ("[match]" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_abcMatcher, ("abcd" : stdgo.GoString), ("[match]d" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_abcMatcher, ("cabcabcdabca" : stdgo.GoString), ("c[match][match]d[match]a" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase)));
        var _noHello = newReplacer(("Hello" : stdgo.GoString), stdgo.Go.str()?.__copy__());
        _testCases = (_testCases.__append__((new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_noHello, ("Hello" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_noHello, ("Hellox" : stdgo.GoString), ("x" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_noHello, ("xHello" : stdgo.GoString), ("x" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_noHello, ("xHellox" : stdgo.GoString), ("xx" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase)));
        var _nop = newReplacer();
        _testCases = (_testCases.__append__((new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_nop, ("abc" : stdgo.GoString), ("abc" : stdgo.GoString)) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase), (new stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase(_nop, stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo._internal.strings_test.Strings_test.T_testReplacer_5___localname___testCase)));
...
function testGenericTrieBuilding(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        for (__0 => _tc in _testCases) {
            ...
            var _got:stdgo.GoString = newReplacer(...(_args : Array<stdgo.GoString>)).printTrie()?.__copy__();
...
function benchmarkGenericNoMatch(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        var _str:stdgo.GoString = (repeat(("A" : stdgo.GoString), (100 : stdgo.GoInt)) + repeat(("B" : stdgo.GoString), (100 : stdgo.GoInt))?.__copy__() : stdgo.GoString)?.__copy__();
...
function benchmarkByteStringMatch(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        var _str:stdgo.GoString = (((("<" : stdgo.GoString) + repeat(("a" : stdgo.GoString), (99 : stdgo.GoInt))?.__copy__() : stdgo.GoString) + repeat(("b" : stdgo.GoString), (99 : stdgo.GoInt))?.__copy__() : stdgo.GoString) + (">" : stdgo.GoString)?.__copy__() : stdgo.GoString)?.__copy__();
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor((_i < _b.n : Bool), _i++, {
...
function testIndexRandom(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        {};
        {
            ...
            stdgo.Go.cfor((_times < (10 : stdgo.GoInt) : Bool), _times++, {
                {
                    var _strLen:stdgo.GoInt = ((5 : stdgo.GoInt) + stdgo._internal.math.rand.Rand.intn((5 : stdgo.GoInt)) : stdgo.GoInt);
                    stdgo.Go.cfor((_strLen < (140 : stdgo.GoInt) : Bool), _strLen = (_strLen + ((10 : stdgo.GoInt)) : stdgo.GoInt), {
                        ...
                        var _s:stdgo.GoString = (_s1 : stdgo.GoString)?.__copy__();
                        {
                            ...
                            stdgo.Go.cfor((_i < (50 : stdgo.GoInt) : Bool), _i++, {
                                var _begin:stdgo.GoInt = stdgo._internal.math.rand.Rand.intn(((_s.length) + (1 : stdgo.GoInt) : stdgo.GoInt));
                                var _end:stdgo.GoInt = (_begin + stdgo._internal.math.rand.Rand.intn((((_s.length) + (1 : stdgo.GoInt) : stdgo.GoInt) - _begin : stdgo.GoInt)) : stdgo.GoInt);
                                var _sep:stdgo.GoString = (_s.__slice__(_begin, _end) : stdgo.GoString)?.__copy__();
                                if ((_i % (4 : stdgo.GoInt) : stdgo.GoInt) == ((0 : stdgo.GoInt))) {
                                    var _pos:stdgo.GoInt = stdgo._internal.math.rand.Rand.intn(((_sep.length) + (1 : stdgo.GoInt) : stdgo.GoInt));
