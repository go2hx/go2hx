...
[30;41m ERROR [0m stdgo/_internal/sync/atomic_test/Atomic_test.hx:2416: characters 57-69
 ...
 2416 | [2m        var _v:stdgo.GoUIntptr = ((stdgo.Go.toInterface([0m[1m_addr.load()[0m[2m) : stdgo._internal.unsafe.Unsafe.UnsafePointer).__convert__(stdgo._internal.internal.reflect.Reflect.GoType.basic(uintptr_kind)) : stdgo.GoUIntptr);[0m
      ...
      [30;41m -> [0m stdgo/_internal/sync/atomic_test/Atomic_test.hx:2416: characters 36-70

       2416 | [2m        var _v:stdgo.GoUIntptr = (([0m[1mstdgo.Go.toInterface(_addr.load())[0m[2m : stdgo._internal.unsafe.Unsafe.UnsafePointer).__convert__(stdgo._internal.internal.reflect.Reflect.GoType.basic(uintptr_kind)) : stdgo.GoUIntptr);[0m
            |                                    [31m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m
            | Called from here
