...
@:keep @:allow(stdgo._internal.sync.Sync.T_copyChecker_asInterface) class T_copyChecker_static_extension {
    @:keep
    @:pointer
    static public function _check(____:stdgo._internal.sync.Sync_T_copyChecker.T_copyChecker,  _c:stdgo.Pointer<stdgo._internal.sync.Sync_T_copyChecker.T_copyChecker>):Void {
