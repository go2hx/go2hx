...
function _storePoolChainElt(_pp:stdgo.Pointer<stdgo.Ref<stdgo._internal.sync.Sync_t_poolchainelt.T_poolChainElt>>, _v:stdgo.Ref<stdgo._internal.sync.Sync_t_poolchainelt.T_poolChainElt>):Void {
        //"file:///home/runner/.go/go1.21.3/src/sync/poolqueue.go#L221"
