...
function newPoolDequeue(_n:stdgo.GoInt):stdgo._internal.sync.Sync_pooldequeue.PoolDequeue {
        ...
        (@:checkr _d ?? throw "null pointer dereference")._headTail = _d._pack((-500u32 : stdgo.GoUInt32), (-500u32 : stdgo.GoUInt32));
        //"file:///home/runner/.go/go1.21.3/src/sync/export_test.go#L27"
