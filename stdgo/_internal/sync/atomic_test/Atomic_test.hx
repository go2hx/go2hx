...
function testStoreLoadRelAcq32(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        try {
            ...
            var _c = new stdgo.Chan<Bool>((2 : stdgo.GoInt).toBasic(), () -> false);
            {};
            var x:T_testStoreLoadRelAcq32_11___localname___Data = ({} : stdgo._internal.sync.atomic_test.Atomic_test.T_testStoreLoadRelAcq32_11___localname___Data);
            {
...
function testStoreLoadRelAcq64(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        try {
            ...
            var _c = new stdgo.Chan<Bool>((2 : stdgo.GoInt).toBasic(), () -> false);
            {};
            var x:T_testStoreLoadRelAcq64_12___localname___Data = ({} : stdgo._internal.sync.atomic_test.Atomic_test.T_testStoreLoadRelAcq64_12___localname___Data);
            {
...
function exampleValue_readMostly():Void {
        ...
        var _read:stdgo.GoString -> stdgo.GoString = function(_key:stdgo.GoString):stdgo.GoString {
            ...
            var _m1:stdgo._internal.sync.atomic_test.Atomic_test.T_exampleValue_readMostly_13___localname___Map = (stdgo.Go.typeAssert((_m.load() : T_exampleValue_readMostly_13___localname___Map)) : T_exampleValue_readMostly_13___localname___Map);
        ...
        var _insert:(stdgo.GoString, stdgo.GoString) -> Void = function(_key:stdgo.GoString, _val:stdgo.GoString):Void {
            ...
            try {
                ...
                var _m1:stdgo._internal.sync.atomic_test.Atomic_test.T_exampleValue_readMostly_13___localname___Map = (stdgo.Go.typeAssert((_m.load() : T_exampleValue_readMostly_13___localname___Map)) : T_exampleValue_readMostly_13___localname___Map);
                var _m2:stdgo._internal.sync.atomic_test.Atomic_test.T_exampleValue_readMostly_13___localname___Map = ({
                    final x = new stdgo.GoMap.GoStringMap<stdgo.GoString>();
                    x.__defaultValue__ = () -> ("" : stdgo.GoString);
                    @:mergeBlock {};
                    x;
