...
function _benchMap(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>, _bench:T_bench):Void {
        for (__4 => _m in (new stdgo.GoArray<stdgo._internal.sync_test.Sync_test.T_mapInterface>(stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo._internal.sync_test.Sync_test.DeepCopyMap() : stdgo._internal.sync_test.Sync_test.DeepCopyMap)) : stdgo.Ref<stdgo._internal.sync_test.Sync_test.DeepCopyMap>)), stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo._internal.sync_test.Sync_test.RWMutexMap() : stdgo._internal.sync_test.Sync_test.RWMutexMap)) : stdgo.Ref<stdgo._internal.sync_test.Sync_test.RWMutexMap>)), stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo._internal.sync.Sync.Map_() : stdgo._internal.sync.Sync.Map_)) : stdgo.Ref<stdgo._internal.sync.Sync.Map_>))) : stdgo.GoArray<stdgo._internal.sync_test.Sync_test.T_mapInterface>)) {
            _b.run(stdgo._internal.fmt.Fmt.sprintf(("%T" : stdgo.GoString), stdgo.Go.toInterface(_m))?.__copy__(), function(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
                ...
                _b.runParallel(function(_pb:stdgo.Ref<stdgo._internal.testing.Testing.PB>):Void {
                    var _id:stdgo.GoInt = (stdgo._internal.sync.atomic_.Atomic_.addInt64(stdgo.Go.pointer(_i), (1i64 : stdgo.GoInt64)) - (1i64 : stdgo.GoInt64) : stdgo.GoInt);
...
function _randValue(_r:stdgo.Ref<stdgo._internal.math.rand.Rand.Rand>):stdgo.AnyInterface {
        ...
        for (_i => _ in _b) {
            _b[(_i : stdgo.GoInt)] = (97 : stdgo.GoUInt8) + (stdgo._internal.math.rand.Rand.intn((26 : stdgo.GoInt)) : stdgo.GoByte);
        };
            ...
            _m.range(function(_key:stdgo.AnyInterface, _value:stdgo.AnyInterface):Bool {
                {
                    ...
                    if (!_ok || !stdgo._internal.reflect.Reflect.deepEqual(_v, _value)) {
                ...
                _m.store(stdgo.Go.toInterface((42 : stdgo.GoInt)), stdgo.Go.toInterface(_val));
                {
                    ...
                    if (!_loaded || !stdgo._internal.reflect.Reflect.deepEqual(_v, stdgo.Go.toInterface(_val))) {
...
function testMutexMisuse(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        for (__4 => _test in _misuseTests) {
            ...
            if ((_err == null) || !stdgo._internal.strings.Strings.contains((_out : stdgo.GoString)?.__copy__(), ("unlocked" : stdgo.GoString))) {
...
@:structInit @:using(stdgo._internal.sync_test.Sync_test.T_benchmarkMutexUncontended_30___localname___PaddedMutex_static_extension) class T_benchmarkMutexUncontended_30___localname___PaddedMutex {
    @:embedded
...
function benchmarkMutexUncontended(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        {};
        _b.runParallel(function(_pb:stdgo.Ref<stdgo._internal.testing.Testing.PB>):Void {
            var _mu:T_benchmarkMutexUncontended_30___localname___PaddedMutex = ({} : stdgo._internal.sync_test.Sync_test.T_benchmarkMutexUncontended_30___localname___PaddedMutex);
            while (_pb.next()) {
                _mu.lock();
                _mu.unlock();
            };
        ...
        stdgo._internal.internal.Macro.controlFlow({
            ...
            @:label("loop") {
                ...
                stdgo.Go.cfor(_try < (3 : stdgo.GoInt), _try++, {
                    if ((_try == (1 : stdgo.GoInt)) && stdgo._internal.testing.Testing.short()) {
                        break;
                    };
                    ...
                    };
                    {
                        ...
                        stdgo.Go.cfor(_i < (5 : stdgo.GoInt), _i++, {
                            stdgo._internal.runtime.Runtime.gc();
                            stdgo._internal.time.Time.sleep(((_i * (100 : stdgo.GoInt)) + (10 : stdgo.GoInt) : stdgo._internal.time.Time.Duration) * (1000000i64 : stdgo._internal.time.Time.Duration));
                            {
...
function _testPoolDequeue(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>, _d:PoolDequeue):Void {
        ...
        if (!stdgo._internal.testing.Testing.short() && (_nPopHead == (0 : stdgo.GoInt))) {
                    ...
                    var a = function():Void {
                        {
                            ...
                            stdgo.Go.cfor(_p < (stdgo._internal.runtime.Runtime.gomaxprocs((0 : stdgo.GoInt)) / (2 : stdgo.GoInt)), _p++, {
...
@:structInit @:using(stdgo._internal.sync_test.Sync_test.T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex_static_extension) class T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex {
    @:embedded
...
function benchmarkRWMutexUncontended(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        {};
        _b.runParallel(function(_pb:stdgo.Ref<stdgo._internal.testing.Testing.PB>):Void {
            var _rwm:T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex = ({} : stdgo._internal.sync_test.Sync_test.T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex);
            while (_pb.next()) {
                _rwm.rlock();
                _rwm.rlock();
                _rwm.runlock();
...
function testWaitGroupAlign(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        {};
        var _x:T_testWaitGroupAlign_33___localname___X = ({} : stdgo._internal.sync_test.Sync_test.T_testWaitGroupAlign_33___localname___X);
        _x._wg.add((1 : stdgo.GoInt));
        stdgo.Go.routine(() -> {
            var a = function(_x:stdgo.Ref<T_testWaitGroupAlign_33___localname___X>):Void {
                _x._wg.done();
            };
            a((stdgo.Go.setRef(_x) : stdgo.Ref<stdgo._internal.sync_test.Sync_test.T_testWaitGroupAlign_33___localname___X>));
        });
        _x._wg.wait_();
    }
@:structInit @:using(stdgo._internal.sync_test.Sync_test.T_benchmarkWaitGroupUncontended_34___localname___PaddedWaitGroup_static_extension) class T_benchmarkWaitGroupUncontended_34___localname___PaddedWaitGroup {
    @:embedded
...
function benchmarkWaitGroupUncontended(_b:stdgo.Ref<stdgo._internal.testing.Testing.B>):Void {
        {};
        _b.runParallel(function(_pb:stdgo.Ref<stdgo._internal.testing.Testing.PB>):Void {
            var _wg:T_benchmarkWaitGroupUncontended_34___localname___PaddedWaitGroup = ({} : stdgo._internal.sync_test.Sync_test.T_benchmarkWaitGroupUncontended_34___localname___PaddedWaitGroup);
            while (_pb.next()) {
                _wg.add((1 : stdgo.GoInt));
                _wg.done();
                _wg.wait_();
...
@:keep var _ = {
        try {
            if ((stdgo._internal.os.Os.args.length == (3 : stdgo.GoInt)) && (stdgo._internal.os.Os.args[(1 : stdgo.GoInt)] == ("TESTMISUSE" : stdgo.GoString))) {
                for (__4 => _test in _misuseTests) {
...
@:keep @:allow(stdgo._internal.sync_test.Sync_test.T_benchmarkMutexUncontended_30___localname___PaddedMutex_asInterface) class T_benchmarkMutexUncontended_30___localname___PaddedMutex_static_extension {
    @:embedded
...
@:keep @:allow(stdgo._internal.sync_test.Sync_test.T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex_asInterface) class T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex_static_extension {
    @:embedded
    ...
    @:embedded
    public static function rlocker( __self__:T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex):stdgo._internal.sync.Sync.Locker return __self__.rlocker();
    @:embedded
...
@:keep @:allow(stdgo._internal.sync_test.Sync_test.T_benchmarkWaitGroupUncontended_34___localname___PaddedWaitGroup_asInterface) class T_benchmarkWaitGroupUncontended_34___localname___PaddedWaitGroup_static_extension {
    @:embedded
