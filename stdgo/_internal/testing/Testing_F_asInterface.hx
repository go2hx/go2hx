...
class F_asInterface {
    ...
    @:keep
    public dynamic function fuzz(_ff:stdgo.AnyInterface):Void __self__.value.fuzz(_ff);
    @:keep
    public dynamic function add(_args:haxe.Rest<stdgo.AnyInterface>):Void __self__.value.add(..._args);
    @:keep
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.testing.Testing_F.F>;
