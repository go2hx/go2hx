...
@:structInit @:using(stdgo._internal.testing.Testing_T__static_extension.T__static_extension) class T_ {
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_fail():() -> Void return @:check3 this._common.fail;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_helper():() -> Void return @:check3 this._common.helper;
    ...
    @:embedded
    @:embeddededffieldsffun
    public function get_skipped():() -> Bool return @:check3 this._common.skipped;
