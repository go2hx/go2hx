...
class T__asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function run(_name:stdgo.GoString, _f:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_> -> Void):Bool return @:_0 __self__.value.run(_name, _f);
    @:keep
    @:tdfield
    public dynamic function setenv(_key:stdgo.GoString, _value:stdgo.GoString):Void @:_0 __self__.value.setenv(_key, _value);
    @:keep
    @:tdfield
    public dynamic function parallel():Void @:_0 __self__.value.parallel();
    @:embedded
    ...
    var __self__ : stdgo._internal.testing.Testing_t_pointer.T_Pointer;
