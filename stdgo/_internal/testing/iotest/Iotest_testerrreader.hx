...
function testErrReader(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L240"
        for (__0 => _tt in _cases) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L242"
            _t.run(_tt._name?.__copy__(), function(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
                ...
                //"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L244"
                if (stdgo.Go.toInterface(_err) != (stdgo.Go.toInterface(_tt._err))) {
                    //"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L245"
                    _t.fatalf(("Error mismatch\nGot:  %v\nWant: %v" : stdgo.GoString), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(_tt._err));
                };
                //"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L247"
                if (_n != ((0 : stdgo.GoInt))) {
                    //"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L248"
                    _t.fatalf(("Byte count mismatch: got %d want 0" : stdgo.GoString), stdgo.Go.toInterface(_n));
                };
            });
        };
    }
