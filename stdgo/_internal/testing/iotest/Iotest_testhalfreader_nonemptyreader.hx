...
function testHalfReader_nonEmptyReader(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L70"
        ...
        //"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L75"
        if (((_err != null) || (_n != (0 : stdgo.GoInt)) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L76"
            _t.errorf(("Empty buffer read returned n=%d err=%v" : stdgo.GoString), stdgo.Go.toInterface(_n), stdgo.Go.toInterface(_err));
        };
        _b = (new stdgo.Slice<stdgo.GoUInt8>((2 : stdgo.GoInt).toBasic(), 0).__setNumber32__() : stdgo.Slice<stdgo.GoUInt8>);
        ...
        //"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L81"
        {
...
//"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L83"
                if (_err != null) {
                    //"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L84"
                    break;
                };
//"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L86"
                {
                    var __0 = (_n : stdgo.GoInt), __1 = (1 : stdgo.GoInt);
var _w = __1, _g = __0;
                    if (_g != (_w)) {
                        //"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L87"
