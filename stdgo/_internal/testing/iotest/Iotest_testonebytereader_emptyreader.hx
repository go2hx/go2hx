...
function testOneByteReader_emptyReader(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L53"
        {
            var __tmp__ = _obr.read(_b), _n:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (((_err != null) || (_n != (0 : stdgo.GoInt)) : Bool)) {
                //"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L54"
        ...
        var __tmp__ = _obr.read(_b), _n:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        //"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L59"
        {
            var __0 = (_err : stdgo.Error), __1 = (stdgo._internal.io.Io_eof.eOF : stdgo.Error);
var _w = __1, _g = __0;
            if (stdgo.Go.toInterface(_g) != (stdgo.Go.toInterface(_w))) {
                //"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L60"
                _t.errorf(("Error mismatch\n\tGot:  %v\n\tWant: %v" : stdgo.GoString), stdgo.Go.toInterface(_g), stdgo.Go.toInterface(_w));
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L62"
        {
            var __0 = (_n : stdgo.GoInt), __1 = (0 : stdgo.GoInt);
var _w = __1, _g = __0;
            if (_g != (_w)) {
                //"file:///home/runner/.go/go1.21.3/src/testing/iotest/reader_test.go#L63"
