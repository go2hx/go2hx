...
stdgo/_internal/internal/Macro.macro.hx:54: non hxb types:,372
...
function exampleErrReader():Void {
        var _r:stdgo._internal.io.Io.Reader = stdgo._internal.testing.iotest.Iotest.errReader(stdgo._internal.errors.Errors.new_(("custom error" : stdgo.GoString)));
