...
function value(_t:stdgo._internal.reflect.Reflect.Type_, _rand:stdgo.Ref<stdgo._internal.math.rand.Rand.Rand>):{ var _0 : stdgo._internal.reflect.Reflect.Value; var _1 : Bool; } {
        var _value:stdgo._internal.reflect.Reflect.Value = ({} : stdgo._internal.reflect.Reflect.Value), _ok:Bool = false;
...
function _sizedValue(_t:stdgo._internal.reflect.Reflect.Type_, _rand:stdgo.Ref<stdgo._internal.math.rand.Rand.Rand>, _size:stdgo.GoInt):{ var _0 : stdgo._internal.reflect.Reflect.Value; var _1 : Bool; } {
        ...
        var _v:stdgo._internal.reflect.Reflect.Value = stdgo._internal.reflect.Reflect.new_(_t).elem()?.__copy__();
        {
            var _concrete:stdgo._internal.reflect.Reflect.Type_ = _t;
            {
...
function check(_f:stdgo.AnyInterface, _config:stdgo.Ref<Config>):stdgo.Error {
        ...
        var _arguments = new stdgo.Slice<stdgo._internal.reflect.Reflect.Value>((_fType.numIn() : stdgo.GoInt).toBasic(), 0, ...[for (i in 0 ... ((_fType.numIn() : stdgo.GoInt).toBasic() > 0 ? (_fType.numIn() : stdgo.GoInt).toBasic() : 0 : stdgo.GoInt).toBasic()) ({} : stdgo._internal.reflect.Reflect.Value)]);
        ...
        var _maxCount:stdgo.GoInt = _config._getMaxCount();
        {
            ...
            stdgo.Go.cfor(_i < _maxCount, _i++, {
                ...
                if (!_fVal.call(_arguments)[(0 : stdgo.GoInt)].bool_()) {
                    return stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo._internal.testing.quick.Quick.CheckError(_i + (1 : stdgo.GoInt), _toInterfaces(_arguments)) : stdgo._internal.testing.quick.Quick.CheckError)) : stdgo.Ref<stdgo._internal.testing.quick.Quick.CheckError>));
                };
            });
        };
...
function checkEqual(_f:stdgo.AnyInterface, _g:stdgo.AnyInterface, _config:stdgo.Ref<Config>):stdgo.Error {
        ...
        var _arguments = new stdgo.Slice<stdgo._internal.reflect.Reflect.Value>((_xType.numIn() : stdgo.GoInt).toBasic(), 0, ...[for (i in 0 ... ((_xType.numIn() : stdgo.GoInt).toBasic() > 0 ? (_xType.numIn() : stdgo.GoInt).toBasic() : 0 : stdgo.GoInt).toBasic()) ({} : stdgo._internal.reflect.Reflect.Value)]);
        var _rand = _config._getRand();
        var _maxCount:stdgo.GoInt = _config._getMaxCount();
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
...
function _functionAndType(_f:stdgo.AnyInterface):{ var _0 : stdgo._internal.reflect.Reflect.Value; var _1 : stdgo._internal.reflect.Reflect.Type_; var _2 : Bool; } {
        var _v:stdgo._internal.reflect.Reflect.Value = ({} : stdgo._internal.reflect.Reflect.Value), _t:stdgo._internal.reflect.Reflect.Type_ = (null : stdgo._internal.reflect.Reflect.Type_), _ok:Bool = false;
...
@:structInit class T_testRecursive_35___localname___R {
    public var ptr : stdgo.Ref<stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R> = (null : stdgo.Ref<stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>);
    public var sliceP : stdgo.Slice<stdgo.Ref<stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>> = (null : stdgo.Slice<stdgo.Ref<stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>>);
    public var slice : stdgo.Slice<stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R> = (null : stdgo.Slice<stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>);
    public var map_ : stdgo.GoMap<stdgo.GoInt, stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R> = (null : stdgo.GoMap<stdgo.GoInt, stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>);
    public var mapP : stdgo.GoMap<stdgo.GoInt, stdgo.Ref<stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>> = (null : stdgo.GoMap<stdgo.GoInt, stdgo.Ref<stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>>);
    public var mapR : stdgo.GoMap<stdgo.Ref<stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>, stdgo.Ref<stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>> = (null : stdgo.GoMap<stdgo.Ref<stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>, stdgo.Ref<stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>>);
    public var sliceMap : stdgo.Slice<stdgo.GoMap<stdgo.GoInt, stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>> = (null : stdgo.Slice<stdgo.GoMap<stdgo.GoInt, stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>>);
    public function new(?ptr:stdgo.Ref<stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>, ?sliceP:stdgo.Slice<stdgo.Ref<stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>>, ?slice:stdgo.Slice<stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>, ?map_:stdgo.GoMap<stdgo.GoInt, stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>, ?mapP:stdgo.GoMap<stdgo.GoInt, stdgo.Ref<stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>>, ?mapR:stdgo.GoMap<stdgo.Ref<stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>, stdgo.Ref<stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>>, ?sliceMap:stdgo.Slice<stdgo.GoMap<stdgo.GoInt, stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R>>) {
    ...
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() {
        return new T_testRecursive_35___localname___R(ptr, sliceP, slice, map_, mapP, mapR, sliceMap);
    }
}
function testRecursive(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        {};
        var _f:stdgo._internal.testing.quick.Quick.T_testRecursive_35___localname___R -> Bool = function(_r:T_testRecursive_35___localname___R):Bool {
            return true;
        };
...
function testMutuallyRecursive(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        var _f:stdgo._internal.testing.quick.Quick.A -> Bool = function(_a:A):Bool {
            return true;
        };
        check(stdgo.Go.toInterface(_f), null);
    }
@:structInit class T_testNonZeroSliceAndMap_36___localname___Q {
    ...
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() {
        return new T_testNonZeroSliceAndMap_36___localname___Q(m, s);
    }
}
function testNonZeroSliceAndMap(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        {};
        var _f:stdgo._internal.testing.quick.Quick.T_testNonZeroSliceAndMap_36___localname___Q -> Bool = function(_q:T_testNonZeroSliceAndMap_36___localname___Q):Bool {
