...
@:keep @:allow(stdgo._internal.text.scanner.Scanner.Scanner_asInterface) class Scanner_static_extension {
    ...
    static public function scan( _s:stdgo.Ref<stdgo._internal.text.scanner.Scanner_Scanner.Scanner>):stdgo.GoInt32 {
        @:recv var _s:stdgo.Ref<stdgo._internal.text.scanner.Scanner_Scanner.Scanner> = _s;
        var _tok_4210404:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _redoBreak = false;
        var _ch_4209705:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4209779i32;
                } else if (__value__ == (4209779i32)) {
                    var __blank__ = 0i32;
                    _redoBreak = false;
                    _gotoNext = 4209807i32;
                } else if (__value__ == (4209807i32)) {
                    if (!_redoBreak && ((_s.whitespace & (((1i64 : stdgo.GoUInt64) << (_ch_4209705 : stdgo.GoUInt) : stdgo.GoUInt64)) : stdgo.GoUInt64) != (0i64 : stdgo.GoUInt64))) {
                        _gotoNext = 4209843i32;
                    } else {
                        _gotoNext = 4209898i32;
                    };
                } else if (__value__ == (4209843i32)) {
                    _ch_4209705 = _s._next();
                    _gotoNext = 4209807i32;
                } else if (__value__ == (4209898i32)) {
                    _s._tokBuf.reset();
                    _s._tokPos = (_s._srcPos - _s._lastCharLen : stdgo.GoInt);
                    _s.position.offset = (_s._srcBufOffset + _s._tokPos : stdgo.GoInt);
                    if ((_s._column > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4210095i32;
                    } else {
                        _gotoNext = 4210193i32;
                    };
                } else if (__value__ == (4210095i32)) {
                    _s.position.line = _s._line;
                    _s.position.column = _s._column;
                    _gotoNext = 4210404i32;
                } else if (__value__ == (4210193i32)) {
                    _gotoNext = 4210193i32;
                    _s.position.line = (_s._line - (1 : stdgo.GoInt) : stdgo.GoInt);
                    _s.position.column = _s._lastLineLen;
                    var __blank__ = 0i32;
                    _gotoNext = 4210404i32;
                } else if (__value__ == (4210404i32)) {
                    _tok_4210404 = _ch_4209705;
                    _gotoNext = 4210415i32;
                } else if (__value__ == (4210415i32)) {
                    if (_s._isIdentRune(_ch_4209705, (0 : stdgo.GoInt))) {
                        _gotoNext = 4210425i32;
                    } else if (stdgo._internal.text.scanner.Scanner__isDecimal._isDecimal(_ch_4209705)) {
                        _gotoNext = 4210557i32;
                    } else {
                        _gotoNext = 4210688i32;
                    };
                } else if (__value__ == (4210425i32)) {
                    if ((_s.mode & (4u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4210480i32;
                    } else {
                        _gotoNext = 4210533i32;
                    };
                } else if (__value__ == (4210480i32)) {
                    _tok_4210404 = (-2 : stdgo.GoInt32);
                    _ch_4209705 = _s._scanIdentifier();
                    _gotoNext = 4211493i32;
                } else if (__value__ == (4210533i32)) {
                    _gotoNext = 4210533i32;
                    _ch_4209705 = _s._next();
                    var __blank__ = 0i32;
                    _gotoNext = 4211493i32;
                } else if (__value__ == (4210557i32)) {
                    if ((_s.mode & (24u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4210616i32;
                    } else {
                        _gotoNext = 4210664i32;
                    };
                } else if (__value__ == (4210616i32)) {
                    {
                        var __tmp__ = _s._scanNumber(_ch_4209705, false);
                        _tok_4210404 = __tmp__._0;
                        _ch_4209705 = __tmp__._1;
                    };
                    _gotoNext = 4211493i32;
                } else if (__value__ == (4210664i32)) {
                    _gotoNext = 4210664i32;
                    _ch_4209705 = _s._next();
                    var __blank__ = 0i32;
                    _gotoNext = 4211493i32;
                } else if (__value__ == (4210688i32)) {
                    _gotoNext = 4210699i32;
                } else if (__value__ == (4210699i32)) {
                    {
                        final __value__ = _ch_4209705;
                        if (__value__ == ((-1 : stdgo.GoInt32))) {
                            _gotoNext = 4210713i32;
                        } else if (__value__ == ((34 : stdgo.GoInt32))) {
                            _gotoNext = 4210734i32;
                        } else if (__value__ == ((39 : stdgo.GoInt32))) {
                            _gotoNext = 4210839i32;
                        } else if (__value__ == ((46 : stdgo.GoInt32))) {
                            _gotoNext = 4210936i32;
                        } else if (__value__ == ((47 : stdgo.GoInt32))) {
                            _gotoNext = 4211055i32;
                        } else if (__value__ == ((96 : stdgo.GoInt32))) {
                            _gotoNext = 4211325i32;
                        } else {
                            _gotoNext = 4211436i32;
                        };
                    };
                } else if (__value__ == (4210713i32)) {
                    _gotoNext = 4211493i32;
                } else if (__value__ == (4210734i32)) {
                    if ((_s.mode & (64u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4210774i32;
                    } else {
                        _gotoNext = 4210823i32;
                    };
                } else if (__value__ == (4210774i32)) {
                    _s._scanString((34 : stdgo.GoInt32));
                    _tok_4210404 = (-6 : stdgo.GoInt32);
                    _gotoNext = 4210823i32;
                } else if (__value__ == (4210823i32)) {
                    _ch_4209705 = _s._next();
                    _gotoNext = 4211493i32;
                } else if (__value__ == (4210839i32)) {
                    if ((_s.mode & (32u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4210878i32;
                    } else {
                        _gotoNext = 4210920i32;
                    };
                } else if (__value__ == (4210878i32)) {
                    _s._scanChar();
                    _tok_4210404 = (-5 : stdgo.GoInt32);
                    _gotoNext = 4210920i32;
                } else if (__value__ == (4210920i32)) {
                    _ch_4209705 = _s._next();
                    _gotoNext = 4211493i32;
                } else if (__value__ == (4210936i32)) {
                    _ch_4209705 = _s._next();
                    if ((stdgo._internal.text.scanner.Scanner__isDecimal._isDecimal(_ch_4209705) && ((_s.mode & (16u32 : stdgo.GoUInt) : stdgo.GoUInt) != (0u32 : stdgo.GoUInt)) : Bool)) {
                        _gotoNext = 4211009i32;
                    } else {
                        _gotoNext = 4211493i32;
                    };
                } else if (__value__ == (4211009i32)) {
                    {
                        var __tmp__ = _s._scanNumber(_ch_4209705, true);
                        _tok_4210404 = __tmp__._0;
                        _ch_4209705 = __tmp__._1;
                    };
                    _gotoNext = 4211493i32;
                } else if (__value__ == (4211055i32)) {
                    _ch_4209705 = _s._next();
                    if (((((_ch_4209705 == (47 : stdgo.GoInt32)) || (_ch_4209705 == (42 : stdgo.GoInt32)) : Bool)) && ((_s.mode & (256u32 : stdgo.GoUInt) : stdgo.GoUInt) != (0u32 : stdgo.GoUInt)) : Bool)) {
                        _gotoNext = 4211141i32;
                    } else {
                        _gotoNext = 4211493i32;
                    };
                } else if (__value__ == (4211141i32)) {
                    if ((_s.mode & (512u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4211175i32;
                    } else {
                        _gotoNext = 4211277i32;
                    };
                } else if (__value__ == (4211175i32)) {
                    _s._tokPos = (-1 : stdgo.GoInt);
                    _ch_4209705 = _s._scanComment(_ch_4209705);
                    _gotoNext = 4209779i32;
                } else if (__value__ == (4211277i32)) {
                    _ch_4209705 = _s._scanComment(_ch_4209705);
                    _tok_4210404 = (-8 : stdgo.GoInt32);
                    _gotoNext = 4211493i32;
                } else if (__value__ == (4211325i32)) {
                    if ((_s.mode & (128u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4211368i32;
                    } else {
                        _gotoNext = 4211420i32;
                    };
                } else if (__value__ == (4211368i32)) {
                    _s._scanRawString();
                    _tok_4210404 = (-7 : stdgo.GoInt32);
                    _gotoNext = 4211420i32;
                } else if (__value__ == (4211420i32)) {
                    _ch_4209705 = _s._next();
                    _gotoNext = 4211493i32;
                } else if (__value__ == (4211436i32)) {
                    _ch_4209705 = _s._next();
                    _gotoNext = 4211493i32;
                } else if (__value__ == (4211493i32)) {
