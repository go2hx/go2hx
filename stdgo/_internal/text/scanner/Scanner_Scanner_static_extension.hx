...
@:keep @:allow(stdgo._internal.text.scanner.Scanner.Scanner_asInterface) class Scanner_static_extension {
    ...
    static public function scan( _s:stdgo.Ref<stdgo._internal.text.scanner.Scanner_Scanner.Scanner>):stdgo.GoInt32 {
        @:recv var _s:stdgo.Ref<stdgo._internal.text.scanner.Scanner_Scanner.Scanner> = _s;
        var _tok_4441269:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _redoBreak = false;
        var _ch_4440570:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4440644i32;
                } else if (__value__ == (4440644i32)) {
                    var __blank__ = 0i32;
                    _redoBreak = false;
                    _gotoNext = 4440672i32;
                } else if (__value__ == (4440672i32)) {
                    if (!_redoBreak && (((@:checkr _s ?? throw "null pointer dereference").whitespace & (((1i64 : stdgo.GoUInt64) << (_ch_4440570 : stdgo.GoUInt) : stdgo.GoUInt64)) : stdgo.GoUInt64) != (0i64 : stdgo.GoUInt64))) {
                        _gotoNext = 4440708i32;
                    } else {
                        _gotoNext = 4440763i32;
                    };
                } else if (__value__ == (4440708i32)) {
                    _ch_4440570 = @:check2r _s._next();
                    _gotoNext = 4440672i32;
                } else if (__value__ == (4440763i32)) {
                    ...
                    if (((@:checkr _s ?? throw "null pointer dereference")._column > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4440960i32;
                    } else {
                        _gotoNext = 4441058i32;
                    };
                } else if (__value__ == (4440960i32)) {
                    ...
                    _gotoNext = 4441269i32;
                } else if (__value__ == (4441058i32)) {
                    _gotoNext = 4441058i32;
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 4441269i32;
                } else if (__value__ == (4441269i32)) {
                    _tok_4441269 = _ch_4440570;
                    _gotoNext = 4441280i32;
                } else if (__value__ == (4441280i32)) {
                    if (@:check2r _s._isIdentRune(_ch_4440570, (0 : stdgo.GoInt))) {
                        _gotoNext = 4441290i32;
                    } else if (stdgo._internal.text.scanner.Scanner__isDecimal._isDecimal(_ch_4440570)) {
                        _gotoNext = 4441422i32;
                    } else {
                        _gotoNext = 4441553i32;
                    };
                } else if (__value__ == (4441290i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (4u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4441345i32;
                    } else {
                        _gotoNext = 4441398i32;
                    };
                } else if (__value__ == (4441345i32)) {
                    _tok_4441269 = (-2 : stdgo.GoInt32);
                    _ch_4440570 = @:check2r _s._scanIdentifier();
                    _gotoNext = 4442358i32;
                } else if (__value__ == (4441398i32)) {
                    _gotoNext = 4441398i32;
                    _ch_4440570 = @:check2r _s._next();
                    var __blank__ = 0i32;
                    _gotoNext = 4442358i32;
                } else if (__value__ == (4441422i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (24u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4441481i32;
                    } else {
                        _gotoNext = 4441529i32;
                    };
                } else if (__value__ == (4441481i32)) {
                    {
                        var __tmp__ = @:check2r _s._scanNumber(_ch_4440570, false);
                        _tok_4441269 = __tmp__._0;
                        _ch_4440570 = __tmp__._1;
                    };
                    _gotoNext = 4442358i32;
                } else if (__value__ == (4441529i32)) {
                    _gotoNext = 4441529i32;
                    _ch_4440570 = @:check2r _s._next();
                    var __blank__ = 0i32;
                    _gotoNext = 4442358i32;
                } else if (__value__ == (4441553i32)) {
                    _gotoNext = 4441564i32;
                } else if (__value__ == (4441564i32)) {
                    {
                        final __value__ = _ch_4440570;
                        if (__value__ == ((-1 : stdgo.GoInt32))) {
                            _gotoNext = 4441578i32;
                        } else if (__value__ == ((34 : stdgo.GoInt32))) {
                            _gotoNext = 4441599i32;
                        } else if (__value__ == ((39 : stdgo.GoInt32))) {
                            _gotoNext = 4441704i32;
                        } else if (__value__ == ((46 : stdgo.GoInt32))) {
                            _gotoNext = 4441801i32;
                        } else if (__value__ == ((47 : stdgo.GoInt32))) {
                            _gotoNext = 4441920i32;
                        } else if (__value__ == ((96 : stdgo.GoInt32))) {
                            _gotoNext = 4442190i32;
                        } else {
                            _gotoNext = 4442301i32;
                        };
                    };
                } else if (__value__ == (4441578i32)) {
                    _gotoNext = 4442358i32;
                } else if (__value__ == (4441599i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (64u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4441639i32;
                    } else {
                        _gotoNext = 4441688i32;
                    };
                } else if (__value__ == (4441639i32)) {
                    @:check2r _s._scanString((34 : stdgo.GoInt32));
                    _tok_4441269 = (-6 : stdgo.GoInt32);
                    _gotoNext = 4441688i32;
                } else if (__value__ == (4441688i32)) {
                    _ch_4440570 = @:check2r _s._next();
                    _gotoNext = 4442358i32;
                } else if (__value__ == (4441704i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (32u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4441743i32;
                    } else {
                        _gotoNext = 4441785i32;
                    };
                } else if (__value__ == (4441743i32)) {
                    @:check2r _s._scanChar();
                    _tok_4441269 = (-5 : stdgo.GoInt32);
                    _gotoNext = 4441785i32;
                } else if (__value__ == (4441785i32)) {
                    _ch_4440570 = @:check2r _s._next();
                    _gotoNext = 4442358i32;
                } else if (__value__ == (4441801i32)) {
                    _ch_4440570 = @:check2r _s._next();
                    if ((stdgo._internal.text.scanner.Scanner__isDecimal._isDecimal(_ch_4440570) && (((@:checkr _s ?? throw "null pointer dereference").mode & (16u32 : stdgo.GoUInt) : stdgo.GoUInt) != (0u32 : stdgo.GoUInt)) : Bool)) {
                        _gotoNext = 4441874i32;
                    } else {
                        _gotoNext = 4442358i32;
                    };
                } else if (__value__ == (4441874i32)) {
                    {
                        var __tmp__ = @:check2r _s._scanNumber(_ch_4440570, true);
                        _tok_4441269 = __tmp__._0;
                        _ch_4440570 = __tmp__._1;
                    };
                    _gotoNext = 4442358i32;
                } else if (__value__ == (4441920i32)) {
                    _ch_4440570 = @:check2r _s._next();
                    if (((((_ch_4440570 == (47 : stdgo.GoInt32)) || (_ch_4440570 == (42 : stdgo.GoInt32)) : Bool)) && (((@:checkr _s ?? throw "null pointer dereference").mode & (256u32 : stdgo.GoUInt) : stdgo.GoUInt) != (0u32 : stdgo.GoUInt)) : Bool)) {
                        _gotoNext = 4442006i32;
                    } else {
                        _gotoNext = 4442358i32;
                    };
                } else if (__value__ == (4442006i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (512u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4442040i32;
                    } else {
                        _gotoNext = 4442142i32;
                    };
                } else if (__value__ == (4442040i32)) {
                    (@:checkr _s ?? throw "null pointer dereference")._tokPos = (-1 : stdgo.GoInt);
                    _ch_4440570 = @:check2r _s._scanComment(_ch_4440570);
                    _gotoNext = 4440644i32;
                } else if (__value__ == (4442142i32)) {
                    _ch_4440570 = @:check2r _s._scanComment(_ch_4440570);
                    _tok_4441269 = (-8 : stdgo.GoInt32);
                    _gotoNext = 4442358i32;
                } else if (__value__ == (4442190i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (128u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4442233i32;
                    } else {
                        _gotoNext = 4442285i32;
                    };
                } else if (__value__ == (4442233i32)) {
                    @:check2r _s._scanRawString();
                    _tok_4441269 = (-7 : stdgo.GoInt32);
                    _gotoNext = 4442285i32;
                } else if (__value__ == (4442285i32)) {
                    _ch_4440570 = @:check2r _s._next();
                    _gotoNext = 4442358i32;
                } else if (__value__ == (4442301i32)) {
                    _ch_4440570 = @:check2r _s._next();
                    _gotoNext = 4442358i32;
                } else if (__value__ == (4442358i32)) {
                    ...
                    (@:checkr _s ?? throw "null pointer dereference")._ch = _ch_4440570;
                    return _tok_4441269;
                    _gotoNext = -1i32;
                };
            };
