...
@:keep @:allow(stdgo._internal.text.scanner.Scanner.Scanner_asInterface) class Scanner_static_extension {
    ...
    static public function scan( _s:stdgo.Ref<stdgo._internal.text.scanner.Scanner_Scanner.Scanner>):stdgo.GoInt32 {
        @:recv var _s:stdgo.Ref<stdgo._internal.text.scanner.Scanner_Scanner.Scanner> = _s;
        var _tok_4209081:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _redoBreak = false;
        var _ch_4208382:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4208456i32;
                } else if (__value__ == (4208456i32)) {
                    var __blank__ = 0i32;
                    _redoBreak = false;
                    _gotoNext = 4208484i32;
                } else if (__value__ == (4208484i32)) {
                    if (!_redoBreak && ((_s.whitespace & (((1i64 : stdgo.GoUInt64) << (_ch_4208382 : stdgo.GoUInt) : stdgo.GoUInt64)) : stdgo.GoUInt64) != (0i64 : stdgo.GoUInt64))) {
                        _gotoNext = 4208520i32;
                    } else {
                        _gotoNext = 4208575i32;
                    };
                } else if (__value__ == (4208520i32)) {
                    _ch_4208382 = _s._next();
                    _gotoNext = 4208484i32;
                } else if (__value__ == (4208575i32)) {
                    _s._tokBuf.reset();
                    _s._tokPos = (_s._srcPos - _s._lastCharLen : stdgo.GoInt);
                    _s.position.offset = (_s._srcBufOffset + _s._tokPos : stdgo.GoInt);
                    if ((_s._column > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4208772i32;
                    } else {
                        _gotoNext = 4208870i32;
                    };
                } else if (__value__ == (4208772i32)) {
                    _s.position.line = _s._line;
                    _s.position.column = _s._column;
                    _gotoNext = 4209081i32;
                } else if (__value__ == (4208870i32)) {
                    _gotoNext = 4208870i32;
                    _s.position.line = (_s._line - (1 : stdgo.GoInt) : stdgo.GoInt);
                    _s.position.column = _s._lastLineLen;
                    var __blank__ = 0i32;
                    _gotoNext = 4209081i32;
                } else if (__value__ == (4209081i32)) {
                    _tok_4209081 = _ch_4208382;
                    _gotoNext = 4209092i32;
                } else if (__value__ == (4209092i32)) {
                    if (_s._isIdentRune(_ch_4208382, (0 : stdgo.GoInt))) {
                        _gotoNext = 4209102i32;
                    } else if (stdgo._internal.text.scanner.Scanner__isDecimal._isDecimal(_ch_4208382)) {
                        _gotoNext = 4209234i32;
                    } else {
                        _gotoNext = 4209365i32;
                    };
                } else if (__value__ == (4209102i32)) {
                    if ((_s.mode & (4u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4209157i32;
                    } else {
                        _gotoNext = 4209210i32;
                    };
                } else if (__value__ == (4209157i32)) {
                    _tok_4209081 = (-2 : stdgo.GoInt32);
                    _ch_4208382 = _s._scanIdentifier();
                    _gotoNext = 4210170i32;
                } else if (__value__ == (4209210i32)) {
                    _gotoNext = 4209210i32;
                    _ch_4208382 = _s._next();
                    var __blank__ = 0i32;
                    _gotoNext = 4210170i32;
                } else if (__value__ == (4209234i32)) {
                    if ((_s.mode & (24u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4209293i32;
                    } else {
                        _gotoNext = 4209341i32;
                    };
                } else if (__value__ == (4209293i32)) {
                    {
                        var __tmp__ = _s._scanNumber(_ch_4208382, false);
                        _tok_4209081 = __tmp__._0;
                        _ch_4208382 = __tmp__._1;
                    };
                    _gotoNext = 4210170i32;
                } else if (__value__ == (4209341i32)) {
                    _gotoNext = 4209341i32;
                    _ch_4208382 = _s._next();
                    var __blank__ = 0i32;
                    _gotoNext = 4210170i32;
                } else if (__value__ == (4209365i32)) {
                    _gotoNext = 4209376i32;
                } else if (__value__ == (4209376i32)) {
                    {
                        final __value__ = _ch_4208382;
                        if (__value__ == ((-1 : stdgo.GoInt32))) {
                            _gotoNext = 4209390i32;
                        } else if (__value__ == ((34 : stdgo.GoInt32))) {
                            _gotoNext = 4209411i32;
                        } else if (__value__ == ((39 : stdgo.GoInt32))) {
                            _gotoNext = 4209516i32;
                        } else if (__value__ == ((46 : stdgo.GoInt32))) {
                            _gotoNext = 4209613i32;
                        } else if (__value__ == ((47 : stdgo.GoInt32))) {
                            _gotoNext = 4209732i32;
                        } else if (__value__ == ((96 : stdgo.GoInt32))) {
                            _gotoNext = 4210002i32;
                        } else {
                            _gotoNext = 4210113i32;
                        };
                    };
                } else if (__value__ == (4209390i32)) {
                    _gotoNext = 4210170i32;
                } else if (__value__ == (4209411i32)) {
                    if ((_s.mode & (64u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4209451i32;
                    } else {
                        _gotoNext = 4209500i32;
                    };
                } else if (__value__ == (4209451i32)) {
                    _s._scanString((34 : stdgo.GoInt32));
                    _tok_4209081 = (-6 : stdgo.GoInt32);
                    _gotoNext = 4209500i32;
                } else if (__value__ == (4209500i32)) {
                    _ch_4208382 = _s._next();
                    _gotoNext = 4210170i32;
                } else if (__value__ == (4209516i32)) {
                    if ((_s.mode & (32u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4209555i32;
                    } else {
                        _gotoNext = 4209597i32;
                    };
                } else if (__value__ == (4209555i32)) {
                    _s._scanChar();
                    _tok_4209081 = (-5 : stdgo.GoInt32);
                    _gotoNext = 4209597i32;
                } else if (__value__ == (4209597i32)) {
                    _ch_4208382 = _s._next();
                    _gotoNext = 4210170i32;
                } else if (__value__ == (4209613i32)) {
                    _ch_4208382 = _s._next();
                    if ((stdgo._internal.text.scanner.Scanner__isDecimal._isDecimal(_ch_4208382) && ((_s.mode & (16u32 : stdgo.GoUInt) : stdgo.GoUInt) != (0u32 : stdgo.GoUInt)) : Bool)) {
                        _gotoNext = 4209686i32;
                    } else {
                        _gotoNext = 4210170i32;
                    };
                } else if (__value__ == (4209686i32)) {
                    {
                        var __tmp__ = _s._scanNumber(_ch_4208382, true);
                        _tok_4209081 = __tmp__._0;
                        _ch_4208382 = __tmp__._1;
                    };
                    _gotoNext = 4210170i32;
                } else if (__value__ == (4209732i32)) {
                    _ch_4208382 = _s._next();
                    if (((((_ch_4208382 == (47 : stdgo.GoInt32)) || (_ch_4208382 == (42 : stdgo.GoInt32)) : Bool)) && ((_s.mode & (256u32 : stdgo.GoUInt) : stdgo.GoUInt) != (0u32 : stdgo.GoUInt)) : Bool)) {
                        _gotoNext = 4209818i32;
                    } else {
                        _gotoNext = 4210170i32;
                    };
                } else if (__value__ == (4209818i32)) {
                    if ((_s.mode & (512u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4209852i32;
                    } else {
                        _gotoNext = 4209954i32;
                    };
                } else if (__value__ == (4209852i32)) {
                    _s._tokPos = (-1 : stdgo.GoInt);
                    _ch_4208382 = _s._scanComment(_ch_4208382);
                    _gotoNext = 4208456i32;
                } else if (__value__ == (4209954i32)) {
                    _ch_4208382 = _s._scanComment(_ch_4208382);
                    _tok_4209081 = (-8 : stdgo.GoInt32);
                    _gotoNext = 4210170i32;
                } else if (__value__ == (4210002i32)) {
                    if ((_s.mode & (128u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4210045i32;
                    } else {
                        _gotoNext = 4210097i32;
                    };
                } else if (__value__ == (4210045i32)) {
                    _s._scanRawString();
                    _tok_4209081 = (-7 : stdgo.GoInt32);
                    _gotoNext = 4210097i32;
                } else if (__value__ == (4210097i32)) {
                    _ch_4208382 = _s._next();
                    _gotoNext = 4210170i32;
                } else if (__value__ == (4210113i32)) {
                    _ch_4208382 = _s._next();
                    _gotoNext = 4210170i32;
                } else if (__value__ == (4210170i32)) {
