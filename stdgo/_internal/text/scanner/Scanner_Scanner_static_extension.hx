...
@:keep @:allow(stdgo._internal.text.scanner.Scanner.Scanner_asInterface) class Scanner_static_extension {
    ...
    static public function scan( _s:stdgo.Ref<stdgo._internal.text.scanner.Scanner_Scanner.Scanner>):stdgo.GoInt32 {
        @:recv var _s:stdgo.Ref<stdgo._internal.text.scanner.Scanner_Scanner.Scanner> = _s;
        var _tok_4239490:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _redoBreak = false;
        var _ch_4238791:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4238865i32;
                } else if (__value__ == (4238865i32)) {
                    var __blank__ = 0i32;
                    _redoBreak = false;
                    _gotoNext = 4238893i32;
                } else if (__value__ == (4238893i32)) {
                    if (!_redoBreak && ((_s.whitespace & (((1i64 : stdgo.GoUInt64) << (_ch_4238791 : stdgo.GoUInt) : stdgo.GoUInt64)) : stdgo.GoUInt64) != (0i64 : stdgo.GoUInt64))) {
                        _gotoNext = 4238929i32;
                    } else {
                        _gotoNext = 4238984i32;
                    };
                } else if (__value__ == (4238929i32)) {
                    _ch_4238791 = _s._next();
                    _gotoNext = 4238893i32;
                } else if (__value__ == (4238984i32)) {
                    _s._tokBuf.reset();
                    _s._tokPos = (_s._srcPos - _s._lastCharLen : stdgo.GoInt);
                    _s.position.offset = (_s._srcBufOffset + _s._tokPos : stdgo.GoInt);
                    if ((_s._column > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4239181i32;
                    } else {
                        _gotoNext = 4239279i32;
                    };
                } else if (__value__ == (4239181i32)) {
                    _s.position.line = _s._line;
                    _s.position.column = _s._column;
                    _gotoNext = 4239490i32;
                } else if (__value__ == (4239279i32)) {
                    _s.position.line = (_s._line - (1 : stdgo.GoInt) : stdgo.GoInt);
                    _s.position.column = _s._lastLineLen;
                    _gotoNext = 4239490i32;
                } else if (__value__ == (4239490i32)) {
                    _tok_4239490 = _ch_4238791;
                    var __blank__ = 0i32;
                    _gotoNext = 4239501i32;
                } else if (__value__ == (4239501i32)) {
                    if (_s._isIdentRune(_ch_4238791, (0 : stdgo.GoInt))) {
                        _gotoNext = 4239511i32;
                    } else if (stdgo._internal.text.scanner.Scanner__isDecimal._isDecimal(_ch_4238791)) {
                        _gotoNext = 4239643i32;
                    } else {
                        _gotoNext = 4239774i32;
                    };
                } else if (__value__ == (4239511i32)) {
                    if ((_s.mode & (4u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4239566i32;
                    } else {
                        _gotoNext = 4239619i32;
                    };
                } else if (__value__ == (4239566i32)) {
                    _tok_4239490 = (-2 : stdgo.GoInt32);
                    _ch_4238791 = _s._scanIdentifier();
                    _gotoNext = 4240579i32;
                } else if (__value__ == (4239619i32)) {
                    _ch_4238791 = _s._next();
                    _gotoNext = 4240579i32;
                } else if (__value__ == (4239643i32)) {
                    if ((_s.mode & (24u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4239702i32;
                    } else {
                        _gotoNext = 4239750i32;
                    };
                } else if (__value__ == (4239702i32)) {
                    {
                        var __tmp__ = _s._scanNumber(_ch_4238791, false);
                        _tok_4239490 = __tmp__._0;
                        _ch_4238791 = __tmp__._1;
                    };
                    _gotoNext = 4240579i32;
                } else if (__value__ == (4239750i32)) {
                    _ch_4238791 = _s._next();
                    _gotoNext = 4240579i32;
                } else if (__value__ == (4239774i32)) {
                    var __blank__ = 0i32;
                    _gotoNext = 4239785i32;
                } else if (__value__ == (4239785i32)) {
                    {
                        final __value__ = _ch_4238791;
                        if (__value__ == ((-1 : stdgo.GoInt32))) {
                            _gotoNext = 4239799i32;
                        } else if (__value__ == ((34 : stdgo.GoInt32))) {
                            _gotoNext = 4239820i32;
                        } else if (__value__ == ((39 : stdgo.GoInt32))) {
                            _gotoNext = 4239925i32;
                        } else if (__value__ == ((46 : stdgo.GoInt32))) {
                            _gotoNext = 4240022i32;
                        } else if (__value__ == ((47 : stdgo.GoInt32))) {
                            _gotoNext = 4240141i32;
                        } else if (__value__ == ((96 : stdgo.GoInt32))) {
                            _gotoNext = 4240411i32;
                        } else {
                            _gotoNext = 4240522i32;
                        };
                    };
                } else if (__value__ == (4239799i32)) {
                    _gotoNext = 4240579i32;
                } else if (__value__ == (4239820i32)) {
                    if ((_s.mode & (64u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4239860i32;
                    } else {
                        _gotoNext = 4239909i32;
                    };
                } else if (__value__ == (4239860i32)) {
                    _s._scanString((34 : stdgo.GoInt32));
                    _tok_4239490 = (-6 : stdgo.GoInt32);
                    _gotoNext = 4239909i32;
                } else if (__value__ == (4239909i32)) {
                    _ch_4238791 = _s._next();
                    _gotoNext = 4240579i32;
                } else if (__value__ == (4239925i32)) {
                    if ((_s.mode & (32u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4239964i32;
                    } else {
                        _gotoNext = 4240006i32;
                    };
                } else if (__value__ == (4239964i32)) {
                    _s._scanChar();
                    _tok_4239490 = (-5 : stdgo.GoInt32);
                    _gotoNext = 4240006i32;
                } else if (__value__ == (4240006i32)) {
                    _ch_4238791 = _s._next();
                    _gotoNext = 4240579i32;
                } else if (__value__ == (4240022i32)) {
                    _ch_4238791 = _s._next();
                    if ((stdgo._internal.text.scanner.Scanner__isDecimal._isDecimal(_ch_4238791) && ((_s.mode & (16u32 : stdgo.GoUInt) : stdgo.GoUInt) != (0u32 : stdgo.GoUInt)) : Bool)) {
                        _gotoNext = 4240095i32;
                    } else {
                        _gotoNext = 4240579i32;
                    };
                } else if (__value__ == (4240095i32)) {
                    {
                        var __tmp__ = _s._scanNumber(_ch_4238791, true);
                        _tok_4239490 = __tmp__._0;
                        _ch_4238791 = __tmp__._1;
                    };
                    _gotoNext = 4240579i32;
                } else if (__value__ == (4240141i32)) {
                    _ch_4238791 = _s._next();
                    if (((((_ch_4238791 == (47 : stdgo.GoInt32)) || (_ch_4238791 == (42 : stdgo.GoInt32)) : Bool)) && ((_s.mode & (256u32 : stdgo.GoUInt) : stdgo.GoUInt) != (0u32 : stdgo.GoUInt)) : Bool)) {
                        _gotoNext = 4240227i32;
                    } else {
                        _gotoNext = 4240579i32;
                    };
                } else if (__value__ == (4240227i32)) {
                    if ((_s.mode & (512u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4240261i32;
                    } else {
                        _gotoNext = 4240363i32;
                    };
                } else if (__value__ == (4240261i32)) {
                    _s._tokPos = (-1 : stdgo.GoInt);
                    _ch_4238791 = _s._scanComment(_ch_4238791);
                    _gotoNext = 4238865i32;
                } else if (__value__ == (4240363i32)) {
                    _ch_4238791 = _s._scanComment(_ch_4238791);
                    _tok_4239490 = (-8 : stdgo.GoInt32);
                    _gotoNext = 4240579i32;
                } else if (__value__ == (4240411i32)) {
                    if ((_s.mode & (128u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4240454i32;
                    } else {
                        _gotoNext = 4240506i32;
                    };
                } else if (__value__ == (4240454i32)) {
                    _s._scanRawString();
                    _tok_4239490 = (-7 : stdgo.GoInt32);
                    _gotoNext = 4240506i32;
                } else if (__value__ == (4240506i32)) {
                    _ch_4238791 = _s._next();
                    _gotoNext = 4240579i32;
                } else if (__value__ == (4240522i32)) {
                    _ch_4238791 = _s._next();
                    _gotoNext = 4240579i32;
                } else if (__value__ == (4240579i32)) {
