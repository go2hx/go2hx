...
@:keep @:allow(stdgo._internal.text.scanner.Scanner.Scanner_asInterface) class Scanner_static_extension {
    ...
    static public function scan( _s:stdgo.Ref<stdgo._internal.text.scanner.Scanner_Scanner.Scanner>):stdgo.GoInt32 {
        @:recv var _s:stdgo.Ref<stdgo._internal.text.scanner.Scanner_Scanner.Scanner> = _s;
        var _tok_4200524:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _redoBreak = false;
        var _ch_4199825:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4199899i32;
                } else if (__value__ == (4199899i32)) {
                    var __blank__ = 0i32;
                    _redoBreak = false;
                    _gotoNext = 4199927i32;
                } else if (__value__ == (4199927i32)) {
                    if (!_redoBreak && ((_s.whitespace & (((1i64 : stdgo.GoUInt64) << (_ch_4199825 : stdgo.GoUInt) : stdgo.GoUInt64)) : stdgo.GoUInt64) != (0i64 : stdgo.GoUInt64))) {
                        _gotoNext = 4199963i32;
                    } else {
                        _gotoNext = 4200018i32;
                    };
                } else if (__value__ == (4199963i32)) {
                    _ch_4199825 = _s._next();
                    _gotoNext = 4199927i32;
                } else if (__value__ == (4200018i32)) {
                    _s._tokBuf.reset();
                    _s._tokPos = (_s._srcPos - _s._lastCharLen : stdgo.GoInt);
                    _s.position.offset = (_s._srcBufOffset + _s._tokPos : stdgo.GoInt);
                    if ((_s._column > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4200215i32;
                    } else {
                        _gotoNext = 4200313i32;
                    };
                } else if (__value__ == (4200215i32)) {
                    _s.position.line = _s._line;
                    _s.position.column = _s._column;
                    _gotoNext = 4200524i32;
                } else if (__value__ == (4200313i32)) {
                    _gotoNext = 4200313i32;
                    _s.position.line = (_s._line - (1 : stdgo.GoInt) : stdgo.GoInt);
                    _s.position.column = _s._lastLineLen;
                    var __blank__ = 0i32;
                    _gotoNext = 4200524i32;
                } else if (__value__ == (4200524i32)) {
                    _tok_4200524 = _ch_4199825;
                    _gotoNext = 4200535i32;
                } else if (__value__ == (4200535i32)) {
                    if (_s._isIdentRune(_ch_4199825, (0 : stdgo.GoInt))) {
                        _gotoNext = 4200545i32;
                    } else if (stdgo._internal.text.scanner.Scanner__isDecimal._isDecimal(_ch_4199825)) {
                        _gotoNext = 4200677i32;
                    } else {
                        _gotoNext = 4200808i32;
                    };
                } else if (__value__ == (4200545i32)) {
                    if ((_s.mode & (4u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4200600i32;
                    } else {
                        _gotoNext = 4200653i32;
                    };
                } else if (__value__ == (4200600i32)) {
                    _tok_4200524 = (-2 : stdgo.GoInt32);
                    _ch_4199825 = _s._scanIdentifier();
                    _gotoNext = 4201613i32;
                } else if (__value__ == (4200653i32)) {
                    _gotoNext = 4200653i32;
                    _ch_4199825 = _s._next();
                    var __blank__ = 0i32;
                    _gotoNext = 4201613i32;
                } else if (__value__ == (4200677i32)) {
                    if ((_s.mode & (24u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4200736i32;
                    } else {
                        _gotoNext = 4200784i32;
                    };
                } else if (__value__ == (4200736i32)) {
                    {
                        var __tmp__ = _s._scanNumber(_ch_4199825, false);
                        _tok_4200524 = __tmp__._0;
                        _ch_4199825 = __tmp__._1;
                    };
                    _gotoNext = 4201613i32;
                } else if (__value__ == (4200784i32)) {
                    _gotoNext = 4200784i32;
                    _ch_4199825 = _s._next();
                    var __blank__ = 0i32;
                    _gotoNext = 4201613i32;
                } else if (__value__ == (4200808i32)) {
                    _gotoNext = 4200819i32;
                } else if (__value__ == (4200819i32)) {
                    {
                        final __value__ = _ch_4199825;
                        if (__value__ == ((-1 : stdgo.GoInt32))) {
                            _gotoNext = 4200833i32;
                        } else if (__value__ == ((34 : stdgo.GoInt32))) {
                            _gotoNext = 4200854i32;
                        } else if (__value__ == ((39 : stdgo.GoInt32))) {
                            _gotoNext = 4200959i32;
                        } else if (__value__ == ((46 : stdgo.GoInt32))) {
                            _gotoNext = 4201056i32;
                        } else if (__value__ == ((47 : stdgo.GoInt32))) {
                            _gotoNext = 4201175i32;
                        } else if (__value__ == ((96 : stdgo.GoInt32))) {
                            _gotoNext = 4201445i32;
                        } else {
                            _gotoNext = 4201556i32;
                        };
                    };
                } else if (__value__ == (4200833i32)) {
                    _gotoNext = 4201613i32;
                } else if (__value__ == (4200854i32)) {
                    if ((_s.mode & (64u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4200894i32;
                    } else {
                        _gotoNext = 4200943i32;
                    };
                } else if (__value__ == (4200894i32)) {
                    _s._scanString((34 : stdgo.GoInt32));
                    _tok_4200524 = (-6 : stdgo.GoInt32);
                    _gotoNext = 4200943i32;
                } else if (__value__ == (4200943i32)) {
                    _ch_4199825 = _s._next();
                    _gotoNext = 4201613i32;
                } else if (__value__ == (4200959i32)) {
                    if ((_s.mode & (32u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4200998i32;
                    } else {
                        _gotoNext = 4201040i32;
                    };
                } else if (__value__ == (4200998i32)) {
                    _s._scanChar();
                    _tok_4200524 = (-5 : stdgo.GoInt32);
                    _gotoNext = 4201040i32;
                } else if (__value__ == (4201040i32)) {
                    _ch_4199825 = _s._next();
                    _gotoNext = 4201613i32;
                } else if (__value__ == (4201056i32)) {
                    _ch_4199825 = _s._next();
                    if ((stdgo._internal.text.scanner.Scanner__isDecimal._isDecimal(_ch_4199825) && ((_s.mode & (16u32 : stdgo.GoUInt) : stdgo.GoUInt) != (0u32 : stdgo.GoUInt)) : Bool)) {
                        _gotoNext = 4201129i32;
                    } else {
                        _gotoNext = 4201613i32;
                    };
                } else if (__value__ == (4201129i32)) {
                    {
                        var __tmp__ = _s._scanNumber(_ch_4199825, true);
                        _tok_4200524 = __tmp__._0;
                        _ch_4199825 = __tmp__._1;
                    };
                    _gotoNext = 4201613i32;
                } else if (__value__ == (4201175i32)) {
                    _ch_4199825 = _s._next();
                    if (((((_ch_4199825 == (47 : stdgo.GoInt32)) || (_ch_4199825 == (42 : stdgo.GoInt32)) : Bool)) && ((_s.mode & (256u32 : stdgo.GoUInt) : stdgo.GoUInt) != (0u32 : stdgo.GoUInt)) : Bool)) {
                        _gotoNext = 4201261i32;
                    } else {
                        _gotoNext = 4201613i32;
                    };
                } else if (__value__ == (4201261i32)) {
                    if ((_s.mode & (512u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4201295i32;
                    } else {
                        _gotoNext = 4201397i32;
                    };
                } else if (__value__ == (4201295i32)) {
                    _s._tokPos = (-1 : stdgo.GoInt);
                    _ch_4199825 = _s._scanComment(_ch_4199825);
                    _gotoNext = 4199899i32;
                } else if (__value__ == (4201397i32)) {
                    _ch_4199825 = _s._scanComment(_ch_4199825);
                    _tok_4200524 = (-8 : stdgo.GoInt32);
                    _gotoNext = 4201613i32;
                } else if (__value__ == (4201445i32)) {
                    if ((_s.mode & (128u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4201488i32;
                    } else {
                        _gotoNext = 4201540i32;
                    };
                } else if (__value__ == (4201488i32)) {
                    _s._scanRawString();
                    _tok_4200524 = (-7 : stdgo.GoInt32);
                    _gotoNext = 4201540i32;
                } else if (__value__ == (4201540i32)) {
                    _ch_4199825 = _s._next();
                    _gotoNext = 4201613i32;
                } else if (__value__ == (4201556i32)) {
                    _ch_4199825 = _s._next();
                    _gotoNext = 4201613i32;
                } else if (__value__ == (4201613i32)) {
