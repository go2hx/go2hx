...
@:keep @:allow(stdgo._internal.text.scanner.Scanner.Scanner_asInterface) class Scanner_static_extension {
    ...
    static public function scan( _s:stdgo.Ref<stdgo._internal.text.scanner.Scanner_scanner.Scanner>):stdgo.GoInt32 {
        @:recv var _s:stdgo.Ref<stdgo._internal.text.scanner.Scanner_scanner.Scanner> = _s;
        var _tok_4196405:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _redoBreak = false;
        var _ch_4195706:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4195780i32;
                } else if (__value__ == (4195780i32)) {
                    var __blank__ = 0i32;
                    _redoBreak = false;
                    _gotoNext = 4195808i32;
                } else if (__value__ == (4195808i32)) {
                    if (!_redoBreak && (((@:checkr _s ?? throw "null pointer dereference").whitespace & (((1i64 : stdgo.GoUInt64) << (_ch_4195706 : stdgo.GoUInt) : stdgo.GoUInt64)) : stdgo.GoUInt64) != (0i64 : stdgo.GoUInt64))) {
                        _gotoNext = 4195844i32;
                    } else {
                        _gotoNext = 4195899i32;
                    };
                } else if (__value__ == (4195844i32)) {
                    _ch_4195706 = @:check2r _s._next();
                    _gotoNext = 4195808i32;
                } else if (__value__ == (4195899i32)) {
                    ...
                    if (((@:checkr _s ?? throw "null pointer dereference")._column > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4196096i32;
                    } else {
                        _gotoNext = 4196194i32;
                    };
                } else if (__value__ == (4196096i32)) {
                    ...
                    _gotoNext = 4196405i32;
                } else if (__value__ == (4196194i32)) {
                    _gotoNext = 4196194i32;
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 4196405i32;
                } else if (__value__ == (4196405i32)) {
                    _tok_4196405 = _ch_4195706;
                    _gotoNext = 4196416i32;
                } else if (__value__ == (4196416i32)) {
                    if (@:check2r _s._isIdentRune(_ch_4195706, (0 : stdgo.GoInt))) {
                        _gotoNext = 4196426i32;
                    } else if (stdgo._internal.text.scanner.Scanner__isdecimal._isDecimal(_ch_4195706)) {
                        _gotoNext = 4196558i32;
                    } else {
                        _gotoNext = 4196689i32;
                    };
                } else if (__value__ == (4196426i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (4u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4196481i32;
                    } else {
                        _gotoNext = 4196534i32;
                    };
                } else if (__value__ == (4196481i32)) {
                    _tok_4196405 = (-2 : stdgo.GoInt32);
                    _ch_4195706 = @:check2r _s._scanIdentifier();
                    _gotoNext = 4197494i32;
                } else if (__value__ == (4196534i32)) {
                    _gotoNext = 4196534i32;
                    _ch_4195706 = @:check2r _s._next();
                    var __blank__ = 0i32;
                    _gotoNext = 4197494i32;
                } else if (__value__ == (4196558i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (24u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4196617i32;
                    } else {
                        _gotoNext = 4196665i32;
                    };
                } else if (__value__ == (4196617i32)) {
                    {
                        var __tmp__ = @:check2r _s._scanNumber(_ch_4195706, false);
                        _tok_4196405 = @:tmpset0 __tmp__._0;
                        _ch_4195706 = @:tmpset0 __tmp__._1;
                    };
                    _gotoNext = 4197494i32;
                } else if (__value__ == (4196665i32)) {
                    _gotoNext = 4196665i32;
                    _ch_4195706 = @:check2r _s._next();
                    var __blank__ = 0i32;
                    _gotoNext = 4197494i32;
                } else if (__value__ == (4196689i32)) {
                    _gotoNext = 4196700i32;
                } else if (__value__ == (4196700i32)) {
                    {
                        final __value__ = _ch_4195706;
                        if (__value__ == ((-1 : stdgo.GoInt32))) {
                            _gotoNext = 4196714i32;
                        } else if (__value__ == ((34 : stdgo.GoInt32))) {
                            _gotoNext = 4196735i32;
                        } else if (__value__ == ((39 : stdgo.GoInt32))) {
                            _gotoNext = 4196840i32;
                        } else if (__value__ == ((46 : stdgo.GoInt32))) {
                            _gotoNext = 4196937i32;
                        } else if (__value__ == ((47 : stdgo.GoInt32))) {
                            _gotoNext = 4197056i32;
                        } else if (__value__ == ((96 : stdgo.GoInt32))) {
                            _gotoNext = 4197326i32;
                        } else {
                            _gotoNext = 4197437i32;
                        };
                    };
                } else if (__value__ == (4196714i32)) {
                    _gotoNext = 4197494i32;
                } else if (__value__ == (4196735i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (64u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4196775i32;
                    } else {
                        _gotoNext = 4196824i32;
                    };
                } else if (__value__ == (4196775i32)) {
                    @:check2r _s._scanString((34 : stdgo.GoInt32));
                    _tok_4196405 = (-6 : stdgo.GoInt32);
                    _gotoNext = 4196824i32;
                } else if (__value__ == (4196824i32)) {
                    _ch_4195706 = @:check2r _s._next();
                    _gotoNext = 4197494i32;
                } else if (__value__ == (4196840i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (32u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4196879i32;
                    } else {
                        _gotoNext = 4196921i32;
                    };
                } else if (__value__ == (4196879i32)) {
                    @:check2r _s._scanChar();
                    _tok_4196405 = (-5 : stdgo.GoInt32);
                    _gotoNext = 4196921i32;
                } else if (__value__ == (4196921i32)) {
                    _ch_4195706 = @:check2r _s._next();
                    _gotoNext = 4197494i32;
                } else if (__value__ == (4196937i32)) {
                    _ch_4195706 = @:check2r _s._next();
                    if ((stdgo._internal.text.scanner.Scanner__isdecimal._isDecimal(_ch_4195706) && (((@:checkr _s ?? throw "null pointer dereference").mode & (16u32 : stdgo.GoUInt) : stdgo.GoUInt) != (0u32 : stdgo.GoUInt)) : Bool)) {
                        _gotoNext = 4197010i32;
                    } else {
                        _gotoNext = 4197494i32;
                    };
                } else if (__value__ == (4197010i32)) {
                    {
                        var __tmp__ = @:check2r _s._scanNumber(_ch_4195706, true);
                        _tok_4196405 = @:tmpset0 __tmp__._0;
                        _ch_4195706 = @:tmpset0 __tmp__._1;
                    };
                    _gotoNext = 4197494i32;
                } else if (__value__ == (4197056i32)) {
                    _ch_4195706 = @:check2r _s._next();
                    if (((((_ch_4195706 == (47 : stdgo.GoInt32)) || (_ch_4195706 == (42 : stdgo.GoInt32)) : Bool)) && (((@:checkr _s ?? throw "null pointer dereference").mode & (256u32 : stdgo.GoUInt) : stdgo.GoUInt) != (0u32 : stdgo.GoUInt)) : Bool)) {
                        _gotoNext = 4197142i32;
                    } else {
                        _gotoNext = 4197494i32;
                    };
                } else if (__value__ == (4197142i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (512u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4197176i32;
                    } else {
                        _gotoNext = 4197278i32;
                    };
                } else if (__value__ == (4197176i32)) {
                    (@:checkr _s ?? throw "null pointer dereference")._tokPos = (-1 : stdgo.GoInt);
                    _ch_4195706 = @:check2r _s._scanComment(_ch_4195706);
                    _gotoNext = 4195780i32;
                } else if (__value__ == (4197278i32)) {
                    _ch_4195706 = @:check2r _s._scanComment(_ch_4195706);
                    _tok_4196405 = (-8 : stdgo.GoInt32);
                    _gotoNext = 4197494i32;
                } else if (__value__ == (4197326i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (128u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4197369i32;
                    } else {
                        _gotoNext = 4197421i32;
                    };
                } else if (__value__ == (4197369i32)) {
                    @:check2r _s._scanRawString();
                    _tok_4196405 = (-7 : stdgo.GoInt32);
                    _gotoNext = 4197421i32;
                } else if (__value__ == (4197421i32)) {
                    _ch_4195706 = @:check2r _s._next();
                    _gotoNext = 4197494i32;
                } else if (__value__ == (4197437i32)) {
                    _ch_4195706 = @:check2r _s._next();
                    _gotoNext = 4197494i32;
                } else if (__value__ == (4197494i32)) {
                    ...
                    (@:checkr _s ?? throw "null pointer dereference")._ch = _ch_4195706;
                    return _tok_4196405;
                    _gotoNext = -1i32;
                };
            };
