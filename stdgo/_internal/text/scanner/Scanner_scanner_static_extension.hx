...
@:keep @:allow(stdgo._internal.text.scanner.Scanner.Scanner_asInterface) class Scanner_static_extension {
    ...
    static public function scan( _s:stdgo.Ref<stdgo._internal.text.scanner.Scanner_scanner.Scanner>):stdgo.GoInt32 {
        @:recv var _s:stdgo.Ref<stdgo._internal.text.scanner.Scanner_scanner.Scanner> = _s;
        var _tok_4264037:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _redoBreak = false;
        var _ch_4263338:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4263412i32;
                } else if (__value__ == (4263412i32)) {
                    var __blank__ = 0i32;
                    _redoBreak = false;
                    _gotoNext = 4263440i32;
                } else if (__value__ == (4263440i32)) {
                    if (!_redoBreak && (((@:checkr _s ?? throw "null pointer dereference").whitespace & (((1i64 : stdgo.GoUInt64) << (_ch_4263338 : stdgo.GoUInt) : stdgo.GoUInt64)) : stdgo.GoUInt64) != (0i64 : stdgo.GoUInt64))) {
                        _gotoNext = 4263476i32;
                    } else {
                        _gotoNext = 4263531i32;
                    };
                } else if (__value__ == (4263476i32)) {
                    _ch_4263338 = @:check2r _s._next();
                    _gotoNext = 4263440i32;
                } else if (__value__ == (4263531i32)) {
                    ...
                    if (((@:checkr _s ?? throw "null pointer dereference")._column > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4263728i32;
                    } else {
                        _gotoNext = 4263826i32;
                    };
                } else if (__value__ == (4263728i32)) {
                    ...
                    _gotoNext = 4264037i32;
                } else if (__value__ == (4263826i32)) {
                    _gotoNext = 4263826i32;
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 4264037i32;
                } else if (__value__ == (4264037i32)) {
                    _tok_4264037 = _ch_4263338;
                    _gotoNext = 4264048i32;
                } else if (__value__ == (4264048i32)) {
                    if (@:check2r _s._isIdentRune(_ch_4263338, (0 : stdgo.GoInt))) {
                        _gotoNext = 4264058i32;
                    } else if (stdgo._internal.text.scanner.Scanner__isdecimal._isDecimal(_ch_4263338)) {
                        _gotoNext = 4264190i32;
                    } else {
                        _gotoNext = 4264321i32;
                    };
                } else if (__value__ == (4264058i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (4u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4264113i32;
                    } else {
                        _gotoNext = 4264166i32;
                    };
                } else if (__value__ == (4264113i32)) {
                    _tok_4264037 = (-2 : stdgo.GoInt32);
                    _ch_4263338 = @:check2r _s._scanIdentifier();
                    _gotoNext = 4265126i32;
                } else if (__value__ == (4264166i32)) {
                    _gotoNext = 4264166i32;
                    _ch_4263338 = @:check2r _s._next();
                    var __blank__ = 0i32;
                    _gotoNext = 4265126i32;
                } else if (__value__ == (4264190i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (24u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4264249i32;
                    } else {
                        _gotoNext = 4264297i32;
                    };
                } else if (__value__ == (4264249i32)) {
                    {
                        var __tmp__ = @:check2r _s._scanNumber(_ch_4263338, false);
                        _tok_4264037 = @:tmpset0 __tmp__._0;
                        _ch_4263338 = @:tmpset0 __tmp__._1;
                    };
                    _gotoNext = 4265126i32;
                } else if (__value__ == (4264297i32)) {
                    _gotoNext = 4264297i32;
                    _ch_4263338 = @:check2r _s._next();
                    var __blank__ = 0i32;
                    _gotoNext = 4265126i32;
                } else if (__value__ == (4264321i32)) {
                    _gotoNext = 4264332i32;
                } else if (__value__ == (4264332i32)) {
                    {
                        final __value__ = _ch_4263338;
                        if (__value__ == ((-1 : stdgo.GoInt32))) {
                            _gotoNext = 4264346i32;
                        } else if (__value__ == ((34 : stdgo.GoInt32))) {
                            _gotoNext = 4264367i32;
                        } else if (__value__ == ((39 : stdgo.GoInt32))) {
                            _gotoNext = 4264472i32;
                        } else if (__value__ == ((46 : stdgo.GoInt32))) {
                            _gotoNext = 4264569i32;
                        } else if (__value__ == ((47 : stdgo.GoInt32))) {
                            _gotoNext = 4264688i32;
                        } else if (__value__ == ((96 : stdgo.GoInt32))) {
                            _gotoNext = 4264958i32;
                        } else {
                            _gotoNext = 4265069i32;
                        };
                    };
                } else if (__value__ == (4264346i32)) {
                    _gotoNext = 4265126i32;
                } else if (__value__ == (4264367i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (64u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4264407i32;
                    } else {
                        _gotoNext = 4264456i32;
                    };
                } else if (__value__ == (4264407i32)) {
                    @:check2r _s._scanString((34 : stdgo.GoInt32));
                    _tok_4264037 = (-6 : stdgo.GoInt32);
                    _gotoNext = 4264456i32;
                } else if (__value__ == (4264456i32)) {
                    _ch_4263338 = @:check2r _s._next();
                    _gotoNext = 4265126i32;
                } else if (__value__ == (4264472i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (32u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4264511i32;
                    } else {
                        _gotoNext = 4264553i32;
                    };
                } else if (__value__ == (4264511i32)) {
                    @:check2r _s._scanChar();
                    _tok_4264037 = (-5 : stdgo.GoInt32);
                    _gotoNext = 4264553i32;
                } else if (__value__ == (4264553i32)) {
                    _ch_4263338 = @:check2r _s._next();
                    _gotoNext = 4265126i32;
                } else if (__value__ == (4264569i32)) {
                    _ch_4263338 = @:check2r _s._next();
                    if ((stdgo._internal.text.scanner.Scanner__isdecimal._isDecimal(_ch_4263338) && (((@:checkr _s ?? throw "null pointer dereference").mode & (16u32 : stdgo.GoUInt) : stdgo.GoUInt) != (0u32 : stdgo.GoUInt)) : Bool)) {
                        _gotoNext = 4264642i32;
                    } else {
                        _gotoNext = 4265126i32;
                    };
                } else if (__value__ == (4264642i32)) {
                    {
                        var __tmp__ = @:check2r _s._scanNumber(_ch_4263338, true);
                        _tok_4264037 = @:tmpset0 __tmp__._0;
                        _ch_4263338 = @:tmpset0 __tmp__._1;
                    };
                    _gotoNext = 4265126i32;
                } else if (__value__ == (4264688i32)) {
                    _ch_4263338 = @:check2r _s._next();
                    if (((((_ch_4263338 == (47 : stdgo.GoInt32)) || (_ch_4263338 == (42 : stdgo.GoInt32)) : Bool)) && (((@:checkr _s ?? throw "null pointer dereference").mode & (256u32 : stdgo.GoUInt) : stdgo.GoUInt) != (0u32 : stdgo.GoUInt)) : Bool)) {
                        _gotoNext = 4264774i32;
                    } else {
                        _gotoNext = 4265126i32;
                    };
                } else if (__value__ == (4264774i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (512u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4264808i32;
                    } else {
                        _gotoNext = 4264910i32;
                    };
                } else if (__value__ == (4264808i32)) {
                    (@:checkr _s ?? throw "null pointer dereference")._tokPos = (-1 : stdgo.GoInt);
                    _ch_4263338 = @:check2r _s._scanComment(_ch_4263338);
                    _gotoNext = 4263412i32;
                } else if (__value__ == (4264910i32)) {
                    _ch_4263338 = @:check2r _s._scanComment(_ch_4263338);
                    _tok_4264037 = (-8 : stdgo.GoInt32);
                    _gotoNext = 4265126i32;
                } else if (__value__ == (4264958i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (128u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4265001i32;
                    } else {
                        _gotoNext = 4265053i32;
                    };
                } else if (__value__ == (4265001i32)) {
                    @:check2r _s._scanRawString();
                    _tok_4264037 = (-7 : stdgo.GoInt32);
                    _gotoNext = 4265053i32;
                } else if (__value__ == (4265053i32)) {
                    _ch_4263338 = @:check2r _s._next();
                    _gotoNext = 4265126i32;
                } else if (__value__ == (4265069i32)) {
                    _ch_4263338 = @:check2r _s._next();
                    _gotoNext = 4265126i32;
                } else if (__value__ == (4265126i32)) {
                    ...
                    (@:checkr _s ?? throw "null pointer dereference")._ch = _ch_4263338;
                    return _tok_4264037;
                    _gotoNext = -1i32;
                };
            };
