        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4255520i32;
                } else if (__value__ == (4255520i32)) {
                    0i32;
                    _redoBreak = false;
                    _gotoNext = 4255548i32;
                } else if (__value__ == (4255548i32)) {
                    if (!_redoBreak && (((@:checkr _s ?? throw "null pointer dereference").whitespace & (((1i64 : stdgo.GoUInt64) << (_ch_0 : stdgo.GoUInt) : stdgo.GoUInt64)) : stdgo.GoUInt64) != (0i64 : stdgo.GoUInt64))) {
                        _gotoNext = 4255584i32;
                    } else {
                        _gotoNext = 4255639i32;
                    };
                } else if (__value__ == (4255584i32)) {
                    _ch_0 = @:check2r _s._next();
                    _gotoNext = 4255548i32;
                } else if (__value__ == (4255639i32)) {
                    ...
                    if (((@:checkr _s ?? throw "null pointer dereference")._column > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4255836i32;
                    } else {
                        _gotoNext = 4255934i32;
                    };
                } else if (__value__ == (4255836i32)) {
                    ...
                    _gotoNext = 4256145i32;
                } else if (__value__ == (4255934i32)) {
                    _gotoNext = 4255934i32;
                    ...
                    0i32;
                    _gotoNext = 4256145i32;
                } else if (__value__ == (4256145i32)) {
                    _tok_1 = _ch_0;
                    _gotoNext = 4256156i32;
                } else if (__value__ == (4256156i32)) {
                    if (@:check2r _s._isIdentRune(_ch_0, (0 : stdgo.GoInt))) {
                        _gotoNext = 4256166i32;
                    } else if (stdgo._internal.text.scanner.Scanner__isdecimal._isDecimal(_ch_0)) {
                        _gotoNext = 4256298i32;
                    } else {
                        _gotoNext = 4256429i32;
                    };
                } else if (__value__ == (4256166i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (4u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4256221i32;
                    } else {
                        _gotoNext = 4256274i32;
                    };
                } else if (__value__ == (4256221i32)) {
                    _tok_1 = (-2 : stdgo.GoInt32);
                    _ch_0 = @:check2r _s._scanIdentifier();
                    _gotoNext = 4257234i32;
                } else if (__value__ == (4256274i32)) {
                    _gotoNext = 4256274i32;
                    _ch_0 = @:check2r _s._next();
                    0i32;
                    _gotoNext = 4257234i32;
                } else if (__value__ == (4256298i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (24u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4256357i32;
                    } else {
                        _gotoNext = 4256405i32;
                    };
                } else if (__value__ == (4256357i32)) {
                    {
                    ...
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (32u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4256619i32;
                    } else {
                        _gotoNext = 4256661i32;
                    };
                } else if (__value__ == (4256619i32)) {
                    @:check2r _s._scanChar();
                    _tok_1 = (-5 : stdgo.GoInt32);
                    _gotoNext = 4256661i32;
                } else if (__value__ == (4256661i32)) {
                    _ch_0 = @:check2r _s._next();
                    _gotoNext = 4257234i32;
                } else if (__value__ == (4256677i32)) {
                    _ch_0 = @:check2r _s._next();
                    if ((stdgo._internal.text.scanner.Scanner__isdecimal._isDecimal(_ch_0) && (((@:checkr _s ?? throw "null pointer dereference").mode & (16u32 : stdgo.GoUInt) : stdgo.GoUInt) != (0u32 : stdgo.GoUInt)) : Bool)) {
                        _gotoNext = 4256750i32;
                    } else {
                        _gotoNext = 4257234i32;
                    };
                } else if (__value__ == (4256750i32)) {
                    {
                    ...
                    _gotoNext = 4257234i32;
                } else if (__value__ == (4257066i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (128u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4257109i32;
                    } else {
                        _gotoNext = 4257161i32;
                    };
                } else if (__value__ == (4257109i32)) {
                    @:check2r _s._scanRawString();
                    _tok_1 = (-7 : stdgo.GoInt32);
                    _gotoNext = 4257161i32;
                } else if (__value__ == (4257161i32)) {
                    _ch_0 = @:check2r _s._next();
                    _gotoNext = 4257234i32;
                } else if (__value__ == (4257177i32)) {
                    _ch_0 = @:check2r _s._next();
                    _gotoNext = 4257234i32;
                } else if (__value__ == (4257234i32)) {
