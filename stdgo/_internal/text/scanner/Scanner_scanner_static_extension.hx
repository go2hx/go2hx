...
@:keep @:allow(stdgo._internal.text.scanner.Scanner.Scanner_asInterface) class Scanner_static_extension {
    ...
    static public function scan( _s:stdgo.Ref<stdgo._internal.text.scanner.Scanner_scanner.Scanner>):stdgo.GoInt32 {
        ...
        var _ch_4296689:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _tok_4297388:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        var _gotoNext = 0i32;
        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    ...
                    _gotoNext = 4296763i32;
                } else if (__value__ == (4296763i32)) {
                    var __blank__ = 0i32;
                    _redoBreak = false;
                    _gotoNext = 4296791i32;
                } else if (__value__ == (4296791i32)) {
                    if (!_redoBreak && (((@:checkr _s ?? throw "null pointer dereference").whitespace & (((1i64 : stdgo.GoUInt64) << (_ch_4296689 : stdgo.GoUInt) : stdgo.GoUInt64)) : stdgo.GoUInt64) != (0i64 : stdgo.GoUInt64))) {
                        _gotoNext = 4296827i32;
                    } else {
                        _gotoNext = 4296882i32;
                    };
                } else if (__value__ == (4296827i32)) {
                    _ch_4296689 = @:check2r _s._next();
                    _gotoNext = 4296791i32;
                } else if (__value__ == (4296882i32)) {
                    ...
                    if (((@:checkr _s ?? throw "null pointer dereference")._column > (0 : stdgo.GoInt) : Bool)) {
                        _gotoNext = 4297079i32;
                    } else {
                        _gotoNext = 4297177i32;
                    };
                } else if (__value__ == (4297079i32)) {
                    ...
                    _gotoNext = 4297388i32;
                } else if (__value__ == (4297177i32)) {
                    _gotoNext = 4297177i32;
                    ...
                    var __blank__ = 0i32;
                    _gotoNext = 4297388i32;
                } else if (__value__ == (4297388i32)) {
                    _tok_4297388 = _ch_4296689;
                    _gotoNext = 4297399i32;
                } else if (__value__ == (4297399i32)) {
                    if (@:check2r _s._isIdentRune(_ch_4296689, (0 : stdgo.GoInt))) {
                        _gotoNext = 4297409i32;
                    } else if (stdgo._internal.text.scanner.Scanner__isdecimal._isDecimal(_ch_4296689)) {
                        _gotoNext = 4297541i32;
                    } else {
                        _gotoNext = 4297672i32;
                    };
                } else if (__value__ == (4297409i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (4u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4297464i32;
                    } else {
                        _gotoNext = 4297517i32;
                    };
                } else if (__value__ == (4297464i32)) {
                    _tok_4297388 = (-2 : stdgo.GoInt32);
                    _ch_4296689 = @:check2r _s._scanIdentifier();
                    _gotoNext = 4298477i32;
                } else if (__value__ == (4297517i32)) {
                    _gotoNext = 4297517i32;
                    _ch_4296689 = @:check2r _s._next();
                    var __blank__ = 0i32;
                    _gotoNext = 4298477i32;
                } else if (__value__ == (4297541i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (24u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4297600i32;
                    } else {
                        _gotoNext = 4297648i32;
                    };
                } else if (__value__ == (4297600i32)) {
                    {
                        var __tmp__ = @:check2r _s._scanNumber(_ch_4296689, false);
                        _tok_4297388 = @:tmpset0 __tmp__._0;
                        _ch_4296689 = @:tmpset0 __tmp__._1;
                    };
                    _gotoNext = 4298477i32;
                } else if (__value__ == (4297648i32)) {
                    _gotoNext = 4297648i32;
                    _ch_4296689 = @:check2r _s._next();
                    var __blank__ = 0i32;
                    _gotoNext = 4298477i32;
                } else if (__value__ == (4297672i32)) {
                    _gotoNext = 4297683i32;
                } else if (__value__ == (4297683i32)) {
                    {
                        final __value__ = _ch_4296689;
                        if (__value__ == ((-1 : stdgo.GoInt32))) {
                            _gotoNext = 4297697i32;
                        } else if (__value__ == ((34 : stdgo.GoInt32))) {
                            _gotoNext = 4297718i32;
                        } else if (__value__ == ((39 : stdgo.GoInt32))) {
                            _gotoNext = 4297823i32;
                        } else if (__value__ == ((46 : stdgo.GoInt32))) {
                            _gotoNext = 4297920i32;
                        } else if (__value__ == ((47 : stdgo.GoInt32))) {
                            _gotoNext = 4298039i32;
                        } else if (__value__ == ((96 : stdgo.GoInt32))) {
                            _gotoNext = 4298309i32;
                        } else {
                            _gotoNext = 4298420i32;
                        };
                    };
                } else if (__value__ == (4297697i32)) {
                    _gotoNext = 4298477i32;
                } else if (__value__ == (4297718i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (64u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4297758i32;
                    } else {
                        _gotoNext = 4297807i32;
                    };
                } else if (__value__ == (4297758i32)) {
                    @:check2r _s._scanString((34 : stdgo.GoInt32));
                    _tok_4297388 = (-6 : stdgo.GoInt32);
                    _gotoNext = 4297807i32;
                } else if (__value__ == (4297807i32)) {
                    _ch_4296689 = @:check2r _s._next();
                    _gotoNext = 4298477i32;
                } else if (__value__ == (4297823i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (32u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4297862i32;
                    } else {
                        _gotoNext = 4297904i32;
                    };
                } else if (__value__ == (4297862i32)) {
                    @:check2r _s._scanChar();
                    _tok_4297388 = (-5 : stdgo.GoInt32);
                    _gotoNext = 4297904i32;
                } else if (__value__ == (4297904i32)) {
                    _ch_4296689 = @:check2r _s._next();
                    _gotoNext = 4298477i32;
                } else if (__value__ == (4297920i32)) {
                    _ch_4296689 = @:check2r _s._next();
                    if ((stdgo._internal.text.scanner.Scanner__isdecimal._isDecimal(_ch_4296689) && (((@:checkr _s ?? throw "null pointer dereference").mode & (16u32 : stdgo.GoUInt) : stdgo.GoUInt) != (0u32 : stdgo.GoUInt)) : Bool)) {
                        _gotoNext = 4297993i32;
                    } else {
                        _gotoNext = 4298477i32;
                    };
                } else if (__value__ == (4297993i32)) {
                    {
                        var __tmp__ = @:check2r _s._scanNumber(_ch_4296689, true);
                        _tok_4297388 = @:tmpset0 __tmp__._0;
                        _ch_4296689 = @:tmpset0 __tmp__._1;
                    };
                    _gotoNext = 4298477i32;
                } else if (__value__ == (4298039i32)) {
                    _ch_4296689 = @:check2r _s._next();
                    if (((((_ch_4296689 == (47 : stdgo.GoInt32)) || (_ch_4296689 == (42 : stdgo.GoInt32)) : Bool)) && (((@:checkr _s ?? throw "null pointer dereference").mode & (256u32 : stdgo.GoUInt) : stdgo.GoUInt) != (0u32 : stdgo.GoUInt)) : Bool)) {
                        _gotoNext = 4298125i32;
                    } else {
                        _gotoNext = 4298477i32;
                    };
                } else if (__value__ == (4298125i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (512u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4298159i32;
                    } else {
                        _gotoNext = 4298261i32;
                    };
                } else if (__value__ == (4298159i32)) {
                    (@:checkr _s ?? throw "null pointer dereference")._tokPos = (-1 : stdgo.GoInt);
                    _ch_4296689 = @:check2r _s._scanComment(_ch_4296689);
                    _gotoNext = 4296763i32;
                } else if (__value__ == (4298261i32)) {
                    _ch_4296689 = @:check2r _s._scanComment(_ch_4296689);
                    _tok_4297388 = (-8 : stdgo.GoInt32);
                    _gotoNext = 4298477i32;
                } else if (__value__ == (4298309i32)) {
                    if (((@:checkr _s ?? throw "null pointer dereference").mode & (128u32 : stdgo.GoUInt) : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _gotoNext = 4298352i32;
                    } else {
                        _gotoNext = 4298404i32;
                    };
                } else if (__value__ == (4298352i32)) {
                    @:check2r _s._scanRawString();
                    _tok_4297388 = (-7 : stdgo.GoInt32);
                    _gotoNext = 4298404i32;
                } else if (__value__ == (4298404i32)) {
                    _ch_4296689 = @:check2r _s._next();
                    _gotoNext = 4298477i32;
                } else if (__value__ == (4298420i32)) {
                    _ch_4296689 = @:check2r _s._next();
                    _gotoNext = 4298477i32;
                } else if (__value__ == (4298477i32)) {
                    ...
                    (@:checkr _s ?? throw "null pointer dereference")._ch = _ch_4296689;
                    return _tok_4297388;
                    _gotoNext = -1i32;
                };
            };
