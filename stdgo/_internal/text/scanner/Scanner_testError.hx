...
function testError(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        stdgo._internal.text.scanner.Scanner__testError._testError(_t, stdgo.Go.str(0)?.__copy__(), ("<input>:1:1" : stdgo.GoString), ("invalid character NUL" : stdgo.GoString), (0 : stdgo.GoInt32));
        stdgo._internal.text.scanner.Scanner__testError._testError(_t, stdgo.Go.str(128)?.__copy__(), ("<input>:1:1" : stdgo.GoString), ("invalid UTF-8 encoding" : stdgo.GoString), (65533 : stdgo.GoInt32));
        stdgo._internal.text.scanner.Scanner__testError._testError(_t, stdgo.Go.str(255)?.__copy__(), ("<input>:1:1" : stdgo.GoString), ("invalid UTF-8 encoding" : stdgo.GoString), (65533 : stdgo.GoInt32));
        stdgo._internal.text.scanner.Scanner__testError._testError(_t, stdgo.Go.str("a", 0)?.__copy__(), ("<input>:1:2" : stdgo.GoString), ("invalid character NUL" : stdgo.GoString), (-2 : stdgo.GoInt32));
        stdgo._internal.text.scanner.Scanner__testError._testError(_t, stdgo.Go.str("ab", 128)?.__copy__(), ("<input>:1:3" : stdgo.GoString), ("invalid UTF-8 encoding" : stdgo.GoString), (-2 : stdgo.GoInt32));
        stdgo._internal.text.scanner.Scanner__testError._testError(_t, stdgo.Go.str("abc", 255)?.__copy__(), ("<input>:1:4" : stdgo.GoString), ("invalid UTF-8 encoding" : stdgo.GoString), (-2 : stdgo.GoInt32));
        stdgo._internal.text.scanner.Scanner__testError._testError(_t, stdgo.Go.str("\"a", 0)?.__copy__(), ("<input>:1:3" : stdgo.GoString), ("invalid character NUL" : stdgo.GoString), (-6 : stdgo.GoInt32));
        stdgo._internal.text.scanner.Scanner__testError._testError(_t, stdgo.Go.str("\"ab", 128)?.__copy__(), ("<input>:1:4" : stdgo.GoString), ("invalid UTF-8 encoding" : stdgo.GoString), (-6 : stdgo.GoInt32));
        stdgo._internal.text.scanner.Scanner__testError._testError(_t, stdgo.Go.str("\"abc", 255)?.__copy__(), ("<input>:1:5" : stdgo.GoString), ("invalid UTF-8 encoding" : stdgo.GoString), (-6 : stdgo.GoInt32));
        stdgo._internal.text.scanner.Scanner__testError._testError(_t, stdgo.Go.str("`a", 0)?.__copy__(), ("<input>:1:3" : stdgo.GoString), ("invalid character NUL" : stdgo.GoString), (-7 : stdgo.GoInt32));
        stdgo._internal.text.scanner.Scanner__testError._testError(_t, stdgo.Go.str("`ab", 128)?.__copy__(), ("<input>:1:4" : stdgo.GoString), ("invalid UTF-8 encoding" : stdgo.GoString), (-7 : stdgo.GoInt32));
        stdgo._internal.text.scanner.Scanner__testError._testError(_t, stdgo.Go.str("`abc", 255)?.__copy__(), ("<input>:1:5" : stdgo.GoString), ("invalid UTF-8 encoding" : stdgo.GoString), (-7 : stdgo.GoInt32));
