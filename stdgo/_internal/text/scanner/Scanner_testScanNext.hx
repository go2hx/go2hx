...
function testScanNext(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        stdgo._internal.text.scanner.Scanner__checkTok._checkTok(_t, _s, (0 : stdgo.GoInt), @:check2r _s.next(), (61 : stdgo.GoInt32), stdgo.Go.str()?.__copy__());
        stdgo._internal.text.scanner.Scanner__checkTok._checkTok(_t, _s, (0 : stdgo.GoInt), @:check2r _s.next(), (32 : stdgo.GoInt32), stdgo.Go.str()?.__copy__());
        stdgo._internal.text.scanner.Scanner__checkTok._checkTok(_t, _s, (0 : stdgo.GoInt), @:check2r _s.next(), (98 : stdgo.GoInt32), stdgo.Go.str()?.__copy__());
        ...
        stdgo._internal.text.scanner.Scanner__checkTok._checkTok(_t, _s, (3 : stdgo.GoInt), @:check2r _s.scan(), (-1 : stdgo.GoInt32), stdgo.Go.str()?.__copy__());
