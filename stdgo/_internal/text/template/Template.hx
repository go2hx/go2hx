...
var _siVal : stdgo._internal.text.template.Template.I = stdgo.Go.asInterface((new stdgo.Slice<stdgo.GoString>(2, 2, ("a" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo._internal.text.template.Template.S));
...
var _bigInt : stdgo.GoString = stdgo._internal.fmt.Fmt.sprintf(("0x%x" : stdgo.GoString), stdgo.Go.toInterface((((1 : stdgo.GoInt) << (stdgo._internal.reflect.Reflect.typeOf(stdgo.Go.toInterface((0 : stdgo.GoInt))).bits() - (1 : stdgo.GoInt) : stdgo.GoUInt)) - (1 : stdgo.GoInt) : stdgo.GoInt)));
var _bigUint : stdgo.GoString = stdgo._internal.fmt.Fmt.sprintf(("0x%x" : stdgo.GoString), stdgo.Go.toInterface(((1u32 : stdgo.GoUInt) << (stdgo._internal.reflect.Reflect.typeOf(stdgo.Go.toInterface((0 : stdgo.GoInt))).bits() - (1 : stdgo.GoInt) : stdgo.GoUInt) : stdgo.GoUInt)));
var _execTests : stdgo.Slice<stdgo._internal.text.template.Template.T_execTest> = (new stdgo.Slice<stdgo._internal.text.template.Template.T_execTest>(
320,
320,
...
(new stdgo._internal.text.template.Template.T_execTest(("ideal int" : stdgo.GoString), ("{{typeOf " : stdgo.GoString) + _bigInt?.__copy__() + ("}}" : stdgo.GoString)?.__copy__()?.__copy__(), ("int" : stdgo.GoString), stdgo.Go.toInterface((0 : stdgo.GoInt)), true) : stdgo._internal.text.template.Template.T_execTest),
(new stdgo._internal.text.template.Template.T_execTest(("ideal too big" : stdgo.GoString), ("{{typeOf " : stdgo.GoString) + _bigUint?.__copy__() + ("}}" : stdgo.GoString)?.__copy__()?.__copy__(), stdgo.Go.str()?.__copy__(), stdgo.Go.toInterface((0 : stdgo.GoInt)), false) : stdgo._internal.text.template.Template.T_execTest),
...
(new stdgo._internal.text.template.Template.T_execTest(("dot slice" : stdgo.GoString), ("<{{.}}>" : stdgo.GoString), ("<[-1 -2 -3]>" : stdgo.GoString), stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoInt>(3, 3, (-1 : stdgo.GoInt), (-2 : stdgo.GoInt), (-3 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>)), true) : stdgo._internal.text.template.Template.T_execTest),
...
var _cmpTests : stdgo.Slice<stdgo._internal.text.template.Template.T_cmpTest> = (new stdgo.Slice<stdgo._internal.text.template.Template.T_cmpTest>(
117,
117,
...
function _isHexInt(_s:stdgo.GoString):Bool {
        return (((_s.length > (2 : stdgo.GoInt)) && (_s[(0 : stdgo.GoInt)] == (48 : stdgo.GoUInt8))) && ((_s[(1 : stdgo.GoInt)] == (120 : stdgo.GoUInt8)) || (_s[(1 : stdgo.GoInt)] == (88 : stdgo.GoUInt8)))) && !stdgo._internal.strings.Strings.containsAny(_s?.__copy__(), ("pP" : stdgo.GoString));
    }
...
function _indirect(_v:stdgo._internal.reflect.Reflect.Value):{ var _0 : stdgo._internal.reflect.Reflect.Value; var _1 : Bool; } {
        ...
        stdgo.Go.cfor((_v.kind() == (22u32 : stdgo._internal.reflect.Reflect.Kind)) || (_v.kind() == (20u32 : stdgo._internal.reflect.Reflect.Kind)), _v = _v.elem()?.__copy__(), {
            if (_v.isNil()) {
...
function _printableValue(_v:stdgo._internal.reflect.Reflect.Value):{ var _0 : stdgo.AnyInterface; var _1 : Bool; } {
        ...
        if (!_v.type().implements_(_errorType) && !_v.type().implements_(_fmtStringerType)) {
            if (_v.canAddr() && (stdgo._internal.reflect.Reflect.pointerTo(_v.type()).implements_(_errorType) || stdgo._internal.reflect.Reflect.pointerTo(_v.type()).implements_(_fmtStringerType))) {
                _v = _v.addr()?.__copy__();
            } else {
                {
...
function testComparison(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _cmpStruct:T__struct_3 = ({ uthree : (3u32 : stdgo.GoUInt), ufour : (4u32 : stdgo.GoUInt), negOne : (-1 : stdgo.GoInt), three : (3 : stdgo.GoInt), ptr : stdgo.Go.pointer((0 : stdgo.GoInt)), nilPtr : (null : stdgo.Pointer<stdgo.GoInt>), nonNilMap : ({
            ...
            @:mergeBlock {};
            x;
        } : stdgo.GoMap<stdgo.GoInt, stdgo.GoInt>), map_ : (null : stdgo.GoMap<stdgo.GoInt, stdgo.GoInt>), v1 : ({} : stdgo._internal.text.template.Template.V), v2 : ({} : stdgo._internal.text.template.Template.V), iface1 : stdgo.Go.asInterface(_b), nilIface : (null : stdgo._internal.fmt.Fmt.Stringer) } : T__struct_3);
...
({ _text : ("{{lt (index .Slice 1) .Zero}}" : stdgo.GoString), _out : ("false" : stdgo.GoString) } : T__struct_5)) : stdgo.Slice<T__struct_5>);
        for (__8 => _tt in _tests) {
            ...
            if (stdgo._internal.strings.Strings.hasPrefix(_tt._out?.__copy__(), ("ERROR:" : stdgo.GoString))) {
                ...
                if ((_err == null) || !stdgo._internal.strings.Strings.contains(_err.error()?.__copy__(), _e?.__copy__())) {
...
@:structInit @:using(stdgo._internal.text.template.Template.T_testIssue48215_52___localname___B_static_extension) class T_testIssue48215_52___localname___B {
    @:embedded
    public var a : stdgo.Ref<stdgo._internal.text.template.Template.T_testIssue48215_51___localname___A> = (null : stdgo.Ref<stdgo._internal.text.template.Template.T_testIssue48215_51___localname___A>);
    public function new(?a:stdgo.Ref<stdgo._internal.text.template.Template.T_testIssue48215_51___localname___A>) {
        if (a != null) this.a = a;
    }
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() {
...
function testIssue48215(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        _err = _tmpl.execute(stdgo._internal.io.Io.discard, stdgo.Go.toInterface((new stdgo._internal.text.template.Template.T_testIssue48215_52___localname___B() : stdgo._internal.text.template.Template.T_testIssue48215_52___localname___B)));
        if (_err == null) {
...
function _goodName(_name:stdgo.GoString):Bool {
        ...
        for (_i => _r in _name) {
            if (_r == ((95 : stdgo.GoInt32))) {} else if ((_i == (0 : stdgo.GoInt)) && !stdgo._internal.unicode.Unicode.isLetter(_r)) {
                return false;
            } else if (!stdgo._internal.unicode.Unicode.isLetter(_r) && !stdgo._internal.unicode.Unicode.isDigit(_r)) {
                return false;
            };
        };
        return true;
...
function _call(_fn:stdgo._internal.reflect.Reflect.Value, _args:haxe.Rest<stdgo._internal.reflect.Reflect.Value>):{ var _0 : stdgo._internal.reflect.Reflect.Value; var _1 : stdgo.Error; } {
        ...
        if (_typ.isVariadic()) {
            if ((_args.length) < (_numIn - (1 : stdgo.GoInt))) {
                return { _0 : (new stdgo._internal.reflect.Reflect.Value() : stdgo._internal.reflect.Reflect.Value), _1 : stdgo._internal.fmt.Fmt.errorf(("wrong number of args: got %d want at least %d" : stdgo.GoString), stdgo.Go.toInterface((_args.length)), stdgo.Go.toInterface(_numIn - (1 : stdgo.GoInt))) };
            };
        ...
        var _argv = new stdgo.Slice<stdgo._internal.reflect.Reflect.Value>((_args.length : stdgo.GoInt).toBasic(), 0, ...[for (i in 0 ... ((_args.length : stdgo.GoInt).toBasic() > 0 ? (_args.length : stdgo.GoInt).toBasic() : 0 : stdgo.GoInt).toBasic()) ({} : stdgo._internal.reflect.Reflect.Value)]);
...
function _canCompare(_v1:stdgo._internal.reflect.Reflect.Value, _v2:stdgo._internal.reflect.Reflect.Value):Bool {
        ...
        return (_k1 == (0u32 : stdgo._internal.reflect.Reflect.Kind)) || (_k2 == (0u32 : stdgo._internal.reflect.Reflect.Kind));
    }
function _eq(_arg1:stdgo._internal.reflect.Reflect.Value, _arg2:haxe.Rest<stdgo._internal.reflect.Reflect.Value>):{ var _0 : Bool; var _1 : stdgo.Error; } {
        ...
        for (__9 => _arg in _arg2) {
            ...
            if (_k1 != (_k2)) {
                if ((_k1 == (3 : stdgo._internal.text.template.Template.T_kind)) && (_k2 == (6 : stdgo._internal.text.template.Template.T_kind))) {
                    _truth = (_arg1.int_() >= (0i64 : stdgo.GoInt64)) && ((_arg1.int_() : stdgo.GoUInt64) == _arg.uint());
                } else if ((_k1 == (6 : stdgo._internal.text.template.Template.T_kind)) && (_k2 == (3 : stdgo._internal.text.template.Template.T_kind))) {
...
function jsescapeString(_s:stdgo.GoString):stdgo.GoString {
        if (stdgo._internal.strings.Strings.indexFunc(_s?.__copy__(), _jsIsSpecial) < (0 : stdgo.GoInt)) {
            return _s?.__copy__();
        };
        var _b:stdgo._internal.strings.Strings.Builder = ({} : stdgo._internal.strings.Strings.Builder);
...
function testClone(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        for (_k => _v in _clone._common._tmpl) {
            if ((_k == _clone._name) && ((_v._common._tmpl[_k] ?? (null : stdgo.Ref<stdgo._internal.text.template.Template.Template>)) != _clone)) {
...
@:keep @:allow(stdgo._internal.text.template.Template.T_state_asInterface) class T_state_static_extension {
    ...
    static public function _validateType( _s:stdgo.Ref<T_state>, _value:stdgo._internal.reflect.Reflect.Value, _typ:stdgo._internal.reflect.Reflect.Type_):stdgo._internal.reflect.Reflect.Value {
        ...
        if (!((_typ.string() : String) == (null.string() : String)) && !_value.type().assignableTo(_typ)) {
            if ((_value.kind() == (20u32 : stdgo._internal.reflect.Reflect.Kind)) && !_value.isNil()) {
                _value = _value.elem()?.__copy__();
                if (_value.type().assignableTo(_typ)) {
                    return _value?.__copy__();
                };
            };
            if ((_value.kind() == (22u32 : stdgo._internal.reflect.Reflect.Kind)) && _value.type().elem().assignableTo(_typ)) {
                _value = _value.elem()?.__copy__();
                if (!_value.isValid()) {
                    _s._errorf(("dereference of nil pointer of type %s" : stdgo.GoString), stdgo.Go.toInterface(_typ));
                };
            } else if (stdgo._internal.reflect.Reflect.pointerTo(_value.type()).assignableTo(_typ) && _value.canAddr()) {
    ...
    static public function _evalCall( _s:stdgo.Ref<T_state>, _dot:stdgo._internal.reflect.Reflect.Value, _fun:stdgo._internal.reflect.Reflect.Value, _isBuiltin:Bool, _node:stdgo._internal.text.template.parse.Parse.Node, _name:stdgo.GoString, _args:stdgo.Slice<stdgo._internal.text.template.parse.Parse.Node>, _final:stdgo._internal.reflect.Reflect.Value):stdgo._internal.reflect.Reflect.Value {
        ...
        var _argv = new stdgo.Slice<stdgo._internal.reflect.Reflect.Value>((_numIn : stdgo.GoInt).toBasic(), 0, ...[for (i in 0 ... ((_numIn : stdgo.GoInt).toBasic() > 0 ? (_numIn : stdgo.GoInt).toBasic() : 0 : stdgo.GoInt).toBasic()) ({} : stdgo._internal.reflect.Reflect.Value)]);
        var _i:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        if (_typ.isVariadic()) {
            var _argType:stdgo._internal.reflect.Reflect.Type_ = _typ.in_(_typ.numIn() - (1 : stdgo.GoInt)).elem();
            stdgo.Go.cfor(_i < (_args.length), _i++, {
                _argv[(_i : stdgo.GoInt)] = _s._evalArg(_dot?.__copy__(), _argType, _args[(_i : stdgo.GoInt)])?.__copy__();
            });
        };
        if (!_isMissing(_final?.__copy__())) {
            var _t:stdgo._internal.reflect.Reflect.Type_ = _typ.in_(_typ.numIn() - (1 : stdgo.GoInt));
            if (_typ.isVariadic()) {
    ...
    static public function _evalField( _s:stdgo.Ref<T_state>, _dot:stdgo._internal.reflect.Reflect.Value, _fieldName:stdgo.GoString, _node:stdgo._internal.text.template.parse.Parse.Node, _args:stdgo.Slice<stdgo._internal.text.template.parse.Parse.Node>, _final:stdgo._internal.reflect.Reflect.Value, _receiver:stdgo._internal.reflect.Reflect.Value):stdgo._internal.reflect.Reflect.Value {
        ...
        if ((_receiver.kind() == (20u32 : stdgo._internal.reflect.Reflect.Kind)) && _isNil) {
        ...
        if (((_ptr.kind() != (20u32 : stdgo._internal.reflect.Reflect.Kind)) && (_ptr.kind() != (22u32 : stdgo._internal.reflect.Reflect.Kind))) && _ptr.canAddr()) {
    ...
    static public function _idealConstant( _s:stdgo.Ref<T_state>, _constant:stdgo.Ref<stdgo._internal.text.template.parse.Parse.NumberNode>):stdgo._internal.reflect.Reflect.Value {
        ...
        } else if (((_constant.isFloat && !_isHexInt(_constant.text?.__copy__())) && !_isRuneInt(_constant.text?.__copy__())) && stdgo._internal.strings.Strings.containsAny(_constant.text?.__copy__(), (".eEpP" : stdgo.GoString))) {
    ...
    static public function _evalPipeline( _s:stdgo.Ref<T_state>, _dot:stdgo._internal.reflect.Reflect.Value, _pipe:stdgo.Ref<stdgo._internal.text.template.parse.Parse.PipeNode>):stdgo._internal.reflect.Reflect.Value {
        ...
        for (__16 => _cmd in _pipe.cmds) {
            ...
            if ((_value.kind() == (20u32 : stdgo._internal.reflect.Reflect.Kind)) && (_value.type().numMethod() == (0 : stdgo.GoInt))) {
    ...
    static public function _walkTemplate( _s:stdgo.Ref<T_state>, _dot:stdgo._internal.reflect.Reflect.Value, _t:stdgo.Ref<stdgo._internal.text.template.parse.Parse.TemplateNode>):Void {
        ...
        _newState._vars = (new stdgo.Slice<stdgo._internal.text.template.Template.T_variable>(1, 1, (new stdgo._internal.text.template.Template.T_variable(("$" : stdgo.GoString), _dot?.__copy__()) : stdgo._internal.text.template.Template.T_variable)) : stdgo.Slice<stdgo._internal.text.template.Template.T_variable>);
...
@:keep @:allow(stdgo._internal.text.template.Template.Template_asInterface) class Template_static_extension {
    ...
    static public function _associate( _t:stdgo.Ref<Template>, _new:stdgo.Ref<Template>, _tree:stdgo.Ref<stdgo._internal.text.template.parse.Parse.Tree>):Bool {
        ...
        };
        {
            ...
            if ((((_old != null) && ((_old : Dynamic).__nil__ == null || !(_old : Dynamic).__nil__)) && stdgo._internal.text.template.parse.Parse.isEmptyTree(stdgo.Go.asInterface(_tree.root))) && ((_old.tree != null) && ((_old.tree : Dynamic).__nil__ == null || !(_old.tree : Dynamic).__nil__))) {
                return false;
            };
        };
    ...
    static public function templates( _t:stdgo.Ref<Template>):stdgo.Slice<stdgo.Ref<Template>> {
        ...
        try {
            ...
            _t._common._muTmpl.rlock();
            __deferstack__.unshift(() -> _t._common._muTmpl.runlock());
            var _m = new stdgo.Slice<stdgo.Ref<stdgo._internal.text.template.Template.Template>>((0 : stdgo.GoInt).toBasic(), (_t._common._tmpl.length));
...
@:keep @:allow(stdgo._internal.text.template.Template.T_testIssue48215_52___localname___B_asInterface) class T_testIssue48215_52___localname___B_static_extension {
