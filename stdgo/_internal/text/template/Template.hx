...
var _delimPairs : stdgo.Slice<stdgo.GoString> = (new stdgo.Slice<stdgo.GoString>(10, 10, ...[stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__(), ("{{" : stdgo.GoString), ("}}" : stdgo.GoString), ("<<" : stdgo.GoString), (">>" : stdgo.GoString), ("|" : stdgo.GoString), ("|" : stdgo.GoString), ("(日)" : stdgo.GoString), ("(本)" : stdgo.GoString)]) : stdgo.Slice<stdgo.GoString>);
...
function _slice(_item:stdgo._internal.reflect.Reflect.Value, _indexes:haxe.Rest<stdgo._internal.reflect.Reflect.Value>):{ var _0 : stdgo._internal.reflect.Reflect.Value; var _1 : stdgo.Error; } {
        ...
        var _idx = (new stdgo.GoArray<stdgo.GoInt>(3, 3, ...([(0 : stdgo.GoInt), _item.len()].concat([for (i in 0 ... 1) (0 : stdgo.GoInt)]))) : stdgo.GoArray<stdgo.GoInt>);
