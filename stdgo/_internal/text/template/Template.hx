...
function _indirect(_v:stdgo._internal.reflect.Reflect.Value):{ var _0 : stdgo._internal.reflect.Reflect.Value; var _1 : Bool; } {
        var _rv = ({} : stdgo._internal.reflect.Reflect.Value), _isNil = false;
...
function testDelims(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _value:T__struct_1 = ({ str : ("Hello, world" : stdgo.GoString) } : T__struct_1);
        {
            ...
            stdgo.Go.cfor((_i < (_delimPairs.length) : Bool), _i = (_i + ((2 : stdgo.GoInt)) : stdgo.GoInt), {
                ...
                var _left = (_delimPairs[(_i + (0 : stdgo.GoInt) : stdgo.GoInt)]?.__copy__() : stdgo.GoString);
                var _trueLeft = (_left?.__copy__() : stdgo.GoString);
                var _right = (_delimPairs[(_i + (1 : stdgo.GoInt) : stdgo.GoInt)]?.__copy__() : stdgo.GoString);
...
function testExecError_CustomError(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _b:stdgo._internal.bytes.Bytes.Buffer = ({} : stdgo._internal.bytes.Bytes.Buffer);
        var _err = (_tmpl.execute(stdgo.Go.asInterface((stdgo.Go.setRef(_b) : stdgo.Ref<stdgo._internal.bytes.Bytes.Buffer>)), (null : stdgo.AnyInterface)) : stdgo.Error);
...
function testJSEscaping(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        for (__8 => _tc in _testCases) {
            var _s = (jsescapeString(_tc._in?.__copy__())?.__copy__() : stdgo.GoString);
            if (_s != (_tc._exp)) {
...
function testMessageForExecuteEmpty(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _b:stdgo._internal.bytes.Bytes.Buffer = ({} : stdgo._internal.bytes.Bytes.Buffer);
        var _err = (_tmpl.execute(stdgo.Go.asInterface((stdgo.Go.setRef(_b) : stdgo.Ref<stdgo._internal.bytes.Bytes.Buffer>)), stdgo.Go.toInterface((0 : stdgo.GoInt))) : stdgo.Error);
        if (_err == null) {
...
function testComparison(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        for (__8 => _test in _cmpTests) {
            var _text = (stdgo._internal.fmt.Fmt.sprintf(("{{if %s}}true{{else}}false{{end}}" : stdgo.GoString), stdgo.Go.toInterface(_test._expr))?.__copy__() : stdgo.GoString);
...
function testBlock(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        {
            var _err = (_tmpl.execute(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo._internal.strings.Strings.Builder>)), stdgo.Go.toInterface(("hello" : stdgo.GoString))) : stdgo.Error);
            if (_err != null) {
                _t.fatal(stdgo.Go.toInterface(_err));
            };
        };
        ...
        _buf.reset();
        {
            var _err = (_tmpl2.execute(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo._internal.strings.Strings.Builder>)), stdgo.Go.toInterface(("goodbye" : stdgo.GoString))) : stdgo.Error);
            if (_err != null) {
                _t.fatal(stdgo.Go.toInterface(_err));
            };
        };
...
function testEvalFieldErrors(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        for (__8 => _tc in _tests) {
            _t.run(_tc._name?.__copy__(), function(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
                ...
                var _err = (_tmpl.execute(stdgo._internal.io.Io.discard, _tc._value) : stdgo.Error);
...
function testMaxExecDepth(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _err = (_tmpl.execute(stdgo._internal.io.Io.discard, (null : stdgo.AnyInterface)) : stdgo.Error);
        var _got = ("<nil>" : stdgo.GoString);
        if (_err != null) {
            _got = _err.error()?.__copy__();
        };
...
function testAddrOfIndex(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        for (__8 => _text in _texts) {
            ...
            var _buf:stdgo._internal.strings.Strings.Builder = ({} : stdgo._internal.strings.Strings.Builder);
            var _err = (_tmpl.execute(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo._internal.strings.Strings.Builder>)), stdgo.Go.toInterface(stdgo.Go.asInterface(stdgo._internal.reflect.Reflect.valueOf(stdgo.Go.toInterface((new stdgo.Slice<stdgo._internal.text.template.Template.V>(1, 1, ...[(new stdgo._internal.text.template.Template.V((1 : stdgo.GoInt)) : stdgo._internal.text.template.Template.V)].concat([for (i in 1 ... (1 > 1 ? 1 : 1 : stdgo.GoInt).toBasic()) ({} : stdgo._internal.text.template.Template.V)])) : stdgo.Slice<stdgo._internal.text.template.Template.V>)))))) : stdgo.Error);
            if (_err != null) {
...
({ _text : ("{{lt (index .Slice 1) .Zero}}" : stdgo.GoString), _out : ("false" : stdgo.GoString) } : T__struct_5)].concat([for (i in 30 ... (30 > 30 ? 30 : 30 : stdgo.GoInt).toBasic()) ({ _text : ("" : stdgo.GoString), _out : ("" : stdgo.GoString) } : T__struct_5)])) : stdgo.Slice<T__struct_5>);
        for (__8 => _tt in _tests) {
            ...
            var _buf:stdgo._internal.strings.Strings.Builder = ({} : stdgo._internal.strings.Strings.Builder);
            var _err = (_tmpl.execute(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo._internal.strings.Strings.Builder>)), stdgo.Go.toInterface(({
                final x = new stdgo.GoMap.GoStringMap<stdgo.AnyInterface>();
                x.__defaultValue__ = () -> (null : stdgo.AnyInterface);
...
x.set(("Zero" : stdgo.GoString), stdgo.Go.toInterface((0 : stdgo.GoInt)));
            ...
            if (stdgo._internal.strings.Strings.hasPrefix(_tt._out?.__copy__(), ("ERROR:" : stdgo.GoString))) {
                var _e = (stdgo._internal.strings.Strings.trimSpace(stdgo._internal.strings.Strings.trimPrefix(_tt._out?.__copy__(), ("ERROR:" : stdgo.GoString))?.__copy__())?.__copy__() : stdgo.GoString);
...
function testIssue43065(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        var _err = (_tmp.execute(stdgo.Go.asInterface((stdgo.Go.setRef(_b) : stdgo.Ref<stdgo._internal.bytes.Bytes.Buffer>)), stdgo.Go.toInterface(_ch)) : stdgo.Error);
        if (_err == null) {
...
function _addValueFuncs(_out:stdgo.GoMap<stdgo.GoString, stdgo._internal.reflect.Reflect.Value>, _in:FuncMap):Void {
        for (_name => _fn in _in) {
            ...
            var _v = (stdgo._internal.reflect.Reflect.valueOf(_fn)?.__copy__() : stdgo._internal.reflect.Reflect.Value);
...
function _findFunction(_name:stdgo.GoString, _tmpl:stdgo.Ref<Template>):{ var _0 : stdgo._internal.reflect.Reflect.Value; var _1 : Bool; var _2 : Bool; } {
        var __deferstack__:Array<Void -> Void> = [];
        var _v = ({} : stdgo._internal.reflect.Reflect.Value), _isBuiltin = false, _ok = false;
        try {
            if ((((_tmpl != null) && ((_tmpl : Dynamic).__nil__ == null || !(_tmpl : Dynamic).__nil__)) && ((_tmpl._common != null) && ((_tmpl._common : Dynamic).__nil__ == null || !(_tmpl._common : Dynamic).__nil__)) : Bool)) {
                ...
                {
                    var _fn = ((_tmpl._common._execFuncs[_name] ?? ({} : stdgo._internal.reflect.Reflect.Value))?.__copy__() : stdgo._internal.reflect.Reflect.Value);
                    if (_fn.isValid()) {
                        {
            ...
            {
                var _fn = ((_builtinFuncs()[_name] ?? ({} : stdgo._internal.reflect.Reflect.Value))?.__copy__() : stdgo._internal.reflect.Reflect.Value);
                if (_fn.isValid()) {
                    {
        ...
        for (__8 => _index in _indexes) {
            ...
            };
            {
                ...
                if (__value__ == ((17u32 : stdgo._internal.reflect.Reflect.Kind)) || __value__ == ((23u32 : stdgo._internal.reflect.Reflect.Kind)) || __value__ == ((24u32 : stdgo._internal.reflect.Reflect.Kind))) {
                    ...
                    {
                        var _x = (_item.mapIndex(_index?.__copy__())?.__copy__() : stdgo._internal.reflect.Reflect.Value);
                        if (_x.isValid()) {
                            _item = _x?.__copy__();
                        } else {
...
function _call(_fn:stdgo._internal.reflect.Reflect.Value, _args:haxe.Rest<stdgo._internal.reflect.Reflect.Value>):{ var _0 : stdgo._internal.reflect.Reflect.Value; var _1 : stdgo.Error; } {
        ...
        var _typ = (_fn.type() : stdgo._internal.reflect.Reflect.Type_);
        ...
        for (_i => _arg in _args) {
            ...
            var _argType = (_dddType : stdgo._internal.reflect.Reflect.Type_);
...
function _safeCall(_fun:stdgo._internal.reflect.Reflect.Value, _args:stdgo.Slice<stdgo._internal.reflect.Reflect.Value>):{ var _0 : stdgo._internal.reflect.Reflect.Value; var _1 : stdgo.Error; } {
        var __deferstack__:Array<Void -> Void> = [];
        var _val = ({} : stdgo._internal.reflect.Reflect.Value), _err = (null : stdgo.Error);
        try {
            __deferstack__.unshift(() -> {
                var a = function():Void {
                    {
...
function _canCompare(_v1:stdgo._internal.reflect.Reflect.Value, _v2:stdgo._internal.reflect.Reflect.Value):Bool {
        var _k1 = (_v1.kind() : stdgo._internal.reflect.Reflect.Kind);
        var _k2 = (_v2.kind() : stdgo._internal.reflect.Reflect.Kind);
        if (_k1 == (_k2)) {
            return true;
        };
...
function testParseFS(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        var _fs = (stdgo._internal.os.Os.dirFS(("testdata" : stdgo.GoString)) : stdgo._internal.io.fs.Fs.FS);
        {
...
function testEmptyTemplate(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        ...
        for (_i => _c in _cases) {
            ...
            var __0:stdgo.Ref<Template> = (null : stdgo.Ref<stdgo._internal.text.template.Template.Template>), __1:stdgo.Error = (null : stdgo.Error);
var _err = __1, _m = __0;
...
@:keep @:allow(stdgo._internal.text.template.Template.T_state_asInterface) class T_state_static_extension {
    ...
    static public function _evalComplex( _s:stdgo.Ref<T_state>, _typ:stdgo._internal.reflect.Reflect.Type_, _n:stdgo._internal.text.template.parse.Parse.Node):stdgo._internal.reflect.Reflect.Value {
        @:recv var _s:stdgo.Ref<T_state> = _s;
        {
            ...
            if ((_ok && _n.isComplex : Bool)) {
                var _value = (stdgo._internal.reflect.Reflect.new_(_typ).elem()?.__copy__() : stdgo._internal.reflect.Reflect.Value);
    ...
    static public function _evalCall( _s:stdgo.Ref<T_state>, _dot:stdgo._internal.reflect.Reflect.Value, _fun:stdgo._internal.reflect.Reflect.Value, _isBuiltin:Bool, _node:stdgo._internal.text.template.parse.Parse.Node, _name:stdgo.GoString, _args:stdgo.Slice<stdgo._internal.text.template.parse.Parse.Node>, _final:stdgo._internal.reflect.Reflect.Value):stdgo._internal.reflect.Reflect.Value {
        ...
        var _typ = (_fun.type() : stdgo._internal.reflect.Reflect.Type_);
        ...
        var _unwrap = (function(_v:stdgo._internal.reflect.Reflect.Value):stdgo._internal.reflect.Reflect.Value {
        ...
        if ((_isBuiltin && (((_name == ("and" : stdgo.GoString)) || (_name == ("or" : stdgo.GoString)) : Bool)) : Bool)) {
            var _argType = (_typ.in_((0 : stdgo.GoInt)) : stdgo._internal.reflect.Reflect.Type_);
        ...
        if (_typ.isVariadic()) {
            var _argType = (_typ.in_((_typ.numIn() - (1 : stdgo.GoInt) : stdgo.GoInt)).elem() : stdgo._internal.reflect.Reflect.Type_);
        ...
        if (!_isMissing(_final?.__copy__())) {
            var _t = (_typ.in_((_typ.numIn() - (1 : stdgo.GoInt) : stdgo.GoInt)) : stdgo._internal.reflect.Reflect.Type_);
            if (_typ.isVariadic()) {
    ...
    static public function _evalField( _s:stdgo.Ref<T_state>, _dot:stdgo._internal.reflect.Reflect.Value, _fieldName:stdgo.GoString, _node:stdgo._internal.text.template.parse.Parse.Node, _args:stdgo.Slice<stdgo._internal.text.template.parse.Parse.Node>, _final:stdgo._internal.reflect.Reflect.Value, _receiver:stdgo._internal.reflect.Reflect.Value):stdgo._internal.reflect.Reflect.Value {
        ...
        var _typ = (_receiver.type() : stdgo._internal.reflect.Reflect.Type_);
        ...
        var _ptr = (_receiver?.__copy__() : stdgo._internal.reflect.Reflect.Value);
        ...
        {
            var _method = (_ptr.methodByName(_fieldName?.__copy__())?.__copy__() : stdgo._internal.reflect.Reflect.Value);
            if (_method.isValid()) {
                return _s._evalCall(_dot?.__copy__(), _method?.__copy__(), false, _node, _fieldName?.__copy__(), _args, _final?.__copy__())?.__copy__();
            };
        };
        var _hasArgs = (((_args.length) > (1 : stdgo.GoInt) : Bool) || !_isMissing(_final?.__copy__()) : Bool);
        {
            ...
            while (__run__) {
                __run__ = false;
                {
                    ...
                    if (__value__ == ((25u32 : stdgo._internal.reflect.Reflect.Kind))) {
                        ...
                        var _nameVal = (stdgo._internal.reflect.Reflect.valueOf(stdgo.Go.toInterface(_fieldName))?.__copy__() : stdgo._internal.reflect.Reflect.Value);
                        if (_nameVal.type().assignableTo(_receiver.type().key())) {
                            ...
                            var _result = (_receiver.mapIndex(_nameVal?.__copy__())?.__copy__() : stdgo._internal.reflect.Reflect.Value);
                            if (!_result.isValid()) {
                                {
                        ...
                        var _etyp = (_receiver.type().elem() : stdgo._internal.reflect.Reflect.Type_);
    ...
    static public function _evalVariableNode( _s:stdgo.Ref<T_state>, _dot:stdgo._internal.reflect.Reflect.Value, _variable:stdgo.Ref<stdgo._internal.text.template.parse.Parse.VariableNode>, _args:stdgo.Slice<stdgo._internal.text.template.parse.Parse.Node>, _final:stdgo._internal.reflect.Reflect.Value):stdgo._internal.reflect.Reflect.Value {
        ...
        var _value = (_s._varValue(_variable.ident[(0 : stdgo.GoInt)]?.__copy__())?.__copy__() : stdgo._internal.reflect.Reflect.Value);
    ...
    static public function _evalChainNode( _s:stdgo.Ref<T_state>, _dot:stdgo._internal.reflect.Reflect.Value, _chain:stdgo.Ref<stdgo._internal.text.template.parse.Parse.ChainNode>, _args:stdgo.Slice<stdgo._internal.text.template.parse.Parse.Node>, _final:stdgo._internal.reflect.Reflect.Value):stdgo._internal.reflect.Reflect.Value {
        ...
        var _pipe = (_s._evalArg(_dot?.__copy__(), (null : stdgo._internal.reflect.Reflect.Type_), _chain.node)?.__copy__() : stdgo._internal.reflect.Reflect.Value);
    ...
    static public function _evalCommand( _s:stdgo.Ref<T_state>, _dot:stdgo._internal.reflect.Reflect.Value, _cmd:stdgo.Ref<stdgo._internal.text.template.parse.Parse.CommandNode>, _final:stdgo._internal.reflect.Reflect.Value):stdgo._internal.reflect.Reflect.Value {
        @:recv var _s:stdgo.Ref<T_state> = _s;
        var _firstWord = (_cmd.args[(0 : stdgo.GoInt)] : stdgo._internal.text.template.parse.Parse.Node);
        {
    ...
    static public function _evalPipeline( _s:stdgo.Ref<T_state>, _dot:stdgo._internal.reflect.Reflect.Value, _pipe:stdgo.Ref<stdgo._internal.text.template.parse.Parse.PipeNode>):stdgo._internal.reflect.Reflect.Value {
        @:recv var _s:stdgo.Ref<T_state> = _s;
        var _value = ({} : stdgo._internal.reflect.Reflect.Value);
    ...
    static public function _walkTemplate( _s:stdgo.Ref<T_state>, _dot:stdgo._internal.reflect.Reflect.Value, _t:stdgo.Ref<stdgo._internal.text.template.parse.Parse.TemplateNode>):Void {
        ...
        var _newState = ((_s : stdgo._internal.text.template.Template.T_state)?.__copy__() : stdgo._internal.text.template.Template.T_state);
        _newState._depth++;
    ...
    static public function _walkRange( _s:stdgo.Ref<T_state>, _dot:stdgo._internal.reflect.Reflect.Value, _r:stdgo.Ref<stdgo._internal.text.template.parse.Parse.RangeNode>):Void {
        ...
        try {
            ...
            var _oneIteration = (function(_index:stdgo._internal.reflect.Reflect.Value, _elem:stdgo._internal.reflect.Reflect.Value):Void {
                var __deferstack__:Array<Void -> Void> = [];
                try {
            ...
            } : (stdgo._internal.reflect.Reflect.Value, stdgo._internal.reflect.Reflect.Value) -> Void);
            {
                var __switchIndex__ = -1;
                var __run__ = true;
                while (__run__) {
    ...
    static public function _walkIfOrWith( _s:stdgo.Ref<T_state>, _typ:stdgo._internal.text.template.parse.Parse.NodeType, _dot:stdgo._internal.reflect.Reflect.Value, _pipe:stdgo.Ref<stdgo._internal.text.template.parse.Parse.PipeNode>, _list:stdgo.Ref<stdgo._internal.text.template.parse.Parse.ListNode>, _elseList:stdgo.Ref<stdgo._internal.text.template.parse.Parse.ListNode>):Void {
        ...
        try {
            ...
            var _val = (_s._evalPipeline(_dot?.__copy__(), _pipe)?.__copy__() : stdgo._internal.reflect.Reflect.Value);
    ...
    static public function _walk( _s:stdgo.Ref<T_state>, _dot:stdgo._internal.reflect.Reflect.Value, _node:stdgo._internal.text.template.parse.Parse.Node):Void {
        ...
        _s._at(_node);
        {
            ...
            if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo._internal.text.template.parse.Parse.ActionNode>))) {
                ...
                var _val = (_s._evalPipeline(_dot?.__copy__(), _node.pipe)?.__copy__() : stdgo._internal.reflect.Reflect.Value);
    ...
    static public function _errorf( _s:stdgo.Ref<T_state>, _format:stdgo.GoString, _args:haxe.Rest<stdgo.AnyInterface>):Void {
        var _args = new stdgo.Slice<stdgo.AnyInterface>(_args.length, 0, ..._args);
        @:recv var _s:stdgo.Ref<T_state> = _s;
        var _name = (_doublePercent(_s._tmpl.tree.name()?.__copy__())?.__copy__() : stdgo.GoString);
        if (_s._node == null) {
...
@:keep @:allow(stdgo._internal.text.template.Template.T__asInterface) class T__static_extension {
    ...
    static public function copy( _t:stdgo.Ref<T_>):stdgo.Ref<T_> {
        ...
        var _n = (stdgo.Go.setRef(({} : stdgo._internal.text.template.Template.T_)) : stdgo.Ref<stdgo._internal.text.template.Template.T_>);
        {
            ...
            (_n : stdgo._internal.text.template.Template.T_)._True = __tmp__._True;
            (_n : stdgo._internal.text.template.Template.T_).i = __tmp__.i;
            (_n : stdgo._internal.text.template.Template.T_).u16 = __tmp__.u16;
            (_n : stdgo._internal.text.template.Template.T_).x = __tmp__.x;
            (_n : stdgo._internal.text.template.Template.T_).s = __tmp__.s;
            (_n : stdgo._internal.text.template.Template.T_).floatZero = __tmp__.floatZero;
            (_n : stdgo._internal.text.template.Template.T_).complexZero = __tmp__.complexZero;
            (_n : stdgo._internal.text.template.Template.T_).u = __tmp__.u;
            (_n : stdgo._internal.text.template.Template.T_).v0 = __tmp__.v0;
            (_n : stdgo._internal.text.template.Template.T_).v1 = __tmp__.v1;
            (_n : stdgo._internal.text.template.Template.T_).v2 = __tmp__.v2;
            (_n : stdgo._internal.text.template.Template.T_).w0 = __tmp__.w0;
            (_n : stdgo._internal.text.template.Template.T_).w1 = __tmp__.w1;
            (_n : stdgo._internal.text.template.Template.T_).w2 = __tmp__.w2;
            (_n : stdgo._internal.text.template.Template.T_).si = __tmp__.si;
            (_n : stdgo._internal.text.template.Template.T_).sicap = __tmp__.sicap;
            (_n : stdgo._internal.text.template.Template.T_).siempty = __tmp__.siempty;
            (_n : stdgo._internal.text.template.Template.T_).sb = __tmp__.sb;
            (_n : stdgo._internal.text.template.Template.T_).ai = __tmp__.ai;
            (_n : stdgo._internal.text.template.Template.T_).msi = __tmp__.msi;
            (_n : stdgo._internal.text.template.Template.T_).msione = __tmp__.msione;
            (_n : stdgo._internal.text.template.Template.T_).msiempty = __tmp__.msiempty;
            (_n : stdgo._internal.text.template.Template.T_).mxi = __tmp__.mxi;
            (_n : stdgo._internal.text.template.Template.T_).mii = __tmp__.mii;
            (_n : stdgo._internal.text.template.Template.T_).mi32s = __tmp__.mi32s;
            (_n : stdgo._internal.text.template.Template.T_).mi64s = __tmp__.mi64s;
            (_n : stdgo._internal.text.template.Template.T_).mui32s = __tmp__.mui32s;
            (_n : stdgo._internal.text.template.Template.T_).mui64s = __tmp__.mui64s;
            (_n : stdgo._internal.text.template.Template.T_).mi8s = __tmp__.mi8s;
            (_n : stdgo._internal.text.template.Template.T_).mui8s = __tmp__.mui8s;
            (_n : stdgo._internal.text.template.Template.T_).smsi = __tmp__.smsi;
            (_n : stdgo._internal.text.template.Template.T_).empty0 = __tmp__.empty0;
            (_n : stdgo._internal.text.template.Template.T_).empty1 = __tmp__.empty1;
            (_n : stdgo._internal.text.template.Template.T_).empty2 = __tmp__.empty2;
            (_n : stdgo._internal.text.template.Template.T_).empty3 = __tmp__.empty3;
            (_n : stdgo._internal.text.template.Template.T_).empty4 = __tmp__.empty4;
            (_n : stdgo._internal.text.template.Template.T_).nonEmptyInterface = __tmp__.nonEmptyInterface;
            (_n : stdgo._internal.text.template.Template.T_).nonEmptyInterfacePtS = __tmp__.nonEmptyInterfacePtS;
            (_n : stdgo._internal.text.template.Template.T_).nonEmptyInterfaceNil = __tmp__.nonEmptyInterfaceNil;
            (_n : stdgo._internal.text.template.Template.T_).nonEmptyInterfaceTypedNil = __tmp__.nonEmptyInterfaceTypedNil;
            (_n : stdgo._internal.text.template.Template.T_).str = __tmp__.str;
            (_n : stdgo._internal.text.template.Template.T_).err = __tmp__.err;
            (_n : stdgo._internal.text.template.Template.T_).pi = __tmp__.pi;
            (_n : stdgo._internal.text.template.Template.T_).ps = __tmp__.ps;
            (_n : stdgo._internal.text.template.Template.T_).psi = __tmp__.psi;
            (_n : stdgo._internal.text.template.Template.T_).nil = __tmp__.nil;
            (_n : stdgo._internal.text.template.Template.T_).binaryFunc = __tmp__.binaryFunc;
            (_n : stdgo._internal.text.template.Template.T_).variadicFunc = __tmp__.variadicFunc;
            (_n : stdgo._internal.text.template.Template.T_).variadicFuncInt = __tmp__.variadicFuncInt;
            (_n : stdgo._internal.text.template.Template.T_).nilOKFunc = __tmp__.nilOKFunc;
            (_n : stdgo._internal.text.template.Template.T_).errFunc = __tmp__.errFunc;
            (_n : stdgo._internal.text.template.Template.T_).panicFunc = __tmp__.panicFunc;
            (_n : stdgo._internal.text.template.Template.T_).tmpl = __tmp__.tmpl;
            (_n : stdgo._internal.text.template.Template.T_)._unexported = __tmp__._unexported;
        };
        return _n;
    }
    @:keep
