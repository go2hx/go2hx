...
x.set(("twelve" : stdgo.GoString), (12 : stdgo.GoInt));
        ...
        //"file:///home/runner/.go/go1.21.3/src/text/template/exec_test.go#L165"
        ...
        //"file:///home/runner/.go/go1.21.3/src/text/template/exec_test.go#L166"
        ...
        var _s = new stdgo.Slice<stdgo.GoString>(_s.length, 0, ..._s);
        //"file:///home/runner/.go/go1.21.3/src/text/template/exec_test.go#L167"
        ...
        //"file:///home/runner/.go/go1.21.3/src/text/template/exec_test.go#L168"
        return _s == null;
    }, errFunc : function():{ var _0 : stdgo.GoString; var _1 : stdgo.Error; } {
        //"file:///home/runner/.go/go1.21.3/src/text/template/exec_test.go#L169"
        return { _0 : ("bla" : stdgo.GoString), _1 : (null : stdgo.Error) };
    }, panicFunc : function():stdgo.GoString {
        //"file:///home/runner/.go/go1.21.3/src/text/template/exec_test.go#L170"
        throw stdgo.Go.toInterface(("test panic" : stdgo.GoString));
    }, tmpl : ({
        @:tupleArg var __tmp__ = stdgo._internal.text.template.Template_new_.new_(("x" : stdgo.GoString)).parse(("test template" : stdgo.GoString));
        var __f__ = stdgo._internal.text.template.Template_must.must;
        var __tmp__ = stdgo._internal.text.template.Template_new_.new_(("x" : stdgo.GoString)).parse(("test template" : stdgo.GoString));
