...
function testIssue48215(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        _err = @:check2r _tmpl.execute(stdgo._internal.io.Io_discard.discard, stdgo.Go.toInterface((new stdgo._internal.text.template.Template_T_testIssue48215___localname___B_58304.T_testIssue48215___localname___B_58304() : stdgo._internal.text.template.Template_T_testIssue48215___localname___B_58304.T_testIssue48215___localname___B_58304)));
        if (_err == null) {
