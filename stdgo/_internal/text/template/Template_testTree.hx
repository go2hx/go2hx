...
function testTree(_t:stdgo.Ref<stdgo._internal.testing.Testing_T_.T_>):Void {
        ...
        {};
        _err = @:check2r @:check2r _tmpl.lookup(("tree" : stdgo.GoString)).execute(stdgo.Go.asInterface((stdgo.Go.setRef(_b) : stdgo.Ref<stdgo._internal.strings.Strings_Builder.Builder>)), stdgo.Go.toInterface(_tree));
        if (_err != null) {
        ...
        @:check2 _b.reset();
        _err = @:check2r _tmpl.executeTemplate(stdgo.Go.asInterface((stdgo.Go.setRef(_b) : stdgo.Ref<stdgo._internal.strings.Strings_Builder.Builder>)), ("tree" : stdgo.GoString), stdgo.Go.toInterface(_tree));
        if (_err != null) {
            @:check2r _t.fatal(stdgo.Go.toInterface(("exec error:" : stdgo.GoString)), stdgo.Go.toInterface(_err));
        };
