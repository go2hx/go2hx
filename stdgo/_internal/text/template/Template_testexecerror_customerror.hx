...
function testExecError_CustomError(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        var _failingFunc = (function():{ var _0 : stdgo.GoString; var _1 : stdgo.Error; } {
            //"file:///home/runner/.go/go1.21.3/src/text/template/exec_test.go#L930"
        ...
        var _tmpl = ({
            @:tupleArg var __tmp__ = stdgo._internal.text.template.Template_new_.new_(("top" : stdgo.GoString)).funcs((({
        ...
        //"file:///home/runner/.go/go1.21.3/src/text/template/exec_test.go#L940"
        if (!stdgo._internal.errors.Errors_as.as(_err, stdgo.Go.toInterface(stdgo.Go.pointer(_e)))) {
            //"file:///home/runner/.go/go1.21.3/src/text/template/exec_test.go#L941"
