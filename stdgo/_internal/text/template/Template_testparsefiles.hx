...
function testParseFiles(_t:stdgo.Ref<stdgo._internal.testing.Testing_t_.T_>):Void {
        ...
        //"file:///home/runner/.go/go1.21.3/src/text/template/multi_test.go#L129"
        if (_err == null) {
            //"file:///home/runner/.go/go1.21.3/src/text/template/multi_test.go#L130"
        ...
        //"file:///home/runner/.go/go1.21.3/src/text/template/multi_test.go#L134"
        if (_err != null) {
            //"file:///home/runner/.go/go1.21.3/src/text/template/multi_test.go#L135"
            _t.fatalf(("error parsing files: %v" : stdgo.GoString), stdgo.Go.toInterface(_err));
        };
        //"file:///home/runner/.go/go1.21.3/src/text/template/multi_test.go#L137"
