...
class ChainNode_asInterface {
    ...
    @:keep
    public dynamic function add(_field:stdgo.GoString):Void __self__.value.add(_field);
    @:embedded
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.text.template.parse.Parse_ChainNode.ChainNode>;
