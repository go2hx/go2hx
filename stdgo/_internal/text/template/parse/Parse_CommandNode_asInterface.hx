...
class CommandNode_asInterface {
    ...
    @:keep
    public dynamic function _append(_arg:stdgo._internal.text.template.parse.Parse_Node.Node):Void __self__.value._append(_arg);
    @:embedded
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.text.template.parse.Parse_CommandNode.CommandNode>;
