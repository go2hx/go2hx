...
class NumberNode_asInterface {
    ...
    @:keep
    public dynamic function _simplifyComplex():Void __self__.value._simplifyComplex();
    @:embedded
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.text.template.parse.Parse_NumberNode.NumberNode>;
