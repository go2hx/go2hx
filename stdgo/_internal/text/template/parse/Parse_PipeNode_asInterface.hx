...
class PipeNode_asInterface {
    ...
    @:keep
    public dynamic function copyPipe():stdgo.Ref<stdgo._internal.text.template.parse.Parse_PipeNode.PipeNode> return __self__.value.copyPipe();
    @:keep
    ...
    @:keep
    public dynamic function _append(_command:stdgo.Ref<stdgo._internal.text.template.parse.Parse_CommandNode.CommandNode>):Void __self__.value._append(_command);
    @:embedded
    ...
    var __self__ : stdgo.Pointer<stdgo._internal.text.template.parse.Parse_PipeNode.PipeNode>;
