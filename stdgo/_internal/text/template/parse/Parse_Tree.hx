...
@:structInit @:using(stdgo._internal.text.template.parse.Parse_Tree_static_extension.Tree_static_extension) class Tree {
    ...
    public var _token : stdgo.GoArray<stdgo._internal.text.template.parse.Parse_T_item.T_item> = new stdgo.GoArray<stdgo._internal.text.template.parse.Parse_T_item.T_item>(3, 3, ...[for (i in 0 ... 3) ({} : stdgo._internal.text.template.parse.Parse_T_item.T_item)]);
