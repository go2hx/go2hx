        ...
        while (_gotoNext != ((-1i32 : stdgo.GoInt))) {
            {
                ...
                if (__value__ == (0i32)) {
                    _token_3636409 = _t._peekNonSpace()?.__copy__();
                    _pipe = _t._newPipeline(_token_3636409._pos, _token_3636409._line, (null : stdgo.Slice<stdgo.Ref<stdgo._internal.text.template.parse.Parse_VariableNode.VariableNode>>));
                    _gotoNext = 3636528i32;
                } else if (__value__ == (3636528i32)) {
                    {
                        _v_3636539 = _t._peekNonSpace()?.__copy__();
                    ...
                    _t._next();
                    _tokenAfterVariable_3636900 = _t._peek()?.__copy__();
                    _next_3636933 = _t._peekNonSpace()?.__copy__();
                    ...
                    _pipe.isAssign = _next_3636933._typ == ((6 : stdgo._internal.text.template.parse.Parse_T_itemType.T_itemType));
                    _t._nextNonSpace();
                    _pipe.decl = (_pipe.decl.__append__(_t._newVariable(_v_3636539._pos, _v_3636539._val?.__copy__())));
                    _t._vars = (_t._vars.__append__(_v_3636539._val?.__copy__()));
                    _gotoNext = 3637801i32;
                    ...
                    _t._backup3(_v_3636539?.__copy__(), _tokenAfterVariable_3636900?.__copy__());
                    _gotoNext = 3637801i32;
                } else if (__value__ == (3637768i32)) {
                    _t._backup2(_v_3636539?.__copy__());
                    _gotoNext = 3637801i32;
                    ...
                    {
                        _token_3637816 = _t._nextNonSpace()?.__copy__();
                        {
                    ...
                    _t._unexpected(_token_3637816?.__copy__(), _context?.__copy__());
                    _gotoNext = 3638213i32;
