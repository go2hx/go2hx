...
function _lexChar(_l:stdgo.Ref<stdgo._internal.text.template.parse.Parse_t_lexer.T_lexer>):stdgo._internal.text.template.parse.Parse_t_statefn.T_stateFn {
        ...
        while (_gotoNext != ((-1i64 : stdgo.GoInt))) {
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    _gotoNext = 3668460i64;
                } else if (__value__ == (3668460i64)) {
                    0i64;
                    loopBreak = false;
                    _gotoNext = 3668467i64;
                } else if (__value__ == (3668467i64)) {
                    //"file://#L0"
                    if (!loopBreak) {
                        _gotoNext = 3668471i64;
                    } else {
                        _gotoNext = 3668688i64;
                    };
                } else if (__value__ == (3668471i64)) {
                    _gotoNext = 3668475i64;
                } else if (__value__ == (3668475i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/text/template/parse/lex.go#L567"
                    {
                        final __value__ = _l._next();
                        if (__value__ == ((92 : stdgo.GoInt32))) {
                            _gotoNext = 3668495i64;
                        } else if (__value__ == ((-1 : stdgo.GoInt32)) || __value__ == ((10 : stdgo.GoInt32))) {
                            _gotoNext = 3668583i64;
                        } else if (__value__ == ((39 : stdgo.GoInt32))) {
                            _gotoNext = 3668655i64;
                        } else {
                            _gotoNext = 3668467i64;
                        };
                    };
                } else if (__value__ == (3668495i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/text/template/parse/lex.go#L569"
                    {
                        _r_0 = _l._next();
                        if (((_r_0 != (-1 : stdgo.GoInt32)) && (_r_0 != (10 : stdgo.GoInt32)) : Bool)) {
                            _gotoNext = 3668549i64;
                        } else {
                            _gotoNext = 3668569i64;
                        };
                    };
                } else if (__value__ == (3668549i64)) {
                    _gotoNext = 3668467i64;
                } else if (__value__ == (3668569i64)) {
                    _gotoNext = 3668583i64;
                } else if (__value__ == (3668583i64)) {
                    ...
                    _gotoNext = 3668467i64;
                } else if (__value__ == (3668655i64)) {
                    loopBreak = true;
                    _gotoNext = 3668467i64;
                } else if (__value__ == (3668688i64)) {
