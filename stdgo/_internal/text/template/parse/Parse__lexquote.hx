...
function _lexQuote(_l:stdgo.Ref<stdgo._internal.text.template.parse.Parse_t_lexer.T_lexer>):stdgo._internal.text.template.parse.Parse_t_statefn.T_stateFn {
        ...
        while (_gotoNext != ((-1i64 : stdgo.GoInt))) {
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    _gotoNext = 3648557i64;
                } else if (__value__ == (3648557i64)) {
                    0i64;
                    loopBreak = false;
                    _gotoNext = 3648564i64;
                } else if (__value__ == (3648564i64)) {
                    //"file://#L0"
                    if (!loopBreak) {
                        _gotoNext = 3648568i64;
                    } else {
                        _gotoNext = 3648779i64;
                    };
                } else if (__value__ == (3648568i64)) {
                    _gotoNext = 3648572i64;
                } else if (__value__ == (3648572i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/text/template/parse/lex.go#L641"
                    {
                        final __value__ = _l._next();
                        if (__value__ == ((92 : stdgo.GoInt32))) {
                            _gotoNext = 3648592i64;
                        } else if (__value__ == ((-1 : stdgo.GoInt32)) || __value__ == ((10 : stdgo.GoInt32))) {
                            _gotoNext = 3648680i64;
                        } else if (__value__ == ((34 : stdgo.GoInt32))) {
                            _gotoNext = 3648747i64;
                        } else {
                            _gotoNext = 3648564i64;
                        };
                    };
                } else if (__value__ == (3648592i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/text/template/parse/lex.go#L643"
                    {
                        _r_1 = _l._next();
                        if (((_r_1 != (-1 : stdgo.GoInt32)) && (_r_1 != (10 : stdgo.GoInt32)) : Bool)) {
                            _gotoNext = 3648646i64;
                        } else {
                            _gotoNext = 3648666i64;
                        };
                    };
                } else if (__value__ == (3648646i64)) {
                    _gotoNext = 3648564i64;
                } else if (__value__ == (3648666i64)) {
                    _gotoNext = 3648680i64;
                } else if (__value__ == (3648680i64)) {
                    ...
                    _gotoNext = 3648564i64;
                } else if (__value__ == (3648747i64)) {
                    loopBreak = true;
                    _gotoNext = 3648564i64;
                } else if (__value__ == (3648779i64)) {
