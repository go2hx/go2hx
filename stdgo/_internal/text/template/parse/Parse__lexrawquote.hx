...
function _lexRawQuote(_l:stdgo.Ref<stdgo._internal.text.template.parse.Parse_t_lexer.T_lexer>):stdgo._internal.text.template.parse.Parse_t_statefn.T_stateFn {
        ...
        while (_gotoNext != ((-1i64 : stdgo.GoInt))) {
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    _gotoNext = 3648887i64;
                } else if (__value__ == (3648887i64)) {
                    0i64;
                    loopBreak = false;
                    _gotoNext = 3648894i64;
                } else if (__value__ == (3648894i64)) {
                    //"file://#L0"
                    if (!loopBreak) {
                        _gotoNext = 3648898i64;
                    } else {
                        _gotoNext = 3649019i64;
                    };
                } else if (__value__ == (3648898i64)) {
                    _gotoNext = 3648902i64;
                } else if (__value__ == (3648902i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/text/template/parse/lex.go#L660"
                    {
                        final __value__ = _l._next();
                        if (__value__ == ((-1 : stdgo.GoInt32))) {
                            _gotoNext = 3648922i64;
                        } else if (__value__ == ((96 : stdgo.GoInt32))) {
                            _gotoNext = 3648987i64;
                        } else {
                            _gotoNext = 3648894i64;
                        };
                    };
                } else if (__value__ == (3648922i64)) {
                    ...
                    _gotoNext = 3648894i64;
                } else if (__value__ == (3648987i64)) {
                    loopBreak = true;
                    _gotoNext = 3648894i64;
                } else if (__value__ == (3649019i64)) {
