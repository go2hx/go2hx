...
function _lexRawQuote(_l:stdgo.Ref<stdgo._internal.text.template.parse.Parse_t_lexer.T_lexer>):stdgo._internal.text.template.parse.Parse_t_statefn.T_stateFn {
        ...
        while (_gotoNext != ((-1i64 : stdgo.GoInt))) {
            //"file://#L0"
            {
                ...
                if (__value__ == (0i64)) {
                    _gotoNext = 3670549i64;
                } else if (__value__ == (3670549i64)) {
                    0i64;
                    loopBreak = false;
                    _gotoNext = 3670556i64;
                } else if (__value__ == (3670556i64)) {
                    //"file://#L0"
                    if (!loopBreak) {
                        _gotoNext = 3670560i64;
                    } else {
                        _gotoNext = 3670681i64;
                    };
                } else if (__value__ == (3670560i64)) {
                    _gotoNext = 3670564i64;
                } else if (__value__ == (3670564i64)) {
                    //"file:///home/runner/.go/go1.21.3/src/text/template/parse/lex.go#L660"
                    {
                        final __value__ = _l._next();
                        if (__value__ == ((-1 : stdgo.GoInt32))) {
                            _gotoNext = 3670584i64;
                        } else if (__value__ == ((96 : stdgo.GoInt32))) {
                            _gotoNext = 3670649i64;
                        } else {
                            _gotoNext = 3670556i64;
                        };
                    };
                } else if (__value__ == (3670584i64)) {
                    ...
                    _gotoNext = 3670556i64;
                } else if (__value__ == (3670649i64)) {
                    loopBreak = true;
                    _gotoNext = 3670556i64;
                } else if (__value__ == (3670681i64)) {
