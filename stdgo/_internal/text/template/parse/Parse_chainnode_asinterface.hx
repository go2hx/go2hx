...
class ChainNode_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function add(_field:stdgo.GoString):Void @:_0 __self__.value.add(_field);
    @:embedded
    ...
    var __self__ : stdgo._internal.text.template.parse.Parse_chainnodepointer.ChainNodePointer;
