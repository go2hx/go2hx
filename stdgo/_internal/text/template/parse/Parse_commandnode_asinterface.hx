...
class CommandNode_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function _append(_arg:stdgo._internal.text.template.parse.Parse_node.Node):Void @:_0 __self__.value._append(_arg);
    @:embedded
    ...
    var __self__ : stdgo._internal.text.template.parse.Parse_commandnodepointer.CommandNodePointer;
