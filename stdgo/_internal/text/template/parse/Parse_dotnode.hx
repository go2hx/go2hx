...
@:structInit @:using(stdgo._internal.text.template.parse.Parse_dotnode_static_extension.DotNode_static_extension) class DotNode {
    @:embedded
    ...
    public function __copy__() {
        return new DotNode(nodeType, pos, _tr);
    }
}
