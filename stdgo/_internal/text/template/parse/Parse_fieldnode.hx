...
@:structInit @:using(stdgo._internal.text.template.parse.Parse_fieldnode_static_extension.FieldNode_static_extension) class FieldNode {
    @:embedded
    ...
    public function __copy__() {
        return new FieldNode(nodeType, pos, _tr, ident);
    }
}
