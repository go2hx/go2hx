...
@:structInit @:using(stdgo._internal.text.template.parse.Parse_nilnode_static_extension.NilNode_static_extension) class NilNode {
    @:embedded
    ...
    public function __copy__() {
        return new NilNode(nodeType, pos, _tr);
    }
}
