...
class NumberNode_asInterface {
    ...
    @:keep
    @:tdfield
    public dynamic function _simplifyComplex():Void @:_0 __self__.value._simplifyComplex();
    @:embedded
    ...
    var __self__ : stdgo._internal.text.template.parse.Parse_numbernodepointer.NumberNodePointer;
