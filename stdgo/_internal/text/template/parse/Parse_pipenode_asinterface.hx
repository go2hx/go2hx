...
class PipeNode_asInterface {
    @:keep
    @:tdfield
    public dynamic function copy():stdgo._internal.text.template.parse.Parse_node.Node return @:_0 __self__.value.copy();
    @:keep
    @:tdfield
    public dynamic function copyPipe():stdgo.Ref<stdgo._internal.text.template.parse.Parse_pipenode.PipeNode> return @:_0 __self__.value.copyPipe();
    @:keep
    @:tdfield
    ...
    @:keep
    @:tdfield
    public dynamic function _append(_command:stdgo.Ref<stdgo._internal.text.template.parse.Parse_commandnode.CommandNode>):Void @:_0 __self__.value._append(_command);
    @:embedded
    ...
    var __self__ : stdgo._internal.text.template.parse.Parse_pipenodepointer.PipeNodePointer;
