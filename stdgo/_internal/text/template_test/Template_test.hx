...
function exampleTemplate_share():Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            var _dir:stdgo.GoString = _createTestDir((new stdgo.Slice<stdgo._internal.text.template_test.Template_test.T_templateFile>(2, 2, ...[(new stdgo._internal.text.template_test.Template_test.T_templateFile(("T0.tmpl" : stdgo.GoString), ("T0 ({{.}} version) invokes T1: ({{template `T1`}})\n" : stdgo.GoString)) : stdgo._internal.text.template_test.Template_test.T_templateFile), (new stdgo._internal.text.template_test.Template_test.T_templateFile(("T1.tmpl" : stdgo.GoString), ("{{define \"T1\"}}T1 invokes T2: ({{template \"T2\"}}){{end}}" : stdgo.GoString)) : stdgo._internal.text.template_test.Template_test.T_templateFile)]) : stdgo.Slice<stdgo._internal.text.template_test.Template_test.T_templateFile>))?.__copy__();
            {
                var _a0 = _dir;
                __deferstack__.unshift(() -> stdgo._internal.os.Os.removeAll(_a0?.__copy__()));
            };
