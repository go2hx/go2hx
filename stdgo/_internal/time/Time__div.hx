...
function _div(_t:stdgo._internal.time.Time_time.Time, _d:stdgo._internal.time.Time_duration.Duration):{ var _0 : stdgo.GoInt; var _1 : stdgo._internal.time.Time_duration.Duration; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1564"
        if ((_sec < (0i64 : stdgo.GoInt64) : Bool)) {
            _neg = true;
            _sec = -_sec;
            _nsec = -_nsec;
            //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1569"
            if ((_nsec < (0 : stdgo.GoInt32) : Bool)) {
                _nsec = (_nsec + ((1000000000 : stdgo.GoInt32)) : stdgo.GoInt32);
                //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1571"
                _sec--;
            };
        };
        //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1575"
        {
...
var _u0 = __1, _u0x = __0;
                    //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1599"
                    if ((_u0 < _u0x : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1600"
                        _u1++;
                    };
                    {
                        final __tmp__0 = _u0;
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1603"
                    if ((_u0 < _u0x : Bool)) {
                        //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1604"
                        _u1++;
                    };
                    var _d1 = (_d : stdgo.GoUInt64);
                    //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1610"
                    ...
                    //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1614"
                    while (true) {
                        _qmod2 = (0 : stdgo.GoInt);
                        //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1616"
                        if (((_u1 > _d1 : Bool) || (_u1 == (_d1) && (_u0 >= _d0 : Bool) : Bool) : Bool)) {
                            ...
                            //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1620"
                            if ((_u0 > _u0x : Bool)) {
                                //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1621"
                                _u1--;
                            };
                            _u1 = (_u1 - (_d1) : stdgo.GoUInt64);
                        };
                        //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1625"
                        if (((_d1 == (0i64 : stdgo.GoUInt64)) && (_d0 == (_d : stdgo.GoUInt64)) : Bool)) {
                            //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1626"
                            break;
                        };
        ...
        //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1635"
        ...
        //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1645"
