...
function _tzsetNum(_s:stdgo.GoString, _min:stdgo.GoInt, _max:stdgo.GoInt):{ var _0 : stdgo.GoInt; var _1 : stdgo.GoString; var _2 : Bool; } {
        ...
        if ((_s.length) == ((0 : stdgo.GoInt))) {
            return { _0 : _num = (0 : stdgo.GoInt), _1 : _rest = stdgo.Go.str()?.__copy__(), _2 : _ok = false };
        };
        _num = (0 : stdgo.GoInt);
        for (_i => _r in _s) {
            if (((_r < (48 : stdgo.GoInt32) : Bool) || (_r > (57 : stdgo.GoInt32) : Bool) : Bool)) {
                ...
                return { _0 : _num, _1 : _rest = (_s.__slice__(_i) : stdgo.GoString)?.__copy__(), _2 : _ok = true };
            };
        ...
        return { _0 : _num, _1 : _rest = stdgo.Go.str()?.__copy__(), _2 : _ok = true };
    }
