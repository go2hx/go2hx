...
function date(_year:stdgo.GoInt, _month:stdgo._internal.time.Time_month.Month, _day:stdgo.GoInt, _hour:stdgo.GoInt, _min:stdgo.GoInt, _sec:stdgo.GoInt, _nsec:stdgo.GoInt, _loc:stdgo.Ref<stdgo._internal.time.Time_location.Location>):stdgo._internal.time.Time_time.Time {
        //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1468"
        if (({
            final value = _loc;
            (value == null || (value : Dynamic).__nil__);
        })) {
            //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1469"
        ...
        //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1506"
        if (_offset != ((0 : stdgo.GoInt))) {
            var _utc = (_unix - (_offset : stdgo.GoInt64) : stdgo.GoInt64);
            //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1510"
        ...
        //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1517"
        _t._setLoc(_loc);
        //"file:///home/runner/.go/go1.21.3/src/time/time.go#L1518"
        return _t?.__copy__();
    }
