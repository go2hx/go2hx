...
function _to(__case:stdgo.GoInt, _r:stdgo.GoInt32, _caseRange:stdgo.Slice<stdgo._internal.unicode.Unicode_caserange.CaseRange>):{ var _0 : stdgo.GoInt32; var _1 : Bool; } {
        ...
        //"file:///home/runner/.go/go1.21.3/src/unicode/letter.go#L212"
        if (((__case < (0 : stdgo.GoInt) : Bool) || ((3 : stdgo.GoInt) <= __case : Bool) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/unicode/letter.go#L213"
            return {
        ...
        //"file:///home/runner/.go/go1.21.3/src/unicode/letter.go#L218"
        while ((_lo < _hi : Bool)) {
            ...
            //"file:///home/runner/.go/go1.21.3/src/unicode/letter.go#L221"
            if ((((_cr.lo : stdgo.GoInt32) <= _r : Bool) && (_r <= (_cr.hi : stdgo.GoInt32) : Bool) : Bool)) {
                var _delta = (_cr.delta[(__case : stdgo.GoInt)] : stdgo.GoInt32);
                //"file:///home/runner/.go/go1.21.3/src/unicode/letter.go#L223"
                if ((_delta > (1114111 : stdgo.GoInt32) : Bool)) {
                    //"file:///home/runner/.go/go1.21.3/src/unicode/letter.go#L234"
                    return {
                ...
                //"file:///home/runner/.go/go1.21.3/src/unicode/letter.go#L236"
                return {
            ...
            //"file:///home/runner/.go/go1.21.3/src/unicode/letter.go#L238"
        ...
        //"file:///home/runner/.go/go1.21.3/src/unicode/letter.go#L244"
        return {
