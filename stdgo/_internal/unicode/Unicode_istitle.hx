...
function isTitle(_r:stdgo.GoInt32):Bool {
        //"file:///home/runner/.go/go1.21.3/src/unicode/letter.go#L203"
        if ((_r <= (255 : stdgo.GoInt32) : Bool)) {
            //"file:///home/runner/.go/go1.21.3/src/unicode/letter.go#L204"
            return false;
        };
        //"file:///home/runner/.go/go1.21.3/src/unicode/letter.go#L206"
