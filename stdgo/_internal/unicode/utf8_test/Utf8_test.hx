...
var _invalidSequenceTests : stdgo.Slice<stdgo.GoString> = (new stdgo.Slice<stdgo.GoString>(
37,
37,
...
var _runelentests : stdgo.Slice<stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest> = (new stdgo.Slice<stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest>(
10,
10,
(new stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest((0 : stdgo.GoInt32), (1 : stdgo.GoInt)) : stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest),
(new stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest((101 : stdgo.GoInt32), (1 : stdgo.GoInt)) : stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest),
(new stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest((233 : stdgo.GoInt32), (2 : stdgo.GoInt)) : stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest),
(new stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest((9786 : stdgo.GoInt32), (3 : stdgo.GoInt)) : stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest),
(new stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest((65533 : stdgo.GoInt32), (3 : stdgo.GoInt)) : stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest),
(new stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest((1114111 : stdgo.GoInt32), (4 : stdgo.GoInt)) : stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest),
(new stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest((55296 : stdgo.GoInt32), (-1 : stdgo.GoInt)) : stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest),
(new stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest((57343 : stdgo.GoInt32), (-1 : stdgo.GoInt)) : stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest),
(new stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest((1114112 : stdgo.GoInt32), (-1 : stdgo.GoInt)) : stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest),
(new stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest((-1 : stdgo.GoInt32), (-1 : stdgo.GoInt)) : stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest)) : stdgo.Slice<stdgo._internal.unicode.utf8_test.Utf8_test.RuneLenTest>);
var _validTests : stdgo.Slice<stdgo._internal.unicode.utf8_test.Utf8_test.ValidTest> = (new stdgo.Slice<stdgo._internal.unicode.utf8_test.Utf8_test.ValidTest>(
18,
18,
...
var _validrunetests : stdgo.Slice<stdgo._internal.unicode.utf8_test.Utf8_test.ValidRuneTest> = (new stdgo.Slice<stdgo._internal.unicode.utf8_test.Utf8_test.ValidRuneTest>(
12,
12,
...
function testFullRune(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        for (__0 => _m in _utf8map) {
            ...
            var _s1:stdgo.GoString = (_b1 : stdgo.GoString)?.__copy__();
...
function testEncodeRune(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        for (__0 => _m in _utf8map) {
            var _b = (_m._str : stdgo.Slice<stdgo.GoByte>);
            var _buf:stdgo.GoArray<stdgo.GoByte> = new stdgo.GoArray<stdgo.GoUInt8>(...[for (i in 0 ... 10) (0 : stdgo.GoUInt8)]);
            var _n:stdgo.GoInt = encodeRune((_buf.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>), _m._r);
...
function testRuntimeConversion(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        for (__0 => _ts in _testStrings) {
            var _count:stdgo.GoInt = runeCountInString(_ts?.__copy__());
            {
                var _n:stdgo.GoInt = _runtimeRuneCount(_ts?.__copy__());
                if (_n != (_count)) {
            ...
            {
                var _n:stdgo.GoInt = (_runes.length);
                if (_n != (_count)) {
...
function testDecodeInvalidSequence(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        for (__0 => _s in _invalidSequenceTests) {
            ...
            {
                var _want:stdgo.GoInt32 = (65533 : stdgo.GoInt32);
                if (_r1 != (_want)) {
            ...
            var _r3:stdgo.GoInt32 = _runtimeDecodeRune(_s?.__copy__());
            if (_r2 != (_r3)) {
...
function _testSequence(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>, _s:stdgo.GoString):Void {
        {};
        var _index = new stdgo.Slice<stdgo._internal.unicode.utf8_test.Utf8_test.T__testSequence_0___localname___info>((_s.length : stdgo.GoInt).toBasic(), 0, ...[for (i in 0 ... ((_s.length : stdgo.GoInt).toBasic() > 0 ? (_s.length : stdgo.GoInt).toBasic() : 0 : stdgo.GoInt).toBasic()) ({} : stdgo._internal.unicode.utf8_test.Utf8_test.T__testSequence_0___localname___info)]);
        var _b = (_s : stdgo.Slice<stdgo.GoByte>);
        ...
        for (_i => _r in _s) {
            ...
            _index[(_j : stdgo.GoInt)] = (new stdgo._internal.unicode.utf8_test.Utf8_test.T__testSequence_0___localname___info(_i, _r) : stdgo._internal.unicode.utf8_test.Utf8_test.T__testSequence_0___localname___info);
            _j++;
...
function testNegativeRune(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        var _errorbuf = new stdgo.Slice<stdgo.GoUInt8>((4 : stdgo.GoInt).toBasic(), 0).__setNumber32__();
...
function testRuneCount(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        for (__0 => _tt in _runecounttests) {
            {
                var _out:stdgo.GoInt = runeCountInString(_tt._in?.__copy__());
                if (_out != (_tt._out)) {
            ...
            {
                var _out:stdgo.GoInt = runeCount((_tt._in : stdgo.Slice<stdgo.GoByte>));
                if (_out != (_tt._out)) {
...
function testRuneLen(_t:stdgo.Ref<stdgo._internal.testing.Testing.T_>):Void {
        for (__0 => _tt in _runelentests) {
            {
                var _size:stdgo.GoInt = runeLen(_tt._r);
                if (_size != (_tt._size)) {
