...
@:named class T_headerError {
	...
	public function __copy__()
		return new T_headerError(__t__);

	public function __append__(args:haxe.Rest<GoString>)
		return new T_headerError(this.__t__.__append__(...args));

	public function __slice__(low:GoInt, high:GoInt = -1)
		return new T_headerError(this.__t__.__slice__(low, high));
}
...
@:structInit class Header {
	...
	public function _allowedFormats():{var _0:Format; var _1:GoMap<GoString, GoString>; var _2:Error;} {
		...
		var _format:Format = new Format(),
			_paxHdrs:GoMap<GoString, GoString> = new GoMap<GoString,
		...
		_paxHdrs = new GoMap<GoString,
			GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
				stdgo.reflect.Reflect.GoType.basic(string_kind))));
		var _whyNoUSTAR:GoString = (("" : GoString)),
			_whyNoPAX:GoString = (("" : GoString)),
			_whyNoGNU:GoString = (("" : GoString));
		...
		var _verifyString:(GoString, GoInt, GoString, GoString) -> Void = function(_s:GoString, _size:GoInt, _name:GoString, _paxKey:GoString):Void {
			...
			{
				var __tmp__ = _h.paxrecords.exists(_paxKey) ? {value: _h.paxrecords[_paxKey], ok: true} : {value: _h.paxrecords.defaultValue(), ok: false},
					_v:GoString = __tmp__.value, _ok:Bool = __tmp__.ok;
				if (_ok && _v == _s) {
					_paxHdrs[_paxKey] = _v;
				};
			};
		...
		var _verifyTime:(stdgo.time.Time.Time, GoInt, GoString,
			GoString) -> Void = function(_ts:stdgo.time.Time.Time, _size:GoInt, _name:GoString, _paxKey:GoString):Void {
				if (_ts.isZero()) {
					return;
				};
		...
		var _whyOnlyPAX:GoString = (("" : GoString)),
			_whyOnlyGNU:GoString = (("" : GoString));
		if (_h.typeflag == typeReg || _h.typeflag == typeChar || _h.typeflag == typeBlock || _h.typeflag == typeFifo || _h.typeflag == typeGNUSparse) {
			if (stdgo.strings.Strings.hasSuffix(_h.name, "/")) {
				return {_0: formatUnknown, _1: new GoMap<GoString,
					GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
					stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil(),
					_2: new T_headerError(new Slice<GoString>("filename may not have trailing slash")).__copy__()};
			};
		} else if (_h.typeflag == typeXHeader || _h.typeflag == typeGNULongName || _h.typeflag == typeGNULongLink) {
			return {_0: formatUnknown, _1: new GoMap<GoString,
				GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
				stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil(),
				_2: new T_headerError(new Slice<GoString>("cannot manually encode TypeXHeader, TypeGNULongName, or TypeGNULongLink headers")).__copy__()};
		} else if (_h.typeflag == typeXGlobalHeader) {
			var _h2:Header = (({
				name: _h.name,
				typeflag: _h.typeflag,
				xattrs: _h.xattrs,
				paxrecords: _h.paxrecords,
				format: _h.format,
				linkname: "",
				size: 0,
				mode: 0,
				...
				accessTime: new stdgo.time.Time.Time(),
				changeTime: new stdgo.time.Time.Time(),
				devmajor: 0,
				devminor: 0
			} : Header)).__copy__();
			if (!stdgo.reflect.Reflect.deepEqual(Go.toInterface(_h.__copy__()), Go.toInterface(_h2.__copy__()))) {
				return {_0: formatUnknown, _1: new GoMap<GoString,
					GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
					stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil(),
					_2: new T_headerError(new Slice<GoString>("only PAXRecords should be set for TypeXGlobalHeader")).__copy__()};
			};
		...
		if (!_isHeaderOnlyType(_h.typeflag) && _h.size < ((0 : GoInt64))) {
			return {_0: formatUnknown, _1: new GoMap<GoString,
				GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
				stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil(), _2: new T_headerError(new Slice<GoString>("negative size on header-only type"))
					.__copy__()};
		};
		...
		if ((_h.paxrecords == null ? 0 : _h.paxrecords.length) > ((0 : GoInt))) {
			{
				...
				for (_obj in _h.paxrecords.keyValueIterator()) {
					...
					_v = _obj.value;
					{
						var __tmp__ = _paxHdrs.exists(_k) ? {value: _paxHdrs[_k], ok: true} : {value: _paxHdrs.defaultValue(), ok: false},
			...
			for (_obj in _paxHdrs.keyValueIterator()) {
				...
				if (!_validPAXRecord(_k, _v)) {
					return {_0: formatUnknown, _1: new GoMap<GoString,
						GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
						stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil(),
						_2: new T_headerError(new Slice<GoString>(stdgo.fmt.Fmt.sprintf("invalid PAX record: %q", Go.toInterface(_k
							+ ((" = " : GoString)) + _v)))).__copy__()};
				};
			};
		};
		{
	...
	public var xattrs:GoMap<GoString, GoString> = new GoMap<GoString,
		GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
			stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil();
	public var paxrecords:GoMap<GoString, GoString> = new GoMap<GoString,
		GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
			stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil();
	public var format:Format = new Format();

	public function new(?typeflag:GoUInt8, ?name:GoString, ?linkname:GoString, ?size:GoInt64, ?mode:GoInt64, ?uid:GoInt, ?gid:GoInt, ?uname:GoString,
			?gname:GoString, ?modTime:stdgo.time.Time.Time, ?accessTime:stdgo.time.Time.Time, ?changeTime:stdgo.time.Time.Time, ?devmajor:GoInt64,
			?devminor:GoInt64, ?xattrs:GoMap<GoString, GoString>, ?paxrecords:GoMap<GoString, GoString>, ?format:Format)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(typeflag) + " " + Go.string(name) + " " + Go.string(linkname) + " " + Go.string(size) + " " + Go.string(mode) + " "
			+ Go.string(uid) + " " + Go.string(gid) + " " + Go.string(uname) + " " + Go.string(gname) + " " + Go.string(modTime) + " "
			+ Go.string(accessTime) + " " + Go.string(changeTime) + " " + Go.string(devmajor) + " " + Go.string(devminor) + " " + Go.string(xattrs) + " "
			+ Go.string(paxrecords) + " " + Go.string(format) + "}";
	}
	...
	public function __copy__() {
		return new Header(typeflag, name, linkname, size, mode, uid, gid, uname, gname, modTime, accessTime, changeTime, devmajor, devminor, xattrs,
			paxrecords, format);
	}
...
@:named class T_sparseDatas {
	...
	public function __copy__()
		return new T_sparseDatas(__t__);

	public function __append__(args:haxe.Rest<T_sparseEntry>)
		return new T_sparseDatas(this.__t__.__append__(...args));

	public function __slice__(low:GoInt, high:GoInt = -1)
		return new T_sparseDatas(this.__t__.__slice__(low, high));
}
...
@:named class T_sparseHoles {
	...
	public function __copy__()
		return new T_sparseHoles(__t__);

	public function __append__(args:haxe.Rest<T_sparseEntry>)
		return new T_sparseHoles(this.__t__.__append__(...args));

	public function __slice__(low:GoInt, high:GoInt = -1)
		return new T_sparseHoles(this.__t__.__slice__(low, high));
}
...
@:structInit class T_headerFileInfo {
	public function mode():stdgo.io.fs.Fs.FileMode {
		...
		{
			var _m:stdgo.io.fs.Fs.FileMode = new stdgo.io.fs.Fs.FileMode((new stdgo.io.fs.Fs.FileMode(new stdgo.io.fs.Fs.FileMode(_fi._h.value.mode)
				.__t__ & ((4095 : GoUInt32)))).__t__ ^ ((-1 : GoUnTypedInt)));
	...
	public function new(?_h:Pointer<Header>)
		stdgo.internal.Macro.initLocals();
...
@:named class T_block {
	...
	public function computeChecksum():{var _0:GoInt64; var _1:GoInt64;} {
		var _b = new Pointer(() -> new T_block(this.__t__), __tmp__ -> new T_block(this.__t__ = __tmp__.__t__));
		var _unsigned:GoInt64 = ((0 : GoInt64)),
			_signed:GoInt64 = ((0 : GoInt64));
		{
			var _i;
			var _c;
	...
	public function setFormat(_format:Format):Void {
		...
		var __tmp__ = _b.value.computeChecksum(),
			_chksum:GoInt64 = __tmp__._0,
			_:GoInt64 = __tmp__._1;
	...
	public function getFormat():Format {
		...
		var __tmp__ = _b.value.computeChecksum(),
			_chksum1:GoInt64 = __tmp__._0,
			_chksum2:GoInt64 = __tmp__._1;
	...
	public function ustar():Pointer<T_headerUSTAR> {
		var _b = new Pointer(() -> new T_block(this.__t__), __tmp__ -> new T_block(this.__t__ = __tmp__.__t__));
		return new Pointer<T_headerUSTAR>(() -> new T_headerUSTAR(_b.value.__copy__().__t__),
			v -> new T_headerUSTAR((_b.value = new T_block(v.__copy__().__t__)).__copy__().__t__));
	}

	public function star():Pointer<T_headerSTAR> {
		var _b = new Pointer(() -> new T_block(this.__t__), __tmp__ -> new T_block(this.__t__ = __tmp__.__t__));
		return new Pointer<T_headerSTAR>(() -> new T_headerSTAR(_b.value.__copy__().__t__),
			v -> new T_headerSTAR((_b.value = new T_block(v.__copy__().__t__)).__copy__().__t__));
	}

	public function gnu():Pointer<T_headerGNU> {
		var _b = new Pointer(() -> new T_block(this.__t__), __tmp__ -> new T_block(this.__t__ = __tmp__.__t__));
		return new Pointer<T_headerGNU>(() -> new T_headerGNU(_b.value.__copy__().__t__),
			v -> new T_headerGNU((_b.value = new T_block(v.__copy__().__t__)).__copy__().__t__));
	}

	public function v7():Pointer<T_headerV7> {
		var _b = new Pointer(() -> new T_block(this.__t__), __tmp__ -> new T_block(this.__t__ = __tmp__.__t__));
		return new Pointer<T_headerV7>(() -> new T_headerV7(_b.value.__copy__().__t__),
			v -> new T_headerV7((_b.value = new T_block(v.__copy__().__t__)).__copy__().__t__));
	}
...
@:named class T_headerV7 {
	...
	public function __copy__()
		return new T_headerV7(__t__.copy());
...
@:named class T_headerGNU {
	...
	public function sparse():T_sparseArray {
		var _h = new Pointer(() -> new T_headerGNU(this.__t__), __tmp__ -> new T_headerGNU(this.__t__ = __tmp__.__t__));
		return new T_sparseArray(_h.value.__slice__(((386 : GoInt)))
			.__slice__(0, ((24 : GoUnTypedInt)) * ((4 : GoUnTypedInt)) + ((1 : GoUnTypedInt)))).__copy__();
	}
	...
	public function v7():Pointer<T_headerV7> {
		var _h = new Pointer(() -> new T_headerGNU(this.__t__), __tmp__ -> new T_headerGNU(this.__t__ = __tmp__.__t__));
		return new Pointer<T_headerV7>(() -> new T_headerV7(_h.value.__copy__().__t__),
			v -> new T_headerV7((_h.value = new T_headerGNU(v.__copy__().__t__)).__copy__().__t__));
	}
	...
	public function __copy__()
		return new T_headerGNU(__t__.copy());
...
@:named class T_headerSTAR {
	...
	public function v7():Pointer<T_headerV7> {
		var _h = new Pointer(() -> new T_headerSTAR(this.__t__), __tmp__ -> new T_headerSTAR(this.__t__ = __tmp__.__t__));
		return new Pointer<T_headerV7>(() -> new T_headerV7(_h.value.__copy__().__t__),
			v -> new T_headerV7((_h.value = new T_headerSTAR(v.__copy__().__t__)).__copy__().__t__));
	}
	...
	public function __copy__()
		return new T_headerSTAR(__t__.copy());
...
@:named class T_headerUSTAR {
	...
	public function v7():Pointer<T_headerV7> {
		var _h = new Pointer(() -> new T_headerUSTAR(this.__t__), __tmp__ -> new T_headerUSTAR(this.__t__ = __tmp__.__t__));
		return new Pointer<T_headerV7>(() -> new T_headerV7(_h.value.__copy__().__t__),
			v -> new T_headerV7((_h.value = new T_headerUSTAR(v.__copy__().__t__)).__copy__().__t__));
	}
	...
	public function __copy__()
		return new T_headerUSTAR(__t__.copy());
...
@:named class T_sparseArray {
	...
	public function isExtended():Slice<GoByte> {
		var _s = this.__copy__();
		return _s.__slice__(((24 : GoInt)) * _s.maxEntries())
			.__slice__(0, ((1 : GoInt)))
			.__copy__()
			.__t__;
	}
	...
	public function __copy__()
		return new T_sparseArray(__t__);

	public function __append__(args:haxe.Rest<GoUInt8>)
		return new T_sparseArray(this.__t__.__append__(...args));

	public function __slice__(low:GoInt, high:GoInt = -1)
		return new T_sparseArray(this.__t__.__slice__(low, high));
}
...
@:named class T_sparseElem {
	...
	public function __copy__()
		return new T_sparseElem(__t__);

	public function __append__(args:haxe.Rest<GoUInt8>)
		return new T_sparseElem(this.__t__.__append__(...args));

	public function __slice__(low:GoInt, high:GoInt = -1)
		return new T_sparseElem(this.__t__.__slice__(low, high));
}
...
@:structInit class Reader {
	public function _writeTo(_w:stdgo.io.Io.Writer):{var _0:GoInt64; var _1:Error;} {
		...
		var __tmp__ = _tr.value._curr.writeTo(_w),
	...
	public function read(_b:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
		...
		var __tmp__ = _tr.value._curr.read(_b),
			_n:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
	...
	public function _readOldGNUSparseMap(_hdr:Pointer<Header>, _blk:Pointer<T_block>):{var _0:T_sparseDatas; var _1:Error;} {
		...
		var _spd:T_sparseDatas = new T_sparseDatas(new Slice<T_sparseEntry>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) new T_sparseEntry()])
			.setCap(((_s.maxEntries() : GoInt)).toBasic())).__copy__();
		while (true) {
			{
			...
			if (_s.isExtended()[((0 : GoInt))] > ((0 : GoUInt8))) {
				{
					var __tmp__ = _mustReadFull(_tr.value._r, _blk.value.__slice__(0)),
						_:GoInt = __tmp__._0,
						_err:stdgo.Error = __tmp__._1;
					if (_err != null) {
	...
	public function _readHeader():{var _0:Pointer<Header>; var _1:Pointer<T_block>; var _2:Error;} {
		var _tr = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		{
			var __tmp__ = stdgo.io.Io.readFull(_tr.value._r, _tr.value._blk.__slice__(0)),
				_:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
		...
		if (_format.__t__ > _formatV7.__t__) {
			...
			if (_format._has(new Format(formatUSTAR.__t__ | formatPAX.__t__))) {
				...
				if (!(_nul(_v7.value.size()) && _nul(_v7.value.mode()) && _nul(_v7.value.uid()) && _nul(_v7.value.gid()) && _nul(_v7.value.modTime())
					&& _nul(_ustar.value.devMajor()) && _nul(_ustar.value.devMinor()))) {
					_hdr.value.format = formatUnknown;
				};
			} else if (_format._has(_formatSTAR)) {
	...
	public function _readGNUSparsePAXHeaders(_hdr:Pointer<Header>):{var _0:T_sparseDatas; var _1:Error;} {
		...
		var _major:GoString = _hdr.value.paxrecords[_paxGNUSparseMajor],
			_minor:GoString = _hdr.value.paxrecords[_paxGNUSparseMinor];
		...
		if (_size != (("" : GoString))) {
			var __tmp__ = stdgo.strconv.Strconv.parseInt(_size, ((10 : GoInt)), ((64 : GoInt))),
				_n:GoInt64 = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return {_0: new T_sparseDatas(), _1: errHeader};
	...
	public function _next():{var _0:Pointer<Header>; var _1:Error;} {
		var _tr = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _paxHdrs:GoMap<GoString, GoString> = new GoMap<GoString,
			GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
				stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil();
		var _gnuLongName:GoString = (("" : GoString)),
			_gnuLongLink:GoString = (("" : GoString));
		...
		while (true) {
			...
			{
				var __tmp__ = _tryReadFull(_tr.value._r, _tr.value._blk.__slice__(0, _tr.value._pad)),
					_:GoInt = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
					return {_0: new Pointer<Header>().nil(), _1: _err};
			...
			var __tmp__ = _tr.value._readHeader(),
				_hdr:Pointer<Header> = __tmp__._0,
				_rawHdr:Pointer<T_block> = __tmp__._1,
			...
			if (_hdr.value.typeflag == typeXHeader || _hdr.value.typeflag == typeXGlobalHeader) {
				...
				if (_hdr.value.typeflag == typeXGlobalHeader) {
					...
					return {_0: Go.pointer((({
						name: _hdr.value.name,
						typeflag: _hdr.value.typeflag,
						xattrs: _hdr.value.xattrs,
						paxrecords: _hdr.value.paxrecords,
						format: _format,
						linkname: "",
						size: 0,
						mode: 0,
...
@:structInit class T_sparseFileReader {
	...
	public function writeTo(_w:stdgo.io.Io.Writer):{var _0:GoInt64; var _1:Error;} {
		...
		if (_ok) {
			{
				var __tmp__ = _ws.seek(((0 : GoInt64)), stdgo.io.Io.seekCurrent),
		...
		while (_sr.value.logicalRemaining() > ((0 : GoInt64)) && !_writeLastByte && _err == null) {
			...
			var _holeStart:GoInt64 = _sr.value._sp.__t__[((0 : GoInt))].offset,
				_holeEnd:GoInt64 = _sr.value._sp.__t__[((0 : GoInt))]._endOffset();
...
@:structInit class T_parser {
	public function _parseOctal(_b:Slice<GoByte>):GoInt64 {
		...
		var __tmp__ = stdgo.strconv.Strconv.parseUint(_p.value._parseString(_b), ((8 : GoInt)), ((64 : GoInt))),
			_x:GoUInt64 = __tmp__._0,
			_perr:stdgo.Error = __tmp__._1;
		if (_perr != null) {
...
@:structInit class Writer {
	...
	public function _readFrom(_r:stdgo.io.Io.Reader):{var _0:GoInt64; var _1:Error;} {
		...
		var __tmp__ = _tw.value._curr.readFrom(_r),
			_n:GoInt64 = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
	...
	public function write(_b:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
		...
		var __tmp__ = _tw.value._curr.write(_b),
			_n:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null && Go.toInterface(_err) != Go.toInterface(errWriteTooLong)) {
			_tw.value._err = _err;
	...
	public function _writeRawHeader(_blk:Pointer<T_block>, _size:GoInt64, _flag:GoByte):Error {
		...
		{
			var __tmp__ = _tw.value._w.write(_blk.value.__slice__(0)),
				_:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return _err;
	...
	public function _writeRawFile(_name:GoString, _data:GoString, _flag:GoByte, _format:Format):Error {
		...
		var __tmp__ = stdgo.io.Io.writeString(_tw.value, _data),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		return _err;
	}
	...
	public function _writeGNUHeader(_hdr:Pointer<Header>):Error {
		...
		if (_spd.__t__.length > ((0 : GoInt))) {
			{
				var __tmp__ = _tw.value._w.write(_spb),
					_:GoInt = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
					return _err;
	...
	public function _writePAXHeader(_hdr:Pointer<Header>, _paxHdrs:GoMap<GoString, GoString>):Error {
		var _tw = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _realName:GoString = _hdr.value.name,
			_realSize:GoInt64 = _hdr.value.size;
		_realSize;
		...
		if ((_paxHdrs == null ? 0 : _paxHdrs.length) > ((0 : GoInt)) || _isGlobal) {
			...
			for (_k in _keys) {
				var __tmp__ = _formatPAXRecord(_k, _paxHdrs[_k]),
					_rec:GoString = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
					return _err;
				};
			...
			if (_isGlobal) {
				...
				var __tmp__ = stdgo.path.Path.split(_realName),
	...
	public function _writeUSTARHeader(_hdr:Pointer<Header>):Error {
		...
		{
			var __tmp__ = _splitUSTARPath(_hdr.value.name),
				_prefix:GoString = __tmp__._0,
				_suffix:GoString = __tmp__._1,
				_ok:Bool = __tmp__._2;
			if (_ok) {
				{
	...
	public function writeHeader(_hdr:Pointer<Header>):Error {
		...
		var __tmp__ = _tw.value._hdr._allowedFormats(),
			_allowedFormats:Format = __tmp__._0,
			_paxHdrs:GoMap<GoString, GoString> = __tmp__._1,
			_err:stdgo.Error = __tmp__._2;
...
@:named class T_stringFormatter {
	...
	public function __copy__()
		return new T_stringFormatter(__t__);
}
...
@:named class T_numberFormatter {
	...
	public function __copy__()
		return new T_numberFormatter(__t__);
}
...
@:structInit class T_sparseFileWriter {
	...
	public function readFrom(_r:stdgo.io.Io.Reader):{var _0:GoInt64; var _1:Error;} {
		...
		if (_ok) {
			{
				var __tmp__ = _rs.seek(((0 : GoInt64)), stdgo.io.Io.seekCurrent),
					_:GoInt64 = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
					_ok = false;
		...
		while (_sw.value.logicalRemaining() > ((0 : GoInt64)) && !_readLastByte && _err == null) {
			var _nf:GoInt64 = ((0 : GoInt64));
			var _dataStart:GoInt64 = _sw.value._sp.__t__[((0 : GoInt))].offset,
				_dataEnd:GoInt64 = _sw.value._sp.__t__[((0 : GoInt))]._endOffset();
...
var _basicKeys:GoMap<GoString, Bool> = new GoMap<GoString,
	...
	{key: _paxLinkpath, value: true}, {key: _paxSize, value: true}, {key: _paxUid, value: true}, {key: _paxGid, value: true}, {key: _paxUname, value: true},
	{key: _paxGname, value: true}, {key: _paxMtime, value: true}, {key: _paxAtime, value: true}, {key: _paxCtime, value: true});
...
var _formatNames:GoMap<Format, GoString> = new GoMap<Format,
	GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("archive/tar.Format", [],
	...
	{key: formatUSTAR, value: "USTAR"}, {key: formatPAX, value: "PAX"}, {key: formatGNU, value: "GNU"}, {key: _formatSTAR, value: "STAR"});
...
function fileInfoHeader(_fi:stdgo.io.fs.Fs.FileInfo, _link:GoString):{var _0:Pointer<Header>; var _1:Error;} {
	...
	var _h:Pointer<Header> = Go.pointer((({
		name: _fi.name(),
		modTime: _fi.modTime().__copy__(),
		mode: _fm.perm().__t__,
		typeflag: 0,
		linkname: "",
		size: 0,
		...
		devmajor: 0,
		devminor: 0,
		xattrs: new GoMap<GoString,
			GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
				stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil(),
		paxrecords: new GoMap<GoString,
			GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
				stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil(),
		format: new Format()
	} : Header)));
	...
	};
	{
		...
		if (_ok) {
			...
			if (_sys.value.xattrs != null && !_sys.value.xattrs.isNil()) {
				_h.value.xattrs = new GoMap<GoString,
					GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
						stdgo.reflect.Reflect.GoType.basic(string_kind))));
				{
					var _k;
			...
			if (_sys.value.paxrecords != null && !_sys.value.paxrecords.isNil()) {
				_h.value.paxrecords = new GoMap<GoString,
					GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
						stdgo.reflect.Reflect.GoType.basic(string_kind))));
				{
					var _k;
...
function newReader(_r:stdgo.io.Io.Reader):Pointer<Reader> {
	return Go.pointer((({
		_r: _r,
		_curr: Go.pointer(new T_regFileReader(_r, ((0 : GoInt64)))).value,
		_pad: 0,
		_blk: new T_block(),
			...
			if (_k == _paxPath) {
				...
				if (stdgo.strings.Strings.hasPrefix(_k, _paxSchilyXattr)) {
					if (_hdr.value.xattrs == null || _hdr.value.xattrs.isNil()) {
						_hdr.value.xattrs = new GoMap<GoString,
							GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
								stdgo.reflect.Reflect.GoType.basic(string_kind))));
					};
...
function _parsePAX(_r:stdgo.io.Io.Reader):{var _0:GoMap<GoString, GoString>; var _1:Error;} {
	var __tmp__ = stdgo.io.Io.readAll(_r),
		...
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
		return {_0: new GoMap<GoString,
			GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
				stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil(), _1: _err};
	};
	...
	while (_sbuf.length > ((0 : GoInt))) {
		var __tmp__ = _parsePAXRecord(_sbuf),
			_key:GoString = __tmp__._0,
			_value:GoString = __tmp__._1,
			_residual:GoString = __tmp__._2,
			_err:stdgo.Error = __tmp__._3;
		if (_err != null) {
			return {_0: new GoMap<GoString,
				GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
					stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil(), _1: errHeader};
		};
		_sbuf = _residual;
		if (_key == _paxGNUSparseOffset || _key == _paxGNUSparseNumBytes) {
			if ((_sparseMap.length % ((2 : GoInt)) == ((0 : GoInt)) && _key != _paxGNUSparseOffset)
				|| (_sparseMap.length % ((2 : GoInt)) == ((1 : GoInt)) && _key != _paxGNUSparseNumBytes)
				|| stdgo.strings.Strings.contains(_value, ",")) {
				return {_0: new GoMap<GoString,
					GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
						stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil(), _1: errHeader};
			};
...
function _readGNUSparseMap1x0(_r:stdgo.io.Io.Reader):{var _0:T_sparseDatas; var _1:Error;} {
	var _cntNewline:GoInt64 = ((0 : GoInt64)),
		_buf:stdgo.bytes.Bytes.Buffer = new stdgo.bytes.Bytes.Buffer(),
		_blk:T_block = new T_block();
	...
	var __tmp__ = stdgo.strconv.Strconv.parseInt(_nextToken(), ((10 : GoInt)), ((0 : GoInt))),
		_numEntries:GoInt64 = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	...
	var _spd:T_sparseDatas = new T_sparseDatas(new Slice<T_sparseEntry>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) new T_sparseEntry()])
		.setCap(((_numEntries : GoInt)).toBasic())).__copy__();
	{
		var _i:GoInt64 = ((((0 : GoInt64)) : GoInt64));
		Go.cfor(_i < _numEntries, _i++, {
			var __tmp__ = stdgo.strconv.Strconv.parseInt(_nextToken(), ((10 : GoInt)), ((64 : GoInt))),
				_offset:GoInt64 = __tmp__._0,
				_err1:stdgo.Error = __tmp__._1;
			var __tmp__ = stdgo.strconv.Strconv.parseInt(_nextToken(), ((10 : GoInt)), ((64 : GoInt))),
				_length:GoInt64 = __tmp__._0,
...
function _readGNUSparseMap0x1(_paxHdrs:GoMap<GoString, GoString>):{var _0:T_sparseDatas; var _1:Error;} {
	...
	var __tmp__ = stdgo.strconv.Strconv.parseInt(_numEntriesStr, ((10 : GoInt)), ((0 : GoInt))),
		_numEntries:GoInt64 = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null || _numEntries < ((0 : GoInt64)) || (((((2 : GoInt64)) * _numEntries) : GoInt)) < ((_numEntries : GoInt))) {
		return {_0: new T_sparseDatas(), _1: errHeader};
	...
	while (_sparseMap.length >= ((2 : GoInt))) {
		var __tmp__ = stdgo.strconv.Strconv.parseInt(_sparseMap[((0 : GoInt))], ((10 : GoInt)), ((64 : GoInt))),
			_offset:GoInt64 = __tmp__._0,
			_err1:stdgo.Error = __tmp__._1;
		var __tmp__ = stdgo.strconv.Strconv.parseInt(_sparseMap[((1 : GoInt))], ((10 : GoInt)), ((64 : GoInt))),
			_length:GoInt64 = __tmp__._0,
			_err2:stdgo.Error = __tmp__._1;
		if (_err1 != null || _err2 != null) {
			return {_0: new T_sparseDatas(), _1: errHeader};
...
function _mustReadFull(_r:stdgo.io.Io.Reader, _b:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
	var __tmp__ = _tryReadFull(_r, _b),
		_n:GoInt = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (Go.toInterface(_err) == Go.toInterface(stdgo.io.Io.eof)) {
...
function _discard(_r:stdgo.io.Io.Reader, _n:GoInt64):Error {
	var _seekSkipped:GoInt64 = ((0 : GoInt64));
	{
		...
		if (_ok && _n > ((1 : GoInt64))) {
			var __tmp__ = _sr.seek(((0 : GoInt64)), stdgo.io.Io.seekCurrent),
				_pos1:GoInt64 = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_pos1 >= ((0 : GoInt64)) && _err == null) {
				var __tmp__ = _sr.seek(_n - ((1 : GoInt64)), stdgo.io.Io.seekCurrent),
					_pos2:GoInt64 = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
	...
	var __tmp__ = stdgo.io.Io.copyN(stdgo.io.Io.discard, _r, _n - _seekSkipped),
		_copySkipped:GoInt64 = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
...
function _parsePAXTime(_s:GoString):{var _0:stdgo.time.Time.Time; var _1:Error;} {
	...
	var __tmp__ = stdgo.strconv.Strconv.parseInt(_ss, ((10 : GoInt)), ((64 : GoInt))),
		_secs:GoInt64 = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
	...
	var __tmp__ = stdgo.strconv.Strconv.parseInt(_sn, ((10 : GoInt)), ((64 : GoInt))),
		_nsecs:GoInt64 = __tmp__._0,
...
**/
function _parsePAXRecord(_s:GoString):{
	var _0:GoString;
	var _1:GoString;
	var _2:GoString;
	var _3:Error;
	...
	var _k:GoString = (("" : GoString)),
		_v:GoString = (("" : GoString)),
		_r:GoString = (("" : GoString)),
		_err:Error = ((null : stdgo.Error));
	...
	var __tmp__ = stdgo.strconv.Strconv.parseInt(_s.__slice__(0, _sp), ((10 : GoInt)), ((0 : GoInt))),
		_n:GoInt64 = __tmp__._0,
		_perr:stdgo.Error = __tmp__._1;
	...
	var _rec:GoString = _s.__slice__(_afterSpace, _beforeLastNewLine),
		_nl:GoString = _s.__slice__(_beforeLastNewLine, _n),
		_rem:GoString = _s.__slice__(_n);
	if (_nl != (("\n" : GoString))) {
		return {
			_0: "",
			_1: "",
...
function newWriter(_w:stdgo.io.Io.Writer):Pointer<Writer> {
	return Go.pointer((({
		_w: _w,
		_curr: Go.pointer(new T_regFileWriter(_w, ((0 : GoInt64)))).value,
		_pad: 0,
		_hdr: new Header(),
		_blk: new T_block(),
		_err: ((null : stdgo.Error))
...
function _ensureEOF(_r:stdgo.io.Io.Reader):Error {
	var __tmp__ = _tryReadFull(_r, new Slice<GoUInt8>(((0 : GoUInt8)))),
		_n:GoInt = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_n > ((0 : GoInt))) {
...
class Header_extension_fields {
	public function _allowedFormats(__tmp__):{var _0:Format; var _1:GoMap<GoString, GoString>; var _2:Error;}
		return __tmp__._allowedFormats();

	public function fileInfo(__tmp__):stdgo.io.fs.Fs.FileInfo
		return __tmp__.fileInfo();
}

class T_sparseEntry_extension_fields {
	public function _endOffset(__tmp__):GoInt64
		return __tmp__._endOffset();
}
...
class T_headerFileInfo_extension_fields {
	...
	public function modTime(__tmp__):stdgo.time.Time.Time
		return __tmp__.modTime();

	public function sys(__tmp__):AnyInterface
		return __tmp__.sys();

	public function name(__tmp__):GoString
		return __tmp__.name();

	public function mode(__tmp__):stdgo.io.fs.Fs.FileMode
		return __tmp__.mode();
}

class Format_extension_fields {
	public function _has(__tmp__, _f2:Format):Bool
		return __tmp__._has(_f2);

	public function _mayBe(__tmp__, _f2:Format):Void
		__tmp__._mayBe(_f2);

	public function _mayOnlyBe(__tmp__, _f2:Format):Void
		__tmp__._mayOnlyBe(_f2);

	public function _mustNotBe(__tmp__, _f2:Format):Void
		__tmp__._mustNotBe(_f2);
...
class T_block_extension_fields {
	public function v7(__tmp__):Pointer<T_headerV7>
		return __tmp__.v7();

	public function gnu(__tmp__):Pointer<T_headerGNU>
		return __tmp__.gnu();

	public function star(__tmp__):Pointer<T_headerSTAR>
		return __tmp__.star();

	public function ustar(__tmp__):Pointer<T_headerUSTAR>
		return __tmp__.ustar();

	public function sparse(__tmp__):T_sparseArray
		return __tmp__.sparse();

	public function getFormat(__tmp__):Format
		return __tmp__.getFormat();

	public function setFormat(__tmp__, _format:Format):Void
		__tmp__.setFormat(_format);

	public function computeChecksum(__tmp__):{var _0:GoInt64; var _1:GoInt64;}
		return __tmp__.computeChecksum();
...
class T_headerV7_extension_fields {
	public function name(__tmp__):Slice<GoByte>
		return __tmp__.name();

	public function mode(__tmp__):Slice<GoByte>
		return __tmp__.mode();

	public function uid(__tmp__):Slice<GoByte>
		return __tmp__.uid();

	public function gid(__tmp__):Slice<GoByte>
		return __tmp__.gid();

	public function size(__tmp__):Slice<GoByte>
		return __tmp__.size();

	public function modTime(__tmp__):Slice<GoByte>
		return __tmp__.modTime();

	public function chksum(__tmp__):Slice<GoByte>
		return __tmp__.chksum();

	public function typeFlag(__tmp__):Slice<GoByte>
		return __tmp__.typeFlag();

	public function linkName(__tmp__):Slice<GoByte>
		return __tmp__.linkName();
}
...
class T_headerGNU_extension_fields {
	...
	public function magic(__tmp__):Slice<GoByte>
		return __tmp__.magic();

	public function version(__tmp__):Slice<GoByte>
		return __tmp__.version();

	public function userName(__tmp__):Slice<GoByte>
		return __tmp__.userName();

	public function groupName(__tmp__):Slice<GoByte>
		return __tmp__.groupName();

	public function devMajor(__tmp__):Slice<GoByte>
		return __tmp__.devMajor();

	public function devMinor(__tmp__):Slice<GoByte>
		return __tmp__.devMinor();

	public function accessTime(__tmp__):Slice<GoByte>
		return __tmp__.accessTime();

	public function changeTime(__tmp__):Slice<GoByte>
		return __tmp__.changeTime();

	public function sparse(__tmp__):T_sparseArray
		return __tmp__.sparse();

	public function realSize(__tmp__):Slice<GoByte>
		return __tmp__.realSize();
}
...
class T_headerSTAR_extension_fields {
	...
	public function prefix(__tmp__):Slice<GoByte>
	...
	public function trailer(__tmp__):Slice<GoByte>
		return __tmp__.trailer();
}
...
class T_sparseArray_extension_fields {
	public function entry(__tmp__, _i:GoInt):T_sparseElem
		return __tmp__.entry(_i);

	public function isExtended(__tmp__):Slice<GoByte>
		return __tmp__.isExtended();

	public function maxEntries(__tmp__):GoInt
		return __tmp__.maxEntries();
}

class T_sparseElem_extension_fields {
	public function offset(__tmp__):Slice<GoByte>
		return __tmp__.offset();

	public function length(__tmp__):Slice<GoByte>
		return __tmp__.length();
}

class Reader_extension_fields {
	public function next(__tmp__):{var _0:Pointer<Header>; var _1:Error;}
		return __tmp__.next();

	public function _next(__tmp__):{var _0:Pointer<Header>; var _1:Error;}
		return __tmp__._next();

	public function _handleRegularFile(__tmp__, _hdr:Pointer<Header>):Error
		return __tmp__._handleRegularFile(_hdr);

	public function _handleSparseFile(__tmp__, _hdr:Pointer<Header>, _rawHdr:Pointer<T_block>):Error
		return __tmp__._handleSparseFile(_hdr, _rawHdr);

	public function _readGNUSparsePAXHeaders(__tmp__, _hdr:Pointer<Header>):{var _0:T_sparseDatas; var _1:Error;}
		return __tmp__._readGNUSparsePAXHeaders(_hdr);

	public function _readHeader(__tmp__):{var _0:Pointer<Header>; var _1:Pointer<T_block>; var _2:Error;}
		return __tmp__._readHeader();

	public function _readOldGNUSparseMap(__tmp__, _hdr:Pointer<Header>, _blk:Pointer<T_block>):{var _0:T_sparseDatas; var _1:Error;}
		return __tmp__._readOldGNUSparseMap(_hdr, _blk);

	public function read(__tmp__, _b:Slice<GoByte>):{var _0:GoInt; var _1:Error;}
		return __tmp__.read(_b);

	public function _writeTo(__tmp__, _w:stdgo.io.Io.Writer):{var _0:GoInt64; var _1:Error;}
		return __tmp__._writeTo(_w);
}
...
class T_regFileReader_extension_fields {
	...
	public function logicalRemaining(__tmp__):GoInt64
		return __tmp__.logicalRemaining();

	public function physicalRemaining(__tmp__):GoInt64
		return __tmp__.physicalRemaining();
}
...
class T_parser_extension_fields {
	public function _parseString(__tmp__, _b:Slice<GoByte>):GoString
		return __tmp__._parseString(_b);

	public function _parseNumeric(__tmp__, _b:Slice<GoByte>):GoInt64
		return __tmp__._parseNumeric(_b);

	public function _parseOctal(__tmp__, _b:Slice<GoByte>):GoInt64
		return __tmp__._parseOctal(_b);
}

class T_formatter_extension_fields {
	public function _formatString(__tmp__, _b:Slice<GoByte>, _s:GoString):Void
		__tmp__._formatString(_b, _s);

	public function _formatNumeric(__tmp__, _b:Slice<GoByte>, _x:GoInt64):Void
		__tmp__._formatNumeric(_b, _x);

	public function _formatOctal(__tmp__, _b:Slice<GoByte>, _x:GoInt64):Void
		__tmp__._formatOctal(_b, _x);
}
...
class Writer_extension_fields {
	...
	public function writeHeader(__tmp__, _hdr:Pointer<Header>):Error
		return __tmp__.writeHeader(_hdr);

	public function _writeUSTARHeader(__tmp__, _hdr:Pointer<Header>):Error
		return __tmp__._writeUSTARHeader(_hdr);

	public function _writePAXHeader(__tmp__, _hdr:Pointer<Header>, _paxHdrs:GoMap<GoString, GoString>):Error
		return __tmp__._writePAXHeader(_hdr, _paxHdrs);

	public function _writeGNUHeader(__tmp__, _hdr:Pointer<Header>):Error
		return __tmp__._writeGNUHeader(_hdr);

	public function _templateV7Plus(__tmp__, _hdr:Pointer<Header>, _fmtStr:T_stringFormatter, _fmtNum:T_numberFormatter):Pointer<T_block>
		return __tmp__._templateV7Plus(_hdr, _fmtStr, _fmtNum);

	public function _writeRawFile(__tmp__, _name:GoString, _data:GoString, _flag:GoByte, _format:Format):Error
		return __tmp__._writeRawFile(_name, _data, _flag, _format);

	public function _writeRawHeader(__tmp__, _blk:Pointer<T_block>, _size:GoInt64, _flag:GoByte):Error
		return __tmp__._writeRawHeader(_blk, _size, _flag);
