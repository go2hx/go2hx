...
@:structInit class Reader {
    ...
    public function readSlice(_delim:GoByte):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        ...
        while (true) {
            ...
            if (Go.toInterface(_b.value._err) != Go.toInterface(null)) {
        ...
        };
        {
            ...
            if (_i >= ((0 : GoInt))) {
                ...
                _b.value._lastRuneSize = ((-1 : GoInt));
            };
        };
    ...
    public function readRune():{ var _0 : GoRune; var _1 : GoInt; var _2 : Error; } {
        ...
        while (((((_b.value._r + ((4 : GoInt))) > _b.value._w) && !stdgo.unicode.utf8.Utf8.fullRune(_b.value._buf.__slice__(_b.value._r, _b.value._w))) && (Go.toInterface(_b.value._err) == Go.toInterface(null))) && ((_b.value._w - _b.value._r) < _b.value._buf.length)) {
            _b.value._fill();
        };
        _b.value._lastRuneSize = ((-1 : GoInt));
    ...
    public function peek(_n:GoInt):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        ...
        _b.value._lastByte = ((-1 : GoInt));
        _b.value._lastRuneSize = ((-1 : GoInt));
        while ((((_b.value._w - _b.value._r) < _n) && ((_b.value._w - _b.value._r) < _b.value._buf.length)) && (Go.toInterface(_b.value._err) == Go.toInterface(null))) {
            _b.value._fill();
        };
    ...
    public function _reset(_buf:Slice<GoByte>, _r:stdgo.io.Io.Reader):Void {
        var _b = this.__copy__();
        _b.value = (({ _buf : _buf, _rd : _r, _lastByte : ((-1 : GoInt)), _lastRuneSize : ((-1 : GoInt)), _r : 0, _w : 0, _err : ((null : stdgo.Error)) } : Reader)).__copy__();
    }
...
@:structInit class Writer {
    ...
    public function writeString(_s:GoString):{ var _0 : GoInt; var _1 : Error; } {
        ...
        while ((_s.length > _b.value.available()) && (Go.toInterface(_b.value._err) == Go.toInterface(null))) {
    ...
    public function writeByte(_c:GoByte):Error {
        ...
        if ((_b.value.available() <= ((0 : GoInt))) && (Go.toInterface(_b.value.flush()) != Go.toInterface(null))) {
            return _b.value._err;
        };
    ...
    public function write(_p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } {
        ...
        while ((_p.length > _b.value.available()) && (Go.toInterface(_b.value._err) == Go.toInterface(null))) {
    ...
    public function flush():Error {
        ...
        if ((_n < _b.value._n) && (Go.toInterface(_err) == Go.toInterface(null))) {
...
@:structInit class ReadWriter {
    @:embedded
    public var reader = null;
    @:embedded
    public var writer = null;
...
@:structInit class Scanner {
    ...
    public function _setErr(_err:Error):Void {
        var _s = this.__copy__();
        if ((Go.toInterface(_s.value._err) == Go.toInterface(null)) || (Go.toInterface(_s.value._err) == Go.toInterface(stdgo.io.Io.eof))) {
            _s.value._err = _err;
        };
    }
    ...
    public function scan():Bool {
        ...
        while (true) {
            if ((_s.value._end > _s.value._start) || (Go.toInterface(_s.value._err) != Go.toInterface(null))) {
                var __tmp__ = _s.value._split.__t__(_s.value._buf.__slice__(_s.value._start, _s.value._end), Go.toInterface(_s.value._err) != Go.toInterface(null)), _advance:GoInt = __tmp__._0, _token:Slice<GoUInt8> = __tmp__._1, _err:stdgo.Error = __tmp__._2;
                if (Go.toInterface(_err) != Go.toInterface(null)) {
                ...
                _s.value._token = _token;
                if (_token != null) {
                    if ((Go.toInterface(_s.value._err) == Go.toInterface(null)) || (_advance > ((0 : GoInt)))) {
                        _s.value._empties = ((0 : GoInt));
                    } else {
                        _s.value._empties++;
                        if (_s.value._empties > ((100 : GoInt))) {
            ...
            if (Go.toInterface(_s.value._err) != Go.toInterface(null)) {
            ...
            if (_s.value._end == _s.value._buf.length) {
                {};
                if ((_s.value._buf.length >= _s.value._maxTokenSize) || (_s.value._buf.length > ((1073741823 : GoInt)))) {
...
function newScanner(_r:stdgo.io.Io.Reader):Pointer<Scanner> {
        return Go.pointer((({ _r : _r, _split : new SplitFunc(scanLines), _maxTokenSize : ((65536 : GoInt)), _token : new Slice<GoUInt8>().nil(), _buf : new Slice<GoUInt8>().nil(), _start : 0, _end : 0, _err : ((null : stdgo.Error)), _empties : 0, _scanCalled : false, _done : false } : Scanner)));
    }
/**
