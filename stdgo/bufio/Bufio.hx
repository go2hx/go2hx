...
**/
var errInvalidUnreadByte = stdgo.errors.Errors.new_(("bufio: invalid use of UnreadByte" : GoString));
/**
    
    
    
**/
var errInvalidUnreadRune = stdgo.errors.Errors.new_(("bufio: invalid use of UnreadRune" : GoString));
/**
    
    
    
**/
var errBufferFull = stdgo.errors.Errors.new_(("bufio: buffer full" : GoString));
/**
    
    
    
**/
var errNegativeCount = stdgo.errors.Errors.new_(("bufio: negative count" : GoString));
/**
    
    
    
**/
private var _errNegativeRead = stdgo.errors.Errors.new_(("bufio: reader returned negative count from Read" : GoString));
/**
    
    
    
**/
private var _errNegativeWrite = stdgo.errors.Errors.new_(("bufio: writer returned negative count from Write" : GoString));
/**
    // Errors returned by Scanner.
    
    
**/
var errTooLong = stdgo.errors.Errors.new_(("bufio.Scanner: token too long" : GoString));
/**
    // Errors returned by Scanner.
    
    
**/
var errNegativeAdvance = stdgo.errors.Errors.new_(("bufio.Scanner: SplitFunc returns negative advance count" : GoString));
/**
    // Errors returned by Scanner.
    
    
**/
var errAdvanceTooFar = stdgo.errors.Errors.new_(("bufio.Scanner: SplitFunc returns advance count beyond input" : GoString));
/**
    // Errors returned by Scanner.
    
    
**/
var errBadReadCount = stdgo.errors.Errors.new_(("bufio.Scanner: Read returned impossible count" : GoString));
/**
...
**/
var errFinalToken = stdgo.errors.Errors.new_(("final token" : GoString));
/**
    
    
    
**/
private var _errorRune = (((65533 : GoInt32) : GoString) : Slice<GoByte>);
/**
...
@:structInit @:using(stdgo.bufio.Bufio.ReadWriter_static_extension) class ReadWriter {
    ...
    @:embedded
    public function discard(__0:GoInt):{ var _0 : GoInt; var _1 : Error; } return reader.discard(__0);
    @:embedded
    public function flush():Error return writer.flush();
    @:embedded
    public function peek(__0:GoInt):{ var _0 : Slice<GoUInt8>; var _1 : Error; } return reader.peek(__0);
    @:embedded
    public function read(_p:Slice<GoUInt8>):{ var _0 : GoInt; var _1 : Error; } return reader.read(_p);
    @:embedded
    public function readByte():{ var _0 : GoUInt8; var _1 : Error; } return reader.readByte();
    @:embedded
    public function readBytes(_delim:GoUInt8):{ var _0 : Slice<GoUInt8>; var _1 : Error; } return reader.readBytes(_delim);
    @:embedded
    public function readFrom(_r:stdgo.io.Io.Reader):{ var _0 : GoInt64; var _1 : Error; } return writer.readFrom(_r);
    @:embedded
    public function readLine():{ var _0 : Slice<GoUInt8>; var _1 : Bool; var _2 : Error; } return reader.readLine();
    @:embedded
    public function readRune():{ var _0 : GoInt32; var _1 : GoInt; var _2 : Error; } return reader.readRune();
    @:embedded
    public function readSlice(_delim:GoUInt8):{ var _0 : Slice<GoUInt8>; var _1 : Error; } return reader.readSlice(_delim);
    @:embedded
    public function readString(_delim:GoUInt8):{ var _0 : GoString; var _1 : Error; } return reader.readString(_delim);
    @:embedded
    public function unreadByte():Error return reader.unreadByte();
    @:embedded
    public function unreadRune():Error return reader.unreadRune();
    @:embedded
    public function write(_p:Slice<GoUInt8>):{ var _0 : GoInt; var _1 : Error; } return writer.write(_p);
    @:embedded
    public function writeByte(_delim:GoUInt8):Error return writer.writeByte(_delim);
    @:embedded
    public function writeRune(_r:GoInt32):{ var _0 : GoInt; var _1 : Error; } return writer.writeRune(_r);
    @:embedded
    public function writeString(_text:GoString):{ var _0 : GoInt; var _1 : Error; } return writer.writeString(_text);
    @:embedded
    public function writeTo(_w:stdgo.io.Io.Writer):{ var _0 : GoInt64; var _1 : Error; } return reader.writeTo(_w);
    @:embedded
    public function _collectFragments(_delim:GoUInt8):{ var _0 : Slice<Slice<GoUInt8>>; var _1 : Slice<GoUInt8>; var _2 : GoInt; var _3 : Error; } return reader._collectFragments(_delim);
    @:embedded
    public function _fill() reader._fill();
    @:embedded
    public function _readErr():Error return reader._readErr();
    @:embedded
    public function _reset(_buf:Slice<GoUInt8>, _r:stdgo.io.Io.Reader) reader._reset(_buf, _r);
    @:embedded
    public function _writeBuf(_w:stdgo.io.Io.Writer):{ var _0 : GoInt64; var _1 : Error; } return reader._writeBuf(_w);
    public function __copy__() {
...
**/
@:named typedef SplitFunc = (Slice<GoUInt8>, Bool) -> { var _0 : GoInt; var _1 : Slice<GoUInt8>; var _2 : Error; };
/**
...
@:keep @:allow(stdgo.bufio.Bufio.Reader_asInterface) class Reader_static_extension {
    ...
    **/
    ...
    static public function _writeBuf( _b:Ref<Reader>, _w:stdgo.io.Io.Writer):{ var _0 : GoInt64; var _1 : Error; } {
        var __tmp__ = _w.write((_b._buf.__slice__(_b._r, _b._w) : Slice<GoUInt8>)), _n:GoInt = __tmp__._0, _err:Error = __tmp__._1;
        if (_n < (0 : GoInt)) {
    ...
    **/
    ...
    static public function writeTo( _b:Ref<Reader>, _w:stdgo.io.Io.Writer):{ var _0 : GoInt64; var _1 : Error; } {
        ...
        };
        {
            ...
            if (_ok) {
                var __tmp__ = _r.writeTo(_w), _m:GoInt64 = __tmp__._0, _err:Error = __tmp__._1;
                _n = _n + (_m);
                return { _0 : _n, _1 : _err };
            };
        };
        {
            ...
            if (_ok) {
                var __tmp__ = _w.readFrom(_b._rd), _m:GoInt64 = __tmp__._0, _err:Error = __tmp__._1;
                _n = _n + (_m);
                return { _0 : _n, _1 : _err };
            };
        };
        ...
        while (_b._r < _b._w) {
            var __tmp__ = _b._writeBuf(_w), _m:GoInt64 = __tmp__._0, _err:Error = __tmp__._1;
            _n = _n + (_m);
            if (_err != null) {
                return { _0 : _n, _1 : _err };
            };
    ...
    **/
    @:keep
    static public function _collectFragments( _b:Ref<Reader>, _delim:GoByte):{ var _0 : Slice<Slice<GoByte>>; var _1 : Slice<GoByte>; var _2 : GoInt; var _3 : Error; } {
        var _fullBuffers:Slice<Slice<GoByte>> = (null : Slice<Slice<GoUInt8>>), _finalFragment:Slice<GoByte> = (null : Slice<GoUInt8>), _totalLen:GoInt = (0 : GoInt), _err:Error = (null : Error);
    ...
    **/
    ...
    static public function readLine( _b:Ref<Reader>):{ var _0 : Slice<GoByte>; var _1 : Bool; var _2 : Error; } {
        var _line:Slice<GoByte> = (null : Slice<GoUInt8>), _isPrefix:Bool = false, _err:Error = (null : Error);
        {
    ...
    **/
    ...
    static public function readRune( _b:Ref<Reader>):{ var _0 : GoRune; var _1 : GoInt; var _2 : Error; } {
        ...
        while (((((_b._r + (4 : GoInt)) > _b._w) && !stdgo.unicode.utf8.Utf8.fullRune((_b._buf.__slice__(_b._r, _b._w) : Slice<GoUInt8>))) && (_b._err == null)) && ((_b._w - _b._r) < _b._buf.length)) {
            _b._fill();
        };
        _b._lastRuneSize = (-1 : GoInt);
        if (_b._r == (_b._w)) {
    ...
    **/
    ...
    static public function _fill( _b:Ref<Reader>):Void {
        ...
        };
        {
            ...
            Go.cfor(_i > (0 : GoInt), _i--, {
                var __tmp__ = _b._rd.read((_b._buf.__slice__(_b._w) : Slice<GoUInt8>)), _n:GoInt = __tmp__._0, _err:Error = __tmp__._1;
                if (_n < (0 : GoInt)) {
                    throw Go.toInterface(_errNegativeRead);
                };
                _b._w = _b._w + (_n);
    ...
    static public function _reset( _b:Ref<Reader>, _buf:Slice<GoByte>, _r:stdgo.io.Io.Reader):Void {
        {
            var __tmp__ = ({ _buf : _buf, _rd : _r, _lastByte : (-1 : GoInt), _lastRuneSize : (-1 : GoInt) } : Reader);
...
@:keep @:allow(stdgo.bufio.Bufio.Writer_asInterface) class Writer_static_extension {
    ...
    static public function readFrom( _b:Ref<Writer>, _r:stdgo.io.Io.Reader):{ var _0 : GoInt64; var _1 : Error; } {
        ...
        while (true) {
            ...
            if (_readerFromOK && (_b.buffered() == (0 : GoInt))) {
                var __tmp__ = _readerFrom.readFrom(_r), _nn:GoInt64 = __tmp__._0, _err:Error = __tmp__._1;
                _b._err = _err;
                _n = _n + (_nn);
                return { _0 : _n, _1 : _err };
            };
    ...
    **/
    ...
    static public function flush( _b:Ref<Writer>):Error {
        ...
        var __tmp__ = _b._wr.write((_b._buf.__slice__((0 : GoInt), _b._n) : Slice<GoUInt8>)), _n:GoInt = __tmp__._0, _err:Error = __tmp__._1;
...
@:keep @:allow(stdgo.bufio.Bufio.ReadWriter_asInterface) class ReadWriter_static_extension {
    @:embedded
    public static function _writeBuf( __self__:ReadWriter, _w:stdgo.io.Io.Writer):{ var _0 : GoInt64; var _1 : Error; } return __self__._writeBuf(_w);
    @:embedded
    public static function _reset( __self__:ReadWriter, _buf:Slice<GoUInt8>, _r:stdgo.io.Io.Reader) __self__._reset(_buf, _r);
    @:embedded
    public static function _readErr( __self__:ReadWriter):Error return __self__._readErr();
    @:embedded
    public static function _fill( __self__:ReadWriter) __self__._fill();
    @:embedded
    public static function _collectFragments( __self__:ReadWriter, _delim:GoUInt8):{ var _0 : Slice<Slice<GoUInt8>>; var _1 : Slice<GoUInt8>; var _2 : GoInt; var _3 : Error; } return __self__._collectFragments(_delim);
    @:embedded
    public static function writeTo( __self__:ReadWriter, _w:stdgo.io.Io.Writer):{ var _0 : GoInt64; var _1 : Error; } return __self__.writeTo(_w);
    @:embedded
    public static function writeString( __self__:ReadWriter, _text:GoString):{ var _0 : GoInt; var _1 : Error; } return __self__.writeString(_text);
    @:embedded
    public static function writeRune( __self__:ReadWriter, _r:GoInt32):{ var _0 : GoInt; var _1 : Error; } return __self__.writeRune(_r);
    @:embedded
    public static function writeByte( __self__:ReadWriter, _delim:GoUInt8):Error return __self__.writeByte(_delim);
    @:embedded
    public static function write( __self__:ReadWriter, _p:Slice<GoUInt8>):{ var _0 : GoInt; var _1 : Error; } return __self__.write(_p);
    @:embedded
    public static function unreadRune( __self__:ReadWriter):Error return __self__.unreadRune();
    @:embedded
    public static function unreadByte( __self__:ReadWriter):Error return __self__.unreadByte();
    @:embedded
    public static function readString( __self__:ReadWriter, _delim:GoUInt8):{ var _0 : GoString; var _1 : Error; } return __self__.readString(_delim);
    @:embedded
    public static function readSlice( __self__:ReadWriter, _delim:GoUInt8):{ var _0 : Slice<GoUInt8>; var _1 : Error; } return __self__.readSlice(_delim);
    @:embedded
    public static function readRune( __self__:ReadWriter):{ var _0 : GoInt32; var _1 : GoInt; var _2 : Error; } return __self__.readRune();
    @:embedded
    public static function readLine( __self__:ReadWriter):{ var _0 : Slice<GoUInt8>; var _1 : Bool; var _2 : Error; } return __self__.readLine();
    @:embedded
    public static function readFrom( __self__:ReadWriter, _r:stdgo.io.Io.Reader):{ var _0 : GoInt64; var _1 : Error; } return __self__.readFrom(_r);
    @:embedded
    public static function readBytes( __self__:ReadWriter, _delim:GoUInt8):{ var _0 : Slice<GoUInt8>; var _1 : Error; } return __self__.readBytes(_delim);
    @:embedded
    public static function readByte( __self__:ReadWriter):{ var _0 : GoUInt8; var _1 : Error; } return __self__.readByte();
    @:embedded
    public static function read( __self__:ReadWriter, _p:Slice<GoUInt8>):{ var _0 : GoInt; var _1 : Error; } return __self__.read(_p);
    @:embedded
    public static function peek( __self__:ReadWriter, __0:GoInt):{ var _0 : Slice<GoUInt8>; var _1 : Error; } return __self__.peek(__0);
    @:embedded
    public static function flush( __self__:ReadWriter):Error return __self__.flush();
    @:embedded
    public static function discard( __self__:ReadWriter, __0:GoInt):{ var _0 : GoInt; var _1 : Error; } return __self__.discard(__0);
    @:embedded
    public static function availableBuffer( __self__:ReadWriter):Slice<GoUInt8> return __self__.availableBuffer();
    @:embedded
    public static function available( __self__:ReadWriter):GoInt return __self__.available();
}
    ...
    static public function scan( _s:Ref<Scanner>):Bool {
        ...
        while (true) {
            if ((_s._end > _s._start) || (_s._err != null)) {
                var __tmp__ = _s._split((_s._buf.__slice__(_s._start, _s._end) : Slice<GoUInt8>), _s._err != null), _advance:GoInt = __tmp__._0, _token:Slice<GoUInt8> = __tmp__._1, _err:Error = __tmp__._2;
                if (_err != null) {
            ...
            };
            {
                ...
                while (true) {
                    var __tmp__ = _s._r.read((_s._buf.__slice__(_s._end, (_s._buf.length)) : Slice<GoUInt8>)), _n:GoInt = __tmp__._0, _err:Error = __tmp__._1;
