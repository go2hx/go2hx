...
@:structInit class Reader {
	public function _writeBuf(_w:stdgo.io.Io.Writer):{var _0:GoInt64; var _1:Error;} {
		...
		var __tmp__ = _w.write(_b.value._buf.__slice__(_b.value._r, _b.value._w)),
			_n:GoInt = __tmp__._0,
	...
	public function writeTo(_w:stdgo.io.Io.Writer):{var _0:GoInt64; var _1:Error;} {
		...
		};
		{
			...
			if (_ok) {
				var __tmp__ = _w.readFrom(_b.value._rd),
					_m:GoInt64 = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				_n = _n + (_m);
				return {_0: _n, _1: _err};
	...
	public function readString(_delim:GoByte):{var _0:GoString; var _1:Error;} {
		var _b = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _b.value._collectFragments(_delim),
	...
	public function _collectFragments(_delim:GoByte):{
		...
		var _b = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _fullBuffers:Slice<Slice<GoByte>> = new Slice<Slice<GoUInt8>>().nil(),
			_finalFragment:Slice<GoByte> = new Slice<GoUInt8>().nil(),
	...
	public function readRune():{var _0:GoRune; var _1:GoInt; var _2:Error;} {
		...
		var _r:GoRune = ((0 : GoInt32)),
			_size:GoInt = ((0 : GoInt)),
			_err:Error = ((null : stdgo.Error));
		while (_b.value._r + stdgo.unicode.utf8.Utf8.utfmax > _b.value._w
			&& !stdgo.unicode.utf8.Utf8.fullRune(_b.value._buf.__slice__(_b.value._r, _b.value._w))
			&& _b.value._err == null
			&& _b.value._w - _b.value._r < _b.value._buf.length) {
			_b.value._fill();
		};
		_b.value._lastRuneSize = -((1 : GoUnTypedInt));
	...
	public function _fill():Void {
		...
		};
		{
			...
			Go.cfor(_i > ((0 : GoInt)), _i--, {
				var __tmp__ = _b.value._rd.read(_b.value._buf.__slice__(_b.value._w)),
					_n:GoInt = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_n < ((0 : GoInt))) {
					throw _errNegativeRead;
	...
	public function _reset(_buf:Slice<GoByte>, _r:stdgo.io.Io.Reader):Void {
		...
		_b.value = (({
			_buf: _buf,
			_rd: _r,
			_lastByte: -((1 : GoUnTypedInt)),
			_lastRuneSize: -((1 : GoUnTypedInt)),
			_r: 0,
			_w: 0,
			_err: ((null : stdgo.Error))
		} : Reader)).__copy__();
	...
	public function toString() {
		return '{' + Go.string(_buf) + " " + Go.string(_rd) + " " + Go.string(_r) + " " + Go.string(_w) + " " + Go.string(_err) + " " + Go.string(_lastByte)
			+ " " + Go.string(_lastRuneSize) + "}";
	}
...
@:structInit class Writer {
	...
	public function flush():Error {
		...
		var __tmp__ = _b.value._wr.write(_b.value._buf.__slice__(((0 : GoInt)), _b.value._n)),
			_n:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
...
@:structInit class ReadWriter {
	...
	public function new(?reader:Pointer<Reader>, ?writer:Pointer<Writer>)
		stdgo.internal.Macro.initLocals();
	...
	public function discard(_n:GoInt):{var _0:GoInt; var _1:stdgo.Error;}
		return reader.discard(_0);

	public function flush():stdgo.Error
		return writer.flush();

	public function peek(_n:GoInt):{var _0:GoInt -> {
	...
	public function readBytes(_delim:GoUInt8):{var _0:GoUInt8 -> {
		var _0:Slice<GoUInt8>;
		var _1:stdgo.Error;
	}; var _1:GoUInt8 -> {
		var _0:Slice<GoUInt8>;
		...
		return reader.readBytes(_0);

	public function readFrom(_r:stdgo.io.Io.Reader):{var _0:GoInt64; var _1:stdgo.Error;}
		return writer.readFrom(_0);

	public function readLine():{var _0:Slice<GoUInt8>; var _1:Bool; var _2:stdgo.Error;}
		return reader.readLine();

	public function readRune():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
		return reader.readRune();

	public function readSlice(_delim:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
		return reader.readSlice(_0);

	public function readString(_delim:GoUInt8):{var _0:GoUInt8 -> {
		var _0:GoString;
		var _1:stdgo.Error;
	}; var _1:GoUInt8 -> {
		var _0:GoString;
	...
	public function writeTo(_w:stdgo.io.Io.Writer):{var _0:GoInt64; var _1:stdgo.Error;}
		return reader.writeTo(_0);
	...
	public function _collectFragments(_delim:GoUInt8):{
		...
		return reader._collectFragments(_0);

	public function _fill()
		reader._fill();

	public function _readErr():stdgo.Error
		return reader._readErr();

	public function _reset(_buf:Slice<GoUInt8>, _r:stdgo.io.Io.Reader)
		reader._reset(_0, _1);

	public function _writeBuf(_w:stdgo.io.Io.Writer):{var _0:stdgo.io.Io.Writer -> {
		var _0:GoInt64;
		var _1:stdgo.Error;
	}; var _1:stdgo.io.Io.Writer -> {
		var _0:GoInt64;
		var _1:stdgo.Error;
		};}
		return reader._writeBuf(_0);
...
@:structInit class Scanner {
	...
	public function scan():Bool {
		...
		while (true) {
			if (_s.value._end > _s.value._start || _s.value._err != null) {
				var __tmp__ = _s.value._split.__t__(_s.value._buf.__slice__(_s.value._start, _s.value._end), _s.value._err != null),
			...
			if (_s.value._start > ((0 : GoInt))
				&& (_s.value._end == _s.value._buf.length || _s.value._start > _s.value._buf.length / ((2 : GoInt)))) {
			...
			};
			{
				...
				while (true) {
					var __tmp__ = _s.value._r.read(_s.value._buf.__slice__(_s.value._end, _s.value._buf.length)),
						_n:GoInt = __tmp__._0,
						_err:stdgo.Error = __tmp__._1;
	...
	public function new(?_r:stdgo.io.Io.Reader, ?_split:SplitFunc, ?_maxTokenSize:GoInt, ?_token:Slice<GoUInt8>, ?_buf:Slice<GoUInt8>, ?_start:GoInt,
			?_end:GoInt, ?_err:stdgo.Error, ?_empties:GoInt, ?_scanCalled:Bool, ?_done:Bool)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_r) + " " + Go.string(_split) + " " + Go.string(_maxTokenSize) + " " + Go.string(_token) + " " + Go.string(_buf) + " "
			+ Go.string(_start) + " " + Go.string(_end) + " " + Go.string(_err) + " " + Go.string(_empties) + " " + Go.string(_scanCalled) + " "
			+ Go.string(_done) + "}";
	}
...
@:named class SplitFunc {
	public var __t__:(Slice<GoUInt8>, Bool) -> {
		var _0:GoInt;
		var _1:Slice<GoUInt8>;
		var _2:stdgo.Error;
	};

	public function new(?t:(Slice<GoUInt8>, Bool) -> {
		var _0:GoInt;
		var _1:Slice<GoUInt8>;
		var _2:stdgo.Error;
	}) {
...
function newScanner(_r:stdgo.io.Io.Reader):Pointer<Scanner> {
	return Go.pointer((({
		_r: _r,
		_split: new SplitFunc(scanLines),
		_maxTokenSize: maxScanTokenSize,
		_token: new Slice<GoUInt8>().nil(),
...
function scanBytes(_data:Slice<GoByte>, _atEOF:Bool):{var _0:GoInt; var _1:Slice<GoByte>; var _2:Error;} {
	var _advance:GoInt = ((0 : GoInt)),
		_token:Slice<GoByte> = new Slice<GoUInt8>().nil(),
		_err:Error = ((null : stdgo.Error));
...
function _isSpace(_r:GoRune):Bool {
	if (_r <= (("\u{00FF}".code : GoRune))) {
		if (_r == ((" ".code : GoRune)) || _r == (("\t".code : GoRune)) || _r == (("\n".code : GoRune)) || _r == (("".code : GoRune))
			|| _r == (("".code : GoRune)) || _r == (("\r".code : GoRune))) {
			return true;
	...
	if (_r == (("\u{1680}".code : GoRune)) || _r == (("\u{2028}".code : GoRune)) || _r == (("\u{2029}".code : GoRune))
		|| _r == (("\u{202f}".code : GoRune)) || _r == (("\u{205f}".code : GoRune)) || _r == (("\u{3000}".code : GoRune))) {
		return true;
	};
	return false;
}
...
class Reader_extension_fields {
	...
	public function reset(__tmp__, _r:stdgo.io.Io.Reader):Void
		__tmp__.reset(_r);

	public function _reset(__tmp__, _buf:Slice<GoByte>, _r:stdgo.io.Io.Reader):Void
		__tmp__._reset(_buf, _r);

	public function _fill(__tmp__):Void
		__tmp__._fill();

	public function _readErr(__tmp__):Error
		return __tmp__._readErr();

	public function peek(__tmp__, _n:GoInt):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__.peek(_n);

	public function discard(__tmp__, _n:GoInt):{var _0:GoInt; var _1:Error;}
		return __tmp__.discard(_n);
	...
	public function buffered(__tmp__):GoInt
		return __tmp__.buffered();

	public function readSlice(__tmp__, _delim:GoByte):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__.readSlice(_delim);

	public function readLine(__tmp__):{var _0:Slice<GoByte>; var _1:Bool; var _2:Error;}
		return __tmp__.readLine();

	public function _collectFragments(__tmp__, _delim:GoByte):{
		var _0:Slice<Slice<GoByte>>;
		var _1:Slice<GoByte>;
		var _2:GoInt;
		var _3:Error;
	}
		return __tmp__._collectFragments(_delim);
	...
	public function _writeBuf(__tmp__, _w:stdgo.io.Io.Writer):{var _0:GoInt64; var _1:Error;}
		return __tmp__._writeBuf(_w);
}
...
class Writer_extension_fields {
	...
	public function available(__tmp__):GoInt
		return __tmp__.available();
...
class Scanner_extension_fields {
	...
	public function text(__tmp__):GoString
		return __tmp__.text();

	public function scan(__tmp__):Bool
		return __tmp__.scan();

	public function _advance(__tmp__, _n:GoInt):Bool
		return __tmp__._advance(_n);

	public function _setErr(__tmp__, _err:Error):Void
		__tmp__._setErr(_err);

	public function buffer(__tmp__, _buf:Slice<GoByte>, _max:GoInt):Void
		__tmp__.buffer(_buf, _max);

	public function split(__tmp__, _split:SplitFunc):Void
		__tmp__.split(_split);
}
