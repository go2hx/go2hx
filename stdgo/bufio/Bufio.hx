...
@:structInit @:using(stdgo.bufio.Bufio.Reader_static_extension) class Reader {
    ...
    public function new(?_buf:stdgo.Slice<stdgo.GoUInt8>, ?_rd:stdgo.io.Io.Reader, ?_r:stdgo.GoInt, ?_w:stdgo.GoInt, ?_err:stdgo.Error, ?_lastByte:stdgo.GoInt, ?_lastRuneSize:stdgo.GoInt) {
...
@:structInit @:using(stdgo.bufio.Bufio.Writer_static_extension) class Writer {
    ...
    public function new(?_err:stdgo.Error, ?_buf:stdgo.Slice<stdgo.GoUInt8>, ?_n:stdgo.GoInt, ?_wr:stdgo.io.Io.Writer) {
        if (_err != null) this._err = _err;
        if (_buf != null) this._buf = _buf;
...
@:structInit @:using(stdgo.bufio.Bufio.ReadWriter_static_extension) class ReadWriter {
    @:embedded
    public var reader : stdgo.Ref<stdgo.bufio.Bufio.Reader> = (null : stdgo.Ref<stdgo.bufio.Bufio.Reader>);
    @:embedded
    public var writer : stdgo.Ref<stdgo.bufio.Bufio.Writer> = (null : stdgo.Ref<stdgo.bufio.Bufio.Writer>);
    public function new(?reader:stdgo.Ref<stdgo.bufio.Bufio.Reader>, ?writer:stdgo.Ref<stdgo.bufio.Bufio.Writer>) {
    ...
    @:embedded
    public function readFrom(_r:stdgo.io.Io.Reader):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } return writer.readFrom(_r);
    @:embedded
    ...
    @:embedded
    public function writeTo(_w:stdgo.io.Io.Writer):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } return reader.writeTo(_w);
    @:embedded
    ...
    @:embedded
    public function _reset(_buf:stdgo.Slice<stdgo.GoUInt8>, _r:stdgo.io.Io.Reader) reader._reset(_buf, _r);
    @:embedded
    public function _writeBuf(_w:stdgo.io.Io.Writer):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } return reader._writeBuf(_w);
    public function __copy__() {
...
@:structInit @:using(stdgo.bufio.Bufio.Scanner_static_extension) class Scanner {
    ...
    public function new(?_r:stdgo.io.Io.Reader, ?_split:stdgo.bufio.Bufio.SplitFunc, ?_maxTokenSize:stdgo.GoInt, ?_token:stdgo.Slice<stdgo.GoUInt8>, ?_buf:stdgo.Slice<stdgo.GoUInt8>, ?_start:stdgo.GoInt, ?_end:stdgo.GoInt, ?_err:stdgo.Error, ?_empties:stdgo.GoInt, ?_scanCalled:Bool, ?_done:Bool) {
        if (_r != null) this._r = _r;
...
**/
function newReaderSize(_rd:stdgo.io.Io.Reader, _size:stdgo.GoInt):stdgo.Ref<Reader> {
        var __tmp__ = try {
        ...
        var _r = (stdgo.Go.setRef(({} : stdgo.bufio.Bufio.Reader)) : stdgo.Ref<stdgo.bufio.Bufio.Reader>);
...
**/
function newReader(_rd:stdgo.io.Io.Reader):stdgo.Ref<Reader> {
...
**/
function newWriterSize(_w:stdgo.io.Io.Writer, _size:stdgo.GoInt):stdgo.Ref<Writer> {
        var __tmp__ = try {
            { _0 : (stdgo.Go.typeAssert((stdgo.Go.toInterface(_w) : stdgo.Ref<Writer>)) : stdgo.Ref<Writer>), _1 : true };
        } catch(_) {
            { _0 : (null : stdgo.Ref<stdgo.bufio.Bufio.Writer>), _1 : false };
        }, _b = __tmp__._0, _ok = __tmp__._1;
        if (_ok && (_b._buf.length >= _size)) {
            return _b;
        };
        ...
        return (stdgo.Go.setRef(({ _buf : new stdgo.Slice<stdgo.GoUInt8>((_size : stdgo.GoInt).toBasic(), 0).__setNumber32__(), _wr : _w } : stdgo.bufio.Bufio.Writer)) : stdgo.Ref<stdgo.bufio.Bufio.Writer>);
    }
/**
...
function newReadWriter(_r:stdgo.Ref<Reader>, _w:stdgo.Ref<Writer>):stdgo.Ref<ReadWriter> {
        return (stdgo.Go.setRef((new stdgo.bufio.Bufio.ReadWriter(_r, _w) : stdgo.bufio.Bufio.ReadWriter)) : stdgo.Ref<stdgo.bufio.Bufio.ReadWriter>);
    }
/**
    // NewScanner returns a new Scanner to read from r.
    // The split function defaults to ScanLines.
**/
function newScanner(_r:stdgo.io.Io.Reader):stdgo.Ref<Scanner> {
        return (stdgo.Go.setRef(({ _r : _r, _split : scanLines, _maxTokenSize : (65536 : stdgo.GoInt) } : stdgo.bufio.Bufio.Scanner)) : stdgo.Ref<stdgo.bufio.Bufio.Scanner>);
    }
/**
...
function scanRunes(_data:stdgo.Slice<stdgo.GoByte>, _atEOF:Bool):{ var _0 : stdgo.GoInt; var _1 : stdgo.Slice<stdgo.GoByte>; var _2 : stdgo.Error; } {
        ...
        var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRune(_data), __0:stdgo.GoInt32 = __tmp__._0, _width:stdgo.GoInt = __tmp__._1;
...
function scanLines(_data:stdgo.Slice<stdgo.GoByte>, _atEOF:Bool):{ var _0 : stdgo.GoInt; var _1 : stdgo.Slice<stdgo.GoByte>; var _2 : stdgo.Error; } {
        ...
        {
            var _i:stdgo.GoInt = stdgo.bytes.Bytes.indexByte(_data, (10 : stdgo.GoUInt8));
            if (_i >= (0 : stdgo.GoInt)) {
...
function scanWords(_data:stdgo.Slice<stdgo.GoByte>, _atEOF:Bool):{ var _0 : stdgo.GoInt; var _1 : stdgo.Slice<stdgo.GoByte>; var _2 : stdgo.Error; } {
        ...
        var _start:stdgo.GoInt = (0 : stdgo.GoInt);
        {
            ...
            stdgo.Go.cfor(_start < (_data.length), _start = _start + (_width), {
                ...
                {
                    var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRune((_data.__slice__(_start) : stdgo.Slice<stdgo.GoUInt8>));
                    _r = __tmp__._0;
                    _width = __tmp__._1;
                };
                if (!_isSpace(_r)) {
        ...
        };
        {
            ...
            stdgo.Go.cfor(_i < (_data.length), _i = _i + (_width), {
                var _r:stdgo.GoRune = (0 : stdgo.GoInt32);
                {
                    var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRune((_data.__slice__(_i) : stdgo.Slice<stdgo.GoUInt8>));
                    _r = __tmp__._0;
                    _width = __tmp__._1;
                };
                if (_isSpace(_r)) {
...
class Reader_asInterface {
    ...
    **/
    @:keep
    public dynamic function _writeBuf(_w:stdgo.io.Io.Writer):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } return __self__.value._writeBuf(_w);
    /**
    ...
    **/
    ...
    @:keep
    public dynamic function _reset(_buf:stdgo.Slice<stdgo.GoByte>, _r:stdgo.io.Io.Reader):Void __self__.value._reset(_buf, _r);
    /**
...
@:keep @:allow(stdgo.bufio.Bufio.Reader_asInterface) class Reader_static_extension {
    ...
    **/
    @:keep
    static public function _writeBuf( _b:stdgo.Ref<Reader>, _w:stdgo.io.Io.Writer):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } {
    ...
    **/
    @:keep
    static public function writeTo( _b:stdgo.Ref<Reader>, _w:stdgo.io.Io.Writer):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } {
        @:recv var _b:stdgo.Ref<Reader> = _b;
    ...
    **/
    ...
    static public function readSlice( _b:stdgo.Ref<Reader>, _delim:stdgo.GoByte):{ var _0 : stdgo.Slice<stdgo.GoByte>; var _1 : stdgo.Error; } {
        ...
        while (true) {
            {
                var _i:stdgo.GoInt = stdgo.bytes.Bytes.indexByte((_b._buf.__slice__(_b._r + _s, _b._w) : stdgo.Slice<stdgo.GoUInt8>), _delim);
                if (_i >= (0 : stdgo.GoInt)) {
                    _i = _i + (_s);
    ...
    **/
    ...
    static public function readRune( _b:stdgo.Ref<Reader>):{ var _0 : stdgo.GoRune; var _1 : stdgo.GoInt; var _2 : stdgo.Error; } {
        ...
        while (((((_b._r + (4 : stdgo.GoInt)) > _b._w) && !stdgo.unicode.utf8.Utf8.fullRune((_b._buf.__slice__(_b._r, _b._w) : stdgo.Slice<stdgo.GoUInt8>))) && (_b._err == null)) && ((_b._w - _b._r) < _b._buf.length)) {
            _b._fill();
        };
        _b._lastRuneSize = (-1 : stdgo.GoInt);
        if (_b._r == (_b._w)) {
        ...
        if (_r >= (128 : stdgo.GoInt32)) {
            {
                var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRune((_b._buf.__slice__(_b._r, _b._w) : stdgo.Slice<stdgo.GoUInt8>));
                _r = __tmp__._0;
                _size = __tmp__._1;
            };
        };
    ...
    **/
    ...
    @:keep
    static public function _reset( _b:stdgo.Ref<Reader>, _buf:stdgo.Slice<stdgo.GoByte>, _r:stdgo.io.Io.Reader):Void {
        @:recv var _b:stdgo.Ref<Reader> = _b;
        {
            var __tmp__ = ({ _buf : _buf, _rd : _r, _lastByte : (-1 : stdgo.GoInt), _lastRuneSize : (-1 : stdgo.GoInt) } : stdgo.bufio.Bufio.Reader);
    ...
    **/
    @:keep
    static public function reset( _b:stdgo.Ref<Reader>, _r:stdgo.io.Io.Reader):Void {
        @:recv var _b:stdgo.Ref<Reader> = _b;
...
@:keep @:allow(stdgo.bufio.Bufio.Writer_asInterface) class Writer_static_extension {
    ...
    **/
    @:keep
    static public function readFrom( _b:stdgo.Ref<Writer>, _r:stdgo.io.Io.Reader):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } {
    ...
    **/
    ...
    static public function writeRune( _b:stdgo.Ref<Writer>, _r:stdgo.GoRune):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        ...
        _size = stdgo.unicode.utf8.Utf8.encodeRune((_b._buf.__slice__(_b._n) : stdgo.Slice<stdgo.GoUInt8>), _r);
        _b._n = _b._n + (_size);
    ...
    **/
    @:keep
    static public function reset( _b:stdgo.Ref<Writer>, _w:stdgo.io.Io.Writer):Void {
        @:recv var _b:stdgo.Ref<Writer> = _b;
...
class ReadWriter_asInterface {
    ...
    public dynamic function _writeBuf(_w:stdgo.io.Io.Writer):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } return __self__.value._writeBuf(_w);
    @:embedded
    public dynamic function _reset(_buf:stdgo.Slice<stdgo.GoUInt8>, _r:stdgo.io.Io.Reader):Void __self__.value._reset(_buf, _r);
    @:embedded
    public dynamic function _readErr():stdgo.Error return __self__.value._readErr();
    @:embedded
    public dynamic function _fill():Void __self__.value._fill();
...
@:keep @:allow(stdgo.bufio.Bufio.ReadWriter_asInterface) class ReadWriter_static_extension {
    @:embedded
    public static function _writeBuf( __self__:ReadWriter, _w:stdgo.io.Io.Writer):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } return __self__._writeBuf(_w);
    @:embedded
    public static function _reset( __self__:ReadWriter, _buf:stdgo.Slice<stdgo.GoUInt8>, _r:stdgo.io.Io.Reader) __self__._reset(_buf, _r);
    @:embedded
    ...
    @:embedded
    public static function writeTo( __self__:ReadWriter, _w:stdgo.io.Io.Writer):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } return __self__.writeTo(_w);
    @:embedded
    ...
    @:embedded
    public static function readFrom( __self__:ReadWriter, _r:stdgo.io.Io.Reader):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } return __self__.readFrom(_r);
    @:embedded
