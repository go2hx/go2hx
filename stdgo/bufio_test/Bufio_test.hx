...
private var _segmentList:Slice<Slice<GoString>> = (new Slice<Slice<GoString>>(0, 0, (new Slice<GoString>(0, 0) : Slice<GoString>),
	...
	(new Slice<GoString>(0, 0, Go.str("\u{000065e5}"), Go.str("\u{0000672c}"), Go.str("\u{00008a9e}")) : Slice<GoString>),
	(new Slice<GoString>(0, 0, Go.str(230), Go.str(151, 165, 230), Go.str(156, 172, 232, 170, 158)) : Slice<GoString>),
...
function testReader(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _all:GoString = Go.str();
	{
		...
		Go.cfor(_i < (30:GoInt), _i++, {
			_texts[_i] = _str + Go.str("\n");
			_all = _all + (_texts[_i]);
			_str = _str + ((((_i % (26 : GoInt)) + ("a".code : GoRune) : GoRune) : GoString));
		});
	};
						...
						Go.cfor(_j < (_bufreaders.length), _j++, {
							{
								...
								Go.cfor(_k < (_bufsizes.length), _k++, {
									var _readmaker:stdgo.bufio_test.Bufio_test.T_readMaker = (_readMakers[_i] == null ? null : _readMakers[_i].__copy__());
									var _bufreader:stdgo.bufio_test.Bufio_test.T_bufReader = (_bufreaders[_j] == null ? null : _bufreaders[_j].__copy__());
									var _bufsize:GoInt = _bufsizes[_k];
...
function testUnreadByteOthers(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	for (_rno => _read in _readers) {
		...
		};
		{
			var _i:GoInt = (0 : GoInt);
			Go.cfor(_i < (10:GoInt), _i++, {
				_readTo(("d".code : GoRune), Go.str("abcd"));
				{
					var _j:GoInt = (0 : GoInt);
					Go.cfor(_j < (3:GoInt), _j++, {
						...
						_readTo(("d".code : GoRune), Go.str("d"));
					});
				};
				_readTo(("g".code : GoRune), Go.str("efg"));
			});
		};
		var __tmp__ = _r.readByte(),
...
function testReadStringAllocs(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _allocs:GoFloat64 = stdgo.testing.Testing.allocsPerRun((100 : GoInt), function():Void {
		...
		var __tmp__ = _buf.readString(("\n".code : GoRune)), _0:GoString = __tmp__._0, _err:Error = __tmp__._1;
		if (_err != null) {
...
function testWriter(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _data:GoArray<GoByte> = new GoArray<GoUInt8>(...[for (i in 0...8192) (0 : GoUInt8)]);
	{
		...
		Go.cfor(_i < (_data.length), _i++, {
			_data[_i] = ((" ".code : GoRune) + (_i % (94 : GoInt)) : GoByte);
		});
	};
		...
		Go.cfor(_i < (_bufsizes.length), _i++, {
			{
				...
				Go.cfor(_j < (_bufsizes.length), _j++, {
					var _nwrite:GoInt = _bufsizes[_i];
					var _bs:GoInt = _bufsizes[_j];
					_w.reset();
...
function testWriterAppend(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _w = newWriterSize(Go.asInterface(_got), (64 : GoInt));
	{
		...
		Go.cfor(_i < (100:GoInt), _i++, {
			...
			_want = (stdgo.strconv.Strconv.appendInt(_want, _n, (10 : GoInt)).__append__((" ".code : GoRune)));
			_b = (stdgo.strconv.Strconv.appendInt(_b, _n, (10 : GoInt)).__append__((" ".code : GoRune)));
			_w.write(_b);
		});
	};
	_w.flush();
...
function testBufferFull(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _buf = newReaderSize(Go.asInterface(stdgo.strings.Strings.newReader(Go.str("And now, hello, world! It is the time for all good men to come to the aid of their party"))),
		(16 : GoInt));
	var __tmp__ = _buf.readSlice(("!".code : GoRune)),
...
function testPeek(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	_buf = newReaderSize(Go.asInterface((Go.str("abcd") : T_dataAndEOFReader)), (32 : GoInt));
	{
		...
		if (((_s : GoString) != Go.str("ab")) || (_err != null)) {
			_t.errorf("Peek(2) on \"abcd\", EOF = %q, %v; want \"ab\", nil", Go.toInterface((_s : GoString)), Go.toInterface(_err));
		};
	};
	{
		var __tmp__ = _buf.peek((4 : GoInt)),
			...
			_err:Error = __tmp__._1;
		if (((_s : GoString) != Go.str("abcd")) || (_err != null)) {
			_t.errorf("Peek(4) on \"abcd\", EOF = %q, %v; want \"abcd\", nil", Go.toInterface((_s : GoString)), Go.toInterface(_err));
		};
	};
	{
	...
	};
	{
		...
		if ((((_p.__slice__((0 : GoInt), _n) : Slice<GoUInt8>) : GoString) != Go.str())
			...
			_t.fatalf("second Read after peek = %q, %v; want \"\", EOF", Go.toInterface((_p.__slice__((0 : GoInt), _n) : Slice<GoUInt8>)),
				Go.toInterface(_err));
		};
	};
}
...
function testLineTooLong(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _data = new Slice<GoUInt8>((0 : GoInt).toBasic(), 0, ...[for (i in 0...(0 : GoInt).toBasic()) (0 : GoUInt8)]);
	{
		...
		Go.cfor(_i < (40:GoInt), _i++, {
			_data = _data.__appendref__(("0".code : GoRune) + (_i % (10 : GoInt) : GoByte));
		});
	};
...
function testReaderWriteTo(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	for (_i => _val in _w.bytes()) {
		if (_val != (_input[_i])) {
			_t.errorf(Go.str("after write: out[%d] = %#x, want %#x"), Go.toInterface(_i), Go.toInterface(_val), Go.toInterface(_input[_i]));
		};
	};
}
		...
		for (_wi => _wfunc in _ws) {
			...
			};
			{
				var _got:GoString = (_b.string() : GoString),
					_want:GoString = (_input : GoString);
				if (_got != (_want)) {
...
function testWriterReadFromUntilEOF(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	_w.flush();
	{
		var _got:GoString = (_buf.bytes() : GoString),
			_want:GoString = Go.str("0123abcd");
		if (_got != (_want)) {
...
function testWriterReadFromWithBufferedData(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	{
		var _got:GoInt = _rfw._writeBytes, _want:GoInt = (16 : GoInt);
		if (_got != (_want)) {
			_t.errorf(Go.str("wrote %v bytes with Write, want %v"), Go.toInterface(_got), Go.toInterface(_want));
		};
	};
	{
		var _got:GoInt = _rfw._readFromBytes,
			_want:GoInt = (_input.length) - (16 : GoInt);
		if (_got != (_want)) {
...
function testWriterReset(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _buf1:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer),
		...
		_buf3:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
...
function testReaderDiscard(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	for (_0 => _tt in _tests) {
		...
		var __tmp__ = _br.discard(_tt._n),
			...
			_err:Error = __tmp__._1;
		{
			var _ge:GoString = stdgo.fmt.Fmt.sprint(_err),
				_we:GoString = stdgo.fmt.Fmt.sprint(_tt._wantErr);
...
function testReaderSize(_t:Ref<stdgo.testing.Testing.T>):Void {
	{
		var _got:GoInt = newReader((null : stdgo.io.Io.Reader)).size(),
			_want:GoInt = (4096 : GoInt);
		if (_got != (_want)) {
			_t.errorf(Go.str("NewReader\'s Reader.Size = %d; want %d"), Go.toInterface(_got), Go.toInterface(_want));
		};
	};
	{
		var _got:GoInt = newReaderSize((null : stdgo.io.Io.Reader), (1234 : GoInt)).size(),
			_want:GoInt = (1234 : GoInt);
		if (_got != (_want)) {
...
function testWriterSize(_t:Ref<stdgo.testing.Testing.T>):Void {
	{
		var _got:GoInt = newWriter((null : stdgo.io.Io.Writer)).size(),
			_want:GoInt = (4096 : GoInt);
		if (_got != (_want)) {
	...
	{
		var _got:GoInt = newWriterSize((null : stdgo.io.Io.Writer), (1234 : GoInt)).size(),
			_want:GoInt = (1234 : GoInt);
		if (_got != (_want)) {
...
function benchmarkWriterEmpty(_b:Ref<stdgo.testing.Testing.B>):Void {
	...
	var _bs = (_str : Slice<GoByte>);
	{
		...
		Go.cfor(_i < _b.n, _i++, {
			...
			_bw.flush();
			_bw.writeByte(("a".code : GoRune));
			_bw.flush();
			_bw.writeRune(("B".code : GoRune));
			_bw.flush();
			_bw.write(_bs);
			_bw.flush();
...
function exampleWriter():Void {
	...
	stdgo.fmt.Fmt.fprint(_w, Go.str("Hello, "));
	stdgo.fmt.Fmt.fprint(_w, Go.str("world!"));
	_w.flush();
}
...
function exampleScanner_lines():Void {
	...
	while (_scanner.scan()) {
		stdgo.fmt.Fmt.println(_scanner.text());
	};
	{
		var _err:Error = _scanner.err();
		if (_err != null) {
			stdgo.fmt.Fmt.fprintln(stdgo.os.Os.stderr, Go.str("reading standard input:"), _err);
		};
	};
}
...
function exampleScanner_Bytes():Void {
	...
	while (_scanner.scan()) {
		stdgo.fmt.Fmt.println((_scanner.bytes().length) == ((6 : GoInt)));
	};
	{
		var _err:Error = _scanner.err();
		if (_err != null) {
			stdgo.fmt.Fmt.fprintln(stdgo.os.Os.stderr, Go.str("shouldn\'t see an error scanning a string"));
		};
	};
}
...
function exampleScanner_words():Void {
	...
	};
	{
		var _err:Error = _scanner.err();
		if (_err != null) {
			stdgo.fmt.Fmt.fprintln(stdgo.os.Os.stderr, Go.str("reading input:"), _err);
		};
	};
	...
	for (_n => _test in _scanTests) {
		...
		var _i:GoInt = (0 : GoInt);
		{
			...
			Go.cfor(_s.scan(), _i++, {
				{
					var _b = _s.bytes();
					if ((_b.length != (1 : GoInt)) || (_b[(0 : GoInt)] != _test[_i])) {
...
function testScanRune(_t:Ref<stdgo.testing.Testing.T>):Void {
	for (_n => _test in _scanTests) {
		...
		var _s = newScanner(Go.asInterface(_buf));
		_s.split(scanRunes);
		var _i:GoInt = (0 : GoInt), _runeCount:GoInt = (0 : GoInt);
	...
	for (_n => _test in _wordScanTests) {
		...
		var _wordCount:GoInt = (0 : GoInt);
		{
			...
			Go.cfor(_wordCount < (_words.length), _wordCount++, {
				...
				if (_got != (_words[_wordCount])) {
					_t.errorf(Go.str("#%d: %d: expected %q got %q"), Go.toInterface(_n), Go.toInterface(_wordCount), Go.toInterface(_words[_wordCount]),
						Go.toInterface(_got));
				};
			});
		};
...
function _genLine(_buf:Ref<stdgo.bytes.Bytes.Buffer>, _lineNum:GoInt, _n:GoInt, _addNewline:Bool):Void {
	...
	};
	{
		...
		Go.cfor(_i < (_n - (1 : GoInt)), _i++, {
			var _c:GoUInt8 = ("a".code : GoRune) + (_lineNum + _i : GoByte);
			if ((_c == ("\n".code : GoRune)) || (_c == ("\r".code : GoRune))) {
				_c = ("N".code : GoRune);
			};
			_buf.writeByte(_c);
		});
...
function _testNoNewline(_text:GoString, _lines:Slice<GoString>, _t:Ref<stdgo.testing.Testing.T>):Void {
	...
	_s.split(scanLines);
	{
		var _lineNum:GoInt = (0 : GoInt);
		Go.cfor(_s.scan(), _lineNum++, {
			var _line:GoString = _lines[_lineNum];
			if (_s.text() != (_line)) {
				_t.errorf(Go.str("%d: bad line: %d %d\n%.100q\n%.100q\n"), Go.toInterface(_lineNum), Go.toInterface((_s.bytes().length)),
					Go.toInterface((_line.length)), Go.toInterface(_s.bytes()), Go.toInterface(_line));
			};
...
function testSplitError(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _i:GoInt = (0 : GoInt);
	{
		_i = (0 : GoInt);
		Go.cfor(_s.scan(), _i++, {
			if ((_s.bytes().length != (1 : GoInt)) || (Go.str("abcdefghijklmnopqrstuvwxyz")[_i] != _s.bytes()[(0 : GoInt)])) {
				_t.errorf(Go.str("#%d: expected %q got %q"), Go.toInterface(_i), Go.toInterface(Go.str("abcdefghijklmnopqrstuvwxyz")[_i]),
...
function _testEmptyTokens(_t:Ref<stdgo.testing.Testing.T>, _text:GoString, _values:Slice<GoString>):Void {
	...
	var _i:GoInt = (0 : GoInt);
	{
		...
		Go.cfor(_s.scan(), _i++, {
			...
			if (_s.text() != (_values[_i])) {
				_t.errorf(Go.str("%d: expected %q got %q"), Go.toInterface(_i), Go.toInterface(_values[_i]), Go.toInterface(_s.text()));
			};
		});
	};
	if (_i != ((_values.length))) {
...
function testNegativeEOFReader(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	{
		var _got:Error = _scanner.err(), _want:Error = errBadReadCount;
...
@:keep @:allow(stdgo.bufio_test.Bufio_test.T_rot13Reader_asInterface) class T_rot13Reader_static_extension {
	...
	static public function read(_r13:Ref<T_rot13Reader>, _p:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
			...
			_err:Error = __tmp__._1;
		{
			var _i:GoInt = (0 : GoInt);
			Go.cfor(_i < _n, _i++, {
				var _c:GoUInt8 = _p[_i] | (32 : GoUInt8);
				if ((("a".code : GoRune) <= _c) && (_c <= ("m".code : GoRune))) {
					_p[_i] = _p[_i] + ((13 : GoUInt8));
				} else if ((("n".code : GoRune) <= _c) && (_c <= ("z".code : GoRune))) {
					_p[_i] = _p[_i] - ((13 : GoUInt8));
				};
			});
		};
...
@:keep @:allow(stdgo.bufio_test.Bufio_test.StringReader_asInterface) class StringReader_static_extension {
	...
	static public function read(_r:Ref<StringReader>, _p:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
		...
		if (_r._step < (_r._data.length)) {
			var _s:GoString = _r._data[_r._step];
