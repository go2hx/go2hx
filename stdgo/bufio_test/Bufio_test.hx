...
**/
private var _readMakers = (new Slice<stdgo.bufio_test.Bufio_test.T_readMaker>(5, 5, (new stdgo.bufio_test.Bufio_test.T_readMaker(("full" : GoString), function(_r:stdgo.io.Io.Reader):stdgo.io.Io.Reader {
        return _r;
...
**/
private var _bufreaders = (new Slice<stdgo.bufio_test.Bufio_test.T_bufReader>(8, 8, (new stdgo.bufio_test.Bufio_test.T_bufReader(("1" : GoString), function(_b:Ref<Reader>):GoString {
...
**/
private var _segmentList = (new Slice<Slice<GoString>>(8, 8, (new Slice<GoString>(0, 0) : Slice<GoString>), (new Slice<GoString>(1, 1, Go.str()) : Slice<GoString>), (new Slice<GoString>(2, 2, ("日" : GoString), ("本語" : GoString)) : Slice<GoString>), (new Slice<GoString>(3, 3, ("日" : GoString), ("本" : GoString), ("語" : GoString)) : Slice<GoString>), (new Slice<GoString>(3, 3, ("日" : GoString), ("本" : GoString), ("語" : GoString)) : Slice<GoString>), (new Slice<GoString>(3, 3, Go.str(230), Go.str(151, 165, 230), Go.str(156, 172, "語")) : Slice<GoString>), (new Slice<GoString>(4, 4, ("Hello" : GoString), (", " : GoString), ("World" : GoString), ("!" : GoString)) : Slice<GoString>), (new Slice<GoString>(5, 5, ("Hello" : GoString), (", " : GoString), Go.str(), ("World" : GoString), ("!" : GoString)) : Slice<GoString>)) : Slice<Slice<GoString>>);
/**
    
    
    
**/
private var _errorWriterTests = (new Slice<stdgo.bufio_test.Bufio_test.T_errorWriterTest>(6, 6, (new stdgo.bufio_test.Bufio_test.T_errorWriterTest((0 : GoInt), (1 : GoInt), (null : Error), stdgo.io.Io.errShortWrite) : stdgo.bufio_test.Bufio_test.T_errorWriterTest), (new stdgo.bufio_test.Bufio_test.T_errorWriterTest((1 : GoInt), (2 : GoInt), (null : Error), stdgo.io.Io.errShortWrite) : stdgo.bufio_test.Bufio_test.T_errorWriterTest), (new stdgo.bufio_test.Bufio_test.T_errorWriterTest((1 : GoInt), (1 : GoInt), (null : Error), (null : Error)) : stdgo.bufio_test.Bufio_test.T_errorWriterTest), (new stdgo.bufio_test.Bufio_test.T_errorWriterTest((0 : GoInt), (1 : GoInt), stdgo.io.Io.errClosedPipe, stdgo.io.Io.errClosedPipe) : stdgo.bufio_test.Bufio_test.T_errorWriterTest), (new stdgo.bufio_test.Bufio_test.T_errorWriterTest((1 : GoInt), (2 : GoInt), stdgo.io.Io.errClosedPipe, stdgo.io.Io.errClosedPipe) : stdgo.bufio_test.Bufio_test.T_errorWriterTest), (new stdgo.bufio_test.Bufio_test.T_errorWriterTest((1 : GoInt), (1 : GoInt), stdgo.io.Io.errClosedPipe, stdgo.io.Io.errClosedPipe) : stdgo.bufio_test.Bufio_test.T_errorWriterTest)) : Slice<stdgo.bufio_test.Bufio_test.T_errorWriterTest>);
/**
...
**/
private var _readLineNewlinesTests = (new Slice<T__struct_0>(2, 2, ({ _input : ("012345678901234\r\n012345678901234\r\n" : GoString), _expect : (new Slice<stdgo.bufio_test.Bufio_test.T_readLineResult>(5, 5, (new stdgo.bufio_test.Bufio_test.T_readLineResult((("012345678901234" : GoString) : Slice<GoByte>), true, (null : Error)) : stdgo.bufio_test.Bufio_test.T_readLineResult), (new stdgo.bufio_test.Bufio_test.T_readLineResult((null : Slice<GoUInt8>), false, (null : Error)) : stdgo.bufio_test.Bufio_test.T_readLineResult), (new stdgo.bufio_test.Bufio_test.T_readLineResult((("012345678901234" : GoString) : Slice<GoByte>), true, (null : Error)) : stdgo.bufio_test.Bufio_test.T_readLineResult), (new stdgo.bufio_test.Bufio_test.T_readLineResult((null : Slice<GoUInt8>), false, (null : Error)) : stdgo.bufio_test.Bufio_test.T_readLineResult), (new stdgo.bufio_test.Bufio_test.T_readLineResult((null : Slice<GoUInt8>), false, stdgo.io.Io.eof) : stdgo.bufio_test.Bufio_test.T_readLineResult)) : Slice<stdgo.bufio_test.Bufio_test.T_readLineResult>) } : T__struct_0), ({ _input : ("0123456789012345\r012345678901234\r" : GoString), _expect : (new Slice<stdgo.bufio_test.Bufio_test.T_readLineResult>(4, 4, (new stdgo.bufio_test.Bufio_test.T_readLineResult((("0123456789012345" : GoString) : Slice<GoByte>), true, (null : Error)) : stdgo.bufio_test.Bufio_test.T_readLineResult), (new stdgo.bufio_test.Bufio_test.T_readLineResult((("\r012345678901234" : GoString) : Slice<GoByte>), true, (null : Error)) : stdgo.bufio_test.Bufio_test.T_readLineResult), (new stdgo.bufio_test.Bufio_test.T_readLineResult((("\r" : GoString) : Slice<GoByte>), false, (null : Error)) : stdgo.bufio_test.Bufio_test.T_readLineResult), (new stdgo.bufio_test.Bufio_test.T_readLineResult((null : Slice<GoUInt8>), false, stdgo.io.Io.eof) : stdgo.bufio_test.Bufio_test.T_readLineResult)) : Slice<stdgo.bufio_test.Bufio_test.T_readLineResult>) } : T__struct_0)) : Slice<T__struct_0>);
/**
    
    
    
**/
private var _errorWriterToTests = (new Slice<stdgo.bufio_test.Bufio_test.T_errorWriterToTest>(4, 4, (new stdgo.bufio_test.Bufio_test.T_errorWriterToTest((1 : GoInt), (0 : GoInt), (null : Error), stdgo.io.Io.errClosedPipe, stdgo.io.Io.errClosedPipe) : stdgo.bufio_test.Bufio_test.T_errorWriterToTest), (new stdgo.bufio_test.Bufio_test.T_errorWriterToTest((0 : GoInt), (1 : GoInt), stdgo.io.Io.errClosedPipe, (null : Error), stdgo.io.Io.errClosedPipe) : stdgo.bufio_test.Bufio_test.T_errorWriterToTest), (new stdgo.bufio_test.Bufio_test.T_errorWriterToTest((0 : GoInt), (0 : GoInt), stdgo.io.Io.errUnexpectedEOF, stdgo.io.Io.errClosedPipe, stdgo.io.Io.errClosedPipe) : stdgo.bufio_test.Bufio_test.T_errorWriterToTest), (new stdgo.bufio_test.Bufio_test.T_errorWriterToTest((0 : GoInt), (1 : GoInt), stdgo.io.Io.eof, (null : Error), (null : Error)) : stdgo.bufio_test.Bufio_test.T_errorWriterToTest)) : Slice<stdgo.bufio_test.Bufio_test.T_errorWriterToTest>);
/**
    
    
    
**/
private var _errorReaderFromTests = (new Slice<stdgo.bufio_test.Bufio_test.T_errorReaderFromTest>(5, 5, (new stdgo.bufio_test.Bufio_test.T_errorReaderFromTest((0 : GoInt), (1 : GoInt), stdgo.io.Io.eof, (null : Error), (null : Error)) : stdgo.bufio_test.Bufio_test.T_errorReaderFromTest), (new stdgo.bufio_test.Bufio_test.T_errorReaderFromTest((1 : GoInt), (1 : GoInt), stdgo.io.Io.eof, (null : Error), (null : Error)) : stdgo.bufio_test.Bufio_test.T_errorReaderFromTest), (new stdgo.bufio_test.Bufio_test.T_errorReaderFromTest((0 : GoInt), (1 : GoInt), stdgo.io.Io.errClosedPipe, (null : Error), stdgo.io.Io.errClosedPipe) : stdgo.bufio_test.Bufio_test.T_errorReaderFromTest), (new stdgo.bufio_test.Bufio_test.T_errorReaderFromTest((0 : GoInt), (0 : GoInt), stdgo.io.Io.errClosedPipe, stdgo.io.Io.errShortWrite, stdgo.io.Io.errClosedPipe) : stdgo.bufio_test.Bufio_test.T_errorReaderFromTest), (new stdgo.bufio_test.Bufio_test.T_errorReaderFromTest((1 : GoInt), (0 : GoInt), (null : Error), stdgo.io.Io.errShortWrite, stdgo.io.Io.errShortWrite) : stdgo.bufio_test.Bufio_test.T_errorReaderFromTest)) : Slice<stdgo.bufio_test.Bufio_test.T_errorReaderFromTest>);
/**
...
**/
private final _smallMaxTokenSize = (256i64 : GoUInt64);
/**
...
@:structInit @:private class T_bufReader {
    public var _name : GoString = "";
    public var _fn : Ref<stdgo.bufio.Bufio.Reader> -> GoString = null;
    public function new(?_name:GoString, ?_fn:Ref<stdgo.bufio.Bufio.Reader> -> GoString) {
        if (_name != null) this._name = _name;
        if (_fn != null) this._fn = _fn;
    }
    public function __underlying__() return Go.toInterface(this);
...
private function _newRot13Reader(_r:stdgo.io.Io.Reader):Ref<T_rot13Reader> {
        var _r13 = (Go.setRef(({} : stdgo.bufio_test.Bufio_test.T_rot13Reader)) : Ref<stdgo.bufio_test.Bufio_test.T_rot13Reader>);
        _r13._r = _r;
        return _r13;
    }
/**
                            ...
                            Go.cfor(_j < (_bufreaders.length), _j++, {
                                {
                                    ...
                                    Go.cfor(_k < (_bufsizes.length), _k++, {
                                        var _readmaker:stdgo.bufio_test.Bufio_test.T_readMaker = _readMakers[(_i : GoInt)];
                                        var _bufreader:stdgo.bufio_test.Bufio_test.T_bufReader = _bufreaders[(_j : GoInt)];
...
function testZeroReader(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        Go.routine(() -> {
            var a = function():Void {
                var __tmp__ = _r.readByte(), __0:GoUInt8 = __tmp__._0, _err:Error = __tmp__._1;
                _c.__send__(_err);
            };
            a();
        });
        Go.select([stdgo.time.Time.after((1000000000i64 : stdgo.time.Time.Duration)).__get__() => {
...
private function _readRuneSegments(_t:Ref<stdgo.testing.Testing.T>, _segments:Slice<GoString>):Void {
        ...
        var _r = newReader(Go.asInterface((Go.setRef(({ _data : _segments } : StringReader)) : Ref<stdgo.bufio_test.Bufio_test.StringReader>)));
        while (true) {
            var __tmp__ = _r.readRune(), _r:GoInt32 = __tmp__._0, __0:GoInt = __tmp__._1, _err:Error = __tmp__._2;
            if (_err != null) {
                if (Go.toInterface(_err) != (Go.toInterface(stdgo.io.Io.eof))) {
                    return;
                };
...
function testUnreadRune(_t:Ref<stdgo.testing.Testing.T>):Void {
        var _segments = (new Slice<GoString>(2, 2, ("Hello, world:" : GoString), ("日本語" : GoString)) : Slice<GoString>);
        var _r = newReader(Go.asInterface((Go.setRef(({ _data : _segments } : StringReader)) : Ref<stdgo.bufio_test.Bufio_test.StringReader>)));
        var _got:GoString = Go.str();
        var _want:GoString = stdgo.strings.Strings.join(_segments, Go.str());
        while (true) {
            var __tmp__ = _r.readRune(), _r1:GoInt32 = __tmp__._0, __0:GoInt = __tmp__._1, _err:Error = __tmp__._2;
            if (_err != null) {
                if (Go.toInterface(_err) != (Go.toInterface(stdgo.io.Io.eof))) {
            ...
            var __tmp__ = _r.readRune(), _r2:GoInt32 = __tmp__._0, __1:GoInt = __tmp__._1, _err:Error = __tmp__._2;
            if (_err != null) {
...
function testUnreadByte(_t:Ref<stdgo.testing.Testing.T>):Void {
        var _segments = (new Slice<GoString>(2, 2, ("Hello, " : GoString), ("world" : GoString)) : Slice<GoString>);
        var _r = newReader(Go.asInterface((Go.setRef(({ _data : _segments } : StringReader)) : Ref<stdgo.bufio_test.Bufio_test.StringReader>)));
        var _got:GoString = Go.str();
        var _want:GoString = stdgo.strings.Strings.join(_segments, Go.str());
        while (true) {
...
function testUnreadByteOthers(_t:Ref<stdgo.testing.Testing.T>):Void {
        var _readers:Slice<(Ref<stdgo.bufio.Bufio.Reader>, GoUInt8) -> { var _0 : Slice<GoUInt8>; var _1 : Error; }> = (new Slice<(Ref<stdgo.bufio.Bufio.Reader>, GoUInt8) -> { var _0 : Slice<GoUInt8>; var _1 : Error; }>(3, 3, Reader_static_extension.readBytes, Reader_static_extension.readSlice, function(_r:Ref<Reader>, _delim:GoByte):{ var _0 : Slice<GoByte>; var _1 : Error; } {
            var __tmp__ = _r.readString(_delim), _data:GoString = __tmp__._0, _err:Error = __tmp__._1;
            return { _0 : (_data : Slice<GoByte>), _1 : _err };
        }) : Slice<(Ref<stdgo.bufio.Bufio.Reader>, GoUInt8) -> { var _0 : Slice<GoUInt8>; var _1 : Error; }>);
        for (_rno => _read in _readers) {
            ...
            var _r = newReaderSize(Go.asInterface((Go.setRef(_buf) : Ref<stdgo.bytes.Bytes.Buffer>)), (16 : GoInt));
...
function testUnreadRuneError(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _r = newReader(Go.asInterface((Go.setRef(({ _data : (new Slice<GoString>(1, 1, ("日本語日本語日本語" : GoString)) : Slice<GoString>) } : StringReader)) : Ref<stdgo.bufio_test.Bufio_test.StringReader>)));
...
function testReadWriteRune(_t:Ref<stdgo.testing.Testing.T>):Void {
        {};
        var _byteBuf = (Go.setRef(({} : stdgo.bytes.Bytes.Buffer)) : Ref<stdgo.bytes.Bytes.Buffer>);
...
function testWriteInvalidRune(_t:Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _r in (new Slice<GoInt32>(2, 2, (-1 : GoInt32), (1114112 : GoInt32)) : Slice<GoInt32>)) {
            ...
            var _w = newWriter(Go.asInterface((Go.setRef(_buf) : Ref<stdgo.strings.Strings.Builder>)));
            _w.writeRune(_r);
            _w.flush();
            {
...
function testReadStringAllocs(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _allocs:GoFloat64 = stdgo.testing.Testing.allocsPerRun((100 : GoInt), function():Void {
            _r.seek((0i64 : GoInt64), (0 : GoInt));
            _buf.reset(Go.asInterface(_r));
            var __tmp__ = _buf.readString((10 : GoUInt8)), __0:GoString = __tmp__._0, _err:Error = __tmp__._1;
            if (_err != null) {
...
function testWriter(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _w = (Go.setRef(({} : stdgo.bytes.Bytes.Buffer)) : Ref<stdgo.bytes.Bytes.Buffer>);
        {
            var _i:GoInt = (0 : GoInt);
...
function testWriterAppend(_t:Ref<stdgo.testing.Testing.T>):Void {
        var _got = (Go.setRef(({} : stdgo.bytes.Bytes.Buffer)) : Ref<stdgo.bytes.Bytes.Buffer>);
        var _want:Slice<GoByte> = (null : Slice<GoUInt8>);
        var _rn = stdgo.math.rand.Rand.new_(stdgo.math.rand.Rand.newSource((0i64 : GoInt64)));
...
function testWriteErrors(_t:Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _w in _errorWriterTests) {
            ...
            var __tmp__ = _buf.write((("hello world" : GoString) : Slice<GoByte>)), __1:GoInt = __tmp__._0, _e:Error = __tmp__._1;
            if (_e != null) {
...
function testNewWriterSizeIdempotent(_t:Ref<stdgo.testing.Testing.T>):Void {
        {};
        var _b = newWriterSize(Go.asInterface((Go.setRef(({} : stdgo.bytes.Bytes.Buffer)) : Ref<stdgo.bytes.Bytes.Buffer>)), (1000 : GoInt));
...
function testWriteStringStringWriter(_t:Ref<stdgo.testing.Testing.T>):Void {
        {};
        {
            var _tw = (Go.setRef((new T_teststringwriter() : T_teststringwriter)) : Ref<stdgo.bufio_test.Bufio_test.T_teststringwriter>);
...
function testPeek(_t:Ref<stdgo.testing.Testing.T>):Void {
        var _p = new Slice<GoUInt8>((10 : GoInt).toBasic(), 0).__setNumber32__();
        ...
        {
            var __tmp__ = _buf.peek((-1 : GoInt)), __0:Slice<GoUInt8> = __tmp__._0, _err:Error = __tmp__._1;
        ...
        {
            var __tmp__ = _buf.read((_p.__slice__((0 : GoInt), (3 : GoInt)) : Slice<GoUInt8>)), __1:GoInt = __tmp__._0, _err:Error = __tmp__._1;
        ...
        {
            var __tmp__ = _buf.read((_p.__slice__((0 : GoInt), (3 : GoInt)) : Slice<GoUInt8>)), __2:GoInt = __tmp__._0, _err:Error = __tmp__._1;
        ...
        {
            var __tmp__ = _buf.read((_p.__slice__((0 : GoInt)) : Slice<GoUInt8>)), __3:GoInt = __tmp__._0, _err:Error = __tmp__._1;
        ...
        {
            var __tmp__ = _buf.peek((1 : GoInt)), __4:Slice<GoUInt8> = __tmp__._0, _err:Error = __tmp__._1;
            if (Go.toInterface(_err) != (Go.toInterface(stdgo.io.Io.eof))) {
                _t.fatalf(("want EOF got %v" : GoString), Go.toInterface(_err));
            };
        };
        _buf = newReaderSize(Go.asInterface(((("abcd" : GoString) : stdgo.bufio_test.Bufio_test.T_dataAndEOFReader) : T_dataAndEOFReader)), (32 : GoInt));
        {
            var __tmp__ = _buf.peek((2 : GoInt)), _s:Slice<GoUInt8> = __tmp__._0, _err:Error = __tmp__._1;
...
private function _testReadLine(_t:Ref<stdgo.testing.Testing.T>, _input:Slice<GoByte>):Void {
        {
            ...
            Go.cfor(_stride < (2 : GoInt), _stride++, {
                ...
                var _l = newReaderSize(Go.asInterface((Go.setRef(_reader) : Ref<stdgo.bufio_test.Bufio_test.T_testReader>)), (_input.length) + (1 : GoInt));
                while (true) {
...
function testLineTooLong(_t:Ref<stdgo.testing.Testing.T>):Void {
        var _data = new Slice<GoUInt8>((0 : GoInt).toBasic(), 0).__setNumber32__();
        {
            var _i:GoInt = (0 : GoInt);
            Go.cfor(_i < (40 : GoInt), _i++, {
                _data = (_data.__append__((48 : GoUInt8) + (_i % (10 : GoInt) : GoByte)));
            });
        };
...
function testReadAfterLines(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _outbuf = (Go.setRef(({} : stdgo.strings.Strings.Builder)) : Ref<stdgo.strings.Strings.Builder>);
...
function testReadEmptyBuffer(_t:Ref<stdgo.testing.Testing.T>):Void {
        var _l = newReaderSize(Go.asInterface((Go.setRef(({} : stdgo.bytes.Bytes.Buffer)) : Ref<stdgo.bytes.Bytes.Buffer>)), (16 : GoInt));
        var __tmp__ = _l.readLine(), _line:Slice<GoUInt8> = __tmp__._0, _isPrefix:Bool = __tmp__._1, _err:Error = __tmp__._2;
        if (Go.toInterface(_err) != (Go.toInterface(stdgo.io.Io.eof))) {
...
function testLinesAfterRead(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var __tmp__ = stdgo.io.Io.readAll(Go.asInterface(_l)), __0:Slice<GoUInt8> = __tmp__._0, _err:Error = __tmp__._1;
        if (_err != null) {
...
function testReadLineNonNilLineOrError(_t:Ref<stdgo.testing.Testing.T>):Void {
        var _r = newReader(Go.asInterface(stdgo.strings.Strings.newReader(("line 1\n" : GoString))));
        {
            var _i:GoInt = (0 : GoInt);
            Go.cfor(_i < (2 : GoInt), _i++, {
                var __tmp__ = _r.readLine(), _l:Slice<GoUInt8> = __tmp__._0, __0:Bool = __tmp__._1, _err:Error = __tmp__._2;
...
private function _createTestInput(_n:GoInt):Slice<GoByte> {
        var _input = new Slice<GoUInt8>((_n : GoInt).toBasic(), 0).__setNumber32__();
...
function testReaderWriteToErrors(_t:Ref<stdgo.testing.Testing.T>):Void {
        for (_i => _rw in _errorWriterToTests) {
            ...
            {
                var __tmp__ = _r.writeTo(Go.asInterface(_rw)), __0:GoInt64 = __tmp__._0, _err:Error = __tmp__._1;
...
function testWriterReadFrom(_t:Ref<stdgo.testing.Testing.T>):Void {
        var _ws = (new Slice<stdgo.io.Io.Writer -> stdgo.io.Io.Writer>(2, 2, function(_w:stdgo.io.Io.Writer):stdgo.io.Io.Writer {
        ...
        var _rs = (new Slice<stdgo.io.Io.Reader -> stdgo.io.Io.Reader>(2, 2, stdgo.testing.iotest.Iotest.dataErrReader, function(_r:stdgo.io.Io.Reader):stdgo.io.Io.Reader {
            return _r;
        ...
        for (_ri => _rfunc in _rs) {
            for (_wi => _wfunc in _ws) {
                ...
                {
                    var __0:GoString = (_b.string() : GoString), __1:GoString = (_input : GoString), _want:GoString = __1, _got:GoString = __0;
                    if (_got != (_want)) {
...
function testWriterReadFromErrors(_t:Ref<stdgo.testing.Testing.T>):Void {
        for (_i => _rw in _errorReaderFromTests) {
            ...
            {
                var __tmp__ = _w.readFrom(Go.asInterface(_rw)), __0:GoInt64 = __tmp__._0, _err:Error = __tmp__._1;
                if (Go.toInterface(_err) != (Go.toInterface(_rw._expected))) {
...
function testNegativeRead(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        try {
            ...
            _b.read(new Slice<GoUInt8>((100 : GoInt).toBasic(), 0).__setNumber32__());
...
function testReaderClearError(_t:Ref<stdgo.testing.Testing.T>):Void {
        var _r = (Go.setRef((new T_errorThenGoodReader() : T_errorThenGoodReader)) : Ref<stdgo.bufio_test.Bufio_test.T_errorThenGoodReader>);
        var _b = newReader(Go.asInterface(_r));
        var _buf = new Slice<GoUInt8>((1 : GoInt).toBasic(), 0).__setNumber32__();
        {
            var __tmp__ = _b.read((null : Slice<GoUInt8>)), __0:GoInt = __tmp__._0, _err:Error = __tmp__._1;
            if (_err != null) {
                _t.fatalf(("1st nil Read = %v; want nil" : GoString), Go.toInterface(_err));
            };
        };
        {
            var __tmp__ = _b.read(_buf), __1:GoInt = __tmp__._0, _err:Error = __tmp__._1;
            if (Go.toInterface(_err) != (Go.toInterface(_errFake))) {
                _t.fatalf(("1st Read = %v; want errFake" : GoString), Go.toInterface(_err));
            };
        };
        {
            var __tmp__ = _b.read((null : Slice<GoUInt8>)), __2:GoInt = __tmp__._0, _err:Error = __tmp__._1;
            if (_err != null) {
                _t.fatalf(("2nd nil Read = %v; want nil" : GoString), Go.toInterface(_err));
            };
        };
        {
            var __tmp__ = _b.read(_buf), __3:GoInt = __tmp__._0, _err:Error = __tmp__._1;
            if (_err != null) {
...
function testWriterReadFromUntilEOF(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _r = (Go.setRef(({ _r : Go.asInterface(stdgo.strings.Strings.newReader(("abcd" : GoString))), _n : (3 : GoInt) } : T_emptyThenNonEmptyReader)) : Ref<stdgo.bufio_test.Bufio_test.T_emptyThenNonEmptyReader>);
        var __tmp__ = _w.readFrom(Go.asInterface(_r)), _n2:GoInt64 = __tmp__._0, _err:Error = __tmp__._1;
        if ((_n2 != (4i64 : GoInt64)) || (_err != null)) {
            _t.fatalf(("ReadFrom returned (%v, %v), want (4, nil)" : GoString), Go.toInterface(_n2), Go.toInterface(_err));
        };
        _w.flush();
        {
            var __0:GoString = (_buf.string() : GoString), __1:GoString = ("0123abcd" : GoString), _want:GoString = __1, _got:GoString = __0;
            if (_got != (_want)) {
...
function testWriterReadFromErrNoProgress(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _r = (Go.setRef(({ _r : Go.asInterface(stdgo.strings.Strings.newReader(("abcd" : GoString))), _n : (100 : GoInt) } : T_emptyThenNonEmptyReader)) : Ref<stdgo.bufio_test.Bufio_test.T_emptyThenNonEmptyReader>);
        var __tmp__ = _w.readFrom(Go.asInterface(_r)), _n2:GoInt64 = __tmp__._0, _err:Error = __tmp__._1;
        if ((_n2 != (0i64 : GoInt64)) || (Go.toInterface(_err) != Go.toInterface(stdgo.io.Io.errNoProgress))) {
...
function testWriterReadFromWithBufferedData(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _rfw = (Go.setRef((new T_readFromWriter() : T_readFromWriter)) : Ref<stdgo.bufio_test.Bufio_test.T_readFromWriter>);
        ...
        {
            var __0:GoInt = _rfw._writeBytes, __1:GoInt = (16 : GoInt), _want:GoInt = __1, _got:GoInt = __0;
            if (_got != (_want)) {
                _t.errorf(("wrote %v bytes with Write, want %v" : GoString), Go.toInterface(_got), Go.toInterface(_want));
            };
        };
        {
            var __0:GoInt = _rfw._readFromBytes, __1:GoInt = (_input.length) - (16 : GoInt), _want:GoInt = __1, _got:GoInt = __0;
            if (_got != (_want)) {
...
function testReadZero(_t:Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _size in (new Slice<GoInt>(2, 2, (100 : GoInt), (2 : GoInt)) : Slice<GoInt>)) {
            _t.run(stdgo.fmt.Fmt.sprintf(("bufsize=%d" : GoString), Go.toInterface(_size)), function(_t:Ref<stdgo.testing.Testing.T>):Void {
                var _r:stdgo.io.Io.Reader = stdgo.io.Io.multiReader(Go.asInterface(stdgo.strings.Strings.newReader(("abc" : GoString))), Go.asInterface((Go.setRef(({ _r : Go.asInterface(stdgo.strings.Strings.newReader(("def" : GoString))), _n : (1 : GoInt) } : T_emptyThenNonEmptyReader)) : Ref<stdgo.bufio_test.Bufio_test.T_emptyThenNonEmptyReader>)));
                var _br = newReaderSize(_r, _size);
                var _want:(GoString, Error) -> Void = function(_s:GoString, _wantErr:Error):Void {
                    var _p = new Slice<GoUInt8>((50 : GoInt).toBasic(), 0).__setNumber32__();
...
function testWriterReset(_t:Ref<stdgo.testing.Testing.T>):Void {
        var __0:stdgo.strings.Strings.Builder = ({} : stdgo.strings.Strings.Builder), __1:stdgo.strings.Strings.Builder = ({} : stdgo.strings.Strings.Builder), __2:stdgo.strings.Strings.Builder = ({} : stdgo.strings.Strings.Builder), _buf3:stdgo.strings.Strings.Builder = __2, _buf2:stdgo.strings.Strings.Builder = __1, _buf1:stdgo.strings.Strings.Builder = __0;
        var _w = newWriter(Go.asInterface((Go.setRef(_buf1) : Ref<stdgo.strings.Strings.Builder>)));
        _w.writeString(("foo" : GoString));
        _w.reset(Go.asInterface((Go.setRef(_buf2) : Ref<stdgo.strings.Strings.Builder>)));
        ...
        _w.reset(Go.asInterface((Go.setRef(_buf3) : Ref<stdgo.strings.Strings.Builder>)));
        _w.writeString(("bar" : GoString));
        _w.flush();
        if ((_buf1.string() : GoString) != (Go.str())) {
            _t.errorf(("buf1 = %q; want empty" : GoString), Go.toInterface((_buf1.string() : GoString)));
...
({ _name : ("discard negative" : GoString), _r : _newScriptedReader(), _bufSize : (0 : GoInt), _peekSize : (0 : GoInt), _n : (-1 : GoInt), _want : (0 : GoInt), _wantErr : errNegativeCount, _wantBuffered : (0 : GoInt) } : T__struct_1)) : Slice<T__struct_1>);
        for (__0 => _tt in _tests) {
            ...
            {
                var __0:GoString = stdgo.fmt.Fmt.sprint(Go.toInterface(_err)), __1:GoString = stdgo.fmt.Fmt.sprint(Go.toInterface(_tt._wantErr)), _we:GoString = __1, _ge:GoString = __0;
...
function testReaderSize(_t:Ref<stdgo.testing.Testing.T>):Void {
        {
            var __0:GoInt = newReader((null : stdgo.io.Io.Reader)).size(), __1:GoInt = (4096 : GoInt), _want:GoInt = __1, _got:GoInt = __0;
            if (_got != (_want)) {
                _t.errorf(("NewReader\'s Reader.Size = %d; want %d" : GoString), Go.toInterface(_got), Go.toInterface(_want));
            };
        };
        {
            var __0:GoInt = newReaderSize((null : stdgo.io.Io.Reader), (1234 : GoInt)).size(), __1:GoInt = (1234 : GoInt), _want:GoInt = __1, _got:GoInt = __0;
            if (_got != (_want)) {
...
function testWriterSize(_t:Ref<stdgo.testing.Testing.T>):Void {
        {
            var __0:GoInt = newWriter((null : stdgo.io.Io.Writer)).size(), __1:GoInt = (4096 : GoInt), _want:GoInt = __1, _got:GoInt = __0;
            if (_got != (_want)) {
                _t.errorf(("NewWriter\'s Writer.Size = %d; want %d" : GoString), Go.toInterface(_got), Go.toInterface(_want));
            };
        };
        {
            var __0:GoInt = newWriterSize((null : stdgo.io.Io.Writer), (1234 : GoInt)).size(), __1:GoInt = (1234 : GoInt), _want:GoInt = __1, _got:GoInt = __0;
            if (_got != (_want)) {
...
private function _newScriptedReader(_steps:haxe.Rest<(_p:Slice<GoByte>) -> { var _0 : GoInt; var _1 : Error; }>):stdgo.io.Io.Reader {
        var _steps = new Slice<(_p:Slice<GoByte>) -> { var _0 : GoInt; var _1 : Error; }>(_steps.length, 0, ..._steps);
        var _sr:stdgo.bufio_test.Bufio_test.T_scriptedReader = (_steps : T_scriptedReader);
        return Go.asInterface((Go.setRef(_sr) : Ref<stdgo.bufio_test.Bufio_test.T_scriptedReader>));
    }
function testPartialReadEOF(_t:Ref<stdgo.testing.Testing.T>):Void {
        var _src = new Slice<GoUInt8>((10 : GoInt).toBasic(), 0).__setNumber32__();
        var _eofR = (Go.setRef(({ _buf : _src } : T_eofReader)) : Ref<stdgo.bufio_test.Bufio_test.T_eofReader>);
        var _r = newReader(Go.asInterface(_eofR));
        var _dest = new Slice<GoUInt8>((5 : GoInt).toBasic(), 0).__setNumber32__();
...
function testWriterReadFromMustSetUnderlyingError(_t:Ref<stdgo.testing.Testing.T>):Void {
        var _wr:Ref<stdgo.bufio.Bufio.Writer> = newWriter(Go.asInterface((new T_writerWithReadFromError() : T_writerWithReadFromError)));
        {
            var __tmp__ = _wr.readFrom(Go.asInterface(stdgo.strings.Strings.newReader(("test2" : GoString)))), __0:GoInt64 = __tmp__._0, _err:Error = __tmp__._1;
            if (_err == null) {
                _t.fatal(Go.toInterface(("expected ReadFrom returns error, got nil" : GoString)));
            };
        };
        {
            var __tmp__ = _wr.write((("123" : GoString) : Slice<GoByte>)), __1:GoInt = __tmp__._0, _err:Error = __tmp__._1;
            if (_err == null) {
...
function testWriterReadFromMustReturnUnderlyingError(_t:Ref<stdgo.testing.Testing.T>):Void {
        var _wr:Ref<stdgo.bufio.Bufio.Writer> = newWriter(Go.asInterface((new T_writeErrorOnlyWriter() : T_writeErrorOnlyWriter)));
        var _s:GoString = ("test1" : GoString);
        var _wantBuffered:GoInt = (_s.length);
        {
            var __tmp__ = _wr.writeString(_s), __0:GoInt = __tmp__._0, _err:Error = __tmp__._1;
            if (_err != null) {
                _t.fatalf(("unexpected error: %v" : GoString), Go.toInterface(_err));
            };
        };
        ...
        {
            var __tmp__ = _wr.readFrom(Go.asInterface(stdgo.strings.Strings.newReader(("test2" : GoString)))), __1:GoInt64 = __tmp__._0, _err:Error = __tmp__._1;
            if (_err == null) {
...
function benchmarkReaderCopyOptimal(_b:Ref<stdgo.testing.Testing.B>):Void {
        var _srcBuf = stdgo.bytes.Bytes.newBuffer(new Slice<GoUInt8>((8192 : GoInt).toBasic(), 0).__setNumber32__());
        var _src = newReader(Go.asInterface(_srcBuf));
        var _dstBuf = (Go.setRef(({} : stdgo.bytes.Bytes.Buffer)) : Ref<stdgo.bytes.Bytes.Buffer>);
...
function benchmarkReaderWriteToOptimal(_b:Ref<stdgo.testing.Testing.B>):Void {
        {};
        var _buf = new Slice<GoUInt8>((16384 : GoInt).toBasic(), 0).__setNumber32__();
...
function benchmarkReaderReadString(_b:Ref<stdgo.testing.Testing.B>):Void {
        ...
        _b.reportAllocs();
        {
            ...
            Go.cfor(_i < _b.n, _i++, {
                _r.seek((0i64 : GoInt64), (0 : GoInt));
                _buf.reset(Go.asInterface(_r));
                var __tmp__ = _buf.readString((10 : GoUInt8)), __8:GoString = __tmp__._0, _err:Error = __tmp__._1;
                if (_err != null) {
                    _b.fatal(Go.toInterface(_err));
                };
            });
...
function exampleWriter_AvailableBuffer():Void {
        var _w = stdgo.bufio.Bufio.newWriter(Go.asInterface(stdgo.os.Os.stdout));
        for (__0 => _i in (new Slice<GoInt64>(4, 4, (1i64 : GoInt64), (2i64 : GoInt64), (3i64 : GoInt64), (4i64 : GoInt64)) : Slice<GoInt64>)) {
            var _b = _w.availableBuffer();
...
function testScanRune(_t:Ref<stdgo.testing.Testing.T>):Void {
        for (_n => _test in _scanTests) {
            ...
            var _s = newScanner(Go.asInterface(_buf));
            _s.split(scanRunes);
            var __0:GoInt = (0 : GoInt), __1:GoInt = (0 : GoInt), _runeCount:GoInt = __1, _i:GoInt = __0;
            ...
            for (__key__ => __value__ in (_test : GoString)) {
                ...
                _runeCount++;
                var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRune(_s.bytes()), _got:GoInt32 = __tmp__._0, __0:GoInt = __tmp__._1;
                if (_got != (_expect)) {
...
function testScanLongLines(_t:Ref<stdgo.testing.Testing.T>):Void {
        var _tmp = (Go.setRef(({} : stdgo.bytes.Bytes.Buffer)) : Ref<stdgo.bytes.Bytes.Buffer>);
        var _buf = (Go.setRef(({} : stdgo.bytes.Bytes.Buffer)) : Ref<stdgo.bytes.Bytes.Buffer>);
        ...
        var _s = newScanner(Go.asInterface((Go.setRef((new T_slowReader((1 : GoInt), Go.asInterface(_buf)) : T_slowReader)) : Ref<stdgo.bufio_test.Bufio_test.T_slowReader>)));
        _s.split(scanLines);
...
function testScanLineTooLong(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _s = newScanner(Go.asInterface((Go.setRef((new T_slowReader((3 : GoInt), Go.asInterface(_buf)) : T_slowReader)) : Ref<stdgo.bufio_test.Bufio_test.T_slowReader>)));
        _s.split(scanLines);
        _s.maxTokenSize((256 : GoInt));
        _j = (0 : GoInt);
        {
...
private function _testNoNewline(_text:GoString, _lines:Slice<GoString>, _t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _s = newScanner(Go.asInterface((Go.setRef((new T_slowReader((7 : GoInt), Go.asInterface(_buf)) : T_slowReader)) : Ref<stdgo.bufio_test.Bufio_test.T_slowReader>)));
        _s.split(scanLines);
        {
            var _lineNum:GoInt = (0 : GoInt);
            Go.cfor(_s.scan(), _lineNum++, {
...
function testScanLineNoNewline(_t:Ref<stdgo.testing.Testing.T>):Void {
        {};
        var _lines = (new Slice<GoString>(2, 2, ("abcdefghijklmn" : GoString), ("opqrstuvwxyz" : GoString)) : Slice<GoString>);
...
function testScanLineEmptyFinalLine(_t:Ref<stdgo.testing.Testing.T>):Void {
        {};
        var _lines = (new Slice<GoString>(3, 3, ("abcdefghijklmn" : GoString), ("opqrstuvwxyz" : GoString), Go.str()) : Slice<GoString>);
        _testNoNewline(("abcdefghijklmn\nopqrstuvwxyz\n\n" : GoString), _lines, _t);
    }
/**
...
function testEmptyTokens(_t:Ref<stdgo.testing.Testing.T>):Void {
        _testEmptyTokens(_t, ("1,2,3," : GoString), (new Slice<GoString>(4, 4, ("1" : GoString), ("2" : GoString), ("3" : GoString), Go.str()) : Slice<GoString>));
    }
function testWithNoEmptyTokens(_t:Ref<stdgo.testing.Testing.T>):Void {
        _testEmptyTokens(_t, ("1,2,3" : GoString), (new Slice<GoString>(3, 3, ("1" : GoString), ("2" : GoString), ("3" : GoString)) : Slice<GoString>));
    }
...
function testHugeBuffer(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _s = newScanner(Go.asInterface(stdgo.strings.Strings.newReader(_text + ("\n" : GoString))));
        _s.buffer(new Slice<GoUInt8>((100 : GoInt).toBasic(), 0).__setNumber32__(), (196608 : GoInt));
        while (_s.scan()) {
...
function testNegativeEOFReader(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        {
            var __0:Error = _scanner.err(), __1:Error = errBadReadCount, _want:Error = __1, _got:Error = __0;
...
class T_teststringwriter_asInterface {
    @:keep
    public dynamic function _check(_t:Ref<stdgo.testing.Testing.T>, _write:GoString, _writeString:GoString):Void __self__.value._check(_t, _write, _writeString);
    @:keep
...
@:keep @:allow(stdgo.bufio_test.Bufio_test.T_eofReader_asInterface) class T_eofReader_static_extension {
    ...
    static public function read( _r:Ref<T_eofReader>, _p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } {
        ...
        _r._buf = (_r._buf.__slice__(_read) : Slice<GoUInt8>);
        {
            ...
            if (__value__ == ((0 : GoInt)) || __value__ == ((_r._buf.length))) {
...
@:keep @:allow(stdgo.bufio_test.Bufio_test.T_writerWithReadFromError_asInterface) class T_writerWithReadFromError_static_extension {
    ...
    static public function readFrom( _w:T_writerWithReadFromError, _r:stdgo.io.Io.Reader):{ var _0 : GoInt64; var _1 : Error; } {
        return { _0 : (0i64 : GoInt64), _1 : stdgo.errors.Errors.new_(("writerWithReadFromError error" : GoString)) };
    }
}
...
class T_writeCountingDiscard_asInterface {
    @:keep
    @:pointer
    public dynamic function write(_p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } return __self__.value.write(__self__, _p);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
class T_negativeReader_asInterface {
    @:keep
    @:pointer
    public dynamic function read(_0:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } return __self__.value.read(__self__, _0);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
@:keep @:allow(stdgo.bufio_test.Bufio_test.T_scriptedReader_asInterface) class T_scriptedReader_static_extension {
    ...
    static public function read( _sr:Ref<T_scriptedReader>, _p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } {
        var _n:GoInt = (0 : GoInt), _err:Error = (null : Error);
        if (((_sr : stdgo.bufio_test.Bufio_test.T_scriptedReader).length) == ((0 : GoInt))) {
            throw Go.toInterface(("too many Read calls on scripted Reader. No steps remain." : GoString));
        };
        var _step = ((_sr : stdgo.bufio_test.Bufio_test.T_scriptedReader))[(0 : GoInt)];
        _sr.__setData__((((_sr : stdgo.bufio_test.Bufio_test.T_scriptedReader)).__slice__((1 : GoInt)) : stdgo.bufio_test.Bufio_test.T_scriptedReader));
        return _step(_p);
    }
}
class T_countdown_asInterface {
    @:keep
    @:pointer
    public dynamic function _split(_data:Slice<GoByte>, _atEOF:Bool):{ var _0 : GoInt; var _1 : Slice<GoByte>; var _2 : Error; } return __self__.value._split(__self__, _data, _atEOF);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
class T_negativeEOFReader_asInterface {
    @:keep
    @:pointer
    public dynamic function read(_p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } return __self__.value.read(__self__, _p);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
