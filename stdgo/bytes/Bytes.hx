...
/**
    /|*{
    	...
    	gotoNext = 2905181
    	_ = gotoNext == 2905181
    	if i_2905173 < len(s) && i_2905173 < len(t) {
    		gotoNext = 2905217
    		_ = gotoNext == 2905217
    		sr_2905221 = s[i_2905173]
    		tr_2905234 = t[i_2905173]
    		if sr_2905221|tr_2905234 >= 128 {
    			gotoNext = 2905273
    			_ = gotoNext == 2905273
    			gotoNext = 2905631
    			gotoNext = 2905317
    		...
    		if tr_2905234 < sr_2905221 {
    			gotoNext = 2905405
    			_ = gotoNext == 2905405
    			tr_2905234, sr_2905221 = sr_2905221, tr_2905234
    			gotoNext = 2905480
    		} else {
    			gotoNext = 2905480
    		}
    		_ = gotoNext == 2905480
    		if 65 <= sr_2905221 && sr_2905221 <= 90 && tr_2905234 == sr_2905221+97-65 {
    			gotoNext = 2905526
    			_ = gotoNext == 2905526
    			i_2905173++
    			gotoNext = 2905181
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			...
    			gotoNext = 2905818
    			_ = gotoNext == 2905818
    			r_2905823, size_2905826 = utf8.DecodeRune(s)
    			sr_2905740, s = r_2905823, s[size_2905826:]
    			_ = 0
    			gotoNext = 2905882
    		}
    		_ = gotoNext == 2905882
    		if t[0] < 128 {
    			...
    			gotoNext = 2905946
    			_ = gotoNext == 2905946
    			r_2905951, size_2905954 = utf8.DecodeRune(t)
    			tr_2905744, t = r_2905951, t[size_2905954:]
    			_ = 0
    			gotoNext = 2906082
    		}
    		_ = gotoNext == 2906082
    		if tr_2905744 == sr_2905740 {
    			gotoNext = 2906094
    			_ = gotoNext == 2906094
    			_ = 0
    			gotoNext = 2905666
    		...
    		if tr_2905744 < sr_2905740 {
    			gotoNext = 2906170
    			_ = gotoNext == 2906170
    			tr_2905744, sr_2905740 = sr_2905740, tr_2905744
    			gotoNext = 2906224
    		} else {
    			gotoNext = 2906224
    		}
    		...
    		if tr_2905744 < 128 {
    			gotoNext = 2906246
    			_ = gotoNext == 2906246
    			if 65 <= sr_2905740 && sr_2905740 <= 90 && tr_2905744 == sr_2905740+97-65 {
    				gotoNext = 2906346
    				_ = gotoNext == 2906346
    				_ = 0
    				gotoNext = 2905666
    		...
    		_ = gotoNext == 2906499
    		r_2906499 = unicode.SimpleFold(sr_2905740)
    		_ = 0
    		gotoNext = 2906529
    		_ = gotoNext == 2906529
    		if r_2906499 != sr_2905740 && r_2906499 < tr_2905744 {
    			gotoNext = 2906551
    			_ = gotoNext == 2906551
    			r_2906499 = unicode.SimpleFold(r_2906499)
    			gotoNext = 2906529
    		} else {
    			gotoNext = 2906588
    		}
    		_ = gotoNext == 2906588
    		if r_2906499 == tr_2905744 {
    			gotoNext = 2906599
    			_ = gotoNext == 2906599
    			_ = 0
    			gotoNext = 2905666
