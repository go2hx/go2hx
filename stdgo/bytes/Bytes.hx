...
/**
    /|*{
    	...
    	gotoNext = 2780660
    	_ = gotoNext == 2780660
    	if i_2780652 < len(s) && i_2780652 < len(t) {
    		gotoNext = 2780696
    		_ = gotoNext == 2780696
    		sr_2780700 = s[i_2780652]
    		tr_2780713 = t[i_2780652]
    		if sr_2780700|tr_2780713 >= 128 {
    			gotoNext = 2780752
    			_ = gotoNext == 2780752
    			gotoNext = 2781110
    			gotoNext = 2780796
    		...
    		if tr_2780713 < sr_2780700 {
    			gotoNext = 2780884
    			_ = gotoNext == 2780884
    			tr_2780713, sr_2780700 = sr_2780700, tr_2780713
    			gotoNext = 2780959
    		} else {
    			gotoNext = 2780959
    		}
    		_ = gotoNext == 2780959
    		if 65 <= sr_2780700 && sr_2780700 <= 90 && tr_2780713 == sr_2780700+97-65 {
    			gotoNext = 2781005
    			_ = gotoNext == 2781005
    			i_2780652++
    			gotoNext = 2780660
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			...
    			gotoNext = 2781297
    			_ = gotoNext == 2781297
    			r_2781302, size_2781305 = utf8.DecodeRune(s)
    			sr_2781219, s = r_2781302, s[size_2781305:]
    			_ = 0
    			gotoNext = 2781361
    		}
    		_ = gotoNext == 2781361
    		if t[0] < 128 {
    			...
    			gotoNext = 2781425
    			_ = gotoNext == 2781425
    			r_2781430, size_2781433 = utf8.DecodeRune(t)
    			tr_2781223, t = r_2781430, t[size_2781433:]
    			_ = 0
    			gotoNext = 2781561
    		}
    		_ = gotoNext == 2781561
    		if tr_2781223 == sr_2781219 {
    			gotoNext = 2781573
    			_ = gotoNext == 2781573
    			_ = 0
    			gotoNext = 2781145
    		...
    		if tr_2781223 < sr_2781219 {
    			gotoNext = 2781649
    			_ = gotoNext == 2781649
    			tr_2781223, sr_2781219 = sr_2781219, tr_2781223
    			gotoNext = 2781703
    		} else {
    			gotoNext = 2781703
    		}
    		...
    		if tr_2781223 < 128 {
    			gotoNext = 2781725
    			_ = gotoNext == 2781725
    			if 65 <= sr_2781219 && sr_2781219 <= 90 && tr_2781223 == sr_2781219+97-65 {
    				gotoNext = 2781825
    				_ = gotoNext == 2781825
    				_ = 0
    				gotoNext = 2781145
    		...
    		_ = gotoNext == 2781978
    		r_2781978 = unicode.SimpleFold(sr_2781219)
    		_ = 0
    		gotoNext = 2782008
    		_ = gotoNext == 2782008
    		if r_2781978 != sr_2781219 && r_2781978 < tr_2781223 {
    			gotoNext = 2782030
    			_ = gotoNext == 2782030
    			r_2781978 = unicode.SimpleFold(r_2781978)
    			gotoNext = 2782008
    		} else {
    			gotoNext = 2782067
    		}
    		_ = gotoNext == 2782067
    		if r_2781978 == tr_2781223 {
    			gotoNext = 2782078
    			_ = gotoNext == 2782078
    			_ = 0
    			gotoNext = 2781145
