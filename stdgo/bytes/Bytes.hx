...
@:structInit class Buffer {
    public function readString(_delim:GoByte):{ var _0 : GoString; var _1 : Error; } {
        ...
        var __tmp__ = _b.value._readSlice(_delim), _slice:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
    ...
    public function readRune():{ var _0 : GoRune; var _1 : GoInt; var _2 : Error; } {
        ...
        var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRune(_b.value._buf.__slice__(_b.value._off)), _r:GoInt32 = __tmp__._0, _n:GoInt = __tmp__._1;
    ...
    public function writeRune(_r:GoRune):{ var _0 : GoInt; var _1 : Error; } {
        ...
        _b.value._lastRead = _opInvalid;
        var __tmp__ = _b.value._tryGrowByReslice(stdgo.unicode.utf8.Utf8.utfmax), _m:GoInt = __tmp__._0, _ok:Bool = __tmp__._1;
        if (!_ok) {
    ...
    public function writeByte(_c:GoByte):Error {
        var _b = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        _b.value._lastRead = _opInvalid;
        var __tmp__ = _b.value._tryGrowByReslice(((1 : GoInt))), _m:GoInt = __tmp__._0, _ok:Bool = __tmp__._1;
        if (!_ok) {
    ...
    public function writeTo(_w:stdgo.io.Io.Writer):{ var _0 : GoInt64; var _1 : Error; } {
        ...
        _b.value._lastRead = _opInvalid;
        {
            ...
            if (_nBytes > ((0 : GoInt))) {
                var __tmp__ = _w.write(_b.value._buf.__slice__(_b.value._off)), _m:GoInt = __tmp__._0, _e:stdgo.Error = __tmp__._1;
                if (_m > _nBytes) {
    ...
    public function readFrom(_r:stdgo.io.Io.Reader):{ var _0 : GoInt64; var _1 : Error; } {
        ...
        while (true) {
            ...
            var __tmp__ = _r.read(_b.value._buf.__slice__(_i, _b.value._buf.cap())), _m:GoInt = __tmp__._0, _e:stdgo.Error = __tmp__._1;
            if (_m < ((0 : GoInt))) {
    ...
    public function writeString(_s:GoString):{ var _0 : GoInt; var _1 : Error; } {
        ...
        var _n:GoInt = ((0 : GoInt)), _err:Error = ((null : stdgo.Error));
        _b.value._lastRead = _opInvalid;
        var __tmp__ = _b.value._tryGrowByReslice(_s.length), _m:GoInt = __tmp__._0, _ok:Bool = __tmp__._1;
        if (!_ok) {
    ...
    public function write(_p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } {
        ...
        var _n:GoInt = ((0 : GoInt)), _err:Error = ((null : stdgo.Error));
        _b.value._lastRead = _opInvalid;
        var __tmp__ = _b.value._tryGrowByReslice(_p.length), _m:GoInt = __tmp__._0, _ok:Bool = __tmp__._1;
        if (!_ok) {
    ...
    public function _grow(_n:GoInt):GoInt {
        ...
        {
            var __tmp__ = _b.value._tryGrowByReslice(_n), _i:GoInt = __tmp__._0, _ok:Bool = __tmp__._1;
            if (_ok) {
                return _i;
            };
        };
...
function fieldsFunc(_s:Slice<GoByte>, _f:GoRune -> Bool):Slice<Slice<GoByte>> {
        {};
        var _spans:Slice<T_span_fieldsFunc_0> = new Slice<T_span_fieldsFunc_0>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) new T_span_fieldsFunc_0()]).setCap(((((32 : GoInt)) : GoInt)).toBasic());
...
function toValidUTF8(_s:Slice<GoByte>, _replacement:Slice<GoByte>):Slice<GoByte> {
        var _b:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((_s.length + _replacement.length : GoInt)).toBasic());
...
function equalFold(_s:Slice<GoByte>, _t:Slice<GoByte>):Bool {
        while (_s.length != ((0 : GoInt)) && _t.length != ((0 : GoInt))) {
            ...
            if (_tr < stdgo.unicode.utf8.Utf8.runeSelf) {
                if ((("A".code : GoRune)) <= _sr && _sr <= (("Z".code : GoRune)) && _tr == _sr + (("a".code : GoRune)) - (("A".code : GoRune))) {
                    continue;
                };
                return false;
            };
...
class Buffer_extension_fields {
    ...
    public function cap(__tmp__):GoInt return __tmp__.cap();
    public function truncate(__tmp__, _n:GoInt):Void __tmp__.truncate(_n);
    public function reset(__tmp__):Void __tmp__.reset();
    public function _tryGrowByReslice(__tmp__, _n:GoInt):{ var _0 : GoInt; var _1 : Bool; } return __tmp__._tryGrowByReslice(_n);
    public function _grow(__tmp__, _n:GoInt):GoInt return __tmp__._grow(_n);
    public function grow(__tmp__, _n:GoInt):Void __tmp__.grow(_n);
    ...
    public function next(__tmp__, _n:GoInt):Slice<GoByte> return __tmp__.next(_n);
    ...
    public function _readSlice(__tmp__, _delim:GoByte):{ var _0 : Slice<GoByte>; var _1 : Error; } return __tmp__._readSlice(_delim);
...
class T_asciiSet_extension_fields {
    public function _contains(__tmp__, _c:GoByte):Bool return __tmp__._contains(_c);
}
class Reader_extension_fields {
    ...
    public function readAt(__tmp__, _b:Slice<GoByte>, _off:GoInt64):{ var _0 : GoInt; var _1 : Error; } return __tmp__.readAt(_b, _off);
    public function readByte(__tmp__):{ var _0 : GoByte; var _1 : Error; } return __tmp__.readByte();
    public function unreadByte(__tmp__):Error return __tmp__.unreadByte();
    public function readRune(__tmp__):{ var _0 : GoRune; var _1 : GoInt; var _2 : Error; } return __tmp__.readRune();
    public function unreadRune(__tmp__):Error return __tmp__.unreadRune();
    ...
    public function writeTo(__tmp__, _w:stdgo.io.Io.Writer):{ var _0 : GoInt64; var _1 : Error; } return __tmp__.writeTo(_w);
    public function reset(__tmp__, _b:Slice<GoByte>):Void __tmp__.reset(_b);
}
