...
/**
    /|*{
    	...
    	gotoNext = 3140650
    	_ = gotoNext == 3140650
    	if i_3140642 < len(s) && i_3140642 < len(t) {
    		gotoNext = 3140686
    		_ = gotoNext == 3140686
    		sr_3140690 = s[i_3140642]
    		tr_3140703 = t[i_3140642]
    		if sr_3140690|tr_3140703 >= 128 {
    			gotoNext = 3140742
    			_ = gotoNext == 3140742
    			gotoNext = 3141100
    			gotoNext = 3140786
    		...
    		if tr_3140703 < sr_3140690 {
    			gotoNext = 3140874
    			_ = gotoNext == 3140874
    			tr_3140703, sr_3140690 = sr_3140690, tr_3140703
    			gotoNext = 3140949
    		} else {
    			gotoNext = 3140949
    		}
    		_ = gotoNext == 3140949
    		if 65 <= sr_3140690 && sr_3140690 <= 90 && tr_3140703 == sr_3140690+97-65 {
    			gotoNext = 3140995
    			_ = gotoNext == 3140995
    			i_3140642++
    			gotoNext = 3140650
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			gotoNext = 3141247
    			_ = gotoNext == 3141247
    			sr_3141209, s = rune(s[0]), s[1:]
    			gotoNext = 3141351
    		} else {
    			gotoNext = 3141287
    			_ = gotoNext == 3141287
    			r_3141292, size_3141295 = utf8.DecodeRune(s)
    			sr_3141209, s = r_3141292, s[size_3141295:]
    			gotoNext = 3141351
    		}
    		_ = gotoNext == 3141351
    		if t[0] < 128 {
    			gotoNext = 3141375
    			_ = gotoNext == 3141375
    			tr_3141213, t = rune(t[0]), t[1:]
    			gotoNext = 3141551
    		} else {
    			gotoNext = 3141415
    			_ = gotoNext == 3141415
    			r_3141420, size_3141423 = utf8.DecodeRune(t)
    			tr_3141213, t = r_3141420, t[size_3141423:]
    			gotoNext = 3141551
    		}
    		_ = gotoNext == 3141551
    		if tr_3141213 == sr_3141209 {
    			gotoNext = 3141563
    			_ = gotoNext == 3141563
    			_ = 0
    			gotoNext = 3141135
    		...
    		if tr_3141213 < sr_3141209 {
    			gotoNext = 3141639
    			_ = gotoNext == 3141639
    			tr_3141213, sr_3141209 = sr_3141209, tr_3141213
    			gotoNext = 3141693
    		} else {
    			gotoNext = 3141693
    		}
    		...
    		if tr_3141213 < 128 {
    			gotoNext = 3141715
    			_ = gotoNext == 3141715
    			if 65 <= sr_3141209 && sr_3141209 <= 90 && tr_3141213 == sr_3141209+97-65 {
    				gotoNext = 3141815
    				_ = gotoNext == 3141815
    				_ = 0
    				gotoNext = 3141135
    		...
    		_ = gotoNext == 3141968
    		r_3141968 = unicode.SimpleFold(sr_3141209)
    		_ = 0
    		gotoNext = 3141998
    		_ = gotoNext == 3141998
    		if r_3141968 != sr_3141209 && r_3141968 < tr_3141213 {
    			gotoNext = 3142020
    			_ = gotoNext == 3142020
    			r_3141968 = unicode.SimpleFold(r_3141968)
    			gotoNext = 3141998
    		} else {
    			gotoNext = 3142057
    		}
    		_ = gotoNext == 3142057
    		if r_3141968 == tr_3141213 {
    			gotoNext = 3142068
    			_ = gotoNext == 3142068
    			_ = 0
    			gotoNext = 3141135
