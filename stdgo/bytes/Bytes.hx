...
/**
    /|*{
    	...
    	gotoNext = 3257678
    	_ = gotoNext == 3257678
    	if i_3257670 < len(s) && i_3257670 < len(t) {
    		gotoNext = 3257714
    		_ = gotoNext == 3257714
    		sr_3257718 = s[i_3257670]
    		tr_3257731 = t[i_3257670]
    		if sr_3257718|tr_3257731 >= 128 {
    			gotoNext = 3257770
    			_ = gotoNext == 3257770
    			gotoNext = 3258128
    			gotoNext = 3257814
    		...
    		if tr_3257731 < sr_3257718 {
    			gotoNext = 3257902
    			_ = gotoNext == 3257902
    			tr_3257731, sr_3257718 = sr_3257718, tr_3257731
    			gotoNext = 3257977
    		} else {
    			gotoNext = 3257977
    		}
    		_ = gotoNext == 3257977
    		if 65 <= sr_3257718 && sr_3257718 <= 90 && tr_3257731 == sr_3257718+97-65 {
    			gotoNext = 3258023
    			_ = gotoNext == 3258023
    			i_3257670++
    			gotoNext = 3257678
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			gotoNext = 3258275
    			_ = gotoNext == 3258275
    			sr_3258237, s = rune(s[0]), s[1:]
    			gotoNext = 3258379
    		} else {
    			gotoNext = 3258315
    			_ = gotoNext == 3258315
    			r_3258320, size_3258323 = utf8.DecodeRune(s)
    			sr_3258237, s = r_3258320, s[size_3258323:]
    			gotoNext = 3258379
    		}
    		_ = gotoNext == 3258379
    		if t[0] < 128 {
    			gotoNext = 3258403
    			_ = gotoNext == 3258403
    			tr_3258241, t = rune(t[0]), t[1:]
    			gotoNext = 3258579
    		} else {
    			gotoNext = 3258443
    			_ = gotoNext == 3258443
    			r_3258448, size_3258451 = utf8.DecodeRune(t)
    			tr_3258241, t = r_3258448, t[size_3258451:]
    			gotoNext = 3258579
    		}
    		_ = gotoNext == 3258579
    		if tr_3258241 == sr_3258237 {
    			gotoNext = 3258591
    			_ = gotoNext == 3258591
    			_ = 0
    			gotoNext = 3258163
    		...
    		if tr_3258241 < sr_3258237 {
    			gotoNext = 3258667
    			_ = gotoNext == 3258667
    			tr_3258241, sr_3258237 = sr_3258237, tr_3258241
    			gotoNext = 3258721
    		} else {
    			gotoNext = 3258721
    		}
    		...
    		if tr_3258241 < 128 {
    			gotoNext = 3258743
    			_ = gotoNext == 3258743
    			if 65 <= sr_3258237 && sr_3258237 <= 90 && tr_3258241 == sr_3258237+97-65 {
    				gotoNext = 3258843
    				_ = gotoNext == 3258843
    				_ = 0
    				gotoNext = 3258163
    		...
    		_ = gotoNext == 3258996
    		r_3258996 = unicode.SimpleFold(sr_3258237)
    		_ = 0
    		gotoNext = 3259026
    		_ = gotoNext == 3259026
    		if r_3258996 != sr_3258237 && r_3258996 < tr_3258241 {
    			gotoNext = 3259048
    			_ = gotoNext == 3259048
    			r_3258996 = unicode.SimpleFold(r_3258996)
    			gotoNext = 3259026
    		} else {
    			gotoNext = 3259085
    		}
    		_ = gotoNext == 3259085
    		if r_3258996 == tr_3258241 {
    			gotoNext = 3259096
    			_ = gotoNext == 3259096
    			_ = 0
    			gotoNext = 3258163
