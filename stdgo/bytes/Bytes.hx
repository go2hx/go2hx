...
/**
    /|*{
    	...
    	gotoNext = 2919004
    	_ = gotoNext == 2919004
    	if i_2918996 < len(s) && i_2918996 < len(t) {
    		gotoNext = 2919040
    		_ = gotoNext == 2919040
    		sr_2919044 = s[i_2918996]
    		tr_2919057 = t[i_2918996]
    		if sr_2919044|tr_2919057 >= 128 {
    			gotoNext = 2919096
    			_ = gotoNext == 2919096
    			gotoNext = 2919454
    			gotoNext = 2919140
    		...
    		if tr_2919057 < sr_2919044 {
    			gotoNext = 2919228
    			_ = gotoNext == 2919228
    			tr_2919057, sr_2919044 = sr_2919044, tr_2919057
    			gotoNext = 2919303
    		} else {
    			gotoNext = 2919303
    		}
    		_ = gotoNext == 2919303
    		if 65 <= sr_2919044 && sr_2919044 <= 90 && tr_2919057 == sr_2919044+97-65 {
    			gotoNext = 2919349
    			_ = gotoNext == 2919349
    			i_2918996++
    			gotoNext = 2919004
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			...
    			gotoNext = 2919641
    			_ = gotoNext == 2919641
    			r_2919646, size_2919649 = utf8.DecodeRune(s)
    			sr_2919563, s = r_2919646, s[size_2919649:]
    			_ = 0
    			gotoNext = 2919705
    		}
    		_ = gotoNext == 2919705
    		if t[0] < 128 {
    			...
    			gotoNext = 2919769
    			_ = gotoNext == 2919769
    			r_2919774, size_2919777 = utf8.DecodeRune(t)
    			tr_2919567, t = r_2919774, t[size_2919777:]
    			_ = 0
    			gotoNext = 2919905
    		}
    		_ = gotoNext == 2919905
    		if tr_2919567 == sr_2919563 {
    			gotoNext = 2919917
    			_ = gotoNext == 2919917
    			_ = 0
    			gotoNext = 2919489
    		...
    		if tr_2919567 < sr_2919563 {
    			gotoNext = 2919993
    			_ = gotoNext == 2919993
    			tr_2919567, sr_2919563 = sr_2919563, tr_2919567
    			gotoNext = 2920047
    		} else {
    			gotoNext = 2920047
    		}
    		...
    		if tr_2919567 < 128 {
    			gotoNext = 2920069
    			_ = gotoNext == 2920069
    			if 65 <= sr_2919563 && sr_2919563 <= 90 && tr_2919567 == sr_2919563+97-65 {
    				gotoNext = 2920169
    				_ = gotoNext == 2920169
    				_ = 0
    				gotoNext = 2919489
    		...
    		_ = gotoNext == 2920322
    		r_2920322 = unicode.SimpleFold(sr_2919563)
    		_ = 0
    		gotoNext = 2920352
    		_ = gotoNext == 2920352
    		if r_2920322 != sr_2919563 && r_2920322 < tr_2919567 {
    			gotoNext = 2920374
    			_ = gotoNext == 2920374
    			r_2920322 = unicode.SimpleFold(r_2920322)
    			gotoNext = 2920352
    		} else {
    			gotoNext = 2920411
    		}
    		_ = gotoNext == 2920411
    		if r_2920322 == tr_2919567 {
    			gotoNext = 2920422
    			_ = gotoNext == 2920422
    			_ = 0
    			gotoNext = 2919489
