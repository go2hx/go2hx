...
/**
    /|*{
    	...
    	gotoNext = 2734416
    	_ = gotoNext == 2734416
    	if i_2734408 < len(s) && i_2734408 < len(t) {
    		gotoNext = 2734452
    		_ = gotoNext == 2734452
    		sr_2734456 = s[i_2734408]
    		tr_2734469 = t[i_2734408]
    		if sr_2734456|tr_2734469 >= 128 {
    			gotoNext = 2734508
    			_ = gotoNext == 2734508
    			gotoNext = 2734866
    			gotoNext = 2734552
    		...
    		if tr_2734469 < sr_2734456 {
    			gotoNext = 2734640
    			_ = gotoNext == 2734640
    			tr_2734469, sr_2734456 = sr_2734456, tr_2734469
    			gotoNext = 2734715
    		} else {
    			gotoNext = 2734715
    		}
    		_ = gotoNext == 2734715
    		if 65 <= sr_2734456 && sr_2734456 <= 90 && tr_2734469 == sr_2734456+97-65 {
    			gotoNext = 2734761
    			_ = gotoNext == 2734761
    			i_2734408++
    			gotoNext = 2734416
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			...
    			gotoNext = 2735053
    			_ = gotoNext == 2735053
    			r_2735058, size_2735061 = utf8.DecodeRune(s)
    			sr_2734975, s = r_2735058, s[size_2735061:]
    			_ = 0
    			gotoNext = 2735117
    		}
    		_ = gotoNext == 2735117
    		if t[0] < 128 {
    			...
    			gotoNext = 2735181
    			_ = gotoNext == 2735181
    			r_2735186, size_2735189 = utf8.DecodeRune(t)
    			tr_2734979, t = r_2735186, t[size_2735189:]
    			_ = 0
    			gotoNext = 2735317
    		}
    		_ = gotoNext == 2735317
    		if tr_2734979 == sr_2734975 {
    			gotoNext = 2735329
    			_ = gotoNext == 2735329
    			_ = 0
    			gotoNext = 2734901
    		...
    		if tr_2734979 < sr_2734975 {
    			gotoNext = 2735405
    			_ = gotoNext == 2735405
    			tr_2734979, sr_2734975 = sr_2734975, tr_2734979
    			gotoNext = 2735459
    		} else {
    			gotoNext = 2735459
    		}
    		...
    		if tr_2734979 < 128 {
    			gotoNext = 2735481
    			_ = gotoNext == 2735481
    			if 65 <= sr_2734975 && sr_2734975 <= 90 && tr_2734979 == sr_2734975+97-65 {
    				gotoNext = 2735581
    				_ = gotoNext == 2735581
    				_ = 0
    				gotoNext = 2734901
    		...
    		_ = gotoNext == 2735734
    		r_2735734 = unicode.SimpleFold(sr_2734975)
    		_ = 0
    		gotoNext = 2735764
    		_ = gotoNext == 2735764
    		if r_2735734 != sr_2734975 && r_2735734 < tr_2734979 {
    			gotoNext = 2735786
    			_ = gotoNext == 2735786
    			r_2735734 = unicode.SimpleFold(r_2735734)
    			gotoNext = 2735764
    		} else {
    			gotoNext = 2735823
    		}
    		_ = gotoNext == 2735823
    		if r_2735734 == tr_2734979 {
    			gotoNext = 2735834
    			_ = gotoNext == 2735834
    			_ = 0
    			gotoNext = 2734901
