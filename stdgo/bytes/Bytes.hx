...
/**
    /|*{
    	...
    	gotoNext = 2972284
    	_ = gotoNext == 2972284
    	if i_2972276 < len(s) && i_2972276 < len(t) {
    		gotoNext = 2972320
    		_ = gotoNext == 2972320
    		sr_2972324 = s[i_2972276]
    		tr_2972337 = t[i_2972276]
    		if sr_2972324|tr_2972337 >= 128 {
    			gotoNext = 2972376
    			_ = gotoNext == 2972376
    			gotoNext = 2972734
    			gotoNext = 2972420
    		...
    		if tr_2972337 < sr_2972324 {
    			gotoNext = 2972508
    			_ = gotoNext == 2972508
    			tr_2972337, sr_2972324 = sr_2972324, tr_2972337
    			gotoNext = 2972583
    		} else {
    			gotoNext = 2972583
    		}
    		_ = gotoNext == 2972583
    		if 65 <= sr_2972324 && sr_2972324 <= 90 && tr_2972337 == sr_2972324+97-65 {
    			gotoNext = 2972629
    			_ = gotoNext == 2972629
    			i_2972276++
    			gotoNext = 2972284
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			...
    			gotoNext = 2972921
    			_ = gotoNext == 2972921
    			r_2972926, size_2972929 = utf8.DecodeRune(s)
    			sr_2972843, s = r_2972926, s[size_2972929:]
    			_ = 0
    			gotoNext = 2972985
    		}
    		_ = gotoNext == 2972985
    		if t[0] < 128 {
    			...
    			gotoNext = 2973049
    			_ = gotoNext == 2973049
    			r_2973054, size_2973057 = utf8.DecodeRune(t)
    			tr_2972847, t = r_2973054, t[size_2973057:]
    			_ = 0
    			gotoNext = 2973185
    		}
    		_ = gotoNext == 2973185
    		if tr_2972847 == sr_2972843 {
    			gotoNext = 2973197
    			_ = gotoNext == 2973197
    			_ = 0
    			gotoNext = 2972769
    		...
    		if tr_2972847 < sr_2972843 {
    			gotoNext = 2973273
    			_ = gotoNext == 2973273
    			tr_2972847, sr_2972843 = sr_2972843, tr_2972847
    			gotoNext = 2973327
    		} else {
    			gotoNext = 2973327
    		}
    		...
    		if tr_2972847 < 128 {
    			gotoNext = 2973349
    			_ = gotoNext == 2973349
    			if 65 <= sr_2972843 && sr_2972843 <= 90 && tr_2972847 == sr_2972843+97-65 {
    				gotoNext = 2973449
    				_ = gotoNext == 2973449
    				_ = 0
    				gotoNext = 2972769
    		...
    		_ = gotoNext == 2973602
    		r_2973602 = unicode.SimpleFold(sr_2972843)
    		_ = 0
    		gotoNext = 2973632
    		_ = gotoNext == 2973632
    		if r_2973602 != sr_2972843 && r_2973602 < tr_2972847 {
    			gotoNext = 2973654
    			_ = gotoNext == 2973654
    			r_2973602 = unicode.SimpleFold(r_2973602)
    			gotoNext = 2973632
    		} else {
    			gotoNext = 2973691
    		}
    		_ = gotoNext == 2973691
    		if r_2973602 == tr_2972847 {
    			gotoNext = 2973702
    			_ = gotoNext == 2973702
    			_ = 0
    			gotoNext = 2972769
