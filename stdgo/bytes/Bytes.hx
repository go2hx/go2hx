...
function _growSlice(_b:Slice<GoByte>, _n:GoInt):Slice<GoByte> {
        ...
        try {
            ...
            var _b2 = (((null : Slice<GoUInt8>) : Slice<GoByte>).__append__(...new Slice<GoUInt8>((_c : GoInt).toBasic(), 0, ...[for (i in 0 ... (_c : GoInt).toBasic()) (0 : GoUInt8)]).__toArray__()));
            Go.copySlice(_b2, _b);
            {
...
function toUpper(_s:Slice<GoByte>):Slice<GoByte> {
        ...
        if (_isASCII) {
            if (!_hasLower) {
                return (((Go.str() : GoString) : Slice<GoByte>).__append__(..._s.__toArray__()));
            };
...
function trimRight(_s:Slice<GoByte>, _cutset:GoString):Slice<GoByte> {
        if ((_s.length == (0 : GoInt)) || (_cutset == (Go.str() : GoString))) {
            return _s;
        };
        if ((_cutset.length == (1 : GoInt)) && (_cutset[(0 : GoInt)] < (128 : GoUInt8))) {
...
function _trimRightUnicode(_s:Slice<GoByte>, _cutset:GoString):Slice<GoByte> {
        while ((_s.length) > (0 : GoInt)) {
            var _r:GoInt32 = (_s[(_s.length) - (1 : GoInt)] : GoRune), _n:GoInt = (1 : GoInt);
            if (_r >= (128 : GoInt32)) {
                {
...
function replace(_s:Slice<GoByte>, _old:Slice<GoByte>, _new:Slice<GoByte>, _n:GoInt):Slice<GoByte> {
        ...
        var _t = new Slice<GoUInt8>(((_s.length) + (_n * (_new.length) - (_old.length)) : GoInt).toBasic(), 0, ...[for (i in 0 ... ((_s.length) + (_n * (_new.length) - (_old.length)) : GoInt).toBasic()) (0 : GoUInt8)]);
    ...
    **/
    ...
    static public function readFrom( _b:Buffer, _r:stdgo.io.Io.Reader):{ var _0 : GoInt64; var _1 : Error; } {
        ...
        while (true) {
            ...
            var __tmp__ = _r.read((_b._buf.__slice__(_i, _b._buf.capacity) : Slice<GoUInt8>)), _m:GoInt = __tmp__._0, _e:stdgo.Error = __tmp__._1;
            if (_m < (0 : GoInt)) {
