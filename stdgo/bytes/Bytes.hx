...
/**
    /|*{
    	...
    	gotoNext = 2843752
    	_ = gotoNext == 2843752
    	if i_2843744 < len(s) && i_2843744 < len(t) {
    		gotoNext = 2843788
    		_ = gotoNext == 2843788
    		sr_2843792 = s[i_2843744]
    		tr_2843805 = t[i_2843744]
    		if sr_2843792|tr_2843805 >= 128 {
    			gotoNext = 2843844
    			_ = gotoNext == 2843844
    			gotoNext = 2844202
    			gotoNext = 2843888
    		...
    		if tr_2843805 < sr_2843792 {
    			gotoNext = 2843976
    			_ = gotoNext == 2843976
    			tr_2843805, sr_2843792 = sr_2843792, tr_2843805
    			gotoNext = 2844051
    		} else {
    			gotoNext = 2844051
    		}
    		_ = gotoNext == 2844051
    		if 65 <= sr_2843792 && sr_2843792 <= 90 && tr_2843805 == sr_2843792+97-65 {
    			gotoNext = 2844097
    			_ = gotoNext == 2844097
    			i_2843744++
    			gotoNext = 2843752
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			...
    			gotoNext = 2844389
    			_ = gotoNext == 2844389
    			r_2844394, size_2844397 = utf8.DecodeRune(s)
    			sr_2844311, s = r_2844394, s[size_2844397:]
    			_ = 0
    			gotoNext = 2844453
    		}
    		_ = gotoNext == 2844453
    		if t[0] < 128 {
    			...
    			gotoNext = 2844517
    			_ = gotoNext == 2844517
    			r_2844522, size_2844525 = utf8.DecodeRune(t)
    			tr_2844315, t = r_2844522, t[size_2844525:]
    			_ = 0
    			gotoNext = 2844653
    		}
    		_ = gotoNext == 2844653
    		if tr_2844315 == sr_2844311 {
    			gotoNext = 2844665
    			_ = gotoNext == 2844665
    			_ = 0
    			gotoNext = 2844237
    		...
    		if tr_2844315 < sr_2844311 {
    			gotoNext = 2844741
    			_ = gotoNext == 2844741
    			tr_2844315, sr_2844311 = sr_2844311, tr_2844315
    			gotoNext = 2844795
    		} else {
    			gotoNext = 2844795
    		}
    		...
    		if tr_2844315 < 128 {
    			gotoNext = 2844817
    			_ = gotoNext == 2844817
    			if 65 <= sr_2844311 && sr_2844311 <= 90 && tr_2844315 == sr_2844311+97-65 {
    				gotoNext = 2844917
    				_ = gotoNext == 2844917
    				_ = 0
    				gotoNext = 2844237
    		...
    		_ = gotoNext == 2845070
    		r_2845070 = unicode.SimpleFold(sr_2844311)
    		_ = 0
    		gotoNext = 2845100
    		_ = gotoNext == 2845100
    		if r_2845070 != sr_2844311 && r_2845070 < tr_2844315 {
    			gotoNext = 2845122
    			_ = gotoNext == 2845122
    			r_2845070 = unicode.SimpleFold(r_2845070)
    			gotoNext = 2845100
    		} else {
    			gotoNext = 2845159
    		}
    		_ = gotoNext == 2845159
    		if r_2845070 == tr_2844315 {
    			gotoNext = 2845170
    			_ = gotoNext == 2845170
    			_ = 0
    			gotoNext = 2844237
