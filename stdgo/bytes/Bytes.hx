...
/**
    /|*{
    	...
    	gotoNext = 2988379
    	_ = gotoNext == 2988379
    	if i_2988371 < len(s) && i_2988371 < len(t) {
    		gotoNext = 2988415
    		_ = gotoNext == 2988415
    		sr_2988419 = s[i_2988371]
    		tr_2988432 = t[i_2988371]
    		if sr_2988419|tr_2988432 >= 128 {
    			gotoNext = 2988471
    			_ = gotoNext == 2988471
    			gotoNext = 2988829
    			gotoNext = 2988515
    		...
    		if tr_2988432 < sr_2988419 {
    			gotoNext = 2988603
    			_ = gotoNext == 2988603
    			tr_2988432, sr_2988419 = sr_2988419, tr_2988432
    			gotoNext = 2988678
    		} else {
    			gotoNext = 2988678
    		}
    		_ = gotoNext == 2988678
    		if 65 <= sr_2988419 && sr_2988419 <= 90 && tr_2988432 == sr_2988419+97-65 {
    			gotoNext = 2988724
    			_ = gotoNext == 2988724
    			i_2988371++
    			gotoNext = 2988379
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			gotoNext = 2988976
    			_ = gotoNext == 2988976
    			sr_2988938, s = rune(s[0]), s[1:]
    			gotoNext = 2989080
    		} else {
    			gotoNext = 2989016
    			_ = gotoNext == 2989016
    			r_2989021, size_2989024 = utf8.DecodeRune(s)
    			sr_2988938, s = r_2989021, s[size_2989024:]
    			gotoNext = 2989080
    		}
    		_ = gotoNext == 2989080
    		if t[0] < 128 {
    			gotoNext = 2989104
    			_ = gotoNext == 2989104
    			tr_2988942, t = rune(t[0]), t[1:]
    			gotoNext = 2989280
    		} else {
    			gotoNext = 2989144
    			_ = gotoNext == 2989144
    			r_2989149, size_2989152 = utf8.DecodeRune(t)
    			tr_2988942, t = r_2989149, t[size_2989152:]
    			gotoNext = 2989280
    		}
    		_ = gotoNext == 2989280
    		if tr_2988942 == sr_2988938 {
    			gotoNext = 2989292
    			_ = gotoNext == 2989292
    			_ = 0
    			gotoNext = 2988864
    		...
    		if tr_2988942 < sr_2988938 {
    			gotoNext = 2989368
    			_ = gotoNext == 2989368
    			tr_2988942, sr_2988938 = sr_2988938, tr_2988942
    			gotoNext = 2989422
    		} else {
    			gotoNext = 2989422
    		}
    		...
    		if tr_2988942 < 128 {
    			gotoNext = 2989444
    			_ = gotoNext == 2989444
    			if 65 <= sr_2988938 && sr_2988938 <= 90 && tr_2988942 == sr_2988938+97-65 {
    				gotoNext = 2989544
    				_ = gotoNext == 2989544
    				_ = 0
    				gotoNext = 2988864
    		...
    		_ = gotoNext == 2989697
    		r_2989697 = unicode.SimpleFold(sr_2988938)
    		_ = 0
    		gotoNext = 2989727
    		_ = gotoNext == 2989727
    		if r_2989697 != sr_2988938 && r_2989697 < tr_2988942 {
    			gotoNext = 2989749
    			_ = gotoNext == 2989749
    			r_2989697 = unicode.SimpleFold(r_2989697)
    			gotoNext = 2989727
    		} else {
    			gotoNext = 2989786
    		}
    		_ = gotoNext == 2989786
    		if r_2989697 == tr_2988942 {
    			gotoNext = 2989797
    			_ = gotoNext == 2989797
    			_ = 0
    			gotoNext = 2988864
