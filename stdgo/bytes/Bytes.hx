...
/**
    /|*{
    	...
    	gotoNext = 3016501
    	_ = gotoNext == 3016501
    	if i_3016493 < len(s) && i_3016493 < len(t) {
    		gotoNext = 3016537
    		_ = gotoNext == 3016537
    		sr_3016541 = s[i_3016493]
    		tr_3016554 = t[i_3016493]
    		if sr_3016541|tr_3016554 >= 128 {
    			gotoNext = 3016593
    			_ = gotoNext == 3016593
    			gotoNext = 3016951
    			gotoNext = 3016637
    		...
    		if tr_3016554 < sr_3016541 {
    			gotoNext = 3016725
    			_ = gotoNext == 3016725
    			tr_3016554, sr_3016541 = sr_3016541, tr_3016554
    			gotoNext = 3016800
    		} else {
    			gotoNext = 3016800
    		}
    		_ = gotoNext == 3016800
    		if 65 <= sr_3016541 && sr_3016541 <= 90 && tr_3016554 == sr_3016541+97-65 {
    			gotoNext = 3016846
    			_ = gotoNext == 3016846
    			i_3016493++
    			gotoNext = 3016501
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			...
    			gotoNext = 3017138
    			_ = gotoNext == 3017138
    			r_3017143, size_3017146 = utf8.DecodeRune(s)
    			sr_3017060, s = r_3017143, s[size_3017146:]
    			_ = 0
    			gotoNext = 3017202
    		}
    		_ = gotoNext == 3017202
    		if t[0] < 128 {
    			...
    			gotoNext = 3017266
    			_ = gotoNext == 3017266
    			r_3017271, size_3017274 = utf8.DecodeRune(t)
    			tr_3017064, t = r_3017271, t[size_3017274:]
    			_ = 0
    			gotoNext = 3017402
    		}
    		_ = gotoNext == 3017402
    		if tr_3017064 == sr_3017060 {
    			gotoNext = 3017414
    			_ = gotoNext == 3017414
    			_ = 0
    			gotoNext = 3016986
    		...
    		if tr_3017064 < sr_3017060 {
    			gotoNext = 3017490
    			_ = gotoNext == 3017490
    			tr_3017064, sr_3017060 = sr_3017060, tr_3017064
    			gotoNext = 3017544
    		} else {
    			gotoNext = 3017544
    		}
    		...
    		if tr_3017064 < 128 {
    			gotoNext = 3017566
    			_ = gotoNext == 3017566
    			if 65 <= sr_3017060 && sr_3017060 <= 90 && tr_3017064 == sr_3017060+97-65 {
    				gotoNext = 3017666
    				_ = gotoNext == 3017666
    				_ = 0
    				gotoNext = 3016986
    		...
    		_ = gotoNext == 3017819
    		r_3017819 = unicode.SimpleFold(sr_3017060)
    		_ = 0
    		gotoNext = 3017849
    		_ = gotoNext == 3017849
    		if r_3017819 != sr_3017060 && r_3017819 < tr_3017064 {
    			gotoNext = 3017871
    			_ = gotoNext == 3017871
    			r_3017819 = unicode.SimpleFold(r_3017819)
    			gotoNext = 3017849
    		} else {
    			gotoNext = 3017908
    		}
    		_ = gotoNext == 3017908
    		if r_3017819 == tr_3017064 {
    			gotoNext = 3017919
    			_ = gotoNext == 3017919
    			_ = 0
    			gotoNext = 3016986
