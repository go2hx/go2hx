...
/**
    /|*{
    	...
    	gotoNext = 2882582
    	_ = gotoNext == 2882582
    	if i_2882574 < len(s) && i_2882574 < len(t) {
    		gotoNext = 2882618
    		_ = gotoNext == 2882618
    		sr_2882622 = s[i_2882574]
    		tr_2882635 = t[i_2882574]
    		if sr_2882622|tr_2882635 >= 128 {
    			gotoNext = 2882674
    			_ = gotoNext == 2882674
    			gotoNext = 2883032
    			gotoNext = 2882718
    		...
    		if tr_2882635 < sr_2882622 {
    			gotoNext = 2882806
    			_ = gotoNext == 2882806
    			tr_2882635, sr_2882622 = sr_2882622, tr_2882635
    			gotoNext = 2882881
    		} else {
    			gotoNext = 2882881
    		}
    		_ = gotoNext == 2882881
    		if 65 <= sr_2882622 && sr_2882622 <= 90 && tr_2882635 == sr_2882622+97-65 {
    			gotoNext = 2882927
    			_ = gotoNext == 2882927
    			i_2882574++
    			gotoNext = 2882582
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			gotoNext = 2883179
    			_ = gotoNext == 2883179
    			sr_2883141, s = rune(s[0]), s[1:]
    			gotoNext = 2883283
    		} else {
    			gotoNext = 2883219
    			_ = gotoNext == 2883219
    			r_2883224, size_2883227 = utf8.DecodeRune(s)
    			sr_2883141, s = r_2883224, s[size_2883227:]
    			gotoNext = 2883283
    		}
    		_ = gotoNext == 2883283
    		if t[0] < 128 {
    			gotoNext = 2883307
    			_ = gotoNext == 2883307
    			tr_2883145, t = rune(t[0]), t[1:]
    			gotoNext = 2883483
    		} else {
    			gotoNext = 2883347
    			_ = gotoNext == 2883347
    			r_2883352, size_2883355 = utf8.DecodeRune(t)
    			tr_2883145, t = r_2883352, t[size_2883355:]
    			gotoNext = 2883483
    		}
    		_ = gotoNext == 2883483
    		if tr_2883145 == sr_2883141 {
    			gotoNext = 2883495
    			_ = gotoNext == 2883495
    			_ = 0
    			gotoNext = 2883067
    		...
    		if tr_2883145 < sr_2883141 {
    			gotoNext = 2883571
    			_ = gotoNext == 2883571
    			tr_2883145, sr_2883141 = sr_2883141, tr_2883145
    			gotoNext = 2883625
    		} else {
    			gotoNext = 2883625
    		}
    		...
    		if tr_2883145 < 128 {
    			gotoNext = 2883647
    			_ = gotoNext == 2883647
    			if 65 <= sr_2883141 && sr_2883141 <= 90 && tr_2883145 == sr_2883141+97-65 {
    				gotoNext = 2883747
    				_ = gotoNext == 2883747
    				_ = 0
    				gotoNext = 2883067
    		...
    		_ = gotoNext == 2883900
    		r_2883900 = unicode.SimpleFold(sr_2883141)
    		_ = 0
    		gotoNext = 2883930
    		_ = gotoNext == 2883930
    		if r_2883900 != sr_2883141 && r_2883900 < tr_2883145 {
    			gotoNext = 2883952
    			_ = gotoNext == 2883952
    			r_2883900 = unicode.SimpleFold(r_2883900)
    			gotoNext = 2883930
    		} else {
    			gotoNext = 2883989
    		}
    		_ = gotoNext == 2883989
    		if r_2883900 == tr_2883145 {
    			gotoNext = 2884000
    			_ = gotoNext == 2884000
    			_ = 0
    			gotoNext = 2883067
