...
/**
    /|*{
    	...
    	gotoNext = 2854558
    	_ = gotoNext == 2854558
    	if i_2854550 < len(s) && i_2854550 < len(t) {
    		gotoNext = 2854594
    		_ = gotoNext == 2854594
    		sr_2854598 = s[i_2854550]
    		tr_2854611 = t[i_2854550]
    		if sr_2854598|tr_2854611 >= 128 {
    			gotoNext = 2854650
    			_ = gotoNext == 2854650
    			gotoNext = 2855008
    			gotoNext = 2854694
    		...
    		if tr_2854611 < sr_2854598 {
    			gotoNext = 2854782
    			_ = gotoNext == 2854782
    			tr_2854611, sr_2854598 = sr_2854598, tr_2854611
    			gotoNext = 2854857
    		} else {
    			gotoNext = 2854857
    		}
    		_ = gotoNext == 2854857
    		if 65 <= sr_2854598 && sr_2854598 <= 90 && tr_2854611 == sr_2854598+97-65 {
    			gotoNext = 2854903
    			_ = gotoNext == 2854903
    			i_2854550++
    			gotoNext = 2854558
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			...
    			gotoNext = 2855195
    			_ = gotoNext == 2855195
    			r_2855200, size_2855203 = utf8.DecodeRune(s)
    			sr_2855117, s = r_2855200, s[size_2855203:]
    			_ = 0
    			gotoNext = 2855259
    		}
    		_ = gotoNext == 2855259
    		if t[0] < 128 {
    			...
    			gotoNext = 2855323
    			_ = gotoNext == 2855323
    			r_2855328, size_2855331 = utf8.DecodeRune(t)
    			tr_2855121, t = r_2855328, t[size_2855331:]
    			_ = 0
    			gotoNext = 2855459
    		}
    		_ = gotoNext == 2855459
    		if tr_2855121 == sr_2855117 {
    			gotoNext = 2855471
    			_ = gotoNext == 2855471
    			_ = 0
    			gotoNext = 2855043
    		...
    		if tr_2855121 < sr_2855117 {
    			gotoNext = 2855547
    			_ = gotoNext == 2855547
    			tr_2855121, sr_2855117 = sr_2855117, tr_2855121
    			gotoNext = 2855601
    		} else {
    			gotoNext = 2855601
    		}
    		...
    		if tr_2855121 < 128 {
    			gotoNext = 2855623
    			_ = gotoNext == 2855623
    			if 65 <= sr_2855117 && sr_2855117 <= 90 && tr_2855121 == sr_2855117+97-65 {
    				gotoNext = 2855723
    				_ = gotoNext == 2855723
    				_ = 0
    				gotoNext = 2855043
    		...
    		_ = gotoNext == 2855876
    		r_2855876 = unicode.SimpleFold(sr_2855117)
    		_ = 0
    		gotoNext = 2855906
    		_ = gotoNext == 2855906
    		if r_2855876 != sr_2855117 && r_2855876 < tr_2855121 {
    			gotoNext = 2855928
    			_ = gotoNext == 2855928
    			r_2855876 = unicode.SimpleFold(r_2855876)
    			gotoNext = 2855906
    		} else {
    			gotoNext = 2855965
    		}
    		_ = gotoNext == 2855965
    		if r_2855876 == tr_2855121 {
    			gotoNext = 2855976
    			_ = gotoNext == 2855976
    			_ = 0
    			gotoNext = 2855043
