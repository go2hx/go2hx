...
/**
    /|*{
    	...
    	gotoNext = 3002910
    	_ = gotoNext == 3002910
    	if i_3002902 < len(s) && i_3002902 < len(t) {
    		gotoNext = 3002946
    		_ = gotoNext == 3002946
    		sr_3002950 = s[i_3002902]
    		tr_3002963 = t[i_3002902]
    		if sr_3002950|tr_3002963 >= 128 {
    			gotoNext = 3003002
    			_ = gotoNext == 3003002
    			gotoNext = 3003360
    			gotoNext = 3003046
    		...
    		if tr_3002963 < sr_3002950 {
    			gotoNext = 3003134
    			_ = gotoNext == 3003134
    			tr_3002963, sr_3002950 = sr_3002950, tr_3002963
    			gotoNext = 3003209
    		} else {
    			gotoNext = 3003209
    		}
    		_ = gotoNext == 3003209
    		if 65 <= sr_3002950 && sr_3002950 <= 90 && tr_3002963 == sr_3002950+97-65 {
    			gotoNext = 3003255
    			_ = gotoNext == 3003255
    			i_3002902++
    			gotoNext = 3002910
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			...
    			gotoNext = 3003547
    			_ = gotoNext == 3003547
    			r_3003552, size_3003555 = utf8.DecodeRune(s)
    			sr_3003469, s = r_3003552, s[size_3003555:]
    			_ = 0
    			gotoNext = 3003611
    		}
    		_ = gotoNext == 3003611
    		if t[0] < 128 {
    			...
    			gotoNext = 3003675
    			_ = gotoNext == 3003675
    			r_3003680, size_3003683 = utf8.DecodeRune(t)
    			tr_3003473, t = r_3003680, t[size_3003683:]
    			_ = 0
    			gotoNext = 3003811
    		}
    		_ = gotoNext == 3003811
    		if tr_3003473 == sr_3003469 {
    			gotoNext = 3003823
    			_ = gotoNext == 3003823
    			_ = 0
    			gotoNext = 3003395
    		...
    		if tr_3003473 < sr_3003469 {
    			gotoNext = 3003899
    			_ = gotoNext == 3003899
    			tr_3003473, sr_3003469 = sr_3003469, tr_3003473
    			gotoNext = 3003953
    		} else {
    			gotoNext = 3003953
    		}
    		...
    		if tr_3003473 < 128 {
    			gotoNext = 3003975
    			_ = gotoNext == 3003975
    			if 65 <= sr_3003469 && sr_3003469 <= 90 && tr_3003473 == sr_3003469+97-65 {
    				gotoNext = 3004075
    				_ = gotoNext == 3004075
    				_ = 0
    				gotoNext = 3003395
    		...
    		_ = gotoNext == 3004228
    		r_3004228 = unicode.SimpleFold(sr_3003469)
    		_ = 0
    		gotoNext = 3004258
    		_ = gotoNext == 3004258
    		if r_3004228 != sr_3003469 && r_3004228 < tr_3003473 {
    			gotoNext = 3004280
    			_ = gotoNext == 3004280
    			r_3004228 = unicode.SimpleFold(r_3004228)
    			gotoNext = 3004258
    		} else {
    			gotoNext = 3004317
    		}
    		_ = gotoNext == 3004317
    		if r_3004228 == tr_3003473 {
    			gotoNext = 3004328
    			_ = gotoNext == 3004328
    			_ = 0
    			gotoNext = 3003395
