...
/**
    /|*{
    	...
    	gotoNext = 2859133
    	_ = gotoNext == 2859133
    	if i_2859125 < len(s) && i_2859125 < len(t) {
    		gotoNext = 2859169
    		_ = gotoNext == 2859169
    		sr_2859173 = s[i_2859125]
    		tr_2859186 = t[i_2859125]
    		if sr_2859173|tr_2859186 >= 128 {
    			gotoNext = 2859225
    			_ = gotoNext == 2859225
    			gotoNext = 2859583
    			gotoNext = 2859269
    		...
    		if tr_2859186 < sr_2859173 {
    			gotoNext = 2859357
    			_ = gotoNext == 2859357
    			tr_2859186, sr_2859173 = sr_2859173, tr_2859186
    			gotoNext = 2859432
    		} else {
    			gotoNext = 2859432
    		}
    		_ = gotoNext == 2859432
    		if 65 <= sr_2859173 && sr_2859173 <= 90 && tr_2859186 == sr_2859173+97-65 {
    			gotoNext = 2859478
    			_ = gotoNext == 2859478
    			i_2859125++
    			gotoNext = 2859133
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			...
    			gotoNext = 2859770
    			_ = gotoNext == 2859770
    			r_2859775, size_2859778 = utf8.DecodeRune(s)
    			sr_2859692, s = r_2859775, s[size_2859778:]
    			_ = 0
    			gotoNext = 2859834
    		}
    		_ = gotoNext == 2859834
    		if t[0] < 128 {
    			...
    			gotoNext = 2859898
    			_ = gotoNext == 2859898
    			r_2859903, size_2859906 = utf8.DecodeRune(t)
    			tr_2859696, t = r_2859903, t[size_2859906:]
    			_ = 0
    			gotoNext = 2860034
    		}
    		_ = gotoNext == 2860034
    		if tr_2859696 == sr_2859692 {
    			gotoNext = 2860046
    			_ = gotoNext == 2860046
    			_ = 0
    			gotoNext = 2859618
    		...
    		if tr_2859696 < sr_2859692 {
    			gotoNext = 2860122
    			_ = gotoNext == 2860122
    			tr_2859696, sr_2859692 = sr_2859692, tr_2859696
    			gotoNext = 2860176
    		} else {
    			gotoNext = 2860176
    		}
    		...
    		if tr_2859696 < 128 {
    			gotoNext = 2860198
    			_ = gotoNext == 2860198
    			if 65 <= sr_2859692 && sr_2859692 <= 90 && tr_2859696 == sr_2859692+97-65 {
    				gotoNext = 2860298
    				_ = gotoNext == 2860298
    				_ = 0
    				gotoNext = 2859618
    		...
    		_ = gotoNext == 2860451
    		r_2860451 = unicode.SimpleFold(sr_2859692)
    		_ = 0
    		gotoNext = 2860481
    		_ = gotoNext == 2860481
    		if r_2860451 != sr_2859692 && r_2860451 < tr_2859696 {
    			gotoNext = 2860503
    			_ = gotoNext == 2860503
    			r_2860451 = unicode.SimpleFold(r_2860451)
    			gotoNext = 2860481
    		} else {
    			gotoNext = 2860540
    		}
    		_ = gotoNext == 2860540
    		if r_2860451 == tr_2859696 {
    			gotoNext = 2860551
    			_ = gotoNext == 2860551
    			_ = 0
    			gotoNext = 2859618
