...
/**
    /|*{
    	...
    	gotoNext = 2880404
    	_ = gotoNext == 2880404
    	if i_2880396 < len(s) && i_2880396 < len(t) {
    		gotoNext = 2880440
    		_ = gotoNext == 2880440
    		sr_2880444 = s[i_2880396]
    		tr_2880457 = t[i_2880396]
    		if sr_2880444|tr_2880457 >= 128 {
    			gotoNext = 2880496
    			_ = gotoNext == 2880496
    			gotoNext = 2880854
    			gotoNext = 2880540
    		...
    		if tr_2880457 < sr_2880444 {
    			gotoNext = 2880628
    			_ = gotoNext == 2880628
    			tr_2880457, sr_2880444 = sr_2880444, tr_2880457
    			gotoNext = 2880703
    		} else {
    			gotoNext = 2880703
    		}
    		_ = gotoNext == 2880703
    		if 65 <= sr_2880444 && sr_2880444 <= 90 && tr_2880457 == sr_2880444+97-65 {
    			gotoNext = 2880749
    			_ = gotoNext == 2880749
    			i_2880396++
    			gotoNext = 2880404
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			...
    			gotoNext = 2881041
    			_ = gotoNext == 2881041
    			r_2881046, size_2881049 = utf8.DecodeRune(s)
    			sr_2880963, s = r_2881046, s[size_2881049:]
    			_ = 0
    			gotoNext = 2881105
    		}
    		_ = gotoNext == 2881105
    		if t[0] < 128 {
    			...
    			gotoNext = 2881169
    			_ = gotoNext == 2881169
    			r_2881174, size_2881177 = utf8.DecodeRune(t)
    			tr_2880967, t = r_2881174, t[size_2881177:]
    			_ = 0
    			gotoNext = 2881305
    		}
    		_ = gotoNext == 2881305
    		if tr_2880967 == sr_2880963 {
    			gotoNext = 2881317
    			_ = gotoNext == 2881317
    			_ = 0
    			gotoNext = 2880889
    		...
    		if tr_2880967 < sr_2880963 {
    			gotoNext = 2881393
    			_ = gotoNext == 2881393
    			tr_2880967, sr_2880963 = sr_2880963, tr_2880967
    			gotoNext = 2881447
    		} else {
    			gotoNext = 2881447
    		}
    		...
    		if tr_2880967 < 128 {
    			gotoNext = 2881469
    			_ = gotoNext == 2881469
    			if 65 <= sr_2880963 && sr_2880963 <= 90 && tr_2880967 == sr_2880963+97-65 {
    				gotoNext = 2881569
    				_ = gotoNext == 2881569
    				_ = 0
    				gotoNext = 2880889
    		...
    		_ = gotoNext == 2881722
    		r_2881722 = unicode.SimpleFold(sr_2880963)
    		_ = 0
    		gotoNext = 2881752
    		_ = gotoNext == 2881752
    		if r_2881722 != sr_2880963 && r_2881722 < tr_2880967 {
    			gotoNext = 2881774
    			_ = gotoNext == 2881774
    			r_2881722 = unicode.SimpleFold(r_2881722)
    			gotoNext = 2881752
    		} else {
    			gotoNext = 2881811
    		}
    		_ = gotoNext == 2881811
    		if r_2881722 == tr_2880967 {
    			gotoNext = 2881822
    			_ = gotoNext == 2881822
    			_ = 0
    			gotoNext = 2880889
