...
/**
    /|*{
    	...
    	gotoNext = 2944039
    	_ = gotoNext == 2944039
    	if i_2944031 < len(s) && i_2944031 < len(t) {
    		gotoNext = 2944075
    		_ = gotoNext == 2944075
    		sr_2944079 = s[i_2944031]
    		tr_2944092 = t[i_2944031]
    		if sr_2944079|tr_2944092 >= 128 {
    			gotoNext = 2944131
    			_ = gotoNext == 2944131
    			gotoNext = 2944489
    			gotoNext = 2944175
    		...
    		if tr_2944092 < sr_2944079 {
    			gotoNext = 2944263
    			_ = gotoNext == 2944263
    			tr_2944092, sr_2944079 = sr_2944079, tr_2944092
    			gotoNext = 2944338
    		} else {
    			gotoNext = 2944338
    		}
    		_ = gotoNext == 2944338
    		if 65 <= sr_2944079 && sr_2944079 <= 90 && tr_2944092 == sr_2944079+97-65 {
    			gotoNext = 2944384
    			_ = gotoNext == 2944384
    			i_2944031++
    			gotoNext = 2944039
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			...
    			gotoNext = 2944676
    			_ = gotoNext == 2944676
    			r_2944681, size_2944684 = utf8.DecodeRune(s)
    			sr_2944598, s = r_2944681, s[size_2944684:]
    			_ = 0
    			gotoNext = 2944740
    		}
    		_ = gotoNext == 2944740
    		if t[0] < 128 {
    			...
    			gotoNext = 2944804
    			_ = gotoNext == 2944804
    			r_2944809, size_2944812 = utf8.DecodeRune(t)
    			tr_2944602, t = r_2944809, t[size_2944812:]
    			_ = 0
    			gotoNext = 2944940
    		}
    		_ = gotoNext == 2944940
    		if tr_2944602 == sr_2944598 {
    			gotoNext = 2944952
    			_ = gotoNext == 2944952
    			_ = 0
    			gotoNext = 2944524
    		...
    		if tr_2944602 < sr_2944598 {
    			gotoNext = 2945028
    			_ = gotoNext == 2945028
    			tr_2944602, sr_2944598 = sr_2944598, tr_2944602
    			gotoNext = 2945082
    		} else {
    			gotoNext = 2945082
    		}
    		...
    		if tr_2944602 < 128 {
    			gotoNext = 2945104
    			_ = gotoNext == 2945104
    			if 65 <= sr_2944598 && sr_2944598 <= 90 && tr_2944602 == sr_2944598+97-65 {
    				gotoNext = 2945204
    				_ = gotoNext == 2945204
    				_ = 0
    				gotoNext = 2944524
    		...
    		_ = gotoNext == 2945357
    		r_2945357 = unicode.SimpleFold(sr_2944598)
    		_ = 0
    		gotoNext = 2945387
    		_ = gotoNext == 2945387
    		if r_2945357 != sr_2944598 && r_2945357 < tr_2944602 {
    			gotoNext = 2945409
    			_ = gotoNext == 2945409
    			r_2945357 = unicode.SimpleFold(r_2945357)
    			gotoNext = 2945387
    		} else {
    			gotoNext = 2945446
    		}
    		_ = gotoNext == 2945446
    		if r_2945357 == tr_2944602 {
    			gotoNext = 2945457
    			_ = gotoNext == 2945457
    			_ = 0
    			gotoNext = 2944524
