...
@:structInit @:using(Bytes.Buffer_static_extension) class Buffer {
    ...
    public function readFrom(_r:stdgo.io.Io.Reader):{ var _0 : GoInt64; var _1 : Error; } {
        ...
        while (true) {
            ...
            var __tmp__ = _r.read(_b._buf.__slice__(_i, (_b._buf != null ? _b._buf.cap() : ((0 : GoInt))))), _m:GoInt = __tmp__._0, _e:stdgo.Error = __tmp__._1;
            if (_m < ((0 : GoInt))) {
...
@:named @:using(Bytes.T_asciiSet_static_extension) typedef T_asciiSet = GoArray<GoUInt32>;
...
function _explode(_s:Slice<GoByte>, _n:GoInt):Slice<Slice<GoByte>> {
        ...
        while ((_s != null ? _s.length : ((0 : GoInt))) > ((0 : GoInt))) {
            ...
            if (_a != null) _a[_na] = _s.__slice__(((0 : GoInt)), _size).__setCap__(((_size : GoInt)) - ((1 : GoInt)));
...
function count(_s:Slice<GoByte>, _sep:Slice<GoByte>):GoInt {
        ...
        while (true) {
            ...
            _n++;
            _s = _s.__slice__(_i + (_sep != null ? _sep.length : ((0 : GoInt))));
        };
    }
/**
...
function _genSplit(_s:Slice<GoByte>, _sep:Slice<GoByte>, _sepSave:GoInt, _n:GoInt):Slice<Slice<GoByte>> {
        ...
        while (_i < _n) {
            ...
            if (_a != null) _a[_i] = _s.__slice__(0, _m + _sepSave).__setCap__(((_m + _sepSave : GoInt)) - ((1 : GoInt)));
            _s = _s.__slice__(_m + (_sep != null ? _sep.length : ((0 : GoInt))));
            _i++;
        };
        if (_a != null) _a[_i] = _s;
...
function fields(_s:Slice<GoByte>):Slice<Slice<GoByte>> {
        ...
        while (_i < (_s != null ? _s.length : ((0 : GoInt)))) {
            ...
            if (_a != null) _a[_na] = _s.__slice__(_fieldStart, _i).__setCap__(((_i : GoInt)) - ((1 : GoInt)));
            _na++;
            _i++;
            while ((_i < (_s != null ? _s.length : ((0 : GoInt)))) && ((_asciiSpace != null ? _asciiSpace[(_s != null ? _s[_i] : ((0 : GoUInt8)))] : ((0 : GoUInt8))) != ((0 : GoUInt8)))) {
                _i++;
        ...
        if (_fieldStart < (_s != null ? _s.length : ((0 : GoInt)))) {
            if (_a != null) _a[_na] = _s.__slice__(_fieldStart, (_s != null ? _s.length : ((0 : GoInt)))).__setCap__((((_s != null ? _s.length : ((0 : GoInt))) : GoInt)) - ((1 : GoInt)));
        };
        return _a;
    }
...
function fieldsFunc(_s:Slice<GoByte>, _f:GoRune -> Bool):Slice<Slice<GoByte>> {
        ...
        for (_i => _span in _spans) {
            if (_a != null) _a[_i] = _s.__slice__(_span._start, _span._end).__setCap__(((_span._end : GoInt)) - ((1 : GoInt)));
        };
        return _a;
    }
/**
...
function join(_s:Slice<Slice<GoByte>>, _sep:Slice<GoByte>):Slice<GoByte> {
        ...
        var _bp:GoInt = Go.copy(_b, (_s != null ? _s[((0 : GoInt))] : ((null : Slice<GoUInt8>))));
...
function hasPrefix(_s:Slice<GoByte>, _prefix:Slice<GoByte>):Bool {
        return ((_s != null ? _s.length : ((0 : GoInt))) >= (_prefix != null ? _prefix.length : ((0 : GoInt)))) && equal(_s.__slice__(((0 : GoInt)), (_prefix != null ? _prefix.length : ((0 : GoInt)))), _prefix);
    }
/**
    // HasSuffix tests whether the byte slice s ends with suffix.
**/
function hasSuffix(_s:Slice<GoByte>, _suffix:Slice<GoByte>):Bool {
        return ((_s != null ? _s.length : ((0 : GoInt))) >= (_suffix != null ? _suffix.length : ((0 : GoInt)))) && equal(_s.__slice__((_s != null ? _s.length : ((0 : GoInt))) - (_suffix != null ? _suffix.length : ((0 : GoInt)))), _suffix);
    }
/**
...
function toUpper(_s:Slice<GoByte>):Slice<GoByte> {
        ...
        if (_isASCII) {
            if (!_hasLower) {
                return (((("") : Slice<GoByte>)) != null ? ((("") : Slice<GoByte>)).__append__(..._s.__toArray__()) : new Slice<GoUInt8>(..._s.__toArray__()));
            };
...
function toValidUTF8(_s:Slice<GoByte>, _replacement:Slice<GoByte>):Slice<GoByte> {
        ...
        var _invalid:Bool = false;
        {
            ...
            while (_i < (_s != null ? _s.length : ((0 : GoInt)))) {
                ...
                _invalid = false;
                _b = (_b != null ? _b.__append__(..._s.__slice__(_i, _i + _wid).__toArray__()) : new Slice<GoUInt8>(..._s.__slice__(_i, _i + _wid).__toArray__()));
                _i = _i + (_wid);
            };
        };
        return _b;
...
function trimPrefix(_s:Slice<GoByte>, _prefix:Slice<GoByte>):Slice<GoByte> {
        if (hasPrefix(_s, _prefix)) {
            return _s.__slice__((_prefix != null ? _prefix.length : ((0 : GoInt))));
        };
        return _s;
    }
/**
...
function trimSuffix(_s:Slice<GoByte>, _suffix:Slice<GoByte>):Slice<GoByte> {
        if (hasSuffix(_s, _suffix)) {
            return _s.__slice__(0, (_s != null ? _s.length : ((0 : GoInt))) - (_suffix != null ? _suffix.length : ((0 : GoInt))));
        };
        return _s;
    }
/**
...
function trim(_s:Slice<GoByte>, _cutset:GoString):Slice<GoByte> {
        if (((_s != null ? _s.length : ((0 : GoInt))) == ((0 : GoInt))) || (_cutset == (""))) {
            return _s;
        };
...
function _trimRightByte(_s:Slice<GoByte>, _c:GoByte):Slice<GoByte> {
        while (((_s != null ? _s.length : ((0 : GoInt))) > ((0 : GoInt))) && ((_s != null ? _s[(_s != null ? _s.length : ((0 : GoInt))) - ((1 : GoInt))] : ((0 : GoUInt8))) == _c)) {
            _s = _s.__slice__(0, (_s != null ? _s.length : ((0 : GoInt))) - ((1 : GoInt)));
        };
        return _s;
    }
...
function _trimRightUnicode(_s:Slice<GoByte>, _cutset:GoString):Slice<GoByte> {
        while ((_s != null ? _s.length : ((0 : GoInt))) > ((0 : GoInt))) {
            ...
            _s = _s.__slice__(0, (_s != null ? _s.length : ((0 : GoInt))) - _n);
        };
        return _s;
    }
/**
...
function index(_s:Slice<GoByte>, _sep:Slice<GoByte>):GoInt {
        ...
        if (_n == ((0 : GoInt))) {
            ...
            while (_i < _t) {
                ...
                if (((_s != null ? _s[_i + ((1 : GoInt))] : ((0 : GoUInt8))) == _c1) && equal(_s.__slice__(_i, _i + _n), _sep)) {
                    return _i;
                };
                _fails++;
                _i++;
...
function cut(_s:Slice<GoByte>, _sep:Slice<GoByte>):{ var _0 : Slice<GoByte>; var _1 : Slice<GoByte>; var _2 : Bool; } {
        var _before:Slice<GoByte> = ((null : Slice<GoUInt8>)), _after:Slice<GoByte> = ((null : Slice<GoUInt8>)), _found:Bool = false;
        {
            var _i:GoInt = index(_s, _sep);
            if (_i >= ((0 : GoInt))) {
                return { _0 : _s.__slice__(0, _i), _1 : _s.__slice__(_i + (_sep != null ? _sep.length : ((0 : GoInt)))), _2 : true };
            };
        };
...
@:build(stdgo.internal.Macro.wrapper(Buffer)) class Buffer_static_extension {

}
@:build(stdgo.internal.Macro.wrapper(T_asciiSet)) class T_asciiSet_static_extension {
    @:keep
...
@:build(stdgo.internal.Macro.wrapper(Reader)) class Reader_static_extension {
