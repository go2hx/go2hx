...
/**
    /|*{
    	...
    	gotoNext = 2824358
    	_ = gotoNext == 2824358
    	if i_2824350 < len(s) && i_2824350 < len(t) {
    		gotoNext = 2824394
    		_ = gotoNext == 2824394
    		sr_2824398 = s[i_2824350]
    		tr_2824411 = t[i_2824350]
    		if sr_2824398|tr_2824411 >= 128 {
    			gotoNext = 2824450
    			_ = gotoNext == 2824450
    			gotoNext = 2824808
    			gotoNext = 2824494
    		...
    		if tr_2824411 < sr_2824398 {
    			gotoNext = 2824582
    			_ = gotoNext == 2824582
    			tr_2824411, sr_2824398 = sr_2824398, tr_2824411
    			gotoNext = 2824657
    		} else {
    			gotoNext = 2824657
    		}
    		_ = gotoNext == 2824657
    		if 65 <= sr_2824398 && sr_2824398 <= 90 && tr_2824411 == sr_2824398+97-65 {
    			gotoNext = 2824703
    			_ = gotoNext == 2824703
    			i_2824350++
    			gotoNext = 2824358
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			...
    			gotoNext = 2824995
    			_ = gotoNext == 2824995
    			r_2825000, size_2825003 = utf8.DecodeRune(s)
    			sr_2824917, s = r_2825000, s[size_2825003:]
    			_ = 0
    			gotoNext = 2825059
    		}
    		_ = gotoNext == 2825059
    		if t[0] < 128 {
    			...
    			gotoNext = 2825123
    			_ = gotoNext == 2825123
    			r_2825128, size_2825131 = utf8.DecodeRune(t)
    			tr_2824921, t = r_2825128, t[size_2825131:]
    			_ = 0
    			gotoNext = 2825259
    		}
    		_ = gotoNext == 2825259
    		if tr_2824921 == sr_2824917 {
    			gotoNext = 2825271
    			_ = gotoNext == 2825271
    			_ = 0
    			gotoNext = 2824843
    		...
    		if tr_2824921 < sr_2824917 {
    			gotoNext = 2825347
    			_ = gotoNext == 2825347
    			tr_2824921, sr_2824917 = sr_2824917, tr_2824921
    			gotoNext = 2825401
    		} else {
    			gotoNext = 2825401
    		}
    		...
    		if tr_2824921 < 128 {
    			gotoNext = 2825423
    			_ = gotoNext == 2825423
    			if 65 <= sr_2824917 && sr_2824917 <= 90 && tr_2824921 == sr_2824917+97-65 {
    				gotoNext = 2825523
    				_ = gotoNext == 2825523
    				_ = 0
    				gotoNext = 2824843
    		...
    		_ = gotoNext == 2825676
    		r_2825676 = unicode.SimpleFold(sr_2824917)
    		_ = 0
    		gotoNext = 2825706
    		_ = gotoNext == 2825706
    		if r_2825676 != sr_2824917 && r_2825676 < tr_2824921 {
    			gotoNext = 2825728
    			_ = gotoNext == 2825728
    			r_2825676 = unicode.SimpleFold(r_2825676)
    			gotoNext = 2825706
    		} else {
    			gotoNext = 2825765
    		}
    		_ = gotoNext == 2825765
    		if r_2825676 == tr_2824921 {
    			gotoNext = 2825776
    			_ = gotoNext == 2825776
    			_ = 0
    			gotoNext = 2824843
