...
/**
    /|*{
    	...
    	gotoNext = 2879202
    	_ = gotoNext == 2879202
    	if i_2879194 < len(s) && i_2879194 < len(t) {
    		gotoNext = 2879238
    		_ = gotoNext == 2879238
    		sr_2879242 = s[i_2879194]
    		tr_2879255 = t[i_2879194]
    		if sr_2879242|tr_2879255 >= 128 {
    			gotoNext = 2879294
    			_ = gotoNext == 2879294
    			gotoNext = 2879652
    			gotoNext = 2879338
    		...
    		if tr_2879255 < sr_2879242 {
    			gotoNext = 2879426
    			_ = gotoNext == 2879426
    			tr_2879255, sr_2879242 = sr_2879242, tr_2879255
    			gotoNext = 2879501
    		} else {
    			gotoNext = 2879501
    		}
    		_ = gotoNext == 2879501
    		if 65 <= sr_2879242 && sr_2879242 <= 90 && tr_2879255 == sr_2879242+97-65 {
    			gotoNext = 2879547
    			_ = gotoNext == 2879547
    			i_2879194++
    			gotoNext = 2879202
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			...
    			gotoNext = 2879839
    			_ = gotoNext == 2879839
    			r_2879844, size_2879847 = utf8.DecodeRune(s)
    			sr_2879761, s = r_2879844, s[size_2879847:]
    			_ = 0
    			gotoNext = 2879903
    		}
    		_ = gotoNext == 2879903
    		if t[0] < 128 {
    			...
    			gotoNext = 2879967
    			_ = gotoNext == 2879967
    			r_2879972, size_2879975 = utf8.DecodeRune(t)
    			tr_2879765, t = r_2879972, t[size_2879975:]
    			_ = 0
    			gotoNext = 2880103
    		}
    		_ = gotoNext == 2880103
    		if tr_2879765 == sr_2879761 {
    			gotoNext = 2880115
    			_ = gotoNext == 2880115
    			_ = 0
    			gotoNext = 2879687
    		...
    		if tr_2879765 < sr_2879761 {
    			gotoNext = 2880191
    			_ = gotoNext == 2880191
    			tr_2879765, sr_2879761 = sr_2879761, tr_2879765
    			gotoNext = 2880245
    		} else {
    			gotoNext = 2880245
    		}
    		...
    		if tr_2879765 < 128 {
    			gotoNext = 2880267
    			_ = gotoNext == 2880267
    			if 65 <= sr_2879761 && sr_2879761 <= 90 && tr_2879765 == sr_2879761+97-65 {
    				gotoNext = 2880367
    				_ = gotoNext == 2880367
    				_ = 0
    				gotoNext = 2879687
    		...
    		_ = gotoNext == 2880520
    		r_2880520 = unicode.SimpleFold(sr_2879761)
    		_ = 0
    		gotoNext = 2880550
    		_ = gotoNext == 2880550
    		if r_2880520 != sr_2879761 && r_2880520 < tr_2879765 {
    			gotoNext = 2880572
    			_ = gotoNext == 2880572
    			r_2880520 = unicode.SimpleFold(r_2880520)
    			gotoNext = 2880550
    		} else {
    			gotoNext = 2880609
    		}
    		_ = gotoNext == 2880609
    		if r_2880520 == tr_2879765 {
    			gotoNext = 2880620
    			_ = gotoNext == 2880620
    			_ = 0
    			gotoNext = 2879687
