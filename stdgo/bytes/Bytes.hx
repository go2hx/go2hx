...
/**
    /|*{
    	...
    	gotoNext = 2949657
    	_ = gotoNext == 2949657
    	if i_2949649 < len(s) && i_2949649 < len(t) {
    		gotoNext = 2949693
    		_ = gotoNext == 2949693
    		sr_2949697 = s[i_2949649]
    		tr_2949710 = t[i_2949649]
    		if sr_2949697|tr_2949710 >= 128 {
    			gotoNext = 2949749
    			_ = gotoNext == 2949749
    			gotoNext = 2950107
    			gotoNext = 2949793
    		...
    		if tr_2949710 < sr_2949697 {
    			gotoNext = 2949881
    			_ = gotoNext == 2949881
    			tr_2949710, sr_2949697 = sr_2949697, tr_2949710
    			gotoNext = 2949956
    		} else {
    			gotoNext = 2949956
    		}
    		_ = gotoNext == 2949956
    		if 65 <= sr_2949697 && sr_2949697 <= 90 && tr_2949710 == sr_2949697+97-65 {
    			gotoNext = 2950002
    			_ = gotoNext == 2950002
    			i_2949649++
    			gotoNext = 2949657
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			...
    			gotoNext = 2950294
    			_ = gotoNext == 2950294
    			r_2950299, size_2950302 = utf8.DecodeRune(s)
    			sr_2950216, s = r_2950299, s[size_2950302:]
    			_ = 0
    			gotoNext = 2950358
    		}
    		_ = gotoNext == 2950358
    		if t[0] < 128 {
    			...
    			gotoNext = 2950422
    			_ = gotoNext == 2950422
    			r_2950427, size_2950430 = utf8.DecodeRune(t)
    			tr_2950220, t = r_2950427, t[size_2950430:]
    			_ = 0
    			gotoNext = 2950558
    		}
    		_ = gotoNext == 2950558
    		if tr_2950220 == sr_2950216 {
    			gotoNext = 2950570
    			_ = gotoNext == 2950570
    			_ = 0
    			gotoNext = 2950142
    		...
    		if tr_2950220 < sr_2950216 {
    			gotoNext = 2950646
    			_ = gotoNext == 2950646
    			tr_2950220, sr_2950216 = sr_2950216, tr_2950220
    			gotoNext = 2950700
    		} else {
    			gotoNext = 2950700
    		}
    		...
    		if tr_2950220 < 128 {
    			gotoNext = 2950722
    			_ = gotoNext == 2950722
    			if 65 <= sr_2950216 && sr_2950216 <= 90 && tr_2950220 == sr_2950216+97-65 {
    				gotoNext = 2950822
    				_ = gotoNext == 2950822
    				_ = 0
    				gotoNext = 2950142
    		...
    		_ = gotoNext == 2950975
    		r_2950975 = unicode.SimpleFold(sr_2950216)
    		_ = 0
    		gotoNext = 2951005
    		_ = gotoNext == 2951005
    		if r_2950975 != sr_2950216 && r_2950975 < tr_2950220 {
    			gotoNext = 2951027
    			_ = gotoNext == 2951027
    			r_2950975 = unicode.SimpleFold(r_2950975)
    			gotoNext = 2951005
    		} else {
    			gotoNext = 2951064
    		}
    		_ = gotoNext == 2951064
    		if r_2950975 == tr_2950220 {
    			gotoNext = 2951075
    			_ = gotoNext == 2951075
    			_ = 0
    			gotoNext = 2950142
