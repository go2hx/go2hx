...
/**
    /|*{
    	...
    	gotoNext = 2959449
    	_ = gotoNext == 2959449
    	if i_2959441 < len(s) && i_2959441 < len(t) {
    		gotoNext = 2959485
    		_ = gotoNext == 2959485
    		sr_2959489 = s[i_2959441]
    		tr_2959502 = t[i_2959441]
    		if sr_2959489|tr_2959502 >= 128 {
    			gotoNext = 2959541
    			_ = gotoNext == 2959541
    			gotoNext = 2959899
    			gotoNext = 2959585
    		...
    		if tr_2959502 < sr_2959489 {
    			gotoNext = 2959673
    			_ = gotoNext == 2959673
    			tr_2959502, sr_2959489 = sr_2959489, tr_2959502
    			gotoNext = 2959748
    		} else {
    			gotoNext = 2959748
    		}
    		_ = gotoNext == 2959748
    		if 65 <= sr_2959489 && sr_2959489 <= 90 && tr_2959502 == sr_2959489+97-65 {
    			gotoNext = 2959794
    			_ = gotoNext == 2959794
    			i_2959441++
    			gotoNext = 2959449
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			gotoNext = 2960046
    			_ = gotoNext == 2960046
    			sr_2960008, s = rune(s[0]), s[1:]
    			gotoNext = 2960150
    		} else {
    			gotoNext = 2960086
    			_ = gotoNext == 2960086
    			r_2960091, size_2960094 = utf8.DecodeRune(s)
    			sr_2960008, s = r_2960091, s[size_2960094:]
    			_ = 0
    			gotoNext = 2960150
    		}
    		_ = gotoNext == 2960150
    		if t[0] < 128 {
    			gotoNext = 2960174
    			_ = gotoNext == 2960174
    			tr_2960012, t = rune(t[0]), t[1:]
    			gotoNext = 2960350
    		} else {
    			gotoNext = 2960214
    			_ = gotoNext == 2960214
    			r_2960219, size_2960222 = utf8.DecodeRune(t)
    			tr_2960012, t = r_2960219, t[size_2960222:]
    			_ = 0
    			gotoNext = 2960350
    		}
    		_ = gotoNext == 2960350
    		if tr_2960012 == sr_2960008 {
    			gotoNext = 2960362
    			_ = gotoNext == 2960362
    			_ = 0
    			gotoNext = 2959934
    		...
    		if tr_2960012 < sr_2960008 {
    			gotoNext = 2960438
    			_ = gotoNext == 2960438
    			tr_2960012, sr_2960008 = sr_2960008, tr_2960012
    			gotoNext = 2960492
    		} else {
    			gotoNext = 2960492
    		}
    		...
    		if tr_2960012 < 128 {
    			gotoNext = 2960514
    			_ = gotoNext == 2960514
    			if 65 <= sr_2960008 && sr_2960008 <= 90 && tr_2960012 == sr_2960008+97-65 {
    				gotoNext = 2960614
    				_ = gotoNext == 2960614
    				_ = 0
    				gotoNext = 2959934
    		...
    		_ = gotoNext == 2960767
    		r_2960767 = unicode.SimpleFold(sr_2960008)
    		_ = 0
    		gotoNext = 2960797
    		_ = gotoNext == 2960797
    		if r_2960767 != sr_2960008 && r_2960767 < tr_2960012 {
    			gotoNext = 2960819
    			_ = gotoNext == 2960819
    			r_2960767 = unicode.SimpleFold(r_2960767)
    			gotoNext = 2960797
    		} else {
    			gotoNext = 2960856
    		}
    		_ = gotoNext == 2960856
    		if r_2960767 == tr_2960012 {
    			gotoNext = 2960867
    			_ = gotoNext == 2960867
    			_ = 0
    			gotoNext = 2959934
