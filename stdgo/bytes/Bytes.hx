...
/**
    /|*{
    	...
    	gotoNext = 2763556
    	_ = gotoNext == 2763556
    	if i_2763548 < len(s) && i_2763548 < len(t) {
    		gotoNext = 2763592
    		_ = gotoNext == 2763592
    		sr_2763596 = s[i_2763548]
    		tr_2763609 = t[i_2763548]
    		if sr_2763596|tr_2763609 >= 128 {
    			gotoNext = 2763648
    			_ = gotoNext == 2763648
    			gotoNext = 2764006
    			gotoNext = 2763692
    		...
    		if tr_2763609 < sr_2763596 {
    			gotoNext = 2763780
    			_ = gotoNext == 2763780
    			tr_2763609, sr_2763596 = sr_2763596, tr_2763609
    			gotoNext = 2763855
    		} else {
    			gotoNext = 2763855
    		}
    		_ = gotoNext == 2763855
    		if 65 <= sr_2763596 && sr_2763596 <= 90 && tr_2763609 == sr_2763596+97-65 {
    			gotoNext = 2763901
    			_ = gotoNext == 2763901
    			i_2763548++
    			gotoNext = 2763556
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			...
    			gotoNext = 2764193
    			_ = gotoNext == 2764193
    			r_2764198, size_2764201 = utf8.DecodeRune(s)
    			sr_2764115, s = r_2764198, s[size_2764201:]
    			_ = 0
    			gotoNext = 2764257
    		}
    		_ = gotoNext == 2764257
    		if t[0] < 128 {
    			...
    			gotoNext = 2764321
    			_ = gotoNext == 2764321
    			r_2764326, size_2764329 = utf8.DecodeRune(t)
    			tr_2764119, t = r_2764326, t[size_2764329:]
    			_ = 0
    			gotoNext = 2764457
    		}
    		_ = gotoNext == 2764457
    		if tr_2764119 == sr_2764115 {
    			gotoNext = 2764469
    			_ = gotoNext == 2764469
    			_ = 0
    			gotoNext = 2764041
    		...
    		if tr_2764119 < sr_2764115 {
    			gotoNext = 2764545
    			_ = gotoNext == 2764545
    			tr_2764119, sr_2764115 = sr_2764115, tr_2764119
    			gotoNext = 2764599
    		} else {
    			gotoNext = 2764599
    		}
    		...
    		if tr_2764119 < 128 {
    			gotoNext = 2764621
    			_ = gotoNext == 2764621
    			if 65 <= sr_2764115 && sr_2764115 <= 90 && tr_2764119 == sr_2764115+97-65 {
    				gotoNext = 2764721
    				_ = gotoNext == 2764721
    				_ = 0
    				gotoNext = 2764041
    		...
    		_ = gotoNext == 2764874
    		r_2764874 = unicode.SimpleFold(sr_2764115)
    		_ = 0
    		gotoNext = 2764904
    		_ = gotoNext == 2764904
    		if r_2764874 != sr_2764115 && r_2764874 < tr_2764119 {
    			gotoNext = 2764926
    			_ = gotoNext == 2764926
    			r_2764874 = unicode.SimpleFold(r_2764874)
    			gotoNext = 2764904
    		} else {
    			gotoNext = 2764963
    		}
    		_ = gotoNext == 2764963
    		if r_2764874 == tr_2764119 {
    			gotoNext = 2764974
    			_ = gotoNext == 2764974
    			_ = 0
    			gotoNext = 2764041
