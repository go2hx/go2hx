...
/**
    /|*{
    	...
    	gotoNext = 3020164
    	_ = gotoNext == 3020164
    	if i_3020156 < len(s) && i_3020156 < len(t) {
    		gotoNext = 3020200
    		_ = gotoNext == 3020200
    		sr_3020204 = s[i_3020156]
    		tr_3020217 = t[i_3020156]
    		if sr_3020204|tr_3020217 >= 128 {
    			gotoNext = 3020256
    			_ = gotoNext == 3020256
    			gotoNext = 3020614
    			gotoNext = 3020300
    		...
    		if tr_3020217 < sr_3020204 {
    			gotoNext = 3020388
    			_ = gotoNext == 3020388
    			tr_3020217, sr_3020204 = sr_3020204, tr_3020217
    			gotoNext = 3020463
    		} else {
    			gotoNext = 3020463
    		}
    		_ = gotoNext == 3020463
    		if 65 <= sr_3020204 && sr_3020204 <= 90 && tr_3020217 == sr_3020204+97-65 {
    			gotoNext = 3020509
    			_ = gotoNext == 3020509
    			i_3020156++
    			gotoNext = 3020164
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			...
    			gotoNext = 3020801
    			_ = gotoNext == 3020801
    			r_3020806, size_3020809 = utf8.DecodeRune(s)
    			sr_3020723, s = r_3020806, s[size_3020809:]
    			_ = 0
    			gotoNext = 3020865
    		}
    		_ = gotoNext == 3020865
    		if t[0] < 128 {
    			...
    			gotoNext = 3020929
    			_ = gotoNext == 3020929
    			r_3020934, size_3020937 = utf8.DecodeRune(t)
    			tr_3020727, t = r_3020934, t[size_3020937:]
    			_ = 0
    			gotoNext = 3021065
    		}
    		_ = gotoNext == 3021065
    		if tr_3020727 == sr_3020723 {
    			gotoNext = 3021077
    			_ = gotoNext == 3021077
    			_ = 0
    			gotoNext = 3020649
    		...
    		if tr_3020727 < sr_3020723 {
    			gotoNext = 3021153
    			_ = gotoNext == 3021153
    			tr_3020727, sr_3020723 = sr_3020723, tr_3020727
    			gotoNext = 3021207
    		} else {
    			gotoNext = 3021207
    		}
    		...
    		if tr_3020727 < 128 {
    			gotoNext = 3021229
    			_ = gotoNext == 3021229
    			if 65 <= sr_3020723 && sr_3020723 <= 90 && tr_3020727 == sr_3020723+97-65 {
    				gotoNext = 3021329
    				_ = gotoNext == 3021329
    				_ = 0
    				gotoNext = 3020649
    		...
    		_ = gotoNext == 3021482
    		r_3021482 = unicode.SimpleFold(sr_3020723)
    		_ = 0
    		gotoNext = 3021512
    		_ = gotoNext == 3021512
    		if r_3021482 != sr_3020723 && r_3021482 < tr_3020727 {
    			gotoNext = 3021534
    			_ = gotoNext == 3021534
    			r_3021482 = unicode.SimpleFold(r_3021482)
    			gotoNext = 3021512
    		} else {
    			gotoNext = 3021571
    		}
    		_ = gotoNext == 3021571
    		if r_3021482 == tr_3020727 {
    			gotoNext = 3021582
    			_ = gotoNext == 3021582
    			_ = 0
    			gotoNext = 3020649
