...
@:structInit @:using(stdgo.bytes.Bytes.Buffer_static_extension) class Buffer {
    ...
    public var _lastRead : stdgo.bytes.Bytes.T_readOp = ((0 : stdgo.GoInt8) : stdgo.bytes.Bytes.T_readOp);
    public function new(?_buf:stdgo.Slice<stdgo.GoUInt8>, ?_off:stdgo.GoInt, ?_lastRead:stdgo.bytes.Bytes.T_readOp) {
...
**/
@:named @:using(stdgo.bytes.Bytes.T_asciiSet_static_extension) typedef T_asciiSet = stdgo.GoArray<stdgo.GoUInt32>;
/**
...
function _growSlice(_b:stdgo.Slice<stdgo.GoByte>, _n:stdgo.GoInt):stdgo.Slice<stdgo.GoByte> {
        ...
        try {
            ...
            var _c:stdgo.GoInt = (_b.length) + _n;
            if (_c < ((2 : stdgo.GoInt) * _b.capacity)) {
                _c = (2 : stdgo.GoInt) * _b.capacity;
            };
...
function newBuffer(_buf:stdgo.Slice<stdgo.GoByte>):stdgo.Ref<Buffer> {
        return (stdgo.Go.setRef(({ _buf : _buf } : stdgo.bytes.Bytes.Buffer)) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>);
    }
/**
...
function newBufferString(_s:stdgo.GoString):stdgo.Ref<Buffer> {
        return (stdgo.Go.setRef(({ _buf : (_s : stdgo.Slice<stdgo.GoByte>) } : stdgo.bytes.Bytes.Buffer)) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>);
    }
/**
...
function _explode(_s:stdgo.Slice<stdgo.GoByte>, _n:stdgo.GoInt):stdgo.Slice<stdgo.Slice<stdgo.GoByte>> {
        if ((_n <= (0 : stdgo.GoInt)) || (_n > _s.length)) {
            _n = (_s.length);
        };
        var _a = new stdgo.Slice<stdgo.Slice<stdgo.GoUInt8>>((_n : stdgo.GoInt).toBasic(), 0);
        var _size:stdgo.GoInt = (0 : stdgo.GoInt);
        var _na:stdgo.GoInt = (0 : stdgo.GoInt);
        while ((_s.length) > (0 : stdgo.GoInt)) {
            if ((_na + (1 : stdgo.GoInt)) >= _n) {
...
function count(_s:stdgo.Slice<stdgo.GoByte>, _sep:stdgo.Slice<stdgo.GoByte>):stdgo.GoInt {
        if ((_sep.length) == ((0 : stdgo.GoInt))) {
            return stdgo.unicode.utf8.Utf8.runeCount(_s) + (1 : stdgo.GoInt);
        };
        if ((_sep.length) == ((1 : stdgo.GoInt))) {
            return stdgo.internal.bytealg.Bytealg.count(_s, _sep[(0 : stdgo.GoInt)]);
        };
        ...
        while (true) {
            ...
            _n++;
            _s = (_s.__slice__(_i + (_sep.length)) : stdgo.Slice<stdgo.GoUInt8>);
        };
    }
/**
...
function lastIndex(_s:stdgo.Slice<stdgo.GoByte>, _sep:stdgo.Slice<stdgo.GoByte>):stdgo.GoInt {
        ...
        var __tmp__ = stdgo.internal.bytealg.Bytealg.hashStrRevBytes(_sep), _hashss:stdgo.GoUInt32 = __tmp__._0, _pow:stdgo.GoUInt32 = __tmp__._1;
        ...
        if ((_h == _hashss) && equal((_s.__slice__(_last) : stdgo.Slice<stdgo.GoUInt8>), _sep)) {
            return _last;
        };
        {
            ...
            stdgo.Go.cfor(_i >= (0 : stdgo.GoInt), _i--, {
                ...
                if ((_h == _hashss) && equal((_s.__slice__(_i, _i + _n) : stdgo.Slice<stdgo.GoUInt8>), _sep)) {
                    return _i;
                };
            });
        };
...
function indexRune(_s:stdgo.Slice<stdgo.GoByte>, _r:stdgo.GoRune):stdgo.GoInt {
        if (((0 : stdgo.GoInt32) <= _r) && (_r < (128 : stdgo.GoInt32))) {
        ...
        } else if (_r == ((65533 : stdgo.GoInt32))) {
            {
                ...
                while (_i < (_s.length)) {
                    var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRune((_s.__slice__(_i) : stdgo.Slice<stdgo.GoUInt8>)), _r1:stdgo.GoInt32 = __tmp__._0, _n:stdgo.GoInt = __tmp__._1;
            ...
            var _n:stdgo.GoInt = stdgo.unicode.utf8.Utf8.encodeRune((_b.__slice__(0) : stdgo.Slice<stdgo.GoUInt8>), _r);
...
function indexAny(_s:stdgo.Slice<stdgo.GoByte>, _chars:stdgo.GoString):stdgo.GoInt {
        ...
        if ((_s.length) == ((1 : stdgo.GoInt))) {
            ...
            if (stdgo.internal.bytealg.Bytealg.indexByteString(_chars?.__copy__(), _s[(0 : stdgo.GoInt)]) >= (0 : stdgo.GoInt)) {
                return (0 : stdgo.GoInt);
            };
            return (-1 : stdgo.GoInt);
        };
        ...
        var _width:stdgo.GoInt = (0 : stdgo.GoInt);
        {
            ...
            stdgo.Go.cfor(_i < (_s.length), _i = _i + (_width), {
                ...
                if (_r < (128 : stdgo.GoInt32)) {
                    if (stdgo.internal.bytealg.Bytealg.indexByteString(_chars?.__copy__(), _s[(_i : stdgo.GoInt)]) >= (0 : stdgo.GoInt)) {
                        return _i;
                    };
                ...
                {
                    var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRune((_s.__slice__(_i) : stdgo.Slice<stdgo.GoUInt8>));
                    _r = __tmp__._0;
                    _width = __tmp__._1;
                };
                if (_r != ((65533 : stdgo.GoInt32))) {
                    ...
                    if (stdgo.internal.bytealg.Bytealg.maxLen >= _width) {
                        if (stdgo.internal.bytealg.Bytealg.indexString(_chars?.__copy__(), (_r : stdgo.GoString)?.__copy__()) >= (0 : stdgo.GoInt)) {
                            return _i;
                        };
                        continue;
                    };
...
function lastIndexAny(_s:stdgo.Slice<stdgo.GoByte>, _chars:stdgo.GoString):stdgo.GoInt {
        ...
        if ((_chars.length) == ((1 : stdgo.GoInt))) {
            ...
            if (_cr >= (128 : stdgo.GoInt32)) {
                _cr = (65533 : stdgo.GoInt32);
            };
            {
                var _i:stdgo.GoInt = (_s.length);
                while (_i > (0 : stdgo.GoInt)) {
                    var __tmp__ = stdgo.unicode.utf8.Utf8.decodeLastRune((_s.__slice__(0, _i) : stdgo.Slice<stdgo.GoUInt8>)), _r:stdgo.GoInt32 = __tmp__._0, _size:stdgo.GoInt = __tmp__._1;
                    _i = _i - (_size);
                    if (_r == (_cr)) {
                        return _i;
                    };
        ...
        };
        {
            ...
            while (_i > (0 : stdgo.GoInt)) {
                ...
                if (_r < (128 : stdgo.GoInt32)) {
                    if (stdgo.internal.bytealg.Bytealg.indexByteString(_chars?.__copy__(), _s[(_i - (1 : stdgo.GoInt) : stdgo.GoInt)]) >= (0 : stdgo.GoInt)) {
...
function _genSplit(_s:stdgo.Slice<stdgo.GoByte>, _sep:stdgo.Slice<stdgo.GoByte>, _sepSave:stdgo.GoInt, _n:stdgo.GoInt):stdgo.Slice<stdgo.Slice<stdgo.GoByte>> {
        ...
        if (_n < (0 : stdgo.GoInt)) {
            _n = count(_s, _sep) + (1 : stdgo.GoInt);
        };
        ...
        while (_i < _n) {
            ...
            _a[(_i : stdgo.GoInt)] = (_s.__slice__(0, _m + _sepSave, _m + _sepSave) : stdgo.Slice<stdgo.GoUInt8>);
            _s = (_s.__slice__(_m + (_sep.length)) : stdgo.Slice<stdgo.GoUInt8>);
            _i++;
        };
        _a[(_i : stdgo.GoInt)] = _s;
        return (_a.__slice__(0, _i + (1 : stdgo.GoInt)) : stdgo.Slice<stdgo.Slice<stdgo.GoUInt8>>);
    }
/**
...
function join(_s:stdgo.Slice<stdgo.Slice<stdgo.GoByte>>, _sep:stdgo.Slice<stdgo.GoByte>):stdgo.Slice<stdgo.GoByte> {
        ...
        var _n:stdgo.GoInt = (0 : stdgo.GoInt);
        if ((_sep.length) > (0 : stdgo.GoInt)) {
            if ((_sep.length) >= ((2147483647 : stdgo.GoInt) / (_s.length - (1 : stdgo.GoInt)))) {
                throw stdgo.Go.toInterface(("bytes: Join output length overflow" : stdgo.GoString));
            };
            _n = _n + (_sep.length * (_s.length - (1 : stdgo.GoInt)));
        };
        for (__0 => _v in _s) {
            if ((_v.length) > ((2147483647 : stdgo.GoInt) - _n)) {
                throw stdgo.Go.toInterface(("bytes: Join output length overflow" : stdgo.GoString));
            };
            _n = _n + ((_v.length));
        };
        ...
        for (__1 => _v in (_s.__slice__((1 : stdgo.GoInt)) : stdgo.Slice<stdgo.Slice<stdgo.GoUInt8>>)) {
            _bp = _bp + (stdgo.Go.copySlice((_b.__slice__(_bp) : stdgo.Slice<stdgo.GoUInt8>), _sep));
            _bp = _bp + (stdgo.Go.copySlice((_b.__slice__(_bp) : stdgo.Slice<stdgo.GoUInt8>), _v));
        };
        return _b;
    }
/**
...
function hasPrefix(_s:stdgo.Slice<stdgo.GoByte>, _prefix:stdgo.Slice<stdgo.GoByte>):Bool {
        return (_s.length >= _prefix.length) && equal((_s.__slice__((0 : stdgo.GoInt), (_prefix.length)) : stdgo.Slice<stdgo.GoUInt8>), _prefix);
    }
/**
    // HasSuffix tests whether the byte slice s ends with suffix.
**/
function hasSuffix(_s:stdgo.Slice<stdgo.GoByte>, _suffix:stdgo.Slice<stdgo.GoByte>):Bool {
        return (_s.length >= _suffix.length) && equal((_s.__slice__((_s.length) - (_suffix.length)) : stdgo.Slice<stdgo.GoUInt8>), _suffix);
    }
/**
...
function map_(_mapping:(_r:stdgo.GoRune) -> stdgo.GoRune, _s:stdgo.Slice<stdgo.GoByte>):stdgo.Slice<stdgo.GoByte> {
        var _b = new stdgo.Slice<stdgo.GoUInt8>((0 : stdgo.GoInt).toBasic(), (_s.length)).__setNumber32__();
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            while (_i < (_s.length)) {
...
function repeat(_b:stdgo.Slice<stdgo.GoByte>, _count:stdgo.GoInt):stdgo.Slice<stdgo.GoByte> {
        ...
        if ((_b.length) >= ((2147483647 : stdgo.GoInt) / _count)) {
            throw stdgo.Go.toInterface(("bytes: Repeat output length overflow" : stdgo.GoString));
        };
        var _n:stdgo.GoInt = (_b.length) * _count;
        if ((_b.length) == ((0 : stdgo.GoInt))) {
            return (new stdgo.Slice<stdgo.GoUInt8>(0, 0) : stdgo.Slice<stdgo.GoUInt8>);
        };
        {};
        var _chunkMax:stdgo.GoInt = _n;
        if (_chunkMax > (8192 : stdgo.GoInt)) {
            _chunkMax = ((8192 : stdgo.GoInt) / _b.length) * (_b.length);
        ...
        while (_bp < _n) {
            ...
            _bp = _bp + (stdgo.Go.copySlice((_nb.__slice__(_bp) : stdgo.Slice<stdgo.GoUInt8>), (_nb.__slice__(0, _chunk) : stdgo.Slice<stdgo.GoUInt8>)));
        };
        return _nb;
    }
/**
...
**/
function toUpperSpecial(_c:stdgo.unicode.Unicode.SpecialCase, _s:stdgo.Slice<stdgo.GoByte>):stdgo.Slice<stdgo.GoByte> {
...
**/
function toLowerSpecial(_c:stdgo.unicode.Unicode.SpecialCase, _s:stdgo.Slice<stdgo.GoByte>):stdgo.Slice<stdgo.GoByte> {
...
**/
function toTitleSpecial(_c:stdgo.unicode.Unicode.SpecialCase, _s:stdgo.Slice<stdgo.GoByte>):stdgo.Slice<stdgo.GoByte> {
...
function toValidUTF8(_s:stdgo.Slice<stdgo.GoByte>, _replacement:stdgo.Slice<stdgo.GoByte>):stdgo.Slice<stdgo.GoByte> {
        var _b = new stdgo.Slice<stdgo.GoUInt8>((0 : stdgo.GoInt).toBasic(), (_s.length) + (_replacement.length)).__setNumber32__();
        var _invalid:Bool = false;
        {
            ...
            while (_i < (_s.length)) {
                ...
                var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRune((_s.__slice__(_i) : stdgo.Slice<stdgo.GoUInt8>)), __0:stdgo.GoInt32 = __tmp__._0, _wid:stdgo.GoInt = __tmp__._1;
                ...
                _invalid = false;
                _b = (_b.__append__(...(_s.__slice__(_i, _i + _wid) : stdgo.Slice<stdgo.GoUInt8>).__toArray__()));
                _i = _i + (_wid);
            };
        };
        return _b;
...
function trimSuffix(_s:stdgo.Slice<stdgo.GoByte>, _suffix:stdgo.Slice<stdgo.GoByte>):stdgo.Slice<stdgo.GoByte> {
        if (hasSuffix(_s, _suffix)) {
            return (_s.__slice__(0, (_s.length) - (_suffix.length)) : stdgo.Slice<stdgo.GoUInt8>);
        };
        return _s;
    }
/**
...
function _indexFunc(_s:stdgo.Slice<stdgo.GoByte>, _f:(_r:stdgo.GoRune) -> Bool, _truth:Bool):stdgo.GoInt {
        ...
        while (_start < (_s.length)) {
            ...
            if (_r >= (128 : stdgo.GoInt32)) {
                {
                    var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRune((_s.__slice__(_start) : stdgo.Slice<stdgo.GoUInt8>));
                    _r = __tmp__._0;
                    _wid = __tmp__._1;
                };
            };
...
function _lastIndexFunc(_s:stdgo.Slice<stdgo.GoByte>, _f:(_r:stdgo.GoRune) -> Bool, _truth:Bool):stdgo.GoInt {
        {
            ...
            while (_i > (0 : stdgo.GoInt)) {
                ...
                if (_r >= (128 : stdgo.GoInt32)) {
                    {
                        var __tmp__ = stdgo.unicode.utf8.Utf8.decodeLastRune((_s.__slice__((0 : stdgo.GoInt), _i) : stdgo.Slice<stdgo.GoUInt8>));
                        _r = __tmp__._0;
                        _size = __tmp__._1;
                    };
                };
...
function _makeASCIISet(_chars:stdgo.GoString):{ var _0 : T_asciiSet; var _1 : Bool; } {
        var _as:T_asciiSet = new stdgo.bytes.Bytes.T_asciiSet(...[for (i in 0 ... 8) (0 : stdgo.GoUInt32)]), _ok:Bool = false;
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
...
function trim(_s:stdgo.Slice<stdgo.GoByte>, _cutset:stdgo.GoString):stdgo.Slice<stdgo.GoByte> {
        ...
        };
        {
            ...
            if (_ok) {
                return _trimLeftASCII(_trimRightASCII(_s, (stdgo.Go.setRef(_as) : stdgo.Ref<stdgo.bytes.Bytes.T_asciiSet>)), (stdgo.Go.setRef(_as) : stdgo.Ref<stdgo.bytes.Bytes.T_asciiSet>));
            };
        };
...
function trimLeft(_s:stdgo.Slice<stdgo.GoByte>, _cutset:stdgo.GoString):stdgo.Slice<stdgo.GoByte> {
        ...
        };
        {
            var __tmp__ = _makeASCIISet(_cutset?.__copy__()), _as:stdgo.bytes.Bytes.T_asciiSet = __tmp__._0, _ok:Bool = __tmp__._1;
            if (_ok) {
                return _trimLeftASCII(_s, (stdgo.Go.setRef(_as) : stdgo.Ref<stdgo.bytes.Bytes.T_asciiSet>));
            };
        };
...
function trimRight(_s:stdgo.Slice<stdgo.GoByte>, _cutset:stdgo.GoString):stdgo.Slice<stdgo.GoByte> {
        if ((_s.length == (0 : stdgo.GoInt)) || (_cutset == stdgo.Go.str())) {
            return _s;
        };
        if ((_cutset.length == (1 : stdgo.GoInt)) && (_cutset[(0 : stdgo.GoInt)] < (128 : stdgo.GoUInt8))) {
        ...
        };
        {
            var __tmp__ = _makeASCIISet(_cutset?.__copy__()), _as:stdgo.bytes.Bytes.T_asciiSet = __tmp__._0, _ok:Bool = __tmp__._1;
            if (_ok) {
                return _trimRightASCII(_s, (stdgo.Go.setRef(_as) : stdgo.Ref<stdgo.bytes.Bytes.T_asciiSet>));
            };
        };
...
function _trimRightByte(_s:stdgo.Slice<stdgo.GoByte>, _c:stdgo.GoByte):stdgo.Slice<stdgo.GoByte> {
        while ((_s.length > (0 : stdgo.GoInt)) && (_s[((_s.length) - (1 : stdgo.GoInt) : stdgo.GoInt)] == _c)) {
            _s = (_s.__slice__(0, (_s.length) - (1 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>);
        };
        return _s;
    }
...
function _trimRightUnicode(_s:stdgo.Slice<stdgo.GoByte>, _cutset:stdgo.GoString):stdgo.Slice<stdgo.GoByte> {
        while ((_s.length) > (0 : stdgo.GoInt)) {
            ...
            _s = (_s.__slice__(0, (_s.length) - _n) : stdgo.Slice<stdgo.GoUInt8>);
        };
        return _s;
    }
/**
...
function trimSpace(_s:stdgo.Slice<stdgo.GoByte>):stdgo.Slice<stdgo.GoByte> {
        ...
        stdgo.Go.cfor(_start < (_s.length), _start++, {
            ...
            if (_c >= (128 : stdgo.GoUInt8)) {
                return trimFunc((_s.__slice__(_start) : stdgo.Slice<stdgo.GoUInt8>), stdgo.unicode.Unicode.isSpace);
            };
        ...
        stdgo.Go.cfor(_stop > _start, _stop--, {
            ...
            if (_c >= (128 : stdgo.GoUInt8)) {
                return trimFunc((_s.__slice__(_start, _stop) : stdgo.Slice<stdgo.GoUInt8>), stdgo.unicode.Unicode.isSpace);
            };
            if (_asciiSpace[(_c : stdgo.GoInt)] == ((0 : stdgo.GoUInt8))) {
                break;
            };
...
function runes(_s:stdgo.Slice<stdgo.GoByte>):stdgo.Slice<stdgo.GoRune> {
        var _t = new stdgo.Slice<stdgo.GoInt32>((stdgo.unicode.utf8.Utf8.runeCount(_s) : stdgo.GoInt).toBasic(), 0).__setNumber32__();
        var _i:stdgo.GoInt = (0 : stdgo.GoInt);
        while ((_s.length) > (0 : stdgo.GoInt)) {
            var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRune(_s), _r:stdgo.GoInt32 = __tmp__._0, _l:stdgo.GoInt = __tmp__._1;
...
function replace(_s:stdgo.Slice<stdgo.GoByte>, _old:stdgo.Slice<stdgo.GoByte>, _new:stdgo.Slice<stdgo.GoByte>, _n:stdgo.GoInt):stdgo.Slice<stdgo.GoByte> {
        ...
        if ((_n < (0 : stdgo.GoInt)) || (_m < _n)) {
            _n = _m;
        };
        var _t = new stdgo.Slice<stdgo.GoUInt8>(((_s.length) + (_n * (_new.length - _old.length)) : stdgo.GoInt).toBasic(), 0).__setNumber32__();
        ...
        var _start:stdgo.GoInt = (0 : stdgo.GoInt);
        {
            ...
            stdgo.Go.cfor(_i < _n, _i++, {
                ...
                if ((_old.length) == ((0 : stdgo.GoInt))) {
                    if (_i > (0 : stdgo.GoInt)) {
                        var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRune((_s.__slice__(_start) : stdgo.Slice<stdgo.GoUInt8>)), __0:stdgo.GoInt32 = __tmp__._0, _wid:stdgo.GoInt = __tmp__._1;
                        _j = _j + (_wid);
                    };
                } else {
                    _j = _j + (index((_s.__slice__(_start) : stdgo.Slice<stdgo.GoUInt8>), _old));
                };
                _w = _w + (stdgo.Go.copySlice((_t.__slice__(_w) : stdgo.Slice<stdgo.GoUInt8>), (_s.__slice__(_start, _j) : stdgo.Slice<stdgo.GoUInt8>)));
                _w = _w + (stdgo.Go.copySlice((_t.__slice__(_w) : stdgo.Slice<stdgo.GoUInt8>), _new));
                _start = _j + (_old.length);
            });
        };
        _w = _w + (stdgo.Go.copySlice((_t.__slice__(_w) : stdgo.Slice<stdgo.GoUInt8>), (_s.__slice__(_start) : stdgo.Slice<stdgo.GoUInt8>)));
        ...
        stdgo.internal.Macro.controlFlow({
            ...
            while ((_s.length != (0 : stdgo.GoInt)) && (_t.length != (0 : stdgo.GoInt))) {
                ...
                if (_s[(0 : stdgo.GoInt)] < (128 : stdgo.GoUInt8)) {
                    ...
                    var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRune(_s), _r:stdgo.GoInt32 = __tmp__._0, _size:stdgo.GoInt = __tmp__._1;
                    {
                        final __tmp__0 = _r;
                ...
                if (_t[(0 : stdgo.GoInt)] < (128 : stdgo.GoUInt8)) {
                    ...
                    var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRune(_t), _r:stdgo.GoInt32 = __tmp__._0, _size:stdgo.GoInt = __tmp__._1;
                    {
                        final __tmp__0 = _r;
...
function cut(_s:stdgo.Slice<stdgo.GoByte>, _sep:stdgo.Slice<stdgo.GoByte>):{ var _0 : stdgo.Slice<stdgo.GoByte>; var _1 : stdgo.Slice<stdgo.GoByte>; var _2 : Bool; } {
        var _before:stdgo.Slice<stdgo.GoByte> = (null : stdgo.Slice<stdgo.GoUInt8>), _after:stdgo.Slice<stdgo.GoByte> = (null : stdgo.Slice<stdgo.GoUInt8>), _found:Bool = false;
        {
            var _i:stdgo.GoInt = index(_s, _sep);
            if (_i >= (0 : stdgo.GoInt)) {
                return { _0 : (_s.__slice__(0, _i) : stdgo.Slice<stdgo.GoUInt8>), _1 : (_s.__slice__(_i + (_sep.length)) : stdgo.Slice<stdgo.GoUInt8>), _2 : true };
            };
        };
...
function cutSuffix(_s:stdgo.Slice<stdgo.GoByte>, _suffix:stdgo.Slice<stdgo.GoByte>):{ var _0 : stdgo.Slice<stdgo.GoByte>; var _1 : Bool; } {
        ...
        return { _0 : (_s.__slice__(0, (_s.length) - (_suffix.length)) : stdgo.Slice<stdgo.GoUInt8>), _1 : true };
    }
/**
    // NewReader returns a new Reader reading from b.
**/
function newReader(_b:stdgo.Slice<stdgo.GoByte>):stdgo.Ref<Reader> {
        return (stdgo.Go.setRef((new stdgo.bytes.Bytes.Reader(_b, (0i64 : stdgo.GoInt64), (-1 : stdgo.GoInt)) : stdgo.bytes.Bytes.Reader)) : stdgo.Ref<stdgo.bytes.Bytes.Reader>);
    }
...
@:keep @:allow(stdgo.bytes.Bytes.Buffer_asInterface) class Buffer_static_extension {
    ...
    **/
    ...
    static public function _readSlice( _b:stdgo.Ref<Buffer>, _delim:stdgo.GoByte):{ var _0 : stdgo.Slice<stdgo.GoByte>; var _1 : stdgo.Error; } {
        ...
        var _end:stdgo.GoInt = (_b._off + _i) + (1 : stdgo.GoInt);
        if (_i < (0 : stdgo.GoInt)) {
            _end = (_b._buf.length);
    ...
    **/
    ...
    static public function unreadRune( _b:stdgo.Ref<Buffer>):stdgo.Error {
        ...
        if (_b._off >= (_b._lastRead : stdgo.GoInt)) {
            _b._off = _b._off - ((_b._lastRead : stdgo.GoInt));
        };
        _b._lastRead = (0 : stdgo.bytes.Bytes.T_readOp);
        return (null : stdgo.Error);
    }
    ...
    **/
    ...
    static public function readRune( _b:stdgo.Ref<Buffer>):{ var _0 : stdgo.GoRune; var _1 : stdgo.GoInt; var _2 : stdgo.Error; } {
        ...
        var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRune((_b._buf.__slice__(_b._off) : stdgo.Slice<stdgo.GoUInt8>)), _r:stdgo.GoInt32 = __tmp__._0, _n:stdgo.GoInt = __tmp__._1;
        _b._off = _b._off + (_n);
    ...
    **/
    ...
    static public function next( _b:stdgo.Ref<Buffer>, _n:stdgo.GoInt):stdgo.Slice<stdgo.GoByte> {
        ...
        var _data = (_b._buf.__slice__(_b._off, _b._off + _n) : stdgo.Slice<stdgo.GoUInt8>);
        _b._off = _b._off + (_n);
        if (_n > (0 : stdgo.GoInt)) {
            _b._lastRead = (-1 : stdgo.bytes.Bytes.T_readOp);
        };
    ...
    **/
    ...
    static public function writeRune( _b:stdgo.Ref<Buffer>, _r:stdgo.GoRune):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        @:recv var _b:stdgo.Ref<Buffer> = _b;
        var _n:stdgo.GoInt = (0 : stdgo.GoInt), _err:stdgo.Error = (null : stdgo.Error);
        if ((_r : stdgo.GoUInt32) < (128u32 : stdgo.GoUInt32)) {
        ...
        _b._buf = stdgo.unicode.utf8.Utf8.appendRune((_b._buf.__slice__(0, _m) : stdgo.Slice<stdgo.GoUInt8>), _r);
    ...
    **/
    @:keep
    static public function writeTo( _b:stdgo.Ref<Buffer>, _w:stdgo.io.Io.Writer):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } {
        @:recv var _b:stdgo.Ref<Buffer> = _b;
        var _n:stdgo.GoInt64 = (0 : stdgo.GoInt64), _err:stdgo.Error = (null : stdgo.Error);
        _b._lastRead = (0 : stdgo.bytes.Bytes.T_readOp);
        {
            var _nBytes:stdgo.GoInt = _b.len();
            if (_nBytes > (0 : stdgo.GoInt)) {
    ...
    **/
    @:keep
    static public function readFrom( _b:stdgo.Ref<Buffer>, _r:stdgo.io.Io.Reader):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } {
        @:recv var _b:stdgo.Ref<Buffer> = _b;
        var _n:stdgo.GoInt64 = (0 : stdgo.GoInt64), _err:stdgo.Error = (null : stdgo.Error);
        _b._lastRead = (0 : stdgo.bytes.Bytes.T_readOp);
        while (true) {
            ...
            _b._buf = (_b._buf.__slice__(0, _i + _m) : stdgo.Slice<stdgo.GoUInt8>);
    ...
    **/
    ...
    static public function _grow( _b:stdgo.Ref<Buffer>, _n:stdgo.GoInt):stdgo.GoInt {
        @:recv var _b:stdgo.Ref<Buffer> = _b;
        var _m:stdgo.GoInt = _b.len();
        if ((_m == (0 : stdgo.GoInt)) && (_b._off != (0 : stdgo.GoInt))) {
            _b.reset();
        };
        {
        ...
        if ((_b._buf == null) && (_n <= (64 : stdgo.GoInt))) {
            _b._buf = new stdgo.Slice<stdgo.GoUInt8>((_n : stdgo.GoInt).toBasic(), (64 : stdgo.GoInt)).__setNumber32__();
            return (0 : stdgo.GoInt);
        };
        var _c:stdgo.GoInt = _b._buf.capacity;
        if (_n <= ((_c / (2 : stdgo.GoInt)) - _m)) {
            stdgo.Go.copySlice(_b._buf, (_b._buf.__slice__(_b._off) : stdgo.Slice<stdgo.GoUInt8>));
        } else if (_c > (((2147483647 : stdgo.GoInt) - _c) - _n)) {
            throw stdgo.Go.toInterface(errTooLarge);
        } else {
            _b._buf = _growSlice((_b._buf.__slice__(_b._off) : stdgo.Slice<stdgo.GoUInt8>), _b._off + _n);
        };
        _b._off = (0 : stdgo.GoInt);
        _b._buf = (_b._buf.__slice__(0, _m + _n) : stdgo.Slice<stdgo.GoUInt8>);
        return _m;
    }
    /**
        // tryGrowByReslice is an inlineable version of grow for the fast-case where the
    ...
    static public function _tryGrowByReslice( _b:stdgo.Ref<Buffer>, _n:stdgo.GoInt):{ var _0 : stdgo.GoInt; var _1 : Bool; } {
        @:recv var _b:stdgo.Ref<Buffer> = _b;
        {
            ...
            if (_n <= (_b._buf.capacity - _l)) {
                _b._buf = (_b._buf.__slice__(0, _l + _n) : stdgo.Slice<stdgo.GoUInt8>);
    ...
    **/
    ...
    static public function truncate( _b:stdgo.Ref<Buffer>, _n:stdgo.GoInt):Void {
        ...
        _b._lastRead = (0 : stdgo.bytes.Bytes.T_readOp);
        if ((_n < (0 : stdgo.GoInt)) || (_n > _b.len())) {
            throw stdgo.Go.toInterface(("bytes.Buffer: truncation out of range" : stdgo.GoString));
        };
        _b._buf = (_b._buf.__slice__(0, _b._off + _n) : stdgo.Slice<stdgo.GoUInt8>);
    }
    /**
        // Available returns how many bytes are unused in the buffer.
    **/
...
@:keep @:allow(stdgo.bytes.Bytes.Reader_asInterface) class Reader_static_extension {
    ...
    **/
    ...
    static public function reset( _r:stdgo.Ref<Reader>, _b:stdgo.Slice<stdgo.GoByte>):Void {
        ...
        {
            var __tmp__ = (new stdgo.bytes.Bytes.Reader(_b, (0i64 : stdgo.GoInt64), (-1 : stdgo.GoInt)) : stdgo.bytes.Bytes.Reader);
            _r._s = __tmp__._s;
            _r._i = __tmp__._i;
    ...
    static public function seek( _r:stdgo.Ref<Reader>, _offset:stdgo.GoInt64, _whence:stdgo.GoInt):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } {
        ...
        var _abs:stdgo.GoInt64 = (0 : stdgo.GoInt64);
        {
            ...
            if (__value__ == ((0 : stdgo.GoInt))) {
                ...
                return { _0 : (0i64 : stdgo.GoInt64), _1 : stdgo.errors.Errors.new_(("bytes.Reader.Seek: invalid whence" : stdgo.GoString)) };
            };
        };
        if (_abs < (0i64 : stdgo.GoInt64)) {
            return { _0 : (0i64 : stdgo.GoInt64), _1 : stdgo.errors.Errors.new_(("bytes.Reader.Seek: negative position" : stdgo.GoString)) };
        };
        _r._i = _abs;
    ...
    **/
    ...
    static public function readRune( _r:stdgo.Ref<Reader>):{ var _0 : stdgo.GoRune; var _1 : stdgo.GoInt; var _2 : stdgo.Error; } {
        ...
        {
            var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRune((_r._s.__slice__(_r._i) : stdgo.Slice<stdgo.GoUInt8>));
            _ch = __tmp__._0;
            _size = __tmp__._1;
        };
    ...
    **/
    ...
    static public function readAt( _r:stdgo.Ref<Reader>, _b:stdgo.Slice<stdgo.GoByte>, _off:stdgo.GoInt64):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        ...
        if (_off < (0i64 : stdgo.GoInt64)) {
            return { _0 : (0 : stdgo.GoInt), _1 : stdgo.errors.Errors.new_(("bytes.Reader.ReadAt: negative offset" : stdgo.GoString)) };
        };
