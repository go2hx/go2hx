...
/**
    /|*{
    	...
    	gotoNext = 3033655
    	_ = gotoNext == 3033655
    	if i_3033647 < len(s) && i_3033647 < len(t) {
    		gotoNext = 3033691
    		_ = gotoNext == 3033691
    		sr_3033695 = s[i_3033647]
    		tr_3033708 = t[i_3033647]
    		if sr_3033695|tr_3033708 >= 128 {
    			gotoNext = 3033747
    			_ = gotoNext == 3033747
    			gotoNext = 3034105
    			gotoNext = 3033791
    		...
    		if tr_3033708 < sr_3033695 {
    			gotoNext = 3033879
    			_ = gotoNext == 3033879
    			tr_3033708, sr_3033695 = sr_3033695, tr_3033708
    			gotoNext = 3033954
    		} else {
    			gotoNext = 3033954
    		}
    		_ = gotoNext == 3033954
    		if 65 <= sr_3033695 && sr_3033695 <= 90 && tr_3033708 == sr_3033695+97-65 {
    			gotoNext = 3034000
    			_ = gotoNext == 3034000
    			i_3033647++
    			gotoNext = 3033655
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			...
    			gotoNext = 3034292
    			_ = gotoNext == 3034292
    			r_3034297, size_3034300 = utf8.DecodeRune(s)
    			sr_3034214, s = r_3034297, s[size_3034300:]
    			_ = 0
    			gotoNext = 3034356
    		}
    		_ = gotoNext == 3034356
    		if t[0] < 128 {
    			...
    			gotoNext = 3034420
    			_ = gotoNext == 3034420
    			r_3034425, size_3034428 = utf8.DecodeRune(t)
    			tr_3034218, t = r_3034425, t[size_3034428:]
    			_ = 0
    			gotoNext = 3034556
    		}
    		_ = gotoNext == 3034556
    		if tr_3034218 == sr_3034214 {
    			gotoNext = 3034568
    			_ = gotoNext == 3034568
    			_ = 0
    			gotoNext = 3034140
    		...
    		if tr_3034218 < sr_3034214 {
    			gotoNext = 3034644
    			_ = gotoNext == 3034644
    			tr_3034218, sr_3034214 = sr_3034214, tr_3034218
    			gotoNext = 3034698
    		} else {
    			gotoNext = 3034698
    		}
    		...
    		if tr_3034218 < 128 {
    			gotoNext = 3034720
    			_ = gotoNext == 3034720
    			if 65 <= sr_3034214 && sr_3034214 <= 90 && tr_3034218 == sr_3034214+97-65 {
    				gotoNext = 3034820
    				_ = gotoNext == 3034820
    				_ = 0
    				gotoNext = 3034140
    		...
    		_ = gotoNext == 3034973
    		r_3034973 = unicode.SimpleFold(sr_3034214)
    		_ = 0
    		gotoNext = 3035003
    		_ = gotoNext == 3035003
    		if r_3034973 != sr_3034214 && r_3034973 < tr_3034218 {
    			gotoNext = 3035025
    			_ = gotoNext == 3035025
    			r_3034973 = unicode.SimpleFold(r_3034973)
    			gotoNext = 3035003
    		} else {
    			gotoNext = 3035062
    		}
    		_ = gotoNext == 3035062
    		if r_3034973 == tr_3034218 {
    			gotoNext = 3035073
    			_ = gotoNext == 3035073
    			_ = 0
    			gotoNext = 3034140
