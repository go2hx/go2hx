...
```
{
    	...
    	gotoNext = 3009380
    	_ = gotoNext == 3009380
    	if i_3009372 < len(s) && i_3009372 < len(t) {
    		gotoNext = 3009416
    		_ = gotoNext == 3009416
    		sr_3009420 = s[i_3009372]
    		tr_3009433 = t[i_3009372]
    		if sr_3009420|tr_3009433 >= 128 {
    			gotoNext = 3009472
    			_ = gotoNext == 3009472
    			gotoNext = 3009830
    			gotoNext = 3009516
    		...
    		if tr_3009433 < sr_3009420 {
    			gotoNext = 3009604
    			_ = gotoNext == 3009604
    			tr_3009433, sr_3009420 = sr_3009420, tr_3009433
    			gotoNext = 3009679
    		} else {
    			gotoNext = 3009679
}
    		_ = gotoNext == 3009679
    		if 65 <= sr_3009420 && sr_3009420 <= 90 && tr_3009433 == sr_3009420+97-65 {
    			gotoNext = 3009725
    			_ = gotoNext == 3009725
    			i_3009372++
    			gotoNext = 3009380
    	...
    	if len(s) != 0 && len(t) != 0 {
    		...
    		if s[0] < 128 {
    			gotoNext = 3009977
    			_ = gotoNext == 3009977
    			sr_3009939, s = rune(s[0]), s[1:]
    			gotoNext = 3010081
    		} else {
    			gotoNext = 3010017
    			_ = gotoNext == 3010017
    			r_3010022, size_3010025 = utf8.DecodeRune(s)
    			sr_3009939, s = r_3010022, s[size_3010025:]
    			gotoNext = 3010081
}
    		_ = gotoNext == 3010081
    		if t[0] < 128 {
    			gotoNext = 3010105
    			_ = gotoNext == 3010105
    			tr_3009943, t = rune(t[0]), t[1:]
    			gotoNext = 3010281
    		} else {
    			gotoNext = 3010145
    			_ = gotoNext == 3010145
    			r_3010150, size_3010153 = utf8.DecodeRune(t)
    			tr_3009943, t = r_3010150, t[size_3010153:]
    			gotoNext = 3010281
}
    		_ = gotoNext == 3010281
    		if tr_3009943 == sr_3009939 {
    			gotoNext = 3010293
    			_ = gotoNext == 3010293
    			_ = 0
    			gotoNext = 3009865
    		...
    		if tr_3009943 < sr_3009939 {
    			gotoNext = 3010369
    			_ = gotoNext == 3010369
    			tr_3009943, sr_3009939 = sr_3009939, tr_3009943
    			gotoNext = 3010423
    		} else {
    			gotoNext = 3010423
}
    		...
    		if tr_3009943 < 128 {
    			gotoNext = 3010445
    			_ = gotoNext == 3010445
    			if 65 <= sr_3009939 && sr_3009939 <= 90 && tr_3009943 == sr_3009939+97-65 {
    				gotoNext = 3010545
    				_ = gotoNext == 3010545
    				_ = 0
    				gotoNext = 3009865
    		...
    		_ = gotoNext == 3010698
    		r_3010698 = unicode.SimpleFold(sr_3009939)
    		_ = 0
    		gotoNext = 3010728
    		_ = gotoNext == 3010728
    		if r_3010698 != sr_3009939 && r_3010698 < tr_3009943 {
    			gotoNext = 3010750
    			_ = gotoNext == 3010750
    			r_3010698 = unicode.SimpleFold(r_3010698)
    			gotoNext = 3010728
    		} else {
    			gotoNext = 3010787
}
    		_ = gotoNext == 3010787
    		if r_3010698 == tr_3009943 {
    			gotoNext = 3010798
    			_ = gotoNext == 3010798
    			_ = 0
    			gotoNext = 3009865
