...
**/
function newReader(r:stdgo._internal.io.Io.Reader):stdgo.Tuple<stdgo._internal.io.Io.ReadCloser, stdgo.Error> {
        return {
...
**/
function newReaderDict(r:stdgo._internal.io.Io.Reader, dict:Array<StdTypes.Int>):stdgo.Tuple<stdgo._internal.io.Io.ReadCloser, stdgo.Error> {
...
function testDecompressor(t:stdgo._internal.testing.Testing.T_):Void {
...
**/
function newWriterLevel(w:stdgo._internal.io.Io.Writer, level:StdTypes.Int):stdgo.Tuple<Writer, stdgo.Error> {
        return {
...
**/
function newWriterLevelDict(w:stdgo._internal.io.Io.Writer, level:StdTypes.Int, dict:Array<StdTypes.Int>):stdgo.Tuple<Writer, stdgo.Error> {
        final dict = ([for (i in dict) i] : stdgo.Slice<stdgo.GoByte>);
        return {
...
function testWriter(t:stdgo._internal.testing.Testing.T_):Void {
        stdgo._internal.compress.zlib.Zlib.testWriter(t);
    }
function testWriterBig(t:stdgo._internal.testing.Testing.T_):Void {
...
function testWriterDictIsUsed(t:stdgo._internal.testing.Testing.T_):Void {
