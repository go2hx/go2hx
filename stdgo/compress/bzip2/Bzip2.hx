...
@:structInit class T_bitReader {
    ...
    public function readBits64(_bits:GoUInt):GoUInt64 {
        ...
        while (_bits > _br.value._bits) {
            var __tmp__ = _br.value._r.readByte(), _b:GoUInt8 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
    ...
    public function new(?_r:stdgo.io.Io.ByteReader, ?_n:GoUInt64, ?_bits:GoUInt, ?_err:stdgo.Error) stdgo.internal.Macro.initLocals();
...
@:named class StructuralError {
    ...
    public function __copy__() return new StructuralError(__t__);
}
@:structInit class T_reader {
    ...
    public function _read(_buf:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } {
        ...
        while (true) {
            ...
            if (_br.value.readBits64(((48 : GoUInt))) == _bzip2BlockMagic) {
                ...
                var __tmp__ = _br.value._r.readByte(), _z:GoUInt8 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    if (Go.toInterface(_err) == Go.toInterface(stdgo.io.Io.eof)) {
                        _err = stdgo.io.Io.errUnexpectedEOF;
                    };
    ...
    public function new(?_br:T_bitReader, ?_fileCRC:GoUInt32, ?_blockCRC:GoUInt32, ?_wantBlockCRC:GoUInt32, ?_setupDone:Bool, ?_blockSize:GoInt, ?_eof:Bool, ?_c:GoArray<GoUInt>, ?_tt:Slice<GoUInt32>, ?_tPos:GoUInt32, ?_preRLE:Slice<GoUInt32>, ?_preRLEUsed:GoInt, ?_lastByte:GoInt, ?_byteRepeats:GoUInt, ?_repeats:GoUInt) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_br) + " " + Go.string(_fileCRC) + " " + Go.string(_blockCRC) + " " + Go.string(_wantBlockCRC) + " " + Go.string(_setupDone) + " " + Go.string(_blockSize) + " " + Go.string(_eof) + " " + Go.string(_c) + " " + Go.string(_tt) + " " + Go.string(_tPos) + " " + Go.string(_preRLE) + " " + Go.string(_preRLEUsed) + " " + Go.string(_lastByte) + " " + Go.string(_byteRepeats) + " " + Go.string(_repeats) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
        return new T_reader(
...
@:structInit class T_huffmanTree {
    public function decode(_br:Pointer<T_bitReader>):GoUInt16 {
        ...
        while (true) {
            ...
            var _l:GoUInt16 = _node.value._left, _r:GoUInt16 = _node.value._right;
            if (_bit == ((1 : GoUInt16))) {
                _nodeIndex = _l;
            } else {
                _nodeIndex = _r;
            ...
            if (_nodeIndex == _invalidNodeValue) {
                var _l:GoUInt16 = _node.value._leftValue, _r:GoUInt16 = _node.value._rightValue;
                if (_bit == ((1 : GoUInt16))) {
                    _v = _l;
                } else {
                    _v = _r;
    ...
    public function new(?_nodes:Slice<T_huffmanNode>, ?_nextNode:GoInt) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_huffmanNode {
    ...
    public function new(?_left:GoUInt16, ?_right:GoUInt16, ?_leftValue:GoUInt16, ?_rightValue:GoUInt16) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_huffmanSymbolLengthPair {
    ...
    public function new(?_value:GoUInt16, ?_length:GoUInt8) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_huffmanCode {
    ...
    public var _value : GoUInt16 = ((0 : GoUInt16));
    public function new(?_code:GoUInt32, ?_codeLen:GoUInt8, ?_value:GoUInt16) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:named class T_moveToFrontDecoder {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new T_moveToFrontDecoder(__t__);
    public function __append__(args:haxe.Rest<GoUInt8>) return new T_moveToFrontDecoder(this.__t__.__append__(...args));
    public function __slice__(low:GoInt, high:GoInt = -1) return new T_moveToFrontDecoder(this.__t__.__slice__(low, high));
}
...
function _newBitReader(_r:stdgo.io.Io.Reader):T_bitReader {
        ...
        return (({ _r : _byter, _n : 0, _bits : 0, _err : ((null : stdgo.Error)) } : T_bitReader)).__copy__();
    }
/**
...
function _newHuffmanTree(_lengths:Slice<GoUInt8>):{ var _0 : T_huffmanTree; var _1 : Error; } {
        ...
        var _pairs:Slice<T_huffmanSymbolLengthPair> = new Slice<T_huffmanSymbolLengthPair>(...[for (i in 0 ... ((_lengths.length : GoInt)).toBasic()) new T_huffmanSymbolLengthPair()]);
        {
            var _i;
            var _length;
            for (_obj in _lengths.keyValueIterator()) {
        ...
        var __tmp__ = _buildHuffmanNode(Go.pointer(_t), _codes, ((0 : GoUInt32))), _:GoUInt16 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
...
class T_bitReader_extension_fields {
    public function readBits64(__tmp__, _bits:GoUInt):GoUInt64 return __tmp__.readBits64(_bits);
    public function readBits(__tmp__, _bits:GoUInt):GoInt return __tmp__.readBits(_bits);
    public function readBit(__tmp__):Bool return __tmp__.readBit();
...
class T_reader_extension_fields {
    public function _setup(__tmp__, _needMagic:Bool):Error return __tmp__._setup(_needMagic);
    public function read(__tmp__, _buf:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } return __tmp__.read(_buf);
    public function _readFromBlock(__tmp__, _buf:Slice<GoByte>):GoInt return __tmp__._readFromBlock(_buf);
    public function _read(__tmp__, _buf:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } return __tmp__._read(_buf);
    public function _readBlock(__tmp__):Error return __tmp__._readBlock();
}
class T_huffmanTree_extension_fields {
    public function decode(__tmp__, _br:Pointer<T_bitReader>):GoUInt16 return __tmp__.decode(_br);
}
class T_moveToFrontDecoder_extension_fields {
    public function decode(__tmp__, _n:GoInt):GoByte return __tmp__.decode(_n);
    public function first(__tmp__):GoByte return __tmp__.first();
}
