...
@:structInit @:using(stdgo.compress.bzip2.Bzip2.T_bitReader_static_extension) abstract T_bitReader(stdgo._internal.compress.bzip2.Bzip2_T_bitReader.T_bitReader) from stdgo._internal.compress.bzip2.Bzip2_T_bitReader.T_bitReader to stdgo._internal.compress.bzip2.Bzip2_T_bitReader.T_bitReader {
    ...
    public function new(?_r:stdgo._internal.io.Io_ByteReader.ByteReader, ?_n:haxe.UInt64, ?_bits:std.UInt, ?_err:stdgo.Error) this = new stdgo._internal.compress.bzip2.Bzip2_T_bitReader.T_bitReader(_r, _n, _bits, _err);
...
@:structInit @:using(stdgo.compress.bzip2.Bzip2.T_huffmanTree_static_extension) abstract T_huffmanTree(stdgo._internal.compress.bzip2.Bzip2_T_huffmanTree.T_huffmanTree) from stdgo._internal.compress.bzip2.Bzip2_T_huffmanTree.T_huffmanTree to stdgo._internal.compress.bzip2.Bzip2_T_huffmanTree.T_huffmanTree {
    ...
    public function new(?_nodes:Array<T_huffmanNode>, ?_nextNode:StdTypes.Int) this = new stdgo._internal.compress.bzip2.Bzip2_T_huffmanTree.T_huffmanTree(([for (i in _nodes) i] : stdgo.Slice<stdgo._internal.compress.bzip2.Bzip2_T_huffmanNode.T_huffmanNode>), _nextNode);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_huffmanNode(stdgo._internal.compress.bzip2.Bzip2_T_huffmanNode.T_huffmanNode) from stdgo._internal.compress.bzip2.Bzip2_T_huffmanNode.T_huffmanNode to stdgo._internal.compress.bzip2.Bzip2_T_huffmanNode.T_huffmanNode {
...
@:structInit abstract T_huffmanSymbolLengthPair(stdgo._internal.compress.bzip2.Bzip2_T_huffmanSymbolLengthPair.T_huffmanSymbolLengthPair) from stdgo._internal.compress.bzip2.Bzip2_T_huffmanSymbolLengthPair.T_huffmanSymbolLengthPair to stdgo._internal.compress.bzip2.Bzip2_T_huffmanSymbolLengthPair.T_huffmanSymbolLengthPair {
    ...
    public function new(?_value:std.UInt, ?_length:std.UInt) this = new stdgo._internal.compress.bzip2.Bzip2_T_huffmanSymbolLengthPair.T_huffmanSymbolLengthPair(_value, _length);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_huffmanCode(stdgo._internal.compress.bzip2.Bzip2_T_huffmanCode.T_huffmanCode) from stdgo._internal.compress.bzip2.Bzip2_T_huffmanCode.T_huffmanCode to stdgo._internal.compress.bzip2.Bzip2_T_huffmanCode.T_huffmanCode {
    ...
    public function new(?_code:std.UInt, ?_codeLen:std.UInt, ?_value:std.UInt) this = new stdgo._internal.compress.bzip2.Bzip2_T_huffmanCode.T_huffmanCode(_code, _codeLen, _value);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
class Bzip2 {
    ...
    **/
    static public function newReader(_r:stdgo._internal.io.Io_Reader.Reader):stdgo._internal.io.Io_Reader.Reader {
        return stdgo._internal.compress.bzip2.Bzip2_newReader.newReader(_r);
    }
    static public function testReader(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.compress.bzip2.Bzip2_testReader.testReader(_t);
    }
    static public function testBitReader(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.compress.bzip2.Bzip2_testBitReader.testBitReader(_t);
    }
    static public function testMTF(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.compress.bzip2.Bzip2_testMTF.testMTF(_t);
    }
    static public function testZeroRead(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.compress.bzip2.Bzip2_testZeroRead.testZeroRead(_t);
    }
    static public function benchmarkDecodeDigits(_b:stdgo._internal.testing.Testing_B.B):Void {
        stdgo._internal.compress.bzip2.Bzip2_benchmarkDecodeDigits.benchmarkDecodeDigits(_b);
    }
    static public function benchmarkDecodeNewton(_b:stdgo._internal.testing.Testing_B.B):Void {
        stdgo._internal.compress.bzip2.Bzip2_benchmarkDecodeNewton.benchmarkDecodeNewton(_b);
    }
    static public function benchmarkDecodeRand(_b:stdgo._internal.testing.Testing_B.B):Void {
