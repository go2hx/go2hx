...
@:structInit @:private @:using(stdgo.compress.bzip2.Bzip2.T_bitReader_static_extension) class T_bitReader {
    ...
    public function new(?_r:stdgo.io.Io.ByteReader, ?_n:stdgo.GoUInt64, ?_bits:stdgo.GoUInt, ?_err:stdgo.Error) {
...
@:structInit @:private @:using(stdgo.compress.bzip2.Bzip2.T_reader_static_extension) class T_reader {
    ...
    public var _c : stdgo.GoArray<stdgo.GoUInt> = new stdgo.GoArray<stdgo.GoUInt>(...[for (i in 0 ... 256) (0 : stdgo.GoUInt)]);
...
@:structInit @:private @:using(stdgo.compress.bzip2.Bzip2.T_huffmanTree_static_extension) class T_huffmanTree {
    ...
    **/
    ...
    public function new(?_nodes:stdgo.Slice<stdgo.compress.bzip2.Bzip2.T_huffmanNode>, ?_nextNode:stdgo.GoInt) {
...
**/
@:named @:using(stdgo.compress.bzip2.Bzip2.T_moveToFrontDecoder_static_extension) typedef T_moveToFrontDecoder = stdgo.Slice<stdgo.GoUInt8>;
/**
...
function newReader(_r:stdgo.io.Io.Reader):stdgo.io.Io.Reader {
        var _bz2 = (stdgo.Go.setRef(({} : stdgo.compress.bzip2.Bzip2.T_reader)) : stdgo.Ref<stdgo.compress.bzip2.Bzip2.T_reader>);
...
function _inverseBWT(_tt:stdgo.Slice<stdgo.GoUInt32>, _origPtr:stdgo.GoUInt, _c:stdgo.Slice<stdgo.GoUInt>):stdgo.GoUInt32 {
        var _sum:stdgo.GoUInt = (0u32 : stdgo.GoUInt);
        {
            ...
            stdgo.Go.cfor(_i < (256 : stdgo.GoInt), _i++, {
                _sum = _sum + (_c[(_i : stdgo.GoInt)]);
                _c[(_i : stdgo.GoInt)] = _sum - _c[(_i : stdgo.GoInt)];
            });
        };
        for (_i in 0 ... _tt.length.toBasic()) {
            var _b:stdgo.GoUInt32 = _tt[(_i : stdgo.GoInt)] & (255u32 : stdgo.GoUInt32);
            _tt[(_c[(_b : stdgo.GoInt)] : stdgo.GoInt)] = _tt[(_c[(_b : stdgo.GoInt)] : stdgo.GoInt)] | ((_i : stdgo.GoUInt32) << (8i64 : stdgo.GoUInt64));
            _c[(_b : stdgo.GoInt)]++;
        };
        return _tt[(_origPtr : stdgo.GoInt)] >> (8i64 : stdgo.GoUInt64);
    }
/**
...
function _updateCRC(_val:stdgo.GoUInt32, _b:stdgo.Slice<stdgo.GoByte>):stdgo.GoUInt32 {
        ...
        for (__0 => _v in _b) {
            _crc = _crctab[((_crc >> (24i64 : stdgo.GoUInt64) : stdgo.GoByte) ^ _v : stdgo.GoInt)] ^ (_crc << (8i64 : stdgo.GoUInt64));
        };
        return (-1 ^ _crc);
    }
...
function _trim(_b:stdgo.Slice<stdgo.GoByte>):stdgo.GoString {
        {};
        if ((_b.length) < (1024 : stdgo.GoInt)) {
            return stdgo.fmt.Fmt.sprintf(("%q" : stdgo.GoString), stdgo.Go.toInterface(_b))?.__copy__();
        };
        return stdgo.fmt.Fmt.sprintf(("%q..." : stdgo.GoString), stdgo.Go.toInterface((_b.__slice__(0, (1024 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>)))?.__copy__();
    }
function testReader(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
({ _desc : ("32B zeros" : stdgo.GoString), _input : _mustDecodeHex(("425a6839314159265359b5aa5098000000600040000004200021008283177245385090b5aa5098" : stdgo.GoString)), _output : new stdgo.Slice<stdgo.GoUInt8>((32 : stdgo.GoInt).toBasic(), 0).__setNumber32__(), _fail : false } : T__struct_0),
({ _desc : ("1MiB zeros" : stdgo.GoString), _input : _mustDecodeHex(("425a683931415926535938571ce50008084000c0040008200030cc0529a60806c4201e2ee48a70a12070ae39ca" : stdgo.GoString)), _output : new stdgo.Slice<stdgo.GoUInt8>((1048576 : stdgo.GoInt).toBasic(), 0).__setNumber32__(), _fail : false } : T__struct_0),
...
({ _desc : ("RLE2 buffer overrun - issue 5747" : stdgo.GoString), _input : _mustLoadFile(("testdata/fail-issue5747.bz2" : stdgo.GoString)), _output : (null : stdgo.Slice<stdgo.GoUInt8>), _fail : true } : T__struct_0),
({ _desc : ("out-of-range selector - issue 8363" : stdgo.GoString), _input : _mustDecodeHex(("425a68393141592653594eece83600000251800010400006449080200031064c4101a7a9a580bb943117724538509000000000" : stdgo.GoString)), _output : (null : stdgo.Slice<stdgo.GoUInt8>), _fail : true } : T__struct_0),
({ _desc : ("bad block size - issue 13941" : stdgo.GoString), _input : _mustDecodeHex(("425a683131415926535936dc55330063ffc0006000200020a40830008b0008b8bb9229c28481b6e2a998" : stdgo.GoString)), _output : (null : stdgo.Slice<stdgo.GoUInt8>), _fail : true } : T__struct_0),
({ _desc : ("bad huffman delta" : stdgo.GoString), _input : _mustDecodeHex(("425a6836314159265359b1f7404b000000400040002000217d184682ee48a70a12163ee80960" : stdgo.GoString)), _output : (null : stdgo.Slice<stdgo.GoUInt8>), _fail : true } : T__struct_0)) : stdgo.Slice<T__struct_0>);
        for (_i => _v in _vectors) {
            var _rd:stdgo.io.Io.Reader = newReader(stdgo.Go.asInterface(stdgo.bytes.Bytes.newReader(_v._input)));
            var __tmp__ = stdgo.io.Io.readAll(_rd), _buf:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            {
...
function testBitReader(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _vectors:stdgo.Slice<T__struct_1> = (new stdgo.Slice<T__struct_1>(
9,
9,
({ _nbits : (1u32 : stdgo.GoUInt), _value : (1 : stdgo.GoInt), _fail : false } : T__struct_1),
({ _nbits : (1u32 : stdgo.GoUInt), _value : (0 : stdgo.GoInt), _fail : false } : T__struct_1),
({ _nbits : (1u32 : stdgo.GoUInt), _value : (1 : stdgo.GoInt), _fail : false } : T__struct_1),
({ _nbits : (5u32 : stdgo.GoUInt), _value : (11 : stdgo.GoInt), _fail : false } : T__struct_1),
({ _nbits : (32u32 : stdgo.GoUInt), _value : (305419896 : stdgo.GoInt), _fail : false } : T__struct_1),
({ _nbits : (15u32 : stdgo.GoUInt), _value : (14495 : stdgo.GoInt), _fail : false } : T__struct_1),
({ _nbits : (3u32 : stdgo.GoUInt), _value : (6 : stdgo.GoInt), _fail : false } : T__struct_1),
({ _nbits : (6u32 : stdgo.GoUInt), _value : (13 : stdgo.GoInt), _fail : false } : T__struct_1),
({ _nbits : (1u32 : stdgo.GoUInt), _value : (0 : stdgo.GoInt), _fail : true } : T__struct_1)) : stdgo.Slice<T__struct_1>);
        var _rd = stdgo.bytes.Bytes.newReader((new stdgo.Slice<stdgo.GoUInt8>(8, 8, (171 : stdgo.GoUInt8), (18 : stdgo.GoUInt8), (52 : stdgo.GoUInt8), (86 : stdgo.GoUInt8), (120 : stdgo.GoUInt8), (113 : stdgo.GoUInt8), (63 : stdgo.GoUInt8), (141 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>));
...
function testZeroRead(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function _benchmarkDecode(_b:stdgo.Ref<stdgo.testing.Testing.B>, _compressed:stdgo.Slice<stdgo.GoByte>):Void {
        var __tmp__ = stdgo.io.Io.copy(stdgo.io.Io.discard, newReader(stdgo.Go.asInterface(stdgo.bytes.Bytes.newReader(_compressed)))), _uncompressedSize:stdgo.GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
...
function benchmarkDecodeDigits(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkDecode(_b, _digits);
    }
function benchmarkDecodeNewton(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkDecode(_b, _newton);
    }
function benchmarkDecodeRand(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
...
function _newHuffmanTree(_lengths:stdgo.Slice<stdgo.GoUInt8>):{ var _0 : T_huffmanTree; var _1 : stdgo.Error; } {
        if ((_lengths.length) < (2 : stdgo.GoInt)) {
        ...
        var _pairs = new stdgo.Slice<stdgo.compress.bzip2.Bzip2.T_huffmanSymbolLengthPair>((_lengths.length : stdgo.GoInt).toBasic(), 0, ...[for (i in 0 ... ((_lengths.length : stdgo.GoInt).toBasic() > 0 ? (_lengths.length : stdgo.GoInt).toBasic() : 0 : stdgo.GoInt).toBasic()) ({} : stdgo.compress.bzip2.Bzip2.T_huffmanSymbolLengthPair)]);
        for (_i => _length in _lengths) {
            _pairs[(_i : stdgo.GoInt)]._value = (_i : stdgo.GoUInt16);
            _pairs[(_i : stdgo.GoInt)]._length = _length;
        };
        stdgo.sort.Sort.slice(stdgo.Go.toInterface(_pairs), function(_i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
            if (_pairs[(_i : stdgo.GoInt)]._length < _pairs[(_j : stdgo.GoInt)]._length) {
                return true;
            };
            if (_pairs[(_i : stdgo.GoInt)]._length > _pairs[(_j : stdgo.GoInt)]._length) {
                return false;
            };
            if (_pairs[(_i : stdgo.GoInt)]._value < _pairs[(_j : stdgo.GoInt)]._value) {
                return true;
            };
            return false;
        });
        ...
        var _codes = new stdgo.Slice<stdgo.compress.bzip2.Bzip2.T_huffmanCode>((_lengths.length : stdgo.GoInt).toBasic(), 0, ...[for (i in 0 ... ((_lengths.length : stdgo.GoInt).toBasic() > 0 ? (_lengths.length : stdgo.GoInt).toBasic() : 0 : stdgo.GoInt).toBasic()) ({} : stdgo.compress.bzip2.Bzip2.T_huffmanCode)]);
        {
            var _i:stdgo.GoInt = (_pairs.length) - (1 : stdgo.GoInt);
            stdgo.Go.cfor(_i >= (0 : stdgo.GoInt), _i--, {
                if (_length > _pairs[(_i : stdgo.GoInt)]._length) {
                ...
                _code = _code + ((1u32 : stdgo.GoUInt32) << ((32 : stdgo.GoUInt8) - _length));
            });
        };
        stdgo.sort.Sort.slice(stdgo.Go.toInterface(_codes), function(_i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
            return _codes[(_i : stdgo.GoInt)]._code < _codes[(_j : stdgo.GoInt)]._code;
        });
        _t._nodes = new stdgo.Slice<stdgo.compress.bzip2.Bzip2.T_huffmanNode>((_codes.length : stdgo.GoInt).toBasic(), 0, ...[for (i in 0 ... ((_codes.length : stdgo.GoInt).toBasic() > 0 ? (_codes.length : stdgo.GoInt).toBasic() : 0 : stdgo.GoInt).toBasic()) ({} : stdgo.compress.bzip2.Bzip2.T_huffmanNode)]);
        var __tmp__ = _buildHuffmanNode((stdgo.Go.setRef(_t) : stdgo.Ref<stdgo.compress.bzip2.Bzip2.T_huffmanTree>), _codes, (0u32 : stdgo.GoUInt32)), __0:stdgo.GoUInt16 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
...
function _buildHuffmanNode(_t:stdgo.Ref<T_huffmanTree>, _codes:stdgo.Slice<T_huffmanCode>, _level:stdgo.GoUInt32):{ var _0 : stdgo.GoUInt16; var _1 : stdgo.Error; } {
        ...
        var _test:stdgo.GoUInt32 = (1u32 : stdgo.GoUInt32) << ((31u32 : stdgo.GoUInt32) - _level);
        var _firstRightIndex:stdgo.GoInt = (_codes.length);
        for (_i => _code in _codes) {
            if (_code._code & _test != ((0u32 : stdgo.GoUInt32))) {
                _firstRightIndex = _i;
                break;
            };
        };
        ...
        if ((_left.length == (0 : stdgo.GoInt)) || (_right.length == (0 : stdgo.GoInt))) {
            if ((_codes.length) < (2 : stdgo.GoInt)) {
                return { _0 : (0 : stdgo.GoUInt16), _1 : stdgo.Go.asInterface(((("empty Huffman tree" : stdgo.GoString) : stdgo.compress.bzip2.Bzip2.StructuralError) : StructuralError)) };
            };
            if (_level == ((31u32 : stdgo.GoUInt32))) {
                return { _0 : (0 : stdgo.GoUInt16), _1 : stdgo.Go.asInterface(((("equal symbols in Huffman tree" : stdgo.GoString) : stdgo.compress.bzip2.Bzip2.StructuralError) : StructuralError)) };
            };
            if ((_left.length) == ((0 : stdgo.GoInt))) {
                return _buildHuffmanNode(_t, _right, _level + (1u32 : stdgo.GoUInt32));
            };
            return _buildHuffmanNode(_t, _left, _level + (1u32 : stdgo.GoUInt32));
        };
        _nodeIndex = (_t._nextNode : stdgo.GoUInt16);
        var _node = (stdgo.Go.setRef(_t._nodes[(_t._nextNode : stdgo.GoInt)]) : stdgo.Ref<stdgo.compress.bzip2.Bzip2.T_huffmanNode>);
        _t._nextNode++;
        if ((_left.length) == ((1 : stdgo.GoInt))) {
            ...
            {
                var __tmp__ = _buildHuffmanNode(_t, _left, _level + (1u32 : stdgo.GoUInt32));
        ...
        if ((_right.length) == ((1 : stdgo.GoInt))) {
            ...
            {
                var __tmp__ = _buildHuffmanNode(_t, _right, _level + (1u32 : stdgo.GoUInt32));
...
function _newMTFDecoder(_symbols:stdgo.Slice<stdgo.GoByte>):T_moveToFrontDecoder {
        if ((_symbols.length) > (256 : stdgo.GoInt)) {
...
function _newMTFDecoderWithRange(_n:stdgo.GoInt):T_moveToFrontDecoder {
        if (_n > (256 : stdgo.GoInt)) {
            throw stdgo.Go.toInterface(("newMTFDecoderWithRange: cannot have > 256 symbols" : stdgo.GoString));
        };
        var _m = new stdgo.Slice<stdgo.GoUInt8>((_n : stdgo.GoInt).toBasic(), 0).__setNumber32__();
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
...
@:keep var _ = {
        try {
            ...
            for (_i in 0 ... _crctab.length.toBasic()) {
                var _crc:stdgo.GoUInt32 = (_i : stdgo.GoUInt32) << (24i64 : stdgo.GoUInt64);
                {
                    var _j:stdgo.GoInt = (0 : stdgo.GoInt);
                    stdgo.Go.cfor(_j < (8 : stdgo.GoInt), _j++, {
                        if (_crc & (-2147483648u32 : stdgo.GoUInt32) != ((0u32 : stdgo.GoUInt32))) {
                            _crc = (_crc << (1i64 : stdgo.GoUInt64)) ^ (79764919u32 : stdgo.GoUInt32);
                        } else {
                            _crc = _crc << ((1i64 : stdgo.GoUInt64));
                        };
                    });
                };
    ...
    **/
    ...
    static public function readBits64( _br:stdgo.Ref<T_bitReader>, _bits:stdgo.GoUInt):stdgo.GoUInt64 {
        ...
        while (_bits > _br._bits) {
            ...
            _br._n = _br._n << ((8i64 : stdgo.GoUInt64));
            _br._n = _br._n | ((_b : stdgo.GoUInt64));
            _br._bits = _br._bits + ((8u32 : stdgo.GoUInt));
        };
        _n = (_br._n >> (_br._bits - _bits)) & (((1i64 : stdgo.GoUInt64) << _bits) - (1i64 : stdgo.GoUInt64));
...
@:keep @:allow(stdgo.compress.bzip2.Bzip2.T_reader_asInterface) class T_reader_static_extension {
    ...
    **/
    ...
    static public function _readBlock( _bz2:stdgo.Ref<T_reader>):stdgo.Error {
        ...
        var _br = (stdgo.Go.setRef(_bz2._br) : stdgo.Ref<stdgo.compress.bzip2.Bzip2.T_bitReader>);
        _bz2._wantBlockCRC = (_br.readBits64((32u32 : stdgo.GoUInt)) : stdgo.GoUInt32);
        _bz2._blockCRC = (0u32 : stdgo.GoUInt32);
        _bz2._fileCRC = ((_bz2._fileCRC << (1i64 : stdgo.GoUInt64)) | (_bz2._fileCRC >> (31i64 : stdgo.GoUInt64))) ^ _bz2._wantBlockCRC;
        ...
        var _symbolPresent = new stdgo.Slice<Bool>((256 : stdgo.GoInt).toBasic(), 0);
        var _numSymbols:stdgo.GoInt = (0 : stdgo.GoInt);
        {
            var _symRange:stdgo.GoUInt = (0u32 : stdgo.GoUInt);
            stdgo.Go.cfor(_symRange < (16u32 : stdgo.GoUInt), _symRange++, {
                if (_symbolRangeUsedBitmap & ((1 : stdgo.GoInt) << ((15u32 : stdgo.GoUInt) - _symRange)) != ((0 : stdgo.GoInt))) {
                    var _bits:stdgo.GoInt = _br.readBits((16u32 : stdgo.GoUInt));
                    {
                        var _symbol:stdgo.GoUInt = (0u32 : stdgo.GoUInt);
                        stdgo.Go.cfor(_symbol < (16u32 : stdgo.GoUInt), _symbol++, {
                            if (_bits & ((1 : stdgo.GoInt) << ((15u32 : stdgo.GoUInt) - _symbol)) != ((0 : stdgo.GoInt))) {
                                _symbolPresent[(((16u32 : stdgo.GoUInt) * _symRange) + _symbol : stdgo.GoInt)] = true;
                                _numSymbols++;
                            };
                        });
                    };
        ...
        if ((_numHuffmanTrees < (2 : stdgo.GoInt)) || (_numHuffmanTrees > (6 : stdgo.GoInt))) {
        ...
        var _treeIndexes = new stdgo.Slice<stdgo.GoUInt8>((_numSelectors : stdgo.GoInt).toBasic(), 0).__setNumber32__();
        ...
        var _symbols = new stdgo.Slice<stdgo.GoUInt8>((_numSymbols : stdgo.GoInt).toBasic(), 0).__setNumber32__();
        ...
        _numSymbols = _numSymbols + ((2 : stdgo.GoInt));
        var _huffmanTrees = new stdgo.Slice<stdgo.compress.bzip2.Bzip2.T_huffmanTree>((_numHuffmanTrees : stdgo.GoInt).toBasic(), 0, ...[for (i in 0 ... ((_numHuffmanTrees : stdgo.GoInt).toBasic() > 0 ? (_numHuffmanTrees : stdgo.GoInt).toBasic() : 0 : stdgo.GoInt).toBasic()) ({} : stdgo.compress.bzip2.Bzip2.T_huffmanTree)]);
        var _lengths = new stdgo.Slice<stdgo.GoUInt8>((_numSymbols : stdgo.GoInt).toBasic(), 0).__setNumber32__();
        for (_i in 0 ... _huffmanTrees.length.toBasic()) {
            ...
            for (_j in 0 ... _lengths.length.toBasic()) {
                while (true) {
                    if ((_length < (1 : stdgo.GoInt)) || (_length > (20 : stdgo.GoInt))) {
        ...
        if ((_treeIndexes[(0 : stdgo.GoInt)] : stdgo.GoInt) >= (_huffmanTrees.length)) {
        ...
        var _currentHuffmanTree:stdgo.compress.bzip2.Bzip2.T_huffmanTree = _huffmanTrees[(_treeIndexes[(0 : stdgo.GoInt)] : stdgo.GoInt)];
        ...
        while (true) {
            if (_decoded == ((50 : stdgo.GoInt))) {
                ...
                if ((_treeIndexes[(_selectorIndex : stdgo.GoInt)] : stdgo.GoInt) >= (_huffmanTrees.length)) {
                    return stdgo.Go.asInterface(((("tree selector out of range" : stdgo.GoString) : stdgo.compress.bzip2.Bzip2.StructuralError) : StructuralError));
                };
            ...
            _decoded++;
            if (_v < (2 : stdgo.GoUInt16)) {
                if (_repeat == ((0 : stdgo.GoInt))) {
                    _repeatPower = (1 : stdgo.GoInt);
                };
                _repeat = _repeat + (_repeatPower << _v);
                _repeatPower = _repeatPower << ((1i64 : stdgo.GoUInt64));
                if (_repeat > (2097152 : stdgo.GoInt)) {
            ...
            if ((_v : stdgo.GoInt) == (_numSymbols - (1 : stdgo.GoInt))) {
                break;
            };
            var _b:stdgo.GoUInt8 = _mtf.decode((_v - (1 : stdgo.GoUInt16) : stdgo.GoInt));
        ...
        if (_origPtr >= (_bufIndex : stdgo.GoUInt)) {
    ...
    static public function _read( _bz2:stdgo.Ref<T_reader>, _buf:stdgo.Slice<stdgo.GoByte>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        ...
        while (true) {
            ...
            if ((_n > (0 : stdgo.GoInt)) || (_buf.length == (0 : stdgo.GoInt))) {
            ...
            var _br = (stdgo.Go.setRef(_bz2._br) : stdgo.Ref<stdgo.compress.bzip2.Bzip2.T_bitReader>);
            {
                ...
                if (__value__ == ((54156738319193i64 : stdgo.GoUInt64))) {
                    ...
                    if (_br._bits % (8u32 : stdgo.GoUInt) != ((0u32 : stdgo.GoUInt))) {
                        _br.readBits(_br._bits % (8u32 : stdgo.GoUInt));
                    };
                    var __tmp__ = _br._r.readByte(), _b:stdgo.GoUInt8 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                    if (stdgo.Go.toInterface(_err) == (stdgo.Go.toInterface(stdgo.io.Io.eof))) {
                    ...
                    if ((_b != (66 : stdgo.GoUInt8)) || (_z != (90 : stdgo.GoUInt8))) {
                        return { _0 : (0 : stdgo.GoInt), _1 : stdgo.Go.asInterface(((("bad magic value in continuation file" : stdgo.GoString) : stdgo.compress.bzip2.Bzip2.StructuralError) : StructuralError)) };
                    };
                    {
                    ...
                    return { _0 : (0 : stdgo.GoInt), _1 : stdgo.Go.asInterface(((("bad magic value found" : stdgo.GoString) : stdgo.compress.bzip2.Bzip2.StructuralError) : StructuralError)) };
                };
            };
        };
    }
    ...
    static public function _readFromBlock( _bz2:stdgo.Ref<T_reader>, _buf:stdgo.Slice<stdgo.GoByte>):stdgo.GoInt {
        @:recv var _bz2:stdgo.Ref<T_reader> = _bz2;
        var _n:stdgo.GoInt = (0 : stdgo.GoInt);
        while (((_bz2._repeats > (0u32 : stdgo.GoUInt)) || (_bz2._preRLEUsed < _bz2._preRLE.length)) && (_n < _buf.length)) {
            ...
            _bz2._tPos = _bz2._tPos >> ((8i64 : stdgo.GoUInt64));
            _bz2._preRLEUsed++;
    ...
    **/
    ...
    static public function _setup( _bz2:stdgo.Ref<T_reader>, _needMagic:Bool):stdgo.Error {
        ...
        if ((_level < (49 : stdgo.GoInt)) || (_level > (57 : stdgo.GoInt))) {
        ...
        _bz2._blockSize = (100000 : stdgo.GoInt) * (_level - (48 : stdgo.GoInt));
        if (_bz2._blockSize > (_bz2._tt.length)) {
            _bz2._tt = new stdgo.Slice<stdgo.GoUInt32>((_bz2._blockSize : stdgo.GoInt).toBasic(), 0).__setNumber32__();
        };
        return (null : stdgo.Error);
    }
}
...
@:keep @:allow(stdgo.compress.bzip2.Bzip2.T_huffmanTree_asInterface) class T_huffmanTree_static_extension {
    ...
    **/
    ...
    static public function decode( _t:stdgo.Ref<T_huffmanTree>, _br:stdgo.Ref<T_bitReader>):stdgo.GoUInt16 {
        ...
        while (true) {
            var _node = (stdgo.Go.setRef(_t._nodes[(_nodeIndex : stdgo.GoInt)]) : stdgo.Ref<stdgo.compress.bzip2.Bzip2.T_huffmanNode>);
            var _bit:stdgo.GoUInt16 = (0 : stdgo.GoUInt16);
            if (_br._bits > (0u32 : stdgo.GoUInt)) {
                _br._bits--;
                _bit = (_br._n >> (_br._bits & (63u32 : stdgo.GoUInt)) : stdgo.GoUInt16) & (1 : stdgo.GoUInt16);
            } else {
...
@:keep @:allow(stdgo.compress.bzip2.Bzip2.T_moveToFrontDecoder_asInterface) class T_moveToFrontDecoder_static_extension {
    ...
    **/
    ...
    static public function decode( _m:T_moveToFrontDecoder, _n:stdgo.GoInt):stdgo.GoByte {
        ...
        stdgo.Go.copySlice((_m.__slice__((1 : stdgo.GoInt)) : stdgo.compress.bzip2.Bzip2.T_moveToFrontDecoder), (_m.__slice__(0, _n) : stdgo.compress.bzip2.Bzip2.T_moveToFrontDecoder));
        _m[(0 : stdgo.GoInt)] = _b;
        return _b;
    }
}
