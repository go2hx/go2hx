...
/**
    /|*{
    	...
    	_ = gotoNext == 3693887
    	{
    		v_3693980, err_3693983 = f.huffSym(f.hl)
    		if err_3693983 != nil {
    			gotoNext = 3694022
    			_ = gotoNext == 3694022
    			f.err = err_3693983
    		...
    		case v_3693980 < 256:
    			gotoNext = 3694120
    			_ = gotoNext == 3694120
    			f.dict.writeByte(byte(v_3693980))
    		...
    		case v_3693980 < 265:
    			gotoNext = 3694424
    			_ = gotoNext == 3694424
    			length_3694096 = v_3693980 - 254
    			n_3694059 = 0
    			gotoNext = 3694872
    		case v_3693980 < 269:
    			gotoNext = 3694475
    			_ = gotoNext == 3694475
    			length_3694096 = v_3693980*2 - 519
    			n_3694059 = 1
    			gotoNext = 3694872
    		case v_3693980 < 273:
    			gotoNext = 3694531
    			_ = gotoNext == 3694531
    			length_3694096 = v_3693980*4 - 1057
    			n_3694059 = 2
    			gotoNext = 3694872
    		case v_3693980 < 277:
    			gotoNext = 3694587
    			_ = gotoNext == 3694587
    			length_3694096 = v_3693980*8 - 2149
    			n_3694059 = 3
    			gotoNext = 3694872
    		case v_3693980 < 281:
    			gotoNext = 3694643
    			_ = gotoNext == 3694643
    			length_3694096 = v_3693980*16 - 4365
    			n_3694059 = 4
    			gotoNext = 3694872
    		case v_3693980 < 285:
    			gotoNext = 3694701
    			_ = gotoNext == 3694701
    			length_3694096 = v_3693980*32 - 8861
    			n_3694059 = 5
    			gotoNext = 3694872
    		case v_3693980 < 286:
    			gotoNext = 3694760
    		...
    		if n_3694059 > 0 {
    			...
    			if f.nb < n_3694059 {
    				gotoNext = 3694899
    				_ = gotoNext == 3694899
    				if err_3693983 = f.moreBits(); err_3693983 != nil {
    					gotoNext = 3694939
    					_ = gotoNext == 3694939
    					f.err = err_3693983
    					return
    			...
    			_ = gotoNext == 3694984
    			length_3694096 += int(f.b & uint32(1<<n_3694059-1))
    			f.b >>= n_3694059
    			f.nb -= n_3694059
    			gotoNext = 3695053
    		} else {
    		...
    		if f.hd == nil {
    			...
    			_ = gotoNext == 3695186
    			dist_3695057 = int(bits.Reverse8(uint8(f.b & 31 << 3)))
    			f.b >>= 5
    			f.nb -= 5
    			gotoNext = 3695360
    		} else {
    			gotoNext = 3695271
    			_ = gotoNext == 3695271
    			if dist_3695057, err_3693983 = f.huffSym(f.hd); err_3693983 != nil {
    				gotoNext = 3695319
    				_ = gotoNext == 3695319
    				f.err = err_3693983
    				return
    		...
    		case dist_3695057 < 4:
    			...
    			dist_3695057++
    			gotoNext = 3695846
    		case dist_3695057 < 30:
    			gotoNext = 3695398
    			_ = gotoNext == 3695398
    			nb_3695425 = uint(dist_3695057-2) >> 1
    			extra_3695502 = (dist_3695057 & 1) << nb_3695425
    			_ = 0
    			gotoNext = 3695531
    			_ = gotoNext == 3695531
    			if f.nb < nb_3695425 {
    			...
    			_ = gotoNext == 3695630
    			extra_3695502 |= int(f.b & uint32(1<<nb_3695425-1))
    			f.b >>= nb_3695425
    			f.nb -= nb_3695425
    			dist_3695057 = 1<<(nb_3695425+1) + 1 + extra_3695502
    			gotoNext = 3695846
    		default:
    			gotoNext = 3695728
    			_ = gotoNext == 3695728
    		...
    		_ = gotoNext == 3695846
    		if dist_3695057 > f.dict.histSize() {
    			gotoNext = 3695874
    			_ = gotoNext == 3695874
    			f.err = CorruptInputError(f.roffset)
    			return
    		...
    		_ = gotoNext == 3695933
    		f.copyLen, f.copyDist = length_3694096, dist_3695057
    		gotoNext = 3695993
    	}
    	gotoNext = 3695993
    	_ = gotoNext == 3695993
    	{
    		cnt_3696072 = f.dict.tryWriteCopy(f.copyDist, f.copyLen)
    		if cnt_3696072 == 0 {
    			gotoNext = 3696136
    			_ = gotoNext == 3696136
    			cnt_3696072 = f.dict.writeCopy(f.copyDist, f.copyLen)
    			gotoNext = 3696193
    		} else {
    			gotoNext = 3696193
    		}
    		_ = gotoNext == 3696193
    		f.copyLen -= cnt_3696072
