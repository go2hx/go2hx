...
@:structInit @:using(Flate.T_compressor_static_extension) @:dox(hide) abstract T_compressor(stdgo._internal.compress.flate.Flate_t_compressor.T_compressor) from stdgo._internal.compress.flate.Flate_t_compressor.T_compressor to stdgo._internal.compress.flate.Flate_t_compressor.T_compressor {
...
@:structInit @:using(Flate.T_dictWriter_static_extension) @:dox(hide) abstract T_dictWriter(stdgo._internal.compress.flate.Flate_t_dictwriter.T_dictWriter) from stdgo._internal.compress.flate.Flate_t_dictwriter.T_dictWriter to stdgo._internal.compress.flate.Flate_t_dictwriter.T_dictWriter {
...
@:structInit @:using(Flate.Writer_static_extension) abstract Writer(stdgo._internal.compress.flate.Flate_writer.Writer) from stdgo._internal.compress.flate.Flate_writer.Writer to stdgo._internal.compress.flate.Flate_writer.Writer {
...
@:structInit @:using(Flate.T_tableEntry_static_extension) @:dox(hide) abstract T_tableEntry(stdgo._internal.compress.flate.Flate_t_tableentry.T_tableEntry) from stdgo._internal.compress.flate.Flate_t_tableentry.T_tableEntry to stdgo._internal.compress.flate.Flate_t_tableentry.T_tableEntry {
...
@:structInit @:using(Flate.T_deflateFast_static_extension) @:dox(hide) abstract T_deflateFast(stdgo._internal.compress.flate.Flate_t_deflatefast.T_deflateFast) from stdgo._internal.compress.flate.Flate_t_deflatefast.T_deflateFast to stdgo._internal.compress.flate.Flate_t_deflatefast.T_deflateFast {
...
@:structInit @:using(Flate.T_dictDecoder_static_extension) @:dox(hide) abstract T_dictDecoder(stdgo._internal.compress.flate.Flate_t_dictdecoder.T_dictDecoder) from stdgo._internal.compress.flate.Flate_t_dictdecoder.T_dictDecoder to stdgo._internal.compress.flate.Flate_t_dictdecoder.T_dictDecoder {
...
@:structInit @:using(Flate.T_hcode_static_extension) @:dox(hide) abstract T_hcode(stdgo._internal.compress.flate.Flate_t_hcode.T_hcode) from stdgo._internal.compress.flate.Flate_t_hcode.T_hcode to stdgo._internal.compress.flate.Flate_t_hcode.T_hcode {
...
@:structInit @:using(Flate.T_literalNode_static_extension) @:dox(hide) abstract T_literalNode(stdgo._internal.compress.flate.Flate_t_literalnode.T_literalNode) from stdgo._internal.compress.flate.Flate_t_literalnode.T_literalNode to stdgo._internal.compress.flate.Flate_t_literalnode.T_literalNode {
...
@:structInit @:using(Flate.T_levelInfo_static_extension) @:dox(hide) abstract T_levelInfo(stdgo._internal.compress.flate.Flate_t_levelinfo.T_levelInfo) from stdgo._internal.compress.flate.Flate_t_levelinfo.T_levelInfo to stdgo._internal.compress.flate.Flate_t_levelinfo.T_levelInfo {
    public var _level(get, set) : StdTypes.Int;
    function get__level():StdTypes.Int return this._level;
    function set__level(v:StdTypes.Int):StdTypes.Int {
...
@:structInit @:using(Flate.ReadError_static_extension) abstract ReadError(stdgo._internal.compress.flate.Flate_readerror.ReadError) from stdgo._internal.compress.flate.Flate_readerror.ReadError to stdgo._internal.compress.flate.Flate_readerror.ReadError {
...
@:structInit @:using(Flate.WriteError_static_extension) abstract WriteError(stdgo._internal.compress.flate.Flate_writeerror.WriteError) from stdgo._internal.compress.flate.Flate_writeerror.WriteError to stdgo._internal.compress.flate.Flate_writeerror.WriteError {
    public var offset(get, set) : haxe.Int64;
    function get_offset():haxe.Int64 return this.offset;
    function set_offset(v:haxe.Int64):haxe.Int64 {
        this.offset = (v : stdgo.GoInt64);
...
@:structInit @:using(Flate.T_huffmanDecoder_static_extension) @:dox(hide) abstract T_huffmanDecoder(stdgo._internal.compress.flate.Flate_t_huffmandecoder.T_huffmanDecoder) from stdgo._internal.compress.flate.Flate_t_huffmandecoder.T_huffmanDecoder to stdgo._internal.compress.flate.Flate_t_huffmandecoder.T_huffmanDecoder {
...
@:structInit @:using(Flate.T_decompressor_static_extension) @:dox(hide) abstract T_decompressor(stdgo._internal.compress.flate.Flate_t_decompressor.T_decompressor) from stdgo._internal.compress.flate.Flate_t_decompressor.T_decompressor to stdgo._internal.compress.flate.Flate_t_decompressor.T_decompressor {
