...
/**
    /|*{
    	...
    	_ = gotoNext == 3708538
    	{
    		gotoNext = 3708627
    		_ = gotoNext == 3708627
    		v_3708631, err_3708634 = f.huffSym(f.hl)
    		if err_3708634 != nil {
    			gotoNext = 3708673
    			_ = gotoNext == 3708673
    			f.err = err_3708634
    		...
    		case v_3708631 < 256:
    			gotoNext = 3708771
    			_ = gotoNext == 3708771
    			f.dict.writeByte(byte(v_3708631))
    		...
    		case v_3708631 < 265:
    			gotoNext = 3709075
    			_ = gotoNext == 3709075
    			length_3708747 = v_3708631 - 254
    			n_3708710 = 0
    			gotoNext = 3709523
    		case v_3708631 < 269:
    			gotoNext = 3709126
    			_ = gotoNext == 3709126
    			length_3708747 = v_3708631*2 - 519
    			n_3708710 = 1
    			gotoNext = 3709523
    		case v_3708631 < 273:
    			gotoNext = 3709182
    			_ = gotoNext == 3709182
    			length_3708747 = v_3708631*4 - 1057
    			n_3708710 = 2
    			gotoNext = 3709523
    		case v_3708631 < 277:
    			gotoNext = 3709238
    			_ = gotoNext == 3709238
    			length_3708747 = v_3708631*8 - 2149
    			n_3708710 = 3
    			gotoNext = 3709523
    		case v_3708631 < 281:
    			gotoNext = 3709294
    			_ = gotoNext == 3709294
    			length_3708747 = v_3708631*16 - 4365
    			n_3708710 = 4
    			gotoNext = 3709523
    		case v_3708631 < 285:
    			gotoNext = 3709352
    			_ = gotoNext == 3709352
    			length_3708747 = v_3708631*32 - 8861
    			n_3708710 = 5
    			gotoNext = 3709523
    		case v_3708631 < 286:
    			gotoNext = 3709411
    		...
    		if n_3708710 > 0 {
    			...
    			if f.nb < n_3708710 {
    				gotoNext = 3709550
    				_ = gotoNext == 3709550
    				if err_3708634 = f.moreBits(); err_3708634 != nil {
    					gotoNext = 3709590
    					_ = gotoNext == 3709590
    					f.err = err_3708634
    					return
    			...
    			_ = gotoNext == 3709635
    			length_3708747 += int(f.b & uint32(1<<n_3708710-1))
    			f.b >>= n_3708710
    			f.nb -= n_3708710
    			gotoNext = 3709704
    		} else {
    		...
    		if f.hd == nil {
    			...
    			_ = gotoNext == 3709837
    			dist_3709708 = int(bits.Reverse8(uint8(f.b & 31 << 3)))
    			f.b >>= 5
    			f.nb -= 5
    			gotoNext = 3710011
    		} else {
    			...
    			gotoNext = 3709922
    			_ = gotoNext == 3709922
    			if dist_3709708, err_3708634 = f.huffSym(f.hd); err_3708634 != nil {
    				gotoNext = 3709970
    				_ = gotoNext == 3709970
    				f.err = err_3708634
    				return
    		...
    		case dist_3709708 < 4:
    			...
    			dist_3709708++
    			gotoNext = 3710497
    		case dist_3709708 < 30:
    			gotoNext = 3710049
    			_ = gotoNext == 3710049
    			nb_3710076 = uint(dist_3709708-2) >> 1
    			extra_3710153 = (dist_3709708 & 1) << nb_3710076
    			_ = 0
    			gotoNext = 3710182
    			_ = gotoNext == 3710182
    			if f.nb < nb_3710076 {
    			...
    			_ = gotoNext == 3710281
    			extra_3710153 |= int(f.b & uint32(1<<nb_3710076-1))
    			f.b >>= nb_3710076
    			f.nb -= nb_3710076
    			dist_3709708 = 1<<(nb_3710076+1) + 1 + extra_3710153
    			gotoNext = 3710497
    		default:
    			gotoNext = 3710379
    			_ = gotoNext == 3710379
    		...
    		_ = gotoNext == 3710497
    		if dist_3709708 > f.dict.histSize() {
    			gotoNext = 3710525
    			_ = gotoNext == 3710525
    			f.err = CorruptInputError(f.roffset)
    			return
    		...
    		_ = gotoNext == 3710584
    		f.copyLen, f.copyDist = length_3708747, dist_3709708
    		gotoNext = 3710644
    		gotoNext = 3710644
    	}
    	_ = gotoNext == 3710644
    	...
    	_ = gotoNext == 3710644
    	{
    		gotoNext = 3710719
    		_ = gotoNext == 3710719
    		cnt_3710723 = f.dict.tryWriteCopy(f.copyDist, f.copyLen)
    		if cnt_3710723 == 0 {
    			gotoNext = 3710787
    			_ = gotoNext == 3710787
    			cnt_3710723 = f.dict.writeCopy(f.copyDist, f.copyLen)
    			gotoNext = 3710844
    		} else {
    			gotoNext = 3710844
    		}
    		_ = gotoNext == 3710844
    		f.copyLen -= cnt_3710723
