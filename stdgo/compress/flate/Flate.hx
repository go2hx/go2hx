...
/**
    /|*{
    	...
    	_ = gotoNext == 3701764
    	{
    		v_3701857, err_3701860 = f.huffSym(f.hl)
    		if err_3701860 != nil {
    			gotoNext = 3701899
    			_ = gotoNext == 3701899
    			f.err = err_3701860
    		...
    		case v_3701857 < 256:
    			gotoNext = 3701997
    			_ = gotoNext == 3701997
    			f.dict.writeByte(byte(v_3701857))
    		...
    		case v_3701857 < 265:
    			gotoNext = 3702301
    			_ = gotoNext == 3702301
    			length_3701973 = v_3701857 - 254
    			n_3701936 = 0
    			gotoNext = 3702749
    		case v_3701857 < 269:
    			gotoNext = 3702352
    			_ = gotoNext == 3702352
    			length_3701973 = v_3701857*2 - 519
    			n_3701936 = 1
    			gotoNext = 3702749
    		case v_3701857 < 273:
    			gotoNext = 3702408
    			_ = gotoNext == 3702408
    			length_3701973 = v_3701857*4 - 1057
    			n_3701936 = 2
    			gotoNext = 3702749
    		case v_3701857 < 277:
    			gotoNext = 3702464
    			_ = gotoNext == 3702464
    			length_3701973 = v_3701857*8 - 2149
    			n_3701936 = 3
    			gotoNext = 3702749
    		case v_3701857 < 281:
    			gotoNext = 3702520
    			_ = gotoNext == 3702520
    			length_3701973 = v_3701857*16 - 4365
    			n_3701936 = 4
    			gotoNext = 3702749
    		case v_3701857 < 285:
    			gotoNext = 3702578
    			_ = gotoNext == 3702578
    			length_3701973 = v_3701857*32 - 8861
    			n_3701936 = 5
    			gotoNext = 3702749
    		case v_3701857 < 286:
    			gotoNext = 3702637
    		...
    		if n_3701936 > 0 {
    			...
    			if f.nb < n_3701936 {
    				gotoNext = 3702776
    				_ = gotoNext == 3702776
    				if err_3701860 = f.moreBits(); err_3701860 != nil {
    					gotoNext = 3702816
    					_ = gotoNext == 3702816
    					f.err = err_3701860
    					return
    			...
    			_ = gotoNext == 3702861
    			length_3701973 += int(f.b & uint32(1<<n_3701936-1))
    			f.b >>= n_3701936
    			f.nb -= n_3701936
    			gotoNext = 3702930
    		} else {
    		...
    		if f.hd == nil {
    			...
    			_ = gotoNext == 3703063
    			dist_3702934 = int(bits.Reverse8(uint8(f.b & 31 << 3)))
    			f.b >>= 5
    			f.nb -= 5
    			gotoNext = 3703237
    		} else {
    			gotoNext = 3703148
    			_ = gotoNext == 3703148
    			if dist_3702934, err_3701860 = f.huffSym(f.hd); err_3701860 != nil {
    				gotoNext = 3703196
    				_ = gotoNext == 3703196
    				f.err = err_3701860
    				return
    		...
    		case dist_3702934 < 4:
    			...
    			dist_3702934++
    			gotoNext = 3703723
    		case dist_3702934 < 30:
    			gotoNext = 3703275
    			_ = gotoNext == 3703275
    			nb_3703302 = uint(dist_3702934-2) >> 1
    			extra_3703379 = (dist_3702934 & 1) << nb_3703302
    			_ = 0
    			gotoNext = 3703408
    			_ = gotoNext == 3703408
    			if f.nb < nb_3703302 {
    			...
    			_ = gotoNext == 3703507
    			extra_3703379 |= int(f.b & uint32(1<<nb_3703302-1))
    			f.b >>= nb_3703302
    			f.nb -= nb_3703302
    			dist_3702934 = 1<<(nb_3703302+1) + 1 + extra_3703379
    			gotoNext = 3703723
    		default:
    			gotoNext = 3703605
    			_ = gotoNext == 3703605
    		...
    		_ = gotoNext == 3703723
    		if dist_3702934 > f.dict.histSize() {
    			gotoNext = 3703751
    			_ = gotoNext == 3703751
    			f.err = CorruptInputError(f.roffset)
    			return
    		...
    		_ = gotoNext == 3703810
    		f.copyLen, f.copyDist = length_3701973, dist_3702934
    		gotoNext = 3703870
    	}
    	gotoNext = 3703870
    	_ = gotoNext == 3703870
    	{
    		cnt_3703949 = f.dict.tryWriteCopy(f.copyDist, f.copyLen)
    		if cnt_3703949 == 0 {
    			gotoNext = 3704013
    			_ = gotoNext == 3704013
    			cnt_3703949 = f.dict.writeCopy(f.copyDist, f.copyLen)
    			gotoNext = 3704070
    		} else {
    			gotoNext = 3704070
    		}
    		_ = gotoNext == 3704070
    		f.copyLen -= cnt_3703949
