...
@:structInit class T_compressionLevel {
    ...
    public function new(?_level:GoInt, ?_good:GoInt, ?_lazy:GoInt, ?_nice:GoInt, ?_chain:GoInt, ?_fastSkipHashing:GoInt) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_level) + " " + Go.string(_good) + " " + Go.string(_lazy) + " " + Go.string(_nice) + " " + Go.string(_chain) + " " + Go.string(_fastSkipHashing) + "}";
    }
...
@:structInit class T_compressor {
    ...
    public function _deflate():Void {
        ...
        stdgo.internal.Macro.controlFlow({
            ...
            @:label("Loop") while (true) {
                ...
                if (_d.value._chainHead - _d.value._hashOffset >= _minIndex && (_d.value._compressionLevel._fastSkipHashing != _skipNever && _lookahead > _minMatchLength - ((1 : GoUnTypedInt)) || _d.value._compressionLevel._fastSkipHashing == _skipNever && _lookahead > _prevLength && _prevLength < _d.value._compressionLevel._lazy)) {
                    {
                        var __tmp__ = _d.value._findMatch(_d.value._index, _d.value._chainHead - _d.value._hashOffset, _minMatchLength - ((1 : GoUnTypedInt)), _lookahead), _newLength:GoInt = __tmp__._0, _newOffset:GoInt = __tmp__._1, _ok:Bool = __tmp__._2;
                        if (_ok) {
                ...
                if (_d.value._compressionLevel._fastSkipHashing != _skipNever && _d.value._length >= _minMatchLength || _d.value._compressionLevel._fastSkipHashing == _skipNever && _prevLength >= _minMatchLength && _d.value._length <= _prevLength) {
                    if (_d.value._compressionLevel._fastSkipHashing != _skipNever) {
                        _d.value._tokens = _d.value._tokens.__append__(_matchToken((((_d.value._length - _baseMatchLength) : GoUInt32)), (((_d.value._offset - _baseMatchOffset) : GoUInt32))));
                    } else {
                        _d.value._tokens = _d.value._tokens.__append__(_matchToken((((_prevLength - _baseMatchLength) : GoUInt32)), (((_prevOffset - _baseMatchOffset) : GoUInt32))));
                    };
    ...
    public function _initDeflate():Void {
        var _d = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        _d.value._window = new Slice<GoUInt8>(...[for (i in 0 ... ((((2 : GoUnTypedInt)) * _windowSize : GoInt)).toBasic()) ((0 : GoUInt8))]);
        _d.value._hashOffset = ((1 : GoInt));
        _d.value._tokens = new Slice<T_token>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) new T_token()]).setCap(((_maxFlateBlockTokens + ((1 : GoUnTypedInt)) : GoInt)).toBasic());
        _d.value._length = _minMatchLength - ((1 : GoUnTypedInt));
        _d.value._offset = ((0 : GoInt));
        _d.value._byteAvailable = false;
    ...
    public function new(?_compressionLevel:T_compressionLevel, ?_w:Pointer<T_huffmanBitWriter>, ?_bulkHasher:(Slice<GoUInt8>, Slice<GoUInt32>) -> Void, ?_fill:(Pointer<T_compressor>, Slice<GoUInt8>) -> GoInt, ?_step:Pointer<T_compressor> -> Void, ?_sync:Bool, ?_bestSpeed:Pointer<T_deflateFast>, ?_chainHead:GoInt, ?_hashHead:GoArray<GoUInt32>, ?_hashPrev:GoArray<GoUInt32>, ?_hashOffset:GoInt, ?_index:GoInt, ?_window:Slice<GoUInt8>, ?_windowEnd:GoInt, ?_blockStart:GoInt, ?_byteAvailable:Bool, ?_tokens:Slice<T_token>, ?_length:GoInt, ?_offset:GoInt, ?_hash:GoUInt32, ?_maxInsertIndex:GoInt, ?_err:stdgo.Error, ?_hashMatch:GoArray<GoUInt32>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_compressionLevel) + " " + Go.string(_w) + " " + Go.string(_bulkHasher) + " " + Go.string(_fill) + " " + Go.string(_step) + " " + Go.string(_sync) + " " + Go.string(_bestSpeed) + " " + Go.string(_chainHead) + " " + Go.string(_hashHead) + " " + Go.string(_hashPrev) + " " + Go.string(_hashOffset) + " " + Go.string(_index) + " " + Go.string(_window) + " " + Go.string(_windowEnd) + " " + Go.string(_blockStart) + " " + Go.string(_byteAvailable) + " " + Go.string(_tokens) + " " + Go.string(_length) + " " + Go.string(_offset) + " " + Go.string(_hash) + " " + Go.string(_maxInsertIndex) + " " + Go.string(_err) + " " + Go.string(_hashMatch) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_dictWriter {
    ...
    public function new(?_w:stdgo.io.Io.Writer) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_w) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
...
@:structInit class Writer {
    ...
    public function new(?_d:T_compressor, ?_dict:Slice<GoUInt8>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_tableEntry {
    ...
    public function new(?_val:GoUInt32, ?_offset:GoInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_deflateFast {
        ...
        return stdgo.internal.Macro.controlFlow({
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    _e.value._table[_prevHash & _tableMask] = (({ _offset : _e.value._cur + _s - ((1 : GoInt32)), _val : ((_x : GoUInt32)) } : T_tableEntry)).__copy__();
    ...
    public function new(?_table:GoArray<T_tableEntry>, ?_prev:Slice<GoUInt8>, ?_cur:GoInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_dictDecoder {
    ...
    public function _init(_size:GoInt, _dict:Slice<GoByte>):Void {
        var _dd = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        _dd.value = (({ _hist : _dd.value._hist, _wrPos : 0, _rdPos : 0, _full : false } : T_dictDecoder)).__copy__();
    ...
    public function new(?_hist:Slice<GoUInt8>, ?_wrPos:GoInt, ?_rdPos:GoInt, ?_full:Bool) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_huffmanBitWriter {
    public function _writeBlockHuff(_eof:Bool, _input:Slice<GoByte>):Void {
        ...
        var __tmp__ = _w.value._dynamicSize(_w.value._literalEncoding, _huffOffset, ((0 : GoInt))), _size:GoInt = __tmp__._0, _numCodegens:GoInt = __tmp__._1;
        {
            var __tmp__ = _w.value._storedSize(_input), _ssize:GoInt = __tmp__._0, _storable:Bool = __tmp__._1;
    ...
    public function _writeBlockDynamic(_tokens:Slice<T_token>, _eof:Bool, _input:Slice<GoByte>):Void {
        ...
        var __tmp__ = _w.value._indexTokens(_tokens), _numLiterals:GoInt = __tmp__._0, _numOffsets:GoInt = __tmp__._1;
        _w.value._generateCodegen(_numLiterals, _numOffsets, _w.value._literalEncoding, _w.value._offsetEncoding);
        _w.value._codegenEncoding.value._generate(_w.value._codegenFreq.__slice__(0), ((7 : GoInt32)));
        var __tmp__ = _w.value._dynamicSize(_w.value._literalEncoding, _w.value._offsetEncoding, ((0 : GoInt))), _size:GoInt = __tmp__._0, _numCodegens:GoInt = __tmp__._1;
        {
            var __tmp__ = _w.value._storedSize(_input), _ssize:GoInt = __tmp__._0, _storable:Bool = __tmp__._1;
            if (_storable && _ssize < (_size + (_size >> ((4 : GoUnTypedInt))))) {
                _w.value._writeStoredHeader(_input.length, _eof);
    ...
    public function _writeBlock(_tokens:Slice<T_token>, _eof:Bool, _input:Slice<GoByte>):Void {
        ...
        var __tmp__ = _w.value._storedSize(_input), _storedSize:GoInt = __tmp__._0, _storable:Bool = __tmp__._1;
        if (_storable) {
            {
        ...
        _w.value._generateCodegen(_numLiterals, _numOffsets, _w.value._literalEncoding, _w.value._offsetEncoding);
        _w.value._codegenEncoding.value._generate(_w.value._codegenFreq.__slice__(0), ((7 : GoInt32)));
        var __tmp__ = _w.value._dynamicSize(_w.value._literalEncoding, _w.value._offsetEncoding, _extraBits), _dynamicSize:GoInt = __tmp__._0, _numCodegens:GoInt = __tmp__._1;
    ...
    public function _fixedSize(_extraBits:GoInt):GoInt {
        var _w = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        return ((3 : GoInt)) + _fixedLiteralEncoding.value._bitLength(_w.value._literalFreq) + _fixedOffsetEncoding.value._bitLength(_w.value._offsetFreq) + _extraBits;
    }
    public function _dynamicSize(_litEnc:Pointer<T_huffmanEncoder>, _offEnc:Pointer<T_huffmanEncoder>, _extraBits:GoInt):{ var _0 : GoInt; var _1 : GoInt; } {
        ...
        var _header:GoInt = ((3 : GoUnTypedInt)) + ((5 : GoUnTypedInt)) + ((5 : GoUnTypedInt)) + ((4 : GoUnTypedInt)) + (((3 : GoInt)) * _numCodegens) + _w.value._codegenEncoding.value._bitLength(_w.value._codegenFreq.__slice__(0)) + ((_w.value._codegenFreq[((16 : GoInt))] : GoInt)) * ((2 : GoInt)) + ((_w.value._codegenFreq[((17 : GoInt))] : GoInt)) * ((3 : GoInt)) + ((_w.value._codegenFreq[((18 : GoInt))] : GoInt)) * ((7 : GoInt));
    ...
    public var _err : stdgo.Error = ((null : stdgo.Error));
    public function new(?_writer:stdgo.io.Io.Writer, ?_bits:GoUInt64, ?_nbits:GoUInt, ?_bytes:GoArray<GoUInt8>, ?_codegenFreq:GoArray<GoInt32>, ?_nbytes:GoInt, ?_literalFreq:Slice<GoInt32>, ?_offsetFreq:Slice<GoInt32>, ?_codegen:Slice<GoUInt8>, ?_literalEncoding:Pointer<T_huffmanEncoder>, ?_offsetEncoding:Pointer<T_huffmanEncoder>, ?_codegenEncoding:Pointer<T_huffmanEncoder>, ?_err:stdgo.Error) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_writer) + " " + Go.string(_bits) + " " + Go.string(_nbits) + " " + Go.string(_bytes) + " " + Go.string(_codegenFreq) + " " + Go.string(_nbytes) + " " + Go.string(_literalFreq) + " " + Go.string(_offsetFreq) + " " + Go.string(_codegen) + " " + Go.string(_literalEncoding) + " " + Go.string(_offsetEncoding) + " " + Go.string(_codegenEncoding) + " " + Go.string(_err) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_hcode {
    ...
    public function new(?_code:GoUInt16, ?_len:GoUInt16) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_huffmanEncoder {
    public function _generate(_freq:Slice<GoInt32>, _maxBits:GoInt32):Void {
        ...
        if (_h.value._freqcache == null || _h.value._freqcache.isNil()) {
            _h.value._freqcache = new Slice<T_literalNode>(...[for (i in 0 ... ((_maxNumLit + ((1 : GoUnTypedInt)) : GoInt)).toBasic()) new T_literalNode()]);
        };
    ...
    public function _bitCounts(_list:Slice<T_literalNode>, _maxBits:GoInt32):Slice<GoInt32> {
        ...
        var _leafCounts:GoArray<GoArray<GoInt32>> = new GoArray<GoArray<GoInt32>>(...[for (i in 0 ... 16) new GoArray<GoInt32>(...[for (i in 0 ... 16) ((0 : GoInt32))])]);
        {
            ...
            Go.cfor(_level <= _maxBits, _level++, {
                _levels[_level] = (({ _level : _level, _lastFreq : _list[((1 : GoInt))]._freq, _nextCharFreq : _list[((2 : GoInt))]._freq, _nextPairFreq : _list[((0 : GoInt))]._freq + _list[((1 : GoInt))]._freq, _needed : 0 } : T_levelInfo)).__copy__();
    ...
    public function new(?_codes:Slice<T_hcode>, ?_freqcache:Slice<T_literalNode>, ?_bitCount:GoArray<GoInt32>, ?_lns:T_byLiteral, ?_lfs:T_byFreq) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_codes) + " " + Go.string(_freqcache) + " " + Go.string(_bitCount) + " " + Go.string(_lns) + " " + Go.string(_lfs) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_literalNode {
    ...
    public function new(?_literal:GoUInt16, ?_freq:GoInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_levelInfo {
    ...
    public function new(?_level:GoInt32, ?_lastFreq:GoInt32, ?_nextCharFreq:GoInt32, ?_nextPairFreq:GoInt32, ?_needed:GoInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_level) + " " + Go.string(_lastFreq) + " " + Go.string(_nextCharFreq) + " " + Go.string(_nextPairFreq) + " " + Go.string(_needed) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:named class T_byLiteral {
    ...
    public function __copy__() return new T_byLiteral(__t__);
    public function __append__(args:haxe.Rest<T_literalNode>) return new T_byLiteral(this.__t__.__append__(...args));
    public function __slice__(low:GoInt, high:GoInt = -1) return new T_byLiteral(this.__t__.__slice__(low, high));
}
@:named class T_byFreq {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new T_byFreq(__t__);
    public function __append__(args:haxe.Rest<T_literalNode>) return new T_byFreq(this.__t__.__append__(...args));
    public function __slice__(low:GoInt, high:GoInt = -1) return new T_byFreq(this.__t__.__slice__(low, high));
}
...
@:named class InternalError {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new InternalError(__t__);
}
@:structInit class ReadError {
    public function error():GoString {
        var _e = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        return (("flate: read error at offset " : GoString)) + stdgo.strconv.Strconv.formatInt(_e.value.offset, ((10 : GoInt))) + ((": " : GoString)) + _e.value.err.error();
    }
    public var offset : GoInt64 = ((0 : GoInt64));
    public var err : stdgo.Error = ((null : stdgo.Error));
    public function new(?offset:GoInt64, ?err:stdgo.Error) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class WriteError {
    public function error():GoString {
        var _e = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        return (("flate: write error at offset " : GoString)) + stdgo.strconv.Strconv.formatInt(_e.value.offset, ((10 : GoInt))) + ((": " : GoString)) + _e.value.err.error();
    }
    public var offset : GoInt64 = ((0 : GoInt64));
    public var err : stdgo.Error = ((null : stdgo.Error));
    public function new(?offset:GoInt64, ?err:stdgo.Error) stdgo.internal.Macro.initLocals();
...
@:structInit class T_huffmanDecoder {
    public function _init(_lengths:Slice<GoInt>):Bool {
        ...
        if (_max > _huffmanChunkBits) {
            ...
            _h.value._links = new Slice<Slice<GoUInt32>>(...[for (i in 0 ... ((_huffmanNumChunks - _link : GoInt)).toBasic()) new Slice<GoUInt32>().nil()]);
            {
    ...
    public function new(?_min:GoInt, ?_chunks:GoArray<GoUInt32>, ?_links:Slice<Slice<GoUInt32>>, ?_linkMask:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_decompressor {
    public function reset(_r:stdgo.io.Io.Reader, _dict:Slice<GoByte>):Error {
        ...
        _f.value = (({ _r : _makeReader(_r), _bits : _f.value._bits, _codebits : _f.value._codebits, _dict : _f.value._dict.__copy__(), _step : (_decompressor.value).value._nextBlock, _roffset : 0, _b : 0, _nb : 0, _h1 : new T_huffmanDecoder(), _h2 : new T_huffmanDecoder(), _buf : new GoArray<GoUInt8>(...[for (i in 0 ... 4) ((0 : GoUInt8))]), _stepState : 0, _final : false, _err : ((null : stdgo.Error)), _toRead : new Slice<GoUInt8>().nil(), _hl : new Pointer<T_huffmanDecoder>().nil(), _hd : new Pointer<T_huffmanDecoder>().nil(), _copyLen : 0, _copyDist : 0 } : T_decompressor)).__copy__();
    ...
    public function _huffSym(_h:Pointer<T_huffmanDecoder>):{ var _0 : GoInt; var _1 : Error; } {
        ...
        while (true) {
            while (_nb < _n) {
                var __tmp__ = _f.value._r.readByte(), _c:GoUInt8 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    _f.value._b = _b;
                    _f.value._nb = _nb;
    ...
    public function _copyData():Void {
        ...
        var __tmp__ = stdgo.io.Io.readFull(_f.value._r, _buf), _cnt:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
    ...
    public function _dataBlock():Void {
        ...
        var __tmp__ = stdgo.io.Io.readFull(_f.value._r, _f.value._buf.__slice__(((0 : GoInt)), ((4 : GoInt)))), _nr:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
    ...
    public function _huffmanBlock():Void {
        ...
        stdgo.internal.Macro.controlFlow({
            ...
            @:label("readLiteral") {
                var __tmp__ = _f.value._huffSym(_f.value._hl), _v:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    _f.value._err = _err;
                    return;
                };
    ...
    public function _readHuffman():Error {
        ...
        };
        {
            ...
            while (_i < _n) {
                var __tmp__ = _f.value._huffSym(Go.pointer(_f.value._h1)), _x:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    return _err;
                };
                if (_x < ((16 : GoInt))) {
        ...
        if (!_f.value._h1._init(_f.value._bits.value.__slice__(((0 : GoInt)), _nlit)) || !_f.value._h2._init(_f.value._bits.value.__slice__(_nlit, _nlit + _ndist))) {
            return new CorruptInputError(_f.value._roffset);
        };
    ...
    public function new(?_r:Reader, ?_roffset:GoInt64, ?_b:GoUInt32, ?_nb:GoUInt, ?_h1:T_huffmanDecoder, ?_h2:T_huffmanDecoder, ?_bits:Pointer<GoArray<GoInt>>, ?_codebits:Pointer<GoArray<GoInt>>, ?_dict:T_dictDecoder, ?_buf:GoArray<GoUInt8>, ?_step:Pointer<T_decompressor> -> Void, ?_stepState:GoInt, ?_final:Bool, ?_err:stdgo.Error, ?_toRead:Slice<GoUInt8>, ?_hl:Pointer<T_huffmanDecoder>, ?_hd:Pointer<T_huffmanDecoder>, ?_copyLen:GoInt, ?_copyDist:GoInt) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_r) + " " + Go.string(_roffset) + " " + Go.string(_b) + " " + Go.string(_nb) + " " + Go.string(_h1) + " " + Go.string(_h2) + " " + Go.string(_bits) + " " + Go.string(_codebits) + " " + Go.string(_dict) + " " + Go.string(_buf) + " " + Go.string(_step) + " " + Go.string(_stepState) + " " + Go.string(_final) + " " + Go.string(_err) + " " + Go.string(_toRead) + " " + Go.string(_hl) + " " + Go.string(_hd) + " " + Go.string(_copyLen) + " " + Go.string(_copyDist) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:named class T_token {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new T_token(__t__);
}
...
var _levels : Slice<T_compressionLevel> = new Slice<T_compressionLevel>(new T_compressionLevel(((0 : GoInt)), ((0 : GoInt)), ((0 : GoInt)), ((0 : GoInt)), ((0 : GoInt)), ((0 : GoInt))).__copy__(), new T_compressionLevel(((1 : GoInt)), ((0 : GoInt)), ((0 : GoInt)), ((0 : GoInt)), ((0 : GoInt)), ((0 : GoInt))).__copy__(), new T_compressionLevel(((2 : GoInt)), ((4 : GoInt)), ((0 : GoInt)), ((16 : GoInt)), ((8 : GoInt)), ((5 : GoInt))).__copy__(), new T_compressionLevel(((3 : GoInt)), ((4 : GoInt)), ((0 : GoInt)), ((32 : GoInt)), ((32 : GoInt)), ((6 : GoInt))).__copy__(), new T_compressionLevel(((4 : GoInt)), ((4 : GoInt)), ((4 : GoInt)), ((16 : GoInt)), ((16 : GoInt)), _skipNever).__copy__(), new T_compressionLevel(((5 : GoInt)), ((8 : GoInt)), ((16 : GoInt)), ((32 : GoInt)), ((32 : GoInt)), _skipNever).__copy__(), new T_compressionLevel(((6 : GoInt)), ((8 : GoInt)), ((16 : GoInt)), ((128 : GoInt)), ((128 : GoInt)), _skipNever).__copy__(), new T_compressionLevel(((7 : GoInt)), ((8 : GoInt)), ((32 : GoInt)), ((128 : GoInt)), ((256 : GoInt)), _skipNever).__copy__(), new T_compressionLevel(((8 : GoInt)), ((32 : GoInt)), ((128 : GoInt)), ((258 : GoInt)), ((1024 : GoInt)), _skipNever).__copy__(), new T_compressionLevel(((9 : GoInt)), ((32 : GoInt)), ((258 : GoInt)), ((258 : GoInt)), ((4096 : GoInt)), _skipNever).__copy__());
...
function _hash4(_b:Slice<GoByte>):GoUInt32 {
        return (((((_b[((3 : GoInt))] : GoUInt32)) | (((_b[((2 : GoInt))] : GoUInt32)) << ((8 : GoUnTypedInt))) | (((_b[((1 : GoInt))] : GoUInt32)) << ((16 : GoUnTypedInt))) | (((_b[((0 : GoInt))] : GoUInt32)) << ((24 : GoUnTypedInt)))) * _hashmul) >> (((32 : GoUnTypedInt)) - _hashBits));
    }
/**
...
function newWriterDict(_w:stdgo.io.Io.Writer, _level:GoInt, _dict:Slice<GoByte>):{ var _0 : Pointer<Writer>; var _1 : Error; } {
        ...
        var __tmp__ = newWriter(_dw.value, _level), _zw:Pointer<Writer> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<Writer>().nil(), _1 : _err };
        };
...
function _load32(_b:Slice<GoByte>, _i:GoInt32):GoUInt32 {
        ...
        return ((_b[((0 : GoInt))] : GoUInt32)) | (((_b[((1 : GoInt))] : GoUInt32)) << ((8 : GoUnTypedInt))) | (((_b[((2 : GoInt))] : GoUInt32)) << ((16 : GoUnTypedInt))) | (((_b[((3 : GoInt))] : GoUInt32)) << ((24 : GoUnTypedInt)));
    }
function _load64(_b:Slice<GoByte>, _i:GoInt32):GoUInt64 {
        _b = _b.__slice__(_i, _i + ((8 : GoInt32))).setCap(((_b.length : GoInt)) - ((1 : GoInt)));
        return ((_b[((0 : GoInt))] : GoUInt64)) | (((_b[((1 : GoInt))] : GoUInt64)) << ((8 : GoUnTypedInt))) | (((_b[((2 : GoInt))] : GoUInt64)) << ((16 : GoUnTypedInt))) | (((_b[((3 : GoInt))] : GoUInt64)) << ((24 : GoUnTypedInt))) | (((_b[((4 : GoInt))] : GoUInt64)) << ((32 : GoUnTypedInt))) | (((_b[((5 : GoInt))] : GoUInt64)) << ((40 : GoUnTypedInt))) | (((_b[((6 : GoInt))] : GoUInt64)) << ((48 : GoUnTypedInt))) | (((_b[((7 : GoInt))] : GoUInt64)) << ((56 : GoUnTypedInt)));
    }
...
function _newDeflateFast():Pointer<T_deflateFast> {
        return Go.pointer((({ _cur : _maxStoreBlockSize, _prev : new Slice<GoUInt8>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((_maxStoreBlockSize : GoInt)).toBasic()), _table : new GoArray<T_tableEntry>(...[for (i in 0 ... 16384) new T_tableEntry()]) } : T_deflateFast)));
    }
...
function _newHuffmanBitWriter(_w:stdgo.io.Io.Writer):Pointer<T_huffmanBitWriter> {
        return Go.pointer((({ _writer : _w, _literalFreq : new Slice<GoInt32>(...[for (i in 0 ... ((_maxNumLit : GoInt)).toBasic()) ((0 : GoInt32))]), _offsetFreq : new Slice<GoInt32>(...[for (i in 0 ... ((_offsetCodeCount : GoInt)).toBasic()) ((0 : GoInt32))]), _codegen : new Slice<GoUInt8>(...[for (i in 0 ... ((_maxNumLit + _offsetCodeCount + ((1 : GoUnTypedInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]), _literalEncoding : _newHuffmanEncoder(_maxNumLit), _codegenEncoding : _newHuffmanEncoder(_codegenCodeCount), _offsetEncoding : _newHuffmanEncoder(_offsetCodeCount), _bits : 0, _nbits : 0, _bytes : new GoArray<GoUInt8>(...[for (i in 0 ... 248) ((0 : GoUInt8))]), _codegenFreq : new GoArray<GoInt32>(...[for (i in 0 ... 19) ((0 : GoInt32))]), _nbytes : 0, _err : ((null : stdgo.Error)) } : T_huffmanBitWriter)));
    }
/**
...
function _newHuffmanEncoder(_size:GoInt):Pointer<T_huffmanEncoder> {
        return Go.pointer((({ _codes : new Slice<T_hcode>(...[for (i in 0 ... ((_size : GoInt)).toBasic()) new T_hcode()]), _freqcache : new Slice<T_literalNode>().nil(), _bitCount : new GoArray<GoInt32>(...[for (i in 0 ... 17) ((0 : GoInt32))]), _lns : new T_byLiteral(), _lfs : new T_byFreq() } : T_huffmanEncoder)));
    }
/**
...
class T_compressor_extension_fields {
    public function _fillDeflate(__tmp__, _b:Slice<GoByte>):GoInt return __tmp__._fillDeflate(_b);
    public function _writeBlock(__tmp__, _tokens:Slice<T_token>, _index:GoInt):Error return __tmp__._writeBlock(_tokens, _index);
    public function _fillWindow(__tmp__, _b:Slice<GoByte>):Void __tmp__._fillWindow(_b);
    public function _findMatch(__tmp__, _pos:GoInt, _prevHead:GoInt, _prevLength:GoInt, _lookahead:GoInt):{ var _0 : GoInt; var _1 : GoInt; var _2 : Bool; } return __tmp__._findMatch(_pos, _prevHead, _prevLength, _lookahead);
    public function _writeStoredBlock(__tmp__, _buf:Slice<GoByte>):Error return __tmp__._writeStoredBlock(_buf);
    public function _encSpeed(__tmp__):Void __tmp__._encSpeed();
    public function _initDeflate(__tmp__):Void __tmp__._initDeflate();
    public function _deflate(__tmp__):Void __tmp__._deflate();
    public function _fillStore(__tmp__, _b:Slice<GoByte>):GoInt return __tmp__._fillStore(_b);
    public function _store(__tmp__):Void __tmp__._store();
    public function _storeHuff(__tmp__):Void __tmp__._storeHuff();
    public function _write(__tmp__, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } return __tmp__._write(_b);
    public function _syncFlush(__tmp__):Error return __tmp__._syncFlush();
    public function _init(__tmp__, _w:stdgo.io.Io.Writer, _level:GoInt):Error return __tmp__._init(_w, _level);
    public function _reset(__tmp__, _w:stdgo.io.Io.Writer):Void __tmp__._reset(_w);
...
class Writer_extension_fields {
    ...
    public function reset(__tmp__, _dst:stdgo.io.Io.Writer):Void __tmp__.reset(_dst);
}
class T_deflateFast_extension_fields {
    public function _encode(__tmp__, _dst:Slice<T_token>, _src:Slice<GoByte>):Slice<T_token> return __tmp__._encode(_dst, _src);
    public function _matchLen(__tmp__, _s:GoInt32, _t:GoInt32, _src:Slice<GoByte>):GoInt32 return __tmp__._matchLen(_s, _t, _src);
    public function _reset(__tmp__):Void __tmp__._reset();
    public function _shiftOffsets(__tmp__):Void __tmp__._shiftOffsets();
}
class T_dictDecoder_extension_fields {
    public function _init(__tmp__, _size:GoInt, _dict:Slice<GoByte>):Void __tmp__._init(_size, _dict);
    public function _histSize(__tmp__):GoInt return __tmp__._histSize();
    public function _availRead(__tmp__):GoInt return __tmp__._availRead();
    public function _availWrite(__tmp__):GoInt return __tmp__._availWrite();
    public function _writeSlice(__tmp__):Slice<GoByte> return __tmp__._writeSlice();
    public function _writeMark(__tmp__, _cnt:GoInt):Void __tmp__._writeMark(_cnt);
    public function _writeByte(__tmp__, _c:GoByte):Void __tmp__._writeByte(_c);
    public function _writeCopy(__tmp__, _dist:GoInt, _length:GoInt):GoInt return __tmp__._writeCopy(_dist, _length);
    public function _tryWriteCopy(__tmp__, _dist:GoInt, _length:GoInt):GoInt return __tmp__._tryWriteCopy(_dist, _length);
    public function _readFlush(__tmp__):Slice<GoByte> return __tmp__._readFlush();
}
class T_huffmanBitWriter_extension_fields {
    public function _reset(__tmp__, _writer:stdgo.io.Io.Writer):Void __tmp__._reset(_writer);
    public function _flush(__tmp__):Void __tmp__._flush();
    public function _write(__tmp__, _b:Slice<GoByte>):Void __tmp__._write(_b);
    public function _writeBits(__tmp__, _b:GoInt32, _nb:GoUInt):Void __tmp__._writeBits(_b, _nb);
    public function _writeBytes(__tmp__, _bytes:Slice<GoByte>):Void __tmp__._writeBytes(_bytes);
    public function _generateCodegen(__tmp__, _numLiterals:GoInt, _numOffsets:GoInt, _litEnc:Pointer<T_huffmanEncoder>, _offEnc:Pointer<T_huffmanEncoder>):Void __tmp__._generateCodegen(_numLiterals, _numOffsets, _litEnc, _offEnc);
    public function _dynamicSize(__tmp__, _litEnc:Pointer<T_huffmanEncoder>, _offEnc:Pointer<T_huffmanEncoder>, _extraBits:GoInt):{ var _0 : GoInt; var _1 : GoInt; } return __tmp__._dynamicSize(_litEnc, _offEnc, _extraBits);
    public function _fixedSize(__tmp__, _extraBits:GoInt):GoInt return __tmp__._fixedSize(_extraBits);
    public function _storedSize(__tmp__, _in:Slice<GoByte>):{ var _0 : GoInt; var _1 : Bool; } return __tmp__._storedSize(_in);
    public function _writeCode(__tmp__, _c:T_hcode):Void __tmp__._writeCode(_c);
    public function _writeDynamicHeader(__tmp__, _numLiterals:GoInt, _numOffsets:GoInt, _numCodegens:GoInt, _isEof:Bool):Void __tmp__._writeDynamicHeader(_numLiterals, _numOffsets, _numCodegens, _isEof);
    public function _writeStoredHeader(__tmp__, _length:GoInt, _isEof:Bool):Void __tmp__._writeStoredHeader(_length, _isEof);
    public function _writeFixedHeader(__tmp__, _isEof:Bool):Void __tmp__._writeFixedHeader(_isEof);
    public function _writeBlock(__tmp__, _tokens:Slice<T_token>, _eof:Bool, _input:Slice<GoByte>):Void __tmp__._writeBlock(_tokens, _eof, _input);
    public function _writeBlockDynamic(__tmp__, _tokens:Slice<T_token>, _eof:Bool, _input:Slice<GoByte>):Void __tmp__._writeBlockDynamic(_tokens, _eof, _input);
    public function _indexTokens(__tmp__, _tokens:Slice<T_token>):{ var _0 : GoInt; var _1 : GoInt; } return __tmp__._indexTokens(_tokens);
    public function _writeTokens(__tmp__, _tokens:Slice<T_token>, _leCodes:Slice<T_hcode>, _oeCodes:Slice<T_hcode>):Void __tmp__._writeTokens(_tokens, _leCodes, _oeCodes);
    public function _writeBlockHuff(__tmp__, _eof:Bool, _input:Slice<GoByte>):Void __tmp__._writeBlockHuff(_eof, _input);
}
class T_hcode_extension_fields {
    public function _set(__tmp__, _code:GoUInt16, _length:GoUInt16):Void __tmp__._set(_code, _length);
}
class T_huffmanEncoder_extension_fields {
    public function _bitLength(__tmp__, _freq:Slice<GoInt32>):GoInt return __tmp__._bitLength(_freq);
    public function _bitCounts(__tmp__, _list:Slice<T_literalNode>, _maxBits:GoInt32):Slice<GoInt32> return __tmp__._bitCounts(_list, _maxBits);
    public function _assignEncodingAndSize(__tmp__, _bitCount:Slice<GoInt32>, _list:Slice<T_literalNode>):Void __tmp__._assignEncodingAndSize(_bitCount, _list);
    public function _generate(__tmp__, _freq:Slice<GoInt32>, _maxBits:GoInt32):Void __tmp__._generate(_freq, _maxBits);
}
class T_byLiteral_extension_fields {
    public function _sort(__tmp__, _a:Slice<T_literalNode>):Void __tmp__._sort(_a);
...
class T_huffmanDecoder_extension_fields {
    public function _init(__tmp__, _lengths:Slice<GoInt>):Bool return __tmp__._init(_lengths);
}
class T_decompressor_extension_fields {
    public function _nextBlock(__tmp__):Void __tmp__._nextBlock();
    public function read(__tmp__, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } return __tmp__.read(_b);
    public function close(__tmp__):Error return __tmp__.close();
    public function _readHuffman(__tmp__):Error return __tmp__._readHuffman();
    public function _huffmanBlock(__tmp__):Void __tmp__._huffmanBlock();
    public function _dataBlock(__tmp__):Void __tmp__._dataBlock();
    public function _copyData(__tmp__):Void __tmp__._copyData();
    public function _finishBlock(__tmp__):Void __tmp__._finishBlock();
    public function _moreBits(__tmp__):Error return __tmp__._moreBits();
    public function _huffSym(__tmp__, _h:Pointer<T_huffmanDecoder>):{ var _0 : GoInt; var _1 : Error; } return __tmp__._huffSym(_h);
    public function reset(__tmp__, _r:stdgo.io.Io.Reader, _dict:Slice<GoByte>):Error return __tmp__.reset(_r, _dict);
}
class T_token_extension_fields {
    public function _literal(__tmp__):GoUInt32 return __tmp__._literal();
    public function _offset(__tmp__):GoUInt32 return __tmp__._offset();
    public function _length(__tmp__):GoUInt32 return __tmp__._length();
}
