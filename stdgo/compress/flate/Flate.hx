...
/**
    /|*{
    	...
    	_ = gotoNext == 3675062
    	{
    		gotoNext = 3675151
    		_ = gotoNext == 3675151
    		v_3675155, err_3675158 = f.huffSym(f.hl)
    		if err_3675158 != nil {
    			gotoNext = 3675197
    			_ = gotoNext == 3675197
    			f.err = err_3675158
    		...
    		case v_3675155 < 256:
    			gotoNext = 3675295
    			_ = gotoNext == 3675295
    			f.dict.writeByte(byte(v_3675155))
    		...
    		case v_3675155 < 265:
    			gotoNext = 3675599
    			_ = gotoNext == 3675599
    			length_3675271 = v_3675155 - 254
    			n_3675234 = 0
    			gotoNext = 3676047
    		case v_3675155 < 269:
    			gotoNext = 3675650
    			_ = gotoNext == 3675650
    			length_3675271 = v_3675155*2 - 519
    			n_3675234 = 1
    			gotoNext = 3676047
    		case v_3675155 < 273:
    			gotoNext = 3675706
    			_ = gotoNext == 3675706
    			length_3675271 = v_3675155*4 - 1057
    			n_3675234 = 2
    			gotoNext = 3676047
    		case v_3675155 < 277:
    			gotoNext = 3675762
    			_ = gotoNext == 3675762
    			length_3675271 = v_3675155*8 - 2149
    			n_3675234 = 3
    			gotoNext = 3676047
    		case v_3675155 < 281:
    			gotoNext = 3675818
    			_ = gotoNext == 3675818
    			length_3675271 = v_3675155*16 - 4365
    			n_3675234 = 4
    			gotoNext = 3676047
    		case v_3675155 < 285:
    			gotoNext = 3675876
    			_ = gotoNext == 3675876
    			length_3675271 = v_3675155*32 - 8861
    			n_3675234 = 5
    			gotoNext = 3676047
    		case v_3675155 < 286:
    			gotoNext = 3675935
    		...
    		if n_3675234 > 0 {
    			...
    			if f.nb < n_3675234 {
    				gotoNext = 3676074
    				_ = gotoNext == 3676074
    				if err_3675158 = f.moreBits(); err_3675158 != nil {
    					gotoNext = 3676114
    					_ = gotoNext == 3676114
    					f.err = err_3675158
    					return
    			...
    			_ = gotoNext == 3676159
    			length_3675271 += int(f.b & uint32(1<<n_3675234-1))
    			f.b >>= n_3675234
    			f.nb -= n_3675234
    			gotoNext = 3676228
    		} else {
    		...
    		if f.hd == nil {
    			...
    			_ = gotoNext == 3676361
    			dist_3676232 = int(bits.Reverse8(uint8(f.b & 31 << 3)))
    			f.b >>= 5
    			f.nb -= 5
    			gotoNext = 3676535
    		} else {
    			...
    			gotoNext = 3676446
    			_ = gotoNext == 3676446
    			if dist_3676232, err_3675158 = f.huffSym(f.hd); err_3675158 != nil {
    				gotoNext = 3676494
    				_ = gotoNext == 3676494
    				f.err = err_3675158
    				return
    		...
    		case dist_3676232 < 4:
    			...
    			dist_3676232++
    			gotoNext = 3677021
    		case dist_3676232 < 30:
    			gotoNext = 3676573
    			_ = gotoNext == 3676573
    			nb_3676600 = uint(dist_3676232-2) >> 1
    			extra_3676677 = (dist_3676232 & 1) << nb_3676600
    			_ = 0
    			gotoNext = 3676706
    			_ = gotoNext == 3676706
    			if f.nb < nb_3676600 {
    			...
    			_ = gotoNext == 3676805
    			extra_3676677 |= int(f.b & uint32(1<<nb_3676600-1))
    			f.b >>= nb_3676600
    			f.nb -= nb_3676600
    			dist_3676232 = 1<<(nb_3676600+1) + 1 + extra_3676677
    			gotoNext = 3677021
    		default:
    			gotoNext = 3676903
    			_ = gotoNext == 3676903
    		...
    		_ = gotoNext == 3677021
    		if dist_3676232 > f.dict.histSize() {
    			gotoNext = 3677049
    			_ = gotoNext == 3677049
    			f.err = CorruptInputError(f.roffset)
    			return
    		...
    		_ = gotoNext == 3677108
    		f.copyLen, f.copyDist = length_3675271, dist_3676232
    		gotoNext = 3677168
    		gotoNext = 3677168
    	}
    	_ = gotoNext == 3677168
    	...
    	_ = gotoNext == 3677168
    	{
    		gotoNext = 3677243
    		_ = gotoNext == 3677243
    		cnt_3677247 = f.dict.tryWriteCopy(f.copyDist, f.copyLen)
    		if cnt_3677247 == 0 {
    			gotoNext = 3677311
    			_ = gotoNext == 3677311
    			cnt_3677247 = f.dict.writeCopy(f.copyDist, f.copyLen)
    			gotoNext = 3677368
    		} else {
    			gotoNext = 3677368
    		}
    		_ = gotoNext == 3677368
    		f.copyLen -= cnt_3677247
