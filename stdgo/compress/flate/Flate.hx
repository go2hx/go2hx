...
/**
    /|*{
    	...
    	_ = gotoNext == 3679801
    	{
    		v_3679894, err_3679897 = f.huffSym(f.hl)
    		if err_3679897 != nil {
    			gotoNext = 3679936
    			_ = gotoNext == 3679936
    			f.err = err_3679897
    		...
    		case v_3679894 < 256:
    			gotoNext = 3680034
    			_ = gotoNext == 3680034
    			f.dict.writeByte(byte(v_3679894))
    		...
    		case v_3679894 < 265:
    			gotoNext = 3680338
    			_ = gotoNext == 3680338
    			length_3680010 = v_3679894 - 254
    			n_3679973 = 0
    			gotoNext = 3680786
    		case v_3679894 < 269:
    			gotoNext = 3680389
    			_ = gotoNext == 3680389
    			length_3680010 = v_3679894*2 - 519
    			n_3679973 = 1
    			gotoNext = 3680786
    		case v_3679894 < 273:
    			gotoNext = 3680445
    			_ = gotoNext == 3680445
    			length_3680010 = v_3679894*4 - 1057
    			n_3679973 = 2
    			gotoNext = 3680786
    		case v_3679894 < 277:
    			gotoNext = 3680501
    			_ = gotoNext == 3680501
    			length_3680010 = v_3679894*8 - 2149
    			n_3679973 = 3
    			gotoNext = 3680786
    		case v_3679894 < 281:
    			gotoNext = 3680557
    			_ = gotoNext == 3680557
    			length_3680010 = v_3679894*16 - 4365
    			n_3679973 = 4
    			gotoNext = 3680786
    		case v_3679894 < 285:
    			gotoNext = 3680615
    			_ = gotoNext == 3680615
    			length_3680010 = v_3679894*32 - 8861
    			n_3679973 = 5
    			gotoNext = 3680786
    		case v_3679894 < 286:
    			gotoNext = 3680674
    		...
    		if n_3679973 > 0 {
    			...
    			if f.nb < n_3679973 {
    				gotoNext = 3680813
    				_ = gotoNext == 3680813
    				if err_3679897 = f.moreBits(); err_3679897 != nil {
    					gotoNext = 3680853
    					_ = gotoNext == 3680853
    					f.err = err_3679897
    					return
    			...
    			_ = gotoNext == 3680898
    			length_3680010 += int(f.b & uint32(1<<n_3679973-1))
    			f.b >>= n_3679973
    			f.nb -= n_3679973
    			gotoNext = 3680967
    		} else {
    		...
    		if f.hd == nil {
    			...
    			_ = gotoNext == 3681100
    			dist_3680971 = int(bits.Reverse8(uint8(f.b & 31 << 3)))
    			f.b >>= 5
    			f.nb -= 5
    			gotoNext = 3681274
    		} else {
    			gotoNext = 3681185
    			_ = gotoNext == 3681185
    			if dist_3680971, err_3679897 = f.huffSym(f.hd); err_3679897 != nil {
    				gotoNext = 3681233
    				_ = gotoNext == 3681233
    				f.err = err_3679897
    				return
    		...
    		case dist_3680971 < 4:
    			...
    			dist_3680971++
    			gotoNext = 3681760
    		case dist_3680971 < 30:
    			gotoNext = 3681312
    			_ = gotoNext == 3681312
    			nb_3681339 = uint(dist_3680971-2) >> 1
    			extra_3681416 = (dist_3680971 & 1) << nb_3681339
    			_ = 0
    			gotoNext = 3681445
    			_ = gotoNext == 3681445
    			if f.nb < nb_3681339 {
    			...
    			_ = gotoNext == 3681544
    			extra_3681416 |= int(f.b & uint32(1<<nb_3681339-1))
    			f.b >>= nb_3681339
    			f.nb -= nb_3681339
    			dist_3680971 = 1<<(nb_3681339+1) + 1 + extra_3681416
    			gotoNext = 3681760
    		default:
    			gotoNext = 3681642
    			_ = gotoNext == 3681642
    		...
    		_ = gotoNext == 3681760
    		if dist_3680971 > f.dict.histSize() {
    			gotoNext = 3681788
    			_ = gotoNext == 3681788
    			f.err = CorruptInputError(f.roffset)
    			return
    		...
    		_ = gotoNext == 3681847
    		f.copyLen, f.copyDist = length_3680010, dist_3680971
    		gotoNext = 3681907
    	}
    	gotoNext = 3681907
    	_ = gotoNext == 3681907
    	{
    		cnt_3681986 = f.dict.tryWriteCopy(f.copyDist, f.copyLen)
    		if cnt_3681986 == 0 {
    			gotoNext = 3682050
    			_ = gotoNext == 3682050
    			cnt_3681986 = f.dict.writeCopy(f.copyDist, f.copyLen)
    			gotoNext = 3682107
    		} else {
    			gotoNext = 3682107
    		}
    		_ = gotoNext == 3682107
    		f.copyLen -= cnt_3681986
