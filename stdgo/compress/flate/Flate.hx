...
/**
    /|*{
    	...
    	_ = gotoNext == 3704857
    	{
    		gotoNext = 3704946
    		_ = gotoNext == 3704946
    		v_3704950, err_3704953 = f.huffSym(f.hl)
    		if err_3704953 != nil {
    			gotoNext = 3704992
    			_ = gotoNext == 3704992
    			f.err = err_3704953
    		...
    		case v_3704950 < 256:
    			gotoNext = 3705090
    			_ = gotoNext == 3705090
    			f.dict.writeByte(byte(v_3704950))
    		...
    		case v_3704950 < 265:
    			gotoNext = 3705394
    			_ = gotoNext == 3705394
    			length_3705066 = v_3704950 - 254
    			n_3705029 = 0
    			gotoNext = 3705842
    		case v_3704950 < 269:
    			gotoNext = 3705445
    			_ = gotoNext == 3705445
    			length_3705066 = v_3704950*2 - 519
    			n_3705029 = 1
    			gotoNext = 3705842
    		case v_3704950 < 273:
    			gotoNext = 3705501
    			_ = gotoNext == 3705501
    			length_3705066 = v_3704950*4 - 1057
    			n_3705029 = 2
    			gotoNext = 3705842
    		case v_3704950 < 277:
    			gotoNext = 3705557
    			_ = gotoNext == 3705557
    			length_3705066 = v_3704950*8 - 2149
    			n_3705029 = 3
    			gotoNext = 3705842
    		case v_3704950 < 281:
    			gotoNext = 3705613
    			_ = gotoNext == 3705613
    			length_3705066 = v_3704950*16 - 4365
    			n_3705029 = 4
    			gotoNext = 3705842
    		case v_3704950 < 285:
    			gotoNext = 3705671
    			_ = gotoNext == 3705671
    			length_3705066 = v_3704950*32 - 8861
    			n_3705029 = 5
    			gotoNext = 3705842
    		case v_3704950 < 286:
    			gotoNext = 3705730
    		...
    		if n_3705029 > 0 {
    			...
    			if f.nb < n_3705029 {
    				gotoNext = 3705869
    				_ = gotoNext == 3705869
    				if err_3704953 = f.moreBits(); err_3704953 != nil {
    					gotoNext = 3705909
    					_ = gotoNext == 3705909
    					f.err = err_3704953
    					return
    			...
    			_ = gotoNext == 3705954
    			length_3705066 += int(f.b & uint32(1<<n_3705029-1))
    			f.b >>= n_3705029
    			f.nb -= n_3705029
    			gotoNext = 3706023
    		} else {
    		...
    		if f.hd == nil {
    			...
    			_ = gotoNext == 3706156
    			dist_3706027 = int(bits.Reverse8(uint8(f.b & 31 << 3)))
    			f.b >>= 5
    			f.nb -= 5
    			gotoNext = 3706330
    		} else {
    			...
    			gotoNext = 3706241
    			_ = gotoNext == 3706241
    			if dist_3706027, err_3704953 = f.huffSym(f.hd); err_3704953 != nil {
    				gotoNext = 3706289
    				_ = gotoNext == 3706289
    				f.err = err_3704953
    				return
    		...
    		case dist_3706027 < 4:
    			...
    			dist_3706027++
    			gotoNext = 3706816
    		case dist_3706027 < 30:
    			gotoNext = 3706368
    			_ = gotoNext == 3706368
    			nb_3706395 = uint(dist_3706027-2) >> 1
    			extra_3706472 = (dist_3706027 & 1) << nb_3706395
    			_ = 0
    			gotoNext = 3706501
    			_ = gotoNext == 3706501
    			if f.nb < nb_3706395 {
    			...
    			_ = gotoNext == 3706600
    			extra_3706472 |= int(f.b & uint32(1<<nb_3706395-1))
    			f.b >>= nb_3706395
    			f.nb -= nb_3706395
    			dist_3706027 = 1<<(nb_3706395+1) + 1 + extra_3706472
    			gotoNext = 3706816
    		default:
    			gotoNext = 3706698
    			_ = gotoNext == 3706698
    		...
    		_ = gotoNext == 3706816
    		if dist_3706027 > f.dict.histSize() {
    			gotoNext = 3706844
    			_ = gotoNext == 3706844
    			f.err = CorruptInputError(f.roffset)
    			return
    		...
    		_ = gotoNext == 3706903
    		f.copyLen, f.copyDist = length_3705066, dist_3706027
    		gotoNext = 3706963
    		gotoNext = 3706963
    	}
    	_ = gotoNext == 3706963
    	...
    	_ = gotoNext == 3706963
    	{
    		gotoNext = 3707038
    		_ = gotoNext == 3707038
    		cnt_3707042 = f.dict.tryWriteCopy(f.copyDist, f.copyLen)
    		if cnt_3707042 == 0 {
    			gotoNext = 3707106
    			_ = gotoNext == 3707106
    			cnt_3707042 = f.dict.writeCopy(f.copyDist, f.copyLen)
    			gotoNext = 3707163
    		} else {
    			gotoNext = 3707163
    		}
    		_ = gotoNext == 3707163
    		f.copyLen -= cnt_3707042
