...
class Resetter_static_extension {
    static public function reset(t:Resetter, r:stdgo._internal.io.Io.Reader, dict:Array<StdTypes.Int>):stdgo.Error {
        ...
        return stdgo._internal.compress.flate.Flate.Resetter_static_extension.reset(t, r, dict);
    }
}
...
@:structInit @:private abstract T_compressionLevel(stdgo._internal.compress.flate.Flate.T_compressionLevel) from stdgo._internal.compress.flate.Flate.T_compressionLevel to stdgo._internal.compress.flate.Flate.T_compressionLevel {
...
@:structInit @:private @:using(stdgo.compress.flate.Flate.T_compressor_static_extension) abstract T_compressor(stdgo._internal.compress.flate.Flate.T_compressor) from stdgo._internal.compress.flate.Flate.T_compressor to stdgo._internal.compress.flate.Flate.T_compressor {
...
@:structInit @:private @:using(stdgo.compress.flate.Flate.T_dictWriter_static_extension) abstract T_dictWriter(stdgo._internal.compress.flate.Flate.T_dictWriter) from stdgo._internal.compress.flate.Flate.T_dictWriter to stdgo._internal.compress.flate.Flate.T_dictWriter {
...
@:structInit @:using(stdgo.compress.flate.Flate.Writer_static_extension) abstract Writer(stdgo._internal.compress.flate.Flate.Writer) from stdgo._internal.compress.flate.Flate.Writer to stdgo._internal.compress.flate.Flate.Writer {
...
@:structInit @:private abstract T_deflateTest(stdgo._internal.compress.flate.Flate.T_deflateTest) from stdgo._internal.compress.flate.Flate.T_deflateTest to stdgo._internal.compress.flate.Flate.T_deflateTest {
...
@:structInit @:private abstract T_deflateInflateTest(stdgo._internal.compress.flate.Flate.T_deflateInflateTest) from stdgo._internal.compress.flate.Flate.T_deflateInflateTest to stdgo._internal.compress.flate.Flate.T_deflateInflateTest {
    public var _in(get, set) : Array<std.UInt>;
    function get__in():Array<std.UInt> return [for (i in this._in) i];
    function set__in(v:Array<std.UInt>):Array<std.UInt> {
        this._in = ([for (i in v) i] : stdgo.Slice<stdgo.GoUInt8>);
...
@:structInit @:private abstract T_reverseBitsTest(stdgo._internal.compress.flate.Flate.T_reverseBitsTest) from stdgo._internal.compress.flate.Flate.T_reverseBitsTest to stdgo._internal.compress.flate.Flate.T_reverseBitsTest {
...
@:structInit @:private @:using(stdgo.compress.flate.Flate.T_sparseReader_static_extension) abstract T_sparseReader(stdgo._internal.compress.flate.Flate.T_sparseReader) from stdgo._internal.compress.flate.Flate.T_sparseReader to stdgo._internal.compress.flate.Flate.T_sparseReader {
...
@:structInit @:private @:using(stdgo.compress.flate.Flate.T_syncBuffer_static_extension) abstract T_syncBuffer(stdgo._internal.compress.flate.Flate.T_syncBuffer) from stdgo._internal.compress.flate.Flate.T_syncBuffer to stdgo._internal.compress.flate.Flate.T_syncBuffer {
...
@:structInit @:private abstract T_deflateInflateStringTest(stdgo._internal.compress.flate.Flate.T_deflateInflateStringTest) from stdgo._internal.compress.flate.Flate.T_deflateInflateStringTest to stdgo._internal.compress.flate.Flate.T_deflateInflateStringTest {
...
@:structInit @:private @:using(stdgo.compress.flate.Flate.T_failWriter_static_extension) abstract T_failWriter(stdgo._internal.compress.flate.Flate.T_failWriter) from stdgo._internal.compress.flate.Flate.T_failWriter to stdgo._internal.compress.flate.Flate.T_failWriter {
...
@:structInit @:private abstract T_tableEntry(stdgo._internal.compress.flate.Flate.T_tableEntry) from stdgo._internal.compress.flate.Flate.T_tableEntry to stdgo._internal.compress.flate.Flate.T_tableEntry {
...
@:structInit @:private @:using(stdgo.compress.flate.Flate.T_deflateFast_static_extension) abstract T_deflateFast(stdgo._internal.compress.flate.Flate.T_deflateFast) from stdgo._internal.compress.flate.Flate.T_deflateFast to stdgo._internal.compress.flate.Flate.T_deflateFast {
...
@:structInit @:private @:using(stdgo.compress.flate.Flate.T_dictDecoder_static_extension) abstract T_dictDecoder(stdgo._internal.compress.flate.Flate.T_dictDecoder) from stdgo._internal.compress.flate.Flate.T_dictDecoder to stdgo._internal.compress.flate.Flate.T_dictDecoder {
...
@:structInit @:private @:using(stdgo.compress.flate.Flate.T_huffmanBitWriter_static_extension) abstract T_huffmanBitWriter(stdgo._internal.compress.flate.Flate.T_huffmanBitWriter) from stdgo._internal.compress.flate.Flate.T_huffmanBitWriter to stdgo._internal.compress.flate.Flate.T_huffmanBitWriter {
...
@:structInit @:private abstract T_huffTest(stdgo._internal.compress.flate.Flate.T_huffTest) from stdgo._internal.compress.flate.Flate.T_huffTest to stdgo._internal.compress.flate.Flate.T_huffTest {
    public var _tokens(get, set) : Array<stdgo._internal.compress.flate.Flate.T_token>;
    function get__tokens():Array<stdgo._internal.compress.flate.Flate.T_token> return [for (i in this._tokens) i];
    function set__tokens(v:Array<stdgo._internal.compress.flate.Flate.T_token>):Array<stdgo._internal.compress.flate.Flate.T_token> {
        this._tokens = ([for (i in v) i] : stdgo.Slice<stdgo._internal.compress.flate.Flate.T_token>);
...
@:structInit @:private @:using(stdgo.compress.flate.Flate.T_hcode_static_extension) abstract T_hcode(stdgo._internal.compress.flate.Flate.T_hcode) from stdgo._internal.compress.flate.Flate.T_hcode to stdgo._internal.compress.flate.Flate.T_hcode {
...
@:structInit @:private @:using(stdgo.compress.flate.Flate.T_huffmanEncoder_static_extension) abstract T_huffmanEncoder(stdgo._internal.compress.flate.Flate.T_huffmanEncoder) from stdgo._internal.compress.flate.Flate.T_huffmanEncoder to stdgo._internal.compress.flate.Flate.T_huffmanEncoder {
...
@:structInit @:private abstract T_literalNode(stdgo._internal.compress.flate.Flate.T_literalNode) from stdgo._internal.compress.flate.Flate.T_literalNode to stdgo._internal.compress.flate.Flate.T_literalNode {
...
@:structInit @:private abstract T_levelInfo(stdgo._internal.compress.flate.Flate.T_levelInfo) from stdgo._internal.compress.flate.Flate.T_levelInfo to stdgo._internal.compress.flate.Flate.T_levelInfo {
    public var _level(get, set) : StdTypes.Int;
    function get__level():StdTypes.Int return this._level;
    function set__level(v:StdTypes.Int):StdTypes.Int {
        this._level = v;
...
@:structInit @:using(stdgo.compress.flate.Flate.ReadError_static_extension) abstract ReadError(stdgo._internal.compress.flate.Flate.ReadError) from stdgo._internal.compress.flate.Flate.ReadError to stdgo._internal.compress.flate.Flate.ReadError {
...
@:structInit @:using(stdgo.compress.flate.Flate.WriteError_static_extension) abstract WriteError(stdgo._internal.compress.flate.Flate.WriteError) from stdgo._internal.compress.flate.Flate.WriteError to stdgo._internal.compress.flate.Flate.WriteError {
    public var offset(get, set) : haxe.Int64;
    function get_offset():haxe.Int64 return this.offset;
    function set_offset(v:haxe.Int64):haxe.Int64 {
        this.offset = v;
...
@:structInit @:private @:using(stdgo.compress.flate.Flate.T_huffmanDecoder_static_extension) abstract T_huffmanDecoder(stdgo._internal.compress.flate.Flate.T_huffmanDecoder) from stdgo._internal.compress.flate.Flate.T_huffmanDecoder to stdgo._internal.compress.flate.Flate.T_huffmanDecoder {
...
@:structInit @:private @:using(stdgo.compress.flate.Flate.T_decompressor_static_extension) abstract T_decompressor(stdgo._internal.compress.flate.Flate.T_decompressor) from stdgo._internal.compress.flate.Flate.T_decompressor to stdgo._internal.compress.flate.Flate.T_decompressor {
...
@:structInit @:private @:using(stdgo.compress.flate.Flate.T_errorWriter_static_extension) abstract T_errorWriter(stdgo._internal.compress.flate.Flate.T_errorWriter) from stdgo._internal.compress.flate.Flate.T_errorWriter to stdgo._internal.compress.flate.Flate.T_errorWriter {
...
class T__struct_4_static_extension {
    public static function read(_self__:T__struct_4, b:Array<std.UInt>):stdgo.Tuple<StdTypes.Int, stdgo.Error> {
        final b = ([for (i in b) i] : stdgo.Slice<stdgo.GoUInt8>);
        return {
            final obj = stdgo._internal.compress.flate.Flate.T__struct_4_static_extension.read(_self__, b);
            { _0 : obj._0, _1 : obj._1 };
        };
    }
}
...
class T_compressor_static_extension {
    static public function _close(d:T_compressor):stdgo.Error {
        return stdgo._internal.compress.flate.Flate.T_compressor_static_extension._close(d);
    }
    static public function _reset(d:T_compressor, w:stdgo._internal.io.Io.Writer):Void {
        stdgo._internal.compress.flate.Flate.T_compressor_static_extension._reset(d, w);
    }
    static public function _init(d:T_compressor, w:stdgo._internal.io.Io.Writer, level:StdTypes.Int):stdgo.Error {
        return stdgo._internal.compress.flate.Flate.T_compressor_static_extension._init(d, w, level);
    }
    static public function _syncFlush(d:T_compressor):stdgo.Error {
        return stdgo._internal.compress.flate.Flate.T_compressor_static_extension._syncFlush(d);
    }
    static public function _write(d:T_compressor, b:Array<StdTypes.Int>):stdgo.Tuple<StdTypes.Int, stdgo.Error> {
        final b = ([for (i in b) i] : stdgo.Slice<stdgo.GoByte>);
        return {
            final obj = stdgo._internal.compress.flate.Flate.T_compressor_static_extension._write(d, b);
            { _0 : obj._0, _1 : obj._1 };
        };
    }
    static public function _storeHuff(d:T_compressor):Void {
        stdgo._internal.compress.flate.Flate.T_compressor_static_extension._storeHuff(d);
    }
    static public function _store(d:T_compressor):Void {
        stdgo._internal.compress.flate.Flate.T_compressor_static_extension._store(d);
    }
    static public function _fillStore(d:T_compressor, b:Array<StdTypes.Int>):StdTypes.Int {
        final b = ([for (i in b) i] : stdgo.Slice<stdgo.GoByte>);
        return stdgo._internal.compress.flate.Flate.T_compressor_static_extension._fillStore(d, b);
    }
    static public function _deflate(d:T_compressor):Void {
        stdgo._internal.compress.flate.Flate.T_compressor_static_extension._deflate(d);
    }
    static public function _initDeflate(d:T_compressor):Void {
        stdgo._internal.compress.flate.Flate.T_compressor_static_extension._initDeflate(d);
    }
    static public function _encSpeed(d:T_compressor):Void {
        stdgo._internal.compress.flate.Flate.T_compressor_static_extension._encSpeed(d);
    }
    static public function _writeStoredBlock(d:T_compressor, buf:Array<StdTypes.Int>):stdgo.Error {
        final buf = ([for (i in buf) i] : stdgo.Slice<stdgo.GoByte>);
        return stdgo._internal.compress.flate.Flate.T_compressor_static_extension._writeStoredBlock(d, buf);
    }
    static public function _findMatch(d:T_compressor, pos:StdTypes.Int, prevHead:StdTypes.Int, prevLength:StdTypes.Int, lookahead:StdTypes.Int):stdgo.Tuple.Tuple3<StdTypes.Int, StdTypes.Int, Bool> {
        return {
            final obj = stdgo._internal.compress.flate.Flate.T_compressor_static_extension._findMatch(d, pos, prevHead, prevLength, lookahead);
            { _0 : obj._0, _1 : obj._1, _2 : obj._2 };
        };
    }
    static public function _fillWindow(d:T_compressor, b:Array<StdTypes.Int>):Void {
        final b = ([for (i in b) i] : stdgo.Slice<stdgo.GoByte>);
        stdgo._internal.compress.flate.Flate.T_compressor_static_extension._fillWindow(d, b);
    }
    static public function _writeBlock(d:T_compressor, tokens:Array<T_token>, index:StdTypes.Int):stdgo.Error {
        final tokens = ([for (i in tokens) i] : stdgo.Slice<T_token>);
        return stdgo._internal.compress.flate.Flate.T_compressor_static_extension._writeBlock(d, tokens, index);
    }
    static public function _fillDeflate(d:T_compressor, b:Array<StdTypes.Int>):StdTypes.Int {
        final b = ([for (i in b) i] : stdgo.Slice<stdgo.GoByte>);
        return stdgo._internal.compress.flate.Flate.T_compressor_static_extension._fillDeflate(d, b);
    }
}
class T_dictWriter_static_extension {
    static public function write(w:T_dictWriter, b:Array<StdTypes.Int>):stdgo.Tuple<StdTypes.Int, stdgo.Error> {
        final b = ([for (i in b) i] : stdgo.Slice<stdgo.GoByte>);
        return {
            final obj = stdgo._internal.compress.flate.Flate.T_dictWriter_static_extension.write(w, b);
            { _0 : obj._0, _1 : obj._1 };
        };
    }
}
class Writer_static_extension {
    static public function reset(w:Writer, dst:stdgo._internal.io.Io.Writer):Void {
        stdgo._internal.compress.flate.Flate.Writer_static_extension.reset(w, dst);
    }
    static public function close(w:Writer):stdgo.Error {
        return stdgo._internal.compress.flate.Flate.Writer_static_extension.close(w);
    }
    static public function flush(w:Writer):stdgo.Error {
        return stdgo._internal.compress.flate.Flate.Writer_static_extension.flush(w);
    }
    static public function write(w:Writer, data:Array<StdTypes.Int>):stdgo.Tuple<StdTypes.Int, stdgo.Error> {
        final data = ([for (i in data) i] : stdgo.Slice<stdgo.GoByte>);
        return {
            final obj = stdgo._internal.compress.flate.Flate.Writer_static_extension.write(w, data);
            { _0 : obj._0, _1 : obj._1 };
        };
    }
}
class T_sparseReader_static_extension {
    static public function read(r:T_sparseReader, b:Array<StdTypes.Int>):stdgo.Tuple<StdTypes.Int, stdgo.Error> {
        final b = ([for (i in b) i] : stdgo.Slice<stdgo.GoByte>);
        return {
            final obj = stdgo._internal.compress.flate.Flate.T_sparseReader_static_extension.read(r, b);
            { _0 : obj._0, _1 : obj._1 };
        };
    }
}
class T_syncBuffer_static_extension {
    static public function close(b:T_syncBuffer):stdgo.Error {
        return stdgo._internal.compress.flate.Flate.T_syncBuffer_static_extension.close(b);
    }
    static public function readMode(b:T_syncBuffer):Void {
        stdgo._internal.compress.flate.Flate.T_syncBuffer_static_extension.readMode(b);
    }
    static public function writeMode(b:T_syncBuffer):Void {
        stdgo._internal.compress.flate.Flate.T_syncBuffer_static_extension.writeMode(b);
    }
    static public function write(b:T_syncBuffer, p:Array<StdTypes.Int>):stdgo.Tuple<StdTypes.Int, stdgo.Error> {
        final p = ([for (i in p) i] : stdgo.Slice<stdgo.GoByte>);
        return {
            final obj = stdgo._internal.compress.flate.Flate.T_syncBuffer_static_extension.write(b, p);
            { _0 : obj._0, _1 : obj._1 };
        };
    }
    static public function _signal(b:T_syncBuffer):Void {
        stdgo._internal.compress.flate.Flate.T_syncBuffer_static_extension._signal(b);
    }
    static public function read(b:T_syncBuffer, p:Array<StdTypes.Int>):stdgo.Tuple<StdTypes.Int, stdgo.Error> {
        final p = ([for (i in p) i] : stdgo.Slice<stdgo.GoByte>);
        return {
            final obj = stdgo._internal.compress.flate.Flate.T_syncBuffer_static_extension.read(b, p);
            { _0 : obj._0, _1 : obj._1 };
        };
    }
}
class T_failWriter_static_extension {
    static public function write(w:T_failWriter, b:Array<StdTypes.Int>):stdgo.Tuple<StdTypes.Int, stdgo.Error> {
        final b = ([for (i in b) i] : stdgo.Slice<stdgo.GoByte>);
        return {
            final obj = stdgo._internal.compress.flate.Flate.T_failWriter_static_extension.write(w, b);
            { _0 : obj._0, _1 : obj._1 };
        };
    }
}
class T_deflateFast_static_extension {
    static public function _shiftOffsets(e:T_deflateFast):Void {
        stdgo._internal.compress.flate.Flate.T_deflateFast_static_extension._shiftOffsets(e);
    }
    static public function _reset(e:T_deflateFast):Void {
        stdgo._internal.compress.flate.Flate.T_deflateFast_static_extension._reset(e);
    }
    static public function _matchLen(e:T_deflateFast, s:StdTypes.Int, t:StdTypes.Int, src:Array<StdTypes.Int>):StdTypes.Int {
        final src = ([for (i in src) i] : stdgo.Slice<stdgo.GoByte>);
        return stdgo._internal.compress.flate.Flate.T_deflateFast_static_extension._matchLen(e, s, t, src);
    }
    static public function _encode(e:T_deflateFast, dst:Array<T_token>, src:Array<StdTypes.Int>):Array<T_token> {
        final dst = ([for (i in dst) i] : stdgo.Slice<T_token>);
        final src = ([for (i in src) i] : stdgo.Slice<stdgo.GoByte>);
        return [for (i in stdgo._internal.compress.flate.Flate.T_deflateFast_static_extension._encode(e, dst, src)) i];
    }
}
class T_dictDecoder_static_extension {
    static public function _readFlush(dd:T_dictDecoder):Array<StdTypes.Int> {
        return [for (i in stdgo._internal.compress.flate.Flate.T_dictDecoder_static_extension._readFlush(dd)) i];
    }
    static public function _tryWriteCopy(dd:T_dictDecoder, dist:StdTypes.Int, _length:StdTypes.Int):StdTypes.Int {
        return stdgo._internal.compress.flate.Flate.T_dictDecoder_static_extension._tryWriteCopy(dd, dist, _length);
    }
    static public function _writeCopy(dd:T_dictDecoder, dist:StdTypes.Int, _length:StdTypes.Int):StdTypes.Int {
        return stdgo._internal.compress.flate.Flate.T_dictDecoder_static_extension._writeCopy(dd, dist, _length);
    }
    static public function _writeByte(dd:T_dictDecoder, c:StdTypes.Int):Void {
        stdgo._internal.compress.flate.Flate.T_dictDecoder_static_extension._writeByte(dd, c);
    }
    static public function _writeMark(dd:T_dictDecoder, cnt:StdTypes.Int):Void {
        stdgo._internal.compress.flate.Flate.T_dictDecoder_static_extension._writeMark(dd, cnt);
    }
    static public function _writeSlice(dd:T_dictDecoder):Array<StdTypes.Int> {
        return [for (i in stdgo._internal.compress.flate.Flate.T_dictDecoder_static_extension._writeSlice(dd)) i];
    }
    static public function _availWrite(dd:T_dictDecoder):StdTypes.Int {
        return stdgo._internal.compress.flate.Flate.T_dictDecoder_static_extension._availWrite(dd);
    }
    static public function _availRead(dd:T_dictDecoder):StdTypes.Int {
        return stdgo._internal.compress.flate.Flate.T_dictDecoder_static_extension._availRead(dd);
    }
    static public function _histSize(dd:T_dictDecoder):StdTypes.Int {
        return stdgo._internal.compress.flate.Flate.T_dictDecoder_static_extension._histSize(dd);
    }
    static public function _init(dd:T_dictDecoder, size:StdTypes.Int, dict:Array<StdTypes.Int>):Void {
        final dict = ([for (i in dict) i] : stdgo.Slice<stdgo.GoByte>);
        stdgo._internal.compress.flate.Flate.T_dictDecoder_static_extension._init(dd, size, dict);
    }
}
class T_huffmanBitWriter_static_extension {
    static public function _writeBlockHuff(w:T_huffmanBitWriter, eof:Bool, input:Array<StdTypes.Int>):Void {
        final input = ([for (i in input) i] : stdgo.Slice<stdgo.GoByte>);
        stdgo._internal.compress.flate.Flate.T_huffmanBitWriter_static_extension._writeBlockHuff(w, eof, input);
    }
    static public function _writeTokens(w:T_huffmanBitWriter, tokens:Array<T_token>, leCodes:Array<T_hcode>, oeCodes:Array<T_hcode>):Void {
        final tokens = ([for (i in tokens) i] : stdgo.Slice<T_token>);
        final leCodes = ([for (i in leCodes) i] : stdgo.Slice<T_hcode>);
        final oeCodes = ([for (i in oeCodes) i] : stdgo.Slice<T_hcode>);
        stdgo._internal.compress.flate.Flate.T_huffmanBitWriter_static_extension._writeTokens(w, tokens, leCodes, oeCodes);
    }
    static public function _indexTokens(w:T_huffmanBitWriter, tokens:Array<T_token>):stdgo.Tuple<StdTypes.Int, StdTypes.Int> {
        final tokens = ([for (i in tokens) i] : stdgo.Slice<T_token>);
        return {
            final obj = stdgo._internal.compress.flate.Flate.T_huffmanBitWriter_static_extension._indexTokens(w, tokens);
            { _0 : obj._0, _1 : obj._1 };
        };
    }
    static public function _writeBlockDynamic(w:T_huffmanBitWriter, tokens:Array<T_token>, eof:Bool, input:Array<StdTypes.Int>):Void {
        final tokens = ([for (i in tokens) i] : stdgo.Slice<T_token>);
        final input = ([for (i in input) i] : stdgo.Slice<stdgo.GoByte>);
        stdgo._internal.compress.flate.Flate.T_huffmanBitWriter_static_extension._writeBlockDynamic(w, tokens, eof, input);
    }
    static public function _writeBlock(w:T_huffmanBitWriter, tokens:Array<T_token>, eof:Bool, input:Array<StdTypes.Int>):Void {
        final tokens = ([for (i in tokens) i] : stdgo.Slice<T_token>);
        final input = ([for (i in input) i] : stdgo.Slice<stdgo.GoByte>);
        stdgo._internal.compress.flate.Flate.T_huffmanBitWriter_static_extension._writeBlock(w, tokens, eof, input);
    }
    static public function _writeFixedHeader(w:T_huffmanBitWriter, isEof:Bool):Void {
        stdgo._internal.compress.flate.Flate.T_huffmanBitWriter_static_extension._writeFixedHeader(w, isEof);
    }
    static public function _writeStoredHeader(w:T_huffmanBitWriter, _length:StdTypes.Int, isEof:Bool):Void {
        stdgo._internal.compress.flate.Flate.T_huffmanBitWriter_static_extension._writeStoredHeader(w, _length, isEof);
    }
    static public function _writeDynamicHeader(w:T_huffmanBitWriter, numLiterals:StdTypes.Int, numOffsets:StdTypes.Int, numCodegens:StdTypes.Int, isEof:Bool):Void {
        stdgo._internal.compress.flate.Flate.T_huffmanBitWriter_static_extension._writeDynamicHeader(w, numLiterals, numOffsets, numCodegens, isEof);
    }
    static public function _writeCode(w:T_huffmanBitWriter, c:T_hcode):Void {
        stdgo._internal.compress.flate.Flate.T_huffmanBitWriter_static_extension._writeCode(w, c);
    }
    static public function _storedSize(w:T_huffmanBitWriter, _in:Array<StdTypes.Int>):stdgo.Tuple<StdTypes.Int, Bool> {
        final _in = ([for (i in _in) i] : stdgo.Slice<stdgo.GoByte>);
        return {
            final obj = stdgo._internal.compress.flate.Flate.T_huffmanBitWriter_static_extension._storedSize(w, _in);
            { _0 : obj._0, _1 : obj._1 };
        };
    }
    static public function _fixedSize(w:T_huffmanBitWriter, extraBits:StdTypes.Int):StdTypes.Int {
        return stdgo._internal.compress.flate.Flate.T_huffmanBitWriter_static_extension._fixedSize(w, extraBits);
    }
    static public function _dynamicSize(w:T_huffmanBitWriter, litEnc:T_huffmanEncoder, offEnc:T_huffmanEncoder, extraBits:StdTypes.Int):stdgo.Tuple<StdTypes.Int, StdTypes.Int> {
        return {
            final obj = stdgo._internal.compress.flate.Flate.T_huffmanBitWriter_static_extension._dynamicSize(w, litEnc, offEnc, extraBits);
            { _0 : obj._0, _1 : obj._1 };
        };
    }
    static public function _generateCodegen(w:T_huffmanBitWriter, numLiterals:StdTypes.Int, numOffsets:StdTypes.Int, litEnc:T_huffmanEncoder, offEnc:T_huffmanEncoder):Void {
        stdgo._internal.compress.flate.Flate.T_huffmanBitWriter_static_extension._generateCodegen(w, numLiterals, numOffsets, litEnc, offEnc);
    }
    static public function _writeBytes(w:T_huffmanBitWriter, bytes:Array<StdTypes.Int>):Void {
        final bytes = ([for (i in bytes) i] : stdgo.Slice<stdgo.GoByte>);
        stdgo._internal.compress.flate.Flate.T_huffmanBitWriter_static_extension._writeBytes(w, bytes);
    }
    static public function _writeBits(w:T_huffmanBitWriter, b:StdTypes.Int, nb:std.UInt):Void {
        stdgo._internal.compress.flate.Flate.T_huffmanBitWriter_static_extension._writeBits(w, b, nb);
    }
    static public function _write(w:T_huffmanBitWriter, b:Array<StdTypes.Int>):Void {
        final b = ([for (i in b) i] : stdgo.Slice<stdgo.GoByte>);
        stdgo._internal.compress.flate.Flate.T_huffmanBitWriter_static_extension._write(w, b);
    }
    static public function _flush(w:T_huffmanBitWriter):Void {
        stdgo._internal.compress.flate.Flate.T_huffmanBitWriter_static_extension._flush(w);
    }
    static public function _reset(w:T_huffmanBitWriter, writer:stdgo._internal.io.Io.Writer):Void {
        stdgo._internal.compress.flate.Flate.T_huffmanBitWriter_static_extension._reset(w, writer);
    }
}
class T_hcode_static_extension {
    static public function _set(h:T_hcode, code:std.UInt, _length:std.UInt):Void {
        stdgo._internal.compress.flate.Flate.T_hcode_static_extension._set(h, code, _length);
    }
}
class T_huffmanEncoder_static_extension {
    static public function _generate(h:T_huffmanEncoder, freq:Array<StdTypes.Int>, maxBits:StdTypes.Int):Void {
        final freq = ([for (i in freq) i] : stdgo.Slice<stdgo.GoInt32>);
        stdgo._internal.compress.flate.Flate.T_huffmanEncoder_static_extension._generate(h, freq, maxBits);
    }
    static public function _assignEncodingAndSize(h:T_huffmanEncoder, bitCount:Array<StdTypes.Int>, list:Array<T_literalNode>):Void {
        final bitCount = ([for (i in bitCount) i] : stdgo.Slice<stdgo.GoInt32>);
        final list = ([for (i in list) i] : stdgo.Slice<T_literalNode>);
        stdgo._internal.compress.flate.Flate.T_huffmanEncoder_static_extension._assignEncodingAndSize(h, bitCount, list);
    }
    static public function _bitCounts(h:T_huffmanEncoder, list:Array<T_literalNode>, maxBits:StdTypes.Int):Array<StdTypes.Int> {
        final list = ([for (i in list) i] : stdgo.Slice<T_literalNode>);
        return [for (i in stdgo._internal.compress.flate.Flate.T_huffmanEncoder_static_extension._bitCounts(h, list, maxBits)) i];
    }
    static public function _bitLength(h:T_huffmanEncoder, freq:Array<StdTypes.Int>):StdTypes.Int {
        final freq = ([for (i in freq) i] : stdgo.Slice<stdgo.GoInt32>);
        return stdgo._internal.compress.flate.Flate.T_huffmanEncoder_static_extension._bitLength(h, freq);
    }
}
class ReadError_static_extension {
    static public function error(e:ReadError):String {
        return stdgo._internal.compress.flate.Flate.ReadError_static_extension.error(e);
    }
}
class WriteError_static_extension {
    static public function error(e:WriteError):String {
        return stdgo._internal.compress.flate.Flate.WriteError_static_extension.error(e);
    }
}
class T_huffmanDecoder_static_extension {
    static public function _init(h:T_huffmanDecoder, lengths:Array<StdTypes.Int>):Bool {
        final lengths = ([for (i in lengths) i] : stdgo.Slice<stdgo.GoInt>);
        return stdgo._internal.compress.flate.Flate.T_huffmanDecoder_static_extension._init(h, lengths);
    }
}
class T_decompressor_static_extension {
    static public function reset(f:T_decompressor, r:stdgo._internal.io.Io.Reader, dict:Array<StdTypes.Int>):stdgo.Error {
        final dict = ([for (i in dict) i] : stdgo.Slice<stdgo.GoByte>);
        return stdgo._internal.compress.flate.Flate.T_decompressor_static_extension.reset(f, r, dict);
    }
    static public function _makeReader(f:T_decompressor, r:stdgo._internal.io.Io.Reader):Void {
        stdgo._internal.compress.flate.Flate.T_decompressor_static_extension._makeReader(f, r);
    }
    static public function _huffSym(f:T_decompressor, h:T_huffmanDecoder):stdgo.Tuple<StdTypes.Int, stdgo.Error> {
        return {
            final obj = stdgo._internal.compress.flate.Flate.T_decompressor_static_extension._huffSym(f, h);
            { _0 : obj._0, _1 : obj._1 };
        };
    }
    static public function _moreBits(f:T_decompressor):stdgo.Error {
        return stdgo._internal.compress.flate.Flate.T_decompressor_static_extension._moreBits(f);
    }
    static public function _finishBlock(f:T_decompressor):Void {
        stdgo._internal.compress.flate.Flate.T_decompressor_static_extension._finishBlock(f);
    }
    static public function _copyData(f:T_decompressor):Void {
        stdgo._internal.compress.flate.Flate.T_decompressor_static_extension._copyData(f);
    }
    static public function _dataBlock(f:T_decompressor):Void {
        stdgo._internal.compress.flate.Flate.T_decompressor_static_extension._dataBlock(f);
    }
    static public function _huffmanBlock(f:T_decompressor):Void {
        stdgo._internal.compress.flate.Flate.T_decompressor_static_extension._huffmanBlock(f);
    }
    static public function _readHuffman(f:T_decompressor):stdgo.Error {
        return stdgo._internal.compress.flate.Flate.T_decompressor_static_extension._readHuffman(f);
    }
    static public function close(f:T_decompressor):stdgo.Error {
        return stdgo._internal.compress.flate.Flate.T_decompressor_static_extension.close(f);
    }
    static public function read(f:T_decompressor, b:Array<StdTypes.Int>):stdgo.Tuple<StdTypes.Int, stdgo.Error> {
        final b = ([for (i in b) i] : stdgo.Slice<stdgo.GoByte>);
        return {
            final obj = stdgo._internal.compress.flate.Flate.T_decompressor_static_extension.read(f, b);
            { _0 : obj._0, _1 : obj._1 };
        };
    }
    static public function _nextBlock(f:T_decompressor):Void {
        stdgo._internal.compress.flate.Flate.T_decompressor_static_extension._nextBlock(f);
    }
}
class T_errorWriter_static_extension {
    static public function write(e:T_errorWriter, b:Array<StdTypes.Int>):stdgo.Tuple<StdTypes.Int, stdgo.Error> {
        final b = ([for (i in b) i] : stdgo.Slice<stdgo.GoByte>);
        return {
            final obj = stdgo._internal.compress.flate.Flate.T_errorWriter_static_extension.write(e, b);
            { _0 : obj._0, _1 : obj._1 };
        };
    }
}
class T_byLiteral_static_extension {
    static public function swap(s:T_byLiteral, i:StdTypes.Int, j:StdTypes.Int):Void {
        stdgo._internal.compress.flate.Flate.T_byLiteral_static_extension.swap(s, i, j);
    }
    static public function less(s:T_byLiteral, i:StdTypes.Int, j:StdTypes.Int):Bool {
        return stdgo._internal.compress.flate.Flate.T_byLiteral_static_extension.less(s, i, j);
    }
    static public function len(s:T_byLiteral):StdTypes.Int {
        return stdgo._internal.compress.flate.Flate.T_byLiteral_static_extension.len(s);
    }
    static public function _sort(s:T_byLiteral, a:Array<T_literalNode>):Void {
        final a = ([for (i in a) i] : stdgo.Slice<T_literalNode>);
        stdgo._internal.compress.flate.Flate.T_byLiteral_static_extension._sort(s, a);
    }
}
class T_byFreq_static_extension {
    static public function swap(s:T_byFreq, i:StdTypes.Int, j:StdTypes.Int):Void {
        stdgo._internal.compress.flate.Flate.T_byFreq_static_extension.swap(s, i, j);
    }
    static public function less(s:T_byFreq, i:StdTypes.Int, j:StdTypes.Int):Bool {
        return stdgo._internal.compress.flate.Flate.T_byFreq_static_extension.less(s, i, j);
    }
    static public function len(s:T_byFreq):StdTypes.Int {
        return stdgo._internal.compress.flate.Flate.T_byFreq_static_extension.len(s);
    }
    static public function _sort(s:T_byFreq, a:Array<T_literalNode>):Void {
        final a = ([for (i in a) i] : stdgo.Slice<T_literalNode>);
        stdgo._internal.compress.flate.Flate.T_byFreq_static_extension._sort(s, a);
    }
}
class CorruptInputError_static_extension {
    static public function error(e:CorruptInputError):String {
        return stdgo._internal.compress.flate.Flate.CorruptInputError_static_extension.error(e);
    }
}
class InternalError_static_extension {
    static public function error(e:InternalError):String {
        return stdgo._internal.compress.flate.Flate.InternalError_static_extension.error(e);
    }
}
class T_token_static_extension {
    static public function _length(t:T_token):std.UInt {
        return stdgo._internal.compress.flate.Flate.T_token_static_extension._length(t);
    }
    static public function _offset(t:T_token):std.UInt {
        return stdgo._internal.compress.flate.Flate.T_token_static_extension._offset(t);
    }
    static public function _literal(t:T_token):std.UInt {
        return stdgo._internal.compress.flate.Flate.T_token_static_extension._literal(t);
    }
}
/**
