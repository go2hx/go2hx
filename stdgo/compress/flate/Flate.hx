...
/**
    /|*{
    	...
    	_ = gotoNext == 3714689
    	{
    		gotoNext = 3714778
    		_ = gotoNext == 3714778
    		v_3714782, err_3714785 = f.huffSym(f.hl)
    		if err_3714785 != nil {
    			gotoNext = 3714824
    			_ = gotoNext == 3714824
    			f.err = err_3714785
    		...
    		case v_3714782 < 256:
    			gotoNext = 3714922
    			_ = gotoNext == 3714922
    			f.dict.writeByte(byte(v_3714782))
    		...
    		case v_3714782 < 265:
    			gotoNext = 3715226
    			_ = gotoNext == 3715226
    			length_3714898 = v_3714782 - 254
    			n_3714861 = 0
    			gotoNext = 3715674
    		case v_3714782 < 269:
    			gotoNext = 3715277
    			_ = gotoNext == 3715277
    			length_3714898 = v_3714782*2 - 519
    			n_3714861 = 1
    			gotoNext = 3715674
    		case v_3714782 < 273:
    			gotoNext = 3715333
    			_ = gotoNext == 3715333
    			length_3714898 = v_3714782*4 - 1057
    			n_3714861 = 2
    			gotoNext = 3715674
    		case v_3714782 < 277:
    			gotoNext = 3715389
    			_ = gotoNext == 3715389
    			length_3714898 = v_3714782*8 - 2149
    			n_3714861 = 3
    			gotoNext = 3715674
    		case v_3714782 < 281:
    			gotoNext = 3715445
    			_ = gotoNext == 3715445
    			length_3714898 = v_3714782*16 - 4365
    			n_3714861 = 4
    			gotoNext = 3715674
    		case v_3714782 < 285:
    			gotoNext = 3715503
    			_ = gotoNext == 3715503
    			length_3714898 = v_3714782*32 - 8861
    			n_3714861 = 5
    			gotoNext = 3715674
    		case v_3714782 < 286:
    			gotoNext = 3715562
    		...
    		if n_3714861 > 0 {
    			...
    			if f.nb < n_3714861 {
    				gotoNext = 3715701
    				_ = gotoNext == 3715701
    				if err_3714785 = f.moreBits(); err_3714785 != nil {
    					gotoNext = 3715741
    					_ = gotoNext == 3715741
    					f.err = err_3714785
    					return
    			...
    			_ = gotoNext == 3715786
    			length_3714898 += int(f.b & uint32(1<<n_3714861-1))
    			f.b >>= n_3714861
    			f.nb -= n_3714861
    			gotoNext = 3715855
    		} else {
    		...
    		if f.hd == nil {
    			...
    			_ = gotoNext == 3715988
    			dist_3715859 = int(bits.Reverse8(uint8(f.b & 31 << 3)))
    			f.b >>= 5
    			f.nb -= 5
    			gotoNext = 3716162
    		} else {
    			...
    			gotoNext = 3716073
    			_ = gotoNext == 3716073
    			if dist_3715859, err_3714785 = f.huffSym(f.hd); err_3714785 != nil {
    				gotoNext = 3716121
    				_ = gotoNext == 3716121
    				f.err = err_3714785
    				return
    		...
    		case dist_3715859 < 4:
    			...
    			dist_3715859++
    			gotoNext = 3716648
    		case dist_3715859 < 30:
    			gotoNext = 3716200
    			_ = gotoNext == 3716200
    			nb_3716227 = uint(dist_3715859-2) >> 1
    			extra_3716304 = (dist_3715859 & 1) << nb_3716227
    			_ = 0
    			gotoNext = 3716333
    			_ = gotoNext == 3716333
    			if f.nb < nb_3716227 {
    			...
    			_ = gotoNext == 3716432
    			extra_3716304 |= int(f.b & uint32(1<<nb_3716227-1))
    			f.b >>= nb_3716227
    			f.nb -= nb_3716227
    			dist_3715859 = 1<<(nb_3716227+1) + 1 + extra_3716304
    			gotoNext = 3716648
    		default:
    			gotoNext = 3716530
    			_ = gotoNext == 3716530
    		...
    		_ = gotoNext == 3716648
    		if dist_3715859 > f.dict.histSize() {
    			gotoNext = 3716676
    			_ = gotoNext == 3716676
    			f.err = CorruptInputError(f.roffset)
    			return
    		...
    		_ = gotoNext == 3716735
    		f.copyLen, f.copyDist = length_3714898, dist_3715859
    		gotoNext = 3716795
    		gotoNext = 3716795
    	}
    	_ = gotoNext == 3716795
    	...
    	_ = gotoNext == 3716795
    	{
    		gotoNext = 3716870
    		_ = gotoNext == 3716870
    		cnt_3716874 = f.dict.tryWriteCopy(f.copyDist, f.copyLen)
    		if cnt_3716874 == 0 {
    			gotoNext = 3716938
    			_ = gotoNext == 3716938
    			cnt_3716874 = f.dict.writeCopy(f.copyDist, f.copyLen)
    			gotoNext = 3716995
    		} else {
    			gotoNext = 3716995
    		}
    		_ = gotoNext == 3716995
    		f.copyLen -= cnt_3716874
