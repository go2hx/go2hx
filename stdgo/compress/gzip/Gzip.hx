...
@:structInit class Header {
    ...
    public function new(?comment:GoString, ?extra:Slice<GoUInt8>, ?modTime:stdgo.time.Time.Time, ?name:GoString, ?os:GoUInt8) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(comment) + " " + Go.string(extra) + " " + Go.string(modTime) + " " + Go.string(name) + " " + Go.string(os) + "}";
    }
...
@:structInit class Reader {
    ...
    public function read(_p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } {
        ...
        {
            var __tmp__ = stdgo.io.Io.readFull(_z.value._r, _z.value._buf.__slice__(0, ((8 : GoInt)))), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
    ...
    public function _readHeader():{ var _0 : Header; var _1 : Error; } {
        ...
        if (_z.value._buf[((0 : GoInt))] != _gzipID1 || _z.value._buf[((1 : GoInt))] != _gzipID2 || _z.value._buf[((2 : GoInt))] != _gzipDeflate) {
        ...
        if (_flg & _flagExtra != ((0 : GoUInt8))) {
            ...
            var _data:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0 ... ((_le.uint16(_z.value._buf.__slice__(0, ((2 : GoInt)))) : GoInt)).toBasic()) ((0 : GoUInt8))]);
            {
                {
        ...
        var _needConv:Bool = false;
        {
            ...
            Go.cfor(true, _i++, {
                ...
                if (_z.value._buf[_i] == ((0 : GoUInt8))) {
                    _z.value._digest = stdgo.hash.crc32.Crc32.update(_z.value._digest, stdgo.hash.crc32.Crc32.ieeetable, _z.value._buf.__slice__(0, _i + ((1 : GoInt))));
                    if (_needConv) {
                        var _s:Slice<GoInt32> = new Slice<GoInt32>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoInt32))]).setCap(((_i : GoInt)).toBasic());
    ...
    public function reset(_r:stdgo.io.Io.Reader):Error {
        var _z = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        _z.value = (({ _decompressor : _z.value._decompressor, _multistream : true, header : new Header(), _r : ((null : stdgo.compress.flate.Flate.Reader)), _digest : 0, _size : 0, _buf : new GoArray<GoUInt8>(...[for (i in 0 ... 512) ((0 : GoUInt8))]), _err : ((null : stdgo.Error)) } : Reader)).__copy__();
        {
            var __tmp__ = try {
    ...
    public function new(?header:Header, ?_r:stdgo.compress.flate.Flate.Reader, ?_decompressor:stdgo.io.Io.ReadCloser, ?_digest:GoUInt32, ?_size:GoUInt32, ?_buf:GoArray<GoUInt8>, ?_err:stdgo.Error, ?_multistream:Bool) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(header) + " " + Go.string(_r) + " " + Go.string(_decompressor) + " " + Go.string(_digest) + " " + Go.string(_size) + " " + Go.string(_buf) + " " + Go.string(_err) + " " + Go.string(_multistream) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class Writer {
    ...
    public function _writeBytes(_b:Slice<GoByte>):Error {
        ...
        var __tmp__ = _z.value._w.write(_z.value._buf.__slice__(0, ((2 : GoInt)))), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return _err;
        };
        {
    ...
    public function _init(_w:stdgo.io.Io.Writer, _level:GoInt):Void {
        ...
        _z.value = (({ header : (({ os : ((255 : GoUInt8)), comment : "", extra : new Slice<GoUInt8>().nil(), modTime : new stdgo.time.Time.Time(), name : "" } : Header)).__copy__(), _w : _w, _level : _level, _compressor : _compressor, _wroteHeader : false, _digest : 0, _size : 0, _closed : false, _buf : new GoArray<GoUInt8>(...[for (i in 0 ... 10) ((0 : GoUInt8))]), _err : ((null : stdgo.Error)) } : Writer)).__copy__();
    }
    @:embedded
    public var header : Header = new Header();
    ...
    public var _err : stdgo.Error = ((null : stdgo.Error));
    public function new(?header:Header, ?_w:stdgo.io.Io.Writer, ?_level:GoInt, ?_wroteHeader:Bool, ?_compressor:Pointer<stdgo.compress.flate.Flate.Writer>, ?_digest:GoUInt32, ?_size:GoUInt32, ?_closed:Bool, ?_buf:GoArray<GoUInt8>, ?_err:stdgo.Error) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(header) + " " + Go.string(_w) + " " + Go.string(_level) + " " + Go.string(_wroteHeader) + " " + Go.string(_compressor) + " " + Go.string(_digest) + " " + Go.string(_size) + " " + Go.string(_closed) + " " + Go.string(_buf) + " " + Go.string(_err) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
function newWriter(_w:stdgo.io.Io.Writer):Pointer<Writer> {
        var __tmp__ = newWriterLevel(_w, defaultCompression), _z:Pointer<Writer> = __tmp__._0, _:stdgo.Error = __tmp__._1;
        return _z;
    }
/**
...
class Reader_extension_fields {
    public function reset(__tmp__, _r:stdgo.io.Io.Reader):Error return __tmp__.reset(_r);
    public function multistream(__tmp__, _ok:Bool):Void __tmp__.multistream(_ok);
    public function _readString(__tmp__):{ var _0 : GoString; var _1 : Error; } return __tmp__._readString();
    public function _readHeader(__tmp__):{ var _0 : Header; var _1 : Error; } return __tmp__._readHeader();
...
class Writer_extension_fields {
    public function _init(__tmp__, _w:stdgo.io.Io.Writer, _level:GoInt):Void __tmp__._init(_w, _level);
    public function reset(__tmp__, _w:stdgo.io.Io.Writer):Void __tmp__.reset(_w);
    public function _writeBytes(__tmp__, _b:Slice<GoByte>):Error return __tmp__._writeBytes(_b);
    public function _writeString(__tmp__, _s:GoString):Error return __tmp__._writeString(_s);
