...
@:structInit @:using(Lzw.Reader_static_extension) abstract Reader(stdgo._internal.compress.lzw.Lzw_reader.Reader) from stdgo._internal.compress.lzw.Lzw_reader.Reader to stdgo._internal.compress.lzw.Lzw_reader.Reader {
...
@:structInit @:using(Lzw.Writer_static_extension) abstract Writer(stdgo._internal.compress.lzw.Lzw_writer.Writer) from stdgo._internal.compress.lzw.Lzw_writer.Writer to stdgo._internal.compress.lzw.Lzw_writer.Writer {
