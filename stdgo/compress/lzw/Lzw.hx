...
@:named class Order {
    ...
    public function __copy__() return new Order(__t__);
}
@:structInit class Reader {
    ...
    public function _decode():Void {
        ...
        stdgo.internal.Macro.controlFlow({
            @:label("loop") while (true) {
                var __tmp__ = _r.value._read(_r), _code:GoUInt16 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                ...
                };
                {
                    ...
                    while (true) {
                        if (_code < _r.value._clear) {
                            ...
                            var _c:GoUInt16 = _code, _i:GoInt = _r.value._output.length - ((1 : GoInt));
    ...
    public function _readMSB():{ var _0 : GoUInt16; var _1 : Error; } {
        ...
        while (_r.value._nBits < _r.value._width) {
            var __tmp__ = _r.value._r.readByte(), _x:GoUInt8 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
    ...
    public var _read : Pointer<Reader> -> { var _0 : GoUInt16; var _1 : stdgo.Error; } = null;
    ...
    public function new(?_r:stdgo.io.Io.ByteReader, ?_bits:GoUInt32, ?_nBits:GoUInt, ?_width:GoUInt, ?_read:Pointer<Reader> -> { var _0 : GoUInt16; var _1 : stdgo.Error; }, ?_litWidth:GoInt, ?_err:stdgo.Error, ?_clear:GoUInt16, ?_eof:GoUInt16, ?_hi:GoUInt16, ?_overflow:GoUInt16, ?_last:GoUInt16, ?_suffix:GoArray<GoUInt8>, ?_prefix:GoArray<GoUInt16>, ?_output:GoArray<GoUInt8>, ?_o:GoInt, ?_toRead:Slice<GoUInt8>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_r) + " " + Go.string(_bits) + " " + Go.string(_nBits) + " " + Go.string(_width) + " " + Go.string(_read) + " " + Go.string(_litWidth) + " " + Go.string(_err) + " " + Go.string(_clear) + " " + Go.string(_eof) + " " + Go.string(_hi) + " " + Go.string(_overflow) + " " + Go.string(_last) + " " + Go.string(_suffix) + " " + Go.string(_prefix) + " " + Go.string(_output) + " " + Go.string(_o) + " " + Go.string(_toRead) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
...
@:structInit class Writer {
    ...
    public function write(_p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } {
        ...
        return stdgo.internal.Macro.controlFlow({
            ...
            @:label("loop") for (_x in _p) {
                ...
                {
                    var _h:GoUInt32 = _hash, _t:GoUInt32 = _w.value._table[_hash];
    ...
    public function new(?_w:T_writer, ?_order:Order, ?_write:(Pointer<Writer>, GoUInt32) -> stdgo.Error, ?_bits:GoUInt32, ?_nBits:GoUInt, ?_width:GoUInt, ?_litWidth:GoUInt, ?_hi:GoUInt32, ?_overflow:GoUInt32, ?_savedCode:GoUInt32, ?_err:stdgo.Error, ?_table:GoArray<GoUInt32>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_w) + " " + Go.string(_order) + " " + Go.string(_write) + " " + Go.string(_bits) + " " + Go.string(_nBits) + " " + Go.string(_width) + " " + Go.string(_litWidth) + " " + Go.string(_hi) + " " + Go.string(_overflow) + " " + Go.string(_savedCode) + " " + Go.string(_err) + " " + Go.string(_table) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
        return new Writer(
...
class Reader_extension_fields {
    public function _readLSB(__tmp__):{ var _0 : GoUInt16; var _1 : Error; } return __tmp__._readLSB();
    public function _readMSB(__tmp__):{ var _0 : GoUInt16; var _1 : Error; } return __tmp__._readMSB();
    public function read(__tmp__, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } return __tmp__.read(_b);
    public function _decode(__tmp__):Void __tmp__._decode();
    public function close(__tmp__):Error return __tmp__.close();
    public function reset(__tmp__, _src:stdgo.io.Io.Reader, _order:Order, _litWidth:GoInt):Void __tmp__.reset(_src, _order, _litWidth);
    public function _init(__tmp__, _src:stdgo.io.Io.Reader, _order:Order, _litWidth:GoInt):Void __tmp__._init(_src, _order, _litWidth);
}
class Writer_extension_fields {
    public function _writeLSB(__tmp__, _c:GoUInt32):Error return __tmp__._writeLSB(_c);
    public function _writeMSB(__tmp__, _c:GoUInt32):Error return __tmp__._writeMSB(_c);
    public function _incHi(__tmp__):Error return __tmp__._incHi();
    public function write(__tmp__, _p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } return __tmp__.write(_p);
    public function close(__tmp__):Error return __tmp__.close();
    public function reset(__tmp__, _dst:stdgo.io.Io.Writer, _order:Order, _litWidth:GoInt):Void __tmp__.reset(_dst, _order, _litWidth);
    public function _init(__tmp__, _dst:stdgo.io.Io.Writer, _order:Order, _litWidth:GoInt):Void __tmp__._init(_dst, _order, _litWidth);
}
