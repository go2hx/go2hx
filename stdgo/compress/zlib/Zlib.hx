...
@:structInit class T_reader {
    public function reset(_r:stdgo.io.Io.Reader, _dict:Slice<GoByte>):Error {
        ...
        _z.value = (({ _decompressor : _z.value._decompressor, _r : ((null : stdgo.compress.flate.Flate.Reader)), _digest : ((null : stdgo.hash.Hash.Hash32)), _err : ((null : stdgo.Error)), _scratch : new GoArray<GoUInt8>(...[for (i in 0 ... 4) ((0 : GoUInt8))]) } : T_reader)).__copy__();
        {
            var __tmp__ = try {
    ...
    public function read(_p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } {
        ...
        {
            var __tmp__ = stdgo.io.Io.readFull(_z.value._r, _z.value._scratch.__slice__(((0 : GoInt)), ((4 : GoInt)))), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
    ...
    public function new(?_r:stdgo.compress.flate.Flate.Reader, ?_decompressor:stdgo.io.Io.ReadCloser, ?_digest:stdgo.hash.Hash.Hash32, ?_err:stdgo.Error, ?_scratch:GoArray<GoUInt8>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_r) + " " + Go.string(_decompressor) + " " + Go.string(_digest) + " " + Go.string(_err) + " " + Go.string(_scratch) + "}";
    }
...
@:structInit class Writer {
    ...
    public function _writeHeader():Error {
        ...
        } else if (_z.value._level == ((2 : GoInt)) || _z.value._level == ((3 : GoInt)) || _z.value._level == ((4 : GoInt)) || _z.value._level == ((5 : GoInt))) {
        ...
        _z.value._scratch[((1 : GoInt))] = _z.value._scratch[((1 : GoInt))] + ((((((31 : GoUInt16)) - ((((_z.value._scratch[((0 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) + ((_z.value._scratch[((1 : GoInt))] : GoUInt16))) % ((31 : GoUInt16))) : GoUInt8)));
        {
            {
    ...
    public function new(?_w:stdgo.io.Io.Writer, ?_level:GoInt, ?_dict:Slice<GoUInt8>, ?_compressor:Pointer<stdgo.compress.flate.Flate.Writer>, ?_digest:stdgo.hash.Hash.Hash32, ?_err:stdgo.Error, ?_scratch:GoArray<GoUInt8>, ?_wroteHeader:Bool) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_w) + " " + Go.string(_level) + " " + Go.string(_dict) + " " + Go.string(_compressor) + " " + Go.string(_digest) + " " + Go.string(_err) + " " + Go.string(_scratch) + " " + Go.string(_wroteHeader) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
function newWriter(_w:stdgo.io.Io.Writer):Pointer<Writer> {
        var __tmp__ = newWriterLevelDict(_w, defaultCompression, new Slice<GoUInt8>().nil()), _z:Pointer<Writer> = __tmp__._0, _:stdgo.Error = __tmp__._1;
        return _z;
    }
/**
...
function newWriterLevelDict(_w:stdgo.io.Io.Writer, _level:GoInt, _dict:Slice<GoByte>):{ var _0 : Pointer<Writer>; var _1 : Error; } {
        ...
        return { _0 : Go.pointer((({ _w : _w, _level : _level, _dict : _dict, _compressor : new Pointer<stdgo.compress.flate.Flate.Writer>().nil(), _digest : ((null : stdgo.hash.Hash.Hash32)), _err : ((null : stdgo.Error)), _scratch : new GoArray<GoUInt8>(...[for (i in 0 ... 4) ((0 : GoUInt8))]), _wroteHeader : false } : Writer))), _1 : ((null : stdgo.Error)) };
    }
...
class Writer_extension_fields {
    ...
    public function _writeHeader(__tmp__):Error return __tmp__._writeHeader();
