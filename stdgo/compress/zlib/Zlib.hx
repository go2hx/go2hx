...
function testWriterBig(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (_i => _fn in _filenames) {
            ...
            _testFileLevelDict(_t, _fn?.__copy__(), (-2 : stdgo.StdGoTypes.GoInt), stdgo.Go.str()?.__copy__());
            {
                var _level:stdgo.StdGoTypes.GoInt = (1 : stdgo.StdGoTypes.GoInt);
                stdgo.Go.cfor(_level <= (9 : stdgo.StdGoTypes.GoInt), _level++, {
...
function testWriterReset(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        for (__0 => _fn in _filenames) {
            ...
            _testFileLevelDictReset(_t, _fn?.__copy__(), (-1 : stdgo.StdGoTypes.GoInt), (null : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>));
            _testFileLevelDictReset(_t, _fn?.__copy__(), (-2 : stdgo.StdGoTypes.GoInt), (null : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>));
            _testFileLevelDictReset(_t, _fn?.__copy__(), (0 : stdgo.StdGoTypes.GoInt), (("0123456789." : stdgo.GoString) : stdgo.Slice<stdgo.StdGoTypes.GoByte>));
            _testFileLevelDictReset(_t, _fn?.__copy__(), (-1 : stdgo.StdGoTypes.GoInt), (("0123456789." : stdgo.GoString) : stdgo.Slice<stdgo.StdGoTypes.GoByte>));
            _testFileLevelDictReset(_t, _fn?.__copy__(), (-2 : stdgo.StdGoTypes.GoInt), (("0123456789." : stdgo.GoString) : stdgo.Slice<stdgo.StdGoTypes.GoByte>));
            ...
            };
            {
                var _level:stdgo.StdGoTypes.GoInt = (1 : stdgo.StdGoTypes.GoInt);
                stdgo.Go.cfor(_level <= (9 : stdgo.StdGoTypes.GoInt), _level++, {
                    _testFileLevelDictReset(_t, _fn?.__copy__(), _level, (null : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>));
                });
            };
        };
    }
