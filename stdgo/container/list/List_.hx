...
@:structInit class Element {
	...
	public function new(?_next:Pointer<Element>, ?_prev:Pointer<Element>, ?_list:Pointer<List_>, ?value:AnyInterface)
...
@:structInit class List_ {
	public function pushFrontList(_other:Pointer<List_>):Void {
		...
		_l.value._lazyInit();
		{
			var _i:GoInt = _other.value.len(),
				_e:Pointer<Element> = _other.value.back();
			Go.cfor(_i > ((0 : GoInt)), {
	...
	public function pushBackList(_other:Pointer<List_>):Void {
		...
		{
			var _i:GoInt = _other.value.len(),
				_e:Pointer<Element> = _other.value.front();
			Go.cfor(_i > ((0 : GoInt)), {
				final __tmp__0 = _i - ((1 : GoInt));
	...
	public function _insertValue(_v:AnyInterface, _at:Pointer<Element>):Pointer<Element> {
		var _l = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		return _l.value._insert(Go.pointer((({
			value: Go.toInterface(_v),
			_next: new Pointer<Element>().nil(),
			_prev: new Pointer<Element>().nil(),
			_list: new Pointer<List_>().nil()
		} : Element))), _at);
	}
...
class Element_extension_fields {
	public function next(__tmp__):Pointer<Element>
		return __tmp__.next();

	public function prev(__tmp__):Pointer<Element>
		return __tmp__.prev();
}

class List__extension_fields {
	public function init(__tmp__):Pointer<List_>
		return __tmp__.init();

	public function len(__tmp__):GoInt
		return __tmp__.len();

	public function front(__tmp__):Pointer<Element>
		return __tmp__.front();

	public function back(__tmp__):Pointer<Element>
		return __tmp__.back();

	public function _lazyInit(__tmp__):Void
		__tmp__._lazyInit();

	public function _insert(__tmp__, _e:Pointer<Element>, _at:Pointer<Element>):Pointer<Element>
		return __tmp__._insert(_e, _at);

	public function _insertValue(__tmp__, _v:AnyInterface, _at:Pointer<Element>):Pointer<Element>
		return __tmp__._insertValue(_v, _at);

	public function _remove(__tmp__, _e:Pointer<Element>):Pointer<Element>
		return __tmp__._remove(_e);

	public function _move(__tmp__, _e:Pointer<Element>, _at:Pointer<Element>):Pointer<Element>
		return __tmp__._move(_e, _at);

	public function remove(__tmp__, _e:Pointer<Element>):AnyInterface
		return __tmp__.remove(_e);

	public function pushFront(__tmp__, _v:AnyInterface):Pointer<Element>
		return __tmp__.pushFront(_v);

	public function pushBack(__tmp__, _v:AnyInterface):Pointer<Element>
		return __tmp__.pushBack(_v);

	public function insertBefore(__tmp__, _v:AnyInterface, _mark:Pointer<Element>):Pointer<Element>
		return __tmp__.insertBefore(_v, _mark);

	public function insertAfter(__tmp__, _v:AnyInterface, _mark:Pointer<Element>):Pointer<Element>
		return __tmp__.insertAfter(_v, _mark);

	public function moveToFront(__tmp__, _e:Pointer<Element>):Void
		__tmp__.moveToFront(_e);

	public function moveToBack(__tmp__, _e:Pointer<Element>):Void
		__tmp__.moveToBack(_e);

	public function moveBefore(__tmp__, _e:Pointer<Element>, _mark:Pointer<Element>):Void
		__tmp__.moveBefore(_e, _mark);

	public function moveAfter(__tmp__, _e:Pointer<Element>, _mark:Pointer<Element>):Void
		__tmp__.moveAfter(_e, _mark);

	public function pushBackList(__tmp__, _other:Pointer<List_>):Void
		__tmp__.pushBackList(_other);

	public function pushFrontList(__tmp__, _other:Pointer<List_>):Void
		__tmp__.pushFrontList(_other);
}
