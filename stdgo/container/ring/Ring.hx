...
@:structInit class Ring {
	...
	public function new(?_next:Pointer<Ring>, ?_prev:Pointer<Ring>, ?value:AnyInterface)
...
class Ring_extension_fields {
	public function _init(__tmp__):Pointer<Ring>
		return __tmp__._init();

	public function next(__tmp__):Pointer<Ring>
		return __tmp__.next();

	public function prev(__tmp__):Pointer<Ring>
		return __tmp__.prev();

	public function move(__tmp__, _n:GoInt):Pointer<Ring>
		return __tmp__.move(_n);

	public function link(__tmp__, _s:Pointer<Ring>):Pointer<Ring>
		return __tmp__.link(_s);

	public function unlink(__tmp__, _n:GoInt):Pointer<Ring>
		return __tmp__.unlink(_n);

	public function len(__tmp__):GoInt
		return __tmp__.len();

	public function do_(__tmp__, _f:AnyInterface->Void):Void
		__tmp__.do_(_f);
}
