...
```
[30;41m ERROR [0m stdgo/crypto/sha1/Sha1.hx:135: characters 9-59

  135 | [2m        [0m[1mreturn stdgo._internal.crypto.sha1.Sha1.sum(_data)[0m[2m;[0m
      |         [31m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^[0m
      | stdgo.GoArray<stdgo.GoByte> should be haxe.ds.Vector<Int>
