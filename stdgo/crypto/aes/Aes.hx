...
@:dox(hide) @:forward abstract T_testInterface(stdgo._internal.crypto.aes.Aes_t_testinterface.T_testInterface) from stdgo._internal.crypto.aes.Aes_t_testinterface.T_testInterface to stdgo._internal.crypto.aes.Aes_t_testinterface.T_testInterface {
    @:from
