...
typedef AEAD = StructType & {
	...
	public function open(_dst:Slice<GoByte>, _nonce:Slice<GoByte>, _ciphertext:Slice<GoByte>,
		_additionalData:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:Error;};
};
...
@:named @:structInit class T_cbcEncrypter extends T_cbc {
	...
	public function new(?_b, ?_blockSize, ?_iv, ?_tmp)
		super(_b, _blockSize, _iv, _tmp);

	public override function __copy__()
		return new T_cbcEncrypter(_b, _blockSize, _iv, _tmp);
}
...
@:named @:structInit class T_cbcDecrypter extends T_cbc {
	...
	public override function __copy__()
		return new T_cbcDecrypter(_b, _blockSize, _iv, _tmp);
}
...
@:structInit class T_gcm {
	...
	public function open(_dst:Slice<GoByte>, _nonce:Slice<GoByte>, _ciphertext:Slice<GoByte>, _data:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:Error;} {
		...
		if (((_ciphertext.length : GoUInt64)) > (((((1 : GoUnTypedInt)) << ((32 : GoUnTypedInt))))
			- ((2 : GoUnTypedInt))) * ((_g.value._cipher.blockSize() : GoUInt64))
			+ ((_g.value._tagSize : GoUInt64))) {
			return {_0: new Slice<GoUInt8>().nil(), _1: _errOpen};
		};
		...
		var _counter:GoArray<GoByte> = new GoArray<GoUInt8>(...[for (i in 0...16) ((0 : GoUInt8))]),
			_tagMask:GoArray<GoByte> = new GoArray<GoUInt8>(...[for (i in 0...16) ((0 : GoUInt8))]);
		...
		var __tmp__ = _sliceForAppend(_dst, _ciphertext.length),
	...
	public function seal(_dst:Slice<GoByte>, _nonce:Slice<GoByte>, _plaintext:Slice<GoByte>, _data:Slice<GoByte>):Slice<GoByte> {
		...
		var __tmp__ = _sliceForAppend(_dst, _plaintext.length + _g.value._tagSize),
			_ret:Slice<GoUInt8> = __tmp__._0,
			_out:Slice<GoUInt8> = __tmp__._1;
	...
	public function toString() {
		return '{'
			+ Go.string(_cipher)
			+ " "
			+ Go.string(_nonceSize)
			+ " "
			+ Go.string(_tagSize)
			+ " "
			+ Go.string(_productTable)
			+ "}";
	}
...
var _gcmReductionTable:Slice<GoUInt16> = new Slice<GoUInt16>(((0 : GoUInt16)), ((7200 : GoUInt16)), ((14400 : GoUInt16)), ((9312 : GoUInt16)),
	((28800 : GoUInt16)), ((27808 : GoUInt16)), ((18624 : GoUInt16)), ((21728 : GoUInt16)), ((57600 : GoUInt16)), ((64800 : GoUInt16)), ((55616 : GoUInt16)),
	((50528 : GoUInt16)), ((37248 : GoUInt16)), ((36256 : GoUInt16)), ((43456 : GoUInt16)), ((46560 : GoUInt16)));

final _gcmStandardNonceSize:GoInt64 = ((12 : GoUnTypedInt));

final _supportsUnaligned:Bool = stdgo.runtime.Runtime.goarch == (("386" : GoString))
	|| stdgo.runtime.Runtime.goarch == (("ppc64" : GoString))
...
function _newCBC(_b:Block, _iv:Slice<GoByte>):Pointer<T_cbc> {
	return Go.pointer((({
		_b: _b,
		_blockSize: _b.blockSize(),
		_iv: _dup(_iv),
		_tmp: new Slice<GoUInt8>(...[for (i in 0...((_b.blockSize() : GoInt)).toBasic()) ((0 : GoUInt8))])
	} : T_cbc)));
}
...
function newCBCEncrypter(_b:Block, _iv:Slice<GoByte>):BlockMode {
	...
	return {
		var p = new Pointer<T_cbcEncrypter>(() -> new T_cbcEncrypter(_newCBC(_b, _iv).value._b, _newCBC(_b, _iv).value._blockSize, _newCBC(_b, _iv).value._iv,
			_newCBC(_b, _iv).value._tmp),
			null, false, _newCBC(_b, _iv));
...
function newCBCDecrypter(_b:Block, _iv:Slice<GoByte>):BlockMode {
	...
	return {
		var p = new Pointer<T_cbcDecrypter>(() -> new T_cbcDecrypter(_newCBC(_b, _iv).value._b, _newCBC(_b, _iv).value._blockSize, _newCBC(_b, _iv).value._iv,
			_newCBC(_b, _iv).value._tmp),
			null, false, _newCBC(_b, _iv));
		p.convert = v -> new T_cbc(v._b, v._blockSize, v._iv, v._tmp);
		p;
...
function _newCFB(_block:Block, _iv:Slice<GoByte>, _decrypt:Bool):Stream {
	...
	var _x:Pointer<T_cfb> = Go.pointer((({
		_b: _block,
		_out: new Slice<GoUInt8>(...[for (i in 0...((_blockSize : GoInt)).toBasic()) ((0 : GoUInt8))]),
		_next: new Slice<GoUInt8>(...[for (i in 0...((_blockSize : GoInt)).toBasic()) ((0 : GoUInt8))]),
		_outUsed: _blockSize,
		_decrypt: _decrypt
	} : T_cfb)));
...
function newCTR(_block:Block, _iv:Slice<GoByte>):Stream {
	...
	return Go.pointer((({
		_b: _block,
		_ctr: _dup(_iv),
		_out: new Slice<GoUInt8>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((_bufSize : GoInt)).toBasic()),
		_outUsed: ((0 : GoInt))
	} : T_ctr))).value;
}
...
function _newGCMWithNonceAndTagSize(_cipher:Block, _nonceSize:GoInt, _tagSize:GoInt):{var _0:AEAD; var _1:Error;} {
	...
	if (_nonceSize <= ((0 : GoInt))) {
		return {_0: ((null : AEAD)),
			_1: stdgo.errors.Errors.new_("cipher: the nonce can\'t have zero length, or the security of the key will be immediately compromised")};
	};
	{
		var __tmp__ = try {
	...
	var _g:Pointer<T_gcm> = Go.pointer((({
		_cipher: _cipher,
		_nonceSize: _nonceSize,
		_tagSize: _tagSize,
		_productTable: new GoArray<T_gcmFieldElement>(...[for (i in 0...16) new T_gcmFieldElement()])
	} : T_gcm)));
	var _x:T_gcmFieldElement = new T_gcmFieldElement(stdgo.encoding.binary.Binary.bigEndian.uint64(_key.__slice__(0, ((8 : GoInt)))),
		stdgo.encoding.binary.Binary.bigEndian.uint64(_key.__slice__(((8 : GoInt))))).__copy__();
	_g.value._productTable[_reverseBits(((1 : GoInt)))] = _x.__copy__();
	{
		...
		Go.cfor(_i < ((16 : GoInt)), _i = _i + (((2 : GoInt))), {
			...
			_g.value._productTable[_reverseBits(_i + ((1 : GoInt)))] = _gcmAdd(Go.pointer(_g.value._productTable[_reverseBits(_i)]),
				Go.pointer(_x)).__copy__();
		});
	};
...
function _sliceForAppend(_in:Slice<GoByte>, _n:GoInt):{var _0:Slice<GoByte>; var _1:Slice<GoByte>;} {
	var _head:Slice<GoByte> = new Slice<GoUInt8>().nil(),
		_tail:Slice<GoByte> = new Slice<GoUInt8>().nil();
	{
...
function newOFB(_b:Block, _iv:Slice<GoByte>):Stream {
	...
	var _x:Pointer<T_ofb> = Go.pointer((({
		_b: _b,
		_cipher: new Slice<GoUInt8>(...[for (i in 0...((_blockSize : GoInt)).toBasic()) ((0 : GoUInt8))]),
		_out: new Slice<GoUInt8>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((_bufSize : GoInt)).toBasic()),
		_outUsed: ((0 : GoInt))
	} : T_ofb)));
...
class T_cbcEncrypter_extension_fields {
	...
	public function cryptBlocks(__tmp__, _dst:Slice<GoByte>, _src:Slice<GoByte>):Void
		__tmp__.cryptBlocks(_dst, _src);

	public function setIV(__tmp__, _iv:Slice<GoByte>):Void
		__tmp__.setIV(_iv);
}
...
class T_ctr_extension_fields {
	public function _refill(__tmp__):Void
		__tmp__._refill();
...
class T_gcm_extension_fields {
	public function nonceSize(__tmp__):GoInt
		return __tmp__.nonceSize();

	public function overhead(__tmp__):GoInt
		return __tmp__.overhead();

	public function seal(__tmp__, _dst:Slice<GoByte>, _nonce:Slice<GoByte>, _plaintext:Slice<GoByte>, _data:Slice<GoByte>):Slice<GoByte>
		return __tmp__.seal(_dst, _nonce, _plaintext, _data);

	public function open(__tmp__, _dst:Slice<GoByte>, _nonce:Slice<GoByte>, _ciphertext:Slice<GoByte>,
			_data:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__.open(_dst, _nonce, _ciphertext, _data);

	public function _mul(__tmp__, _y:Pointer<T_gcmFieldElement>):Void
		__tmp__._mul(_y);

	public function _updateBlocks(__tmp__, _y:Pointer<T_gcmFieldElement>, _blocks:Slice<GoByte>):Void
		__tmp__._updateBlocks(_y, _blocks);

	public function _update(__tmp__, _y:Pointer<T_gcmFieldElement>, _data:Slice<GoByte>):Void
		__tmp__._update(_y, _data);

	public function _counterCrypt(__tmp__, _out:Slice<GoByte>, _in:Slice<GoByte>, _counter:Pointer<GoArray<GoByte>>):Void
		__tmp__._counterCrypt(_out, _in, _counter);

	public function _deriveCounter(__tmp__, _counter:Pointer<GoArray<GoByte>>, _nonce:Slice<GoByte>):Void
		__tmp__._deriveCounter(_counter, _nonce);

	public function _auth(__tmp__, _out:Slice<GoByte>, _ciphertext:Slice<GoByte>, _additionalData:Slice<GoByte>, _tagMask:Pointer<GoArray<GoByte>>):Void
		__tmp__._auth(_out, _ciphertext, _additionalData, _tagMask);
}

class StreamReader_extension_fields {
	public function read(__tmp__, _dst:Slice<GoByte>):{var _0:GoInt; var _1:Error;}
		return __tmp__.read(_dst);
}

class StreamWriter_extension_fields {
	public function write(__tmp__, _src:Slice<GoByte>):{var _0:GoInt; var _1:Error;}
		return __tmp__.write(_src);
