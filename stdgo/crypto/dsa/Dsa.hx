...
@:structInit class PublicKey {
	...
	public function new(?parameters:Parameters, ?y:Pointer<stdgo.math.big.Big.Int_>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class PrivateKey {
	...
	public function new(?publicKey:PublicKey, ?x:Pointer<stdgo.math.big.Big.Int_>)
		stdgo.internal.Macro.initLocals();
...
@:named class ParameterSizes {
	...
	public function __copy__()
		return new ParameterSizes(__t__);
}
...
function generateParameters(_params:Pointer<Parameters>, _rand:stdgo.io.Io.Reader, _sizes:ParameterSizes):Error {
	return stdgo.internal.Macro.controlFlow({
		...
		@:label("GeneratePrimes") while (true) {
			{
				var __tmp__ = stdgo.io.Io.readFull(_rand, _qBytes),
					_:GoInt = __tmp__._0,
			...
			};
			{
				...
				Go.cfor(_i < ((4 : GoInt)) * l, _i++, {
					{
						var __tmp__ = stdgo.io.Io.readFull(_rand, _pBytes),
							_:GoInt = __tmp__._0,
							_err:stdgo.Error = __tmp__._1;
						if (_err != null) {
							return _err;
...
function generateKey(_priv:Pointer<PrivateKey>, _rand:stdgo.io.Io.Reader):Error {
	if ((_priv.value.publicKey.parameters.p == null || _priv.value.publicKey.parameters.p.isNil())
		|| (_priv.value.publicKey.parameters.q == null || _priv.value.publicKey.parameters.q.isNil())
		|| (_priv.value.publicKey.parameters.g == null || _priv.value.publicKey.parameters.g.isNil())) {
	...
	var _xBytes:Slice<GoUInt8> = new Slice<GoUInt8>(...[
		for (i in 0...((_priv.value.publicKey.parameters.q.value.bitLen() / ((8 : GoInt)):GoInt)).toBasic()) ((0 : GoUInt8))
	]);
	while (true) {
		var __tmp__ = stdgo.io.Io.readFull(_rand, _xBytes),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return _err;
...
function sign(_rand:stdgo.io.Io.Reader, _priv:Pointer<PrivateKey>,
	...
	if (_priv.value.publicKey.parameters.q.value.sign() <= ((0 : GoInt))
		|| _priv.value.publicKey.parameters.p.value.sign() <= ((0 : GoInt))
		|| _priv.value.publicKey.parameters.g.value.sign() <= ((0 : GoInt))
		|| _priv.value.x.value.sign() <= ((0 : GoInt))
		|| _n % ((8 : GoInt)) != ((0 : GoInt))) {
