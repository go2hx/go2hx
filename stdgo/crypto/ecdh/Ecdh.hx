...
@:structInit @:using(Ecdh.PublicKey_static_extension) abstract PublicKey(stdgo._internal.crypto.ecdh.Ecdh_publickey.PublicKey) from stdgo._internal.crypto.ecdh.Ecdh_publickey.PublicKey to stdgo._internal.crypto.ecdh.Ecdh_publickey.PublicKey {
...
@:structInit @:using(Ecdh.PrivateKey_static_extension) abstract PrivateKey(stdgo._internal.crypto.ecdh.Ecdh_privatekey.PrivateKey) from stdgo._internal.crypto.ecdh.Ecdh_privatekey.PrivateKey to stdgo._internal.crypto.ecdh.Ecdh_privatekey.PrivateKey {
    public var _curve(get, set) : Curve;
    function get__curve():Curve return this._curve;
    function set__curve(v:Curve):Curve {
        this._curve = v;
...
@:structInit @:using(Ecdh.T_nistCurve_static_extension) @:dox(hide) abstract T_nistCurve(stdgo._internal.crypto.ecdh.Ecdh_t_nistcurve.T_nistCurve) from stdgo._internal.crypto.ecdh.Ecdh_t_nistcurve.T_nistCurve to stdgo._internal.crypto.ecdh.Ecdh_t_nistcurve.T_nistCurve {
...
@:structInit @:using(Ecdh.T_x25519Curve_static_extension) @:dox(hide) abstract T_x25519Curve(stdgo._internal.crypto.ecdh.Ecdh_t_x25519curve.T_x25519Curve) from stdgo._internal.crypto.ecdh.Ecdh_t_x25519curve.T_x25519Curve to stdgo._internal.crypto.ecdh.Ecdh_t_x25519curve.T_x25519Curve {
