...
typedef T_combinedMult = StructType & {
	public function combinedMult(_bigX:Pointer<stdgo.math.big.Big.Int_>, _bigY:Pointer<stdgo.math.big.Big.Int_>, _baseScalar:Slice<GoByte>,
		_scalar:Slice<GoByte>):{
...
@:structInit class PublicKey {
	public function equal(_x:stdgo.crypto.Crypto.PublicKey):Bool {
		...
		return _pub.value.x.value.cmp(_xx.value.x) == ((0 : GoInt))
			&& _pub.value.y.value.cmp(_xx.value.y) == ((0 : GoInt))
			&& Go.toInterface(_pub.value.curve) == Go.toInterface(_xx.value.curve);
	}
	...
	public function new(?curve:stdgo.crypto.elliptic.Elliptic.Curve, ?x:Pointer<stdgo.math.big.Big.Int_>, ?y:Pointer<stdgo.math.big.Big.Int_>)
	...
	public function double(_x1:Pointer<stdgo.math.big.Big.Int_>,
		...
		return curve.double(_0, _1);

	public function isOnCurve(_x:Pointer<stdgo.math.big.Big.Int_>, _y:Pointer<stdgo.math.big.Big.Int_>):Bool
		return curve.isOnCurve(_0, _1);

	public function params():Pointer<stdgo.crypto.elliptic.Elliptic.CurveParams>
		return curve.params();

	public function scalarBaseMult(_k:Slice<GoUInt8>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;}
		return curve.scalarBaseMult(_0);

	public function scalarMult(_x1:Pointer<stdgo.math.big.Big.Int_>, _y1:Pointer<stdgo.math.big.Big.Int_>,
			_k:Slice<GoUInt8>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;}
		return curve.scalarMult(_0, _1, _2);
...
@:structInit class PrivateKey {
	public function sign(_rand:stdgo.io.Io.Reader, _digest:Slice<GoByte>, _opts:stdgo.crypto.Crypto.SignerOpts):{var _0:Slice<GoByte>; var _1:Error;} {
		...
		var __tmp__ = Ecdsa.sign(_rand, _priv, _digest),
			_r:Pointer<stdgo.math.big.Big.Int_> = __tmp__._0,
			_s:Pointer<stdgo.math.big.Big.Int_> = __tmp__._1,
	...
	public function equal(_x:stdgo.crypto.Crypto.PrivateKey):Bool {
		...
		return _priv.value.publicKey.equal(Go.toInterface(Go.pointer(_xx.value.publicKey)))
	...
	public function new(?publicKey:PublicKey, ?d:Pointer<stdgo.math.big.Big.Int_>)
		stdgo.internal.Macro.initLocals();
	...
	public function add(_x1:Pointer<stdgo.math.big.Big.Int_>, _y1:Pointer<stdgo.math.big.Big.Int_>, _x2:Pointer<stdgo.math.big.Big.Int_>,
		...
		return publicKey.add(_0, _1, _2, _3);

	public function double(_x1:Pointer<stdgo.math.big.Big.Int_>,
			_y1:Pointer<stdgo.math.big.Big.Int_>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;}
		return publicKey.double(_0, _1);

	public function isOnCurve(_x:Pointer<stdgo.math.big.Big.Int_>, _y:Pointer<stdgo.math.big.Big.Int_>):Bool
		return publicKey.isOnCurve(_0, _1);

	public function params():Pointer<stdgo.crypto.elliptic.Elliptic.CurveParams>
		return publicKey.params();

	public function scalarBaseMult(_k:Slice<GoUInt8>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;}
		return publicKey.scalarBaseMult(_0);

	public function scalarMult(_x1:Pointer<stdgo.math.big.Big.Int_>, _y1:Pointer<stdgo.math.big.Big.Int_>,
			_k:Slice<GoUInt8>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;}
		return publicKey.scalarMult(_0, _1, _2);
...
function _randFieldElement(_c:stdgo.crypto.elliptic.Elliptic.Curve, _rand:stdgo.io.Io.Reader):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Error;} {
	var _k:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil(),
	...
	var _b:Slice<GoUInt8> = new Slice<GoUInt8>(...[
		for (i in 0...((_params.value.bitSize / ((8 : GoInt)) + ((8 : GoInt)):GoInt)).toBasic()) ((0 : GoUInt8))
	]);
	{
...
function generateKey(_c:stdgo.crypto.elliptic.Elliptic.Curve, _rand:stdgo.io.Io.Reader):{var _0:Pointer<PrivateKey>; var _1:Error;} {
	var __tmp__ = _randFieldElement(_c, _rand),
		_k:Pointer<stdgo.math.big.Big.Int_> = __tmp__._0,
...
**/
function sign(_rand:stdgo.io.Io.Reader, _priv:Pointer<PrivateKey>,
		_hash:Slice<GoByte>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>; var _2:Error;} {
	var _r:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil(),
		_s:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil(),
		_err:Error = ((null : stdgo.Error));
	...
	var _csprng:stdgo.crypto.cipher.Cipher.StreamReader = (({r: _zeroReader.value, s: stdgo.crypto.cipher.Cipher.newCTR(_block,
		((_aesIV : Slice<GoByte>)))} : stdgo.crypto.cipher.Cipher.StreamReader)).__copy__();
	var _c:stdgo.crypto.elliptic.Elliptic.Curve = _priv.value.publicKey.curve;
	return _sign(_priv, Go.pointer(_csprng), _c, _hash);
}

function _signGeneric(_priv:Pointer<PrivateKey>, _csprng:Pointer<stdgo.crypto.cipher.Cipher.StreamReader>, _c:stdgo.crypto.elliptic.Elliptic.Curve,
		_hash:Slice<GoByte>):{
	var _0:Pointer<stdgo.math.big.Big.Int_>;
	var _1:Pointer<stdgo.math.big.Big.Int_>;
	var _2:Error;
	...
	var _k:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil(),
		_kInv:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil();
	while (true) {
		while (true) {
			{
...
function _verifyGeneric(_pub:Pointer<PublicKey>, _c:stdgo.crypto.elliptic.Elliptic.Curve, _hash:Slice<GoByte>, _r:Pointer<stdgo.math.big.Big.Int_>,
		_s:Pointer<stdgo.math.big.Big.Int_>):Bool {
	var _e:Pointer<stdgo.math.big.Big.Int_> = _hashToInt(_hash, _c);
		...
		_y:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil();
	{
		...
		if (_ok) {
			...
			var __tmp__ = _c.scalarBaseMult(_u1.value.bytes()),
				_x1:Pointer<stdgo.math.big.Big.Int_> = __tmp__._0,
				_y1:Pointer<stdgo.math.big.Big.Int_> = __tmp__._1;
			var __tmp__ = _c.scalarMult(_pub.value.x, _pub.value.y, _u2.value.bytes()),
				_x2:Pointer<stdgo.math.big.Big.Int_> = __tmp__._0,
				_y2:Pointer<stdgo.math.big.Big.Int_> = __tmp__._1;
			{
...
function verifyASN1(_pub:Pointer<PublicKey>, _hash:Slice<GoByte>, _sig:Slice<GoByte>):Bool {
	var _r:Pointer<stdgo.math.big.Big.Int_> = Go.pointer(new stdgo.math.big.Big.Int_()),
		_s:Pointer<stdgo.math.big.Big.Int_> = Go.pointer(new stdgo.math.big.Big.Int_()),
		_inner:golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_();
	...
	if (!_input.readASN1(Go.pointer(_inner), golang_org.x.crypto.cryptobyte.asn1.Asn1.sequence)
		|| !_input.empty()
		|| !_inner.readASN1Integer(Go.toInterface(_r))
		|| !_inner.readASN1Integer(Go.toInterface(_s))
		|| !_inner.empty()) {
		return false;
	};
...
function _sign(_priv:Pointer<PrivateKey>, _csprng:Pointer<stdgo.crypto.cipher.Cipher.StreamReader>, _c:stdgo.crypto.elliptic.Elliptic.Curve,
		_hash:Slice<GoByte>):{
	var _0:Pointer<stdgo.math.big.Big.Int_>;
	var _1:Pointer<stdgo.math.big.Big.Int_>;
	var _2:Error;
...
function _verify(_pub:Pointer<PublicKey>, _c:stdgo.crypto.elliptic.Elliptic.Curve, _hash:Slice<GoByte>, _r:Pointer<stdgo.math.big.Big.Int_>,
		_s:Pointer<stdgo.math.big.Big.Int_>):Bool {
