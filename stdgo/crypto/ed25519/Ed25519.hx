...
@:named class PublicKey {
	...
	public function __copy__()
		return new PublicKey(__t__);

	public function __append__(args:haxe.Rest<GoUInt8>)
		return new PublicKey(this.__t__.__append__(...args));

	public function __slice__(low:GoInt, high:GoInt = -1)
		return new PublicKey(this.__t__.__slice__(low, high));
}
...
@:named class PrivateKey {
	...
	public function __copy__()
		return new PrivateKey(__t__);

	public function __append__(args:haxe.Rest<GoUInt8>)
		return new PrivateKey(this.__t__.__append__(...args));

	public function __slice__(low:GoInt, high:GoInt = -1)
		return new PrivateKey(this.__t__.__slice__(low, high));
}
...
function generateKey(_rand:stdgo.io.Io.Reader):{var _0:PublicKey; var _1:PrivateKey; var _2:Error;} {
	...
	var _seed:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0...((seedSize : GoInt)).toBasic()) ((0 : GoUInt8))]);
	{
		var __tmp__ = stdgo.io.Io.readFull(_rand, _seed),
			_:GoInt = __tmp__._0,
...
function _newKeyFromSeed(_privateKey:Slice<GoByte>, _seed:Slice<GoByte>):Void {
	...
	var _s:Pointer<crypto.ed25519.internal.edwards25519.Edwards25519.Scalar> = crypto.ed25519.internal.edwards25519.Edwards25519.newScalar()
		.value.setBytesWithClamping(_h.__slice__(0, ((32 : GoInt))));
	var a:Pointer<crypto.ed25519.internal.edwards25519.Edwards25519.Point> = (Go.pointer(new crypto.ed25519.internal.edwards25519.Edwards25519.Point()))
		.value.scalarBaseMult(_s);
...
function _sign(_signature:Slice<GoByte>, _privateKey:Slice<GoByte>, _message:Slice<GoByte>):Void {
	...
	var _seed:Slice<GoUInt8> = _privateKey.__slice__(0, seedSize),
		_publicKey:Slice<GoUInt8> = _privateKey.__slice__(seedSize);
	var _h:GoArray<GoUInt8> = stdgo.crypto.sha512.Sha512.sum512(_seed).copy();
	var _s:Pointer<crypto.ed25519.internal.edwards25519.Edwards25519.Scalar> = crypto.ed25519.internal.edwards25519.Edwards25519.newScalar()
		.value.setBytesWithClamping(_h.__slice__(0, ((32 : GoInt))));
	...
	_mh.write(_prefix);
	_mh.write(_message);
	var _messageDigest:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))])
		.setCap(((stdgo.crypto.sha512.Sha512.size : GoInt)).toBasic());
	_messageDigest = _mh.sum(_messageDigest);
	var _r:Pointer<crypto.ed25519.internal.edwards25519.Edwards25519.Scalar> = crypto.ed25519.internal.edwards25519.Edwards25519.newScalar()
		.value.setUniformBytes(_messageDigest);
	var r:Pointer<crypto.ed25519.internal.edwards25519.Edwards25519.Point> = (Go.pointer(new crypto.ed25519.internal.edwards25519.Edwards25519.Point()))
		.value.scalarBaseMult(_r);
	var _kh:stdgo.hash.Hash.Hash = stdgo.crypto.sha512.Sha512.new_();
	_kh.write(r.value.bytes());
	_kh.write(_publicKey);
	_kh.write(_message);
	var _hramDigest:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))])
		.setCap(((stdgo.crypto.sha512.Sha512.size : GoInt)).toBasic());
	_hramDigest = _kh.sum(_hramDigest);
	var _k:Pointer<crypto.ed25519.internal.edwards25519.Edwards25519.Scalar> = crypto.ed25519.internal.edwards25519.Edwards25519.newScalar()
		.value.setUniformBytes(_hramDigest);
	var s:Pointer<crypto.ed25519.internal.edwards25519.Edwards25519.Scalar> = crypto.ed25519.internal.edwards25519.Edwards25519.newScalar()
		.value.multiplyAdd(_k, _s, _r);
...
function verify(_publicKey:PublicKey, _message:Slice<GoByte>, _sig:Slice<GoByte>):Bool {
	...
	var __tmp__ = (Go.pointer(new crypto.ed25519.internal.edwards25519.Edwards25519.Point())).value.setBytes(_publicKey.__copy__().__t__),
		a:Pointer<crypto.ed25519.internal.edwards25519.Edwards25519.Point> = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
		return false;
	};
	...
	var _k:Pointer<crypto.ed25519.internal.edwards25519.Edwards25519.Scalar> = crypto.ed25519.internal.edwards25519.Edwards25519.newScalar()
		.value.setUniformBytes(_hramDigest);
	var __tmp__ = crypto.ed25519.internal.edwards25519.Edwards25519.newScalar().value.setCanonicalBytes(_sig.__slice__(((32 : GoInt)))),
		s:Pointer<crypto.ed25519.internal.edwards25519.Edwards25519.Scalar> = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
		return false;
	};
	var _minusA:Pointer<crypto.ed25519.internal.edwards25519.Edwards25519.Point> = (Go.pointer(new crypto.ed25519.internal.edwards25519.Edwards25519.Point()))
		.value.negate(a);
	var r:Pointer<crypto.ed25519.internal.edwards25519.Edwards25519.Point> = (Go.pointer(new crypto.ed25519.internal.edwards25519.Edwards25519.Point()))
		.value.varTimeDoubleScalarBaseMult(_k, _minusA, s);
...
class PrivateKey_extension_fields {
	...
	public function seed(__tmp__):Slice<GoByte>
		return __tmp__.seed();

	public function sign(__tmp__, _rand:stdgo.io.Io.Reader, _message:Slice<GoByte>, _opts:stdgo.crypto.Crypto.SignerOpts):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__.sign(_rand, _message, _opts);
}
