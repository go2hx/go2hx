...
@:structInit class T_projP1xP1 {
	public function double(_p:Pointer<T_projP2>):Pointer<T_projP1xP1> {
		...
		var xx:crypto.ed25519.internal.edwards25519.field.Field.Element = new crypto.ed25519.internal.edwards25519.field.Field.Element(),
			yy:crypto.ed25519.internal.edwards25519.field.Field.Element = new crypto.ed25519.internal.edwards25519.field.Field.Element(),
			zz2:crypto.ed25519.internal.edwards25519.field.Field.Element = new crypto.ed25519.internal.edwards25519.field.Field.Element(),
			xplusYsq:crypto.ed25519.internal.edwards25519.field.Field.Element = new crypto.ed25519.internal.edwards25519.field.Field.Element();
	...
	public function subAffine(_p:Pointer<Point>, _q:Pointer<T_affineCached>):Pointer<T_projP1xP1> {
		var _v = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var yplusX:crypto.ed25519.internal.edwards25519.field.Field.Element = new crypto.ed25519.internal.edwards25519.field.Field.Element(),
			yminusX:crypto.ed25519.internal.edwards25519.field.Field.Element = new crypto.ed25519.internal.edwards25519.field.Field.Element(),
			pp:crypto.ed25519.internal.edwards25519.field.Field.Element = new crypto.ed25519.internal.edwards25519.field.Field.Element(),
			mm:crypto.ed25519.internal.edwards25519.field.Field.Element = new crypto.ed25519.internal.edwards25519.field.Field.Element(),
			tt2d:crypto.ed25519.internal.edwards25519.field.Field.Element = new crypto.ed25519.internal.edwards25519.field.Field.Element(),
			z2:crypto.ed25519.internal.edwards25519.field.Field.Element = new crypto.ed25519.internal.edwards25519.field.Field.Element();
	...
	public function new(?x:crypto.ed25519.internal.edwards25519.field.Field.Element, ?y:crypto.ed25519.internal.edwards25519.field.Field.Element,
			?z:crypto.ed25519.internal.edwards25519.field.Field.Element, ?t:crypto.ed25519.internal.edwards25519.field.Field.Element)
...
@:structInit class T_projP2 {
	...
	public function new(?x:crypto.ed25519.internal.edwards25519.field.Field.Element, ?y:crypto.ed25519.internal.edwards25519.field.Field.Element,
			?z:crypto.ed25519.internal.edwards25519.field.Field.Element)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Point {
	...
	public function equal(_u:Pointer<Point>):GoInt {
		...
		var _t1:crypto.ed25519.internal.edwards25519.field.Field.Element = new crypto.ed25519.internal.edwards25519.field.Field.Element(),
			_t2:crypto.ed25519.internal.edwards25519.field.Field.Element = new crypto.ed25519.internal.edwards25519.field.Field.Element(),
			_t3:crypto.ed25519.internal.edwards25519.field.Field.Element = new crypto.ed25519.internal.edwards25519.field.Field.Element(),
			_t4:crypto.ed25519.internal.edwards25519.field.Field.Element = new crypto.ed25519.internal.edwards25519.field.Field.Element();
	...
	public function setBytes(_x:Slice<GoByte>):{var _0:Pointer<Point>; var _1:Error;} {
		...
		var _y:Pointer<crypto.ed25519.internal.edwards25519.field.Field.Element> = Go.pointer(new crypto.ed25519.internal.edwards25519.field.Field.Element())
			.value.setBytes(_x);
		var _y2:Pointer<crypto.ed25519.internal.edwards25519.field.Field.Element> = Go.pointer(new crypto.ed25519.internal.edwards25519.field.Field.Element())
			.value.square(_y);
		var _u:Pointer<crypto.ed25519.internal.edwards25519.field.Field.Element> = Go.pointer(new crypto.ed25519.internal.edwards25519.field.Field.Element())
			.value.subtract(_y2, _feOne);
		var _vv:Pointer<crypto.ed25519.internal.edwards25519.field.Field.Element> = Go.pointer(new crypto.ed25519.internal.edwards25519.field.Field.Element())
			.value.multiply(_y2, _d);
		_vv = _vv.value.add(_vv, _feOne);
		var __tmp__ = Go.pointer(new crypto.ed25519.internal.edwards25519.field.Field.Element()).value.sqrtRatio(_u, _vv),
			_xx:Pointer<crypto.ed25519.internal.edwards25519.field.Field.Element> = __tmp__._0,
			_wasSquare:GoInt = __tmp__._1;
		if (_wasSquare == ((0 : GoInt))) {
			return {_0: new Pointer<Point>().nil(), _1: stdgo.errors.Errors.new_("edwards25519: invalid point encoding")};
		};
		var _xxNeg:Pointer<crypto.ed25519.internal.edwards25519.field.Field.Element> = Go.pointer(new crypto.ed25519.internal.edwards25519.field.Field.Element())
			.value.negate(_xx);
	...
	public function _bytes(_buf:Pointer<GoArray<GoByte>>):Slice<GoByte> {
		...
		var _zInv:crypto.ed25519.internal.edwards25519.field.Field.Element = new crypto.ed25519.internal.edwards25519.field.Field.Element(),
			_x:crypto.ed25519.internal.edwards25519.field.Field.Element = new crypto.ed25519.internal.edwards25519.field.Field.Element(),
			_y:crypto.ed25519.internal.edwards25519.field.Field.Element = new crypto.ed25519.internal.edwards25519.field.Field.Element();
	...
	public function new(?_x:crypto.ed25519.internal.edwards25519.field.Field.Element, ?_y:crypto.ed25519.internal.edwards25519.field.Field.Element,
			?_z:crypto.ed25519.internal.edwards25519.field.Field.Element, ?_t:crypto.ed25519.internal.edwards25519.field.Field.Element,
			?___blank__0:T_incomparable)
		stdgo.internal.Macro.initLocals();
...
@:named class T_incomparable {
	...
	public function __copy__()
		return new T_incomparable(__t__.copy());
...
@:structInit class T_projCached {
	public function condNeg(_cond:GoInt):Pointer<T_projCached> {
		...
		_v.value.t2d.select(Go.pointer(new crypto.ed25519.internal.edwards25519.field.Field.Element()).value.negate(Go.pointer(_v.value.t2d)),
			Go.pointer(_v.value.t2d), _cond);
		return _v;
	}
	...
	public function new(?yplusX:crypto.ed25519.internal.edwards25519.field.Field.Element, ?yminusX:crypto.ed25519.internal.edwards25519.field.Field.Element,
			?z:crypto.ed25519.internal.edwards25519.field.Field.Element, ?t2d:crypto.ed25519.internal.edwards25519.field.Field.Element)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_affineCached {
	...
	public function new(?yplusX:crypto.ed25519.internal.edwards25519.field.Field.Element, ?yminusX:crypto.ed25519.internal.edwards25519.field.Field.Element,
			?t2d:crypto.ed25519.internal.edwards25519.field.Field.Element)
		stdgo.internal.Macro.initLocals();
...
@:structInit @:local class T__struct_0 {
	...
	public function new(?_table:GoArray<T_affineLookupTable>, ?_initOnce:stdgo.sync.Sync.Once)
		stdgo.internal.Macro.initLocals();
...
@:structInit @:local class T__struct_1 {
	...
	public function new(?_table:T_nafLookupTable8, ?_initOnce:stdgo.sync.Sync.Once)
		stdgo.internal.Macro.initLocals();
...
var _scOne:Scalar = new Scalar(new GoArray<GoUInt8>(((1 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)),
	((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)),
	((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)),
	((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8))).copy()).__copy__();

var __tmp__0 = Go.pointer(new Point())
	.value.setBytes(new Slice<GoUInt8>(((1 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)),
...
var _feOne:Pointer<crypto.ed25519.internal.edwards25519.field.Field.Element> = Go.pointer(new crypto.ed25519.internal.edwards25519.field.Field.Element())
	.value.one();

var _0 = __tmp__0._1;
var _basepointNafTablePrecomp:T__struct_1 = new T__struct_1();

var __tmp__1 = Go.pointer(new Point())
	.value.setBytes(new Slice<GoUInt8>(((88 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)),
		((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)),
		((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)),
		((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)),
		((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8)), ((102 : GoUInt8))));

var _1 = __tmp__1._1;

var _d:Pointer<crypto.ed25519.internal.edwards25519.field.Field.Element> = Go.pointer(new crypto.ed25519.internal.edwards25519.field.Field.Element())
	.value.setBytes(new Slice<GoUInt8>(((163 : GoUInt8)), ((120 : GoUInt8)), ((89 : GoUInt8)), ((19 : GoUInt8)), ((202 : GoUInt8)), ((77 : GoUInt8)),
		((235 : GoUInt8)), ((117 : GoUInt8)), ((171 : GoUInt8)), ((216 : GoUInt8)), ((65 : GoUInt8)), ((65 : GoUInt8)), ((77 : GoUInt8)), ((10 : GoUInt8)),
		((112 : GoUInt8)), ((0 : GoUInt8)), ((152 : GoUInt8)), ((232 : GoUInt8)), ((121 : GoUInt8)), ((119 : GoUInt8)), ((121 : GoUInt8)), ((64 : GoUInt8)),
		((199 : GoUInt8)), ((140 : GoUInt8)), ((115 : GoUInt8)), ((254 : GoUInt8)), ((111 : GoUInt8)), ((43 : GoUInt8)), ((238 : GoUInt8)), ((108 : GoUInt8)),
		((3 : GoUInt8)), ((82 : GoUInt8))));

var _d2:Pointer<crypto.ed25519.internal.edwards25519.field.Field.Element> = Go.pointer(new crypto.ed25519.internal.edwards25519.field.Field.Element())
	.value.add(_d, _d);

var _scMinusOne:Scalar = new Scalar(new GoArray<GoUInt8>(((236 : GoUInt8)), ((211 : GoUInt8)), ((245 : GoUInt8)), ((92 : GoUInt8)), ((26 : GoUInt8)),
	((99 : GoUInt8)), ((18 : GoUInt8)), ((88 : GoUInt8)), ((214 : GoUInt8)), ((156 : GoUInt8)), ((247 : GoUInt8)), ((162 : GoUInt8)), ((222 : GoUInt8)),
	((249 : GoUInt8)), ((222 : GoUInt8)), ((20 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)),
	((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)),
	((0 : GoUInt8)), ((16 : GoUInt8))).copy()).__copy__();

var _basepointTablePrecomp:T__struct_0 = new T__struct_0();

var _scZero:Scalar = new Scalar(new GoArray<GoUInt8>(((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)),
	((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)),
	((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)),
	((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8))).copy()).__copy__();
...
function _checkInitialized(_points:haxe.Rest<Pointer<Point>>):Void {
	...
	for (_ => _p in _points) {
		if (Go.toInterface(_p.value._x) == Go.toInterface((new crypto.ed25519.internal.edwards25519.field.Field.Element()))
			&& Go.toInterface(_p.value._y) == Go.toInterface((new crypto.ed25519.internal.edwards25519.field.Field.Element()))) {
...
function _scMulAdd(_s:Pointer<GoArray<GoByte>>, _a:Pointer<GoArray<GoByte>>, _b:Pointer<GoArray<GoByte>>, _c:Pointer<GoArray<GoByte>>):Void {
	...
	var _s9:GoInt64 = _c9
		...
		+ _a8 * _b1
		+ _a9 * _b0;
	var _s10:GoInt64 = _c10 + _a0 * _b10 + _a1 * _b9 + _a2 * _b8 + _a3 * _b7 + _a4 * _b6 + _a5 * _b5 + _a6 * _b4 + _a7 * _b3 + _a8 * _b2 + _a9 * _b1
		+ _a10 * _b0;
	var _s11:GoInt64 = _c11 + _a0 * _b11 + _a1 * _b10 + _a2 * _b9 + _a3 * _b8 + _a4 * _b7 + _a5 * _b6 + _a6 * _b5 + _a7 * _b4 + _a8 * _b3 + _a9 * _b2
		+ _a10 * _b1 + _a11 * _b0;
	var _s12:GoInt64 = _a1 * _b11
		+ _a2 * _b10
		+ _a3 * _b9
		+ _a4 * _b8
		+ _a5 * _b7
...
class T_projP1xP1_extension_fields {
	public function add(__tmp__, _p:Pointer<Point>, _q:Pointer<T_projCached>):Pointer<T_projP1xP1>
		return __tmp__.add(_p, _q);

	public function sub(__tmp__, _p:Pointer<Point>, _q:Pointer<T_projCached>):Pointer<T_projP1xP1>
		return __tmp__.sub(_p, _q);

	public function addAffine(__tmp__, _p:Pointer<Point>, _q:Pointer<T_affineCached>):Pointer<T_projP1xP1>
		return __tmp__.addAffine(_p, _q);

	public function subAffine(__tmp__, _p:Pointer<Point>, _q:Pointer<T_affineCached>):Pointer<T_projP1xP1>
		return __tmp__.subAffine(_p, _q);

	public function double(__tmp__, _p:Pointer<T_projP2>):Pointer<T_projP1xP1>
		return __tmp__.double(_p);
}

class T_projP2_extension_fields {
	public function zero(__tmp__):Pointer<T_projP2>
		return __tmp__.zero();

	public function fromP1xP1(__tmp__, _p:Pointer<T_projP1xP1>):Pointer<T_projP2>
		return __tmp__.fromP1xP1(_p);

	public function fromP3(__tmp__, _p:Pointer<Point>):Pointer<T_projP2>
		return __tmp__.fromP3(_p);
}

class Point_extension_fields {
	public function set(__tmp__, _u:Pointer<Point>):Pointer<Point>
		return __tmp__.set(_u);

	public function bytes(__tmp__):Slice<GoByte>
		return __tmp__.bytes();

	public function _bytes(__tmp__, _buf:Pointer<GoArray<GoByte>>):Slice<GoByte>
		return __tmp__._bytes(_buf);

	public function setBytes(__tmp__, _x:Slice<GoByte>):{var _0:Pointer<Point>; var _1:Error;}
		return __tmp__.setBytes(_x);

	public function _fromP1xP1(__tmp__, _p:Pointer<T_projP1xP1>):Pointer<Point>
		return __tmp__._fromP1xP1(_p);

	public function _fromP2(__tmp__, _p:Pointer<T_projP2>):Pointer<Point>
		return __tmp__._fromP2(_p);

	public function add(__tmp__, _p:Pointer<Point>, _q:Pointer<Point>):Pointer<Point>
		return __tmp__.add(_p, _q);

	public function subtract(__tmp__, _p:Pointer<Point>, _q:Pointer<Point>):Pointer<Point>
		return __tmp__.subtract(_p, _q);

	public function negate(__tmp__, _p:Pointer<Point>):Pointer<Point>
		return __tmp__.negate(_p);

	public function equal(__tmp__, _u:Pointer<Point>):GoInt
		return __tmp__.equal(_u);

	public function scalarBaseMult(__tmp__, _x:Pointer<Scalar>):Pointer<Point>
		return __tmp__.scalarBaseMult(_x);

	public function scalarMult(__tmp__, _x:Pointer<Scalar>, _q:Pointer<Point>):Pointer<Point>
		return __tmp__.scalarMult(_x, _q);

	public function varTimeDoubleScalarBaseMult(__tmp__, _a:Pointer<Scalar>, a:Pointer<Point>, _b:Pointer<Scalar>):Pointer<Point>
		return __tmp__.varTimeDoubleScalarBaseMult(_a, a, _b);
}

class T_projCached_extension_fields {
	public function zero(__tmp__):Pointer<T_projCached>
		return __tmp__.zero();

	public function fromP3(__tmp__, _p:Pointer<Point>):Pointer<T_projCached>
		return __tmp__.fromP3(_p);

	public function select(__tmp__, _a:Pointer<T_projCached>, _b:Pointer<T_projCached>, _cond:GoInt):Pointer<T_projCached>
		return __tmp__.select(_a, _b, _cond);

	public function condNeg(__tmp__, _cond:GoInt):Pointer<T_projCached>
		return __tmp__.condNeg(_cond);
}

class T_affineCached_extension_fields {
	public function zero(__tmp__):Pointer<T_affineCached>
		return __tmp__.zero();

	public function fromP3(__tmp__, _p:Pointer<Point>):Pointer<T_affineCached>
		return __tmp__.fromP3(_p);

	public function select(__tmp__, _a:Pointer<T_affineCached>, _b:Pointer<T_affineCached>, _cond:GoInt):Pointer<T_affineCached>
		return __tmp__.select(_a, _b, _cond);

	public function condNeg(__tmp__, _cond:GoInt):Pointer<T_affineCached>
		return __tmp__.condNeg(_cond);
}

class Scalar_extension_fields {
	public function multiplyAdd(__tmp__, _x:Pointer<Scalar>, _y:Pointer<Scalar>, _z:Pointer<Scalar>):Pointer<Scalar>
		return __tmp__.multiplyAdd(_x, _y, _z);

	public function add(__tmp__, _x:Pointer<Scalar>, _y:Pointer<Scalar>):Pointer<Scalar>
		return __tmp__.add(_x, _y);

	public function subtract(__tmp__, _x:Pointer<Scalar>, _y:Pointer<Scalar>):Pointer<Scalar>
		return __tmp__.subtract(_x, _y);

	public function negate(__tmp__, _x:Pointer<Scalar>):Pointer<Scalar>
		return __tmp__.negate(_x);

	public function multiply(__tmp__, _x:Pointer<Scalar>, _y:Pointer<Scalar>):Pointer<Scalar>
		return __tmp__.multiply(_x, _y);

	public function set(__tmp__, _x:Pointer<Scalar>):Pointer<Scalar>
		return __tmp__.set(_x);

	public function setUniformBytes(__tmp__, _x:Slice<GoByte>):Pointer<Scalar>
		return __tmp__.setUniformBytes(_x);

	public function setCanonicalBytes(__tmp__, _x:Slice<GoByte>):{var _0:Pointer<Scalar>; var _1:Error;}
		return __tmp__.setCanonicalBytes(_x);

	public function setBytesWithClamping(__tmp__, _x:Slice<GoByte>):Pointer<Scalar>
		return __tmp__.setBytesWithClamping(_x);

	public function bytes(__tmp__):Slice<GoByte>
		return __tmp__.bytes();

	public function equal(__tmp__, _t:Pointer<Scalar>):GoInt
		return __tmp__.equal(_t);

	public function _nonAdjacentForm(__tmp__, _w:GoUInt):GoArray<GoInt8>
		return __tmp__._nonAdjacentForm(_w);

	public function _signedRadix16(__tmp__):GoArray<GoInt8>
		return __tmp__._signedRadix16();
}

class T_projLookupTable_extension_fields {
	public function fromP3(__tmp__, _q:Pointer<Point>):Void
		__tmp__.fromP3(_q);

	public function selectInto(__tmp__, _dest:Pointer<T_projCached>, _x:GoInt8):Void
		__tmp__.selectInto(_dest, _x);
}
...
class T_affineLookupTable_extension_fields {
	...
	public function selectInto(__tmp__, _dest:Pointer<T_affineCached>, _x:GoInt8):Void
		__tmp__.selectInto(_dest, _x);
}
