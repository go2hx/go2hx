...
@:structInit class Element {
    ...
    public function sqrtRatio(_u:Pointer<Element>, _v:Pointer<Element>):{ var _0 : Pointer<Element>; var _1 : GoInt; } {
        ...
        var _rr:Pointer<Element> = new Pointer<Element>().nil(), _wasSquare:GoInt = ((0 : GoInt));
    ...
    public function mult32(_x:Pointer<Element>, _y:GoUInt32):Pointer<Element> {
        var _v = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _mul51(_x.value._l0, _y), _x0lo:GoUInt64 = __tmp__._0, _x0hi:GoUInt64 = __tmp__._1;
        var __tmp__ = _mul51(_x.value._l1, _y), _x1lo:GoUInt64 = __tmp__._0, _x1hi:GoUInt64 = __tmp__._1;
        var __tmp__ = _mul51(_x.value._l2, _y), _x2lo:GoUInt64 = __tmp__._0, _x2hi:GoUInt64 = __tmp__._1;
        var __tmp__ = _mul51(_x.value._l3, _y), _x3lo:GoUInt64 = __tmp__._0, _x3hi:GoUInt64 = __tmp__._1;
        var __tmp__ = _mul51(_x.value._l4, _y), _x4lo:GoUInt64 = __tmp__._0, _x4hi:GoUInt64 = __tmp__._1;
    ...
    public function equal(_u:Pointer<Element>):GoInt {
        var _v = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _sa:Slice<GoUInt8> = _u.value.bytes(), _sv:Slice<GoUInt8> = _v.value.bytes();
    ...
    public function new(?_l0:GoUInt64, ?_l1:GoUInt64, ?_l2:GoUInt64, ?_l3:GoUInt64, ?_l4:GoUInt64) stdgo.internal.Macro.initLocals();
...
var _sqrtM1 : Pointer<Element> = Go.pointer(new Element((("1718705420411056" : GoUInt64)), (("234908883556509" : GoUInt64)), (("2233514472574048" : GoUInt64)), (("2117202627021982" : GoUInt64)), (("765476049583133" : GoUInt64))));
/**
...
class Element_extension_fields {
    public function zero(__tmp__):Pointer<Element> return __tmp__.zero();
    public function one(__tmp__):Pointer<Element> return __tmp__.one();
    public function _reduce(__tmp__):Pointer<Element> return __tmp__._reduce();
    public function add(__tmp__, _a:Pointer<Element>, _b:Pointer<Element>):Pointer<Element> return __tmp__.add(_a, _b);
    public function subtract(__tmp__, _a:Pointer<Element>, _b:Pointer<Element>):Pointer<Element> return __tmp__.subtract(_a, _b);
    public function negate(__tmp__, _a:Pointer<Element>):Pointer<Element> return __tmp__.negate(_a);
    public function invert(__tmp__, _z:Pointer<Element>):Pointer<Element> return __tmp__.invert(_z);
    public function set(__tmp__, _a:Pointer<Element>):Pointer<Element> return __tmp__.set(_a);
    public function setBytes(__tmp__, _x:Slice<GoByte>):Pointer<Element> return __tmp__.setBytes(_x);
    public function bytes(__tmp__):Slice<GoByte> return __tmp__.bytes();
    public function _bytes(__tmp__, _out:Pointer<GoArray<GoByte>>):Slice<GoByte> return __tmp__._bytes(_out);
    public function equal(__tmp__, _u:Pointer<Element>):GoInt return __tmp__.equal(_u);
    public function select(__tmp__, _a:Pointer<Element>, _b:Pointer<Element>, _cond:GoInt):Pointer<Element> return __tmp__.select(_a, _b, _cond);
    public function swap(__tmp__, _u:Pointer<Element>, _cond:GoInt):Void __tmp__.swap(_u, _cond);
    public function isNegative(__tmp__):GoInt return __tmp__.isNegative();
    public function absolute(__tmp__, _u:Pointer<Element>):Pointer<Element> return __tmp__.absolute(_u);
    public function multiply(__tmp__, _x:Pointer<Element>, _y:Pointer<Element>):Pointer<Element> return __tmp__.multiply(_x, _y);
    public function square(__tmp__, _x:Pointer<Element>):Pointer<Element> return __tmp__.square(_x);
    public function mult32(__tmp__, _x:Pointer<Element>, _y:GoUInt32):Pointer<Element> return __tmp__.mult32(_x, _y);
    public function pow22523(__tmp__, _x:Pointer<Element>):Pointer<Element> return __tmp__.pow22523(_x);
    public function sqrtRatio(__tmp__, _u:Pointer<Element>, _v:Pointer<Element>):{ var _0 : Pointer<Element>; var _1 : GoInt; } return __tmp__.sqrtRatio(_u, _v);
    public function _carryPropagate(__tmp__):Pointer<Element> return __tmp__._carryPropagate();
    public function _carryPropagateGeneric(__tmp__):Pointer<Element> return __tmp__._carryPropagateGeneric();
}
