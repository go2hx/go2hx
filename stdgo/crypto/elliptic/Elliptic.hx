...
@:structInit @:using(stdgo.crypto.elliptic.Elliptic.T_nistCurve_static_extension) abstract T_nistCurve(stdgo._internal.crypto.elliptic.Elliptic_T_nistCurve.T_nistCurve) from stdgo._internal.crypto.elliptic.Elliptic_T_nistCurve.T_nistCurve to stdgo._internal.crypto.elliptic.Elliptic_T_nistCurve.T_nistCurve {
    ...
    public function new(?_newPoint:() -> Dynamic, ?_params:CurveParams) this = new stdgo._internal.crypto.elliptic.Elliptic_T_nistCurve.T_nistCurve(_newPoint, _params);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.crypto.elliptic.Elliptic.CurveParams_static_extension) abstract CurveParams(stdgo._internal.crypto.elliptic.Elliptic_CurveParams.CurveParams) from stdgo._internal.crypto.elliptic.Elliptic_CurveParams.CurveParams to stdgo._internal.crypto.elliptic.Elliptic_CurveParams.CurveParams {
    ...
    public function new(?p:stdgo._internal.math.big.Big_Int_.Int_, ?n:stdgo._internal.math.big.Big_Int_.Int_, ?b:stdgo._internal.math.big.Big_Int_.Int_, ?gx:stdgo._internal.math.big.Big_Int_.Int_, ?gy:stdgo._internal.math.big.Big_Int_.Int_, ?bitSize:StdTypes.Int, ?name:String) this = new stdgo._internal.crypto.elliptic.Elliptic_CurveParams.CurveParams(p, n, b, gx, gy, bitSize, name);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
class T_nistCurve_static_extension {
    ...
    static public function unmarshal<Dynamic>(_curve:T_nistCurve<Dynamic>, _data:Array<std.UInt>):stdgo.Tuple<stdgo._internal.math.big.Big_Int_.Int_, stdgo._internal.math.big.Big_Int_.Int_> {
        final _data = ([for (i in _data) i] : stdgo.Slice<stdgo.GoUInt8>);
        return {
    ...
    static public function combinedMult<Dynamic>(_curve:T_nistCurve<Dynamic>, px:stdgo._internal.math.big.Big_Int_.Int_, py:stdgo._internal.math.big.Big_Int_.Int_, _s1:Array<std.UInt>, _s2:Array<std.UInt>):stdgo.Tuple<stdgo._internal.math.big.Big_Int_.Int_, stdgo._internal.math.big.Big_Int_.Int_> {
        final _s1 = ([for (i in _s1) i] : stdgo.Slice<stdgo.GoUInt8>);
        final _s2 = ([for (i in _s2) i] : stdgo.Slice<stdgo.GoUInt8>);
        return {
    ...
    static public function scalarBaseMult<Dynamic>(_curve:T_nistCurve<Dynamic>, _scalar:Array<std.UInt>):stdgo.Tuple<stdgo._internal.math.big.Big_Int_.Int_, stdgo._internal.math.big.Big_Int_.Int_> {
        final _scalar = ([for (i in _scalar) i] : stdgo.Slice<stdgo.GoUInt8>);
        return {
    ...
    static public function scalarMult<Dynamic>(_curve:T_nistCurve<Dynamic>, bx:stdgo._internal.math.big.Big_Int_.Int_, by:stdgo._internal.math.big.Big_Int_.Int_, _scalar:Array<std.UInt>):stdgo.Tuple<stdgo._internal.math.big.Big_Int_.Int_, stdgo._internal.math.big.Big_Int_.Int_> {
        final _scalar = ([for (i in _scalar) i] : stdgo.Slice<stdgo.GoUInt8>);
        return {
    ...
    static public function _normalizeScalar<Dynamic>(_curve:T_nistCurve<Dynamic>, _scalar:Array<std.UInt>):Array<std.UInt> {
        final _scalar = ([for (i in _scalar) i] : stdgo.Slice<stdgo.GoUInt8>);
    ...
    static public function double<Dynamic>(_curve:T_nistCurve<Dynamic>, _x1:stdgo._internal.math.big.Big_Int_.Int_, _y1:stdgo._internal.math.big.Big_Int_.Int_):stdgo.Tuple<stdgo._internal.math.big.Big_Int_.Int_, stdgo._internal.math.big.Big_Int_.Int_> {
        return {
    ...
    static public function add<Dynamic>(_curve:T_nistCurve<Dynamic>, _x1:stdgo._internal.math.big.Big_Int_.Int_, _y1:stdgo._internal.math.big.Big_Int_.Int_, _x2:stdgo._internal.math.big.Big_Int_.Int_, _y2:stdgo._internal.math.big.Big_Int_.Int_):stdgo.Tuple<stdgo._internal.math.big.Big_Int_.Int_, stdgo._internal.math.big.Big_Int_.Int_> {
        return {
    ...
    static public function _pointToAffine<Dynamic>(_curve:T_nistCurve<Dynamic>, _p:Dynamic):stdgo.Tuple<stdgo._internal.math.big.Big_Int_.Int_, stdgo._internal.math.big.Big_Int_.Int_> {
        return {
    ...
    static public function isOnCurve<Dynamic>(_curve:T_nistCurve<Dynamic>, _x:stdgo._internal.math.big.Big_Int_.Int_, _y:stdgo._internal.math.big.Big_Int_.Int_):Bool {
    ...
    static public function params<Dynamic>(_curve:T_nistCurve<Dynamic>):CurveParams {
...
class Elliptic {
    ...
    **/
    static public function generateKey(_curve:Curve, _rand:stdgo._internal.io.Io_Reader.Reader):stdgo.Tuple.Tuple4<Array<std.UInt>, stdgo._internal.math.big.Big_Int_.Int_, stdgo._internal.math.big.Big_Int_.Int_, stdgo.Error> {
        return {
    ...
    **/
    static public function marshal(_curve:Curve, _x:stdgo._internal.math.big.Big_Int_.Int_, _y:stdgo._internal.math.big.Big_Int_.Int_):Array<std.UInt> {
    ...
    **/
    static public function marshalCompressed(_curve:Curve, _x:stdgo._internal.math.big.Big_Int_.Int_, _y:stdgo._internal.math.big.Big_Int_.Int_):Array<std.UInt> {
    ...
    **/
    static public function unmarshal(_curve:Curve, _data:Array<std.UInt>):stdgo.Tuple<stdgo._internal.math.big.Big_Int_.Int_, stdgo._internal.math.big.Big_Int_.Int_> {
        final _data = ([for (i in _data) i] : stdgo.Slice<stdgo.GoUInt8>);
        return {
    ...
    **/
    static public function unmarshalCompressed(_curve:Curve, _data:Array<std.UInt>):stdgo.Tuple<stdgo._internal.math.big.Big_Int_.Int_, stdgo._internal.math.big.Big_Int_.Int_> {
        final _data = ([for (i in _data) i] : stdgo.Slice<stdgo.GoUInt8>);
        return {
    ...
    **/
    static public function p224():Curve {
    ...
    /**
        ...
        The cryptographic operations are implemented using constant-time algorithms.
    **/
    static public function p256():Curve {
    ...
    /**
        ...
        The cryptographic operations are implemented using constant-time algorithms.
    **/
    static public function p384():Curve {
    ...
    /**
        ...
        The cryptographic operations are implemented using constant-time algorithms.
    **/
    static public function p521():Curve {
