...
typedef Curve = StructType & {
	...
	public function add(_x1:Pointer<stdgo.math.big.Big.Int_>, _y1:Pointer<stdgo.math.big.Big.Int_>, _x2:Pointer<stdgo.math.big.Big.Int_>,
		_y2:Pointer<stdgo.math.big.Big.Int_>):{
		var _0:Pointer<stdgo.math.big.Big.Int_>;
		var _1:Pointer<stdgo.math.big.Big.Int_>;
	};
	public function double(_x1:Pointer<stdgo.math.big.Big.Int_>,
		_y1:Pointer<stdgo.math.big.Big.Int_>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;};
	public function scalarMult(_x1:Pointer<stdgo.math.big.Big.Int_>, _y1:Pointer<stdgo.math.big.Big.Int_>,
		_k:Slice<GoByte>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;};
...
@:structInit class CurveParams {
	public function scalarBaseMult(_k:Slice<GoByte>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;} {
		...
		{
			var __tmp__ = _matchesSpecificCurve(_curve, _p224.__copy__(), _p256.__copy__(), _p521.__copy__()),
				_specific:Curve = __tmp__._0,
				_ok:Bool = __tmp__._1;
			if (_ok) {
	...
	public function scalarMult(bx:Pointer<stdgo.math.big.Big.Int_>, by:Pointer<stdgo.math.big.Big.Int_>,
			_k:Slice<GoByte>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;} {
		var _curve = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		{
			var __tmp__ = _matchesSpecificCurve(_curve, _p224.__copy__(), _p256.__copy__(), _p521.__copy__()),
		...
		var _x:Pointer<stdgo.math.big.Big.Int_> = Go.pointer(new stdgo.math.big.Big.Int_()),
			_y:Pointer<stdgo.math.big.Big.Int_> = Go.pointer(new stdgo.math.big.Big.Int_()),
			_z:Pointer<stdgo.math.big.Big.Int_> = Go.pointer(new stdgo.math.big.Big.Int_());
		for (_ => _byte in _k) {
			{
	...
	public function _doubleJacobian(_x:Pointer<stdgo.math.big.Big.Int_>, _y:Pointer<stdgo.math.big.Big.Int_>,
			_z:Pointer<stdgo.math.big.Big.Int_>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>; var _2:Pointer<stdgo.math.big.Big.Int_>;} {
		var _curve = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
	...
	public function double(_x1:Pointer<stdgo.math.big.Big.Int_>,
		...
		var _curve = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		{
			var __tmp__ = _matchesSpecificCurve(_curve, _p224.__copy__(), _p521.__copy__()),
				_specific:Curve = __tmp__._0,
				_ok:Bool = __tmp__._1;
			if (_ok) {
		...
		return {
			...
			_curve.value._affineFromJacobian(((__tmp__._0 : Pointer<stdgo.math.big.Big.Int_>)), ((__tmp__._1 : Pointer<stdgo.math.big.Big.Int_>)),
				((__tmp__._2 : Pointer<stdgo.math.big.Big.Int_>)));
		};
	}

	public function _addJacobian(_x1:Pointer<stdgo.math.big.Big.Int_>, _y1:Pointer<stdgo.math.big.Big.Int_>, _z1:Pointer<stdgo.math.big.Big.Int_>,
			_x2:Pointer<stdgo.math.big.Big.Int_>, _y2:Pointer<stdgo.math.big.Big.Int_>, _z2:Pointer<stdgo.math.big.Big.Int_>):{
		var _0:Pointer<stdgo.math.big.Big.Int_>;
		var _1:Pointer<stdgo.math.big.Big.Int_>;
		var _2:Pointer<stdgo.math.big.Big.Int_>;
	} {
		var _curve = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _x3:Pointer<stdgo.math.big.Big.Int_> = Go.pointer(new stdgo.math.big.Big.Int_()),
			_y3:Pointer<stdgo.math.big.Big.Int_> = Go.pointer(new stdgo.math.big.Big.Int_()),
			_z3:Pointer<stdgo.math.big.Big.Int_> = Go.pointer(new stdgo.math.big.Big.Int_());
	...
	public function _affineFromJacobian(_x:Pointer<stdgo.math.big.Big.Int_>, _y:Pointer<stdgo.math.big.Big.Int_>,
			_z:Pointer<stdgo.math.big.Big.Int_>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;} {
		var _curve = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _xOut:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil(),
			_yOut:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil();
	...
	public function new(?p:Pointer<stdgo.math.big.Big.Int_>, ?n:Pointer<stdgo.math.big.Big.Int_>, ?b:Pointer<stdgo.math.big.Big.Int_>,
			?gx:Pointer<stdgo.math.big.Big.Int_>, ?gy:Pointer<stdgo.math.big.Big.Int_>, ?bitSize:GoInt, ?name:GoString)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(p) + " " + Go.string(n) + " " + Go.string(b) + " " + Go.string(gx) + " " + Go.string(gy) + " " + Go.string(bitSize) + " "
			+ Go.string(name) + "}";
	}
...
@:structInit class T_p224Curve {
	public function scalarBaseMult(_scalar:Slice<GoByte>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;} {
		...
		var _x:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil(),
			_y:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil();
		var _z1:T_p224FieldElement = new T_p224FieldElement(),
			_x2:T_p224FieldElement = new T_p224FieldElement(),
			_y2:T_p224FieldElement = new T_p224FieldElement(),
			_z2:T_p224FieldElement = new T_p224FieldElement();
	...
	public function scalarMult(_bigX1:Pointer<stdgo.math.big.Big.Int_>, _bigY1:Pointer<stdgo.math.big.Big.Int_>,
			_scalar:Slice<GoByte>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;} {
		var _x:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil(),
			_y:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil();
		var _x1:T_p224FieldElement = new T_p224FieldElement(),
			_y1:T_p224FieldElement = new T_p224FieldElement(),
			_z1:T_p224FieldElement = new T_p224FieldElement(),
			_x2:T_p224FieldElement = new T_p224FieldElement(),
			_y2:T_p224FieldElement = new T_p224FieldElement(),
			_z2:T_p224FieldElement = new T_p224FieldElement();
	...
	public function double(_bigX1:Pointer<stdgo.math.big.Big.Int_>,
			_bigY1:Pointer<stdgo.math.big.Big.Int_>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;} {
		var _x:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil(),
			_y:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil();
		var _x1:T_p224FieldElement = new T_p224FieldElement(),
			_y1:T_p224FieldElement = new T_p224FieldElement(),
	...
	public function add(_bigX1:Pointer<stdgo.math.big.Big.Int_>, _bigY1:Pointer<stdgo.math.big.Big.Int_>, _bigX2:Pointer<stdgo.math.big.Big.Int_>,
			_bigY2:Pointer<stdgo.math.big.Big.Int_>):{
		var _0:Pointer<stdgo.math.big.Big.Int_>;
		var _1:Pointer<stdgo.math.big.Big.Int_>;
	} {
		var _x:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil(),
		...
		var _x1:T_p224FieldElement = new T_p224FieldElement(),
			...
			_y2:T_p224FieldElement = new T_p224FieldElement(),
			_z2:T_p224FieldElement = new T_p224FieldElement(),
			_x3:T_p224FieldElement = new T_p224FieldElement(),
			_y3:T_p224FieldElement = new T_p224FieldElement(),
			_z3:T_p224FieldElement = new T_p224FieldElement();
		_p224FromBig(Go.pointer(_x1), _bigX1);
		_p224FromBig(Go.pointer(_y1), _bigY1);
		...
		_p224AddJacobian(Go.pointer(_x3), Go.pointer(_y3), Go.pointer(_z3), Go.pointer(_x1), Go.pointer(_y1), Go.pointer(_z1), Go.pointer(_x2),
			Go.pointer(_y2), Go.pointer(_z2));
	...
	public function isOnCurve(_bigX:Pointer<stdgo.math.big.Big.Int_>, _bigY:Pointer<stdgo.math.big.Big.Int_>):Bool {
		var _curve = this.__copy__();
		var _x:T_p224FieldElement = new T_p224FieldElement(),
			_y:T_p224FieldElement = new T_p224FieldElement();
	...
	public function new(?curveParams:Pointer<CurveParams>, ?_gx:T_p224FieldElement, ?_gy:T_p224FieldElement, ?_b:T_p224FieldElement)
		stdgo.internal.Macro.initLocals();
	...
	public function _addJacobian(_x1:Pointer<stdgo.math.big.Big.Int_>, _y1:Pointer<stdgo.math.big.Big.Int_>, _z1:Pointer<stdgo.math.big.Big.Int_>,
			_x2:Pointer<stdgo.math.big.Big.Int_>, _y2:Pointer<stdgo.math.big.Big.Int_>, _z2:Pointer<stdgo.math.big.Big.Int_>):{
		var _0:(Pointer<stdgo.math.big.Big.Int_>, Pointer<stdgo.math.big.Big.Int_>, Pointer<stdgo.math.big.Big.Int_>, Pointer<stdgo.math.big.Big.Int_>,
			Pointer<stdgo.math.big.Big.Int_>, Pointer<stdgo.math.big.Big.Int_>) -> {
				var _0:Pointer<stdgo.math.big.Big.Int_>;
				var _1:Pointer<stdgo.math.big.Big.Int_>;
				var _2:Pointer<stdgo.math.big.Big.Int_>;
			};
		var _1:(Pointer<stdgo.math.big.Big.Int_>, Pointer<stdgo.math.big.Big.Int_>, Pointer<stdgo.math.big.Big.Int_>, Pointer<stdgo.math.big.Big.Int_>,
			Pointer<stdgo.math.big.Big.Int_>, Pointer<stdgo.math.big.Big.Int_>) -> {
				var _0:Pointer<stdgo.math.big.Big.Int_>;
				var _1:Pointer<stdgo.math.big.Big.Int_>;
				var _2:Pointer<stdgo.math.big.Big.Int_>;
			};
		var _2:(Pointer<stdgo.math.big.Big.Int_>, Pointer<stdgo.math.big.Big.Int_>, Pointer<stdgo.math.big.Big.Int_>, Pointer<stdgo.math.big.Big.Int_>,
			Pointer<stdgo.math.big.Big.Int_>, Pointer<stdgo.math.big.Big.Int_>) -> {
				var _0:Pointer<stdgo.math.big.Big.Int_>;
				var _1:Pointer<stdgo.math.big.Big.Int_>;
				var _2:Pointer<stdgo.math.big.Big.Int_>;
		...
		return curveParams._addJacobian(_0, _1, _2, _3, _4, _5);

	public function _affineFromJacobian(_x:Pointer<stdgo.math.big.Big.Int_>, _y:Pointer<stdgo.math.big.Big.Int_>,
			_z:Pointer<stdgo.math.big.Big.Int_>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;}
		return curveParams._affineFromJacobian(_0, _1, _2);

	public function _doubleJacobian(_x:Pointer<stdgo.math.big.Big.Int_>, _y:Pointer<stdgo.math.big.Big.Int_>,
			_z:Pointer<stdgo.math.big.Big.Int_>):{var _0:(Pointer<stdgo.math.big.Big.Int_>, Pointer<stdgo.math.big.Big.Int_>,
		Pointer<stdgo.math.big.Big.Int_>) -> {
			var _0:Pointer<stdgo.math.big.Big.Int_>;
			var _1:Pointer<stdgo.math.big.Big.Int_>;
			var _2:Pointer<stdgo.math.big.Big.Int_>;
		}; var _1:(Pointer<stdgo.math.big.Big.Int_>, Pointer<stdgo.math.big.Big.Int_>, Pointer<stdgo.math.big.Big.Int_>) -> {
			var _0:Pointer<stdgo.math.big.Big.Int_>;
			var _1:Pointer<stdgo.math.big.Big.Int_>;
			var _2:Pointer<stdgo.math.big.Big.Int_>;
		}; var _2:(Pointer<stdgo.math.big.Big.Int_>, Pointer<stdgo.math.big.Big.Int_>, Pointer<stdgo.math.big.Big.Int_>) -> {
			var _0:Pointer<stdgo.math.big.Big.Int_>;
			var _1:Pointer<stdgo.math.big.Big.Int_>;
			var _2:Pointer<stdgo.math.big.Big.Int_>;
		};}
		return curveParams._doubleJacobian(_0, _1, _2);

	public function _polynomial(_x:Pointer<stdgo.math.big.Big.Int_>):Pointer<stdgo.math.big.Big.Int_>
		return curveParams._polynomial(_0);
...
@:named class T_p224FieldElement {
	...
	public function __copy__()
		return new T_p224FieldElement(__t__.copy());
...
@:named class T_p224LargeFieldElement {
	...
	public function __copy__()
		return new T_p224LargeFieldElement(__t__.copy());
...
@:structInit class T_p256Curve {
	public function scalarMult(_bigX:Pointer<stdgo.math.big.Big.Int_>, _bigY:Pointer<stdgo.math.big.Big.Int_>,
			_scalar:Slice<GoByte>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;} {
		var _x:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil(),
			_y:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil();
	...
	public function scalarBaseMult(_scalar:Slice<GoByte>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;} {
		...
		var _scalarReversed:GoArray<GoByte> = new GoArray<GoUInt8>(...[for (i in 0...32) ((0 : GoUInt8))]);
		_p256GetScalar(Go.pointer(_scalarReversed), _scalar);
		var _x1:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]),
			_y1:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]),
			_z1:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]);
	...
	public function new(?curveParams:Pointer<CurveParams>)
		stdgo.internal.Macro.initLocals();
	...
	public function add(_x1:Pointer<stdgo.math.big.Big.Int_>, _y1:Pointer<stdgo.math.big.Big.Int_>, _x2:Pointer<stdgo.math.big.Big.Int_>,
		...
		return curveParams.add(_0, _1, _2, _3);

	public function double(_x1:Pointer<stdgo.math.big.Big.Int_>,
			_y1:Pointer<stdgo.math.big.Big.Int_>):{var _0:(Pointer<stdgo.math.big.Big.Int_>, Pointer<stdgo.math.big.Big.Int_>) -> {
		var _0:Pointer<stdgo.math.big.Big.Int_>;
		var _1:Pointer<stdgo.math.big.Big.Int_>;
	}; var _1:(Pointer<stdgo.math.big.Big.Int_>, Pointer<stdgo.math.big.Big.Int_>) -> {
		var _0:Pointer<stdgo.math.big.Big.Int_>;
		var _1:Pointer<stdgo.math.big.Big.Int_>;
		};}
		return curveParams.double(_0, _1);

	public function isOnCurve(_x:Pointer<stdgo.math.big.Big.Int_>, _y:Pointer<stdgo.math.big.Big.Int_>):Bool
		return curveParams.isOnCurve(_0, _1);
...
@:structInit class T_p521Curve {
	...
	public function scalarMult(bx:Pointer<stdgo.math.big.Big.Int_>, by:Pointer<stdgo.math.big.Big.Int_>,
		...
		var _p:Pointer<T_p521Point> = Go.pointer((({_x: Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element()),
			_y: Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element()),
			_z: Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())} : T_p521Point))),
			_t:Pointer<T_p521Point> = Go.pointer((({_x: Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element()),
				_y: Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element()),
				_z: Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())} : T_p521Point)));
	...
	public function _jacobianFromAffine(_x:Pointer<stdgo.math.big.Big.Int_>, _y:Pointer<stdgo.math.big.Big.Int_>):Pointer<T_p521Point> {
		...
		if (_x.value.sign() == ((0 : GoInt)) && _y.value.sign() == ((0 : GoInt))) {
			return Go.pointer((({_x: Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element()),
				_y: Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element()),
				_z: Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())} : T_p521Point)));
		};
		return Go.pointer((({_x: _bigIntToFiatP521(_x), _y: _bigIntToFiatP521(_y), _z: Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())
			.value.one()} : T_p521Point)));
	}
	...
	public function _affineFromJacobian(_p:Pointer<T_p521Point>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;} {
		...
		var _zinv:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element> = Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())
			.value.invert(_p.value._z);
		var _zinvsq:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element> = Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())
			.value.mul(_zinv, _zinv);
		var _xx:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element> = Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())
			.value.mul(_p.value._x, _zinvsq);
		_zinvsq.value.mul(_zinvsq, _zinv);
		var _yy:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element> = Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())
			.value.mul(_p.value._y, _zinvsq);
	...
	public function isOnCurve(_x:Pointer<stdgo.math.big.Big.Int_>, _y:Pointer<stdgo.math.big.Big.Int_>):Bool {
		...
		var _threeX:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element> = Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())
			.value.add(_x1, _x1);
...
@:structInit class T_p521Point {
	public function _doubleJacobian(_p:Pointer<T_p521Point>):Pointer<T_p521Point> {
		...
		var _delta:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element> = Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())
			.value.square(_p.value._z);
		var _gamma:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element> = Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())
			.value.square(_p.value._y);
		var _alpha:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element> = Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())
			.value.sub(_p.value._x, _delta);
		var _alpha2:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element> = Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())
			.value.add(_p.value._x, _delta);
		_alpha.value.mul(_alpha, _alpha2);
		_alpha2.value.set(_alpha);
		...
		var _beta8:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element> = Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())
			.value.add(_beta, _beta);
	...
	public function _addJacobian(_p1:Pointer<T_p521Point>, _p2:Pointer<T_p521Point>):Pointer<T_p521Point> {
		...
		var _z1z1:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element> = Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())
			.value.square(_p1.value._z);
		var _z2z2:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element> = Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())
			.value.square(_p2.value._z);
		var _u1:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element> = Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())
			.value.mul(_p1.value._x, _z2z2);
		var _u2:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element> = Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())
			.value.mul(_p2.value._x, _z1z1);
		...
		var _s1:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element> = Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())
			.value.mul(_p1.value._y, _p2.value._z);
		_s1.value.mul(_s1, _z2z2);
		var _s2:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element> = Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())
			.value.mul(_p2.value._y, _p1.value._z);
		_s2.value.mul(_s2, _z1z1);
		...
		_y.value.sub(_y, _s1);
		var _z:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element> = Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element())
			.value.add(_p1.value._z, _p2.value._z);
		_z.value.square(_z);
	...
	public function new(?_x:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element>, ?_y:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element>,
			?_z:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element>)
		stdgo.internal.Macro.initLocals();
...
final _two31m15m3:GoUnTypedInt = (((1 : GoUnTypedInt)) << ((31 : GoUnTypedInt))) - (((1 : GoUnTypedInt)) << ((15 : GoUnTypedInt)))
	- (((1 : GoUnTypedInt)) << ((3 : GoUnTypedInt)));
...
var _p256One:GoArray<GoUInt32> = new GoArray<GoUInt32>(((2 : GoUInt32)), ((0 : GoUInt32)), ((0 : GoUInt32)), ((268433408 : GoUInt32)),
	((536870911 : GoUInt32)), ((268435455 : GoUInt32)), ((532676607 : GoUInt32)), ((33554431 : GoUInt32)), ((0 : GoUInt32))).copy();

var _p256:T_p256Curve = new T_p256Curve();
var _p521:T_p521Curve = new T_p521Curve();

var _mask:Slice<GoUInt8> = new Slice<GoUInt8>(((255 : GoUInt8)), ((1 : GoUInt8)), ((3 : GoUInt8)), ((7 : GoUInt8)), ((15 : GoUInt8)), ((31 : GoUInt8)),
	((63 : GoUInt8)), ((127 : GoUInt8)));

var _p256P:GoArray<GoUInt32> = new GoArray<GoUInt32>(((536870911 : GoUInt32)), ((268435455 : GoUInt32)), ((536870911 : GoUInt32)), ((1023 : GoUInt32)),
	((0 : GoUInt32)), ((0 : GoUInt32)), ((2097152 : GoUInt32)), ((251658240 : GoUInt32)), ((268435455 : GoUInt32))).copy();

final _two63m35:GoUnTypedInt = (((1 : GoUnTypedInt)) << ((63 : GoUnTypedInt))) - (((1 : GoUnTypedInt)) << ((35 : GoUnTypedInt)));

var _p2562P:GoArray<GoUInt32> = new GoArray<GoUInt32>(((536870910 : GoUInt32)), ((268435455 : GoUInt32)), ((536870911 : GoUInt32)), ((2047 : GoUInt32)),
	((0 : GoUInt32)), ((0 : GoUInt32)), ((4194304 : GoUInt32)), ((234881024 : GoUInt32)), ((536870911 : GoUInt32))).copy();

var _p224P:GoArray<GoUInt32> = new GoArray<GoUInt32>(((1 : GoUInt32)), ((0 : GoUInt32)), ((0 : GoUInt32)), ((268431360 : GoUInt32)), ((268435455 : GoUInt32)),
	((268435455 : GoUInt32)), ((268435455 : GoUInt32)), ((268435455 : GoUInt32))).copy();

final _bottom28Bits:GoInt64 = ((268435455 : GoUnTypedInt));

final _two30m27m2:GoUnTypedInt = (((1 : GoUnTypedInt)) << ((30 : GoUnTypedInt))) - (((1 : GoUnTypedInt)) << ((27 : GoUnTypedInt)))
	- (((1 : GoUnTypedInt)) << ((2 : GoUnTypedInt)));

final _bottom12Bits:GoInt64 = ((4095 : GoUnTypedInt));

var _p256Zero:GoArray<GoUInt32> = new GoArray<GoUInt32>(((0 : GoUInt32)), ((0 : GoUInt32)), ((0 : GoUInt32)), ((0 : GoUInt32)), ((0 : GoUInt32)),
	((0 : GoUInt32)), ((0 : GoUInt32)), ((0 : GoUInt32)), ((0 : GoUInt32))).copy();
...
final _two30p13m2:GoUnTypedInt = (((1 : GoUnTypedInt)) << ((30 : GoUnTypedInt))) + (((1 : GoUnTypedInt)) << ((13 : GoUnTypedInt)))
	- (((1 : GoUnTypedInt)) << ((2 : GoUnTypedInt)));

final _two31p24m2:GoUnTypedInt = (((1 : GoUnTypedInt)) << ((31 : GoUnTypedInt))) + (((1 : GoUnTypedInt)) << ((24 : GoUnTypedInt)))
	- (((1 : GoUnTypedInt)) << ((2 : GoUnTypedInt)));

var _p256Zero31:GoArray<GoUInt32> = new GoArray<GoUInt32>(_two31m3, _two30m2, _two31m2, _two30p13m2, _two31m2, _two30m2, _two31p24m2, _two30m27m2,
	_two31m2).copy();

final _two63p35:GoUnTypedInt = (((1 : GoUnTypedInt)) << ((63 : GoUnTypedInt))) + (((1 : GoUnTypedInt)) << ((35 : GoUnTypedInt)));

final _two63m35m19:GoUnTypedInt = (((1 : GoUnTypedInt)) << ((63 : GoUnTypedInt))) - (((1 : GoUnTypedInt)) << ((35 : GoUnTypedInt)))
	- (((1 : GoUnTypedInt)) << ((19 : GoUnTypedInt)));

var _p224ZeroModP63:GoArray<GoUInt64> = new GoArray<GoUInt64>(_two63p35, _two63m35, _two63m35, _two63m35, _two63m35m19, _two63m35, _two63m35,
	_two63m35).copy();
...
var _p256Precomputed:GoArray<GoUInt32> = new GoArray<GoUInt32>(((290596984 : GoUInt32)), ((242421057 : GoUInt32)), ((230031737 : GoUInt32)),
	((78635775 : GoUInt32)), ((310917853 : GoUInt32)), ((212721032 : GoUInt32)), ((295599836 : GoUInt32)), ((222981803 : GoUInt32)), ((51514350 : GoUInt32)),
	((489335829 : GoUInt32)), ((254096764 : GoUInt32)), ((434396381 : GoUInt32)), ((96936400 : GoUInt32)), ((429049253 : GoUInt32)), ((170095751 : GoUInt32)),
	((22329889 : GoUInt32)), ((21696699 : GoUInt32)), ((11419619 : GoUInt32)), ((222406006 : GoUInt32)), ((153287761 : GoUInt32)), ((37001551 : GoUInt32)),
	((101408979 : GoUInt32)), ((373655214 : GoUInt32)), ((216620824 : GoUInt32)), ((535072883 : GoUInt32)), ((66729676 : GoUInt32)), ((99339564 : GoUInt32)),
	((188755759 : GoUInt32)), ((22835391 : GoUInt32)), ((358715996 : GoUInt32)), ((94529284 : GoUInt32)), ((229187216 : GoUInt32)), ((215751807 : GoUInt32)),
	((513877062 : GoUInt32)), ((236641822 : GoUInt32)), ((248061730 : GoUInt32)), ((40859512 : GoUInt32)), ((90604670 : GoUInt32)), ((168553630 : GoUInt32)),
	((37024851 : GoUInt32)), ((439480858 : GoUInt32)), ((226879324 : GoUInt32)), ((90992905 : GoUInt32)), ((170293760 : GoUInt32)), ((190300240 : GoUInt32)),
	((10025815 : GoUInt32)), ((178796492 : GoUInt32)), ((101451666 : GoUInt32)), ((217734681 : GoUInt32)), ((102476702 : GoUInt32)), ((92922779 : GoUInt32)),
:Pointer<stdgo.math.big.Big.Int_>, _y:Pointer<stdgo.math.big.Big.Int_>):Slice<GoByte> {
	...
	var _ret:Slice<GoUInt8> = new Slice<GoUInt8>(...[
		for (i in 0...((((1 : GoInt)) + ((2 : GoInt)) * _byteLen : GoInt)).toBasic()) ((0 : GoUInt8))
	]);
...
function _initP384():Void {
	_p384 = Go.pointer((({
		name: "P-384",
		p: new Pointer<stdgo.math.big.Big.Int_>().nil(),
		n: new Pointer<stdgo.math.big.Big.Int_>().nil(),
		b: new Pointer<stdgo.math.big.Big.Int_>().nil(),
		gx: new Pointer<stdgo.math.big.Big.Int_>().nil(),
		gy: new Pointer<stdgo.math.big.Big.Int_>().nil(),
		bitSize: 0
	} : CurveParams)));
	{
		var __tmp__ = Go.pointer(new stdgo.math.big.Big.Int_())
			.value.setString("39402006196394479212279040100143613805079739270465446667948293404245721771496870329047266088258938001861606973112319",
				((10 : GoInt)));
		_p384.value.p = __tmp__._0;
	};
	{
		var __tmp__ = Go.pointer(new stdgo.math.big.Big.Int_())
			.value.setString("39402006196394479212279040100143613805079739270465446667946905279627659399113263569398956308152294913554433653942643",
				((10 : GoInt)));
		_p384.value.n = __tmp__._0;
	};
	{
		var __tmp__ = Go.pointer(new stdgo.math.big.Big.Int_())
			.value.setString("b3312fa7e23ee7e4988e056be3f82d19181d9c6efe8141120314088f5013875ac656398d8a2ed19d2a85c8edd3ec2aef", ((16 : GoInt)));
		_p384.value.b = __tmp__._0;
	};
	{
		var __tmp__ = Go.pointer(new stdgo.math.big.Big.Int_())
			.value.setString("aa87ca22be8b05378eb1c71ef320ad746e1d3b628ba79b9859f741e082542a385502f25dbf55296c3a545e3872760ab7", ((16 : GoInt)));
		_p384.value.gx = __tmp__._0;
	};
	{
		var __tmp__ = Go.pointer(new stdgo.math.big.Big.Int_())
			.value.setString("3617de4a96262c6f5d9e98bf9292dc29f8f41dbd289a147ce9da3113b5f0b8c00a60b1ce1d7e819d7a431d7c90ea0e5f", ((16 : GoInt)));
...
function _initP224():Void {
	...
	{
		var __tmp__ = Go.pointer(new stdgo.math.big.Big.Int_())
			.value.setString("26959946667150639794667015087019630673557916260026308143510066298881", ((10 : GoInt)));
		_p224.curveParams.value.p = __tmp__._0;
	};
	{
		var __tmp__ = Go.pointer(new stdgo.math.big.Big.Int_())
			.value.setString("26959946667150639794667015087019625940457807714424391721682722368061", ((10 : GoInt)));
...
/**
	...
	// out[i] < 2**29
**/
function _p224Mul(_out:Pointer<T_p224FieldElement>, _a:Pointer<T_p224FieldElement>, _b:Pointer<T_p224FieldElement>,
		_tmp:Pointer<T_p224LargeFieldElement>):Void {
	{
		var _i:GoInt = ((0 : GoInt));
...
function _p224ReduceLarge(_out:Pointer<T_p224FieldElement>, _in:Pointer<T_p224LargeFieldElement>):Void {
	...
	};
	{
		...
		Go.cfor(_i >= ((8 : GoInt)), _i--, {
			...
			_in.value.__t__[_i - ((5 : GoInt))] = _in.value.__t__[_i - ((5 : GoInt))]
				+ (((_in.value.__t__[_i] & ((65535 : GoUInt64))) << ((12 : GoUnTypedInt))));
	...
	_out.value.__t__[((3 : GoInt))] = _out.value.__t__[((3 : GoInt))]
		+ (((((_in.value.__t__[((8 : GoInt))] & ((65535 : GoUInt64))) : GoUInt32)) << ((12 : GoUnTypedInt))));
	...
	_out.value.__t__[((1 : GoInt))] = _out.value.__t__[((1 : GoInt))]
		+ ((((((_in.value.__t__[((0 : GoInt))] >> ((28 : GoUnTypedInt)))) & _bottom28Bits) : GoUInt32)));
...
function _p224Invert(_out:Pointer<T_p224FieldElement>, _in:Pointer<T_p224FieldElement>):Void {
	var _f1:T_p224FieldElement = new T_p224FieldElement(),
		_f2:T_p224FieldElement = new T_p224FieldElement(),
		_f3:T_p224FieldElement = new T_p224FieldElement(),
		_f4:T_p224FieldElement = new T_p224FieldElement();
...
**/
function _p224AddJacobian(_x3:Pointer<T_p224FieldElement>, _y3:Pointer<T_p224FieldElement>, _z3:Pointer<T_p224FieldElement>, _x1:Pointer<T_p224FieldElement>,
		_y1:Pointer<T_p224FieldElement>, _z1:Pointer<T_p224FieldElement>, _x2:Pointer<T_p224FieldElement>, _y2:Pointer<T_p224FieldElement>,
		_z2:Pointer<T_p224FieldElement>):Void {
	var _z1z1:T_p224FieldElement = new T_p224FieldElement(),
		_z2z2:T_p224FieldElement = new T_p224FieldElement(),
		_u1:T_p224FieldElement = new T_p224FieldElement(),
		_u2:T_p224FieldElement = new T_p224FieldElement(),
		_s1:T_p224FieldElement = new T_p224FieldElement(),
		_s2:T_p224FieldElement = new T_p224FieldElement(),
		_h:T_p224FieldElement = new T_p224FieldElement(),
		_i:T_p224FieldElement = new T_p224FieldElement(),
		_j:T_p224FieldElement = new T_p224FieldElement(),
		_r:T_p224FieldElement = new T_p224FieldElement(),
		_v:T_p224FieldElement = new T_p224FieldElement();
	var _c:T_p224LargeFieldElement = new T_p224LargeFieldElement();
	...
	if (_xEqual == ((1 : GoUInt32))
		&& _yEqual == ((1 : GoUInt32))
		&& _z1IsZero == ((0 : GoUInt32))
		&& _z2IsZero == ((0 : GoUInt32))) {
...
**/
function _p224DoubleJacobian(_x3:Pointer<T_p224FieldElement>, _y3:Pointer<T_p224FieldElement>, _z3:Pointer<T_p224FieldElement>,
		_x1:Pointer<T_p224FieldElement>, _y1:Pointer<T_p224FieldElement>, _z1:Pointer<T_p224FieldElement>):Void {
	var _delta:T_p224FieldElement = new T_p224FieldElement(),
		_gamma:T_p224FieldElement = new T_p224FieldElement(),
		_beta:T_p224FieldElement = new T_p224FieldElement(),
		_alpha:T_p224FieldElement = new T_p224FieldElement(),
		_t:T_p224FieldElement = new T_p224FieldElement();
	var _c:T_p224LargeFieldElement = new T_p224LargeFieldElement();
...
function _p224ScalarMult(_outX:Pointer<T_p224FieldElement>, _outY:Pointer<T_p224FieldElement>, _outZ:Pointer<T_p224FieldElement>,
		_inX:Pointer<T_p224FieldElement>, _inY:Pointer<T_p224FieldElement>, _inZ:Pointer<T_p224FieldElement>, _scalar:Slice<GoByte>):Void {
	var _xx:T_p224FieldElement = new T_p224FieldElement(),
		_yy:T_p224FieldElement = new T_p224FieldElement(),
		_zz:T_p224FieldElement = new T_p224FieldElement();
	{
		var _i:GoInt = ((0 : GoInt));
		Go.cfor(_i < ((8 : GoInt)), _i++, {
...
**/
function _p224ToAffine(_x:Pointer<T_p224FieldElement>, _y:Pointer<T_p224FieldElement>,
		_z:Pointer<T_p224FieldElement>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;} {
	var _zinv:T_p224FieldElement = new T_p224FieldElement(),
		_zinvsq:T_p224FieldElement = new T_p224FieldElement(),
		_outx:T_p224FieldElement = new T_p224FieldElement(),
		_outy:T_p224FieldElement = new T_p224FieldElement();
	var _tmp:T_p224LargeFieldElement = new T_p224LargeFieldElement();
	{
...
function _initP256():Void {
	...
	{
		var __tmp__ = Go.pointer(new stdgo.math.big.Big.Int_())
			.value.setString("115792089210356248762697446949407573530086143415290314195533631308867097853951", ((10 : GoInt)));
		_p256Params.value.p = __tmp__._0;
	};
	{
		var __tmp__ = Go.pointer(new stdgo.math.big.Big.Int_())
			.value.setString("115792089210356248762697446949407573529996955224135760342422259061068512044369", ((10 : GoInt)));
		_p256Params.value.n = __tmp__._0;
	};
	{
		var __tmp__ = Go.pointer(new stdgo.math.big.Big.Int_())
			.value.setString("5ac635d8aa3a93e7b3ebbd55769886bc651d06b0cc53b0f63bce3c3e27d2604b", ((16 : GoInt)));
		_p256Params.value.b = __tmp__._0;
	};
	{
		var __tmp__ = Go.pointer(new stdgo.math.big.Big.Int_())
			.value.setString("6b17d1f2e12c4247f8bce6e563a440f277037d812deb33a0f4a13945d898c296", ((16 : GoInt)));
		_p256Params.value.gx = __tmp__._0;
	};
	{
		var __tmp__ = Go.pointer(new stdgo.math.big.Big.Int_())
			.value.setString("4fe342e2fe1a7f9b8ee7eb4a7c0f9e162bce33576b315ececbb6406837bf51f5", ((16 : GoInt)));
		_p256Params.value.gy = __tmp__._0;
	};
	_p256Params.value.bitSize = ((256 : GoInt));
	{
		var __tmp__ = Go.pointer(new stdgo.math.big.Big.Int_())
			.value.setString("7fffffff00000001fffffffe8000000100000000ffffffff0000000180000000", ((16 : GoInt)));
...
function _p256ReduceDegree(_out:Pointer<GoArray<GoUInt32>>, _tmp:GoArray<GoUInt64>):Void {
	...
	var _carry:GoUInt32 = ((0 : GoUInt32)),
		_x:GoUInt32 = ((0 : GoUInt32)),
		_xMask:GoUInt32 = ((0 : GoUInt32));
...
function _p256Square(_out:Pointer<GoArray<GoUInt32>>, _in:Pointer<GoArray<GoUInt32>>):Void {
	...
	_tmp[((2 : GoInt))] = ((_in.value[((0 : GoInt))] : GoUInt64)) * ((((_in.value[((2 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((1 : GoInt))] : GoUInt64)) * ((((_in.value[((1 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))));
	_tmp[((3 : GoInt))] = ((_in.value[((0 : GoInt))] : GoUInt64)) * ((((_in.value[((3 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((1 : GoInt))] : GoUInt64)) * ((((_in.value[((2 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))));
	_tmp[((4 : GoInt))] = ((_in.value[((0 : GoInt))] : GoUInt64)) * ((((_in.value[((4 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((1 : GoInt))] : GoUInt64)) * ((((_in.value[((3 : GoInt))] : GoUInt64)) << ((2 : GoUnTypedInt))))
		+ ((_in.value[((2 : GoInt))] : GoUInt64)) * ((_in.value[((2 : GoInt))] : GoUInt64));
	_tmp[((5 : GoInt))] = ((_in.value[((0 : GoInt))] : GoUInt64)) * ((((_in.value[((5 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((1 : GoInt))] : GoUInt64)) * ((((_in.value[((4 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((2 : GoInt))] : GoUInt64)) * ((((_in.value[((3 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))));
	_tmp[((6 : GoInt))] = ((_in.value[((0 : GoInt))] : GoUInt64)) * ((((_in.value[((6 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((1 : GoInt))] : GoUInt64)) * ((((_in.value[((5 : GoInt))] : GoUInt64)) << ((2 : GoUnTypedInt))))
		+ ((_in.value[((2 : GoInt))] : GoUInt64)) * ((((_in.value[((4 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((3 : GoInt))] : GoUInt64)) * ((((_in.value[((3 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))));
	_tmp[((7 : GoInt))] = ((_in.value[((0 : GoInt))] : GoUInt64)) * ((((_in.value[((7 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((1 : GoInt))] : GoUInt64)) * ((((_in.value[((6 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((2 : GoInt))] : GoUInt64)) * ((((_in.value[((5 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((3 : GoInt))] : GoUInt64)) * ((((_in.value[((4 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))));
	_tmp[((8 : GoInt))] = ((_in.value[((0 : GoInt))] : GoUInt64)) * ((((_in.value[((8 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((1 : GoInt))] : GoUInt64)) * ((((_in.value[((7 : GoInt))] : GoUInt64)) << ((2 : GoUnTypedInt))))
		+ ((_in.value[((2 : GoInt))] : GoUInt64)) * ((((_in.value[((6 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((3 : GoInt))] : GoUInt64)) * ((((_in.value[((5 : GoInt))] : GoUInt64)) << ((2 : GoUnTypedInt))))
		+ ((_in.value[((4 : GoInt))] : GoUInt64)) * ((_in.value[((4 : GoInt))] : GoUInt64));
	_tmp[((9 : GoInt))] = ((_in.value[((1 : GoInt))] : GoUInt64)) * ((((_in.value[((8 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((2 : GoInt))] : GoUInt64)) * ((((_in.value[((7 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((3 : GoInt))] : GoUInt64)) * ((((_in.value[((6 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((4 : GoInt))] : GoUInt64)) * ((((_in.value[((5 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))));
	_tmp[((10 : GoInt))] = ((_in.value[((2 : GoInt))] : GoUInt64)) * ((((_in.value[((8 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((3 : GoInt))] : GoUInt64)) * ((((_in.value[((7 : GoInt))] : GoUInt64)) << ((2 : GoUnTypedInt))))
		+ ((_in.value[((4 : GoInt))] : GoUInt64)) * ((((_in.value[((6 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((5 : GoInt))] : GoUInt64)) * ((((_in.value[((5 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))));
	_tmp[((11 : GoInt))] = ((_in.value[((3 : GoInt))] : GoUInt64)) * ((((_in.value[((8 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((4 : GoInt))] : GoUInt64)) * ((((_in.value[((7 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((5 : GoInt))] : GoUInt64)) * ((((_in.value[((6 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))));
	_tmp[((12 : GoInt))] = ((_in.value[((4 : GoInt))] : GoUInt64)) * ((((_in.value[((8 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((5 : GoInt))] : GoUInt64)) * ((((_in.value[((7 : GoInt))] : GoUInt64)) << ((2 : GoUnTypedInt))))
		+ ((_in.value[((6 : GoInt))] : GoUInt64)) * ((_in.value[((6 : GoInt))] : GoUInt64));
	_tmp[((13 : GoInt))] = ((_in.value[((5 : GoInt))] : GoUInt64)) * ((((_in.value[((8 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((6 : GoInt))] : GoUInt64)) * ((((_in.value[((7 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))));
	_tmp[((14 : GoInt))] = ((_in.value[((6 : GoInt))] : GoUInt64)) * ((((_in.value[((8 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((7 : GoInt))] : GoUInt64)) * ((((_in.value[((7 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))));
...
function _p256Mul(_out:Pointer<GoArray<GoUInt32>>, _in:Pointer<GoArray<GoUInt32>>, _in2:Pointer<GoArray<GoUInt32>>):Void {
	...
	_tmp[((1 : GoInt))] = ((_in.value[((0 : GoInt))] : GoUInt64)) * ((((_in2.value[((1 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((1 : GoInt))] : GoUInt64)) * ((((_in2.value[((0 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))));
	_tmp[((2 : GoInt))] = ((_in.value[((0 : GoInt))] : GoUInt64)) * ((((_in2.value[((2 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((1 : GoInt))] : GoUInt64)) * ((((_in2.value[((1 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((2 : GoInt))] : GoUInt64)) * ((((_in2.value[((0 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))));
	_tmp[((3 : GoInt))] = ((_in.value[((0 : GoInt))] : GoUInt64)) * ((((_in2.value[((3 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((1 : GoInt))] : GoUInt64)) * ((((_in2.value[((2 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((2 : GoInt))] : GoUInt64)) * ((((_in2.value[((1 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((3 : GoInt))] : GoUInt64)) * ((((_in2.value[((0 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))));
	_tmp[((4 : GoInt))] = ((_in.value[((0 : GoInt))] : GoUInt64)) * ((((_in2.value[((4 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((1 : GoInt))] : GoUInt64)) * ((((_in2.value[((3 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((2 : GoInt))] : GoUInt64)) * ((((_in2.value[((2 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((3 : GoInt))] : GoUInt64)) * ((((_in2.value[((1 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((4 : GoInt))] : GoUInt64)) * ((((_in2.value[((0 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))));
	_tmp[((5 : GoInt))] = ((_in.value[((0 : GoInt))] : GoUInt64)) * ((((_in2.value[((5 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((1 : GoInt))] : GoUInt64)) * ((((_in2.value[((4 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((2 : GoInt))] : GoUInt64)) * ((((_in2.value[((3 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((3 : GoInt))] : GoUInt64)) * ((((_in2.value[((2 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((4 : GoInt))] : GoUInt64)) * ((((_in2.value[((1 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((5 : GoInt))] : GoUInt64)) * ((((_in2.value[((0 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))));
	_tmp[((6 : GoInt))] = ((_in.value[((0 : GoInt))] : GoUInt64)) * ((((_in2.value[((6 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((1 : GoInt))] : GoUInt64)) * ((((_in2.value[((5 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((2 : GoInt))] : GoUInt64)) * ((((_in2.value[((4 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((3 : GoInt))] : GoUInt64)) * ((((_in2.value[((3 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((4 : GoInt))] : GoUInt64)) * ((((_in2.value[((2 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((5 : GoInt))] : GoUInt64)) * ((((_in2.value[((1 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((6 : GoInt))] : GoUInt64)) * ((((_in2.value[((0 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))));
	_tmp[((7 : GoInt))] = ((_in.value[((0 : GoInt))] : GoUInt64)) * ((((_in2.value[((7 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((1 : GoInt))] : GoUInt64)) * ((((_in2.value[((6 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((2 : GoInt))] : GoUInt64)) * ((((_in2.value[((5 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((3 : GoInt))] : GoUInt64)) * ((((_in2.value[((4 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((4 : GoInt))] : GoUInt64)) * ((((_in2.value[((3 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((5 : GoInt))] : GoUInt64)) * ((((_in2.value[((2 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((6 : GoInt))] : GoUInt64)) * ((((_in2.value[((1 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((7 : GoInt))] : GoUInt64)) * ((((_in2.value[((0 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))));
	_tmp[((8 : GoInt))] = ((_in.value[((0 : GoInt))] : GoUInt64)) * ((((_in2.value[((8 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((1 : GoInt))] : GoUInt64)) * ((((_in2.value[((7 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((2 : GoInt))] : GoUInt64)) * ((((_in2.value[((6 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((3 : GoInt))] : GoUInt64)) * ((((_in2.value[((5 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((4 : GoInt))] : GoUInt64)) * ((((_in2.value[((4 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((5 : GoInt))] : GoUInt64)) * ((((_in2.value[((3 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((6 : GoInt))] : GoUInt64)) * ((((_in2.value[((2 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((7 : GoInt))] : GoUInt64)) * ((((_in2.value[((1 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((8 : GoInt))] : GoUInt64)) * ((((_in2.value[((0 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))));
	_tmp[((9 : GoInt))] = ((_in.value[((1 : GoInt))] : GoUInt64)) * ((((_in2.value[((8 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((2 : GoInt))] : GoUInt64)) * ((((_in2.value[((7 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((3 : GoInt))] : GoUInt64)) * ((((_in2.value[((6 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((4 : GoInt))] : GoUInt64)) * ((((_in2.value[((5 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((5 : GoInt))] : GoUInt64)) * ((((_in2.value[((4 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((6 : GoInt))] : GoUInt64)) * ((((_in2.value[((3 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((7 : GoInt))] : GoUInt64)) * ((((_in2.value[((2 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((8 : GoInt))] : GoUInt64)) * ((((_in2.value[((1 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))));
	_tmp[((10 : GoInt))] = ((_in.value[((2 : GoInt))] : GoUInt64)) * ((((_in2.value[((8 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((3 : GoInt))] : GoUInt64)) * ((((_in2.value[((7 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((4 : GoInt))] : GoUInt64)) * ((((_in2.value[((6 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((5 : GoInt))] : GoUInt64)) * ((((_in2.value[((5 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((6 : GoInt))] : GoUInt64)) * ((((_in2.value[((4 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((7 : GoInt))] : GoUInt64)) * ((((_in2.value[((3 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((8 : GoInt))] : GoUInt64)) * ((((_in2.value[((2 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))));
	_tmp[((11 : GoInt))] = ((_in.value[((3 : GoInt))] : GoUInt64)) * ((((_in2.value[((8 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((4 : GoInt))] : GoUInt64)) * ((((_in2.value[((7 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((5 : GoInt))] : GoUInt64)) * ((((_in2.value[((6 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((6 : GoInt))] : GoUInt64)) * ((((_in2.value[((5 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((7 : GoInt))] : GoUInt64)) * ((((_in2.value[((4 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((8 : GoInt))] : GoUInt64)) * ((((_in2.value[((3 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))));
	_tmp[((12 : GoInt))] = ((_in.value[((4 : GoInt))] : GoUInt64)) * ((((_in2.value[((8 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((5 : GoInt))] : GoUInt64)) * ((((_in2.value[((7 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((6 : GoInt))] : GoUInt64)) * ((((_in2.value[((6 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((7 : GoInt))] : GoUInt64)) * ((((_in2.value[((5 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((8 : GoInt))] : GoUInt64)) * ((((_in2.value[((4 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))));
	_tmp[((13 : GoInt))] = ((_in.value[((5 : GoInt))] : GoUInt64)) * ((((_in2.value[((8 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((6 : GoInt))] : GoUInt64)) * ((((_in2.value[((7 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((7 : GoInt))] : GoUInt64)) * ((((_in2.value[((6 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((8 : GoInt))] : GoUInt64)) * ((((_in2.value[((5 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))));
	_tmp[((14 : GoInt))] = ((_in.value[((6 : GoInt))] : GoUInt64)) * ((((_in2.value[((8 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((7 : GoInt))] : GoUInt64)) * ((((_in2.value[((7 : GoInt))] : GoUInt64)) << ((1 : GoUnTypedInt))))
		+ ((_in.value[((8 : GoInt))] : GoUInt64)) * ((((_in2.value[((6 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))));
	_tmp[((15 : GoInt))] = ((_in.value[((7 : GoInt))] : GoUInt64)) * ((((_in2.value[((8 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))))
		+ ((_in.value[((8 : GoInt))] : GoUInt64)) * ((((_in2.value[((7 : GoInt))] : GoUInt64)) << ((0 : GoUnTypedInt))));
...
function _p256Invert(_out:Pointer<GoArray<GoUInt32>>, _in:Pointer<GoArray<GoUInt32>>):Void {
	var _ftmp:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]),
		_ftmp2:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]);
...
function _p256Scalar4(_out:Pointer<GoArray<GoUInt32>>):Void {
	var _carry:GoUInt32 = ((0 : GoUInt32)),
		_nextCarry:GoUInt32 = ((0 : GoUInt32));
	{
		var _i:GoInt = ((0 : GoInt));
		Go.cfor(true, _i++, {
...
**/
function _p256PointDouble(_xOut:Pointer<GoArray<GoUInt32>>, _yOut:Pointer<GoArray<GoUInt32>>, _zOut:Pointer<GoArray<GoUInt32>>, _x:Pointer<GoArray<GoUInt32>>,
		_y:Pointer<GoArray<GoUInt32>>, _z:Pointer<GoArray<GoUInt32>>):Void {
	var _delta:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]),
		...
		_beta:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]),
...
/**
	...
	// correctly.
**/
function _p256PointAddMixed(_xOut:Pointer<GoArray<GoUInt32>>, _yOut:Pointer<GoArray<GoUInt32>>, _zOut:Pointer<GoArray<GoUInt32>>,
		_x1:Pointer<GoArray<GoUInt32>>, _y1:Pointer<GoArray<GoUInt32>>, _z1:Pointer<GoArray<GoUInt32>>, _x2:Pointer<GoArray<GoUInt32>>,
		_y2:Pointer<GoArray<GoUInt32>>):Void {
	var _z1z1:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]),
		...
		_i:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]),
...
/**
	...
	// correctly.
**/
function _p256PointAdd(_xOut:Pointer<GoArray<GoUInt32>>, _yOut:Pointer<GoArray<GoUInt32>>, _zOut:Pointer<GoArray<GoUInt32>>, _x1:Pointer<GoArray<GoUInt32>>,
		_y1:Pointer<GoArray<GoUInt32>>, _z1:Pointer<GoArray<GoUInt32>>, _x2:Pointer<GoArray<GoUInt32>>, _y2:Pointer<GoArray<GoUInt32>>,
		_z2:Pointer<GoArray<GoUInt32>>):Void {
	var _z1z1:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]),
		_z1z1z1:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]),
...
/**
	...
	// On entry: index < 16, table[0] must be zero.
**/
function _p256SelectJacobianPoint(_xOut:Pointer<GoArray<GoUInt32>>, _yOut:Pointer<GoArray<GoUInt32>>, _zOut:Pointer<GoArray<GoUInt32>>,
		_table:Pointer<GoArray<GoArray<GoArray<GoUInt32>>>>, _index:GoUInt32):Void {
	for (_i => _ in _xOut.value) {
		_xOut.value[_i] = ((0 : GoUInt32));
	};
	for (_i => _ in _yOut.value) {
...
/**
	...
	// order of the group.
**/
function _p256ScalarBaseMult(_xOut:Pointer<GoArray<GoUInt32>>, _yOut:Pointer<GoArray<GoUInt32>>, _zOut:Pointer<GoArray<GoUInt32>>,
		_scalar:Pointer<GoArray<GoUInt8>>):Void {
	var _nIsInfinityMask:GoUInt32 = -1 ^ ((((0 : GoUInt32)) : GoUInt32));
	var _pIsNoninfiniteMask:GoUInt32 = ((0 : GoUInt32)),
		_mask:GoUInt32 = ((0 : GoUInt32)),
		_tableOffset:GoUInt32 = ((0 : GoUInt32));
	var _px:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]),
		_py:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]),
...
**/
function _p256PointToAffine(_xOut:Pointer<GoArray<GoUInt32>>, _yOut:Pointer<GoArray<GoUInt32>>, _x:Pointer<GoArray<GoUInt32>>, _y:Pointer<GoArray<GoUInt32>>,
		_z:Pointer<GoArray<GoUInt32>>):Void {
	var _zInv:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]),
		_zInvSq:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]);
...
/**
	...
	// of {x,y,z}.
**/
function _p256ToAffine(_x:Pointer<GoArray<GoUInt32>>, _y:Pointer<GoArray<GoUInt32>>,
		_z:Pointer<GoArray<GoUInt32>>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;} {
	var _xOut:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil(),
		_yOut:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil();
	var _xx:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]),
		_yy:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]);
...
**/
function _p256ScalarMult(_xOut:Pointer<GoArray<GoUInt32>>, _yOut:Pointer<GoArray<GoUInt32>>, _zOut:Pointer<GoArray<GoUInt32>>, _x:Pointer<GoArray<GoUInt32>>,
		_y:Pointer<GoArray<GoUInt32>>, _scalar:Pointer<GoArray<GoUInt8>>):Void {
	var _px:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]),
		_py:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]),
		...
		_ty:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]),
		_tz:GoArray<GoUInt32> = new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))]);
	var _precomp:GoArray<GoArray<GoArray<GoUInt32>>> = new GoArray<GoArray<GoArray<GoUInt32>>>(...[
		for (i in 0...16) new GoArray<GoArray<GoUInt32>>(...[for (i in 0...3) new GoArray<GoUInt32>(...[for (i in 0...9) ((0 : GoUInt32))])])
	]);
	var _nIsInfinityMask:GoUInt32 = ((0 : GoUInt32)),
		_index:GoUInt32 = ((0 : GoUInt32)),
		_pIsNoninfiniteMask:GoUInt32 = ((0 : GoUInt32)),
		_mask:GoUInt32 = ((0 : GoUInt32));
	...
	_precomp[((1 : GoInt))][((2 : GoInt))] = _p256One.copy();
	{
		...
		Go.cfor(_i < ((16 : GoInt)), _i = _i + (((2 : GoInt))), {
			_p256PointDouble(Go.pointer(_precomp[_i][((0 : GoInt))]), Go.pointer(_precomp[_i][((1 : GoInt))]), Go.pointer(_precomp[_i][((2 : GoInt))]),
				Go.pointer(_precomp[_i / ((2 : GoInt))][((0 : GoInt))]), Go.pointer(_precomp[_i / ((2 : GoInt))][((1 : GoInt))]),
				Go.pointer(_precomp[_i / ((2 : GoInt))][((2 : GoInt))]));
			_p256PointAddMixed(Go.pointer(_precomp[_i + ((1 : GoInt))][((0 : GoInt))]), Go.pointer(_precomp[_i + ((1 : GoInt))][((1 : GoInt))]),
				Go.pointer(_precomp[_i + ((1 : GoInt))][((2 : GoInt))]), Go.pointer(_precomp[_i][((0 : GoInt))]), Go.pointer(_precomp[_i][((1 : GoInt))]),
				Go.pointer(_precomp[_i][((2 : GoInt))]), _x, _y);
		});
	};
	for (_i => _ in _xOut.value) {
		_xOut.value[_i] = ((0 : GoUInt32));
...
function _p256ToBig(_in:Pointer<GoArray<GoUInt32>>):Pointer<stdgo.math.big.Big.Int_> {
	var _result:Pointer<stdgo.math.big.Big.Int_> = Go.pointer(new stdgo.math.big.Big.Int_()),
		_tmp:Pointer<stdgo.math.big.Big.Int_> = Go.pointer(new stdgo.math.big.Big.Int_());
...
function _initP521():Void {
	...
	{
		var __tmp__ = Go.pointer(new stdgo.math.big.Big.Int_())
			.value.setString("6864797660130609714981900799081393217269435300143305409394463459185543183397656052122559640661454554977296311391480858037121987999716643812574028291115057151",
				((10 : GoInt)));
		_p521.curveParams.value.p = __tmp__._0;
	};
	{
		var __tmp__ = Go.pointer(new stdgo.math.big.Big.Int_())
			.value.setString("6864797660130609714981900799081393217269435300143305409394463459185543183397655394245057746333217197532963996371363321113864768612440380340372808892707005449",
				((10 : GoInt)));
		_p521.curveParams.value.n = __tmp__._0;
	};
	{
		var __tmp__ = Go.pointer(new stdgo.math.big.Big.Int_())
			.value.setString("051953eb9618e1c9a1f929a21a0b68540eea2da725b99b315f3b8b489918ef109e156193951ec7e937b1652c0bd3bb1bf073573df883d2c34f1ef451fd46b503f00",
				((16 : GoInt)));
		_p521.curveParams.value.b = __tmp__._0;
	};
	{
		var __tmp__ = Go.pointer(new stdgo.math.big.Big.Int_())
			.value.setString("c6858e06b70404e9cd9e3ecb662395b4429c648139053fb521f828af606b4d3dbaa14b5e77efe75928fe1dc127a2ffa8de3348b3c1856a429bf97e7e31c2e5bd66",
				((16 : GoInt)));
		_p521.curveParams.value.gx = __tmp__._0;
	};
	{
		var __tmp__ = Go.pointer(new stdgo.math.big.Big.Int_())
			.value.setString("11839296a789a3bc0045c8a5fb42c7d1bd998f54449579b446817afbd17273e662c97ee72995ef42640c550b9013fad0761353c7086a272c24088be94769fd16650",
				((16 : GoInt)));
...
function _bigIntToFiatP521(_x:Pointer<stdgo.math.big.Big.Int_>):Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element> {
	var _xBytes:Slice<GoUInt8> = Go.pointer(new stdgo.math.big.Big.Int_())
		.value.mod(_x, _p521.curveParams.value.p)
		.value.fillBytes(new Slice<GoUInt8>(...[for (i in 0...((((66 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]));
	for (_i => _ in _xBytes.__slice__(0, _xBytes.length / ((2 : GoInt)))) {
		{
			final __tmp__0 = _xBytes[_xBytes.length - _i - ((1 : GoInt))];
			final __tmp__1 = _xBytes[_i];
	...
	var __tmp__ = Go.pointer(new crypto.elliptic.internal.fiat.Fiat.P521Element()).value.setBytes(_xBytes),
		_x1:Pointer<crypto.elliptic.internal.fiat.Fiat.P521Element> = __tmp__._0,
...
class CurveParams_extension_fields {
	public function params(__tmp__):Pointer<CurveParams>
		return __tmp__.params();

	public function _polynomial(__tmp__, _x:Pointer<stdgo.math.big.Big.Int_>):Pointer<stdgo.math.big.Big.Int_>
		return __tmp__._polynomial(_x);

	public function isOnCurve(__tmp__, _x:Pointer<stdgo.math.big.Big.Int_>, _y:Pointer<stdgo.math.big.Big.Int_>):Bool
		return __tmp__.isOnCurve(_x, _y);

	public function _affineFromJacobian(__tmp__, _x:Pointer<stdgo.math.big.Big.Int_>, _y:Pointer<stdgo.math.big.Big.Int_>,
			_z:Pointer<stdgo.math.big.Big.Int_>):{
		var _0:Pointer<stdgo.math.big.Big.Int_>;
		var _1:Pointer<stdgo.math.big.Big.Int_>;
	}
		return __tmp__._affineFromJacobian(_x, _y, _z);

	public function add(__tmp__, _x1:Pointer<stdgo.math.big.Big.Int_>, _y1:Pointer<stdgo.math.big.Big.Int_>, _x2:Pointer<stdgo.math.big.Big.Int_>,
			_y2:Pointer<stdgo.math.big.Big.Int_>):{
		var _0:Pointer<stdgo.math.big.Big.Int_>;
		var _1:Pointer<stdgo.math.big.Big.Int_>;
	}
		return __tmp__.add(_x1, _y1, _x2, _y2);

	public function _addJacobian(__tmp__, _x1:Pointer<stdgo.math.big.Big.Int_>, _y1:Pointer<stdgo.math.big.Big.Int_>, _z1:Pointer<stdgo.math.big.Big.Int_>,
			_x2:Pointer<stdgo.math.big.Big.Int_>, _y2:Pointer<stdgo.math.big.Big.Int_>, _z2:Pointer<stdgo.math.big.Big.Int_>):{
		var _0:Pointer<stdgo.math.big.Big.Int_>;
		var _1:Pointer<stdgo.math.big.Big.Int_>;
		var _2:Pointer<stdgo.math.big.Big.Int_>;
	}
		return __tmp__._addJacobian(_x1, _y1, _z1, _x2, _y2, _z2);

	public function double(__tmp__, _x1:Pointer<stdgo.math.big.Big.Int_>,
			_y1:Pointer<stdgo.math.big.Big.Int_>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;}
		return __tmp__.double(_x1, _y1);

	public function _doubleJacobian(__tmp__, _x:Pointer<stdgo.math.big.Big.Int_>, _y:Pointer<stdgo.math.big.Big.Int_>,
			_z:Pointer<stdgo.math.big.Big.Int_>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>; var _2:Pointer<stdgo.math.big.Big.Int_>;}
		return __tmp__._doubleJacobian(_x, _y, _z);

	public function scalarMult(__tmp__, bx:Pointer<stdgo.math.big.Big.Int_>, by:Pointer<stdgo.math.big.Big.Int_>,
			_k:Slice<GoByte>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;}
		return __tmp__.scalarMult(bx, by, _k);

	public function scalarBaseMult(__tmp__, _k:Slice<GoByte>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;}
		return __tmp__.scalarBaseMult(_k);
}
...
class T_p224Curve_extension_fields {
	...
	public function isOnCurve(__tmp__, _bigX:Pointer<stdgo.math.big.Big.Int_>, _bigY:Pointer<stdgo.math.big.Big.Int_>):Bool
		return __tmp__.isOnCurve(_bigX, _bigY);

	public function add(__tmp__, _bigX1:Pointer<stdgo.math.big.Big.Int_>, _bigY1:Pointer<stdgo.math.big.Big.Int_>, _bigX2:Pointer<stdgo.math.big.Big.Int_>,
			_bigY2:Pointer<stdgo.math.big.Big.Int_>):{
		var _0:Pointer<stdgo.math.big.Big.Int_>;
		var _1:Pointer<stdgo.math.big.Big.Int_>;
	}
		return __tmp__.add(_bigX1, _bigY1, _bigX2, _bigY2);

	public function double(__tmp__, _bigX1:Pointer<stdgo.math.big.Big.Int_>,
			_bigY1:Pointer<stdgo.math.big.Big.Int_>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;}
		return __tmp__.double(_bigX1, _bigY1);

	public function scalarMult(__tmp__, _bigX1:Pointer<stdgo.math.big.Big.Int_>, _bigY1:Pointer<stdgo.math.big.Big.Int_>,
			_scalar:Slice<GoByte>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;}
		return __tmp__.scalarMult(_bigX1, _bigY1, _scalar);

	public function scalarBaseMult(__tmp__, _scalar:Slice<GoByte>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;}
		return __tmp__.scalarBaseMult(_scalar);
}
...
class T_p256Curve_extension_fields {
	...
	public function scalarMult(__tmp__, _bigX:Pointer<stdgo.math.big.Big.Int_>, _bigY:Pointer<stdgo.math.big.Big.Int_>,
			_scalar:Slice<GoByte>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;}
		return __tmp__.scalarMult(_bigX, _bigY, _scalar);
}
...
class T_p521Curve_extension_fields {
	...
	public function _affineFromJacobian(__tmp__, _p:Pointer<T_p521Point>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;}
		return __tmp__._affineFromJacobian(_p);

	public function _jacobianFromAffine(__tmp__, _x:Pointer<stdgo.math.big.Big.Int_>, _y:Pointer<stdgo.math.big.Big.Int_>):Pointer<T_p521Point>
		return __tmp__._jacobianFromAffine(_x, _y);
	...
	public function scalarMult(__tmp__, bx:Pointer<stdgo.math.big.Big.Int_>, by:Pointer<stdgo.math.big.Big.Int_>,
			_scalar:Slice<GoByte>):{var _0:Pointer<stdgo.math.big.Big.Int_>; var _1:Pointer<stdgo.math.big.Big.Int_>;}
		return __tmp__.scalarMult(bx, by, _scalar);
...
class T_p521Point_extension_fields {
	public function _addJacobian(__tmp__, _p1:Pointer<T_p521Point>, _p2:Pointer<T_p521Point>):Pointer<T_p521Point>
		return __tmp__._addJacobian(_p1, _p2);

	public function _doubleJacobian(__tmp__, _p:Pointer<T_p521Point>):Pointer<T_p521Point>
		return __tmp__._doubleJacobian(_p);
}
