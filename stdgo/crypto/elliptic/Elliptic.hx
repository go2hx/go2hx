...
@:structInit @:using(Elliptic.T_p256Curve_static_extension) @:dox(hide) abstract T_p256Curve(stdgo._internal.crypto.elliptic.Elliptic_t_p256curve.T_p256Curve) from stdgo._internal.crypto.elliptic.Elliptic_t_p256curve.T_p256Curve to stdgo._internal.crypto.elliptic.Elliptic_t_p256curve.T_p256Curve {
...
@:structInit @:using(Elliptic.T_nistCurve_static_extension) @:dox(hide) abstract T_nistCurve(stdgo._internal.crypto.elliptic.Elliptic_t_nistcurve.T_nistCurve) from stdgo._internal.crypto.elliptic.Elliptic_t_nistcurve.T_nistCurve to stdgo._internal.crypto.elliptic.Elliptic_t_nistcurve.T_nistCurve {
...
@:structInit @:using(Elliptic.CurveParams_static_extension) abstract CurveParams(stdgo._internal.crypto.elliptic.Elliptic_curveparams.CurveParams) from stdgo._internal.crypto.elliptic.Elliptic_curveparams.CurveParams to stdgo._internal.crypto.elliptic.Elliptic_curveparams.CurveParams {
