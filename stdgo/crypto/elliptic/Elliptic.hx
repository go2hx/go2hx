...
@:dox(hide) typedef T_unmarshaler = stdgo._internal.crypto.elliptic.Elliptic_t_unmarshaler.T_unmarshaler;
...
@:dox(hide) typedef T_nistPoint = stdgo._internal.crypto.elliptic.Elliptic_t_nistpoint.T_nistPoint<T_>;
