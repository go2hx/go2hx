...
@:structInit class P521Element {
    public function invert(_t:Pointer<P521Element>):Pointer<P521Element> {
        ...
        var _t1:Pointer<P521Element> = Go.pointer(new P521Element()), _t2:Pointer<P521Element> = Go.pointer(new P521Element());
        _t1.value.square(_t);
    ...
    public function new(?_x:GoArray<GoUInt64>) stdgo.internal.Macro.initLocals();
...
@:named class T_p521Uint1 {
    ...
    public function __copy__() return new T_p521Uint1(__t__);
}
@:named class T_p521Int1 {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new T_p521Int1(__t__);
}
...
function _p521AddcarryxU64(_x:GoUInt64, _y:GoUInt64, _carry:T_p521Uint1):{ var _0 : GoUInt64; var _1 : T_p521Uint1; } {
        var __tmp__ = stdgo.math.bits.Bits.add64(_x, _y, _carry.__t__), _sum:GoUInt64 = __tmp__._0, _carryOut:GoUInt64 = __tmp__._1;
...
function _p521SubborrowxU64(_x:GoUInt64, _y:GoUInt64, _carry:T_p521Uint1):{ var _0 : GoUInt64; var _1 : T_p521Uint1; } {
        var __tmp__ = stdgo.math.bits.Bits.sub64(_x, _y, _carry.__t__), _sum:GoUInt64 = __tmp__._0, _carryOut:GoUInt64 = __tmp__._1;
        return { _0 : _sum, _1 : new T_p521Uint1(_carryOut) };
    }
/**
...
class P521Element_extension_fields {
    public function one(__tmp__):Pointer<P521Element> return __tmp__.one();
    public function equal(__tmp__, _t:Pointer<P521Element>):GoInt return __tmp__.equal(_t);
    public function isZero(__tmp__):GoInt return __tmp__.isZero();
    public function set(__tmp__, _t:Pointer<P521Element>):Pointer<P521Element> return __tmp__.set(_t);
    public function bytes(__tmp__):Slice<GoByte> return __tmp__.bytes();
    public function setBytes(__tmp__, _v:Slice<GoByte>):{ var _0 : Pointer<P521Element>; var _1 : Error; } return __tmp__.setBytes(_v);
    public function add(__tmp__, _t1:Pointer<P521Element>, _t2:Pointer<P521Element>):Pointer<P521Element> return __tmp__.add(_t1, _t2);
    public function sub(__tmp__, _t1:Pointer<P521Element>, _t2:Pointer<P521Element>):Pointer<P521Element> return __tmp__.sub(_t1, _t2);
    public function mul(__tmp__, _t1:Pointer<P521Element>, _t2:Pointer<P521Element>):Pointer<P521Element> return __tmp__.mul(_t1, _t2);
    public function square(__tmp__, _t:Pointer<P521Element>):Pointer<P521Element> return __tmp__.square(_t);
    public function select(__tmp__, _a:Pointer<P521Element>, _b:Pointer<P521Element>, _cond:GoInt):Pointer<P521Element> return __tmp__.select(_a, _b, _cond);
    public function invert(__tmp__, _t:Pointer<P521Element>):Pointer<P521Element> return __tmp__.invert(_t);
}
