...
@:structInit @:using(Hmac.T_hmac_static_extension) @:dox(hide) abstract T_hmac(stdgo._internal.crypto.hmac.Hmac_t_hmac.T_hmac) from stdgo._internal.crypto.hmac.Hmac_t_hmac.T_hmac to stdgo._internal.crypto.hmac.Hmac_t_hmac.T_hmac {
