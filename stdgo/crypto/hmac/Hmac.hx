...
@:structInit @:using(stdgo.crypto.hmac.Hmac.T_hmac_static_extension) abstract T_hmac(stdgo._internal.crypto.hmac.Hmac_T_hmac.T_hmac) from stdgo._internal.crypto.hmac.Hmac_T_hmac.T_hmac to stdgo._internal.crypto.hmac.Hmac_T_hmac.T_hmac {
    ...
    function set__opad(v:Array<std.UInt>):Array<std.UInt> {
        this._opad = ([for (i in v) i] : stdgo.Slice<stdgo.GoUInt8>);
        return v;
    }
    ...
    function set__ipad(v:Array<std.UInt>):Array<std.UInt> {
        this._ipad = ([for (i in v) i] : stdgo.Slice<stdgo.GoUInt8>);
        return v;
    }
    ...
    public function new(?_opad:Array<std.UInt>, ?_ipad:Array<std.UInt>, ?_outer:stdgo._internal.hash.Hash_Hash.Hash, ?_inner:stdgo._internal.hash.Hash_Hash.Hash, ?_marshaled:Bool) this = new stdgo._internal.crypto.hmac.Hmac_T_hmac.T_hmac(([for (i in _opad) i] : stdgo.Slice<stdgo.GoUInt8>), ([for (i in _ipad) i] : stdgo.Slice<stdgo.GoUInt8>), _outer, _inner, _marshaled);
...
class Hmac {
    ...
    **/
    static public function new_(_h:() -> stdgo._internal.hash.Hash_Hash.Hash, _key:Array<std.UInt>):stdgo._internal.hash.Hash_Hash.Hash {
        final _h = _h;
    ...
    **/
    static public function equal(_mac1:Array<std.UInt>, _mac2:Array<std.UInt>):Bool {
        final _mac1 = ([for (i in _mac1) i] : stdgo.Slice<stdgo.GoUInt8>);
        final _mac2 = ([for (i in _mac2) i] : stdgo.Slice<stdgo.GoUInt8>);
