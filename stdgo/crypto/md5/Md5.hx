...
@:structInit class T_digest {
    ...
    public function new(?_s:GoArray<GoUInt32>, ?_x:GoArray<GoUInt8>, ?_nx:GoInt, ?_len:GoUInt64) stdgo.internal.Macro.initLocals();
...
function _blockGeneric(_dig:Pointer<T_digest>, _p:Slice<GoByte>):Void {
        var _a:GoUInt32 = _dig.value._s[((0 : GoInt))], _b:GoUInt32 = _dig.value._s[((1 : GoInt))], _c:GoUInt32 = _dig.value._s[((2 : GoInt))], _d:GoUInt32 = _dig.value._s[((3 : GoInt))];
        {
