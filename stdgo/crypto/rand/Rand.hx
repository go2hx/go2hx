...
private var _jsCrypto:stdgo.syscall.js.Js.Value = stdgo.syscall.js.Js.global().get(("crypto" : GoString));
private var _uint8Array:stdgo.syscall.js.Js.Value = stdgo.syscall.js.Js.global().get(("Uint8Array" : GoString));
...
**/
@:structInit @:using(stdgo.crypto.rand.Rand.T_reader_static_extension) private class T_reader {
	public function new() {}
...
function testRead(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var __tmp__ = stdgo.io.Io.readFull(reader, _b),
		_n:GoInt = __tmp__._0,
	...
	var __tmp__ = stdgo.compress.flate.Flate.newWriter(Go.asInterface((_z : Ref<stdgo.bytes.Bytes.Buffer>)), (5 : GoInt)),
		_f:Ref<stdgo.compress.flate.Flate.Writer> = __tmp__._0,
		_0:Error = __tmp__._1;
	_f.write(_b);
	_f.close();
...
function testReadEmpty(_t:Ref<stdgo.testing.Testing.T>):Void {
	var __tmp__ = reader.read(new Slice<GoUInt8>((0 : GoInt).toBasic(), 0, ...[for (i in 0...(0 : GoInt).toBasic()) (0 : GoUInt8)])),
		_n:GoInt = __tmp__._0,
		_err:Error = __tmp__._1;
...
function prime(_rand:stdgo.io.Io.Reader, _bits:GoInt):{var _0:Ref<stdgo.math.big.Big.Int_>; var _1:Error;} {
	...
	var _bytes = new Slice<GoUInt8>(((_bits + (7 : GoInt)) / (8 : GoInt) : GoInt).toBasic(), 0, ...[
		for (i in 0...((_bits + (7 : GoInt)) / (8 : GoInt) : GoInt).toBasic()) (0 : GoUInt8)
	]);
...
function int_(_rand:stdgo.io.Io.Reader, _max:Ref<stdgo.math.big.Big.Int_>):{var _0:Ref<stdgo.math.big.Big.Int_>; var _1:Error;} {
	var _n:Ref<stdgo.math.big.Big.Int_> = (null : Ref<stdgo.math.big.Big.Int_>),
...
@:keep @:allow(stdgo.crypto.rand.Rand.T_reader_asInterface) class T_reader_static_extension {
	...
	static public function read(_r:Ref<T_reader>, _b:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
		var _a:stdgo.syscall.js.Js.Value = (_uint8Array.new_(Go.toInterface((_b.length))) == null ? null : _uint8Array.new_(Go.toInterface((_b.length)))
			.__copy__());
