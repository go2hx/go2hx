...
@:structInit class PKCS1v15DecryptOptions {
    ...
    public function new(?sessionKeyLen:GoInt) stdgo.internal.Macro.initLocals();
...
@:structInit class PSSOptions {
    ...
    public function new(?saltLength:GoInt, ?hash:stdgo.crypto.Crypto.Hash) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class PublicKey {
    ...
    public function new(?n:Pointer<stdgo.math.big.Big.Int_>, ?e:GoInt) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class OAEPOptions {
    ...
    public function new(?hash:stdgo.crypto.Crypto.Hash, ?label:Slice<GoUInt8>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class PrivateKey {
    public function precompute():Void {
        ...
        _priv.value.precomputed.qinv = Go.pointer(new stdgo.math.big.Big.Int_()).value.modInverse(_priv.value.primes[((1 : GoInt))], _priv.value.primes[((0 : GoInt))]);
        var _r:Pointer<stdgo.math.big.Big.Int_> = Go.pointer(new stdgo.math.big.Big.Int_()).value.mul(_priv.value.primes[((0 : GoInt))], _priv.value.primes[((1 : GoInt))]);
        _priv.value.precomputed.crtvalues = new Slice<CRTValue>(...[for (i in 0 ... ((_priv.value.primes.length - ((2 : GoInt)) : GoInt)).toBasic()) new CRTValue()]);
        {
    ...
    public function decrypt(_rand:stdgo.io.Io.Reader, _ciphertext:Slice<GoByte>, _opts:stdgo.crypto.Crypto.DecrypterOpts):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        var _priv = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _plaintext:Slice<GoByte> = new Slice<GoUInt8>().nil(), _err:Error = ((null : stdgo.Error));
        if (_opts == null) {
            return decryptPKCS1v15(_rand, _priv, _ciphertext);
        };
        if (Go.assertable(((_opts : Pointer<OAEPOptions>)))) {
            var _opts:Pointer<OAEPOptions> = _opts == null ? null : _opts.__underlying__() == null ? null : _opts == null ? null : _opts.__underlying__().value;
            ...
            var _opts:Pointer<PKCS1v15DecryptOptions> = _opts == null ? null : _opts.__underlying__() == null ? null : _opts == null ? null : _opts.__underlying__().value;
            {
                var _l:GoInt = _opts.value.sessionKeyLen;
                if (_l > ((0 : GoInt))) {
                    _plaintext = new Slice<GoUInt8>(...[for (i in 0 ... ((_l : GoInt)).toBasic()) ((0 : GoUInt8))]);
                    {
                        var __tmp__ = stdgo.io.Io.readFull(_rand, _plaintext), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                        if (_err != null) {
    ...
    public function equal(_x:stdgo.crypto.Crypto.PrivateKey):Bool {
        ...
        if (!_priv.value.publicKey.equal(Go.toInterface(Go.pointer(_xx.value.publicKey))) || _priv.value.d.value.cmp(_xx.value.d) != ((0 : GoInt))) {
            return false;
        };
    ...
    public function new(?publicKey:PublicKey, ?d:Pointer<stdgo.math.big.Big.Int_>, ?primes:Slice<Pointer<stdgo.math.big.Big.Int_>>, ?precomputed:PrecomputedValues) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class PrecomputedValues {
    ...
    public function new(?dp:Pointer<stdgo.math.big.Big.Int_>, ?dq:Pointer<stdgo.math.big.Big.Int_>, ?qinv:Pointer<stdgo.math.big.Big.Int_>, ?crtvalues:Slice<CRTValue>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class CRTValue {
    ...
    public function new(?exp:Pointer<stdgo.math.big.Big.Int_>, ?coeff:Pointer<stdgo.math.big.Big.Int_>, ?r:Pointer<stdgo.math.big.Big.Int_>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
((0 : GoUInt8)),
((4 : GoUInt8)),
((16 : GoUInt8))) }, { key : stdgo.crypto.Crypto.sha1, value : new Slice<GoUInt8>(
((48 : GoUInt8)),
((33 : GoUInt8)),
((48 : GoUInt8)),
((9 : GoUInt8)),
...
((0 : GoUInt8)),
((4 : GoUInt8)),
((20 : GoUInt8))) }, { key : stdgo.crypto.Crypto.sha224, value : new Slice<GoUInt8>(
((48 : GoUInt8)),
((45 : GoUInt8)),
((48 : GoUInt8)),
((13 : GoUInt8)),
...
((0 : GoUInt8)),
((4 : GoUInt8)),
((28 : GoUInt8))) }, { key : stdgo.crypto.Crypto.sha256, value : new Slice<GoUInt8>(
((48 : GoUInt8)),
((49 : GoUInt8)),
((48 : GoUInt8)),
((13 : GoUInt8)),
...
((0 : GoUInt8)),
((4 : GoUInt8)),
((32 : GoUInt8))) }, { key : stdgo.crypto.Crypto.sha384, value : new Slice<GoUInt8>(
((48 : GoUInt8)),
((65 : GoUInt8)),
((48 : GoUInt8)),
((13 : GoUInt8)),
...
((0 : GoUInt8)),
((4 : GoUInt8)),
((48 : GoUInt8))) }, { key : stdgo.crypto.Crypto.sha512, value : new Slice<GoUInt8>(
((48 : GoUInt8)),
((81 : GoUInt8)),
((48 : GoUInt8)),
((13 : GoUInt8)),
...
((0 : GoUInt8)),
((4 : GoUInt8)),
((64 : GoUInt8))) }, { key : stdgo.crypto.Crypto.md5sha1, value : new Slice<GoUInt8>() }, { key : stdgo.crypto.Crypto.ripemd160, value : new Slice<GoUInt8>(
((48 : GoUInt8)),
((32 : GoUInt8)),
((48 : GoUInt8)),
((8 : GoUInt8)),
...
function encryptPKCS1v15(_rand:stdgo.io.Io.Reader, _pub:Pointer<PublicKey>, _msg:Slice<GoByte>):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        ...
        var _ps:Slice<GoUInt8> = _em.__slice__(((2 : GoInt)), _em.length - _msg.length - ((1 : GoInt))), _mm:Slice<GoUInt8> = _em.__slice__(_em.length - _msg.length);
...
**/
function _decryptPKCS1v15(_rand:stdgo.io.Io.Reader, _priv:Pointer<PrivateKey>, _ciphertext:Slice<GoByte>):{ var _0 : GoInt; var _1 : Slice<GoByte>; var _2 : GoInt; var _3 : Error; } {
        var _valid:GoInt = ((0 : GoInt)), _em:Slice<GoByte> = new Slice<GoUInt8>().nil(), _index:GoInt = ((0 : GoInt)), _err:Error = ((null : stdgo.Error));
        var _k:GoInt = _priv.value.size();
        if (_k < ((11 : GoInt))) {
            _err = errDecryption;
        ...
        var __tmp__ = _decrypt(_rand, _priv, _c), _m:Pointer<stdgo.math.big.Big.Int_> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : _valid, _1 : _em, _2 : _index, _3 : _err };
        };
...
**/
function signPKCS1v15(_rand:stdgo.io.Io.Reader, _priv:Pointer<PrivateKey>, _hash:stdgo.crypto.Crypto.Hash, _hashed:Slice<GoByte>):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        var __tmp__ = _pkcs1v15HashInfo(_hash, _hashed.length), _hashLen:GoInt = __tmp__._0, _prefix:Slice<GoUInt8> = __tmp__._1, _err:stdgo.Error = __tmp__._2;
        if (_err != null) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        };
        ...
        var _m:Pointer<stdgo.math.big.Big.Int_> = Go.pointer(new stdgo.math.big.Big.Int_()).value.setBytes(_em);
        var __tmp__ = _decryptAndCheck(_rand, _priv, _m), _c:Pointer<stdgo.math.big.Big.Int_> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        };
        return { _0 : _c.value.fillBytes(_em), _1 : ((null : stdgo.Error)) };
...
function _pkcs1v15HashInfo(_hash:stdgo.crypto.Crypto.Hash, _inLen:GoInt):{ var _0 : GoInt; var _1 : Slice<GoByte>; var _2 : Error; } {
        var _hashLen:GoInt = ((0 : GoInt)), _prefix:Slice<GoByte> = new Slice<GoUInt8>().nil(), _err:Error = ((null : stdgo.Error));
        ...
        var __tmp__ = _hashPrefixes.exists(_hash) ? { value : _hashPrefixes[_hash], ok : true } : { value : _hashPrefixes.defaultValue(), ok : false }, _prefix:Slice<GoUInt8> = __tmp__.value, _ok:Bool = __tmp__.ok;
        if (!_ok) {
...
**/
function _signPSSWithSalt(_rand:stdgo.io.Io.Reader, _priv:Pointer<PrivateKey>, _hash:stdgo.crypto.Crypto.Hash, _hashed:Slice<GoByte>, _salt:Slice<GoByte>):{ var _0 : Slice<GoByte>; var _1 : Error; } {
...
function signPSS(_rand:stdgo.io.Io.Reader, _priv:Pointer<PrivateKey>, _hash:stdgo.crypto.Crypto.Hash, _digest:Slice<GoByte>, _opts:Pointer<PSSOptions>):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        ...
        {
            var __tmp__ = stdgo.io.Io.readFull(_rand, _salt), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
            };
        };
...
function generateMultiPrimeKey(_random:stdgo.io.Io.Reader, _nprimes:GoInt, _bits:GoInt):{ var _0 : Pointer<PrivateKey>; var _1 : Error; } {
        return stdgo.internal.Macro.controlFlow({
            ...
            var _primes:Slice<Pointer<stdgo.math.big.Big.Int_>> = new Slice<Pointer<stdgo.math.big.Big.Int_>>(...[for (i in 0 ... ((_nprimes : GoInt)).toBasic()) new Pointer<stdgo.math.big.Big.Int_>().nil()]);
...
**/
function encryptOAEP(_hash:stdgo.hash.Hash.Hash, _random:stdgo.io.Io.Reader, _pub:Pointer<PublicKey>, _msg:Slice<GoByte>, _label:Slice<GoByte>):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        {
            var _err:stdgo.Error = _checkPub(_pub);
            if (_err != null) {
                return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        ...
        var __tmp__ = stdgo.io.Io.readFull(_random, _seed), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        };
...
**/
function _decrypt(_random:stdgo.io.Io.Reader, _priv:Pointer<PrivateKey>, _c:Pointer<stdgo.math.big.Big.Int_>):{ var _0 : Pointer<stdgo.math.big.Big.Int_>; var _1 : Error; } {
        var _m:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil(), _err:Error = ((null : stdgo.Error));
        ...
        if (_priv.value.precomputed.dp == null || _priv.value.precomputed.dp.isNil()) {
            ...
            var _m2:Pointer<stdgo.math.big.Big.Int_> = Go.pointer(new stdgo.math.big.Big.Int_()).value.exp(_c, _priv.value.precomputed.dq, _priv.value.primes[((1 : GoInt))]);
            _m.value.sub(_m, _m2);
...
function _decryptAndCheck(_random:stdgo.io.Io.Reader, _priv:Pointer<PrivateKey>, _c:Pointer<stdgo.math.big.Big.Int_>):{ var _0 : Pointer<stdgo.math.big.Big.Int_>; var _1 : Error; } {
        var _m:Pointer<stdgo.math.big.Big.Int_> = new Pointer<stdgo.math.big.Big.Int_>().nil(), _err:Error = ((null : stdgo.Error));
        {
...
**/
function decryptOAEP(_hash:stdgo.hash.Hash.Hash, _random:stdgo.io.Io.Reader, _priv:Pointer<PrivateKey>, _ciphertext:Slice<GoByte>, _label:Slice<GoByte>):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        {
            var _err:stdgo.Error = _checkPub(Go.pointer(_priv.value.publicKey));
            if (_err != null) {
                return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        ...
        var _c:Pointer<stdgo.math.big.Big.Int_> = Go.pointer(new stdgo.math.big.Big.Int_()).value.setBytes(_ciphertext);
        var __tmp__ = _decrypt(_random, _priv, _c), _m:Pointer<stdgo.math.big.Big.Int_> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        };
        _hash.write(_label);
...
class PSSOptions_extension_fields {
    public function hashFunc(__tmp__):stdgo.crypto.Crypto.Hash return __tmp__.hashFunc();
    public function _saltLength(__tmp__):GoInt return __tmp__._saltLength();
}
...
class PrivateKey_extension_fields {
    ...
    public function decrypt(__tmp__, _rand:stdgo.io.Io.Reader, _ciphertext:Slice<GoByte>, _opts:stdgo.crypto.Crypto.DecrypterOpts):{ var _0 : Slice<GoByte>; var _1 : Error; } return __tmp__.decrypt(_rand, _ciphertext, _opts);
    public function validate(__tmp__):Error return __tmp__.validate();
    public function precompute(__tmp__):Void __tmp__.precompute();
}
