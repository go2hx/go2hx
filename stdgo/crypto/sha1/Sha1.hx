...
function _blockGeneric(_dig:Pointer<T_digest>, _p:Slice<GoByte>):Void {
	...
	var _h0:GoUInt32 = _dig.value._h[((0 : GoInt))],
		_h1:GoUInt32 = _dig.value._h[((1 : GoInt))],
		_h2:GoUInt32 = _dig.value._h[((2 : GoInt))],
		_h3:GoUInt32 = _dig.value._h[((3 : GoInt))],
		_h4:GoUInt32 = _dig.value._h[((4 : GoInt))];
	while (_p.length >= _chunk) {
		{
			var _i:GoInt = ((0 : GoInt));
			Go.cfor(_i < ((16 : GoInt)), _i++, {
				var _j:GoInt = _i * ((4 : GoInt));
				_w[_i] = (((_p[_j] : GoUInt32)) << ((24 : GoUnTypedInt))) | (((_p[_j + ((1 : GoInt))] : GoUInt32)) << ((16 : GoUnTypedInt))) | (((_p[_j
					+ ((2 : GoInt))] : GoUInt32)) << ((8 : GoUnTypedInt))) | ((_p[_j + ((3 : GoInt))] : GoUInt32));
			});
		};
		var _a:GoUInt32 = _h0,
			_b:GoUInt32 = _h1,
...
class T_digest_extension_fields {
	...
	public function constantTimeSum(__tmp__, _in:Slice<GoByte>):Slice<GoByte>
		return __tmp__.constantTimeSum(_in);

	public function _constSum(__tmp__):GoArray<GoByte>
		return __tmp__._constSum();
}
