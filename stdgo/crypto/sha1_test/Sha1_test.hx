...
function exampleNew():Void {
        ...
        stdgo.fmt.Fmt.printf(("% x" : stdgo.GoString), stdgo.Go.toInterface(_h.sum((null : stdgo.Slice<stdgo.GoUInt8>))));
    }
...
function exampleNew_file():Void {
        ...
        try {
            var __tmp__ = stdgo.os.Os.open(("file.txt" : stdgo.GoString)), _f:stdgo.Ref<stdgo.os.Os.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
            ...
            var _h:stdgo.hash.Hash.Hash = stdgo.crypto.sha1.Sha1.new_();
            {
                var __tmp__ = stdgo.io.Io.copy(_h, stdgo.Go.asInterface(_f)), __0:stdgo.GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
                };
            };
