...
@:structInit class T_digest {
	...
	public function unmarshalBinary(_b:Slice<GoByte>):Error {
		var _d = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		if (_b.length < _magic224.length
			|| (_d.value._is224 && ((_b.__slice__(0, _magic224.length) : GoString)) != _magic224)
			|| (!_d.value._is224 && ((_b.__slice__(0, _magic256.length) : GoString)) != _magic256)) {
...
var __K:Slice<GoUInt32> = new Slice<GoUInt32>(((1116352408 : GoUInt32)), ((1899447441 : GoUInt32)), (("3049323471" : GoUInt32)), (("3921009573" : GoUInt32)),
	((961987163 : GoUInt32)), ((1508970993 : GoUInt32)), (("2453635748" : GoUInt32)), (("2870763221" : GoUInt32)), (("3624381080" : GoUInt32)),
	((310598401 : GoUInt32)), ((607225278 : GoUInt32)), ((1426881987 : GoUInt32)), ((1925078388 : GoUInt32)), (("2162078206" : GoUInt32)),
	(("2614888103" : GoUInt32)), (("3248222580" : GoUInt32)), (("3835390401" : GoUInt32)), (("4022224774" : GoUInt32)), ((264347078 : GoUInt32)),
	((604807628 : GoUInt32)), ((770255983 : GoUInt32)), ((1249150122 : GoUInt32)), ((1555081692 : GoUInt32)), ((1996064986 : GoUInt32)),
	(("2554220882" : GoUInt32)), (("2821834349" : GoUInt32)), (("2952996808" : GoUInt32)), (("3210313671" : GoUInt32)), (("3336571891" : GoUInt32)),
	(("3584528711" : GoUInt32)), ((113926993 : GoUInt32)), ((338241895 : GoUInt32)), ((666307205 : GoUInt32)), ((773529912 : GoUInt32)),
	((1294757372 : GoUInt32)), ((1396182291 : GoUInt32)), ((1695183700 : GoUInt32)), ((1986661051 : GoUInt32)), (("2177026350" : GoUInt32)),
	(("2456956037" : GoUInt32)), (("2730485921" : GoUInt32)), (("2820302411" : GoUInt32)), (("3259730800" : GoUInt32)), (("3345764771" : GoUInt32)),
	(("3516065817" : GoUInt32)), (("3600352804" : GoUInt32)), (("4094571909" : GoUInt32)), ((275423344 : GoUInt32)), ((430227734 : GoUInt32)),
	((506948616 : GoUInt32)), ((659060556 : GoUInt32)), ((883997877 : GoUInt32)), ((958139571 : GoUInt32)), ((1322822218 : GoUInt32)),
	((1537002063 : GoUInt32)), ((1747873779 : GoUInt32)), ((1955562222 : GoUInt32)), ((2024104815 : GoUInt32)), (("2227730452" : GoUInt32)),
	(("2361852424" : GoUInt32)), (("2428436474" : GoUInt32)), (("2756734187" : GoUInt32)), (("3204031479" : GoUInt32)), (("3329325298" : GoUInt32)));
...
function _blockGeneric(_dig:Pointer<T_digest>, _p:Slice<GoByte>):Void {
	...
	var _h0:GoUInt32 = _dig.value._h[((0 : GoInt))],
		...
		_h5:GoUInt32 = _dig.value._h[((5 : GoInt))],
		_h6:GoUInt32 = _dig.value._h[((6 : GoInt))],
		_h7:GoUInt32 = _dig.value._h[((7 : GoInt))];
	while (_p.length >= _chunk) {
		...
		};
		{
			...
			Go.cfor(_i < ((64 : GoInt)), _i++, {
				...
				var _t1:GoUInt32 = (stdgo.math.bits.Bits.rotateLeft32(_v1,
					-((17 : GoUnTypedInt)))) ^ (stdgo.math.bits.Bits.rotateLeft32(_v1, -((19 : GoUnTypedInt)))) ^ ((_v1 >> ((10 : GoUnTypedInt))));
				var _v2:GoUInt32 = _w[_i - ((15 : GoInt))];
				var _t2:GoUInt32 = (stdgo.math.bits.Bits.rotateLeft32(_v2,
					-((7 : GoUnTypedInt)))) ^ (stdgo.math.bits.Bits.rotateLeft32(_v2, -((18 : GoUnTypedInt)))) ^ ((_v2 >> ((3 : GoUnTypedInt))));
			...
			_h:GoUInt32 = _h7;
		{
			...
			Go.cfor(_i < ((64 : GoInt)), _i++, {
				var _t1:GoUInt32 = _h
					+ ((stdgo.math.bits.Bits.rotateLeft32(_e,
						-((6 : GoUnTypedInt)))) ^ (stdgo.math.bits.Bits.rotateLeft32(_e,
							-((11 : GoUnTypedInt)))) ^ (stdgo.math.bits.Bits.rotateLeft32(_e, -((25 : GoUnTypedInt)))))
					+ ((_e & _f) ^ (-1 ^ _e & _g))
					+ __K[_i]
					+ _w[_i];
				var _t2:GoUInt32 = ((stdgo.math.bits.Bits.rotateLeft32(_a,
					-((2 : GoUnTypedInt)))) ^ (stdgo.math.bits.Bits.rotateLeft32(_a,
						-((13 : GoUnTypedInt)))) ^ (stdgo.math.bits.Bits.rotateLeft32(_a, -((22 : GoUnTypedInt)))))
					+ ((_a & _b) ^ (_a & _c) ^ (_b & _c));
				_h = _g;
				_g = _f;
				_f = _e;
