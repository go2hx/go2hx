...
@:structInit class T_digest {
	...
	public function unmarshalBinary(_b:Slice<GoByte>):Error {
		...
		if (_d.value._function.__t__ == stdgo.crypto.Crypto.sha384.__t__
			&& ((_b.__slice__(0,
				_magic384.length) : GoString)) == _magic384) {} else if (_d.value._function.__t__ == stdgo.crypto.Crypto.sha512_224.__t__
			&& ((_b.__slice__(0,
				_magic512_224.length) : GoString)) == _magic512_224) {} else if (_d.value._function.__t__ == stdgo.crypto.Crypto.sha512_256.__t__
			&& ((_b.__slice__(0,
				_magic512_256.length) : GoString)) == _magic512_256) {} else if (_d.value._function.__t__ == stdgo.crypto.Crypto.sha512.__t__
			&& ((_b.__slice__(0, _magic512.length) : GoString)) == _magic512) {} else {
			return stdgo.errors.Errors.new_("crypto/sha512: invalid hash state identifier");
		};
...
var __K:Slice<GoUInt64> = new Slice<GoUInt64>((("4794697086780616226" : GoUInt64)), (("8158064640168781261" : GoUInt64)),
	(("13096744586834688815" : GoUInt64)), (("16840607885511220156" : GoUInt64)), (("4131703408338449720" : GoUInt64)), (("6480981068601479193" : GoUInt64)),
	(("10538285296894168987" : GoUInt64)), (("12329834152419229976" : GoUInt64)), (("15566598209576043074" : GoUInt64)), (("1334009975649890238" : GoUInt64)),
	(("2608012711638119052" : GoUInt64)), (("6128411473006802146" : GoUInt64)), (("8268148722764581231" : GoUInt64)), (("9286055187155687089" : GoUInt64)),
	(("11230858885718282805" : GoUInt64)), (("13951009754708518548" : GoUInt64)), (("16472876342353939154" : GoUInt64)),
	(("17275323862435702243" : GoUInt64)), (("1135362057144423861" : GoUInt64)), (("2597628984639134821" : GoUInt64)), (("3308224258029322869" : GoUInt64)),
	(("5365058923640841347" : GoUInt64)), (("6679025012923562964" : GoUInt64)), (("8573033837759648693" : GoUInt64)), (("10970295158949994411" : GoUInt64)),
	(("12119686244451234320" : GoUInt64)), (("12683024718118986047" : GoUInt64)), (("13788192230050041572" : GoUInt64)),
	(("14330467153632333762" : GoUInt64)), (("15395433587784984357" : GoUInt64)), (("489312712824947311" : GoUInt64)), (("1452737877330783856" : GoUInt64)),
	(("2861767655752347644" : GoUInt64)), (("3322285676063803686" : GoUInt64)), (("5560940570517711597" : GoUInt64)), (("5996557281743188959" : GoUInt64)),
	(("7280758554555802590" : GoUInt64)), (("8532644243296465576" : GoUInt64)), (("9350256976987008742" : GoUInt64)), (("10552545826968843579" : GoUInt64)),
	(("11727347734174303076" : GoUInt64)), (("12113106623233404929" : GoUInt64)), (("14000437183269869457" : GoUInt64)),
	(("14369950271660146224" : GoUInt64)), (("15101387698204529176" : GoUInt64)), (("15463397548674623760" : GoUInt64)),
	(("17586052441742319658" : GoUInt64)), (("1182934255886127544" : GoUInt64)), (("1847814050463011016" : GoUInt64)), (("2177327727835720531" : GoUInt64)),
	(("2830643537854262169" : GoUInt64)), (("3796741975233480872" : GoUInt64)), (("4115178125766777443" : GoUInt64)), (("5681478168544905931" : GoUInt64)),
	(("6601373596472566643" : GoUInt64)), (("7507060721942968483" : GoUInt64)), (("8399075790359081724" : GoUInt64)), (("8693463985226723168" : GoUInt64)),
	(("9568029438360202098" : GoUInt64)), (("10144078919501101548" : GoUInt64)), (("10430055236837252648" : GoUInt64)), (("11840083180663258601" : GoUInt64)),
	(("13761210420658862357" : GoUInt64)), (("14299343276471374635" : GoUInt64)), (("14566680578165727644" : GoUInt64)),
	(("15097957966210449927" : GoUInt64)), (("16922976911328602910" : GoUInt64)), (("17689382322260857208" : GoUInt64)), (("500013540394364858" : GoUInt64)),
	(("748580250866718886" : GoUInt64)), (("1242879168328830382" : GoUInt64)), (("1977374033974150939" : GoUInt64)), (("2944078676154940804" : GoUInt64)),
	(("3659926193048069267" : GoUInt64)), (("4368137639120453308" : GoUInt64)), (("4836135668995329356" : GoUInt64)), (("5532061633213252278" : GoUInt64)),
	(("6448918945643986474" : GoUInt64)), (("6902733635092675308" : GoUInt64)), (("7801388544844847127" : GoUInt64)));
...
function new_():stdgo.hash.Hash.Hash {
	var _d:Pointer<T_digest> = Go.pointer((({
		_function: stdgo.crypto.Crypto.sha512,
		_h: new GoArray<GoUInt64>(...[for (i in 0...8) ((0 : GoUInt64))]),
		_x: new GoArray<GoUInt8>(...[for (i in 0...128) ((0 : GoUInt8))]),
		_nx: 0,
		_len: 0
	} : T_digest)));
	_d.value.reset();
...
function new512_224():stdgo.hash.Hash.Hash {
	var _d:Pointer<T_digest> = Go.pointer((({
		_function: stdgo.crypto.Crypto.sha512_224,
		_h: new GoArray<GoUInt64>(...[for (i in 0...8) ((0 : GoUInt64))]),
		_x: new GoArray<GoUInt8>(...[for (i in 0...128) ((0 : GoUInt8))]),
		_nx: 0,
		_len: 0
...
function new512_256():stdgo.hash.Hash.Hash {
	var _d:Pointer<T_digest> = Go.pointer((({
		_function: stdgo.crypto.Crypto.sha512_256,
		_h: new GoArray<GoUInt64>(...[for (i in 0...8) ((0 : GoUInt64))]),
		_x: new GoArray<GoUInt8>(...[for (i in 0...128) ((0 : GoUInt8))]),
		_nx: 0,
		_len: 0
...
function new384():stdgo.hash.Hash.Hash {
	var _d:Pointer<T_digest> = Go.pointer((({
		_function: stdgo.crypto.Crypto.sha384,
		_h: new GoArray<GoUInt64>(...[for (i in 0...8) ((0 : GoUInt64))]),
		_x: new GoArray<GoUInt8>(...[for (i in 0...128) ((0 : GoUInt8))]),
		_nx: 0,
		_len: 0
...
function _blockGeneric(_dig:Pointer<T_digest>, _p:Slice<GoByte>):Void {
	...
	var _h0:GoUInt64 = _dig.value._h[((0 : GoInt))],
		_h1:GoUInt64 = _dig.value._h[((1 : GoInt))],
		_h2:GoUInt64 = _dig.value._h[((2 : GoInt))],
		_h3:GoUInt64 = _dig.value._h[((3 : GoInt))],
		_h4:GoUInt64 = _dig.value._h[((4 : GoInt))],
		_h5:GoUInt64 = _dig.value._h[((5 : GoInt))],
		_h6:GoUInt64 = _dig.value._h[((6 : GoInt))],
		_h7:GoUInt64 = _dig.value._h[((7 : GoInt))];
	while (_p.length >= _chunk) {
		{
			var _i:GoInt = ((0 : GoInt));
			Go.cfor(_i < ((16 : GoInt)), _i++, {
				var _j:GoInt = _i * ((8 : GoInt));
				_w[_i] = (((_p[_j] : GoUInt64)) << ((56 : GoUnTypedInt))) | (((_p[_j + ((1 : GoInt))] : GoUInt64)) << ((48 : GoUnTypedInt))) | (((_p[_j
					+ ((2 : GoInt))] : GoUInt64)) << ((40 : GoUnTypedInt))) | (((_p[_j + ((3 : GoInt))] : GoUInt64)) << ((32 : GoUnTypedInt))) | (((_p[_j
						+ ((4 : GoInt))] : GoUInt64)) << ((24 : GoUnTypedInt))) | (((_p[_j + ((5 : GoInt))] : GoUInt64)) << ((16 : GoUnTypedInt))) | (((_p[_j
							+ ((6 : GoInt))] : GoUInt64)) << ((8 : GoUnTypedInt))) | ((_p[_j + ((7 : GoInt))] : GoUInt64));
			});
		};
		{
			...
			Go.cfor(_i < ((80 : GoInt)), _i++, {
				...
				var _t1:GoUInt64 = stdgo.math.bits.Bits.rotateLeft64(_v1,
					-((19 : GoUnTypedInt))) ^ stdgo.math.bits.Bits.rotateLeft64(_v1, -((61 : GoUnTypedInt))) ^ ((_v1 >> ((6 : GoUnTypedInt))));
				var _v2:GoUInt64 = _w[_i - ((15 : GoInt))];
				var _t2:GoUInt64 = stdgo.math.bits.Bits.rotateLeft64(_v2,
					-((1 : GoUnTypedInt))) ^ stdgo.math.bits.Bits.rotateLeft64(_v2, -((8 : GoUnTypedInt))) ^ ((_v2 >> ((7 : GoUnTypedInt))));
			...
			_h:GoUInt64 = _h7;
		{
			...
			Go.cfor(_i < ((80 : GoInt)), _i++, {
				var _t1:GoUInt64 = _h
					+ (stdgo.math.bits.Bits.rotateLeft64(_e,
						-((14 : GoUnTypedInt))) ^ stdgo.math.bits.Bits.rotateLeft64(_e,
							-((18 : GoUnTypedInt))) ^ stdgo.math.bits.Bits.rotateLeft64(_e, -((41 : GoUnTypedInt))))
					+ ((_e & _f) ^ (-1 ^ _e & _g))
					+ __K[_i]
					+ _w[_i];
				var _t2:GoUInt64 = (stdgo.math.bits.Bits.rotateLeft64(_a,
					-((28 : GoUnTypedInt))) ^ stdgo.math.bits.Bits.rotateLeft64(_a,
						-((34 : GoUnTypedInt))) ^ stdgo.math.bits.Bits.rotateLeft64(_a, -((39 : GoUnTypedInt))))
					+ ((_a & _b) ^ (_a & _c) ^ (_b & _c));
				_h = _g;
				_g = _f;
				_f = _e;
