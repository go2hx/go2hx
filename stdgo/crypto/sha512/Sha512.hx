...
@:structInit @:using(stdgo.crypto.sha512.Sha512.T_digest_static_extension) abstract T_digest(stdgo._internal.crypto.sha512.Sha512_T_digest.T_digest) from stdgo._internal.crypto.sha512.Sha512_T_digest.T_digest to stdgo._internal.crypto.sha512.Sha512_T_digest.T_digest {
    ...
    function set__h(v:haxe.ds.Vector<haxe.UInt64>):haxe.ds.Vector<haxe.UInt64> {
        this._h = ([for (i in v) i] : stdgo.GoArray<stdgo.GoUInt64>);
        return v;
    }
    ...
    public function new(?_h:haxe.ds.Vector<haxe.UInt64>, ?_x:haxe.ds.Vector<std.UInt>, ?_nx:StdTypes.Int, ?_len:haxe.UInt64, ?_function:stdgo._internal.crypto.Crypto_Hash.Hash) this = new stdgo._internal.crypto.sha512.Sha512_T_digest.T_digest(([for (i in _h) i] : stdgo.GoArray<stdgo.GoUInt64>), ([for (i in _x) i] : stdgo.GoArray<stdgo.GoUInt8>), _nx, _len, _function);
...
class Sha512 {
    ...
    **/
    static public function new512_224():stdgo._internal.hash.Hash_Hash.Hash {
        return stdgo._internal.crypto.sha512.Sha512_new512_224.new512_224();
    }
    /**
        New512_256 returns a new hash.Hash computing the SHA-512/256 checksum.
    **/
    static public function new512_256():stdgo._internal.hash.Hash_Hash.Hash {
        return stdgo._internal.crypto.sha512.Sha512_new512_256.new512_256();
    }
    /**
        New384 returns a new hash.Hash computing the SHA-384 checksum.
    **/
    static public function new384():stdgo._internal.hash.Hash_Hash.Hash {
        return stdgo._internal.crypto.sha512.Sha512_new384.new384();
    }
    /**
        Sum512 returns the SHA512 checksum of the data.
    **/
    static public function sum512(_data:Array<std.UInt>):haxe.ds.Vector<std.UInt> {
    ...
    **/
    static public function sum384(_data:Array<std.UInt>):haxe.ds.Vector<std.UInt> {
        final _data = ([for (i in _data) i] : stdgo.Slice<stdgo.GoUInt8>);
    ...
    **/
    static public function sum512_224(_data:Array<std.UInt>):haxe.ds.Vector<std.UInt> {
        final _data = ([for (i in _data) i] : stdgo.Slice<stdgo.GoUInt8>);
    ...
    **/
    static public function sum512_256(_data:Array<std.UInt>):haxe.ds.Vector<std.UInt> {
        final _data = ([for (i in _data) i] : stdgo.Slice<stdgo.GoUInt8>);
