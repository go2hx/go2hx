...
function constantTimeCompare(_x:Slice<GoByte>, _y:Slice<GoByte>):GoInt {
        if ((_x != null ? _x.length : ((0 : GoInt))) != (_y != null ? _y.length : ((0 : GoInt)))) {
            return ((0 : GoInt));
        };
        var _v:GoByte = ((0 : GoUInt8));
        {
            var _i:GoInt = ((0 : GoInt));
            Go.cfor(_i < (_x != null ? _x.length : ((0 : GoInt))), _i++, {
                _v = _v | ((_x != null ? _x[_i] : ((0 : GoUInt8))) ^ (_y != null ? _y[_i] : ((0 : GoUInt8))));
            });
        };
...
function constantTimeCopy(_v:GoInt, _x:Slice<GoByte>, _y:Slice<GoByte>):Void {
        if ((_x != null ? _x.length : ((0 : GoInt))) != (_y != null ? _y.length : ((0 : GoInt)))) {
            throw Go.toInterface(((("subtle: slices have different lengths" : GoString))));
        };
        ...
        var _ymask:GoUInt8 = (((-1 ^ (_v - ((1 : GoInt)))) : GoByte));
        {
            var _i:GoInt = ((0 : GoInt));
            Go.cfor(_i < (_x != null ? _x.length : ((0 : GoInt))), _i++, {
                if (_x != null) _x[_i] = ((_x != null ? _x[_i] : ((0 : GoUInt8))) & _xmask) | ((_y != null ? _y[_i] : ((0 : GoUInt8))) & _ymask);
            });
        };
    }
/**
