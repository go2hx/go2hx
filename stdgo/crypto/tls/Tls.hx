...
@:named class T_alert {
	...
	public function toString():GoString {
		var _e = this.__copy__();
		var __tmp__ = _alertText.exists(_e) ? {value: _alertText[_e], ok: true} : {value: _alertText.defaultValue(), ok: false},
...
@:structInit class CipherSuite {
	...
	public function new(?id:GoUInt16, ?name:GoString, ?supportedVersions:Slice<GoUInt16>, ?insecure:Bool)
...
@:structInit class T_cipherSuite {
	...
	public function new(?_id:GoUInt16, ?_keyLen:GoInt, ?_macLen:GoInt, ?_ivLen:GoInt, ?_ka:GoUInt16->T_keyAgreement, ?_flags:GoInt,
			?_cipher:(Slice<GoUInt8>, Slice<GoUInt8>, Bool) -> AnyInterface, ?_mac:Slice<GoUInt8>->stdgo.hash.Hash.Hash,
			?_aead:(Slice<GoUInt8>, Slice<GoUInt8>) -> T_aead)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_id) + " " + Go.string(_keyLen) + " " + Go.string(_macLen) + " " + Go.string(_ivLen) + " " + Go.string(_ka) + " "
			+ Go.string(_flags) + " " + Go.string(_cipher) + " " + Go.string(_mac) + " " + Go.string(_aead) + "}";
	}
...
@:structInit class T_cipherSuiteTLS13 {
	public function _exportKeyingMaterial(_masterSecret:Slice<GoByte>, _transcript:stdgo.hash.Hash.Hash):(GoString, Slice<GoByte>, GoInt) -> {
		var _0:Slice<GoByte>;
		var _1:Error;
	} {
	...
	public function _trafficKey(_trafficSecret:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:Slice<GoByte>;} {
		var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _key:Slice<GoByte> = new Slice<GoUInt8>().nil(),
			_iv:Slice<GoByte> = new Slice<GoUInt8>().nil();
	...
	public function _expandLabel(_secret:Slice<GoByte>, _label:GoString, _context:Slice<GoByte>, _length:GoInt):Slice<GoByte> {
		...
		var __tmp__ = golang_org.x.crypto.hkdf.Hkdf.expand(_c.value._hash.new_, _secret, _hkdfLabel.bytesOrPanic()).read(_out),
			_n:GoInt = __tmp__._0,
	...
	public function new(?_id:GoUInt16, ?_keyLen:GoInt, ?_aead:(Slice<GoUInt8>, Slice<GoUInt8>) -> T_aead, ?_hash:stdgo.crypto.Crypto.Hash)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_prefixNonceAEAD {
	public function open(_out:Slice<GoByte>, _nonce:Slice<GoByte>, _ciphertext:Slice<GoByte>,
	...
	public function new(?_nonce:GoArray<GoUInt8>, ?_aead:stdgo.crypto.cipher.Cipher.AEAD)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_xorNonceAEAD {
	public function open(_out:Slice<GoByte>, _nonce:Slice<GoByte>, _ciphertext:Slice<GoByte>,
		...
		var __tmp__ = _f.value._aead.open(_out, _f.value._nonceMask.__slice__(0), _ciphertext, _additionalData),
			_result:Slice<GoUInt8> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		for (_i => _b in _nonce) {
			_f.value._nonceMask[((4 : GoInt)) + _i] = _f.value._nonceMask[((4 : GoInt)) + _i] ^ (_b);
		};
	...
	public function new(?_nonceMask:GoArray<GoUInt8>, ?_aead:stdgo.crypto.cipher.Cipher.AEAD)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_cthWrapper {
	...
	public function new(?_h:T_constantTimeHash)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_keyShare {
	...
	public function new(?_group:CurveID, ?_data:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_pskIdentity {
	...
	public function new(?_label:Slice<GoUInt8>, ?_obfuscatedTicketAge:GoUInt32)
		stdgo.internal.Macro.initLocals();
...
@:structInit class ConnectionState {
	...
	public var _ekm:(GoString, Slice<GoUInt8>, GoInt) -> {
		var _0:Slice<GoUInt8>;
		var _1:stdgo.Error;
	} = null;

	public function new(?version:GoUInt16, ?handshakeComplete:Bool, ?didResume:Bool, ?cipherSuite:GoUInt16, ?negotiatedProtocol:GoString,
			?negotiatedProtocolIsMutual:Bool, ?serverName:GoString, ?peerCertificates:Slice<Pointer<stdgo.crypto.x509.X509.Certificate>>,
			?verifiedChains:Slice<Slice<Pointer<stdgo.crypto.x509.X509.Certificate>>>, ?signedCertificateTimestamps:Slice<Slice<GoUInt8>>,
			?ocspresponse:Slice<GoUInt8>, ?tlsunique:Slice<GoUInt8>, ?_ekm:(GoString, Slice<GoUInt8>, GoInt) -> {
			var _0:Slice<GoUInt8>;
			var _1:stdgo.Error;
		})
		stdgo.internal.Macro.initLocals();
	...
	public function toString() {
		return '{' + Go.string(version) + " " + Go.string(handshakeComplete) + " " + Go.string(didResume) + " " + Go.string(cipherSuite) + " "
			+ Go.string(negotiatedProtocol) + " " + Go.string(negotiatedProtocolIsMutual) + " " + Go.string(serverName) + " " + Go.string(peerCertificates)
			+ " " + Go.string(verifiedChains) + " " + Go.string(signedCertificateTimestamps) + " " + Go.string(ocspresponse) + " " + Go.string(tlsunique)
			+ " " + Go.string(_ekm) + "}";
	}
	...
	public function __copy__() {
		return new ConnectionState(version, handshakeComplete, didResume, cipherSuite, negotiatedProtocol, negotiatedProtocolIsMutual, serverName,
			peerCertificates, verifiedChains, signedCertificateTimestamps, ocspresponse, tlsunique, _ekm);
	}
...
@:named class ClientAuthType {
	...
	public function __copy__()
		return new ClientAuthType(__t__);
}
...
@:structInit class ClientSessionState {
	...
	public var _verifiedChains:Slice<Slice<Pointer<stdgo.crypto.x509.X509.Certificate>>> = new Slice<Slice<Pointer<stdgo.crypto.x509.X509.Certificate>>>()
		.nil();
	...
	public function new(?_sessionTicket:Slice<GoUInt8>, ?_vers:GoUInt16, ?_cipherSuite:GoUInt16, ?_masterSecret:Slice<GoUInt8>,
			?_serverCertificates:Slice<Pointer<stdgo.crypto.x509.X509.Certificate>>,
			?_verifiedChains:Slice<Slice<Pointer<stdgo.crypto.x509.X509.Certificate>>>, ?_receivedAt:stdgo.time.Time.Time, ?_ocspResponse:Slice<GoUInt8>,
			?_scts:Slice<Slice<GoUInt8>>, ?_nonce:Slice<GoUInt8>, ?_useBy:stdgo.time.Time.Time, ?_ageAdd:GoUInt32)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_sessionTicket) + " " + Go.string(_vers) + " " + Go.string(_cipherSuite) + " " + Go.string(_masterSecret) + " "
			+ Go.string(_serverCertificates) + " " + Go.string(_verifiedChains) + " " + Go.string(_receivedAt) + " " + Go.string(_ocspResponse) + " "
			+ Go.string(_scts) + " " + Go.string(_nonce) + " " + Go.string(_useBy) + " " + Go.string(_ageAdd) + "}";
	}
	...
	public function __copy__() {
		return new ClientSessionState(_sessionTicket, _vers, _cipherSuite, _masterSecret, _serverCertificates, _verifiedChains, _receivedAt, _ocspResponse,
			_scts, _nonce, _useBy, _ageAdd);
	}
...
@:named class SignatureScheme {
	public function toString():GoString {
		...
		if (_i.__t__ == ((513 : GoUInt16))) {
			...
			return __SignatureScheme_name_8.__slice__(__SignatureScheme_index_8[_i.__t__],
				__SignatureScheme_index_8[new SignatureScheme(_i.__t__ + ((1 : GoUInt16))).__t__]);
		} else {
	...
	public function __copy__()
		return new SignatureScheme(__t__);
}
...
@:structInit class ClientHelloInfo {
	public function supportsCertificate(_c:Pointer<Certificate>):Error {
		...
		var __tmp__ = _config.value._mutualVersion(_chi.value.supportedVersions),
			_vers:GoUInt16 = __tmp__._0,
			_ok:Bool = __tmp__._1;
		if (!_ok) {
			return stdgo.errors.Errors.new_("no mutually supported protocol versions");
		};
		if (_chi.value.serverName != (("" : GoString))) {
			var __tmp__ = _c.value._leaf(),
				_x509Cert:Pointer<stdgo.crypto.x509.X509.Certificate> = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
		...
		var _supportsRSAFallback:stdgo.Error->stdgo.Error = function(_unsupported:Error):Error {
			...
			var _rsaCipherSuite:Pointer<T_cipherSuite> = _selectCipherSuite(_chi.value.cipherSuites, _config.value._cipherSuites(),
				function(_c:Pointer<T_cipherSuite>):Bool {
		...
		if (_chi.value.signatureSchemes.length > ((0 : GoInt))) {
			{
				var __tmp__ = _selectSignatureScheme(_vers, _c, _chi.value.signatureSchemes),
					_:SignatureScheme = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
			...
			if (_ok) {
				{
					while (true) {
						if (Go.assertable(((_priv.public_() : Pointer<stdgo.crypto.ecdsa.Ecdsa.PublicKey>)))) {
							var _pub:Pointer<stdgo.crypto.ecdsa.Ecdsa.PublicKey> = _priv.public_() == null ? null : _priv.public_()
								.__underlying__() == null ? null : _priv.public_() == null ? null : _priv.public_()
								.__underlying__()
								.value;
							...
							var _pub:stdgo.crypto.ed25519.Ed25519.PublicKey = _priv.public_() == null ? null : _priv.public_()
								.__underlying__() == null ? null : _priv.public_() == null ? null : _priv.public_()
								.__underlying__()
								.value;
							...
							var _pub:Pointer<stdgo.crypto.rsa.Rsa.PublicKey> = _priv.public_() == null ? null : _priv.public_()
								.__underlying__() == null ? null : _priv.public_() == null ? null : _priv.public_()
								.__underlying__()
								.value;
						} else {
		...
		var _cipherSuite:Pointer<T_cipherSuite> = _selectCipherSuite(_chi.value.cipherSuites, _config.value._cipherSuites(),
			function(_c:Pointer<T_cipherSuite>):Bool {
				if (_c.value._flags & _suiteECDHE == ((0 : GoInt))) {
					return false;
				};
	...
	public function new(?cipherSuites:Slice<GoUInt16>, ?serverName:GoString, ?supportedCurves:Slice<CurveID>, ?supportedPoints:Slice<GoUInt8>,
			?signatureSchemes:Slice<SignatureScheme>, ?supportedProtos:Slice<GoString>, ?supportedVersions:Slice<GoUInt16>, ?conn:stdgo.net.Net.Conn,
			?_config:Pointer<Config>, ?_ctx:stdgo.context.Context.Context)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(cipherSuites) + " " + Go.string(serverName) + " " + Go.string(supportedCurves) + " " + Go.string(supportedPoints) + " "
			+ Go.string(signatureSchemes) + " " + Go.string(supportedProtos) + " " + Go.string(supportedVersions) + " " + Go.string(conn) + " "
			+ Go.string(_config) + " " + Go.string(_ctx) + "}";
	}
...
@:structInit class CertificateRequestInfo {
	public function supportsCertificate(_c:Pointer<Certificate>):Error {
		...
		{
			var __tmp__ = _selectSignatureScheme(_cri.value.version, _c, _cri.value.signatureSchemes),
				_:SignatureScheme = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return _err;
	...
	public function new(?acceptableCAs:Slice<Slice<GoUInt8>>, ?signatureSchemes:Slice<SignatureScheme>, ?version:GoUInt16, ?_ctx:stdgo.context.Context.Context)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{'
			+ Go.string(acceptableCAs)
			+ " "
			+ Go.string(signatureSchemes)
			+ " "
			+ Go.string(version)
			+ " "
			+ Go.string(_ctx)
...
@:named class RenegotiationSupport {
	...
	public function __copy__()
		return new RenegotiationSupport(__t__);
}
...
@:structInit class Config {
	public function _writeKeyLog(_label:GoString, _clientRandom:Slice<GoByte>, _secret:Slice<GoByte>):Error {
		...
		var _logLine:Slice<GoUInt8> = ((stdgo.fmt.Fmt.sprintf("%s %x %x\n", Go.toInterface(_label), Go.toInterface(_clientRandom),
			Go.toInterface(_secret)) : Slice<GoByte>));
		_writerMutex.lock();
		var __tmp__ = _c.value.keyLogWriter.write(_logLine),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		_writerMutex.unlock();
		return _err;
	...
	public function buildNameToCertificate():Void {
		var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		_c.value.nameToCertificate = new GoMap<GoString,
			Pointer<Certificate>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
			stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("Certificate", [],
				stdgo.reflect.Reflect.GoType.named("Certificate", [], stdgo.reflect.Reflect.GoType.structType([
					...
					},
					{
						...
						embedded: false,
						tag: "",
						type: stdgo.reflect.Reflect.GoType.named("stdgo.crypto.Crypto.PrivateKey", [], stdgo.reflect.Reflect.GoType.interfaceType(true, []))
					},
					{
						name: "supportedSignatureAlgorithms",
						embedded: false,
						tag: "",
						type: stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("SignatureScheme", [],
							stdgo.reflect.Reflect.GoType.basic(uint16_kind)))
					},
					{
						name: "ocspstaple",
						embedded: false,
					...
					},
					{
						...
						embedded: false,
						tag: "",
						type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("stdgo.crypto.x509.X509.Certificate", [],
							stdgo.reflect.Reflect.GoType.structType([
								...
								},
								{
									...
									embedded: false,
									tag: "",
									type: stdgo.reflect.Reflect.GoType.named("stdgo.crypto.x509.X509.SignatureAlgorithm", [],
								...
								},
								{
									...
									embedded: false,
									tag: "",
									type: stdgo.reflect.Reflect.GoType.named("stdgo.crypto.x509.X509.PublicKeyAlgorithm", [],
										stdgo.reflect.Reflect.GoType.basic(int_kind))
								},
								{
									name: "publicKey",
								...
								},
								{
									...
									embedded: false,
									tag: "",
									type: stdgo.reflect.Reflect.GoType.named("stdgo.crypto.x509.pkix.Pkix.Name", [], stdgo.reflect.Reflect.GoType.invalidType)
								},
								{
									name: "notBefore",
									embedded: false,
								...
								},
								{
									...
									embedded: false,
									tag: "",
									type: stdgo.reflect.Reflect.GoType.named("stdgo.time.Time.Time", [], stdgo.reflect.Reflect.GoType.invalidType)
								},
								{
									name: "keyUsage",
									embedded: false,
									tag: "",
									type: stdgo.reflect.Reflect.GoType.named("stdgo.crypto.x509.X509.KeyUsage", [],
										stdgo.reflect.Reflect.GoType.basic(int_kind))
								},
								{
									name: "extensions",
								...
								},
								{
									...
									embedded: false,
									tag: "",
									type: stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("stdgo.crypto.x509.X509.ExtKeyUsage", [],
										stdgo.reflect.Reflect.GoType.basic(int_kind)))
								},
								{
								...
								},
								{
									...
									type: stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("stdgo.net.Net.IPNet",
											[], stdgo.reflect.Reflect.GoType.structType([
										{
											...
											embedded: false,
											tag: "",
											type: stdgo.reflect.Reflect.GoType.named("stdgo.net.Net.IP", [], stdgo.reflect.Reflect.GoType.invalidType)
										},
										{
											name: "mask",
											embedded: false,
	...
	public function _getCertificate(_clientHello:Pointer<ClientHelloInfo>):{var _0:Pointer<Certificate>; var _1:Error;} {
		var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		if (_c.value.getCertificate != null
			&& (_c.value.certificates.length == ((0 : GoInt)) || _clientHello.value.serverName.length > ((0 : GoInt)))) {
			var __tmp__ = _c.value.getCertificate(_clientHello),
		...
		if ((_c.value.nameToCertificate != null && !_c.value.nameToCertificate.isNil())) {
			...
			{
				var __tmp__ = _c.value.nameToCertificate.exists(_name) ? {value: _c.value.nameToCertificate[_name],
					ok: true} : {value: _c.value.nameToCertificate.defaultValue(), ok: false},
					_cert:Pointer<Certificate> = __tmp__.value,
					_ok:Bool = __tmp__.ok;
				if (_ok) {
			...
			if (_name.length > ((0 : GoInt))) {
				...
				{
					var __tmp__ = _c.value.nameToCertificate.exists(_wildcardName) ? {value: _c.value.nameToCertificate[_wildcardName],
						ok: true} : {value: _c.value.nameToCertificate.defaultValue(), ok: false},
						_cert:Pointer<Certificate> = __tmp__.value,
						_ok:Bool = __tmp__.ok;
					if (_ok) {
	...
	public function _supportedVersions():Slice<GoUInt16> {
		var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _versions:Slice<GoUInt16> = new Slice<GoUInt16>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt16))])
			.setCap(((Tls._supportedVersions.length : GoInt)).toBasic());
		for (_ => _v in Tls._supportedVersions) {
	...
	public function _ticketKeys(_configForClient:Pointer<Config>):Slice<T_ticketKey> {
		...
		try {
			...
			if (_c.value._autoSessionTicketKeys.length > ((0 : GoInt))
				&& _c.value._time().sub(_c.value._autoSessionTicketKeys[((0 : GoInt))]._created.__copy__()).__t__ < _ticketKeyRotation.__t__) {
				{
					for (defer in deferstack) {
						defer();
					};
			...
			if (_c.value._autoSessionTicketKeys.length == ((0 : GoInt))
				...
				{
					var __tmp__ = stdgo.io.Io.readFull(_c.value._rand(), _newKey.__slice__(0)),
						_:GoInt = __tmp__._0,
						_err:stdgo.Error = __tmp__._1;
					if (_err != null) {
				...
				var _valid:Slice<T_ticketKey> = new Slice<T_ticketKey>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) new T_ticketKey()])
					.setCap(((_c.value._autoSessionTicketKeys.length
	...
	public function _initLegacySessionTicketKeyRLocked():Void {
		...
		try {
			if (! {
				...
				bool;
			} && (stdgo.bytes.Bytes.hasPrefix(_c.value.sessionTicketKey.__slice__(0), _deprecatedSessionTicketKey)
				|| _c.value._sessionTicketKeys.length > ((0 : GoInt)))) {
				return;
			};
			_c.value._mutex.runlock();
			deferstack.unshift(() -> _c.value._mutex.rlock());
			...
			if ({
				...
				{
					var __tmp__ = stdgo.io.Io.readFull(_c.value._rand(), _c.value.sessionTicketKey.__slice__(0)),
						_:GoInt = __tmp__._0,
						_err:stdgo.Error = __tmp__._1;
					if (_err != null) {
			...
			} else if (!stdgo.bytes.Bytes.hasPrefix(_c.value.sessionTicketKey.__slice__(0), _deprecatedSessionTicketKey)
				&& _c.value._sessionTicketKeys.length == ((0 : GoInt))) {
		...
		try {
			...
			deferstack.unshift(() -> _c.value._mutex.runlock());
			{
				...
				return Go.pointer((({
					rand: _c.value.rand,
					time: _c.value.time,
					certificates: _c.value.certificates,
					nameToCertificate: _c.value.nameToCertificate,
					getCertificate: _c.value.getCertificate,
					getClientCertificate: _c.value.getClientCertificate,
					getConfigForClient: _c.value.getConfigForClient,
					verifyPeerCertificate: _c.value.verifyPeerCertificate,
					verifyConnection: _c.value.verifyConnection,
					rootCAs: _c.value.rootCAs,
					nextProtos: _c.value.nextProtos,
					serverName: _c.value.serverName,
					clientAuth: _c.value.clientAuth,
					clientCAs: _c.value.clientCAs,
					insecureSkipVerify: _c.value.insecureSkipVerify,
					cipherSuites: _c.value.cipherSuites,
					preferServerCipherSuites: _c.value.preferServerCipherSuites,
					sessionTicketsDisabled: _c.value.sessionTicketsDisabled,
					sessionTicketKey: _c.value.sessionTicketKey.copy(),
					clientSessionCache: _c.value.clientSessionCache,
					minVersion: _c.value.minVersion,
					maxVersion: _c.value.maxVersion,
					curvePreferences: _c.value.curvePreferences,
					dynamicRecordSizingDisabled: _c.value.dynamicRecordSizingDisabled,
					renegotiation: _c.value.renegotiation,
					keyLogWriter: _c.value.keyLogWriter,
					_sessionTicketKeys: _c.value._sessionTicketKeys,
					_autoSessionTicketKeys: _c.value._autoSessionTicketKeys,
	...
	public var nameToCertificate:GoMap<GoString, Pointer<Certificate>> = new GoMap<GoString,
		Pointer<Certificate>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
		stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("Certificate", [], stdgo.reflect.Reflect.GoType.structType([
			{
				name: "certificate",
				embedded: false,
				tag: "",
				...
				type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("stdgo.crypto.x509.X509.Certificate", [],
					stdgo.reflect.Reflect.GoType.structType([
						...
						},
						{
							...
							embedded: false,
							tag: "",
							type: stdgo.reflect.Reflect.GoType.named("stdgo.crypto.x509.X509.KeyUsage", [], stdgo.reflect.Reflect.GoType.basic(int_kind))
						},
						{
							name: "extensions",
							embedded: false,
	...
	public var getCertificate:Pointer<ClientHelloInfo> -> {
		var _0:Pointer<Certificate>;
		var _1:stdgo.Error;
	} = null;
	public var getClientCertificate:Pointer<CertificateRequestInfo> -> {
		var _0:Pointer<Certificate>;
		var _1:stdgo.Error;
	} = null;
	public var getConfigForClient:Pointer<ClientHelloInfo> -> {
		var _0:Pointer<Config>;
		var _1:stdgo.Error;
	} = null;
	...
	public function new(?rand:stdgo.io.Io.Reader, ?time:() -> stdgo.time.Time.Time, ?certificates:Slice<Certificate>,
			?nameToCertificate:GoMap<GoString, Pointer<Certificate>>, ?getCertificate:Pointer<ClientHelloInfo> -> {
			var _0:Pointer<Certificate>;
			var _1:stdgo.Error;
		}, ?getClientCertificate:Pointer<CertificateRequestInfo> -> {
			var _0:Pointer<Certificate>;
			var _1:stdgo.Error;
		}, ?getConfigForClient:Pointer<ClientHelloInfo> -> {
			var _0:Pointer<Config>;
			var _1:stdgo.Error;
		},
			?verifyPeerCertificate:(Slice<Slice<GoUInt8>>, Slice<Slice<Pointer<stdgo.crypto.x509.X509.Certificate>>>) -> stdgo.Error,
			?verifyConnection:ConnectionState->stdgo.Error, ?rootCAs:Pointer<stdgo.crypto.x509.X509.CertPool>, ?nextProtos:Slice<GoString>,
			?serverName:GoString, ?clientAuth:ClientAuthType, ?clientCAs:Pointer<stdgo.crypto.x509.X509.CertPool>, ?insecureSkipVerify:Bool,
			?cipherSuites:Slice<GoUInt16>, ?preferServerCipherSuites:Bool, ?sessionTicketsDisabled:Bool, ?sessionTicketKey:GoArray<GoUInt8>,
			?clientSessionCache:ClientSessionCache, ?minVersion:GoUInt16, ?maxVersion:GoUInt16, ?curvePreferences:Slice<CurveID>,
			?dynamicRecordSizingDisabled:Bool, ?renegotiation:RenegotiationSupport, ?keyLogWriter:stdgo.io.Io.Writer, ?_mutex:stdgo.sync.Sync.RWMutex,
			?_sessionTicketKeys:Slice<T_ticketKey>, ?_autoSessionTicketKeys:Slice<T_ticketKey>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(rand) + " " + Go.string(time) + " " + Go.string(certificates) + " " + Go.string(nameToCertificate) + " "
			+ Go.string(getCertificate) + " " + Go.string(getClientCertificate) + " " + Go.string(getConfigForClient) + " "
			+ Go.string(verifyPeerCertificate) + " " + Go.string(verifyConnection) + " " + Go.string(rootCAs) + " " + Go.string(nextProtos) + " "
			+ Go.string(serverName) + " " + Go.string(clientAuth) + " " + Go.string(clientCAs) + " " + Go.string(insecureSkipVerify) + " "
			+ Go.string(cipherSuites) + " " + Go.string(preferServerCipherSuites) + " " + Go.string(sessionTicketsDisabled) + " "
			+ Go.string(sessionTicketKey) + " " + Go.string(clientSessionCache) + " " + Go.string(minVersion) + " " + Go.string(maxVersion) + " "
			+ Go.string(curvePreferences) + " " + Go.string(dynamicRecordSizingDisabled) + " " + Go.string(renegotiation) + " " + Go.string(keyLogWriter)
			+ " " + Go.string(_mutex) + " " + Go.string(_sessionTicketKeys) + " " + Go.string(_autoSessionTicketKeys) + "}";
	}
	...
	public function __copy__() {
		return new Config(rand, time, certificates, nameToCertificate, getCertificate, getClientCertificate, getConfigForClient, verifyPeerCertificate,
			verifyConnection, rootCAs, nextProtos, serverName, clientAuth, clientCAs, insecureSkipVerify, cipherSuites, preferServerCipherSuites,
			sessionTicketsDisabled, sessionTicketKey, clientSessionCache, minVersion, maxVersion, curvePreferences, dynamicRecordSizingDisabled,
			renegotiation, keyLogWriter, _mutex, _sessionTicketKeys, _autoSessionTicketKeys);
	}
...
@:structInit class T_ticketKey {
	...
	public function new(?_keyName:GoArray<GoUInt8>, ?_aesKey:GoArray<GoUInt8>, ?_hmacKey:GoArray<GoUInt8>, ?_created:stdgo.time.Time.Time)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Certificate {
	...
	public function new(?certificate:Slice<Slice<GoUInt8>>, ?privateKey:stdgo.crypto.Crypto.PrivateKey, ?supportedSignatureAlgorithms:Slice<SignatureScheme>,
			?ocspstaple:Slice<GoUInt8>, ?signedCertificateTimestamps:Slice<Slice<GoUInt8>>, ?leaf:Pointer<stdgo.crypto.x509.X509.Certificate>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(certificate) + " " + Go.string(privateKey) + " " + Go.string(supportedSignatureAlgorithms) + " " + Go.string(ocspstaple)
			+ " " + Go.string(signedCertificateTimestamps) + " " + Go.string(leaf) + "}";
	}
...
@:structInit class T_lruSessionCache {
	public function get(_sessionKey:GoString):{var _0:Pointer<ClientSessionState>; var _1:Bool;} {
		...
		try {
			{
				var __tmp__ = _c.value._m.exists(_sessionKey) ? {value: _c.value._m[_sessionKey], ok: true} : {value: _c.value._m.defaultValue(), ok: false},
					_elem:Pointer<stdgo.container.list.List.Element> = __tmp__.value,
					_ok:Bool = __tmp__.ok;
				if (_ok) {
	...
	public var _m:GoMap<GoString, Pointer<stdgo.container.list.List.Element>> = new GoMap<GoString,
		Pointer<stdgo.container.list.List.Element>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
		stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("stdgo.container.list.List.Element", [],
			stdgo.reflect.Reflect.GoType.structType([
				{
					name: "_next",
					embedded: false,
					tag: "",
					type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("stdgo.container.list.List.Element", [],
						stdgo.reflect.Reflect.GoType.invalidType))
				},
				{
					name: "_prev",
				...
				},
				{
					...
					embedded: false,
					tag: "",
					type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("stdgo.container.list.List.List", [],
						stdgo.reflect.Reflect.GoType.structType([
							{
								name: "_root",
								embedded: false,
								tag: "",
								type: stdgo.reflect.Reflect.GoType.named("stdgo.container.list.List.Element", [], stdgo.reflect.Reflect.GoType.invalidType)
							},
							{
								name: "_len",
								embedded: false,
	...
	public function new(?mutex:stdgo.sync.Sync.Mutex, ?_m:GoMap<GoString, Pointer<stdgo.container.list.List.Element>>,
			?_q:Pointer<stdgo.container.list.List.List>, ?_capacity:GoInt)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_lruSessionCacheEntry {
	...
	public function new(?_sessionKey:GoString, ?_state:Pointer<ClientSessionState>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Conn {
	public function _decryptTicket(_encrypted:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:Bool;} {
		...
		var _ciphertext:Slice<GoUInt8> = _encrypted.__slice__(_ticketKeyNameLen + stdgo.crypto.aes.Aes.blockSize,
			_encrypted.length - stdgo.crypto.sha256.Sha256.size);
		...
		var __tmp__ = stdgo.crypto.aes.Aes.newCipher(_key.value._aesKey.__slice__(0)),
	...
	public function _encryptTicket(_state:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:Error;} {
		...
		var _encrypted:Slice<GoUInt8> = new Slice<GoUInt8>(...[
			for (i in 0...((_ticketKeyNameLen + stdgo.crypto.aes.Aes.blockSize + _state.length + stdgo.crypto.sha256.Sha256.size : GoInt)).toBasic())
				((0 : GoUInt8))
		]);
		var _keyName:Slice<GoUInt8> = _encrypted.__slice__(0, _ticketKeyNameLen);
		var _iv:Slice<GoUInt8> = _encrypted.__slice__(_ticketKeyNameLen, _ticketKeyNameLen + stdgo.crypto.aes.Aes.blockSize);
		var _macBytes:Slice<GoUInt8> = _encrypted.__slice__(_encrypted.length - stdgo.crypto.sha256.Sha256.size);
		{
			var __tmp__ = stdgo.io.Io.readFull(_c.value._config.value._rand(), _iv),
				_:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
		...
		var __tmp__ = stdgo.crypto.aes.Aes.newCipher(_key._aesKey.__slice__(0)),
			_block:stdgo.crypto.cipher.Cipher.Block = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new Slice<GoUInt8>().nil(), _1: stdgo.errors.Errors.new_((("tls: failed to create cipher while encrypting ticket: " : GoString))
				+ _err.error())};
		};
	...
	public function _processCertsFromClient(_certificate:Certificate):Error {
		...
		var _certs:Slice<Pointer<stdgo.crypto.x509.X509.Certificate>> = new Slice<Pointer<stdgo.crypto.x509.X509.Certificate>>(...[
			for (i in 0...((_certificates.length : GoInt)).toBasic()) new Pointer<stdgo.crypto.x509.X509.Certificate>().nil()
		]);
		var _err:Error = ((null : stdgo.Error));
		...
		if (_c.value._config.value.clientAuth.__t__ >= verifyClientCertIfGiven.__t__ && _certs.length > ((0 : GoInt))) {
			var _opts:stdgo.crypto.x509.X509.VerifyOptions = (({
				roots: _c.value._config.value.clientCAs,
				currentTime: new stdgo.time.Time.Time(_c.value._config.value._time().__copy__().__copy__()),
				intermediates: stdgo.crypto.x509.X509.newCertPool(),
				keyUsages: new Slice<stdgo.crypto.x509.X509.ExtKeyUsage>(stdgo.crypto.x509.X509.extKeyUsageClientAuth),
				dnsname: "",
				maxConstraintComparisions: 0
			} : stdgo.crypto.x509.X509.VerifyOptions)).__copy__();
			...
			var __tmp__ = _certs[((0 : GoInt))].value.verify(_opts.__copy__()),
				_chains:Slice<Slice<Pointer<stdgo.crypto.x509.X509.Certificate>>> = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				_c.value._sendAlert(_alertBadCertificate);
		...
		if (_certs.length > ((0 : GoInt))) {
			if (Go.assertable(((_certs[((0 : GoInt))].value.publicKey : Pointer<stdgo.crypto.ecdsa.Ecdsa.PublicKey>)))
				|| Go.assertable(((_certs[((0 : GoInt))].value.publicKey : Pointer<stdgo.crypto.rsa.Rsa.PublicKey>)))
				|| Go.assertable(((_certs[((0 : GoInt))].value.publicKey : stdgo.crypto.ed25519.Ed25519.PublicKey)))) {} else {
				_c.value._sendAlert(_alertUnsupportedCertificate);
				return stdgo.fmt.Fmt.errorf("tls: client certificate contains an unsupported public key of type %T",
					Go.toInterface(_certs[((0 : GoInt))].value.publicKey));
			};
		};
	...
	public function _readClientHello(_ctx:stdgo.context.Context.Context):{var _0:Pointer<T_clientHelloMsg>; var _1:Error;} {
		...
		if (!_ok) {
			...
			return {_0: new Pointer<T_clientHelloMsg>().nil(), _1: stdgo.fmt.Fmt.errorf("tls: client offered only unsupported versions: %x",
				Go.toInterface(_clientVersions))};
		};
	...
	public function _serverHandshake(_ctx:stdgo.context.Context.Context):Error {
		var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _c.value._readClientHello(_ctx),
			_clientHello:Pointer<T_clientHelloMsg> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return _err;
		};
		if (_c.value._vers == versionTLS13) {
			var _hs:T_serverHandshakeStateTLS13 = (({
				_c: _c,
				_ctx: _ctx,
				_clientHello: _clientHello,
				_hello: new Pointer<T_serverHelloMsg>().nil(),
				_sentDummyCCS: false,
				_usingPSK: false,
				_suite: new Pointer<T_cipherSuiteTLS13>().nil(),
				_cert: new Pointer<Certificate>().nil(),
				_sigAlg: new SignatureScheme(),
				_earlySecret: new Slice<GoUInt8>().nil(),
				_sharedKey: new Slice<GoUInt8>().nil(),
				_handshakeSecret: new Slice<GoUInt8>().nil(),
				_masterSecret: new Slice<GoUInt8>().nil(),
				_trafficSecret: new Slice<GoUInt8>().nil(),
				_transcript: ((null : stdgo.hash.Hash.Hash)),
				_clientFinished: new Slice<GoUInt8>().nil()
			} : T_serverHandshakeStateTLS13)).__copy__();
			return _hs._handshake();
		};
		var _hs:T_serverHandshakeState = (({
			_c: _c,
			_ctx: _ctx,
			_clientHello: _clientHello,
			_hello: new Pointer<T_serverHelloMsg>().nil(),
			_suite: new Pointer<T_cipherSuite>().nil(),
			_ecdheOk: false,
			_ecSignOk: false,
			_rsaDecryptOk: false,
			_rsaSignOk: false,
			_sessionState: new Pointer<T_sessionState>().nil(),
			_finishedHash: new T_finishedHash(),
			_masterSecret: new Slice<GoUInt8>().nil(),
			_cert: new Pointer<Certificate>().nil()
		} : T_serverHandshakeState)).__copy__();
		return _hs._handshake();
	}
	...
	public function _handleNewSessionTicket(_msg:Pointer<T_newSessionTicketMsgTLS13>):Error {
		...
		var _lifetime:stdgo.time.Time.Duration = new stdgo.time.Time.Duration(new stdgo.time.Time.Duration(_msg.value._lifetime)
		...
		var _session:Pointer<ClientSessionState> = Go.pointer((({
			_sessionTicket: _msg.value._label,
			_vers: _c.value._vers,
			_cipherSuite: _c.value._cipherSuite,
			_masterSecret: _c.value._resumptionSecret,
			_serverCertificates: _c.value._peerCertificates,
			_verifiedChains: _c.value._verifiedChains,
			_receivedAt: _c.value._config.value._time().__copy__(),
			_nonce: _msg.value._nonce,
			_useBy: _c.value._config.value._time().add(_lifetime).__copy__(),
			_ageAdd: _msg.value._ageAdd,
			_ocspResponse: _c.value._ocspResponse,
			_scts: _c.value._scts
		} : ClientSessionState)));
	...
	public function _verifyServerCertificate(_certificates:Slice<Slice<GoByte>>):Error {
		...
		for (_i => _asn1Data in _certificates) {
			var __tmp__ = stdgo.crypto.x509.X509.parseCertificate(_asn1Data),
				_cert:Pointer<stdgo.crypto.x509.X509.Certificate> = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				_c.value._sendAlert(_alertBadCertificate);
		...
		if (!_c.value._config.value.insecureSkipVerify) {
			var _opts:stdgo.crypto.x509.X509.VerifyOptions = (({
				roots: _c.value._config.value.rootCAs,
				currentTime: new stdgo.time.Time.Time(_c.value._config.value._time().__copy__().__copy__()),
				dnsname: _c.value._config.value.serverName,
				intermediates: stdgo.crypto.x509.X509.newCertPool(),
				keyUsages: new Slice<stdgo.crypto.x509.X509.ExtKeyUsage>().nil(),
				maxConstraintComparisions: 0
			} : stdgo.crypto.x509.X509.VerifyOptions)).__copy__();
			for (_ => _cert in _certs.__slice__(((1 : GoInt)))) {
				_opts.intermediates.value.addCert(_cert);
		...
		{
			while (true) {
				if (Go.assertable(((_certs[((0 : GoInt))].value.publicKey : Pointer<stdgo.crypto.rsa.Rsa.PublicKey>)))
					|| Go.assertable(((_certs[((0 : GoInt))].value.publicKey : Pointer<stdgo.crypto.ecdsa.Ecdsa.PublicKey>)))
					|| Go.assertable(((_certs[((0 : GoInt))].value.publicKey : stdgo.crypto.ed25519.Ed25519.PublicKey)))) {
					break;
				} else {
					_c.value._sendAlert(_alertUnsupportedCertificate);
					return stdgo.fmt.Fmt.errorf("tls: server\'s certificate contains an unsupported type of public key: %T",
						Go.toInterface(_certs[((0 : GoInt))].value.publicKey));
				};
				break;
			};
	...
	public function _pickTLSVersion(_serverHello:Pointer<T_serverHelloMsg>):Error {
		...
		var __tmp__ = _c.value._config.value._mutualVersion(new Slice<GoUInt16>(_peerVersion)),
			_vers:GoUInt16 = __tmp__._0,
			_ok:Bool = __tmp__._1;
		if (!_ok) {
			_c.value._sendAlert(_alertProtocolVersion);
	...
	public function _loadSession(_hello:Pointer<T_clientHelloMsg>):{
		var _0:GoString;
		var _1:Pointer<ClientSessionState>;
		var _2:Slice<GoByte>;
		var _3:Slice<GoByte>;
	} {
		var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _cacheKey:GoString = (("" : GoString)),
			_session:Pointer<ClientSessionState> = new Pointer<ClientSessionState>().nil(),
			_earlySecret:Slice<GoByte> = new Slice<GoUInt8>().nil(),
			_binderKey:Slice<GoByte> = new Slice<GoUInt8>().nil();
		if (_c.value._config.value.sessionTicketsDisabled || _c.value._config.value.clientSessionCache == null) {
			return {
				_0: "",
				_1: new Pointer<ClientSessionState>().nil(),
				_2: new Slice<GoUInt8>().nil(),
				_3: new Slice<GoUInt8>().nil()
			};
		};
		...
		var __tmp__ = _c.value._config.value.clientSessionCache.get(_cacheKey),
			_session:Pointer<ClientSessionState> = __tmp__._0,
			_ok:Bool = __tmp__._1;
		...
		if (_session.value._vers != versionTLS13) {
			if ((_mutualCipherSuite(_hello.value._cipherSuites, _session.value._cipherSuite) == null
				|| _mutualCipherSuite(_hello.value._cipherSuites, _session.value._cipherSuite).isNil())) {
				return {
					_0: _cacheKey,
					_1: new Pointer<ClientSessionState>().nil(),
					_2: new Slice<GoUInt8>().nil(),
		...
		var _ticketAge:GoUInt32 = new stdgo.time.Time.Duration(_c.value._config.value._time()
			.sub(_session.value._receivedAt.__copy__())
			.__t__ / stdgo.time.Time.millisecond.__t__).__t__;
		var _identity:T_pskIdentity = (({_label: _session.value._sessionTicket, _obfuscatedTicketAge: _ticketAge
			+ _session.value._ageAdd} : T_pskIdentity)).__copy__();
		_hello.value._pskIdentities = new Slice<T_pskIdentity>(_identity.__copy__());
		_hello.value._pskBinders = new Slice<Slice<GoUInt8>>(new Slice<GoUInt8>(...[
			for (i in 0...((_cipherSuite.value._hash.size() : GoInt)).toBasic()) ((0 : GoUInt8))
		]));
		var _psk:Slice<GoUInt8> = _cipherSuite.value._expandLabel(_session.value._masterSecret, "resumption", _session.value._nonce,
			_cipherSuite.value._hash.size());
	...
	public function _clientHandshake(_ctx:stdgo.context.Context.Context):Error {
		...
		try {
			...
			var __tmp__ = _c.value._makeClientHello(),
				_hello:Pointer<T_clientHelloMsg> = __tmp__._0,
				_ecdheParams:T_ecdheParameters = __tmp__._1,
				_err:stdgo.Error = __tmp__._2;
			if (_err != null) {
				return _err;
			};
			_c.value._serverName = _hello.value._serverName;
			var __tmp__ = _c.value._loadSession(_hello),
				_cacheKey:GoString = __tmp__._0,
				_session:Pointer<ClientSessionState> = __tmp__._1,
				_earlySecret:Slice<GoUInt8> = __tmp__._2,
				_binderKey:Slice<GoUInt8> = __tmp__._3;
			...
			{
				var __tmp__ = _c.value._writeRecord(_recordTypeHandshake, _hello.value._marshal()),
					_:GoInt = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
					{
			...
			if (_maxVers == versionTLS13
				&& _c.value._vers <= versionTLS12
				&& (_tls12Downgrade || _tls11Downgrade)
				|| _maxVers == versionTLS12
				&& _c.value._vers <= versionTLS11
				&& _tls11Downgrade) {
				_c.value._sendAlert(_alertIllegalParameter);
				{
					for (defer in deferstack) {
			...
			if (_c.value._vers == versionTLS13) {
				var _hs:Pointer<T_clientHandshakeStateTLS13> = Go.pointer((({
					_c: _c,
					_ctx: _ctx,
					_serverHello: _serverHello,
					_hello: _hello,
					_ecdheParams: _ecdheParams,
					_session: _session,
					_earlySecret: _earlySecret,
					_binderKey: _binderKey,
					_certReq: new Pointer<T_certificateRequestMsgTLS13>().nil(),
					_usingPSK: false,
					_sentDummyCCS: false,
					_suite: new Pointer<T_cipherSuiteTLS13>().nil(),
					_transcript: ((null : stdgo.hash.Hash.Hash)),
			...
			var _hs:Pointer<T_clientHandshakeState> = Go.pointer((({
				_c: _c,
				_ctx: _ctx,
				_serverHello: _serverHello,
				_hello: _hello,
			...
			if (_cacheKey != (("" : GoString))
				&& (_hs.value._session != null && !_hs.value._session.isNil())
				&& _session != _hs.value._session) {
	...
	public function _makeClientHello():{var _0:Pointer<T_clientHelloMsg>; var _1:T_ecdheParameters; var _2:Error;} {
		...
		if (_config.value.serverName.length == ((0 : GoInt)) && !_config.value.insecureSkipVerify) {
			return {_0: new Pointer<T_clientHelloMsg>().nil(), _1: ((null : T_ecdheParameters)),
				_2: stdgo.errors.Errors.new_("tls: either ServerName or InsecureSkipVerify must be specified in the tls.Config")};
		};
		...
		for (_ => _proto in _config.value.nextProtos) {
			{
				...
				if (_l == ((0 : GoInt)) || _l > ((255 : GoInt))) {
					return {_0: new Pointer<T_clientHelloMsg>().nil(), _1: ((null : T_ecdheParameters)),
						_2: stdgo.errors.Errors.new_("tls: invalid NextProtos value")};
				} else {
		...
		if (_nextProtosLength > ((65535 : GoInt))) {
			return {_0: new Pointer<T_clientHelloMsg>().nil(), _1: ((null : T_ecdheParameters)),
				_2: stdgo.errors.Errors.new_("tls: NextProtos values too large")};
		};
		var _supportedVersions:Slice<GoUInt16> = _config.value._supportedVersions();
		if (_supportedVersions.length == ((0 : GoInt))) {
			return {_0: new Pointer<T_clientHelloMsg>().nil(), _1: ((null : T_ecdheParameters)),
				_2: stdgo.errors.Errors.new_("tls: no supported versions satisfy MinVersion and MaxVersion")};
		};
		...
		var _hello:Pointer<T_clientHelloMsg> = Go.pointer((({
			_vers: _clientHelloVersion,
			_compressionMethods: new Slice<GoUInt8>(_compressionNone),
			_random: new Slice<GoUInt8>(...[for (i in 0...((((32 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]),
			_sessionId: new Slice<GoUInt8>(...[for (i in 0...((((32 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]),
			_ocspStapling: true,
			_scts: true,
			_serverName: _hostnameInSNI(_config.value.serverName),
			_supportedCurves: _config.value._curvePreferences(),
			_supportedPoints: new Slice<GoUInt8>(_pointFormatUncompressed),
			_secureRenegotiationSupported: true,
			_alpnProtocols: _config.value.nextProtos,
			_supportedVersions: _supportedVersions,
			_raw: new Slice<GoUInt8>().nil(),
			_cipherSuites: new Slice<GoUInt16>().nil(),
			_ticketSupported: false,
			_sessionTicket: new Slice<GoUInt8>().nil(),
			_supportedSignatureAlgorithms: new Slice<SignatureScheme>().nil(),
			_supportedSignatureAlgorithmsCert: new Slice<SignatureScheme>().nil(),
			_secureRenegotiation: new Slice<GoUInt8>().nil(),
			_cookie: new Slice<GoUInt8>().nil(),
			_keyShares: new Slice<T_keyShare>().nil(),
			_earlyData: false,
			_pskModes: new Slice<GoUInt8>().nil(),
			_pskIdentities: new Slice<T_pskIdentity>().nil(),
			_pskBinders: new Slice<Slice<GoUInt8>>().nil()
		} : T_clientHelloMsg)));
		if (_c.value._handshakes > ((0 : GoInt))) {
		...
		_hello.value._cipherSuites = new Slice<GoUInt16>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt16))])
			.setCap(((_configCipherSuites.length : GoInt)).toBasic());
		...
		var __tmp__ = stdgo.io.Io.readFull(_config.value._rand(), _hello.value._random),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new Pointer<T_clientHelloMsg>().nil(), _1: ((null : T_ecdheParameters)),
				_2: stdgo.errors.Errors.new_((("tls: short read from Rand: " : GoString))
				+ _err.error())};
		};
		{
			var __tmp__ = stdgo.io.Io.readFull(_config.value._rand(), _hello.value._sessionId),
				_:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return {_0: new Pointer<T_clientHelloMsg>().nil(), _1: ((null : T_ecdheParameters)),
		...
		if (_hello.value._supportedVersions[((0 : GoInt))] == versionTLS13) {
			...
			{
				var __tmp__ = _curveForCurveID(_curveID),
					_:stdgo.crypto.elliptic.Elliptic.Curve = __tmp__._0,
					_ok:Bool = __tmp__._1;
				if (_curveID.__t__ != x25519.__t__ && !_ok) {
					return {_0: new Pointer<T_clientHelloMsg>().nil(), _1: ((null : T_ecdheParameters)),
						_2: stdgo.errors.Errors.new_("tls: CurvePreferences includes unsupported curve")};
				};
			};
			{
	...
	public function _handshakeContext(_ctx:stdgo.context.Context.Context):Error {
		...
		try {
			var __tmp__ = stdgo.context.Context.withCancel(_ctx),
				_handshakeCtx:stdgo.context.Context.Context = __tmp__._0,
	...
	public function read(_b:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
		...
		try {
			...
			var __tmp__ = _c.value._input.read(_b),
				_n:GoInt = __tmp__._0,
				_:stdgo.Error = __tmp__._1;
			if (_n != ((0 : GoInt))
				&& _c.value._input.len() == ((0 : GoInt))
				&& _c.value._rawInput.len() > ((0 : GoInt))
				&& new T_recordType(_c.value._rawInput.bytes()[((0 : GoInt))]).__t__ == _recordTypeAlert.__t__) {
				{
					var _err:stdgo.Error = _c.value._readRecord();
					if (_err != null) {
						{
	...
	public function _handleKeyUpdate(_keyUpdate:Pointer<T_keyUpdateMsg>):Error {
		...
		try {
			...
			if (_keyUpdate.value._updateRequested) {
				...
				var __tmp__ = _c.value._writeRecordLocked(_recordTypeHandshake, _msg.value._marshal()),
					_:GoInt = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
	...
	public function _handlePostHandshakeMessage():Error {
		...
		if (Go.assertable(((_msg : Pointer<T_newSessionTicketMsgTLS13>)))) {
			var _msg:Pointer<T_newSessionTicketMsgTLS13> = _msg == null ? null : _msg.__underlying__() == null ? null : _msg == null ? null : _msg.__underlying__()
				.value;
	...
	public function write(_b:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
		...
		try {
			...
			if (_b.length > ((1 : GoInt)) && _c.value._vers == versionTLS10) {
				{
					...
					if (_ok) {
						var __tmp__ = _c.value._writeRecordLocked(_recordTypeApplicationData, _b.__slice__(0, ((1 : GoInt)))),
							_n:GoInt = __tmp__._0,
							_err:stdgo.Error = __tmp__._1;
						if (_err != null) {
							{
			...
			var __tmp__ = _c.value._writeRecordLocked(_recordTypeApplicationData, _b),
				_n:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			{
				for (defer in deferstack) {
	...
	public function _readHandshake():{var _0:AnyInterface; var _1:Error;} {
		...
		if (_n > _maxHandshake) {
			...
			return {_0: ((null : AnyInterface)),
				_1: _c.value._in._setErrorLocked(stdgo.fmt.Fmt.errorf("tls: handshake message of length %d bytes exceeds maximum of %d bytes",
					Go.toInterface(_n), Go.toInterface(_maxHandshake)))};
		};
		...
		if (_data[((0 : GoInt))] == _typeHelloRequest) {
			...
			if (_c.value._vers == versionTLS13) {
				...
				_m = Go.pointer((({
					_hasSignatureAlgorithm: _c.value._vers >= versionTLS12,
					_raw: new Slice<GoUInt8>().nil(),
					_certificateTypes: new Slice<GoUInt8>().nil(),
					_supportedSignatureAlgorithms: new Slice<SignatureScheme>().nil(),
					_certificateAuthorities: new Slice<Slice<GoUInt8>>().nil()
				} : T_certificateRequestMsg))).value;
			};
			...
			_m = Go.pointer((({
				_hasSignatureAlgorithm: _c.value._vers >= versionTLS12,
				_raw: new Slice<GoUInt8>().nil(),
				_signatureAlgorithm: new SignatureScheme(),
				_signature: new Slice<GoUInt8>().nil()
			} : T_certificateVerifyMsg))).value;
	...
	public function _writeRecordLocked(_typ:T_recordType, _data:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
		...
		try {
			...
			while (_data.length > ((0 : GoInt))) {
				...
				{
					var __tmp__ = _c.value._write(_outBuf),
						_:GoInt = __tmp__._0,
						_err:stdgo.Error = __tmp__._1;
					if (_err != null) {
						{
	...
	public function _flush():{var _0:GoInt; var _1:Error;} {
		...
		var __tmp__ = _c.value._conn.write(_c.value._sendBuf),
			_n:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
	...
	public function _write(_data:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
		...
		var __tmp__ = _c.value._conn.write(_data),
			_n:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		_c.value._bytesSent = _c.value._bytesSent + (((_n : GoInt64)));
		return {_0: _n, _1: _err};
	...
	public function _maxPayloadSizeForWrite(_typ:T_recordType):GoInt {
		...
		if (_c.value._out._cipher != null) {
			if (Go.assertable(((_c.value._out._cipher : stdgo.crypto.cipher.Cipher.Stream)))) {
				var _ciph:stdgo.crypto.cipher.Cipher.Stream = _c.value._out._cipher == null ? null : _c.value._out._cipher.__underlying__() == null ? null : _c.value._out._cipher == null ? null : _c.value._out._cipher.__underlying__()
					.value;
				...
				var _ciph:stdgo.crypto.cipher.Cipher.AEAD = _c.value._out._cipher == null ? null : _c.value._out._cipher.__underlying__() == null ? null : _c.value._out._cipher == null ? null : _c.value._out._cipher.__underlying__()
					.value;
				_payloadBytes = _payloadBytes - (_ciph.overhead());
			} else if (Go.assertable(((_c.value._out._cipher : T_cbcMode)))) {
				var _ciph:T_cbcMode = _c.value._out._cipher == null ? null : _c.value._out._cipher.__underlying__() == null ? null : _c.value._out._cipher == null ? null : _c.value._out._cipher.__underlying__()
					.value;
	...
	public function _sendAlertLocked(_err:T_alert):Error {
		...
		var __tmp__ = _c.value._writeRecordLocked(_recordTypeAlert, _c.value._tmp.__slice__(((0 : GoInt)), ((2 : GoInt)))),
			_:GoInt = __tmp__._0,
			_writeErr:stdgo.Error = __tmp__._1;
		if (_err.__t__ == _alertCloseNotify.__t__) {
			return _writeErr;
		};
		return _c.value._out._setErrorLocked(Go.pointer((({
			op: "local error",
			err: _err,
			net: "",
	...
	public function _readFromUntil(_r:stdgo.io.Io.Reader, _n:GoInt):Error {
		...
		var __tmp__ = _c.value._rawInput.readFrom(Go.pointer(new T_atLeastReader(_r, ((_needs : GoInt64)))).value),
	...
	public function _readRecordOrCCS(_expectChangeCipherSpec:Bool):Error {
		...
		if (!_handshakeComplete && _typ.__t__ == ((128 : GoUInt8))) {
			_c.value._sendAlert(_alertProtocolVersion);
			return _c.value._in._setErrorLocked(_c.value._newRecordHeaderError(((null : stdgo.net.Net.Conn)), "unsupported SSLv2 handshake received")
				.__copy__());
		};
		...
		if (_c.value._haveVers && _c.value._vers != versionTLS13 && _vers != _c.value._vers) {
			_c.value._sendAlert(_alertProtocolVersion);
			var _msg:GoString = stdgo.fmt.Fmt.sprintf("received record with version %x when expecting version %x", Go.toInterface(_vers),
				Go.toInterface(_c.value._vers));
		...
		if (!_c.value._haveVers) {
			if ((_typ.__t__ != _recordTypeAlert.__t__ && _typ.__t__ != _recordTypeHandshake.__t__) || _vers >= ((4096 : GoUInt16))) {
				return _c.value._in._setErrorLocked(_c.value._newRecordHeaderError(_c.value._conn, "first record does not look like a TLS handshake")
					.__copy__());
			};
		};
		...
		var __tmp__ = _c.value._in._decrypt(_record),
			_data:Slice<GoUInt8> = __tmp__._0,
			_typ:T_recordType = __tmp__._1,
			_err:stdgo.Error = __tmp__._2;
		if (_err != null) {
		...
		if (_typ.__t__ == _recordTypeAlert.__t__) {
			...
			if (_c.value._vers == versionTLS13) {
				return _c.value._in._setErrorLocked(Go.pointer((({
					op: "remote error",
					err: new T_alert(_data[((1 : GoInt))]),
					net: "",
					source: ((null : stdgo.net.Net.Addr)),
					addr: ((null : stdgo.net.Net.Addr))
				} : stdgo.net.Net.OpError))).value);
	...
	public function new(?_conn:stdgo.net.Net.Conn, ?_isClient:Bool, ?_handshakeFn:stdgo.context.Context.Context->stdgo.Error, ?_handshakeStatus:GoUInt32,
			?_handshakeMutex:stdgo.sync.Sync.Mutex, ?_handshakeErr:stdgo.Error, ?_vers:GoUInt16, ?_haveVers:Bool, ?_config:Pointer<Config>,
			?_handshakes:GoInt, ?_didResume:Bool, ?_cipherSuite:GoUInt16, ?_ocspResponse:Slice<GoUInt8>, ?_scts:Slice<Slice<GoUInt8>>,
			?_peerCertificates:Slice<Pointer<stdgo.crypto.x509.X509.Certificate>>, ?_verifiedChains:Slice<Slice<Pointer<stdgo.crypto.x509.X509.Certificate>>>,
			?_serverName:GoString, ?_secureRenegotiation:Bool, ?_ekm:(GoString, Slice<GoUInt8>, GoInt) -> {
			var _0:Slice<GoUInt8>;
			var _1:stdgo.Error;
		},
			?_resumptionSecret:Slice<GoUInt8>, ?_ticketKeys:Slice<T_ticketKey>, ?_clientFinishedIsFirst:Bool, ?_closeNotifyErr:stdgo.Error,
			?_closeNotifySent:Bool, ?_clientFinished:GoArray<GoUInt8>, ?_serverFinished:GoArray<GoUInt8>, ?_clientProtocol:GoString, ?_in:T_halfConn,
			?_out:T_halfConn, ?_rawInput:stdgo.bytes.Bytes.Buffer, ?_input:stdgo.bytes.Bytes.Reader, ?_hand:stdgo.bytes.Bytes.Buffer, ?_buffering:Bool,
			?_sendBuf:Slice<GoUInt8>, ?_bytesSent:GoInt64, ?_packetsSent:GoInt64, ?_retryCount:GoInt, ?_activeCall:GoInt32, ?_tmp:GoArray<GoUInt8>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_conn) + " " + Go.string(_isClient) + " " + Go.string(_handshakeFn) + " " + Go.string(_handshakeStatus) + " "
			+ Go.string(_handshakeMutex) + " " + Go.string(_handshakeErr) + " " + Go.string(_vers) + " " + Go.string(_haveVers) + " " + Go.string(_config)
			+ " " + Go.string(_handshakes) + " " + Go.string(_didResume) + " " + Go.string(_cipherSuite) + " " + Go.string(_ocspResponse) + " "
			+ Go.string(_scts) + " " + Go.string(_peerCertificates) + " " + Go.string(_verifiedChains) + " " + Go.string(_serverName) + " "
			+ Go.string(_secureRenegotiation) + " " + Go.string(_ekm) + " " + Go.string(_resumptionSecret) + " " + Go.string(_ticketKeys) + " "
			+ Go.string(_clientFinishedIsFirst) + " " + Go.string(_closeNotifyErr) + " " + Go.string(_closeNotifySent) + " " + Go.string(_clientFinished)
			+ " " + Go.string(_serverFinished) + " " + Go.string(_clientProtocol) + " " + Go.string(_in) + " " + Go.string(_out) + " " + Go.string(_rawInput)
			+ " " + Go.string(_input) + " " + Go.string(_hand) + " " + Go.string(_buffering) + " " + Go.string(_sendBuf) + " " + Go.string(_bytesSent) + " "
			+ Go.string(_packetsSent) + " " + Go.string(_retryCount) + " " + Go.string(_activeCall) + " " + Go.string(_tmp) + "}";
	}
	...
	public function __copy__() {
		return new Conn(_conn, _isClient, _handshakeFn, _handshakeStatus, _handshakeMutex, _handshakeErr, _vers, _haveVers, _config, _handshakes, _didResume,
			_cipherSuite, _ocspResponse, _scts, _peerCertificates, _verifiedChains, _serverName, _secureRenegotiation, _ekm, _resumptionSecret, _ticketKeys,
			_clientFinishedIsFirst, _closeNotifyErr, _closeNotifySent, _clientFinished, _serverFinished, _clientProtocol, _in, _out, _rawInput, _input, _hand,
			_buffering, _sendBuf, _bytesSent, _packetsSent, _retryCount, _activeCall, _tmp);
	}
...
@:structInit class T_halfConn {
	public function _encrypt(_record:Slice<GoByte>, _payload:Slice<GoByte>, _rand:stdgo.io.Io.Reader):{var _0:Slice<GoByte>; var _1:Error;} {
			...
			if (_explicitNonceLen > ((0 : GoInt))) {
				...
				};
				{
					...
					if (!_isCBC && _explicitNonceLen < ((16 : GoInt))) {
						...
						{
							var __tmp__ = stdgo.io.Io.readFull(_rand, _explicitNonce),
								_:GoInt = __tmp__._0,
								_err:stdgo.Error = __tmp__._1;
							if (_err != null) {
								return {_0: new Slice<GoUInt8>().nil(), _1: _err};
		...
		if (Go.assertable(((_hc.value._cipher : stdgo.crypto.cipher.Cipher.Stream)))) {
			var _c:stdgo.crypto.cipher.Cipher.Stream = _hc.value._cipher == null ? null : _hc.value._cipher.__underlying__() == null ? null : _hc.value._cipher == null ? null : _hc.value._cipher.__underlying__()
				.value;
			var _mac:Slice<GoUInt8> = _tls10MAC(_hc.value._mac, _hc.value._scratchBuf.__slice__(0, ((0 : GoInt))), _hc.value._seq.__slice__(0),
				_record.__slice__(0, _recordHeaderLen), _payload, new Slice<GoUInt8>().nil());
			{
			...
			var _c:T_aead = _hc.value._cipher == null ? null : _hc.value._cipher.__underlying__() == null ? null : _hc.value._cipher == null ? null : _hc.value._cipher.__underlying__()
				.value;
			...
			var _c:T_cbcMode = _hc.value._cipher == null ? null : _hc.value._cipher.__underlying__() == null ? null : _hc.value._cipher == null ? null : _hc.value._cipher.__underlying__()
				.value;
			var _mac:Slice<GoUInt8> = _tls10MAC(_hc.value._mac, _hc.value._scratchBuf.__slice__(0, ((0 : GoInt))), _hc.value._seq.__slice__(0),
				_record.__slice__(0, _recordHeaderLen), _payload, new Slice<GoUInt8>().nil());
	...
	public function _decrypt(_record:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:T_recordType; var _2:Error;} {
		...
		if (_hc.value._mac != null) {
			...
			var _localMAC:Slice<GoUInt8> = _tls10MAC(_hc.value._mac, _hc.value._scratchBuf.__slice__(0, ((0 : GoInt))), _hc.value._seq.__slice__(0),
				_record.__slice__(0, _recordHeaderLen), _payload.__slice__(0, _n), _payload.__slice__(_n + _macSize));
	...
	public function _setTrafficSecret(_suite:Pointer<T_cipherSuiteTLS13>, _secret:Slice<GoByte>):Void {
		...
		var __tmp__ = _suite.value._trafficKey(_secret),
			_key:Slice<GoUInt8> = __tmp__._0,
			_iv:Slice<GoUInt8> = __tmp__._1;
	...
	public function new(?mutex:stdgo.sync.Sync.Mutex, ?_err:stdgo.Error, ?_version:GoUInt16, ?_cipher:AnyInterface, ?_mac:stdgo.hash.Hash.Hash,
			?_seq:GoArray<GoUInt8>, ?_scratchBuf:GoArray<GoUInt8>, ?_nextCipher:AnyInterface, ?_nextMac:stdgo.hash.Hash.Hash, ?_trafficSecret:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(mutex) + " " + Go.string(_err) + " " + Go.string(_version) + " " + Go.string(_cipher) + " " + Go.string(_mac) + " "
			+ Go.string(_seq) + " " + Go.string(_scratchBuf) + " " + Go.string(_nextCipher) + " " + Go.string(_nextMac) + " " + Go.string(_trafficSecret) + "}";
	}
...
@:structInit class T_permanentError {
	...
	public function new(?_err:stdgo.net.Net.T_error)
		stdgo.internal.Macro.initLocals();
...
@:structInit class RecordHeaderError {
	...
	public function new(?msg:GoString, ?recordHeader:GoArray<GoUInt8>, ?conn:stdgo.net.Net.Conn)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_atLeastReader {
	public function read(_p:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
		...
		var __tmp__ = _r.value.r.read(_p),
			_n:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
...
@:structInit class T_clientHandshakeState {
	public function _sendFinished(_out:Slice<GoByte>):Error {
		...
		{
			var __tmp__ = _c.value._writeRecord(_recordTypeChangeCipherSpec, new Slice<GoUInt8>(((1 : GoUInt8)))),
				_:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return _err;
		...
		{
			var __tmp__ = _c.value._writeRecord(_recordTypeHandshake, _finished.value._marshal()),
				_:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return _err;
	...
	public function _readSessionTicket():Error {
		...
		_hs.value._session = Go.pointer((({
			_sessionTicket: _sessionTicketMsg.value._ticket,
			_vers: _c.value._vers,
			_cipherSuite: _hs.value._suite.value._id,
			_masterSecret: _hs.value._masterSecret,
			_serverCertificates: _c.value._peerCertificates,
			_verifiedChains: _c.value._verifiedChains,
			_receivedAt: _c.value._config.value._time().__copy__(),
			_ocspResponse: _c.value._ocspResponse,
			_scts: _c.value._scts,
			_nonce: new Slice<GoUInt8>().nil(),
			_useBy: new stdgo.time.Time.Time(),
			_ageAdd: 0
		} : ClientSessionState)));
		return ((null : stdgo.Error));
	}
	...
	public function _readFinished(_out:Slice<GoByte>):Error {
		...
		if (_verify.length != _serverFinished.value._verifyData.length
			|| stdgo.crypto.subtle.Subtle.constantTimeCompare(_verify, _serverFinished.value._verifyData) != ((1 : GoInt))) {
	...
	public function _serverResumedSession():Bool {
		var _hs = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		return (_hs.value._session != null && !_hs.value._session.isNil())
			&& (_hs.value._hello.value._sessionId != null && !_hs.value._hello.value._sessionId.isNil())
			&& stdgo.bytes.Bytes.equal(_hs.value._serverHello.value._sessionId, _hs.value._hello.value._sessionId);
	}

	public function _establishKeys():Error {
		var _hs = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _c:Pointer<Conn> = _hs.value._c;
		var __tmp__ = _keysFromMasterSecret(_c.value._vers, _hs.value._suite, _hs.value._masterSecret, _hs.value._hello.value._random,
			_hs.value._serverHello.value._random, _hs.value._suite.value._macLen, _hs.value._suite.value._keyLen, _hs.value._suite.value._ivLen),
			_clientMAC:Slice<GoUInt8> = __tmp__._0,
			_serverMAC:Slice<GoUInt8> = __tmp__._1,
			_clientKey:Slice<GoUInt8> = __tmp__._2,
			_serverKey:Slice<GoUInt8> = __tmp__._3,
			_clientIV:Slice<GoUInt8> = __tmp__._4,
			_serverIV:Slice<GoUInt8> = __tmp__._5;
		var _clientCipher:AnyInterface = ((null : AnyInterface)),
			_serverCipher:AnyInterface = ((null : AnyInterface));
		var _clientHash:stdgo.hash.Hash.Hash = ((null : stdgo.hash.Hash.Hash)),
			_serverHash:stdgo.hash.Hash.Hash = ((null : stdgo.hash.Hash.Hash));
	...
	public function _doFullHandshake():Error {
		...
		if (_ok) {
			...
			_err = _keyAgreement._processServerKeyExchange(_c.value._config, _hs.value._hello, _hs.value._serverHello,
				_c.value._peerCertificates[((0 : GoInt))], _skx);
			if (_err != null) {
				_c.value._sendAlert(_alertUnexpectedMessage);
				return _err;
			};
		...
		if (_certRequested) {
			...
			_hs.value._finishedHash.write(_certMsg.value._marshal());
			{
				var __tmp__ = _c.value._writeRecord(_recordTypeHandshake, _certMsg.value._marshal()),
					_:GoInt = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
					return _err;
		...
		var __tmp__ = _keyAgreement._generateClientKeyExchange(_c.value._config, _hs.value._hello, _c.value._peerCertificates[((0 : GoInt))]),
			_preMasterSecret:Slice<GoUInt8> = __tmp__._0,
			_ckx:Pointer<T_clientKeyExchangeMsg> = __tmp__._1,
			_err:stdgo.Error = __tmp__._2;
		if (_err != null) {
			_c.value._sendAlert(_alertInternalError);
			return _err;
		...
		if ((_ckx != null && !_ckx.isNil())) {
			...
			{
				var __tmp__ = _c.value._writeRecord(_recordTypeHandshake, _ckx.value._marshal()),
					_:GoInt = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
					return _err;
		...
		if ((_chainToSend != null && !_chainToSend.isNil()) && _chainToSend.value.certificate.length > ((0 : GoInt))) {
			...
			if (!_ok) {
				_c.value._sendAlert(_alertInternalError);
				return stdgo.fmt.Fmt.errorf("tls: client certificate private key of type %T does not implement crypto.Signer",
					Go.toInterface(_chainToSend.value.privateKey));
			};
			...
			if (_c.value._vers >= versionTLS12) {
				var __tmp__ = _selectSignatureScheme(_c.value._vers, _chainToSend, _certReq.value._supportedSignatureAlgorithms),
					_signatureAlgorithm:SignatureScheme = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
					_c.value._sendAlert(_alertIllegalParameter);
					return _err;
			...
			{
				var __tmp__ = _c.value._writeRecord(_recordTypeHandshake, _certVerify.value._marshal()),
					_:GoInt = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
					return _err;
		...
		_hs.value._masterSecret = _masterFromPreMasterSecret(_c.value._vers, _hs.value._suite, _preMasterSecret, _hs.value._hello.value._random,
			_hs.value._serverHello.value._random);
		{
	...
	public function _handshake():Error {
		var _hs = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _c:Pointer<Conn> = _hs.value._c;
		var __tmp__ = _hs.value._processServerHello(),
			_isResume:Bool = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return _err;
		};
		...
		if (_isResume
			|| (_c.value._config.value.certificates.length == ((0 : GoInt)) && _c.value._config.value.getClientCertificate == null)) {
			_hs.value._finishedHash._discardHandshakeBuffer();
		};
		...
		_c.value._ekm = _ekmFromMasterSecret(_c.value._vers, _hs.value._suite, _hs.value._masterSecret, _hs.value._hello.value._random,
			_hs.value._serverHello.value._random);
	...
	public function new(?_c:Pointer<Conn>, ?_ctx:stdgo.context.Context.Context, ?_serverHello:Pointer<T_serverHelloMsg>, ?_hello:Pointer<T_clientHelloMsg>,
			?_suite:Pointer<T_cipherSuite>, ?_finishedHash:T_finishedHash, ?_masterSecret:Slice<GoUInt8>, ?_session:Pointer<ClientSessionState>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_c) + " " + Go.string(_ctx) + " " + Go.string(_serverHello) + " " + Go.string(_hello) + " " + Go.string(_suite) + " "
			+ Go.string(_finishedHash) + " " + Go.string(_masterSecret) + " " + Go.string(_session) + "}";
	}
...
@:structInit class T_clientHandshakeStateTLS13 {
	public function _sendClientFinished():Error {
		var _hs = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _c:Pointer<Conn> = _hs.value._c;
		var _finished:Pointer<T_finishedMsg> = Go.pointer((({_verifyData: _hs.value._suite.value._finishedHash(_c.value._out._trafficSecret,
			_hs.value._transcript), _raw: new Slice<GoUInt8>().nil()} : T_finishedMsg)));
	...
	public function _sendClientCertificate():Error {
		...
		var __tmp__ = _c.value._getClientCertificate(Go.pointer((({
			acceptableCAs: _hs.value._certReq.value._certificateAuthorities,
			signatureSchemes: _hs.value._certReq.value._supportedSignatureAlgorithms,
			version: _c.value._vers,
			_ctx: _hs.value._ctx
		} : CertificateRequestInfo)))), _cert:Pointer<Certificate> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return _err;
		};
		...
		var __tmp__ = _typeAndHashFromSignatureScheme(_certVerifyMsg.value._signatureAlgorithm),
			_sigType:GoUInt8 = __tmp__._0,
			_sigHash:stdgo.crypto.Crypto.Hash = __tmp__._1,
			_err:stdgo.Error = __tmp__._2;
		if (_err != null) {
			return _c.value._sendAlert(_alertInternalError);
		};
		...
		var __tmp__ = ((_cert.value.privateKey.value : stdgo.crypto.Crypto.Signer)).sign(_c.value._config.value._rand(), _signed, _signOpts),
			_sig:Slice<GoUInt8> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			_c.value._sendAlert(_alertInternalError);
		...
		{
			var __tmp__ = _c.value._writeRecord(_recordTypeHandshake, _certVerifyMsg.value._marshal()),
				_:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return _err;
	...
	public function _readServerFinished():Error {
		...
		var _serverSecret:Slice<GoUInt8> = _hs.value._suite.value._deriveSecret(_hs.value._masterSecret, _serverApplicationTrafficLabel,
			_hs.value._transcript);
	...
	public function _readServerCertificate():Error {
		...
		{
			var _err:stdgo.Error = _verifyHandshakeSignature(_sigType, Go.toInterface(_c.value._peerCertificates[((0 : GoInt))].value.publicKey), _sigHash,
				_signed, _certVerify.value._signature);
			if (_err != null) {
				_c.value._sendAlert(_alertDecryptError);
	...
	public function _establishHandshakeKeys():Error {
		...
		var _handshakeSecret:Slice<GoUInt8> = _hs.value._suite.value._extract(_sharedKey,
			_hs.value._suite.value._deriveSecret(_earlySecret, "derived", ((null : stdgo.hash.Hash.Hash))));
		...
		_hs.value._masterSecret = _hs.value._suite.value._extract(new Slice<GoUInt8>().nil(),
			_hs.value._suite.value._deriveSecret(_handshakeSecret, "derived", ((null : stdgo.hash.Hash.Hash))));
		return ((null : stdgo.Error));
	}
	...
	public function _processHelloRetryRequest():Error {
		...
		if (_hs.value._serverHello.value._selectedGroup.__t__ == ((0 : GoUInt16))
			&& (_hs.value._serverHello.value._cookie == null || _hs.value._serverHello.value._cookie.isNil())) {
			_c.value._sendAlert(_alertIllegalParameter);
		...
		};
		{
			...
			if (_curveID.__t__ != ((0 : GoUInt16))) {
				...
				var __tmp__ = _generateECDHEParameters(_c.value._config.value._rand(), _curveID),
					_params:T_ecdheParameters = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
					_c.value._sendAlert(_alertInternalError);
					return _err;
		...
		if (_hs.value._hello.value._pskIdentities.length > ((0 : GoInt))) {
			...
			if (_pskSuite.value._hash.__t__ == _hs.value._suite.value._hash.__t__) {
				var _ticketAge:GoUInt32 = new stdgo.time.Time.Duration(_c.value._config.value._time()
					.sub(_hs.value._session.value._receivedAt.__copy__())
					.__t__ / stdgo.time.Time.millisecond.__t__).__t__;
		...
		{
			var __tmp__ = _c.value._writeRecord(_recordTypeHandshake, _hs.value._hello.value._marshal()),
				_:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return _err;
	...
	public function _sendDummyChangeCipherSpec():Error {
		...
		var __tmp__ = _hs.value._c.value._writeRecord(_recordTypeChangeCipherSpec, new Slice<GoUInt8>(((1 : GoUInt8)))),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		return _err;
	}
	...
	public function _checkServerHelloOrHRR():Error {
		...
		if (_hs.value._serverHello.value._ocspStapling
			|| _hs.value._serverHello.value._ticketSupported
			|| _hs.value._serverHello.value._secureRenegotiationSupported
			|| _hs.value._serverHello.value._secureRenegotiation.length != ((0 : GoInt))
			|| _hs.value._serverHello.value._alpnProtocol.length != ((0 : GoInt))
			|| _hs.value._serverHello.value._scts.length != ((0 : GoInt))) {
			_c.value._sendAlert(_alertUnsupportedExtension);
		...
		var _selectedSuite:Pointer<T_cipherSuiteTLS13> = _mutualCipherSuiteTLS13(_hs.value._hello.value._cipherSuites,
			_hs.value._serverHello.value._cipherSuite);
	...
	public function new(?_c:Pointer<Conn>, ?_ctx:stdgo.context.Context.Context, ?_serverHello:Pointer<T_serverHelloMsg>, ?_hello:Pointer<T_clientHelloMsg>,
			?_ecdheParams:T_ecdheParameters, ?_session:Pointer<ClientSessionState>, ?_earlySecret:Slice<GoUInt8>, ?_binderKey:Slice<GoUInt8>,
			?_certReq:Pointer<T_certificateRequestMsgTLS13>, ?_usingPSK:Bool, ?_sentDummyCCS:Bool, ?_suite:Pointer<T_cipherSuiteTLS13>,
			?_transcript:stdgo.hash.Hash.Hash, ?_masterSecret:Slice<GoUInt8>, ?_trafficSecret:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_c) + " " + Go.string(_ctx) + " " + Go.string(_serverHello) + " " + Go.string(_hello) + " " + Go.string(_ecdheParams) + " "
			+ Go.string(_session) + " " + Go.string(_earlySecret) + " " + Go.string(_binderKey) + " " + Go.string(_certReq) + " " + Go.string(_usingPSK)
			+ " " + Go.string(_sentDummyCCS) + " " + Go.string(_suite) + " " + Go.string(_transcript) + " " + Go.string(_masterSecret) + " "
			+ Go.string(_trafficSecret) + "}";
	}
	...
	public function __copy__() {
		return new T_clientHandshakeStateTLS13(_c, _ctx, _serverHello, _hello, _ecdheParams, _session, _earlySecret, _binderKey, _certReq, _usingPSK,
			_sentDummyCCS, _suite, _transcript, _masterSecret, _trafficSecret);
	}
...
@:named class T_marshalingFunction {
	...
	public function __copy__()
		return new T_marshalingFunction(__t__);
}
...
@:structInit class T_clientHelloMsg {
	public function _unmarshal(_data:Slice<GoByte>):Bool {
		...
		_m.value = (({
			_raw: _data,
			_vers: 0,
			_random: new Slice<GoUInt8>().nil(),
			_sessionId: new Slice<GoUInt8>().nil(),
			_cipherSuites: new Slice<GoUInt16>().nil(),
			_compressionMethods: new Slice<GoUInt8>().nil(),
			_serverName: "",
			_ocspStapling: false,
			_supportedCurves: new Slice<CurveID>().nil(),
			_supportedPoints: new Slice<GoUInt8>().nil(),
			_ticketSupported: false,
			_sessionTicket: new Slice<GoUInt8>().nil(),
			_supportedSignatureAlgorithms: new Slice<SignatureScheme>().nil(),
			_supportedSignatureAlgorithmsCert: new Slice<SignatureScheme>().nil(),
			_secureRenegotiationSupported: false,
			_secureRenegotiation: new Slice<GoUInt8>().nil(),
			_alpnProtocols: new Slice<GoString>().nil(),
			_scts: false,
			_supportedVersions: new Slice<GoUInt16>().nil(),
			_cookie: new Slice<GoUInt8>().nil(),
			_keyShares: new Slice<T_keyShare>().nil(),
			_earlyData: false,
			_pskModes: new Slice<GoUInt8>().nil(),
		...
		if (!_s.skip(((4 : GoInt)))
			|| !_s.readUint16(Go.pointer(_m.value._vers))
			|| !_s.readBytes(Go.pointer(_m.value._random), ((32 : GoInt)))
			|| !_readUint8LengthPrefixed(Go.pointer(_s), Go.pointer(_m.value._sessionId))) {
			return false;
		};
		...
		while (!_extensions.empty()) {
			...
			if (_extension == _extensionServerName) {
				...
				while (!_nameList.empty()) {
					...
					if (!_nameList.readUint8(Go.pointer(_nameType))
						|| !_nameList.readUint16LengthPrefixed(Go.pointer(_serverName))
						|| _serverName.empty()) {
						return false;
					};
				...
				if (!_extData.readUint8(Go.pointer(_statusType))
					|| !_extData.readUint16LengthPrefixed(Go.pointer(_ignored))
					|| !_extData.readUint16LengthPrefixed(Go.pointer(_ignored))) {
					return false;
				};
				...
				if (!_readUint8LengthPrefixed(Go.pointer(_extData), Go.pointer(_m.value._supportedPoints))
					|| _m.value._supportedPoints.length == ((0 : GoInt))) {
					return false;
				};
				...
				if (!_readUint16LengthPrefixed(Go.pointer(_extData), Go.pointer(_m.value._cookie))
					|| _m.value._cookie.length == ((0 : GoInt))) {
					return false;
				};
				...
				while (!_clientShares.empty()) {
					...
					if (!_clientShares.readUint16(new Pointer<GoUInt16>(() -> Go.pointer(_ks._group).value.__t__,
						v -> (Go.pointer(_ks._group).value = new CurveID(v)).__t__))
						|| !_readUint16LengthPrefixed(Go.pointer(_clientShares), Go.pointer(_ks._data))
						|| _ks._data.length == ((0 : GoInt))) {
						return false;
					};
				...
				while (!_identities.empty()) {
					...
					if (!_readUint16LengthPrefixed(Go.pointer(_identities), Go.pointer(_psk._label))
						|| !_identities.readUint32(Go.pointer(_psk._obfuscatedTicketAge))
						|| _psk._label.length == ((0 : GoInt))) {
						return false;
					};
	...
	public function _updateBinders(_pskBinders:Slice<Slice<GoByte>>):Void {
		...
		if ((_m.value._raw != null && !_m.value._raw.isNil())) {
			...
			var _b:Pointer<vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.Builder> = golang_org.x.crypto.cryptobyte.Cryptobyte.newBuilder(_m.value._raw.__slice__(0,
				_lenWithoutBinders));
	...
	public function new(?_raw:Slice<GoUInt8>, ?_vers:GoUInt16, ?_random:Slice<GoUInt8>, ?_sessionId:Slice<GoUInt8>, ?_cipherSuites:Slice<GoUInt16>,
			?_compressionMethods:Slice<GoUInt8>, ?_serverName:GoString, ?_ocspStapling:Bool, ?_supportedCurves:Slice<CurveID>,
			?_supportedPoints:Slice<GoUInt8>, ?_ticketSupported:Bool, ?_sessionTicket:Slice<GoUInt8>, ?_supportedSignatureAlgorithms:Slice<SignatureScheme>,
			?_supportedSignatureAlgorithmsCert:Slice<SignatureScheme>, ?_secureRenegotiationSupported:Bool, ?_secureRenegotiation:Slice<GoUInt8>,
			?_alpnProtocols:Slice<GoString>, ?_scts:Bool, ?_supportedVersions:Slice<GoUInt16>, ?_cookie:Slice<GoUInt8>, ?_keyShares:Slice<T_keyShare>,
			?_earlyData:Bool, ?_pskModes:Slice<GoUInt8>, ?_pskIdentities:Slice<T_pskIdentity>, ?_pskBinders:Slice<Slice<GoUInt8>>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_raw) + " " + Go.string(_vers) + " " + Go.string(_random) + " " + Go.string(_sessionId) + " " + Go.string(_cipherSuites)
			+ " " + Go.string(_compressionMethods) + " " + Go.string(_serverName) + " " + Go.string(_ocspStapling) + " " + Go.string(_supportedCurves) + " "
			+ Go.string(_supportedPoints) + " " + Go.string(_ticketSupported) + " " + Go.string(_sessionTicket) + " "
			+ Go.string(_supportedSignatureAlgorithms) + " " + Go.string(_supportedSignatureAlgorithmsCert) + " " + Go.string(_secureRenegotiationSupported)
			+ " " + Go.string(_secureRenegotiation) + " " + Go.string(_alpnProtocols) + " " + Go.string(_scts) + " " + Go.string(_supportedVersions) + " "
			+ Go.string(_cookie) + " " + Go.string(_keyShares) + " " + Go.string(_earlyData) + " " + Go.string(_pskModes) + " " + Go.string(_pskIdentities)
			+ " " + Go.string(_pskBinders) + "}";
	}
	...
	public function __copy__() {
		return new T_clientHelloMsg(_raw, _vers, _random, _sessionId, _cipherSuites, _compressionMethods, _serverName, _ocspStapling, _supportedCurves,
			_supportedPoints, _ticketSupported, _sessionTicket, _supportedSignatureAlgorithms, _supportedSignatureAlgorithmsCert,
			_secureRenegotiationSupported, _secureRenegotiation, _alpnProtocols, _scts, _supportedVersions, _cookie, _keyShares, _earlyData, _pskModes,
			_pskIdentities, _pskBinders);
	}
...
@:structInit class T_serverHelloMsg {
	public function _unmarshal(_data:Slice<GoByte>):Bool {
		...
		_m.value = (({
			...
			_secureRenegotiation: new Slice<GoUInt8>().nil(),
			_alpnProtocol: "",
			_scts: new Slice<Slice<GoUInt8>>().nil(),
			_supportedVersion: 0,
			_serverShare: new T_keyShare(),
			_selectedIdentityPresent: false,
			_selectedIdentity: 0,
			_supportedPoints: new Slice<GoUInt8>().nil(),
			_cookie: new Slice<GoUInt8>().nil(),
			_selectedGroup: new CurveID()
		} : T_serverHelloMsg)).__copy__();
		var _s:vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new golang_org.x.crypto.cryptobyte.Cryptobyte.String_(_data).__copy__();
		if (!_s.skip(((4 : GoInt)))
			|| !_s.readUint16(Go.pointer(_m.value._vers))
			|| !_s.readBytes(Go.pointer(_m.value._random), ((32 : GoInt)))
			|| !_readUint8LengthPrefixed(Go.pointer(_s), Go.pointer(_m.value._sessionId))
			|| !_s.readUint16(Go.pointer(_m.value._cipherSuite))
			|| !_s.readUint8(Go.pointer(_m.value._compressionMethod))) {
			return false;
		};
		if (_s.empty()) {
			return true;
		...
		while (!_extensions.empty()) {
			...
			if (_extension == _extensionStatusRequest) {
				...
				if (_extData.__t__.length == ((2 : GoInt))) {
					if (!_extData.readUint16(new Pointer<GoUInt16>(() -> Go.pointer(_m.value._selectedGroup).value.__t__,
						v -> (Go.pointer(_m.value._selectedGroup).value = new CurveID(v)).__t__))) {
						return false;
					};
				} else {
					if (!_extData.readUint16(new Pointer<GoUInt16>(() -> Go.pointer(_m.value._serverShare._group).value.__t__,
						v -> (Go.pointer(_m.value._serverShare._group).value = new CurveID(v)).__t__))
						|| !_readUint16LengthPrefixed(Go.pointer(_extData), Go.pointer(_m.value._serverShare._data))) {
						return false;
					};
				};
			} else if (_extension == _extensionPreSharedKey) {
	...
	public function new(?_raw:Slice<GoUInt8>, ?_vers:GoUInt16, ?_random:Slice<GoUInt8>, ?_sessionId:Slice<GoUInt8>, ?_cipherSuite:GoUInt16,
			?_compressionMethod:GoUInt8, ?_ocspStapling:Bool, ?_ticketSupported:Bool, ?_secureRenegotiationSupported:Bool,
			?_secureRenegotiation:Slice<GoUInt8>, ?_alpnProtocol:GoString, ?_scts:Slice<Slice<GoUInt8>>, ?_supportedVersion:GoUInt16,
			?_serverShare:T_keyShare, ?_selectedIdentityPresent:Bool, ?_selectedIdentity:GoUInt16, ?_supportedPoints:Slice<GoUInt8>, ?_cookie:Slice<GoUInt8>,
			?_selectedGroup:CurveID)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_raw) + " " + Go.string(_vers) + " " + Go.string(_random) + " " + Go.string(_sessionId) + " " + Go.string(_cipherSuite) + " "
			+ Go.string(_compressionMethod) + " " + Go.string(_ocspStapling) + " " + Go.string(_ticketSupported) + " "
			+ Go.string(_secureRenegotiationSupported) + " " + Go.string(_secureRenegotiation) + " " + Go.string(_alpnProtocol) + " " + Go.string(_scts)
			+ " " + Go.string(_supportedVersion) + " " + Go.string(_serverShare) + " " + Go.string(_selectedIdentityPresent) + " "
			+ Go.string(_selectedIdentity) + " " + Go.string(_supportedPoints) + " " + Go.string(_cookie) + " " + Go.string(_selectedGroup) + "}";
	}
	...
	public function __copy__() {
		return new T_serverHelloMsg(_raw, _vers, _random, _sessionId, _cipherSuite, _compressionMethod, _ocspStapling, _ticketSupported,
			_secureRenegotiationSupported, _secureRenegotiation, _alpnProtocol, _scts, _supportedVersion, _serverShare, _selectedIdentityPresent,
			_selectedIdentity, _supportedPoints, _cookie, _selectedGroup);
	}
...
@:structInit class T_encryptedExtensionsMsg {
	...
	public function new(?_raw:Slice<GoUInt8>, ?_alpnProtocol:GoString)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_keyUpdateMsg {
	...
	public function new(?_raw:Slice<GoUInt8>, ?_updateRequested:Bool)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_newSessionTicketMsgTLS13 {
	public function _unmarshal(_data:Slice<GoByte>):Bool {
		...
		_m.value = (({
			...
			_ageAdd: 0,
			_nonce: new Slice<GoUInt8>().nil(),
			_label: new Slice<GoUInt8>().nil(),
			_maxEarlyData: 0
		} : T_newSessionTicketMsgTLS13)).__copy__();
		var _s:vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new golang_org.x.crypto.cryptobyte.Cryptobyte.String_(_data).__copy__();
		var _extensions:golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_();
		if (!_s.skip(((4 : GoInt)))
			|| !_s.readUint32(Go.pointer(_m.value._lifetime))
			|| !_s.readUint32(Go.pointer(_m.value._ageAdd))
			|| !_readUint8LengthPrefixed(Go.pointer(_s), Go.pointer(_m.value._nonce))
			|| !_readUint16LengthPrefixed(Go.pointer(_s), Go.pointer(_m.value._label))
			|| !_s.readUint16LengthPrefixed(Go.pointer(_extensions))
			|| !_s.empty()) {
			return false;
		};
		while (!_extensions.empty()) {
	...
	public function new(?_raw:Slice<GoUInt8>, ?_lifetime:GoUInt32, ?_ageAdd:GoUInt32, ?_nonce:Slice<GoUInt8>, ?_label:Slice<GoUInt8>, ?_maxEarlyData:GoUInt32)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_raw) + " " + Go.string(_lifetime) + " " + Go.string(_ageAdd) + " " + Go.string(_nonce) + " " + Go.string(_label) + " "
			+ Go.string(_maxEarlyData) + "}";
	}
...
@:structInit class T_certificateRequestMsgTLS13 {
	public function _unmarshal(_data:Slice<GoByte>):Bool {
		...
		_m.value = (({
			...
			_supportedSignatureAlgorithmsCert: new Slice<SignatureScheme>().nil(),
			_certificateAuthorities: new Slice<Slice<GoUInt8>>().nil()
		} : T_certificateRequestMsgTLS13)).__copy__();
		var _s:vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new golang_org.x.crypto.cryptobyte.Cryptobyte.String_(_data).__copy__();
		var _context:golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_(),
			_extensions:golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_();
		if (!_s.skip(((4 : GoInt)))
			|| !_s.readUint8LengthPrefixed(Go.pointer(_context))
			|| !_context.empty()
			|| !_s.readUint16LengthPrefixed(Go.pointer(_extensions))
			|| !_s.empty()) {
			return false;
	...
	public function new(?_raw:Slice<GoUInt8>, ?_ocspStapling:Bool, ?_scts:Bool, ?_supportedSignatureAlgorithms:Slice<SignatureScheme>,
			?_supportedSignatureAlgorithmsCert:Slice<SignatureScheme>, ?_certificateAuthorities:Slice<Slice<GoUInt8>>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_raw) + " " + Go.string(_ocspStapling) + " " + Go.string(_scts) + " " + Go.string(_supportedSignatureAlgorithms) + " "
			+ Go.string(_supportedSignatureAlgorithmsCert) + " " + Go.string(_certificateAuthorities) + "}";
	}
	...
	public function __copy__() {
		return new T_certificateRequestMsgTLS13(_raw, _ocspStapling, _scts, _supportedSignatureAlgorithms, _supportedSignatureAlgorithmsCert,
...
@:structInit class T_certificateMsg {
	...
	public function new(?_raw:Slice<GoUInt8>, ?_certificates:Slice<Slice<GoUInt8>>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_certificateMsgTLS13 {
	public function _unmarshal(_data:Slice<GoByte>):Bool {
		...
		_m.value = (({
			...
			_ocspStapling: false,
			_scts: false
		} : T_certificateMsgTLS13)).__copy__();
		var _s:vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new golang_org.x.crypto.cryptobyte.Cryptobyte.String_(_data).__copy__();
		var _context:golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_();
		if (!_s.skip(((4 : GoInt)))
			|| !_s.readUint8LengthPrefixed(Go.pointer(_context))
			|| !_context.empty()
			|| !_unmarshalCertificate(Go.pointer(_s), Go.pointer(_m.value._certificate))
			|| !_s.empty()) {
			return false;
		};
		_m.value._scts = (_m.value._certificate.signedCertificateTimestamps != null
			&& !_m.value._certificate.signedCertificateTimestamps.isNil());
	...
	public function new(?_raw:Slice<GoUInt8>, ?_certificate:Certificate, ?_ocspStapling:Bool, ?_scts:Bool)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_serverKeyExchangeMsg {
	...
	public function new(?_raw:Slice<GoUInt8>, ?_key:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_certificateStatusMsg {
	public function _unmarshal(_data:Slice<GoByte>):Bool {
		...
		var _statusType:GoUInt8 = ((0 : GoUInt8));
		if (!_s.skip(((4 : GoInt)))
			|| !_s.readUint8(Go.pointer(_statusType))
			|| _statusType != _statusTypeOCSP
			|| !_readUint24LengthPrefixed(Go.pointer(_s), Go.pointer(_m.value._response))
			|| _m.value._response.length == ((0 : GoInt))
			|| !_s.empty()) {
			return false;
		};
		return true;
	...
	public function new(?_raw:Slice<GoUInt8>, ?_response:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_clientKeyExchangeMsg {
	...
	public function new(?_raw:Slice<GoUInt8>, ?_ciphertext:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_finishedMsg {
	...
	public function new(?_raw:Slice<GoUInt8>, ?_verifyData:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_certificateRequestMsg {
	public function _unmarshal(_data:Slice<GoByte>):Bool {
		...
		if (_m.value._hasSignatureAlgorithm) {
			...
			for (_i => _ in _m.value._supportedSignatureAlgorithms) {
				_m.value._supportedSignatureAlgorithms[_i] = new SignatureScheme((new SignatureScheme(new SignatureScheme(_data[((0 : GoInt))])
					.__t__ << ((8 : GoUnTypedInt)))).__t__ | new SignatureScheme(_data[((1 : GoInt))])
					.__t__);
				_data = _data.__slice__(((2 : GoInt)));
			};
		};
	...
	public function new(?_raw:Slice<GoUInt8>, ?_hasSignatureAlgorithm:Bool, ?_certificateTypes:Slice<GoUInt8>,
			?_supportedSignatureAlgorithms:Slice<SignatureScheme>, ?_certificateAuthorities:Slice<Slice<GoUInt8>>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_raw) + " " + Go.string(_hasSignatureAlgorithm) + " " + Go.string(_certificateTypes) + " "
			+ Go.string(_supportedSignatureAlgorithms) + " " + Go.string(_certificateAuthorities) + "}";
	}
...
@:structInit class T_certificateVerifyMsg {
	public function _unmarshal(_data:Slice<GoByte>):Bool {
		...
		if (_m.value._hasSignatureAlgorithm) {
			if (!_s.readUint16(new Pointer<GoUInt16>(() -> Go.pointer(_m.value._signatureAlgorithm).value.__t__,
				v -> (Go.pointer(_m.value._signatureAlgorithm).value = new SignatureScheme(v)).__t__))) {
				return false;
			};
		};
	...
	public function new(?_raw:Slice<GoUInt8>, ?_hasSignatureAlgorithm:Bool, ?_signatureAlgorithm:SignatureScheme, ?_signature:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();
	...
	public function toString() {
		return '{'
			+ Go.string(_raw)
			+ " "
			+ Go.string(_hasSignatureAlgorithm)
			+ " "
			+ Go.string(_signatureAlgorithm)
			+ " "
			+ Go.string(_signature)
			+ "}";
	}
...
@:structInit class T_newSessionTicketMsg {
	...
	public function new(?_raw:Slice<GoUInt8>, ?_ticket:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_serverHandshakeState {
	...
	public function _sendSessionTicket():Error {
		...
		var _state:T_sessionState = (({
			_vers: _c.value._vers,
			_cipherSuite: _hs.value._suite.value._id,
			_createdAt: _createdAt,
			_masterSecret: _hs.value._masterSecret,
			_certificates: _certsFromClient,
			_usedOldKey: false
		} : T_sessionState)).__copy__();
		var _err:Error = ((null : stdgo.Error));
		{
		...
		{
			var __tmp__ = _c.value._writeRecord(_recordTypeHandshake, _m.value._marshal()),
				_:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return _err;
	...
	public function _readFinished(_out:Slice<GoByte>):Error {
		...
		if (_verify.length != _clientFinished.value._verifyData.length
			|| stdgo.crypto.subtle.Subtle.constantTimeCompare(_verify, _clientFinished.value._verifyData) != ((1 : GoInt))) {
			_c.value._sendAlert(_alertHandshakeFailure);
	...
	public function _establishKeys():Error {
		var _hs = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _c:Pointer<Conn> = _hs.value._c;
		var __tmp__ = _keysFromMasterSecret(_c.value._vers, _hs.value._suite, _hs.value._masterSecret, _hs.value._clientHello.value._random,
			_hs.value._hello.value._random, _hs.value._suite.value._macLen, _hs.value._suite.value._keyLen, _hs.value._suite.value._ivLen),
			_clientMAC:Slice<GoUInt8> = __tmp__._0,
			_serverMAC:Slice<GoUInt8> = __tmp__._1,
			_clientKey:Slice<GoUInt8> = __tmp__._2,
			_serverKey:Slice<GoUInt8> = __tmp__._3,
	...
	public function _doFullHandshake():Error {
		...
		_hs.value._hello.value._ticketSupported = _hs.value._clientHello.value._ticketSupported
			&& !_c.value._config.value.sessionTicketsDisabled;
		...
		if (_hs.value._hello.value._ocspStapling) {
			...
			{
				var __tmp__ = _c.value._writeRecord(_recordTypeHandshake, _certStatus.value._marshal()),
					_:GoInt = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
					return _err;
		...
		var _keyAgreement:T_keyAgreement = _hs.value._suite.value._ka(_c.value._vers);
		var __tmp__ = _keyAgreement._generateServerKeyExchange(_c.value._config, _hs.value._cert, _hs.value._clientHello, _hs.value._hello),
			_skx:Pointer<T_serverKeyExchangeMsg> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			_c.value._sendAlert(_alertHandshakeFailure);
			return _err;
		...
		if ((_skx != null && !_skx.isNil())) {
			_hs.value._finishedHash.write(_skx.value._marshal());
			{
				var __tmp__ = _c.value._writeRecord(_recordTypeHandshake, _skx.value._marshal()),
					_:GoInt = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
					return _err;
		...
		if (_c.value._config.value.clientAuth.__t__ >= requestClientCert.__t__) {
			...
			_hs.value._finishedHash.write(_certReq.value._marshal());
			{
				var __tmp__ = _c.value._writeRecord(_recordTypeHandshake, _certReq.value._marshal()),
					_:GoInt = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
					return _err;
		...
		{
			var __tmp__ = _c.value._writeRecord(_recordTypeHandshake, _helloDone.value._marshal()),
				_:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return _err;
		...
		if (_c.value._config.value.clientAuth.__t__ >= requestClientCert.__t__) {
			...
			_hs.value._finishedHash.write(_certMsg.value._marshal());
			{
				var _err:stdgo.Error = _c.value._processCertsFromClient((({
					certificate: _certMsg.value._certificates,
					privateKey: ((null : stdgo.crypto.Crypto.PrivateKey)),
					supportedSignatureAlgorithms: new Slice<SignatureScheme>().nil(),
					ocspstaple: new Slice<GoUInt8>().nil(),
					signedCertificateTimestamps: new Slice<Slice<GoUInt8>>().nil(),
					leaf: new Pointer<stdgo.crypto.x509.X509.Certificate>().nil()
				} : Certificate)).__copy__());
				if (_err != null) {
					return _err;
				};
			};
		...
		_hs.value._finishedHash.write(_ckx.value._marshal());
		var __tmp__ = _keyAgreement._processClientKeyExchange(_c.value._config, _hs.value._cert, _ckx, _c.value._vers),
			_preMasterSecret:Slice<GoUInt8> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			_c.value._sendAlert(_alertHandshakeFailure);
		...
		_hs.value._masterSecret = _masterFromPreMasterSecret(_c.value._vers, _hs.value._suite, _preMasterSecret, _hs.value._clientHello.value._random,
			_hs.value._hello.value._random);
		{
	...
	public function _doResumeHandshake():Error {
		...
		{
			var _err:stdgo.Error = _c.value._processCertsFromClient((({
				certificate: _hs.value._sessionState.value._certificates,
				privateKey: ((null : stdgo.crypto.Crypto.PrivateKey)),
				supportedSignatureAlgorithms: new Slice<SignatureScheme>().nil(),
				ocspstaple: new Slice<GoUInt8>().nil(),
				signedCertificateTimestamps: new Slice<Slice<GoUInt8>>().nil(),
	...
	public function _checkForResumption():Bool {
		...
		var __tmp__ = _c.value._decryptTicket(_hs.value._clientHello.value._sessionTicket),
			_plaintext:Slice<GoUInt8> = __tmp__._0,
			_usedOldKey:Bool = __tmp__._1;
		if ((_plaintext == null || _plaintext.isNil())) {
			return false;
		};
		_hs.value._sessionState = Go.pointer((({
			_usedOldKey: _usedOldKey,
			_vers: 0,
			_cipherSuite: 0,
			_createdAt: 0,
			_masterSecret: new Slice<GoUInt8>().nil(),
			_certificates: new Slice<Slice<GoUInt8>>().nil()
		} : T_sessionState)));
		...
		_hs.value._suite = _selectCipherSuite(new Slice<GoUInt16>(_hs.value._sessionState.value._cipherSuite), _c.value._config.value._cipherSuites(),
			_hs.value._cipherSuiteOk);
		if ((_hs.value._suite == null || _hs.value._suite.isNil())) {
			return false;
		};
	...
	public function _pickCipherSuite():Error {
		...
		var _preferenceList:Slice<GoUInt16> = new Slice<GoUInt16>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt16))])
			.setCap(((_configCipherSuites.length : GoInt)).toBasic());
		for (_ => _suiteID in _preferenceOrder) {
	...
	public function _processClientHello():Error {
		...
		var __tmp__ = stdgo.io.Io.readFull(_c.value._config.value._rand(), _serverRandom),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			_c.value._sendAlert(_alertInternalError);
		...
		var __tmp__ = _negotiateALPN(_c.value._config.value.nextProtos, _hs.value._clientHello.value._alpnProtocols),
			_selectedProto:GoString = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
	...
	public function _handshake():Error {
		...
		_c.value._ekm = _ekmFromMasterSecret(_c.value._vers, _hs.value._suite, _hs.value._masterSecret, _hs.value._clientHello.value._random,
			_hs.value._hello.value._random);
		stdgo.sync.atomic.Atomic.storeUint32(Go.pointer(_c.value._handshakeStatus), ((1 : GoUInt32)));
		return ((null : stdgo.Error));
	}
	...
	public function new(?_c:Pointer<Conn>, ?_ctx:stdgo.context.Context.Context, ?_clientHello:Pointer<T_clientHelloMsg>, ?_hello:Pointer<T_serverHelloMsg>,
			?_suite:Pointer<T_cipherSuite>, ?_ecdheOk:Bool, ?_ecSignOk:Bool, ?_rsaDecryptOk:Bool, ?_rsaSignOk:Bool, ?_sessionState:Pointer<T_sessionState>,
			?_finishedHash:T_finishedHash, ?_masterSecret:Slice<GoUInt8>, ?_cert:Pointer<Certificate>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_c) + " " + Go.string(_ctx) + " " + Go.string(_clientHello) + " " + Go.string(_hello) + " " + Go.string(_suite) + " "
			+ Go.string(_ecdheOk) + " " + Go.string(_ecSignOk) + " " + Go.string(_rsaDecryptOk) + " " + Go.string(_rsaSignOk) + " "
			+ Go.string(_sessionState) + " " + Go.string(_finishedHash) + " " + Go.string(_masterSecret) + " " + Go.string(_cert) + "}";
	}
	...
	public function __copy__() {
		return new T_serverHandshakeState(_c, _ctx, _clientHello, _hello, _suite, _ecdheOk, _ecSignOk, _rsaDecryptOk, _rsaSignOk, _sessionState,
			_finishedHash, _masterSecret, _cert);
	}
...
@:structInit class T_serverHandshakeStateTLS13 {
	...
	public function _readClientCertificate():Error {
		...
		if (_certMsg.value._certificate.certificate.length != ((0 : GoInt))) {
			...
			var _signed:Slice<GoUInt8> = _signedMessage(_sigHash, _clientSignatureContext, _hs.value._transcript);
			{
				var _err:stdgo.Error = _verifyHandshakeSignature(_sigType, Go.toInterface(_c.value._peerCertificates[((0 : GoInt))].value.publicKey),
					_sigHash, _signed, _certVerify.value._signature);
				if (_err != null) {
					_c.value._sendAlert(_alertDecryptError);
					return stdgo.errors.Errors.new_((("tls: invalid signature by the client certificate: " : GoString)) + _err.error());
				};
	...
	public function _sendSessionTickets():Error {
		...
		var _state:T_sessionStateTLS13 = (({
			_cipherSuite: _hs.value._suite.value._id,
			_createdAt: ((_c.value._config.value._time().unix() : GoUInt64)),
			_resumptionSecret: _resumptionSecret,
			_certificate: (({
				certificate: _certsFromClient,
				ocspstaple: _c.value._ocspResponse,
				signedCertificateTimestamps: _c.value._scts,
				privateKey: ((null : stdgo.crypto.Crypto.PrivateKey)),
				supportedSignatureAlgorithms: new Slice<SignatureScheme>().nil(),
				leaf: new Pointer<stdgo.crypto.x509.X509.Certificate>().nil()
			} : Certificate)).__copy__()
		} : T_sessionStateTLS13)).__copy__();
		var _err:Error = ((null : stdgo.Error));
		{
			var __tmp__ = _c.value._encryptTicket(_state._marshal());
	...
	public function _sendServerFinished():Error {
		...
		_hs.value._masterSecret = _hs.value._suite.value._extract(new Slice<GoUInt8>().nil(),
			_hs.value._suite.value._deriveSecret(_hs.value._handshakeSecret, "derived", ((null : stdgo.hash.Hash.Hash))));
		_hs.value._trafficSecret = _hs.value._suite.value._deriveSecret(_hs.value._masterSecret, _clientApplicationTrafficLabel, _hs.value._transcript);
		var _serverSecret:Slice<GoUInt8> = _hs.value._suite.value._deriveSecret(_hs.value._masterSecret, _serverApplicationTrafficLabel,
			_hs.value._transcript);
	...
	public function _sendServerCertificate():Error {
		...
		_certMsg.value._scts = _hs.value._clientHello.value._scts
			&& _hs.value._cert.value.signedCertificateTimestamps.length > ((0 : GoInt));
		_certMsg.value._ocspStapling = _hs.value._clientHello.value._ocspStapling
			&& _hs.value._cert.value.ocspstaple.length > ((0 : GoInt));
		_hs.value._transcript.write(_certMsg.value._marshal());
		{
			var __tmp__ = _c.value._writeRecord(_recordTypeHandshake, _certMsg.value._marshal()),
				_:GoInt = __tmp__._0,
		...
		var __tmp__ = _typeAndHashFromSignatureScheme(_hs.value._sigAlg),
			_sigType:GoUInt8 = __tmp__._0,
			_sigHash:stdgo.crypto.Crypto.Hash = __tmp__._1,
			_err:stdgo.Error = __tmp__._2;
		if (_err != null) {
		...
		var __tmp__ = ((_hs.value._cert.value.privateKey.value : stdgo.crypto.Crypto.Signer)).sign(_c.value._config.value._rand(), _signed, _signOpts),
			_sig:Slice<GoUInt8> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			var _public:stdgo.crypto.Crypto.PublicKey = Go.toInterface(((_hs.value._cert.value.privateKey.value : stdgo.crypto.Crypto.Signer)).public_());
			{
				...
				if (_ok
					...
					&& _rsaKey.value.n.value.bitLen() / ((8 : GoInt)) < _sigHash.size() * ((2 : GoInt)) + ((2 : GoInt))) {
					_c.value._sendAlert(_alertHandshakeFailure);
				} else {
					_c.value._sendAlert(_alertInternalError);
				};
	...
	public function _sendServerParameters():Error {
		...
		_hs.value._handshakeSecret = _hs.value._suite.value._extract(_hs.value._sharedKey,
			_hs.value._suite.value._deriveSecret(_earlySecret, "derived", ((null : stdgo.hash.Hash.Hash))));
		var _clientSecret:Slice<GoUInt8> = _hs.value._suite.value._deriveSecret(_hs.value._handshakeSecret, _clientHandshakeTrafficLabel,
			_hs.value._transcript);
		_c.value._in._setTrafficSecret(_hs.value._suite, _clientSecret);
		var _serverSecret:Slice<GoUInt8> = _hs.value._suite.value._deriveSecret(_hs.value._handshakeSecret, _serverHandshakeTrafficLabel,
			_hs.value._transcript);
		_c.value._out._setTrafficSecret(_hs.value._suite, _serverSecret);
		...
		_hs.value._transcript.write(_encryptedExtensions.value._marshal());
		{
			var __tmp__ = _c.value._writeRecord(_recordTypeHandshake, _encryptedExtensions.value._marshal()),
				_:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return _err;
	...
	public function _doHelloRetryRequest(_selectedGroup:CurveID):Error {
		...
		_hs.value._transcript.write(new Slice<GoUInt8>(_typeMessageHash, ((0 : GoUInt8)), ((0 : GoUInt8)), ((_chHash.length : GoUInt8))));
		_hs.value._transcript.write(_chHash);
		var _helloRetryRequest:Pointer<T_serverHelloMsg> = Go.pointer((({
			_vers: _hs.value._hello.value._vers,
			_random: _helloRetryRequestRandom,
			_sessionId: _hs.value._hello.value._sessionId,
			_cipherSuite: _hs.value._hello.value._cipherSuite,
			_compressionMethod: _hs.value._hello.value._compressionMethod,
			_supportedVersion: _hs.value._hello.value._supportedVersion,
		...
		{
			var __tmp__ = _c.value._writeRecord(_recordTypeHandshake, _helloRetryRequest.value._marshal()),
				_:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return _err;
		...
		if (_clientHello.value._keyShares.length != ((1 : GoInt))
			|| _clientHello.value._keyShares[((0 : GoInt))]._group.__t__ != _selectedGroup.__t__) {
			_c.value._sendAlert(_alertIllegalParameter);
	...
	public function _pickCertificate():Error {
		...
		var __tmp__ = _c.value._config.value._getCertificate(_clientHelloInfo(_hs.value._ctx, _c, _hs.value._clientHello)),
			_certificate:Pointer<Certificate> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			if (Go.toInterface(_err) == Go.toInterface(_errNoCertificates)) {
				_c.value._sendAlert(_alertUnrecognizedName);
	...
	public function _checkForResumption():Error {
		...
		for (_i => _identity in _hs.value._clientHello.value._pskIdentities) {
			...
			var __tmp__ = _c.value._decryptTicket(_identity._label),
				_plaintext:Slice<GoUInt8> = __tmp__._0,
				_:Bool = __tmp__._1;
			if ((_plaintext == null || _plaintext.isNil())) {
				continue;
			...
			var _psk:Slice<GoUInt8> = _hs.value._suite.value._expandLabel(_sessionState.value._resumptionSecret, "resumption", new Slice<GoUInt8>().nil(),
				_hs.value._suite.value._hash.size());
			_hs.value._earlySecret = _hs.value._suite.value._extract(_psk, new Slice<GoUInt8>().nil());
			var _binderKey:Slice<GoUInt8> = _hs.value._suite.value._deriveSecret(_hs.value._earlySecret, _resumptionBinderLabel,
				((null : stdgo.hash.Hash.Hash)));
	...
	public function _processClientHello():Error {
		...
		return stdgo.internal.Macro.controlFlow({
			...
			if (_hs.value._clientHello.value._compressionMethods.length != ((1 : GoInt))
				|| _hs.value._clientHello.value._compressionMethods[((0 : GoInt))] != _compressionNone) {
				_c.value._sendAlert(_alertIllegalParameter);
				return stdgo.errors.Errors.new_("tls: TLS 1.3 client supports illegal compression methods");
			};
			_hs.value._hello.value._random = new Slice<GoUInt8>(...[for (i in 0...((((32 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]);
			{
				var __tmp__ = stdgo.io.Io.readFull(_c.value._config.value._rand(), _hs.value._hello.value._random),
					_:GoInt = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
					_c.value._sendAlert(_alertInternalError);
			...
			{
				var __tmp__ = _curveForCurveID(_selectedGroup),
					_:stdgo.crypto.elliptic.Elliptic.Curve = __tmp__._0,
					_ok:Bool = __tmp__._1;
			...
			var __tmp__ = _generateECDHEParameters(_c.value._config.value._rand(), _selectedGroup),
				_params:T_ecdheParameters = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				_c.value._sendAlert(_alertInternalError);
	...
	public function new(?_c:Pointer<Conn>, ?_ctx:stdgo.context.Context.Context, ?_clientHello:Pointer<T_clientHelloMsg>, ?_hello:Pointer<T_serverHelloMsg>,
			?_sentDummyCCS:Bool, ?_usingPSK:Bool, ?_suite:Pointer<T_cipherSuiteTLS13>, ?_cert:Pointer<Certificate>, ?_sigAlg:SignatureScheme,
			?_earlySecret:Slice<GoUInt8>, ?_sharedKey:Slice<GoUInt8>, ?_handshakeSecret:Slice<GoUInt8>, ?_masterSecret:Slice<GoUInt8>,
			?_trafficSecret:Slice<GoUInt8>, ?_transcript:stdgo.hash.Hash.Hash, ?_clientFinished:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_c) + " " + Go.string(_ctx) + " " + Go.string(_clientHello) + " " + Go.string(_hello) + " " + Go.string(_sentDummyCCS) + " "
			+ Go.string(_usingPSK) + " " + Go.string(_suite) + " " + Go.string(_cert) + " " + Go.string(_sigAlg) + " " + Go.string(_earlySecret) + " "
			+ Go.string(_sharedKey) + " " + Go.string(_handshakeSecret) + " " + Go.string(_masterSecret) + " " + Go.string(_trafficSecret) + " "
			+ Go.string(_transcript) + " " + Go.string(_clientFinished) + "}";
	}
	...
	public function __copy__() {
		return new T_serverHandshakeStateTLS13(_c, _ctx, _clientHello, _hello, _sentDummyCCS, _usingPSK, _suite, _cert, _sigAlg, _earlySecret, _sharedKey,
			_handshakeSecret, _masterSecret, _trafficSecret, _transcript, _clientFinished);
	}
...
@:structInit class T_rsaKeyAgreement {
	public function _generateClientKeyExchange(_config:Pointer<Config>, _clientHello:Pointer<T_clientHelloMsg>,
			_cert:Pointer<stdgo.crypto.x509.X509.Certificate>):{
		var _0:Slice<GoByte>;
		var _1:Pointer<T_clientKeyExchangeMsg>;
		var _2:Error;
	} {
		...
		var __tmp__ = stdgo.io.Io.readFull(_config.value._rand(), _preMasterSecret.__slice__(((2 : GoInt)))),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
		...
		if (!_ok) {
			return {_0: new Slice<GoUInt8>().nil(), _1: new Pointer<T_clientKeyExchangeMsg>().nil(),
				_2: stdgo.errors.Errors.new_("tls: server certificate contains incorrect key type for selected ciphersuite")};
		};
		var __tmp__ = stdgo.crypto.rsa.Rsa.encryptPKCS1v15(_config.value._rand(), _rsaKey, _preMasterSecret),
			_encrypted:Slice<GoUInt8> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new Slice<GoUInt8>().nil(), _1: new Pointer<T_clientKeyExchangeMsg>().nil(), _2: _err};
		};
		var _ckx:Pointer<T_clientKeyExchangeMsg> = Go.pointer(new T_clientKeyExchangeMsg());
		_ckx.value._ciphertext = new Slice<GoUInt8>(...[
			for (i in 0...((_encrypted.length + ((2 : GoInt)):GoInt)).toBasic()) ((0 : GoUInt8))
		]);
	...
	public function _processServerKeyExchange(_config:Pointer<Config>, _clientHello:Pointer<T_clientHelloMsg>, _serverHello:Pointer<T_serverHelloMsg>,
			_cert:Pointer<stdgo.crypto.x509.X509.Certificate>, _skx:Pointer<T_serverKeyExchangeMsg>):Error {
		var _ka = this.__copy__();
		return stdgo.errors.Errors.new_("tls: unexpected ServerKeyExchange");
	}

	public function _processClientKeyExchange(_config:Pointer<Config>, _cert:Pointer<Certificate>, _ckx:Pointer<T_clientKeyExchangeMsg>,
			_version:GoUInt16):{var _0:Slice<GoByte>; var _1:Error;} {
		var _ka = this.__copy__();
		...
		var __tmp__ = _priv.decrypt(_config.value._rand(), _ciphertext,
			Go.toInterface(Go.pointer((({sessionKeyLen: ((48 : GoInt))} : stdgo.crypto.rsa.Rsa.PKCS1v15DecryptOptions))))),
			_preMasterSecret:Slice<GoUInt8> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new Slice<GoUInt8>().nil(), _1: _err};
	...
	public function _generateServerKeyExchange(_config:Pointer<Config>, _cert:Pointer<Certificate>, _clientHello:Pointer<T_clientHelloMsg>,
			_hello:Pointer<T_serverHelloMsg>):{
		var _0:Pointer<T_serverKeyExchangeMsg>;
		var _1:Error;
	} {
		var _ka = this.__copy__();
...
@:structInit class T_ecdheKeyAgreement {
	public function _generateClientKeyExchange(_config:Pointer<Config>, _clientHello:Pointer<T_clientHelloMsg>,
		...
		if ((_ka.value._ckx == null || _ka.value._ckx.isNil())) {
			return {_0: new Slice<GoUInt8>().nil(), _1: new Pointer<T_clientKeyExchangeMsg>().nil(),
				_2: stdgo.errors.Errors.new_("tls: missing ServerKeyExchange message")};
		};
	...
	public function _processServerKeyExchange(_config:Pointer<Config>, _clientHello:Pointer<T_clientHelloMsg>, _serverHello:Pointer<T_serverHelloMsg>,
		...
		var _curveID:CurveID = new CurveID((new CurveID(new CurveID(_skx.value._key[((1 : GoInt))]).__t__ << ((8 : GoUnTypedInt))))
			.__t__ | new CurveID(_skx.value._key[((2 : GoInt))])
			.__t__);
		...
		_ka.value._ckx.value._ciphertext = new Slice<GoUInt8>(...[
			for (i in 0...((((1 : GoInt)) + _ourPublicKey.length : GoInt)).toBasic()) ((0 : GoUInt8))
		]);
		...
		if (_ka.value._version >= versionTLS12) {
			var _signatureAlgorithm:SignatureScheme = new SignatureScheme((new SignatureScheme(new SignatureScheme(_sig[((0 : GoInt))])
				.__t__ << ((8 : GoUnTypedInt)))).__t__ | new SignatureScheme(_sig[((1 : GoInt))])
				.__t__);
		...
		_sig = _sig.__slice__(((2 : GoInt)));
		var _signed:Slice<GoUInt8> = _hashForServerKeyExchange(_sigType, _sigHash, _ka.value._version, _clientHello.value._random, _serverHello.value._random,
			_serverECDHEParams);
		{
	...
	public function _processClientKeyExchange(_config:Pointer<Config>, _cert:Pointer<Certificate>, _ckx:Pointer<T_clientKeyExchangeMsg>,
			_version:GoUInt16):{var _0:Slice<GoByte>; var _1:Error;} {
		var _ka = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		if (_ckx.value._ciphertext.length == ((0 : GoInt))
			|| ((_ckx.value._ciphertext[((0 : GoInt))] : GoInt)) != _ckx.value._ciphertext.length - ((1 : GoInt))) {
			return {_0: new Slice<GoUInt8>().nil(), _1: _errClientKeyExchange};
		};
	...
	public function _generateServerKeyExchange(_config:Pointer<Config>, _cert:Pointer<Certificate>, _clientHello:Pointer<T_clientHelloMsg>,
		...
		var _serverECDHEParams:Slice<GoUInt8> = new Slice<GoUInt8>(...[
			for (i in 0...((((1 : GoUnTypedInt)) + ((2 : GoUnTypedInt)) + ((1 : GoUnTypedInt)) + _ecdhePublic.length : GoInt)).toBasic()) ((0 : GoUInt8))
		]);
		...
		if (!_ok) {
			return {_0: new Pointer<T_serverKeyExchangeMsg>().nil(),
				_1: stdgo.fmt.Fmt.errorf("tls: certificate private key of type %T does not implement crypto.Signer", Go.toInterface(_cert.value.privateKey))};
		};
		...
		if ((_sigType == _signaturePKCS1v15 || _sigType == _signatureRSAPSS) != _ka.value._isRSA) {
			return {_0: new Pointer<T_serverKeyExchangeMsg>().nil(),
				_1: stdgo.errors.Errors.new_("tls: certificate cannot be used with the selected cipher suite")};
		};
		var _signed:Slice<GoUInt8> = _hashForServerKeyExchange(_sigType, _sigHash, _ka.value._version, _clientHello.value._random, _hello.value._random,
			_serverECDHEParams);
		var _signOpts:stdgo.crypto.Crypto.SignerOpts = ((_sigHash : stdgo.crypto.Crypto.SignerOpts));
		if (_sigType == _signatureRSAPSS) {
			_signOpts = Go.pointer((({saltLength: stdgo.crypto.rsa.Rsa.psssaltLengthEqualsHash, hash: _sigHash} : stdgo.crypto.rsa.Rsa.PSSOptions))).value;
		};
		var __tmp__ = _priv.sign(_config.value._rand(), _signed, _signOpts),
			_sig:Slice<GoUInt8> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new Pointer<T_serverKeyExchangeMsg>().nil(), _1: stdgo.errors.Errors.new_((("tls: failed to sign ECDHE parameters: " : GoString))
				+ _err.error())};
		};
		...
		_skx.value._key = new Slice<GoUInt8>(...[
			for (i in 0...((_serverECDHEParams.length + _sigAndHashLen + ((2 : GoInt)) + _sig.length:GoInt)).toBasic()) ((0 : GoUInt8))
		]);
	...
	public function new(?_version:GoUInt16, ?_isRSA:Bool, ?_params:T_ecdheParameters, ?_ckx:Pointer<T_clientKeyExchangeMsg>, ?_preMasterSecret:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_nistParameters {
	public function sharedKey(_peerPublicKey:Slice<GoByte>):Slice<GoByte> {
		...
		var __tmp__ = _curveForCurveID(_p.value._curveID),
			_curve:stdgo.crypto.elliptic.Elliptic.Curve = __tmp__._0,
			_:Bool = __tmp__._1;
		var __tmp__ = stdgo.crypto.elliptic.Elliptic.unmarshal(_curve, _peerPublicKey),
			_x:Pointer<stdgo.math.big.Big.Int_> = __tmp__._0,
			_y:Pointer<stdgo.math.big.Big.Int_> = __tmp__._1;
		if ((_x == null || _x.isNil())) {
			return new Slice<GoUInt8>().nil();
		};
		var __tmp__ = _curve.scalarMult(_x, _y, _p.value._privateKey),
			_xShared:Pointer<stdgo.math.big.Big.Int_> = __tmp__._0,
			_:Pointer<stdgo.math.big.Big.Int_> = __tmp__._1;
		var _sharedKey:Slice<GoUInt8> = new Slice<GoUInt8>(...[
			for (i in 0...(((_curve.params().value.bitSize + ((7 : GoInt))) / ((8 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))
		]);
	...
	public function new(?_privateKey:Slice<GoUInt8>, ?_x:Pointer<stdgo.math.big.Big.Int_>, ?_y:Pointer<stdgo.math.big.Big.Int_>, ?_curveID:CurveID)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_x25519Parameters {
	public function sharedKey(_peerPublicKey:Slice<GoByte>):Slice<GoByte> {
		var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = golang_org.x.crypto.curve25519.Curve25519.x25519(_p.value._privateKey, _peerPublicKey),
			_sharedKey:Slice<GoUInt8> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return new Slice<GoUInt8>().nil();
		};
	...
	public function new(?_privateKey:Slice<GoUInt8>, ?_publicKey:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_finishedHash {
	...
	public function sum():Slice<GoByte> {
		...
		var _out:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((stdgo.crypto.md5.Md5.size
			+ stdgo.crypto.sha1.Sha1.size:GoInt)).toBasic());
	...
	public function new(?_client:stdgo.hash.Hash.Hash, ?_server:stdgo.hash.Hash.Hash, ?_clientMD5:stdgo.hash.Hash.Hash, ?_serverMD5:stdgo.hash.Hash.Hash,
			?_buffer:Slice<GoUInt8>, ?_version:GoUInt16, ?_prf:(Slice<GoUInt8>, Slice<GoUInt8>, Slice<GoUInt8>, Slice<GoUInt8>) -> Void)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_client) + " " + Go.string(_server) + " " + Go.string(_clientMD5) + " " + Go.string(_serverMD5) + " " + Go.string(_buffer)
			+ " " + Go.string(_version) + " " + Go.string(_prf) + "}";
	}
...
@:structInit class T_sessionState {
	public function _unmarshal(_data:Slice<GoByte>):Bool {
		var _m = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		_m.value = (({
			_usedOldKey: _m.value._usedOldKey,
			_vers: 0,
			_cipherSuite: 0,
			_createdAt: 0,
			_masterSecret: new Slice<GoUInt8>().nil(),
		...
		var _s:vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new golang_org.x.crypto.cryptobyte.Cryptobyte.String_(_data).__copy__();
		{
			var _ok:Bool = _s.readUint16(Go.pointer(_m.value._vers))
				&& _s.readUint16(Go.pointer(_m.value._cipherSuite))
				&& _readUint64(Go.pointer(_s), Go.pointer(_m.value._createdAt))
				&& _readUint16LengthPrefixed(Go.pointer(_s), Go.pointer(_m.value._masterSecret))
				&& _m.value._masterSecret.length != ((0 : GoInt));
			if (!_ok) {
				return false;
			};
		};
	...
	public function new(?_vers:GoUInt16, ?_cipherSuite:GoUInt16, ?_createdAt:GoUInt64, ?_masterSecret:Slice<GoUInt8>, ?_certificates:Slice<Slice<GoUInt8>>,
			?_usedOldKey:Bool)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_vers) + " " + Go.string(_cipherSuite) + " " + Go.string(_createdAt) + " " + Go.string(_masterSecret) + " "
			+ Go.string(_certificates) + " " + Go.string(_usedOldKey) + "}";
	}
...
@:structInit class T_sessionStateTLS13 {
	public function _unmarshal(_data:Slice<GoByte>):Bool {
		...
		return _s.readUint16(Go.pointer(_version))
			&& _version == versionTLS13
			&& _s.readUint8(Go.pointer(_revision))
			&& _revision == ((0 : GoUInt8))
			&& _s.readUint16(Go.pointer(_m.value._cipherSuite))
			&& _readUint64(Go.pointer(_s), Go.pointer(_m.value._createdAt))
			&& _readUint8LengthPrefixed(Go.pointer(_s), Go.pointer(_m.value._resumptionSecret))
			&& _m.value._resumptionSecret.length != ((0 : GoInt))
			&& _unmarshalCertificate(Go.pointer(_s), Go.pointer(_m.value._certificate))
			&& _s.empty();
	}
	...
	public function new(?_cipherSuite:GoUInt16, ?_createdAt:GoUInt64, ?_resumptionSecret:Slice<GoUInt8>, ?_certificate:Certificate)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{'
			+ Go.string(_cipherSuite)
			+ " "
			+ Go.string(_createdAt)
			+ " "
			+ Go.string(_resumptionSecret)
			+ " "
			+ Go.string(_certificate)
			+ "}";
	}
...
@:structInit class T_listener {
	public function accept():{var _0:stdgo.net.Net.Conn; var _1:Error;} {
		...
		var __tmp__ = _l.value.listener.accept(),
	...
	public function new(?listener:stdgo.net.Net.Listener, ?_config:Pointer<Config>)
		stdgo.internal.Macro.initLocals();
	...
	public function addr():stdgo.net.Net.Addr
...
@:structInit class Dialer {
	public function dialContext(_ctx:stdgo.context.Context.Context, _network:GoString, _addr:GoString):{var _0:stdgo.net.Net.Conn; var _1:Error;} {
		...
		var __tmp__ = _dial(_ctx, _d.value._netDialer(), _network, _addr, _d.value.config),
			_c:Pointer<Conn> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: ((null : stdgo.net.Net.Conn)), _1: _err};
		};
	...
	public function new(?netDialer:Pointer<stdgo.net.Net.Dialer>, ?config:Pointer<Config>)
		stdgo.internal.Macro.initLocals();
...
@:structInit @:local class T__struct_0 {
	...
	public function new(?_scheme:SignatureScheme, ?_minModulusBytes:GoInt, ?_maxVersion:GoUInt16)
		stdgo.internal.Macro.initLocals();
...
var _outBufPool:stdgo.sync.Sync.Pool = (({
	new_: function():AnyInterface {
		return Go.toInterface(Go.pointer(new Slice<GoUInt8>().nil()));
	},
	_noCopy: new stdgo.sync.Sync.T_noCopy(),
	_local: null,
	_localSize: 0,
	_victim: null,
	_victimSize: 0
} : stdgo.sync.Sync.Pool)).__copy__();

final _alertNoRenegotiation:T_alert = new T_alert(((100 : GoUInt8)));

var __SignatureScheme_index_8:GoArray<GoUInt8> = new GoArray<GoUInt8>(((0 : GoUInt8)), ((13 : GoUInt8)), ((26 : GoUInt8)), ((39 : GoUInt8)),
	((46 : GoUInt8))).copy();
...
final _ticketKeyLifetime:stdgo.time.Time.Duration = new stdgo.time.Time.Duration(new stdgo.time.Time.Duration(((7 : GoUnTypedInt)) * ((24 : GoUnTypedInt)))
	.__t__ * stdgo.time.Time.hour.__t__);
...
var _cipherSuitesTLS13:Slice<Pointer<T_cipherSuiteTLS13>> = new Slice<Pointer<T_cipherSuiteTLS13>>(Go.pointer(new T_cipherSuiteTLS13(tls_AES_128_GCM_SHA256,
	((16 : GoInt)), _aeadAESGCMTLS13, stdgo.crypto.Crypto.sha256)),
	Go.pointer(new T_cipherSuiteTLS13(tls_CHACHA20_POLY1305_SHA256, ((32 : GoInt)), _aeadChaCha20Poly1305, stdgo.crypto.Crypto.sha256)),
	Go.pointer(new T_cipherSuiteTLS13(tls_AES_256_GCM_SHA384, ((32 : GoInt)), _aeadAESGCMTLS13, stdgo.crypto.Crypto.sha384)));
...
var _helloRetryRequestRandom:Slice<GoUInt8> = new Slice<GoUInt8>(((207 : GoUInt8)), ((33 : GoUInt8)), ((173 : GoUInt8)), ((116 : GoUInt8)), ((229 : GoUInt8)),
	((154 : GoUInt8)), ((97 : GoUInt8)), ((17 : GoUInt8)), ((190 : GoUInt8)), ((29 : GoUInt8)), ((140 : GoUInt8)), ((2 : GoUInt8)), ((30 : GoUInt8)),
	((101 : GoUInt8)), ((184 : GoUInt8)), ((145 : GoUInt8)), ((194 : GoUInt8)), ((162 : GoUInt8)), ((17 : GoUInt8)), ((22 : GoUInt8)), ((122 : GoUInt8)),
	((187 : GoUInt8)), ((140 : GoUInt8)), ((94 : GoUInt8)), ((7 : GoUInt8)), ((158 : GoUInt8)), ((9 : GoUInt8)), ((226 : GoUInt8)), ((200 : GoUInt8)),
	((168 : GoUInt8)), ((51 : GoUInt8)), ((156 : GoUInt8)));
...
var _cipherSuitesPreferenceOrder:Slice<GoUInt16> = new Slice<GoUInt16>(tls_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256, tls_ECDHE_RSA_WITH_AES_128_GCM_SHA256,
	tls_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384, tls_ECDHE_RSA_WITH_AES_256_GCM_SHA384, tls_ECDHE_ECDSA_WITH_CHACHA20_POLY1305,
	tls_ECDHE_RSA_WITH_CHACHA20_POLY1305, tls_ECDHE_ECDSA_WITH_AES_128_CBC_SHA, tls_ECDHE_RSA_WITH_AES_128_CBC_SHA, tls_ECDHE_ECDSA_WITH_AES_256_CBC_SHA,
	tls_ECDHE_RSA_WITH_AES_256_CBC_SHA, tls_RSA_WITH_AES_128_GCM_SHA256, tls_RSA_WITH_AES_256_GCM_SHA384, tls_RSA_WITH_AES_128_CBC_SHA,
	tls_RSA_WITH_AES_256_CBC_SHA, tls_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA, tls_RSA_WITH_3DES_EDE_CBC_SHA, tls_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256,
	tls_ECDHE_RSA_WITH_AES_128_CBC_SHA256, tls_RSA_WITH_AES_128_CBC_SHA256, tls_ECDHE_ECDSA_WITH_RC4_128_SHA, tls_ECDHE_RSA_WITH_RC4_128_SHA,
	tls_RSA_WITH_RC4_128_SHA);

var _disabledCipherSuites:Slice<GoUInt16> = new Slice<GoUInt16>(tls_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256, tls_ECDHE_RSA_WITH_AES_128_CBC_SHA256,
	tls_RSA_WITH_AES_128_CBC_SHA256, tls_ECDHE_ECDSA_WITH_RC4_128_SHA, tls_ECDHE_RSA_WITH_RC4_128_SHA, tls_RSA_WITH_RC4_128_SHA);
...
var _alertText:GoMap<T_alert, GoString> = new GoMap<T_alert,
	GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("T_alert", [],
		stdgo.reflect.Reflect.GoType.basic(uint8_kind)), stdgo.reflect.Reflect.GoType.basic(string_kind))),
	{
		key: _alertCloseNotify,
		value: "close notify"
	},
	{key: _alertUnexpectedMessage, value: "unexpected message"}, {key: _alertBadRecordMAC, value: "bad record MAC"},
	{key: _alertDecryptionFailed, value: "decryption failed"}, {key: _alertRecordOverflow, value: "record overflow"},
	{key: _alertDecompressionFailure, value: "decompression failure"}, {key: _alertHandshakeFailure, value: "handshake failure"},
	{key: _alertBadCertificate, value: "bad certificate"}, {key: _alertUnsupportedCertificate, value: "unsupported certificate"},
	{key: _alertCertificateRevoked, value: "revoked certificate"}, {key: _alertCertificateExpired, value: "expired certificate"},
	{key: _alertCertificateUnknown, value: "unknown certificate"}, {key: _alertIllegalParameter, value: "illegal parameter"},
	{key: _alertUnknownCA, value: "unknown certificate authority"}, {key: _alertAccessDenied, value: "access denied"},
	{key: _alertDecodeError, value: "error decoding message"}, {key: _alertDecryptError, value: "error decrypting message"},
	{key: _alertExportRestriction, value: "export restriction"}, {key: _alertProtocolVersion, value: "protocol version not supported"},
	{key: _alertInsufficientSecurity, value: "insufficient security level"}, {key: _alertInternalError, value: "internal error"},
	{key: _alertInappropriateFallback, value: "inappropriate fallback"}, {key: _alertUserCanceled, value: "user canceled"},
	{key: _alertNoRenegotiation, value: "no renegotiation"}, {key: _alertMissingExtension, value: "missing extension"},
	{key: _alertUnsupportedExtension, value: "unsupported extension"}, {key: _alertCertificateUnobtainable, value: "certificate unobtainable"},
	{key: _alertUnrecognizedName, value: "unrecognized name"}, {key: _alertBadCertificateStatusResponse, value: "bad certificate status response"},
	{key: _alertBadCertificateHashValue, value: "bad certificate hash value"}, {key: _alertUnknownPSKIdentity, value: "unknown PSK identity"},
	{key: _alertCertificateRequired, value: "certificate required"}, {key: _alertNoApplicationProtocol, value: "no application protocol"});
...
var __ClientAuthType_index:GoArray<GoUInt8> = new GoArray<GoUInt8>(((0 : GoUInt8)), ((12 : GoUInt8)), ((29 : GoUInt8)), ((49 : GoUInt8)), ((72 : GoUInt8)),
	((98 : GoUInt8))).copy();
...
var _nonAESGCMAEADCiphers:GoMap<GoUInt16, Bool> = new GoMap<GoUInt16,
	Bool>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(uint16_kind),
		stdgo.reflect.Reflect.GoType.basic(bool_kind))),
	{
		key: tls_ECDHE_RSA_WITH_CHACHA20_POLY1305,
		value: true
	},
	{key: tls_ECDHE_ECDSA_WITH_CHACHA20_POLY1305, value: true}, {key: tls_CHACHA20_POLY1305_SHA256, value: true});
...
var _aesgcmCiphers:GoMap<GoUInt16, Bool> = new GoMap<GoUInt16,
	Bool>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(uint16_kind),
		stdgo.reflect.Reflect.GoType.basic(bool_kind))),
	{
	...
	{key: tls_ECDHE_RSA_WITH_AES_256_GCM_SHA384, value: true}, {key: tls_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256, value: true},
	{key: tls_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384, value: true}, {key: tls_AES_128_GCM_SHA256, value: true}, {key: tls_AES_256_GCM_SHA384, value: true});
...
var _hasGCMAsmS390X:Bool = internal.cpu.Cpu.s390x.hasAES
	&& internal.cpu.Cpu.s390x.hasAESCBC
	&& internal.cpu.Cpu.s390x.hasAESCTR
	&& (internal.cpu.Cpu.s390x.hasGHASH || internal.cpu.Cpu.s390x.hasAESGCM);

var _hasAESGCMHardwareSupport:Bool = stdgo.runtime.Runtime.goarch == (("amd64" : GoString))
	&& _hasGCMAsmAMD64
...
var _supportedSignatureAlgorithms:Slice<SignatureScheme> = new Slice<SignatureScheme>(psswithSHA256, ecdsawithP256AndSHA256, ed25519, psswithSHA384,
	psswithSHA512, pkcs1withSHA256, pkcs1withSHA384, pkcs1withSHA512, ecdsawithP384AndSHA384, ecdsawithP521AndSHA512, pkcs1withSHA1, ecdsawithSHA1);
...
var _signaturePadding:Slice<GoUInt8> = new Slice<GoUInt8>(((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)),
	((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)),
	((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)),
	((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)),
	((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)),
	((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)),
	((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)),
	((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)),
	((32 : GoUInt8)), ((32 : GoUInt8)), ((32 : GoUInt8)));
...
final _maxSessionTicketLifetime:stdgo.time.Time.Duration = new stdgo.time.Time.Duration(new stdgo.time.Time.Duration(((7 : GoUnTypedInt)) * ((24 : GoUnTypedInt)))
	.__t__ * stdgo.time.Time.hour.__t__);
...
var _rsaSignatureSchemes:Slice<T__struct_0> = new Slice<T__struct_0>(new T__struct_0(psswithSHA256,
	stdgo.crypto.Crypto.sha256.size() * ((2 : GoInt)) + ((2 : GoInt)), versionTLS13).__copy__(),
	new T__struct_0(psswithSHA384, stdgo.crypto.Crypto.sha384.size() * ((2 : GoInt)) + ((2 : GoInt)), versionTLS13).__copy__(),
	new T__struct_0(psswithSHA512, stdgo.crypto.Crypto.sha512.size() * ((2 : GoInt)) + ((2 : GoInt)), versionTLS13).__copy__(),
	new T__struct_0(pkcs1withSHA256, ((19 : GoInt)) + stdgo.crypto.Crypto.sha256.size() + ((11 : GoInt)), versionTLS12).__copy__(),
	new T__struct_0(pkcs1withSHA384, ((19 : GoInt)) + stdgo.crypto.Crypto.sha384.size() + ((11 : GoInt)), versionTLS12).__copy__(),
	new T__struct_0(pkcs1withSHA512, ((19 : GoInt)) + stdgo.crypto.Crypto.sha512.size() + ((11 : GoInt)), versionTLS12).__copy__(),
	new T__struct_0(pkcs1withSHA1, ((15 : GoInt)) + stdgo.crypto.Crypto.sha1.size() + ((11 : GoInt)), versionTLS12).__copy__());
...
var _cipherSuites:Slice<Pointer<T_cipherSuite>> = new Slice<Pointer<T_cipherSuite>>(Go.pointer(new T_cipherSuite(tls_ECDHE_RSA_WITH_CHACHA20_POLY1305,
	((32 : GoInt)), ((0 : GoInt)), ((12 : GoInt)), _ecdheRSAKA, _suiteECDHE | _suiteTLS12, null, null, _aeadChaCha20Poly1305)),
	Go.pointer(new T_cipherSuite(tls_ECDHE_ECDSA_WITH_CHACHA20_POLY1305, ((32 : GoInt)), ((0 : GoInt)), ((12 : GoInt)), _ecdheECDSAKA,
		_suiteECDHE | _suiteECSign | _suiteTLS12, null, null, _aeadChaCha20Poly1305)),
	Go.pointer(new T_cipherSuite(tls_ECDHE_RSA_WITH_AES_128_GCM_SHA256, ((16 : GoInt)), ((0 : GoInt)), ((4 : GoInt)), _ecdheRSAKA, _suiteECDHE | _suiteTLS12,
		null, null, _aeadAESGCM)),
	Go.pointer(new T_cipherSuite(tls_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256, ((16 : GoInt)), ((0 : GoInt)), ((4 : GoInt)), _ecdheECDSAKA,
		_suiteECDHE | _suiteECSign | _suiteTLS12, null, null, _aeadAESGCM)),
	Go.pointer(new T_cipherSuite(tls_ECDHE_RSA_WITH_AES_256_GCM_SHA384, ((32 : GoInt)), ((0 : GoInt)), ((4 : GoInt)), _ecdheRSAKA,
		_suiteECDHE | _suiteTLS12 | _suiteSHA384, null, null, _aeadAESGCM)),
	Go.pointer(new T_cipherSuite(tls_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384, ((32 : GoInt)), ((0 : GoInt)), ((4 : GoInt)), _ecdheECDSAKA,
		_suiteECDHE | _suiteECSign | _suiteTLS12 | _suiteSHA384, null, null, _aeadAESGCM)),
	Go.pointer(new T_cipherSuite(tls_ECDHE_RSA_WITH_AES_128_CBC_SHA256, ((16 : GoInt)), ((32 : GoInt)), ((16 : GoInt)), _ecdheRSAKA,
		_suiteECDHE | _suiteTLS12, _cipherAES, _macSHA256, null)),
	Go.pointer(new T_cipherSuite(tls_ECDHE_RSA_WITH_AES_128_CBC_SHA, ((16 : GoInt)), ((20 : GoInt)), ((16 : GoInt)), _ecdheRSAKA, _suiteECDHE, _cipherAES,
		_macSHA1, null)),
	Go.pointer(new T_cipherSuite(tls_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256, ((16 : GoInt)), ((32 : GoInt)), ((16 : GoInt)), _ecdheECDSAKA,
		_suiteECDHE | _suiteECSign | _suiteTLS12, _cipherAES, _macSHA256, null)),
	Go.pointer(new T_cipherSuite(tls_ECDHE_ECDSA_WITH_AES_128_CBC_SHA, ((16 : GoInt)), ((20 : GoInt)), ((16 : GoInt)), _ecdheECDSAKA,
		_suiteECDHE | _suiteECSign, _cipherAES, _macSHA1, null)),
	Go.pointer(new T_cipherSuite(tls_ECDHE_RSA_WITH_AES_256_CBC_SHA, ((32 : GoInt)), ((20 : GoInt)), ((16 : GoInt)), _ecdheRSAKA, _suiteECDHE, _cipherAES,
		_macSHA1, null)),
	Go.pointer(new T_cipherSuite(tls_ECDHE_ECDSA_WITH_AES_256_CBC_SHA, ((32 : GoInt)), ((20 : GoInt)), ((16 : GoInt)), _ecdheECDSAKA,
		_suiteECDHE | _suiteECSign, _cipherAES, _macSHA1, null)),
	...
	Go.pointer(new T_cipherSuite(tls_RSA_WITH_AES_256_GCM_SHA384, ((32 : GoInt)), ((0 : GoInt)), ((4 : GoInt)), _rsaKA, _suiteTLS12 | _suiteSHA384, null,
		null, _aeadAESGCM)),
	Go.pointer(new T_cipherSuite(tls_RSA_WITH_AES_128_CBC_SHA256, ((16 : GoInt)), ((32 : GoInt)), ((16 : GoInt)), _rsaKA, _suiteTLS12, _cipherAES, _macSHA256,
		null)),
	Go.pointer(new T_cipherSuite(tls_RSA_WITH_AES_128_CBC_SHA, ((16 : GoInt)), ((20 : GoInt)), ((16 : GoInt)), _rsaKA, ((0 : GoInt)), _cipherAES, _macSHA1,
		null)),
	Go.pointer(new T_cipherSuite(tls_RSA_WITH_AES_256_CBC_SHA, ((32 : GoInt)), ((20 : GoInt)), ((16 : GoInt)), _rsaKA, ((0 : GoInt)), _cipherAES, _macSHA1,
		null)),
	Go.pointer(new T_cipherSuite(tls_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA, ((24 : GoInt)), ((20 : GoInt)), ((8 : GoInt)), _ecdheRSAKA, _suiteECDHE, _cipher3DES,
		_macSHA1, null)),
	Go.pointer(new T_cipherSuite(tls_RSA_WITH_3DES_EDE_CBC_SHA, ((24 : GoInt)), ((20 : GoInt)), ((8 : GoInt)), _rsaKA, ((0 : GoInt)), _cipher3DES, _macSHA1,
		null)),
	Go.pointer(new T_cipherSuite(tls_RSA_WITH_RC4_128_SHA, ((16 : GoInt)), ((20 : GoInt)), ((0 : GoInt)), _rsaKA, ((0 : GoInt)), _cipherRC4, _macSHA1, null)),
	Go.pointer(new T_cipherSuite(tls_ECDHE_RSA_WITH_RC4_128_SHA, ((16 : GoInt)), ((20 : GoInt)), ((0 : GoInt)), _ecdheRSAKA, _suiteECDHE, _cipherRC4,
		_macSHA1, null)),
	Go.pointer(new T_cipherSuite(tls_ECDHE_ECDSA_WITH_RC4_128_SHA, ((16 : GoInt)), ((20 : GoInt)), ((0 : GoInt)), _ecdheECDSAKA, _suiteECDHE | _suiteECSign,
		_cipherRC4, _macSHA1, null)));
...
var _cipherSuitesPreferenceOrderNoAES:Slice<GoUInt16> = new Slice<GoUInt16>(tls_ECDHE_ECDSA_WITH_CHACHA20_POLY1305, tls_ECDHE_RSA_WITH_CHACHA20_POLY1305,
	tls_ECDHE_ECDSA_WITH_AES_128_GCM_SHA256, tls_ECDHE_RSA_WITH_AES_128_GCM_SHA256, tls_ECDHE_ECDSA_WITH_AES_256_GCM_SHA384,
	tls_ECDHE_RSA_WITH_AES_256_GCM_SHA384, tls_ECDHE_ECDSA_WITH_AES_128_CBC_SHA, tls_ECDHE_RSA_WITH_AES_128_CBC_SHA, tls_ECDHE_ECDSA_WITH_AES_256_CBC_SHA,
	tls_ECDHE_RSA_WITH_AES_256_CBC_SHA, tls_RSA_WITH_AES_128_GCM_SHA256, tls_RSA_WITH_AES_256_GCM_SHA384, tls_RSA_WITH_AES_128_CBC_SHA,
	tls_RSA_WITH_AES_256_CBC_SHA, tls_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA, tls_RSA_WITH_3DES_EDE_CBC_SHA, tls_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256,
	tls_ECDHE_RSA_WITH_AES_128_CBC_SHA256, tls_RSA_WITH_AES_128_CBC_SHA256, tls_ECDHE_ECDSA_WITH_RC4_128_SHA, tls_ECDHE_RSA_WITH_RC4_128_SHA,
	tls_RSA_WITH_RC4_128_SHA);
...
**/
function _verifyHandshakeSignature(_sigType:GoUInt8, _pubkey:stdgo.crypto.Crypto.PublicKey, _hashFunc:stdgo.crypto.Crypto.Hash, _signed:Slice<GoByte>,
		_sig:Slice<GoByte>):Error {
	if (_sigType == _signatureECDSA) {
		var __tmp__ = try {
		...
		var _signOpts:Pointer<stdgo.crypto.rsa.Rsa.PSSOptions> = Go.pointer((({saltLength: stdgo.crypto.rsa.Rsa.psssaltLengthEqualsHash,
...
function _typeAndHashFromSignatureScheme(_signatureAlgorithm:SignatureScheme):{var _0:GoUInt8; var _1:stdgo.crypto.Crypto.Hash; var _2:Error;} {
	var _sigType:GoUInt8 = ((0 : GoUInt8)),
		_hash:stdgo.crypto.Crypto.Hash = new stdgo.crypto.Crypto.Hash(),
		_err:Error = ((null : stdgo.Error));
	if (_signatureAlgorithm.__t__ == pkcs1withSHA1.__t__
		|| _signatureAlgorithm.__t__ == pkcs1withSHA256.__t__
		|| _signatureAlgorithm.__t__ == pkcs1withSHA384.__t__
		|| _signatureAlgorithm.__t__ == pkcs1withSHA512.__t__) {
		_sigType = _signaturePKCS1v15;
	} else if (_signatureAlgorithm.__t__ == psswithSHA256.__t__
		|| _signatureAlgorithm.__t__ == psswithSHA384.__t__
		|| _signatureAlgorithm.__t__ == psswithSHA512.__t__) {
		_sigType = _signatureRSAPSS;
	} else if (_signatureAlgorithm.__t__ == ecdsawithSHA1.__t__
		|| _signatureAlgorithm.__t__ == ecdsawithP256AndSHA256.__t__
		|| _signatureAlgorithm.__t__ == ecdsawithP384AndSHA384.__t__
		|| _signatureAlgorithm.__t__ == ecdsawithP521AndSHA512.__t__) {
		_sigType = _signatureECDSA;
	} else if (_signatureAlgorithm.__t__ == ed25519.__t__) {
		_sigType = _signatureEd25519;
	} else {
		return {_0: ((0 : GoUInt8)), _1: new stdgo.crypto.Crypto.Hash(((0 : GoUInt))), _2: stdgo.fmt.Fmt.errorf("unsupported signature algorithm: %v",
			Go.toInterface(_signatureAlgorithm))};
	};
	...
	} else if (_signatureAlgorithm.__t__ == pkcs1withSHA256.__t__
		|| _signatureAlgorithm.__t__ == psswithSHA256.__t__
		|| _signatureAlgorithm.__t__ == ecdsawithP256AndSHA256.__t__) {
		stdgo.hash.Hash = stdgo.crypto.Crypto.sha256;
	} else if (_signatureAlgorithm.__t__ == pkcs1withSHA384.__t__
		|| _signatureAlgorithm.__t__ == psswithSHA384.__t__
		|| _signatureAlgorithm.__t__ == ecdsawithP384AndSHA384.__t__) {
		stdgo.hash.Hash = stdgo.crypto.Crypto.sha384;
	} else if (_signatureAlgorithm.__t__ == pkcs1withSHA512.__t__
		|| _signatureAlgorithm.__t__ == psswithSHA512.__t__
		|| _signatureAlgorithm.__t__ == ecdsawithP521AndSHA512.__t__) {
...
function _legacyTypeAndHashFromPublicKey(_pub:stdgo.crypto.Crypto.PublicKey):{var _0:GoUInt8; var _1:stdgo.crypto.Crypto.Hash; var _2:Error;} {
	...
	if (Go.assertable(((_pub : Pointer<stdgo.crypto.rsa.Rsa.PublicKey>)))) {
		...
		return {_0: ((0 : GoUInt8)), _1: new stdgo.crypto.Crypto.Hash(((0 : GoUInt))),
			_2: stdgo.fmt.Fmt.errorf("tls: Ed25519 public keys are not supported before TLS 1.2")};
	} else {
		return {_0: ((0 : GoUInt8)), _1: new stdgo.crypto.Crypto.Hash(((0 : GoUInt))), _2: stdgo.fmt.Fmt.errorf("tls: unsupported public key: %T",
			Go.toInterface(_pub))};
	};
}
...
function _signatureSchemesForCertificate(_version:GoUInt16, _cert:Pointer<Certificate>):Slice<SignatureScheme> {
	...
	if (Go.assertable(((_priv.public_() : Pointer<stdgo.crypto.ecdsa.Ecdsa.PublicKey>)))) {
		...
		_sigAlgs = new Slice<SignatureScheme>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) new SignatureScheme()])
			.setCap(((_rsaSignatureSchemes.length : GoInt)).toBasic());
...
function _selectSignatureScheme(_vers:GoUInt16, _c:Pointer<Certificate>, _peerAlgs:Slice<SignatureScheme>):{var _0:SignatureScheme; var _1:Error;} {
	...
	return {_0: new SignatureScheme(((0 : GoUInt16))),
		_1: stdgo.errors.Errors.new_("tls: peer doesn\'t support any of the certificate\'s signature algorithms")};
}
...
function _unsupportedCertificateError(_cert:Pointer<Certificate>):Error {
	if (Go.assertable(((_cert.value.privateKey : stdgo.crypto.rsa.Rsa.PrivateKey)))
		|| Go.assertable(((_cert.value.privateKey : stdgo.crypto.ecdsa.Ecdsa.PrivateKey)))) {
		return stdgo.fmt.Fmt.errorf("tls: unsupported certificate: private key is %T, expected *%T", Go.toInterface(_cert.value.privateKey),
			Go.toInterface(_cert.value.privateKey));
	...
	if (Go.assertable(((_signer.public_() : Pointer<stdgo.crypto.ecdsa.Ecdsa.PublicKey>)))) {
		var _pub:Pointer<stdgo.crypto.ecdsa.Ecdsa.PublicKey> = _signer.public_() == null ? null : _signer.public_()
			.__underlying__() == null ? null : _signer.public_() == null ? null : _signer.public_()
			.__underlying__()
			.value;
		if (Go.toInterface(_pub.value.curve) == Go.toInterface(stdgo.crypto.elliptic.Elliptic.p256())) {} else
			if (Go.toInterface(_pub.value.curve) == Go.toInterface(stdgo.crypto.elliptic.Elliptic.p384())) {} else
				if (Go.toInterface(_pub.value.curve) == Go.toInterface(stdgo.crypto.elliptic.Elliptic.p521())) {} else {
		...
		var _pub:Pointer<stdgo.crypto.rsa.Rsa.PublicKey> = _signer.public_() == null ? null : _signer.public_()
			.__underlying__() == null ? null : _signer.public_() == null ? null : _signer.public_()
			.__underlying__()
			.value;
		...
		var _pub:stdgo.crypto.ed25519.Ed25519.PublicKey = _signer.public_() == null ? null : _signer.public_()
			.__underlying__() == null ? null : _signer.public_() == null ? null : _signer.public_()
			.__underlying__()
			.value;
	} else {
...
function cipherSuites():Slice<Pointer<CipherSuite>> {
	return new Slice<Pointer<CipherSuite>>(Go.pointer(new CipherSuite(tls_RSA_WITH_AES_128_CBC_SHA, "TLS_RSA_WITH_AES_128_CBC_SHA", _supportedUpToTLS12,
		false)),
		...
		Go.pointer(new CipherSuite(tls_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256, "TLS_ECDHE_ECDSA_WITH_CHACHA20_POLY1305_SHA256", _supportedOnlyTLS12,
			false)));
}
...
function insecureCipherSuites():Slice<Pointer<CipherSuite>> {
	return new Slice<Pointer<CipherSuite>>(Go.pointer(new CipherSuite(tls_RSA_WITH_RC4_128_SHA, "TLS_RSA_WITH_RC4_128_SHA", _supportedUpToTLS12, true)),
		Go.pointer(new CipherSuite(tls_RSA_WITH_3DES_EDE_CBC_SHA, "TLS_RSA_WITH_3DES_EDE_CBC_SHA", _supportedUpToTLS12, true)),
		Go.pointer(new CipherSuite(tls_RSA_WITH_AES_128_CBC_SHA256, "TLS_RSA_WITH_AES_128_CBC_SHA256", _supportedOnlyTLS12, true)),
		Go.pointer(new CipherSuite(tls_ECDHE_ECDSA_WITH_RC4_128_SHA, "TLS_ECDHE_ECDSA_WITH_RC4_128_SHA", _supportedUpToTLS12, true)),
		Go.pointer(new CipherSuite(tls_ECDHE_RSA_WITH_RC4_128_SHA, "TLS_ECDHE_RSA_WITH_RC4_128_SHA", _supportedUpToTLS12, true)),
		Go.pointer(new CipherSuite(tls_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA, "TLS_ECDHE_RSA_WITH_3DES_EDE_CBC_SHA", _supportedUpToTLS12, true)),
		Go.pointer(new CipherSuite(tls_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256, "TLS_ECDHE_ECDSA_WITH_AES_128_CBC_SHA256", _supportedOnlyTLS12, true)),
		Go.pointer(new CipherSuite(tls_ECDHE_RSA_WITH_AES_128_CBC_SHA256, "TLS_ECDHE_RSA_WITH_AES_128_CBC_SHA256", _supportedOnlyTLS12, true)));
}
...
function _cipherRC4(_key:Slice<GoByte>, _iv:Slice<GoByte>, _isRead:Bool):AnyInterface {
	var __tmp__ = stdgo.crypto.rc4.Rc4.newCipher(_key),
		_cipher:Pointer<stdgo.crypto.rc4.Rc4.Cipher> = __tmp__._0,
		_:stdgo.Error = __tmp__._1;
	return Go.toInterface(_cipher);
}

function _cipher3DES(_key:Slice<GoByte>, _iv:Slice<GoByte>, _isRead:Bool):AnyInterface {
	var __tmp__ = stdgo.crypto.des.Des.newTripleDESCipher(_key),
		_block:stdgo.crypto.cipher.Cipher.Block = __tmp__._0,
		_:stdgo.Error = __tmp__._1;
	if (_isRead) {
...
function _cipherAES(_key:Slice<GoByte>, _iv:Slice<GoByte>, _isRead:Bool):AnyInterface {
	var __tmp__ = stdgo.crypto.aes.Aes.newCipher(_key),
		_block:stdgo.crypto.cipher.Cipher.Block = __tmp__._0,
		_:stdgo.Error = __tmp__._1;
	if (_isRead) {
		return Go.toInterface(stdgo.crypto.cipher.Cipher.newCBCDecrypter(_block, _iv));
...
function _aeadAESGCM(_key:Slice<GoByte>, _noncePrefix:Slice<GoByte>):T_aead {
	...
	var __tmp__ = stdgo.crypto.aes.Aes.newCipher(_key),
		_aes:stdgo.crypto.cipher.Cipher.Block = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
		throw _err;
	};
	var __tmp__ = stdgo.crypto.cipher.Cipher.newGCM(_aes),
		_aead:stdgo.crypto.cipher.Cipher.AEAD = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
		throw _err;
	};
	var _ret:Pointer<T_prefixNonceAEAD> = Go.pointer((({_aead: _aead,
		_nonce: new GoArray<GoUInt8>(...[for (i in 0...12) ((0 : GoUInt8))])} : T_prefixNonceAEAD)));
...
function _aeadAESGCMTLS13(_key:Slice<GoByte>, _nonceMask:Slice<GoByte>):T_aead {
	...
	var _ret:Pointer<T_xorNonceAEAD> = Go.pointer((({_aead: _aead,
		_nonceMask: new GoArray<GoUInt8>(...[for (i in 0...12) ((0 : GoUInt8))])} : T_xorNonceAEAD)));
...
function _aeadChaCha20Poly1305(_key:Slice<GoByte>, _nonceMask:Slice<GoByte>):T_aead {
	...
	var __tmp__ = golang_org.x.crypto.chacha20poly1305.Chacha20poly1305.new_(_key),
		_aead:stdgo.crypto.cipher.Cipher.AEAD = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
		throw _err;
...
**/
function _tls10MAC(_h:stdgo.hash.Hash.Hash, _out:Slice<GoByte>, _seq:Slice<GoByte>, _header:Slice<GoByte>, _data:Slice<GoByte>,
		_extra:Slice<GoByte>):Slice<GoByte> {
	_h.reset();
	_h.write(_seq);
	_h.write(_header);
	_h.write(_data);
...
function _ecdheECDSAKA(_version:GoUInt16):T_keyAgreement {
	return Go.pointer((({
		_isRSA: false,
		_version: _version,
		_params: ((null : T_ecdheParameters)),
		_ckx: new Pointer<T_clientKeyExchangeMsg>().nil(),
		_preMasterSecret: new Slice<GoUInt8>().nil()
	} : T_ecdheKeyAgreement))).value;
}
...
function _supportedVersionsFromMax(_maxVersion:GoUInt16):Slice<GoUInt16> {
	var _versions:Slice<GoUInt16> = new Slice<GoUInt16>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt16))])
		.setCap(((_supportedVersions.length : GoInt)).toBasic());
...
function newLRUClientSessionCache(_capacity:GoInt):ClientSessionCache {
	...
	return Go.pointer((({
		...
		_q: stdgo.container.list.List.new_(),
		_capacity: _capacity,
		mutex: new stdgo.sync.Sync.Mutex()
	} : T_lruSessionCache))).value;
}
...
**/
function _certificateRequestInfoFromMsg(_ctx:stdgo.context.Context.Context, _vers:GoUInt16,
		_certReq:Pointer<T_certificateRequestMsg>):Pointer<CertificateRequestInfo> {
	var _cri:Pointer<CertificateRequestInfo> = Go.pointer((({
		acceptableCAs: _certReq.value._certificateAuthorities,
		version: _vers,
		_ctx: _ctx,
		signatureSchemes: new Slice<SignatureScheme>().nil()
	...
	if (!_certReq.value._hasSignatureAlgorithm) {
		if (_rsaAvail && _ecAvail) {
			_cri.value.signatureSchemes = new Slice<SignatureScheme>(ecdsawithP256AndSHA256, ecdsawithP384AndSHA384, ecdsawithP521AndSHA512, pkcs1withSHA256,
				pkcs1withSHA384, pkcs1withSHA512, pkcs1withSHA1);
		} else if (_rsaAvail) {
	...
	_cri.value.signatureSchemes = new Slice<SignatureScheme>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) new SignatureScheme()])
		.setCap(((_certReq.value._supportedSignatureAlgorithms.length : GoInt)).toBasic());
	for (_ => _sigScheme in _certReq.value._supportedSignatureAlgorithms) {
		var __tmp__ = _typeAndHashFromSignatureScheme(_sigScheme),
			_sigType:GoUInt8 = __tmp__._0,
			_:stdgo.crypto.Crypto.Hash = __tmp__._1,
			_err:stdgo.Error = __tmp__._2;
		if (_err != null) {
			continue;
		};
...
function _hostnameInSNI(_name:GoString):GoString {
	...
	if (_host.length > ((0 : GoInt))
		&& _host[((0 : GoInt))] == (("[".code : GoRune))
		&& _host[_host.length - ((1 : GoInt))] == (("]".code : GoRune))) {
...
function _readUint8LengthPrefixed(_s:Pointer<golang_org.x.crypto.cryptobyte.Cryptobyte.String_>, _out:Pointer<Slice<GoByte>>):Bool {
	return _s.value.readUint8LengthPrefixed(new Pointer<vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_>(() ->
		new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_(_out.value),
		v -> new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_((_out.value = v.__t__))));
}
...
function _readUint16LengthPrefixed(_s:Pointer<golang_org.x.crypto.cryptobyte.Cryptobyte.String_>, _out:Pointer<Slice<GoByte>>):Bool {
	return _s.value.readUint16LengthPrefixed(new Pointer<vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_>(() ->
		new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_(_out.value),
		v -> new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_((_out.value = v.__t__))));
}
...
function _readUint24LengthPrefixed(_s:Pointer<golang_org.x.crypto.cryptobyte.Cryptobyte.String_>, _out:Pointer<Slice<GoByte>>):Bool {
	return _s.value.readUint24LengthPrefixed(new Pointer<vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_>(() ->
		new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_(_out.value),
		v -> new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_((_out.value = v.__t__))));
}
...
function _unmarshalCertificate(_s:Pointer<golang_org.x.crypto.cryptobyte.Cryptobyte.String_>, _certificate:Pointer<Certificate>):Bool {
	...
	while (!_certList.empty()) {
		...
		var _extensions:golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_();
		if (!_readUint24LengthPrefixed(Go.pointer(_certList), Go.pointer(_cert))
			|| !_certList.readUint16LengthPrefixed(Go.pointer(_extensions))) {
			return false;
		};
		...
		while (!_extensions.empty()) {
			...
			if (_extension == _extensionStatusRequest) {
				...
				if (!_extData.readUint8(Go.pointer(_statusType))
					|| _statusType != _statusTypeOCSP
					|| !_readUint24LengthPrefixed(Go.pointer(_extData), Go.pointer(_certificate.value.ocspstaple))
					|| _certificate.value.ocspstaple.length == ((0 : GoInt))) {
					return false;
				};
			} else if (_extension == _extensionSCT) {
				var _sctList:golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_();
...
function _clientHelloInfo(_ctx:stdgo.context.Context.Context, _c:Pointer<Conn>, _clientHello:Pointer<T_clientHelloMsg>):Pointer<ClientHelloInfo> {
	...
	return Go.pointer((({
		cipherSuites: _clientHello.value._cipherSuites,
		serverName: _clientHello.value._serverName,
		supportedCurves: _clientHello.value._supportedCurves,
		supportedPoints: _clientHello.value._supportedPoints,
		signatureSchemes: _clientHello.value._supportedSignatureAlgorithms,
		supportedProtos: _clientHello.value._alpnProtocols,
		supportedVersions: _supportedVersions,
		conn: _c.value._conn,
		_config: _c.value._config,
		_ctx: _ctx
	} : ClientHelloInfo)));
}
...
function _cloneHash(_in:stdgo.hash.Hash.Hash, _h:stdgo.crypto.Crypto.Hash):stdgo.hash.Hash.Hash {
	...
	var __tmp__ = _marshaler.marshalBinary(),
...
function _illegalClientHelloChange(_ch:Pointer<T_clientHelloMsg>, _ch1:Pointer<T_clientHelloMsg>):Bool {
	if (_ch.value._supportedVersions.length != _ch1.value._supportedVersions.length
		|| _ch.value._cipherSuites.length != _ch1.value._cipherSuites.length
		|| _ch.value._supportedCurves.length != _ch1.value._supportedCurves.length
		|| _ch.value._supportedSignatureAlgorithms.length != _ch1.value._supportedSignatureAlgorithms.length
		|| _ch.value._supportedSignatureAlgorithmsCert.length != _ch1.value._supportedSignatureAlgorithmsCert.length
		|| _ch.value._alpnProtocols.length != _ch1.value._alpnProtocols.length) {
		return true;
	};
	...
	return _ch.value._vers != _ch1.value._vers
		|| !stdgo.bytes.Bytes.equal(_ch.value._random, _ch1.value._random)
		|| !stdgo.bytes.Bytes.equal(_ch.value._sessionId, _ch1.value._sessionId)
		|| !stdgo.bytes.Bytes.equal(_ch.value._compressionMethods, _ch1.value._compressionMethods)
		|| _ch.value._serverName != _ch1.value._serverName
		|| _ch.value._ocspStapling != _ch1.value._ocspStapling
		|| !stdgo.bytes.Bytes.equal(_ch.value._supportedPoints, _ch1.value._supportedPoints)
		|| _ch.value._ticketSupported != _ch1.value._ticketSupported
		|| !stdgo.bytes.Bytes.equal(_ch.value._sessionTicket, _ch1.value._sessionTicket)
		|| _ch.value._secureRenegotiationSupported != _ch1.value._secureRenegotiationSupported
		|| !stdgo.bytes.Bytes.equal(_ch.value._secureRenegotiation, _ch1.value._secureRenegotiation)
		|| _ch.value._scts != _ch1.value._scts
		|| !stdgo.bytes.Bytes.equal(_ch.value._cookie, _ch1.value._cookie)
		|| !stdgo.bytes.Bytes.equal(_ch.value._pskModes, _ch1.value._pskModes);
}
...
function _md5SHA1Hash(_slices:Slice<Slice<GoByte>>):Slice<GoByte> {
	var _md5sha1:Slice<GoUInt8> = new Slice<GoUInt8>(...[
		for (i in 0...((stdgo.crypto.md5.Md5.size + stdgo.crypto.sha1.Sha1.size:GoInt)).toBasic()) ((0 : GoUInt8))
	]);
...
function _generateECDHEParameters(_rand:stdgo.io.Io.Reader, _curveID:CurveID):{var _0:T_ecdheParameters; var _1:Error;} {
	if (_curveID.__t__ == x25519.__t__) {
		var _privateKey:Slice<GoUInt8> = new Slice<GoUInt8>(...[
			for (i in 0...((golang_org.x.crypto.curve25519.Curve25519.scalarSize : GoInt)).toBasic()) ((0 : GoUInt8))
		]);
		{
			var __tmp__ = stdgo.io.Io.readFull(_rand, _privateKey),
				_:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
		...
		var __tmp__ = golang_org.x.crypto.curve25519.Curve25519.x25519(_privateKey, golang_org.x.crypto.curve25519.Curve25519.basepoint),
			_publicKey:Slice<GoUInt8> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: ((null : T_ecdheParameters)), _1: _err};
		};
	...
	var _p:Pointer<T_nistParameters> = Go.pointer((({
		_curveID: _curveID,
		_privateKey: new Slice<GoUInt8>().nil(),
		_x: new Pointer<stdgo.math.big.Big.Int_>().nil(),
		_y: new Pointer<stdgo.math.big.Big.Int_>().nil()
	} : T_nistParameters)));
	var _err:Error = ((null : stdgo.Error));
	{
...
function _splitPreMasterSecret(_secret:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:Slice<GoByte>;} {
	var _s1:Slice<GoByte> = new Slice<GoUInt8>().nil(),
		_s2:Slice<GoByte> = new Slice<GoUInt8>().nil();
...
function _prf10(_result:Slice<GoByte>, _secret:Slice<GoByte>, _label:Slice<GoByte>, _seed:Slice<GoByte>):Void {
	...
	var __tmp__ = _splitPreMasterSecret(_secret),
		_s1:Slice<GoUInt8> = __tmp__._0,
		_s2:Slice<GoUInt8> = __tmp__._1;
...
function _prfAndHashForVersion(_version:GoUInt16,
		_suite:Pointer<T_cipherSuite>):{var _0:(_result:Slice<GoByte>, _secret:Slice<GoByte>, _label:Slice<GoByte>,
	_seed:Slice<GoByte>) -> Void; var _1:stdgo.crypto.Crypto.Hash;} {
...
function _prfForVersion(_version:GoUInt16,
		_suite:Pointer<T_cipherSuite>):(_result:Slice<GoByte>, _secret:Slice<GoByte>, _label:Slice<GoByte>, _seed:Slice<GoByte>) -> Void {
	var __tmp__ = _prfAndHashForVersion(_version, _suite),
		_prf:(Slice<GoUInt8>, Slice<GoUInt8>, Slice<GoUInt8>, Slice<GoUInt8>) -> Void = __tmp__._0,
		_:stdgo.crypto.Crypto.Hash = __tmp__._1;
	return _prf;
}
...
**/
function _masterFromPreMasterSecret(_version:GoUInt16, _suite:Pointer<T_cipherSuite>, _preMasterSecret:Slice<GoByte>, _clientRandom:Slice<GoByte>,
		_serverRandom:Slice<GoByte>):Slice<GoByte> {
	var _seed:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((_clientRandom.length
		+ _serverRandom.length:GoInt)).toBasic());
...
**/
function _keysFromMasterSecret(_version:GoUInt16, _suite:Pointer<T_cipherSuite>, _masterSecret:Slice<GoByte>, _clientRandom:Slice<GoByte>,
		_serverRandom:Slice<GoByte>, _macLen:GoInt, _keyLen:GoInt, _ivLen:GoInt):{
	var _0:Slice<GoByte>;
	var _1:Slice<GoByte>;
	var _2:Slice<GoByte>;
	var _3:Slice<GoByte>;
	...
	var _clientMAC:Slice<GoByte> = new Slice<GoUInt8>().nil(),
		_serverMAC:Slice<GoByte> = new Slice<GoUInt8>().nil(),
		_clientKey:Slice<GoByte> = new Slice<GoUInt8>().nil(),
		_serverKey:Slice<GoByte> = new Slice<GoUInt8>().nil(),
		_clientIV:Slice<GoByte> = new Slice<GoUInt8>().nil(),
		_serverIV:Slice<GoByte> = new Slice<GoUInt8>().nil();
	var _seed:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((_serverRandom.length
		+ _clientRandom.length:GoInt)).toBasic());
	_seed = _seed.__append__(..._serverRandom.toArray());
	_seed = _seed.__append__(..._clientRandom.toArray());
...
function _newFinishedHash(_version:GoUInt16, _cipherSuite:Pointer<T_cipherSuite>):T_finishedHash {
	...
	var __tmp__ = _prfAndHashForVersion(_version, _cipherSuite),
		_prf:(Slice<GoUInt8>, Slice<GoUInt8>, Slice<GoUInt8>, Slice<GoUInt8>) -> Void = __tmp__._0,
		_hash:stdgo.crypto.Crypto.Hash = __tmp__._1;
	if (_hash.__t__ != ((0 : GoUInt))) {
		return new T_finishedHash(_hash.new_(), _hash.new_(), ((null : stdgo.hash.Hash.Hash)), ((null : stdgo.hash.Hash.Hash)), _buffer, _version,
			_prf).__copy__();
	};
	return new T_finishedHash(stdgo.crypto.sha1.Sha1.new_(), stdgo.crypto.sha1.Sha1.new_(), stdgo.crypto.md5.Md5.new_(), stdgo.crypto.md5.Md5.new_(), _buffer,
		_version, _prf).__copy__();
}
...
**/
function _ekmFromMasterSecret(_version:GoUInt16, _suite:Pointer<T_cipherSuite>, _masterSecret:Slice<GoByte>, _clientRandom:Slice<GoByte>,
		_serverRandom:Slice<GoByte>):(GoString, Slice<GoByte>, GoInt) -> {
		var _0:Slice<GoByte>;
		var _1:Error;
	} {
	return function(_label:GoString, _context:Slice<GoByte>, _length:GoInt):{var _0:Slice<GoByte>; var _1:Error;} {
		if (_label == (("client finished" : GoString))
			|| _label == (("server finished" : GoString))
			|| _label == (("master secret" : GoString))
			|| _label == (("key expansion" : GoString))) {
		...
		var _seed:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((_seedLen : GoInt))
			.toBasic());
		_seed = _seed.__append__(..._clientRandom.toArray());
		_seed = _seed.__append__(..._serverRandom.toArray());
		if ((_context != null && !_context.isNil())) {
...
function server(_conn:stdgo.net.Net.Conn, _config:Pointer<Config>):Pointer<Conn> {
	var _c:Pointer<Conn> = Go.pointer((({
		_conn: _conn,
		_config: _config,
		_isClient: false,
		_handshakeFn: null,
		_handshakeStatus: 0,
		_handshakeMutex: new stdgo.sync.Sync.Mutex(),
		_handshakeErr: ((null : stdgo.Error)),
		_vers: 0,
		_haveVers: false,
		_handshakes: 0,
		_didResume: false,
		_cipherSuite: 0,
		_ocspResponse: new Slice<GoUInt8>().nil(),
		_scts: new Slice<Slice<GoUInt8>>().nil(),
		_peerCertificates: new Slice<Pointer<stdgo.crypto.x509.X509.Certificate>>().nil(),
		_verifiedChains: new Slice<Slice<Pointer<stdgo.crypto.x509.X509.Certificate>>>().nil(),
		_serverName: "",
		_secureRenegotiation: false,
		_ekm: null,
		_resumptionSecret: new Slice<GoUInt8>().nil(),
		_ticketKeys: new Slice<T_ticketKey>().nil(),
		_clientFinishedIsFirst: false,
		_closeNotifyErr: ((null : stdgo.Error)),
		_closeNotifySent: false,
		_clientFinished: new GoArray<GoUInt8>(...[for (i in 0...12) ((0 : GoUInt8))]),
		_serverFinished: new GoArray<GoUInt8>(...[for (i in 0...12) ((0 : GoUInt8))]),
		_clientProtocol: "",
		_in: new T_halfConn(),
		_out: new T_halfConn(),
		_rawInput: new stdgo.bytes.Bytes.Buffer(),
		_input: new stdgo.bytes.Bytes.Reader(),
		_hand: new stdgo.bytes.Bytes.Buffer(),
		_buffering: false,
		_sendBuf: new Slice<GoUInt8>().nil(),
		_bytesSent: 0,
		_packetsSent: 0,
		_retryCount: 0,
		_activeCall: 0,
		_tmp: new GoArray<GoUInt8>(...[for (i in 0...16) ((0 : GoUInt8))])
	} : Conn)));
...
function listen(_network:GoString, _laddr:GoString, _config:Pointer<Config>):{var _0:stdgo.net.Net.Listener; var _1:Error;} {
	if ((_config == null || _config.isNil())
		|| _config.value.certificates.length == ((0 : GoInt))
		&& _config.value.getCertificate == null
		&& _config.value.getConfigForClient == null) {
		return {_0: ((null : stdgo.net.Net.Listener)),
			_1: stdgo.errors.Errors.new_("tls: neither Certificates, GetCertificate, nor GetConfigForClient set in Config")};
	};
	var __tmp__ = stdgo.net.Net.listen(_network, _laddr),
		_l:stdgo.net.Net.Listener = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
...
**/
function dialWithDialer(_dialer:Pointer<stdgo.net.Net.Dialer>, _network:GoString, _addr:GoString,
		_config:Pointer<Config>):{var _0:Pointer<Conn>; var _1:Error;} {
	return _dial(stdgo.context.Context.background(), _dialer, _network, _addr, _config);
}

function _dial(_ctx:stdgo.context.Context.Context, _netDialer:Pointer<stdgo.net.Net.Dialer>, _network:GoString, _addr:GoString,
		_config:Pointer<Config>):{var _0:Pointer<Conn>; var _1:Error;} {
	var recover_exception:Error = null;
	var deferstack:Array<Void->Void> = [];
	...
	try {
		var __tmp__ = _netDialer.value.dialContext(_ctx, _network, _addr),
			_rawConn:stdgo.net.Net.Conn = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			{
				for (defer in deferstack) {
...
function loadX509KeyPair(_certFile:GoString, _keyFile:GoString):{var _0:Certificate; var _1:Error;} {
	var __tmp__ = stdgo.os.Os.readFile(_certFile),
		_certPEMBlock:Slice<GoUInt8> = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
		return {_0: new Certificate().__copy__(), _1: _err};
	};
	var __tmp__ = stdgo.os.Os.readFile(_keyFile),
		_keyPEMBlock:Slice<GoUInt8> = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
		return {_0: new Certificate().__copy__(), _1: _err};
	};
...
function x509keyPair(_certPEMBlock:Slice<GoByte>, _keyPEMBlock:Slice<GoByte>):{var _0:Certificate; var _1:Error;} {
	var _fail:stdgo.Error -> {
		var _0:Certificate;
		var _1:stdgo.Error;
	} = function(_err:Error):{var _0:Certificate; var _1:Error;} {
		return {_0: new Certificate().__copy__(), _1: _err};
	};
	...
	if (_cert.certificate.length == ((0 : GoInt))) {
		...
		if (_skippedBlockTypes.length == ((1 : GoInt))
			&& stdgo.strings.Strings.hasSuffix(_skippedBlockTypes[((0 : GoInt))], "PRIVATE KEY")) {
			return
				_fail(stdgo.errors.Errors.new_("tls: failed to find certificate PEM data in certificate input, but did find a private key; PEM inputs may have been switched"));
		};
		return
			_fail(stdgo.fmt.Fmt.errorf("tls: failed to find \"CERTIFICATE\" PEM block in certificate input after skipping PEM blocks of the following types: %v",
			Go.toInterface(_skippedBlockTypes)));
	};
	...
	while (true) {
		...
		if ((_keyDERBlock == null || _keyDERBlock.isNil())) {
			...
			return
				_fail(stdgo.fmt.Fmt.errorf("tls: failed to find PEM block with type ending in \"PRIVATE KEY\" in key input after skipping PEM blocks of the following types: %v",
				Go.toInterface(_skippedBlockTypes)));
		};
		if (_keyDERBlock.value.type == (("PRIVATE KEY" : GoString))
			|| stdgo.strings.Strings.hasSuffix(_keyDERBlock.value.type, " PRIVATE KEY")) {
			break;
		};
		_skippedBlockTypes = _skippedBlockTypes.__append__(_keyDERBlock.value.type);
	};
	var __tmp__ = stdgo.crypto.x509.X509.parseCertificate(_cert.certificate[((0 : GoInt))]),
		_x509Cert:Pointer<stdgo.crypto.x509.X509.Certificate> = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
		return _fail(_err);
	...
	if (Go.assertable(((_x509Cert.value.publicKey : Pointer<stdgo.crypto.rsa.Rsa.PublicKey>)))) {
		var _pub:Pointer<stdgo.crypto.rsa.Rsa.PublicKey> = _x509Cert.value.publicKey == null ? null : _x509Cert.value.publicKey.__underlying__() == null ? null : _x509Cert.value.publicKey == null ? null : _x509Cert.value.publicKey.__underlying__()
			.value;
		var __tmp__ = try {
		...
		var _pub:Pointer<stdgo.crypto.ecdsa.Ecdsa.PublicKey> = _x509Cert.value.publicKey == null ? null : _x509Cert.value.publicKey.__underlying__() == null ? null : _x509Cert.value.publicKey == null ? null : _x509Cert.value.publicKey.__underlying__()
			.value;
		var __tmp__ = try {
		...
		if (_pub.value.x.value.cmp(_priv.value.publicKey.x) != ((0 : GoInt))
			|| _pub.value.y.value.cmp(_priv.value.publicKey.y) != ((0 : GoInt))) {
			return _fail(stdgo.errors.Errors.new_("tls: private key does not match public key"));
		};
	} else if (Go.assertable(((_x509Cert.value.publicKey : stdgo.crypto.ed25519.Ed25519.PublicKey)))) {
		var _pub:stdgo.crypto.ed25519.Ed25519.PublicKey = _x509Cert.value.publicKey == null ? null : _x509Cert.value.publicKey.__underlying__() == null ? null : _x509Cert.value.publicKey == null ? null : _x509Cert.value.publicKey.__underlying__()
			.value;
		var __tmp__ = try {
		...
		if (!stdgo.bytes.Bytes.equal(new stdgo.crypto.ed25519.Ed25519.PublicKey(((_priv.public_().value : stdgo.crypto.Crypto.PublicKey))).__copy__().__t__,
			_pub.__copy__().__t__)) {
			return _fail(stdgo.errors.Errors.new_("tls: private key does not match public key"));
		};
	} else {
...
function _parsePrivateKey(_der:Slice<GoByte>):{var _0:stdgo.crypto.Crypto.PrivateKey; var _1:Error;} {
	{
		var __tmp__ = stdgo.crypto.x509.X509.parsePKCS1PrivateKey(_der),
			_key:Pointer<stdgo.crypto.rsa.Rsa.PrivateKey> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err == null) {
	...
	{
		var __tmp__ = stdgo.crypto.x509.X509.parsePKCS8PrivateKey(_der),
			_key:AnyInterface = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err == null) {
			if (Go.assertable(((_key : Pointer<stdgo.crypto.rsa.Rsa.PrivateKey>)))
				|| Go.assertable(((_key : Pointer<stdgo.crypto.ecdsa.Ecdsa.PrivateKey>)))
				|| Go.assertable(((_key : stdgo.crypto.ed25519.Ed25519.PrivateKey)))) {
	...
	{
		var __tmp__ = stdgo.crypto.x509.X509.parseECPrivateKey(_der),
			_key:Pointer<stdgo.crypto.ecdsa.Ecdsa.PrivateKey> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err == null) {
			return {_0: Go.toInterface(_key), _1: ((null : stdgo.Error))};
		};
...
class T_cipherSuiteTLS13_extension_fields {
	public function _expandLabel(__tmp__, _secret:Slice<GoByte>, _label:GoString, _context:Slice<GoByte>, _length:GoInt):Slice<GoByte>
		return __tmp__._expandLabel(_secret, _label, _context, _length);

	public function _deriveSecret(__tmp__, _secret:Slice<GoByte>, _label:GoString, _transcript:stdgo.hash.Hash.Hash):Slice<GoByte>
		return __tmp__._deriveSecret(_secret, _label, _transcript);

	public function _extract(__tmp__, _newSecret:Slice<GoByte>, _currentSecret:Slice<GoByte>):Slice<GoByte>
		return __tmp__._extract(_newSecret, _currentSecret);

	public function _nextTrafficSecret(__tmp__, _trafficSecret:Slice<GoByte>):Slice<GoByte>
		return __tmp__._nextTrafficSecret(_trafficSecret);

	public function _trafficKey(__tmp__, _trafficSecret:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:Slice<GoByte>;}
		return __tmp__._trafficKey(_trafficSecret);

	public function _finishedHash(__tmp__, _baseKey:Slice<GoByte>, _transcript:stdgo.hash.Hash.Hash):Slice<GoByte>
		return __tmp__._finishedHash(_baseKey, _transcript);

	public function _exportKeyingMaterial(__tmp__, _masterSecret:Slice<GoByte>, _transcript:stdgo.hash.Hash.Hash):(GoString, Slice<GoByte>, GoInt) -> {
		var _0:Slice<GoByte>;
		var _1:Error;
	}
		return __tmp__._exportKeyingMaterial(_masterSecret, _transcript);
}
...
class T_prefixNonceAEAD_extension_fields {
	...
	public function _explicitNonceLen(__tmp__):GoInt
		return __tmp__._explicitNonceLen();

	public function seal(__tmp__, _out:Slice<GoByte>, _nonce:Slice<GoByte>, _plaintext:Slice<GoByte>, _additionalData:Slice<GoByte>):Slice<GoByte>
		return __tmp__.seal(_out, _nonce, _plaintext, _additionalData);

	public function open(__tmp__, _out:Slice<GoByte>, _nonce:Slice<GoByte>, _ciphertext:Slice<GoByte>,
			_additionalData:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__.open(_out, _nonce, _ciphertext, _additionalData);
}
...
class ConnectionState_extension_fields {
	public function exportKeyingMaterial(__tmp__, _label:GoString, _context:Slice<GoByte>, _length:GoInt):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__.exportKeyingMaterial(_label, _context, _length);
}
...
class ClientHelloInfo_extension_fields {
	public function context(__tmp__):stdgo.context.Context.Context
		return __tmp__.context();

	public function supportsCertificate(__tmp__, _c:Pointer<Certificate>):Error
		return __tmp__.supportsCertificate(_c);
}
...
class Config_extension_fields {
	public function _ticketKeyFromBytes(__tmp__, _b:GoArray<GoByte>):T_ticketKey
		return __tmp__._ticketKeyFromBytes(_b);

	public function clone(__tmp__):Pointer<Config>
		return __tmp__.clone();

	public function _initLegacySessionTicketKeyRLocked(__tmp__):Void
		__tmp__._initLegacySessionTicketKeyRLocked();

	public function _ticketKeys(__tmp__, _configForClient:Pointer<Config>):Slice<T_ticketKey>
		return __tmp__._ticketKeys(_configForClient);

	public function setSessionTicketKeys(__tmp__, _keys:Slice<GoArray<GoByte>>):Void
		__tmp__.setSessionTicketKeys(_keys);

	public function _rand(__tmp__):stdgo.io.Io.Reader
		return __tmp__._rand();

	public function _time(__tmp__):stdgo.time.Time.Time
		return __tmp__._time();

	public function _cipherSuites(__tmp__):Slice<GoUInt16>
		return __tmp__._cipherSuites();

	public function _supportedVersions(__tmp__):Slice<GoUInt16>
		return __tmp__._supportedVersions();

	public function _maxSupportedVersion(__tmp__):GoUInt16
		return __tmp__._maxSupportedVersion();

	public function _curvePreferences(__tmp__):Slice<CurveID>
		return __tmp__._curvePreferences();

	public function _supportsCurve(__tmp__, _curve:CurveID):Bool
		return __tmp__._supportsCurve(_curve);

	public function _mutualVersion(__tmp__, _peerVersions:Slice<GoUInt16>):{var _0:GoUInt16; var _1:Bool;}
		return __tmp__._mutualVersion(_peerVersions);

	public function _getCertificate(__tmp__, _clientHello:Pointer<ClientHelloInfo>):{var _0:Pointer<Certificate>; var _1:Error;}
		return __tmp__._getCertificate(_clientHello);

	public function buildNameToCertificate(__tmp__):Void
		__tmp__.buildNameToCertificate();

	public function _writeKeyLog(__tmp__, _label:GoString, _clientRandom:Slice<GoByte>, _secret:Slice<GoByte>):Error
		return __tmp__._writeKeyLog(_label, _clientRandom, _secret);
}

class Certificate_extension_fields {
	public function _leaf(__tmp__):{var _0:Pointer<stdgo.crypto.x509.X509.Certificate>; var _1:Error;}
		return __tmp__._leaf();
}

class T_lruSessionCache_extension_fields {
	public function put(__tmp__, _sessionKey:GoString, _cs:Pointer<ClientSessionState>):Void
		__tmp__.put(_sessionKey, _cs);

	public function get(__tmp__, _sessionKey:GoString):{var _0:Pointer<ClientSessionState>; var _1:Bool;}
		return __tmp__.get(_sessionKey);
}
...
class Conn_extension_fields {
	...
	public function _newRecordHeaderError(__tmp__, _conn:stdgo.net.Net.Conn, _msg:GoString):RecordHeaderError
		return __tmp__._newRecordHeaderError(_conn, _msg);

	public function _readRecord(__tmp__):Error
		return __tmp__._readRecord();

	public function _readChangeCipherSpec(__tmp__):Error
		return __tmp__._readChangeCipherSpec();

	public function _readRecordOrCCS(__tmp__, _expectChangeCipherSpec:Bool):Error
		return __tmp__._readRecordOrCCS(_expectChangeCipherSpec);

	public function _retryReadRecord(__tmp__, _expectChangeCipherSpec:Bool):Error
		return __tmp__._retryReadRecord(_expectChangeCipherSpec);

	public function _readFromUntil(__tmp__, _r:stdgo.io.Io.Reader, _n:GoInt):Error
		return __tmp__._readFromUntil(_r, _n);

	public function _sendAlertLocked(__tmp__, _err:T_alert):Error
		return __tmp__._sendAlertLocked(_err);

	public function _sendAlert(__tmp__, _err:T_alert):Error
		return __tmp__._sendAlert(_err);

	public function _maxPayloadSizeForWrite(__tmp__, _typ:T_recordType):GoInt
		return __tmp__._maxPayloadSizeForWrite(_typ);

	public function _write(__tmp__, _data:Slice<GoByte>):{var _0:GoInt; var _1:Error;}
		return __tmp__._write(_data);

	public function _flush(__tmp__):{var _0:GoInt; var _1:Error;}
		return __tmp__._flush();

	public function _writeRecordLocked(__tmp__, _typ:T_recordType, _data:Slice<GoByte>):{var _0:GoInt; var _1:Error;}
		return __tmp__._writeRecordLocked(_typ, _data);

	public function _writeRecord(__tmp__, _typ:T_recordType, _data:Slice<GoByte>):{var _0:GoInt; var _1:Error;}
		return __tmp__._writeRecord(_typ, _data);

	public function _readHandshake(__tmp__):{var _0:AnyInterface; var _1:Error;}
		return __tmp__._readHandshake();

	public function write(__tmp__, _b:Slice<GoByte>):{var _0:GoInt; var _1:Error;}
		return __tmp__.write(_b);

	public function _handleRenegotiation(__tmp__):Error
		return __tmp__._handleRenegotiation();

	public function _handlePostHandshakeMessage(__tmp__):Error
		return __tmp__._handlePostHandshakeMessage();

	public function _handleKeyUpdate(__tmp__, _keyUpdate:Pointer<T_keyUpdateMsg>):Error
		return __tmp__._handleKeyUpdate(_keyUpdate);
	...
	public function _closeNotify(__tmp__):Error
		return __tmp__._closeNotify();

	public function handshake(__tmp__):Error
		return __tmp__.handshake();

	public function handshakeContext(__tmp__, _ctx:stdgo.context.Context.Context):Error
		return __tmp__.handshakeContext(_ctx);

	public function _handshakeContext(__tmp__, _ctx:stdgo.context.Context.Context):Error
		return __tmp__._handshakeContext(_ctx);

	public function connectionState(__tmp__):ConnectionState
		return __tmp__.connectionState();

	public function _connectionStateLocked(__tmp__):ConnectionState
		return __tmp__._connectionStateLocked();

	public function ocspresponse(__tmp__):Slice<GoByte>
		return __tmp__.ocspresponse();

	public function verifyHostname(__tmp__, _host:GoString):Error
		return __tmp__.verifyHostname(_host);

	public function _handshakeComplete(__tmp__):Bool
		return __tmp__._handshakeComplete();

	public function _makeClientHello(__tmp__):{var _0:Pointer<T_clientHelloMsg>; var _1:T_ecdheParameters; var _2:Error;}
		return __tmp__._makeClientHello();

	public function _clientHandshake(__tmp__, _ctx:stdgo.context.Context.Context):Error
		return __tmp__._clientHandshake(_ctx);

	public function _loadSession(__tmp__, _hello:Pointer<T_clientHelloMsg>):{
		var _0:GoString;
		var _1:Pointer<ClientSessionState>;
		var _2:Slice<GoByte>;
		var _3:Slice<GoByte>;
	}
		return __tmp__._loadSession(_hello);

	public function _pickTLSVersion(__tmp__, _serverHello:Pointer<T_serverHelloMsg>):Error
		return __tmp__._pickTLSVersion(_serverHello);

	public function _verifyServerCertificate(__tmp__, _certificates:Slice<Slice<GoByte>>):Error
		return __tmp__._verifyServerCertificate(_certificates);

	public function _getClientCertificate(__tmp__, _cri:Pointer<CertificateRequestInfo>):{var _0:Pointer<Certificate>; var _1:Error;}
		return __tmp__._getClientCertificate(_cri);

	public function _handleNewSessionTicket(__tmp__, _msg:Pointer<T_newSessionTicketMsgTLS13>):Error
		return __tmp__._handleNewSessionTicket(_msg);

	public function _serverHandshake(__tmp__, _ctx:stdgo.context.Context.Context):Error
		return __tmp__._serverHandshake(_ctx);

	public function _readClientHello(__tmp__, _ctx:stdgo.context.Context.Context):{var _0:Pointer<T_clientHelloMsg>; var _1:Error;}
		return __tmp__._readClientHello(_ctx);

	public function _processCertsFromClient(__tmp__, _certificate:Certificate):Error
		return __tmp__._processCertsFromClient(_certificate);

	public function _encryptTicket(__tmp__, _state:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__._encryptTicket(_state);

	public function _decryptTicket(__tmp__, _encrypted:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:Bool;}
		return __tmp__._decryptTicket(_encrypted);
}

class T_halfConn_extension_fields {
	public function _setErrorLocked(__tmp__, _err:Error):Error
		return __tmp__._setErrorLocked(_err);

	public function _prepareCipherSpec(__tmp__, _version:GoUInt16, _cipher:AnyInterface, _mac:stdgo.hash.Hash.Hash):Void
		__tmp__._prepareCipherSpec(_version, _cipher, _mac);

	public function _changeCipherSpec(__tmp__):Error
		return __tmp__._changeCipherSpec();

	public function _setTrafficSecret(__tmp__, _suite:Pointer<T_cipherSuiteTLS13>, _secret:Slice<GoByte>):Void
		__tmp__._setTrafficSecret(_suite, _secret);

	public function _incSeq(__tmp__):Void
		__tmp__._incSeq();

	public function _explicitNonceLen(__tmp__):GoInt
		return __tmp__._explicitNonceLen();

	public function _decrypt(__tmp__, _record:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:T_recordType; var _2:Error;}
		return __tmp__._decrypt(_record);

	public function _encrypt(__tmp__, _record:Slice<GoByte>, _payload:Slice<GoByte>, _rand:stdgo.io.Io.Reader):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__._encrypt(_record, _payload, _rand);
}
...
class T_clientHandshakeState_extension_fields {
	public function _handshake(__tmp__):Error
		return __tmp__._handshake();

	public function _pickCipherSuite(__tmp__):Error
		return __tmp__._pickCipherSuite();

	public function _doFullHandshake(__tmp__):Error
		return __tmp__._doFullHandshake();

	public function _establishKeys(__tmp__):Error
		return __tmp__._establishKeys();

	public function _serverResumedSession(__tmp__):Bool
		return __tmp__._serverResumedSession();

	public function _processServerHello(__tmp__):{var _0:Bool; var _1:Error;}
		return __tmp__._processServerHello();

	public function _readFinished(__tmp__, _out:Slice<GoByte>):Error
		return __tmp__._readFinished(_out);

	public function _readSessionTicket(__tmp__):Error
		return __tmp__._readSessionTicket();

	public function _sendFinished(__tmp__, _out:Slice<GoByte>):Error
		return __tmp__._sendFinished(_out);
}
...
class T_clientHandshakeStateTLS13_extension_fields {
	...
	public function _checkServerHelloOrHRR(__tmp__):Error
		return __tmp__._checkServerHelloOrHRR();

	public function _sendDummyChangeCipherSpec(__tmp__):Error
		return __tmp__._sendDummyChangeCipherSpec();

	public function _processHelloRetryRequest(__tmp__):Error
		return __tmp__._processHelloRetryRequest();

	public function _processServerHello(__tmp__):Error
		return __tmp__._processServerHello();

	public function _establishHandshakeKeys(__tmp__):Error
		return __tmp__._establishHandshakeKeys();

	public function _readServerParameters(__tmp__):Error
		return __tmp__._readServerParameters();

	public function _readServerCertificate(__tmp__):Error
		return __tmp__._readServerCertificate();

	public function _readServerFinished(__tmp__):Error
		return __tmp__._readServerFinished();

	public function _sendClientCertificate(__tmp__):Error
		return __tmp__._sendClientCertificate();

	public function _sendClientFinished(__tmp__):Error
		return __tmp__._sendClientFinished();
}

class T_marshalingFunction_extension_fields {
	public function marshal(__tmp__, _b:Pointer<golang_org.x.crypto.cryptobyte.Cryptobyte.Builder>):Error
		return __tmp__.marshal(_b);
}

class T_clientHelloMsg_extension_fields {
	public function _marshal(__tmp__):Slice<GoByte>
		return __tmp__._marshal();

	public function _marshalWithoutBinders(__tmp__):Slice<GoByte>
		return __tmp__._marshalWithoutBinders();

	public function _updateBinders(__tmp__, _pskBinders:Slice<Slice<GoByte>>):Void
		__tmp__._updateBinders(_pskBinders);

	public function _unmarshal(__tmp__, _data:Slice<GoByte>):Bool
		return __tmp__._unmarshal(_data);
}
...
class T_serverHandshakeState_extension_fields {
	...
	public function _processClientHello(__tmp__):Error
		return __tmp__._processClientHello();

	public function _pickCipherSuite(__tmp__):Error
		return __tmp__._pickCipherSuite();

	public function _cipherSuiteOk(__tmp__, _c:Pointer<T_cipherSuite>):Bool
		return __tmp__._cipherSuiteOk(_c);

	public function _checkForResumption(__tmp__):Bool
		return __tmp__._checkForResumption();

	public function _doResumeHandshake(__tmp__):Error
		return __tmp__._doResumeHandshake();
	...
	public function _sendSessionTicket(__tmp__):Error
		return __tmp__._sendSessionTicket();
...
class T_serverHandshakeStateTLS13_extension_fields {
	...
	public function _checkForResumption(__tmp__):Error
		return __tmp__._checkForResumption();

	public function _pickCertificate(__tmp__):Error
		return __tmp__._pickCertificate();

	public function _sendDummyChangeCipherSpec(__tmp__):Error
		return __tmp__._sendDummyChangeCipherSpec();

	public function _doHelloRetryRequest(__tmp__, _selectedGroup:CurveID):Error
		return __tmp__._doHelloRetryRequest(_selectedGroup);

	public function _sendServerParameters(__tmp__):Error
		return __tmp__._sendServerParameters();

	public function _requestClientCert(__tmp__):Bool
		return __tmp__._requestClientCert();

	public function _sendServerCertificate(__tmp__):Error
		return __tmp__._sendServerCertificate();

	public function _sendServerFinished(__tmp__):Error
		return __tmp__._sendServerFinished();

	public function _shouldSendSessionTickets(__tmp__):Bool
		return __tmp__._shouldSendSessionTickets();

	public function _sendSessionTickets(__tmp__):Error
		return __tmp__._sendSessionTickets();

	public function _readClientCertificate(__tmp__):Error
		return __tmp__._readClientCertificate();

	public function _readClientFinished(__tmp__):Error
		return __tmp__._readClientFinished();
}

class T_rsaKeyAgreement_extension_fields {
	public function _generateServerKeyExchange(__tmp__, _config:Pointer<Config>, _cert:Pointer<Certificate>, _clientHello:Pointer<T_clientHelloMsg>,
			_hello:Pointer<T_serverHelloMsg>):{
		var _0:Pointer<T_serverKeyExchangeMsg>;
		var _1:Error;
	}
		return __tmp__._generateServerKeyExchange(_config, _cert, _clientHello, _hello);

	public function _processClientKeyExchange(__tmp__, _config:Pointer<Config>, _cert:Pointer<Certificate>, _ckx:Pointer<T_clientKeyExchangeMsg>,
			_version:GoUInt16):{var _0:Slice<GoByte>; var _1:Error;
	}
		return __tmp__._processClientKeyExchange(_config, _cert, _ckx, _version);

	public function _processServerKeyExchange(__tmp__, _config:Pointer<Config>, _clientHello:Pointer<T_clientHelloMsg>,
			_serverHello:Pointer<T_serverHelloMsg>, _cert:Pointer<stdgo.crypto.x509.X509.Certificate>, _skx:Pointer<T_serverKeyExchangeMsg>):Error
		return __tmp__._processServerKeyExchange(_config, _clientHello, _serverHello, _cert, _skx);

	public function _generateClientKeyExchange(__tmp__, _config:Pointer<Config>, _clientHello:Pointer<T_clientHelloMsg>,
			_cert:Pointer<stdgo.crypto.x509.X509.Certificate>):{
		var _0:Slice<GoByte>;
		var _1:Pointer<T_clientKeyExchangeMsg>;
		var _2:Error;
	}
		return __tmp__._generateClientKeyExchange(_config, _clientHello, _cert);
}
...
class T_nistParameters_extension_fields {
	public function curveID(__tmp__):CurveID
		return __tmp__.curveID();

	public function publicKey(__tmp__):Slice<GoByte>
		return __tmp__.publicKey();

	public function sharedKey(__tmp__, _peerPublicKey:Slice<GoByte>):Slice<GoByte>
		return __tmp__.sharedKey(_peerPublicKey);
}
...
class T_finishedHash_extension_fields {
	public function write(__tmp__, _msg:Slice<GoByte>):{var _0:GoInt; var _1:Error;}
		return __tmp__.write(_msg);

	public function sum(__tmp__):Slice<GoByte>
		return __tmp__.sum();

	public function _clientSum(__tmp__, _masterSecret:Slice<GoByte>):Slice<GoByte>
		return __tmp__._clientSum(_masterSecret);

	public function _serverSum(__tmp__, _masterSecret:Slice<GoByte>):Slice<GoByte>
		return __tmp__._serverSum(_masterSecret);

	public function _hashForClientCertificate(__tmp__, _sigType:GoUInt8, _hashAlg:stdgo.crypto.Crypto.Hash, _masterSecret:Slice<GoByte>):Slice<GoByte>
		return __tmp__._hashForClientCertificate(_sigType, _hashAlg, _masterSecret);

	public function _discardHandshakeBuffer(__tmp__):Void
		__tmp__._discardHandshakeBuffer();
}
...
class T_listener_extension_fields {
	public function accept(__tmp__):{var _0:stdgo.net.Net.Conn; var _1:Error;}
...
class Dialer_extension_fields {
	public function dial(__tmp__, _network:GoString, _addr:GoString):{var _0:stdgo.net.Net.Conn; var _1:Error;}
		return __tmp__.dial(_network, _addr);

	public function _netDialer(__tmp__):Pointer<stdgo.net.Net.Dialer>
		return __tmp__._netDialer();

	public function dialContext(__tmp__, _ctx:stdgo.context.Context.Context, _network:GoString, _addr:GoString):{var _0:stdgo.net.Net.Conn; var _1:Error;}
		return __tmp__.dialContext(_ctx, _network, _addr);
}
