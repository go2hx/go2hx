...
@:named class T_sum224 {
    ...
    public function __copy__() return new T_sum224(__t__.copy());
...
@:structInit class CertPool {
    public function subjects():Slice<Slice<GoByte>> {
        ...
        var _res:Slice<Slice<GoUInt8>> = new Slice<Slice<GoUInt8>>(...[for (i in 0 ... ((_s.value._len() : GoInt)).toBasic()) new Slice<GoUInt8>().nil()]);
        {
            var _i;
            var _lc;
            for (_obj in _s.value._lazyCerts.keyValueIterator()) {
                _i = _obj.key;
                _lc = _obj.value;
    ...
    public function appendCertsFromPEM(_pemCerts:Slice<GoByte>):Bool {
        ...
        while (_pemCerts.length > ((0 : GoInt))) {
            ...
            if (_block.value.type != (("CERTIFICATE" : GoString)) || (_block.value.headers == null ? 0 : _block.value.headers.length) != ((0 : GoInt))) {
                continue;
            };
            var _certBytes:Slice<GoUInt8> = _block.value.bytes;
            var __tmp__ = parseCertificate(_certBytes), _cert:Pointer<Certificate> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                continue;
            };
            var _lazyCert:T__struct_55 = new T__struct_55();
            _s.value._addCertFunc(new T_sum224(stdgo.crypto.sha256.Sha256.sum224(_cert.value.raw).copy().copy()), ((_cert.value.rawSubject : GoString)), function():{ var _0 : Pointer<Certificate>; var _1 : Error; } {
    ...
    public function _addCertFunc(_rawSum224:T_sum224, _rawSubject:GoString, _getCert:() -> { var _0 : Pointer<Certificate>; var _1 : Error; }):Void {
        var _s = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        if (_getCert == null) {
    ...
    public function _findPotentialParents(_cert:Pointer<Certificate>):Slice<Pointer<Certificate>> {
        ...
        var _matchingKeyID:Slice<Pointer<Certificate>> = new Slice<Pointer<Certificate>>().nil(), _oneKeyID:Slice<Pointer<Certificate>> = new Slice<Pointer<Certificate>>().nil(), _mismatchKeyID:Slice<Pointer<Certificate>> = new Slice<Pointer<Certificate>>().nil();
        for (_c in _s.value._byName[((_cert.value.rawIssuer : GoString))]) {
            var __tmp__ = _s.value._cert(_c), _candidate:Pointer<Certificate> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                continue;
            };
            ...
            } else if ((_candidate.value.subjectKeyId.length == ((0 : GoInt)) && _cert.value.authorityKeyId.length > ((0 : GoInt))) || (_candidate.value.subjectKeyId.length > ((0 : GoInt)) && _cert.value.authorityKeyId.length == ((0 : GoInt)))) {
        ...
        var _candidates:Slice<Pointer<Certificate>> = new Slice<Pointer<Certificate>>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) new Pointer<Certificate>().nil()]).setCap(((_found : GoInt)).toBasic());
    ...
    public function _copy():Pointer<CertPool> {
        var _s = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _p:Pointer<CertPool> = Go.pointer((({ _byName : new GoMap<GoString, Slice<GoInt>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(int_kind))))), _lazyCerts : new Slice<T_lazyCert>(...[for (i in 0 ... ((_s.value._lazyCerts.length : GoInt)).toBasic()) new T_lazyCert()]), _haveSum : new GoMap<T_sum224, Bool>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("crypto/x509.sum224", [], stdgo.reflect.Reflect.GoType.arrayType(stdgo.reflect.Reflect.GoType.basic(uint8_kind), 28)), stdgo.reflect.Reflect.GoType.basic(bool_kind)))) } : CertPool)));
        {
            var _k;
            var _v;
            for (_obj in _s.value._byName.keyValueIterator()) {
                _k = _obj.key;
                _v = _obj.value;
        ...
        {
            var _k;
            for (_obj in _s.value._haveSum.keyValueIterator()) {
                _k = _obj.key;
    ...
    public var _byName : GoMap<GoString, Slice<GoInt>> = new GoMap<GoString, Slice<GoInt>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(int_kind))))).nil();
    public var _lazyCerts : Slice<T_lazyCert> = new Slice<T_lazyCert>().nil();
    public var _haveSum : GoMap<T_sum224, Bool> = new GoMap<T_sum224, Bool>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("crypto/x509.sum224", [], stdgo.reflect.Reflect.GoType.arrayType(stdgo.reflect.Reflect.GoType.basic(uint8_kind), 28)), stdgo.reflect.Reflect.GoType.basic(bool_kind)))).nil();
    public function new(?_byName:GoMap<GoString, Slice<GoInt>>, ?_lazyCerts:Slice<T_lazyCert>, ?_haveSum:GoMap<T_sum224, Bool>) stdgo.internal.Macro.initLocals();
...
@:structInit class T_lazyCert {
    ...
    public var _getCert : () -> { var _0 : Pointer<Certificate>; var _1 : stdgo.Error; } = null;
    public function new(?_rawSubject:Slice<GoUInt8>, ?_getCert:() -> { var _0 : Pointer<Certificate>; var _1 : stdgo.Error; }) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:named class PEMCipher {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new PEMCipher(__t__);
}
@:structInit class T_rfc1423Algo {
    ...
    public var _cipherFunc : Slice<GoUInt8> -> { var _0 : stdgo.crypto.cipher.Cipher.Block; var _1 : stdgo.Error; } = null;
    public var _keySize : GoInt = ((0 : GoInt));
    public var _blockSize : GoInt = ((0 : GoInt));
    public function new(?_cipher:PEMCipher, ?_name:GoString, ?_cipherFunc:Slice<GoUInt8> -> { var _0 : stdgo.crypto.cipher.Cipher.Block; var _1 : stdgo.Error; }, ?_keySize:GoInt, ?_blockSize:GoInt) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_pkcs1PrivateKey {
    ...
    public function new(?version:GoInt, ?n:Pointer<stdgo.math.big.Big.Int_>, ?e:GoInt, ?d:Pointer<stdgo.math.big.Big.Int_>, ?p:Pointer<stdgo.math.big.Big.Int_>, ?q:Pointer<stdgo.math.big.Big.Int_>, ?dp:Pointer<stdgo.math.big.Big.Int_>, ?dq:Pointer<stdgo.math.big.Big.Int_>, ?qinv:Pointer<stdgo.math.big.Big.Int_>, ?additionalPrimes:Slice<T_pkcs1AdditionalRSAPrime>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(version) + " " + Go.string(n) + " " + Go.string(e) + " " + Go.string(d) + " " + Go.string(p) + " " + Go.string(q) + " " + Go.string(dp) + " " + Go.string(dq) + " " + Go.string(qinv) + " " + Go.string(additionalPrimes) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_pkcs1AdditionalRSAPrime {
    ...
    public function new(?prime:Pointer<stdgo.math.big.Big.Int_>, ?exp:Pointer<stdgo.math.big.Big.Int_>, ?coeff:Pointer<stdgo.math.big.Big.Int_>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_pkcs8 {
    ...
    public function new(?version:GoInt, ?algo:stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier, ?privateKey:Slice<GoUInt8>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_ecPrivateKey {
    ...
    public function new(?version:GoInt, ?privateKey:Slice<GoUInt8>, ?namedCurveOID:stdgo.encoding.asn1.Asn1.ObjectIdentifier, ?publicKey:stdgo.encoding.asn1.Asn1.BitString) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(version) + " " + Go.string(privateKey) + " " + Go.string(namedCurveOID) + " " + Go.string(publicKey) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:named class InvalidReason {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new InvalidReason(__t__);
}
@:structInit class CertificateInvalidError {
    ...
    public function new(?cert:Pointer<Certificate>, ?reason:InvalidReason, ?detail:GoString) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class HostnameError {
    public function error():GoString {
        ...
        var _valid:GoString = (("" : GoString));
        {
            ...
            if (_ip.__t__ != null && !_ip.__t__.isNil()) {
                ...
                for (_san in _c.value.ipaddresses) {
    ...
    public function new(?certificate:Pointer<Certificate>, ?host:GoString) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class UnknownAuthorityError {
    public function error():GoString {
        ...
        if (_e._hintErr != null) {
            ...
            _s = _s + (stdgo.fmt.Fmt.sprintf(" (possibly because of %q while trying to verify candidate authority certificate %q)", Go.toInterface(_e._hintErr), Go.toInterface(_certName)));
        };
        return _s;
    }
    public var cert : Pointer<Certificate> = new Pointer<Certificate>().nil();
    ...
    public function new(?cert:Pointer<Certificate>, ?_hintErr:stdgo.Error, ?_hintCert:Pointer<Certificate>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class VerifyOptions {
    ...
    public function new(?dnsname:GoString, ?intermediates:Pointer<CertPool>, ?roots:Pointer<CertPool>, ?currentTime:stdgo.time.Time.Time, ?keyUsages:Slice<ExtKeyUsage>, ?maxConstraintComparisions:GoInt) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(dnsname) + " " + Go.string(intermediates) + " " + Go.string(roots) + " " + Go.string(currentTime) + " " + Go.string(keyUsages) + " " + Go.string(maxConstraintComparisions) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_rfc2821Mailbox {
    ...
    public function new(?_local:GoString, ?_domain:GoString) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_pkixPublicKey {
    ...
    public function new(?algo:stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier, ?bitString:stdgo.encoding.asn1.Asn1.BitString) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_certificate {
    ...
    public function new(?raw:stdgo.encoding.asn1.Asn1.RawContent, ?tbscertificate:T_tbsCertificate, ?signatureAlgorithm:stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier, ?signatureValue:stdgo.encoding.asn1.Asn1.BitString) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(raw) + " " + Go.string(tbscertificate) + " " + Go.string(signatureAlgorithm) + " " + Go.string(signatureValue) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_tbsCertificate {
    ...
    public function new(?raw:stdgo.encoding.asn1.Asn1.RawContent, ?version:GoInt, ?serialNumber:Pointer<stdgo.math.big.Big.Int_>, ?signatureAlgorithm:stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier, ?issuer:stdgo.encoding.asn1.Asn1.RawValue, ?validity:T_validity, ?subject:stdgo.encoding.asn1.Asn1.RawValue, ?publicKey:T_publicKeyInfo, ?uniqueId:stdgo.encoding.asn1.Asn1.BitString, ?subjectUniqueId:stdgo.encoding.asn1.Asn1.BitString, ?extensions:Slice<stdgo.crypto.x509.pkix.Pkix.Extension>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(raw) + " " + Go.string(version) + " " + Go.string(serialNumber) + " " + Go.string(signatureAlgorithm) + " " + Go.string(issuer) + " " + Go.string(validity) + " " + Go.string(subject) + " " + Go.string(publicKey) + " " + Go.string(uniqueId) + " " + Go.string(subjectUniqueId) + " " + Go.string(extensions) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_validity {
    ...
    public function new(?notBefore:stdgo.time.Time.Time, ?notAfter:stdgo.time.Time.Time) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_publicKeyInfo {
    ...
    public var publicKey : stdgo.encoding.asn1.Asn1.BitString = new stdgo.encoding.asn1.Asn1.BitString();
    public function new(?raw:stdgo.encoding.asn1.Asn1.RawContent, ?algorithm:stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier, ?publicKey:stdgo.encoding.asn1.Asn1.BitString) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_authKeyId {
    ...
    public function new(?id:Slice<GoUInt8>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(id) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
...
@:named class SignatureAlgorithm {
    public function toString():GoString {
        ...
        for (_details in _signatureAlgorithmDetails) {
    ...
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() return new SignatureAlgorithm(__t__);
}
@:named class PublicKeyAlgorithm {
    ...
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() return new PublicKeyAlgorithm(__t__);
}
@:structInit class T_pssParameters {
    ...
    public function new(?hash:stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier, ?mgf:stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier, ?saltLength:GoInt, ?trailerField:GoInt) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:named class KeyUsage {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new KeyUsage(__t__);
}
@:named class ExtKeyUsage {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new ExtKeyUsage(__t__);
}
@:structInit class Certificate {
    public function createCRL(_rand:stdgo.io.Io.Reader, _priv:AnyInterface, _revokedCerts:Slice<stdgo.crypto.x509.pkix.Pkix.RevokedCertificate>, _now:stdgo.time.Time.Time, _expiry:stdgo.time.Time.Time):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _crlBytes:Slice<GoByte> = new Slice<GoUInt8>().nil(), _err:Error = ((null : stdgo.Error));
        var __tmp__ = try {
        ...
        var __tmp__ = _signingParamsForPublicKey(Go.toInterface(_key.public_()), new SignatureAlgorithm(((0 : GoInt)))), _hashFunc:stdgo.crypto.Crypto.Hash = __tmp__._0, _signatureAlgorithm:stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier = __tmp__._1, _err:stdgo.Error = __tmp__._2;
        if (_err != null) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        };
        var _revokedCertsUTC:Slice<stdgo.crypto.x509.pkix.Pkix.RevokedCertificate> = new Slice<stdgo.crypto.x509.pkix.Pkix.RevokedCertificate>(...[for (i in 0 ... ((_revokedCerts.length : GoInt)).toBasic()) new stdgo.crypto.x509.pkix.Pkix.RevokedCertificate()]);
        {
            var _i;
            var _rc;
            for (_obj in _revokedCerts.keyValueIterator()) {
                _i = _obj.key;
                _rc = _obj.value;
        ...
        var _tbsCertList:stdgo.crypto.x509.pkix.Pkix.TBSCertificateList = (({ version : ((1 : GoInt)), signature : _signatureAlgorithm.__copy__(), issuer : _c.value.subject.toRDNSequence().__copy__(), thisUpdate : _now.utc().__copy__(), nextUpdate : new stdgo.time.Time.Time(_expiry.utc().__copy__().__copy__()), revokedCertificates : _revokedCertsUTC, raw : new stdgo.encoding.asn1.Asn1.RawContent(), extensions : new Slice<stdgo.crypto.x509.pkix.Pkix.Extension>().nil() } : stdgo.crypto.x509.pkix.Pkix.TBSCertificateList)).__copy__();
        ...
        var __tmp__ = stdgo.encoding.asn1.Asn1.marshal(Go.toInterface(_tbsCertList.__copy__())), _tbsCertListContents:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : _crlBytes, _1 : _err };
        };
        ...
        return stdgo.encoding.asn1.Asn1.marshal(Go.toInterface((({ tbscertList : _tbsCertList.__copy__(), signatureAlgorithm : new stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier(_signatureAlgorithm.__copy__().__copy__()), signatureValue : (({ bytes : _signature, bitLength : _signature.length * ((8 : GoInt)) } : stdgo.encoding.asn1.Asn1.BitString)).__copy__() } : stdgo.crypto.x509.pkix.Pkix.CertificateList)).__copy__()));
    }
    ...
    public function checkSignatureFrom(_parent:Pointer<Certificate>):Error {
        var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        if (_parent.value.version == ((3 : GoInt)) && !_parent.value.basicConstraintsValid || _parent.value.basicConstraintsValid && !_parent.value.isCA) {
            return new ConstraintViolationError().__copy__();
        };
        if (_parent.value.keyUsage.__t__ != ((0 : GoInt)) && new KeyUsage(_parent.value.keyUsage.__t__ & keyUsageCertSign.__t__).__t__ == ((0 : GoInt))) {
            return new ConstraintViolationError().__copy__();
        };
    ...
    public function verifyHostname(_h:GoString):Error {
        ...
        for (_match in _c.value.dnsnames) {
    ...
    public function _buildChains(_cache:GoMap<Pointer<Certificate>, Slice<Slice<Pointer<Certificate>>>>, _currentChain:Slice<Pointer<Certificate>>, _sigChecks:Pointer<GoInt>, _opts:Pointer<VerifyOptions>):{ var _0 : Slice<Slice<Pointer<Certificate>>>; var _1 : Error; } {
        var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _chains:Slice<Slice<Pointer<Certificate>>> = new Slice<Slice<Pointer<Certificate>>>().nil(), _err:Error = ((null : stdgo.Error));
        var _hintErr:Error = ((null : stdgo.Error)), _hintCert:Pointer<Certificate> = new Pointer<Certificate>().nil();
        var _considerCandidate:(GoInt, Pointer<Certificate>) -> Void = function(_certType:GoInt, _candidate:Pointer<Certificate>):Void {
            for (_cert in _currentChain) {
            ...
            if (_certType == _rootCertificate) {
                ...
                if (_cache == null || _cache.isNil()) {
                    _cache = new GoMap<Pointer<Certificate>, Slice<Slice<Pointer<Certificate>>>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("crypto/x509.Certificate", [], stdgo.reflect.Reflect.GoType.named("crypto/x509.Certificate", [], stdgo.reflect.Reflect.GoType.structType([
...
{ name : "subject", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("crypto/x509/pkix.Name", [], stdgo.reflect.Reflect.GoType.structType([
{ name : "country", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)) },
{ name : "organization", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)) },
{ name : "organizationalUnit", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)) },
{ name : "locality", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)) },
...
{ name : "extensions", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("crypto/x509/pkix.Extension", [], stdgo.reflect.Reflect.GoType.structType([{ name : "id", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("encoding/asn1.ObjectIdentifier", [], stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(int_kind))) }, { name : "critical", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }, { name : "value", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) }]))) },
{ name : "extraExtensions", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("crypto/x509/pkix.Extension", [], stdgo.reflect.Reflect.GoType.structType([{ name : "id", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("encoding/asn1.ObjectIdentifier", [], stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(int_kind))) }, { name : "critical", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }, { name : "value", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) }]))) },
{ name : "unhandledCriticalExtensions", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("encoding/asn1.ObjectIdentifier", [], stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(int_kind)))) },
...
{ name : "unknownExtKeyUsage", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("encoding/asn1.ObjectIdentifier", [], stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(int_kind)))) },
...
{ name : "policyIdentifiers", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("encoding/asn1.ObjectIdentifier", [], stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(int_kind)))) }])))), stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("crypto/x509.Certificate", [], stdgo.reflect.Reflect.GoType.named("crypto/x509.Certificate", [], stdgo.reflect.Reflect.GoType.structType([
{ name : "raw", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) },
{ name : "rawTBSCertificate", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) },
{ name : "rawSubjectPublicKeyInfo", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) },
{ name : "rawSubject", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) },
...
{ name : "excludedURIDomains", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)) },
{ name : "crldistributionPoints", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)) },
{ name : "policyIdentifiers", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("encoding/asn1.ObjectIdentifier", [], stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(int_kind)))) }])))))))));
                };
                var __tmp__ = _cache.exists(_candidate) ? { value : _cache[_candidate], ok : true } : { value : _cache.defaultValue(), ok : false }, _childChains:Slice<Slice<Pointer<Certificate>>> = __tmp__.value, _ok:Bool = __tmp__.ok;
                if (!_ok) {
                    {
        ...
        for (_root in _opts.value.roots.value._findPotentialParents(_c)) {
            _considerCandidate(_rootCertificate, _root);
        };
        for (_intermediate in _opts.value.intermediates.value._findPotentialParents(_c)) {
    ...
    public function verify(_opts:VerifyOptions):{ var _0 : Slice<Slice<Pointer<Certificate>>>; var _1 : Error; } {
        ...
        };
        {
            ...
            Go.cfor(_i < _opts.intermediates.value._len(), _i++, {
                var __tmp__ = _opts.intermediates.value._cert(_i), _c:Pointer<Certificate> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    return { _0 : new Slice<Slice<Pointer<Certificate>>>().nil(), _1 : stdgo.fmt.Fmt.errorf("crypto/x509: error fetching intermediate: %w", Go.toInterface(_err)) };
                };
                if (_c.value.raw.length == ((0 : GoInt))) {
                    return { _0 : new Slice<Slice<Pointer<Certificate>>>().nil(), _1 : _errNotParsed };
                };
        ...
        if (_opts.roots.value._contains(_c)) {
            ...
            {
                {
                    var __tmp__ = _c.value._buildChains(new GoMap<Pointer<Certificate>, Slice<Slice<Pointer<Certificate>>>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("crypto/x509.Certificate", [], stdgo.reflect.Reflect.GoType.named("crypto/x509.Certificate", [], stdgo.reflect.Reflect.GoType.structType([
{ name : "raw", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) },
{ name : "rawTBSCertificate", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) },
{ name : "rawSubjectPublicKeyInfo", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) },
{ name : "rawSubject", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) },
...
{ name : "excludedURIDomains", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)) },
{ name : "crldistributionPoints", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)) },
{ name : "policyIdentifiers", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("encoding/asn1.ObjectIdentifier", [], stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(int_kind)))) }]))))))))).nil(), new Slice<Pointer<Certificate>>(_c), new Pointer<GoInt>().nil(), Go.pointer(_opts));
    ...
    public function _isValid(_certType:GoInt, _currentChain:Slice<Pointer<Certificate>>, _opts:Pointer<VerifyOptions>):Error {
        ...
        if (_c.value.unhandledCriticalExtensions.length > ((0 : GoInt))) {
            return new UnhandledCriticalExtension().__copy__();
        };
        ...
        if (_now.before(_c.value.notBefore.__copy__())) {
            return (({ cert : _c, reason : expired, detail : stdgo.fmt.Fmt.sprintf("current time %s is before %s", Go.toInterface(_now.format(stdgo.time.Time.rfc3339)), Go.toInterface(_c.value.notBefore.format(stdgo.time.Time.rfc3339))) } : CertificateInvalidError)).__copy__();
        } else if (_now.after(_c.value.notAfter.__copy__())) {
            return (({ cert : _c, reason : expired, detail : stdgo.fmt.Fmt.sprintf("current time %s is after %s", Go.toInterface(_now.format(stdgo.time.Time.rfc3339)), Go.toInterface(_c.value.notAfter.format(stdgo.time.Time.rfc3339))) } : CertificateInvalidError)).__copy__();
        };
        ...
        if ((_certType == _intermediateCertificate || _certType == _rootCertificate) && _c.value._hasNameConstraints() && _leaf.value._hasSANExtension()) {
            var _err:stdgo.Error = _forEachSAN(new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_(_leaf.value._getSANExtension()), function(_tag:GoInt, _data:Slice<GoByte>):Error {
                if (_tag == _nameTypeEmail) {
                    ...
                    {
                        var _err:stdgo.Error = _c.value._checkNameConstraints(Go.pointer(_comparisonCount), _maxConstraintComparisons, "email address", _name, Go.toInterface(_mailbox.__copy__()), function(_parsedName:AnyInterface, _constraint:AnyInterface):{ var _0 : Bool; var _1 : Error; } {
                            return _matchEmailConstraint(((_parsedName.value : T_rfc2821Mailbox)).__copy__(), ((_constraint.value : GoString)));
                        }, Go.toInterface(_c.value.permittedEmailAddresses), Go.toInterface(_c.value.excludedEmailAddresses));
                        if (_err != null) {
                            return _err;
                        };
                    };
                    ...
                    {
                        var _err:stdgo.Error = _c.value._checkNameConstraints(Go.pointer(_comparisonCount), _maxConstraintComparisons, "DNS name", _name, Go.toInterface(_name), function(_parsedName:AnyInterface, _constraint:AnyInterface):{ var _0 : Bool; var _1 : Error; } {
                            return _matchDomainConstraint(((_parsedName.value : GoString)), ((_constraint.value : GoString)));
                        }, Go.toInterface(_c.value.permittedDNSDomains), Go.toInterface(_c.value.excludedDNSDomains));
                        if (_err != null) {
                            return _err;
                        };
                    };
                    ...
                    {
                        var _err:stdgo.Error = _c.value._checkNameConstraints(Go.pointer(_comparisonCount), _maxConstraintComparisons, "URI", _name, Go.toInterface(_uri), function(_parsedName:AnyInterface, _constraint:AnyInterface):{ var _0 : Bool; var _1 : Error; } {
                            return _matchURIConstraint(((_parsedName.value : Pointer<stdgo.net.url.Url.URL>)), ((_constraint.value : GoString)));
                        }, Go.toInterface(_c.value.permittedURIDomains), Go.toInterface(_c.value.excludedURIDomains));
                        if (_err != null) {
                            return _err;
                        };
                    };
                    ...
                    {
                        var _err:stdgo.Error = _c.value._checkNameConstraints(Go.pointer(_comparisonCount), _maxConstraintComparisons, "IP address", _ip.toString(), Go.toInterface(_ip.__copy__()), function(_parsedName:AnyInterface, _constraint:AnyInterface):{ var _0 : Bool; var _1 : Error; } {
                            return _matchIPConstraint(new stdgo.net.Net.IP(((_parsedName.value : AnyInterface))).__copy__(), ((_constraint.value : Pointer<stdgo.net.Net.IPNet>)));
                        }, Go.toInterface(_c.value.permittedIPRanges), Go.toInterface(_c.value.excludedIPRanges));
                        if (_err != null) {
                            return _err;
                        };
                    };
    ...
    public function _checkNameConstraints(_count:Pointer<GoInt>, _maxConstraintComparisons:GoInt, _nameType:GoString, _name:GoString, _parsedName:AnyInterface, _match:(_parsedName:AnyInterface, _constraint:AnyInterface) -> { var _0 : Bool; var _1 : Error; }, _permitted:AnyInterface, _excluded:AnyInterface):Error {
        var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        ...
        };
        {
            ...
            Go.cfor(_i < _excludedValue.len(), _i++, {
                ...
                var __tmp__ = _match(Go.toInterface(_parsedName), Go.toInterface(_constraint)), _match:Bool = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    return new CertificateInvalidError(_c, canotAuthorizedForThisName, _err.error()).__copy__();
                };
                if (_match) {
                    return new CertificateInvalidError(_c, canotAuthorizedForThisName, stdgo.fmt.Fmt.sprintf("%s %q is excluded by constraint %q", Go.toInterface(_nameType), Go.toInterface(_name), Go.toInterface(_constraint))).__copy__();
                };
            });
        };
        ...
        if (!_ok) {
            return new CertificateInvalidError(_c, canotAuthorizedForThisName, stdgo.fmt.Fmt.sprintf("%s %q is not permitted by any constraint", Go.toInterface(_nameType), Go.toInterface(_name))).__copy__();
        };
        return ((null : stdgo.Error));
    }
    ...
    public function new(?raw:Slice<GoUInt8>, ?rawTBSCertificate:Slice<GoUInt8>, ?rawSubjectPublicKeyInfo:Slice<GoUInt8>, ?rawSubject:Slice<GoUInt8>, ?rawIssuer:Slice<GoUInt8>, ?signature:Slice<GoUInt8>, ?signatureAlgorithm:SignatureAlgorithm, ?publicKeyAlgorithm:PublicKeyAlgorithm, ?publicKey:AnyInterface, ?version:GoInt, ?serialNumber:Pointer<stdgo.math.big.Big.Int_>, ?issuer:stdgo.crypto.x509.pkix.Pkix.Name, ?subject:stdgo.crypto.x509.pkix.Pkix.Name, ?notBefore:stdgo.time.Time.Time, ?notAfter:stdgo.time.Time.Time, ?keyUsage:KeyUsage, ?extensions:Slice<stdgo.crypto.x509.pkix.Pkix.Extension>, ?extraExtensions:Slice<stdgo.crypto.x509.pkix.Pkix.Extension>, ?unhandledCriticalExtensions:Slice<stdgo.encoding.asn1.Asn1.ObjectIdentifier>, ?extKeyUsage:Slice<ExtKeyUsage>, ?unknownExtKeyUsage:Slice<stdgo.encoding.asn1.Asn1.ObjectIdentifier>, ?basicConstraintsValid:Bool, ?isCA:Bool, ?maxPathLen:GoInt, ?maxPathLenZero:Bool, ?subjectKeyId:Slice<GoUInt8>, ?authorityKeyId:Slice<GoUInt8>, ?ocspserver:Slice<GoString>, ?issuingCertificateURL:Slice<GoString>, ?dnsnames:Slice<GoString>, ?emailAddresses:Slice<GoString>, ?ipaddresses:Slice<stdgo.net.Net.IP>, ?uris:Slice<Pointer<stdgo.net.url.Url.URL>>, ?permittedDNSDomainsCritical:Bool, ?permittedDNSDomains:Slice<GoString>, ?excludedDNSDomains:Slice<GoString>, ?permittedIPRanges:Slice<Pointer<stdgo.net.Net.IPNet>>, ?excludedIPRanges:Slice<Pointer<stdgo.net.Net.IPNet>>, ?permittedEmailAddresses:Slice<GoString>, ?excludedEmailAddresses:Slice<GoString>, ?permittedURIDomains:Slice<GoString>, ?excludedURIDomains:Slice<GoString>, ?crldistributionPoints:Slice<GoString>, ?policyIdentifiers:Slice<stdgo.encoding.asn1.Asn1.ObjectIdentifier>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(raw) + " " + Go.string(rawTBSCertificate) + " " + Go.string(rawSubjectPublicKeyInfo) + " " + Go.string(rawSubject) + " " + Go.string(rawIssuer) + " " + Go.string(signature) + " " + Go.string(signatureAlgorithm) + " " + Go.string(publicKeyAlgorithm) + " " + Go.string(publicKey) + " " + Go.string(version) + " " + Go.string(serialNumber) + " " + Go.string(issuer) + " " + Go.string(subject) + " " + Go.string(notBefore) + " " + Go.string(notAfter) + " " + Go.string(keyUsage) + " " + Go.string(extensions) + " " + Go.string(extraExtensions) + " " + Go.string(unhandledCriticalExtensions) + " " + Go.string(extKeyUsage) + " " + Go.string(unknownExtKeyUsage) + " " + Go.string(basicConstraintsValid) + " " + Go.string(isCA) + " " + Go.string(maxPathLen) + " " + Go.string(maxPathLenZero) + " " + Go.string(subjectKeyId) + " " + Go.string(authorityKeyId) + " " + Go.string(ocspserver) + " " + Go.string(issuingCertificateURL) + " " + Go.string(dnsnames) + " " + Go.string(emailAddresses) + " " + Go.string(ipaddresses) + " " + Go.string(uris) + " " + Go.string(permittedDNSDomainsCritical) + " " + Go.string(permittedDNSDomains) + " " + Go.string(excludedDNSDomains) + " " + Go.string(permittedIPRanges) + " " + Go.string(excludedIPRanges) + " " + Go.string(permittedEmailAddresses) + " " + Go.string(excludedEmailAddresses) + " " + Go.string(permittedURIDomains) + " " + Go.string(excludedURIDomains) + " " + Go.string(crldistributionPoints) + " " + Go.string(policyIdentifiers) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:named class InsecureAlgorithmError {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new InsecureAlgorithmError(__t__);
}
...
@:structInit class T_basicConstraints {
    ...
    public var maxPathLen : GoInt = ((0 : GoInt));
    public function new(?isCA:Bool, ?maxPathLen:GoInt) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_policyInformation {
    ...
    public function new(?policy:stdgo.encoding.asn1.Asn1.ObjectIdentifier) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_authorityInfoAccess {
    ...
    public function new(?method:stdgo.encoding.asn1.Asn1.ObjectIdentifier, ?location:stdgo.encoding.asn1.Asn1.RawValue) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_distributionPoint {
    ...
    public function new(?distributionPoint:T_distributionPointName, ?reason:stdgo.encoding.asn1.Asn1.BitString, ?crlissuer:stdgo.encoding.asn1.Asn1.RawValue) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_distributionPointName {
    ...
    public function new(?fullName:Slice<stdgo.encoding.asn1.Asn1.RawValue>, ?relativeName:stdgo.crypto.x509.pkix.Pkix.RDNSequence) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class CertificateRequest {
    ...
    public var ipaddresses : Slice<stdgo.net.Net.IP> = new Slice<stdgo.net.Net.IP>().nil();
    public var uris : Slice<Pointer<stdgo.net.url.Url.URL>> = new Slice<Pointer<stdgo.net.url.Url.URL>>().nil();
    public function new(?raw:Slice<GoUInt8>, ?rawTBSCertificateRequest:Slice<GoUInt8>, ?rawSubjectPublicKeyInfo:Slice<GoUInt8>, ?rawSubject:Slice<GoUInt8>, ?version:GoInt, ?signature:Slice<GoUInt8>, ?signatureAlgorithm:SignatureAlgorithm, ?publicKeyAlgorithm:PublicKeyAlgorithm, ?publicKey:AnyInterface, ?subject:stdgo.crypto.x509.pkix.Pkix.Name, ?attributes:Slice<stdgo.crypto.x509.pkix.Pkix.AttributeTypeAndValueSET>, ?extensions:Slice<stdgo.crypto.x509.pkix.Pkix.Extension>, ?extraExtensions:Slice<stdgo.crypto.x509.pkix.Pkix.Extension>, ?dnsnames:Slice<GoString>, ?emailAddresses:Slice<GoString>, ?ipaddresses:Slice<stdgo.net.Net.IP>, ?uris:Slice<Pointer<stdgo.net.url.Url.URL>>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(raw) + " " + Go.string(rawTBSCertificateRequest) + " " + Go.string(rawSubjectPublicKeyInfo) + " " + Go.string(rawSubject) + " " + Go.string(version) + " " + Go.string(signature) + " " + Go.string(signatureAlgorithm) + " " + Go.string(publicKeyAlgorithm) + " " + Go.string(publicKey) + " " + Go.string(subject) + " " + Go.string(attributes) + " " + Go.string(extensions) + " " + Go.string(extraExtensions) + " " + Go.string(dnsnames) + " " + Go.string(emailAddresses) + " " + Go.string(ipaddresses) + " " + Go.string(uris) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_tbsCertificateRequest {
    ...
    public function new(?raw:stdgo.encoding.asn1.Asn1.RawContent, ?version:GoInt, ?subject:stdgo.encoding.asn1.Asn1.RawValue, ?publicKey:T_publicKeyInfo, ?rawAttributes:Slice<stdgo.encoding.asn1.Asn1.RawValue>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(raw) + " " + Go.string(version) + " " + Go.string(subject) + " " + Go.string(publicKey) + " " + Go.string(rawAttributes) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_certificateRequest {
    ...
    public var signatureAlgorithm : stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier = new stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier();
    public var signatureValue : stdgo.encoding.asn1.Asn1.BitString = new stdgo.encoding.asn1.Asn1.BitString();
    public function new(?raw:stdgo.encoding.asn1.Asn1.RawContent, ?tbscsr:T_tbsCertificateRequest, ?signatureAlgorithm:stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier, ?signatureValue:stdgo.encoding.asn1.Asn1.BitString) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(raw) + " " + Go.string(tbscsr) + " " + Go.string(signatureAlgorithm) + " " + Go.string(signatureValue) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class RevocationList {
    ...
    public var extraExtensions : Slice<stdgo.crypto.x509.pkix.Pkix.Extension> = new Slice<stdgo.crypto.x509.pkix.Pkix.Extension>().nil();
    public function new(?signatureAlgorithm:SignatureAlgorithm, ?revokedCertificates:Slice<stdgo.crypto.x509.pkix.Pkix.RevokedCertificate>, ?number:Pointer<stdgo.math.big.Big.Int_>, ?thisUpdate:stdgo.time.Time.Time, ?nextUpdate:stdgo.time.Time.Time, ?extraExtensions:Slice<stdgo.crypto.x509.pkix.Pkix.Extension>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(signatureAlgorithm) + " " + Go.string(revokedCertificates) + " " + Go.string(number) + " " + Go.string(thisUpdate) + " " + Go.string(nextUpdate) + " " + Go.string(extraExtensions) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit @:local class T__struct_55 {
    ...
    public function new(?once:stdgo.sync.Sync.Once, ?_v:Pointer<Certificate>) stdgo.internal.Macro.initLocals();
    public function toString() {
    ...
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
        return new T__struct_55(once, _v);
    }
    public function __set__(__tmp__) {
...
@:structInit @:local class T__struct_56 {
    ...
    public function new(?_algo:SignatureAlgorithm, ?_name:GoString, ?_oid:stdgo.encoding.asn1.Asn1.ObjectIdentifier, ?_pubKeyAlgo:PublicKeyAlgorithm, ?_hash:stdgo.crypto.Crypto.Hash) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_algo) + " " + Go.string(_name) + " " + Go.string(_oid) + " " + Go.string(_pubKeyAlgo) + " " + Go.string(_hash) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
        return new T__struct_56(_algo, _name, _oid, _pubKeyAlgo, _hash);
    }
    public function __set__(__tmp__) {
...
@:structInit @:local class T__struct_57 {
    ...
    public var _oid : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier();
    public function new(?_extKeyUsage:ExtKeyUsage, ?_oid:stdgo.encoding.asn1.Asn1.ObjectIdentifier) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_extKeyUsage) + " " + Go.string(_oid) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
        return new T__struct_57(_extKeyUsage, _oid);
    }
    public function __set__(__tmp__) {
...
@:structInit @:local class T__struct_58 {
    ...
    public function new(?type:stdgo.encoding.asn1.Asn1.ObjectIdentifier, ?value:Slice<Slice<stdgo.crypto.x509.pkix.Pkix.Extension>>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(type) + " " + Go.string(value) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
        return new T__struct_58(type, value);
    }
    public function __set__(__tmp__) {
...
var _oidExtKeyUsageMicrosoftCommercialCodeSigning : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((6 : GoInt)), ((1 : GoInt)), ((4 : GoInt)), ((1 : GoInt)), ((311 : GoInt)), ((2 : GoInt)), ((1 : GoInt)), ((22 : GoInt)))).__copy__();
var _oidExtKeyUsageCodeSigning : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((6 : GoInt)), ((1 : GoInt)), ((5 : GoInt)), ((5 : GoInt)), ((7 : GoInt)), ((3 : GoInt)), ((3 : GoInt)))).__copy__();
final keyUsageDataEncipherment : KeyUsage = (new KeyUsage(((1 : GoUnTypedInt)) << (3 : GoUnTypedInt)));
var _oidSHA256 : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((2 : GoInt)), ((16 : GoInt)), ((840 : GoInt)), ((1 : GoInt)), ((101 : GoInt)), ((3 : GoInt)), ((4 : GoInt)), ((2 : GoInt)), ((1 : GoInt)))).__copy__();
var _oidExtKeyUsageIPSECEndSystem : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((6 : GoInt)), ((1 : GoInt)), ((5 : GoInt)), ((5 : GoInt)), ((7 : GoInt)), ((3 : GoInt)), ((5 : GoInt)))).__copy__();
var _oidExtensionSubjectKeyId : Slice<GoInt> = new Slice<GoInt>(((2 : GoInt)), ((5 : GoInt)), ((29 : GoInt)), ((14 : GoInt)));
var _oidNamedCurveP256 : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((2 : GoInt)), ((840 : GoInt)), ((10045 : GoInt)), ((3 : GoInt)), ((1 : GoInt)), ((7 : GoInt)))).__copy__();
...
var _oidISOSignatureSHA1WithRSA : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((14 : GoInt)), ((3 : GoInt)), ((2 : GoInt)), ((29 : GoInt)))).__copy__();
...
var _oidSignatureSHA512WithRSA : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((2 : GoInt)), ((840 : GoInt)), ((113549 : GoInt)), ((1 : GoInt)), ((1 : GoInt)), ((13 : GoInt)))).__copy__();
var _oidSignatureDSAWithSHA256 : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((2 : GoInt)), ((16 : GoInt)), ((840 : GoInt)), ((1 : GoInt)), ((101 : GoInt)), ((3 : GoInt)), ((4 : GoInt)), ((3 : GoInt)), ((2 : GoInt)))).__copy__();
var _oidSHA512 : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((2 : GoInt)), ((16 : GoInt)), ((840 : GoInt)), ((1 : GoInt)), ((101 : GoInt)), ((3 : GoInt)), ((4 : GoInt)), ((2 : GoInt)), ((3 : GoInt)))).__copy__();
final unknownPublicKeyAlgorithm : PublicKeyAlgorithm = new PublicKeyAlgorithm((0 : GoUnTypedInt));
var _oidSignatureEd25519 : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((101 : GoInt)), ((112 : GoInt)))).__copy__();
...
var _oidSignatureSHA256WithRSA : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((2 : GoInt)), ((840 : GoInt)), ((113549 : GoInt)), ((1 : GoInt)), ((1 : GoInt)), ((11 : GoInt)))).__copy__();
final pemcipher3DES : PEMCipher = new PEMCipher((2 : GoUnTypedInt));
final _certDirEnv : GoString = "SSL_CERT_DIR";
var _oidExtKeyUsageIPSECUser : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((6 : GoInt)), ((1 : GoInt)), ((5 : GoInt)), ((5 : GoInt)), ((7 : GoInt)), ((3 : GoInt)), ((7 : GoInt)))).__copy__();
var _oidSignatureMD5WithRSA : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((2 : GoInt)), ((840 : GoInt)), ((113549 : GoInt)), ((1 : GoInt)), ((1 : GoInt)), ((4 : GoInt)))).__copy__();
...
var _oidExtKeyUsageMicrosoftKernelCodeSigning : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((6 : GoInt)), ((1 : GoInt)), ((4 : GoInt)), ((1 : GoInt)), ((311 : GoInt)), ((61 : GoInt)), ((1 : GoInt)), ((1 : GoInt)))).__copy__();
...
var _oidExtKeyUsageServerAuth : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((6 : GoInt)), ((1 : GoInt)), ((5 : GoInt)), ((5 : GoInt)), ((7 : GoInt)), ((3 : GoInt)), ((1 : GoInt)))).__copy__();
...
var _oidSignatureECDSAWithSHA384 : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((2 : GoInt)), ((840 : GoInt)), ((10045 : GoInt)), ((4 : GoInt)), ((3 : GoInt)), ((3 : GoInt)))).__copy__();
...
var _oidSignatureMD2WithRSA : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((2 : GoInt)), ((840 : GoInt)), ((113549 : GoInt)), ((1 : GoInt)), ((1 : GoInt)), ((2 : GoInt)))).__copy__();
...
var _oidExtKeyUsageEmailProtection : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((6 : GoInt)), ((1 : GoInt)), ((5 : GoInt)), ((5 : GoInt)), ((7 : GoInt)), ((3 : GoInt)), ((4 : GoInt)))).__copy__();
final unknownSignatureAlgorithm : SignatureAlgorithm = new SignatureAlgorithm((0 : GoUnTypedInt));
var _oidSignatureECDSAWithSHA256 : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((2 : GoInt)), ((840 : GoInt)), ((10045 : GoInt)), ((4 : GoInt)), ((3 : GoInt)), ((2 : GoInt)))).__copy__();
...
var _oidExtKeyUsageNetscapeServerGatedCrypto : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((2 : GoInt)), ((16 : GoInt)), ((840 : GoInt)), ((1 : GoInt)), ((113730 : GoInt)), ((4 : GoInt)), ((1 : GoInt)))).__copy__();
...
var _oidSignatureECDSAWithSHA512 : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((2 : GoInt)), ((840 : GoInt)), ((10045 : GoInt)), ((4 : GoInt)), ((3 : GoInt)), ((4 : GoInt)))).__copy__();
var _oidExtensionCertificatePolicies : Slice<GoInt> = new Slice<GoInt>(((2 : GoInt)), ((5 : GoInt)), ((29 : GoInt)), ((32 : GoInt)));
var _oidNamedCurveP224 : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((132 : GoInt)), ((0 : GoInt)), ((33 : GoInt)))).__copy__();
...
var _oidSignatureECDSAWithSHA1 : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((2 : GoInt)), ((840 : GoInt)), ((10045 : GoInt)), ((4 : GoInt)), ((1 : GoInt)))).__copy__();
var _oidAuthorityInfoAccessOcsp : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((6 : GoInt)), ((1 : GoInt)), ((5 : GoInt)), ((5 : GoInt)), ((7 : GoInt)), ((48 : GoInt)), ((1 : GoInt)))).__copy__();
var _oidPublicKeyRSA : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((2 : GoInt)), ((840 : GoInt)), ((113549 : GoInt)), ((1 : GoInt)), ((1 : GoInt)), ((1 : GoInt)))).__copy__();
var _oidSignatureRSAPSS : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((2 : GoInt)), ((840 : GoInt)), ((113549 : GoInt)), ((1 : GoInt)), ((1 : GoInt)), ((10 : GoInt)))).__copy__();
...
var _oidExtKeyUsageIPSECTunnel : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((6 : GoInt)), ((1 : GoInt)), ((5 : GoInt)), ((5 : GoInt)), ((7 : GoInt)), ((3 : GoInt)), ((6 : GoInt)))).__copy__();
var _oidExtKeyUsageOCSPSigning : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((6 : GoInt)), ((1 : GoInt)), ((5 : GoInt)), ((5 : GoInt)), ((7 : GoInt)), ((3 : GoInt)), ((9 : GoInt)))).__copy__();
...
var _oidSignatureSHA1WithRSA : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((2 : GoInt)), ((840 : GoInt)), ((113549 : GoInt)), ((1 : GoInt)), ((1 : GoInt)), ((5 : GoInt)))).__copy__();
...
var _oidExtKeyUsageAny : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((2 : GoInt)), ((5 : GoInt)), ((29 : GoInt)), ((37 : GoInt)), ((0 : GoInt)))).__copy__();
final extKeyUsageServerAuth : ExtKeyUsage = new ExtKeyUsage((1 : GoUnTypedInt));
var _oidExtKeyUsageClientAuth : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((6 : GoInt)), ((1 : GoInt)), ((5 : GoInt)), ((5 : GoInt)), ((7 : GoInt)), ((3 : GoInt)), ((2 : GoInt)))).__copy__();
final extKeyUsageCodeSigning : ExtKeyUsage = new ExtKeyUsage((3 : GoUnTypedInt));
var _oidExtKeyUsageTimeStamping : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((6 : GoInt)), ((1 : GoInt)), ((5 : GoInt)), ((5 : GoInt)), ((7 : GoInt)), ((3 : GoInt)), ((8 : GoInt)))).__copy__();
var _oidExtKeyUsageMicrosoftServerGatedCrypto : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((6 : GoInt)), ((1 : GoInt)), ((4 : GoInt)), ((1 : GoInt)), ((311 : GoInt)), ((10 : GoInt)), ((3 : GoInt)), ((3 : GoInt)))).__copy__();
final extKeyUsageMicrosoftKernelCodeSigning : ExtKeyUsage = new ExtKeyUsage((13 : GoUnTypedInt));
var _extKeyUsageOIDs : Slice<T__struct_57> = new Slice<T__struct_57>(
new T__struct_57(extKeyUsageAny, _oidExtKeyUsageAny.__copy__()).__copy__(),
new T__struct_57(extKeyUsageServerAuth, _oidExtKeyUsageServerAuth.__copy__()).__copy__(),
new T__struct_57(extKeyUsageClientAuth, _oidExtKeyUsageClientAuth.__copy__()).__copy__(),
new T__struct_57(extKeyUsageCodeSigning, _oidExtKeyUsageCodeSigning.__copy__()).__copy__(),
new T__struct_57(extKeyUsageEmailProtection, _oidExtKeyUsageEmailProtection.__copy__()).__copy__(),
new T__struct_57(extKeyUsageIPSECEndSystem, _oidExtKeyUsageIPSECEndSystem.__copy__()).__copy__(),
new T__struct_57(extKeyUsageIPSECTunnel, _oidExtKeyUsageIPSECTunnel.__copy__()).__copy__(),
new T__struct_57(extKeyUsageIPSECUser, _oidExtKeyUsageIPSECUser.__copy__()).__copy__(),
new T__struct_57(extKeyUsageTimeStamping, _oidExtKeyUsageTimeStamping.__copy__()).__copy__(),
new T__struct_57(extKeyUsageOCSPSigning, _oidExtKeyUsageOCSPSigning.__copy__()).__copy__(),
new T__struct_57(extKeyUsageMicrosoftServerGatedCrypto, _oidExtKeyUsageMicrosoftServerGatedCrypto.__copy__()).__copy__(),
new T__struct_57(extKeyUsageNetscapeServerGatedCrypto, _oidExtKeyUsageNetscapeServerGatedCrypto.__copy__()).__copy__(),
new T__struct_57(extKeyUsageMicrosoftCommercialCodeSigning, _oidExtKeyUsageMicrosoftCommercialCodeSigning.__copy__()).__copy__(),
new T__struct_57(extKeyUsageMicrosoftKernelCodeSigning, _oidExtKeyUsageMicrosoftKernelCodeSigning.__copy__()).__copy__());
...
var _hashToPSSParameters : GoMap<stdgo.crypto.Crypto.Hash, stdgo.encoding.asn1.Asn1.RawValue> = new GoMap<stdgo.crypto.Crypto.Hash, stdgo.encoding.asn1.Asn1.RawValue>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("crypto.Hash", [], stdgo.reflect.Reflect.GoType.basic(uint_kind)), stdgo.reflect.Reflect.GoType.named("encoding/asn1.RawValue", [], stdgo.reflect.Reflect.GoType.structType([{ name : "class_", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }, { name : "tag", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }, { name : "isCompound", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }, { name : "bytes", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) }, { name : "fullBytes", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) }])))), { key : stdgo.crypto.Crypto.sha256, value : (({ fullBytes : new Slice<GoUInt8>(
((48 : GoUInt8)),
((52 : GoUInt8)),
((160 : GoUInt8)),
((15 : GoUInt8)),
...
((2 : GoUInt8)),
((1 : GoUInt8)),
((32 : GoUInt8))), class_ : 0, tag : 0, isCompound : false, bytes : new Slice<GoUInt8>().nil() } : stdgo.encoding.asn1.Asn1.RawValue)).__copy__() }, { key : stdgo.crypto.Crypto.sha384, value : (({ fullBytes : new Slice<GoUInt8>(
((48 : GoUInt8)),
((52 : GoUInt8)),
((160 : GoUInt8)),
((15 : GoUInt8)),
...
((2 : GoUInt8)),
((1 : GoUInt8)),
((48 : GoUInt8))), class_ : 0, tag : 0, isCompound : false, bytes : new Slice<GoUInt8>().nil() } : stdgo.encoding.asn1.Asn1.RawValue)).__copy__() }, { key : stdgo.crypto.Crypto.sha512, value : (({ fullBytes : new Slice<GoUInt8>(
((48 : GoUInt8)),
((52 : GoUInt8)),
((160 : GoUInt8)),
((15 : GoUInt8)),
...
((2 : GoUInt8)),
((1 : GoUInt8)),
((64 : GoUInt8))), class_ : 0, tag : 0, isCompound : false, bytes : new Slice<GoUInt8>().nil() } : stdgo.encoding.asn1.Asn1.RawValue)).__copy__() });
...
var _oidSignatureSHA384WithRSA : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((2 : GoInt)), ((840 : GoInt)), ((113549 : GoInt)), ((1 : GoInt)), ((1 : GoInt)), ((12 : GoInt)))).__copy__();
final ed25519 : PublicKeyAlgorithm = new PublicKeyAlgorithm((4 : GoUnTypedInt));
final _nameTypeIP : GoInt64 = ((7 : GoUnTypedInt));
var _oidSignatureDSAWithSHA1 : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((2 : GoInt)), ((840 : GoInt)), ((10040 : GoInt)), ((4 : GoInt)), ((3 : GoInt)))).__copy__();
...
var _signatureAlgorithmDetails : Slice<T__struct_56> = new Slice<T__struct_56>(
new T__struct_56(md2withRSA, "MD2-RSA", _oidSignatureMD2WithRSA.__copy__(), rsa, new stdgo.crypto.Crypto.Hash(((0 : GoUInt)))).__copy__(),
new T__struct_56(md5withRSA, "MD5-RSA", _oidSignatureMD5WithRSA.__copy__(), rsa, stdgo.crypto.Crypto.md5).__copy__(),
new T__struct_56(sha1withRSA, "SHA1-RSA", _oidSignatureSHA1WithRSA.__copy__(), rsa, stdgo.crypto.Crypto.sha1).__copy__(),
new T__struct_56(sha1withRSA, "SHA1-RSA", _oidISOSignatureSHA1WithRSA.__copy__(), rsa, stdgo.crypto.Crypto.sha1).__copy__(),
new T__struct_56(sha256withRSA, "SHA256-RSA", _oidSignatureSHA256WithRSA.__copy__(), rsa, stdgo.crypto.Crypto.sha256).__copy__(),
new T__struct_56(sha384withRSA, "SHA384-RSA", _oidSignatureSHA384WithRSA.__copy__(), rsa, stdgo.crypto.Crypto.sha384).__copy__(),
new T__struct_56(sha512withRSA, "SHA512-RSA", _oidSignatureSHA512WithRSA.__copy__(), rsa, stdgo.crypto.Crypto.sha512).__copy__(),
new T__struct_56(sha256withRSAPSS, "SHA256-RSAPSS", _oidSignatureRSAPSS.__copy__(), rsa, stdgo.crypto.Crypto.sha256).__copy__(),
new T__struct_56(sha384withRSAPSS, "SHA384-RSAPSS", _oidSignatureRSAPSS.__copy__(), rsa, stdgo.crypto.Crypto.sha384).__copy__(),
new T__struct_56(sha512withRSAPSS, "SHA512-RSAPSS", _oidSignatureRSAPSS.__copy__(), rsa, stdgo.crypto.Crypto.sha512).__copy__(),
new T__struct_56(dsawithSHA1, "DSA-SHA1", _oidSignatureDSAWithSHA1.__copy__(), dsa, stdgo.crypto.Crypto.sha1).__copy__(),
new T__struct_56(dsawithSHA256, "DSA-SHA256", _oidSignatureDSAWithSHA256.__copy__(), dsa, stdgo.crypto.Crypto.sha256).__copy__(),
new T__struct_56(ecdsawithSHA1, "ECDSA-SHA1", _oidSignatureECDSAWithSHA1.__copy__(), ecdsa, stdgo.crypto.Crypto.sha1).__copy__(),
new T__struct_56(ecdsawithSHA256, "ECDSA-SHA256", _oidSignatureECDSAWithSHA256.__copy__(), ecdsa, stdgo.crypto.Crypto.sha256).__copy__(),
new T__struct_56(ecdsawithSHA384, "ECDSA-SHA384", _oidSignatureECDSAWithSHA384.__copy__(), ecdsa, stdgo.crypto.Crypto.sha384).__copy__(),
new T__struct_56(ecdsawithSHA512, "ECDSA-SHA512", _oidSignatureECDSAWithSHA512.__copy__(), ecdsa, stdgo.crypto.Crypto.sha512).__copy__(),
new T__struct_56(pureEd25519, "Ed25519", _oidSignatureEd25519.__copy__(), ed25519, new stdgo.crypto.Crypto.Hash(((0 : GoUInt)))).__copy__());
var _oidMGF1 : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((2 : GoInt)), ((840 : GoInt)), ((113549 : GoInt)), ((1 : GoInt)), ((1 : GoInt)), ((8 : GoInt)))).__copy__();
...
var _oidExtensionAuthorityInfoAccess : Slice<GoInt> = new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((6 : GoInt)), ((1 : GoInt)), ((5 : GoInt)), ((5 : GoInt)), ((7 : GoInt)), ((1 : GoInt)), ((1 : GoInt)));
...
var _oidPublicKeyDSA : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((2 : GoInt)), ((840 : GoInt)), ((10040 : GoInt)), ((4 : GoInt)), ((1 : GoInt)))).__copy__();
...
var _oidExtensionRequest : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((2 : GoInt)), ((840 : GoInt)), ((113549 : GoInt)), ((1 : GoInt)), ((9 : GoInt)), ((14 : GoInt)))).__copy__();
var _certFiles : Slice<GoString> = new Slice<GoString>();
final _rootCertificate = (2 : GoUnTypedInt);
var _oidAuthorityInfoAccessIssuers : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((6 : GoInt)), ((1 : GoInt)), ((5 : GoInt)), ((5 : GoInt)), ((7 : GoInt)), ((48 : GoInt)), ((2 : GoInt)))).__copy__();
var _pemCRLPrefix : Slice<GoUInt8> = (("-----BEGIN X509 CRL" : Slice<GoByte>));
var _oidNamedCurveP521 : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((132 : GoInt)), ((0 : GoInt)), ((35 : GoInt)))).__copy__();
var incorrectPasswordError : stdgo.Error = stdgo.errors.Errors.new_("x509: decryption password incorrect");
var _oidSHA384 : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((2 : GoInt)), ((16 : GoInt)), ((840 : GoInt)), ((1 : GoInt)), ((101 : GoInt)), ((3 : GoInt)), ((4 : GoInt)), ((2 : GoInt)), ((2 : GoInt)))).__copy__();
var _oidExtensionAuthorityKeyId : Slice<GoInt> = new Slice<GoInt>(((2 : GoInt)), ((5 : GoInt)), ((29 : GoInt)), ((35 : GoInt)));
var _oidNamedCurveP384 : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((3 : GoInt)), ((132 : GoInt)), ((0 : GoInt)), ((34 : GoInt)))).__copy__();
final _nameTypeURI : GoInt64 = ((6 : GoUnTypedInt));
var _oidPublicKeyECDSA : stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(new Slice<GoInt>(((1 : GoInt)), ((2 : GoInt)), ((840 : GoInt)), ((10045 : GoInt)), ((2 : GoInt)), ((1 : GoInt)))).__copy__();
final canotAuthorizedForThisName : InvalidReason = new InvalidReason((2 : GoUnTypedInt));
var _rfc1423Algos : Slice<T_rfc1423Algo> = new Slice<T_rfc1423Algo>((({ _cipher : pemcipherDES, _name : "DES-CBC", _cipherFunc : stdgo.crypto.des.Des.newCipher, _keySize : ((8 : GoInt)), _blockSize : stdgo.crypto.des.Des.blockSize } : T_rfc1423Algo)).__copy__(), (({ _cipher : pemcipher3DES, _name : "DES-EDE3-CBC", _cipherFunc : stdgo.crypto.des.Des.newTripleDESCipher, _keySize : ((24 : GoInt)), _blockSize : stdgo.crypto.des.Des.blockSize } : T_rfc1423Algo)).__copy__(), (({ _cipher : pemcipherAES128, _name : "AES-128-CBC", _cipherFunc : stdgo.crypto.aes.Aes.newCipher, _keySize : ((16 : GoInt)), _blockSize : stdgo.crypto.aes.Aes.blockSize } : T_rfc1423Algo)).__copy__(), (({ _cipher : pemcipherAES192, _name : "AES-192-CBC", _cipherFunc : stdgo.crypto.aes.Aes.newCipher, _keySize : ((24 : GoInt)), _blockSize : stdgo.crypto.aes.Aes.blockSize } : T_rfc1423Algo)).__copy__(), (({ _cipher : pemcipherAES256, _name : "AES-256-CBC", _cipherFunc : stdgo.crypto.aes.Aes.newCipher, _keySize : ((32 : GoInt)), _blockSize : stdgo.crypto.aes.Aes.blockSize } : T_rfc1423Algo)).__copy__());
/**
    // NewCertPool returns a new, empty CertPool.
**/
function newCertPool():Pointer<CertPool> {
        return Go.pointer((({ _byName : new GoMap<GoString, Slice<GoInt>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(int_kind))))), _haveSum : new GoMap<T_sum224, Bool>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("crypto/x509.sum224", [], stdgo.reflect.Reflect.GoType.arrayType(stdgo.reflect.Reflect.GoType.basic(uint8_kind), 28)), stdgo.reflect.Reflect.GoType.basic(bool_kind)))), _lazyCerts : new Slice<T_lazyCert>().nil() } : CertPool)));
    }
/**
...
function _isPrintable(_b:GoByte):Bool {
        return (("a".code : GoRune)) <= _b && _b <= (("z".code : GoRune)) || (("A".code : GoRune)) <= _b && _b <= (("Z".code : GoRune)) || (("0".code : GoRune)) <= _b && _b <= (("9".code : GoRune)) || (("\'".code : GoRune)) <= _b && _b <= ((")".code : GoRune)) || (("+".code : GoRune)) <= _b && _b <= (("/".code : GoRune)) || _b == ((" ".code : GoRune)) || _b == ((":".code : GoRune)) || _b == (("=".code : GoRune)) || _b == (("?".code : GoRune)) || _b == (("*".code : GoRune)) || _b == (("&".code : GoRune));
    }
/**
...
function _parseASN1String(_tag:golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag, _value:Slice<GoByte>):{ var _0 : GoString; var _1 : Error; } {
        if (_tag.__t__ == golang_org.x.crypto.cryptobyte.asn1.Asn1.t61string.__t__) {
            ...
            var _s:Slice<GoUInt16> = new Slice<GoUInt16>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt16))]).setCap(((_value.length / ((2 : GoInt)) : GoInt)).toBasic());
        ...
        while (!_raw.empty()) {
            ...
            while (!_set.empty()) {
                ...
                if (!_set.readASN1(Go.pointer(_atav), golang_org.x.crypto.cryptobyte.asn1.Asn1.sequence)) {
                    return { _0 : new Pointer<stdgo.crypto.x509.pkix.Pkix.RDNSequence>().nil(), _1 : stdgo.errors.Errors.new_("x509: invalid RDNSequence: invalid attribute") };
                };
                ...
                if (!_atav.readASN1ObjectIdentifier(Go.pointer(_attr.type))) {
                    return { _0 : new Pointer<stdgo.crypto.x509.pkix.Pkix.RDNSequence>().nil(), _1 : stdgo.errors.Errors.new_("x509: invalid RDNSequence: invalid attribute type") };
                };
                ...
                if (!_atav.readAnyASN1(Go.pointer(_rawValue), Go.pointer(_valueTag))) {
                    return { _0 : new Pointer<stdgo.crypto.x509.pkix.Pkix.RDNSequence>().nil(), _1 : stdgo.errors.Errors.new_("x509: invalid RDNSequence: invalid attribute value") };
                };
                var _err:Error = ((null : stdgo.Error));
                {
                ...
                if (_err != null) {
                    return { _0 : new Pointer<stdgo.crypto.x509.pkix.Pkix.RDNSequence>().nil(), _1 : stdgo.fmt.Fmt.errorf("x509: invalid RDNSequence: invalid attribute value: %s", Go.toInterface(_err)) };
                };
...
function _parseValidity(_der:golang_org.x.crypto.cryptobyte.Cryptobyte.String_):{ var _0 : stdgo.time.Time.Time; var _1 : stdgo.time.Time.Time; var _2 : Error; } {
        var _extract:() -> { var _0 : stdgo.time.Time.Time; var _1 : stdgo.Error; } = function():{ var _0 : stdgo.time.Time.Time; var _1 : Error; } {
        ...
        var __tmp__ = _extract(), _notBefore:stdgo.time.Time.Time = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new stdgo.time.Time.Time().__copy__(), _1 : new stdgo.time.Time.Time().__copy__(), _2 : _err };
        };
        var __tmp__ = _extract(), _notAfter:stdgo.time.Time.Time = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new stdgo.time.Time.Time().__copy__(), _1 : new stdgo.time.Time.Time().__copy__(), _2 : _err };
        };
...
function _parsePublicKey(_algo:PublicKeyAlgorithm, _keyData:Pointer<T_publicKeyInfo>):{ var _0 : AnyInterface; var _1 : Error; } {
        var _der:vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new golang_org.x.crypto.cryptobyte.Cryptobyte.String_(_keyData.value.publicKey.rightAlign()).__copy__();
        if (_algo.__t__ == rsa.__t__) {
            ...
            var _paramsDer:vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new golang_org.x.crypto.cryptobyte.Cryptobyte.String_(_keyData.value.algorithm.parameters.fullBytes).__copy__();
            ...
            var __tmp__ = stdgo.crypto.elliptic.Elliptic.unmarshal(_namedCurve, _der.__copy__().__t__), _x:Pointer<stdgo.math.big.Big.Int_> = __tmp__._0, _y:Pointer<stdgo.math.big.Big.Int_> = __tmp__._1;
            if (_x == null || _x.isNil()) {
            ...
            var _pub:Pointer<stdgo.crypto.dsa.Dsa.PublicKey> = Go.pointer((({ y : _y, parameters : (({ p : Go.pointer(new stdgo.math.big.Big.Int_()), q : Go.pointer(new stdgo.math.big.Big.Int_()), g : Go.pointer(new stdgo.math.big.Big.Int_()) } : stdgo.crypto.dsa.Dsa.Parameters)).__copy__() } : stdgo.crypto.dsa.Dsa.PublicKey)));
            var _paramsDer:vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new golang_org.x.crypto.cryptobyte.Cryptobyte.String_(_keyData.value.algorithm.parameters.fullBytes).__copy__();
            if (!_paramsDer.readASN1(Go.pointer(_paramsDer), golang_org.x.crypto.cryptobyte.asn1.Asn1.sequence) || !_paramsDer.readASN1Integer(Go.toInterface(_pub.value.parameters.p)) || !_paramsDer.readASN1Integer(Go.toInterface(_pub.value.parameters.q)) || !_paramsDer.readASN1Integer(Go.toInterface(_pub.value.parameters.g))) {
                return { _0 : ((null : AnyInterface)), _1 : stdgo.errors.Errors.new_("x509: invalid DSA parameters") };
            };
            if (_pub.value.y.value.sign() <= ((0 : GoInt)) || _pub.value.parameters.p.value.sign() <= ((0 : GoInt)) || _pub.value.parameters.q.value.sign() <= ((0 : GoInt)) || _pub.value.parameters.g.value.sign() <= ((0 : GoInt))) {
...
function _forEachSAN(_der:golang_org.x.crypto.cryptobyte.Cryptobyte.String_, _callback:(_tag:GoInt, _data:Slice<GoByte>) -> Error):Error {
        ...
        while (!_der.empty()) {
            ...
            {
                var _err:stdgo.Error = _callback(new vendor.golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag(_tag.__t__ ^ ((128 : GoUInt8))).__t__, _san.__copy__().__t__);
                if (_err != null) {
                    return _err;
                };
            };
...
function _parseSANExtension(_der:golang_org.x.crypto.cryptobyte.Cryptobyte.String_):{ var _0 : Slice<GoString>; var _1 : Slice<GoString>; var _2 : Slice<stdgo.net.Net.IP>; var _3 : Slice<Pointer<stdgo.net.url.Url.URL>>; var _4 : Error; } {
        var _dnsNames:Slice<GoString> = new Slice<GoString>().nil(), _emailAddresses:Slice<GoString> = new Slice<GoString>().nil(), _ipAddresses:Slice<stdgo.net.Net.IP> = new Slice<stdgo.net.Net.IP>().nil(), _uris:Slice<Pointer<stdgo.net.url.Url.URL>> = new Slice<Pointer<stdgo.net.url.Url.URL>>().nil(), _err:Error = ((null : stdgo.Error));
        _err = _forEachSAN(_der.__copy__(), function(_tag:GoInt, _data:Slice<GoByte>):Error {
            if (_tag == _nameTypeEmail) {
                ...
                var __tmp__ = stdgo.net.url.Url.parse(_uriStr), _uri:Pointer<stdgo.net.url.Url.URL> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                ...
                if (_uri.value.host.length > ((0 : GoInt))) {
                    {
                        var __tmp__ = _domainToReverseLabels(_uri.value.host), _:Slice<GoString> = __tmp__._0, _ok:Bool = __tmp__._1;
                        if (!_ok) {
...
function _parseExtKeyUsageExtension(_der:golang_org.x.crypto.cryptobyte.Cryptobyte.String_):{ var _0 : Slice<ExtKeyUsage>; var _1 : Slice<stdgo.encoding.asn1.Asn1.ObjectIdentifier>; var _2 : Error; } {
        ...
        if (!_der.readASN1(Go.pointer(_der), golang_org.x.crypto.cryptobyte.asn1.Asn1.sequence)) {
            return { _0 : new Slice<ExtKeyUsage>().nil(), _1 : new Slice<stdgo.encoding.asn1.Asn1.ObjectIdentifier>().nil(), _2 : stdgo.errors.Errors.new_("x509: invalid extended key usages") };
        };
        while (!_der.empty()) {
            ...
            {
                var __tmp__ = _extKeyUsageFromOID(_eku.__copy__()), _extKeyUsage:ExtKeyUsage = __tmp__._0, _ok:Bool = __tmp__._1;
                if (_ok) {
...
function _isValidIPMask(_mask:Slice<GoByte>):Bool {
        ...
        for (_b in _mask) {
            ...
            if (_b == ((0 : GoUInt8)) || _b == ((128 : GoUInt8)) || _b == ((192 : GoUInt8)) || _b == ((224 : GoUInt8)) || _b == ((240 : GoUInt8)) || _b == ((248 : GoUInt8)) || _b == ((252 : GoUInt8)) || _b == ((254 : GoUInt8))) {
                _seenZero = true;
...
function _parseNameConstraintsExtension(_out:Pointer<Certificate>, _e:stdgo.crypto.x509.pkix.Pkix.Extension):{ var _0 : Bool; var _1 : Error; } {
        ...
        var _toplevel:golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_(), _permitted:golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_(), _excluded:golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_();
        var _havePermitted:Bool = false, _haveExcluded:Bool = false;
        if (!_outer.readASN1(Go.pointer(_toplevel), golang_org.x.crypto.cryptobyte.asn1.Asn1.sequence) || !_outer.empty() || !_toplevel.readOptionalASN1(Go.pointer(_permitted), Go.pointer(_havePermitted), new golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag(((0 : GoUInt8))).contextSpecific().constructed()) || !_toplevel.readOptionalASN1(Go.pointer(_excluded), Go.pointer(_haveExcluded), new golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag(((1 : GoUInt8))).contextSpecific().constructed()) || !_toplevel.empty()) {
        ...
        var _getValues:vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_ -> { var _0 : Slice<GoString>; var _1 : Slice<Pointer<stdgo.net.Net.IPNet>>; var _2 : Slice<GoString>; var _3 : Slice<GoString>; var _4 : stdgo.Error; } = function(_subtrees:golang_org.x.crypto.cryptobyte.Cryptobyte.String_):{ var _0 : Slice<GoString>; var _1 : Slice<Pointer<stdgo.net.Net.IPNet>>; var _2 : Slice<GoString>; var _3 : Slice<GoString>; var _4 : Error; } {
            var _dnsNames:Slice<GoString> = new Slice<GoString>().nil(), _ips:Slice<Pointer<stdgo.net.Net.IPNet>> = new Slice<Pointer<stdgo.net.Net.IPNet>>().nil(), _emails:Slice<GoString> = new Slice<GoString>().nil(), _uriDomains:Slice<GoString> = new Slice<GoString>().nil(), _err:Error = ((null : stdgo.Error));
            while (!_subtrees.empty()) {
                var _seq:golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_(), _value:golang_org.x.crypto.cryptobyte.Cryptobyte.String_ = new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.String_();
                var _tag:golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag = new vendor.golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag();
                if (!_subtrees.readASN1(Go.pointer(_seq), golang_org.x.crypto.cryptobyte.asn1.Asn1.sequence) || !_seq.readAnyASN1(Go.pointer(_value), Go.pointer(_tag))) {
                    return { _0 : new Slice<GoString>().nil(), _1 : new Slice<Pointer<stdgo.net.Net.IPNet>>().nil(), _2 : new Slice<GoString>().nil(), _3 : new Slice<GoString>().nil(), _4 : stdgo.fmt.Fmt.errorf("x509: invalid NameConstraints extension") };
                };
                var _dnsTag:vendor.golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag = new golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag(((2 : GoUInt8))).contextSpecific(), _emailTag:vendor.golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag = new golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag(((1 : GoUInt8))).contextSpecific(), _ipTag:vendor.golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag = new golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag(((7 : GoUInt8))).contextSpecific(), _uriTag:vendor.golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag = new golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag(((6 : GoUInt8))).contextSpecific();
                if (_tag.__t__ == _dnsTag.__t__) {
                    var _domain:GoString = _value.__t__;
                    {
                        var _err:stdgo.Error = _isIA5String(_domain);
                        if (_err != null) {
                            return { _0 : new Slice<GoString>().nil(), _1 : new Slice<Pointer<stdgo.net.Net.IPNet>>().nil(), _2 : new Slice<GoString>().nil(), _3 : new Slice<GoString>().nil(), _4 : stdgo.errors.Errors.new_((("x509: invalid constraint value: " : GoString)) + _err.error()) };
                        };
                    };
                    ...
                    };
                    {
                        ...
                        if (!_ok) {
                            return { _0 : new Slice<GoString>().nil(), _1 : new Slice<Pointer<stdgo.net.Net.IPNet>>().nil(), _2 : new Slice<GoString>().nil(), _3 : new Slice<GoString>().nil(), _4 : stdgo.fmt.Fmt.errorf("x509: failed to parse dnsName constraint %q", Go.toInterface(_domain)) };
                        };
                    };
                    ...
                    if (_l == ((8 : GoInt))) {
                        ...
                        return { _0 : new Slice<GoString>().nil(), _1 : new Slice<Pointer<stdgo.net.Net.IPNet>>().nil(), _2 : new Slice<GoString>().nil(), _3 : new Slice<GoString>().nil(), _4 : stdgo.fmt.Fmt.errorf("x509: IP constraint contained value of length %d", Go.toInterface(_l)) };
                    };
                    if (!_isValidIPMask(_mask)) {
                        return { _0 : new Slice<GoString>().nil(), _1 : new Slice<Pointer<stdgo.net.Net.IPNet>>().nil(), _2 : new Slice<GoString>().nil(), _3 : new Slice<GoString>().nil(), _4 : stdgo.fmt.Fmt.errorf("x509: IP constraint contained invalid mask %x", Go.toInterface(_mask)) };
                    };
                    _ips = _ips.__append__(Go.pointer((({ ip : new stdgo.net.Net.IP(_ip).__copy__(), mask : new stdgo.net.Net.IPMask(_mask).__copy__() } : stdgo.net.Net.IPNet))));
                    ...
                    if (stdgo.strings.Strings.contains(_constraint, "@")) {
                        {
                            ...
                            if (!_ok) {
                                return { _0 : new Slice<GoString>().nil(), _1 : new Slice<Pointer<stdgo.net.Net.IPNet>>().nil(), _2 : new Slice<GoString>().nil(), _3 : new Slice<GoString>().nil(), _4 : stdgo.fmt.Fmt.errorf("x509: failed to parse rfc822Name constraint %q", Go.toInterface(_constraint)) };
                            };
                        };
                    } else {
                    ...
                    if (stdgo.net.Net.parseIP(_domain).__t__ != null && !stdgo.net.Net.parseIP(_domain).__t__.isNil()) {
                        return { _0 : new Slice<GoString>().nil(), _1 : new Slice<Pointer<stdgo.net.Net.IPNet>>().nil(), _2 : new Slice<GoString>().nil(), _3 : new Slice<GoString>().nil(), _4 : stdgo.fmt.Fmt.errorf("x509: failed to parse URI constraint %q: cannot be IP address", Go.toInterface(_domain)) };
                    };
                    var _trimmedDomain:GoString = _domain;
                    if (_trimmedDomain.length > ((0 : GoInt)) && _trimmedDomain[((0 : GoInt))] == ((".".code : GoRune))) {
                        _trimmedDomain = _trimmedDomain.__slice__(((1 : GoInt)));
                    };
                    {
                        var __tmp__ = _domainToReverseLabels(_trimmedDomain), _:Slice<GoString> = __tmp__._0, _ok:Bool = __tmp__._1;
                        if (!_ok) {
                            return { _0 : new Slice<GoString>().nil(), _1 : new Slice<Pointer<stdgo.net.Net.IPNet>>().nil(), _2 : new Slice<GoString>().nil(), _3 : new Slice<GoString>().nil(), _4 : stdgo.fmt.Fmt.errorf("x509: failed to parse URI constraint %q", Go.toInterface(_domain)) };
                        };
                    };
...
function _processExtensions(_out:Pointer<Certificate>):Error {
        var _err:Error = ((null : stdgo.Error));
        for (_e in _out.value.extensions) {
            var _unhandled:Bool = false;
            if (_e.id.__t__.length == ((4 : GoInt)) && _e.id.__t__[((0 : GoInt))] == ((2 : GoInt)) && _e.id.__t__[((1 : GoInt))] == ((5 : GoInt)) && _e.id.__t__[((2 : GoInt))] == ((29 : GoInt))) {
                {
                    ...
                    while (true) {
                        if (_e.id.__t__[((3 : GoInt))] == ((15 : GoInt))) {
                            ...
                            if (_out.value.dnsnames.length == ((0 : GoInt)) && _out.value.emailAddresses.length == ((0 : GoInt)) && _out.value.ipaddresses.length == ((0 : GoInt)) && _out.value.uris.length == ((0 : GoInt))) {
                                _unhandled = true;
                            };
                            break;
                            ...
                            while (!_val.empty()) {
                                ...
                                if (!_dpDER.readOptionalASN1(Go.pointer(_dpNameDER), Go.pointer(_dpNamePresent), new golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag(((0 : GoUInt8))).constructed().contextSpecific())) {
                                    return stdgo.errors.Errors.new_("x509: invalid CRL distribution point");
                                };
                                if (!_dpNamePresent) {
                                    continue;
                                };
                                if (!_dpNameDER.readASN1(Go.pointer(_dpNameDER), new golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag(((0 : GoUInt8))).constructed().contextSpecific())) {
                                    return stdgo.errors.Errors.new_("x509: invalid CRL distribution point");
                                };
                                while (!_dpNameDER.empty()) {
                                    ...
                                    if (!_dpNameDER.readASN1(Go.pointer(_uri), new golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag(((6 : GoUInt8))).contextSpecific())) {
                                        return stdgo.errors.Errors.new_("x509: invalid CRL distribution point");
                                    };
...
function _parseCertificate(_der:Slice<GoByte>):{ var _0 : Pointer<Certificate>; var _1 : Error; } {
        ...
        if (!_tbs.readOptionalASN1Integer(Go.toInterface(Go.pointer(_cert.value.version)), new golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag(((0 : GoUInt8))).constructed().contextSpecific(), Go.toInterface(((0 : GoInt))))) {
        ...
        var __tmp__ = _parseAI(_sigAISeq.__copy__()), _sigAI:stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
        ...
        var __tmp__ = _parseName(_issuerSeq.__copy__()), _issuerRDNs:Pointer<stdgo.crypto.x509.pkix.Pkix.RDNSequence> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<Certificate>().nil(), _1 : _err };
        };
        ...
        var __tmp__ = _parseName(_subjectSeq.__copy__()), _subjectRDNs:Pointer<stdgo.crypto.x509.pkix.Pkix.RDNSequence> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<Certificate>().nil(), _1 : _err };
        };
        ...
        var __tmp__ = _parseAI(_pkAISeq.__copy__()), _pkAI:stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<Certificate>().nil(), _1 : _err };
        };
        ...
        {
            var __tmp__ = _parsePublicKey(_cert.value.publicKeyAlgorithm, Go.pointer((({ algorithm : _pkAI.__copy__(), publicKey : _spk.__copy__(), raw : new stdgo.encoding.asn1.Asn1.RawContent() } : T_publicKeyInfo))));
        ...
        if (_cert.value.version > ((1 : GoInt))) {
            ...
            if (_cert.value.version == ((3 : GoInt))) {
                ...
                if (!_tbs.readOptionalASN1(Go.pointer(_extensions), Go.pointer(_present), new golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag(((3 : GoUInt8))).constructed().contextSpecific())) {
                ...
                if (_present) {
                    ...
                    while (!_extensions.empty()) {
                        ...
                        var __tmp__ = _parseExtension(_extension.__copy__()), _ext:stdgo.crypto.x509.pkix.Pkix.Extension = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                        if (_err != null) {
                            return { _0 : new Pointer<Certificate>().nil(), _1 : _err };
                        };
...
function parseCertificate(_der:Slice<GoByte>):{ var _0 : Pointer<Certificate>; var _1 : Error; } {
        var __tmp__ = _parseCertificate(_der), _cert:Pointer<Certificate> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<Certificate>().nil(), _1 : _err };
        };
...
function isEncryptedPEMBlock(_b:Pointer<stdgo.encoding.pem.Pem.Block>):Bool {
        var __tmp__ = _b.value.headers.exists("DEK-Info") ? { value : _b.value.headers["DEK-Info"], ok : true } : { value : _b.value.headers.defaultValue(), ok : false }, _:GoString = __tmp__.value, _ok:Bool = __tmp__.ok;
        return _ok;
    }
/**
...
function decryptPEMBlock(_b:Pointer<stdgo.encoding.pem.Pem.Block>, _password:Slice<GoByte>):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        var __tmp__ = _b.value.headers.exists("DEK-Info") ? { value : _b.value.headers["DEK-Info"], ok : true } : { value : _b.value.headers.defaultValue(), ok : false }, _dek:GoString = __tmp__.value, _ok:Bool = __tmp__.ok;
        if (!_ok) {
        ...
        var _mode:GoString = _dek.__slice__(0, _idx), _hexIV:GoString = _dek.__slice__(_idx + ((1 : GoInt)));
        ...
        var __tmp__ = stdgo.encoding.hex.Hex.decodeString(_hexIV), _iv:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        };
        ...
        var __tmp__ = _ciph.value._cipherFunc(_key), _block:stdgo.crypto.cipher.Cipher.Block = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        };
        ...
        for (_val in _data.__slice__(_dlen - _last)) {
            if (((_val : GoInt)) != _last) {
                return { _0 : new Slice<GoUInt8>().nil(), _1 : incorrectPasswordError };
            };
        };
...
/**
    ...
    // padding oracle attacks that can let an attacker recover the plaintext.
**/
function encryptPEMBlock(_rand:stdgo.io.Io.Reader, _blockType:GoString, _data:Slice<GoByte>, _password:Slice<GoByte>, _alg:PEMCipher):{ var _0 : Pointer<stdgo.encoding.pem.Pem.Block>; var _1 : Error; } {
        ...
        {
            var __tmp__ = stdgo.io.Io.readFull(_rand, _iv), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return { _0 : new Pointer<stdgo.encoding.pem.Pem.Block>().nil(), _1 : stdgo.errors.Errors.new_((("x509: cannot generate IV: " : GoString)) + _err.error()) };
            };
        };
        var _key:Slice<GoUInt8> = _ciph.value._deriveKey(_password, _iv.__slice__(0, ((8 : GoInt))));
        var __tmp__ = _ciph.value._cipherFunc(_key), _block:stdgo.crypto.cipher.Cipher.Block = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        ...
        var _encrypted:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0 ... ((_data.length : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((_data.length + _pad : GoInt)).toBasic());
        ...
        return { _0 : Go.pointer((({ type : _blockType, headers : new GoMap<GoString, GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.basic(string_kind))), { key : "Proc-Type", value : "4,ENCRYPTED" }, { key : "DEK-Info", value : _ciph.value._name + (("," : GoString)) + stdgo.encoding.hex.Hex.encodeToString(_iv) }), bytes : _encrypted } : stdgo.encoding.pem.Pem.Block))), _1 : ((null : stdgo.Error)) };
    }
function _cipherByName(_name:GoString):Pointer<T_rfc1423Algo> {
        {
            var _i;
            for (_obj in _rfc1423Algos.keyValueIterator()) {
                _i = _obj.key;
...
function parsePKCS1PrivateKey(_der:Slice<GoByte>):{ var _0 : Pointer<stdgo.crypto.rsa.Rsa.PrivateKey>; var _1 : Error; } {
        ...
        var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_der, Go.toInterface(Go.pointer(_priv))), _rest:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        ...
        if (_err != null) {
            {
                var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_der, Go.toInterface(Go.pointer(new T_ecPrivateKey()))), _:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err == null) {
                    return { _0 : new Pointer<stdgo.crypto.rsa.Rsa.PrivateKey>().nil(), _1 : stdgo.errors.Errors.new_("x509: failed to parse private key (use ParseECPrivateKey instead for this key format)") };
                };
            };
            {
                var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_der, Go.toInterface(Go.pointer(new T_pkcs8()))), _:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err == null) {
                    return { _0 : new Pointer<stdgo.crypto.rsa.Rsa.PrivateKey>().nil(), _1 : stdgo.errors.Errors.new_("x509: failed to parse private key (use ParsePKCS8PrivateKey instead for this key format)") };
                };
            };
        ...
        if (_priv.n.value.sign() <= ((0 : GoInt)) || _priv.d.value.sign() <= ((0 : GoInt)) || _priv.p.value.sign() <= ((0 : GoInt)) || _priv.q.value.sign() <= ((0 : GoInt))) {
        ...
        _key.value.primes = new Slice<Pointer<stdgo.math.big.Big.Int_>>(...[for (i in 0 ... ((((2 : GoInt)) + _priv.additionalPrimes.length : GoInt)).toBasic()) new Pointer<stdgo.math.big.Big.Int_>().nil()]);
        _key.value.primes[((0 : GoInt))] = _priv.p;
        _key.value.primes[((1 : GoInt))] = _priv.q;
        {
            var _i;
            var _a;
            for (_obj in _priv.additionalPrimes.keyValueIterator()) {
                _i = _obj.key;
                _a = _obj.value;
                if (_a.prime.value.sign() <= ((0 : GoInt))) {
                    return { _0 : new Pointer<stdgo.crypto.rsa.Rsa.PrivateKey>().nil(), _1 : stdgo.errors.Errors.new_("x509: private key contains zero or negative prime") };
                };
...
function marshalPKCS1PrivateKey(_key:Pointer<stdgo.crypto.rsa.Rsa.PrivateKey>):Slice<GoByte> {
        ...
        var _priv:T_pkcs1PrivateKey = (({ version : _version, n : _key.value.publicKey.n, e : _key.value.publicKey.e, d : _key.value.d, p : _key.value.primes[((0 : GoInt))], q : _key.value.primes[((1 : GoInt))], dp : _key.value.precomputed.dp, dq : _key.value.precomputed.dq, qinv : _key.value.precomputed.qinv, additionalPrimes : new Slice<T_pkcs1AdditionalRSAPrime>().nil() } : T_pkcs1PrivateKey)).__copy__();
        _priv.additionalPrimes = new Slice<T_pkcs1AdditionalRSAPrime>(...[for (i in 0 ... ((_key.value.precomputed.crtvalues.length : GoInt)).toBasic()) new T_pkcs1AdditionalRSAPrime()]);
        {
            var _i;
            var _values;
            for (_obj in _key.value.precomputed.crtvalues.keyValueIterator()) {
                _i = _obj.key;
                _values = _obj.value;
        ...
        var __tmp__ = stdgo.encoding.asn1.Asn1.marshal(Go.toInterface(_priv.__copy__())), _b:Slice<GoUInt8> = __tmp__._0, _:stdgo.Error = __tmp__._1;
        return _b;
    }
/**
...
function parsePKCS1PublicKey(_der:Slice<GoByte>):{ var _0 : Pointer<stdgo.crypto.rsa.Rsa.PublicKey>; var _1 : Error; } {
        ...
        var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_der, Go.toInterface(Go.pointer(_pub))), _rest:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            {
                var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_der, Go.toInterface(Go.pointer(new T_publicKeyInfo()))), _:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err == null) {
                    return { _0 : new Pointer<stdgo.crypto.rsa.Rsa.PublicKey>().nil(), _1 : stdgo.errors.Errors.new_("x509: failed to parse public key (use ParsePKIXPublicKey instead for this key format)") };
                };
            };
...
function marshalPKCS1PublicKey(_key:Pointer<stdgo.crypto.rsa.Rsa.PublicKey>):Slice<GoByte> {
        var __tmp__ = stdgo.encoding.asn1.Asn1.marshal(Go.toInterface((({ n : _key.value.n, e : _key.value.e } : T_pkcs1PublicKey)).__copy__())), _derBytes:Slice<GoUInt8> = __tmp__._0, _:stdgo.Error = __tmp__._1;
        return _derBytes;
    }
/**
...
function parsePKCS8PrivateKey(_der:Slice<GoByte>):{ var _0 : AnyInterface; var _1 : Error; } {
        var _key:AnyInterface = ((null : AnyInterface)), _err:Error = ((null : stdgo.Error));
        var _privKey:T_pkcs8 = new T_pkcs8();
        {
            var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_der, Go.toInterface(Go.pointer(_privKey))), _:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                {
                    var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_der, Go.toInterface(Go.pointer(new T_ecPrivateKey()))), _:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                    if (_err == null) {
                        return { _0 : ((null : AnyInterface)), _1 : stdgo.errors.Errors.new_("x509: failed to parse private key (use ParseECPrivateKey instead for this key format)") };
                    };
                };
                {
                    var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_der, Go.toInterface(Go.pointer(new T_pkcs1PrivateKey()))), _:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                    if (_err == null) {
                        return { _0 : ((null : AnyInterface)), _1 : stdgo.errors.Errors.new_("x509: failed to parse private key (use ParsePKCS1PrivateKey instead for this key format)") };
                    };
                };
        ...
        if (_privKey.algo.algorithm.equal(_oidPublicKeyRSA.__copy__())) {
            ...
            if (_err != null) {
                return { _0 : ((null : AnyInterface)), _1 : stdgo.errors.Errors.new_((("x509: failed to parse RSA private key embedded in PKCS#8: " : GoString)) + _err.error()) };
            };
            ...
            var _namedCurveOID:Pointer<stdgo.encoding.asn1.Asn1.ObjectIdentifier> = Go.pointer(new stdgo.encoding.asn1.Asn1.ObjectIdentifier());
            {
                var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_bytes, Go.toInterface(_namedCurveOID)), _:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
            ...
            if (_err != null) {
                return { _0 : ((null : AnyInterface)), _1 : stdgo.errors.Errors.new_((("x509: failed to parse EC private key embedded in PKCS#8: " : GoString)) + _err.error()) };
            };
            return { _0 : Go.toInterface(_key), _1 : ((null : stdgo.Error)) };
            ...
            {
                var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_privKey.privateKey, Go.toInterface(Go.pointer(_curvePrivateKey))), _:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
            ...
            return { _0 : ((null : AnyInterface)), _1 : stdgo.fmt.Fmt.errorf("x509: PKCS#8 wrapping contained private key with unknown algorithm: %v", Go.toInterface(_privKey.algo.algorithm.__copy__())) };
        };
    }
/**
...
function marshalPKCS8PrivateKey(_key:AnyInterface):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        ...
        if (Go.assertable(((_key : Pointer<stdgo.crypto.rsa.Rsa.PrivateKey>)))) {
            var _k:Pointer<stdgo.crypto.rsa.Rsa.PrivateKey> = _key == null ? null : _key.__underlying__() == null ? null : _key == null ? null : _key.__underlying__().value;
            _privKey.algo = (({ algorithm : _oidPublicKeyRSA.__copy__(), parameters : stdgo.encoding.asn1.Asn1.nullRawValue.__copy__() } : stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier)).__copy__();
            _privKey.privateKey = marshalPKCS1PrivateKey(_k);
        } else if (Go.assertable(((_key : Pointer<stdgo.crypto.ecdsa.Ecdsa.PrivateKey>)))) {
            var _k:Pointer<stdgo.crypto.ecdsa.Ecdsa.PrivateKey> = _key == null ? null : _key.__underlying__() == null ? null : _key == null ? null : _key.__underlying__().value;
            var __tmp__ = _oidFromNamedCurve(_k.value.publicKey.curve), _oid:stdgo.encoding.asn1.Asn1.ObjectIdentifier = __tmp__._0, _ok:Bool = __tmp__._1;
            if (!_ok) {
                return { _0 : new Slice<GoUInt8>().nil(), _1 : stdgo.errors.Errors.new_("x509: unknown curve while marshaling to PKCS#8") };
            };
            var __tmp__ = stdgo.encoding.asn1.Asn1.marshal(Go.toInterface(_oid.__copy__())), _oidBytes:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return { _0 : new Slice<GoUInt8>().nil(), _1 : stdgo.errors.Errors.new_((("x509: failed to marshal curve OID: " : GoString)) + _err.error()) };
            };
            _privKey.algo = (({ algorithm : _oidPublicKeyECDSA.__copy__(), parameters : (({ fullBytes : _oidBytes, class_ : 0, tag : 0, isCompound : false, bytes : new Slice<GoUInt8>().nil() } : stdgo.encoding.asn1.Asn1.RawValue)).__copy__() } : stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier)).__copy__();
            {
                {
                ...
                if (_err != null) {
                    return { _0 : new Slice<GoUInt8>().nil(), _1 : stdgo.errors.Errors.new_((("x509: failed to marshal EC private key while building PKCS#8: " : GoString)) + _err.error()) };
                };
            };
        } else if (Go.assertable(((_key : stdgo.crypto.ed25519.Ed25519.PrivateKey)))) {
            var _k:stdgo.crypto.ed25519.Ed25519.PrivateKey = _key == null ? null : _key.__underlying__() == null ? null : _key == null ? null : _key.__underlying__().value;
            _privKey.algo = (({ algorithm : _oidPublicKeyEd25519.__copy__(), parameters : new stdgo.encoding.asn1.Asn1.RawValue() } : stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier)).__copy__();
            var __tmp__ = stdgo.encoding.asn1.Asn1.marshal(Go.toInterface(_k.seed())), _curvePrivateKey:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
...
function _loadSystemRoots():{ var _0 : Pointer<CertPool>; var _1 : Error; } {
        ...
        for (_file in _files) {
            var __tmp__ = stdgo.os.Os.readFile(_file), _data:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err == null) {
        ...
        for (_directory in _dirs) {
            var __tmp__ = _readUniqueDirectoryEntries(_directory), _fis:Slice<stdgo.io.fs.Fs.DirEntry> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                if (_firstErr == null && !stdgo.os.Os.isNotExist(_err)) {
                    _firstErr = _err;
                };
            ...
            for (_fi in _fis) {
                var __tmp__ = stdgo.os.Os.readFile(_directory + (("/" : GoString)) + _fi.name()), _data:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err == null) {
                    _roots.value.appendCertsFromPEM(_data);
                };
            };
...
function _readUniqueDirectoryEntries(_dir:GoString):{ var _0 : Slice<stdgo.io.fs.Fs.DirEntry>; var _1 : Error; } {
        var __tmp__ = stdgo.os.Os.readDir(_dir), _files:Slice<stdgo.io.fs.Fs.DirEntry> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
...
function _isSameDirSymlink(_f:stdgo.io.fs.Fs.DirEntry, _dir:GoString):Bool {
        ...
        var __tmp__ = stdgo.os.Os.readlink(stdgo.path.filepath.Filepath.join(_dir, _f.name())), _target:GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
...
function marshalECPrivateKey(_key:Pointer<stdgo.crypto.ecdsa.Ecdsa.PrivateKey>):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        var __tmp__ = _oidFromNamedCurve(_key.value.publicKey.curve), _oid:stdgo.encoding.asn1.Asn1.ObjectIdentifier = __tmp__._0, _ok:Bool = __tmp__._1;
        if (!_ok) {
...
**/
function _marshalECPrivateKeyWithOID(_key:Pointer<stdgo.crypto.ecdsa.Ecdsa.PrivateKey>, _oid:stdgo.encoding.asn1.Asn1.ObjectIdentifier):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        var _privateKey:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0 ... (((_key.value.publicKey.curve.params().value.n.value.bitLen() + ((7 : GoInt))) / ((8 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]);
        return stdgo.encoding.asn1.Asn1.marshal(Go.toInterface((({ version : ((1 : GoInt)), privateKey : _key.value.d.value.fillBytes(_privateKey), namedCurveOID : _oid.__copy__(), publicKey : (({ bytes : stdgo.crypto.elliptic.Elliptic.marshal(_key.value.publicKey.curve, _key.value.publicKey.x, _key.value.publicKey.y), bitLength : 0 } : stdgo.encoding.asn1.Asn1.BitString)).__copy__() } : T_ecPrivateKey)).__copy__()));
    }
/**
...
**/
function _parseECPrivateKey(_namedCurveOID:Pointer<stdgo.encoding.asn1.Asn1.ObjectIdentifier>, _der:Slice<GoByte>):{ var _0 : Pointer<stdgo.crypto.ecdsa.Ecdsa.PrivateKey>; var _1 : Error; } {
        var _key:Pointer<stdgo.crypto.ecdsa.Ecdsa.PrivateKey> = new Pointer<stdgo.crypto.ecdsa.Ecdsa.PrivateKey>().nil(), _err:Error = ((null : stdgo.Error));
            ...
            if (_err != null) {
                {
                    var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_der, Go.toInterface(Go.pointer(new T_pkcs8()))), _:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                    if (_err == null) {
                        return { _0 : new Pointer<stdgo.crypto.ecdsa.Ecdsa.PrivateKey>().nil(), _1 : stdgo.errors.Errors.new_("x509: failed to parse private key (use ParsePKCS8PrivateKey instead for this key format)") };
                    };
                };
                {
                    var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_der, Go.toInterface(Go.pointer(new T_pkcs1PrivateKey()))), _:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                    if (_err == null) {
                        return { _0 : new Pointer<stdgo.crypto.ecdsa.Ecdsa.PrivateKey>().nil(), _1 : stdgo.errors.Errors.new_("x509: failed to parse private key (use ParsePKCS1PrivateKey instead for this key format)") };
                    };
                };
                return { _0 : new Pointer<stdgo.crypto.ecdsa.Ecdsa.PrivateKey>().nil(), _1 : stdgo.errors.Errors.new_((("x509: failed to parse EC private key: " : GoString)) + _err.error()) };
            };
        };
        if (_privKey.version != _ecPrivKeyVersion) {
            return { _0 : new Pointer<stdgo.crypto.ecdsa.Ecdsa.PrivateKey>().nil(), _1 : stdgo.fmt.Fmt.errorf("x509: unknown EC private key version %d", Go.toInterface(_privKey.version)) };
        };
        ...
        _priv.value.d = _k;
        var _privateKey:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0 ... (((_curveOrder.value.bitLen() + ((7 : GoInt))) / ((8 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]);
...
function _parseRFC2821Mailbox(_in:GoString):{ var _0 : T_rfc2821Mailbox; var _1 : Bool; } {
        return stdgo.internal.Macro.controlFlow({
            var _mailbox:T_rfc2821Mailbox = new T_rfc2821Mailbox(), _ok:Bool = false;
            if (_in.length == ((0 : GoInt))) {
                return { _0 : _mailbox.__copy__(), _1 : false };
            };
            var _localPartBytes:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((_in.length / ((2 : GoInt)) : GoInt)).toBasic());
            if (_in[((0 : GoInt))] == (("\"".code : GoRune))) {
                    ...
                    _in = _in.__slice__(((1 : GoInt)));
                    {
                        ...
                        while (true) {
                            if (_c == (("\"".code : GoRune))) {
                                ...
                                if (_in[((0 : GoInt))] == ((11 : GoUInt8)) || _in[((0 : GoInt))] == ((12 : GoUInt8)) || (((1 : GoUInt8)) <= _in[((0 : GoInt))] && _in[((0 : GoInt))] <= ((9 : GoUInt8))) || (((14 : GoUInt8)) <= _in[((0 : GoInt))] && _in[((0 : GoInt))] <= ((127 : GoUInt8)))) {
                                ...
                                break;
                            } else if (_c == ((11 : GoUInt8)) || _c == ((12 : GoUInt8)) || _c == ((32 : GoUInt8)) || _c == ((33 : GoUInt8)) || _c == ((127 : GoUInt8)) || (((1 : GoUInt8)) <= _c && _c <= ((8 : GoUInt8))) || (((14 : GoUInt8)) <= _c && _c <= ((31 : GoUInt8))) || (((35 : GoUInt8)) <= _c && _c <= ((91 : GoUInt8))) || (((93 : GoUInt8)) <= _c && _c <= ((126 : GoUInt8)))) {
                    ...
                    var _c:GoUInt8 = _in[((0 : GoInt))];
                    {
                        ...
                        while (true) {
                            if (__switchIndex__ == 0 || (__switchIndex__ == -1 && _c == (("\\".code : GoRune)))) {
                                ...
                                break;
                            } else if (__switchIndex__ == 1 || (__switchIndex__ == -1 && ((("0".code : GoRune)) <= _c && _c <= (("9".code : GoRune))) || ((("a".code : GoRune)) <= _c && _c <= (("z".code : GoRune))) || ((("A".code : GoRune)) <= _c && _c <= (("Z".code : GoRune))) || _c == (("!".code : GoRune)) || _c == (("#".code : GoRune)) || _c == (("$".code : GoRune)) || _c == (("%".code : GoRune)) || _c == (("&".code : GoRune)) || _c == (("\'".code : GoRune)) || _c == (("*".code : GoRune)) || _c == (("+".code : GoRune)) || _c == (("-".code : GoRune)) || _c == (("/".code : GoRune)) || _c == (("=".code : GoRune)) || _c == (("?".code : GoRune)) || _c == (("^".code : GoRune)) || _c == (("_".code : GoRune)) || _c == (("`".code : GoRune)) || _c == (("{".code : GoRune)) || _c == (("|".code : GoRune)) || _c == (("}".code : GoRune)) || _c == (("~".code : GoRune)) || _c == ((".".code : GoRune)))) {
                                _localPartBytes = _localPartBytes.__append__(_in[((0 : GoInt))]);
                                _in = _in.__slice__(((1 : GoInt)));
                                break;
                                break;
                ...
                if (_localPartBytes[((0 : GoInt))] == ((".".code : GoRune)) || _localPartBytes[_localPartBytes.length - ((1 : GoInt))] == ((".".code : GoRune)) || stdgo.bytes.Bytes.contains(_localPartBytes, _twoDots)) {
                    return { _0 : _mailbox.__copy__(), _1 : false };
                };
            };
            ...
            _in = _in.__slice__(((1 : GoInt)));
            {
                var __tmp__ = _domainToReverseLabels(_in), _:Slice<GoString> = __tmp__._0, _ok:Bool = __tmp__._1;
                if (!_ok) {
                    return { _0 : _mailbox.__copy__(), _1 : false };
                };
            };
...
function _domainToReverseLabels(_domain:GoString):{ var _0 : Slice<GoString>; var _1 : Bool; } {
        var _reverseLabels:Slice<GoString> = new Slice<GoString>().nil(), _ok:Bool = false;
...
function _matchEmailConstraint(_mailbox:T_rfc2821Mailbox, _constraint:GoString):{ var _0 : Bool; var _1 : Error; } {
        if (stdgo.strings.Strings.contains(_constraint, "@")) {
            var __tmp__ = _parseRFC2821Mailbox(_constraint), _constraintMailbox:T_rfc2821Mailbox = __tmp__._0, _ok:Bool = __tmp__._1;
            if (!_ok) {
                return { _0 : false, _1 : stdgo.fmt.Fmt.errorf("x509: internal error: cannot parse constraint %q", Go.toInterface(_constraint)) };
            };
            return { _0 : _mailbox._local == _constraintMailbox._local && stdgo.strings.Strings.equalFold(_mailbox._domain, _constraintMailbox._domain), _1 : ((null : stdgo.Error)) };
        };
...
function _matchURIConstraint(_uri:Pointer<stdgo.net.url.Url.URL>, _constraint:GoString):{ var _0 : Bool; var _1 : Error; } {
        ...
        if (stdgo.strings.Strings.hasPrefix(_host, "[") && stdgo.strings.Strings.hasSuffix(_host, "]") || stdgo.net.Net.parseIP(_host).__t__ != null && !stdgo.net.Net.parseIP(_host).__t__.isNil()) {
...
function _matchIPConstraint(_ip:stdgo.net.Net.IP, _constraint:Pointer<stdgo.net.Net.IPNet>):{ var _0 : Bool; var _1 : Error; } {
        ...
        {
            var _i;
            for (_obj in _ip.__t__.keyValueIterator()) {
                _i = _obj.key;
                {
...
function _matchDomainConstraint(_domain:GoString, _constraint:GoString):{ var _0 : Bool; var _1 : Error; } {
        ...
        var __tmp__ = _domainToReverseLabels(_domain), _domainLabels:Slice<GoString> = __tmp__._0, _ok:Bool = __tmp__._1;
        if (!_ok) {
        ...
        var __tmp__ = _domainToReverseLabels(_constraint), _constraintLabels:Slice<GoString> = __tmp__._0, _ok:Bool = __tmp__._1;
        if (!_ok) {
        ...
        {
            var _i;
            var _constraintLabel;
            for (_obj in _constraintLabels.keyValueIterator()) {
                _i = _obj.key;
                _constraintLabel = _obj.value;
...
function _appendToFreshChain(_chain:Slice<Pointer<Certificate>>, _cert:Pointer<Certificate>):Slice<Pointer<Certificate>> {
        var _n:Slice<Pointer<Certificate>> = new Slice<Pointer<Certificate>>(...[for (i in 0 ... ((_chain.length + ((1 : GoInt)) : GoInt)).toBasic()) new Pointer<Certificate>().nil()]);
        Go.copy(_n, _chain);
...
function _validHostname(_host:GoString, _isPattern:Bool):Bool {
        ...
        };
        {
            var _i;
            var _part;
            for (_obj in stdgo.strings.Strings.split(_host, ".").keyValueIterator()) {
                _i = _obj.key;
                _part = _obj.value;
                if (_part == (("" : GoString))) {
                    return false;
                ...
                };
                {
                    var _j;
                    var _c;
                    for (_obj in _part.keyValueIterator()) {
                        _j = _obj.key;
                        _c = _obj.value;
...
function _matchExactly(_hostA:GoString, _hostB:GoString):Bool {
        if (_hostA == (("" : GoString)) || _hostA == (("." : GoString)) || _hostB == (("" : GoString)) || _hostB == (("." : GoString))) {
            return false;
        };
...
function _matchHostnames(_pattern:GoString, _host:GoString):Bool {
        ...
        };
        {
            var _i;
            var _patternPart;
            for (_obj in _patternParts.keyValueIterator()) {
                _i = _obj.key;
                _patternPart = _obj.value;
        ...
        return stdgo.internal.Macro.controlFlow({
            ...
            @:label("NextCert") {
                ...
                Go.cfor(_i >= ((0 : GoInt)), _i--, {
                    ...
                    for (_usage in _cert.value.extKeyUsage) {
                        if (_usage.__t__ == extKeyUsageAny.__t__) {
                            continue;
                        };
                    };
                    final _invalidUsage:ExtKeyUsage = new ExtKeyUsage(-((1 : GoUnTypedInt)));
                    @:label("NextRequestedUsage") {
                        var _i;
                        var _requestedUsage;
                        for (_obj in _usages.keyValueIterator()) {
                            _i = _obj.key;
                            _requestedUsage = _obj.value;
                            ...
                            for (_usage in _cert.value.extKeyUsage) {
                                if (_requestedUsage.__t__ == _usage.__t__) {
                                    continue;
                                } else if (_requestedUsage.__t__ == extKeyUsageServerAuth.__t__ && (_usage.__t__ == extKeyUsageNetscapeServerGatedCrypto.__t__ || _usage.__t__ == extKeyUsageMicrosoftServerGatedCrypto.__t__)) {
                                    continue;
                                };
                            };
...
function parsePKIXPublicKey(_derBytes:Slice<GoByte>):{ var _0 : AnyInterface; var _1 : Error; } {
        var _pub:AnyInterface = ((null : AnyInterface)), _err:Error = ((null : stdgo.Error));
        var _pki:T_publicKeyInfo = new T_publicKeyInfo();
        {
            var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_derBytes, Go.toInterface(Go.pointer(_pki))), _rest:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                {
                    var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_derBytes, Go.toInterface(Go.pointer(new T_pkcs1PublicKey()))), _:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                    if (_err == null) {
                        return { _0 : ((null : AnyInterface)), _1 : stdgo.errors.Errors.new_("x509: failed to parse public key (use ParsePKCS1PublicKey instead for this key format)") };
                    };
                };
                return { _0 : ((null : AnyInterface)), _1 : _err };
...
function _marshalPublicKey(_pub:AnyInterface):{ var _0 : Slice<GoByte>; var _1 : stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier; var _2 : Error; } {
        var _publicKeyBytes:Slice<GoByte> = new Slice<GoUInt8>().nil(), _publicKeyAlgorithm:stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier = new stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier(), _err:Error = ((null : stdgo.Error));
        if (Go.assertable(((_pub : Pointer<stdgo.crypto.rsa.Rsa.PublicKey>)))) {
            var _pub:Pointer<stdgo.crypto.rsa.Rsa.PublicKey> = _pub == null ? null : _pub.__underlying__() == null ? null : _pub == null ? null : _pub.__underlying__().value;
            {
            ...
            var _pub:Pointer<stdgo.crypto.ecdsa.Ecdsa.PublicKey> = _pub == null ? null : _pub.__underlying__() == null ? null : _pub == null ? null : _pub.__underlying__().value;
            _publicKeyBytes = stdgo.crypto.elliptic.Elliptic.marshal(_pub.value.curve, _pub.value.x, _pub.value.y);
            var __tmp__ = _oidFromNamedCurve(_pub.value.curve), _oid:stdgo.encoding.asn1.Asn1.ObjectIdentifier = __tmp__._0, _ok:Bool = __tmp__._1;
            if (!_ok) {
                return { _0 : new Slice<GoUInt8>().nil(), _1 : new stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier().__copy__(), _2 : stdgo.errors.Errors.new_("x509: unsupported elliptic curve") };
            };
            ...
            var _pub:stdgo.crypto.ed25519.Ed25519.PublicKey = _pub == null ? null : _pub.__underlying__() == null ? null : _pub == null ? null : _pub.__underlying__().value;
            ...
            return { _0 : new Slice<GoUInt8>().nil(), _1 : new stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier().__copy__(), _2 : stdgo.fmt.Fmt.errorf("x509: unsupported public key type: %T", Go.toInterface(_pub)) };
        };
...
function marshalPKIXPublicKey(_pub:AnyInterface):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        ...
        var _pkix:T_pkixPublicKey = (({ algo : _publicKeyAlgorithm.__copy__(), bitString : (({ bytes : _publicKeyBytes, bitLength : ((8 : GoInt)) * _publicKeyBytes.length } : stdgo.encoding.asn1.Asn1.BitString)).__copy__() } : T_pkixPublicKey)).__copy__();
        var __tmp__ = stdgo.encoding.asn1.Asn1.marshal(Go.toInterface(_pkix.__copy__())), _ret:Slice<GoUInt8> = __tmp__._0, _:stdgo.Error = __tmp__._1;
...
function _getSignatureAlgorithmFromAI(_ai:stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier):SignatureAlgorithm {
        ...
        {
            var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_ai.parameters.fullBytes, Go.toInterface(Go.pointer(_params))), _:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return unknownSignatureAlgorithm;
            };
        };
        ...
        {
            var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_params.mgf.parameters.fullBytes, Go.toInterface(Go.pointer(_mgf1HashFunc))), _:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return unknownSignatureAlgorithm;
            };
        };
        if ((_params.hash.parameters.fullBytes.length != ((0 : GoInt)) && !stdgo.bytes.Bytes.equal(_params.hash.parameters.fullBytes, stdgo.encoding.asn1.Asn1.nullBytes)) || !_params.mgf.algorithm.equal(_oidMGF1.__copy__()) || !_mgf1HashFunc.algorithm.equal(_params.hash.algorithm.__copy__()) || (_mgf1HashFunc.parameters.fullBytes.length != ((0 : GoInt)) && !stdgo.bytes.Bytes.equal(_mgf1HashFunc.parameters.fullBytes, stdgo.encoding.asn1.Asn1.nullBytes)) || _params.trailerField != ((1 : GoInt))) {
            return unknownSignatureAlgorithm;
        };
...
function _oidFromExtKeyUsage(_eku:ExtKeyUsage):{ var _0 : stdgo.encoding.asn1.Asn1.ObjectIdentifier; var _1 : Bool; } {
        var _oid:stdgo.encoding.asn1.Asn1.ObjectIdentifier = new stdgo.encoding.asn1.Asn1.ObjectIdentifier(), _ok:Bool = false;
        for (_pair in _extKeyUsageOIDs) {
...
function _signaturePublicKeyAlgoMismatchError(_expectedPubKeyAlgo:PublicKeyAlgorithm, _pubKey:AnyInterface):Error {
        return stdgo.fmt.Fmt.errorf("x509: signature algorithm specifies an %s public key, but have public key of type %T", Go.toInterface(_expectedPubKeyAlgo.toString()), Go.toInterface(_pubKey));
    }
/**
...
function _checkSignature(_algo:SignatureAlgorithm, _signed:Slice<GoByte>, _signature:Slice<GoByte>, _publicKey:stdgo.crypto.Crypto.PublicKey):Error {
        ...
        if (Go.assertable(((_publicKey : Pointer<stdgo.crypto.rsa.Rsa.PublicKey>)))) {
            var _pub:Pointer<stdgo.crypto.rsa.Rsa.PublicKey> = _publicKey == null ? null : _publicKey.__underlying__() == null ? null : _publicKey == null ? null : _publicKey.__underlying__().value;
            if (_pubKeyAlgo.__t__ != rsa.__t__) {
                return _signaturePublicKeyAlgoMismatchError(_pubKeyAlgo, Go.toInterface(_pub));
            };
            if (_algo._isRSAPSS()) {
                return stdgo.crypto.rsa.Rsa.verifyPSS(_pub, _hashType, _signed, _signature, Go.pointer((({ saltLength : stdgo.crypto.rsa.Rsa.psssaltLengthEqualsHash, hash : new stdgo.crypto.Crypto.Hash() } : stdgo.crypto.rsa.Rsa.PSSOptions))));
            } else {
            ...
            var _pub:Pointer<stdgo.crypto.ecdsa.Ecdsa.PublicKey> = _publicKey == null ? null : _publicKey.__underlying__() == null ? null : _publicKey == null ? null : _publicKey.__underlying__().value;
            ...
            var _pub:stdgo.crypto.ed25519.Ed25519.PublicKey = _publicKey == null ? null : _publicKey.__underlying__() == null ? null : _publicKey == null ? null : _publicKey.__underlying__().value;
            if (_pubKeyAlgo.__t__ != ed25519.__t__) {
...
function _asn1BitLength(_bitString:Slice<GoByte>):GoInt {
        ...
        {
            var _i;
            for (_obj in _bitString.keyValueIterator()) {
                _i = _obj.key;
...
**/
function _marshalSANs(_dnsNames:Slice<GoString>, _emailAddresses:Slice<GoString>, _ipAddresses:Slice<stdgo.net.Net.IP>, _uris:Slice<Pointer<stdgo.net.url.Url.URL>>):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        var _derBytes:Slice<GoByte> = new Slice<GoUInt8>().nil(), _err:Error = ((null : stdgo.Error));
        var _rawValues:Slice<stdgo.encoding.asn1.Asn1.RawValue> = new Slice<stdgo.encoding.asn1.Asn1.RawValue>().nil();
        for (_name in _dnsNames) {
            {
                var _err:stdgo.Error = _isIA5String(_name);
                if (_err != null) {
                    return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
            ...
            _rawValues = _rawValues.__append__((({ tag : _nameTypeDNS, class_ : ((2 : GoInt)), bytes : ((_name : Slice<GoByte>)), isCompound : false, fullBytes : new Slice<GoUInt8>().nil() } : stdgo.encoding.asn1.Asn1.RawValue)).__copy__());
        };
        for (_email in _emailAddresses) {
            {
                var _err:stdgo.Error = _isIA5String(_email);
                if (_err != null) {
                    return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
            ...
            _rawValues = _rawValues.__append__((({ tag : _nameTypeEmail, class_ : ((2 : GoInt)), bytes : ((_email : Slice<GoByte>)), isCompound : false, fullBytes : new Slice<GoUInt8>().nil() } : stdgo.encoding.asn1.Asn1.RawValue)).__copy__());
        };
        for (_rawIP in _ipAddresses) {
            var _ip:stdgo.net.Net.IP = _rawIP.to4().__copy__();
            if (_ip.__t__ == null || _ip.__t__.isNil()) {
                _ip = _rawIP.__copy__();
            };
            _rawValues = _rawValues.__append__((({ tag : _nameTypeIP, class_ : ((2 : GoInt)), bytes : _ip.__copy__().__t__, isCompound : false, fullBytes : new Slice<GoUInt8>().nil() } : stdgo.encoding.asn1.Asn1.RawValue)).__copy__());
        };
        for (_uri in _uris) {
            ...
            _rawValues = _rawValues.__append__((({ tag : _nameTypeURI, class_ : ((2 : GoInt)), bytes : ((_uriStr : Slice<GoByte>)), isCompound : false, fullBytes : new Slice<GoUInt8>().nil() } : stdgo.encoding.asn1.Asn1.RawValue)).__copy__());
        };
...
function _buildCertExtensions(_template:Pointer<Certificate>, _subjectIsEmpty:Bool, _authorityKeyId:Slice<GoByte>, _subjectKeyId:Slice<GoByte>):{ var _0 : Slice<stdgo.crypto.x509.pkix.Pkix.Extension>; var _1 : Error; } {
        var _ret:Slice<stdgo.crypto.x509.pkix.Pkix.Extension> = new Slice<stdgo.crypto.x509.pkix.Pkix.Extension>().nil(), _err:Error = ((null : stdgo.Error));
        _ret = new Slice<stdgo.crypto.x509.pkix.Pkix.Extension>(...[for (i in 0 ... ((((10 : GoInt)) : GoInt)).toBasic()) new stdgo.crypto.x509.pkix.Pkix.Extension()]);
        var _n:GoInt = ((0 : GoInt));
        if (_template.value.keyUsage.__t__ != ((0 : GoInt)) && !_oidInExtensions(new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidExtensionKeyUsage), _template.value.extraExtensions)) {
            {
        ...
        if ((_template.value.extKeyUsage.length > ((0 : GoInt)) || _template.value.unknownExtKeyUsage.length > ((0 : GoInt))) && !_oidInExtensions(new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidExtensionExtendedKeyUsage), _template.value.extraExtensions)) {
            {
        ...
        if (_template.value.basicConstraintsValid && !_oidInExtensions(new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidExtensionBasicConstraints), _template.value.extraExtensions)) {
            {
        ...
        if (_subjectKeyId.length > ((0 : GoInt)) && !_oidInExtensions(new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidExtensionSubjectKeyId), _template.value.extraExtensions)) {
        ...
        if (_authorityKeyId.length > ((0 : GoInt)) && !_oidInExtensions(new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidExtensionAuthorityKeyId), _template.value.extraExtensions)) {
        ...
        if ((_template.value.ocspserver.length > ((0 : GoInt)) || _template.value.issuingCertificateURL.length > ((0 : GoInt))) && !_oidInExtensions(new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidExtensionAuthorityInfoAccess), _template.value.extraExtensions)) {
            ...
            for (_name in _template.value.ocspserver) {
                _aiaValues = _aiaValues.__append__((({ method : _oidAuthorityInfoAccessOcsp.__copy__(), location : (({ tag : ((6 : GoInt)), class_ : ((2 : GoInt)), bytes : ((_name : Slice<GoByte>)), isCompound : false, fullBytes : new Slice<GoUInt8>().nil() } : stdgo.encoding.asn1.Asn1.RawValue)).__copy__() } : T_authorityInfoAccess)).__copy__());
            };
            for (_name in _template.value.issuingCertificateURL) {
                _aiaValues = _aiaValues.__append__((({ method : _oidAuthorityInfoAccessIssuers.__copy__(), location : (({ tag : ((6 : GoInt)), class_ : ((2 : GoInt)), bytes : ((_name : Slice<GoByte>)), isCompound : false, fullBytes : new Slice<GoUInt8>().nil() } : stdgo.encoding.asn1.Asn1.RawValue)).__copy__() } : T_authorityInfoAccess)).__copy__());
            };
            {
        ...
        if ((_template.value.dnsnames.length > ((0 : GoInt)) || _template.value.emailAddresses.length > ((0 : GoInt)) || _template.value.ipaddresses.length > ((0 : GoInt)) || _template.value.uris.length > ((0 : GoInt))) && !_oidInExtensions(new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidExtensionSubjectAltName), _template.value.extraExtensions)) {
        ...
        if (_template.value.policyIdentifiers.length > ((0 : GoInt)) && !_oidInExtensions(new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidExtensionCertificatePolicies), _template.value.extraExtensions)) {
            {
        ...
        if ((_template.value.permittedDNSDomains.length > ((0 : GoInt)) || _template.value.excludedDNSDomains.length > ((0 : GoInt)) || _template.value.permittedIPRanges.length > ((0 : GoInt)) || _template.value.excludedIPRanges.length > ((0 : GoInt)) || _template.value.permittedEmailAddresses.length > ((0 : GoInt)) || _template.value.excludedEmailAddresses.length > ((0 : GoInt)) || _template.value.permittedURIDomains.length > ((0 : GoInt)) || _template.value.excludedURIDomains.length > ((0 : GoInt))) && !_oidInExtensions(new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidExtensionNameConstraints), _template.value.extraExtensions)) {
            ...
            var _ipAndMask:Pointer<stdgo.net.Net.IPNet> -> Slice<GoUInt8> = function(_ipNet:Pointer<stdgo.net.Net.IPNet>):Slice<GoByte> {
                ...
                var _ipAndMask:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((_maskedIP.__t__.length + _ipNet.value.mask.__t__.length : GoInt)).toBasic());
                _ipAndMask = _ipAndMask.__append__(..._maskedIP.__t__.toArray());
                _ipAndMask = _ipAndMask.__append__(..._ipNet.value.mask.__t__.toArray());
                return _ipAndMask;
            };
            var _serialiseConstraints:(Slice<GoString>, Slice<Pointer<stdgo.net.Net.IPNet>>, Slice<GoString>, Slice<GoString>) -> { var _0 : Slice<GoUInt8>; var _1 : stdgo.Error; } = function(_dns:Slice<GoString>, _ips:Slice<Pointer<stdgo.net.Net.IPNet>>, _emails:Slice<GoString>, _uriDomains:Slice<GoString>):{ var _0 : Slice<GoByte>; var _1 : Error; } {
                ...
                for (_name in _dns) {
                    ...
                    _b.addASN1(golang_org.x.crypto.cryptobyte.asn1.Asn1.sequence, new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.BuilderContinuation(function(_b:Pointer<golang_org.x.crypto.cryptobyte.Cryptobyte.Builder>):Void {
                        _b.value.addASN1(new golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag(((2 : GoUInt8))).contextSpecific(), new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.BuilderContinuation(function(_b:Pointer<golang_org.x.crypto.cryptobyte.Cryptobyte.Builder>):Void {
                ...
                for (_ipNet in _ips) {
                    _b.addASN1(golang_org.x.crypto.cryptobyte.asn1.Asn1.sequence, new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.BuilderContinuation(function(_b:Pointer<golang_org.x.crypto.cryptobyte.Cryptobyte.Builder>):Void {
                        _b.value.addASN1(new golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag(((7 : GoUInt8))).contextSpecific(), new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.BuilderContinuation(function(_b:Pointer<golang_org.x.crypto.cryptobyte.Cryptobyte.Builder>):Void {
                ...
                for (_email in _emails) {
                    ...
                    _b.addASN1(golang_org.x.crypto.cryptobyte.asn1.Asn1.sequence, new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.BuilderContinuation(function(_b:Pointer<golang_org.x.crypto.cryptobyte.Cryptobyte.Builder>):Void {
                        _b.value.addASN1(new golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag(((1 : GoUInt8))).contextSpecific(), new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.BuilderContinuation(function(_b:Pointer<golang_org.x.crypto.cryptobyte.Cryptobyte.Builder>):Void {
                            _b.value.addBytes(((_email : Slice<GoByte>)));
                        }));
                    }));
                };
                for (_uriDomain in _uriDomains) {
                    {
                    ...
                    _b.addASN1(golang_org.x.crypto.cryptobyte.asn1.Asn1.sequence, new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.BuilderContinuation(function(_b:Pointer<golang_org.x.crypto.cryptobyte.Cryptobyte.Builder>):Void {
                        _b.value.addASN1(new golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag(((6 : GoUInt8))).contextSpecific(), new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.BuilderContinuation(function(_b:Pointer<golang_org.x.crypto.cryptobyte.Cryptobyte.Builder>):Void {
            ...
            var __tmp__ = _serialiseConstraints(_template.value.permittedDNSDomains, _template.value.permittedIPRanges, _template.value.permittedEmailAddresses, _template.value.permittedURIDomains), _permitted:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return { _0 : new Slice<stdgo.crypto.x509.pkix.Pkix.Extension>().nil(), _1 : _err };
            };
            var __tmp__ = _serialiseConstraints(_template.value.excludedDNSDomains, _template.value.excludedIPRanges, _template.value.excludedEmailAddresses, _template.value.excludedURIDomains), _excluded:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return { _0 : new Slice<stdgo.crypto.x509.pkix.Pkix.Extension>().nil(), _1 : _err };
            };
            var _b:golang_org.x.crypto.cryptobyte.Cryptobyte.Builder = new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.Builder();
            _b.addASN1(golang_org.x.crypto.cryptobyte.asn1.Asn1.sequence, new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.BuilderContinuation(function(_b:Pointer<golang_org.x.crypto.cryptobyte.Cryptobyte.Builder>):Void {
                if (_permitted.length > ((0 : GoInt))) {
                    _b.value.addASN1(new golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag(((0 : GoUInt8))).contextSpecific().constructed(), new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.BuilderContinuation(function(_b:Pointer<golang_org.x.crypto.cryptobyte.Cryptobyte.Builder>):Void {
                        _b.value.addBytes(_permitted);
                    }));
                };
                if (_excluded.length > ((0 : GoInt))) {
                    _b.value.addASN1(new golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag(((1 : GoUInt8))).contextSpecific().constructed(), new vendor.golang_org.x.crypto.cryptobyte.Cryptobyte.BuilderContinuation(function(_b:Pointer<golang_org.x.crypto.cryptobyte.Cryptobyte.Builder>):Void {
        ...
        if (_template.value.crldistributionPoints.length > ((0 : GoInt)) && !_oidInExtensions(new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidExtensionCRLDistributionPoints), _template.value.extraExtensions)) {
            ...
            for (_name in _template.value.crldistributionPoints) {
                var _dp:T_distributionPoint = (({ distributionPoint : (({ fullName : new Slice<stdgo.encoding.asn1.Asn1.RawValue>((({ tag : ((6 : GoInt)), class_ : ((2 : GoInt)), bytes : ((_name : Slice<GoByte>)), isCompound : false, fullBytes : new Slice<GoUInt8>().nil() } : stdgo.encoding.asn1.Asn1.RawValue)).__copy__()), relativeName : new stdgo.crypto.x509.pkix.Pkix.RDNSequence() } : T_distributionPointName)).__copy__(), reason : new stdgo.encoding.asn1.Asn1.BitString(), crlissuer : new stdgo.encoding.asn1.Asn1.RawValue() } : T_distributionPoint)).__copy__();
...
function _marshalKeyUsage(_ku:KeyUsage):{ var _0 : stdgo.crypto.x509.pkix.Pkix.Extension; var _1 : Error; } {
        var _ext:stdgo.crypto.x509.pkix.Pkix.Extension = (({ id : new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidExtensionKeyUsage), critical : true, value : new Slice<GoUInt8>().nil() } : stdgo.crypto.x509.pkix.Pkix.Extension)).__copy__();
        ...
        var _err:Error = ((null : stdgo.Error));
        {
            var __tmp__ = stdgo.encoding.asn1.Asn1.marshal(Go.toInterface((({ bytes : _bitString, bitLength : _asn1BitLength(_bitString) } : stdgo.encoding.asn1.Asn1.BitString)).__copy__()));
...
function _marshalExtKeyUsage(_extUsages:Slice<ExtKeyUsage>, _unknownUsages:Slice<stdgo.encoding.asn1.Asn1.ObjectIdentifier>):{ var _0 : stdgo.crypto.x509.pkix.Pkix.Extension; var _1 : Error; } {
        var _ext:stdgo.crypto.x509.pkix.Pkix.Extension = (({ id : new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidExtensionExtendedKeyUsage), critical : false, value : new Slice<GoUInt8>().nil() } : stdgo.crypto.x509.pkix.Pkix.Extension)).__copy__();
        var _oids:Slice<stdgo.encoding.asn1.Asn1.ObjectIdentifier> = new Slice<stdgo.encoding.asn1.Asn1.ObjectIdentifier>(...[for (i in 0 ... ((_extUsages.length + _unknownUsages.length : GoInt)).toBasic()) new stdgo.encoding.asn1.Asn1.ObjectIdentifier()]);
        {
            var _i;
            var _u;
            for (_obj in _extUsages.keyValueIterator()) {
                _i = _obj.key;
                _u = _obj.value;
                {
                    var __tmp__ = _oidFromExtKeyUsage(_u), _oid:stdgo.encoding.asn1.Asn1.ObjectIdentifier = __tmp__._0, _ok:Bool = __tmp__._1;
                    if (_ok) {
...
function _marshalBasicConstraints(_isCA:Bool, _maxPathLen:GoInt, _maxPathLenZero:Bool):{ var _0 : stdgo.crypto.x509.pkix.Pkix.Extension; var _1 : Error; } {
        var _ext:stdgo.crypto.x509.pkix.Pkix.Extension = (({ id : new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidExtensionBasicConstraints), critical : true, value : new Slice<GoUInt8>().nil() } : stdgo.crypto.x509.pkix.Pkix.Extension)).__copy__();
...
function _marshalCertificatePolicies(_policyIdentifiers:Slice<stdgo.encoding.asn1.Asn1.ObjectIdentifier>):{ var _0 : stdgo.crypto.x509.pkix.Pkix.Extension; var _1 : Error; } {
        var _ext:stdgo.crypto.x509.pkix.Pkix.Extension = (({ id : new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidExtensionCertificatePolicies), critical : false, value : new Slice<GoUInt8>().nil() } : stdgo.crypto.x509.pkix.Pkix.Extension)).__copy__();
        var _policies:Slice<T_policyInformation> = new Slice<T_policyInformation>(...[for (i in 0 ... ((_policyIdentifiers.length : GoInt)).toBasic()) new T_policyInformation()]);
        {
            var _i;
            var _policy;
            for (_obj in _policyIdentifiers.keyValueIterator()) {
                _i = _obj.key;
                _policy = _obj.value;
...
function _buildCSRExtensions(_template:Pointer<CertificateRequest>):{ var _0 : Slice<stdgo.crypto.x509.pkix.Pkix.Extension>; var _1 : Error; } {
        ...
        if ((_template.value.dnsnames.length > ((0 : GoInt)) || _template.value.emailAddresses.length > ((0 : GoInt)) || _template.value.ipaddresses.length > ((0 : GoInt)) || _template.value.uris.length > ((0 : GoInt))) && !_oidInExtensions(new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidExtensionSubjectAltName), _template.value.extraExtensions)) {
            var __tmp__ = _marshalSANs(_template.value.dnsnames, _template.value.emailAddresses, _template.value.ipaddresses, _template.value.uris), _sanBytes:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return { _0 : new Slice<stdgo.crypto.x509.pkix.Pkix.Extension>().nil(), _1 : _err };
            };
            _ret = _ret.__append__((({ id : new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidExtensionSubjectAltName), value : _sanBytes, critical : false } : stdgo.crypto.x509.pkix.Pkix.Extension)).__copy__());
        };
...
/**
    ...
    // signature algorithm.
**/
function _signingParamsForPublicKey(_pub:AnyInterface, _requestedSigAlgo:SignatureAlgorithm):{ var _0 : stdgo.crypto.Crypto.Hash; var _1 : stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier; var _2 : Error; } {
        var _hashFunc:stdgo.crypto.Crypto.Hash = new stdgo.crypto.Crypto.Hash(), _sigAlgo:stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier = new stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier(), _err:Error = ((null : stdgo.Error));
        ...
        if (Go.assertable(((_pub : Pointer<stdgo.crypto.rsa.Rsa.PublicKey>)))) {
            ...
            var _pub:Pointer<stdgo.crypto.ecdsa.Ecdsa.PublicKey> = _pub == null ? null : _pub.__underlying__() == null ? null : _pub == null ? null : _pub.__underlying__().value;
            _pubType = ecdsa;
            if (Go.toInterface(_pub.value.curve) == Go.toInterface(stdgo.crypto.elliptic.Elliptic.p224()) || Go.toInterface(_pub.value.curve) == Go.toInterface(stdgo.crypto.elliptic.Elliptic.p256())) {
                _hashFunc = stdgo.crypto.Crypto.sha256;
...
**/
function createCertificate(_rand:stdgo.io.Io.Reader, _template:Pointer<Certificate>, _parent:Pointer<Certificate>, _pub:AnyInterface, _priv:AnyInterface):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        var __tmp__ = try {
            { value : ((_priv.value : stdgo.crypto.Crypto.Signer)), ok : true };
        } catch(_) {
            { value : ((null : stdgo.crypto.Crypto.Signer)), ok : false };
        ...
        if (_template.value.basicConstraintsValid && !_template.value.isCA && _template.value.maxPathLen != -((1 : GoUnTypedInt)) && (_template.value.maxPathLen != ((0 : GoInt)) || _template.value.maxPathLenZero)) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : stdgo.errors.Errors.new_("x509: only CAs are allowed to specify MaxPathLen") };
        };
        var __tmp__ = _signingParamsForPublicKey(Go.toInterface(_key.public_()), _template.value.signatureAlgorithm), _hashFunc:stdgo.crypto.Crypto.Hash = __tmp__._0, _signatureAlgorithm:stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier = __tmp__._1, _err:stdgo.Error = __tmp__._2;
        if (_err != null) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        };
        var __tmp__ = _marshalPublicKey(Go.toInterface(_pub)), _publicKeyBytes:Slice<GoUInt8> = __tmp__._0, _publicKeyAlgorithm:stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier = __tmp__._1, _err:stdgo.Error = __tmp__._2;
        if (_err != null) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        };
        var __tmp__ = _subjectBytes(_parent), _asn1Issuer:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        };
        var __tmp__ = _subjectBytes(_template), _asn1Subject:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        };
        ...
        var __tmp__ = _buildCertExtensions(_template, stdgo.bytes.Bytes.equal(_asn1Subject, _emptyASN1Subject), _authorityKeyId, _subjectKeyId), _extensions:Slice<stdgo.crypto.x509.pkix.Pkix.Extension> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        };
        var _encodedPublicKey:stdgo.encoding.asn1.Asn1.BitString = (({ bitLength : _publicKeyBytes.length * ((8 : GoInt)), bytes : _publicKeyBytes } : stdgo.encoding.asn1.Asn1.BitString)).__copy__();
        var _c:T_tbsCertificate = (({ version : ((2 : GoInt)), serialNumber : _template.value.serialNumber, signatureAlgorithm : _signatureAlgorithm.__copy__(), issuer : (({ fullBytes : _asn1Issuer, class_ : 0, tag : 0, isCompound : false, bytes : new Slice<GoUInt8>().nil() } : stdgo.encoding.asn1.Asn1.RawValue)).__copy__(), validity : new T_validity(_template.value.notBefore.utc().__copy__(), _template.value.notAfter.utc().__copy__()).__copy__(), subject : (({ fullBytes : _asn1Subject, class_ : 0, tag : 0, isCompound : false, bytes : new Slice<GoUInt8>().nil() } : stdgo.encoding.asn1.Asn1.RawValue)).__copy__(), publicKey : new T_publicKeyInfo(new stdgo.encoding.asn1.Asn1.RawContent(), _publicKeyAlgorithm.__copy__(), _encodedPublicKey.__copy__()).__copy__(), extensions : _extensions, raw : new stdgo.encoding.asn1.Asn1.RawContent(), uniqueId : new stdgo.encoding.asn1.Asn1.BitString(), subjectUniqueId : new stdgo.encoding.asn1.Asn1.BitString() } : T_tbsCertificate)).__copy__();
        var __tmp__ = stdgo.encoding.asn1.Asn1.marshal(Go.toInterface(_c.__copy__())), _tbsCertContents:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        };
            ...
            if (_sigAlg.__t__ != md5withRSA.__t__) {
                {
                    ...
                    if (_err != null) {
                        return { _0 : new Slice<GoUInt8>().nil(), _1 : stdgo.fmt.Fmt.errorf("x509: signature over certificate returned by signer is invalid: %w", Go.toInterface(_err)) };
                    };
                };
            };
        };
...
function parseCRL(_crlBytes:Slice<GoByte>):{ var _0 : Pointer<stdgo.crypto.x509.pkix.Pkix.CertificateList>; var _1 : Error; } {
        if (stdgo.bytes.Bytes.hasPrefix(_crlBytes, _pemCRLPrefix)) {
            var __tmp__ = stdgo.encoding.pem.Pem.decode(_crlBytes), _block:Pointer<stdgo.encoding.pem.Pem.Block> = __tmp__._0, _:Slice<GoUInt8> = __tmp__._1;
...
function parseDERCRL(_derBytes:Slice<GoByte>):{ var _0 : Pointer<stdgo.crypto.x509.pkix.Pkix.CertificateList>; var _1 : Error; } {
        ...
        {
            var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_derBytes, Go.toInterface(_certList)), _rest:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
...
function _newRawAttributes(_attributes:Slice<stdgo.crypto.x509.pkix.Pkix.AttributeTypeAndValueSET>):{ var _0 : Slice<stdgo.encoding.asn1.Asn1.RawValue>; var _1 : Error; } {
        ...
        var __tmp__ = stdgo.encoding.asn1.Asn1.marshal(Go.toInterface(_attributes)), _b:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<stdgo.encoding.asn1.Asn1.RawValue>().nil(), _1 : _err };
        };
        var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_b, Go.toInterface(Go.pointer(_rawAttributes))), _rest:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<stdgo.encoding.asn1.Asn1.RawValue>().nil(), _1 : _err };
        };
        if (_rest.length != ((0 : GoInt))) {
...
function _parseRawAttributes(_rawAttributes:Slice<stdgo.encoding.asn1.Asn1.RawValue>):Slice<stdgo.crypto.x509.pkix.Pkix.AttributeTypeAndValueSET> {
        ...
        for (_rawAttr in _rawAttributes) {
            var _attr:stdgo.crypto.x509.pkix.Pkix.AttributeTypeAndValueSET = new stdgo.crypto.x509.pkix.Pkix.AttributeTypeAndValueSET();
            var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_rawAttr.fullBytes, Go.toInterface(Go.pointer(_attr))), _rest:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
...
@:structInit class T_pkcs10Attribute__parseCSRExtensions_0 {
    ...
    public function new(?id:stdgo.encoding.asn1.Asn1.ObjectIdentifier, ?values:Slice<stdgo.encoding.asn1.Asn1.RawValue>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
function _parseCSRExtensions(_rawAttributes:Slice<stdgo.encoding.asn1.Asn1.RawValue>):{ var _0 : Slice<stdgo.crypto.x509.pkix.Pkix.Extension>; var _1 : Error; } {
        ...
        for (_rawAttr in _rawAttributes) {
            ...
            {
                var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_attr.values[((0 : GoInt))].fullBytes, Go.toInterface(Go.pointer(_extensions))), _:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    return { _0 : new Slice<stdgo.crypto.x509.pkix.Pkix.Extension>().nil(), _1 : _err };
                };
            };
...
function createCertificateRequest(_rand:stdgo.io.Io.Reader, _template:Pointer<CertificateRequest>, _priv:AnyInterface):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        var _csr:Slice<GoByte> = new Slice<GoUInt8>().nil(), _err:Error = ((null : stdgo.Error));
        var __tmp__ = try {
            { value : ((_priv.value : stdgo.crypto.Crypto.Signer)), ok : true };
        } catch(_) {
            { value : ((null : stdgo.crypto.Crypto.Signer)), ok : false };
        ...
        var __tmp__ = _buildCSRExtensions(_template), _extensions:Slice<stdgo.crypto.x509.pkix.Pkix.Extension> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        };
        var _attributes:Slice<stdgo.crypto.x509.pkix.Pkix.AttributeTypeAndValueSET> = new Slice<stdgo.crypto.x509.pkix.Pkix.AttributeTypeAndValueSET>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) new stdgo.crypto.x509.pkix.Pkix.AttributeTypeAndValueSET()]).setCap(((_template.value.attributes.length : GoInt)).toBasic());
        for (_attr in _template.value.attributes) {
            var _values:Slice<Slice<stdgo.crypto.x509.pkix.Pkix.AttributeTypeAndValue>> = new Slice<Slice<stdgo.crypto.x509.pkix.Pkix.AttributeTypeAndValue>>(...[for (i in 0 ... ((_attr.value.length : GoInt)).toBasic()) new Slice<stdgo.crypto.x509.pkix.Pkix.AttributeTypeAndValue>().nil()]);
            Go.copy(_values, _attr.value);
            _attributes = _attributes.__append__((({ type : _attr.type.__copy__(), value : _values } : stdgo.crypto.x509.pkix.Pkix.AttributeTypeAndValueSET)).__copy__());
        };
        var _extensionsAppended:Bool = false;
        if (_extensions.length > ((0 : GoInt))) {
            for (_atvSet in _attributes) {
                if (!_atvSet.type.equal(_oidExtensionRequest.__copy__()) || _atvSet.value.length == ((0 : GoInt))) {
                    continue;
                };
                var _specifiedExtensions:GoMap<GoString, Bool> = new GoMap<GoString, Bool>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.basic(bool_kind))));
                for (_atvs in _atvSet.value) {
                    for (_atv in _atvs) {
                        _specifiedExtensions[_atv.type.toString()] = true;
                    };
                };
                var _newValue:Slice<stdgo.crypto.x509.pkix.Pkix.AttributeTypeAndValue> = new Slice<stdgo.crypto.x509.pkix.Pkix.AttributeTypeAndValue>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) new stdgo.crypto.x509.pkix.Pkix.AttributeTypeAndValue()]).setCap(((_atvSet.value[((0 : GoInt))].length + _extensions.length : GoInt)).toBasic());
                _newValue = _newValue.__append__(..._atvSet.value[((0 : GoInt))].toArray());
                for (_e in _extensions) {
                    if (_specifiedExtensions[_e.id.toString()]) {
                        continue;
                    };
                    _newValue = _newValue.__append__((({ type : _e.id.__copy__(), value : Go.toInterface(_e.value) } : stdgo.crypto.x509.pkix.Pkix.AttributeTypeAndValue)).__copy__());
                };
        ...
        var __tmp__ = _newRawAttributes(_attributes), _rawAttributes:Slice<stdgo.encoding.asn1.Asn1.RawValue> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : _csr, _1 : _err };
        };
        if (_extensions.length > ((0 : GoInt)) && !_extensionsAppended) {
            var _attr:T__struct_58 = (({ type : _oidExtensionRequest.__copy__(), value : new Slice<Slice<stdgo.crypto.x509.pkix.Pkix.Extension>>(_extensions) } : T__struct_58)).__copy__();
            var __tmp__ = stdgo.encoding.asn1.Asn1.marshal(Go.toInterface(_attr.__copy__())), _b:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return { _0 : new Slice<GoUInt8>().nil(), _1 : stdgo.errors.Errors.new_((("x509: failed to serialise extensions attribute: " : GoString)) + _err.error()) };
            };
            var _rawValue:stdgo.encoding.asn1.Asn1.RawValue = new stdgo.encoding.asn1.Asn1.RawValue();
            {
                var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_b, Go.toInterface(Go.pointer(_rawValue))), _:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
                };
            };
        ...
        var _tbsCSR:T_tbsCertificateRequest = (({ version : ((0 : GoInt)), subject : (({ fullBytes : _asn1Subject, class_ : 0, tag : 0, isCompound : false, bytes : new Slice<GoUInt8>().nil() } : stdgo.encoding.asn1.Asn1.RawValue)).__copy__(), publicKey : (({ algorithm : _publicKeyAlgorithm.__copy__(), publicKey : (({ bytes : _publicKeyBytes, bitLength : _publicKeyBytes.length * ((8 : GoInt)) } : stdgo.encoding.asn1.Asn1.BitString)).__copy__(), raw : new stdgo.encoding.asn1.Asn1.RawContent() } : T_publicKeyInfo)).__copy__(), rawAttributes : _rawAttributes, raw : new stdgo.encoding.asn1.Asn1.RawContent() } : T_tbsCertificateRequest)).__copy__();
        var __tmp__ = stdgo.encoding.asn1.Asn1.marshal(Go.toInterface(_tbsCSR.__copy__())), _tbsCSRContents:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : _csr, _1 : _err };
        };
        ...
        return stdgo.encoding.asn1.Asn1.marshal(Go.toInterface((({ tbscsr : _tbsCSR.__copy__(), signatureAlgorithm : _sigAlgo.__copy__(), signatureValue : (({ bytes : _signature, bitLength : _signature.length * ((8 : GoInt)) } : stdgo.encoding.asn1.Asn1.BitString)).__copy__(), raw : new stdgo.encoding.asn1.Asn1.RawContent() } : T_certificateRequest)).__copy__()));
    }
/**
...
function parseCertificateRequest(_asn1Data:Slice<GoByte>):{ var _0 : Pointer<CertificateRequest>; var _1 : Error; } {
        ...
        var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_asn1Data, Go.toInterface(Go.pointer(_csr))), _rest:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
...
function _parseCertificateRequest(_in:Pointer<T_certificateRequest>):{ var _0 : Pointer<CertificateRequest>; var _1 : Error; } {
        var _out:Pointer<CertificateRequest> = Go.pointer((({ raw : _in.value.raw.__copy__().__t__, rawTBSCertificateRequest : _in.value.tbscsr.raw.__copy__().__t__, rawSubjectPublicKeyInfo : _in.value.tbscsr.publicKey.raw.__copy__().__t__, rawSubject : _in.value.tbscsr.subject.fullBytes, signature : _in.value.signatureValue.rightAlign(), signatureAlgorithm : _getSignatureAlgorithmFromAI(_in.value.signatureAlgorithm.__copy__()), publicKeyAlgorithm : _getPublicKeyAlgorithmFromOID(_in.value.tbscsr.publicKey.algorithm.algorithm.__copy__()), version : _in.value.tbscsr.version, attributes : _parseRawAttributes(_in.value.tbscsr.rawAttributes), publicKey : ((null : AnyInterface)), subject : new stdgo.crypto.x509.pkix.Pkix.Name(), extensions : new Slice<stdgo.crypto.x509.pkix.Pkix.Extension>().nil(), extraExtensions : new Slice<stdgo.crypto.x509.pkix.Pkix.Extension>().nil(), dnsnames : new Slice<GoString>().nil(), emailAddresses : new Slice<GoString>().nil(), ipaddresses : new Slice<stdgo.net.Net.IP>().nil(), uris : new Slice<Pointer<stdgo.net.url.Url.URL>>().nil() } : CertificateRequest)));
        var _err:Error = ((null : stdgo.Error));
        {
        ...
        {
            var __tmp__ = stdgo.encoding.asn1.Asn1.unmarshal(_in.value.tbscsr.subject.fullBytes, Go.toInterface(Go.pointer(_subject))), _rest:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return { _0 : new Pointer<CertificateRequest>().nil(), _1 : _err };
            } else if (_rest.length != ((0 : GoInt))) {
        ...
        for (_extension in _out.value.extensions) {
...
/**
    ...
    // SubjectKeyId set.
**/
function createRevocationList(_rand:stdgo.io.Io.Reader, _template:Pointer<RevocationList>, _issuer:Pointer<Certificate>, _priv:stdgo.crypto.Crypto.Signer):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        ...
        var __tmp__ = _signingParamsForPublicKey(Go.toInterface(_priv.public_()), _template.value.signatureAlgorithm), _hashFunc:stdgo.crypto.Crypto.Hash = __tmp__._0, _signatureAlgorithm:stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier = __tmp__._1, _err:stdgo.Error = __tmp__._2;
        if (_err != null) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        };
        var _revokedCertsUTC:Slice<stdgo.crypto.x509.pkix.Pkix.RevokedCertificate> = new Slice<stdgo.crypto.x509.pkix.Pkix.RevokedCertificate>(...[for (i in 0 ... ((_template.value.revokedCertificates.length : GoInt)).toBasic()) new stdgo.crypto.x509.pkix.Pkix.RevokedCertificate()]);
        {
            var _i;
            var _rc;
            for (_obj in _template.value.revokedCertificates.keyValueIterator()) {
                _i = _obj.key;
                _rc = _obj.value;
                _rc.revocationTime = _rc.revocationTime.utc().__copy__();
                _revokedCertsUTC[_i] = _rc.__copy__();
        ...
        var __tmp__ = stdgo.encoding.asn1.Asn1.marshal(Go.toInterface((({ id : _issuer.value.subjectKeyId } : T_authKeyId)).__copy__())), _aki:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        };
        var __tmp__ = stdgo.encoding.asn1.Asn1.marshal(Go.toInterface(_template.value.number)), _crlNum:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        };
        var _tbsCertList:stdgo.crypto.x509.pkix.Pkix.TBSCertificateList = (({ version : ((1 : GoInt)), signature : _signatureAlgorithm.__copy__(), issuer : _issuer.value.subject.toRDNSequence().__copy__(), thisUpdate : _template.value.thisUpdate.utc().__copy__(), nextUpdate : new stdgo.time.Time.Time(_template.value.nextUpdate.utc().__copy__().__copy__()), extensions : new Slice<stdgo.crypto.x509.pkix.Pkix.Extension>((({ id : new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidExtensionAuthorityKeyId), value : _aki, critical : false } : stdgo.crypto.x509.pkix.Pkix.Extension)).__copy__(), (({ id : new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidExtensionCRLNumber), value : _crlNum, critical : false } : stdgo.crypto.x509.pkix.Pkix.Extension)).__copy__()), raw : new stdgo.encoding.asn1.Asn1.RawContent(), revokedCertificates : new Slice<stdgo.crypto.x509.pkix.Pkix.RevokedCertificate>().nil() } : stdgo.crypto.x509.pkix.Pkix.TBSCertificateList)).__copy__();
        ...
        var __tmp__ = _priv.sign(_rand, _input, _signerOpts), _signature:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        };
        return stdgo.encoding.asn1.Asn1.marshal(Go.toInterface((({ tbscertList : _tbsCertList.__copy__(), signatureAlgorithm : new stdgo.crypto.x509.pkix.Pkix.AlgorithmIdentifier(_signatureAlgorithm.__copy__().__copy__()), signatureValue : (({ bytes : _signature, bitLength : _signature.length * ((8 : GoInt)) } : stdgo.encoding.asn1.Asn1.BitString)).__copy__() } : stdgo.crypto.x509.pkix.Pkix.CertificateList)).__copy__()));
...
class CertPool_extension_fields {
    ...
    public function _cert(__tmp__, _n:GoInt):{ var _0 : Pointer<Certificate>; var _1 : Error; } return __tmp__._cert(_n);
    public function _copy(__tmp__):Pointer<CertPool> return __tmp__._copy();
    public function _findPotentialParents(__tmp__, _cert:Pointer<Certificate>):Slice<Pointer<Certificate>> return __tmp__._findPotentialParents(_cert);
    public function _contains(__tmp__, _cert:Pointer<Certificate>):Bool return __tmp__._contains(_cert);
    public function addCert(__tmp__, _cert:Pointer<Certificate>):Void __tmp__.addCert(_cert);
    public function _addCertFunc(__tmp__, _rawSum224:T_sum224, _rawSubject:GoString, _getCert:() -> { var _0 : Pointer<Certificate>; var _1 : Error; }):Void __tmp__._addCertFunc(_rawSum224, _rawSubject, _getCert);
    public function appendCertsFromPEM(__tmp__, _pemCerts:Slice<GoByte>):Bool return __tmp__.appendCertsFromPEM(_pemCerts);
    public function subjects(__tmp__):Slice<Slice<GoByte>> return __tmp__.subjects();
}
class T_rfc1423Algo_extension_fields {
    public function _deriveKey(__tmp__, _password:Slice<GoByte>, _salt:Slice<GoByte>):Slice<GoByte> return __tmp__._deriveKey(_password, _salt);
}
...
class SignatureAlgorithm_extension_fields {
    public function _isRSAPSS(__tmp__):Bool return __tmp__._isRSAPSS();
...
class Certificate_extension_fields {
    public function _systemVerify(__tmp__, _opts:Pointer<VerifyOptions>):{ var _0 : Slice<Slice<Pointer<Certificate>>>; var _1 : Error; } return __tmp__._systemVerify(_opts);
    public function _checkNameConstraints(__tmp__, _count:Pointer<GoInt>, _maxConstraintComparisons:GoInt, _nameType:GoString, _name:GoString, _parsedName:AnyInterface, _match:(_parsedName:AnyInterface, _constraint:AnyInterface) -> { var _0 : Bool; var _1 : Error; }, _permitted:AnyInterface, _excluded:AnyInterface):Error return __tmp__._checkNameConstraints(_count, _maxConstraintComparisons, _nameType, _name, _parsedName, _match, _permitted, _excluded);
    public function _isValid(__tmp__, _certType:GoInt, _currentChain:Slice<Pointer<Certificate>>, _opts:Pointer<VerifyOptions>):Error return __tmp__._isValid(_certType, _currentChain, _opts);
    public function verify(__tmp__, _opts:VerifyOptions):{ var _0 : Slice<Slice<Pointer<Certificate>>>; var _1 : Error; } return __tmp__.verify(_opts);
    public function _buildChains(__tmp__, _cache:GoMap<Pointer<Certificate>, Slice<Slice<Pointer<Certificate>>>>, _currentChain:Slice<Pointer<Certificate>>, _sigChecks:Pointer<GoInt>, _opts:Pointer<VerifyOptions>):{ var _0 : Slice<Slice<Pointer<Certificate>>>; var _1 : Error; } return __tmp__._buildChains(_cache, _currentChain, _sigChecks, _opts);
    public function verifyHostname(__tmp__, _h:GoString):Error return __tmp__.verifyHostname(_h);
    public function equal(__tmp__, _other:Pointer<Certificate>):Bool return __tmp__.equal(_other);
    public function _hasSANExtension(__tmp__):Bool return __tmp__._hasSANExtension();
    public function checkSignatureFrom(__tmp__, _parent:Pointer<Certificate>):Error return __tmp__.checkSignatureFrom(_parent);
    public function checkSignature(__tmp__, _algo:SignatureAlgorithm, _signed:Slice<GoByte>, _signature:Slice<GoByte>):Error return __tmp__.checkSignature(_algo, _signed, _signature);
    public function _hasNameConstraints(__tmp__):Bool return __tmp__._hasNameConstraints();
    public function _getSANExtension(__tmp__):Slice<GoByte> return __tmp__._getSANExtension();
    public function checkCRLSignature(__tmp__, _crl:Pointer<stdgo.crypto.x509.pkix.Pkix.CertificateList>):Error return __tmp__.checkCRLSignature(_crl);
    public function createCRL(__tmp__, _rand:stdgo.io.Io.Reader, _priv:AnyInterface, _revokedCerts:Slice<stdgo.crypto.x509.pkix.Pkix.RevokedCertificate>, _now:stdgo.time.Time.Time, _expiry:stdgo.time.Time.Time):{ var _0 : Slice<GoByte>; var _1 : Error; } return __tmp__.createCRL(_rand, _priv, _revokedCerts, _now, _expiry);
}
...
class CertificateRequest_extension_fields {
    public function checkSignature(__tmp__):Error return __tmp__.checkSignature();
}
