...
@:structInit class AlgorithmIdentifier {
	...
	public function new(?algorithm:stdgo.encoding.asn1.Asn1.ObjectIdentifier, ?parameters:stdgo.encoding.asn1.Asn1.RawValue)
...
@:named class RDNSequence {
		...
		var _s:GoString = "";
		{
			...
			Go.cfor(_i < _r.__t__.length, _i++, {
				...
				for (_j => _tv in _rdn.__t__) {
					...
					var __tmp__ = _attributeTypeNames.exists(_oidString) ? {value: _attributeTypeNames[_oidString],
						ok: true} : {value: _attributeTypeNames.defaultValue(), ok: false},
						_typeName:GoString = __tmp__.value,
						_ok:Bool = __tmp__.ok;
					if (!_ok) {
						var __tmp__ = stdgo.encoding.asn1.Asn1.marshal(Go.toInterface(_tv.value)),
					...
					var _escaped:Slice<GoInt32> = new Slice<GoInt32>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoInt32))])
						.setCap(((_valueString.length : GoInt)).toBasic());
	...
	public function __copy__()
		return new RDNSequence(__t__);

	public function __append__(args:haxe.Rest<RelativeDistinguishedNameSET>)
		return new RDNSequence(this.__t__.__append__(...args));

	public function __slice__(low:GoInt, high:GoInt = -1)
		return new RDNSequence(this.__t__.__slice__(low, high));
}
...
@:named class RelativeDistinguishedNameSET {
	...
	public function __copy__()
		return new RelativeDistinguishedNameSET(__t__);

	public function __append__(args:haxe.Rest<AttributeTypeAndValue>)
		return new RelativeDistinguishedNameSET(this.__t__.__append__(...args));

	public function __slice__(low:GoInt, high:GoInt = -1)
		return new RelativeDistinguishedNameSET(this.__t__.__slice__(low, high));
}
...
@:structInit class AttributeTypeAndValue {
	...
	public function new(?type:stdgo.encoding.asn1.Asn1.ObjectIdentifier, ?value:AnyInterface)
		stdgo.internal.Macro.initLocals();
...
@:structInit class AttributeTypeAndValueSET {
	...
	public function new(?type:stdgo.encoding.asn1.Asn1.ObjectIdentifier, ?value:Slice<Slice<AttributeTypeAndValue>>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Extension {
	...
	public function new(?id:stdgo.encoding.asn1.Asn1.ObjectIdentifier, ?critical:Bool, ?value:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Name {
	public function toString():GoString {
		...
		if ((_n.extraNames == null || _n.extraNames.isNil())) {
			for (_ => _atv in _n.names) {
				...
				if (_t.__t__.length == ((4 : GoInt))
					&& _t.__t__[((0 : GoInt))] == ((2 : GoInt))
					&& _t.__t__[((1 : GoInt))] == ((5 : GoInt))
					&& _t.__t__[((2 : GoInt))] == ((4 : GoInt))) {
					if (_t.__t__[((3 : GoInt))] == ((3 : GoInt))
						|| _t.__t__[((3 : GoInt))] == ((5 : GoInt))
						|| _t.__t__[((3 : GoInt))] == ((6 : GoInt))
						|| _t.__t__[((3 : GoInt))] == ((7 : GoInt))
						|| _t.__t__[((3 : GoInt))] == ((8 : GoInt))
						|| _t.__t__[((3 : GoInt))] == ((9 : GoInt))
						|| _t.__t__[((3 : GoInt))] == ((10 : GoInt))
						|| _t.__t__[((3 : GoInt))] == ((11 : GoInt))
						|| _t.__t__[((3 : GoInt))] == ((17 : GoInt))) {
						continue;
					};
				};
	...
	public function toRDNSequence():RDNSequence {
		...
		if (_n.commonName.length > ((0 : GoInt))) {
			_ret = _n._appendRDNs(_ret.__copy__(), new Slice<GoString>(_n.commonName), new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidCommonName))
				.__copy__();
		};
		if (_n.serialNumber.length > ((0 : GoInt))) {
			_ret = _n._appendRDNs(_ret.__copy__(), new Slice<GoString>(_n.serialNumber), new stdgo.encoding.asn1.Asn1.ObjectIdentifier(_oidSerialNumber))
				.__copy__();
		};
	...
	public function _appendRDNs(_in:RDNSequence, _values:Slice<GoString>, _oid:stdgo.encoding.asn1.Asn1.ObjectIdentifier):RDNSequence {
		...
		var _s:Slice<AttributeTypeAndValue> = new Slice<AttributeTypeAndValue>(...[for (i in 0...((_values.length : GoInt))
			.toBasic()) new AttributeTypeAndValue()]);
	...
	public function new(?country:Slice<GoString>, ?organization:Slice<GoString>, ?organizationalUnit:Slice<GoString>, ?locality:Slice<GoString>,
			?province:Slice<GoString>, ?streetAddress:Slice<GoString>, ?postalCode:Slice<GoString>, ?serialNumber:GoString, ?commonName:GoString,
			?names:Slice<AttributeTypeAndValue>, ?extraNames:Slice<AttributeTypeAndValue>)
		stdgo.internal.Macro.initLocals();
	...
	public function __copy__() {
		return new Name(country, organization, organizationalUnit, locality, province, streetAddress, postalCode, serialNumber, commonName, names, extraNames);
	}
...
@:structInit class CertificateList {
	...
	public function new(?tbscertList:TBSCertificateList, ?signatureAlgorithm:AlgorithmIdentifier, ?signatureValue:stdgo.encoding.asn1.Asn1.BitString)
		stdgo.internal.Macro.initLocals();
...
@:structInit class TBSCertificateList {
	...
	public function new(?raw:stdgo.encoding.asn1.Asn1.RawContent, ?version:GoInt, ?signature:AlgorithmIdentifier, ?issuer:RDNSequence,
			?thisUpdate:stdgo.time.Time.Time, ?nextUpdate:stdgo.time.Time.Time, ?revokedCertificates:Slice<RevokedCertificate>, ?extensions:Slice<Extension>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(raw) + " " + Go.string(version) + " " + Go.string(signature) + " " + Go.string(issuer) + " " + Go.string(thisUpdate) + " "
			+ Go.string(nextUpdate) + " " + Go.string(revokedCertificates) + " " + Go.string(extensions) + "}";
	}
...
@:structInit class RevokedCertificate {
	...
	public function new(?serialNumber:Pointer<stdgo.math.big.Big.Int_>, ?revocationTime:stdgo.time.Time.Time, ?extensions:Slice<Extension>)
		stdgo.internal.Macro.initLocals();
...
var _attributeTypeNames:GoMap<GoString, GoString> = new GoMap<GoString,
	...
	{key: "2.5.4.10", value: "O"}, {key: "2.5.4.11", value: "OU"}, {key: "2.5.4.3", value: "CN"}, {key: "2.5.4.5", value: "SERIALNUMBER"},
	{key: "2.5.4.7", value: "L"}, {key: "2.5.4.8", value: "ST"}, {key: "2.5.4.9", value: "STREET"}, {key: "2.5.4.17", value: "POSTALCODE"});
...
class Name_extension_fields {
	public function fillFromRDNSequence(__tmp__, _rdns:Pointer<RDNSequence>):Void
		__tmp__.fillFromRDNSequence(_rdns);

	public function _appendRDNs(__tmp__, _in:RDNSequence, _values:Slice<GoString>, _oid:stdgo.encoding.asn1.Asn1.ObjectIdentifier):RDNSequence
		return __tmp__._appendRDNs(_in, _values, _oid);

	public function toRDNSequence(__tmp__):RDNSequence
		return __tmp__.toRDNSequence();
...
class CertificateList_extension_fields {
	public function hasExpired(__tmp__, _now:stdgo.time.Time.Time):Bool
		return __tmp__.hasExpired(_now);
}
