...
typedef T_decimalDecompose = StructType & {
	public function decompose(_buf:Slice<GoByte>):{
		var _0:GoByte;
		var _1:Bool;
		var _2:Slice<GoByte>;
		var _3:GoInt32;
...
@:structInit class T_ccChecker {
	public function checkNamedValue(_nv:Pointer<stdgo.database.sql.driver.Driver.NamedValue>):Error {
		...
		};
		{
			...
			if (_ok) {
				var __tmp__ = _callValuerValue(_vr),
					_sv:stdgo.database.sql.driver.Driver.Value = __tmp__._0,
		...
		if (!stdgo.database.sql.driver.Driver.isValue(Go.toInterface(_nv.value.value))) {
			return stdgo.fmt.Fmt.errorf("driver ColumnConverter error converted %T to unsupported type %T", Go.toInterface(_arg),
				Go.toInterface(_nv.value.value));
		};
		return ((null : stdgo.Error));
	}
	...
	public function new(?_cci:stdgo.database.sql.driver.Driver.ColumnConverter, ?_want:GoInt)
...
@:structInit class NamedArg {
	...
	public function new(?__Named_Fields_Required:T__struct_44, ?name:GoString, ?value:AnyInterface)
		stdgo.internal.Macro.initLocals();
...
@:named class IsolationLevel {
	...
	public function __copy__()
		return new IsolationLevel(__t__);
}
...
@:structInit class TxOptions {
	...
	public function new(?isolation:IsolationLevel, ?readOnly:Bool)
		stdgo.internal.Macro.initLocals();
...
@:named class RawBytes {
	...
	public function __copy__()
		return new RawBytes(__t__);

	public function __append__(args:haxe.Rest<GoUInt8>)
		return new RawBytes(this.__t__.__append__(...args));

	public function __slice__(low:GoInt, high:GoInt = -1)
		return new RawBytes(this.__t__.__slice__(low, high));
}
...
@:structInit class NullString {
	...
	public function new(?toString:GoString, ?valid:Bool)
		stdgo.internal.Macro.initLocals();
...
@:structInit class NullInt64 {
	...
	public function new(?int64:GoInt64, ?valid:Bool)
		stdgo.internal.Macro.initLocals();
...
@:structInit class NullInt32 {
	...
	public function new(?int32:GoInt32, ?valid:Bool)
		stdgo.internal.Macro.initLocals();
...
@:structInit class NullInt16 {
	...
	public function new(?int16:GoInt16, ?valid:Bool)
		stdgo.internal.Macro.initLocals();
...
@:structInit class NullByte {
	...
	public function new(?byte:GoUInt8, ?valid:Bool)
		stdgo.internal.Macro.initLocals();
...
@:structInit class NullFloat64 {
	...
	public function new(?float64:GoFloat64, ?valid:Bool)
		stdgo.internal.Macro.initLocals();
...
@:structInit class NullBool {
	...
	public function new(?bool:Bool, ?valid:Bool)
		stdgo.internal.Macro.initLocals();
...
@:structInit class NullTime {
	...
	public function new(?time:stdgo.time.Time.Time, ?valid:Bool)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Out {
	...
	public function new(?__Named_Fields_Required:T__struct_44, ?dest:AnyInterface, ?in_:Bool)
		stdgo.internal.Macro.initLocals();
...
@:structInit class DB {
	public function conn(_ctx:stdgo.context.Context.Context):{var _0:Pointer<Conn>; var _1:Error;} {
		...
		var _conn:Pointer<Conn> = Go.pointer((({
			_db: _db,
			_dc: _dc,
			_closemu: new stdgo.sync.Sync.RWMutex(),
			_done: 0
		} : Conn)));
	...
	public function _beginDC(_ctx:stdgo.context.Context.Context, _dc:Pointer<T_driverConn>, _release:Error->Void,
			_opts:Pointer<TxOptions>):{var _0:Pointer<Tx>; var _1:Error;} {
		var _db = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		...
		_tx = Go.pointer((({
			_db: _db,
			_dc: _dc,
			_releaseConn: _release,
			_txi: _txi,
			_cancel: _cancel.__copy__().__t__,
			_keepConnOnRollback: _keepConnOnRollback,
			_ctx: _ctx,
			_closemu: new stdgo.sync.Sync.RWMutex(),
			_done: 0,
			_stmts: {
				mutex: new stdgo.sync.Sync.Mutex(),
				_v: new Slice<Pointer<Stmt>>().nil()
			}
		} : Tx)));
	...
	public function _begin(_ctx:stdgo.context.Context.Context, _opts:Pointer<TxOptions>, _strategy:T_connReuseStrategy):{var _0:Pointer<Tx>; var _1:Error;} {
		...
		var _tx:Pointer<Tx> = new Pointer<Tx>().nil(),
			_err:Error = ((null : stdgo.Error));
		var __tmp__ = _db.value._conn(_ctx, _strategy),
			_dc:Pointer<T_driverConn> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new Pointer<Tx>().nil(), _1: _err};
		};
	...
	public function queryRowContext(_ctx:stdgo.context.Context.Context, _query:GoString, _args:haxe.Rest<AnyInterface>):Pointer<Row> {
		var _db = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _args = new Slice<AnyInterface>(..._args);
		var __tmp__ = _db.value.queryContext(_ctx, _query, ..._args.toArray()),
			_rows:Pointer<Rows> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		return Go.pointer((({_rows: _rows, _err: _err} : Row)));
	}

	public function _queryDC(_ctx:stdgo.context.Context.Context, _txctx:stdgo.context.Context.Context, _dc:Pointer<T_driverConn>, _releaseConn:Error->Void,
			_query:GoString, _args:Slice<AnyInterface>):{var _0:Pointer<Rows>; var _1:Error;
	} {
		var _db = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = try {
		...
		if (_ok) {
			...
			if (Go.toInterface(_err) != Go.toInterface(stdgo.database.sql.driver.Driver.errSkip)) {
				...
				var _rows:Pointer<Rows> = Go.pointer((({
					_dc: _dc,
					_releaseConn: _releaseConn,
					_rowsi: _rowsi,
					_cancel: null,
					_closeStmt: new Pointer<T_driverStmt>().nil(),
					_closemu: new stdgo.sync.Sync.RWMutex(),
					_closed: false,
					_lasterr: ((null : stdgo.Error)),
					_lastcols: new Slice<stdgo.database.sql.driver.Driver.Value>().nil()
				} : Rows)));
		...
		var _ds:Pointer<T_driverStmt> = Go.pointer((({
			locker: _dc.value,
			_si: _si,
			_closed: false,
			_closeErr: ((null : stdgo.Error))
		} : T_driverStmt)));
		var __tmp__ = _rowsiFromStatement(_ctx, _dc.value._ci, _ds, ..._args.toArray()),
			_rowsi:stdgo.database.sql.driver.Driver.Rows = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			_ds.value.close();
			_releaseConn(_err);
	...
	public function _query(_ctx:stdgo.context.Context.Context, _query:GoString, _args:Slice<AnyInterface>,
			_strategy:T_connReuseStrategy):{var _0:Pointer<Rows>; var _1:Error;} {
		var _db = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _db.value._conn(_ctx, _strategy),
			_dc:Pointer<T_driverConn> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
	...
	public function _execDC(_ctx:stdgo.context.Context.Context, _dc:Pointer<T_driverConn>, _release:Error->Void, _query:GoString,
			_args:Slice<AnyInterface>):{var _0:Result; var _1:Error;} {
		var _db = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
	...
	public function _exec(_ctx:stdgo.context.Context.Context, _query:GoString, _args:Slice<AnyInterface>,
			_strategy:T_connReuseStrategy):{var _0:Result; var _1:Error;} {
		var _db = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _db.value._conn(_ctx, _strategy),
			_dc:Pointer<T_driverConn> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
	...
	public function _prepareDC(_ctx:stdgo.context.Context.Context, _dc:Pointer<T_driverConn>, _release:Error->Void, _cg:T_stmtConnGrabber,
			_query:GoString):{var _0:Pointer<Stmt>; var _1:Error;} {
		var _db = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var recover_exception:Error = null;
		var deferstack:Array<Void->Void> = [];
		...
		try {
			...
			var _stmt:Pointer<Stmt> = Go.pointer((({
				_db: _db,
				_query: _query,
				_cg: _cg,
				_cgds: _ds,
				_stickyErr: ((null : stdgo.Error)),
				_closemu: new stdgo.sync.Sync.RWMutex(),
				_parentStmt: new Pointer<Stmt>().nil(),
				_mu: new stdgo.sync.Sync.Mutex(),
				_closed: false,
				_css: new Slice<T_connStmt>().nil(),
				_lastNumClosed: 0
			} : Stmt)));
			if (_cg == null) {
	...
	public function _putConn(_dc:Pointer<T_driverConn>, _err:Error, _resetSession:Bool):Void {
		...
		if (!_dc.value._inUse) {
			...
			if (_debugGetPut) {
				stdgo.fmt.Fmt.printf("putConn(%v) DUPLICATE was: %s\n\nPREVIOUS was: %s", Go.toInterface(_dc), Go.toInterface(_stack()),
					Go.toInterface(_db.value._lastPut[_dc]));
			};
			throw "sql: connection returned that was never out";
		};
		if (Go.toInterface(_err) != Go.toInterface(stdgo.database.sql.driver.Driver.errBadConn)
			&& _dc.value._expired(_db.value._maxLifetime)) {
	...
	public function _conn(_ctx:stdgo.context.Context.Context, _strategy:T_connReuseStrategy):{var _0:Pointer<T_driverConn>; var _1:Error;} {
		...
		_db.value._numOpen++;
		_db.value._mu.unlock();
		var __tmp__ = _db.value._connector.connect(_ctx),
			_ci:stdgo.database.sql.driver.Driver.Conn = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			_db.value._mu.lock();
			_db.value._numOpen--;
		...
		_db.value._mu.lock();
		var _dc:Pointer<T_driverConn> = Go.pointer((({
			_db: _db,
			_createdAt: _nowFunc().__copy__(),
			_returnedAt: _nowFunc().__copy__(),
			_ci: _ci,
			_inUse: true,
			mutex: new stdgo.sync.Sync.Mutex(),
			_needReset: false,
			_closed: false,
			_finalClosed: false,
			_openStmt: new GoMap<Pointer<T_driverStmt>,
				Bool>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("database/sql.driverStmt",
				...
				},
				{
					...
					embedded: false,
					tag: "",
					type: stdgo.reflect.Reflect.GoType.named("database/sql/driver.Stmt", [], stdgo.reflect.Reflect.GoType.interfaceType(false, []))
				},
				{
					name: "_closed",
					embedded: false,
	...
	public function stats():DBStats {
		...
		try {
			...
			deferstack.unshift(() -> _db.value._mu.unlock());
			var _stats:DBStats = (({
				maxOpenConnections: _db.value._maxOpen,
				idle: _db.value._freeConn.length,
				openConnections: _db.value._numOpen,
				inUse: _db.value._numOpen - _db.value._freeConn.length,
				waitCount: _db.value._waitCount,
				waitDuration: new stdgo.time.Time.Duration(_wait),
				maxIdleClosed: _db.value._maxIdleClosed,
				maxIdleTimeClosed: _db.value._maxIdleTimeClosed,
				maxLifetimeClosed: _db.value._maxLifetimeClosed
			} : DBStats)).__copy__();
			{
				for (defer in deferstack) {
					defer();
	...
	public function _startCleanerLocked():Void {
		var _db = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		if ((_db.value._maxLifetime.__t__ > ((0 : GoInt64)) || _db.value._maxIdleTime.__t__ > ((0 : GoInt64)))
			&& _db.value._numOpen > ((0 : GoInt))
			&& _db.value._cleanerCh == null
			|| _db.value._cleanerCh.isNil()) {
	...
	public function setConnMaxIdleTime(_d:stdgo.time.Time.Duration):Void {
		...
		try {
			...
			deferstack.unshift(() -> _db.value._mu.unlock());
			if (_d.__t__ > ((0 : GoInt64))
				&& _d.__t__ < _db.value._maxIdleTime.__t__
				&& _db.value._cleanerCh != null
				&& !_db.value._cleanerCh.isNil()) {
				{
	...
	public function setConnMaxLifetime(_d:stdgo.time.Time.Duration):Void {
		...
		_db.value._mu.lock();
		if (_d.__t__ > ((0 : GoInt64))
			&& _d.__t__ < _db.value._maxLifetime.__t__
			&& _db.value._cleanerCh != null
			&& !_db.value._cleanerCh.isNil()) {
			{
				_db.value._cleanerCh.send(new T__struct_44());
	...
	public function close():Error {
		...
		var _err:Error = ((null : stdgo.Error));
		var _fns:Slice<() -> stdgo.Error> = new Slice<() -> stdgo.Error>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) null])
			.setCap(((_db.value._freeConn.length : GoInt)).toBasic());
	...
	public function _removeDepLocked(_x:T_finalCloser, _dep:AnyInterface):() -> Error {
		var _db = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _db.value._dep.exists(_x) ? {value: _db.value._dep[_x], ok: true} : {value: _db.value._dep.defaultValue(), ok: false},
			_xdep:T_depSet = __tmp__.value,
			_ok:Bool = __tmp__.ok;
		if (!_ok) {
	...
	public function _addDepLocked(_x:T_finalCloser, _dep:AnyInterface):Void {
		...
		if (_db.value._dep == null || _db.value._dep.isNil()) {
			_db.value._dep = new GoMap<T_finalCloser,
				T_depSet>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("database/sql.finalCloser",
					[],
				stdgo.reflect.Reflect.GoType.named("database/sql.finalCloser", [], stdgo.reflect.Reflect.GoType.interfaceType(false, []))),
				stdgo.reflect.Reflect.GoType.named("database/sql.depSet", [],
					stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.interfaceType(true, []),
		...
		if (_xdep.__t__ == null || _xdep.__t__.isNil()) {
			_xdep = new T_depSet(new GoMap<AnyInterface,
				Bool>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.interfaceType(true, []),
					stdgo.reflect.Reflect.GoType.basic(bool_kind))))).__copy__();
	...
	public var _connRequests:GoMap<GoUInt64, Chan<T_connRequest>> = new GoMap<GoUInt64,
		Chan<T_connRequest>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(uint64_kind),
		stdgo.reflect.Reflect.GoType.chanType(0, stdgo.reflect.Reflect.GoType.named("database/sql.connRequest", [], stdgo.reflect.Reflect.GoType.structType([
			{
				name: "_conn",
				embedded: false,
				tag: "",
				type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("database/sql.driverConn", [],
					stdgo.reflect.Reflect.GoType.structType([
						{
							name: "_db",
							embedded: false,
							tag: "",
							type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("database/sql.DB", [],
								stdgo.reflect.Reflect.GoType.named("database/sql.DB", [], stdgo.reflect.Reflect.GoType.structType([
									{
										name: "_waitDuration",
										embedded: false,
										tag: "",
									...
									},
									{
										...
										embedded: false,
										tag: "",
										type: stdgo.reflect.Reflect.GoType.named("database/sql/driver.Connector", [],
									...
									},
									{
										...
										embedded: false,
										tag: "",
										type: stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("database/sql.driverConn",
												[], stdgo.reflect.Reflect.GoType.structType([
											{
												name: "_db",
												embedded: false,
												...
												type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("database/sql.DB", [],
													stdgo.reflect.Reflect.GoType.structType([
														...
														},
														{
															...
															embedded: false,
															tag: "",
															type: stdgo.reflect.Reflect.GoType.named("sync.Mutex", [],
																stdgo.reflect.Reflect.GoType.structType([
																	{
																		name: "_state",
																		embedded: false,
														...
														},
														{
															...
															embedded: false,
															tag: "",
															type: stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(uint64_kind),
																stdgo.reflect.Reflect.GoType.chanType(0,
																	stdgo.reflect.Reflect.GoType.named("database/sql.connRequest", [],
																		stdgo.reflect.Reflect.GoType.structType([
																			{
																				name: "_conn",
																				embedded: false,
																			...
																			},
																			{
																				...
																				embedded: false,
																				tag: "",
																				type: stdgo.reflect.Reflect.GoType.named("error", [],
																					stdgo.reflect.Reflect.GoType.interfaceType(false, []))
																			}
																		]))))
														},
														...
														},
														{
															...
															embedded: false,
															tag: "",
															type: stdgo.reflect.Reflect.GoType.chanType(0, stdgo.reflect.Reflect.GoType.structType([]))
														},
														{
															name: "_closed",
															embedded: false,
														...
														},
														{
															...
															embedded: false,
															tag: "",
															type: stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("database/sql.finalCloser",
																		[],
																stdgo.reflect.Reflect.GoType.named("database/sql.finalCloser", [],
																	stdgo.reflect.Reflect.GoType.interfaceType(false, []))),
																stdgo.reflect.Reflect.GoType.named("database/sql.depSet", [],
																	stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.interfaceType(true, []),
																		stdgo.reflect.Reflect.GoType.basic(bool_kind))))
														},
														{
															...
															embedded: false,
															tag: "",
															type: stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("database/sql.driverConn",
																		[], stdgo.reflect.Reflect.GoType.invalidType)),
														...
														},
														{
															...
															embedded: false,
															tag: "",
															type: stdgo.reflect.Reflect.GoType.named("time.Duration", [],
														...
														{
															name: "_maxIdleTimeClosed",
															embedded: false,
															tag: "",
															type: stdgo.reflect.Reflect.GoType.basic(int64_kind)
														},
														{
															name: "_maxLifetimeClosed",
															embedded: false,
															tag: "",
															type: stdgo.reflect.Reflect.GoType.basic(int64_kind)
														},
											...
											},
											{
												...
												embedded: false,
												tag: "",
												type: stdgo.reflect.Reflect.GoType.named("database/sql/driver.Conn", [],
													stdgo.reflect.Reflect.GoType.interfaceType(false, []))
											},
											{
												name: "_needReset",
											...
											},
											{
												...
												embedded: false,
												tag: "",
												type: stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("database/sql.driverStmt",
															[], stdgo.reflect.Reflect.GoType.structType([
													{
														name: "locker",
														embedded: true,
													...
													},
													{
														...
														embedded: false,
														tag: "",
														type: stdgo.reflect.Reflect.GoType.named("database/sql/driver.Stmt", [],
															stdgo.reflect.Reflect.GoType.interfaceType(false, []))
													},
													{
														name: "_closed",
											...
											},
											{
												...
												embedded: false,
												tag: "",
												type: stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.signature(false, [], [],
													stdgo.reflect.Reflect.GoType.invalidType))
											},
											{
												name: "_dbmuClosed",
									...
									},
									{
										...
										type: stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(uint64_kind),
											stdgo.reflect.Reflect.GoType.chanType(0,
												stdgo.reflect.Reflect.GoType.named("database/sql.connRequest", [], stdgo.reflect.Reflect.GoType.structType([
													{
														name: "_conn",
														embedded: false,
														tag: "",
														type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("database/sql.driverConn",
															...
															},
															{
																...
																embedded: false,
																tag: "",
																type: stdgo.reflect.Reflect.GoType.named("time.Time", [],
																	stdgo.reflect.Reflect.GoType.structType([
																		{
																			name: "_wall",
																			embedded: false,
									...
									},
									{
										...
										embedded: false,
										tag: "",
										type: stdgo.reflect.Reflect.GoType.named("time.Duration", [], stdgo.reflect.Reflect.GoType.basic(int64_kind))
									},
									{
										name: "_maxIdleTime",
										embedded: false,
						...
						},
						{
							...
							embedded: false,
							tag: "",
							type: stdgo.reflect.Reflect.GoType.named("database/sql/driver.Conn", [], stdgo.reflect.Reflect.GoType.interfaceType(false, []))
						},
						{
							name: "_needReset",
							embedded: false,
	...
	public var _dep:GoMap<T_finalCloser, T_depSet> = new GoMap<T_finalCloser,
		T_depSet>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("database/sql.finalCloser", [],
		stdgo.reflect.Reflect.GoType.named("database/sql.finalCloser", [], stdgo.reflect.Reflect.GoType.interfaceType(false, []))),
		stdgo.reflect.Reflect.GoType.named("database/sql.depSet", [],
			stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.interfaceType(true, []),
				stdgo.reflect.Reflect.GoType.basic(bool_kind)))))).nil();
	public var _lastPut:GoMap<Pointer<T_driverConn>, GoString> = new GoMap<Pointer<T_driverConn>,
		GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("database/sql.driverConn",
			[], stdgo.reflect.Reflect.GoType.structType([
		{
			name: "_db",
			embedded: false,
			...
			type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("database/sql.DB", [],
				stdgo.reflect.Reflect.GoType.named("database/sql.DB", [], stdgo.reflect.Reflect.GoType.structType([
					...
					},
					{
						...
						embedded: false,
						tag: "",
						type: stdgo.reflect.Reflect.GoType.named("database/sql/driver.Connector", [], stdgo.reflect.Reflect.GoType.interfaceType(false, []))
					},
					{
						name: "_numClosed",
						embedded: false,
								...
								type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("database/sql.DB", [],
									stdgo.reflect.Reflect.GoType.structType([
										...
										},
										{
											...
											embedded: false,
											tag: "",
											type: stdgo.reflect.Reflect.GoType.named("time.Duration", [], stdgo.reflect.Reflect.GoType.invalidType)
										},
										{
											name: "_cleanerCh",
											embedded: false,
		...
		},
		{
			...
			embedded: false,
			tag: "",
			type: stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType))
		},
		{
			name: "_dbmuClosed",
			embedded: false,
	...
	public function new(?_waitDuration:GoInt64, ?_connector:stdgo.database.sql.driver.Driver.Connector, ?_numClosed:GoUInt64, ?_mu:stdgo.sync.Sync.Mutex,
			?_freeConn:Slice<Pointer<T_driverConn>>, ?_connRequests:GoMap<GoUInt64, Chan<T_connRequest>>, ?_nextRequest:GoUInt64, ?_numOpen:GoInt,
			?_openerCh:Chan<{}>, ?_closed:Bool, ?_dep:GoMap<T_finalCloser, T_depSet>, ?_lastPut:GoMap<Pointer<T_driverConn>, GoString>, ?_maxIdleCount:GoInt,
			?_maxOpen:GoInt, ?_maxLifetime:stdgo.time.Time.Duration, ?_maxIdleTime:stdgo.time.Time.Duration, ?_cleanerCh:Chan<{}>, ?_waitCount:GoInt64,
			?_maxIdleClosed:GoInt64, ?_maxIdleTimeClosed:GoInt64, ?_maxLifetimeClosed:GoInt64, ?_stop:() -> Void)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_waitDuration) + " " + Go.string(_connector) + " " + Go.string(_numClosed) + " " + Go.string(_mu) + " "
			+ Go.string(_freeConn) + " " + Go.string(_connRequests) + " " + Go.string(_nextRequest) + " " + Go.string(_numOpen) + " " + Go.string(_openerCh)
			+ " " + Go.string(_closed) + " " + Go.string(_dep) + " " + Go.string(_lastPut) + " " + Go.string(_maxIdleCount) + " " + Go.string(_maxOpen) + " "
			+ Go.string(_maxLifetime) + " " + Go.string(_maxIdleTime) + " " + Go.string(_cleanerCh) + " " + Go.string(_waitCount) + " "
			+ Go.string(_maxIdleClosed) + " " + Go.string(_maxIdleTimeClosed) + " " + Go.string(_maxLifetimeClosed) + " " + Go.string(_stop) + "}";
	}
	...
	public function __copy__() {
		return new DB(_waitDuration, _connector, _numClosed, _mu, _freeConn, _connRequests, _nextRequest, _numOpen, _openerCh, _closed, _dep, _lastPut,
			_maxIdleCount, _maxOpen, _maxLifetime, _maxIdleTime, _cleanerCh, _waitCount, _maxIdleClosed, _maxIdleTimeClosed, _maxLifetimeClosed, _stop);
	}
...
@:named class T_connReuseStrategy {
	...
	public function __copy__()
		return new T_connReuseStrategy(__t__);
}
...
@:structInit class T_driverConn {
	public function _finalClose():Error {
		...
		_withLock(_dc.value, function():Void {
			_openStmt = new Slice<Pointer<T_driverStmt>>(...[
				for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) new Pointer<T_driverStmt>().nil()
			]).setCap((((_dc.value._openStmt == null ? 0 : _dc.value._openStmt.length) : GoInt)).toBasic());
			{
				var _ds;
			...
			_dc.value._openStmt = new GoMap<Pointer<T_driverStmt>,
				Bool>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("database/sql.driverStmt",
					[], stdgo.reflect.Reflect.GoType.named("database/sql.driverStmt", [], stdgo.reflect.Reflect.GoType.structType([
				{
					name: "locker",
					embedded: true,
					tag: "",
	...
	public function _prepareLocked(_ctx:stdgo.context.Context.Context, _cg:T_stmtConnGrabber, _query:GoString):{var _0:Pointer<T_driverStmt>; var _1:Error;} {
		var _dc = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _ctxDriverPrepare(_ctx, _dc.value._ci, _query),
			_si:stdgo.database.sql.driver.Driver.Stmt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
	...
	public var _openStmt:GoMap<Pointer<T_driverStmt>, Bool> = new GoMap<Pointer<T_driverStmt>,
		Bool>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("database/sql.driverStmt",
			[], stdgo.reflect.Reflect.GoType.structType([
		{
			name: "locker",
	...
	public function new(?_db:Pointer<DB>, ?_createdAt:stdgo.time.Time.Time, ?mutex:stdgo.sync.Sync.Mutex, ?_ci:stdgo.database.sql.driver.Driver.Conn,
			?_needReset:Bool, ?_closed:Bool, ?_finalClosed:Bool, ?_openStmt:GoMap<Pointer<T_driverStmt>, Bool>, ?_inUse:Bool,
			?_returnedAt:stdgo.time.Time.Time, ?_onPut:Slice<() -> Void>, ?_dbmuClosed:Bool)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_db) + " " + Go.string(_createdAt) + " " + Go.string(mutex) + " " + Go.string(_ci) + " " + Go.string(_needReset) + " "
			+ Go.string(_closed) + " " + Go.string(_finalClosed) + " " + Go.string(_openStmt) + " " + Go.string(_inUse) + " " + Go.string(_returnedAt) + " "
			+ Go.string(_onPut) + " " + Go.string(_dbmuClosed) + "}";
	}
	...
	public function __copy__() {
		return new T_driverConn(_db, _createdAt, mutex, _ci, _needReset, _closed, _finalClosed, _openStmt, _inUse, _returnedAt, _onPut, _dbmuClosed);
	}
...
@:structInit class T_driverStmt {
	...
	public function new(?locker:stdgo.sync.Sync.Locker, ?_si:stdgo.database.sql.driver.Driver.Stmt, ?_closed:Bool, ?_closeErr:stdgo.Error)
		stdgo.internal.Macro.initLocals();
...
@:named class T_depSet {
	...
	public function new(?t:GoMap<AnyInterface, Bool>) {
		__t__ = t == null ? new GoMap<AnyInterface,
			Bool>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.interfaceType(true, []),
				stdgo.reflect.Reflect.GoType.basic(bool_kind)))).nil() : t;
	}
...
@:structInit class T_dsnConnector {
	...
	public function new(?_dsn:GoString, ?_driver:stdgo.database.sql.driver.Driver.Driver)
		stdgo.internal.Macro.initLocals();
...
@:structInit class DBStats {
	...
	public function new(?maxOpenConnections:GoInt, ?openConnections:GoInt, ?inUse:GoInt, ?idle:GoInt, ?waitCount:GoInt64,
			?waitDuration:stdgo.time.Time.Duration, ?maxIdleClosed:GoInt64, ?maxIdleTimeClosed:GoInt64, ?maxLifetimeClosed:GoInt64)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(maxOpenConnections) + " " + Go.string(openConnections) + " " + Go.string(inUse) + " " + Go.string(idle) + " "
			+ Go.string(waitCount) + " " + Go.string(waitDuration) + " " + Go.string(maxIdleClosed) + " " + Go.string(maxIdleTimeClosed) + " "
			+ Go.string(maxLifetimeClosed) + "}";
	}
...
@:structInit class T_connRequest {
	...
	public function new(?_conn:Pointer<T_driverConn>, ?_err:stdgo.Error)
		stdgo.internal.Macro.initLocals();
...
@:named class T_releaseConn {
	...
	public function __copy__()
		return new T_releaseConn(__t__);
}
...
@:structInit class Conn {
	...
	public function beginTx(_ctx:stdgo.context.Context.Context, _opts:Pointer<TxOptions>):{var _0:Pointer<Tx>; var _1:Error;} {
		var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _c.value._grabConn(_ctx),
			_dc:Pointer<T_driverConn> = __tmp__._0,
			_release:T_releaseConn = __tmp__._1,
	...
	public function queryRowContext(_ctx:stdgo.context.Context.Context, _query:GoString, _args:haxe.Rest<AnyInterface>):Pointer<Row> {
		var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _args = new Slice<AnyInterface>(..._args);
		var __tmp__ = _c.value.queryContext(_ctx, _query, ..._args.toArray()),
			_rows:Pointer<Rows> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		return Go.pointer((({_rows: _rows, _err: _err} : Row)));
	}
	...
	public function new(?_db:Pointer<DB>, ?_closemu:stdgo.sync.Sync.RWMutex, ?_dc:Pointer<T_driverConn>, ?_done:GoInt32)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Tx {
	...
	public function queryRowContext(_ctx:stdgo.context.Context.Context, _query:GoString, _args:haxe.Rest<AnyInterface>):Pointer<Row> {
		var _tx = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _args = new Slice<AnyInterface>(..._args);
		var __tmp__ = _tx.value.queryContext(_ctx, _query, ..._args.toArray()),
			_rows:Pointer<Rows> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		return Go.pointer((({_rows: _rows, _err: _err} : Row)));
	}
	...
	public function queryContext(_ctx:stdgo.context.Context.Context, _query:GoString, _args:haxe.Rest<AnyInterface>):{var _0:Pointer<Rows>; var _1:Error;} {
		var _tx = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _args = new Slice<AnyInterface>(..._args);
		var __tmp__ = _tx.value._grabConn(_ctx),
			_dc:Pointer<T_driverConn> = __tmp__._0,
			_release:T_releaseConn = __tmp__._1,
			_err:stdgo.Error = __tmp__._2;
		if (_err != null) {
	...
	public function stmtContext(_ctx:stdgo.context.Context.Context, _stmt:Pointer<Stmt>):Pointer<Stmt> {
		...
		try {
			if (_err != null) {
				return Go.pointer((({
					_stickyErr: _err,
					_db: new Pointer<DB>().nil(),
					_query: "",
					_closemu: new stdgo.sync.Sync.RWMutex(),
					_cg: ((null : T_stmtConnGrabber)),
					_cgds: new Pointer<T_driverStmt>().nil(),
					_parentStmt: new Pointer<Stmt>().nil(),
					_mu: new stdgo.sync.Sync.Mutex(),
					_closed: false,
					_css: new Slice<T_connStmt>().nil(),
			...
			if (_tx.value._db != _stmt.value._db) {
				{
					...
					return Go.pointer((({
						_stickyErr: stdgo.errors.Errors.new_("sql: Tx.Stmt: statement from different database used"),
						_db: new Pointer<DB>().nil(),
						_query: "",
						_closemu: new stdgo.sync.Sync.RWMutex(),
						_cg: ((null : T_stmtConnGrabber)),
			...
			var _txs:Pointer<Stmt> = Go.pointer((({
				_db: _tx.value._db,
				_cg: _tx.value,
				_cgds: Go.pointer((({
					locker: _dc.value,
				...
				_parentStmt: _parentStmt,
				_query: _stmt.value._query,
				_stickyErr: ((null : stdgo.Error)),
				_closemu: new stdgo.sync.Sync.RWMutex(),
				_mu: new stdgo.sync.Sync.Mutex(),
				_closed: false,
	...
	public function prepareContext(_ctx:stdgo.context.Context.Context, _query:GoString):{var _0:Pointer<Stmt>; var _1:Error;} {
		...
		var __tmp__ = _tx.value._db.value._prepareDC(_ctx, _dc, _release.__copy__().__t__, _tx.value, _query),
			_stmt:Pointer<Stmt> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new Pointer<Stmt>().nil(), _1: _err};
		};
	...
	public function new(?_db:Pointer<DB>, ?_closemu:stdgo.sync.Sync.RWMutex, ?_dc:Pointer<T_driverConn>, ?_txi:stdgo.database.sql.driver.Driver.Tx,
			?_releaseConn:stdgo.Error->Void, ?_done:GoInt32, ?_keepConnOnRollback:Bool, ?_stmts:T__struct_45, ?_cancel:() -> Void,
			?_ctx:stdgo.context.Context.Context)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_db) + " " + Go.string(_closemu) + " " + Go.string(_dc) + " " + Go.string(_txi) + " " + Go.string(_releaseConn) + " "
			+ Go.string(_done) + " " + Go.string(_keepConnOnRollback) + " " + Go.string(_stmts) + " " + Go.string(_cancel) + " " + Go.string(_ctx) + "}";
	}
...
@:structInit class T_connStmt {
	...
	public function new(?_dc:Pointer<T_driverConn>, ?_ds:Pointer<T_driverStmt>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Stmt {
	...
	public function queryRowContext(_ctx:stdgo.context.Context.Context, _args:haxe.Rest<AnyInterface>):Pointer<Row> {
		var _s = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _args = new Slice<AnyInterface>(..._args);
		var __tmp__ = _s.value.queryContext(_ctx, ..._args.toArray()),
			_rows:Pointer<Rows> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
		...
		try {
			...
			var _strategy:T_connReuseStrategy = _cachedOrNewConn;
			{
				...
				Go.cfor(_i < _maxBadConnRetries + ((1 : GoUnTypedInt)), _i++, {
					...
					var __tmp__ = _s.value._connStmt(_ctx, _strategy),
						_dc:Pointer<T_driverConn> = __tmp__._0,
						_releaseConn:stdgo.Error->Void = __tmp__._1,
						_ds:Pointer<T_driverStmt> = __tmp__._2,
	...
	public function _prepareOnConnLocked(_ctx:stdgo.context.Context.Context, _dc:Pointer<T_driverConn>):{var _0:Pointer<T_driverStmt>; var _1:Error;} {
		var _s = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _dc.value._prepareLocked(_ctx, _s.value._cg, _s.value._query),
			_si:Pointer<T_driverStmt> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new Pointer<T_driverStmt>().nil(), _1: _err};
		};
	...
	public function _connStmt(_ctx:stdgo.context.Context.Context, _strategy:T_connReuseStrategy):{
		var _0:Pointer<T_driverConn>;
		var _1:Error->Void;
		var _2:Pointer<T_driverStmt>;
		var _3:Error;
	} {
		var _s = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _dc:Pointer<T_driverConn> = new Pointer<T_driverConn>().nil(),
			_releaseConn:Error->Void = null,
			_ds:Pointer<T_driverStmt> = new Pointer<T_driverStmt>().nil(),
			_err:Error = ((null : stdgo.Error));
		{
		...
		if (_err != null) {
			return {
				_0: new Pointer<T_driverConn>().nil(),
				_1: null,
				_2: new Pointer<T_driverStmt>().nil(),
				_3: _err
			};
		};
		_s.value._mu.lock();
	...
	public function new(?_db:Pointer<DB>, ?_query:GoString, ?_stickyErr:stdgo.Error, ?_closemu:stdgo.sync.Sync.RWMutex, ?_cg:T_stmtConnGrabber,
			?_cgds:Pointer<T_driverStmt>, ?_parentStmt:Pointer<Stmt>, ?_mu:stdgo.sync.Sync.Mutex, ?_closed:Bool, ?_css:Slice<T_connStmt>,
			?_lastNumClosed:GoUInt64)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_db) + " " + Go.string(_query) + " " + Go.string(_stickyErr) + " " + Go.string(_closemu) + " " + Go.string(_cg) + " "
			+ Go.string(_cgds) + " " + Go.string(_parentStmt) + " " + Go.string(_mu) + " " + Go.string(_closed) + " " + Go.string(_css) + " "
			+ Go.string(_lastNumClosed) + "}";
	}
	...
	public function __copy__() {
		return new Stmt(_db, _query, _stickyErr, _closemu, _cg, _cgds, _parentStmt, _mu, _closed, _css, _lastNumClosed);
	}
...
@:structInit class Rows {
	...
	public function scan(_dest:haxe.Rest<AnyInterface>):Error {
		...
		if (_dest.length != _rs.value._lastcols.length) {
			return stdgo.fmt.Fmt.errorf("sql: expected %d destination arguments in Scan, not %d", Go.toInterface(_rs.value._lastcols.length),
				Go.toInterface(_dest.length));
		};
		{
			var _i;
			var _sv;
			for (_obj in _rs.value._lastcols.keyValueIterator()) {
				...
				if (_err != null) {
					return stdgo.fmt.Fmt.errorf("sql: Scan error on column index %d, name %q: %w", Go.toInterface(_i),
						Go.toInterface(_rs.value._rowsi.columns()[_i]), Go.toInterface(_err));
				};
			};
		};
		return ((null : stdgo.Error));
	...
	public function _nextLocked():{var _0:Bool; var _1:Bool;} {
		...
		try {
			...
			deferstack.unshift(() -> _rs.value._dc.value.unlock());
			if (_rs.value._lastcols == null || _rs.value._lastcols.isNil()) {
				_rs.value._lastcols = new Slice<stdgo.database.sql.driver.Driver.Value>(...[
					for (i in 0...((_rs.value._rowsi.columns().length : GoInt)).toBasic()) ((null : stdgo.database.sql.driver.Driver.Value))
				]);
			};
	...
	public function new(?_dc:Pointer<T_driverConn>, ?_releaseConn:stdgo.Error->Void, ?_rowsi:stdgo.database.sql.driver.Driver.Rows, ?_cancel:() -> Void,
			?_closeStmt:Pointer<T_driverStmt>, ?_closemu:stdgo.sync.Sync.RWMutex, ?_closed:Bool, ?_lasterr:stdgo.Error,
			?_lastcols:Slice<stdgo.database.sql.driver.Driver.Value>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_dc) + " " + Go.string(_releaseConn) + " " + Go.string(_rowsi) + " " + Go.string(_cancel) + " " + Go.string(_closeStmt) + " "
			+ Go.string(_closemu) + " " + Go.string(_closed) + " " + Go.string(_lasterr) + " " + Go.string(_lastcols) + "}";
	}
...
@:structInit class ColumnType {
	...
	public function decimalSize():{var _0:GoInt64; var _1:GoInt64; var _2:Bool;} {
		var _ci = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _precision:GoInt64 = ((0 : GoInt64)),
			_scale:GoInt64 = ((0 : GoInt64)),
			_ok:Bool = false;
	...
	public function new(?_name:GoString, ?_hasNullable:Bool, ?_hasLength:Bool, ?_hasPrecisionScale:Bool, ?_nullable:Bool, ?_length:GoInt64,
			?_databaseType:GoString, ?_precision:GoInt64, ?_scale:GoInt64, ?_scanType:stdgo.reflect.Reflect.Type)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_name) + " " + Go.string(_hasNullable) + " " + Go.string(_hasLength) + " " + Go.string(_hasPrecisionScale) + " "
			+ Go.string(_nullable) + " " + Go.string(_length) + " " + Go.string(_databaseType) + " " + Go.string(_precision) + " " + Go.string(_scale) + " "
			+ Go.string(_scanType) + "}";
	}
...
@:structInit class Row {
	...
	public function new(?_err:stdgo.Error, ?_rows:Pointer<Rows>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_driverResult {
	...
	public function new(?locker:stdgo.sync.Sync.Locker, ?_resi:stdgo.database.sql.driver.Driver.Result)
		stdgo.internal.Macro.initLocals();
...
@:structInit @:local class T__struct_45 {
	...
	public function new(?mutex:stdgo.sync.Sync.Mutex, ?_v:Slice<Pointer<Stmt>>)
		stdgo.internal.Macro.initLocals();
...
var _valuerReflectType:stdgo.reflect.Reflect.Type = stdgo.reflect.Reflect.typeOf(Go.toInterface(((new Pointer<stdgo.database.sql.driver.Driver.Valuer>()
	.nil() : Pointer<stdgo.database.sql.driver.Driver.Valuer>))))
	.elem();
...
var _drivers:GoMap<GoString, stdgo.database.sql.driver.Driver.Driver> = new GoMap<GoString,
	stdgo.database.sql.driver.Driver.Driver>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
	stdgo.reflect.Reflect.GoType.named("database/sql/driver.Driver", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])))));
...
function _validateNamedValueName(_name:GoString):Error {
	...
	var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRuneInString(_name),
...
/**
	...
	// ci must be locked.
**/
function _driverArgsConnLocked(_ci:stdgo.database.sql.driver.Driver.Conn, _ds:Pointer<T_driverStmt>,
		_args:Slice<AnyInterface>):{var _0:Slice<stdgo.database.sql.driver.Driver.NamedValue>; var _1:Error;} {
	return stdgo.internal.Macro.controlFlow({
		var _nvargs:Slice<stdgo.database.sql.driver.Driver.NamedValue> = new Slice<stdgo.database.sql.driver.Driver.NamedValue>(...[
			for (i in 0...((_args.length : GoInt)).toBasic()) new stdgo.database.sql.driver.Driver.NamedValue()
		]);
		...
		for (_arg in _args) {
			...
			if (_err == null) {
				...
				return {_0: new Slice<stdgo.database.sql.driver.Driver.NamedValue>().nil(), _1: stdgo.fmt.Fmt.errorf("sql: converting argument %s type: %v",
					Go.toInterface(_describeNamedValue(_nv)), Go.toInterface(_err))};
			};
		};
		if (_want != -((1 : GoUnTypedInt)) && _nvargs.length != _want) {
			return {_0: new Slice<stdgo.database.sql.driver.Driver.NamedValue>().nil(), _1: stdgo.fmt.Fmt.errorf("sql: expected %d arguments, got %d",
				Go.toInterface(_want), Go.toInterface(_nvargs.length))};
		};
...
function _convertAssignRows(_dest:AnyInterface, _src:AnyInterface, _rows:Pointer<Rows>):Error {
	if (Go.assertable(((_src : GoString)))) {
		...
		if (Go.assertable(((_dest : Pointer<GoString>)))) {
			...
			var _d:Pointer<Slice<GoUInt8>> = _dest == null ? null : _dest.__underlying__() == null ? null : _dest == null ? null : _dest.__underlying__()
				.value;
			if (_d == null || _d.isNil()) {
				return _errNilPtr;
			};
		...
		if (Go.assertable(((_dest : Pointer<stdgo.time.Time.Time>)))) {
			var _d:Pointer<stdgo.time.Time.Time> = _dest == null ? null : _dest.__underlying__() == null ? null : _dest == null ? null : _dest.__underlying__()
				.value;
		...
		var _s:stdgo.database.sql.driver.Driver.Rows = _src == null ? null : _src.__underlying__() == null ? null : _src == null ? null : _src.__underlying__()
			.value;
	...
	if (Go.assertable(((_dest : Pointer<GoString>)))) {
		...
		if (_sv.kind().__t__ == stdgo.reflect.Reflect.bool.__t__
			|| _sv.kind().__t__ == stdgo.reflect.Reflect.int.__t__
			|| _sv.kind().__t__ == stdgo.reflect.Reflect.int8.__t__
			|| _sv.kind().__t__ == stdgo.reflect.Reflect.int16.__t__
			|| _sv.kind().__t__ == stdgo.reflect.Reflect.int32.__t__
			|| _sv.kind().__t__ == stdgo.reflect.Reflect.int64.__t__
			|| _sv.kind().__t__ == stdgo.reflect.Reflect.uint.__t__
			|| _sv.kind().__t__ == stdgo.reflect.Reflect.uint8.__t__
			|| _sv.kind().__t__ == stdgo.reflect.Reflect.uint16.__t__
			|| _sv.kind().__t__ == stdgo.reflect.Reflect.uint32.__t__
			|| _sv.kind().__t__ == stdgo.reflect.Reflect.uint64.__t__
			|| _sv.kind().__t__ == stdgo.reflect.Reflect.float32.__t__
			|| _sv.kind().__t__ == stdgo.reflect.Reflect.float64.__t__) {
		...
		_sv = stdgo.reflect.Reflect.valueOf(Go.toInterface(_src)).__copy__();
		{
			var __tmp__ = _asBytes(new Slice<GoUInt8>().nil(), _sv.__copy__()),
		...
		_sv = stdgo.reflect.Reflect.valueOf(Go.toInterface(_src)).__copy__();
		{
			var __tmp__ = _asBytes(_d.value.__t__.__slice__(0, ((0 : GoInt))), _sv.__copy__()),
				_b:Slice<GoUInt8> = __tmp__._0,
				_ok:Bool = __tmp__._1;
			if (_ok) {
		...
		var __tmp__ = stdgo.database.sql.driver.Driver.bool.convertValue(Go.toInterface(_src)),
			_bv:stdgo.database.sql.driver.Driver.Value = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err == null) {
	...
	if (_dv.kind().__t__ == stdgo.reflect.Reflect.ptr.__t__) {
	...
	} else if (_dv.kind().__t__ == stdgo.reflect.Reflect.int.__t__
		|| _dv.kind().__t__ == stdgo.reflect.Reflect.int8.__t__
		|| _dv.kind().__t__ == stdgo.reflect.Reflect.int16.__t__
		|| _dv.kind().__t__ == stdgo.reflect.Reflect.int32.__t__
		|| _dv.kind().__t__ == stdgo.reflect.Reflect.int64.__t__) {
		if (_src == null) {
		...
		var __tmp__ = stdgo.strconv.Strconv.parseInt(_s, ((10 : GoInt)), _dv.type().bits()),
			_i64:GoInt64 = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			_err = _strconvErr(_err);
			return stdgo.fmt.Fmt.errorf("converting driver.Value type %T (%q) to a %s: %v", Go.toInterface(_src), Go.toInterface(_s),
				Go.toInterface(_dv.kind()), Go.toInterface(_err));
		};
		_dv.setInt(_i64);
		return ((null : stdgo.Error));
	} else if (_dv.kind().__t__ == stdgo.reflect.Reflect.uint.__t__
		|| _dv.kind().__t__ == stdgo.reflect.Reflect.uint8.__t__
		|| _dv.kind().__t__ == stdgo.reflect.Reflect.uint16.__t__
		|| _dv.kind().__t__ == stdgo.reflect.Reflect.uint32.__t__
		|| _dv.kind().__t__ == stdgo.reflect.Reflect.uint64.__t__) {
		if (_src == null) {
			return stdgo.fmt.Fmt.errorf("converting NULL to %s is unsupported", Go.toInterface(_dv.kind()));
		};
		var _s:GoString = _asString(Go.toInterface(_src));
		var __tmp__ = stdgo.strconv.Strconv.parseUint(_s, ((10 : GoInt)), _dv.type().bits()),
			_u64:GoUInt64 = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			_err = _strconvErr(_err);
			return stdgo.fmt.Fmt.errorf("converting driver.Value type %T (%q) to a %s: %v", Go.toInterface(_src), Go.toInterface(_s),
		...
		var _s:GoString = _asString(Go.toInterface(_src));
		var __tmp__ = stdgo.strconv.Strconv.parseFloat(_s, _dv.type().bits()),
...
function _asString(_src:AnyInterface):GoString {
	...
	if (_rv.kind().__t__ == stdgo.reflect.Reflect.int.__t__
		|| _rv.kind().__t__ == stdgo.reflect.Reflect.int8.__t__
		|| _rv.kind().__t__ == stdgo.reflect.Reflect.int16.__t__
		|| _rv.kind().__t__ == stdgo.reflect.Reflect.int32.__t__
		|| _rv.kind().__t__ == stdgo.reflect.Reflect.int64.__t__) {
		return stdgo.strconv.Strconv.formatInt(_rv.int(), ((10 : GoInt)));
	} else if (_rv.kind().__t__ == stdgo.reflect.Reflect.uint.__t__
		|| _rv.kind().__t__ == stdgo.reflect.Reflect.uint8.__t__
		|| _rv.kind().__t__ == stdgo.reflect.Reflect.uint16.__t__
		|| _rv.kind().__t__ == stdgo.reflect.Reflect.uint32.__t__
		|| _rv.kind().__t__ == stdgo.reflect.Reflect.uint64.__t__) {
...
function _callValuerValue(_vr:stdgo.database.sql.driver.Driver.Valuer):{var _0:stdgo.database.sql.driver.Driver.Value; var _1:Error;} {
	var _v:stdgo.database.sql.driver.Driver.Value = ((null : stdgo.database.sql.driver.Driver.Value)),
		_err:Error = ((null : stdgo.Error));
	{
...
function _ctxDriverPrepare(_ctx:stdgo.context.Context.Context, _ci:stdgo.database.sql.driver.Driver.Conn,
		_query:GoString):{var _0:stdgo.database.sql.driver.Driver.Stmt; var _1:Error;} {
	{
		var __tmp__ = try {
	...
	var __tmp__ = _ci.prepare(_query),
		_si:stdgo.database.sql.driver.Driver.Stmt = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err == null) {
		{
...
function _ctxDriverExec(_ctx:stdgo.context.Context.Context, _execerCtx:stdgo.database.sql.driver.Driver.ExecerContext,
		_execer:stdgo.database.sql.driver.Driver.Execer, _query:GoString, _nvdargs:Slice<stdgo.database.sql.driver.Driver.NamedValue>):{
	var _0:stdgo.database.sql.driver.Driver.Result;
	var _1:Error;
} {
	if (_execerCtx != null) {
		return _execerCtx.execContext(_ctx, _query, _nvdargs);
	};
	var __tmp__ = _namedValueToValue(_nvdargs),
		_dargs:Slice<stdgo.database.sql.driver.Driver.Value> = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
...
function _ctxDriverQuery(_ctx:stdgo.context.Context.Context, _queryerCtx:stdgo.database.sql.driver.Driver.QueryerContext,
		_queryer:stdgo.database.sql.driver.Driver.Queryer, _query:GoString, _nvdargs:Slice<stdgo.database.sql.driver.Driver.NamedValue>):{
	var _0:stdgo.database.sql.driver.Driver.Rows;
	var _1:Error;
} {
	if (_queryerCtx != null) {
...
function _ctxDriverStmtExec(_ctx:stdgo.context.Context.Context, _si:stdgo.database.sql.driver.Driver.Stmt,
		_nvdargs:Slice<stdgo.database.sql.driver.Driver.NamedValue>):{
	var _0:stdgo.database.sql.driver.Driver.Result;
	var _1:Error;
} {
	{
...
function _ctxDriverStmtQuery(_ctx:stdgo.context.Context.Context, _si:stdgo.database.sql.driver.Driver.Stmt,
		_nvdargs:Slice<stdgo.database.sql.driver.Driver.NamedValue>):{
	var _0:stdgo.database.sql.driver.Driver.Rows;
	var _1:Error;
} {
...
function _ctxDriverBegin(_ctx:stdgo.context.Context.Context, _opts:Pointer<TxOptions>,
		_ci:stdgo.database.sql.driver.Driver.Conn):{var _0:stdgo.database.sql.driver.Driver.Tx; var _1:Error;} {
	{
		var __tmp__ = try {
	...
	if (_opts != null && !_opts.isNil()) {
		if (_opts.value.isolation.__t__ != levelDefault.__t__) {
			return {_0: ((null : stdgo.database.sql.driver.Driver.Tx)),
				_1: stdgo.errors.Errors.new_("sql: driver does not support non-default isolation level")};
		};
	...
	var __tmp__ = _ci.begin(),
		_txi:stdgo.database.sql.driver.Driver.Tx = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err == null) {
		{
			null;
...
function _namedValueToValue(_named:Slice<stdgo.database.sql.driver.Driver.NamedValue>):{var _0:Slice<stdgo.database.sql.driver.Driver.Value>; var _1:Error;} {
	var _dargs:Slice<stdgo.database.sql.driver.Driver.Value> = new Slice<stdgo.database.sql.driver.Driver.Value>(...[
		for (i in 0...((_named.length : GoInt)).toBasic()) ((null : stdgo.database.sql.driver.Driver.Value))
	]);
	{
		var _n;
		var _param;
		for (_obj in _named.keyValueIterator()) {
			...
			if (_param.name.length > ((0 : GoInt))) {
				return {_0: new Slice<stdgo.database.sql.driver.Driver.Value>().nil(),
					_1: stdgo.errors.Errors.new_("sql: driver does not support the use of Named Parameters")};
			};
...
function register(_name:GoString, _driver:stdgo.database.sql.driver.Driver.Driver):Void {
	...
	try {
		...
		{
			var __tmp__ = _drivers.exists(_name) ? {value: _drivers[_name], ok: true} : {value: _drivers.defaultValue(), ok: false},
				_:stdgo.database.sql.driver.Driver.Driver = __tmp__.value,
				_dup:Bool = __tmp__.ok;
			if (_dup) {
...
function drivers():Slice<GoString> {
	...
	try {
		...
		var _list:Slice<GoString> = new Slice<GoString>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) (("" : GoString))])
			.setCap((((_drivers == null ? 0 : _drivers.length) : GoInt)).toBasic());
		{
			var _name;
...
function openDB(_c:stdgo.database.sql.driver.Driver.Connector):Pointer<DB> {
	var __tmp__ = stdgo.context.Context.withCancel(stdgo.context.Context.background()),
		_ctx:stdgo.context.Context.Context = __tmp__._0,
		_cancel:stdgo.context.Context.CancelFunc = __tmp__._1;
	var _db:Pointer<DB> = Go.pointer((({
		_connector: _c,
		_openerCh: new Chan<T__struct_44>(((_connectionRequestQueueSize : GoInt)).toBasic(), () -> new T__struct_44()),
		_lastPut: new GoMap<Pointer<T_driverConn>,
			GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("database/sql.driverConn",
				[],
			stdgo.reflect.Reflect.GoType.named("database/sql.driverConn", [],
				stdgo.reflect.Reflect.GoType.structType([
					{
						name: "_db",
						embedded: false,
			...
			stdgo.reflect.Reflect.GoType.basic(string_kind)))),
		_connRequests: new GoMap<GoUInt64,
			Chan<T_connRequest>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(uint64_kind),
			stdgo.reflect.Reflect.GoType.chanType(0,
				stdgo.reflect.Reflect.GoType.named("database/sql.connRequest", [],
					stdgo.reflect.Reflect.GoType.named("database/sql.connRequest", [],
						stdgo.reflect.Reflect.GoType.structType([
							{
								...
								tag: "",
								type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("database/sql.driverConn", [],
									stdgo.reflect.Reflect.GoType.named("database/sql.driverConn", [], stdgo.reflect.Reflect.GoType.structType([
										{
											name: "_db",
											embedded: false,
											tag: "",
		...
		_stop: _cancel.__copy__().__t__,
		_waitDuration: 0,
		_numClosed: 0,
		_mu: new stdgo.sync.Sync.Mutex(),
		_freeConn: new Slice<Pointer<T_driverConn>>().nil(),
		_nextRequest: 0,
		_numOpen: 0,
		_closed: false,
		_dep: new GoMap<T_finalCloser,
			T_depSet>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("database/sql.finalCloser", [],
			stdgo.reflect.Reflect.GoType.named("database/sql.finalCloser", [], stdgo.reflect.Reflect.GoType.interfaceType(false, []))),
			stdgo.reflect.Reflect.GoType.named("database/sql.depSet", [],
				stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.interfaceType(true, []),
		...
		_maxIdleCount: 0,
		_maxOpen: 0,
		_maxLifetime: new stdgo.time.Time.Duration(),
		_maxIdleTime: new stdgo.time.Time.Duration(),
		_cleanerCh: new Chan<{}>(0, () -> null, true),
		_waitCount: 0,
		_maxIdleClosed: 0,
		_maxIdleTimeClosed: 0,
		_maxLifetimeClosed: 0
	} : DB)));
...
function open(_driverName:GoString, _dataSourceName:GoString):{var _0:Pointer<DB>; var _1:Error;} {
	_driversMu.rlock();
	var __tmp__ = _drivers.exists(_driverName) ? {value: _drivers[_driverName], ok: true} : {value: _drivers.defaultValue(), ok: false},
		_driveri:stdgo.database.sql.driver.Driver.Driver = __tmp__.value,
		_ok:Bool = __tmp__.ok;
	_driversMu.runlock();
	if (!_ok) {
	...
	};
	{
		...
		if (_ok) {
			var __tmp__ = _driverCtx.openConnector(_dataSourceName),
				_connector:stdgo.database.sql.driver.Driver.Connector = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
...
function _resultFromStatement(_ctx:stdgo.context.Context.Context, _ci:stdgo.database.sql.driver.Driver.Conn, _ds:Pointer<T_driverStmt>,
		_args:haxe.Rest<AnyInterface>):{var _0:Result; var _1:Error;
} {
	var _args = new Slice<AnyInterface>(..._args);
	var recover_exception:Error = null;
	var deferstack:Array<Void->Void> = [];
	...
	deferstack.unshift(() -> _ds.value.unlock());
	try {
		var __tmp__ = _driverArgsConnLocked(_ci, _ds, _args),
			_dargs:Slice<stdgo.database.sql.driver.Driver.NamedValue> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			{
				for (defer in deferstack) {
		...
		var __tmp__ = _ctxDriverStmtExec(_ctx, _ds.value._si, _dargs),
			_resi:stdgo.database.sql.driver.Driver.Result = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			{
				for (defer in deferstack) {
...
function _rowsiFromStatement(_ctx:stdgo.context.Context.Context, _ci:stdgo.database.sql.driver.Driver.Conn, _ds:Pointer<T_driverStmt>,
		_args:haxe.Rest<AnyInterface>):{
	var _0:stdgo.database.sql.driver.Driver.Rows;
	var _1:Error;
} {
	var _args = new Slice<AnyInterface>(..._args);
...
function _rowsColumnInfoSetupConnLocked(_rowsi:stdgo.database.sql.driver.Driver.Rows):Slice<Pointer<ColumnType>> {
	...
	var _list:Slice<Pointer<ColumnType>> = new Slice<Pointer<ColumnType>>(...[
		for (i in 0...((_names.length : GoInt)).toBasic()) new Pointer<ColumnType>().nil()
	]);
	{
		var _i;
		for (_obj in _list.keyValueIterator()) {
			_i = _obj.key;
			var _ci:Pointer<ColumnType> = Go.pointer((({
				_name: _names[_i],
				_hasNullable: false,
				_hasLength: false,
				_hasPrecisionScale: false,
				_nullable: false,
				_length: 0,
				_databaseType: "",
				_precision: 0,
				_scale: 0,
				_scanType: ((null : stdgo.reflect.Reflect.Type))
			} : ColumnType)));
			_list[_i] = _ci;
			{
				var __tmp__ = try {
...
class T_ccChecker_extension_fields {
	public function checkNamedValue(__tmp__, _nv:Pointer<stdgo.database.sql.driver.Driver.NamedValue>):Error
		return __tmp__.checkNamedValue(_nv);
}
...
class NullString_extension_fields {
	public function scan(__tmp__, _value:AnyInterface):Error
		return __tmp__.scan(_value);

	public function value(__tmp__):{var _0:stdgo.database.sql.driver.Driver.Value; var _1:Error;}
		return __tmp__.value();
}
...
class DB_extension_fields {
	public function _addDep(__tmp__, _x:T_finalCloser, _dep:AnyInterface):Void
		__tmp__._addDep(_x, _dep);

	public function _addDepLocked(__tmp__, _x:T_finalCloser, _dep:AnyInterface):Void
		__tmp__._addDepLocked(_x, _dep);

	public function _removeDep(__tmp__, _x:T_finalCloser, _dep:AnyInterface):Error
		return __tmp__._removeDep(_x, _dep);

	public function _removeDepLocked(__tmp__, _x:T_finalCloser, _dep:AnyInterface):() -> Error
		return __tmp__._removeDepLocked(_x, _dep);

	public function _pingDC(__tmp__, _ctx:stdgo.context.Context.Context, _dc:Pointer<T_driverConn>, _release:Error->Void):Error
		return __tmp__._pingDC(_ctx, _dc, _release);

	public function pingContext(__tmp__, _ctx:stdgo.context.Context.Context):Error
		return __tmp__.pingContext(_ctx);

	public function ping(__tmp__):Error
		return __tmp__.ping();

	public function close(__tmp__):Error
		return __tmp__.close();

	public function _maxIdleConnsLocked(__tmp__):GoInt
		return __tmp__._maxIdleConnsLocked();

	public function _shortestIdleTimeLocked(__tmp__):stdgo.time.Time.Duration
		return __tmp__._shortestIdleTimeLocked();

	public function setMaxIdleConns(__tmp__, _n:GoInt):Void
		__tmp__.setMaxIdleConns(_n);

	public function setMaxOpenConns(__tmp__, _n:GoInt):Void
		__tmp__.setMaxOpenConns(_n);

	public function setConnMaxLifetime(__tmp__, _d:stdgo.time.Time.Duration):Void
		__tmp__.setConnMaxLifetime(_d);

	public function setConnMaxIdleTime(__tmp__, _d:stdgo.time.Time.Duration):Void
		__tmp__.setConnMaxIdleTime(_d);

	public function _startCleanerLocked(__tmp__):Void
		__tmp__._startCleanerLocked();

	public function _connectionCleaner(__tmp__, _d:stdgo.time.Time.Duration):Void
		__tmp__._connectionCleaner(_d);

	public function _connectionCleanerRunLocked(__tmp__):Slice<Pointer<T_driverConn>>
		return __tmp__._connectionCleanerRunLocked();

	public function stats(__tmp__):DBStats
		return __tmp__.stats();

	public function _maybeOpenNewConnections(__tmp__):Void
		__tmp__._maybeOpenNewConnections();

	public function _connectionOpener(__tmp__, _ctx:stdgo.context.Context.Context):Void
		__tmp__._connectionOpener(_ctx);

	public function _openNewConnection(__tmp__, _ctx:stdgo.context.Context.Context):Void
		__tmp__._openNewConnection(_ctx);

	public function _nextRequestKeyLocked(__tmp__):GoUInt64
		return __tmp__._nextRequestKeyLocked();

	public function _conn(__tmp__, _ctx:stdgo.context.Context.Context, _strategy:T_connReuseStrategy):{var _0:Pointer<T_driverConn>; var _1:Error;}
		return __tmp__._conn(_ctx, _strategy);

	public function _noteUnusedDriverStatement(__tmp__, _c:Pointer<T_driverConn>, _ds:Pointer<T_driverStmt>):Void
		__tmp__._noteUnusedDriverStatement(_c, _ds);

	public function _putConn(__tmp__, _dc:Pointer<T_driverConn>, _err:Error, _resetSession:Bool):Void
		__tmp__._putConn(_dc, _err, _resetSession);

	public function _putConnDBLocked(__tmp__, _dc:Pointer<T_driverConn>, _err:Error):Bool
		return __tmp__._putConnDBLocked(_dc, _err);

	public function prepareContext(__tmp__, _ctx:stdgo.context.Context.Context, _query:GoString):{var _0:Pointer<Stmt>; var _1:Error;}
		return __tmp__.prepareContext(_ctx, _query);

	public function prepare(__tmp__, _query:GoString):{var _0:Pointer<Stmt>; var _1:Error;}
		return __tmp__.prepare(_query);

	public function _prepare(__tmp__, _ctx:stdgo.context.Context.Context, _query:GoString, _strategy:T_connReuseStrategy):{var _0:Pointer<Stmt>; var _1:Error;}
		return __tmp__._prepare(_ctx, _query, _strategy);

	public function _prepareDC(__tmp__, _ctx:stdgo.context.Context.Context, _dc:Pointer<T_driverConn>, _release:Error->Void, _cg:T_stmtConnGrabber,
			_query:GoString):{var _0:Pointer<Stmt>; var _1:Error;
	}
		return __tmp__._prepareDC(_ctx, _dc, _release, _cg, _query);

	public function execContext(__tmp__, _ctx:stdgo.context.Context.Context, _query:GoString, _args:haxe.Rest<AnyInterface>):{var _0:Result; var _1:Error;}
		return __tmp__.execContext(_ctx, _query, _args);

	public function exec(__tmp__, _query:GoString, _args:haxe.Rest<AnyInterface>):{var _0:Result; var _1:Error;}
		return __tmp__.exec(_query, _args);

	public function _exec(__tmp__, _ctx:stdgo.context.Context.Context, _query:GoString, _args:Slice<AnyInterface>,
			_strategy:T_connReuseStrategy):{var _0:Result; var _1:Error;}
		return __tmp__._exec(_ctx, _query, _args, _strategy);

	public function _execDC(__tmp__, _ctx:stdgo.context.Context.Context, _dc:Pointer<T_driverConn>, _release:Error->Void, _query:GoString,
			_args:Slice<AnyInterface>):{var _0:Result; var _1:Error;
	}
		return __tmp__._execDC(_ctx, _dc, _release, _query, _args);

	public function queryContext(__tmp__, _ctx:stdgo.context.Context.Context, _query:GoString,
			_args:haxe.Rest<AnyInterface>):{var _0:Pointer<Rows>; var _1:Error;}
		return __tmp__.queryContext(_ctx, _query, _args);

	public function query(__tmp__, _query:GoString, _args:haxe.Rest<AnyInterface>):{var _0:Pointer<Rows>; var _1:Error;}
		return __tmp__.query(_query, _args);

	public function _query(__tmp__, _ctx:stdgo.context.Context.Context, _query:GoString, _args:Slice<AnyInterface>,
			_strategy:T_connReuseStrategy):{var _0:Pointer<Rows>; var _1:Error;}
		return __tmp__._query(_ctx, _query, _args, _strategy);

	public function _queryDC(__tmp__, _ctx:stdgo.context.Context.Context, _txctx:stdgo.context.Context.Context, _dc:Pointer<T_driverConn>,
			_releaseConn:Error->Void, _query:GoString, _args:Slice<AnyInterface>):{var _0:Pointer<Rows>; var _1:Error;
	}
		return __tmp__._queryDC(_ctx, _txctx, _dc, _releaseConn, _query, _args);

	public function queryRowContext(__tmp__, _ctx:stdgo.context.Context.Context, _query:GoString, _args:haxe.Rest<AnyInterface>):Pointer<Row>
		return __tmp__.queryRowContext(_ctx, _query, _args);

	public function queryRow(__tmp__, _query:GoString, _args:haxe.Rest<AnyInterface>):Pointer<Row>
		return __tmp__.queryRow(_query, _args);

	public function beginTx(__tmp__, _ctx:stdgo.context.Context.Context, _opts:Pointer<TxOptions>):{var _0:Pointer<Tx>; var _1:Error;}
		return __tmp__.beginTx(_ctx, _opts);

	public function begin(__tmp__):{var _0:Pointer<Tx>; var _1:Error;}
		return __tmp__.begin();

	public function _begin(__tmp__, _ctx:stdgo.context.Context.Context, _opts:Pointer<TxOptions>,
			_strategy:T_connReuseStrategy):{var _0:Pointer<Tx>; var _1:Error;}
		return __tmp__._begin(_ctx, _opts, _strategy);

	public function _beginDC(__tmp__, _ctx:stdgo.context.Context.Context, _dc:Pointer<T_driverConn>, _release:Error->Void,
			_opts:Pointer<TxOptions>):{var _0:Pointer<Tx>; var _1:Error;}
		return __tmp__._beginDC(_ctx, _dc, _release, _opts);

	public function driver(__tmp__):stdgo.database.sql.driver.Driver.Driver
		return __tmp__.driver();

	public function conn(__tmp__, _ctx:stdgo.context.Context.Context):{var _0:Pointer<Conn>; var _1:Error;}
		return __tmp__.conn(_ctx);
}

class T_driverConn_extension_fields {
	public function _releaseConn(__tmp__, _err:Error):Void
		__tmp__._releaseConn(_err);

	public function _removeOpenStmt(__tmp__, _ds:Pointer<T_driverStmt>):Void
		__tmp__._removeOpenStmt(_ds);

	public function _expired(__tmp__, _timeout:stdgo.time.Time.Duration):Bool
		return __tmp__._expired(_timeout);

	public function _resetSession(__tmp__, _ctx:stdgo.context.Context.Context):Error
		return __tmp__._resetSession(_ctx);

	public function _validateConnection(__tmp__, _needsReset:Bool):Bool
		return __tmp__._validateConnection(_needsReset);

	public function _prepareLocked(__tmp__, _ctx:stdgo.context.Context.Context, _cg:T_stmtConnGrabber,
			_query:GoString):{var _0:Pointer<T_driverStmt>; var _1:Error;}
		return __tmp__._prepareLocked(_ctx, _cg, _query);

	public function _closeDBLocked(__tmp__):() -> Error
		return __tmp__._closeDBLocked();

	public function close(__tmp__):Error
		return __tmp__.close();

	public function _finalClose(__tmp__):Error
		return __tmp__._finalClose();
}
...
class T_dsnConnector_extension_fields {
	public function connect(__tmp__, _:stdgo.context.Context.Context):{var _0:stdgo.database.sql.driver.Driver.Conn; var _1:Error;}
		return __tmp__.connect(_);
...
class Conn_extension_fields {
	...
	public function raw(__tmp__, _f:(_driverConn:AnyInterface) -> Error):Error
		return __tmp__.raw(_f);

	public function beginTx(__tmp__, _ctx:stdgo.context.Context.Context, _opts:Pointer<TxOptions>):{var _0:Pointer<Tx>; var _1:Error;}
		return __tmp__.beginTx(_ctx, _opts);

	public function _closemuRUnlockCondReleaseConn(__tmp__, _err:Error):Void
		__tmp__._closemuRUnlockCondReleaseConn(_err);

	public function _txCtx(__tmp__):stdgo.context.Context.Context
		return __tmp__._txCtx();

	public function _close(__tmp__, _err:Error):Error
		return __tmp__._close(_err);
...
class Tx_extension_fields {
	public function _awaitDone(__tmp__):Void
		__tmp__._awaitDone();

	public function _isDone(__tmp__):Bool
		return __tmp__._isDone();

	public function _close(__tmp__, _err:Error):Void
		__tmp__._close(_err);

	public function _grabConn(__tmp__, _ctx:stdgo.context.Context.Context):{var _0:Pointer<T_driverConn>; var _1:T_releaseConn; var _2:Error;}
		return __tmp__._grabConn(_ctx);
	...
	public function commit(__tmp__):Error
		return __tmp__.commit();

	public function _rollback(__tmp__, _discardConn:Bool):Error
		return __tmp__._rollback(_discardConn);

	public function rollback(__tmp__):Error
		return __tmp__.rollback();
	...
	public function stmtContext(__tmp__, _ctx:stdgo.context.Context.Context, _stmt:Pointer<Stmt>):Pointer<Stmt>
		return __tmp__.stmtContext(_ctx, _stmt);

	public function stmt(__tmp__, _stmt:Pointer<Stmt>):Pointer<Stmt>
		return __tmp__.stmt(_stmt);
...
class Stmt_extension_fields {
	public function execContext(__tmp__, _ctx:stdgo.context.Context.Context, _args:haxe.Rest<AnyInterface>):{var _0:Result; var _1:Error;}
		return __tmp__.execContext(_ctx, _args);

	public function exec(__tmp__, _args:haxe.Rest<AnyInterface>):{var _0:Result; var _1:Error;}
		return __tmp__.exec(_args);

	public function _removeClosedStmtLocked(__tmp__):Void
		__tmp__._removeClosedStmtLocked();

	public function _connStmt(__tmp__, _ctx:stdgo.context.Context.Context, _strategy:T_connReuseStrategy):{
		var _0:Pointer<T_driverConn>;
		var _1:Error->Void;
		var _2:Pointer<T_driverStmt>;
		var _3:Error;
	}
		return __tmp__._connStmt(_ctx, _strategy);

	public function _prepareOnConnLocked(__tmp__, _ctx:stdgo.context.Context.Context, _dc:Pointer<T_driverConn>):{var _0:Pointer<T_driverStmt>; var _1:Error;}
		return __tmp__._prepareOnConnLocked(_ctx, _dc);

	public function queryContext(__tmp__, _ctx:stdgo.context.Context.Context, _args:haxe.Rest<AnyInterface>):{var _0:Pointer<Rows>; var _1:Error;}
		return __tmp__.queryContext(_ctx, _args);

	public function query(__tmp__, _args:haxe.Rest<AnyInterface>):{var _0:Pointer<Rows>; var _1:Error;}
		return __tmp__.query(_args);

	public function queryRowContext(__tmp__, _ctx:stdgo.context.Context.Context, _args:haxe.Rest<AnyInterface>):Pointer<Row>
		return __tmp__.queryRowContext(_ctx, _args);

	public function queryRow(__tmp__, _args:haxe.Rest<AnyInterface>):Pointer<Row>
		return __tmp__.queryRow(_args);
...
class Rows_extension_fields {
	public function _lasterrOrErrLocked(__tmp__, _err:Error):Error
		return __tmp__._lasterrOrErrLocked(_err);

	public function _initContextClose(__tmp__, _ctx:stdgo.context.Context.Context, _txctx:stdgo.context.Context.Context):Void
		__tmp__._initContextClose(_ctx, _txctx);

	public function _awaitDone(__tmp__, _ctx:stdgo.context.Context.Context, _txctx:stdgo.context.Context.Context):Void
		__tmp__._awaitDone(_ctx, _txctx);

	public function next(__tmp__):Bool
		return __tmp__.next();

	public function _nextLocked(__tmp__):{var _0:Bool; var _1:Bool;}
		return __tmp__._nextLocked();

	public function nextResultSet(__tmp__):Bool
		return __tmp__.nextResultSet();

	public function err(__tmp__):Error
		return __tmp__.err();

	public function columns(__tmp__):{var _0:Slice<GoString>; var _1:Error;}
		return __tmp__.columns();

	public function columnTypes(__tmp__):{var _0:Slice<Pointer<ColumnType>>; var _1:Error;}
		return __tmp__.columnTypes();

	public function scan(__tmp__, _dest:haxe.Rest<AnyInterface>):Error
		return __tmp__.scan(_dest);
...
class ColumnType_extension_fields {
	...
	public function length(__tmp__):{var _0:GoInt64; var _1:Bool;}
		return __tmp__.length();

	public function decimalSize(__tmp__):{var _0:GoInt64; var _1:GoInt64; var _2:Bool;}
		return __tmp__.decimalSize();

	public function scanType(__tmp__):stdgo.reflect.Reflect.Type
		return __tmp__.scanType();

	public function nullable(__tmp__):{var _0:Bool; var _1:Bool;}
		return __tmp__.nullable();

	public function databaseTypeName(__tmp__):GoString
		return __tmp__.databaseTypeName();
}
...
class T_driverResult_extension_fields {
	public function lastInsertId(__tmp__):{var _0:GoInt64; var _1:Error;}
		return __tmp__.lastInsertId();

	public function rowsAffected(__tmp__):{var _0:GoInt64; var _1:Error;}
		return __tmp__.rowsAffected();
}
