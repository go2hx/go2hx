...
@:structInit @:using(stdgo.debug.dwarf.Dwarf.T_buf_static_extension) abstract T_buf(stdgo._internal.debug.dwarf.Dwarf_T_buf.T_buf) from stdgo._internal.debug.dwarf.Dwarf_T_buf.T_buf to stdgo._internal.debug.dwarf.Dwarf_T_buf.T_buf {
    ...
    public function new(?_dwarf:Data, ?_order:stdgo._internal.encoding.binary.Binary_ByteOrder.ByteOrder, ?_format:T_dataFormat, ?_name:String, ?_off:Offset, ?_data:Array<std.UInt>, ?_err:stdgo.Error) this = new stdgo._internal.debug.dwarf.Dwarf_T_buf.T_buf(_dwarf, _order, _format, _name, _off, ([for (i in _data) i] : stdgo.Slice<stdgo.GoUInt8>), _err);
...
@:structInit @:using(stdgo.debug.dwarf.Dwarf.DecodeError_static_extension) abstract DecodeError(stdgo._internal.debug.dwarf.Dwarf_DecodeError.DecodeError) from stdgo._internal.debug.dwarf.Dwarf_DecodeError.DecodeError to stdgo._internal.debug.dwarf.Dwarf_DecodeError.DecodeError {
    ...
    public function new(?name:String, ?offset:Offset, ?err:String) this = new stdgo._internal.debug.dwarf.Dwarf_DecodeError.DecodeError(name, offset, err);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_abbrev(stdgo._internal.debug.dwarf.Dwarf_T_abbrev.T_abbrev) from stdgo._internal.debug.dwarf.Dwarf_T_abbrev.T_abbrev to stdgo._internal.debug.dwarf.Dwarf_T_abbrev.T_abbrev {
...
@:structInit abstract T_afield(stdgo._internal.debug.dwarf.Dwarf_T_afield.T_afield) from stdgo._internal.debug.dwarf.Dwarf_T_afield.T_afield to stdgo._internal.debug.dwarf.Dwarf_T_afield.T_afield {
    ...
    public function new(?_attr:Attr, ?_fmt:T_format, ?_class:Class_, ?_val:haxe.Int64) this = new stdgo._internal.debug.dwarf.Dwarf_T_afield.T_afield(_attr, _fmt, _class, _val);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
@:structInit abstract Field(stdgo._internal.debug.dwarf.Dwarf_Field.Field) from stdgo._internal.debug.dwarf.Dwarf_Field.Field to stdgo._internal.debug.dwarf.Dwarf_Field.Field {
    ...
    public function new(?attr:Attr, ?val:stdgo.AnyInterface, ?class_:Class_) this = new stdgo._internal.debug.dwarf.Dwarf_Field.Field(attr, val, class_);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.debug.dwarf.Dwarf.Reader_static_extension) abstract Reader(stdgo._internal.debug.dwarf.Dwarf_Reader.Reader) from stdgo._internal.debug.dwarf.Dwarf_Reader.Reader to stdgo._internal.debug.dwarf.Dwarf_Reader.Reader {
    ...
    public function new(?_b:T_buf, ?_d:Data, ?_err:stdgo.Error, ?_unit:StdTypes.Int, ?_lastUnit:Bool, ?_lastChildren:Bool, ?_lastSibling:Offset, ?_cu:Entry) this = new stdgo._internal.debug.dwarf.Dwarf_Reader.Reader(_b, _d, _err, _unit, _lastUnit, _lastChildren, _lastSibling, _cu);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.debug.dwarf.Dwarf.LineReader_static_extension) abstract LineReader(stdgo._internal.debug.dwarf.Dwarf_LineReader.LineReader) from stdgo._internal.debug.dwarf.Dwarf_LineReader.LineReader to stdgo._internal.debug.dwarf.Dwarf_LineReader.LineReader {
    ...
    function set__section(v:Array<std.UInt>):Array<std.UInt> {
        this._section = ([for (i in v) i] : stdgo.Slice<stdgo.GoUInt8>);
        return v;
    }
    ...
    function set__lineStr(v:Array<std.UInt>):Array<std.UInt> {
        this._lineStr = ([for (i in v) i] : stdgo.Slice<stdgo.GoUInt8>);
        return v;
    }
    ...
    function set__opcodeLengths(v:Array<StdTypes.Int>):Array<StdTypes.Int> {
        this._opcodeLengths = ([for (i in v) i] : stdgo.Slice<stdgo.GoInt>);
        return v;
    }
    ...
    function set__directories(v:Array<String>):Array<String> {
        this._directories = ([for (i in v) i] : stdgo.Slice<stdgo.GoString>);
        return v;
    }
    ...
    function set__fileEntries(v:Array<LineFile>):Array<LineFile> {
        this._fileEntries = ([for (i in v) i] : stdgo.Slice<stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_LineFile.LineFile>>);
        return v;
    }
...
_buf,
([for (i in _section) i] : stdgo.Slice<stdgo.GoUInt8>),
([for (i in _str) i] : stdgo.Slice<stdgo.GoUInt8>),
([for (i in _lineStr) i] : stdgo.Slice<stdgo.GoUInt8>),
_version,
_addrsize,
...
_lineRange,
_opcodeBase,
([for (i in _opcodeLengths) i] : stdgo.Slice<stdgo.GoInt>),
([for (i in _directories) i] : stdgo.Slice<stdgo.GoString>),
([for (i in _fileEntries) i] : stdgo.Slice<stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_LineFile.LineFile>>),
_programOffset,
_endOffset,
_initialFileEntries,
_state,
...
@:structInit abstract LineEntry(stdgo._internal.debug.dwarf.Dwarf_LineEntry.LineEntry) from stdgo._internal.debug.dwarf.Dwarf_LineEntry.LineEntry to stdgo._internal.debug.dwarf.Dwarf_LineEntry.LineEntry {
...
@:structInit abstract LineFile(stdgo._internal.debug.dwarf.Dwarf_LineFile.LineFile) from stdgo._internal.debug.dwarf.Dwarf_LineFile.LineFile to stdgo._internal.debug.dwarf.Dwarf_LineFile.LineFile {
    public var name(get, set) : String;
    function get_name():String return this.name;
    function set_name(v:String):String {
        this.name = v;
    ...
    public function new(?name:String, ?mtime:haxe.UInt64, ?length_:StdTypes.Int) this = new stdgo._internal.debug.dwarf.Dwarf_LineFile.LineFile(name, mtime, length_);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_lnctForm(stdgo._internal.debug.dwarf.Dwarf_T_lnctForm.T_lnctForm) from stdgo._internal.debug.dwarf.Dwarf_T_lnctForm.T_lnctForm to stdgo._internal.debug.dwarf.Dwarf_T_lnctForm.T_lnctForm {
    ...
    public function new(?_lnct:StdTypes.Int, ?_form:T_format) this = new stdgo._internal.debug.dwarf.Dwarf_T_lnctForm.T_lnctForm(_lnct, _form);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract LineReaderPos(stdgo._internal.debug.dwarf.Dwarf_LineReaderPos.LineReaderPos) from stdgo._internal.debug.dwarf.Dwarf_LineReaderPos.LineReaderPos to stdgo._internal.debug.dwarf.Dwarf_LineReaderPos.LineReaderPos {
    public var _off(get, set) : Offset;
    function get__off():Offset return this._off;
    function set__off(v:Offset):Offset {
        this._off = v;
    ...
    public function new(?_off:Offset, ?_numFileEntries:StdTypes.Int, ?_state:LineEntry, ?_fileIndex:StdTypes.Int) this = new stdgo._internal.debug.dwarf.Dwarf_LineReaderPos.LineReaderPos(_off, _numFileEntries, _state, _fileIndex);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.debug.dwarf.Dwarf.Data_static_extension) abstract Data(stdgo._internal.debug.dwarf.Dwarf_Data.Data) from stdgo._internal.debug.dwarf.Dwarf_Data.Data to stdgo._internal.debug.dwarf.Dwarf_Data.Data {
    ...
    function set__abbrev(v:Array<std.UInt>):Array<std.UInt> {
        this._abbrev = ([for (i in v) i] : stdgo.Slice<stdgo.GoUInt8>);
        return v;
    }
    ...
    function set__aranges(v:Array<std.UInt>):Array<std.UInt> {
        this._aranges = ([for (i in v) i] : stdgo.Slice<stdgo.GoUInt8>);
        return v;
    }
    ...
    function set__frame(v:Array<std.UInt>):Array<std.UInt> {
        this._frame = ([for (i in v) i] : stdgo.Slice<stdgo.GoUInt8>);
        return v;
    }
    ...
    function set__info(v:Array<std.UInt>):Array<std.UInt> {
        this._info = ([for (i in v) i] : stdgo.Slice<stdgo.GoUInt8>);
        return v;
    }
    ...
    function set__pubnames(v:Array<std.UInt>):Array<std.UInt> {
        this._pubnames = ([for (i in v) i] : stdgo.Slice<stdgo.GoUInt8>);
        return v;
    }
    ...
    function set__ranges(v:Array<std.UInt>):Array<std.UInt> {
        this._ranges = ([for (i in v) i] : stdgo.Slice<stdgo.GoUInt8>);
        return v;
    }
    public var _str(get, set) : Array<std.UInt>;
    function get__str():Array<std.UInt> return [for (i in this._str) i];
    ...
    function set__addr(v:Array<std.UInt>):Array<std.UInt> {
        this._addr = ([for (i in v) i] : stdgo.Slice<stdgo.GoUInt8>);
        return v;
    }
    public var _lineStr(get, set) : Array<std.UInt>;
    function get__lineStr():Array<std.UInt> return [for (i in this._lineStr) i];
    ...
    function set__strOffsets(v:Array<std.UInt>):Array<std.UInt> {
        this._strOffsets = ([for (i in v) i] : stdgo.Slice<stdgo.GoUInt8>);
        return v;
    }
    ...
    function set__rngLists(v:Array<std.UInt>):Array<std.UInt> {
        this._rngLists = ([for (i in v) i] : stdgo.Slice<stdgo.GoUInt8>);
        return v;
    }
...
([for (i in _abbrev) i] : stdgo.Slice<stdgo.GoUInt8>),
([for (i in _aranges) i] : stdgo.Slice<stdgo.GoUInt8>),
([for (i in _frame) i] : stdgo.Slice<stdgo.GoUInt8>),
([for (i in _info) i] : stdgo.Slice<stdgo.GoUInt8>),
([for (i in _line) i] : stdgo.Slice<stdgo.GoUInt8>),
([for (i in _pubnames) i] : stdgo.Slice<stdgo.GoUInt8>),
([for (i in _ranges) i] : stdgo.Slice<stdgo.GoUInt8>),
([for (i in _str) i] : stdgo.Slice<stdgo.GoUInt8>),
([for (i in _addr) i] : stdgo.Slice<stdgo.GoUInt8>),
([for (i in _lineStr) i] : stdgo.Slice<stdgo.GoUInt8>),
([for (i in _strOffsets) i] : stdgo.Slice<stdgo.GoUInt8>),
([for (i in _rngLists) i] : stdgo.Slice<stdgo.GoUInt8>),
_abbrevCache,
_bigEndian,
_order,
_typeCache,
...
@:structInit @:using(stdgo.debug.dwarf.Dwarf.CommonType_static_extension) abstract CommonType(stdgo._internal.debug.dwarf.Dwarf_CommonType.CommonType) from stdgo._internal.debug.dwarf.Dwarf_CommonType.CommonType to stdgo._internal.debug.dwarf.Dwarf_CommonType.CommonType {
    ...
    public function new(?byteSize:haxe.Int64, ?name:String) this = new stdgo._internal.debug.dwarf.Dwarf_CommonType.CommonType(byteSize, name);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.debug.dwarf.Dwarf.BasicType_static_extension) abstract BasicType(stdgo._internal.debug.dwarf.Dwarf_BasicType.BasicType) from stdgo._internal.debug.dwarf.Dwarf_BasicType.BasicType to stdgo._internal.debug.dwarf.Dwarf_BasicType.BasicType {
    ...
    function set_dataBitOffset(v:haxe.Int64):haxe.Int64 {
        this.dataBitOffset = v;
        return v;
    }
    public function new(?commonType:CommonType, ?bitSize:haxe.Int64, ?bitOffset:haxe.Int64, ?dataBitOffset:haxe.Int64) this = new stdgo._internal.debug.dwarf.Dwarf_BasicType.BasicType(commonType, bitSize, bitOffset, dataBitOffset);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
@:structInit @:using(stdgo.debug.dwarf.Dwarf.QualType_static_extension) abstract QualType(stdgo._internal.debug.dwarf.Dwarf_QualType.QualType) from stdgo._internal.debug.dwarf.Dwarf_QualType.QualType to stdgo._internal.debug.dwarf.Dwarf_QualType.QualType {
    ...
    public function new(?commonType:CommonType, ?qual:String, ?type:Type_) this = new stdgo._internal.debug.dwarf.Dwarf_QualType.QualType(commonType, qual, type);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.debug.dwarf.Dwarf.ArrayType_static_extension) abstract ArrayType(stdgo._internal.debug.dwarf.Dwarf_ArrayType.ArrayType) from stdgo._internal.debug.dwarf.Dwarf_ArrayType.ArrayType to stdgo._internal.debug.dwarf.Dwarf_ArrayType.ArrayType {
    ...
    public function new(?commonType:CommonType, ?type:Type_, ?strideBitSize:haxe.Int64, ?count:haxe.Int64) this = new stdgo._internal.debug.dwarf.Dwarf_ArrayType.ArrayType(commonType, type, strideBitSize, count);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
@:structInit @:using(stdgo.debug.dwarf.Dwarf.StructType_static_extension) abstract StructType(stdgo._internal.debug.dwarf.Dwarf_StructType.StructType) from stdgo._internal.debug.dwarf.Dwarf_StructType.StructType to stdgo._internal.debug.dwarf.Dwarf_StructType.StructType {
    ...
    function set_field(v:Array<StructField>):Array<StructField> {
        this.field = ([for (i in v) i] : stdgo.Slice<stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_StructField.StructField>>);
        return v;
    }
    ...
    public function new(?commonType:CommonType, ?structName:String, ?kind:String, ?field:Array<StructField>, ?incomplete:Bool) this = new stdgo._internal.debug.dwarf.Dwarf_StructType.StructType(commonType, structName, kind, ([for (i in field) i] : stdgo.Slice<stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_StructField.StructField>>), incomplete);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.debug.dwarf.Dwarf.StructField_static_extension) abstract StructField(stdgo._internal.debug.dwarf.Dwarf_StructField.StructField) from stdgo._internal.debug.dwarf.Dwarf_StructField.StructField to stdgo._internal.debug.dwarf.Dwarf_StructField.StructField {
    ...
    public function new(?name:String, ?type:Type_, ?byteOffset:haxe.Int64, ?byteSize:haxe.Int64, ?bitOffset:haxe.Int64, ?dataBitOffset:haxe.Int64, ?bitSize:haxe.Int64) this = new stdgo._internal.debug.dwarf.Dwarf_StructField.StructField(name, type, byteOffset, byteSize, bitOffset, dataBitOffset, bitSize);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.debug.dwarf.Dwarf.EnumType_static_extension) abstract EnumType(stdgo._internal.debug.dwarf.Dwarf_EnumType.EnumType) from stdgo._internal.debug.dwarf.Dwarf_EnumType.EnumType to stdgo._internal.debug.dwarf.Dwarf_EnumType.EnumType {
    ...
    function set_val(v:Array<EnumValue_>):Array<EnumValue_> {
        this.val = ([for (i in v) i] : stdgo.Slice<stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_EnumValue_.EnumValue_>>);
        return v;
    }
    public function new(?commonType:CommonType, ?enumName:String, ?val:Array<EnumValue_>) this = new stdgo._internal.debug.dwarf.Dwarf_EnumType.EnumType(commonType, enumName, ([for (i in val) i] : stdgo.Slice<stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_EnumValue_.EnumValue_>>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract EnumValue_(stdgo._internal.debug.dwarf.Dwarf_EnumValue_.EnumValue_) from stdgo._internal.debug.dwarf.Dwarf_EnumValue_.EnumValue_ to stdgo._internal.debug.dwarf.Dwarf_EnumValue_.EnumValue_ {
    public var name(get, set) : String;
    function get_name():String return this.name;
    function set_name(v:String):String {
        this.name = v;
    ...
    public function new(?name:String, ?val:haxe.Int64) this = new stdgo._internal.debug.dwarf.Dwarf_EnumValue_.EnumValue_(name, val);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
@:structInit @:using(stdgo.debug.dwarf.Dwarf.T_typeFixer_static_extension) abstract T_typeFixer(stdgo._internal.debug.dwarf.Dwarf_T_typeFixer.T_typeFixer) from stdgo._internal.debug.dwarf.Dwarf_T_typeFixer.T_typeFixer to stdgo._internal.debug.dwarf.Dwarf_T_typeFixer.T_typeFixer {
    ...
    function set__typedefs(v:Array<TypedefType>):Array<TypedefType> {
        this._typedefs = ([for (i in v) i] : stdgo.Slice<stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_TypedefType.TypedefType>>);
        return v;
    }
    ...
    function set__arraytypes(v:Array<Type_>):Array<Type_> {
        this._arraytypes = ([for (i in v) i] : stdgo.Slice<stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_Type_.Type_>>);
        return v;
    }
    public function new(?_typedefs:Array<TypedefType>, ?_arraytypes:Array<Type_>) this = new stdgo._internal.debug.dwarf.Dwarf_T_typeFixer.T_typeFixer(([for (i in _typedefs) i] : stdgo.Slice<stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_TypedefType.TypedefType>>), ([for (i in _arraytypes) i] : stdgo.Slice<stdgo.Ref<stdgo._internal.debug.dwarf.Dwarf_Type_.Type_>>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.debug.dwarf.Dwarf.T_typeUnit_static_extension) abstract T_typeUnit(stdgo._internal.debug.dwarf.Dwarf_T_typeUnit.T_typeUnit) from stdgo._internal.debug.dwarf.Dwarf_T_typeUnit.T_typeUnit to stdgo._internal.debug.dwarf.Dwarf_T_typeUnit.T_typeUnit {
    ...
    public function new(?_unit:T_unit, ?_toff:Offset, ?_name:String, ?_cache:Type_) this = new stdgo._internal.debug.dwarf.Dwarf_T_typeUnit.T_typeUnit(_unit, _toff, _name, _cache);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.debug.dwarf.Dwarf.T_typeUnitReader_static_extension) abstract T_typeUnitReader(stdgo._internal.debug.dwarf.Dwarf_T_typeUnitReader.T_typeUnitReader) from stdgo._internal.debug.dwarf.Dwarf_T_typeUnitReader.T_typeUnitReader to stdgo._internal.debug.dwarf.Dwarf_T_typeUnitReader.T_typeUnitReader {
    ...
    public function new(?_d:Data, ?_tu:T_typeUnit, ?_b:T_buf, ?_err:stdgo.Error) this = new stdgo._internal.debug.dwarf.Dwarf_T_typeUnitReader.T_typeUnitReader(_d, _tu, _b, _err);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.debug.dwarf.Dwarf.T_unit_static_extension) abstract T_unit(stdgo._internal.debug.dwarf.Dwarf_T_unit.T_unit) from stdgo._internal.debug.dwarf.Dwarf_T_unit.T_unit to stdgo._internal.debug.dwarf.Dwarf_T_unit.T_unit {
    ...
    public function new(?_base:Offset, ?_off:Offset, ?_data:Array<std.UInt>, ?_atable:T_abbrevTable, ?_asize:StdTypes.Int, ?_vers:StdTypes.Int, ?_utype:std.UInt, ?_is64:Bool) this = new stdgo._internal.debug.dwarf.Dwarf_T_unit.T_unit(_base, _off, ([for (i in _data) i] : stdgo.Slice<stdgo.GoUInt8>), _atable, _asize, _vers, _utype, _is64);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
@:structInit abstract T__entry___localname___delayed_12177(stdgo._internal.debug.dwarf.Dwarf_T__entry___localname___delayed_12177.T__entry___localname___delayed_12177) from stdgo._internal.debug.dwarf.Dwarf_T__entry___localname___delayed_12177.T__entry___localname___delayed_12177 to stdgo._internal.debug.dwarf.Dwarf_T__entry___localname___delayed_12177.T__entry___localname___delayed_12177 {
    ...
    public function new(?_idx:StdTypes.Int, ?_off:haxe.UInt64, ?_fmt:T_format) this = new stdgo._internal.debug.dwarf.Dwarf_T__entry___localname___delayed_12177.T__entry___localname___delayed_12177(_idx, _off, _fmt);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
class Data_static_extension {
    ...
    static public function _parseTypes(_d:Data, _name:String, _types:Array<std.UInt>):stdgo.Error {
        final _types = ([for (i in _types) i] : stdgo.Slice<stdgo.GoUInt8>);
    ...
    static public function addSection(_d:Data, _name:String, _contents:Array<std.UInt>):stdgo.Error {
        final _contents = ([for (i in _contents) i] : stdgo.Slice<stdgo.GoUInt8>);
    ...
    static public function _dwarf5Ranges(_d:Data, _u:T_unit, _cu:Entry, _base:haxe.UInt64, _ranges:haxe.Int64, _ret:Array<haxe.ds.Vector<haxe.UInt64>>):stdgo.Tuple<Array<haxe.ds.Vector<haxe.UInt64>>, stdgo.Error> {
        final _ret = ([for (i in _ret) ([for (i in i) i] : stdgo.GoArray<stdgo.GoUInt64>)] : stdgo.Slice<stdgo.GoArray<stdgo.GoUInt64>>);
        return {
...
/**
    /|*{
    	if t_3688430, ok_3688433 = typeCache[off]; ok_3688433 {
    		gotoNext = 3688458
    		_ = gotoNext == 3688458
    		return t_3688430, nil
    		gotoNext = 3688480
    	} else {
    		gotoNext = 3688480
    	}
    	_ = gotoNext == 3688480
    	r.Seek(off)
    	e_3688493, err_3688496 = r.Next()
    	if err_3688496 != nil {
    		gotoNext = 3688527
    		_ = gotoNext == 3688527
    		return nil, err_3688496
    		gotoNext = 3688551
    	} else {
    		gotoNext = 3688551
    	}
    	_ = gotoNext == 3688551
    	addressSize_3688551 = r.AddressSize()
    	if e_3688493 == nil || e_3688493.Offset != off {
    		gotoNext = 3688614
    		_ = gotoNext == 3688614
    	...
    	_ = gotoNext == 3689212
    	nextDepth_3689227 = 0
    	next_3689290 = func() *Entry {
    		if !e_3688493.Children {
    			return nil
    		}
    		for {
    			kid, err1 := r.Next()
    			...
    			if kid == nil {
    				err_3688496 = DecodeError{name, r.offset(), "unexpected end of DWARF entries"}
    				return nil
    			}
    			if kid.Tag == 0 {
    				if nextDepth_3689227 > 0 {
    					nextDepth_3689227--
    					continue
    				}
    				return nil
    	...
    	typeOf_3690093 = func(e *Entry) Type {
    		tval := e.Val(73)
    		var t Type
    		switch toff := tval.(type) {
    		case Offset:
    			if t, err_3688496 = d.readType(name, r.clone(), toff, typeCache, fixups); err_3688496 != nil {
    				return nil
    			}
    		case uint64:
    			if t, err_3688496 = d.sigToType(toff); err_3688496 != nil {
    				return nil
    			}
    		default:
    			return new(VoidType)
    	...
    	gotoNext = 3690493
    	_ = gotoNext == 3690493
    	switch e_3688493.Tag {
    	case 1:
    		gotoNext = 3690509
    		_ = gotoNext == 3690509
    		t_3690855 = new(ArrayType)
    		typ_3689216 = t_3690855
    		typeCache[off] = t_3690855
    		if t_3690855.Type = typeOf_3690093(e_3688493); err_3688496 != nil {
    			gotoNext = 3690942
    			_ = gotoNext == 3690942
    			gotoNext = 3700341
    			gotoNext = 3690964
    		...
    		_ = gotoNext == 3690964
    		t_3690855.StrideBitSize, _ = e_3688493.Val(46).(int64)
    		kid_3691069 = next_3689290()
    		gotoNext = 3691065
    		_ = gotoNext == 3691065
    		if kid_3691069 != nil {
    			gotoNext = 3691109
    			...
    			gotoNext = 3691207
    			_ = gotoNext == 3691207
    			switch kid_3691069.Tag {
    			case 33:
    				gotoNext = 3691227
    				_ = gotoNext == 3691227
    				count_3691253, ok_3691260 = kid_3691069.Val(55).(int64)
    				if !ok_3691260 {
    					gotoNext = 3691304
    					_ = gotoNext == 3691304
    					count_3691253, ok_3691260 = kid_3691069.Val(47).(int64)
    					if ok_3691260 {
    						gotoNext = 3691420
    						_ = gotoNext == 3691420
    						count_3691253++
    						gotoNext = 3691556
    					} else if len(dims_3691050) == 0 {
    						gotoNext = 3691506
    						_ = gotoNext == 3691506
    						count_3691253 = -1
    						gotoNext = 3691556
    				...
    				_ = gotoNext == 3691556
    				dims_3691050 = append(dims_3691050, count_3691253)
    				gotoNext = 3691096
    			case 4:
    				gotoNext = 3691586
    				_ = gotoNext == 3691586
    				err_3688496 = DecodeError{name, kid_3691069.Offset, "cannot handle enumeration type as array bound"}
    				gotoNext = 3700341
    				gotoNext = 3691096
    			default:
    				gotoNext = 3691096
    		...
    		_ = gotoNext == 3691726
    		if len(dims_3691050) == 0 {
    			gotoNext = 3691744
    			_ = gotoNext == 3691744
    			dims_3691050 = []int64{-1}
    			gotoNext = 3691810
    		} else {
    			gotoNext = 3691810
    		}
    		_ = gotoNext == 3691810
    		t_3690855.Count = dims_3691050[0]
    		i_3691834 = len(dims_3691050) - 1
    		gotoNext = 3691830
    		_ = gotoNext == 3691830
    		if i_3691834 >= 1 {
    			gotoNext = 3691866
    			_ = gotoNext == 3691866
    			t_3690855.Type = &ArrayType{Type: t_3690855.Type, Count: dims_3691050[i_3691834]}
    			i_3691834--
    			gotoNext = 3691830
    		} else {
    			gotoNext = 3699938
    	...
    	case 36:
    		gotoNext = 3691927
    		_ = gotoNext == 3691927
    		name_3692491, _ = e_3688493.Val(3).(string)
    		enc_3692529, ok_3692534 = e_3688493.Val(62).(int64)
    		if !ok_3692534 {
    			gotoNext = 3692577
    			_ = gotoNext == 3692577
    			err_3688496 = DecodeError{name_3692491, e_3688493.Offset, "missing encoding attribute for " + name_3692491}
    			gotoNext = 3700341
    			gotoNext = 3692678
    		} else {
    			gotoNext = 3692678
    		...
    		default:
    			gotoNext = 3692693
    			_ = gotoNext == 3692693
    			err_3688496 = DecodeError{name_3692491, e_3688493.Offset, "unrecognized encoding attribute value"}
    			gotoNext = 3700341
    			gotoNext = 3693515
    		case 1:
    			gotoNext = 3692797
    			_ = gotoNext == 3692797
    			typ_3689216 = new(AddrType)
    			gotoNext = 3693515
    		case 2:
    			gotoNext = 3692839
    			_ = gotoNext == 3692839
    			typ_3689216 = new(BoolType)
    			gotoNext = 3693515
    		case 3:
    			gotoNext = 3692881
    			_ = gotoNext == 3692881
    			typ_3689216 = new(ComplexType)
    			if name_3692491 == "complex" {
    				gotoNext = 3692953
    				_ = gotoNext == 3692953
    				byteSize_3693144, _ = e_3688493.Val(11).(int64)
    				gotoNext = 3693137
    				_ = gotoNext == 3693137
    				switch byteSize_3693144, _ = e_3688493.Val(11).(int64); byteSize_3693144 {
    				case 8:
    					gotoNext = 3693203
    					_ = gotoNext == 3693203
    					name_3692491 = "complex float"
    					gotoNext = 3693515
    				case 16:
    					gotoNext = 3693243
    					_ = gotoNext == 3693243
    					name_3692491 = "complex double"
    					gotoNext = 3693515
    				default:
    					gotoNext = 3693515
    				}
    		...
    		case 4:
    			gotoNext = 3693294
    			_ = gotoNext == 3693294
    			typ_3689216 = new(FloatType)
    			gotoNext = 3693515
    		case 5:
    			gotoNext = 3693335
    			_ = gotoNext == 3693335
    			typ_3689216 = new(IntType)
    			gotoNext = 3693515
    		case 7:
    			gotoNext = 3693375
    			_ = gotoNext == 3693375
    			typ_3689216 = new(UintType)
    			gotoNext = 3693515
    		case 6:
    			gotoNext = 3693418
    			_ = gotoNext == 3693418
    			typ_3689216 = new(CharType)
    			gotoNext = 3693515
    		case 8:
    			gotoNext = 3693463
    			_ = gotoNext == 3693463
    			typ_3689216 = new(UcharType)
    			gotoNext = 3693515
    		}
    		_ = gotoNext == 3693515
    		typeCache[off] = typ_3689216
    		t_3693538 = typ_3689216.(_interface_0).Basic()
    		t_3693538.Name = name_3692491
    		t_3693538.BitSize, _ = e_3688493.Val(13).(int64)
    		haveBitOffset_3693657 = false
    		haveDataBitOffset_3693682 = false
    		t_3693538.BitOffset, haveBitOffset_3693657 = e_3688493.Val(12).(int64)
    		t_3693538.DataBitOffset, haveDataBitOffset_3693682 = e_3688493.Val(107).(int64)
    		if haveBitOffset_3693657 && haveDataBitOffset_3693682 {
    			gotoNext = 3693881
    			_ = gotoNext == 3693881
    			err_3688496 = DecodeError{name_3692491, e_3688493.Offset, "duplicate bit offset attributes"}
    			gotoNext = 3700341
    			gotoNext = 3699938
    		} else {
    			gotoNext = 3699938
    	...
    	case 2, 19, 23:
    		gotoNext = 3693975
    		_ = gotoNext == 3693975
    		t_3694728 = new(StructType)
    		typ_3689216 = t_3694728
    		typeCache[off] = t_3694728
    		_ = 0
    		gotoNext = 3694782
    		_ = gotoNext == 3694782
    		switch e_3688493.Tag {
    		case 2:
    			gotoNext = 3694799
    			_ = gotoNext == 3694799
    			t_3694728.Kind = "class"
    			gotoNext = 3694928
    		case 19:
    			gotoNext = 3694840
    			_ = gotoNext == 3694840
    			t_3694728.Kind = "struct"
    			gotoNext = 3694928
    		case 23:
    			gotoNext = 3694883
    			_ = gotoNext == 3694883
    			t_3694728.Kind = "union"
    			gotoNext = 3694928
    		default:
    			gotoNext = 3694928
    		}
    		_ = gotoNext == 3694928
    		t_3694728.StructName, _ = e_3688493.Val(3).(string)
    		t_3694728.Incomplete = e_3688493.Val(60) != nil
    		t_3694728.Field = make([]*StructField, 0, 8)
    		kid_3695150 = next_3689290()
    		gotoNext = 3695146
    		_ = gotoNext == 3695146
    		if kid_3695150 != nil {
    			gotoNext = 3695190
    			_ = gotoNext == 3695190
    			if kid_3695150.Tag != 13 {
    				gotoNext = 3695219
    				_ = gotoNext == 3695219
    				kid_3695150 = next_3689290()
    				gotoNext = 3695146
    			...
    			_ = gotoNext == 3695242
    			f_3695242 = new(StructField)
    			if f_3695242.Type = typeOf_3690093(kid_3695150); err_3688496 != nil {
    				gotoNext = 3695303
    				_ = gotoNext == 3695303
    				gotoNext = 3700341
    				gotoNext = 3695328
    			...
    			gotoNext = 3695328
    			_ = gotoNext == 3695328
    			switch loc := kid_3695150.Val(56).(type) {
    			case []byte:
    				loc_3695392 = loc
    				gotoNext = 3695381
    				_ = gotoNext == 3695381
    				b_3695481 = makeBuf(d, unknownFormat{}, "location", 0, loc_3695392)
    				if b_3695481.uint8() != 35 {
    					gotoNext = 3695567
    					_ = gotoNext == 3695567
    					err_3688496 = DecodeError{name, kid_3695150.Offset, "unexpected opcode"}
    					gotoNext = 3700341
    					gotoNext = 3695657
    				} else {
    					gotoNext = 3695657
    				...
    				_ = gotoNext == 3695657
    				f_3695242.ByteOffset = int64(b_3695481.uint())
    				if b_3695481.err != nil {
    					gotoNext = 3695708
    					_ = gotoNext == 3695708
    					err_3688496 = b_3695481.err
    					gotoNext = 3700341
    					gotoNext = 3695796
    				} else {
    					gotoNext = 3695796
    			...
    			case int64:
    				...
    				gotoNext = 3695752
    				_ = gotoNext == 3695752
    				f_3695242.ByteOffset = loc_3695762
    				gotoNext = 3695796
    			default:
    				gotoNext = 3695796
    			}
    			_ = gotoNext == 3695796
    			f_3695242.Name, _ = kid_3695150.Val(3).(string)
    			f_3695242.ByteSize, _ = kid_3695150.Val(11).(int64)
    			haveBitOffset_3695887 = false
    			haveDataBitOffset_3695913 = false
    			f_3695242.BitOffset, haveBitOffset_3695887 = kid_3695150.Val(12).(int64)
    			f_3695242.DataBitOffset, haveDataBitOffset_3695913 = kid_3695150.Val(107).(int64)
    			if haveBitOffset_3695887 && haveDataBitOffset_3695913 {
    				gotoNext = 3696119
    				_ = gotoNext == 3696119
    				err_3688496 = DecodeError{name, e_3688493.Offset, "duplicate bit offset attributes"}
    				gotoNext = 3700341
    				gotoNext = 3696217
    			} else {
    				gotoNext = 3696217
    			...
    			_ = gotoNext == 3696217
    			f_3695242.BitSize, _ = kid_3695150.Val(13).(int64)
    			t_3694728.Field = append(t_3694728.Field, f_3695242)
    			if lastFieldBitSize_3695089 == 0 && lastFieldByteOffset_3695118 == f_3695242.ByteOffset && t_3694728.Kind != "union" {
    				gotoNext = 3696382
    				_ = gotoNext == 3696382
    				fixups.recordArrayType(lastFieldType_3695063)
    				gotoNext = 3696561
    			} else {
    				gotoNext = 3696561
    			}
    			_ = gotoNext == 3696561
    			lastFieldType_3695063 = &f_3695242.Type
    			lastFieldByteOffset_3695118 = f_3695242.ByteOffset
    			lastFieldBitSize_3695089 = f_3695242.BitSize
    			kid_3695150 = next_3689290()
    			gotoNext = 3695146
    		} else {
    			gotoNext = 3696661
    		...
    		_ = gotoNext == 3696661
    		if t_3694728.Kind != "union" {
    			gotoNext = 3696682
    			_ = gotoNext == 3696682
    			b_3696687, ok_3696690 = e_3688493.Val(11).(int64)
    			if ok_3696690 && b_3696687 == lastFieldByteOffset_3695118 {
    				gotoNext = 3696761
    				_ = gotoNext == 3696761
    				fixups.recordArrayType(lastFieldType_3695063)
    				gotoNext = 3699938
    	...
    	case 38, 53, 55:
    		gotoNext = 3696873
    		_ = gotoNext == 3696873
    		t_3697004 = new(QualType)
    		typ_3689216 = t_3697004
    		typeCache[off] = t_3697004
    		if t_3697004.Type = typeOf_3690093(e_3688493); err_3688496 != nil {
    			gotoNext = 3697090
    			_ = gotoNext == 3697090
    			gotoNext = 3700341
    			gotoNext = 3697112
    		...
    		case 38:
    			gotoNext = 3697129
    			_ = gotoNext == 3697129
    			t_3697004.Qual = "const"
    			gotoNext = 3699938
    		case 55:
    			gotoNext = 3697170
    			_ = gotoNext == 3697170
    			t_3697004.Qual = "restrict"
    			gotoNext = 3699938
    		case 53:
    			gotoNext = 3697217
    			_ = gotoNext == 3697217
    			t_3697004.Qual = "volatile"
    			gotoNext = 3699938
    		default:
    			gotoNext = 3699938
    		}
    	...
    	case 4:
    		gotoNext = 3697268
    		_ = gotoNext == 3697268
    		t_3697552 = new(EnumType)
    		typ_3689216 = t_3697552
    		typeCache[off] = t_3697552
    		t_3697552.EnumName, _ = e_3688493.Val(3).(string)
    		t_3697552.Val = make([]*EnumValue, 0, 8)
    		kid_3697686 = next_3689290()
    		gotoNext = 3697682
    		_ = gotoNext == 3697682
    		if kid_3697686 != nil {
    			gotoNext = 3697726
    			_ = gotoNext == 3697726
    			if kid_3697686.Tag == 40 {
    				gotoNext = 3697759
    				_ = gotoNext == 3697759
    				f_3697765 = new(EnumValue)
    				f_3697765.Name, _ = kid_3697686.Val(3).(string)
    				f_3697765.Val, _ = kid_3697686.Val(28).(int64)
    				n_3697879 = len(t_3697552.Val)
    				if n_3697879 >= cap(t_3697552.Val) {
    					gotoNext = 3697918
    					_ = gotoNext == 3697918
    					val_3697925 = make([]*EnumValue, n_3697879, n_3697879*2)
    					copy(val_3697925, t_3697552.Val)
    					t_3697552.Val = val_3697925
    					gotoNext = 3698008
    				} else {
    					gotoNext = 3698008
    				}
    				_ = gotoNext == 3698008
    				t_3697552.Val = t_3697552.Val[0 : n_3697879+1]
    				t_3697552.Val[n_3697879] = f_3697765
    				gotoNext = 3697713
    			} else {
    				gotoNext = 3697713
    			}
    	...
    	case 15:
    		gotoNext = 3698059
    		_ = gotoNext == 3698059
    		t_3698241 = new(PtrType)
    		typ_3689216 = t_3698241
    		typeCache[off] = t_3698241
    		if e_3688493.Val(73) == nil {
    			gotoNext = 3698318
    			_ = gotoNext == 3698318
    			t_3698241.Type = &VoidType{}
    			gotoNext = 3699938
    			gotoNext = 3698359
    		} else {
    			gotoNext = 3698359
    		...
    		_ = gotoNext == 3698359
    		t_3698241.Type = typeOf_3690093(e_3688493)
    		gotoNext = 3699938
    	case 21:
    		gotoNext = 3698380
    		_ = gotoNext == 3698380
    		t_3698744 = new(FuncType)
    		typ_3689216 = t_3698744
    		typeCache[off] = t_3698744
    		if t_3698744.ReturnType = typeOf_3690093(e_3688493); err_3688496 != nil {
    			gotoNext = 3698836
    			_ = gotoNext == 3698836
    			gotoNext = 3700341
    			gotoNext = 3698858
    		...
    		_ = gotoNext == 3698858
    		t_3698744.ParamType = make([]Type, 0, 8)
    		kid_3698897 = next_3689290()
    		gotoNext = 3698893
    		_ = gotoNext == 3698893
    		if kid_3698897 != nil {
    			gotoNext = 3698937
    			...
    			case 5:
    				gotoNext = 3699004
    				_ = gotoNext == 3699004
    				if tkid_3698946 = typeOf_3690093(kid_3698897); err_3688496 != nil {
    					gotoNext = 3699067
    					_ = gotoNext == 3699067
    					gotoNext = 3700341
    					gotoNext = 3699161
    			...
    			case 24:
    				gotoNext = 3699094
    				_ = gotoNext == 3699094
    				tkid_3698946 = &DotDotDotType{}
    				gotoNext = 3699161
    			}
    			_ = gotoNext == 3699161
    			t_3698744.ParamType = append(t_3698744.ParamType, tkid_3698946)
    			kid_3698897 = next_3689290()
    			gotoNext = 3698893
    		} else {
    			gotoNext = 3699938
    	...
    	case 22:
    		gotoNext = 3699207
    		_ = gotoNext == 3699207
    		t_3699346 = new(TypedefType)
    		typ_3689216 = t_3699346
    		typeCache[off] = t_3699346
    		t_3699346.Name, _ = e_3688493.Val(3).(string)
    		t_3699346.Type = typeOf_3690093(e_3688493)
    		gotoNext = 3699938
    	case 59:
    		gotoNext = 3699461
    		_ = gotoNext == 3699461
    		t_3699564 = new(UnspecifiedType)
    		typ_3689216 = t_3699564
    		typeCache[off] = t_3699564
    		t_3699564.Name, _ = e_3688493.Val(3).(string)
    		gotoNext = 3699938
    	default:
    		gotoNext = 3699662
    		_ = gotoNext == 3699662
    		t_3699821 = new(UnsupportedType)
    		typ_3689216 = t_3699821
    		typeCache[off] = t_3699821
    		t_3699821.Tag = e_3688493.Tag
    		t_3699821.Name, _ = e_3688493.Val(3).(string)
    		gotoNext = 3699938
    	}
    	_ = gotoNext == 3699938
    	if err_3688496 != nil {
    	...
    	_ = gotoNext == 3699972
    	{
    		b_3699976, ok_3699979 = e_3688493.Val(11).(int64)
    		if !ok_3699979 {
    			gotoNext = 3700022
    			_ = gotoNext == 3700022
    			b_3699976 = -1
    			...
    			gotoNext = 3700037
    			_ = gotoNext == 3700037
    			switch t := typ_3689216.(type) {
    			case *TypedefType:
    				t_3700082 = t
    				gotoNext = 3700065
    				_ = gotoNext == 3700065
    				fixups.typedefs = append(fixups.typedefs, t_3700082)
    				gotoNext = 3700294
    			case *PtrType:
    				t_3700254 = t
    				gotoNext = 3700241
    				_ = gotoNext == 3700241
    				b_3699976 = int64(addressSize_3688551)
    				gotoNext = 3700294
    			default:
    				gotoNext = 3700294
    			}
    		...
    		_ = gotoNext == 3700294
    		typ_3689216.Common().ByteSize = b_3699976
    	}
    	return typ_3689216, nil
    	gotoNext = 3700341
    	_ = gotoNext == 3700341
...
class Dwarf {
    ...
    **/
    static public function new_(_abbrev:Array<std.UInt>, _aranges:Array<std.UInt>, _frame:Array<std.UInt>, _info:Array<std.UInt>, _line:Array<std.UInt>, _pubnames:Array<std.UInt>, _ranges:Array<std.UInt>, _str:Array<std.UInt>):stdgo.Tuple<Data, stdgo.Error> {
        final _abbrev = ([for (i in _abbrev) i] : stdgo.Slice<stdgo.GoUInt8>);
        final _aranges = ([for (i in _aranges) i] : stdgo.Slice<stdgo.GoUInt8>);
        final _frame = ([for (i in _frame) i] : stdgo.Slice<stdgo.GoUInt8>);
        final _info = ([for (i in _info) i] : stdgo.Slice<stdgo.GoUInt8>);
        final _line = ([for (i in _line) i] : stdgo.Slice<stdgo.GoUInt8>);
        final _pubnames = ([for (i in _pubnames) i] : stdgo.Slice<stdgo.GoUInt8>);
        final _ranges = ([for (i in _ranges) i] : stdgo.Slice<stdgo.GoUInt8>);
