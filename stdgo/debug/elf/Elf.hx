...
@:named class CompressionType {
	...
	public function __copy__()
		return new CompressionType(__t__);
}
...
@:structInit class Header32 {
	...
	public function new(?ident:GoArray<GoUInt8>, ?type:GoUInt16, ?machine:GoUInt16, ?version:GoUInt32, ?entry:GoUInt32, ?phoff:GoUInt32, ?shoff:GoUInt32,
			?flags:GoUInt32, ?ehsize:GoUInt16, ?phentsize:GoUInt16, ?phnum:GoUInt16, ?shentsize:GoUInt16, ?shnum:GoUInt16, ?shstrndx:GoUInt16)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(ident) + " " + Go.string(type) + " " + Go.string(machine) + " " + Go.string(version) + " " + Go.string(entry) + " "
			+ Go.string(phoff) + " " + Go.string(shoff) + " " + Go.string(flags) + " " + Go.string(ehsize) + " " + Go.string(phentsize) + " "
			+ Go.string(phnum) + " " + Go.string(shentsize) + " " + Go.string(shnum) + " " + Go.string(shstrndx) + "}";
	}
	...
	public function __copy__() {
		return new Header32(ident, type, machine, version, entry, phoff, shoff, flags, ehsize, phentsize, phnum, shentsize, shnum, shstrndx);
	}
...
@:structInit class Section32 {
	...
	public function new(?name:GoUInt32, ?type:GoUInt32, ?flags:GoUInt32, ?addr:GoUInt32, ?off:GoUInt32, ?size:GoUInt32, ?link:GoUInt32, ?info:GoUInt32,
			?addralign:GoUInt32, ?entsize:GoUInt32)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(name) + " " + Go.string(type) + " " + Go.string(flags) + " " + Go.string(addr) + " " + Go.string(off) + " " + Go.string(size)
			+ " " + Go.string(link) + " " + Go.string(info) + " " + Go.string(addralign) + " " + Go.string(entsize) + "}";
	}
...
@:structInit class Prog32 {
	...
	public function new(?type:GoUInt32, ?off:GoUInt32, ?vaddr:GoUInt32, ?paddr:GoUInt32, ?filesz:GoUInt32, ?memsz:GoUInt32, ?flags:GoUInt32, ?align:GoUInt32)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(type) + " " + Go.string(off) + " " + Go.string(vaddr) + " " + Go.string(paddr) + " " + Go.string(filesz) + " "
			+ Go.string(memsz) + " " + Go.string(flags) + " " + Go.string(align) + "}";
	}
...
@:structInit class Dyn32 {
	...
	public function new(?tag:GoInt32, ?val:GoUInt32)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Chdr32 {
	...
	public function new(?type:GoUInt32, ?size:GoUInt32, ?addralign:GoUInt32)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Rel32 {
	...
	public function new(?off:GoUInt32, ?info:GoUInt32)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Rela32 {
	...
	public function new(?off:GoUInt32, ?info:GoUInt32, ?addend:GoInt32)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Sym32 {
	...
	public function new(?name:GoUInt32, ?value:GoUInt32, ?size:GoUInt32, ?info:GoUInt8, ?other:GoUInt8, ?shndx:GoUInt16)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(name) + " " + Go.string(value) + " " + Go.string(size) + " " + Go.string(info) + " " + Go.string(other) + " "
			+ Go.string(shndx) + "}";
	}
...
@:structInit class Header64 {
	...
	public function new(?ident:GoArray<GoUInt8>, ?type:GoUInt16, ?machine:GoUInt16, ?version:GoUInt32, ?entry:GoUInt64, ?phoff:GoUInt64, ?shoff:GoUInt64,
			?flags:GoUInt32, ?ehsize:GoUInt16, ?phentsize:GoUInt16, ?phnum:GoUInt16, ?shentsize:GoUInt16, ?shnum:GoUInt16, ?shstrndx:GoUInt16)
		stdgo.internal.Macro.initLocals();
	...
	public function __copy__() {
		return new Header64(ident, type, machine, version, entry, phoff, shoff, flags, ehsize, phentsize, phnum, shentsize, shnum, shstrndx);
	}
...
@:structInit class Section64 {
	...
	public function new(?name:GoUInt32, ?type:GoUInt32, ?flags:GoUInt64, ?addr:GoUInt64, ?off:GoUInt64, ?size:GoUInt64, ?link:GoUInt32, ?info:GoUInt32,
			?addralign:GoUInt64, ?entsize:GoUInt64)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Prog64 {
	...
	public function new(?type:GoUInt32, ?flags:GoUInt32, ?off:GoUInt64, ?vaddr:GoUInt64, ?paddr:GoUInt64, ?filesz:GoUInt64, ?memsz:GoUInt64, ?align:GoUInt64)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(type) + " " + Go.string(flags) + " " + Go.string(off) + " " + Go.string(vaddr) + " " + Go.string(paddr) + " "
			+ Go.string(filesz) + " " + Go.string(memsz) + " " + Go.string(align) + "}";
	}
...
@:structInit class Dyn64 {
	...
	public function new(?tag:GoInt64, ?val:GoUInt64)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Chdr64 {
	...
	public function new(?type:GoUInt32, ?___blank__0:GoUInt32, ?size:GoUInt64, ?addralign:GoUInt64)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Rel64 {
	...
	public function new(?off:GoUInt64, ?info:GoUInt64)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Rela64 {
	...
	public function new(?off:GoUInt64, ?info:GoUInt64, ?addend:GoInt64)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Sym64 {
	...
	public function new(?name:GoUInt32, ?info:GoUInt8, ?other:GoUInt8, ?shndx:GoUInt16, ?value:GoUInt64, ?size:GoUInt64)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(name) + " " + Go.string(info) + " " + Go.string(other) + " " + Go.string(shndx) + " " + Go.string(value) + " "
			+ Go.string(size) + "}";
	}
...
@:structInit class FileHeader {
	...
	public function new(?class_:Class_, ?data:Data, ?version:Version, ?osabi:OSABI, ?abiversion:GoUInt8, ?byteOrder:stdgo.encoding.binary.Binary.ByteOrder,
			?type:Type, ?machine:Machine, ?entry:GoUInt64)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(class_) + " " + Go.string(data) + " " + Go.string(version) + " " + Go.string(osabi) + " " + Go.string(abiversion) + " "
			+ Go.string(byteOrder) + " " + Go.string(type) + " " + Go.string(machine) + " " + Go.string(entry) + "}";
	}
...
@:structInit class File {
	public function dynString(_tag:DynTag):{var _0:Slice<GoString>; var _1:Error;} {
		...
		var __tmp__ = _f.value._stringTable(_ds.value.sectionHeader.link),
			_str:Slice<GoUInt8> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new Slice<GoString>().nil(), _1: _err};
		};
		...
		while (_d.length > ((0 : GoInt))) {
			...
			if (_t.__t__ == _tag.__t__) {
				var __tmp__ = _getString(_str, ((_v : GoInt))),
	...
	public function _gnuVersion(_i:GoInt):{var _0:GoString; var _1:GoString;} {
		var _f = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _library:GoString = (("" : GoString)),
			_version:GoString = (("" : GoString));
	...
	public function _gnuVersionInit(_str:Slice<GoByte>):Bool {
		...
		while (true) {
			...
			var __tmp__ = _getString(_str, ((_fileoff : GoInt))),
				_file:GoString = __tmp__._0,
				_:Bool = __tmp__._1;
			...
			var _j:GoInt = _i + ((_aux : GoInt));
			{
				...
				Go.cfor(_c < ((_cnt : GoInt)), _c++, {
					...
					if (_ndx >= _need.length) {
						var _a:Slice<T_verneed> = new Slice<T_verneed>(...[
							for (i in 0...((((2 : GoInt)) * (_ndx + ((1 : GoInt))) : GoInt)).toBasic()) new T_verneed()
						]);
						Go.copy(_a, _need);
						_need = _a;
					};
	...
	public function importedSymbols():{var _0:Slice<ImportedSymbol>; var _1:Error;} {
		var _f = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _f.value._getSymbols(sht_DYNSYM),
			_sym:Slice<Symbol> = __tmp__._0,
			_str:Slice<GoUInt8> = __tmp__._1,
	...
	public function symbols():{var _0:Slice<Symbol>; var _1:Error;} {
		var _f = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _f.value._getSymbols(sht_SYMTAB),
			_sym:Slice<Symbol> = __tmp__._0,
	...
	public function dwarf():{var _0:Pointer<stdgo.debug.dwarf.Dwarf.Data>; var _1:Error;} {
		...
		var _sectionData:(GoInt, Pointer<Section>) -> {
			var _0:Slice<GoUInt8>;
			var _1:stdgo.Error;
		} = function(_i:GoInt, _s:Pointer<Section>):{var _0:Slice<GoByte>; var _1:Error;} {
			...
			{key: "line", value: new Slice<GoUInt8>().nil()}, {key: "ranges", value: new Slice<GoUInt8>().nil()});
		{
			...
			for (_obj in _f.value.sections.keyValueIterator()) {
				...
				var __tmp__ = _sectionData(_i, _s),
	...
	public function _applyRelocationsSPARC64(_dst:Slice<GoByte>, _rels:Slice<GoByte>):Error {
		...
		var __tmp__ = _f.value._getSymbols(sht_SYMTAB),
			_symbols:Slice<Symbol> = __tmp__._0,
			_:Slice<GoUInt8> = __tmp__._1,
			_err:stdgo.Error = __tmp__._2;
		if (_err != null) {
			return _err;
	...
	public function _getSymbols64(_typ:SectionType):{var _0:Slice<Symbol>; var _1:Slice<GoByte>; var _2:Error;} {
		...
		if (_symtab.value.len() % sym64Size != ((0 : GoInt))) {
			return {_0: new Slice<Symbol>().nil(), _1: new Slice<GoUInt8>().nil(),
				_2: stdgo.errors.Errors.new_("length of symbol section is not a multiple of Sym64Size")};
		};
		var __tmp__ = _f.value._stringTable(_symtabSection.value.sectionHeader.link),
			_strdata:Slice<GoUInt8> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
		...
		while (_symtab.value.len() > ((0 : GoInt))) {
			...
			var __tmp__ = _getString(_strdata, ((_sym.name : GoInt))),
	...
	public function _getSymbols32(_typ:SectionType):{var _0:Slice<Symbol>; var _1:Slice<GoByte>; var _2:Error;} {
		...
		if (_symtab.value.len() % sym32Size != ((0 : GoInt))) {
			return {_0: new Slice<Symbol>().nil(), _1: new Slice<GoUInt8>().nil(),
				_2: stdgo.errors.Errors.new_("length of symbol section is not a multiple of SymSize")};
		};
		var __tmp__ = _f.value._stringTable(_symtabSection.value.sectionHeader.link),
			_strdata:Slice<GoUInt8> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
	...
	public function new(?fileHeader:FileHeader, ?sections:Slice<Pointer<Section>>, ?progs:Slice<Pointer<Prog>>, ?_closer:stdgo.io.Io.Closer,
			?_gnuNeed:Slice<T_verneed>, ?_gnuVersym:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(fileHeader) + " " + Go.string(sections) + " " + Go.string(progs) + " " + Go.string(_closer) + " " + Go.string(_gnuNeed) + " "
			+ Go.string(_gnuVersym) + "}";
	}
...
@:structInit class SectionHeader {
	...
	public function new(?name:GoString, ?type:SectionType, ?flags:SectionFlag, ?addr:GoUInt64, ?offset:GoUInt64, ?size:GoUInt64, ?link:GoUInt32,
			?info:GoUInt32, ?addralign:GoUInt64, ?entsize:GoUInt64, ?fileSize:GoUInt64)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(name) + " " + Go.string(type) + " " + Go.string(flags) + " " + Go.string(addr) + " " + Go.string(offset) + " "
			+ Go.string(size) + " " + Go.string(link) + " " + Go.string(info) + " " + Go.string(addralign) + " " + Go.string(entsize) + " "
			+ Go.string(fileSize) + "}";
	}
	...
	public function __copy__() {
		return new SectionHeader(name, type, flags, addr, offset, size, link, info, addralign, entsize, fileSize);
	}
...
@:structInit class Section {
	public function open():stdgo.io.Io.ReadSeeker {
		...
		if (new SectionFlag(_s.value.sectionHeader.flags.__t__ & shf_COMPRESSED.__t__).__t__ == ((0 : GoUInt32))) {
			return stdgo.io.Io.newSectionReader(_s.value._sr.value, ((0 : GoInt64)), (((1 : GoUnTypedInt)) << ((63 : GoUnTypedInt))) - ((1 : GoUnTypedInt)))
				.value;
		};
		if (_s.value._compressionType.__t__ == compress_ZLIB.__t__) {
			return Go.pointer((({
				_reset: function():{var _0:stdgo.io.Io.Reader; var _1:Error;} {
					var _fr:Pointer<stdgo.io.Io.SectionReader> = stdgo.io.Io.newSectionReader(_s.value._sr.value, _s.value._compressionOffset,
						((_s.value.sectionHeader.fileSize : GoInt64)) - _s.value._compressionOffset);
					return stdgo.compress.zlib.Zlib.newReader(_fr.value);
				},
				_size: ((_s.value.sectionHeader.size : GoInt64)),
				_r: ((null : stdgo.io.Io.Reader)),
				_offset: 0
			} : T_readSeekerFromReader))).value;
		};
		var _err:Pointer<FormatError> = Go.pointer(new FormatError(((_s.value.sectionHeader.offset : GoInt64)), "unknown compression type",
			Go.toInterface(_s.value._compressionType)));
	...
	public function data():{var _0:Slice<GoByte>; var _1:Error;} {
		...
		var __tmp__ = stdgo.io.Io.readFull(_s.value.open(), _dat),
			_n:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
	...
	public function new(?sectionHeader:SectionHeader, ?readerAt:stdgo.io.Io.ReaderAt, ?_sr:Pointer<stdgo.io.Io.SectionReader>,
			?_compressionType:CompressionType, ?_compressionOffset:GoInt64)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(sectionHeader) + " " + Go.string(readerAt) + " " + Go.string(_sr) + " " + Go.string(_compressionType) + " "
			+ Go.string(_compressionOffset) + "}";
	}
...
@:structInit class ProgHeader {
	...
	public function new(?type:ProgType, ?flags:ProgFlag, ?off:GoUInt64, ?vaddr:GoUInt64, ?paddr:GoUInt64, ?filesz:GoUInt64, ?memsz:GoUInt64, ?align:GoUInt64)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Prog {
	...
	public function new(?progHeader:ProgHeader, ?readerAt:stdgo.io.Io.ReaderAt, ?_sr:Pointer<stdgo.io.Io.SectionReader>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Symbol {
	...
	public function new(?name:GoString, ?info:GoUInt8, ?other:GoUInt8, ?section:SectionIndex, ?value:GoUInt64, ?size:GoUInt64, ?version:GoString,
			?library:GoString)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(name) + " " + Go.string(info) + " " + Go.string(other) + " " + Go.string(section) + " " + Go.string(value) + " "
			+ Go.string(size) + " " + Go.string(version) + " " + Go.string(library) + "}";
	}
...
@:structInit class ImportedSymbol {
	...
	public function new(?name:GoString, ?version:GoString, ?library:GoString)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_verneed {
	...
	public function new(?file:GoString, ?name:GoString)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_readSeekerFromReader {
	...
	public function _start():Void {
		var _r = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _r.value._reset(),
			_x:stdgo.io.Io.Reader = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
	...
	public function new(?_reset:() -> {
		var _0:stdgo.io.Io.Reader;
		var _1:stdgo.Error;
	}, ?_r:stdgo.io.Io.Reader, ?_size:GoInt64, ?_offset:GoInt64)
		stdgo.internal.Macro.initLocals();
...
var _sttStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "STT_NOTYPE").__copy__(),
	new T_intName(((1 : GoUInt32)), "STT_OBJECT").__copy__(), new T_intName(((2 : GoUInt32)), "STT_FUNC").__copy__(),
	new T_intName(((3 : GoUInt32)), "STT_SECTION").__copy__(), new T_intName(((4 : GoUInt32)), "STT_FILE").__copy__(),
	new T_intName(((5 : GoUInt32)), "STT_COMMON").__copy__(), new T_intName(((6 : GoUInt32)), "STT_TLS").__copy__(),
	new T_intName(((10 : GoUInt32)), "STT_LOOS").__copy__(), new T_intName(((12 : GoUInt32)), "STT_HIOS").__copy__(),
	new T_intName(((13 : GoUInt32)), "STT_LOPROC").__copy__(), new T_intName(((15 : GoUInt32)), "STT_HIPROC").__copy__());
...
var _rppc64Strings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "R_PPC64_NONE").__copy__(),
	new T_intName(((1 : GoUInt32)), "R_PPC64_ADDR32").__copy__(), new T_intName(((2 : GoUInt32)), "R_PPC64_ADDR24").__copy__(),
	new T_intName(((3 : GoUInt32)), "R_PPC64_ADDR16").__copy__(), new T_intName(((4 : GoUInt32)), "R_PPC64_ADDR16_LO").__copy__(),
	new T_intName(((5 : GoUInt32)), "R_PPC64_ADDR16_HI").__copy__(), new T_intName(((6 : GoUInt32)), "R_PPC64_ADDR16_HA").__copy__(),
	new T_intName(((7 : GoUInt32)), "R_PPC64_ADDR14").__copy__(), new T_intName(((8 : GoUInt32)), "R_PPC64_ADDR14_BRTAKEN").__copy__(),
	new T_intName(((9 : GoUInt32)), "R_PPC64_ADDR14_BRNTAKEN").__copy__(), new T_intName(((10 : GoUInt32)), "R_PPC64_REL24").__copy__(),
	new T_intName(((11 : GoUInt32)), "R_PPC64_REL14").__copy__(), new T_intName(((12 : GoUInt32)), "R_PPC64_REL14_BRTAKEN").__copy__(),
	new T_intName(((13 : GoUInt32)), "R_PPC64_REL14_BRNTAKEN").__copy__(), new T_intName(((14 : GoUInt32)), "R_PPC64_GOT16").__copy__(),
	new T_intName(((15 : GoUInt32)), "R_PPC64_GOT16_LO").__copy__(), new T_intName(((16 : GoUInt32)), "R_PPC64_GOT16_HI").__copy__(),
	new T_intName(((17 : GoUInt32)), "R_PPC64_GOT16_HA").__copy__(), new T_intName(((21 : GoUInt32)), "R_PPC64_JMP_SLOT").__copy__(),
	new T_intName(((26 : GoUInt32)), "R_PPC64_REL32").__copy__(), new T_intName(((38 : GoUInt32)), "R_PPC64_ADDR64").__copy__(),
	new T_intName(((39 : GoUInt32)), "R_PPC64_ADDR16_HIGHER").__copy__(), new T_intName(((40 : GoUInt32)), "R_PPC64_ADDR16_HIGHERA").__copy__(),
	new T_intName(((41 : GoUInt32)), "R_PPC64_ADDR16_HIGHEST").__copy__(), new T_intName(((42 : GoUInt32)), "R_PPC64_ADDR16_HIGHESTA").__copy__(),
	new T_intName(((44 : GoUInt32)), "R_PPC64_REL64").__copy__(), new T_intName(((47 : GoUInt32)), "R_PPC64_TOC16").__copy__(),
	new T_intName(((48 : GoUInt32)), "R_PPC64_TOC16_LO").__copy__(), new T_intName(((49 : GoUInt32)), "R_PPC64_TOC16_HI").__copy__(),
	new T_intName(((50 : GoUInt32)), "R_PPC64_TOC16_HA").__copy__(), new T_intName(((51 : GoUInt32)), "R_PPC64_TOC").__copy__(),
	new T_intName(((52 : GoUInt32)), "R_PPC64_PLTGOT16").__copy__(), new T_intName(((53 : GoUInt32)), "R_PPC64_PLTGOT16_LO").__copy__(),
	new T_intName(((54 : GoUInt32)), "R_PPC64_PLTGOT16_HI").__copy__(), new T_intName(((55 : GoUInt32)), "R_PPC64_PLTGOT16_HA").__copy__(),
	new T_intName(((56 : GoUInt32)), "R_PPC64_ADDR16_DS").__copy__(), new T_intName(((57 : GoUInt32)), "R_PPC64_ADDR16_LO_DS").__copy__(),
	new T_intName(((58 : GoUInt32)), "R_PPC64_GOT16_DS").__copy__(), new T_intName(((59 : GoUInt32)), "R_PPC64_GOT16_LO_DS").__copy__(),
	new T_intName(((60 : GoUInt32)), "R_PPC64_PLT16_LO_DS").__copy__(), new T_intName(((61 : GoUInt32)), "R_PPC64_SECTOFF_DS").__copy__(),
	new T_intName(((61 : GoUInt32)), "R_PPC64_SECTOFF_LO_DS").__copy__(), new T_intName(((63 : GoUInt32)), "R_PPC64_TOC16_DS").__copy__(),
	new T_intName(((64 : GoUInt32)), "R_PPC64_TOC16_LO_DS").__copy__(), new T_intName(((65 : GoUInt32)), "R_PPC64_PLTGOT16_DS").__copy__(),
	new T_intName(((66 : GoUInt32)), "R_PPC64_PLTGOT_LO_DS").__copy__(), new T_intName(((67 : GoUInt32)), "R_PPC64_TLS").__copy__(),
	new T_intName(((68 : GoUInt32)), "R_PPC64_DTPMOD64").__copy__(), new T_intName(((69 : GoUInt32)), "R_PPC64_TPREL16").__copy__(),
	new T_intName(((70 : GoUInt32)), "R_PPC64_TPREL16_LO").__copy__(), new T_intName(((71 : GoUInt32)), "R_PPC64_TPREL16_HI").__copy__(),
	new T_intName(((72 : GoUInt32)), "R_PPC64_TPREL16_HA").__copy__(), new T_intName(((73 : GoUInt32)), "R_PPC64_TPREL64").__copy__(),
	new T_intName(((74 : GoUInt32)), "R_PPC64_DTPREL16").__copy__(), new T_intName(((75 : GoUInt32)), "R_PPC64_DTPREL16_LO").__copy__(),
	new T_intName(((76 : GoUInt32)), "R_PPC64_DTPREL16_HI").__copy__(), new T_intName(((77 : GoUInt32)), "R_PPC64_DTPREL16_HA").__copy__(),
	new T_intName(((78 : GoUInt32)), "R_PPC64_DTPREL64").__copy__(), new T_intName(((79 : GoUInt32)), "R_PPC64_GOT_TLSGD16").__copy__(),
	new T_intName(((80 : GoUInt32)), "R_PPC64_GOT_TLSGD16_LO").__copy__(), new T_intName(((81 : GoUInt32)), "R_PPC64_GOT_TLSGD16_HI").__copy__(),
	new T_intName(((82 : GoUInt32)), "R_PPC64_GOT_TLSGD16_HA").__copy__(), new T_intName(((83 : GoUInt32)), "R_PPC64_GOT_TLSLD16").__copy__(),
	new T_intName(((84 : GoUInt32)), "R_PPC64_GOT_TLSLD16_LO").__copy__(), new T_intName(((85 : GoUInt32)), "R_PPC64_GOT_TLSLD16_HI").__copy__(),
	new T_intName(((86 : GoUInt32)), "R_PPC64_GOT_TLSLD16_HA").__copy__(), new T_intName(((87 : GoUInt32)), "R_PPC64_GOT_TPREL16_DS").__copy__(),
	new T_intName(((88 : GoUInt32)), "R_PPC64_GOT_TPREL16_LO_DS").__copy__(), new T_intName(((89 : GoUInt32)), "R_PPC64_GOT_TPREL16_HI").__copy__(),
	new T_intName(((90 : GoUInt32)), "R_PPC64_GOT_TPREL16_HA").__copy__(), new T_intName(((91 : GoUInt32)), "R_PPC64_GOT_DTPREL16_DS").__copy__(),
	new T_intName(((92 : GoUInt32)), "R_PPC64_GOT_DTPREL16_LO_DS").__copy__(), new T_intName(((93 : GoUInt32)), "R_PPC64_GOT_DTPREL16_HI").__copy__(),
	new T_intName(((94 : GoUInt32)), "R_PPC64_GOT_DTPREL16_HA").__copy__(), new T_intName(((95 : GoUInt32)), "R_PPC64_TPREL16_DS").__copy__(),
	new T_intName(((96 : GoUInt32)), "R_PPC64_TPREL16_LO_DS").__copy__(), new T_intName(((97 : GoUInt32)), "R_PPC64_TPREL16_HIGHER").__copy__(),
	new T_intName(((98 : GoUInt32)), "R_PPC64_TPREL16_HIGHERA").__copy__(), new T_intName(((99 : GoUInt32)), "R_PPC64_TPREL16_HIGHEST").__copy__(),
	new T_intName(((100 : GoUInt32)), "R_PPC64_TPREL16_HIGHESTA").__copy__(), new T_intName(((101 : GoUInt32)), "R_PPC64_DTPREL16_DS").__copy__(),
	new T_intName(((102 : GoUInt32)), "R_PPC64_DTPREL16_LO_DS").__copy__(), new T_intName(((103 : GoUInt32)), "R_PPC64_DTPREL16_HIGHER").__copy__(),
	new T_intName(((104 : GoUInt32)), "R_PPC64_DTPREL16_HIGHERA").__copy__(), new T_intName(((105 : GoUInt32)), "R_PPC64_DTPREL16_HIGHEST").__copy__(),
	new T_intName(((106 : GoUInt32)), "R_PPC64_DTPREL16_HIGHESTA").__copy__(), new T_intName(((107 : GoUInt32)), "R_PPC64_TLSGD").__copy__(),
	new T_intName(((108 : GoUInt32)), "R_PPC64_TLSLD").__copy__(), new T_intName(((109 : GoUInt32)), "R_PPC64_TOCSAVE").__copy__(),
	new T_intName(((110 : GoUInt32)), "R_PPC64_ADDR16_HIGH").__copy__(), new T_intName(((111 : GoUInt32)), "R_PPC64_ADDR16_HIGHA").__copy__(),
	new T_intName(((112 : GoUInt32)), "R_PPC64_TPREL16_HIGH").__copy__(), new T_intName(((113 : GoUInt32)), "R_PPC64_TPREL16_HIGHA").__copy__(),
	new T_intName(((114 : GoUInt32)), "R_PPC64_DTPREL16_HIGH").__copy__(), new T_intName(((115 : GoUInt32)), "R_PPC64_DTPREL16_HIGHA").__copy__(),
	new T_intName(((116 : GoUInt32)), "R_PPC64_REL24_NOTOC").__copy__(), new T_intName(((117 : GoUInt32)), "R_PPC64_ADDR64_LOCAL").__copy__(),
	new T_intName(((118 : GoUInt32)), "R_PPC64_ENTRY").__copy__(), new T_intName(((246 : GoUInt32)), "R_PPC64_REL16DX_HA").__copy__(),
	new T_intName(((247 : GoUInt32)), "R_PPC64_JMP_IREL").__copy__(), new T_intName(((248 : GoUInt32)), "R_PPC64_IRELATIVE").__copy__(),
	new T_intName(((249 : GoUInt32)), "R_PPC64_REL16").__copy__(), new T_intName(((250 : GoUInt32)), "R_PPC64_REL16_LO").__copy__(),
	new T_intName(((251 : GoUInt32)), "R_PPC64_REL16_HI").__copy__(), new T_intName(((252 : GoUInt32)), "R_PPC64_REL16_HA").__copy__());
...
var _typeStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "ET_NONE").__copy__(),
	new T_intName(((1 : GoUInt32)), "ET_REL").__copy__(), new T_intName(((2 : GoUInt32)), "ET_EXEC").__copy__(),
	new T_intName(((3 : GoUInt32)), "ET_DYN").__copy__(), new T_intName(((4 : GoUInt32)), "ET_CORE").__copy__(),
	new T_intName(((65024 : GoUInt32)), "ET_LOOS").__copy__(), new T_intName(((65279 : GoUInt32)), "ET_HIOS").__copy__(),
	new T_intName(((65280 : GoUInt32)), "ET_LOPROC").__copy__(), new T_intName(((65535 : GoUInt32)), "ET_HIPROC").__copy__());
...
var _versionStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "EV_NONE").__copy__(),
	new T_intName(((1 : GoUInt32)), "EV_CURRENT").__copy__());
...
var _ptStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "PT_NULL").__copy__(),
	new T_intName(((1 : GoUInt32)), "PT_LOAD").__copy__(), new T_intName(((2 : GoUInt32)), "PT_DYNAMIC").__copy__(),
	new T_intName(((3 : GoUInt32)), "PT_INTERP").__copy__(), new T_intName(((4 : GoUInt32)), "PT_NOTE").__copy__(),
	new T_intName(((5 : GoUInt32)), "PT_SHLIB").__copy__(), new T_intName(((6 : GoUInt32)), "PT_PHDR").__copy__(),
	new T_intName(((7 : GoUInt32)), "PT_TLS").__copy__(), new T_intName(((1610612736 : GoUInt32)), "PT_LOOS").__copy__(),
	new T_intName(((1685382480 : GoUInt32)), "PT_GNU_EH_FRAME").__copy__(), new T_intName(((1685382481 : GoUInt32)), "PT_GNU_STACK").__copy__(),
	new T_intName(((1685382482 : GoUInt32)), "PT_GNU_RELRO").__copy__(), new T_intName(((1685382483 : GoUInt32)), "PT_GNU_PROPERTY").__copy__(),
	new T_intName(((1694766464 : GoUInt32)), "PT_PAX_FLAGS").__copy__(), new T_intName(((1705237478 : GoUInt32)), "PT_OPENBSD_RANDOMIZE").__copy__(),
	new T_intName(((1705237479 : GoUInt32)), "PT_OPENBSD_WXNEEDED").__copy__(), new T_intName(((1705253862 : GoUInt32)), "PT_OPENBSD_BOOTDATA").__copy__(),
	new T_intName(((1879048187 : GoUInt32)), "PT_SUNWSTACK").__copy__(), new T_intName(((1879048191 : GoUInt32)), "PT_HIOS").__copy__(),
	new T_intName(((1879048192 : GoUInt32)), "PT_LOPROC").__copy__(), new T_intName(((2147483647 : GoUInt32)), "PT_HIPROC").__copy__());
...
var _r386Strings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "R_386_NONE").__copy__(),
	new T_intName(((1 : GoUInt32)), "R_386_32").__copy__(), new T_intName(((2 : GoUInt32)), "R_386_PC32").__copy__(),
	new T_intName(((3 : GoUInt32)), "R_386_GOT32").__copy__(), new T_intName(((4 : GoUInt32)), "R_386_PLT32").__copy__(),
	new T_intName(((5 : GoUInt32)), "R_386_COPY").__copy__(), new T_intName(((6 : GoUInt32)), "R_386_GLOB_DAT").__copy__(),
	new T_intName(((7 : GoUInt32)), "R_386_JMP_SLOT").__copy__(), new T_intName(((8 : GoUInt32)), "R_386_RELATIVE").__copy__(),
	new T_intName(((9 : GoUInt32)), "R_386_GOTOFF").__copy__(), new T_intName(((10 : GoUInt32)), "R_386_GOTPC").__copy__(),
	new T_intName(((11 : GoUInt32)), "R_386_32PLT").__copy__(), new T_intName(((14 : GoUInt32)), "R_386_TLS_TPOFF").__copy__(),
	new T_intName(((15 : GoUInt32)), "R_386_TLS_IE").__copy__(), new T_intName(((16 : GoUInt32)), "R_386_TLS_GOTIE").__copy__(),
	new T_intName(((17 : GoUInt32)), "R_386_TLS_LE").__copy__(), new T_intName(((18 : GoUInt32)), "R_386_TLS_GD").__copy__(),
	new T_intName(((19 : GoUInt32)), "R_386_TLS_LDM").__copy__(), new T_intName(((20 : GoUInt32)), "R_386_16").__copy__(),
	new T_intName(((21 : GoUInt32)), "R_386_PC16").__copy__(), new T_intName(((22 : GoUInt32)), "R_386_8").__copy__(),
	new T_intName(((23 : GoUInt32)), "R_386_PC8").__copy__(), new T_intName(((24 : GoUInt32)), "R_386_TLS_GD_32").__copy__(),
	new T_intName(((25 : GoUInt32)), "R_386_TLS_GD_PUSH").__copy__(), new T_intName(((26 : GoUInt32)), "R_386_TLS_GD_CALL").__copy__(),
	new T_intName(((27 : GoUInt32)), "R_386_TLS_GD_POP").__copy__(), new T_intName(((28 : GoUInt32)), "R_386_TLS_LDM_32").__copy__(),
	new T_intName(((29 : GoUInt32)), "R_386_TLS_LDM_PUSH").__copy__(), new T_intName(((30 : GoUInt32)), "R_386_TLS_LDM_CALL").__copy__(),
	new T_intName(((31 : GoUInt32)), "R_386_TLS_LDM_POP").__copy__(), new T_intName(((32 : GoUInt32)), "R_386_TLS_LDO_32").__copy__(),
	new T_intName(((33 : GoUInt32)), "R_386_TLS_IE_32").__copy__(), new T_intName(((34 : GoUInt32)), "R_386_TLS_LE_32").__copy__(),
	new T_intName(((35 : GoUInt32)), "R_386_TLS_DTPMOD32").__copy__(), new T_intName(((36 : GoUInt32)), "R_386_TLS_DTPOFF32").__copy__(),
	new T_intName(((37 : GoUInt32)), "R_386_TLS_TPOFF32").__copy__(), new T_intName(((38 : GoUInt32)), "R_386_SIZE32").__copy__(),
	new T_intName(((39 : GoUInt32)), "R_386_TLS_GOTDESC").__copy__(), new T_intName(((40 : GoUInt32)), "R_386_TLS_DESC_CALL").__copy__(),
	new T_intName(((41 : GoUInt32)), "R_386_TLS_DESC").__copy__(), new T_intName(((42 : GoUInt32)), "R_386_IRELATIVE").__copy__(),
...
var _classStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "ELFCLASSNONE").__copy__(),
	new T_intName(((1 : GoUInt32)), "ELFCLASS32").__copy__(), new T_intName(((2 : GoUInt32)), "ELFCLASS64").__copy__());
...
var _osabiStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "ELFOSABI_NONE").__copy__(),
	new T_intName(((1 : GoUInt32)), "ELFOSABI_HPUX").__copy__(), new T_intName(((2 : GoUInt32)), "ELFOSABI_NETBSD").__copy__(),
	new T_intName(((3 : GoUInt32)), "ELFOSABI_LINUX").__copy__(), new T_intName(((4 : GoUInt32)), "ELFOSABI_HURD").__copy__(),
	new T_intName(((5 : GoUInt32)), "ELFOSABI_86OPEN").__copy__(), new T_intName(((6 : GoUInt32)), "ELFOSABI_SOLARIS").__copy__(),
	new T_intName(((7 : GoUInt32)), "ELFOSABI_AIX").__copy__(), new T_intName(((8 : GoUInt32)), "ELFOSABI_IRIX").__copy__(),
	new T_intName(((9 : GoUInt32)), "ELFOSABI_FREEBSD").__copy__(), new T_intName(((10 : GoUInt32)), "ELFOSABI_TRU64").__copy__(),
	new T_intName(((11 : GoUInt32)), "ELFOSABI_MODESTO").__copy__(), new T_intName(((12 : GoUInt32)), "ELFOSABI_OPENBSD").__copy__(),
	new T_intName(((13 : GoUInt32)), "ELFOSABI_OPENVMS").__copy__(), new T_intName(((14 : GoUInt32)), "ELFOSABI_NSK").__copy__(),
	new T_intName(((15 : GoUInt32)), "ELFOSABI_AROS").__copy__(), new T_intName(((16 : GoUInt32)), "ELFOSABI_FENIXOS").__copy__(),
	new T_intName(((17 : GoUInt32)), "ELFOSABI_CLOUDABI").__copy__(), new T_intName(((97 : GoUInt32)), "ELFOSABI_ARM").__copy__(),
...
var _dtStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "DT_NULL").__copy__(),
	new T_intName(((1 : GoUInt32)), "DT_NEEDED").__copy__(), new T_intName(((2 : GoUInt32)), "DT_PLTRELSZ").__copy__(),
	new T_intName(((3 : GoUInt32)), "DT_PLTGOT").__copy__(), new T_intName(((4 : GoUInt32)), "DT_HASH").__copy__(),
	new T_intName(((5 : GoUInt32)), "DT_STRTAB").__copy__(), new T_intName(((6 : GoUInt32)), "DT_SYMTAB").__copy__(),
	new T_intName(((7 : GoUInt32)), "DT_RELA").__copy__(), new T_intName(((8 : GoUInt32)), "DT_RELASZ").__copy__(),
	new T_intName(((9 : GoUInt32)), "DT_RELAENT").__copy__(), new T_intName(((10 : GoUInt32)), "DT_STRSZ").__copy__(),
	new T_intName(((11 : GoUInt32)), "DT_SYMENT").__copy__(), new T_intName(((12 : GoUInt32)), "DT_INIT").__copy__(),
	new T_intName(((13 : GoUInt32)), "DT_FINI").__copy__(), new T_intName(((14 : GoUInt32)), "DT_SONAME").__copy__(),
	new T_intName(((15 : GoUInt32)), "DT_RPATH").__copy__(), new T_intName(((16 : GoUInt32)), "DT_SYMBOLIC").__copy__(),
	new T_intName(((17 : GoUInt32)), "DT_REL").__copy__(), new T_intName(((18 : GoUInt32)), "DT_RELSZ").__copy__(),
	new T_intName(((19 : GoUInt32)), "DT_RELENT").__copy__(), new T_intName(((20 : GoUInt32)), "DT_PLTREL").__copy__(),
	new T_intName(((21 : GoUInt32)), "DT_DEBUG").__copy__(), new T_intName(((22 : GoUInt32)), "DT_TEXTREL").__copy__(),
	new T_intName(((23 : GoUInt32)), "DT_JMPREL").__copy__(), new T_intName(((24 : GoUInt32)), "DT_BIND_NOW").__copy__(),
	new T_intName(((25 : GoUInt32)), "DT_INIT_ARRAY").__copy__(), new T_intName(((26 : GoUInt32)), "DT_FINI_ARRAY").__copy__(),
	new T_intName(((27 : GoUInt32)), "DT_INIT_ARRAYSZ").__copy__(), new T_intName(((28 : GoUInt32)), "DT_FINI_ARRAYSZ").__copy__(),
	new T_intName(((29 : GoUInt32)), "DT_RUNPATH").__copy__(), new T_intName(((30 : GoUInt32)), "DT_FLAGS").__copy__(),
	new T_intName(((32 : GoUInt32)), "DT_ENCODING").__copy__(), new T_intName(((32 : GoUInt32)), "DT_PREINIT_ARRAY").__copy__(),
	new T_intName(((33 : GoUInt32)), "DT_PREINIT_ARRAYSZ").__copy__(), new T_intName(((34 : GoUInt32)), "DT_SYMTAB_SHNDX").__copy__(),
	new T_intName(((1610612749 : GoUInt32)), "DT_LOOS").__copy__(), new T_intName(((1879044096 : GoUInt32)), "DT_HIOS").__copy__(),
	new T_intName(((1879047424 : GoUInt32)), "DT_VALRNGLO").__copy__(), new T_intName(((1879047669 : GoUInt32)), "DT_GNU_PRELINKED").__copy__(),
	new T_intName(((1879047670 : GoUInt32)), "DT_GNU_CONFLICTSZ").__copy__(), new T_intName(((1879047671 : GoUInt32)), "DT_GNU_LIBLISTSZ").__copy__(),
	new T_intName(((1879047672 : GoUInt32)), "DT_CHECKSUM").__copy__(), new T_intName(((1879047673 : GoUInt32)), "DT_PLTPADSZ").__copy__(),
	new T_intName(((1879047674 : GoUInt32)), "DT_MOVEENT").__copy__(), new T_intName(((1879047675 : GoUInt32)), "DT_MOVESZ").__copy__(),
	new T_intName(((1879047676 : GoUInt32)), "DT_FEATURE").__copy__(), new T_intName(((1879047677 : GoUInt32)), "DT_POSFLAG_1").__copy__(),
	new T_intName(((1879047678 : GoUInt32)), "DT_SYMINSZ").__copy__(), new T_intName(((1879047679 : GoUInt32)), "DT_SYMINENT").__copy__(),
	new T_intName(((1879047679 : GoUInt32)), "DT_VALRNGHI").__copy__(), new T_intName(((1879047680 : GoUInt32)), "DT_ADDRRNGLO").__copy__(),
	new T_intName(((1879047925 : GoUInt32)), "DT_GNU_HASH").__copy__(), new T_intName(((1879047926 : GoUInt32)), "DT_TLSDESC_PLT").__copy__(),
	new T_intName(((1879047927 : GoUInt32)), "DT_TLSDESC_GOT").__copy__(), new T_intName(((1879047928 : GoUInt32)), "DT_GNU_CONFLICT").__copy__(),
	new T_intName(((1879047929 : GoUInt32)), "DT_GNU_LIBLIST").__copy__(), new T_intName(((1879047930 : GoUInt32)), "DT_CONFIG").__copy__(),
	new T_intName(((1879047931 : GoUInt32)), "DT_DEPAUDIT").__copy__(), new T_intName(((1879047932 : GoUInt32)), "DT_AUDIT").__copy__(),
	new T_intName(((1879047933 : GoUInt32)), "DT_PLTPAD").__copy__(), new T_intName(((1879047934 : GoUInt32)), "DT_MOVETAB").__copy__(),
	new T_intName(((1879047935 : GoUInt32)), "DT_SYMINFO").__copy__(), new T_intName(((1879047935 : GoUInt32)), "DT_ADDRRNGHI").__copy__(),
	new T_intName(((1879048176 : GoUInt32)), "DT_VERSYM").__copy__(), new T_intName(((1879048185 : GoUInt32)), "DT_RELACOUNT").__copy__(),
	new T_intName(((1879048186 : GoUInt32)), "DT_RELCOUNT").__copy__(), new T_intName(((1879048187 : GoUInt32)), "DT_FLAGS_1").__copy__(),
	new T_intName(((1879048188 : GoUInt32)), "DT_VERDEF").__copy__(), new T_intName(((1879048189 : GoUInt32)), "DT_VERDEFNUM").__copy__(),
	new T_intName(((1879048190 : GoUInt32)), "DT_VERNEED").__copy__(), new T_intName(((1879048191 : GoUInt32)), "DT_VERNEEDNUM").__copy__(),
	new T_intName(((1879048192 : GoUInt32)), "DT_LOPROC").__copy__(), new T_intName(((2147483645 : GoUInt32)), "DT_AUXILIARY").__copy__(),
	new T_intName(((2147483646 : GoUInt32)), "DT_USED").__copy__(), new T_intName(((2147483647 : GoUInt32)), "DT_FILTER").__copy__());

final em_8051:Machine = new Machine(((165 : GoUInt16)));

var _rarmStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "R_ARM_NONE").__copy__(),
	new T_intName(((1 : GoUInt32)), "R_ARM_PC24").__copy__(), new T_intName(((2 : GoUInt32)), "R_ARM_ABS32").__copy__(),
	new T_intName(((3 : GoUInt32)), "R_ARM_REL32").__copy__(), new T_intName(((4 : GoUInt32)), "R_ARM_PC13").__copy__(),
	new T_intName(((5 : GoUInt32)), "R_ARM_ABS16").__copy__(), new T_intName(((6 : GoUInt32)), "R_ARM_ABS12").__copy__(),
	new T_intName(((7 : GoUInt32)), "R_ARM_THM_ABS5").__copy__(), new T_intName(((8 : GoUInt32)), "R_ARM_ABS8").__copy__(),
	new T_intName(((9 : GoUInt32)), "R_ARM_SBREL32").__copy__(), new T_intName(((10 : GoUInt32)), "R_ARM_THM_PC22").__copy__(),
	new T_intName(((11 : GoUInt32)), "R_ARM_THM_PC8").__copy__(), new T_intName(((12 : GoUInt32)), "R_ARM_AMP_VCALL9").__copy__(),
	new T_intName(((13 : GoUInt32)), "R_ARM_SWI24").__copy__(), new T_intName(((14 : GoUInt32)), "R_ARM_THM_SWI8").__copy__(),
	new T_intName(((15 : GoUInt32)), "R_ARM_XPC25").__copy__(), new T_intName(((16 : GoUInt32)), "R_ARM_THM_XPC22").__copy__(),
	new T_intName(((17 : GoUInt32)), "R_ARM_TLS_DTPMOD32").__copy__(), new T_intName(((18 : GoUInt32)), "R_ARM_TLS_DTPOFF32").__copy__(),
	new T_intName(((19 : GoUInt32)), "R_ARM_TLS_TPOFF32").__copy__(), new T_intName(((20 : GoUInt32)), "R_ARM_COPY").__copy__(),
	new T_intName(((21 : GoUInt32)), "R_ARM_GLOB_DAT").__copy__(), new T_intName(((22 : GoUInt32)), "R_ARM_JUMP_SLOT").__copy__(),
	new T_intName(((23 : GoUInt32)), "R_ARM_RELATIVE").__copy__(), new T_intName(((24 : GoUInt32)), "R_ARM_GOTOFF").__copy__(),
	new T_intName(((25 : GoUInt32)), "R_ARM_GOTPC").__copy__(), new T_intName(((26 : GoUInt32)), "R_ARM_GOT32").__copy__(),
	new T_intName(((27 : GoUInt32)), "R_ARM_PLT32").__copy__(), new T_intName(((28 : GoUInt32)), "R_ARM_CALL").__copy__(),
	new T_intName(((29 : GoUInt32)), "R_ARM_JUMP24").__copy__(), new T_intName(((30 : GoUInt32)), "R_ARM_THM_JUMP24").__copy__(),
	new T_intName(((31 : GoUInt32)), "R_ARM_BASE_ABS").__copy__(), new T_intName(((32 : GoUInt32)), "R_ARM_ALU_PCREL_7_0").__copy__(),
	new T_intName(((33 : GoUInt32)), "R_ARM_ALU_PCREL_15_8").__copy__(), new T_intName(((34 : GoUInt32)), "R_ARM_ALU_PCREL_23_15").__copy__(),
	new T_intName(((35 : GoUInt32)), "R_ARM_LDR_SBREL_11_10_NC").__copy__(), new T_intName(((36 : GoUInt32)), "R_ARM_ALU_SBREL_19_12_NC").__copy__(),
	new T_intName(((37 : GoUInt32)), "R_ARM_ALU_SBREL_27_20_CK").__copy__(), new T_intName(((38 : GoUInt32)), "R_ARM_TARGET1").__copy__(),
	new T_intName(((39 : GoUInt32)), "R_ARM_SBREL31").__copy__(), new T_intName(((40 : GoUInt32)), "R_ARM_V4BX").__copy__(),
	new T_intName(((41 : GoUInt32)), "R_ARM_TARGET2").__copy__(), new T_intName(((42 : GoUInt32)), "R_ARM_PREL31").__copy__(),
	new T_intName(((43 : GoUInt32)), "R_ARM_MOVW_ABS_NC").__copy__(), new T_intName(((44 : GoUInt32)), "R_ARM_MOVT_ABS").__copy__(),
	new T_intName(((45 : GoUInt32)), "R_ARM_MOVW_PREL_NC").__copy__(), new T_intName(((46 : GoUInt32)), "R_ARM_MOVT_PREL").__copy__(),
	new T_intName(((47 : GoUInt32)), "R_ARM_THM_MOVW_ABS_NC").__copy__(), new T_intName(((48 : GoUInt32)), "R_ARM_THM_MOVT_ABS").__copy__(),
	new T_intName(((49 : GoUInt32)), "R_ARM_THM_MOVW_PREL_NC").__copy__(), new T_intName(((50 : GoUInt32)), "R_ARM_THM_MOVT_PREL").__copy__(),
	new T_intName(((51 : GoUInt32)), "R_ARM_THM_JUMP19").__copy__(), new T_intName(((52 : GoUInt32)), "R_ARM_THM_JUMP6").__copy__(),
	new T_intName(((53 : GoUInt32)), "R_ARM_THM_ALU_PREL_11_0").__copy__(), new T_intName(((54 : GoUInt32)), "R_ARM_THM_PC12").__copy__(),
	new T_intName(((55 : GoUInt32)), "R_ARM_ABS32_NOI").__copy__(), new T_intName(((56 : GoUInt32)), "R_ARM_REL32_NOI").__copy__(),
	new T_intName(((57 : GoUInt32)), "R_ARM_ALU_PC_G0_NC").__copy__(), new T_intName(((58 : GoUInt32)), "R_ARM_ALU_PC_G0").__copy__(),
	new T_intName(((59 : GoUInt32)), "R_ARM_ALU_PC_G1_NC").__copy__(), new T_intName(((60 : GoUInt32)), "R_ARM_ALU_PC_G1").__copy__(),
	new T_intName(((61 : GoUInt32)), "R_ARM_ALU_PC_G2").__copy__(), new T_intName(((62 : GoUInt32)), "R_ARM_LDR_PC_G1").__copy__(),
	new T_intName(((63 : GoUInt32)), "R_ARM_LDR_PC_G2").__copy__(), new T_intName(((64 : GoUInt32)), "R_ARM_LDRS_PC_G0").__copy__(),
	new T_intName(((65 : GoUInt32)), "R_ARM_LDRS_PC_G1").__copy__(), new T_intName(((66 : GoUInt32)), "R_ARM_LDRS_PC_G2").__copy__(),
	new T_intName(((67 : GoUInt32)), "R_ARM_LDC_PC_G0").__copy__(), new T_intName(((68 : GoUInt32)), "R_ARM_LDC_PC_G1").__copy__(),
	new T_intName(((69 : GoUInt32)), "R_ARM_LDC_PC_G2").__copy__(), new T_intName(((70 : GoUInt32)), "R_ARM_ALU_SB_G0_NC").__copy__(),
	new T_intName(((71 : GoUInt32)), "R_ARM_ALU_SB_G0").__copy__(), new T_intName(((72 : GoUInt32)), "R_ARM_ALU_SB_G1_NC").__copy__(),
	new T_intName(((73 : GoUInt32)), "R_ARM_ALU_SB_G1").__copy__(), new T_intName(((74 : GoUInt32)), "R_ARM_ALU_SB_G2").__copy__(),
	new T_intName(((75 : GoUInt32)), "R_ARM_LDR_SB_G0").__copy__(), new T_intName(((76 : GoUInt32)), "R_ARM_LDR_SB_G1").__copy__(),
	new T_intName(((77 : GoUInt32)), "R_ARM_LDR_SB_G2").__copy__(), new T_intName(((78 : GoUInt32)), "R_ARM_LDRS_SB_G0").__copy__(),
	new T_intName(((79 : GoUInt32)), "R_ARM_LDRS_SB_G1").__copy__(), new T_intName(((80 : GoUInt32)), "R_ARM_LDRS_SB_G2").__copy__(),
	new T_intName(((81 : GoUInt32)), "R_ARM_LDC_SB_G0").__copy__(), new T_intName(((82 : GoUInt32)), "R_ARM_LDC_SB_G1").__copy__(),
	new T_intName(((83 : GoUInt32)), "R_ARM_LDC_SB_G2").__copy__(), new T_intName(((84 : GoUInt32)), "R_ARM_MOVW_BREL_NC").__copy__(),
	new T_intName(((85 : GoUInt32)), "R_ARM_MOVT_BREL").__copy__(), new T_intName(((86 : GoUInt32)), "R_ARM_MOVW_BREL").__copy__(),
	new T_intName(((87 : GoUInt32)), "R_ARM_THM_MOVW_BREL_NC").__copy__(), new T_intName(((88 : GoUInt32)), "R_ARM_THM_MOVT_BREL").__copy__(),
	new T_intName(((89 : GoUInt32)), "R_ARM_THM_MOVW_BREL").__copy__(), new T_intName(((90 : GoUInt32)), "R_ARM_TLS_GOTDESC").__copy__(),
	new T_intName(((91 : GoUInt32)), "R_ARM_TLS_CALL").__copy__(), new T_intName(((92 : GoUInt32)), "R_ARM_TLS_DESCSEQ").__copy__(),
	new T_intName(((93 : GoUInt32)), "R_ARM_THM_TLS_CALL").__copy__(), new T_intName(((94 : GoUInt32)), "R_ARM_PLT32_ABS").__copy__(),
	new T_intName(((95 : GoUInt32)), "R_ARM_GOT_ABS").__copy__(), new T_intName(((96 : GoUInt32)), "R_ARM_GOT_PREL").__copy__(),
	new T_intName(((97 : GoUInt32)), "R_ARM_GOT_BREL12").__copy__(), new T_intName(((98 : GoUInt32)), "R_ARM_GOTOFF12").__copy__(),
	new T_intName(((99 : GoUInt32)), "R_ARM_GOTRELAX").__copy__(), new T_intName(((100 : GoUInt32)), "R_ARM_GNU_VTENTRY").__copy__(),
	new T_intName(((101 : GoUInt32)), "R_ARM_GNU_VTINHERIT").__copy__(), new T_intName(((102 : GoUInt32)), "R_ARM_THM_JUMP11").__copy__(),
	new T_intName(((103 : GoUInt32)), "R_ARM_THM_JUMP8").__copy__(), new T_intName(((104 : GoUInt32)), "R_ARM_TLS_GD32").__copy__(),
	new T_intName(((105 : GoUInt32)), "R_ARM_TLS_LDM32").__copy__(), new T_intName(((106 : GoUInt32)), "R_ARM_TLS_LDO32").__copy__(),
	new T_intName(((107 : GoUInt32)), "R_ARM_TLS_IE32").__copy__(), new T_intName(((108 : GoUInt32)), "R_ARM_TLS_LE32").__copy__(),
	new T_intName(((109 : GoUInt32)), "R_ARM_TLS_LDO12").__copy__(), new T_intName(((110 : GoUInt32)), "R_ARM_TLS_LE12").__copy__(),
	new T_intName(((111 : GoUInt32)), "R_ARM_TLS_IE12GP").__copy__(), new T_intName(((112 : GoUInt32)), "R_ARM_PRIVATE_0").__copy__(),
	new T_intName(((113 : GoUInt32)), "R_ARM_PRIVATE_1").__copy__(), new T_intName(((114 : GoUInt32)), "R_ARM_PRIVATE_2").__copy__(),
	new T_intName(((115 : GoUInt32)), "R_ARM_PRIVATE_3").__copy__(), new T_intName(((116 : GoUInt32)), "R_ARM_PRIVATE_4").__copy__(),
	new T_intName(((117 : GoUInt32)), "R_ARM_PRIVATE_5").__copy__(), new T_intName(((118 : GoUInt32)), "R_ARM_PRIVATE_6").__copy__(),
	new T_intName(((119 : GoUInt32)), "R_ARM_PRIVATE_7").__copy__(), new T_intName(((120 : GoUInt32)), "R_ARM_PRIVATE_8").__copy__(),
	new T_intName(((121 : GoUInt32)), "R_ARM_PRIVATE_9").__copy__(), new T_intName(((122 : GoUInt32)), "R_ARM_PRIVATE_10").__copy__(),
	new T_intName(((123 : GoUInt32)), "R_ARM_PRIVATE_11").__copy__(), new T_intName(((124 : GoUInt32)), "R_ARM_PRIVATE_12").__copy__(),
	new T_intName(((125 : GoUInt32)), "R_ARM_PRIVATE_13").__copy__(), new T_intName(((126 : GoUInt32)), "R_ARM_PRIVATE_14").__copy__(),
	new T_intName(((127 : GoUInt32)), "R_ARM_PRIVATE_15").__copy__(), new T_intName(((128 : GoUInt32)), "R_ARM_ME_TOO").__copy__(),
	new T_intName(((129 : GoUInt32)), "R_ARM_THM_TLS_DESCSEQ16").__copy__(), new T_intName(((130 : GoUInt32)), "R_ARM_THM_TLS_DESCSEQ32").__copy__(),
	new T_intName(((131 : GoUInt32)), "R_ARM_THM_GOT_BREL12").__copy__(), new T_intName(((132 : GoUInt32)), "R_ARM_THM_ALU_ABS_G0_NC").__copy__(),
	new T_intName(((133 : GoUInt32)), "R_ARM_THM_ALU_ABS_G1_NC").__copy__(), new T_intName(((134 : GoUInt32)), "R_ARM_THM_ALU_ABS_G2_NC").__copy__(),
	new T_intName(((135 : GoUInt32)), "R_ARM_THM_ALU_ABS_G3").__copy__(), new T_intName(((160 : GoUInt32)), "R_ARM_IRELATIVE").__copy__(),
	new T_intName(((249 : GoUInt32)), "R_ARM_RXPC25").__copy__(), new T_intName(((250 : GoUInt32)), "R_ARM_RSBREL32").__copy__(),
	new T_intName(((251 : GoUInt32)), "R_ARM_THM_RPC22").__copy__(), new T_intName(((252 : GoUInt32)), "R_ARM_RREL32").__copy__(),
	new T_intName(((253 : GoUInt32)), "R_ARM_RABS32").__copy__(), new T_intName(((254 : GoUInt32)), "R_ARM_RPC24").__copy__(),
...
var _rmipsStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "R_MIPS_NONE").__copy__(),
	new T_intName(((1 : GoUInt32)), "R_MIPS_16").__copy__(), new T_intName(((2 : GoUInt32)), "R_MIPS_32").__copy__(),
	new T_intName(((3 : GoUInt32)), "R_MIPS_REL32").__copy__(), new T_intName(((4 : GoUInt32)), "R_MIPS_26").__copy__(),
	new T_intName(((5 : GoUInt32)), "R_MIPS_HI16").__copy__(), new T_intName(((6 : GoUInt32)), "R_MIPS_LO16").__copy__(),
	new T_intName(((7 : GoUInt32)), "R_MIPS_GPREL16").__copy__(), new T_intName(((8 : GoUInt32)), "R_MIPS_LITERAL").__copy__(),
	new T_intName(((9 : GoUInt32)), "R_MIPS_GOT16").__copy__(), new T_intName(((10 : GoUInt32)), "R_MIPS_PC16").__copy__(),
	new T_intName(((11 : GoUInt32)), "R_MIPS_CALL16").__copy__(), new T_intName(((12 : GoUInt32)), "R_MIPS_GPREL32").__copy__(),
	new T_intName(((16 : GoUInt32)), "R_MIPS_SHIFT5").__copy__(), new T_intName(((17 : GoUInt32)), "R_MIPS_SHIFT6").__copy__(),
	new T_intName(((18 : GoUInt32)), "R_MIPS_64").__copy__(), new T_intName(((19 : GoUInt32)), "R_MIPS_GOT_DISP").__copy__(),
	new T_intName(((20 : GoUInt32)), "R_MIPS_GOT_PAGE").__copy__(), new T_intName(((21 : GoUInt32)), "R_MIPS_GOT_OFST").__copy__(),
	new T_intName(((22 : GoUInt32)), "R_MIPS_GOT_HI16").__copy__(), new T_intName(((23 : GoUInt32)), "R_MIPS_GOT_LO16").__copy__(),
	new T_intName(((24 : GoUInt32)), "R_MIPS_SUB").__copy__(), new T_intName(((25 : GoUInt32)), "R_MIPS_INSERT_A").__copy__(),
	new T_intName(((26 : GoUInt32)), "R_MIPS_INSERT_B").__copy__(), new T_intName(((27 : GoUInt32)), "R_MIPS_DELETE").__copy__(),
	new T_intName(((28 : GoUInt32)), "R_MIPS_HIGHER").__copy__(), new T_intName(((29 : GoUInt32)), "R_MIPS_HIGHEST").__copy__(),
	new T_intName(((30 : GoUInt32)), "R_MIPS_CALL_HI16").__copy__(), new T_intName(((31 : GoUInt32)), "R_MIPS_CALL_LO16").__copy__(),
	new T_intName(((32 : GoUInt32)), "R_MIPS_SCN_DISP").__copy__(), new T_intName(((33 : GoUInt32)), "R_MIPS_REL16").__copy__(),
	new T_intName(((34 : GoUInt32)), "R_MIPS_ADD_IMMEDIATE").__copy__(), new T_intName(((35 : GoUInt32)), "R_MIPS_PJUMP").__copy__(),
	new T_intName(((36 : GoUInt32)), "R_MIPS_RELGOT").__copy__(), new T_intName(((37 : GoUInt32)), "R_MIPS_JALR").__copy__(),
	new T_intName(((38 : GoUInt32)), "R_MIPS_TLS_DTPMOD32").__copy__(), new T_intName(((39 : GoUInt32)), "R_MIPS_TLS_DTPREL32").__copy__(),
	new T_intName(((40 : GoUInt32)), "R_MIPS_TLS_DTPMOD64").__copy__(), new T_intName(((41 : GoUInt32)), "R_MIPS_TLS_DTPREL64").__copy__(),
	new T_intName(((42 : GoUInt32)), "R_MIPS_TLS_GD").__copy__(), new T_intName(((43 : GoUInt32)), "R_MIPS_TLS_LDM").__copy__(),
	new T_intName(((44 : GoUInt32)), "R_MIPS_TLS_DTPREL_HI16").__copy__(), new T_intName(((45 : GoUInt32)), "R_MIPS_TLS_DTPREL_LO16").__copy__(),
	new T_intName(((46 : GoUInt32)), "R_MIPS_TLS_GOTTPREL").__copy__(), new T_intName(((47 : GoUInt32)), "R_MIPS_TLS_TPREL32").__copy__(),
	new T_intName(((48 : GoUInt32)), "R_MIPS_TLS_TPREL64").__copy__(), new T_intName(((49 : GoUInt32)), "R_MIPS_TLS_TPREL_HI16").__copy__(),
...
var _ntypeStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((1 : GoUInt32)), "NT_PRSTATUS").__copy__(),
	new T_intName(((2 : GoUInt32)), "NT_FPREGSET").__copy__(), new T_intName(((3 : GoUInt32)), "NT_PRPSINFO").__copy__());
...
var _r390Strings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "R_390_NONE").__copy__(),
	new T_intName(((1 : GoUInt32)), "R_390_8").__copy__(), new T_intName(((2 : GoUInt32)), "R_390_12").__copy__(),
	new T_intName(((3 : GoUInt32)), "R_390_16").__copy__(), new T_intName(((4 : GoUInt32)), "R_390_32").__copy__(),
	new T_intName(((5 : GoUInt32)), "R_390_PC32").__copy__(), new T_intName(((6 : GoUInt32)), "R_390_GOT12").__copy__(),
	new T_intName(((7 : GoUInt32)), "R_390_GOT32").__copy__(), new T_intName(((8 : GoUInt32)), "R_390_PLT32").__copy__(),
	new T_intName(((9 : GoUInt32)), "R_390_COPY").__copy__(), new T_intName(((10 : GoUInt32)), "R_390_GLOB_DAT").__copy__(),
	new T_intName(((11 : GoUInt32)), "R_390_JMP_SLOT").__copy__(), new T_intName(((12 : GoUInt32)), "R_390_RELATIVE").__copy__(),
	new T_intName(((13 : GoUInt32)), "R_390_GOTOFF").__copy__(), new T_intName(((14 : GoUInt32)), "R_390_GOTPC").__copy__(),
	new T_intName(((15 : GoUInt32)), "R_390_GOT16").__copy__(), new T_intName(((16 : GoUInt32)), "R_390_PC16").__copy__(),
	new T_intName(((17 : GoUInt32)), "R_390_PC16DBL").__copy__(), new T_intName(((18 : GoUInt32)), "R_390_PLT16DBL").__copy__(),
	new T_intName(((19 : GoUInt32)), "R_390_PC32DBL").__copy__(), new T_intName(((20 : GoUInt32)), "R_390_PLT32DBL").__copy__(),
	new T_intName(((21 : GoUInt32)), "R_390_GOTPCDBL").__copy__(), new T_intName(((22 : GoUInt32)), "R_390_64").__copy__(),
	new T_intName(((23 : GoUInt32)), "R_390_PC64").__copy__(), new T_intName(((24 : GoUInt32)), "R_390_GOT64").__copy__(),
	new T_intName(((25 : GoUInt32)), "R_390_PLT64").__copy__(), new T_intName(((26 : GoUInt32)), "R_390_GOTENT").__copy__(),
	new T_intName(((27 : GoUInt32)), "R_390_GOTOFF16").__copy__(), new T_intName(((28 : GoUInt32)), "R_390_GOTOFF64").__copy__(),
	new T_intName(((29 : GoUInt32)), "R_390_GOTPLT12").__copy__(), new T_intName(((30 : GoUInt32)), "R_390_GOTPLT16").__copy__(),
	new T_intName(((31 : GoUInt32)), "R_390_GOTPLT32").__copy__(), new T_intName(((32 : GoUInt32)), "R_390_GOTPLT64").__copy__(),
	new T_intName(((33 : GoUInt32)), "R_390_GOTPLTENT").__copy__(), new T_intName(((34 : GoUInt32)), "R_390_GOTPLTOFF16").__copy__(),
	new T_intName(((35 : GoUInt32)), "R_390_GOTPLTOFF32").__copy__(), new T_intName(((36 : GoUInt32)), "R_390_GOTPLTOFF64").__copy__(),
	new T_intName(((37 : GoUInt32)), "R_390_TLS_LOAD").__copy__(), new T_intName(((38 : GoUInt32)), "R_390_TLS_GDCALL").__copy__(),
	new T_intName(((39 : GoUInt32)), "R_390_TLS_LDCALL").__copy__(), new T_intName(((40 : GoUInt32)), "R_390_TLS_GD32").__copy__(),
	new T_intName(((41 : GoUInt32)), "R_390_TLS_GD64").__copy__(), new T_intName(((42 : GoUInt32)), "R_390_TLS_GOTIE12").__copy__(),
	new T_intName(((43 : GoUInt32)), "R_390_TLS_GOTIE32").__copy__(), new T_intName(((44 : GoUInt32)), "R_390_TLS_GOTIE64").__copy__(),
	new T_intName(((45 : GoUInt32)), "R_390_TLS_LDM32").__copy__(), new T_intName(((46 : GoUInt32)), "R_390_TLS_LDM64").__copy__(),
	new T_intName(((47 : GoUInt32)), "R_390_TLS_IE32").__copy__(), new T_intName(((48 : GoUInt32)), "R_390_TLS_IE64").__copy__(),
	new T_intName(((49 : GoUInt32)), "R_390_TLS_IEENT").__copy__(), new T_intName(((50 : GoUInt32)), "R_390_TLS_LE32").__copy__(),
	new T_intName(((51 : GoUInt32)), "R_390_TLS_LE64").__copy__(), new T_intName(((52 : GoUInt32)), "R_390_TLS_LDO32").__copy__(),
	new T_intName(((53 : GoUInt32)), "R_390_TLS_LDO64").__copy__(), new T_intName(((54 : GoUInt32)), "R_390_TLS_DTPMOD").__copy__(),
	new T_intName(((55 : GoUInt32)), "R_390_TLS_DTPOFF").__copy__(), new T_intName(((56 : GoUInt32)), "R_390_TLS_TPOFF").__copy__(),
	new T_intName(((57 : GoUInt32)), "R_390_20").__copy__(), new T_intName(((58 : GoUInt32)), "R_390_GOT20").__copy__(),
	new T_intName(((59 : GoUInt32)), "R_390_GOTPLT20").__copy__(), new T_intName(((60 : GoUInt32)), "R_390_TLS_GOTIE20").__copy__());
...
var _shtStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "SHT_NULL").__copy__(),
	new T_intName(((1 : GoUInt32)), "SHT_PROGBITS").__copy__(), new T_intName(((2 : GoUInt32)), "SHT_SYMTAB").__copy__(),
	new T_intName(((3 : GoUInt32)), "SHT_STRTAB").__copy__(), new T_intName(((4 : GoUInt32)), "SHT_RELA").__copy__(),
	new T_intName(((5 : GoUInt32)), "SHT_HASH").__copy__(), new T_intName(((6 : GoUInt32)), "SHT_DYNAMIC").__copy__(),
	new T_intName(((7 : GoUInt32)), "SHT_NOTE").__copy__(), new T_intName(((8 : GoUInt32)), "SHT_NOBITS").__copy__(),
	new T_intName(((9 : GoUInt32)), "SHT_REL").__copy__(), new T_intName(((10 : GoUInt32)), "SHT_SHLIB").__copy__(),
	new T_intName(((11 : GoUInt32)), "SHT_DYNSYM").__copy__(), new T_intName(((14 : GoUInt32)), "SHT_INIT_ARRAY").__copy__(),
	new T_intName(((15 : GoUInt32)), "SHT_FINI_ARRAY").__copy__(), new T_intName(((16 : GoUInt32)), "SHT_PREINIT_ARRAY").__copy__(),
	new T_intName(((17 : GoUInt32)), "SHT_GROUP").__copy__(), new T_intName(((18 : GoUInt32)), "SHT_SYMTAB_SHNDX").__copy__(),
	new T_intName(((1610612736 : GoUInt32)), "SHT_LOOS").__copy__(), new T_intName(((1879048181 : GoUInt32)), "SHT_GNU_ATTRIBUTES").__copy__(),
	new T_intName(((1879048182 : GoUInt32)), "SHT_GNU_HASH").__copy__(), new T_intName(((1879048183 : GoUInt32)), "SHT_GNU_LIBLIST").__copy__(),
	new T_intName(((1879048189 : GoUInt32)), "SHT_GNU_VERDEF").__copy__(), new T_intName(((1879048190 : GoUInt32)), "SHT_GNU_VERNEED").__copy__(),
	new T_intName(((1879048191 : GoUInt32)), "SHT_GNU_VERSYM").__copy__(), new T_intName(((1879048192 : GoUInt32)), "SHT_LOPROC").__copy__(),
	new T_intName(((1879048234 : GoUInt32)), "SHT_MIPS_ABIFLAGS").__copy__(), new T_intName(((2147483647 : GoUInt32)), "SHT_HIPROC").__copy__(),
	new T_intName((("2147483648" : GoUInt32)), "SHT_LOUSER").__copy__(), new T_intName((("4294967295" : GoUInt32)), "SHT_HIUSER").__copy__());
...
var _rppcStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "R_PPC_NONE").__copy__(),
	new T_intName(((1 : GoUInt32)), "R_PPC_ADDR32").__copy__(), new T_intName(((2 : GoUInt32)), "R_PPC_ADDR24").__copy__(),
	new T_intName(((3 : GoUInt32)), "R_PPC_ADDR16").__copy__(), new T_intName(((4 : GoUInt32)), "R_PPC_ADDR16_LO").__copy__(),
	new T_intName(((5 : GoUInt32)), "R_PPC_ADDR16_HI").__copy__(), new T_intName(((6 : GoUInt32)), "R_PPC_ADDR16_HA").__copy__(),
	new T_intName(((7 : GoUInt32)), "R_PPC_ADDR14").__copy__(), new T_intName(((8 : GoUInt32)), "R_PPC_ADDR14_BRTAKEN").__copy__(),
	new T_intName(((9 : GoUInt32)), "R_PPC_ADDR14_BRNTAKEN").__copy__(), new T_intName(((10 : GoUInt32)), "R_PPC_REL24").__copy__(),
	new T_intName(((11 : GoUInt32)), "R_PPC_REL14").__copy__(), new T_intName(((12 : GoUInt32)), "R_PPC_REL14_BRTAKEN").__copy__(),
	new T_intName(((13 : GoUInt32)), "R_PPC_REL14_BRNTAKEN").__copy__(), new T_intName(((14 : GoUInt32)), "R_PPC_GOT16").__copy__(),
	new T_intName(((15 : GoUInt32)), "R_PPC_GOT16_LO").__copy__(), new T_intName(((16 : GoUInt32)), "R_PPC_GOT16_HI").__copy__(),
	new T_intName(((17 : GoUInt32)), "R_PPC_GOT16_HA").__copy__(), new T_intName(((18 : GoUInt32)), "R_PPC_PLTREL24").__copy__(),
	new T_intName(((19 : GoUInt32)), "R_PPC_COPY").__copy__(), new T_intName(((20 : GoUInt32)), "R_PPC_GLOB_DAT").__copy__(),
	new T_intName(((21 : GoUInt32)), "R_PPC_JMP_SLOT").__copy__(), new T_intName(((22 : GoUInt32)), "R_PPC_RELATIVE").__copy__(),
	new T_intName(((23 : GoUInt32)), "R_PPC_LOCAL24PC").__copy__(), new T_intName(((24 : GoUInt32)), "R_PPC_UADDR32").__copy__(),
	new T_intName(((25 : GoUInt32)), "R_PPC_UADDR16").__copy__(), new T_intName(((26 : GoUInt32)), "R_PPC_REL32").__copy__(),
	new T_intName(((27 : GoUInt32)), "R_PPC_PLT32").__copy__(), new T_intName(((28 : GoUInt32)), "R_PPC_PLTREL32").__copy__(),
	new T_intName(((29 : GoUInt32)), "R_PPC_PLT16_LO").__copy__(), new T_intName(((30 : GoUInt32)), "R_PPC_PLT16_HI").__copy__(),
	new T_intName(((31 : GoUInt32)), "R_PPC_PLT16_HA").__copy__(), new T_intName(((32 : GoUInt32)), "R_PPC_SDAREL16").__copy__(),
	new T_intName(((33 : GoUInt32)), "R_PPC_SECTOFF").__copy__(), new T_intName(((34 : GoUInt32)), "R_PPC_SECTOFF_LO").__copy__(),
	new T_intName(((35 : GoUInt32)), "R_PPC_SECTOFF_HI").__copy__(), new T_intName(((36 : GoUInt32)), "R_PPC_SECTOFF_HA").__copy__(),
	new T_intName(((67 : GoUInt32)), "R_PPC_TLS").__copy__(), new T_intName(((68 : GoUInt32)), "R_PPC_DTPMOD32").__copy__(),
	new T_intName(((69 : GoUInt32)), "R_PPC_TPREL16").__copy__(), new T_intName(((70 : GoUInt32)), "R_PPC_TPREL16_LO").__copy__(),
	new T_intName(((71 : GoUInt32)), "R_PPC_TPREL16_HI").__copy__(), new T_intName(((72 : GoUInt32)), "R_PPC_TPREL16_HA").__copy__(),
	new T_intName(((73 : GoUInt32)), "R_PPC_TPREL32").__copy__(), new T_intName(((74 : GoUInt32)), "R_PPC_DTPREL16").__copy__(),
	new T_intName(((75 : GoUInt32)), "R_PPC_DTPREL16_LO").__copy__(), new T_intName(((76 : GoUInt32)), "R_PPC_DTPREL16_HI").__copy__(),
	new T_intName(((77 : GoUInt32)), "R_PPC_DTPREL16_HA").__copy__(), new T_intName(((78 : GoUInt32)), "R_PPC_DTPREL32").__copy__(),
	new T_intName(((79 : GoUInt32)), "R_PPC_GOT_TLSGD16").__copy__(), new T_intName(((80 : GoUInt32)), "R_PPC_GOT_TLSGD16_LO").__copy__(),
	new T_intName(((81 : GoUInt32)), "R_PPC_GOT_TLSGD16_HI").__copy__(), new T_intName(((82 : GoUInt32)), "R_PPC_GOT_TLSGD16_HA").__copy__(),
	new T_intName(((83 : GoUInt32)), "R_PPC_GOT_TLSLD16").__copy__(), new T_intName(((84 : GoUInt32)), "R_PPC_GOT_TLSLD16_LO").__copy__(),
	new T_intName(((85 : GoUInt32)), "R_PPC_GOT_TLSLD16_HI").__copy__(), new T_intName(((86 : GoUInt32)), "R_PPC_GOT_TLSLD16_HA").__copy__(),
	new T_intName(((87 : GoUInt32)), "R_PPC_GOT_TPREL16").__copy__(), new T_intName(((88 : GoUInt32)), "R_PPC_GOT_TPREL16_LO").__copy__(),
	new T_intName(((89 : GoUInt32)), "R_PPC_GOT_TPREL16_HI").__copy__(), new T_intName(((90 : GoUInt32)), "R_PPC_GOT_TPREL16_HA").__copy__(),
	new T_intName(((101 : GoUInt32)), "R_PPC_EMB_NADDR32").__copy__(), new T_intName(((102 : GoUInt32)), "R_PPC_EMB_NADDR16").__copy__(),
	new T_intName(((103 : GoUInt32)), "R_PPC_EMB_NADDR16_LO").__copy__(), new T_intName(((104 : GoUInt32)), "R_PPC_EMB_NADDR16_HI").__copy__(),
	new T_intName(((105 : GoUInt32)), "R_PPC_EMB_NADDR16_HA").__copy__(), new T_intName(((106 : GoUInt32)), "R_PPC_EMB_SDAI16").__copy__(),
	new T_intName(((107 : GoUInt32)), "R_PPC_EMB_SDA2I16").__copy__(), new T_intName(((108 : GoUInt32)), "R_PPC_EMB_SDA2REL").__copy__(),
	new T_intName(((109 : GoUInt32)), "R_PPC_EMB_SDA21").__copy__(), new T_intName(((110 : GoUInt32)), "R_PPC_EMB_MRKREF").__copy__(),
	new T_intName(((111 : GoUInt32)), "R_PPC_EMB_RELSEC16").__copy__(), new T_intName(((112 : GoUInt32)), "R_PPC_EMB_RELST_LO").__copy__(),
	new T_intName(((113 : GoUInt32)), "R_PPC_EMB_RELST_HI").__copy__(), new T_intName(((114 : GoUInt32)), "R_PPC_EMB_RELST_HA").__copy__(),
	new T_intName(((115 : GoUInt32)), "R_PPC_EMB_BIT_FLD").__copy__(), new T_intName(((116 : GoUInt32)), "R_PPC_EMB_RELSDA").__copy__());
...
var _rsparcStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "R_SPARC_NONE").__copy__(),
	new T_intName(((1 : GoUInt32)), "R_SPARC_8").__copy__(), new T_intName(((2 : GoUInt32)), "R_SPARC_16").__copy__(),
	new T_intName(((3 : GoUInt32)), "R_SPARC_32").__copy__(), new T_intName(((4 : GoUInt32)), "R_SPARC_DISP8").__copy__(),
	new T_intName(((5 : GoUInt32)), "R_SPARC_DISP16").__copy__(), new T_intName(((6 : GoUInt32)), "R_SPARC_DISP32").__copy__(),
	new T_intName(((7 : GoUInt32)), "R_SPARC_WDISP30").__copy__(), new T_intName(((8 : GoUInt32)), "R_SPARC_WDISP22").__copy__(),
	new T_intName(((9 : GoUInt32)), "R_SPARC_HI22").__copy__(), new T_intName(((10 : GoUInt32)), "R_SPARC_22").__copy__(),
	new T_intName(((11 : GoUInt32)), "R_SPARC_13").__copy__(), new T_intName(((12 : GoUInt32)), "R_SPARC_LO10").__copy__(),
	new T_intName(((13 : GoUInt32)), "R_SPARC_GOT10").__copy__(), new T_intName(((14 : GoUInt32)), "R_SPARC_GOT13").__copy__(),
	new T_intName(((15 : GoUInt32)), "R_SPARC_GOT22").__copy__(), new T_intName(((16 : GoUInt32)), "R_SPARC_PC10").__copy__(),
	new T_intName(((17 : GoUInt32)), "R_SPARC_PC22").__copy__(), new T_intName(((18 : GoUInt32)), "R_SPARC_WPLT30").__copy__(),
	new T_intName(((19 : GoUInt32)), "R_SPARC_COPY").__copy__(), new T_intName(((20 : GoUInt32)), "R_SPARC_GLOB_DAT").__copy__(),
	new T_intName(((21 : GoUInt32)), "R_SPARC_JMP_SLOT").__copy__(), new T_intName(((22 : GoUInt32)), "R_SPARC_RELATIVE").__copy__(),
	new T_intName(((23 : GoUInt32)), "R_SPARC_UA32").__copy__(), new T_intName(((24 : GoUInt32)), "R_SPARC_PLT32").__copy__(),
	new T_intName(((25 : GoUInt32)), "R_SPARC_HIPLT22").__copy__(), new T_intName(((26 : GoUInt32)), "R_SPARC_LOPLT10").__copy__(),
	new T_intName(((27 : GoUInt32)), "R_SPARC_PCPLT32").__copy__(), new T_intName(((28 : GoUInt32)), "R_SPARC_PCPLT22").__copy__(),
	new T_intName(((29 : GoUInt32)), "R_SPARC_PCPLT10").__copy__(), new T_intName(((30 : GoUInt32)), "R_SPARC_10").__copy__(),
	new T_intName(((31 : GoUInt32)), "R_SPARC_11").__copy__(), new T_intName(((32 : GoUInt32)), "R_SPARC_64").__copy__(),
	new T_intName(((33 : GoUInt32)), "R_SPARC_OLO10").__copy__(), new T_intName(((34 : GoUInt32)), "R_SPARC_HH22").__copy__(),
	new T_intName(((35 : GoUInt32)), "R_SPARC_HM10").__copy__(), new T_intName(((36 : GoUInt32)), "R_SPARC_LM22").__copy__(),
	new T_intName(((37 : GoUInt32)), "R_SPARC_PC_HH22").__copy__(), new T_intName(((38 : GoUInt32)), "R_SPARC_PC_HM10").__copy__(),
	new T_intName(((39 : GoUInt32)), "R_SPARC_PC_LM22").__copy__(), new T_intName(((40 : GoUInt32)), "R_SPARC_WDISP16").__copy__(),
	new T_intName(((41 : GoUInt32)), "R_SPARC_WDISP19").__copy__(), new T_intName(((42 : GoUInt32)), "R_SPARC_GLOB_JMP").__copy__(),
	new T_intName(((43 : GoUInt32)), "R_SPARC_7").__copy__(), new T_intName(((44 : GoUInt32)), "R_SPARC_5").__copy__(),
	new T_intName(((45 : GoUInt32)), "R_SPARC_6").__copy__(), new T_intName(((46 : GoUInt32)), "R_SPARC_DISP64").__copy__(),
	new T_intName(((47 : GoUInt32)), "R_SPARC_PLT64").__copy__(), new T_intName(((48 : GoUInt32)), "R_SPARC_HIX22").__copy__(),
	new T_intName(((49 : GoUInt32)), "R_SPARC_LOX10").__copy__(), new T_intName(((50 : GoUInt32)), "R_SPARC_H44").__copy__(),
	new T_intName(((51 : GoUInt32)), "R_SPARC_M44").__copy__(), new T_intName(((52 : GoUInt32)), "R_SPARC_L44").__copy__(),
	new T_intName(((53 : GoUInt32)), "R_SPARC_REGISTER").__copy__(), new T_intName(((54 : GoUInt32)), "R_SPARC_UA64").__copy__(),
...
var _shnStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "SHN_UNDEF").__copy__(),
	new T_intName(((65280 : GoUInt32)), "SHN_LOPROC").__copy__(), new T_intName(((65312 : GoUInt32)), "SHN_LOOS").__copy__(),
	new T_intName(((65521 : GoUInt32)), "SHN_ABS").__copy__(), new T_intName(((65522 : GoUInt32)), "SHN_COMMON").__copy__(),
	new T_intName(((65535 : GoUInt32)), "SHN_XINDEX").__copy__());

final pt_GNU_STACK:ProgType = new ProgType(((1685382481 : GoInt)));
final em_HUANY:Machine = new Machine(((81 : GoUInt16)));

var _stbStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "STB_LOCAL").__copy__(),
	new T_intName(((1 : GoUInt32)), "STB_GLOBAL").__copy__(), new T_intName(((2 : GoUInt32)), "STB_WEAK").__copy__(),
	new T_intName(((10 : GoUInt32)), "STB_LOOS").__copy__(), new T_intName(((12 : GoUInt32)), "STB_HIOS").__copy__(),
	new T_intName(((13 : GoUInt32)), "STB_LOPROC").__copy__(), new T_intName(((15 : GoUInt32)), "STB_HIPROC").__copy__());
...
var _dataStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "ELFDATANONE").__copy__(),
	new T_intName(((1 : GoUInt32)), "ELFDATA2LSB").__copy__(), new T_intName(((2 : GoUInt32)), "ELFDATA2MSB").__copy__());

final r_RISCV_SET32:R_RISCV = new R_RISCV(((56 : GoInt)));
final r_PPC64_REL16DX_HA:R_PPC64 = new R_PPC64(((246 : GoInt)));

var _ralphaStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "R_ALPHA_NONE").__copy__(),
	new T_intName(((1 : GoUInt32)), "R_ALPHA_REFLONG").__copy__(), new T_intName(((2 : GoUInt32)), "R_ALPHA_REFQUAD").__copy__(),
	new T_intName(((3 : GoUInt32)), "R_ALPHA_GPREL32").__copy__(), new T_intName(((4 : GoUInt32)), "R_ALPHA_LITERAL").__copy__(),
	new T_intName(((5 : GoUInt32)), "R_ALPHA_LITUSE").__copy__(), new T_intName(((6 : GoUInt32)), "R_ALPHA_GPDISP").__copy__(),
	new T_intName(((7 : GoUInt32)), "R_ALPHA_BRADDR").__copy__(), new T_intName(((8 : GoUInt32)), "R_ALPHA_HINT").__copy__(),
	new T_intName(((9 : GoUInt32)), "R_ALPHA_SREL16").__copy__(), new T_intName(((10 : GoUInt32)), "R_ALPHA_SREL32").__copy__(),
	new T_intName(((11 : GoUInt32)), "R_ALPHA_SREL64").__copy__(), new T_intName(((12 : GoUInt32)), "R_ALPHA_OP_PUSH").__copy__(),
	new T_intName(((13 : GoUInt32)), "R_ALPHA_OP_STORE").__copy__(), new T_intName(((14 : GoUInt32)), "R_ALPHA_OP_PSUB").__copy__(),
	new T_intName(((15 : GoUInt32)), "R_ALPHA_OP_PRSHIFT").__copy__(), new T_intName(((16 : GoUInt32)), "R_ALPHA_GPVALUE").__copy__(),
	new T_intName(((17 : GoUInt32)), "R_ALPHA_GPRELHIGH").__copy__(), new T_intName(((18 : GoUInt32)), "R_ALPHA_GPRELLOW").__copy__(),
	new T_intName(((19 : GoUInt32)), "R_ALPHA_IMMED_GP_16").__copy__(), new T_intName(((20 : GoUInt32)), "R_ALPHA_IMMED_GP_HI32").__copy__(),
	new T_intName(((21 : GoUInt32)), "R_ALPHA_IMMED_SCN_HI32").__copy__(), new T_intName(((22 : GoUInt32)), "R_ALPHA_IMMED_BR_HI32").__copy__(),
	new T_intName(((23 : GoUInt32)), "R_ALPHA_IMMED_LO32").__copy__(), new T_intName(((24 : GoUInt32)), "R_ALPHA_COPY").__copy__(),
	new T_intName(((25 : GoUInt32)), "R_ALPHA_GLOB_DAT").__copy__(), new T_intName(((26 : GoUInt32)), "R_ALPHA_JMP_SLOT").__copy__(),
...
var _rx86_64Strings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "R_X86_64_NONE").__copy__(),
	new T_intName(((1 : GoUInt32)), "R_X86_64_64").__copy__(), new T_intName(((2 : GoUInt32)), "R_X86_64_PC32").__copy__(),
	new T_intName(((3 : GoUInt32)), "R_X86_64_GOT32").__copy__(), new T_intName(((4 : GoUInt32)), "R_X86_64_PLT32").__copy__(),
	new T_intName(((5 : GoUInt32)), "R_X86_64_COPY").__copy__(), new T_intName(((6 : GoUInt32)), "R_X86_64_GLOB_DAT").__copy__(),
	new T_intName(((7 : GoUInt32)), "R_X86_64_JMP_SLOT").__copy__(), new T_intName(((8 : GoUInt32)), "R_X86_64_RELATIVE").__copy__(),
	new T_intName(((9 : GoUInt32)), "R_X86_64_GOTPCREL").__copy__(), new T_intName(((10 : GoUInt32)), "R_X86_64_32").__copy__(),
	new T_intName(((11 : GoUInt32)), "R_X86_64_32S").__copy__(), new T_intName(((12 : GoUInt32)), "R_X86_64_16").__copy__(),
	new T_intName(((13 : GoUInt32)), "R_X86_64_PC16").__copy__(), new T_intName(((14 : GoUInt32)), "R_X86_64_8").__copy__(),
	new T_intName(((15 : GoUInt32)), "R_X86_64_PC8").__copy__(), new T_intName(((16 : GoUInt32)), "R_X86_64_DTPMOD64").__copy__(),
	new T_intName(((17 : GoUInt32)), "R_X86_64_DTPOFF64").__copy__(), new T_intName(((18 : GoUInt32)), "R_X86_64_TPOFF64").__copy__(),
	new T_intName(((19 : GoUInt32)), "R_X86_64_TLSGD").__copy__(), new T_intName(((20 : GoUInt32)), "R_X86_64_TLSLD").__copy__(),
	new T_intName(((21 : GoUInt32)), "R_X86_64_DTPOFF32").__copy__(), new T_intName(((22 : GoUInt32)), "R_X86_64_GOTTPOFF").__copy__(),
	new T_intName(((23 : GoUInt32)), "R_X86_64_TPOFF32").__copy__(), new T_intName(((24 : GoUInt32)), "R_X86_64_PC64").__copy__(),
	new T_intName(((25 : GoUInt32)), "R_X86_64_GOTOFF64").__copy__(), new T_intName(((26 : GoUInt32)), "R_X86_64_GOTPC32").__copy__(),
	new T_intName(((27 : GoUInt32)), "R_X86_64_GOT64").__copy__(), new T_intName(((28 : GoUInt32)), "R_X86_64_GOTPCREL64").__copy__(),
	new T_intName(((29 : GoUInt32)), "R_X86_64_GOTPC64").__copy__(), new T_intName(((30 : GoUInt32)), "R_X86_64_GOTPLT64").__copy__(),
	new T_intName(((31 : GoUInt32)), "R_X86_64_PLTOFF64").__copy__(), new T_intName(((32 : GoUInt32)), "R_X86_64_SIZE32").__copy__(),
	new T_intName(((33 : GoUInt32)), "R_X86_64_SIZE64").__copy__(), new T_intName(((34 : GoUInt32)), "R_X86_64_GOTPC32_TLSDESC").__copy__(),
	new T_intName(((35 : GoUInt32)), "R_X86_64_TLSDESC_CALL").__copy__(), new T_intName(((36 : GoUInt32)), "R_X86_64_TLSDESC").__copy__(),
	new T_intName(((37 : GoUInt32)), "R_X86_64_IRELATIVE").__copy__(), new T_intName(((38 : GoUInt32)), "R_X86_64_RELATIVE64").__copy__(),
	new T_intName(((39 : GoUInt32)), "R_X86_64_PC32_BND").__copy__(), new T_intName(((40 : GoUInt32)), "R_X86_64_PLT32_BND").__copy__(),
	new T_intName(((41 : GoUInt32)), "R_X86_64_GOTPCRELX").__copy__(), new T_intName(((42 : GoUInt32)), "R_X86_64_REX_GOTPCRELX").__copy__());
...
var _machineStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "EM_NONE").__copy__(),
	new T_intName(((1 : GoUInt32)), "EM_M32").__copy__(), new T_intName(((2 : GoUInt32)), "EM_SPARC").__copy__(),
	new T_intName(((3 : GoUInt32)), "EM_386").__copy__(), new T_intName(((4 : GoUInt32)), "EM_68K").__copy__(),
	new T_intName(((5 : GoUInt32)), "EM_88K").__copy__(), new T_intName(((7 : GoUInt32)), "EM_860").__copy__(),
	new T_intName(((8 : GoUInt32)), "EM_MIPS").__copy__(), new T_intName(((9 : GoUInt32)), "EM_S370").__copy__(),
	new T_intName(((10 : GoUInt32)), "EM_MIPS_RS3_LE").__copy__(), new T_intName(((15 : GoUInt32)), "EM_PARISC").__copy__(),
	new T_intName(((17 : GoUInt32)), "EM_VPP500").__copy__(), new T_intName(((18 : GoUInt32)), "EM_SPARC32PLUS").__copy__(),
	new T_intName(((19 : GoUInt32)), "EM_960").__copy__(), new T_intName(((20 : GoUInt32)), "EM_PPC").__copy__(),
	new T_intName(((21 : GoUInt32)), "EM_PPC64").__copy__(), new T_intName(((22 : GoUInt32)), "EM_S390").__copy__(),
	new T_intName(((36 : GoUInt32)), "EM_V800").__copy__(), new T_intName(((37 : GoUInt32)), "EM_FR20").__copy__(),
	new T_intName(((38 : GoUInt32)), "EM_RH32").__copy__(), new T_intName(((39 : GoUInt32)), "EM_RCE").__copy__(),
	new T_intName(((40 : GoUInt32)), "EM_ARM").__copy__(), new T_intName(((42 : GoUInt32)), "EM_SH").__copy__(),
	new T_intName(((43 : GoUInt32)), "EM_SPARCV9").__copy__(), new T_intName(((44 : GoUInt32)), "EM_TRICORE").__copy__(),
	new T_intName(((45 : GoUInt32)), "EM_ARC").__copy__(), new T_intName(((46 : GoUInt32)), "EM_H8_300").__copy__(),
	new T_intName(((47 : GoUInt32)), "EM_H8_300H").__copy__(), new T_intName(((48 : GoUInt32)), "EM_H8S").__copy__(),
	new T_intName(((49 : GoUInt32)), "EM_H8_500").__copy__(), new T_intName(((50 : GoUInt32)), "EM_IA_64").__copy__(),
	new T_intName(((51 : GoUInt32)), "EM_MIPS_X").__copy__(), new T_intName(((52 : GoUInt32)), "EM_COLDFIRE").__copy__(),
	new T_intName(((53 : GoUInt32)), "EM_68HC12").__copy__(), new T_intName(((54 : GoUInt32)), "EM_MMA").__copy__(),
	new T_intName(((55 : GoUInt32)), "EM_PCP").__copy__(), new T_intName(((56 : GoUInt32)), "EM_NCPU").__copy__(),
	new T_intName(((57 : GoUInt32)), "EM_NDR1").__copy__(), new T_intName(((58 : GoUInt32)), "EM_STARCORE").__copy__(),
	new T_intName(((59 : GoUInt32)), "EM_ME16").__copy__(), new T_intName(((60 : GoUInt32)), "EM_ST100").__copy__(),
	new T_intName(((61 : GoUInt32)), "EM_TINYJ").__copy__(), new T_intName(((62 : GoUInt32)), "EM_X86_64").__copy__(),
	new T_intName(((63 : GoUInt32)), "EM_PDSP").__copy__(), new T_intName(((64 : GoUInt32)), "EM_PDP10").__copy__(),
	new T_intName(((65 : GoUInt32)), "EM_PDP11").__copy__(), new T_intName(((66 : GoUInt32)), "EM_FX66").__copy__(),
	new T_intName(((67 : GoUInt32)), "EM_ST9PLUS").__copy__(), new T_intName(((68 : GoUInt32)), "EM_ST7").__copy__(),
	new T_intName(((69 : GoUInt32)), "EM_68HC16").__copy__(), new T_intName(((70 : GoUInt32)), "EM_68HC11").__copy__(),
	new T_intName(((71 : GoUInt32)), "EM_68HC08").__copy__(), new T_intName(((72 : GoUInt32)), "EM_68HC05").__copy__(),
	new T_intName(((73 : GoUInt32)), "EM_SVX").__copy__(), new T_intName(((74 : GoUInt32)), "EM_ST19").__copy__(),
	new T_intName(((75 : GoUInt32)), "EM_VAX").__copy__(), new T_intName(((76 : GoUInt32)), "EM_CRIS").__copy__(),
	new T_intName(((77 : GoUInt32)), "EM_JAVELIN").__copy__(), new T_intName(((78 : GoUInt32)), "EM_FIREPATH").__copy__(),
	new T_intName(((79 : GoUInt32)), "EM_ZSP").__copy__(), new T_intName(((80 : GoUInt32)), "EM_MMIX").__copy__(),
	new T_intName(((81 : GoUInt32)), "EM_HUANY").__copy__(), new T_intName(((82 : GoUInt32)), "EM_PRISM").__copy__(),
	new T_intName(((83 : GoUInt32)), "EM_AVR").__copy__(), new T_intName(((84 : GoUInt32)), "EM_FR30").__copy__(),
	new T_intName(((85 : GoUInt32)), "EM_D10V").__copy__(), new T_intName(((86 : GoUInt32)), "EM_D30V").__copy__(),
	new T_intName(((87 : GoUInt32)), "EM_V850").__copy__(), new T_intName(((88 : GoUInt32)), "EM_M32R").__copy__(),
	new T_intName(((89 : GoUInt32)), "EM_MN10300").__copy__(), new T_intName(((90 : GoUInt32)), "EM_MN10200").__copy__(),
	new T_intName(((91 : GoUInt32)), "EM_PJ").__copy__(), new T_intName(((92 : GoUInt32)), "EM_OPENRISC").__copy__(),
	new T_intName(((93 : GoUInt32)), "EM_ARC_COMPACT").__copy__(), new T_intName(((94 : GoUInt32)), "EM_XTENSA").__copy__(),
	new T_intName(((95 : GoUInt32)), "EM_VIDEOCORE").__copy__(), new T_intName(((96 : GoUInt32)), "EM_TMM_GPP").__copy__(),
	new T_intName(((97 : GoUInt32)), "EM_NS32K").__copy__(), new T_intName(((98 : GoUInt32)), "EM_TPC").__copy__(),
	new T_intName(((99 : GoUInt32)), "EM_SNP1K").__copy__(), new T_intName(((100 : GoUInt32)), "EM_ST200").__copy__(),
	new T_intName(((101 : GoUInt32)), "EM_IP2K").__copy__(), new T_intName(((102 : GoUInt32)), "EM_MAX").__copy__(),
	new T_intName(((103 : GoUInt32)), "EM_CR").__copy__(), new T_intName(((104 : GoUInt32)), "EM_F2MC16").__copy__(),
	new T_intName(((105 : GoUInt32)), "EM_MSP430").__copy__(), new T_intName(((106 : GoUInt32)), "EM_BLACKFIN").__copy__(),
	new T_intName(((107 : GoUInt32)), "EM_SE_C33").__copy__(), new T_intName(((108 : GoUInt32)), "EM_SEP").__copy__(),
	new T_intName(((109 : GoUInt32)), "EM_ARCA").__copy__(), new T_intName(((110 : GoUInt32)), "EM_UNICORE").__copy__(),
	new T_intName(((111 : GoUInt32)), "EM_EXCESS").__copy__(), new T_intName(((112 : GoUInt32)), "EM_DXP").__copy__(),
	new T_intName(((113 : GoUInt32)), "EM_ALTERA_NIOS2").__copy__(), new T_intName(((114 : GoUInt32)), "EM_CRX").__copy__(),
	new T_intName(((115 : GoUInt32)), "EM_XGATE").__copy__(), new T_intName(((116 : GoUInt32)), "EM_C166").__copy__(),
	new T_intName(((117 : GoUInt32)), "EM_M16C").__copy__(), new T_intName(((118 : GoUInt32)), "EM_DSPIC30F").__copy__(),
	new T_intName(((119 : GoUInt32)), "EM_CE").__copy__(), new T_intName(((120 : GoUInt32)), "EM_M32C").__copy__(),
	new T_intName(((131 : GoUInt32)), "EM_TSK3000").__copy__(), new T_intName(((132 : GoUInt32)), "EM_RS08").__copy__(),
	new T_intName(((133 : GoUInt32)), "EM_SHARC").__copy__(), new T_intName(((134 : GoUInt32)), "EM_ECOG2").__copy__(),
	new T_intName(((135 : GoUInt32)), "EM_SCORE7").__copy__(), new T_intName(((136 : GoUInt32)), "EM_DSP24").__copy__(),
	new T_intName(((137 : GoUInt32)), "EM_VIDEOCORE3").__copy__(), new T_intName(((138 : GoUInt32)), "EM_LATTICEMICO32").__copy__(),
	new T_intName(((139 : GoUInt32)), "EM_SE_C17").__copy__(), new T_intName(((140 : GoUInt32)), "EM_TI_C6000").__copy__(),
	new T_intName(((141 : GoUInt32)), "EM_TI_C2000").__copy__(), new T_intName(((142 : GoUInt32)), "EM_TI_C5500").__copy__(),
	new T_intName(((143 : GoUInt32)), "EM_TI_ARP32").__copy__(), new T_intName(((144 : GoUInt32)), "EM_TI_PRU").__copy__(),
	new T_intName(((160 : GoUInt32)), "EM_MMDSP_PLUS").__copy__(), new T_intName(((161 : GoUInt32)), "EM_CYPRESS_M8C").__copy__(),
	new T_intName(((162 : GoUInt32)), "EM_R32C").__copy__(), new T_intName(((163 : GoUInt32)), "EM_TRIMEDIA").__copy__(),
	new T_intName(((164 : GoUInt32)), "EM_QDSP6").__copy__(), new T_intName(((165 : GoUInt32)), "EM_8051").__copy__(),
	new T_intName(((166 : GoUInt32)), "EM_STXP7X").__copy__(), new T_intName(((167 : GoUInt32)), "EM_NDS32").__copy__(),
	new T_intName(((168 : GoUInt32)), "EM_ECOG1").__copy__(), new T_intName(((168 : GoUInt32)), "EM_ECOG1X").__copy__(),
	new T_intName(((169 : GoUInt32)), "EM_MAXQ30").__copy__(), new T_intName(((170 : GoUInt32)), "EM_XIMO16").__copy__(),
	new T_intName(((171 : GoUInt32)), "EM_MANIK").__copy__(), new T_intName(((172 : GoUInt32)), "EM_CRAYNV2").__copy__(),
	new T_intName(((173 : GoUInt32)), "EM_RX").__copy__(), new T_intName(((174 : GoUInt32)), "EM_METAG").__copy__(),
	new T_intName(((175 : GoUInt32)), "EM_MCST_ELBRUS").__copy__(), new T_intName(((176 : GoUInt32)), "EM_ECOG16").__copy__(),
	new T_intName(((177 : GoUInt32)), "EM_CR16").__copy__(), new T_intName(((178 : GoUInt32)), "EM_ETPU").__copy__(),
	new T_intName(((179 : GoUInt32)), "EM_SLE9X").__copy__(), new T_intName(((180 : GoUInt32)), "EM_L10M").__copy__(),
	new T_intName(((181 : GoUInt32)), "EM_K10M").__copy__(), new T_intName(((183 : GoUInt32)), "EM_AARCH64").__copy__(),
	new T_intName(((185 : GoUInt32)), "EM_AVR32").__copy__(), new T_intName(((186 : GoUInt32)), "EM_STM8").__copy__(),
	new T_intName(((187 : GoUInt32)), "EM_TILE64").__copy__(), new T_intName(((188 : GoUInt32)), "EM_TILEPRO").__copy__(),
	new T_intName(((189 : GoUInt32)), "EM_MICROBLAZE").__copy__(), new T_intName(((190 : GoUInt32)), "EM_CUDA").__copy__(),
	new T_intName(((191 : GoUInt32)), "EM_TILEGX").__copy__(), new T_intName(((192 : GoUInt32)), "EM_CLOUDSHIELD").__copy__(),
	new T_intName(((193 : GoUInt32)), "EM_COREA_1ST").__copy__(), new T_intName(((194 : GoUInt32)), "EM_COREA_2ND").__copy__(),
	new T_intName(((195 : GoUInt32)), "EM_ARC_COMPACT2").__copy__(), new T_intName(((196 : GoUInt32)), "EM_OPEN8").__copy__(),
	new T_intName(((197 : GoUInt32)), "EM_RL78").__copy__(), new T_intName(((198 : GoUInt32)), "EM_VIDEOCORE5").__copy__(),
	new T_intName(((199 : GoUInt32)), "EM_78KOR").__copy__(), new T_intName(((200 : GoUInt32)), "EM_56800EX").__copy__(),
	new T_intName(((201 : GoUInt32)), "EM_BA1").__copy__(), new T_intName(((202 : GoUInt32)), "EM_BA2").__copy__(),
	new T_intName(((203 : GoUInt32)), "EM_XCORE").__copy__(), new T_intName(((204 : GoUInt32)), "EM_MCHP_PIC").__copy__(),
	new T_intName(((205 : GoUInt32)), "EM_INTEL205").__copy__(), new T_intName(((206 : GoUInt32)), "EM_INTEL206").__copy__(),
	new T_intName(((207 : GoUInt32)), "EM_INTEL207").__copy__(), new T_intName(((208 : GoUInt32)), "EM_INTEL208").__copy__(),
	new T_intName(((209 : GoUInt32)), "EM_INTEL209").__copy__(), new T_intName(((210 : GoUInt32)), "EM_KM32").__copy__(),
	new T_intName(((211 : GoUInt32)), "EM_KMX32").__copy__(), new T_intName(((212 : GoUInt32)), "EM_KMX16").__copy__(),
	new T_intName(((213 : GoUInt32)), "EM_KMX8").__copy__(), new T_intName(((214 : GoUInt32)), "EM_KVARC").__copy__(),
	new T_intName(((215 : GoUInt32)), "EM_CDP").__copy__(), new T_intName(((216 : GoUInt32)), "EM_COGE").__copy__(),
	new T_intName(((217 : GoUInt32)), "EM_COOL").__copy__(), new T_intName(((218 : GoUInt32)), "EM_NORC").__copy__(),
	new T_intName(((219 : GoUInt32)), "EM_CSR_KALIMBA ").__copy__(), new T_intName(((220 : GoUInt32)), "EM_Z80 ").__copy__(),
	new T_intName(((221 : GoUInt32)), "EM_VISIUM ").__copy__(), new T_intName(((222 : GoUInt32)), "EM_FT32 ").__copy__(),
	new T_intName(((223 : GoUInt32)), "EM_MOXIE").__copy__(), new T_intName(((224 : GoUInt32)), "EM_AMDGPU").__copy__(),
	new T_intName(((243 : GoUInt32)), "EM_RISCV").__copy__(), new T_intName(((244 : GoUInt32)), "EM_LANAI").__copy__(),
	new T_intName(((247 : GoUInt32)), "EM_BPF").__copy__(), new T_intName(((6 : GoUInt32)), "EM_486").__copy__(),
	new T_intName(((10 : GoUInt32)), "EM_MIPS_RS4_BE").__copy__(), new T_intName(((41 : GoUInt32)), "EM_ALPHA_STD").__copy__(),
...
var _stvStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "STV_DEFAULT").__copy__(),
	new T_intName(((1 : GoUInt32)), "STV_INTERNAL").__copy__(), new T_intName(((2 : GoUInt32)), "STV_HIDDEN").__copy__(),
	new T_intName(((3 : GoUInt32)), "STV_PROTECTED").__copy__());
...
var _raarch64Strings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "R_AARCH64_NONE").__copy__(),
	new T_intName(((1 : GoUInt32)), "R_AARCH64_P32_ABS32").__copy__(), new T_intName(((2 : GoUInt32)), "R_AARCH64_P32_ABS16").__copy__(),
	new T_intName(((3 : GoUInt32)), "R_AARCH64_P32_PREL32").__copy__(), new T_intName(((4 : GoUInt32)), "R_AARCH64_P32_PREL16").__copy__(),
	new T_intName(((5 : GoUInt32)), "R_AARCH64_P32_MOVW_UABS_G0").__copy__(), new T_intName(((6 : GoUInt32)), "R_AARCH64_P32_MOVW_UABS_G0_NC").__copy__(),
	new T_intName(((7 : GoUInt32)), "R_AARCH64_P32_MOVW_UABS_G1").__copy__(), new T_intName(((8 : GoUInt32)), "R_AARCH64_P32_MOVW_SABS_G0").__copy__(),
	new T_intName(((9 : GoUInt32)), "R_AARCH64_P32_LD_PREL_LO19").__copy__(), new T_intName(((10 : GoUInt32)), "R_AARCH64_P32_ADR_PREL_LO21").__copy__(),
	...
	new T_intName(((17 : GoUInt32)), "R_AARCH64_P32_LDST128_ABS_LO12_NC").__copy__(), new T_intName(((18 : GoUInt32)), "R_AARCH64_P32_TSTBR14").__copy__(),
	new T_intName(((19 : GoUInt32)), "R_AARCH64_P32_CONDBR19").__copy__(), new T_intName(((20 : GoUInt32)), "R_AARCH64_P32_JUMP26").__copy__(),
	new T_intName(((21 : GoUInt32)), "R_AARCH64_P32_CALL26").__copy__(), new T_intName(((25 : GoUInt32)), "R_AARCH64_P32_GOT_LD_PREL19").__copy__(),
	new T_intName(((26 : GoUInt32)), "R_AARCH64_P32_ADR_GOT_PAGE").__copy__(), new T_intName(((27 : GoUInt32)), "R_AARCH64_P32_LD32_GOT_LO12_NC").__copy__(),
	...
	new T_intName(((127 : GoUInt32)), "R_AARCH64_P32_TLSDESC_CALL").__copy__(), new T_intName(((180 : GoUInt32)), "R_AARCH64_P32_COPY").__copy__(),
	new T_intName(((181 : GoUInt32)), "R_AARCH64_P32_GLOB_DAT").__copy__(), new T_intName(((182 : GoUInt32)), "R_AARCH64_P32_JUMP_SLOT").__copy__(),
	new T_intName(((183 : GoUInt32)), "R_AARCH64_P32_RELATIVE").__copy__(), new T_intName(((184 : GoUInt32)), "R_AARCH64_P32_TLS_DTPMOD").__copy__(),
	new T_intName(((185 : GoUInt32)), "R_AARCH64_P32_TLS_DTPREL").__copy__(), new T_intName(((186 : GoUInt32)), "R_AARCH64_P32_TLS_TPREL").__copy__(),
	new T_intName(((187 : GoUInt32)), "R_AARCH64_P32_TLSDESC").__copy__(), new T_intName(((188 : GoUInt32)), "R_AARCH64_P32_IRELATIVE").__copy__(),
	new T_intName(((256 : GoUInt32)), "R_AARCH64_NULL").__copy__(), new T_intName(((257 : GoUInt32)), "R_AARCH64_ABS64").__copy__(),
	new T_intName(((258 : GoUInt32)), "R_AARCH64_ABS32").__copy__(), new T_intName(((259 : GoUInt32)), "R_AARCH64_ABS16").__copy__(),
	new T_intName(((260 : GoUInt32)), "R_AARCH64_PREL64").__copy__(), new T_intName(((261 : GoUInt32)), "R_AARCH64_PREL32").__copy__(),
	new T_intName(((262 : GoUInt32)), "R_AARCH64_PREL16").__copy__(), new T_intName(((263 : GoUInt32)), "R_AARCH64_MOVW_UABS_G0").__copy__(),
	new T_intName(((264 : GoUInt32)), "R_AARCH64_MOVW_UABS_G0_NC").__copy__(), new T_intName(((265 : GoUInt32)), "R_AARCH64_MOVW_UABS_G1").__copy__(),
	new T_intName(((266 : GoUInt32)), "R_AARCH64_MOVW_UABS_G1_NC").__copy__(), new T_intName(((267 : GoUInt32)), "R_AARCH64_MOVW_UABS_G2").__copy__(),
	new T_intName(((268 : GoUInt32)), "R_AARCH64_MOVW_UABS_G2_NC").__copy__(), new T_intName(((269 : GoUInt32)), "R_AARCH64_MOVW_UABS_G3").__copy__(),
	new T_intName(((270 : GoUInt32)), "R_AARCH64_MOVW_SABS_G0").__copy__(), new T_intName(((271 : GoUInt32)), "R_AARCH64_MOVW_SABS_G1").__copy__(),
	new T_intName(((272 : GoUInt32)), "R_AARCH64_MOVW_SABS_G2").__copy__(), new T_intName(((273 : GoUInt32)), "R_AARCH64_LD_PREL_LO19").__copy__(),
	new T_intName(((274 : GoUInt32)), "R_AARCH64_ADR_PREL_LO21").__copy__(), new T_intName(((275 : GoUInt32)), "R_AARCH64_ADR_PREL_PG_HI21").__copy__(),
	new T_intName(((276 : GoUInt32)), "R_AARCH64_ADR_PREL_PG_HI21_NC").__copy__(), new T_intName(((277 : GoUInt32)), "R_AARCH64_ADD_ABS_LO12_NC").__copy__(),
	new T_intName(((278 : GoUInt32)), "R_AARCH64_LDST8_ABS_LO12_NC").__copy__(), new T_intName(((279 : GoUInt32)), "R_AARCH64_TSTBR14").__copy__(),
	new T_intName(((280 : GoUInt32)), "R_AARCH64_CONDBR19").__copy__(), new T_intName(((282 : GoUInt32)), "R_AARCH64_JUMP26").__copy__(),
	new T_intName(((283 : GoUInt32)), "R_AARCH64_CALL26").__copy__(), new T_intName(((284 : GoUInt32)), "R_AARCH64_LDST16_ABS_LO12_NC").__copy__(),
	...
	new T_intName(((299 : GoUInt32)), "R_AARCH64_LDST128_ABS_LO12_NC").__copy__(), new T_intName(((309 : GoUInt32)), "R_AARCH64_GOT_LD_PREL19").__copy__(),
	new T_intName(((310 : GoUInt32)), "R_AARCH64_LD64_GOTOFF_LO15").__copy__(), new T_intName(((311 : GoUInt32)), "R_AARCH64_ADR_GOT_PAGE").__copy__(),
	new T_intName(((312 : GoUInt32)), "R_AARCH64_LD64_GOT_LO12_NC").__copy__(), new T_intName(((313 : GoUInt32)), "R_AARCH64_LD64_GOTPAGE_LO15").__copy__(),
	new T_intName(((512 : GoUInt32)), "R_AARCH64_TLSGD_ADR_PREL21").__copy__(), new T_intName(((513 : GoUInt32)), "R_AARCH64_TLSGD_ADR_PAGE21").__copy__(),
	new T_intName(((514 : GoUInt32)), "R_AARCH64_TLSGD_ADD_LO12_NC").__copy__(), new T_intName(((515 : GoUInt32)), "R_AARCH64_TLSGD_MOVW_G1").__copy__(),
	new T_intName(((516 : GoUInt32)), "R_AARCH64_TLSGD_MOVW_G0_NC").__copy__(), new T_intName(((517 : GoUInt32)), "R_AARCH64_TLSLD_ADR_PREL21").__copy__(),
	...
	new T_intName(((560 : GoUInt32)), "R_AARCH64_TLSDESC_LD_PREL19").__copy__(), new T_intName(((561 : GoUInt32)), "R_AARCH64_TLSDESC_ADR_PREL21").__copy__(),
	...
	new T_intName(((564 : GoUInt32)), "R_AARCH64_TLSDESC_ADD_LO12_NC").__copy__(), new T_intName(((565 : GoUInt32)), "R_AARCH64_TLSDESC_OFF_G1").__copy__(),
	new T_intName(((566 : GoUInt32)), "R_AARCH64_TLSDESC_OFF_G0_NC").__copy__(), new T_intName(((567 : GoUInt32)), "R_AARCH64_TLSDESC_LDR").__copy__(),
	new T_intName(((568 : GoUInt32)), "R_AARCH64_TLSDESC_ADD").__copy__(), new T_intName(((569 : GoUInt32)), "R_AARCH64_TLSDESC_CALL").__copy__(),
	...
	new T_intName(((573 : GoUInt32)), "R_AARCH64_TLSLD_LDST128_DTPREL_LO12_NC").__copy__(), new T_intName(((1024 : GoUInt32)), "R_AARCH64_COPY").__copy__(),
	new T_intName(((1025 : GoUInt32)), "R_AARCH64_GLOB_DAT").__copy__(), new T_intName(((1026 : GoUInt32)), "R_AARCH64_JUMP_SLOT").__copy__(),
	new T_intName(((1027 : GoUInt32)), "R_AARCH64_RELATIVE").__copy__(), new T_intName(((1028 : GoUInt32)), "R_AARCH64_TLS_DTPMOD64").__copy__(),
	new T_intName(((1029 : GoUInt32)), "R_AARCH64_TLS_DTPREL64").__copy__(), new T_intName(((1030 : GoUInt32)), "R_AARCH64_TLS_TPREL64").__copy__(),
	new T_intName(((1031 : GoUInt32)), "R_AARCH64_TLSDESC").__copy__(), new T_intName(((1032 : GoUInt32)), "R_AARCH64_IRELATIVE").__copy__());

final pt_TLS:ProgType = new ProgType(((7 : GoInt)));

var _dflagStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((1 : GoUInt32)), "DF_ORIGIN").__copy__(),
	new T_intName(((2 : GoUInt32)), "DF_SYMBOLIC").__copy__(), new T_intName(((4 : GoUInt32)), "DF_TEXTREL").__copy__(),
	new T_intName(((8 : GoUInt32)), "DF_BIND_NOW").__copy__(), new T_intName(((16 : GoUInt32)), "DF_STATIC_TLS").__copy__());
...
var _rriscvStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "R_RISCV_NONE").__copy__(),
	new T_intName(((1 : GoUInt32)), "R_RISCV_32").__copy__(), new T_intName(((2 : GoUInt32)), "R_RISCV_64").__copy__(),
	new T_intName(((3 : GoUInt32)), "R_RISCV_RELATIVE").__copy__(), new T_intName(((4 : GoUInt32)), "R_RISCV_COPY").__copy__(),
	new T_intName(((5 : GoUInt32)), "R_RISCV_JUMP_SLOT").__copy__(), new T_intName(((6 : GoUInt32)), "R_RISCV_TLS_DTPMOD32").__copy__(),
	new T_intName(((7 : GoUInt32)), "R_RISCV_TLS_DTPMOD64").__copy__(), new T_intName(((8 : GoUInt32)), "R_RISCV_TLS_DTPREL32").__copy__(),
	new T_intName(((9 : GoUInt32)), "R_RISCV_TLS_DTPREL64").__copy__(), new T_intName(((10 : GoUInt32)), "R_RISCV_TLS_TPREL32").__copy__(),
	new T_intName(((11 : GoUInt32)), "R_RISCV_TLS_TPREL64").__copy__(), new T_intName(((16 : GoUInt32)), "R_RISCV_BRANCH").__copy__(),
	new T_intName(((17 : GoUInt32)), "R_RISCV_JAL").__copy__(), new T_intName(((18 : GoUInt32)), "R_RISCV_CALL").__copy__(),
	new T_intName(((19 : GoUInt32)), "R_RISCV_CALL_PLT").__copy__(), new T_intName(((20 : GoUInt32)), "R_RISCV_GOT_HI20").__copy__(),
	new T_intName(((21 : GoUInt32)), "R_RISCV_TLS_GOT_HI20").__copy__(), new T_intName(((22 : GoUInt32)), "R_RISCV_TLS_GD_HI20").__copy__(),
	new T_intName(((23 : GoUInt32)), "R_RISCV_PCREL_HI20").__copy__(), new T_intName(((24 : GoUInt32)), "R_RISCV_PCREL_LO12_I").__copy__(),
	new T_intName(((25 : GoUInt32)), "R_RISCV_PCREL_LO12_S").__copy__(), new T_intName(((26 : GoUInt32)), "R_RISCV_HI20").__copy__(),
	new T_intName(((27 : GoUInt32)), "R_RISCV_LO12_I").__copy__(), new T_intName(((28 : GoUInt32)), "R_RISCV_LO12_S").__copy__(),
	new T_intName(((29 : GoUInt32)), "R_RISCV_TPREL_HI20").__copy__(), new T_intName(((30 : GoUInt32)), "R_RISCV_TPREL_LO12_I").__copy__(),
	new T_intName(((31 : GoUInt32)), "R_RISCV_TPREL_LO12_S").__copy__(), new T_intName(((32 : GoUInt32)), "R_RISCV_TPREL_ADD").__copy__(),
	new T_intName(((33 : GoUInt32)), "R_RISCV_ADD8").__copy__(), new T_intName(((34 : GoUInt32)), "R_RISCV_ADD16").__copy__(),
	new T_intName(((35 : GoUInt32)), "R_RISCV_ADD32").__copy__(), new T_intName(((36 : GoUInt32)), "R_RISCV_ADD64").__copy__(),
	new T_intName(((37 : GoUInt32)), "R_RISCV_SUB8").__copy__(), new T_intName(((38 : GoUInt32)), "R_RISCV_SUB16").__copy__(),
	new T_intName(((39 : GoUInt32)), "R_RISCV_SUB32").__copy__(), new T_intName(((40 : GoUInt32)), "R_RISCV_SUB64").__copy__(),
	new T_intName(((41 : GoUInt32)), "R_RISCV_GNU_VTINHERIT").__copy__(), new T_intName(((42 : GoUInt32)), "R_RISCV_GNU_VTENTRY").__copy__(),
	new T_intName(((43 : GoUInt32)), "R_RISCV_ALIGN").__copy__(), new T_intName(((44 : GoUInt32)), "R_RISCV_RVC_BRANCH").__copy__(),
	new T_intName(((45 : GoUInt32)), "R_RISCV_RVC_JUMP").__copy__(), new T_intName(((46 : GoUInt32)), "R_RISCV_RVC_LUI").__copy__(),
	new T_intName(((47 : GoUInt32)), "R_RISCV_GPREL_I").__copy__(), new T_intName(((48 : GoUInt32)), "R_RISCV_GPREL_S").__copy__(),
	new T_intName(((49 : GoUInt32)), "R_RISCV_TPREL_I").__copy__(), new T_intName(((50 : GoUInt32)), "R_RISCV_TPREL_S").__copy__(),
	new T_intName(((51 : GoUInt32)), "R_RISCV_RELAX").__copy__(), new T_intName(((52 : GoUInt32)), "R_RISCV_SUB6").__copy__(),
	new T_intName(((53 : GoUInt32)), "R_RISCV_SET6").__copy__(), new T_intName(((54 : GoUInt32)), "R_RISCV_SET8").__copy__(),
	new T_intName(((55 : GoUInt32)), "R_RISCV_SET16").__copy__(), new T_intName(((56 : GoUInt32)), "R_RISCV_SET32").__copy__(),
...
var _shfStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((1 : GoUInt32)), "SHF_WRITE").__copy__(),
	new T_intName(((2 : GoUInt32)), "SHF_ALLOC").__copy__(), new T_intName(((4 : GoUInt32)), "SHF_EXECINSTR").__copy__(),
	new T_intName(((16 : GoUInt32)), "SHF_MERGE").__copy__(), new T_intName(((32 : GoUInt32)), "SHF_STRINGS").__copy__(),
	new T_intName(((64 : GoUInt32)), "SHF_INFO_LINK").__copy__(), new T_intName(((128 : GoUInt32)), "SHF_LINK_ORDER").__copy__(),
	new T_intName(((256 : GoUInt32)), "SHF_OS_NONCONFORMING").__copy__(), new T_intName(((512 : GoUInt32)), "SHF_GROUP").__copy__(),
	new T_intName(((1024 : GoUInt32)), "SHF_TLS").__copy__(), new T_intName(((2048 : GoUInt32)), "SHF_COMPRESSED").__copy__());
...
var _pfStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((1 : GoUInt32)), "PF_X").__copy__(), new T_intName(((2 : GoUInt32)), "PF_W").__copy__(),
	new T_intName(((4 : GoUInt32)), "PF_R").__copy__());
...
var _compressionStrings:Slice<T_intName> = new Slice<T_intName>(new T_intName(((0 : GoUInt32)), "COMPRESS_ZLIB").__copy__(),
	new T_intName(((1610612736 : GoUInt32)), "COMPRESS_LOOS").__copy__(), new T_intName(((1879048191 : GoUInt32)), "COMPRESS_HIOS").__copy__(),
	new T_intName(((1879048192 : GoUInt32)), "COMPRESS_LOPROC").__copy__(), new T_intName(((2147483647 : GoUInt32)), "COMPRESS_HIPROC").__copy__());
...
function newFile(_r:stdgo.io.Io.ReaderAt):{var _0:Pointer<File>; var _1:Error;} {
	...
	if (_ident[((0 : GoInt))] != (("\u{007f}".code : GoRune))
		|| _ident[((1 : GoInt))] != (("E".code : GoRune))
		|| _ident[((2 : GoInt))] != (("L".code : GoRune))
		|| _ident[((3 : GoInt))] != (("F".code : GoRune))) {
		return {_0: new Pointer<File>().nil(), _1: Go.pointer(new FormatError(((0 : GoInt64)), "bad magic number",
			Go.toInterface(_ident.__slice__(((0 : GoInt)), ((4 : GoInt))))))
			.value};
	};
	...
	if (_f.value.fileHeader.class_.__t__ == elfclass32.__t__) {} else if (_f.value.fileHeader.class_.__t__ == elfclass64.__t__) {} else {
		return {_0: new Pointer<File>().nil(), _1: Go.pointer(new FormatError(((0 : GoInt64)), "unknown ELF class",
			Go.toInterface(_f.value.fileHeader.class_)))
			.value};
	};
	...
	if (_f.value.fileHeader.data.__t__ == elfdata2lsb.__t__) {
		...
		return {_0: new Pointer<File>().nil(), _1: Go.pointer(new FormatError(((0 : GoInt64)), "unknown ELF data encoding",
			Go.toInterface(_f.value.fileHeader.data)))
			.value};
	};
	_f.value.fileHeader.version = new Version(_ident[ei_VERSION]);
	if (_f.value.fileHeader.version.__t__ != ev_CURRENT.__t__) {
		return {_0: new Pointer<File>().nil(), _1: Go.pointer(new FormatError(((0 : GoInt64)), "unknown ELF version",
			Go.toInterface(_f.value.fileHeader.version)))
			.value};
	};
	...
	var _shentsize:GoInt = ((0 : GoInt)),
		_shnum:GoInt = ((0 : GoInt)),
		_shstrndx:GoInt = ((0 : GoInt));
	if (_f.value.fileHeader.class_.__t__ == elfclass32.__t__) {
	...
	if (_shoff == ((0 : GoInt64)) && _shnum != ((0 : GoInt))) {
		return {_0: new Pointer<File>().nil(), _1: Go.pointer(new FormatError(((0 : GoInt64)), "invalid ELF shnum for shoff=0", Go.toInterface(_shnum)))
			.value};
	};
	...
	_f.value.progs = new Slice<Pointer<Prog>>(...[for (i in 0...((_phnum : GoInt)).toBasic()) new Pointer<Prog>().nil()]);
	{
		...
		Go.cfor(_i < _phnum, _i++, {
			...
			if (_f.value.fileHeader.class_.__t__ == elfclass32.__t__) {
				...
				_p.value.progHeader = (({
					type: new ProgType(_ph.value.type),
					flags: new ProgFlag(_ph.value.flags),
					off: ((_ph.value.off : GoUInt64)),
					vaddr: ((_ph.value.vaddr : GoUInt64)),
					paddr: ((_ph.value.paddr : GoUInt64)),
					filesz: ((_ph.value.filesz : GoUInt64)),
					memsz: ((_ph.value.memsz : GoUInt64)),
					align: ((_ph.value.align : GoUInt64))
				} : ProgHeader)).__copy__();
			} else if (_f.value.fileHeader.class_.__t__ == elfclass64.__t__) {
				...
				_p.value.progHeader = (({
					...
					flags: new ProgFlag(_ph.value.flags),
					off: _ph.value.off,
					vaddr: _ph.value.vaddr,
					paddr: _ph.value.paddr,
					filesz: _ph.value.filesz,
					memsz: _ph.value.memsz,
					align: _ph.value.align
				} : ProgHeader)).__copy__();
			};
		...
		Go.cfor(_i < _shnum, _i++, {
			...
			if (_f.value.fileHeader.class_.__t__ == elfclass32.__t__) {
				...
				_s.value.sectionHeader = (({
					type: new SectionType(_sh.value.type),
					flags: new SectionFlag(_sh.value.flags),
					addr: ((_sh.value.addr : GoUInt64)),
					offset: ((_sh.value.off : GoUInt64)),
					fileSize: ((_sh.value.size : GoUInt64)),
					link: _sh.value.link,
					info: _sh.value.info,
					addralign: ((_sh.value.addralign : GoUInt64)),
					entsize: ((_sh.value.entsize : GoUInt64)),
					name: "",
					size: 0
				...
				_s.value.sectionHeader = (({
					type: new SectionType(_sh.value.type),
					flags: new SectionFlag(_sh.value.flags),
					offset: _sh.value.off,
					fileSize: _sh.value.size,
					addr: _sh.value.addr,
					link: _sh.value.link,
					info: _sh.value.info,
					addralign: _sh.value.addralign,
					entsize: _sh.value.entsize,
					name: "",
					size: 0
				} : SectionHeader)).__copy__();
			};
	...
	var __tmp__ = _f.value.sections[_shstrndx].value.data(),
		_shstrtab:Slice<GoUInt8> = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
		return {_0: new Pointer<File>().nil(), _1: _err};
	};
	{
		...
		for (_obj in _f.value.sections.keyValueIterator()) {
			...
			if (!_ok) {
				return {_0: new Pointer<File>().nil(), _1: Go.pointer(new FormatError(_shoff + (((_i * _shentsize) : GoInt64)), "bad section name index",
					Go.toInterface(_names[_i])))
					.value};
			};
		};
	};
...
class File_extension_fields {
	public function _stringTable(__tmp__, _link:GoUInt32):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__._stringTable(_link);

	public function close(__tmp__):Error
		return __tmp__.close();

	public function sectionByType(__tmp__, _typ:SectionType):Pointer<Section>
		return __tmp__.sectionByType(_typ);

	public function _getSymbols(__tmp__, _typ:SectionType):{var _0:Slice<Symbol>; var _1:Slice<GoByte>; var _2:Error;}
		return __tmp__._getSymbols(_typ);

	public function _getSymbols32(__tmp__, _typ:SectionType):{var _0:Slice<Symbol>; var _1:Slice<GoByte>; var _2:Error;}
		return __tmp__._getSymbols32(_typ);

	public function _getSymbols64(__tmp__, _typ:SectionType):{var _0:Slice<Symbol>; var _1:Slice<GoByte>; var _2:Error;}
		return __tmp__._getSymbols64(_typ);

	public function section(__tmp__, _name:GoString):Pointer<Section>
		return __tmp__.section(_name);

	public function _applyRelocations(__tmp__, _dst:Slice<GoByte>, _rels:Slice<GoByte>):Error
		return __tmp__._applyRelocations(_dst, _rels);

	public function _applyRelocationsAMD64(__tmp__, _dst:Slice<GoByte>, _rels:Slice<GoByte>):Error
		return __tmp__._applyRelocationsAMD64(_dst, _rels);

	public function _applyRelocations386(__tmp__, _dst:Slice<GoByte>, _rels:Slice<GoByte>):Error
		return __tmp__._applyRelocations386(_dst, _rels);

	public function _applyRelocationsARM(__tmp__, _dst:Slice<GoByte>, _rels:Slice<GoByte>):Error
		return __tmp__._applyRelocationsARM(_dst, _rels);

	public function _applyRelocationsARM64(__tmp__, _dst:Slice<GoByte>, _rels:Slice<GoByte>):Error
		return __tmp__._applyRelocationsARM64(_dst, _rels);

	public function _applyRelocationsPPC(__tmp__, _dst:Slice<GoByte>, _rels:Slice<GoByte>):Error
		return __tmp__._applyRelocationsPPC(_dst, _rels);

	public function _applyRelocationsPPC64(__tmp__, _dst:Slice<GoByte>, _rels:Slice<GoByte>):Error
		return __tmp__._applyRelocationsPPC64(_dst, _rels);

	public function _applyRelocationsMIPS(__tmp__, _dst:Slice<GoByte>, _rels:Slice<GoByte>):Error
		return __tmp__._applyRelocationsMIPS(_dst, _rels);

	public function _applyRelocationsMIPS64(__tmp__, _dst:Slice<GoByte>, _rels:Slice<GoByte>):Error
		return __tmp__._applyRelocationsMIPS64(_dst, _rels);

	public function _applyRelocationsRISCV64(__tmp__, _dst:Slice<GoByte>, _rels:Slice<GoByte>):Error
		return __tmp__._applyRelocationsRISCV64(_dst, _rels);

	public function _applyRelocationss390x(__tmp__, _dst:Slice<GoByte>, _rels:Slice<GoByte>):Error
		return __tmp__._applyRelocationss390x(_dst, _rels);

	public function _applyRelocationsSPARC64(__tmp__, _dst:Slice<GoByte>, _rels:Slice<GoByte>):Error
		return __tmp__._applyRelocationsSPARC64(_dst, _rels);

	public function dwarf(__tmp__):{var _0:Pointer<stdgo.debug.dwarf.Dwarf.Data>; var _1:Error;}
		return __tmp__.dwarf();

	public function symbols(__tmp__):{var _0:Slice<Symbol>; var _1:Error;}
		return __tmp__.symbols();

	public function dynamicSymbols(__tmp__):{var _0:Slice<Symbol>; var _1:Error;}
		return __tmp__.dynamicSymbols();

	public function importedSymbols(__tmp__):{var _0:Slice<ImportedSymbol>; var _1:Error;}
		return __tmp__.importedSymbols();

	public function _gnuVersionInit(__tmp__, _str:Slice<GoByte>):Bool
		return __tmp__._gnuVersionInit(_str);

	public function _gnuVersion(__tmp__, _i:GoInt):{var _0:GoString; var _1:GoString;}
		return __tmp__._gnuVersion(_i);

	public function importedLibraries(__tmp__):{var _0:Slice<GoString>; var _1:Error;}
		return __tmp__.importedLibraries();

	public function dynString(__tmp__, _tag:DynTag):{var _0:Slice<GoString>; var _1:Error;}
		return __tmp__.dynString(_tag);
}
...
class T_readSeekerFromReader_extension_fields {
	public function _start(__tmp__):Void
		__tmp__._start();
