...
@:structInit @:using(stdgo.debug.elf.Elf.T_readSeekerFromReader_static_extension) @:dox(hide) abstract T_readSeekerFromReader(stdgo._internal.debug.elf.Elf_t_readseekerfromreader.T_readSeekerFromReader) from stdgo._internal.debug.elf.Elf_t_readseekerfromreader.T_readSeekerFromReader to stdgo._internal.debug.elf.Elf_t_readseekerfromreader.T_readSeekerFromReader {
    ...
    function get__reset():() -> stdgo.Tuple<stdgo._internal.io.Io_reader.Reader, stdgo.Error> return () -> {
        final obj = this._reset();
        { _0 : obj._0, _1 : obj._1 };
    };
    ...
    public function new(?_reset:() -> stdgo.Tuple<stdgo._internal.io.Io_reader.Reader, stdgo.Error>, ?_r:stdgo._internal.io.Io_reader.Reader, ?_size:haxe.Int64, ?_offset:haxe.Int64) this = new stdgo._internal.debug.elf.Elf_t_readseekerfromreader.T_readSeekerFromReader(() -> {
        final obj = _reset();
        { _0 : obj._0, _1 : (obj._1 : stdgo.Error) };
    }, _r, (_size : stdgo.GoInt64), (_offset : stdgo.GoInt64));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
