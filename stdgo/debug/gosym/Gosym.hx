...
@:structInit class LineTable {
	...
	public function _initFileMap():Void {
		...
		try {
			...
			var _m:GoMap<GoString, GoUInt32> = new GoMap<GoString,
				GoUInt32>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
					stdgo.reflect.Reflect.GoType.basic(uint32_kind))));
	...
	public function _go12LineToPC(_file:GoString, _line:GoInt):GoUInt64 {
		...
		try {
			...
			_t.value._initFileMap();
			var __tmp__ = _t.value._fileMap.exists(_file) ? {value: _t.value._fileMap[_file], ok: true} : {value: _t.value._fileMap.defaultValue(), ok: false},
				_filenum:GoUInt32 = __tmp__.value,
				_ok:Bool = __tmp__.ok;
			if (!_ok) {
				{
					for (defer in deferstack) {
			...
			var _cutab:Slice<GoByte> = new Slice<GoUInt8>().nil();
			{
				...
				Go.cfor(_i < _t.value._nfunctab, _i++, {
					var _f:Slice<GoUInt8> = _t.value._funcdata.__slice__(_t.value._uintptr(_t.value._functab.__slice__(((2 : GoUInt32)) * _t.value._ptrsize * _i
						+ _t.value._ptrsize)));
					...
					if (_t.value._version.__t__ == _ver116.__t__) {
						var _cuoff:GoUInt32 = _t.value._binary.uint32(_f.__slice__(_t.value._ptrsize +
							((7 : GoUnTypedInt)) * ((4 : GoUnTypedInt)))) * ((4 : GoUInt32));
	...
	public function _findFileLine(_entry:GoUInt64, _filetab:GoUInt32, _linetab:GoUInt32, _filenum:GoInt32, _line:GoInt32, _cutab:Slice<GoByte>):GoUInt64 {
		...
		while (_t.value._step(Go.pointer(_fp), Go.pointer(_filePC), Go.pointer(_fileVal), _filePC == _entry)) {
			...
			if (_fileIndex == _filenum && _fileStartPC < _filePC) {
				...
				while (_linePC < _filePC
					&& _t.value._step(Go.pointer(_fl), Go.pointer(_linePC), Go.pointer(_lineVal), _linePC == _entry)) {
					if (_lineVal == _line) {
	...
	public function _stringFrom(_arr:Slice<GoByte>, _off:GoUInt32):GoString {
		var _t = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		{
			var __tmp__ = _t.value._strings.exists(_off) ? {value: _t.value._strings[_off], ok: true} : {value: _t.value._strings.defaultValue(), ok: false},
	...
	public function _funcName(_off:GoUInt32):GoString {
		var _t = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		{
			var __tmp__ = _t.value._funcNames.exists(_off) ? {value: _t.value._funcNames[_off], ok: true} : {value: _t.value._funcNames.defaultValue(),
				ok: false},
				_s:GoString = __tmp__.value,
				_ok:Bool = __tmp__.ok;
			if (_ok) {
	...
	public function _findFunc(_pc:GoUInt64):Slice<GoByte> {
		var _t = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		if (_pc < _t.value._uintptr(_t.value._functab)
			|| _pc >= _t.value._uintptr(_t.value._functab.__slice__(_t.value._functab.length - ((_t.value._ptrsize : GoInt))))) {
		...
		try {
			...
			var _funcs:Slice<Func> = new Slice<Func>(...[for (i in 0...((_n : GoInt)).toBasic()) new Func()]);
			{
				...
				for (_obj in _funcs.keyValueIterator()) {
					...
					var _info:Slice<GoUInt8> = _t.value._funcdata.__slice__(_t.value._uintptr(_t.value._functab.__slice__((((2 : GoInt)) * _i +
						((1 : GoInt))) * ((_t.value._ptrsize : GoInt)))));
					...
					_f.value.sym = Go.pointer((({
						value: _f.value.entry,
						type: (("T".code : GoRune)),
						name: _t.value._funcName(_t.value._binary.uint32(_info.__slice__(_t.value._ptrsize))),
						goType: ((0 : GoUInt64)),
						func: _f
					} : Sym)));
				};
	...
	public function _parsePclnTab():Void {
		...
		try {
			...
			if (_t.value.data.length < ((16 : GoInt))
				|| _t.value.data[((4 : GoInt))] != ((0 : GoUInt8))
				|| _t.value.data[((5 : GoInt))] != ((0 : GoUInt8))
				|| (_t.value.data[((6 : GoInt))] != ((1 : GoUInt8))
					&& _t.value.data[((6 : GoInt))] != ((2 : GoUInt8))
					&& _t.value.data[((6 : GoInt))] != ((4 : GoUInt8)))
				|| (_t.value.data[((7 : GoInt))] != ((4 : GoUInt8)) && _t.value.data[((7 : GoInt))] != ((8 : GoUInt8)))) {
				{
					for (defer in deferstack) {
						defer();
					};
	...
	public function lineToPC(_line:GoInt, _maxpc:GoUInt64):GoUInt64 {
		...
		var __tmp__ = _t.value._parse(_maxpc, _line),
			_:Slice<GoUInt8> = __tmp__._0,
			_pc:GoUInt64 = __tmp__._1,
			_line1:GoInt = __tmp__._2;
		if (_line1 != _line) {
			return ((0 : GoUInt64));
		};
	...
	public function pctoLine(_pc:GoUInt64):GoInt {
		...
		var __tmp__ = _t.value._parse(_pc, -((1 : GoUnTypedInt))),
			_:Slice<GoUInt8> = __tmp__._0,
	...
	public function _slice(_pc:GoUInt64):Pointer<LineTable> {
		...
		return Go.pointer((({
			...
			_version: new T_version(),
			_binary: ((null : stdgo.encoding.binary.Binary.ByteOrder)),
			_quantum: 0,
			_ptrsize: 0,
			_funcnametab: new Slice<GoUInt8>().nil(),
			_cutab: new Slice<GoUInt8>().nil(),
			_funcdata: new Slice<GoUInt8>().nil(),
			_functab: new Slice<GoUInt8>().nil(),
			_nfunctab: 0,
			_filetab: new Slice<GoUInt8>().nil(),
			_pctab: new Slice<GoUInt8>().nil(),
			_nfiletab: 0,
			_funcNames: new GoMap<GoUInt32,
				GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(uint32_kind),
					stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil(),
			_strings: new GoMap<GoUInt32,
				GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(uint32_kind),
					stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil(),
			_fileMap: new GoMap<GoString,
				GoUInt32>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
					stdgo.reflect.Reflect.GoType.basic(uint32_kind)))).nil()} : LineTable)));
	}
	...
	public var _funcNames:GoMap<GoUInt32, GoString> = new GoMap<GoUInt32,
		GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(uint32_kind),
			stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil();
	public var _strings:GoMap<GoUInt32, GoString> = new GoMap<GoUInt32,
		GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(uint32_kind),
			stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil();
	public var _fileMap:GoMap<GoString, GoUInt32> = new GoMap<GoString,
		GoUInt32>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
			stdgo.reflect.Reflect.GoType.basic(uint32_kind)))).nil();

	public function new(?data:Slice<GoUInt8>, ?pc:GoUInt64, ?line:GoInt, ?_mu:stdgo.sync.Sync.Mutex, ?_version:T_version,
			?_binary:stdgo.encoding.binary.Binary.ByteOrder, ?_quantum:GoUInt32, ?_ptrsize:GoUInt32, ?_funcnametab:Slice<GoUInt8>, ?_cutab:Slice<GoUInt8>,
			?_funcdata:Slice<GoUInt8>, ?_functab:Slice<GoUInt8>, ?_nfunctab:GoUInt32, ?_filetab:Slice<GoUInt8>, ?_pctab:Slice<GoUInt8>, ?_nfiletab:GoUInt32,
			?_funcNames:GoMap<GoUInt32, GoString>, ?_strings:GoMap<GoUInt32, GoString>, ?_fileMap:GoMap<GoString, GoUInt32>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(data) + " " + Go.string(pc) + " " + Go.string(line) + " " + Go.string(_mu) + " " + Go.string(_version) + " "
			+ Go.string(_binary) + " " + Go.string(_quantum) + " " + Go.string(_ptrsize) + " " + Go.string(_funcnametab) + " " + Go.string(_cutab) + " "
			+ Go.string(_funcdata) + " " + Go.string(_functab) + " " + Go.string(_nfunctab) + " " + Go.string(_filetab) + " " + Go.string(_pctab) + " "
			+ Go.string(_nfiletab) + " " + Go.string(_funcNames) + " " + Go.string(_strings) + " " + Go.string(_fileMap) + "}";
	}
	...
	public function __copy__() {
		return new LineTable(data, pc, line, _mu, _version, _binary, _quantum, _ptrsize, _funcnametab, _cutab, _funcdata, _functab, _nfunctab, _filetab,
			_pctab, _nfiletab, _funcNames, _strings, _fileMap);
	}
...
@:structInit class Sym {
	...
	public function new(?value:GoUInt64, ?type:GoUInt8, ?name:GoString, ?goType:GoUInt64, ?func:Pointer<Func>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Func {
	...
	public function new(?entry:GoUInt64, ?sym:Pointer<Sym>, ?end:GoUInt64, ?params:Slice<Pointer<Sym>>, ?locals:Slice<Pointer<Sym>>, ?frameSize:GoInt,
			?lineTable:Pointer<LineTable>, ?obj:Pointer<Obj>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(entry) + " " + Go.string(sym) + " " + Go.string(end) + " " + Go.string(params) + " " + Go.string(locals) + " "
			+ Go.string(frameSize) + " " + Go.string(lineTable) + " " + Go.string(obj) + "}";
	}
	...
	public function packageName():GoString
		return sym.packageName();

	public function receiverName():GoString
		return sym.receiverName();
...
@:structInit class Obj {
	...
	public function _lineFromAline(_aline:GoInt):{var _0:GoString; var _1:GoInt;} {
		...
		return stdgo.internal.Macro.controlFlow({
			{};
			var _noPath:Pointer<T_stackEnt__lineFromAline_0> = Go.pointer(new T_stackEnt__lineFromAline_0("", ((0 : GoInt)), ((0 : GoInt)),
				new Pointer<T_stackEnt__lineFromAline_0>().nil()));
	...
	public function new(?funcs:Slice<Func>, ?paths:Slice<Sym>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Table {
	public function symByAddr(_addr:GoUInt64):Pointer<Sym> {
		var _t = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		{
			...
			for (_obj in _t.value.syms.keyValueIterator()) {
				...
				if (_s.value.type == (("T".code : GoRune))
					|| _s.value.type == (("t".code : GoRune))
					|| _s.value.type == (("L".code : GoRune))
					|| _s.value.type == (("l".code : GoRune))
					|| _s.value.type == (("D".code : GoRune))
					|| _s.value.type == (("d".code : GoRune))
					|| _s.value.type == (("B".code : GoRune))
					|| _s.value.type == (("b".code : GoRune))) {
	...
	public function lineToPC(_file:GoString, _line:GoInt):{var _0:GoUInt64; var _1:Pointer<Func>; var _2:Error;} {
		var _t = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _pc:GoUInt64 = ((0 : GoUInt64)),
			_fn:Pointer<Func> = new Pointer<Func>().nil(),
			_err:Error = ((null : stdgo.Error));
		var __tmp__ = _t.value.files.exists(_file) ? {value: _t.value.files[_file], ok: true} : {value: _t.value.files.defaultValue(), ok: false},
			_obj:Pointer<Obj> = __tmp__.value,
			_ok:Bool = __tmp__.ok;
		if (!_ok) {
		...
		var __tmp__ = _obj.value._alineFromLine(_file, _line),
			_abs:GoInt = __tmp__._0,
	...
	public var funcs:Slice<Func> = new Slice<Func>().nil();
	public var files:GoMap<GoString, Pointer<Obj>> = new GoMap<GoString,
		Pointer<Obj>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
		stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("debug/gosym.Obj", [],
			stdgo.reflect.Reflect.GoType.named("debug/gosym.Obj", [], stdgo.reflect.Reflect.GoType.structType([
				{
					name: "funcs",
					embedded: false,
					tag: "",
					type: stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("debug/gosym.Func", [],
						stdgo.reflect.Reflect.GoType.named("debug/gosym.Func", [], stdgo.reflect.Reflect.GoType.structType([
							{
								name: "entry",
								embedded: false,
								tag: "",
							...
							},
							{
								...
								embedded: true,
								tag: "",
								type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("debug/gosym.Sym", [],
									stdgo.reflect.Reflect.GoType.named("debug/gosym.Sym", [], stdgo.reflect.Reflect.GoType.structType([
										{
											name: "value",
											embedded: false,
											tag: "",
										...
										},
										{
											...
											embedded: false,
											tag: "",
											type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("debug/gosym.Func", [],
												stdgo.reflect.Reflect.GoType.structType([
													...
													},
													{
														...
														embedded: false,
														tag: "",
														type: stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("debug/gosym.Sym",
																[], stdgo.reflect.Reflect.GoType.invalidType)))
													},
													{
														name: "locals",
													...
													},
													{
														...
														embedded: false,
														tag: "",
														type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("debug/gosym.LineTable",
															[],
															stdgo.reflect.Reflect.GoType.named("debug/gosym.LineTable", [],
																stdgo.reflect.Reflect.GoType.structType([
																	{
																		name: "data",
																		embedded: false,
																	...
																	},
																	{
																		...
																		embedded: false,
																		tag: "",
																		type: stdgo.reflect.Reflect.GoType.named("debug/gosym.version", [],
																	...
																	},
																	{
																		...
																		embedded: false,
																		tag: "",
																		type: stdgo.reflect.Reflect.GoType.named("encoding/binary.ByteOrder", [],
																	...
																	},
																	{
																		...
																		embedded: false,
																		tag: "",
																		type: stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(uint32_kind),
													...
													},
													{
														...
														embedded: false,
														tag: "",
														type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("debug/gosym.Obj", [],
															stdgo.reflect.Reflect.GoType.structType([
																{
																	name: "funcs",
																	embedded: false,
																...
																},
																{
																	...
																	embedded: false,
																	tag: "",
																	type: stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("debug/gosym.Sym",
																			[], stdgo.reflect.Reflect.GoType.invalidType))
																}
															])))
													}
							...
							},
							{
								...
								tag: "",
								type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("debug/gosym.LineTable", [],
									stdgo.reflect.Reflect.GoType.named("debug/gosym.LineTable", [], stdgo.reflect.Reflect.GoType.structType([
										{
											name: "data",
											embedded: false,
											tag: "",
										...
										},
										{
											...
											embedded: false,
											tag: "",
											type: stdgo.reflect.Reflect.GoType.named("debug/gosym.version", [], stdgo.reflect.Reflect.GoType.basic(int_kind))
										},
										{
											name: "_binary",
											embedded: false,
	...
	public function new(?syms:Slice<Sym>, ?funcs:Slice<Func>, ?files:GoMap<GoString, Pointer<Obj>>, ?objs:Slice<Obj>, ?_go12line:Pointer<LineTable>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_sym {
	...
	public function new(?_value:GoUInt64, ?_gotype:GoUInt64, ?_typ:GoUInt8, ?_name:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();
...
@:named class UnknownFileError {
	...
	public function __copy__()
		return new UnknownFileError(__t__);
}
...
@:structInit class UnknownLineError {
	...
	public function new(?file:GoString, ?line:GoInt)
		stdgo.internal.Macro.initLocals();
...
var _oldLittleEndianSymtab:Slice<GoUInt8> = new Slice<GoUInt8>(((254 : GoUInt8)), ((255 : GoUInt8)), ((255 : GoUInt8)), ((255 : GoUInt8)), ((0 : GoUInt8)),
	((0 : GoUInt8)));

final _go12magic:GoInt64 = (("4294967291" : GoUnTypedInt));
final _oldQuantum:GoInt64 = ((1 : GoUnTypedInt));

var _bigEndianSymtab:Slice<GoUInt8> = new Slice<GoUInt8>(((255 : GoUInt8)), ((255 : GoUInt8)), ((255 : GoUInt8)), ((253 : GoUInt8)), ((0 : GoUInt8)),
	((0 : GoUInt8)), ((0 : GoUInt8)));

var _littleEndianSymtab:Slice<GoUInt8> = new Slice<GoUInt8>(((253 : GoUInt8)), ((255 : GoUInt8)), ((255 : GoUInt8)), ((255 : GoUInt8)), ((0 : GoUInt8)),
	((0 : GoUInt8)), ((0 : GoUInt8)));
	...
	return stdgo.internal.Macro.controlFlow({
												...
												type: stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("debug/gosym.Func", [],
													stdgo.reflect.Reflect.GoType.structType([
														...
														},
														{
															...
															type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("debug/gosym.Sym",
																[],
																stdgo.reflect.Reflect.GoType.named("debug/gosym.Sym", [],
																	stdgo.reflect.Reflect.GoType.structType([
																		{
																			name: "value",
																			embedded: false,
		...
		var _lastf:GoInt = ((0 : GoInt));
		{
			...
			Go.cfor(_i < _t.syms.length, _i++, {
				...
				if (_sym.value.type == (("Z".code : GoRune)) || _sym.value.type == (("z".code : GoRune))) {
				...
				} else if (_sym.value.type == (("T".code : GoRune))
					|| _sym.value.type == (("t".code : GoRune))
					|| _sym.value.type == (("L".code : GoRune))
					|| _sym.value.type == (("l".code : GoRune))) {
					{
						...
						Go.cfor(_end < _t.syms.length, _end++, {
							{
								var __switchIndex__ = -1;
								while (true) {
									if (_t.syms[_end].type == (("T".code : GoRune))
										|| _t.syms[_end].type == (("t".code : GoRune))
										|| _t.syms[_end].type == (("L".code : GoRune))
										|| _t.syms[_end].type == (("l".code : GoRune))
										|| _t.syms[_end].type == (("Z".code : GoRune))
										|| _t.syms[_end].type == (("z".code : GoRune))) {
										@:break {
											____exit____ = true;
											____break____ = true;
					...
					_sym.value.func = _fn;
					_fn.value.params = new Slice<Pointer<Sym>>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) new Pointer<Sym>().nil()])
						.setCap(((_np : GoInt)).toBasic());
					_fn.value.locals = new Slice<Pointer<Sym>>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) new Pointer<Sym>().nil()])
						.setCap(((_na : GoInt)).toBasic());
					_fn.value.sym = _sym;
...
class LineTable_extension_fields {
	public function _parse(__tmp__, _targetPC:GoUInt64, _targetLine:GoInt):{var _0:Slice<GoByte>; var _1:GoUInt64; var _2:GoInt;}
		return __tmp__._parse(_targetPC, _targetLine);

	public function _slice(__tmp__, _pc:GoUInt64):Pointer<LineTable>
		return __tmp__._slice(_pc);

	public function pctoLine(__tmp__, _pc:GoUInt64):GoInt
		return __tmp__.pctoLine(_pc);

	public function lineToPC(__tmp__, _line:GoInt, _maxpc:GoUInt64):GoUInt64
		return __tmp__.lineToPC(_line, _maxpc);

	public function _isGo12(__tmp__):Bool
		return __tmp__._isGo12();

	public function _uintptr(__tmp__, _b:Slice<GoByte>):GoUInt64
		return __tmp__._uintptr(_b);

	public function _parsePclnTab(__tmp__):Void
		__tmp__._parsePclnTab();

	public function _go12Funcs(__tmp__):Slice<Func>
		return __tmp__._go12Funcs();

	public function _findFunc(__tmp__, _pc:GoUInt64):Slice<GoByte>
		return __tmp__._findFunc(_pc);

	public function _readvarint(__tmp__, _pp:Pointer<Slice<GoByte>>):GoUInt32
		return __tmp__._readvarint(_pp);

	public function _funcName(__tmp__, _off:GoUInt32):GoString
		return __tmp__._funcName(_off);

	public function _stringFrom(__tmp__, _arr:Slice<GoByte>, _off:GoUInt32):GoString
		return __tmp__._stringFrom(_arr, _off);

	public function _string(__tmp__, _off:GoUInt32):GoString
		return __tmp__._string(_off);

	public function _step(__tmp__, _p:Pointer<Slice<GoByte>>, _pc:Pointer<GoUInt64>, _val:Pointer<GoInt32>, _first:Bool):Bool
		return __tmp__._step(_p, _pc, _val, _first);

	public function _pcvalue(__tmp__, _off:GoUInt32, _entry:GoUInt64, _targetpc:GoUInt64):GoInt32
		return __tmp__._pcvalue(_off, _entry, _targetpc);

	public function _findFileLine(__tmp__, _entry:GoUInt64, _filetab:GoUInt32, _linetab:GoUInt32, _filenum:GoInt32, _line:GoInt32,
			_cutab:Slice<GoByte>):GoUInt64
		return __tmp__._findFileLine(_entry, _filetab, _linetab, _filenum, _line, _cutab);

	public function _go12PCToLine(__tmp__, _pc:GoUInt64):GoInt
		return __tmp__._go12PCToLine(_pc);

	public function _go12PCToFile(__tmp__, _pc:GoUInt64):GoString
		return __tmp__._go12PCToFile(_pc);

	public function _go12LineToPC(__tmp__, _file:GoString, _line:GoInt):GoUInt64
		return __tmp__._go12LineToPC(_file, _line);

	public function _initFileMap(__tmp__):Void
		__tmp__._initFileMap();

	public function _go12MapFiles(__tmp__, _m:GoMap<GoString, Pointer<Obj>>, _obj:Pointer<Obj>):Void
		__tmp__._go12MapFiles(_m, _obj);
}

class Sym_extension_fields {
	public function static_(__tmp__):Bool
		return __tmp__.static_();

	public function packageName(__tmp__):GoString
		return __tmp__.packageName();

	public function receiverName(__tmp__):GoString
		return __tmp__.receiverName();

	public function baseName(__tmp__):GoString
		return __tmp__.baseName();
}

class Obj_extension_fields {
	public function _lineFromAline(__tmp__, _aline:GoInt):{var _0:GoString; var _1:GoInt;}
		return __tmp__._lineFromAline(_aline);

	public function _alineFromLine(__tmp__, _path:GoString, _line:GoInt):{var _0:GoInt; var _1:Error;}
		return __tmp__._alineFromLine(_path, _line);
}
...
@:structInit class T_stackEnt__lineFromAline_0 {
	...
	public function new(?_path:GoString, ?_start:GoInt, ?_offset:GoInt, ?_prev:Pointer<T_stackEnt__lineFromAline_0>)
		stdgo.internal.Macro.initLocals();
...
class Table_extension_fields {
	public function pctoFunc(__tmp__, _pc:GoUInt64):Pointer<Func>
		return __tmp__.pctoFunc(_pc);

	public function pctoLine(__tmp__, _pc:GoUInt64):{var _0:GoString; var _1:GoInt; var _2:Pointer<Func>;}
		return __tmp__.pctoLine(_pc);

	public function lineToPC(__tmp__, _file:GoString, _line:GoInt):{var _0:GoUInt64; var _1:Pointer<Func>; var _2:Error;}
		return __tmp__.lineToPC(_file, _line);

	public function lookupSym(__tmp__, _name:GoString):Pointer<Sym>
		return __tmp__.lookupSym(_name);

	public function lookupFunc(__tmp__, _name:GoString):Pointer<Func>
		return __tmp__.lookupFunc(_name);

	public function symByAddr(__tmp__, _addr:GoUInt64):Pointer<Sym>
		return __tmp__.symByAddr(_addr);
}
