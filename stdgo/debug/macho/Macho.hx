...
@:structInit class FatFile {
    ...
    public function new(?magic:GoUInt32, ?arches:Slice<FatArch>, ?_closer:stdgo.io.Io.Closer) stdgo.internal.Macro.initLocals();
...
@:structInit class FatArchHeader {
    ...
    public function new(?cpu:Cpu, ?subCpu:GoUInt32, ?offset:GoUInt32, ?size:GoUInt32, ?align:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(cpu) + " " + Go.string(subCpu) + " " + Go.string(offset) + " " + Go.string(size) + " " + Go.string(align) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class FatArch {
    ...
    public function new(?fatArchHeader:FatArchHeader, ?file:Pointer<File>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(fatArchHeader) + " " + Go.string(file) + "}";
    }
    public function close():stdgo.Error return file.close();
    public function dwarf():{ var _0 : () -> { var _0 : Pointer<stdgo.debug.dwarf.Dwarf.Data>; var _1 : stdgo.Error; }; var _1 : () -> { var _0 : Pointer<stdgo.debug.dwarf.Dwarf.Data>; var _1 : stdgo.Error; }; } return file.dwarf();
    public function importedLibraries():{ var _0 : () -> { var _0 : Slice<GoString>; var _1 : stdgo.Error; }; var _1 : () -> { var _0 : Slice<GoString>; var _1 : stdgo.Error; }; } return file.importedLibraries();
    public function importedSymbols():{ var _0 : () -> { var _0 : Slice<GoString>; var _1 : stdgo.Error; }; var _1 : () -> { var _0 : Slice<GoString>; var _1 : stdgo.Error; }; } return file.importedSymbols();
    public function section(_name:GoString):Pointer<Section> return file.section(_0);
    public function segment(_name:GoString):Pointer<Segment> return file.segment(_0);
    public function _parseSymtab(_symdat:Slice<GoUInt8>, _strtab:Slice<GoUInt8>, _cmddat:Slice<GoUInt8>, _hdr:Pointer<SymtabCmd>, _offset:GoInt64):{ var _0 : (Slice<GoUInt8>, Slice<GoUInt8>, Slice<GoUInt8>, Pointer<SymtabCmd>, GoInt64) -> { var _0 : Pointer<Symtab>; var _1 : stdgo.Error; }; var _1 : (Slice<GoUInt8>, Slice<GoUInt8>, Slice<GoUInt8>, Pointer<SymtabCmd>, GoInt64) -> { var _0 : Pointer<Symtab>; var _1 : stdgo.Error; }; } return file._parseSymtab(_0, _1, _2, _3, _4);
    public function _pushSection(_sh:Pointer<Section>, _r:stdgo.io.Io.ReaderAt):stdgo.Error return file._pushSection(_0, _1);
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class File {
    ...
    public function dwarf():{ var _0 : Pointer<stdgo.debug.dwarf.Dwarf.Data>; var _1 : Error; } {
        ...
        var _sectionData:Pointer<Section> -> { var _0 : Slice<GoUInt8>; var _1 : stdgo.Error; } = function(_s:Pointer<Section>):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        ...
        for (_s in _f.value.sections) {
            ...
            var __tmp__ = _sectionData(_s), _b:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
    ...
    public function _pushSection(_sh:Pointer<Section>, _r:stdgo.io.Io.ReaderAt):Error {
        ...
        if (_sh.value.sectionHeader.nreloc > ((0 : GoUInt32))) {
            var _reldat:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0 ... ((((_sh.value.sectionHeader.nreloc : GoInt)) * ((8 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]);
            {
                var __tmp__ = _r.readAt(_reldat, ((_sh.value.sectionHeader.reloff : GoInt64))), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    return _err;
                };
            };
                ...
                for (_obj in _sh.value.relocs.keyValueIterator()) {
                    ...
                    if (_ri.addr & ((((1 : GoUnTypedInt)) << ((31 : GoUnTypedInt)))) != ((0 : GoUInt32))) {
                        ...
                        if (Go.toInterface(_bo) == Go.toInterface(stdgo.encoding.binary.Binary.littleEndian)) {
                            ...
                            _rel.value.len = (((((_ri.symnum >> ((25 : GoUnTypedInt)))) & ((((1 : GoUnTypedInt)) << ((2 : GoUnTypedInt))) - ((1 : GoUnTypedInt)))) : GoUInt8));
                            _rel.value.extern_ = _ri.symnum & ((((1 : GoUnTypedInt)) << ((27 : GoUnTypedInt)))) != ((0 : GoUInt32));
                            _rel.value.type = (((((_ri.symnum >> ((28 : GoUnTypedInt)))) & ((((1 : GoUnTypedInt)) << ((4 : GoUnTypedInt))) - ((1 : GoUnTypedInt)))) : GoUInt8));
    ...
    public function _parseSymtab(_symdat:Slice<GoByte>, _strtab:Slice<GoByte>, _cmddat:Slice<GoByte>, _hdr:Pointer<SymtabCmd>, _offset:GoInt64):{ var _0 : Pointer<Symtab>; var _1 : Error; } {
        var _f = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _bo:stdgo.encoding.binary.Binary.ByteOrder = _f.value.byteOrder;
        ...
        var _b:Pointer<stdgo.bytes.Bytes.Reader> = stdgo.bytes.Bytes.newReader(_symdat);
        {
            ...
            for (_obj in _symtab.keyValueIterator()) {
                ...
                if (_n.name >= ((_strtab.length : GoUInt32))) {
                    return { _0 : new Pointer<Symtab>().nil(), _1 : Go.pointer(new FormatError(_offset, "invalid name in symbol table", Go.toInterface(_n.name))).value };
                };
    ...
    public var _closer : stdgo.io.Io.Closer = ((null : stdgo.io.Io.Closer));
    public function new(?fileHeader:FileHeader, ?byteOrder:stdgo.encoding.binary.Binary.ByteOrder, ?loads:Slice<Load>, ?sections:Slice<Pointer<Section>>, ?symtab:Pointer<Symtab>, ?dysymtab:Pointer<Dysymtab>, ?_closer:stdgo.io.Io.Closer) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(fileHeader) + " " + Go.string(byteOrder) + " " + Go.string(loads) + " " + Go.string(sections) + " " + Go.string(symtab) + " " + Go.string(dysymtab) + " " + Go.string(_closer) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:named class LoadBytes {
    ...
    public function __copy__() return new LoadBytes(__t__);
    public function __append__(args:haxe.Rest<GoUInt8>) return new LoadBytes(this.__t__.__append__(...args));
    public function __slice__(low:GoInt, high:GoInt = -1) return new LoadBytes(this.__t__.__slice__(low, high));
}
@:structInit class SegmentHeader {
    ...
    public function new(?cmd:LoadCmd, ?len:GoUInt32, ?name:GoString, ?addr:GoUInt64, ?memsz:GoUInt64, ?offset:GoUInt64, ?filesz:GoUInt64, ?maxprot:GoUInt32, ?prot:GoUInt32, ?nsect:GoUInt32, ?flag:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(cmd) + " " + Go.string(len) + " " + Go.string(name) + " " + Go.string(addr) + " " + Go.string(memsz) + " " + Go.string(offset) + " " + Go.string(filesz) + " " + Go.string(maxprot) + " " + Go.string(prot) + " " + Go.string(nsect) + " " + Go.string(flag) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class Segment {
    ...
    public function new(?loadBytes:LoadBytes, ?segmentHeader:SegmentHeader, ?readerAt:stdgo.io.Io.ReaderAt, ?_sr:Pointer<stdgo.io.Io.SectionReader>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(loadBytes) + " " + Go.string(segmentHeader) + " " + Go.string(readerAt) + " " + Go.string(_sr) + "}";
    }
    public function raw():Slice<GoUInt8> return loadBytes.raw();
...
@:structInit class SectionHeader {
    ...
    public function new(?name:GoString, ?seg:GoString, ?addr:GoUInt64, ?size:GoUInt64, ?offset:GoUInt32, ?align:GoUInt32, ?reloff:GoUInt32, ?nreloc:GoUInt32, ?flags:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(name) + " " + Go.string(seg) + " " + Go.string(addr) + " " + Go.string(size) + " " + Go.string(offset) + " " + Go.string(align) + " " + Go.string(reloff) + " " + Go.string(nreloc) + " " + Go.string(flags) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class Reloc {
    ...
    public function new(?addr:GoUInt32, ?value:GoUInt32, ?type:GoUInt8, ?len:GoUInt8, ?pcrel:Bool, ?extern_:Bool, ?scattered:Bool) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(addr) + " " + Go.string(value) + " " + Go.string(type) + " " + Go.string(len) + " " + Go.string(pcrel) + " " + Go.string(extern_) + " " + Go.string(scattered) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class Dylib {
    ...
    public function new(?loadBytes:LoadBytes, ?name:GoString, ?time:GoUInt32, ?currentVersion:GoUInt32, ?compatVersion:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class Symtab {
    ...
    public function new(?loadBytes:LoadBytes, ?symtabCmd:SymtabCmd, ?syms:Slice<Symbol>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class Dysymtab {
    ...
    public function new(?loadBytes:LoadBytes, ?dysymtabCmd:DysymtabCmd, ?indirectSyms:Slice<GoUInt32>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class Rpath {
    ...
    public function new(?loadBytes:LoadBytes, ?path:GoString) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class Symbol {
    ...
    public function new(?name:GoString, ?type:GoUInt8, ?sect:GoUInt8, ?desc:GoUInt16, ?value:GoUInt64) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(name) + " " + Go.string(type) + " " + Go.string(sect) + " " + Go.string(desc) + " " + Go.string(value) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_relocInfo {
    ...
    public function new(?addr:GoUInt32, ?symnum:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class FileHeader {
    ...
    public var flags : GoUInt32 = ((0 : GoUInt32));
    public function new(?magic:GoUInt32, ?cpu:Cpu, ?subCpu:GoUInt32, ?type:Type, ?ncmd:GoUInt32, ?cmdsz:GoUInt32, ?flags:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(magic) + " " + Go.string(cpu) + " " + Go.string(subCpu) + " " + Go.string(type) + " " + Go.string(ncmd) + " " + Go.string(cmdsz) + " " + Go.string(flags) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:named class Cpu {
    ...
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() return new Cpu(__t__);
}
@:named class LoadCmd {
    public function goString():GoString {
        var _i = this.__copy__();
    ...
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() return new LoadCmd(__t__);
}
@:structInit class Segment32 {
    ...
    public var nsect : GoUInt32 = ((0 : GoUInt32));
    public var flag : GoUInt32 = ((0 : GoUInt32));
    public function new(?cmd:LoadCmd, ?len:GoUInt32, ?name:GoArray<GoUInt8>, ?addr:GoUInt32, ?memsz:GoUInt32, ?offset:GoUInt32, ?filesz:GoUInt32, ?maxprot:GoUInt32, ?prot:GoUInt32, ?nsect:GoUInt32, ?flag:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(cmd) + " " + Go.string(len) + " " + Go.string(name) + " " + Go.string(addr) + " " + Go.string(memsz) + " " + Go.string(offset) + " " + Go.string(filesz) + " " + Go.string(maxprot) + " " + Go.string(prot) + " " + Go.string(nsect) + " " + Go.string(flag) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
...
@:structInit class Segment64 {
    ...
    public var nsect : GoUInt32 = ((0 : GoUInt32));
    public var flag : GoUInt32 = ((0 : GoUInt32));
    public function new(?cmd:LoadCmd, ?len:GoUInt32, ?name:GoArray<GoUInt8>, ?addr:GoUInt64, ?memsz:GoUInt64, ?offset:GoUInt64, ?filesz:GoUInt64, ?maxprot:GoUInt32, ?prot:GoUInt32, ?nsect:GoUInt32, ?flag:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(cmd) + " " + Go.string(len) + " " + Go.string(name) + " " + Go.string(addr) + " " + Go.string(memsz) + " " + Go.string(offset) + " " + Go.string(filesz) + " " + Go.string(maxprot) + " " + Go.string(prot) + " " + Go.string(nsect) + " " + Go.string(flag) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
...
@:structInit class SymtabCmd {
    ...
    public function new(?cmd:LoadCmd, ?len:GoUInt32, ?symoff:GoUInt32, ?nsyms:GoUInt32, ?stroff:GoUInt32, ?strsize:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(cmd) + " " + Go.string(len) + " " + Go.string(symoff) + " " + Go.string(nsyms) + " " + Go.string(stroff) + " " + Go.string(strsize) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class DysymtabCmd {
    ...
    public function new(?cmd:LoadCmd, ?len:GoUInt32, ?ilocalsym:GoUInt32, ?nlocalsym:GoUInt32, ?iextdefsym:GoUInt32, ?nextdefsym:GoUInt32, ?iundefsym:GoUInt32, ?nundefsym:GoUInt32, ?tocoffset:GoUInt32, ?ntoc:GoUInt32, ?modtaboff:GoUInt32, ?nmodtab:GoUInt32, ?extrefsymoff:GoUInt32, ?nextrefsyms:GoUInt32, ?indirectsymoff:GoUInt32, ?nindirectsyms:GoUInt32, ?extreloff:GoUInt32, ?nextrel:GoUInt32, ?locreloff:GoUInt32, ?nlocrel:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(cmd) + " " + Go.string(len) + " " + Go.string(ilocalsym) + " " + Go.string(nlocalsym) + " " + Go.string(iextdefsym) + " " + Go.string(nextdefsym) + " " + Go.string(iundefsym) + " " + Go.string(nundefsym) + " " + Go.string(tocoffset) + " " + Go.string(ntoc) + " " + Go.string(modtaboff) + " " + Go.string(nmodtab) + " " + Go.string(extrefsymoff) + " " + Go.string(nextrefsyms) + " " + Go.string(indirectsymoff) + " " + Go.string(nindirectsyms) + " " + Go.string(extreloff) + " " + Go.string(nextrel) + " " + Go.string(locreloff) + " " + Go.string(nlocrel) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class DylibCmd {
    ...
    public var currentVersion : GoUInt32 = ((0 : GoUInt32));
    public var compatVersion : GoUInt32 = ((0 : GoUInt32));
    public function new(?cmd:LoadCmd, ?len:GoUInt32, ?name:GoUInt32, ?time:GoUInt32, ?currentVersion:GoUInt32, ?compatVersion:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(cmd) + " " + Go.string(len) + " " + Go.string(name) + " " + Go.string(time) + " " + Go.string(currentVersion) + " " + Go.string(compatVersion) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class RpathCmd {
    ...
    public function new(?cmd:LoadCmd, ?len:GoUInt32, ?path:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class Thread {
    ...
    public function new(?cmd:LoadCmd, ?len:GoUInt32, ?type:GoUInt32, ?data:Slice<GoUInt32>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class Section32 {
    ...
    public function new(?name:GoArray<GoUInt8>, ?seg:GoArray<GoUInt8>, ?addr:GoUInt32, ?size:GoUInt32, ?offset:GoUInt32, ?align:GoUInt32, ?reloff:GoUInt32, ?nreloc:GoUInt32, ?flags:GoUInt32, ?reserve1:GoUInt32, ?reserve2:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(name) + " " + Go.string(seg) + " " + Go.string(addr) + " " + Go.string(size) + " " + Go.string(offset) + " " + Go.string(align) + " " + Go.string(reloff) + " " + Go.string(nreloc) + " " + Go.string(flags) + " " + Go.string(reserve1) + " " + Go.string(reserve2) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class Section64 {
    ...
    public function new(?name:GoArray<GoUInt8>, ?seg:GoArray<GoUInt8>, ?addr:GoUInt64, ?size:GoUInt64, ?offset:GoUInt32, ?align:GoUInt32, ?reloff:GoUInt32, ?nreloc:GoUInt32, ?flags:GoUInt32, ?reserve1:GoUInt32, ?reserve2:GoUInt32, ?reserve3:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(name) + " " + Go.string(seg) + " " + Go.string(addr) + " " + Go.string(size) + " " + Go.string(offset) + " " + Go.string(align) + " " + Go.string(reloff) + " " + Go.string(nreloc) + " " + Go.string(flags) + " " + Go.string(reserve1) + " " + Go.string(reserve2) + " " + Go.string(reserve3) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class Nlist32 {
    ...
    public var desc : GoUInt16 = ((0 : GoUInt16));
    public var value : GoUInt32 = ((0 : GoUInt32));
    public function new(?name:GoUInt32, ?type:GoUInt8, ?sect:GoUInt8, ?desc:GoUInt16, ?value:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(name) + " " + Go.string(type) + " " + Go.string(sect) + " " + Go.string(desc) + " " + Go.string(value) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
...
@:structInit class Nlist64 {
    ...
    public var desc : GoUInt16 = ((0 : GoUInt16));
    public var value : GoUInt64 = ((0 : GoUInt64));
    public function new(?name:GoUInt32, ?type:GoUInt8, ?sect:GoUInt8, ?desc:GoUInt16, ?value:GoUInt64) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(name) + " " + Go.string(type) + " " + Go.string(sect) + " " + Go.string(desc) + " " + Go.string(value) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
...
@:structInit class Regs386 {
    ...
    public function new(?ax:GoUInt32, ?bx:GoUInt32, ?cx:GoUInt32, ?dx:GoUInt32, ?di:GoUInt32, ?si:GoUInt32, ?bp:GoUInt32, ?sp:GoUInt32, ?ss:GoUInt32, ?flags:GoUInt32, ?ip:GoUInt32, ?cs:GoUInt32, ?ds:GoUInt32, ?es:GoUInt32, ?fs:GoUInt32, ?gs:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(ax) + " " + Go.string(bx) + " " + Go.string(cx) + " " + Go.string(dx) + " " + Go.string(di) + " " + Go.string(si) + " " + Go.string(bp) + " " + Go.string(sp) + " " + Go.string(ss) + " " + Go.string(flags) + " " + Go.string(ip) + " " + Go.string(cs) + " " + Go.string(ds) + " " + Go.string(es) + " " + Go.string(fs) + " " + Go.string(gs) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
        return new Regs386(
...
@:structInit class RegsAMD64 {
    ...
    public function new(?ax:GoUInt64, ?bx:GoUInt64, ?cx:GoUInt64, ?dx:GoUInt64, ?di:GoUInt64, ?si:GoUInt64, ?bp:GoUInt64, ?sp:GoUInt64, ?r8:GoUInt64, ?r9:GoUInt64, ?r10:GoUInt64, ?r11:GoUInt64, ?r12:GoUInt64, ?r13:GoUInt64, ?r14:GoUInt64, ?r15:GoUInt64, ?ip:GoUInt64, ?flags:GoUInt64, ?cs:GoUInt64, ?fs:GoUInt64, ?gs:GoUInt64) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(ax) + " " + Go.string(bx) + " " + Go.string(cx) + " " + Go.string(dx) + " " + Go.string(di) + " " + Go.string(si) + " " + Go.string(bp) + " " + Go.string(sp) + " " + Go.string(r8) + " " + Go.string(r9) + " " + Go.string(r10) + " " + Go.string(r11) + " " + Go.string(r12) + " " + Go.string(r13) + " " + Go.string(r14) + " " + Go.string(r15) + " " + Go.string(ip) + " " + Go.string(flags) + " " + Go.string(cs) + " " + Go.string(fs) + " " + Go.string(gs) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:named class RelocTypeGeneric {
    public function toString():GoString {
        ...
        return __RelocTypeGeneric_name.__slice__(__RelocTypeGeneric_index[_i.__t__], __RelocTypeGeneric_index[new RelocTypeGeneric(_i.__t__ + ((1 : GoInt))).__t__]);
    }
    public function goString():GoString {
    ...
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() return new RelocTypeGeneric(__t__);
}
@:named class RelocTypeX86_64 {
    public function toString():GoString {
        ...
        return __RelocTypeX86_64_name.__slice__(__RelocTypeX86_64_index[_i.__t__], __RelocTypeX86_64_index[new RelocTypeX86_64(_i.__t__ + ((1 : GoInt))).__t__]);
    }
    public function goString():GoString {
        var _r = this.__copy__();
        return (("macho." : GoString)) + _r.toString();
    ...
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() return new RelocTypeX86_64(__t__);
}
@:named class RelocTypeARM {
    ...
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() return new RelocTypeARM(__t__);
}
@:named class RelocTypeARM64 {
    ...
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() return new RelocTypeARM64(__t__);
}
...
var _cpuStrings : Slice<T_intName> = new Slice<T_intName>(new T_intName(cpu386.__t__, "Cpu386").__copy__(), new T_intName(cpuAmd64.__t__, "CpuAmd64").__copy__(), new T_intName(cpuArm.__t__, "CpuArm").__copy__(), new T_intName(cpuArm64.__t__, "CpuArm64").__copy__(), new T_intName(cpuPpc.__t__, "CpuPpc").__copy__(), new T_intName(cpuPpc64.__t__, "CpuPpc64").__copy__());
...
var __RelocTypeARM_index : GoArray<GoUInt8> = new GoArray<GoUInt8>(
((0 : GoUInt8)),
((17 : GoUInt8)),
((31 : GoUInt8)),
((49 : GoUInt8)),
...
var __RelocTypeARM64_index : GoArray<GoUInt16> = new GoArray<GoUInt16>(
((0 : GoUInt16)),
((20 : GoUInt16)),
((42 : GoUInt16)),
((62 : GoUInt16)),
...
var _typeStrings : Slice<T_intName> = new Slice<T_intName>(new T_intName(typeObj.__t__, "Obj").__copy__(), new T_intName(typeExec.__t__, "Exec").__copy__(), new T_intName(typeDylib.__t__, "Dylib").__copy__(), new T_intName(typeBundle.__t__, "Bundle").__copy__());
...
var __RelocTypeX86_64_index : GoArray<GoUInt8> = new GoArray<GoUInt8>(
((0 : GoUInt8)),
((21 : GoUInt8)),
((40 : GoUInt8)),
((59 : GoUInt8)),
...
var _cmdStrings : Slice<T_intName> = new Slice<T_intName>(new T_intName(loadCmdSegment.__t__, "LoadCmdSegment").__copy__(), new T_intName(loadCmdThread.__t__, "LoadCmdThread").__copy__(), new T_intName(loadCmdUnixThread.__t__, "LoadCmdUnixThread").__copy__(), new T_intName(loadCmdDylib.__t__, "LoadCmdDylib").__copy__(), new T_intName(loadCmdSegment64.__t__, "LoadCmdSegment64").__copy__(), new T_intName(loadCmdRpath.__t__, "LoadCmdRpath").__copy__());
...
var __RelocTypeGeneric_index : GoArray<GoUInt8> = new GoArray<GoUInt8>(((0 : GoUInt8)), ((21 : GoUInt8)), ((39 : GoUInt8)), ((61 : GoUInt8)), ((84 : GoUInt8)), ((112 : GoUInt8)), ((129 : GoUInt8))).copy();
...
function newFatFile(_r:stdgo.io.Io.ReaderAt):{ var _0 : Pointer<FatFile>; var _1 : Error; } {
        ...
        var _err:stdgo.Error = stdgo.encoding.binary.Binary.read(_sr.value, stdgo.encoding.binary.Binary.bigEndian.__copy__(), Go.toInterface(Go.pointer(_ff.magic)));
        if (_err != null) {
            return { _0 : new Pointer<FatFile>().nil(), _1 : Go.pointer(new FormatError(((0 : GoInt64)), "error reading magic number", ((null : AnyInterface)))).value };
        ...
        var _seenArches:GoMap<GoUInt64, Bool> = new GoMap<GoUInt64, Bool>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(uint64_kind), stdgo.reflect.Reflect.GoType.basic(bool_kind))));
        ...
        _ff.arches = new Slice<FatArch>(...[for (i in 0 ... ((_narch : GoInt)).toBasic()) new FatArch()]);
        {
            ...
            Go.cfor(_i < _narch, _i++, {
                ...
                _err = stdgo.encoding.binary.Binary.read(_sr.value, stdgo.encoding.binary.Binary.bigEndian.__copy__(), Go.toInterface(Go.pointer(_fa.value.fatArchHeader)));
                if (_err != null) {
                ...
                var _fr:Pointer<stdgo.io.Io.SectionReader> = stdgo.io.Io.newSectionReader(_r, ((_fa.value.fatArchHeader.offset : GoInt64)), ((_fa.value.fatArchHeader.size : GoInt64)));
                {
                ...
                {
                    var __tmp__ = _seenArches.exists(_seenArch) ? { value : _seenArches[_seenArch], ok : true } : { value : _seenArches.defaultValue(), ok : false }, _o:Bool = __tmp__.value, _k:Bool = __tmp__.ok;
                    if (_o || _k) {
                        return { _0 : new Pointer<FatFile>().nil(), _1 : Go.pointer(new FormatError(_offset, stdgo.fmt.Fmt.sprintf("duplicate architecture cpu=%v, subcpu=%#x", Go.toInterface(_fa.value.fatArchHeader.cpu), Go.toInterface(_fa.value.fatArchHeader.subCpu)), ((null : AnyInterface)))).value };
                    };
                };
                ...
                if (_i == ((0 : GoUInt32))) {
                    ...
                    if (_fa.value.file.value.fileHeader.type.__t__ != _machoType.__t__) {
                        return { _0 : new Pointer<FatFile>().nil(), _1 : Go.pointer(new FormatError(_offset, stdgo.fmt.Fmt.sprintf("Mach-O type for architecture #%d (type=%#x) does not match first (type=%#x)", Go.toInterface(_i), Go.toInterface(_fa.value.file.value.fileHeader.type), Go.toInterface(_machoType)), ((null : AnyInterface)))).value };
                    };
                };
            });
        };
...
function openFat(_name:GoString):{ var _0 : Pointer<FatFile>; var _1 : Error; } {
        ...
        var __tmp__ = newFatFile(_f.value), _ff:Pointer<FatFile> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _f.value.close();
            return { _0 : new Pointer<FatFile>().nil(), _1 : _err };
        };
...
function newFile(_r:stdgo.io.Io.ReaderAt):{ var _0 : Pointer<File>; var _1 : Error; } {
        ...
        {
            var __tmp__ = _r.readAt(_dat, _offset), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return { _0 : new Pointer<File>().nil(), _1 : _err };
            };
        };
        ...
        var _bo:stdgo.encoding.binary.Binary.ByteOrder = _f.value.byteOrder;
        {
            ...
            for (_obj in _f.value.loads.keyValueIterator()) {
                ...
                var _cmd:LoadCmd = new LoadCmd(_bo.uint32(_dat.__slice__(((0 : GoInt)), ((4 : GoInt))))), _siz:GoUInt32 = _bo.uint32(_dat.__slice__(((4 : GoInt)), ((8 : GoInt))));
                ...
                if (_cmd.__t__ == loadCmdRpath.__t__) {
                    ...
                    if (_hdr.path >= ((_cmddat.length : GoUInt32))) {
                        return { _0 : new Pointer<File>().nil(), _1 : Go.pointer(new FormatError(_offset, "invalid path in rpath command", Go.toInterface(_hdr.path))).value };
                    };
                    ...
                    if (_hdr.name >= ((_cmddat.length : GoUInt32))) {
                        return { _0 : new Pointer<File>().nil(), _1 : Go.pointer(new FormatError(_offset, "invalid name in dynamic library command", Go.toInterface(_hdr.name))).value };
                    };
                    ...
                    {
                        var __tmp__ = _r.readAt(_strtab, ((_hdr.stroff : GoInt64))), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                        if (_err != null) {
                            return { _0 : new Pointer<File>().nil(), _1 : _err };
                        };
                    };
                    ...
                    var _symdat:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0 ... ((((_hdr.nsyms : GoInt)) * _symsz : GoInt)).toBasic()) ((0 : GoUInt8))]);
                    {
                        var __tmp__ = _r.readAt(_symdat, ((_hdr.symoff : GoInt64))), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                        if (_err != null) {
                            return { _0 : new Pointer<File>().nil(), _1 : _err };
                        };
                    };
                    var __tmp__ = _f.value._parseSymtab(_symdat, _strtab, _cmddat, Go.pointer(_hdr), _offset), _st:Pointer<Symtab> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                    if (_err != null) {
                        return { _0 : new Pointer<File>().nil(), _1 : _err };
                    };
                    ...
                    var _dat:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0 ... ((_hdr.nindirectsyms * ((4 : GoUInt32)) : GoInt)).toBasic()) ((0 : GoUInt8))]);
                    {
                        var __tmp__ = _r.readAt(_dat, ((_hdr.indirectsymoff : GoInt64))), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                        if (_err != null) {
                            return { _0 : new Pointer<File>().nil(), _1 : _err };
                        };
                    };
...
class File_extension_fields {
    public function close(__tmp__):Error return __tmp__.close();
    public function _parseSymtab(__tmp__, _symdat:Slice<GoByte>, _strtab:Slice<GoByte>, _cmddat:Slice<GoByte>, _hdr:Pointer<SymtabCmd>, _offset:GoInt64):{ var _0 : Pointer<Symtab>; var _1 : Error; } return __tmp__._parseSymtab(_symdat, _strtab, _cmddat, _hdr, _offset);
    public function _pushSection(__tmp__, _sh:Pointer<Section>, _r:stdgo.io.Io.ReaderAt):Error return __tmp__._pushSection(_sh, _r);
    public function segment(__tmp__, _name:GoString):Pointer<Segment> return __tmp__.segment(_name);
    ...
    public function importedSymbols(__tmp__):{ var _0 : Slice<GoString>; var _1 : Error; } return __tmp__.importedSymbols();
...
class LoadBytes_extension_fields {
    public function raw(__tmp__):Slice<GoByte> return __tmp__.raw();
}
