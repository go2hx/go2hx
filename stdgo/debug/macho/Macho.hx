...
var magic32 : stdgo.GoUInt32 = 4277009102i32;
var magic64 : stdgo.GoUInt32 = 4277009103i32;
var magicFat : stdgo.GoUInt32 = 3405691582i32;
var typeObj : Type_ = 1i32;
var typeExec : Type_ = 2i32;
var typeDylib : Type_ = 6i32;
var typeBundle : Type_ = 8i32;
var cpu386 : Cpu = 7i32;
var cpuAmd64 : Cpu = 16777223i32;
var cpuArm : Cpu = 12i32;
var cpuArm64 : Cpu = 16777228i32;
var cpuPpc : Cpu = 18i32;
var cpuPpc64 : Cpu = 16777234i32;
var loadCmdSegment : LoadCmd = 1i32;
var loadCmdSymtab : LoadCmd = 2i32;
var loadCmdThread : LoadCmd = 4i32;
var loadCmdUnixThread : LoadCmd = 5i32;
var loadCmdDysymtab : LoadCmd = 11i32;
var loadCmdDylib : LoadCmd = 12i32;
var loadCmdDylinker : LoadCmd = 15i32;
var loadCmdSegment64 : LoadCmd = 25i32;
var loadCmdRpath : LoadCmd = 2147483676i32;
var flagNoUndefs : stdgo.GoUInt32 = 1i32;
var flagIncrLink : stdgo.GoUInt32 = 2i32;
var flagDyldLink : stdgo.GoUInt32 = 4i32;
var flagBindAtLoad : stdgo.GoUInt32 = 8i32;
var flagPrebound : stdgo.GoUInt32 = 16i32;
var flagSplitSegs : stdgo.GoUInt32 = 32i32;
var flagLazyInit : stdgo.GoUInt32 = 64i32;
var flagTwoLevel : stdgo.GoUInt32 = 128i32;
var flagForceFlat : stdgo.GoUInt32 = 256i32;
var flagNoMultiDefs : stdgo.GoUInt32 = 512i32;
var flagNoFixPrebinding : stdgo.GoUInt32 = 1024i32;
var flagPrebindable : stdgo.GoUInt32 = 2048i32;
var flagAllModsBound : stdgo.GoUInt32 = 4096i32;
var flagSubsectionsViaSymbols : stdgo.GoUInt32 = 8192i32;
var flagCanonical : stdgo.GoUInt32 = 16384i32;
var flagWeakDefines : stdgo.GoUInt32 = 32768i32;
var flagBindsToWeak : stdgo.GoUInt32 = 65536i32;
var flagAllowStackExecution : stdgo.GoUInt32 = 131072i32;
var flagRootSafe : stdgo.GoUInt32 = 262144i32;
var flagSetuidSafe : stdgo.GoUInt32 = 524288i32;
var flagNoReexportedDylibs : stdgo.GoUInt32 = 1048576i32;
var flagPIE : stdgo.GoUInt32 = 2097152i32;
var flagDeadStrippableDylib : stdgo.GoUInt32 = 4194304i32;
var flagHasTLVDescriptors : stdgo.GoUInt32 = 8388608i32;
var flagNoHeapExecution : stdgo.GoUInt32 = 16777216i32;
var flagAppExtensionSafe : stdgo.GoUInt32 = 33554432i32;
var gENERIC_RELOC_VANILLA : RelocTypeGeneric = 0i32;
var gENERIC_RELOC_PAIR : RelocTypeGeneric = 1i32;
var gENERIC_RELOC_SECTDIFF : RelocTypeGeneric = 2i32;
var gENERIC_RELOC_PB_LA_PTR : RelocTypeGeneric = 3i32;
var gENERIC_RELOC_LOCAL_SECTDIFF : RelocTypeGeneric = 4i32;
var gENERIC_RELOC_TLV : RelocTypeGeneric = 5i32;
var x86_64_RELOC_UNSIGNED : RelocTypeX86_64 = 0i32;
var x86_64_RELOC_SIGNED : RelocTypeX86_64 = 1i32;
var x86_64_RELOC_BRANCH : RelocTypeX86_64 = 2i32;
var x86_64_RELOC_GOT_LOAD : RelocTypeX86_64 = 3i32;
var x86_64_RELOC_GOT : RelocTypeX86_64 = 4i32;
var x86_64_RELOC_SUBTRACTOR : RelocTypeX86_64 = 5i32;
var x86_64_RELOC_SIGNED_1 : RelocTypeX86_64 = 6i32;
var x86_64_RELOC_SIGNED_2 : RelocTypeX86_64 = 7i32;
var x86_64_RELOC_SIGNED_4 : RelocTypeX86_64 = 8i32;
var x86_64_RELOC_TLV : RelocTypeX86_64 = 9i32;
var aRM_RELOC_VANILLA : RelocTypeARM = 0i32;
var aRM_RELOC_PAIR : RelocTypeARM = 1i32;
var aRM_RELOC_SECTDIFF : RelocTypeARM = 2i32;
var aRM_RELOC_LOCAL_SECTDIFF : RelocTypeARM = 3i32;
var aRM_RELOC_PB_LA_PTR : RelocTypeARM = 4i32;
var aRM_RELOC_BR24 : RelocTypeARM = 5i32;
var aRM_THUMB_RELOC_BR22 : RelocTypeARM = 6i32;
var aRM_THUMB_32BIT_BRANCH : RelocTypeARM = 7i32;
var aRM_RELOC_HALF : RelocTypeARM = 8i32;
var aRM_RELOC_HALF_SECTDIFF : RelocTypeARM = 9i32;
var aRM64_RELOC_UNSIGNED : RelocTypeARM64 = 0i32;
var aRM64_RELOC_SUBTRACTOR : RelocTypeARM64 = 1i32;
var aRM64_RELOC_BRANCH26 : RelocTypeARM64 = 2i32;
var aRM64_RELOC_PAGE21 : RelocTypeARM64 = 3i32;
var aRM64_RELOC_PAGEOFF12 : RelocTypeARM64 = 4i32;
var aRM64_RELOC_GOT_LOAD_PAGE21 : RelocTypeARM64 = 5i32;
var aRM64_RELOC_GOT_LOAD_PAGEOFF12 : RelocTypeARM64 = 6i32;
var aRM64_RELOC_POINTER_TO_GOT : RelocTypeARM64 = 7i32;
var aRM64_RELOC_TLVP_LOAD_PAGE21 : RelocTypeARM64 = 8i32;
var aRM64_RELOC_TLVP_LOAD_PAGEOFF12 : RelocTypeARM64 = 9i32;
var aRM64_RELOC_ADDEND : RelocTypeARM64 = 10i32;
