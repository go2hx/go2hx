...
@:structInit class File {
    ...
    public function importedSymbols():{ var _0 : Slice<GoString>; var _1 : Error; } {
        ...
        var _pe64:Bool = _f.value.fileHeader.machine == image_FILE_MACHINE_AMD64 || _f.value.fileHeader.machine == image_FILE_MACHINE_ARM64;
        ...
        for (_s in _f.value.sections) {
            if (_s.value.sectionHeader.virtualAddress <= _idd.virtualAddress && _idd.virtualAddress < _s.value.sectionHeader.virtualAddress + _s.value.sectionHeader.virtualSize) {
                _ds = _s;
                break;
            };
        };
        ...
        var __tmp__ = _ds.value.data(), _names:Slice<GoUInt8> = __tmp__._0, _:stdgo.Error = __tmp__._1;
            ...
            while (_d.length > ((0 : GoInt))) {
                if (_pe64) {
                    ...
                    if (_va & (("9223372036854775808" : GoUInt64)) > ((0 : GoUInt64))) {} else {
                        var __tmp__ = _getString(_names, (((((_va : GoUInt32)) - _ds.value.sectionHeader.virtualAddress + ((2 : GoUInt32))) : GoInt))), _fn:GoString = __tmp__._0, _:Bool = __tmp__._1;
                    ...
                    if (_va & (("2147483648" : GoUInt32)) > ((0 : GoUInt32))) {} else {
                        var __tmp__ = _getString(_names, (((_va - _ds.value.sectionHeader.virtualAddress + ((2 : GoUInt32))) : GoInt))), _fn:GoString = __tmp__._0, _:Bool = __tmp__._1;
                        _all = _all.__append__(_fn + ((":" : GoString)) + _dt._dll);
                    };
                };
            };
    ...
    public function dwarf():{ var _0 : Pointer<stdgo.debug.dwarf.Dwarf.Data>; var _1 : Error; } {
        ...
        var _sectionData:Pointer<Section> -> { var _0 : Slice<GoUInt8>; var _1 : stdgo.Error; } = function(_s:Pointer<Section>):{ var _0 : Slice<GoByte>; var _1 : Error; } {
            ...
            if (((0 : GoUInt32)) < _s.value.sectionHeader.virtualSize && _s.value.sectionHeader.virtualSize < _s.value.sectionHeader.size) {
    ...
    public function new(?fileHeader:FileHeader, ?optionalHeader:AnyInterface, ?sections:Slice<Pointer<Section>>, ?symbols:Slice<Pointer<Symbol>>, ?coffsymbols:Slice<COFFSymbol>, ?stringTable:StringTable, ?_closer:stdgo.io.Io.Closer) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(fileHeader) + " " + Go.string(optionalHeader) + " " + Go.string(sections) + " " + Go.string(symbols) + " " + Go.string(coffsymbols) + " " + Go.string(stringTable) + " " + Go.string(_closer) + "}";
    }
...
@:structInit class ImportDirectory {
    ...
    public function new(?originalFirstThunk:GoUInt32, ?timeDateStamp:GoUInt32, ?forwarderChain:GoUInt32, ?name:GoUInt32, ?firstThunk:GoUInt32, ?_dll:GoString) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(originalFirstThunk) + " " + Go.string(timeDateStamp) + " " + Go.string(forwarderChain) + " " + Go.string(name) + " " + Go.string(firstThunk) + " " + Go.string(_dll) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class FileHeader {
    ...
    public function new(?machine:GoUInt16, ?numberOfSections:GoUInt16, ?timeDateStamp:GoUInt32, ?pointerToSymbolTable:GoUInt32, ?numberOfSymbols:GoUInt32, ?sizeOfOptionalHeader:GoUInt16, ?characteristics:GoUInt16) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(machine) + " " + Go.string(numberOfSections) + " " + Go.string(timeDateStamp) + " " + Go.string(pointerToSymbolTable) + " " + Go.string(numberOfSymbols) + " " + Go.string(sizeOfOptionalHeader) + " " + Go.string(characteristics) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class DataDirectory {
    ...
    public function new(?virtualAddress:GoUInt32, ?size:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class OptionalHeader32 {
    ...
    public function new(?magic:GoUInt16, ?majorLinkerVersion:GoUInt8, ?minorLinkerVersion:GoUInt8, ?sizeOfCode:GoUInt32, ?sizeOfInitializedData:GoUInt32, ?sizeOfUninitializedData:GoUInt32, ?addressOfEntryPoint:GoUInt32, ?baseOfCode:GoUInt32, ?baseOfData:GoUInt32, ?imageBase:GoUInt32, ?sectionAlignment:GoUInt32, ?fileAlignment:GoUInt32, ?majorOperatingSystemVersion:GoUInt16, ?minorOperatingSystemVersion:GoUInt16, ?majorImageVersion:GoUInt16, ?minorImageVersion:GoUInt16, ?majorSubsystemVersion:GoUInt16, ?minorSubsystemVersion:GoUInt16, ?win32VersionValue:GoUInt32, ?sizeOfImage:GoUInt32, ?sizeOfHeaders:GoUInt32, ?checkSum:GoUInt32, ?subsystem:GoUInt16, ?dllCharacteristics:GoUInt16, ?sizeOfStackReserve:GoUInt32, ?sizeOfStackCommit:GoUInt32, ?sizeOfHeapReserve:GoUInt32, ?sizeOfHeapCommit:GoUInt32, ?loaderFlags:GoUInt32, ?numberOfRvaAndSizes:GoUInt32, ?dataDirectory:GoArray<DataDirectory>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(magic) + " " + Go.string(majorLinkerVersion) + " " + Go.string(minorLinkerVersion) + " " + Go.string(sizeOfCode) + " " + Go.string(sizeOfInitializedData) + " " + Go.string(sizeOfUninitializedData) + " " + Go.string(addressOfEntryPoint) + " " + Go.string(baseOfCode) + " " + Go.string(baseOfData) + " " + Go.string(imageBase) + " " + Go.string(sectionAlignment) + " " + Go.string(fileAlignment) + " " + Go.string(majorOperatingSystemVersion) + " " + Go.string(minorOperatingSystemVersion) + " " + Go.string(majorImageVersion) + " " + Go.string(minorImageVersion) + " " + Go.string(majorSubsystemVersion) + " " + Go.string(minorSubsystemVersion) + " " + Go.string(win32VersionValue) + " " + Go.string(sizeOfImage) + " " + Go.string(sizeOfHeaders) + " " + Go.string(checkSum) + " " + Go.string(subsystem) + " " + Go.string(dllCharacteristics) + " " + Go.string(sizeOfStackReserve) + " " + Go.string(sizeOfStackCommit) + " " + Go.string(sizeOfHeapReserve) + " " + Go.string(sizeOfHeapCommit) + " " + Go.string(loaderFlags) + " " + Go.string(numberOfRvaAndSizes) + " " + Go.string(dataDirectory) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class OptionalHeader64 {
    ...
    public var numberOfRvaAndSizes : GoUInt32 = ((0 : GoUInt32));
    public var dataDirectory : GoArray<DataDirectory> = new GoArray<DataDirectory>(...[for (i in 0 ... 16) new DataDirectory()]);
    public function new(?magic:GoUInt16, ?majorLinkerVersion:GoUInt8, ?minorLinkerVersion:GoUInt8, ?sizeOfCode:GoUInt32, ?sizeOfInitializedData:GoUInt32, ?sizeOfUninitializedData:GoUInt32, ?addressOfEntryPoint:GoUInt32, ?baseOfCode:GoUInt32, ?imageBase:GoUInt64, ?sectionAlignment:GoUInt32, ?fileAlignment:GoUInt32, ?majorOperatingSystemVersion:GoUInt16, ?minorOperatingSystemVersion:GoUInt16, ?majorImageVersion:GoUInt16, ?minorImageVersion:GoUInt16, ?majorSubsystemVersion:GoUInt16, ?minorSubsystemVersion:GoUInt16, ?win32VersionValue:GoUInt32, ?sizeOfImage:GoUInt32, ?sizeOfHeaders:GoUInt32, ?checkSum:GoUInt32, ?subsystem:GoUInt16, ?dllCharacteristics:GoUInt16, ?sizeOfStackReserve:GoUInt64, ?sizeOfStackCommit:GoUInt64, ?sizeOfHeapReserve:GoUInt64, ?sizeOfHeapCommit:GoUInt64, ?loaderFlags:GoUInt32, ?numberOfRvaAndSizes:GoUInt32, ?dataDirectory:GoArray<DataDirectory>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(magic) + " " + Go.string(majorLinkerVersion) + " " + Go.string(minorLinkerVersion) + " " + Go.string(sizeOfCode) + " " + Go.string(sizeOfInitializedData) + " " + Go.string(sizeOfUninitializedData) + " " + Go.string(addressOfEntryPoint) + " " + Go.string(baseOfCode) + " " + Go.string(imageBase) + " " + Go.string(sectionAlignment) + " " + Go.string(fileAlignment) + " " + Go.string(majorOperatingSystemVersion) + " " + Go.string(minorOperatingSystemVersion) + " " + Go.string(majorImageVersion) + " " + Go.string(minorImageVersion) + " " + Go.string(majorSubsystemVersion) + " " + Go.string(minorSubsystemVersion) + " " + Go.string(win32VersionValue) + " " + Go.string(sizeOfImage) + " " + Go.string(sizeOfHeaders) + " " + Go.string(checkSum) + " " + Go.string(subsystem) + " " + Go.string(dllCharacteristics) + " " + Go.string(sizeOfStackReserve) + " " + Go.string(sizeOfStackCommit) + " " + Go.string(sizeOfHeapReserve) + " " + Go.string(sizeOfHeapCommit) + " " + Go.string(loaderFlags) + " " + Go.string(numberOfRvaAndSizes) + " " + Go.string(dataDirectory) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class SectionHeader32 {
    public function _fullName(_st:StringTable):{ var _0 : GoString; var _1 : Error; } {
        ...
        var __tmp__ = stdgo.strconv.Strconv.atoi(_cstring(_sh.value.name.__slice__(((1 : GoInt))))), _i:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : "", _1 : _err };
        };
    ...
    public function new(?name:GoArray<GoUInt8>, ?virtualSize:GoUInt32, ?virtualAddress:GoUInt32, ?sizeOfRawData:GoUInt32, ?pointerToRawData:GoUInt32, ?pointerToRelocations:GoUInt32, ?pointerToLineNumbers:GoUInt32, ?numberOfRelocations:GoUInt16, ?numberOfLineNumbers:GoUInt16, ?characteristics:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(name) + " " + Go.string(virtualSize) + " " + Go.string(virtualAddress) + " " + Go.string(sizeOfRawData) + " " + Go.string(pointerToRawData) + " " + Go.string(pointerToRelocations) + " " + Go.string(pointerToLineNumbers) + " " + Go.string(numberOfRelocations) + " " + Go.string(numberOfLineNumbers) + " " + Go.string(characteristics) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class Reloc {
    ...
    public function new(?virtualAddress:GoUInt32, ?symbolTableIndex:GoUInt32, ?type:GoUInt16) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class SectionHeader {
    ...
    public var numberOfLineNumbers : GoUInt16 = ((0 : GoUInt16));
    public var characteristics : GoUInt32 = ((0 : GoUInt32));
    public function new(?name:GoString, ?virtualSize:GoUInt32, ?virtualAddress:GoUInt32, ?size:GoUInt32, ?offset:GoUInt32, ?pointerToRelocations:GoUInt32, ?pointerToLineNumbers:GoUInt32, ?numberOfRelocations:GoUInt16, ?numberOfLineNumbers:GoUInt16, ?characteristics:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(name) + " " + Go.string(virtualSize) + " " + Go.string(virtualAddress) + " " + Go.string(size) + " " + Go.string(offset) + " " + Go.string(pointerToRelocations) + " " + Go.string(pointerToLineNumbers) + " " + Go.string(numberOfRelocations) + " " + Go.string(numberOfLineNumbers) + " " + Go.string(characteristics) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:named class StringTable {
    ...
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() return new StringTable(__t__);
    public function __append__(args:haxe.Rest<GoUInt8>) return new StringTable(this.__t__.__append__(...args));
    public function __slice__(low:GoInt, high:GoInt = -1) return new StringTable(this.__t__.__slice__(low, high));
}
@:structInit class COFFSymbol {
    public function fullName(_st:StringTable):{ var _0 : GoString; var _1 : Error; } {
        ...
        {
            var __tmp__ = _isSymNameOffset(_sym.value.name.copy()), _ok:Bool = __tmp__._0, _offset:GoUInt32 = __tmp__._1;
            if (_ok) {
    ...
    public function new(?name:GoArray<GoUInt8>, ?value:GoUInt32, ?sectionNumber:GoInt16, ?type:GoUInt16, ?storageClass:GoUInt8, ?numberOfAuxSymbols:GoUInt8) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(name) + " " + Go.string(value) + " " + Go.string(sectionNumber) + " " + Go.string(type) + " " + Go.string(storageClass) + " " + Go.string(numberOfAuxSymbols) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class Symbol {
    ...
    public var type : GoUInt16 = ((0 : GoUInt16));
    public var storageClass : GoUInt8 = ((0 : GoUInt8));
    public function new(?name:GoString, ?value:GoUInt32, ?sectionNumber:GoInt16, ?type:GoUInt16, ?storageClass:GoUInt8) stdgo.internal.Macro.initLocals();
    public function toString() {
...
function newFile(_r:stdgo.io.Io.ReaderAt):{ var _0 : Pointer<File>; var _1 : Error; } {
        ...
        {
            var __tmp__ = _r.readAt(_dosheader.__slice__(((0 : GoInt))), ((0 : GoInt64))), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return { _0 : new Pointer<File>().nil(), _1 : _err };
            };
        };
        ...
        if (_dosheader[((0 : GoInt))] == (("M".code : GoRune)) && _dosheader[((1 : GoInt))] == (("Z".code : GoRune))) {
            ...
            if (!(_sign[((0 : GoInt))] == (("P".code : GoRune)) && _sign[((1 : GoInt))] == (("E".code : GoRune)) && _sign[((2 : GoInt))] == ((0 : GoUInt8)) && _sign[((3 : GoInt))] == ((0 : GoUInt8)))) {
        ...
        {
            var _err:stdgo.Error = stdgo.encoding.binary.Binary.read(_sr.value, stdgo.encoding.binary.Binary.littleEndian.__copy__(), Go.toInterface(Go.pointer(_f.value.fileHeader)));
            if (_err != null) {
                return { _0 : new Pointer<File>().nil(), _1 : _err };
            };
        };
        if (_f.value.fileHeader.machine == image_FILE_MACHINE_AMD64 || _f.value.fileHeader.machine == image_FILE_MACHINE_ARM64 || _f.value.fileHeader.machine == image_FILE_MACHINE_ARMNT || _f.value.fileHeader.machine == image_FILE_MACHINE_I386 || _f.value.fileHeader.machine == image_FILE_MACHINE_UNKNOWN) {} else {
        ...
        _f.value.sections = new Slice<Pointer<Section>>(...[for (i in 0 ... ((_f.value.fileHeader.numberOfSections : GoInt)).toBasic()) new Pointer<Section>().nil()]);
        {
            ...
            Go.cfor(_i < ((_f.value.fileHeader.numberOfSections : GoInt)), _i++, {
                ...
                var __tmp__ = _sh.value._fullName(_f.value.stringTable.__copy__()), _name:GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    return { _0 : new Pointer<File>().nil(), _1 : _err };
                };
                var _s:Pointer<Section> = Go.pointer(new Section());
                _s.value.sectionHeader = (({ name : _name, virtualSize : _sh.value.virtualSize, virtualAddress : _sh.value.virtualAddress, size : _sh.value.sizeOfRawData, offset : _sh.value.pointerToRawData, pointerToRelocations : _sh.value.pointerToRelocations, pointerToLineNumbers : _sh.value.pointerToLineNumbers, numberOfRelocations : _sh.value.numberOfRelocations, numberOfLineNumbers : _sh.value.numberOfLineNumbers, characteristics : _sh.value.characteristics } : SectionHeader)).__copy__();
...
function _readOptionalHeader(_r:stdgo.io.Io.ReadSeeker, _sz:GoUInt16):{ var _0 : AnyInterface; var _1 : Error; } {
        ...
        var _ohMagic:GoUInt16 = ((0 : GoUInt16)), _ohMagicSz:GoInt = stdgo.encoding.binary.Binary.size(Go.toInterface(_ohMagic));
        ...
        if (_ohMagic == ((267 : GoUInt16))) {
            var _oh32:OptionalHeader32 = new OptionalHeader32(), _oh32MinSz:GoInt = stdgo.encoding.binary.Binary.size(Go.toInterface(_oh32.__copy__())) - stdgo.encoding.binary.Binary.size(Go.toInterface(_oh32.dataDirectory.copy()));
            if (_sz < ((_oh32MinSz : GoUInt16))) {
                return { _0 : ((null : AnyInterface)), _1 : stdgo.fmt.Fmt.errorf("optional header size(%d) is less minimum size (%d) of PE32 optional header", Go.toInterface(_sz), Go.toInterface(_oh32MinSz)) };
            };
            _oh32.magic = _ohMagic;
            if (!_read(Go.toInterface(Go.pointer(_oh32.majorLinkerVersion))) || !_read(Go.toInterface(Go.pointer(_oh32.minorLinkerVersion))) || !_read(Go.toInterface(Go.pointer(_oh32.sizeOfCode))) || !_read(Go.toInterface(Go.pointer(_oh32.sizeOfInitializedData))) || !_read(Go.toInterface(Go.pointer(_oh32.sizeOfUninitializedData))) || !_read(Go.toInterface(Go.pointer(_oh32.addressOfEntryPoint))) || !_read(Go.toInterface(Go.pointer(_oh32.baseOfCode))) || !_read(Go.toInterface(Go.pointer(_oh32.baseOfData))) || !_read(Go.toInterface(Go.pointer(_oh32.imageBase))) || !_read(Go.toInterface(Go.pointer(_oh32.sectionAlignment))) || !_read(Go.toInterface(Go.pointer(_oh32.fileAlignment))) || !_read(Go.toInterface(Go.pointer(_oh32.majorOperatingSystemVersion))) || !_read(Go.toInterface(Go.pointer(_oh32.minorOperatingSystemVersion))) || !_read(Go.toInterface(Go.pointer(_oh32.majorImageVersion))) || !_read(Go.toInterface(Go.pointer(_oh32.minorImageVersion))) || !_read(Go.toInterface(Go.pointer(_oh32.majorSubsystemVersion))) || !_read(Go.toInterface(Go.pointer(_oh32.minorSubsystemVersion))) || !_read(Go.toInterface(Go.pointer(_oh32.win32VersionValue))) || !_read(Go.toInterface(Go.pointer(_oh32.sizeOfImage))) || !_read(Go.toInterface(Go.pointer(_oh32.sizeOfHeaders))) || !_read(Go.toInterface(Go.pointer(_oh32.checkSum))) || !_read(Go.toInterface(Go.pointer(_oh32.subsystem))) || !_read(Go.toInterface(Go.pointer(_oh32.dllCharacteristics))) || !_read(Go.toInterface(Go.pointer(_oh32.sizeOfStackReserve))) || !_read(Go.toInterface(Go.pointer(_oh32.sizeOfStackCommit))) || !_read(Go.toInterface(Go.pointer(_oh32.sizeOfHeapReserve))) || !_read(Go.toInterface(Go.pointer(_oh32.sizeOfHeapCommit))) || !_read(Go.toInterface(Go.pointer(_oh32.loaderFlags))) || !_read(Go.toInterface(Go.pointer(_oh32.numberOfRvaAndSizes)))) {
                return { _0 : ((null : AnyInterface)), _1 : stdgo.fmt.Fmt.errorf("failure to read PE32 optional header: %v", Go.toInterface(_err)) };
            };
            var __tmp__ = _readDataDirectories(_r, _sz - ((_oh32MinSz : GoUInt16)), _oh32.numberOfRvaAndSizes), _dd:Slice<DataDirectory> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
            ...
            var _oh64:OptionalHeader64 = new OptionalHeader64(), _oh64MinSz:GoInt = stdgo.encoding.binary.Binary.size(Go.toInterface(_oh64.__copy__())) - stdgo.encoding.binary.Binary.size(Go.toInterface(_oh64.dataDirectory.copy()));
            if (_sz < ((_oh64MinSz : GoUInt16))) {
                return { _0 : ((null : AnyInterface)), _1 : stdgo.fmt.Fmt.errorf("optional header size(%d) is less minimum size (%d) for PE32+ optional header", Go.toInterface(_sz), Go.toInterface(_oh64MinSz)) };
            };
            _oh64.magic = _ohMagic;
            if (!_read(Go.toInterface(Go.pointer(_oh64.majorLinkerVersion))) || !_read(Go.toInterface(Go.pointer(_oh64.minorLinkerVersion))) || !_read(Go.toInterface(Go.pointer(_oh64.sizeOfCode))) || !_read(Go.toInterface(Go.pointer(_oh64.sizeOfInitializedData))) || !_read(Go.toInterface(Go.pointer(_oh64.sizeOfUninitializedData))) || !_read(Go.toInterface(Go.pointer(_oh64.addressOfEntryPoint))) || !_read(Go.toInterface(Go.pointer(_oh64.baseOfCode))) || !_read(Go.toInterface(Go.pointer(_oh64.imageBase))) || !_read(Go.toInterface(Go.pointer(_oh64.sectionAlignment))) || !_read(Go.toInterface(Go.pointer(_oh64.fileAlignment))) || !_read(Go.toInterface(Go.pointer(_oh64.majorOperatingSystemVersion))) || !_read(Go.toInterface(Go.pointer(_oh64.minorOperatingSystemVersion))) || !_read(Go.toInterface(Go.pointer(_oh64.majorImageVersion))) || !_read(Go.toInterface(Go.pointer(_oh64.minorImageVersion))) || !_read(Go.toInterface(Go.pointer(_oh64.majorSubsystemVersion))) || !_read(Go.toInterface(Go.pointer(_oh64.minorSubsystemVersion))) || !_read(Go.toInterface(Go.pointer(_oh64.win32VersionValue))) || !_read(Go.toInterface(Go.pointer(_oh64.sizeOfImage))) || !_read(Go.toInterface(Go.pointer(_oh64.sizeOfHeaders))) || !_read(Go.toInterface(Go.pointer(_oh64.checkSum))) || !_read(Go.toInterface(Go.pointer(_oh64.subsystem))) || !_read(Go.toInterface(Go.pointer(_oh64.dllCharacteristics))) || !_read(Go.toInterface(Go.pointer(_oh64.sizeOfStackReserve))) || !_read(Go.toInterface(Go.pointer(_oh64.sizeOfStackCommit))) || !_read(Go.toInterface(Go.pointer(_oh64.sizeOfHeapReserve))) || !_read(Go.toInterface(Go.pointer(_oh64.sizeOfHeapCommit))) || !_read(Go.toInterface(Go.pointer(_oh64.loaderFlags))) || !_read(Go.toInterface(Go.pointer(_oh64.numberOfRvaAndSizes)))) {
                return { _0 : ((null : AnyInterface)), _1 : stdgo.fmt.Fmt.errorf("failure to read PE32+ optional header: %v", Go.toInterface(_err)) };
            };
            var __tmp__ = _readDataDirectories(_r, _sz - ((_oh64MinSz : GoUInt16)), _oh64.numberOfRvaAndSizes), _dd:Slice<DataDirectory> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return { _0 : ((null : AnyInterface)), _1 : _err };
            };
...
function _readDataDirectories(_r:stdgo.io.Io.ReadSeeker, _sz:GoUInt16, _n:GoUInt32):{ var _0 : Slice<DataDirectory>; var _1 : Error; } {
        ...
        if (((_sz : GoUInt32)) != _n * ((_ddSz : GoUInt32))) {
            return { _0 : new Slice<DataDirectory>().nil(), _1 : stdgo.fmt.Fmt.errorf("size of data directories(%d) is inconsistent with number of data directories(%d)", Go.toInterface(_sz), Go.toInterface(_n)) };
        };
...
function _readRelocs(_sh:Pointer<SectionHeader>, _r:stdgo.io.Io.ReadSeeker):{ var _0 : Slice<Reloc>; var _1 : Error; } {
        ...
        var __tmp__ = _r.seek(((_sh.value.pointerToRelocations : GoInt64)), _seekStart), _:GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<Reloc>().nil(), _1 : stdgo.fmt.Fmt.errorf("fail to seek to %q section relocations: %v", Go.toInterface(_sh.value.name), Go.toInterface(_err)) };
        };
...
function _readStringTable(_fh:Pointer<FileHeader>, _r:stdgo.io.Io.ReadSeeker):{ var _0 : StringTable; var _1 : Error; } {
        ...
        var __tmp__ = _r.seek(((_offset : GoInt64)), _seekStart), _:GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
...
function _readCOFFSymbols(_fh:Pointer<FileHeader>, _r:stdgo.io.Io.ReadSeeker):{ var _0 : Slice<COFFSymbol>; var _1 : Error; } {
        ...
        var __tmp__ = _r.seek(((_fh.value.pointerToSymbolTable : GoInt64)), _seekStart), _:GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
...
function _isSymNameOffset(_name:GoArray<GoByte>):{ var _0 : Bool; var _1 : GoUInt32; } {
        if (_name[((0 : GoInt))] == ((0 : GoUInt8)) && _name[((1 : GoInt))] == ((0 : GoUInt8)) && _name[((2 : GoInt))] == ((0 : GoUInt8)) && _name[((3 : GoInt))] == ((0 : GoUInt8))) {
...
function _removeAuxSymbols(_allsyms:Slice<COFFSymbol>, _st:StringTable):{ var _0 : Slice<Pointer<Symbol>>; var _1 : Error; } {
        ...
        for (_sym in _allsyms) {
            ...
            var __tmp__ = _sym.fullName(_st.__copy__()), _name:GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return { _0 : new Slice<Pointer<Symbol>>().nil(), _1 : _err };
            };
            _aux = _sym.numberOfAuxSymbols;
            var _s:Pointer<Symbol> = Go.pointer((({ name : _name, value : _sym.value, sectionNumber : _sym.sectionNumber, type : _sym.type, storageClass : _sym.storageClass } : Symbol)));
...
class SectionHeader32_extension_fields {
    public function _fullName(__tmp__, _st:StringTable):{ var _0 : GoString; var _1 : Error; } return __tmp__._fullName(_st);
}
...
class StringTable_extension_fields {
    public function toString(__tmp__, _start:GoUInt32):{ var _0 : GoString; var _1 : Error; } return __tmp__.toString(_start);
}
class COFFSymbol_extension_fields {
    public function fullName(__tmp__, _st:StringTable):{ var _0 : GoString; var _1 : Error; } return __tmp__.fullName(_st);
}
