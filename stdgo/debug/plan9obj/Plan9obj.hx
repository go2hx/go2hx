...
@:structInit class FileHeader {
    ...
    public function new(?magic:GoUInt32, ?bss:GoUInt32, ?entry:GoUInt64, ?ptrSize:GoInt, ?loadAddress:GoUInt64, ?hdrSize:GoUInt64) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(magic) + " " + Go.string(bss) + " " + Go.string(entry) + " " + Go.string(ptrSize) + " " + Go.string(loadAddress) + " " + Go.string(hdrSize) + "}";
    }
...
@:structInit class File {
    ...
    public function symbols():{ var _0 : Slice<Sym>; var _1 : Error; } {
        ...
        var __tmp__ = _symtabSection.value.data(), _symtab:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
    ...
    public function new(?fileHeader:FileHeader, ?sections:Slice<Pointer<Section>>, ?_closer:stdgo.io.Io.Closer) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class SectionHeader {
    ...
    public function new(?name:GoString, ?size:GoUInt32, ?offset:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class Section {
    ...
    public function new(?sectionHeader:SectionHeader, ?readerAt:stdgo.io.Io.ReaderAt, ?_sr:Pointer<stdgo.io.Io.SectionReader>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class Sym {
    ...
    public var name : GoString = (("" : GoString));
    public function new(?value:GoUInt64, ?type:GoInt32, ?name:GoString) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_prog {
    ...
    public function new(?magic:GoUInt32, ?text:GoUInt32, ?data:GoUInt32, ?bss:GoUInt32, ?syms:GoUInt32, ?entry:GoUInt32, ?spsz:GoUInt32, ?pcsz:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(magic) + " " + Go.string(text) + " " + Go.string(data) + " " + Go.string(bss) + " " + Go.string(syms) + " " + Go.string(entry) + " " + Go.string(spsz) + " " + Go.string(pcsz) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_sym {
    ...
    public function new(?_value:GoUInt64, ?_typ:GoUInt8, ?_name:Slice<GoUInt8>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit @:local class T__struct_43 {
    ...
    public function new(?_name:GoString, ?_size:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
...
final magicAMD64 : GoUnTypedInt = (((4 : GoUnTypedInt)) * ((26 : GoUnTypedInt)) + ((0 : GoUnTypedInt))) * ((26 : GoUnTypedInt)) + ((7 : GoUnTypedInt)) + magic64;
...
function newFile(_r:stdgo.io.Io.ReaderAt):{ var _0 : Pointer<File>; var _1 : Error; } {
        ...
        {
            var __tmp__ = _r.readAt(_magic.__slice__(0), ((0 : GoInt64))), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return { _0 : new Pointer<File>().nil(), _1 : _err };
            };
        };
        var __tmp__ = _parseMagic(_magic.__slice__(0)), _:GoUInt32 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<File>().nil(), _1 : _err };
        };
        ...
        var _f:Pointer<File> = Go.pointer((({ fileHeader : (({ magic : _ph.value.magic, bss : _ph.value.bss, entry : ((_ph.value.entry : GoUInt64)), ptrSize : ((4 : GoInt)), loadAddress : ((4096 : GoUInt64)), hdrSize : ((4 : GoUnTypedInt)) * ((8 : GoUnTypedInt)) } : FileHeader)).__copy__(), sections : new Slice<Pointer<Section>>().nil(), _closer : ((null : stdgo.io.Io.Closer)) } : File)));
        if (_ph.value.magic & magic64 != ((0 : GoUInt32))) {
            {
                var _err:stdgo.Error = stdgo.encoding.binary.Binary.read(_sr.value, stdgo.encoding.binary.Binary.bigEndian.__copy__(), Go.toInterface(Go.pointer(_f.value.fileHeader.entry)));
                if (_err != null) {
                    return { _0 : new Pointer<File>().nil(), _1 : _err };
                };
            };
        ...
        var _sects:Slice<T__struct_43> = new Slice<T__struct_43>(new T__struct_43("text", _ph.value.text).__copy__(), new T__struct_43("data", _ph.value.data).__copy__(), new T__struct_43("syms", _ph.value.syms).__copy__(), new T__struct_43("spsz", _ph.value.spsz).__copy__(), new T__struct_43("pcsz", _ph.value.pcsz).__copy__());
...
class File_extension_fields {
    ...
    public function symbols(__tmp__):{ var _0 : Slice<Sym>; var _1 : Error; } return __tmp__.symbols();
