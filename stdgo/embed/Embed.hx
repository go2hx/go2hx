...
@:structInit class FS {
	public function readFile(_name:GoString):{var _0:Slice<GoByte>; var _1:Error;} {
		...
		var __tmp__ = _f.open(_name),
			_file:io.fs.Fs.File = __tmp__._0,
		...
		if (!_ok) {
			return {_0: new Slice<GoUInt8>().nil(), _1: Go.pointer((({op: "read", path: _name,
	...
	public function readDir(_name:GoString):{var _0:Slice<io.fs.Fs.DirEntry>; var _1:Error;} {
		...
		if (!_ok) {
			return {_0: new Slice<io.fs.Fs.DirEntry>().nil(), _1: Go.pointer((({op: "read", path: _name,
				err: stdgo.errors.Errors.new_("not a directory")} : io.fs.Fs.PathError)))
				.value};
		};
		var _list:Slice<io.fs.Fs.DirEntry> = new Slice<io.fs.Fs.DirEntry>(...[
			for (i in 0...((_dir.value._files.length : GoInt)).toBasic()) ((null : io.fs.Fs.DirEntry))
		]);
		{
			var _i;
	...
	public function _lookup(_name:GoString):Pointer<T_file> {
		...
		var __tmp__ = _split(_name),
			_dir:GoString = __tmp__._0,
			_elem:GoString = __tmp__._1,
			_:Bool = __tmp__._2;
		var _files:Slice<T_file> = _f._files.value;
		var _i:GoInt = _sortSearch(_files.length, function(_i:GoInt):Bool {
	...
	public function new(?_files:Pointer<Slice<T_file>>)
...
@:structInit class T_file {
	...
	public function isDir():Bool {
		var _f = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _split(_f.value._name),
			_:GoString = __tmp__._0,
			_:GoString = __tmp__._1,
			_isDir:Bool = __tmp__._2;
		return _isDir;
	}
	...
	public function new(?_name:GoString, ?_data:GoString, ?_hash:GoArray<GoUInt8>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_openFile {
	...
	public function new(?_f:Pointer<T_file>, ?_offset:GoInt64)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_openDir {
	...
	public function new(?_f:Pointer<T_file>, ?_files:Slice<T_file>, ?_offset:GoInt)
		stdgo.internal.Macro.initLocals();
...
class FS_extension_fields {
	public function _lookup(__tmp__, _name:GoString):Pointer<T_file>
		return __tmp__._lookup(_name);

	public function _readDir(__tmp__, _dir:GoString):Slice<T_file>
		return __tmp__._readDir(_dir);

	public function open(__tmp__, _name:GoString):{var _0:io.fs.Fs.File; var _1:Error;}
		return __tmp__.open(_name);

	public function readDir(__tmp__, _name:GoString):{var _0:Slice<io.fs.Fs.DirEntry>; var _1:Error;}
...
class T_file_extension_fields {
	...
	public function type(__tmp__):io.fs.Fs.FileMode
		return __tmp__.type();

	public function info(__tmp__):{var _0:io.fs.Fs.FileInfo; var _1:Error;}
		return __tmp__.info();

	public function mode(__tmp__):io.fs.Fs.FileMode
		return __tmp__.mode();
}
