...
@:structInit class StructuralError {
	...
	public function new(?msg:GoString)
...
@:structInit class BitString {
	...
	public function new(?bytes:Slice<GoUInt8>, ?bitLength:GoInt)
		stdgo.internal.Macro.initLocals();
...
@:named class ObjectIdentifier {
	...
	public function __copy__()
		return new ObjectIdentifier(__t__);

	public function __append__(args:haxe.Rest<GoInt>)
		return new ObjectIdentifier(this.__t__.__append__(...args));

	public function __slice__(low:GoInt, high:GoInt = -1)
		return new ObjectIdentifier(this.__t__.__slice__(low, high));
}
...
@:named class T_asteriskFlag {
	...
	public function __copy__()
		return new T_asteriskFlag(__t__);
}
...
@:named class T_ampersandFlag {
	...
	public function __copy__()
		return new T_ampersandFlag(__t__);
}
...
@:structInit class RawValue {
	...
	public function new(?class_:GoInt, ?tag:GoInt, ?isCompound:Bool, ?bytes:Slice<GoUInt8>, ?fullBytes:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();
...
@:named class RawContent {
	...
	public function __copy__()
		return new RawContent(__t__);

	public function __append__(args:haxe.Rest<GoUInt8>)
		return new RawContent(this.__t__.__append__(...args));

	public function __slice__(low:GoInt, high:GoInt = -1)
		return new RawContent(this.__t__.__slice__(low, high));
}
...
@:structInit class T_tagAndLength {
	...
	public function new(?_class:GoInt, ?_tag:GoInt, ?_length:GoInt, ?_isCompound:Bool)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_fieldParameters {
	...
	public function new(?_optional:Bool, ?_explicit:Bool, ?_application:Bool, ?_private:Bool, ?_defaultValue:Pointer<GoInt64>, ?_tag:Pointer<GoInt>,
			?_stringType:GoInt, ?_timeType:GoInt, ?_set:Bool, ?_omitEmpty:Bool)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_optional) + " " + Go.string(_explicit) + " " + Go.string(_application) + " " + Go.string(_private) + " "
			+ Go.string(_defaultValue) + " " + Go.string(_tag) + " " + Go.string(_stringType) + " " + Go.string(_timeType) + " " + Go.string(_set) + " "
			+ Go.string(_omitEmpty) + "}";
	}
...
@:named class T_byteEncoder {
	...
	public function __copy__()
		return new T_byteEncoder(__t__);
}
...
@:named class T_bytesEncoder {
	...
	public function __copy__()
		return new T_bytesEncoder(__t__);

	public function __append__(args:haxe.Rest<GoUInt8>)
		return new T_bytesEncoder(this.__t__.__append__(...args));

	public function __slice__(low:GoInt, high:GoInt = -1)
		return new T_bytesEncoder(this.__t__.__slice__(low, high));
}
...
@:named class T_stringEncoder {
	...
	public function __copy__()
		return new T_stringEncoder(__t__);
}
...
@:named class T_multiEncoder {
	...
	public function __copy__()
		return new T_multiEncoder(__t__);

	public function __append__(args:haxe.Rest<T_encoder>)
		return new T_multiEncoder(this.__t__.__append__(...args));

	public function __slice__(low:GoInt, high:GoInt = -1)
		return new T_multiEncoder(this.__t__.__slice__(low, high));
}
...
@:named class T_setEncoder {
	...
	public function __copy__()
		return new T_setEncoder(__t__);

	public function __append__(args:haxe.Rest<T_encoder>)
		return new T_setEncoder(this.__t__.__append__(...args));

	public function __slice__(low:GoInt, high:GoInt = -1)
		return new T_setEncoder(this.__t__.__slice__(low, high));
}
...
@:structInit class T_taggedEncoder {
	...
	public function new(?_scratch:GoArray<GoUInt8>, ?_tag:T_encoder, ?_body:T_encoder)
		stdgo.internal.Macro.initLocals();
...
@:named class T_int64Encoder {
	...
	public function __copy__()
		return new T_int64Encoder(__t__);
}
...
@:named @:structInit class T_bitStringEncoder extends BitString {
	...
	public function new(?bytes, ?bitLength)
		super(bytes, bitLength);

	public override function __copy__()
		return new T_bitStringEncoder(bytes, bitLength);
}
...
@:named class T_oidEncoder {
	...
	public function __copy__()
		return new T_oidEncoder(__t__);

	public function __append__(args:haxe.Rest<GoInt>)
		return new T_oidEncoder(this.__t__.__append__(...args));

	public function __slice__(low:GoInt, high:GoInt = -1)
		return new T_oidEncoder(this.__t__.__slice__(low, high));
}
...
function _checkInteger(_bytes:Slice<GoByte>):Error {
	...
	if ((_bytes[((0 : GoInt))] == ((0 : GoUInt8)) && _bytes[((1 : GoInt))] & ((128 : GoUInt8)) == ((0 : GoUInt8)))
		|| (_bytes[((0 : GoInt))] == ((255 : GoUInt8)) && _bytes[((1 : GoInt))] & ((128 : GoUInt8)) == ((128 : GoUInt8)))) {
...
function _parseInt32(_bytes:Slice<GoByte>):{var _0:GoInt32; var _1:Error;} {
	...
	var __tmp__ = _parseInt64(_bytes),
		_ret64:GoInt64 = __tmp__._0,
...
function _parseBitString(_bytes:Slice<GoByte>):{var _0:BitString; var _1:Error;} {
	...
	if (_paddingBits > ((7 : GoInt))
		|| _bytes.length == ((1 : GoInt))
		&& _paddingBits > ((0 : GoInt))
		|| _bytes[_bytes.length - ((1 : GoInt))] & (((((1 : GoUInt8)) << _bytes[((0 : GoInt))])) - ((1 : GoUInt8))) != ((0 : GoUInt8))) {
...
function _parseObjectIdentifier(_bytes:Slice<GoByte>):{var _0:ObjectIdentifier; var _1:Error;} {
	var _s:ObjectIdentifier = new ObjectIdentifier(),
	...
	var __tmp__ = _parseBase128Int(_bytes, ((0 : GoInt))),
		_v:GoInt = __tmp__._0,
...
function _parseUTCTime(_bytes:Slice<GoByte>):{var _0:stdgo.time.Time.Time; var _1:Error;} {
	var _ret:stdgo.time.Time.Time = new stdgo.time.Time.Time(),
		_err:Error = ((null : stdgo.Error));
	...
	};
	{
		...
		if (_serialized != _s) {
			_err = stdgo.fmt.Fmt.errorf("asn1: time did not serialize back to the original value and may be invalid: given %q, but serialized as %q",
				Go.toInterface(_s), Go.toInterface(_serialized));
			return {_0: _ret, _1: _err};
		};
	};
			...
			|| (("0".code : GoRune)) <= _b
				...
				|| (("\'".code : GoRune)) <= _b
					...
					|| (("+".code : GoRune)) <= _b
						...
						|| _b == (("=".code : GoRune))
						|| _b == (("?".code : GoRune))
						|| (_asterisk.__t__ && _b == (("*".code : GoRune)))
						|| (_ampersand.__t__ && _b == (("&".code : GoRune)));
}
...
function _parseBMPString(_bmpString:Slice<GoByte>):{var _0:GoString; var _1:Error;} {
	...
	};
	{
		...
		if (_l >= ((2 : GoInt))
			&& _bmpString[_l - ((1 : GoInt))] == ((0 : GoUInt8))
			&& _bmpString[_l - ((2 : GoInt))] == ((0 : GoUInt8))) {
	...
	var _s:Slice<GoUInt16> = new Slice<GoUInt16>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt16))])
		.setCap(((_bmpString.length / ((2 : GoInt)):GoInt)).toBasic());
...
function _parseTagAndLength(_bytes:Slice<GoByte>, _initOffset:GoInt):{var _0:T_tagAndLength; var _1:GoInt; var _2:Error;} {
	var _ret:T_tagAndLength = new T_tagAndLength(),
		_offset:GoInt = ((0 : GoInt)),
		_err:Error = ((null : stdgo.Error));
	_offset = _initOffset;
...
**/
function _parseSequenceOf(_bytes:Slice<GoByte>, _sliceType:stdgo.reflect.Reflect.Type,
		_elemType:stdgo.reflect.Reflect.Type):{var _0:stdgo.reflect.Reflect.Value; var _1:Error;} {
	var _ret:stdgo.reflect.Reflect.Value = new stdgo.reflect.Reflect.Value(),
		_err:Error = ((null : stdgo.Error));
	var __tmp__ = _getUniversalType(_elemType),
		_matchAny:Bool = __tmp__._0,
		_expectedTag:GoInt = __tmp__._1,
		_compoundType:Bool = __tmp__._2,
		_ok:Bool = __tmp__._3;
	if (!_ok) {
	...
	var _numElements:GoInt = ((0 : GoInt));
	{
		...
		while (_offset < _bytes.length) {
			...
			if (_t._tag == tagIA5String || _t._tag == tagGeneralString || _t._tag == tagT61String || _t._tag == tagUTF8String
				|| _t._tag == tagNumericString || _t._tag == tagBMPString) {
...
function _parseField(_v:stdgo.reflect.Reflect.Value, _bytes:Slice<GoByte>, _initOffset:GoInt, _params:T_fieldParameters):{var _0:GoInt; var _1:Error;} {
	...
	var __tmp__ = _getUniversalType(_fieldType),
		_matchAny:Bool = __tmp__._0,
		_universalTag:GoInt = __tmp__._1,
		_compoundType:Bool = __tmp__._2,
		_ok1:Bool = __tmp__._3;
	if (!_ok1) {
	...
	if (!_matchAnyClassAndTag
		&& (_t._class != _expectedClass || _t._tag != _expectedTag)
		|| (!_matchAny && _t._isCompound != _compoundType)) {
		var _ok:Bool = _setDefaultValue(_v.__copy__(), _params.__copy__());
		if (_ok) {
			_offset = _initOffset;
		} else {
			_err = new StructuralError(stdgo.fmt.Fmt.sprintf("tags don\'t match (%d vs %+v) %+v %s @%d", Go.toInterface(_expectedTag),
				Go.toInterface(_t.__copy__()), Go.toInterface(_params.__copy__()), Go.toInterface(_fieldType.name()), Go.toInterface(_offset))).__copy__();
		};
		return {_0: _offset, _1: _err};
	};
	if (_invalidLength(_offset, _t._length, _bytes.length)) {
	...
	if (Go.assertable(((_v.addr().interface_() : Pointer<RawValue>)))) {
		var _v:Pointer<RawValue> = _v.addr()
			.interface_() == null ? null : _v.addr()
			.interface_()
			.__underlying__() == null ? null : _v.addr()
			.interface_() == null ? null : _v.addr()
			.interface_()
			.__underlying__()
			.value;
		...
		var _v:Pointer<ObjectIdentifier> = _v.addr()
			.interface_() == null ? null : _v.addr()
			.interface_()
			.__underlying__() == null ? null : _v.addr()
			.interface_() == null ? null : _v.addr()
		...
		var _v:Pointer<BitString> = _v.addr()
			.interface_() == null ? null : _v.addr()
			.interface_()
			.__underlying__() == null ? null : _v.addr()
			.interface_() == null ? null : _v.addr()
		...
		var _v:Pointer<stdgo.time.Time.Time> = _v.addr()
			.interface_() == null ? null : _v.addr()
			.interface_()
			.__underlying__() == null ? null : _v.addr()
			.interface_() == null ? null : _v.addr()
		...
		var _v:Pointer<Enumerated> = _v.addr()
			.interface_() == null ? null : _v.addr()
			.interface_()
			.__underlying__() == null ? null : _v.addr()
			.interface_() == null ? null : _v.addr()
			...
			.__underlying__()
			.value;
		var __tmp__ = _parseInt32(_innerBytes),
			_parsedInt:GoInt32 = __tmp__._0,
		...
		var _v:Pointer<Pointer<stdgo.math.big.Big.Int_>> = _v.addr()
			.interface_() == null ? null : _v.addr()
			.interface_()
			.__underlying__() == null ? null : _v.addr()
			.interface_() == null ? null : _v.addr()
			...
			.__underlying__()
			.value;
		var __tmp__ = _parseBigInt(_innerBytes),
			_parsedInt:Pointer<stdgo.math.big.Big.Int_> = __tmp__._0,
			_err1:stdgo.Error = __tmp__._1;
		if (_err1 == null) {
			_v.value = _parsedInt;
		};
	...
	};
	{
		...
		if (_val.kind().__t__ == stdgo.reflect.Reflect.bool.__t__) {
			var __tmp__ = _parseBool(_innerBytes),
				_parsedBool:Bool = __tmp__._0,
				_err1:stdgo.Error = __tmp__._1;
			if (_err1 == null) {
			...
			_err = _err1;
			return {_0: _offset, _1: _err};
		} else if (_val.kind().__t__ == stdgo.reflect.Reflect.int.__t__
			|| _val.kind().__t__ == stdgo.reflect.Reflect.int32.__t__
			|| _val.kind().__t__ == stdgo.reflect.Reflect.int64.__t__) {
			...
			if (_structType.numField() > ((0 : GoInt))
				&& _structType.field(((0 : GoInt))).type.toString() == _rawContentsType.toString()) {
			...
			var _innerOffset:GoInt = ((0 : GoInt));
			{
				...
				Go.cfor(_i < _structType.numField(), _i++, {
					...
					{
						var __tmp__ = _parseField(_val.field(_i).__copy__(), _innerBytes, _innerOffset,
							_parseFieldParameters(_field.tag.get("asn1")).__copy__());
			...
			var __tmp__ = _parseSequenceOf(_innerBytes, _sliceType, _sliceType.elem()),
				_newSlice:stdgo.reflect.Reflect.Value = __tmp__._0,
				_err1:stdgo.Error = __tmp__._1;
			if (_err1 == null) {
...
function _canHaveDefaultValue(_k:stdgo.reflect.Reflect.Kind):Bool {
	if (_k.__t__ == stdgo.reflect.Reflect.int.__t__
		|| _k.__t__ == stdgo.reflect.Reflect.int8.__t__
		|| _k.__t__ == stdgo.reflect.Reflect.int16.__t__
		|| _k.__t__ == stdgo.reflect.Reflect.int32.__t__
		|| _k.__t__ == stdgo.reflect.Reflect.int64.__t__) {
		return true;
	};
	return false;
}
...
function unmarshal(_b:Slice<GoByte>, _val:AnyInterface):{var _0:Slice<GoByte>; var _1:Error;} {
	var _rest:Slice<GoByte> = new Slice<GoUInt8>().nil(),
		_err:Error = ((null : stdgo.Error));
...
function unmarshalWithParams(_b:Slice<GoByte>, _val:AnyInterface, _params:GoString):{var _0:Slice<GoByte>; var _1:Error;} {
	...
	var __tmp__ = _parseField(_v.elem().__copy__(), _b, ((0 : GoInt)), _parseFieldParameters(_params).__copy__()),
...
function _parseFieldParameters(_str:GoString):T_fieldParameters {
	...
	while (_str.length > ((0 : GoInt))) {
		...
		if (_part == (("optional" : GoString))) {
			...
			var __tmp__ = stdgo.strconv.Strconv.parseInt(_part.__slice__(((8 : GoInt))), ((10 : GoInt)), ((64 : GoInt))),
			...
			var __tmp__ = stdgo.strconv.Strconv.atoi(_part.__slice__(((4 : GoInt)))),
				_i:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err == null) {
				_ret._tag = Go.pointer(((0 : GoInt)));
...
**/
function _getUniversalType(_t:stdgo.reflect.Reflect.Type):{
	var _0:Bool;
	var _1:GoInt;
	var _2:Bool;
	var _3:Bool;
} {
	var _matchAny:Bool = false,
		_tagNumber:GoInt = ((0 : GoInt)),
		_isCompound:Bool = false,
		_ok:Bool = false;
	...
	} else if (_t.kind().__t__ == stdgo.reflect.Reflect.int.__t__
...
function _makeBigInt(_n:Pointer<stdgo.math.big.Big.Int_>):{var _0:T_encoder; var _1:Error;} {
	...
	if (_n.value.sign() < ((0 : GoInt))) {
		...
		if (_bytes.length == ((0 : GoInt)) || _bytes[((0 : GoInt))] & ((128 : GoUInt8)) == ((0 : GoUInt8))) {
			return {_0: new T_multiEncoder(new Slice<T_encoder>(_byteFFEncoder,
				new T_bytesEncoder(_bytes).__copy__())).__copy__(), _1: ((null : stdgo.Error))};
		};
		...
		if (_bytes.length > ((0 : GoInt)) && _bytes[((0 : GoInt))] & ((128 : GoUInt8)) != ((0 : GoUInt8))) {
			return {_0: new T_multiEncoder(new Slice<T_encoder>(_byte00Encoder,
				new T_bytesEncoder(_bytes).__copy__())).__copy__(), _1: ((null : stdgo.Error))};
		};
		return {_0: new T_bytesEncoder(_bytes).__copy__(), _1: ((null : stdgo.Error))};
	};
...
function _makeObjectIdentifier(_oid:Slice<GoInt>):{var _0:T_encoder; var _1:Error;} {
	var _e:T_encoder = ((null : T_encoder)),
		_err:Error = ((null : stdgo.Error));
	if (_oid.length < ((2 : GoInt))
		|| _oid[((0 : GoInt))] > ((2 : GoInt))
		|| (_oid[((0 : GoInt))] < ((2 : GoInt)) && _oid[((1 : GoInt))] >= ((40 : GoInt)))) {
...
function _appendTwoDigits(_dst:Slice<GoByte>, _v:GoInt):Slice<GoByte> {
	return _dst.__append__(((((("0".code : GoRune)) + (_v / ((10 : GoInt))) % ((10 : GoInt))) : GoByte)),
		((((("0".code : GoRune)) + _v % ((10 : GoInt))) : GoByte)));
}
...
function _makeUTCTime(_t:stdgo.time.Time.Time):{var _0:T_encoder; var _1:Error;} {
	var _e:T_encoder = ((null : T_encoder)),
		_err:Error = ((null : stdgo.Error));
	var _dst:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((((18 : GoInt)) : GoInt))
		.toBasic());
	{
...
function _makeGeneralizedTime(_t:stdgo.time.Time.Time):{var _0:T_encoder; var _1:Error;} {
	var _e:T_encoder = ((null : T_encoder)),
		_err:Error = ((null : stdgo.Error));
	var _dst:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((((20 : GoInt)) : GoInt))
		.toBasic());
	{
...
function _appendUTCTime(_dst:Slice<GoByte>, _t:stdgo.time.Time.Time):{var _0:Slice<GoByte>; var _1:Error;} {
	var _ret:Slice<GoByte> = new Slice<GoUInt8>().nil(),
		_err:Error = ((null : stdgo.Error));
	var _year:GoInt = _t.year();
...
function _stripTagAndLength(_in:Slice<GoByte>):Slice<GoByte> {
	var __tmp__ = _parseTagAndLength(_in, ((0 : GoInt))),
		_:T_tagAndLength = __tmp__._0,
		_offset:GoInt = __tmp__._1,
		_err:stdgo.Error = __tmp__._2;
	if (_err != null) {
		return _in;
...
function _makeBody(_value:stdgo.reflect.Reflect.Value, _params:T_fieldParameters):{var _0:T_encoder; var _1:Error;} {
	...
	if (_value.type().toString() == _flagType.toString()) {
		...
		return {_0: new T_bitStringEncoder(((_value.interface_().value : BitString)).bytes,
			((_value.interface_().value : BitString)).bitLength).__copy__(), _1: ((null : stdgo.Error))};
			...
			};
			{
				...
				if (_n1 == ((0 : GoInt))) {
					...
					var _m:Slice<T_encoder> = new Slice<T_encoder>(...[for (i in 0...((_n1 : GoInt)).toBasic()) ((null : T_encoder))]);
					{
						...
						Go.cfor(_i < _n1, _i++, {
							{
								var __tmp__ = _makeField(_v.field(_i + _startingField).__copy__(),
									_parseFieldParameters(_t.field(_i + _startingField).tag.get("asn1")).__copy__());
								_m[_i] = __tmp__._0;
								_err = __tmp__._1;
							};
							if (_err != null) {
...
function _makeField(_v:stdgo.reflect.Reflect.Value, _params:T_fieldParameters):{var _0:T_encoder; var _1:Error;} {
	...
	if (_v.type().toString() == _rawValueType.toString()) {
		...
		_t.value._tag = new T_bytesEncoder(_appendTagAndLength(_t.value._scratch.__slice__(0, ((0 : GoInt))),
			new T_tagAndLength(_rv.class_, _rv.tag, _rv.bytes.length, _rv.isCompound).__copy__())).__copy__();
		_t.value._body = new T_bytesEncoder(_rv.bytes).__copy__();
		return {_0: _t.value, _1: ((null : stdgo.Error))};
	};
	var __tmp__ = _getUniversalType(_v.type()),
		_matchAny:Bool = __tmp__._0,
		_tag:GoInt = __tmp__._1,
		_isCompound:Bool = __tmp__._2,
		_ok:Bool = __tmp__._3;
	if (!_ok || _matchAny) {
	...
	};
	{
		...
		while (true) {
			if (_tag == tagPrintableString) {
				...
				if (_params._timeType == tagGeneralizedTime
					|| _outsideUTCRange(((_v.interface_().value : stdgo.time.Time.Time)).__copy__())) {
	...
	if (_params._tag != null && !_params._tag.isNil()) {
		...
		if (_params._explicit) {
			_t.value._tag = new T_bytesEncoder(_appendTagAndLength(_t.value._scratch.__slice__(0, ((0 : GoInt))),
				new T_tagAndLength(classUniversal, _tag, _bodyLen, _isCompound).__copy__())).__copy__();
			var _tt:Pointer<T_taggedEncoder> = Go.pointer(new T_taggedEncoder());
			_tt.value._body = _t.value;
			_tt.value._tag = new T_bytesEncoder(_appendTagAndLength(_tt.value._scratch.__slice__(0, ((0 : GoInt))), (({
				_class: _class,
				_tag: _params._tag.value,
				_length: _bodyLen + _t.value._tag.len(),
				_isCompound: true
			} : T_tagAndLength)).__copy__())).__copy__();
			return {_0: _tt.value, _1: ((null : stdgo.Error))};
		};
		_tag = _params._tag.value;
	};
	_t.value._tag = new T_bytesEncoder(_appendTagAndLength(_t.value._scratch.__slice__(0, ((0 : GoInt))),
		new T_tagAndLength(_class, _tag, _bodyLen, _isCompound).__copy__())).__copy__();
	return {_0: _t.value, _1: ((null : stdgo.Error))};
}
...
function marshalWithParams(_val:AnyInterface, _params:GoString):{var _0:Slice<GoByte>; var _1:Error;} {
	var __tmp__ = _makeField(stdgo.reflect.Reflect.valueOf(Go.toInterface(_val)).__copy__(), _parseFieldParameters(_params).__copy__()),
		_e:T_encoder = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
		return {_0: new Slice<GoUInt8>().nil(), _1: _err};
	};
...
class BitString_extension_fields {
	public function at(__tmp__, _i:GoInt):GoInt
		return __tmp__.at(_i);

	public function rightAlign(__tmp__):Slice<GoByte>
		return __tmp__.rightAlign();
}

class ObjectIdentifier_extension_fields {
	public function equal(__tmp__, _other:ObjectIdentifier):Bool
...
class T_byteEncoder_extension_fields {
	...
	public function encode(__tmp__, _dst:Slice<GoByte>):Void
		__tmp__.encode(_dst);
}
