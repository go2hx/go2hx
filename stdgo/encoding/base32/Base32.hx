...
@:structInit class Encoding {
    ...
    public function decodeString(_s:GoString):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        ...
        var __tmp__ = _enc.value._decode(_buf, _buf.__slice__(0, _l)), _n:GoInt = __tmp__._0, _:Bool = __tmp__._1, _err:stdgo.Error = __tmp__._2;
    ...
    public function _decode(_dst:Slice<GoByte>, _src:Slice<GoByte>):{ var _0 : GoInt; var _1 : Bool; var _2 : Error; } {
        var _enc = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _n:GoInt = ((0 : GoInt)), _end:Bool = false, _err:Error = ((null : stdgo.Error));
    ...
    public function new(?_encode:GoArray<GoUInt8>, ?_decodeMap:GoArray<GoUInt8>, ?_padChar:GoInt32) stdgo.internal.Macro.initLocals();
...
@:structInit class T_decoder {
    ...
    public function new(?_err:stdgo.Error, ?_enc:Pointer<Encoding>, ?_r:stdgo.io.Io.Reader, ?_end:Bool, ?_buf:GoArray<GoUInt8>, ?_nbuf:GoInt, ?_out:Slice<GoUInt8>, ?_outbuf:GoArray<GoUInt8>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_err) + " " + Go.string(_enc) + " " + Go.string(_r) + " " + Go.string(_end) + " " + Go.string(_buf) + " " + Go.string(_nbuf) + " " + Go.string(_out) + " " + Go.string(_outbuf) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
function newEncoder(_enc:Pointer<Encoding>, _w:stdgo.io.Io.Writer):stdgo.io.Io.WriteCloser {
        return Go.pointer((({ _enc : _enc, _w : _w, _err : ((null : stdgo.Error)), _buf : new GoArray<GoUInt8>(...[for (i in 0 ... 5) ((0 : GoUInt8))]), _nbuf : 0, _out : new GoArray<GoUInt8>(...[for (i in 0 ... 1024) ((0 : GoUInt8))]) } : T_encoder))).value;
    }
function _readEncodedData(_r:stdgo.io.Io.Reader, _buf:Slice<GoByte>, _min:GoInt, _expectsPadding:Bool):{ var _0 : GoInt; var _1 : Error; } {
        ...
        if (_expectsPadding && _min < ((8 : GoInt)) && _n == ((0 : GoInt)) && Go.toInterface(_err) == Go.toInterface(stdgo.io.Io.eof)) {
            _err = stdgo.io.Io.errUnexpectedEOF;
        };
        return { _0 : _n, _1 : _err };
    }
...
function newDecoder(_enc:Pointer<Encoding>, _r:stdgo.io.Io.Reader):stdgo.io.Io.Reader {
        return Go.pointer((({ _enc : _enc, _r : Go.pointer(new T_newlineFilteringReader(_r)).value, _err : ((null : stdgo.Error)), _end : false, _buf : new GoArray<GoUInt8>(...[for (i in 0 ... 1024) ((0 : GoUInt8))]), _nbuf : 0, _out : new Slice<GoUInt8>().nil(), _outbuf : new GoArray<GoUInt8>(...[for (i in 0 ... 640) ((0 : GoUInt8))]) } : T_decoder))).value;
    }
class Encoding_extension_fields {
    ...
    public function _decode(__tmp__, _dst:Slice<GoByte>, _src:Slice<GoByte>):{ var _0 : GoInt; var _1 : Bool; var _2 : Error; } return __tmp__._decode(_dst, _src);
