...
@:structInit class Encoding {
	...
	public function decode(_dst:Slice<GoByte>, _src:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
		...
		while (stdgo.strconv.Strconv.intSize >= ((64 : GoUnTypedInt))
			&& _src.length - _si >= ((8 : GoInt))
			&& _dst.length - _n >= ((8 : GoInt))) {
			var _src2:Slice<GoUInt8> = _src.__slice__(_si, _si + ((8 : GoInt)));
			{
				var __tmp__ = _assemble64(_enc.value._decodeMap[_src2[((0 : GoInt))]], _enc.value._decodeMap[_src2[((1 : GoInt))]],
					_enc.value._decodeMap[_src2[((2 : GoInt))]], _enc.value._decodeMap[_src2[((3 : GoInt))]], _enc.value._decodeMap[_src2[((4 : GoInt))]],
					_enc.value._decodeMap[_src2[((5 : GoInt))]], _enc.value._decodeMap[_src2[((6 : GoInt))]], _enc.value._decodeMap[_src2[((7 : GoInt))]]),
		...
		while (_src.length - _si >= ((4 : GoInt)) && _dst.length - _n >= ((4 : GoInt))) {
			...
			{
				var __tmp__ = _assemble32(_enc.value._decodeMap[_src2[((0 : GoInt))]], _enc.value._decodeMap[_src2[((1 : GoInt))]],
					_enc.value._decodeMap[_src2[((2 : GoInt))]], _enc.value._decodeMap[_src2[((3 : GoInt))]]),
	...
	public function decodeString(_s:GoString):{var _0:Slice<GoByte>; var _1:Error;} {
		var _enc = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _dbuf:Slice<GoUInt8> = new Slice<GoUInt8>(...[
			for (i in 0...((_enc.value.decodedLen(_s.length) : GoInt)).toBasic()) ((0 : GoUInt8))
		]);
		var __tmp__ = _enc.value.decode(_dbuf, ((_s : Slice<GoByte>))),
			_n:GoInt = __tmp__._0,
	...
	public function encode(_dst:Slice<GoByte>, _src:Slice<GoByte>):Void {
		...
		while (_si < _n) {
			var _val:GoUInt = (((_src[_si + ((0 : GoInt))] : GoUInt)) << ((16 : GoUnTypedInt))) | (((_src[_si + ((1 : GoInt))] : GoUInt)) << ((8 : GoUnTypedInt))) | ((_src[_si
				+ ((2 : GoInt))] : GoUInt));
...
@:structInit class T_decoder {
	...
	public function new(?_err:stdgo.Error, ?_readErr:stdgo.Error, ?_enc:Pointer<Encoding>, ?_r:stdgo.io.Io.Reader, ?_buf:GoArray<GoUInt8>, ?_nbuf:GoInt,
			?_out:Slice<GoUInt8>, ?_outbuf:GoArray<GoUInt8>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_err) + " " + Go.string(_readErr) + " " + Go.string(_enc) + " " + Go.string(_r) + " " + Go.string(_buf) + " "
			+ Go.string(_nbuf) + " " + Go.string(_out) + " " + Go.string(_outbuf) + "}";
	}
...
function newEncoder(_enc:Pointer<Encoding>, _w:stdgo.io.Io.Writer):stdgo.io.Io.WriteCloser {
	return Go.pointer((({
		...
		_buf: new GoArray<GoUInt8>(...[for (i in 0...3) ((0 : GoUInt8))]),
		_nbuf: 0,
...
function _assemble32(_n1:GoByte, _n2:GoByte, _n3:GoByte, _n4:GoByte):{var _0:GoUInt32; var _1:Bool;} {
	...
	return
		{_0: (((_n1 : GoUInt32)) << ((26 : GoUnTypedInt))) | (((_n2 : GoUInt32)) << ((20 : GoUnTypedInt))) | (((_n3 : GoUInt32)) << ((14 : GoUnTypedInt))) | (((_n4 : GoUInt32)) << ((8 : GoUnTypedInt))),
			_1: true};
}
...
function _assemble64(_n1:GoByte, _n2:GoByte, _n3:GoByte, _n4:GoByte, _n5:GoByte, _n6:GoByte, _n7:GoByte, _n8:GoByte):{var _0:GoUInt64; var _1:Bool;} {
	...
	return
		{_0: (((_n1 : GoUInt64)) << ((58 : GoUnTypedInt))) | (((_n2 : GoUInt64)) << ((52 : GoUnTypedInt))) | (((_n3 : GoUInt64)) << ((46 : GoUnTypedInt))) | (((_n4 : GoUInt64)) << ((40 : GoUnTypedInt))) | (((_n5 : GoUInt64)) << ((34 : GoUnTypedInt))) | (((_n6 : GoUInt64)) << ((28 : GoUnTypedInt))) | (((_n7 : GoUInt64)) << ((22 : GoUnTypedInt))) | (((_n8 : GoUInt64)) << ((16 : GoUnTypedInt))),
			_1: true};
}
...
function newDecoder(_enc:Pointer<Encoding>, _r:stdgo.io.Io.Reader):stdgo.io.Io.Reader {
	return Go.pointer((({
		...
		_outbuf: new GoArray<GoUInt8>(...[for (i in 0...768) ((0 : GoUInt8))])
	} : T_decoder))).value;
}
...
class Encoding_extension_fields {
	...
	public function strict(__tmp__):Pointer<Encoding>
		return __tmp__.strict();
	...
	public function _decodeQuantum(__tmp__, _dst:Slice<GoByte>, _src:Slice<GoByte>, _si:GoInt):{var _0:GoInt; var _1:GoInt; var _2:Error;}
		return __tmp__._decodeQuantum(_dst, _src, _si);
