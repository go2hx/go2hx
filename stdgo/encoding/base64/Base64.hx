...
**/
var stdEncoding : stdgo.Ref<stdgo.encoding.base64.Base64.Encoding> = newEncoding(("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/" : stdgo.GoString));
/**
...
**/
var urlencoding : stdgo.Ref<stdgo.encoding.base64.Base64.Encoding> = newEncoding(("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_" : stdgo.GoString));
/**
...
**/
var rawStdEncoding : stdgo.Ref<stdgo.encoding.base64.Base64.Encoding> = stdEncoding.withPadding((-1 : stdgo.GoInt32));
/**
...
**/
var rawURLEncoding : stdgo.Ref<stdgo.encoding.base64.Base64.Encoding> = urlencoding.withPadding((-1 : stdgo.GoInt32));
/**
...
**/
var _funnyEncoding : stdgo.Ref<stdgo.encoding.base64.Base64.Encoding> = newEncoding(("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/" : stdgo.GoString)).withPadding(((64 : stdgo.GoInt32) : stdgo.GoRune));
/**
...
@:structInit @:private @:using(stdgo.encoding.base64.Base64.T_encoder_static_extension) class T_encoder {
    ...
    public var _enc : stdgo.Ref<stdgo.encoding.base64.Base64.Encoding> = (null : stdgo.Ref<stdgo.encoding.base64.Base64.Encoding>);
    ...
    public function new(?_err:stdgo.Error, ?_enc:stdgo.Ref<stdgo.encoding.base64.Base64.Encoding>, ?_w:stdgo.io.Io.Writer, ?_buf:stdgo.GoArray<stdgo.GoUInt8>, ?_nbuf:stdgo.GoInt, ?_out:stdgo.GoArray<stdgo.GoUInt8>) {
...
@:structInit @:private @:using(stdgo.encoding.base64.Base64.T_decoder_static_extension) class T_decoder {
    ...
    public function new(?_err:stdgo.Error, ?_readErr:stdgo.Error, ?_enc:stdgo.Ref<stdgo.encoding.base64.Base64.Encoding>, ?_r:stdgo.io.Io.Reader, ?_buf:stdgo.GoArray<stdgo.GoUInt8>, ?_nbuf:stdgo.GoInt, ?_out:stdgo.Slice<stdgo.GoUInt8>, ?_outbuf:stdgo.GoArray<stdgo.GoUInt8>) {
        if (_err != null) this._err = _err;
...
@:structInit @:private class T_encodingTest {
    ...
    public function new(?_enc:stdgo.Ref<stdgo.encoding.base64.Base64.Encoding>, ?_conv:stdgo.GoString -> stdgo.GoString) {
        if (_enc != null) this._enc = _enc;
...
@:local @:using(stdgo.encoding.base64.Base64.T__struct_1_static_extension) typedef T__struct_1 = {
    public var _enc : stdgo.Ref<stdgo.encoding.base64.Base64.Encoding>;
    public var _n : stdgo.GoInt;
    public var _want : stdgo.GoInt;
};
@:named @:using(stdgo.encoding.base64.Base64.CorruptInputError_static_extension) typedef CorruptInputError = stdgo.GoInt64;
/**
...
function newEncoding(_encoder:stdgo.GoString):stdgo.Ref<Encoding> {
        ...
        var _e = (stdgo.Go.setRef(({} : stdgo.encoding.base64.Base64.Encoding)) : stdgo.Ref<stdgo.encoding.base64.Base64.Encoding>);
...
**/
function newEncoder(_enc:stdgo.Ref<Encoding>, _w:stdgo.io.Io.Writer):stdgo.io.Io.WriteCloser {
        return stdgo.Go.asInterface((stdgo.Go.setRef(({ _enc : _enc, _w : _w } : stdgo.encoding.base64.Base64.T_encoder)) : stdgo.Ref<stdgo.encoding.base64.Base64.T_encoder>));
    }
/**
...
function _testEqual(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _msg:stdgo.GoString, _args:haxe.Rest<stdgo.AnyInterface>):Bool {
        var _args = new stdgo.Slice<stdgo.AnyInterface>(_args.length, 0, ..._args);
        _t.helper();
        var _a:stdgo.AnyInterface = _args[((_args.length) - (2 : stdgo.GoInt) : stdgo.GoInt)];
        var _b:stdgo.AnyInterface = _args[((_args.length) - (1 : stdgo.GoInt) : stdgo.GoInt)];
        if (_a != (_b)) {
...
function testEncoder(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        for (__0 => _p in _pairs) {
            var _bb = (stdgo.Go.setRef((new stdgo.strings.Strings.Builder() : stdgo.strings.Strings.Builder)) : stdgo.Ref<stdgo.strings.Strings.Builder>);
...
function testEncoderBuffering(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testDecoderBuffering(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {
            var _bs:stdgo.GoInt = (1 : stdgo.GoInt);
            stdgo.Go.cfor(_bs <= (12 : stdgo.GoInt), _bs++, {
...
function testDecodeCorrupt(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        for (__0 => _tc in _testCases) {
            ...
            };
            {
                ...
                if (stdgo.Go.typeEquals((__type__ : CorruptInputError))) {
                    var _err:stdgo.encoding.base64.Base64.CorruptInputError = __type__ == null ? ((0 : stdgo.GoInt64) : stdgo.encoding.base64.Base64.CorruptInputError) : __type__.__underlying__() == null ? ((0 : stdgo.GoInt64) : stdgo.encoding.base64.Base64.CorruptInputError) : __type__ == null ? ((0 : stdgo.GoInt64) : stdgo.encoding.base64.Base64.CorruptInputError) : __type__.__underlying__().value;
...
function testDecodeBounds(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testEncodedLen(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testDecodedLen(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testBig(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        var _encoded = (stdgo.Go.setRef(({} : stdgo.bytes.Bytes.Buffer)) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>);
        ...
        var __tmp__ = stdgo.io.Io.readAll(newDecoder(stdEncoding, stdgo.Go.asInterface(_encoded))), _decoded:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
...
function testNewLineCharacters(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
...
**/
function testDecoderIssue3577(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _next = new stdgo.Chan<stdgo.encoding.base64.Base64.T_nextRead>((10 : stdgo.GoInt).toBasic(), () -> ({} : stdgo.encoding.base64.Base64.T_nextRead));
        var _wantErr:stdgo.Error = stdgo.errors.Errors.new_(("my error" : stdgo.GoString));
        _next.__send__((new stdgo.encoding.base64.Base64.T_nextRead((5 : stdgo.GoInt), (null : stdgo.Error)) : stdgo.encoding.base64.Base64.T_nextRead));
        _next.__send__((new stdgo.encoding.base64.Base64.T_nextRead((10 : stdgo.GoInt), _wantErr) : stdgo.encoding.base64.Base64.T_nextRead));
        _next.__send__((new stdgo.encoding.base64.Base64.T_nextRead((0 : stdgo.GoInt), _wantErr) : stdgo.encoding.base64.Base64.T_nextRead));
        var _d:stdgo.io.Io.Reader = newDecoder(stdEncoding, stdgo.Go.asInterface((stdgo.Go.setRef(({ _source : ("VHdhcyBicmlsbGlnLCBhbmQgdGhlIHNsaXRoeSB0b3Zlcw==" : stdgo.GoString), _nextc : _next } : stdgo.encoding.base64.Base64.T_faultInjectReader)) : stdgo.Ref<stdgo.encoding.base64.Base64.T_faultInjectReader>)));
        var _errc = new stdgo.Chan<stdgo.Error>((1 : stdgo.GoInt).toBasic(), () -> (null : stdgo.Error));
        stdgo.Go.routine(() -> {
            var a = function():Void {
                var __tmp__ = stdgo.io.Io.readAll(_d), __0:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                _errc.__send__(_err);
            };
            a();
        });
...
function testDecoderIssue4779(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        var __tmp__ = stdgo.io.Io.readAll(_dec), _res1:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
...
function testDecoderIssue7733(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testDecoderIssue15656(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function benchmarkEncodeToString(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
...
function benchmarkDecodeString(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        ...
        var _benchFunc = function(_b:stdgo.Ref<stdgo.testing.Testing.B>, _benchSize:stdgo.GoInt):Void {
...
function benchmarkNewEncoding(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.setBytes(((new stdgo.encoding.base64.Base64.Encoding() : stdgo.encoding.base64.Base64.Encoding)._decodeMap.length : stdgo.GoInt64));
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
...
function testDecoderRaw(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        var _r:stdgo.io.Io.Reader = newDecoder(rawURLEncoding, stdgo.Go.asInterface(stdgo.bytes.Bytes.newReader((_source : stdgo.Slice<stdgo.GoByte>))));
        var __tmp__ = stdgo.io.Io.readAll(stdgo.io.Io.limitReader(_r, (100i64 : stdgo.GoInt64))), _dec2:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        ...
        _r = newDecoder(urlencoding, stdgo.Go.asInterface(stdgo.bytes.Bytes.newReader((_source + ("==" : stdgo.GoString)?.__copy__() : stdgo.Slice<stdgo.GoByte>))));
        var __tmp__ = stdgo.io.Io.readAll(_r), _dec3:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
...
@:keep @:allow(stdgo.encoding.base64.Base64.Encoding_asInterface) class Encoding_static_extension {
    ...
    static public function decode( _enc:stdgo.Ref<Encoding>, _dst:stdgo.Slice<stdgo.GoByte>, _src:stdgo.Slice<stdgo.GoByte>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        ...
        while ((false && ((_src.length - _si) >= (8 : stdgo.GoInt))) && ((_dst.length - _n) >= (8 : stdgo.GoInt))) {
            var _src2 = (_src.__slice__(_si, _si + (8 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>);
            {
                ...
                if (_ok) {
                    stdgo.encoding.binary.Binary.bigEndian.putUint64((_dst.__slice__(_n) : stdgo.Slice<stdgo.GoUInt8>), _dn);
                    _n = _n + ((6 : stdgo.GoInt));
        ...
        while (((_src.length - _si) >= (4 : stdgo.GoInt)) && ((_dst.length - _n) >= (4 : stdgo.GoInt))) {
            var _src2 = (_src.__slice__(_si, _si + (4 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>);
            {
                ...
                if (_ok) {
                    stdgo.encoding.binary.Binary.bigEndian.putUint32((_dst.__slice__(_n) : stdgo.Slice<stdgo.GoUInt8>), _dn);
                    _n = _n + ((3 : stdgo.GoInt));
    ...
    **/
    ...
    static public function strict( _enc:Encoding):stdgo.Ref<Encoding> {
        ...
        _enc._strict = true;
        return (stdgo.Go.setRef(_enc) : stdgo.Ref<stdgo.encoding.base64.Base64.Encoding>);
    }
    /**
        // WithPadding creates a new encoding identical to enc except
        // with a specified padding character, or NoPadding to disable padding.
...
@:keep @:allow(stdgo.encoding.base64.Base64.T_decoder_asInterface) class T_decoder_static_extension {
    ...
    static public function read( _d:stdgo.Ref<T_decoder>, _p:stdgo.Slice<stdgo.GoByte>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        ...
        if (_d._nbuf < (4 : stdgo.GoInt)) {
            ...
            _d._err = _d._readErr;
            if ((stdgo.Go.toInterface(_d._err) == stdgo.Go.toInterface(stdgo.io.Io.eof)) && (_d._nbuf > (0 : stdgo.GoInt))) {
...
@:keep @:allow(stdgo.encoding.base64.Base64.CorruptInputError_asInterface) class CorruptInputError_static_extension {
    ...
    static public function error( _e:CorruptInputError):stdgo.GoString {
        ...
        return ("illegal base64 data at input byte " : stdgo.GoString) + stdgo.strconv.Strconv.formatInt((_e : stdgo.GoInt64), (10 : stdgo.GoInt))?.__copy__()?.__copy__();
    }
}
