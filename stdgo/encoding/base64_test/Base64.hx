...
private var _tests:Slice<stdgo.testing.Testing.InternalTest> = (new Slice<stdgo.testing.Testing.InternalTest>(0, 0,
	...
	(new stdgo.testing.Testing.InternalTest(("TestEncoderBuffering" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestDecoderBuffering" : GoString),
		stdgo.encoding.base64.Base64.testDecoderBuffering) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestDecodeCorrupt" : GoString),
		stdgo.encoding.base64.Base64.testDecodeCorrupt) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestDecodeBounds" : GoString),
		stdgo.encoding.base64.Base64.testDecodeBounds) : stdgo.testing.Testing.InternalTest),
...
private var _benchmarks:Slice<stdgo.testing.Testing.InternalBenchmark> = (new Slice<stdgo.testing.Testing.InternalBenchmark>(0, 0,
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkEncodeToString" : GoString),
		stdgo.encoding.base64.Base64.benchmarkEncodeToString) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkDecodeString" : GoString),
...
private var _examples:Slice<stdgo.testing.Testing.InternalExample> = (new Slice<stdgo.testing.Testing.InternalExample>(0, 0,
	(new stdgo.testing.Testing.InternalExample(("Example" : GoString), stdgo.encoding.base64_test.Base64_test.example,
		("SGVsbG8sIOS4lueVjA==\nHello, 世界\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleEncoding_EncodeToString" : GoString),
		stdgo.encoding.base64_test.Base64_test.exampleEncoding_EncodeToString, ("YW55ICsgb2xkICYgZGF0YQ==\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleEncoding_Encode" : GoString), stdgo.encoding.base64_test.Base64_test.exampleEncoding_Encode,
		("SGVsbG8sIHdvcmxkIQ==\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleEncoding_DecodeString" : GoString),
		stdgo.encoding.base64_test.Base64_test.exampleEncoding_DecodeString, ("\"some data with \\x00 and \\ufeff\"\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleEncoding_Decode" : GoString), stdgo.encoding.base64_test.Base64_test.exampleEncoding_Decode,
		("\"Hello, world!\"\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleNewEncoder" : GoString), stdgo.encoding.base64_test.Base64_test.exampleNewEncoder,
