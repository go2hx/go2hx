...
function example():Void {
        ...
        var _encoded:stdgo.GoString = stdgo.encoding.base64.Base64.stdEncoding.encodeToString((_msg : stdgo.Slice<stdgo.StdGoTypes.GoByte>));
        stdgo.fmt.Fmt.println(stdgo.Go.toInterface(_encoded));
        var __tmp__ = stdgo.encoding.base64.Base64.stdEncoding.decodeString(_encoded), _decoded:stdgo.Slice<stdgo.StdGoTypes.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
...
function exampleEncoding_EncodeToString():Void {
        ...
        var _str:stdgo.GoString = stdgo.encoding.base64.Base64.stdEncoding.encodeToString(_data);
...
function exampleEncoding_DecodeString():Void {
        ...
        var __tmp__ = stdgo.encoding.base64.Base64.stdEncoding.decodeString(_str), _data:stdgo.Slice<stdgo.StdGoTypes.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
