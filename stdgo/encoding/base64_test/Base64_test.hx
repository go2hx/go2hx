...
function example():Void {
        ...
        var _encoded:stdgo.GoString = stdgo.encoding.base64.Base64.stdEncoding.encodeToString((_msg : stdgo.Slice<stdgo.GoByte>))?.__copy__();
        stdgo.fmt.Fmt.println(stdgo.Go.toInterface(_encoded));
        var __tmp__ = stdgo.encoding.base64.Base64.stdEncoding.decodeString(_encoded?.__copy__()), _decoded:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
...
function exampleEncoding_Encode():Void {
        ...
        var _dst = new stdgo.Slice<stdgo.GoUInt8>((stdgo.encoding.base64.Base64.stdEncoding.encodedLen((_data.length)) : stdgo.GoInt).toBasic(), 0).__setNumber32__();
...
function exampleEncoding_DecodeString():Void {
        ...
        var __tmp__ = stdgo.encoding.base64.Base64.stdEncoding.decodeString(_str?.__copy__()), _data:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
...
function exampleEncoding_Decode():Void {
        ...
        var _dst = new stdgo.Slice<stdgo.GoUInt8>((stdgo.encoding.base64.Base64.stdEncoding.decodedLen((_str.length)) : stdgo.GoInt).toBasic(), 0).__setNumber32__();
        var __tmp__ = stdgo.encoding.base64.Base64.stdEncoding.decode(_dst, (_str : stdgo.Slice<stdgo.GoByte>)), _n:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            stdgo.fmt.Fmt.println(stdgo.Go.toInterface(("decode error:" : stdgo.GoString)), stdgo.Go.toInterface(_err));
            return;
        };
