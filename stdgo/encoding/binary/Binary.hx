...
@:structInit class T_coder {
    ...
    public function new(?_order:ByteOrder, ?_buf:Slice<GoUInt8>, ?_offset:GoInt) stdgo.internal.Macro.initLocals();
...
@:named @:structInit class T_decoder extends T_coder {
    ...
    public function _value(_v:stdgo.reflect.Reflect.Value):Void {
        ...
        if (_v.kind().__t__ == stdgo.reflect.Reflect.array.__t__) {
            ...
            _v.setComplex(new GoComplex128(((stdgo.math.Math.float32frombits(_d.value._uint32()) : GoFloat64)), ((stdgo.math.Math.float32frombits(_d.value._uint32()) : GoFloat64))));
    ...
    public function new(?_order, ?_buf, ?_offset) super(_order, _buf, _offset);
    public override function __copy__() return new T_decoder(_order, _buf, _offset);
}
@:named @:structInit class T_encoder extends T_coder {
    ...
    public function _value(_v:stdgo.reflect.Reflect.Value):Void {
        ...
        } else if (_v.kind().__t__ == stdgo.reflect.Reflect.uint.__t__ || _v.kind().__t__ == stdgo.reflect.Reflect.uint8.__t__ || _v.kind().__t__ == stdgo.reflect.Reflect.uint16.__t__ || _v.kind().__t__ == stdgo.reflect.Reflect.uint32.__t__ || _v.kind().__t__ == stdgo.reflect.Reflect.uint64.__t__ || _v.kind().__t__ == stdgo.reflect.Reflect.uintptr.__t__) {
    ...
    public function new(?_order, ?_buf, ?_offset) super(_order, _buf, _offset);
    public override function __copy__() return new T_encoder(_order, _buf, _offset);
}
...
function read(_r:stdgo.io.Io.Reader, _order:ByteOrder, _data:AnyInterface):Error {
        {
            ...
            if (_n != ((0 : GoInt))) {
                ...
                {
                    var __tmp__ = stdgo.io.Io.readFull(_r, _bs), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                    if (_err != null) {
                        return _err;
                    };
                };
        ...
        var _d:Pointer<T_decoder> = Go.pointer((({ _order : _order, _buf : new Slice<GoUInt8>(...[for (i in 0 ... ((_size : GoInt)).toBasic()) ((0 : GoUInt8))]), _offset : 0 } : T_decoder)));
        {
            var __tmp__ = stdgo.io.Io.readFull(_r, _d.value._buf), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return _err;
            };
        };
...
function write(_w:stdgo.io.Io.Writer, _order:ByteOrder, _data:AnyInterface):Error {
        {
            ...
            if (_n != ((0 : GoInt))) {
                ...
                var __tmp__ = _w.write(_bs), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                return _err;
            };
        };
        ...
        _e.value._value(_v.__copy__());
        var __tmp__ = _w.write(_buf), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        return _err;
    }
/**
...
function _sizeof(_t:stdgo.reflect.Reflect.Type):GoInt {
        if (_t.kind().__t__ == stdgo.reflect.Reflect.array.__t__) {
            ...
            return _sum;
        } else if (_t.kind().__t__ == stdgo.reflect.Reflect.bool.__t__ || _t.kind().__t__ == stdgo.reflect.Reflect.uint8.__t__ || _t.kind().__t__ == stdgo.reflect.Reflect.uint16.__t__ || _t.kind().__t__ == stdgo.reflect.Reflect.uint32.__t__ || _t.kind().__t__ == stdgo.reflect.Reflect.uint64.__t__ || _t.kind().__t__ == stdgo.reflect.Reflect.int8.__t__ || _t.kind().__t__ == stdgo.reflect.Reflect.int16.__t__ || _t.kind().__t__ == stdgo.reflect.Reflect.int32.__t__ || _t.kind().__t__ == stdgo.reflect.Reflect.int64.__t__ || _t.kind().__t__ == stdgo.reflect.Reflect.float32.__t__ || _t.kind().__t__ == stdgo.reflect.Reflect.float64.__t__ || _t.kind().__t__ == stdgo.reflect.Reflect.complex64.__t__ || _t.kind().__t__ == stdgo.reflect.Reflect.complex128.__t__) {
...
class T_littleEndian_extension_fields {
    public function uint16(__tmp__, _b:Slice<GoByte>):GoUInt16 return __tmp__.uint16(_b);
    public function putUint16(__tmp__, _b:Slice<GoByte>, _v:GoUInt16):Void __tmp__.putUint16(_b, _v);
    public function uint32(__tmp__, _b:Slice<GoByte>):GoUInt32 return __tmp__.uint32(_b);
    public function putUint32(__tmp__, _b:Slice<GoByte>, _v:GoUInt32):Void __tmp__.putUint32(_b, _v);
    public function uint64(__tmp__, _b:Slice<GoByte>):GoUInt64 return __tmp__.uint64(_b);
    public function putUint64(__tmp__, _b:Slice<GoByte>, _v:GoUInt64):Void __tmp__.putUint64(_b, _v);
...
class T_decoder_extension_fields {
    public function _bool(__tmp__):Bool return __tmp__._bool();
    ...
    public function _int8(__tmp__):GoInt8 return __tmp__._int8();
    public function _int16(__tmp__):GoInt16 return __tmp__._int16();
    public function _int32(__tmp__):GoInt32 return __tmp__._int32();
    public function _int64(__tmp__):GoInt64 return __tmp__._int64();
    public function _value(__tmp__, _v:stdgo.reflect.Reflect.Value):Void __tmp__._value(_v);
    public function _skip(__tmp__, _v:stdgo.reflect.Reflect.Value):Void __tmp__._skip(_v);
}
class T_encoder_extension_fields {
    public function _bool(__tmp__, _x:Bool):Void __tmp__._bool(_x);
    public function _uint8(__tmp__, _x:GoUInt8):Void __tmp__._uint8(_x);
    public function _uint16(__tmp__, _x:GoUInt16):Void __tmp__._uint16(_x);
    public function _uint32(__tmp__, _x:GoUInt32):Void __tmp__._uint32(_x);
    public function _uint64(__tmp__, _x:GoUInt64):Void __tmp__._uint64(_x);
    public function _int8(__tmp__, _x:GoInt8):Void __tmp__._int8(_x);
    public function _int16(__tmp__, _x:GoInt16):Void __tmp__._int16(_x);
    public function _int32(__tmp__, _x:GoInt32):Void __tmp__._int32(_x);
    public function _int64(__tmp__, _x:GoInt64):Void __tmp__._int64(_x);
    public function _value(__tmp__, _v:stdgo.reflect.Reflect.Value):Void __tmp__._value(_v);
    public function _skip(__tmp__, _v:stdgo.reflect.Reflect.Value):Void __tmp__._skip(_v);
}
