...
@:invalid typedef ByteOrder_static_extension = Dynamic;
typedef ByteOrder = stdgo._internal.encoding.binary.Binary.ByteOrder;
@:invalid typedef AppendByteOrder_static_extension = Dynamic;
...
@:invalid typedef T_testSizeStructCache_14___localname___foo = Dynamic;
@:invalid typedef T_testSizeStructCache_15___localname___bar = Dynamic;
...
@:invalid typedef T_testByteOrder_16___localname___byteOrder_static_extension = Dynamic;
typedef T_testByteOrder_16___localname___byteOrder = stdgo._internal.encoding.binary.Binary.T_testByteOrder_16___localname___byteOrder;
...
@:invalid typedef T_testNoFixedSize_17___localname___Person = Dynamic;
