...
function read(_r:stdgo.io.Io.Reader, _order:ByteOrder, _data:stdgo.StdGoTypes.AnyInterface):stdgo.Error {
        ...
        if (_size < (0 : stdgo.StdGoTypes.GoInt)) {
            return stdgo.errors.Errors.new_(("binary.Read: invalid type " : stdgo.GoString) + (stdgo.reflect.Reflect.typeOf(_data).string() : stdgo.GoString));
        };
...
function write(_w:stdgo.io.Io.Writer, _order:ByteOrder, _data:stdgo.StdGoTypes.AnyInterface):stdgo.Error {
        ...
        if (_size < (0 : stdgo.StdGoTypes.GoInt)) {
            return stdgo.errors.Errors.new_(("binary.Write: some values are not fixed-sized in type " : stdgo.GoString) + (stdgo.reflect.Reflect.typeOf(_data).string() : stdgo.GoString));
        };
...
function testWriteT(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _tv:stdgo.reflect.Reflect.Value = stdgo.reflect.Reflect.indirect(stdgo.reflect.Reflect.valueOf(stdgo.Go.toInterface(_ts))?.__copy__())?.__copy__();
        {
            ...
            stdgo.Go.cfor(_i < _n, _i++, {
                var _typ:stdgo.GoString = (_tv.field(_i).type().string() : stdgo.GoString);
...
function testReadErrorMsg(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _read:stdgo.StdGoTypes.AnyInterface -> Void = function(_data:stdgo.StdGoTypes.AnyInterface):Void {
            ...
            var _want:stdgo.GoString = ("binary.Read: invalid type " : stdgo.GoString) + (stdgo.reflect.Reflect.typeOf(_data).string() : stdgo.GoString);
            if (_err == null) {
...
function testReadTruncated(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _b2:T__struct_5 = ({ a : (0 : stdgo.StdGoTypes.GoUInt8), b : (0 : stdgo.StdGoTypes.GoUInt8), c : (0 : stdgo.StdGoTypes.GoUInt8), d : (0 : stdgo.StdGoTypes.GoUInt8), e : (0 : stdgo.StdGoTypes.GoInt32), f : (0 : stdgo.StdGoTypes.GoFloat64) } : T__struct_5);
        {
            ...
            stdgo.Go.cfor(_i <= (("0123456789abcdef" : stdgo.GoString).length), _i++, {
                ...
                {
                    var _err:stdgo.Error = read(stdgo.Go.asInterface(stdgo.strings.Strings.newReader((("0123456789abcdef" : stdgo.GoString).__slice__(0, _i) : stdgo.GoString))), stdgo.Go.asInterface(littleEndian), stdgo.Go.toInterface((stdgo.Go.setRef(_b1) : stdgo.StdGoTypes.Ref<stdgo.Slice<stdgo.StdGoTypes.GoInt32>>)));
                ...
                {
                    var _err:stdgo.Error = read(stdgo.Go.asInterface(stdgo.strings.Strings.newReader((("0123456789abcdef" : stdgo.GoString).__slice__(0, _i) : stdgo.GoString))), stdgo.Go.asInterface(littleEndian), stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_b2) : stdgo.StdGoTypes.Ref<T__struct_5>))));
                    if (stdgo.Go.toInterface(_err) != (stdgo.Go.toInterface(_errWant))) {
...
stdgo.Go.toInterface((false : Bool))) : stdgo.Slice<stdgo.StdGoTypes.AnyInterface>);
        for (__0 => _dst in _destinations) {
            ...
            var _want:stdgo.GoString = stdgo.fmt.Fmt.sprintf(("binary.Read: invalid type %T" : stdgo.GoString), _dst);
...
function _testVarint(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>, _x:stdgo.StdGoTypes.GoInt64):Void {
        ...
        if ((_buf2 : stdgo.GoString) != (("prefix" : stdgo.GoString) + ((_buf.__slice__(0, _n) : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>) : stdgo.GoString))) {
            _t.errorf(("AppendVarint(%d): got %q, want %q" : stdgo.GoString), stdgo.Go.toInterface(_x), stdgo.Go.toInterface(_buf2), stdgo.Go.toInterface(("prefix" : stdgo.GoString) + ((_buf.__slice__(0, _n) : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>) : stdgo.GoString)));
        };
...
function _testUvarint(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>, _x:stdgo.StdGoTypes.GoUInt64):Void {
        ...
        if ((_buf2 : stdgo.GoString) != (("prefix" : stdgo.GoString) + ((_buf.__slice__(0, _n) : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>) : stdgo.GoString))) {
            _t.errorf(("AppendUvarint(%d): got %q, want %q" : stdgo.GoString), stdgo.Go.toInterface(_x), stdgo.Go.toInterface(_buf2), stdgo.Go.toInterface(("prefix" : stdgo.GoString) + ((_buf.__slice__(0, _n) : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>) : stdgo.GoString)));
        };
...
(127 : stdgo.StdGoTypes.GoUInt8)) : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>), _name : ("invalid: 10th byte" : stdgo.GoString), _wantN : (-10 : stdgo.StdGoTypes.GoInt), _wantValue : (0i64 : stdgo.StdGoTypes.GoUInt64) } : T__struct_6)) : stdgo.Slice<T__struct_6>);
        for (__0 => _tt in _tests) {
            ...
            _t.run(_tt._name, function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
