...
@:invalid typedef T_testSizeStructCache_22___localname___foo = Dynamic;
@:invalid typedef T_testSizeStructCache_23___localname___bar = Dynamic;
...
typedef T_testByteOrder_24___localname___byteOrder = stdgo._internal.encoding.binary.Binary.T_testByteOrder_24___localname___byteOrder;
...
@:invalid typedef T_testNoFixedSize_25___localname___Person = Dynamic;
