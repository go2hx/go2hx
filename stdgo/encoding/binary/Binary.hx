...
**/
private var _src = (new Slice<GoUInt8>(0, 0, (1 : GoUInt8), (2 : GoUInt8), (3 : GoUInt8), (4 : GoUInt8), (5 : GoUInt8), (6 : GoUInt8), (7 : GoUInt8), (8 : GoUInt8)) : Slice<GoUInt8>);
/**
    
    
    
**/
private var _res = (new Slice<GoInt32>(0, 0, (16909060 : GoInt32), (84281096 : GoInt32)) : Slice<GoInt32>);
/**
    
    
    
**/
private var _putbuf = (new Slice<GoUInt8>(0, 0, (0 : GoUInt8), (0 : GoUInt8), (0 : GoUInt8), (0 : GoUInt8), (0 : GoUInt8), (0 : GoUInt8), (0 : GoUInt8), (0 : GoUInt8)) : Slice<GoUInt8>);
/**
    // Addresses of arrays are easier to manipulate with reflection than are slices.
    
    
**/
private var _intArrays = (new Slice<AnyInterface>(0, 0, Go.toInterface(((new GoArray<GoInt8>(...([].concat([for (i in 0 ... 100) (0 : GoInt8)]))) : GoArray<GoInt8>) : Ref<GoArray<GoInt8>>)), Go.toInterface(((new GoArray<GoInt16>(...([].concat([for (i in 0 ... 100) (0 : GoInt16)]))) : GoArray<GoInt16>) : Ref<GoArray<GoInt16>>)), Go.toInterface(((new GoArray<GoInt32>(...([].concat([for (i in 0 ... 100) (0 : GoInt32)]))) : GoArray<GoInt32>) : Ref<GoArray<GoInt32>>)), Go.toInterface(((new GoArray<GoInt64>(...([].concat([for (i in 0 ... 100) (0 : GoInt64)]))) : GoArray<GoInt64>) : Ref<GoArray<GoInt64>>)), Go.toInterface(((new GoArray<GoUInt8>(...([].concat([for (i in 0 ... 100) (0 : GoUInt8)]))) : GoArray<GoUInt8>) : Ref<GoArray<GoUInt8>>)), Go.toInterface(((new GoArray<GoUInt16>(...([].concat([for (i in 0 ... 100) (0 : GoUInt16)]))) : GoArray<GoUInt16>) : Ref<GoArray<GoUInt16>>)), Go.toInterface(((new GoArray<GoUInt32>(...([].concat([for (i in 0 ... 100) (0 : GoUInt32)]))) : GoArray<GoUInt32>) : Ref<GoArray<GoUInt32>>)), Go.toInterface(((new GoArray<GoUInt64>(...([].concat([for (i in 0 ... 100) (0 : GoUInt64)]))) : GoArray<GoUInt64>) : Ref<GoArray<GoUInt64>>))) : Slice<AnyInterface>);
/**
...
**/
final maxVarintLen16 = ("3" : GoUInt64);
/**
    // MaxVarintLenN is the maximum length of a varint-encoded N-bit integer.
    
    
**/
final maxVarintLen32 = ("5" : GoUInt64);
/**
    // MaxVarintLenN is the maximum length of a varint-encoded N-bit integer.
    
    
**/
final maxVarintLen64 = ("10" : GoUInt64);
/**
...
@:structInit class BlankFields {
    ...
    public function new(?a:GoUInt32, ?_4:GoInt32, ?b:GoFloat64, ?_5:GoArray<GoInt16>, ?c:GoUInt8, ?_6:GoArray<GoUInt8>, ?_7:{ var _f : GoArray<GoFloat32>; }) {
        if (a != null) this.a = a;
        if (_4 != null) this._4 = _4;
        if (b != null) this.b = b;
        if (_5 != null) this._5 = _5;
        if (c != null) this.c = c;
        if (_6 != null) this._6 = _6;
        if (_7 != null) this._7 = _7;
    }
    public function __underlying__() return Go.toInterface(this);
    public function __copy__() {
...
function read(_r:stdgo.io.Io.Reader, _order:ByteOrder, _data:AnyInterface):Error {
        {
            ...
            if (_n != ((0 : GoInt))) {
                ...
                {
                    var __tmp__ = stdgo.io.Io.readFull(_r, _bs), _0:GoInt = __tmp__._0, _err:Error = __tmp__._1;
                    if (_err != null) {
                        return _err;
                    };
                };
        ...
        var _d = (({ _order : _order, _buf : new Slice<GoUInt8>((_size : GoInt).toBasic(), 0, ...[for (i in 0 ... (_size : GoInt).toBasic()) (0 : GoUInt8)]) } : T_decoder) : Ref<T_decoder>);
        {
            var __tmp__ = stdgo.io.Io.readFull(_r, _d._buf), _1:GoInt = __tmp__._0, _err:Error = __tmp__._1;
            if (_err != null) {
                return _err;
            };
        };
...
function write(_w:stdgo.io.Io.Writer, _order:ByteOrder, _data:AnyInterface):Error {
        {
            ...
            if (_n != ((0 : GoInt))) {
                ...
                var __tmp__ = _w.write(_bs), _0:GoInt = __tmp__._0, _err:Error = __tmp__._1;
                return _err;
            };
        };
        var _v:stdgo.reflect.Reflect.Value = (stdgo.reflect.Reflect.indirect((stdgo.reflect.Reflect.valueOf(_data) == null ? null : stdgo.reflect.Reflect.valueOf(_data).__copy__())) == null ? null : stdgo.reflect.Reflect.indirect((stdgo.reflect.Reflect.valueOf(_data) == null ? null : stdgo.reflect.Reflect.valueOf(_data).__copy__())).__copy__());
        ...
        var __tmp__ = _w.write(_buf), _1:GoInt = __tmp__._0, _err:Error = __tmp__._1;
        return _err;
    }
/**
...
function size(_v:AnyInterface):GoInt {
        return _dataSize((stdgo.reflect.Reflect.indirect((stdgo.reflect.Reflect.valueOf(_v) == null ? null : stdgo.reflect.Reflect.valueOf(_v).__copy__())) == null ? null : stdgo.reflect.Reflect.indirect((stdgo.reflect.Reflect.valueOf(_v) == null ? null : stdgo.reflect.Reflect.valueOf(_v).__copy__())).__copy__()));
    }
/**
...
private function _sizeof(_t:stdgo.reflect.Reflect.Type):GoInt {
        if (_t.kind() == ((("17" : GoUInt) : stdgo.reflect.Reflect.Kind))) {
            ...
            return _sum;
        } else if (_t.kind() == ((("1" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _t.kind() == ((("8" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _t.kind() == ((("9" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _t.kind() == ((("10" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _t.kind() == ((("11" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _t.kind() == ((("3" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _t.kind() == ((("4" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _t.kind() == ((("5" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _t.kind() == ((("6" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _t.kind() == ((("13" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _t.kind() == ((("14" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _t.kind() == ((("15" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _t.kind() == ((("16" : GoUInt) : stdgo.reflect.Reflect.Kind))) {
...
function testReadBool(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        _err = read(Go.asInterface(stdgo.bytes.Bytes.newReader((new Slice<GoUInt8>(0, 0, (0 : GoUInt8)) : Slice<GoUInt8>))), Go.asInterface(bigEndian), Go.toInterface(Go.pointer(_res)));
        _checkResult(_t, ("ReadBool" : GoString), Go.asInterface(bigEndian), _err, Go.toInterface(_res), Go.toInterface(false));
        _res = false;
        _err = read(Go.asInterface(stdgo.bytes.Bytes.newReader((new Slice<GoUInt8>(0, 0, (1 : GoUInt8)) : Slice<GoUInt8>))), Go.asInterface(bigEndian), Go.toInterface(Go.pointer(_res)));
        _checkResult(_t, ("ReadBool" : GoString), Go.asInterface(bigEndian), _err, Go.toInterface(_res), Go.toInterface(true));
        _res = false;
        _err = read(Go.asInterface(stdgo.bytes.Bytes.newReader((new Slice<GoUInt8>(0, 0, (2 : GoUInt8)) : Slice<GoUInt8>))), Go.asInterface(bigEndian), Go.toInterface(Go.pointer(_res)));
        _checkResult(_t, ("ReadBool" : GoString), Go.asInterface(bigEndian), _err, Go.toInterface(_res), Go.toInterface(true));
    }
function testReadBoolSlice(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _err:Error = read(Go.asInterface(stdgo.bytes.Bytes.newReader((new Slice<GoUInt8>(0, 0, (0 : GoUInt8), (1 : GoUInt8), (2 : GoUInt8), (255 : GoUInt8)) : Slice<GoUInt8>))), Go.asInterface(bigEndian), Go.toInterface(_slice));
...
function testSliceRoundTrip(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        for (_0 => _array in _intArrays) {
            ...
            if (_src.index((0 : GoInt)).kind() == ((("8" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _src.index((0 : GoInt)).kind() == ((("9" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _src.index((0 : GoInt)).kind() == ((("10" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _src.index((0 : GoInt)).kind() == ((("11" : GoUInt) : stdgo.reflect.Reflect.Kind))) {
                _unsigned = true;
            };
            {
...
function testWriteT(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        {
            var _0:GoInt = (0 : GoInt), _1:GoInt = _tv.numField(), _n:GoInt = _1, _i:GoInt = _0;
            Go.cfor(_i < _n, _i++, {
...
function testReadTruncated(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _b2:T__struct_5 = ({ a : (0 : GoUInt8), b : (0 : GoUInt8), c : (0 : GoUInt8), d : (0 : GoUInt8), e : (0 : GoInt32), f : (0 : GoFloat64) } : T__struct_5);
        {
            ...
            Go.cfor(_i <= (("0123456789abcdef" : GoString).length), _i++, {
                ...
                {
                    var _err:Error = read(Go.asInterface(stdgo.strings.Strings.newReader((("0123456789abcdef" : GoString).__slice__(0, _i) : GoString))), Go.asInterface(littleEndian), Go.toInterface((_b1 : Ref<Slice<GoInt32>>)));
                ...
                {
                    var _err:Error = read(Go.asInterface(stdgo.strings.Strings.newReader((("0123456789abcdef" : GoString).__slice__(0, _i) : GoString))), Go.asInterface(littleEndian), Go.toInterface(Go.asInterface((_b2 : Ref<T__struct_5>))));
                    if (Go.toInterface(_err) != (Go.toInterface(_errWant))) {
...
Go.toInterface((("0" : GoUInt32) : GoUInt32)),
Go.toInterface((("0" : GoUInt64) : GoUInt64)),
Go.toInterface((false : Bool))) : Slice<AnyInterface>);
        for (_0 => _dst in _destinations) {
            var _err:Error = read(Go.asInterface(stdgo.bytes.Bytes.newReader((new Slice<GoUInt8>(0, 0, (1 : GoUInt8), (2 : GoUInt8), (3 : GoUInt8), (4 : GoUInt8), (5 : GoUInt8), (6 : GoUInt8), (7 : GoUInt8), (8 : GoUInt8)) : Slice<GoUInt8>))), _order, _dst);
...
function benchmarkReadSlice1000Int32s(_b:Ref<stdgo.testing.Testing.B>):Void {
        ...
        var _buf = new Slice<GoUInt8>(((_slice.length) * (4 : GoInt) : GoInt).toBasic(), 0, ...[for (i in 0 ... ((_slice.length) * (4 : GoInt) : GoInt).toBasic()) (0 : GoUInt8)]);
...
function testBufferTooSmall(_t:Ref<stdgo.testing.Testing.T>):Void {
        var _buf = (new Slice<GoUInt8>(0, 0, (128 : GoUInt8), (128 : GoUInt8), (128 : GoUInt8), (128 : GoUInt8)) : Slice<GoUInt8>);
        {
            ...
            Go.cfor(_i <= (_buf.length), _i++, {
                ...
                if ((_x != ("0" : GoUInt64)) || (Go.toInterface(_err) != Go.toInterface(_wantErr))) {
...
function testBufferTooBigWithOverflow(_t:Ref<stdgo.testing.Testing.T>):Void {
        var _tests = (new Slice<T__struct_6>(0, 0, ({ _in : {
            ...
            a();
        }, _name : ("invalid: 1000 bytes" : GoString), _wantN : (-11 : GoInt), _wantValue : ("0" : GoUInt64) } : T__struct_6), ({ _in : (new Slice<GoUInt8>(
0,
0,
(215 : GoUInt8),
(255 : GoUInt8),
...
(255 : GoUInt8),
(255 : GoUInt8),
(1 : GoUInt8)) : Slice<GoUInt8>), _name : ("valid: math.MaxUint64-40" : GoString), _wantN : (10 : GoInt), _wantValue : ("18446744073709551575" : GoUInt64) } : T__struct_6), ({ _in : (new Slice<GoUInt8>(
0,
0,
(215 : GoUInt8),
(255 : GoUInt8),
...
(255 : GoUInt8),
(255 : GoUInt8),
(1 : GoUInt8)) : Slice<GoUInt8>), _name : ("invalid: with more than MaxVarintLen64 bytes" : GoString), _wantN : (-11 : GoInt), _wantValue : ("0" : GoUInt64) } : T__struct_6), ({ _in : (new Slice<GoUInt8>(
0,
0,
(215 : GoUInt8),
(255 : GoUInt8),
...
(255 : GoUInt8),
(255 : GoUInt8),
(127 : GoUInt8)) : Slice<GoUInt8>), _name : ("invalid: 10th byte" : GoString), _wantN : (-10 : GoInt), _wantValue : ("0" : GoUInt64) } : T__struct_6)) : Slice<T__struct_6>);
        for (_0 => _tt in _tests) {
            ...
            _t.run(_tt._name, function(_t:Ref<stdgo.testing.Testing.T>):Void {
                ...
                {
                    var _0:GoInt = _n, _1:GoInt = _tt._wantN, _w:GoInt = _1, _g:GoInt = _0;
                    if (_g != (_w)) {
                        _t.errorf(("bytes returned=%d, want=%d" : GoString), Go.toInterface(_g), Go.toInterface(_w));
                    };
                };
                {
                    var _0:GoUInt64 = _value, _1:GoUInt64 = _tt._wantValue, _w:GoUInt64 = _1, _g:GoUInt64 = _0;
                    if (_g != (_w)) {
...
(128 : GoUInt8),
(128 : GoUInt8),
(2 : GoUInt8)) : Slice<GoUInt8>), ("0" : GoUInt64), (-10 : GoInt), _overflow);
        _testOverflow(_t, (new Slice<GoUInt8>(
0,
0,
(128 : GoUInt8),
...
class T_littleEndian_asInterface {
    ...
    @:keep
    public function appendUint64(_b:Slice<GoByte>, _v:GoUInt64):Slice<GoByte> return __self__.value.appendUint64(_b, _v);
    @:keep
    public function putUint64(_b:Slice<GoByte>, _v:GoUInt64):Void __self__.value.putUint64(_b, _v);
    @:keep
    public function uint64(_b:Slice<GoByte>):GoUInt64 return __self__.value.uint64(_b);
    @:keep
    public function appendUint32(_b:Slice<GoByte>, _v:GoUInt32):Slice<GoByte> return __self__.value.appendUint32(_b, _v);
    @:keep
    public function putUint32(_b:Slice<GoByte>, _v:GoUInt32):Void __self__.value.putUint32(_b, _v);
    @:keep
    public function uint32(_b:Slice<GoByte>):GoUInt32 return __self__.value.uint32(_b);
    @:keep
    public function appendUint16(_b:Slice<GoByte>, _v:GoUInt16):Slice<GoByte> return __self__.value.appendUint16(_b, _v);
    @:keep
    public function putUint16(_b:Slice<GoByte>, _v:GoUInt16):Void __self__.value.putUint16(_b, _v);
    @:keep
    public function uint16(_b:Slice<GoByte>):GoUInt16 return __self__.value.uint16(_b);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
@:keep @:allow(stdgo.encoding.binary.Binary.T_littleEndian_asInterface) class T_littleEndian_static_extension {
    ...
    static public function appendUint64( _:T_littleEndian, _b:Slice<GoByte>, _v:GoUInt64):Slice<GoByte> {
        return (_b.__append__((_v : GoByte), (_v >> ("8" : GoUInt64) : GoByte), (_v >> ("16" : GoUInt64) : GoByte), (_v >> ("24" : GoUInt64) : GoByte), (_v >> ("32" : GoUInt64) : GoByte), (_v >> ("40" : GoUInt64) : GoByte), (_v >> ("48" : GoUInt64) : GoByte), (_v >> ("56" : GoUInt64) : GoByte)));
    }
    @:keep
    ...
    static public function uint64( _:T_littleEndian, _b:Slice<GoByte>):GoUInt64 {
        _b[(7 : GoInt)];
        return (((((((_b[(0 : GoInt)] : GoUInt64) | ((_b[(1 : GoInt)] : GoUInt64) << (("8" : GoUInt64) : GoUInt64))) | ((_b[(2 : GoInt)] : GoUInt64) << (("16" : GoUInt64) : GoUInt64))) | ((_b[(3 : GoInt)] : GoUInt64) << (("24" : GoUInt64) : GoUInt64))) | ((_b[(4 : GoInt)] : GoUInt64) << (("32" : GoUInt64) : GoUInt64))) | ((_b[(5 : GoInt)] : GoUInt64) << (("40" : GoUInt64) : GoUInt64))) | ((_b[(6 : GoInt)] : GoUInt64) << (("48" : GoUInt64) : GoUInt64))) | ((_b[(7 : GoInt)] : GoUInt64) << (("56" : GoUInt64) : GoUInt64));
    }
    @:keep
    ...
    static public function uint32( _:T_littleEndian, _b:Slice<GoByte>):GoUInt32 {
        _b[(3 : GoInt)];
        return (((_b[(0 : GoInt)] : GoUInt32) | ((_b[(1 : GoInt)] : GoUInt32) << (("8" : GoUInt64) : GoUInt64))) | ((_b[(2 : GoInt)] : GoUInt32) << (("16" : GoUInt64) : GoUInt64))) | ((_b[(3 : GoInt)] : GoUInt32) << (("24" : GoUInt64) : GoUInt64));
    }
    @:keep
...
@:keep @:allow(stdgo.encoding.binary.Binary.T_bigEndian_asInterface) class T_bigEndian_static_extension {
    ...
    static public function appendUint64( _:T_bigEndian, _b:Slice<GoByte>, _v:GoUInt64):Slice<GoByte> {
        return (_b.__append__((_v >> ("56" : GoUInt64) : GoByte), (_v >> ("48" : GoUInt64) : GoByte), (_v >> ("40" : GoUInt64) : GoByte), (_v >> ("32" : GoUInt64) : GoByte), (_v >> ("24" : GoUInt64) : GoByte), (_v >> ("16" : GoUInt64) : GoByte), (_v >> ("8" : GoUInt64) : GoByte), (_v : GoByte)));
    }
    @:keep
    ...
    static public function uint64( _:T_bigEndian, _b:Slice<GoByte>):GoUInt64 {
        _b[(7 : GoInt)];
        return (((((((_b[(7 : GoInt)] : GoUInt64) | ((_b[(6 : GoInt)] : GoUInt64) << (("8" : GoUInt64) : GoUInt64))) | ((_b[(5 : GoInt)] : GoUInt64) << (("16" : GoUInt64) : GoUInt64))) | ((_b[(4 : GoInt)] : GoUInt64) << (("24" : GoUInt64) : GoUInt64))) | ((_b[(3 : GoInt)] : GoUInt64) << (("32" : GoUInt64) : GoUInt64))) | ((_b[(2 : GoInt)] : GoUInt64) << (("40" : GoUInt64) : GoUInt64))) | ((_b[(1 : GoInt)] : GoUInt64) << (("48" : GoUInt64) : GoUInt64))) | ((_b[(0 : GoInt)] : GoUInt64) << (("56" : GoUInt64) : GoUInt64));
    }
    @:keep
    ...
    static public function uint32( _:T_bigEndian, _b:Slice<GoByte>):GoUInt32 {
        _b[(3 : GoInt)];
        return (((_b[(3 : GoInt)] : GoUInt32) | ((_b[(2 : GoInt)] : GoUInt32) << (("8" : GoUInt64) : GoUInt64))) | ((_b[(1 : GoInt)] : GoUInt32) << (("16" : GoUInt64) : GoUInt64))) | ((_b[(0 : GoInt)] : GoUInt32) << (("24" : GoUInt64) : GoUInt64));
    }
    @:keep
...
class T_decoder_asInterface {
    @:keep
    public function _skip(_v:stdgo.reflect.Reflect.Value):Void __self__.value._skip(_v);
    @:keep
    public function _value(_v:stdgo.reflect.Reflect.Value):Void __self__.value._value(_v);
    @:keep
    public function _int64():GoInt64 return __self__.value._int64();
    @:keep
    public function _int32():GoInt32 return __self__.value._int32();
    @:keep
    public function _int16():GoInt16 return __self__.value._int16();
    @:keep
    public function _int8():GoInt8 return __self__.value._int8();
    @:keep
    public function _uint64():GoUInt64 return __self__.value._uint64();
    @:keep
    public function _uint32():GoUInt32 return __self__.value._uint32();
    @:keep
    public function _uint16():GoUInt16 return __self__.value._uint16();
    @:keep
    public function _uint8():GoUInt8 return __self__.value._uint8();
    @:keep
    public function _bool():Bool return __self__.value._bool();
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
class T_encoder_asInterface {
    ...
    public function _value(_v:stdgo.reflect.Reflect.Value):Void __self__.value._value(_v);
    @:keep
    public function _int64(_x:GoInt64):Void __self__.value._int64(_x);
    @:keep
    public function _int32(_x:GoInt32):Void __self__.value._int32(_x);
    @:keep
    public function _int16(_x:GoInt16):Void __self__.value._int16(_x);
    @:keep
    public function _int8(_x:GoInt8):Void __self__.value._int8(_x);
    @:keep
    public function _uint64(_x:GoUInt64):Void __self__.value._uint64(_x);
    @:keep
    public function _uint32(_x:GoUInt32):Void __self__.value._uint32(_x);
    @:keep
    public function _uint16(_x:GoUInt16):Void __self__.value._uint16(_x);
    @:keep
    public function _uint8(_x:GoUInt8):Void __self__.value._uint8(_x);
    @:keep
    public function _bool(_x:Bool):Void __self__.value._bool(_x);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
