...
Called from stdgo.encoding.binary._Binary.$Binary_Fields_._dataSize (stdgo/encoding/binary/Binary.hx line 1055)
Called from stdgo.encoding.binary._Binary.$Binary_Fields_.read (stdgo/encoding/binary/Binary.hx line 847)
Called from stdgo.encoding.binary._Binary.$Binary_Fields_._testRead (stdgo/encoding/binary/Binary.hx line 1169)
Called from stdgo.encoding.binary._Binary.$Binary_Fields_.testLittleEndianRead (stdgo/encoding/binary/Binary.hx line 1178)
Called from stdgo.testing.M.run (stdgo/testing/Testing.hx line 355)
Called from stdgo.encoding.binary_test._Binary.$Binary_Fields_.main (stdgo/encoding/binary_test/Binary.hx line 106)
```
</p>
</details>
...
=== RUN  TestLittleEndianRead
Exception: sync.load is not yet implemented
Called from stdgo.encoding.binary._Binary.Binary_Fields_.testLittleEndianRead (stdgo/encoding/binary/Binary.hx line 1178 column 9)
Called from stdgo.encoding.binary._Binary.Binary_Fields_._testRead (stdgo/encoding/binary/Binary.hx line 1169 column 26)
Called from stdgo.encoding.binary._Binary.Binary_Fields_.read (stdgo/encoding/binary/Binary.hx line 847 column 21)
Called from stdgo.encoding.binary._Binary.Binary_Fields_._dataSize (stdgo/encoding/binary/Binary.hx line 1055 column 31)
...
- [class T\_bar\_testSizeStructCache\_1](<#class-t_bar_testsizestructcache_1>)

  - [`function new(?a:stdgo.encoding.binary.Struct, ?b:stdgo.encoding.binary.T_foo_testSizeStructCache_0, ?c:stdgo.encoding.binary.Struct):Void`](<#t_bar_testsizestructcache_1-function-new>)

- [class T\_bigEndian](<#class-t_bigendian>)

  - [`function new():Void`](<#t_bigendian-function-new>)

  - [`function appendUint16( _b:stdgo.Slice<stdgo.GoByte>, _v:stdgo.GoUInt16):stdgo.Slice<stdgo.GoByte>`](<#t_bigendian-function-appenduint16>)

  - [`function appendUint32( _b:stdgo.Slice<stdgo.GoByte>, _v:stdgo.GoUInt32):stdgo.Slice<stdgo.GoByte>`](<#t_bigendian-function-appenduint32>)

  - [`function appendUint64( _b:stdgo.Slice<stdgo.GoByte>, _v:stdgo.GoUInt64):stdgo.Slice<stdgo.GoByte>`](<#t_bigendian-function-appenduint64>)

  - [`function goString():stdgo.GoString`](<#t_bigendian-function-gostring>)

  - [`function putUint16( _b:stdgo.Slice<stdgo.GoByte>, _v:stdgo.GoUInt16):Void`](<#t_bigendian-function-putuint16>)

  - [`function putUint32( _b:stdgo.Slice<stdgo.GoByte>, _v:stdgo.GoUInt32):Void`](<#t_bigendian-function-putuint32>)

  - [`function putUint64( _b:stdgo.Slice<stdgo.GoByte>, _v:stdgo.GoUInt64):Void`](<#t_bigendian-function-putuint64>)

  - [`function string():stdgo.GoString`](<#t_bigendian-function-string>)

  - [`function uint16( _b:stdgo.Slice<stdgo.GoByte>):stdgo.GoUInt16`](<#t_bigendian-function-uint16>)

  - [`function uint32( _b:stdgo.Slice<stdgo.GoByte>):stdgo.GoUInt32`](<#t_bigendian-function-uint32>)

  - [`function uint64( _b:stdgo.Slice<stdgo.GoByte>):stdgo.GoUInt64`](<#t_bigendian-function-uint64>)

- [class T\_byteSliceReader](<#class-t_byteslicereader>)

  - [`function new(?_remain:stdgo.Slice<stdgo.GoUInt8>):Void`](<#t_byteslicereader-function-new>)

  - [`function read( _p:stdgo.Slice<stdgo.GoByte>):{_1:stdgo.Error, _0:stdgo.GoInt}`](<#t_byteslicereader-function-read>)

- [class T\_coder](<#class-t_coder>)

  - [`function new(?_order:Null<stdgo.encoding.binary.ByteOrder>, ?_buf:stdgo.Slice<stdgo.GoUInt8>, ?_offset:Null<stdgo.GoInt>):Void`](<#t_coder-function-new>)

- [class T\_foo\_testSizeStructCache\_0](<#class-t_foo_testsizestructcache_0>)

  - [`function new(?a:stdgo.GoUInt32):Void`](<#t_foo_testsizestructcache_0-function-new>)

- [class T\_littleEndian](<#class-t_littleendian>)

  - [`function new():Void`](<#t_littleendian-function-new>)

  - [`function appendUint16( _b:stdgo.Slice<stdgo.GoByte>, _v:stdgo.GoUInt16):stdgo.Slice<stdgo.GoByte>`](<#t_littleendian-function-appenduint16>)

  - [`function appendUint32( _b:stdgo.Slice<stdgo.GoByte>, _v:stdgo.GoUInt32):stdgo.Slice<stdgo.GoByte>`](<#t_littleendian-function-appenduint32>)

  - [`function appendUint64( _b:stdgo.Slice<stdgo.GoByte>, _v:stdgo.GoUInt64):stdgo.Slice<stdgo.GoByte>`](<#t_littleendian-function-appenduint64>)

  - [`function goString():stdgo.GoString`](<#t_littleendian-function-gostring>)

  - [`function putUint16( _b:stdgo.Slice<stdgo.GoByte>, _v:stdgo.GoUInt16):Void`](<#t_littleendian-function-putuint16>)

  - [`function putUint32( _b:stdgo.Slice<stdgo.GoByte>, _v:stdgo.GoUInt32):Void`](<#t_littleendian-function-putuint32>)

  - [`function putUint64( _b:stdgo.Slice<stdgo.GoByte>, _v:stdgo.GoUInt64):Void`](<#t_littleendian-function-putuint64>)

  - [`function string():stdgo.GoString`](<#t_littleendian-function-string>)

  - [`function uint16( _b:stdgo.Slice<stdgo.GoByte>):stdgo.GoUInt16`](<#t_littleendian-function-uint16>)

  - [`function uint32( _b:stdgo.Slice<stdgo.GoByte>):stdgo.GoUInt32`](<#t_littleendian-function-uint32>)

  - [`function uint64( _b:stdgo.Slice<stdgo.GoByte>):stdgo.GoUInt64`](<#t_littleendian-function-uint64>)
...
```haxe
final maxVarintLen16:stdgo.GoUInt64 = (("3" : GoUInt64))
```
...
```haxe
final maxVarintLen32:stdgo.GoUInt64 = (("5" : GoUInt64))
```
...
```haxe
final maxVarintLen64:stdgo.GoUInt64 = (("10" : GoUInt64))
```
...
```haxe
var _4:stdgo.GoInt32
```


```haxe
var _5:stdgo.GoArray<stdgo.GoInt16>
```


```haxe
var _6:stdgo.GoArray<stdgo.GoUInt8>
```
...
## class T\_bar\_testSizeStructCache\_1
...
```haxe
var b:stdgo.encoding.binary.T_foo_testSizeStructCache_0
```
...
### T\_bar\_testSizeStructCache\_1 function new


```haxe
function new(?a:stdgo.encoding.binary.Struct, ?b:stdgo.encoding.binary.T_foo_testSizeStructCache_0, ?c:stdgo.encoding.binary.Struct):Void
```
...
[\(view code\)](<./Binary.hx#L410>)


### T\_bigEndian function appendUint16


```haxe
function appendUint16( _b:stdgo.Slice<stdgo.GoByte>, _v:stdgo.GoUInt16):stdgo.Slice<stdgo.GoByte>
```
...
[\(view code\)](<./Binary.hx#L2592>)


### T\_bigEndian function appendUint32


```haxe
function appendUint32( _b:stdgo.Slice<stdgo.GoByte>, _v:stdgo.GoUInt32):stdgo.Slice<stdgo.GoByte>
```
...
[\(view code\)](<./Binary.hx#L2575>)


### T\_bigEndian function appendUint64


```haxe
function appendUint64( _b:stdgo.Slice<stdgo.GoByte>, _v:stdgo.GoUInt64):stdgo.Slice<stdgo.GoByte>
```
...
[\(view code\)](<./Binary.hx#L2554>)


### T\_bigEndian function goString
...
[\(view code\)](<./Binary.hx#L2546>)


### T\_bigEndian function putUint16


```haxe
function putUint16( _b:stdgo.Slice<stdgo.GoByte>, _v:stdgo.GoUInt16):Void
```
...
[\(view code\)](<./Binary.hx#L2596>)


### T\_bigEndian function putUint32


```haxe
function putUint32( _b:stdgo.Slice<stdgo.GoByte>, _v:stdgo.GoUInt32):Void
```
...
[\(view code\)](<./Binary.hx#L2579>)


### T\_bigEndian function putUint64


```haxe
function putUint64( _b:stdgo.Slice<stdgo.GoByte>, _v:stdgo.GoUInt64):Void
```
...
[\(view code\)](<./Binary.hx#L2558>)


### T\_bigEndian function string
...
[\(view code\)](<./Binary.hx#L2550>)


### T\_bigEndian function uint16


```haxe
function uint16( _b:stdgo.Slice<stdgo.GoByte>):stdgo.GoUInt16
```
...
[\(view code\)](<./Binary.hx#L2602>)


### T\_bigEndian function uint32


```haxe
function uint32( _b:stdgo.Slice<stdgo.GoByte>):stdgo.GoUInt32
```
...
[\(view code\)](<./Binary.hx#L2587>)


### T\_bigEndian function uint64


```haxe
function uint64( _b:stdgo.Slice<stdgo.GoByte>):stdgo.GoUInt64
```
...
[\(view code\)](<./Binary.hx#L2570>)


## class T\_byteSliceReader
...
```haxe
var _remain:stdgo.Slice<stdgo.GoUInt8>
```


### T\_byteSliceReader function new


```haxe
function new(?_remain:stdgo.Slice<stdgo.GoUInt8>):Void
```
...
[\(view code\)](<./Binary.hx#L594>)


### T\_byteSliceReader function read
...
```haxe
var _order:stdgo.encoding.binary.ByteOrder
```


### T\_coder function new


```haxe
function new(?_order:Null<stdgo.encoding.binary.ByteOrder>, ?_buf:stdgo.Slice<stdgo.GoUInt8>, ?_offset:Null<stdgo.GoInt>):Void
```
...
[\(view code\)](<./Binary.hx#L425>)


## class T\_foo\_testSizeStructCache\_0
...
### T\_foo\_testSizeStructCache\_0 function new
...
## class T\_littleEndian





### T\_littleEndian function new
...
[\(view code\)](<./Binary.hx#L398>)


### T\_littleEndian function appendUint16
...
[\(view code\)](<./Binary.hx#L2498>)


### T\_littleEndian function appendUint32
...
[\(view code\)](<./Binary.hx#L2481>)


### T\_littleEndian function appendUint64
...
[\(view code\)](<./Binary.hx#L2460>)


### T\_littleEndian function goString
...
### T\_littleEndian function putUint16
...
[\(view code\)](<./Binary.hx#L2502>)


### T\_littleEndian function putUint32
...
[\(view code\)](<./Binary.hx#L2485>)


### T\_littleEndian function putUint64
...
[\(view code\)](<./Binary.hx#L2464>)


### T\_littleEndian function string
...
[\(view code\)](<./Binary.hx#L2456>)


### T\_littleEndian function uint16
...
[\(view code\)](<./Binary.hx#L2508>)


### T\_littleEndian function uint32
...
[\(view code\)](<./Binary.hx#L2493>)


### T\_littleEndian function uint64
