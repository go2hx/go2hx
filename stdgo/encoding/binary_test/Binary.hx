...
private var _tests:Slice<stdgo.testing.Testing.InternalTest> = (new Slice<stdgo.testing.Testing.InternalTest>(0, 0,
	(new stdgo.testing.Testing.InternalTest(("TestLittleEndianRead" : GoString),
		stdgo.encoding.binary.Binary.testLittleEndianRead) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestLittleEndianWrite" : GoString),
		stdgo.encoding.binary.Binary.testLittleEndianWrite) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestLittleEndianPtrWrite" : GoString),
		stdgo.encoding.binary.Binary.testLittleEndianPtrWrite) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestBigEndianRead" : GoString),
		stdgo.encoding.binary.Binary.testBigEndianRead) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestBigEndianWrite" : GoString),
		stdgo.encoding.binary.Binary.testBigEndianWrite) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestBigEndianPtrWrite" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestReadBoolSlice" : GoString),
		stdgo.encoding.binary.Binary.testReadBoolSlice) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestSliceRoundTrip" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestBlankFields" : GoString),
		stdgo.encoding.binary.Binary.testBlankFields) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestSizeStructCache" : GoString),
		stdgo.encoding.binary.Binary.testSizeStructCache) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestUnexportedRead" : GoString),
		stdgo.encoding.binary.Binary.testUnexportedRead) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestReadErrorMsg" : GoString),
		stdgo.encoding.binary.Binary.testReadErrorMsg) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestReadTruncated" : GoString),
		stdgo.encoding.binary.Binary.testReadTruncated) : stdgo.testing.Testing.InternalTest),
	...
	(new stdgo.testing.Testing.InternalTest(("TestEarlyBoundsChecks" : GoString),
		stdgo.encoding.binary.Binary.testEarlyBoundsChecks) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestReadInvalidDestination" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestBufferTooSmall" : GoString),
		stdgo.encoding.binary.Binary.testBufferTooSmall) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestBufferTooBigWithOverflow" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestNonCanonicalZero" : GoString),
...
private var _examples:Slice<stdgo.testing.Testing.InternalExample> = (new Slice<stdgo.testing.Testing.InternalExample>(0, 0,
	(new stdgo.testing.Testing.InternalExample(("ExampleWrite" : GoString), stdgo.encoding.binary_test.Binary_test.exampleWrite,
		("18 2d 44 54 fb 21 09 40\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleWrite_multi" : GoString), stdgo.encoding.binary_test.Binary_test.exampleWrite_multi,
		("beefcafe\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleRead" : GoString), stdgo.encoding.binary_test.Binary_test.exampleRead,
		("3.141592653589793\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleRead_multi" : GoString), stdgo.encoding.binary_test.Binary_test.exampleRead_multi,
		("3.141592653589793\n255\n01 02 03\n61374\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleByteOrder_put" : GoString), stdgo.encoding.binary_test.Binary_test.exampleByteOrder_put,
		("e8 03 d0 07\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleByteOrder_get" : GoString), stdgo.encoding.binary_test.Binary_test.exampleByteOrder_get,
		("0x03e8 0x07d0\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExamplePutUvarint" : GoString), stdgo.encoding.binary_test.Binary_test.examplePutUvarint,
		("01\n02\n7f\n8001\nff01\n8002\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExamplePutVarint" : GoString), stdgo.encoding.binary_test.Binary_test.examplePutVarint,
		("8101\n7f\n03\n01\n00\n02\n04\n7e\n8001\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleUvarint" : GoString), stdgo.encoding.binary_test.Binary_test.exampleUvarint,
		("1\n2\n127\n128\n255\n256\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleVarint" : GoString), stdgo.encoding.binary_test.Binary_test.exampleVarint,
