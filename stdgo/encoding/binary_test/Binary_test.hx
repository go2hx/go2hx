...
function exampleByteOrder_put():Void {
        ...
        stdgo.encoding.binary.Binary.littleEndian.putUint16((_b.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>), (1000 : stdgo.GoUInt16));
        stdgo.encoding.binary.Binary.littleEndian.putUint16((_b.__slice__((2 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>), (2000 : stdgo.GoUInt16));
...
function exampleByteOrder_get():Void {
        ...
        var _x1:stdgo.GoUInt16 = stdgo.encoding.binary.Binary.littleEndian.uint16((_b.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
        var _x2:stdgo.GoUInt16 = stdgo.encoding.binary.Binary.littleEndian.uint16((_b.__slice__((2 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
