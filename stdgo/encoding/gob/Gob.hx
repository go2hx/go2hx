...
@:structInit class T_decoderState {
	...
	public function _decodeUint():GoUInt64 {
		...
		var __tmp__ = _state.value._b.value.readByte(),
	...
	public function new(?_dec:Pointer<Decoder>, ?_b:Pointer<T_decBuffer>, ?_fieldnum:GoInt, ?_next:Pointer<T_decoderState>)
...
@:structInit class Decoder {
	...
	public function _nextUint():GoUInt64 {
		var _dec = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _decodeUintReader(Go.pointer(_dec.value._buf).value, _dec.value._countBuf),
	...
	public function _recvMessage():Bool {
		var _dec = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _decodeUintReader(_dec.value._r, _dec.value._countBuf),
			_nbytes:GoUInt64 = __tmp__._0,
			_:GoInt = __tmp__._1,
			_err:stdgo.Error = __tmp__._2;
		if (_err != null) {
			_dec.value._err = _err;
		...
		try {
			...
			var _engine:Pointer<T_decEngine> = _enginePtr.value;
			{
				...
				if (_st.kind().__t__ == stdgo.reflect.Reflect.struct.__t__ && _ut.value._externalDec == ((0 : GoInt))) {
					...
					if (_engine.value._numInstr == ((0 : GoInt))
						&& _st.numField() > ((0 : GoInt))
						&& _wt != null
						&& !_wt.isNil()
						&& _wt.value.structT.value.field.length > ((0 : GoInt))) {
	...
	public function _getIgnoreEnginePtr(_wireId:T_typeId):{var _0:Pointer<Pointer<T_decEngine>>; var _1:Error;} {
		...
		{
			{
				var __tmp__ = _dec.value._ignorerCache.exists(_wireId) ? {value: _dec.value._ignorerCache[_wireId],
					ok: true} : {value: _dec.value._ignorerCache.defaultValue(), ok: false};
	...
	public function _getDecEnginePtr(_remoteId:T_typeId, _ut:Pointer<T_userTypeInfo>):{var _0:Pointer<Pointer<T_decEngine>>; var _1:Error;} {
		...
		var __tmp__ = _dec.value._decoderCache.exists(_rt) ? {value: _dec.value._decoderCache[_rt],
			ok: true} : {value: _dec.value._decoderCache.defaultValue(), ok: false},
			_decoderMap:GoMap<T_typeId, Pointer<Pointer<T_decEngine>>> = __tmp__.value,
			_ok:Bool = __tmp__.ok;
		if (!_ok) {
			_decoderMap = new GoMap<T_typeId,
				Pointer<Pointer<T_decEngine>>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId",
					[], stdgo.reflect.Reflect.GoType.basic(int32_kind)),
				stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.decEngine", [],
					stdgo.reflect.Reflect.GoType.named("encoding/gob.decEngine", [], stdgo.reflect.Reflect.GoType.structType([
						{
							name: "_instr",
							embedded: false,
							tag: "",
							type: stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("encoding/gob.decInstr", [],
								stdgo.reflect.Reflect.GoType.named("encoding/gob.decInstr", [], stdgo.reflect.Reflect.GoType.structType([
									{
										name: "_op",
										embedded: false,
										tag: "",
										type: stdgo.reflect.Reflect.GoType.named("encoding/gob.decOp", [],
									...
									},
									{
										...
										embedded: false,
										tag: "",
										type: stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(int_kind))
									},
									{
										name: "_ovfl",
										embedded: false,
	...
	public function _compileDec(_remoteId:T_typeId, _ut:Pointer<T_userTypeInfo>):{var _0:Pointer<T_decEngine>; var _1:Error;} {
		...
		var recover_exception:Error = null;
		var deferstack:Array<Void->Void> = [];
		var _engine:Pointer<T_decEngine> = new Pointer<T_decEngine>().nil(),
			_err:Error = ((null : stdgo.Error));
		{
		...
		try {
			...
			{
				var __tmp__ = _builtinIdToType.exists(_remoteId) ? {value: _builtinIdToType[_remoteId], ok: true} : {value: _builtinIdToType.defaultValue(),
					ok: false},
					_t:T_gobType = __tmp__.value,
					_ok:Bool = __tmp__.ok;
				if (_ok) {
					{
						var __tmp__ = try {
			...
			_engine.value._instr = new Slice<T_decInstr>(...[
				for (i in 0...((_wireStruct.value.field.length : GoInt)).toBasic()) new T_decInstr()
			]);
			var _seen:GoMap<stdgo.reflect.Reflect.Type, Pointer<T_decOp>> = new GoMap<stdgo.reflect.Reflect.Type,
				Pointer<T_decOp>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("reflect.Type", [],
					stdgo.reflect.Reflect.GoType.interfaceType(false, [])),
				stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.decOp", [],
					stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType))))));
			{
				...
				Go.cfor(_fieldnum < _wireStruct.value.field.length, _fieldnum++, {
					...
					var __tmp__ = _srt.fieldByName(_wireField.value.name),
						_localField:stdgo.reflect.Reflect.StructField = __tmp__._0,
						_present:Bool = __tmp__._1;
					if (!_present || !_isExported(_wireField.value.name)) {
						var _op:Pointer<T_decOp> = _dec.value._decIgnoreOpFor(_wireField.value.id,
							new GoMap<T_typeId,
								Pointer<T_decOp>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId",
									[], stdgo.reflect.Reflect.GoType.basic(int32_kind)),
								stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.decOp", [],
									stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType)))))));
					...
					if (!_dec.value._compatibleType(_localField.type, _wireField.value.id,
						new GoMap<stdgo.reflect.Reflect.Type,
							T_typeId>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("reflect.Type",
								[], stdgo.reflect.Reflect.GoType.interfaceType(false, [])),
							stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId", [], stdgo.reflect.Reflect.GoType.basic(int32_kind))))))) {
						_errorf("wrong type (%s) for received field %s.%s", Go.toInterface(_localField.type),
							Go.toInterface(_wireStruct.value.commonType.name), Go.toInterface(_wireField.value.name));
					};
	...
	public function _compileSingle(_remoteId:T_typeId, _ut:Pointer<T_userTypeInfo>):{var _0:Pointer<T_decEngine>; var _1:Error;} {
		...
		if (!_dec.value._compatibleType(_rt, _remoteId,
			new GoMap<stdgo.reflect.Reflect.Type,
				T_typeId>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("reflect.Type", [],
					stdgo.reflect.Reflect.GoType.interfaceType(false, [])),
				stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId", [], stdgo.reflect.Reflect.GoType.basic(int32_kind))))))) {
			...
			if (_ut.value._base.kind().__t__ == stdgo.reflect.Reflect.interface_.__t__ && _remoteId.__t__ != _tInterface.__t__) {
				return {_0: new Pointer<T_decEngine>().nil(), _1: stdgo.errors.Errors.new_((("gob: local interface type " : GoString))
					+ _name
					+ ((" can only be decoded from remote interface type; received concrete type " : GoString))
					+ _remoteType)};
			};
			return {_0: new Pointer<T_decEngine>().nil(), _1: stdgo.errors.Errors.new_((("gob: decoding into local type " : GoString)) + _name
				+ ((", received remote type " : GoString)) + _remoteType)};
		};
		var _op:Pointer<T_decOp> = _dec.value._decOpFor(_remoteId, _rt, _name,
			new GoMap<stdgo.reflect.Reflect.Type,
				Pointer<T_decOp>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("reflect.Type", [],
					stdgo.reflect.Reflect.GoType.interfaceType(false, [])),
				stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.decOp", [],
	...
	public function _compatibleType(_fr:stdgo.reflect.Reflect.Type, _fw:T_typeId, _inProgress:GoMap<stdgo.reflect.Reflect.Type, T_typeId>):Bool {
		var _dec = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		{
			var __tmp__ = _inProgress.exists(_fr) ? {value: _inProgress[_fr], ok: true} : {value: _inProgress.defaultValue(), ok: false},
				_rhs:T_typeId = __tmp__.value,
				_ok:Bool = __tmp__.ok;
			if (_ok) {
		...
		var __tmp__ = _dec.value._wireType.exists(_fw) ? {value: _dec.value._wireType[_fw], ok: true} : {value: _dec.value._wireType.defaultValue(), ok: false},
			_wire:Pointer<T_wireType> = __tmp__.value,
			_ok:Bool = __tmp__.ok;
		if ((_ut.value._externalDec == _xGob) != (_ok && _wire.value.gobEncoderT != null && !_wire.value.gobEncoderT.isNil())
			|| (_ut.value._externalDec == _xBinary) != (_ok
				&& _wire.value.binaryMarshalerT != null
				&& !_wire.value.binaryMarshalerT.isNil())
				|| (_ut.value._externalDec == _xText) != (_ok && _wire.value.textMarshalerT != null && !_wire.value.textMarshalerT.isNil())) {
			return false;
		};
		...
		};
		{
			...
			if (_t.kind().__t__ == stdgo.reflect.Reflect.bool.__t__) {
			...
			} else if (_t.kind().__t__ == stdgo.reflect.Reflect.uint.__t__
				...
				|| _t.kind().__t__ == stdgo.reflect.Reflect.uintptr.__t__) {
			...
			} else if (_t.kind().__t__ == stdgo.reflect.Reflect.complex64.__t__
				...
				return _dec.value._compatibleType(_t.key(), mapType.value.key, _inProgress)
					&& _dec.value._compatibleType(_t.elem(), mapType.value.elem, _inProgress);
				...
				{
					var __tmp__ = _builtinIdToType.exists(_fw) ? {value: _builtinIdToType[_fw], ok: true} : {value: _builtinIdToType.defaultValue(), ok: false},
						_tt:T_gobType = __tmp__.value,
						_ok:Bool = __tmp__.ok;
					if (_ok) {
						{
							var __tmp__ = try {
	...
	public function _decIgnoreOpFor(_wireId:T_typeId, _inProgress:GoMap<T_typeId, Pointer<T_decOp>>):Pointer<T_decOp> {
		...
		var __tmp__ = _decIgnoreOpMap.exists(_wireId) ? {value: _decIgnoreOpMap[_wireId], ok: true} : {value: _decIgnoreOpMap.defaultValue(), ok: false},
			_op:T_decOp = __tmp__.value,
			_ok:Bool = __tmp__.ok;
		if (!_ok) {
			...
			if (_wire == null || _wire.isNil()) {
				...
				var __tmp__ = _dec.value._getIgnoreEnginePtr(_wireId),
					_enginePtr:Pointer<Pointer<T_decEngine>> = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
					_error_(_err);
				};
			...
			} else if (_wire.value.gobEncoderT != null
				&& !_wire.value.gobEncoderT.isNil()
				|| _wire.value.binaryMarshalerT != null
				&& !_wire.value.binaryMarshalerT.isNil()
				|| _wire.value.textMarshalerT != null
				&& !_wire.value.textMarshalerT.isNil()) {
				_op = new T_decOp(function(_i:Pointer<T_decInstr>, _state:Pointer<T_decoderState>, _value:stdgo.reflect.Reflect.Value):Void {
	...
	public function _decOpFor(_wireId:T_typeId, _rt:stdgo.reflect.Reflect.Type, _name:GoString,
			_inProgress:GoMap<stdgo.reflect.Reflect.Type, Pointer<T_decOp>>):Pointer<T_decOp> {
		var _dec = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
				...
				var _t:stdgo.reflect.Reflect.Type = _typ;
				{
					...
					while (true) {
						if (_t.kind().__t__ == stdgo.reflect.Reflect.array.__t__) {
							...
							{
								var __tmp__ = _builtinIdToType.exists(_wireId) ? {value: _builtinIdToType[_wireId],
									ok: true} : {value: _builtinIdToType.defaultValue(), ok: false},
									_tt:T_gobType = __tmp__.value,
									_ok:Bool = __tmp__.ok;
								if (_ok) {
	...
	public function _decodeInterface(_ityp:stdgo.reflect.Reflect.Type, _state:Pointer<T_decoderState>, _value:stdgo.reflect.Reflect.Value):Void {
		...
		var __tmp__ = _nameToConcreteType.load(Go.toInterface(((_name : GoString)))),
			_typi:AnyInterface = __tmp__._0,
			_ok:Bool = __tmp__._1;
		if (!_ok) {
	...
	public function _ignoreMap(_state:Pointer<T_decoderState>, _keyOp:T_decOp, _elemOp:T_decOp):Void {
		var _dec = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _n:GoInt = ((_state.value._decodeUint() : GoInt));
		var _keyInstr:Pointer<T_decInstr> = Go.pointer(new T_decInstr(_keyOp.__copy__(), ((0 : GoInt)), new Slice<GoInt>().nil(),
			stdgo.errors.Errors.new_("no error")));
		var _elemInstr:Pointer<T_decInstr> = Go.pointer(new T_decInstr(_elemOp.__copy__(), ((0 : GoInt)), new Slice<GoInt>().nil(),
			stdgo.errors.Errors.new_("no error")));
		{
	...
	public function _ignoreArrayHelper(_state:Pointer<T_decoderState>, _elemOp:T_decOp, _length:GoInt):Void {
		var _dec = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _instr:Pointer<T_decInstr> = Go.pointer(new T_decInstr(_elemOp.__copy__(), ((0 : GoInt)), new Slice<GoInt>().nil(),
			stdgo.errors.Errors.new_("no error")));
		{
			var _i:GoInt = ((0 : GoInt));
	...
	public function _decodeMap(_mtyp:stdgo.reflect.Reflect.Type, _state:Pointer<T_decoderState>, _value:stdgo.reflect.Reflect.Value, _keyOp:T_decOp,
			_elemOp:T_decOp, _ovfl:Error):Void {
		var _dec = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _n:GoInt = ((_state.value._decodeUint() : GoInt));
		if (_value.isNil()) {
		...
		var _elemZ:stdgo.reflect.Reflect.Value = stdgo.reflect.Reflect.zero(_mtyp.elem()).__copy__();
		{
			...
			Go.cfor(_i < _n, _i++, {
				...
				var _elem:stdgo.reflect.Reflect.Value = _decodeIntoValue(_state, _elemOp.__copy__(), _elemIsPtr, _elemP.elem().__copy__(),
					_elemInstr).__copy__();
	...
	public function _decodeArray(_state:Pointer<T_decoderState>, _value:stdgo.reflect.Reflect.Value, _elemOp:T_decOp, _length:GoInt, _ovfl:Error,
			_helper:T_decHelper):Void {
		var _dec = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		{
			var _n:GoUInt64 = _state.value._decodeUint();
			if (_n != ((_length : GoUInt64))) {
	...
	public function _decodeArrayHelper(_state:Pointer<T_decoderState>, _value:stdgo.reflect.Reflect.Value, _elemOp:T_decOp, _length:GoInt, _ovfl:Error,
			_helper:T_decHelper):Void {
		var _dec = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		if (_helper.__t__ != null
			&& _helper.__t__(_state, new stdgo.reflect.Reflect.Value(_value.__copy__().__copy__()), _length, new stdgo.Error(_ovfl))) {
			return;
		};
	...
	public var _wireType:GoMap<T_typeId, Pointer<T_wireType>> = new GoMap<T_typeId,
		Pointer<T_wireType>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId", [],
			stdgo.reflect.Reflect.GoType.basic(int32_kind)),
		stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.wireType", [], stdgo.reflect.Reflect.GoType.structType([
			{
				name: "arrayT",
				embedded: false,
				tag: "",
				type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.arrayType", [],
					stdgo.reflect.Reflect.GoType.structType([
						{
							name: "commonType",
							embedded: true,
							tag: "",
							type: stdgo.reflect.Reflect.GoType.named("encoding/gob.CommonType", [], stdgo.reflect.Reflect.GoType.structType([
								{
									name: "name",
									embedded: false,
									tag: "",
								...
								},
								{
									...
									embedded: false,
									tag: "",
									type: stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId", [], stdgo.reflect.Reflect.GoType.basic(int32_kind))
								}
							]))
						},
						{
							...
							embedded: false,
							tag: "",
							type: stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId", [], stdgo.reflect.Reflect.GoType.invalidType)
						},
						{
							name: "len",
							embedded: false,
			...
			},
			{
				...
				embedded: false,
				tag: "",
				type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.sliceType", [],
					stdgo.reflect.Reflect.GoType.structType([
						{
							name: "commonType",
							embedded: true,
							tag: "",
							type: stdgo.reflect.Reflect.GoType.named("encoding/gob.CommonType", [], stdgo.reflect.Reflect.GoType.invalidType)
						},
						{
							name: "elem",
							embedded: false,
			...
			},
			{
				...
				embedded: false,
				tag: "",
				type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.structType", [],
					stdgo.reflect.Reflect.GoType.structType([
						{
							name: "commonType",
							embedded: true,
						...
						},
						{
							...
							embedded: false,
							tag: "",
							type: stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.fieldType",
									[], stdgo.reflect.Reflect.GoType.structType([
								{
									name: "name",
									embedded: false,
			...
			},
			{
				...
				embedded: false,
				tag: "",
				type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.mapType", [],
					stdgo.reflect.Reflect.GoType.structType([
						{
							name: "commonType",
							embedded: true,
			...
			},
			{
				...
				embedded: false,
				tag: "",
				type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.gobEncoderType", [],
					stdgo.reflect.Reflect.GoType.structType([
						{
							name: "commonType",
							embedded: true,
	...
	public var _decoderCache:GoMap<stdgo.reflect.Reflect.Type,
		GoMap<T_typeId, Pointer<Pointer<T_decEngine>>>> = new GoMap<stdgo.reflect.Reflect.Type,
			GoMap<T_typeId,
				Pointer<Pointer<T_decEngine>>>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("reflect.Type",
				[], stdgo.reflect.Reflect.GoType.interfaceType(false, [])),
				stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId", [],
					stdgo.reflect.Reflect.GoType.basic(int32_kind)),
					stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.decEngine", [],
						stdgo.reflect.Reflect.GoType.named("encoding/gob.decEngine", [], stdgo.reflect.Reflect.GoType.structType([
							{
	...
	public var _ignorerCache:GoMap<T_typeId, Pointer<Pointer<T_decEngine>>> = new GoMap<T_typeId,
		Pointer<Pointer<T_decEngine>>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId",
			[], stdgo.reflect.Reflect.GoType.basic(int32_kind)),
		stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.decEngine", [],
			stdgo.reflect.Reflect.GoType.named("encoding/gob.decEngine", [], stdgo.reflect.Reflect.GoType.structType([
	...
	public function new(?_mutex:stdgo.sync.Sync.Mutex, ?_r:stdgo.io.Io.Reader, ?_buf:T_decBuffer, ?_wireType:GoMap<T_typeId, Pointer<T_wireType>>,
			?_decoderCache:GoMap<stdgo.reflect.Reflect.Type, GoMap<T_typeId, Pointer<Pointer<T_decEngine>>>>,
			?_ignorerCache:GoMap<T_typeId, Pointer<Pointer<T_decEngine>>>, ?_freeList:Pointer<T_decoderState>, ?_countBuf:Slice<GoUInt8>, ?_err:stdgo.Error)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_mutex) + " " + Go.string(_r) + " " + Go.string(_buf) + " " + Go.string(_wireType) + " " + Go.string(_decoderCache) + " "
			+ Go.string(_ignorerCache) + " " + Go.string(_freeList) + " " + Go.string(_countBuf) + " " + Go.string(_err) + "}";
	}
...
@:structInit class T_encoderState {
	...
	public function new(?_enc:Pointer<Encoder>, ?_b:Pointer<T_encBuffer>, ?_sendZero:Bool, ?_fieldnum:GoInt, ?_buf:GoArray<GoUInt8>,
			?_next:Pointer<T_encoderState>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_enc) + " " + Go.string(_b) + " " + Go.string(_sendZero) + " " + Go.string(_fieldnum) + " " + Go.string(_buf) + " "
			+ Go.string(_next) + "}";
	}
...
@:structInit class Encoder {
	public function encodeValue(_value:stdgo.reflect.Reflect.Value):Error {
		...
		try {
			...
			var __tmp__ = _validUserType(_value.type()),
				_ut:Pointer<T_userTypeInfo> = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				{
					for (defer in deferstack) {
	...
	public function _sendTypeDescriptor(_w:stdgo.io.Io.Writer, _state:Pointer<T_encoderState>, _ut:Pointer<T_userTypeInfo>):Void {
		...
		{
			var __tmp__ = _enc.value._sent.exists(_rt) ? {value: _enc.value._sent[_rt], ok: true} : {value: _enc.value._sent.defaultValue(), ok: false},
				_:T_typeId = __tmp__.value,
				_alreadySent:Bool = __tmp__.ok;
			if (!_alreadySent) {
				...
				if (!_sent) {
					var __tmp__ = _getTypeInfo(_ut),
						_info:Pointer<T_typeInfo> = __tmp__._0,
						_err:stdgo.Error = __tmp__._1;
					if (_err != null) {
			...
			var _rt:stdgo.reflect.Reflect.Type = _ut.value._base;
			{
				...
				while (true) {
					if (_rt.kind().__t__ == stdgo.reflect.Reflect.slice.__t__) {
						...
						break;
						break;
					} else if (_rt.kind().__t__ == stdgo.reflect.Reflect.chan.__t__
						|| _rt.kind().__t__ == stdgo.reflect.Reflect.func.__t__) {
						return _sent;
						break;
					};
					break;
	...
	public function _sendActualType(_w:stdgo.io.Io.Writer, _state:Pointer<T_encoderState>, _ut:Pointer<T_userTypeInfo>,
			_actual:stdgo.reflect.Reflect.Type):Bool {
		var _enc = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _sent:Bool = false;
		{
			var __tmp__ = _enc.value._sent.exists(_actual) ? {value: _enc.value._sent[_actual], ok: true} : {value: _enc.value._sent.defaultValue(), ok: false},
				_:T_typeId = __tmp__.value,
				_alreadySent:Bool = __tmp__.ok;
			if (_alreadySent) {
				return false;
	...
	public function _writeMessage(_w:stdgo.io.Io.Writer, _b:Pointer<T_encBuffer>):Void {
		...
		var __tmp__ = _w.write(_message.__slice__(_offset)),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		_b.value.reset();
	...
	public function _encode(_b:Pointer<T_encBuffer>, _value:stdgo.reflect.Reflect.Value, _ut:Pointer<T_userTypeInfo>):Void {
		...
		try {
			...
			var _engine:Pointer<T_encEngine> = _getEncEngine(_ut,
				new GoMap<Pointer<T_typeInfo>,
					Bool>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.typeInfo",
						[], stdgo.reflect.Reflect.GoType.named("encoding/gob.typeInfo", [], stdgo.reflect.Reflect.GoType.structType([
					{
						name: "_id",
						embedded: false,
						tag: "",
					...
					},
					{
						...
						embedded: false,
						tag: "",
						type: stdgo.reflect.Reflect.GoType.named("sync/atomic.Value", [], stdgo.reflect.Reflect.GoType.structType([
							{
								name: "_v",
								embedded: false,
								tag: "",
					...
					},
					{
						...
						embedded: false,
						tag: "",
						type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.wireType", [],
							stdgo.reflect.Reflect.GoType.named("encoding/gob.wireType", [], stdgo.reflect.Reflect.GoType.structType([
								{
									name: "arrayT",
									embedded: false,
									tag: "",
									type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.arrayType", [],
										stdgo.reflect.Reflect.GoType.named("encoding/gob.arrayType", [], stdgo.reflect.Reflect.GoType.structType([
											{
												name: "commonType",
												embedded: true,
												tag: "",
												type: stdgo.reflect.Reflect.GoType.named("encoding/gob.CommonType", [],
													stdgo.reflect.Reflect.GoType.named("encoding/gob.CommonType", [], stdgo.reflect.Reflect.GoType.structType([
														{
															name: "name",
															embedded: false,
															tag: "",
														...
														},
														{
															...
															embedded: false,
															tag: "",
															type: stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId", [],
																stdgo.reflect.Reflect.GoType.basic(int32_kind))
														}
													])))
											},
								...
								},
								{
									...
									tag: "",
									type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.sliceType", [],
										stdgo.reflect.Reflect.GoType.named("encoding/gob.sliceType", [], stdgo.reflect.Reflect.GoType.structType([
											{
												name: "commonType",
												embedded: true,
												tag: "",
								...
								},
								{
									...
									tag: "",
									type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.structType", [],
										stdgo.reflect.Reflect.GoType.named("encoding/gob.structType", [], stdgo.reflect.Reflect.GoType.structType([
											{
												name: "commonType",
												embedded: true,
												tag: "",
								...
								},
								{
									...
									tag: "",
									type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.mapType", [],
										stdgo.reflect.Reflect.GoType.named("encoding/gob.mapType", [], stdgo.reflect.Reflect.GoType.structType([
											{
												name: "commonType",
												embedded: true,
												tag: "",
								...
								},
								{
									...
									tag: "",
									type: stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.gobEncoderType", [],
										stdgo.reflect.Reflect.GoType.named("encoding/gob.gobEncoderType", [], stdgo.reflect.Reflect.GoType.structType([
											{
												name: "commonType",
												embedded: true,
												tag: "",
	...
	public function _encodeInterface(_b:Pointer<T_encBuffer>, _iv:stdgo.reflect.Reflect.Value):Void {
		...
		var __tmp__ = _concreteTypeToName.load(Go.toInterface(_ut.value._base)),
			_namei:AnyInterface = __tmp__._0,
			_ok:Bool = __tmp__._1;
		if (!_ok) {
	...
	public function _encodeMap(_b:Pointer<T_encBuffer>, _mv:stdgo.reflect.Reflect.Value, _keyOp:T_encOp, _elemOp:T_encOp, _keyIndir:GoInt,
			_elemIndir:GoInt):Void {
		var _enc = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _state:Pointer<T_encoderState> = _enc.value._newEncoderState(_b);
		_state.value._fieldnum = -((1 : GoUnTypedInt));
		_state.value._sendZero = true;
	...
	public function _encodeArray(_b:Pointer<T_encBuffer>, _value:stdgo.reflect.Reflect.Value, _op:T_encOp, _elemIndir:GoInt, _length:GoInt,
			_helper:T_encHelper):Void {
		var _enc = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var recover_exception:Error = null;
		var deferstack:Array<Void->Void> = [];
		try {
	...
	public var _sent:GoMap<stdgo.reflect.Reflect.Type, T_typeId> = new GoMap<stdgo.reflect.Reflect.Type,
		T_typeId>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("reflect.Type", [],
			stdgo.reflect.Reflect.GoType.interfaceType(false, [])),
		stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId", [], stdgo.reflect.Reflect.GoType.basic(int32_kind))))).nil();
	...
	public function new(?_mutex:stdgo.sync.Sync.Mutex, ?_w:Slice<stdgo.io.Io.Writer>, ?_sent:GoMap<stdgo.reflect.Reflect.Type, T_typeId>,
			?_countState:Pointer<T_encoderState>, ?_freeList:Pointer<T_encoderState>, ?_byteBuf:T_encBuffer, ?_err:stdgo.Error)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_mutex) + " " + Go.string(_w) + " " + Go.string(_sent) + " " + Go.string(_countState) + " " + Go.string(_freeList) + " "
			+ Go.string(_byteBuf) + " " + Go.string(_err) + "}";
	}
...
@:structInit class T_userTypeInfo {
	...
	public function new(?_user:stdgo.reflect.Reflect.Type, ?_base:stdgo.reflect.Reflect.Type, ?_indir:GoInt, ?_externalEnc:GoInt, ?_externalDec:GoInt,
			?_encIndir:GoInt8, ?_decIndir:GoInt8)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_user) + " " + Go.string(_base) + " " + Go.string(_indir) + " " + Go.string(_externalEnc) + " " + Go.string(_externalDec)
			+ " " + Go.string(_encIndir) + " " + Go.string(_decIndir) + "}";
	}
...
@:structInit class T_arrayType {
	public function _string():GoString {
		...
		return _a.value._safeString(new GoMap<T_typeId,
			Bool>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId", [],
				stdgo.reflect.Reflect.GoType.basic(int32_kind)),
	...
	public function _id():T_typeId
		return commonType._id();

	public function _name():GoString
		return commonType._name();

	public function _setId(_id:T_typeId)
		commonType._setId(_0);
...
@:structInit class T_mapType {
	public function _string():GoString {
		...
		return _m.value._safeString(new GoMap<T_typeId,
			Bool>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId", [],
				stdgo.reflect.Reflect.GoType.basic(int32_kind)),
			stdgo.reflect.Reflect.GoType.basic(bool_kind)))));
	}
...
@:structInit class T_sliceType {
	public function _string():GoString {
		...
		return _s.value._safeString(new GoMap<T_typeId,
			Bool>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId", [],
				stdgo.reflect.Reflect.GoType.basic(int32_kind)),
			stdgo.reflect.Reflect.GoType.basic(bool_kind)))));
	}
...
@:structInit class T_structType {
	...
	public function _safeString(_seen:GoMap<T_typeId, Bool>):GoString {
		...
		{
			var __tmp__ = _seen.exists(_s.value.commonType.id) ? {value: _seen[_s.value.commonType.id], ok: true} : {value: _seen.defaultValue(), ok: false},
				_:Bool = __tmp__.value,
				_ok:Bool = __tmp__.ok;
			if (_ok) {
				return _s.value.commonType.name;
			};
	...
	public function new(?commonType:CommonType, ?field:Slice<Pointer<T_fieldType>>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_wireType {
	...
	public function new(?arrayT:Pointer<T_arrayType>, ?sliceT:Pointer<T_sliceType>, ?structT:Pointer<T_structType>, ?mapT:Pointer<T_mapType>,
			?gobEncoderT:Pointer<T_gobEncoderType>, ?binaryMarshalerT:Pointer<T_gobEncoderType>, ?textMarshalerT:Pointer<T_gobEncoderType>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(arrayT) + " " + Go.string(sliceT) + " " + Go.string(structT) + " " + Go.string(mapT) + " " + Go.string(gobEncoderT) + " "
			+ Go.string(binaryMarshalerT) + " " + Go.string(textMarshalerT) + "}";
	}
...
@:structInit class T_typeInfo {
	...
	public function new(?_id:T_typeId, ?_encInit:stdgo.sync.Sync.Mutex, ?_encoder:stdgo.sync.atomic.Atomic.Value, ?_wire:Pointer<T_wireType>)
		stdgo.internal.Macro.initLocals();
...
var _tReserved1:T_typeId = _bootstrapType("_reserved1", Go.toInterface(((new Pointer<T__struct_49>().nil() : Pointer<T__struct_49>))),
	new T_typeId(((15 : GoInt32))));
...
var _encBufferPool:stdgo.sync.Sync.Pool = (({
...
var _tReserved2:T_typeId = _bootstrapType("_reserved1", Go.toInterface(((new Pointer<T__struct_48>().nil() : Pointer<T__struct_48>))),
	new T_typeId(((14 : GoInt32))));

final _firstUserId:GoInt64 = ((64 : GoUnTypedInt));

var _binaryUnmarshalerInterfaceType:stdgo.reflect.Reflect.Type = stdgo.reflect.Reflect.typeOf(Go.toInterface(((new Pointer<stdgo.encoding.Encoding.BinaryUnmarshaler>()
	.nil() : Pointer<stdgo.encoding.Encoding.BinaryUnmarshaler>))))
	.elem();

var _errBadType:stdgo.Error = stdgo.errors.Errors.new_("gob: unknown type id or corrupted data");

var _binaryMarshalerInterfaceType:stdgo.reflect.Reflect.Type = stdgo.reflect.Reflect.typeOf(Go.toInterface(((new Pointer<stdgo.encoding.Encoding.BinaryMarshaler>()
	.nil() : Pointer<stdgo.encoding.Encoding.BinaryMarshaler>))))
	.elem();

var _concreteTypeToName:stdgo.sync.Sync.Map_ = new stdgo.sync.Sync.Map_();

var _tReserved3:T_typeId = _bootstrapType("_reserved1", Go.toInterface(((new Pointer<T__struct_47>().nil() : Pointer<T__struct_47>))),
	new T_typeId(((13 : GoInt32))));
...
var _tReserved4:T_typeId = _bootstrapType("_reserved1", Go.toInterface(((new Pointer<T__struct_46>().nil() : Pointer<T__struct_46>))),
	new T_typeId(((12 : GoInt32))));
...
var _tReserved5:T_typeId = _bootstrapType("_reserved1", Go.toInterface(((new Pointer<T__struct_45>().nil() : Pointer<T__struct_45>))),
	new T_typeId(((11 : GoInt32))));
...
var _gobDecoderInterfaceType:stdgo.reflect.Reflect.Type = stdgo.reflect.Reflect.typeOf(Go.toInterface(((new Pointer<GobDecoder>()
	.nil() : Pointer<GobDecoder>))))
	.elem();

final _xText = ((1 : GoUnTypedInt)) + (2 : GoUnTypedInt);
var _errBadCount:stdgo.Error = stdgo.errors.Errors.new_("invalid message length");

var _decArrayHelper:GoMap<stdgo.reflect.Reflect.Kind, T_decHelper> = new GoMap<stdgo.reflect.Reflect.Kind,
	T_decHelper>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("reflect.Kind", [],
		stdgo.reflect.Reflect.GoType.basic(uint_kind)),
	stdgo.reflect.Reflect.GoType.named("encoding/gob.decHelper", [],
		stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType)))),
	{
		key: stdgo.reflect.Reflect.bool,
		value: new T_decHelper(_decBoolArray)
	},
	...
	{key: stdgo.reflect.Reflect.float64, value: new T_decHelper(_decFloat64Array)}, {key: stdgo.reflect.Reflect.int, value: new T_decHelper(_decIntArray)},
	{key: stdgo.reflect.Reflect.int16, value: new T_decHelper(_decInt16Array)}, {key: stdgo.reflect.Reflect.int32, value: new T_decHelper(_decInt32Array)},
	{key: stdgo.reflect.Reflect.int64, value: new T_decHelper(_decInt64Array)}, {key: stdgo.reflect.Reflect.int8, value: new T_decHelper(_decInt8Array)},
	{key: stdgo.reflect.Reflect.toString, value: new T_decHelper(_decStringArray)}, {key: stdgo.reflect.Reflect.uint, value: new T_decHelper(_decUintArray)},
...
var _tReserved6:T_typeId = _bootstrapType("_reserved1", Go.toInterface(((new Pointer<T__struct_44>().nil() : Pointer<T__struct_44>))),
	new T_typeId(((10 : GoInt32))));

var _nameToConcreteType:stdgo.sync.Sync.Map_ = new stdgo.sync.Sync.Map_();

var _tReserved7:T_typeId = _bootstrapType("_reserved1", Go.toInterface(((new Pointer<T__struct_43>().nil() : Pointer<T__struct_43>))),
	new T_typeId(((9 : GoInt32))));

var _userTypeCache:stdgo.sync.Sync.Map_ = new stdgo.sync.Sync.Map_();

var _types:GoMap<stdgo.reflect.Reflect.Type, T_gobType> = new GoMap<stdgo.reflect.Reflect.Type,
	T_gobType>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("reflect.Type", [],
		stdgo.reflect.Reflect.GoType.interfaceType(false, [])),
	stdgo.reflect.Reflect.GoType.named("encoding/gob.gobType", [],
		stdgo.reflect.Reflect.GoType.named("encoding/gob.gobType", [], stdgo.reflect.Reflect.GoType.interfaceType(false, []))))));
...
var _tComplex:T_typeId = _bootstrapType("complex", Go.toInterface(((new Pointer<GoComplex128>().nil() : Pointer<GoComplex128>))),
	new T_typeId(((7 : GoInt32))));
...
var _tBytes:T_typeId = _bootstrapType("bytes", Go.toInterface(((new Pointer<Slice<GoUInt8>>().nil() : Pointer<Slice<GoByte>>))),
	new T_typeId(((5 : GoInt32))));

var _textMarshalerInterfaceType:stdgo.reflect.Reflect.Type = stdgo.reflect.Reflect.typeOf(Go.toInterface(((new Pointer<stdgo.encoding.Encoding.TextMarshaler>()
	.nil() : Pointer<stdgo.encoding.Encoding.TextMarshaler>))))
	.elem();

var _encArrayHelper:GoMap<stdgo.reflect.Reflect.Kind, T_encHelper> = new GoMap<stdgo.reflect.Reflect.Kind,
	T_encHelper>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("reflect.Kind", [],
		stdgo.reflect.Reflect.GoType.basic(uint_kind)),
	stdgo.reflect.Reflect.GoType.named("encoding/gob.encHelper", [],
		stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType)))),
	{
		key: stdgo.reflect.Reflect.bool,
		value: new T_encHelper(_encBoolArray)
	},
	...
	{key: stdgo.reflect.Reflect.float64, value: new T_encHelper(_encFloat64Array)}, {key: stdgo.reflect.Reflect.int, value: new T_encHelper(_encIntArray)},
	{key: stdgo.reflect.Reflect.int16, value: new T_encHelper(_encInt16Array)}, {key: stdgo.reflect.Reflect.int32, value: new T_encHelper(_encInt32Array)},
	{key: stdgo.reflect.Reflect.int64, value: new T_encHelper(_encInt64Array)}, {key: stdgo.reflect.Reflect.int8, value: new T_encHelper(_encInt8Array)},
	{key: stdgo.reflect.Reflect.toString, value: new T_encHelper(_encStringArray)}, {key: stdgo.reflect.Reflect.uint, value: new T_encHelper(_encUintArray)},
...
var _encSliceHelper:GoMap<stdgo.reflect.Reflect.Kind, T_encHelper> = new GoMap<stdgo.reflect.Reflect.Kind,
	T_encHelper>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("reflect.Kind", [],
		stdgo.reflect.Reflect.GoType.basic(uint_kind)),
	stdgo.reflect.Reflect.GoType.named("encoding/gob.encHelper", [],
		stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType)))),
	{
		key: stdgo.reflect.Reflect.bool,
		value: new T_encHelper(_encBoolSlice)
	},
	...
	{key: stdgo.reflect.Reflect.float64, value: new T_encHelper(_encFloat64Slice)}, {key: stdgo.reflect.Reflect.int, value: new T_encHelper(_encIntSlice)},
	{key: stdgo.reflect.Reflect.int16, value: new T_encHelper(_encInt16Slice)}, {key: stdgo.reflect.Reflect.int32, value: new T_encHelper(_encInt32Slice)},
	{key: stdgo.reflect.Reflect.int64, value: new T_encHelper(_encInt64Slice)}, {key: stdgo.reflect.Reflect.int8, value: new T_encHelper(_encInt8Slice)},
	{key: stdgo.reflect.Reflect.toString, value: new T_encHelper(_encStringSlice)}, {key: stdgo.reflect.Reflect.uint, value: new T_encHelper(_encUintSlice)},
...
var _textUnmarshalerInterfaceType:stdgo.reflect.Reflect.Type = stdgo.reflect.Reflect.typeOf(Go.toInterface(((new Pointer<stdgo.encoding.Encoding.TextUnmarshaler>()
	.nil() : Pointer<stdgo.encoding.Encoding.TextUnmarshaler>))))
	.elem();

var _errRange:stdgo.Error = stdgo.errors.Errors.new_("gob: bad data: field numbers out of bounds");

var _gobEncoderInterfaceType:stdgo.reflect.Reflect.Type = stdgo.reflect.Reflect.typeOf(Go.toInterface(((new Pointer<GobEncoder>()
	.nil() : Pointer<GobEncoder>))))
	.elem();

var _builtinIdToType:GoMap<T_typeId, T_gobType> = new GoMap<T_typeId,
	T_gobType>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId", [],
		stdgo.reflect.Reflect.GoType.basic(int32_kind)),
	stdgo.reflect.Reflect.GoType.named("encoding/gob.gobType", [],
		stdgo.reflect.Reflect.GoType.named("encoding/gob.gobType", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])))))).nil();

var _idToType:GoMap<T_typeId, T_gobType> = new GoMap<T_typeId,
	T_gobType>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId", [],
		stdgo.reflect.Reflect.GoType.basic(int32_kind)),
	stdgo.reflect.Reflect.GoType.named("encoding/gob.gobType", [],
		stdgo.reflect.Reflect.GoType.named("encoding/gob.gobType", [], stdgo.reflect.Reflect.GoType.interfaceType(false, []))))));

var _decIgnoreOpMap:GoMap<T_typeId, T_decOp> = new GoMap<T_typeId,
	T_decOp>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId", [],
		stdgo.reflect.Reflect.GoType.basic(int32_kind)),
	stdgo.reflect.Reflect.GoType.named("encoding/gob.decOp", [],
		stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType)))),
	{
		key: _tBool,
		value: new T_decOp(_ignoreUint)
	},
	{key: _tInt, value: new T_decOp(_ignoreUint)}, {key: _tUint, value: new T_decOp(_ignoreUint)}, {key: _tFloat, value: new T_decOp(_ignoreUint)},
	{key: _tBytes, value: new T_decOp(_ignoreUint8Array)}, {key: _tString, value: new T_decOp(_ignoreUint8Array)},
	{key: _tComplex, value: new T_decOp(_ignoreTwoUints)});
...
var _tInterface:T_typeId = _bootstrapType("interface", Go.toInterface(((new Pointer<AnyInterface>().nil() : Pointer<AnyInterface>))),
	new T_typeId(((8 : GoInt32))));

var _nextId:T_typeId = new T_typeId();

var _decSliceHelper:GoMap<stdgo.reflect.Reflect.Kind, T_decHelper> = new GoMap<stdgo.reflect.Reflect.Kind,
	T_decHelper>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("reflect.Kind", [],
		stdgo.reflect.Reflect.GoType.basic(uint_kind)),
	stdgo.reflect.Reflect.GoType.named("encoding/gob.decHelper", [],
		stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType)))),
	{
		key: stdgo.reflect.Reflect.bool,
		value: new T_decHelper(_decBoolSlice)
	},
	...
	{key: stdgo.reflect.Reflect.float64, value: new T_decHelper(_decFloat64Slice)}, {key: stdgo.reflect.Reflect.int, value: new T_decHelper(_decIntSlice)},
	{key: stdgo.reflect.Reflect.int16, value: new T_decHelper(_decInt16Slice)}, {key: stdgo.reflect.Reflect.int32, value: new T_decHelper(_decInt32Slice)},
	{key: stdgo.reflect.Reflect.int64, value: new T_decHelper(_decInt64Slice)}, {key: stdgo.reflect.Reflect.int8, value: new T_decHelper(_decInt8Slice)},
	{key: stdgo.reflect.Reflect.toString, value: new T_decHelper(_decStringSlice)}, {key: stdgo.reflect.Reflect.uint, value: new T_decHelper(_decUintSlice)},
...
function _decIntSlice(_state:Pointer<T_decoderState>, _v:stdgo.reflect.Reflect.Value, _length:GoInt, _ovfl:Error):Bool {
	...
	};
	{
		...
		Go.cfor(_i < _length, _i++, {
			...
			if (_x < -1 ^ (((-1 ^ ((((0 : GoUInt)) : GoUInt)) >> ((1 : GoUnTypedInt))) : GoInt64))
				|| (((-1 ^ ((((0 : GoUInt)) : GoUInt)) >> ((1 : GoUnTypedInt))) : GoInt64)) < _x) {
				_error_(_ovfl);
			};
			_slice[_i] = ((_x : GoInt));
		});
...
function _decodeUintReader(_r:stdgo.io.Io.Reader, _buf:Slice<GoByte>):{var _0:GoUInt64; var _1:GoInt; var _2:Error;} {
	var _x:GoUInt64 = ((0 : GoUInt64)),
		_width:GoInt = ((0 : GoInt)),
		_err:Error = ((null : stdgo.Error));
	_width = ((1 : GoInt));
	var __tmp__ = stdgo.io.Io.readFull(_r, _buf.__slice__(((0 : GoInt)), _width)),
		_n:GoInt = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_n == ((0 : GoInt))) {
...
function _decUint8Slice(_i:Pointer<T_decInstr>, _state:Pointer<T_decoderState>, _value:stdgo.reflect.Reflect.Value):Void {
	...
	{
		var __tmp__ = _state.value._b.value.read(_value.bytes()),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
...
**/
function _decodeIntoValue(_state:Pointer<T_decoderState>, _op:T_decOp, _isPtr:Bool, _value:stdgo.reflect.Reflect.Value,
		_instr:Pointer<T_decInstr>):stdgo.reflect.Reflect.Value {
...
function newDecoder(_r:stdgo.io.Io.Reader):Pointer<Decoder> {
	...
	_dec.value._r = _r;
	_dec.value._wireType = new GoMap<T_typeId,
		Pointer<T_wireType>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId", [],
			stdgo.reflect.Reflect.GoType.basic(int32_kind)),
		stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.wireType", [],
			stdgo.reflect.Reflect.GoType.named("encoding/gob.wireType", [], stdgo.reflect.Reflect.GoType.structType([
				{
					name: "arrayT",
					embedded: false,
	...
	_dec.value._decoderCache = new GoMap<stdgo.reflect.Reflect.Type,
		GoMap<T_typeId,
			Pointer<Pointer<T_decEngine>>>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("reflect.Type",
			[], stdgo.reflect.Reflect.GoType.interfaceType(false, [])),
			stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId", [], stdgo.reflect.Reflect.GoType.basic(int32_kind)),
				stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.decEngine", [],
					stdgo.reflect.Reflect.GoType.named("encoding/gob.decEngine", [], stdgo.reflect.Reflect.GoType.structType([
						{
							name: "_instr",
	...
	_dec.value._ignorerCache = new GoMap<T_typeId,
		Pointer<Pointer<T_decEngine>>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId",
			[], stdgo.reflect.Reflect.GoType.basic(int32_kind)),
		stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.decEngine", [],
			stdgo.reflect.Reflect.GoType.named("encoding/gob.decEngine", [], stdgo.reflect.Reflect.GoType.structType([
...
function _isZero(_val:stdgo.reflect.Reflect.Value):Bool {
	if (_val.kind().__t__ == stdgo.reflect.Reflect.array.__t__) {
		...
		return true;
	} else if (_val.kind().__t__ == stdgo.reflect.Reflect.map.__t__
		|| _val.kind().__t__ == stdgo.reflect.Reflect.slice.__t__
		|| _val.kind().__t__ == stdgo.reflect.Reflect.toString.__t__) {
	...
	} else if (_val.kind().__t__ == stdgo.reflect.Reflect.chan.__t__
		|| _val.kind().__t__ == stdgo.reflect.Reflect.func.__t__
		|| _val.kind().__t__ == stdgo.reflect.Reflect.interface_.__t__
		|| _val.kind().__t__ == stdgo.reflect.Reflect.ptr.__t__) {
		return _val.isNil();
	} else if (_val.kind().__t__ == stdgo.reflect.Reflect.int.__t__
		|| _val.kind().__t__ == stdgo.reflect.Reflect.int8.__t__
		|| _val.kind().__t__ == stdgo.reflect.Reflect.int16.__t__
	...
	} else if (_val.kind().__t__ == stdgo.reflect.Reflect.uint.__t__
		|| _val.kind().__t__ == stdgo.reflect.Reflect.uint8.__t__
		|| _val.kind().__t__ == stdgo.reflect.Reflect.uint16.__t__
		|| _val.kind().__t__ == stdgo.reflect.Reflect.uint32.__t__
		|| _val.kind().__t__ == stdgo.reflect.Reflect.uint64.__t__
		|| _val.kind().__t__ == stdgo.reflect.Reflect.uintptr.__t__) {
...
**/
function _encOpFor(_rt:stdgo.reflect.Reflect.Type, _inProgress:GoMap<stdgo.reflect.Reflect.Type, Pointer<T_encOp>>,
		_building:GoMap<Pointer<T_typeInfo>, Bool>):{var _0:Pointer<T_encOp>; var _1:GoInt;
} {
	var _ut:Pointer<T_userTypeInfo> = _userType(_rt);
	if (_ut.value._externalEnc != ((0 : GoInt))) {
			...
			var _t:stdgo.reflect.Reflect.Type = _typ;
			{
				...
				while (true) {
					if (_t.kind().__t__ == stdgo.reflect.Reflect.slice.__t__) {
						...
						var __tmp__ = _encOpFor(_t.elem(), _inProgress, _building),
							_elemOp:Pointer<T_encOp> = __tmp__._0,
							_elemIndir:GoInt = __tmp__._1;
						...
						_op = new T_encOp(function(_i:Pointer<T_encInstr>, _state:Pointer<T_encoderState>, _slice:stdgo.reflect.Reflect.Value):Void {
							...
							_state.value._update(_i);
							_state.value._enc.value._encodeArray(_state.value._b, _slice.__copy__(), _elemOp.value.__copy__(), _elemIndir, _slice.len(),
								_helper.__copy__());
						});
						break;
					} else if (_t.kind().__t__ == stdgo.reflect.Reflect.array.__t__) {
						...
						_op = new T_encOp(function(_i:Pointer<T_encInstr>, _state:Pointer<T_encoderState>, _array:stdgo.reflect.Reflect.Value):Void {
							_state.value._update(_i);
							_state.value._enc.value._encodeArray(_state.value._b, _array.__copy__(), _elemOp.value.__copy__(), _elemIndir, _array.len(),
								_helper.__copy__());
						});
						break;
					} else if (_t.kind().__t__ == stdgo.reflect.Reflect.map.__t__) {
						var __tmp__ = _encOpFor(_t.key(), _inProgress, _building),
							_keyOp:Pointer<T_encOp> = __tmp__._0,
							_keyIndir:GoInt = __tmp__._1;
						var __tmp__ = _encOpFor(_t.elem(), _inProgress, _building),
							_elemOp:Pointer<T_encOp> = __tmp__._0,
							_elemIndir:GoInt = __tmp__._1;
						_op = new T_encOp(function(_i:Pointer<T_encInstr>, _state:Pointer<T_encoderState>, _mv:stdgo.reflect.Reflect.Value):Void {
							...
							_state.value._update(_i);
							_state.value._enc.value._encodeMap(_state.value._b, _mv.__copy__(), _keyOp.value.__copy__(), _elemOp.value.__copy__(), _keyIndir,
								_elemIndir);
						});
						break;
					} else if (_t.kind().__t__ == stdgo.reflect.Reflect.struct.__t__) {
...
function _compileEnc(_ut:Pointer<T_userTypeInfo>, _building:GoMap<Pointer<T_typeInfo>, Bool>):Pointer<T_encEngine> {
	...
	var _seen:GoMap<stdgo.reflect.Reflect.Type, Pointer<T_encOp>> = new GoMap<stdgo.reflect.Reflect.Type,
		Pointer<T_encOp>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("reflect.Type", [],
			stdgo.reflect.Reflect.GoType.interfaceType(false, [])),
		stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.encOp", [],
			stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType))))));
	var _rt:stdgo.reflect.Reflect.Type = _ut.value._base;
	if (_ut.value._externalEnc != ((0 : GoInt))) {
		_rt = _ut.value._user;
	...
	if (_ut.value._externalEnc == ((0 : GoInt)) && _srt.kind().__t__ == stdgo.reflect.Reflect.struct.__t__) {
		{
			...
			Go.cfor(_fieldNum < _srt.numField(), _fieldNum++, {
				...
				var __tmp__ = _encOpFor(_f.type, _seen, _building),
					_op:Pointer<T_encOp> = __tmp__._0,
					_indir:GoInt = __tmp__._1;
		...
		_engine.value._instr = _engine.value._instr.__append__(new T_encInstr(new T_encOp(_encStructTerminator), ((0 : GoInt)), new Slice<GoInt>().nil(),
			((0 : GoInt))).__copy__());
	} else {
		_engine.value._instr = new Slice<T_encInstr>(...[for (i in 0...((((1 : GoInt)) : GoInt)).toBasic()) new T_encInstr()]);
		var __tmp__ = _encOpFor(_rt, _seen, _building),
			_op:Pointer<T_encOp> = __tmp__._0,
			_indir:GoInt = __tmp__._1;
	...
	try {
		...
		if (!_ok) {
			if (_building == null || _building.isNil()) {
				_building = new GoMap<Pointer<T_typeInfo>,
					Bool>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.typeInfo",
						[], stdgo.reflect.Reflect.GoType.named("encoding/gob.typeInfo", [], stdgo.reflect.Reflect.GoType.structType([
					{
						name: "_id",
...
function newEncoder(_w:stdgo.io.Io.Writer):Pointer<Encoder> {
	...
	_enc.value._sent = new GoMap<stdgo.reflect.Reflect.Type,
		T_typeId>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("reflect.Type", [],
			stdgo.reflect.Reflect.GoType.interfaceType(false, [])),
		stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId", [], stdgo.reflect.Reflect.GoType.basic(int32_kind)))));
...
function _validUserType(_rt:stdgo.reflect.Reflect.Type):{var _0:Pointer<T_userTypeInfo>; var _1:Error;} {
	{
		var __tmp__ = _userTypeCache.load(Go.toInterface(_rt)),
			_ui:AnyInterface = __tmp__._0,
			_ok:Bool = __tmp__._1;
		if (_ok) {
	...
	while (true) {
		...
		if (_ut.value._base.toString() == _slowpoke.toString()) {
			return {_0: new Pointer<T_userTypeInfo>().nil(), _1: stdgo.errors.Errors.new_((("can\'t represent recursive pointer type " : GoString))
				+ _ut.value._base.toString())};
		};
	...
	{
		var __tmp__ = _implementsInterface(_ut.value._user, _gobEncoderInterfaceType),
			_ok:Bool = __tmp__._0,
			_indir:GoInt8 = __tmp__._1;
		if (_ok) {
			{
			...
			var __tmp__ = _implementsInterface(_ut.value._user, _binaryMarshalerInterfaceType),
				_ok:Bool = __tmp__._0,
				_indir:GoInt8 = __tmp__._1;
			if (_ok) {
				{
	...
	{
		var __tmp__ = _implementsInterface(_ut.value._user, _gobDecoderInterfaceType),
			_ok:Bool = __tmp__._0,
			_indir:GoInt8 = __tmp__._1;
		if (_ok) {
			{
			...
			var __tmp__ = _implementsInterface(_ut.value._user, _binaryUnmarshalerInterfaceType),
				_ok:Bool = __tmp__._0,
				_indir:GoInt8 = __tmp__._1;
			if (_ok) {
				{
	...
	var __tmp__ = _userTypeCache.loadOrStore(Go.toInterface(_rt), Go.toInterface(_ut)),
		_ui:AnyInterface = __tmp__._0,
		_:Bool = __tmp__._1;
	return {_0: ((_ui.value : Pointer<T_userTypeInfo>)), _1: ((null : stdgo.Error))};
}
...
function _userType(_rt:stdgo.reflect.Reflect.Type):Pointer<T_userTypeInfo> {
	var __tmp__ = _validUserType(_rt),
		_ut:Pointer<T_userTypeInfo> = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
		_error_(_err);
...
function _newArrayType(_name:GoString):Pointer<T_arrayType> {
	var _a:Pointer<T_arrayType> = Go.pointer(new T_arrayType((({name: _name, id: new T_typeId()} : CommonType)).__copy__(), new T_typeId(((0 : GoInt32))),
		((0 : GoInt))));
	return _a;
}
...
function _newMapType(_name:GoString):Pointer<T_mapType> {
	var _m:Pointer<T_mapType> = Go.pointer(new T_mapType((({name: _name, id: new T_typeId()} : CommonType)).__copy__(), new T_typeId(((0 : GoInt32))),
		new T_typeId(((0 : GoInt32)))));
	return _m;
}
...
function _newStructType(_name:GoString):Pointer<T_structType> {
	var _s:Pointer<T_structType> = Go.pointer(new T_structType((({name: _name, id: new T_typeId()} : CommonType)).__copy__(),
		new Slice<Pointer<T_fieldType>>().nil()));
	_setTypeId(_s.value);
	return _s;
}
...
function _newTypeObject(_name:GoString, _ut:Pointer<T_userTypeInfo>, _rt:stdgo.reflect.Reflect.Type):{var _0:T_gobType; var _1:Error;} {
	...
	var _err:Error = ((null : stdgo.Error));
	try {
		var _type0:T_gobType = ((null : T_gobType)),
			_type1:T_gobType = ((null : T_gobType));
		{
			deferstack.unshift(() -> {
				var a = function():Void {
					if (_err != null) {
			...
			if (_t.kind().__t__ == stdgo.reflect.Reflect.bool.__t__) {
				...
				_idToType[_st.value._id()] = _st.value;
				{
					...
					Go.cfor(_i < _t.numField(), _i++, {
						...
						var __tmp__ = _getBaseType(_tname, _f.type),
							_gt:T_gobType = __tmp__._0,
							_err:stdgo.Error = __tmp__._1;
						if (_err != null) {
							{
								for (defer in deferstack) {
...
function _getType(_name:GoString, _ut:Pointer<T_userTypeInfo>, _rt:stdgo.reflect.Reflect.Type):{var _0:T_gobType; var _1:Error;} {
	var __tmp__ = _types.exists(_rt) ? {value: _types[_rt], ok: true} : {value: _types.defaultValue(), ok: false},
		_typ:T_gobType = __tmp__.value,
		_present:Bool = __tmp__.ok;
	if (_present) {
		return {_0: _typ, _1: ((null : stdgo.Error))};
	};
	var __tmp__ = _newTypeObject(_name, _ut, _rt),
		_typ:T_gobType = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err == null) {
		_types[_rt] = _typ;
	};
...
function _checkId(_want:T_typeId, _got:T_typeId):Void {
	if (_want.__t__ != _got.__t__) {
		...
		throw(("bootstrap type wrong id: " : GoString))
			+ _got._name()
			+ ((" " : GoString))
			+ _got._string()
			+ ((" not " : GoString))
...
function _lookupTypeInfo(_rt:stdgo.reflect.Reflect.Type):Pointer<T_typeInfo> {
	var __tmp__ = try {
		...
		{value: new GoMap<stdgo.reflect.Reflect.Type,
			Pointer<T_typeInfo>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("reflect.Type", [],
				stdgo.reflect.Reflect.GoType.interfaceType(false, [])),
			stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.typeInfo", [],
				stdgo.reflect.Reflect.GoType.named("encoding/gob.typeInfo", [], stdgo.reflect.Reflect.GoType.structType([
					{
						name: "_id",
						embedded: false,
...
function _buildTypeInfo(_ut:Pointer<T_userTypeInfo>, _rt:stdgo.reflect.Reflect.Type):{var _0:Pointer<T_typeInfo>; var _1:Error;} {
	...
	try {
		...
		var __tmp__ = _getBaseType(_rt.name(), _rt),
			_gt:T_gobType = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			{
		...
		var _info:Pointer<T_typeInfo> = Go.pointer((({
			_id: _gt._id(),
			_encInit: new stdgo.sync.Sync.Mutex(),
			_encoder: new stdgo.sync.atomic.Atomic.Value(),
			_wire: new Pointer<T_wireType>().nil()
		} : T_typeInfo)));
		if (_ut.value._externalEnc != ((0 : GoInt))) {
			var __tmp__ = _getType(_rt.name(), _ut, _rt),
				_userType:T_gobType = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				{
					for (defer in deferstack) {
			...
			if (_ut.value._externalEnc == _xGob) {
				_info.value._wire = Go.pointer((({
					gobEncoderT: _gt,
					arrayT: new Pointer<T_arrayType>().nil(),
					sliceT: new Pointer<T_sliceType>().nil(),
					structT: new Pointer<T_structType>().nil(),
					mapT: new Pointer<T_mapType>().nil(),
					binaryMarshalerT: new Pointer<T_gobEncoderType>().nil(),
					textMarshalerT: new Pointer<T_gobEncoderType>().nil()
				} : T_wireType)));
			} else if (_ut.value._externalEnc == _xBinary) {
				_info.value._wire = Go.pointer((({
					binaryMarshalerT: _gt,
					arrayT: new Pointer<T_arrayType>().nil(),
					sliceT: new Pointer<T_sliceType>().nil(),
					structT: new Pointer<T_structType>().nil(),
					mapT: new Pointer<T_mapType>().nil(),
					gobEncoderT: new Pointer<T_gobEncoderType>().nil(),
					textMarshalerT: new Pointer<T_gobEncoderType>().nil()
				} : T_wireType)));
			} else if (_ut.value._externalEnc == _xText) {
				_info.value._wire = Go.pointer((({
			...
			var _t:T_gobType = _info.value._id._gobType();
			{
				...
				if (_typ.kind().__t__ == stdgo.reflect.Reflect.array.__t__) {
					_info.value._wire = Go.pointer((({
						arrayT: ((_t.__underlying__().value : T_arrayType)),
						sliceT: new Pointer<T_sliceType>().nil(),
						structT: new Pointer<T_structType>().nil(),
						mapT: new Pointer<T_mapType>().nil(),
						gobEncoderT: new Pointer<T_gobEncoderType>().nil(),
					...
					_info.value._wire = Go.pointer((({
						mapT: ((_t.__underlying__().value : T_mapType)),
						arrayT: new Pointer<T_arrayType>().nil(),
						sliceT: new Pointer<T_sliceType>().nil(),
						structT: new Pointer<T_structType>().nil(),
						gobEncoderT: new Pointer<T_gobEncoderType>().nil(),
					...
					if (_typ.elem().kind().__t__ != stdgo.reflect.Reflect.uint8.__t__) {
						_info.value._wire = Go.pointer((({
							sliceT: ((_t.__underlying__().value : T_sliceType)),
							arrayT: new Pointer<T_arrayType>().nil(),
							structT: new Pointer<T_structType>().nil(),
							mapT: new Pointer<T_mapType>().nil(),
							gobEncoderT: new Pointer<T_gobEncoderType>().nil(),
					...
					_info.value._wire = Go.pointer((({
						structT: ((_t.__underlying__().value : T_structType)),
						arrayT: new Pointer<T_arrayType>().nil(),
						sliceT: new Pointer<T_sliceType>().nil(),
						mapT: new Pointer<T_mapType>().nil(),
						gobEncoderT: new Pointer<T_gobEncoderType>().nil(),
		...
		var _newm:GoMap<stdgo.reflect.Reflect.Type, Pointer<T_typeInfo>> = new GoMap<stdgo.reflect.Reflect.Type,
			Pointer<T_typeInfo>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("reflect.Type", [],
				stdgo.reflect.Reflect.GoType.interfaceType(false, [])),
			stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/gob.typeInfo", [],
				stdgo.reflect.Reflect.GoType.named("encoding/gob.typeInfo", [], stdgo.reflect.Reflect.GoType.structType([
											...
											stdgo.reflect.Reflect.GoType.named("encoding/gob.arrayType", [], stdgo.reflect.Reflect.GoType.structType([
												{
													...
													tag: "",
													type: stdgo.reflect.Reflect.GoType.named("encoding/gob.CommonType", [],
														stdgo.reflect.Reflect.GoType.named("encoding/gob.CommonType", [],
															stdgo.reflect.Reflect.GoType.structType([
																{
																	name: "name",
																	embedded: false,
...
function _mustGetTypeInfo(_rt:stdgo.reflect.Reflect.Type):Pointer<T_typeInfo> {
	var __tmp__ = _getTypeInfo(_userType(_rt)),
		_t:Pointer<T_typeInfo> = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
...
function registerName(_name:GoString, _value:AnyInterface):Void {
	...
	{
		var __tmp__ = _nameToConcreteType.loadOrStore(Go.toInterface(_name), Go.toInterface(stdgo.reflect.Reflect.typeOf(Go.toInterface(_value)))),
			_t:AnyInterface = __tmp__._0,
			_dup:Bool = __tmp__._1;
		if (_dup && Go.toInterface(_t) != Go.toInterface(_ut.value._user)) {
			throw stdgo.fmt.Fmt.sprintf("gob: registering duplicate types for %q: %s != %s", Go.toInterface(_name), Go.toInterface(_t),
				Go.toInterface(_ut.value._user));
		};
	};
	{
		var __tmp__ = _concreteTypeToName.loadOrStore(Go.toInterface(_ut.value._base), Go.toInterface(_name)),
			_n:AnyInterface = __tmp__._0,
			_dup:Bool = __tmp__._1;
		if (_dup && Go.toInterface(_n) != Go.toInterface(_name)) {
			_nameToConcreteType.delete(Go.toInterface(_name));
			throw stdgo.fmt.Fmt.sprintf("gob: registering duplicate names for %s: %q != %q", Go.toInterface(_ut.value._user), Go.toInterface(_n),
...
@:keep var _ = {
	try {
		...
		_builtinIdToType = new GoMap<T_typeId,
			T_gobType>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("encoding/gob.typeId", [],
				stdgo.reflect.Reflect.GoType.basic(int32_kind)),
			stdgo.reflect.Reflect.GoType.named("encoding/gob.gobType", [],
				stdgo.reflect.Reflect.GoType.named("encoding/gob.gobType", [], stdgo.reflect.Reflect.GoType.interfaceType(false, []))))));
...
class T_decoderState_extension_fields {
	public function _decodeUint(__tmp__):GoUInt64
		return __tmp__._decodeUint();

	public function _decodeInt(__tmp__):GoInt64
		return __tmp__._decodeInt();

	public function _getLength(__tmp__):{var _0:GoInt; var _1:Bool;}
		return __tmp__._getLength();
}
...
class T_decBuffer_extension_fields {
	...
	public function drop(__tmp__, _n:GoInt):Void
		__tmp__.drop(_n);

	public function size(__tmp__, _n:GoInt):Void
		__tmp__.size(_n);
...
class Decoder_extension_fields {
	public function _newDecoderState(__tmp__, _buf:Pointer<T_decBuffer>):Pointer<T_decoderState>
		return __tmp__._newDecoderState(_buf);

	public function _freeDecoderState(__tmp__, _d:Pointer<T_decoderState>):Void
		__tmp__._freeDecoderState(_d);

	public function _decodeSingle(__tmp__, _engine:Pointer<T_decEngine>, _value:stdgo.reflect.Reflect.Value):Void
		__tmp__._decodeSingle(_engine, _value);

	public function _decodeStruct(__tmp__, _engine:Pointer<T_decEngine>, _value:stdgo.reflect.Reflect.Value):Void
		__tmp__._decodeStruct(_engine, _value);

	public function _ignoreStruct(__tmp__, _engine:Pointer<T_decEngine>):Void
		__tmp__._ignoreStruct(_engine);

	public function _ignoreSingle(__tmp__, _engine:Pointer<T_decEngine>):Void
		__tmp__._ignoreSingle(_engine);

	public function _decodeArrayHelper(__tmp__, _state:Pointer<T_decoderState>, _value:stdgo.reflect.Reflect.Value, _elemOp:T_decOp, _length:GoInt,
			_ovfl:Error, _helper:T_decHelper):Void
		__tmp__._decodeArrayHelper(_state, _value, _elemOp, _length, _ovfl, _helper);

	public function _decodeArray(__tmp__, _state:Pointer<T_decoderState>, _value:stdgo.reflect.Reflect.Value, _elemOp:T_decOp, _length:GoInt, _ovfl:Error,
			_helper:T_decHelper):Void
		__tmp__._decodeArray(_state, _value, _elemOp, _length, _ovfl, _helper);

	public function _decodeMap(__tmp__, _mtyp:stdgo.reflect.Reflect.Type, _state:Pointer<T_decoderState>, _value:stdgo.reflect.Reflect.Value, _keyOp:T_decOp,
			_elemOp:T_decOp, _ovfl:Error):Void
		__tmp__._decodeMap(_mtyp, _state, _value, _keyOp, _elemOp, _ovfl);

	public function _ignoreArrayHelper(__tmp__, _state:Pointer<T_decoderState>, _elemOp:T_decOp, _length:GoInt):Void
		__tmp__._ignoreArrayHelper(_state, _elemOp, _length);

	public function _ignoreArray(__tmp__, _state:Pointer<T_decoderState>, _elemOp:T_decOp, _length:GoInt):Void
		__tmp__._ignoreArray(_state, _elemOp, _length);

	public function _ignoreMap(__tmp__, _state:Pointer<T_decoderState>, _keyOp:T_decOp, _elemOp:T_decOp):Void
		__tmp__._ignoreMap(_state, _keyOp, _elemOp);

	public function _decodeSlice(__tmp__, _state:Pointer<T_decoderState>, _value:stdgo.reflect.Reflect.Value, _elemOp:T_decOp, _ovfl:Error,
			_helper:T_decHelper):Void
		__tmp__._decodeSlice(_state, _value, _elemOp, _ovfl, _helper);

	public function _ignoreSlice(__tmp__, _state:Pointer<T_decoderState>, _elemOp:T_decOp):Void
		__tmp__._ignoreSlice(_state, _elemOp);

	public function _decodeInterface(__tmp__, _ityp:stdgo.reflect.Reflect.Type, _state:Pointer<T_decoderState>, _value:stdgo.reflect.Reflect.Value):Void
		__tmp__._decodeInterface(_ityp, _state, _value);

	public function _ignoreInterface(__tmp__, _state:Pointer<T_decoderState>):Void
		__tmp__._ignoreInterface(_state);

	public function _decodeGobDecoder(__tmp__, _ut:Pointer<T_userTypeInfo>, _state:Pointer<T_decoderState>, _value:stdgo.reflect.Reflect.Value):Void
		__tmp__._decodeGobDecoder(_ut, _state, _value);

	public function _ignoreGobDecoder(__tmp__, _state:Pointer<T_decoderState>):Void
		__tmp__._ignoreGobDecoder(_state);

	public function _decOpFor(__tmp__, _wireId:T_typeId, _rt:stdgo.reflect.Reflect.Type, _name:GoString,
			_inProgress:GoMap<stdgo.reflect.Reflect.Type, Pointer<T_decOp>>):Pointer<T_decOp>
		return __tmp__._decOpFor(_wireId, _rt, _name, _inProgress);

	public function _decIgnoreOpFor(__tmp__, _wireId:T_typeId, _inProgress:GoMap<T_typeId, Pointer<T_decOp>>):Pointer<T_decOp>
		return __tmp__._decIgnoreOpFor(_wireId, _inProgress);

	public function _gobDecodeOpFor(__tmp__, _ut:Pointer<T_userTypeInfo>):Pointer<T_decOp>
		return __tmp__._gobDecodeOpFor(_ut);

	public function _compatibleType(__tmp__, _fr:stdgo.reflect.Reflect.Type, _fw:T_typeId, _inProgress:GoMap<stdgo.reflect.Reflect.Type, T_typeId>):Bool
		return __tmp__._compatibleType(_fr, _fw, _inProgress);

	public function _typeString(__tmp__, _remoteId:T_typeId):GoString
		return __tmp__._typeString(_remoteId);

	public function _compileSingle(__tmp__, _remoteId:T_typeId, _ut:Pointer<T_userTypeInfo>):{var _0:Pointer<T_decEngine>; var _1:Error;}
		return __tmp__._compileSingle(_remoteId, _ut);

	public function _compileIgnoreSingle(__tmp__, _remoteId:T_typeId):Pointer<T_decEngine>
		return __tmp__._compileIgnoreSingle(_remoteId);

	public function _compileDec(__tmp__, _remoteId:T_typeId, _ut:Pointer<T_userTypeInfo>):{var _0:Pointer<T_decEngine>; var _1:Error;}
		return __tmp__._compileDec(_remoteId, _ut);

	public function _getDecEnginePtr(__tmp__, _remoteId:T_typeId, _ut:Pointer<T_userTypeInfo>):{var _0:Pointer<Pointer<T_decEngine>>; var _1:Error;}
		return __tmp__._getDecEnginePtr(_remoteId, _ut);

	public function _getIgnoreEnginePtr(__tmp__, _wireId:T_typeId):{var _0:Pointer<Pointer<T_decEngine>>; var _1:Error;}
		return __tmp__._getIgnoreEnginePtr(_wireId);

	public function _decodeValue(__tmp__, _wireId:T_typeId, _value:stdgo.reflect.Reflect.Value):Void
		__tmp__._decodeValue(_wireId, _value);

	public function _decodeIgnoredValue(__tmp__, _wireId:T_typeId):Void
		__tmp__._decodeIgnoredValue(_wireId);

	public function _recvType(__tmp__, _id:T_typeId):Void
		__tmp__._recvType(_id);

	public function _recvMessage(__tmp__):Bool
		return __tmp__._recvMessage();

	public function _readMessage(__tmp__, _nbytes:GoInt):Void
		__tmp__._readMessage(_nbytes);

	public function _nextInt(__tmp__):GoInt64
		return __tmp__._nextInt();

	public function _nextUint(__tmp__):GoUInt64
		return __tmp__._nextUint();

	public function _decodeTypeSequence(__tmp__, _isInterface:Bool):T_typeId
		return __tmp__._decodeTypeSequence(_isInterface);

	public function decode(__tmp__, _e:AnyInterface):Error
		return __tmp__.decode(_e);

	public function decodeValue(__tmp__, _v:stdgo.reflect.Reflect.Value):Error
		return __tmp__.decodeValue(_v);
}

class T_encoderState_extension_fields {
	public function _encodeUint(__tmp__, _x:GoUInt64):Void
		__tmp__._encodeUint(_x);

	public function _encodeInt(__tmp__, _i:GoInt64):Void
		__tmp__._encodeInt(_i);

	public function _update(__tmp__, _instr:Pointer<T_encInstr>):Void
		__tmp__._update(_instr);
}
...
class T_encBuffer_extension_fields {
	...
	public function writeString(__tmp__, _s:GoString):Void
		__tmp__.writeString(_s);
...
class Encoder_extension_fields {
	public function _newEncoderState(__tmp__, _b:Pointer<T_encBuffer>):Pointer<T_encoderState>
		return __tmp__._newEncoderState(_b);

	public function _freeEncoderState(__tmp__, _e:Pointer<T_encoderState>):Void
		__tmp__._freeEncoderState(_e);

	public function _encodeSingle(__tmp__, _b:Pointer<T_encBuffer>, _engine:Pointer<T_encEngine>, _value:stdgo.reflect.Reflect.Value):Void
		__tmp__._encodeSingle(_b, _engine, _value);

	public function _encodeStruct(__tmp__, _b:Pointer<T_encBuffer>, _engine:Pointer<T_encEngine>, _value:stdgo.reflect.Reflect.Value):Void
		__tmp__._encodeStruct(_b, _engine, _value);

	public function _encodeArray(__tmp__, _b:Pointer<T_encBuffer>, _value:stdgo.reflect.Reflect.Value, _op:T_encOp, _elemIndir:GoInt, _length:GoInt,
			_helper:T_encHelper):Void
		__tmp__._encodeArray(_b, _value, _op, _elemIndir, _length, _helper);

	public function _encodeMap(__tmp__, _b:Pointer<T_encBuffer>, _mv:stdgo.reflect.Reflect.Value, _keyOp:T_encOp, _elemOp:T_encOp, _keyIndir:GoInt,
			_elemIndir:GoInt):Void
		__tmp__._encodeMap(_b, _mv, _keyOp, _elemOp, _keyIndir, _elemIndir);

	public function _encodeInterface(__tmp__, _b:Pointer<T_encBuffer>, _iv:stdgo.reflect.Reflect.Value):Void
		__tmp__._encodeInterface(_b, _iv);

	public function _encodeGobEncoder(__tmp__, _b:Pointer<T_encBuffer>, _ut:Pointer<T_userTypeInfo>, _v:stdgo.reflect.Reflect.Value):Void
		__tmp__._encodeGobEncoder(_b, _ut, _v);

	public function _encode(__tmp__, _b:Pointer<T_encBuffer>, _value:stdgo.reflect.Reflect.Value, _ut:Pointer<T_userTypeInfo>):Void
		__tmp__._encode(_b, _value, _ut);

	public function _writer(__tmp__):stdgo.io.Io.Writer
		return __tmp__._writer();

	public function _pushWriter(__tmp__, _w:stdgo.io.Io.Writer):Void
		__tmp__._pushWriter(_w);

	public function _popWriter(__tmp__):Void
		__tmp__._popWriter();

	public function _setError(__tmp__, _err:Error):Void
		__tmp__._setError(_err);

	public function _writeMessage(__tmp__, _w:stdgo.io.Io.Writer, _b:Pointer<T_encBuffer>):Void
		__tmp__._writeMessage(_w, _b);

	public function _sendActualType(__tmp__, _w:stdgo.io.Io.Writer, _state:Pointer<T_encoderState>, _ut:Pointer<T_userTypeInfo>,
			_actual:stdgo.reflect.Reflect.Type):Bool
		return __tmp__._sendActualType(_w, _state, _ut, _actual);

	public function _sendType(__tmp__, _w:stdgo.io.Io.Writer, _state:Pointer<T_encoderState>, _origt:stdgo.reflect.Reflect.Type):Bool
		return __tmp__._sendType(_w, _state, _origt);

	public function encode(__tmp__, _e:AnyInterface):Error
		return __tmp__.encode(_e);

	public function _sendTypeDescriptor(__tmp__, _w:stdgo.io.Io.Writer, _state:Pointer<T_encoderState>, _ut:Pointer<T_userTypeInfo>):Void
		__tmp__._sendTypeDescriptor(_w, _state, _ut);

	public function _sendTypeId(__tmp__, _state:Pointer<T_encoderState>, _ut:Pointer<T_userTypeInfo>):Void
		__tmp__._sendTypeId(_state, _ut);

	public function encodeValue(__tmp__, _value:stdgo.reflect.Reflect.Value):Error
		return __tmp__.encodeValue(_value);
}

class T_typeId_extension_fields {
	public function _gobType(__tmp__):T_gobType
		return __tmp__._gobType();

	public function _string(__tmp__):GoString
		return __tmp__._string();

	public function _name(__tmp__):GoString
		return __tmp__._name();
}

class CommonType_extension_fields {
	public function _id(__tmp__):T_typeId
		return __tmp__._id();

	public function _setId(__tmp__, _id:T_typeId):Void
		__tmp__._setId(_id);

	public function _string(__tmp__):GoString
		return __tmp__._string();

	public function _safeString(__tmp__, _seen:GoMap<T_typeId, Bool>):GoString
		return __tmp__._safeString(_seen);
...
class T_arrayType_extension_fields {
	public function _init(__tmp__, _elem:T_gobType, _len:GoInt):Void
		__tmp__._init(_elem, _len);
...
class T_mapType_extension_fields {
	public function _init(__tmp__, _key:T_gobType, _elem:T_gobType):Void
		__tmp__._init(_key, _elem);
...
class T_sliceType_extension_fields {
	public function _init(__tmp__, _elem:T_gobType):Void
		__tmp__._init(_elem);
