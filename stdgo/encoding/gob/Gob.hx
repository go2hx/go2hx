...
@:structInit abstract EncodeT(stdgo._internal.encoding.gob.Gob_EncodeT.EncodeT) from stdgo._internal.encoding.gob.Gob_EncodeT.EncodeT to stdgo._internal.encoding.gob.Gob_EncodeT.EncodeT {
    ...
    public function new(?_x:haxe.UInt64, ?_b:Array<std.UInt>) this = new stdgo._internal.encoding.gob.Gob_EncodeT.EncodeT(_x, ([for (i in _b) i] : stdgo.Slice<stdgo.GoUInt8>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T0(stdgo._internal.encoding.gob.Gob_T0.T0) from stdgo._internal.encoding.gob.Gob_T0.T0 to stdgo._internal.encoding.gob.Gob_T0.T0 {
    ...
    public function new(?a:StdTypes.Int, ?b:StdTypes.Int, ?c:StdTypes.Int, ?d:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_T0.T0(a, b, c, d);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T1(stdgo._internal.encoding.gob.Gob_T1.T1) from stdgo._internal.encoding.gob.Gob_T1.T1 to stdgo._internal.encoding.gob.Gob_T1.T1 {
    public var a(get, set) : StdTypes.Int;
    function get_a():StdTypes.Int return this.a;
    function set_a(v:StdTypes.Int):StdTypes.Int {
        this.a = v;
    ...
    public function new(?a:StdTypes.Int, ?b:stdgo.Pointer<StdTypes.Int>, ?c:stdgo.Pointer<stdgo.Pointer<StdTypes.Int>>, ?d:stdgo.Pointer<stdgo.Pointer<stdgo.Pointer<StdTypes.Int>>>) this = new stdgo._internal.encoding.gob.Gob_T1.T1(a, b, c, d);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T2(stdgo._internal.encoding.gob.Gob_T2.T2) from stdgo._internal.encoding.gob.Gob_T2.T2 to stdgo._internal.encoding.gob.Gob_T2.T2 {
    ...
    public function new(?a:stdgo.Pointer<stdgo.Pointer<stdgo.Pointer<StdTypes.Int>>>, ?b:stdgo.Pointer<stdgo.Pointer<StdTypes.Int>>, ?c:stdgo.Pointer<StdTypes.Int>, ?d:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_T2.T2(a, b, c, d);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract RT0(stdgo._internal.encoding.gob.Gob_RT0.RT0) from stdgo._internal.encoding.gob.Gob_RT0.RT0 to stdgo._internal.encoding.gob.Gob_RT0.RT0 {
    public var a(get, set) : StdTypes.Int;
    function get_a():StdTypes.Int return this.a;
    function set_a(v:StdTypes.Int):StdTypes.Int {
        this.a = v;
    ...
    public function new(?a:StdTypes.Int, ?b:String, ?c:StdTypes.Float) this = new stdgo._internal.encoding.gob.Gob_RT0.RT0(a, b, c);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract RT1(stdgo._internal.encoding.gob.Gob_RT1.RT1) from stdgo._internal.encoding.gob.Gob_RT1.RT1 to stdgo._internal.encoding.gob.Gob_RT1.RT1 {
    public var c(get, set) : StdTypes.Float;
    function get_c():StdTypes.Float return this.c;
    function set_c(v:StdTypes.Float):StdTypes.Float {
        this.c = v;
    ...
    public function new(?c:StdTypes.Float, ?b:String, ?a:StdTypes.Int, ?notSet:String) this = new stdgo._internal.encoding.gob.Gob_RT1.RT1(c, b, a, notSet);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract IT0(stdgo._internal.encoding.gob.Gob_IT0.IT0) from stdgo._internal.encoding.gob.Gob_IT0.IT0 to stdgo._internal.encoding.gob.Gob_IT0.IT0 {
    ...
    public function new(?a:haxe.Int64, ?b:String, ?ignore_d:Array<StdTypes.Int>, ?ignore_e:haxe.ds.Vector<StdTypes.Float>, ?ignore_f:Bool, ?ignore_g:String, ?ignore_h:Array<std.UInt>, ?ignore_i:RT1, ?ignore_m:stdgo.GoMap<stdgo.GoString, stdgo.GoInt>, ?c:StdTypes.Float) this = new stdgo._internal.encoding.gob.Gob_IT0.IT0(a, b, ([for (i in ignore_d) i] : stdgo.Slice<stdgo.GoInt>), ([for (i in ignore_e) i] : stdgo.GoArray<stdgo.GoFloat64>), ignore_f, ignore_g, ([for (i in ignore_h) i] : stdgo.Slice<stdgo.GoUInt8>), ignore_i, ignore_m, c);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract Indirect(stdgo._internal.encoding.gob.Gob_Indirect.Indirect) from stdgo._internal.encoding.gob.Gob_Indirect.Indirect to stdgo._internal.encoding.gob.Gob_Indirect.Indirect {
...
@:structInit abstract Direct(stdgo._internal.encoding.gob.Gob_Direct.Direct) from stdgo._internal.encoding.gob.Gob_Direct.Direct to stdgo._internal.encoding.gob.Gob_Direct.Direct {
    ...
    public function new(?a:haxe.ds.Vector<StdTypes.Int>, ?s:Array<StdTypes.Int>, ?m:stdgo.GoMap<stdgo.GoString, stdgo.GoInt>) this = new stdgo._internal.encoding.gob.Gob_Direct.Direct(([for (i in a) i] : stdgo.GoArray<stdgo.GoInt>), ([for (i in s) i] : stdgo.Slice<stdgo.GoInt>), m);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.encoding.gob.Gob.Point_static_extension) abstract Point(stdgo._internal.encoding.gob.Gob_Point.Point) from stdgo._internal.encoding.gob.Gob_Point.Point to stdgo._internal.encoding.gob.Gob_Point.Point {
    ...
    public function new(?x:StdTypes.Int, ?y:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_Point.Point(x, y);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract InterfaceItem(stdgo._internal.encoding.gob.Gob_InterfaceItem.InterfaceItem) from stdgo._internal.encoding.gob.Gob_InterfaceItem.InterfaceItem to stdgo._internal.encoding.gob.Gob_InterfaceItem.InterfaceItem {
    ...
    public function new(?i:StdTypes.Int, ?sq1:Squarer, ?sq2:Squarer, ?sq3:Squarer, ?f:StdTypes.Float, ?sq:Array<Squarer>) this = new stdgo._internal.encoding.gob.Gob_InterfaceItem.InterfaceItem(i, sq1, sq2, sq3, f, ([for (i in sq) i] : stdgo.Slice<stdgo._internal.encoding.gob.Gob_Squarer.Squarer>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract NoInterfaceItem(stdgo._internal.encoding.gob.Gob_NoInterfaceItem.NoInterfaceItem) from stdgo._internal.encoding.gob.Gob_NoInterfaceItem.NoInterfaceItem to stdgo._internal.encoding.gob.Gob_NoInterfaceItem.NoInterfaceItem {
    public var i(get, set) : StdTypes.Int;
    function get_i():StdTypes.Int return this.i;
    function set_i(v:StdTypes.Int):StdTypes.Int {
        this.i = v;
    ...
    public function new(?i:StdTypes.Int, ?f:StdTypes.Float) this = new stdgo._internal.encoding.gob.Gob_NoInterfaceItem.NoInterfaceItem(i, f);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract BasicInterfaceItem(stdgo._internal.encoding.gob.Gob_BasicInterfaceItem.BasicInterfaceItem) from stdgo._internal.encoding.gob.Gob_BasicInterfaceItem.BasicInterfaceItem to stdgo._internal.encoding.gob.Gob_BasicInterfaceItem.BasicInterfaceItem {
...
@:structInit abstract PtrInterfaceItem(stdgo._internal.encoding.gob.Gob_PtrInterfaceItem.PtrInterfaceItem) from stdgo._internal.encoding.gob.Gob_PtrInterfaceItem.PtrInterfaceItem to stdgo._internal.encoding.gob.Gob_PtrInterfaceItem.PtrInterfaceItem {
    ...
    public function new(?str1:stdgo.AnyInterface, ?str2:stdgo.AnyInterface) this = new stdgo._internal.encoding.gob.Gob_PtrInterfaceItem.PtrInterfaceItem(str1, str2);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract U(stdgo._internal.encoding.gob.Gob_U.U) from stdgo._internal.encoding.gob.Gob_U.U to stdgo._internal.encoding.gob.Gob_U.U {
    public var a(get, set) : StdTypes.Int;
    function get_a():StdTypes.Int return this.a;
    function set_a(v:StdTypes.Int):StdTypes.Int {
        this.a = v;
    ...
    public function new(?a:StdTypes.Int, ?b:String, ?_c:StdTypes.Float, ?d:std.UInt) this = new stdgo._internal.encoding.gob.Gob_U.U(a, b, _c, d);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract OnTheFly(stdgo._internal.encoding.gob.Gob_OnTheFly.OnTheFly) from stdgo._internal.encoding.gob.Gob_OnTheFly.OnTheFly to stdgo._internal.encoding.gob.Gob_OnTheFly.OnTheFly {
    public var a(get, set) : StdTypes.Int;
    function get_a():StdTypes.Int return this.a;
    function set_a(v:StdTypes.Int):StdTypes.Int {
        this.a = v;
    ...
    public function new(?a:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_OnTheFly.OnTheFly(a);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract DT(stdgo._internal.encoding.gob.Gob_DT.DT) from stdgo._internal.encoding.gob.Gob_DT.DT to stdgo._internal.encoding.gob.Gob_DT.DT {
    public var a(get, set) : StdTypes.Int;
    function get_a():StdTypes.Int return this.a;
    function set_a(v:StdTypes.Int):StdTypes.Int {
        this.a = v;
    ...
    public function new(?a:StdTypes.Int, ?b:String, ?c:StdTypes.Float, ?i:stdgo.AnyInterface, ?j:stdgo.AnyInterface, ?i_nil:stdgo.AnyInterface, ?m:stdgo.GoMap<stdgo.GoString, stdgo.GoInt>, ?t:haxe.ds.Vector<StdTypes.Int>, ?s:Array<String>) this = new stdgo._internal.encoding.gob.Gob_DT.DT(a, b, c, i, j, i_nil, m, ([for (i in t) i] : stdgo.GoArray<stdgo.GoInt>), ([for (i in s) i] : stdgo.Slice<stdgo.GoString>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract LargeSliceByte(stdgo._internal.encoding.gob.Gob_LargeSliceByte.LargeSliceByte) from stdgo._internal.encoding.gob.Gob_LargeSliceByte.LargeSliceByte to stdgo._internal.encoding.gob.Gob_LargeSliceByte.LargeSliceByte {
    ...
    public function new(?s:Array<std.UInt>) this = new stdgo._internal.encoding.gob.Gob_LargeSliceByte.LargeSliceByte(([for (i in s) i] : stdgo.Slice<stdgo.GoUInt8>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract LargeSliceInt8(stdgo._internal.encoding.gob.Gob_LargeSliceInt8.LargeSliceInt8) from stdgo._internal.encoding.gob.Gob_LargeSliceInt8.LargeSliceInt8 to stdgo._internal.encoding.gob.Gob_LargeSliceInt8.LargeSliceInt8 {
    public var s(get, set) : Array<StdTypes.Int>;
    function get_s():Array<StdTypes.Int> return [for (i in this.s) i];
    function set_s(v:Array<StdTypes.Int>):Array<StdTypes.Int> {
    ...
    public function new(?s:Array<StdTypes.Int>) this = new stdgo._internal.encoding.gob.Gob_LargeSliceInt8.LargeSliceInt8(([for (i in s) i] : stdgo.Slice<stdgo.GoInt8>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract StringPair(stdgo._internal.encoding.gob.Gob_StringPair.StringPair) from stdgo._internal.encoding.gob.Gob_StringPair.StringPair to stdgo._internal.encoding.gob.Gob_StringPair.StringPair {
    ...
    public function new(?a:String, ?b:String) this = new stdgo._internal.encoding.gob.Gob_StringPair.StringPair(a, b);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract LargeSliceStruct(stdgo._internal.encoding.gob.Gob_LargeSliceStruct.LargeSliceStruct) from stdgo._internal.encoding.gob.Gob_LargeSliceStruct.LargeSliceStruct to stdgo._internal.encoding.gob.Gob_LargeSliceStruct.LargeSliceStruct {
...
@:structInit abstract LargeSliceString(stdgo._internal.encoding.gob.Gob_LargeSliceString.LargeSliceString) from stdgo._internal.encoding.gob.Gob_LargeSliceString.LargeSliceString to stdgo._internal.encoding.gob.Gob_LargeSliceString.LargeSliceString {
    public var s(get, set) : Array<String>;
    function get_s():Array<String> return [for (i in this.s) i];
    function set_s(v:Array<String>):Array<String> {
        this.s = ([for (i in v) i] : stdgo.Slice<stdgo.GoString>);
    ...
    public function new(?s:Array<String>) this = new stdgo._internal.encoding.gob.Gob_LargeSliceString.LargeSliceString(([for (i in s) i] : stdgo.Slice<stdgo.GoString>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.encoding.gob.Gob.T_decoderState_static_extension) abstract T_decoderState(stdgo._internal.encoding.gob.Gob_T_decoderState.T_decoderState) from stdgo._internal.encoding.gob.Gob_T_decoderState.T_decoderState to stdgo._internal.encoding.gob.Gob_T_decoderState.T_decoderState {
    ...
    public function new(?_dec:Decoder, ?_b:T_decBuffer, ?_fieldnum:StdTypes.Int, ?_next:T_decoderState) this = new stdgo._internal.encoding.gob.Gob_T_decoderState.T_decoderState(_dec, _b, _fieldnum, _next);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.encoding.gob.Gob.T_decBuffer_static_extension) abstract T_decBuffer(stdgo._internal.encoding.gob.Gob_T_decBuffer.T_decBuffer) from stdgo._internal.encoding.gob.Gob_T_decBuffer.T_decBuffer to stdgo._internal.encoding.gob.Gob_T_decBuffer.T_decBuffer {
    ...
    public function new(?_data:Array<std.UInt>, ?_offset:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_T_decBuffer.T_decBuffer(([for (i in _data) i] : stdgo.Slice<stdgo.GoUInt8>), _offset);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_decInstr(stdgo._internal.encoding.gob.Gob_T_decInstr.T_decInstr) from stdgo._internal.encoding.gob.Gob_T_decInstr.T_decInstr to stdgo._internal.encoding.gob.Gob_T_decInstr.T_decInstr {
    ...
    public function new(?_op:T_decOp, ?_field:StdTypes.Int, ?_index:Array<StdTypes.Int>, ?_ovfl:stdgo.Error) this = new stdgo._internal.encoding.gob.Gob_T_decInstr.T_decInstr(_op, _field, ([for (i in _index) i] : stdgo.Slice<stdgo.GoInt>), _ovfl);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_decEngine(stdgo._internal.encoding.gob.Gob_T_decEngine.T_decEngine) from stdgo._internal.encoding.gob.Gob_T_decEngine.T_decEngine to stdgo._internal.encoding.gob.Gob_T_decEngine.T_decEngine {
    ...
    public function new(?_instr:Array<T_decInstr>, ?_numInstr:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_T_decEngine.T_decEngine(([for (i in _instr) i] : stdgo.Slice<stdgo._internal.encoding.gob.Gob_T_decInstr.T_decInstr>), _numInstr);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_emptyStruct(stdgo._internal.encoding.gob.Gob_T_emptyStruct.T_emptyStruct) from stdgo._internal.encoding.gob.Gob_T_emptyStruct.T_emptyStruct to stdgo._internal.encoding.gob.Gob_T_emptyStruct.T_emptyStruct {
...
@:structInit @:using(stdgo.encoding.gob.Gob.T_encoderState_static_extension) abstract T_encoderState(stdgo._internal.encoding.gob.Gob_T_encoderState.T_encoderState) from stdgo._internal.encoding.gob.Gob_T_encoderState.T_encoderState to stdgo._internal.encoding.gob.Gob_T_encoderState.T_encoderState {
    ...
    public function new(?_enc:Encoder, ?_b:T_encBuffer, ?_sendZero:Bool, ?_fieldnum:StdTypes.Int, ?_buf:haxe.ds.Vector<std.UInt>, ?_next:T_encoderState) this = new stdgo._internal.encoding.gob.Gob_T_encoderState.T_encoderState(_enc, _b, _sendZero, _fieldnum, ([for (i in _buf) i] : stdgo.GoArray<stdgo.GoUInt8>), _next);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.encoding.gob.Gob.T_encBuffer_static_extension) abstract T_encBuffer(stdgo._internal.encoding.gob.Gob_T_encBuffer.T_encBuffer) from stdgo._internal.encoding.gob.Gob_T_encBuffer.T_encBuffer to stdgo._internal.encoding.gob.Gob_T_encBuffer.T_encBuffer {
    ...
    public function new(?_data:Array<std.UInt>, ?_scratch:haxe.ds.Vector<std.UInt>) this = new stdgo._internal.encoding.gob.Gob_T_encBuffer.T_encBuffer(([for (i in _data) i] : stdgo.Slice<stdgo.GoUInt8>), ([for (i in _scratch) i] : stdgo.GoArray<stdgo.GoUInt8>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_encInstr(stdgo._internal.encoding.gob.Gob_T_encInstr.T_encInstr) from stdgo._internal.encoding.gob.Gob_T_encInstr.T_encInstr to stdgo._internal.encoding.gob.Gob_T_encInstr.T_encInstr {
    ...
    public function new(?_op:T_encOp, ?_field:StdTypes.Int, ?_index:Array<StdTypes.Int>, ?_indir:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_T_encInstr.T_encInstr(_op, _field, ([for (i in _index) i] : stdgo.Slice<stdgo.GoInt>), _indir);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_encEngine(stdgo._internal.encoding.gob.Gob_T_encEngine.T_encEngine) from stdgo._internal.encoding.gob.Gob_T_encEngine.T_encEngine to stdgo._internal.encoding.gob.Gob_T_encEngine.T_encEngine {
...
@:structInit abstract ET0(stdgo._internal.encoding.gob.Gob_ET0.ET0) from stdgo._internal.encoding.gob.Gob_ET0.ET0 to stdgo._internal.encoding.gob.Gob_ET0.ET0 {
    ...
    public function new(?a:StdTypes.Int, ?b:String) this = new stdgo._internal.encoding.gob.Gob_ET0.ET0(a, b);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract ET2(stdgo._internal.encoding.gob.Gob_ET2.ET2) from stdgo._internal.encoding.gob.Gob_ET2.ET2 to stdgo._internal.encoding.gob.Gob_ET2.ET2 {
    ...
    public function new(?x:String) this = new stdgo._internal.encoding.gob.Gob_ET2.ET2(x);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract ET1(stdgo._internal.encoding.gob.Gob_ET1.ET1) from stdgo._internal.encoding.gob.Gob_ET1.ET1 to stdgo._internal.encoding.gob.Gob_ET1.ET1 {
    public var a(get, set) : StdTypes.Int;
    function get_a():StdTypes.Int return this.a;
    function set_a(v:StdTypes.Int):StdTypes.Int {
        this.a = v;
    ...
    public function new(?a:StdTypes.Int, ?et2:ET2, ?next:ET1) this = new stdgo._internal.encoding.gob.Gob_ET1.ET1(a, et2, next);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract ET3(stdgo._internal.encoding.gob.Gob_ET3.ET3) from stdgo._internal.encoding.gob.Gob_ET3.ET3 to stdgo._internal.encoding.gob.Gob_ET3.ET3 {
    public var a(get, set) : StdTypes.Int;
    function get_a():StdTypes.Int return this.a;
    function set_a(v:StdTypes.Int):StdTypes.Int {
        this.a = v;
    ...
    public function new(?a:StdTypes.Int, ?et2:ET2, ?differentNext:ET1) this = new stdgo._internal.encoding.gob.Gob_ET3.ET3(a, et2, differentNext);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract ET4(stdgo._internal.encoding.gob.Gob_ET4.ET4) from stdgo._internal.encoding.gob.Gob_ET4.ET4 to stdgo._internal.encoding.gob.Gob_ET4.ET4 {
    public var a(get, set) : StdTypes.Int;
    function get_a():StdTypes.Int return this.a;
    function set_a(v:StdTypes.Int):StdTypes.Int {
        this.a = v;
    ...
    public function new(?a:StdTypes.Int, ?et2:StdTypes.Float, ?next:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_ET4.ET4(a, et2, next);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract SingleTest(stdgo._internal.encoding.gob.Gob_SingleTest.SingleTest) from stdgo._internal.encoding.gob.Gob_SingleTest.SingleTest to stdgo._internal.encoding.gob.Gob_SingleTest.SingleTest {
    ...
    public function new(?_in:stdgo.AnyInterface, ?_out:stdgo.AnyInterface, ?_err:String) this = new stdgo._internal.encoding.gob.Gob_SingleTest.SingleTest(_in, _out, _err);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
@:structInit abstract Struct0(stdgo._internal.encoding.gob.Gob_Struct0.Struct0) from stdgo._internal.encoding.gob.Gob_Struct0.Struct0 to stdgo._internal.encoding.gob.Gob_Struct0.Struct0 {
    public var i(get, set) : stdgo.AnyInterface;
    function get_i():stdgo.AnyInterface return this.i;
    function set_i(v:stdgo.AnyInterface):stdgo.AnyInterface {
        this.i = v;
    ...
    public function new(?i:stdgo.AnyInterface) this = new stdgo._internal.encoding.gob.Gob_Struct0.Struct0(i);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract NewType0(stdgo._internal.encoding.gob.Gob_NewType0.NewType0) from stdgo._internal.encoding.gob.Gob_NewType0.NewType0 to stdgo._internal.encoding.gob.Gob_NewType0.NewType0 {
    ...
    public function new(?s:String) this = new stdgo._internal.encoding.gob.Gob_NewType0.NewType0(s);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_ignoreTest(stdgo._internal.encoding.gob.Gob_T_ignoreTest.T_ignoreTest) from stdgo._internal.encoding.gob.Gob_T_ignoreTest.T_ignoreTest to stdgo._internal.encoding.gob.Gob_T_ignoreTest.T_ignoreTest {
    public var _in(get, set) : stdgo.AnyInterface;
    function get__in():stdgo.AnyInterface return this._in;
    function set__in(v:stdgo.AnyInterface):stdgo.AnyInterface {
        this._in = v;
    ...
    public function new(?_in:stdgo.AnyInterface, ?_out:stdgo.AnyInterface) this = new stdgo._internal.encoding.gob.Gob_T_ignoreTest.T_ignoreTest(_in, _out);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract Bug0Outer(stdgo._internal.encoding.gob.Gob_Bug0Outer.Bug0Outer) from stdgo._internal.encoding.gob.Gob_Bug0Outer.Bug0Outer to stdgo._internal.encoding.gob.Gob_Bug0Outer.Bug0Outer {
    ...
    public function new(?bug0Field:stdgo.AnyInterface) this = new stdgo._internal.encoding.gob.Gob_Bug0Outer.Bug0Outer(bug0Field);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract Bug0Inner(stdgo._internal.encoding.gob.Gob_Bug0Inner.Bug0Inner) from stdgo._internal.encoding.gob.Gob_Bug0Inner.Bug0Inner to stdgo._internal.encoding.gob.Gob_Bug0Inner.Bug0Inner {
    public var a(get, set) : StdTypes.Int;
    function get_a():StdTypes.Int return this.a;
    function set_a(v:StdTypes.Int):StdTypes.Int {
        this.a = v;
    ...
    public function new(?a:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_Bug0Inner.Bug0Inner(a);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract Bug1Elem(stdgo._internal.encoding.gob.Gob_Bug1Elem.Bug1Elem) from stdgo._internal.encoding.gob.Gob_Bug1Elem.Bug1Elem to stdgo._internal.encoding.gob.Gob_Bug1Elem.Bug1Elem {
    ...
    public function new(?name:String, ?id:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_Bug1Elem.Bug1Elem(name, id);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract Bug2(stdgo._internal.encoding.gob.Gob_Bug2.Bug2) from stdgo._internal.encoding.gob.Gob_Bug2.Bug2 to stdgo._internal.encoding.gob.Gob_Bug2.Bug2 {
    public var a(get, set) : StdTypes.Int;
    function get_a():StdTypes.Int return this.a;
    function set_a(v:StdTypes.Int):StdTypes.Int {
        this.a = v;
...
@:structInit abstract Bug3(stdgo._internal.encoding.gob.Gob_Bug3.Bug3) from stdgo._internal.encoding.gob.Gob_Bug3.Bug3 to stdgo._internal.encoding.gob.Gob_Bug3.Bug3 {
    ...
    function set_children(v:Array<Bug3>):Array<Bug3> {
        this.children = ([for (i in v) i] : stdgo.Slice<stdgo.Ref<stdgo._internal.encoding.gob.Gob_Bug3.Bug3>>);
        return v;
    }
    public function new(?num:StdTypes.Int, ?children:Array<Bug3>) this = new stdgo._internal.encoding.gob.Gob_Bug3.Bug3(num, ([for (i in children) i] : stdgo.Slice<stdgo.Ref<stdgo._internal.encoding.gob.Gob_Bug3.Bug3>>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract Bug4Public(stdgo._internal.encoding.gob.Gob_Bug4Public.Bug4Public) from stdgo._internal.encoding.gob.Gob_Bug4Public.Bug4Public to stdgo._internal.encoding.gob.Gob_Bug4Public.Bug4Public {
    public var name(get, set) : String;
    function get_name():String return this.name;
    function set_name(v:String):String {
        this.name = v;
    ...
    public function new(?name:String, ?secret:Bug4Secret) this = new stdgo._internal.encoding.gob.Gob_Bug4Public.Bug4Public(name, secret);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract Bug4Secret(stdgo._internal.encoding.gob.Gob_Bug4Secret.Bug4Secret) from stdgo._internal.encoding.gob.Gob_Bug4Secret.Bug4Secret to stdgo._internal.encoding.gob.Gob_Bug4Secret.Bug4Secret {
    ...
    public function new(?_a:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_Bug4Secret.Bug4Secret(_a);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract Z(stdgo._internal.encoding.gob.Gob_Z.Z) from stdgo._internal.encoding.gob.Gob_Z.Z to stdgo._internal.encoding.gob.Gob_Z.Z {
    public function new() this = new stdgo._internal.encoding.gob.Gob_Z.Z();
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_badDataTest(stdgo._internal.encoding.gob.Gob_T_badDataTest.T_badDataTest) from stdgo._internal.encoding.gob.Gob_T_badDataTest.T_badDataTest to stdgo._internal.encoding.gob.Gob_T_badDataTest.T_badDataTest {
    ...
    public function new(?_input:String, ?_error:String, ?_data:stdgo.AnyInterface) this = new stdgo._internal.encoding.gob.Gob_T_badDataTest.T_badDataTest(_input, _error, _data);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_gobError(stdgo._internal.encoding.gob.Gob_T_gobError.T_gobError) from stdgo._internal.encoding.gob.Gob_T_gobError.T_gobError to stdgo._internal.encoding.gob.Gob_T_gobError.T_gobError {
    public var _err(get, set) : stdgo.Error;
    function get__err():stdgo.Error return this._err;
    function set__err(v:stdgo.Error):stdgo.Error {
        this._err = v;
    ...
    public function new(?_err:stdgo.Error) this = new stdgo._internal.encoding.gob.Gob_T_gobError.T_gobError(_err);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.encoding.gob.Gob.ByteStruct_static_extension) abstract ByteStruct(stdgo._internal.encoding.gob.Gob_ByteStruct.ByteStruct) from stdgo._internal.encoding.gob.Gob_ByteStruct.ByteStruct to stdgo._internal.encoding.gob.Gob_ByteStruct.ByteStruct {
    ...
    public function new(?_a:std.UInt) this = new stdgo._internal.encoding.gob.Gob_ByteStruct.ByteStruct(_a);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.encoding.gob.Gob.StringStruct_static_extension) abstract StringStruct(stdgo._internal.encoding.gob.Gob_StringStruct.StringStruct) from stdgo._internal.encoding.gob.Gob_StringStruct.StringStruct to stdgo._internal.encoding.gob.Gob_StringStruct.StringStruct {
    ...
    public function new(?_s:String) this = new stdgo._internal.encoding.gob.Gob_StringStruct.StringStruct(_s);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.encoding.gob.Gob.ArrayStruct_static_extension) abstract ArrayStruct(stdgo._internal.encoding.gob.Gob_ArrayStruct.ArrayStruct) from stdgo._internal.encoding.gob.Gob_ArrayStruct.ArrayStruct to stdgo._internal.encoding.gob.Gob_ArrayStruct.ArrayStruct {
    ...
    public function new(?_a:haxe.ds.Vector<std.UInt>) this = new stdgo._internal.encoding.gob.Gob_ArrayStruct.ArrayStruct(([for (i in _a) i] : stdgo.GoArray<stdgo.GoUInt8>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract GobTest0(stdgo._internal.encoding.gob.Gob_GobTest0.GobTest0) from stdgo._internal.encoding.gob.Gob_GobTest0.GobTest0 to stdgo._internal.encoding.gob.Gob_GobTest0.GobTest0 {
    public var x(get, set) : StdTypes.Int;
    function get_x():StdTypes.Int return this.x;
    function set_x(v:StdTypes.Int):StdTypes.Int {
        this.x = v;
    ...
    public function new(?x:StdTypes.Int, ?g:ByteStruct) this = new stdgo._internal.encoding.gob.Gob_GobTest0.GobTest0(x, g);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract GobTest1(stdgo._internal.encoding.gob.Gob_GobTest1.GobTest1) from stdgo._internal.encoding.gob.Gob_GobTest1.GobTest1 to stdgo._internal.encoding.gob.Gob_GobTest1.GobTest1 {
    public var x(get, set) : StdTypes.Int;
    function get_x():StdTypes.Int return this.x;
    function set_x(v:StdTypes.Int):StdTypes.Int {
        this.x = v;
    ...
    public function new(?x:StdTypes.Int, ?g:StringStruct) this = new stdgo._internal.encoding.gob.Gob_GobTest1.GobTest1(x, g);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract GobTest2(stdgo._internal.encoding.gob.Gob_GobTest2.GobTest2) from stdgo._internal.encoding.gob.Gob_GobTest2.GobTest2 to stdgo._internal.encoding.gob.Gob_GobTest2.GobTest2 {
    public var x(get, set) : StdTypes.Int;
    function get_x():StdTypes.Int return this.x;
    function set_x(v:StdTypes.Int):StdTypes.Int {
        this.x = v;
    ...
    public function new(?x:StdTypes.Int, ?g:String) this = new stdgo._internal.encoding.gob.Gob_GobTest2.GobTest2(x, g);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract GobTest3(stdgo._internal.encoding.gob.Gob_GobTest3.GobTest3) from stdgo._internal.encoding.gob.Gob_GobTest3.GobTest3 to stdgo._internal.encoding.gob.Gob_GobTest3.GobTest3 {
    public var x(get, set) : StdTypes.Int;
    function get_x():StdTypes.Int return this.x;
    function set_x(v:StdTypes.Int):StdTypes.Int {
        this.x = v;
    ...
    public function new(?x:StdTypes.Int, ?g:stdgo.Pointer<Gobber>, ?b:stdgo.Pointer<BinaryGobber>, ?t:stdgo.Pointer<TextGobber>) this = new stdgo._internal.encoding.gob.Gob_GobTest3.GobTest3(x, g, b, t);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract GobTest4(stdgo._internal.encoding.gob.Gob_GobTest4.GobTest4) from stdgo._internal.encoding.gob.Gob_GobTest4.GobTest4 to stdgo._internal.encoding.gob.Gob_GobTest4.GobTest4 {
    public var x(get, set) : StdTypes.Int;
    function get_x():StdTypes.Int return this.x;
    function set_x(v:StdTypes.Int):StdTypes.Int {
        this.x = v;
...
@:structInit abstract GobTest5(stdgo._internal.encoding.gob.Gob_GobTest5.GobTest5) from stdgo._internal.encoding.gob.Gob_GobTest5.GobTest5 to stdgo._internal.encoding.gob.Gob_GobTest5.GobTest5 {
    public var x(get, set) : StdTypes.Int;
    function get_x():StdTypes.Int return this.x;
    function set_x(v:StdTypes.Int):StdTypes.Int {
        this.x = v;
...
@:structInit abstract GobTest6(stdgo._internal.encoding.gob.Gob_GobTest6.GobTest6) from stdgo._internal.encoding.gob.Gob_GobTest6.GobTest6 to stdgo._internal.encoding.gob.Gob_GobTest6.GobTest6 {
    public var x(get, set) : StdTypes.Int;
    function get_x():StdTypes.Int return this.x;
    function set_x(v:StdTypes.Int):StdTypes.Int {
        this.x = v;
...
@:structInit abstract GobTest7(stdgo._internal.encoding.gob.Gob_GobTest7.GobTest7) from stdgo._internal.encoding.gob.Gob_GobTest7.GobTest7 to stdgo._internal.encoding.gob.Gob_GobTest7.GobTest7 {
    public var x(get, set) : StdTypes.Int;
    function get_x():StdTypes.Int return this.x;
    function set_x(v:StdTypes.Int):StdTypes.Int {
        this.x = v;
...
@:structInit abstract GobTestIgnoreEncoder(stdgo._internal.encoding.gob.Gob_GobTestIgnoreEncoder.GobTestIgnoreEncoder) from stdgo._internal.encoding.gob.Gob_GobTestIgnoreEncoder.GobTestIgnoreEncoder to stdgo._internal.encoding.gob.Gob_GobTestIgnoreEncoder.GobTestIgnoreEncoder {
    public var x(get, set) : StdTypes.Int;
    function get_x():StdTypes.Int return this.x;
    function set_x(v:StdTypes.Int):StdTypes.Int {
        this.x = v;
    ...
    public function new(?x:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_GobTestIgnoreEncoder.GobTestIgnoreEncoder(x);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract GobTestValueEncDec(stdgo._internal.encoding.gob.Gob_GobTestValueEncDec.GobTestValueEncDec) from stdgo._internal.encoding.gob.Gob_GobTestValueEncDec.GobTestValueEncDec to stdgo._internal.encoding.gob.Gob_GobTestValueEncDec.GobTestValueEncDec {
    public var x(get, set) : StdTypes.Int;
    function get_x():StdTypes.Int return this.x;
    function set_x(v:StdTypes.Int):StdTypes.Int {
        this.x = v;
    ...
    public function new(?x:StdTypes.Int, ?g:StringStruct) this = new stdgo._internal.encoding.gob.Gob_GobTestValueEncDec.GobTestValueEncDec(x, g);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract GobTestIndirectEncDec(stdgo._internal.encoding.gob.Gob_GobTestIndirectEncDec.GobTestIndirectEncDec) from stdgo._internal.encoding.gob.Gob_GobTestIndirectEncDec.GobTestIndirectEncDec to stdgo._internal.encoding.gob.Gob_GobTestIndirectEncDec.GobTestIndirectEncDec {
    public var x(get, set) : StdTypes.Int;
    function get_x():StdTypes.Int return this.x;
    function set_x(v:StdTypes.Int):StdTypes.Int {
        this.x = v;
    ...
    public function new(?x:StdTypes.Int, ?g:stdgo.Pointer<StringStruct>) this = new stdgo._internal.encoding.gob.Gob_GobTestIndirectEncDec.GobTestIndirectEncDec(x, g);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract GobTestArrayEncDec(stdgo._internal.encoding.gob.Gob_GobTestArrayEncDec.GobTestArrayEncDec) from stdgo._internal.encoding.gob.Gob_GobTestArrayEncDec.GobTestArrayEncDec to stdgo._internal.encoding.gob.Gob_GobTestArrayEncDec.GobTestArrayEncDec {
    public var x(get, set) : StdTypes.Int;
    function get_x():StdTypes.Int return this.x;
    function set_x(v:StdTypes.Int):StdTypes.Int {
        this.x = v;
    ...
    public function new(?x:StdTypes.Int, ?a:ArrayStruct) this = new stdgo._internal.encoding.gob.Gob_GobTestArrayEncDec.GobTestArrayEncDec(x, a);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract GobTestIndirectArrayEncDec(stdgo._internal.encoding.gob.Gob_GobTestIndirectArrayEncDec.GobTestIndirectArrayEncDec) from stdgo._internal.encoding.gob.Gob_GobTestIndirectArrayEncDec.GobTestIndirectArrayEncDec to stdgo._internal.encoding.gob.Gob_GobTestIndirectArrayEncDec.GobTestIndirectArrayEncDec {
    public var x(get, set) : StdTypes.Int;
    function get_x():StdTypes.Int return this.x;
    function set_x(v:StdTypes.Int):StdTypes.Int {
        this.x = v;
    ...
    public function new(?x:StdTypes.Int, ?a:stdgo.Pointer<ArrayStruct>) this = new stdgo._internal.encoding.gob.Gob_GobTestIndirectArrayEncDec.GobTestIndirectArrayEncDec(x, a);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.encoding.gob.Gob.T_gobDecoderBug0_static_extension) abstract T_gobDecoderBug0(stdgo._internal.encoding.gob.Gob_T_gobDecoderBug0.T_gobDecoderBug0) from stdgo._internal.encoding.gob.Gob_T_gobDecoderBug0.T_gobDecoderBug0 to stdgo._internal.encoding.gob.Gob_T_gobDecoderBug0.T_gobDecoderBug0 {
    ...
    public function new(?_foo:String, ?_bar:String) this = new stdgo._internal.encoding.gob.Gob_T_gobDecoderBug0.T_gobDecoderBug0(_foo, _bar);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_isZeroBug(stdgo._internal.encoding.gob.Gob_T_isZeroBug.T_isZeroBug) from stdgo._internal.encoding.gob.Gob_T_isZeroBug.T_isZeroBug to stdgo._internal.encoding.gob.Gob_T_isZeroBug.T_isZeroBug {
    ...
    public function new(?t:stdgo._internal.time.Time_Time.Time, ?s:String, ?i:StdTypes.Int, ?a:T_isZeroBugArray, ?f:T_isZeroBugInterface) this = new stdgo._internal.encoding.gob.Gob_T_isZeroBug.T_isZeroBug(t, s, i, a, f);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.encoding.gob.Gob.T_isZeroBugInterface_static_extension) abstract T_isZeroBugInterface(stdgo._internal.encoding.gob.Gob_T_isZeroBugInterface.T_isZeroBugInterface) from stdgo._internal.encoding.gob.Gob_T_isZeroBugInterface.T_isZeroBugInterface to stdgo._internal.encoding.gob.Gob_T_isZeroBugInterface.T_isZeroBugInterface {
    ...
    public function new(?i:stdgo.AnyInterface) this = new stdgo._internal.encoding.gob.Gob_T_isZeroBugInterface.T_isZeroBugInterface(i);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract Bench(stdgo._internal.encoding.gob.Gob_Bench.Bench) from stdgo._internal.encoding.gob.Gob_Bench.Bench to stdgo._internal.encoding.gob.Gob_Bench.Bench {
    public var a(get, set) : StdTypes.Int;
    function get_a():StdTypes.Int return this.a;
    function set_a(v:StdTypes.Int):StdTypes.Int {
        this.a = v;
    ...
    public function new(?a:StdTypes.Int, ?b:StdTypes.Float, ?c:String, ?d:Array<std.UInt>) this = new stdgo._internal.encoding.gob.Gob_Bench.Bench(a, b, c, ([for (i in d) i] : stdgo.Slice<stdgo.GoUInt8>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.encoding.gob.Gob.T_benchmarkBuf_static_extension) abstract T_benchmarkBuf(stdgo._internal.encoding.gob.Gob_T_benchmarkBuf.T_benchmarkBuf) from stdgo._internal.encoding.gob.Gob_T_benchmarkBuf.T_benchmarkBuf to stdgo._internal.encoding.gob.Gob_T_benchmarkBuf.T_benchmarkBuf {
    ...
    public function new(?_offset:StdTypes.Int, ?_data:Array<std.UInt>) this = new stdgo._internal.encoding.gob.Gob_T_benchmarkBuf.T_benchmarkBuf(_offset, ([for (i in _data) i] : stdgo.Slice<stdgo.GoUInt8>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_userTypeInfo(stdgo._internal.encoding.gob.Gob_T_userTypeInfo.T_userTypeInfo) from stdgo._internal.encoding.gob.Gob_T_userTypeInfo.T_userTypeInfo to stdgo._internal.encoding.gob.Gob_T_userTypeInfo.T_userTypeInfo {
...
@:structInit @:using(stdgo.encoding.gob.Gob.CommonType_static_extension) abstract CommonType(stdgo._internal.encoding.gob.Gob_CommonType.CommonType) from stdgo._internal.encoding.gob.Gob_CommonType.CommonType to stdgo._internal.encoding.gob.Gob_CommonType.CommonType {
    ...
    public function new(?name:String, ?id:T_typeId) this = new stdgo._internal.encoding.gob.Gob_CommonType.CommonType(name, id);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.encoding.gob.Gob.T_arrayType_static_extension) abstract T_arrayType(stdgo._internal.encoding.gob.Gob_T_arrayType.T_arrayType) from stdgo._internal.encoding.gob.Gob_T_arrayType.T_arrayType to stdgo._internal.encoding.gob.Gob_T_arrayType.T_arrayType {
    ...
    public function new(?commonType:CommonType, ?elem:T_typeId, ?len:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_T_arrayType.T_arrayType(commonType, elem, len);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
@:structInit abstract T_fieldType(stdgo._internal.encoding.gob.Gob_T_fieldType.T_fieldType) from stdgo._internal.encoding.gob.Gob_T_fieldType.T_fieldType to stdgo._internal.encoding.gob.Gob_T_fieldType.T_fieldType {
    public var name(get, set) : String;
    function get_name():String return this.name;
    function set_name(v:String):String {
        this.name = v;
    ...
    public function new(?name:String, ?id:T_typeId) this = new stdgo._internal.encoding.gob.Gob_T_fieldType.T_fieldType(name, id);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
@:structInit @:using(stdgo.encoding.gob.Gob.T_wireType_static_extension) abstract T_wireType(stdgo._internal.encoding.gob.Gob_T_wireType.T_wireType) from stdgo._internal.encoding.gob.Gob_T_wireType.T_wireType to stdgo._internal.encoding.gob.Gob_T_wireType.T_wireType {
    ...
    public function new(?arrayT:T_arrayType, ?sliceT:T_sliceType, ?structT:T_structType, ?mapT:T_mapType, ?gobEncoderT:T_gobEncoderType, ?binaryMarshalerT:T_gobEncoderType, ?textMarshalerT:T_gobEncoderType) this = new stdgo._internal.encoding.gob.Gob_T_wireType.T_wireType(arrayT, sliceT, structT, mapT, gobEncoderT, binaryMarshalerT, textMarshalerT);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_typeInfo(stdgo._internal.encoding.gob.Gob_T_typeInfo.T_typeInfo) from stdgo._internal.encoding.gob.Gob_T_typeInfo.T_typeInfo to stdgo._internal.encoding.gob.Gob_T_typeInfo.T_typeInfo {
...
@:structInit abstract T_typeT(stdgo._internal.encoding.gob.Gob_T_typeT.T_typeT) from stdgo._internal.encoding.gob.Gob_T_typeT.T_typeT to stdgo._internal.encoding.gob.Gob_T_typeT.T_typeT {
    public var _id(get, set) : T_typeId;
    function get__id():T_typeId return this._id;
    function set__id(v:T_typeId):T_typeId {
        this._id = v;
    ...
    public function new(?_id:T_typeId, ?_str:String) this = new stdgo._internal.encoding.gob.Gob_T_typeT.T_typeT(_id, _str);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract Bar(stdgo._internal.encoding.gob.Gob_Bar.Bar) from stdgo._internal.encoding.gob.Gob_Bar.Bar to stdgo._internal.encoding.gob.Gob_Bar.Bar {
    public var x(get, set) : String;
    function get_x():String return this.x;
    function set_x(v:String):String {
        this.x = v;
    ...
    public function new(?x:String) this = new stdgo._internal.encoding.gob.Gob_Bar.Bar(x);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract Foo(stdgo._internal.encoding.gob.Gob_Foo.Foo) from stdgo._internal.encoding.gob.Gob_Foo.Foo to stdgo._internal.encoding.gob.Gob_Foo.Foo {
    public var a(get, set) : StdTypes.Int;
    function get_a():StdTypes.Int return this.a;
    function set_a(v:StdTypes.Int):StdTypes.Int {
        this.a = v;
    ...
    public function new(?a:StdTypes.Int, ?b:StdTypes.Int, ?c:String, ?d:Array<std.UInt>, ?e:stdgo.Pointer<StdTypes.Float>, ?f:stdgo.Pointer<stdgo.Pointer<stdgo.Pointer<stdgo.Pointer<StdTypes.Float>>>>, ?g:Bar, ?h:Bar, ?i:Foo) this = new stdgo._internal.encoding.gob.Gob_Foo.Foo(a, b, c, ([for (i in d) i] : stdgo.Slice<stdgo.GoUInt8>), e, f, g, h, i);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract N1(stdgo._internal.encoding.gob.Gob_N1.N1) from stdgo._internal.encoding.gob.Gob_N1.N1 to stdgo._internal.encoding.gob.Gob_N1.N1 {
    public function new() this = new stdgo._internal.encoding.gob.Gob_N1.N1();
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract N2(stdgo._internal.encoding.gob.Gob_N2.N2) from stdgo._internal.encoding.gob.Gob_N2.N2 to stdgo._internal.encoding.gob.Gob_N2.N2 {
...
@:structInit abstract T_testEndToEnd___localname___T3_13794(stdgo._internal.encoding.gob.Gob_T_testEndToEnd___localname___T3_13794.T_testEndToEnd___localname___T3_13794) from stdgo._internal.encoding.gob.Gob_T_testEndToEnd___localname___T3_13794.T_testEndToEnd___localname___T3_13794 to stdgo._internal.encoding.gob.Gob_T_testEndToEnd___localname___T3_13794.T_testEndToEnd___localname___T3_13794 {
    ...
    public function new(?x:StdTypes.Float, ?z:stdgo.Pointer<StdTypes.Int>) this = new stdgo._internal.encoding.gob.Gob_T_testEndToEnd___localname___T3_13794.T_testEndToEnd___localname___T3_13794(x, z);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_testEndToEnd___localname___T1_13836(stdgo._internal.encoding.gob.Gob_T_testEndToEnd___localname___T1_13836.T_testEndToEnd___localname___T1_13836) from stdgo._internal.encoding.gob.Gob_T_testEndToEnd___localname___T1_13836.T_testEndToEnd___localname___T1_13836 to stdgo._internal.encoding.gob.Gob_T_testEndToEnd___localname___T1_13836.T_testEndToEnd___localname___T1_13836 {
    public var a(get, set) : StdTypes.Int;
    function get_a():StdTypes.Int return this.a;
    function set_a(v:StdTypes.Int):StdTypes.Int {
        this.a = v;
...
@:structInit abstract T_testOverflow___localname___outi8_16178(stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outi8_16178.T_testOverflow___localname___outi8_16178) from stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outi8_16178.T_testOverflow___localname___outi8_16178 to stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outi8_16178.T_testOverflow___localname___outi8_16178 {
    ...
    public function new(?maxi:StdTypes.Int, ?mini:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outi8_16178.T_testOverflow___localname___outi8_16178(maxi, mini);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_testOverflow___localname___outi16_16677(stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outi16_16677.T_testOverflow___localname___outi16_16677) from stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outi16_16677.T_testOverflow___localname___outi16_16677 to stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outi16_16677.T_testOverflow___localname___outi16_16677 {
    public var maxi(get, set) : StdTypes.Int;
    function get_maxi():StdTypes.Int return this.maxi;
    function set_maxi(v:StdTypes.Int):StdTypes.Int {
        this.maxi = v;
    ...
    public function new(?maxi:StdTypes.Int, ?mini:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outi16_16677.T_testOverflow___localname___outi16_16677(maxi, mini);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_testOverflow___localname___outi32_17183(stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outi32_17183.T_testOverflow___localname___outi32_17183) from stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outi32_17183.T_testOverflow___localname___outi32_17183 to stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outi32_17183.T_testOverflow___localname___outi32_17183 {
    public var maxi(get, set) : StdTypes.Int;
    function get_maxi():StdTypes.Int return this.maxi;
    function set_maxi(v:StdTypes.Int):StdTypes.Int {
        this.maxi = v;
    ...
    public function new(?maxi:StdTypes.Int, ?mini:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outi32_17183.T_testOverflow___localname___outi32_17183(maxi, mini);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_testOverflow___localname___outu8_17689(stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outu8_17689.T_testOverflow___localname___outu8_17689) from stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outu8_17689.T_testOverflow___localname___outu8_17689 to stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outu8_17689.T_testOverflow___localname___outu8_17689 {
...
@:structInit abstract T_testOverflow___localname___outu16_17967(stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outu16_17967.T_testOverflow___localname___outu16_17967) from stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outu16_17967.T_testOverflow___localname___outu16_17967 to stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outu16_17967.T_testOverflow___localname___outu16_17967 {
    ...
    public function new(?maxu:std.UInt) this = new stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outu16_17967.T_testOverflow___localname___outu16_17967(maxu);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_testOverflow___localname___outu32_18249(stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outu32_18249.T_testOverflow___localname___outu32_18249) from stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outu32_18249.T_testOverflow___localname___outu32_18249 to stdgo._internal.encoding.gob.Gob_T_testOverflow___localname___outu32_18249.T_testOverflow___localname___outu32_18249 {
    public var maxu(get, set) : std.UInt;
    function get_maxu():std.UInt return this.maxu;
    function set_maxu(v:std.UInt):std.UInt {
        this.maxu = v;
...
@:structInit abstract T_testNesting___localname___RT_19135(stdgo._internal.encoding.gob.Gob_T_testNesting___localname___RT_19135.T_testNesting___localname___RT_19135) from stdgo._internal.encoding.gob.Gob_T_testNesting___localname___RT_19135.T_testNesting___localname___RT_19135 to stdgo._internal.encoding.gob.Gob_T_testNesting___localname___RT_19135.T_testNesting___localname___RT_19135 {
    ...
    public function new(?a:String, ?next:T_testNesting___localname___RT_19135) this = new stdgo._internal.encoding.gob.Gob_T_testNesting___localname___RT_19135.T_testNesting___localname___RT_19135(a, next);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
@:structInit abstract T_testTypeToPtrType___localname___Type0_6215(stdgo._internal.encoding.gob.Gob_T_testTypeToPtrType___localname___Type0_6215.T_testTypeToPtrType___localname___Type0_6215) from stdgo._internal.encoding.gob.Gob_T_testTypeToPtrType___localname___Type0_6215.T_testTypeToPtrType___localname___Type0_6215 to stdgo._internal.encoding.gob.Gob_T_testTypeToPtrType___localname___Type0_6215.T_testTypeToPtrType___localname___Type0_6215 {
    ...
    public function new(?a:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_T_testTypeToPtrType___localname___Type0_6215.T_testTypeToPtrType___localname___Type0_6215(a);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_testPtrTypeToType___localname___Type1_6414(stdgo._internal.encoding.gob.Gob_T_testPtrTypeToType___localname___Type1_6414.T_testPtrTypeToType___localname___Type1_6414) from stdgo._internal.encoding.gob.Gob_T_testPtrTypeToType___localname___Type1_6414.T_testPtrTypeToType___localname___Type1_6414 to stdgo._internal.encoding.gob.Gob_T_testPtrTypeToType___localname___Type1_6414.T_testPtrTypeToType___localname___Type1_6414 {
    ...
    public function new(?a:std.UInt) this = new stdgo._internal.encoding.gob.Gob_T_testPtrTypeToType___localname___Type1_6414.T_testPtrTypeToType___localname___Type1_6414(a);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
@:structInit abstract T_testSlice___localname___Type3_7005(stdgo._internal.encoding.gob.Gob_T_testSlice___localname___Type3_7005.T_testSlice___localname___Type3_7005) from stdgo._internal.encoding.gob.Gob_T_testSlice___localname___Type3_7005.T_testSlice___localname___Type3_7005 to stdgo._internal.encoding.gob.Gob_T_testSlice___localname___Type3_7005.T_testSlice___localname___Type3_7005 {
    ...
    public function new(?a:Array<String>) this = new stdgo._internal.encoding.gob.Gob_T_testSlice___localname___Type3_7005.T_testSlice___localname___Type3_7005(([for (i in a) i] : stdgo.Slice<stdgo.GoString>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_testValueError___localname___Type4_7228(stdgo._internal.encoding.gob.Gob_T_testValueError___localname___Type4_7228.T_testValueError___localname___Type4_7228) from stdgo._internal.encoding.gob.Gob_T_testValueError___localname___Type4_7228.T_testValueError___localname___Type4_7228 to stdgo._internal.encoding.gob.Gob_T_testValueError___localname___Type4_7228.T_testValueError___localname___Type4_7228 {
    public var a(get, set) : StdTypes.Int;
    function get_a():StdTypes.Int return this.a;
    function set_a(v:StdTypes.Int):StdTypes.Int {
        this.a = v;
    ...
    public function new(?a:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_T_testValueError___localname___Type4_7228.T_testValueError___localname___Type4_7228(a);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_testArray___localname___Type5_7494(stdgo._internal.encoding.gob.Gob_T_testArray___localname___Type5_7494.T_testArray___localname___Type5_7494) from stdgo._internal.encoding.gob.Gob_T_testArray___localname___Type5_7494.T_testArray___localname___Type5_7494 to stdgo._internal.encoding.gob.Gob_T_testArray___localname___Type5_7494.T_testArray___localname___Type5_7494 {
    ...
    public function new(?a:haxe.ds.Vector<String>, ?b:haxe.ds.Vector<std.UInt>) this = new stdgo._internal.encoding.gob.Gob_T_testArray___localname___Type5_7494.T_testArray___localname___Type5_7494(([for (i in a) i] : stdgo.GoArray<stdgo.GoString>), ([for (i in b) i] : stdgo.GoArray<stdgo.GoUInt8>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_testArray___localname___Type6_7544(stdgo._internal.encoding.gob.Gob_T_testArray___localname___Type6_7544.T_testArray___localname___Type6_7544) from stdgo._internal.encoding.gob.Gob_T_testArray___localname___Type6_7544.T_testArray___localname___Type6_7544 to stdgo._internal.encoding.gob.Gob_T_testArray___localname___Type6_7544.T_testArray___localname___Type6_7544 {
    public var a(get, set) : haxe.ds.Vector<String>;
    function get_a():haxe.ds.Vector<String> return haxe.ds.Vector.fromArrayCopy([for (i in this.a) i]);
    function set_a(v:haxe.ds.Vector<String>):haxe.ds.Vector<String> {
        this.a = ([for (i in v) i] : stdgo.GoArray<stdgo.GoString>);
    ...
    public function new(?a:haxe.ds.Vector<String>) this = new stdgo._internal.encoding.gob.Gob_T_testArray___localname___Type6_7544.T_testArray___localname___Type6_7544(([for (i in a) i] : stdgo.GoArray<stdgo.GoString>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
@:structInit abstract T_testDefaultsInArray___localname___Type7_8446(stdgo._internal.encoding.gob.Gob_T_testDefaultsInArray___localname___Type7_8446.T_testDefaultsInArray___localname___Type7_8446) from stdgo._internal.encoding.gob.Gob_T_testDefaultsInArray___localname___Type7_8446.T_testDefaultsInArray___localname___Type7_8446 to stdgo._internal.encoding.gob.Gob_T_testDefaultsInArray___localname___Type7_8446.T_testDefaultsInArray___localname___Type7_8446 {
    ...
    public function new(?b:Array<Bool>, ?i:Array<StdTypes.Int>, ?s:Array<String>, ?f:Array<StdTypes.Float>) this = new stdgo._internal.encoding.gob.Gob_T_testDefaultsInArray___localname___Type7_8446.T_testDefaultsInArray___localname___Type7_8446(([for (i in b) i] : stdgo.Slice<Bool>), ([for (i in i) i] : stdgo.Slice<stdgo.GoInt>), ([for (i in s) i] : stdgo.Slice<stdgo.GoString>), ([for (i in f) i] : stdgo.Slice<stdgo.GoFloat64>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_testStructNonStruct___localname___Struct_10305(stdgo._internal.encoding.gob.Gob_T_testStructNonStruct___localname___Struct_10305.T_testStructNonStruct___localname___Struct_10305) from stdgo._internal.encoding.gob.Gob_T_testStructNonStruct___localname___Struct_10305.T_testStructNonStruct___localname___Struct_10305 to stdgo._internal.encoding.gob.Gob_T_testStructNonStruct___localname___Struct_10305.T_testStructNonStruct___localname___Struct_10305 {
    ...
    public function new(?a:String) this = new stdgo._internal.encoding.gob.Gob_T_testStructNonStruct___localname___Struct_10305.T_testStructNonStruct___localname___Struct_10305(a);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
@:structInit abstract T_testDecodeErrorMultipleTypes___localname___Test_26917(stdgo._internal.encoding.gob.Gob_T_testDecodeErrorMultipleTypes___localname___Test_26917.T_testDecodeErrorMultipleTypes___localname___Test_26917) from stdgo._internal.encoding.gob.Gob_T_testDecodeErrorMultipleTypes___localname___Test_26917.T_testDecodeErrorMultipleTypes___localname___Test_26917 to stdgo._internal.encoding.gob.Gob_T_testDecodeErrorMultipleTypes___localname___Test_26917.T_testDecodeErrorMultipleTypes___localname___Test_26917 {
    ...
    public function new(?a:String, ?b:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_T_testDecodeErrorMultipleTypes___localname___Test_26917.T_testDecodeErrorMultipleTypes___localname___Test_26917(a, b);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
@:structInit abstract T_testStressParallel___localname___T2_5091(stdgo._internal.encoding.gob.Gob_T_testStressParallel___localname___T2_5091.T_testStressParallel___localname___T2_5091) from stdgo._internal.encoding.gob.Gob_T_testStressParallel___localname___T2_5091.T_testStressParallel___localname___T2_5091 to stdgo._internal.encoding.gob.Gob_T_testStressParallel___localname___T2_5091.T_testStressParallel___localname___T2_5091 {
    ...
    public function new(?a:StdTypes.Int) this = new stdgo._internal.encoding.gob.Gob_T_testStressParallel___localname___T2_5091.T_testStressParallel___localname___T2_5091(a);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
class Gob {
    ...
    **/
    static public function testUintCodec(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testUintCodec.testUintCodec(_t);
    }
    /**
        Test basic encode/decode routines for signed integers
    **/
    static public function testIntCodec(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    **/
    static public function testScalarEncInstructions(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    /**
        ...
        Do not run the machine yet; instead do individual instructions crafted by hand.
    **/
    static public function testScalarDecInstructions(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testScalarDecInstructions.testScalarDecInstructions(_t);
    }
    static public function testEndToEnd(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    static public function testNesting(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testNesting.testNesting(_t);
    }
    static public function testAutoIndirection(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testAutoIndirection.testAutoIndirection(_t);
    }
    static public function testReorderedFields(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testReorderedFields.testReorderedFields(_t);
    }
    static public function testIgnoredFields(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testIgnoredFields.testIgnoredFields(_t);
    }
    static public function testBadRecursiveType(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testBadRecursiveType.testBadRecursiveType(_t);
    }
    static public function testIndirectSliceMapArray(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testIndirectSliceMapArray.testIndirectSliceMapArray(_t);
    }
    static public function testInterface(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testInterface.testInterface(_t);
    }
    static public function testInterfaceBasic(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    **/
    static public function testInterfacePointer(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testInterfacePointer.testInterfacePointer(_t);
    }
    static public function testIgnoreInterface(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testIgnoreInterface.testIgnoreInterface(_t);
    }
    static public function testUnexportedFields(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testUnexportedFields.testUnexportedFields(_t);
    }
    static public function testDebugSingleton(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testDebugSingleton.testDebugSingleton(_t);
    }
    static public function testDebugStruct(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testDebugStruct.testDebugStruct(_t);
    }
    /**
        This does some "fuzz testing" by attempting to decode a sequence of random bytes.
    **/
    static public function testFuzz(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testFuzz.testFuzz(_t);
    }
    static public function testFuzzRegressions(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    **/
    static public function testFuzzOneByte(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    /**
        ...
        Issue 9649.
    **/
    static public function testErrorInvalidTypeId(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testErrorInvalidTypeId.testErrorInvalidTypeId(_t);
    }
    static public function testLargeSlice(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testLargeSlice.testLargeSlice(_t);
    }
    static public function testLocalRemoteTypesMismatch(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    **/
    static public function testBasicEncoderDecoder(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testBasicEncoderDecoder.testBasicEncoderDecoder(_t);
    }
    static public function testEncodeIntSlice(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    **/
    static public function testWrongTypeDecoder(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testWrongTypeDecoder.testWrongTypeDecoder(_t);
    }
    static public function testUnsupported(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testUnsupported.testUnsupported(_t);
    }
    static public function testTypeToPtrType(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testTypeToPtrType.testTypeToPtrType(_t);
    }
    static public function testPtrTypeToType(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testPtrTypeToType.testPtrTypeToType(_t);
    }
    static public function testTypeToPtrPtrPtrPtrType(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testTypeToPtrPtrPtrPtrType.testTypeToPtrPtrPtrPtrType(_t);
    }
    static public function testSlice(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testSlice.testSlice(_t);
    }
    static public function testValueError(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testValueError.testValueError(_t);
    }
    static public function testArray(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testArray.testArray(_t);
    }
    static public function testRecursiveMapType(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testRecursiveMapType.testRecursiveMapType(_t);
    }
    static public function testRecursiveSliceType(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testRecursiveSliceType.testRecursiveSliceType(_t);
    }
    /**
        Regression test for bug: must send zero values inside arrays
    **/
    static public function testDefaultsInArray(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testDefaultsInArray.testDefaultsInArray(_t);
    }
    static public function testSingletons(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testSingletons.testSingletons(_t);
    }
    static public function testStructNonStruct(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    **/
    static public function testInterfaceIndirect(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testInterfaceIndirect.testInterfaceIndirect(_t);
    }
    static public function testDecodeIntoNothing(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testDecodeIntoNothing.testDecodeIntoNothing(_t);
    }
    static public function testIgnoreRecursiveType(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testIgnoreRecursiveType.testIgnoreRecursiveType(_t);
    }
    static public function testNestedInterfaces(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testNestedInterfaces.testNestedInterfaces(_t);
    }
    static public function testMapBug1(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testMapBug1.testMapBug1(_t);
    }
    static public function testGobMapInterfaceEncode(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testGobMapInterfaceEncode.testGobMapInterfaceEncode(_t);
    }
    static public function testSliceReusesMemory(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testSliceReusesMemory.testSliceReusesMemory(_t);
    }
    /**
        Used to crash: negative count in recvMessage.
    **/
    static public function testBadCount(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    **/
    static public function testSequentialDecoder(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testSequentialDecoder.testSequentialDecoder(_t);
    }
    static public function testChanFuncIgnored(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testChanFuncIgnored.testChanFuncIgnored(_t);
    }
    static public function testSliceIncompatibility(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testSliceIncompatibility.testSliceIncompatibility(_t);
    }
    static public function testGobPtrSlices(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    **/
    static public function testPtrToMapOfMap(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    /**
        ...
        See Issue 16204.
    **/
    static public function testCatchInvalidNilValue(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testCatchInvalidNilValue.testCatchInvalidNilValue(_t);
    }
    /**
        A top-level nil pointer generates a panic with a helpful string-valued message.
    **/
    static public function testTopLevelNilPointer(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testTopLevelNilPointer.testTopLevelNilPointer(_t);
    }
    static public function testNilPointerPanics(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testNilPointerPanics.testNilPointerPanics(_t);
    }
    static public function testNilPointerInsideInterface(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    /**
        ...
        Issue 3723.
    **/
    static public function testMutipleEncodingsOfBadType(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testMutipleEncodingsOfBadType.testMutipleEncodingsOfBadType(_t);
    }
    static public function test29ElementSlice(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    /**
        ...
        Issue 8084.
    **/
    static public function testErrorForHugeSlice(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    **/
    static public function testBadData(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testBadData.testBadData(_t);
    }
    static public function testDecodeErrorMultipleTypes(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testDecodeErrorMultipleTypes.testDecodeErrorMultipleTypes(_t);
    }
    /**
        Issue 24075
    **/
    static public function testMarshalFloatMap(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testMarshalFloatMap.testMarshalFloatMap(_t);
    }
    static public function testDecodePartial(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testDecodePartial.testDecodePartial(_t);
    }
    static public function testDecoderOverflow(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testDecoderOverflow.testDecoderOverflow(_t);
    }
    static public function testGobEncoderField(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    **/
    static public function testGobEncoderValueField(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    **/
    static public function testGobEncoderIndirectField(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testGobEncoderIndirectField.testGobEncoderIndirectField(_t);
    }
    /**
        Test with a large field with methods.
    **/
    static public function testGobEncoderArrayField(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testGobEncoderArrayField.testGobEncoderArrayField(_t);
    }
    /**
        Test an indirection to a large field with methods.
    **/
    static public function testGobEncoderIndirectArrayField(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    /**
        ...
        defeat the purpose.
    **/
    static public function testGobEncoderFieldsOfDifferentType(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testGobEncoderFieldsOfDifferentType.testGobEncoderFieldsOfDifferentType(_t);
    }
    /**
        Test that we can encode a value and decode into a pointer.
    **/
    static public function testGobEncoderValueEncoder(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    **/
    static public function testGobEncoderValueThenPointer(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    **/
    static public function testGobEncoderPointerThenValue(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testGobEncoderPointerThenValue.testGobEncoderPointerThenValue(_t);
    }
    static public function testGobEncoderFieldTypeError(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testGobEncoderFieldTypeError.testGobEncoderFieldTypeError(_t);
    }
    /**
        Even though ByteStruct is a struct, it's treated as a singleton at the top level.
    **/
    static public function testGobEncoderStructSingleton(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testGobEncoderStructSingleton.testGobEncoderStructSingleton(_t);
    }
    static public function testGobEncoderNonStructSingleton(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testGobEncoderNonStructSingleton.testGobEncoderNonStructSingleton(_t);
    }
    static public function testGobEncoderIgnoreStructField(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testGobEncoderIgnoreStructField.testGobEncoderIgnoreStructField(_t);
    }
    static public function testGobEncoderIgnoreNonStructField(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testGobEncoderIgnoreNonStructField.testGobEncoderIgnoreNonStructField(_t);
    }
    static public function testGobEncoderIgnoreNilEncoder(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    /**
        ...
        than the variable.
    **/
    static public function testGobEncoderExtraIndirect(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testGobEncoderExtraIndirect.testGobEncoderExtraIndirect(_t);
    }
    static public function testGobEncodeIsZero(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testGobEncodeIsZero.testGobEncodeIsZero(_t);
    }
    static public function testGobEncodePtrError(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testGobEncodePtrError.testGobEncodePtrError(_t);
    }
    static public function testNetIP(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testNetIP.testNetIP(_t);
    }
    static public function testIgnoreDepthLimit(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testIgnoreDepthLimit.testIgnoreDepthLimit(_t);
    }
    static public function benchmarkEndToEndPipe(_b:stdgo._internal.testing.Testing_B.B):Void {
        stdgo._internal.encoding.gob.Gob_benchmarkEndToEndPipe.benchmarkEndToEndPipe(_b);
    }
    static public function benchmarkEndToEndByteBuffer(_b:stdgo._internal.testing.Testing_B.B):Void {
        stdgo._internal.encoding.gob.Gob_benchmarkEndToEndByteBuffer.benchmarkEndToEndByteBuffer(_b);
    }
    static public function benchmarkEndToEndSliceByteBuffer(_b:stdgo._internal.testing.Testing_B.B):Void {
        stdgo._internal.encoding.gob.Gob_benchmarkEndToEndSliceByteBuffer.benchmarkEndToEndSliceByteBuffer(_b);
    }
    static public function testCountEncodeMallocs(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testCountEncodeMallocs.testCountEncodeMallocs(_t);
    }
    static public function testCountDecodeMallocs(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testCountDecodeMallocs.testCountDecodeMallocs(_t);
    }
    static public function benchmarkEncodeComplex128Slice(_b:stdgo._internal.testing.Testing_B.B):Void {
        stdgo._internal.encoding.gob.Gob_benchmarkEncodeComplex128Slice.benchmarkEncodeComplex128Slice(_b);
    }
    static public function benchmarkEncodeFloat64Slice(_b:stdgo._internal.testing.Testing_B.B):Void {
        stdgo._internal.encoding.gob.Gob_benchmarkEncodeFloat64Slice.benchmarkEncodeFloat64Slice(_b);
    }
    static public function benchmarkEncodeInt32Slice(_b:stdgo._internal.testing.Testing_B.B):Void {
        stdgo._internal.encoding.gob.Gob_benchmarkEncodeInt32Slice.benchmarkEncodeInt32Slice(_b);
    }
    static public function benchmarkEncodeStringSlice(_b:stdgo._internal.testing.Testing_B.B):Void {
        stdgo._internal.encoding.gob.Gob_benchmarkEncodeStringSlice.benchmarkEncodeStringSlice(_b);
    }
    static public function benchmarkEncodeInterfaceSlice(_b:stdgo._internal.testing.Testing_B.B):Void {
        stdgo._internal.encoding.gob.Gob_benchmarkEncodeInterfaceSlice.benchmarkEncodeInterfaceSlice(_b);
    }
    static public function benchmarkDecodeComplex128Slice(_b:stdgo._internal.testing.Testing_B.B):Void {
        stdgo._internal.encoding.gob.Gob_benchmarkDecodeComplex128Slice.benchmarkDecodeComplex128Slice(_b);
    }
    static public function benchmarkDecodeFloat64Slice(_b:stdgo._internal.testing.Testing_B.B):Void {
        stdgo._internal.encoding.gob.Gob_benchmarkDecodeFloat64Slice.benchmarkDecodeFloat64Slice(_b);
    }
    static public function benchmarkDecodeInt32Slice(_b:stdgo._internal.testing.Testing_B.B):Void {
        stdgo._internal.encoding.gob.Gob_benchmarkDecodeInt32Slice.benchmarkDecodeInt32Slice(_b);
    }
    static public function benchmarkDecodeStringSlice(_b:stdgo._internal.testing.Testing_B.B):Void {
        stdgo._internal.encoding.gob.Gob_benchmarkDecodeStringSlice.benchmarkDecodeStringSlice(_b);
    }
    static public function benchmarkDecodeStringsSlice(_b:stdgo._internal.testing.Testing_B.B):Void {
        stdgo._internal.encoding.gob.Gob_benchmarkDecodeStringsSlice.benchmarkDecodeStringsSlice(_b);
    }
    static public function benchmarkDecodeBytesSlice(_b:stdgo._internal.testing.Testing_B.B):Void {
        stdgo._internal.encoding.gob.Gob_benchmarkDecodeBytesSlice.benchmarkDecodeBytesSlice(_b);
    }
    static public function benchmarkDecodeInterfaceSlice(_b:stdgo._internal.testing.Testing_B.B):Void {
        stdgo._internal.encoding.gob.Gob_benchmarkDecodeInterfaceSlice.benchmarkDecodeInterfaceSlice(_b);
    }
    static public function benchmarkDecodeMap(_b:stdgo._internal.testing.Testing_B.B):Void {
    ...
    **/
    ...
    /**
        Sanity checks
    **/
    static public function testBasic(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testBasic.testBasic(_t);
    }
    /**
        Reregister some basic types to check registration is idempotent.
    **/
    static public function testReregistration(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testReregistration.testReregistration(_t);
    }
    static public function testArrayType(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testArrayType.testArrayType(_t);
    }
    static public function testSliceType(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testSliceType.testSliceType(_t);
    }
    static public function testMapType(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testMapType.testMapType(_t);
    }
    static public function testStructType(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    **/
    static public function testRegistration(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testRegistration.testRegistration(_t);
    }
    /**
        See comment in type.go/Register.
    **/
    static public function testRegistrationNaming(_t:stdgo._internal.testing.Testing_T_.T_):Void {
        stdgo._internal.encoding.gob.Gob_testRegistrationNaming.testRegistrationNaming(_t);
    }
    static public function testStressParallel(_t:stdgo._internal.testing.Testing_T_.T_):Void {
    ...
    **/
    static public function testTypeRace(_t:stdgo._internal.testing.Testing_T_.T_):Void {
