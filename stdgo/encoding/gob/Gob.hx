...
@:named typedef T_testBadRecursiveType_130___localname___Rec = stdgo.StdGoTypes.Ref<stdgo.StdGoTypes.Ref<stdgo.StdGoTypes.Ref<stdgo.encoding.gob.Gob.T_testBadRecursiveType_130___localname___Rec>>>;
function testBadRecursiveType(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        {};
        var _rec:T_testBadRecursiveType_130___localname___Rec = new stdgo.encoding.gob.Gob.T_testBadRecursiveType_130___localname___Rec();
        var _b = (stdgo.Go.setRef(({} : stdgo.bytes.Bytes.Buffer)) : stdgo.StdGoTypes.Ref<stdgo.bytes.Bytes.Buffer>);
...
function testTypeToPtrPtrPtrPtrType(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _t2pppp = (stdgo.Go.setRef((null : stdgo.StdGoTypes.Ref<stdgo.StdGoTypes.Ref<stdgo.StdGoTypes.Ref<stdgo.encoding.gob.Gob.T_testTypeToPtrPtrPtrPtrType_133___localname___Type2>>>)) : stdgo.StdGoTypes.Ref<stdgo.StdGoTypes.Ref<stdgo.StdGoTypes.Ref<stdgo.StdGoTypes.Ref<stdgo.encoding.gob.Gob.T_testTypeToPtrPtrPtrPtrType_133___localname___Type2>>>>);
        {
        ...
        if ((((((((_t2pppp : stdgo.StdGoTypes.Ref<stdgo.StdGoTypes.Ref<stdgo.StdGoTypes.Ref<stdgo.encoding.gob.Gob.T_testTypeToPtrPtrPtrPtrType_133___localname___Type2>>>) : stdgo.StdGoTypes.Ref<stdgo.StdGoTypes.Ref<stdgo.encoding.gob.Gob.T_testTypeToPtrPtrPtrPtrType_133___localname___Type2>>) : stdgo.StdGoTypes.Ref<stdgo.encoding.gob.Gob.T_testTypeToPtrPtrPtrPtrType_133___localname___Type2>) : stdgo.encoding.gob.Gob.T_testTypeToPtrPtrPtrPtrType_133___localname___Type2).a : stdgo.StdGoTypes.Ref<stdgo.StdGoTypes.Ref<stdgo.Pointer<stdgo.StdGoTypes.GoFloat64>>>) : stdgo.StdGoTypes.Ref<stdgo.Pointer<stdgo.StdGoTypes.GoFloat64>>) : stdgo.Pointer<stdgo.StdGoTypes.GoFloat64>).value != ((((_t2.a : stdgo.StdGoTypes.Ref<stdgo.StdGoTypes.Ref<stdgo.Pointer<stdgo.StdGoTypes.GoFloat64>>>) : stdgo.StdGoTypes.Ref<stdgo.Pointer<stdgo.StdGoTypes.GoFloat64>>) : stdgo.Pointer<stdgo.StdGoTypes.GoFloat64>).value)) {
            _t.errorf(("wrong value after decode: %g not %g" : stdgo.GoString), stdgo.Go.toInterface((((((((_t2pppp : stdgo.StdGoTypes.Ref<stdgo.StdGoTypes.Ref<stdgo.StdGoTypes.Ref<stdgo.encoding.gob.Gob.T_testTypeToPtrPtrPtrPtrType_133___localname___Type2>>>) : stdgo.StdGoTypes.Ref<stdgo.StdGoTypes.Ref<stdgo.encoding.gob.Gob.T_testTypeToPtrPtrPtrPtrType_133___localname___Type2>>) : stdgo.StdGoTypes.Ref<stdgo.encoding.gob.Gob.T_testTypeToPtrPtrPtrPtrType_133___localname___Type2>) : stdgo.encoding.gob.Gob.T_testTypeToPtrPtrPtrPtrType_133___localname___Type2).a : stdgo.StdGoTypes.Ref<stdgo.StdGoTypes.Ref<stdgo.Pointer<stdgo.StdGoTypes.GoFloat64>>>) : stdgo.StdGoTypes.Ref<stdgo.Pointer<stdgo.StdGoTypes.GoFloat64>>) : stdgo.Pointer<stdgo.StdGoTypes.GoFloat64>).value), stdgo.Go.toInterface((((_t2.a : stdgo.StdGoTypes.Ref<stdgo.StdGoTypes.Ref<stdgo.Pointer<stdgo.StdGoTypes.GoFloat64>>>) : stdgo.StdGoTypes.Ref<stdgo.Pointer<stdgo.StdGoTypes.GoFloat64>>) : stdgo.Pointer<stdgo.StdGoTypes.GoFloat64>).value));
        };
    }
/**
