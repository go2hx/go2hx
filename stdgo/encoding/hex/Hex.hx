...
@:named class InvalidByteError {
	...
	public function __copy__()
		return new InvalidByteError(__t__);
}
...
@:structInit class T_encoder {
	...
	public function new(?_w:stdgo.io.Io.Writer, ?_err:stdgo.Error, ?_out:GoArray<GoUInt8>)
...
@:structInit class T_decoder {
	public function read(_p:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
		...
		if (_d.value._in.length < ((2 : GoInt)) && _d.value._err == null) {
			...
			if (Go.toInterface(_d.value._err) == Go.toInterface(stdgo.io.Io.eof) && _d.value._in.length % ((2 : GoInt)) != ((0 : GoInt))) {
				{
					var __tmp__ = _fromHexChar(_d.value._in[_d.value._in.length - ((1 : GoInt))]),
						_:GoUInt8 = __tmp__._0,
						_ok:Bool = __tmp__._1;
					if (!_ok) {
		...
		var __tmp__ = decode(_p, _d.value._in.__slice__(0, _p.length * ((2 : GoInt)))),
			_numDec:GoInt = __tmp__._0,
	...
	public function new(?_r:stdgo.io.Io.Reader, ?_err:stdgo.Error, ?_in:Slice<GoUInt8>, ?_arr:GoArray<GoUInt8>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_dumper {
	...
	public function toString() {
		return '{' + Go.string(_w) + " " + Go.string(_rightChars) + " " + Go.string(_buf) + " " + Go.string(_used) + " " + Go.string(_n) + " "
			+ Go.string(_closed) + "}";
	}
...
function decode(_dst:Slice<GoByte>, _src:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
	...
	Go.cfor(_j < _src.length, _j = _j + (((2 : GoInt))), {
		var __tmp__ = _fromHexChar(_src[_j - ((1 : GoInt))]),
			_a:GoUInt8 = __tmp__._0,
			_ok:Bool = __tmp__._1;
		if (!_ok) {
			return {_0: _i, _1: new InvalidByteError(_src[_j - ((1 : GoInt))])};
		};
		var __tmp__ = _fromHexChar(_src[_j]),
...
function newDecoder(_r:stdgo.io.Io.Reader):stdgo.io.Io.Reader {
	return Go.pointer((({
		...
		_in: new Slice<GoUInt8>().nil(),
		_arr: new GoArray<GoUInt8>(...[for (i in 0...1024) ((0 : GoUInt8))])
	} : T_decoder))).value;
}
...
function dumper(_w:stdgo.io.Io.Writer):stdgo.io.Io.WriteCloser {
	return Go.pointer((({
		_w: _w,
		_rightChars: new GoArray<GoUInt8>(...[for (i in 0...18) ((0 : GoUInt8))]),
		_buf: new GoArray<GoUInt8>(...[for (i in 0...14) ((0 : GoUInt8))]),
		_used: 0,
		_n: 0,
		_closed: false
	} : T_dumper))).value;
