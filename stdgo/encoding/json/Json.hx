...
/**
    /|*{
    	...
    	gotoNext = 5404006
    	_ = gotoNext == 5404006
    	if !InputBreak && (scanp_5403861 >= 0) {
    		gotoNext = 5404021
    		_ = gotoNext == 5404021
    		_ = 0
    		gotoNext = 5404067
    		_ = gotoNext == 5404067
    		if scanp_5403861 < len(dec.buf) {
    			gotoNext = 5404103
    			_ = gotoNext == 5404103
    			c_5404108 = dec.buf[scanp_5403861]
    			dec.scan.bytes++
    			gotoNext = 5404151
    			_ = gotoNext == 5404151
    			switch dec.scan.step(&dec.scan, c_5404108) {
    			case 10:
    				gotoNext = 5404191
    				_ = gotoNext == 5404191
    				dec.scan.bytes--
    		...
    		if err_5403885 != nil {
    			...
    			if err_5403885 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5404959
    					_ = gotoNext == 5404959
    					err_5403885 = io.ErrUnexpectedEOF
    					gotoNext = 5405006
    				} else {
    					gotoNext = 5405006
    				}
    			...
    			_ = gotoNext == 5405006
    			dec.err = err_5403885
    			return 0, err_5403885
    			gotoNext = 5405044
    		} else {
    			gotoNext = 5405044
    		}
    		_ = gotoNext == 5405044
    		n_5405044 = scanp_5403861 - dec.scanp
    		err_5403885 = dec.refill()
    		scanp_5403861 = dec.scanp + n_5405044
    		gotoNext = 5404006
    	} else {
    		gotoNext = 5405116
    	}
    	_ = gotoNext == 5405116
    	return scanp_5403861 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
