...
/**
    /|*{
    	...
    	gotoNext = 5522847
    	_ = gotoNext == 5522847
    	if !InputBreak && (scanp_5522702 >= 0) {
    		gotoNext = 5522862
    		_ = gotoNext == 5522862
    		_ = 0
    		gotoNext = 5522908
    		_ = gotoNext == 5522908
    		if scanp_5522702 < len(dec.buf) {
    			gotoNext = 5522944
    			_ = gotoNext == 5522944
    			c_5522949 = dec.buf[scanp_5522702]
    			dec.scan.bytes++
    			_ = 0
    			gotoNext = 5522992
    			_ = gotoNext == 5522992
    			switch dec.scan.step(&dec.scan, c_5522949) {
    			case 10:
    				gotoNext = 5523032
    				_ = gotoNext == 5523032
    				dec.scan.bytes--
    		...
    		if err_5522726 != nil {
    			...
    			if err_5522726 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5523800
    					_ = gotoNext == 5523800
    					err_5522726 = io.ErrUnexpectedEOF
    					gotoNext = 5523847
    				} else {
    					gotoNext = 5523847
    				}
    			...
    			_ = gotoNext == 5523847
    			dec.err = err_5522726
    			return 0, err_5522726
    			gotoNext = 5523885
    		} else {
    			gotoNext = 5523885
    		}
    		_ = gotoNext == 5523885
    		n_5523885 = scanp_5522702 - dec.scanp
    		err_5522726 = dec.refill()
    		scanp_5522702 = dec.scanp + n_5523885
    		gotoNext = 5522847
    	} else {
    		gotoNext = 5523957
    	}
    	_ = gotoNext == 5523957
    	return scanp_5522702 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
