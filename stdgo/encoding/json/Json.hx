...
/**
    /|*{
    	...
    	gotoNext = 6867940
    	_ = gotoNext == 6867940
    	if !InputBreak && (scanp_6867795 >= 0) {
    		gotoNext = 6867955
    		_ = gotoNext == 6867955
    		_ = 0
    		gotoNext = 6868001
    		_ = gotoNext == 6868001
    		if scanp_6867795 < len(dec.buf) {
    			gotoNext = 6868037
    			_ = gotoNext == 6868037
    			c_6868042 = dec.buf[scanp_6867795]
    			dec.scan.bytes++
    			gotoNext = 6868085
    			_ = gotoNext == 6868085
    			switch dec.scan.step(&dec.scan, c_6868042) {
    			case 10:
    				gotoNext = 6868125
    				_ = gotoNext == 6868125
    				dec.scan.bytes--
    		...
    		if err_6867819 != nil {
    			...
    			if err_6867819 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 6868893
    					_ = gotoNext == 6868893
    					err_6867819 = io.ErrUnexpectedEOF
    					gotoNext = 6868940
    				} else {
    					gotoNext = 6868940
    				}
    			...
    			_ = gotoNext == 6868940
    			dec.err = err_6867819
    			return 0, err_6867819
    			gotoNext = 6868978
    		} else {
    			gotoNext = 6868978
    		}
    		_ = gotoNext == 6868978
    		n_6868978 = scanp_6867795 - dec.scanp
    		err_6867819 = dec.refill()
    		scanp_6867795 = dec.scanp + n_6868978
    		gotoNext = 6867940
    	} else {
    		gotoNext = 6869050
    	}
    	_ = gotoNext == 6869050
    	return scanp_6867795 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
