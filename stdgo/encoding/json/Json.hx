...
/**
    /|*{
    	...
    	gotoNext = 5378169
    	_ = gotoNext == 5378169
    	if !InputBreak && (scanp_5378024 >= 0) {
    		gotoNext = 5378184
    		_ = gotoNext == 5378184
    		_ = 0
    		gotoNext = 5378230
    		_ = gotoNext == 5378230
    		if scanp_5378024 < len(dec.buf) {
    			gotoNext = 5378266
    			_ = gotoNext == 5378266
    			c_5378271 = dec.buf[scanp_5378024]
    			dec.scan.bytes++
    			gotoNext = 5378314
    			_ = gotoNext == 5378314
    			switch dec.scan.step(&dec.scan, c_5378271) {
    			case 10:
    				gotoNext = 5378354
    				_ = gotoNext == 5378354
    				dec.scan.bytes--
    		...
    		if err_5378048 != nil {
    			...
    			if err_5378048 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5379122
    					_ = gotoNext == 5379122
    					err_5378048 = io.ErrUnexpectedEOF
    					gotoNext = 5379169
    				} else {
    					gotoNext = 5379169
    				}
    			...
    			_ = gotoNext == 5379169
    			dec.err = err_5378048
    			return 0, err_5378048
    			gotoNext = 5379207
    		} else {
    			gotoNext = 5379207
    		}
    		_ = gotoNext == 5379207
    		n_5379207 = scanp_5378024 - dec.scanp
    		err_5378048 = dec.refill()
    		scanp_5378024 = dec.scanp + n_5379207
    		gotoNext = 5378169
    	} else {
    		gotoNext = 5379279
    	}
    	_ = gotoNext == 5379279
    	return scanp_5378024 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
