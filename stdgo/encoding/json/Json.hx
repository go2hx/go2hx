...
/**
    /|*{
    	...
    	gotoNext = 5388186
    	_ = gotoNext == 5388186
    	if !InputBreak && (scanp_5388041 >= 0) {
    		gotoNext = 5388201
    		_ = gotoNext == 5388201
    		_ = 0
    		gotoNext = 5388247
    		_ = gotoNext == 5388247
    		if scanp_5388041 < len(dec.buf) {
    			gotoNext = 5388283
    			_ = gotoNext == 5388283
    			c_5388288 = dec.buf[scanp_5388041]
    			dec.scan.bytes++
    			gotoNext = 5388331
    			_ = gotoNext == 5388331
    			switch dec.scan.step(&dec.scan, c_5388288) {
    			case 10:
    				gotoNext = 5388371
    				_ = gotoNext == 5388371
    				dec.scan.bytes--
    		...
    		if err_5388065 != nil {
    			...
    			if err_5388065 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5389139
    					_ = gotoNext == 5389139
    					err_5388065 = io.ErrUnexpectedEOF
    					gotoNext = 5389186
    				} else {
    					gotoNext = 5389186
    				}
    			...
    			_ = gotoNext == 5389186
    			dec.err = err_5388065
    			return 0, err_5388065
    			gotoNext = 5389224
    		} else {
    			gotoNext = 5389224
    		}
    		_ = gotoNext == 5389224
    		n_5389224 = scanp_5388041 - dec.scanp
    		err_5388065 = dec.refill()
    		scanp_5388041 = dec.scanp + n_5389224
    		gotoNext = 5388186
    	} else {
    		gotoNext = 5389296
    	}
    	_ = gotoNext == 5389296
    	return scanp_5388041 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
