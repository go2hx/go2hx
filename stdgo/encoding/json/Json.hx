...
/**
    /|*{
    	...
    	gotoNext = 5802042
    	_ = gotoNext == 5802042
    	if !InputBreak && (scanp_5801897 >= 0) {
    		gotoNext = 5802057
    		_ = gotoNext == 5802057
    		_ = 0
    		gotoNext = 5802103
    		_ = gotoNext == 5802103
    		if scanp_5801897 < len(dec.buf) {
    			gotoNext = 5802139
    			_ = gotoNext == 5802139
    			c_5802144 = dec.buf[scanp_5801897]
    			dec.scan.bytes++
    			gotoNext = 5802187
    			_ = gotoNext == 5802187
    			switch dec.scan.step(&dec.scan, c_5802144) {
    			case 10:
    				gotoNext = 5802227
    				_ = gotoNext == 5802227
    				dec.scan.bytes--
    		...
    		if err_5801921 != nil {
    			...
    			if err_5801921 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5802995
    					_ = gotoNext == 5802995
    					err_5801921 = io.ErrUnexpectedEOF
    					gotoNext = 5803042
    				} else {
    					gotoNext = 5803042
    				}
    			...
    			_ = gotoNext == 5803042
    			dec.err = err_5801921
    			return 0, err_5801921
    			gotoNext = 5803080
    		} else {
    			gotoNext = 5803080
    		}
    		_ = gotoNext == 5803080
    		n_5803080 = scanp_5801897 - dec.scanp
    		err_5801921 = dec.refill()
    		scanp_5801897 = dec.scanp + n_5803080
    		gotoNext = 5802042
    	} else {
    		gotoNext = 5803152
    	}
    	_ = gotoNext == 5803152
    	return scanp_5801897 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
