...
/**
    /|*{
    	...
    	gotoNext = 5424359
    	_ = gotoNext == 5424359
    	if !InputBreak && (scanp_5424214 >= 0) {
    		gotoNext = 5424374
    		_ = gotoNext == 5424374
    		_ = 0
    		gotoNext = 5424420
    		_ = gotoNext == 5424420
    		if scanp_5424214 < len(dec.buf) {
    			gotoNext = 5424456
    			_ = gotoNext == 5424456
    			c_5424461 = dec.buf[scanp_5424214]
    			dec.scan.bytes++
    			gotoNext = 5424504
    			_ = gotoNext == 5424504
    			switch dec.scan.step(&dec.scan, c_5424461) {
    			case 10:
    				gotoNext = 5424544
    				_ = gotoNext == 5424544
    				dec.scan.bytes--
    		...
    		if err_5424238 != nil {
    			...
    			if err_5424238 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5425312
    					_ = gotoNext == 5425312
    					err_5424238 = io.ErrUnexpectedEOF
    					gotoNext = 5425359
    				} else {
    					gotoNext = 5425359
    				}
    			...
    			_ = gotoNext == 5425359
    			dec.err = err_5424238
    			return 0, err_5424238
    			gotoNext = 5425397
    		} else {
    			gotoNext = 5425397
    		}
    		_ = gotoNext == 5425397
    		n_5425397 = scanp_5424214 - dec.scanp
    		err_5424238 = dec.refill()
    		scanp_5424214 = dec.scanp + n_5425397
    		gotoNext = 5424359
    	} else {
    		gotoNext = 5425469
    	}
    	_ = gotoNext == 5425469
    	return scanp_5424214 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
