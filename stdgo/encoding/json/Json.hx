...
/**
    /|*{
    	...
    	gotoNext = 5353093
    	_ = gotoNext == 5353093
    	if !InputBreak && (scanp_5352948 >= 0) {
    		gotoNext = 5353108
    		_ = gotoNext == 5353108
    		_ = 0
    		gotoNext = 5353154
    		_ = gotoNext == 5353154
    		if scanp_5352948 < len(dec.buf) {
    			gotoNext = 5353190
    			_ = gotoNext == 5353190
    			c_5353195 = dec.buf[scanp_5352948]
    			dec.scan.bytes++
    			_ = 0
    			gotoNext = 5353238
    			_ = gotoNext == 5353238
    			switch dec.scan.step(&dec.scan, c_5353195) {
    			case 10:
    				gotoNext = 5353278
    				_ = gotoNext == 5353278
    				dec.scan.bytes--
    		...
    		if err_5352972 != nil {
    			...
    			if err_5352972 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5354046
    					_ = gotoNext == 5354046
    					err_5352972 = io.ErrUnexpectedEOF
    					gotoNext = 5354093
    				} else {
    					gotoNext = 5354093
    				}
    			...
    			_ = gotoNext == 5354093
    			dec.err = err_5352972
    			return 0, err_5352972
    			gotoNext = 5354131
    		} else {
    			gotoNext = 5354131
    		}
    		_ = gotoNext == 5354131
    		n_5354131 = scanp_5352948 - dec.scanp
    		err_5352972 = dec.refill()
    		scanp_5352948 = dec.scanp + n_5354131
    		gotoNext = 5353093
    	} else {
    		gotoNext = 5354203
    	}
    	_ = gotoNext == 5354203
    	return scanp_5352948 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
