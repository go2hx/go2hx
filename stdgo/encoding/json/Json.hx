...
/**
    /|*{
    	...
    	gotoNext = 6762640
    	_ = gotoNext == 6762640
    	if !InputBreak && (scanp_6762495 >= 0) {
    		gotoNext = 6762655
    		_ = gotoNext == 6762655
    		_ = 0
    		gotoNext = 6762701
    		_ = gotoNext == 6762701
    		if scanp_6762495 < len(dec.buf) {
    			gotoNext = 6762737
    			_ = gotoNext == 6762737
    			c_6762742 = dec.buf[scanp_6762495]
    			dec.scan.bytes++
    			_ = 0
    			gotoNext = 6762785
    			_ = gotoNext == 6762785
    			switch dec.scan.step(&dec.scan, c_6762742) {
    			case 10:
    				gotoNext = 6762825
    				_ = gotoNext == 6762825
    				dec.scan.bytes--
    		...
    		if err_6762519 != nil {
    			...
    			if err_6762519 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 6763593
    					_ = gotoNext == 6763593
    					err_6762519 = io.ErrUnexpectedEOF
    					gotoNext = 6763640
    				} else {
    					gotoNext = 6763640
    				}
    			...
    			_ = gotoNext == 6763640
    			dec.err = err_6762519
    			return 0, err_6762519
    			gotoNext = 6763678
    		} else {
    			gotoNext = 6763678
    		}
    		_ = gotoNext == 6763678
    		n_6763678 = scanp_6762495 - dec.scanp
    		err_6762519 = dec.refill()
    		scanp_6762495 = dec.scanp + n_6763678
    		gotoNext = 6762640
    	} else {
    		gotoNext = 6763750
    	}
    	_ = gotoNext == 6763750
    	return scanp_6762495 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
