...
/**
    /|*{
    	...
    	gotoNext = 5469956
    	_ = gotoNext == 5469956
    	if !InputBreak && (scanp_5469811 >= 0) {
    		gotoNext = 5469971
    		_ = gotoNext == 5469971
    		_ = 0
    		gotoNext = 5470017
    		_ = gotoNext == 5470017
    		if scanp_5469811 < len(dec.buf) {
    			gotoNext = 5470053
    			_ = gotoNext == 5470053
    			c_5470058 = dec.buf[scanp_5469811]
    			dec.scan.bytes++
    			_ = 0
    			gotoNext = 5470101
    			_ = gotoNext == 5470101
    			switch dec.scan.step(&dec.scan, c_5470058) {
    			case 10:
    				gotoNext = 5470141
    				_ = gotoNext == 5470141
    				dec.scan.bytes--
    		...
    		if err_5469835 != nil {
    			...
    			if err_5469835 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5470909
    					_ = gotoNext == 5470909
    					err_5469835 = io.ErrUnexpectedEOF
    					gotoNext = 5470956
    				} else {
    					gotoNext = 5470956
    				}
    			...
    			_ = gotoNext == 5470956
    			dec.err = err_5469835
    			return 0, err_5469835
    			gotoNext = 5470994
    		} else {
    			gotoNext = 5470994
    		}
    		_ = gotoNext == 5470994
    		n_5470994 = scanp_5469811 - dec.scanp
    		err_5469835 = dec.refill()
    		scanp_5469811 = dec.scanp + n_5470994
    		gotoNext = 5469956
    	} else {
    		gotoNext = 5471066
    	}
    	_ = gotoNext == 5471066
    	return scanp_5469811 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
