...
/**
    /|*{
    	...
    	gotoNext = 5158230
    	_ = gotoNext == 5158230
    	if !InputBreak && (scanp_5158085 >= 0) {
    		gotoNext = 5158245
    		_ = gotoNext == 5158245
    		_ = 0
    		gotoNext = 5158291
    		_ = gotoNext == 5158291
    		if scanp_5158085 < len(dec.buf) {
    			gotoNext = 5158327
    			_ = gotoNext == 5158327
    			c_5158332 = dec.buf[scanp_5158085]
    			dec.scan.bytes++
    			gotoNext = 5158375
    			_ = gotoNext == 5158375
    			switch dec.scan.step(&dec.scan, c_5158332) {
    			case 10:
    				gotoNext = 5158415
    				_ = gotoNext == 5158415
    				dec.scan.bytes--
    		...
    		if err_5158109 != nil {
    			...
    			if err_5158109 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5159183
    					_ = gotoNext == 5159183
    					err_5158109 = io.ErrUnexpectedEOF
    					gotoNext = 5159230
    				} else {
    					gotoNext = 5159230
    				}
    			...
    			_ = gotoNext == 5159230
    			dec.err = err_5158109
    			return 0, err_5158109
    			gotoNext = 5159268
    		} else {
    			gotoNext = 5159268
    		}
    		_ = gotoNext == 5159268
    		n_5159268 = scanp_5158085 - dec.scanp
    		err_5158109 = dec.refill()
    		scanp_5158085 = dec.scanp + n_5159268
    		gotoNext = 5158230
    	} else {
    		gotoNext = 5159340
    	}
    	_ = gotoNext == 5159340
    	return scanp_5158085 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
