...
/**
    /|*{
    	...
    	gotoNext = 5666898
    	_ = gotoNext == 5666898
    	if !InputBreak && (scanp_5666753 >= 0) {
    		gotoNext = 5666913
    		_ = gotoNext == 5666913
    		_ = 0
    		gotoNext = 5666959
    		_ = gotoNext == 5666959
    		if scanp_5666753 < len(dec.buf) {
    			gotoNext = 5666995
    			_ = gotoNext == 5666995
    			c_5667000 = dec.buf[scanp_5666753]
    			dec.scan.bytes++
    			_ = 0
    			gotoNext = 5667043
    			_ = gotoNext == 5667043
    			switch dec.scan.step(&dec.scan, c_5667000) {
    			case 10:
    				gotoNext = 5667083
    				_ = gotoNext == 5667083
    				dec.scan.bytes--
    		...
    		if err_5666777 != nil {
    			...
    			if err_5666777 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5667851
    					_ = gotoNext == 5667851
    					err_5666777 = io.ErrUnexpectedEOF
    					gotoNext = 5667898
    				} else {
    					gotoNext = 5667898
    				}
    			...
    			_ = gotoNext == 5667898
    			dec.err = err_5666777
    			return 0, err_5666777
    			gotoNext = 5667936
    		} else {
    			gotoNext = 5667936
    		}
    		_ = gotoNext == 5667936
    		n_5667936 = scanp_5666753 - dec.scanp
    		err_5666777 = dec.refill()
    		scanp_5666753 = dec.scanp + n_5667936
    		gotoNext = 5666898
    	} else {
    		gotoNext = 5668008
    	}
    	_ = gotoNext == 5668008
    	return scanp_5666753 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
