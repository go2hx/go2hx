...
/**
    /|*{
    	...
    	gotoNext = 5952401
    	_ = gotoNext == 5952401
    	if !InputBreak && (scanp_5952256 >= 0) {
    		gotoNext = 5952416
    		_ = gotoNext == 5952416
    		_ = 0
    		gotoNext = 5952462
    		_ = gotoNext == 5952462
    		if scanp_5952256 < len(dec.buf) {
    			gotoNext = 5952498
    			_ = gotoNext == 5952498
    			c_5952503 = dec.buf[scanp_5952256]
    			dec.scan.bytes++
    			_ = 0
    			gotoNext = 5952546
    			_ = gotoNext == 5952546
    			switch dec.scan.step(&dec.scan, c_5952503) {
    			case 10:
    				gotoNext = 5952586
    				_ = gotoNext == 5952586
    				dec.scan.bytes--
    		...
    		if err_5952280 != nil {
    			...
    			if err_5952280 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5953354
    					_ = gotoNext == 5953354
    					err_5952280 = io.ErrUnexpectedEOF
    					gotoNext = 5953401
    				} else {
    					gotoNext = 5953401
    				}
    			...
    			_ = gotoNext == 5953401
    			dec.err = err_5952280
    			return 0, err_5952280
    			gotoNext = 5953439
    		} else {
    			gotoNext = 5953439
    		}
    		_ = gotoNext == 5953439
    		n_5953439 = scanp_5952256 - dec.scanp
    		err_5952280 = dec.refill()
    		scanp_5952256 = dec.scanp + n_5953439
    		gotoNext = 5952401
    	} else {
    		gotoNext = 5953511
    	}
    	_ = gotoNext == 5953511
    	return scanp_5952256 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
