...
/**
    /|*{
    	...
    	gotoNext = 5421401
    	_ = gotoNext == 5421401
    	if !InputBreak && (scanp_5421256 >= 0) {
    		gotoNext = 5421416
    		_ = gotoNext == 5421416
    		_ = 0
    		gotoNext = 5421462
    		_ = gotoNext == 5421462
    		if scanp_5421256 < len(dec.buf) {
    			gotoNext = 5421498
    			_ = gotoNext == 5421498
    			c_5421503 = dec.buf[scanp_5421256]
    			dec.scan.bytes++
    			gotoNext = 5421546
    			_ = gotoNext == 5421546
    			switch dec.scan.step(&dec.scan, c_5421503) {
    			case 10:
    				gotoNext = 5421586
    				_ = gotoNext == 5421586
    				dec.scan.bytes--
    		...
    		if err_5421280 != nil {
    			...
    			if err_5421280 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5422354
    					_ = gotoNext == 5422354
    					err_5421280 = io.ErrUnexpectedEOF
    					gotoNext = 5422401
    				} else {
    					gotoNext = 5422401
    				}
    			...
    			_ = gotoNext == 5422401
    			dec.err = err_5421280
    			return 0, err_5421280
    			gotoNext = 5422439
    		} else {
    			gotoNext = 5422439
    		}
    		_ = gotoNext == 5422439
    		n_5422439 = scanp_5421256 - dec.scanp
    		err_5421280 = dec.refill()
    		scanp_5421256 = dec.scanp + n_5422439
    		gotoNext = 5421401
    	} else {
    		gotoNext = 5422511
    	}
    	_ = gotoNext == 5422511
    	return scanp_5421256 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
