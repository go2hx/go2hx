...
/**
    /|*{
    	...
    	gotoNext = 5433399
    	_ = gotoNext == 5433399
    	if !InputBreak && (scanp_5433254 >= 0) {
    		gotoNext = 5433414
    		_ = gotoNext == 5433414
    		_ = 0
    		gotoNext = 5433460
    		_ = gotoNext == 5433460
    		if scanp_5433254 < len(dec.buf) {
    			gotoNext = 5433496
    			_ = gotoNext == 5433496
    			c_5433501 = dec.buf[scanp_5433254]
    			dec.scan.bytes++
    			gotoNext = 5433544
    			_ = gotoNext == 5433544
    			switch dec.scan.step(&dec.scan, c_5433501) {
    			case 10:
    				gotoNext = 5433584
    				_ = gotoNext == 5433584
    				dec.scan.bytes--
    		...
    		if err_5433278 != nil {
    			...
    			if err_5433278 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5434352
    					_ = gotoNext == 5434352
    					err_5433278 = io.ErrUnexpectedEOF
    					gotoNext = 5434399
    				} else {
    					gotoNext = 5434399
    				}
    			...
    			_ = gotoNext == 5434399
    			dec.err = err_5433278
    			return 0, err_5433278
    			gotoNext = 5434437
    		} else {
    			gotoNext = 5434437
    		}
    		_ = gotoNext == 5434437
    		n_5434437 = scanp_5433254 - dec.scanp
    		err_5433278 = dec.refill()
    		scanp_5433254 = dec.scanp + n_5434437
    		gotoNext = 5433399
    	} else {
    		gotoNext = 5434509
    	}
    	_ = gotoNext == 5434509
    	return scanp_5433254 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
