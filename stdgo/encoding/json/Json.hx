...
/**
    /|*{
    	...
    	gotoNext = 5338358
    	_ = gotoNext == 5338358
    	if !InputBreak && (scanp_5338213 >= 0) {
    		gotoNext = 5338373
    		_ = gotoNext == 5338373
    		_ = 0
    		gotoNext = 5338419
    		_ = gotoNext == 5338419
    		if scanp_5338213 < len(dec.buf) {
    			gotoNext = 5338455
    			_ = gotoNext == 5338455
    			c_5338460 = dec.buf[scanp_5338213]
    			dec.scan.bytes++
    			_ = 0
    			gotoNext = 5338503
    			_ = gotoNext == 5338503
    			switch dec.scan.step(&dec.scan, c_5338460) {
    			case 10:
    				gotoNext = 5338543
    				_ = gotoNext == 5338543
    				dec.scan.bytes--
    		...
    		if err_5338237 != nil {
    			...
    			if err_5338237 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5339311
    					_ = gotoNext == 5339311
    					err_5338237 = io.ErrUnexpectedEOF
    					gotoNext = 5339358
    				} else {
    					gotoNext = 5339358
    				}
    			...
    			_ = gotoNext == 5339358
    			dec.err = err_5338237
    			return 0, err_5338237
    			gotoNext = 5339396
    		} else {
    			gotoNext = 5339396
    		}
    		_ = gotoNext == 5339396
    		n_5339396 = scanp_5338213 - dec.scanp
    		err_5338237 = dec.refill()
    		scanp_5338213 = dec.scanp + n_5339396
    		gotoNext = 5338358
    	} else {
    		gotoNext = 5339468
    	}
    	_ = gotoNext == 5339468
    	return scanp_5338213 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
