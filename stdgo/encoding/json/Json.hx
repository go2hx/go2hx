...
/**
    /|*{
    	...
    	gotoNext = 6646676
    	_ = gotoNext == 6646676
    	if !InputBreak && (scanp_6646531 >= 0) {
    		gotoNext = 6646691
    		_ = gotoNext == 6646691
    		_ = 0
    		gotoNext = 6646737
    		_ = gotoNext == 6646737
    		if scanp_6646531 < len(dec.buf) {
    			gotoNext = 6646773
    			_ = gotoNext == 6646773
    			c_6646778 = dec.buf[scanp_6646531]
    			dec.scan.bytes++
    			_ = 0
    			gotoNext = 6646821
    			_ = gotoNext == 6646821
    			switch dec.scan.step(&dec.scan, c_6646778) {
    			case 10:
    				gotoNext = 6646861
    				_ = gotoNext == 6646861
    				dec.scan.bytes--
    		...
    		if err_6646555 != nil {
    			...
    			if err_6646555 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 6647629
    					_ = gotoNext == 6647629
    					err_6646555 = io.ErrUnexpectedEOF
    					gotoNext = 6647676
    				} else {
    					gotoNext = 6647676
    				}
    			...
    			_ = gotoNext == 6647676
    			dec.err = err_6646555
    			return 0, err_6646555
    			gotoNext = 6647714
    		} else {
    			gotoNext = 6647714
    		}
    		_ = gotoNext == 6647714
    		n_6647714 = scanp_6646531 - dec.scanp
    		err_6646555 = dec.refill()
    		scanp_6646531 = dec.scanp + n_6647714
    		gotoNext = 6646676
    	} else {
    		gotoNext = 6647786
    	}
    	_ = gotoNext == 6647786
    	return scanp_6646531 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
