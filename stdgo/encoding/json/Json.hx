...
/**
    /|*{
    	...
    	gotoNext = 5368985
    	_ = gotoNext == 5368985
    	if !InputBreak && (scanp_5368840 >= 0) {
    		gotoNext = 5369000
    		_ = gotoNext == 5369000
    		_ = 0
    		gotoNext = 5369046
    		_ = gotoNext == 5369046
    		if scanp_5368840 < len(dec.buf) {
    			gotoNext = 5369082
    			_ = gotoNext == 5369082
    			c_5369087 = dec.buf[scanp_5368840]
    			dec.scan.bytes++
    			gotoNext = 5369130
    			_ = gotoNext == 5369130
    			switch dec.scan.step(&dec.scan, c_5369087) {
    			case 10:
    				gotoNext = 5369170
    				_ = gotoNext == 5369170
    				dec.scan.bytes--
    		...
    		if err_5368864 != nil {
    			...
    			if err_5368864 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5369938
    					_ = gotoNext == 5369938
    					err_5368864 = io.ErrUnexpectedEOF
    					gotoNext = 5369985
    				} else {
    					gotoNext = 5369985
    				}
    			...
    			_ = gotoNext == 5369985
    			dec.err = err_5368864
    			return 0, err_5368864
    			gotoNext = 5370023
    		} else {
    			gotoNext = 5370023
    		}
    		_ = gotoNext == 5370023
    		n_5370023 = scanp_5368840 - dec.scanp
    		err_5368864 = dec.refill()
    		scanp_5368840 = dec.scanp + n_5370023
    		gotoNext = 5368985
    	} else {
    		gotoNext = 5370095
    	}
    	_ = gotoNext == 5370095
    	return scanp_5368840 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
