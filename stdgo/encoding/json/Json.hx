...
/**
    /|*{
    	...
    	gotoNext = 5805559
    	_ = gotoNext == 5805559
    	if !InputBreak && (scanp_5805414 >= 0) {
    		gotoNext = 5805574
    		_ = gotoNext == 5805574
    		_ = 0
    		gotoNext = 5805620
    		_ = gotoNext == 5805620
    		if scanp_5805414 < len(dec.buf) {
    			gotoNext = 5805656
    			_ = gotoNext == 5805656
    			c_5805661 = dec.buf[scanp_5805414]
    			dec.scan.bytes++
    			gotoNext = 5805704
    			_ = gotoNext == 5805704
    			switch dec.scan.step(&dec.scan, c_5805661) {
    			case 10:
    				gotoNext = 5805744
    				_ = gotoNext == 5805744
    				dec.scan.bytes--
    		...
    		if err_5805438 != nil {
    			...
    			if err_5805438 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5806512
    					_ = gotoNext == 5806512
    					err_5805438 = io.ErrUnexpectedEOF
    					gotoNext = 5806559
    				} else {
    					gotoNext = 5806559
    				}
    			...
    			_ = gotoNext == 5806559
    			dec.err = err_5805438
    			return 0, err_5805438
    			gotoNext = 5806597
    		} else {
    			gotoNext = 5806597
    		}
    		_ = gotoNext == 5806597
    		n_5806597 = scanp_5805414 - dec.scanp
    		err_5805438 = dec.refill()
    		scanp_5805414 = dec.scanp + n_5806597
    		gotoNext = 5805559
    	} else {
    		gotoNext = 5806669
    	}
    	_ = gotoNext == 5806669
    	return scanp_5805414 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
