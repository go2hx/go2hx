...
/**
    /|*{
    	...
    	gotoNext = 5325763
    	_ = gotoNext == 5325763
    	if !InputBreak && (scanp_5325618 >= 0) {
    		gotoNext = 5325778
    		_ = gotoNext == 5325778
    		_ = 0
    		gotoNext = 5325824
    		_ = gotoNext == 5325824
    		if scanp_5325618 < len(dec.buf) {
    			gotoNext = 5325860
    			_ = gotoNext == 5325860
    			c_5325865 = dec.buf[scanp_5325618]
    			dec.scan.bytes++
    			gotoNext = 5325908
    			_ = gotoNext == 5325908
    			switch dec.scan.step(&dec.scan, c_5325865) {
    			case 10:
    				gotoNext = 5325948
    				_ = gotoNext == 5325948
    				dec.scan.bytes--
    		...
    		if err_5325642 != nil {
    			...
    			if err_5325642 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5326716
    					_ = gotoNext == 5326716
    					err_5325642 = io.ErrUnexpectedEOF
    					gotoNext = 5326763
    				} else {
    					gotoNext = 5326763
    				}
    			...
    			_ = gotoNext == 5326763
    			dec.err = err_5325642
    			return 0, err_5325642
    			gotoNext = 5326801
    		} else {
    			gotoNext = 5326801
    		}
    		_ = gotoNext == 5326801
    		n_5326801 = scanp_5325618 - dec.scanp
    		err_5325642 = dec.refill()
    		scanp_5325618 = dec.scanp + n_5326801
    		gotoNext = 5325763
    	} else {
    		gotoNext = 5326873
    	}
    	_ = gotoNext == 5326873
    	return scanp_5325618 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
