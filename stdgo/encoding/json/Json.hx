...
/**
    /|*{
    	...
    	gotoNext = 5374981
    	_ = gotoNext == 5374981
    	if !InputBreak && (scanp_5374836 >= 0) {
    		gotoNext = 5374996
    		_ = gotoNext == 5374996
    		_ = 0
    		gotoNext = 5375042
    		_ = gotoNext == 5375042
    		if scanp_5374836 < len(dec.buf) {
    			gotoNext = 5375078
    			_ = gotoNext == 5375078
    			c_5375083 = dec.buf[scanp_5374836]
    			dec.scan.bytes++
    			gotoNext = 5375126
    			_ = gotoNext == 5375126
    			switch dec.scan.step(&dec.scan, c_5375083) {
    			case 10:
    				gotoNext = 5375166
    				_ = gotoNext == 5375166
    				dec.scan.bytes--
    		...
    		if err_5374860 != nil {
    			...
    			if err_5374860 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5375934
    					_ = gotoNext == 5375934
    					err_5374860 = io.ErrUnexpectedEOF
    					gotoNext = 5375981
    				} else {
    					gotoNext = 5375981
    				}
    			...
    			_ = gotoNext == 5375981
    			dec.err = err_5374860
    			return 0, err_5374860
    			gotoNext = 5376019
    		} else {
    			gotoNext = 5376019
    		}
    		_ = gotoNext == 5376019
    		n_5376019 = scanp_5374836 - dec.scanp
    		err_5374860 = dec.refill()
    		scanp_5374836 = dec.scanp + n_5376019
    		gotoNext = 5374981
    	} else {
    		gotoNext = 5376091
    	}
    	_ = gotoNext == 5376091
    	return scanp_5374836 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
