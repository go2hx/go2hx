...
/**
    /|*{
    	...
    	gotoNext = 6424774
    	_ = gotoNext == 6424774
    	if !InputBreak && (scanp_6424629 >= 0) {
    		gotoNext = 6424789
    		_ = gotoNext == 6424789
    		_ = 0
    		gotoNext = 6424835
    		_ = gotoNext == 6424835
    		if scanp_6424629 < len(dec.buf) {
    			gotoNext = 6424871
    			_ = gotoNext == 6424871
    			c_6424876 = dec.buf[scanp_6424629]
    			dec.scan.bytes++
    			gotoNext = 6424919
    			_ = gotoNext == 6424919
    			switch dec.scan.step(&dec.scan, c_6424876) {
    			case 10:
    				gotoNext = 6424959
    				_ = gotoNext == 6424959
    				dec.scan.bytes--
    		...
    		if err_6424653 != nil {
    			...
    			if err_6424653 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 6425727
    					_ = gotoNext == 6425727
    					err_6424653 = io.ErrUnexpectedEOF
    					gotoNext = 6425774
    				} else {
    					gotoNext = 6425774
    				}
    			...
    			_ = gotoNext == 6425774
    			dec.err = err_6424653
    			return 0, err_6424653
    			gotoNext = 6425812
    		} else {
    			gotoNext = 6425812
    		}
    		_ = gotoNext == 6425812
    		n_6425812 = scanp_6424629 - dec.scanp
    		err_6424653 = dec.refill()
    		scanp_6424629 = dec.scanp + n_6425812
    		gotoNext = 6424774
    	} else {
    		gotoNext = 6425884
    	}
    	_ = gotoNext == 6425884
    	return scanp_6424629 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
