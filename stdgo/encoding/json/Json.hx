...
/**
    /|*{
    	...
    	gotoNext = 5493974
    	_ = gotoNext == 5493974
    	if !InputBreak && (scanp_5493829 >= 0) {
    		gotoNext = 5493989
    		_ = gotoNext == 5493989
    		_ = 0
    		gotoNext = 5494035
    		_ = gotoNext == 5494035
    		if scanp_5493829 < len(dec.buf) {
    			gotoNext = 5494071
    			_ = gotoNext == 5494071
    			c_5494076 = dec.buf[scanp_5493829]
    			dec.scan.bytes++
    			gotoNext = 5494119
    			_ = gotoNext == 5494119
    			switch dec.scan.step(&dec.scan, c_5494076) {
    			case 10:
    				gotoNext = 5494159
    				_ = gotoNext == 5494159
    				dec.scan.bytes--
    		...
    		if err_5493853 != nil {
    			...
    			if err_5493853 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5494927
    					_ = gotoNext == 5494927
    					err_5493853 = io.ErrUnexpectedEOF
    					gotoNext = 5494974
    				} else {
    					gotoNext = 5494974
    				}
    			...
    			_ = gotoNext == 5494974
    			dec.err = err_5493853
    			return 0, err_5493853
    			gotoNext = 5495012
    		} else {
    			gotoNext = 5495012
    		}
    		_ = gotoNext == 5495012
    		n_5495012 = scanp_5493829 - dec.scanp
    		err_5493853 = dec.refill()
    		scanp_5493829 = dec.scanp + n_5495012
    		gotoNext = 5493974
    	} else {
    		gotoNext = 5495084
    	}
    	_ = gotoNext == 5495084
    	return scanp_5493829 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
