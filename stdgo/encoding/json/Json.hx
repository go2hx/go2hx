...
/**
    /|*{
    	...
    	gotoNext = 5967368
    	_ = gotoNext == 5967368
    	if !InputBreak && (scanp_5967223 >= 0) {
    		gotoNext = 5967383
    		_ = gotoNext == 5967383
    		_ = 0
    		gotoNext = 5967429
    		_ = gotoNext == 5967429
    		if scanp_5967223 < len(dec.buf) {
    			gotoNext = 5967465
    			_ = gotoNext == 5967465
    			c_5967470 = dec.buf[scanp_5967223]
    			dec.scan.bytes++
    			gotoNext = 5967513
    			_ = gotoNext == 5967513
    			switch dec.scan.step(&dec.scan, c_5967470) {
    			case 10:
    				gotoNext = 5967553
    				_ = gotoNext == 5967553
    				dec.scan.bytes--
    		...
    		if err_5967247 != nil {
    			...
    			if err_5967247 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5968321
    					_ = gotoNext == 5968321
    					err_5967247 = io.ErrUnexpectedEOF
    					gotoNext = 5968368
    				} else {
    					gotoNext = 5968368
    				}
    			...
    			_ = gotoNext == 5968368
    			dec.err = err_5967247
    			return 0, err_5967247
    			gotoNext = 5968406
    		} else {
    			gotoNext = 5968406
    		}
    		_ = gotoNext == 5968406
    		n_5968406 = scanp_5967223 - dec.scanp
    		err_5967247 = dec.refill()
    		scanp_5967223 = dec.scanp + n_5968406
    		gotoNext = 5967368
    	} else {
    		gotoNext = 5968478
    	}
    	_ = gotoNext == 5968478
    	return scanp_5967223 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
