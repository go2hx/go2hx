...
/**
    /|*{
    	...
    	gotoNext = 6355659
    	_ = gotoNext == 6355659
    	if !InputBreak && (scanp_6355514 >= 0) {
    		gotoNext = 6355674
    		_ = gotoNext == 6355674
    		_ = 0
    		gotoNext = 6355720
    		_ = gotoNext == 6355720
    		if scanp_6355514 < len(dec.buf) {
    			gotoNext = 6355756
    			_ = gotoNext == 6355756
    			c_6355761 = dec.buf[scanp_6355514]
    			dec.scan.bytes++
    			gotoNext = 6355804
    			_ = gotoNext == 6355804
    			switch dec.scan.step(&dec.scan, c_6355761) {
    			case 10:
    				gotoNext = 6355844
    				_ = gotoNext == 6355844
    				dec.scan.bytes--
    		...
    		if err_6355538 != nil {
    			...
    			if err_6355538 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 6356612
    					_ = gotoNext == 6356612
    					err_6355538 = io.ErrUnexpectedEOF
    					gotoNext = 6356659
    				} else {
    					gotoNext = 6356659
    				}
    			...
    			_ = gotoNext == 6356659
    			dec.err = err_6355538
    			return 0, err_6355538
    			gotoNext = 6356697
    		} else {
    			gotoNext = 6356697
    		}
    		_ = gotoNext == 6356697
    		n_6356697 = scanp_6355514 - dec.scanp
    		err_6355538 = dec.refill()
    		scanp_6355514 = dec.scanp + n_6356697
    		gotoNext = 6355659
    	} else {
    		gotoNext = 6356769
    	}
    	_ = gotoNext == 6356769
    	return scanp_6355514 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
