...
/**
    /|*{
    	...
    	gotoNext = 5564975
    	_ = gotoNext == 5564975
    	if !InputBreak && (scanp_5564830 >= 0) {
    		gotoNext = 5564990
    		_ = gotoNext == 5564990
    		_ = 0
    		gotoNext = 5565036
    		_ = gotoNext == 5565036
    		if scanp_5564830 < len(dec.buf) {
    			gotoNext = 5565072
    			_ = gotoNext == 5565072
    			c_5565077 = dec.buf[scanp_5564830]
    			dec.scan.bytes++
    			gotoNext = 5565120
    			_ = gotoNext == 5565120
    			switch dec.scan.step(&dec.scan, c_5565077) {
    			case 10:
    				gotoNext = 5565160
    				_ = gotoNext == 5565160
    				dec.scan.bytes--
    		...
    		if err_5564854 != nil {
    			...
    			if err_5564854 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5565928
    					_ = gotoNext == 5565928
    					err_5564854 = io.ErrUnexpectedEOF
    					gotoNext = 5565975
    				} else {
    					gotoNext = 5565975
    				}
    			...
    			_ = gotoNext == 5565975
    			dec.err = err_5564854
    			return 0, err_5564854
    			gotoNext = 5566013
    		} else {
    			gotoNext = 5566013
    		}
    		_ = gotoNext == 5566013
    		n_5566013 = scanp_5564830 - dec.scanp
    		err_5564854 = dec.refill()
    		scanp_5564830 = dec.scanp + n_5566013
    		gotoNext = 5564975
    	} else {
    		gotoNext = 5566085
    	}
    	_ = gotoNext == 5566085
    	return scanp_5564830 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
