...
/**
    /|*{
    	...
    	gotoNext = 6707179
    	_ = gotoNext == 6707179
    	if !InputBreak && (scanp_6707034 >= 0) {
    		gotoNext = 6707194
    		_ = gotoNext == 6707194
    		_ = 0
    		gotoNext = 6707240
    		_ = gotoNext == 6707240
    		if scanp_6707034 < len(dec.buf) {
    			gotoNext = 6707276
    			_ = gotoNext == 6707276
    			c_6707281 = dec.buf[scanp_6707034]
    			dec.scan.bytes++
    			gotoNext = 6707324
    			_ = gotoNext == 6707324
    			switch dec.scan.step(&dec.scan, c_6707281) {
    			case 10:
    				gotoNext = 6707364
    				_ = gotoNext == 6707364
    				dec.scan.bytes--
    		...
    		if err_6707058 != nil {
    			...
    			if err_6707058 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 6708132
    					_ = gotoNext == 6708132
    					err_6707058 = io.ErrUnexpectedEOF
    					gotoNext = 6708179
    				} else {
    					gotoNext = 6708179
    				}
    			...
    			_ = gotoNext == 6708179
    			dec.err = err_6707058
    			return 0, err_6707058
    			gotoNext = 6708217
    		} else {
    			gotoNext = 6708217
    		}
    		_ = gotoNext == 6708217
    		n_6708217 = scanp_6707034 - dec.scanp
    		err_6707058 = dec.refill()
    		scanp_6707034 = dec.scanp + n_6708217
    		gotoNext = 6707179
    	} else {
    		gotoNext = 6708289
    	}
    	_ = gotoNext == 6708289
    	return scanp_6707034 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
