...
/**
    /|*{
    	...
    	gotoNext = 5421204
    	_ = gotoNext == 5421204
    	if !InputBreak && (scanp_5421059 >= 0) {
    		gotoNext = 5421219
    		_ = gotoNext == 5421219
    		_ = 0
    		gotoNext = 5421265
    		_ = gotoNext == 5421265
    		if scanp_5421059 < len(dec.buf) {
    			gotoNext = 5421301
    			_ = gotoNext == 5421301
    			c_5421306 = dec.buf[scanp_5421059]
    			dec.scan.bytes++
    			gotoNext = 5421349
    			_ = gotoNext == 5421349
    			switch dec.scan.step(&dec.scan, c_5421306) {
    			case 10:
    				gotoNext = 5421389
    				_ = gotoNext == 5421389
    				dec.scan.bytes--
    		...
    		if err_5421083 != nil {
    			...
    			if err_5421083 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5422157
    					_ = gotoNext == 5422157
    					err_5421083 = io.ErrUnexpectedEOF
    					gotoNext = 5422204
    				} else {
    					gotoNext = 5422204
    				}
    			...
    			_ = gotoNext == 5422204
    			dec.err = err_5421083
    			return 0, err_5421083
    			gotoNext = 5422242
    		} else {
    			gotoNext = 5422242
    		}
    		_ = gotoNext == 5422242
    		n_5422242 = scanp_5421059 - dec.scanp
    		err_5421083 = dec.refill()
    		scanp_5421059 = dec.scanp + n_5422242
    		gotoNext = 5421204
    	} else {
    		gotoNext = 5422314
    	}
    	_ = gotoNext == 5422314
    	return scanp_5421059 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
