...
/**
    /|*{
    	...
    	gotoNext = 5454848
    	_ = gotoNext == 5454848
    	if !InputBreak && (scanp_5454703 >= 0) {
    		gotoNext = 5454863
    		_ = gotoNext == 5454863
    		_ = 0
    		gotoNext = 5454909
    		_ = gotoNext == 5454909
    		if scanp_5454703 < len(dec.buf) {
    			gotoNext = 5454945
    			_ = gotoNext == 5454945
    			c_5454950 = dec.buf[scanp_5454703]
    			dec.scan.bytes++
    			gotoNext = 5454993
    			_ = gotoNext == 5454993
    			switch dec.scan.step(&dec.scan, c_5454950) {
    			case 10:
    				gotoNext = 5455033
    				_ = gotoNext == 5455033
    				dec.scan.bytes--
    		...
    		if err_5454727 != nil {
    			...
    			if err_5454727 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5455801
    					_ = gotoNext == 5455801
    					err_5454727 = io.ErrUnexpectedEOF
    					gotoNext = 5455848
    				} else {
    					gotoNext = 5455848
    				}
    			...
    			_ = gotoNext == 5455848
    			dec.err = err_5454727
    			return 0, err_5454727
    			gotoNext = 5455886
    		} else {
    			gotoNext = 5455886
    		}
    		_ = gotoNext == 5455886
    		n_5455886 = scanp_5454703 - dec.scanp
    		err_5454727 = dec.refill()
    		scanp_5454703 = dec.scanp + n_5455886
    		gotoNext = 5454848
    	} else {
    		gotoNext = 5455958
    	}
    	_ = gotoNext == 5455958
    	return scanp_5454703 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
