...
/**
    /|*{
    	...
    	gotoNext = 5485576
    	_ = gotoNext == 5485576
    	if !InputBreak && (scanp_5485431 >= 0) {
    		gotoNext = 5485591
    		_ = gotoNext == 5485591
    		_ = 0
    		gotoNext = 5485637
    		_ = gotoNext == 5485637
    		if scanp_5485431 < len(dec.buf) {
    			gotoNext = 5485673
    			_ = gotoNext == 5485673
    			c_5485678 = dec.buf[scanp_5485431]
    			dec.scan.bytes++
    			gotoNext = 5485721
    			_ = gotoNext == 5485721
    			switch dec.scan.step(&dec.scan, c_5485678) {
    			case 10:
    				gotoNext = 5485761
    				_ = gotoNext == 5485761
    				dec.scan.bytes--
    		...
    		if err_5485455 != nil {
    			...
    			if err_5485455 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5486529
    					_ = gotoNext == 5486529
    					err_5485455 = io.ErrUnexpectedEOF
    					gotoNext = 5486576
    				} else {
    					gotoNext = 5486576
    				}
    			...
    			_ = gotoNext == 5486576
    			dec.err = err_5485455
    			return 0, err_5485455
    			gotoNext = 5486614
    		} else {
    			gotoNext = 5486614
    		}
    		_ = gotoNext == 5486614
    		n_5486614 = scanp_5485431 - dec.scanp
    		err_5485455 = dec.refill()
    		scanp_5485431 = dec.scanp + n_5486614
    		gotoNext = 5485576
    	} else {
    		gotoNext = 5486686
    	}
    	_ = gotoNext == 5486686
    	return scanp_5485431 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
