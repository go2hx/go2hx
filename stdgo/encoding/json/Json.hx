...
/**
    /|*{
    	...
    	gotoNext = 5329951
    	_ = gotoNext == 5329951
    	if !InputBreak && (scanp_5329806 >= 0) {
    		gotoNext = 5329966
    		_ = gotoNext == 5329966
    		_ = 0
    		gotoNext = 5330012
    		_ = gotoNext == 5330012
    		if scanp_5329806 < len(dec.buf) {
    			gotoNext = 5330048
    			_ = gotoNext == 5330048
    			c_5330053 = dec.buf[scanp_5329806]
    			dec.scan.bytes++
    			gotoNext = 5330096
    			_ = gotoNext == 5330096
    			switch dec.scan.step(&dec.scan, c_5330053) {
    			case 10:
    				gotoNext = 5330136
    				_ = gotoNext == 5330136
    				dec.scan.bytes--
    		...
    		if err_5329830 != nil {
    			...
    			if err_5329830 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5330904
    					_ = gotoNext == 5330904
    					err_5329830 = io.ErrUnexpectedEOF
    					gotoNext = 5330951
    				} else {
    					gotoNext = 5330951
    				}
    			...
    			_ = gotoNext == 5330951
    			dec.err = err_5329830
    			return 0, err_5329830
    			gotoNext = 5330989
    		} else {
    			gotoNext = 5330989
    		}
    		_ = gotoNext == 5330989
    		n_5330989 = scanp_5329806 - dec.scanp
    		err_5329830 = dec.refill()
    		scanp_5329806 = dec.scanp + n_5330989
    		gotoNext = 5329951
    	} else {
    		gotoNext = 5331061
    	}
    	_ = gotoNext == 5331061
    	return scanp_5329806 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
