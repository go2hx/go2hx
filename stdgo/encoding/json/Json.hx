...
/**
    /|*{
    	...
    	gotoNext = 5428183
    	_ = gotoNext == 5428183
    	if !InputBreak && (scanp_5428038 >= 0) {
    		gotoNext = 5428198
    		_ = gotoNext == 5428198
    		_ = 0
    		gotoNext = 5428244
    		_ = gotoNext == 5428244
    		if scanp_5428038 < len(dec.buf) {
    			gotoNext = 5428280
    			_ = gotoNext == 5428280
    			c_5428285 = dec.buf[scanp_5428038]
    			dec.scan.bytes++
    			_ = 0
    			gotoNext = 5428328
    			_ = gotoNext == 5428328
    			switch dec.scan.step(&dec.scan, c_5428285) {
    			case 10:
    				gotoNext = 5428368
    				_ = gotoNext == 5428368
    				dec.scan.bytes--
    		...
    		if err_5428062 != nil {
    			...
    			if err_5428062 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5429136
    					_ = gotoNext == 5429136
    					err_5428062 = io.ErrUnexpectedEOF
    					gotoNext = 5429183
    				} else {
    					gotoNext = 5429183
    				}
    			...
    			_ = gotoNext == 5429183
    			dec.err = err_5428062
    			return 0, err_5428062
    			gotoNext = 5429221
    		} else {
    			gotoNext = 5429221
    		}
    		_ = gotoNext == 5429221
    		n_5429221 = scanp_5428038 - dec.scanp
    		err_5428062 = dec.refill()
    		scanp_5428038 = dec.scanp + n_5429221
    		gotoNext = 5428183
    	} else {
    		gotoNext = 5429293
    	}
    	_ = gotoNext == 5429293
    	return scanp_5428038 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
