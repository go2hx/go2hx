...
/**
    /|*{
    	...
    	gotoNext = 5445276
    	_ = gotoNext == 5445276
    	if !InputBreak && (scanp_5445131 >= 0) {
    		gotoNext = 5445291
    		_ = gotoNext == 5445291
    		_ = 0
    		gotoNext = 5445337
    		_ = gotoNext == 5445337
    		if scanp_5445131 < len(dec.buf) {
    			gotoNext = 5445373
    			_ = gotoNext == 5445373
    			c_5445378 = dec.buf[scanp_5445131]
    			dec.scan.bytes++
    			gotoNext = 5445421
    			_ = gotoNext == 5445421
    			switch dec.scan.step(&dec.scan, c_5445378) {
    			case 10:
    				gotoNext = 5445461
    				_ = gotoNext == 5445461
    				dec.scan.bytes--
    		...
    		if err_5445155 != nil {
    			...
    			if err_5445155 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5446229
    					_ = gotoNext == 5446229
    					err_5445155 = io.ErrUnexpectedEOF
    					gotoNext = 5446276
    				} else {
    					gotoNext = 5446276
    				}
    			...
    			_ = gotoNext == 5446276
    			dec.err = err_5445155
    			return 0, err_5445155
    			gotoNext = 5446314
    		} else {
    			gotoNext = 5446314
    		}
    		_ = gotoNext == 5446314
    		n_5446314 = scanp_5445131 - dec.scanp
    		err_5445155 = dec.refill()
    		scanp_5445131 = dec.scanp + n_5446314
    		gotoNext = 5445276
    	} else {
    		gotoNext = 5446386
    	}
    	_ = gotoNext == 5446386
    	return scanp_5445131 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
