...
/**
    /|*{
    	...
    	gotoNext = 5427878
    	_ = gotoNext == 5427878
    	if !InputBreak && (scanp_5427733 >= 0) {
    		gotoNext = 5427893
    		_ = gotoNext == 5427893
    		_ = 0
    		gotoNext = 5427939
    		_ = gotoNext == 5427939
    		if scanp_5427733 < len(dec.buf) {
    			gotoNext = 5427975
    			_ = gotoNext == 5427975
    			c_5427980 = dec.buf[scanp_5427733]
    			dec.scan.bytes++
    			gotoNext = 5428023
    			_ = gotoNext == 5428023
    			switch dec.scan.step(&dec.scan, c_5427980) {
    			case 10:
    				gotoNext = 5428063
    				_ = gotoNext == 5428063
    				dec.scan.bytes--
    		...
    		if err_5427757 != nil {
    			...
    			if err_5427757 == io.EOF {
    				...
    				if nonSpace(dec.buf) {
    					gotoNext = 5428831
    					_ = gotoNext == 5428831
    					err_5427757 = io.ErrUnexpectedEOF
    					gotoNext = 5428878
    				} else {
    					gotoNext = 5428878
    				}
    			...
    			_ = gotoNext == 5428878
    			dec.err = err_5427757
    			return 0, err_5427757
    			gotoNext = 5428916
    		} else {
    			gotoNext = 5428916
    		}
    		_ = gotoNext == 5428916
    		n_5428916 = scanp_5427733 - dec.scanp
    		err_5427757 = dec.refill()
    		scanp_5427733 = dec.scanp + n_5428916
    		gotoNext = 5427878
    	} else {
    		gotoNext = 5428988
    	}
    	_ = gotoNext == 5428988
    	return scanp_5427733 - dec.scanp, nil
    	gotoNext = -1
    }*|/
**/
class Json {
