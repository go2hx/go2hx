                        ...
                        while (_i < (_src.length)) {
                            {
                                ...
                                if (_b < (128 : stdgo.GoUInt8)) {
                                    if (@:privateAccess stdgo.encoding.json.Json._htmlSafeSet[(_b : stdgo.GoInt)] || (!_escapeHTML && @:privateAccess stdgo.encoding.json.Json._safeSet[(_b : stdgo.GoInt)])) {
                                        _i++;
                                        continue;
                                    };
                                    _dst = (_dst.__append__(...(_src.__slice__(_start, _i) : $Bytes).__toArray__()));
                                    {
                                        ...
                                        if (__value__ == ((92 : stdgo.GoUInt8)) || __value__ == ((34 : stdgo.GoUInt8))) {
                                            ...
                                            _dst = (_dst.__append__((92 : stdgo.GoUInt8), (117 : stdgo.GoUInt8), (48 : stdgo.GoUInt8), (48 : stdgo.GoUInt8), @:privateAccess stdgo.encoding.json.Json._hex[(_b >> (4i64 : stdgo.GoUInt64) : stdgo.GoInt)], @:privateAccess stdgo.encoding.json.Json._hex[(_b & (15 : stdgo.GoUInt8) : stdgo.GoInt)]));
                                        };
                                    };
                                    _i++;
                                    _start = _i;
                            ...
                            var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRuneInString(((_src.__slice__(_i, _i + _n) : $Bytes) : stdgo.GoString).__copy__()), _c:stdgo.GoInt32 = __tmp__._0, _size:stdgo.GoInt = __tmp__._1;
                            ...
                            if ((_c == (8232 : stdgo.GoInt32)) || (_c == (8233 : stdgo.GoInt32))) {
                                _dst = (_dst.__append__(...(_src.__slice__(_start, _i) : $Bytes).__toArray__()));
                                _dst = (_dst.__append__((92 : stdgo.GoUInt8), (117 : stdgo.GoUInt8), (50 : stdgo.GoUInt8), (48 : stdgo.GoUInt8), (50 : stdgo.GoUInt8), @:privateAccess stdgo.encoding.json.Json._hex[(_c & (15 : stdgo.GoInt32) : stdgo.GoInt)]));
                                _i = _i + (_size);
                                _start = _i;
                                continue;
                            };
