...
[30;41m ERROR [0m stdgo/encoding/json/Json.hx:5: characters 94-95

    5 | [2m        return stdgo._internal.encoding.json.Json.Unmarshaler_static_extension.unmarshalJSON([0m[1mt[0m[2m, _0);[0m
      |                                                                                              [31m^[0m
      | stdgo.encoding.json.Unmarshaler should be stdgo._internal.encoding.json.Unmarshaler
