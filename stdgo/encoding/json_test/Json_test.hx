...
function exampleMarshal():Void {
        {};
        var _group:stdgo.encoding.json_test.Json_test.T_exampleMarshal_144___localname___ColorGroup = ({ id : (1 : stdgo.GoInt), name : ("Reds" : stdgo.GoString), colors : (new stdgo.Slice<stdgo.GoString>(4, 4, ("Crimson" : stdgo.GoString), ("Red" : stdgo.GoString), ("Ruby" : stdgo.GoString), ("Maroon" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : stdgo.encoding.json_test.Json_test.T_exampleMarshal_144___localname___ColorGroup);
...
function exampleDecoder():Void {
        ...
        while (true) {
            var _m:T_exampleDecoder_146___localname___Message = ({} : stdgo.encoding.json_test.Json_test.T_exampleDecoder_146___localname___Message);
            {
                var _err:stdgo.Error = _dec.decode(stdgo.Go.toInterface((stdgo.Go.setRef(_m) : stdgo.Ref<stdgo.encoding.json_test.Json_test.T_exampleDecoder_146___localname___Message>)));
...
function exampleDecoder_Decode_stream():Void {
        ...
        while (_dec.more()) {
            var _m:T_exampleDecoder_Decode_stream_147___localname___Message = ({} : stdgo.encoding.json_test.Json_test.T_exampleDecoder_Decode_stream_147___localname___Message);
            var _err:stdgo.Error = _dec.decode(stdgo.Go.toInterface((stdgo.Go.setRef(_m) : stdgo.Ref<stdgo.encoding.json_test.Json_test.T_exampleDecoder_Decode_stream_147___localname___Message>)));
            if (_err != null) {
                stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
            };
...
function exampleRawMessage_unmarshal():Void {
        ...
        var _colors:stdgo.Slice<T_exampleRawMessage_unmarshal_148___localname___Color> = (null : stdgo.Slice<stdgo.encoding.json_test.Json_test.T_exampleRawMessage_unmarshal_148___localname___Color>);
        var _err:stdgo.Error = stdgo.encoding.json.Json.unmarshal(_j, stdgo.Go.toInterface((stdgo.Go.setRef(_colors) : stdgo.Ref<stdgo.Slice<stdgo.encoding.json_test.Json_test.T_exampleRawMessage_unmarshal_148___localname___Color>>)));
        if (_err != null) {
        ...
        for (__0 => _c in _colors) {
            var _dst:stdgo.AnyInterface = (null : stdgo.AnyInterface);
            {
                ...
                if (__value__ == (("RGB" : stdgo.GoString))) {
                    _dst = stdgo.Go.toInterface((stdgo.Go.setRef(({} : stdgo.encoding.json_test.Json_test.T_exampleRawMessage_unmarshal_149___localname___RGB)) : stdgo.Ref<stdgo.encoding.json_test.Json_test.T_exampleRawMessage_unmarshal_149___localname___RGB>));
                } else if (__value__ == (("YCbCr" : stdgo.GoString))) {
                    _dst = stdgo.Go.toInterface((stdgo.Go.setRef(({} : stdgo.encoding.json_test.Json_test.T_exampleRawMessage_unmarshal_150___localname___YCbCr)) : stdgo.Ref<stdgo.encoding.json_test.Json_test.T_exampleRawMessage_unmarshal_150___localname___YCbCr>));
                };
            };
...
function exampleIndent():Void {
        {};
        var _roads = (new stdgo.Slice<stdgo.encoding.json_test.Json_test.T_exampleIndent_151___localname___Road>(2, 2, (new stdgo.encoding.json_test.Json_test.T_exampleIndent_151___localname___Road(("Diamond Fork" : stdgo.GoString), (29 : stdgo.GoInt)) : stdgo.encoding.json_test.Json_test.T_exampleIndent_151___localname___Road), (new stdgo.encoding.json_test.Json_test.T_exampleIndent_151___localname___Road(("Sheep Creek" : stdgo.GoString), (51 : stdgo.GoInt)) : stdgo.encoding.json_test.Json_test.T_exampleIndent_151___localname___Road)) : stdgo.Slice<stdgo.encoding.json_test.Json_test.T_exampleIndent_151___localname___Road>);
