...
@:local @:using(stdgo.encoding.json_test.Json_test.T__struct_47_static_extension) typedef T__struct_47 = {
    @:tag("`json:\"header\"`")
    public var header : stdgo.StdGoTypes.Ref<stdgo.encoding.json.Json.RawMessage>;
    @:tag("`json:\"body\"`")
    public var body : stdgo.GoString;
};
@:named @:using(stdgo.encoding.json_test.Json_test.Animal_static_extension) typedef Animal = stdgo.StdGoTypes.GoInt;
@:named @:using(stdgo.encoding.json_test.Json_test.Size_static_extension) typedef Size = stdgo.StdGoTypes.GoInt;
function example_customMarshalJSON():Void {
        ...
        {
            var _err:stdgo.Error = stdgo.encoding.json.Json.unmarshal((_blob : stdgo.Slice<stdgo.StdGoTypes.GoByte>), stdgo.Go.toInterface((stdgo.Go.setRef(_zoo) : stdgo.StdGoTypes.Ref<stdgo.Slice<stdgo.encoding.json_test.Json_test.Animal>>)));
            if (_err != null) {
        ...
        var _census = ({
            ...
            @:mergeBlock {};
            x;
        } : stdgo.GoMap<stdgo.encoding.json_test.Json_test.Animal, stdgo.StdGoTypes.GoInt>);
        for (__0 => _animal in _zoo) {
            _census[_animal] = (_census[_animal] ?? (0 : stdgo.StdGoTypes.GoInt)) + ((1 : stdgo.StdGoTypes.GoInt));
        };
        stdgo.fmt.Fmt.printf(("Zoo Census:\n* Gophers: %d\n* Zebras:  %d\n* Unknown: %d\n" : stdgo.GoString), stdgo.Go.toInterface((_census[(1 : stdgo.encoding.json_test.Json_test.Animal)] ?? (0 : stdgo.StdGoTypes.GoInt))), stdgo.Go.toInterface((_census[(2 : stdgo.encoding.json_test.Json_test.Animal)] ?? (0 : stdgo.StdGoTypes.GoInt))), stdgo.Go.toInterface((_census[(0 : stdgo.encoding.json_test.Json_test.Animal)] ?? (0 : stdgo.StdGoTypes.GoInt))));
    }
/**
...
@:structInit class T_exampleMarshal_109___localname___ColorGroup {
    ...
    public function new(?id:stdgo.StdGoTypes.GoInt, ?name:stdgo.GoString, ?colors:stdgo.Slice<stdgo.GoString>) {
...
function exampleMarshal():Void {
        {};
        var _group:stdgo.encoding.json_test.Json_test.T_exampleMarshal_109___localname___ColorGroup = ({ id : (1 : stdgo.StdGoTypes.GoInt), name : ("Reds" : stdgo.GoString), colors : (new stdgo.Slice<stdgo.GoString>(4, 4, ("Crimson" : stdgo.GoString), ("Red" : stdgo.GoString), ("Ruby" : stdgo.GoString), ("Maroon" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : stdgo.encoding.json_test.Json_test.T_exampleMarshal_109___localname___ColorGroup);
        var __tmp__ = stdgo.encoding.json.Json.marshal(stdgo.Go.toInterface(_group)), _b:stdgo.Slice<stdgo.StdGoTypes.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
...
function exampleUnmarshal():Void {
        ...
        var _err:stdgo.Error = stdgo.encoding.json.Json.unmarshal(_jsonBlob, stdgo.Go.toInterface((stdgo.Go.setRef(_animals) : stdgo.StdGoTypes.Ref<stdgo.Slice<stdgo.encoding.json_test.Json_test.T_exampleUnmarshal_110___localname___Animal>>)));
        if (_err != null) {
            stdgo.fmt.Fmt.println(stdgo.Go.toInterface(("error:" : stdgo.GoString)), stdgo.Go.toInterface(_err));
        };
...
function exampleDecoder():Void {
        ...
        while (true) {
            ...
            {
                var _err:stdgo.Error = _dec.decode(stdgo.Go.toInterface((stdgo.Go.setRef(_m) : stdgo.StdGoTypes.Ref<stdgo.encoding.json_test.Json_test.T_exampleDecoder_111___localname___Message>)));
...
function exampleDecoder_Decode_stream():Void {
        ...
        while (_dec.more()) {
            ...
            var _err:stdgo.Error = _dec.decode(stdgo.Go.toInterface((stdgo.Go.setRef(_m) : stdgo.StdGoTypes.Ref<stdgo.encoding.json_test.Json_test.T_exampleDecoder_Decode_stream_112___localname___Message>)));
            if (_err != null) {
                stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
            };
...
@:structInit class T_exampleRawMessage_unmarshal_114___localname___RGB {
    ...
    public function new(?r:stdgo.StdGoTypes.GoUInt8, ?g:stdgo.StdGoTypes.GoUInt8, ?b:stdgo.StdGoTypes.GoUInt8) {
        if (r != null) this.r = r;
        if (g != null) this.g = g;
        if (b != null) this.b = b;
    }
...
@:structInit class T_exampleRawMessage_unmarshal_115___localname___YCbCr {
    ...
    public var cb : stdgo.StdGoTypes.GoInt8 = 0;
    public var cr : stdgo.StdGoTypes.GoInt8 = 0;
    public function new(?y:stdgo.StdGoTypes.GoUInt8, ?cb:stdgo.StdGoTypes.GoInt8, ?cr:stdgo.StdGoTypes.GoInt8) {
        if (y != null) this.y = y;
...
function exampleRawMessage_unmarshal():Void {
        ...
        {};
        {};
        var _j:stdgo.Slice<stdgo.StdGoTypes.GoUInt8> = (("[\n\t{\"Space\": \"YCbCr\", \"Point\": {\"Y\": 255, \"Cb\": 0, \"Cr\": -10}},\n\t{\"Space\": \"RGB\",   \"Point\": {\"R\": 98, \"G\": 218, \"B\": 255}}\n]" : stdgo.GoString) : stdgo.Slice<stdgo.StdGoTypes.GoByte>);
        ...
        var _err:stdgo.Error = stdgo.encoding.json.Json.unmarshal(_j, stdgo.Go.toInterface((stdgo.Go.setRef(_colors) : stdgo.StdGoTypes.Ref<stdgo.Slice<stdgo.encoding.json_test.Json_test.T_exampleRawMessage_unmarshal_113___localname___Color>>)));
        if (_err != null) {
            stdgo.log.Log.fatalln(stdgo.Go.toInterface(("error:" : stdgo.GoString)), stdgo.Go.toInterface(_err));
        };
        for (__0 => _c in _colors) {
            var _dst:stdgo.StdGoTypes.AnyInterface = (null : stdgo.StdGoTypes.AnyInterface);
            {
                final __value__ = _c.space;
                if (__value__ == (("RGB" : stdgo.GoString))) {
                    _dst = stdgo.Go.toInterface((stdgo.Go.setRef(({} : stdgo.encoding.json_test.Json_test.T_exampleRawMessage_unmarshal_114___localname___RGB)) : stdgo.StdGoTypes.Ref<stdgo.encoding.json_test.Json_test.T_exampleRawMessage_unmarshal_114___localname___RGB>));
                } else if (__value__ == (("YCbCr" : stdgo.GoString))) {
                    _dst = stdgo.Go.toInterface((stdgo.Go.setRef(({} : stdgo.encoding.json_test.Json_test.T_exampleRawMessage_unmarshal_115___localname___YCbCr)) : stdgo.StdGoTypes.Ref<stdgo.encoding.json_test.Json_test.T_exampleRawMessage_unmarshal_115___localname___YCbCr>));
                };
            };
...
function exampleRawMessage_marshal():Void {
        ...
        var _c:T__struct_47 = ({ header : (stdgo.Go.setRef(_h) : stdgo.StdGoTypes.Ref<stdgo.encoding.json.Json.RawMessage>), body : ("Hello Gophers!" : stdgo.GoString) } : T__struct_47);
        var __tmp__ = stdgo.encoding.json.Json.marshalIndent(stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_c) : stdgo.StdGoTypes.Ref<T__struct_47>))), stdgo.Go.str()?.__copy__(), ("\t" : stdgo.GoString)), _b:stdgo.Slice<stdgo.StdGoTypes.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            stdgo.fmt.Fmt.println(stdgo.Go.toInterface(("error:" : stdgo.GoString)), stdgo.Go.toInterface(_err));
        };
        stdgo.os.Os.stdout.write(_b);
...
@:structInit class T_exampleIndent_116___localname___Road {
    public var name : stdgo.GoString = "";
    public var number : stdgo.StdGoTypes.GoInt = 0;
    public function new(?name:stdgo.GoString, ?number:stdgo.StdGoTypes.GoInt) {
        if (name != null) this.name = name;
...
function exampleIndent():Void {
        {};
        var _roads = (new stdgo.Slice<stdgo.encoding.json_test.Json_test.T_exampleIndent_116___localname___Road>(2, 2, (new stdgo.encoding.json_test.Json_test.T_exampleIndent_116___localname___Road(("Diamond Fork" : stdgo.GoString), (29 : stdgo.StdGoTypes.GoInt)) : stdgo.encoding.json_test.Json_test.T_exampleIndent_116___localname___Road), (new stdgo.encoding.json_test.Json_test.T_exampleIndent_116___localname___Road(("Sheep Creek" : stdgo.GoString), (51 : stdgo.StdGoTypes.GoInt)) : stdgo.encoding.json_test.Json_test.T_exampleIndent_116___localname___Road)) : stdgo.Slice<stdgo.encoding.json_test.Json_test.T_exampleIndent_116___localname___Road>);
        var __tmp__ = stdgo.encoding.json.Json.marshal(stdgo.Go.toInterface(_roads)), _b:stdgo.Slice<stdgo.StdGoTypes.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
        };
        var _out:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        stdgo.encoding.json.Json.indent((stdgo.Go.setRef(_out) : stdgo.StdGoTypes.Ref<stdgo.bytes.Bytes.Buffer>), _b, ("=" : stdgo.GoString), ("\t" : stdgo.GoString));
...
function exampleMarshalIndent():Void {
        var _data = ({
            ...
            @:mergeBlock {
                ...
                x.set(("b" : stdgo.GoString), (2 : stdgo.StdGoTypes.GoInt));
            };
            x;
        } : stdgo.GoMap<stdgo.GoString, stdgo.StdGoTypes.GoInt>);
        var __tmp__ = stdgo.encoding.json.Json.marshalIndent(stdgo.Go.toInterface(_data), ("<prefix>" : stdgo.GoString), ("<indent>" : stdgo.GoString)), _b:stdgo.Slice<stdgo.StdGoTypes.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
        };
...
function exampleValid():Void {
        ...
        stdgo.fmt.Fmt.println(stdgo.Go.toInterface(stdgo.encoding.json.Json.valid((_goodJSON : stdgo.Slice<stdgo.StdGoTypes.GoByte>))), stdgo.Go.toInterface(stdgo.encoding.json.Json.valid((_badJSON : stdgo.Slice<stdgo.StdGoTypes.GoByte>))));
    }
function exampleHTMLEscape():Void {
        var _out:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        stdgo.encoding.json.Json.htmlescape((stdgo.Go.setRef(_out) : stdgo.StdGoTypes.Ref<stdgo.bytes.Bytes.Buffer>), (("{\"Name\":\"<b>HTML content</b>\"}" : stdgo.GoString) : stdgo.Slice<stdgo.StdGoTypes.GoByte>));
        _out.writeTo(stdgo.Go.asInterface(stdgo.os.Os.stdout));
    }
function example_textMarshalJSON():Void {
        ...
        {
            var _err:stdgo.Error = stdgo.encoding.json.Json.unmarshal((_blob : stdgo.Slice<stdgo.StdGoTypes.GoByte>), stdgo.Go.toInterface((stdgo.Go.setRef(_inventory) : stdgo.StdGoTypes.Ref<stdgo.Slice<stdgo.encoding.json_test.Json_test.Size>>)));
            if (_err != null) {
                stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
            };
        };
        var _counts = ({
            ...
            @:mergeBlock {};
            x;
        } : stdgo.GoMap<stdgo.encoding.json_test.Json_test.Size, stdgo.StdGoTypes.GoInt>);
        for (__0 => _size in _inventory) {
            _counts[_size] = (_counts[_size] ?? (0 : stdgo.StdGoTypes.GoInt)) + ((1 : stdgo.StdGoTypes.GoInt));
        };
        stdgo.fmt.Fmt.printf(("Inventory Counts:\n* Small:        %d\n* Large:        %d\n* Unrecognized: %d\n" : stdgo.GoString), stdgo.Go.toInterface((_counts[(1 : stdgo.encoding.json_test.Json_test.Size)] ?? (0 : stdgo.StdGoTypes.GoInt))), stdgo.Go.toInterface((_counts[(2 : stdgo.encoding.json_test.Json_test.Size)] ?? (0 : stdgo.StdGoTypes.GoInt))), stdgo.Go.toInterface((_counts[(0 : stdgo.encoding.json_test.Json_test.Size)] ?? (0 : stdgo.StdGoTypes.GoInt))));
    }
class Animal_asInterface {
    ...
    @:keep
    @:pointer
    public dynamic function unmarshalJSON(_b:stdgo.Slice<stdgo.StdGoTypes.GoByte>):stdgo.Error return __self__.value.unmarshalJSON(__self__, _b);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
@:keep @:allow(stdgo.encoding.json_test.Json_test.Animal_asInterface) class Animal_static_extension {
    @:keep
    static public function marshalJSON( _a:Animal):{ var _0 : stdgo.Slice<stdgo.StdGoTypes.GoByte>; var _1 : stdgo.Error; } {
    ...
    @:keep
    @:pointer
    static public function unmarshalJSON(____:Animal,  _a:stdgo.Pointer<Animal>, _b:stdgo.Slice<stdgo.StdGoTypes.GoByte>):stdgo.Error {
        var _s:stdgo.GoString = ("" : stdgo.GoString);
        {
...
@:keep @:allow(stdgo.encoding.json_test.Json_test.Size_asInterface) class Size_static_extension {
    @:keep
    static public function marshalText( _s:Size):{ var _0 : stdgo.Slice<stdgo.StdGoTypes.GoByte>; var _1 : stdgo.Error; } {
        @:recv var _s:Size = _s;
        ...
        return { _0 : (_name : stdgo.Slice<stdgo.StdGoTypes.GoByte>), _1 : (null : stdgo.Error) };
    }
    @:keep
    @:pointer
    static public function unmarshalText(____:Size,  _s:stdgo.Pointer<Size>, _text:stdgo.Slice<stdgo.StdGoTypes.GoByte>):stdgo.Error {
        {
