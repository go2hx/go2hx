...
@:structInit class Block {
    ...
    public var headers : GoMap<GoString, GoString> = new GoMap<GoString, GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil();
    public var bytes : Slice<GoUInt8> = new Slice<GoUInt8>().nil();
    public function new(?type:GoString, ?headers:GoMap<GoString, GoString>, ?bytes:Slice<GoUInt8>) stdgo.internal.Macro.initLocals();
...
@:structInit class T_lineBreaker {
    ...
    public function new(?_line:GoArray<GoUInt8>, ?_used:GoInt, ?_out:stdgo.io.Io.Writer) stdgo.internal.Macro.initLocals();
    public function toString() {
...
function _getLine(_data:Slice<GoByte>):{ var _0 : Slice<GoByte>; var _1 : Slice<GoByte>; } {
        var _line:Slice<GoByte> = new Slice<GoUInt8>().nil(), _rest:Slice<GoByte> = new Slice<GoUInt8>().nil();
...
function decode(_data:Slice<GoByte>):{ var _0 : Pointer<Block>; var _1 : Slice<GoByte>; } {
        var _p:Pointer<Block> = new Pointer<Block>().nil(), _rest:Slice<GoByte> = new Slice<GoUInt8>().nil();
        _rest = _data;
        ...
        var __tmp__ = _getLine(_rest), _typeLine:Slice<GoUInt8> = __tmp__._0, _rest:Slice<GoUInt8> = __tmp__._1;
        ...
        _p = Go.pointer((({ headers : new GoMap<GoString, GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.basic(string_kind)))), type : ((_typeLine : GoString)), bytes : new Slice<GoUInt8>().nil() } : Block)));
        while (true) {
            if (_rest.length == ((0 : GoInt))) {
                return { _0 : new Pointer<Block>().nil(), _1 : _data };
            };
            var __tmp__ = _getLine(_rest), _line:Slice<GoUInt8> = __tmp__._0, _next:Slice<GoUInt8> = __tmp__._1;
            var _i:GoInt = stdgo.bytes.Bytes.indexByte(_line, ((":".code : GoRune)));
            if (_i == -((1 : GoUnTypedInt))) {
                break;
            };
            var _key:Slice<GoUInt8> = _line.__slice__(0, _i), _val:Slice<GoUInt8> = _line.__slice__(_i + ((1 : GoInt)));
            _key = stdgo.bytes.Bytes.trimSpace(_key);
            _val = stdgo.bytes.Bytes.trimSpace(_val);
            _p.value.headers[((_key : GoString))] = ((_val : GoString));
            _rest = _next;
        };
        var _endIndex:GoInt = ((0 : GoInt)), _endTrailerIndex:GoInt = ((0 : GoInt));
        if ((_p.value.headers == null ? 0 : _p.value.headers.length) == ((0 : GoInt)) && stdgo.bytes.Bytes.hasPrefix(_rest, _pemEnd.__slice__(((1 : GoInt))))) {
            _endIndex = ((0 : GoInt));
        ...
        {
            var __tmp__ = _getLine(_restOfEndLine), _s:Slice<GoUInt8> = __tmp__._0, _:Slice<GoUInt8> = __tmp__._1;
            if (_s.length != ((0 : GoInt))) {
                return _decodeError(_data, _rest);
            };
        };
        var _base64Data:Slice<GoUInt8> = _removeSpacesAndTabs(_rest.__slice__(0, _endIndex));
        _p.value.bytes = new Slice<GoUInt8>(...[for (i in 0 ... ((stdgo.encoding.base64.Base64.stdEncoding.value.decodedLen(_base64Data.length) : GoInt)).toBasic()) ((0 : GoUInt8))]);
        var __tmp__ = stdgo.encoding.base64.Base64.stdEncoding.value.decode(_p.value.bytes, _base64Data), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return _decodeError(_data, _rest);
        };
...
function _decodeError(_data:Slice<GoByte>, _rest:Slice<GoByte>):{ var _0 : Pointer<Block>; var _1 : Slice<GoByte>; } {
        var __tmp__ = decode(_rest), _p:Pointer<Block> = __tmp__._0, _rest:Slice<GoUInt8> = __tmp__._1;
        if (_p == null || _p.isNil()) {
            _rest = _data;
        };
        return { _0 : _p, _1 : _rest };
...
function _writeHeader(_out:stdgo.io.Io.Writer, _k:GoString, _v:GoString):Error {
        var __tmp__ = _out.write((((_k + ((": " : GoString)) + _v + (("\n" : GoString))) : Slice<GoByte>))), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        return _err;
    }
/**
...
function encode(_out:stdgo.io.Io.Writer, _b:Pointer<Block>):Error {
        ...
        {
            var __tmp__ = _out.write(_pemStart.__slice__(((1 : GoInt)))), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return _err;
            };
        };
        ...
        if ((_b.value.headers == null ? 0 : _b.value.headers.length) > ((0 : GoInt))) {
            ...
            var _h:Slice<GoString> = new Slice<GoString>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) (("" : GoString))]).setCap((((_b.value.headers == null ? 0 : _b.value.headers.length) : GoInt)).toBasic());
            ...
            {
                var __tmp__ = _out.write(_nl), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    return _err;
                };
            };
        ...
        {
            var __tmp__ = _b64.write(_b.value.bytes), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return _err;
            };
        };
        ...
        _breaker.close();
        {
            var __tmp__ = _out.write(_pemEnd.__slice__(((1 : GoInt)))), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return _err;
            };
        };
