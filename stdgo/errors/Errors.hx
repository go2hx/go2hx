...
@:structInit @:using(T_errorString_static_extension) @:dox(hide) abstract T_errorString(stdgo._internal.errors.Errors_t_errorstring.T_errorString) from stdgo._internal.errors.Errors_t_errorstring.T_errorString to stdgo._internal.errors.Errors_t_errorstring.T_errorString {
...
@:structInit @:using(T_joinError_static_extension) @:dox(hide) abstract T_joinError(stdgo._internal.errors.Errors_t_joinerror.T_joinError) from stdgo._internal.errors.Errors_t_joinerror.T_joinError to stdgo._internal.errors.Errors_t_joinerror.T_joinError {
