...
=== RUN   TestNewEqual
--- PASS: TestNewEqual (0.000276803970336914)
=== RUN   TestErrorMethod
--- PASS: TestErrorMethod (3.88622283935547e-05)
=== RUN   TestIs
--- PASS: TestIs (0.000159978866577148)
=== RUN   TestAs
--- PASS: TestAs (0.00117707252502441)
=== RUN   TestAsValidation
--- PASS: TestAsValidation (0.000134944915771484)
=== RUN   TestUnwrap
Unwrap(wrap 2) = null, want 1
```
</p>
</details>
...
```
=== RUN   TestNewEqual
--- PASS: TestNewEqual (0.000252008438110351562)
=== RUN   TestErrorMethod
--- PASS: TestErrorMethod (3.0040740966796875e-05)
=== RUN   TestIs
--- PASS: TestIs (0.000220060348510742188)
=== RUN   TestAs
--- PASS: TestAs (0.000891923904418945312)
=== RUN   TestAsValidation
--- PASS: TestAsValidation (9.79900360107421875e-05)
=== RUN   TestUnwrap
Unwrap(wrap 2) = null, want 1
```
</p>
