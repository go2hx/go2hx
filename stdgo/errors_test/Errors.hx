...
private var _tests:Slice<stdgo.testing.Testing.InternalTest> = (new Slice<stdgo.testing.Testing.InternalTest>(0, 0,
	...
	(new stdgo.testing.Testing.InternalTest(("TestErrorMethod" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestAsValidation" : GoString),
		stdgo.errors_test.Errors_test.testAsValidation) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestUnwrap" : GoString),
...
private var _examples:Slice<stdgo.testing.Testing.InternalExample> = (new Slice<stdgo.testing.Testing.InternalExample>(0, 0,
	(new stdgo.testing.Testing.InternalExample(("ExampleNew" : GoString), stdgo.errors_test.Errors_test.exampleNew,
		("emit macho dwarf: elf header corrupted\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleNew_errorf" : GoString), stdgo.errors_test.Errors_test.exampleNew_errorf,
		("user \"bimmler\" (id 17) not found\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("Example" : GoString), stdgo.errors_test.Errors_test.example,
		("1989-03-15 22:30:00 +0000 UTC: the file system has gone away\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleIs" : GoString), stdgo.errors_test.Errors_test.exampleIs, ("file does not exist\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleAs" : GoString), stdgo.errors_test.Errors_test.exampleAs,
