...
function testJoinErrorMethod(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        for (__0 => _test in (new stdgo.Slice<T__struct_1>(3, 3, ({ _errs : (new stdgo.Slice<stdgo.Error>(1, 1, _err1) : stdgo.Slice<stdgo.Error>), _want : ("err1" : stdgo.GoString) } : T__struct_1), ({ _errs : (new stdgo.Slice<stdgo.Error>(2, 2, _err1, _err2) : stdgo.Slice<stdgo.Error>), _want : ("err1\nerr2" : stdgo.GoString) } : T__struct_1), ({ _errs : (new stdgo.Slice<stdgo.Error>(3, 3, _err1, (null : stdgo.Error), _err2) : stdgo.Slice<stdgo.Error>), _want : ("err1\nerr2" : stdgo.GoString) } : T__struct_1)) : stdgo.Slice<T__struct_1>)) {
            var _got:stdgo.GoString = stdgo.errors.Errors.join(..._test._errs.__toArray__()).error();
            if (_got != (_test._want)) {
...
function testIs(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _erra:stdgo.errors_test.Errors_test.T_wrapped = (new T_wrapped(("wrap 2" : stdgo.GoString), _err1) : T_wrapped);
        var _errb:stdgo.errors_test.Errors_test.T_wrapped = (new T_wrapped(("wrap 3" : stdgo.GoString), stdgo.Go.asInterface(_erra)) : T_wrapped);
        var _err3:stdgo.Error = stdgo.errors.Errors.new_(("3" : stdgo.GoString));
        var _poser = (stdgo.Go.setRef((new T_poser(("either 1 or 3" : stdgo.GoString), function(_err:stdgo.Error):Bool {
...
({ _err : stdgo.Go.asInterface((new stdgo.Slice<stdgo.Error>(1, 1, (null : stdgo.Error)) : stdgo.errors_test.Errors_test.T_multiErr)), _target : (null : stdgo.Error), _match : false } : T__struct_2)) : stdgo.Slice<T__struct_2>);
        for (__0 => _tc in _testCases) {
            _t.run(stdgo.Go.str(), function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
                {
...
function testAs(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _poserErr = (stdgo.Go.setRef((new T_poser(("oh no" : stdgo.GoString), null) : T_poser)) : stdgo.StdGoTypes.Ref<stdgo.errors_test.Errors_test.T_poser>);
...
({ _err : stdgo.Go.asInterface((new T_wrapped(("pitied the fool" : stdgo.GoString), stdgo.Go.asInterface((new T_errorT(("T" : stdgo.GoString)) : T_errorT))) : T_wrapped)), _target : stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_errT) : stdgo.StdGoTypes.Ref<stdgo.errors_test.Errors_test.T_errorT>))), _match : true, _want : stdgo.Go.toInterface(stdgo.Go.asInterface((new T_errorT(("T" : stdgo.GoString)) : T_errorT))) } : T__struct_3),
...
({ _err : stdgo.Go.asInterface((new T_wrapped(("path error" : stdgo.GoString), _errF) : T_wrapped)), _target : stdgo.Go.toInterface((stdgo.Go.setRef(_timeout) : stdgo.StdGoTypes.Ref<T__interface_5>)), _match : true, _want : stdgo.Go.toInterface(_errF) } : T__struct_3),
...
({ _err : stdgo.Go.asInterface((new stdgo.Slice<stdgo.Error>(2, 2, stdgo.errors.Errors.new_(("a" : stdgo.GoString)), stdgo.Go.asInterface((new T_errorT(("T" : stdgo.GoString)) : T_errorT))) : stdgo.errors_test.Errors_test.T_multiErr)), _target : stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_errT) : stdgo.StdGoTypes.Ref<stdgo.errors_test.Errors_test.T_errorT>))), _match : true, _want : stdgo.Go.toInterface(stdgo.Go.asInterface((new T_errorT(("T" : stdgo.GoString)) : T_errorT))) } : T__struct_3),
({ _err : stdgo.Go.asInterface((new stdgo.Slice<stdgo.Error>(2, 2, stdgo.Go.asInterface((new T_errorT(("T" : stdgo.GoString)) : T_errorT)), stdgo.errors.Errors.new_(("a" : stdgo.GoString))) : stdgo.errors_test.Errors_test.T_multiErr)), _target : stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_errT) : stdgo.StdGoTypes.Ref<stdgo.errors_test.Errors_test.T_errorT>))), _match : true, _want : stdgo.Go.toInterface(stdgo.Go.asInterface((new T_errorT(("T" : stdgo.GoString)) : T_errorT))) } : T__struct_3),
({ _err : stdgo.Go.asInterface((new stdgo.Slice<stdgo.Error>(2, 2, stdgo.Go.asInterface((new T_errorT(("a" : stdgo.GoString)) : T_errorT)), stdgo.Go.asInterface((new T_errorT(("b" : stdgo.GoString)) : T_errorT))) : stdgo.errors_test.Errors_test.T_multiErr)), _target : stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_errT) : stdgo.StdGoTypes.Ref<stdgo.errors_test.Errors_test.T_errorT>))), _match : true, _want : stdgo.Go.toInterface(stdgo.Go.asInterface((new T_errorT(("a" : stdgo.GoString)) : T_errorT))) } : T__struct_3),
({ _err : stdgo.Go.asInterface((new stdgo.Slice<stdgo.Error>(2, 2, stdgo.Go.asInterface((new stdgo.Slice<stdgo.Error>(2, 2, stdgo.errors.Errors.new_(("a" : stdgo.GoString)), stdgo.Go.asInterface((new T_errorT(("a" : stdgo.GoString)) : T_errorT))) : stdgo.errors_test.Errors_test.T_multiErr)), stdgo.Go.asInterface((new T_errorT(("b" : stdgo.GoString)) : T_errorT))) : stdgo.errors_test.Errors_test.T_multiErr)), _target : stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_errT) : stdgo.StdGoTypes.Ref<stdgo.errors_test.Errors_test.T_errorT>))), _match : true, _want : stdgo.Go.toInterface(stdgo.Go.asInterface((new T_errorT(("a" : stdgo.GoString)) : T_errorT))) } : T__struct_3),
({ _err : stdgo.Go.asInterface((new stdgo.Slice<stdgo.Error>(1, 1, stdgo.Go.asInterface((new T_wrapped(("path error" : stdgo.GoString), _errF) : T_wrapped))) : stdgo.errors_test.Errors_test.T_multiErr)), _target : stdgo.Go.toInterface((stdgo.Go.setRef(_timeout) : stdgo.StdGoTypes.Ref<T__interface_5>)), _match : true, _want : stdgo.Go.toInterface(_errF) } : T__struct_3),
({ _err : stdgo.Go.asInterface((new stdgo.Slice<stdgo.Error>(1, 1, (null : stdgo.Error)) : stdgo.errors_test.Errors_test.T_multiErr)), _target : stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_errT) : stdgo.StdGoTypes.Ref<stdgo.errors_test.Errors_test.T_errorT>))), _match : false, _want : (null : stdgo.StdGoTypes.AnyInterface) } : T__struct_3)) : stdgo.Slice<T__struct_3>);
        for (_i => _tc in _testCases) {
            var _name:stdgo.GoString = stdgo.fmt.Fmt.sprintf(("%d:As(Errorf(..., %v), %v)" : stdgo.GoString), stdgo.Go.toInterface(_i), stdgo.Go.toInterface(_tc._err), _tc._target);
...
function testAsValidation(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        for (__0 => _tc in _testCases) {
            _t.run(stdgo.fmt.Fmt.sprintf(("%T(%v)" : stdgo.GoString), _tc, _tc), function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
    ...
    static public function as( _p:stdgo.StdGoTypes.Ref<T_poser>, _err:stdgo.StdGoTypes.AnyInterface):Bool {
        @:recv var _p:stdgo.StdGoTypes.Ref<T_poser> = _p;
        {
            ...
            if (stdgo.Go.typeEquals((__type__ : stdgo.StdGoTypes.Ref<stdgo.StdGoTypes.Ref<T_poser>>))) {
                ...
                {
                    var __tmp__ = (new T_errorT(("poser" : stdgo.GoString)) : T_errorT);
                    _x._s = __tmp__._s;
                };
