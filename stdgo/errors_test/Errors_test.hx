...
private var _poserPathErr:Ref<stdgo.io.fs.Fs.PathError> = (({op: ("poser" : GoString)} : stdgo.io.fs.Fs.PathError) : Ref<stdgo.io.fs.Fs.PathError>);
...
private function _oops():Error {
	return Go.asInterface((new MyError((stdgo.time.Time.date((1989 : GoInt), (3 : stdgo.time.Time.Month), (15 : GoInt), (22 : GoInt), (30 : GoInt),
		(0 : GoInt), (0 : GoInt),
		...
		.__copy__()),
		("the file system has gone away" : GoString)) : MyError));
}
...
function testIs(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _testCases = (new Slice<T__struct_0>(0, 0, ({_err: (null : Error), _target: (null : Error), _match: true} : T__struct_0),
		...
		({_err: Go.asInterface((new T_errorUncomparable() : T_errorUncomparable)), _target: Go.asInterface((new T_errorUncomparable() : T_errorUncomparable)),
			_match: true} : T__struct_0),
		({_err: Go.asInterface((new T_errorUncomparable() : T_errorUncomparable)),
			_target: Go.asInterface(((new T_errorUncomparable() : T_errorUncomparable) : Ref<stdgo.errors_test.Errors_test.T_errorUncomparable>)),
			_match: false} : T__struct_0),
		({_err: Go.asInterface(((new T_errorUncomparable() : T_errorUncomparable) : Ref<stdgo.errors_test.Errors_test.T_errorUncomparable>)),
			_target: Go.asInterface((new T_errorUncomparable() : T_errorUncomparable)), _match: true} : T__struct_0),
		({_err: Go.asInterface(((new T_errorUncomparable() : T_errorUncomparable) : Ref<stdgo.errors_test.Errors_test.T_errorUncomparable>)),
			_target: Go.asInterface(((new T_errorUncomparable() : T_errorUncomparable) : Ref<stdgo.errors_test.Errors_test.T_errorUncomparable>)),
			_match: false} : T__struct_0),
		({_err: Go.asInterface((new T_errorUncomparable() : T_errorUncomparable)), _target: _err1, _match: false} : T__struct_0),
		({_err: Go.asInterface(((new T_errorUncomparable() : T_errorUncomparable) : Ref<stdgo.errors_test.Errors_test.T_errorUncomparable>)), _target: _err1,
		...
		_t.run(Go.str(), function(_t:Ref<stdgo.testing.Testing.T>):Void {
			{
				...
				if (_got != (_tc._match)) {
					_t.errorf(("Is(%v, %v) = %v, want %v" : GoString), Go.toInterface(_tc._err), Go.toInterface(_tc._target), Go.toInterface(_got),
...
function testAs(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _testCases = (new Slice<T__struct_1>(0, 0, ({
		...
		_err: Go.asInterface((new T_wrapped(("pitied the fool" : GoString), Go.asInterface((new T_errorT(("T" : GoString)) : T_errorT))) : T_wrapped)),
		_target: Go.toInterface(Go.asInterface((_errT : Ref<stdgo.errors_test.Errors_test.T_errorT>))),
		_match: true,
		_want: Go.toInterface(Go.asInterface((new T_errorT(("T" : GoString)) : T_errorT)))
		} : T__struct_1), ({
		_err: _errF,
		_target: Go.toInterface((_errP : Ref<Ref<stdgo.io.fs.Fs.PathError>>)),
		_match: true,
		...
		_err: Go.asInterface((new T_errorT() : T_errorT)),
		_target: Go.toInterface((_errP : Ref<Ref<stdgo.io.fs.Fs.PathError>>)),
		_match: false,
		_want: (null : AnyInterface)
		} : T__struct_1), ({
		_err: Go.asInterface((new T_wrapped(("wrapped" : GoString), (null : Error)) : T_wrapped)),
		_target: Go.toInterface(Go.asInterface((_errT : Ref<stdgo.errors_test.Errors_test.T_errorT>))),
		_match: false,
		_want: (null : AnyInterface)
		} : T__struct_1), ({
		_err: Go.asInterface(((new T_poser(("error" : GoString), null) : T_poser) : Ref<stdgo.errors_test.Errors_test.T_poser>)),
		_target: Go.toInterface(Go.asInterface((_errT : Ref<stdgo.errors_test.Errors_test.T_errorT>))),
		_match: true,
		_want: Go.toInterface(Go.asInterface((new T_errorT(("poser" : GoString)) : T_errorT)))
		} : T__struct_1), ({
		_err: Go.asInterface(((new T_poser(("path" : GoString), null) : T_poser) : Ref<stdgo.errors_test.Errors_test.T_poser>)),
		_target: Go.toInterface((_errP : Ref<Ref<stdgo.io.fs.Fs.PathError>>)),
		_match: true,
		_want: Go.toInterface(Go.asInterface(_poserPathErr))
		} : T__struct_1), ({
		_err: Go.asInterface(_poserErr),
		_target: Go.toInterface((_p : Ref<Ref<stdgo.errors_test.Errors_test.T_poser>>)),
		_match: true,
		_want: Go.toInterface(Go.asInterface(_poserErr))
		} : T__struct_1), ({
		_err: stdgo.errors.Errors.new_(("err" : GoString)),
		...
		_err: Go.asInterface((new T_wrapped(("path error" : GoString), _errF) : T_wrapped)),
		_target: Go.toInterface((_timeout : Ref<T__interface_3>)),
		_match: true,
		_want: Go.toInterface(_errF)
...
function testAsValidation(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _testCases = (new Slice<AnyInterface>(0, 0, (null : AnyInterface), Go.toInterface((null : Pointer<GoInt>)), Go.toInterface(("error" : GoString)),
...
function testUnwrap(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _testCases = (new Slice<T__struct_2>(0, 0, ({_err: (null : Error), _want: (null : Error)} : T__struct_2),
		({_err: Go.asInterface((new T_wrapped(("wrapped" : GoString), (null : Error)) : T_wrapped)), _want: (null : Error)} : T__struct_2),
		({_err: _err1, _want: (null : Error)} : T__struct_2), ({_err: Go.asInterface(_erra), _want: _err1} : T__struct_2),
		({_err: Go.asInterface((new T_wrapped(("wrap 3" : GoString),
			Go.asInterface(_erra)) : T_wrapped)), _want: Go.asInterface(_erra)} : T__struct_2)) : Slice<T__struct_2>);
	for (_0 => _tc in _testCases) {
		{
