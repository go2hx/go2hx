...
@:structInit class Int_ {
	...
	public function new(?_i:GoInt64)
...
@:structInit class Float_ {
	...
	public function toString():GoString {
		var _v = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		return stdgo.strconv.Strconv.formatFloat(stdgo.math.Math.float64frombits(stdgo.sync.atomic.Atomic.loadUint64(Go.pointer(_v.value._f))),
			(("g".code : GoRune)), -((1 : GoUnTypedInt)), ((64 : GoInt)));
	}
	...
	public function new(?_f:GoUInt64)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Map_ {
	public function do_(_f:KeyValue->Void):Void {
		...
		try {
			...
			for (_k in _v.value._keys) {
				var __tmp__ = _v.value._m.load(Go.toInterface(_k)),
					_i:AnyInterface = __tmp__._0,
					_:Bool = __tmp__._1;
	...
	public function addFloat(_key:GoString, _delta:GoFloat64):Void {
		var _v = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _v.value._m.load(Go.toInterface(_key)),
			_i:AnyInterface = __tmp__._0,
			_ok:Bool = __tmp__._1;
		if (!_ok) {
			var _dup:Bool = false;
	...
	public function set(_key:GoString, _av:Var):Void {
		var _v = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		{
			...
			if (!_ok) {
				{
					var __tmp__ = _v.value._m.loadOrStore(Go.toInterface(_key), Go.toInterface(_av)),
						_:AnyInterface = __tmp__._0,
	...
	public function new(?_m:stdgo.sync.Sync.Map_, ?_keysMu:stdgo.sync.Sync.RWMutex, ?_keys:Slice<GoString>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class KeyValue {
	...
	public function new(?key:GoString, ?value:Var)
		stdgo.internal.Macro.initLocals();
...
@:structInit class String_ {
	...
	public function toString():GoString {
		...
		var __tmp__ = stdgo.encoding.json.Json.marshal(Go.toInterface(_s)),
	...
	public function new(?_s:stdgo.sync.atomic.Atomic.Value)
		stdgo.internal.Macro.initLocals();
...
@:named class Func {
	public function toString():GoString {
		...
		var __tmp__ = stdgo.encoding.json.Json.marshal(Go.toInterface(_f.__t__())),
			_v:Slice<GoUInt8> = __tmp__._0,
			_:stdgo.Error = __tmp__._1;
		return ((_v : GoString));
	}
...
function publish(_name:GoString, _v:Var):Void {
	...
	try {
		{
			var __tmp__ = _vars.loadOrStore(Go.toInterface(_name), Go.toInterface(_v)),
				_:AnyInterface = __tmp__._0,
				_dup:Bool = __tmp__._1;
			if (_dup) {
...
function get(_name:GoString):Var {
	var __tmp__ = _vars.load(Go.toInterface(_name)),
		_i:AnyInterface = __tmp__._0,
		_:Bool = __tmp__._1;
	var __tmp__ = try {
		{value: ((_i.value : Var)), ok: true};
...
function do_(_f:KeyValue->Void):Void {
	...
	try {
		...
		for (_k in _varKeys) {
			var __tmp__ = _vars.load(Go.toInterface(_k)),
				_val:AnyInterface = __tmp__._0,
				_:Bool = __tmp__._1;
...
class Int__extension_fields {
	public function value(__tmp__):GoInt64
		return __tmp__.value();

	public function toString(__tmp__):GoString
		return __tmp__.toString();

	public function add(__tmp__, _delta:GoInt64):Void
		__tmp__.add(_delta);

	public function set(__tmp__, _value:GoInt64):Void
		__tmp__.set(_value);
}

class Float__extension_fields {
	public function value(__tmp__):GoFloat64
		return __tmp__.value();

	public function toString(__tmp__):GoString
		return __tmp__.toString();

	public function add(__tmp__, _delta:GoFloat64):Void
		__tmp__.add(_delta);

	public function set(__tmp__, _value:GoFloat64):Void
		__tmp__.set(_value);
}
...
class Map__extension_fields {
	...
	public function init(__tmp__):Pointer<Map_>
		return __tmp__.init();

	public function _addKey(__tmp__, _key:GoString):Void
		__tmp__._addKey(_key);

	public function get(__tmp__, _key:GoString):Var
		return __tmp__.get(_key);

	public function set(__tmp__, _key:GoString, _av:Var):Void
		__tmp__.set(_key, _av);

	public function add(__tmp__, _key:GoString, _delta:GoInt64):Void
		__tmp__.add(_key, _delta);

	public function addFloat(__tmp__, _key:GoString, _delta:GoFloat64):Void
		__tmp__.addFloat(_key, _delta);

	public function delete(__tmp__, _key:GoString):Void
		__tmp__.delete(_key);

	public function do_(__tmp__, _f:KeyValue->Void):Void
		__tmp__.do_(_f);
}

class String__extension_fields {
	public function value(__tmp__):GoString
		return __tmp__.value();

	public function toString(__tmp__):GoString
		return __tmp__.toString();

	public function set(__tmp__, _value:GoString):Void
		__tmp__.set(_value);
}

class Func_extension_fields {
	public function value(__tmp__):AnyInterface
		return __tmp__.value();
