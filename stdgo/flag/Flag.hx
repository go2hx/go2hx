...
@:named class T_intValue {
	...
	public function set(_s:GoString):Error {
		var _i = new Pointer(() -> new T_intValue(this.__t__), __tmp__ -> new T_intValue(this.__t__ = __tmp__.__t__));
		var __tmp__ = stdgo.strconv.Strconv.parseInt(_s, ((0 : GoInt)), stdgo.strconv.Strconv.intSize),
...
@:named class T_uintValue {
	...
	public function set(_s:GoString):Error {
		var _i = new Pointer(() -> new T_uintValue(this.__t__), __tmp__ -> new T_uintValue(this.__t__ = __tmp__.__t__));
		var __tmp__ = stdgo.strconv.Strconv.parseUint(_s, ((0 : GoInt)), stdgo.strconv.Strconv.intSize),
...
@:named class T_uint64Value {
	...
	public function __copy__()
		return new T_uint64Value(__t__);
}
...
@:named class T_stringValue {
	...
	public function __copy__()
		return new T_stringValue(__t__);
}
...
@:named class T_float64Value {
	public function toString():GoString {
		...
		return stdgo.strconv.Strconv.formatFloat(_f.value.__t__, (((("g" : GoString)).code : GoRune)), -((1 : GoUnTypedInt)), ((64 : GoInt)));
	}
	...
	public function __copy__()
		return new T_float64Value(__t__);
}
...
@:named class T_durationValue {
	public function toString():GoString {
		...
		return new Pointer<stdgo.time.Time.Duration>(() -> new stdgo.time.Time.Duration(_d.value.__t__),
			v -> new stdgo.time.Time.Duration((_d.value = new T_durationValue(v.__t__)).__t__)).value.toString();
	}
	...
	public function __copy__()
		return new T_durationValue(__t__);
}
...
@:named class ErrorHandling {
	...
	public function __copy__()
		return new ErrorHandling(__t__);
}
...
@:structInit class FlagSet {
	...
	public function parse(_arguments:Slice<GoString>):Error {
		...
		while (true) {
			var __tmp__ = _f.value._parseOne(),
	...
	public function _parseOne():{var _0:Bool; var _1:Error;} {
		...
		if ((_s.length < ((2 : GoInt))) || (_s[((0 : GoInt))] != (((("-" : GoString)).code : GoRune)))) {
			return {_0: false, _1: ((null : stdgo.Error))};
		};
		var _numMinuses:GoInt = ((1 : GoInt));
		if (_s[((1 : GoInt))] == (((("-" : GoString)).code : GoRune))) {
			_numMinuses++;
		...
		if (((_name.length == ((0 : GoInt))) || (_name[((0 : GoInt))] == (((("-" : GoString)).code : GoRune))))
			|| (_name[((0 : GoInt))] == (((("=" : GoString)).code : GoRune)))) {
			return {_0: false, _1: _f.value._failf((("bad flag syntax: %s" : GoString)), Go.toInterface(_s))};
		};
		_f.value._args = _f.value._args.__slice__(((1 : GoInt)));
		...
		var _value:GoString = "";
		{
			...
			Go.cfor(_i < _name.length, _i++, {
				if (_name[_i] == (((("=" : GoString)).code : GoRune))) {
		...
		var __tmp__ = _m.exists(_name) ? {value: _m[_name], ok: true} : {value: _m.defaultValue(), ok: false},
			_flag:Pointer<Flag> = __tmp__.value,
		...
		if (!_alreadythere) {
			...
			return {_0: false, _1: _f.value._failf((("flag provided but not defined: -%s" : GoString)), Go.toInterface(_name))};
		};
		{
			var __tmp__ = try {
			...
			if (_ok && _fv.isBoolFlag()) {
				if (_hasValue) {
					{
						...
						if (Go.toInterface(_err) != Go.toInterface(null)) {
							return {
								_0: false,
								_1: _f.value._failf((("invalid boolean value %q for -%s: %v" : GoString)), Go.toInterface(_value), Go.toInterface(_name),
									Go.toInterface(_err))
							};
						};
					};
				} else {
					{
						...
						if (Go.toInterface(_err) != Go.toInterface(null)) {
							return {_0: false, _1: _f.value._failf((("invalid boolean flag %s: %v" : GoString)), Go.toInterface(_name), Go.toInterface(_err))};
						};
					};
				};
			} else {
				...
				if (!_hasValue) {
					return {_0: false, _1: _f.value._failf((("flag needs an argument: -%s" : GoString)), Go.toInterface(_name))};
				};
				{
					...
					if (Go.toInterface(_err) != Go.toInterface(null)) {
						return {
							_0: false,
							_1: _f.value._failf((("invalid value %q for flag -%s: %v" : GoString)), Go.toInterface(_value), Go.toInterface(_name),
								Go.toInterface(_err))
						};
					};
				};
		...
		if (_f.value._actual == null) {
			_f.value._actual = new GoMap<GoString,
				Pointer<Flag>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
				stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("Flag", [],
					stdgo.reflect.Reflect.GoType.named("Flag", [], stdgo.reflect.Reflect.GoType.structType([
						{
							name: "name",
							embedded: false,
							tag: "",
	...
	public function var_(_value:Value, _name:GoString, _usage:GoString):Void {
		...
		if (stdgo.strings.Strings.hasPrefix(_name, (("-" : GoString)))) {
			throw _f.value._sprintf((("flag %q begins with -" : GoString)), Go.toInterface(_name));
		} else if (stdgo.strings.Strings.contains(_name, (("=" : GoString)))) {
			throw _f.value._sprintf((("flag %q contains =" : GoString)), Go.toInterface(_name));
		};
		var _flag:Pointer<Flag> = Go.pointer(new Flag(_name, _usage, _value, _value.toString()));
		var __tmp__ = _f.value._formal.exists(_name) ? {value: _f.value._formal[_name], ok: true} : {value: _f.value._formal.defaultValue(), ok: false},
			_:Pointer<Flag> = __tmp__.value,
			_alreadythere:Bool = __tmp__.ok;
		if (_alreadythere) {
			var _msg:GoString = (("" : GoString));
			if (_f.value._name == (("" : GoString))) {
				_msg = _f.value._sprintf((("flag redefined: %s" : GoString)), Go.toInterface(_name));
			} else {
				_msg = _f.value._sprintf((("%s flag redefined: %s" : GoString)), Go.toInterface(_f.value._name), Go.toInterface(_name));
			};
			throw _msg;
		};
		if (_f.value._formal == null) {
			_f.value._formal = new GoMap<GoString,
				Pointer<Flag>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
				stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("Flag", [],
					stdgo.reflect.Reflect.GoType.named("Flag", [], stdgo.reflect.Reflect.GoType.structType([
						{
	...
	public function printDefaults():Void {
		...
		_f.value.visitAll(function(_flag:Pointer<Flag>):Void {
			...
			stdgo.fmt.Fmt.fprintf(Go.pointer(_b).value, (("  -%s" : GoString)), Go.toInterface(_flag.value.name));
			...
			if (!_isZeroValue(_flag, _flag.value.defValue)) {
				{
					...
					if (_ok) {
						stdgo.fmt.Fmt.fprintf(Go.pointer(_b).value, ((" (default %q)" : GoString)), Go.toInterface(_flag.value.defValue));
					} else {
						stdgo.fmt.Fmt.fprintf(Go.pointer(_b).value, ((" (default %v)" : GoString)), Go.toInterface(_flag.value.defValue));
					};
				};
			};
	...
	public function visit(_fn:Pointer<Flag>->Void):Void {
		var _f = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		for (_ => _flag in _sortFlags(_f.value._actual)) {
			_fn(_flag);
		};
	}
	...
	public function visitAll(_fn:Pointer<Flag>->Void):Void {
		var _f = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		for (_ => _flag in _sortFlags(_f.value._formal)) {
			_fn(_flag);
		};
	}
	...
	public function output():stdgo.io.Io.Writer {
		var _f = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		if (Go.toInterface(_f.value._output) == Go.toInterface(null)) {
	...
	public var _actual:GoMap<GoString, Pointer<Flag>> = new GoMap<GoString,
		Pointer<Flag>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
		stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("Flag", [], stdgo.reflect.Reflect.GoType.structType([
			{
				name: "name",
				embedded: false,
				tag: "",
	...
	public var _formal:GoMap<GoString, Pointer<Flag>> = new GoMap<GoString,
		Pointer<Flag>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
		stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("Flag", [], stdgo.reflect.Reflect.GoType.structType([
			{
				name: "name",
	...
	public function new(?usage:() -> Void, ?_name:GoString, ?_parsed:Bool, ?_actual:GoMap<GoString, Pointer<Flag>>, ?_formal:GoMap<GoString, Pointer<Flag>>,
...
function _newDurationValue(_val:stdgo.time.Time.Duration, _p:Pointer<stdgo.time.Time.Duration>):Pointer<T_durationValue> {
	_p.value = _val;
	return new Pointer<T_durationValue>(() -> new T_durationValue(_p.value.__t__),
		v -> new T_durationValue((_p.value = new stdgo.time.Time.Duration(v.__t__)).__t__));
}
...
function _sortFlags(_flags:GoMap<GoString, Pointer<Flag>>):Slice<Pointer<Flag>> {
	var _result:Slice<Pointer<Flag>> = new Slice<Pointer<Flag>>(...[
		for (i in 0...(((_flags == null ? 0 : _flags.length) : GoInt)).toBasic())
			new Pointer<Flag>().nil()
	]);
...
function unquoteUsage(_flag:Pointer<Flag>):{var _0:GoString; var _1:GoString;} {
	...
	} else if (Go.assertable(((_flag.value.value : Pointer<T_intValue>)))
		|| Go.assertable(((_flag.value.value : Pointer<T_int64Value>)))) {
		_name = (("int" : GoString));
	} else if (Go.assertable(((_flag.value.value : Pointer<T_stringValue>)))) {
		_name = (("string" : GoString));
	} else if (Go.assertable(((_flag.value.value : Pointer<T_uintValue>)))
		|| Go.assertable(((_flag.value.value : Pointer<T_uint64Value>)))) {
		_name = (("uint" : GoString));
	};
	return {_0: _name, _1: _usage};
}
...
function newFlagSet(_name:GoString, _errorHandling:ErrorHandling):Pointer<FlagSet> {
	var _f:Pointer<FlagSet> = Go.pointer((({
		_name: _name,
		_errorHandling: _errorHandling,
		usage: null,
		_parsed: false,
		_actual: new GoMap<GoString,
			Pointer<Flag>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
			stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("Flag", [],
		...
		_args: new Slice<GoString>().nil(),
		_output: ((null : stdgo.io.Io.Writer))
	} : FlagSet)));
...
class T_boolValue_extension_fields {
	public function set(__tmp__, _s:GoString):Error
		return __tmp__.set(_s);

	public function get(__tmp__):AnyInterface
		return __tmp__.get();

	public function toString(__tmp__):GoString
		return __tmp__.toString();

	public function isBoolFlag(__tmp__):Bool
		return __tmp__.isBoolFlag();
}
...
class T_stringValue_extension_fields {
	public function set(__tmp__, _val:GoString):Error
		return __tmp__.set(_val);
...
class FlagSet_extension_fields {
	public function output(__tmp__):stdgo.io.Io.Writer
		return __tmp__.output();

	public function name(__tmp__):GoString
		return __tmp__.name();

	public function errorHandling(__tmp__):ErrorHandling
		return __tmp__.errorHandling();

	public function setOutput(__tmp__, _output:stdgo.io.Io.Writer):Void
		__tmp__.setOutput(_output);

	public function visitAll(__tmp__, _fn:Pointer<Flag>->Void):Void
		__tmp__.visitAll(_fn);

	public function visit(__tmp__, _fn:Pointer<Flag>->Void):Void
		__tmp__.visit(_fn);

	public function lookup(__tmp__, _name:GoString):Pointer<Flag>
		return __tmp__.lookup(_name);

	public function set(__tmp__, _name:GoString, _value:GoString):Error
		return __tmp__.set(_name, _value);

	public function printDefaults(__tmp__):Void
		__tmp__.printDefaults();

	public function _defaultUsage(__tmp__):Void
		__tmp__._defaultUsage();

	public function nflag(__tmp__):GoInt
		return __tmp__.nflag();

	public function arg(__tmp__, _i:GoInt):GoString
		return __tmp__.arg(_i);

	public function narg(__tmp__):GoInt
		return __tmp__.narg();

	public function args(__tmp__):Slice<GoString>
		return __tmp__.args();

	public function boolVar(__tmp__, _p:Pointer<Bool>, _name:GoString, _value:Bool, _usage:GoString):Void
		__tmp__.boolVar(_p, _name, _value, _usage);

	public function bool(__tmp__, _name:GoString, _value:Bool, _usage:GoString):Pointer<Bool>
		return __tmp__.bool(_name, _value, _usage);

	public function intVar(__tmp__, _p:Pointer<GoInt>, _name:GoString, _value:GoInt, _usage:GoString):Void
		__tmp__.intVar(_p, _name, _value, _usage);

	public function int(__tmp__, _name:GoString, _value:GoInt, _usage:GoString):Pointer<GoInt>
		return __tmp__.int(_name, _value, _usage);

	public function int64Var(__tmp__, _p:Pointer<GoInt64>, _name:GoString, _value:GoInt64, _usage:GoString):Void
		__tmp__.int64Var(_p, _name, _value, _usage);

	public function int64(__tmp__, _name:GoString, _value:GoInt64, _usage:GoString):Pointer<GoInt64>
		return __tmp__.int64(_name, _value, _usage);

	public function uintVar(__tmp__, _p:Pointer<GoUInt>, _name:GoString, _value:GoUInt, _usage:GoString):Void
		__tmp__.uintVar(_p, _name, _value, _usage);

	public function uint(__tmp__, _name:GoString, _value:GoUInt, _usage:GoString):Pointer<GoUInt>
		return __tmp__.uint(_name, _value, _usage);

	public function uint64Var(__tmp__, _p:Pointer<GoUInt64>, _name:GoString, _value:GoUInt64, _usage:GoString):Void
		__tmp__.uint64Var(_p, _name, _value, _usage);

	public function uint64(__tmp__, _name:GoString, _value:GoUInt64, _usage:GoString):Pointer<GoUInt64>
		return __tmp__.uint64(_name, _value, _usage);

	public function stringVar(__tmp__, _p:Pointer<GoString>, _name:GoString, _value:GoString, _usage:GoString):Void
		__tmp__.stringVar(_p, _name, _value, _usage);

	public function toString(__tmp__, _name:GoString, _value:GoString, _usage:GoString):Pointer<GoString>
		return __tmp__.toString(_name, _value, _usage);

	public function float64Var(__tmp__, _p:Pointer<GoFloat64>, _name:GoString, _value:GoFloat64, _usage:GoString):Void
		__tmp__.float64Var(_p, _name, _value, _usage);

	public function float64(__tmp__, _name:GoString, _value:GoFloat64, _usage:GoString):Pointer<GoFloat64>
		return __tmp__.float64(_name, _value, _usage);

	public function durationVar(__tmp__, _p:Pointer<stdgo.time.Time.Duration>, _name:GoString, _value:stdgo.time.Time.Duration, _usage:GoString):Void
		__tmp__.durationVar(_p, _name, _value, _usage);

	public function duration(__tmp__, _name:GoString, _value:stdgo.time.Time.Duration, _usage:GoString):Pointer<stdgo.time.Time.Duration>
		return __tmp__.duration(_name, _value, _usage);

	public function func(__tmp__, _name:GoString, _usage:GoString, _fn:GoString->Error):Void
		__tmp__.func(_name, _usage, _fn);

	public function var_(__tmp__, _value:Value, _name:GoString, _usage:GoString):Void
		__tmp__.var_(_value, _name, _usage);

	public function _sprintf(__tmp__, _format:GoString, _a:haxe.Rest<AnyInterface>):GoString
		return __tmp__._sprintf(_format, _a);

	public function _failf(__tmp__, _format:GoString, _a:haxe.Rest<AnyInterface>):Error
		return __tmp__._failf(_format, _a);

	public function _usage(__tmp__):Void
		__tmp__._usage();

	public function _parseOne(__tmp__):{var _0:Bool; var _1:Error;}
		return __tmp__._parseOne();

	public function parse(__tmp__, _arguments:Slice<GoString>):Error
		return __tmp__.parse(_arguments);

	public function parsed(__tmp__):Bool
		return __tmp__.parsed();

	public function init(__tmp__, _name:GoString, _errorHandling:ErrorHandling):Void
		__tmp__.init(_name, _errorHandling);
}
