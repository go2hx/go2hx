...
**/
var errHelp = stdgo.errors.Errors.new_(("flag: help requested" : GoString));
/**
...
**/
private var _errParse = stdgo.errors.Errors.new_(("parse error" : GoString));
/**
...
**/
private var _errRange = stdgo.errors.Errors.new_(("value out of range" : GoString));
/**
...
private function _numError(_err:Error):Error {
        var __tmp__ = try {
...
private function _sortFlags(_flags:GoMap<GoString, Ref<Flag>>):Slice<Ref<Flag>> {
        var _result = new Slice<Ref<stdgo.flag.Flag.Flag>>((_flags.length : GoInt).toBasic(), 0);
...
/**
    ...
    // value for a flag.
**/
private function _isZeroValue(_flag:Ref<Flag>, _value:GoString):{ var _0 : Bool; var _1 : Error; } {
...
private function _commandLineUsage():Void {
        usage();
    }
/**
    ...
    static public function string( _v:T_textValue):GoString {
        {
            ...
            if (_ok) {
                {
                    var __tmp__ = _m.marshalText(), _b:Slice<GoUInt8> = __tmp__._0, _err:Error = __tmp__._1;
                    if (_err == null) {
                        return (_b : GoString);
                    };
                };
...
@:keep @:allow(stdgo.flag.Flag.FlagSet_asInterface) class FlagSet_static_extension {
    ...
    **/
    ...
    static public function parse( _f:Ref<FlagSet>, _arguments:Slice<GoString>):Error {
        ...
        _f._args = _arguments;
        while (true) {
            var __tmp__ = _f._parseOne(), _seen:Bool = __tmp__._0, _err:Error = __tmp__._1;
            if (_seen) {
                continue;
            };
            if (_err == null) {
    ...
    **/
    ...
    static public function _parseOne( _f:Ref<FlagSet>):{ var _0 : Bool; var _1 : Error; } {
        ...
        var __tmp__ = (_f._formal != null && _f._formal.exists(_name) ? { value : _f._formal[_name], ok : true } : { value : (null : Ref<stdgo.flag.Flag.Flag>), ok : false }), _flag:Ref<stdgo.flag.Flag.Flag> = __tmp__.value, _ok:Bool = __tmp__.ok;
        if (!_ok) {
        ...
        };
        {
            ...
            if (_ok && _fv.isBoolFlag()) {
                if (_hasValue) {
                    ...
                    {
                        var _err:Error = _fv.set(("true" : GoString));
                        if (_err != null) {
    ...
    **/
    ...
    static public function var_( _f:Ref<FlagSet>, _value:Value, _name:GoString, _usage:GoString):Void {
        ...
        var __tmp__ = (_f._formal != null && _f._formal.exists(_name) ? { value : _f._formal[_name], ok : true } : { value : (null : Ref<stdgo.flag.Flag.Flag>), ok : false }), __0:Ref<stdgo.flag.Flag.Flag> = __tmp__.value, _alreadythere:Bool = __tmp__.ok;
        if (_alreadythere) {
    ...
    **/
    @:keep
    static public function textVar( _f:Ref<FlagSet>, _p:stdgo.encoding.Encoding.TextUnmarshaler, _name:GoString, _value:stdgo.encoding.Encoding.TextMarshaler, _usage:GoString):Void {
    ...
    **/
    @:keep
    static public function durationVar( _f:Ref<FlagSet>, _p:Pointer<stdgo.time.Time.Duration>, _name:GoString, _value:stdgo.time.Time.Duration, _usage:GoString):Void {
    ...
    **/
    ...
    static public function printDefaults( _f:Ref<FlagSet>):Void {
        ...
        _f.visitAll(function(_flag:Ref<Flag>):Void {
            ...
            {
                var __tmp__ = _isZeroValue(_flag, _flag.defValue), _isZero:Bool = __tmp__._0, _err:Error = __tmp__._1;
                if (_err != null) {
            ...
            stdgo.fmt.Fmt.fprint(_f.output(), Go.toInterface((_b.string() : GoString)), Go.toInterface(("\n" : GoString)));
        });
        {
...
@:keep @:allow(stdgo.flag.Flag.T_boolValue_asInterface) class T_boolValue_static_extension {
    ...
    static public function set(____:T_boolValue,  _b:Pointer<T_boolValue>, _s:GoString):Error {
        var __tmp__ = stdgo.strconv.Strconv.parseBool(_s), _v:Bool = __tmp__._0, _err:Error = __tmp__._1;
        if (_err != null) {
            _err = _errParse;
        };
...
@:keep @:allow(stdgo.flag.Flag.T_intValue_asInterface) class T_intValue_static_extension {
    ...
    static public function set(____:T_intValue,  _i:Pointer<T_intValue>, _s:GoString):Error {
        var __tmp__ = stdgo.strconv.Strconv.parseInt(_s, (0 : GoInt), (32 : GoInt)), _v:GoInt64 = __tmp__._0, _err:Error = __tmp__._1;
        if (_err != null) {
            _err = _numError(_err);
        };
...
@:keep @:allow(stdgo.flag.Flag.T_int64Value_asInterface) class T_int64Value_static_extension {
    ...
    static public function set(____:T_int64Value,  _i:Pointer<T_int64Value>, _s:GoString):Error {
        var __tmp__ = stdgo.strconv.Strconv.parseInt(_s, (0 : GoInt), (64 : GoInt)), _v:GoInt64 = __tmp__._0, _err:Error = __tmp__._1;
        if (_err != null) {
            _err = _numError(_err);
        };
...
@:keep @:allow(stdgo.flag.Flag.T_uintValue_asInterface) class T_uintValue_static_extension {
    ...
    static public function set(____:T_uintValue,  _i:Pointer<T_uintValue>, _s:GoString):Error {
        var __tmp__ = stdgo.strconv.Strconv.parseUint(_s, (0 : GoInt), (32 : GoInt)), _v:GoUInt64 = __tmp__._0, _err:Error = __tmp__._1;
        if (_err != null) {
            _err = _numError(_err);
        };
...
@:keep @:allow(stdgo.flag.Flag.T_uint64Value_asInterface) class T_uint64Value_static_extension {
    ...
    static public function set(____:T_uint64Value,  _i:Pointer<T_uint64Value>, _s:GoString):Error {
        var __tmp__ = stdgo.strconv.Strconv.parseUint(_s, (0 : GoInt), (64 : GoInt)), _v:GoUInt64 = __tmp__._0, _err:Error = __tmp__._1;
        if (_err != null) {
            _err = _numError(_err);
        };
...
@:keep @:allow(stdgo.flag.Flag.T_float64Value_asInterface) class T_float64Value_static_extension {
    ...
    static public function set(____:T_float64Value,  _f:Pointer<T_float64Value>, _s:GoString):Error {
        var __tmp__ = stdgo.strconv.Strconv.parseFloat(_s, (64 : GoInt)), _v:GoFloat64 = __tmp__._0, _err:Error = __tmp__._1;
        if (_err != null) {
            _err = _numError(_err);
        };
...
@:keep @:allow(stdgo.flag.Flag.T_durationValue_asInterface) class T_durationValue_static_extension {
    ...
    static public function set(____:T_durationValue,  _d:Pointer<T_durationValue>, _s:GoString):Error {
        var __tmp__ = stdgo.time.Time.parseDuration(_s), _v:stdgo.time.Time.Duration = __tmp__._0, _err:Error = __tmp__._1;
        if (_err != null) {
            _err = _errParse;
        };
