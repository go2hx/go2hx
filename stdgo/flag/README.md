...
[30;41m ERROR [0m stdgo/flag/Flag.hx:2: character 1

    2 | [0m[1m[0m[2mfinal continueOnError : ErrorHandling = stdgo._internal.flag.Flag.continueOnError;[0m
      | [31m^[0m
      | stdgo.flag._Flag.Flag_Fields_ is not ready to be accessed, separate your type declarations in several files
