...
private var _tests:Slice<stdgo.testing.Testing.InternalTest> = (new Slice<stdgo.testing.Testing.InternalTest>(0, 0,
	...
	(new stdgo.testing.Testing.InternalTest(("TestUserDefinedFunc" : GoString),
		stdgo.flag_test.Flag_test.testUserDefinedFunc) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestUserDefinedForCommandLine" : GoString),
		stdgo.flag_test.Flag_test.testUserDefinedForCommandLine) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestUserDefinedBool" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestPrintDefaults" : GoString),
		stdgo.flag_test.Flag_test.testPrintDefaults) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestIntFlagOverflow" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestRedefinedFlags" : GoString),
...
private var _examples:Slice<stdgo.testing.Testing.InternalExample> = (new Slice<stdgo.testing.Testing.InternalExample>(0, 0,
	(new stdgo.testing.Testing.InternalExample(("ExampleFunc" : GoString), stdgo.flag_test.Flag_test.exampleFunc,
	...
	(new stdgo.testing.Testing.InternalExample(("ExampleTextVar" : GoString), stdgo.flag_test.Flag_test.exampleTextVar,
		...
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleValue" : GoString), stdgo.flag_test.Flag_test.exampleValue,
