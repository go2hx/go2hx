...
import stdgo.GoMap;
import stdgo.Chan;
var _species : Pointer<GoString> = stdgo.flag.Flag.string(((Go.str("species") : GoString)), ((Go.str("gopher") : GoString)), ((Go.str("the species we are studying") : GoString)));
...
function exampleValue():Void {
        ...
        _fs.var_({
            ...
            __self__.set = #if !macro function(__0:GoString):stdgo.Error return ((new stdgo.flag_test.Flag_test.URLValue(_u) : stdgo.flag_test.Flag_test.URLValue)).set(__0) #else null #end;
            __self__.string = #if !macro function():GoString return ((new stdgo.flag_test.Flag_test.URLValue(_u) : stdgo.flag_test.Flag_test.URLValue)).string() #else null #end;
            __self__;
...
function testEverything(_t:stdgo.testing.Testing.T):Void {
        ...
        var _visitor = function(_f:Flag):Void {
            if (((_f.name != null ? _f.name.length : ((0 : GoInt))) > ((5 : GoInt))) && (((_f.name.__slice__(((0 : GoInt)), ((5 : GoInt))) : GoString)) == ((Go.str("test_") : GoString)))) {
                ...
                if (((_f.value.string() : GoString)) == _desired) {
                    ...
                    _ok = true;
                } else if ((_f.name == ((Go.str("test_duration") : GoString))) && (((_f.value.string() : GoString)) == (_desired + ((Go.str("s") : GoString))))) {
                    _ok = true;
                } else if ((_f.name == ((Go.str("test_func") : GoString))) && (((_f.value.string() : GoString)) == ((Go.str() : GoString)))) {
                    _ok = true;
                };
                if (!_ok) {
                    _t.error(Go.toInterface(((Go.str("Visit: bad value") : GoString))), Go.toInterface(((_f.value.string() : GoString))), Go.toInterface(((Go.str("for") : GoString))), Go.toInterface(_f.name));
                };
            };
        };
        visitAll(_visitor);
        ...
        visit(function(_f:Flag):Void {
            _flagNames = (_flagNames != null ? _flagNames.__append__(_f.name) : new Slice<GoString>(0, 0, _f.name));
        });
...
function testGet(_t:stdgo.testing.Testing.T):Void {
        ...
        var _visitor = function(_f:Flag):Void {
            if (((_f.name != null ? _f.name.length : ((0 : GoInt))) > ((5 : GoInt))) && (((_f.name.__slice__(((0 : GoInt)), ((5 : GoInt))) : GoString)) == ((Go.str("test_") : GoString)))) {
                ...
                if (!_ok) {
                    _t.errorf(((Go.str("Visit: bad value %T(%v) for %s") : GoString)), Go.toInterface(_g.get(Go.pointer(_g))), Go.toInterface(_g.get(Go.pointer(_g))), Go.toInterface(_f.name));
                };
            };
        };
        visitAll(_visitor);
...
0,
0,
((Go.str("-bool") : GoString)),
((Go.str("-bool2=true") : GoString)),
((Go.str("--int") : GoString)),
((Go.str("22") : GoString)),
((Go.str("--int64") : GoString)),
((Go.str("0x23") : GoString)),
((Go.str("-uint") : GoString)),
((Go.str("24") : GoString)),
((Go.str("--uint64") : GoString)),
((Go.str("25") : GoString)),
((Go.str("-string") : GoString)),
((Go.str("hello") : GoString)),
((Go.str("-float64") : GoString)),
((Go.str("2718e28") : GoString)),
((Go.str("-duration") : GoString)),
((Go.str("2m") : GoString)),
_extra) : Slice<GoString>));
        ...
        if ((_f.args() != null ? _f.args().length : ((0 : GoInt))) != ((1 : GoInt))) {
            _t.error(Go.toInterface(((Go.str("expected one argument, got") : GoString))), Go.toInterface((_f.args() != null ? _f.args().length : ((0 : GoInt)))));
        } else if ((_f.args() != null ? _f.args()[((0 : GoInt))] : (("" : GoString))) != _extra) {
            _t.errorf(((Go.str("expected argument %q got %q") : GoString)), Go.toInterface(_extra), Go.toInterface((_f.args() != null ? _f.args()[((0 : GoInt))] : (("" : GoString)))));
        };
    }
...
function testUserDefined(_t:stdgo.testing.Testing.T):Void {
        ...
        {
            var _err:stdgo.Error = _flags.parse(((new Slice<GoString>(0, 0, ((Go.str("-v") : GoString)), ((Go.str("1") : GoString)), ((Go.str("-v") : GoString)), ((Go.str("2") : GoString)), ((Go.str("-v=3") : GoString))) : Slice<GoString>)));
            if (_err != null) {
                _t.error(Go.toInterface(_err));
            };
        };
        if ((_v != null ? _v.length : ((0 : GoInt))) != ((3 : GoInt))) {
            _t.fatal(Go.toInterface(((Go.str("expected 3 args; got ") : GoString))), Go.toInterface((_v != null ? _v.length : ((0 : GoInt)))));
        };
...
function testUserDefinedFunc(_t:stdgo.testing.Testing.T):Void {
        ...
        _flags.func(((Go.str("v") : GoString)), ((Go.str("usage") : GoString)), function(_s:GoString):Error {
            _ss = (_ss != null ? _ss.__append__(_s) : new Slice<GoString>(0, 0, _s));
            return ((null : stdgo.Error));
        });
        {
            var _err:stdgo.Error = _flags.parse(((new Slice<GoString>(0, 0, ((Go.str("-v") : GoString)), ((Go.str("1") : GoString)), ((Go.str("-v") : GoString)), ((Go.str("2") : GoString)), ((Go.str("-v=3") : GoString))) : Slice<GoString>)));
        ...
        if ((_ss != null ? _ss.length : ((0 : GoInt))) != ((3 : GoInt))) {
            _t.fatal(Go.toInterface(((Go.str("expected 3 args; got ") : GoString))), Go.toInterface((_ss != null ? _ss.length : ((0 : GoInt)))));
        };
        var _expect:GoString = ((Go.str("[1 2 3]") : GoString));
        {
...
function testUserDefinedBool(_t:stdgo.testing.Testing.T):Void {
        ...
        {
            _err = _flags.parse(((new Slice<GoString>(0, 0, ((Go.str("-b") : GoString)), ((Go.str("-b") : GoString)), ((Go.str("-b") : GoString)), ((Go.str("-b=true") : GoString)), ((Go.str("-b=false") : GoString)), ((Go.str("-b") : GoString)), ((Go.str("barg") : GoString)), ((Go.str("-b") : GoString))) : Slice<GoString>)));
            if (_err != null) {
...
function testChangingArgs(_t:stdgo.testing.Testing.T):Void {
        ...
        try {
            ...
            stdgo.os.Os.args = ((new Slice<GoString>(0, 0, ((Go.str("cmd") : GoString)), ((Go.str("-before") : GoString)), ((Go.str("subcmd") : GoString)), ((Go.str("-after") : GoString)), ((Go.str("args") : GoString))) : Slice<GoString>));
            ...
            parse();
            var _args = args();
            if ((((!_before.value || (_cmd != ((Go.str("subcmd") : GoString)))) || !_after.value) || ((_args != null ? _args.length : ((0 : GoInt))) != ((1 : GoInt)))) || ((_args != null ? _args[((0 : GoInt))] : (("" : GoString))) != ((Go.str("args") : GoString)))) {
                _t.fatalf(((Go.str("expected true subcmd true [args] got %v %v %v %v") : GoString)), Go.toInterface(_before.value), Go.toInterface(_cmd), Go.toInterface(_after.value), Go.toInterface(_args));
            };
...
function testPrintDefaults(_t:stdgo.testing.Testing.T):Void {
        ...
        _fs.var_({
            final __self__ = new stdgo.flag_test.Flag_test.T_flagVar_wrapper(((new stdgo.flag_test.Flag_test.T_flagVar(0, 0, ((Go.str("a") : GoString)), ((Go.str("b") : GoString))) : stdgo.flag_test.Flag_test.T_flagVar)));
            __self__.set = #if !macro function(__0:GoString):stdgo.Error return ((new stdgo.flag_test.Flag_test.T_flagVar(0, 0, ((Go.str("a") : GoString)), ((Go.str("b") : GoString))) : stdgo.flag_test.Flag_test.T_flagVar)).set(__0) #else null #end;
            __self__.string = #if !macro function():GoString return ((new stdgo.flag_test.Flag_test.T_flagVar(0, 0, ((Go.str("a") : GoString)), ((Go.str("b") : GoString))) : stdgo.flag_test.Flag_test.T_flagVar)).string() #else null #end;
            __self__;
        ...
        _fs.var_({
            final __self__ = new stdgo.flag_test.Flag_test.T_zeroPanicker_wrapper(((new stdgo.flag_test.Flag_test.T_zeroPanicker(true, ((Go.str() : GoString))) : stdgo.flag_test.Flag_test.T_zeroPanicker)));
            __self__.set = #if !macro function(__0:GoString):stdgo.Error return ((new stdgo.flag_test.Flag_test.T_zeroPanicker(true, ((Go.str() : GoString))) : stdgo.flag_test.Flag_test.T_zeroPanicker)).set(__0) #else null #end;
            __self__.string = #if !macro function():GoString return ((new stdgo.flag_test.Flag_test.T_zeroPanicker(true, ((Go.str() : GoString))) : stdgo.flag_test.Flag_test.T_zeroPanicker)).string() #else null #end;
            __self__;
        }, ((Go.str("ZP0") : GoString)), ((Go.str("a flag whose String method panics when it is zero") : GoString)));
        _fs.var_({
            final __self__ = new stdgo.flag_test.Flag_test.T_zeroPanicker_wrapper(((new stdgo.flag_test.Flag_test.T_zeroPanicker(true, ((Go.str("something") : GoString))) : stdgo.flag_test.Flag_test.T_zeroPanicker)));
            __self__.set = #if !macro function(__0:GoString):stdgo.Error return ((new stdgo.flag_test.Flag_test.T_zeroPanicker(true, ((Go.str("something") : GoString))) : stdgo.flag_test.Flag_test.T_zeroPanicker)).set(__0) #else null #end;
            __self__.string = #if !macro function():GoString return ((new stdgo.flag_test.Flag_test.T_zeroPanicker(true, ((Go.str("something") : GoString))) : stdgo.flag_test.Flag_test.T_zeroPanicker)).string() #else null #end;
            __self__;
        ...
        if (_got != ((Go.str("  -A\tfor bootstrapping, allow \'any\' type\n  -Alongflagname\n    \tdisable bounds checking\n  -C\ta boolean defaulting to true (default true)\n  -D path\n    \tset relative path for local imports\n  -E string\n    \tissue 23543 (default \"0\")\n  -F number\n    \ta non-zero number (default 2.7)\n  -G float\n    \ta float that defaults to zero\n  -M string\n    \ta multiline\n    \thelp\n    \tstring\n  -N int\n    \ta non-zero int (default 27)\n  -O\ta flag\n    \tmultiline help string (default true)\n  -V list\n    \ta list of strings (default [a b])\n  -Z int\n    \tan int that defaults to zero\n  -ZP0 value\n    \ta flag whose String method panics when it is zero\n  -ZP1 value\n    \ta flag whose String method panics when it is zero\n  -maxT timeout\n    \tset timeout for dial\n\npanic calling String method on zero flag_test.zeroPanicker for flag ZP0: panic!\npanic calling String method on zero flag_test.zeroPanicker for flag ZP1: panic!\n") : GoString))) {
            _t.errorf(((Go.str("got:\n%q\nwant:\n%q") : GoString)), Go.toInterface(_got), Go.toInterface(((Go.str("  -A\tfor bootstrapping, allow \'any\' type\n  -Alongflagname\n    \tdisable bounds checking\n  -C\ta boolean defaulting to true (default true)\n  -D path\n    \tset relative path for local imports\n  -E string\n    \tissue 23543 (default \"0\")\n  -F number\n    \ta non-zero number (default 2.7)\n  -G float\n    \ta float that defaults to zero\n  -M string\n    \ta multiline\n    \thelp\n    \tstring\n  -N int\n    \ta non-zero int (default 27)\n  -O\ta flag\n    \tmultiline help string (default true)\n  -V list\n    \ta list of strings (default [a b])\n  -Z int\n    \tan int that defaults to zero\n  -ZP0 value\n    \ta flag whose String method panics when it is zero\n  -ZP1 value\n    \ta flag whose String method panics when it is zero\n  -maxT timeout\n    \tset timeout for dial\n\npanic calling String method on zero flag_test.zeroPanicker for flag ZP0: panic!\npanic calling String method on zero flag_test.zeroPanicker for flag ZP1: panic!\n") : GoString))));
        };
    }
/**
        ...
        try {
            ...
            {};
            {
                ...
                if (_got != ((Go.str("flag provided but not defined: -i\nUsage of app:\n") : GoString))) {
                    _t.errorf(((Go.str("output = %q; want %q") : GoString)), Go.toInterface(_got), Go.toInterface(((Go.str("flag provided but not defined: -i\nUsage of app:\n") : GoString))));
                };
            };
            for (defer in __deferstack__) {
                defer();
...
function testGetters(_t:stdgo.testing.Testing.T):Void {
        ...
        if (_fs.errorHandling() != _expectedErrorHandling) {
            _t.errorf(((Go.str("unexpected ErrorHandling: got %d, expected %d") : GoString)), Go.toInterface(_fs.errorHandling()), Go.toInterface(_expectedErrorHandling));
        };
...
function testParseError(_t:stdgo.testing.Testing.T):Void {
        for (_0 => _typ in ((new Slice<GoString>(0, 0, ((Go.str("bool") : GoString)), ((Go.str("int") : GoString)), ((Go.str("int64") : GoString)), ((Go.str("uint") : GoString)), ((Go.str("uint64") : GoString)), ((Go.str("float64") : GoString)), ((Go.str("duration") : GoString))) : Slice<GoString>))) {
            ...
            if (!stdgo.strings.Strings.contains(_err.error(), ((Go.str("invalid") : GoString))) || !stdgo.strings.Strings.contains(_err.error(), ((Go.str("parse error") : GoString)))) {
                _t.errorf(((Go.str("Parse(%q)=%v; expected parse error") : GoString)), Go.toInterface(_args), Go.toInterface(_err));
            };
        };
    }
function testRangeError(_t:stdgo.testing.Testing.T):Void {
        var _bad = ((new Slice<GoString>(0, 0, ((Go.str("-int=123456789012345678901") : GoString)), ((Go.str("-int64=123456789012345678901") : GoString)), ((Go.str("-uint=123456789012345678901") : GoString)), ((Go.str("-uint64=123456789012345678901") : GoString)), ((Go.str("-float64=1e1000") : GoString))) : Slice<GoString>));
        for (_0 => _arg in _bad) {
            var _fs = newFlagSet(((Go.str("parse error test") : GoString)), ((0 : ErrorHandling)));
            _fs.setOutput(stdgo.io.Io.discard);
            _fs.int(((Go.str("int") : GoString)), ((0 : GoInt)), ((Go.str() : GoString)));
            ...
            if (!stdgo.strings.Strings.contains(_err.error(), ((Go.str("invalid") : GoString))) || !stdgo.strings.Strings.contains(_err.error(), ((Go.str("value out of range") : GoString)))) {
                _t.errorf(((Go.str("Parse(%q)=%v; expected range error") : GoString)), Go.toInterface(_arg), Go.toInterface(_err));
            };
        };
    }
function testExitCode(_t:stdgo.testing.Testing.T):Void {
        ...
        var _tests = ((new Slice<T__struct_0>(0, 0, (({ _flag : (("" : GoString)), _flagHandle : (("" : GoString)), _expectExit : ((0 : GoInt)) } : T__struct_0)), (({ _flag : (("" : GoString)), _flagHandle : (("" : GoString)), _expectExit : ((0 : GoInt)) } : T__struct_0)), (({ _flag : (("" : GoString)), _flagHandle : (("" : GoString)), _expectExit : ((0 : GoInt)) } : T__struct_0)), (({ _flag : (("" : GoString)), _flagHandle : (("" : GoString)), _expectExit : ((0 : GoInt)) } : T__struct_0)), (({ _flag : (("" : GoString)), _flagHandle : (("" : GoString)), _expectExit : ((0 : GoInt)) } : T__struct_0))) : Slice<T__struct_0>));
        for (_0 => _test in _tests) {
            var _cmd = stdgo.os.exec.Exec.command((stdgo.os.Os.args != null ? stdgo.os.Os.args[((0 : GoInt))] : (("" : GoString))), ((Go.str("-test.run=TestExitCode") : GoString)));
            _cmd.env = (stdgo.os.Os.environ() != null ? stdgo.os.Os.environ().__append__(((Go.str("GO_CHILD_FLAG=") : GoString)) + _test._flag, ((Go.str("GO_CHILD_FLAG_HANDLE=") : GoString)) + _test._flagHandle) : new Slice<GoString>(0, 0, ((Go.str("GO_CHILD_FLAG=") : GoString)) + _test._flag, ((Go.str("GO_CHILD_FLAG_HANDLE=") : GoString)) + _test._flagHandle));
            _cmd.run();
...
function testInvalidFlags(_t:stdgo.testing.Testing.T):Void {
        var _tests = ((new Slice<T__struct_1>(0, 0, (({ _flag : (("" : GoString)), _errorMsg : (("" : GoString)) } : T__struct_1)), (({ _flag : (("" : GoString)), _errorMsg : (("" : GoString)) } : T__struct_1))) : Slice<T__struct_1>));
        for (_0 => _test in _tests) {
...
function testRedefinedFlags(_t:stdgo.testing.Testing.T):Void {
        var _tests = ((new Slice<T__struct_2>(0, 0, (({ _flagSetName : (("" : GoString)), _errorMsg : (("" : GoString)) } : T__struct_2)), (({ _flagSetName : (("" : GoString)), _errorMsg : (("" : GoString)) } : T__struct_2))) : Slice<T__struct_2>));
        for (_0 => _test in _tests) {
...
@:keep var _ = {
        try {
            ...
            stdgo.flag.Flag.var_({
                ...
                __self__;
            }, ((Go.str("deltaT") : GoString)), ((Go.str("comma-separated list of intervals to use between events") : GoString)));
    ...
    **/
    ...
    static public function set( _i:T_interval, _value:GoString):Error {
        ...
        for (_0 => _dt in stdgo.strings.Strings.split(_value, ((Go.str(",") : GoString)))) {
            ...
            _i = (_i != null ? _i.__append__(_duration) : new stdgo.flag_test.Flag_test.T_interval(0, 0, _duration));
        };
        return ((null : stdgo.Error));
    }
    /**
...
@:keep class T_flagVar_static_extension {
    ...
    static public function set( _f:T_flagVar, _value:GoString):Error {
        _f = (_f != null ? _f.__append__(_value) : new stdgo.flag_test.Flag_test.T_flagVar(0, 0, _value));
        return ((null : stdgo.Error));
    }
    @:keep
