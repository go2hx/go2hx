...
**/
private var _species:Pointer<GoString> = stdgo.flag.Flag.string(("species" : GoString), ("gopher" : GoString), ("the species we are studying" : GoString));
...
function exampleTextVar():Void {
	...
	_fs.setOutput(Go.asInterface(stdgo.os.Os.stdout));
	var _ip:stdgo.net.Net.IP = new stdgo.net.Net.IP(0, 0);
	_fs.textVar(Go.asInterface((_ip : Ref<stdgo.net.Net.IP>)), ("ip" : GoString),
		Go.asInterface(stdgo.net.Net.ipv4((192 : GoUInt8), (168 : GoUInt8), (0 : GoUInt8), (100 : GoUInt8))), ("`IP address` to parse" : GoString));
	_fs.parse((new Slice<GoString>(0, 0, ("-ip" : GoString), ("127.0.0.1" : GoString)) : Slice<GoString>));
...
function exampleValue():Void {
	...
	_fs.var_(Go.asInterface(((new URLValue(_u) : URLValue) : Ref<stdgo.flag_test.Flag_test.URLValue>)), ("url" : GoString), ("URL to parse" : GoString));
...
function testEverything(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _m = (new GoObjectMap<GoString, Ref<Flag>>(new stdgo.internal.reflect.Reflect._Type(stdgo.internal.reflect.Reflect.GoType.mapType({get: () ->
		...
		{get: () -> stdgo.internal.reflect.Reflect.GoType.refType({get: () -> stdgo.internal.reflect.Reflect.GoType.named("Flag", [], null, false,
			{get: () -> null})})}))) : GoMap<GoString, Ref<Flag>>);
	...
	var _visitor = function(_f:Ref<Flag>):Void {
		if ((_f.name.length > (5 : GoInt)) && ((_f.name.__slice__((0 : GoInt), (5 : GoInt)) : GoString) == ("test_" : GoString))) {
			...
			if (!_ok) {
				_t.error(Go.toInterface(("Visit: bad value" : GoString)), Go.toInterface((_f.value.string() : GoString)), Go.toInterface(("for" : GoString)),
	...
	var _visitor = function(_f:Ref<Flag>):Void {
		if ((_f.name.length > (5 : GoInt)) && ((_f.name.__slice__((0 : GoInt), (5 : GoInt)) : GoString) == ("test_" : GoString))) {
			...
			if (_f.name == (("test_bool" : GoString))) {
				...
				_ok = Go.toInterface(_g.get()) == (Go.toInterface(("5" : GoString)));
...
private function _testParse(_f:Ref<FlagSet>, _t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _args = (new Slice<GoString>(0, 0, ("-bool" : GoString), ("-bool2=true" : GoString), ("--int" : GoString), ("22" : GoString), ("--int64" : GoString),
		("0x23" : GoString), ("-uint" : GoString), ("24" : GoString), ("--uint64" : GoString), ("25" : GoString), ("-string" : GoString),
		("hello" : GoString), ("-float64" : GoString), ("2718e28" : GoString), ("-duration" : GoString), ("2m" : GoString), _extra) : Slice<GoString>);
	{
...
function testUserDefined(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	_flags.var_(Go.asInterface((_v : Ref<stdgo.flag_test.Flag_test.T_flagVar>)), ("v" : GoString), ("usage" : GoString));
	{
		var _err:Error = _flags.parse((new Slice<GoString>(0, 0, ("-v" : GoString), ("1" : GoString), ("-v" : GoString), ("2" : GoString),
			("-v=3" : GoString)) : Slice<GoString>));
		if (_err != null) {
...
function testUserDefinedBool(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	_flags.var_(Go.asInterface((_b : Ref<stdgo.flag_test.Flag_test.T_boolFlagVar>)), ("b" : GoString), ("usage" : GoString));
	{
		_err = _flags.parse((new Slice<GoString>(0, 0, ("-b" : GoString), ("-b" : GoString), ("-b" : GoString), ("-b=true" : GoString),
			("-b=false" : GoString), ("-b" : GoString), ("barg" : GoString), ("-b" : GoString)) : Slice<GoString>));
		if (_err != null) {
...
function testChangingArgs(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	try {
		...
		stdgo.os.Os.args = (new Slice<GoString>(0, 0, ("cmd" : GoString), ("-before" : GoString), ("subcmd" : GoString), ("-after" : GoString),
			("args" : GoString)) : Slice<GoString>);
		...
		parse();
		var _args = args();
		if ((((!_before.value || (_cmd != ("subcmd" : GoString))) || !_after.value) || (_args.length != (1 : GoInt)))
			|| (_args[(0 : GoInt)] != ("args" : GoString))) {
			_t.fatalf(("expected true subcmd true [args] got %v %v %v %v" : GoString), Go.toInterface(_before.value), Go.toInterface(_cmd),
...
function testPrintDefaults(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	_fs.var_(Go.asInterface(((new Slice<GoString>(0, 0, ("a" : GoString),
		("b" : GoString)) : stdgo.flag_test.Flag_test.T_flagVar) : Ref<stdgo.flag_test.Flag_test.T_flagVar>)),
		("V" : GoString), ("a `list` of strings" : GoString));
	_fs.int_(("Z" : GoString), (0 : GoInt), ("an int that defaults to zero" : GoString));
	_fs.var_(Go.asInterface(((new T_zeroPanicker(true, Go.str()) : T_zeroPanicker) : Ref<stdgo.flag_test.Flag_test.T_zeroPanicker>)), ("ZP0" : GoString),
		("a flag whose String method panics when it is zero" : GoString));
	_fs.var_(Go.asInterface(((new T_zeroPanicker(true, ("something" : GoString)) : T_zeroPanicker) : Ref<stdgo.flag_test.Flag_test.T_zeroPanicker>)),
		("ZP1" : GoString), ("a flag whose String method panics when it is zero" : GoString));
	...
	if (_got != (("  -A\tfor bootstrapping, allow \'any\' type\n  -Alongflagname\n    \tdisable bounds checking\n  -C\ta boolean defaulting to true (default true)\n  -D path\n    \tset relative path for local imports\n  -E string\n    \tissue 23543 (default \"0\")\n  -F number\n    \ta non-zero number (default 2.7)\n  -G float\n    \ta float that defaults to zero\n  -M string\n    \ta multiline\n    \thelp\n    \tstring\n  -N int\n    \ta non-zero int (default 27)\n  -O\ta flag\n    \tmultiline help string (default true)\n  -V list\n    \ta list of strings (default [a b])\n  -Z int\n    \tan int that defaults to zero\n  -ZP0 value\n    \ta flag whose String method panics when it is zero\n  -ZP1 value\n    \ta flag whose String method panics when it is zero\n  -maxT timeout\n    \tset timeout for dial\n\npanic calling String method on zero flag_test.zeroPanicker for flag ZP0: panic!\npanic calling String method on zero flag_test.zeroPanicker for flag ZP1: panic!\n" : GoString))) {
		_t.errorf(("got:\n%q\nwant:\n%q" : GoString), Go.toInterface(_got),
			Go.toInterface(("  -A\tfor bootstrapping, allow \'any\' type\n  -Alongflagname\n    \tdisable bounds checking\n  -C\ta boolean defaulting to true (default true)\n  -D path\n    \tset relative path for local imports\n  -E string\n    \tissue 23543 (default \"0\")\n  -F number\n    \ta non-zero number (default 2.7)\n  -G float\n    \ta float that defaults to zero\n  -M string\n    \ta multiline\n    \thelp\n    \tstring\n  -N int\n    \ta non-zero int (default 27)\n  -O\ta flag\n    \tmultiline help string (default true)\n  -V list\n    \ta list of strings (default [a b])\n  -Z int\n    \tan int that defaults to zero\n  -ZP0 value\n    \ta flag whose String method panics when it is zero\n  -ZP1 value\n    \ta flag whose String method panics when it is zero\n  -maxT timeout\n    \tset timeout for dial\n\npanic calling String method on zero flag_test.zeroPanicker for flag ZP0: panic!\npanic calling String method on zero flag_test.zeroPanicker for flag ZP1: panic!\n" : GoString)));
	};
}
	...
	try {
		...
		{};
		{
			...
			if (_got != (("flag provided but not defined: -i\nUsage of app:\n" : GoString))) {
				_t.errorf(("output = %q; want %q" : GoString), Go.toInterface(_got),
					Go.toInterface(("flag provided but not defined: -i\nUsage of app:\n" : GoString)));
			};
		};
		for (defer in __deferstack__) {
			defer();
...
function testParseError(_t:Ref<stdgo.testing.Testing.T>):Void {
	for (_0 => _typ in (new Slice<GoString>(0, 0, ("bool" : GoString), ("int" : GoString), ("int64" : GoString), ("uint" : GoString), ("uint64" : GoString),
		("float64" : GoString), ("duration" : GoString)) : Slice<GoString>)) {
		...
		if (!stdgo.strings.Strings.contains(_err.error(), ("invalid" : GoString))
			|| !stdgo.strings.Strings.contains(_err.error(), ("parse error" : GoString))) {
			_t.errorf(("Parse(%q)=%v; expected parse error" : GoString), Go.toInterface(_args), Go.toInterface(_err));
		};
	};
}
...
function testRangeError(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _bad = (new Slice<GoString>(0, 0, ("-int=123456789012345678901" : GoString), ("-int64=123456789012345678901" : GoString),
		("-uint=123456789012345678901" : GoString), ("-uint64=123456789012345678901" : GoString), ("-float64=1e1000" : GoString)) : Slice<GoString>);
	for (_0 => _arg in _bad) {
		var _fs = newFlagSet(("parse error test" : GoString), (0 : ErrorHandling));
		_fs.setOutput(stdgo.io.Io.discard);
		_fs.int_(("int" : GoString), (0 : GoInt), Go.str());
		...
		if (!stdgo.strings.Strings.contains(_err.error(), ("invalid" : GoString))
			|| !stdgo.strings.Strings.contains(_err.error(), ("value out of range" : GoString))) {
			_t.errorf(("Parse(%q)=%v; expected range error" : GoString), Go.toInterface(_arg), Go.toInterface(_err));
		};
	};
}
...
function testExitCode(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _tests = (new Slice<T__struct_0>(0, 0, ({_flag: ("-h" : GoString), _flagHandle: ("" : GoString), _expectExit: (0 : GoInt)} : T__struct_0),
		({_flag: ("-help" : GoString), _flagHandle: ("" : GoString), _expectExit: (0 : GoInt)} : T__struct_0),
		({_flag: ("-undefined" : GoString), _flagHandle: ("" : GoString), _expectExit: (2 : GoInt)} : T__struct_0),
		({_flag: ("-h" : GoString), _flagHandle: ("h" : GoString), _expectExit: _magic} : T__struct_0),
		({_flag: ("-help" : GoString), _flagHandle: ("help" : GoString), _expectExit: _magic} : T__struct_0)) : Slice<T__struct_0>);
	for (_0 => _test in _tests) {
		...
		if (_got != (_test._expectExit)) {
			_t.errorf(("unexpected exit code for test case %+v \n: got %d, expect %d" : GoString), Go.toInterface(Go.asInterface(_test)),
				Go.toInterface(_got), Go.toInterface(_test._expectExit));
		};
	};
}
			...
			var a = function():Void {
				{
					...
					if (__type__ == null) {
						...
						_t.errorf(("%s\n: expected panic(%q), but got panic(%T%v)" : GoString), Go.toInterface(_testName), Go.toInterface(_expected), _msg,
							_msg);
					};
				};
			};
...
function testInvalidFlags(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _tests = (new Slice<T__struct_1>(0, 0, ({_flag: ("-foo" : GoString), _errorMsg: ("flag \"-foo\" begins with -" : GoString)} : T__struct_1),
		({_flag: ("foo=bar" : GoString), _errorMsg: ("flag \"foo=bar\" contains =" : GoString)} : T__struct_1)) : Slice<T__struct_1>);
	for (_0 => _test in _tests) {
		...
		});
		{
			...
			if (_msg != ((_buf.string() : GoString))) {
				_t.errorf(("%s\n: unexpected output: expected %q, bug got %q" : GoString), Go.toInterface(_testName), Go.toInterface(_msg),
					Go.toInterface(Go.asInterface(_buf)));
			};
		};
	};
}
...
function testRedefinedFlags(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _tests = (new Slice<T__struct_2>(0, 0, ({_flagSetName: Go.str(), _errorMsg: ("flag redefined: foo" : GoString)} : T__struct_2),
		({_flagSetName: ("fs" : GoString), _errorMsg: ("fs flag redefined: foo" : GoString)} : T__struct_2)) : Slice<T__struct_2>);
	for (_0 => _test in _tests) {
		...
		_fs.setOutput(Go.asInterface(_buf));
		var _v:T_flagVar = new stdgo.flag_test.Flag_test.T_flagVar(0, 0);
		_fs.var_(Go.asInterface((_v : Ref<stdgo.flag_test.Flag_test.T_flagVar>)), ("foo" : GoString), Go.str());
		_mustPanic(_t, _testName, _test._errorMsg, function():Void {
			_fs.var_(Go.asInterface((_v : Ref<stdgo.flag_test.Flag_test.T_flagVar>)), ("foo" : GoString), Go.str());
		});
		{
...
@:keep var _ = {
	try {
		...
		stdgo.flag.Flag.var_(Go.asInterface((_intervalFlag : Ref<stdgo.flag_test.Flag_test.T_interval>)), ("deltaT" : GoString),
			("comma-separated list of intervals to use between events" : GoString));
	} catch (__exception__)
...
@:keep @:allow(stdgo.flag_test.Flag_test.T_interval_asInterface) class T_interval_static_extension {
	...
	**/
	...
	static public function set(_i:Ref<T_interval>, _value:GoString):Error {
		...
		for (_0 => _dt in stdgo.strings.Strings.split(_value, ("," : GoString))) {
			...
			_i.__setData__(_i.__appendref__(_duration));
		};
		return (null : Error);
	}
	...
	**/
	...
	static public function string(_i:Ref<T_interval>):GoString {
		return stdgo.fmt.Fmt.sprint(Go.toInterface(Go.asInterface(_i)));
	}
}
...
@:keep @:allow(stdgo.flag_test.Flag_test.T_flagVar_asInterface) class T_flagVar_static_extension {
	...
	static public function set(_f:Ref<T_flagVar>, _value:GoString):Error {
		_f.__setData__(_f.__appendref__(_value));
		return (null : Error);
	}

	@:keep
	static public function string(_f:Ref<T_flagVar>):GoString {
		return stdgo.fmt.Fmt.sprint(Go.toInterface((_f : Slice<GoString>)));
	}
}
