...
@:structInit @:using(stdgo.flag_test.Flag_test.URLValue_static_extension) class URLValue {
    public var url : stdgo.Ref<stdgo.net.url.Url.URL> = (null : stdgo.Ref<stdgo.net.url.Url.URL>);
    public function new(?url:stdgo.Ref<stdgo.net.url.Url.URL>) {
...
function exampleTextVar():Void {
        ...
        _fs.setOutput(stdgo.Go.asInterface(stdgo.os.Os.stdout));
        var _ip:stdgo.net.Net.IP = new stdgo.net.Net.IP(0, 0);
        _fs.textVar(stdgo.Go.asInterface((stdgo.Go.setRef(_ip) : stdgo.Ref<stdgo.net.Net.IP>)), ("ip" : stdgo.GoString), stdgo.Go.asInterface(stdgo.net.Net.ipv4((192 : stdgo.GoUInt8), (168 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (100 : stdgo.GoUInt8))), ("`IP address` to parse" : stdgo.GoString));
        _fs.parse((new stdgo.Slice<stdgo.GoString>(2, 2, ("-ip" : stdgo.GoString), ("127.0.0.1" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>));
...
function exampleValue():Void {
        ...
        _fs.var_(stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.flag_test.Flag_test.URLValue(_u) : stdgo.flag_test.Flag_test.URLValue)) : stdgo.Ref<stdgo.flag_test.Flag_test.URLValue>)), ("url" : stdgo.GoString), ("URL to parse" : stdgo.GoString));
...
function testEverything(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        var _m = ({
            final x = new stdgo.GoMap.GoStringMap<stdgo.Ref<stdgo.flag.Flag.Flag>>();
            x.__defaultValue__ = () -> (null : stdgo.Ref<stdgo.flag.Flag.Flag>);
            @:mergeBlock {};
            x;
        } : stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.flag.Flag.Flag>>);
        var _desired:stdgo.GoString = ("0" : stdgo.GoString);
        var _visitor = function(_f:stdgo.Ref<Flag>):Void {
            if ((_f.name.length > (5 : stdgo.GoInt)) && ((_f.name.__slice__((0 : stdgo.GoInt), (5 : stdgo.GoInt)) : stdgo.GoString) == ("test_" : stdgo.GoString))) {
                _m[_f.name] = _f;
                var _ok:Bool = false;
...
function testGet(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        resetForTesting(null);
...
function testUsage(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function _testParse(_f:stdgo.Ref<FlagSet>, _t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        if (_f.parsed()) {
...
function testFlagSetParse(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        _testParse(newFlagSet(("test" : stdgo.GoString), (0 : stdgo.flag.Flag.ErrorHandling)), _t);
    }
function testUserDefined(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        _flags.var_(stdgo.Go.asInterface((stdgo.Go.setRef(_v) : stdgo.Ref<stdgo.flag_test.Flag_test.T_flagVar>)), ("v" : stdgo.GoString), ("usage" : stdgo.GoString));
        {
...
function testUserDefinedFunc(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        _flags.setOutput(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.strings.Strings.Builder>)));
        _flags.parse((new stdgo.Slice<stdgo.GoString>(1, 1, ("-h" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>));
        {
            ...
            if (!stdgo.strings.Strings.contains(_usage?.__copy__(), ("usage" : stdgo.GoString))) {
        ...
        };
        {
            ...
            if (_err == null) {
                ...
                if (!stdgo.strings.Strings.contains(_errMsg?.__copy__(), ("test error" : stdgo.GoString))) {
                    _t.errorf(("error should contain \"test error\"; got %q" : stdgo.GoString), stdgo.Go.toInterface(_errMsg));
                };
            };
        };
    }
function testUserDefinedForCommandLine(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
...
function testUserDefinedBool(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _flags:FlagSet = ({} : stdgo.flag.Flag.FlagSet);
        _flags.init(("test" : stdgo.GoString), (0 : stdgo.flag.Flag.ErrorHandling));
        _flags.setOutput(stdgo.io.Io.discard);
        var _b:T_boolFlagVar = ({} : stdgo.flag_test.Flag_test.T_boolFlagVar);
        var _err:stdgo.Error = (null : stdgo.Error);
        _flags.var_(stdgo.Go.asInterface((stdgo.Go.setRef(_b) : stdgo.Ref<stdgo.flag_test.Flag_test.T_boolFlagVar>)), ("b" : stdgo.GoString), ("usage" : stdgo.GoString));
        {
...
function testUserDefinedBoolUsage(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _flags:FlagSet = ({} : stdgo.flag.Flag.FlagSet);
        _flags.init(("test" : stdgo.GoString), (0 : stdgo.flag.Flag.ErrorHandling));
        var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        _flags.setOutput(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)));
        var _b:T_boolFlagVar = ({} : stdgo.flag_test.Flag_test.T_boolFlagVar);
        _flags.var_(stdgo.Go.asInterface((stdgo.Go.setRef(_b) : stdgo.Ref<stdgo.flag_test.Flag_test.T_boolFlagVar>)), ("b" : stdgo.GoString), ("X" : stdgo.GoString));
...
function testSetOutput(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _flags:FlagSet = ({} : stdgo.flag.Flag.FlagSet);
        var _buf:stdgo.strings.Strings.Builder = ({} : stdgo.strings.Strings.Builder);
        _flags.setOutput(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.strings.Strings.Builder>)));
        _flags.init(("test" : stdgo.GoString), (0 : stdgo.flag.Flag.ErrorHandling));
        _flags.parse((new stdgo.Slice<stdgo.GoString>(1, 1, ("-unknown" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>));
        {
            ...
            if (!stdgo.strings.Strings.contains(_out?.__copy__(), ("-unknown" : stdgo.GoString))) {
...
**/
function testChangingArgs(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        try {
            ...
            {
                var _err:stdgo.Error = commandLine.parse((stdgo.os.Os.args.__slice__((1 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoString>));
                if (_err != null) {
                    _t.fatal(stdgo.Go.toInterface(_err));
                };
            };
            ...
            parse();
            var _args = args();
            if ((((!_before.value || (_cmd != ("subcmd" : stdgo.GoString))) || !_after.value) || (_args.length != (1 : stdgo.GoInt))) || (_args[(0 : stdgo.GoInt)] != ("args" : stdgo.GoString))) {
...
**/
function testHelp(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testPrintDefaults(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _fs = newFlagSet(("print defaults test" : stdgo.GoString), (0 : stdgo.flag.Flag.ErrorHandling));
        var _buf:stdgo.strings.Strings.Builder = ({} : stdgo.strings.Strings.Builder);
        _fs.setOutput(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.strings.Strings.Builder>)));
        ...
        _fs.var_(stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.Slice<stdgo.GoString>(2, 2, ("a" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo.flag_test.Flag_test.T_flagVar)) : stdgo.Ref<stdgo.flag_test.Flag_test.T_flagVar>)), ("V" : stdgo.GoString), ("a `list` of strings" : stdgo.GoString));
        _fs.int_(("Z" : stdgo.GoString), (0 : stdgo.GoInt), ("an int that defaults to zero" : stdgo.GoString));
        _fs.var_(stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.flag_test.Flag_test.T_zeroPanicker(true, stdgo.Go.str()?.__copy__()) : stdgo.flag_test.Flag_test.T_zeroPanicker)) : stdgo.Ref<stdgo.flag_test.Flag_test.T_zeroPanicker>)), ("ZP0" : stdgo.GoString), ("a flag whose String method panics when it is zero" : stdgo.GoString));
        _fs.var_(stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.flag_test.Flag_test.T_zeroPanicker(true, ("something" : stdgo.GoString)) : stdgo.flag_test.Flag_test.T_zeroPanicker)) : stdgo.Ref<stdgo.flag_test.Flag_test.T_zeroPanicker>)), ("ZP1" : stdgo.GoString), ("a flag whose String method panics when it is zero" : stdgo.GoString));
...
**/
function testIntFlagOverflow(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        if (false) {
            return;
        };
        resetForTesting(null);
...
**/
function testUsageOutput(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            resetForTesting(defaultUsage);
            var _buf:stdgo.strings.Strings.Builder = ({} : stdgo.strings.Strings.Builder);
            commandLine.setOutput(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.strings.Strings.Builder>)));
            {
...
function testGetters(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testParseError(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        for (__0 => _typ in (new stdgo.Slice<stdgo.GoString>(7, 7, ("bool" : stdgo.GoString), ("int" : stdgo.GoString), ("int64" : stdgo.GoString), ("uint" : stdgo.GoString), ("uint64" : stdgo.GoString), ("float64" : stdgo.GoString), ("duration" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) {
            ...
            _fs.duration(("duration" : stdgo.GoString), (0i64 : stdgo.time.Time.Duration), stdgo.Go.str()?.__copy__());
            ...
            if (!stdgo.strings.Strings.contains(_err.error()?.__copy__(), ("invalid" : stdgo.GoString)) || !stdgo.strings.Strings.contains(_err.error()?.__copy__(), ("parse error" : stdgo.GoString))) {
                _t.errorf(("Parse(%q)=%v; expected parse error" : stdgo.GoString), stdgo.Go.toInterface(_args), stdgo.Go.toInterface(_err));
            };
        };
    }
function testRangeError(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        for (__0 => _arg in _bad) {
            ...
            if (!stdgo.strings.Strings.contains(_err.error()?.__copy__(), ("invalid" : stdgo.GoString)) || !stdgo.strings.Strings.contains(_err.error()?.__copy__(), ("value out of range" : stdgo.GoString))) {
                _t.errorf(("Parse(%q)=%v; expected range error" : stdgo.GoString), stdgo.Go.toInterface(_arg), stdgo.Go.toInterface(_err));
            };
        };
    }
function testExitCode(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        if (stdgo.os.Os.getenv(("GO_CHILD_FLAG" : stdgo.GoString)) != (stdgo.Go.str())) {
            ...
            if (stdgo.os.Os.getenv(("GO_CHILD_FLAG_HANDLE" : stdgo.GoString)) != (stdgo.Go.str())) {
                var _b:Bool = false;
                _fs.boolVar(stdgo.Go.pointer(_b), stdgo.os.Os.getenv(("GO_CHILD_FLAG_HANDLE" : stdgo.GoString))?.__copy__(), false, stdgo.Go.str()?.__copy__());
            };
            _fs.parse((new stdgo.Slice<stdgo.GoString>(1, 1, stdgo.os.Os.getenv(("GO_CHILD_FLAG" : stdgo.GoString))?.__copy__()) : stdgo.Slice<stdgo.GoString>));
            Sys.exit(_magic);
        };
        ...
        for (__0 => _test in _tests) {
            var _cmd = stdgo.os.exec.Exec.command(stdgo.os.Os.args[(0 : stdgo.GoInt)]?.__copy__(), ("-test.run=TestExitCode" : stdgo.GoString));
            ...
            if (false && (_test._expectExit != (0 : stdgo.GoInt))) {
...
function _mustPanic(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _testName:stdgo.GoString, _expected:stdgo.GoString, _f:() -> Void):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            _t.helper();
            __deferstack__.unshift(() -> {
...
function testInvalidFlags(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        for (__0 => _test in _tests) {
            ...
            _mustPanic(_t, _testName?.__copy__(), _test._errorMsg?.__copy__(), function():Void {
                var _v:T_flagVar = new stdgo.flag_test.Flag_test.T_flagVar(0, 0);
                _fs.var_(stdgo.Go.asInterface((stdgo.Go.setRef(_v) : stdgo.Ref<stdgo.flag_test.Flag_test.T_flagVar>)), _test._flag?.__copy__(), stdgo.Go.str()?.__copy__());
            });
            {
...
function testRedefinedFlags(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        for (__0 => _test in _tests) {
            ...
            _fs.setOutput(stdgo.Go.asInterface(_buf));
            var _v:T_flagVar = new stdgo.flag_test.Flag_test.T_flagVar(0, 0);
            _fs.var_(stdgo.Go.asInterface((stdgo.Go.setRef(_v) : stdgo.Ref<stdgo.flag_test.Flag_test.T_flagVar>)), ("foo" : stdgo.GoString), stdgo.Go.str()?.__copy__());
            _mustPanic(_t, _testName?.__copy__(), _test._errorMsg?.__copy__(), function():Void {
                _fs.var_(stdgo.Go.asInterface((stdgo.Go.setRef(_v) : stdgo.Ref<stdgo.flag_test.Flag_test.T_flagVar>)), ("foo" : stdgo.GoString), stdgo.Go.str()?.__copy__());
            });
            {
...
function testUserDefinedBoolFunc(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _flags = newFlagSet(("test" : stdgo.GoString), (0 : stdgo.flag.Flag.ErrorHandling));
        _flags.setOutput(stdgo.io.Io.discard);
        var _ss:stdgo.Slice<stdgo.GoString> = (null : stdgo.Slice<stdgo.GoString>);
...
function testDefineAfterSet(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _flags = newFlagSet(("test" : stdgo.GoString), (0 : stdgo.flag.Flag.ErrorHandling));
...
@:keep var _ = {
        try {
            ...
            stdgo.flag.Flag.var_(stdgo.Go.asInterface((stdgo.Go.setRef(_intervalFlag) : stdgo.Ref<stdgo.flag_test.Flag_test.T_interval>)), ("deltaT" : stdgo.GoString), ("comma-separated list of intervals to use between events" : stdgo.GoString));
...
@:keep @:allow(stdgo.flag_test.Flag_test.URLValue_asInterface) class URLValue_static_extension {
    ...
    static public function set( _v:URLValue, _s:stdgo.GoString):stdgo.Error {
        ...
        {
            var __tmp__ = stdgo.net.url.Url.parse(_s?.__copy__()), _u:stdgo.Ref<stdgo.net.url.Url.URL> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return _err;
            } else {
                {
...
@:keep @:allow(stdgo.flag_test.Flag_test.T_boolFlagVar_asInterface) class T_boolFlagVar_static_extension {
    ...
    static public function isBoolFlag( _b:stdgo.Ref<T_boolFlagVar>):Bool {
        ...
        return _b._count < (4 : stdgo.GoInt);
    }
    @:keep
    ...
    static public function string( _b:stdgo.Ref<T_boolFlagVar>):stdgo.GoString {
        @:recv var _b:stdgo.Ref<T_boolFlagVar> = _b;
        return stdgo.fmt.Fmt.sprintf(("%d" : stdgo.GoString), stdgo.Go.toInterface(_b._count))?.__copy__();
    }
}
...
@:keep @:allow(stdgo.flag_test.Flag_test.T_interval_asInterface) class T_interval_static_extension {
    ...
    **/
    ...
    static public function set( _i:stdgo.Ref<T_interval>, _value:stdgo.GoString):stdgo.Error {
        ...
        if (((_i : stdgo.flag_test.Flag_test.T_interval).length) > (0 : stdgo.GoInt)) {
            return stdgo.errors.Errors.new_(("interval flag already set" : stdgo.GoString));
        };
        for (__0 => _dt in stdgo.strings.Strings.split(_value?.__copy__(), ("," : stdgo.GoString))) {
