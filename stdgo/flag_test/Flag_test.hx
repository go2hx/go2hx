        ...
        var _visitor = function(_f:Flag):Void {
            if (((_f.name != null ? _f.name.length : ((0 : GoInt))) > ((5 : GoInt))) && (((_f.name.__slice__(((0 : GoInt)), ((5 : GoInt))) : GoString)) == ((((("test_" : GoString))) : GoString)))) {
                ...
                if (_f.name == ((((("test_bool" : GoString))) : GoString))) {
                    ...
                    _ok = _g.get() == ((((("5" : GoString))) : GoString));
                    ...
                    _ok = _g.get() == ((((7 : stdgo.time.Time.Duration)) : stdgo.time.Time.Duration));
                };
                if (!_ok) {
                    _t.errorf(((((("Visit: bad value %T(%v) for %s" : GoString))) : GoString)), Go.toInterface(_g.get()), Go.toInterface(_g.get()), Go.toInterface(_f.name));
                };
            };
        };
        visitAll(_visitor);
...
function testUserDefinedFunc(_t:stdgo.testing.Testing.T):Void {
        ...
        _flags = (newFlagSet(((((("test" : GoString))) : GoString)), ((0 : ErrorHandling))) == null ? null : newFlagSet(((((("test" : GoString))) : GoString)), ((0 : ErrorHandling))).__copy__());
        _flags.func(((((("v" : GoString))) : GoString)), ((((("usage" : GoString))) : GoString)), function(_s:GoString):Error {
...
function testGetters(_t:stdgo.testing.Testing.T):Void {
        ...
        var _expectedOutput:stdgo.io.Io.Writer = {
            ...
            __self__.setDeadline = #if !macro function(_t_:stdgo.time.Time.Time):stdgo.Error return stdgo.os.Os.stderr.setDeadline(_t_) #else null #end;
            __self__.setReadDeadline = #if !macro function(_t__:stdgo.time.Time.Time):stdgo.Error return stdgo.os.Os.stderr.setReadDeadline(_t__) #else null #end;
            __self__.setWriteDeadline = #if !macro function(_t___:stdgo.time.Time.Time):stdgo.Error return stdgo.os.Os.stderr.setWriteDeadline(_t___) #else null #end;
            ...
            __self__._setDeadline = #if !macro function(_t____:stdgo.time.Time.Time):stdgo.Error return stdgo.os.Os.stderr._setDeadline(_t____) #else null #end;
            __self__._setReadDeadline = #if !macro function(_t_____:stdgo.time.Time.Time):stdgo.Error return stdgo.os.Os.stderr._setReadDeadline(_t_____) #else null #end;
            __self__._setWriteDeadline = #if !macro function(_t______:stdgo.time.Time.Time):stdgo.Error return stdgo.os.Os.stderr._setWriteDeadline(_t______) #else null #end;
        ...
        _expectedOutput = {
            ...
            __self__.readdirnames = #if !macro function(_n:GoInt):{ var _0 : Slice<GoString>; var _1 : stdgo.Error; } return stdgo.os.Os.stdout.readdirnames(_n) #else null #end;
            __self__.seek = #if !macro function(_offset:GoInt64, _whence:GoInt):{ var _0 : GoInt64; var _1 : stdgo.Error; } return stdgo.os.Os.stdout.seek(_offset, _whence) #else null #end;
            __self__.setDeadline = #if !macro function(_t_:stdgo.time.Time.Time):stdgo.Error return stdgo.os.Os.stdout.setDeadline(_t_) #else null #end;
            __self__.setReadDeadline = #if !macro function(_t__:stdgo.time.Time.Time):stdgo.Error return stdgo.os.Os.stdout.setReadDeadline(_t__) #else null #end;
            __self__.setWriteDeadline = #if !macro function(_t___:stdgo.time.Time.Time):stdgo.Error return stdgo.os.Os.stdout.setWriteDeadline(_t___) #else null #end;
            __self__.stat = #if !macro function():{ var _0 : stdgo.io.fs.Fs.FileInfo; var _1 : stdgo.Error; } return stdgo.os.Os.stdout.stat() #else null #end;
            __self__.sync = #if !macro function():stdgo.Error return stdgo.os.Os.stdout.sync() #else null #end;
            __self__.syscallConn = #if !macro function():{ var _0 : stdgo.syscall.Syscall.RawConn; var _1 : stdgo.Error; } return stdgo.os.Os.stdout.syscallConn() #else null #end;
            __self__.truncate = #if !macro function(_size:GoInt64):stdgo.Error return stdgo.os.Os.stdout.truncate(_size) #else null #end;
            ...
            __self__._readdir = #if !macro function(_n:GoInt, _mode:stdgo.os.Os.T_readdirMode):{ var _0 : Slice<GoString>; var _1 : Slice<stdgo.io.fs.Fs.DirEntry>; var _2 : Slice<stdgo.io.fs.Fs.FileInfo>; var _3 : stdgo.Error; } return stdgo.os.Os.stdout._readdir(_n, _mode) #else null #end;
            __self__._seek = #if !macro function(_offset:GoInt64, _whence:GoInt):{ var _0 : GoInt64; var _1 : stdgo.Error; } return stdgo.os.Os.stdout._seek(_offset, _whence) #else null #end;
            __self__._setDeadline = #if !macro function(_t____:stdgo.time.Time.Time):stdgo.Error return stdgo.os.Os.stdout._setDeadline(_t____) #else null #end;
            __self__._setReadDeadline = #if !macro function(_t_____:stdgo.time.Time.Time):stdgo.Error return stdgo.os.Os.stdout._setReadDeadline(_t_____) #else null #end;
            __self__._setWriteDeadline = #if !macro function(_t______:stdgo.time.Time.Time):stdgo.Error return stdgo.os.Os.stdout._setWriteDeadline(_t______) #else null #end;
            __self__._wrapErr = #if !macro function(_op:GoString, _err:stdgo.Error):stdgo.Error return stdgo.os.Os.stdout._wrapErr(_op, _err) #else null #end;
            __self__._write = #if !macro function(_b:Slice<GoUInt8>):{ var _0 : GoInt; var _1 : stdgo.Error; } return stdgo.os.Os.stdout._write(_b) #else null #end;
            __self__;
        };
