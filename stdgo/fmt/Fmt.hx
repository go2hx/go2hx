...
/**
    /|*{
    	end_4048573 = len(format)
    	argNum_4048593 = 0
    	afterIndex_4048664 = false
    	p.reordered = false
    	gotoNext = 4048755
    	_ = gotoNext == 4048755
    	i_4048772 = 0
    	...
    	gotoNext = 4048768
    	_ = gotoNext == 4048768
    	if !formatLoopBreak && (i_4048772 < end_4048573) {
    		gotoNext = 4048789
    		_ = gotoNext == 4048789
    		p.goodArgNum = true
    		lasti_4048815 = i_4048772
    		_ = 0
    		gotoNext = 4048828
    		_ = gotoNext == 4048828
    		if i_4048772 < end_4048573 && format[i_4048772] != 37 {
    			gotoNext = 4048860
    			_ = gotoNext == 4048860
    			i_4048772++
    			gotoNext = 4048828
    		...
    		_ = gotoNext == 4048875
    		if i_4048772 > lasti_4048815 {
    			gotoNext = 4048888
    			_ = gotoNext == 4048888
    			p.buf.writeString(format[lasti_4048815:i_4048772])
    			gotoNext = 4048934
    		} else {
    			gotoNext = 4048934
    		}
    		_ = gotoNext == 4048934
    		if i_4048772 >= end_4048573 {
    			gotoNext = 4048946
    			_ = gotoNext == 4048946
    			gotoNext = 4052599
    			gotoNext = 4049022
    		...
    		gotoNext = 4049088
    		_ = gotoNext == 4049088
    		if !simpleFormatBreak && (i_4048772 < end_4048573) {
    			gotoNext = 4049107
    			_ = gotoNext == 4049107
    			c_4049112 = format[i_4048772]
    			gotoNext = 4049130
    			_ = gotoNext == 4049130
    			switch c_4049112 {
    			case 35:
    			...
    			default:
    				gotoNext = 4049432
    				_ = gotoNext == 4049432
    				if 97 <= c_4049112 && c_4049112 <= 122 && argNum_4048593 < len(a) {
    					gotoNext = 4049609
    					_ = gotoNext == 4049609
    					gotoNext = 4049616
    					_ = gotoNext == 4049616
    					...
    					case 119:
    						gotoNext = 4049632
    						_ = gotoNext == 4049632
    						p.wrappedErrs = append(p.wrappedErrs, argNum_4048593)
    						gotoNext = 4049717
    						gotoNext = 4049902
    					case 118:
    						gotoNext = 4049717
    					...
    					_ = gotoNext == 4049902
    					p.printArg(a[argNum_4048593], rune(c_4049112))
    					argNum_4048593++
    					i_4048772++
    					gotoNext = 4048768
    					gotoNext = 4050067
    		...
    		_ = gotoNext == 4050142
    		argNum_4048593, i_4048772, afterIndex_4048664 = p.argNumber(argNum_4048593, format, i_4048772, len(a))
    		if i_4048772 < end_4048573 && format[i_4048772] == 42 {
    			gotoNext = 4050262
    			_ = gotoNext == 4050262
    			i_4048772++
    			p.fmt.wid, p.fmt.widPresent, argNum_4048593 = intFromArg(a, argNum_4048593)
    			if !p.fmt.widPresent {
    				gotoNext = 4050359
    				_ = gotoNext == 4050359
    			...
    			gotoNext = 4050669
    			_ = gotoNext == 4050669
    			p.fmt.wid, p.fmt.widPresent, i_4048772 = parsenum(format, i_4048772, end_4048573)
    			if afterIndex_4048664 && p.fmt.widPresent {
    				gotoNext = 4050769
    				_ = gotoNext == 4050769
    				p.goodArgNum = false
    				gotoNext = 4050847
    		...
    		_ = gotoNext == 4050847
    		if i_4048772+1 < end_4048573 && format[i_4048772] == 46 {
    			gotoNext = 4050880
    			_ = gotoNext == 4050880
    			i_4048772++
    			if afterIndex_4048664 {
    				gotoNext = 4050906
    				_ = gotoNext == 4050906
    				p.goodArgNum = false
    				gotoNext = 4050954
    			...
    			if i_4048772 < end_4048573 && format[i_4048772] == 42 {
    				...
    				_ = gotoNext == 4051051
    				i_4048772++
    				p.fmt.prec, p.fmt.precPresent, argNum_4048593 = intFromArg(a, argNum_4048593)
    				if p.fmt.prec < 0 {
    					gotoNext = 4051202
    					_ = gotoNext == 4051202
    					p.fmt.prec = 0
    				...
    				gotoNext = 4051366
    				_ = gotoNext == 4051366
    				p.fmt.prec, p.fmt.precPresent, i_4048772 = parsenum(format, i_4048772, end_4048573)
    				if !p.fmt.precPresent {
    					gotoNext = 4051458
    					_ = gotoNext == 4051458
    					p.fmt.prec = 0
    		...
    		_ = gotoNext == 4051683
    		verb_4051683, size_4051689 = rune(format[i_4048772]), 1
    		if verb_4051683 >= 128 {
    			gotoNext = 4051743
    			_ = gotoNext == 4051743
    			verb_4051683, size_4051689 = utf8.DecodeRuneInString(format[i_4048772:])
    			gotoNext = 4051803
    		} else {
    			gotoNext = 4051803
    		}
    		_ = gotoNext == 4051803
    		i_4048772 += size_4051689
    		gotoNext = 4051816
    		_ = gotoNext == 4051816
    		switch {
    		case verb_4051683 == 37:
    			gotoNext = 4051827
    			_ = gotoNext == 4051827
    			p.buf.writeByte(37)
    			gotoNext = 4048768
    		case !p.goodArgNum:
    			gotoNext = 4051937
    			_ = gotoNext == 4051937
    			p.badArgNum(verb_4051683)
    			gotoNext = 4048768
    		case argNum_4048593 >= len(a):
    			gotoNext = 4051980
    			_ = gotoNext == 4051980
    			p.missingArg(verb_4051683)
    			gotoNext = 4048768
    		case verb_4051683 == 119:
    			gotoNext = 4052083
    			_ = gotoNext == 4052083
    			p.wrappedErrs = append(p.wrappedErrs, argNum_4048593)
    			gotoNext = 4052167
    			gotoNext = 4048768
    		case verb_4051683 == 118:
    			gotoNext = 4052167
    			_ = gotoNext == 4052167
    			p.fmt.sharpV = p.fmt.sharp
    			p.fmt.sharp = false
    		...
    		default:
    			gotoNext = 4052347
    			_ = gotoNext == 4052347
    			p.printArg(a[argNum_4048593], verb_4051683)
    			argNum_4048593++
    			gotoNext = 4048768
    		}
    		gotoNext = 4048768
    	...
    	_ = gotoNext == 4052599
    	if !p.reordered && argNum_4048593 < len(a) {
    		gotoNext = 4052634
    		_ = gotoNext == 4052634
    		p.fmt.clearflags()
    		p.buf.writeString("%!(EXTRA ")
    		if 0 < len(a[argNum_4048593:]) {
    			gotoNext = 4052961
    			_ = gotoNext == 4052961
    			i_4052696, arg_4052699 = 0, a[argNum_4048593:][0]
    			gotoNext = 4052962
    			_ = gotoNext == 4052962
    			if i_4052696 < len(a[argNum_4048593:]) {
    				gotoNext = 4052723
    				_ = gotoNext == 4052723
    				arg_4052699 = a[argNum_4048593:][i_4052696]
    				if i_4052696 > 0 {
    					gotoNext = 4052737
    					_ = gotoNext == 4052737
    					p.buf.writeString(", ")
    				...
    				if arg_4052699 == nil {
    					...
    					gotoNext = 4052851
    					_ = gotoNext == 4052851
    					p.buf.writeString(reflect.TypeOf(arg_4052699).String())
    					p.buf.writeByte(61)
    					p.printArg(arg_4052699, 118)
    					_ = 0
    					gotoNext = 4052696
    				}
    				_ = gotoNext == 4052696
