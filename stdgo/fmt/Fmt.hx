...
/**
    /|*{
    	end_4053875 = len(format)
    	argNum_4053895 = 0
    	afterIndex_4053966 = false
    	p.reordered = false
    	gotoNext = 4054057
    	_ = gotoNext == 4054057
    	i_4054074 = 0
    	...
    	gotoNext = 4054070
    	_ = gotoNext == 4054070
    	if !formatLoopBreak && (i_4054074 < end_4053875) {
    		gotoNext = 4054091
    		_ = gotoNext == 4054091
    		p.goodArgNum = true
    		lasti_4054117 = i_4054074
    		_ = 0
    		gotoNext = 4054130
    		_ = gotoNext == 4054130
    		if i_4054074 < end_4053875 && format[i_4054074] != 37 {
    			gotoNext = 4054162
    			_ = gotoNext == 4054162
    			i_4054074++
    			gotoNext = 4054130
    		...
    		_ = gotoNext == 4054177
    		if i_4054074 > lasti_4054117 {
    			gotoNext = 4054190
    			_ = gotoNext == 4054190
    			p.buf.writeString(format[lasti_4054117:i_4054074])
    			gotoNext = 4054236
    		} else {
    			gotoNext = 4054236
    		}
    		_ = gotoNext == 4054236
    		if i_4054074 >= end_4053875 {
    			gotoNext = 4054248
    			_ = gotoNext == 4054248
    			gotoNext = 4057901
    			gotoNext = 4054324
    		...
    		gotoNext = 4054390
    		_ = gotoNext == 4054390
    		if !simpleFormatBreak && (i_4054074 < end_4053875) {
    			gotoNext = 4054409
    			_ = gotoNext == 4054409
    			c_4054414 = format[i_4054074]
    			gotoNext = 4054432
    			_ = gotoNext == 4054432
    			switch c_4054414 {
    			case 35:
    			...
    			default:
    				gotoNext = 4054734
    				_ = gotoNext == 4054734
    				if 97 <= c_4054414 && c_4054414 <= 122 && argNum_4053895 < len(a) {
    					gotoNext = 4054911
    					_ = gotoNext == 4054911
    					gotoNext = 4054918
    					_ = gotoNext == 4054918
    					...
    					case 119:
    						gotoNext = 4054934
    						_ = gotoNext == 4054934
    						p.wrappedErrs = append(p.wrappedErrs, argNum_4053895)
    						gotoNext = 4055019
    						gotoNext = 4055204
    					case 118:
    						gotoNext = 4055019
    					...
    					_ = gotoNext == 4055204
    					p.printArg(a[argNum_4053895], rune(c_4054414))
    					argNum_4053895++
    					i_4054074++
    					gotoNext = 4054070
    					gotoNext = 4055369
    		...
    		_ = gotoNext == 4055444
    		argNum_4053895, i_4054074, afterIndex_4053966 = p.argNumber(argNum_4053895, format, i_4054074, len(a))
    		if i_4054074 < end_4053875 && format[i_4054074] == 42 {
    			gotoNext = 4055564
    			_ = gotoNext == 4055564
    			i_4054074++
    			p.fmt.wid, p.fmt.widPresent, argNum_4053895 = intFromArg(a, argNum_4053895)
    			if !p.fmt.widPresent {
    				gotoNext = 4055661
    				_ = gotoNext == 4055661
    			...
    			gotoNext = 4055971
    			_ = gotoNext == 4055971
    			p.fmt.wid, p.fmt.widPresent, i_4054074 = parsenum(format, i_4054074, end_4053875)
    			if afterIndex_4053966 && p.fmt.widPresent {
    				gotoNext = 4056071
    				_ = gotoNext == 4056071
    				p.goodArgNum = false
    				gotoNext = 4056149
    		...
    		_ = gotoNext == 4056149
    		if i_4054074+1 < end_4053875 && format[i_4054074] == 46 {
    			gotoNext = 4056182
    			_ = gotoNext == 4056182
    			i_4054074++
    			if afterIndex_4053966 {
    				gotoNext = 4056208
    				_ = gotoNext == 4056208
    				p.goodArgNum = false
    				gotoNext = 4056256
    			...
    			if i_4054074 < end_4053875 && format[i_4054074] == 42 {
    				...
    				_ = gotoNext == 4056353
    				i_4054074++
    				p.fmt.prec, p.fmt.precPresent, argNum_4053895 = intFromArg(a, argNum_4053895)
    				if p.fmt.prec < 0 {
    					gotoNext = 4056504
    					_ = gotoNext == 4056504
    					p.fmt.prec = 0
    				...
    				gotoNext = 4056668
    				_ = gotoNext == 4056668
    				p.fmt.prec, p.fmt.precPresent, i_4054074 = parsenum(format, i_4054074, end_4053875)
    				if !p.fmt.precPresent {
    					gotoNext = 4056760
    					_ = gotoNext == 4056760
    					p.fmt.prec = 0
    		...
    		_ = gotoNext == 4056985
    		verb_4056985, size_4056991 = rune(format[i_4054074]), 1
    		if verb_4056985 >= 128 {
    			gotoNext = 4057045
    			_ = gotoNext == 4057045
    			verb_4056985, size_4056991 = utf8.DecodeRuneInString(format[i_4054074:])
    			gotoNext = 4057105
    		} else {
    			gotoNext = 4057105
    		}
    		_ = gotoNext == 4057105
    		i_4054074 += size_4056991
    		gotoNext = 4057118
    		_ = gotoNext == 4057118
    		switch {
    		case verb_4056985 == 37:
    			gotoNext = 4057129
    			_ = gotoNext == 4057129
    			p.buf.writeByte(37)
    			gotoNext = 4054070
    		case !p.goodArgNum:
    			gotoNext = 4057239
    			_ = gotoNext == 4057239
    			p.badArgNum(verb_4056985)
    			gotoNext = 4054070
    		case argNum_4053895 >= len(a):
    			gotoNext = 4057282
    			_ = gotoNext == 4057282
    			p.missingArg(verb_4056985)
    			gotoNext = 4054070
    		case verb_4056985 == 119:
    			gotoNext = 4057385
    			_ = gotoNext == 4057385
    			p.wrappedErrs = append(p.wrappedErrs, argNum_4053895)
    			gotoNext = 4057469
    			gotoNext = 4054070
    		case verb_4056985 == 118:
    			gotoNext = 4057469
    			_ = gotoNext == 4057469
    			p.fmt.sharpV = p.fmt.sharp
    			p.fmt.sharp = false
    		...
    		default:
    			gotoNext = 4057649
    			_ = gotoNext == 4057649
    			p.printArg(a[argNum_4053895], verb_4056985)
    			argNum_4053895++
    			gotoNext = 4054070
    		}
    		gotoNext = 4054070
    	...
    	_ = gotoNext == 4057901
    	if !p.reordered && argNum_4053895 < len(a) {
    		gotoNext = 4057936
    		_ = gotoNext == 4057936
    		p.fmt.clearflags()
    		p.buf.writeString("%!(EXTRA ")
    		if 0 < len(a[argNum_4053895:]) {
    			gotoNext = 4058263
    			_ = gotoNext == 4058263
    			i_4057998, arg_4058001 = 0, a[argNum_4053895:][0]
    			gotoNext = 4058264
    			_ = gotoNext == 4058264
    			if i_4057998 < len(a[argNum_4053895:]) {
    				gotoNext = 4058025
    				_ = gotoNext == 4058025
    				arg_4058001 = a[argNum_4053895:][i_4057998]
    				if i_4057998 > 0 {
    					gotoNext = 4058039
    					_ = gotoNext == 4058039
    					p.buf.writeString(", ")
    				...
    				if arg_4058001 == nil {
    					...
    					gotoNext = 4058153
    					_ = gotoNext == 4058153
    					p.buf.writeString(reflect.TypeOf(arg_4058001).String())
    					p.buf.writeByte(61)
    					p.printArg(arg_4058001, 118)
    					_ = 0
    					gotoNext = 4057998
    				}
    				_ = gotoNext == 4057998
