...
/**
    /|*{
    	end_4075784 = len(format)
    	argNum_4075804 = 0
    	afterIndex_4075875 = false
    	p.reordered = false
    	gotoNext = 4075966
    	_ = gotoNext == 4075966
    	i_4075983 = 0
    	...
    	gotoNext = 4075979
    	_ = gotoNext == 4075979
    	if !formatLoopBreak && (i_4075983 < end_4075784) {
    		gotoNext = 4076000
    		_ = gotoNext == 4076000
    		p.goodArgNum = true
    		lasti_4076026 = i_4075983
    		_ = 0
    		gotoNext = 4076039
    		_ = gotoNext == 4076039
    		if i_4075983 < end_4075784 && format[i_4075983] != 37 {
    			gotoNext = 4076071
    			_ = gotoNext == 4076071
    			i_4075983++
    			gotoNext = 4076039
    		...
    		_ = gotoNext == 4076086
    		if i_4075983 > lasti_4076026 {
    			gotoNext = 4076099
    			_ = gotoNext == 4076099
    			p.buf.writeString(format[lasti_4076026:i_4075983])
    			gotoNext = 4076145
    		} else {
    			gotoNext = 4076145
    		}
    		_ = gotoNext == 4076145
    		if i_4075983 >= end_4075784 {
    			gotoNext = 4076157
    			_ = gotoNext == 4076157
    			gotoNext = 4079810
    			gotoNext = 4076233
    		...
    		gotoNext = 4076299
    		_ = gotoNext == 4076299
    		if !simpleFormatBreak && (i_4075983 < end_4075784) {
    			gotoNext = 4076318
    			_ = gotoNext == 4076318
    			c_4076323 = format[i_4075983]
    			gotoNext = 4076341
    			_ = gotoNext == 4076341
    			switch c_4076323 {
    			case 35:
    			...
    			default:
    				gotoNext = 4076643
    				_ = gotoNext == 4076643
    				if 97 <= c_4076323 && c_4076323 <= 122 && argNum_4075804 < len(a) {
    					gotoNext = 4076820
    					_ = gotoNext == 4076820
    					gotoNext = 4076827
    					_ = gotoNext == 4076827
    					...
    					case 119:
    						gotoNext = 4076843
    						_ = gotoNext == 4076843
    						p.wrappedErrs = append(p.wrappedErrs, argNum_4075804)
    						gotoNext = 4076928
    						gotoNext = 4077113
    					case 118:
    						gotoNext = 4076928
    					...
    					_ = gotoNext == 4077113
    					p.printArg(a[argNum_4075804], rune(c_4076323))
    					argNum_4075804++
    					i_4075983++
    					gotoNext = 4075979
    					gotoNext = 4077278
    		...
    		_ = gotoNext == 4077353
    		argNum_4075804, i_4075983, afterIndex_4075875 = p.argNumber(argNum_4075804, format, i_4075983, len(a))
    		if i_4075983 < end_4075784 && format[i_4075983] == 42 {
    			gotoNext = 4077473
    			_ = gotoNext == 4077473
    			i_4075983++
    			p.fmt.wid, p.fmt.widPresent, argNum_4075804 = intFromArg(a, argNum_4075804)
    			if !p.fmt.widPresent {
    				gotoNext = 4077570
    				_ = gotoNext == 4077570
    			...
    			gotoNext = 4077880
    			_ = gotoNext == 4077880
    			p.fmt.wid, p.fmt.widPresent, i_4075983 = parsenum(format, i_4075983, end_4075784)
    			if afterIndex_4075875 && p.fmt.widPresent {
    				gotoNext = 4077980
    				_ = gotoNext == 4077980
    				p.goodArgNum = false
    				gotoNext = 4078058
    		...
    		_ = gotoNext == 4078058
    		if i_4075983+1 < end_4075784 && format[i_4075983] == 46 {
    			gotoNext = 4078091
    			_ = gotoNext == 4078091
    			i_4075983++
    			if afterIndex_4075875 {
    				gotoNext = 4078117
    				_ = gotoNext == 4078117
    				p.goodArgNum = false
    				gotoNext = 4078165
    			...
    			if i_4075983 < end_4075784 && format[i_4075983] == 42 {
    				...
    				_ = gotoNext == 4078262
    				i_4075983++
    				p.fmt.prec, p.fmt.precPresent, argNum_4075804 = intFromArg(a, argNum_4075804)
    				if p.fmt.prec < 0 {
    					gotoNext = 4078413
    					_ = gotoNext == 4078413
    					p.fmt.prec = 0
    				...
    				gotoNext = 4078577
    				_ = gotoNext == 4078577
    				p.fmt.prec, p.fmt.precPresent, i_4075983 = parsenum(format, i_4075983, end_4075784)
    				if !p.fmt.precPresent {
    					gotoNext = 4078669
    					_ = gotoNext == 4078669
    					p.fmt.prec = 0
    		...
    		_ = gotoNext == 4078894
    		verb_4078894, size_4078900 = rune(format[i_4075983]), 1
    		if verb_4078894 >= 128 {
    			gotoNext = 4078954
    			_ = gotoNext == 4078954
    			verb_4078894, size_4078900 = utf8.DecodeRuneInString(format[i_4075983:])
    			gotoNext = 4079014
    		} else {
    			gotoNext = 4079014
    		}
    		_ = gotoNext == 4079014
    		i_4075983 += size_4078900
    		gotoNext = 4079027
    		_ = gotoNext == 4079027
    		switch {
    		case verb_4078894 == 37:
    			gotoNext = 4079038
    			_ = gotoNext == 4079038
    			p.buf.writeByte(37)
    			gotoNext = 4075979
    		case !p.goodArgNum:
    			gotoNext = 4079148
    			_ = gotoNext == 4079148
    			p.badArgNum(verb_4078894)
    			gotoNext = 4075979
    		case argNum_4075804 >= len(a):
    			gotoNext = 4079191
    			_ = gotoNext == 4079191
    			p.missingArg(verb_4078894)
    			gotoNext = 4075979
    		case verb_4078894 == 119:
    			gotoNext = 4079294
    			_ = gotoNext == 4079294
    			p.wrappedErrs = append(p.wrappedErrs, argNum_4075804)
    			gotoNext = 4079378
    			gotoNext = 4075979
    		case verb_4078894 == 118:
    			gotoNext = 4079378
    			_ = gotoNext == 4079378
    			p.fmt.sharpV = p.fmt.sharp
    			p.fmt.sharp = false
    		...
    		default:
    			gotoNext = 4079558
    			_ = gotoNext == 4079558
    			p.printArg(a[argNum_4075804], verb_4078894)
    			argNum_4075804++
    			gotoNext = 4075979
    		}
    		gotoNext = 4075979
    	...
    	_ = gotoNext == 4079810
    	if !p.reordered && argNum_4075804 < len(a) {
    		gotoNext = 4079845
    		_ = gotoNext == 4079845
    		p.fmt.clearflags()
    		p.buf.writeString("%!(EXTRA ")
    		if 0 < len(a[argNum_4075804:]) {
    			gotoNext = 4080172
    			_ = gotoNext == 4080172
    			i_4079907, arg_4079910 = 0, a[argNum_4075804:][0]
    			gotoNext = 4080173
    			_ = gotoNext == 4080173
    			if i_4079907 < len(a[argNum_4075804:]) {
    				gotoNext = 4079934
    				_ = gotoNext == 4079934
    				arg_4079910 = a[argNum_4075804:][i_4079907]
    				if i_4079907 > 0 {
    					gotoNext = 4079948
    					_ = gotoNext == 4079948
    					p.buf.writeString(", ")
    				...
    				if arg_4079910 == nil {
    					...
    					gotoNext = 4080062
    					_ = gotoNext == 4080062
    					p.buf.writeString(reflect.TypeOf(arg_4079910).String())
    					p.buf.writeByte(61)
    					p.printArg(arg_4079910, 118)
    					_ = 0
    					gotoNext = 4079907
    				}
    				_ = gotoNext == 4079907
