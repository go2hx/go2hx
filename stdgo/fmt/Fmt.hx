...
/**
    /|*{
    	end_4117391 = len(format)
    	argNum_4117411 = 0
    	afterIndex_4117482 = false
    	p.reordered = false
    	gotoNext = 4117573
    	_ = gotoNext == 4117573
    	i_4117590 = 0
    	...
    	gotoNext = 4117586
    	_ = gotoNext == 4117586
    	if !formatLoopBreak && (i_4117590 < end_4117391) {
    		gotoNext = 4117607
    		_ = gotoNext == 4117607
    		p.goodArgNum = true
    		lasti_4117633 = i_4117590
    		_ = 0
    		gotoNext = 4117646
    		_ = gotoNext == 4117646
    		if i_4117590 < end_4117391 && format[i_4117590] != 37 {
    			gotoNext = 4117678
    			_ = gotoNext == 4117678
    			i_4117590++
    			gotoNext = 4117646
    		...
    		_ = gotoNext == 4117693
    		if i_4117590 > lasti_4117633 {
    			gotoNext = 4117706
    			_ = gotoNext == 4117706
    			p.buf.writeString(format[lasti_4117633:i_4117590])
    			gotoNext = 4117752
    		} else {
    			gotoNext = 4117752
    		}
    		_ = gotoNext == 4117752
    		if i_4117590 >= end_4117391 {
    			gotoNext = 4117764
    			_ = gotoNext == 4117764
    			gotoNext = 4121417
    			gotoNext = 4117840
    		...
    		gotoNext = 4117906
    		_ = gotoNext == 4117906
    		if !simpleFormatBreak && (i_4117590 < end_4117391) {
    			gotoNext = 4117925
    			_ = gotoNext == 4117925
    			c_4117930 = format[i_4117590]
    			gotoNext = 4117948
    			_ = gotoNext == 4117948
    			switch c_4117930 {
    			case 35:
    			...
    			default:
    				gotoNext = 4118250
    				_ = gotoNext == 4118250
    				if 97 <= c_4117930 && c_4117930 <= 122 && argNum_4117411 < len(a) {
    					gotoNext = 4118427
    					_ = gotoNext == 4118427
    					gotoNext = 4118434
    					_ = gotoNext == 4118434
    					...
    					case 119:
    						gotoNext = 4118450
    						_ = gotoNext == 4118450
    						p.wrappedErrs = append(p.wrappedErrs, argNum_4117411)
    						gotoNext = 4118535
    						gotoNext = 4118720
    					case 118:
    						gotoNext = 4118535
    					...
    					_ = gotoNext == 4118720
    					p.printArg(a[argNum_4117411], rune(c_4117930))
    					argNum_4117411++
    					i_4117590++
    					gotoNext = 4117586
    					gotoNext = 4118885
    		...
    		_ = gotoNext == 4118960
    		argNum_4117411, i_4117590, afterIndex_4117482 = p.argNumber(argNum_4117411, format, i_4117590, len(a))
    		if i_4117590 < end_4117391 && format[i_4117590] == 42 {
    			gotoNext = 4119080
    			_ = gotoNext == 4119080
    			i_4117590++
    			p.fmt.wid, p.fmt.widPresent, argNum_4117411 = intFromArg(a, argNum_4117411)
    			if !p.fmt.widPresent {
    				gotoNext = 4119177
    				_ = gotoNext == 4119177
    			...
    			gotoNext = 4119487
    			_ = gotoNext == 4119487
    			p.fmt.wid, p.fmt.widPresent, i_4117590 = parsenum(format, i_4117590, end_4117391)
    			if afterIndex_4117482 && p.fmt.widPresent {
    				gotoNext = 4119587
    				_ = gotoNext == 4119587
    				p.goodArgNum = false
    				gotoNext = 4119665
    		...
    		_ = gotoNext == 4119665
    		if i_4117590+1 < end_4117391 && format[i_4117590] == 46 {
    			gotoNext = 4119698
    			_ = gotoNext == 4119698
    			i_4117590++
    			if afterIndex_4117482 {
    				gotoNext = 4119724
    				_ = gotoNext == 4119724
    				p.goodArgNum = false
    				gotoNext = 4119772
    			...
    			if i_4117590 < end_4117391 && format[i_4117590] == 42 {
    				...
    				_ = gotoNext == 4119869
    				i_4117590++
    				p.fmt.prec, p.fmt.precPresent, argNum_4117411 = intFromArg(a, argNum_4117411)
    				if p.fmt.prec < 0 {
    					gotoNext = 4120020
    					_ = gotoNext == 4120020
    					p.fmt.prec = 0
    				...
    				gotoNext = 4120184
    				_ = gotoNext == 4120184
    				p.fmt.prec, p.fmt.precPresent, i_4117590 = parsenum(format, i_4117590, end_4117391)
    				if !p.fmt.precPresent {
    					gotoNext = 4120276
    					_ = gotoNext == 4120276
    					p.fmt.prec = 0
    		...
    		_ = gotoNext == 4120501
    		verb_4120501, size_4120507 = rune(format[i_4117590]), 1
    		if verb_4120501 >= 128 {
    			gotoNext = 4120561
    			_ = gotoNext == 4120561
    			verb_4120501, size_4120507 = utf8.DecodeRuneInString(format[i_4117590:])
    			gotoNext = 4120621
    		} else {
    			gotoNext = 4120621
    		}
    		_ = gotoNext == 4120621
    		i_4117590 += size_4120507
    		gotoNext = 4120634
    		_ = gotoNext == 4120634
    		switch {
    		case verb_4120501 == 37:
    			gotoNext = 4120645
    			_ = gotoNext == 4120645
    			p.buf.writeByte(37)
    			gotoNext = 4117586
    		case !p.goodArgNum:
    			gotoNext = 4120755
    			_ = gotoNext == 4120755
    			p.badArgNum(verb_4120501)
    			gotoNext = 4117586
    		case argNum_4117411 >= len(a):
    			gotoNext = 4120798
    			_ = gotoNext == 4120798
    			p.missingArg(verb_4120501)
    			gotoNext = 4117586
    		case verb_4120501 == 119:
    			gotoNext = 4120901
    			_ = gotoNext == 4120901
    			p.wrappedErrs = append(p.wrappedErrs, argNum_4117411)
    			gotoNext = 4120985
    			gotoNext = 4117586
    		case verb_4120501 == 118:
    			gotoNext = 4120985
    			_ = gotoNext == 4120985
    			p.fmt.sharpV = p.fmt.sharp
    			p.fmt.sharp = false
    		...
    		default:
    			gotoNext = 4121165
    			_ = gotoNext == 4121165
    			p.printArg(a[argNum_4117411], verb_4120501)
    			argNum_4117411++
    			gotoNext = 4117586
    		}
    		gotoNext = 4117586
    	...
    	_ = gotoNext == 4121417
    	if !p.reordered && argNum_4117411 < len(a) {
    		gotoNext = 4121452
    		_ = gotoNext == 4121452
    		p.fmt.clearflags()
    		p.buf.writeString("%!(EXTRA ")
    		if 0 < len(a[argNum_4117411:]) {
    			gotoNext = 4121779
    			_ = gotoNext == 4121779
    			i_4121514, arg_4121517 = 0, a[argNum_4117411:][0]
    			gotoNext = 4121780
    			_ = gotoNext == 4121780
    			if i_4121514 < len(a[argNum_4117411:]) {
    				gotoNext = 4121541
    				_ = gotoNext == 4121541
    				arg_4121517 = a[argNum_4117411:][i_4121514]
    				if i_4121514 > 0 {
    					gotoNext = 4121555
    					_ = gotoNext == 4121555
    					p.buf.writeString(", ")
    				...
    				if arg_4121517 == nil {
    					...
    					gotoNext = 4121669
    					_ = gotoNext == 4121669
    					p.buf.writeString(reflect.TypeOf(arg_4121517).String())
    					p.buf.writeByte(61)
    					p.printArg(arg_4121517, 118)
    					_ = 0
    					gotoNext = 4121514
    				}
    				_ = gotoNext == 4121514
