...
/**
    /|*{
    	end_4050019 = len(format)
    	argNum_4050039 = 0
    	afterIndex_4050110 = false
    	p.reordered = false
    	gotoNext = 4050201
    	_ = gotoNext == 4050201
    	i_4050218 = 0
    	...
    	gotoNext = 4050214
    	_ = gotoNext == 4050214
    	if !formatLoopBreak && (i_4050218 < end_4050019) {
    		gotoNext = 4050235
    		_ = gotoNext == 4050235
    		p.goodArgNum = true
    		lasti_4050261 = i_4050218
    		_ = 0
    		gotoNext = 4050274
    		_ = gotoNext == 4050274
    		if i_4050218 < end_4050019 && format[i_4050218] != 37 {
    			gotoNext = 4050306
    			_ = gotoNext == 4050306
    			i_4050218++
    			gotoNext = 4050274
    		...
    		_ = gotoNext == 4050321
    		if i_4050218 > lasti_4050261 {
    			gotoNext = 4050334
    			_ = gotoNext == 4050334
    			p.buf.writeString(format[lasti_4050261:i_4050218])
    			gotoNext = 4050380
    		} else {
    			gotoNext = 4050380
    		}
    		_ = gotoNext == 4050380
    		if i_4050218 >= end_4050019 {
    			gotoNext = 4050392
    			_ = gotoNext == 4050392
    			gotoNext = 4054045
    			gotoNext = 4050468
    		...
    		gotoNext = 4050534
    		_ = gotoNext == 4050534
    		if !simpleFormatBreak && (i_4050218 < end_4050019) {
    			gotoNext = 4050553
    			_ = gotoNext == 4050553
    			c_4050558 = format[i_4050218]
    			gotoNext = 4050576
    			_ = gotoNext == 4050576
    			switch c_4050558 {
    			case 35:
    			...
    			default:
    				gotoNext = 4050878
    				_ = gotoNext == 4050878
    				if 97 <= c_4050558 && c_4050558 <= 122 && argNum_4050039 < len(a) {
    					gotoNext = 4051055
    					_ = gotoNext == 4051055
    					gotoNext = 4051062
    					_ = gotoNext == 4051062
    					...
    					case 119:
    						gotoNext = 4051078
    						_ = gotoNext == 4051078
    						p.wrappedErrs = append(p.wrappedErrs, argNum_4050039)
    						gotoNext = 4051163
    						gotoNext = 4051348
    					case 118:
    						gotoNext = 4051163
    					...
    					_ = gotoNext == 4051348
    					p.printArg(a[argNum_4050039], rune(c_4050558))
    					argNum_4050039++
    					i_4050218++
    					gotoNext = 4050214
    					gotoNext = 4051513
    		...
    		_ = gotoNext == 4051588
    		argNum_4050039, i_4050218, afterIndex_4050110 = p.argNumber(argNum_4050039, format, i_4050218, len(a))
    		if i_4050218 < end_4050019 && format[i_4050218] == 42 {
    			gotoNext = 4051708
    			_ = gotoNext == 4051708
    			i_4050218++
    			p.fmt.wid, p.fmt.widPresent, argNum_4050039 = intFromArg(a, argNum_4050039)
    			if !p.fmt.widPresent {
    				gotoNext = 4051805
    				_ = gotoNext == 4051805
    			...
    			gotoNext = 4052115
    			_ = gotoNext == 4052115
    			p.fmt.wid, p.fmt.widPresent, i_4050218 = parsenum(format, i_4050218, end_4050019)
    			if afterIndex_4050110 && p.fmt.widPresent {
    				gotoNext = 4052215
    				_ = gotoNext == 4052215
    				p.goodArgNum = false
    				gotoNext = 4052293
    		...
    		_ = gotoNext == 4052293
    		if i_4050218+1 < end_4050019 && format[i_4050218] == 46 {
    			gotoNext = 4052326
    			_ = gotoNext == 4052326
    			i_4050218++
    			if afterIndex_4050110 {
    				gotoNext = 4052352
    				_ = gotoNext == 4052352
    				p.goodArgNum = false
    				gotoNext = 4052400
    			...
    			if i_4050218 < end_4050019 && format[i_4050218] == 42 {
    				...
    				_ = gotoNext == 4052497
    				i_4050218++
    				p.fmt.prec, p.fmt.precPresent, argNum_4050039 = intFromArg(a, argNum_4050039)
    				if p.fmt.prec < 0 {
    					gotoNext = 4052648
    					_ = gotoNext == 4052648
    					p.fmt.prec = 0
    				...
    				gotoNext = 4052812
    				_ = gotoNext == 4052812
    				p.fmt.prec, p.fmt.precPresent, i_4050218 = parsenum(format, i_4050218, end_4050019)
    				if !p.fmt.precPresent {
    					gotoNext = 4052904
    					_ = gotoNext == 4052904
    					p.fmt.prec = 0
    		...
    		_ = gotoNext == 4053129
    		verb_4053129, size_4053135 = rune(format[i_4050218]), 1
    		if verb_4053129 >= 128 {
    			gotoNext = 4053189
    			_ = gotoNext == 4053189
    			verb_4053129, size_4053135 = utf8.DecodeRuneInString(format[i_4050218:])
    			gotoNext = 4053249
    		} else {
    			gotoNext = 4053249
    		}
    		_ = gotoNext == 4053249
    		i_4050218 += size_4053135
    		gotoNext = 4053262
    		_ = gotoNext == 4053262
    		switch {
    		case verb_4053129 == 37:
    			gotoNext = 4053273
    			_ = gotoNext == 4053273
    			p.buf.writeByte(37)
    			gotoNext = 4050214
    		case !p.goodArgNum:
    			gotoNext = 4053383
    			_ = gotoNext == 4053383
    			p.badArgNum(verb_4053129)
    			gotoNext = 4050214
    		case argNum_4050039 >= len(a):
    			gotoNext = 4053426
    			_ = gotoNext == 4053426
    			p.missingArg(verb_4053129)
    			gotoNext = 4050214
    		case verb_4053129 == 119:
    			gotoNext = 4053529
    			_ = gotoNext == 4053529
    			p.wrappedErrs = append(p.wrappedErrs, argNum_4050039)
    			gotoNext = 4053613
    			gotoNext = 4050214
    		case verb_4053129 == 118:
    			gotoNext = 4053613
    			_ = gotoNext == 4053613
    			p.fmt.sharpV = p.fmt.sharp
    			p.fmt.sharp = false
    		...
    		default:
    			gotoNext = 4053793
    			_ = gotoNext == 4053793
    			p.printArg(a[argNum_4050039], verb_4053129)
    			argNum_4050039++
    			gotoNext = 4050214
    		}
    		gotoNext = 4050214
    	...
    	_ = gotoNext == 4054045
    	if !p.reordered && argNum_4050039 < len(a) {
    		gotoNext = 4054080
    		_ = gotoNext == 4054080
    		p.fmt.clearflags()
    		p.buf.writeString("%!(EXTRA ")
    		if 0 < len(a[argNum_4050039:]) {
    			gotoNext = 4054407
    			_ = gotoNext == 4054407
    			i_4054142, arg_4054145 = 0, a[argNum_4050039:][0]
    			gotoNext = 4054408
    			_ = gotoNext == 4054408
    			if i_4054142 < len(a[argNum_4050039:]) {
    				gotoNext = 4054169
    				_ = gotoNext == 4054169
    				arg_4054145 = a[argNum_4050039:][i_4054142]
    				if i_4054142 > 0 {
    					gotoNext = 4054183
    					_ = gotoNext == 4054183
    					p.buf.writeString(", ")
    				...
    				if arg_4054145 == nil {
    					...
    					gotoNext = 4054297
    					_ = gotoNext == 4054297
    					p.buf.writeString(reflect.TypeOf(arg_4054145).String())
    					p.buf.writeByte(61)
    					p.printArg(arg_4054145, 118)
    					_ = 0
    					gotoNext = 4054142
    				}
    				_ = gotoNext == 4054142
