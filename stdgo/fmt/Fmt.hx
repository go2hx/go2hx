...
/**
    /|*{
    	end_4092136 = len(format)
    	argNum_4092156 = 0
    	afterIndex_4092227 = false
    	p.reordered = false
    	gotoNext = 4092318
    	_ = gotoNext == 4092318
    	i_4092335 = 0
    	...
    	gotoNext = 4092331
    	_ = gotoNext == 4092331
    	if !formatLoopBreak && (i_4092335 < end_4092136) {
    		gotoNext = 4092352
    		_ = gotoNext == 4092352
    		p.goodArgNum = true
    		lasti_4092378 = i_4092335
    		_ = 0
    		gotoNext = 4092391
    		_ = gotoNext == 4092391
    		if i_4092335 < end_4092136 && format[i_4092335] != 37 {
    			gotoNext = 4092423
    			_ = gotoNext == 4092423
    			i_4092335++
    			gotoNext = 4092391
    		...
    		_ = gotoNext == 4092438
    		if i_4092335 > lasti_4092378 {
    			gotoNext = 4092451
    			_ = gotoNext == 4092451
    			p.buf.writeString(format[lasti_4092378:i_4092335])
    			gotoNext = 4092497
    		} else {
    			gotoNext = 4092497
    		}
    		_ = gotoNext == 4092497
    		if i_4092335 >= end_4092136 {
    			gotoNext = 4092509
    			_ = gotoNext == 4092509
    			gotoNext = 4096162
    			gotoNext = 4092585
    		...
    		gotoNext = 4092651
    		_ = gotoNext == 4092651
    		if !simpleFormatBreak && (i_4092335 < end_4092136) {
    			gotoNext = 4092670
    			_ = gotoNext == 4092670
    			c_4092675 = format[i_4092335]
    			gotoNext = 4092693
    			_ = gotoNext == 4092693
    			switch c_4092675 {
    			case 35:
    			...
    			default:
    				gotoNext = 4092995
    				_ = gotoNext == 4092995
    				if 97 <= c_4092675 && c_4092675 <= 122 && argNum_4092156 < len(a) {
    					gotoNext = 4093172
    					_ = gotoNext == 4093172
    					gotoNext = 4093179
    					_ = gotoNext == 4093179
    					...
    					case 119:
    						gotoNext = 4093195
    						_ = gotoNext == 4093195
    						p.wrappedErrs = append(p.wrappedErrs, argNum_4092156)
    						gotoNext = 4093280
    						gotoNext = 4093465
    					case 118:
    						gotoNext = 4093280
    					...
    					_ = gotoNext == 4093465
    					p.printArg(a[argNum_4092156], rune(c_4092675))
    					argNum_4092156++
    					i_4092335++
    					gotoNext = 4092331
    					gotoNext = 4093630
    		...
    		_ = gotoNext == 4093705
    		argNum_4092156, i_4092335, afterIndex_4092227 = p.argNumber(argNum_4092156, format, i_4092335, len(a))
    		if i_4092335 < end_4092136 && format[i_4092335] == 42 {
    			gotoNext = 4093825
    			_ = gotoNext == 4093825
    			i_4092335++
    			p.fmt.wid, p.fmt.widPresent, argNum_4092156 = intFromArg(a, argNum_4092156)
    			if !p.fmt.widPresent {
    				gotoNext = 4093922
    				_ = gotoNext == 4093922
    			...
    			gotoNext = 4094232
    			_ = gotoNext == 4094232
    			p.fmt.wid, p.fmt.widPresent, i_4092335 = parsenum(format, i_4092335, end_4092136)
    			if afterIndex_4092227 && p.fmt.widPresent {
    				gotoNext = 4094332
    				_ = gotoNext == 4094332
    				p.goodArgNum = false
    				gotoNext = 4094410
    		...
    		_ = gotoNext == 4094410
    		if i_4092335+1 < end_4092136 && format[i_4092335] == 46 {
    			gotoNext = 4094443
    			_ = gotoNext == 4094443
    			i_4092335++
    			if afterIndex_4092227 {
    				gotoNext = 4094469
    				_ = gotoNext == 4094469
    				p.goodArgNum = false
    				gotoNext = 4094517
    			...
    			if i_4092335 < end_4092136 && format[i_4092335] == 42 {
    				...
    				_ = gotoNext == 4094614
    				i_4092335++
    				p.fmt.prec, p.fmt.precPresent, argNum_4092156 = intFromArg(a, argNum_4092156)
    				if p.fmt.prec < 0 {
    					gotoNext = 4094765
    					_ = gotoNext == 4094765
    					p.fmt.prec = 0
    				...
    				gotoNext = 4094929
    				_ = gotoNext == 4094929
    				p.fmt.prec, p.fmt.precPresent, i_4092335 = parsenum(format, i_4092335, end_4092136)
    				if !p.fmt.precPresent {
    					gotoNext = 4095021
    					_ = gotoNext == 4095021
    					p.fmt.prec = 0
    		...
    		_ = gotoNext == 4095246
    		verb_4095246, size_4095252 = rune(format[i_4092335]), 1
    		if verb_4095246 >= 128 {
    			gotoNext = 4095306
    			_ = gotoNext == 4095306
    			verb_4095246, size_4095252 = utf8.DecodeRuneInString(format[i_4092335:])
    			gotoNext = 4095366
    		} else {
    			gotoNext = 4095366
    		}
    		_ = gotoNext == 4095366
    		i_4092335 += size_4095252
    		gotoNext = 4095379
    		_ = gotoNext == 4095379
    		switch {
    		case verb_4095246 == 37:
    			gotoNext = 4095390
    			_ = gotoNext == 4095390
    			p.buf.writeByte(37)
    			gotoNext = 4092331
    		case !p.goodArgNum:
    			gotoNext = 4095500
    			_ = gotoNext == 4095500
    			p.badArgNum(verb_4095246)
    			gotoNext = 4092331
    		case argNum_4092156 >= len(a):
    			gotoNext = 4095543
    			_ = gotoNext == 4095543
    			p.missingArg(verb_4095246)
    			gotoNext = 4092331
    		case verb_4095246 == 119:
    			gotoNext = 4095646
    			_ = gotoNext == 4095646
    			p.wrappedErrs = append(p.wrappedErrs, argNum_4092156)
    			gotoNext = 4095730
    			gotoNext = 4092331
    		case verb_4095246 == 118:
    			gotoNext = 4095730
    			_ = gotoNext == 4095730
    			p.fmt.sharpV = p.fmt.sharp
    			p.fmt.sharp = false
    		...
    		default:
    			gotoNext = 4095910
    			_ = gotoNext == 4095910
    			p.printArg(a[argNum_4092156], verb_4095246)
    			argNum_4092156++
    			gotoNext = 4092331
    		}
    		gotoNext = 4092331
    	...
    	_ = gotoNext == 4096162
    	if !p.reordered && argNum_4092156 < len(a) {
    		gotoNext = 4096197
    		_ = gotoNext == 4096197
    		p.fmt.clearflags()
    		p.buf.writeString("%!(EXTRA ")
    		if 0 < len(a[argNum_4092156:]) {
    			gotoNext = 4096524
    			_ = gotoNext == 4096524
    			i_4096259, arg_4096262 = 0, a[argNum_4092156:][0]
    			gotoNext = 4096525
    			_ = gotoNext == 4096525
    			if i_4096259 < len(a[argNum_4092156:]) {
    				gotoNext = 4096286
    				_ = gotoNext == 4096286
    				arg_4096262 = a[argNum_4092156:][i_4096259]
    				if i_4096259 > 0 {
    					gotoNext = 4096300
    					_ = gotoNext == 4096300
    					p.buf.writeString(", ")
    				...
    				if arg_4096262 == nil {
    					...
    					gotoNext = 4096414
    					_ = gotoNext == 4096414
    					p.buf.writeString(reflect.TypeOf(arg_4096262).String())
    					p.buf.writeByte(61)
    					p.printArg(arg_4096262, 118)
    					_ = 0
    					gotoNext = 4096259
    				}
    				_ = gotoNext == 4096259
