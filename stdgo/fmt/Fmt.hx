...
/**
    /|*{
    	end_4024867 = len(format)
    	argNum_4024887 = 0
    	afterIndex_4024958 = false
    	p.reordered = false
    	gotoNext = 4025049
    	_ = gotoNext == 4025049
    	i_4025066 = 0
    	...
    	gotoNext = 4025062
    	_ = gotoNext == 4025062
    	if !formatLoopBreak && (i_4025066 < end_4024867) {
    		gotoNext = 4025083
    		_ = gotoNext == 4025083
    		p.goodArgNum = true
    		lasti_4025109 = i_4025066
    		_ = 0
    		gotoNext = 4025122
    		_ = gotoNext == 4025122
    		if i_4025066 < end_4024867 && format[i_4025066] != 37 {
    			gotoNext = 4025154
    			_ = gotoNext == 4025154
    			i_4025066++
    			gotoNext = 4025122
    		...
    		_ = gotoNext == 4025169
    		if i_4025066 > lasti_4025109 {
    			gotoNext = 4025182
    			_ = gotoNext == 4025182
    			p.buf.writeString(format[lasti_4025109:i_4025066])
    			gotoNext = 4025228
    		} else {
    			gotoNext = 4025228
    		}
    		_ = gotoNext == 4025228
    		if i_4025066 >= end_4024867 {
    			gotoNext = 4025240
    			_ = gotoNext == 4025240
    			gotoNext = 4028893
    			gotoNext = 4025316
    		...
    		gotoNext = 4025382
    		_ = gotoNext == 4025382
    		if !simpleFormatBreak && (i_4025066 < end_4024867) {
    			gotoNext = 4025401
    			_ = gotoNext == 4025401
    			c_4025406 = format[i_4025066]
    			gotoNext = 4025424
    			_ = gotoNext == 4025424
    			switch c_4025406 {
    			case 35:
    			...
    			default:
    				gotoNext = 4025726
    				_ = gotoNext == 4025726
    				if 97 <= c_4025406 && c_4025406 <= 122 && argNum_4024887 < len(a) {
    					gotoNext = 4025903
    					_ = gotoNext == 4025903
    					gotoNext = 4025910
    					_ = gotoNext == 4025910
    					...
    					case 119:
    						gotoNext = 4025926
    						_ = gotoNext == 4025926
    						p.wrappedErrs = append(p.wrappedErrs, argNum_4024887)
    						gotoNext = 4026011
    						gotoNext = 4026196
    					case 118:
    						gotoNext = 4026011
    					...
    					_ = gotoNext == 4026196
    					p.printArg(a[argNum_4024887], rune(c_4025406))
    					argNum_4024887++
    					i_4025066++
    					gotoNext = 4025062
    					gotoNext = 4026361
    		...
    		_ = gotoNext == 4026436
    		argNum_4024887, i_4025066, afterIndex_4024958 = p.argNumber(argNum_4024887, format, i_4025066, len(a))
    		if i_4025066 < end_4024867 && format[i_4025066] == 42 {
    			gotoNext = 4026556
    			_ = gotoNext == 4026556
    			i_4025066++
    			p.fmt.wid, p.fmt.widPresent, argNum_4024887 = intFromArg(a, argNum_4024887)
    			if !p.fmt.widPresent {
    				gotoNext = 4026653
    				_ = gotoNext == 4026653
    			...
    			gotoNext = 4026963
    			_ = gotoNext == 4026963
    			p.fmt.wid, p.fmt.widPresent, i_4025066 = parsenum(format, i_4025066, end_4024867)
    			if afterIndex_4024958 && p.fmt.widPresent {
    				gotoNext = 4027063
    				_ = gotoNext == 4027063
    				p.goodArgNum = false
    				gotoNext = 4027141
    		...
    		_ = gotoNext == 4027141
    		if i_4025066+1 < end_4024867 && format[i_4025066] == 46 {
    			gotoNext = 4027174
    			_ = gotoNext == 4027174
    			i_4025066++
    			if afterIndex_4024958 {
    				gotoNext = 4027200
    				_ = gotoNext == 4027200
    				p.goodArgNum = false
    				gotoNext = 4027248
    			...
    			if i_4025066 < end_4024867 && format[i_4025066] == 42 {
    				...
    				_ = gotoNext == 4027345
    				i_4025066++
    				p.fmt.prec, p.fmt.precPresent, argNum_4024887 = intFromArg(a, argNum_4024887)
    				if p.fmt.prec < 0 {
    					gotoNext = 4027496
    					_ = gotoNext == 4027496
    					p.fmt.prec = 0
    				...
    				gotoNext = 4027660
    				_ = gotoNext == 4027660
    				p.fmt.prec, p.fmt.precPresent, i_4025066 = parsenum(format, i_4025066, end_4024867)
    				if !p.fmt.precPresent {
    					gotoNext = 4027752
    					_ = gotoNext == 4027752
    					p.fmt.prec = 0
    		...
    		_ = gotoNext == 4027977
    		verb_4027977, size_4027983 = rune(format[i_4025066]), 1
    		if verb_4027977 >= 128 {
    			gotoNext = 4028037
    			_ = gotoNext == 4028037
    			verb_4027977, size_4027983 = utf8.DecodeRuneInString(format[i_4025066:])
    			gotoNext = 4028097
    		} else {
    			gotoNext = 4028097
    		}
    		_ = gotoNext == 4028097
    		i_4025066 += size_4027983
    		gotoNext = 4028110
    		_ = gotoNext == 4028110
    		switch {
    		case verb_4027977 == 37:
    			gotoNext = 4028121
    			_ = gotoNext == 4028121
    			p.buf.writeByte(37)
    			gotoNext = 4025062
    		case !p.goodArgNum:
    			gotoNext = 4028231
    			_ = gotoNext == 4028231
    			p.badArgNum(verb_4027977)
    			gotoNext = 4025062
    		case argNum_4024887 >= len(a):
    			gotoNext = 4028274
    			_ = gotoNext == 4028274
    			p.missingArg(verb_4027977)
    			gotoNext = 4025062
    		case verb_4027977 == 119:
    			gotoNext = 4028377
    			_ = gotoNext == 4028377
    			p.wrappedErrs = append(p.wrappedErrs, argNum_4024887)
    			gotoNext = 4028461
    			gotoNext = 4025062
    		case verb_4027977 == 118:
    			gotoNext = 4028461
    			_ = gotoNext == 4028461
    			p.fmt.sharpV = p.fmt.sharp
    			p.fmt.sharp = false
    		...
    		default:
    			gotoNext = 4028641
    			_ = gotoNext == 4028641
    			p.printArg(a[argNum_4024887], verb_4027977)
    			argNum_4024887++
    			gotoNext = 4025062
    		}
    		gotoNext = 4025062
    	...
    	_ = gotoNext == 4028893
    	if !p.reordered && argNum_4024887 < len(a) {
    		gotoNext = 4028928
    		_ = gotoNext == 4028928
    		p.fmt.clearflags()
    		p.buf.writeString("%!(EXTRA ")
    		if 0 < len(a[argNum_4024887:]) {
    			gotoNext = 4029255
    			_ = gotoNext == 4029255
    			i_4028990, arg_4028993 = 0, a[argNum_4024887:][0]
    			gotoNext = 4029256
    			_ = gotoNext == 4029256
    			if i_4028990 < len(a[argNum_4024887:]) {
    				gotoNext = 4029017
    				_ = gotoNext == 4029017
    				arg_4028993 = a[argNum_4024887:][i_4028990]
    				if i_4028990 > 0 {
    					gotoNext = 4029031
    					_ = gotoNext == 4029031
    					p.buf.writeString(", ")
    				...
    				if arg_4028993 == nil {
    					...
    					gotoNext = 4029145
    					_ = gotoNext == 4029145
    					p.buf.writeString(reflect.TypeOf(arg_4028993).String())
    					p.buf.writeByte(61)
    					p.printArg(arg_4028993, 118)
    					_ = 0
    					gotoNext = 4028990
    				}
    				_ = gotoNext == 4028990
