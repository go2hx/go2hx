...
/**
    /|*{
    	end_4100839 = len(format)
    	argNum_4100859 = 0
    	afterIndex_4100930 = false
    	p.reordered = false
    	gotoNext = 4101021
    	_ = gotoNext == 4101021
    	i_4101038 = 0
    	...
    	gotoNext = 4101034
    	_ = gotoNext == 4101034
    	if !formatLoopBreak && (i_4101038 < end_4100839) {
    		gotoNext = 4101055
    		_ = gotoNext == 4101055
    		p.goodArgNum = true
    		lasti_4101081 = i_4101038
    		_ = 0
    		gotoNext = 4101094
    		_ = gotoNext == 4101094
    		if i_4101038 < end_4100839 && format[i_4101038] != 37 {
    			gotoNext = 4101126
    			_ = gotoNext == 4101126
    			i_4101038++
    			gotoNext = 4101094
    		...
    		_ = gotoNext == 4101141
    		if i_4101038 > lasti_4101081 {
    			gotoNext = 4101154
    			_ = gotoNext == 4101154
    			p.buf.writeString(format[lasti_4101081:i_4101038])
    			gotoNext = 4101200
    		} else {
    			gotoNext = 4101200
    		}
    		_ = gotoNext == 4101200
    		if i_4101038 >= end_4100839 {
    			gotoNext = 4101212
    			_ = gotoNext == 4101212
    			gotoNext = 4104865
    			gotoNext = 4101288
    		...
    		gotoNext = 4101354
    		_ = gotoNext == 4101354
    		if !simpleFormatBreak && (i_4101038 < end_4100839) {
    			gotoNext = 4101373
    			_ = gotoNext == 4101373
    			c_4101378 = format[i_4101038]
    			gotoNext = 4101396
    			_ = gotoNext == 4101396
    			switch c_4101378 {
    			case 35:
    			...
    			default:
    				gotoNext = 4101698
    				_ = gotoNext == 4101698
    				if 97 <= c_4101378 && c_4101378 <= 122 && argNum_4100859 < len(a) {
    					gotoNext = 4101875
    					_ = gotoNext == 4101875
    					gotoNext = 4101882
    					_ = gotoNext == 4101882
    					...
    					case 119:
    						gotoNext = 4101898
    						_ = gotoNext == 4101898
    						p.wrappedErrs = append(p.wrappedErrs, argNum_4100859)
    						gotoNext = 4101983
    						gotoNext = 4102168
    					case 118:
    						gotoNext = 4101983
    					...
    					_ = gotoNext == 4102168
    					p.printArg(a[argNum_4100859], rune(c_4101378))
    					argNum_4100859++
    					i_4101038++
    					gotoNext = 4101034
    					gotoNext = 4102333
    		...
    		_ = gotoNext == 4102408
    		argNum_4100859, i_4101038, afterIndex_4100930 = p.argNumber(argNum_4100859, format, i_4101038, len(a))
    		if i_4101038 < end_4100839 && format[i_4101038] == 42 {
    			gotoNext = 4102528
    			_ = gotoNext == 4102528
    			i_4101038++
    			p.fmt.wid, p.fmt.widPresent, argNum_4100859 = intFromArg(a, argNum_4100859)
    			if !p.fmt.widPresent {
    				gotoNext = 4102625
    				_ = gotoNext == 4102625
    			...
    			gotoNext = 4102935
    			_ = gotoNext == 4102935
    			p.fmt.wid, p.fmt.widPresent, i_4101038 = parsenum(format, i_4101038, end_4100839)
    			if afterIndex_4100930 && p.fmt.widPresent {
    				gotoNext = 4103035
    				_ = gotoNext == 4103035
    				p.goodArgNum = false
    				gotoNext = 4103113
    		...
    		_ = gotoNext == 4103113
    		if i_4101038+1 < end_4100839 && format[i_4101038] == 46 {
    			gotoNext = 4103146
    			_ = gotoNext == 4103146
    			i_4101038++
    			if afterIndex_4100930 {
    				gotoNext = 4103172
    				_ = gotoNext == 4103172
    				p.goodArgNum = false
    				gotoNext = 4103220
    			...
    			if i_4101038 < end_4100839 && format[i_4101038] == 42 {
    				...
    				_ = gotoNext == 4103317
    				i_4101038++
    				p.fmt.prec, p.fmt.precPresent, argNum_4100859 = intFromArg(a, argNum_4100859)
    				if p.fmt.prec < 0 {
    					gotoNext = 4103468
    					_ = gotoNext == 4103468
    					p.fmt.prec = 0
    				...
    				gotoNext = 4103632
    				_ = gotoNext == 4103632
    				p.fmt.prec, p.fmt.precPresent, i_4101038 = parsenum(format, i_4101038, end_4100839)
    				if !p.fmt.precPresent {
    					gotoNext = 4103724
    					_ = gotoNext == 4103724
    					p.fmt.prec = 0
    		...
    		_ = gotoNext == 4103949
    		verb_4103949, size_4103955 = rune(format[i_4101038]), 1
    		if verb_4103949 >= 128 {
    			gotoNext = 4104009
    			_ = gotoNext == 4104009
    			verb_4103949, size_4103955 = utf8.DecodeRuneInString(format[i_4101038:])
    			gotoNext = 4104069
    		} else {
    			gotoNext = 4104069
    		}
    		_ = gotoNext == 4104069
    		i_4101038 += size_4103955
    		gotoNext = 4104082
    		_ = gotoNext == 4104082
    		switch {
    		case verb_4103949 == 37:
    			gotoNext = 4104093
    			_ = gotoNext == 4104093
    			p.buf.writeByte(37)
    			gotoNext = 4101034
    		case !p.goodArgNum:
    			gotoNext = 4104203
    			_ = gotoNext == 4104203
    			p.badArgNum(verb_4103949)
    			gotoNext = 4101034
    		case argNum_4100859 >= len(a):
    			gotoNext = 4104246
    			_ = gotoNext == 4104246
    			p.missingArg(verb_4103949)
    			gotoNext = 4101034
    		case verb_4103949 == 119:
    			gotoNext = 4104349
    			_ = gotoNext == 4104349
    			p.wrappedErrs = append(p.wrappedErrs, argNum_4100859)
    			gotoNext = 4104433
    			gotoNext = 4101034
    		case verb_4103949 == 118:
    			gotoNext = 4104433
    			_ = gotoNext == 4104433
    			p.fmt.sharpV = p.fmt.sharp
    			p.fmt.sharp = false
    		...
    		default:
    			gotoNext = 4104613
    			_ = gotoNext == 4104613
    			p.printArg(a[argNum_4100859], verb_4103949)
    			argNum_4100859++
    			gotoNext = 4101034
    		}
    		gotoNext = 4101034
    	...
    	_ = gotoNext == 4104865
    	if !p.reordered && argNum_4100859 < len(a) {
    		gotoNext = 4104900
    		_ = gotoNext == 4104900
    		p.fmt.clearflags()
    		p.buf.writeString("%!(EXTRA ")
    		if 0 < len(a[argNum_4100859:]) {
    			gotoNext = 4105227
    			_ = gotoNext == 4105227
    			i_4104962, arg_4104965 = 0, a[argNum_4100859:][0]
    			gotoNext = 4105228
    			_ = gotoNext == 4105228
    			if i_4104962 < len(a[argNum_4100859:]) {
    				gotoNext = 4104989
    				_ = gotoNext == 4104989
    				arg_4104965 = a[argNum_4100859:][i_4104962]
    				if i_4104962 > 0 {
    					gotoNext = 4105003
    					_ = gotoNext == 4105003
    					p.buf.writeString(", ")
    				...
    				if arg_4104965 == nil {
    					...
    					gotoNext = 4105117
    					_ = gotoNext == 4105117
    					p.buf.writeString(reflect.TypeOf(arg_4104965).String())
    					p.buf.writeByte(61)
    					p.printArg(arg_4104965, 118)
    					_ = 0
    					gotoNext = 4104962
    				}
    				_ = gotoNext == 4104962
