...
/**
    /|*{
    	end_4073873 = len(format)
    	argNum_4073893 = 0
    	afterIndex_4073964 = false
    	p.reordered = false
    	gotoNext = 4074055
    	_ = gotoNext == 4074055
    	i_4074072 = 0
    	...
    	gotoNext = 4074068
    	_ = gotoNext == 4074068
    	if !formatLoopBreak && (i_4074072 < end_4073873) {
    		gotoNext = 4074089
    		_ = gotoNext == 4074089
    		p.goodArgNum = true
    		lasti_4074115 = i_4074072
    		_ = 0
    		gotoNext = 4074128
    		_ = gotoNext == 4074128
    		if i_4074072 < end_4073873 && format[i_4074072] != 37 {
    			gotoNext = 4074160
    			_ = gotoNext == 4074160
    			i_4074072++
    			gotoNext = 4074128
    		...
    		_ = gotoNext == 4074175
    		if i_4074072 > lasti_4074115 {
    			gotoNext = 4074188
    			_ = gotoNext == 4074188
    			p.buf.writeString(format[lasti_4074115:i_4074072])
    			gotoNext = 4074234
    		} else {
    			gotoNext = 4074234
    		}
    		_ = gotoNext == 4074234
    		if i_4074072 >= end_4073873 {
    			gotoNext = 4074246
    			_ = gotoNext == 4074246
    			gotoNext = 4077899
    			gotoNext = 4074322
    		...
    		gotoNext = 4074388
    		_ = gotoNext == 4074388
    		if !simpleFormatBreak && (i_4074072 < end_4073873) {
    			gotoNext = 4074407
    			_ = gotoNext == 4074407
    			c_4074412 = format[i_4074072]
    			gotoNext = 4074430
    			_ = gotoNext == 4074430
    			switch c_4074412 {
    			case 35:
    			...
    			default:
    				gotoNext = 4074732
    				_ = gotoNext == 4074732
    				if 97 <= c_4074412 && c_4074412 <= 122 && argNum_4073893 < len(a) {
    					gotoNext = 4074909
    					_ = gotoNext == 4074909
    					gotoNext = 4074916
    					_ = gotoNext == 4074916
    					...
    					case 119:
    						gotoNext = 4074932
    						_ = gotoNext == 4074932
    						p.wrappedErrs = append(p.wrappedErrs, argNum_4073893)
    						gotoNext = 4075017
    						gotoNext = 4075202
    					case 118:
    						gotoNext = 4075017
    					...
    					_ = gotoNext == 4075202
    					p.printArg(a[argNum_4073893], rune(c_4074412))
    					argNum_4073893++
    					i_4074072++
    					gotoNext = 4074068
    					gotoNext = 4075367
    		...
    		_ = gotoNext == 4075442
    		argNum_4073893, i_4074072, afterIndex_4073964 = p.argNumber(argNum_4073893, format, i_4074072, len(a))
    		if i_4074072 < end_4073873 && format[i_4074072] == 42 {
    			gotoNext = 4075562
    			_ = gotoNext == 4075562
    			i_4074072++
    			p.fmt.wid, p.fmt.widPresent, argNum_4073893 = intFromArg(a, argNum_4073893)
    			if !p.fmt.widPresent {
    				gotoNext = 4075659
    				_ = gotoNext == 4075659
    			...
    			gotoNext = 4075969
    			_ = gotoNext == 4075969
    			p.fmt.wid, p.fmt.widPresent, i_4074072 = parsenum(format, i_4074072, end_4073873)
    			if afterIndex_4073964 && p.fmt.widPresent {
    				gotoNext = 4076069
    				_ = gotoNext == 4076069
    				p.goodArgNum = false
    				gotoNext = 4076147
    		...
    		_ = gotoNext == 4076147
    		if i_4074072+1 < end_4073873 && format[i_4074072] == 46 {
    			gotoNext = 4076180
    			_ = gotoNext == 4076180
    			i_4074072++
    			if afterIndex_4073964 {
    				gotoNext = 4076206
    				_ = gotoNext == 4076206
    				p.goodArgNum = false
    				gotoNext = 4076254
    			...
    			if i_4074072 < end_4073873 && format[i_4074072] == 42 {
    				...
    				_ = gotoNext == 4076351
    				i_4074072++
    				p.fmt.prec, p.fmt.precPresent, argNum_4073893 = intFromArg(a, argNum_4073893)
    				if p.fmt.prec < 0 {
    					gotoNext = 4076502
    					_ = gotoNext == 4076502
    					p.fmt.prec = 0
    				...
    				gotoNext = 4076666
    				_ = gotoNext == 4076666
    				p.fmt.prec, p.fmt.precPresent, i_4074072 = parsenum(format, i_4074072, end_4073873)
    				if !p.fmt.precPresent {
    					gotoNext = 4076758
    					_ = gotoNext == 4076758
    					p.fmt.prec = 0
    		...
    		_ = gotoNext == 4076983
    		verb_4076983, size_4076989 = rune(format[i_4074072]), 1
    		if verb_4076983 >= 128 {
    			gotoNext = 4077043
    			_ = gotoNext == 4077043
    			verb_4076983, size_4076989 = utf8.DecodeRuneInString(format[i_4074072:])
    			gotoNext = 4077103
    		} else {
    			gotoNext = 4077103
    		}
    		_ = gotoNext == 4077103
    		i_4074072 += size_4076989
    		gotoNext = 4077116
    		_ = gotoNext == 4077116
    		switch {
    		case verb_4076983 == 37:
    			gotoNext = 4077127
    			_ = gotoNext == 4077127
    			p.buf.writeByte(37)
    			gotoNext = 4074068
    		case !p.goodArgNum:
    			gotoNext = 4077237
    			_ = gotoNext == 4077237
    			p.badArgNum(verb_4076983)
    			gotoNext = 4074068
    		case argNum_4073893 >= len(a):
    			gotoNext = 4077280
    			_ = gotoNext == 4077280
    			p.missingArg(verb_4076983)
    			gotoNext = 4074068
    		case verb_4076983 == 119:
    			gotoNext = 4077383
    			_ = gotoNext == 4077383
    			p.wrappedErrs = append(p.wrappedErrs, argNum_4073893)
    			gotoNext = 4077467
    			gotoNext = 4074068
    		case verb_4076983 == 118:
    			gotoNext = 4077467
    			_ = gotoNext == 4077467
    			p.fmt.sharpV = p.fmt.sharp
    			p.fmt.sharp = false
    		...
    		default:
    			gotoNext = 4077647
    			_ = gotoNext == 4077647
    			p.printArg(a[argNum_4073893], verb_4076983)
    			argNum_4073893++
    			gotoNext = 4074068
    		}
    		gotoNext = 4074068
    	...
    	_ = gotoNext == 4077899
    	if !p.reordered && argNum_4073893 < len(a) {
    		gotoNext = 4077934
    		_ = gotoNext == 4077934
    		p.fmt.clearflags()
    		p.buf.writeString("%!(EXTRA ")
    		if 0 < len(a[argNum_4073893:]) {
    			gotoNext = 4078261
    			_ = gotoNext == 4078261
    			i_4077996, arg_4077999 = 0, a[argNum_4073893:][0]
    			gotoNext = 4078262
    			_ = gotoNext == 4078262
    			if i_4077996 < len(a[argNum_4073893:]) {
    				gotoNext = 4078023
    				_ = gotoNext == 4078023
    				arg_4077999 = a[argNum_4073893:][i_4077996]
    				if i_4077996 > 0 {
    					gotoNext = 4078037
    					_ = gotoNext == 4078037
    					p.buf.writeString(", ")
    				...
    				if arg_4077999 == nil {
    					...
    					gotoNext = 4078151
    					_ = gotoNext == 4078151
    					p.buf.writeString(reflect.TypeOf(arg_4077999).String())
    					p.buf.writeByte(61)
    					p.printArg(arg_4077999, 118)
    					_ = 0
    					gotoNext = 4077996
    				}
    				_ = gotoNext == 4077996
