...
/**
    /|*{
    	end_4107292 = len(format)
    	argNum_4107312 = 0
    	afterIndex_4107383 = false
    	p.reordered = false
    	gotoNext = 4107474
    	_ = gotoNext == 4107474
    	i_4107491 = 0
    	...
    	gotoNext = 4107487
    	_ = gotoNext == 4107487
    	if !formatLoopBreak && (i_4107491 < end_4107292) {
    		gotoNext = 4107508
    		_ = gotoNext == 4107508
    		p.goodArgNum = true
    		lasti_4107534 = i_4107491
    		_ = 0
    		gotoNext = 4107547
    		_ = gotoNext == 4107547
    		if i_4107491 < end_4107292 && format[i_4107491] != 37 {
    			gotoNext = 4107579
    			_ = gotoNext == 4107579
    			i_4107491++
    			gotoNext = 4107547
    		...
    		_ = gotoNext == 4107594
    		if i_4107491 > lasti_4107534 {
    			gotoNext = 4107607
    			_ = gotoNext == 4107607
    			p.buf.writeString(format[lasti_4107534:i_4107491])
    			gotoNext = 4107653
    		} else {
    			gotoNext = 4107653
    		}
    		_ = gotoNext == 4107653
    		if i_4107491 >= end_4107292 {
    			gotoNext = 4107665
    			_ = gotoNext == 4107665
    			gotoNext = 4111318
    			gotoNext = 4107741
    		...
    		gotoNext = 4107807
    		_ = gotoNext == 4107807
    		if !simpleFormatBreak && (i_4107491 < end_4107292) {
    			gotoNext = 4107826
    			_ = gotoNext == 4107826
    			c_4107831 = format[i_4107491]
    			_ = 0
    			gotoNext = 4107849
    			_ = gotoNext == 4107849
    			switch c_4107831 {
    			...
    			default:
    				gotoNext = 4108151
    				_ = gotoNext == 4108151
    				if 97 <= c_4107831 && c_4107831 <= 122 && argNum_4107312 < len(a) {
    					gotoNext = 4108328
    					_ = gotoNext == 4108328
    					_ = 0
    					gotoNext = 4108335
    					...
    					case 119:
    						gotoNext = 4108351
    						_ = gotoNext == 4108351
    						p.wrappedErrs = append(p.wrappedErrs, argNum_4107312)
    						gotoNext = 4108436
    						gotoNext = 4108621
    					case 118:
    						gotoNext = 4108436
    					...
    					_ = gotoNext == 4108621
    					p.printArg(a[argNum_4107312], rune(c_4107831))
    					argNum_4107312++
    					i_4107491++
    					gotoNext = 4107487
    					gotoNext = 4108786
    		...
    		_ = gotoNext == 4108861
    		argNum_4107312, i_4107491, afterIndex_4107383 = p.argNumber(argNum_4107312, format, i_4107491, len(a))
    		if i_4107491 < end_4107292 && format[i_4107491] == 42 {
    			gotoNext = 4108981
    			_ = gotoNext == 4108981
    			i_4107491++
    			p.fmt.wid, p.fmt.widPresent, argNum_4107312 = intFromArg(a, argNum_4107312)
    			if !p.fmt.widPresent {
    				gotoNext = 4109078
    				_ = gotoNext == 4109078
    			...
    			gotoNext = 4109388
    			_ = gotoNext == 4109388
    			p.fmt.wid, p.fmt.widPresent, i_4107491 = parsenum(format, i_4107491, end_4107292)
    			if afterIndex_4107383 && p.fmt.widPresent {
    				gotoNext = 4109488
    				_ = gotoNext == 4109488
    				p.goodArgNum = false
    				gotoNext = 4109566
    		...
    		_ = gotoNext == 4109566
    		if i_4107491+1 < end_4107292 && format[i_4107491] == 46 {
    			gotoNext = 4109599
    			_ = gotoNext == 4109599
    			i_4107491++
    			if afterIndex_4107383 {
    				gotoNext = 4109625
    				_ = gotoNext == 4109625
    				p.goodArgNum = false
    				gotoNext = 4109673
    			...
    			if i_4107491 < end_4107292 && format[i_4107491] == 42 {
    				...
    				_ = gotoNext == 4109770
    				i_4107491++
    				p.fmt.prec, p.fmt.precPresent, argNum_4107312 = intFromArg(a, argNum_4107312)
    				if p.fmt.prec < 0 {
    					gotoNext = 4109921
    					_ = gotoNext == 4109921
    					p.fmt.prec = 0
    				...
    				gotoNext = 4110085
    				_ = gotoNext == 4110085
    				p.fmt.prec, p.fmt.precPresent, i_4107491 = parsenum(format, i_4107491, end_4107292)
    				if !p.fmt.precPresent {
    					gotoNext = 4110177
    					_ = gotoNext == 4110177
    					p.fmt.prec = 0
    		...
    		_ = gotoNext == 4110402
    		verb_4110402, size_4110408 = rune(format[i_4107491]), 1
    		if verb_4110402 >= 128 {
    			gotoNext = 4110462
    			_ = gotoNext == 4110462
    			verb_4110402, size_4110408 = utf8.DecodeRuneInString(format[i_4107491:])
    			gotoNext = 4110522
    		} else {
    			gotoNext = 4110522
    		}
    		_ = gotoNext == 4110522
    		i_4107491 += size_4110408
    		_ = 0
    		gotoNext = 4110535
    		_ = gotoNext == 4110535
    		switch {
    		case verb_4110402 == 37:
    			gotoNext = 4110546
    			_ = gotoNext == 4110546
    			p.buf.writeByte(37)
    			gotoNext = 4111318
    		case !p.goodArgNum:
    			gotoNext = 4110656
    			_ = gotoNext == 4110656
    			p.badArgNum(verb_4110402)
    			gotoNext = 4111318
    		case argNum_4107312 >= len(a):
    			gotoNext = 4110699
    			_ = gotoNext == 4110699
    			p.missingArg(verb_4110402)
    			gotoNext = 4111318
    		case verb_4110402 == 119:
    			gotoNext = 4110802
    			_ = gotoNext == 4110802
    			p.wrappedErrs = append(p.wrappedErrs, argNum_4107312)
    			gotoNext = 4110886
    			gotoNext = 4111318
    		case verb_4110402 == 118:
    			gotoNext = 4110886
    			_ = gotoNext == 4110886
    			p.fmt.sharpV = p.fmt.sharp
    			p.fmt.sharp = false
    		...
    		default:
    			gotoNext = 4111066
    			_ = gotoNext == 4111066
    			p.printArg(a[argNum_4107312], verb_4110402)
    			argNum_4107312++
    			gotoNext = 4111318
    		}
    		gotoNext = 4107487
    	...
    	_ = gotoNext == 4111318
    	if !p.reordered && argNum_4107312 < len(a) {
    		gotoNext = 4111353
    		_ = gotoNext == 4111353
    		p.fmt.clearflags()
    		p.buf.writeString("%!(EXTRA ")
    		if 0 < len(a[argNum_4107312:]) {
    			gotoNext = 4111680
    			_ = gotoNext == 4111680
    			i_4111415, arg_4111418 = 0, a[argNum_4107312:][0]
    			gotoNext = 4111681
    			_ = gotoNext == 4111681
    			if i_4111415 < len(a[argNum_4107312:]) {
    				gotoNext = 4111442
    				_ = gotoNext == 4111442
    				arg_4111418 = a[argNum_4107312:][i_4111415]
    				if i_4111415 > 0 {
    					gotoNext = 4111456
    					_ = gotoNext == 4111456
    					p.buf.writeString(", ")
    				...
    				if arg_4111418 == nil {
    					...
    					gotoNext = 4111570
    					_ = gotoNext == 4111570
    					p.buf.writeString(reflect.TypeOf(arg_4111418).String())
    					p.buf.writeByte(61)
    					p.printArg(arg_4111418, 118)
    					_ = 0
    					gotoNext = 4111415
    				}
    				_ = gotoNext == 4111415
