...
/**
    /|*{
    	end_4061420 = len(format)
    	argNum_4061440 = 0
    	afterIndex_4061511 = false
    	p.reordered = false
    	gotoNext = 4061602
    	_ = gotoNext == 4061602
    	i_4061619 = 0
    	...
    	gotoNext = 4061615
    	_ = gotoNext == 4061615
    	if !formatLoopBreak && (i_4061619 < end_4061420) {
    		gotoNext = 4061636
    		_ = gotoNext == 4061636
    		p.goodArgNum = true
    		lasti_4061662 = i_4061619
    		_ = 0
    		gotoNext = 4061675
    		_ = gotoNext == 4061675
    		if i_4061619 < end_4061420 && format[i_4061619] != 37 {
    			gotoNext = 4061707
    			_ = gotoNext == 4061707
    			i_4061619++
    			gotoNext = 4061675
    		...
    		_ = gotoNext == 4061722
    		if i_4061619 > lasti_4061662 {
    			gotoNext = 4061735
    			_ = gotoNext == 4061735
    			p.buf.writeString(format[lasti_4061662:i_4061619])
    			gotoNext = 4061781
    		} else {
    			gotoNext = 4061781
    		}
    		_ = gotoNext == 4061781
    		if i_4061619 >= end_4061420 {
    			gotoNext = 4061793
    			_ = gotoNext == 4061793
    			gotoNext = 4065446
    			gotoNext = 4061869
    		...
    		gotoNext = 4061935
    		_ = gotoNext == 4061935
    		if !simpleFormatBreak && (i_4061619 < end_4061420) {
    			gotoNext = 4061954
    			_ = gotoNext == 4061954
    			c_4061959 = format[i_4061619]
    			gotoNext = 4061977
    			_ = gotoNext == 4061977
    			switch c_4061959 {
    			case 35:
    			...
    			default:
    				gotoNext = 4062279
    				_ = gotoNext == 4062279
    				if 97 <= c_4061959 && c_4061959 <= 122 && argNum_4061440 < len(a) {
    					gotoNext = 4062456
    					_ = gotoNext == 4062456
    					gotoNext = 4062463
    					_ = gotoNext == 4062463
    					...
    					case 119:
    						gotoNext = 4062479
    						_ = gotoNext == 4062479
    						p.wrappedErrs = append(p.wrappedErrs, argNum_4061440)
    						gotoNext = 4062564
    						gotoNext = 4062749
    					case 118:
    						gotoNext = 4062564
    					...
    					_ = gotoNext == 4062749
    					p.printArg(a[argNum_4061440], rune(c_4061959))
    					argNum_4061440++
    					i_4061619++
    					gotoNext = 4061615
    					gotoNext = 4062914
    		...
    		_ = gotoNext == 4062989
    		argNum_4061440, i_4061619, afterIndex_4061511 = p.argNumber(argNum_4061440, format, i_4061619, len(a))
    		if i_4061619 < end_4061420 && format[i_4061619] == 42 {
    			gotoNext = 4063109
    			_ = gotoNext == 4063109
    			i_4061619++
    			p.fmt.wid, p.fmt.widPresent, argNum_4061440 = intFromArg(a, argNum_4061440)
    			if !p.fmt.widPresent {
    				gotoNext = 4063206
    				_ = gotoNext == 4063206
    			...
    			gotoNext = 4063516
    			_ = gotoNext == 4063516
    			p.fmt.wid, p.fmt.widPresent, i_4061619 = parsenum(format, i_4061619, end_4061420)
    			if afterIndex_4061511 && p.fmt.widPresent {
    				gotoNext = 4063616
    				_ = gotoNext == 4063616
    				p.goodArgNum = false
    				gotoNext = 4063694
    		...
    		_ = gotoNext == 4063694
    		if i_4061619+1 < end_4061420 && format[i_4061619] == 46 {
    			gotoNext = 4063727
    			_ = gotoNext == 4063727
    			i_4061619++
    			if afterIndex_4061511 {
    				gotoNext = 4063753
    				_ = gotoNext == 4063753
    				p.goodArgNum = false
    				gotoNext = 4063801
    			...
    			if i_4061619 < end_4061420 && format[i_4061619] == 42 {
    				...
    				_ = gotoNext == 4063898
    				i_4061619++
    				p.fmt.prec, p.fmt.precPresent, argNum_4061440 = intFromArg(a, argNum_4061440)
    				if p.fmt.prec < 0 {
    					gotoNext = 4064049
    					_ = gotoNext == 4064049
    					p.fmt.prec = 0
    				...
    				gotoNext = 4064213
    				_ = gotoNext == 4064213
    				p.fmt.prec, p.fmt.precPresent, i_4061619 = parsenum(format, i_4061619, end_4061420)
    				if !p.fmt.precPresent {
    					gotoNext = 4064305
    					_ = gotoNext == 4064305
    					p.fmt.prec = 0
    		...
    		_ = gotoNext == 4064530
    		verb_4064530, size_4064536 = rune(format[i_4061619]), 1
    		if verb_4064530 >= 128 {
    			gotoNext = 4064590
    			_ = gotoNext == 4064590
    			verb_4064530, size_4064536 = utf8.DecodeRuneInString(format[i_4061619:])
    			gotoNext = 4064650
    		} else {
    			gotoNext = 4064650
    		}
    		_ = gotoNext == 4064650
    		i_4061619 += size_4064536
    		gotoNext = 4064663
    		_ = gotoNext == 4064663
    		switch {
    		case verb_4064530 == 37:
    			gotoNext = 4064674
    			_ = gotoNext == 4064674
    			p.buf.writeByte(37)
    			gotoNext = 4061615
    		case !p.goodArgNum:
    			gotoNext = 4064784
    			_ = gotoNext == 4064784
    			p.badArgNum(verb_4064530)
    			gotoNext = 4061615
    		case argNum_4061440 >= len(a):
    			gotoNext = 4064827
    			_ = gotoNext == 4064827
    			p.missingArg(verb_4064530)
    			gotoNext = 4061615
    		case verb_4064530 == 119:
    			gotoNext = 4064930
    			_ = gotoNext == 4064930
    			p.wrappedErrs = append(p.wrappedErrs, argNum_4061440)
    			gotoNext = 4065014
    			gotoNext = 4061615
    		case verb_4064530 == 118:
    			gotoNext = 4065014
    			_ = gotoNext == 4065014
    			p.fmt.sharpV = p.fmt.sharp
    			p.fmt.sharp = false
    		...
    		default:
    			gotoNext = 4065194
    			_ = gotoNext == 4065194
    			p.printArg(a[argNum_4061440], verb_4064530)
    			argNum_4061440++
    			gotoNext = 4061615
    		}
    		gotoNext = 4061615
    	...
    	_ = gotoNext == 4065446
    	if !p.reordered && argNum_4061440 < len(a) {
    		gotoNext = 4065481
    		_ = gotoNext == 4065481
    		p.fmt.clearflags()
    		p.buf.writeString("%!(EXTRA ")
    		if 0 < len(a[argNum_4061440:]) {
    			gotoNext = 4065808
    			_ = gotoNext == 4065808
    			i_4065543, arg_4065546 = 0, a[argNum_4061440:][0]
    			gotoNext = 4065809
    			_ = gotoNext == 4065809
    			if i_4065543 < len(a[argNum_4061440:]) {
    				gotoNext = 4065570
    				_ = gotoNext == 4065570
    				arg_4065546 = a[argNum_4061440:][i_4065543]
    				if i_4065543 > 0 {
    					gotoNext = 4065584
    					_ = gotoNext == 4065584
    					p.buf.writeString(", ")
    				...
    				if arg_4065546 == nil {
    					...
    					gotoNext = 4065698
    					_ = gotoNext == 4065698
    					p.buf.writeString(reflect.TypeOf(arg_4065546).String())
    					p.buf.writeByte(61)
    					p.printArg(arg_4065546, 118)
    					_ = 0
    					gotoNext = 4065543
    				}
    				_ = gotoNext == 4065543
