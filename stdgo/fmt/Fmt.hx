...
/**
    /|*{
    	end_3988901 = len(format)
    	argNum_3988921 = 0
    	afterIndex_3988992 = false
    	p.reordered = false
    	gotoNext = 3989083
    	_ = gotoNext == 3989083
    	i_3989100 = 0
    	...
    	gotoNext = 3989096
    	_ = gotoNext == 3989096
    	if !formatLoopBreak && (i_3989100 < end_3988901) {
    		gotoNext = 3989117
    		_ = gotoNext == 3989117
    		p.goodArgNum = true
    		lasti_3989143 = i_3989100
    		_ = 0
    		gotoNext = 3989156
    		_ = gotoNext == 3989156
    		if i_3989100 < end_3988901 && format[i_3989100] != 37 {
    			gotoNext = 3989188
    			_ = gotoNext == 3989188
    			i_3989100++
    			gotoNext = 3989156
    		...
    		_ = gotoNext == 3989203
    		if i_3989100 > lasti_3989143 {
    			gotoNext = 3989216
    			_ = gotoNext == 3989216
    			p.buf.writeString(format[lasti_3989143:i_3989100])
    			gotoNext = 3989262
    		} else {
    			gotoNext = 3989262
    		}
    		_ = gotoNext == 3989262
    		if i_3989100 >= end_3988901 {
    			gotoNext = 3989274
    			_ = gotoNext == 3989274
    			gotoNext = 3992927
    			gotoNext = 3989350
    		...
    		gotoNext = 3989416
    		_ = gotoNext == 3989416
    		if !simpleFormatBreak && (i_3989100 < end_3988901) {
    			gotoNext = 3989435
    			_ = gotoNext == 3989435
    			c_3989440 = format[i_3989100]
    			gotoNext = 3989458
    			_ = gotoNext == 3989458
    			switch c_3989440 {
    			case 35:
    			...
    			default:
    				gotoNext = 3989760
    				_ = gotoNext == 3989760
    				if 97 <= c_3989440 && c_3989440 <= 122 && argNum_3988921 < len(a) {
    					gotoNext = 3989937
    					_ = gotoNext == 3989937
    					gotoNext = 3989944
    					_ = gotoNext == 3989944
    					...
    					case 119:
    						gotoNext = 3989960
    						_ = gotoNext == 3989960
    						p.wrappedErrs = append(p.wrappedErrs, argNum_3988921)
    						gotoNext = 3990045
    						gotoNext = 3990230
    					case 118:
    						gotoNext = 3990045
    					...
    					_ = gotoNext == 3990230
    					p.printArg(a[argNum_3988921], rune(c_3989440))
    					argNum_3988921++
    					i_3989100++
    					gotoNext = 3989096
    					gotoNext = 3990395
    		...
    		_ = gotoNext == 3990470
    		argNum_3988921, i_3989100, afterIndex_3988992 = p.argNumber(argNum_3988921, format, i_3989100, len(a))
    		if i_3989100 < end_3988901 && format[i_3989100] == 42 {
    			gotoNext = 3990590
    			_ = gotoNext == 3990590
    			i_3989100++
    			p.fmt.wid, p.fmt.widPresent, argNum_3988921 = intFromArg(a, argNum_3988921)
    			if !p.fmt.widPresent {
    				gotoNext = 3990687
    				_ = gotoNext == 3990687
    			...
    			gotoNext = 3990997
    			_ = gotoNext == 3990997
    			p.fmt.wid, p.fmt.widPresent, i_3989100 = parsenum(format, i_3989100, end_3988901)
    			if afterIndex_3988992 && p.fmt.widPresent {
    				gotoNext = 3991097
    				_ = gotoNext == 3991097
    				p.goodArgNum = false
    				gotoNext = 3991175
    		...
    		_ = gotoNext == 3991175
    		if i_3989100+1 < end_3988901 && format[i_3989100] == 46 {
    			gotoNext = 3991208
    			_ = gotoNext == 3991208
    			i_3989100++
    			if afterIndex_3988992 {
    				gotoNext = 3991234
    				_ = gotoNext == 3991234
    				p.goodArgNum = false
    				gotoNext = 3991282
    			...
    			if i_3989100 < end_3988901 && format[i_3989100] == 42 {
    				...
    				_ = gotoNext == 3991379
    				i_3989100++
    				p.fmt.prec, p.fmt.precPresent, argNum_3988921 = intFromArg(a, argNum_3988921)
    				if p.fmt.prec < 0 {
    					gotoNext = 3991530
    					_ = gotoNext == 3991530
    					p.fmt.prec = 0
    				...
    				gotoNext = 3991694
    				_ = gotoNext == 3991694
    				p.fmt.prec, p.fmt.precPresent, i_3989100 = parsenum(format, i_3989100, end_3988901)
    				if !p.fmt.precPresent {
    					gotoNext = 3991786
    					_ = gotoNext == 3991786
    					p.fmt.prec = 0
    		...
    		_ = gotoNext == 3992011
    		verb_3992011, size_3992017 = rune(format[i_3989100]), 1
    		if verb_3992011 >= 128 {
    			gotoNext = 3992071
    			_ = gotoNext == 3992071
    			verb_3992011, size_3992017 = utf8.DecodeRuneInString(format[i_3989100:])
    			gotoNext = 3992131
    		} else {
    			gotoNext = 3992131
    		}
    		_ = gotoNext == 3992131
    		i_3989100 += size_3992017
    		gotoNext = 3992144
    		_ = gotoNext == 3992144
    		switch {
    		case verb_3992011 == 37:
    			gotoNext = 3992155
    			_ = gotoNext == 3992155
    			p.buf.writeByte(37)
    			gotoNext = 3989096
    		case !p.goodArgNum:
    			gotoNext = 3992265
    			_ = gotoNext == 3992265
    			p.badArgNum(verb_3992011)
    			gotoNext = 3989096
    		case argNum_3988921 >= len(a):
    			gotoNext = 3992308
    			_ = gotoNext == 3992308
    			p.missingArg(verb_3992011)
    			gotoNext = 3989096
    		case verb_3992011 == 119:
    			gotoNext = 3992411
    			_ = gotoNext == 3992411
    			p.wrappedErrs = append(p.wrappedErrs, argNum_3988921)
    			gotoNext = 3992495
    			gotoNext = 3989096
    		case verb_3992011 == 118:
    			gotoNext = 3992495
    			_ = gotoNext == 3992495
    			p.fmt.sharpV = p.fmt.sharp
    			p.fmt.sharp = false
    		...
    		default:
    			gotoNext = 3992675
    			_ = gotoNext == 3992675
    			p.printArg(a[argNum_3988921], verb_3992011)
    			argNum_3988921++
    			gotoNext = 3989096
    		}
    		gotoNext = 3989096
    	...
    	_ = gotoNext == 3992927
    	if !p.reordered && argNum_3988921 < len(a) {
    		gotoNext = 3992962
    		_ = gotoNext == 3992962
    		p.fmt.clearflags()
    		p.buf.writeString("%!(EXTRA ")
    		if 0 < len(a[argNum_3988921:]) {
    			gotoNext = 3993289
    			_ = gotoNext == 3993289
    			i_3993024, arg_3993027 = 0, a[argNum_3988921:][0]
    			gotoNext = 3993290
    			_ = gotoNext == 3993290
    			if i_3993024 < len(a[argNum_3988921:]) {
    				gotoNext = 3993051
    				_ = gotoNext == 3993051
    				arg_3993027 = a[argNum_3988921:][i_3993024]
    				if i_3993024 > 0 {
    					gotoNext = 3993065
    					_ = gotoNext == 3993065
    					p.buf.writeString(", ")
    				...
    				if arg_3993027 == nil {
    					...
    					gotoNext = 3993179
    					_ = gotoNext == 3993179
    					p.buf.writeString(reflect.TypeOf(arg_3993027).String())
    					p.buf.writeByte(61)
    					p.printArg(arg_3993027, 118)
    					_ = 0
    					gotoNext = 3993024
    				}
    				_ = gotoNext == 3993024
