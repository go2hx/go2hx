...
/**
    /|*{
    	end_4021494 = len(format)
    	argNum_4021514 = 0
    	afterIndex_4021585 = false
    	p.reordered = false
    	gotoNext = 4021676
    	_ = gotoNext == 4021676
    	i_4021693 = 0
    	...
    	gotoNext = 4021689
    	_ = gotoNext == 4021689
    	if !formatLoopBreak && (i_4021693 < end_4021494) {
    		gotoNext = 4021710
    		_ = gotoNext == 4021710
    		p.goodArgNum = true
    		lasti_4021736 = i_4021693
    		_ = 0
    		gotoNext = 4021749
    		_ = gotoNext == 4021749
    		if i_4021693 < end_4021494 && format[i_4021693] != 37 {
    			gotoNext = 4021781
    			_ = gotoNext == 4021781
    			i_4021693++
    			gotoNext = 4021749
    		...
    		_ = gotoNext == 4021796
    		if i_4021693 > lasti_4021736 {
    			gotoNext = 4021809
    			_ = gotoNext == 4021809
    			p.buf.writeString(format[lasti_4021736:i_4021693])
    			gotoNext = 4021855
    		} else {
    			gotoNext = 4021855
    		}
    		_ = gotoNext == 4021855
    		if i_4021693 >= end_4021494 {
    			gotoNext = 4021867
    			_ = gotoNext == 4021867
    			gotoNext = 4025520
    			gotoNext = 4021943
    		...
    		gotoNext = 4022009
    		_ = gotoNext == 4022009
    		if !simpleFormatBreak && (i_4021693 < end_4021494) {
    			gotoNext = 4022028
    			_ = gotoNext == 4022028
    			c_4022033 = format[i_4021693]
    			gotoNext = 4022051
    			_ = gotoNext == 4022051
    			switch c_4022033 {
    			case 35:
    			...
    			default:
    				gotoNext = 4022353
    				_ = gotoNext == 4022353
    				if 97 <= c_4022033 && c_4022033 <= 122 && argNum_4021514 < len(a) {
    					gotoNext = 4022530
    					_ = gotoNext == 4022530
    					gotoNext = 4022537
    					_ = gotoNext == 4022537
    					...
    					case 119:
    						gotoNext = 4022553
    						_ = gotoNext == 4022553
    						p.wrappedErrs = append(p.wrappedErrs, argNum_4021514)
    						gotoNext = 4022638
    						gotoNext = 4022823
    					case 118:
    						gotoNext = 4022638
    					...
    					_ = gotoNext == 4022823
    					p.printArg(a[argNum_4021514], rune(c_4022033))
    					argNum_4021514++
    					i_4021693++
    					gotoNext = 4021689
    					gotoNext = 4022988
    		...
    		_ = gotoNext == 4023063
    		argNum_4021514, i_4021693, afterIndex_4021585 = p.argNumber(argNum_4021514, format, i_4021693, len(a))
    		if i_4021693 < end_4021494 && format[i_4021693] == 42 {
    			gotoNext = 4023183
    			_ = gotoNext == 4023183
    			i_4021693++
    			p.fmt.wid, p.fmt.widPresent, argNum_4021514 = intFromArg(a, argNum_4021514)
    			if !p.fmt.widPresent {
    				gotoNext = 4023280
    				_ = gotoNext == 4023280
    			...
    			gotoNext = 4023590
    			_ = gotoNext == 4023590
    			p.fmt.wid, p.fmt.widPresent, i_4021693 = parsenum(format, i_4021693, end_4021494)
    			if afterIndex_4021585 && p.fmt.widPresent {
    				gotoNext = 4023690
    				_ = gotoNext == 4023690
    				p.goodArgNum = false
    				gotoNext = 4023768
    		...
    		_ = gotoNext == 4023768
    		if i_4021693+1 < end_4021494 && format[i_4021693] == 46 {
    			gotoNext = 4023801
    			_ = gotoNext == 4023801
    			i_4021693++
    			if afterIndex_4021585 {
    				gotoNext = 4023827
    				_ = gotoNext == 4023827
    				p.goodArgNum = false
    				gotoNext = 4023875
    			...
    			if i_4021693 < end_4021494 && format[i_4021693] == 42 {
    				...
    				_ = gotoNext == 4023972
    				i_4021693++
    				p.fmt.prec, p.fmt.precPresent, argNum_4021514 = intFromArg(a, argNum_4021514)
    				if p.fmt.prec < 0 {
    					gotoNext = 4024123
    					_ = gotoNext == 4024123
    					p.fmt.prec = 0
    				...
    				gotoNext = 4024287
    				_ = gotoNext == 4024287
    				p.fmt.prec, p.fmt.precPresent, i_4021693 = parsenum(format, i_4021693, end_4021494)
    				if !p.fmt.precPresent {
    					gotoNext = 4024379
    					_ = gotoNext == 4024379
    					p.fmt.prec = 0
    		...
    		_ = gotoNext == 4024604
    		verb_4024604, size_4024610 = rune(format[i_4021693]), 1
    		if verb_4024604 >= 128 {
    			gotoNext = 4024664
    			_ = gotoNext == 4024664
    			verb_4024604, size_4024610 = utf8.DecodeRuneInString(format[i_4021693:])
    			gotoNext = 4024724
    		} else {
    			gotoNext = 4024724
    		}
    		_ = gotoNext == 4024724
    		i_4021693 += size_4024610
    		gotoNext = 4024737
    		_ = gotoNext == 4024737
    		switch {
    		case verb_4024604 == 37:
    			gotoNext = 4024748
    			_ = gotoNext == 4024748
    			p.buf.writeByte(37)
    			gotoNext = 4021689
    		case !p.goodArgNum:
    			gotoNext = 4024858
    			_ = gotoNext == 4024858
    			p.badArgNum(verb_4024604)
    			gotoNext = 4021689
    		case argNum_4021514 >= len(a):
    			gotoNext = 4024901
    			_ = gotoNext == 4024901
    			p.missingArg(verb_4024604)
    			gotoNext = 4021689
    		case verb_4024604 == 119:
    			gotoNext = 4025004
    			_ = gotoNext == 4025004
    			p.wrappedErrs = append(p.wrappedErrs, argNum_4021514)
    			gotoNext = 4025088
    			gotoNext = 4021689
    		case verb_4024604 == 118:
    			gotoNext = 4025088
    			_ = gotoNext == 4025088
    			p.fmt.sharpV = p.fmt.sharp
    			p.fmt.sharp = false
    		...
    		default:
    			gotoNext = 4025268
    			_ = gotoNext == 4025268
    			p.printArg(a[argNum_4021514], verb_4024604)
    			argNum_4021514++
    			gotoNext = 4021689
    		}
    		gotoNext = 4021689
    	...
    	_ = gotoNext == 4025520
    	if !p.reordered && argNum_4021514 < len(a) {
    		gotoNext = 4025555
    		_ = gotoNext == 4025555
    		p.fmt.clearflags()
    		p.buf.writeString("%!(EXTRA ")
    		if 0 < len(a[argNum_4021514:]) {
    			gotoNext = 4025882
    			_ = gotoNext == 4025882
    			i_4025617, arg_4025620 = 0, a[argNum_4021514:][0]
    			gotoNext = 4025883
    			_ = gotoNext == 4025883
    			if i_4025617 < len(a[argNum_4021514:]) {
    				gotoNext = 4025644
    				_ = gotoNext == 4025644
    				arg_4025620 = a[argNum_4021514:][i_4025617]
    				if i_4025617 > 0 {
    					gotoNext = 4025658
    					_ = gotoNext == 4025658
    					p.buf.writeString(", ")
    				...
    				if arg_4025620 == nil {
    					...
    					gotoNext = 4025772
    					_ = gotoNext == 4025772
    					p.buf.writeString(reflect.TypeOf(arg_4025620).String())
    					p.buf.writeByte(61)
    					p.printArg(arg_4025620, 118)
    					_ = 0
    					gotoNext = 4025617
    				}
    				_ = gotoNext == 4025617
