...
/**
    /|*{
    	end_4086468 = len(format)
    	argNum_4086488 = 0
    	afterIndex_4086559 = false
    	p.reordered = false
    	gotoNext = 4086650
    	_ = gotoNext == 4086650
    	i_4086667 = 0
    	...
    	gotoNext = 4086663
    	_ = gotoNext == 4086663
    	if !formatLoopBreak && (i_4086667 < end_4086468) {
    		gotoNext = 4086684
    		_ = gotoNext == 4086684
    		p.goodArgNum = true
    		lasti_4086710 = i_4086667
    		_ = 0
    		gotoNext = 4086723
    		_ = gotoNext == 4086723
    		if i_4086667 < end_4086468 && format[i_4086667] != 37 {
    			gotoNext = 4086755
    			_ = gotoNext == 4086755
    			i_4086667++
    			gotoNext = 4086723
    		...
    		_ = gotoNext == 4086770
    		if i_4086667 > lasti_4086710 {
    			gotoNext = 4086783
    			_ = gotoNext == 4086783
    			p.buf.writeString(format[lasti_4086710:i_4086667])
    			gotoNext = 4086829
    		} else {
    			gotoNext = 4086829
    		}
    		_ = gotoNext == 4086829
    		if i_4086667 >= end_4086468 {
    			gotoNext = 4086841
    			_ = gotoNext == 4086841
    			gotoNext = 4090494
    			gotoNext = 4086917
    		...
    		gotoNext = 4086983
    		_ = gotoNext == 4086983
    		if !simpleFormatBreak && (i_4086667 < end_4086468) {
    			gotoNext = 4087002
    			_ = gotoNext == 4087002
    			c_4087007 = format[i_4086667]
    			gotoNext = 4087025
    			_ = gotoNext == 4087025
    			switch c_4087007 {
    			case 35:
    			...
    			default:
    				gotoNext = 4087327
    				_ = gotoNext == 4087327
    				if 97 <= c_4087007 && c_4087007 <= 122 && argNum_4086488 < len(a) {
    					gotoNext = 4087504
    					_ = gotoNext == 4087504
    					gotoNext = 4087511
    					_ = gotoNext == 4087511
    					...
    					case 119:
    						gotoNext = 4087527
    						_ = gotoNext == 4087527
    						p.wrappedErrs = append(p.wrappedErrs, argNum_4086488)
    						gotoNext = 4087612
    						gotoNext = 4087797
    					case 118:
    						gotoNext = 4087612
    					...
    					_ = gotoNext == 4087797
    					p.printArg(a[argNum_4086488], rune(c_4087007))
    					argNum_4086488++
    					i_4086667++
    					gotoNext = 4086663
    					gotoNext = 4087962
    		...
    		_ = gotoNext == 4088037
    		argNum_4086488, i_4086667, afterIndex_4086559 = p.argNumber(argNum_4086488, format, i_4086667, len(a))
    		if i_4086667 < end_4086468 && format[i_4086667] == 42 {
    			gotoNext = 4088157
    			_ = gotoNext == 4088157
    			i_4086667++
    			p.fmt.wid, p.fmt.widPresent, argNum_4086488 = intFromArg(a, argNum_4086488)
    			if !p.fmt.widPresent {
    				gotoNext = 4088254
    				_ = gotoNext == 4088254
    			...
    			gotoNext = 4088564
    			_ = gotoNext == 4088564
    			p.fmt.wid, p.fmt.widPresent, i_4086667 = parsenum(format, i_4086667, end_4086468)
    			if afterIndex_4086559 && p.fmt.widPresent {
    				gotoNext = 4088664
    				_ = gotoNext == 4088664
    				p.goodArgNum = false
    				gotoNext = 4088742
    		...
    		_ = gotoNext == 4088742
    		if i_4086667+1 < end_4086468 && format[i_4086667] == 46 {
    			gotoNext = 4088775
    			_ = gotoNext == 4088775
    			i_4086667++
    			if afterIndex_4086559 {
    				gotoNext = 4088801
    				_ = gotoNext == 4088801
    				p.goodArgNum = false
    				gotoNext = 4088849
    			...
    			if i_4086667 < end_4086468 && format[i_4086667] == 42 {
    				...
    				_ = gotoNext == 4088946
    				i_4086667++
    				p.fmt.prec, p.fmt.precPresent, argNum_4086488 = intFromArg(a, argNum_4086488)
    				if p.fmt.prec < 0 {
    					gotoNext = 4089097
    					_ = gotoNext == 4089097
    					p.fmt.prec = 0
    				...
    				gotoNext = 4089261
    				_ = gotoNext == 4089261
    				p.fmt.prec, p.fmt.precPresent, i_4086667 = parsenum(format, i_4086667, end_4086468)
    				if !p.fmt.precPresent {
    					gotoNext = 4089353
    					_ = gotoNext == 4089353
    					p.fmt.prec = 0
    		...
    		_ = gotoNext == 4089578
    		verb_4089578, size_4089584 = rune(format[i_4086667]), 1
    		if verb_4089578 >= 128 {
    			gotoNext = 4089638
    			_ = gotoNext == 4089638
    			verb_4089578, size_4089584 = utf8.DecodeRuneInString(format[i_4086667:])
    			gotoNext = 4089698
    		} else {
    			gotoNext = 4089698
    		}
    		_ = gotoNext == 4089698
    		i_4086667 += size_4089584
    		gotoNext = 4089711
    		_ = gotoNext == 4089711
    		switch {
    		case verb_4089578 == 37:
    			gotoNext = 4089722
    			_ = gotoNext == 4089722
    			p.buf.writeByte(37)
    			gotoNext = 4086663
    		case !p.goodArgNum:
    			gotoNext = 4089832
    			_ = gotoNext == 4089832
    			p.badArgNum(verb_4089578)
    			gotoNext = 4086663
    		case argNum_4086488 >= len(a):
    			gotoNext = 4089875
    			_ = gotoNext == 4089875
    			p.missingArg(verb_4089578)
    			gotoNext = 4086663
    		case verb_4089578 == 119:
    			gotoNext = 4089978
    			_ = gotoNext == 4089978
    			p.wrappedErrs = append(p.wrappedErrs, argNum_4086488)
    			gotoNext = 4090062
    			gotoNext = 4086663
    		case verb_4089578 == 118:
    			gotoNext = 4090062
    			_ = gotoNext == 4090062
    			p.fmt.sharpV = p.fmt.sharp
    			p.fmt.sharp = false
    		...
    		default:
    			gotoNext = 4090242
    			_ = gotoNext == 4090242
    			p.printArg(a[argNum_4086488], verb_4089578)
    			argNum_4086488++
    			gotoNext = 4086663
    		}
    		gotoNext = 4086663
    	...
    	_ = gotoNext == 4090494
    	if !p.reordered && argNum_4086488 < len(a) {
    		gotoNext = 4090529
    		_ = gotoNext == 4090529
    		p.fmt.clearflags()
    		p.buf.writeString("%!(EXTRA ")
    		if 0 < len(a[argNum_4086488:]) {
    			gotoNext = 4090856
    			_ = gotoNext == 4090856
    			i_4090591, arg_4090594 = 0, a[argNum_4086488:][0]
    			gotoNext = 4090857
    			_ = gotoNext == 4090857
    			if i_4090591 < len(a[argNum_4086488:]) {
    				gotoNext = 4090618
    				_ = gotoNext == 4090618
    				arg_4090594 = a[argNum_4086488:][i_4090591]
    				if i_4090591 > 0 {
    					gotoNext = 4090632
    					_ = gotoNext == 4090632
    					p.buf.writeString(", ")
    				...
    				if arg_4090594 == nil {
    					...
    					gotoNext = 4090746
    					_ = gotoNext == 4090746
    					p.buf.writeString(reflect.TypeOf(arg_4090594).String())
    					p.buf.writeByte(61)
    					p.printArg(arg_4090594, 118)
    					_ = 0
    					gotoNext = 4090591
    				}
    				_ = gotoNext == 4090591
