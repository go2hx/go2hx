...
/**
    /|*{
    	end_4081227 = len(format)
    	argNum_4081247 = 0
    	afterIndex_4081318 = false
    	p.reordered = false
    	gotoNext = 4081409
    	_ = gotoNext == 4081409
    	i_4081426 = 0
    	...
    	gotoNext = 4081422
    	_ = gotoNext == 4081422
    	if !formatLoopBreak && (i_4081426 < end_4081227) {
    		gotoNext = 4081443
    		_ = gotoNext == 4081443
    		p.goodArgNum = true
    		lasti_4081469 = i_4081426
    		_ = 0
    		gotoNext = 4081482
    		_ = gotoNext == 4081482
    		if i_4081426 < end_4081227 && format[i_4081426] != 37 {
    			gotoNext = 4081514
    			_ = gotoNext == 4081514
    			i_4081426++
    			gotoNext = 4081482
    		...
    		_ = gotoNext == 4081529
    		if i_4081426 > lasti_4081469 {
    			gotoNext = 4081542
    			_ = gotoNext == 4081542
    			p.buf.writeString(format[lasti_4081469:i_4081426])
    			gotoNext = 4081588
    		} else {
    			gotoNext = 4081588
    		}
    		_ = gotoNext == 4081588
    		if i_4081426 >= end_4081227 {
    			gotoNext = 4081600
    			_ = gotoNext == 4081600
    			gotoNext = 4085253
    			gotoNext = 4081676
    		...
    		gotoNext = 4081742
    		_ = gotoNext == 4081742
    		if !simpleFormatBreak && (i_4081426 < end_4081227) {
    			gotoNext = 4081761
    			_ = gotoNext == 4081761
    			c_4081766 = format[i_4081426]
    			_ = 0
    			gotoNext = 4081784
    			_ = gotoNext == 4081784
    			switch c_4081766 {
    			...
    			default:
    				gotoNext = 4082086
    				_ = gotoNext == 4082086
    				if 97 <= c_4081766 && c_4081766 <= 122 && argNum_4081247 < len(a) {
    					gotoNext = 4082263
    					_ = gotoNext == 4082263
    					_ = 0
    					gotoNext = 4082270
    					...
    					case 119:
    						gotoNext = 4082286
    						_ = gotoNext == 4082286
    						p.wrappedErrs = append(p.wrappedErrs, argNum_4081247)
    						gotoNext = 4082371
    						gotoNext = 4082556
    					case 118:
    						gotoNext = 4082371
    					...
    					_ = gotoNext == 4082556
    					p.printArg(a[argNum_4081247], rune(c_4081766))
    					argNum_4081247++
    					i_4081426++
    					gotoNext = 4081422
    					gotoNext = 4082721
    		...
    		_ = gotoNext == 4082796
    		argNum_4081247, i_4081426, afterIndex_4081318 = p.argNumber(argNum_4081247, format, i_4081426, len(a))
    		if i_4081426 < end_4081227 && format[i_4081426] == 42 {
    			gotoNext = 4082916
    			_ = gotoNext == 4082916
    			i_4081426++
    			p.fmt.wid, p.fmt.widPresent, argNum_4081247 = intFromArg(a, argNum_4081247)
    			if !p.fmt.widPresent {
    				gotoNext = 4083013
    				_ = gotoNext == 4083013
    			...
    			gotoNext = 4083323
    			_ = gotoNext == 4083323
    			p.fmt.wid, p.fmt.widPresent, i_4081426 = parsenum(format, i_4081426, end_4081227)
    			if afterIndex_4081318 && p.fmt.widPresent {
    				gotoNext = 4083423
    				_ = gotoNext == 4083423
    				p.goodArgNum = false
    				gotoNext = 4083501
    		...
    		_ = gotoNext == 4083501
    		if i_4081426+1 < end_4081227 && format[i_4081426] == 46 {
    			gotoNext = 4083534
    			_ = gotoNext == 4083534
    			i_4081426++
    			if afterIndex_4081318 {
    				gotoNext = 4083560
    				_ = gotoNext == 4083560
    				p.goodArgNum = false
    				gotoNext = 4083608
    			...
    			if i_4081426 < end_4081227 && format[i_4081426] == 42 {
    				...
    				_ = gotoNext == 4083705
    				i_4081426++
    				p.fmt.prec, p.fmt.precPresent, argNum_4081247 = intFromArg(a, argNum_4081247)
    				if p.fmt.prec < 0 {
    					gotoNext = 4083856
    					_ = gotoNext == 4083856
    					p.fmt.prec = 0
    				...
    				gotoNext = 4084020
    				_ = gotoNext == 4084020
    				p.fmt.prec, p.fmt.precPresent, i_4081426 = parsenum(format, i_4081426, end_4081227)
    				if !p.fmt.precPresent {
    					gotoNext = 4084112
    					_ = gotoNext == 4084112
    					p.fmt.prec = 0
    		...
    		_ = gotoNext == 4084337
    		verb_4084337, size_4084343 = rune(format[i_4081426]), 1
    		if verb_4084337 >= 128 {
    			gotoNext = 4084397
    			_ = gotoNext == 4084397
    			verb_4084337, size_4084343 = utf8.DecodeRuneInString(format[i_4081426:])
    			gotoNext = 4084457
    		} else {
    			gotoNext = 4084457
    		}
    		_ = gotoNext == 4084457
    		i_4081426 += size_4084343
    		_ = 0
    		gotoNext = 4084470
    		_ = gotoNext == 4084470
    		switch {
    		case verb_4084337 == 37:
    			gotoNext = 4084481
    			_ = gotoNext == 4084481
    			p.buf.writeByte(37)
    			gotoNext = 4085253
    		case !p.goodArgNum:
    			gotoNext = 4084591
    			_ = gotoNext == 4084591
    			p.badArgNum(verb_4084337)
    			gotoNext = 4085253
    		case argNum_4081247 >= len(a):
    			gotoNext = 4084634
    			_ = gotoNext == 4084634
    			p.missingArg(verb_4084337)
    			gotoNext = 4085253
    		case verb_4084337 == 119:
    			gotoNext = 4084737
    			_ = gotoNext == 4084737
    			p.wrappedErrs = append(p.wrappedErrs, argNum_4081247)
    			gotoNext = 4084821
    			gotoNext = 4085253
    		case verb_4084337 == 118:
    			gotoNext = 4084821
    			_ = gotoNext == 4084821
    			p.fmt.sharpV = p.fmt.sharp
    			p.fmt.sharp = false
    		...
    		default:
    			gotoNext = 4085001
    			_ = gotoNext == 4085001
    			p.printArg(a[argNum_4081247], verb_4084337)
    			argNum_4081247++
    			gotoNext = 4085253
    		}
    		gotoNext = 4081422
    	...
    	_ = gotoNext == 4085253
    	if !p.reordered && argNum_4081247 < len(a) {
    		gotoNext = 4085288
    		_ = gotoNext == 4085288
    		p.fmt.clearflags()
    		p.buf.writeString("%!(EXTRA ")
    		if 0 < len(a[argNum_4081247:]) {
    			gotoNext = 4085615
    			_ = gotoNext == 4085615
    			i_4085350, arg_4085353 = 0, a[argNum_4081247:][0]
    			gotoNext = 4085616
    			_ = gotoNext == 4085616
    			if i_4085350 < len(a[argNum_4081247:]) {
    				gotoNext = 4085377
    				_ = gotoNext == 4085377
    				arg_4085353 = a[argNum_4081247:][i_4085350]
    				if i_4085350 > 0 {
    					gotoNext = 4085391
    					_ = gotoNext == 4085391
    					p.buf.writeString(", ")
    				...
    				if arg_4085353 == nil {
    					...
    					gotoNext = 4085505
    					_ = gotoNext == 4085505
    					p.buf.writeString(reflect.TypeOf(arg_4085353).String())
    					p.buf.writeByte(61)
    					p.printArg(arg_4085353, 118)
    					gotoNext = 4085350
    				}
    				_ = gotoNext == 4085350
    				i_4085350++
