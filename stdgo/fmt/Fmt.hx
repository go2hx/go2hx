...
/**
    /|*{
    	end_4065028 = len(format)
    	argNum_4065048 = 0
    	afterIndex_4065119 = false
    	p.reordered = false
    	gotoNext = 4065210
    	_ = gotoNext == 4065210
    	i_4065227 = 0
    	...
    	gotoNext = 4065223
    	_ = gotoNext == 4065223
    	if !formatLoopBreak && (i_4065227 < end_4065028) {
    		gotoNext = 4065244
    		_ = gotoNext == 4065244
    		p.goodArgNum = true
    		lasti_4065270 = i_4065227
    		_ = 0
    		gotoNext = 4065283
    		_ = gotoNext == 4065283
    		if i_4065227 < end_4065028 && format[i_4065227] != 37 {
    			gotoNext = 4065315
    			_ = gotoNext == 4065315
    			i_4065227++
    			gotoNext = 4065283
    		...
    		_ = gotoNext == 4065330
    		if i_4065227 > lasti_4065270 {
    			gotoNext = 4065343
    			_ = gotoNext == 4065343
    			p.buf.writeString(format[lasti_4065270:i_4065227])
    			gotoNext = 4065389
    		} else {
    			gotoNext = 4065389
    		}
    		_ = gotoNext == 4065389
    		if i_4065227 >= end_4065028 {
    			gotoNext = 4065401
    			_ = gotoNext == 4065401
    			gotoNext = 4069054
    			gotoNext = 4065477
    		...
    		gotoNext = 4065543
    		_ = gotoNext == 4065543
    		if !simpleFormatBreak && (i_4065227 < end_4065028) {
    			gotoNext = 4065562
    			_ = gotoNext == 4065562
    			c_4065567 = format[i_4065227]
    			gotoNext = 4065585
    			_ = gotoNext == 4065585
    			switch c_4065567 {
    			case 35:
    			...
    			default:
    				gotoNext = 4065887
    				_ = gotoNext == 4065887
    				if 97 <= c_4065567 && c_4065567 <= 122 && argNum_4065048 < len(a) {
    					gotoNext = 4066064
    					_ = gotoNext == 4066064
    					gotoNext = 4066071
    					_ = gotoNext == 4066071
    					...
    					case 119:
    						gotoNext = 4066087
    						_ = gotoNext == 4066087
    						p.wrappedErrs = append(p.wrappedErrs, argNum_4065048)
    						gotoNext = 4066172
    						gotoNext = 4066357
    					case 118:
    						gotoNext = 4066172
    					...
    					_ = gotoNext == 4066357
    					p.printArg(a[argNum_4065048], rune(c_4065567))
    					argNum_4065048++
    					i_4065227++
    					gotoNext = 4065223
    					gotoNext = 4066522
    		...
    		_ = gotoNext == 4066597
    		argNum_4065048, i_4065227, afterIndex_4065119 = p.argNumber(argNum_4065048, format, i_4065227, len(a))
    		if i_4065227 < end_4065028 && format[i_4065227] == 42 {
    			gotoNext = 4066717
    			_ = gotoNext == 4066717
    			i_4065227++
    			p.fmt.wid, p.fmt.widPresent, argNum_4065048 = intFromArg(a, argNum_4065048)
    			if !p.fmt.widPresent {
    				gotoNext = 4066814
    				_ = gotoNext == 4066814
    			...
    			gotoNext = 4067124
    			_ = gotoNext == 4067124
    			p.fmt.wid, p.fmt.widPresent, i_4065227 = parsenum(format, i_4065227, end_4065028)
    			if afterIndex_4065119 && p.fmt.widPresent {
    				gotoNext = 4067224
    				_ = gotoNext == 4067224
    				p.goodArgNum = false
    				gotoNext = 4067302
    		...
    		_ = gotoNext == 4067302
    		if i_4065227+1 < end_4065028 && format[i_4065227] == 46 {
    			gotoNext = 4067335
    			_ = gotoNext == 4067335
    			i_4065227++
    			if afterIndex_4065119 {
    				gotoNext = 4067361
    				_ = gotoNext == 4067361
    				p.goodArgNum = false
    				gotoNext = 4067409
    			...
    			if i_4065227 < end_4065028 && format[i_4065227] == 42 {
    				...
    				_ = gotoNext == 4067506
    				i_4065227++
    				p.fmt.prec, p.fmt.precPresent, argNum_4065048 = intFromArg(a, argNum_4065048)
    				if p.fmt.prec < 0 {
    					gotoNext = 4067657
    					_ = gotoNext == 4067657
    					p.fmt.prec = 0
    				...
    				gotoNext = 4067821
    				_ = gotoNext == 4067821
    				p.fmt.prec, p.fmt.precPresent, i_4065227 = parsenum(format, i_4065227, end_4065028)
    				if !p.fmt.precPresent {
    					gotoNext = 4067913
    					_ = gotoNext == 4067913
    					p.fmt.prec = 0
    		...
    		_ = gotoNext == 4068138
    		verb_4068138, size_4068144 = rune(format[i_4065227]), 1
    		if verb_4068138 >= 128 {
    			gotoNext = 4068198
    			_ = gotoNext == 4068198
    			verb_4068138, size_4068144 = utf8.DecodeRuneInString(format[i_4065227:])
    			gotoNext = 4068258
    		} else {
    			gotoNext = 4068258
    		}
    		_ = gotoNext == 4068258
    		i_4065227 += size_4068144
    		gotoNext = 4068271
    		_ = gotoNext == 4068271
    		switch {
    		case verb_4068138 == 37:
    			gotoNext = 4068282
    			_ = gotoNext == 4068282
    			p.buf.writeByte(37)
    			gotoNext = 4065223
    		case !p.goodArgNum:
    			gotoNext = 4068392
    			_ = gotoNext == 4068392
    			p.badArgNum(verb_4068138)
    			gotoNext = 4065223
    		case argNum_4065048 >= len(a):
    			gotoNext = 4068435
    			_ = gotoNext == 4068435
    			p.missingArg(verb_4068138)
    			gotoNext = 4065223
    		case verb_4068138 == 119:
    			gotoNext = 4068538
    			_ = gotoNext == 4068538
    			p.wrappedErrs = append(p.wrappedErrs, argNum_4065048)
    			gotoNext = 4068622
    			gotoNext = 4065223
    		case verb_4068138 == 118:
    			gotoNext = 4068622
    			_ = gotoNext == 4068622
    			p.fmt.sharpV = p.fmt.sharp
    			p.fmt.sharp = false
    		...
    		default:
    			gotoNext = 4068802
    			_ = gotoNext == 4068802
    			p.printArg(a[argNum_4065048], verb_4068138)
    			argNum_4065048++
    			gotoNext = 4065223
    		}
    		gotoNext = 4065223
    	...
    	_ = gotoNext == 4069054
    	if !p.reordered && argNum_4065048 < len(a) {
    		gotoNext = 4069089
    		_ = gotoNext == 4069089
    		p.fmt.clearflags()
    		p.buf.writeString("%!(EXTRA ")
    		if 0 < len(a[argNum_4065048:]) {
    			gotoNext = 4069416
    			_ = gotoNext == 4069416
    			i_4069151, arg_4069154 = 0, a[argNum_4065048:][0]
    			gotoNext = 4069417
    			_ = gotoNext == 4069417
    			if i_4069151 < len(a[argNum_4065048:]) {
    				gotoNext = 4069178
    				_ = gotoNext == 4069178
    				arg_4069154 = a[argNum_4065048:][i_4069151]
    				if i_4069151 > 0 {
    					gotoNext = 4069192
    					_ = gotoNext == 4069192
    					p.buf.writeString(", ")
    				...
    				if arg_4069154 == nil {
    					...
    					gotoNext = 4069306
    					_ = gotoNext == 4069306
    					p.buf.writeString(reflect.TypeOf(arg_4069154).String())
    					p.buf.writeByte(61)
    					p.printArg(arg_4069154, 118)
    					_ = 0
    					gotoNext = 4069151
    				}
    				_ = gotoNext == 4069151
