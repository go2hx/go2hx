...
class T_stringReader_static_extension {
    static public function read(____:T_stringReader, _r:stdgo.Pointer<T_stringReader>, _b:Array<std.UInt>):stdgo.Tuple<StdTypes.Int, stdgo.Error> {
        final _b = ([for (i in _b) i] : stdgo.Slice<stdgo.GoUInt8>);
        return {
            final obj = stdgo._internal.fmt.Fmt_T_stringReader_static_extension.T_stringReader_static_extension.read(____, _r, _b);
            { _0 : obj._0, _1 : obj._1 };
        };
    }
}
/**
    /|*{
    	end_4082479 = len(format)
    	argNum_4082499 = 0
    	afterIndex_4082570 = false
    	p.reordered = false
    	gotoNext = 4082661
    	_ = gotoNext == 4082661
    	i_4082678 = 0
    	...
    	gotoNext = 4082674
    	_ = gotoNext == 4082674
    	if !formatLoopBreak && (i_4082678 < end_4082479) {
    		gotoNext = 4082695
    		_ = gotoNext == 4082695
    		p.goodArgNum = true
    		lasti_4082721 = i_4082678
    		_ = 0
    		gotoNext = 4082734
    		_ = gotoNext == 4082734
    		if i_4082678 < end_4082479 && format[i_4082678] != 37 {
    			gotoNext = 4082766
    			_ = gotoNext == 4082766
    			i_4082678++
    			gotoNext = 4082734
    		...
    		_ = gotoNext == 4082781
    		if i_4082678 > lasti_4082721 {
    			gotoNext = 4082794
    			_ = gotoNext == 4082794
    			p.buf.writeString(format[lasti_4082721:i_4082678])
    			gotoNext = 4082840
    		} else {
    			gotoNext = 4082840
    		}
    		_ = gotoNext == 4082840
    		if i_4082678 >= end_4082479 {
    			gotoNext = 4082852
    			_ = gotoNext == 4082852
    			gotoNext = 4086505
    			gotoNext = 4082928
    		...
    		gotoNext = 4082994
    		_ = gotoNext == 4082994
    		if !simpleFormatBreak && (i_4082678 < end_4082479) {
    			gotoNext = 4083013
    			_ = gotoNext == 4083013
    			c_4083018 = format[i_4082678]
    			gotoNext = 4083036
    			_ = gotoNext == 4083036
    			switch c_4083018 {
    			case 35:
    			...
    			default:
    				gotoNext = 4083338
    				_ = gotoNext == 4083338
    				if 97 <= c_4083018 && c_4083018 <= 122 && argNum_4082499 < len(a) {
    					gotoNext = 4083515
    					_ = gotoNext == 4083515
    					gotoNext = 4083522
    					_ = gotoNext == 4083522
    					...
    					case 119:
    						gotoNext = 4083538
    						_ = gotoNext == 4083538
    						p.wrappedErrs = append(p.wrappedErrs, argNum_4082499)
    						gotoNext = 4083623
    						gotoNext = 4083808
    					case 118:
    						gotoNext = 4083623
    					...
    					_ = gotoNext == 4083808
    					p.printArg(a[argNum_4082499], rune(c_4083018))
    					argNum_4082499++
    					i_4082678++
    					gotoNext = 4082674
    					gotoNext = 4083973
    		...
    		_ = gotoNext == 4084048
    		argNum_4082499, i_4082678, afterIndex_4082570 = p.argNumber(argNum_4082499, format, i_4082678, len(a))
    		if i_4082678 < end_4082479 && format[i_4082678] == 42 {
    			gotoNext = 4084168
    			_ = gotoNext == 4084168
    			i_4082678++
    			p.fmt.wid, p.fmt.widPresent, argNum_4082499 = intFromArg(a, argNum_4082499)
    			if !p.fmt.widPresent {
    				gotoNext = 4084265
    				_ = gotoNext == 4084265
    			...
    			gotoNext = 4084575
    			_ = gotoNext == 4084575
    			p.fmt.wid, p.fmt.widPresent, i_4082678 = parsenum(format, i_4082678, end_4082479)
    			if afterIndex_4082570 && p.fmt.widPresent {
    				gotoNext = 4084675
    				_ = gotoNext == 4084675
    				p.goodArgNum = false
    				gotoNext = 4084753
    		...
    		_ = gotoNext == 4084753
    		if i_4082678+1 < end_4082479 && format[i_4082678] == 46 {
    			gotoNext = 4084786
    			_ = gotoNext == 4084786
    			i_4082678++
    			if afterIndex_4082570 {
    				gotoNext = 4084812
    				_ = gotoNext == 4084812
    				p.goodArgNum = false
    				gotoNext = 4084860
    			...
    			if i_4082678 < end_4082479 && format[i_4082678] == 42 {
    				...
    				_ = gotoNext == 4084957
    				i_4082678++
    				p.fmt.prec, p.fmt.precPresent, argNum_4082499 = intFromArg(a, argNum_4082499)
    				if p.fmt.prec < 0 {
    					gotoNext = 4085108
    					_ = gotoNext == 4085108
    					p.fmt.prec = 0
    				...
    				gotoNext = 4085272
    				_ = gotoNext == 4085272
    				p.fmt.prec, p.fmt.precPresent, i_4082678 = parsenum(format, i_4082678, end_4082479)
    				if !p.fmt.precPresent {
    					gotoNext = 4085364
    					_ = gotoNext == 4085364
    					p.fmt.prec = 0
    		...
    		_ = gotoNext == 4085589
    		verb_4085589, size_4085595 = rune(format[i_4082678]), 1
    		if verb_4085589 >= 128 {
    			gotoNext = 4085649
    			_ = gotoNext == 4085649
    			verb_4085589, size_4085595 = utf8.DecodeRuneInString(format[i_4082678:])
    			gotoNext = 4085709
    		} else {
    			gotoNext = 4085709
    		}
    		_ = gotoNext == 4085709
    		i_4082678 += size_4085595
    		gotoNext = 4085722
    		_ = gotoNext == 4085722
    		switch {
    		case verb_4085589 == 37:
    			gotoNext = 4085733
    			_ = gotoNext == 4085733
    			p.buf.writeByte(37)
    			gotoNext = 4082674
    		case !p.goodArgNum:
    			gotoNext = 4085843
    			_ = gotoNext == 4085843
    			p.badArgNum(verb_4085589)
    			gotoNext = 4082674
    		case argNum_4082499 >= len(a):
    			gotoNext = 4085886
    			_ = gotoNext == 4085886
    			p.missingArg(verb_4085589)
    			gotoNext = 4082674
    		case verb_4085589 == 119:
    			gotoNext = 4085989
    			_ = gotoNext == 4085989
    			p.wrappedErrs = append(p.wrappedErrs, argNum_4082499)
    			gotoNext = 4086073
    			gotoNext = 4082674
    		case verb_4085589 == 118:
    			gotoNext = 4086073
    			_ = gotoNext == 4086073
    			p.fmt.sharpV = p.fmt.sharp
    			p.fmt.sharp = false
    		...
    		default:
    			gotoNext = 4086253
    			_ = gotoNext == 4086253
    			p.printArg(a[argNum_4082499], verb_4085589)
    			argNum_4082499++
    			gotoNext = 4082674
    		}
    		gotoNext = 4082674
    	...
    	_ = gotoNext == 4086505
    	if !p.reordered && argNum_4082499 < len(a) {
    		gotoNext = 4086540
    		_ = gotoNext == 4086540
    		p.fmt.clearflags()
    		p.buf.writeString("%!(EXTRA ")
    		if 0 < len(a[argNum_4082499:]) {
    			gotoNext = 4086867
    			_ = gotoNext == 4086867
    			i_4086602, arg_4086605 = 0, a[argNum_4082499:][0]
    			gotoNext = 4086868
    			_ = gotoNext == 4086868
    			if i_4086602 < len(a[argNum_4082499:]) {
    				gotoNext = 4086629
    				_ = gotoNext == 4086629
    				arg_4086605 = a[argNum_4082499:][i_4086602]
    				if i_4086602 > 0 {
    					gotoNext = 4086643
    					_ = gotoNext == 4086643
    					p.buf.writeString(", ")
    				...
    				if arg_4086605 == nil {
    					...
    					gotoNext = 4086757
    					_ = gotoNext == 4086757
    					p.buf.writeString(reflect.TypeOf(arg_4086605).String())
    					p.buf.writeByte(61)
    					p.printArg(arg_4086605, 118)
    					_ = 0
    					gotoNext = 4086602
    				}
    				_ = gotoNext == 4086602
