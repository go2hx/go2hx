...
/**
    /|*{
    	end_4055755 = len(format)
    	argNum_4055775 = 0
    	afterIndex_4055846 = false
    	p.reordered = false
    	gotoNext = 4055937
    	_ = gotoNext == 4055937
    	i_4055954 = 0
    	...
    	gotoNext = 4055950
    	_ = gotoNext == 4055950
    	if !formatLoopBreak && (i_4055954 < end_4055755) {
    		gotoNext = 4055971
    		_ = gotoNext == 4055971
    		p.goodArgNum = true
    		lasti_4055997 = i_4055954
    		_ = 0
    		gotoNext = 4056010
    		_ = gotoNext == 4056010
    		if i_4055954 < end_4055755 && format[i_4055954] != 37 {
    			gotoNext = 4056042
    			_ = gotoNext == 4056042
    			i_4055954++
    			gotoNext = 4056010
    		...
    		_ = gotoNext == 4056057
    		if i_4055954 > lasti_4055997 {
    			gotoNext = 4056070
    			_ = gotoNext == 4056070
    			p.buf.writeString(format[lasti_4055997:i_4055954])
    			gotoNext = 4056116
    		} else {
    			gotoNext = 4056116
    		}
    		_ = gotoNext == 4056116
    		if i_4055954 >= end_4055755 {
    			gotoNext = 4056128
    			_ = gotoNext == 4056128
    			gotoNext = 4059781
    			gotoNext = 4056204
    		...
    		gotoNext = 4056270
    		_ = gotoNext == 4056270
    		if !simpleFormatBreak && (i_4055954 < end_4055755) {
    			gotoNext = 4056289
    			_ = gotoNext == 4056289
    			c_4056294 = format[i_4055954]
    			gotoNext = 4056312
    			_ = gotoNext == 4056312
    			switch c_4056294 {
    			case 35:
    			...
    			default:
    				gotoNext = 4056614
    				_ = gotoNext == 4056614
    				if 97 <= c_4056294 && c_4056294 <= 122 && argNum_4055775 < len(a) {
    					gotoNext = 4056791
    					_ = gotoNext == 4056791
    					gotoNext = 4056798
    					_ = gotoNext == 4056798
    					...
    					case 119:
    						gotoNext = 4056814
    						_ = gotoNext == 4056814
    						p.wrappedErrs = append(p.wrappedErrs, argNum_4055775)
    						gotoNext = 4056899
    						gotoNext = 4057084
    					case 118:
    						gotoNext = 4056899
    					...
    					_ = gotoNext == 4057084
    					p.printArg(a[argNum_4055775], rune(c_4056294))
    					argNum_4055775++
    					i_4055954++
    					gotoNext = 4055950
    					gotoNext = 4057249
    		...
    		_ = gotoNext == 4057324
    		argNum_4055775, i_4055954, afterIndex_4055846 = p.argNumber(argNum_4055775, format, i_4055954, len(a))
    		if i_4055954 < end_4055755 && format[i_4055954] == 42 {
    			gotoNext = 4057444
    			_ = gotoNext == 4057444
    			i_4055954++
    			p.fmt.wid, p.fmt.widPresent, argNum_4055775 = intFromArg(a, argNum_4055775)
    			if !p.fmt.widPresent {
    				gotoNext = 4057541
    				_ = gotoNext == 4057541
    			...
    			gotoNext = 4057851
    			_ = gotoNext == 4057851
    			p.fmt.wid, p.fmt.widPresent, i_4055954 = parsenum(format, i_4055954, end_4055755)
    			if afterIndex_4055846 && p.fmt.widPresent {
    				gotoNext = 4057951
    				_ = gotoNext == 4057951
    				p.goodArgNum = false
    				gotoNext = 4058029
    		...
    		_ = gotoNext == 4058029
    		if i_4055954+1 < end_4055755 && format[i_4055954] == 46 {
    			gotoNext = 4058062
    			_ = gotoNext == 4058062
    			i_4055954++
    			if afterIndex_4055846 {
    				gotoNext = 4058088
    				_ = gotoNext == 4058088
    				p.goodArgNum = false
    				gotoNext = 4058136
    			...
    			if i_4055954 < end_4055755 && format[i_4055954] == 42 {
    				...
    				_ = gotoNext == 4058233
    				i_4055954++
    				p.fmt.prec, p.fmt.precPresent, argNum_4055775 = intFromArg(a, argNum_4055775)
    				if p.fmt.prec < 0 {
    					gotoNext = 4058384
    					_ = gotoNext == 4058384
    					p.fmt.prec = 0
    				...
    				gotoNext = 4058548
    				_ = gotoNext == 4058548
    				p.fmt.prec, p.fmt.precPresent, i_4055954 = parsenum(format, i_4055954, end_4055755)
    				if !p.fmt.precPresent {
    					gotoNext = 4058640
    					_ = gotoNext == 4058640
    					p.fmt.prec = 0
    		...
    		_ = gotoNext == 4058865
    		verb_4058865, size_4058871 = rune(format[i_4055954]), 1
    		if verb_4058865 >= 128 {
    			gotoNext = 4058925
    			_ = gotoNext == 4058925
    			verb_4058865, size_4058871 = utf8.DecodeRuneInString(format[i_4055954:])
    			gotoNext = 4058985
    		} else {
    			gotoNext = 4058985
    		}
    		_ = gotoNext == 4058985
    		i_4055954 += size_4058871
    		gotoNext = 4058998
    		_ = gotoNext == 4058998
    		switch {
    		case verb_4058865 == 37:
    			gotoNext = 4059009
    			_ = gotoNext == 4059009
    			p.buf.writeByte(37)
    			gotoNext = 4055950
    		case !p.goodArgNum:
    			gotoNext = 4059119
    			_ = gotoNext == 4059119
    			p.badArgNum(verb_4058865)
    			gotoNext = 4055950
    		case argNum_4055775 >= len(a):
    			gotoNext = 4059162
    			_ = gotoNext == 4059162
    			p.missingArg(verb_4058865)
    			gotoNext = 4055950
    		case verb_4058865 == 119:
    			gotoNext = 4059265
    			_ = gotoNext == 4059265
    			p.wrappedErrs = append(p.wrappedErrs, argNum_4055775)
    			gotoNext = 4059349
    			gotoNext = 4055950
    		case verb_4058865 == 118:
    			gotoNext = 4059349
    			_ = gotoNext == 4059349
    			p.fmt.sharpV = p.fmt.sharp
    			p.fmt.sharp = false
    		...
    		default:
    			gotoNext = 4059529
    			_ = gotoNext == 4059529
    			p.printArg(a[argNum_4055775], verb_4058865)
    			argNum_4055775++
    			gotoNext = 4055950
    		}
    		gotoNext = 4055950
    	...
    	_ = gotoNext == 4059781
    	if !p.reordered && argNum_4055775 < len(a) {
    		gotoNext = 4059816
    		_ = gotoNext == 4059816
    		p.fmt.clearflags()
    		p.buf.writeString("%!(EXTRA ")
    		if 0 < len(a[argNum_4055775:]) {
    			gotoNext = 4060143
    			_ = gotoNext == 4060143
    			i_4059878, arg_4059881 = 0, a[argNum_4055775:][0]
    			gotoNext = 4060144
    			_ = gotoNext == 4060144
    			if i_4059878 < len(a[argNum_4055775:]) {
    				gotoNext = 4059905
    				_ = gotoNext == 4059905
    				arg_4059881 = a[argNum_4055775:][i_4059878]
    				if i_4059878 > 0 {
    					gotoNext = 4059919
    					_ = gotoNext == 4059919
    					p.buf.writeString(", ")
    				...
    				if arg_4059881 == nil {
    					...
    					gotoNext = 4060033
    					_ = gotoNext == 4060033
    					p.buf.writeString(reflect.TypeOf(arg_4059881).String())
    					p.buf.writeByte(61)
    					p.printArg(arg_4059881, 118)
    					_ = 0
    					gotoNext = 4059878
    				}
    				_ = gotoNext == 4059878
