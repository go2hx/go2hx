...
/**
    /|*{
    	end_4032374 = len(format)
    	argNum_4032394 = 0
    	afterIndex_4032465 = false
    	p.reordered = false
    	gotoNext = 4032556
    	_ = gotoNext == 4032556
    	i_4032573 = 0
    	...
    	gotoNext = 4032569
    	_ = gotoNext == 4032569
    	if !formatLoopBreak && (i_4032573 < end_4032374) {
    		gotoNext = 4032590
    		_ = gotoNext == 4032590
    		p.goodArgNum = true
    		lasti_4032616 = i_4032573
    		_ = 0
    		gotoNext = 4032629
    		_ = gotoNext == 4032629
    		if i_4032573 < end_4032374 && format[i_4032573] != 37 {
    			gotoNext = 4032661
    			_ = gotoNext == 4032661
    			i_4032573++
    			gotoNext = 4032629
    		...
    		_ = gotoNext == 4032676
    		if i_4032573 > lasti_4032616 {
    			gotoNext = 4032689
    			_ = gotoNext == 4032689
    			p.buf.writeString(format[lasti_4032616:i_4032573])
    			gotoNext = 4032735
    		} else {
    			gotoNext = 4032735
    		}
    		_ = gotoNext == 4032735
    		if i_4032573 >= end_4032374 {
    			gotoNext = 4032747
    			_ = gotoNext == 4032747
    			gotoNext = 4036400
    			gotoNext = 4032823
    		...
    		gotoNext = 4032889
    		_ = gotoNext == 4032889
    		if !simpleFormatBreak && (i_4032573 < end_4032374) {
    			gotoNext = 4032908
    			_ = gotoNext == 4032908
    			c_4032913 = format[i_4032573]
    			gotoNext = 4032931
    			_ = gotoNext == 4032931
    			switch c_4032913 {
    			case 35:
    			...
    			default:
    				gotoNext = 4033233
    				_ = gotoNext == 4033233
    				if 97 <= c_4032913 && c_4032913 <= 122 && argNum_4032394 < len(a) {
    					gotoNext = 4033410
    					_ = gotoNext == 4033410
    					gotoNext = 4033417
    					_ = gotoNext == 4033417
    					...
    					case 119:
    						gotoNext = 4033433
    						_ = gotoNext == 4033433
    						p.wrappedErrs = append(p.wrappedErrs, argNum_4032394)
    						gotoNext = 4033518
    						gotoNext = 4033703
    					case 118:
    						gotoNext = 4033518
    					...
    					_ = gotoNext == 4033703
    					p.printArg(a[argNum_4032394], rune(c_4032913))
    					argNum_4032394++
    					i_4032573++
    					gotoNext = 4032569
    					gotoNext = 4033868
    		...
    		_ = gotoNext == 4033943
    		argNum_4032394, i_4032573, afterIndex_4032465 = p.argNumber(argNum_4032394, format, i_4032573, len(a))
    		if i_4032573 < end_4032374 && format[i_4032573] == 42 {
    			gotoNext = 4034063
    			_ = gotoNext == 4034063
    			i_4032573++
    			p.fmt.wid, p.fmt.widPresent, argNum_4032394 = intFromArg(a, argNum_4032394)
    			if !p.fmt.widPresent {
    				gotoNext = 4034160
    				_ = gotoNext == 4034160
    			...
    			gotoNext = 4034470
    			_ = gotoNext == 4034470
    			p.fmt.wid, p.fmt.widPresent, i_4032573 = parsenum(format, i_4032573, end_4032374)
    			if afterIndex_4032465 && p.fmt.widPresent {
    				gotoNext = 4034570
    				_ = gotoNext == 4034570
    				p.goodArgNum = false
    				gotoNext = 4034648
    		...
    		_ = gotoNext == 4034648
    		if i_4032573+1 < end_4032374 && format[i_4032573] == 46 {
    			gotoNext = 4034681
    			_ = gotoNext == 4034681
    			i_4032573++
    			if afterIndex_4032465 {
    				gotoNext = 4034707
    				_ = gotoNext == 4034707
    				p.goodArgNum = false
    				gotoNext = 4034755
    			...
    			if i_4032573 < end_4032374 && format[i_4032573] == 42 {
    				...
    				_ = gotoNext == 4034852
    				i_4032573++
    				p.fmt.prec, p.fmt.precPresent, argNum_4032394 = intFromArg(a, argNum_4032394)
    				if p.fmt.prec < 0 {
    					gotoNext = 4035003
    					_ = gotoNext == 4035003
    					p.fmt.prec = 0
    				...
    				gotoNext = 4035167
    				_ = gotoNext == 4035167
    				p.fmt.prec, p.fmt.precPresent, i_4032573 = parsenum(format, i_4032573, end_4032374)
    				if !p.fmt.precPresent {
    					gotoNext = 4035259
    					_ = gotoNext == 4035259
    					p.fmt.prec = 0
    		...
    		_ = gotoNext == 4035484
    		verb_4035484, size_4035490 = rune(format[i_4032573]), 1
    		if verb_4035484 >= 128 {
    			gotoNext = 4035544
    			_ = gotoNext == 4035544
    			verb_4035484, size_4035490 = utf8.DecodeRuneInString(format[i_4032573:])
    			gotoNext = 4035604
    		} else {
    			gotoNext = 4035604
    		}
    		_ = gotoNext == 4035604
    		i_4032573 += size_4035490
    		gotoNext = 4035617
    		_ = gotoNext == 4035617
    		switch {
    		case verb_4035484 == 37:
    			gotoNext = 4035628
    			_ = gotoNext == 4035628
    			p.buf.writeByte(37)
    			gotoNext = 4032569
    		case !p.goodArgNum:
    			gotoNext = 4035738
    			_ = gotoNext == 4035738
    			p.badArgNum(verb_4035484)
    			gotoNext = 4032569
    		case argNum_4032394 >= len(a):
    			gotoNext = 4035781
    			_ = gotoNext == 4035781
    			p.missingArg(verb_4035484)
    			gotoNext = 4032569
    		case verb_4035484 == 119:
    			gotoNext = 4035884
    			_ = gotoNext == 4035884
    			p.wrappedErrs = append(p.wrappedErrs, argNum_4032394)
    			gotoNext = 4035968
    			gotoNext = 4032569
    		case verb_4035484 == 118:
    			gotoNext = 4035968
    			_ = gotoNext == 4035968
    			p.fmt.sharpV = p.fmt.sharp
    			p.fmt.sharp = false
    		...
    		default:
    			gotoNext = 4036148
    			_ = gotoNext == 4036148
    			p.printArg(a[argNum_4032394], verb_4035484)
    			argNum_4032394++
    			gotoNext = 4032569
    		}
    		gotoNext = 4032569
    	...
    	_ = gotoNext == 4036400
    	if !p.reordered && argNum_4032394 < len(a) {
    		gotoNext = 4036435
    		_ = gotoNext == 4036435
    		p.fmt.clearflags()
    		p.buf.writeString("%!(EXTRA ")
    		if 0 < len(a[argNum_4032394:]) {
    			gotoNext = 4036762
    			_ = gotoNext == 4036762
    			i_4036497, arg_4036500 = 0, a[argNum_4032394:][0]
    			gotoNext = 4036763
    			_ = gotoNext == 4036763
    			if i_4036497 < len(a[argNum_4032394:]) {
    				gotoNext = 4036524
    				_ = gotoNext == 4036524
    				arg_4036500 = a[argNum_4032394:][i_4036497]
    				if i_4036497 > 0 {
    					gotoNext = 4036538
    					_ = gotoNext == 4036538
    					p.buf.writeString(", ")
    				...
    				if arg_4036500 == nil {
    					...
    					gotoNext = 4036652
    					_ = gotoNext == 4036652
    					p.buf.writeString(reflect.TypeOf(arg_4036500).String())
    					p.buf.writeByte(61)
    					p.printArg(arg_4036500, 118)
    					_ = 0
    					gotoNext = 4036497
    				}
    				_ = gotoNext == 4036497
