...
**/
var naN : stdgo.GoFloat64 = stdgo.math.Math.naN();
/**
    
    
    
**/
var _posInf : stdgo.GoFloat64 = stdgo.math.Math.inf((1 : stdgo.GoInt));
/**
    
    
    
**/
var _negInf : stdgo.GoFloat64 = stdgo.math.Math.inf((-1 : stdgo.GoInt));
/**
...
({ _fmt : ("%v" : stdgo.GoString), _val : stdgo.Go.toInterface((stdgo.Go.setRef(_barray) : stdgo.Ref<stdgo.GoArray<stdgo.fmt_test.Fmt_test.T_renamedUint8>>)), _out : ("&[1 2 3 4 5]" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%v" : stdgo.GoString), _val : stdgo.Go.toInterface((stdgo.Go.setRef(_bslice) : stdgo.Ref<stdgo.Slice<stdgo.fmt_test.Fmt_test.T_renamedUint8>>)), _out : ("&[1 2 3 4 5]" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.fmt_test.Fmt_test.A((1 : stdgo.GoInt), (2u32 : stdgo.GoUInt), ("a" : stdgo.GoString), (new stdgo.Slice<stdgo.GoInt>(2, 2, (1 : stdgo.GoInt), (2 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>)) : stdgo.fmt_test.Fmt_test.A)), _out : ("{1 2 a [1 2]}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%+v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.fmt_test.Fmt_test.A((1 : stdgo.GoInt), (2u32 : stdgo.GoUInt), ("a" : stdgo.GoString), (new stdgo.Slice<stdgo.GoInt>(2, 2, (1 : stdgo.GoInt), (2 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>)) : stdgo.fmt_test.Fmt_test.A)), _out : ("{i:1 j:2 s:a x:[1 2]}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%+v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.fmt_test.Fmt_test.B((1 : stdgo.fmt_test.Fmt_test.I), (2 : stdgo.GoInt)) : stdgo.fmt_test.Fmt_test.B)), _out : ("{I:<1> j:2}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%+v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.fmt_test.Fmt_test.C((1 : stdgo.GoInt), (new stdgo.fmt_test.Fmt_test.B((2 : stdgo.fmt_test.Fmt_test.I), (3 : stdgo.GoInt)) : stdgo.fmt_test.Fmt_test.B)) : stdgo.fmt_test.Fmt_test.C)), _out : ("{i:1 B:{I:<2> j:3}}" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.fmt_test.Fmt_test.A((1 : stdgo.GoInt), (2u32 : stdgo.GoUInt), ("a" : stdgo.GoString), (new stdgo.Slice<stdgo.GoInt>(2, 2, (1 : stdgo.GoInt), (2 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>)) : stdgo.fmt_test.Fmt_test.A)), _out : ("fmt_test.A{i:1, j:0x2, s:\"a\", x:[]int{1, 2}}" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface(({
        ...
        @:mergeBlock {
            x.set(("a" : stdgo.GoString), (new stdgo.fmt_test.Fmt_test.B((1 : stdgo.fmt_test.Fmt_test.I), (2 : stdgo.GoInt)) : stdgo.fmt_test.Fmt_test.B));
        };
        x;
...
({ _fmt : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.fmt_test.Fmt_test.SI() : stdgo.fmt_test.Fmt_test.SI)), _out : ("fmt_test.SI{I:interface {}(nil)}" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(0, 0) : stdgo.Slice<stdgo.GoUInt8>)), _out : ("[]byte{}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface(stdgo.reflect.Reflect.valueOf(stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(0, 0) : stdgo.Slice<stdgo.GoUInt8>))))), _out : ("[]uint8{}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface(stdgo.reflect.Reflect.valueOf(stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoUInt8>(0, 0) : stdgo.Slice<stdgo.GoUInt8>))))), _out : ("[]uint8{}" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%+v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.fmt_test.Fmt_test.S(((4 : stdgo.fmt_test.Fmt_test.F) : F), ((5 : stdgo.fmt_test.Fmt_test.G) : G)) : stdgo.fmt_test.Fmt_test.S)), _out : ("{F:<v=F(4)> G:5}" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.fmt_test.Fmt_test.S(((7 : stdgo.fmt_test.Fmt_test.F) : F), ((8 : stdgo.fmt_test.Fmt_test.G) : G)) : stdgo.fmt_test.Fmt_test.S)), _out : ("fmt_test.S{F:<v=F(7)>, G:GoString(8)}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%T" : stdgo.GoString), _val : stdgo.Go.toInterface(((0 : stdgo.GoUInt8) : stdgo.GoByte)), _out : ("uint8" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%T" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface(stdgo.reflect.Reflect.valueOf((null : stdgo.AnyInterface)))), _out : ("reflect.Value" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%v" : stdgo.GoString), _val : stdgo.Go.toInterface((stdgo.reflect.Reflect.valueOf(stdgo.Go.toInterface((new stdgo.fmt_test.Fmt_test.A() : stdgo.fmt_test.Fmt_test.A))).field((0 : stdgo.GoInt)).string() : stdgo.GoString)), _out : ("<int Value>" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%v" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface(stdgo.reflect.Reflect.valueOf(stdgo.Go.toInterface((new stdgo.fmt_test.Fmt_test.A() : stdgo.fmt_test.Fmt_test.A))).field((0 : stdgo.GoInt)))), _out : ("0" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%#04x" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface(stdgo.reflect.Reflect.valueOf(stdgo.Go.toInterface((256 : stdgo.GoInt))))), _out : ("0x0100" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%v" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.reflect.Reflect.Value() : stdgo.reflect.Reflect.Value)) : stdgo.Ref<stdgo.reflect.Reflect.Value>))), _out : ("<invalid Value>" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%v" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.fmt_test.Fmt_test.SI(stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.reflect.Reflect.Value() : stdgo.reflect.Reflect.Value)))) : stdgo.fmt_test.Fmt_test.SI)), _out : ("{<invalid Value>}" : stdgo.GoString) } : T__struct_2),
...
({ _fmt : ("%☠" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.fmt_test.Fmt_test.SI(stdgo.Go.toInterface(((0 : stdgo.fmt_test.Fmt_test.T_renamedInt) : T_renamedInt))) : stdgo.fmt_test.Fmt_test.SI)), _out : ("{%!☠(fmt_test.renamedInt=0)}" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%☠" : stdgo.GoString), _val : stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo.Slice<stdgo.AnyInterface>(2, 2, stdgo.Go.toInterface(stdgo.Go.asInterface(((1 : stdgo.fmt_test.Fmt_test.I) : I))), stdgo.Go.toInterface(stdgo.Go.asInterface(((2 : stdgo.fmt_test.Fmt_test.G) : G)))) : stdgo.Slice<stdgo.AnyInterface>)) : stdgo.Ref<stdgo.Slice<stdgo.AnyInterface>>)), _out : ("&[%!☠(fmt_test.I=1) %!☠(fmt_test.G=2)]" : stdgo.GoString) } : T__struct_2),
({ _fmt : ("%☠" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.fmt_test.Fmt_test.SI(stdgo.Go.toInterface((stdgo.Go.setRef((new stdgo.Slice<stdgo.AnyInterface>(2, 2, stdgo.Go.toInterface(stdgo.Go.asInterface(((1 : stdgo.fmt_test.Fmt_test.I) : I))), stdgo.Go.toInterface(stdgo.Go.asInterface(((2 : stdgo.fmt_test.Fmt_test.G) : G)))) : stdgo.Slice<stdgo.AnyInterface>)) : stdgo.Ref<stdgo.Slice<stdgo.AnyInterface>>))) : stdgo.fmt_test.Fmt_test.SI)), _out : ("{%!☠(*[]interface {}=&[1 2])}" : stdgo.GoString) } : T__struct_2),
...
32,
32,
({ _fmt : ("%[1]d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(1, 1, stdgo.Go.toInterface((1 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("1" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%[2]d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(2, 2, stdgo.Go.toInterface((2 : stdgo.GoInt)), stdgo.Go.toInterface((1 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("1" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%[2]d %[1]d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(2, 2, stdgo.Go.toInterface((1 : stdgo.GoInt)), stdgo.Go.toInterface((2 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("2 1" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%[2]*[1]d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(2, 2, stdgo.Go.toInterface((2 : stdgo.GoInt)), stdgo.Go.toInterface((5 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("    2" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%6.2f" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(1, 1, stdgo.Go.toInterface((12 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.SE), _out : (" 12.00" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%[3]*.[2]*[1]f" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(3, 3, stdgo.Go.toInterface((12 : stdgo.GoFloat64)), stdgo.Go.toInterface((2 : stdgo.GoInt)), stdgo.Go.toInterface((6 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : (" 12.00" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%[1]*.[2]*[3]f" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(3, 3, stdgo.Go.toInterface((6 : stdgo.GoInt)), stdgo.Go.toInterface((2 : stdgo.GoInt)), stdgo.Go.toInterface((12 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.SE), _out : (" 12.00" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%10f" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(1, 1, stdgo.Go.toInterface((12 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.SE), _out : (" 12.000000" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%[1]*[3]f" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(3, 3, stdgo.Go.toInterface((10 : stdgo.GoInt)), stdgo.Go.toInterface((99 : stdgo.GoInt)), stdgo.Go.toInterface((12 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.SE), _out : (" 12.000000" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%.6f" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(1, 1, stdgo.Go.toInterface((12 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.SE), _out : ("12.000000" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%.[1]*[3]f" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(3, 3, stdgo.Go.toInterface((6 : stdgo.GoInt)), stdgo.Go.toInterface((99 : stdgo.GoInt)), stdgo.Go.toInterface((12 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.SE), _out : ("12.000000" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%6.f" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(1, 1, stdgo.Go.toInterface((12 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.SE), _out : ("    12" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%[1]*.[3]f" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(3, 3, stdgo.Go.toInterface((6 : stdgo.GoInt)), stdgo.Go.toInterface((3 : stdgo.GoInt)), stdgo.Go.toInterface((12 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.SE), _out : ("    12" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%d %d %d %#[1]o %#o %#o" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(3, 3, stdgo.Go.toInterface((11 : stdgo.GoInt)), stdgo.Go.toInterface((12 : stdgo.GoInt)), stdgo.Go.toInterface((13 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("11 12 13 013 014 015" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%[d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(2, 2, stdgo.Go.toInterface((2 : stdgo.GoInt)), stdgo.Go.toInterface((1 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("%!d(BADINDEX)" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%]d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(2, 2, stdgo.Go.toInterface((2 : stdgo.GoInt)), stdgo.Go.toInterface((1 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("%!](int=2)d%!(EXTRA int=1)" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%[]d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(2, 2, stdgo.Go.toInterface((2 : stdgo.GoInt)), stdgo.Go.toInterface((1 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("%!d(BADINDEX)" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%[-3]d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(2, 2, stdgo.Go.toInterface((2 : stdgo.GoInt)), stdgo.Go.toInterface((1 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("%!d(BADINDEX)" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%[99]d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(2, 2, stdgo.Go.toInterface((2 : stdgo.GoInt)), stdgo.Go.toInterface((1 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("%!d(BADINDEX)" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%[3]" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(2, 2, stdgo.Go.toInterface((2 : stdgo.GoInt)), stdgo.Go.toInterface((1 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("%!(NOVERB)" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%[1].2d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(2, 2, stdgo.Go.toInterface((5 : stdgo.GoInt)), stdgo.Go.toInterface((6 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("%!d(BADINDEX)" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%[1]2d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(2, 2, stdgo.Go.toInterface((2 : stdgo.GoInt)), stdgo.Go.toInterface((1 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("%!d(BADINDEX)" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%3.[2]d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(1, 1, stdgo.Go.toInterface((7 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("%!d(BADINDEX)" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%.[2]d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(1, 1, stdgo.Go.toInterface((7 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("%!d(BADINDEX)" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%d %d %d %#[1]o %#o %#o %#o" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(3, 3, stdgo.Go.toInterface((11 : stdgo.GoInt)), stdgo.Go.toInterface((12 : stdgo.GoInt)), stdgo.Go.toInterface((13 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("11 12 13 013 014 015 %!o(MISSING)" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%[5]d %[2]d %d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(3, 3, stdgo.Go.toInterface((1 : stdgo.GoInt)), stdgo.Go.toInterface((2 : stdgo.GoInt)), stdgo.Go.toInterface((3 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("%!d(BADINDEX) 2 3" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%d %[3]d %d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(2, 2, stdgo.Go.toInterface((1 : stdgo.GoInt)), stdgo.Go.toInterface((2 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("1 %!d(BADINDEX) 2" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%.[]" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(0, 0) : stdgo.fmt_test.Fmt_test.SE), _out : ("%!](BADINDEX)" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%.-3d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(1, 1, stdgo.Go.toInterface((42 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("%!-(int=42)3d" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%2147483648d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(1, 1, stdgo.Go.toInterface((42 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("%!(NOVERB)%!(EXTRA int=42)" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%-2147483648d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(1, 1, stdgo.Go.toInterface((42 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("%!(NOVERB)%!(EXTRA int=42)" : stdgo.GoString) } : T__struct_3),
({ _fmt : ("%.2147483648d" : stdgo.GoString), _val : (new stdgo.Slice<stdgo.AnyInterface>(1, 1, stdgo.Go.toInterface((42 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out : ("%!(NOVERB)%!(EXTRA int=42)" : stdgo.GoString) } : T__struct_3)) : stdgo.Slice<T__struct_3>);
/**
...
({ _count : (0 : stdgo.GoInt), _desc : ("Fprintf(buf, \"%s\")" : stdgo.GoString), _fn : function():Void {
        _mallocBuf.reset();
        fprintf(stdgo.Go.asInterface((stdgo.Go.setRef(_mallocBuf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), ("%s" : stdgo.GoString), stdgo.Go.toInterface(("hello" : stdgo.GoString)));
    } } : T__struct_4),
({ _count : (0 : stdgo.GoInt), _desc : ("Fprintf(buf, \"%x\")" : stdgo.GoString), _fn : function():Void {
        _mallocBuf.reset();
        fprintf(stdgo.Go.asInterface((stdgo.Go.setRef(_mallocBuf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), ("%x" : stdgo.GoString), stdgo.Go.toInterface((7 : stdgo.GoInt)));
    } } : T__struct_4),
({ _count : (0 : stdgo.GoInt), _desc : ("Fprintf(buf, \"%x\")" : stdgo.GoString), _fn : function():Void {
        _mallocBuf.reset();
        fprintf(stdgo.Go.asInterface((stdgo.Go.setRef(_mallocBuf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), ("%x" : stdgo.GoString), stdgo.Go.toInterface((65536 : stdgo.GoInt)));
    } } : T__struct_4),
({ _count : (2 : stdgo.GoInt), _desc : ("Fprintf(buf, \"%80000s\")" : stdgo.GoString), _fn : function():Void {
        _mallocBuf.reset();
        fprintf(stdgo.Go.asInterface((stdgo.Go.setRef(_mallocBuf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), ("%80000s" : stdgo.GoString), stdgo.Go.toInterface(("hello" : stdgo.GoString)));
    } } : T__struct_4),
...
10,
10,
({ _fmt : ("%s" : stdgo.GoString), _in : stdgo.Go.toInterface(stdgo.Go.asInterface(((null : stdgo.Ref<stdgo.fmt_test.Fmt_test.PanicS>) : stdgo.Ref<PanicS>))), _out : ("<nil>" : stdgo.GoString) } : T__struct_8),
({ _fmt : ("%s" : stdgo.GoString), _in : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.PanicS(stdgo.Go.toInterface(stdgo.io.Io.errUnexpectedEOF)) : stdgo.fmt_test.Fmt_test.PanicS))), _out : ("%!s(PANIC=String method: unexpected EOF)" : stdgo.GoString) } : T__struct_8),
({ _fmt : ("%s" : stdgo.GoString), _in : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.PanicS(stdgo.Go.toInterface((3 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.PanicS))), _out : ("%!s(PANIC=String method: 3)" : stdgo.GoString) } : T__struct_8),
({ _fmt : ("%#v" : stdgo.GoString), _in : stdgo.Go.toInterface(stdgo.Go.asInterface(((null : stdgo.Ref<stdgo.fmt_test.Fmt_test.PanicGo>) : stdgo.Ref<PanicGo>))), _out : ("<nil>" : stdgo.GoString) } : T__struct_8),
({ _fmt : ("%#v" : stdgo.GoString), _in : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.PanicGo(stdgo.Go.toInterface(stdgo.io.Io.errUnexpectedEOF)) : stdgo.fmt_test.Fmt_test.PanicGo))), _out : ("%!v(PANIC=GoString method: unexpected EOF)" : stdgo.GoString) } : T__struct_8),
({ _fmt : ("%#v" : stdgo.GoString), _in : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.PanicGo(stdgo.Go.toInterface((3 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.PanicGo))), _out : ("%!v(PANIC=GoString method: 3)" : stdgo.GoString) } : T__struct_8),
({ _fmt : ("%#v" : stdgo.GoString), _in : stdgo.Go.toInterface((new stdgo.Slice<stdgo.AnyInterface>(2, 2, stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.PanicGo(stdgo.Go.toInterface((3 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.PanicGo))), stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.PanicGo(stdgo.Go.toInterface((3 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.PanicGo)))) : stdgo.Slice<stdgo.AnyInterface>)), _out : ("[]interface {}{%!v(PANIC=GoString method: 3), %!v(PANIC=GoString method: 3)}" : stdgo.GoString) } : T__struct_8),
({ _fmt : ("%s" : stdgo.GoString), _in : stdgo.Go.toInterface(stdgo.Go.asInterface(((null : stdgo.Ref<stdgo.fmt_test.Fmt_test.PanicF>) : stdgo.Ref<PanicF>))), _out : ("<nil>" : stdgo.GoString) } : T__struct_8),
({ _fmt : ("%s" : stdgo.GoString), _in : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.PanicF(stdgo.Go.toInterface(stdgo.io.Io.errUnexpectedEOF)) : stdgo.fmt_test.Fmt_test.PanicF))), _out : ("%!s(PANIC=Format method: unexpected EOF)" : stdgo.GoString) } : T__struct_8),
({ _fmt : ("%s" : stdgo.GoString), _in : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.PanicF(stdgo.Go.toInterface((3 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.PanicF))), _out : ("%!s(PANIC=Format method: 3)" : stdgo.GoString) } : T__struct_8)) : stdgo.Slice<T__struct_8>);
/**
...
48,
48,
({ _in : ("%a" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%a]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-a" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%-a]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%+a" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%+a]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%#a" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%#a]" : stdgo.GoString) } : T__struct_9),
({ _in : ("% a" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[% a]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%0a" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%0a]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%1.2a" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%1.2a]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-1.2a" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%-1.2a]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%+1.2a" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%+1.2a]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-+1.2a" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%+-1.2a]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-+1.2abc" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%+-1.2a]bc" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-1.2abc" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%-1.2a]bc" : stdgo.GoString) } : T__struct_9),
...
({ _in : ("%-1.2abc" : stdgo.GoString), _val : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0 ... 1) ({} : stdgo.fmt_test.Fmt_test.T_flagPrinter)]))) : stdgo.GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>)), _out : ("[[%-1.2a]]bc" : stdgo.GoString) } : T__struct_9),
({ _in : ("%v" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%v]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-v" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%-v]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%+v" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%+v]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%#v" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%#v]" : stdgo.GoString) } : T__struct_9),
({ _in : ("% v" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[% v]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%0v" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%0v]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%1.2v" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%1.2v]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-1.2v" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%-1.2v]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%+1.2v" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%+1.2v]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-+1.2v" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%+-1.2v]" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-+1.2vbc" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%+-1.2v]bc" : stdgo.GoString) } : T__struct_9),
({ _in : ("%-1.2vbc" : stdgo.GoString), _val : stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.T_flagPrinter() : stdgo.fmt_test.Fmt_test.T_flagPrinter))), _out : ("[%-1.2v]bc" : stdgo.GoString) } : T__struct_9),
...
(new stdgo.fmt_test.Fmt_test.ScanTest(("21\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((21 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("2_1\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((21 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("0\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((0 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("000\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((0 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("0x10\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((16 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("0x_1_0\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((16 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("-0x10\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((-16 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("0377\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((255 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
...
(new stdgo.fmt_test.Fmt_test.ScanTest(("-0377\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((-255 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("-0o377\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((-255 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("0\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((0u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("000\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((0u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("0x10\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((16u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("0377\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((255u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("22\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int8Val)), stdgo.Go.toInterface((22 : stdgo.GoInt8))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("23\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int16Val)), stdgo.Go.toInterface((23 : stdgo.GoInt16))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("24\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int32Val)), stdgo.Go.toInterface((24 : stdgo.GoInt32))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("25\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int64Val)), stdgo.Go.toInterface((25i64 : stdgo.GoInt64))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("127\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int8Val)), stdgo.Go.toInterface((127 : stdgo.GoInt8))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("-21\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((-21 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("-22\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int8Val)), stdgo.Go.toInterface((-22 : stdgo.GoInt8))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("-23\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int16Val)), stdgo.Go.toInterface((-23 : stdgo.GoInt16))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("-24\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int32Val)), stdgo.Go.toInterface((-24 : stdgo.GoInt32))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("-25\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int64Val)), stdgo.Go.toInterface((-25i64 : stdgo.GoInt64))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("-128\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int8Val)), stdgo.Go.toInterface((-128 : stdgo.GoInt8))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("+21\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((21 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("+22\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int8Val)), stdgo.Go.toInterface((22 : stdgo.GoInt8))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("+23\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int16Val)), stdgo.Go.toInterface((23 : stdgo.GoInt16))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("+24\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int32Val)), stdgo.Go.toInterface((24 : stdgo.GoInt32))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("+25\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int64Val)), stdgo.Go.toInterface((25i64 : stdgo.GoInt64))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("+127\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int8Val)), stdgo.Go.toInterface((127 : stdgo.GoInt8))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("26\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((26u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("27\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uint8Val)), stdgo.Go.toInterface((27 : stdgo.GoUInt8))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("28\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uint16Val)), stdgo.Go.toInterface((28 : stdgo.GoUInt16))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("29\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uint32Val)), stdgo.Go.toInterface((29u32 : stdgo.GoUInt32))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("30\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uint64Val)), stdgo.Go.toInterface((30i64 : stdgo.GoUInt64))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("31\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintptrVal)), stdgo.Go.toInterface((31 : stdgo.GoUIntptr))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("255\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uint8Val)), stdgo.Go.toInterface((255 : stdgo.GoUInt8))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("32767\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int16Val)), stdgo.Go.toInterface((32767 : stdgo.GoInt16))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("2.3\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float64Val)), stdgo.Go.toInterface((2.3 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("2.3e1\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float32Val)), stdgo.Go.toInterface(((23 : stdgo.GoFloat64) : stdgo.GoFloat32))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("2.3e2\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float64Val)), stdgo.Go.toInterface((230 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("2.3p2\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float64Val)), stdgo.Go.toInterface((9.2 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("2.3p+2\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float64Val)), stdgo.Go.toInterface((9.2 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("2.3p+66\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float64Val)), stdgo.Go.toInterface((1.6971004547812786e+20 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("2.3p-66\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float64Val)), stdgo.Go.toInterface((3.117081245895825e-20 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("0x2.3p-66\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float64Val)), stdgo.Go.toInterface((2.964615315390051e-20 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("2_3.4_5\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float64Val)), stdgo.Go.toInterface((23.45 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanTest),
...
(new stdgo.fmt_test.Fmt_test.ScanTest(("2345678\n" : stdgo.GoString), stdgo.Go.toInterface((stdgo.Go.setRef(_bytesVal) : stdgo.Ref<stdgo.Slice<stdgo.GoUInt8>>)), stdgo.Go.toInterface((("2345678" : stdgo.GoString) : stdgo.Slice<stdgo.GoByte>))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("(3.4e1-2i)\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_complex128Val)), stdgo.Go.toInterface(((34f64 : stdgo.GoFloat64) + new stdgo.GoComplex128(0f64, -2f64)))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("-3.45e1-3i\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_complex64Val)), stdgo.Go.toInterface(((-34.5f64 : stdgo.GoFloat64) + new stdgo.GoComplex128(0f64, -3f64) : stdgo.GoComplex64))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("-.45e1-1e2i\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_complex128Val)), stdgo.Go.toInterface(((-4.5f64 : stdgo.GoFloat64) + new stdgo.GoComplex128(0f64, -100f64) : stdgo.GoComplex128))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("-.4_5e1-1E2i\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_complex128Val)), stdgo.Go.toInterface(((-4.5f64 : stdgo.GoFloat64) + new stdgo.GoComplex128(0f64, -100f64) : stdgo.GoComplex128))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("0x1.0p1+0x1.0P2i\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_complex128Val)), stdgo.Go.toInterface(((2f64 : stdgo.GoFloat64) + new stdgo.GoComplex128(0f64, 4f64) : stdgo.GoComplex128))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("-0x1p1-0x1p2i\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_complex128Val)), stdgo.Go.toInterface(((-2f64 : stdgo.GoFloat64) + new stdgo.GoComplex128(0f64, -4f64) : stdgo.GoComplex128))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("-0x1ep-1-0x1p2i\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_complex128Val)), stdgo.Go.toInterface(((-15f64 : stdgo.GoFloat64) + new stdgo.GoComplex128(0f64, -4f64) : stdgo.GoComplex128))) : stdgo.fmt_test.Fmt_test.ScanTest),
...
(new stdgo.fmt_test.Fmt_test.ScanTest(("115\n" : stdgo.GoString), stdgo.Go.toInterface((stdgo.Go.setRef(_renamedBytesVal) : stdgo.Ref<stdgo.fmt_test.Fmt_test.T_renamedBytes>)), stdgo.Go.toInterface(((("115" : stdgo.GoString) : stdgo.Slice<stdgo.GoByte>) : T_renamedBytes))) : stdgo.fmt_test.Fmt_test.ScanTest),
...
(new stdgo.fmt_test.Fmt_test.ScanTest((" 1234hello" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_intStringVal) : stdgo.Ref<stdgo.fmt_test.Fmt_test.IntString>))), stdgo.Go.toInterface(stdgo.Go.asInterface((new stdgo.fmt_test.Fmt_test.IntString((1234 : stdgo.GoInt), ("hello" : stdgo.GoString)) : stdgo.fmt_test.Fmt_test.IntString)))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("2147483648\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int64Val)), stdgo.Go.toInterface((2147483648i64 : stdgo.GoInt64))) : stdgo.fmt_test.Fmt_test.ScanTest)) : stdgo.Slice<stdgo.fmt_test.Fmt_test.ScanTest>);
/**
...
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : stdgo.GoString), ("-71\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((-71 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : stdgo.GoString), ("-7_1\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((-71 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : stdgo.GoString), ("0b111\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((7 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : stdgo.GoString), ("0b_1_1_1\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((7 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : stdgo.GoString), ("0377\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((255 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
...
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : stdgo.GoString), ("0x44\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((68 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : stdgo.GoString), ("0x_4_4\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((68 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : stdgo.GoString), ("72\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((72 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%c" : stdgo.GoString), ("a\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_runeVal)), stdgo.Go.toInterface((97 : stdgo.GoInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%c" : stdgo.GoString), ("偲\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_runeVal)), stdgo.Go.toInterface((20594 : stdgo.GoInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%c" : stdgo.GoString), ("ሴ\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_runeVal)), stdgo.Go.toInterface((4660 : stdgo.GoInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : stdgo.GoString), ("73\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int8Val)), stdgo.Go.toInterface((73 : stdgo.GoInt8))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : stdgo.GoString), ("+74\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int16Val)), stdgo.Go.toInterface((74 : stdgo.GoInt16))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : stdgo.GoString), ("75\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int32Val)), stdgo.Go.toInterface((75 : stdgo.GoInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : stdgo.GoString), ("76\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int64Val)), stdgo.Go.toInterface((76i64 : stdgo.GoInt64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%b" : stdgo.GoString), ("1001001\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((73 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%o" : stdgo.GoString), ("075\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((61 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%x" : stdgo.GoString), ("a75\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((2677 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : stdgo.GoString), ("71\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((71u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : stdgo.GoString), ("72\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((72u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : stdgo.GoString), ("7_2\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((7u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : stdgo.GoString), ("73\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uint8Val)), stdgo.Go.toInterface((73 : stdgo.GoUInt8))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : stdgo.GoString), ("74\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uint16Val)), stdgo.Go.toInterface((74 : stdgo.GoUInt16))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : stdgo.GoString), ("75\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uint32Val)), stdgo.Go.toInterface((75u32 : stdgo.GoUInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : stdgo.GoString), ("76\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uint64Val)), stdgo.Go.toInterface((76i64 : stdgo.GoUInt64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : stdgo.GoString), ("77\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintptrVal)), stdgo.Go.toInterface((77 : stdgo.GoUIntptr))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%b" : stdgo.GoString), ("1001001\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((73u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%b" : stdgo.GoString), ("100_1001\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((4u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%o" : stdgo.GoString), ("075\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((61u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%o" : stdgo.GoString), ("07_5\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((7u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%x" : stdgo.GoString), ("a75\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((2677u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%x" : stdgo.GoString), ("A75\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((2677u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%x" : stdgo.GoString), ("A7_5\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((167u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%U" : stdgo.GoString), ("U+1234\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((4660 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%U" : stdgo.GoString), ("U+4567\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((17767u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%e" : stdgo.GoString), ("2.3\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float64Val)), stdgo.Go.toInterface((2.3 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%E" : stdgo.GoString), ("2.3e1\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float32Val)), stdgo.Go.toInterface(((23 : stdgo.GoFloat64) : stdgo.GoFloat32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%f" : stdgo.GoString), ("2.3e2\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float64Val)), stdgo.Go.toInterface((230 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%g" : stdgo.GoString), ("2.3p2\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float64Val)), stdgo.Go.toInterface((9.2 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%G" : stdgo.GoString), ("2.3p+2\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float64Val)), stdgo.Go.toInterface((9.2 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : stdgo.GoString), ("2.3p+66\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float64Val)), stdgo.Go.toInterface((1.6971004547812786e+20 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%f" : stdgo.GoString), ("2.3p-66\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float64Val)), stdgo.Go.toInterface((3.117081245895825e-20 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%G" : stdgo.GoString), ("0x2.3p-66\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float64Val)), stdgo.Go.toInterface((2.964615315390051e-20 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%E" : stdgo.GoString), ("2_3.4_5\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float64Val)), stdgo.Go.toInterface((23.45 : stdgo.GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
...
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%s" : stdgo.GoString), ("bytes-%s\n" : stdgo.GoString), stdgo.Go.toInterface((stdgo.Go.setRef(_bytesVal) : stdgo.Ref<stdgo.Slice<stdgo.GoUInt8>>)), stdgo.Go.toInterface((("bytes-%s" : stdgo.GoString) : stdgo.Slice<stdgo.GoByte>))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%x" : stdgo.GoString), ("62797465732d2578\n" : stdgo.GoString), stdgo.Go.toInterface((stdgo.Go.setRef(_bytesVal) : stdgo.Ref<stdgo.Slice<stdgo.GoUInt8>>)), stdgo.Go.toInterface((("bytes-%x" : stdgo.GoString) : stdgo.Slice<stdgo.GoByte>))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%X" : stdgo.GoString), ("62797465732D2558\n" : stdgo.GoString), stdgo.Go.toInterface((stdgo.Go.setRef(_bytesVal) : stdgo.Ref<stdgo.Slice<stdgo.GoUInt8>>)), stdgo.Go.toInterface((("bytes-%X" : stdgo.GoString) : stdgo.Slice<stdgo.GoByte>))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%q" : stdgo.GoString), ("\"bytes\\rwith\\vdo\\u0075bl\\x65s\"\n" : stdgo.GoString), stdgo.Go.toInterface((stdgo.Go.setRef(_bytesVal) : stdgo.Ref<stdgo.Slice<stdgo.GoUInt8>>)), stdgo.Go.toInterface((("bytes\rwith\x0Bdoubles" : stdgo.GoString) : stdgo.Slice<stdgo.GoByte>))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%q" : stdgo.GoString), ("`bytes with backs`\n" : stdgo.GoString), stdgo.Go.toInterface((stdgo.Go.setRef(_bytesVal) : stdgo.Ref<stdgo.Slice<stdgo.GoUInt8>>)), stdgo.Go.toInterface((("bytes with backs" : stdgo.GoString) : stdgo.Slice<stdgo.GoByte>))) : stdgo.fmt_test.Fmt_test.ScanfTest),
...
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%q" : stdgo.GoString), ("\"1155\"\n" : stdgo.GoString), stdgo.Go.toInterface((stdgo.Go.setRef(_renamedBytesVal) : stdgo.Ref<stdgo.fmt_test.Fmt_test.T_renamedBytes>)), stdgo.Go.toInterface(((("1155" : stdgo.GoString) : stdgo.Slice<stdgo.GoByte>) : T_renamedBytes))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%g" : stdgo.GoString), ("116e1\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_renamedFloat32Val)), stdgo.Go.toInterface(((1160 : stdgo.GoFloat64) : T_renamedFloat32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%g" : stdgo.GoString), ("-11.7e+1" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_renamedFloat64Val)), stdgo.Go.toInterface(((-117 : stdgo.GoFloat64) : T_renamedFloat64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%g" : stdgo.GoString), ("11+6e1i\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_renamedComplex64Val)), stdgo.Go.toInterface(((11f64 : stdgo.GoFloat64) + new stdgo.GoComplex128(0f64, 60f64) : T_renamedComplex64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%g" : stdgo.GoString), ("-11.+7e+1i" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_renamedComplex128Val)), stdgo.Go.toInterface(((-11f64 : stdgo.GoFloat64) + new stdgo.GoComplex128(0f64, 70f64) : T_renamedComplex128))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("here is\tthe value:%d" : stdgo.GoString), ("here is   the\tvalue:118\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((118 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%% %%:%d" : stdgo.GoString), ("% %:119\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((119 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d%%" : stdgo.GoString), ("42%" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((42 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%x" : stdgo.GoString), ("FFFFFFFF\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uint32Val)), stdgo.Go.toInterface((-1u32 : stdgo.GoUInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
...
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d\n" : stdgo.GoString), ("27\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d\n" : stdgo.GoString), ("28 \n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((28 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : stdgo.GoString), ("0" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((0 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : stdgo.GoString), ("0" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((0u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%c" : stdgo.GoString), (" " : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((32u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%c" : stdgo.GoString), ("\t" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((9u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%c" : stdgo.GoString), ("\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((10u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d%%" : stdgo.GoString), ("23%\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((23u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%%%d" : stdgo.GoString), ("%23\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uintVal)), stdgo.Go.toInterface((23u32 : stdgo.GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : stdgo.GoString), ("27" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : stdgo.GoString), ("27 " : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : stdgo.GoString), (" 27" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : stdgo.GoString), (" 27 " : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%d" : stdgo.GoString), ("X27" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%d" : stdgo.GoString), ("X27 " : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%d" : stdgo.GoString), ("X 27" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%d" : stdgo.GoString), ("X 27 " : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %d" : stdgo.GoString), ("X27" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %d" : stdgo.GoString), ("X27 " : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %d" : stdgo.GoString), ("X 27" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %d" : stdgo.GoString), ("X 27 " : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%dX" : stdgo.GoString), ("27X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%dX" : stdgo.GoString), ("27 X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%dX" : stdgo.GoString), (" 27X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%dX" : stdgo.GoString), (" 27 X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d X" : stdgo.GoString), ("27X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d X" : stdgo.GoString), ("27 X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d X" : stdgo.GoString), (" 27X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d X" : stdgo.GoString), (" 27 X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %d X" : stdgo.GoString), ("X27X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %d X" : stdgo.GoString), ("X27 X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %d X" : stdgo.GoString), ("X 27X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %d X" : stdgo.GoString), ("X 27 X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %s X" : stdgo.GoString), ("X27X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_stringVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %s X" : stdgo.GoString), ("X27 X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_stringVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %s X" : stdgo.GoString), ("X 27X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_stringVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
...
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%sX" : stdgo.GoString), ("X27X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_stringVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%sX" : stdgo.GoString), ("X27 X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_stringVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%sX" : stdgo.GoString), ("X 27X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_stringVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%sX" : stdgo.GoString), ("X 27 X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_stringVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
...
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%s" : stdgo.GoString), ("X 27 " : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_stringVal)), stdgo.Go.toInterface(("27" : stdgo.GoString))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX" : stdgo.GoString), ("X27X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX" : stdgo.GoString), ("X27 X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX" : stdgo.GoString), ("X 27X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX" : stdgo.GoString), ("X 27 X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX" : stdgo.GoString), ("X27X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX" : stdgo.GoString), ("X27X " : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX" : stdgo.GoString), (" X27X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX" : stdgo.GoString), (" X27X " : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX\n" : stdgo.GoString), ("X27X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX \n" : stdgo.GoString), ("X27X " : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX\n" : stdgo.GoString), ("X27X\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX\n" : stdgo.GoString), ("X27X \n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX \n" : stdgo.GoString), ("X27X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
...
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX \n" : stdgo.GoString), ("X27X\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX \n" : stdgo.GoString), ("X27X \n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%c" : stdgo.GoString), ("X\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_runeVal)), stdgo.Go.toInterface((10 : stdgo.GoInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%c" : stdgo.GoString), ("X \n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_runeVal)), stdgo.Go.toInterface((32 : stdgo.GoInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %c" : stdgo.GoString), ("X!" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_runeVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %c" : stdgo.GoString), ("X\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_runeVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %c" : stdgo.GoString), ("X !" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_runeVal)), stdgo.Go.toInterface((33 : stdgo.GoInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %c" : stdgo.GoString), ("X \n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_runeVal)), stdgo.Go.toInterface((10 : stdgo.GoInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest((" X%dX" : stdgo.GoString), ("X27X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest((" X%dX" : stdgo.GoString), ("X27X " : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), (null : stdgo.AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest((" X%dX" : stdgo.GoString), (" X27X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
...
(new stdgo.fmt_test.Fmt_test.ScanfTest((" X%dX " : stdgo.GoString), (" X27X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest((" X%dX " : stdgo.GoString), (" X27X " : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d\nX" : stdgo.GoString), ("27\nX" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
(new stdgo.fmt_test.Fmt_test.ScanfTest(("%dX\n X" : stdgo.GoString), ("27X\n X" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_intVal)), stdgo.Go.toInterface((27 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest)) : stdgo.Slice<stdgo.fmt_test.Fmt_test.ScanfTest>);
/**
...
11,
11,
(new stdgo.fmt_test.Fmt_test.ScanTest(("128" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int8Val)), stdgo.Go.toInterface((0 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("32768" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int16Val)), stdgo.Go.toInterface((0 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("-129" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int8Val)), stdgo.Go.toInterface((0 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("-32769" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_int16Val)), stdgo.Go.toInterface((0 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("256" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uint8Val)), stdgo.Go.toInterface((0 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("65536" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_uint16Val)), stdgo.Go.toInterface((0 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("1e100" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float32Val)), stdgo.Go.toInterface((0 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("1e500" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_float64Val)), stdgo.Go.toInterface((0 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("(1e100+0i)" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_complex64Val)), stdgo.Go.toInterface((0 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("(1+1e100i)" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_complex64Val)), stdgo.Go.toInterface((0 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
(new stdgo.fmt_test.Fmt_test.ScanTest(("(1-1e500i)" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.pointer(_complex128Val)), stdgo.Go.toInterface((0 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest)) : stdgo.Slice<stdgo.fmt_test.Fmt_test.ScanTest>);
/**
...
**/
@:structInit class B {
    public var i : stdgo.fmt_test.Fmt_test.I = ((0 : stdgo.GoInt) : stdgo.fmt_test.Fmt_test.I);
    public var _j : stdgo.GoInt = 0;
    public function new(?i:stdgo.fmt_test.Fmt_test.I, ?_j:stdgo.GoInt) {
        if (i != null) this.i = i;
        if (_j != null) this._j = _j;
    }
    public function __underlying__() return stdgo.Go.toInterface(this);
...
@:structInit @:using(stdgo.fmt_test.Fmt_test.C_static_extension) class C {
    ...
    public function new(?_i:stdgo.GoInt, ?b:stdgo.fmt_test.Fmt_test.B) {
        if (_i != null) this._i = _i;
        if (b != null) this.b = b;
    }
    public function __underlying__() return stdgo.Go.toInterface(this);
...
**/
@:structInit class S {
    public var f : stdgo.fmt_test.Fmt_test.F = ((0 : stdgo.GoInt) : stdgo.fmt_test.Fmt_test.F);
    public var g : stdgo.fmt_test.Fmt_test.G = ((0 : stdgo.GoInt) : stdgo.fmt_test.Fmt_test.G);
...
@:structInit @:using(stdgo.fmt_test.Fmt_test.Person_static_extension) class Person {
    ...
    public var addr : stdgo.Ref<stdgo.fmt_test.Fmt_test.Address> = (null : stdgo.Ref<stdgo.fmt_test.Fmt_test.Address>);
    public function new(?name:stdgo.GoString, ?age:stdgo.GoUInt, ?addr:stdgo.Ref<stdgo.fmt_test.Fmt_test.Address>) {
...
@:structInit @:private @:using(stdgo.fmt_test.Fmt_test.T_eofCounter_static_extension) class T_eofCounter {
    public var _reader : stdgo.Ref<stdgo.strings.Strings.Reader> = (null : stdgo.Ref<stdgo.strings.Strings.Reader>);
    public var _eofCount : stdgo.GoInt = 0;
    public function new(?_reader:stdgo.Ref<stdgo.strings.Strings.Reader>, ?_eofCount:stdgo.GoInt) {
...
@:structInit @:using(stdgo.fmt_test.Fmt_test.RecursiveInt_static_extension) class RecursiveInt {
    public var _i : stdgo.GoInt = 0;
    public var _next : stdgo.Ref<stdgo.fmt_test.Fmt_test.RecursiveInt> = (null : stdgo.Ref<stdgo.fmt_test.Fmt_test.RecursiveInt>);
    public function new(?_i:stdgo.GoInt, ?_next:stdgo.Ref<stdgo.fmt_test.Fmt_test.RecursiveInt>) {
        if (_i != null) this._i = _i;
...
@:named @:using(stdgo.fmt_test.Fmt_test.I_static_extension) typedef I = stdgo.GoInt;
@:named @:using(stdgo.fmt_test.Fmt_test.F_static_extension) typedef F = stdgo.GoInt;
@:named @:using(stdgo.fmt_test.Fmt_test.G_static_extension) typedef G = stdgo.GoInt;
/**
    // P is a type with a String method with pointer receiver for testing %p.
**/
@:named @:using(stdgo.fmt_test.Fmt_test.P_static_extension) typedef P = stdgo.GoInt;
@:named @:using(stdgo.fmt_test.Fmt_test.T_byteStringer_static_extension) typedef T_byteStringer = stdgo.GoUInt8;
@:named @:using(stdgo.fmt_test.Fmt_test.T_byteFormatter_static_extension) typedef T_byteFormatter = stdgo.GoUInt8;
...
@:named @:using(stdgo.fmt_test.Fmt_test.T_hexBytes_static_extension) typedef T_hexBytes = stdgo.GoArray<stdgo.GoUInt8>;
@:named @:using(stdgo.fmt_test.Fmt_test.TI_static_extension) typedef TI = stdgo.GoInt;
@:named @:using(stdgo.fmt_test.Fmt_test.TI8_static_extension) typedef TI8 = stdgo.GoInt8;
@:named @:using(stdgo.fmt_test.Fmt_test.TI16_static_extension) typedef TI16 = stdgo.GoInt16;
@:named @:using(stdgo.fmt_test.Fmt_test.TI32_static_extension) typedef TI32 = stdgo.GoInt32;
@:named @:using(stdgo.fmt_test.Fmt_test.TI64_static_extension) typedef TI64 = stdgo.GoInt64;
@:named @:using(stdgo.fmt_test.Fmt_test.TU_static_extension) typedef TU = stdgo.GoUInt;
@:named @:using(stdgo.fmt_test.Fmt_test.TU8_static_extension) typedef TU8 = stdgo.GoUInt8;
@:named @:using(stdgo.fmt_test.Fmt_test.TU16_static_extension) typedef TU16 = stdgo.GoUInt16;
@:named @:using(stdgo.fmt_test.Fmt_test.TU32_static_extension) typedef TU32 = stdgo.GoUInt32;
@:named @:using(stdgo.fmt_test.Fmt_test.TU64_static_extension) typedef TU64 = stdgo.GoUInt64;
@:named @:using(stdgo.fmt_test.Fmt_test.TUI_static_extension) typedef TUI = stdgo.GoUIntptr;
@:named @:using(stdgo.fmt_test.Fmt_test.TF_static_extension) typedef TF = stdgo.GoFloat64;
@:named @:using(stdgo.fmt_test.Fmt_test.TF32_static_extension) typedef TF32 = stdgo.GoFloat32;
@:named @:using(stdgo.fmt_test.Fmt_test.TF64_static_extension) typedef TF64 = stdgo.GoFloat64;
...
function testErrorf(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
({ _err : _noVetErrorf(("wrapped nil error: %w %w %w" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(((("1" : stdgo.GoString) : stdgo.fmt_test.Fmt_test.T_errString) : T_errString))), (null : stdgo.AnyInterface), stdgo.Go.toInterface(stdgo.Go.asInterface(((("2" : stdgo.GoString) : stdgo.fmt_test.Fmt_test.T_errString) : T_errString)))), _wantText : ("wrapped nil error: 1 %!w(<nil>) 2" : stdgo.GoString), _wantUnwrap : (null : stdgo.Error), _wantSplit : (new stdgo.Slice<stdgo.Error>(2, 2, stdgo.Go.asInterface(((("1" : stdgo.GoString) : stdgo.fmt_test.Fmt_test.T_errString) : T_errString)), stdgo.Go.asInterface(((("2" : stdgo.GoString) : stdgo.fmt_test.Fmt_test.T_errString) : T_errString))) : stdgo.Slice<stdgo.Error>) } : T__struct_0),
...
({ _err : stdgo.fmt.Fmt.errorf(("%w" : stdgo.GoString), (null : stdgo.AnyInterface)), _wantText : ("%!w(<nil>)" : stdgo.GoString), _wantUnwrap : (null : stdgo.Error), _wantSplit : (null : stdgo.Slice<stdgo.Error>) } : T__struct_0)) : stdgo.Slice<T__struct_0>)) {
            {
...
function _splitErr(_err:stdgo.Error):stdgo.Slice<stdgo.Error> {
        {
            var __tmp__ = try {
                ...
                { _0 : (null : stdgo.fmt_test.Fmt_test.T__interface_0), _1 : false };
...
function example_printers():Void {
        ...
        var _h:stdgo.GoFloat64 = stdgo.math.Math.hypot(_a, _b);
...
function example_formats():Void {
        ...
        var _now:stdgo.time.Time.Time = stdgo.time.Time.unix((123456789i64 : stdgo.GoInt64), (0i64 : stdgo.GoInt64)).utc()?.__copy__();
        stdgo.fmt.Fmt.printf(("%v %q\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_now)), stdgo.Go.toInterface(stdgo.Go.asInterface(_now)));
    }
function testFmtInterface(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function _zeroFill(_prefix:stdgo.GoString, _width:stdgo.GoInt, _suffix:stdgo.GoString):stdgo.GoString {
        return _prefix + stdgo.strings.Strings.repeat(("0" : stdgo.GoString), _width - (_suffix.length))?.__copy__() + _suffix?.__copy__()?.__copy__();
    }
function testSprintf(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        for (__3 => _tt in _fmtTests) {
            var _s:stdgo.GoString = sprintf(_tt._fmt?.__copy__(), _tt._val)?.__copy__();
            var _i:stdgo.GoInt = stdgo.strings.Strings.index(_tt._out?.__copy__(), ("PTR" : stdgo.GoString));
            if ((_i >= (0 : stdgo.GoInt)) && (_i < _s.length)) {
                ...
                if (stdgo.strings.Strings.hasPrefix((_tt._out.__slice__(_i) : stdgo.GoString)?.__copy__(), ("PTR_b" : stdgo.GoString))) {
                    _pattern = ("PTR_b" : stdgo.GoString);
                    _chars = ("01" : stdgo.GoString);
                } else if (stdgo.strings.Strings.hasPrefix((_tt._out.__slice__(_i) : stdgo.GoString)?.__copy__(), ("PTR_o" : stdgo.GoString))) {
                    _pattern = ("PTR_o" : stdgo.GoString);
                    _chars = ("01234567" : stdgo.GoString);
                } else if (stdgo.strings.Strings.hasPrefix((_tt._out.__slice__(_i) : stdgo.GoString)?.__copy__(), ("PTR_d" : stdgo.GoString))) {
                    _pattern = ("PTR_d" : stdgo.GoString);
                    _chars = ("0123456789" : stdgo.GoString);
                } else if (stdgo.strings.Strings.hasPrefix((_tt._out.__slice__(_i) : stdgo.GoString)?.__copy__(), ("PTR_x" : stdgo.GoString))) {
                ...
                var _p:stdgo.GoString = (_s.__slice__(0, _i) : stdgo.GoString) + _pattern?.__copy__()?.__copy__();
                {
                    ...
                    stdgo.Go.cfor(_j < (_s.length), _j++, {
                        if (!stdgo.strings.Strings.containsRune(_chars?.__copy__(), (_s[(_j : stdgo.GoInt)] : stdgo.GoRune))) {
...
**/
function testComplexFormatting(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testReorder(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function benchmarkSprintfPadding(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
...
function benchmarkSprintfEmpty(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            while (_pb.next()) {
                sprintf(stdgo.Go.str()?.__copy__());
            };
...
function benchmarkSprintfString(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            while (_pb.next()) {
                sprintf(("%s" : stdgo.GoString), stdgo.Go.toInterface(("hello" : stdgo.GoString)));
            };
...
function benchmarkSprintfTruncateString(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            while (_pb.next()) {
...
function benchmarkSprintfTruncateBytes(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
...
function benchmarkSprintfSlowParsingPath(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            while (_pb.next()) {
...
function benchmarkSprintfQuoteString(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            while (_pb.next()) {
...
function benchmarkSprintfInt(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            while (_pb.next()) {
...
function benchmarkSprintfIntInt(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            while (_pb.next()) {
...
function benchmarkSprintfPrefixedInt(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            while (_pb.next()) {
...
function benchmarkSprintfFloat(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            while (_pb.next()) {
...
function benchmarkSprintfComplex(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            while (_pb.next()) {
...
function benchmarkSprintfBoolean(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            while (_pb.next()) {
...
function benchmarkSprintfHexString(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            while (_pb.next()) {
...
function benchmarkSprintfHexBytes(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
...
function benchmarkSprintfBytes(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _data = (("0123456789abcdef" : stdgo.GoString) : stdgo.Slice<stdgo.GoByte>);
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            while (_pb.next()) {
...
function benchmarkSprintfStringer(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
...
function benchmarkSprintfStructure(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _s = (stdgo.Go.setRef((new stdgo.Slice<stdgo.AnyInterface>(2, 2, stdgo.Go.toInterface((new stdgo.fmt_test.Fmt_test.SI(stdgo.Go.toInterface((12345 : stdgo.GoInt))) : stdgo.fmt_test.Fmt_test.SI)), stdgo.Go.toInterface(({
...
function benchmarkManyArgs(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
            while (_pb.next()) {
                _buf.reset();
                fprintf(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), ("%2d/%2d/%2d %d:%d:%d %s %s\n" : stdgo.GoString), stdgo.Go.toInterface((3 : stdgo.GoInt)), stdgo.Go.toInterface((4 : stdgo.GoInt)), stdgo.Go.toInterface((5 : stdgo.GoInt)), stdgo.Go.toInterface((11 : stdgo.GoInt)), stdgo.Go.toInterface((12 : stdgo.GoInt)), stdgo.Go.toInterface((13 : stdgo.GoInt)), stdgo.Go.toInterface(("hello" : stdgo.GoString)), stdgo.Go.toInterface(("world" : stdgo.GoString)));
            };
        });
    }
function benchmarkFprintInt(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
                _buf.reset();
                fprint(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), stdgo.Go.toInterface((123456 : stdgo.GoInt)));
            });
        };
    }
function benchmarkFprintfBytes(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        ...
        var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        {
            ...
            stdgo.Go.cfor(_i < _b.n, _i++, {
                _buf.reset();
                fprintf(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), ("%s" : stdgo.GoString), stdgo.Go.toInterface(_data));
            });
        };
    }
function benchmarkFprintIntNoAlloc(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        ...
        var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        {
            ...
            stdgo.Go.cfor(_i < _b.n, _i++, {
                _buf.reset();
                fprint(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), _x);
            });
        };
    }
function testCountMallocs(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        } else if (stdgo.runtime.Runtime.gomaxprocs((0 : stdgo.GoInt)) > (1 : stdgo.GoInt)) {
        ...
        for (__27 => _mt in _mallocTest) {
            var _mallocs:stdgo.GoFloat64 = stdgo.testing.Testing.allocsPerRun((100 : stdgo.GoInt), _mt._fn);
            {
...
function testFlagParser(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _flagprinter:T_flagPrinter = ({} : stdgo.fmt_test.Fmt_test.T_flagPrinter);
        for (__3 => _tt in _flagtests) {
            var _s:stdgo.GoString = sprintf(_tt._in?.__copy__(), stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_flagprinter) : stdgo.Ref<stdgo.fmt_test.Fmt_test.T_flagPrinter>))))?.__copy__();
            if (_s != (_tt._out)) {
...
function testSlicePrinter(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
/**
    ...
    // print order.
**/
function _presentInMap(_s:stdgo.GoString, _a:stdgo.Slice<stdgo.GoString>, _t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < (_a.length), _i++, {
                var _loc:stdgo.GoInt = stdgo.strings.Strings.index(_s?.__copy__(), _a[(_i : stdgo.GoInt)]?.__copy__());
...
function testMapPrinter(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _m0 = ({
            final x = new stdgo.GoMap.GoIntMap<stdgo.GoString>();
            x.__defaultValue__ = () -> ("" : stdgo.GoString);
            @:mergeBlock {};
        ...
        if (!stdgo.strings.Strings.hasPrefix(sprint(stdgo.Go.toInterface((stdgo.Go.setRef(_m1) : stdgo.Ref<stdgo.GoMap<stdgo.GoInt, stdgo.GoString>>)))?.__copy__(), ("&" : stdgo.GoString))) {
...
function testEmptyMap(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
...
**/
function testBlank(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
**/
function testBlankln(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
**/
function testFormatterPrintln(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testWidthAndPrecision(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testPanics(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testBadVerbRecursion(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _failed:Bool = false;
        var _r = (stdgo.Go.setRef((new stdgo.fmt_test.Fmt_test.Recur((3 : stdgo.GoInt), stdgo.Go.pointer(_failed)) : stdgo.fmt_test.Fmt_test.Recur)) : stdgo.Ref<stdgo.fmt_test.Fmt_test.Recur>);
        sprintf(("recur@%p value: %d\n" : stdgo.GoString), stdgo.Go.toInterface((stdgo.Go.setRef(_r) : stdgo.Ref<stdgo.Ref<stdgo.fmt_test.Fmt_test.Recur>>)), stdgo.Go.toInterface(_r._i));
        if (_failed) {
            _t.error(stdgo.Go.toInterface(("fail with pointer" : stdgo.GoString)));
        };
        _failed = false;
        _r = (stdgo.Go.setRef((new stdgo.fmt_test.Fmt_test.Recur((4 : stdgo.GoInt), stdgo.Go.pointer(_failed)) : stdgo.fmt_test.Fmt_test.Recur)) : stdgo.Ref<stdgo.fmt_test.Fmt_test.Recur>);
...
function testIsSpace(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {
...
function testFormatterFlags(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testParsenum(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testAppendf(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testAppendln(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _b = new stdgo.Slice<stdgo.GoUInt8>((100 : stdgo.GoInt).toBasic(), 0).__setNumber32__();
        _b = (_b.__slice__(0, stdgo.Go.copySlice(_b, ("hello " : stdgo.GoString))) : stdgo.Slice<stdgo.GoUInt8>);
...
function exampleGoStringer():Void {
        var _p1:stdgo.fmt_test.Fmt_test.Person = ({ name : ("Warren" : stdgo.GoString), age : (31u32 : stdgo.GoUInt), addr : (stdgo.Go.setRef(({ city : ("Denver" : stdgo.GoString), state : ("CO" : stdgo.GoString), country : ("U.S.A." : stdgo.GoString) } : stdgo.fmt_test.Fmt_test.Address)) : stdgo.Ref<stdgo.fmt_test.Fmt_test.Address>) } : stdgo.fmt_test.Fmt_test.Person);
        stdgo.fmt.Fmt.printf(("%#v\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_p1)));
        var _p2:stdgo.fmt_test.Fmt_test.Person = ({ name : ("Theia" : stdgo.GoString), age : (4u32 : stdgo.GoUInt) } : stdgo.fmt_test.Fmt_test.Person);
        stdgo.fmt.Fmt.printf(("%#v\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_p2)));
    }
function _testScan(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _f:stdgo.GoString -> stdgo.io.Io.Reader, _scan:(_r:stdgo.io.Io.Reader, _a:haxe.Rest<stdgo.AnyInterface>) -> { var _0 : stdgo.GoInt; var _1 : stdgo.Error; }):Void {
...
function testScan(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        for (__3 => _r in _readers) {
            _t.run(_r._name?.__copy__(), function(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
                _testScan(_t, _r._f, fscan);
            });
        };
    }
function testScanln(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        for (__3 => _r in _readers) {
            _t.run(_r._name?.__copy__(), function(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testScanf(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testScanOverflow(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function _verifyNaN(_str:stdgo.GoString, _t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _f:stdgo.GoFloat64 = (0 : stdgo.GoFloat64);
        ...
        var __tmp__ = fscan(stdgo.Go.asInterface(stdgo.strings.Strings.newReader(_text?.__copy__())), stdgo.Go.toInterface(stdgo.Go.pointer(_f)), stdgo.Go.toInterface(stdgo.Go.pointer(_f32)), stdgo.Go.toInterface(stdgo.Go.pointer(_f64))), _n:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
        ...
        if ((!stdgo.math.Math.isNaN((_f : stdgo.GoFloat64)) || !stdgo.math.Math.isNaN((_f32 : stdgo.GoFloat64))) || !stdgo.math.Math.isNaN(_f64)) {
...
function _verifyInf(_str:stdgo.GoString, _t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _f:stdgo.GoFloat64 = (0 : stdgo.GoFloat64);
        var _f32:stdgo.GoFloat32 = (0 : stdgo.GoFloat32);
        var _f64:stdgo.GoFloat64 = (0 : stdgo.GoFloat64);
        var _text:stdgo.GoString = _str + (" " : stdgo.GoString)?.__copy__() + _str?.__copy__() + (" " : stdgo.GoString)?.__copy__() + _str?.__copy__()?.__copy__();
        ...
        if ((!stdgo.math.Math.isInf((_f : stdgo.GoFloat64), _sign) || !stdgo.math.Math.isInf((_f32 : stdgo.GoFloat64), _sign)) || !stdgo.math.Math.isInf(_f64, _sign)) {
...
function testInf(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function _testScanfMulti(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _f:stdgo.GoString -> stdgo.io.Io.Reader):Void {
        var _sliceType:stdgo.reflect.Reflect.Type_ = stdgo.reflect.Reflect.typeOf(stdgo.Go.toInterface(new stdgo.Slice<stdgo.AnyInterface>((1 : stdgo.GoInt).toBasic(), 0)));
        for (__3 => _test in _multiTests) {
            ...
            var _resultVal:stdgo.reflect.Reflect.Value = stdgo.reflect.Reflect.makeSlice(_sliceType, _n, _n)?.__copy__();
            {
                ...
                stdgo.Go.cfor(_i < _n, _i++, {
                    var _v:stdgo.reflect.Reflect.Value = stdgo.reflect.Reflect.valueOf(_test._in[(_i : stdgo.GoInt)]).elem()?.__copy__();
...
function testScanfMulti(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        for (__3 => _r in _readers) {
            _t.run(_r._name?.__copy__(), function(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testScanMultiple(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
**/
function testScanEmpty(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testScanNotPointer(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        } else if (!stdgo.strings.Strings.contains(_err.error()?.__copy__(), ("pointer" : stdgo.GoString))) {
            _t.errorf(("expected pointer error scanning non-pointer, got: %s" : stdgo.GoString), stdgo.Go.toInterface(_err));
        };
    }
function testScanlnNoNewline(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _a:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        } else if (!stdgo.strings.Strings.contains(_err.error()?.__copy__(), ("newline" : stdgo.GoString))) {
            _t.errorf(("expected newline error scanning string missing newline, got: %s" : stdgo.GoString), stdgo.Go.toInterface(_err));
        };
    }
function testScanlnWithMiddleNewline(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
**/
function testEOF(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _ec = (stdgo.Go.setRef((new stdgo.fmt_test.Fmt_test.T_eofCounter(stdgo.strings.Strings.newReader(("123\n" : stdgo.GoString)), (0 : stdgo.GoInt)) : stdgo.fmt_test.Fmt_test.T_eofCounter)) : stdgo.Ref<stdgo.fmt_test.Fmt_test.T_eofCounter>);
        var _a:stdgo.GoInt = (0 : stdgo.GoInt);
...
**/
function testEOFAtEndOfInput(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testEOFAllTypes(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
**/
function testUnreadRuneWithBufio(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testMultiLine(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
/**
    ...
    // 3481.
**/
function testLineByLineFscanf(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testScanStateCount(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        var __tmp__ = sscanf(("12➂" : stdgo.GoString), ("%c%c%c" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_a) : stdgo.Ref<stdgo.fmt_test.Fmt_test.T_runeScanner>))), stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_b) : stdgo.Ref<stdgo.fmt_test.Fmt_test.T_runeScanner>))), stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_c) : stdgo.Ref<stdgo.fmt_test.Fmt_test.T_runeScanner>)))), _n:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
...
**/
function _scanInts(_r:stdgo.Ref<RecursiveInt>, _b:stdgo.Ref<stdgo.bytes.Bytes.Buffer>):stdgo.Error {
        ...
        var _next = (stdgo.Go.setRef(({} : stdgo.fmt_test.Fmt_test.RecursiveInt)) : stdgo.Ref<stdgo.fmt_test.Fmt_test.RecursiveInt>);
...
function _makeInts(_n:stdgo.GoInt):stdgo.Slice<stdgo.GoByte> {
        var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        fprintf(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), ("1" : stdgo.GoString));
        {
            var _i:stdgo.GoInt = (1 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _n, _i++, {
                fprintf(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), (".%d" : stdgo.GoString), stdgo.Go.toInterface(_i + (1 : stdgo.GoInt)));
            });
        };
        return _buf.bytes();
    }
function testScanInts(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        _testScanInts(_t, _scanInts);
        _testScanInts(_t, function(_r:stdgo.Ref<RecursiveInt>, _b:stdgo.Ref<stdgo.bytes.Bytes.Buffer>):stdgo.Error {
            var _err:stdgo.Error = (null : stdgo.Error);
            {
...
function _testScanInts(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _scan:(stdgo.Ref<RecursiveInt>, stdgo.Ref<stdgo.bytes.Bytes.Buffer>) -> stdgo.Error):Void {
        var _r = (stdgo.Go.setRef(({} : stdgo.fmt_test.Fmt_test.RecursiveInt)) : stdgo.Ref<stdgo.fmt_test.Fmt_test.RecursiveInt>);
...
function benchmarkScanInts(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.stopTimer();
        var _ints = _makeInts((800 : stdgo.GoInt));
        var _r:RecursiveInt = ({} : stdgo.fmt_test.Fmt_test.RecursiveInt);
        {
            ...
            stdgo.Go.cfor(_i < _b.n, _i++, {
                var _buf = stdgo.bytes.Bytes.newBuffer(_ints);
                _b.startTimer();
                _scanInts((stdgo.Go.setRef(_r) : stdgo.Ref<stdgo.fmt_test.Fmt_test.RecursiveInt>), _buf);
                _b.stopTimer();
            });
        };
    }
function benchmarkScanRecursiveInt(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.stopTimer();
        var _ints = _makeInts((800 : stdgo.GoInt));
        var _r:RecursiveInt = ({} : stdgo.fmt_test.Fmt_test.RecursiveInt);
        {
            ...
            stdgo.Go.cfor(_i < _b.n, _i++, {
                var _buf = stdgo.bytes.Bytes.newBuffer(_ints);
                _b.startTimer();
                fscan(stdgo.Go.asInterface(_buf), stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_r) : stdgo.Ref<stdgo.fmt_test.Fmt_test.RecursiveInt>))));
                _b.stopTimer();
            });
        };
    }
function benchmarkScanRecursiveIntReaderWrapper(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.stopTimer();
        var _ints = _makeInts((800 : stdgo.GoInt));
        var _r:RecursiveInt = ({} : stdgo.fmt_test.Fmt_test.RecursiveInt);
        {
...
**/
function testHexBytes(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testScanNewlinesAreSpaces(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __0:stdgo.GoInt = (0 : stdgo.GoInt), __1:stdgo.GoInt = (0 : stdgo.GoInt), _b:stdgo.GoInt = __1, _a:stdgo.GoInt = __0;
...
function testScanlnNewlinesTerminate(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __0:stdgo.GoInt = (0 : stdgo.GoInt), __1:stdgo.GoInt = (0 : stdgo.GoInt), _b:stdgo.GoInt = __1, _a:stdgo.GoInt = __0;
...
function testScanfNewlineMatchFormat(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __0:stdgo.GoInt = (0 : stdgo.GoInt), __1:stdgo.GoInt = (0 : stdgo.GoInt), _b:stdgo.GoInt = __1, _a:stdgo.GoInt = __0;
...
({ _name : ("space vs newline no-percent 1111" : stdgo.GoString), _text : ("1 \n 2" : stdgo.GoString), _format : ("1 \n 2" : stdgo.GoString), _count : (0 : stdgo.GoInt), _ok : true } : T__struct_16)) : stdgo.Slice<T__struct_16>);
        for (__3 => _test in _tests) {
            ...
            var _err:stdgo.Error = (null : stdgo.Error);
            if (stdgo.strings.Strings.contains(_test._format?.__copy__(), ("%" : stdgo.GoString))) {
                {
...
function testHexByte(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _h:T_hexBytes = new stdgo.fmt_test.Fmt_test.T_hexBytes(...[for (i in 0 ... 2) (0 : stdgo.GoUInt8)]);
        var __tmp__ = sscanln(("0123\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_h) : stdgo.Ref<stdgo.fmt_test.Fmt_test.T_hexBytes>)))), _n:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _t.fatal(stdgo.Go.toInterface(_err));
        };
        if (_n != ((1 : stdgo.GoInt))) {
...
function testFormatString(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
({ _width : (7 : stdgo.GoInt), _prec : (3 : stdgo.GoInt), _flags : ("0" : stdgo.GoString), _result : ("%07.3x" : stdgo.GoString) } : T__struct_17)) : stdgo.Slice<T__struct_17>);
        for (__3 => _test in _tests) {
            var _got:stdgo.GoString = stdgo.fmt.Fmt.formatString(stdgo.Go.asInterface(_mkState(_test._width, _test._prec, _test._flags?.__copy__())), (120 : stdgo.GoInt32))?.__copy__();
...
function exampleStringer():Void {
        var _a:stdgo.fmt_test.Fmt_test.Animal = ({ name : ("Gopher" : stdgo.GoString), age : (2u32 : stdgo.GoUInt) } : stdgo.fmt_test.Fmt_test.Animal);
        stdgo.fmt.Fmt.println(stdgo.Go.toInterface(stdgo.Go.asInterface(_a)));
    }
function _check(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _got:stdgo.GoString, _want:stdgo.GoString):Void {
        if (_got != (_want)) {
            _t.error(stdgo.Go.toInterface(_got), stdgo.Go.toInterface(("!=" : stdgo.GoString)), stdgo.Go.toInterface(_want));
        };
    }
function testStringer(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        _s = sprintf(("%v %v" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface((true : TB))), stdgo.Go.toInterface(stdgo.Go.asInterface(((("x" : stdgo.GoString) : stdgo.fmt_test.Fmt_test.TS) : TS))))?.__copy__();
    ...
    **/
    ...
    static public function goString( _p:Person):stdgo.GoString {
        ...
        if (_p.addr != null && ((_p.addr : Dynamic).__nil__ == null || !(_p.addr : Dynamic).__nil__)) {
            return stdgo.fmt.Fmt.sprintf(("Person{Name: %q, Age: %d, Addr: &Address{City: %q, State: %q, Country: %q}}" : stdgo.GoString), stdgo.Go.toInterface(_p.name), stdgo.Go.toInterface((_p.age : stdgo.GoInt)), stdgo.Go.toInterface(_p.addr.city), stdgo.Go.toInterface(_p.addr.state), stdgo.Go.toInterface(_p.addr.country))?.__copy__();
        };
        return stdgo.fmt.Fmt.sprintf(("Person{Name: %q, Age: %d}" : stdgo.GoString), stdgo.Go.toInterface(_p.name), stdgo.Go.toInterface((_p.age : stdgo.GoInt)))?.__copy__();
    }
}
...
@:keep @:allow(stdgo.fmt_test.Fmt_test.Animal_asInterface) class Animal_static_extension {
    ...
    **/
    ...
    static public function string( _a:Animal):stdgo.GoString {
        ...
        return stdgo.fmt.Fmt.sprintf(("%v (%d)" : stdgo.GoString), stdgo.Go.toInterface(_a.name), stdgo.Go.toInterface(_a.age))?.__copy__();
    }
}
...
@:keep @:allow(stdgo.fmt_test.Fmt_test.T_writeStringFormatter_asInterface) class T_writeStringFormatter_static_extension {
    ...
    static public function format( _sf:T_writeStringFormatter, _f:State, _c:stdgo.GoRune):Void {
        ...
        {
            var __tmp__ = try {
                { _0 : (stdgo.Go.typeAssert((stdgo.Go.toInterface(_f) : stdgo.io.Io.StringWriter)) : stdgo.io.Io.StringWriter), _1 : true };
            } catch(_) {
...
@:keep @:allow(stdgo.fmt_test.Fmt_test.T_hexBytes_asInterface) class T_hexBytes_static_extension {
    ...
    static public function scan( _h:stdgo.Ref<T_hexBytes>, _ss:ScanState, _verb:stdgo.GoRune):stdgo.Error {
        ...
        stdgo.Go.copySlice((((_h : stdgo.fmt_test.Fmt_test.T_hexBytes)).__slice__(0) : stdgo.Slice<stdgo.GoUInt8>), _b);
        return _err;
    }
}
