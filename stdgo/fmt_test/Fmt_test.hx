...
var naN:GoFloat64 = stdgo.math.Math.naN();
private var _posInf:GoFloat64 = stdgo.math.Math.inf((1 : GoInt));
private var _negInf:GoFloat64 = stdgo.math.Math.inf((-1 : GoInt));
private var _intVar:GoInt = (0 : GoInt);
private var _array:GoArray<GoInt> = (new GoArray<GoInt>((1 : GoInt), (2 : GoInt), (3 : GoInt), (4 : GoInt), (5 : GoInt)) : GoArray<GoInt>);

private var _iarray:GoArray<AnyInterface> = (new GoArray<AnyInterface>(Go.toInterface((1 : GoInt)), Go.toInterface(("hello" : GoString)),
	Go.toInterface((2.5 : GoFloat64)), (null : AnyInterface)) : GoArray<AnyInterface>);

private var _slice:Slice<GoInt> = (_array.__slice__(0) : Slice<GoInt>);
private var _islice:Slice<AnyInterface> = (_iarray.__slice__(0) : Slice<AnyInterface>);

private var _barray:GoArray<stdgo.fmt_test.Fmt_test.T_renamedUint8> = (new GoArray<stdgo.fmt_test.Fmt_test.T_renamedUint8>((1 : stdgo.fmt_test.Fmt_test.T_renamedUint8),
	(2 : stdgo.fmt_test.Fmt_test.T_renamedUint8), (3 : stdgo.fmt_test.Fmt_test.T_renamedUint8),
	(4 : stdgo.fmt_test.Fmt_test.T_renamedUint8), (5 : stdgo.fmt_test.Fmt_test.T_renamedUint8)) : GoArray<stdgo.fmt_test.Fmt_test.T_renamedUint8>);

private var _bslice:Slice<stdgo.fmt_test.Fmt_test.T_renamedUint8> = (_barray.__slice__(0) : Slice<stdgo.fmt_test.Fmt_test.T_renamedUint8>);

private var _byteStringerSlice:Slice<stdgo.fmt_test.Fmt_test.T_byteStringer> = (new Slice<stdgo.fmt_test.Fmt_test.T_byteStringer>(0, 0,
	(104 : stdgo.fmt_test.Fmt_test.T_byteStringer), (101 : stdgo.fmt_test.Fmt_test.T_byteStringer), (108 : stdgo.fmt_test.Fmt_test.T_byteStringer),
	(108 : stdgo.fmt_test.Fmt_test.T_byteStringer), (111 : stdgo.fmt_test.Fmt_test.T_byteStringer)) : Slice<stdgo.fmt_test.Fmt_test.T_byteStringer>);

private var _byteFormatterSlice:Slice<stdgo.fmt_test.Fmt_test.T_byteFormatter> = (new Slice<stdgo.fmt_test.Fmt_test.T_byteFormatter>(0, 0,
	(104 : stdgo.fmt_test.Fmt_test.T_byteFormatter), (101 : stdgo.fmt_test.Fmt_test.T_byteFormatter), (108 : stdgo.fmt_test.Fmt_test.T_byteFormatter),
	(108 : stdgo.fmt_test.Fmt_test.T_byteFormatter), (111 : stdgo.fmt_test.Fmt_test.T_byteFormatter)) : Slice<stdgo.fmt_test.Fmt_test.T_byteFormatter>);

private var _fmtTests:Slice<T__struct_2> = (new Slice<T__struct_2>(0, 0,
	...
	({_fmt: ("%s" : GoString), _val: Go.toInterface((new GoArray<GoUInt8>((97 : GoUInt8), (98 : GoUInt8),
		(99 : GoUInt8)) : GoArray<GoUInt8>)), _out: ("abc" : GoString)} : T__struct_2),
	({_fmt: ("%s" : GoString), _val: Go.toInterface(((new GoArray<GoUInt8>((97 : GoUInt8), (98 : GoUInt8),
		(99 : GoUInt8)) : GoArray<GoUInt8>) : Ref<GoArray<GoUInt8>>)), _out: ("&abc" : GoString)} : T__struct_2),
	...
	({_fmt: ("%5s" : GoString), _val: Go.toInterface(("abcdefghijklmnopqrstuvwxyz" : GoString)),
		_out: ("abcdefghijklmnopqrstuvwxyz" : GoString)} : T__struct_2),
	({_fmt: ("%5s" : GoString), _val: Go.toInterface((("abcdefghijklmnopqrstuvwxyz" : GoString) : Slice<GoByte>)),
		_out: ("abcdefghijklmnopqrstuvwxyz" : GoString)} : T__struct_2),
	...
	({_fmt: ("%.5q" : GoString), _val: Go.toInterface((("abcdefghijklmnopqrstuvwxyz" : GoString) : Slice<GoByte>)),
		_out: ("\"abcde\"" : GoString)} : T__struct_2),
	({_fmt: ("%.5x" : GoString), _val: Go.toInterface(("abcdefghijklmnopqrstuvwxyz" : GoString)), _out: ("6162636465" : GoString)} : T__struct_2),
	({_fmt: ("%.5x" : GoString), _val: Go.toInterface((("abcdefghijklmnopqrstuvwxyz" : GoString) : Slice<GoByte>)),
		_out: ("6162636465" : GoString)} : T__struct_2),
	...
	({_fmt: ("%b" : GoString), _val: Go.toInterface(("18446744073709551615" : GoUInt64)),
		_out: ("1111111111111111111111111111111111111111111111111111111111111111" : GoString)} : T__struct_2),
	({_fmt: ("%b" : GoString), _val: Go.toInterface((("-9223372036854775808" : GoInt64) : GoInt64)), _out: _zeroFill(("-1" : GoString), (63 : GoInt),
		Go.str())} : T__struct_2),
	...
	({_fmt: ("%#-014.6U" : GoString), _val: Go.toInterface((8984 : GoInt32)), _out: ("U+002318 \'⌘\'  " : GoString)} : T__struct_2),
	({_fmt: ("%.68U" : GoString), _val: Go.toInterface((("42" : GoUInt) : GoUInt)), _out: _zeroFill(("U+" : GoString), (68 : GoInt),
		("2A" : GoString))} : T__struct_2),
	({_fmt: ("%#.68U" : GoString), _val: Go.toInterface((26085 : GoInt32)), _out: _zeroFill(("U+" : GoString), (68 : GoInt), ("65E5" : GoString))
		+ (" \'日\'" : GoString)} : T__struct_2),
	...
	({_fmt: ("%+.f" : GoString), _val: Go.toInterface(((0 : GoFloat64) + new GoComplex128(0, 0))), _out: ("(+0+0i)" : GoString)} : T__struct_2),
	({_fmt: ("% +.f" : GoString), _val: Go.toInterface(((0 : GoFloat64) + new GoComplex128(0, 0))), _out: ("(+0+0i)" : GoString)} : T__struct_2),
	({_fmt: ("%+.3e" : GoString), _val: Go.toInterface(((0 : GoFloat64) + new GoComplex128(0,
		0))), _out: ("(+0.000e+00+0.000e+00i)" : GoString)} : T__struct_2),
	({_fmt: ("%+.3x" : GoString), _val: Go.toInterface(((0 : GoFloat64) + new GoComplex128(0,
		0))), _out: ("(+0x0.000p+00+0x0.000p+00i)" : GoString)} : T__struct_2),
	...
	({_fmt: ("%+.3e" : GoString), _val: Go.toInterface(((1 : GoFloat64) + new GoComplex128(0,
		2))), _out: ("(+1.000e+00+2.000e+00i)" : GoString)} : T__struct_2),
	({_fmt: ("%+.3x" : GoString), _val: Go.toInterface(((1 : GoFloat64) + new GoComplex128(0,
		2))), _out: ("(+0x1.000p+00+0x1.000p+01i)" : GoString)} : T__struct_2),
	...
	({_fmt: ("%.3f" : GoString), _val: Go.toInterface(((0 : GoFloat64) + new GoComplex128(0, 0))), _out: ("(0.000+0.000i)" : GoString)} : T__struct_2),
	({_fmt: ("%.3F" : GoString), _val: Go.toInterface(((0 : GoFloat64) + new GoComplex128(0, 0))), _out: ("(0.000+0.000i)" : GoString)} : T__struct_2),
	({_fmt: ("%.3F" : GoString), _val: Go.toInterface(((0 : GoFloat64) + new GoComplex128(0,
		0) : GoComplex64)), _out: ("(0.000+0.000i)" : GoString)} : T__struct_2),
	({_fmt: ("%.3g" : GoString), _val: Go.toInterface(((0 : GoFloat64) + new GoComplex128(0, 0))), _out: ("(0+0i)" : GoString)} : T__struct_2),
	...
	({_fmt: ("%#g" : GoString), _val: Go.toInterface(((123456 : GoFloat64) + new GoComplex128(0,
		789012))), _out: ("(123456.+789012.i)" : GoString)} : T__struct_2),
	({_fmt: ("%#g" : GoString), _val: Go.toInterface(((0 : GoFloat64) + new GoComplex128(0,
		1e-10))), _out: ("(0.00000+1.00000e-10i)" : GoString)} : T__struct_2),
	({_fmt: ("%#g" : GoString), _val: Go.toInterface(((-1e+10 : GoFloat64) + new GoComplex128(0,
		-1.11e+100))), _out: ("(-1.00000e+10-1.11000e+100i)" : GoString)} : T__struct_2),
	...
	({_fmt: ("%#.0x" : GoString), _val: Go.toInterface(((1.23 : GoFloat64) + new GoComplex128(0,
		1))), _out: ("(0x1.p+00+0x1.p+00i)" : GoString)} : T__struct_2),
	...
	({_fmt: ("%#.4e" : GoString), _val: Go.toInterface(((123 : GoFloat64) + new GoComplex128(0,
		1))), _out: ("(1.2300e+02+1.0000e+00i)" : GoString)} : T__struct_2),
	({_fmt: ("%#.4x" : GoString), _val: Go.toInterface(((123 : GoFloat64) + new GoComplex128(0,
		1))), _out: ("(0x1.ec00p+06+0x1.0000p+00i)" : GoString)} : T__struct_2),
	({_fmt: ("%#.4g" : GoString), _val: Go.toInterface(((123 : GoFloat64) + new GoComplex128(0, 1.23))), _out: ("(123.0+1.230i)" : GoString)} : T__struct_2),
	({_fmt: ("%#12.5g" : GoString), _val: Go.toInterface(((0 : GoFloat64) + new GoComplex128(0,
		100000))), _out: ("(      0.0000 +1.0000e+05i)" : GoString)} : T__struct_2),
	({_fmt: ("%#12.5g" : GoString), _val: Go.toInterface(((1.23e+06 : GoFloat64) + new GoComplex128(0,
		0))), _out: ("(  1.2300e+06     +0.0000i)" : GoString)} : T__struct_2),
	({_fmt: ("%b" : GoString), _val: Go.toInterface(((1 : GoFloat64) + new GoComplex128(0,
		2))), _out: ("(4503599627370496p-52+4503599627370496p-51i)" : GoString)} : T__struct_2),
	({_fmt: ("%b" : GoString), _val: Go.toInterface(((1 : GoFloat64) + new GoComplex128(0,
		2) : GoComplex64)), _out: ("(8388608p-23+8388608p-22i)" : GoString)} : T__struct_2),
	({_fmt: ("%#b" : GoString), _val: Go.toInterface(((1 : GoFloat64) + new GoComplex128(0,
		2))), _out: ("(4503599627370496p-52+4503599627370496p-51i)" : GoString)} : T__struct_2),
	({_fmt: ("%.4b" : GoString), _val: Go.toInterface(((1 : GoFloat64) + new GoComplex128(0,
		2))), _out: ("(4503599627370496p-52+4503599627370496p-51i)" : GoString)} : T__struct_2),
	({_fmt: ("%.4b" : GoString), _val: Go.toInterface(((1 : GoFloat64) + new GoComplex128(0,
		2) : GoComplex64)), _out: ("(8388608p-23+8388608p-22i)" : GoString)} : T__struct_2),
	...
	({_fmt: ("%v" : GoString), _val: Go.toInterface((_barray : Ref<GoArray<stdgo.fmt_test.Fmt_test.T_renamedUint8>>)),
		_out: ("&[1 2 3 4 5]" : GoString)} : T__struct_2),
	...
	({_fmt: ("%v" : GoString), _val: Go.toInterface((_bslice : Ref<Slice<stdgo.fmt_test.Fmt_test.T_renamedUint8>>)),
		_out: ("&[1 2 3 4 5]" : GoString)} : T__struct_2),
	({_fmt: ("%b" : GoString), _val: Go.toInterface((new GoArray<GoUInt8>((65 : GoUInt8), (66 : GoUInt8),
		(67 : GoUInt8)) : GoArray<GoUInt8>)), _out: ("[1000001 1000010 1000011]" : GoString)} : T__struct_2),
	({_fmt: ("%c" : GoString), _val: Go.toInterface((new GoArray<GoUInt8>((65 : GoUInt8), (66 : GoUInt8),
		(67 : GoUInt8)) : GoArray<GoUInt8>)), _out: ("[A B C]" : GoString)} : T__struct_2),
	({_fmt: ("%d" : GoString), _val: Go.toInterface((new GoArray<GoUInt8>((65 : GoUInt8), (66 : GoUInt8),
		(67 : GoUInt8)) : GoArray<GoUInt8>)), _out: ("[65 66 67]" : GoString)} : T__struct_2),
	({_fmt: ("%o" : GoString), _val: Go.toInterface((new GoArray<GoUInt8>((65 : GoUInt8), (66 : GoUInt8),
		(67 : GoUInt8)) : GoArray<GoUInt8>)), _out: ("[101 102 103]" : GoString)} : T__struct_2),
	({_fmt: ("%U" : GoString), _val: Go.toInterface((new GoArray<GoUInt8>((65 : GoUInt8), (66 : GoUInt8),
		(67 : GoUInt8)) : GoArray<GoUInt8>)), _out: ("[U+0041 U+0042 U+0043]" : GoString)} : T__struct_2),
	({_fmt: ("%v" : GoString), _val: Go.toInterface((new GoArray<GoUInt8>((65 : GoUInt8), (66 : GoUInt8),
		(67 : GoUInt8)) : GoArray<GoUInt8>)), _out: ("[65 66 67]" : GoString)} : T__struct_2),
	...
	({_fmt: ("%6v" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (1 : GoUInt8), (11 : GoUInt8),
		(111 : GoUInt8)) : Slice<GoUInt8>)), _out: ("[     1     11    111]" : GoString)} : T__struct_2),
	({_fmt: ("%06v" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (1 : GoUInt8), (11 : GoUInt8),
		(111 : GoUInt8)) : Slice<GoUInt8>)), _out: ("[000001 000011 000111]" : GoString)} : T__struct_2),
	({_fmt: ("%-6v" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (1 : GoUInt8), (11 : GoUInt8),
		(111 : GoUInt8)) : Slice<GoUInt8>)), _out: ("[1      11     111   ]" : GoString)} : T__struct_2),
	({_fmt: ("%-06v" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (1 : GoUInt8), (11 : GoUInt8),
		(111 : GoUInt8)) : Slice<GoUInt8>)), _out: ("[1      11     111   ]" : GoString)} : T__struct_2),
	({_fmt: ("%#v" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (1 : GoUInt8), (11 : GoUInt8),
		(111 : GoUInt8)) : Slice<GoUInt8>)), _out: ("[]byte{0x1, 0xb, 0x6f}" : GoString)} : T__struct_2),
	({_fmt: ("%#6v" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (1 : GoUInt8), (11 : GoUInt8),
		(111 : GoUInt8)) : Slice<GoUInt8>)), _out: ("[]byte{   0x1,    0xb,   0x6f}" : GoString)} : T__struct_2),
	({_fmt: ("%#06v" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (1 : GoUInt8), (11 : GoUInt8),
		(111 : GoUInt8)) : Slice<GoUInt8>)), _out: ("[]byte{0x000001, 0x00000b, 0x00006f}" : GoString)} : T__struct_2),
	({_fmt: ("%#-6v" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (1 : GoUInt8), (11 : GoUInt8),
		(111 : GoUInt8)) : Slice<GoUInt8>)), _out: ("[]byte{0x1   , 0xb   , 0x6f  }" : GoString)} : T__struct_2),
	({_fmt: ("%#-06v" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (1 : GoUInt8), (11 : GoUInt8),
		(111 : GoUInt8)) : Slice<GoUInt8>)), _out: ("[]byte{0x1   , 0xb   , 0x6f  }" : GoString)} : T__struct_2),
	({_fmt: ("% v" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (1 : GoUInt8), (11 : GoUInt8),
		(111 : GoUInt8)) : Slice<GoUInt8>)), _out: ("[ 1  11  111]" : GoString)} : T__struct_2),
	({_fmt: ("%+v" : GoString), _val: Go.toInterface((new GoArray<GoUInt8>((1 : GoUInt8), (11 : GoUInt8),
		(111 : GoUInt8)) : GoArray<GoUInt8>)), _out: ("[1 11 111]" : GoString)} : T__struct_2),
	({_fmt: ("%# -6v" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (1 : GoUInt8), (11 : GoUInt8),
		(111 : GoUInt8)) : Slice<GoUInt8>)), _out: ("[]byte{ 0x1  ,  0xb  ,  0x6f }" : GoString)} : T__struct_2),
	({_fmt: ("%#+-6v" : GoString), _val: Go.toInterface((new GoArray<GoUInt8>((1 : GoUInt8), (11 : GoUInt8),
		(111 : GoUInt8)) : GoArray<GoUInt8>)), _out: ("[3]uint8{0x1   , 0xb   , 0x6f  }" : GoString)} : T__struct_2),
	({_fmt: ("% d" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (1 : GoUInt8), (11 : GoUInt8),
		(111 : GoUInt8)) : Slice<GoUInt8>)), _out: ("[ 1  11  111]" : GoString)} : T__struct_2),
	({_fmt: ("%+d" : GoString), _val: Go.toInterface((new GoArray<GoUInt8>((1 : GoUInt8), (11 : GoUInt8),
		(111 : GoUInt8)) : GoArray<GoUInt8>)), _out: ("[+1 +11 +111]" : GoString)} : T__struct_2),
	({_fmt: ("%# -6d" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (1 : GoUInt8), (11 : GoUInt8),
		(111 : GoUInt8)) : Slice<GoUInt8>)), _out: ("[ 1      11     111  ]" : GoString)} : T__struct_2),
	({_fmt: ("%#+-6d" : GoString), _val: Go.toInterface((new GoArray<GoUInt8>((1 : GoUInt8), (11 : GoUInt8),
		(111 : GoUInt8)) : GoArray<GoUInt8>)), _out: ("[+1     +11    +111  ]" : GoString)} : T__struct_2),
	...
	({_fmt: ("%v" : GoString), _val: Go.toInterface((new A((1 : GoInt), ("2" : GoUInt), ("a" : GoString),
		(new Slice<GoInt>(0, 0, (1 : GoInt), (2 : GoInt)) : Slice<GoInt>)) : A)), _out: ("{1 2 a [1 2]}" : GoString)} : T__struct_2),
	({_fmt: ("%+v" : GoString), _val: Go.toInterface((new A((1 : GoInt), ("2" : GoUInt), ("a" : GoString),
		(new Slice<GoInt>(0, 0, (1 : GoInt), (2 : GoInt)) : Slice<GoInt>)) : A)), _out: ("{i:1 j:2 s:a x:[1 2]}" : GoString)} : T__struct_2),
	({_fmt: ("%+v" : GoString), _val: Go.toInterface((new B((1 : stdgo.fmt_test.Fmt_test.I),
		(2 : GoInt)) : B)), _out: ("{I:<1> j:2}" : GoString)} : T__struct_2),
	({_fmt: ("%+v" : GoString), _val: Go.toInterface((new C((1 : GoInt),
		(new B((2 : stdgo.fmt_test.Fmt_test.I), (3 : GoInt)) : B)) : C)), _out: ("{i:1 B:{I:<2> j:3}}" : GoString)} : T__struct_2),
	...
	({_fmt: ("%# x" : GoString), _val: Go.toInterface(Go.asInterface(((23 : stdgo.fmt_test.Fmt_test.I) : I))),
		_out: ("0x3c 0x32 0x33 0x3e" : GoString)} : T__struct_2),
	({_fmt: ("%d" : GoString), _val: Go.toInterface(Go.asInterface(((23 : stdgo.fmt_test.Fmt_test.I) : I))), _out: ("23" : GoString)} : T__struct_2),
	({_fmt: ("%s" : GoString),
		_val: Go.toInterface(Go.asInterface(stdgo.reflect.Reflect.valueOf(Go.toInterface(Go.asInterface(((23 : stdgo.fmt_test.Fmt_test.I) : I)))))),
		_out: ("<23>" : GoString)} : T__struct_2),
	({_fmt: ("%#v" : GoString), _val: Go.toInterface((new A((1 : GoInt), ("2" : GoUInt), ("a" : GoString),
		(new Slice<GoInt>(0, 0, (1 : GoInt),
			(2 : GoInt)) : Slice<GoInt>)) : A)), _out: ("fmt_test.A{i:1, j:0x2, s:\"a\", x:[]int{1, 2}}" : GoString)} : T__struct_2),
	...
	({_fmt: ("%#v" : GoString), _val: Go.toInterface((1000000000 : GoInt)), _out: ("1000000000" : GoString)} : T__struct_2), ({
		...
		_out: ("map[string]int{\"a\":1}" : GoString)
	} : T__struct_2), ({
		_fmt: ("%#v" : GoString),
		_val: Go.toInterface(({
			final x = new stdgo.GoMap.GoObjectMap<GoString,
				stdgo.fmt_test.Fmt_test.B>(new stdgo.internal.reflect.Reflect._Type(stdgo.internal.reflect.Reflect.GoType.mapType({
				get: () -> stdgo.internal.reflect.Reflect.GoType.basic(string_kind)
			},
				{get: () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.fmt_test.Fmt_test.B", [], null, false, {get: () -> null})})));
			@:privateAccess x._keys = [("a" : GoString)];
			@:privateAccess x._values = [({} : stdgo.fmt_test.Fmt_test.B)];
			x;
		} : stdgo.GoMap<GoString, stdgo.fmt_test.Fmt_test.B>)),
		_out: ("map[string]fmt_test.B{\"a\":fmt_test.B{I:1, j:2}}" : GoString)
	} : T__struct_2),
	({_fmt: ("%#v" : GoString), _val: Go.toInterface((new Slice<GoString>(0, 0, ("a" : GoString),
		("b" : GoString)) : Slice<GoString>)), _out: ("[]string{\"a\", \"b\"}" : GoString)} : T__struct_2),
	...
	({_fmt: ("%#v" : GoString), _val: Go.toInterface((_iarray : Ref<GoArray<AnyInterface>>)),
		_out: ("&[4]interface {}{1, \"hello\", 2.5, interface {}(nil)}" : GoString)} : T__struct_2),
	({_fmt: ("%#v" : GoString), _val: Go.toInterface(((null : GoMap<GoInt, GoUInt8>) : GoMap<GoInt, GoByte>)),
		_out: ("map[int]uint8(nil)" : GoString)} : T__struct_2),
	({_fmt: ("%#v" : GoString), _val: Go.toInterface((new stdgo.GoMap.GoObjectMap<GoInt,
		GoUInt8>(new stdgo.internal.reflect.Reflect._Type(stdgo.internal.reflect.Reflect.GoType.mapType({
		get: () -> stdgo.internal.reflect.Reflect.GoType.basic(int_kind)
	},
		{get: () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind)}))) : stdgo.GoMap<GoInt, GoUInt8>)),
	...
	({_fmt: ("%#v" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0) : Slice<GoUInt8>)), _out: ("[]byte{}" : GoString)} : T__struct_2),
	({_fmt: ("%#v" : GoString), _val: Go.toInterface(Go.asInterface(stdgo.reflect.Reflect.valueOf(Go.toInterface((new Slice<GoUInt8>(0,
		0) : Slice<GoUInt8>))))), _out: ("[]uint8{}" : GoString)} : T__struct_2),
	({_fmt: ("%#v" : GoString), _val: Go.toInterface(Go.asInterface(stdgo.reflect.Reflect.valueOf(Go.toInterface((new Slice<GoUInt8>(0,
		0) : Slice<GoUInt8>))))), _out: ("[]uint8{}" : GoString)} : T__struct_2),
	({_fmt: ("%#v" : GoString), _val: Go.toInterface(((new Slice<GoUInt8>(0,
		0) : Slice<GoUInt8>) : Ref<Slice<GoUInt8>>)), _out: ("&[]uint8{}" : GoString)} : T__struct_2),
	({_fmt: ("%#v" : GoString), _val: Go.toInterface(((new Slice<GoUInt8>(0,
		0) : Slice<GoUInt8>) : Ref<Slice<GoUInt8>>)), _out: ("&[]uint8{}" : GoString)} : T__struct_2),
	({_fmt: ("%#v" : GoString), _val: Go.toInterface((new GoArray<GoUInt8>(...([].concat([for (i in 0...3) (0 : GoUInt8)]))) : GoArray<GoUInt8>)),
		_out: ("[3]uint8{0x0, 0x0, 0x0}" : GoString)} : T__struct_2),
	({_fmt: ("%#v" : GoString), _val: Go.toInterface((new GoArray<GoUInt8>(...([].concat([for (i in 0...3) (0 : GoUInt8)]))) : GoArray<GoUInt8>)),
		_out: ("[3]uint8{0x0, 0x0, 0x0}" : GoString)} : T__struct_2),
	({_fmt: ("%#x" : GoString), _val: Go.toInterface((new Slice<GoInt>(0, 0, (1 : GoInt), (2 : GoInt),
		(15 : GoInt)) : Slice<GoInt>)), _out: ("[0x1 0x2 0xf]" : GoString)} : T__struct_2),
	({_fmt: ("%x" : GoString), _val: Go.toInterface((new Slice<GoInt>(0, 0, (1 : GoInt), (2 : GoInt),
		(15 : GoInt)) : Slice<GoInt>)), _out: ("[1 2 f]" : GoString)} : T__struct_2),
	({_fmt: ("%d" : GoString), _val: Go.toInterface((new Slice<GoInt>(0, 0, (1 : GoInt), (2 : GoInt),
		(15 : GoInt)) : Slice<GoInt>)), _out: ("[1 2 15]" : GoString)} : T__struct_2),
	({_fmt: ("%d" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (1 : GoUInt8), (2 : GoUInt8),
		(15 : GoUInt8)) : Slice<GoUInt8>)), _out: ("[1 2 15]" : GoString)} : T__struct_2),
	({_fmt: ("%q" : GoString), _val: Go.toInterface((new Slice<GoString>(0, 0, ("a" : GoString),
		("b" : GoString)) : Slice<GoString>)), _out: ("[\"a\" \"b\"]" : GoString)} : T__struct_2),
	({_fmt: ("% 02x" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (1 : GoUInt8)) : Slice<GoUInt8>)), _out: ("01" : GoString)} : T__struct_2),
	({_fmt: ("% 02x" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (1 : GoUInt8), (2 : GoUInt8),
		(3 : GoUInt8)) : Slice<GoUInt8>)), _out: ("01 02 03" : GoString)} : T__struct_2),
	...
	({_fmt: ("%8x" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0,
		(171 : GoUInt8)) : Slice<GoUInt8>)), _out: ("      ab" : GoString)} : T__struct_2),
	({_fmt: ("% 8x" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0,
		(171 : GoUInt8)) : Slice<GoUInt8>)), _out: ("      ab" : GoString)} : T__struct_2),
	({_fmt: ("%#8x" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0,
		(171 : GoUInt8)) : Slice<GoUInt8>)), _out: ("    0xab" : GoString)} : T__struct_2),
	({_fmt: ("%# 8x" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0,
		(171 : GoUInt8)) : Slice<GoUInt8>)), _out: ("    0xab" : GoString)} : T__struct_2),
	({_fmt: ("%08x" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0,
		(171 : GoUInt8)) : Slice<GoUInt8>)), _out: ("000000ab" : GoString)} : T__struct_2),
	({_fmt: ("% 08x" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0,
		(171 : GoUInt8)) : Slice<GoUInt8>)), _out: ("000000ab" : GoString)} : T__struct_2),
	({_fmt: ("%#08x" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0,
		(171 : GoUInt8)) : Slice<GoUInt8>)), _out: ("00000xab" : GoString)} : T__struct_2),
	({_fmt: ("%# 08x" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0,
		(171 : GoUInt8)) : Slice<GoUInt8>)), _out: ("00000xab" : GoString)} : T__struct_2),
	({_fmt: ("%10x" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (171 : GoUInt8),
		(205 : GoUInt8)) : Slice<GoUInt8>)), _out: ("      abcd" : GoString)} : T__struct_2),
	({_fmt: ("% 10x" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (171 : GoUInt8),
		(205 : GoUInt8)) : Slice<GoUInt8>)), _out: ("     ab cd" : GoString)} : T__struct_2),
	({_fmt: ("%#10x" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (171 : GoUInt8),
		(205 : GoUInt8)) : Slice<GoUInt8>)), _out: ("    0xabcd" : GoString)} : T__struct_2),
	({_fmt: ("%# 10x" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (171 : GoUInt8),
		(205 : GoUInt8)) : Slice<GoUInt8>)), _out: (" 0xab 0xcd" : GoString)} : T__struct_2),
	({_fmt: ("%010x" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (171 : GoUInt8),
		(205 : GoUInt8)) : Slice<GoUInt8>)), _out: ("000000abcd" : GoString)} : T__struct_2),
	({_fmt: ("% 010x" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (171 : GoUInt8),
		(205 : GoUInt8)) : Slice<GoUInt8>)), _out: ("00000ab cd" : GoString)} : T__struct_2),
	({_fmt: ("%#010x" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (171 : GoUInt8),
		(205 : GoUInt8)) : Slice<GoUInt8>)), _out: ("00000xabcd" : GoString)} : T__struct_2),
	({_fmt: ("%# 010x" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (171 : GoUInt8),
		(205 : GoUInt8)) : Slice<GoUInt8>)), _out: ("00xab 0xcd" : GoString)} : T__struct_2),
	({_fmt: ("%-10X" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0,
		(171 : GoUInt8)) : Slice<GoUInt8>)), _out: ("AB        " : GoString)} : T__struct_2),
	({_fmt: ("% -010X" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0,
		(171 : GoUInt8)) : Slice<GoUInt8>)), _out: ("AB        " : GoString)} : T__struct_2),
	({_fmt: ("%#-10X" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (171 : GoUInt8),
		(205 : GoUInt8)) : Slice<GoUInt8>)), _out: ("0XABCD    " : GoString)} : T__struct_2),
	({_fmt: ("%# -010X" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (171 : GoUInt8),
	...
	({_fmt: ("%v" : GoString), _val: Go.toInterface(((-11 : stdgo.fmt_test.Fmt_test.T_renamedInt32) : T_renamedInt32)),
		_out: ("-11" : GoString)} : T__struct_2),
	({_fmt: ("%X" : GoString), _val: Go.toInterface(((("255" : GoInt64) : stdgo.fmt_test.Fmt_test.T_renamedInt64) : T_renamedInt64)),
		_out: ("FF" : GoString)} : T__struct_2),
	({_fmt: ("%v" : GoString), _val: Go.toInterface(((("13" : GoUInt) : stdgo.fmt_test.Fmt_test.T_renamedUint) : T_renamedUint)),
		_out: ("13" : GoString)} : T__struct_2),
	...
	({_fmt: ("%d" : GoString), _val: Go.toInterface(((("16" : GoUInt32) : stdgo.fmt_test.Fmt_test.T_renamedUint32) : T_renamedUint32)),
		_out: ("16" : GoString)} : T__struct_2),
	({_fmt: ("%X" : GoString), _val: Go.toInterface(((("17" : GoUInt64) : stdgo.fmt_test.Fmt_test.T_renamedUint64) : T_renamedUint64)),
		_out: ("11" : GoString)} : T__struct_2),
	({_fmt: ("%o" : GoString), _val: Go.toInterface(((18 : stdgo.fmt_test.Fmt_test.T_renamedUintptr) : T_renamedUintptr)),
		_out: ("22" : GoString)} : T__struct_2),
	({_fmt: ("%x" : GoString), _val: Go.toInterface((("thing" : GoString) : T_renamedString)), _out: ("7468696e67" : GoString)} : T__struct_2),
	({_fmt: ("%d" : GoString), _val: Go.toInterface(((new Slice<GoUInt8>(0, 0, (1 : GoUInt8), (2 : GoUInt8),
		(15 : GoUInt8)) : Slice<GoUInt8>) : T_renamedBytes)), _out: ("[1 2 15]" : GoString)} : T__struct_2),
	({_fmt: ("%q" : GoString), _val: Go.toInterface(((("hello" : GoString) : Slice<GoByte>) : T_renamedBytes)), _out: ("\"hello\"" : GoString)} : T__struct_2),
	({_fmt: ("%x" : GoString), _val: Go.toInterface((new Slice<stdgo.fmt_test.Fmt_test.T_renamedUint8>(0, 0, (104 : stdgo.fmt_test.Fmt_test.T_renamedUint8),
		(101 : stdgo.fmt_test.Fmt_test.T_renamedUint8), (108 : stdgo.fmt_test.Fmt_test.T_renamedUint8), (108 : stdgo.fmt_test.Fmt_test.T_renamedUint8),
		(111 : stdgo.fmt_test.Fmt_test.T_renamedUint8)) : Slice<stdgo.fmt_test.Fmt_test.T_renamedUint8>)), _out: ("68656c6c6f" : GoString)} : T__struct_2),
	({_fmt: ("%X" : GoString), _val: Go.toInterface((new Slice<stdgo.fmt_test.Fmt_test.T_renamedUint8>(0, 0, (104 : stdgo.fmt_test.Fmt_test.T_renamedUint8),
		(101 : stdgo.fmt_test.Fmt_test.T_renamedUint8), (108 : stdgo.fmt_test.Fmt_test.T_renamedUint8), (108 : stdgo.fmt_test.Fmt_test.T_renamedUint8),
		(111 : stdgo.fmt_test.Fmt_test.T_renamedUint8)) : Slice<stdgo.fmt_test.Fmt_test.T_renamedUint8>)), _out: ("68656C6C6F" : GoString)} : T__struct_2),
	({_fmt: ("%s" : GoString), _val: Go.toInterface((new Slice<stdgo.fmt_test.Fmt_test.T_renamedUint8>(0, 0, (104 : stdgo.fmt_test.Fmt_test.T_renamedUint8),
		(101 : stdgo.fmt_test.Fmt_test.T_renamedUint8), (108 : stdgo.fmt_test.Fmt_test.T_renamedUint8), (108 : stdgo.fmt_test.Fmt_test.T_renamedUint8),
		(111 : stdgo.fmt_test.Fmt_test.T_renamedUint8)) : Slice<stdgo.fmt_test.Fmt_test.T_renamedUint8>)), _out: ("hello" : GoString)} : T__struct_2),
	({_fmt: ("%q" : GoString), _val: Go.toInterface((new Slice<stdgo.fmt_test.Fmt_test.T_renamedUint8>(0, 0, (104 : stdgo.fmt_test.Fmt_test.T_renamedUint8),
		(101 : stdgo.fmt_test.Fmt_test.T_renamedUint8), (108 : stdgo.fmt_test.Fmt_test.T_renamedUint8), (108 : stdgo.fmt_test.Fmt_test.T_renamedUint8),
		(111 : stdgo.fmt_test.Fmt_test.T_renamedUint8)) : Slice<stdgo.fmt_test.Fmt_test.T_renamedUint8>)), _out: ("\"hello\"" : GoString)} : T__struct_2),
	...
	({_fmt: ("%v" : GoString), _val: Go.toInterface(((3 : GoFloat64) + new GoComplex128(0,
		4) : T_renamedComplex64)), _out: ("(3+4i)" : GoString)} : T__struct_2),
	({_fmt: ("%v" : GoString), _val: Go.toInterface(((4 : GoFloat64) + new GoComplex128(0,
		-3) : T_renamedComplex128)), _out: ("(4-3i)" : GoString)} : T__struct_2),
	...
	({_fmt: ("%+v" : GoString), _val: Go.toInterface((new S(((4 : stdgo.fmt_test.Fmt_test.F) : F),
		((5 : stdgo.fmt_test.Fmt_test.G) : G)) : S)), _out: ("{F:<v=F(4)> G:5}" : GoString)} : T__struct_2),
	({_fmt: ("%#v" : GoString), _val: Go.toInterface(Go.asInterface(((6 : stdgo.fmt_test.Fmt_test.G) : G))), _out: ("GoString(6)" : GoString)} : T__struct_2),
	({_fmt: ("%#v" : GoString), _val: Go.toInterface((new S(((7 : stdgo.fmt_test.Fmt_test.F) : F),
		((8 : stdgo.fmt_test.Fmt_test.G) : G)) : S)), _out: ("fmt_test.S{F:<v=F(7)>, G:GoString(8)}" : GoString)} : T__struct_2),
	({_fmt: ("%T" : GoString), _val: Go.toInterface(((0 : GoUInt8) : GoByte)), _out: ("uint8" : GoString)} : T__struct_2),
	({_fmt: ("%T" : GoString), _val: Go.toInterface(Go.asInterface(stdgo.reflect.Reflect.valueOf((null : AnyInterface)))),
		_out: ("reflect.Value" : GoString)} : T__struct_2),
	({_fmt: ("%T" : GoString), _val: Go.toInterface(((4 : GoFloat64) + new GoComplex128(0, -3))), _out: ("complex128" : GoString)} : T__struct_2),
	({_fmt: ("%T" : GoString), _val: Go.toInterface(((4 : GoFloat64) + new GoComplex128(0,
		-3) : T_renamedComplex128)), _out: ("fmt_test.renamedComplex128" : GoString)} : T__struct_2),
	...
	({_fmt: ("%p" : GoString), _val: Go.toInterface((new GoObjectMap<GoInt,
		GoInt>(new stdgo.internal.reflect.Reflect._Type(stdgo.internal.reflect.Reflect.GoType.mapType({
		get: () -> stdgo.internal.reflect.Reflect.GoType.basic(int_kind)
	},
		{get: () -> stdgo.internal.reflect.Reflect.GoType.basic(int_kind)}))) : GoMap<GoInt, GoInt>)), _out: ("0xPTR" : GoString)} : T__struct_2),
	...
	({_fmt: ("%s" : GoString), _val: Go.toInterface(Go.asInterface((new stdgo.time.Time.Time() : stdgo.time.Time.Time).month())),
		_out: ("January" : GoString)} : T__struct_2),
	({_fmt: ("%d" : GoString), _val: Go.toInterface(Go.asInterface((new stdgo.time.Time.Time() : stdgo.time.Time.Time).month())),
		_out: ("1" : GoString)} : T__struct_2),
	...
	({_fmt: ("%017091901790959340919092959340919017929593813360" : GoString), _val: Go.toInterface((0 : GoInt)),
		_out: ("%!(NOVERB)%!(EXTRA int=0)" : GoString)} : T__struct_2),
	...
	({_fmt: ("%010.2" : GoString), _val: Go.toInterface(("12345" : GoString)), _out: ("%!(NOVERB)%!(EXTRA string=12345)" : GoString)} : T__struct_2), ({
		...
		_val: Go.toInterface(({
			final x = new stdgo.GoMap.GoObjectMap<GoFloat64,
				GoInt>(new stdgo.internal.reflect.Reflect._Type(stdgo.internal.reflect.Reflect.GoType.mapType({get: () ->
					stdgo.internal.reflect.Reflect.GoType.basic(float64_kind)}, {get: () -> stdgo.internal.reflect.Reflect.GoType.basic(int_kind)})));
			@:privateAccess x._keys = [naN, naN];
			@:privateAccess x._values = [(1 : GoInt), (1 : GoInt)];
			x;
		} : stdgo.GoMap<GoFloat64, GoInt>)),
		_out: ("map[NaN:1 NaN:1]" : GoString)
	} : T__struct_2),
	...
	({_fmt: ("%06v" : GoString), _val: Go.toInterface((new Slice<AnyInterface>(0, 0, Go.toInterface((10 : GoFloat64)),
		Go.toInterface((10 : GoInt))) : Slice<AnyInterface>)), _out: ("[000010 000010]" : GoString)} : T__struct_2),
	({_fmt: ("%06v" : GoString), _val: Go.toInterface((new Slice<AnyInterface>(0, 0, Go.toInterface((-10 : GoFloat64)),
		Go.toInterface((10 : GoInt))) : Slice<AnyInterface>)), _out: ("[-00010 000010]" : GoString)} : T__struct_2),
	({_fmt: ("%06v" : GoString), _val: Go.toInterface((new Slice<AnyInterface>(0, 0, Go.toInterface(((10 : GoFloat64) + new GoComplex128(0, 10))),
		Go.toInterface((10 : GoInt))) : Slice<AnyInterface>)), _out: ("[(000010+00010i) 000010]" : GoString)} : T__struct_2),
	({_fmt: ("%06v" : GoString), _val: Go.toInterface((new Slice<AnyInterface>(0, 0, Go.toInterface(((-10 : GoFloat64) + new GoComplex128(0, 10))),
		Go.toInterface((10 : GoInt))) : Slice<AnyInterface>)), _out: ("[(-00010+00010i) 000010]" : GoString)} : T__struct_2),
	({_fmt: ("%03.6v" : GoString), _val: Go.toInterface((new Slice<AnyInterface>(0, 0, Go.toInterface((1 : GoInt)), Go.toInterface((2 : GoFloat64)),
		Go.toInterface(("x" : GoString))) : Slice<AnyInterface>)), _out: ("[000001 002 00x]" : GoString)} : T__struct_2),
	({_fmt: ("%03.0v" : GoString), _val: Go.toInterface((new Slice<AnyInterface>(0, 0, Go.toInterface((0 : GoInt)), Go.toInterface((2 : GoFloat64)),
		Go.toInterface(("x" : GoString))) : Slice<AnyInterface>)), _out: ("[    002 000]" : GoString)} : T__struct_2),
	({_fmt: ("%v" : GoString), _val: Go.toInterface((new Slice<GoComplex64>(0, 0, ((1 : GoFloat64) + new GoComplex128(0, 0)),
		((2 : GoFloat64) + new GoComplex128(0, 0)),
		((3 : GoFloat64) + new GoComplex128(0, 0))) : Slice<GoComplex64>)), _out: ("[(1+0i) (2+0i) (3+0i)]" : GoString)} : T__struct_2),
	({_fmt: ("%v" : GoString), _val: Go.toInterface((new Slice<GoComplex128>(0, 0, ((1 : GoFloat64) + new GoComplex128(0, 0)),
		((2 : GoFloat64) + new GoComplex128(0, 0)),
		((3 : GoFloat64) + new GoComplex128(0, 0))) : Slice<GoComplex128>)), _out: ("[(1+0i) (2+0i) (3+0i)]" : GoString)} : T__struct_2),
	({_fmt: ("%." : GoString), _val: Go.toInterface((3 : GoInt)), _out: ("%!.(int=3)" : GoString)} : T__struct_2),
	({_fmt: ("%+10.2f" : GoString), _val: Go.toInterface(((104.66 : GoFloat64) + new GoComplex128(0,
		440.51))), _out: ("(   +104.66   +440.51i)" : GoString)} : T__struct_2),
	({_fmt: ("%+10.2f" : GoString), _val: Go.toInterface(((-104.66 : GoFloat64) + new GoComplex128(0,
		440.51))), _out: ("(   -104.66   +440.51i)" : GoString)} : T__struct_2),
	({_fmt: ("%+10.2f" : GoString), _val: Go.toInterface(((104.66 : GoFloat64) + new GoComplex128(0,
		-440.51))), _out: ("(   +104.66   -440.51i)" : GoString)} : T__struct_2),
	({_fmt: ("%+10.2f" : GoString), _val: Go.toInterface(((-104.66 : GoFloat64) + new GoComplex128(0,
		-440.51))), _out: ("(   -104.66   -440.51i)" : GoString)} : T__struct_2),
	({_fmt: ("%+010.2f" : GoString), _val: Go.toInterface(((104.66 : GoFloat64) + new GoComplex128(0,
		440.51))), _out: ("(+000104.66+000440.51i)" : GoString)} : T__struct_2),
	({_fmt: ("%+010.2f" : GoString), _val: Go.toInterface(((-104.66 : GoFloat64) + new GoComplex128(0,
		440.51))), _out: ("(-000104.66+000440.51i)" : GoString)} : T__struct_2),
	({_fmt: ("%+010.2f" : GoString), _val: Go.toInterface(((104.66 : GoFloat64) + new GoComplex128(0,
		-440.51))), _out: ("(+000104.66-000440.51i)" : GoString)} : T__struct_2),
	...
	({_fmt: ("%X" : GoString), _val: Go.toInterface(_byteStringerSlice), _out: ("68656C6C6F" : GoString)} : T__struct_2),
	({_fmt: ("%#v" : GoString), _val: Go.toInterface(_byteStringerSlice),
		_out: ("[]fmt_test.byteStringer{0x68, 0x65, 0x6c, 0x6c, 0x6f}" : GoString)} : T__struct_2),
	...
	({_fmt: ("%s" : GoString), _val: Go.toInterface(Go.asInterface((("xyz" : GoString) : T_writeStringFormatter))),
		_out: ("***xyz***" : GoString)} : T__struct_2),
	({_fmt: ("%s" : GoString), _val: Go.toInterface(Go.asInterface((("⌘/⌘" : GoString) : T_writeStringFormatter))),
		_out: ("***⌘/⌘***" : GoString)} : T__struct_2),
	({_fmt: ("%v" : GoString), _val: Go.toInterface((stdgo.reflect.Reflect.valueOf(Go.toInterface((new A() : A)))
		.field((0 : GoInt))
		.string() : GoString)), _out: ("<int Value>" : GoString)} : T__struct_2),
	({_fmt: ("%v" : GoString), _val: Go.toInterface(Go.asInterface(stdgo.reflect.Reflect.valueOf(Go.toInterface((new A() : A)))
		.field((0 : GoInt)))), _out: ("0" : GoString)} : T__struct_2),
	({_fmt: ("%s" : GoString), _val: Go.toInterface(Go.asInterface(stdgo.reflect.Reflect.valueOf(Go.toInterface(("hello" : GoString))))),
		_out: ("hello" : GoString)} : T__struct_2),
	({_fmt: ("%q" : GoString), _val: Go.toInterface(Go.asInterface(stdgo.reflect.Reflect.valueOf(Go.toInterface(("hello" : GoString))))),
		_out: ("\"hello\"" : GoString)} : T__struct_2),
	({_fmt: ("%#04x" : GoString), _val: Go.toInterface(Go.asInterface(stdgo.reflect.Reflect.valueOf(Go.toInterface((256 : GoInt))))),
		_out: ("0x0100" : GoString)} : T__struct_2),
	({_fmt: ("%v" : GoString), _val: Go.toInterface(Go.asInterface((new stdgo.reflect.Reflect.Value() : stdgo.reflect.Reflect.Value))),
		_out: ("<invalid reflect.Value>" : GoString)} : T__struct_2),
	({_fmt: ("%v" : GoString),
		_val: Go.toInterface(Go.asInterface(((new stdgo.reflect.Reflect.Value() : stdgo.reflect.Reflect.Value) : Ref<stdgo.reflect.Reflect.Value>))),
		_out: ("<invalid Value>" : GoString)} : T__struct_2),
	({_fmt: ("%v" : GoString),
		_val: Go.toInterface((new SI(Go.toInterface(Go.asInterface((new stdgo.reflect.Reflect.Value() : stdgo.reflect.Reflect.Value)))) : SI)),
		_out: ("{<invalid Value>}" : GoString)} : T__struct_2),
	...
	({_fmt: ("%☠" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (0 : GoUInt8),
		(1 : GoUInt8)) : Slice<GoUInt8>)), _out: ("[%!☠(uint8=0) %!☠(uint8=1)]" : GoString)} : T__struct_2),
	({_fmt: ("%☠" : GoString), _val: Go.toInterface((new Slice<GoUInt8>(0, 0, (0 : GoUInt8),
		(1 : GoUInt8)) : Slice<GoUInt8>)), _out: ("[%!☠(uint8=0) %!☠(uint8=1)]" : GoString)} : T__struct_2),
	({_fmt: ("%☠" : GoString), _val: Go.toInterface((new GoArray<GoUInt8>((0 : GoUInt8)) : GoArray<GoUInt8>)),
		_out: ("[%!☠(uint8=0)]" : GoString)} : T__struct_2),
	({_fmt: ("%☠" : GoString), _val: Go.toInterface((new GoArray<GoUInt8>((0 : GoUInt8)) : GoArray<GoUInt8>)),
		_out: ("[%!☠(uint8=0)]" : GoString)} : T__struct_2),
	...
	({_fmt: ("%☠" : GoString), _val: Go.toInterface(((1.2345678 : GoFloat64) + new GoComplex128(0,
		1.2345678))), _out: ("%!☠(complex128=(1.2345678+1.2345678i))" : GoString)} : T__struct_2),
	({_fmt: ("%☠" : GoString), _val: Go.toInterface(((1.2345678 : GoFloat64) + new GoComplex128(0,
		1.2345678) : GoComplex64)), _out: ("%!☠(complex64=(1.2345678+1.2345678i))" : GoString)} : T__struct_2),
	...
	({_fmt: ("%☠" : GoString),
		_val: Go.toInterface(Go.asInterface(stdgo.reflect.Reflect.valueOf(Go.toInterface(((0 : stdgo.fmt_test.Fmt_test.T_renamedInt) : T_renamedInt))))),
		_out: ("%!☠(fmt_test.renamedInt=0)" : GoString)} : T__struct_2),
	({_fmt: ("%☠" : GoString), _val: Go.toInterface((new SI(Go.toInterface(((0 : stdgo.fmt_test.Fmt_test.T_renamedInt) : T_renamedInt))) : SI)),
		_out: ("{%!☠(fmt_test.renamedInt=0)}" : GoString)} : T__struct_2),
	({_fmt: ("%☠" : GoString), _val: Go.toInterface(((new Slice<AnyInterface>(0, 0, Go.toInterface(Go.asInterface(((1 : stdgo.fmt_test.Fmt_test.I) : I))),
		Go.toInterface(Go.asInterface(((2 : stdgo.fmt_test.Fmt_test.G) : G)))) : Slice<AnyInterface>) : Ref<Slice<AnyInterface>>)),
		_out: ("&[%!☠(fmt_test.I=1) %!☠(fmt_test.G=2)]" : GoString)} : T__struct_2),
	({_fmt: ("%☠" : GoString), _val: Go.toInterface((new SI(Go.toInterface(((new Slice<AnyInterface>(0, 0,
		Go.toInterface(Go.asInterface(((1 : stdgo.fmt_test.Fmt_test.I) : I))),
		Go.toInterface(Go.asInterface(((2 : stdgo.fmt_test.Fmt_test.G) : G)))) : Slice<AnyInterface>) : Ref<Slice<AnyInterface>>))) : SI)),
		_out: ("{%!☠(*[]interface {}=&[1 2])}" : GoString)} : T__struct_2),
	({_fmt: ("%☠" : GoString), _val: Go.toInterface(Go.asInterface((new stdgo.reflect.Reflect.Value() : stdgo.reflect.Reflect.Value))),
		_out: ("<invalid reflect.Value>" : GoString)} : T__struct_2),
	({
		_fmt: ("%☠" : GoString),
		_val: Go.toInterface(({
		...
		_out: ("map[%!☠(float64=NaN):%!☠(int=1)]" : GoString)
	} : T__struct_2)) : Slice<T__struct_2>);

private var _reorderTests:Slice<T__struct_3> = (new Slice<T__struct_3>(0, 0,
	({_fmt: ("%[1]d" : GoString), _val: (new Slice<AnyInterface>(0, 0,
		Go.toInterface((1 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("1" : GoString)} : T__struct_3),
	({_fmt: ("%[2]d" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((2 : GoInt)),
		Go.toInterface((1 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("1" : GoString)} : T__struct_3),
	({_fmt: ("%[2]d %[1]d" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((1 : GoInt)),
		Go.toInterface((2 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("2 1" : GoString)} : T__struct_3),
	({_fmt: ("%[2]*[1]d" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((2 : GoInt)),
		Go.toInterface((5 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("    2" : GoString)} : T__struct_3),
	({_fmt: ("%6.2f" : GoString), _val: (new Slice<AnyInterface>(0, 0,
		Go.toInterface((12 : GoFloat64))) : stdgo.fmt_test.Fmt_test.SE), _out: (" 12.00" : GoString)} : T__struct_3),
	({_fmt: ("%[3]*.[2]*[1]f" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((12 : GoFloat64)), Go.toInterface((2 : GoInt)),
		Go.toInterface((6 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: (" 12.00" : GoString)} : T__struct_3),
	({_fmt: ("%[1]*.[2]*[3]f" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((6 : GoInt)), Go.toInterface((2 : GoInt)),
		Go.toInterface((12 : GoFloat64))) : stdgo.fmt_test.Fmt_test.SE), _out: (" 12.00" : GoString)} : T__struct_3),
	({_fmt: ("%10f" : GoString), _val: (new Slice<AnyInterface>(0, 0,
		Go.toInterface((12 : GoFloat64))) : stdgo.fmt_test.Fmt_test.SE), _out: (" 12.000000" : GoString)} : T__struct_3),
	({_fmt: ("%[1]*[3]f" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((10 : GoInt)), Go.toInterface((99 : GoInt)),
		Go.toInterface((12 : GoFloat64))) : stdgo.fmt_test.Fmt_test.SE), _out: (" 12.000000" : GoString)} : T__struct_3),
	({_fmt: ("%.6f" : GoString), _val: (new Slice<AnyInterface>(0, 0,
		Go.toInterface((12 : GoFloat64))) : stdgo.fmt_test.Fmt_test.SE), _out: ("12.000000" : GoString)} : T__struct_3),
	({_fmt: ("%.[1]*[3]f" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((6 : GoInt)), Go.toInterface((99 : GoInt)),
		Go.toInterface((12 : GoFloat64))) : stdgo.fmt_test.Fmt_test.SE), _out: ("12.000000" : GoString)} : T__struct_3),
	({_fmt: ("%6.f" : GoString), _val: (new Slice<AnyInterface>(0, 0,
		Go.toInterface((12 : GoFloat64))) : stdgo.fmt_test.Fmt_test.SE), _out: ("    12" : GoString)} : T__struct_3),
	({_fmt: ("%[1]*.[3]f" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((6 : GoInt)), Go.toInterface((3 : GoInt)),
		Go.toInterface((12 : GoFloat64))) : stdgo.fmt_test.Fmt_test.SE), _out: ("    12" : GoString)} : T__struct_3),
	({_fmt: ("%d %d %d %#[1]o %#o %#o" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((11 : GoInt)), Go.toInterface((12 : GoInt)),
		Go.toInterface((13 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("11 12 13 013 014 015" : GoString)} : T__struct_3),
	({_fmt: ("%[d" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((2 : GoInt)),
		Go.toInterface((1 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("%!d(BADINDEX)" : GoString)} : T__struct_3),
	({_fmt: ("%]d" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((2 : GoInt)),
		Go.toInterface((1 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("%!](int=2)d%!(EXTRA int=1)" : GoString)} : T__struct_3),
	({_fmt: ("%[]d" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((2 : GoInt)),
		Go.toInterface((1 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("%!d(BADINDEX)" : GoString)} : T__struct_3),
	({_fmt: ("%[-3]d" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((2 : GoInt)),
		Go.toInterface((1 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("%!d(BADINDEX)" : GoString)} : T__struct_3),
	({_fmt: ("%[99]d" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((2 : GoInt)),
		Go.toInterface((1 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("%!d(BADINDEX)" : GoString)} : T__struct_3),
	({_fmt: ("%[3]" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((2 : GoInt)),
		Go.toInterface((1 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("%!(NOVERB)" : GoString)} : T__struct_3),
	({_fmt: ("%[1].2d" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((5 : GoInt)),
		Go.toInterface((6 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("%!d(BADINDEX)" : GoString)} : T__struct_3),
	({_fmt: ("%[1]2d" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((2 : GoInt)),
		Go.toInterface((1 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("%!d(BADINDEX)" : GoString)} : T__struct_3),
	({_fmt: ("%3.[2]d" : GoString), _val: (new Slice<AnyInterface>(0, 0,
		Go.toInterface((7 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("%!d(BADINDEX)" : GoString)} : T__struct_3),
	({_fmt: ("%.[2]d" : GoString), _val: (new Slice<AnyInterface>(0, 0,
		Go.toInterface((7 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("%!d(BADINDEX)" : GoString)} : T__struct_3),
	({_fmt: ("%d %d %d %#[1]o %#o %#o %#o" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((11 : GoInt)), Go.toInterface((12 : GoInt)),
		Go.toInterface((13 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("11 12 13 013 014 015 %!o(MISSING)" : GoString)} : T__struct_3),
	({_fmt: ("%[5]d %[2]d %d" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((1 : GoInt)), Go.toInterface((2 : GoInt)),
		Go.toInterface((3 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("%!d(BADINDEX) 2 3" : GoString)} : T__struct_3),
	({_fmt: ("%d %[3]d %d" : GoString), _val: (new Slice<AnyInterface>(0, 0, Go.toInterface((1 : GoInt)),
		Go.toInterface((2 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("1 %!d(BADINDEX) 2" : GoString)} : T__struct_3),
	({_fmt: ("%.[]" : GoString), _val: (new Slice<AnyInterface>(0, 0) : stdgo.fmt_test.Fmt_test.SE), _out: ("%!](BADINDEX)" : GoString)} : T__struct_3),
	({_fmt: ("%.-3d" : GoString), _val: (new Slice<AnyInterface>(0, 0,
		Go.toInterface((42 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("%!-(int=42)3d" : GoString)} : T__struct_3),
	({_fmt: ("%2147483648d" : GoString), _val: (new Slice<AnyInterface>(0, 0,
		Go.toInterface((42 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("%!(NOVERB)%!(EXTRA int=42)" : GoString)} : T__struct_3),
	({_fmt: ("%-2147483648d" : GoString), _val: (new Slice<AnyInterface>(0, 0,
		Go.toInterface((42 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("%!(NOVERB)%!(EXTRA int=42)" : GoString)} : T__struct_3),
	({_fmt: ("%.2147483648d" : GoString), _val: (new Slice<AnyInterface>(0, 0,
		Go.toInterface((42 : GoInt))) : stdgo.fmt_test.Fmt_test.SE), _out: ("%!(NOVERB)%!(EXTRA int=42)" : GoString)} : T__struct_3)) : Slice<T__struct_3>);

private var _mallocTest:Slice<T__struct_4> = (new Slice<T__struct_4>(0, 0, ({
	_count: (0 : GoInt),
	_desc: ("Sprintf(\"\")" : GoString),
	_fn: function():Void {
		sprintf(Go.str());
	}
} : T__struct_4), ({
	_count: (1 : GoInt),
	_desc: ("Sprintf(\"xxx\")" : GoString),
	_fn: function():Void {
		sprintf(("xxx" : GoString));
	}
	} : T__struct_4), ({
	_count: (2 : GoInt),
	_desc: ("Sprintf(\"%x\")" : GoString),
	_fn: function():Void {
		sprintf(("%x" : GoString), Go.toInterface((7 : GoInt)));
	}
	} : T__struct_4), ({
	_count: (2 : GoInt),
	_desc: ("Sprintf(\"%s\")" : GoString),
	_fn: function():Void {
		sprintf(("%s" : GoString), Go.toInterface(("hello" : GoString)));
	}
	} : T__struct_4), ({
	_count: (3 : GoInt),
	_desc: ("Sprintf(\"%x %x\")" : GoString),
	_fn: function():Void {
		sprintf(("%x %x" : GoString), Go.toInterface((7 : GoInt)), Go.toInterface((112 : GoInt)));
	}
	} : T__struct_4), ({
	_count: (2 : GoInt),
	_desc: ("Sprintf(\"%g\")" : GoString),
	_fn: function():Void {
		sprintf(("%g" : GoString), Go.toInterface(((3.14159 : GoFloat64) : GoFloat32)));
	}
	} : T__struct_4), ({
	_count: (1 : GoInt),
	_desc: ("Fprintf(buf, \"%s\")" : GoString),
	_fn: function():Void {
		_mallocBuf.reset();
	...
	_count: (0 : GoInt),
	_desc: ("Fprintf(buf, \"%x %x %x\")" : GoString),
	_fn: function():Void {
		_mallocBuf.reset();
		fprintf(Go.asInterface((_mallocBuf : Ref<stdgo.bytes.Bytes.Buffer>)), ("%x %x %x" : GoString), Go.toInterface(_mallocPointer),
			Go.toInterface(_mallocPointer), Go.toInterface(_mallocPointer));
	}
	} : T__struct_4)) : Slice<T__struct_4>);

private var _flagtests:Slice<T__struct_5> = (new Slice<T__struct_5>(0, 0, ({_in: ("%a" : GoString), _out: ("[%a]" : GoString)} : T__struct_5),
	({_in: ("%-a" : GoString), _out: ("[%-a]" : GoString)} : T__struct_5), ({_in: ("%+a" : GoString), _out: ("[%+a]" : GoString)} : T__struct_5),
	({_in: ("%#a" : GoString), _out: ("[%#a]" : GoString)} : T__struct_5), ({_in: ("% a" : GoString), _out: ("[% a]" : GoString)} : T__struct_5),
	({_in: ("%0a" : GoString), _out: ("[%0a]" : GoString)} : T__struct_5), ({_in: ("%1.2a" : GoString), _out: ("[%1.2a]" : GoString)} : T__struct_5),
	({_in: ("%-1.2a" : GoString), _out: ("[%-1.2a]" : GoString)} : T__struct_5), ({_in: ("%+1.2a" : GoString), _out: ("[%+1.2a]" : GoString)} : T__struct_5),
...
private var _startests:Slice<T__struct_7> = (new Slice<T__struct_7>(0, 0,
	...
	({_fmt: ("%*.*d" : GoString), _in: _args(Go.toInterface((8 : GoInt)), Go.toInterface((4 : GoInt)),
		Go.toInterface((42 : GoInt))), _out: ("    0042" : GoString)} : T__struct_7),
	({_fmt: ("%0*d" : GoString), _in: _args(Go.toInterface((4 : GoInt)), Go.toInterface((42 : GoInt))), _out: ("0042" : GoString)} : T__struct_7),
	({_fmt: ("%0*d" : GoString), _in: _args(Go.toInterface((("4" : GoUInt) : GoUInt)),
		Go.toInterface((42 : GoInt))), _out: ("0042" : GoString)} : T__struct_7),
	({_fmt: ("%0*d" : GoString), _in: _args(Go.toInterface((("4" : GoUInt64) : GoUInt64)),
		Go.toInterface((42 : GoInt))), _out: ("0042" : GoString)} : T__struct_7),
	...
	({_fmt: ("%*d" : GoString), _in: _args(Go.toInterface((10000000 : GoInt)),
		Go.toInterface((42 : GoInt))), _out: ("%!(BADWIDTH)42" : GoString)} : T__struct_7),
	({_fmt: ("%*d" : GoString), _in: _args(Go.toInterface((-10000000 : GoInt)),
		Go.toInterface((42 : GoInt))), _out: ("%!(BADWIDTH)42" : GoString)} : T__struct_7),
	...
	({_fmt: ("%.*d" : GoString), _in: _args(Go.toInterface((10000000 : GoInt)),
		Go.toInterface((42 : GoInt))), _out: ("%!(BADPREC)42" : GoString)} : T__struct_7),
	({_fmt: ("%.*d" : GoString), _in: _args(Go.toInterface((("10000000" : GoUInt) : GoUInt)),
		Go.toInterface((42 : GoInt))), _out: ("%!(BADPREC)42" : GoString)} : T__struct_7),
	({_fmt: ("%.*d" : GoString), _in: _args(Go.toInterface((("9223372036854775808" : GoUInt64) : GoUInt64)),
		Go.toInterface((42 : GoInt))), _out: ("%!(BADPREC)42" : GoString)} : T__struct_7),
	({_fmt: ("%.*d" : GoString), _in: _args(Go.toInterface((("18446744073709551615" : GoUInt64) : GoUInt64)),
		Go.toInterface((42 : GoInt))), _out: ("%!(BADPREC)42" : GoString)} : T__struct_7),
	({_fmt: ("%*d" : GoString), _in: _args(Go.toInterface((5 : GoInt)),
		Go.toInterface(("foo" : GoString))), _out: ("%!d(string=  foo)" : GoString)} : T__struct_7),
...
private var _panictests:Slice<T__struct_8> = (new Slice<T__struct_8>(0, 0,
	({_fmt: ("%s" : GoString), _in: Go.toInterface(Go.asInterface(((null : Ref<stdgo.fmt_test.Fmt_test.PanicS>) : Ref<PanicS>))),
		_out: ("<nil>" : GoString)} : T__struct_8),
	({_fmt: ("%s" : GoString), _in: Go.toInterface(Go.asInterface((new PanicS(Go.toInterface(stdgo.io.Io.errUnexpectedEOF)) : PanicS))),
		_out: ("%!s(PANIC=String method: unexpected EOF)" : GoString)} : T__struct_8),
	({_fmt: ("%s" : GoString), _in: Go.toInterface(Go.asInterface((new PanicS(Go.toInterface((3 : GoInt))) : PanicS))),
		_out: ("%!s(PANIC=String method: 3)" : GoString)} : T__struct_8),
	({_fmt: ("%#v" : GoString), _in: Go.toInterface(Go.asInterface(((null : Ref<stdgo.fmt_test.Fmt_test.PanicGo>) : Ref<PanicGo>))),
		_out: ("<nil>" : GoString)} : T__struct_8),
	({_fmt: ("%#v" : GoString), _in: Go.toInterface(Go.asInterface((new PanicGo(Go.toInterface(stdgo.io.Io.errUnexpectedEOF)) : PanicGo))),
		_out: ("%!v(PANIC=GoString method: unexpected EOF)" : GoString)} : T__struct_8),
	({_fmt: ("%#v" : GoString), _in: Go.toInterface(Go.asInterface((new PanicGo(Go.toInterface((3 : GoInt))) : PanicGo))),
		_out: ("%!v(PANIC=GoString method: 3)" : GoString)} : T__struct_8),
	({_fmt: ("%#v" : GoString), _in: Go.toInterface((new Slice<AnyInterface>(0, 0,
		Go.toInterface(Go.asInterface((new PanicGo(Go.toInterface((3 : GoInt))) : PanicGo))),
		Go.toInterface(Go.asInterface((new PanicGo(Go.toInterface((3 : GoInt))) : PanicGo)))) : Slice<AnyInterface>)),
		_out: ("[]interface {}{%!v(PANIC=GoString method: 3), %!v(PANIC=GoString method: 3)}" : GoString)} : T__struct_8),
	({_fmt: ("%s" : GoString), _in: Go.toInterface(Go.asInterface(((null : Ref<stdgo.fmt_test.Fmt_test.PanicF>) : Ref<PanicF>))),
		_out: ("<nil>" : GoString)} : T__struct_8),
	({_fmt: ("%s" : GoString), _in: Go.toInterface(Go.asInterface((new PanicF(Go.toInterface(stdgo.io.Io.errUnexpectedEOF)) : PanicF))),
		_out: ("%!s(PANIC=Format method: unexpected EOF)" : GoString)} : T__struct_8),
	({_fmt: ("%s" : GoString), _in: Go.toInterface(Go.asInterface((new PanicF(Go.toInterface((3 : GoInt))) : PanicF))),
		_out: ("%!s(PANIC=Format method: 3)" : GoString)} : T__struct_8)) : Slice<T__struct_8>);

/**
	// recurCount tests that erroneous String routine doesn't cause fatal recursion.
**/
private var _recurCount:GoInt = (0 : GoInt);

private var _formatterFlagTests:Slice<T__struct_9> = (new Slice<T__struct_9>(0, 0,
	...
	({_in: ("%+1.2a" : GoString), _val: Go.toInterface(Go.asInterface((new T_flagPrinter() : T_flagPrinter))), _out: ("[%+1.2a]" : GoString)} : T__struct_9),
	({_in: ("%-+1.2a" : GoString), _val: Go.toInterface(Go.asInterface((new T_flagPrinter() : T_flagPrinter))), _out: ("[%+-1.2a]" : GoString)} : T__struct_9),
	({_in: ("%-+1.2abc" : GoString), _val: Go.toInterface(Go.asInterface((new T_flagPrinter() : T_flagPrinter))),
		_out: ("[%+-1.2a]bc" : GoString)} : T__struct_9),
	({_in: ("%-1.2abc" : GoString), _val: Go.toInterface(Go.asInterface((new T_flagPrinter() : T_flagPrinter))),
		_out: ("[%-1.2a]bc" : GoString)} : T__struct_9),
	({_in: ("%a" : GoString),
		_val: Go.toInterface((new GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0...1) ({} : stdgo.fmt_test.Fmt_test.T_flagPrinter)]))) : GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>)),
		_out: ("[[%a]]" : GoString)} : T__struct_9),
	({_in: ("%-a" : GoString),
		_val: Go.toInterface((new GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0...1) ({} : stdgo.fmt_test.Fmt_test.T_flagPrinter)]))) : GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>)),
		_out: ("[[%-a]]" : GoString)} : T__struct_9),
	({_in: ("%+a" : GoString),
	...
	({_in: ("%0a" : GoString),
		_val: Go.toInterface((new GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0...1) ({} : stdgo.fmt_test.Fmt_test.T_flagPrinter)]))) : GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>)),
		_out: ("[[%0a]]" : GoString)} : T__struct_9),
	({_in: ("%1.2a" : GoString),
		_val: Go.toInterface((new GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0...1) ({} : stdgo.fmt_test.Fmt_test.T_flagPrinter)]))) : GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>)),
		_out: ("[[%1.2a]]" : GoString)} : T__struct_9),
	({_in: ("%-1.2a" : GoString),
		_val: Go.toInterface((new GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0...1) ({} : stdgo.fmt_test.Fmt_test.T_flagPrinter)]))) : GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>)),
		_out: ("[[%-1.2a]]" : GoString)} : T__struct_9),
	({_in: ("%+1.2a" : GoString),
	...
	({_in: ("%+1.2v" : GoString), _val: Go.toInterface(Go.asInterface((new T_flagPrinter() : T_flagPrinter))), _out: ("[%+1.2v]" : GoString)} : T__struct_9),
	({_in: ("%-+1.2v" : GoString), _val: Go.toInterface(Go.asInterface((new T_flagPrinter() : T_flagPrinter))), _out: ("[%+-1.2v]" : GoString)} : T__struct_9),
	({_in: ("%-+1.2vbc" : GoString), _val: Go.toInterface(Go.asInterface((new T_flagPrinter() : T_flagPrinter))),
		_out: ("[%+-1.2v]bc" : GoString)} : T__struct_9),
	({_in: ("%-1.2vbc" : GoString), _val: Go.toInterface(Go.asInterface((new T_flagPrinter() : T_flagPrinter))),
		_out: ("[%-1.2v]bc" : GoString)} : T__struct_9),
	({_in: ("%v" : GoString),
		_val: Go.toInterface((new GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0...1) ({} : stdgo.fmt_test.Fmt_test.T_flagPrinter)]))) : GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>)),
		_out: ("[[%v]]" : GoString)} : T__struct_9),
	({_in: ("%-v" : GoString),
		_val: Go.toInterface((new GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0...1) ({} : stdgo.fmt_test.Fmt_test.T_flagPrinter)]))) : GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>)),
		_out: ("[[%-v]]" : GoString)} : T__struct_9),
	({_in: ("%+v" : GoString),
	...
	({_in: ("%#v" : GoString),
		_val: Go.toInterface((new GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0...1) ({} : stdgo.fmt_test.Fmt_test.T_flagPrinter)]))) : GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>)),
		_out: ("[1]fmt_test.flagPrinter{[%#v]}" : GoString)} : T__struct_9),
	({_in: ("% v" : GoString),
		_val: Go.toInterface((new GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0...1) ({} : stdgo.fmt_test.Fmt_test.T_flagPrinter)]))) : GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>)),
		_out: ("[[% v]]" : GoString)} : T__struct_9),
	({_in: ("%0v" : GoString),
		_val: Go.toInterface((new GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0...1) ({} : stdgo.fmt_test.Fmt_test.T_flagPrinter)]))) : GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>)),
		_out: ("[[%0v]]" : GoString)} : T__struct_9),
	({_in: ("%1.2v" : GoString),
		_val: Go.toInterface((new GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0...1) ({} : stdgo.fmt_test.Fmt_test.T_flagPrinter)]))) : GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>)),
		_out: ("[[%1.2v]]" : GoString)} : T__struct_9),
	({_in: ("%-1.2v" : GoString),
		_val: Go.toInterface((new GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0...1) ({} : stdgo.fmt_test.Fmt_test.T_flagPrinter)]))) : GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>)),
		_out: ("[[%-1.2v]]" : GoString)} : T__struct_9),
	({_in: ("%+1.2v" : GoString),
	...
	({_in: ("%-1.2vbc" : GoString),
		_val: Go.toInterface((new GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>(...([].concat([for (i in 0...1) ({} : stdgo.fmt_test.Fmt_test.T_flagPrinter)]))) : GoArray<stdgo.fmt_test.Fmt_test.T_flagPrinter>)),
		_out: ("[[%-1.2v]]bc" : GoString)} : T__struct_9)) : Slice<T__struct_9>);

private var _scanTests:Slice<stdgo.fmt_test.Fmt_test.ScanTest> = (new Slice<stdgo.fmt_test.Fmt_test.ScanTest>(0, 0,
	...
	(new stdgo.fmt_test.Fmt_test.ScanTest(("-0o377\n" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((-255 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("0\n" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("0" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("000\n" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("0" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("0x10\n" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("16" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("0377\n" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("255" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("22\n" : GoString), Go.toInterface(Go.pointer(_int8Val)),
		Go.toInterface((22 : GoInt8))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("23\n" : GoString), Go.toInterface(Go.pointer(_int16Val)),
		Go.toInterface((23 : GoInt16))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("24\n" : GoString), Go.toInterface(Go.pointer(_int32Val)),
		Go.toInterface((24 : GoInt32))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("25\n" : GoString), Go.toInterface(Go.pointer(_int64Val)),
		Go.toInterface((("25" : GoInt64) : GoInt64))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("127\n" : GoString), Go.toInterface(Go.pointer(_int8Val)),
		Go.toInterface((127 : GoInt8))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("-21\n" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((-21 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("-22\n" : GoString), Go.toInterface(Go.pointer(_int8Val)),
		Go.toInterface((-22 : GoInt8))) : stdgo.fmt_test.Fmt_test.ScanTest),
	...
	(new stdgo.fmt_test.Fmt_test.ScanTest(("-128\n" : GoString), Go.toInterface(Go.pointer(_int8Val)),
		Go.toInterface((-128 : GoInt8))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("+21\n" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((21 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("+22\n" : GoString), Go.toInterface(Go.pointer(_int8Val)),
		Go.toInterface((22 : GoInt8))) : stdgo.fmt_test.Fmt_test.ScanTest),
	...
	(new stdgo.fmt_test.Fmt_test.ScanTest(("26\n" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("26" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("27\n" : GoString), Go.toInterface(Go.pointer(_uint8Val)),
		Go.toInterface((27 : GoUInt8))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("28\n" : GoString), Go.toInterface(Go.pointer(_uint16Val)),
		Go.toInterface((28 : GoUInt16))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("29\n" : GoString), Go.toInterface(Go.pointer(_uint32Val)),
		Go.toInterface((("29" : GoUInt32) : GoUInt32))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("30\n" : GoString), Go.toInterface(Go.pointer(_uint64Val)),
		Go.toInterface((("30" : GoUInt64) : GoUInt64))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("255\n" : GoString), Go.toInterface(Go.pointer(_uint8Val)),
		Go.toInterface((255 : GoUInt8))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("32767\n" : GoString), Go.toInterface(Go.pointer(_int16Val)),
		Go.toInterface((32767 : GoInt16))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("2.3\n" : GoString), Go.toInterface(Go.pointer(_float64Val)),
		Go.toInterface((2.3 : GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("2.3e1\n" : GoString), Go.toInterface(Go.pointer(_float32Val)),
		Go.toInterface(((23 : GoFloat64) : GoFloat32))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("2.3e2\n" : GoString), Go.toInterface(Go.pointer(_float64Val)),
		Go.toInterface((230 : GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("2.3p2\n" : GoString), Go.toInterface(Go.pointer(_float64Val)),
		Go.toInterface((9.2 : GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("2.3p+2\n" : GoString), Go.toInterface(Go.pointer(_float64Val)),
		Go.toInterface((9.2 : GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("2.3p+66\n" : GoString), Go.toInterface(Go.pointer(_float64Val)),
		Go.toInterface((1.6971004547812786e+20 : GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("2.3p-66\n" : GoString), Go.toInterface(Go.pointer(_float64Val)),
		Go.toInterface((3.117081245895825e-20 : GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("0x2.3p-66\n" : GoString), Go.toInterface(Go.pointer(_float64Val)),
		Go.toInterface((2.964615315390051e-20 : GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("2_3.4_5\n" : GoString), Go.toInterface(Go.pointer(_float64Val)),
		Go.toInterface((23.45 : GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("2.35\n" : GoString), Go.toInterface(Go.pointer(_stringVal)),
		Go.toInterface(("2.35" : GoString))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("2345678\n" : GoString), Go.toInterface((_bytesVal : Ref<Slice<GoUInt8>>)),
		Go.toInterface((("2345678" : GoString) : Slice<GoByte>))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("(3.4e1-2i)\n" : GoString), Go.toInterface(Go.pointer(_complex128Val)),
		Go.toInterface(((34 : GoFloat64) + new GoComplex128(0, -2)))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("-3.45e1-3i\n" : GoString), Go.toInterface(Go.pointer(_complex64Val)),
		Go.toInterface(((-34.5 : GoFloat64) + new GoComplex128(0, -3) : GoComplex64))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("-.45e1-1e2i\n" : GoString), Go.toInterface(Go.pointer(_complex128Val)),
		Go.toInterface(((-4.5 : GoFloat64) + new GoComplex128(0, -100) : GoComplex128))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("-.4_5e1-1E2i\n" : GoString), Go.toInterface(Go.pointer(_complex128Val)),
		Go.toInterface(((-4.5 : GoFloat64) + new GoComplex128(0, -100) : GoComplex128))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("0x1.0p1+0x1.0P2i\n" : GoString), Go.toInterface(Go.pointer(_complex128Val)),
		Go.toInterface(((2 : GoFloat64) + new GoComplex128(0, 4) : GoComplex128))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("-0x1p1-0x1p2i\n" : GoString), Go.toInterface(Go.pointer(_complex128Val)),
		Go.toInterface(((-2 : GoFloat64) + new GoComplex128(0, -4) : GoComplex128))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("-0x1ep-1-0x1p2i\n" : GoString), Go.toInterface(Go.pointer(_complex128Val)),
		Go.toInterface(((-15 : GoFloat64) + new GoComplex128(0, -4) : GoComplex128))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("-0x1_Ep-1-0x1p0_2i\n" : GoString), Go.toInterface(Go.pointer(_complex128Val)),
		Go.toInterface(((-15 : GoFloat64) + new GoComplex128(0, -4) : GoComplex128))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("hello\n" : GoString), Go.toInterface(Go.pointer(_stringVal)),
		Go.toInterface(("hello" : GoString))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("hello\r\n" : GoString), Go.toInterface(Go.pointer(_stringVal)),
		Go.toInterface(("hello" : GoString))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("27\r\n" : GoString), Go.toInterface(Go.pointer(_uint8Val)),
		Go.toInterface((27 : GoUInt8))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("true\n" : GoString), Go.toInterface(Go.pointer(_renamedBoolVal)),
		Go.toInterface((true : T_renamedBool))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("F\n" : GoString), Go.toInterface(Go.pointer(_renamedBoolVal)),
		Go.toInterface((false : T_renamedBool))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("101\n" : GoString), Go.toInterface(Go.pointer(_renamedIntVal)),
		Go.toInterface(((101 : stdgo.fmt_test.Fmt_test.T_renamedInt) : T_renamedInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("102\n" : GoString), Go.toInterface(Go.pointer(_renamedIntVal)),
		Go.toInterface(((102 : stdgo.fmt_test.Fmt_test.T_renamedInt) : T_renamedInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("103\n" : GoString), Go.toInterface(Go.pointer(_renamedUintVal)),
		Go.toInterface(((("103" : GoUInt) : stdgo.fmt_test.Fmt_test.T_renamedUint) : T_renamedUint))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("104\n" : GoString), Go.toInterface(Go.pointer(_renamedUintVal)),
		Go.toInterface(((("104" : GoUInt) : stdgo.fmt_test.Fmt_test.T_renamedUint) : T_renamedUint))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("105\n" : GoString), Go.toInterface(Go.pointer(_renamedInt8Val)),
		Go.toInterface(((105 : stdgo.fmt_test.Fmt_test.T_renamedInt8) : T_renamedInt8))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("106\n" : GoString), Go.toInterface(Go.pointer(_renamedInt16Val)),
		Go.toInterface(((106 : stdgo.fmt_test.Fmt_test.T_renamedInt16) : T_renamedInt16))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("107\n" : GoString), Go.toInterface(Go.pointer(_renamedInt32Val)),
		Go.toInterface(((107 : stdgo.fmt_test.Fmt_test.T_renamedInt32) : T_renamedInt32))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("108\n" : GoString), Go.toInterface(Go.pointer(_renamedInt64Val)),
		Go.toInterface(((("108" : GoInt64) : stdgo.fmt_test.Fmt_test.T_renamedInt64) : T_renamedInt64))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("109\n" : GoString), Go.toInterface(Go.pointer(_renamedUint8Val)),
		Go.toInterface(((109 : stdgo.fmt_test.Fmt_test.T_renamedUint8) : T_renamedUint8))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("110\n" : GoString), Go.toInterface(Go.pointer(_renamedUint16Val)),
		Go.toInterface(((110 : stdgo.fmt_test.Fmt_test.T_renamedUint16) : T_renamedUint16))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("111\n" : GoString), Go.toInterface(Go.pointer(_renamedUint32Val)),
		Go.toInterface(((("111" : GoUInt32) : stdgo.fmt_test.Fmt_test.T_renamedUint32) : T_renamedUint32))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("112\n" : GoString), Go.toInterface(Go.pointer(_renamedUint64Val)),
		Go.toInterface(((("112" : GoUInt64) : stdgo.fmt_test.Fmt_test.T_renamedUint64) : T_renamedUint64))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("113\n" : GoString), Go.toInterface(Go.pointer(_renamedUintptrVal)),
		Go.toInterface(((113 : stdgo.fmt_test.Fmt_test.T_renamedUintptr) : T_renamedUintptr))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("114\n" : GoString), Go.toInterface(Go.pointer(_renamedStringVal)),
		Go.toInterface((("114" : GoString) : T_renamedString))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("115\n" : GoString), Go.toInterface((_renamedBytesVal : Ref<stdgo.fmt_test.Fmt_test.T_renamedBytes>)),
		Go.toInterface(((("115" : GoString) : Slice<GoByte>) : T_renamedBytes))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("  vvv " : GoString), Go.toInterface(Go.pointer(_xVal)),
		Go.toInterface(Go.asInterface((("vvv" : GoString) : Xs)))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest((" 1234hello" : GoString), Go.toInterface(Go.asInterface((_intStringVal : Ref<stdgo.fmt_test.Fmt_test.IntString>))),
		Go.toInterface(Go.asInterface((new IntString((1234 : GoInt), ("hello" : GoString)) : IntString)))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("2147483648\n" : GoString), Go.toInterface(Go.pointer(_int64Val)),
		Go.toInterface((("2147483648" : GoInt64) : GoInt64))) : stdgo.fmt_test.Fmt_test.ScanTest)) : Slice<stdgo.fmt_test.Fmt_test.ScanTest>);

private var _scanfTests:Slice<stdgo.fmt_test.Fmt_test.ScanfTest> = (new Slice<stdgo.fmt_test.Fmt_test.ScanfTest>(0, 0,
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : GoString), ("TRUE\n" : GoString), Go.toInterface(Go.pointer(_boolVal)),
		Go.toInterface(true)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%t" : GoString), ("false\n" : GoString), Go.toInterface(Go.pointer(_boolVal)),
		Go.toInterface(false)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : GoString), ("-71\n" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((-71 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : GoString), ("-7_1\n" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((-71 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : GoString), ("0b111\n" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((7 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : GoString), ("0b_1_1_1\n" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((7 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : GoString), ("0377\n" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((255 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	...
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : GoString), ("0x44\n" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((68 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : GoString), ("0x_4_4\n" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((68 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("72\n" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((72 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%c" : GoString), ("a\n" : GoString), Go.toInterface(Go.pointer(_runeVal)),
		Go.toInterface((97 : GoInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%c" : GoString), ("偲\n" : GoString), Go.toInterface(Go.pointer(_runeVal)),
		Go.toInterface((20594 : GoInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%c" : GoString), ("ሴ\n" : GoString), Go.toInterface(Go.pointer(_runeVal)),
		Go.toInterface((4660 : GoInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("73\n" : GoString), Go.toInterface(Go.pointer(_int8Val)),
		Go.toInterface((73 : GoInt8))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("+74\n" : GoString), Go.toInterface(Go.pointer(_int16Val)),
		Go.toInterface((74 : GoInt16))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("75\n" : GoString), Go.toInterface(Go.pointer(_int32Val)),
		Go.toInterface((75 : GoInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("76\n" : GoString), Go.toInterface(Go.pointer(_int64Val)),
		Go.toInterface((("76" : GoInt64) : GoInt64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%b" : GoString), ("1001001\n" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((73 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%o" : GoString), ("075\n" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((61 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%x" : GoString), ("a75\n" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((2677 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : GoString), ("71\n" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("71" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("72\n" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("72" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("7_2\n" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("7" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("73\n" : GoString), Go.toInterface(Go.pointer(_uint8Val)),
		Go.toInterface((73 : GoUInt8))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("74\n" : GoString), Go.toInterface(Go.pointer(_uint16Val)),
		Go.toInterface((74 : GoUInt16))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("75\n" : GoString), Go.toInterface(Go.pointer(_uint32Val)),
		Go.toInterface((("75" : GoUInt32) : GoUInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("76\n" : GoString), Go.toInterface(Go.pointer(_uint64Val)),
		Go.toInterface((("76" : GoUInt64) : GoUInt64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%b" : GoString), ("1001001\n" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("73" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%b" : GoString), ("100_1001\n" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("4" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%o" : GoString), ("075\n" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("61" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%o" : GoString), ("07_5\n" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("7" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%x" : GoString), ("a75\n" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("2677" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%x" : GoString), ("A75\n" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("2677" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%x" : GoString), ("A7_5\n" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("167" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%U" : GoString), ("U+1234\n" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((4660 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%U" : GoString), ("U+4567\n" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("17767" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%e" : GoString), ("2.3\n" : GoString), Go.toInterface(Go.pointer(_float64Val)),
		Go.toInterface((2.3 : GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%E" : GoString), ("2.3e1\n" : GoString), Go.toInterface(Go.pointer(_float32Val)),
		Go.toInterface(((23 : GoFloat64) : GoFloat32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%f" : GoString), ("2.3e2\n" : GoString), Go.toInterface(Go.pointer(_float64Val)),
		Go.toInterface((230 : GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%g" : GoString), ("2.3p2\n" : GoString), Go.toInterface(Go.pointer(_float64Val)),
		Go.toInterface((9.2 : GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%G" : GoString), ("2.3p+2\n" : GoString), Go.toInterface(Go.pointer(_float64Val)),
		Go.toInterface((9.2 : GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : GoString), ("2.3p+66\n" : GoString), Go.toInterface(Go.pointer(_float64Val)),
		Go.toInterface((1.6971004547812786e+20 : GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%f" : GoString), ("2.3p-66\n" : GoString), Go.toInterface(Go.pointer(_float64Val)),
		Go.toInterface((3.117081245895825e-20 : GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%G" : GoString), ("0x2.3p-66\n" : GoString), Go.toInterface(Go.pointer(_float64Val)),
		Go.toInterface((2.964615315390051e-20 : GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%E" : GoString), ("2_3.4_5\n" : GoString), Go.toInterface(Go.pointer(_float64Val)),
		Go.toInterface((23.45 : GoFloat64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%s" : GoString), ("using-%s\n" : GoString), Go.toInterface(Go.pointer(_stringVal)),
		Go.toInterface(("using-%s" : GoString))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%x" : GoString), ("7573696e672d2578\n" : GoString), Go.toInterface(Go.pointer(_stringVal)),
		Go.toInterface(("using-%x" : GoString))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	...
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%q" : GoString), ("\"quoted\\twith\\\\do\\u0075bl\\x65s\"\n" : GoString), Go.toInterface(Go.pointer(_stringVal)),
		Go.toInterface(("quoted\twith\\doubles" : GoString))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%q" : GoString), ("`quoted with backs`\n" : GoString), Go.toInterface(Go.pointer(_stringVal)),
		Go.toInterface(("quoted with backs" : GoString))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%s" : GoString), ("bytes-%s\n" : GoString), Go.toInterface((_bytesVal : Ref<Slice<GoUInt8>>)),
		Go.toInterface((("bytes-%s" : GoString) : Slice<GoByte>))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%x" : GoString), ("62797465732d2578\n" : GoString), Go.toInterface((_bytesVal : Ref<Slice<GoUInt8>>)),
		Go.toInterface((("bytes-%x" : GoString) : Slice<GoByte>))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	...
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%q" : GoString), ("\"bytes\\rwith\\vdo\\u0075bl\\x65s\"\n" : GoString),
		Go.toInterface((_bytesVal : Ref<Slice<GoUInt8>>)),
		Go.toInterface((("bytes\rwith\x0Bdoubles" : GoString) : Slice<GoByte>))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%q" : GoString), ("`bytes with backs`\n" : GoString), Go.toInterface((_bytesVal : Ref<Slice<GoUInt8>>)),
		Go.toInterface((("bytes with backs" : GoString) : Slice<GoByte>))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v\n" : GoString), ("true\n" : GoString), Go.toInterface(Go.pointer(_renamedBoolVal)),
		Go.toInterface((true : T_renamedBool))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%t\n" : GoString), ("F\n" : GoString), Go.toInterface(Go.pointer(_renamedBoolVal)),
		Go.toInterface((false : T_renamedBool))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : GoString), ("101\n" : GoString), Go.toInterface(Go.pointer(_renamedIntVal)),
		Go.toInterface(((101 : stdgo.fmt_test.Fmt_test.T_renamedInt) : T_renamedInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%c" : GoString), ("ā\n" : GoString), Go.toInterface(Go.pointer(_renamedIntVal)),
		Go.toInterface(((257 : stdgo.fmt_test.Fmt_test.T_renamedInt) : T_renamedInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%o" : GoString), ("0146\n" : GoString), Go.toInterface(Go.pointer(_renamedIntVal)),
		Go.toInterface(((102 : stdgo.fmt_test.Fmt_test.T_renamedInt) : T_renamedInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : GoString), ("103\n" : GoString), Go.toInterface(Go.pointer(_renamedUintVal)),
		Go.toInterface(((("103" : GoUInt) : stdgo.fmt_test.Fmt_test.T_renamedUint) : T_renamedUint))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("104\n" : GoString), Go.toInterface(Go.pointer(_renamedUintVal)),
		Go.toInterface(((("104" : GoUInt) : stdgo.fmt_test.Fmt_test.T_renamedUint) : T_renamedUint))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("105\n" : GoString), Go.toInterface(Go.pointer(_renamedInt8Val)),
		Go.toInterface(((105 : stdgo.fmt_test.Fmt_test.T_renamedInt8) : T_renamedInt8))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("106\n" : GoString), Go.toInterface(Go.pointer(_renamedInt16Val)),
		Go.toInterface(((106 : stdgo.fmt_test.Fmt_test.T_renamedInt16) : T_renamedInt16))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("107\n" : GoString), Go.toInterface(Go.pointer(_renamedInt32Val)),
		Go.toInterface(((107 : stdgo.fmt_test.Fmt_test.T_renamedInt32) : T_renamedInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("108\n" : GoString), Go.toInterface(Go.pointer(_renamedInt64Val)),
		Go.toInterface(((("108" : GoInt64) : stdgo.fmt_test.Fmt_test.T_renamedInt64) : T_renamedInt64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%x" : GoString), ("6D\n" : GoString), Go.toInterface(Go.pointer(_renamedUint8Val)),
		Go.toInterface(((109 : stdgo.fmt_test.Fmt_test.T_renamedUint8) : T_renamedUint8))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%o" : GoString), ("0156\n" : GoString), Go.toInterface(Go.pointer(_renamedUint16Val)),
		Go.toInterface(((110 : stdgo.fmt_test.Fmt_test.T_renamedUint16) : T_renamedUint16))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("111\n" : GoString), Go.toInterface(Go.pointer(_renamedUint32Val)),
		Go.toInterface(((("111" : GoUInt32) : stdgo.fmt_test.Fmt_test.T_renamedUint32) : T_renamedUint32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("112\n" : GoString), Go.toInterface(Go.pointer(_renamedUint64Val)),
		Go.toInterface(((("112" : GoUInt64) : stdgo.fmt_test.Fmt_test.T_renamedUint64) : T_renamedUint64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("113\n" : GoString), Go.toInterface(Go.pointer(_renamedUintptrVal)),
		Go.toInterface(((113 : stdgo.fmt_test.Fmt_test.T_renamedUintptr) : T_renamedUintptr))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%s" : GoString), ("114\n" : GoString), Go.toInterface(Go.pointer(_renamedStringVal)),
		Go.toInterface((("114" : GoString) : T_renamedString))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%q" : GoString), ("\"1155\"\n" : GoString),
		Go.toInterface((_renamedBytesVal : Ref<stdgo.fmt_test.Fmt_test.T_renamedBytes>)),
		Go.toInterface(((("1155" : GoString) : Slice<GoByte>) : T_renamedBytes))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%g" : GoString), ("116e1\n" : GoString), Go.toInterface(Go.pointer(_renamedFloat32Val)),
		Go.toInterface(((1160 : GoFloat64) : T_renamedFloat32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%g" : GoString), ("-11.7e+1" : GoString), Go.toInterface(Go.pointer(_renamedFloat64Val)),
		Go.toInterface(((-117 : GoFloat64) : T_renamedFloat64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%g" : GoString), ("11+6e1i\n" : GoString), Go.toInterface(Go.pointer(_renamedComplex64Val)),
		Go.toInterface(((11 : GoFloat64) + new GoComplex128(0, 60) : T_renamedComplex64))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%g" : GoString), ("-11.+7e+1i" : GoString), Go.toInterface(Go.pointer(_renamedComplex128Val)),
		Go.toInterface(((-11 : GoFloat64) + new GoComplex128(0, 70) : T_renamedComplex128))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("here is\tthe value:%d" : GoString), ("here is   the\tvalue:118\n" : GoString),
		Go.toInterface(Go.pointer(_intVal)), Go.toInterface((118 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%% %%:%d" : GoString), ("% %:119\n" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((119 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d%%" : GoString), ("42%" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((42 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%x" : GoString), ("FFFFFFFF\n" : GoString), Go.toInterface(Go.pointer(_uint32Val)),
		Go.toInterface((("4294967295" : GoUInt32) : GoUInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%s" : GoString), ("  sss " : GoString), Go.toInterface(Go.pointer(_xVal)),
		Go.toInterface(Go.asInterface((("sss" : GoString) : Xs)))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%2s" : GoString), ("sssss" : GoString), Go.toInterface(Go.pointer(_xVal)),
		Go.toInterface(Go.asInterface((("ss" : GoString) : Xs)))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d\n" : GoString), ("27\n" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d\n" : GoString), ("28 \n" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((28 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : GoString), ("0" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((0 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%v" : GoString), ("0" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("0" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%c" : GoString), (" " : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("32" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%c" : GoString), ("\t" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("9" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%c" : GoString), ("\n" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("10" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d%%" : GoString), ("23%\n" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("23" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%%%d" : GoString), ("%23\n" : GoString), Go.toInterface(Go.pointer(_uintVal)),
		Go.toInterface((("23" : GoUInt) : GoUInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("27" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), ("27 " : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), (" 27" : GoString), Go.toInterface(Go.pointer(_intVal)),
	...
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d" : GoString), (" 27 " : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%d" : GoString), ("X27" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%d" : GoString), ("X27 " : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%d" : GoString), ("X 27" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%d" : GoString), ("X 27 " : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %d" : GoString), ("X27" : GoString), Go.toInterface(Go.pointer(_intVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %d" : GoString), ("X27 " : GoString), Go.toInterface(Go.pointer(_intVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %d" : GoString), ("X 27" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %d" : GoString), ("X 27 " : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%dX" : GoString), ("27X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%dX" : GoString), ("27 X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%dX" : GoString), (" 27X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%dX" : GoString), (" 27 X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d X" : GoString), ("27X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d X" : GoString), ("27 X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d X" : GoString), (" 27X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d X" : GoString), (" 27 X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %d X" : GoString), ("X27X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %d X" : GoString), ("X27 X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %d X" : GoString), ("X 27X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %d X" : GoString), ("X 27 X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %s X" : GoString), ("X27X" : GoString), Go.toInterface(Go.pointer(_stringVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %s X" : GoString), ("X27 X" : GoString), Go.toInterface(Go.pointer(_stringVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %s X" : GoString), ("X 27X" : GoString), Go.toInterface(Go.pointer(_stringVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %s X" : GoString), ("X 27 X" : GoString), Go.toInterface(Go.pointer(_stringVal)),
		Go.toInterface(("27" : GoString))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%sX" : GoString), ("X27X" : GoString), Go.toInterface(Go.pointer(_stringVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%sX" : GoString), ("X27 X" : GoString), Go.toInterface(Go.pointer(_stringVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%sX" : GoString), ("X 27X" : GoString), Go.toInterface(Go.pointer(_stringVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%sX" : GoString), ("X 27 X" : GoString), Go.toInterface(Go.pointer(_stringVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%s" : GoString), ("X27" : GoString), Go.toInterface(Go.pointer(_stringVal)),
		Go.toInterface(("27" : GoString))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%s" : GoString), ("X27 " : GoString), Go.toInterface(Go.pointer(_stringVal)),
		Go.toInterface(("27" : GoString))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%s" : GoString), ("X 27" : GoString), Go.toInterface(Go.pointer(_stringVal)),
		Go.toInterface(("27" : GoString))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%s" : GoString), ("X 27 " : GoString), Go.toInterface(Go.pointer(_stringVal)),
		Go.toInterface(("27" : GoString))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX" : GoString), ("X27X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX" : GoString), ("X27 X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX" : GoString), ("X 27X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX" : GoString), ("X 27 X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX" : GoString), ("X27X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX" : GoString), ("X27X " : GoString), Go.toInterface(Go.pointer(_intVal)),
	...
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX" : GoString), (" X27X " : GoString), Go.toInterface(Go.pointer(_intVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX\n" : GoString), ("X27X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX \n" : GoString), ("X27X " : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%dX\n" : GoString), ("X27X\n" : GoString), Go.toInterface(Go.pointer(_intVal)),
	...
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%c" : GoString), ("X\n" : GoString), Go.toInterface(Go.pointer(_runeVal)),
		Go.toInterface((10 : GoInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X%c" : GoString), ("X \n" : GoString), Go.toInterface(Go.pointer(_runeVal)),
		Go.toInterface((32 : GoInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %c" : GoString), ("X!" : GoString), Go.toInterface(Go.pointer(_runeVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %c" : GoString), ("X\n" : GoString), Go.toInterface(Go.pointer(_runeVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %c" : GoString), ("X !" : GoString), Go.toInterface(Go.pointer(_runeVal)),
		Go.toInterface((33 : GoInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("X %c" : GoString), ("X \n" : GoString), Go.toInterface(Go.pointer(_runeVal)),
		Go.toInterface((10 : GoInt32))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest((" X%dX" : GoString), ("X27X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		(null : AnyInterface)) : stdgo.fmt_test.Fmt_test.ScanfTest),
	...
	(new stdgo.fmt_test.Fmt_test.ScanfTest((" X%dX " : GoString), (" X27X " : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%d\nX" : GoString), ("27\nX" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest),
	(new stdgo.fmt_test.Fmt_test.ScanfTest(("%dX\n X" : GoString), ("27X\n X" : GoString), Go.toInterface(Go.pointer(_intVal)),
		Go.toInterface((27 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanfTest)) : Slice<stdgo.fmt_test.Fmt_test.ScanfTest>);

private var _overflowTests:Slice<stdgo.fmt_test.Fmt_test.ScanTest> = (new Slice<stdgo.fmt_test.Fmt_test.ScanTest>(0, 0,
	(new stdgo.fmt_test.Fmt_test.ScanTest(("128" : GoString), Go.toInterface(Go.pointer(_int8Val)),
		Go.toInterface((0 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("32768" : GoString), Go.toInterface(Go.pointer(_int16Val)),
		Go.toInterface((0 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("-129" : GoString), Go.toInterface(Go.pointer(_int8Val)),
		Go.toInterface((0 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("-32769" : GoString), Go.toInterface(Go.pointer(_int16Val)),
		Go.toInterface((0 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("256" : GoString), Go.toInterface(Go.pointer(_uint8Val)),
		Go.toInterface((0 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("65536" : GoString), Go.toInterface(Go.pointer(_uint16Val)),
		Go.toInterface((0 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("1e100" : GoString), Go.toInterface(Go.pointer(_float32Val)),
		Go.toInterface((0 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("1e500" : GoString), Go.toInterface(Go.pointer(_float64Val)),
		Go.toInterface((0 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("(1e100+0i)" : GoString), Go.toInterface(Go.pointer(_complex64Val)),
		Go.toInterface((0 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("(1+1e100i)" : GoString), Go.toInterface(Go.pointer(_complex64Val)),
		Go.toInterface((0 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest),
	(new stdgo.fmt_test.Fmt_test.ScanTest(("(1-1e500i)" : GoString), Go.toInterface(Go.pointer(_complex128Val)),
		Go.toInterface((0 : GoInt))) : stdgo.fmt_test.Fmt_test.ScanTest)) : Slice<stdgo.fmt_test.Fmt_test.ScanTest>);

private var _multiTests:Slice<stdgo.fmt_test.Fmt_test.ScanfMultiTest> = (new Slice<stdgo.fmt_test.Fmt_test.ScanfMultiTest>(0, 0,
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(Go.str(), Go.str(), (new Slice<AnyInterface>(0, 0) : Slice<AnyInterface>),
		(new Slice<AnyInterface>(0, 0) : Slice<AnyInterface>), Go.str()) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%d" : GoString), ("23" : GoString), _args(Go.toInterface(Go.pointer(_i))),
		_args(Go.toInterface((23 : GoInt))), Go.str()) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%2s%3s" : GoString), ("22333" : GoString),
		_args(Go.toInterface(Go.pointer(_s)), Go.toInterface(Go.pointer(_t))), _args(Go.toInterface(("22" : GoString)), Go.toInterface(("333" : GoString))),
		Go.str()) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%2d%3d" : GoString), ("44555" : GoString),
		_args(Go.toInterface(Go.pointer(_i)), Go.toInterface(Go.pointer(_j))), _args(Go.toInterface((44 : GoInt)), Go.toInterface((555 : GoInt))),
		Go.str()) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%2d.%3d" : GoString), ("66.777" : GoString),
		_args(Go.toInterface(Go.pointer(_i)), Go.toInterface(Go.pointer(_j))), _args(Go.toInterface((66 : GoInt)), Go.toInterface((777 : GoInt))),
		Go.str()) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%d, %d" : GoString), ("23, 18" : GoString),
		_args(Go.toInterface(Go.pointer(_i)), Go.toInterface(Go.pointer(_j))), _args(Go.toInterface((23 : GoInt)), Go.toInterface((18 : GoInt))),
		Go.str()) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%3d22%3d" : GoString), ("33322333" : GoString),
		_args(Go.toInterface(Go.pointer(_i)), Go.toInterface(Go.pointer(_j))), _args(Go.toInterface((333 : GoInt)), Go.toInterface((333 : GoInt))),
		Go.str()) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%6vX=%3fY" : GoString), ("3+2iX=2.5Y" : GoString),
		_args(Go.toInterface(Go.pointer(_c)), Go.toInterface(Go.pointer(_f))),
		_args(Go.toInterface(((3 : GoFloat64) + new GoComplex128(0, 2))), Go.toInterface((2.5 : GoFloat64))),
		Go.str()) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%d%s" : GoString), ("123abc" : GoString),
		_args(Go.toInterface(Go.pointer(_i)), Go.toInterface(Go.pointer(_s))), _args(Go.toInterface((123 : GoInt)), Go.toInterface(("abc" : GoString))),
		Go.str()) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%c%c%c" : GoString), ("2僂X" : GoString),
		_args(Go.toInterface(Go.pointer(_r1)), Go.toInterface(Go.pointer(_r2)), Go.toInterface(Go.pointer(_r3))),
		_args(Go.toInterface((50 : GoInt32)), Go.toInterface((20674 : GoInt32)), Go.toInterface((88 : GoInt32))),
		Go.str()) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%5s%d" : GoString), (" 1234567 " : GoString),
		_args(Go.toInterface(Go.pointer(_s)), Go.toInterface(Go.pointer(_i))), _args(Go.toInterface(("12345" : GoString)), Go.toInterface((67 : GoInt))),
		Go.str()) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%5s%d" : GoString), (" 12 34 567 " : GoString),
		_args(Go.toInterface(Go.pointer(_s)), Go.toInterface(Go.pointer(_i))), _args(Go.toInterface(("12" : GoString)), Go.toInterface((34 : GoInt))),
		Go.str()) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%e%f" : GoString), ("eefffff" : GoString),
		_args(Go.toInterface(Go.pointer(_x)), Go.toInterface(Go.pointer(_y))),
		_args(Go.toInterface(Go.asInterface((("ee" : GoString) : Xs))), Go.toInterface(Go.asInterface((("fffff" : GoString) : Xs)))),
		Go.str()) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%4v%s" : GoString), ("12abcd" : GoString),
		_args(Go.toInterface(Go.asInterface((_z : Ref<stdgo.fmt_test.Fmt_test.IntString>))), Go.toInterface(Go.pointer(_s))),
		_args(Go.toInterface(Go.asInterface((new IntString((12 : GoInt), ("ab" : GoString)) : IntString))), Go.toInterface(("cd" : GoString))),
		Go.str()) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%t" : GoString), ("23 18" : GoString), _args(Go.toInterface(Go.pointer(_i))), (null : Slice<AnyInterface>),
		("bad verb" : GoString)) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%d %d %d" : GoString), ("23 18" : GoString),
		_args(Go.toInterface(Go.pointer(_i)), Go.toInterface(Go.pointer(_j))), _args(Go.toInterface((23 : GoInt)), Go.toInterface((18 : GoInt))),
		("too few operands" : GoString)) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%d %d" : GoString), ("23 18 27" : GoString),
		_args(Go.toInterface(Go.pointer(_i)), Go.toInterface(Go.pointer(_j)), Go.toInterface(Go.pointer(_k))),
		_args(Go.toInterface((23 : GoInt)), Go.toInterface((18 : GoInt))), ("too many operands" : GoString)) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%c" : GoString), ("Ā" : GoString), _args(Go.toInterface(Go.pointer(_int8Val))),
		(null : Slice<AnyInterface>), ("overflow" : GoString)) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("X%d" : GoString), ("10X" : GoString), _args(Go.toInterface(Go.pointer(_intVal))),
		(null : Slice<AnyInterface>), ("input does not match format" : GoString)) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%d%" : GoString), ("42%" : GoString), _args(Go.toInterface(Go.pointer(_intVal))),
		_args(Go.toInterface((42 : GoInt))), ("missing verb: % at end of format string" : GoString)) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%d% " : GoString), ("42%" : GoString), _args(Go.toInterface(Go.pointer(_intVal))),
		_args(Go.toInterface((42 : GoInt))), ("too few operands for format \'% \'" : GoString)) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%%%d" : GoString), ("xxx 42" : GoString), _args(Go.toInterface(Go.pointer(_intVal))),
		_args(Go.toInterface((42 : GoInt))), ("missing literal %" : GoString)) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%%%d" : GoString), ("x42" : GoString), _args(Go.toInterface(Go.pointer(_intVal))),
		_args(Go.toInterface((42 : GoInt))), ("missing literal %" : GoString)) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%%%d" : GoString), ("42" : GoString), _args(Go.toInterface(Go.pointer(_intVal))),
		_args(Go.toInterface((42 : GoInt))), ("missing literal %" : GoString)) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%c%c%c" : GoString), Go.str(194, "X", 194),
		_args(Go.toInterface(Go.pointer(_r1)), Go.toInterface(Go.pointer(_r2)), Go.toInterface(Go.pointer(_r3))),
		_args(Go.toInterface((65533 : GoInt32)), Go.toInterface((88 : GoInt32)), Go.toInterface((65533 : GoInt32))),
		Go.str()) : stdgo.fmt_test.Fmt_test.ScanfMultiTest),
	(new stdgo.fmt_test.Fmt_test.ScanfMultiTest(("%v%v" : GoString), ("FALSE23" : GoString),
		_args(Go.toInterface(Go.pointer(_truth)), Go.toInterface(Go.pointer(_i))), _args(Go.toInterface(false), Go.toInterface((23 : GoInt))),
		Go.str()) : stdgo.fmt_test.Fmt_test.ScanfMultiTest)) : Slice<stdgo.fmt_test.Fmt_test.ScanfMultiTest>);

private var _readers:Slice<T__struct_11> = (new Slice<T__struct_11>(0, 0, ({
	_name: ("StringReader" : GoString),
	_f: function(_s:GoString):stdgo.io.Io.Reader {
		return Go.asInterface(stdgo.strings.Strings.newReader(_s));
	}
} : T__struct_11), ({
	_name: ("ReaderOnly" : GoString),
	_f: function(_s:GoString):stdgo.io.Io.Reader {
		return Go.asInterface(({reader: Go.asInterface(stdgo.strings.Strings.newReader(_s))} : T__struct_12));
	}
	} : T__struct_11), ({
	_name: ("OneByteReader" : GoString),
	_f: function(_s:GoString):stdgo.io.Io.Reader {
		return stdgo.testing.iotest.Iotest.oneByteReader(Go.asInterface(stdgo.strings.Strings.newReader(_s)));
	}
	} : T__struct_11), ({
	_name: ("DataErrReader" : GoString),
	_f: function(_s:GoString):stdgo.io.Io.Reader {
...
private var _eofTests:Slice<T__struct_13> = (new Slice<T__struct_13>(0, 0,
...
private var _0:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
private final _appendResult:GoString = ("hello world, 23" : GoString);
private final _hello:GoString = ("hello " : GoString);
...
**/
private final _intCount:GoUInt64 = ("800" : GoUInt64);
...
@:structInit @:using(stdgo.fmt_test.Fmt_test.T_flagPrinter_static_extension) private class T_flagPrinter {
	public function new() {}
...
**/
@:structInit @:using(stdgo.fmt_test.Fmt_test.T_eofCounter_static_extension) private class T_eofCounter {
...
**/
@:structInit @:using(stdgo.fmt_test.Fmt_test.T_runeScanner_static_extension) private class T_runeScanner {
...
@:keep @:allow(stdgo.fmt_test.Fmt_test.T__struct_12_asInterface) class T__struct_12_static_extension {
	@:embedded
	public static function read(__self__:T__struct_12, __0:Slice<GoUInt8>):{var _0:GoInt; var _1:Error;}
		return return __self__.reader.read(__0);
}
...
function testErrorf(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	for (_0 => _test in (new Slice<T__struct_0>(0, 0,
		({_err: stdgo.fmt.Fmt.errorf(("%w" : GoString),
			Go.toInterface(_wrapped)), _wantText: ("inner error" : GoString), _wantUnwrap: _wrapped} : T__struct_0),
		({_err: stdgo.fmt.Fmt.errorf(("added context: %w" : GoString),
			Go.toInterface(_wrapped)), _wantText: ("added context: inner error" : GoString), _wantUnwrap: _wrapped} : T__struct_0),
		({_err: stdgo.fmt.Fmt.errorf(("%w with added context" : GoString),
			Go.toInterface(_wrapped)), _wantText: ("inner error with added context" : GoString), _wantUnwrap: _wrapped} : T__struct_0),
		({_err: stdgo.fmt.Fmt.errorf(("%s %w %v" : GoString), Go.toInterface(("prefix" : GoString)), Go.toInterface(_wrapped),
			Go.toInterface(("suffix" : GoString))), _wantText: ("prefix inner error suffix" : GoString), _wantUnwrap: _wrapped} : T__struct_0),
		({_err: stdgo.fmt.Fmt.errorf(("%[2]s: %[1]w" : GoString), Go.toInterface(_wrapped),
			Go.toInterface(("positional verb" : GoString))), _wantText: ("positional verb: inner error" : GoString), _wantUnwrap: _wrapped} : T__struct_0),
		({_err: stdgo.fmt.Fmt.errorf(("%v" : GoString),
			Go.toInterface(_wrapped)), _wantText: ("inner error" : GoString), _wantUnwrap: (null : Error)} : T__struct_0),
		({_err: stdgo.fmt.Fmt.errorf(("added context: %v" : GoString),
			Go.toInterface(_wrapped)), _wantText: ("added context: inner error" : GoString), _wantUnwrap: (null : Error)} : T__struct_0),
		({_err: stdgo.fmt.Fmt.errorf(("%v with added context" : GoString),
			Go.toInterface(_wrapped)), _wantText: ("inner error with added context" : GoString), _wantUnwrap: (null : Error)} : T__struct_0),
		({_err: _noVetErrorf(("%w is not an error" : GoString),
			Go.toInterface(("not-an-error" : GoString))), _wantText: ("%!w(string=not-an-error) is not an error" : GoString),
			_wantUnwrap: (null : Error)} : T__struct_0),
		({_err: _noVetErrorf(("wrapped two errors: %w %w" : GoString), Go.toInterface(Go.asInterface((("1" : GoString) : T_errString))),
			Go.toInterface(Go.asInterface((("2" : GoString) : T_errString)))), _wantText: ("wrapped two errors: 1 %!w(fmt_test.errString=2)" : GoString),
			_wantUnwrap: (null : Error)} : T__struct_0),
		({_err: _noVetErrorf(("wrapped three errors: %w %w %w" : GoString), Go.toInterface(Go.asInterface((("1" : GoString) : T_errString))),
			Go.toInterface(Go.asInterface((("2" : GoString) : T_errString))),
			Go.toInterface(Go.asInterface((("3" : GoString) : T_errString)))),
			_wantText: ("wrapped three errors: 1 %!w(fmt_test.errString=2) %!w(fmt_test.errString=3)" : GoString), _wantUnwrap: (null : Error)} : T__struct_0),
		({_err: stdgo.fmt.Fmt.errorf(("%w" : GoString),
			(null : AnyInterface)), _wantText: ("%!w(<nil>)" : GoString), _wantUnwrap: (null : Error)} : T__struct_0)) : Slice<T__struct_0>)) {
		{
			var _0:Error = stdgo.errors.Errors.unwrap(_test._err),
				_1:Error = _test._wantUnwrap,
				_want:Error = _1,
				_got:Error = _0;
			if (Go.toInterface(_got) != (Go.toInterface(_want))) {
				_t.errorf(("Formatted error: %v\nerrors.Unwrap() = %v, want %v" : GoString), Go.toInterface(_test._err), Go.toInterface(_got),
					Go.toInterface(_want));
			};
		};
		{
			var _0:GoString = _test._err.error(),
				_1:GoString = _test._wantText,
				_want:GoString = _1,
				_got:GoString = _0;
			if (_got != (_want)) {
...
function example_printers():Void {
	var _0:GoFloat64 = (3 : GoFloat64),
		_1:GoFloat64 = (4 : GoFloat64),
		_b:GoFloat64 = _1,
		_a:GoFloat64 = _0;
	var _h:GoFloat64 = stdgo.math.Math.hypot(_a, _b);
	stdgo.fmt.Fmt.print(Go.toInterface(("The vector (" : GoString)), Go.toInterface(_a), Go.toInterface(_b), Go.toInterface((") has length " : GoString)),
		Go.toInterface(_h), Go.toInterface((".\n" : GoString)));
	stdgo.fmt.Fmt.println(Go.toInterface(("The vector (" : GoString)), Go.toInterface(_a), Go.toInterface(_b), Go.toInterface((") has length" : GoString)),
		Go.toInterface(_h), Go.toInterface(("." : GoString)));
...
function example_formats():Void {
	...
	stdgo.fmt.Fmt.printf(("%v %d %x %o %b\n" : GoString), Go.toInterface(_answer), Go.toInterface(_answer), Go.toInterface(_answer), Go.toInterface(_answer),
		Go.toInterface(_answer));
	var _pi:GoFloat64 = (3.141592653589793 : GoFloat64);
	stdgo.fmt.Fmt.printf(("%v %g %.2f (%6.2f) %e\n" : GoString), Go.toInterface(_pi), Go.toInterface(_pi), Go.toInterface(_pi), Go.toInterface(_pi),
		Go.toInterface(_pi));
	...
	stdgo.fmt.Fmt.printf(("%v %d %c %q %U %#U\n" : GoString), Go.toInterface(_smile), Go.toInterface(_smile), Go.toInterface(_smile), Go.toInterface(_smile),
		Go.toInterface(_smile), Go.toInterface(_smile));
	var _placeholders:GoString = ("foo \"bar\"" : GoString);
	stdgo.fmt.Fmt.printf(("%v %s %q %#q\n" : GoString), Go.toInterface(_placeholders), Go.toInterface(_placeholders), Go.toInterface(_placeholders),
		Go.toInterface(_placeholders));
	var _isLegume = ({
		final x = new stdgo.GoMap.GoObjectMap<GoString,
	...
	stdgo.fmt.Fmt.printf(("%v %+v %#v\n" : GoString), Go.toInterface(Go.asInterface(_person)), Go.toInterface(Go.asInterface(_person)),
		Go.toInterface(Go.asInterface(_person)));
	...
	var _greats = (new GoArray<GoString>(("Kitano" : GoString), ("Kobayashi" : GoString), ("Kurosawa" : GoString), ("Miyazaki" : GoString),
		("Ozu" : GoString)) : GoArray<GoString>);
	...
	stdgo.fmt.Fmt.printf(("%v %d %s %q %x % x\n" : GoString), Go.toInterface(_cmd), Go.toInterface(_cmd), Go.toInterface(_cmd), Go.toInterface(_cmd),
		Go.toInterface(_cmd), Go.toInterface(_cmd));
	var _now:stdgo.time.Time.Time = (stdgo.time.Time.unix(("123456789" : GoInt64), ("0" : GoInt64))
		.utc() == null ? null : stdgo.time.Time.unix(("123456789" : GoInt64), ("0" : GoInt64))
		.utc()
		.__copy__());
		...
		if (_s != (_tt._out)) {
			{
				...
				if (_ok) {
					_t.errorf(("Sprintf(%q, %q) = <%s> want <%s>" : GoString), Go.toInterface(_tt._fmt), _tt._val, Go.toInterface(_s),
				...
				for (_3 => _char in ("fFeEgG" : GoString)) {
					...
					for (_4 => _realValue in _values) {
						for (_5 => _imagValue in _values) {
							...
							var _two:GoString = sprintf(((("(" : GoString) + _realFmt) + _imagFmt) + ("i)" : GoString), Go.toInterface(_realValue),
								Go.toInterface(_imagValue));
							if (_one != (_two)) {
...
function testReorder(_t:Ref<stdgo.testing.Testing.T>):Void {
	for (_0 => _tt in _reorderTests) {
		...
		if (_s != (_tt._out)) {
			_t.errorf(("Sprintf(%q, %v) = <%s> want <%s>" : GoString), Go.toInterface(_tt._fmt), Go.toInterface(_tt._val), Go.toInterface(_s),
				Go.toInterface(_tt._out));
		} else {};
	};
}
...
function benchmarkManyArgs(_b:Ref<stdgo.testing.Testing.B>):Void {
	_b.runParallel(function(_pb:Ref<stdgo.testing.Testing.PB>):Void {
		...
		while (_pb.next()) {
			_buf.reset();
			fprintf(Go.asInterface((_buf : Ref<stdgo.bytes.Bytes.Buffer>)), ("%2d/%2d/%2d %d:%d:%d %s %s\n" : GoString), Go.toInterface((3 : GoInt)),
				Go.toInterface((4 : GoInt)), Go.toInterface((5 : GoInt)), Go.toInterface((11 : GoInt)), Go.toInterface((12 : GoInt)),
				Go.toInterface((13 : GoInt)), Go.toInterface(("hello" : GoString)), Go.toInterface(("world" : GoString)));
		};
	});
}
...
function testCountMallocs(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	for (_0 => _mt in _mallocTest) {
		...
		{
			var _0:GoFloat64 = _mallocs,
				_1:GoFloat64 = (_mt._count : GoFloat64),
				_max:GoFloat64 = _1,
				_got:GoFloat64 = _0;
			if (_got > _max) {
...
function testStructPrinter(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	_s._b = ("def" : GoString);
	_s._c = (123 : GoInt);
	var _tests:Slice<T__struct_6> = (new Slice<T__struct_6>(0, 0, ({_fmt: ("%v" : GoString), _out: ("{abc def 123}" : GoString)} : T__struct_6),
		({_fmt: ("%+v" : GoString), _out: ("{a:abc b:def c:123}" : GoString)} : T__struct_6),
		({_fmt: ("%#v" : GoString), _out: ("fmt_test.T{a:\"abc\", b:\"def\", c:123}" : GoString)} : T__struct_6)) : Slice<T__struct_6>);
	for (_0 => _tt in _tests) {
		...
		if (_out != (("&" : GoString) + _tt._out)) {
			_t.errorf(("Sprintf(%q, &s) = %#q, want %#q" : GoString), Go.toInterface(_tt._fmt), Go.toInterface(_out),
				Go.toInterface(("&" : GoString) + _tt._out));
		};
	};
}
...
function testMapPrinter(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _m0 = (new GoObjectMap<GoInt, GoString>(new stdgo.internal.reflect.Reflect._Type(stdgo.internal.reflect.Reflect.GoType.mapType({get: () ->
...
function testEmptyMap(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	_m = (new GoObjectMap<GoString, GoInt>(new stdgo.internal.reflect.Reflect._Type(stdgo.internal.reflect.Reflect.GoType.mapType({get: () ->
...
function testBlank(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _got:GoString = sprint(Go.toInterface(("<" : GoString)), Go.toInterface((1 : GoInt)), Go.toInterface((">:" : GoString)), Go.toInterface((1 : GoInt)),
		Go.toInterface((2 : GoInt)), Go.toInterface((3 : GoInt)), Go.toInterface(("!" : GoString)));
...
function testBlankln(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _got:GoString = sprintln(Go.toInterface(("<" : GoString)), Go.toInterface((1 : GoInt)), Go.toInterface((">:" : GoString)),
		Go.toInterface((1 : GoInt)), Go.toInterface((2 : GoInt)), Go.toInterface((3 : GoInt)), Go.toInterface(("!" : GoString)));
...
function testIsSpace(_t:Ref<stdgo.testing.Testing.T>):Void {
	{
		...
		Go.cfor(_i <= (1114111 : GoInt32), _i++, {
			if (isSpace(_i) != (stdgo.unicode.Unicode.isSpace(_i))) {
				_t.errorf(("isSpace(%U) = %v, want %v" : GoString), Go.toInterface(_i), Go.toInterface(isSpace(_i)),
					Go.toInterface(stdgo.unicode.Unicode.isSpace(_i)));
			};
		});
	};
}
...
function testNilDoesNotBecomeTyped(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _got:GoString = sprintf(_hideFromVet(("%s %s %s %s %s" : GoString)), (null : AnyInterface), Go.toInterface(_a), (null : AnyInterface),
		Go.toInterface(_b), (null : AnyInterface));
	{};
	if (_got != (("%!s(<nil>) %!s(*fmt_test.A=<nil>) %!s(<nil>) {} %!s(<nil>)" : GoString))) {
		_t.errorf(("expected:\n\t%q\ngot:\n\t%q" : GoString), Go.toInterface(("%!s(<nil>) %!s(*fmt_test.A=<nil>) %!s(<nil>) {} %!s(<nil>)" : GoString)),
			Go.toInterface(_got));
	};
}
...
function testParsenum(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _testCases = (new Slice<T__struct_10>(0, 0, ({
		_s: ("a123" : GoString),
		_start: (0 : GoInt),
		_end: (4 : GoInt),
		_num: (0 : GoInt),
	...
	for (_0 => _tt in _testCases) {
		var __tmp__ = parsenum(_tt._s, _tt._start, _tt._end),
			_num:GoInt = __tmp__._0,
			_isnum:Bool = __tmp__._1,
			_newi:GoInt = __tmp__._2;
		if (((_num != _tt._num) || (_isnum != _tt._isnum)) || (_newi != _tt._newi)) {
			_t.errorf(("parsenum(%q, %d, %d) = %d, %v, %d, want %d, %v, %d" : GoString), Go.toInterface(_tt._s), Go.toInterface(_tt._start),
				Go.toInterface(_tt._end), Go.toInterface(_num), Go.toInterface(_isnum), Go.toInterface(_newi), Go.toInterface(_tt._num),
				Go.toInterface(_tt._isnum), Go.toInterface(_tt._newi));
		};
	};
}
...
private function _testScan(_t:Ref<stdgo.testing.Testing.T>, _f:GoString->stdgo.io.Io.Reader, _scan:(_r:stdgo.io.Io.Reader, _a:haxe.Rest<AnyInterface>) -> {
	var _0:GoInt;
	var _1:Error;
}):Void {
	for (_0 => _test in _scanTests) {
		var _r:stdgo.io.Io.Reader = _f(_test._text);
		var __tmp__ = _scan(_r, _test._in),
			_n:GoInt = __tmp__._0,
			_err:Error = __tmp__._1;
		if (_err != null) {
...
function testScanf(_t:Ref<stdgo.testing.Testing.T>):Void {
	for (_0 => _test in _scanfTests) {
		var __tmp__ = sscanf(_test._text, _test._format, _test._in),
			_n:GoInt = __tmp__._0,
			_err:Error = __tmp__._1;
		if (_err != null) {
			if (_test._out != null) {
				_t.errorf(("Sscanf(%q, %q): unexpected error: %v" : GoString), Go.toInterface(_test._text), Go.toInterface(_test._format),
					Go.toInterface(_err));
			};
			continue;
		};
		...
		var _val:AnyInterface = _v.interface_();
		if (!stdgo.reflect.Reflect.deepEqual(_val, _test._out)) {
			_t.errorf(("Sscanf(%q, %q): parsed value %T(%#v), want %T(%#v)" : GoString), Go.toInterface(_test._text), Go.toInterface(_test._format), _val,
				_val, _test._out, _test._out);
		};
	};
}
...
function testScanOverflow(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	for (_0 => _test in _overflowTests) {
		var __tmp__ = sscan(_test._text, _test._in),
			_1:GoInt = __tmp__._0,
			_err:Error = __tmp__._1;
		if (_err == null) {
...
private function _verifyNaN(_str:GoString, _t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var __tmp__ = fscan(Go.asInterface(stdgo.strings.Strings.newReader(_text)), Go.toInterface(Go.pointer(_f)), Go.toInterface(Go.pointer(_f32)),
		Go.toInterface(Go.pointer(_f64))),
		_n:GoInt = __tmp__._0,
		_err:Error = __tmp__._1;
	if (_err != null) {
	...
	if ((!stdgo.math.Math.isNaN((_f : GoFloat64)) || !stdgo.math.Math.isNaN((_f32 : GoFloat64))) || !stdgo.math.Math.isNaN(_f64)) {
		_t.errorf(("didn\'t get NaNs scanning %q: got %g %g %g" : GoString), Go.toInterface(_text), Go.toInterface(_f), Go.toInterface(_f32),
			Go.toInterface(_f64));
	};
}
...
private function _verifyInf(_str:GoString, _t:Ref<stdgo.testing.Testing.T>):Void {
	...
	if ((!stdgo.math.Math.isInf((_f : GoFloat64), _sign) || !stdgo.math.Math.isInf((_f32 : GoFloat64), _sign))
		|| !stdgo.math.Math.isInf(_f64, _sign)) {
		_t.errorf(("didn\'t get right Infs scanning %q: got %g %g %g" : GoString), Go.toInterface(_text), Go.toInterface(_f), Go.toInterface(_f32),
			Go.toInterface(_f64));
	};
}

function testInf(_t:Ref<stdgo.testing.Testing.T>):Void {
	for (_0 => _s in (new Slice<GoString>(0, 0, ("inf" : GoString), ("+inf" : GoString), ("-inf" : GoString), ("INF" : GoString), ("-INF" : GoString),
		("+INF" : GoString), ("Inf" : GoString), ("-Inf" : GoString), ("+Inf" : GoString)) : Slice<GoString>)) {
		_verifyInf(_s, _t);
	};
}
...
private function _testScanfMulti(_t:Ref<stdgo.testing.Testing.T>, _f:GoString->stdgo.io.Io.Reader):Void {
	var _sliceType:stdgo.reflect.Reflect.Type = stdgo.reflect.Reflect.typeOf(Go.toInterface(new Slice<AnyInterface>((1 : GoInt).toBasic(), 0,
		...[for (i in 0...(1 : GoInt).toBasic()) (null : AnyInterface)])));
	for (_0 => _test in _multiTests) {
		var _r:stdgo.io.Io.Reader = _f(_test._text);
		var __tmp__ = fscanf(_r, _test._format, ..._test._in.__toArray__()),
			_n:GoInt = __tmp__._0,
			_err:Error = __tmp__._1;
		if (_err != null) {
			if (_test._err == (Go.str())) {
				...
				_t.errorf(("got wrong error scanning (%q, %q): %q; expected %q" : GoString), Go.toInterface(_test._format), Go.toInterface(_test._text),
					Go.toInterface(_err), Go.toInterface(_test._err));
			};
			continue;
		};
		if (_test._err != (Go.str())) {
			_t.errorf(("expected error %q error scanning (%q, %q)" : GoString), Go.toInterface(_test._err), Go.toInterface(_test._format),
				Go.toInterface(_test._text));
		};
		if (_n != ((_test._out.length))) {
			_t.errorf(("count error on entry (%q, %q): expected %d got %d" : GoString), Go.toInterface(_test._format), Go.toInterface(_test._text),
				Go.toInterface((_test._out.length)), Go.toInterface(_n));
			continue;
		};
		var _resultVal:stdgo.reflect.Reflect.Value = (stdgo.reflect.Reflect.makeSlice(_sliceType, _n,
			_n) == null ? null : stdgo.reflect.Reflect.makeSlice(_sliceType, _n, _n).__copy__());
		{
			var _i:GoInt = (0 : GoInt);
			Go.cfor(_i < _n, _i++, {
				var _v:stdgo.reflect.Reflect.Value = (stdgo.reflect.Reflect.valueOf(_test._in[(_i : GoInt)])
					.elem() == null ? null : stdgo.reflect.Reflect.valueOf(_test._in[(_i : GoInt)])
					.elem()
					.__copy__());
		...
		if (!stdgo.reflect.Reflect.deepEqual(_result, Go.toInterface(_test._out))) {
			_t.errorf(("scanning (%q, %q): expected %#v got %#v" : GoString), Go.toInterface(_test._format), Go.toInterface(_test._text),
				Go.toInterface(_test._out), _result);
		};
	};
}
...
function testScanMultiple(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var __tmp__ = sscan(("123abc" : GoString), Go.toInterface(Go.pointer(_a)), Go.toInterface(Go.pointer(_s))),
		_n:GoInt = __tmp__._0,
		_err:Error = __tmp__._1;
	if (_n != ((2 : GoInt))) {
...
function testScanEmpty(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _0:GoString = ("" : GoString),
		...
		_s2:GoString = _1,
		_s1:GoString = _0;
	var __tmp__ = sscan(("abc" : GoString), Go.toInterface(Go.pointer(_s1)), Go.toInterface(Go.pointer(_s2))),
		_n:GoInt = __tmp__._0,
		_err:Error = __tmp__._1;
	if (_n != ((1 : GoInt))) {
		_t.errorf(("Sscan count error: expected 1: got %d" : GoString), Go.toInterface(_n));
...
function testScanNotPointer(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _a:GoInt = (0 : GoInt);
	var __tmp__ = fscan(Go.asInterface(_r), Go.toInterface(_a)),
		_0:GoInt = __tmp__._0,
		_err:Error = __tmp__._1;
	if (_err == null) {
...
function testScanlnNoNewline(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _a:GoInt = (0 : GoInt);
	var __tmp__ = sscanln(("1 x\n" : GoString), Go.toInterface(Go.pointer(_a))),
		_0:GoInt = __tmp__._0,
		_err:Error = __tmp__._1;
	if (_err == null) {
...
function testScanlnWithMiddleNewline(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _0:GoInt = (0 : GoInt),
		...
		_b:GoInt = _1,
		_a:GoInt = _0;
	var __tmp__ = fscanln(Go.asInterface(_r), Go.toInterface(Go.pointer(_a)), Go.toInterface(Go.pointer(_b))),
		_0:GoInt = __tmp__._0,
		_err:Error = __tmp__._1;
	if (_err == null) {
...
function testEOF(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _ec = ((new T_eofCounter(stdgo.strings.Strings.newReader(("123\n" : GoString)),
		(0 : GoInt)) : T_eofCounter) : Ref<stdgo.fmt_test.Fmt_test.T_eofCounter>);
	var _a:GoInt = (0 : GoInt);
...
function testEOFAtEndOfInput(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _0:GoInt = (0 : GoInt),
		...
		_j:GoInt = _1,
		_i:GoInt = _0;
	var __tmp__ = sscanf(("23" : GoString), ("%d %d" : GoString), Go.toInterface(Go.pointer(_i)), Go.toInterface(Go.pointer(_j))),
		_n:GoInt = __tmp__._0,
		_err:Error = __tmp__._1;
...
function testEOFAllTypes(_t:Ref<stdgo.testing.Testing.T>):Void {
	for (_i => _test in _eofTests) {
		{
			var __tmp__ = sscanf(Go.str(), _test._format, _test._v),
				_0:GoInt = __tmp__._0,
				_err:Error = __tmp__._1;
			if (Go.toInterface(_err) != (Go.toInterface(stdgo.io.Io.eof))) {
				_t.errorf(("#%d: %s %T not eof on empty string: %s" : GoString), Go.toInterface(_i), Go.toInterface(_test._format), _test._v,
					Go.toInterface(_err));
			};
		};
		{
			var __tmp__ = sscanf(("   " : GoString), _test._format, _test._v),
				_1:GoInt = __tmp__._0,
				_err:Error = __tmp__._1;
			if (Go.toInterface(_err) != (Go.toInterface(stdgo.io.Io.eof))) {
				_t.errorf(("#%d: %s %T not eof on trailing blanks: %s" : GoString), Go.toInterface(_i), Go.toInterface(_test._format), _test._v,
					Go.toInterface(_err));
			};
		};
	};
...
function testUnreadRuneWithBufio(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _i:GoInt = (0 : GoInt);
	var _a:GoString = ("" : GoString);
	var __tmp__ = fscanf(Go.asInterface(_r), ("%d" : GoString), Go.toInterface(Go.pointer(_i))),
		_n:GoInt = __tmp__._0,
		_err:Error = __tmp__._1;
...
function testMultiLine(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var __tmp__ = sscan(_input, Go.toInterface(Go.pointer(_tscan))),
		_n:GoInt = __tmp__._0,
		_err:Error = __tmp__._1;
	if (_n != ((1 : GoInt))) {
...
function testScanStateCount(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _0:T_runeScanner = ({} : stdgo.fmt_test.Fmt_test.T_runeScanner),
		_1:T_runeScanner = ({} : stdgo.fmt_test.Fmt_test.T_runeScanner),
		_2:T_runeScanner = ({} : stdgo.fmt_test.Fmt_test.T_runeScanner),
		_c:T_runeScanner = _2,
		_b:T_runeScanner = _1,
		_a:T_runeScanner = _0;
	var __tmp__ = sscanf(("12➂" : GoString), ("%c%c%c" : GoString), Go.toInterface(Go.asInterface((_a : Ref<stdgo.fmt_test.Fmt_test.T_runeScanner>))),
		Go.toInterface(Go.asInterface((_b : Ref<stdgo.fmt_test.Fmt_test.T_runeScanner>))),
		Go.toInterface(Go.asInterface((_c : Ref<stdgo.fmt_test.Fmt_test.T_runeScanner>)))),
		_n:GoInt = __tmp__._0,
		_err:Error = __tmp__._1;
	if (_err != null) {
	...
	if (((_a._rune != (49 : GoInt32)) || (_b._rune != (50 : GoInt32))) || (_c._rune != (10114 : GoInt32))) {
		_t.errorf(("bad scan rune: %q %q %q should be \'1\' \'2\' \'➂\'" : GoString), Go.toInterface(_a._rune), Go.toInterface(_b._rune),
			Go.toInterface(_c._rune));
	};
...
function testHexBytes(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	{
		var __tmp__ = sscanf(("00010203 00010203" : GoString), ("%x %x" : GoString), Go.toInterface((_a : Ref<Slice<GoUInt8>>)),
			Go.toInterface((_b : Ref<Slice<GoUInt8>>)));
		_n = __tmp__._0;
		_err = __tmp__._1;
	};
...
function testScanNewlinesAreSpaces(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _tests:Slice<T__struct_14> = (new Slice<T__struct_14>(0, 0,
		({_name: ("newlines" : GoString), _text: ("1\n2\n" : GoString), _count: (2 : GoInt)} : T__struct_14),
		({_name: ("no final newline" : GoString), _text: ("1\n2" : GoString), _count: (2 : GoInt)} : T__struct_14),
		({_name: ("newlines with spaces " : GoString), _text: ("1  \n  2  \n" : GoString), _count: (2 : GoInt)} : T__struct_14),
		({_name: ("no final newline with spaces" : GoString), _text: ("1  \n  2" : GoString), _count: (2 : GoInt)} : T__struct_14)) : Slice<T__struct_14>);
	for (_0 => _test in _tests) {
		var __tmp__ = sscan(_test._text, Go.toInterface(Go.pointer(_a)), Go.toInterface(Go.pointer(_b))),
			_n:GoInt = __tmp__._0,
			_err:Error = __tmp__._1;
		if (_n != (_test._count)) {
			_t.errorf(("%s: expected to scan %d item(s), scanned %d" : GoString), Go.toInterface(_test._name), Go.toInterface(_test._count),
				Go.toInterface(_n));
		};
		if (_err != null) {
...
function testScanlnNewlinesTerminate(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _tests:Slice<T__struct_15> = (new Slice<T__struct_15>(0, 0, ({
		_name: ("one line one item" : GoString),
		_text: ("1\n" : GoString),
		_count: (1 : GoInt),
		_ok: false
	} : T__struct_15), ({
		_name: ("one line two items with spaces " : GoString),
		_text: ("   1 2    \n" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_15), ({
		_name: ("one line two items no newline" : GoString),
		_text: ("   1 2" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_15), ({
		_name: ("two lines two items" : GoString),
		_text: ("1\n2\n" : GoString),
		_count: (1 : GoInt),
		_ok: false
		} : T__struct_15)) : Slice<T__struct_15>);
	for (_0 => _test in _tests) {
		var __tmp__ = sscanln(_test._text, Go.toInterface(Go.pointer(_a)), Go.toInterface(Go.pointer(_b))),
			_n:GoInt = __tmp__._0,
			_err:Error = __tmp__._1;
		if (_n != (_test._count)) {
			_t.errorf(("%s: expected to scan %d item(s), scanned %d" : GoString), Go.toInterface(_test._name), Go.toInterface(_test._count),
...
function testScanfNewlineMatchFormat(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _0:GoInt = (0 : GoInt),
		...
		_b:GoInt = _1,
		_a:GoInt = _0;
	var _tests:Slice<T__struct_16> = (new Slice<T__struct_16>(0, 0, ({
		_name: ("newline in both" : GoString),
		_text: ("1\n2" : GoString),
		_format: ("%d\n%d\n" : GoString),
		_count: (2 : GoInt),
		_ok: true
	} : T__struct_16), ({
		_name: ("newline in input" : GoString),
		_text: ("1\n2" : GoString),
		_format: ("%d %d" : GoString),
		_count: (1 : GoInt),
		_ok: false
		} : T__struct_16), ({
		_name: ("space-newline in input" : GoString),
		_text: ("1 \n2" : GoString),
		_format: ("%d %d" : GoString),
		_count: (1 : GoInt),
		_ok: false
		} : T__struct_16), ({
		_name: ("newline in format" : GoString),
		_text: ("1 2" : GoString),
		_format: ("%d\n%d" : GoString),
		_count: (1 : GoInt),
		_ok: false
		} : T__struct_16), ({
		_name: ("space-newline in format" : GoString),
		_text: ("1 2" : GoString),
		_format: ("%d \n%d" : GoString),
		_count: (1 : GoInt),
		_ok: false
		} : T__struct_16), ({
		_name: ("space-newline in both" : GoString),
		_text: ("1 \n2" : GoString),
		_format: ("%d \n%d" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("extra space in format" : GoString),
		_text: ("1\n2" : GoString),
		_format: ("%d\n %d" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("two extra spaces in format" : GoString),
		_text: ("1\n2" : GoString),
		_format: ("%d \n %d" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline 0000" : GoString),
		_text: ("1\n2" : GoString),
		_format: ("%d\n%d" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline 0001" : GoString),
		_text: ("1\n2" : GoString),
		_format: ("%d\n %d" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline 0010" : GoString),
		_text: ("1\n2" : GoString),
		_format: ("%d \n%d" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline 0011" : GoString),
		_text: ("1\n2" : GoString),
		_format: ("%d \n %d" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline 0100" : GoString),
		_text: ("1\n 2" : GoString),
		_format: ("%d\n%d" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline 0101" : GoString),
		_text: ("1\n 2" : GoString),
		_format: ("%d\n%d " : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline 0110" : GoString),
		_text: ("1\n 2" : GoString),
		_format: ("%d \n%d" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline 0111" : GoString),
		_text: ("1\n 2" : GoString),
		_format: ("%d \n %d" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline 1000" : GoString),
		_text: ("1 \n2" : GoString),
		_format: ("%d\n%d" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline 1001" : GoString),
		_text: ("1 \n2" : GoString),
		_format: ("%d\n %d" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline 1010" : GoString),
		_text: ("1 \n2" : GoString),
		_format: ("%d \n%d" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline 1011" : GoString),
		_text: ("1 \n2" : GoString),
		_format: ("%d \n %d" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline 1100" : GoString),
		_text: ("1 \n 2" : GoString),
		_format: ("%d\n%d" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline 1101" : GoString),
		_text: ("1 \n 2" : GoString),
		_format: ("%d\n %d" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline 1110" : GoString),
		_text: ("1 \n 2" : GoString),
		_format: ("%d \n%d" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline 1111" : GoString),
		_text: ("1 \n 2" : GoString),
		_format: ("%d \n %d" : GoString),
		_count: (2 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline no-percent 0000" : GoString),
		_text: ("1\n2" : GoString),
		_format: ("1\n2" : GoString),
		_count: (0 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline no-percent 0001" : GoString),
		_text: ("1\n2" : GoString),
		_format: ("1\n 2" : GoString),
		_count: (0 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline no-percent 0010" : GoString),
		_text: ("1\n2" : GoString),
		_format: ("1 \n2" : GoString),
		_count: (0 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline no-percent 0011" : GoString),
		_text: ("1\n2" : GoString),
		_format: ("1 \n 2" : GoString),
		_count: (0 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline no-percent 0100" : GoString),
		_text: ("1\n 2" : GoString),
		_format: ("1\n2" : GoString),
		_count: (0 : GoInt),
		_ok: false
		} : T__struct_16), ({
		_name: ("space vs newline no-percent 0101" : GoString),
		_text: ("1\n 2" : GoString),
		_format: ("1\n2 " : GoString),
		_count: (0 : GoInt),
		_ok: false
		} : T__struct_16), ({
		_name: ("space vs newline no-percent 0110" : GoString),
		_text: ("1\n 2" : GoString),
		_format: ("1 \n2" : GoString),
		_count: (0 : GoInt),
		_ok: false
		} : T__struct_16), ({
		_name: ("space vs newline no-percent 0111" : GoString),
		_text: ("1\n 2" : GoString),
		_format: ("1 \n 2" : GoString),
		_count: (0 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline no-percent 1000" : GoString),
		_text: ("1 \n2" : GoString),
		_format: ("1\n2" : GoString),
		_count: (0 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline no-percent 1001" : GoString),
		_text: ("1 \n2" : GoString),
		_format: ("1\n 2" : GoString),
		_count: (0 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline no-percent 1010" : GoString),
		_text: ("1 \n2" : GoString),
		_format: ("1 \n2" : GoString),
		_count: (0 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline no-percent 1011" : GoString),
		_text: ("1 \n2" : GoString),
		_format: ("1 \n 2" : GoString),
		_count: (0 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline no-percent 1100" : GoString),
		_text: ("1 \n 2" : GoString),
		_format: ("1\n2" : GoString),
		_count: (0 : GoInt),
		_ok: false
		} : T__struct_16), ({
		_name: ("space vs newline no-percent 1101" : GoString),
		_text: ("1 \n 2" : GoString),
		_format: ("1\n 2" : GoString),
		_count: (0 : GoInt),
		_ok: true
		} : T__struct_16), ({
		_name: ("space vs newline no-percent 1110" : GoString),
		_text: ("1 \n 2" : GoString),
		_format: ("1 \n2" : GoString),
		_count: (0 : GoInt),
		_ok: false
		} : T__struct_16), ({
		_name: ("space vs newline no-percent 1111" : GoString),
		_text: ("1 \n 2" : GoString),
		_format: ("1 \n 2" : GoString),
		_count: (0 : GoInt),
		_ok: true
...
function testHexByte(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var __tmp__ = sscanln(("0123\n" : GoString), Go.toInterface(Go.asInterface((_h : Ref<stdgo.fmt_test.Fmt_test.T_hexBytes>)))),
		_n:GoInt = __tmp__._0,
		_err:Error = __tmp__._1;
	if (_err != null) {
		_t.fatal(Go.toInterface(_err));
...
function testStringer(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _s:GoString = sprintf(("%v %v %v %v %v" : GoString), Go.toInterface(Go.asInterface(((0 : stdgo.fmt_test.Fmt_test.TI) : TI))),
		Go.toInterface(Go.asInterface(((1 : stdgo.fmt_test.Fmt_test.TI8) : TI8))),
		Go.toInterface(Go.asInterface(((2 : stdgo.fmt_test.Fmt_test.TI16) : TI16))),
		Go.toInterface(Go.asInterface(((3 : stdgo.fmt_test.Fmt_test.TI32) : TI32))),
		Go.toInterface(Go.asInterface(((("4" : GoInt64) : stdgo.fmt_test.Fmt_test.TI64) : TI64))));
	_check(_t, _s, ("I: 0 I8: 1 I16: 2 I32: 3 I64: 4" : GoString));
	_s = sprintf(("%v %v %v %v %v %v" : GoString), Go.toInterface(Go.asInterface(((("5" : GoUInt) : stdgo.fmt_test.Fmt_test.TU) : TU))),
		Go.toInterface(Go.asInterface(((6 : stdgo.fmt_test.Fmt_test.TU8) : TU8))),
		Go.toInterface(Go.asInterface(((7 : stdgo.fmt_test.Fmt_test.TU16) : TU16))),
		Go.toInterface(Go.asInterface(((("8" : GoUInt32) : stdgo.fmt_test.Fmt_test.TU32) : TU32))),
		Go.toInterface(Go.asInterface(((("9" : GoUInt64) : stdgo.fmt_test.Fmt_test.TU64) : TU64))),
		Go.toInterface(Go.asInterface(((10 : stdgo.fmt_test.Fmt_test.TUI) : TUI))));
	_check(_t, _s, ("U: 5 U8: 6 U16: 7 U32: 8 U64: 9 UI: 10" : GoString));
	_s = sprintf(("%v %v %v" : GoString), Go.toInterface(Go.asInterface(((1 : GoFloat64) : TF))), Go.toInterface(Go.asInterface(((2 : GoFloat64) : TF32))),
		Go.toInterface(Go.asInterface(((3 : GoFloat64) : TF64))));
...
class T_flagPrinter_asInterface {
	@:keep
	public function format(_f:State, _c:GoRune):Void
		__self__.value.format(_f, _c);
...
@:keep @:allow(stdgo.fmt_test.Fmt_test.Person_asInterface) class Person_static_extension {
	...
	**/
	...
	static public function goString(_p:Person):GoString {
		if (_p.addr != null) {
			return stdgo.fmt.Fmt.sprintf(("Person{Name: %q, Age: %d, Addr: &Address{City: %q, State: %q, Country: %q}}" : GoString), Go.toInterface(_p.name),
				Go.toInterface((_p.age : GoInt)), Go.toInterface(_p.addr.city), Go.toInterface(_p.addr.state), Go.toInterface(_p.addr.country));
		};
...
class IntString_asInterface {
	...
	public function scan(_state:ScanState, _verb:GoRune):Error
		return __self__.value.scan(_state, _verb);
...
@:keep @:allow(stdgo.fmt_test.Fmt_test.IntString_asInterface) class IntString_static_extension {
	...
	static public function scan(_s:Ref<IntString>, _state:ScanState, _verb:GoRune):Error {
		{
			var __tmp__ = fscan(_state, Go.toInterface(Go.pointer(_s._i))),
				_0:GoInt = __tmp__._0,
				_err:Error = __tmp__._1;
			if (_err != null) {
				return _err;
		...
		var __tmp__ = _state.token(true, null),
			_tok:Slice<GoUInt8> = __tmp__._0,
			_err:Error = __tmp__._1;
		if (_err != null) {
			return _err;
		};
...
class F_asInterface {
	@:keep
	public function format(_s:State, _c:GoRune):Void
		__self__.value.format(_s, _c);
...
class T_byteFormatter_asInterface {
	@:keep
	public function format(_f:State, _0:GoRune):Void
		__self__.value.format(_f, _0);
...
class Xs_asInterface {
	...
	@:pointer
	public function scan(_state:ScanState, _verb:GoRune):Error
		return __self__.value.scan(__self__, _state, _verb);
...
class T_hexBytes_asInterface {
	@:keep
	public function scan(_ss:ScanState, _verb:GoRune):Error
		return __self__.value.scan(_ss, _verb);
...
@:keep @:allow(stdgo.fmt_test.Fmt_test.T_hexBytes_asInterface) class T_hexBytes_static_extension {
	...
	static public function scan(_h:Ref<T_hexBytes>, _ss:ScanState, _verb:GoRune):Error {
		...
		var __tmp__ = fscanf(_ss, ("%4x" : GoString), Go.toInterface((_b : Ref<Slice<GoUInt8>>))),
			_0:GoInt = __tmp__._0,
			_err:Error = __tmp__._1;
		if (_err != null) {
			throw Go.toInterface(_err);
