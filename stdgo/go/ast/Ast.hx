...
**/
private var _separator:Ref<Comment> = ((new Comment((0 : stdgo.go.token.Token.Pos), ("//" : GoString)) : Comment) : Ref<Comment>);

private var _indent:Slice<GoUInt8> = ((".  " : GoString) : Slice<GoByte>);

private var _objKindStrings:GoArray<GoString> = {
...
private var _comments:Slice<T__struct_0> = (new Slice<T__struct_0>(0, 0,
	...
	({_list: (new Slice<GoString>(0, 0, ("//" : GoString), ("//" : GoString),
		("// foo" : GoString)) : Slice<GoString>), _text: ("foo\n" : GoString)} : T__struct_0),
	...
	({_list: (new Slice<GoString>(0, 0, ("// foo" : GoString), ("//" : GoString), ("//" : GoString), ("//" : GoString),
		("// bar" : GoString)) : Slice<GoString>), _text: ("foo\n\nbar\n" : GoString)} : T__struct_0),
	({_list: (new Slice<GoString>(0, 0, ("// foo" : GoString), ("/* bar */" : GoString)) : Slice<GoString>), _text: ("foo\n bar\n" : GoString)} : T__struct_0),
	({_list: (new Slice<GoString>(0, 0, ("//" : GoString), ("//" : GoString), ("//" : GoString), ("// foo" : GoString), ("//" : GoString), ("//" : GoString),
		("//" : GoString)) : Slice<GoString>), _text: ("foo\n" : GoString)} : T__struct_0),
	({_list: (new Slice<GoString>(0, 0, ("/**/" : GoString)) : Slice<GoString>), _text: Go.str()} : T__struct_0),
	({_list: (new Slice<GoString>(0, 0, ("/*   */" : GoString)) : Slice<GoString>), _text: Go.str()} : T__struct_0),
	({_list: (new Slice<GoString>(0, 0, ("/**/" : GoString), ("/**/" : GoString), ("/*   */" : GoString)) : Slice<GoString>), _text: Go.str()} : T__struct_0),
	({_list: (new Slice<GoString>(0, 0, ("/* Foo   */" : GoString)) : Slice<GoString>), _text: (" Foo\n" : GoString)} : T__struct_0),
	...
	({_list: (new Slice<GoString>(0, 0, ("// foo" : GoString), ("//go:noinline" : GoString), ("// bar" : GoString),
		("//:baz" : GoString)) : Slice<GoString>), _text: ("foo\nbar\n:baz\n" : GoString)} : T__struct_0),
	({_list: (new Slice<GoString>(0, 0, ("// foo" : GoString), ("//lint123:ignore" : GoString),
		("// bar" : GoString)) : Slice<GoString>), _text: ("foo\nbar\n" : GoString)} : T__struct_0)) : Slice<T__struct_0>);

private var _isDirectiveTests:Slice<T__struct_1> = (new Slice<T__struct_1>(0, 0, ({_in: ("abc" : GoString), _ok: false} : T__struct_1),
	({_in: ("go:inline" : GoString), _ok: true} : T__struct_1), ({_in: ("Go:inline" : GoString), _ok: false} : T__struct_1),
	({_in: ("go:Inline" : GoString), _ok: false} : T__struct_1), ({_in: (":inline" : GoString), _ok: false} : T__struct_1),
	({_in: ("lint:ignore" : GoString), _ok: true} : T__struct_1), ({_in: ("lint:1234" : GoString), _ok: true} : T__struct_1),
	({_in: ("1234:lint" : GoString), _ok: true} : T__struct_1), ({_in: ("go: inline" : GoString), _ok: false} : T__struct_1),
	({_in: ("go:" : GoString), _ok: false} : T__struct_1), ({_in: ("go:*" : GoString), _ok: false} : T__struct_1),
	({_in: ("go:x*" : GoString), _ok: true} : T__struct_1), ({_in: ("export foo" : GoString), _ok: true} : T__struct_1),
	({_in: ("extern foo" : GoString), _ok: true} : T__struct_1), ({_in: ("expert foo" : GoString), _ok: false} : T__struct_1)) : Slice<T__struct_1>);

private var _tests:Slice<T__struct_2> = (new Slice<T__struct_2>(0, 0, ({_x: (null : AnyInterface), _s: ("0  nil" : GoString)} : T__struct_2),
	({_x: Go.toInterface(true), _s: ("0  true" : GoString)} : T__struct_2), ({_x: Go.toInterface((42 : GoInt)), _s: ("0  42" : GoString)} : T__struct_2),
	...
	({_x: Go.toInterface((new stdgo.GoMap.GoObjectMap<Expr,
		GoString>(new stdgo.internal.reflect.Reflect._Type(stdgo.internal.reflect.Reflect.GoType.mapType({get: () ->
			stdgo.internal.reflect.Reflect.GoType.named("Expr", [], null, false, {get: () -> null})},
		{get: () -> stdgo.internal.reflect.Reflect.GoType.basic(string_kind)}))) : stdgo.GoMap<Expr, GoString>)),
		_s: ("0  map[ast.Expr]string (len = 0) {}" : GoString)} : T__struct_2),
	({
		_x: Go.toInterface(({
			final x = new stdgo.GoMap.GoObjectMap<GoString,
				GoInt>(new stdgo.internal.reflect.Reflect._Type(stdgo.internal.reflect.Reflect.GoType.mapType({get: () ->
					stdgo.internal.reflect.Reflect.GoType.basic(string_kind)}, {get: () -> stdgo.internal.reflect.Reflect.GoType.basic(int_kind)})));
			@:privateAccess x._keys = [("a" : GoString)];
			@:privateAccess x._values = [(1 : GoInt)];
			x;
		} : stdgo.GoMap<GoString, GoInt>)),
	...
	({_x: Go.toInterface((new GoArray<GoInt>((1 : GoInt), (2 : GoInt),
		(3 : GoInt)) : GoArray<GoInt>)), _s: ("0  [3]int {\n\t\t1  .  0: 1\n\t\t2  .  1: 2\n\t\t3  .  2: 3\n\t\t4  }" : GoString)} : T__struct_2),
	...
	({_x: Go.toInterface((new Slice<GoInt>(0, 0, (1 : GoInt), (2 : GoInt),
		(3 : GoInt)) : Slice<GoInt>)), _s: ("0  []int (len = 3) {\n\t\t1  .  0: 1\n\t\t2  .  1: 2\n\t\t3  .  2: 3\n\t\t4  }" : GoString)} : T__struct_2),
	...
	({_x: Go.toInterface(Go.asInterface(({x: (42 : GoInt), _y: (991 : GoInt)} : T__struct_5))),
		_s: ("0  struct { X int; y int } {\n\t\t1  .  X: 42\n\t\t2  }" : GoString)} : T__struct_2),
	({_x: Go.toInterface(Go.asInterface(({x: (42 : GoInt), y: (991 : GoInt)} : T__struct_6))),
		_s: ("0  struct { X int; Y int } {\n\t\t1  .  X: 42\n\t\t2  .  Y: 991\n\t\t3  }" : GoString)} : T__struct_2)) : Slice<T__struct_2>);

final send:ChanDir = (2 : ChanDir);
final recv:ChanDir = (2 : ChanDir);
...
**/
final filterUnassociatedComments:MergeMode = (("4" : GoUInt) : MergeMode);

/**
	// If set, duplicate import declarations are excluded.
**/
final filterImportDuplicates:MergeMode = (("4" : GoUInt) : MergeMode);

/**
	// for error handling// The list of possible Object kinds.
**/
final bad:ObjKind = (6 : ObjKind);

/**
	// package// The list of possible Object kinds.
**/
final pkg:ObjKind = (6 : ObjKind);

/**
	// constant// The list of possible Object kinds.
**/
final con:ObjKind = (6 : ObjKind);

/**
	// type// The list of possible Object kinds.
**/
final typ:ObjKind = (6 : ObjKind);

/**
	// variable// The list of possible Object kinds.
**/
final var_:ObjKind = (6 : ObjKind);

/**
	// function or method// The list of possible Object kinds.
**/
final fun:ObjKind = (6 : ObjKind);

/**
	// label// The list of possible Object kinds.
**/
final lbl:ObjKind = (6 : ObjKind);
...
typedef Stmt = StructType & {
	> Node,
	public function _stmtNode():Void;
};
...
typedef Decl = StructType & {
	> Node,
	public function _declNode():Void;
};
...
typedef Spec = StructType & {
	> Node,
	public function _specNode():Void;
};
...
typedef Visitor = StructType & {
	public function visit(_node:Node):Visitor;
};
...
@:structInit @:using(stdgo.go.ast.Ast.RangeStmt_static_extension) class RangeStmt {
	...
	public function new(?for_:stdgo.go.token.Token.Pos, ?key:Expr, ?value:Expr, ?tokPos:stdgo.go.token.Token.Pos, ?tok:stdgo.go.token.Token.Token, ?x:Expr,
			?body:Ref<BlockStmt>) {
		if (for_ != null)
			this.for_ = for_;
		if (key != null)
	...
	public function __copy__() {
		return new RangeStmt(for_, key, value, tokPos, tok, x, body);
	}
}
...
@:structInit @:using(stdgo.go.ast.Ast.TypeSpec_static_extension) class TypeSpec {
	...
	public function new(?doc:Ref<CommentGroup>, ?name:Ref<Ident>, ?typeParams:Ref<FieldList>, ?assign:stdgo.go.token.Token.Pos, ?type:Expr,
			?comment:Ref<CommentGroup>) {
		if (doc != null)
			this.doc = doc;
		if (name != null)
			this.name = name;
...
@:structInit @:using(stdgo.go.ast.Ast.GenDecl_static_extension) class GenDecl {
	...
	public function new(?doc:Ref<CommentGroup>, ?tokPos:stdgo.go.token.Token.Pos, ?tok:stdgo.go.token.Token.Token, ?lparen:stdgo.go.token.Token.Pos,
			?specs:Slice<Spec>, ?rparen:stdgo.go.token.Token.Pos) {
		if (doc != null)
			this.doc = doc;
		if (tokPos != null)
			this.tokPos = tokPos;
...
@:structInit @:using(stdgo.go.ast.Ast.File_static_extension) class File {
	...
	public function new(?doc:Ref<CommentGroup>, ?package_:stdgo.go.token.Token.Pos, ?name:Ref<Ident>, ?decls:Slice<Decl>, ?scope:Ref<Scope>,
			?imports:Slice<Ref<ImportSpec>>, ?unresolved:Slice<Ref<Ident>>, ?comments:Slice<Ref<CommentGroup>>) {
		if (doc != null)
			this.doc = doc;
		if (package_ != null)
	...
	public function __copy__() {
		return new File(doc, package_, name, decls, scope, imports, unresolved, comments);
	}
}
...
**/
@:structInit @:using(stdgo.go.ast.Ast.T_commentListReader_static_extension) private class T_commentListReader {
	...
	public function new(?_fset:Ref<stdgo.go.token.Token.FileSet>, ?_list:Slice<Ref<CommentGroup>>, ?_index:GoInt, ?_comment:Ref<CommentGroup>,
			?_pos:stdgo.go.token.Token.Position, ?_end:stdgo.go.token.Token.Position) {
		if (_fset != null)
			this._fset = _fset;
		if (_list != null)
			this._list = _list;
...
@:structInit @:using(stdgo.go.ast.Ast.T_printer_static_extension) private class T_printer {
	...
	public function new(?_output:stdgo.io.Io.Writer, ?_fset:Ref<stdgo.go.token.Token.FileSet>, ?_filter:FieldFilter, ?_ptrmap:GoMap<AnyInterface, GoInt>,
			?_indent:GoInt, ?_last:GoUInt8, ?_line:GoInt) {
		if (_output != null)
...
@:structInit @:using(stdgo.go.ast.Ast.T_pkgBuilder_static_extension) private class T_pkgBuilder {
	public var _fset:Ref<stdgo.go.token.Token.FileSet> = (null : Ref<stdgo.go.token.Token.FileSet>);
...
/**
	...
	// return pkg.
**/
@:named typedef Importer = (GoMap<GoString, Ref<Object>>, GoString) -> {
	var _0:Ref<Object>;
	var _1:Error;
};
...
function newIdent(_name:GoString):Ref<Ident> {
	return ((new Ident((0 : stdgo.go.token.Token.Pos), _name, null) : Ident) : Ref<Ident>);
}
...
function testCommentText(_t:Ref<stdgo.testing.Testing.T>):Void {
	for (_i => _c in _comments) {
		var _list = new Slice<Ref<Comment>>((_c._list.length : GoInt).toBasic(), 0,
			...[for (i in 0...(_c._list.length : GoInt).toBasic()) (null : Ref<Comment>)]);
		for (_i => _s in _c._list) {
			_list[(_i : GoInt)] = (({text: _s} : Comment) : Ref<Comment>);
		};
		var _text:GoString = (((new CommentGroup(_list) : CommentGroup) : Ref<CommentGroup>)).text();
		if (_text != (_c._text)) {
...
function newCommentMap(_fset:Ref<stdgo.go.token.Token.FileSet>, _node:Node, _comments:Slice<Ref<CommentGroup>>):CommentMap {
	...
	var _cmap:CommentMap = (new GoObjectMap<Node,
		Slice<Ref<CommentGroup>>>(new stdgo.internal.reflect.Reflect._Type(stdgo.internal.reflect.Reflect.GoType.named("CommentMap", [], null, false, {
		get: () -> null
	}))) : CommentMap);
	var _tmp = new Slice<Ref<CommentGroup>>((_comments.length : GoInt).toBasic(), 0,
		...[for (i in 0...(_comments.length : GoInt).toBasic()) (null : Ref<CommentGroup>)]);
	...
	var _0:Node = (null : Node),
		_1:stdgo.go.token.Token.Position = ({} : stdgo.go.token.Token.Position),
		_2:Node = (null : Node),
		_3:stdgo.go.token.Token.Position = ({} : stdgo.go.token.Token.Position),
		_4:T_nodeStack = new T_nodeStack(0, 0),
		_stack:T_nodeStack = _4,
		_pgend:stdgo.go.token.Token.Position = _3,
		_pg:Node = _2,
		_pend:stdgo.go.token.Token.Position = _1,
		_p:Node = _0;
	for (_0 => _q in _nodes) {
		var _qpos:stdgo.go.token.Token.Position = ({} : stdgo.go.token.Token.Position);
		if (_q != null) {
			_qpos = (_fset.position(_q.pos()) == null ? null : _fset.position(_q.pos()).__copy__());
		} else {
			{};
		...
		while (_r._end.offset <= _qpos.offset) {
			{
				...
				if (_top != null) {
					_pg = _top;
					_pgend = (_fset.position(_pg.end()) == null ? null : _fset.position(_pg.end()).__copy__());
				};
			};
			var _assoc:Node = (null : Node);
			if ((_pg != null)
				&& ((_pgend.line == _r._pos.line)
					|| (((_pgend.line + (1 : GoInt)) == _r._pos.line) && ((_r._end.line + (1 : GoInt)) < _qpos.line)))) {
				_assoc = _pg;
			} else if ((_p != null)
				&& (((_pend.line == _r._pos.line)
					|| (((_pend.line + (1 : GoInt)) == _r._pos.line) && ((_r._end.line + (1 : GoInt)) < _qpos.line)))
					|| (_q == null))) {
				_assoc = _p;
			} else {
				if (_q == null) {
		...
		_p = _q;
		_pend = (_fset.position(_p.end()) == null ? null : _fset.position(_p.end()).__copy__());
		{
			final __type__ = _q;
			if (Go.typeEquals((__type__ : Ref<File>))
				|| Go.typeEquals((__type__ : Ref<Field>))
				|| Go.typeEquals((__type__ : Decl))
				|| Go.typeEquals((__type__ : Spec))
				|| Go.typeEquals((__type__ : Stmt))) {
				_stack._push(_q);
			};
		};
	};
...
private function _summary(_list:Slice<Ref<CommentGroup>>):GoString {
	return stdgo.internal.Macro.controlFlow({
		...
		for (_i => _b in _bytes) {
			if (_b == ((9 : GoUInt8)) || _b == ((10 : GoUInt8)) || _b == ((13 : GoUInt8))) {
...
private function _fieldName(_x:Expr):Ref<Ident> {
	{
		...
		if (Go.typeEquals((__type__ : Ref<Ident>))) {
			var _t:Ref<Ident> = __type__ == null ? (null : Ref<Ident>) : __type__.__underlying__() == null ? (null : Ref<Ident>) : __type__ == null ? (null : Ref<Ident>) : __type__.__underlying__()
				.value;
			return _t;
		} else if (Go.typeEquals((__type__ : Ref<SelectorExpr>))) {
			var _t:Ref<SelectorExpr> = __type__ == null ? (null : Ref<SelectorExpr>) : __type__.__underlying__() == null ? (null : Ref<SelectorExpr>) : __type__ == null ? (null : Ref<SelectorExpr>) : __type__.__underlying__()
				.value;
			{
				var __tmp__ = try {
			...
			var _t:Ref<StarExpr> = __type__ == null ? (null : Ref<StarExpr>) : __type__.__underlying__() == null ? (null : Ref<StarExpr>) : __type__ == null ? (null : Ref<StarExpr>) : __type__.__underlying__()
				.value;
...
private function _filterFieldList(_fields:Ref<FieldList>, _filter:Filter, _export:Bool):Bool {
	...
	for (_0 => _f in _list) {
		...
		if ((_f.names.length) == ((0 : GoInt))) {
			...
			_keepField = (_name != null) && _filter(_name.name);
		} else {
	...
	for (_0 => _exp in _list) {
		{
			...
			if (Go.typeEquals((__type__ : Ref<CompositeLit>))) {
				var _x:Ref<CompositeLit> = __type__ == null ? (null : Ref<CompositeLit>) : __type__.__underlying__() == null ? (null : Ref<CompositeLit>) : __type__ == null ? (null : Ref<CompositeLit>) : __type__.__underlying__()
					.value;
				_filterCompositeLit(_x, _filter, _export);
			} else if (Go.typeEquals((__type__ : Ref<KeyValueExpr>))) {
				var _x:Ref<KeyValueExpr> = __type__ == null ? (null : Ref<KeyValueExpr>) : __type__.__underlying__() == null ? (null : Ref<KeyValueExpr>) : __type__ == null ? (null : Ref<KeyValueExpr>) : __type__.__underlying__()
					.value;
				{
					var __tmp__ = try {
...
private function _filterType(_typ:Expr, _f:Filter, _export:Bool):Bool {
	{
		...
		if (Go.typeEquals((__type__ : Ref<Ident>))) {
			...
			var _t:Ref<ParenExpr> = __type__ == null ? (null : Ref<ParenExpr>) : __type__.__underlying__() == null ? (null : Ref<ParenExpr>) : __type__ == null ? (null : Ref<ParenExpr>) : __type__.__underlying__()
				.value;
			return _filterType(_t.x, _f, _export);
		} else if (Go.typeEquals((__type__ : Ref<ArrayType>))) {
			var _t:Ref<ArrayType> = __type__ == null ? (null : Ref<ArrayType>) : __type__.__underlying__() == null ? (null : Ref<ArrayType>) : __type__ == null ? (null : Ref<ArrayType>) : __type__.__underlying__()
				.value;
			return _filterType(_t.elt, _f, _export);
		} else if (Go.typeEquals((__type__ : Ref<StructType>))) {
			var _t:Ref<StructType> = __type__ == null ? (null : Ref<StructType>) : __type__.__underlying__() == null ? (null : Ref<StructType>) : __type__ == null ? (null : Ref<StructType>) : __type__.__underlying__()
				.value;
			...
			var _t:Ref<FuncType> = __type__ == null ? (null : Ref<FuncType>) : __type__.__underlying__() == null ? (null : Ref<FuncType>) : __type__ == null ? (null : Ref<FuncType>) : __type__.__underlying__()
				.value;
			...
			var _t:Ref<InterfaceType> = __type__ == null ? (null : Ref<InterfaceType>) : __type__.__underlying__() == null ? (null : Ref<InterfaceType>) : __type__ == null ? (null : Ref<InterfaceType>) : __type__.__underlying__()
				.value;
			...
			var _t:Ref<MapType> = __type__ == null ? (null : Ref<MapType>) : __type__.__underlying__() == null ? (null : Ref<MapType>) : __type__ == null ? (null : Ref<MapType>) : __type__.__underlying__()
				.value;
			...
			var _t:Ref<ChanType> = __type__ == null ? (null : Ref<ChanType>) : __type__.__underlying__() == null ? (null : Ref<ChanType>) : __type__ == null ? (null : Ref<ChanType>) : __type__.__underlying__()
				.value;
...
private function _filterSpec(_spec:Spec, _f:Filter, _export:Bool):Bool {
	{
		...
		if (Go.typeEquals((__type__ : Ref<ValueSpec>))) {
			var _s:Ref<ValueSpec> = __type__ == null ? (null : Ref<ValueSpec>) : __type__.__underlying__() == null ? (null : Ref<ValueSpec>) : __type__ == null ? (null : Ref<ValueSpec>) : __type__.__underlying__()
				.value;
			...
			var _s:Ref<TypeSpec> = __type__ == null ? (null : Ref<TypeSpec>) : __type__.__underlying__() == null ? (null : Ref<TypeSpec>) : __type__ == null ? (null : Ref<TypeSpec>) : __type__.__underlying__()
				.value;
			if (_f(_s.name.name)) {
				if (_export) {
					_filterType(_s.type, _f, _export);
...
private function _filterDecl(_decl:Decl, _f:Filter, _export:Bool):Bool {
	{
		...
		if (Go.typeEquals((__type__ : Ref<GenDecl>))) {
			var _d:Ref<GenDecl> = __type__ == null ? (null : Ref<GenDecl>) : __type__.__underlying__() == null ? (null : Ref<GenDecl>) : __type__ == null ? (null : Ref<GenDecl>) : __type__.__underlying__()
				.value;
			_d.specs = _filterSpecList(_d.specs, _f, _export);
			return (_d.specs.length) > (0 : GoInt);
		} else if (Go.typeEquals((__type__ : Ref<FuncDecl>))) {
			var _d:Ref<FuncDecl> = __type__ == null ? (null : Ref<FuncDecl>) : __type__.__underlying__() == null ? (null : Ref<FuncDecl>) : __type__ == null ? (null : Ref<FuncDecl>) : __type__.__underlying__()
				.value;
...
private function _nameOf(_f:Ref<FuncDecl>):GoString {
	{
		var _r = _f.recv;
		if ((_r != null) && (_r.list.length == (1 : GoInt))) {
...
function mergePackageFiles(_pkg:Ref<Package>, _mode:MergeMode):Ref<File> {
	...
	if (_ndocs > (0 : GoInt)) {
		var _list = new Slice<Ref<Comment>>((_ndocs - (1 : GoInt) : GoInt).toBasic(), 0,
			...[for (i in 0...(_ndocs - (1 : GoInt) : GoInt).toBasic()) (null : Ref<Comment>)]);
		var _i:GoInt = (0 : GoInt);
		...
		_doc = ((new CommentGroup(_list) : CommentGroup) : Ref<CommentGroup>);
	};
	...
	if (_ndecls > (0 : GoInt)) {
		...
		var _funcs = (new GoObjectMap<GoString, GoInt>(new stdgo.internal.reflect.Reflect._Type(stdgo.internal.reflect.Reflect.GoType.mapType({get: () ->
				...
				if (_mode & (("1" : GoUInt) : MergeMode) != ((("0" : GoUInt) : MergeMode))) {
					{
						...
						if (_isFun) {
							...
							{
								var __tmp__ = (_funcs != null
									&& _funcs.__exists__(_name) ? {value: _funcs[_name], ok: true} : {value: (0 : GoInt), ok: false}),
									_j:GoInt = __tmp__.value,
									_exists:Bool = __tmp__.ok;
								if (_exists) {
									if ((_decls[(_j : GoInt)] != null)
										&& ((Go.typeAssert((Go.toInterface(_decls[(_j : GoInt)]) : Ref<FuncDecl>)) : Ref<FuncDecl>).doc == null)) {
	...
	if (_mode & (("2" : GoUInt) : MergeMode) == ((("0" : GoUInt) : MergeMode))) {
		_comments = new Slice<Ref<CommentGroup>>((_ncomments : GoInt).toBasic(), 0,
			...[for (i in 0...(_ncomments : GoInt).toBasic()) (null : Ref<CommentGroup>)]);
		var _i:GoInt = (0 : GoInt);
	...
	return ((new File(_doc, _pos, newIdent(_pkg.name), _decls, _pkg.scope, _imports, (null : Slice<Ref<Ident>>), _comments) : File) : Ref<File>);
}
...
private function _importPath(_s:Spec):GoString {
	var __tmp__ = stdgo.strconv.Strconv.unquote((Go.typeAssert((Go.toInterface(_s) : Ref<ImportSpec>)) : Ref<ImportSpec>).path.value),
...
private function _collapse(_prev:Spec, _next:Spec):Bool {
	...
	return (Go.typeAssert((Go.toInterface(_prev) : Ref<ImportSpec>)) : Ref<ImportSpec>).comment == null;
}
...
private function _sortSpecs(_fset:Ref<stdgo.go.token.Token.FileSet>, _f:Ref<File>, _specs:Slice<Spec>):Slice<Spec> {
	...
	var _importComments = (new stdgo.GoMap.GoObjectMap<Ref<ImportSpec>,
		Slice<T_cgPos>>(new stdgo.internal.reflect.Reflect._Type(stdgo.internal.reflect.Reflect.GoType.mapType({
		get: () -> stdgo.internal.reflect.Reflect.GoType.refType({get: () -> stdgo.internal.reflect.Reflect.GoType.named("ImportSpec", [], null, false,
			{get: () -> null})})
	},
		{get: () -> stdgo.internal.reflect.Reflect.GoType.sliceType({get: () -> stdgo.internal.reflect.Reflect.GoType.named("T_cgPos", [], null, false,
			{get: () -> null})})}))) : stdgo.GoMap<Ref<ImportSpec>, Slice<T_cgPos>>);
	...
	for (_0 => _g in _comments) {
		...
		if ((_specIndex == (0 : GoInt)) && (_pos[(_specIndex : GoInt)].start > _g.pos())) {
			_left = true;
		} else if (((_specIndex + (1 : GoInt)) < _specs.length)
			&& ((_lineAt(_fset, _pos[(_specIndex : GoInt)].start) + (1 : GoInt)) == _lineAt(_fset, _g.pos()))) {
			_specIndex++;
			_left = true;
		};
...
function notNilFilter(_0:GoString, _v:stdgo.reflect.Reflect.Value):Bool {
	if (_v.kind() == ((("18" : GoUInt) : stdgo.reflect.Reflect.Kind))
		|| _v.kind() == ((("19" : GoUInt) : stdgo.reflect.Reflect.Kind))
		|| _v.kind() == ((("20" : GoUInt) : stdgo.reflect.Reflect.Kind))
		|| _v.kind() == ((("21" : GoUInt) : stdgo.reflect.Reflect.Kind))
		|| _v.kind() == ((("22" : GoUInt) : stdgo.reflect.Reflect.Kind))
		|| _v.kind() == ((("23" : GoUInt) : stdgo.reflect.Reflect.Kind))) {
		return !_v.isNil();
	};
	return true;
}
...
private function _fprint(_w:stdgo.io.Io.Writer, _fset:Ref<stdgo.go.token.Token.FileSet>, _x:AnyInterface, _f:FieldFilter):Error {
	...
	var _p:T_printer = ({
		...
		_fset: _fset,
		_filter: _f,
		_ptrmap: (new GoObjectMap<AnyInterface, GoInt>(new stdgo.internal.reflect.Reflect._Type(stdgo.internal.reflect.Reflect.GoType.mapType({
			get: () -> stdgo.internal.reflect.Reflect.GoType.interfaceType(true, [])
		},
			{get: () -> stdgo.internal.reflect.Reflect.GoType.basic(int_kind)}))) : GoMap<AnyInterface, GoInt>),
		_last: (10 : GoUInt8)
	} : T_printer);
	try {
		...
		_p._print((stdgo.reflect.Reflect.valueOf(_x) == null ? null : stdgo.reflect.Reflect.valueOf(_x).__copy__()));
		_p._printf(("\n" : GoString));
		{
			for (defer in __deferstack__) {
				defer();
...
function testPrint(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	for (_0 => _test in _tests) {
		_buf.reset();
		{
			var _err:Error = fprint(Go.asInterface((_buf : Ref<stdgo.bytes.Bytes.Buffer>)), null, _test._x, null);
			if (_err != null) {
				_t.errorf(("Fprint failed: %s" : GoString), Go.toInterface(_err));
			};
		};
		{
			var _0:GoString = _trim((_buf.string() : GoString)),
				_1:GoString = _trim(_test._s),
				_ts:GoString = _1,
				_s:GoString = _0;
			if (_s != (_ts)) {
...
private function _resolve(_scope:Ref<Scope>, _ident:Ref<Ident>):Bool {
	Go.cfor(_scope != null, _scope = _scope.outer, {
		{
...
**/
function newPackage(_fset:Ref<stdgo.go.token.Token.FileSet>, _files:GoMap<GoString, Ref<File>>, _importer:Importer,
		_universe:Ref<Scope>):{var _0:Ref<Package>; var _1:Error;} {
	var _p:T_pkgBuilder = ({} : T_pkgBuilder);
	_p._fset = _fset;
	var _pkgName:GoString = Go.str();
	var _pkgScope = newScope(_universe);
	for (_2 => _file in _files) {
		{
		...
		for (_3 => _obj in _file.scope.objects) {
			_p._declare(_pkgScope, null, _obj);
		};
	};
	var _imports = (new GoObjectMap<GoString, Ref<Object>>(new stdgo.internal.reflect.Reflect._Type(stdgo.internal.reflect.Reflect.GoType.mapType({get: () ->
		stdgo.internal.reflect.Reflect.GoType.basic(string_kind)},
		{get: () -> stdgo.internal.reflect.Reflect.GoType.refType({get: () -> stdgo.internal.reflect.Reflect.GoType.named("Object", [], null, false,
			{get: () -> null})})}))) : GoMap<GoString, Ref<Object>>);
	for (_4 => _file in _files) {
		if (_file.name.name != (_pkgName)) {
			continue;
		};
		var _importErrors:Bool = false;
		var _fileScope = newScope(_pkgScope);
		for (_5 => _spec in _file.imports) {
			if (_importer == null) {
				_importErrors = true;
				continue;
			};
			var __tmp__ = stdgo.strconv.Strconv.unquote(_spec.path.value),
				_path:GoString = __tmp__._0,
				_6:Error = __tmp__._1;
			var __tmp__ = _importer(_imports, _path),
				_pkg:Ref<Object> = __tmp__._0,
				_err:Error = __tmp__._1;
			if (_err != null) {
			...
			if (_name == (("." : GoString))) {
				for (_7 => _obj in (Go.typeAssert((_pkg.data : Ref<Scope>)) : Ref<Scope>).objects) {
		...
		var _i:GoInt = (0 : GoInt);
		for (_8 => _ident in _file.unresolved) {
	...
	_p._errors.sort();
	return {_0: ((new Package(_pkgName, _pkgScope, _imports, _files) : Package) : Ref<Package>), _1: _p._errors.err()};
}
...
function newScope(_outer:Ref<Scope>):Ref<Scope> {
	{};
	return ((new Scope(_outer,
		(new GoObjectMap<GoString, Ref<Object>>(new stdgo.internal.reflect.Reflect._Type(stdgo.internal.reflect.Reflect.GoType.mapType({get: () ->
			stdgo.internal.reflect.Reflect.GoType.basic(string_kind)},
			{get: () -> stdgo.internal.reflect.Reflect.GoType.refType({get: () -> stdgo.internal.reflect.Reflect.GoType.named("Object", [], null, false,
				{get: () -> null})})}))) : GoMap<GoString, Ref<Object>>)) : Scope) : Ref<Scope>);
}
...
function newObj(_kind:ObjKind, _name:GoString):Ref<Object> {
	return (({kind: _kind, name: _name} : Object) : Ref<Object>);
}
...
function walk(_v:Visitor, _node:Node):Void {
	...
	};
	{
		...
		if (Go.typeEquals((__type__ : Ref<Comment>))) {
			var _n:Ref<Comment> = __type__ == null ? (null : Ref<Comment>) : __type__.__underlying__() == null ? (null : Ref<Comment>) : __type__ == null ? (null : Ref<Comment>) : __type__.__underlying__()
				.value;
		} else if (Go.typeEquals((__type__ : Ref<CommentGroup>))) {
			var _n:Ref<CommentGroup> = __type__ == null ? (null : Ref<CommentGroup>) : __type__.__underlying__() == null ? (null : Ref<CommentGroup>) : __type__ == null ? (null : Ref<CommentGroup>) : __type__.__underlying__()
				.value;
			for (_0 => _c in _n.list) {
				walk(_v, Go.asInterface(_c));
			};
		} else if (Go.typeEquals((__type__ : Ref<Field>))) {
			var _n:Ref<Field> = __type__ == null ? (null : Ref<Field>) : __type__.__underlying__() == null ? (null : Ref<Field>) : __type__ == null ? (null : Ref<Field>) : __type__.__underlying__()
				.value;
			if (_n.doc != null) {
			...
			var _n:Ref<FieldList> = __type__ == null ? (null : Ref<FieldList>) : __type__.__underlying__() == null ? (null : Ref<FieldList>) : __type__ == null ? (null : Ref<FieldList>) : __type__.__underlying__()
				.value;
			for (_1 => _f in _n.list) {
				walk(_v, Go.asInterface(_f));
			};
		} else if (Go.typeEquals((__type__ : Ref<BadExpr>))
			|| Go.typeEquals((__type__ : Ref<Ident>))
			|| Go.typeEquals((__type__ : Ref<BasicLit>))) {
			var _n:Node = __type__ == null ? (null : Node) : cast __type__;
		} else if (Go.typeEquals((__type__ : Ref<Ellipsis>))) {
			var _n:Ref<Ellipsis> = __type__ == null ? (null : Ref<Ellipsis>) : __type__.__underlying__() == null ? (null : Ref<Ellipsis>) : __type__ == null ? (null : Ref<Ellipsis>) : __type__.__underlying__()
				.value;
			if (_n.elt != null) {
				walk(_v, _n.elt);
			};
		} else if (Go.typeEquals((__type__ : Ref<FuncLit>))) {
			var _n:Ref<FuncLit> = __type__ == null ? (null : Ref<FuncLit>) : __type__.__underlying__() == null ? (null : Ref<FuncLit>) : __type__ == null ? (null : Ref<FuncLit>) : __type__.__underlying__()
				.value;
			walk(_v, Go.asInterface(_n.type));
			walk(_v, Go.asInterface(_n.body));
		} else if (Go.typeEquals((__type__ : Ref<CompositeLit>))) {
			var _n:Ref<CompositeLit> = __type__ == null ? (null : Ref<CompositeLit>) : __type__.__underlying__() == null ? (null : Ref<CompositeLit>) : __type__ == null ? (null : Ref<CompositeLit>) : __type__.__underlying__()
				.value;
			if (_n.type != null) {
				walk(_v, _n.type);
			};
			...
			var _n:Ref<ParenExpr> = __type__ == null ? (null : Ref<ParenExpr>) : __type__.__underlying__() == null ? (null : Ref<ParenExpr>) : __type__ == null ? (null : Ref<ParenExpr>) : __type__.__underlying__()
				.value;
			walk(_v, _n.x);
		} else if (Go.typeEquals((__type__ : Ref<SelectorExpr>))) {
			var _n:Ref<SelectorExpr> = __type__ == null ? (null : Ref<SelectorExpr>) : __type__.__underlying__() == null ? (null : Ref<SelectorExpr>) : __type__ == null ? (null : Ref<SelectorExpr>) : __type__.__underlying__()
				.value;
			walk(_v, _n.x);
			walk(_v, Go.asInterface(_n.sel));
		} else if (Go.typeEquals((__type__ : Ref<IndexExpr>))) {
			var _n:Ref<IndexExpr> = __type__ == null ? (null : Ref<IndexExpr>) : __type__.__underlying__() == null ? (null : Ref<IndexExpr>) : __type__ == null ? (null : Ref<IndexExpr>) : __type__.__underlying__()
				.value;
			walk(_v, _n.x);
			walk(_v, _n.index);
		} else if (Go.typeEquals((__type__ : Ref<IndexListExpr>))) {
			var _n:Ref<IndexListExpr> = __type__ == null ? (null : Ref<IndexListExpr>) : __type__.__underlying__() == null ? (null : Ref<IndexListExpr>) : __type__ == null ? (null : Ref<IndexListExpr>) : __type__.__underlying__()
				.value;
			walk(_v, _n.x);
			...
			var _n:Ref<SliceExpr> = __type__ == null ? (null : Ref<SliceExpr>) : __type__.__underlying__() == null ? (null : Ref<SliceExpr>) : __type__ == null ? (null : Ref<SliceExpr>) : __type__.__underlying__()
				.value;
			walk(_v, _n.x);
			if (_n.low != null) {
				walk(_v, _n.low);
			...
			var _n:Ref<TypeAssertExpr> = __type__ == null ? (null : Ref<TypeAssertExpr>) : __type__.__underlying__() == null ? (null : Ref<TypeAssertExpr>) : __type__ == null ? (null : Ref<TypeAssertExpr>) : __type__.__underlying__()
				.value;
			walk(_v, _n.x);
			if (_n.type != null) {
				walk(_v, _n.type);
			...
			var _n:Ref<CallExpr> = __type__ == null ? (null : Ref<CallExpr>) : __type__.__underlying__() == null ? (null : Ref<CallExpr>) : __type__ == null ? (null : Ref<CallExpr>) : __type__.__underlying__()
				.value;
			walk(_v, _n.fun);
			_walkExprList(_v, _n.args);
		} else if (Go.typeEquals((__type__ : Ref<StarExpr>))) {
			var _n:Ref<StarExpr> = __type__ == null ? (null : Ref<StarExpr>) : __type__.__underlying__() == null ? (null : Ref<StarExpr>) : __type__ == null ? (null : Ref<StarExpr>) : __type__.__underlying__()
				.value;
			walk(_v, _n.x);
		} else if (Go.typeEquals((__type__ : Ref<UnaryExpr>))) {
			var _n:Ref<UnaryExpr> = __type__ == null ? (null : Ref<UnaryExpr>) : __type__.__underlying__() == null ? (null : Ref<UnaryExpr>) : __type__ == null ? (null : Ref<UnaryExpr>) : __type__.__underlying__()
				.value;
			walk(_v, _n.x);
		} else if (Go.typeEquals((__type__ : Ref<BinaryExpr>))) {
			var _n:Ref<BinaryExpr> = __type__ == null ? (null : Ref<BinaryExpr>) : __type__.__underlying__() == null ? (null : Ref<BinaryExpr>) : __type__ == null ? (null : Ref<BinaryExpr>) : __type__.__underlying__()
				.value;
			walk(_v, _n.x);
			walk(_v, _n.y);
		} else if (Go.typeEquals((__type__ : Ref<KeyValueExpr>))) {
			var _n:Ref<KeyValueExpr> = __type__ == null ? (null : Ref<KeyValueExpr>) : __type__.__underlying__() == null ? (null : Ref<KeyValueExpr>) : __type__ == null ? (null : Ref<KeyValueExpr>) : __type__.__underlying__()
				.value;
			walk(_v, _n.key);
			walk(_v, _n.value);
		} else if (Go.typeEquals((__type__ : Ref<ArrayType>))) {
			var _n:Ref<ArrayType> = __type__ == null ? (null : Ref<ArrayType>) : __type__.__underlying__() == null ? (null : Ref<ArrayType>) : __type__ == null ? (null : Ref<ArrayType>) : __type__.__underlying__()
				.value;
			if (_n.len != null) {
				walk(_v, _n.len);
			};
			...
			var _n:Ref<StructType> = __type__ == null ? (null : Ref<StructType>) : __type__.__underlying__() == null ? (null : Ref<StructType>) : __type__ == null ? (null : Ref<StructType>) : __type__.__underlying__()
				.value;
			walk(_v, Go.asInterface(_n.fields));
		} else if (Go.typeEquals((__type__ : Ref<FuncType>))) {
			var _n:Ref<FuncType> = __type__ == null ? (null : Ref<FuncType>) : __type__.__underlying__() == null ? (null : Ref<FuncType>) : __type__ == null ? (null : Ref<FuncType>) : __type__.__underlying__()
				.value;
			if (_n.typeParams != null) {
			...
			var _n:Ref<InterfaceType> = __type__ == null ? (null : Ref<InterfaceType>) : __type__.__underlying__() == null ? (null : Ref<InterfaceType>) : __type__ == null ? (null : Ref<InterfaceType>) : __type__.__underlying__()
				.value;
			walk(_v, Go.asInterface(_n.methods));
		} else if (Go.typeEquals((__type__ : Ref<MapType>))) {
			var _n:Ref<MapType> = __type__ == null ? (null : Ref<MapType>) : __type__.__underlying__() == null ? (null : Ref<MapType>) : __type__ == null ? (null : Ref<MapType>) : __type__.__underlying__()
				.value;
			walk(_v, _n.key);
			walk(_v, _n.value);
		} else if (Go.typeEquals((__type__ : Ref<ChanType>))) {
			var _n:Ref<ChanType> = __type__ == null ? (null : Ref<ChanType>) : __type__.__underlying__() == null ? (null : Ref<ChanType>) : __type__ == null ? (null : Ref<ChanType>) : __type__.__underlying__()
				.value;
			walk(_v, _n.value);
		} else if (Go.typeEquals((__type__ : Ref<BadStmt>))) {
			var _n:Ref<BadStmt> = __type__ == null ? (null : Ref<BadStmt>) : __type__.__underlying__() == null ? (null : Ref<BadStmt>) : __type__ == null ? (null : Ref<BadStmt>) : __type__.__underlying__()
				.value;
		} else if (Go.typeEquals((__type__ : Ref<DeclStmt>))) {
			var _n:Ref<DeclStmt> = __type__ == null ? (null : Ref<DeclStmt>) : __type__.__underlying__() == null ? (null : Ref<DeclStmt>) : __type__ == null ? (null : Ref<DeclStmt>) : __type__.__underlying__()
				.value;
			walk(_v, _n.decl);
		} else if (Go.typeEquals((__type__ : Ref<EmptyStmt>))) {
			var _n:Ref<EmptyStmt> = __type__ == null ? (null : Ref<EmptyStmt>) : __type__.__underlying__() == null ? (null : Ref<EmptyStmt>) : __type__ == null ? (null : Ref<EmptyStmt>) : __type__.__underlying__()
				.value;
		} else if (Go.typeEquals((__type__ : Ref<LabeledStmt>))) {
			var _n:Ref<LabeledStmt> = __type__ == null ? (null : Ref<LabeledStmt>) : __type__.__underlying__() == null ? (null : Ref<LabeledStmt>) : __type__ == null ? (null : Ref<LabeledStmt>) : __type__.__underlying__()
				.value;
			walk(_v, Go.asInterface(_n.label));
			walk(_v, _n.stmt);
		} else if (Go.typeEquals((__type__ : Ref<ExprStmt>))) {
			var _n:Ref<ExprStmt> = __type__ == null ? (null : Ref<ExprStmt>) : __type__.__underlying__() == null ? (null : Ref<ExprStmt>) : __type__ == null ? (null : Ref<ExprStmt>) : __type__.__underlying__()
				.value;
			walk(_v, _n.x);
		} else if (Go.typeEquals((__type__ : Ref<SendStmt>))) {
			var _n:Ref<SendStmt> = __type__ == null ? (null : Ref<SendStmt>) : __type__.__underlying__() == null ? (null : Ref<SendStmt>) : __type__ == null ? (null : Ref<SendStmt>) : __type__.__underlying__()
				.value;
			walk(_v, _n.chan);
			walk(_v, _n.value);
		} else if (Go.typeEquals((__type__ : Ref<IncDecStmt>))) {
			var _n:Ref<IncDecStmt> = __type__ == null ? (null : Ref<IncDecStmt>) : __type__.__underlying__() == null ? (null : Ref<IncDecStmt>) : __type__ == null ? (null : Ref<IncDecStmt>) : __type__.__underlying__()
				.value;
			walk(_v, _n.x);
		} else if (Go.typeEquals((__type__ : Ref<AssignStmt>))) {
			var _n:Ref<AssignStmt> = __type__ == null ? (null : Ref<AssignStmt>) : __type__.__underlying__() == null ? (null : Ref<AssignStmt>) : __type__ == null ? (null : Ref<AssignStmt>) : __type__.__underlying__()
				.value;
			_walkExprList(_v, _n.lhs);
			_walkExprList(_v, _n.rhs);
		} else if (Go.typeEquals((__type__ : Ref<GoStmt>))) {
			var _n:Ref<GoStmt> = __type__ == null ? (null : Ref<GoStmt>) : __type__.__underlying__() == null ? (null : Ref<GoStmt>) : __type__ == null ? (null : Ref<GoStmt>) : __type__.__underlying__()
				.value;
			walk(_v, Go.asInterface(_n.call));
		} else if (Go.typeEquals((__type__ : Ref<DeferStmt>))) {
			var _n:Ref<DeferStmt> = __type__ == null ? (null : Ref<DeferStmt>) : __type__.__underlying__() == null ? (null : Ref<DeferStmt>) : __type__ == null ? (null : Ref<DeferStmt>) : __type__.__underlying__()
				.value;
			walk(_v, Go.asInterface(_n.call));
		} else if (Go.typeEquals((__type__ : Ref<ReturnStmt>))) {
			var _n:Ref<ReturnStmt> = __type__ == null ? (null : Ref<ReturnStmt>) : __type__.__underlying__() == null ? (null : Ref<ReturnStmt>) : __type__ == null ? (null : Ref<ReturnStmt>) : __type__.__underlying__()
				.value;
			_walkExprList(_v, _n.results);
		} else if (Go.typeEquals((__type__ : Ref<BranchStmt>))) {
			var _n:Ref<BranchStmt> = __type__ == null ? (null : Ref<BranchStmt>) : __type__.__underlying__() == null ? (null : Ref<BranchStmt>) : __type__ == null ? (null : Ref<BranchStmt>) : __type__.__underlying__()
				.value;
			if (_n.label != null) {
				walk(_v, Go.asInterface(_n.label));
			};
		} else if (Go.typeEquals((__type__ : Ref<BlockStmt>))) {
			var _n:Ref<BlockStmt> = __type__ == null ? (null : Ref<BlockStmt>) : __type__.__underlying__() == null ? (null : Ref<BlockStmt>) : __type__ == null ? (null : Ref<BlockStmt>) : __type__.__underlying__()
				.value;
			_walkStmtList(_v, _n.list);
		} else if (Go.typeEquals((__type__ : Ref<IfStmt>))) {
			var _n:Ref<IfStmt> = __type__ == null ? (null : Ref<IfStmt>) : __type__.__underlying__() == null ? (null : Ref<IfStmt>) : __type__ == null ? (null : Ref<IfStmt>) : __type__.__underlying__()
				.value;
			if (_n.init != null) {
				walk(_v, _n.init);
			};
			...
			var _n:Ref<CaseClause> = __type__ == null ? (null : Ref<CaseClause>) : __type__.__underlying__() == null ? (null : Ref<CaseClause>) : __type__ == null ? (null : Ref<CaseClause>) : __type__.__underlying__()
				.value;
			_walkExprList(_v, _n.list);
			_walkStmtList(_v, _n.body);
		} else if (Go.typeEquals((__type__ : Ref<SwitchStmt>))) {
			var _n:Ref<SwitchStmt> = __type__ == null ? (null : Ref<SwitchStmt>) : __type__.__underlying__() == null ? (null : Ref<SwitchStmt>) : __type__ == null ? (null : Ref<SwitchStmt>) : __type__.__underlying__()
				.value;
			if (_n.init != null) {
				walk(_v, _n.init);
			};
			...
			var _n:Ref<TypeSwitchStmt> = __type__ == null ? (null : Ref<TypeSwitchStmt>) : __type__.__underlying__() == null ? (null : Ref<TypeSwitchStmt>) : __type__ == null ? (null : Ref<TypeSwitchStmt>) : __type__.__underlying__()
				.value;
			if (_n.init != null) {
				walk(_v, _n.init);
			};
			...
			var _n:Ref<CommClause> = __type__ == null ? (null : Ref<CommClause>) : __type__.__underlying__() == null ? (null : Ref<CommClause>) : __type__ == null ? (null : Ref<CommClause>) : __type__.__underlying__()
				.value;
			if (_n.comm != null) {
				walk(_v, _n.comm);
			};
			...
			var _n:Ref<SelectStmt> = __type__ == null ? (null : Ref<SelectStmt>) : __type__.__underlying__() == null ? (null : Ref<SelectStmt>) : __type__ == null ? (null : Ref<SelectStmt>) : __type__.__underlying__()
				.value;
			walk(_v, Go.asInterface(_n.body));
		} else if (Go.typeEquals((__type__ : Ref<ForStmt>))) {
			var _n:Ref<ForStmt> = __type__ == null ? (null : Ref<ForStmt>) : __type__.__underlying__() == null ? (null : Ref<ForStmt>) : __type__ == null ? (null : Ref<ForStmt>) : __type__.__underlying__()
				.value;
			if (_n.init != null) {
				walk(_v, _n.init);
			};
			...
			var _n:Ref<RangeStmt> = __type__ == null ? (null : Ref<RangeStmt>) : __type__.__underlying__() == null ? (null : Ref<RangeStmt>) : __type__ == null ? (null : Ref<RangeStmt>) : __type__.__underlying__()
				.value;
			if (_n.key != null) {
				walk(_v, _n.key);
			};
			...
			var _n:Ref<ImportSpec> = __type__ == null ? (null : Ref<ImportSpec>) : __type__.__underlying__() == null ? (null : Ref<ImportSpec>) : __type__ == null ? (null : Ref<ImportSpec>) : __type__.__underlying__()
				.value;
			if (_n.doc != null) {
				walk(_v, Go.asInterface(_n.doc));
			};
			...
			var _n:Ref<ValueSpec> = __type__ == null ? (null : Ref<ValueSpec>) : __type__.__underlying__() == null ? (null : Ref<ValueSpec>) : __type__ == null ? (null : Ref<ValueSpec>) : __type__.__underlying__()
				.value;
			if (_n.doc != null) {
				walk(_v, Go.asInterface(_n.doc));
			};
			...
			var _n:Ref<TypeSpec> = __type__ == null ? (null : Ref<TypeSpec>) : __type__.__underlying__() == null ? (null : Ref<TypeSpec>) : __type__ == null ? (null : Ref<TypeSpec>) : __type__.__underlying__()
				.value;
			if (_n.doc != null) {
				walk(_v, Go.asInterface(_n.doc));
			};
			...
			var _n:Ref<BadDecl> = __type__ == null ? (null : Ref<BadDecl>) : __type__.__underlying__() == null ? (null : Ref<BadDecl>) : __type__ == null ? (null : Ref<BadDecl>) : __type__.__underlying__()
				.value;
		} else if (Go.typeEquals((__type__ : Ref<GenDecl>))) {
			var _n:Ref<GenDecl> = __type__ == null ? (null : Ref<GenDecl>) : __type__.__underlying__() == null ? (null : Ref<GenDecl>) : __type__ == null ? (null : Ref<GenDecl>) : __type__.__underlying__()
				.value;
			if (_n.doc != null) {
				walk(_v, Go.asInterface(_n.doc));
			};
			...
			var _n:Ref<FuncDecl> = __type__ == null ? (null : Ref<FuncDecl>) : __type__.__underlying__() == null ? (null : Ref<FuncDecl>) : __type__ == null ? (null : Ref<FuncDecl>) : __type__.__underlying__()
				.value;
			if (_n.doc != null) {
				walk(_v, Go.asInterface(_n.doc));
			};
			...
			var _n:Ref<File> = __type__ == null ? (null : Ref<File>) : __type__.__underlying__() == null ? (null : Ref<File>) : __type__ == null ? (null : Ref<File>) : __type__.__underlying__()
				.value;
			if (_n.doc != null) {
				walk(_v, Go.asInterface(_n.doc));
			};
			...
			var _n:Ref<Package> = __type__ == null ? (null : Ref<Package>) : __type__.__underlying__() == null ? (null : Ref<Package>) : __type__ == null ? (null : Ref<Package>) : __type__.__underlying__()
				.value;
...
@:keep @:allow(stdgo.go.ast.Ast.FuncType_asInterface) class FuncType_static_extension {
	...
	static public function pos(_x:Ref<FuncType>):stdgo.go.token.Token.Pos {
		if (_x.func.isValid() || (_x.params == null)) {
			return _x.func;
		};
...
class T_commentListReader_asInterface {
	...
	public function _next():Void
		__self__.value._next();

	@:keep
	public function _eol():Bool
		return __self__.value._eol();
...
@:keep @:allow(stdgo.go.ast.Ast.T_commentListReader_asInterface) class T_commentListReader_static_extension {
	...
	static public function _next(_r:Ref<T_commentListReader>):Void {
		if (!_r._eol()) {
			...
			_r._pos = (_r._fset.position(_r._comment.pos()) == null ? null : _r._fset.position(_r._comment.pos()).__copy__());
			_r._end = (_r._fset.position(_r._comment.end()) == null ? null : _r._fset.position(_r._comment.end()).__copy__());
			_r._index++;
		};
	}
...
class T_printer_asInterface {
	@:keep
	public function _print(_x:stdgo.reflect.Reflect.Value):Void
		__self__.value._print(_x);

	/**
		// printf is a convenience wrapper that takes care of print errors.
	**/
	@:keep
	public function _printf(_format:GoString, _args:haxe.Rest<AnyInterface>):Void
		__self__.value._printf(_format, ..._args);
...
@:keep @:allow(stdgo.go.ast.Ast.T_printer_asInterface) class T_printer_static_extension {
	...
	static public function _print(_p:Ref<T_printer>, _x:stdgo.reflect.Reflect.Value):Void {
		if (!notNilFilter(Go.str(), (_x == null ? null : _x.__copy__()))) {
			_p._printf(("nil" : GoString));
			return;
		};
		if (_x.kind() == ((("20" : GoUInt) : stdgo.reflect.Reflect.Kind))) {
			_p._print((_x.elem() == null ? null : _x.elem().__copy__()));
		} else if (_x.kind() == ((("21" : GoUInt) : stdgo.reflect.Reflect.Kind))) {
			_p._printf(("%s (len = %d) {" : GoString), Go.toInterface(_x.type()), Go.toInterface(_x.len()));
			if (_x.len() > (0 : GoInt)) {
				_p._indent++;
				_p._printf(("\n" : GoString));
				for (_2 => _key in _x.mapKeys()) {
					_p._print((_key == null ? null : _key.__copy__()));
					_p._printf((": " : GoString));
					_p._print((_x.mapIndex((_key == null ? null : _key.__copy__())) == null ? null : _x.mapIndex((_key == null ? null : _key.__copy__()))
						.__copy__()));
					_p._printf(("\n" : GoString));
				};
				_p._indent--;
			...
			_p._printf(("}" : GoString));
		} else if (_x.kind() == ((("22" : GoUInt) : stdgo.reflect.Reflect.Kind))) {
			_p._printf(("*" : GoString));
			var _ptr:AnyInterface = _x.interface_();
			{
				var __tmp__ = (_p._ptrmap != null
					&& _p._ptrmap.__exists__(_ptr) ? {value: _p._ptrmap[_ptr], ok: true} : {value: (0 : GoInt), ok: false}),
					_line:GoInt = __tmp__.value,
					_exists:Bool = __tmp__.ok;
				if (_exists) {
		...
		} else if (_x.kind() == ((("17" : GoUInt) : stdgo.reflect.Reflect.Kind))) {
			...
			if (_x.len() > (0 : GoInt)) {
				...
				_p._printf(("\n" : GoString));
				{
					...
					Go.cfor(_i < _n, _i++, {
						...
						_p._print((_x.index(_i) == null ? null : _x.index(_i).__copy__()));
						_p._printf(("\n" : GoString));
					});
				};
				_p._indent--;
			...
			_p._printf(("}" : GoString));
		} else if (_x.kind() == ((("23" : GoUInt) : stdgo.reflect.Reflect.Kind))) {
			{
				var __tmp__ = try {
			...
			_p._printf(("}" : GoString));
		} else if (_x.kind() == ((("25" : GoUInt) : stdgo.reflect.Reflect.Kind))) {
				...
				Go.cfor(_i < _n, _i++, {
					{
						...
						if (isExported(_name)) {
							var _value:stdgo.reflect.Reflect.Value = (_x.field(_i) == null ? null : _x.field(_i).__copy__());
							if ((_p._filter == null) || _p._filter(_name, (_value == null ? null : _value.__copy__()))) {
								if (_first) {
									_p._printf(("\n" : GoString));
									_first = false;
								};
								_p._printf(("%s: " : GoString), Go.toInterface(_name));
								_p._print((_value == null ? null : _value.__copy__()));
								_p._printf(("\n" : GoString));
							};
						};
					};
			...
			var _v:AnyInterface = _x.interface_();
			{
				...
				if (Go.typeEquals((__type__ : GoString))) {
					...
					var _v:stdgo.go.token.Token.Pos = __type__ == null ? ((0 : GoInt) : stdgo.go.token.Token.Pos) : __type__.__underlying__() == null ? ((0 : GoInt) : stdgo.go.token.Token.Pos) : __type__ == null ? ((0 : GoInt) : stdgo.go.token.Token.Pos) : __type__.__underlying__()
						.value;
					if (_p._fset != null) {
	...
	**/
	...
	static public function _printf(_p:Ref<T_printer>, _format:GoString, _args:haxe.Rest<AnyInterface>):Void {
		...
		{
			var __tmp__ = stdgo.fmt.Fmt.fprintf(Go.asInterface(_p), _format, ..._args.__toArray__()),
				_0:GoInt = __tmp__._0,
				_err:Error = __tmp__._1;
			if (_err != null) {
...
class T_pkgBuilder_asInterface {
	@:keep
	public function _declare(_scope:Ref<Scope>, _altScope:Ref<Scope>, _obj:Ref<Object>):Void
		__self__.value._declare(_scope, _altScope, _obj);

	@:keep
	public function _errorf(_pos:stdgo.go.token.Token.Pos, _format:GoString, _args:haxe.Rest<AnyInterface>):Void
		__self__.value._errorf(_pos, _format, ..._args);

	@:keep
	public function _error(_pos:stdgo.go.token.Token.Pos, _msg:GoString):Void
		__self__.value._error(_pos, _msg);
...
@:keep @:allow(stdgo.go.ast.Ast.T_pkgBuilder_asInterface) class T_pkgBuilder_static_extension {
	...
	static public function _error(_p:Ref<T_pkgBuilder>, _pos:stdgo.go.token.Token.Pos, _msg:GoString):Void {
		_p._errors.add((_p._fset.position(_pos) == null ? null : _p._fset.position(_pos).__copy__()), _msg);
	}
}
...
class Scope_asInterface {
	...
	**/
	@:keep
	public function insert(_obj:Ref<Object>):Ref<Object>
	...
	**/
	@:keep
	public function lookup(_name:GoString):Ref<Object>
...
@:keep @:allow(stdgo.go.ast.Ast.Scope_asInterface) class Scope_static_extension {
	...
	**/
	...
	static public function string(_s:Ref<Scope>):GoString {
		var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
		stdgo.fmt.Fmt.fprintf(Go.asInterface((_buf : Ref<stdgo.bytes.Bytes.Buffer>)), ("scope %p {" : GoString), Go.toInterface(Go.asInterface(_s)));
		if ((_s != null) && (_s.objects.length > (0 : GoInt))) {
			stdgo.fmt.Fmt.fprintln(Go.asInterface((_buf : Ref<stdgo.bytes.Bytes.Buffer>)));
			for (_0 => _obj in _s.objects) {
				stdgo.fmt.Fmt.fprintf(Go.asInterface((_buf : Ref<stdgo.bytes.Bytes.Buffer>)), ("\t%s %s\n" : GoString),
					Go.toInterface(Go.asInterface(_obj.kind)), Go.toInterface(_obj.name));
			};
		};
		stdgo.fmt.Fmt.fprintf(Go.asInterface((_buf : Ref<stdgo.bytes.Bytes.Buffer>)), ("}\n" : GoString));
	...
	static public function pos(_obj:Ref<Object>):stdgo.go.token.Token.Pos {
		var _name:GoString = _obj.name;
		{
			...
			if (Go.typeEquals((__type__ : Ref<Field>))) {
				var _d:Ref<Field> = __type__ == null ? (null : Ref<Field>) : __type__.__underlying__() == null ? (null : Ref<Field>) : __type__ == null ? (null : Ref<Field>) : __type__.__underlying__()
					.value;
				...
				var _d:Ref<ImportSpec> = __type__ == null ? (null : Ref<ImportSpec>) : __type__.__underlying__() == null ? (null : Ref<ImportSpec>) : __type__ == null ? (null : Ref<ImportSpec>) : __type__.__underlying__()
					.value;
				if ((_d.name != null) && (_d.name.name == _name)) {
					return _d.name.pos();
				};
				return _d.path.pos();
			} else if (Go.typeEquals((__type__ : Ref<ValueSpec>))) {
				var _d:Ref<ValueSpec> = __type__ == null ? (null : Ref<ValueSpec>) : __type__.__underlying__() == null ? (null : Ref<ValueSpec>) : __type__ == null ? (null : Ref<ValueSpec>) : __type__.__underlying__()
					.value;
				...
				var _d:Ref<TypeSpec> = __type__ == null ? (null : Ref<TypeSpec>) : __type__.__underlying__() == null ? (null : Ref<TypeSpec>) : __type__ == null ? (null : Ref<TypeSpec>) : __type__.__underlying__()
					.value;
				...
				var _d:Ref<LabeledStmt> = __type__ == null ? (null : Ref<LabeledStmt>) : __type__.__underlying__() == null ? (null : Ref<LabeledStmt>) : __type__ == null ? (null : Ref<LabeledStmt>) : __type__.__underlying__()
					.value;
				if (_d.label.name == (_name)) {
					return _d.label.pos();
				};
			} else if (Go.typeEquals((__type__ : Ref<AssignStmt>))) {
				var _d:Ref<AssignStmt> = __type__ == null ? (null : Ref<AssignStmt>) : __type__.__underlying__() == null ? (null : Ref<AssignStmt>) : __type__ == null ? (null : Ref<AssignStmt>) : __type__.__underlying__()
					.value;
				for (_2 => _x in _d.lhs) {
					{
						var __tmp__ = try {
				...
				var _d:Ref<Scope> = __type__ == null ? (null : Ref<Scope>) : __type__.__underlying__() == null ? (null : Ref<Scope>) : __type__ == null ? (null : Ref<Scope>) : __type__.__underlying__()
					.value;
			};
		};
		return (0 : stdgo.go.token.Token.Pos);
...
class CommentMap_asInterface {
	...
	**/
	@:keep
	public function comments():Slice<Ref<CommentGroup>>
		return __self__.value.comments();
	...
	**/
	@:keep
	public function filter(_node:Node):CommentMap
		return __self__.value.filter(_node);
	...
	**/
	@:keep
	public function update(_old:Node, _new:Node):Node
		return __self__.value.update(_old, _new);

	@:keep
	public function _addComment(_n:Node, _c:Ref<CommentGroup>):Void
		__self__.value._addComment(_n, _c);
...
@:keep @:allow(stdgo.go.ast.Ast.CommentMap_asInterface) class CommentMap_static_extension {
	...
	static public function string(_cmap:CommentMap):GoString {
		...
		var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
		stdgo.fmt.Fmt.fprintln(Go.asInterface((_buf : Ref<stdgo.bytes.Bytes.Buffer>)), Go.toInterface(("CommentMap {" : GoString)));
		for (_0 => _node in _nodes) {
			...
			stdgo.fmt.Fmt.fprintf(Go.asInterface((_buf : Ref<stdgo.bytes.Bytes.Buffer>)), ("\t%p  %20s:  %s\n" : GoString), Go.toInterface(_node),
				Go.toInterface(_s), Go.toInterface(_summary(_comment)));
		};
		stdgo.fmt.Fmt.fprintln(Go.asInterface((_buf : Ref<stdgo.bytes.Bytes.Buffer>)), Go.toInterface(("}" : GoString)));
		return (_buf.string() : GoString);
	}
	...
	**/
	...
	static public function filter(_cmap:CommentMap, _node:Node):CommentMap {
		var _umap:CommentMap = (new GoObjectMap<Node,
			Slice<Ref<CommentGroup>>>(new stdgo.internal.reflect.Reflect._Type(stdgo.internal.reflect.Reflect.GoType.named("CommentMap", [], null, false, {
			get: () -> null
		}))) : CommentMap);
...
@:keep @:allow(stdgo.go.ast.Ast.T_byInterval_asInterface) class T_byInterval_static_extension {
	...
	static public function less(_a:T_byInterval, _i:GoInt, _j:GoInt):Bool {
		var _0:stdgo.go.token.Token.Pos = _a[(_i : GoInt)].pos(),
			_1:stdgo.go.token.Token.Pos = _a[(_j : GoInt)].pos(),
			_pj:stdgo.go.token.Token.Pos = _1,
			_pi:stdgo.go.token.Token.Pos = _0;
...
class T_nodeStack_asInterface {
	...
	**/
	@:keep
	public function _pop(_pos:stdgo.go.token.Token.Pos):Node
		return __self__.value._pop(_pos);
	...
	**/
	@:keep
	public function _push(_n:Node):Void
		__self__.value._push(_n);
...
@:keep @:allow(stdgo.go.ast.Ast.T_nodeStack_asInterface) class T_nodeStack_static_extension {
	...
	**/
	...
	static public function _pop(_s:Ref<T_nodeStack>, _pos:stdgo.go.token.Token.Pos):Node {
		...
		var _i:GoInt = (_s.length);
		while ((_i > (0 : GoInt)) && ((_s)[(_i - (1 : GoInt) : GoInt)].end() <= _pos)) {
			_top = (_s)[(_i - (1 : GoInt) : GoInt)];
			_i--;
		};
		_s.__setData__(((_s).__slice__((0 : GoInt), _i) : T_nodeStack));
		return _top;
	}
	...
	**/
	...
	static public function _push(_s:Ref<T_nodeStack>, _n:Node):Void {
		_s._pop(_n.pos());
		_s.__setData__((_s).__appendref__(_n));
	}
}
...
class T_inspector_asInterface {
	@:keep
	public function visit(_node:Node):Visitor
		return __self__.value.visit(_node);
