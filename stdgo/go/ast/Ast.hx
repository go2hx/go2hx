...
({ _x : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoInt>() : stdgo.GoArray<stdgo.GoInt>)), _s : ("0  [0]int {}" : stdgo.GoString) } : T__struct_2),
({ _x : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoInt>((1 : stdgo.GoInt), (2 : stdgo.GoInt), (3 : stdgo.GoInt)) : stdgo.GoArray<stdgo.GoInt>)), _s : ("0  [3]int {\n\t\t1  .  0: 1\n\t\t2  .  1: 2\n\t\t3  .  2: 3\n\t\t4  }" : stdgo.GoString) } : T__struct_2),
({ _x : stdgo.Go.toInterface((new stdgo.GoArray<stdgo.GoInt>((42 : stdgo.GoInt)) : stdgo.GoArray<stdgo.GoInt>)), _s : ("0  [1]int {\n\t\t1  .  0: 42\n\t\t2  }" : stdgo.GoString) } : T__struct_2),
({ _x : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoInt>(0, 0) : stdgo.Slice<stdgo.GoInt>)), _s : ("0  []int (len = 0) {}" : stdgo.GoString) } : T__struct_2),
({ _x : stdgo.Go.toInterface((new stdgo.Slice<stdgo.GoInt>(3, 3, (1 : stdgo.GoInt), (2 : stdgo.GoInt), (3 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>)), _s : ("0  []int (len = 3) {\n\t\t1  .  0: 1\n\t\t2  .  1: 2\n\t\t3  .  2: 3\n\t\t4  }" : stdgo.GoString) } : T__struct_2),
...
@:structInit @:using(stdgo.go.ast.Ast.Comment_static_extension) class Comment {
    public var slash : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
...
@:structInit @:using(stdgo.go.ast.Ast.CommentGroup_static_extension) class CommentGroup {
    public var list : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Comment>> = (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Comment>>);
    public function new(?list:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Comment>>) {
...
@:structInit @:using(stdgo.go.ast.Ast.Field_static_extension) class Field {
    public var doc : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup> = (null : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>);
    public var names : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Ident>> = (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Ident>>);
    public var type : stdgo.go.ast.Ast.Expr = (null : stdgo.go.ast.Ast.Expr);
    public var tag : stdgo.Ref<stdgo.go.ast.Ast.BasicLit> = (null : stdgo.Ref<stdgo.go.ast.Ast.BasicLit>);
    public var comment : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup> = (null : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>);
    public function new(?doc:stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>, ?names:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Ident>>, ?type:stdgo.go.ast.Ast.Expr, ?tag:stdgo.Ref<stdgo.go.ast.Ast.BasicLit>, ?comment:stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>) {
...
@:structInit @:using(stdgo.go.ast.Ast.FieldList_static_extension) class FieldList {
    public var opening : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var list : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Field>> = (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Field>>);
    public var closing : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public function new(?opening:stdgo.go.token.Token.Pos, ?list:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Field>>, ?closing:stdgo.go.token.Token.Pos) {
...
@:structInit @:using(stdgo.go.ast.Ast.BadExpr_static_extension) class BadExpr {
    public var from : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var to : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
...
@:structInit @:using(stdgo.go.ast.Ast.Ident_static_extension) class Ident {
    public var namePos : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var name : stdgo.GoString = "";
    public var obj : stdgo.Ref<stdgo.go.ast.Ast.Object> = (null : stdgo.Ref<stdgo.go.ast.Ast.Object>);
    public function new(?namePos:stdgo.go.token.Token.Pos, ?name:stdgo.GoString, ?obj:stdgo.Ref<stdgo.go.ast.Ast.Object>) {
...
@:structInit @:using(stdgo.go.ast.Ast.Ellipsis_static_extension) class Ellipsis {
    public var ellipsis : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
...
@:structInit @:using(stdgo.go.ast.Ast.BasicLit_static_extension) class BasicLit {
    public var valuePos : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var kind : stdgo.go.token.Token.Token = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Token);
...
@:structInit @:using(stdgo.go.ast.Ast.FuncLit_static_extension) class FuncLit {
    public var type : stdgo.Ref<stdgo.go.ast.Ast.FuncType> = (null : stdgo.Ref<stdgo.go.ast.Ast.FuncType>);
    public var body : stdgo.Ref<stdgo.go.ast.Ast.BlockStmt> = (null : stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>);
    public function new(?type:stdgo.Ref<stdgo.go.ast.Ast.FuncType>, ?body:stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>) {
        if (type != null) this.type = type;
...
@:structInit @:using(stdgo.go.ast.Ast.CompositeLit_static_extension) class CompositeLit {
    public var type : stdgo.go.ast.Ast.Expr = (null : stdgo.go.ast.Ast.Expr);
    public var lbrace : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var elts : stdgo.Slice<stdgo.go.ast.Ast.Expr> = (null : stdgo.Slice<stdgo.go.ast.Ast.Expr>);
    public var rbrace : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
...
@:structInit @:using(stdgo.go.ast.Ast.ParenExpr_static_extension) class ParenExpr {
    public var lparen : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var x : stdgo.go.ast.Ast.Expr = (null : stdgo.go.ast.Ast.Expr);
    public var rparen : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
...
@:structInit @:using(stdgo.go.ast.Ast.SelectorExpr_static_extension) class SelectorExpr {
    public var x : stdgo.go.ast.Ast.Expr = (null : stdgo.go.ast.Ast.Expr);
    public var sel : stdgo.Ref<stdgo.go.ast.Ast.Ident> = (null : stdgo.Ref<stdgo.go.ast.Ast.Ident>);
    public function new(?x:stdgo.go.ast.Ast.Expr, ?sel:stdgo.Ref<stdgo.go.ast.Ast.Ident>) {
        if (x != null) this.x = x;
...
@:structInit @:using(stdgo.go.ast.Ast.IndexExpr_static_extension) class IndexExpr {
    public var x : stdgo.go.ast.Ast.Expr = (null : stdgo.go.ast.Ast.Expr);
    public var lbrack : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var index : stdgo.go.ast.Ast.Expr = (null : stdgo.go.ast.Ast.Expr);
    public var rbrack : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
...
@:structInit @:using(stdgo.go.ast.Ast.StarExpr_static_extension) class StarExpr {
    public var star : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var x : stdgo.go.ast.Ast.Expr = (null : stdgo.go.ast.Ast.Expr);
...
@:structInit @:using(stdgo.go.ast.Ast.UnaryExpr_static_extension) class UnaryExpr {
    public var opPos : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var op : stdgo.go.token.Token.Token = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Token);
    public var x : stdgo.go.ast.Ast.Expr = (null : stdgo.go.ast.Ast.Expr);
...
@:structInit @:using(stdgo.go.ast.Ast.KeyValueExpr_static_extension) class KeyValueExpr {
    ...
    public var colon : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
...
@:structInit @:using(stdgo.go.ast.Ast.StructType_static_extension) class StructType {
    public var struct_ : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var fields : stdgo.Ref<stdgo.go.ast.Ast.FieldList> = (null : stdgo.Ref<stdgo.go.ast.Ast.FieldList>);
    public var incomplete : Bool = false;
    public function new(?struct_:stdgo.go.token.Token.Pos, ?fields:stdgo.Ref<stdgo.go.ast.Ast.FieldList>, ?incomplete:Bool) {
...
@:structInit @:using(stdgo.go.ast.Ast.FuncType_static_extension) class FuncType {
    public var func : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var typeParams : stdgo.Ref<stdgo.go.ast.Ast.FieldList> = (null : stdgo.Ref<stdgo.go.ast.Ast.FieldList>);
    public var params : stdgo.Ref<stdgo.go.ast.Ast.FieldList> = (null : stdgo.Ref<stdgo.go.ast.Ast.FieldList>);
    public var results : stdgo.Ref<stdgo.go.ast.Ast.FieldList> = (null : stdgo.Ref<stdgo.go.ast.Ast.FieldList>);
    public function new(?func:stdgo.go.token.Token.Pos, ?typeParams:stdgo.Ref<stdgo.go.ast.Ast.FieldList>, ?params:stdgo.Ref<stdgo.go.ast.Ast.FieldList>, ?results:stdgo.Ref<stdgo.go.ast.Ast.FieldList>) {
...
@:structInit @:using(stdgo.go.ast.Ast.InterfaceType_static_extension) class InterfaceType {
    public var interface_ : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var methods : stdgo.Ref<stdgo.go.ast.Ast.FieldList> = (null : stdgo.Ref<stdgo.go.ast.Ast.FieldList>);
    public var incomplete : Bool = false;
    public function new(?interface_:stdgo.go.token.Token.Pos, ?methods:stdgo.Ref<stdgo.go.ast.Ast.FieldList>, ?incomplete:Bool) {
...
@:structInit @:using(stdgo.go.ast.Ast.MapType_static_extension) class MapType {
    public var map_ : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var key : stdgo.go.ast.Ast.Expr = (null : stdgo.go.ast.Ast.Expr);
    public var value : stdgo.go.ast.Ast.Expr = (null : stdgo.go.ast.Ast.Expr);
...
@:structInit @:using(stdgo.go.ast.Ast.ChanType_static_extension) class ChanType {
    public var begin : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var arrow : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var dir : stdgo.go.ast.Ast.ChanDir = ((0 : stdgo.GoInt) : stdgo.go.ast.Ast.ChanDir);
    public var value : stdgo.go.ast.Ast.Expr = (null : stdgo.go.ast.Ast.Expr);
...
@:structInit @:using(stdgo.go.ast.Ast.EmptyStmt_static_extension) class EmptyStmt {
    public var semicolon : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
...
@:structInit @:using(stdgo.go.ast.Ast.LabeledStmt_static_extension) class LabeledStmt {
    public var label : stdgo.Ref<stdgo.go.ast.Ast.Ident> = (null : stdgo.Ref<stdgo.go.ast.Ast.Ident>);
    public var colon : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var stmt : stdgo.go.ast.Ast.Stmt = (null : stdgo.go.ast.Ast.Stmt);
    public function new(?label:stdgo.Ref<stdgo.go.ast.Ast.Ident>, ?colon:stdgo.go.token.Token.Pos, ?stmt:stdgo.go.ast.Ast.Stmt) {
...
@:structInit @:using(stdgo.go.ast.Ast.IncDecStmt_static_extension) class IncDecStmt {
    public var x : stdgo.go.ast.Ast.Expr = (null : stdgo.go.ast.Ast.Expr);
    public var tokPos : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var tok : stdgo.go.token.Token.Token = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Token);
...
@:structInit @:using(stdgo.go.ast.Ast.GoStmt_static_extension) class GoStmt {
    public var go : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var call : stdgo.Ref<stdgo.go.ast.Ast.CallExpr> = (null : stdgo.Ref<stdgo.go.ast.Ast.CallExpr>);
    public function new(?go:stdgo.go.token.Token.Pos, ?call:stdgo.Ref<stdgo.go.ast.Ast.CallExpr>) {
...
@:structInit @:using(stdgo.go.ast.Ast.DeferStmt_static_extension) class DeferStmt {
    public var defer : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var call : stdgo.Ref<stdgo.go.ast.Ast.CallExpr> = (null : stdgo.Ref<stdgo.go.ast.Ast.CallExpr>);
    public function new(?defer:stdgo.go.token.Token.Pos, ?call:stdgo.Ref<stdgo.go.ast.Ast.CallExpr>) {
...
@:structInit @:using(stdgo.go.ast.Ast.ReturnStmt_static_extension) class ReturnStmt {
    public var return_ : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
...
@:structInit @:using(stdgo.go.ast.Ast.BranchStmt_static_extension) class BranchStmt {
    ...
    public var tok : stdgo.go.token.Token.Token = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Token);
    public var label : stdgo.Ref<stdgo.go.ast.Ast.Ident> = (null : stdgo.Ref<stdgo.go.ast.Ast.Ident>);
    public function new(?tokPos:stdgo.go.token.Token.Pos, ?tok:stdgo.go.token.Token.Token, ?label:stdgo.Ref<stdgo.go.ast.Ast.Ident>) {
        if (tokPos != null) this.tokPos = tokPos;
        if (tok != null) this.tok = tok;
        if (label != null) this.label = label;
    }
...
@:structInit @:using(stdgo.go.ast.Ast.IfStmt_static_extension) class IfStmt {
    public var if_ : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    ...
    public function new(?if_:stdgo.go.token.Token.Pos, ?init:stdgo.go.ast.Ast.Stmt, ?cond:stdgo.go.ast.Ast.Expr, ?body:stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>, ?else_:stdgo.go.ast.Ast.Stmt) {
...
@:structInit @:using(stdgo.go.ast.Ast.CaseClause_static_extension) class CaseClause {
    public var case_ : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
...
@:structInit @:using(stdgo.go.ast.Ast.SwitchStmt_static_extension) class SwitchStmt {
    public var switch_ : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var init : stdgo.go.ast.Ast.Stmt = (null : stdgo.go.ast.Ast.Stmt);
    public var tag : stdgo.go.ast.Ast.Expr = (null : stdgo.go.ast.Ast.Expr);
    public var body : stdgo.Ref<stdgo.go.ast.Ast.BlockStmt> = (null : stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>);
    public function new(?switch_:stdgo.go.token.Token.Pos, ?init:stdgo.go.ast.Ast.Stmt, ?tag:stdgo.go.ast.Ast.Expr, ?body:stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>) {
...
@:structInit @:using(stdgo.go.ast.Ast.TypeSwitchStmt_static_extension) class TypeSwitchStmt {
    ...
    public var body : stdgo.Ref<stdgo.go.ast.Ast.BlockStmt> = (null : stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>);
    public function new(?switch_:stdgo.go.token.Token.Pos, ?init:stdgo.go.ast.Ast.Stmt, ?assign:stdgo.go.ast.Ast.Stmt, ?body:stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>) {
        if (switch_ != null) this.switch_ = switch_;
        if (init != null) this.init = init;
...
@:structInit @:using(stdgo.go.ast.Ast.SelectStmt_static_extension) class SelectStmt {
    public var select : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var body : stdgo.Ref<stdgo.go.ast.Ast.BlockStmt> = (null : stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>);
    public function new(?select:stdgo.go.token.Token.Pos, ?body:stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>) {
...
@:structInit @:using(stdgo.go.ast.Ast.ForStmt_static_extension) class ForStmt {
    public var for_ : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var init : stdgo.go.ast.Ast.Stmt = (null : stdgo.go.ast.Ast.Stmt);
    public var cond : stdgo.go.ast.Ast.Expr = (null : stdgo.go.ast.Ast.Expr);
    public var post : stdgo.go.ast.Ast.Stmt = (null : stdgo.go.ast.Ast.Stmt);
    public var body : stdgo.Ref<stdgo.go.ast.Ast.BlockStmt> = (null : stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>);
    public function new(?for_:stdgo.go.token.Token.Pos, ?init:stdgo.go.ast.Ast.Stmt, ?cond:stdgo.go.ast.Ast.Expr, ?post:stdgo.go.ast.Ast.Stmt, ?body:stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>) {
...
@:structInit @:using(stdgo.go.ast.Ast.RangeStmt_static_extension) class RangeStmt {
    ...
    public var tokPos : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var tok : stdgo.go.token.Token.Token = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Token);
    public var range : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var x : stdgo.go.ast.Ast.Expr = (null : stdgo.go.ast.Ast.Expr);
    public var body : stdgo.Ref<stdgo.go.ast.Ast.BlockStmt> = (null : stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>);
    public function new(?for_:stdgo.go.token.Token.Pos, ?key:stdgo.go.ast.Ast.Expr, ?value:stdgo.go.ast.Ast.Expr, ?tokPos:stdgo.go.token.Token.Pos, ?tok:stdgo.go.token.Token.Token, ?range:stdgo.go.token.Token.Pos, ?x:stdgo.go.ast.Ast.Expr, ?body:stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>) {
        if (for_ != null) this.for_ = for_;
        if (key != null) this.key = key;
        if (value != null) this.value = value;
        if (tokPos != null) this.tokPos = tokPos;
...
@:structInit @:using(stdgo.go.ast.Ast.ImportSpec_static_extension) class ImportSpec {
    public var doc : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup> = (null : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>);
    public var name : stdgo.Ref<stdgo.go.ast.Ast.Ident> = (null : stdgo.Ref<stdgo.go.ast.Ast.Ident>);
    public var path : stdgo.Ref<stdgo.go.ast.Ast.BasicLit> = (null : stdgo.Ref<stdgo.go.ast.Ast.BasicLit>);
    public var comment : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup> = (null : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>);
    public var endPos : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public function new(?doc:stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>, ?name:stdgo.Ref<stdgo.go.ast.Ast.Ident>, ?path:stdgo.Ref<stdgo.go.ast.Ast.BasicLit>, ?comment:stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>, ?endPos:stdgo.go.token.Token.Pos) {
        if (doc != null) this.doc = doc;
        if (name != null) this.name = name;
...
@:structInit @:using(stdgo.go.ast.Ast.ValueSpec_static_extension) class ValueSpec {
    ...
    public var comment : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup> = (null : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>);
    public function new(?doc:stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>, ?names:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Ident>>, ?type:stdgo.go.ast.Ast.Expr, ?values:stdgo.Slice<stdgo.go.ast.Ast.Expr>, ?comment:stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>) {
        if (doc != null) this.doc = doc;
        if (names != null) this.names = names;
        if (type != null) this.type = type;
...
@:structInit @:using(stdgo.go.ast.Ast.TypeSpec_static_extension) class TypeSpec {
    ...
    public var name : stdgo.Ref<stdgo.go.ast.Ast.Ident> = (null : stdgo.Ref<stdgo.go.ast.Ast.Ident>);
    public var typeParams : stdgo.Ref<stdgo.go.ast.Ast.FieldList> = (null : stdgo.Ref<stdgo.go.ast.Ast.FieldList>);
    public var assign : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var type : stdgo.go.ast.Ast.Expr = (null : stdgo.go.ast.Ast.Expr);
    public var comment : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup> = (null : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>);
    public function new(?doc:stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>, ?name:stdgo.Ref<stdgo.go.ast.Ast.Ident>, ?typeParams:stdgo.Ref<stdgo.go.ast.Ast.FieldList>, ?assign:stdgo.go.token.Token.Pos, ?type:stdgo.go.ast.Ast.Expr, ?comment:stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>) {
        if (doc != null) this.doc = doc;
        if (name != null) this.name = name;
        if (typeParams != null) this.typeParams = typeParams;
        if (assign != null) this.assign = assign;
...
@:structInit @:using(stdgo.go.ast.Ast.GenDecl_static_extension) class GenDecl {
    ...
    public var rparen : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public function new(?doc:stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>, ?tokPos:stdgo.go.token.Token.Pos, ?tok:stdgo.go.token.Token.Token, ?lparen:stdgo.go.token.Token.Pos, ?specs:stdgo.Slice<stdgo.go.ast.Ast.Spec>, ?rparen:stdgo.go.token.Token.Pos) {
        if (doc != null) this.doc = doc;
        if (tokPos != null) this.tokPos = tokPos;
        if (tok != null) this.tok = tok;
        if (lparen != null) this.lparen = lparen;
...
@:structInit @:using(stdgo.go.ast.Ast.FuncDecl_static_extension) class FuncDecl {
    public var doc : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup> = (null : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>);
    public var recv : stdgo.Ref<stdgo.go.ast.Ast.FieldList> = (null : stdgo.Ref<stdgo.go.ast.Ast.FieldList>);
    public var name : stdgo.Ref<stdgo.go.ast.Ast.Ident> = (null : stdgo.Ref<stdgo.go.ast.Ast.Ident>);
    public var type : stdgo.Ref<stdgo.go.ast.Ast.FuncType> = (null : stdgo.Ref<stdgo.go.ast.Ast.FuncType>);
    public var body : stdgo.Ref<stdgo.go.ast.Ast.BlockStmt> = (null : stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>);
    public function new(?doc:stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>, ?recv:stdgo.Ref<stdgo.go.ast.Ast.FieldList>, ?name:stdgo.Ref<stdgo.go.ast.Ast.Ident>, ?type:stdgo.Ref<stdgo.go.ast.Ast.FuncType>, ?body:stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>) {
        if (doc != null) this.doc = doc;
...
@:structInit @:using(stdgo.go.ast.Ast.File_static_extension) class File {
    public var doc : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup> = (null : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>);
    public var package_ : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var name : stdgo.Ref<stdgo.go.ast.Ast.Ident> = (null : stdgo.Ref<stdgo.go.ast.Ast.Ident>);
    public var decls : stdgo.Slice<stdgo.go.ast.Ast.Decl> = (null : stdgo.Slice<stdgo.go.ast.Ast.Decl>);
    public var fileStart : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var fileEnd : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var scope : stdgo.Ref<stdgo.go.ast.Ast.Scope> = (null : stdgo.Ref<stdgo.go.ast.Ast.Scope>);
    public var imports : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.ImportSpec>> = (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.ImportSpec>>);
    public var unresolved : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Ident>> = (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Ident>>);
    public var comments : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>> = (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>);
    public var goVersion : stdgo.GoString = "";
    public function new(?doc:stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>, ?package_:stdgo.go.token.Token.Pos, ?name:stdgo.Ref<stdgo.go.ast.Ast.Ident>, ?decls:stdgo.Slice<stdgo.go.ast.Ast.Decl>, ?fileStart:stdgo.go.token.Token.Pos, ?fileEnd:stdgo.go.token.Token.Pos, ?scope:stdgo.Ref<stdgo.go.ast.Ast.Scope>, ?imports:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.ImportSpec>>, ?unresolved:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Ident>>, ?comments:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>, ?goVersion:stdgo.GoString) {
        if (doc != null) this.doc = doc;
...
@:structInit @:using(stdgo.go.ast.Ast.Package_static_extension) class Package {
    public var name : stdgo.GoString = "";
    public var scope : stdgo.Ref<stdgo.go.ast.Ast.Scope> = (null : stdgo.Ref<stdgo.go.ast.Ast.Scope>);
    public var imports : stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.go.ast.Ast.Object>> = (null : stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.go.ast.Ast.Object>>);
    public var files : stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.go.ast.Ast.File>> = (null : stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.go.ast.Ast.File>>);
    public function new(?name:stdgo.GoString, ?scope:stdgo.Ref<stdgo.go.ast.Ast.Scope>, ?imports:stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.go.ast.Ast.Object>>, ?files:stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.go.ast.Ast.File>>) {
        if (name != null) this.name = name;
        if (scope != null) this.scope = scope;
        if (imports != null) this.imports = imports;
...
@:structInit @:private @:using(stdgo.go.ast.Ast.T_commentListReader_static_extension) class T_commentListReader {
    ...
    public var _list : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>> = (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>);
    public var _index : stdgo.GoInt = 0;
    public var _comment : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup> = (null : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>);
    ...
    public function new(?_fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, ?_list:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>, ?_index:stdgo.GoInt, ?_comment:stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>, ?_pos:stdgo.go.token.Token.Position, ?_end:stdgo.go.token.Token.Position) {
...
@:structInit @:private class T_posSpan {
    public var start : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var end : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
...
@:structInit @:private class T_cgPos {
    ...
    public var _cg : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup> = (null : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>);
    public function new(?_left:Bool, ?_cg:stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>) {
...
@:structInit @:private @:using(stdgo.go.ast.Ast.T_printer_static_extension) class T_printer {
    ...
    public function new(?_output:stdgo.io.Io.Writer, ?_fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, ?_filter:stdgo.go.ast.Ast.FieldFilter, ?_ptrmap:stdgo.GoMap<stdgo.AnyInterface, stdgo.GoInt>, ?_indent:stdgo.GoInt, ?_last:stdgo.GoUInt8, ?_line:stdgo.GoInt) {
...
@:structInit @:private @:using(stdgo.go.ast.Ast.T_pkgBuilder_static_extension) class T_pkgBuilder {
    ...
    public function new(?_fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, ?_errors:stdgo.go.scanner.Scanner.ErrorList) {
        if (_fset != null) this._fset = _fset;
...
@:structInit @:using(stdgo.go.ast.Ast.Scope_static_extension) class Scope {
    public var outer : stdgo.Ref<stdgo.go.ast.Ast.Scope> = (null : stdgo.Ref<stdgo.go.ast.Ast.Scope>);
    public var objects : stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.go.ast.Ast.Object>> = (null : stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.go.ast.Ast.Object>>);
    public function new(?outer:stdgo.Ref<stdgo.go.ast.Ast.Scope>, ?objects:stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.go.ast.Ast.Object>>) {
...
@:structInit @:using(stdgo.go.ast.Ast.Object_static_extension) class Object {
    public var kind : stdgo.go.ast.Ast.ObjKind = ((0 : stdgo.GoInt) : stdgo.go.ast.Ast.ObjKind);
    public var name : stdgo.GoString = "";
    ...
    public function new(?kind:stdgo.go.ast.Ast.ObjKind, ?name:stdgo.GoString, ?decl:stdgo.AnyInterface, ?data:stdgo.AnyInterface, ?type:stdgo.AnyInterface) {
        if (kind != null) this.kind = kind;
        if (name != null) this.name = name;
        if (decl != null) this.decl = decl;
...
@:named @:using(stdgo.go.ast.Ast.T_byPos_static_extension) typedef T_byPos = stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>;
/**
    // A CommentMap maps an AST node to a list of comment groups
    // associated with it. See NewCommentMap for a description of
    // the association.
**/
@:named @:using(stdgo.go.ast.Ast.CommentMap_static_extension) typedef CommentMap = stdgo.GoMap<stdgo.go.ast.Ast.Node, stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>>;
...
/**
    ...
    // return pkg.
**/
@:named typedef Importer = (stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.go.ast.Ast.Object>>, stdgo.GoString) -> { var _0 : stdgo.Ref<stdgo.go.ast.Ast.Object>; var _1 : stdgo.Error; };
/**
    // ObjKind describes what an object represents.
**/
@:named @:using(stdgo.go.ast.Ast.ObjKind_static_extension) typedef ObjKind = stdgo.GoInt;
...
function _isWhitespace(_ch:stdgo.GoByte):Bool {
        return (((_ch == (32 : stdgo.GoUInt8)) || (_ch == (9 : stdgo.GoUInt8))) || (_ch == (10 : stdgo.GoUInt8))) || (_ch == (13 : stdgo.GoUInt8));
    }
function _stripTrailingWhitespace(_s:stdgo.GoString):stdgo.GoString {
        var _i:stdgo.GoInt = (_s.length);
        while ((_i > (0 : stdgo.GoInt)) && _isWhitespace(_s[(_i - (1 : stdgo.GoInt) : stdgo.GoInt)])) {
            _i--;
        };
...
function _isDirective(_c:stdgo.GoString):Bool {
        ...
        var _colon:stdgo.GoInt = stdgo.strings.Strings.index(_c?.__copy__(), (":" : stdgo.GoString));
        if ((_colon <= (0 : stdgo.GoInt)) || ((_colon + (1 : stdgo.GoInt)) >= _c.length)) {
            return false;
        };
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i <= (_colon + (1 : stdgo.GoInt)), _i++, {
                if (_i == (_colon)) {
                    continue;
                };
                var _b:stdgo.GoUInt8 = _c[(_i : stdgo.GoInt)];
                if (!((((97 : stdgo.GoUInt8) <= _b) && (_b <= (122 : stdgo.GoUInt8))) || (((48 : stdgo.GoUInt8) <= _b) && (_b <= (57 : stdgo.GoUInt8))))) {
                    return false;
                };
            });
        };
...
function newIdent(_name:stdgo.GoString):stdgo.Ref<Ident> {
        return (stdgo.Go.setRef((new stdgo.go.ast.Ast.Ident((0 : stdgo.go.token.Token.Pos), _name?.__copy__(), null) : stdgo.go.ast.Ast.Ident)) : stdgo.Ref<stdgo.go.ast.Ast.Ident>);
    }
/**
...
function testCommentText(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        for (_i => _c in _comments) {
            var _list = new stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Comment>>((_c._list.length : stdgo.GoInt).toBasic(), 0);
            for (_i => _s in _c._list) {
                _list[(_i : stdgo.GoInt)] = (stdgo.Go.setRef(({ text : _s?.__copy__() } : stdgo.go.ast.Ast.Comment)) : stdgo.Ref<stdgo.go.ast.Ast.Comment>);
            };
            var _text:stdgo.GoString = (stdgo.Go.setRef((new stdgo.go.ast.Ast.CommentGroup(_list) : stdgo.go.ast.Ast.CommentGroup)) : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>).text()?.__copy__();
            if (_text != (_c._text)) {
...
function testIsDirective(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
**/
function newCommentMap(_fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, _node:Node, _comments:stdgo.Slice<stdgo.Ref<CommentGroup>>):CommentMap {
        if ((_comments.length) == ((0 : stdgo.GoInt))) {
            return null;
        };
        var _cmap:stdgo.go.ast.Ast.CommentMap = ({
            final x = new stdgo.GoMap.GoObjectMap<stdgo.go.ast.Ast.Node, stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>>();
            ...
            x.__defaultValue__ = () -> (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>);
            @:mergeBlock {};
            cast x;
        } : stdgo.GoMap<stdgo.go.ast.Ast.Node, stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>>);
        var _tmp = new stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>((_comments.length : stdgo.GoInt).toBasic(), 0);
        ...
        for (__8 => _q in _nodes) {
            ...
            while (_r._end.offset <= _qpos.offset) {
                ...
                if ((_pg != null) && ((_pgend.line == _r._pos.line) || (((_pgend.line + (1 : stdgo.GoInt)) == _r._pos.line) && ((_r._end.line + (1 : stdgo.GoInt)) < _qpos.line)))) {
                    _assoc = _pg;
                } else if ((_p != null) && (((_pend.line == _r._pos.line) || (((_pend.line + (1 : stdgo.GoInt)) == _r._pos.line) && ((_r._end.line + (1 : stdgo.GoInt)) < _qpos.line))) || (_q == null))) {
                    _assoc = _p;
                } else {
                    if (_q == null) {
...
function _filterIdentList(_list:stdgo.Slice<stdgo.Ref<Ident>>, _f:Filter):stdgo.Slice<stdgo.Ref<Ident>> {
        ...
        return (_list.__slice__((0 : stdgo.GoInt), _j) : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Ident>>);
    }
/**
...
function _fieldName(_x:Expr):stdgo.Ref<Ident> {
        {
            ...
            if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<Ident>))) {
                var _t:stdgo.Ref<stdgo.go.ast.Ast.Ident> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Ident>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Ident>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Ident>) : __type__.__underlying__().value;
                return _t;
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<SelectorExpr>))) {
                var _t:stdgo.Ref<stdgo.go.ast.Ast.SelectorExpr> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.SelectorExpr>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.SelectorExpr>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.SelectorExpr>) : __type__.__underlying__().value;
                {
                    var __tmp__ = try {
...
function _filterFieldList(_fields:stdgo.Ref<FieldList>, _filter:Filter, _export:Bool):Bool {
        ...
        for (__0 => _f in _list) {
            ...
            if ((_f.names.length) == ((0 : stdgo.GoInt))) {
                ...
                _keepField = (_f.names.length) > (0 : stdgo.GoInt);
            };
            if (_keepField) {
                if (_export) {
        ...
        _fields.list = (_list.__slice__((0 : stdgo.GoInt), _j) : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Field>>);
...
function _filterExprList(_list:stdgo.Slice<Expr>, _filter:Filter, _export:Bool):stdgo.Slice<Expr> {
        ...
        for (__0 => _exp in _list) {
            {
                ...
                if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<CompositeLit>))) {
                    ...
                    var _x:stdgo.Ref<stdgo.go.ast.Ast.KeyValueExpr> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.KeyValueExpr>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.KeyValueExpr>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.KeyValueExpr>) : __type__.__underlying__().value;
                    {
                        var __tmp__ = try {
        ...
        return (_list.__slice__((0 : stdgo.GoInt), _j) : stdgo.Slice<stdgo.go.ast.Ast.Expr>);
    }
...
function _filterType(_typ:Expr, _f:Filter, _export:Bool):Bool {
        {
            ...
            if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<Ident>))) {
                ...
                var _t:stdgo.Ref<stdgo.go.ast.Ast.ArrayType> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ArrayType>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ArrayType>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ArrayType>) : __type__.__underlying__().value;
                return _filterType(_t.elt, _f, _export);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<StructType>))) {
                var _t:stdgo.Ref<stdgo.go.ast.Ast.StructType> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.StructType>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.StructType>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.StructType>) : __type__.__underlying__().value;
                if (_filterFieldList(_t.fields, _f, _export)) {
                    _t.incomplete = true;
                };
                return (_t.fields.list.length) > (0 : stdgo.GoInt);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<FuncType>))) {
                var _t:stdgo.Ref<stdgo.go.ast.Ast.FuncType> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.FuncType>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.FuncType>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.FuncType>) : __type__.__underlying__().value;
                ...
                var _t:stdgo.Ref<stdgo.go.ast.Ast.InterfaceType> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.InterfaceType>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.InterfaceType>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.InterfaceType>) : __type__.__underlying__().value;
                if (_filterFieldList(_t.methods, _f, _export)) {
                    _t.incomplete = true;
                };
                return (_t.methods.list.length) > (0 : stdgo.GoInt);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<MapType>))) {
                var _t:stdgo.Ref<stdgo.go.ast.Ast.MapType> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.MapType>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.MapType>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.MapType>) : __type__.__underlying__().value;
                ...
                var _t:stdgo.Ref<stdgo.go.ast.Ast.ChanType> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ChanType>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ChanType>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ChanType>) : __type__.__underlying__().value;
...
function _filterSpec(_spec:Spec, _f:Filter, _export:Bool):Bool {
        {
            ...
            if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<ValueSpec>))) {
                ...
                if ((_s.names.length) > (0 : stdgo.GoInt)) {
                    if (_export) {
...
function _filterSpecList(_list:stdgo.Slice<Spec>, _f:Filter, _export:Bool):stdgo.Slice<Spec> {
        ...
        return (_list.__slice__((0 : stdgo.GoInt), _j) : stdgo.Slice<stdgo.go.ast.Ast.Spec>);
    }
/**
...
function _filterDecl(_decl:Decl, _f:Filter, _export:Bool):Bool {
        {
            ...
            if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<GenDecl>))) {
                ...
                return (_d.specs.length) > (0 : stdgo.GoInt);
...
function _filterFile(_src:stdgo.Ref<File>, _f:Filter, _export:Bool):Bool {
        ...
        _src.decls = (_src.decls.__slice__((0 : stdgo.GoInt), _j) : stdgo.Slice<stdgo.go.ast.Ast.Decl>);
        return _j > (0 : stdgo.GoInt);
    }
/**
...
function _nameOf(_f:stdgo.Ref<FuncDecl>):stdgo.GoString {
        {
            var _r = _f.recv;
            if (((_r != null) && ((_r : Dynamic).__nil__ == null || !(_r : Dynamic).__nil__)) && (_r.list.length == (1 : stdgo.GoInt))) {
                var _t:stdgo.go.ast.Ast.Expr = _r.list[(0 : stdgo.GoInt)].type;
                {
                    var __tmp__ = try {
...
function mergePackageFiles(_pkg:stdgo.Ref<Package>, _mode:MergeMode):stdgo.Ref<File> {
        ...
        var _filenames = new stdgo.Slice<stdgo.GoString>((_pkg.files.length : stdgo.GoInt).toBasic(), 0).__setString__();
        var __0:stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos), __1:stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos), _maxPos:stdgo.go.token.Token.Pos = __1, _minPos:stdgo.go.token.Token.Pos = __0;
        var _i:stdgo.GoInt = (0 : stdgo.GoInt);
        for (_filename => _f in _pkg.files) {
            ...
            if (_f.doc != null && ((_f.doc : Dynamic).__nil__ == null || !(_f.doc : Dynamic).__nil__)) {
                _ndocs = _ndocs + (_f.doc.list.length + (1 : stdgo.GoInt));
            };
            _ncomments = _ncomments + ((_f.comments.length));
            _ndecls = _ndecls + ((_f.decls.length));
            if ((_i == (0 : stdgo.GoInt)) || (_f.fileStart < _minPos)) {
                _minPos = _f.fileStart;
            };
            if ((_i == (0 : stdgo.GoInt)) || (_f.fileEnd > _maxPos)) {
                _maxPos = _f.fileEnd;
            };
        };
        stdgo.sort.Sort.strings(_filenames);
        var _doc:stdgo.Ref<CommentGroup> = (null : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>);
        var _pos:stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
        if (_ndocs > (0 : stdgo.GoInt)) {
            var _list = new stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Comment>>((_ndocs - (1 : stdgo.GoInt) : stdgo.GoInt).toBasic(), 0);
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            for (__0 => _filename in _filenames) {
                var _f = (_pkg.files[_filename] ?? (null : stdgo.Ref<stdgo.go.ast.Ast.File>));
                if (_f.doc != null && ((_f.doc : Dynamic).__nil__ == null || !(_f.doc : Dynamic).__nil__)) {
                    if (_i > (0 : stdgo.GoInt)) {
            ...
            _doc = (stdgo.Go.setRef((new stdgo.go.ast.Ast.CommentGroup(_list) : stdgo.go.ast.Ast.CommentGroup)) : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>);
        };
        var _decls:stdgo.Slice<Decl> = (null : stdgo.Slice<stdgo.go.ast.Ast.Decl>);
        if (_ndecls > (0 : stdgo.GoInt)) {
            _decls = new stdgo.Slice<stdgo.go.ast.Ast.Decl>((_ndecls : stdgo.GoInt).toBasic(), 0);
            var _funcs = ({
                final x = new stdgo.GoMap.GoStringMap<stdgo.GoInt>();
                x.__defaultValue__ = () -> (0 : stdgo.GoInt);
                @:mergeBlock {};
                    ...
                    if (_mode & (1u32 : stdgo.go.ast.Ast.MergeMode) != ((0u32 : stdgo.go.ast.Ast.MergeMode))) {
                        {
                            ...
                            if (_isFun) {
                                var _name:stdgo.GoString = _nameOf(_f)?.__copy__();
                                {
                                    ...
                                    if (_exists) {
                                        if ((_decls[(_j : stdgo.GoInt)] != null) && ((stdgo.Go.typeAssert((stdgo.Go.toInterface(_decls[(_j : stdgo.GoInt)]) : stdgo.Ref<FuncDecl>)) : stdgo.Ref<FuncDecl>).doc == null) || ((stdgo.Go.typeAssert((stdgo.Go.toInterface(_decls[(_j : stdgo.GoInt)]) : stdgo.Ref<FuncDecl>)) : stdgo.Ref<FuncDecl>).doc : Dynamic).__nil__) {
                                            _decls[(_j : stdgo.GoInt)] = (null : stdgo.go.ast.Ast.Decl);
                                        } else {
            ...
            if (_n > (0 : stdgo.GoInt)) {
                ...
                _decls = (_decls.__slice__((0 : stdgo.GoInt), _i) : stdgo.Slice<stdgo.go.ast.Ast.Decl>);
            };
        };
        var _imports:stdgo.Slice<stdgo.Ref<ImportSpec>> = (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.ImportSpec>>);
        ...
        var _comments:stdgo.Slice<stdgo.Ref<CommentGroup>> = (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>);
        if (_mode & (2u32 : stdgo.go.ast.Ast.MergeMode) == ((0u32 : stdgo.go.ast.Ast.MergeMode))) {
            _comments = new stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>((_ncomments : stdgo.GoInt).toBasic(), 0);
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            for (__8 => _filename in _filenames) {
                var _f = (_pkg.files[_filename] ?? (null : stdgo.Ref<stdgo.go.ast.Ast.File>));
                _i = _i + (stdgo.Go.copySlice((_comments.__slice__(_i) : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>), _f.comments));
            };
        };
...
_pkg.scope,
_imports,
(null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Ident>>),
_comments,
stdgo.Go.str()?.__copy__()) : stdgo.go.ast.Ast.File)) : stdgo.Ref<stdgo.go.ast.Ast.File>);
    }
/**
    // SortImports sorts runs of consecutive import lines in import blocks in f.
    // It also removes duplicate imports when it is possible to do so without data loss.
**/
function sortImports(_fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, _f:stdgo.Ref<File>):Void {
        for (__0 => _d in _f.decls) {
            ...
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            var _specs = (_d.specs.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo.go.ast.Ast.Spec>);
            for (_j => _s in _d.specs) {
                if ((_j > _i) && (_lineAt(_fset, _s.pos()) > ((1 : stdgo.GoInt) + _lineAt(_fset, _d.specs[(_j - (1 : stdgo.GoInt) : stdgo.GoInt)].end())))) {
            ...
            _d.specs = _specs;
            if ((_d.specs.length) > (0 : stdgo.GoInt)) {
                var _lastSpec:stdgo.go.ast.Ast.Spec = _d.specs[((_d.specs.length) - (1 : stdgo.GoInt) : stdgo.GoInt)];
                var _lastLine:stdgo.GoInt = _lineAt(_fset, _lastSpec.pos());
                var _rParenLine:stdgo.GoInt = _lineAt(_fset, _d.rparen);
                while (_rParenLine > (_lastLine + (1 : stdgo.GoInt))) {
                    _rParenLine--;
...
function _lineAt(_fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, _pos:stdgo.go.token.Token.Pos):stdgo.GoInt {
        return _fset.positionFor(_pos, false).line;
    }
function _importPath(_s:Spec):stdgo.GoString {
        var __tmp__ = stdgo.strconv.Strconv.unquote((stdgo.Go.typeAssert((stdgo.Go.toInterface(_s) : stdgo.Ref<ImportSpec>)) : stdgo.Ref<ImportSpec>).path.value?.__copy__()), _t:stdgo.GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err == null) {
            return _t?.__copy__();
        };
...
function _sortSpecs(_fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, _f:stdgo.Ref<File>, _specs:stdgo.Slice<Spec>):stdgo.Slice<Spec> {
        if ((_specs.length) <= (1 : stdgo.GoInt)) {
            return _specs;
        };
        var _pos = new stdgo.Slice<stdgo.go.ast.Ast.T_posSpan>((_specs.length : stdgo.GoInt).toBasic(), 0, ...[for (i in 0 ... ((_specs.length : stdgo.GoInt).toBasic() > 0 ? (_specs.length : stdgo.GoInt).toBasic() : 0 : stdgo.GoInt).toBasic()) ({} : stdgo.go.ast.Ast.T_posSpan)]);
        for (_i => _s in _specs) {
            _pos[(_i : stdgo.GoInt)] = (new stdgo.go.ast.Ast.T_posSpan(_s.pos(), _s.end()) : stdgo.go.ast.Ast.T_posSpan);
        };
        var _begSpecs:stdgo.go.token.Token.Pos = _pos[(0 : stdgo.GoInt)].start;
        var _endSpecs:stdgo.go.token.Token.Pos = _pos[((_pos.length) - (1 : stdgo.GoInt) : stdgo.GoInt)].end;
        ...
        var _end:stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
        if (_endLine == (_endFile.lineCount())) {
            _end = _endSpecs;
        } else {
            _end = _endFile.lineStart(_endLine + (1 : stdgo.GoInt));
        };
        ...
        var _comments:stdgo.Slice<stdgo.Ref<CommentGroup>> = (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>);
        if (_last >= (0 : stdgo.GoInt)) {
            _comments = (_f.comments.__slice__(_first, _last + (1 : stdgo.GoInt)) : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>);
        };
        var _importComments = ({
            final x = new stdgo.GoMap.GoRefMap<stdgo.Ref<stdgo.go.ast.Ast.ImportSpec>, stdgo.Slice<stdgo.go.ast.Ast.T_cgPos>>();
            @:mergeBlock {};
            cast x;
        } : stdgo.GoMap<stdgo.Ref<stdgo.go.ast.Ast.ImportSpec>, stdgo.Slice<stdgo.go.ast.Ast.T_cgPos>>);
        var _specIndex:stdgo.GoInt = (0 : stdgo.GoInt);
        for (__16 => _g in _comments) {
            while (((_specIndex + (1 : stdgo.GoInt)) < _specs.length) && (_pos[(_specIndex + (1 : stdgo.GoInt) : stdgo.GoInt)].start <= _g.pos())) {
                _specIndex++;
            };
            var _left:Bool = false;
            if ((_specIndex == (0 : stdgo.GoInt)) && (_pos[(_specIndex : stdgo.GoInt)].start > _g.pos())) {
                _left = true;
            } else if (((_specIndex + (1 : stdgo.GoInt)) < _specs.length) && ((_lineAt(_fset, _pos[(_specIndex : stdgo.GoInt)].start) + (1 : stdgo.GoInt)) == _lineAt(_fset, _g.pos()))) {
                _specIndex++;
                _left = true;
            };
        ...
        stdgo.sort.Sort.slice(stdgo.Go.toInterface(_specs), function(_i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
            ...
            return _importComment(_specs[(_i : stdgo.GoInt)]) < _importComment(_specs[(_j : stdgo.GoInt)]);
        });
        var _deduped = (_specs.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo.go.ast.Ast.Spec>);
        for (_i => _s in _specs) {
            if ((_i == (_specs.length - (1 : stdgo.GoInt))) || !_collapse(_s, _specs[(_i + (1 : stdgo.GoInt) : stdgo.GoInt)])) {
        ...
        for (_i => _s in _specs) {
            ...
            for (__25 => _g in (_importComments[_s] ?? (null : stdgo.Slice<stdgo.go.ast.Ast.T_cgPos>))) {
                for (__26 => _c in _g._cg.list) {
                    if (_g._left) {
                        _c.slash = _pos[(_i : stdgo.GoInt)].start - (1 : stdgo.go.token.Token.Pos);
                    } else {
        ...
        stdgo.sort.Sort.slice(stdgo.Go.toInterface(_comments), function(_i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
            return _comments[(_i : stdgo.GoInt)].pos() < _comments[(_j : stdgo.GoInt)].pos();
        });
        return _specs;
    }
/**
...
**/
function fprint(_w:stdgo.io.Io.Writer, _fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, _x:stdgo.AnyInterface, _f:FieldFilter):stdgo.Error {
        return _fprint(_w, _fset, _x, _f);
    }
function _fprint(_w:stdgo.io.Io.Writer, _fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, _x:stdgo.AnyInterface, _f:FieldFilter):stdgo.Error {
        ...
        try {
            var _p:stdgo.go.ast.Ast.T_printer = ({ _output : _w, _fset : _fset, _filter : _f, _ptrmap : ({
                ...
                @:mergeBlock {};
                cast x;
            } : stdgo.GoMap<stdgo.AnyInterface, stdgo.GoInt>), _last : (10 : stdgo.GoUInt8) } : stdgo.go.ast.Ast.T_printer);
...
**/
function print(_fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, _x:stdgo.AnyInterface):stdgo.Error {
...
function _trim(_s:stdgo.GoString):stdgo.GoString {
        ...
        return stdgo.strings.Strings.join((_lines.__slice__((0 : stdgo.GoInt), _i) : stdgo.Slice<stdgo.GoString>), ("\n" : stdgo.GoString))?.__copy__();
    }
function testPrint(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _buf:stdgo.strings.Strings.Builder = ({} : stdgo.strings.Strings.Builder);
        for (__0 => _test in _tests) {
            _buf.reset();
            {
                var _err:stdgo.Error = fprint(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.strings.Strings.Builder>)), null, _test._x, null);
                if (_err != null) {
...
**/
function newPackage(_fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, _files:stdgo.GoMap<stdgo.GoString, stdgo.Ref<File>>, _importer:Importer, _universe:stdgo.Ref<Scope>):{ var _0 : stdgo.Ref<Package>; var _1 : stdgo.Error; } {
        ...
        var _imports = ({
            final x = new stdgo.GoMap.GoStringMap<stdgo.Ref<stdgo.go.ast.Ast.Object>>();
            x.__defaultValue__ = () -> (null : stdgo.Ref<stdgo.go.ast.Ast.Object>);
            @:mergeBlock {};
            x;
        } : stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.go.ast.Ast.Object>>);
        for (__26 => _file in _files) {
            ...
            for (__27 => _spec in _file.imports) {
                ...
                var __tmp__ = _importer(_imports, _path?.__copy__()), _pkg:stdgo.Ref<stdgo.go.ast.Ast.Object> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
            ...
            _file.unresolved = (_file.unresolved.__slice__((0 : stdgo.GoInt), _i) : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Ident>>);
            _pkgScope.outer = _universe;
        };
        _p._errors.sort();
        return { _0 : (stdgo.Go.setRef((new stdgo.go.ast.Ast.Package(_pkgName?.__copy__(), _pkgScope, _imports, _files) : stdgo.go.ast.Ast.Package)) : stdgo.Ref<stdgo.go.ast.Ast.Package>), _1 : _p._errors.err() };
    }
/**
...
function newScope(_outer:stdgo.Ref<Scope>):stdgo.Ref<Scope> {
        ...
        return (stdgo.Go.setRef((new stdgo.go.ast.Ast.Scope(_outer, ({
            ...
            @:mergeBlock {};
            x;
        } : stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.go.ast.Ast.Object>>)) : stdgo.go.ast.Ast.Scope)) : stdgo.Ref<stdgo.go.ast.Ast.Scope>);
    }
/**
    // NewObj creates a new object of a given kind and name.
**/
function newObj(_kind:ObjKind, _name:stdgo.GoString):stdgo.Ref<Object> {
        return (stdgo.Go.setRef(({ kind : _kind, name : _name?.__copy__() } : stdgo.go.ast.Ast.Object)) : stdgo.Ref<stdgo.go.ast.Ast.Object>);
    }
...
function walk(_v:Visitor, _node:Node):Void {
        ...
        };
        {
            ...
            if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<Comment>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.Comment> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Comment>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Comment>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Comment>) : __type__.__underlying__().value;
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<CommentGroup>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.CommentGroup> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>) : __type__.__underlying__().value;
                for (__0 => _c in _n.list) {
                    walk(_v, stdgo.Go.asInterface(_c));
                };
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<Field>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.Field> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Field>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Field>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Field>) : __type__.__underlying__().value;
                ...
                var _n:stdgo.Ref<stdgo.go.ast.Ast.FieldList> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.FieldList>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.FieldList>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.FieldList>) : __type__.__underlying__().value;
                ...
                var _n:stdgo.Ref<stdgo.go.ast.Ast.Ellipsis> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Ellipsis>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Ellipsis>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Ellipsis>) : __type__.__underlying__().value;
                if (_n.elt != null) {
                    walk(_v, _n.elt);
                };
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<FuncLit>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.FuncLit> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.FuncLit>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.FuncLit>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.FuncLit>) : __type__.__underlying__().value;
                ...
                var _n:stdgo.Ref<stdgo.go.ast.Ast.CompositeLit> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.CompositeLit>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.CompositeLit>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.CompositeLit>) : __type__.__underlying__().value;
                if (_n.type != null) {
                    walk(_v, _n.type);
                };
                _walkExprList(_v, _n.elts);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<ParenExpr>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.ParenExpr> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ParenExpr>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ParenExpr>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ParenExpr>) : __type__.__underlying__().value;
                walk(_v, _n.x);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<SelectorExpr>))) {
                ...
                var _n:stdgo.Ref<stdgo.go.ast.Ast.IndexExpr> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.IndexExpr>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.IndexExpr>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.IndexExpr>) : __type__.__underlying__().value;
                walk(_v, _n.x);
                walk(_v, _n.index);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<IndexListExpr>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.IndexListExpr> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.IndexListExpr>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.IndexListExpr>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.IndexListExpr>) : __type__.__underlying__().value;
                walk(_v, _n.x);
                for (__2 => _index in _n.indices) {
                    walk(_v, _index);
                };
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<SliceExpr>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.SliceExpr> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.SliceExpr>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.SliceExpr>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.SliceExpr>) : __type__.__underlying__().value;
                walk(_v, _n.x);
                if (_n.low != null) {
                    walk(_v, _n.low);
                };
                ...
                var _n:stdgo.Ref<stdgo.go.ast.Ast.TypeAssertExpr> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.TypeAssertExpr>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.TypeAssertExpr>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.TypeAssertExpr>) : __type__.__underlying__().value;
                walk(_v, _n.x);
                if (_n.type != null) {
                    walk(_v, _n.type);
                };
                ...
                var _n:stdgo.Ref<stdgo.go.ast.Ast.StarExpr> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.StarExpr>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.StarExpr>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.StarExpr>) : __type__.__underlying__().value;
                walk(_v, _n.x);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<UnaryExpr>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.UnaryExpr> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.UnaryExpr>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.UnaryExpr>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.UnaryExpr>) : __type__.__underlying__().value;
                walk(_v, _n.x);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<BinaryExpr>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr>) : __type__.__underlying__().value;
                walk(_v, _n.x);
                walk(_v, _n.y);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<KeyValueExpr>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.KeyValueExpr> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.KeyValueExpr>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.KeyValueExpr>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.KeyValueExpr>) : __type__.__underlying__().value;
                walk(_v, _n.key);
                walk(_v, _n.value);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<ArrayType>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.ArrayType> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ArrayType>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ArrayType>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ArrayType>) : __type__.__underlying__().value;
                if (_n.len != null) {
                    walk(_v, _n.len);
                };
                walk(_v, _n.elt);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<StructType>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.StructType> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.StructType>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.StructType>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.StructType>) : __type__.__underlying__().value;
                walk(_v, stdgo.Go.asInterface(_n.fields));
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<FuncType>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.FuncType> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.FuncType>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.FuncType>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.FuncType>) : __type__.__underlying__().value;
                ...
                var _n:stdgo.Ref<stdgo.go.ast.Ast.InterfaceType> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.InterfaceType>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.InterfaceType>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.InterfaceType>) : __type__.__underlying__().value;
                walk(_v, stdgo.Go.asInterface(_n.methods));
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<MapType>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.MapType> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.MapType>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.MapType>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.MapType>) : __type__.__underlying__().value;
                walk(_v, _n.key);
                walk(_v, _n.value);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<ChanType>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.ChanType> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ChanType>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ChanType>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ChanType>) : __type__.__underlying__().value;
                walk(_v, _n.value);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<BadStmt>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.BadStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BadStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BadStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BadStmt>) : __type__.__underlying__().value;
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<DeclStmt>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.DeclStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.DeclStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.DeclStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.DeclStmt>) : __type__.__underlying__().value;
                walk(_v, _n.decl);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<EmptyStmt>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.EmptyStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.EmptyStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.EmptyStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.EmptyStmt>) : __type__.__underlying__().value;
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<LabeledStmt>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.LabeledStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.LabeledStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.LabeledStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.LabeledStmt>) : __type__.__underlying__().value;
                walk(_v, stdgo.Go.asInterface(_n.label));
                walk(_v, _n.stmt);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<ExprStmt>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.ExprStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ExprStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ExprStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ExprStmt>) : __type__.__underlying__().value;
                walk(_v, _n.x);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<SendStmt>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.SendStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.SendStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.SendStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.SendStmt>) : __type__.__underlying__().value;
                walk(_v, _n.chan);
                walk(_v, _n.value);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<IncDecStmt>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.IncDecStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.IncDecStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.IncDecStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.IncDecStmt>) : __type__.__underlying__().value;
                walk(_v, _n.x);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<AssignStmt>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.AssignStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.AssignStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.AssignStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.AssignStmt>) : __type__.__underlying__().value;
                _walkExprList(_v, _n.lhs);
                _walkExprList(_v, _n.rhs);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<GoStmt>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.GoStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.GoStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.GoStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.GoStmt>) : __type__.__underlying__().value;
                walk(_v, stdgo.Go.asInterface(_n.call));
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<DeferStmt>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.DeferStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.DeferStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.DeferStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.DeferStmt>) : __type__.__underlying__().value;
                walk(_v, stdgo.Go.asInterface(_n.call));
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<ReturnStmt>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.ReturnStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ReturnStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ReturnStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ReturnStmt>) : __type__.__underlying__().value;
                _walkExprList(_v, _n.results);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<BranchStmt>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.BranchStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BranchStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BranchStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BranchStmt>) : __type__.__underlying__().value;
                ...
                var _n:stdgo.Ref<stdgo.go.ast.Ast.BlockStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>) : __type__.__underlying__().value;
                _walkStmtList(_v, _n.list);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<IfStmt>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.IfStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.IfStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.IfStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.IfStmt>) : __type__.__underlying__().value;
                if (_n.init != null) {
                    walk(_v, _n.init);
                };
                walk(_v, _n.cond);
                ...
                var _n:stdgo.Ref<stdgo.go.ast.Ast.CaseClause> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.CaseClause>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.CaseClause>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.CaseClause>) : __type__.__underlying__().value;
                _walkExprList(_v, _n.list);
                _walkStmtList(_v, _n.body);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<SwitchStmt>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.SwitchStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.SwitchStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.SwitchStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.SwitchStmt>) : __type__.__underlying__().value;
                if (_n.init != null) {
                    walk(_v, _n.init);
                };
                if (_n.tag != null) {
                ...
                var _n:stdgo.Ref<stdgo.go.ast.Ast.TypeSwitchStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.TypeSwitchStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.TypeSwitchStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.TypeSwitchStmt>) : __type__.__underlying__().value;
                if (_n.init != null) {
                    walk(_v, _n.init);
                };
                walk(_v, _n.assign);
                ...
                var _n:stdgo.Ref<stdgo.go.ast.Ast.CommClause> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.CommClause>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.CommClause>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.CommClause>) : __type__.__underlying__().value;
                if (_n.comm != null) {
                    walk(_v, _n.comm);
                };
                _walkStmtList(_v, _n.body);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<SelectStmt>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.SelectStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.SelectStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.SelectStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.SelectStmt>) : __type__.__underlying__().value;
                walk(_v, stdgo.Go.asInterface(_n.body));
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<ForStmt>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.ForStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ForStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ForStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ForStmt>) : __type__.__underlying__().value;
                if (_n.init != null) {
                    walk(_v, _n.init);
                };
                if (_n.cond != null) {
                ...
                var _n:stdgo.Ref<stdgo.go.ast.Ast.RangeStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.RangeStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.RangeStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.RangeStmt>) : __type__.__underlying__().value;
                if (_n.key != null) {
                    walk(_v, _n.key);
                };
                if (_n.value != null) {
                ...
                var _n:stdgo.Ref<stdgo.go.ast.Ast.TypeSpec> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.TypeSpec>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.TypeSpec>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.TypeSpec>) : __type__.__underlying__().value;
                if (_n.doc != null && ((_n.doc : Dynamic).__nil__ == null || !(_n.doc : Dynamic).__nil__)) {
                    walk(_v, stdgo.Go.asInterface(_n.doc));
                };
                walk(_v, stdgo.Go.asInterface(_n.name));
                ...
                var _n:stdgo.Ref<stdgo.go.ast.Ast.BadDecl> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BadDecl>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BadDecl>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BadDecl>) : __type__.__underlying__().value;
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<GenDecl>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.GenDecl> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.GenDecl>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.GenDecl>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.GenDecl>) : __type__.__underlying__().value;
                if (_n.doc != null && ((_n.doc : Dynamic).__nil__ == null || !(_n.doc : Dynamic).__nil__)) {
                    walk(_v, stdgo.Go.asInterface(_n.doc));
                };
                ...
                var _n:stdgo.Ref<stdgo.go.ast.Ast.File> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.File>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.File>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.File>) : __type__.__underlying__().value;
                if (_n.doc != null && ((_n.doc : Dynamic).__nil__ == null || !(_n.doc : Dynamic).__nil__)) {
                    walk(_v, stdgo.Go.asInterface(_n.doc));
                };
                walk(_v, stdgo.Go.asInterface(_n.name));
                ...
                var _n:stdgo.Ref<stdgo.go.ast.Ast.Package> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Package>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Package>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Package>) : __type__.__underlying__().value;
...
@:keep @:allow(stdgo.go.ast.Ast.Comment_asInterface) class Comment_static_extension {
    @:keep
    static public function end( _c:stdgo.Ref<Comment>):stdgo.go.token.Token.Pos {
        @:recv var _c:stdgo.Ref<Comment> = _c;
        return ((_c.slash : stdgo.GoInt) + (_c.text.length) : stdgo.go.token.Token.Pos);
    }
    @:keep
    static public function pos( _c:stdgo.Ref<Comment>):stdgo.go.token.Token.Pos {
        @:recv var _c:stdgo.Ref<Comment> = _c;
        return _c.slash;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.CommentGroup_asInterface) class CommentGroup_static_extension {
    ...
    **/
    ...
    static public function text( _g:stdgo.Ref<CommentGroup>):stdgo.GoString {
        ...
        var _comments = new stdgo.Slice<stdgo.GoString>((_g.list.length : stdgo.GoInt).toBasic(), 0).__setString__();
        for (_i => _c in _g.list) {
            _comments[(_i : stdgo.GoInt)] = _c.text?.__copy__();
        };
        var _lines = new stdgo.Slice<stdgo.GoString>((0 : stdgo.GoInt).toBasic(), (10 : stdgo.GoInt)).__setString__();
                ...
                while (__run__) {
                    __run__ = false;
                    {
                        ...
                        if (__value__ == ((47 : stdgo.GoUInt8))) {
                            ...
                            _c = (_c.__slice__((2 : stdgo.GoInt), (_c.length) - (2 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                            break;
                        };
                    };
                    break;
        ...
        for (__2 => _line in _lines) {
            if ((_line != stdgo.Go.str()) || ((_n > (0 : stdgo.GoInt)) && (_lines[(_n - (1 : stdgo.GoInt) : stdgo.GoInt)] != stdgo.Go.str()))) {
                _lines[(_n : stdgo.GoInt)] = _line?.__copy__();
                _n++;
            };
        };
        _lines = (_lines.__slice__((0 : stdgo.GoInt), _n) : stdgo.Slice<stdgo.GoString>);
        if ((_n > (0 : stdgo.GoInt)) && (_lines[(_n - (1 : stdgo.GoInt) : stdgo.GoInt)] != stdgo.Go.str())) {
            _lines = (_lines.__append__(stdgo.Go.str()?.__copy__()));
        };
        return stdgo.strings.Strings.join(_lines, ("\n" : stdgo.GoString))?.__copy__();
    }
    @:keep
    static public function end( _g:stdgo.Ref<CommentGroup>):stdgo.go.token.Token.Pos {
        @:recv var _g:stdgo.Ref<CommentGroup> = _g;
        return _g.list[((_g.list.length) - (1 : stdgo.GoInt) : stdgo.GoInt)].end();
    }
    @:keep
    static public function pos( _g:stdgo.Ref<CommentGroup>):stdgo.go.token.Token.Pos {
        @:recv var _g:stdgo.Ref<CommentGroup> = _g;
...
@:keep @:allow(stdgo.go.ast.Ast.Field_asInterface) class Field_static_extension {
    @:keep
    static public function end( _f:stdgo.Ref<Field>):stdgo.go.token.Token.Pos {
    ...
    @:keep
    static public function pos( _f:stdgo.Ref<Field>):stdgo.go.token.Token.Pos {
        @:recv var _f:stdgo.Ref<Field> = _f;
        if ((_f.names.length) > (0 : stdgo.GoInt)) {
...
@:keep @:allow(stdgo.go.ast.Ast.FieldList_asInterface) class FieldList_static_extension {
    ...
    **/
    ...
    @:keep
    static public function end( _f:stdgo.Ref<FieldList>):stdgo.go.token.Token.Pos {
        @:recv var _f:stdgo.Ref<FieldList> = _f;
    ...
    @:keep
    static public function pos( _f:stdgo.Ref<FieldList>):stdgo.go.token.Token.Pos {
        @:recv var _f:stdgo.Ref<FieldList> = _f;
        if (_f.opening.isValid()) {
            return _f.opening;
        };
        if ((_f.list.length) > (0 : stdgo.GoInt)) {
...
@:keep @:allow(stdgo.go.ast.Ast.BadExpr_asInterface) class BadExpr_static_extension {
    ...
    **/
    ...
    @:keep
    static public function end( _x:stdgo.Ref<BadExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<BadExpr> = _x;
        return _x.to;
    }
    @:keep
    static public function pos( _x:stdgo.Ref<BadExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<BadExpr> = _x;
        return _x.from;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.Ident_asInterface) class Ident_static_extension {
    ...
    **/
    ...
    @:keep
    static public function end( _x:stdgo.Ref<Ident>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<Ident> = _x;
        return ((_x.namePos : stdgo.GoInt) + (_x.name.length) : stdgo.go.token.Token.Pos);
    }
    @:keep
    static public function pos( _x:stdgo.Ref<Ident>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<Ident> = _x;
        return _x.namePos;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.Ellipsis_asInterface) class Ellipsis_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<Ellipsis>):stdgo.go.token.Token.Pos {
    ...
    @:keep
    static public function pos( _x:stdgo.Ref<Ellipsis>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<Ellipsis> = _x;
        return _x.ellipsis;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.BasicLit_asInterface) class BasicLit_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<BasicLit>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<BasicLit> = _x;
        return ((_x.valuePos : stdgo.GoInt) + (_x.value.length) : stdgo.go.token.Token.Pos);
    }
    @:keep
    static public function pos( _x:stdgo.Ref<BasicLit>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<BasicLit> = _x;
        return _x.valuePos;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.FuncLit_asInterface) class FuncLit_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<FuncLit>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<FuncLit> = _x;
        return _x.body.end();
    }
    @:keep
    static public function pos( _x:stdgo.Ref<FuncLit>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<FuncLit> = _x;
        return _x.type.pos();
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.CompositeLit_asInterface) class CompositeLit_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<CompositeLit>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<CompositeLit> = _x;
        return _x.rbrace + (1 : stdgo.go.token.Token.Pos);
    }
    @:keep
    static public function pos( _x:stdgo.Ref<CompositeLit>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<CompositeLit> = _x;
        if (_x.type != null) {
            return _x.type.pos();
        };
...
@:keep @:allow(stdgo.go.ast.Ast.ParenExpr_asInterface) class ParenExpr_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<ParenExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<ParenExpr> = _x;
        return _x.rparen + (1 : stdgo.go.token.Token.Pos);
    }
    @:keep
    static public function pos( _x:stdgo.Ref<ParenExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<ParenExpr> = _x;
        return _x.lparen;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.SelectorExpr_asInterface) class SelectorExpr_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<SelectorExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<SelectorExpr> = _x;
        return _x.sel.end();
    }
    @:keep
    static public function pos( _x:stdgo.Ref<SelectorExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<SelectorExpr> = _x;
        return _x.x.pos();
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.IndexExpr_asInterface) class IndexExpr_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<IndexExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<IndexExpr> = _x;
        return _x.rbrack + (1 : stdgo.go.token.Token.Pos);
    }
    @:keep
    static public function pos( _x:stdgo.Ref<IndexExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<IndexExpr> = _x;
        return _x.x.pos();
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.IndexListExpr_asInterface) class IndexListExpr_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<IndexListExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<IndexListExpr> = _x;
        return _x.rbrack + (1 : stdgo.go.token.Token.Pos);
    }
    @:keep
    static public function pos( _x:stdgo.Ref<IndexListExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<IndexListExpr> = _x;
        return _x.x.pos();
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.SliceExpr_asInterface) class SliceExpr_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<SliceExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<SliceExpr> = _x;
        return _x.rbrack + (1 : stdgo.go.token.Token.Pos);
    }
    @:keep
    static public function pos( _x:stdgo.Ref<SliceExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<SliceExpr> = _x;
        return _x.x.pos();
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.TypeAssertExpr_asInterface) class TypeAssertExpr_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<TypeAssertExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<TypeAssertExpr> = _x;
        return _x.rparen + (1 : stdgo.go.token.Token.Pos);
    }
    @:keep
    static public function pos( _x:stdgo.Ref<TypeAssertExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<TypeAssertExpr> = _x;
        return _x.x.pos();
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.CallExpr_asInterface) class CallExpr_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<CallExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<CallExpr> = _x;
        return _x.rparen + (1 : stdgo.go.token.Token.Pos);
    }
    @:keep
    static public function pos( _x:stdgo.Ref<CallExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<CallExpr> = _x;
        return _x.fun.pos();
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.StarExpr_asInterface) class StarExpr_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<StarExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<StarExpr> = _x;
        return _x.x.end();
    }
    @:keep
    static public function pos( _x:stdgo.Ref<StarExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<StarExpr> = _x;
        return _x.star;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.UnaryExpr_asInterface) class UnaryExpr_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<UnaryExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<UnaryExpr> = _x;
        return _x.x.end();
    }
    @:keep
    static public function pos( _x:stdgo.Ref<UnaryExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<UnaryExpr> = _x;
        return _x.opPos;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.BinaryExpr_asInterface) class BinaryExpr_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<BinaryExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<BinaryExpr> = _x;
        return _x.y.end();
    }
    @:keep
    static public function pos( _x:stdgo.Ref<BinaryExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<BinaryExpr> = _x;
        return _x.x.pos();
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.KeyValueExpr_asInterface) class KeyValueExpr_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<KeyValueExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<KeyValueExpr> = _x;
        return _x.value.end();
    }
    @:keep
    static public function pos( _x:stdgo.Ref<KeyValueExpr>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<KeyValueExpr> = _x;
        return _x.key.pos();
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.ArrayType_asInterface) class ArrayType_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<ArrayType>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<ArrayType> = _x;
        return _x.elt.end();
    }
    @:keep
    static public function pos( _x:stdgo.Ref<ArrayType>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<ArrayType> = _x;
        return _x.lbrack;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.StructType_asInterface) class StructType_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<StructType>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<StructType> = _x;
        return _x.fields.end();
    }
    @:keep
    static public function pos( _x:stdgo.Ref<StructType>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<StructType> = _x;
        return _x.struct_;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.FuncType_asInterface) class FuncType_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<FuncType>):stdgo.go.token.Token.Pos {
    ...
    @:keep
    static public function pos( _x:stdgo.Ref<FuncType>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<FuncType> = _x;
...
@:keep @:allow(stdgo.go.ast.Ast.InterfaceType_asInterface) class InterfaceType_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<InterfaceType>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<InterfaceType> = _x;
        return _x.methods.end();
    }
    @:keep
    static public function pos( _x:stdgo.Ref<InterfaceType>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<InterfaceType> = _x;
...
@:keep @:allow(stdgo.go.ast.Ast.MapType_asInterface) class MapType_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<MapType>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<MapType> = _x;
        return _x.value.end();
    }
    @:keep
    static public function pos( _x:stdgo.Ref<MapType>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<MapType> = _x;
        return _x.map_;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.ChanType_asInterface) class ChanType_static_extension {
    ...
    @:keep
    static public function end( _x:stdgo.Ref<ChanType>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<ChanType> = _x;
        return _x.value.end();
    }
    @:keep
    static public function pos( _x:stdgo.Ref<ChanType>):stdgo.go.token.Token.Pos {
        @:recv var _x:stdgo.Ref<ChanType> = _x;
        return _x.begin;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.BadStmt_asInterface) class BadStmt_static_extension {
    ...
    **/
    ...
    @:keep
    static public function end( _s:stdgo.Ref<BadStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<BadStmt> = _s;
        return _s.to;
    }
    @:keep
    static public function pos( _s:stdgo.Ref<BadStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<BadStmt> = _s;
        return _s.from;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.DeclStmt_asInterface) class DeclStmt_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<DeclStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<DeclStmt> = _s;
        return _s.decl.end();
    }
    @:keep
    static public function pos( _s:stdgo.Ref<DeclStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<DeclStmt> = _s;
        return _s.decl.pos();
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.EmptyStmt_asInterface) class EmptyStmt_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<EmptyStmt>):stdgo.go.token.Token.Pos {
    ...
    @:keep
    static public function pos( _s:stdgo.Ref<EmptyStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<EmptyStmt> = _s;
        return _s.semicolon;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.LabeledStmt_asInterface) class LabeledStmt_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<LabeledStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<LabeledStmt> = _s;
        return _s.stmt.end();
    }
    @:keep
    static public function pos( _s:stdgo.Ref<LabeledStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<LabeledStmt> = _s;
        return _s.label.pos();
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.ExprStmt_asInterface) class ExprStmt_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<ExprStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<ExprStmt> = _s;
        return _s.x.end();
    }
    @:keep
    static public function pos( _s:stdgo.Ref<ExprStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<ExprStmt> = _s;
        return _s.x.pos();
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.SendStmt_asInterface) class SendStmt_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<SendStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<SendStmt> = _s;
        return _s.value.end();
    }
    @:keep
    static public function pos( _s:stdgo.Ref<SendStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<SendStmt> = _s;
        return _s.chan.pos();
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.IncDecStmt_asInterface) class IncDecStmt_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<IncDecStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<IncDecStmt> = _s;
        return _s.tokPos + (2 : stdgo.go.token.Token.Pos);
    }
    @:keep
    static public function pos( _s:stdgo.Ref<IncDecStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<IncDecStmt> = _s;
        return _s.x.pos();
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.AssignStmt_asInterface) class AssignStmt_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<AssignStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<AssignStmt> = _s;
        return _s.rhs[((_s.rhs.length) - (1 : stdgo.GoInt) : stdgo.GoInt)].end();
    }
    @:keep
    static public function pos( _s:stdgo.Ref<AssignStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<AssignStmt> = _s;
...
@:keep @:allow(stdgo.go.ast.Ast.GoStmt_asInterface) class GoStmt_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<GoStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<GoStmt> = _s;
        return _s.call.end();
    }
    @:keep
    static public function pos( _s:stdgo.Ref<GoStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<GoStmt> = _s;
        return _s.go;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.DeferStmt_asInterface) class DeferStmt_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<DeferStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<DeferStmt> = _s;
        return _s.call.end();
    }
    @:keep
    static public function pos( _s:stdgo.Ref<DeferStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<DeferStmt> = _s;
        return _s.defer;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.ReturnStmt_asInterface) class ReturnStmt_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<ReturnStmt>):stdgo.go.token.Token.Pos {
    ...
    @:keep
    static public function pos( _s:stdgo.Ref<ReturnStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<ReturnStmt> = _s;
        return _s.return_;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.BranchStmt_asInterface) class BranchStmt_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<BranchStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<BranchStmt> = _s;
        if (_s.label != null && ((_s.label : Dynamic).__nil__ == null || !(_s.label : Dynamic).__nil__)) {
            return _s.label.end();
        };
        return ((_s.tokPos : stdgo.GoInt) + ((_s.tok.string() : stdgo.GoString).length) : stdgo.go.token.Token.Pos);
    }
    @:keep
    static public function pos( _s:stdgo.Ref<BranchStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<BranchStmt> = _s;
        return _s.tokPos;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.BlockStmt_asInterface) class BlockStmt_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<BlockStmt>):stdgo.go.token.Token.Pos {
    ...
    @:keep
    static public function pos( _s:stdgo.Ref<BlockStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<BlockStmt> = _s;
        return _s.lbrace;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.IfStmt_asInterface) class IfStmt_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<IfStmt>):stdgo.go.token.Token.Pos {
    ...
    @:keep
    static public function pos( _s:stdgo.Ref<IfStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<IfStmt> = _s;
        return _s.if_;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.CaseClause_asInterface) class CaseClause_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<CaseClause>):stdgo.go.token.Token.Pos {
    ...
    @:keep
    static public function pos( _s:stdgo.Ref<CaseClause>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<CaseClause> = _s;
        return _s.case_;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.SwitchStmt_asInterface) class SwitchStmt_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<SwitchStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<SwitchStmt> = _s;
        return _s.body.end();
    }
    @:keep
    static public function pos( _s:stdgo.Ref<SwitchStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<SwitchStmt> = _s;
        return _s.switch_;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.TypeSwitchStmt_asInterface) class TypeSwitchStmt_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<TypeSwitchStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<TypeSwitchStmt> = _s;
        return _s.body.end();
    }
    @:keep
    static public function pos( _s:stdgo.Ref<TypeSwitchStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<TypeSwitchStmt> = _s;
        return _s.switch_;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.CommClause_asInterface) class CommClause_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<CommClause>):stdgo.go.token.Token.Pos {
    ...
    @:keep
    static public function pos( _s:stdgo.Ref<CommClause>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<CommClause> = _s;
        return _s.case_;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.SelectStmt_asInterface) class SelectStmt_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<SelectStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<SelectStmt> = _s;
        return _s.body.end();
    }
    @:keep
    static public function pos( _s:stdgo.Ref<SelectStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<SelectStmt> = _s;
        return _s.select;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.ForStmt_asInterface) class ForStmt_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<ForStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<ForStmt> = _s;
        return _s.body.end();
    }
    @:keep
    static public function pos( _s:stdgo.Ref<ForStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<ForStmt> = _s;
        return _s.for_;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.RangeStmt_asInterface) class RangeStmt_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<RangeStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<RangeStmt> = _s;
        return _s.body.end();
    }
    @:keep
    static public function pos( _s:stdgo.Ref<RangeStmt>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<RangeStmt> = _s;
        return _s.for_;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.ImportSpec_asInterface) class ImportSpec_static_extension {
    ...
    **/
    ...
    @:keep
    static public function end( _s:stdgo.Ref<ImportSpec>):stdgo.go.token.Token.Pos {
    ...
    @:keep
    static public function pos( _s:stdgo.Ref<ImportSpec>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<ImportSpec> = _s;
        if (_s.name != null && ((_s.name : Dynamic).__nil__ == null || !(_s.name : Dynamic).__nil__)) {
            return _s.name.pos();
        };
...
@:keep @:allow(stdgo.go.ast.Ast.ValueSpec_asInterface) class ValueSpec_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<ValueSpec>):stdgo.go.token.Token.Pos {
    ...
    @:keep
    static public function pos( _s:stdgo.Ref<ValueSpec>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<ValueSpec> = _s;
...
@:keep @:allow(stdgo.go.ast.Ast.TypeSpec_asInterface) class TypeSpec_static_extension {
    ...
    @:keep
    static public function end( _s:stdgo.Ref<TypeSpec>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<TypeSpec> = _s;
        return _s.type.end();
    }
    @:keep
    static public function pos( _s:stdgo.Ref<TypeSpec>):stdgo.go.token.Token.Pos {
        @:recv var _s:stdgo.Ref<TypeSpec> = _s;
        return _s.name.pos();
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.BadDecl_asInterface) class BadDecl_static_extension {
    ...
    **/
    ...
    @:keep
    static public function end( _d:stdgo.Ref<BadDecl>):stdgo.go.token.Token.Pos {
        @:recv var _d:stdgo.Ref<BadDecl> = _d;
        return _d.to;
    }
    @:keep
    static public function pos( _d:stdgo.Ref<BadDecl>):stdgo.go.token.Token.Pos {
        @:recv var _d:stdgo.Ref<BadDecl> = _d;
        return _d.from;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.GenDecl_asInterface) class GenDecl_static_extension {
    ...
    @:keep
    static public function end( _d:stdgo.Ref<GenDecl>):stdgo.go.token.Token.Pos {
    ...
    @:keep
    static public function pos( _d:stdgo.Ref<GenDecl>):stdgo.go.token.Token.Pos {
        @:recv var _d:stdgo.Ref<GenDecl> = _d;
        return _d.tokPos;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.FuncDecl_asInterface) class FuncDecl_static_extension {
    ...
    @:keep
    static public function end( _d:stdgo.Ref<FuncDecl>):stdgo.go.token.Token.Pos {
    ...
    @:keep
    static public function pos( _d:stdgo.Ref<FuncDecl>):stdgo.go.token.Token.Pos {
        @:recv var _d:stdgo.Ref<FuncDecl> = _d;
        return _d.type.pos();
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.File_asInterface) class File_static_extension {
    ...
    **/
    @:keep
    static public function end( _f:stdgo.Ref<File>):stdgo.go.token.Token.Pos {
    ...
    **/
    @:keep
    static public function pos( _f:stdgo.Ref<File>):stdgo.go.token.Token.Pos {
        @:recv var _f:stdgo.Ref<File> = _f;
        return _f.package_;
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.Package_asInterface) class Package_static_extension {
    @:keep
    static public function end( _p:stdgo.Ref<Package>):stdgo.go.token.Token.Pos {
        @:recv var _p:stdgo.Ref<Package> = _p;
        return (0 : stdgo.go.token.Token.Pos);
    }
    @:keep
    static public function pos( _p:stdgo.Ref<Package>):stdgo.go.token.Token.Pos {
        @:recv var _p:stdgo.Ref<Package> = _p;
        return (0 : stdgo.go.token.Token.Pos);
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.T_printer_asInterface) class T_printer_static_extension {
    @:keep
    static public function _print( _p:stdgo.Ref<T_printer>, _x:stdgo.reflect.Reflect.Value):Void {
        ...
        };
        {
            ...
            if (__value__ == ((20u32 : stdgo.reflect.Reflect.Kind))) {
                ...
                var _t:stdgo.reflect.Reflect.Type_ = _x.type();
                ...
                var _v:stdgo.AnyInterface = _x.interface_();
                {
                    ...
                    if (stdgo.Go.typeEquals((__type__ : stdgo.GoString))) {
                        ...
                        var _v:stdgo.go.token.Token.Pos = __type__ == null ? ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos) : __type__.__underlying__() == null ? ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos) : __type__ == null ? ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos) : __type__.__underlying__().value;
    ...
    **/
    ...
    static public function _printf( _p:stdgo.Ref<T_printer>, _format:stdgo.GoString, _args:haxe.Rest<stdgo.AnyInterface>):Void {
        ...
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        {
            var __tmp__ = stdgo.fmt.Fmt.fprintf(stdgo.Go.asInterface(_p), _format?.__copy__(), ..._args.__toArray__()), __0:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
    ...
    static public function write( _p:stdgo.Ref<T_printer>, _data:stdgo.Slice<stdgo.GoByte>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        ...
        for (_i => _b in _data) {
            if (_b == ((10 : stdgo.GoUInt8))) {
                {
                    var __tmp__ = _p._output.write((_data.__slice__(_n, _i + (1 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>));
                    _m = __tmp__._0;
                    _err = __tmp__._1;
                };
                _n = _n + (_m);
...
class T_pkgBuilder_asInterface {
    ...
    @:keep
    public dynamic function _errorf(_pos:stdgo.go.token.Token.Pos, _format:stdgo.GoString, _args:haxe.Rest<stdgo.AnyInterface>):Void __self__.value._errorf(_pos, _format, ..._args);
    @:keep
...
@:keep @:allow(stdgo.go.ast.Ast.T_pkgBuilder_asInterface) class T_pkgBuilder_static_extension {
    ...
    @:keep
    static public function _errorf( _p:stdgo.Ref<T_pkgBuilder>, _pos:stdgo.go.token.Token.Pos, _format:stdgo.GoString, _args:haxe.Rest<stdgo.AnyInterface>):Void {
        var _args = new stdgo.Slice<stdgo.AnyInterface>(_args.length, 0, ..._args);
        @:recv var _p:stdgo.Ref<T_pkgBuilder> = _p;
        _p._error(_pos, stdgo.fmt.Fmt.sprintf(_format?.__copy__(), ..._args.__toArray__())?.__copy__());
    }
    @:keep
    static public function _error( _p:stdgo.Ref<T_pkgBuilder>, _pos:stdgo.go.token.Token.Pos, _msg:stdgo.GoString):Void {
        @:recv var _p:stdgo.Ref<T_pkgBuilder> = _p;
...
@:keep @:allow(stdgo.go.ast.Ast.Scope_asInterface) class Scope_static_extension {
    ...
    **/
    ...
    static public function string( _s:stdgo.Ref<Scope>):stdgo.GoString {
        ...
        var _buf:stdgo.strings.Strings.Builder = ({} : stdgo.strings.Strings.Builder);
        stdgo.fmt.Fmt.fprintf(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.strings.Strings.Builder>)), ("scope %p {" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_s)));
        if (((_s != null) && ((_s : Dynamic).__nil__ == null || !(_s : Dynamic).__nil__)) && (_s.objects.length > (0 : stdgo.GoInt))) {
            stdgo.fmt.Fmt.fprintln(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.strings.Strings.Builder>)));
            for (__0 => _obj in _s.objects) {
                stdgo.fmt.Fmt.fprintf(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.strings.Strings.Builder>)), ("\t%s %s\n" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_obj.kind)), stdgo.Go.toInterface(_obj.name));
            };
        };
        stdgo.fmt.Fmt.fprintf(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.strings.Strings.Builder>)), ("}\n" : stdgo.GoString));
    ...
    **/
    ...
    static public function insert( _s:stdgo.Ref<Scope>, _obj:stdgo.Ref<Object>):stdgo.Ref<Object> {
        @:recv var _s:stdgo.Ref<Scope> = _s;
        var _alt:stdgo.Ref<Object> = (null : stdgo.Ref<stdgo.go.ast.Ast.Object>);
        {
            _alt = (_s.objects[_obj.name] ?? (null : stdgo.Ref<stdgo.go.ast.Ast.Object>));
    ...
    **/
    ...
    static public function lookup( _s:stdgo.Ref<Scope>, _name:stdgo.GoString):stdgo.Ref<Object> {
        @:recv var _s:stdgo.Ref<Scope> = _s;
        return (_s.objects[_name] ?? (null : stdgo.Ref<stdgo.go.ast.Ast.Object>));
    }
}
...
@:keep @:allow(stdgo.go.ast.Ast.Object_asInterface) class Object_static_extension {
    ...
    **/
    @:keep
    static public function pos( _obj:stdgo.Ref<Object>):stdgo.go.token.Token.Pos {
        ...
        var _name:stdgo.GoString = _obj.name?.__copy__();
        {
            ...
            if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<Field>))) {
                var _d:stdgo.Ref<stdgo.go.ast.Ast.Field> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Field>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Field>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Field>) : __type__.__underlying__().value;
                ...
                var _d:stdgo.Ref<stdgo.go.ast.Ast.ImportSpec> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ImportSpec>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ImportSpec>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ImportSpec>) : __type__.__underlying__().value;
                if (((_d.name != null) && ((_d.name : Dynamic).__nil__ == null || !(_d.name : Dynamic).__nil__)) && (_d.name.name == _name)) {
                    return _d.name.pos();
                };
                return _d.path.pos();
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<ValueSpec>))) {
                var _d:stdgo.Ref<stdgo.go.ast.Ast.ValueSpec> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ValueSpec>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ValueSpec>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.ValueSpec>) : __type__.__underlying__().value;
                ...
                var _d:stdgo.Ref<stdgo.go.ast.Ast.TypeSpec> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.TypeSpec>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.TypeSpec>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.TypeSpec>) : __type__.__underlying__().value;
                ...
                var _d:stdgo.Ref<stdgo.go.ast.Ast.LabeledStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.LabeledStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.LabeledStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.LabeledStmt>) : __type__.__underlying__().value;
                if (_d.label.name == (_name)) {
                    return _d.label.pos();
                };
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<AssignStmt>))) {
                var _d:stdgo.Ref<stdgo.go.ast.Ast.AssignStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.AssignStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.AssignStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.AssignStmt>) : __type__.__underlying__().value;
                ...
                var _d:stdgo.Ref<stdgo.go.ast.Ast.Scope> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Scope>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Scope>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Scope>) : __type__.__underlying__().value;
            };
        };
        return (0 : stdgo.go.token.Token.Pos);
    }
...
@:keep @:allow(stdgo.go.ast.Ast.T_byPos_asInterface) class T_byPos_static_extension {
    ...
    static public function less( _a:T_byPos, _i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
        @:recv var _a:T_byPos = _a;
        return _a[(_i : stdgo.GoInt)].pos() < _a[(_j : stdgo.GoInt)].pos();
    }
    @:keep
...
@:keep @:allow(stdgo.go.ast.Ast.CommentMap_asInterface) class CommentMap_static_extension {
    ...
    static public function string( _cmap:CommentMap):stdgo.GoString {
        ...
        var _buf:stdgo.strings.Strings.Builder = ({} : stdgo.strings.Strings.Builder);
        stdgo.fmt.Fmt.fprintln(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.strings.Strings.Builder>)), stdgo.Go.toInterface(("CommentMap {" : stdgo.GoString)));
        for (__0 => _node in _nodes) {
            var _comment = (_cmap[_node] ?? (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>));
            ...
            stdgo.fmt.Fmt.fprintf(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.strings.Strings.Builder>)), ("\t%p  %20s:  %s\n" : stdgo.GoString), stdgo.Go.toInterface(_node), stdgo.Go.toInterface(_s), stdgo.Go.toInterface(_summary(_comment)));
        };
    ...
    **/
    ...
    static public function comments( _cmap:CommentMap):stdgo.Slice<stdgo.Ref<CommentGroup>> {
        @:recv var _cmap:CommentMap = _cmap;
        var _list = new stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>((0 : stdgo.GoInt).toBasic(), (_cmap.length));
        for (__0 => _e in _cmap) {
    ...
    **/
    ...
    static public function filter( _cmap:CommentMap, _node:Node):CommentMap {
        ...
        inspect(_node, function(_n:Node):Bool {
            {
                var _g = (_cmap[_n] ?? (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>));
                if ((_g.length) > (0 : stdgo.GoInt)) {
                    _umap[_n] = _g;
                };
            };
            return true;
    ...
    **/
    ...
    static public function update( _cmap:CommentMap, _old:Node, _new:Node):Node {
        @:recv var _cmap:CommentMap = _cmap;
        {
            var _list = (_cmap[_old] ?? (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>));
            if ((_list.length) > (0 : stdgo.GoInt)) {
                if (_cmap != null) _cmap.remove(_old);
                _cmap[_new] = ((_cmap[_new] ?? (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>)).__append__(..._list.__toArray__()));
            };
        };
        return _new;
    }
    ...
    static public function _addComment( _cmap:CommentMap, _n:Node, _c:stdgo.Ref<CommentGroup>):Void {
        @:recv var _cmap:CommentMap = _cmap;
        var _list = (_cmap[_n] ?? (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>));
        if ((_list.length) == ((0 : stdgo.GoInt))) {
            _list = (new stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>(1, 1, _c) : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>);
        } else {
...
@:keep @:allow(stdgo.go.ast.Ast.T_byInterval_asInterface) class T_byInterval_static_extension {
    ...
    static public function less( _a:T_byInterval, _i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
        @:recv var _a:T_byInterval = _a;
        var __0:stdgo.go.token.Token.Pos = _a[(_i : stdgo.GoInt)].pos(), __1:stdgo.go.token.Token.Pos = _a[(_j : stdgo.GoInt)].pos(), _pj:stdgo.go.token.Token.Pos = __1, _pi:stdgo.go.token.Token.Pos = __0;
        return (_pi < _pj) || ((_pi == _pj) && (_a[(_i : stdgo.GoInt)].end() > _a[(_j : stdgo.GoInt)].end()));
    }
    @:keep
...
@:keep @:allow(stdgo.go.ast.Ast.T_nodeStack_asInterface) class T_nodeStack_static_extension {
    ...
    **/
    @:keep
    static public function _pop( _s:stdgo.Ref<T_nodeStack>, _pos:stdgo.go.token.Token.Pos):Node {
        @:recv var _s:stdgo.Ref<T_nodeStack> = _s;
        var _top:Node = (null : stdgo.go.ast.Ast.Node);
        var _i:stdgo.GoInt = ((_s : stdgo.go.ast.Ast.T_nodeStack).length);
        while ((_i > (0 : stdgo.GoInt)) && (((_s : stdgo.go.ast.Ast.T_nodeStack))[(_i - (1 : stdgo.GoInt) : stdgo.GoInt)].end() <= _pos)) {
            _top = ((_s : stdgo.go.ast.Ast.T_nodeStack))[(_i - (1 : stdgo.GoInt) : stdgo.GoInt)];
            _i--;
        };
        _s.__setData__((((_s : stdgo.go.ast.Ast.T_nodeStack)).__slice__((0 : stdgo.GoInt), _i) : stdgo.go.ast.Ast.T_nodeStack));
        return _top;
    }
    /**
        // push pops all nodes that appear lexically before n
