...
**/
private var _separator = ((new Comment((0 : stdgo.go.token.Token.Pos), ("//" : GoString)) : Comment) : Ref<Comment>);
/**
...
function mergePackageFiles(_pkg:Ref<Package>, _mode:MergeMode):Ref<File> {
                    ...
                    if (_mode & (("1" : GoUInt) : MergeMode) != ((("0" : GoUInt) : MergeMode))) {
                        {
                            ...
                            if (_isFun) {
                                var _name:GoString = _nameOf(_f);
                                {
                                    ...
                                    if (_exists) {
                                        if ((_decls[(_j : GoInt)] != null) && ((Go.typeAssert((Go.toInterface(_decls[(_j : GoInt)]) : Ref<FuncDecl>)) : Ref<FuncDecl>).doc == null)) {
        ...
        return ((new File(_doc, _pos, newIdent(_pkg.name), _decls, _minPos, _maxPos, _pkg.scope, _imports, (null : Slice<Ref<Ident>>), _comments) : File) : Ref<File>);
    }
/**
...
function notNilFilter(_0:GoString, _v:stdgo.reflect.Reflect.Value):Bool {
        if (_v.kind() == ((("18" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _v.kind() == ((("19" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _v.kind() == ((("20" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _v.kind() == ((("21" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _v.kind() == ((("22" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _v.kind() == ((("23" : GoUInt) : stdgo.reflect.Reflect.Kind))) {
            return !_v.isNil();
        };
        return true;
    }
...
function testPrint(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        for (_0 => _test in _tests) {
            _buf.reset();
            {
                var _err:Error = fprint(Go.asInterface((_buf : Ref<stdgo.strings.Strings.Builder>)), null, _test._x, null);
                if (_err != null) {
...
function newScope(_outer:Ref<Scope>):Ref<Scope> {
        {};
        return ((new Scope(_outer, (new GoObjectMap<GoString, Ref<Object>>(new stdgo.internal.reflect.Reflect._Type(stdgo.internal.reflect.Reflect.GoType.mapType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(string_kind) }, { get : () -> stdgo.internal.reflect.Reflect.GoType.refType({ get : () -> stdgo.internal.reflect.Reflect.GoType.named("Object", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "kind", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("ObjKind", [], stdgo.internal.reflect.Reflect.GoType.basic(int_kind), false, { get : () -> null }) }, optional : false }, { name : "name", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(string_kind) }, optional : false }, { name : "decl", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.interfaceType(true, []) }, optional : false }, { name : "data", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.interfaceType(true, []) }, optional : false }, { name : "type", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.interfaceType(true, []) }, optional : false }]), false, { get : () -> null }) }) }))) : GoMap<GoString, Ref<Object>>)) : Scope) : Ref<Scope>);
    }
/**
...
class Comment_asInterface {
    @:keep
    public function end():stdgo.go.token.Token.Pos return __self__.value.end();
    @:keep
    public function pos():stdgo.go.token.Token.Pos return __self__.value.pos();
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
class FieldList_asInterface {
    ...
    **/
    @:keep
    public function numFields():GoInt return __self__.value.numFields();
    @:keep
    public function end():stdgo.go.token.Token.Pos return __self__.value.end();
    @:keep
    public function pos():stdgo.go.token.Token.Pos return __self__.value.pos();
...
class BadExpr_asInterface {
    ...
    **/
    @:keep
    public function _exprNode():Void __self__.value._exprNode();
    @:keep
    public function end():stdgo.go.token.Token.Pos return __self__.value.end();
    @:keep
    public function pos():stdgo.go.token.Token.Pos return __self__.value.pos();
...
class BadStmt_asInterface {
    ...
    **/
    @:keep
    public function _stmtNode():Void __self__.value._stmtNode();
    @:keep
    public function end():stdgo.go.token.Token.Pos return __self__.value.end();
    @:keep
    public function pos():stdgo.go.token.Token.Pos return __self__.value.pos();
...
class ImportSpec_asInterface {
    ...
    **/
    @:keep
    public function _specNode():Void __self__.value._specNode();
    @:keep
    public function end():stdgo.go.token.Token.Pos return __self__.value.end();
    @:keep
    public function pos():stdgo.go.token.Token.Pos return __self__.value.pos();
...
class BadDecl_asInterface {
    ...
    **/
    @:keep
    public function _declNode():Void __self__.value._declNode();
    @:keep
    public function end():stdgo.go.token.Token.Pos return __self__.value.end();
    @:keep
    public function pos():stdgo.go.token.Token.Pos return __self__.value.pos();
...
class T_commentListReader_asInterface {
    ...
    @:keep
    public function _eol():Bool return __self__.value._eol();
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
class T_printer_asInterface {
    @:keep
    public function _print(_x:stdgo.reflect.Reflect.Value):Void __self__.value._print(_x);
    /**
        // printf is a convenience wrapper that takes care of print errors.
    **/
    @:keep
    public function _printf(_format:GoString, _args:haxe.Rest<AnyInterface>):Void __self__.value._printf(_format, ..._args);
    @:keep
        ...
        if (_x.kind() == ((("20" : GoUInt) : stdgo.reflect.Reflect.Kind))) {
            ...
            if (_x.len() > (0 : GoInt)) {
                ...
                for (_8 => _key in _x.mapKeys()) {
                    ...
                    _p._printf((": " : GoString));
                    _p._print((_x.mapIndex((_key == null ? null : _key.__copy__())) == null ? null : _x.mapIndex((_key == null ? null : _key.__copy__())).__copy__()));
                    _p._printf(("\n" : GoString));
                };
                _p._indent--;
            };
...
class T_pkgBuilder_asInterface {
    @:keep
    public function _declare(_scope:Ref<Scope>, _altScope:Ref<Scope>, _obj:Ref<Object>):Void __self__.value._declare(_scope, _altScope, _obj);
    @:keep
    public function _errorf(_pos:stdgo.go.token.Token.Pos, _format:GoString, _args:haxe.Rest<AnyInterface>):Void __self__.value._errorf(_pos, _format, ..._args);
    @:keep
    public function _error(_pos:stdgo.go.token.Token.Pos, _msg:GoString):Void __self__.value._error(_pos, _msg);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
class Scope_asInterface {
    ...
    **/
    @:keep
    public function insert(_obj:Ref<Object>):Ref<Object> return __self__.value.insert(_obj);
    /**
    ...
    **/
    @:keep
    public function lookup(_name:GoString):Ref<Object> return __self__.value.lookup(_name);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
@:keep @:allow(stdgo.go.ast.Ast.Scope_asInterface) class Scope_static_extension {
    ...
    **/
    ...
    static public function string( _s:Ref<Scope>):GoString {
        var _buf:stdgo.strings.Strings.Builder = ({} : stdgo.strings.Strings.Builder);
        stdgo.fmt.Fmt.fprintf(Go.asInterface((_buf : Ref<stdgo.strings.Strings.Builder>)), ("scope %p {" : GoString), Go.toInterface(Go.asInterface(_s)));
        if ((_s != null) && (_s.objects.length > (0 : GoInt))) {
            stdgo.fmt.Fmt.fprintln(Go.asInterface((_buf : Ref<stdgo.strings.Strings.Builder>)));
            for (_0 => _obj in _s.objects) {
                stdgo.fmt.Fmt.fprintf(Go.asInterface((_buf : Ref<stdgo.strings.Strings.Builder>)), ("\t%s %s\n" : GoString), Go.toInterface(Go.asInterface(_obj.kind)), Go.toInterface(_obj.name));
            };
        };
        stdgo.fmt.Fmt.fprintf(Go.asInterface((_buf : Ref<stdgo.strings.Strings.Builder>)), ("}\n" : GoString));
...
class CommentMap_asInterface {
    ...
    **/
    @:keep
    public function comments():Slice<Ref<CommentGroup>> return __self__.value.comments();
    /**
    ...
    **/
    @:keep
    public function filter(_node:Node):CommentMap return __self__.value.filter(_node);
    /**
    ...
    **/
    @:keep
    public function update(_old:Node, _new:Node):Node return __self__.value.update(_old, _new);
    @:keep
    public function _addComment(_n:Node, _c:Ref<CommentGroup>):Void __self__.value._addComment(_n, _c);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
@:keep @:allow(stdgo.go.ast.Ast.CommentMap_asInterface) class CommentMap_static_extension {
    ...
    static public function string( _cmap:CommentMap):GoString {
        ...
        var _buf:stdgo.strings.Strings.Builder = ({} : stdgo.strings.Strings.Builder);
        stdgo.fmt.Fmt.fprintln(Go.asInterface((_buf : Ref<stdgo.strings.Strings.Builder>)), Go.toInterface(("CommentMap {" : GoString)));
        for (_0 => _node in _nodes) {
            ...
            stdgo.fmt.Fmt.fprintf(Go.asInterface((_buf : Ref<stdgo.strings.Strings.Builder>)), ("\t%p  %20s:  %s\n" : GoString), Go.toInterface(_node), Go.toInterface(_s), Go.toInterface(_summary(_comment)));
        };
...
class T_nodeStack_asInterface {
    ...
    **/
    @:keep
    public function _pop(_pos:stdgo.go.token.Token.Pos):Node return __self__.value._pop(_pos);
    /**
        // push pops all nodes that appear lexically before n
        // and then pushes n on the stack.
    **/
    @:keep
    public function _push(_n:Node):Void __self__.value._push(_n);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
class T_inspector_asInterface {
    @:keep
    public function visit(_node:Node):Visitor return __self__.value.visit(_node);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
