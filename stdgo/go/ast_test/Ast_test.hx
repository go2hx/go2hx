...
function testCommentMap(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        for (_n => _list in _cmap) {
            var _key:stdgo.GoString = stdgo.fmt.Fmt.sprintf(("%2d: %T" : stdgo.GoString), stdgo.Go.toInterface(_fset.position(_n.pos()).line), stdgo.Go.toInterface(_n));
            var _got:stdgo.GoString = _ctext(_list);
            var _want:stdgo.GoString = (_res[_key] ?? ("" : stdgo.GoString));
            if (_got != (_want)) {
        ...
        if (false) {
            ...
            for (_n => _list in _cmap) {
                _out = (_out.__append__(stdgo.fmt.Fmt.sprintf(("\t\"%2d: %T\":\t%q," : stdgo.GoString), stdgo.Go.toInterface(_fset.position(_n.pos()).line), stdgo.Go.toInterface(_n), stdgo.Go.toInterface(_ctext(_list)))));
            };
...
function exampleInspect():Void {
        ...
        var _fset = stdgo.go.token.Token.newFileSet();
        var __tmp__ = stdgo.go.parser.Parser.parseFile(_fset, ("src.go" : stdgo.GoString), stdgo.Go.toInterface(_src), (0u32 : stdgo.go.parser.Parser.Mode)), _f:stdgo.StdGoTypes.Ref<stdgo.go.ast.Ast.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
...
function examplePrint():Void {
        var _src:stdgo.GoString = ("\npackage main\nfunc main() {\n\tprintln(\"Hello, World!\")\n}\n" : stdgo.GoString);
        var _fset = stdgo.go.token.Token.newFileSet();
        var __tmp__ = stdgo.go.parser.Parser.parseFile(_fset, stdgo.Go.str(), stdgo.Go.toInterface(_src), (0u32 : stdgo.go.parser.Parser.Mode)), _f:stdgo.StdGoTypes.Ref<stdgo.go.ast.Ast.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            throw stdgo.Go.toInterface(_err);
        };
...
function exampleCommentMap():Void {
        ...
        var _fset = stdgo.go.token.Token.newFileSet();
        var __tmp__ = stdgo.go.parser.Parser.parseFile(_fset, ("src.go" : stdgo.GoString), stdgo.Go.toInterface(_src), (4u32 : stdgo.go.parser.Parser.Mode)), _f:stdgo.StdGoTypes.Ref<stdgo.go.ast.Ast.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            throw stdgo.Go.toInterface(_err);
        };
...
function testFilterDuplicates(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _output:stdgo.GoString = (_buf.string() : stdgo.GoString);
...
function testIssue33649(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _src in (new stdgo.Slice<stdgo.GoString>(4, 4, ("package p; func _()" : stdgo.GoString), ("package p; func _() {" : stdgo.GoString), ("package p; func _() { _ = 0" : stdgo.GoString), ("package p; func _() { _ = 0 }" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) {
            var _fset = stdgo.go.token.Token.newFileSet();
            var __tmp__ = stdgo.go.parser.Parser.parseFile(_fset, stdgo.Go.str(), stdgo.Go.toInterface(_src), (32u32 : stdgo.go.parser.Parser.Mode)), _f:stdgo.StdGoTypes.Ref<stdgo.go.ast.Ast.File> = __tmp__._0, __1:stdgo.Error = __tmp__._1;
...
({ _src : ("/* start of a general comment\n\n// Code generated by tool; DO NOT EDIT.\n\nend of a general comment */\n\n// +build !dev\n\n// Package comment.\npackage p\n\n// Does match even though it\'s inside general comment (/*-style).\n" : stdgo.GoString), _want : true } : T__struct_7)) : stdgo.Slice<T__struct_7>)) {
            var _fset = stdgo.go.token.Token.newFileSet();
            var __tmp__ = stdgo.go.parser.Parser.parseFile(_fset, stdgo.Go.str(), stdgo.Go.toInterface(_test._src), (5u32 : stdgo.go.parser.Parser.Mode)), _f:stdgo.StdGoTypes.Ref<stdgo.go.ast.Ast.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_f == null || (_f : Dynamic).__nil__) {
