...
function testIssue33649(_t:Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _src in (new Slice<GoString>(0, 0, ("package p; func _()" : GoString), ("package p; func _() {" : GoString), ("package p; func _() { _ = 0" : GoString), ("package p; func _() { _ = 0 }" : GoString)) : Slice<GoString>)) {
            var _fset = stdgo.go.token.Token.newFileSet();
