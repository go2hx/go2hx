...
private var _tests:Slice<stdgo.testing.Testing.InternalTest> = (new Slice<stdgo.testing.Testing.InternalTest>(0, 0,
	...
	(new stdgo.testing.Testing.InternalTest(("TestBitLen" : GoString),
		stdgo.go.constant.Constant.testBitLen) : stdgo.testing.Testing.InternalTest)) : Slice<stdgo.testing.Testing.InternalTest>);
...
private var _benchmarks:Slice<stdgo.testing.Testing.InternalBenchmark> = (new Slice<stdgo.testing.Testing.InternalBenchmark>(0, 0,
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkStringAdd" : GoString),
		stdgo.go.constant.Constant.benchmarkStringAdd) : stdgo.testing.Testing.InternalBenchmark)) : Slice<stdgo.testing.Testing.InternalBenchmark>);
...
private var _examples:Slice<stdgo.testing.Testing.InternalExample> = (new Slice<stdgo.testing.Testing.InternalExample>(0, 0,
	(new stdgo.testing.Testing.InternalExample(("Example_complexNumbers" : GoString), stdgo.go.constant_test.Constant_test.example_complexNumbers,
	...
	(new stdgo.testing.Testing.InternalExample(("ExampleBinaryOp" : GoString), stdgo.go.constant_test.Constant_test.exampleBinaryOp, ("22\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleUnaryOp" : GoString), stdgo.go.constant_test.Constant_test.exampleUnaryOp,
		("\nfalse\n-2.7\n65493\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleCompare" : GoString), stdgo.go.constant_test.Constant_test.exampleCompare,
		("\nFrame\nZ\na\nbacon\ndefer\ngo\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleSign" : GoString), stdgo.go.constant_test.Constant_test.exampleSign,
		("\n-1 -1\n-1 (0 + -1i)\n-1 (1 + -1i)\n-1 (-1 + 1i)\n-1 (-1 + -1i)\n 0 0\n 0 (0 + 0i)\n 1 1\n 1 (0 + 1i)\n 1 (1 + 1i)\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleVal" : GoString), stdgo.go.constant_test.Constant_test.exampleVal,
