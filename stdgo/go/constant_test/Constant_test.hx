...
function example_complexNumbers():Void {
        var _ar:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeFloat64((2.3 : GoFloat64));
        var _ai:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeImag(stdgo.go.constant.Constant.makeInt64((5i64 : GoInt64)));
        var _a:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.binaryOp(_ar, (12 : stdgo.go.token.Token.Token), _ai);
        var _b:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeUint64((11i64 : GoUInt64));
        ...
        stdgo.fmt.Fmt.println(Go.toInterface(("literal" : GoString)), Go.toInterface(((25.3f64 : GoFloat64) + new GoComplex128(0f64, 55f64))));
...
function exampleBinaryOp():Void {
        var _a:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeUint64((11i64 : GoUInt64));
        var _b:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeFloat64((0.5 : GoFloat64));
        ...
        for (_i => _v in _vs) {
            {
                ...
                if (__value__ == ((1 : stdgo.go.constant.Constant.Kind))) {
                    _vs[(_i : GoInt)] = stdgo.go.constant.Constant.unaryOp((43 : stdgo.go.token.Token.Token), _v, (0u32 : GoUInt));
                } else if (__value__ == ((4 : stdgo.go.constant.Constant.Kind))) {
                    _vs[(_i : GoInt)] = stdgo.go.constant.Constant.unaryOp((13 : stdgo.go.token.Token.Token), _v, (0u32 : GoUInt));
                } else if (__value__ == ((3 : stdgo.go.constant.Constant.Kind))) {
                    _vs[(_i : GoInt)] = stdgo.go.constant.Constant.unaryOp((19 : stdgo.go.token.Token.Token), _v, (16u32 : GoUInt));
                };
            };
        };
        for (__0 => _v in _vs) {
...
function exampleSign():Void {
        var _zero:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeInt64((0i64 : GoInt64));
        var _one:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeInt64((1i64 : GoInt64));
        var _negOne:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeInt64((-1i64 : GoInt64));
...
_mkComplex(_one, _one)) : Slice<stdgo.go.constant.Constant.Value>);
        for (__0 => _v in _vs) {
...
function exampleVal():Void {
        var _maxint:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeInt64((9223372036854775807i64 : GoInt64));
        stdgo.fmt.Fmt.printf(("%v\n" : GoString), stdgo.go.constant.Constant.val(_maxint));
        var _e:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeFloat64((2.718281828459045 : GoFloat64));
