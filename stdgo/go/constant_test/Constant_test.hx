...
function example_complexNumbers():Void {
        var _ar:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeFloat64((2.3 : stdgo.GoFloat64));
        var _ai:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeImag(stdgo.go.constant.Constant.makeInt64((5i64 : stdgo.GoInt64)));
        var _a:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.binaryOp(_ar, (12 : stdgo.go.token.Token.Token), _ai);
        var _b:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeUint64((11i64 : stdgo.GoUInt64));
        var _c:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.binaryOp(_a, (14 : stdgo.go.token.Token.Token), _b);
        var __tmp__ = stdgo.go.constant.Constant.float64Val(stdgo.go.constant.Constant.real(_c)), ar:stdgo.GoFloat64 = __tmp__._0, _exact:Bool = __tmp__._1;
        if (!_exact) {
        ...
        var __tmp__ = stdgo.go.constant.Constant.float64Val(stdgo.go.constant.Constant.imag(_c)), ai:stdgo.GoFloat64 = __tmp__._0, _exact:Bool = __tmp__._1;
        if (!_exact) {
        ...
        stdgo.fmt.Fmt.println(stdgo.Go.toInterface(("literal" : stdgo.GoString)), stdgo.Go.toInterface(((25.3f64 : stdgo.GoFloat64) + new stdgo.GoComplex128(0f64, 55f64))));
...
function exampleBinaryOp():Void {
        var _a:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeUint64((11i64 : stdgo.GoUInt64));
        var _b:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeFloat64((0.5 : stdgo.GoFloat64));
...
function exampleUnaryOp():Void {
        var _vs = (new stdgo.Slice<stdgo.go.constant.Constant.Value>(3, 3, stdgo.go.constant.Constant.makeBool(true), stdgo.go.constant.Constant.makeFloat64((2.7 : stdgo.GoFloat64)), stdgo.go.constant.Constant.makeUint64((42i64 : stdgo.GoUInt64))) : stdgo.Slice<stdgo.go.constant.Constant.Value>);
        for (_i => _v in _vs) {
            {
                final __value__ = _v.kind();
                if (__value__ == ((1 : stdgo.go.constant.Constant.Kind))) {
                    _vs[(_i : stdgo.GoInt)] = stdgo.go.constant.Constant.unaryOp((43 : stdgo.go.token.Token.Token), _v, (0u32 : stdgo.GoUInt));
                } else if (__value__ == ((4 : stdgo.go.constant.Constant.Kind))) {
                    _vs[(_i : stdgo.GoInt)] = stdgo.go.constant.Constant.unaryOp((13 : stdgo.go.token.Token.Token), _v, (0u32 : stdgo.GoUInt));
                } else if (__value__ == ((3 : stdgo.go.constant.Constant.Kind))) {
                    _vs[(_i : stdgo.GoInt)] = stdgo.go.constant.Constant.unaryOp((19 : stdgo.go.token.Token.Token), _v, (16u32 : stdgo.GoUInt));
                };
            };
        };
        for (__0 => _v in _vs) {
...
function exampleSign():Void {
        var _zero:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeInt64((0i64 : stdgo.GoInt64));
        var _one:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeInt64((1i64 : stdgo.GoInt64));
        var _negOne:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeInt64((-1i64 : stdgo.GoInt64));
...
function exampleVal():Void {
        var _maxint:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeInt64((9223372036854775807i64 : stdgo.GoInt64));
        stdgo.fmt.Fmt.printf(("%v\n" : stdgo.GoString), stdgo.go.constant.Constant.val(_maxint));
        var _e:stdgo.go.constant.Constant.Value = stdgo.go.constant.Constant.makeFloat64((2.718281828459045 : stdgo.GoFloat64));
