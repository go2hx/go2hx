...
@:structInit @:private @:using(stdgo.go.importer.Importer.T_gcimports_static_extension) class T_gcimports {
    ...
    public var _packages : stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.go.types.Types.Package>> = (null : stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.go.types.Types.Package>>);
    public var _lookup : stdgo.go.importer.Importer.Lookup = (null : stdgo.go.importer.Importer.Lookup);
    public function new(?_fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, ?_packages:stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.go.types.Types.Package>>, ?_lookup:stdgo.go.importer.Importer.Lookup) {
...
@:structInit @:private @:using(stdgo.go.importer.Importer.T_gccgoimports_static_extension) class T_gccgoimports {
    ...
    public var _lookup : stdgo.go.importer.Importer.Lookup = (null : stdgo.go.importer.Importer.Lookup);
    public function new(?_packages:stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.go.types.Types.Package>>, ?_importer:stdgo.go.internal.gccgoimporter.Gccgoimporter.Importer, ?_lookup:stdgo.go.importer.Importer.Lookup) {
        if (_packages != null) this._packages = _packages;
...
**/
function forCompiler(_fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, _compiler:stdgo.GoString, _lookup:Lookup):stdgo.go.types.Types.Importer {
        {
            ...
            if (__value__ == (("gc" : stdgo.GoString))) {
                return stdgo.Go.asInterface((stdgo.Go.setRef(({ _fset : _fset, _packages : ({
                    ...
                    @:mergeBlock {};
                    x;
                } : stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.go.types.Types.Package>>), _lookup : _lookup } : stdgo.go.importer.Importer.T_gcimports)) : stdgo.Ref<stdgo.go.importer.Importer.T_gcimports>));
                ...
                return stdgo.Go.asInterface((stdgo.Go.setRef(({ _packages : ({
                    ...
                    @:mergeBlock {};
                    x;
                } : stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.go.types.Types.Package>>), _importer : _inst.getImporter((null : stdgo.Slice<stdgo.GoString>), (null : stdgo.GoMap<stdgo.Ref<stdgo.go.types.Types.Package>, stdgo.go.internal.gccgoimporter.Gccgoimporter.InitData>)), _lookup : _lookup } : stdgo.go.importer.Importer.T_gccgoimports)) : stdgo.Ref<stdgo.go.importer.Importer.T_gccgoimports>));
                ...
                return stdgo.Go.asInterface(stdgo.go.internal.srcimporter.Srcimporter.new_((stdgo.Go.setRef(stdgo.go.build.Build.default_) : stdgo.Ref<stdgo.go.build.Build.Context>), _fset, ({
                    final x = new stdgo.GoMap.GoStringMap<stdgo.Ref<stdgo.go.types.Types.Package>>();
                    x.__defaultValue__ = () -> (null : stdgo.Ref<stdgo.go.types.Types.Package>);
                    @:mergeBlock {};
                    x;
...
function testForCompiler(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        stdgo.internal.testenv.Testenv.mustHaveGoBuild(stdgo.Go.asInterface(_t));
        {};
        var __tmp__ = stdgo.internal.testenv.Testenv.command(stdgo.Go.asInterface(_t), stdgo.internal.testenv.Testenv.goToolPath(stdgo.Go.asInterface(_t))?.__copy__(), ("list" : stdgo.GoString), ("-export" : stdgo.GoString), ("-f={{context.Compiler}}:{{.Export}}" : stdgo.GoString), ("math/big" : stdgo.GoString)).combinedOutput(), _out:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
        ...
        _t.run(("LookupDefault" : stdgo.GoString), function(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
            var _imp:stdgo.go.types.Types.Importer = forCompiler(_fset, _compiler?.__copy__(), null);
            var __tmp__ = _imp.import_(("math/big" : stdgo.GoString)), _pkg:stdgo.Ref<stdgo.go.types.Types.Package> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
            ...
            var _filename:stdgo.GoString = stdgo.strings.Strings.replace(_posn.filename?.__copy__(), ("$GOROOT" : stdgo.GoString), stdgo.internal.testenv.Testenv.goroot(stdgo.Go.asInterface(_t))?.__copy__(), (1 : stdgo.GoInt))?.__copy__();
            var __tmp__ = stdgo.os.Os.readFile(_filename?.__copy__()), _data:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
            ...
            if ((_posn.line > _lines.length) || !stdgo.strings.Strings.hasPrefix(_lines[(_posn.line - (1 : stdgo.GoInt) : stdgo.GoInt)]?.__copy__(), ("type Int" : stdgo.GoString))) {
        ...
        _t.run(("LookupCustom" : stdgo.GoString), function(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
            if (true) {
            ...
            var _lookup:stdgo.GoString -> { var _0 : stdgo.io.Io.ReadCloser; var _1 : stdgo.Error; } = function(_path:stdgo.GoString):{ var _0 : stdgo.io.Io.ReadCloser; var _1 : stdgo.Error; } {
                ...
                var __tmp__ = stdgo.os.Os.open(_target?.__copy__()), _f:stdgo.Ref<stdgo.os.Os.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    _t.fatal(stdgo.Go.toInterface(_err));
                };
            ...
            var __tmp__ = _imp.import_(("math/bigger" : stdgo.GoString)), _pkg:stdgo.Ref<stdgo.go.types.Types.Package> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                _t.fatal(stdgo.Go.toInterface(_err));
            };
...
class T_gcimports_asInterface {
    @:keep
    public dynamic function importFrom(_path:stdgo.GoString, _srcDir:stdgo.GoString, _mode:stdgo.go.types.Types.ImportMode):{ var _0 : stdgo.Ref<stdgo.go.types.Types.Package>; var _1 : stdgo.Error; } return __self__.value.importFrom(_path, _srcDir, _mode);
    @:keep
    public dynamic function import_(_path:stdgo.GoString):{ var _0 : stdgo.Ref<stdgo.go.types.Types.Package>; var _1 : stdgo.Error; } return __self__.value.import_(_path);
...
@:keep @:allow(stdgo.go.importer.Importer.T_gcimports_asInterface) class T_gcimports_static_extension {
    @:keep
    static public function importFrom( _m:stdgo.Ref<T_gcimports>, _path:stdgo.GoString, _srcDir:stdgo.GoString, _mode:stdgo.go.types.Types.ImportMode):{ var _0 : stdgo.Ref<stdgo.go.types.Types.Package>; var _1 : stdgo.Error; } {
    ...
    @:keep
    static public function import_( _m:stdgo.Ref<T_gcimports>, _path:stdgo.GoString):{ var _0 : stdgo.Ref<stdgo.go.types.Types.Package>; var _1 : stdgo.Error; } {
        @:recv var _m:stdgo.Ref<T_gcimports> = _m;
...
@:keep @:allow(stdgo.go.importer.Importer.T_gccgoimports_asInterface) class T_gccgoimports_static_extension {
    @:keep
    static public function importFrom( _m:stdgo.Ref<T_gccgoimports>, _path:stdgo.GoString, _srcDir:stdgo.GoString, _mode:stdgo.go.types.Types.ImportMode):{ var _0 : stdgo.Ref<stdgo.go.types.Types.Package>; var _1 : stdgo.Error; } {
    ...
    @:keep
    static public function import_( _m:stdgo.Ref<T_gccgoimports>, _path:stdgo.GoString):{ var _0 : stdgo.Ref<stdgo.go.types.Types.Package>; var _1 : stdgo.Error; } {
        @:recv var _m:stdgo.Ref<T_gccgoimports> = _m;
        return _m.importFrom(_path?.__copy__(), stdgo.Go.str()?.__copy__(), (0 : stdgo.go.types.Types.ImportMode));
    }
}
