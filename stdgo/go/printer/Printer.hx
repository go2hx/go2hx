...
**/
var _fileNode : stdgo.Ref<stdgo.go.ast.Ast.File> = (null : stdgo.Ref<stdgo.go.ast.Ast.File>);
/**
...
@:structInit @:private class T_commentInfo {
    ...
    public function new(?_cindex:stdgo.GoInt, ?_comment:stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>, ?_commentOffset:stdgo.GoInt, ?_commentNewline:Bool) {
...
@:structInit @:private @:using(stdgo.go.printer.Printer.T_printer_static_extension) class T_printer {
    ...
    **/
    ...
    public var _mode : stdgo.go.printer.Printer.T_pmode = ((0 : stdgo.GoInt) : stdgo.go.printer.Printer.T_pmode);
    public var _endAlignment : Bool = false;
    public var _impliedSemi : Bool = false;
    public var _lastTok : stdgo.go.token.Token.Token = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Token);
    public var _prevOpen : stdgo.go.token.Token.Token = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Token);
    ...
    **/
    public var _comments : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>> = (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>);
    ...
    **/
    public var _nodeSizes : stdgo.GoMap<stdgo.go.ast.Ast.Node, stdgo.GoInt> = (null : stdgo.GoMap<stdgo.go.ast.Ast.Node, stdgo.GoInt>);
    /**
        // Cache of most recently computed line position.
    **/
    public var _cachedPos : stdgo.go.token.Token.Pos = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Pos);
    public var _cachedLine : stdgo.GoInt = 0;
    public function new(?config:stdgo.go.printer.Printer.Config, ?_fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, ?_output:stdgo.Slice<stdgo.GoUInt8>, ?_indent:stdgo.GoInt, ?_level:stdgo.GoInt, ?_mode:stdgo.go.printer.Printer.T_pmode, ?_endAlignment:Bool, ?_impliedSemi:Bool, ?_lastTok:stdgo.go.token.Token.Token, ?_prevOpen:stdgo.go.token.Token.Token, ?_wsbuf:stdgo.Slice<stdgo.go.printer.Printer.T_whiteSpace>, ?_goBuild:stdgo.Slice<stdgo.GoInt>, ?_plusBuild:stdgo.Slice<stdgo.GoInt>, ?_pos:stdgo.go.token.Token.Position, ?_out:stdgo.go.token.Token.Position, ?_last:stdgo.go.token.Token.Position, ?_linePtr:stdgo.Pointer<stdgo.GoInt>, ?_sourcePosErr:stdgo.Error, ?_comments:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>, ?_useNodeComments:Bool, ?_commentInfo:stdgo.go.printer.Printer.T_commentInfo, ?_nodeSizes:stdgo.GoMap<stdgo.go.ast.Ast.Node, stdgo.GoInt>, ?_cachedPos:stdgo.go.token.Token.Pos, ?_cachedLine:stdgo.GoInt) {
    ...
    public function __underlying__() return stdgo.Go.toInterface(this);
    @:embedded
    public function fprint(_output:stdgo.io.Io.Writer, _fset_:stdgo.Ref<stdgo.go.token.Token.FileSet>, _node:stdgo.AnyInterface):stdgo.Error return config.fprint(_output, _fset_, _node);
    @:embedded
    public function _fprint(_output:stdgo.io.Io.Writer, _fset_:stdgo.Ref<stdgo.go.token.Token.FileSet>, _node:stdgo.AnyInterface, _nodeSizes:stdgo.GoMap<stdgo.go.ast.Ast.Node, stdgo.GoInt>):stdgo.Error return config._fprint(_output, _fset_, _node, _nodeSizes);
    public function __copy__() {
...
@:structInit @:private @:using(stdgo.go.printer.Printer.T_trimmer_static_extension) class T_trimmer {
    ...
    public function new(?_output:stdgo.io.Io.Writer, ?_state:stdgo.GoInt, ?_space:stdgo.Slice<stdgo.GoUInt8>) {
        if (_output != null) this._output = _output;
...
@:structInit @:using(stdgo.go.printer.Printer.Config_static_extension) class Config {
    public var mode : stdgo.go.printer.Printer.Mode = ((0 : stdgo.GoUInt) : stdgo.go.printer.Printer.Mode);
    public var tabwidth : stdgo.GoInt = 0;
    public var indent : stdgo.GoInt = 0;
    public function new(?mode:stdgo.go.printer.Printer.Mode, ?tabwidth:stdgo.GoInt, ?indent:stdgo.GoInt) {
...
@:structInit class CommentedNode {
    ...
    public function new(?node:stdgo.AnyInterface, ?comments:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>) {
...
@:structInit @:private class T_entry {
    ...
    public var _mode : stdgo.go.printer.Printer.T_checkMode = ((0 : stdgo.GoUInt) : stdgo.go.printer.Printer.T_checkMode);
...
@:named @:using(stdgo.go.printer.Printer.T_visitor_static_extension) typedef T_visitor = stdgo.Chan<stdgo.Ref<stdgo.go.ast.Ast.Ident>>;
/**
    // formatDocComment reformats the doc comment list,
    // returning the canonical formatting.
**/
function _formatDocComment(_list:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Comment>>):stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Comment>> {
        ...
        var _directives:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Comment>> = (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Comment>>);
        if ((_list.length == (1 : stdgo.GoInt)) && stdgo.strings.Strings.hasPrefix(_list[(0 : stdgo.GoInt)].text?.__copy__(), ("/*" : stdgo.GoString))) {
            ...
            _text = (_text.__slice__((2 : stdgo.GoInt), (_text.length) - (2 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
        } else if (stdgo.strings.Strings.hasPrefix(_list[(0 : stdgo.GoInt)].text?.__copy__(), ("//" : stdgo.GoString))) {
            _kind = ("//" : stdgo.GoString);
        ...
        var _slash:stdgo.go.token.Token.Pos = _list[(0 : stdgo.GoInt)].slash;
        if (_kind == (("/*" : stdgo.GoString))) {
            var _c = (stdgo.Go.setRef(({ slash : _slash, text : ("/*\n" : stdgo.GoString) + _text?.__copy__() + ("*/" : stdgo.GoString)?.__copy__()?.__copy__() } : stdgo.go.ast.Ast.Comment)) : stdgo.Ref<stdgo.go.ast.Ast.Comment>);
            return (new stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Comment>>(1, 1, _c) : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Comment>>);
        };
        var _out:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Comment>> = (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Comment>>);
        while (_text != (stdgo.Go.str())) {
            ...
            _out = (_out.__append__((stdgo.Go.setRef(({ slash : _slash, text : _line?.__copy__() } : stdgo.go.ast.Ast.Comment)) : stdgo.Ref<stdgo.go.ast.Ast.Comment>)));
        };
        if ((_directives.length) > (0 : stdgo.GoInt)) {
            _out = (_out.__append__((stdgo.Go.setRef(({ slash : _slash, text : ("//" : stdgo.GoString) } : stdgo.go.ast.Ast.Comment)) : stdgo.Ref<stdgo.go.ast.Ast.Comment>)));
            for (__1 => _c in _directives) {
                _out = (_out.__append__((stdgo.Go.setRef(({ slash : _slash, text : _c.text?.__copy__() } : stdgo.go.ast.Ast.Comment)) : stdgo.Ref<stdgo.go.ast.Ast.Comment>)));
            };
        };
        return _out;
    }
...
function _allStars(_text:stdgo.GoString):Bool {
        {
            ...
            stdgo.Go.cfor(_i < (_text.length), _i++, {
                if (_text[(_i : stdgo.GoInt)] == ((10 : stdgo.GoUInt8))) {
                    ...
                    while ((_j < _text.length) && ((_text[(_j : stdgo.GoInt)] == (32 : stdgo.GoUInt8)) || (_text[(_j : stdgo.GoInt)] == (9 : stdgo.GoUInt8)))) {
                        _j++;
                    };
                    if ((_j < _text.length) && (_text[(_j : stdgo.GoInt)] != (42 : stdgo.GoUInt8))) {
                        return false;
                    };
                };
            });
...
function _appendLines(_x:stdgo.Slice<stdgo.GoByte>, _y:stdgo.Slice<stdgo.GoByte>):stdgo.Slice<stdgo.GoByte> {
        if (((_y.length > (0 : stdgo.GoInt)) && _isNL(_y[(0 : stdgo.GoInt)])) && ((_x.length == (0 : stdgo.GoInt)) || (((_x.length >= (2 : stdgo.GoInt)) && _isNL(_x[((_x.length) - (1 : stdgo.GoInt) : stdgo.GoInt)])) && _isNL(_x[((_x.length) - (2 : stdgo.GoInt) : stdgo.GoInt)])))) {
...
function _isNL(_b:stdgo.GoByte):Bool {
        return (_b == (10 : stdgo.GoUInt8)) || (_b == (12 : stdgo.GoUInt8));
    }
/**
...
function _combinesWithName(_x:stdgo.go.ast.Ast.Expr):Bool {
        {
            final __type__ = _x;
            if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo.go.ast.Ast.StarExpr>))) {
...
function _identListSize(_list:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Ident>>, _maxSize:stdgo.GoInt):stdgo.GoInt {
...
function _walkBinary(_e:stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr>):{ var _0 : Bool; var _1 : Bool; var _2 : stdgo.GoInt; } {
            ...
            final __type__ = _e.x;
            {
                ...
                while (__bool__) {
                    ...
                    if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr>))) {
                        var _l:stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr>) : __type__.__underlying__().value;
        ...
        };
        {
            final __type__ = _e.y;
            {
                ...
                while (__bool__) {
                    __bool__ = false;
                    if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr>))) {
                        var _r:stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr>) : __type__.__underlying__().value;
                        ...
                        var _r:stdgo.Ref<stdgo.go.ast.Ast.StarExpr> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.StarExpr>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.StarExpr>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.StarExpr>) : __type__.__underlying__().value;
                        if (_e.op == ((15 : stdgo.go.token.Token.Token))) {
                            _maxProblem = (5 : stdgo.GoInt);
                        };
                    } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo.go.ast.Ast.UnaryExpr>))) {
                        var _r:stdgo.Ref<stdgo.go.ast.Ast.UnaryExpr> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.UnaryExpr>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.UnaryExpr>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.UnaryExpr>) : __type__.__underlying__().value;
                        {
...
function _cutoff(_e:stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr>, _depth:stdgo.GoInt):stdgo.GoInt {
        var __tmp__ = _walkBinary(_e), _has4:Bool = __tmp__._0, _has5:Bool = __tmp__._1, _maxProblem:stdgo.GoInt = __tmp__._2;
        if (_maxProblem > (0 : stdgo.GoInt)) {
            return _maxProblem + (1 : stdgo.GoInt);
        };
        if (_has4 && _has5) {
...
function _diffPrec(_expr:stdgo.go.ast.Ast.Expr, _prec:stdgo.GoInt):stdgo.GoInt {
        var __tmp__ = try {
            { _0 : (stdgo.Go.typeAssert((stdgo.Go.toInterface(_expr) : stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr>)) : stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr>), _1 : true };
        } catch(_) {
...
**/
function _normalizedNumber(_lit:stdgo.Ref<stdgo.go.ast.Ast.BasicLit>):stdgo.Ref<stdgo.go.ast.Ast.BasicLit> {
        if (((_lit.kind != (5 : stdgo.go.token.Token.Token)) && (_lit.kind != (6 : stdgo.go.token.Token.Token))) && (_lit.kind != (7 : stdgo.go.token.Token.Token))) {
            return _lit;
        };
        if ((_lit.value.length) < (2 : stdgo.GoInt)) {
            return _lit;
        };
            ...
            while (__run__) {
                __run__ = false;
                {
                    ...
                    if (__value__ == (("0X" : stdgo.GoString))) {
                        _x = ("0x" : stdgo.GoString) + (_x.__slice__((2 : stdgo.GoInt)) : stdgo.GoString)?.__copy__()?.__copy__();
                        {
                            var _i:stdgo.GoInt = stdgo.strings.Strings.lastIndexByte(_x?.__copy__(), (80 : stdgo.GoUInt8));
                            if (_i >= (0 : stdgo.GoInt)) {
                                _x = (_x.__slice__(0, _i) : stdgo.GoString) + ("p" : stdgo.GoString)?.__copy__() + (_x.__slice__(_i + (1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__()?.__copy__();
                            };
                        };
                        break;
                        ...
                        _x = ("0o" : stdgo.GoString) + (_x.__slice__((2 : stdgo.GoInt)) : stdgo.GoString)?.__copy__()?.__copy__();
                        break;
                    } else if (__value__ == (("0o" : stdgo.GoString))) {
                        return _lit;
                        break;
                    } else if (__value__ == (("0B" : stdgo.GoString))) {
                        _x = ("0b" : stdgo.GoString) + (_x.__slice__((2 : stdgo.GoInt)) : stdgo.GoString)?.__copy__()?.__copy__();
                        break;
                    } else if (__value__ == (("0b" : stdgo.GoString))) {
                        return _lit;
                        break;
                        ...
                        {
                            var _i:stdgo.GoInt = stdgo.strings.Strings.lastIndexByte(_x?.__copy__(), (69 : stdgo.GoUInt8));
                            if (_i >= (0 : stdgo.GoInt)) {
                                _x = (_x.__slice__(0, _i) : stdgo.GoString) + ("e" : stdgo.GoString)?.__copy__() + (_x.__slice__(_i + (1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__()?.__copy__();
                                break;
                            };
                        };
                        if ((_x[((_x.length) - (1 : stdgo.GoInt) : stdgo.GoInt)] == (105 : stdgo.GoUInt8)) && !stdgo.strings.Strings.containsAny(_x?.__copy__(), (".e" : stdgo.GoString))) {
        ...
        return (stdgo.Go.setRef(({ valuePos : _lit.valuePos, kind : _lit.kind, value : _x?.__copy__() } : stdgo.go.ast.Ast.BasicLit)) : stdgo.Ref<stdgo.go.ast.Ast.BasicLit>);
    }
...
function _keepTypeColumn(_specs:stdgo.Slice<stdgo.go.ast.Ast.Spec>):stdgo.Slice<Bool> {
        var _m = new stdgo.Slice<Bool>((_specs.length : stdgo.GoInt).toBasic(), 0);
        ...
        for (_i => _s in _specs) {
            var _t = (stdgo.Go.typeAssert((stdgo.Go.toInterface(_s) : stdgo.Ref<stdgo.go.ast.Ast.ValueSpec>)) : stdgo.Ref<stdgo.go.ast.Ast.ValueSpec>);
            if (_t.values != null) {
                if (_i0 < (0 : stdgo.GoInt)) {
                    _i0 = _i;
                    _keepType = false;
                };
            } else {
...
function _sanitizeImportPath(_lit:stdgo.Ref<stdgo.go.ast.Ast.BasicLit>):stdgo.Ref<stdgo.go.ast.Ast.BasicLit> {
        ...
        return (stdgo.Go.setRef(({ valuePos : _lit.valuePos, kind : (9 : stdgo.go.token.Token.Token), value : _s?.__copy__() } : stdgo.go.ast.Ast.BasicLit)) : stdgo.Ref<stdgo.go.ast.Ast.BasicLit>);
    }
function _declToken(_decl:stdgo.go.ast.Ast.Decl):stdgo.go.token.Token.Token {
        var _tok:stdgo.go.token.Token.Token = ((0 : stdgo.GoInt) : stdgo.go.token.Token.Token);
        _tok = (0 : stdgo.go.token.Token.Token);
        {
            final __type__ = _decl;
            if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo.go.ast.Ast.GenDecl>))) {
...
function _testprint(_out:stdgo.io.Io.Writer, _node:stdgo.go.ast.Ast.Node):Void {
        {
            var _err:stdgo.Error = (stdgo.Go.setRef((new stdgo.go.printer.Printer.Config((1073741830u32 : stdgo.go.printer.Printer.Mode), (8 : stdgo.GoInt), (0 : stdgo.GoInt)) : stdgo.go.printer.Printer.Config)) : stdgo.Ref<stdgo.go.printer.Printer.Config>).fprint(_out, _fset, stdgo.Go.toInterface(_node));
            if (_err != null) {
...
function _initialize():Void {
        {};
        var __tmp__ = stdgo.os.Os.readFile(("testdata/parser.go" : stdgo.GoString)), _src:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            stdgo.log.Log.fatalf(("%s" : stdgo.GoString), stdgo.Go.toInterface(_err));
        };
        var __tmp__ = stdgo.go.parser.Parser.parseFile(_fset, ("testdata/parser.go" : stdgo.GoString), stdgo.Go.toInterface(_src), (4u32 : stdgo.go.parser.Parser.Mode)), _file:stdgo.Ref<stdgo.go.ast.Ast.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            stdgo.log.Log.fatalf(("%s" : stdgo.GoString), stdgo.Go.toInterface(_err));
        };
        var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        _testprint(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), stdgo.Go.asInterface(_file));
        ...
        for (__0 => _decl in _file.decls) {
            {
                ...
                if (_ok && (_decl.tok == (85 : stdgo.go.token.Token.Token))) {
                    ...
                    _declSize = (_fset.position(_decl.end()).offset - _fset.position(_decl.pos()).offset : stdgo.GoInt64);
                    break;
                };
            };
        };
    }
function benchmarkPrintFile(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
...
function benchmarkPrintDecl(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        if (_declNode == null) {
            _initialize();
        };
        _b.reportAllocs();
...
function _commonPrefix(_a:stdgo.GoString, _b:stdgo.GoString):stdgo.GoString {
        var _i:stdgo.GoInt = (0 : stdgo.GoInt);
        while ((((_i < _a.length) && (_i < _b.length)) && (_a[(_i : stdgo.GoInt)] == _b[(_i : stdgo.GoInt)])) && ((_a[(_i : stdgo.GoInt)] <= (32 : stdgo.GoUInt8)) || (_a[(_i : stdgo.GoInt)] == (42 : stdgo.GoUInt8)))) {
            _i++;
        };
...
function _stripCommonPrefix(_lines:stdgo.Slice<stdgo.GoString>):Void {
        if ((_lines.length) <= (1 : stdgo.GoInt)) {
            return;
        };
        var _prefix:stdgo.GoString = stdgo.Go.str()?.__copy__();
        var _prefixSet:Bool = false;
        if ((_lines.length) > (2 : stdgo.GoInt)) {
            for (_i => _line in (_lines.__slice__((1 : stdgo.GoInt), (_lines.length) - (1 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoString>)) {
            ...
            if (_ok) {
                ...
                if (_isBlank((_first.__slice__((2 : stdgo.GoInt)) : stdgo.GoString)?.__copy__())) {
                    var _i:stdgo.GoInt = (_prefix.length);
                    {
                        ...
                        stdgo.Go.cfor(((_n < (3 : stdgo.GoInt)) && (_i > (0 : stdgo.GoInt))) && (_prefix[(_i - (1 : stdgo.GoInt) : stdgo.GoInt)] == (32 : stdgo.GoUInt8)), _n++, {
                            _i--;
                        });
                    };
                    if (((_i == (_prefix.length)) && (_i > (0 : stdgo.GoInt))) && (_prefix[(_i - (1 : stdgo.GoInt) : stdgo.GoInt)] == (9 : stdgo.GoUInt8))) {
                        _i--;
                    };
                    _prefix = (_prefix.__slice__((0 : stdgo.GoInt), _i) : stdgo.GoString)?.__copy__();
                } else {
                    var _suffix = new stdgo.Slice<stdgo.GoUInt8>((_first.length : stdgo.GoInt).toBasic(), 0).__setNumber32__();
                    var _n:stdgo.GoInt = (2 : stdgo.GoInt);
                    while ((_n < _first.length) && (_first[(_n : stdgo.GoInt)] <= (32 : stdgo.GoUInt8))) {
                        _suffix[(_n : stdgo.GoInt)] = _first[(_n : stdgo.GoInt)];
                        _n++;
                    };
                    if ((_n > (2 : stdgo.GoInt)) && (_suffix[(2 : stdgo.GoInt)] == (9 : stdgo.GoUInt8))) {
                    ...
                    } else {
                        {
                            ...
                            _suffix[(0 : stdgo.GoInt)] = __tmp__0;
                            _suffix[(1 : stdgo.GoInt)] = __tmp__1;
                        };
        ...
        if (_isBlank(_before?.__copy__())) {
            ...
            _lines[((_lines.length) - (1 : stdgo.GoInt) : stdgo.GoInt)] = _prefix + _closing?.__copy__()?.__copy__();
        } else {
            _prefix = _commonPrefix(_prefix?.__copy__(), _last?.__copy__())?.__copy__();
        };
        for (_i => _line in _lines) {
            if ((_i > (0 : stdgo.GoInt)) && (_line != stdgo.Go.str())) {
...
function _mayCombine(_prev:stdgo.go.token.Token.Token, _next:stdgo.GoByte):Bool {
        var _b:Bool = false;
        {
            ...
            if (__value__ == ((5 : stdgo.go.token.Token.Token))) {
                ...
                _b = (_next == (45 : stdgo.GoUInt8)) || (_next == (60 : stdgo.GoUInt8));
            } else if (__value__ == ((17 : stdgo.go.token.Token.Token))) {
                _b = (_next == (38 : stdgo.GoUInt8)) || (_next == (94 : stdgo.GoUInt8));
            };
        };
        return _b;
    }
...
**/
function _getDoc(_n:stdgo.go.ast.Ast.Node):stdgo.Ref<stdgo.go.ast.Ast.CommentGroup> {
        {
            final __type__ = _n;
            if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo.go.ast.Ast.Field>))) {
                ...
                return _n.doc;
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo.go.ast.Ast.ImportSpec>))) {
                ...
                return _n.doc;
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo.go.ast.Ast.File>))) {
...
function _getLastComment(_n:stdgo.go.ast.Ast.Node):stdgo.Ref<stdgo.go.ast.Ast.CommentGroup> {
        {
            final __type__ = _n;
            if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo.go.ast.Ast.Field>))) {
                var _n:stdgo.Ref<stdgo.go.ast.Ast.Field> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Field>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Field>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.Field>) : __type__.__underlying__().value;
...
function _newPrinter(_cfg:stdgo.Ref<Config>, _fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, _nodeSizes:stdgo.GoMap<stdgo.go.ast.Ast.Node, stdgo.GoInt>):stdgo.Ref<T_printer> {
        var _p = (stdgo.Go.typeAssert((_printerPool.get() : stdgo.Ref<T_printer>)) : stdgo.Ref<T_printer>);
        {
            var __tmp__ = ({ config : (_cfg : stdgo.go.printer.Printer.Config)?.__copy__(), _fset : _fset, _output : (_p._output.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>), _wsbuf : (_p._wsbuf.__slice__(0, (0 : stdgo.GoInt)) : stdgo.Slice<stdgo.go.printer.Printer.T_whiteSpace>), _pos : ({ line : (1 : stdgo.GoInt), column : (1 : stdgo.GoInt) } : stdgo.go.token.Token.Position), _out : ({ line : (1 : stdgo.GoInt), column : (1 : stdgo.GoInt) } : stdgo.go.token.Token.Position), _nodeSizes : _nodeSizes, _cachedPos : (-1 : stdgo.go.token.Token.Pos) } : stdgo.go.printer.Printer.T_printer);
...
**/
function fprint(_output:stdgo.io.Io.Writer, _fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, _node:stdgo.AnyInterface):stdgo.Error {
        return (stdgo.Go.setRef(({ tabwidth : (8 : stdgo.GoInt) } : stdgo.go.printer.Printer.Config)) : stdgo.Ref<stdgo.go.printer.Printer.Config>).fprint(_output, _fset, _node);
    }
/**
...
function _format(_src:stdgo.Slice<stdgo.GoByte>, _mode:T_checkMode):{ var _0 : stdgo.Slice<stdgo.GoByte>; var _1 : stdgo.Error; } {
        var __tmp__ = stdgo.go.parser.Parser.parseFile(_fset, stdgo.Go.str()?.__copy__(), stdgo.Go.toInterface(_src), (4u32 : stdgo.go.parser.Parser.Mode)), _f:stdgo.Ref<stdgo.go.ast.Ast.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : (null : stdgo.Slice<stdgo.GoUInt8>), _1 : stdgo.fmt.Fmt.errorf(("parse: %s\n%s" : stdgo.GoString), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(_src)) };
        };
        if (_mode & (1u32 : stdgo.go.printer.Printer.T_checkMode) != ((0u32 : stdgo.go.printer.Printer.T_checkMode))) {
            ...
            _f.comments = (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>);
        };
        var _cfg:stdgo.go.printer.Printer.Config = ({ tabwidth : (8 : stdgo.GoInt) } : stdgo.go.printer.Printer.Config);
        ...
        var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        {
            var _err:stdgo.Error = _cfg.fprint(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), _fset, stdgo.Go.toInterface(stdgo.Go.asInterface(_f)));
            if (_err != null) {
                return { _0 : (null : stdgo.Slice<stdgo.GoUInt8>), _1 : stdgo.fmt.Fmt.errorf(("print: %s" : stdgo.GoString), stdgo.Go.toInterface(_err)) };
            };
        };
        var _res = _buf.bytes();
        {
            var __tmp__ = stdgo.go.parser.Parser.parseFile(_fset, stdgo.Go.str()?.__copy__(), stdgo.Go.toInterface(_res), (4u32 : stdgo.go.parser.Parser.Mode)), __0:stdgo.Ref<stdgo.go.ast.Ast.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return { _0 : (null : stdgo.Slice<stdgo.GoUInt8>), _1 : stdgo.fmt.Fmt.errorf(("re-parse: %s\n%s" : stdgo.GoString), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(_buf.bytes())) };
            };
        };
...
function _lineAt(_text:stdgo.Slice<stdgo.GoByte>, _offs:stdgo.GoInt):stdgo.Slice<stdgo.GoByte> {
        ...
        while ((_i < _text.length) && (_text[(_i : stdgo.GoInt)] != (10 : stdgo.GoUInt8))) {
            _i++;
        };
...
function _runcheck(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _source:stdgo.GoString, _golden:stdgo.GoString, _mode:T_checkMode):Void {
        var __tmp__ = stdgo.os.Os.readFile(_source?.__copy__()), _src:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
        ...
        var __tmp__ = stdgo.os.Os.readFile(_golden?.__copy__()), _gld:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _t.error(stdgo.Go.toInterface(_err));
            return;
        };
...
function _check(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _source:stdgo.GoString, _golden:stdgo.GoString, _mode:T_checkMode):Void {
        var _cc = new stdgo.Chan<stdgo.GoInt>((1 : stdgo.GoInt).toBasic(), () -> (0 : stdgo.GoInt));
        stdgo.Go.routine(() -> {
            var a = function():Void {
...
function testFiles(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        for (__0 => _e in _data) {
            ...
            _t.run(_e._source?.__copy__(), function(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
                _t.parallel();
...
**/
function testLineComments(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
        ...
        fprint(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), _fset, stdgo.Go.toInterface(stdgo.Go.asInterface(_f)));
...
**/
function testBadNodes(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
        {};
...
**/
function _testComment(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _f:stdgo.Ref<stdgo.go.ast.Ast.File>, _srclen:stdgo.GoInt, _comment:stdgo.Ref<stdgo.go.ast.Ast.Comment>):Void {
        ...
        var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        {
            ...
            stdgo.Go.cfor(_offs <= _srclen, _offs++, {
                _buf.reset();
                {
                    var _err:stdgo.Error = fprint(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), _fset, stdgo.Go.toInterface(stdgo.Go.asInterface(_f)));
                    if (_err != null) {
                        _t.error(stdgo.Go.toInterface(_err));
                    };
                };
                {
                    var __tmp__ = stdgo.go.parser.Parser.parseFile(_fset, stdgo.Go.str()?.__copy__(), stdgo.Go.toInterface(_buf.bytes()), (0u32 : stdgo.go.parser.Parser.Mode)), __0:stdgo.Ref<stdgo.go.ast.Ast.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                    if (_err != null) {
...
/**
    ...
    // is incorrect.
**/
function testBadComments(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        _t.parallel();
        {};
        ...
        _testComment(_t, _f, (("\n// first comment - text and position changed by test\npackage p\nimport \"fmt\"\nconst pi = 3.14 // rough circle\nvar (\n\tx, y, z int = 1, 2, 3\n\tu, v float64\n)\nfunc fibo(n int) {\n\tif n < 2 {\n\t\treturn n /* seed values */\n\t}\n\treturn fibo(n-1) + fibo(n-2)\n}\n" : stdgo.GoString).length), (stdgo.Go.setRef(({ slash : _pos, text : ("//-style comment" : stdgo.GoString) } : stdgo.go.ast.Ast.Comment)) : stdgo.Ref<stdgo.go.ast.Ast.Comment>));
        _testComment(_t, _f, (("\n// first comment - text and position changed by test\npackage p\nimport \"fmt\"\nconst pi = 3.14 // rough circle\nvar (\n\tx, y, z int = 1, 2, 3\n\tu, v float64\n)\nfunc fibo(n int) {\n\tif n < 2 {\n\t\treturn n /* seed values */\n\t}\n\treturn fibo(n-1) + fibo(n-2)\n}\n" : stdgo.GoString).length), (stdgo.Go.setRef(({ slash : _pos, text : ("/*-style comment */" : stdgo.GoString) } : stdgo.go.ast.Ast.Comment)) : stdgo.Ref<stdgo.go.ast.Ast.Comment>));
        _testComment(_t, _f, (("\n// first comment - text and position changed by test\npackage p\nimport \"fmt\"\nconst pi = 3.14 // rough circle\nvar (\n\tx, y, z int = 1, 2, 3\n\tu, v float64\n)\nfunc fibo(n int) {\n\tif n < 2 {\n\t\treturn n /* seed values */\n\t}\n\treturn fibo(n-1) + fibo(n-2)\n}\n" : stdgo.GoString).length), (stdgo.Go.setRef(({ slash : _pos, text : ("/*-style \n comment */" : stdgo.GoString) } : stdgo.go.ast.Ast.Comment)) : stdgo.Ref<stdgo.go.ast.Ast.Comment>));
        _testComment(_t, _f, (("\n// first comment - text and position changed by test\npackage p\nimport \"fmt\"\nconst pi = 3.14 // rough circle\nvar (\n\tx, y, z int = 1, 2, 3\n\tu, v float64\n)\nfunc fibo(n int) {\n\tif n < 2 {\n\t\treturn n /* seed values */\n\t}\n\treturn fibo(n-1) + fibo(n-2)\n}\n" : stdgo.GoString).length), (stdgo.Go.setRef(({ slash : _pos, text : ("/*-style comment \n\n\n */" : stdgo.GoString) } : stdgo.go.ast.Ast.Comment)) : stdgo.Ref<stdgo.go.ast.Ast.Comment>));
    }
/**
    // idents is an iterator that returns all idents in f via the result channel.
**/
function _idents(_f:stdgo.Ref<stdgo.go.ast.Ast.File>):stdgo.Chan<stdgo.Ref<stdgo.go.ast.Ast.Ident>> {
        var _v:stdgo.go.printer.Printer.T_visitor = new stdgo.go.printer.Printer.T_visitor(0, () -> (null : stdgo.Ref<stdgo.go.ast.Ast.Ident>));
        stdgo.Go.routine(() -> {
            var a = function():Void {
...
**/
function _identCount(_f:stdgo.Ref<stdgo.go.ast.Ast.File>):stdgo.GoInt {
        var _n:stdgo.GoInt = (0 : stdgo.GoInt);
...
/**
    ...
    // is maintained.
**/
function testSourcePos(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
        var __tmp__ = stdgo.go.parser.Parser.parseFile(_fset, ("src" : stdgo.GoString), stdgo.Go.toInterface(("\npackage p\nimport ( \"go/printer\"; \"math\" )\nconst pi = 3.14; var x = 0\ntype t struct{ x, y, z int; u, v, w float32 }\nfunc (t *t) foo(a, b, c int) int {\n\treturn a*t.x + b*t.y +\n\t\t// two extra lines here\n\t\t// ...\n\t\tc*t.z\n}\n" : stdgo.GoString)), (4u32 : stdgo.go.parser.Parser.Mode)), _f1:stdgo.Ref<stdgo.go.ast.Ast.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _t.fatal(stdgo.Go.toInterface(_err));
        };
        var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        _err = (stdgo.Go.setRef(({ mode : (12u32 : stdgo.go.printer.Printer.Mode), tabwidth : (8 : stdgo.GoInt) } : stdgo.go.printer.Printer.Config)) : stdgo.Ref<stdgo.go.printer.Printer.Config>).fprint(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), _fset, stdgo.Go.toInterface(stdgo.Go.asInterface(_f1)));
        if (_err != null) {
            _t.fatal(stdgo.Go.toInterface(_err));
        };
        var __tmp__ = stdgo.go.parser.Parser.parseFile(_fset, stdgo.Go.str()?.__copy__(), stdgo.Go.toInterface(_buf.bytes()), (0u32 : stdgo.go.parser.Parser.Mode)), _f2:stdgo.Ref<stdgo.go.ast.Ast.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _t.fatalf(("%s\n%s" : stdgo.GoString), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(_buf.bytes()));
        };
...
/**
    ...
    // before empty lines.
**/
function testIssue5945(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
        {};
        var __tmp__ = stdgo.go.parser.Parser.parseFile(_fset, ("src.go" : stdgo.GoString), stdgo.Go.toInterface(("\npackage p   // line 2\nfunc f() {} // line 3\n\nvar x, y, z int\n\n\nfunc g() { // line 8\n}\n" : stdgo.GoString)), (0u32 : stdgo.go.parser.Parser.Mode)), _f1:stdgo.Ref<stdgo.go.ast.Ast.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _t.fatal(stdgo.Go.toInterface(_err));
        };
        var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
...
function testDeclLists(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        for (__0 => _src in _decls) {
            var __tmp__ = stdgo.go.parser.Parser.parseFile(_fset, stdgo.Go.str()?.__copy__(), stdgo.Go.toInterface(("package p;" : stdgo.GoString) + _src?.__copy__()), (4u32 : stdgo.go.parser.Parser.Mode)), _file:stdgo.Ref<stdgo.go.ast.Ast.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                throw stdgo.Go.toInterface(_err);
            };
            var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
            _err = fprint(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), _fset, stdgo.Go.toInterface(_file.decls));
            if (_err != null) {
                throw stdgo.Go.toInterface(_err);
            };
...
function testStmtLists(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        for (__0 => _src in _stmts) {
            var __tmp__ = stdgo.go.parser.Parser.parseFile(_fset, stdgo.Go.str()?.__copy__(), stdgo.Go.toInterface(("package p; func _() {" : stdgo.GoString) + _src?.__copy__() + ("}" : stdgo.GoString)?.__copy__()), (4u32 : stdgo.go.parser.Parser.Mode)), _file:stdgo.Ref<stdgo.go.ast.Ast.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                throw stdgo.Go.toInterface(_err);
            };
            var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
            _err = fprint(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), _fset, stdgo.Go.toInterface((stdgo.Go.typeAssert((stdgo.Go.toInterface(_file.decls[(0 : stdgo.GoInt)]) : stdgo.Ref<stdgo.go.ast.Ast.FuncDecl>)) : stdgo.Ref<stdgo.go.ast.Ast.FuncDecl>).body.list));
            if (_err != null) {
                throw stdgo.Go.toInterface(_err);
            };
            var _out:stdgo.GoString = (_buf.string() : stdgo.GoString)?.__copy__();
...
function testBaseIndent(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        _t.parallel();
        {};
        var __tmp__ = stdgo.os.Os.readFile(("printer.go" : stdgo.GoString)), _src:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            throw stdgo.Go.toInterface(_err);
        };
        var __tmp__ = stdgo.go.parser.Parser.parseFile(_fset, ("printer.go" : stdgo.GoString), stdgo.Go.toInterface(_src), (0u32 : stdgo.go.parser.Parser.Mode)), _file:stdgo.Ref<stdgo.go.ast.Ast.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            throw stdgo.Go.toInterface(_err);
        };
        {
            var _indent:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_indent < (4 : stdgo.GoInt), _indent++, {
                var _indent:stdgo.GoInt = _indent;
                _t.run(stdgo.fmt.Fmt.sprint(stdgo.Go.toInterface(_indent))?.__copy__(), function(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
                    _t.parallel();
                    var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
                    (stdgo.Go.setRef(({ tabwidth : (8 : stdgo.GoInt), indent : _indent } : stdgo.go.printer.Printer.Config)) : stdgo.Ref<stdgo.go.printer.Printer.Config>).fprint(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), _fset, stdgo.Go.toInterface(stdgo.Go.asInterface(_file)));
                    var _lines = stdgo.bytes.Bytes.split(_buf.bytes(), (new stdgo.Slice<stdgo.GoUInt8>(1, 1, (10 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>));
                    for (_i => _line in _lines) {
...
**/
function testFuncType(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _src = (stdgo.Go.setRef(({ name : (stdgo.Go.setRef(({ name : ("p" : stdgo.GoString) } : stdgo.go.ast.Ast.Ident)) : stdgo.Ref<stdgo.go.ast.Ast.Ident>), decls : (new stdgo.Slice<stdgo.go.ast.Ast.Decl>(1, 1, stdgo.Go.asInterface((stdgo.Go.setRef(({ name : (stdgo.Go.setRef(({ name : ("f" : stdgo.GoString) } : stdgo.go.ast.Ast.Ident)) : stdgo.Ref<stdgo.go.ast.Ast.Ident>), type : (stdgo.Go.setRef((new stdgo.go.ast.Ast.FuncType() : stdgo.go.ast.Ast.FuncType)) : stdgo.Ref<stdgo.go.ast.Ast.FuncType>) } : stdgo.go.ast.Ast.FuncDecl)) : stdgo.Ref<stdgo.go.ast.Ast.FuncDecl>))) : stdgo.Slice<stdgo.go.ast.Ast.Decl>) } : stdgo.go.ast.Ast.File)) : stdgo.Ref<stdgo.go.ast.Ast.File>);
        var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        {
            var _err:stdgo.Error = fprint(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), _fset, stdgo.Go.toInterface(stdgo.Go.asInterface(_src)));
            if (_err != null) {
                _t.fatal(stdgo.Go.toInterface(_err));
            };
        };
...
**/
function testWriteErrors(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        _t.parallel();
        {};
        var __tmp__ = stdgo.os.Os.readFile(("printer.go" : stdgo.GoString)), _src:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
        ...
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < (20 : stdgo.GoInt), _i++, {
                var _lw = (stdgo.Go.setRef(({ _remaining : _i } : stdgo.go.printer.Printer.T_limitWriter)) : stdgo.Ref<stdgo.go.printer.Printer.T_limitWriter>);
                var _err:stdgo.Error = (stdgo.Go.setRef(({ mode : (1u32 : stdgo.go.printer.Printer.Mode) } : stdgo.go.printer.Printer.Config)) : stdgo.Ref<stdgo.go.printer.Printer.Config>).fprint(stdgo.Go.asInterface(_lw), _fset, stdgo.Go.toInterface(stdgo.Go.asInterface(_file)));
                if (_lw._errCount > (1 : stdgo.GoInt)) {
...
/**
    ...
    // Do not remove.
**/
function testX(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
        var __tmp__ = _format((("\npackage p\nfunc _() {}\n" : stdgo.GoString) : stdgo.Slice<stdgo.GoByte>), (0u32 : stdgo.go.printer.Printer.T_checkMode)), __0:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _t.error(stdgo.Go.toInterface(_err));
        };
    }
function testCommentedNode(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
        var _fset = stdgo.go.token.Token.newFileSet();
        ...
        var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        _err = fprint(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), _fset, stdgo.Go.toInterface((stdgo.Go.setRef(({ node : stdgo.Go.toInterface(_f.decls[(0 : stdgo.GoInt)]), comments : _f.comments } : stdgo.go.printer.Printer.CommentedNode)) : stdgo.Ref<stdgo.go.printer.Printer.CommentedNode>)));
        if (_err != null) {
            _t.fatal(stdgo.Go.toInterface(_err));
        };
        ...
        _buf.reset();
        _err = fprint(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), _fset, stdgo.Go.toInterface((stdgo.Go.setRef(({ node : stdgo.Go.toInterface(_f.decls[(1 : stdgo.GoInt)]), comments : _f.comments } : stdgo.go.printer.Printer.CommentedNode)) : stdgo.Ref<stdgo.go.printer.Printer.CommentedNode>)));
        if (_err != null) {
            _t.fatal(stdgo.Go.toInterface(_err));
        };
...
function testIssue11151(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
        var _fset = stdgo.go.token.Token.newFileSet();
...
**/
function testParenthesizedDecl(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
        var _fset = stdgo.go.token.Token.newFileSet();
        var __tmp__ = stdgo.go.parser.Parser.parseFile(_fset, stdgo.Go.str()?.__copy__(), stdgo.Go.toInterface(("package p; var ( a float64; b int )" : stdgo.GoString)), (0u32 : stdgo.go.parser.Parser.Mode)), _f:stdgo.Ref<stdgo.go.ast.Ast.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _t.fatal(stdgo.Go.toInterface(_err));
        };
        var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        _err = fprint(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), _fset, stdgo.Go.toInterface(stdgo.Go.asInterface(_f)));
        if (_err != null) {
            _t.fatal(stdgo.Go.toInterface(_err));
        };
        var _original:stdgo.GoString = (_buf.string() : stdgo.GoString)?.__copy__();
        {
            ...
            stdgo.Go.cfor(_i != ((_f.decls.length)), _i++, {
                (stdgo.Go.typeAssert((stdgo.Go.toInterface(_f.decls[(_i : stdgo.GoInt)]) : stdgo.Ref<stdgo.go.ast.Ast.GenDecl>)) : stdgo.Ref<stdgo.go.ast.Ast.GenDecl>).lparen = (0 : stdgo.go.token.Token.Pos);
            });
        };
        _buf.reset();
        _err = fprint(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), _fset, stdgo.Go.toInterface(stdgo.Go.asInterface(_f)));
...
**/
function testIssue32854(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _src:stdgo.GoString = ("package foo\n\nfunc f() {\n        return Composite{\n                call(),\n        }\n}" : stdgo.GoString);
        var _fset = stdgo.go.token.Token.newFileSet();
        var __tmp__ = stdgo.go.parser.Parser.parseFile(_fset, stdgo.Go.str()?.__copy__(), stdgo.Go.toInterface(_src), (0u32 : stdgo.go.parser.Parser.Mode)), _file:stdgo.Ref<stdgo.go.ast.Ast.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            throw stdgo.Go.toInterface(_err);
        };
        var _fd = (stdgo.Go.typeAssert((stdgo.Go.toInterface(_file.decls[(0 : stdgo.GoInt)]) : stdgo.Ref<stdgo.go.ast.Ast.FuncDecl>)) : stdgo.Ref<stdgo.go.ast.Ast.FuncDecl>);
        var _ret = (stdgo.Go.typeAssert((stdgo.Go.toInterface(_fd.body.list[(0 : stdgo.GoInt)]) : stdgo.Ref<stdgo.go.ast.Ast.ReturnStmt>)) : stdgo.Ref<stdgo.go.ast.Ast.ReturnStmt>);
        _ret.results[(0 : stdgo.GoInt)] = (stdgo.Go.typeAssert((stdgo.Go.toInterface(_ret.results[(0 : stdgo.GoInt)]) : stdgo.Ref<stdgo.go.ast.Ast.CompositeLit>)) : stdgo.Ref<stdgo.go.ast.Ast.CompositeLit>).elts[(0 : stdgo.GoInt)];
        var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        {
            var _err:stdgo.Error = fprint(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), _fset, stdgo.Go.toInterface(stdgo.Go.asInterface(_ret)));
            if (_err != null) {
                _t.fatal(stdgo.Go.toInterface(_err));
            };
        };
...
function testSourcePosNewline(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _fname:stdgo.GoString = ("foo\nbar/bar.go" : stdgo.GoString);
        var _src:stdgo.GoString = ("package bar" : stdgo.GoString);
        var _fset = stdgo.go.token.Token.newFileSet();
        var __tmp__ = stdgo.go.parser.Parser.parseFile(_fset, _fname?.__copy__(), stdgo.Go.toInterface(_src), (100u32 : stdgo.go.parser.Parser.Mode)), _f:stdgo.Ref<stdgo.go.ast.Ast.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _t.fatal(stdgo.Go.toInterface(_err));
        };
        var _cfg = (stdgo.Go.setRef(({ mode : (8u32 : stdgo.go.printer.Printer.Mode), tabwidth : (8 : stdgo.GoInt) } : stdgo.go.printer.Printer.Config)) : stdgo.Ref<stdgo.go.printer.Printer.Config>);
        var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        {
            var _err:stdgo.Error = _cfg.fprint(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), _fset, stdgo.Go.toInterface(stdgo.Go.asInterface(_f)));
            if (_err == null) {
...
@:keep var _ = {
        try {
            ...
            var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
            {
                var _err:stdgo.Error = fprint(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), _fset, stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(({ name : ("foobar" : stdgo.GoString) } : stdgo.go.ast.Ast.Ident)) : stdgo.Ref<stdgo.go.ast.Ast.Ident>))));
                if (_err != null) {
                    throw stdgo.Go.toInterface(_err);
                };
            };
...
@:keep @:allow(stdgo.go.printer.Printer.T_sizeCounter_asInterface) class T_sizeCounter_static_extension {
    ...
    static public function write( _c:stdgo.Ref<T_sizeCounter>, _p:stdgo.Slice<stdgo.GoByte>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        ...
        if (!_c._hasNewline) {
            for (__0 => _b in _p) {
                if ((_b == (10 : stdgo.GoUInt8)) || (_b == (12 : stdgo.GoUInt8))) {
                    _c._hasNewline = true;
                    break;
                };
            };
...
class T_printer_asInterface {
    ...
    **/
    ...
    @:keep
    public dynamic function _writeComment(_comment:stdgo.Ref<stdgo.go.ast.Ast.Comment>):Void __self__.value._writeComment(_comment);
    /**
    ...
    **/
    @:keep
    public dynamic function _writeCommentPrefix(_pos:stdgo.go.token.Token.Position, _next:stdgo.go.token.Token.Position, _prev:stdgo.Ref<stdgo.go.ast.Ast.Comment>, _tok:stdgo.go.token.Token.Token):Void __self__.value._writeCommentPrefix(_pos, _next, _prev, _tok);
    /**
    ...
    **/
    ...
    @:keep
    public dynamic function _lineFor(_pos:stdgo.go.token.Token.Pos):stdgo.GoInt return __self__.value._lineFor(_pos);
    @:keep
    ...
    **/
    @:keep
    public dynamic function _commentSizeBefore(_next:stdgo.go.token.Token.Position):stdgo.GoInt return __self__.value._commentSizeBefore(_next);
    /**
    ...
    **/
    @:keep
    public dynamic function _commentsHaveNewline(_list:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Comment>>):Bool return __self__.value._commentsHaveNewline(_list);
    @:keep
    public dynamic function _internalError(_msg:haxe.Rest<stdgo.AnyInterface>):Void __self__.value._internalError(..._msg);
    @:keep
    public dynamic function _file(_src:stdgo.Ref<stdgo.go.ast.Ast.File>):Void __self__.value._file(_src);
    @:keep
    ...
    @:keep
    public dynamic function _funcDecl(_d:stdgo.Ref<stdgo.go.ast.Ast.FuncDecl>):Void __self__.value._funcDecl(_d);
    /**
    ...
    **/
    @:keep
    public dynamic function _distanceFrom(_startPos:stdgo.go.token.Token.Pos, _startOutCol:stdgo.GoInt):stdgo.GoInt return __self__.value._distanceFrom(_startPos, _startOutCol);
    /**
    ...
    **/
    @:keep
    public dynamic function _funcBody(_headerSize:stdgo.GoInt, _sep:T_whiteSpace, _b:stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>):Void __self__.value._funcBody(_headerSize, _sep, _b);
    /**
        // bodySize is like nodeSize but it is specialized for *ast.BlockStmt's.
    **/
    @:keep
    public dynamic function _bodySize(_b:stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>, _maxSize:stdgo.GoInt):stdgo.GoInt return __self__.value._bodySize(_b, _maxSize);
    /**
        // numLines returns the number of lines spanned by node n in the original source.
    **/
    @:keep
    public dynamic function _numLines(_n:stdgo.go.ast.Ast.Node):stdgo.GoInt return __self__.value._numLines(_n);
    /**
    ...
    **/
    @:keep
    public dynamic function _nodeSize(_n:stdgo.go.ast.Ast.Node, _maxSize:stdgo.GoInt):stdgo.GoInt return __self__.value._nodeSize(_n, _maxSize);
    @:keep
    public dynamic function _genDecl(_d:stdgo.Ref<stdgo.go.ast.Ast.GenDecl>):Void __self__.value._genDecl(_d);
    /**
    ...
    **/
    @:keep
    public dynamic function _spec(_spec:stdgo.go.ast.Ast.Spec, _n:stdgo.GoInt, _doIndent:Bool):Void __self__.value._spec(_spec, _n, _doIndent);
    @:keep
    public dynamic function _valueSpec(_s:stdgo.Ref<stdgo.go.ast.Ast.ValueSpec>, _keepType:Bool):Void __self__.value._valueSpec(_s, _keepType);
    @:keep
    ...
    **/
    @:keep
    public dynamic function _block(_b:stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>, _nindent:stdgo.GoInt):Void __self__.value._block(_b, _nindent);
    /**
    ...
    **/
    @:keep
    public dynamic function _stmtList(_list:stdgo.Slice<stdgo.go.ast.Ast.Stmt>, _nindent:stdgo.GoInt, _nextIsRBrace:Bool):Void __self__.value._stmtList(_list, _nindent, _nextIsRBrace);
    @:keep
    public dynamic function _expr(_x:stdgo.go.ast.Ast.Expr):Void __self__.value._expr(_x);
    @:keep
    public dynamic function _expr0(_x:stdgo.go.ast.Ast.Expr, _depth:stdgo.GoInt):Void __self__.value._expr0(_x, _depth);
    /**
        // selectorExpr handles an *ast.SelectorExpr node and reports whether x spans
        // multiple lines.
    **/
    @:keep
    public dynamic function _selectorExpr(_x:stdgo.Ref<stdgo.go.ast.Ast.SelectorExpr>, _depth:stdgo.GoInt, _isMethod:Bool):Bool return __self__.value._selectorExpr(_x, _depth, _isMethod);
    @:keep
    public dynamic function _possibleSelectorExpr(_expr:stdgo.go.ast.Ast.Expr, _prec1:stdgo.GoInt, _depth:stdgo.GoInt):Bool return __self__.value._possibleSelectorExpr(_expr, _prec1, _depth);
    @:keep
    public dynamic function _expr1(_expr:stdgo.go.ast.Ast.Expr, _prec1:stdgo.GoInt, _depth:stdgo.GoInt):Void __self__.value._expr1(_expr, _prec1, _depth);
    /**
    ...
    **/
    @:keep
    public dynamic function _binaryExpr(_x:stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr>, _prec1:stdgo.GoInt, _cutoff:stdgo.GoInt, _depth:stdgo.GoInt):Void __self__.value._binaryExpr(_x, _prec1, _cutoff, _depth);
    @:keep
    public dynamic function _fieldList(_fields:stdgo.Ref<stdgo.go.ast.Ast.FieldList>, _isStruct:Bool, _isIncomplete:Bool):Void __self__.value._fieldList(_fields, _isStruct, _isIncomplete);
    @:keep
    public dynamic function _setLineComment(_text:stdgo.GoString):Void __self__.value._setLineComment(_text);
    @:keep
    public dynamic function _isOneLineFieldList(_list:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Field>>):Bool return __self__.value._isOneLineFieldList(_list);
    @:keep
    public dynamic function _signature(_sig:stdgo.Ref<stdgo.go.ast.Ast.FuncType>):Void __self__.value._signature(_sig);
    @:keep
    public dynamic function _parameters(_fields:stdgo.Ref<stdgo.go.ast.Ast.FieldList>, _mode:T_paramMode):Void __self__.value._parameters(_fields, _mode);
    /**
    ...
    **/
    @:keep
    public dynamic function _exprList(_prev0:stdgo.go.token.Token.Pos, _list:stdgo.Slice<stdgo.go.ast.Ast.Expr>, _depth:stdgo.GoInt, _mode:T_exprListMode, _next0:stdgo.go.token.Token.Pos, _isIncomplete:Bool):Void __self__.value._exprList(_prev0, _list, _depth, _mode, _next0, _isIncomplete);
    /**
        // If indent is set, a multi-line identifier list is indented after the
        // first linebreak encountered.
    **/
    @:keep
    public dynamic function _identList(_list:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Ident>>, _indent:Bool):Void __self__.value._identList(_list, _indent);
    /**
    ...
    **/
    @:keep
    public dynamic function _setComment(_g:stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>):Void __self__.value._setComment(_g);
    /**
    ...
    **/
    ...
    @:embedded
    public dynamic function _fprint(_output:stdgo.io.Io.Writer, _fset_:stdgo.Ref<stdgo.go.token.Token.FileSet>, _node:stdgo.AnyInterface, _nodeSizes:stdgo.GoMap<stdgo.go.ast.Ast.Node, stdgo.GoInt>):stdgo.Error return __self__.value._fprint(_output, _fset_, _node, _nodeSizes);
    @:embedded
    public dynamic function fprint(_output:stdgo.io.Io.Writer, _fset_:stdgo.Ref<stdgo.go.token.Token.FileSet>, _node:stdgo.AnyInterface):stdgo.Error return __self__.value.fprint(_output, _fset_, _node);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
@:keep @:allow(stdgo.go.printer.Printer.T_printer_asInterface) class T_printer_static_extension {
    ...
    static public function _free( _p:stdgo.Ref<T_printer>):Void {
        ...
        if (_p._output.capacity > (65536 : stdgo.GoInt)) {
            return;
        };
    ...
    static public function _printNode( _p:stdgo.Ref<T_printer>, _node:stdgo.AnyInterface):stdgo.Error {
        stdgo.internal.Macro.controlFlow({
            @:recv var _p:stdgo.Ref<T_printer> = _p;
            var _comments:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>> = (null : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>);
            {
                var __tmp__ = try {
                    { _0 : (stdgo.Go.typeAssert((_node : stdgo.Ref<CommentedNode>)) : stdgo.Ref<CommentedNode>), _1 : true };
                } catch(_) {
                    { _0 : (null : stdgo.Ref<stdgo.go.printer.Printer.CommentedNode>), _1 : false };
            ...
            if (_comments != null) {
                var __tmp__ = try {
                    { _0 : (stdgo.Go.typeAssert((_node : stdgo.go.ast.Ast.Node)) : stdgo.go.ast.Ast.Node), _1 : true };
                } catch(_) {
                    { _0 : (null : stdgo.go.ast.Ast.Node), _1 : false };
                ...
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                while ((_i < _comments.length) && (_comments[(_i : stdgo.GoInt)].end() < _beg)) {
                    _i++;
                };
                var _j:stdgo.GoInt = _i;
                while ((_j < _comments.length) && (_comments[(_j : stdgo.GoInt)].pos() < _end)) {
                    _j++;
                };
                if (_i < _j) {
                    _p._comments = (_comments.__slice__(_i, _j) : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>);
                };
            } else {
                var __tmp__ = try {
                    { _0 : (stdgo.Go.typeAssert((_node : stdgo.Ref<stdgo.go.ast.Ast.File>)) : stdgo.Ref<stdgo.go.ast.Ast.File>), _1 : true };
                } catch(_) {
                    { _0 : (null : stdgo.Ref<stdgo.go.ast.Ast.File>), _1 : false };
                }, _n = __tmp__._0, _ok = __tmp__._1;
                if (_ok) {
            ...
            _p._print(stdgo.Go.toInterface(((0 : stdgo.go.printer.Printer.T_pmode) : T_pmode)));
            {
                ...
                if (stdgo.Go.typeEquals((__type__ : stdgo.go.ast.Ast.Expr))) {
                    ...
                    {
                        var __tmp__ = try {
                            { _0 : (stdgo.Go.typeAssert((stdgo.Go.toInterface(_n) : stdgo.Ref<stdgo.go.ast.Ast.LabeledStmt>)) : stdgo.Ref<stdgo.go.ast.Ast.LabeledStmt>), _1 : true };
                        } catch(_) {
                            { _0 : (null : stdgo.Ref<stdgo.go.ast.Ast.LabeledStmt>), _1 : false };
                    ...
                    for (__89 => _s in _n) {
                        {
                            var __tmp__ = try {
                                { _0 : (stdgo.Go.typeAssert((stdgo.Go.toInterface(_s) : stdgo.Ref<stdgo.go.ast.Ast.LabeledStmt>)) : stdgo.Ref<stdgo.go.ast.Ast.LabeledStmt>), _1 : true };
                            } catch(_) {
                                { _0 : (null : stdgo.Ref<stdgo.go.ast.Ast.LabeledStmt>), _1 : false };
    ...
    **/
    @:keep
    static public function _flush( _p:stdgo.Ref<T_printer>, _next:stdgo.go.token.Token.Position, _tok:stdgo.go.token.Token.Token):{ var _0 : Bool; var _1 : Bool; } {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
    ...
    **/
        ...
        for (__0 => _arg in _args) {
            ...
            };
            {
                ...
                if (stdgo.Go.typeEquals((__type__ : T_pmode))) {
                    var _x:stdgo.go.printer.Printer.T_pmode = __type__ == null ? ((0 : stdgo.GoInt) : stdgo.go.printer.Printer.T_pmode) : __type__.__underlying__() == null ? ((0 : stdgo.GoInt) : stdgo.go.printer.Printer.T_pmode) : __type__ == null ? ((0 : stdgo.GoInt) : stdgo.go.printer.Printer.T_pmode) : __type__.__underlying__().value;
                    _p._mode = _p._mode ^ (_x);
                    continue;
                } else if (stdgo.Go.typeEquals((__type__ : T_whiteSpace))) {
                    var _x:stdgo.go.printer.Printer.T_whiteSpace = __type__ == null ? ((0 : stdgo.GoUInt8) : stdgo.go.printer.Printer.T_whiteSpace) : __type__.__underlying__() == null ? ((0 : stdgo.GoUInt8) : stdgo.go.printer.Printer.T_whiteSpace) : __type__ == null ? ((0 : stdgo.GoUInt8) : stdgo.go.printer.Printer.T_whiteSpace) : __type__.__underlying__().value;
                    ...
                    _p._wsbuf = (_p._wsbuf.__slice__((0 : stdgo.GoInt), _i + (1 : stdgo.GoInt)) : stdgo.Slice<stdgo.go.printer.Printer.T_whiteSpace>);
                    ...
                    var _x:stdgo.go.token.Token.Token = __type__ == null ? ((0 : stdgo.GoInt) : stdgo.go.token.Token.Token) : __type__.__underlying__() == null ? ((0 : stdgo.GoInt) : stdgo.go.token.Token.Token) : __type__ == null ? ((0 : stdgo.GoInt) : stdgo.go.token.Token.Token) : __type__.__underlying__().value;
                    ...
                    if (_mayCombine(_p._lastTok, _s[(0 : stdgo.GoInt)])) {
                        ...
                        _p._wsbuf = (_p._wsbuf.__slice__((0 : stdgo.GoInt), (1 : stdgo.GoInt)) : stdgo.Slice<stdgo.go.printer.Printer.T_whiteSpace>);
                        _p._wsbuf[(0 : stdgo.GoInt)] = (32 : stdgo.go.printer.Printer.T_whiteSpace);
                    };
                    _data = _s?.__copy__();
                    {
                        final __value__ = _x;
            ...
            if (!_p._impliedSemi) {
                var _n:stdgo.GoInt = _nlimit(_next.line - _p._pos.line);
                if (_wroteNewline && (_n == (2 : stdgo.GoInt))) {
                    _n = (1 : stdgo.GoInt);
                };
                if (_n > (0 : stdgo.GoInt)) {
    ...
    @:keep
    static public function _setPos( _p:stdgo.Ref<T_printer>, _pos:stdgo.go.token.Token.Pos):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        if (_pos.isValid()) {
    ...
    static public function _writeWhitespace( _p:stdgo.Ref<T_printer>, _n:stdgo.GoInt):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        {
            ...
            stdgo.Go.cfor(_i < _n, _i++, {
                {
                    var _ch:stdgo.go.printer.Printer.T_whiteSpace = _p._wsbuf[(_i : stdgo.GoInt)];
                    {
                        ...
                        while (__run__) {
                            __run__ = false;
                            {
                                ...
                                if (__switchIndex__ == 0 || (__switchIndex__ == -1 && (__value__ == (0 : stdgo.go.printer.Printer.T_whiteSpace)))) {
                                    ...
                                    if (((_i + (1 : stdgo.GoInt)) < _n) && (_p._wsbuf[(_i + (1 : stdgo.GoInt) : stdgo.GoInt)] == (60 : stdgo.go.printer.Printer.T_whiteSpace))) {
                                        {
                                            final __tmp__0 = (60 : stdgo.go.printer.Printer.T_whiteSpace);
                                            final __tmp__1 = (12 : stdgo.go.printer.Printer.T_whiteSpace);
                                            _p._wsbuf[(_i : stdgo.GoInt)] = __tmp__0;
                                            _p._wsbuf[(_i + (1 : stdgo.GoInt) : stdgo.GoInt)] = __tmp__1;
                                        };
                                        _i--;
                                        {
                                            __continue__ = true;
        ...
        var _l:stdgo.GoInt = stdgo.Go.copySlice(_p._wsbuf, (_p._wsbuf.__slice__(_n) : stdgo.Slice<stdgo.go.printer.Printer.T_whiteSpace>));
    ...
    **/
    @:keep
    static public function _intersperseComments( _p:stdgo.Ref<T_printer>, _next:stdgo.go.token.Token.Position, _tok:stdgo.go.token.Token.Token):{ var _0 : Bool; var _1 : Bool; } {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        var _wroteNewline:Bool = false, _droppedFF:Bool = false;
        var _last:stdgo.Ref<stdgo.go.ast.Ast.Comment> = (null : stdgo.Ref<stdgo.go.ast.Ast.Comment>);
        while (_p._commentBefore(_next?.__copy__())) {
            var _list = _p._commentInfo._comment.list;
            var _changed:Bool = false;
            if (((_p._lastTok != (75 : stdgo.go.token.Token.Token)) && (_p._posFor(_p._commentInfo._comment.pos()).column == (1 : stdgo.GoInt))) && (stdgo.Go.toInterface(_p._posFor(_p._commentInfo._comment.end() + (1 : stdgo.go.token.Token.Pos))) == stdgo.Go.toInterface(_next))) {
                _list = _formatDocComment(_list);
                _changed = true;
                if ((_p._commentInfo._comment.list.length > (0 : stdgo.GoInt)) && (_list.length == (0 : stdgo.GoInt))) {
            ...
            if ((_p._commentInfo._comment.list.length > (0 : stdgo.GoInt)) && _changed) {
        ...
        if (_last != null && ((_last : Dynamic).__nil__ == null || !(_last : Dynamic).__nil__)) {
            ...
            if (((((((_p._mode & (1 : stdgo.go.printer.Printer.T_pmode)) == (0 : stdgo.go.printer.Printer.T_pmode)) && (_last.text[(1 : stdgo.GoInt)] == (42 : stdgo.GoUInt8))) && (_p._lineFor(_last.pos()) == _next.line)) && (_tok != (52 : stdgo.go.token.Token.Token))) && ((_tok != (54 : stdgo.go.token.Token.Token)) || (_p._prevOpen == (49 : stdgo.go.token.Token.Token)))) && ((_tok != (55 : stdgo.go.token.Token.Token)) || (_p._prevOpen == (50 : stdgo.go.token.Token.Token)))) {
                if ((_p._containsLinebreak() && ((_p._mode & (2 : stdgo.go.printer.Printer.T_pmode)) == (0 : stdgo.go.printer.Printer.T_pmode))) && (_p._level == (0 : stdgo.GoInt))) {
                    _needsLinebreak = true;
                } else {
                    _p._writeByte((32 : stdgo.GoUInt8), (1 : stdgo.GoInt));
                };
            };
            if (((_last.text[(1 : stdgo.GoInt)] == (47 : stdgo.GoUInt8)) || (_tok == (1 : stdgo.go.token.Token.Token))) || ((_tok == (56 : stdgo.go.token.Token.Token)) && ((_p._mode & (2 : stdgo.go.printer.Printer.T_pmode)) == (0 : stdgo.go.printer.Printer.T_pmode)))) {
                _needsLinebreak = true;
            };
    ...
    **/
        ...
        for (_i => _ch in _p._wsbuf) {
            {
                ...
                if (__value__ == ((32 : stdgo.go.printer.Printer.T_whiteSpace)) || __value__ == ((11 : stdgo.go.printer.Printer.T_whiteSpace))) {
                    _p._wsbuf[(_i : stdgo.GoInt)] = (0 : stdgo.go.printer.Printer.T_whiteSpace);
    ...
    @:keep
    static public function _writeComment( _p:stdgo.Ref<T_printer>, _comment:stdgo.Ref<stdgo.go.ast.Ast.Comment>):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        ...
        try {
            ...
            {};
            if (stdgo.strings.Strings.hasPrefix(_text?.__copy__(), ("//line " : stdgo.GoString)) && (!_pos.isValid() || (_pos.column == (1 : stdgo.GoInt)))) {
                {
                    var _a0 = _p._indent;
            ...
            if ((_pos.isValid() && (_pos.column == (1 : stdgo.GoInt))) && (_p._indent > (0 : stdgo.GoInt))) {
                for (_i => _line in (_lines.__slice__((1 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoString>)) {
                    _lines[((1 : stdgo.GoInt) + _i : stdgo.GoInt)] = ("   " : stdgo.GoString) + _line?.__copy__()?.__copy__();
                };
            };
    ...
    **/
    @:keep
    static public function _writeCommentPrefix( _p:stdgo.Ref<T_printer>, _pos:stdgo.go.token.Token.Position, _next:stdgo.go.token.Token.Position, _prev:stdgo.Ref<stdgo.go.ast.Ast.Comment>, _tok:stdgo.go.token.Token.Token):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        ...
        if ((_pos.line == _p._last.line) && (((_prev == null) || (_prev : Dynamic).__nil__) || (_prev.text[(1 : stdgo.GoInt)] != (47 : stdgo.GoUInt8)))) {
            ...
            for (_i => _ch in _p._wsbuf) {
                {
                    ...
                    if (__value__ == ((32 : stdgo.go.printer.Printer.T_whiteSpace)) || __value__ == ((11 : stdgo.go.printer.Printer.T_whiteSpace))) {
                        ...
                        if (((_i + (1 : stdgo.GoInt)) < _p._wsbuf.length) && (_p._wsbuf[(_i + (1 : stdgo.GoInt) : stdgo.GoInt)] == (60 : stdgo.go.printer.Printer.T_whiteSpace))) {
                            continue;
                        };
            ...
            if ((_p._indent == (0 : stdgo.GoInt)) && _droppedLinebreak) {
                _n++;
            };
            if (((_n == (0 : stdgo.GoInt)) && ((_prev != null) && ((_prev : Dynamic).__nil__ == null || !(_prev : Dynamic).__nil__))) && (_prev.text[(1 : stdgo.GoInt)] == (47 : stdgo.GoUInt8))) {
                _n = (1 : stdgo.GoInt);
            };
            if (_n > (0 : stdgo.GoInt)) {
    ...
    **/
    @:keep
    static public function _writeString( _p:stdgo.Ref<T_printer>, _pos:stdgo.go.token.Token.Position, _s:stdgo.GoString, _isLit:Bool):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
            ...
            stdgo.Go.cfor(_i < (_s.length), _i++, {
                {
                    ...
                    if ((_ch == (10 : stdgo.GoUInt8)) || (_ch == (12 : stdgo.GoUInt8))) {
                        _nlines++;
                        _li = _i;
    ...
    **/
    ...
    static public function _writeIndent( _p:stdgo.Ref<T_printer>):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        var _n:stdgo.GoInt = _p.config.indent + _p._indent;
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _n, _i++, {
    ...
    **/
    @:keep
    static public function _writeLineDirective( _p:stdgo.Ref<T_printer>, _pos:stdgo.go.token.Token.Position):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
    ...
    @:keep
    static public function _lineFor( _p:stdgo.Ref<T_printer>, _pos:stdgo.go.token.Token.Pos):stdgo.GoInt {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
    ...
    @:keep
    static public function _posFor( _p:stdgo.Ref<T_printer>, _pos:stdgo.go.token.Token.Pos):stdgo.go.token.Token.Position {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
    ...
    **/
    @:keep
    static public function _commentSizeBefore( _p:stdgo.Ref<T_printer>, _next:stdgo.go.token.Token.Position):stdgo.GoInt {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        var __deferstack__:Array<Void -> Void> = [];
        try {
            {
    ...
    **/
    @:keep
    static public function _commentBefore( _p:stdgo.Ref<T_printer>, _next:stdgo.go.token.Token.Position):Bool {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
    ...
    **/
    @:keep
    static public function _commentsHaveNewline( _p:stdgo.Ref<T_printer>, _list:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Comment>>):Bool {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        var _line:stdgo.GoInt = _p._lineFor(_list[(0 : stdgo.GoInt)].pos());
        for (_i => _c in _list) {
            if ((_i > (0 : stdgo.GoInt)) && (_p._lineFor(_list[(_i : stdgo.GoInt)].pos()) != _line)) {
                return true;
            };
            {
                var _t:stdgo.GoString = _c.text?.__copy__();
                if ((_t.length >= (2 : stdgo.GoInt)) && ((_t[(1 : stdgo.GoInt)] == (47 : stdgo.GoUInt8)) || stdgo.strings.Strings.contains(_t?.__copy__(), ("\n" : stdgo.GoString)))) {
                    return true;
                };
            };
        };
    ...
    @:keep
    static public function _file( _p:stdgo.Ref<T_printer>, _src:stdgo.Ref<stdgo.go.ast.Ast.File>):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
    ...
    @:keep
    static public function _declList( _p:stdgo.Ref<T_printer>, _list:stdgo.Slice<stdgo.go.ast.Ast.Decl>):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        ...
        for (__0 => _d in _list) {
            ...
            if ((_p._output.length) > (0 : stdgo.GoInt)) {
                ...
                _p._linebreak(_p._lineFor(_d.pos()), _min, (0 : stdgo.go.printer.Printer.T_whiteSpace), (_tok == (71 : stdgo.go.token.Token.Token)) && (_p._numLines(_d) > (1 : stdgo.GoInt)));
            };
            _p._decl(_d);
        };
    }
    @:keep
    static public function _decl( _p:stdgo.Ref<T_printer>, _decl:stdgo.go.ast.Ast.Decl):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        {
            final __type__ = _decl;
    ...
    @:keep
    static public function _funcDecl( _p:stdgo.Ref<T_printer>, _d:stdgo.Ref<stdgo.go.ast.Ast.FuncDecl>):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        ...
        var _startCol:stdgo.GoInt = _p._out.column - (("func " : stdgo.GoString).length);
    ...
    **/
    @:keep
    static public function _distanceFrom( _p:stdgo.Ref<T_printer>, _startPos:stdgo.go.token.Token.Pos, _startOutCol:stdgo.GoInt):stdgo.GoInt {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
    ...
    **/
    @:keep
    static public function _funcBody( _p:stdgo.Ref<T_printer>, _headerSize:stdgo.GoInt, _sep:T_whiteSpace, _b:stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        var __deferstack__:Array<Void -> Void> = [];
        try {
            ...
            {};
            if ((_headerSize + _p._bodySize(_b, (100 : stdgo.GoInt))) <= (100 : stdgo.GoInt)) {
                ...
                if ((_b.list.length) > (0 : stdgo.GoInt)) {
                    _p._print(stdgo.Go.toInterface((32 : stdgo.go.printer.Printer.T_whiteSpace)));
                    for (_i => _s in _b.list) {
                        ...
                        _p._stmt(_s, _i == (_b.list.length - (1 : stdgo.GoInt)));
                    };
                    _p._print(stdgo.Go.toInterface((32 : stdgo.go.printer.Printer.T_whiteSpace)));
                };
    ...
    **/
    @:keep
    static public function _bodySize( _p:stdgo.Ref<T_printer>, _b:stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>, _maxSize:stdgo.GoInt):stdgo.GoInt {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        ...
        if ((_pos1.isValid() && _pos2.isValid()) && (_p._lineFor(_pos1) != _p._lineFor(_pos2))) {
            return _maxSize + (1 : stdgo.GoInt);
        };
        if ((_b.list.length) > (5 : stdgo.GoInt)) {
            return _maxSize + (1 : stdgo.GoInt);
        };
        ...
        for (_i => _s in _b.list) {
            ...
            if (_i > (0 : stdgo.GoInt)) {
                _bodySize = _bodySize + ((2 : stdgo.GoInt));
            };
    ...
    **/
    @:keep
    static public function _numLines( _p:stdgo.Ref<T_printer>, _n:stdgo.go.ast.Ast.Node):stdgo.GoInt {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        {
            ...
            if (_from.isValid()) {
                {
                    ...
                    if (_to.isValid()) {
                        return (_p._lineFor(_to) - _p._lineFor(_from)) + (1 : stdgo.GoInt);
                    };
                };
            };
        };
    ...
    **/
    @:keep
    static public function _nodeSize( _p:stdgo.Ref<T_printer>, _n:stdgo.go.ast.Ast.Node, _maxSize:stdgo.GoInt):stdgo.GoInt {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        var _size:stdgo.GoInt = (0 : stdgo.GoInt);
        {
        ...
        {
            var _err:stdgo.Error = _cfg._fprint(stdgo.Go.asInterface((stdgo.Go.setRef(_counter) : stdgo.Ref<stdgo.go.printer.Printer.T_sizeCounter>)), _p._fset, stdgo.Go.toInterface(_n), _p._nodeSizes);
            if (_err != null) {
                return _size;
            };
        };
    ...
    @:keep
    static public function _genDecl( _p:stdgo.Ref<T_printer>, _d:stdgo.Ref<stdgo.go.ast.Ast.GenDecl>):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        _p._setComment(_d.doc);
        _p._setPos(_d.pos());
        _p._print(stdgo.Go.toInterface(stdgo.Go.asInterface(_d.tok)), stdgo.Go.toInterface((32 : stdgo.go.printer.Printer.T_whiteSpace)));
        if (_d.lparen.isValid() || (_d.specs.length > (1 : stdgo.GoInt))) {
            ...
            _p._print(stdgo.Go.toInterface(stdgo.Go.asInterface((49 : stdgo.go.token.Token.Token))));
            {
                ...
                if (_n > (0 : stdgo.GoInt)) {
                    ...
                    if ((_n > (1 : stdgo.GoInt)) && ((_d.tok == (64 : stdgo.go.token.Token.Token)) || (_d.tok == (85 : stdgo.go.token.Token.Token)))) {
                        var _keepType = _keepTypeColumn(_d.specs);
                        var _line:stdgo.GoInt = (0 : stdgo.GoInt);
                        for (_i => _s in _d.specs) {
                            if (_i > (0 : stdgo.GoInt)) {
                                _p._linebreak(_p._lineFor(_s.pos()), (1 : stdgo.GoInt), (0 : stdgo.go.printer.Printer.T_whiteSpace), _p._linesFrom(_line) > (0 : stdgo.GoInt));
                            };
                            _p._recordLine(stdgo.Go.pointer(_line));
                            _p._valueSpec((stdgo.Go.typeAssert((stdgo.Go.toInterface(_s) : stdgo.Ref<stdgo.go.ast.Ast.ValueSpec>)) : stdgo.Ref<stdgo.go.ast.Ast.ValueSpec>), _keepType[(_i : stdgo.GoInt)]);
                        };
                    } else {
                        var _line:stdgo.GoInt = (0 : stdgo.GoInt);
                        for (_i => _s in _d.specs) {
        ...
        } else if ((_d.specs.length) > (0 : stdgo.GoInt)) {
    ...
    **/
    @:keep
    static public function _spec( _p:stdgo.Ref<T_printer>, _spec:stdgo.go.ast.Ast.Spec, _n:stdgo.GoInt, _doIndent:Bool):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        {
            ...
            if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo.go.ast.Ast.ImportSpec>))) {
                ...
                if (_s.values != null) {
                    ...
                    _p._exprList((0 : stdgo.go.token.Token.Pos), _s.values, (1 : stdgo.GoInt), (0u32 : stdgo.go.printer.Printer.T_exprListMode), (0 : stdgo.go.token.Token.Pos), false);
                };
                _p._setComment(_s.comment);
            } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo.go.ast.Ast.TypeSpec>))) {
    ...
    @:keep
    static public function _valueSpec( _p:stdgo.Ref<T_printer>, _s:stdgo.Ref<stdgo.go.ast.Ast.ValueSpec>, _keepType:Bool):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        _p._setComment(_s.doc);
        ...
        if (_s.comment != null && ((_s.comment : Dynamic).__nil__ == null || !(_s.comment : Dynamic).__nil__)) {
            stdgo.Go.cfor(_extraTabs > (0 : stdgo.GoInt), _extraTabs--, {
                _p._print(stdgo.Go.toInterface((11 : stdgo.go.printer.Printer.T_whiteSpace)));
            });
            _p._setComment(_s.comment);
        };
    ...
    @:keep
    static public function _stmt( _p:stdgo.Ref<T_printer>, _stmt:stdgo.go.ast.Ast.Stmt, _nextIsRBrace:Bool):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        _p._setPos(_stmt.pos());
        {
            final __type__ = _stmt;
            {
                ...
                while (__bool__) {
                    __bool__ = false;
                    if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo.go.ast.Ast.BadStmt>))) {
                        var _s:stdgo.Ref<stdgo.go.ast.Ast.BadStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BadStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BadStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BadStmt>) : __type__.__underlying__().value;
                        ...
                        _p._decl(_s.decl);
                    } else if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo.go.ast.Ast.EmptyStmt>))) {
                        var _s:stdgo.Ref<stdgo.go.ast.Ast.EmptyStmt> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.EmptyStmt>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.EmptyStmt>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.EmptyStmt>) : __type__.__underlying__().value;
                        ...
                        {
                            var __tmp__ = try {
                                { _0 : (stdgo.Go.typeAssert((stdgo.Go.toInterface(_s.stmt) : stdgo.Ref<stdgo.go.ast.Ast.EmptyStmt>)) : stdgo.Ref<stdgo.go.ast.Ast.EmptyStmt>), _1 : true };
                            } catch(_) {
                            ...
                            if (_isEmpty) {
                                ...
                                _p._linebreak(_p._lineFor(_s.stmt.pos()), (1 : stdgo.GoInt), (0 : stdgo.go.printer.Printer.T_whiteSpace), true);
                            };
                        };
                        ...
                        if (_s.results != null) {
                            ...
                            if (_p._indentList(_s.results)) {
                                ...
                                _p._exprList((0 : stdgo.go.token.Token.Pos), _s.results, (1 : stdgo.GoInt), (2u32 : stdgo.go.printer.Printer.T_exprListMode), (0 : stdgo.go.token.Token.Pos), false);
                                _p._print(stdgo.Go.toInterface((60 : stdgo.go.printer.Printer.T_whiteSpace)));
                            } else {
                                _p._exprList((0 : stdgo.go.token.Token.Pos), _s.results, (1 : stdgo.GoInt), (0u32 : stdgo.go.printer.Printer.T_exprListMode), (0 : stdgo.go.token.Token.Pos), false);
                            };
                        };
                        ...
                        if (_s.else_ != null) {
                            _p._print(stdgo.Go.toInterface((32 : stdgo.go.printer.Printer.T_whiteSpace)), stdgo.Go.toInterface(stdgo.Go.asInterface((68 : stdgo.go.token.Token.Token))), stdgo.Go.toInterface((32 : stdgo.go.printer.Printer.T_whiteSpace)));
                            {
                                ...
                                if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>)) || stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo.go.ast.Ast.IfStmt>))) {
                        ...
                        if (_s.list != null) {
                            ...
                            _p._exprList(_s.pos(), _s.list, (1 : stdgo.GoInt), (0u32 : stdgo.go.printer.Printer.T_exprListMode), _s.colon, false);
                        } else {
                        ...
                        var _body = _s.body;
                        if ((_body.list.length == (0 : stdgo.GoInt)) && !_p._commentBefore(_p._posFor(_body.rbrace)?.__copy__())) {
    ...
    **/
    @:keep
    static public function _indentList( _p:stdgo.Ref<T_printer>, _list:stdgo.Slice<stdgo.go.ast.Ast.Expr>):Bool {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        if ((_list.length) >= (2 : stdgo.GoInt)) {
    ...
    @:keep
    static public function _controlClause( _p:stdgo.Ref<T_printer>, _isForStmt:Bool, _init:stdgo.go.ast.Ast.Stmt, _expr:stdgo.go.ast.Ast.Expr, _post:stdgo.go.ast.Ast.Stmt):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        _p._print(stdgo.Go.toInterface((32 : stdgo.go.printer.Printer.T_whiteSpace)));
    ...
    **/
    @:keep
    static public function _block( _p:stdgo.Ref<T_printer>, _b:stdgo.Ref<stdgo.go.ast.Ast.BlockStmt>, _nindent:stdgo.GoInt):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        _p._setPos(_b.lbrace);
        _p._print(stdgo.Go.toInterface(stdgo.Go.asInterface((51 : stdgo.go.token.Token.Token))));
        _p._stmtList(_b.list, _nindent, true);
        _p._linebreak(_p._lineFor(_b.rbrace), (1 : stdgo.GoInt), (0 : stdgo.go.printer.Printer.T_whiteSpace), true);
        _p._setPos(_b.rbrace);
        _p._print(stdgo.Go.toInterface(stdgo.Go.asInterface((56 : stdgo.go.token.Token.Token))));
    }
    /**
    ...
    **/
    @:keep
    static public function _stmtList( _p:stdgo.Ref<T_printer>, _list:stdgo.Slice<stdgo.go.ast.Ast.Stmt>, _nindent:stdgo.GoInt, _nextIsRBrace:Bool):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        if (_nindent > (0 : stdgo.GoInt)) {
            _p._print(stdgo.Go.toInterface((62 : stdgo.go.printer.Printer.T_whiteSpace)));
        };
        var _line:stdgo.GoInt = (0 : stdgo.GoInt);
        var _i:stdgo.GoInt = (0 : stdgo.GoInt);
        for (__8 => _s in _list) {
            {
                var __tmp__ = try {
                    { _0 : (stdgo.Go.typeAssert((stdgo.Go.toInterface(_s) : stdgo.Ref<stdgo.go.ast.Ast.EmptyStmt>)) : stdgo.Ref<stdgo.go.ast.Ast.EmptyStmt>), _1 : true };
                } catch(_) {
                    { _0 : (null : stdgo.Ref<stdgo.go.ast.Ast.EmptyStmt>), _1 : false };
                }, __9 = __tmp__._0, _isEmpty = __tmp__._1;
                if (!_isEmpty) {
                    if ((_p._output.length) > (0 : stdgo.GoInt)) {
                        _p._linebreak(_p._lineFor(_s.pos()), (1 : stdgo.GoInt), (0 : stdgo.go.printer.Printer.T_whiteSpace), ((_i == (0 : stdgo.GoInt)) || (_nindent == (0 : stdgo.GoInt))) || (_p._linesFrom(_line) > (0 : stdgo.GoInt)));
                    };
                    _p._recordLine(stdgo.Go.pointer(_line));
                    _p._stmt(_s, _nextIsRBrace && (_i == (_list.length - (1 : stdgo.GoInt))));
                    {
                        var _t:stdgo.go.ast.Ast.Stmt = _s;
                        while (true) {
                            var __tmp__ = try {
                                { _0 : (stdgo.Go.typeAssert((stdgo.Go.toInterface(_t) : stdgo.Ref<stdgo.go.ast.Ast.LabeledStmt>)) : stdgo.Ref<stdgo.go.ast.Ast.LabeledStmt>), _1 : true };
                            } catch(_) {
                                { _0 : (null : stdgo.Ref<stdgo.go.ast.Ast.LabeledStmt>), _1 : false };
    ...
    @:keep
    static public function _expr( _p:stdgo.Ref<T_printer>, _x:stdgo.go.ast.Ast.Expr):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        {};
        _p._expr1(_x, (0 : stdgo.GoInt), (1 : stdgo.GoInt));
    }
    @:keep
    static public function _expr0( _p:stdgo.Ref<T_printer>, _x:stdgo.go.ast.Ast.Expr, _depth:stdgo.GoInt):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
    ...
    **/
    @:keep
    static public function _selectorExpr( _p:stdgo.Ref<T_printer>, _x:stdgo.Ref<stdgo.go.ast.Ast.SelectorExpr>, _depth:stdgo.GoInt, _isMethod:Bool):Bool {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
    ...
    @:keep
    static public function _possibleSelectorExpr( _p:stdgo.Ref<T_printer>, _expr:stdgo.go.ast.Ast.Expr, _prec1:stdgo.GoInt, _depth:stdgo.GoInt):Bool {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        {
            var __tmp__ = try {
                { _0 : (stdgo.Go.typeAssert((stdgo.Go.toInterface(_expr) : stdgo.Ref<stdgo.go.ast.Ast.SelectorExpr>)) : stdgo.Ref<stdgo.go.ast.Ast.SelectorExpr>), _1 : true };
            } catch(_) {
    ...
    @:keep
    static public function _expr1( _p:stdgo.Ref<T_printer>, _expr:stdgo.go.ast.Ast.Expr, _prec1:stdgo.GoInt, _depth:stdgo.GoInt):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        _p._setPos(_expr.pos());
        {
            final __type__ = _expr;
            if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo.go.ast.Ast.BadExpr>))) {
                var _x:stdgo.Ref<stdgo.go.ast.Ast.BadExpr> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BadExpr>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BadExpr>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.BadExpr>) : __type__.__underlying__().value;
                ...
                {
                    var __tmp__ = try {
                        { _0 : (stdgo.Go.typeAssert((stdgo.Go.toInterface(_x.x) : stdgo.Ref<stdgo.go.ast.Ast.ParenExpr>)) : stdgo.Ref<stdgo.go.ast.Ast.ParenExpr>), _1 : true };
                    } catch(_) {
                        { _0 : (null : stdgo.Ref<stdgo.go.ast.Ast.ParenExpr>), _1 : false };
                ...
                var _x:stdgo.Ref<stdgo.go.ast.Ast.IndexExpr> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.IndexExpr>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.IndexExpr>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.IndexExpr>) : __type__.__underlying__().value;
                ...
                _p._expr0(_x.index, _depth + (1 : stdgo.GoInt));
                ...
                var _x:stdgo.Ref<stdgo.go.ast.Ast.IndexListExpr> = __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.IndexListExpr>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.IndexListExpr>) : __type__ == null ? (null : stdgo.Ref<stdgo.go.ast.Ast.IndexListExpr>) : __type__.__underlying__().value;
                _p._expr1(_x.x, (7 : stdgo.GoInt), (1 : stdgo.GoInt));
                _p._setPos(_x.lbrack);
                _p._print(stdgo.Go.toInterface(stdgo.Go.asInterface((50 : stdgo.go.token.Token.Token))));
                _p._exprList(_x.lbrack, _x.indices, _depth + (1 : stdgo.GoInt), (1u32 : stdgo.go.printer.Printer.T_exprListMode), _x.rbrack, false);
                _p._setPos(_x.rbrack);
                _p._print(stdgo.Go.toInterface(stdgo.Go.asInterface((55 : stdgo.go.token.Token.Token))));
                ...
                if (_depth <= (1 : stdgo.GoInt)) {
                    ...
                    if ((_indexCount > (1 : stdgo.GoInt)) && _hasBinaries) {
                        _needsBlanks = true;
                    };
                };
                for (_i => _x in _indices) {
                    if (_i > (0 : stdgo.GoInt)) {
                        if ((_indices[(_i - (1 : stdgo.GoInt) : stdgo.GoInt)] != null) && _needsBlanks) {
                            _p._print(stdgo.Go.toInterface((32 : stdgo.go.printer.Printer.T_whiteSpace)));
                        };
                        _p._print(stdgo.Go.toInterface(stdgo.Go.asInterface((58 : stdgo.go.token.Token.Token))));
                    ...
                    if (_x != null) {
                        _p._expr0(_x, _depth + (1 : stdgo.GoInt));
                    };
                };
                _p._setPos(_x.rbrack);
                _p._print(stdgo.Go.toInterface(stdgo.Go.asInterface((55 : stdgo.go.token.Token.Token))));
                ...
                if ((_x.args.length) > (1 : stdgo.GoInt)) {
                    _depth++;
                };
                var _wasIndented:Bool = false;
                {
                    var __tmp__ = try {
                        { _0 : (stdgo.Go.typeAssert((stdgo.Go.toInterface(_x.fun) : stdgo.Ref<stdgo.go.ast.Ast.FuncType>)) : stdgo.Ref<stdgo.go.ast.Ast.FuncType>), _1 : true };
                    } catch(_) {
                ...
                _p._print(stdgo.Go.toInterface(stdgo.Go.asInterface((51 : stdgo.go.token.Token.Token))));
                _p._exprList(_x.lbrace, _x.elts, (1 : stdgo.GoInt), (1u32 : stdgo.go.printer.Printer.T_exprListMode), _x.rbrace, _x.incomplete);
    ...
    **/
    @:keep
    static public function _binaryExpr( _p:stdgo.Ref<T_printer>, _x:stdgo.Ref<stdgo.go.ast.Ast.BinaryExpr>, _prec1:stdgo.GoInt, _cutoff:stdgo.GoInt, _depth:stdgo.GoInt):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        ...
        _p._setPos(_x.opPos);
        _p._print(stdgo.Go.toInterface(stdgo.Go.asInterface(_x.op)));
        if (((_xline != _yline) && (_xline > (0 : stdgo.GoInt))) && (_yline > (0 : stdgo.GoInt))) {
            if (_p._linebreak(_yline, (1 : stdgo.GoInt), _ws, true) > (0 : stdgo.GoInt)) {
        ...
        _p._expr1(_x.y, _prec + (1 : stdgo.GoInt), _depth + (1 : stdgo.GoInt));
        if (_ws == ((0 : stdgo.go.printer.Printer.T_whiteSpace))) {
            _p._print(stdgo.Go.toInterface((60 : stdgo.go.printer.Printer.T_whiteSpace)));
        };
    }
    @:keep
    static public function _fieldList( _p:stdgo.Ref<T_printer>, _fields:stdgo.Ref<stdgo.go.ast.Ast.FieldList>, _isStruct:Bool, _isIncomplete:Bool):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
            ...
            if ((_list.length) == ((0 : stdgo.GoInt))) {
                ...
                if (_isStruct) {
                    ...
                    if ((_f.names.length) > (0 : stdgo.GoInt)) {
                        ...
                        _p._signature((stdgo.Go.typeAssert((stdgo.Go.toInterface(_f.type) : stdgo.Ref<stdgo.go.ast.Ast.FuncType>)) : stdgo.Ref<stdgo.go.ast.Ast.FuncType>));
                    } else {
                        _p._expr(_f.type);
                    };
                };
        ...
        if (_hasComments || (_list.length > (0 : stdgo.GoInt))) {
        ...
        if (_isStruct) {
            ...
            for (_i => _f in _list) {
                if (_i > (0 : stdgo.GoInt)) {
                    _p._linebreak(_p._lineFor(_f.pos()), (1 : stdgo.GoInt), (0 : stdgo.go.printer.Printer.T_whiteSpace), _p._linesFrom(_line) > (0 : stdgo.GoInt));
                };
                ...
                if (_f.tag != null && ((_f.tag : Dynamic).__nil__ == null || !(_f.tag : Dynamic).__nil__)) {
                    if ((_f.names.length > (0 : stdgo.GoInt)) && (_sep == (11 : stdgo.go.printer.Printer.T_whiteSpace))) {
                        _p._print(stdgo.Go.toInterface(_sep));
                    };
                    _p._print(stdgo.Go.toInterface(_sep));
            ...
            var _line:stdgo.GoInt = (0 : stdgo.GoInt);
            var _prev:stdgo.Ref<stdgo.go.ast.Ast.Ident> = (null : stdgo.Ref<stdgo.go.ast.Ast.Ident>);
            for (_i => _f in _list) {
                var _name:stdgo.Ref<stdgo.go.ast.Ast.Ident> = (null : stdgo.Ref<stdgo.go.ast.Ast.Ident>);
                if ((_f.names.length) > (0 : stdgo.GoInt)) {
                ...
                if (_i > (0 : stdgo.GoInt)) {
                    ...
                    _p._linebreak(_p._lineFor(_f.pos()), _min, (0 : stdgo.go.printer.Printer.T_whiteSpace), _p._linesFrom(_line) > (0 : stdgo.GoInt));
                };
                _p._setComment(_f.doc);
                _p._recordLine(stdgo.Go.pointer(_line));
    ...
    static public function _setLineComment( _p:stdgo.Ref<T_printer>, _text:stdgo.GoString):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        _p._setComment((stdgo.Go.setRef(({ list : (new stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Comment>>(1, 1, ({ slash : (0 : stdgo.go.token.Token.Pos), text : _text?.__copy__() } : stdgo.go.ast.Ast.Comment)) : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Comment>>) } : stdgo.go.ast.Ast.CommentGroup)) : stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>));
    }
    @:keep
    static public function _isOneLineFieldList( _p:stdgo.Ref<T_printer>, _list:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Field>>):Bool {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        if ((_list.length) != ((1 : stdgo.GoInt))) {
            return false;
        };
        ...
        if (_namesSize > (0 : stdgo.GoInt)) {
            _namesSize = (1 : stdgo.GoInt);
        };
        var _typeSize:stdgo.GoInt = _p._nodeSize(_f.type, (30 : stdgo.GoInt));
        return (_namesSize + _typeSize) <= (30 : stdgo.GoInt);
    }
    @:keep
    static public function _signature( _p:stdgo.Ref<T_printer>, _sig:stdgo.Ref<stdgo.go.ast.Ast.FuncType>):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        ...
        if (_n > (0 : stdgo.GoInt)) {
            _p._print(stdgo.Go.toInterface((32 : stdgo.go.printer.Printer.T_whiteSpace)));
            if ((_n == (1 : stdgo.GoInt)) && (_res.list[(0 : stdgo.GoInt)].names == null)) {
    ...
    @:keep
    static public function _parameters( _p:stdgo.Ref<T_printer>, _fields:stdgo.Ref<stdgo.go.ast.Ast.FieldList>, _mode:T_paramMode):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        ...
        if ((_fields.list.length) > (0 : stdgo.GoInt)) {
            ...
            for (_i => _par in _fields.list) {
                ...
                var _needsLinebreak:Bool = ((0 : stdgo.GoInt) < _prevLine) && (_prevLine < _parLineBeg);
                if (_i > (0 : stdgo.GoInt)) {
                    if (!_needsLinebreak) {
                        _p._setPos(_par.pos());
                    };
                ...
                if (_needsLinebreak && (_p._linebreak(_parLineBeg, (0 : stdgo.GoInt), _ws, true) > (0 : stdgo.GoInt))) {
                    _ws = (0 : stdgo.go.printer.Printer.T_whiteSpace);
                } else if (_i > (0 : stdgo.GoInt)) {
                    _p._print(stdgo.Go.toInterface((32 : stdgo.go.printer.Printer.T_whiteSpace)));
                };
                if ((_par.names.length) > (0 : stdgo.GoInt)) {
            ...
            };
            {
                ...
                if (((0 : stdgo.GoInt) < _prevLine) && (_prevLine < _closing)) {
                    _p._print(stdgo.Go.toInterface(stdgo.Go.asInterface((52 : stdgo.go.token.Token.Token))));
                    _p._linebreak(_closing, (0 : stdgo.GoInt), (0 : stdgo.go.printer.Printer.T_whiteSpace), true);
                } else if (((_mode == (2 : stdgo.go.printer.Printer.T_paramMode)) && (_fields.numFields() == (1 : stdgo.GoInt))) && _combinesWithName(_fields.list[(0 : stdgo.GoInt)].type)) {
                    _p._print(stdgo.Go.toInterface(stdgo.Go.asInterface((52 : stdgo.go.token.Token.Token))));
                };
            };
            if (_ws == ((0 : stdgo.go.printer.Printer.T_whiteSpace))) {
    ...
    **/
    @:keep
    static public function _exprList( _p:stdgo.Ref<T_printer>, _prev0:stdgo.go.token.Token.Pos, _list:stdgo.Slice<stdgo.go.ast.Ast.Expr>, _depth:stdgo.GoInt, _mode:T_exprListMode, _next0:stdgo.go.token.Token.Pos, _isIncomplete:Bool):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        if ((_list.length) == ((0 : stdgo.GoInt))) {
            if (_isIncomplete) {
        ...
        if ((_prev.isValid() && (_prev.line < _line)) && (_p._linebreak(_line, (0 : stdgo.GoInt), _ws, true) > (0 : stdgo.GoInt))) {
            _ws = (0 : stdgo.go.printer.Printer.T_whiteSpace);
        ...
        for (_i => _x in _list) {
            ...
            var __tmp__ = try {
                { _0 : (stdgo.Go.typeAssert((stdgo.Go.toInterface(_x) : stdgo.Ref<stdgo.go.ast.Ast.KeyValueExpr>)) : stdgo.Ref<stdgo.go.ast.Ast.KeyValueExpr>), _1 : true };
            } catch(_) {
                { _0 : (null : stdgo.Ref<stdgo.go.ast.Ast.KeyValueExpr>), _1 : false };
            }, _pair = __tmp__._0, _isPair = __tmp__._1;
            if (((_size <= (1000000 : stdgo.GoInt)) && _prev.isValid()) && _next.isValid()) {
                if (_isPair) {
            ...
            if ((_prevSize > (0 : stdgo.GoInt)) && (_size > (0 : stdgo.GoInt))) {
                {};
                if ((_count == (0 : stdgo.GoInt)) || ((_prevSize <= (40 : stdgo.GoInt)) && (_size <= (40 : stdgo.GoInt)))) {
                    _useFF = false;
                } else {
                    {};
                    var _geomean:stdgo.GoFloat64 = stdgo.math.Math.exp(_lnsum / (_count : stdgo.GoFloat64));
                    var _ratio:stdgo.GoFloat64 = (_size : stdgo.GoFloat64) / _geomean;
                    _useFF = (((2.5 : stdgo.GoFloat64) * _ratio) <= (1 : stdgo.GoFloat64)) || ((2.5 : stdgo.GoFloat64) <= _ratio);
                };
            };
            var _needsLinebreak:Bool = ((0 : stdgo.GoInt) < _prevLine) && (_prevLine < _line);
            if (_i > (0 : stdgo.GoInt)) {
                if (!_needsLinebreak) {
                    _p._setPos(_x.pos());
                };
                ...
                if (_needsLinebreak) {
                    var _nbreaks:stdgo.GoInt = _p._linebreak(_line, (0 : stdgo.GoInt), _ws, _useFF || ((_prevBreak + (1 : stdgo.GoInt)) < _i));
                    if (_nbreaks > (0 : stdgo.GoInt)) {
                        _ws = (0 : stdgo.go.printer.Printer.T_whiteSpace);
                        _prevBreak = _i;
                        _needsBlank = false;
                    };
                    if (_nbreaks > (1 : stdgo.GoInt)) {
            ...
            if ((((_list.length > (1 : stdgo.GoInt)) && _isPair) && (_size > (0 : stdgo.GoInt))) && _needsLinebreak) {
                _p._expr(_pair.key);
            ...
            if (_size > (0 : stdgo.GoInt)) {
                _lnsum = _lnsum + (stdgo.math.Math.log((_size : stdgo.GoFloat64)));
                _count++;
            };
            _prevLine = _line;
        };
    ...
    **/
    @:keep
    static public function _identList( _p:stdgo.Ref<T_printer>, _list:stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.Ident>>, _indent:Bool):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        var _xlist = new stdgo.Slice<stdgo.go.ast.Ast.Expr>((_list.length : stdgo.GoInt).toBasic(), 0);
        for (_i => _x in _list) {
            _xlist[(_i : stdgo.GoInt)] = stdgo.Go.asInterface(_x);
        };
        var _mode:T_exprListMode = ((0 : stdgo.GoUInt) : stdgo.go.printer.Printer.T_exprListMode);
        if (!_indent) {
            _mode = (2u32 : stdgo.go.printer.Printer.T_exprListMode);
        };
        _p._exprList((0 : stdgo.go.token.Token.Pos), _xlist, (1 : stdgo.GoInt), _mode, (0 : stdgo.go.token.Token.Pos), false);
    }
    /**
        // setComment sets g as the next comment if g != nil and if node comments
        // are enabled - this mode is used when printing source code fragments such
    ...
    **/
    @:keep
    static public function _setComment( _p:stdgo.Ref<T_printer>, _g:stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        if (((_g == null) || (_g : Dynamic).__nil__) || !_p._useNodeComments) {
            return;
        };
        if (_p._comments == null) {
            _p._comments = new stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>((1 : stdgo.GoInt).toBasic(), 0);
        } else if (_p._commentInfo._cindex < (_p._comments.length)) {
            _p._flush(_p._posFor(_g.list[(0 : stdgo.GoInt)].pos())?.__copy__(), (0 : stdgo.go.token.Token.Token));
            _p._comments = (_p._comments.__slice__((0 : stdgo.GoInt), (1 : stdgo.GoInt)) : stdgo.Slice<stdgo.Ref<stdgo.go.ast.Ast.CommentGroup>>);
    ...
    **/
    ...
    static public function _linebreak( _p:stdgo.Ref<T_printer>, _line:stdgo.GoInt, _min:stdgo.GoInt, _ws:T_whiteSpace, _newSection:Bool):stdgo.GoInt {
        ...
        var _n:stdgo.GoInt = _nlimit(_line - _p._pos.line);
        if (_n < _min) {
            _n = _min;
        };
        if (_n > (0 : stdgo.GoInt)) {
    ...
    static public function _commentTextAt( _p:stdgo.Ref<T_printer>, _start:stdgo.GoInt):stdgo.GoString {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        if ((_start < _p._output.length) && (_p._output[(_start : stdgo.GoInt)] == (255 : stdgo.GoUInt8))) {
            _start++;
        };
        var _pos:stdgo.GoInt = _start;
        while (((_pos < _p._output.length) && (_p._output[(_pos : stdgo.GoInt)] != (255 : stdgo.GoUInt8))) && !_isNL(_p._output[(_pos : stdgo.GoInt)])) {
            _pos++;
        };
    ...
    static public function _lineAt( _p:stdgo.Ref<T_printer>, _start:stdgo.GoInt):stdgo.Slice<stdgo.GoByte> {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        var _pos:stdgo.GoInt = _start;
        while ((_pos < _p._output.length) && !_isNL(_p._output[(_pos : stdgo.GoInt)])) {
            _pos++;
        };
    ...
    static public function _fixGoBuildLines( _p:stdgo.Ref<T_printer>):Void {
        @:recv var _p:stdgo.Ref<T_printer> = _p;
        if ((_p._goBuild.length) + (_p._plusBuild.length) == ((0 : stdgo.GoInt))) {
            return;
        };
        var _insert:stdgo.GoInt = (0 : stdgo.GoInt);
        {
            ...
            while (true) {
                ...
                while ((_pos < _p._output.length) && ((_p._output[(_pos : stdgo.GoInt)] == (32 : stdgo.GoUInt8)) || (_p._output[(_pos : stdgo.GoInt)] == (9 : stdgo.GoUInt8)))) {
                    _pos++;
                };
                if (((((_pos + (3 : stdgo.GoInt)) < _p._output.length) && (_p._output[(_pos : stdgo.GoInt)] == (255 : stdgo.GoUInt8))) && (_p._output[(_pos + (1 : stdgo.GoInt) : stdgo.GoInt)] == (47 : stdgo.GoUInt8))) && (_p._output[(_pos + (2 : stdgo.GoInt) : stdgo.GoInt)] == (47 : stdgo.GoUInt8))) {
                    _blank = false;
                    while ((_pos < _p._output.length) && !_isNL(_p._output[(_pos : stdgo.GoInt)])) {
                        _pos++;
                    };
                };
                if ((_pos >= _p._output.length) || !_isNL(_p._output[(_pos : stdgo.GoInt)])) {
                    break;
                };
                _pos++;
                if (_blank) {
        ...
        if ((_p._goBuild.length > (0 : stdgo.GoInt)) && (_p._goBuild[(0 : stdgo.GoInt)] < _insert)) {
            _insert = _p._goBuild[(0 : stdgo.GoInt)];
        } else if ((_p._plusBuild.length > (0 : stdgo.GoInt)) && (_p._plusBuild[(0 : stdgo.GoInt)] < _insert)) {
                    ...
                    if (__value__ == ((0 : stdgo.GoInt))) {
                        for (__168 => _pos in _p._plusBuild) {
                            ...
                            if (_x == null) {
                                ...
                                _x = stdgo.Go.asInterface((stdgo.Go.setRef(({ x : _x, y : _y } : stdgo.go.build.constraint.Constraint.AndExpr)) : stdgo.Ref<stdgo.go.build.constraint.Constraint.AndExpr>));
                            };
                        };
                        break;
                    } else if (__value__ == ((1 : stdgo.GoInt))) {
                        {
                            var __tmp__ = stdgo.go.build.constraint.Constraint.parse(_p._commentTextAt(_p._goBuild[(0 : stdgo.GoInt)])?.__copy__());
                            _x = __tmp__._0;
                        };
                        break;
                    };
        ...
        if (_x == null) {
            ...
            if ((_p._plusBuild.length) > (0 : stdgo.GoInt)) {
        ...
        _after = _appendLines(_after, (_p._output.__slice__(_start) : stdgo.Slice<stdgo.GoUInt8>));
        {
            ...
            if (((_n >= (2 : stdgo.GoInt)) && _isNL(_after[(_n - (1 : stdgo.GoInt) : stdgo.GoInt)])) && _isNL(_after[(_n - (2 : stdgo.GoInt) : stdgo.GoInt)])) {
                _after = (_after.__slice__(0, _n - (1 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>);
            };
        };
    ...
    @:embedded
    public static function _fprint( __self__:T_printer, _output:stdgo.io.Io.Writer, _fset_:stdgo.Ref<stdgo.go.token.Token.FileSet>, _node:stdgo.AnyInterface, _nodeSizes:stdgo.GoMap<stdgo.go.ast.Ast.Node, stdgo.GoInt>):stdgo.Error return __self__._fprint(_output, _fset_, _node, _nodeSizes);
    @:embedded
    public static function fprint( __self__:T_printer, _output:stdgo.io.Io.Writer, _fset_:stdgo.Ref<stdgo.go.token.Token.FileSet>, _node:stdgo.AnyInterface):stdgo.Error return __self__.fprint(_output, _fset_, _node);
}
...
class Config_asInterface {
    ...
    **/
    @:keep
    public dynamic function fprint(_output:stdgo.io.Io.Writer, _fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, _node:stdgo.AnyInterface):stdgo.Error return __self__.value.fprint(_output, _fset, _node);
    /**
        // fprint implements Fprint and takes a nodesSizes map for setting up the printer state.
    **/
    @:keep
    public dynamic function _fprint(_output:stdgo.io.Io.Writer, _fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, _node:stdgo.AnyInterface, _nodeSizes:stdgo.GoMap<stdgo.go.ast.Ast.Node, stdgo.GoInt>):stdgo.Error return __self__.value._fprint(_output, _fset, _node, _nodeSizes);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
@:keep @:allow(stdgo.go.printer.Printer.Config_asInterface) class Config_static_extension {
    ...
    **/
    @:keep
    static public function fprint( _cfg:stdgo.Ref<Config>, _output:stdgo.io.Io.Writer, _fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, _node:stdgo.AnyInterface):stdgo.Error {
        @:recv var _cfg:stdgo.Ref<Config> = _cfg;
        return _cfg._fprint(_output, _fset, _node, ({
            final x = new stdgo.GoMap.GoObjectMap<stdgo.go.ast.Ast.Node, stdgo.GoInt>();
            ...
            @:mergeBlock {};
            cast x;
        } : stdgo.GoMap<stdgo.go.ast.Ast.Node, stdgo.GoInt>));
    }
    /**
        // fprint implements Fprint and takes a nodesSizes map for setting up the printer state.
    **/
    @:keep
    static public function _fprint( _cfg:stdgo.Ref<Config>, _output:stdgo.io.Io.Writer, _fset:stdgo.Ref<stdgo.go.token.Token.FileSet>, _node:stdgo.AnyInterface, _nodeSizes:stdgo.GoMap<stdgo.go.ast.Ast.Node, stdgo.GoInt>):stdgo.Error {
        @:recv var _cfg:stdgo.Ref<Config> = _cfg;
        var __deferstack__:Array<Void -> Void> = [];
        ...
        try {
            ...
            _p._impliedSemi = false;
            _p._flush(({ offset : (1073741824 : stdgo.GoInt), line : (1073741824 : stdgo.GoInt) } : stdgo.go.token.Token.Position), (1 : stdgo.go.token.Token.Token));
            _p._fixGoBuildLines();
            _output = stdgo.Go.asInterface((stdgo.Go.setRef(({ _output : _output } : stdgo.go.printer.Printer.T_trimmer)) : stdgo.Ref<stdgo.go.printer.Printer.T_trimmer>));
            if (_cfg.mode & (1u32 : stdgo.go.printer.Printer.Mode) == ((0u32 : stdgo.go.printer.Printer.Mode))) {
                ...
                if (_cfg.mode & (2u32 : stdgo.go.printer.Printer.Mode) != ((0u32 : stdgo.go.printer.Printer.Mode))) {
                    ...
                    _twmode = _twmode | ((16u32 : stdgo.GoUInt));
                };
                _output = stdgo.Go.asInterface(stdgo.text.tabwriter.Tabwriter.newWriter(_output, _minwidth, _cfg.tabwidth, (1 : stdgo.GoInt), _padchar, _twmode));
            };
            {
                {
            ...
            {
                var __tmp__ = try {
                    { _0 : (stdgo.Go.typeAssert((stdgo.Go.toInterface(_output) : stdgo.Ref<stdgo.text.tabwriter.Tabwriter.Writer>)) : stdgo.Ref<stdgo.text.tabwriter.Tabwriter.Writer>), _1 : true };
                } catch(_) {
                    { _0 : (null : stdgo.Ref<stdgo.text.tabwriter.Tabwriter.Writer>), _1 : false };
