...
private var _tests:Slice<stdgo.testing.Testing.InternalTest> = (new Slice<stdgo.testing.Testing.InternalTest>(0, 0,
	...
	(new stdgo.testing.Testing.InternalTest(("TestCommentedNode" : GoString),
		stdgo.go.printer.Printer.testCommentedNode) : stdgo.testing.Testing.InternalTest),
	...
	(new stdgo.testing.Testing.InternalTest(("TestParenthesizedDecl" : GoString),
		stdgo.go.printer.Printer.testParenthesizedDecl) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestIssue32854" : GoString), stdgo.go.printer.Printer.testIssue32854) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("Test" : GoString),
		stdgo.go.printer_test.Printer_test.test) : stdgo.testing.Testing.InternalTest)) : Slice<stdgo.testing.Testing.InternalTest>);
...
private var _benchmarks:Slice<stdgo.testing.Testing.InternalBenchmark> = (new Slice<stdgo.testing.Testing.InternalBenchmark>(0, 0,
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkPrint" : GoString),
		stdgo.go.printer.Printer.benchmarkPrint) : stdgo.testing.Testing.InternalBenchmark)) : Slice<stdgo.testing.Testing.InternalBenchmark>);
...
private var _examples:Slice<stdgo.testing.Testing.InternalExample> = (new Slice<stdgo.testing.Testing.InternalExample>(0, 0,
	(new stdgo.testing.Testing.InternalExample(("ExampleFprint" : GoString), stdgo.go.printer_test.Printer_test.exampleFprint,
