...
private var _tokens:GoArray<GoString> = {
...
private var _tests:Slice<T__struct_0> = (new Slice<T__struct_0>(0, 0, ({
	_filename: ("a" : GoString),
	_source: (new Slice<GoUInt8>(0, 0) : Slice<GoUInt8>),
	_size: (0 : GoInt),
	_lines: (new Slice<GoInt>(0, 0) : Slice<GoInt>)
} : T__struct_0), ({
	_filename: ("b" : GoString),
	_source: (("01234" : GoString) : Slice<GoByte>),
	_size: (5 : GoInt),
	_lines: (new Slice<GoInt>(0, 0, (0 : GoInt)) : Slice<GoInt>)
	} : T__struct_0), ({
	_filename: ("c" : GoString),
	_source: (("\n\n\n\n\n\n\n\n\n" : GoString) : Slice<GoByte>),
	_size: (9 : GoInt),
	_lines: (new Slice<GoInt>(0, 0, (0 : GoInt), (1 : GoInt), (2 : GoInt), (3 : GoInt), (4 : GoInt), (5 : GoInt), (6 : GoInt), (7 : GoInt),
		(8 : GoInt)) : Slice<GoInt>)
	} : T__struct_0), ({
	_filename: ("d" : GoString),
	_source: (null : Slice<GoUInt8>),
	_size: (100 : GoInt),
	_lines: (new Slice<GoInt>(0, 0, (0 : GoInt), (5 : GoInt), (10 : GoInt), (20 : GoInt), (30 : GoInt), (70 : GoInt), (71 : GoInt), (72 : GoInt),
		(80 : GoInt), (85 : GoInt), (90 : GoInt), (99 : GoInt)) : Slice<GoInt>)
	} : T__struct_0), ({
	_filename: ("e" : GoString),
	_source: (null : Slice<GoUInt8>),
	_size: (777 : GoInt),
	_lines: (new Slice<GoInt>(0, 0, (0 : GoInt), (80 : GoInt), (100 : GoInt), (120 : GoInt), (130 : GoInt), (180 : GoInt), (267 : GoInt), (455 : GoInt),
		(500 : GoInt), (567 : GoInt), (620 : GoInt)) : Slice<GoInt>)
	} : T__struct_0), ({
	_filename: ("f" : GoString),
	_source: (("package p\n\nimport \"fmt\"" : GoString) : Slice<GoByte>),
	_size: (23 : GoInt),
	_lines: (new Slice<GoInt>(0, 0, (0 : GoInt), (10 : GoInt), (11 : GoInt)) : Slice<GoInt>)
	} : T__struct_0), ({
	_filename: ("g" : GoString),
	_source: (("package p\n\nimport \"fmt\"\n" : GoString) : Slice<GoByte>),
	_size: (24 : GoInt),
	_lines: (new Slice<GoInt>(0, 0, (0 : GoInt), (10 : GoInt), (11 : GoInt)) : Slice<GoInt>)
	} : T__struct_0), ({
	_filename: ("h" : GoString),
	_source: (("package p\n\nimport \"fmt\"\n " : GoString) : Slice<GoByte>),
	_size: (25 : GoInt),
	_lines: (new Slice<GoInt>(0, 0, (0 : GoInt), (10 : GoInt), (11 : GoInt), (24 : GoInt)) : Slice<GoInt>)
...
/**
	// The list of tokens.
**/
final eof:Token = (89 : Token);

/**
	// The list of tokens.
**/
final comment:Token = (89 : Token);

/**
	// The list of tokens.
**/
private final _literal_beg:Token = (89 : Token);

/**
	// main// Identifiers and basic type literals
	// (these tokens stand for classes of literals)
**/
final ident:Token = (89 : Token);

/**
	// 12345// The list of tokens.
**/
final int_:Token = (89 : Token);

/**
	// 123.45// The list of tokens.
**/
final float_:Token = (89 : Token);

/**
	// 123.45i// The list of tokens.
**/
final imag:Token = (89 : Token);

/**
	// 'a'// The list of tokens.
**/
final char:Token = (89 : Token);

/**
	// "abc"// The list of tokens.
**/
final string:Token = (89 : Token);

/**
	// The list of tokens.
**/
private final _literal_end:Token = (89 : Token);

/**
	// The list of tokens.
**/
private final _operator_beg:Token = (89 : Token);

/**
	// +// Operators and delimiters
**/
final add:Token = (89 : Token);

/**
	// -// The list of tokens.
**/
final sub:Token = (89 : Token);

/**
	// */ / The list of tokens. * * / final mul:Token = (89 : Token);

/**
	// /// The list of tokens.
**/
final quo:Token = (89 : Token);

/**
	// %// The list of tokens.
**/
final rem:Token = (89 : Token);

/**
	// &// The list of tokens.
**/
final and:Token = (89 : Token);

/**
	// |// The list of tokens.
**/
final or:Token = (89 : Token);

/**
	// ^// The list of tokens.
**/
final xor:Token = (89 : Token);

/**
	// <<// The list of tokens.
**/
final shl:Token = (89 : Token);

/**
	// >>// The list of tokens.
**/
final shr:Token = (89 : Token);

/**
	// &^// The list of tokens.
**/
final and_NOT:Token = (89 : Token);

/**
	// +=// The list of tokens.
**/
final add_ASSIGN:Token = (89 : Token);

/**
	// -=// The list of tokens.
**/
final sub_ASSIGN:Token = (89 : Token);

/**
	// *=// The list of tokens.
**/
final mul_ASSIGN:Token = (89 : Token);

/**
	// /=// The list of tokens.
**/
final quo_ASSIGN:Token = (89 : Token);

/**
	// %=// The list of tokens.
**/
final rem_ASSIGN:Token = (89 : Token);

/**
	// &=// The list of tokens.
**/
final and_ASSIGN:Token = (89 : Token);

/**
	// |=// The list of tokens.
**/
final or_ASSIGN:Token = (89 : Token);

/**
	// ^=// The list of tokens.
**/
final xor_ASSIGN:Token = (89 : Token);

/**
	// <<=// The list of tokens.
**/
final shl_ASSIGN:Token = (89 : Token);

/**
	// >>=// The list of tokens.
**/
final shr_ASSIGN:Token = (89 : Token);

/**
	// &^=// The list of tokens.
**/
final and_NOT_ASSIGN:Token = (89 : Token);

/**
	// &&// The list of tokens.
**/
final land:Token = (89 : Token);

/**
	// ||// The list of tokens.
**/
final lor:Token = (89 : Token);

/**
	// <-// The list of tokens.
**/
final arrow:Token = (89 : Token);

/**
	// ++// The list of tokens.
**/
final inc:Token = (89 : Token);

/**
	// --// The list of tokens.
**/
final dec:Token = (89 : Token);

/**
	// ==// The list of tokens.
**/
final eql:Token = (89 : Token);

/**
	// <// The list of tokens.
**/
final lss:Token = (89 : Token);

/**
	// >// The list of tokens.
**/
final gtr:Token = (89 : Token);

/**
	// =// The list of tokens.
**/
final assign:Token = (89 : Token);

/**
	// !// The list of tokens.
**/
final not:Token = (89 : Token);

/**
	// !=// The list of tokens.
**/
final neq:Token = (89 : Token);

/**
	// <=// The list of tokens.
**/
final leq:Token = (89 : Token);

/**
	// >=// The list of tokens.
**/
final geq:Token = (89 : Token);

/**
	// :=// The list of tokens.
**/
final define:Token = (89 : Token);

/**
	// ...// The list of tokens.
**/
final ellipsis:Token = (89 : Token);

/**
	// (// The list of tokens.
**/
final lparen:Token = (89 : Token);

/**
	// [// The list of tokens.
**/
final lbrack:Token = (89 : Token);

/**
	// {// The list of tokens.
**/
final lbrace:Token = (89 : Token);

/**
	// ,// The list of tokens.
**/
final comma:Token = (89 : Token);

/**
	// .// The list of tokens.
**/
final period:Token = (89 : Token);

/**
	// )// The list of tokens.
**/
final rparen:Token = (89 : Token);

/**
	// ]// The list of tokens.
**/
final rbrack:Token = (89 : Token);

/**
	// }// The list of tokens.
**/
final rbrace:Token = (89 : Token);

/**
	// ;// The list of tokens.
**/
final semicolon:Token = (89 : Token);

/**
	// :// The list of tokens.
**/
final colon:Token = (89 : Token);

/**
	// The list of tokens.
**/
private final _operator_end:Token = (89 : Token);

/**
	// The list of tokens.
**/
private final _keyword_beg:Token = (89 : Token);

/**
	// Keywords
**/
final break_:Token = (89 : Token);

/**
	// The list of tokens.
**/
final case_:Token = (89 : Token);

/**
	// The list of tokens.
**/
final chan:Token = (89 : Token);

/**
	// The list of tokens.
**/
final const:Token = (89 : Token);

/**
	// The list of tokens.
**/
final continue_:Token = (89 : Token);

/**
	// The list of tokens.
**/
final default_:Token = (89 : Token);

/**
	// The list of tokens.
**/
final defer:Token = (89 : Token);

/**
	// The list of tokens.
**/
final else_:Token = (89 : Token);

/**
	// The list of tokens.
**/
final fallthrough:Token = (89 : Token);

/**
	// The list of tokens.
**/
final for_:Token = (89 : Token);

/**
	// The list of tokens.
**/
final func:Token = (89 : Token);

/**
	// The list of tokens.
**/
final go:Token = (89 : Token);

/**
	// The list of tokens.
**/
final goto:Token = (89 : Token);

/**
	// The list of tokens.
**/
final if_:Token = (89 : Token);

/**
	// The list of tokens.
**/
final import_:Token = (89 : Token);

/**
	// The list of tokens.
**/
final interface_:Token = (89 : Token);

/**
	// The list of tokens.
**/
final map:Token = (89 : Token);

/**
	// The list of tokens.
**/
final package_:Token = (89 : Token);

/**
	// The list of tokens.
**/
final range:Token = (89 : Token);

/**
	// The list of tokens.
**/
final return_:Token = (89 : Token);

/**
	// The list of tokens.
**/
final select:Token = (89 : Token);

/**
	// The list of tokens.
**/
final struct_:Token = (89 : Token);

/**
	// The list of tokens.
**/
final switch_:Token = (89 : Token);

/**
	// The list of tokens.
**/
final type:Token = (89 : Token);

/**
	// The list of tokens.
**/
final var_:Token = (89 : Token);

/**
	// The list of tokens.
**/
private final _keyword_end:Token = (89 : Token);

/**
	// The list of tokens.
**/
private final _additional_beg:Token = (89 : Token);

/**
	// additional tokens, handled in an ad-hoc manner
**/
final tilde:Token = (89 : Token);

/**
	// The list of tokens.
**/
private final _additional_end:Token = (89 : Token);

/**
	// non-operators// A set of constants for precedence-based expression parsing.
	// Non-operators have lowest precedence, followed by operators
	// starting with precedence 1 up to unary operators. The highest
	// precedence serves as "catch-all" precedence for selector,
	// indexing, and other operator and delimiter tokens.
**/
final lowestPrec:GoUInt64 = ("0" : GoUInt64);
...
/**
	...
	// indexing, and other operator and delimiter tokens.
**/
final unaryPrec:GoUInt64 = ("6" : GoUInt64);
...
/**
	...
	// indexing, and other operator and delimiter tokens.
**/
final highestPrec:GoUInt64 = ("7" : GoUInt64);
...
@:structInit @:using(stdgo.go.token.Token.FileSet_static_extension) class FileSet {
	...
	public var _last:stdgo.sync.atomic.Atomic.Pointer_<T> = {};

	public function new(?_mutex:stdgo.sync.Sync.RWMutex, ?_base:GoInt, ?_files:Slice<Ref<File>>, ?_last:stdgo.sync.atomic.Atomic.Pointer_<T>) {
		if (_mutex != null)
			this._mutex = _mutex;
		if (_base != null)
			this._base = _base;
...
private function _verifyPositions(_t:Ref<stdgo.testing.Testing.T>, _fset:Ref<FileSet>, _f:Ref<File>, _lines:Slice<GoInt>):Void {
	{
		...
		Go.cfor(_offs < _f.size(), _offs++, {
			...
			var __tmp__ = _linecol(_lines, _offs),
				_line:GoInt = __tmp__._0,
				_col:GoInt = __tmp__._1;
			var _msg:GoString = stdgo.fmt.Fmt.sprintf(("%s (offs = %d, p = %d)" : GoString), Go.toInterface(_f.name()), Go.toInterface(_offs),
				Go.toInterface(Go.asInterface(_p)));
			_checkPos(_t, _msg, (_f.position(_f.pos(_offs)) == null ? null : _f.position(_f.pos(_offs)).__copy__()),
				(new Position(_f.name(), _offs, _line, _col) : Position));
...
function testPositions(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	for (_0 => _test in _tests) {
		if ((_test._source != null) && (_test._source.length != _test._size)) {
			_t.errorf(("%s: inconsistent test case: got file size %d; want %d" : GoString), Go.toInterface(_test._filename),
				Go.toInterface((_test._source.length)), Go.toInterface(_test._size));
		};
		...
		for (_i => _offset in _test._lines) {
			...
			if (_f.lineCount() != (_i + (1 : GoInt))) {
				_t.errorf(("%s, AddLine: got line count %d; want %d" : GoString), Go.toInterface(_f.name()), Go.toInterface(_f.lineCount()),
					Go.toInterface(_i + (1 : GoInt)));
			};
			_f.addLine(_offset);
			if (_f.lineCount() != (_i + (1 : GoInt))) {
				_t.errorf(("%s, AddLine: got unchanged line count %d; want %d" : GoString), Go.toInterface(_f.name()), Go.toInterface(_f.lineCount()),
					Go.toInterface(_i + (1 : GoInt)));
			};
		...
		if (_f.lineCount() != ((_test._lines.length))) {
			_t.errorf(("%s, SetLines: got line count %d; want %d" : GoString), Go.toInterface(_f.name()), Go.toInterface(_f.lineCount()),
				Go.toInterface((_test._lines.length)));
		};
		...
		if (_f.lineCount() != ((_test._lines.length))) {
			_t.errorf(("%s, SetLinesForContent: got line count %d; want %d" : GoString), Go.toInterface(_f.name()), Go.toInterface(_f.lineCount()),
				Go.toInterface((_test._lines.length)));
		};
		_verifyPositions(_t, _fset, _f, _test._lines);
	};
...
function testLineInfo(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _lines = (new Slice<GoInt>(0, 0, (0 : GoInt), (42 : GoInt), (77 : GoInt), (100 : GoInt), (210 : GoInt), (220 : GoInt), (277 : GoInt), (300 : GoInt),
		(333 : GoInt), (401 : GoInt)) : Slice<GoInt>);
	for (_0 => _offs in _lines) {
		_f.addLine(_offs);
	...
	};
	{
		...
		Go.cfor(_offs <= _f.size(), _offs++, {
			...
			var _msg:GoString = stdgo.fmt.Fmt.sprintf(("%s (offs = %d, p = %d)" : GoString), Go.toInterface(_f.name()), Go.toInterface(_offs),
				Go.toInterface(Go.asInterface(_p)));
			_checkPos(_t, _msg, (_f.position(_f.pos(_offs)) == null ? null : _f.position(_f.pos(_offs)).__copy__()),
				(new Position(("bar" : GoString), _offs, (42 : GoInt), _col) : Position));
			_checkPos(_t, _msg, (_fset.position(_p) == null ? null : _fset.position(_p).__copy__()),
				(new Position(("bar" : GoString), _offs, (42 : GoInt), _col) : Position));
		});
	};
}
...
function testFileSetCacheUnlikely(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _fset = newFileSet();
	var _offsets = (new GoObjectMap<GoString, GoInt>(new stdgo.internal.reflect.Reflect._Type(stdgo.internal.reflect.Reflect.GoType.mapType({get: () ->
...
function testFileSetRace2(_t:Ref<stdgo.testing.Testing.T>):Void {
	{};
	var _0:Ref<FileSet> = newFileSet(),
		_1:Ref<File> = _fset.addFile(Go.str(), (-1 : GoInt), (1000 : GoInt)),
		_2:Chan<GoInt> = new Chan<GoInt>((2 : GoInt).toBasic(), () -> (0 : GoInt)),
		_ch:Chan<GoInt> = _2,
		_file:Ref<File> = _1,
		_fset:Ref<FileSet> = _0;
	Go.routine(() -> {
		var a = function():Void {
			{
				var _i:GoInt = (0 : GoInt);
	...
	_f.setLinesForContent((("one\ntwo\nthree\n" : GoString) : Slice<GoByte>));
	{
		...
		Go.cfor(_line <= (3 : GoInt), _line++, {
			...
			if ((_position.line != _line) || (_position.column != (1 : GoInt))) {
				_t.errorf(("LineStart(%d) returned wrong pos %d: %s" : GoString), Go.toInterface(_line), Go.toInterface(Go.asInterface(_pos)),
					Go.toInterface(Go.asInterface(_position)));
			};
		});
	};
}
		...
		if ((_p._files.length) != ((_q._files.length))) {
			{
				...
				return stdgo.fmt.Fmt.errorf(("different number of files: %d != %d" : GoString), Go.toInterface((_p._files.length)),
					Go.toInterface((_q._files.length)));
			};
		};
			...
			if (_f._base != (_g._base)) {
				{
					...
					return stdgo.fmt.Fmt.errorf(("different base for %q: %d != %d" : GoString), Go.toInterface(_f._name), Go.toInterface(_f._base),
						Go.toInterface(_g._base));
				};
			};
			if (_f._size != (_g._size)) {
				{
					...
					return stdgo.fmt.Fmt.errorf(("different size for %q: %d != %d" : GoString), Go.toInterface(_f._name), Go.toInterface(_f._size),
						Go.toInterface(_g._size));
				};
			};
...
function lookup(_ident:GoString):Token {
	{
		var __tmp__ = (_keywords != null
			&& _keywords.__exists__(_ident) ? {value: _keywords[_ident], ok: true} : {value: ((0 : GoInt) : Token), ok: false}),
			_tok:Token = __tmp__.value,
			_is_keyword:Bool = __tmp__.ok;
		if (_is_keyword) {
			return _tok;
		};
	};
...
function isKeyword(_name:GoString):Bool {
	var __tmp__ = (_keywords != null
		&& _keywords.__exists__(_name) ? {value: _keywords[_name], ok: true} : {value: ((0 : GoInt) : Token), ok: false}),
		_0:Token = __tmp__.value,
		_ok:Bool = __tmp__.ok;
	return _ok;
}
...
function isIdentifier(_name:GoString):Bool {
	...
	for (_i => _c in _name) {
		if ((!stdgo.unicode.Unicode.isLetter(_c) && (_c != (95 : GoInt32)))
			&& ((_i == (0 : GoInt)) || !stdgo.unicode.Unicode.isDigit(_c))) {
			return false;
		};
	};
	return true;
...
function testIsIdentifier(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _tests = (new Slice<T__struct_1>(0, 0, ({_name: ("Empty" : GoString), _in: Go.str(), _want: false} : T__struct_1),
		({_name: ("Space" : GoString), _in: (" " : GoString), _want: false} : T__struct_1),
		({_name: ("SpaceSuffix" : GoString), _in: ("foo " : GoString), _want: false} : T__struct_1),
		({_name: ("Number" : GoString), _in: ("123" : GoString), _want: false} : T__struct_1),
		({_name: ("Keyword" : GoString), _in: ("func" : GoString), _want: false} : T__struct_1),
		({_name: ("LettersASCII" : GoString), _in: ("foo" : GoString), _want: true} : T__struct_1),
		({_name: ("MixedASCII" : GoString), _in: ("_bar123" : GoString), _want: true} : T__struct_1),
		({_name: ("UppercaseKeyword" : GoString), _in: ("Func" : GoString), _want: true} : T__struct_1),
		({_name: ("LettersUnicode" : GoString), _in: ("fóö" : GoString), _want: true} : T__struct_1)) : Slice<T__struct_1>);
	for (_0 => _test in _tests) {
...
@:keep var _ = {
	try {
		_keywords = (new GoObjectMap<GoString, Token>(new stdgo.internal.reflect.Reflect._Type(stdgo.internal.reflect.Reflect.GoType.mapType({get: () ->
			@:implicitReturn throw "__return__"}, {get: () -> @:implicitReturn throw "__return__"}))) : GoMap<GoString, Token>);
		{
...
class File_asInterface {
	...
	**/
	@:keep
	public function position(_p:Pos):Position
		return __self__.value.position(_p);
	...
	**/
	@:keep
	public function positionFor(_p:Pos, _adjusted:Bool):Position
		return __self__.value.positionFor(_p, _adjusted);

	@:keep
	public function _position(_p:Pos, _adjusted:Bool):Position
		return __self__.value._position(_p, _adjusted);
	...
	**/
	@:keep
	public function _unpack(_offset:GoInt, _adjusted:Bool):{var _0:GoString; var _1:GoInt; var _2:GoInt;}
		return __self__.value._unpack(_offset, _adjusted);
	...
	**/
	@:keep
	public function line(_p:Pos):GoInt
		return __self__.value.line(_p);
	...
	**/
	@:keep
	public function offset(_p:Pos):GoInt
		return __self__.value.offset(_p);
	...
	**/
	@:keep
	public function pos(_offset:GoInt):Pos
		return __self__.value.pos(_offset);
	...
	**/
	@:keep
	public function addLineColumnInfo(_offset:GoInt, _filename:GoString, _line:GoInt, _column:GoInt):Void
		__self__.value.addLineColumnInfo(_offset, _filename, _line, _column);
	...
	**/
	@:keep
	public function addLineInfo(_offset:GoInt, _filename:GoString, _line:GoInt):Void
		__self__.value.addLineInfo(_offset, _filename, _line);
	...
	**/
	@:keep
	public function lineStart(_line:GoInt):Pos
		return __self__.value.lineStart(_line);
	...
	**/
	@:keep
	public function setLinesForContent(_content:Slice<GoByte>):Void
		__self__.value.setLinesForContent(_content);
	...
	**/
	@:keep
	public function setLines(_lines:Slice<GoInt>):Bool
		return __self__.value.setLines(_lines);
	...
	**/
	@:keep
	public function mergeLine(_line:GoInt):Void
		__self__.value.mergeLine(_line);
	...
	**/
	@:keep
	public function addLine(_offset:GoInt):Void
		__self__.value.addLine(_offset);

	/**
		// LineCount returns the number of lines in file f.
	**/
	@:keep
	public function lineCount():GoInt
		return __self__.value.lineCount();
	...
	**/
	@:keep
	public function base():GoInt
		return __self__.value.base();
...
@:keep @:allow(stdgo.go.token.Token.File_asInterface) class File_static_extension {
	...
	static public function positionFor(_f:Ref<File>, _p:Pos, _adjusted:Bool):Position {
		...
		if (_p != ((0 : Pos))) {
			if (((_p : GoInt) < _f._base) || ((_p : GoInt) > (_f._base + _f._size))) {
				throw Go.toInterface(stdgo.fmt.Fmt.sprintf(("invalid Pos value %d (should be in [%d, %d])" : GoString), Go.toInterface(Go.asInterface(_p)),
					Go.toInterface(_f._base), Go.toInterface(_f._base + _f._size)));
			};
	...
	**/
	...
	static public function pos(_f:Ref<File>, _offset:GoInt):Pos {
		if (_offset > _f._size) {
			throw Go.toInterface(stdgo.fmt.Fmt.sprintf(("invalid file offset %d (should be <= %d)" : GoString), Go.toInterface(_offset),
				Go.toInterface(_f._size)));
		};
	...
	static public function lineStart(_f:Ref<File>, _line:GoInt):Pos {
		...
		try {
			...
			if (_line > (_f._lines.length)) {
				throw Go.toInterface(stdgo.fmt.Fmt.sprintf(("invalid line number %d (should be < %d)" : GoString), Go.toInterface(_line),
					Go.toInterface((_f._lines.length))));
			};
			{
				for (defer in __deferstack__) {
					defer();
...
class FileSet_asInterface {
	...
	**/
	@:keep
	public function write(_encode:AnyInterface->Error):Error
		return __self__.value.write(_encode);

	/**
		// Read calls decode to deserialize a file set into s; s must not be nil.
	**/
	@:keep
	public function read(_decode:AnyInterface->Error):Error
		return __self__.value.read(_decode);
	...
	**/
	@:keep
	public function file(_p:Pos):Ref<File>
		return __self__.value.file(_p);

	@:keep
	public function _file(_p:Pos):Ref<File>
		return __self__.value._file(_p);
	...
	**/
	@:keep
	public function iterate(_f:Ref<File>->Bool):Void
		__self__.value.iterate(_f);
	...
	**/
	@:keep
	public function addFile(_filename:GoString, _base:GoInt, _size:GoInt):Ref<File>
		return __self__.value.addFile(_filename, _base, _size);
...
@:keep @:allow(stdgo.go.token.Token.FileSet_asInterface) class FileSet_static_extension {
	...
	**/
	...
	static public function write(_s:Ref<FileSet>, _encode:AnyInterface->Error):Error {
		...
		_s._mutex.lock();
		_ss.base = _s._base;
		var _files = new Slice<T_serializedFile>((_s._files.length : GoInt).toBasic(), 0,
			...[for (i in 0...(_s._files.length : GoInt).toBasic()) ({} : T_serializedFile)]);
		for (_i => _f in _s._files) {
			...
			_files[(_i : GoInt)] = ({
				...
				base: _f._base,
				size: _f._size,
				lines: ((null : Slice<GoInt>).__append__(..._f._lines.__toArray__())),
				infos: ((null : Slice<T_lineInfo>).__append__(..._f._infos.__toArray__()))
			} : T_serializedFile);
			_f._mutex.unlock();
		};
		_ss.files = _files;
	...
	**/
	...
	static public function read(_s:Ref<FileSet>, _decode:AnyInterface->Error):Error {
		...
		_s._mutex.lock();
		_s._base = _ss.base;
		var _files = new Slice<Ref<File>>((_ss.files.length : GoInt).toBasic(), 0,
			...[for (i in 0...(_ss.files.length : GoInt).toBasic()) (null : Ref<File>)]);
		{
			var _i:GoInt = (0 : GoInt);
...
class Token_asInterface {
	...
	**/
	...
	public function isKeyword():Bool
		return __self__.value.isKeyword();
	...
	**/
	...
	public function isOperator():Bool
		return __self__.value.isOperator();
	...
	**/
	...
	public function isLiteral():Bool
		return __self__.value.isLiteral();
	...
	**/
	@:keep
	public function precedence():GoInt
		return __self__.value.precedence();
	...
	**/
	...
	static public function precedence(_op:Token):GoInt {
		if (_op == ((35 : Token))) {
			...
			return (2 : GoInt);
		} else if (_op == ((39 : Token)) || _op == ((44 : Token)) || _op == ((40 : Token)) || _op == ((45 : Token)) || _op == ((41 : Token))
			|| _op == ((46 : Token))) {
			return (3 : GoInt);
		} else if (_op == ((12 : Token)) || _op == ((13 : Token)) || _op == ((18 : Token)) || _op == ((19 : Token))) {
			return (4 : GoInt);
		} else if (_op == ((14 : Token)) || _op == ((15 : Token)) || _op == ((16 : Token)) || _op == ((20 : Token)) || _op == ((21 : Token))
			|| _op == ((17 : Token)) || _op == ((22 : Token))) {
			return (5 : GoInt);
		};
		return (0 : GoInt);
	}
