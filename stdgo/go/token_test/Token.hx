...
private var _tests:Slice<stdgo.testing.Testing.InternalTest> = (new Slice<stdgo.testing.Testing.InternalTest>(0, 0,
	...
	(new stdgo.testing.Testing.InternalTest(("TestFileSetCacheUnlikely" : GoString),
		stdgo.go.token.Token.testFileSetCacheUnlikely) : stdgo.testing.Testing.InternalTest),
	...
	(new stdgo.testing.Testing.InternalTest(("TestIsIdentifier" : GoString),
		stdgo.go.token.Token.testIsIdentifier) : stdgo.testing.Testing.InternalTest)) : Slice<stdgo.testing.Testing.InternalTest>);
...
private var _benchmarks:Slice<stdgo.testing.Testing.InternalBenchmark> = (new Slice<stdgo.testing.Testing.InternalBenchmark>(0, 0,
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkSearchInts" : GoString),
		stdgo.go.token.Token.benchmarkSearchInts) : stdgo.testing.Testing.InternalBenchmark)) : Slice<stdgo.testing.Testing.InternalBenchmark>);
...
private var _examples:Slice<stdgo.testing.Testing.InternalExample> = (new Slice<stdgo.testing.Testing.InternalExample>(0, 0,
	(new stdgo.testing.Testing.InternalExample(("Example_retrievePositionInfo" : GoString), stdgo.go.token_test.Token_test.example_retrievePositionInfo,
