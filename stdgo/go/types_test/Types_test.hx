...
function _pkgName(_src:stdgo.GoString):stdgo.GoString {
        {};
        {
            var _i:stdgo.StdGoTypes.GoInt = stdgo.strings.Strings.index(_src?.__copy__(), ("package " : stdgo.GoString));
...
**/
@:structInit class T_testInstanceInfo_48___localname___testInst {
    public var _name : stdgo.GoString = "";
    ...
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() {
        return new T_testInstanceInfo_48___localname___testInst(_name, _targs, _typ);
    }
}
...
({ _src : ("package type0; type T[P interface{~int}] struct{ x P }; var _ T[int]" : stdgo.GoString), _instances : (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst>(1, 1, (new stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst(("T" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("int" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("struct{x int}" : stdgo.GoString)) : stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst>) } : T__struct_11),
...
({ _src : ("package type3; type T[P1 interface{~[]P2}, P2 any] struct{ x P1; y P2 }; var _ T[[]int, int]" : stdgo.GoString), _instances : (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst>(1, 1, (new stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst(("T" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(2, 2, ("[]int" : stdgo.GoString), ("int" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("struct{x []int; y int}" : stdgo.GoString)) : stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst>) } : T__struct_11),
({ _src : ("package type4; import \"lib\"; var _ lib.T[int]" : stdgo.GoString), _instances : (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst>(1, 1, (new stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst(("T" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("int" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("[]int" : stdgo.GoString)) : stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst>) } : T__struct_11),
({ _src : ("package dupltype0; type T[P interface{~int}] struct{ x P }; var x T[int]; var y T[int]" : stdgo.GoString), _instances : (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst>(2, 2, (new stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst(("T" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("int" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("struct{x int}" : stdgo.GoString)) : stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst), (new stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst(("T" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("int" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("struct{x int}" : stdgo.GoString)) : stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst>) } : T__struct_11),
({ _src : ("package dupltype1; type T[P ~int] struct{ x P }; func (r *T[Q]) add(z T[Q]) { r.x += z.x }" : stdgo.GoString), _instances : (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst>(2, 2, (new stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst(("T" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("Q" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("struct{x Q}" : stdgo.GoString)) : stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst), (new stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst(("T" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("Q" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("struct{x Q}" : stdgo.GoString)) : stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst>) } : T__struct_11),
({ _src : ("package dupltype1; import \"lib\"; var x lib.T[int]; var y lib.T[int]; var z lib.T[string]" : stdgo.GoString), _instances : (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst>(3, 3, (new stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst(("T" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("int" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("[]int" : stdgo.GoString)) : stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst), (new stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst(("T" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("int" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("[]int" : stdgo.GoString)) : stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst), (new stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst(("T" : stdgo.GoString), (new stdgo.Slice<stdgo.GoString>(1, 1, ("string" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("[]string" : stdgo.GoString)) : stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst>) } : T__struct_11),
        ...
        for (__0 => _test in _tests) {
            ...
            _t.run(_pkg.name()?.__copy__(), function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
                ...
                for (_ii => _inst in _instances) {
                    ...
                    var _testInst:stdgo.go.types_test.Types_test.T_testInstanceInfo_48___localname___testInst = _test._instances[(_ii : stdgo.StdGoTypes.GoInt)];
                    {
...
function testCompositeLitTypes(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (_i => _test in (new stdgo.Slice<T__struct_23>(8, 8, ({ _lit : ("[16]byte{}" : stdgo.GoString), _typ : ("[16]byte" : stdgo.GoString) } : T__struct_23), ({ _lit : ("[...]byte{}" : stdgo.GoString), _typ : ("[0]byte" : stdgo.GoString) } : T__struct_23), ({ _lit : ("[...]int{1, 2, 3}" : stdgo.GoString), _typ : ("[3]int" : stdgo.GoString) } : T__struct_23), ({ _lit : ("[...]int{90: 0, 98: 1, 2}" : stdgo.GoString), _typ : ("[100]int" : stdgo.GoString) } : T__struct_23), ({ _lit : ("[]int{}" : stdgo.GoString), _typ : ("[]int" : stdgo.GoString) } : T__struct_23), ({ _lit : ("map[string]bool{\"foo\": true}" : stdgo.GoString), _typ : ("map[string]bool" : stdgo.GoString) } : T__struct_23), ({ _lit : ("struct{}{}" : stdgo.GoString), _typ : ("struct{}" : stdgo.GoString) } : T__struct_23), ({ _lit : ("struct{x, y int; z complex128}{}" : stdgo.GoString), _typ : ("struct{x int; y int; z complex128}" : stdgo.GoString) } : T__struct_23)) : stdgo.Slice<T__struct_23>)) {
            ...
            {
                var __tmp__ = (stdgo.Go.setRef(({} : stdgo.go.types.Types.Config)) : stdgo.StdGoTypes.Ref<stdgo.go.types.Types.Config>).check(("p" : stdgo.GoString), _fset, (new stdgo.Slice<stdgo.StdGoTypes.Ref<stdgo.go.ast.Ast.File>>(1, 1, _f) : stdgo.Slice<stdgo.StdGoTypes.Ref<stdgo.go.ast.Ast.File>>), (stdgo.Go.setRef(({ types : _types } : stdgo.go.types.Types.Info)) : stdgo.StdGoTypes.Ref<stdgo.go.types.Types.Info>)), __0:stdgo.StdGoTypes.Ref<stdgo.go.types.Types.Package> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
...
function testFailedImport(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        for (__0 => _compiler in (new stdgo.Slice<stdgo.GoString>(3, 3, ("gc" : stdgo.GoString), ("gccgo" : stdgo.GoString), ("source" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) {
            ...
            var _conf:stdgo.go.types.Types.Config = ({ error : function(_err:stdgo.Error):Void {
                if ((_errcount > (0 : stdgo.StdGoTypes.GoInt)) || !stdgo.strings.Strings.contains(_err.error()?.__copy__(), ("could not import" : stdgo.GoString))) {
...
function testArgumentErrorUnwrapping(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        var _err:stdgo.Error = stdgo.Go.asInterface((stdgo.Go.setRef(({ index : (1 : stdgo.StdGoTypes.GoInt), err : stdgo.Go.asInterface(({ msg : ("test" : stdgo.GoString) } : stdgo.go.types.Types.T_error)) } : stdgo.go.types.Types.ArgumentError)) : stdgo.StdGoTypes.Ref<stdgo.go.types.Types.ArgumentError>));
...
function testLongConstants(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _src:stdgo.GoString = stdgo.fmt.Fmt.sprintf(_format?.__copy__(), stdgo.Go.toInterface(stdgo.strings.Strings.repeat(("1" : stdgo.GoString), (9999 : stdgo.StdGoTypes.GoInt))), stdgo.Go.toInterface(stdgo.strings.Strings.repeat(("1" : stdgo.GoString), (10001 : stdgo.StdGoTypes.GoInt))))?.__copy__();
...
function testIndexRepresentability(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        {};
        _testFiles(_t, (new stdgo.Slice<stdgo.GoString>(1, 1, ("index.go" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), (new stdgo.Slice<stdgo.Slice<stdgo.StdGoTypes.GoUInt8>>(1, 1, (("package index; var s []byte; var _ = s[int64 /* ERRORx \"int64\\\\(1\\\\) << 40 \\\\(.*\\\\) overflows int\" */ (1) << 40]" : stdgo.GoString) : stdgo.Slice<stdgo.StdGoTypes.GoByte>)) : stdgo.Slice<stdgo.Slice<stdgo.StdGoTypes.GoUInt8>>), false, _withSizes(stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.go.types.Types.StdSizes((4i64 : stdgo.StdGoTypes.GoInt64), (4i64 : stdgo.StdGoTypes.GoInt64)) : stdgo.go.types.Types.StdSizes)) : stdgo.StdGoTypes.Ref<stdgo.go.types.Types.StdSizes>))));
    }
function testIssue47243_TypedRHS(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        {};
        _testFiles(_t, (new stdgo.Slice<stdgo.GoString>(1, 1, ("p.go" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), (new stdgo.Slice<stdgo.Slice<stdgo.StdGoTypes.GoUInt8>>(1, 1, (("package issue47243; var a uint64; var _ = a << uint64(4294967296)" : stdgo.GoString) : stdgo.Slice<stdgo.StdGoTypes.GoByte>)) : stdgo.Slice<stdgo.Slice<stdgo.StdGoTypes.GoUInt8>>), false, _withSizes(stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.go.types.Types.StdSizes((4i64 : stdgo.StdGoTypes.GoInt64), (4i64 : stdgo.StdGoTypes.GoInt64)) : stdgo.go.types.Types.StdSizes)) : stdgo.StdGoTypes.Ref<stdgo.go.types.Types.StdSizes>))));
    }
...
function testEvalArith(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _fset = stdgo.go.token.Token.newFileSet();
        for (__0 => _test in _tests) {
            _testEval(_t, _fset, null, _nopos, _test?.__copy__(), stdgo.Go.asInterface(typ[((19 : stdgo.go.types.Types.BasicKind) : stdgo.StdGoTypes.GoInt)]), stdgo.Go.str()?.__copy__(), ("true" : stdgo.GoString));
        };
    }
            ...
            for (__1 => _group in _file.comments) {
                for (__2 => T_comment_static_extension in _group.list) {
                    ...
                    if (((_s.length >= (4 : stdgo.StdGoTypes.GoInt)) && ((_s.__slice__(0, (2 : stdgo.StdGoTypes.GoInt)) : stdgo.GoString) == ("/*" : stdgo.GoString))) && ((_s.__slice__((_s.length) - (2 : stdgo.StdGoTypes.GoInt)) : stdgo.GoString) == ("*/" : stdgo.GoString))) {
                        var __tmp__ = _split((_s.__slice__((2 : stdgo.StdGoTypes.GoInt), (_s.length) - (2 : stdgo.StdGoTypes.GoInt)) : stdgo.GoString)?.__copy__(), (", " : stdgo.GoString)), _str:stdgo.GoString = __tmp__._0, _typ:stdgo.GoString = __tmp__._1;
...
function testCheckExpr(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        for (__0 => _group in _f.comments) {
            for (__1 => T_comment_static_extension in _group.list) {
                var _s:stdgo.GoString = T_comment_static_extension.text?.__copy__();
                if (((_s.length >= (4 : stdgo.StdGoTypes.GoInt)) && stdgo.strings.Strings.hasPrefix(_s?.__copy__(), ("/*" : stdgo.GoString))) && stdgo.strings.Strings.hasSuffix(_s?.__copy__(), ("*/" : stdgo.GoString))) {
                    var _pos:stdgo.go.token.Token.Pos = T_comment_static_extension.pos();
                    var __tmp__ = _split((_s.__slice__((2 : stdgo.StdGoTypes.GoInt), (_s.length) - (2 : stdgo.StdGoTypes.GoInt)) : stdgo.GoString)?.__copy__(), ("=>" : stdgo.GoString)), _expr:stdgo.GoString = __tmp__._0, _wantObj:stdgo.GoString = __tmp__._1;
                    ...
                    if (_spec != null && ((_spec : Dynamic).__nil__ == null || !(_spec : Dynamic).__nil__)) {
                        {
                            ...
                            if (_ok && (_spec.name.name == ("T" : stdgo.GoString))) {
                                var _want:stdgo.StdGoTypes.GoInt = stdgo.strings.Strings.count(_src?.__copy__(), (";" : stdgo.GoString)) + (1 : stdgo.StdGoTypes.GoInt);
                                {
...
function testIssue29029(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _check = newChecker((stdgo.Go.setRef(_conf) : stdgo.StdGoTypes.Ref<stdgo.go.types.Types.Config>), _fset, newPackage(stdgo.Go.str()?.__copy__(), ("p" : stdgo.GoString)), _info);
        {
        ...
        _check = newChecker((stdgo.Go.setRef(_conf) : stdgo.StdGoTypes.Ref<stdgo.go.types.Types.Config>), _fset, newPackage(stdgo.Go.str()?.__copy__(), ("p" : stdgo.GoString)), _info);
        {
...
**/
@:structInit class T_testNewMethodSet_49___localname___method {
    public var _name : stdgo.GoString = "";
    ...
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() {
        return new T_testNewMethodSet_49___localname___method(_name, _index, _indirect);
    }
}
function testNewMethodSet(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        {};
        var _tests = ({
            final x = new stdgo.GoMap.GoStringMap<stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>>();
            x.__defaultValue__ = () -> (null : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>);
            @:mergeBlock {
                x.set(("var a T; type T struct{}; func (T) f() {}" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(1, 1, (new stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method(("f" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.GoInt>(1, 1, (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), false) : stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a *T; type T struct{}; func (T) f() {}" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(1, 1, (new stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method(("f" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.GoInt>(1, 1, (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), true) : stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a T; type T struct{}; func (*T) f() {}" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(0, 0) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a *T; type T struct{}; func (*T) f() {}" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(1, 1, (new stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method(("f" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.GoInt>(1, 1, (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), true) : stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a T[int]; type T[P any] struct{}; func (T[P]) f() {}" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(1, 1, (new stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method(("f" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.GoInt>(1, 1, (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), false) : stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a *T[int]; type T[P any] struct{}; func (T[P]) f() {}" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(1, 1, (new stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method(("f" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.GoInt>(1, 1, (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), true) : stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a T[int]; type T[P any] struct{}; func (*T[P]) f() {}" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(0, 0) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a *T[int]; type T[P any] struct{}; func (*T[P]) f() {}" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(1, 1, (new stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method(("f" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.GoInt>(1, 1, (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), true) : stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                ...
                x.set(("var a struct{ E }; type E interface{ f() }" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(1, 1, (new stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method(("f" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.GoInt>(2, 2, (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), true) : stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a *struct{ E }; type E interface{ f() }" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(1, 1, (new stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method(("f" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.GoInt>(2, 2, (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), true) : stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                ...
                x.set(("var a struct{ *E }; type E struct{}; func (E) f() {}" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(1, 1, (new stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method(("f" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.GoInt>(2, 2, (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), true) : stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a struct{ E }; type E struct{}; func (*E) f() {}" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(0, 0) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a struct{ *E }; type E struct{}; func (*E) f() {}" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(1, 1, (new stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method(("f" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.GoInt>(2, 2, (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), true) : stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a struct{ E[int] }; type E[P any] interface{ f() }" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(1, 1, (new stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method(("f" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.GoInt>(2, 2, (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), true) : stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a *struct{ E[int] }; type E[P any] interface{ f() }" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(1, 1, (new stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method(("f" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.GoInt>(2, 2, (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), true) : stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a struct{ E[int] }; type E[P any] struct{}; func (E[P]) f() {}" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(1, 1, (new stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method(("f" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.GoInt>(2, 2, (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), false) : stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a struct{ *E[int] }; type E[P any] struct{}; func (E[P]) f() {}" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(1, 1, (new stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method(("f" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.GoInt>(2, 2, (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), true) : stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a struct{ E[int] }; type E[P any] struct{}; func (*E[P]) f() {}" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(0, 0) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a struct{ *E[int] }; type E[P any] struct{}; func (*E[P]) f() {}" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(1, 1, (new stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method(("f" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.GoInt>(2, 2, (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), true) : stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a struct{ E1; *E2 }; type ( E1 interface{ f() }; E2 struct{ f int })" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(0, 0) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a struct{ E1; *E2 }; type ( E1 struct{ f int }; E2 struct{} ); func (E2) f() {}" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(0, 0) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a T[int]; type ( T[P any] struct { *N[P] }; N[P any] struct { *T[P] } ); func (N[P]) m() {}" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(1, 1, (new stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method(("m" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.GoInt>(2, 2, (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), true) : stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("var a T[int]; type ( T[P any] struct { *N[P] }; N[P any] struct { *T[P] } ); func (T[P]) m() {}" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(1, 1, (new stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method(("m" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.GoInt>(1, 1, (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), false) : stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
            };
            x;
        } : stdgo.GoMap<stdgo.GoString, stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>>);
        var _tParamTests = ({
            final x = new stdgo.GoMap.GoStringMap<stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>>();
            x.__defaultValue__ = () -> (null : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>);
            @:mergeBlock {
                x.set(("type C interface{ f() }; func g[T C](a T){}" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(1, 1, (new stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method(("f" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.GoInt>(1, 1, (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), true) : stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
                x.set(("type C interface{ f() }; func g[T C]() { var a T; _ = a }" : stdgo.GoString), (new stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>(1, 1, (new stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method(("f" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.GoInt>(1, 1, (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), true) : stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method)) : stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>));
            };
            x;
        } : stdgo.GoMap<stdgo.GoString, stdgo.Slice<stdgo.go.types_test.Types_test.T_testNewMethodSet_49___localname___method>>);
        var _check = function(_src:stdgo.GoString, _methods:stdgo.Slice<T_testNewMethodSet_49___localname___method>, _generic:Bool):Void {
...
function testResolveIdents(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        var __tmp__ = _conf.check(("testResolveIdents" : stdgo.GoString), _fset, _files, (stdgo.Go.setRef(({ defs : _defs, uses : _uses } : stdgo.go.types.Types.Info)) : stdgo.StdGoTypes.Ref<stdgo.go.types.Types.Info>)), __1:stdgo.StdGoTypes.Ref<stdgo.go.types.Types.Package> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _t.fatal(stdgo.Go.toInterface(_err));
        };
...
function benchmarkCheck(_b:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.B>):Void {
        ...
        for (__0 => _p in (new stdgo.Slice<stdgo.GoString>(5, 5, ("net/http" : stdgo.GoString), ("go/parser" : stdgo.GoString), ("go/constant" : stdgo.GoString), ("runtime" : stdgo.GoString), stdgo.path.filepath.Filepath.join(("go" : stdgo.GoString), ("internal" : stdgo.GoString), ("gcimporter" : stdgo.GoString))?.__copy__()) : stdgo.Slice<stdgo.GoString>)) {
...
function _testTestDir(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>, _path:stdgo.GoString, _ignore:haxe.Rest<stdgo.GoString>):Void {
        ...
        if (_err != null) {
            {
                var __tmp__ = stdgo.os.Os.stat(stdgo.path.filepath.Filepath.join(stdgo.internal.testenv.Testenv.goroot(stdgo.Go.asInterface(_t))?.__copy__(), ("test" : stdgo.GoString))?.__copy__()), __0:stdgo.io.fs.Fs.FileInfo = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (stdgo.os.Os.isNotExist(_err)) {
                    {
                        var __tmp__ = stdgo.os.Os.stat(stdgo.path.filepath.Filepath.join(stdgo.internal.testenv.Testenv.goroot(stdgo.Go.asInterface(_t))?.__copy__(), ("VERSION" : stdgo.GoString))?.__copy__()), __1:stdgo.io.fs.Fs.FileInfo = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                        if (_err == null) {
