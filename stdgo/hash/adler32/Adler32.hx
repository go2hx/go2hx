...
({ _out : (554866632u32 : stdgo.GoUInt32), _in : stdgo.strings.Strings.repeat(stdgo.Go.str(255)?.__copy__(), (5548 : stdgo.GoInt)) + ("8" : stdgo.GoString)?.__copy__()?.__copy__(), _halfState : stdgo.Go.str("adl", 1, 154, 166, 203, 193)?.__copy__() } : T__struct_0),
({ _out : (-1163814712u32 : stdgo.GoUInt32), _in : stdgo.strings.Strings.repeat(stdgo.Go.str(255)?.__copy__(), (5549 : stdgo.GoInt)) + ("9" : stdgo.GoString)?.__copy__()?.__copy__(), _halfState : stdgo.Go.str("adl", 1, "gu", 204, 192)?.__copy__() } : T__struct_0),
({ _out : (1429510590u32 : stdgo.GoUInt32), _in : stdgo.strings.Strings.repeat(stdgo.Go.str(255)?.__copy__(), (5550 : stdgo.GoInt)) + ("0" : stdgo.GoString)?.__copy__()?.__copy__(), _halfState : stdgo.Go.str("adl", 1, "gu", 204, 192)?.__copy__() } : T__struct_0),
({ _out : (-255747394u32 : stdgo.GoUInt32), _in : stdgo.strings.Strings.repeat(stdgo.Go.str(255)?.__copy__(), (5551 : stdgo.GoInt)) + ("1" : stdgo.GoString)?.__copy__()?.__copy__(), _halfState : stdgo.Go.str("adl", 1, "5CͿ")?.__copy__() } : T__struct_0),
({ _out : (-1923310658u32 : stdgo.GoUInt32), _in : stdgo.strings.Strings.repeat(stdgo.Go.str(255)?.__copy__(), (5552 : stdgo.GoInt)) + ("2" : stdgo.GoString)?.__copy__()?.__copy__(), _halfState : stdgo.Go.str("adl", 1, "5CͿ")?.__copy__() } : T__struct_0),
({ _out : (720805054u32 : stdgo.GoUInt32), _in : stdgo.strings.Strings.repeat(stdgo.Go.str(255)?.__copy__(), (5553 : stdgo.GoInt)) + ("3" : stdgo.GoString)?.__copy__()?.__copy__(), _halfState : stdgo.Go.str("adl", 1, 4, 16, "ξ")?.__copy__() } : T__struct_0),
({ _out : (-914317890u32 : stdgo.GoUInt32), _in : stdgo.strings.Strings.repeat(stdgo.Go.str(255)?.__copy__(), (5554 : stdgo.GoInt)) + ("4" : stdgo.GoString)?.__copy__()?.__copy__(), _halfState : stdgo.Go.str("adl", 1, 4, 16, "ξ")?.__copy__() } : T__struct_0),
({ _out : (1763221182u32 : stdgo.GoUInt32), _in : stdgo.strings.Strings.repeat(stdgo.Go.str(255)?.__copy__(), (5555 : stdgo.GoInt)) + ("5" : stdgo.GoString)?.__copy__()?.__copy__(), _halfState : stdgo.Go.str("adl", 1, 211, 205, "Ͻ")?.__copy__() } : T__struct_0),
({ _out : (-2035351551u32 : stdgo.GoUInt32), _in : stdgo.strings.Strings.repeat(stdgo.Go.str(0)?.__copy__(), (100000 : stdgo.GoInt))?.__copy__(), _halfState : stdgo.Go.str("adl", 1, 195, "P", 0, 1)?.__copy__() } : T__struct_0),
({ _out : (2036730701u32 : stdgo.GoUInt32), _in : stdgo.strings.Strings.repeat(("a" : stdgo.GoString), (100000 : stdgo.GoInt))?.__copy__(), _halfState : stdgo.Go.str("adl", 1, 129, "k", 5, 167)?.__copy__() } : T__struct_0),
({ _out : (285575406u32 : stdgo.GoUInt32), _in : stdgo.strings.Strings.repeat(("ABCDEFGHIJKLMNOPQRSTUVWXYZ" : stdgo.GoString), (10000 : stdgo.GoInt))?.__copy__(), _halfState : stdgo.Go.str("adl", 1, "e", 210, 196, "p")?.__copy__() } : T__struct_0)) : stdgo.Slice<T__struct_0>);
/**
...
@:keep @:allow(stdgo.hash.adler32.Adler32.T__struct_0_asInterface) class T__struct_0_static_extension {

}
@:local @:using(stdgo.hash.adler32.Adler32.T__struct_0_static_extension) typedef T__struct_0 = {
...
**/
@:named @:using(stdgo.hash.adler32.Adler32.T_digest_static_extension) typedef T_digest = stdgo.GoUInt32;
/**
...
function new_():stdgo.hash.Hash.Hash32 {
        var _d = stdgo.Go.pointer(((0 : stdgo.GoUInt32) : stdgo.hash.adler32.Adler32.T_digest));
        _d.value.reset(_d);
...
function _update(_d:T_digest, _p:stdgo.Slice<stdgo.GoByte>):T_digest {
        var __0:stdgo.GoUInt32 = (_d & (65535u32 : stdgo.hash.adler32.Adler32.T_digest) : stdgo.GoUInt32), __1:stdgo.GoUInt32 = (_d >> (16i64 : stdgo.GoUInt64) : stdgo.GoUInt32), _s2:stdgo.GoUInt32 = __1, _s1:stdgo.GoUInt32 = __0;
...
function checksum(_data:stdgo.Slice<stdgo.GoByte>):stdgo.GoUInt32 {
        return (_update((1u32 : stdgo.hash.adler32.Adler32.T_digest), _data) : stdgo.GoUInt32);
    }
/**
...
function testGoldenMarshal(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        for (__0 => _g in _golden) {
            var _h:stdgo.hash.Hash.Hash32 = new_();
            var _h2:stdgo.hash.Hash.Hash32 = new_();
...
function benchmarkAdler32KB(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
...
@:keep @:allow(stdgo.hash.adler32.Adler32.T_digest_asInterface) class T_digest_static_extension {
    @:keep
    @:pointer
    ...
    static public function unmarshalBinary(____:T_digest,  _d:stdgo.Pointer<T_digest>, _b:stdgo.Slice<stdgo.GoByte>):stdgo.Error {
        if ((_b.length < stdgo.Go.str("adl", 1).length) || (((_b.__slice__(0, (stdgo.Go.str("adl", 1).length)) : stdgo.Slice<stdgo.GoUInt8>) : stdgo.GoString) != stdgo.Go.str("adl", 1))) {
            return stdgo.errors.Errors.new_(("hash/adler32: invalid hash state identifier" : stdgo.GoString));
        };
        if ((_b.length) != ((8 : stdgo.GoInt))) {
            return stdgo.errors.Errors.new_(("hash/adler32: invalid hash state size" : stdgo.GoString));
        };
    ...
    static public function reset(____:T_digest,  _d:stdgo.Pointer<T_digest>):Void {
        _d.value = (1u32 : stdgo.hash.adler32.Adler32.T_digest);
    }
}
