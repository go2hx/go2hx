...
@:structInit class T_digest {
	public function sum(_in:Slice<GoByte>):Slice<GoByte> {
		...
		return _in.__append__((((_s >> ((24 : GoUnTypedInt))) : GoByte)), (((_s >> ((16 : GoUnTypedInt))) : GoByte)),
			(((_s >> ((8 : GoUnTypedInt))) : GoByte)), ((_s : GoByte)));
	}
	...
	public function new(?_crc:GoUInt32, ?_tab:Pointer<Table>)
...
@:named class T_slicing8Table {
	...
	public function __copy__()
		return new T_slicing8Table(__t__.copy());
