...
@:structInit class T_digest {
	public function sum(_in:Slice<GoByte>):Slice<GoByte> {
		...
		return _in.__append__((((_s >> ((56 : GoUnTypedInt))) : GoByte)), (((_s >> ((48 : GoUnTypedInt))) : GoByte)),
			(((_s >> ((40 : GoUnTypedInt))) : GoByte)), (((_s >> ((32 : GoUnTypedInt))) : GoByte)), (((_s >> ((24 : GoUnTypedInt))) : GoByte)),
			(((_s >> ((16 : GoUnTypedInt))) : GoByte)), (((_s >> ((8 : GoUnTypedInt))) : GoByte)), ((_s : GoByte)));
	}
	...
	public function new(?_crc:GoUInt64, ?_tab:Pointer<Table>)
