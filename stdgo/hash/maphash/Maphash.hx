...
@:structInit class Seed {
    ...
    public function new(?_s:GoUInt64) stdgo.internal.Macro.initLocals();
...
@:structInit class Hash {
    ...
    public function sum(_b:Slice<GoByte>):Slice<GoByte> {
        ...
        return _b.__append__((((_x >> ((0 : GoUnTypedInt))) : GoByte)), (((_x >> ((8 : GoUnTypedInt))) : GoByte)), (((_x >> ((16 : GoUnTypedInt))) : GoByte)), (((_x >> ((24 : GoUnTypedInt))) : GoByte)), (((_x >> ((32 : GoUnTypedInt))) : GoByte)), (((_x >> ((40 : GoUnTypedInt))) : GoByte)), (((_x >> ((48 : GoUnTypedInt))) : GoByte)), (((_x >> ((56 : GoUnTypedInt))) : GoByte)));
    }
    ...
    public function writeString(_s:GoString):{ var _0 : GoInt; var _1 : Error; } {
        ...
        if (_s.length > _bufSize) {
            ...
            while (_s.length > _bufSize) {
                var _ptr:Pointer<GoUInt8> = ((((((Go.pointer(_s) : stdgo.unsafe.Unsafe.Pointer_)) : Pointer<internal.unsafeheader.Unsafeheader.String_>)).value.data : Pointer<GoByte>));
    ...
    public function new(?___blank__0:GoArray<() -> Void>, ?_seed:Seed, ?_state:Seed, ?_buf:GoArray<GoUInt8>, ?_n:GoInt) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(___blank__0) + " " + Go.string(_seed) + " " + Go.string(_state) + " " + Go.string(_buf) + " " + Go.string(_n) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
**/
function _runtime_fastrand():GoUInt32 throw "not implemeneted";
...
/**
    ...
    //go:noescape
**/
function _runtime_memhash(_p:stdgo.unsafe.Unsafe.Pointer_, _seed:GoUIntptr, _s:GoUIntptr):GoUIntptr throw "not implemeneted";
class Hash_extension_fields {
    public function _initSeed(__tmp__):Void __tmp__._initSeed();
    public function writeByte(__tmp__, _b:GoByte):Error return __tmp__.writeByte(_b);
    ...
    public function seed(__tmp__):Seed return __tmp__.seed();
    public function setSeed(__tmp__, _seed:Seed):Void __tmp__.setSeed(_seed);
