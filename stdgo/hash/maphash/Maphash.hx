...
@:structInit abstract Seed(stdgo._internal.hash.maphash.Maphash_Seed.Seed) from stdgo._internal.hash.maphash.Maphash_Seed.Seed to stdgo._internal.hash.maphash.Maphash_Seed.Seed {
    ...
    public function new(?_s:haxe.UInt64) this = new stdgo._internal.hash.maphash.Maphash_Seed.Seed(_s);
...
@:structInit @:using(stdgo.hash.maphash.Maphash.Hash_static_extension) abstract Hash(stdgo._internal.hash.maphash.Maphash_Hash.Hash) from stdgo._internal.hash.maphash.Maphash_Hash.Hash to stdgo._internal.hash.maphash.Maphash_Hash.Hash {
    ...
    public function new(?__1:haxe.ds.Vector<() -> Void>, ?_seed:Seed, ?_state:Seed, ?_buf:haxe.ds.Vector<std.UInt>, ?_n:StdTypes.Int) this = new stdgo._internal.hash.maphash.Maphash_Hash.Hash(([for (i in __1) i] : stdgo.GoArray<() -> Void>), _seed, _state, ([for (i in _buf) i] : stdgo.GoArray<stdgo.GoUInt8>), _n);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
class Maphash {
    /**
        ...
        Bytes is equivalent to, but more convenient and efficient than:
        	...
        	return h.Sum64()
    **/
    static public function bytes(_seed:Seed, _b:Array<std.UInt>):haxe.UInt64 {
        final _b = ([for (i in _b) i] : stdgo.Slice<stdgo.GoUInt8>);
    ...
    /**
        ...
        String is equivalent to, but more convenient and efficient than:
        	...
        	return h.Sum64()
    **/
    static public function string(_seed:Seed, _s:String):haxe.UInt64 {
        return stdgo._internal.hash.maphash.Maphash_string.string(_seed, _s);
    }
    /**
        MakeSeed returns a new random seed.
    **/
    static public function makeSeed():Seed {
