...
**/
private var _tests = (new Slice<stdgo.testing.Testing.InternalTest>(1, 1, (new stdgo.testing.Testing.InternalTest(("TestMarshalHash" : GoString), stdgo.hash_test.Hash_test.testMarshalHash) : stdgo.testing.Testing.InternalTest)) : Slice<stdgo.testing.Testing.InternalTest>);
/**
...
**/
private var _examples = (new Slice<stdgo.testing.Testing.InternalExample>(1, 1, (new stdgo.testing.Testing.InternalExample(("Example_binaryMarshaler" : GoString), stdgo.hash_test.Hash_test.example_binaryMarshaler, ("57d51a066f3a39942649cd9a76c77e97ceab246756ff3888659e6aa5a07f4a52\ntrue\n" : GoString), false) : stdgo.testing.Testing.InternalExample)) : Slice<stdgo.testing.Testing.InternalExample>);
