...
**/
var _examples : stdgo.Slice<stdgo.testing.Testing.InternalExample> = (new stdgo.Slice<stdgo.testing.Testing.InternalExample>(1, 1, (new stdgo.testing.Testing.InternalExample(("Example_binaryMarshaler" : stdgo.GoString)?.__copy__(), stdgo.hash_test.Hash_test.example_binaryMarshaler, ("57d51a066f3a39942649cd9a76c77e97ceab246756ff3888659e6aa5a07f4a52\ntrue\n" : stdgo.GoString)?.__copy__(), false) : stdgo.testing.Testing.InternalExample)) : stdgo.Slice<stdgo.testing.Testing.InternalExample>);
function main():Void {
...
@:keep var _ = {
        try {
            stdgo.testing.internal.testdeps.Testdeps.importPath = ("hash" : stdgo.GoString)?.__copy__();
