...
@:structInit class T_format {
    ...
    public var _decode : stdgo.io.Io.Reader -> { var _0 : Image; var _1 : stdgo.Error; } = null;
    public var _decodeConfig : stdgo.io.Io.Reader -> { var _0 : Config; var _1 : stdgo.Error; } = null;
    public function new(?_name:GoString, ?_magic:GoString, ?_decode:stdgo.io.Io.Reader -> { var _0 : Image; var _1 : stdgo.Error; }, ?_decodeConfig:stdgo.io.Io.Reader -> { var _0 : Config; var _1 : stdgo.Error; }) stdgo.internal.Macro.initLocals();
...
@:structInit class Point {
    ...
    public function toString():GoString {
        var _p = this.__copy__();
        return (("(" : GoString)) + stdgo.strconv.Strconv.itoa(_p.x) + (("," : GoString)) + stdgo.strconv.Strconv.itoa(_p.y) + ((")" : GoString));
    }
    public var x : GoInt = ((0 : GoInt));
    public var y : GoInt = ((0 : GoInt));
    public function new(?x:GoInt, ?y:GoInt) stdgo.internal.Macro.initLocals();
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class Rectangle {
    ...
    public function new(?min:Point, ?max:Point) stdgo.internal.Macro.initLocals();
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class Config {
    ...
    public function new(?colorModel:stdgo.image.color.Color.Model, ?width:GoInt, ?height:GoInt) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class RGBA {
    public function opaque():Bool {
        ...
        var _i0:GoInt = ((3 : GoInt)), _i1:GoInt = _p.value.rect.dx() * ((4 : GoInt));
        {
    ...
    public function set(_x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.Color):Void {
        ...
        var _i:GoInt = _p.value.pixOffset(_x, _y);
        var _c1:stdgo.image.color.Color.RGBA = ((stdgo.image.color.Color.rgbamodel.convert(_c).__underlying__().value : stdgo.image.color.Color.RGBA)).__copy__();
        var _s:Slice<GoUInt8> = _p.value.pix.__slice__(_i, _i + ((4 : GoInt))).setCap(((_i + ((4 : GoInt)) : GoInt)) - ((1 : GoInt)));
        _s[((0 : GoInt))] = _c1.r;
        _s[((1 : GoInt))] = _c1.g;
        _s[((2 : GoInt))] = _c1.b;
    ...
    public function rgba64at(_x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 {
        ...
        return new stdgo.image.color.Color.RGBA64(((_r << ((8 : GoUnTypedInt)))) | _r, ((_g << ((8 : GoUnTypedInt)))) | _g, ((_b << ((8 : GoUnTypedInt)))) | _b, ((_a << ((8 : GoUnTypedInt)))) | _a).__copy__();
    }
    public function at(_x:GoInt, _y:GoInt):stdgo.image.color.Color.Color {
        var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
    ...
    public function new(?pix:Slice<GoUInt8>, ?stride:GoInt, ?rect:Rectangle) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class RGBA64 {
    public function opaque():Bool {
        ...
        var _i0:GoInt = ((6 : GoInt)), _i1:GoInt = _p.value.rect.dx() * ((8 : GoInt));
        {
            var _y:GoInt = _p.value.rect.min.y;
            Go.cfor(_y < _p.value.rect.max.y, _y++, {
                {
                    ...
                    Go.cfor(_i < _i1, _i = _i + (((8 : GoInt))), {
                        if (_p.value.pix[_i + ((0 : GoInt))] != ((255 : GoUInt8)) || _p.value.pix[_i + ((1 : GoInt))] != ((255 : GoUInt8))) {
                            return false;
                        };
                    });
                };
    ...
    public function set(_x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.Color):Void {
        ...
        var _i:GoInt = _p.value.pixOffset(_x, _y);
        var _c1:stdgo.image.color.Color.RGBA64 = ((stdgo.image.color.Color.rgba64model.convert(_c).__underlying__().value : stdgo.image.color.Color.RGBA64)).__copy__();
        var _s:Slice<GoUInt8> = _p.value.pix.__slice__(_i, _i + ((8 : GoInt))).setCap(((_i + ((8 : GoInt)) : GoInt)) - ((1 : GoInt)));
    ...
    public function rgba64at(_x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 {
        ...
        var _i:GoInt = _p.value.pixOffset(_x, _y);
        var _s:Slice<GoUInt8> = _p.value.pix.__slice__(_i, _i + ((8 : GoInt))).setCap(((_i + ((8 : GoInt)) : GoInt)) - ((1 : GoInt)));
        return new stdgo.image.color.Color.RGBA64((((_s[((0 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_s[((1 : GoInt))] : GoUInt16)), (((_s[((2 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_s[((3 : GoInt))] : GoUInt16)), (((_s[((4 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_s[((5 : GoInt))] : GoUInt16)), (((_s[((6 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_s[((7 : GoInt))] : GoUInt16))).__copy__();
    }
    public function at(_x:GoInt, _y:GoInt):stdgo.image.color.Color.Color {
        var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
...
@:structInit class NRGBA {
    ...
    public function setRGBA64(_x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.RGBA64):Void {
        ...
        var _r:GoUInt32 = ((_c.r : GoUInt32)), _g:GoUInt32 = ((_c.g : GoUInt32)), _b:GoUInt32 = ((_c.b : GoUInt32)), _a:GoUInt32 = ((_c.a : GoUInt32));
    ...
    public function rgba64at(_x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 {
        var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _p.value.nrgbaat(_x, _y).rgba(), _r:GoUInt32 = __tmp__._0, _g:GoUInt32 = __tmp__._1, _b:GoUInt32 = __tmp__._2, _a:GoUInt32 = __tmp__._3;
...
@:structInit class NRGBA64 {
    ...
    public function set(_x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.Color):Void {
        ...
        var _i:GoInt = _p.value.pixOffset(_x, _y);
        var _c1:stdgo.image.color.Color.NRGBA64 = ((stdgo.image.color.Color.nrgba64model.convert(_c).__underlying__().value : stdgo.image.color.Color.NRGBA64)).__copy__();
        var _s:Slice<GoUInt8> = _p.value.pix.__slice__(_i, _i + ((8 : GoInt))).setCap(((_i + ((8 : GoInt)) : GoInt)) - ((1 : GoInt)));
        _s[((0 : GoInt))] = (((_c1.r >> ((8 : GoUnTypedInt))) : GoUInt8));
        _s[((1 : GoInt))] = ((_c1.r : GoUInt8));
        _s[((2 : GoInt))] = (((_c1.g >> ((8 : GoUnTypedInt))) : GoUInt8));
    ...
    public function nrgba64at(_x:GoInt, _y:GoInt):stdgo.image.color.Color.NRGBA64 {
        ...
        var _i:GoInt = _p.value.pixOffset(_x, _y);
        var _s:Slice<GoUInt8> = _p.value.pix.__slice__(_i, _i + ((8 : GoInt))).setCap(((_i + ((8 : GoInt)) : GoInt)) - ((1 : GoInt)));
        return new stdgo.image.color.Color.NRGBA64((((_s[((0 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_s[((1 : GoInt))] : GoUInt16)), (((_s[((2 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_s[((3 : GoInt))] : GoUInt16)), (((_s[((4 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_s[((5 : GoInt))] : GoUInt16)), (((_s[((6 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_s[((7 : GoInt))] : GoUInt16))).__copy__();
    }
    public function rgba64at(_x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 {
        var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _p.value.nrgba64at(_x, _y).rgba(), _r:GoUInt32 = __tmp__._0, _g:GoUInt32 = __tmp__._1, _b:GoUInt32 = __tmp__._2, _a:GoUInt32 = __tmp__._3;
        return new stdgo.image.color.Color.RGBA64(((_r : GoUInt16)), ((_g : GoUInt16)), ((_b : GoUInt16)), ((_a : GoUInt16))).__copy__();
    }
    public function at(_x:GoInt, _y:GoInt):stdgo.image.color.Color.Color {
        var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
...
@:structInit class Alpha16 {
    public function opaque():Bool {
        ...
        var _i0:GoInt = ((0 : GoInt)), _i1:GoInt = _p.value.rect.dx() * ((2 : GoInt));
        {
            var _y:GoInt = _p.value.rect.min.y;
            Go.cfor(_y < _p.value.rect.max.y, _y++, {
                {
    ...
    public function set(_x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.Color):Void {
        ...
        var _i:GoInt = _p.value.pixOffset(_x, _y);
        var _c1:stdgo.image.color.Color.Alpha16 = ((stdgo.image.color.Color.alpha16Model.convert(_c).__underlying__().value : stdgo.image.color.Color.Alpha16)).__copy__();
    ...
    public function alpha16At(_x:GoInt, _y:GoInt):stdgo.image.color.Color.Alpha16 {
        ...
        var _i:GoInt = _p.value.pixOffset(_x, _y);
        return new stdgo.image.color.Color.Alpha16((((_p.value.pix[_i + ((0 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_p.value.pix[_i + ((1 : GoInt))] : GoUInt16))).__copy__();
    }
    public function rgba64at(_x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 {
        var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
...
@:structInit class Gray {
    ...
    public function setRGBA64(_x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.RGBA64):Void {
        ...
        var _gray:GoUInt32 = ((((19595 : GoUInt32)) * ((_c.r : GoUInt32)) + ((38470 : GoUInt32)) * ((_c.g : GoUInt32)) + ((7471 : GoUInt32)) * ((_c.b : GoUInt32)) + (((1 : GoUnTypedInt)) << ((15 : GoUnTypedInt)))) >> ((24 : GoUnTypedInt)));
        var _i:GoInt = _p.value.pixOffset(_x, _y);
...
@:structInit class Gray16 {
    ...
    public function setRGBA64(_x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.RGBA64):Void {
        ...
        var _gray:GoUInt32 = ((((19595 : GoUInt32)) * ((_c.r : GoUInt32)) + ((38470 : GoUInt32)) * ((_c.g : GoUInt32)) + ((7471 : GoUInt32)) * ((_c.b : GoUInt32)) + (((1 : GoUnTypedInt)) << ((15 : GoUnTypedInt)))) >> ((16 : GoUnTypedInt)));
        var _i:GoInt = _p.value.pixOffset(_x, _y);
    ...
    public function set(_x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.Color):Void {
        ...
        var _i:GoInt = _p.value.pixOffset(_x, _y);
        var _c1:stdgo.image.color.Color.Gray16 = ((stdgo.image.color.Color.gray16Model.convert(_c).__underlying__().value : stdgo.image.color.Color.Gray16)).__copy__();
    ...
    public function gray16At(_x:GoInt, _y:GoInt):stdgo.image.color.Color.Gray16 {
        ...
        var _i:GoInt = _p.value.pixOffset(_x, _y);
        return new stdgo.image.color.Color.Gray16((((_p.value.pix[_i + ((0 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_p.value.pix[_i + ((1 : GoInt))] : GoUInt16))).__copy__();
    }
    public function rgba64at(_x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 {
        var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
...
@:structInit class CMYK {
    ...
    public function setRGBA64(_x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.RGBA64):Void {
        ...
        var __tmp__ = stdgo.image.color.Color.rgbtoCMYK((((_c.r >> ((8 : GoUnTypedInt))) : GoUInt8)), (((_c.g >> ((8 : GoUnTypedInt))) : GoUInt8)), (((_c.b >> ((8 : GoUnTypedInt))) : GoUInt8))), _cc:GoUInt8 = __tmp__._0, _mm:GoUInt8 = __tmp__._1, _yy:GoUInt8 = __tmp__._2, _kk:GoUInt8 = __tmp__._3;
        var _i:GoInt = _p.value.pixOffset(_x, _y);
        var _s:Slice<GoUInt8> = _p.value.pix.__slice__(_i, _i + ((4 : GoInt))).setCap(((_i + ((4 : GoInt)) : GoInt)) - ((1 : GoInt)));
        _s[((0 : GoInt))] = _cc;
        _s[((1 : GoInt))] = _mm;
    ...
    public function set(_x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.Color):Void {
        ...
        var _i:GoInt = _p.value.pixOffset(_x, _y);
        var _c1:stdgo.image.color.Color.CMYK = ((stdgo.image.color.Color.cmykmodel.convert(_c).__underlying__().value : stdgo.image.color.Color.CMYK)).__copy__();
        var _s:Slice<GoUInt8> = _p.value.pix.__slice__(_i, _i + ((4 : GoInt))).setCap(((_i + ((4 : GoInt)) : GoInt)) - ((1 : GoInt)));
        _s[((0 : GoInt))] = _c1.c;
        _s[((1 : GoInt))] = _c1.m;
        _s[((2 : GoInt))] = _c1.y;
    ...
    public function rgba64at(_x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 {
        var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _p.value.cmykat(_x, _y).rgba(), _r:GoUInt32 = __tmp__._0, _g:GoUInt32 = __tmp__._1, _b:GoUInt32 = __tmp__._2, _a:GoUInt32 = __tmp__._3;
        return new stdgo.image.color.Color.RGBA64(((_r : GoUInt16)), ((_g : GoUInt16)), ((_b : GoUInt16)), ((_a : GoUInt16))).__copy__();
    }
    public function at(_x:GoInt, _y:GoInt):stdgo.image.color.Color.Color {
        var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
...
@:structInit class Paletted {
    ...
    public function subImage(_r:Rectangle):Image {
        ...
        _r = _r.intersect(_p.value.rect.__copy__()).__copy__();
        if (_r.empty()) {
            return Go.pointer((({ palette : _p.value.palette.__copy__(), pix : new Slice<GoUInt8>().nil(), stride : 0, rect : new Rectangle() } : Paletted))).value;
        };
        var _i:GoInt = _p.value.pixOffset(_r.min.x, _r.min.y);
        return Go.pointer((({ pix : _p.value.pix.__slice__(_i), stride : _p.value.stride, rect : _p.value.rect.intersect(_r.__copy__()).__copy__(), palette : _p.value.palette.__copy__() } : Paletted))).value;
    }
    ...
    public function new(?pix:Slice<GoUInt8>, ?stride:GoInt, ?rect:Rectangle, ?palette:stdgo.image.color.Color.Palette) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class Uniform {
    public function opaque():Bool {
        ...
        var __tmp__ = _c.value.c.rgba(), _:GoUInt32 = __tmp__._0, _:GoUInt32 = __tmp__._1, _:GoUInt32 = __tmp__._2, _a:GoUInt32 = __tmp__._3;
        return _a == ((65535 : GoUInt32));
    }
    public function rgba64at(_x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 {
        var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _c.value.c.rgba(), _r:GoUInt32 = __tmp__._0, _g:GoUInt32 = __tmp__._1, _b:GoUInt32 = __tmp__._2, _a:GoUInt32 = __tmp__._3;
        return new stdgo.image.color.Color.RGBA64(((_r : GoUInt16)), ((_g : GoUInt16)), ((_b : GoUInt16)), ((_a : GoUInt16))).__copy__();
    }
    public function at(_x:GoInt, _y:GoInt):stdgo.image.color.Color.Color {
        var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
    ...
    public function bounds():Rectangle {
        var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        return new Rectangle(new Point(-((1e+09 : GoUnTypedFloat)), -((1e+09 : GoUnTypedFloat))).__copy__(), new Point(((1e+09 : GoInt)), ((1e+09 : GoInt))).__copy__()).__copy__();
    }
    ...
    public function rgba():{ var _0 : GoUInt32; var _1 : GoUInt32; var _2 : GoUInt32; var _3 : GoUInt32; } {
        var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
    ...
    public function new(?c:stdgo.image.color.Color.Color) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(c) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
...
@:named class YCbCrSubsampleRatio {
    ...
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() return new YCbCrSubsampleRatio(__t__);
}
@:structInit class YCbCr {
    ...
    public function subImage(_r:Rectangle):Image {
        ...
        _r = _r.intersect(_p.value.rect.__copy__()).__copy__();
        if (_r.empty()) {
            return Go.pointer((({ subsampleRatio : _p.value.subsampleRatio, y : new Slice<GoUInt8>().nil(), cb : new Slice<GoUInt8>().nil(), cr : new Slice<GoUInt8>().nil(), ystride : 0, cstride : 0, rect : new Rectangle() } : YCbCr))).value;
        };
        var _yi:GoInt = _p.value.yoffset(_r.min.x, _r.min.y);
        var _ci:GoInt = _p.value.coffset(_r.min.x, _r.min.y);
        return Go.pointer((({ y : _p.value.y.__slice__(_yi), cb : _p.value.cb.__slice__(_ci), cr : _p.value.cr.__slice__(_ci), subsampleRatio : _p.value.subsampleRatio, ystride : _p.value.ystride, cstride : _p.value.cstride, rect : _r.__copy__() } : YCbCr))).value;
    }
    ...
    public function rgba64at(_x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 {
        var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _p.value.ycbCrAt(_x, _y).rgba(), _r:GoUInt32 = __tmp__._0, _g:GoUInt32 = __tmp__._1, _b:GoUInt32 = __tmp__._2, _a:GoUInt32 = __tmp__._3;
        return new stdgo.image.color.Color.RGBA64(((_r : GoUInt16)), ((_g : GoUInt16)), ((_b : GoUInt16)), ((_a : GoUInt16))).__copy__();
    }
    public function at(_x:GoInt, _y:GoInt):stdgo.image.color.Color.Color {
        var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
    ...
    public var rect : Rectangle = new Rectangle();
    public function new(?y:Slice<GoUInt8>, ?cb:Slice<GoUInt8>, ?cr:Slice<GoUInt8>, ?ystride:GoInt, ?cstride:GoInt, ?subsampleRatio:YCbCrSubsampleRatio, ?rect:Rectangle) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(y) + " " + Go.string(cb) + " " + Go.string(cr) + " " + Go.string(ystride) + " " + Go.string(cstride) + " " + Go.string(subsampleRatio) + " " + Go.string(rect) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class NYCbCrA {
    ...
    public function subImage(_r:Rectangle):Image {
        ...
        if (_r.empty()) {
            return Go.pointer((({ ycbCr : (({ subsampleRatio : _p.value.ycbCr.subsampleRatio, y : new Slice<GoUInt8>().nil(), cb : new Slice<GoUInt8>().nil(), cr : new Slice<GoUInt8>().nil(), ystride : 0, cstride : 0, rect : new Rectangle() } : YCbCr)).__copy__(), a : new Slice<GoUInt8>().nil(), astride : 0 } : NYCbCrA))).value;
        };
        var _yi:GoInt = _p.value.yoffset(_r.min.x, _r.min.y);
        var _ci:GoInt = _p.value.coffset(_r.min.x, _r.min.y);
        var _ai:GoInt = _p.value.aoffset(_r.min.x, _r.min.y);
        return Go.pointer((({ ycbCr : (({ y : _p.value.ycbCr.y.__slice__(_yi), cb : _p.value.ycbCr.cb.__slice__(_ci), cr : _p.value.ycbCr.cr.__slice__(_ci), subsampleRatio : _p.value.ycbCr.subsampleRatio, ystride : _p.value.ycbCr.ystride, cstride : _p.value.ycbCr.cstride, rect : _r.__copy__() } : YCbCr)).__copy__(), a : _p.value.a.__slice__(_ai), astride : _p.value.astride } : NYCbCrA))).value;
    }
    ...
    public function nycbCrAAt(_x:GoInt, _y:GoInt):stdgo.image.color.Color.NYCbCrA {
        ...
        return new stdgo.image.color.Color.NYCbCrA((({ y : _p.value.ycbCr.y[_yi], cb : _p.value.ycbCr.cb[_ci], cr : _p.value.ycbCr.cr[_ci] } : stdgo.image.color.Color.YCbCr)).__copy__(), _p.value.a[_ai]).__copy__();
    }
    public function rgba64at(_x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 {
        var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _p.value.nycbCrAAt(_x, _y).rgba(), _r:GoUInt32 = __tmp__._0, _g:GoUInt32 = __tmp__._1, _b:GoUInt32 = __tmp__._2, _a:GoUInt32 = __tmp__._3;
        return new stdgo.image.color.Color.RGBA64(((_r : GoUInt16)), ((_g : GoUInt16)), ((_b : GoUInt16)), ((_a : GoUInt16))).__copy__();
    }
    public function at(_x:GoInt, _y:GoInt):stdgo.image.color.Color.Color {
        var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
    ...
    public function new(?ycbCr:YCbCr, ?a:Slice<GoUInt8>, ?astride:GoInt) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(ycbCr) + " " + Go.string(a) + " " + Go.string(astride) + "}";
    }
    public function bounds():Rectangle return ycbCr.bounds();
    public function coffset(_x:GoInt, _y:GoInt):GoInt return ycbCr.coffset(_0, _1);
    public function ycbCrAt(_x:GoInt, _y:GoInt):stdgo.image.color.Color.YCbCr return ycbCr.ycbCrAt(_0, _1);
    public function yoffset(_x:GoInt, _y:GoInt):GoInt return ycbCr.yoffset(_0, _1);
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
**/
function registerFormat(_name:GoString, _magic:GoString, _decode:stdgo.io.Io.Reader -> { var _0 : Image; var _1 : Error; }, _decodeConfig:stdgo.io.Io.Reader -> { var _0 : Config; var _1 : Error; }):Void {
        _formatsMu.lock();
        var __tmp__ = try {
...
function _sniff(_r:T_reader):T_format {
        ...
        for (_f in _formats) {
            var __tmp__ = _r.peek(_f._magic.length), _b:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
...
function decode(_r:stdgo.io.Io.Reader):{ var _0 : Image; var _1 : GoString; var _2 : Error; } {
        ...
        var __tmp__ = _f._decode(_rr), _m:Image = __tmp__._0, _err:stdgo.Error = __tmp__._1;
...
function decodeConfig(_r:stdgo.io.Io.Reader):{ var _0 : Config; var _1 : GoString; var _2 : Error; } {
        ...
        var __tmp__ = _f._decodeConfig(_rr), _c:Config = __tmp__._0, _err:stdgo.Error = __tmp__._1;
...
function _mul3NonNeg(_x:GoInt, _y:GoInt, _z:GoInt):GoInt {
        ...
        var __tmp__ = stdgo.math.bits.Bits.mul64(((_x : GoUInt64)), ((_y : GoUInt64))), _hi:GoUInt64 = __tmp__._0, _lo:GoUInt64 = __tmp__._1;
        if (_hi != ((0 : GoUInt64))) {
            return -((1 : GoUnTypedInt));
        };
        {
...
function newRGBA(_r:Rectangle):Pointer<RGBA> {
        return Go.pointer((({ pix : new Slice<GoUInt8>(...[for (i in 0 ... ((_pixelBufferLength(((4 : GoInt)), _r.__copy__(), "RGBA") : GoInt)).toBasic()) ((0 : GoUInt8))]), stride : ((4 : GoInt)) * _r.dx(), rect : _r.__copy__() } : RGBA)));
    }
/**
    // NewRGBA64 returns a new RGBA64 image with the given bounds.
**/
function newRGBA64(_r:Rectangle):Pointer<RGBA64> {
        return Go.pointer((({ pix : new Slice<GoUInt8>(...[for (i in 0 ... ((_pixelBufferLength(((8 : GoInt)), _r.__copy__(), "RGBA64") : GoInt)).toBasic()) ((0 : GoUInt8))]), stride : ((8 : GoInt)) * _r.dx(), rect : _r.__copy__() } : RGBA64)));
    }
/**
    // NewNRGBA returns a new NRGBA image with the given bounds.
**/
function newNRGBA(_r:Rectangle):Pointer<NRGBA> {
        return Go.pointer((({ pix : new Slice<GoUInt8>(...[for (i in 0 ... ((_pixelBufferLength(((4 : GoInt)), _r.__copy__(), "NRGBA") : GoInt)).toBasic()) ((0 : GoUInt8))]), stride : ((4 : GoInt)) * _r.dx(), rect : _r.__copy__() } : NRGBA)));
    }
/**
    // NewNRGBA64 returns a new NRGBA64 image with the given bounds.
**/
function newNRGBA64(_r:Rectangle):Pointer<NRGBA64> {
        return Go.pointer((({ pix : new Slice<GoUInt8>(...[for (i in 0 ... ((_pixelBufferLength(((8 : GoInt)), _r.__copy__(), "NRGBA64") : GoInt)).toBasic()) ((0 : GoUInt8))]), stride : ((8 : GoInt)) * _r.dx(), rect : _r.__copy__() } : NRGBA64)));
    }
/**
    // NewAlpha returns a new Alpha image with the given bounds.
**/
function newAlpha(_r:Rectangle):Pointer<Alpha> {
        return Go.pointer((({ pix : new Slice<GoUInt8>(...[for (i in 0 ... ((_pixelBufferLength(((1 : GoInt)), _r.__copy__(), "Alpha") : GoInt)).toBasic()) ((0 : GoUInt8))]), stride : ((1 : GoInt)) * _r.dx(), rect : _r.__copy__() } : Alpha)));
    }
/**
    // NewAlpha16 returns a new Alpha16 image with the given bounds.
**/
function newAlpha16(_r:Rectangle):Pointer<Alpha16> {
        return Go.pointer((({ pix : new Slice<GoUInt8>(...[for (i in 0 ... ((_pixelBufferLength(((2 : GoInt)), _r.__copy__(), "Alpha16") : GoInt)).toBasic()) ((0 : GoUInt8))]), stride : ((2 : GoInt)) * _r.dx(), rect : _r.__copy__() } : Alpha16)));
    }
/**
    // NewGray returns a new Gray image with the given bounds.
**/
function newGray(_r:Rectangle):Pointer<Gray> {
        return Go.pointer((({ pix : new Slice<GoUInt8>(...[for (i in 0 ... ((_pixelBufferLength(((1 : GoInt)), _r.__copy__(), "Gray") : GoInt)).toBasic()) ((0 : GoUInt8))]), stride : ((1 : GoInt)) * _r.dx(), rect : _r.__copy__() } : Gray)));
    }
/**
    // NewGray16 returns a new Gray16 image with the given bounds.
**/
function newGray16(_r:Rectangle):Pointer<Gray16> {
        return Go.pointer((({ pix : new Slice<GoUInt8>(...[for (i in 0 ... ((_pixelBufferLength(((2 : GoInt)), _r.__copy__(), "Gray16") : GoInt)).toBasic()) ((0 : GoUInt8))]), stride : ((2 : GoInt)) * _r.dx(), rect : _r.__copy__() } : Gray16)));
    }
/**
    // NewCMYK returns a new CMYK image with the given bounds.
**/
function newCMYK(_r:Rectangle):Pointer<CMYK> {
        return Go.pointer((({ pix : new Slice<GoUInt8>(...[for (i in 0 ... ((_pixelBufferLength(((4 : GoInt)), _r.__copy__(), "CMYK") : GoInt)).toBasic()) ((0 : GoUInt8))]), stride : ((4 : GoInt)) * _r.dx(), rect : _r.__copy__() } : CMYK)));
    }
/**
...
function newPaletted(_r:Rectangle, _p:stdgo.image.color.Color.Palette):Pointer<Paletted> {
        return Go.pointer((({ pix : new Slice<GoUInt8>(...[for (i in 0 ... ((_pixelBufferLength(((1 : GoInt)), _r.__copy__(), "Paletted") : GoInt)).toBasic()) ((0 : GoUInt8))]), stride : ((1 : GoInt)) * _r.dx(), rect : _r.__copy__(), palette : _p.__copy__() } : Paletted)));
    }
/**
...
function _yCbCrSize(_r:Rectangle, _subsampleRatio:YCbCrSubsampleRatio):{ var _0 : GoInt; var _1 : GoInt; var _2 : GoInt; var _3 : GoInt; } {
        var _w:GoInt = ((0 : GoInt)), _h:GoInt = ((0 : GoInt)), _cw:GoInt = ((0 : GoInt)), _ch:GoInt = ((0 : GoInt));
        {
...
function newYCbCr(_r:Rectangle, _subsampleRatio:YCbCrSubsampleRatio):Pointer<YCbCr> {
        var __tmp__ = _yCbCrSize(_r.__copy__(), _subsampleRatio), _w:GoInt = __tmp__._0, _h:GoInt = __tmp__._1, _cw:GoInt = __tmp__._2, _ch:GoInt = __tmp__._3;
        ...
        return Go.pointer((({ y : _b.__slice__(0, _i0).setCap(((_i0 : GoInt)) - ((1 : GoInt))), cb : _b.__slice__(_i0, _i1).setCap(((_i1 : GoInt)) - ((1 : GoInt))), cr : _b.__slice__(_i1, _i2).setCap(((_i2 : GoInt)) - ((1 : GoInt))), subsampleRatio : _subsampleRatio, ystride : _w, cstride : _cw, rect : _r.__copy__() } : YCbCr)));
    }
/**
...
function newNYCbCrA(_r:Rectangle, _subsampleRatio:YCbCrSubsampleRatio):Pointer<NYCbCrA> {
        ...
        return Go.pointer((({ ycbCr : (({ y : _b.__slice__(0, _i0).setCap(((_i0 : GoInt)) - ((1 : GoInt))), cb : _b.__slice__(_i0, _i1).setCap(((_i1 : GoInt)) - ((1 : GoInt))), cr : _b.__slice__(_i1, _i2).setCap(((_i2 : GoInt)) - ((1 : GoInt))), subsampleRatio : _subsampleRatio, ystride : _w, cstride : _cw, rect : _r.__copy__() } : YCbCr)).__copy__(), a : _b.__slice__(_i2), astride : _w } : NYCbCrA)));
    }
class Point_extension_fields {
    public function toString(__tmp__):GoString return __tmp__.toString();
    public function add(__tmp__, _q:Point):Point return __tmp__.add(_q);
    public function sub(__tmp__, _q:Point):Point return __tmp__.sub(_q);
    public function mul(__tmp__, _k:GoInt):Point return __tmp__.mul(_k);
    public function div(__tmp__, _k:GoInt):Point return __tmp__.div(_k);
    public function in_(__tmp__, _r:Rectangle):Bool return __tmp__.in_(_r);
    public function mod(__tmp__, _r:Rectangle):Point return __tmp__.mod(_r);
    public function eq(__tmp__, _q:Point):Bool return __tmp__.eq(_q);
}
class Rectangle_extension_fields {
    public function toString(__tmp__):GoString return __tmp__.toString();
    public function dx(__tmp__):GoInt return __tmp__.dx();
    public function dy(__tmp__):GoInt return __tmp__.dy();
    public function size(__tmp__):Point return __tmp__.size();
    public function add(__tmp__, _p:Point):Rectangle return __tmp__.add(_p);
    public function sub(__tmp__, _p:Point):Rectangle return __tmp__.sub(_p);
    public function inset(__tmp__, _n:GoInt):Rectangle return __tmp__.inset(_n);
    public function intersect(__tmp__, _s:Rectangle):Rectangle return __tmp__.intersect(_s);
    public function union(__tmp__, _s:Rectangle):Rectangle return __tmp__.union(_s);
    public function empty(__tmp__):Bool return __tmp__.empty();
    public function eq(__tmp__, _s:Rectangle):Bool return __tmp__.eq(_s);
    public function overlaps(__tmp__, _s:Rectangle):Bool return __tmp__.overlaps(_s);
    public function in_(__tmp__, _s:Rectangle):Bool return __tmp__.in_(_s);
    public function canon(__tmp__):Rectangle return __tmp__.canon();
    public function at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.Color return __tmp__.at(_x, _y);
    public function rgba64at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 return __tmp__.rgba64at(_x, _y);
    public function bounds(__tmp__):Rectangle return __tmp__.bounds();
    public function colorModel(__tmp__):stdgo.image.color.Color.Model return __tmp__.colorModel();
}
class RGBA_extension_fields {
    ...
    public function at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.Color return __tmp__.at(_x, _y);
    public function rgba64at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 return __tmp__.rgba64at(_x, _y);
    public function rgbaat(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA return __tmp__.rgbaat(_x, _y);
    public function pixOffset(__tmp__, _x:GoInt, _y:GoInt):GoInt return __tmp__.pixOffset(_x, _y);
    public function set(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.Color):Void __tmp__.set(_x, _y, _c);
    public function setRGBA64(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.RGBA64):Void __tmp__.setRGBA64(_x, _y, _c);
    public function setRGBA(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.RGBA):Void __tmp__.setRGBA(_x, _y, _c);
    public function subImage(__tmp__, _r:Rectangle):Image return __tmp__.subImage(_r);
    public function opaque(__tmp__):Bool return __tmp__.opaque();
}
...
class NRGBA_extension_fields {
    ...
    public function at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.Color return __tmp__.at(_x, _y);
    public function rgba64at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 return __tmp__.rgba64at(_x, _y);
    public function nrgbaat(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.NRGBA return __tmp__.nrgbaat(_x, _y);
    public function pixOffset(__tmp__, _x:GoInt, _y:GoInt):GoInt return __tmp__.pixOffset(_x, _y);
    public function set(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.Color):Void __tmp__.set(_x, _y, _c);
    public function setRGBA64(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.RGBA64):Void __tmp__.setRGBA64(_x, _y, _c);
    public function setNRGBA(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.NRGBA):Void __tmp__.setNRGBA(_x, _y, _c);
    public function subImage(__tmp__, _r:Rectangle):Image return __tmp__.subImage(_r);
    public function opaque(__tmp__):Bool return __tmp__.opaque();
}
class NRGBA64_extension_fields {
    ...
    public function at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.Color return __tmp__.at(_x, _y);
    public function rgba64at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 return __tmp__.rgba64at(_x, _y);
    public function nrgba64at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.NRGBA64 return __tmp__.nrgba64at(_x, _y);
    public function pixOffset(__tmp__, _x:GoInt, _y:GoInt):GoInt return __tmp__.pixOffset(_x, _y);
    public function set(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.Color):Void __tmp__.set(_x, _y, _c);
    public function setRGBA64(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.RGBA64):Void __tmp__.setRGBA64(_x, _y, _c);
    public function setNRGBA64(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.NRGBA64):Void __tmp__.setNRGBA64(_x, _y, _c);
    public function subImage(__tmp__, _r:Rectangle):Image return __tmp__.subImage(_r);
    public function opaque(__tmp__):Bool return __tmp__.opaque();
}
class Alpha_extension_fields {
    ...
    public function at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.Color return __tmp__.at(_x, _y);
    public function rgba64at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 return __tmp__.rgba64at(_x, _y);
    public function alphaAt(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.Alpha return __tmp__.alphaAt(_x, _y);
    public function pixOffset(__tmp__, _x:GoInt, _y:GoInt):GoInt return __tmp__.pixOffset(_x, _y);
    public function set(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.Color):Void __tmp__.set(_x, _y, _c);
    public function setRGBA64(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.RGBA64):Void __tmp__.setRGBA64(_x, _y, _c);
    public function setAlpha(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.Alpha):Void __tmp__.setAlpha(_x, _y, _c);
    public function subImage(__tmp__, _r:Rectangle):Image return __tmp__.subImage(_r);
    public function opaque(__tmp__):Bool return __tmp__.opaque();
}
class Alpha16_extension_fields {
    ...
    public function at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.Color return __tmp__.at(_x, _y);
    public function rgba64at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 return __tmp__.rgba64at(_x, _y);
    public function alpha16At(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.Alpha16 return __tmp__.alpha16At(_x, _y);
    public function pixOffset(__tmp__, _x:GoInt, _y:GoInt):GoInt return __tmp__.pixOffset(_x, _y);
    public function set(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.Color):Void __tmp__.set(_x, _y, _c);
    public function setRGBA64(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.RGBA64):Void __tmp__.setRGBA64(_x, _y, _c);
    public function setAlpha16(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.Alpha16):Void __tmp__.setAlpha16(_x, _y, _c);
    public function subImage(__tmp__, _r:Rectangle):Image return __tmp__.subImage(_r);
    public function opaque(__tmp__):Bool return __tmp__.opaque();
}
class Gray_extension_fields {
    ...
    public function at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.Color return __tmp__.at(_x, _y);
    public function rgba64at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 return __tmp__.rgba64at(_x, _y);
    public function grayAt(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.Gray return __tmp__.grayAt(_x, _y);
    public function pixOffset(__tmp__, _x:GoInt, _y:GoInt):GoInt return __tmp__.pixOffset(_x, _y);
    public function set(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.Color):Void __tmp__.set(_x, _y, _c);
    public function setRGBA64(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.RGBA64):Void __tmp__.setRGBA64(_x, _y, _c);
    public function setGray(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.Gray):Void __tmp__.setGray(_x, _y, _c);
    public function subImage(__tmp__, _r:Rectangle):Image return __tmp__.subImage(_r);
    public function opaque(__tmp__):Bool return __tmp__.opaque();
}
class Gray16_extension_fields {
    ...
    public function at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.Color return __tmp__.at(_x, _y);
    public function rgba64at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 return __tmp__.rgba64at(_x, _y);
    public function gray16At(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.Gray16 return __tmp__.gray16At(_x, _y);
    public function pixOffset(__tmp__, _x:GoInt, _y:GoInt):GoInt return __tmp__.pixOffset(_x, _y);
    public function set(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.Color):Void __tmp__.set(_x, _y, _c);
    public function setRGBA64(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.RGBA64):Void __tmp__.setRGBA64(_x, _y, _c);
    public function setGray16(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.Gray16):Void __tmp__.setGray16(_x, _y, _c);
    public function subImage(__tmp__, _r:Rectangle):Image return __tmp__.subImage(_r);
    public function opaque(__tmp__):Bool return __tmp__.opaque();
}
class CMYK_extension_fields {
    ...
    public function at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.Color return __tmp__.at(_x, _y);
    public function rgba64at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 return __tmp__.rgba64at(_x, _y);
    public function cmykat(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.CMYK return __tmp__.cmykat(_x, _y);
    public function pixOffset(__tmp__, _x:GoInt, _y:GoInt):GoInt return __tmp__.pixOffset(_x, _y);
    public function set(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.Color):Void __tmp__.set(_x, _y, _c);
    public function setRGBA64(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.RGBA64):Void __tmp__.setRGBA64(_x, _y, _c);
    public function setCMYK(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.CMYK):Void __tmp__.setCMYK(_x, _y, _c);
    public function subImage(__tmp__, _r:Rectangle):Image return __tmp__.subImage(_r);
    public function opaque(__tmp__):Bool return __tmp__.opaque();
}
class Paletted_extension_fields {
    ...
    public function set(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.Color):Void __tmp__.set(_x, _y, _c);
    public function setRGBA64(__tmp__, _x:GoInt, _y:GoInt, _c:stdgo.image.color.Color.RGBA64):Void __tmp__.setRGBA64(_x, _y, _c);
    public function colorIndexAt(__tmp__, _x:GoInt, _y:GoInt):GoUInt8 return __tmp__.colorIndexAt(_x, _y);
    public function setColorIndex(__tmp__, _x:GoInt, _y:GoInt, _index:GoUInt8):Void __tmp__.setColorIndex(_x, _y, _index);
    public function subImage(__tmp__, _r:Rectangle):Image return __tmp__.subImage(_r);
    public function opaque(__tmp__):Bool return __tmp__.opaque();
}
class Uniform_extension_fields {
    public function rgba(__tmp__):{ var _0 : GoUInt32; var _1 : GoUInt32; var _2 : GoUInt32; var _3 : GoUInt32; } return __tmp__.rgba();
    public function colorModel(__tmp__):stdgo.image.color.Color.Model return __tmp__.colorModel();
    public function convert(__tmp__, arg0:stdgo.image.color.Color.Color):stdgo.image.color.Color.Color return __tmp__.convert(arg0);
    public function bounds(__tmp__):Rectangle return __tmp__.bounds();
    public function at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.Color return __tmp__.at(_x, _y);
    public function rgba64at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 return __tmp__.rgba64at(_x, _y);
    public function opaque(__tmp__):Bool return __tmp__.opaque();
...
class YCbCr_extension_fields {
    ...
    public function at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.Color return __tmp__.at(_x, _y);
    public function rgba64at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 return __tmp__.rgba64at(_x, _y);
    public function ycbCrAt(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.YCbCr return __tmp__.ycbCrAt(_x, _y);
    public function yoffset(__tmp__, _x:GoInt, _y:GoInt):GoInt return __tmp__.yoffset(_x, _y);
    public function coffset(__tmp__, _x:GoInt, _y:GoInt):GoInt return __tmp__.coffset(_x, _y);
    public function subImage(__tmp__, _r:Rectangle):Image return __tmp__.subImage(_r);
    public function opaque(__tmp__):Bool return __tmp__.opaque();
}
class NYCbCrA_extension_fields {
    ...
    public function at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.Color return __tmp__.at(_x, _y);
    public function rgba64at(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.RGBA64 return __tmp__.rgba64at(_x, _y);
    public function nycbCrAAt(__tmp__, _x:GoInt, _y:GoInt):stdgo.image.color.Color.NYCbCrA return __tmp__.nycbCrAAt(_x, _y);
    public function aoffset(__tmp__, _x:GoInt, _y:GoInt):GoInt return __tmp__.aoffset(_x, _y);
    public function subImage(__tmp__, _r:Rectangle):Image return __tmp__.subImage(_r);
    public function opaque(__tmp__):Bool return __tmp__.opaque();
}
