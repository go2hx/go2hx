...
**/
var black : stdgo.image.color.Color.Gray16 = (new stdgo.image.color.Color.Gray16((0 : stdgo.GoUInt16)) : stdgo.image.color.Color.Gray16);
/**
    // Standard colors.
    
    
**/
var white : stdgo.image.color.Color.Gray16 = (new stdgo.image.color.Color.Gray16((65535 : stdgo.GoUInt16)) : stdgo.image.color.Color.Gray16);
/**
    // Standard colors.
    
    
**/
var transparent : stdgo.image.color.Color.Alpha16 = (new stdgo.image.color.Color.Alpha16((0 : stdgo.GoUInt16)) : stdgo.image.color.Color.Alpha16);
/**
    // Standard colors.
    
    
**/
var opaque : stdgo.image.color.Color.Alpha16 = (new stdgo.image.color.Color.Alpha16((65535 : stdgo.GoUInt16)) : stdgo.image.color.Color.Alpha16);
/**
...
@:structInit @:using(stdgo.image.color.Color.NYCbCrA_static_extension) class NYCbCrA {
    ...
    public var a : stdgo.GoUInt8 = 0;
    public function new(?ycbCr:stdgo.image.color.Color.YCbCr, ?a:stdgo.GoUInt8) {
...
function modelFunc(_f:Color -> Color):Model {
        return stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.image.color.Color.T_modelFunc(_f) : stdgo.image.color.Color.T_modelFunc)) : stdgo.Ref<stdgo.image.color.Color.T_modelFunc>));
    }
function _rgbaModel(_c:Color):Color {
        ...
        return stdgo.Go.asInterface((new stdgo.image.color.Color.RGBA((_r >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt8), (_g >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt8), (_b >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt8), (_a >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt8)) : stdgo.image.color.Color.RGBA));
    }
function _rgba64Model(_c:Color):Color {
        ...
        var __tmp__ = _c.rgba(), _r:stdgo.GoUInt32 = __tmp__._0, _g:stdgo.GoUInt32 = __tmp__._1, _b:stdgo.GoUInt32 = __tmp__._2, _a:stdgo.GoUInt32 = __tmp__._3;
        return stdgo.Go.asInterface((new stdgo.image.color.Color.RGBA64((_r : stdgo.GoUInt16), (_g : stdgo.GoUInt16), (_b : stdgo.GoUInt16), (_a : stdgo.GoUInt16)) : stdgo.image.color.Color.RGBA64));
    }
function _nrgbaModel(_c:Color):Color {
        ...
        if (_a == ((65535u32 : stdgo.GoUInt32))) {
            return stdgo.Go.asInterface((new stdgo.image.color.Color.NRGBA((_r >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt8), (_g >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt8), (_b >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt8), (255 : stdgo.GoUInt8)) : stdgo.image.color.Color.NRGBA));
        };
        if (_a == ((0u32 : stdgo.GoUInt32))) {
            return stdgo.Go.asInterface((new stdgo.image.color.Color.NRGBA((0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8)) : stdgo.image.color.Color.NRGBA));
        };
        _r = (_r * (65535u32 : stdgo.GoUInt32)) / _a;
        _g = (_g * (65535u32 : stdgo.GoUInt32)) / _a;
        _b = (_b * (65535u32 : stdgo.GoUInt32)) / _a;
        return stdgo.Go.asInterface((new stdgo.image.color.Color.NRGBA((_r >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt8), (_g >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt8), (_b >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt8), (_a >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt8)) : stdgo.image.color.Color.NRGBA));
    }
function _nrgba64Model(_c:Color):Color {
        ...
        var __tmp__ = _c.rgba(), _r:stdgo.GoUInt32 = __tmp__._0, _g:stdgo.GoUInt32 = __tmp__._1, _b:stdgo.GoUInt32 = __tmp__._2, _a:stdgo.GoUInt32 = __tmp__._3;
        if (_a == ((65535u32 : stdgo.GoUInt32))) {
            return stdgo.Go.asInterface((new stdgo.image.color.Color.NRGBA64((_r : stdgo.GoUInt16), (_g : stdgo.GoUInt16), (_b : stdgo.GoUInt16), (65535 : stdgo.GoUInt16)) : stdgo.image.color.Color.NRGBA64));
        };
        if (_a == ((0u32 : stdgo.GoUInt32))) {
            return stdgo.Go.asInterface((new stdgo.image.color.Color.NRGBA64((0 : stdgo.GoUInt16), (0 : stdgo.GoUInt16), (0 : stdgo.GoUInt16), (0 : stdgo.GoUInt16)) : stdgo.image.color.Color.NRGBA64));
        };
        _r = (_r * (65535u32 : stdgo.GoUInt32)) / _a;
        _g = (_g * (65535u32 : stdgo.GoUInt32)) / _a;
        _b = (_b * (65535u32 : stdgo.GoUInt32)) / _a;
        return stdgo.Go.asInterface((new stdgo.image.color.Color.NRGBA64((_r : stdgo.GoUInt16), (_g : stdgo.GoUInt16), (_b : stdgo.GoUInt16), (_a : stdgo.GoUInt16)) : stdgo.image.color.Color.NRGBA64));
    }
function _alphaModel(_c:Color):Color {
        ...
        return stdgo.Go.asInterface((new stdgo.image.color.Color.Alpha((_a >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt8)) : stdgo.image.color.Color.Alpha));
    }
function _alpha16Model(_c:Color):Color {
        ...
        var __tmp__ = _c.rgba(), __1:stdgo.GoUInt32 = __tmp__._0, __2:stdgo.GoUInt32 = __tmp__._1, __3:stdgo.GoUInt32 = __tmp__._2, _a:stdgo.GoUInt32 = __tmp__._3;
        return stdgo.Go.asInterface((new stdgo.image.color.Color.Alpha16((_a : stdgo.GoUInt16)) : stdgo.image.color.Color.Alpha16));
    }
function _grayModel(_c:Color):Color {
        ...
        return stdgo.Go.asInterface((new stdgo.image.color.Color.Gray((_y : stdgo.GoUInt8)) : stdgo.image.color.Color.Gray));
    }
function _gray16Model(_c:Color):Color {
        ...
        return stdgo.Go.asInterface((new stdgo.image.color.Color.Gray16((_y : stdgo.GoUInt16)) : stdgo.image.color.Color.Gray16));
    }
/**
...
function testSqDiff(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
(-1u32 : stdgo.GoUInt32)) : stdgo.Slice<stdgo.GoUInt32>);
        for (__0 => _x in _testCases) {
            for (__1 => _y in _testCases) {
                {
                    var __0:stdgo.GoUInt32 = _sqDiff(_x, _y), __1:stdgo.GoUInt32 = _orig(_x, _y), _want:stdgo.GoUInt32 = __1, _got:stdgo.GoUInt32 = __0;
                    if (_got != (_want)) {
        ...
        {
            var _err:stdgo.Error = stdgo.testing.quick.Quick.checkEqual(stdgo.Go.toInterface(_orig), stdgo.Go.toInterface(_sqDiff), (stdgo.Go.setRef(({ maxCountScale : (10 : stdgo.GoFloat64) } : stdgo.testing.quick.Quick.Config)) : stdgo.Ref<stdgo.testing.quick.Quick.Config>));
            if (_err != null) {
...
function _nYCbCrAModel(_c:Color):Color {
        {
            ...
            if (stdgo.Go.typeEquals((__type__ : NYCbCrA))) {
                ...
                return stdgo.Go.asInterface((new stdgo.image.color.Color.NYCbCrA(_c?.__copy__(), (255 : stdgo.GoUInt8)) : stdgo.image.color.Color.NYCbCrA));
            };
        };
        var __tmp__ = _c.rgba(), _r:stdgo.GoUInt32 = __tmp__._0, _g:stdgo.GoUInt32 = __tmp__._1, _b:stdgo.GoUInt32 = __tmp__._2, _a:stdgo.GoUInt32 = __tmp__._3;
        if (_a != ((0u32 : stdgo.GoUInt32))) {
        ...
        var __tmp__ = rgbtoYCbCr((_r >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt8), (_g >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt8), (_b >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt8)), _y:stdgo.GoUInt8 = __tmp__._0, _u:stdgo.GoUInt8 = __tmp__._1, _v:stdgo.GoUInt8 = __tmp__._2;
        return stdgo.Go.asInterface((new stdgo.image.color.Color.NYCbCrA(({ y : _y, cb : _u, cr : _v } : stdgo.image.color.Color.YCbCr), (_a >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt8)) : stdgo.image.color.Color.NYCbCrA));
    }
/**
...
**/
function testYCbCrRoundtrip(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {
...
/**
    ...
    // bit color).
**/
function testYCbCrToRGBConsistency(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {
                    ...
                    stdgo.Go.cfor(_cb < (256 : stdgo.GoInt), _cb = _cb + ((5 : stdgo.GoInt)), {
                        {
                            ...
                            stdgo.Go.cfor(_cr < (256 : stdgo.GoInt), _cr = _cr + ((3 : stdgo.GoInt)), {
                                var _x:stdgo.image.color.Color.YCbCr = (new stdgo.image.color.Color.YCbCr((_y : stdgo.GoUInt8), (_cb : stdgo.GoUInt8), (_cr : stdgo.GoUInt8)) : stdgo.image.color.Color.YCbCr);
...
**/
function testYCbCrGray(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < (256 : stdgo.GoInt), _i++, {
                var _c0:stdgo.image.color.Color.YCbCr = (new stdgo.image.color.Color.YCbCr((_i : stdgo.GoUInt8), (128 : stdgo.GoUInt8), (128 : stdgo.GoUInt8)) : stdgo.image.color.Color.YCbCr);
                var _c1:stdgo.image.color.Color.Gray = (new stdgo.image.color.Color.Gray((_i : stdgo.GoUInt8)) : stdgo.image.color.Color.Gray);
                {
...
**/
function testNYCbCrAAlpha(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < (256 : stdgo.GoInt), _i++, {
                var _c0:stdgo.image.color.Color.NYCbCrA = (new stdgo.image.color.Color.NYCbCrA((new stdgo.image.color.Color.YCbCr((255 : stdgo.GoUInt8), (128 : stdgo.GoUInt8), (128 : stdgo.GoUInt8)) : stdgo.image.color.Color.YCbCr), (_i : stdgo.GoUInt8)) : stdgo.image.color.Color.NYCbCrA);
                var _c1:stdgo.image.color.Color.Alpha = (new stdgo.image.color.Color.Alpha((_i : stdgo.GoUInt8)) : stdgo.image.color.Color.Alpha);
                {
                    var _err:stdgo.Error = _eq(stdgo.Go.asInterface(_c0), stdgo.Go.asInterface(_c1));
                    if (_err != null) {
                        _t.errorf(("i=0x%02x:\n%v" : stdgo.GoString), stdgo.Go.toInterface(_i), stdgo.Go.toInterface(_err));
...
**/
function testNYCbCrAYCbCr(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < (256 : stdgo.GoInt), _i++, {
                var _c0:stdgo.image.color.Color.NYCbCrA = (new stdgo.image.color.Color.NYCbCrA((new stdgo.image.color.Color.YCbCr((_i : stdgo.GoUInt8), (64 : stdgo.GoUInt8), (192 : stdgo.GoUInt8)) : stdgo.image.color.Color.YCbCr), (255 : stdgo.GoUInt8)) : stdgo.image.color.Color.NYCbCrA);
                var _c1:stdgo.image.color.Color.YCbCr = (new stdgo.image.color.Color.YCbCr((_i : stdgo.GoUInt8), (64 : stdgo.GoUInt8), (192 : stdgo.GoUInt8)) : stdgo.image.color.Color.YCbCr);
                {
                    var _err:stdgo.Error = _eq(stdgo.Go.asInterface(_c0), stdgo.Go.asInterface(_c1));
                    if (_err != null) {
                        _t.errorf(("i=0x%02x:\n%v" : stdgo.GoString), stdgo.Go.toInterface(_i), stdgo.Go.toInterface(_err));
...
**/
function testCMYKRoundtrip(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {
            var _r:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_r < (256 : stdgo.GoInt), _r = _r + ((7 : stdgo.GoInt)), {
                {
...
/**
    ...
    // bit color).
**/
function testCMYKToRGBConsistency(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {
                            ...
                            stdgo.Go.cfor(_y < (256 : stdgo.GoInt), _y = _y + ((3 : stdgo.GoInt)), {
                                {
                                    ...
                                    stdgo.Go.cfor(_k < (256 : stdgo.GoInt), _k = _k + ((11 : stdgo.GoInt)), {
                                        var _x:stdgo.image.color.Color.CMYK = (new stdgo.image.color.Color.CMYK((_c : stdgo.GoUInt8), (_m : stdgo.GoUInt8), (_y : stdgo.GoUInt8), (_k : stdgo.GoUInt8)) : stdgo.image.color.Color.CMYK);
                                        var __tmp__ = _x.rgba(), _r0:stdgo.GoUInt32 = __tmp__._0, _g0:stdgo.GoUInt32 = __tmp__._1, _b0:stdgo.GoUInt32 = __tmp__._2, __0:stdgo.GoUInt32 = __tmp__._3;
                                        var __0:stdgo.GoUInt8 = (_r0 >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt8), __1:stdgo.GoUInt8 = (_g0 >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt8), __2:stdgo.GoUInt8 = (_b0 >> (8i64 : stdgo.GoUInt64) : stdgo.GoUInt8), _b1:stdgo.GoUInt8 = __2, _g1:stdgo.GoUInt8 = __1, _r1:stdgo.GoUInt8 = __0;
...
**/
function testCMYKGray(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < (256 : stdgo.GoInt), _i++, {
                {
                    var _err:stdgo.Error = _eq(stdgo.Go.asInterface((new stdgo.image.color.Color.CMYK((0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), ((255 : stdgo.GoInt) - _i : stdgo.GoUInt8)) : stdgo.image.color.Color.CMYK)), stdgo.Go.asInterface((new stdgo.image.color.Color.Gray((_i : stdgo.GoUInt8)) : stdgo.image.color.Color.Gray)));
                    if (_err != null) {
                        _t.errorf(("i=0x%02x:\n%v" : stdgo.GoString), stdgo.Go.toInterface(_i), stdgo.Go.toInterface(_err));
                    };
                };
...
function testPalette(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _p:stdgo.image.color.Color.Palette = (new stdgo.Slice<stdgo.image.color.Color.Color>(6, 6, stdgo.Go.asInterface((new stdgo.image.color.Color.RGBA((255 : stdgo.GoUInt8), (255 : stdgo.GoUInt8), (255 : stdgo.GoUInt8), (255 : stdgo.GoUInt8)) : stdgo.image.color.Color.RGBA)), stdgo.Go.asInterface((new stdgo.image.color.Color.RGBA((128 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (255 : stdgo.GoUInt8)) : stdgo.image.color.Color.RGBA)), stdgo.Go.asInterface((new stdgo.image.color.Color.RGBA((127 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (127 : stdgo.GoUInt8)) : stdgo.image.color.Color.RGBA)), stdgo.Go.asInterface((new stdgo.image.color.Color.RGBA((0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (127 : stdgo.GoUInt8)) : stdgo.image.color.Color.RGBA)), stdgo.Go.asInterface((new stdgo.image.color.Color.RGBA((0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8)) : stdgo.image.color.Color.RGBA)), stdgo.Go.asInterface((new stdgo.image.color.Color.RGBA((64 : stdgo.GoUInt8), (64 : stdgo.GoUInt8), (64 : stdgo.GoUInt8), (64 : stdgo.GoUInt8)) : stdgo.image.color.Color.RGBA))) : stdgo.image.color.Color.Palette);
        for (_i => _c in _p) {
        ...
        var _got:stdgo.image.color.Color.Color = _p.convert(stdgo.Go.asInterface((new stdgo.image.color.Color.RGBA((128 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (128 : stdgo.GoUInt8)) : stdgo.image.color.Color.RGBA)));
        var _want:stdgo.image.color.Color.RGBA = (new stdgo.image.color.Color.RGBA((127 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (127 : stdgo.GoUInt8)) : stdgo.image.color.Color.RGBA);
...
function benchmarkYCbCrToRGB(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        ...
        _b.run(("128" : stdgo.GoString), function(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_i < _b.n, _i++, {
                    {
        ...
        _b.run(("255" : stdgo.GoString), function(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_i < _b.n, _i++, {
                    {
...
function benchmarkRGBToYCbCr(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.run(("0" : stdgo.GoString), function(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_i < _b.n, _i++, {
        ...
        _b.run(("Cb" : stdgo.GoString), function(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_i < _b.n, _i++, {
                    {
        ...
        _b.run(("Cr" : stdgo.GoString), function(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_i < _b.n, _i++, {
                    {
...
function benchmarkYCbCrToRGBA(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.run(("0" : stdgo.GoString), function(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
            var _c:stdgo.image.color.Color.YCbCr = (new stdgo.image.color.Color.YCbCr((0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8)) : stdgo.image.color.Color.YCbCr);
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_i < _b.n, _i++, {
                    {
        ...
        _b.run(("128" : stdgo.GoString), function(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
            var _c:stdgo.image.color.Color.YCbCr = (new stdgo.image.color.Color.YCbCr((128 : stdgo.GoUInt8), (128 : stdgo.GoUInt8), (128 : stdgo.GoUInt8)) : stdgo.image.color.Color.YCbCr);
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_i < _b.n, _i++, {
                    {
        ...
        _b.run(("255" : stdgo.GoString), function(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
            var _c:stdgo.image.color.Color.YCbCr = (new stdgo.image.color.Color.YCbCr((255 : stdgo.GoUInt8), (255 : stdgo.GoUInt8), (255 : stdgo.GoUInt8)) : stdgo.image.color.Color.YCbCr);
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_i < _b.n, _i++, {
                    {
...
function benchmarkNYCbCrAToRGBA(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.run(("0" : stdgo.GoString), function(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
            var _c:stdgo.image.color.Color.NYCbCrA = (new stdgo.image.color.Color.NYCbCrA((new stdgo.image.color.Color.YCbCr((0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8), (0 : stdgo.GoUInt8)) : stdgo.image.color.Color.YCbCr), (255 : stdgo.GoUInt8)) : stdgo.image.color.Color.NYCbCrA);
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_i < _b.n, _i++, {
                    {
        ...
        _b.run(("128" : stdgo.GoString), function(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
            var _c:stdgo.image.color.Color.NYCbCrA = (new stdgo.image.color.Color.NYCbCrA((new stdgo.image.color.Color.YCbCr((128 : stdgo.GoUInt8), (128 : stdgo.GoUInt8), (128 : stdgo.GoUInt8)) : stdgo.image.color.Color.YCbCr), (255 : stdgo.GoUInt8)) : stdgo.image.color.Color.NYCbCrA);
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_i < _b.n, _i++, {
                    {
        ...
        _b.run(("255" : stdgo.GoString), function(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
            var _c:stdgo.image.color.Color.NYCbCrA = (new stdgo.image.color.Color.NYCbCrA((new stdgo.image.color.Color.YCbCr((255 : stdgo.GoUInt8), (255 : stdgo.GoUInt8), (255 : stdgo.GoUInt8)) : stdgo.image.color.Color.YCbCr), (255 : stdgo.GoUInt8)) : stdgo.image.color.Color.NYCbCrA);
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_i < _b.n, _i++, {
                    {
