...
@:structInit class RGBA {
    ...
    public function new(?r:GoUInt8, ?g:GoUInt8, ?b:GoUInt8, ?a:GoUInt8) stdgo.internal.Macro.initLocals();
...
@:structInit class RGBA64 {
    ...
    public function new(?r:GoUInt16, ?g:GoUInt16, ?b:GoUInt16, ?a:GoUInt16) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(r) + " " + Go.string(g) + " " + Go.string(b) + " " + Go.string(a) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
...
@:structInit class Alpha {
    ...
    public var a : GoUInt8 = ((0 : GoUInt8));
    public function new(?a:GoUInt8) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(a) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
...
@:structInit class Alpha16 {
    ...
    public var a : GoUInt16 = ((0 : GoUInt16));
    public function new(?a:GoUInt16) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(a) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
...
@:structInit class Gray {
    public function rgba():{ var _0 : GoUInt32; var _1 : GoUInt32; var _2 : GoUInt32; var _3 : GoUInt32; } {
        ...
        return { _0 : _y, _1 : _y, _2 : _y, _3 : ((65535 : GoUInt32)) };
    }
    public var y : GoUInt8 = ((0 : GoUInt8));
    public function new(?y:GoUInt8) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(y) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
...
@:structInit class Gray16 {
    ...
    public function new(?y:GoUInt16) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(y) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
...
@:structInit class T_modelFunc {
    ...
    public function new(?_f:Color -> Color) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_f) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
...
@:named class Palette {
    public function index(_c:Color):GoInt {
        ...
        var _ret:GoInt = ((0 : GoInt)), _bestSum:GoUInt32 = ((((((1 : GoUnTypedInt)) << ((32 : GoUnTypedInt))) - ((1 : GoUnTypedInt))) : GoUInt32));
        {
            var _i;
            var _v;
    ...
    public function __copy__() return new Palette(__t__);
    public function __append__(args:haxe.Rest<Color>) return new Palette(this.__t__.__append__(...args));
    public function __slice__(low:GoInt, high:GoInt = -1) return new Palette(this.__t__.__slice__(low, high));
}
@:structInit class YCbCr {
    public function rgba():{ var _0 : GoUInt32; var _1 : GoUInt32; var _2 : GoUInt32; var _3 : GoUInt32; } {
        ...
        return { _0 : ((_r : GoUInt32)), _1 : ((_g : GoUInt32)), _2 : ((_b : GoUInt32)), _3 : ((65535 : GoUInt32)) };
    }
    public var y : GoUInt8 = ((0 : GoUInt8));
    public var cb : GoUInt8 = ((0 : GoUInt8));
    public var cr : GoUInt8 = ((0 : GoUInt8));
    public function new(?y:GoUInt8, ?cb:GoUInt8, ?cr:GoUInt8) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class NYCbCrA {
    public function rgba():{ var _0 : GoUInt32; var _1 : GoUInt32; var _2 : GoUInt32; var _3 : GoUInt32; } {
        ...
        return { _0 : ((_r : GoUInt32)) * _a / ((65535 : GoUInt32)), _1 : ((_g : GoUInt32)) * _a / ((65535 : GoUInt32)), _2 : ((_b : GoUInt32)) * _a / ((65535 : GoUInt32)), _3 : _a };
    }
    @:embedded
    public var ycbCr : YCbCr = new YCbCr();
    public var a : GoUInt8 = ((0 : GoUInt8));
    public function new(?ycbCr:YCbCr, ?a:GoUInt8) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class CMYK {
    public function rgba():{ var _0 : GoUInt32; var _1 : GoUInt32; var _2 : GoUInt32; var _3 : GoUInt32; } {
        ...
        return { _0 : _r, _1 : _g, _2 : _b, _3 : ((65535 : GoUInt32)) };
    }
    public var c : GoUInt8 = ((0 : GoUInt8));
    public var m : GoUInt8 = ((0 : GoUInt8));
    public var y : GoUInt8 = ((0 : GoUInt8));
    public var k : GoUInt8 = ((0 : GoUInt8));
    public function new(?c:GoUInt8, ?m:GoUInt8, ?y:GoUInt8, ?k:GoUInt8) stdgo.internal.Macro.initLocals();
    public function toString() {
...
function _rgbaModel(_c:Color):Color {
        ...
        return new RGBA((((_r >> ((8 : GoUnTypedInt))) : GoUInt8)), (((_g >> ((8 : GoUnTypedInt))) : GoUInt8)), (((_b >> ((8 : GoUnTypedInt))) : GoUInt8)), (((_a >> ((8 : GoUnTypedInt))) : GoUInt8))).__copy__();
    }
...
function _nrgbaModel(_c:Color):Color {
        ...
        if (_a == ((65535 : GoUInt32))) {
            return new NRGBA((((_r >> ((8 : GoUnTypedInt))) : GoUInt8)), (((_g >> ((8 : GoUnTypedInt))) : GoUInt8)), (((_b >> ((8 : GoUnTypedInt))) : GoUInt8)), ((255 : GoUInt8))).__copy__();
        };
        if (_a == ((0 : GoUInt32))) {
        ...
        return new NRGBA((((_r >> ((8 : GoUnTypedInt))) : GoUInt8)), (((_g >> ((8 : GoUnTypedInt))) : GoUInt8)), (((_b >> ((8 : GoUnTypedInt))) : GoUInt8)), (((_a >> ((8 : GoUnTypedInt))) : GoUInt8))).__copy__();
    }
...
function _grayModel(_c:Color):Color {
        ...
        var __tmp__ = _c.rgba(), _r:GoUInt32 = __tmp__._0, _g:GoUInt32 = __tmp__._1, _b:GoUInt32 = __tmp__._2, _:GoUInt32 = __tmp__._3;
        var _y:GoUInt32 = ((((19595 : GoUInt32)) * _r + ((38470 : GoUInt32)) * _g + ((7471 : GoUInt32)) * _b + (((1 : GoUnTypedInt)) << ((15 : GoUnTypedInt)))) >> ((24 : GoUnTypedInt)));
...
function _gray16Model(_c:Color):Color {
        ...
        var __tmp__ = _c.rgba(), _r:GoUInt32 = __tmp__._0, _g:GoUInt32 = __tmp__._1, _b:GoUInt32 = __tmp__._2, _:GoUInt32 = __tmp__._3;
        var _y:GoUInt32 = ((((19595 : GoUInt32)) * _r + ((38470 : GoUInt32)) * _g + ((7471 : GoUInt32)) * _b + (((1 : GoUnTypedInt)) << ((15 : GoUnTypedInt)))) >> ((16 : GoUnTypedInt)));
...
function rgbtoYCbCr(_r:GoUInt8, _g:GoUInt8, _b:GoUInt8):{ var _0 : GoUInt8; var _1 : GoUInt8; var _2 : GoUInt8; } {
        ...
        var _yy:GoInt32 = ((((19595 : GoInt32)) * _r1 + ((38470 : GoInt32)) * _g1 + ((7471 : GoInt32)) * _b1 + (((1 : GoUnTypedInt)) << ((15 : GoUnTypedInt)))) >> ((16 : GoUnTypedInt)));
        var _cb:GoInt32 = -((11056 : GoUnTypedInt)) * _r1 - ((21712 : GoInt32)) * _g1 + ((32768 : GoInt32)) * _b1 + (((257 : GoUnTypedInt)) << ((15 : GoUnTypedInt)));
        if (((_cb : GoUInt32)) & (("4278190080" : GoUInt32)) == ((0 : GoUInt32))) {
            _cb = (_cb >> (((16 : GoUnTypedInt))));
        } else {
            _cb = -1 ^ ((_cb >> ((31 : GoUnTypedInt))));
        };
        var _cr:GoInt32 = ((32768 : GoInt32)) * _r1 - ((27440 : GoInt32)) * _g1 - ((5328 : GoInt32)) * _b1 + (((257 : GoUnTypedInt)) << ((15 : GoUnTypedInt)));
...
function _yCbCrModel(_c:Color):Color {
        ...
        var __tmp__ = _c.rgba(), _r:GoUInt32 = __tmp__._0, _g:GoUInt32 = __tmp__._1, _b:GoUInt32 = __tmp__._2, _:GoUInt32 = __tmp__._3;
        var __tmp__ = rgbtoYCbCr((((_r >> ((8 : GoUnTypedInt))) : GoUInt8)), (((_g >> ((8 : GoUnTypedInt))) : GoUInt8)), (((_b >> ((8 : GoUnTypedInt))) : GoUInt8))), _y:GoUInt8 = __tmp__._0, _u:GoUInt8 = __tmp__._1, _v:GoUInt8 = __tmp__._2;
...
function rgbtoCMYK(_r:GoUInt8, _g:GoUInt8, _b:GoUInt8):{ var _0 : GoUInt8; var _1 : GoUInt8; var _2 : GoUInt8; var _3 : GoUInt8; } {
        ...
        return { _0 : ((_c : GoUInt8)), _1 : ((_m : GoUInt8)), _2 : ((_y : GoUInt8)), _3 : (((((255 : GoUInt32)) - _w) : GoUInt8)) };
    }
/**
...
function _cmykModel(_c:Color):Color {
        ...
        var __tmp__ = _c.rgba(), _r:GoUInt32 = __tmp__._0, _g:GoUInt32 = __tmp__._1, _b:GoUInt32 = __tmp__._2, _:GoUInt32 = __tmp__._3;
        var __tmp__ = rgbtoCMYK((((_r >> ((8 : GoUnTypedInt))) : GoUInt8)), (((_g >> ((8 : GoUnTypedInt))) : GoUInt8)), (((_b >> ((8 : GoUnTypedInt))) : GoUInt8))), _cc:GoUInt8 = __tmp__._0, _mm:GoUInt8 = __tmp__._1, _yy:GoUInt8 = __tmp__._2, _kk:GoUInt8 = __tmp__._3;
...
class T_modelFunc_extension_fields {
    public function convert(__tmp__, _c:Color):Color return __tmp__.convert(_c);
}
class Palette_extension_fields {
    public function convert(__tmp__, _c:Color):Color return __tmp__.convert(_c);
    public function index(__tmp__, _c:Color):GoInt return __tmp__.index(_c);
}
