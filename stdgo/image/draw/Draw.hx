...
@:named class Op {
    ...
    public function __copy__() return new Op(__t__);
}
...
**/
function _clip(_dst:Image, _r:Pointer<stdgo.image.Image.Rectangle>, _src:stdgo.image.Image.Image, _sp:Pointer<stdgo.image.Image.Point>, _mask:stdgo.image.Image.Image, _mp:Pointer<stdgo.image.Image.Point>):Void {
...
function _processBackward(_dst:stdgo.image.Image.Image, _r:stdgo.image.Image.Rectangle, _src:stdgo.image.Image.Image, _sp:stdgo.image.Image.Point):Bool {
        return Go.toInterface(_dst) == Go.toInterface(_src) && _r.overlaps(_r.add(_sp.sub(_r.min.__copy__()).__copy__()).__copy__()) && (_sp.y < _r.min.y || (_sp.y == _r.min.y && _sp.x < _r.min.x));
    }
/**
...
**/
function drawMask(_dst:Image, _r:stdgo.image.Image.Rectangle, _src:stdgo.image.Image.Image, _sp:stdgo.image.Image.Point, _mask:stdgo.image.Image.Image, _mp:stdgo.image.Image.Point, _op:Op):Void {
        _clip(_dst, Go.pointer(_r), _src, Go.pointer(_sp), _mask, Go.pointer(_mp));
        if (_r.empty()) {
            return;
        };
        if (Go.assertable(((_dst : Pointer<stdgo.image.Image.RGBA>)))) {
            var _dst0:Pointer<stdgo.image.Image.RGBA> = _dst == null ? null : _dst.__underlying__() == null ? null : _dst == null ? null : _dst.__underlying__().value;
            if (_op.__t__ == over.__t__) {
                if (_mask == null) {
                    if (Go.assertable(((_src : Pointer<stdgo.image.Image.Uniform>)))) {
                        var _src0:Pointer<stdgo.image.Image.Uniform> = _src == null ? null : _src.__underlying__() == null ? null : _src == null ? null : _src.__underlying__().value;
                        var __tmp__ = _src0.value.rgba(), _sr:GoUInt32 = __tmp__._0, _sg:GoUInt32 = __tmp__._1, _sb:GoUInt32 = __tmp__._2, _sa:GoUInt32 = __tmp__._3;
                        ...
                        var _src0:Pointer<stdgo.image.Image.RGBA> = _src == null ? null : _src.__underlying__() == null ? null : _src == null ? null : _src.__underlying__().value;
                        _drawCopyOver(_dst0, _r.__copy__(), _src0, _sp.__copy__());
                        return;
                    } else if (Go.assertable(((_src : Pointer<stdgo.image.Image.NRGBA>)))) {
                        var _src0:Pointer<stdgo.image.Image.NRGBA> = _src == null ? null : _src.__underlying__() == null ? null : _src == null ? null : _src.__underlying__().value;
                        _drawNRGBAOver(_dst0, _r.__copy__(), _src0, _sp.__copy__());
                        return;
                    } else if (Go.assertable(((_src : Pointer<stdgo.image.Image.YCbCr>)))) {
                        var _src0:Pointer<stdgo.image.Image.YCbCr> = _src == null ? null : _src.__underlying__() == null ? null : _src == null ? null : _src.__underlying__().value;
                        ...
                        var _src0:Pointer<stdgo.image.Image.Gray> = _src == null ? null : _src.__underlying__() == null ? null : _src == null ? null : _src.__underlying__().value;
                        _drawGray(_dst0, _r.__copy__(), _src0, _sp.__copy__());
                        return;
                    } else if (Go.assertable(((_src : Pointer<stdgo.image.Image.CMYK>)))) {
                        var _src0:Pointer<stdgo.image.Image.CMYK> = _src == null ? null : _src.__underlying__() == null ? null : _src == null ? null : _src.__underlying__().value;
            ...
            var _dst0:Pointer<stdgo.image.Image.Paletted> = _dst == null ? null : _dst.__underlying__() == null ? null : _dst == null ? null : _dst.__underlying__().value;
                ...
                var _mx:GoInt = _mp.x + _x0 - _r.min.x;
                {
                    ...
                    Go.cfor(_x != _x1, {
                        ...
                        if (_ma == ((0 : GoUInt32))) {
                            ...
                            var __tmp__ = _src.at(_sx, _sy).rgba(), _sr:GoUInt32 = __tmp__._0, _sg:GoUInt32 = __tmp__._1, _sb:GoUInt32 = __tmp__._2, _sa:GoUInt32 = __tmp__._3;
                            if (_op.__t__ == over.__t__) {
                                var __tmp__ = _dst.at(_x, _y).rgba(), _dr:GoUInt32 = __tmp__._0, _dg:GoUInt32 = __tmp__._1, _db:GoUInt32 = __tmp__._2, _da:GoUInt32 = __tmp__._3;
...
function _drawCopyOver(_dst:Pointer<stdgo.image.Image.RGBA>, _r:stdgo.image.Image.Rectangle, _src:Pointer<stdgo.image.Image.RGBA>, _sp:stdgo.image.Image.Point):Void {
        ...
        var _ddelta:GoInt = ((0 : GoInt)), _sdelta:GoInt = ((0 : GoInt)), _i0:GoInt = ((0 : GoInt)), _i1:GoInt = ((0 : GoInt)), _idelta:GoInt = ((0 : GoInt));
...
function _drawCopySrc(_dst:Pointer<stdgo.image.Image.RGBA>, _r:stdgo.image.Image.Rectangle, _src:Pointer<stdgo.image.Image.RGBA>, _sp:stdgo.image.Image.Point):Void {
...
function _drawNRGBAOver(_dst:Pointer<stdgo.image.Image.RGBA>, _r:stdgo.image.Image.Rectangle, _src:Pointer<stdgo.image.Image.NRGBA>, _sp:stdgo.image.Image.Point):Void {
...
function _drawNRGBASrc(_dst:Pointer<stdgo.image.Image.RGBA>, _r:stdgo.image.Image.Rectangle, _src:Pointer<stdgo.image.Image.NRGBA>, _sp:stdgo.image.Image.Point):Void {
        var _i0:GoInt = (_r.min.x - _dst.value.rect.min.x) * ((4 : GoInt));
        var _i1:GoInt = (_r.max.x - _dst.value.rect.min.x) * ((4 : GoInt));
        var _si0:GoInt = (_sp.x - _src.value.rect.min.x) * ((4 : GoInt));
        var _yMax:GoInt = _r.max.y - _dst.value.rect.min.y;
...
function _drawGray(_dst:Pointer<stdgo.image.Image.RGBA>, _r:stdgo.image.Image.Rectangle, _src:Pointer<stdgo.image.Image.Gray>, _sp:stdgo.image.Image.Point):Void {
        var _i0:GoInt = (_r.min.x - _dst.value.rect.min.x) * ((4 : GoInt));
        var _i1:GoInt = (_r.max.x - _dst.value.rect.min.x) * ((4 : GoInt));
...
function _drawCMYK(_dst:Pointer<stdgo.image.Image.RGBA>, _r:stdgo.image.Image.Rectangle, _src:Pointer<stdgo.image.Image.CMYK>, _sp:stdgo.image.Image.Point):Void {
        var _i0:GoInt = (_r.min.x - _dst.value.rect.min.x) * ((4 : GoInt));
        var _i1:GoInt = (_r.max.x - _dst.value.rect.min.x) * ((4 : GoInt));
        var _si0:GoInt = (_sp.x - _src.value.rect.min.x) * ((4 : GoInt));
        var _yMax:GoInt = _r.max.y - _dst.value.rect.min.y;
...
function _drawGlyphOver(_dst:Pointer<stdgo.image.Image.RGBA>, _r:stdgo.image.Image.Rectangle, _src:Pointer<stdgo.image.Image.Uniform>, _mask:Pointer<stdgo.image.Image.Alpha>, _mp:stdgo.image.Image.Point):Void {
        var _i0:GoInt = _dst.value.pixOffset(_r.min.x, _r.min.y);
        var _i1:GoInt = _i0 + _r.dx() * ((4 : GoInt));
        var _mi0:GoInt = _mask.value.pixOffset(_mp.x, _mp.y);
        var __tmp__ = _src.value.rgba(), _sr:GoUInt32 = __tmp__._0, _sg:GoUInt32 = __tmp__._1, _sb:GoUInt32 = __tmp__._2, _sa:GoUInt32 = __tmp__._3;
        {
...
function _drawRGBA(_dst:Pointer<stdgo.image.Image.RGBA>, _r:stdgo.image.Image.Rectangle, _src:stdgo.image.Image.Image, _sp:stdgo.image.Image.Point, _mask:stdgo.image.Image.Image, _mp:stdgo.image.Image.Point, _op:Op):Void {
        var _x0:GoInt = _r.min.x, _x1:GoInt = _r.max.x, _dx:GoInt = ((1 : GoInt));
        var _y0:GoInt = _r.min.y, _y1:GoInt = _r.max.y, _dy:GoInt = ((1 : GoInt));
        if (Go.toInterface(((_dst.value : stdgo.image.Image.Image))) == Go.toInterface(_src) && _r.overlaps(_r.add(_sp.sub(_r.min.__copy__()).__copy__()).__copy__())) {
...
function _drawPaletted(_dst:Image, _r:stdgo.image.Image.Rectangle, _src:stdgo.image.Image.Image, _sp:stdgo.image.Image.Point, _floydSteinberg:Bool):Void {
        var _palette:Slice<GoArray<GoInt32>> = ((new Slice<GoArray<GoInt32>>().nil() : Slice<GoArray<GoInt32>>)), _pix:Slice<GoUInt8> = ((new Slice<GoUInt8>().nil() : Slice<GoByte>)), _stride:GoInt = ((0 : GoInt));
        {
            var __tmp__ = try {
            ...
            if (_ok) {
                _palette = new Slice<GoArray<GoInt32>>(...[for (i in 0 ... ((_p.value.palette.__t__.length : GoInt)).toBasic()) new GoArray<GoInt32>(...[for (i in 0 ... 4) ((0 : GoInt32))])]);
                {
                    var _i;
                    var _col;
                    for (_obj in _p.value.palette.__t__.keyValueIterator()) {
                        _i = _obj.key;
                        _col = _obj.value;
                        var __tmp__ = _col.rgba(), _r:GoUInt32 = __tmp__._0, _g:GoUInt32 = __tmp__._1, _b:GoUInt32 = __tmp__._2, _a:GoUInt32 = __tmp__._3;
        ...
        var _quantErrorCurr:Slice<GoArray<GoInt32>> = new Slice<GoArray<GoInt32>>().nil(), _quantErrorNext:Slice<GoArray<GoInt32>> = new Slice<GoArray<GoInt32>>().nil();
        if (_floydSteinberg) {
            _quantErrorCurr = new Slice<GoArray<GoInt32>>(...[for (i in 0 ... ((_r.dx() + ((2 : GoInt)) : GoInt)).toBasic()) new GoArray<GoInt32>(...[for (i in 0 ... 4) ((0 : GoInt32))])]);
            _quantErrorNext = new Slice<GoArray<GoInt32>>(...[for (i in 0 ... ((_r.dx() + ((2 : GoInt)) : GoInt)).toBasic()) new GoArray<GoInt32>(...[for (i in 0 ... 4) ((0 : GoInt32))])]);
        };
        var _pxRGBA:(GoInt, GoInt) -> { var _0 : GoUInt32; var _1 : GoUInt32; var _2 : GoUInt32; var _3 : GoUInt32; } = function(_x:GoInt, _y:GoInt):{ var _0 : GoUInt32; var _1 : GoUInt32; var _2 : GoUInt32; var _3 : GoUInt32; } {
        ...
        if (Go.assertable(((_src : Pointer<stdgo.image.Image.RGBA>)))) {
            var _src0:Pointer<stdgo.image.Image.RGBA> = _src == null ? null : _src.__underlying__() == null ? null : _src == null ? null : _src.__underlying__().value;
            _pxRGBA = function(_x:GoInt, _y:GoInt):{ var _0 : GoUInt32; var _1 : GoUInt32; var _2 : GoUInt32; var _3 : GoUInt32; } {
                var _r:GoUInt32 = ((0 : GoUInt32)), _g:GoUInt32 = ((0 : GoUInt32)), _b:GoUInt32 = ((0 : GoUInt32)), _a:GoUInt32 = ((0 : GoUInt32));
        ...
        var _out:stdgo.image.color.Color.RGBA64 = (({ a : ((65535 : GoUInt16)), r : 0, g : 0, b : 0 } : stdgo.image.color.Color.RGBA64)).__copy__();
        {
            ...
            Go.cfor(_y != _r.dy(), _y++, {
                {
                    ...
                    Go.cfor(_x != _r.dx(), _x++, {
                        var __tmp__ = _pxRGBA(_sp.x + _x, _sp.y + _y), _sr:GoUInt32 = __tmp__._0, _sg:GoUInt32 = __tmp__._1, _sb:GoUInt32 = __tmp__._2, _sa:GoUInt32 = __tmp__._3;
                        var _er:GoInt32 = ((_sr : GoInt32)), _eg:GoInt32 = ((_sg : GoInt32)), _eb:GoInt32 = ((_sb : GoInt32)), _ea:GoInt32 = ((_sa : GoInt32));
                        if (_floydSteinberg) {
                        ...
                        if (_palette != null && !_palette.isNil()) {
                            var _bestIndex:GoInt = ((0 : GoInt)), _bestSum:GoUInt32 = ((((((1 : GoUnTypedInt)) << ((32 : GoUnTypedInt))) - ((1 : GoUnTypedInt))) : GoUInt32));
                            {
                                var _index;
                                var _p;
                                for (_obj in _palette.keyValueIterator()) {
                                    _index = _obj.key;
                                    _p = _obj.value;
                                    var _sum:GoUInt32 = _sqDiff(_er, _p[((0 : GoInt))]) + _sqDiff(_eg, _p[((1 : GoInt))]) + _sqDiff(_eb, _p[((2 : GoInt))]) + _sqDiff(_ea, _p[((3 : GoInt))]);
                                    if (_sum < _bestSum) {
                                        {
...
class Op_extension_fields {
    public function draw(__tmp__, _dst:Image, _r:stdgo.image.Image.Rectangle, _src:stdgo.image.Image.Image, _sp:stdgo.image.Image.Point):Void __tmp__.draw(_dst, _r, _src, _sp);
}
