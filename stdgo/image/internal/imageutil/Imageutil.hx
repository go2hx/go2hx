...
**/
function drawYCbCr(_dst:Pointer<stdgo.image.Image.RGBA>, _r:stdgo.image.Image.Rectangle, _src:Pointer<stdgo.image.Image.YCbCr>, _sp:stdgo.image.Image.Point):Bool {
        var _ok:Bool = false;
