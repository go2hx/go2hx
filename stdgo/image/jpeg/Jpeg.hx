...
/**
    /|*{
    	if zigStart == 0 {
    		...
    		_ = gotoNext == 2997441
    		bit_2997441, err_2997446 = d.decodeBit()
    		if err_2997446 != nil {
    			gotoNext = 2997483
    			_ = gotoNext == 2997483
    			return err_2997446
    	...
    	if d.eobRun == 0 {
    		...
    		gotoNext = 2997680
    		_ = gotoNext == 2997680
    		if !loopBreak && (zig_2997635 <= zigEnd) {
    			gotoNext = 2997707
    			_ = gotoNext == 2997707
    			z_2997712 = int32(0)
    			value_2997729, err_2997736 = d.decodeHuffman(h)
    			if err_2997736 != nil {
    				gotoNext = 2997779
    				_ = gotoNext == 2997779
    				return err_2997736
    			...
    			_ = gotoNext == 2997804
    			val0_2997804 = value_2997729 >> 4
    			val1_2997826 = value_2997729 & 15
    			gotoNext = 2997851
    			_ = gotoNext == 2997851
    			switch val1_2997826 {
    			case 0:
    				...
    				if val0_2997804 != 15 {
    					gotoNext = 2997896
    					_ = gotoNext == 2997896
    					d.eobRun = uint16(1 << val0_2997804)
    					if val0_2997804 != 0 {
    						gotoNext = 2997950
    						_ = gotoNext == 2997950
    						bits_2997958, err_2997964 = d.decodeBits(int32(val0_2997804))
    						if err_2997964 != nil {
    							gotoNext = 2998017
    							_ = gotoNext == 2998017
    							return err_2997964
    			...
    			case 1:
    				...
    				_ = gotoNext == 2998108
    				z_2997712 = delta
    				bit_2998134, err_2998139 = d.decodeBit()
    				if err_2998139 != nil {
    					gotoNext = 2998178
    					_ = gotoNext == 2998178
    					return err_2998139
    			...
    			_ = gotoNext == 2998305
    			zig_2997635, err_2997736 = d.refineNonZeroes(b, zig_2997635, zigEnd, int32(val0_2997804), delta)
    			if err_2997736 != nil {
    				gotoNext = 2998387
    				_ = gotoNext == 2998387
    				return err_2997736
    	...
    	if d.eobRun > 0 {
    		...
    		_ = gotoNext == 2998549
    		d.eobRun--
    		if _, err_2998572 = d.refineNonZeroes(b, zig_2997635, zigEnd, -1, delta); err_2998572 != nil {
    			gotoNext = 2998636
    			_ = gotoNext == 2998636
    			return err_2998572
    			gotoNext = 2998660
