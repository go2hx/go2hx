...
/**
    /|*{
    	if zigStart == 0 {
    		...
    		_ = gotoNext == 2989965
    		bit_2989965, err_2989970 = d.decodeBit()
    		if err_2989970 != nil {
    			gotoNext = 2990007
    			_ = gotoNext == 2990007
    			return err_2989970
    	...
    	if d.eobRun == 0 {
    		...
    		gotoNext = 2990204
    		_ = gotoNext == 2990204
    		if !loopBreak && (zig_2990159 <= zigEnd) {
    			gotoNext = 2990231
    			_ = gotoNext == 2990231
    			z_2990236 = int32(0)
    			value_2990253, err_2990260 = d.decodeHuffman(h)
    			if err_2990260 != nil {
    				gotoNext = 2990303
    				_ = gotoNext == 2990303
    				return err_2990260
    			...
    			_ = gotoNext == 2990328
    			val0_2990328 = value_2990253 >> 4
    			val1_2990350 = value_2990253 & 15
    			gotoNext = 2990375
    			_ = gotoNext == 2990375
    			switch val1_2990350 {
    			case 0:
    				...
    				if val0_2990328 != 15 {
    					gotoNext = 2990420
    					_ = gotoNext == 2990420
    					d.eobRun = uint16(1 << val0_2990328)
    					if val0_2990328 != 0 {
    						gotoNext = 2990474
    						_ = gotoNext == 2990474
    						bits_2990482, err_2990488 = d.decodeBits(int32(val0_2990328))
    						if err_2990488 != nil {
    							gotoNext = 2990541
    							_ = gotoNext == 2990541
    							return err_2990488
    			...
    			case 1:
    				...
    				_ = gotoNext == 2990632
    				z_2990236 = delta
    				bit_2990658, err_2990663 = d.decodeBit()
    				if err_2990663 != nil {
    					gotoNext = 2990702
    					_ = gotoNext == 2990702
    					return err_2990663
    			...
    			_ = gotoNext == 2990829
    			zig_2990159, err_2990260 = d.refineNonZeroes(b, zig_2990159, zigEnd, int32(val0_2990328), delta)
    			if err_2990260 != nil {
    				gotoNext = 2990911
    				_ = gotoNext == 2990911
    				return err_2990260
    	...
    	if d.eobRun > 0 {
    		...
    		_ = gotoNext == 2991073
    		d.eobRun--
    		if _, err_2991096 = d.refineNonZeroes(b, zig_2990159, zigEnd, -1, delta); err_2991096 != nil {
    			gotoNext = 2991160
    			_ = gotoNext == 2991160
    			return err_2991096
    			gotoNext = 2991184
