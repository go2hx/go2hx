...
@:structInit class T_interlaceScan {
    ...
    public function new(?_xFactor:GoInt, ?_yFactor:GoInt, ?_xOffset:GoInt, ?_yOffset:GoInt) stdgo.internal.Macro.initLocals();
...
@:structInit class T_decoder {
    public function _checkHeader():Error {
        ...
        var __tmp__ = stdgo.io.Io.readFull(_d.value._r, _d.value._tmp.__slice__(0, _pngHeader.length)), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return _err;
        };
    ...
    public function _verifyChecksum():Error {
        var _d = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        {
            var __tmp__ = stdgo.io.Io.readFull(_d.value._r, _d.value._tmp.__slice__(0, ((4 : GoInt)))), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return _err;
            };
        };
    ...
    public function _parseChunk():Error {
        var _d = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        {
            var __tmp__ = stdgo.io.Io.readFull(_d.value._r, _d.value._tmp.__slice__(0, ((8 : GoInt)))), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return _err;
            };
        };
        ...
        _d.value._crc.write(_d.value._tmp.__slice__(((4 : GoInt)), ((8 : GoInt))));
        {
            ...
            while (true) {
                if (((_d.value._tmp.__slice__(((4 : GoInt)), ((8 : GoInt))) : GoString)) == (("IHDR" : GoString))) {
                    ...
                    if (_d.value._stage < _dsSeenIHDR || _d.value._stage > _dsSeenIDAT || (_d.value._stage == _dsSeenIHDR && _cbPaletted(_d.value._cb))) {
                        return _chunkOrderError;
        ...
        while (_length > ((0 : GoUInt32))) {
            var __tmp__ = stdgo.io.Io.readFull(_d.value._r, _ignored.__slice__(0, _min(_ignored.length, ((_length : GoInt))))), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return _err;
            };
    ...
    public function _mergePassInto(_dst:stdgo.image.Image.Image, _src:stdgo.image.Image.Image, _pass:GoInt):Void {
        ...
        var _srcPix:Slice<GoUInt8> = new Slice<GoUInt8>().nil(), _dstPix:Slice<GoUInt8> = new Slice<GoUInt8>().nil(), _stride:GoInt = ((0 : GoInt)), _rect:stdgo.image.Image.Rectangle = new stdgo.image.Image.Rectangle(), _bytesPerPixel:GoInt = ((0 : GoInt));
        if (Go.assertable(((_dst : Pointer<stdgo.image.Image.Alpha>)))) {
            var _target:Pointer<stdgo.image.Image.Alpha> = _dst == null ? null : _dst.__underlying__() == null ? null : _dst == null ? null : _dst.__underlying__().value;
            ...
            var _target:Pointer<stdgo.image.Image.Alpha16> = _dst == null ? null : _dst.__underlying__() == null ? null : _dst == null ? null : _dst.__underlying__().value;
            ...
            var _target:Pointer<stdgo.image.Image.Gray> = _dst == null ? null : _dst.__underlying__() == null ? null : _dst == null ? null : _dst.__underlying__().value;
            ...
            var _target:Pointer<stdgo.image.Image.Gray16> = _dst == null ? null : _dst.__underlying__() == null ? null : _dst == null ? null : _dst.__underlying__().value;
            ...
            var _target:Pointer<stdgo.image.Image.NRGBA> = _dst == null ? null : _dst.__underlying__() == null ? null : _dst == null ? null : _dst.__underlying__().value;
            ...
            var _target:Pointer<stdgo.image.Image.NRGBA64> = _dst == null ? null : _dst.__underlying__() == null ? null : _dst == null ? null : _dst.__underlying__().value;
            ...
            var _target:Pointer<stdgo.image.Image.Paletted> = _dst == null ? null : _dst.__underlying__() == null ? null : _dst == null ? null : _dst.__underlying__().value;
            ...
            var _target:Pointer<stdgo.image.Image.RGBA> = _dst == null ? null : _dst.__underlying__() == null ? null : _dst == null ? null : _dst.__underlying__().value;
            ...
            var _target:Pointer<stdgo.image.Image.RGBA64> = _dst == null ? null : _dst.__underlying__() == null ? null : _dst == null ? null : _dst.__underlying__().value;
        ...
        var _s:GoInt = ((0 : GoInt)), _bounds:stdgo.image.Image.Rectangle = _src.bounds().__copy__();
        {
    ...
    public function _readImagePass(_r:stdgo.io.Io.Reader, _pass:GoInt, _allocateOnly:Bool):{ var _0 : stdgo.image.Image.Image; var _1 : Error; } {
        ...
        var _gray:Pointer<stdgo.image.Image.Gray> = new Pointer<stdgo.image.Image.Gray>().nil(), _rgba:Pointer<stdgo.image.Image.RGBA> = new Pointer<stdgo.image.Image.RGBA>().nil(), _paletted:Pointer<stdgo.image.Image.Paletted> = new Pointer<stdgo.image.Image.Paletted>().nil(), _nrgba:Pointer<stdgo.image.Image.NRGBA> = new Pointer<stdgo.image.Image.NRGBA>().nil(), _gray16:Pointer<stdgo.image.Image.Gray16> = new Pointer<stdgo.image.Image.Gray16>().nil(), _rgba64:Pointer<stdgo.image.Image.RGBA64> = new Pointer<stdgo.image.Image.RGBA64>().nil(), _nrgba64:Pointer<stdgo.image.Image.NRGBA64> = new Pointer<stdgo.image.Image.NRGBA64>().nil(), _img:stdgo.image.Image.Image = ((null : stdgo.image.Image.Image));
        ...
        if (_d.value._cb == _cbG1 || _d.value._cb == _cbG2 || _d.value._cb == _cbG4 || _d.value._cb == _cbG8) {
            ...
            _bitsPerPixel = _d.value._depth;
            _paletted = stdgo.image.Image.newPaletted(stdgo.image.Image.rect(((0 : GoInt)), ((0 : GoInt)), _width, _height).__copy__(), _d.value._palette.__copy__());
        ...
        var _pr:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0 ... ((_rowSize : GoInt)).toBasic()) ((0 : GoUInt8))]);
        {
            ...
            Go.cfor(_y < _height, _y++, {
                var __tmp__ = stdgo.io.Io.readFull(_r, _cr), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    if (Go.toInterface(_err) == Go.toInterface(stdgo.io.Io.eof) || Go.toInterface(_err) == Go.toInterface(stdgo.io.Io.errUnexpectedEOF)) {
                ...
                if (_d.value._cb == _cbG1) {
                    ...
                    } else {
                        {
                            ...
                            Go.cfor(_x < _width, _x = _x + (((8 : GoInt))), {
                                var _b:GoUInt8 = _cdat[_x / ((8 : GoInt))];
                                {
                                    var _x2:GoInt = ((0 : GoInt));
                                    Go.cfor(_x2 < ((8 : GoInt)) && _x + _x2 < _width, _x2++, {
                                        _gray.value.setGray(_x + _x2, _y, new stdgo.image.color.Color.Gray(((_b >> ((7 : GoUnTypedInt)))) * ((255 : GoUInt8))).__copy__());
                                        _b = (_b << (((1 : GoUnTypedInt))));
                                    });
                                };
                            });
                    ...
                    } else {
                        {
                            ...
                            Go.cfor(_x < _width, _x = _x + (((4 : GoInt))), {
                                var _b:GoUInt8 = _cdat[_x / ((4 : GoInt))];
                                {
                                    var _x2:GoInt = ((0 : GoInt));
                                    Go.cfor(_x2 < ((4 : GoInt)) && _x + _x2 < _width, _x2++, {
                                        _gray.value.setGray(_x + _x2, _y, new stdgo.image.color.Color.Gray(((_b >> ((6 : GoUnTypedInt)))) * ((85 : GoUInt8))).__copy__());
                                        _b = (_b << (((2 : GoUnTypedInt))));
                                    });
                                };
                            });
                    ...
                    } else {
                        {
                            ...
                            Go.cfor(_x < _width, _x = _x + (((2 : GoInt))), {
                                var _b:GoUInt8 = _cdat[_x / ((2 : GoInt))];
                                {
                                    var _x2:GoInt = ((0 : GoInt));
                                    Go.cfor(_x2 < ((2 : GoInt)) && _x + _x2 < _width, _x2++, {
                                        _gray.value.setGray(_x + _x2, _y, new stdgo.image.color.Color.Gray(((_b >> ((4 : GoUnTypedInt)))) * ((17 : GoUInt8))).__copy__());
                                        _b = (_b << (((4 : GoUnTypedInt))));
                                    });
                                };
                            });
                ...
                } else if (_d.value._cb == _cbGA8) {
                    {
                        ...
                        Go.cfor(_x < _width, _x++, {
                            ...
                            _nrgba.value.setNRGBA(_x, _y, new stdgo.image.color.Color.NRGBA(_ycol, _ycol, _ycol, _cdat[((2 : GoInt)) * _x + ((1 : GoInt))]).__copy__());
                        });
                    };
                } else if (_d.value._cb == _cbTC8) {
                    if (_d.value._useTransparent) {
                        var _pix:Slice<GoUInt8> = _nrgba.value.pix, _i:GoInt = _pixOffset, _j:GoInt = ((0 : GoInt));
                        var _tr:GoUInt8 = _d.value._transparent[((1 : GoInt))], _tg:GoUInt8 = _d.value._transparent[((3 : GoInt))], _tb:GoUInt8 = _d.value._transparent[((5 : GoInt))];
                        {
                            var _x:GoInt = ((0 : GoInt));
                            Go.cfor(_x < _width, _x++, {
                        ...
                        var _pix:Slice<GoUInt8> = _rgba.value.pix, _i:GoInt = _pixOffset, _j:GoInt = ((0 : GoInt));
                        {
                            var _x:GoInt = ((0 : GoInt));
                            Go.cfor(_x < _width, _x++, {
                    ...
                    if (_d.value._useTransparent) {
                        var _ty:GoUInt16 = (((_d.value._transparent[((0 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_d.value._transparent[((1 : GoInt))] : GoUInt16));
                        {
                            var _x:GoInt = ((0 : GoInt));
                            Go.cfor(_x < _width, _x++, {
                                var _ycol:GoUInt16 = (((_cdat[((2 : GoInt)) * _x + ((0 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_cdat[((2 : GoInt)) * _x + ((1 : GoInt))] : GoUInt16));
                ...
                } else if (_d.value._cb == _cbGA16) {
                    {
                        var _x:GoInt = ((0 : GoInt));
                        Go.cfor(_x < _width, _x++, {
                            var _ycol:GoUInt16 = (((_cdat[((4 : GoInt)) * _x + ((0 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_cdat[((4 : GoInt)) * _x + ((1 : GoInt))] : GoUInt16));
                            var _acol:GoUInt16 = (((_cdat[((4 : GoInt)) * _x + ((2 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_cdat[((4 : GoInt)) * _x + ((3 : GoInt))] : GoUInt16));
                            _nrgba64.value.setNRGBA64(_x, _y, new stdgo.image.color.Color.NRGBA64(_ycol, _ycol, _ycol, _acol).__copy__());
                        });
                    };
                } else if (_d.value._cb == _cbTC16) {
                    if (_d.value._useTransparent) {
                        ...
                        var _tb:GoUInt16 = (((_d.value._transparent[((4 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_d.value._transparent[((5 : GoInt))] : GoUInt16));
                        {
                            var _x:GoInt = ((0 : GoInt));
                            Go.cfor(_x < _width, _x++, {
                                var _rcol:GoUInt16 = (((_cdat[((6 : GoInt)) * _x + ((0 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_cdat[((6 : GoInt)) * _x + ((1 : GoInt))] : GoUInt16));
                                var _gcol:GoUInt16 = (((_cdat[((6 : GoInt)) * _x + ((2 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_cdat[((6 : GoInt)) * _x + ((3 : GoInt))] : GoUInt16));
                                var _bcol:GoUInt16 = (((_cdat[((6 : GoInt)) * _x + ((4 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_cdat[((6 : GoInt)) * _x + ((5 : GoInt))] : GoUInt16));
                                var _acol:GoUInt16 = ((((65535 : GoUInt16)) : GoUInt16));
                ...
                } else if (_d.value._cb == _cbTCA16) {
                    {
                        var _x:GoInt = ((0 : GoInt));
                        Go.cfor(_x < _width, _x++, {
                            var _rcol:GoUInt16 = (((_cdat[((8 : GoInt)) * _x + ((0 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_cdat[((8 : GoInt)) * _x + ((1 : GoInt))] : GoUInt16));
                            var _gcol:GoUInt16 = (((_cdat[((8 : GoInt)) * _x + ((2 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_cdat[((8 : GoInt)) * _x + ((3 : GoInt))] : GoUInt16));
                            var _bcol:GoUInt16 = (((_cdat[((8 : GoInt)) * _x + ((4 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_cdat[((8 : GoInt)) * _x + ((5 : GoInt))] : GoUInt16));
                            var _acol:GoUInt16 = (((_cdat[((8 : GoInt)) * _x + ((6 : GoInt))] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_cdat[((8 : GoInt)) * _x + ((7 : GoInt))] : GoUInt16));
                            _nrgba64.value.setNRGBA64(_x, _y, new stdgo.image.color.Color.NRGBA64(_rcol, _gcol, _bcol, _acol).__copy__());
                        });
                    };
                };
    ...
    public function _decode():{ var _0 : stdgo.image.Image.Image; var _1 : Error; } {
        ...
        var __tmp__ = stdgo.compress.zlib.Zlib.newReader(_d.value), _r:stdgo.io.Io.ReadCloser = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : ((null : stdgo.image.Image.Image)), _1 : _err };
        };
        try {
            ...
            if (_d.value._interlace == _itNone) {
                ...
                };
                {
                    ...
                    Go.cfor(_pass < ((7 : GoInt)), _pass++, {
                        var __tmp__ = _d.value._readImagePass(_r, _pass, false), _imagePass:stdgo.image.Image.Image = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                        if (_err != null) {
                            {
                                for (defer in deferstack) {
                                    defer();
    ...
    public function read(_p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } {
        ...
        var __tmp__ = _d.value._r.read(_p.__slice__(0, _min(_p.length, ((_d.value._idatLength : GoInt))))), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
    ...
    public function _parsetRNS(_length:GoUInt32):Error {
        var _d = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        if (_d.value._cb == _cbG1 || _d.value._cb == _cbG2 || _d.value._cb == _cbG4 || _d.value._cb == _cbG8 || _d.value._cb == _cbG16) {
            if (_length != ((2 : GoUInt32))) {
                return new FormatError("bad tRNS length");
            };
            var __tmp__ = stdgo.io.Io.readFull(_d.value._r, _d.value._tmp.__slice__(0, _length)), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return _err;
            };
    ...
    public function _parsePLTE(_length:GoUInt32):Error {
        ...
        if (_length % ((3 : GoUInt32)) != ((0 : GoUInt32)) || _np <= ((0 : GoInt)) || _np > ((256 : GoInt)) || _np > (((1 : GoInt)) << ((_d.value._depth : GoUInt)))) {
            return new FormatError("bad PLTE length");
        };
        var __tmp__ = stdgo.io.Io.readFull(_d.value._r, _d.value._tmp.__slice__(0, ((3 : GoInt)) * _np)), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return _err;
        };
        _d.value._crc.write(_d.value._tmp.__slice__(0, _n));
        if (_d.value._cb == _cbP1 || _d.value._cb == _cbP2 || _d.value._cb == _cbP4 || _d.value._cb == _cbP8) {
            _d.value._palette = new stdgo.image.color.Color.Palette(new Slice<stdgo.image.color.Color.Color>(...[for (i in 0 ... ((((256 : GoInt)) : GoInt)).toBasic()) ((null : stdgo.image.color.Color.Color))])).__copy__();
            {
                var _i:GoInt = ((0 : GoInt));
                Go.cfor(_i < _np, _i++, {
                    _d.value._palette.__t__[_i] = new stdgo.image.color.Color.RGBA(_d.value._tmp[((3 : GoInt)) * _i + ((0 : GoInt))], _d.value._tmp[((3 : GoInt)) * _i + ((1 : GoInt))], _d.value._tmp[((3 : GoInt)) * _i + ((2 : GoInt))], ((255 : GoUInt8))).__copy__();
                });
            };
            {
                var _i:GoInt = _np;
                Go.cfor(_i < ((256 : GoInt)), _i++, {
                    _d.value._palette.__t__[_i] = new stdgo.image.color.Color.RGBA(((0 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((255 : GoUInt8))).__copy__();
                });
            };
    ...
    public function _parseIHDR(_length:GoUInt32):Error {
        ...
        {
            var __tmp__ = stdgo.io.Io.readFull(_d.value._r, _d.value._tmp.__slice__(0, ((13 : GoInt)))), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return _err;
            };
        };
        ...
        if (_d.value._cb == _cbInvalid) {
            return new UnsupportedError(stdgo.fmt.Fmt.sprintf("bit depth %d, color type %d", Go.toInterface(_d.value._tmp[((8 : GoInt))]), Go.toInterface(_d.value._tmp[((9 : GoInt))])));
        };
        {
    ...
    public function new(?_r:stdgo.io.Io.Reader, ?_img:stdgo.image.Image.Image, ?_crc:stdgo.hash.Hash.Hash32, ?_width:GoInt, ?_height:GoInt, ?_depth:GoInt, ?_palette:stdgo.image.color.Color.Palette, ?_cb:GoInt, ?_stage:GoInt, ?_idatLength:GoUInt32, ?_tmp:GoArray<GoUInt8>, ?_interlace:GoInt, ?_useTransparent:Bool, ?_transparent:GoArray<GoUInt8>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_r) + " " + Go.string(_img) + " " + Go.string(_crc) + " " + Go.string(_width) + " " + Go.string(_height) + " " + Go.string(_depth) + " " + Go.string(_palette) + " " + Go.string(_cb) + " " + Go.string(_stage) + " " + Go.string(_idatLength) + " " + Go.string(_tmp) + " " + Go.string(_interlace) + " " + Go.string(_useTransparent) + " " + Go.string(_transparent) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class Encoder {
    public function encode(_w:stdgo.io.Io.Writer, _m:stdgo.image.Image.Image):Error {
        ...
        var recover_exception:Error = null;
        var deferstack:Array<Void -> Void> = [];
        var _mw:GoInt64 = ((_m.bounds().dx() : GoInt64)), _mh:GoInt64 = ((_m.bounds().dy() : GoInt64));
        try {
            if (_mw <= ((0 : GoInt64)) || _mh <= ((0 : GoInt64)) || _mw >= (((1 : GoUnTypedInt)) << ((32 : GoUnTypedInt))) || _mh >= (((1 : GoUnTypedInt)) << ((32 : GoUnTypedInt)))) {
                return new FormatError(((("invalid image size: " : GoString)) + stdgo.strconv.Strconv.formatInt(_mw, ((10 : GoInt))) + (("x" : GoString)) + stdgo.strconv.Strconv.formatInt(_mh, ((10 : GoInt)))));
            };
            ...
            if (_enc.value.bufferPool != null) {
                ...
                _e = {
                    var p = new Pointer<T_encoder>(() -> new T_encoder(
_buffer.value._enc,
_buffer.value._w,
_buffer.value._m,
_buffer.value._cb,
_buffer.value._err,
_buffer.value._header,
_buffer.value._footer,
_buffer.value._tmp,
_buffer.value._cr,
_buffer.value._pr,
_buffer.value._zw,
_buffer.value._zwLevel,
_buffer.value._bw), null, false, _buffer);
                    p.convert = v -> new EncoderBuffer(
v._enc,
v._w,
v._m,
v._cb,
...
v._bw);
            ...
            if (_enc.value.bufferPool != null) {
                {
                    var a0 = {
                        var p = new Pointer<EncoderBuffer>(() -> new EncoderBuffer(
_e.value._enc,
_e.value._w,
_e.value._m,
_e.value._cb,
...
_e.value._zw,
_e.value._zwLevel,
_e.value._bw), null, false, _e);
                        p.convert = v -> new T_encoder(
v._enc,
v._w,
v._m,
v._cb,
...
v._bw);
            ...
            if (_pal.__t__ != null && !_pal.__t__.isNil()) {
                ...
                if (Go.toInterface(_m.colorModel()) == Go.toInterface(stdgo.image.color.Color.grayModel)) {
                    ...
                    _e.value._cb = _cbG16;
                } else if (Go.toInterface(_m.colorModel()) == Go.toInterface(stdgo.image.color.Color.rgbamodel) || Go.toInterface(_m.colorModel()) == Go.toInterface(stdgo.image.color.Color.nrgbamodel) || Go.toInterface(_m.colorModel()) == Go.toInterface(stdgo.image.color.Color.alphaModel)) {
                    if (_opaque(_m)) {
                        _e.value._cb = _cbTC8;
                    } else {
    ...
    public function new(?compressionLevel:CompressionLevel, ?bufferPool:EncoderBufferPool) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:named @:structInit class EncoderBuffer extends T_encoder {
    public function new(?_enc, ?_w, ?_m, ?_cb, ?_err, ?_header, ?_footer, ?_tmp, ?_cr, ?_pr, ?_zw, ?_zwLevel, ?_bw) super(_enc,
_w,
_m,
_cb,
_err,
...
_zwLevel,
_bw);
    public override function __copy__() return new EncoderBuffer(
_enc,
_w,
_m,
_cb,
...
@:structInit class T_encoder {
    ...
    public function _writeImage(_w:stdgo.io.Io.Writer, _m:stdgo.image.Image.Image, _cb:GoInt, _level:GoInt):Error {
        ...
        if (_e.value._zw == null || _e.value._zw.isNil() || _e.value._zwLevel != _level) {
            var __tmp__ = stdgo.compress.zlib.Zlib.newWriterLevel(_w, _level), _zw:Pointer<stdgo.compress.zlib.Zlib.Writer> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return _err;
            };
            _e.value._zw = _zw;
            ...
            }, _nrgba = __tmp__.value, _ = __tmp__.ok;
            {
                ...
                Go.cfor(_y < _b.max.y, _y++, {
                    ...
                    if (_cb == _cbG8) {
                        if (_gray != null && !_gray.isNil()) {
                        ...
                        } else {
                            {
                                ...
                                Go.cfor(_x < _b.max.x, _x++, {
                                    var _c:stdgo.image.color.Color.Gray = ((stdgo.image.color.Color.grayModel.convert(_m.at(_x, _y)).__underlying__().value : stdgo.image.color.Color.Gray)).__copy__();
                                    _cr[((0 : GoInt))][_i] = _c.y;
                                    _i++;
                                });
                            };
                        ...
                        var _stride:GoInt = ((0 : GoInt)), _pix:Slice<GoUInt8> = ((new Slice<GoUInt8>().nil() : Slice<GoByte>));
                        ...
                        if (_stride != ((0 : GoInt))) {
                        ...
                        } else {
                            {
                                var _x:GoInt = _b.min.x;
                                Go.cfor(_x < _b.max.x, _x++, {
                                    var __tmp__ = _m.at(_x, _y).rgba(), _r:GoUInt32 = __tmp__._0, _g:GoUInt32 = __tmp__._1, _b:GoUInt32 = __tmp__._2, _:GoUInt32 = __tmp__._3;
                        ...
                        if (_nrgba != null && !_nrgba.isNil()) {
                        ...
                        } else {
                            {
                                var _x:GoInt = _b.min.x;
                                Go.cfor(_x < _b.max.x, _x++, {
                                    var _c:stdgo.image.color.Color.NRGBA = ((stdgo.image.color.Color.nrgbamodel.convert(_m.at(_x, _y)).__underlying__().value : stdgo.image.color.Color.NRGBA)).__copy__();
                    ...
                    } else if (_cb == _cbG16) {
                        {
                            var _x:GoInt = _b.min.x;
                            Go.cfor(_x < _b.max.x, _x++, {
                                var _c:stdgo.image.color.Color.Gray16 = ((stdgo.image.color.Color.gray16Model.convert(_m.at(_x, _y)).__underlying__().value : stdgo.image.color.Color.Gray16)).__copy__();
                    ...
                    } else if (_cb == _cbTCA16) {
                        {
                            var _x:GoInt = _b.min.x;
                            Go.cfor(_x < _b.max.x, _x++, {
                                var _c:stdgo.image.color.Color.NRGBA64 = ((stdgo.image.color.Color.nrgba64model.convert(_m.at(_x, _y)).__underlying__().value : stdgo.image.color.Color.NRGBA64)).__copy__();
                    ...
                    {
                        var __tmp__ = _e.value._zw.value.write(_cr[_f]), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                        if (_err != null) {
                            {
                                for (defer in deferstack) {
                                    defer();
    ...
    public function _writePLTEAndTRNS(_p:stdgo.image.color.Color.Palette):Void {
        ...
        var _last:GoInt = -((1 : GoUnTypedInt));
        {
            ...
            for (_obj in _p.__t__.keyValueIterator()) {
                _i = _obj.key;
                _c = _obj.value;
                var _c1:stdgo.image.color.Color.NRGBA = ((stdgo.image.color.Color.nrgbamodel.convert(_c).__underlying__().value : stdgo.image.color.Color.NRGBA)).__copy__();
        ...
        if (_last != -((1 : GoUnTypedInt))) {
            _e.value._writeChunk(_e.value._tmp.__slice__(((3 : GoUnTypedInt)) * ((256 : GoUnTypedInt)), ((3 : GoUnTypedInt)) * ((256 : GoUnTypedInt)) + ((1 : GoUnTypedInt)) + _last), "tRNS");
        };
    }
    ...
    public function new(?_enc:Pointer<Encoder>, ?_w:stdgo.io.Io.Writer, ?_m:stdgo.image.Image.Image, ?_cb:GoInt, ?_err:stdgo.Error, ?_header:GoArray<GoUInt8>, ?_footer:GoArray<GoUInt8>, ?_tmp:GoArray<GoUInt8>, ?_cr:GoArray<Slice<GoUInt8>>, ?_pr:Slice<GoUInt8>, ?_zw:Pointer<stdgo.compress.zlib.Zlib.Writer>, ?_zwLevel:GoInt, ?_bw:Pointer<bufio.Bufio.Writer>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_enc) + " " + Go.string(_w) + " " + Go.string(_m) + " " + Go.string(_cb) + " " + Go.string(_err) + " " + Go.string(_header) + " " + Go.string(_footer) + " " + Go.string(_tmp) + " " + Go.string(_cr) + " " + Go.string(_pr) + " " + Go.string(_zw) + " " + Go.string(_zwLevel) + " " + Go.string(_bw) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:named class CompressionLevel {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new CompressionLevel(__t__);
}
...
var _interlacing : Slice<T_interlaceScan> = new Slice<T_interlaceScan>(new T_interlaceScan(((8 : GoInt)), ((8 : GoInt)), ((0 : GoInt)), ((0 : GoInt))).__copy__(), new T_interlaceScan(((8 : GoInt)), ((8 : GoInt)), ((4 : GoInt)), ((0 : GoInt))).__copy__(), new T_interlaceScan(((4 : GoInt)), ((8 : GoInt)), ((0 : GoInt)), ((4 : GoInt))).__copy__(), new T_interlaceScan(((4 : GoInt)), ((4 : GoInt)), ((2 : GoInt)), ((0 : GoInt))).__copy__(), new T_interlaceScan(((2 : GoInt)), ((4 : GoInt)), ((0 : GoInt)), ((2 : GoInt))).__copy__(), new T_interlaceScan(((2 : GoInt)), ((2 : GoInt)), ((1 : GoInt)), ((0 : GoInt))).__copy__(), new T_interlaceScan(((1 : GoInt)), ((2 : GoInt)), ((0 : GoInt)), ((1 : GoInt))).__copy__());
...
function _filterPaeth(_cdat:Slice<GoByte>, _pdat:Slice<GoByte>, _bytesPerPixel:GoInt):Void {
        var _a:GoInt = ((0 : GoInt)), _b:GoInt = ((0 : GoInt)), _c:GoInt = ((0 : GoInt)), _pa:GoInt = ((0 : GoInt)), _pb:GoInt = ((0 : GoInt)), _pc:GoInt = ((0 : GoInt));
        {
            var _i:GoInt = ((0 : GoInt));
            Go.cfor(_i < _bytesPerPixel, _i++, {
                {
...
function decode(_r:stdgo.io.Io.Reader):{ var _0 : stdgo.image.Image.Image; var _1 : Error; } {
        var _d:Pointer<T_decoder> = Go.pointer((({ _r : _r, _crc : stdgo.hash.crc32.Crc32.newIEEE(), _img : ((null : stdgo.image.Image.Image)), _width : 0, _height : 0, _depth : 0, _palette : new stdgo.image.color.Color.Palette(), _cb : 0, _stage : 0, _idatLength : 0, _tmp : new GoArray<GoUInt8>(...[for (i in 0 ... 768) ((0 : GoUInt8))]), _interlace : 0, _useTransparent : false, _transparent : new GoArray<GoUInt8>(...[for (i in 0 ... 6) ((0 : GoUInt8))]) } : T_decoder)));
        {
            ...
            Go.cfor(_y < _b.max.y, _y++, {
                {
                    var _x:GoInt = _b.min.x;
                    Go.cfor(_x < _b.max.x, _x++, {
                        var __tmp__ = _m.at(_x, _y).rgba(), _:GoUInt32 = __tmp__._0, _:GoUInt32 = __tmp__._1, _:GoUInt32 = __tmp__._2, _a:GoUInt32 = __tmp__._3;
...
class T_decoder_extension_fields {
    public function _parseIHDR(__tmp__, _length:GoUInt32):Error return __tmp__._parseIHDR(_length);
    public function _parsePLTE(__tmp__, _length:GoUInt32):Error return __tmp__._parsePLTE(_length);
    public function _parsetRNS(__tmp__, _length:GoUInt32):Error return __tmp__._parsetRNS(_length);
    public function read(__tmp__, _p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } return __tmp__.read(_p);
    public function _decode(__tmp__):{ var _0 : stdgo.image.Image.Image; var _1 : Error; } return __tmp__._decode();
    public function _readImagePass(__tmp__, _r:stdgo.io.Io.Reader, _pass:GoInt, _allocateOnly:Bool):{ var _0 : stdgo.image.Image.Image; var _1 : Error; } return __tmp__._readImagePass(_r, _pass, _allocateOnly);
    public function _mergePassInto(__tmp__, _dst:stdgo.image.Image.Image, _src:stdgo.image.Image.Image, _pass:GoInt):Void __tmp__._mergePassInto(_dst, _src, _pass);
    public function _parseIDAT(__tmp__, _length:GoUInt32):Error return __tmp__._parseIDAT(_length);
    public function _parseIEND(__tmp__, _length:GoUInt32):Error return __tmp__._parseIEND(_length);
    public function _parseChunk(__tmp__):Error return __tmp__._parseChunk();
    public function _verifyChecksum(__tmp__):Error return __tmp__._verifyChecksum();
    public function _checkHeader(__tmp__):Error return __tmp__._checkHeader();
}
...
class Encoder_extension_fields {
    public function encode(__tmp__, _w:stdgo.io.Io.Writer, _m:stdgo.image.Image.Image):Error return __tmp__.encode(_w, _m);
}
class T_encoder_extension_fields {
    public function _writeChunk(__tmp__, _b:Slice<GoByte>, _name:GoString):Void __tmp__._writeChunk(_b, _name);
    public function _writeIHDR(__tmp__):Void __tmp__._writeIHDR();
    public function _writePLTEAndTRNS(__tmp__, _p:stdgo.image.color.Color.Palette):Void __tmp__._writePLTEAndTRNS(_p);
    public function write(__tmp__, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } return __tmp__.write(_b);
    public function _writeImage(__tmp__, _w:stdgo.io.Io.Writer, _m:stdgo.image.Image.Image, _cb:GoInt, _level:GoInt):Error return __tmp__._writeImage(_w, _m, _cb, _level);
    public function _writeIDATs(__tmp__):Void __tmp__._writeIDATs();
    public function _writeIEND(__tmp__):Void __tmp__._writeIEND();
}
