...
@:structInit class Index {
    public function findAllIndex(_r:Pointer<stdgo.regexp.Regexp.Regexp>, _n:GoInt):Slice<Slice<GoInt>> {
        ...
        var __tmp__ = _r.value.literalPrefix(), _prefix:GoString = __tmp__._0, _complete:Bool = __tmp__._1;
        ...
        if (_complete) {
            {
                ...
                Go.cfor(true, _n1 = _n1 + (((2 : GoInt)) * (_n - _result.length)), {
                    ...
                    var _pairs:Slice<GoInt> = new Slice<GoInt>(...[for (i in 0 ... ((((2 : GoInt)) * _indices.length : GoInt)).toBasic()) ((0 : GoInt))]);
    ...
    public function write(_w:stdgo.io.Io.Writer):Error {
        ...
        {
            var __tmp__ = _w.write(_x.value._data), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return _err;
            };
        };
        ...
        while (_sa._len() > ((0 : GoInt))) {
            var __tmp__ = _writeSlice(_w, _buf, _sa.__copy__()), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return _err;
            };
    ...
    public function read(_r:stdgo.io.Io.Reader):Error {
        var _x = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _buf:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0 ... ((_bufSize : GoInt)).toBasic()) ((0 : GoUInt8))]);
        var __tmp__ = _readInt(_r, _buf), _n64:GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return _err;
        };
        ...
        if (((2 : GoInt)) * _n < _x.value._data.cap() || _x.value._data.cap() < _n || _x.value._sa._int32 != null && !_x.value._sa._int32.isNil() && _n > _maxData32 || _x.value._sa._int64 != null && !_x.value._sa._int64.isNil() && _n <= _maxData32) {
        ...
        {
            var __tmp__ = stdgo.io.Io.readFull(_r, _x.value._data), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return _err;
            };
        };
        var _sa:T_ints = _x.value._sa.__copy__();
        while (_sa._len() > ((0 : GoInt))) {
            var __tmp__ = _readSlice(_r, _buf, _sa.__copy__()), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return _err;
            };
            _sa = _sa._slice(_n, _sa._len()).__copy__();
    ...
    public function new(?_data:Slice<GoUInt8>, ?_sa:T_ints) stdgo.internal.Macro.initLocals();
...
@:structInit class T_ints {
    ...
    public function new(?_int32:Slice<GoInt32>, ?_int64:Slice<GoInt64>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
function _text_32(_text:Slice<GoByte>, _sa:Slice<GoInt32>):Void {
        ...
        _sais_8_32(_text, ((256 : GoInt)), _sa, new Slice<GoInt32>(...[for (i in 0 ... ((((2 : GoUnTypedInt)) * ((256 : GoUnTypedInt)) : GoInt)).toBasic()) ((0 : GoInt32))]));
    }
/**
...
function _sais_8_32(_text:Slice<GoByte>, _textMax:GoInt, _sa:Slice<GoInt32>, _tmp:Slice<GoInt32>):Void {
        ...
        var _freq:Slice<GoInt32> = new Slice<GoInt32>().nil(), _bucket:Slice<GoInt32> = new Slice<GoInt32>().nil();
...
function _placeLMS_8_32(_text:Slice<GoByte>, _sa:Slice<GoInt32>, _freq:Slice<GoInt32>, _bucket:Slice<GoInt32>):GoInt {
        ...
        _bucket = _bucket.__slice__(0, ((256 : GoInt)));
        var _c0:GoUInt8 = ((((0 : GoUInt8)) : GoByte)), _c1:GoUInt8 = ((((0 : GoUInt8)) : GoByte)), _isTypeS:Bool = false;
        {
...
function _recurse_32(_sa:Slice<GoInt32>, _oldTmp:Slice<GoInt32>, _numLMS:GoInt, _maxID:GoInt):Void {
        var _dst:Slice<GoInt32> = _sa.__slice__(0, _numLMS), _saTmp:Slice<GoInt32> = _sa.__slice__(_numLMS, _sa.length - _numLMS), _text:Slice<GoInt32> = _sa.__slice__(_sa.length - _numLMS);
...
function _text_64(_text:Slice<GoByte>, _sa:Slice<GoInt64>):Void {
        ...
        _sais_8_64(_text, ((256 : GoInt)), _sa, new Slice<GoInt64>(...[for (i in 0 ... ((((2 : GoUnTypedInt)) * ((256 : GoUnTypedInt)) : GoInt)).toBasic()) ((0 : GoInt64))]));
    }
function _sais_8_64(_text:Slice<GoByte>, _textMax:GoInt, _sa:Slice<GoInt64>, _tmp:Slice<GoInt64>):Void {
        ...
        var _freq:Slice<GoInt64> = new Slice<GoInt64>().nil(), _bucket:Slice<GoInt64> = new Slice<GoInt64>().nil();
        if (_tmp.length >= ((2 : GoInt)) * _textMax) {
            {
                final __tmp__0 = _tmp.__slice__(0, _textMax);
                final __tmp__1 = _tmp.__slice__(_textMax, ((2 : GoInt)) * _textMax);
...
function _placeLMS_32(_text:Slice<GoInt32>, _sa:Slice<GoInt32>, _freq:Slice<GoInt32>, _bucket:Slice<GoInt32>):GoInt {
        ...
        var _numLMS:GoInt = ((0 : GoInt));
        var _lastB:GoInt32 = ((-((1 : GoUnTypedInt)) : GoInt32));
        var _c0:GoInt32 = ((((0 : GoInt32)) : GoInt32)), _c1:GoInt32 = ((((0 : GoInt32)) : GoInt32)), _isTypeS:Bool = false;
        {
            var _i:GoInt = _text.length - ((1 : GoInt));
            Go.cfor(_i >= ((0 : GoInt)), _i--, {
                {
...
function _placeLMS_64(_text:Slice<GoInt64>, _sa:Slice<GoInt64>, _freq:Slice<GoInt64>, _bucket:Slice<GoInt64>):GoInt {
        ...
        var _numLMS:GoInt = ((0 : GoInt));
        var _lastB:GoInt64 = ((-((1 : GoUnTypedInt)) : GoInt64));
        var _c0:GoInt64 = ((((0 : GoInt64)) : GoInt64)), _c1:GoInt64 = ((((0 : GoInt64)) : GoInt64)), _isTypeS:Bool = false;
        {
            var _i:GoInt = _text.length - ((1 : GoInt));
            Go.cfor(_i >= ((0 : GoInt)), _i--, {
                {
...
function _recurse_64(_sa:Slice<GoInt64>, _oldTmp:Slice<GoInt64>, _numLMS:GoInt, _maxID:GoInt):Void {
        var _dst:Slice<GoInt64> = _sa.__slice__(0, _numLMS), _saTmp:Slice<GoInt64> = _sa.__slice__(_numLMS, _sa.length - _numLMS), _text:Slice<GoInt64> = _sa.__slice__(_sa.length - _numLMS);
...
function _writeInt(_w:stdgo.io.Io.Writer, _buf:Slice<GoByte>, _x:GoInt):Error {
        ...
        var __tmp__ = _w.write(_buf.__slice__(((0 : GoInt)), stdgo.encoding.binary.Binary.maxVarintLen64)), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        return _err;
    }
/**
...
function _readInt(_r:stdgo.io.Io.Reader, _buf:Slice<GoByte>):{ var _0 : GoInt64; var _1 : Error; } {
        var __tmp__ = stdgo.io.Io.readFull(_r, _buf.__slice__(((0 : GoInt)), stdgo.encoding.binary.Binary.maxVarintLen64)), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        var __tmp__ = stdgo.encoding.binary.Binary.varint(_buf), _x:GoInt64 = __tmp__._0, _:GoInt = __tmp__._1;
...
function _readSlice(_r:stdgo.io.Io.Reader, _buf:Slice<GoByte>, _data:T_ints):{ var _0 : GoInt; var _1 : Error; } {
        ...
        };
        {
            var _p:GoInt = stdgo.encoding.binary.Binary.maxVarintLen64;
            Go.cfor(_p < _size, _n++, {
                var __tmp__ = stdgo.encoding.binary.Binary.uvarint(_buf.__slice__(_p)), _x:GoUInt64 = __tmp__._0, _w:GoInt = __tmp__._1;
...
class Index_extension_fields {
    public function read(__tmp__, _r:stdgo.io.Io.Reader):Error return __tmp__.read(_r);
    ...
    public function _at(__tmp__, _i:GoInt):Slice<GoByte> return __tmp__._at(_i);
    public function _lookupAll(__tmp__, _s:Slice<GoByte>):T_ints return __tmp__._lookupAll(_s);
    public function lookup(__tmp__, _s:Slice<GoByte>, _n:GoInt):Slice<GoInt> return __tmp__.lookup(_s, _n);
    public function findAllIndex(__tmp__, _r:Pointer<stdgo.regexp.Regexp.Regexp>, _n:GoInt):Slice<Slice<GoInt>> return __tmp__.findAllIndex(_r, _n);
}
class T_ints_extension_fields {
    public function _len(__tmp__):GoInt return __tmp__._len();
    public function _get(__tmp__, _i:GoInt):GoInt64 return __tmp__._get(_i);
    public function _set(__tmp__, _i:GoInt, _v:GoInt64):Void __tmp__._set(_i, _v);
    public function _slice(__tmp__, _i:GoInt, _j:GoInt):T_ints return __tmp__._slice(_i, _j);
}
