...
**/
function hashStrBytes(sep:Array<StdTypes.Int>):stdgo.Tuple<std.UInt, std.UInt> {
...
/**
    ...
    factor for use in Rabin-Karp algorithm.
**/
function hashStr(sep:String):stdgo.Tuple<std.UInt, std.UInt> {
        return {
...
**/
function hashStrRevBytes(sep:Array<StdTypes.Int>):stdgo.Tuple<std.UInt, std.UInt> {
        final sep = ([for (i in sep) i] : stdgo.Slice<stdgo.GoByte>);
        return {
...
/**
    ...
    appropriate multiplicative factor for use in Rabin-Karp algorithm.
**/
function hashStrRev(sep:String):stdgo.Tuple<std.UInt, std.UInt> {
        return {
...
**/
function indexRabinKarpBytes(s:Array<StdTypes.Int>, sep:Array<StdTypes.Int>):StdTypes.Int {
...
/**
    ...
    first occurrence of substr in s, or -1 if not present.
**/
function indexRabinKarp(s:String, substr:String):StdTypes.Int {
...
**/
function makeNoZero(n:StdTypes.Int):Array<StdTypes.Int> {
...
function count(b:Array<StdTypes.Int>, c:StdTypes.Int):StdTypes.Int {
        final b = ([for (i in b) i] : stdgo.Slice<stdgo.GoByte>);
        return stdgo._internal.internal.bytealg.Bytealg.count(b, c);
    }
function countString(s:String, c:StdTypes.Int):StdTypes.Int {
...
**/
function index(a:Array<StdTypes.Int>, b:Array<StdTypes.Int>):StdTypes.Int {
        final a = ([for (i in a) i] : stdgo.Slice<stdgo.GoByte>);
        final b = ([for (i in b) i] : stdgo.Slice<stdgo.GoByte>);
...
/**
    ...
    Requires 2 <= len(b) <= MaxLen.
**/
function indexString(a:String, b:String):StdTypes.Int {
...
**/
function cutover(n:StdTypes.Int):StdTypes.Int {
...
/**
    go:noescape
**/
function indexByteString(s:String, c:StdTypes.Int):StdTypes.Int {
