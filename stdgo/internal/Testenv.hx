...
**/
function mustHaveExec(t:stdgo._internal.testing.Testing.TB):Void {
...
**/
function mustHaveExecPath(t:stdgo._internal.testing.Testing.TB, path:String):Void {
...
**/
function cleanCmdEnv(cmd:stdgo._internal.os.exec.Exec.Cmd):stdgo._internal.os.exec.Exec.Cmd {
...
**/
function commandContext(t:stdgo._internal.testing.Testing.TB, ctx:stdgo._internal.context.Context.Context, name:String, args:haxe.Rest<String>):stdgo._internal.os.exec.Exec.Cmd {
...
**/
function command(t:stdgo._internal.testing.Testing.TB, name:String, args:haxe.Rest<String>):stdgo._internal.os.exec.Exec.Cmd {
...
**/
function mustHaveGoBuild(t:stdgo._internal.testing.Testing.TB):Void {
...
**/
function mustHaveGoRun(t:stdgo._internal.testing.Testing.TB):Void {
...
**/
function mustHaveParallelism(t:stdgo._internal.testing.Testing.TB):Void {
...
**/
function goToolPath(t:stdgo._internal.testing.Testing.TB):String {
...
/**
    ...
    or panics otherwise.
**/
function goroot(t:stdgo._internal.testing.Testing.TB):String {
...
**/
function mustHaveExternalNetwork(t:stdgo._internal.testing.Testing.TB):Void {
...
**/
function mustHaveCGO(t:stdgo._internal.testing.Testing.TB):Void {
...
**/
function mustInternalLink(t:stdgo._internal.testing.Testing.TB, withCgo:Bool):Void {
...
**/
function mustHaveBuildMode(t:stdgo._internal.testing.Testing.TB, buildmode:String):Void {
...
**/
function mustHaveSymlink(t:stdgo._internal.testing.Testing.TB):Void {
...
**/
function mustHaveLink(t:stdgo._internal.testing.Testing.TB):Void {
        stdgo._internal.internal.testenv.Testenv.mustHaveLink(t);
    }
function skipFlaky(t:stdgo._internal.testing.Testing.TB, issue:StdTypes.Int):Void {
        stdgo._internal.internal.testenv.Testenv.skipFlaky(t, issue);
    }
function skipFlakyNet(t:stdgo._internal.testing.Testing.TB):Void {
...
**/
function skipIfShortAndSlow(t:stdgo._internal.testing.Testing.TB):Void {
        stdgo._internal.internal.testenv.Testenv.skipIfShortAndSlow(t);
    }
/**
    SkipIfOptimizationOff skips t if optimization is disabled.
**/
function skipIfOptimizationOff(t:stdgo._internal.testing.Testing.TB):Void {
...
**/
function writeImportcfg(t:stdgo._internal.testing.Testing.TB, dstPath:String, packageFiles:stdgo.GoMap<stdgo.GoString, stdgo.GoString>, pkgs:haxe.Rest<String>):Void {
