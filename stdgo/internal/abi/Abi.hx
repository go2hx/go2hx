...
@:structInit @:using(stdgo.internal.abi.Abi.RegArgs_static_extension) class RegArgs {
    ...
    **/
    public var returnIsPtr : stdgo.internal.abi.Abi.IntArgRegBitmap = new stdgo.internal.abi.Abi.IntArgRegBitmap(...[for (i in 0 ... 0) (0 : stdgo.GoUInt8)]);
    public function new(?ints:stdgo.GoArray<stdgo.GoUIntptr>, ?floats:stdgo.GoArray<stdgo.GoUInt64>, ?ptrs:stdgo.GoArray<stdgo.unsafe.Unsafe.UnsafePointer>, ?returnIsPtr:stdgo.internal.abi.Abi.IntArgRegBitmap) {
...
@:structInit @:using(stdgo.internal.abi.Abi.Type__static_extension) class Type_ {
    ...
    public var tflag : stdgo.internal.abi.Abi.TFlag = ((0 : stdgo.GoUInt8) : stdgo.internal.abi.Abi.TFlag);
    ...
    **/
    ...
    public var str : stdgo.internal.abi.Abi.NameOff = ((0 : stdgo.GoInt32) : stdgo.internal.abi.Abi.NameOff);
    public var ptrToThis : stdgo.internal.abi.Abi.TypeOff = ((0 : stdgo.GoInt32) : stdgo.internal.abi.Abi.TypeOff);
    public function new(?size_:stdgo.GoUIntptr, ?ptrBytes:stdgo.GoUIntptr, ?hash:stdgo.GoUInt32, ?tflag:stdgo.internal.abi.Abi.TFlag, ?align_:stdgo.GoUInt8, ?fieldAlign_:stdgo.GoUInt8, ?kind_:stdgo.GoUInt8, ?equal:(stdgo.unsafe.Unsafe.UnsafePointer, stdgo.unsafe.Unsafe.UnsafePointer) -> Bool, ?gcdata:stdgo.Pointer<stdgo.GoUInt8>, ?str:stdgo.internal.abi.Abi.NameOff, ?ptrToThis:stdgo.internal.abi.Abi.TypeOff) {
...
@:structInit class Method {
    public var name : stdgo.internal.abi.Abi.NameOff = ((0 : stdgo.GoInt32) : stdgo.internal.abi.Abi.NameOff);
    public var mtyp : stdgo.internal.abi.Abi.TypeOff = ((0 : stdgo.GoInt32) : stdgo.internal.abi.Abi.TypeOff);
    public var ifn : stdgo.internal.abi.Abi.TextOff = ((0 : stdgo.GoInt32) : stdgo.internal.abi.Abi.TextOff);
    public var tfn : stdgo.internal.abi.Abi.TextOff = ((0 : stdgo.GoInt32) : stdgo.internal.abi.Abi.TextOff);
...
@:structInit @:using(stdgo.internal.abi.Abi.UncommonType_static_extension) class UncommonType {
    public var pkgPath : stdgo.internal.abi.Abi.NameOff = ((0 : stdgo.GoInt32) : stdgo.internal.abi.Abi.NameOff);
    ...
    public function new(?pkgPath:stdgo.internal.abi.Abi.NameOff, ?mcount:stdgo.GoUInt16, ?xcount:stdgo.GoUInt16, ?moff:stdgo.GoUInt32, ?__1:stdgo.GoUInt32) {
...
@:structInit class Imethod {
    public var name : stdgo.internal.abi.Abi.NameOff = ((0 : stdgo.GoInt32) : stdgo.internal.abi.Abi.NameOff);
    public var typ : stdgo.internal.abi.Abi.TypeOff = ((0 : stdgo.GoInt32) : stdgo.internal.abi.Abi.TypeOff);
...
@:structInit @:using(stdgo.internal.abi.Abi.ArrayType_static_extension) class ArrayType {
    ...
    public var elem : stdgo.Ref<stdgo.internal.abi.Abi.Type_> = (null : stdgo.Ref<stdgo.internal.abi.Abi.Type_>);
    public var slice : stdgo.Ref<stdgo.internal.abi.Abi.Type_> = (null : stdgo.Ref<stdgo.internal.abi.Abi.Type_>);
    public var len : stdgo.GoUIntptr = 0;
    public function new(?type:stdgo.internal.abi.Abi.Type_, ?elem:stdgo.Ref<stdgo.internal.abi.Abi.Type_>, ?slice:stdgo.Ref<stdgo.internal.abi.Abi.Type_>, ?len:stdgo.GoUIntptr) {
    ...
    @:embedded
    public function arrayType():stdgo.Ref<stdgo.internal.abi.Abi.ArrayType> return type.arrayType();
    @:embedded
    public function chanDir():stdgo.internal.abi.Abi.ChanDir return type.chanDir();
    @:embedded
    public function common():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return type.common();
    @:embedded
    ...
    @:embedded
    public function funcType():stdgo.Ref<stdgo.internal.abi.Abi.FuncType> return type.funcType();
    @:embedded
    ...
    @:embedded
    public function interfaceType():stdgo.Ref<stdgo.internal.abi.Abi.InterfaceType> return type.interfaceType();
    @:embedded
    public function isDirectIface():Bool return type.isDirectIface();
    @:embedded
    public function key():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return type.key();
    @:embedded
    public function kind():stdgo.internal.abi.Abi.Kind return type.kind();
    @:embedded
    public function mapType():stdgo.Ref<stdgo.internal.abi.Abi.MapType> return type.mapType();
    @:embedded
    ...
    @:embedded
    public function structType():stdgo.Ref<stdgo.internal.abi.Abi.StructType> return type.structType();
    @:embedded
    public function uncommon():stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return type.uncommon();
    public function __copy__() {
...
@:structInit @:using(stdgo.internal.abi.Abi.ChanType_static_extension) class ChanType {
    ...
    public var type : stdgo.internal.abi.Abi.Type_ = ({} : stdgo.internal.abi.Abi.Type_);
    public var elem : stdgo.Ref<stdgo.internal.abi.Abi.Type_> = (null : stdgo.Ref<stdgo.internal.abi.Abi.Type_>);
    public var dir : stdgo.internal.abi.Abi.ChanDir = ((0 : stdgo.GoInt) : stdgo.internal.abi.Abi.ChanDir);
    public function new(?type:stdgo.internal.abi.Abi.Type_, ?elem:stdgo.Ref<stdgo.internal.abi.Abi.Type_>, ?dir:stdgo.internal.abi.Abi.ChanDir) {
        if (type != null) this.type = type;
        if (elem != null) this.elem = elem;
...
@:structInit @:private @:using(stdgo.internal.abi.Abi.T_structTypeUncommon_static_extension) class T_structTypeUncommon {
    ...
    @:embedded
    public function arrayType():stdgo.Ref<stdgo.internal.abi.Abi.ArrayType> return structType.arrayType();
    @:embedded
    public function chanDir():stdgo.internal.abi.Abi.ChanDir return structType.chanDir();
    @:embedded
    public function common():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return structType.common();
    @:embedded
    public function elem():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return structType.elem();
    @:embedded
    ...
    @:embedded
    public function funcType():stdgo.Ref<stdgo.internal.abi.Abi.FuncType> return structType.funcType();
    @:embedded
    ...
    @:embedded
    public function interfaceType():stdgo.Ref<stdgo.internal.abi.Abi.InterfaceType> return structType.interfaceType();
    @:embedded
    public function isDirectIface():Bool return structType.isDirectIface();
    @:embedded
    public function key():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return structType.key();
    @:embedded
    ...
    @:embedded
    public function mapType():stdgo.Ref<stdgo.internal.abi.Abi.MapType> return structType.mapType();
    @:embedded
    ...
    @:embedded
    public function uncommon():stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return structType.uncommon();
    public function __copy__() {
...
@:structInit @:using(stdgo.internal.abi.Abi.InterfaceType_static_extension) class InterfaceType {
    ...
    public function common():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return type.common();
    @:embedded
    public function elem():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return type.elem();
    @:embedded
    public function exportedMethods():stdgo.Slice<stdgo.internal.abi.Abi.Method> return type.exportedMethods();
    @:embedded
    public function fieldAlign():stdgo.GoInt return type.fieldAlign();
...
@:structInit @:using(stdgo.internal.abi.Abi.MapType_static_extension) class MapType {
    @:embedded
    public var type : stdgo.internal.abi.Abi.Type_ = ({} : stdgo.internal.abi.Abi.Type_);
    public var key : stdgo.Ref<stdgo.internal.abi.Abi.Type_> = (null : stdgo.Ref<stdgo.internal.abi.Abi.Type_>);
    public var elem : stdgo.Ref<stdgo.internal.abi.Abi.Type_> = (null : stdgo.Ref<stdgo.internal.abi.Abi.Type_>);
    public var bucket : stdgo.Ref<stdgo.internal.abi.Abi.Type_> = (null : stdgo.Ref<stdgo.internal.abi.Abi.Type_>);
    /**
        // function for hashing keys (ptr to key, seed) -> hash
    **/
    public var hasher : (stdgo.unsafe.Unsafe.UnsafePointer, stdgo.GoUIntptr) -> stdgo.GoUIntptr = null;
    ...
    public function new(?type:stdgo.internal.abi.Abi.Type_, ?key:stdgo.Ref<stdgo.internal.abi.Abi.Type_>, ?elem:stdgo.Ref<stdgo.internal.abi.Abi.Type_>, ?bucket:stdgo.Ref<stdgo.internal.abi.Abi.Type_>, ?hasher:(stdgo.unsafe.Unsafe.UnsafePointer, stdgo.GoUIntptr) -> stdgo.GoUIntptr, ?keySize:stdgo.GoUInt8, ?valueSize:stdgo.GoUInt8, ?bucketSize:stdgo.GoUInt16, ?flags:stdgo.GoUInt32) {
        if (type != null) this.type = type;
...
@:structInit @:using(stdgo.internal.abi.Abi.SliceType_static_extension) class SliceType {
    ...
    public var type : stdgo.internal.abi.Abi.Type_ = ({} : stdgo.internal.abi.Abi.Type_);
    public var elem : stdgo.Ref<stdgo.internal.abi.Abi.Type_> = (null : stdgo.Ref<stdgo.internal.abi.Abi.Type_>);
    public function new(?type:stdgo.internal.abi.Abi.Type_, ?elem:stdgo.Ref<stdgo.internal.abi.Abi.Type_>) {
        if (type != null) this.type = type;
        if (elem != null) this.elem = elem;
    }
    public function __underlying__() return stdgo.Go.toInterface(this);
...
@:structInit @:using(stdgo.internal.abi.Abi.FuncType_static_extension) class FuncType {
    ...
    public function new(?type:stdgo.internal.abi.Abi.Type_, ?inCount:stdgo.GoUInt16, ?outCount:stdgo.GoUInt16) {
        if (type != null) this.type = type;
...
@:structInit @:using(stdgo.internal.abi.Abi.StructField_static_extension) class StructField {
    ...
    public var typ : stdgo.Ref<stdgo.internal.abi.Abi.Type_> = (null : stdgo.Ref<stdgo.internal.abi.Abi.Type_>);
    public var offset : stdgo.GoUIntptr = 0;
    public function new(?name:stdgo.internal.abi.Abi.Name, ?typ:stdgo.Ref<stdgo.internal.abi.Abi.Type_>, ?offset:stdgo.GoUIntptr) {
        if (name != null) this.name = name;
        if (typ != null) this.typ = typ;
...
**/
@:named @:using(stdgo.internal.abi.Abi.IntArgRegBitmap_static_extension) typedef IntArgRegBitmap = stdgo.GoArray<stdgo.GoUInt8>;
/**
...
**/
@:named @:using(stdgo.internal.abi.Abi.Kind_static_extension) typedef Kind = stdgo.GoUInt;
/**
...
function commonSize(_ptrSize:stdgo.GoInt):stdgo.GoInt {
        return (((4 : stdgo.GoInt) * _ptrSize) + (8 : stdgo.GoInt)) + (8 : stdgo.GoInt);
    }
/**
    // StructFieldSize returns sizeof(StructField) for a compilation target with a given ptrSize
**/
function structFieldSize(_ptrSize:stdgo.GoInt):stdgo.GoInt {
        return (3 : stdgo.GoInt) * _ptrSize;
    }
/**
...
function kindOff(_ptrSize:stdgo.GoInt):stdgo.GoInt {
        return ((2 : stdgo.GoInt) * _ptrSize) + (7 : stdgo.GoInt);
    }
/**
...
function tflagOff(_ptrSize:stdgo.GoInt):stdgo.GoInt {
        return ((2 : stdgo.GoInt) * _ptrSize) + (4 : stdgo.GoInt);
    }
/**
...
function newOffset(_ptrSize:stdgo.GoUInt8, _twoWordAlignSlices:Bool):Offset {
        if (_twoWordAlignSlices) {
            return ({ _off : (0i64 : stdgo.GoUInt64), _align : (1 : stdgo.GoUInt8), _ptrSize : _ptrSize, _sliceAlign : (2 : stdgo.GoUInt8) * _ptrSize } : stdgo.internal.abi.Abi.Offset);
        };
        return ({ _off : (0i64 : stdgo.GoUInt64), _align : (1 : stdgo.GoUInt8), _ptrSize : _ptrSize, _sliceAlign : _ptrSize } : stdgo.internal.abi.Abi.Offset);
    }
...
**/
function _addChecked(_p:stdgo.unsafe.Unsafe.UnsafePointer, _x:stdgo.GoUIntptr, _whySafe:stdgo.GoString):stdgo.unsafe.Unsafe.UnsafePointer {
        return (stdgo.Go.toInterface(((_p.__convert__(stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind)) : stdgo.GoUIntptr) + _x)) : stdgo.unsafe.Unsafe.UnsafePointer);
    }
/**
...
function _writeVarint(_buf:stdgo.Slice<stdgo.GoByte>, _n:stdgo.GoInt):stdgo.GoInt {
        {
            ...
            stdgo.Go.cfor(true, _i++, {
                var _b:stdgo.GoUInt8 = (_n & (127 : stdgo.GoInt) : stdgo.GoByte);
                _n = _n >> ((7i64 : stdgo.GoUInt64));
                if (_n == ((0 : stdgo.GoInt))) {
                    _buf[(_i : stdgo.GoInt)] = _b;
                    return _i + (1 : stdgo.GoInt);
                };
                _buf[(_i : stdgo.GoInt)] = _b | (128 : stdgo.GoUInt8);
            });
        };
    }
function newName(_n:stdgo.GoString, _tag:stdgo.GoString, _exported:Bool, _embedded:Bool):Name {
        if ((_n.length) >= (536870912 : stdgo.GoInt)) {
            throw stdgo.Go.toInterface(("abi.NewName: name too long: " : stdgo.GoString) + (_n.__slice__(0, (1024 : stdgo.GoInt)) : stdgo.GoString)?.__copy__() + ("..." : stdgo.GoString)?.__copy__());
        };
        if ((_tag.length) >= (536870912 : stdgo.GoInt)) {
            throw stdgo.Go.toInterface(("abi.NewName: tag too long: " : stdgo.GoString) + (_tag.__slice__(0, (1024 : stdgo.GoInt)) : stdgo.GoString)?.__copy__() + ("..." : stdgo.GoString)?.__copy__());
        };
        ...
        var _l:stdgo.GoInt = ((1 : stdgo.GoInt) + _nameLenLen) + (_n.length);
        if (_exported) {
            _bits = _bits | ((1 : stdgo.GoUInt8));
        };
        if ((_tag.length) > (0 : stdgo.GoInt)) {
            _l = _l + (_tagLenLen + _tag.length);
            _bits = _bits | ((2 : stdgo.GoUInt8));
        };
        if (_embedded) {
            _bits = _bits | ((8 : stdgo.GoUInt8));
        };
        ...
        stdgo.Go.copySlice((_b.__slice__((1 : stdgo.GoInt) + _nameLenLen) : stdgo.Slice<stdgo.GoUInt8>), _n);
        if ((_tag.length) > (0 : stdgo.GoInt)) {
            var _tb = (_b.__slice__(((1 : stdgo.GoInt) + _nameLenLen) + (_n.length)) : stdgo.Slice<stdgo.GoUInt8>);
        ...
        return ({ bytes : stdgo.Go.pointer(_b[(0 : stdgo.GoInt)]) } : stdgo.internal.abi.Abi.Name);
    }
...
class RegArgs_asInterface {
    ...
    **/
    @:keep
    public dynamic function intRegArgAddr(_reg:stdgo.GoInt, _argSize:stdgo.GoUIntptr):stdgo.unsafe.Unsafe.UnsafePointer return __self__.value.intRegArgAddr(_reg, _argSize);
    @:keep
...
@:keep @:allow(stdgo.internal.abi.Abi.RegArgs_asInterface) class RegArgs_static_extension {
    ...
    **/
    @:keep
    static public function intRegArgAddr( _r:stdgo.Ref<RegArgs>, _reg:stdgo.GoInt, _argSize:stdgo.GoUIntptr):stdgo.unsafe.Unsafe.UnsafePointer {
        @:recv var _r:stdgo.Ref<RegArgs> = _r;
        if (((_argSize > (4 : stdgo.GoUIntptr)) || (_argSize == (0 : stdgo.GoUIntptr))) || ((_argSize & (_argSize - (1 : stdgo.GoUIntptr))) != (0 : stdgo.GoUIntptr))) {
            throw stdgo.Go.toInterface(("invalid argSize" : stdgo.GoString));
        };
        var _offset:stdgo.GoUIntptr = (0 : stdgo.GoUIntptr);
        if (false) {
            _offset = (4 : stdgo.GoUIntptr) - _argSize;
        };
        return (stdgo.Go.toInterface((((stdgo.Go.toInterface(stdgo.Go.pointer(_r.ints[(_reg : stdgo.GoInt)])) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind)) : stdgo.GoUIntptr) + _offset)) : stdgo.unsafe.Unsafe.UnsafePointer);
    }
    @:keep
...
@:keep @:allow(stdgo.internal.abi.Abi.Offset_asInterface) class Offset_static_extension {
    ...
    **/
    ...
    static public function interface_( _o:Offset):Offset {
        ...
        _o._off = _o._off + ((2i64 : stdgo.GoUInt64) * (_o._ptrSize : stdgo.GoUInt64));
        return _o?.__copy__();
    }
    /**
        // String returns the offset obtained by appending a string field to o.
    ...
    **/
    ...
    static public function slice( _o:Offset):Offset {
        @:recv var _o:Offset = _o?.__copy__();
        _o = _o._align_(_o._sliceAlign)?.__copy__();
        _o._off = _o._off + ((3i64 : stdgo.GoUInt64) * (_o._ptrSize : stdgo.GoUInt64));
    ...
    **/
    ...
    static public function _align_( _o:Offset, _a:stdgo.GoUInt8):Offset {
        @:recv var _o:Offset = _o?.__copy__();
        _o._off = ((_o._off + (_a : stdgo.GoUInt64)) - (1i64 : stdgo.GoUInt64)) & (-1 ^ ((_a : stdgo.GoUInt64) - (1i64 : stdgo.GoUInt64)));
        if (_o._align < _a) {
            _o._align = _a;
        };
        return _o?.__copy__();
...
{ name : "gcdata", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) }) }, optional : false },
{ name : "str", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false },
{ name : "ptrToThis", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TypeOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) }) }, optional : false }, { name : "hasher", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.signature(false, { get : () -> [stdgo.internal.reflect.Reflect.GoType.basic(unsafepointer_kind), stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind)] }, { get : () -> [stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind)] }, { get : () -> stdgo.internal.reflect.Reflect.GoType.invalidType }) }, optional : false }, { name : "keySize", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) }, optional : false }, { name : "valueSize", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) }, optional : false }, { name : "bucketSize", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }, { name : "flags", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<MapType>);
    }
    /**
        // StructType returns t cast to a *StructType, or nil if its tag does not match.
    **/
...
{ name : "gcdata", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) }) }, optional : false },
{ name : "str", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false },
{ name : "ptrToThis", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TypeOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) }) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<PtrType>);
                return _tt.elem;
...
{ name : "gcdata", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) }) }, optional : false },
{ name : "str", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false },
{ name : "ptrToThis", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TypeOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) }) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<SliceType>);
                return _tt.elem;
            };
        };
        return null;
...
{ name : "gcdata", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) }) }, optional : false },
{ name : "str", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false },
{ name : "ptrToThis", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TypeOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) }) }, optional : false }]), false, { get : () -> null }) }, optional : false }, { name : "_u", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.UncommonType", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "pkgPath", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }, { name : "mcount", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }, { name : "xcount", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }, { name : "moff", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false }, { name : "__214", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false }]), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<T_uncommon_43___localname___u>)._u) : stdgo.Ref<stdgo.internal.abi.Abi.UncommonType>);
            } else if (__value__ == ((19u32 : stdgo.internal.abi.Abi.Kind))) {
                {};
                return (stdgo.Go.setRef(((stdgo.Go.toInterface(_t) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.refType({ get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.T_uncommon_44___localname___u", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "funcType", embedded : true, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.FuncType", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "type", embedded : true, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.Type_", [], stdgo.internal.reflect.Reflect.GoType.structType([
{ name : "size_", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) }, optional : false },
{ name : "ptrBytes", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) }, optional : false },
{ name : "hash", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false },
{ name : "tflag", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TFlag", [], stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind), false, { get : () -> null }) }, optional : false },
...
{ name : "gcdata", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) }) }, optional : false },
{ name : "str", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false },
{ name : "ptrToThis", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TypeOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) }, optional : false }, { name : "inCount", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }, { name : "outCount", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }]), false, { get : () -> null }) }, optional : false }, { name : "_u", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.UncommonType", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "pkgPath", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }, { name : "mcount", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }, { name : "xcount", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }, { name : "moff", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false }, { name : "__223", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false }]), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<T_uncommon_44___localname___u>)._u) : stdgo.Ref<stdgo.internal.abi.Abi.UncommonType>);
            } else if (__value__ == ((23u32 : stdgo.internal.abi.Abi.Kind))) {
                {};
                return (stdgo.Go.setRef(((stdgo.Go.toInterface(_t) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.refType({ get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.T_uncommon_45___localname___u", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "sliceType", embedded : true, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.SliceType", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "type", embedded : true, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.Type_", [], stdgo.internal.reflect.Reflect.GoType.structType([
{ name : "size_", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) }, optional : false },
{ name : "ptrBytes", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) }, optional : false },
{ name : "hash", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false },
{ name : "tflag", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TFlag", [], stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind), false, { get : () -> null }) }, optional : false },
...
{ name : "gcdata", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) }) }, optional : false },
{ name : "str", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false },
{ name : "ptrToThis", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TypeOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) }) }, optional : false }]), false, { get : () -> null }) }, optional : false }, { name : "_u", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.UncommonType", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "pkgPath", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }, { name : "mcount", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }, { name : "xcount", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }, { name : "moff", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false }, { name : "__232", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false }]), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<T_uncommon_45___localname___u>)._u) : stdgo.Ref<stdgo.internal.abi.Abi.UncommonType>);
            } else if (__value__ == ((17u32 : stdgo.internal.abi.Abi.Kind))) {
                {};
                return (stdgo.Go.setRef(((stdgo.Go.toInterface(_t) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.refType({ get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.T_uncommon_46___localname___u", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "arrayType", embedded : true, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.ArrayType", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "type", embedded : true, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.Type_", [], stdgo.internal.reflect.Reflect.GoType.structType([
{ name : "size_", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) }, optional : false },
{ name : "ptrBytes", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) }, optional : false },
{ name : "hash", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false },
{ name : "tflag", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TFlag", [], stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind), false, { get : () -> null }) }, optional : false },
...
{ name : "gcdata", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) }) }, optional : false },
{ name : "str", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false },
{ name : "ptrToThis", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TypeOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) }) }, optional : false }, { name : "len", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) }, optional : false }]), false, { get : () -> null }) }, optional : false }, { name : "_u", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.UncommonType", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "pkgPath", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }, { name : "mcount", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }, { name : "xcount", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }, { name : "moff", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false }, { name : "__241", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false }]), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<T_uncommon_46___localname___u>)._u) : stdgo.Ref<stdgo.internal.abi.Abi.UncommonType>);
            } else if (__value__ == ((18u32 : stdgo.internal.abi.Abi.Kind))) {
                {};
                return (stdgo.Go.setRef(((stdgo.Go.toInterface(_t) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.refType({ get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.T_uncommon_47___localname___u", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "chanType", embedded : true, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.ChanType", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "type", embedded : true, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.Type_", [], stdgo.internal.reflect.Reflect.GoType.structType([
{ name : "size_", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) }, optional : false },
{ name : "ptrBytes", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) }, optional : false },
{ name : "hash", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false },
{ name : "tflag", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TFlag", [], stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind), false, { get : () -> null }) }, optional : false },
...
{ name : "gcdata", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) }) }, optional : false },
{ name : "str", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false },
{ name : "ptrToThis", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TypeOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) }) }, optional : false }, { name : "dir", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.ChanDir", [], stdgo.internal.reflect.Reflect.GoType.basic(int_kind), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) }, optional : false }, { name : "_u", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.UncommonType", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "pkgPath", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }, { name : "mcount", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }, { name : "xcount", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }, { name : "moff", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false }, { name : "__250", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false }]), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<T_uncommon_47___localname___u>)._u) : stdgo.Ref<stdgo.internal.abi.Abi.UncommonType>);
            } else if (__value__ == ((21u32 : stdgo.internal.abi.Abi.Kind))) {
                {};
                return (stdgo.Go.setRef(((stdgo.Go.toInterface(_t) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.refType({ get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.T_uncommon_48___localname___u", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "mapType", embedded : true, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.MapType", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "type", embedded : true, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.Type_", [], stdgo.internal.reflect.Reflect.GoType.structType([
{ name : "size_", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) }, optional : false },
{ name : "ptrBytes", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) }, optional : false },
{ name : "hash", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false },
{ name : "tflag", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TFlag", [], stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind), false, { get : () -> null }) }, optional : false },
...
{ name : "gcdata", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) }) }, optional : false },
{ name : "str", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false },
{ name : "ptrToThis", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TypeOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) }) }, optional : false }, { name : "hasher", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.signature(false, { get : () -> [stdgo.internal.reflect.Reflect.GoType.basic(unsafepointer_kind), stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind)] }, { get : () -> [stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind)] }, { get : () -> stdgo.internal.reflect.Reflect.GoType.invalidType }) }, optional : false }, { name : "keySize", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) }, optional : false }, { name : "valueSize", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) }, optional : false }, { name : "bucketSize", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }, { name : "flags", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false }]), false, { get : () -> null }) }, optional : false }, { name : "_u", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.UncommonType", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "pkgPath", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }, { name : "mcount", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }, { name : "xcount", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }, { name : "moff", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false }, { name : "__259", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false }]), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<T_uncommon_48___localname___u>)._u) : stdgo.Ref<stdgo.internal.abi.Abi.UncommonType>);
            } else if (__value__ == ((20u32 : stdgo.internal.abi.Abi.Kind))) {
                {};
                return (stdgo.Go.setRef(((stdgo.Go.toInterface(_t) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.refType({ get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.T_uncommon_49___localname___u", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "interfaceType", embedded : true, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.InterfaceType", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "type", embedded : true, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.Type_", [], stdgo.internal.reflect.Reflect.GoType.structType([
{ name : "size_", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) }, optional : false },
{ name : "ptrBytes", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) }, optional : false },
{ name : "hash", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false },
{ name : "tflag", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TFlag", [], stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind), false, { get : () -> null }) }, optional : false },
...
{ name : "gcdata", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) }) }, optional : false },
{ name : "str", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false },
{ name : "ptrToThis", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TypeOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) }, optional : false }, { name : "pkgPath", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.Name", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "bytes", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) }) }, optional : false }]), false, { get : () -> null }) }, optional : false }, { name : "methods", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.sliceType({ get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.Imethod", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "name", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }, { name : "typ", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TypeOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) }) }, optional : false }]), false, { get : () -> null }) }, optional : false }, { name : "_u", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.UncommonType", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "pkgPath", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }, { name : "mcount", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }, { name : "xcount", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }, { name : "moff", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false }, { name : "__268", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false }]), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<T_uncommon_49___localname___u>)._u) : stdgo.Ref<stdgo.internal.abi.Abi.UncommonType>);
            } else {
                {};
                return (stdgo.Go.setRef(((stdgo.Go.toInterface(_t) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.refType({ get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.T_uncommon_50___localname___u", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "type", embedded : true, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.Type_", [], stdgo.internal.reflect.Reflect.GoType.structType([
{ name : "size_", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) }, optional : false },
{ name : "ptrBytes", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) }, optional : false },
{ name : "hash", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false },
{ name : "tflag", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TFlag", [], stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind), false, { get : () -> null }) }, optional : false },
...
{ name : "gcdata", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) }) }, optional : false },
{ name : "str", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false },
{ name : "ptrToThis", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TypeOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) }, optional : false }, { name : "_u", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.UncommonType", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "pkgPath", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }, { name : "mcount", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }, { name : "xcount", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint16_kind) }, optional : false }, { name : "moff", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false }, { name : "__277", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false }]), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<T_uncommon_50___localname___u>)._u) : stdgo.Ref<stdgo.internal.abi.Abi.UncommonType>);
            };
        };
    }
    /**
...
{ name : "gcdata", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) }) }, optional : false },
{ name : "str", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false },
{ name : "ptrToThis", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TypeOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) }) }, optional : false }, { name : "len", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<ArrayType>).len : stdgo.GoInt);
        };
        return (0 : stdgo.GoInt);
    }
    @:keep
    ...
    **/
    ...
    static public function isDirectIface( _t:stdgo.Ref<Type_>):Bool {
        @:recv var _t:stdgo.Ref<Type_> = _t;
        return _t.kind_ & (32 : stdgo.GoUInt8) != ((0 : stdgo.GoUInt8));
    }
    /**
        // IfaceIndir reports whether t is stored indirectly in an interface value.
    **/
    ...
    static public function kind( _t:stdgo.Ref<Type_>):Kind {
        @:recv var _t:stdgo.Ref<Type_> = _t;
        return (_t.kind_ & (31 : stdgo.GoUInt8) : Kind);
    }
}
/**
...
@:structInit class T_uncommon_43___localname___u {
    ...
    @:embedded
    public function arrayType():stdgo.Ref<stdgo.internal.abi.Abi.ArrayType> return ptrType.arrayType();
    @:embedded
    public function chanDir():stdgo.internal.abi.Abi.ChanDir return ptrType.chanDir();
    @:embedded
    public function common():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return ptrType.common();
    @:embedded
    ...
    @:embedded
    public function funcType():stdgo.Ref<stdgo.internal.abi.Abi.FuncType> return ptrType.funcType();
    @:embedded
    ...
    @:embedded
    public function interfaceType():stdgo.Ref<stdgo.internal.abi.Abi.InterfaceType> return ptrType.interfaceType();
    @:embedded
    public function isDirectIface():Bool return ptrType.isDirectIface();
    @:embedded
    public function key():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return ptrType.key();
    @:embedded
    public function kind():stdgo.internal.abi.Abi.Kind return ptrType.kind();
    @:embedded
    public function len():stdgo.GoInt return ptrType.len();
    @:embedded
    public function mapType():stdgo.Ref<stdgo.internal.abi.Abi.MapType> return ptrType.mapType();
    @:embedded
    ...
    @:embedded
    public function structType():stdgo.Ref<stdgo.internal.abi.Abi.StructType> return ptrType.structType();
    @:embedded
    public function uncommon():stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return ptrType.uncommon();
    public function __copy__() {
        return new T_uncommon_43___localname___u(ptrType, _u);
    }
}
/**
...
@:structInit class T_uncommon_44___localname___u {
    ...
    @:embedded
    public function arrayType():stdgo.Ref<stdgo.internal.abi.Abi.ArrayType> return funcType.arrayType();
    @:embedded
    public function chanDir():stdgo.internal.abi.Abi.ChanDir return funcType.chanDir();
    @:embedded
    public function common():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return funcType.common();
    @:embedded
    public function elem():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return funcType.elem();
    @:embedded
    ...
    @:embedded
    public function in_(_i:stdgo.GoInt):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return funcType.in_(_i);
    @:embedded
    public function inSlice():stdgo.Slice<stdgo.Ref<stdgo.internal.abi.Abi.Type_>> return funcType.inSlice();
    @:embedded
    public function interfaceType():stdgo.Ref<stdgo.internal.abi.Abi.InterfaceType> return funcType.interfaceType();
    @:embedded
    ...
    @:embedded
    public function key():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return funcType.key();
    @:embedded
    public function kind():stdgo.internal.abi.Abi.Kind return funcType.kind();
    @:embedded
    public function len():stdgo.GoInt return funcType.len();
    @:embedded
    public function mapType():stdgo.Ref<stdgo.internal.abi.Abi.MapType> return funcType.mapType();
    @:embedded
    ...
    @:embedded
    public function out(_i:stdgo.GoInt):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return funcType.out(_i);
    @:embedded
    public function outSlice():stdgo.Slice<stdgo.Ref<stdgo.internal.abi.Abi.Type_>> return funcType.outSlice();
    @:embedded
    public function pointers():Bool return funcType.pointers();
    @:embedded
    public function size():stdgo.GoUIntptr return funcType.size();
    @:embedded
    public function structType():stdgo.Ref<stdgo.internal.abi.Abi.StructType> return funcType.structType();
    @:embedded
    public function uncommon():stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return funcType.uncommon();
    public function __copy__() {
        return new T_uncommon_44___localname___u(funcType, _u);
    }
}
/**
...
@:structInit class T_uncommon_45___localname___u {
    ...
    @:embedded
    public function arrayType():stdgo.Ref<stdgo.internal.abi.Abi.ArrayType> return sliceType.arrayType();
    @:embedded
    public function chanDir():stdgo.internal.abi.Abi.ChanDir return sliceType.chanDir();
    @:embedded
    public function common():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return sliceType.common();
    @:embedded
    ...
    @:embedded
    public function funcType():stdgo.Ref<stdgo.internal.abi.Abi.FuncType> return sliceType.funcType();
    @:embedded
    ...
    @:embedded
    public function interfaceType():stdgo.Ref<stdgo.internal.abi.Abi.InterfaceType> return sliceType.interfaceType();
    @:embedded
    public function isDirectIface():Bool return sliceType.isDirectIface();
    @:embedded
    public function key():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return sliceType.key();
    @:embedded
    ...
    @:embedded
    public function mapType():stdgo.Ref<stdgo.internal.abi.Abi.MapType> return sliceType.mapType();
    @:embedded
    ...
    @:embedded
    public function structType():stdgo.Ref<stdgo.internal.abi.Abi.StructType> return sliceType.structType();
    @:embedded
    public function uncommon():stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return sliceType.uncommon();
    public function __copy__() {
        return new T_uncommon_45___localname___u(sliceType, _u);
    }
}
/**
...
@:structInit class T_uncommon_46___localname___u {
    ...
    @:embedded
    public function common():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return arrayType.common();
    @:embedded
    ...
    @:embedded
    public function funcType():stdgo.Ref<stdgo.internal.abi.Abi.FuncType> return arrayType.funcType();
    @:embedded
    ...
    @:embedded
    public function interfaceType():stdgo.Ref<stdgo.internal.abi.Abi.InterfaceType> return arrayType.interfaceType();
    @:embedded
    public function isDirectIface():Bool return arrayType.isDirectIface();
    @:embedded
    public function key():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return arrayType.key();
    @:embedded
    public function kind():stdgo.internal.abi.Abi.Kind return arrayType.kind();
    @:embedded
    public function mapType():stdgo.Ref<stdgo.internal.abi.Abi.MapType> return arrayType.mapType();
    @:embedded
    ...
    @:embedded
    public function structType():stdgo.Ref<stdgo.internal.abi.Abi.StructType> return arrayType.structType();
    @:embedded
    public function uncommon():stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return arrayType.uncommon();
    public function __copy__() {
        return new T_uncommon_46___localname___u(arrayType, _u);
    }
}
/**
...
**/
@:structInit class T_uncommon_47___localname___u {
    @:embedded
    ...
    @:embedded
    public function arrayType():stdgo.Ref<stdgo.internal.abi.Abi.ArrayType> return chanType.arrayType();
    @:embedded
    public function chanDir():stdgo.internal.abi.Abi.ChanDir return chanType.chanDir();
    @:embedded
    public function common():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return chanType.common();
    @:embedded
    ...
    @:embedded
    public function funcType():stdgo.Ref<stdgo.internal.abi.Abi.FuncType> return chanType.funcType();
    @:embedded
    ...
    @:embedded
    public function interfaceType():stdgo.Ref<stdgo.internal.abi.Abi.InterfaceType> return chanType.interfaceType();
    @:embedded
    public function isDirectIface():Bool return chanType.isDirectIface();
    @:embedded
    public function key():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return chanType.key();
    @:embedded
    public function kind():stdgo.internal.abi.Abi.Kind return chanType.kind();
    @:embedded
    public function len():stdgo.GoInt return chanType.len();
    @:embedded
    public function mapType():stdgo.Ref<stdgo.internal.abi.Abi.MapType> return chanType.mapType();
    @:embedded
    ...
    @:embedded
    public function structType():stdgo.Ref<stdgo.internal.abi.Abi.StructType> return chanType.structType();
    @:embedded
    public function uncommon():stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return chanType.uncommon();
    public function __copy__() {
        return new T_uncommon_47___localname___u(chanType, _u);
    }
}
/**
...
**/
@:structInit class T_uncommon_48___localname___u {
    @:embedded
    ...
    @:embedded
    public function arrayType():stdgo.Ref<stdgo.internal.abi.Abi.ArrayType> return mapType.arrayType();
    @:embedded
    public function chanDir():stdgo.internal.abi.Abi.ChanDir return mapType.chanDir();
    @:embedded
    public function common():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return mapType.common();
    @:embedded
    ...
    @:embedded
    public function funcType():stdgo.Ref<stdgo.internal.abi.Abi.FuncType> return mapType.funcType();
    @:embedded
    ...
    @:embedded
    public function interfaceType():stdgo.Ref<stdgo.internal.abi.Abi.InterfaceType> return mapType.interfaceType();
    @:embedded
    ...
    @:embedded
    public function structType():stdgo.Ref<stdgo.internal.abi.Abi.StructType> return mapType.structType();
    @:embedded
    public function uncommon():stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return mapType.uncommon();
    public function __copy__() {
        return new T_uncommon_48___localname___u(mapType, _u);
    }
}
/**
...
@:structInit class T_uncommon_49___localname___u {
    ...
    @:embedded
    public function arrayType():stdgo.Ref<stdgo.internal.abi.Abi.ArrayType> return interfaceType.arrayType();
    @:embedded
    public function chanDir():stdgo.internal.abi.Abi.ChanDir return interfaceType.chanDir();
    @:embedded
    public function common():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return interfaceType.common();
    @:embedded
    public function elem():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return interfaceType.elem();
    @:embedded
    ...
    @:embedded
    public function funcType():stdgo.Ref<stdgo.internal.abi.Abi.FuncType> return interfaceType.funcType();
    @:embedded
    ...
    @:embedded
    public function key():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return interfaceType.key();
    @:embedded
    ...
    @:embedded
    public function mapType():stdgo.Ref<stdgo.internal.abi.Abi.MapType> return interfaceType.mapType();
    @:embedded
    ...
    @:embedded
    public function structType():stdgo.Ref<stdgo.internal.abi.Abi.StructType> return interfaceType.structType();
    @:embedded
    public function uncommon():stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return interfaceType.uncommon();
    public function __copy__() {
        return new T_uncommon_49___localname___u(interfaceType, _u);
    }
}
/**
...
**/
@:structInit class T_uncommon_50___localname___u {
    @:embedded
    public var type : stdgo.internal.abi.Abi.Type_ = ({} : stdgo.internal.abi.Abi.Type_);
    public var _u : stdgo.internal.abi.Abi.UncommonType = ({} : stdgo.internal.abi.Abi.UncommonType);
    ...
    public function uncommon():stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return type.uncommon();
    public function __copy__() {
        return new T_uncommon_50___localname___u(type, _u);
    }
}
...
@:keep @:allow(stdgo.internal.abi.Abi.UncommonType_asInterface) class UncommonType_static_extension {
    ...
    static public function methods( _t:stdgo.Ref<UncommonType>):stdgo.Slice<Method> {
        ...
        return ((_addChecked((stdgo.Go.toInterface(_t) : stdgo.unsafe.Unsafe.UnsafePointer), (_t.moff : stdgo.GoUIntptr), ("t.mcount > 0" : stdgo.GoString)).__convert__(stdgo.internal.reflect.Reflect.GoType.refType({ get : () -> stdgo.internal.reflect.Reflect.GoType.arrayType({ get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.Method", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "name", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }, { name : "mtyp", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TypeOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }, { name : "ifn", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TextOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }, { name : "tfn", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TextOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) }, 65536) })) : stdgo.Ref<stdgo.GoArray<Method>>).__slice__(0, _t.mcount, _t.mcount) : stdgo.Slice<stdgo.internal.abi.Abi.Method>);
    }
}
class ArrayType_asInterface {
    @:embedded
    public dynamic function uncommon():stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return __self__.value.uncommon();
    @:embedded
    public dynamic function structType():stdgo.Ref<stdgo.internal.abi.Abi.StructType> return __self__.value.structType();
    @:embedded
    public dynamic function size():stdgo.GoUIntptr return __self__.value.size();
    @:embedded
    public dynamic function pointers():Bool return __self__.value.pointers();
    ...
    public dynamic function numMethod():stdgo.GoInt return __self__.value.numMethod();
    @:embedded
    public dynamic function mapType():stdgo.Ref<stdgo.internal.abi.Abi.MapType> return __self__.value.mapType();
    @:embedded
    public dynamic function kind():stdgo.internal.abi.Abi.Kind return __self__.value.kind();
    @:embedded
    public dynamic function key():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.value.key();
    @:embedded
    public dynamic function isDirectIface():Bool return __self__.value.isDirectIface();
    @:embedded
    public dynamic function interfaceType():stdgo.Ref<stdgo.internal.abi.Abi.InterfaceType> return __self__.value.interfaceType();
    @:embedded
    public dynamic function ifaceIndir():Bool return __self__.value.ifaceIndir();
    @:embedded
    public dynamic function hasName():Bool return __self__.value.hasName();
    ...
    @:embedded
    public dynamic function funcType():stdgo.Ref<stdgo.internal.abi.Abi.FuncType> return __self__.value.funcType();
    @:embedded
    public dynamic function fieldAlign():stdgo.GoInt return __self__.value.fieldAlign();
    @:embedded
    public dynamic function exportedMethods():stdgo.Slice<stdgo.internal.abi.Abi.Method> return __self__.value.exportedMethods();
    @:embedded
    public dynamic function common():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.value.common();
    @:embedded
    public dynamic function chanDir():stdgo.internal.abi.Abi.ChanDir return __self__.value.chanDir();
    @:embedded
    public dynamic function arrayType():stdgo.Ref<stdgo.internal.abi.Abi.ArrayType> return __self__.value.arrayType();
    @:embedded
    public dynamic function align():stdgo.GoInt return __self__.value.align();
    public function new(__self__, __type__) {
        this.__self__ = __self__;
...
@:keep @:allow(stdgo.internal.abi.Abi.ArrayType_asInterface) class ArrayType_static_extension {
    @:embedded
    public static function uncommon( __self__:ArrayType):stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return __self__.uncommon();
    @:embedded
    public static function structType( __self__:ArrayType):stdgo.Ref<stdgo.internal.abi.Abi.StructType> return __self__.structType();
    @:embedded
    ...
    @:embedded
    public static function mapType( __self__:ArrayType):stdgo.Ref<stdgo.internal.abi.Abi.MapType> return __self__.mapType();
    @:embedded
    public static function kind( __self__:ArrayType):stdgo.internal.abi.Abi.Kind return __self__.kind();
    @:embedded
    public static function key( __self__:ArrayType):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.key();
    @:embedded
    public static function isDirectIface( __self__:ArrayType):Bool return __self__.isDirectIface();
    @:embedded
    public static function interfaceType( __self__:ArrayType):stdgo.Ref<stdgo.internal.abi.Abi.InterfaceType> return __self__.interfaceType();
    @:embedded
    ...
    @:embedded
    public static function funcType( __self__:ArrayType):stdgo.Ref<stdgo.internal.abi.Abi.FuncType> return __self__.funcType();
    @:embedded
    ...
    @:embedded
    public static function common( __self__:ArrayType):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.common();
    @:embedded
    public static function chanDir( __self__:ArrayType):stdgo.internal.abi.Abi.ChanDir return __self__.chanDir();
    @:embedded
    public static function arrayType( __self__:ArrayType):stdgo.Ref<stdgo.internal.abi.Abi.ArrayType> return __self__.arrayType();
    @:embedded
...
@:keep @:allow(stdgo.internal.abi.Abi.ChanType_asInterface) class ChanType_static_extension {
    @:embedded
    public static function uncommon( __self__:ChanType):stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return __self__.uncommon();
    @:embedded
    public static function structType( __self__:ChanType):stdgo.Ref<stdgo.internal.abi.Abi.StructType> return __self__.structType();
    @:embedded
    ...
    @:embedded
    public static function mapType( __self__:ChanType):stdgo.Ref<stdgo.internal.abi.Abi.MapType> return __self__.mapType();
    @:embedded
    ...
    @:embedded
    public static function key( __self__:ChanType):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.key();
    @:embedded
    public static function isDirectIface( __self__:ChanType):Bool return __self__.isDirectIface();
    @:embedded
    public static function interfaceType( __self__:ChanType):stdgo.Ref<stdgo.internal.abi.Abi.InterfaceType> return __self__.interfaceType();
    @:embedded
    ...
    @:embedded
    public static function funcType( __self__:ChanType):stdgo.Ref<stdgo.internal.abi.Abi.FuncType> return __self__.funcType();
    @:embedded
    ...
    @:embedded
    public static function common( __self__:ChanType):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.common();
    @:embedded
    public static function chanDir( __self__:ChanType):stdgo.internal.abi.Abi.ChanDir return __self__.chanDir();
    @:embedded
    public static function arrayType( __self__:ChanType):stdgo.Ref<stdgo.internal.abi.Abi.ArrayType> return __self__.arrayType();
    @:embedded
...
class T_structTypeUncommon_asInterface {
    ...
    public dynamic function exportedMethods():stdgo.Slice<stdgo.internal.abi.Abi.Method> return __self__.value.exportedMethods();
    @:embedded
    public dynamic function elem():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.value.elem();
    @:embedded
    public dynamic function common():stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.value.common();
    @:embedded
    public dynamic function chanDir():stdgo.internal.abi.Abi.ChanDir return __self__.value.chanDir();
...
@:keep @:allow(stdgo.internal.abi.Abi.T_structTypeUncommon_asInterface) class T_structTypeUncommon_static_extension {
    @:embedded
    public static function uncommon( __self__:T_structTypeUncommon):stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return __self__.uncommon();
    @:embedded
    ...
    @:embedded
    public static function mapType( __self__:T_structTypeUncommon):stdgo.Ref<stdgo.internal.abi.Abi.MapType> return __self__.mapType();
    @:embedded
    ...
    @:embedded
    public static function key( __self__:T_structTypeUncommon):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.key();
    @:embedded
    public static function isDirectIface( __self__:T_structTypeUncommon):Bool return __self__.isDirectIface();
    @:embedded
    public static function interfaceType( __self__:T_structTypeUncommon):stdgo.Ref<stdgo.internal.abi.Abi.InterfaceType> return __self__.interfaceType();
    @:embedded
    ...
    @:embedded
    public static function funcType( __self__:T_structTypeUncommon):stdgo.Ref<stdgo.internal.abi.Abi.FuncType> return __self__.funcType();
    @:embedded
    ...
    @:embedded
    public static function elem( __self__:T_structTypeUncommon):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.elem();
    @:embedded
    public static function common( __self__:T_structTypeUncommon):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.common();
    @:embedded
    public static function chanDir( __self__:T_structTypeUncommon):stdgo.internal.abi.Abi.ChanDir return __self__.chanDir();
    @:embedded
    public static function arrayType( __self__:T_structTypeUncommon):stdgo.Ref<stdgo.internal.abi.Abi.ArrayType> return __self__.arrayType();
    @:embedded
...
@:keep @:allow(stdgo.internal.abi.Abi.InterfaceType_asInterface) class InterfaceType_static_extension {
    ...
    **/
    ...
    @:embedded
    public static function uncommon( __self__:InterfaceType):stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return __self__.uncommon();
    @:embedded
    public static function structType( __self__:InterfaceType):stdgo.Ref<stdgo.internal.abi.Abi.StructType> return __self__.structType();
    @:embedded
    ...
    @:embedded
    public static function mapType( __self__:InterfaceType):stdgo.Ref<stdgo.internal.abi.Abi.MapType> return __self__.mapType();
    @:embedded
    ...
    @:embedded
    public static function key( __self__:InterfaceType):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.key();
    @:embedded
    public static function isDirectIface( __self__:InterfaceType):Bool return __self__.isDirectIface();
    @:embedded
    public static function interfaceType( __self__:InterfaceType):stdgo.Ref<stdgo.internal.abi.Abi.InterfaceType> return __self__.interfaceType();
    @:embedded
    ...
    @:embedded
    public static function funcType( __self__:InterfaceType):stdgo.Ref<stdgo.internal.abi.Abi.FuncType> return __self__.funcType();
    @:embedded
    ...
    @:embedded
    public static function elem( __self__:InterfaceType):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.elem();
    @:embedded
    public static function common( __self__:InterfaceType):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.common();
    @:embedded
    public static function chanDir( __self__:InterfaceType):stdgo.internal.abi.Abi.ChanDir return __self__.chanDir();
    @:embedded
    public static function arrayType( __self__:InterfaceType):stdgo.Ref<stdgo.internal.abi.Abi.ArrayType> return __self__.arrayType();
    @:embedded
...
@:keep @:allow(stdgo.internal.abi.Abi.MapType_asInterface) class MapType_static_extension {
    ...
    static public function hashMightPanic( _mt:stdgo.Ref<MapType>):Bool {
        ...
        return _mt.flags & (16u32 : stdgo.GoUInt32) != ((0u32 : stdgo.GoUInt32));
    }
    @:keep
    static public function needKeyUpdate( _mt:stdgo.Ref<MapType>):Bool {
        @:recv var _mt:stdgo.Ref<MapType> = _mt;
        return _mt.flags & (8u32 : stdgo.GoUInt32) != ((0u32 : stdgo.GoUInt32));
    }
    @:keep
    static public function reflexiveKey( _mt:stdgo.Ref<MapType>):Bool {
        @:recv var _mt:stdgo.Ref<MapType> = _mt;
        return _mt.flags & (4u32 : stdgo.GoUInt32) != ((0u32 : stdgo.GoUInt32));
    }
    @:keep
    static public function indirectElem( _mt:stdgo.Ref<MapType>):Bool {
        @:recv var _mt:stdgo.Ref<MapType> = _mt;
        return _mt.flags & (2u32 : stdgo.GoUInt32) != ((0u32 : stdgo.GoUInt32));
    }
    /**
        // Note: flag values must match those used in the TMAP case
        // in ../cmd/compile/internal/reflectdata/reflect.go:writeType.
    **/
    ...
    static public function indirectKey( _mt:stdgo.Ref<MapType>):Bool {
        @:recv var _mt:stdgo.Ref<MapType> = _mt;
        return _mt.flags & (1u32 : stdgo.GoUInt32) != ((0u32 : stdgo.GoUInt32));
    }
    @:embedded
    public static function uncommon( __self__:MapType):stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return __self__.uncommon();
    @:embedded
    public static function structType( __self__:MapType):stdgo.Ref<stdgo.internal.abi.Abi.StructType> return __self__.structType();
    @:embedded
    ...
    @:embedded
    public static function mapType( __self__:MapType):stdgo.Ref<stdgo.internal.abi.Abi.MapType> return __self__.mapType();
    @:embedded
    ...
    @:embedded
    public static function interfaceType( __self__:MapType):stdgo.Ref<stdgo.internal.abi.Abi.InterfaceType> return __self__.interfaceType();
    @:embedded
    ...
    @:embedded
    public static function funcType( __self__:MapType):stdgo.Ref<stdgo.internal.abi.Abi.FuncType> return __self__.funcType();
    @:embedded
    ...
    @:embedded
    public static function common( __self__:MapType):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.common();
    @:embedded
    public static function chanDir( __self__:MapType):stdgo.internal.abi.Abi.ChanDir return __self__.chanDir();
    @:embedded
    public static function arrayType( __self__:MapType):stdgo.Ref<stdgo.internal.abi.Abi.ArrayType> return __self__.arrayType();
    @:embedded
...
@:keep @:allow(stdgo.internal.abi.Abi.SliceType_asInterface) class SliceType_static_extension {
    @:embedded
    public static function uncommon( __self__:SliceType):stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return __self__.uncommon();
    @:embedded
    public static function structType( __self__:SliceType):stdgo.Ref<stdgo.internal.abi.Abi.StructType> return __self__.structType();
    @:embedded
    ...
    @:embedded
    public static function mapType( __self__:SliceType):stdgo.Ref<stdgo.internal.abi.Abi.MapType> return __self__.mapType();
    @:embedded
    ...
    @:embedded
    public static function key( __self__:SliceType):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.key();
    @:embedded
    public static function isDirectIface( __self__:SliceType):Bool return __self__.isDirectIface();
    @:embedded
    public static function interfaceType( __self__:SliceType):stdgo.Ref<stdgo.internal.abi.Abi.InterfaceType> return __self__.interfaceType();
    @:embedded
    ...
    @:embedded
    public static function funcType( __self__:SliceType):stdgo.Ref<stdgo.internal.abi.Abi.FuncType> return __self__.funcType();
    @:embedded
    ...
    @:embedded
    public static function common( __self__:SliceType):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.common();
    @:embedded
    public static function chanDir( __self__:SliceType):stdgo.internal.abi.Abi.ChanDir return __self__.chanDir();
    @:embedded
    public static function arrayType( __self__:SliceType):stdgo.Ref<stdgo.internal.abi.Abi.ArrayType> return __self__.arrayType();
    @:embedded
...
@:keep @:allow(stdgo.internal.abi.Abi.FuncType_asInterface) class FuncType_static_extension {
    ...
    static public function isVariadic( _t:stdgo.Ref<FuncType>):Bool {
        ...
        return _t.outCount & (32768 : stdgo.GoUInt16) != ((0 : stdgo.GoUInt16));
    }
    @:keep
    static public function outSlice( _t:stdgo.Ref<FuncType>):stdgo.Slice<stdgo.Ref<Type_>> {
        @:recv var _t:stdgo.Ref<FuncType> = _t;
        var _outCount:stdgo.GoUInt16 = (_t.numOut() : stdgo.GoUInt16);
        if (_outCount == ((0 : stdgo.GoUInt16))) {
            return (null : stdgo.Slice<stdgo.Ref<stdgo.internal.abi.Abi.Type_>>);
        };
        var _uadd:stdgo.GoUIntptr = stdgo.unsafe.Unsafe.sizeof(stdgo.Go.toInterface((_t : stdgo.internal.abi.Abi.FuncType)));
...
{ name : "gcdata", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) }) }, optional : false },
{ name : "str", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false },
{ name : "ptrToThis", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TypeOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) }) }, 131072) })) : stdgo.Ref<stdgo.GoArray<stdgo.Ref<Type_>>>).__slice__(_t.inCount, _t.inCount + _outCount, _t.inCount + _outCount) : stdgo.Slice<stdgo.Ref<stdgo.internal.abi.Abi.Type_>>);
    }
    @:keep
...
{ name : "gcdata", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) }) }, optional : false },
{ name : "str", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.NameOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false },
{ name : "ptrToThis", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.internal.abi.Abi.TypeOff", [], stdgo.internal.reflect.Reflect.GoType.basic(int32_kind), false, { get : () -> null }) }, optional : false }]), false, { get : () -> null }) }) }, 65536) })) : stdgo.Ref<stdgo.GoArray<stdgo.Ref<Type_>>>).__slice__(0, _t.inCount, _t.inCount) : stdgo.Slice<stdgo.Ref<stdgo.internal.abi.Abi.Type_>>);
    }
    @:keep
    ...
    static public function numOut( _t:stdgo.Ref<FuncType>):stdgo.GoInt {
        @:recv var _t:stdgo.Ref<FuncType> = _t;
        return (_t.outCount & (32767 : stdgo.GoUInt16) : stdgo.GoInt);
    }
    @:keep
    ...
    @:embedded
    public static function uncommon( __self__:FuncType):stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return __self__.uncommon();
    @:embedded
    public static function structType( __self__:FuncType):stdgo.Ref<stdgo.internal.abi.Abi.StructType> return __self__.structType();
    @:embedded
    ...
    @:embedded
    public static function mapType( __self__:FuncType):stdgo.Ref<stdgo.internal.abi.Abi.MapType> return __self__.mapType();
    @:embedded
    ...
    @:embedded
    public static function key( __self__:FuncType):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.key();
    @:embedded
    public static function isDirectIface( __self__:FuncType):Bool return __self__.isDirectIface();
    @:embedded
    public static function interfaceType( __self__:FuncType):stdgo.Ref<stdgo.internal.abi.Abi.InterfaceType> return __self__.interfaceType();
    @:embedded
    ...
    @:embedded
    public static function funcType( __self__:FuncType):stdgo.Ref<stdgo.internal.abi.Abi.FuncType> return __self__.funcType();
    @:embedded
    ...
    @:embedded
    public static function elem( __self__:FuncType):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.elem();
    @:embedded
    public static function common( __self__:FuncType):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.common();
    @:embedded
    public static function chanDir( __self__:FuncType):stdgo.internal.abi.Abi.ChanDir return __self__.chanDir();
    @:embedded
    public static function arrayType( __self__:FuncType):stdgo.Ref<stdgo.internal.abi.Abi.ArrayType> return __self__.arrayType();
    @:embedded
...
@:keep @:allow(stdgo.internal.abi.Abi.PtrType_asInterface) class PtrType_static_extension {
    @:embedded
    public static function uncommon( __self__:PtrType):stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return __self__.uncommon();
    @:embedded
    public static function structType( __self__:PtrType):stdgo.Ref<stdgo.internal.abi.Abi.StructType> return __self__.structType();
    @:embedded
    ...
    @:embedded
    public static function mapType( __self__:PtrType):stdgo.Ref<stdgo.internal.abi.Abi.MapType> return __self__.mapType();
    @:embedded
    ...
    @:embedded
    public static function key( __self__:PtrType):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.key();
    @:embedded
    public static function isDirectIface( __self__:PtrType):Bool return __self__.isDirectIface();
    @:embedded
    public static function interfaceType( __self__:PtrType):stdgo.Ref<stdgo.internal.abi.Abi.InterfaceType> return __self__.interfaceType();
    @:embedded
    ...
    @:embedded
    public static function funcType( __self__:PtrType):stdgo.Ref<stdgo.internal.abi.Abi.FuncType> return __self__.funcType();
    @:embedded
    ...
    @:embedded
    public static function common( __self__:PtrType):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.common();
    @:embedded
    public static function chanDir( __self__:PtrType):stdgo.internal.abi.Abi.ChanDir return __self__.chanDir();
    @:embedded
    public static function arrayType( __self__:PtrType):stdgo.Ref<stdgo.internal.abi.Abi.ArrayType> return __self__.arrayType();
    @:embedded
...
@:keep @:allow(stdgo.internal.abi.Abi.StructType_asInterface) class StructType_static_extension {
    @:embedded
    public static function uncommon( __self__:StructType):stdgo.Ref<stdgo.internal.abi.Abi.UncommonType> return __self__.uncommon();
    @:embedded
    public static function structType( __self__:StructType):stdgo.Ref<stdgo.internal.abi.Abi.StructType> return __self__.structType();
    @:embedded
    ...
    @:embedded
    public static function mapType( __self__:StructType):stdgo.Ref<stdgo.internal.abi.Abi.MapType> return __self__.mapType();
    @:embedded
    ...
    @:embedded
    public static function key( __self__:StructType):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.key();
    @:embedded
    public static function isDirectIface( __self__:StructType):Bool return __self__.isDirectIface();
    @:embedded
    public static function interfaceType( __self__:StructType):stdgo.Ref<stdgo.internal.abi.Abi.InterfaceType> return __self__.interfaceType();
    @:embedded
    ...
    @:embedded
    public static function funcType( __self__:StructType):stdgo.Ref<stdgo.internal.abi.Abi.FuncType> return __self__.funcType();
    @:embedded
    ...
    @:embedded
    public static function elem( __self__:StructType):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.elem();
    @:embedded
    public static function common( __self__:StructType):stdgo.Ref<stdgo.internal.abi.Abi.Type_> return __self__.common();
    @:embedded
    public static function chanDir( __self__:StructType):stdgo.internal.abi.Abi.ChanDir return __self__.chanDir();
    @:embedded
    public static function arrayType( __self__:StructType):stdgo.Ref<stdgo.internal.abi.Abi.ArrayType> return __self__.arrayType();
    @:embedded
...
@:keep @:allow(stdgo.internal.abi.Abi.Name_asInterface) class Name_static_extension {
    ...
    **/
    ...
    static public function tag( _n:Name):stdgo.GoString {
        ...
        var __tmp__ = _n.readVarint(((1 : stdgo.GoInt) + _i) + _l), _i2:stdgo.GoInt = __tmp__._0, _l2:stdgo.GoInt = __tmp__._1;
        return _unsafeStringFor(_n.dataChecked((((1 : stdgo.GoInt) + _i) + _l) + _i2, ("non-empty string" : stdgo.GoString)), _l2)?.__copy__();
    }
    /**
        // Name returns the tag string for n, or empty if there is none.
    **/
    ...
    static public function name( _n:Name):stdgo.GoString {
        ...
        var __tmp__ = _n.readVarint((1 : stdgo.GoInt)), _i:stdgo.GoInt = __tmp__._0, _l:stdgo.GoInt = __tmp__._1;
        return _unsafeStringFor(_n.dataChecked((1 : stdgo.GoInt) + _i, ("non-empty string" : stdgo.GoString)), _l)?.__copy__();
    }
    /**
        // IsBlank indicates whether n is "_".
    **/
    ...
    static public function isBlank( _n:Name):Bool {
        ...
        return (_l == (1 : stdgo.GoInt)) && (_n.data((2 : stdgo.GoInt)).value == (95 : stdgo.GoUInt8));
    }
    /**
        // ReadVarint parses a varint as encoded by encoding/binary.
        // It returns the number of encoded bytes and the encoded value.
    **/
    ...
    static public function readVarint( _n:Name, _off:stdgo.GoInt):{ var _0 : stdgo.GoInt; var _1 : stdgo.GoInt; } {
        ...
        var _v:stdgo.GoInt = (0 : stdgo.GoInt);
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(true, _i++, {
                var _x:stdgo.GoUInt8 = _n.dataChecked(_off + _i, ("read varint" : stdgo.GoString)).value;
                _v = _v + ((_x & (127 : stdgo.GoUInt8) : stdgo.GoInt) << ((7 : stdgo.GoInt) * _i));
                if (_x & (128 : stdgo.GoUInt8) == ((0 : stdgo.GoUInt8))) {
                    return { _0 : _i + (1 : stdgo.GoInt), _1 : _v };
                };
            });
        };
    }
    ...
    **/
    ...
    static public function isEmbedded( _n:Name):Bool {
        @:recv var _n:Name = _n?.__copy__();
        return (_n.bytes.value) & (8 : stdgo.GoUInt8) != ((0 : stdgo.GoUInt8));
    }
    /**
        // HasTag returns true iff there is tag data following this name
    **/
    ...
    static public function hasTag( _n:Name):Bool {
        @:recv var _n:Name = _n?.__copy__();
        return (_n.bytes.value) & (2 : stdgo.GoUInt8) != ((0 : stdgo.GoUInt8));
    }
    /**
        // IsExported returns "is n exported?"
    **/
    ...
    static public function isExported( _n:Name):Bool {
        @:recv var _n:Name = _n?.__copy__();
        return (_n.bytes.value) & (1 : stdgo.GoUInt8) != ((0 : stdgo.GoUInt8));
    }
    /**
        // Data does pointer arithmetic on n's Bytes, and that arithmetic is asserted to
        // be safe because the runtime made the call (other packages use DataChecked)
    **/
    ...
    static public function data( _n:Name, _off:stdgo.GoInt):stdgo.Pointer<stdgo.GoByte> {
        @:recv var _n:Name = _n?.__copy__();
        return (_addChecked((stdgo.Go.toInterface(_n.bytes) : stdgo.unsafe.Unsafe.UnsafePointer), (_off : stdgo.GoUIntptr), ("the runtime doesn\'t need to give you a reason" : stdgo.GoString)).__convert__(stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) })) : stdgo.Pointer<stdgo.GoByte>);
    }
    /**
        // DataChecked does pointer arithmetic on n's Bytes, and that arithmetic is asserted to
        // be safe for the reason in whySafe (which can appear in a backtrace, etc.)
    **/
    ...
    static public function dataChecked( _n:Name, _off:stdgo.GoInt, _whySafe:stdgo.GoString):stdgo.Pointer<stdgo.GoByte> {
        @:recv var _n:Name = _n?.__copy__();
        return (_addChecked((stdgo.Go.toInterface(_n.bytes) : stdgo.unsafe.Unsafe.UnsafePointer), (_off : stdgo.GoUIntptr), _whySafe?.__copy__()).__convert__(stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) })) : stdgo.Pointer<stdgo.GoByte>);
    }
}
...
@:keep @:allow(stdgo.internal.abi.Abi.IntArgRegBitmap_asInterface) class IntArgRegBitmap_static_extension {
    ...
    **/
    ...
    static public function get( _b:stdgo.Ref<IntArgRegBitmap>, _i:stdgo.GoInt):Bool {
        ...
        return _b[(_i / (8 : stdgo.GoInt) : stdgo.GoInt)] & (((1 : stdgo.GoUInt8) : stdgo.GoUInt8) << (_i % (8 : stdgo.GoInt))) != ((0 : stdgo.GoUInt8));
    }
    /**
        // Set sets the i'th bit of the bitmap to 1.
    **/
    ...
    static public function set( _b:stdgo.Ref<IntArgRegBitmap>, _i:stdgo.GoInt):Void {
        @:recv var _b:stdgo.Ref<IntArgRegBitmap> = _b;
        _b[(_i / (8 : stdgo.GoInt) : stdgo.GoInt)] = _b[(_i / (8 : stdgo.GoInt) : stdgo.GoInt)] | (((1 : stdgo.GoUInt8) : stdgo.GoUInt8) << (_i % (8 : stdgo.GoInt)));
    }
}
...
@:keep @:allow(stdgo.internal.abi.Abi.Kind_asInterface) class Kind_static_extension {
    ...
    **/
    ...
    static public function string( _k:Kind):stdgo.GoString {
        @:recv var _k:Kind = _k;
        if ((_k : stdgo.GoInt) < (_kindNames.length)) {
