...
**/
inline function printMarker(w:Writer, h:haxe.UInt64):stdgo.Error throw "not implemented";
/**
...
**/
inline function marker(id:haxe.UInt64):String throw "not implemented";
/**
    // AppendMarker is like [Marker] but appends the marker to dst.
**/
inline function appendMarker(dst:Array<Int>, id:haxe.UInt64):Array<Int> throw "not implemented";
/**
...
**/
inline function cutMarker(line:String):stdgo.Tuple.Tuple3<String, haxe.UInt64, Bool> throw "not implemented";
/**
...
**/
inline function hash(data:haxe.Rest<stdgo.AnyInterface>):haxe.UInt64 throw "not implemented";
