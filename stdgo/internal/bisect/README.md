...
- [class Bisect](<#class-bisect>)

  - [`function appendMarker(_dst:Array<UInt>, _id:haxe.UInt64):Array<UInt>`](<#bisect-function-appendmarker>)

  - [`function cutMarker(_line:String):stdgo.Tuple3<String, haxe.UInt64, Bool>`](<#bisect-function-cutmarker>)

  - [`function hash(_data:haxe.Rest<stdgo.AnyInterface>):haxe.UInt64`](<#bisect-function-hash>)

  - [`function marker(_id:haxe.UInt64):String`](<#bisect-function-marker>)

  - [`function new_(_pattern:String):stdgo.Tuple<stdgo.internal.bisect.Matcher, stdgo.Error>`](<#bisect-function-new_>)

  - [`function printMarker(_w:stdgo.internal.bisect.Writer, _h:haxe.UInt64):stdgo.Error`](<#bisect-function-printmarker>)

- [typedef Writer](<#typedef-writer>)

- [abstract Matcher](<#abstract-matcher>)

- [abstract T\_atomicPointerDedup](<#abstract-t_atomicpointerdedup>)

- [abstract T\_cond](<#abstract-t_cond>)

- [abstract T\_parseError](<#abstract-t_parseerror>)

- [abstract T\_dedup](<#abstract-t_dedup>)
...
### Bisect function appendMarker


```haxe
function appendMarker(_dst:Array<UInt>, _id:haxe.UInt64):Array<UInt>
```
...
[\(view code\)](<./Bisect.hx#L371>)


### Bisect function cutMarker


```haxe
function cutMarker(_line:String):stdgo.Tuple3<String, haxe.UInt64, Bool>
```
...
```
[\(view code\)](<./Bisect.hx#L382>)


### Bisect function hash


```haxe
function hash(_data:haxe.Rest<stdgo.AnyInterface>):haxe.UInt64
```
...
```
[\(view code\)](<./Bisect.hx#L392>)


### Bisect function marker


```haxe
function marker(_id:haxe.UInt64):String
```
...
### Bisect function new\_


```haxe
function new_(_pattern:String):stdgo.Tuple<stdgo.internal.bisect.Matcher, stdgo.Error>
```
...
[\(view code\)](<./Bisect.hx#L347>)


### Bisect function printMarker


```haxe
function printMarker(_w:stdgo.internal.bisect.Writer, _h:haxe.UInt64):stdgo.Error
```
...
[\(view file containing code\)](<./Bisect.hx>)


## abstract T\_atomicPointerDedup
