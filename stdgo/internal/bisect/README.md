...
- [class Bisect](<#class-bisect>)
  ...
  - [`function appendMarker(_dst:Array<Int>, _id:haxe.UInt64):Array<Int>`](<#bisect-function-appendmarker>)
...
```haxe
function appendMarker(_dst:Array<Int>, _id:haxe.UInt64):Array<Int>
```
