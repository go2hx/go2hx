...
**/
private final _offsetX86HasSSE42:GoUIntptr = stdgo.unsafe.Unsafe.offsetof_(Go.toInterface(stdgo.internal.cpu.Cpu.x86.hasSSE42));

/**
	// Offsets into internal/cpu records for use in assembly.
**/
private final _offsetX86HasAVX2:GoUIntptr = stdgo.unsafe.Unsafe.offsetof_(Go.toInterface(stdgo.internal.cpu.Cpu.x86.hasAVX2));

/**
	// Offsets into internal/cpu records for use in assembly.
**/
private final _offsetX86HasPOPCNT:GoUIntptr = stdgo.unsafe.Unsafe.offsetof_(Go.toInterface(stdgo.internal.cpu.Cpu.x86.hasPOPCNT));

/**
	// Offsets into internal/cpu records for use in assembly.
**/
private final _offsetS390xHasVX:GoUIntptr = stdgo.unsafe.Unsafe.offsetof_(Go.toInterface(stdgo.internal.cpu.Cpu.s390x.hasVX));

/**
	// Offsets into internal/cpu records for use in assembly.
**/
private final _offsetPPC64HasPOWER9:GoUIntptr = stdgo.unsafe.Unsafe.offsetof_(Go.toInterface(stdgo.internal.cpu.Cpu.ppc64.isPOWER9));
...
**/
final primeRK:GoUInt64 = ("16777619" : GoUInt64);

final maxBruteForce:GoUInt64 = ("0" : GoUInt64);
...
function hashStrBytes(_sep:Slice<GoByte>):{var _0:GoUInt32; var _1:GoUInt32;} {
	var _hash:GoUInt32 = (("0" : GoUInt32) : GoUInt32);
	{
		...
		Go.cfor(_i < (_sep.length), _i++, {
			_hash = (_hash * (("16777619" : GoUInt32) : GoUInt32)) + (_sep[_i] : GoUInt32);
		});
	};
	var _0:GoUInt32 = ("1" : GoUInt32),
		_1:GoUInt32 = ("16777619" : GoUInt32),
		_sq:GoUInt32 = _1,
		_pow:GoUInt32 = _0;
	{
...
function indexRabinKarpBytes(_s:Slice<GoByte>, _sep:Slice<GoByte>):GoInt {
	var __tmp__ = hashStrBytes(_sep),
		_hashsep:GoUInt32 = __tmp__._0,
