...
/**
    /|*{
    	...
    	if !fieldBreak && (env != "") {
    		...
    		_ = gotoNext == 264550
    		field_264554 = ""
    		i_264568 = indexByte(env, 44)
    		if i_264568 < 0 {
    			gotoNext = 264604
    			_ = gotoNext == 264604
    			field_264554, env = env, ""
    			gotoNext = 264682
    		} else {
    			gotoNext = 264639
    			_ = gotoNext == 264639
    			gotoNext = 264639
    			_ = gotoNext == 264639
    			field_264554, env = env[:i_264568], env[i_264568+1:]
    			_ = 0
    			gotoNext = 264682
    		}
    		_ = gotoNext == 264682
    		if len(field_264554) < 4 || field_264554[:4] != "cpu." {
    			gotoNext = 264723
    			_ = gotoNext == 264723
    			_ = 0
    			gotoNext = 264536
    		...
    		_ = gotoNext == 264743
    		i_264568 = indexByte(field_264554, 61)
    		if i_264568 < 0 {
    			gotoNext = 264780
    			_ = gotoNext == 264780
    			print("GODEBUG: no value specified for \"", field_264554, "\"\n")
    			_ = 0
    			gotoNext = 264536
    			gotoNext = 264862
    		} else {
    		...
    		_ = gotoNext == 264862
    		key_264862, value_264867 = field_264554[4:i_264568], field_264554[i_264568+1:]
    		gotoNext = 264942
    		_ = gotoNext == 264942
    		switch value_264867 {
    		case "on":
    		...
    		default:
    			gotoNext = 265021
    			_ = gotoNext == 265021
    			print("GODEBUG: value \"", value_264867, "\" not supported for cpu option \"", key_264862, "\"\n")
    			gotoNext = 264536
    			gotoNext = 265143
    		}
    		_ = gotoNext == 265143
    		if key_264862 == "all" {
    			...
    			if 0 < len(options) {
    				...
    				gotoNext = 265255
    				_ = gotoNext == 265255
    				if i_265168 < len(options) {
    					gotoNext = 265187
    					_ = gotoNext == 265187
    					options[i_265168].Specified = true
    					options[i_265168].Enable = enable_264928
    					i_265168++
    					gotoNext = 265255
    				} else {
    					gotoNext = 265260
    		...
    		if 0 < len(options) {
    			...
    			gotoNext = 265427
    			_ = gotoNext == 265427
    			if i_265286 < len(options) {
    				gotoNext = 265305
    				_ = gotoNext == 265305
    				if options[i_265286].Name == key_264862 {
    					gotoNext = 265336
    					_ = gotoNext == 265336
    					options[i_265286].Specified = true
    					options[i_265286].Enable = enable_264928
    					gotoNext = 264536
    					gotoNext = 265286
    				} else {
    					gotoNext = 265286
    		...
    		_ = gotoNext == 265432
    		print("GODEBUG: unknown cpu feature \"", key_264862, "\"\n")
    		gotoNext = 264536
    	} else {
    		gotoNext = 265491
    	}
    	...
    	if 0 < len(options) {
    		gotoNext = 265704
    		_ = gotoNext == 265704
    		i_265503_0, o_265498 = 0, options[0]
    		gotoNext = 265705
    		_ = gotoNext == 265705
    		if i_265503_0 < len(options) {
    			gotoNext = 265517
    			_ = gotoNext == 265517
    			o_265498 = options[i_265503_0]
    			if !o_265498.Specified {
    				gotoNext = 265537
    				_ = gotoNext == 265537
    				i_265503_0++
    				gotoNext = 265705
    			...
    			_ = gotoNext == 265558
    			if o_265498.Enable && !*o_265498.Feature {
    				gotoNext = 265585
    				_ = gotoNext == 265585
    				print("GODEBUG: can not enable \"", o_265498.Name, "\", missing CPU support\n")
    				i_265503_0++
    				gotoNext = 265705
    				gotoNext = 265682
    			} else {
    			...
    			_ = gotoNext == 265682
    			*o_265498.Feature = o_265498.Enable
    			i_265503_0++
    			gotoNext = 265705
    		} else {
    			gotoNext = 265707
