...
@:structInit @:using(Dag.Graph_static_extension) abstract Graph(stdgo._internal.internal.dag.Dag_graph.Graph) from stdgo._internal.internal.dag.Dag_graph.Graph to stdgo._internal.internal.dag.Dag_graph.Graph {
...
@:structInit @:using(Dag.T_rule_static_extension) @:dox(hide) abstract T_rule(stdgo._internal.internal.dag.Dag_t_rule.T_rule) from stdgo._internal.internal.dag.Dag_t_rule.T_rule to stdgo._internal.internal.dag.Dag_t_rule.T_rule {
...
@:structInit @:using(Dag.T_rulesParser_static_extension) @:dox(hide) abstract T_rulesParser(stdgo._internal.internal.dag.Dag_t_rulesparser.T_rulesParser) from stdgo._internal.internal.dag.Dag_t_rulesparser.T_rulesParser to stdgo._internal.internal.dag.Dag_t_rulesparser.T_rulesParser {
