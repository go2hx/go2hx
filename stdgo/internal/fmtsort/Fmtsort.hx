...
@:structInit @:using(stdgo.internal.fmtsort.Fmtsort.SortedMap_static_extension) abstract SortedMap(stdgo._internal.internal.fmtsort.Fmtsort.SortedMap) from stdgo._internal.internal.fmtsort.Fmtsort.SortedMap to stdgo._internal.internal.fmtsort.Fmtsort.SortedMap {
