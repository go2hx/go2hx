...
private function _compare(_aVal:stdgo.reflect.Reflect.Value, _bVal:stdgo.reflect.Reflect.Value):GoInt {
        var _0:stdgo.reflect.Reflect.Type = _aVal.type(), _1:stdgo.reflect.Reflect.Type = _bVal.type(), _bType:stdgo.reflect.Reflect.Type = _1, _aType:stdgo.reflect.Reflect.Type = _0;
        if (!((_aType.string() : String) == (_bType.string() : String))) {
            return (-1 : GoInt);
        };
        if (_aVal.kind() == ((("2" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _aVal.kind() == ((("3" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _aVal.kind() == ((("4" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _aVal.kind() == ((("5" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _aVal.kind() == ((("6" : GoUInt) : stdgo.reflect.Reflect.Kind))) {
            var _0:GoInt64 = _aVal.int_(), _1:GoInt64 = _bVal.int_(), _b:GoInt64 = _1, _a:GoInt64 = _0;
            if (_a < _b) {
                return (-1 : GoInt);
            } else if (_a > _b) {
                return (1 : GoInt);
        ...
        } else if (_aVal.kind() == ((("7" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _aVal.kind() == ((("8" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _aVal.kind() == ((("9" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _aVal.kind() == ((("10" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _aVal.kind() == ((("11" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _aVal.kind() == ((("12" : GoUInt) : stdgo.reflect.Reflect.Kind))) {
            var _0:GoUInt64 = _aVal.uint(), _1:GoUInt64 = _bVal.uint(), _b:GoUInt64 = _1, _a:GoUInt64 = _0;
            if (_a < _b) {
                return (-1 : GoInt);
            } else if (_a > _b) {
                return (1 : GoInt);
            ...
            var _0:GoString = (_aVal.string() : GoString), _1:GoString = (_bVal.string() : GoString), _b:GoString = _1, _a:GoString = _0;
            if (_a < _b) {
                return (-1 : GoInt);
            } else if (_a > _b) {
                return (1 : GoInt);
        ...
        } else if (_aVal.kind() == ((("13" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _aVal.kind() == ((("14" : GoUInt) : stdgo.reflect.Reflect.Kind))) {
            return _floatCompare(_aVal.float_(), _bVal.float_());
        } else if (_aVal.kind() == ((("15" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _aVal.kind() == ((("16" : GoUInt) : stdgo.reflect.Reflect.Kind))) {
            var _0:GoComplex128 = _aVal.complex(), _1:GoComplex128 = _bVal.complex(), _b:GoComplex128 = _1, _a:GoComplex128 = _0;
            {
            ...
            var _0:Bool = _aVal.bool_(), _1:Bool = _bVal.bool_(), _b:Bool = _1, _a:Bool = _0;
            if (_a == (_b)) {
                return (0 : GoInt);
            } else if (_a) {
                return (1 : GoInt);
        ...
        } else if (_aVal.kind() == ((("22" : GoUInt) : stdgo.reflect.Reflect.Kind)) || _aVal.kind() == ((("26" : GoUInt) : stdgo.reflect.Reflect.Kind))) {
            var _0:GoUIntptr = _aVal.pointer(), _1:GoUIntptr = _bVal.pointer(), _b:GoUIntptr = _1, _a:GoUIntptr = _0;
            if (_a < _b) {
                return (-1 : GoInt);
            } else if (_a > _b) {
                return (1 : GoInt);
            ...
            {
                var __tmp__ = _nilCompare((_aVal == null ? null : _aVal.__copy__()), (_bVal == null ? null : _bVal.__copy__())), _c:GoInt = __tmp__._0, _ok:Bool = __tmp__._1;
                if (_ok) {
                    return _c;
                };
            };
            var _0:GoUIntptr = _aVal.pointer(), _1:GoUIntptr = _bVal.pointer(), _bp:GoUIntptr = _1, _ap:GoUIntptr = _0;
            if (_ap < _bp) {
                return (-1 : GoInt);
            } else if (_ap > _bp) {
                return (1 : GoInt);
        ...
        } else if (_aVal.kind() == ((("25" : GoUInt) : stdgo.reflect.Reflect.Kind))) {
            {
                ...
                Go.cfor(_i < _aVal.numField(), _i++, {
                    {
                        var _c:GoInt = _compare((_aVal.field(_i) == null ? null : _aVal.field(_i).__copy__()), (_bVal.field(_i) == null ? null : _bVal.field(_i).__copy__()));
                        if (_c != ((0 : GoInt))) {
                            return _c;
                        };
                    };
        ...
        } else if (_aVal.kind() == ((("17" : GoUInt) : stdgo.reflect.Reflect.Kind))) {
            {
                ...
                Go.cfor(_i < _aVal.len(), _i++, {
                    {
                        var _c:GoInt = _compare((_aVal.index(_i) == null ? null : _aVal.index(_i).__copy__()), (_bVal.index(_i) == null ? null : _bVal.index(_i).__copy__()));
                        if (_c != ((0 : GoInt))) {
                            return _c;
                        };
                    };
            ...
            var _c:GoInt = _compare((stdgo.reflect.Reflect.valueOf(Go.toInterface(_aVal.elem().type())) == null ? null : stdgo.reflect.Reflect.valueOf(Go.toInterface(_aVal.elem().type())).__copy__()), (stdgo.reflect.Reflect.valueOf(Go.toInterface(_bVal.elem().type())) == null ? null : stdgo.reflect.Reflect.valueOf(Go.toInterface(_bVal.elem().type())).__copy__()));
            if (_c != ((0 : GoInt))) {
                return _c;
            };
...
@:keep @:allow(stdgo.internal.fmtsort.Fmtsort.SortedMap_asInterface) class SortedMap_static_extension {
    ...
    static public function less( _o:Ref<SortedMap>, _i:GoInt, _j:GoInt):Bool {
        return _compare((_o.key[(_i : GoInt)] == null ? null : _o.key[(_i : GoInt)].__copy__()), (_o.key[(_j : GoInt)] == null ? null : _o.key[(_j : GoInt)].__copy__())) < (0 : GoInt);
    }
    @:keep
