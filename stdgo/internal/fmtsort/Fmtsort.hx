...
function compare(_a:stdgo.reflect.Reflect.Value, _b:stdgo.reflect.Reflect.Value):stdgo.GoInt {
...
**/
function sort(_mapValue:stdgo.reflect.Reflect.Value):stdgo.Ref<SortedMap> {
        if (_mapValue.type().kind() != ((21u32 : stdgo.reflect.Reflect.Kind))) {
            return null;
        };
        var _n:stdgo.GoInt = _mapValue.len();
        var _key = new stdgo.Slice<stdgo.reflect.Reflect.Value>((0 : stdgo.GoInt).toBasic(), _n, ...[for (i in 0 ... ((0 : stdgo.GoInt).toBasic() > _n ? (0 : stdgo.GoInt).toBasic() : _n : stdgo.GoInt).toBasic()) ({} : stdgo.reflect.Reflect.Value)]);
        var _value = new stdgo.Slice<stdgo.reflect.Reflect.Value>((0 : stdgo.GoInt).toBasic(), _n, ...[for (i in 0 ... ((0 : stdgo.GoInt).toBasic() > _n ? (0 : stdgo.GoInt).toBasic() : _n : stdgo.GoInt).toBasic()) ({} : stdgo.reflect.Reflect.Value)]);
        var _iter = _mapValue.mapRange();
        while (_iter.next()) {
            _key = (_key.__append__(_iter.key()?.__copy__()));
            _value = (_value.__append__(_iter.value()?.__copy__()));
        };
        var _sorted = (stdgo.Go.setRef(({ key : _key, value : _value } : stdgo.internal.fmtsort.Fmtsort.SortedMap)) : stdgo.Ref<stdgo.internal.fmtsort.Fmtsort.SortedMap>);
...
**/
function _compare(_aVal:stdgo.reflect.Reflect.Value, _bVal:stdgo.reflect.Reflect.Value):stdgo.GoInt {
        ...
        };
        {
            ...
            if (__value__ == ((2u32 : stdgo.reflect.Reflect.Kind)) || __value__ == ((3u32 : stdgo.reflect.Reflect.Kind)) || __value__ == ((4u32 : stdgo.reflect.Reflect.Kind)) || __value__ == ((5u32 : stdgo.reflect.Reflect.Kind)) || __value__ == ((6u32 : stdgo.reflect.Reflect.Kind))) {
                ...
                var _c:stdgo.GoInt = _compare(stdgo.reflect.Reflect.valueOf(stdgo.Go.toInterface(_aVal.elem().type()))?.__copy__(), stdgo.reflect.Reflect.valueOf(stdgo.Go.toInterface(_bVal.elem().type()))?.__copy__());
                if (_c != ((0 : stdgo.GoInt))) {
                    return _c;
                };
...
**/
function _nilCompare(_aVal:stdgo.reflect.Reflect.Value, _bVal:stdgo.reflect.Reflect.Value):{ var _0 : stdgo.GoInt; var _1 : Bool; } {
        if (_aVal.isNil()) {
            if (_bVal.isNil()) {
