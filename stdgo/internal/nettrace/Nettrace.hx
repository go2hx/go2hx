...
@:structInit @:using(Nettrace.TraceKey_static_extension) abstract TraceKey(stdgo._internal.internal.nettrace.Nettrace_tracekey.TraceKey) from stdgo._internal.internal.nettrace.Nettrace_tracekey.TraceKey to stdgo._internal.internal.nettrace.Nettrace_tracekey.TraceKey {
    public function new() this = new stdgo._internal.internal.nettrace.Nettrace_tracekey.TraceKey();
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(Nettrace.LookupIPAltResolverKey_static_extension) abstract LookupIPAltResolverKey(stdgo._internal.internal.nettrace.Nettrace_lookupipaltresolverkey.LookupIPAltResolverKey) from stdgo._internal.internal.nettrace.Nettrace_lookupipaltresolverkey.LookupIPAltResolverKey to stdgo._internal.internal.nettrace.Nettrace_lookupipaltresolverkey.LookupIPAltResolverKey {
    public function new() this = new stdgo._internal.internal.nettrace.Nettrace_lookupipaltresolverkey.LookupIPAltResolverKey();
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(Nettrace.Trace_static_extension) abstract Trace(stdgo._internal.internal.nettrace.Nettrace_trace.Trace) from stdgo._internal.internal.nettrace.Nettrace_trace.Trace to stdgo._internal.internal.nettrace.Nettrace_trace.Trace {
