...
@:structInit @:using(stdgo.internal.nettrace.Nettrace.Trace_static_extension) abstract Trace(stdgo._internal.internal.nettrace.Nettrace_trace.Trace) from stdgo._internal.internal.nettrace.Nettrace_trace.Trace to stdgo._internal.internal.nettrace.Nettrace_trace.Trace {
    ...
    function set_dNSStart(v:String -> Void):String -> Void {
        this.dNSStart = _0 -> v((_0 : stdgo.GoString));
        return v;
    }
    ...
    function set_dNSDone(v:(Array<stdgo.AnyInterface>, Bool, stdgo.Error) -> Void):(Array<stdgo.AnyInterface>, Bool, stdgo.Error) -> Void {
        this.dNSDone = (_0, _1, _2) -> v(([for (i in _0) (i : stdgo.AnyInterface)] : stdgo.Slice<stdgo.AnyInterface>), _1, (_2 : stdgo.Error));
        return v;
    }
    ...
    public function new(?dNSStart:String -> Void, ?dNSDone:(Array<stdgo.AnyInterface>, Bool, stdgo.Error) -> Void, ?connectStart:(String, String) -> Void, ?connectDone:(String, String, stdgo.Error) -> Void) this = new stdgo._internal.internal.nettrace.Nettrace_trace.Trace(_0 -> dNSStart((_0 : stdgo.GoString)), (_0, _1, _2) -> dNSDone(([for (i in _0) (i : stdgo.AnyInterface)] : stdgo.Slice<stdgo.AnyInterface>), _1, (_2 : stdgo.Error)), (_0, _1) -> connectStart((_0 : stdgo.GoString), (_1 : stdgo.GoString)), (_0, _1, _2) -> connectDone((_0 : stdgo.GoString), (_1 : stdgo.GoString), (_2 : stdgo.Error)));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
