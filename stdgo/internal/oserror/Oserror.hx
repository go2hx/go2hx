...
private function set_errInvalid(v:stdgo.Error):stdgo.Error {
        stdgo._internal.internal.oserror.Oserror_errinvalid.errInvalid = v;
        return v;
    }
...
private function set_errPermission(v:stdgo.Error):stdgo.Error {
        stdgo._internal.internal.oserror.Oserror_errpermission.errPermission = v;
        return v;
    }
...
private function set_errExist(v:stdgo.Error):stdgo.Error {
        stdgo._internal.internal.oserror.Oserror_errexist.errExist = v;
        return v;
    }
...
private function set_errNotExist(v:stdgo.Error):stdgo.Error {
        stdgo._internal.internal.oserror.Oserror_errnotexist.errNotExist = v;
        return v;
    }
...
private function set_errClosed(v:stdgo.Error):stdgo.Error {
        stdgo._internal.internal.oserror.Oserror_errclosed.errClosed = v;
        return v;
    }
/**
