# Module stdgo.internal.platform has compilation errors, please do not use:
```
stdgo/internal/platform/Platform.hx:2: characters 10-18 : list: Custom property accessor is no longer supported, please use `get`
stdgo/internal/platform/Platform.hx:2: characters 20-28 : list: Custom property accessor is no longer supported, please use `set`
