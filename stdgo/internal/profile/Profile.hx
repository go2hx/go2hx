...
@:structInit @:using(Profile.T_mapInfo_static_extension) @:dox(hide) abstract T_mapInfo(stdgo._internal.internal.profile.Profile_t_mapinfo.T_mapInfo) from stdgo._internal.internal.profile.Profile_t_mapinfo.T_mapInfo to stdgo._internal.internal.profile.Profile_t_mapinfo.T_mapInfo {
...
@:structInit @:using(Profile.T_sampleKey_static_extension) @:dox(hide) abstract T_sampleKey(stdgo._internal.internal.profile.Profile_t_samplekey.T_sampleKey) from stdgo._internal.internal.profile.Profile_t_samplekey.T_sampleKey to stdgo._internal.internal.profile.Profile_t_samplekey.T_sampleKey {
...
@:structInit @:using(Profile.T_mappingKey_static_extension) @:dox(hide) abstract T_mappingKey(stdgo._internal.internal.profile.Profile_t_mappingkey.T_mappingKey) from stdgo._internal.internal.profile.Profile_t_mappingkey.T_mappingKey to stdgo._internal.internal.profile.Profile_t_mappingkey.T_mappingKey {
...
@:structInit @:using(Profile.Profile_static_extension) abstract Profile_(stdgo._internal.internal.profile.Profile_profile.Profile) from stdgo._internal.internal.profile.Profile_profile.Profile to stdgo._internal.internal.profile.Profile_profile.Profile {
...
@:structInit @:using(Profile.ValueType__static_extension) abstract ValueType_(stdgo._internal.internal.profile.Profile_valuetype_.ValueType_) from stdgo._internal.internal.profile.Profile_valuetype_.ValueType_ to stdgo._internal.internal.profile.Profile_valuetype_.ValueType_ {
...
@:structInit @:using(Profile.Sample_static_extension) abstract Sample(stdgo._internal.internal.profile.Profile_sample.Sample) from stdgo._internal.internal.profile.Profile_sample.Sample to stdgo._internal.internal.profile.Profile_sample.Sample {
    public var location(get, set) : Array<Location>;
    function get_location():Array<Location> return [for (i in this.location) i];
    function set_location(v:Array<Location>):Array<Location> {
        this.location = ([for (i in v) (i : stdgo.Ref<stdgo._internal.internal.profile.Profile_location.Location>)] : stdgo.Slice<stdgo.Ref<stdgo._internal.internal.profile.Profile_location.Location>>);
...
@:structInit @:using(Profile.Label_static_extension) abstract Label(stdgo._internal.internal.profile.Profile_label.Label) from stdgo._internal.internal.profile.Profile_label.Label to stdgo._internal.internal.profile.Profile_label.Label {
...
@:structInit @:using(Profile.Mapping_static_extension) abstract Mapping(stdgo._internal.internal.profile.Profile_mapping.Mapping) from stdgo._internal.internal.profile.Profile_mapping.Mapping to stdgo._internal.internal.profile.Profile_mapping.Mapping {
...
@:structInit @:using(Profile.Location_static_extension) abstract Location(stdgo._internal.internal.profile.Profile_location.Location) from stdgo._internal.internal.profile.Profile_location.Location to stdgo._internal.internal.profile.Profile_location.Location {
    public var iD(get, set) : haxe.UInt64;
    function get_iD():haxe.UInt64 return this.iD;
    function set_iD(v:haxe.UInt64):haxe.UInt64 {
        this.iD = (v : stdgo.GoUInt64);
...
@:structInit @:using(Profile.Line_static_extension) abstract Line(stdgo._internal.internal.profile.Profile_line.Line) from stdgo._internal.internal.profile.Profile_line.Line to stdgo._internal.internal.profile.Profile_line.Line {
...
@:structInit @:using(Profile.Function_static_extension) abstract Function(stdgo._internal.internal.profile.Profile_function.Function) from stdgo._internal.internal.profile.Profile_function.Function to stdgo._internal.internal.profile.Profile_function.Function {
    public var iD(get, set) : haxe.UInt64;
    function get_iD():haxe.UInt64 return this.iD;
    function set_iD(v:haxe.UInt64):haxe.UInt64 {
        this.iD = (v : stdgo.GoUInt64);
...
@:structInit @:using(Profile.T_buffer_static_extension) @:dox(hide) abstract T_buffer(stdgo._internal.internal.profile.Profile_t_buffer.T_buffer) from stdgo._internal.internal.profile.Profile_t_buffer.T_buffer to stdgo._internal.internal.profile.Profile_t_buffer.T_buffer {
