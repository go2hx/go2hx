...
function readRange(_addr:stdgo.unsafe.Unsafe.UnsafePointer, _len:stdgo.GoInt):Void throw ":internal.race.readRange is not yet implemented";
function writeRange(_addr:stdgo.unsafe.Unsafe.UnsafePointer, _len:stdgo.GoInt):Void throw ":internal.race.writeRange is not yet implemented";
