...
@:structInit @:using(stdgo.internal.reflectlite.Reflectlite.T_mapType_static_extension) @:dox(hide) abstract T_mapType(stdgo._internal.internal.reflectlite.Reflectlite_t_maptype.T_mapType) from stdgo._internal.internal.reflectlite.Reflectlite_t_maptype.T_mapType to stdgo._internal.internal.reflectlite.Reflectlite_t_maptype.T_mapType {
    ...
    function set_hasher(v:(stdgo._internal.unsafe.Unsafe.UnsafePointer, stdgo.GoUIntptr) -> stdgo.GoUIntptr):(stdgo._internal.unsafe.Unsafe.UnsafePointer, stdgo.GoUIntptr) -> stdgo.GoUIntptr {
        this.hasher = (_0, _1) -> v(_0, (_1 : stdgo.GoUIntptr));
        return v;
    }
    ...
    public function new(?key:stdgo._internal.internal.abi.Abi_type_.Type_, ?elem:stdgo._internal.internal.abi.Abi_type_.Type_, ?bucket:stdgo._internal.internal.abi.Abi_type_.Type_, ?hasher:(stdgo._internal.unsafe.Unsafe.UnsafePointer, stdgo.GoUIntptr) -> stdgo.GoUIntptr, ?keySize:std.UInt, ?valueSize:std.UInt, ?bucketSize:std.UInt, ?flags:std.UInt) this = new stdgo._internal.internal.reflectlite.Reflectlite_t_maptype.T_mapType((key : stdgo.Ref<stdgo._internal.internal.abi.Abi_type_.Type_>), (elem : stdgo.Ref<stdgo._internal.internal.abi.Abi_type_.Type_>), (bucket : stdgo.Ref<stdgo._internal.internal.abi.Abi_type_.Type_>), (_0, _1) -> hasher(_0, (_1 : stdgo.GoUIntptr)), (keySize : stdgo.GoUInt8), (valueSize : stdgo.GoUInt8), (bucketSize : stdgo.GoUInt16), (flags : stdgo.GoUInt32));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
