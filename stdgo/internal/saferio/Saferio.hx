...
**/
function readData(_r:stdgo.io.Io.Reader, _n:stdgo.GoUInt64):{ var _0 : stdgo.Slice<stdgo.GoByte>; var _1 : stdgo.Error; } {
        if (((_n : stdgo.GoInt64) < (0i64 : stdgo.GoInt64)) || (_n != ((_n : stdgo.GoInt) : stdgo.GoUInt64))) {
            return { _0 : (null : stdgo.Slice<stdgo.GoUInt8>), _1 : stdgo.io.Io.errUnexpectedEOF };
        };
        if (_n < (10485760i64 : stdgo.GoUInt64)) {
            var _buf = new stdgo.Slice<stdgo.GoUInt8>((_n : stdgo.GoInt).toBasic(), 0).__setNumber32__();
            var __tmp__ = stdgo.io.Io.readFull(_r, _buf), __0:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
        ...
        while (_n > (0i64 : stdgo.GoUInt64)) {
            var _next:stdgo.GoUInt64 = _n;
            if (_next > (10485760i64 : stdgo.GoUInt64)) {
                _next = (10485760i64 : stdgo.GoUInt64);
            };
            var __tmp__ = stdgo.io.Io.readFull(_r, (_buf1.__slice__(0, _next) : stdgo.Slice<stdgo.GoUInt8>)), __1:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                if ((_buf.length > (0 : stdgo.GoInt)) && (stdgo.Go.toInterface(_err) == stdgo.Go.toInterface(stdgo.io.Io.eof))) {
...
**/
function readDataAt(_r:stdgo.io.Io.ReaderAt, _n:stdgo.GoUInt64, _off:stdgo.GoInt64):{ var _0 : stdgo.Slice<stdgo.GoByte>; var _1 : stdgo.Error; } {
        if (((_n : stdgo.GoInt64) < (0i64 : stdgo.GoInt64)) || (_n != ((_n : stdgo.GoInt) : stdgo.GoUInt64))) {
            return { _0 : (null : stdgo.Slice<stdgo.GoUInt8>), _1 : stdgo.io.Io.errUnexpectedEOF };
        };
        if (_n < (10485760i64 : stdgo.GoUInt64)) {
            ...
            if (_err != null) {
                if ((stdgo.Go.toInterface(_err) != stdgo.Go.toInterface(stdgo.io.Io.eof)) || (_n > (0i64 : stdgo.GoUInt64))) {
                    return { _0 : (null : stdgo.Slice<stdgo.GoUInt8>), _1 : _err };
                };
            };
            return { _0 : _buf, _1 : (null : stdgo.Error) };
...
function sliceCap(_v:stdgo.AnyInterface, _c:stdgo.GoUInt64):stdgo.GoInt {
        if (((_c : stdgo.GoInt64) < (0i64 : stdgo.GoInt64)) || (_c != ((_c : stdgo.GoInt) : stdgo.GoUInt64))) {
            return (-1 : stdgo.GoInt);
        };
        var _typ:stdgo.reflect.Reflect.Type_ = stdgo.reflect.Reflect.typeOf(_v);
        ...
        if ((_size > (0i64 : stdgo.GoUInt64)) && (_c > ((-1i64 : stdgo.GoUInt64) / _size))) {
            return (-1 : stdgo.GoInt);
        };
        if ((_c * _size) > (10485760i64 : stdgo.GoUInt64)) {
