...
@:structInit @:using(Singleflight.T_call_static_extension) @:dox(hide) abstract T_call(stdgo._internal.internal.singleflight.Singleflight_t_call.T_call) from stdgo._internal.internal.singleflight.Singleflight_t_call.T_call to stdgo._internal.internal.singleflight.Singleflight_t_call.T_call {
...
@:structInit @:using(Singleflight.Group_static_extension) abstract Group(stdgo._internal.internal.singleflight.Singleflight_group.Group) from stdgo._internal.internal.singleflight.Singleflight_group.Group to stdgo._internal.internal.singleflight.Singleflight_group.Group {
...
@:structInit @:using(Singleflight.Result_static_extension) abstract Result(stdgo._internal.internal.singleflight.Singleflight_result.Result) from stdgo._internal.internal.singleflight.Singleflight_result.Result to stdgo._internal.internal.singleflight.Singleflight_result.Result {
