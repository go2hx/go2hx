# Module stdgo.internal.testenv has compilation errors, please do not use:
```
...
[30;41m ERROR [0m stdgo/internal/testenv/Testenv.hx:2: character 1

    2 | [0m[1m[0m[2mvar sigquit(get, set) : stdgo._internal.os.Os.Signal;[0m
      | [31m^[0m
      | stdgo.internal.testenv._Testenv.Testenv_Fields_ is not ready to be accessed, separate your type declarations in several files
