...
class T__interface_0_static_extension {
    static public function deadline(t:T__interface_0):stdgo.Tuple<stdgo._internal.time.Time.Time, Bool> {
        return {
            final obj = stdgo._internal.internal.testenv.Testenv.T__interface_0_static_extension.deadline(t);
            { _0 : obj._0, _1 : obj._1 };
        };
    }
}
