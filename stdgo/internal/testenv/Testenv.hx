...
@:interface @:dox(hide) @:forward abstract T__interface_0(stdgo._internal.internal.testenv.Testenv_t__interface_0.T__interface_0) from stdgo._internal.internal.testenv.Testenv_t__interface_0.T__interface_0 to stdgo._internal.internal.testenv.Testenv_t__interface_0.T__interface_0 {
    @:from
    static function fromHaxeInterface(x:{ function deadline():stdgo.Tuple<stdgo._internal.time.Time_time.Time, Bool>; function cleanup(_0:() -> Void):Void; function error(_0:haxe.Rest<stdgo.AnyInterface>):Void; function errorf(_0:String, _1:haxe.Rest<stdgo.AnyInterface>):Void; function fail():Void; function failNow():Void; function failed():Bool; function fatal(_0:haxe.Rest<stdgo.AnyInterface>):Void; function fatalf(_0:String, _1:haxe.Rest<stdgo.AnyInterface>):Void; function helper():Void; function log(_0:haxe.Rest<stdgo.AnyInterface>):Void; function logf(_0:String, _1:haxe.Rest<stdgo.AnyInterface>):Void; function name():String; function setenv(_0:String, _1:String):Void; function skip(_0:haxe.Rest<stdgo.AnyInterface>):Void; function skipNow():Void; function skipf(_0:String, _1:haxe.Rest<stdgo.AnyInterface>):Void; function skipped():Bool; function tempDir():String; function _private():Void; }):T__interface_0 {
        var __f__:Void -> stdgo.AnyInterface = null;
        final y:T__interface_0 = { deadline : () -> x.deadline(), cleanup : _0 -> x.cleanup(() -> _0()), error : _0 -> x.error(_0), errorf : (_0, _1) -> x.errorf(_0, _1), fail : () -> x.fail(), failNow : () -> x.failNow(), failed : () -> x.failed(), fatal : _0 -> x.fatal(_0), fatalf : (_0, _1) -> x.fatalf(_0, _1), helper : () -> x.helper(), log : _0 -> x.log(_0), logf : (_0, _1) -> x.logf(_0, _1), name : () -> x.name(), setenv : (_0, _1) -> x.setenv(_0, _1), skip : _0 -> x.skip(_0), skipNow : () -> x.skipNow(), skipf : (_0, _1) -> x.skipf(_0, _1), skipped : () -> x.skipped(), tempDir : () -> x.tempDir(), _private : () -> x._private(), __underlying__ : () -> __f__() };
