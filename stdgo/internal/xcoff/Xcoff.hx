...
@:structInit class T_bigarFileHeader {
	...
	public function toString() {
		return '{' + Go.string(flmagic) + " " + Go.string(flmemoff) + " " + Go.string(flgstoff) + " " + Go.string(flgst64off) + " " + Go.string(flfstmoff)
			+ " " + Go.string(fllstmoff) + " " + Go.string(flfreeoff) + "}";
	}
...
@:structInit class T_bigarMemberHeader {
	...
	public function toString() {
		return '{' + Go.string(arsize) + " " + Go.string(arnxtmem) + " " + Go.string(arprvmem) + " " + Go.string(ardate) + " " + Go.string(aruid) + " "
			+ Go.string(argid) + " " + Go.string(armode) + " " + Go.string(arnamlen) + "}";
	}
...
@:structInit class Member {
	...
	public function new(?memberHeader:MemberHeader, ?_sr:Pointer<stdgo.io.Io.SectionReader>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class SectionHeader {
	...
	public function toString() {
		return '{' + Go.string(name) + " " + Go.string(virtualAddress) + " " + Go.string(size) + " " + Go.string(type) + " " + Go.string(relptr) + " "
			+ Go.string(nreloc) + "}";
	}
...
@:structInit class Symbol {
	...
	public function toString() {
		return '{' + Go.string(name) + " " + Go.string(value) + " " + Go.string(sectionNumber) + " " + Go.string(storageClass) + " " + Go.string(auxFcn)
			+ " " + Go.string(auxCSect) + "}";
	}
...
@:structInit class Reloc {
	...
	public function new(?virtualAddress:GoUInt64, ?symbol:Pointer<Symbol>, ?signed:Bool, ?instructionFixed:Bool, ?length:GoUInt8, ?type:GoUInt8)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(virtualAddress) + " " + Go.string(symbol) + " " + Go.string(signed) + " " + Go.string(instructionFixed) + " "
			+ Go.string(length) + " " + Go.string(type) + "}";
	}
...
@:structInit class File {
	public function importedLibraries():{var _0:Slice<GoString>; var _1:Error;} {
		...
		var __tmp__ = _f.value._readImportIDs(_s),
	...
	public function importedSymbols():{var _0:Slice<ImportedSymbol>; var _1:Error;} {
		...
		{
			var __tmp__ = _s.value._sr.value.seek(((0 : GoInt64)), stdgo.os.Os.seek_SET),
		...
		if (_f.value.fileHeader.targetMachine == u802tocmagic) {
			...
			{
				var _err:stdgo.Error = stdgo.encoding.binary.Binary.read(_s.value._sr.value, stdgo.encoding.binary.Binary.bigEndian.__copy__(),
		...
		{
			var __tmp__ = _s.value._sr.value.seek(((_stoff : GoInt64)), stdgo.os.Os.seek_SET),
				_:GoInt64 = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return {_0: new Slice<ImportedSymbol>().nil(), _1: _err};
		...
		{
			var __tmp__ = stdgo.io.Io.readFull(_s.value._sr.value, _st),
				_:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return {_0: new Slice<ImportedSymbol>().nil(), _1: _err};
		...
		{
			var __tmp__ = _s.value._sr.value.seek(((_symoff : GoInt64)), stdgo.os.Os.seek_SET),
				_:GoInt64 = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return {_0: new Slice<ImportedSymbol>().nil(), _1: _err};
	...
	public function _readImportIDs(_s:Pointer<Section>):{var _0:Slice<GoString>; var _1:Error;} {
		...
		{
			var __tmp__ = _s.value._sr.value.seek(((_impoff : GoInt64)), stdgo.os.Os.seek_SET),
				_:GoInt64 = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return {_0: new Slice<GoString>().nil(), _1: _err};
		...
		{
			var __tmp__ = stdgo.io.Io.readFull(_s.value._sr.value, _table),
				_:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return {_0: new Slice<GoString>().nil(), _1: _err};
	...
	public function dwarf():{var _0:Pointer<stdgo.debug.dwarf.Dwarf.Data>; var _1:Error;} {
		...
		var _abbrev:Slice<GoUInt8> = _dat[((0 : GoInt))],
			_info:Slice<GoUInt8> = _dat[((1 : GoInt))],
			_line:Slice<GoUInt8> = _dat[((2 : GoInt))],
			_ranges:Slice<GoUInt8> = _dat[((3 : GoInt))],
			_str:Slice<GoUInt8> = _dat[((4 : GoInt))];
		return stdgo.debug.dwarf.Dwarf.new_(_abbrev, new Slice<GoUInt8>().nil(), new Slice<GoUInt8>().nil(), _info, _line, new Slice<GoUInt8>().nil(),
			_ranges, _str);
	}
			...
			if (_sym.value.name == _name && _sym.value.auxCSect.symbolType == xty_SD) {
				{
					...
					if (((0 : GoInt)) <= _i && _i < _f.value.sections.length) {
						...
						if (_sym.value.value + ((_sym.value.auxCSect.length : GoUInt64)) <= _s.value.sectionHeader.size) {
							...
							var __tmp__ = _s.value._sr.value.readAt(_dat, ((_sym.value.value : GoInt64))),
								_:GoInt = __tmp__._0,
								_err:stdgo.Error = __tmp__._1;
							if (_err != null) {
	...
	public function section(_name:GoString):Pointer<Section> {
		...
		for (_s in _f.value.sections) {
			if (_s.value.sectionHeader.name == _name
				|| (_name.length > ((8 : GoInt)) && _s.value.sectionHeader.name == _name.__slice__(0, ((8 : GoInt))))) {
				return _s;
			};
		};
		return new Pointer<Section>().nil();
	...
	public function new(?fileHeader:FileHeader, ?sections:Slice<Pointer<Section>>, ?symbols:Slice<Pointer<Symbol>>, ?stringTable:Slice<GoUInt8>,
			?libraryPaths:Slice<GoString>, ?_closer:stdgo.io.Io.Closer)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(fileHeader) + " " + Go.string(sections) + " " + Go.string(symbols) + " " + Go.string(stringTable) + " "
			+ Go.string(libraryPaths) + " " + Go.string(_closer) + "}";
	}
...
@:structInit class FileHeader32 {
	...
	public function toString() {
		return '{' + Go.string(fmagic) + " " + Go.string(fnscns) + " " + Go.string(ftimedat) + " " + Go.string(fsymptr) + " " + Go.string(fnsyms) + " "
			+ Go.string(fopthdr) + " " + Go.string(fflags) + "}";
	}
...
@:structInit class FileHeader64 {
	...
	public function toString() {
		return '{' + Go.string(fmagic) + " " + Go.string(fnscns) + " " + Go.string(ftimedat) + " " + Go.string(fsymptr) + " " + Go.string(fopthdr) + " "
			+ Go.string(fflags) + " " + Go.string(fnsyms) + "}";
	}
...
@:structInit class SectionHeader32 {
	...
	public function toString() {
		return '{' + Go.string(sname) + " " + Go.string(spaddr) + " " + Go.string(svaddr) + " " + Go.string(ssize) + " " + Go.string(sscnptr) + " "
			+ Go.string(srelptr) + " " + Go.string(slnnoptr) + " " + Go.string(snreloc) + " " + Go.string(snlnno) + " " + Go.string(sflags) + "}";
	}
...
@:structInit class SymEnt32 {
	...
	public function toString() {
		return '{' + Go.string(nname) + " " + Go.string(nvalue) + " " + Go.string(nscnum) + " " + Go.string(ntype) + " " + Go.string(nsclass) + " "
			+ Go.string(nnumaux) + "}";
	}
...
@:structInit class SymEnt64 {
	...
	public function toString() {
		return '{' + Go.string(nvalue) + " " + Go.string(noffset) + " " + Go.string(nscnum) + " " + Go.string(ntype) + " " + Go.string(nsclass) + " "
			+ Go.string(nnumaux) + "}";
	}
...
@:structInit class AuxCSect32 {
	...
	public function toString() {
		return '{' + Go.string(xscnlen) + " " + Go.string(xparmhash) + " " + Go.string(xsnhash) + " " + Go.string(xsmtyp) + " " + Go.string(xsmclas) + " "
			+ Go.string(xstab) + " " + Go.string(xsnstab) + "}";
	}
...
@:structInit class AuxCSect64 {
	...
	public function toString() {
		return '{' + Go.string(xscnlenlo) + " " + Go.string(xparmhash) + " " + Go.string(xsnhash) + " " + Go.string(xsmtyp) + " " + Go.string(xsmclas) + " "
			+ Go.string(xscnlenhi) + " " + Go.string(xpad) + " " + Go.string(xauxtype) + "}";
	}
...
@:structInit class LoaderHeader32 {
	...
	public function toString() {
		return '{' + Go.string(lversion) + " " + Go.string(lnsyms) + " " + Go.string(lnreloc) + " " + Go.string(listlen) + " " + Go.string(lnimpid) + " "
			+ Go.string(limpoff) + " " + Go.string(lstlen) + " " + Go.string(lstoff) + "}";
	}
...
@:structInit class LoaderHeader64 {
	...
	public function toString() {
		return '{' + Go.string(lversion) + " " + Go.string(lnsyms) + " " + Go.string(lnreloc) + " " + Go.string(listlen) + " " + Go.string(lnimpid) + " "
			+ Go.string(lstlen) + " " + Go.string(limpoff) + " " + Go.string(lstoff) + " " + Go.string(lsymoff) + " " + Go.string(lrldoff) + "}";
	}
...
@:structInit class LoaderSymbol32 {
	...
	public function toString() {
		return '{' + Go.string(lname) + " " + Go.string(lvalue) + " " + Go.string(lscnum) + " " + Go.string(lsmtype) + " " + Go.string(lsmclas) + " "
			+ Go.string(lifile) + " " + Go.string(lparm) + "}";
	}
...
@:structInit class LoaderSymbol64 {
	...
	public function toString() {
		return '{' + Go.string(lvalue) + " " + Go.string(loffset) + " " + Go.string(lscnum) + " " + Go.string(lsmtype) + " " + Go.string(lsmclas) + " "
			+ Go.string(lifile) + " " + Go.string(lparm) + "}";
	}
...
function openArchive(_name:GoString):{var _0:Pointer<Archive>; var _1:Error;} {
	...
	var __tmp__ = newArchive(_f.value),
		_arch:Pointer<Archive> = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
		_f.value.close();
		return {_0: new Pointer<Archive>().nil(), _1: _err};
...
function newArchive(_r:stdgo.io.Io.ReaderAt):{var _0:Pointer<Archive>; var _1:Error;} {
	var _parseDecimalBytes:Slice<GoUInt8> -> {
		var _0:GoInt64;
		var _1:stdgo.Error;
	} = function(_b:Slice<GoByte>):{var _0:GoInt64; var _1:Error;} {
	...
	{
		var __tmp__ = _sr.value.readAt(_magic.__slice__(0), ((0 : GoInt64))),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new Pointer<Archive>().nil(), _1: _err};
	...
	{
		var __tmp__ = _sr.value.seek(((0 : GoInt64)), stdgo.os.Os.seek_SET),
			_:GoInt64 = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new Pointer<Archive>().nil(), _1: _err};
	...
	};
	{
		var _err:stdgo.Error = stdgo.encoding.binary.Binary.read(_sr.value, stdgo.encoding.binary.Binary.bigEndian.__copy__(),
			Go.toInterface(Go.pointer(_fhdr)));
		if (_err != null) {
			return {_0: new Pointer<Archive>().nil(), _1: _err};
		};
	};
	var __tmp__ = _parseDecimalBytes(_fhdr.flfstmoff.__slice__(0)),
		_off:GoInt64 = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
		return {_0: new Pointer<Archive>().nil(), _1: stdgo.fmt.Fmt.errorf("error parsing offset of first member in archive header(%q); %v",
			Go.toInterface(_fhdr.__copy__()), Go.toInterface(_err))};
	};
	if (_off == ((0 : GoInt64))) {
		return {_0: _arch, _1: ((null : stdgo.Error))};
	};
	var __tmp__ = _parseDecimalBytes(_fhdr.fllstmoff.__slice__(0)),
	...
	while (true) {
		{
			var __tmp__ = _sr.value.seek(_off, stdgo.os.Os.seek_SET),
				_:GoInt64 = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return {_0: new Pointer<Archive>().nil(), _1: _err};
		...
		{
			var _err:stdgo.Error = stdgo.encoding.binary.Binary.read(_sr.value, stdgo.encoding.binary.Binary.bigEndian.__copy__(),
				Go.toInterface(Go.pointer(_mhdr)));
			if (_err != null) {
				return {_0: new Pointer<Archive>().nil(), _1: _err};
			};
		};
		...
		var __tmp__ = _parseDecimalBytes(_mhdr.arsize.__slice__(0)),
			_size:GoInt64 = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new Pointer<Archive>().nil(), _1: stdgo.fmt.Fmt.errorf("error parsing size in member header(%q); %v",
				Go.toInterface(_mhdr.__copy__()), Go.toInterface(_err))};
		};
		_member.value.memberHeader.size = ((_size : GoUInt64));
		var __tmp__ = _parseDecimalBytes(_mhdr.arnamlen.__slice__(0)),
			_namlen:GoInt64 = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new Pointer<Archive>().nil(), _1: stdgo.fmt.Fmt.errorf("error parsing name length in member header(%q); %v",
				Go.toInterface(_mhdr.__copy__()), Go.toInterface(_err))};
		};
		...
		if (_fileoff & ((1 : GoInt64)) != ((0 : GoInt64))) {
			_fileoff++;
			{
				var __tmp__ = _sr.value.seek(((1 : GoInt64)), stdgo.os.Os.seek_CUR),
					_:GoInt64 = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
					return {_0: new Pointer<Archive>().nil(), _1: _err};
		...
		{
			var _err:stdgo.Error = stdgo.encoding.binary.Binary.read(_sr.value, stdgo.encoding.binary.Binary.bigEndian.__copy__(),
				Go.toInterface(Go.pointer(_fmag)));
			if (_err != null) {
				return {_0: new Pointer<Archive>().nil(), _1: _err};
			};
		};
...
function newFile(_r:stdgo.io.Io.ReaderAt):{var _0:Pointer<File>; var _1:Error;} {
	return stdgo.internal.Macro.controlFlow({
		...
		{
			var __tmp__ = _sr.value.seek(((_offset : GoInt64)), stdgo.os.Os.seek_SET),
				_:GoInt64 = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return {_0: new Pointer<File>().nil(), _1: _err};
		...
		if (_l > ((4 : GoUInt32))) {
			...
			{
				var __tmp__ = stdgo.io.Io.readFull(_sr.value, _f.value.stringTable),
					_:GoInt = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
					return {_0: new Pointer<File>().nil(), _1: _err};
		...
		{
			var __tmp__ = _sr.value.seek(((_hdrsz : GoInt64)) + ((_opthdr : GoInt64)), stdgo.os.Os.seek_SET),
				_:GoInt64 = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return {_0: new Pointer<File>().nil(), _1: _err};
		...
		var _idxToSym:GoMap<GoInt, Pointer<Symbol>> = new GoMap<GoInt,
			Pointer<Symbol>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(int_kind),
			stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("internal/xcoff.Symbol", [],
				stdgo.reflect.Reflect.GoType.named("internal/xcoff.Symbol", [], stdgo.reflect.Reflect.GoType.structType([
					{
						name: "name",
						embedded: false,
						tag: "",
					...
					},
					{
						...
						embedded: false,
						tag: "",
						type: stdgo.reflect.Reflect.GoType.named("internal/xcoff.AuxiliaryFcn", [],
							stdgo.reflect.Reflect.GoType.named("internal/xcoff.AuxiliaryFcn", [], stdgo.reflect.Reflect.GoType.structType([
								{
									name: "size",
									embedded: false,
									tag: "",
					...
					},
					{
						...
						embedded: false,
						tag: "",
						type: stdgo.reflect.Reflect.GoType.named("internal/xcoff.AuxiliaryCSect", [],
							stdgo.reflect.Reflect.GoType.named("internal/xcoff.AuxiliaryCSect", [], stdgo.reflect.Reflect.GoType.structType([
								{
									name: "length",
									embedded: false,
									tag: "",
		...
		{
			var __tmp__ = _sr.value.seek(((_symptr : GoInt64)), stdgo.os.Os.seek_SET),
				_:GoInt64 = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return {_0: new Pointer<File>().nil(), _1: _err};
		...
		_f.value.symbols = new Slice<Pointer<Symbol>>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) new Pointer<Symbol>().nil()]);
		{
			...
			Go.cfor(_i < ((_nsyms : GoInt)), _i++, {
				...
				if (!_needAuxFcn) {
					{
						var __tmp__ = _sr.value.seek((((_numaux - ((1 : GoInt))) : GoInt64)) * symesz, stdgo.os.Os.seek_CUR),
							_:GoInt64 = __tmp__._0,
							_err:stdgo.Error = __tmp__._1;
						if (_err != null) {
							return {_0: new Pointer<File>().nil(), _1: _err};
				...
				{
					var __tmp__ = _sr.value.seek(((_numaux : GoInt64)) * symesz, stdgo.os.Os.seek_CUR),
						_:GoInt64 = __tmp__._0,
						_err:stdgo.Error = __tmp__._1;
					if (_err != null) {
						return {_0: new Pointer<File>().nil(), _1: _err};
		...
		for (_sect in _f.value.sections) {
			...
			_sect.value.relocs = new Slice<Reloc>(...[
				for (i in 0...((_sect.value.sectionHeader.nreloc : GoInt)).toBasic()) new Reloc()
			]);
			if (_sect.value.sectionHeader.relptr == ((0 : GoUInt64))) {
				continue;
			};
			{
				var __tmp__ = _sr.value.seek(((_sect.value.sectionHeader.relptr : GoInt64)), stdgo.os.Os.seek_SET),
					_:GoInt64 = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
					return {_0: new Pointer<File>().nil(), _1: _err};
...
class Archive_extension_fields {
	...
	public function getFile(__tmp__, _name:GoString):{var _0:Pointer<File>; var _1:Error;}
		return __tmp__.getFile(_name);
}
...
class File_extension_fields {
	...
	public function sectionByType(__tmp__, _typ:GoUInt32):Pointer<Section>
		return __tmp__.sectionByType(_typ);

	public function csect(__tmp__, _name:GoString):Slice<GoByte>
		return __tmp__.csect(_name);

	public function dwarf(__tmp__):{var _0:Pointer<stdgo.debug.dwarf.Dwarf.Data>; var _1:Error;}
		return __tmp__.dwarf();

	public function _readImportIDs(__tmp__, _s:Pointer<Section>):{var _0:Slice<GoString>; var _1:Error;}
		return __tmp__._readImportIDs(_s);

	public function importedSymbols(__tmp__):{var _0:Slice<ImportedSymbol>; var _1:Error;}
