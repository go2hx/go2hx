...
var errShortWrite(get_errShortWrite, set_errShortWrite) : stdgo.Error;
...
var errShortBuffer(get_errShortBuffer, set_errShortBuffer) : stdgo.Error;
...
var eof(get_eof, set_eof) : stdgo.Error;
...
var errUnexpectedEOF(get_errUnexpectedEOF, set_errUnexpectedEOF) : stdgo.Error;
...
var errNoProgress(get_errNoProgress, set_errNoProgress) : stdgo.Error;
...
var discard(get_discard, set_discard) : stdgo._internal.io.Io.Writer;
...
var errClosedPipe(get_errClosedPipe, set_errClosedPipe) : stdgo.Error;
...
var errInvalidWrite(get_errInvalidWrite, set_errInvalidWrite) : stdgo.Error;
...
var errWhence(get_errWhence, set_errWhence) : stdgo.Error;
...
var errOffset(get_errOffset, set_errOffset) : stdgo.Error;
