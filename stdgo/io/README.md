...
- [class Fs](<#class-fs>)
  ...
  - [`function fileInfoToDirEntry(info:stdgo.io.FileInfo):stdgo.io.DirEntry`](<#fs-function-fileinfotodirentry>)

  - [`function formatDirEntry(dir:stdgo.io.DirEntry):String`](<#fs-function-formatdirentry>)

  - [`function formatFileInfo(info:stdgo.io.FileInfo):String`](<#fs-function-formatfileinfo>)

  - [`function glob(fsys:stdgo.io.FS, pattern:String):stdgo.Tuple<Array<String>, stdgo.Error>`](<#fs-function-glob>)

  - [`function readDir(fsys:stdgo.io.FS, name:String):stdgo.Tuple<Array<stdgo.io.DirEntry>, stdgo.Error>`](<#fs-function-readdir>)

  - [`function readFile(fsys:stdgo.io.FS, name:String):stdgo.Tuple<Array<Int>, stdgo.Error>`](<#fs-function-readfile>)

  - [`function stat(fsys:stdgo.io.FS, name:String):stdgo.Tuple<stdgo.io.FileInfo, stdgo.Error>`](<#fs-function-stat>)

  - [`function sub(fsys:stdgo.io.FS, dir:String):stdgo.Tuple<stdgo.io.FS, stdgo.Error>`](<#fs-function-sub>)

  - [`function validPath(name:String):Bool`](<#fs-function-validpath>)

  - [`function walkDir(fsys:stdgo.io.FS, root:String, fn:stdgo.io.WalkDirFunc):stdgo.Error`](<#fs-function-walkdir>)
...
```haxe
function fileInfoToDirEntry(info:stdgo.io.FileInfo):stdgo.io.DirEntry
```
...
```haxe
function formatDirEntry(dir:stdgo.io.DirEntry):String
```
...
```haxe
function formatFileInfo(info:stdgo.io.FileInfo):String
```
...
```haxe
function glob(fsys:stdgo.io.FS, pattern:String):stdgo.Tuple<Array<String>, stdgo.Error>
```
...
```haxe
function readDir(fsys:stdgo.io.FS, name:String):stdgo.Tuple<Array<stdgo.io.DirEntry>, stdgo.Error>
```
...
```haxe
function readFile(fsys:stdgo.io.FS, name:String):stdgo.Tuple<Array<Int>, stdgo.Error>
```
...
```haxe
function stat(fsys:stdgo.io.FS, name:String):stdgo.Tuple<stdgo.io.FileInfo, stdgo.Error>
```
...
```haxe
function sub(fsys:stdgo.io.FS, dir:String):stdgo.Tuple<stdgo.io.FS, stdgo.Error>
```
...
```haxe
function walkDir(fsys:stdgo.io.FS, root:String, fn:stdgo.io.WalkDirFunc):stdgo.Error
```
