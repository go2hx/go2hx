...
@:invalid typedef FS_static_extension = Dynamic;
...
@:invalid typedef DirEntry_static_extension = Dynamic;
typedef DirEntry = stdgo._internal.io.fs.Fs.DirEntry;
@:invalid typedef ReadDirFile_static_extension = Dynamic;
typedef ReadDirFile = stdgo._internal.io.fs.Fs.ReadDirFile;
@:invalid typedef FileInfo_static_extension = Dynamic;
typedef FileInfo = stdgo._internal.io.fs.Fs.FileInfo;
@:invalid typedef GlobFS_static_extension = Dynamic;
typedef GlobFS = stdgo._internal.io.fs.Fs.GlobFS;
@:invalid typedef ReadDirFS_static_extension = Dynamic;
typedef ReadDirFS = stdgo._internal.io.fs.Fs.ReadDirFS;
@:invalid typedef ReadFileFS_static_extension = Dynamic;
typedef ReadFileFS = stdgo._internal.io.fs.Fs.ReadFileFS;
@:invalid typedef StatFS_static_extension = Dynamic;
typedef StatFS = stdgo._internal.io.fs.Fs.StatFS;
@:invalid typedef SubFS_static_extension = Dynamic;
