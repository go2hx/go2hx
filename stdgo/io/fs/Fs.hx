...
@:named class FileMode {
    ...
    public function toString():GoString {
        ...
        var _w:GoInt = ((0 : GoInt));
        {
            ...
            for (_obj in _str.keyValueIterator()) {
                _i = _obj.key;
                _c = _obj.value;
                if (new FileMode(_m.__t__ & ((new FileMode(((1 : GoUInt32)) << (((((32 : GoUnTypedInt)) - ((1 : GoUnTypedInt)) - _i) : GoUInt))))).__t__).__t__ != ((0 : GoUInt32))) {
                    _buf[_w] = ((_c : GoByte));
                    _w++;
                };
            };
        ...
        final _rwx:GoString = "rwxrwxrwx";
        {
            ...
            for (_obj in _rwx.keyValueIterator()) {
                _i = _obj.key;
                _c = _obj.value;
                if (new FileMode(_m.__t__ & ((new FileMode(((1 : GoUInt32)) << (((((9 : GoUnTypedInt)) - ((1 : GoUnTypedInt)) - _i) : GoUInt))))).__t__).__t__ != ((0 : GoUInt32))) {
                    _buf[_w] = ((_c : GoByte));
                } else {
                    _buf[_w] = (("-".code : GoRune));
                };
    ...
    public function __copy__() return new FileMode(__t__);
}
@:structInit class PathError {
    ...
    public function new(?op:GoString, ?path:GoString, ?err:stdgo.Error) stdgo.internal.Macro.initLocals();
...
@:structInit class T_dirInfo {
    ...
    public function new(?_fileInfo:FileInfo) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_subFS {
    public function sub(_dir:GoString):{ var _0 : FS; var _1 : Error; } {
        ...
        var __tmp__ = _f.value._fullName("sub", _dir), _full:GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
    ...
    public function glob(_pattern:GoString):{ var _0 : Slice<GoString>; var _1 : Error; } {
        var _f = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        {
            var __tmp__ = stdgo.path.Path.match(_pattern, ""), _:Bool = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
        ...
        var __tmp__ = Fs.glob(_f.value._fsys, _full), _list:Slice<GoString> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        {
            var _i;
            var _name;
            for (_obj in _list.keyValueIterator()) {
                _i = _obj.key;
                _name = _obj.value;
                var __tmp__ = _f.value._shorten(_name), _name:GoString = __tmp__._0, _ok:Bool = __tmp__._1;
                if (!_ok) {
                    return { _0 : new Slice<GoString>().nil(), _1 : stdgo.errors.Errors.new_((("invalid result from inner fsys Glob: " : GoString)) + _name + ((" not in " : GoString)) + _f.value._dir) };
                };
                _list[_i] = _name;
            };
        };
    ...
    public function readFile(_name:GoString):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        var _f = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _f.value._fullName("read", _name), _full:GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<GoUInt8>().nil(), _1 : _err };
        };
        var __tmp__ = Fs.readFile(_f.value._fsys, _full), _data:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
    ...
    public function readDir(_name:GoString):{ var _0 : Slice<DirEntry>; var _1 : Error; } {
        ...
        var __tmp__ = Fs.readDir(_f.value._fsys, _full), _dir:Slice<DirEntry> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        return { _0 : _dir, _1 : _f.value._fixErr(_err) };
    }
    public function open(_name:GoString):{ var _0 : File; var _1 : Error; } {
        var _f = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _f.value._fullName("open", _name), _full:GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : ((null : File)), _1 : _err };
        };
        var __tmp__ = _f.value._fsys.open(_full), _file:File = __tmp__._0, _err:stdgo.Error = __tmp__._1;
    ...
    public function _fixErr(_err:Error):Error {
        var _f = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        {
            ...
            if (_ok) {
                {
                    var __tmp__ = _f.value._shorten(_e.value.path), _short:GoString = __tmp__._0, _ok:Bool = __tmp__._1;
                    if (_ok) {
    ...
    public function _shorten(_name:GoString):{ var _0 : GoString; var _1 : Bool; } {
        ...
        if (_name.length >= _f.value._dir.length + ((2 : GoInt)) && _name[_f.value._dir.length] == (("/".code : GoRune)) && _name.__slice__(0, _f.value._dir.length) == _f.value._dir) {
    ...
    public function new(?_fsys:FS, ?_dir:GoString) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:named class WalkDirFunc {
    ...
    public function __copy__() return new WalkDirFunc(__t__);
}
@:structInit class T_statDirEntry {
    ...
    public function new(?_info:FileInfo) stdgo.internal.Macro.initLocals();
    public function toString() {
...
final modeType : FileMode = new FileMode(new FileMode(new FileMode(new FileMode(new FileMode(new FileMode(modeDir.__t__ | modeSymlink.__t__).__t__ | modeNamedPipe.__t__).__t__ | modeSocket.__t__).__t__ | modeDevice.__t__).__t__ | modeCharDevice.__t__).__t__ | modeIrregular.__t__);
...
function _hasMeta(_path:GoString):Bool {
        {
            ...
            Go.cfor(_i < _path.length, _i++, {
                if (_path[_i] == (("*".code : GoRune)) || _path[_i] == (("?".code : GoRune)) || _path[_i] == (("[".code : GoRune)) || _path[_i] == (("\\".code : GoRune))) {
                    return true;
                };
            });
        };
            ...
            if (!_ok) {
                {
                    ...
                    return { _0 : new Slice<DirEntry>().nil(), _1 : Go.pointer((({ op : "readdir", path : _name, err : stdgo.errors.Errors.new_("not implemented") } : PathError))).value };
                };
            };
            var __tmp__ = _dir.readDir(-((1 : GoUnTypedInt))), _list:Slice<DirEntry> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
...
function readFile(_fsys:FS, _name:GoString):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        ...
        try {
            ...
            var _data:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((_size + ((1 : GoInt)) : GoInt)).toBasic());
            while (true) {
                ...
                var __tmp__ = _file.read(_data.__slice__(_data.length, _data.cap())), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
...
class FileMode_extension_fields {
    ...
    public function isRegular(__tmp__):Bool return __tmp__.isRegular();
    public function perm(__tmp__):FileMode return __tmp__.perm();
    public function type(__tmp__):FileMode return __tmp__.type();
}
...
class T_dirInfo_extension_fields {
    public function isDir(__tmp__):Bool return __tmp__.isDir();
    public function type(__tmp__):FileMode return __tmp__.type();
    public function info(__tmp__):{ var _0 : FileInfo; var _1 : Error; } return __tmp__.info();
    public function name(__tmp__):GoString return __tmp__.name();
}
class T_subFS_extension_fields {
    public function _fullName(__tmp__, _op:GoString, _name:GoString):{ var _0 : GoString; var _1 : Error; } return __tmp__._fullName(_op, _name);
    public function _shorten(__tmp__, _name:GoString):{ var _0 : GoString; var _1 : Bool; } return __tmp__._shorten(_name);
    public function _fixErr(__tmp__, _err:Error):Error return __tmp__._fixErr(_err);
    public function open(__tmp__, _name:GoString):{ var _0 : File; var _1 : Error; } return __tmp__.open(_name);
    public function readDir(__tmp__, _name:GoString):{ var _0 : Slice<DirEntry>; var _1 : Error; } return __tmp__.readDir(_name);
    public function readFile(__tmp__, _name:GoString):{ var _0 : Slice<GoByte>; var _1 : Error; } return __tmp__.readFile(_name);
    public function glob(__tmp__, _pattern:GoString):{ var _0 : Slice<GoString>; var _1 : Error; } return __tmp__.glob(_pattern);
    public function sub(__tmp__, _dir:GoString):{ var _0 : FS; var _1 : Error; } return __tmp__.sub(_dir);
}
