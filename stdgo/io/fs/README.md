...
[30;41m ERROR [0m stdgo/io/fs/Fs.hx:2: character 1

    2 | [0m[1m[0m[2mfinal modeDir : FileMode = stdgo._internal.io.fs.Fs.modeDir;[0m
      | [31m^[0m
      | stdgo.io.fs._Fs.Fs_Fields_ is not ready to be accessed, separate your type declarations in several files

[30;41m ERROR [0m stdgo/io/fs/Fs.hx:63: characters 20-26

   63 | [2m            { _0 : [0m[1mobj._0[0m[2m, _1 : obj._1 };[0m
      |                    [31m^^^^^^[0m
      | Dynamic should be stdgo.io.fs.File
