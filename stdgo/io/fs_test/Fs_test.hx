...
**/
var _formatTests : stdgo.Slice<T__struct_0> = (new stdgo.Slice<T__struct_0>(4, 4, ({ _input : ({ _name : ("hello.go" : stdgo.GoString), _size : (100i64 : stdgo.StdGoTypes.GoInt64), _mode : (420u32 : stdgo.io.fs.Fs.FileMode), _modTime : stdgo.time.Time.date((1970 : stdgo.StdGoTypes.GoInt), (1 : stdgo.time.Time.Month), (1 : stdgo.StdGoTypes.GoInt), (12 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), stdgo.time.Time.utc)?.__copy__(), _isDir : false } : T_formatTest), _wantFileInfo : ("-rw-r--r-- 100 1970-01-01 12:00:00 hello.go" : stdgo.GoString), _wantDirEntry : ("- hello.go" : stdgo.GoString) } : T__struct_0), ({ _input : ({ _name : ("home/gopher" : stdgo.GoString), _size : (0i64 : stdgo.StdGoTypes.GoInt64), _mode : (-2147483155u32 : stdgo.io.fs.Fs.FileMode), _modTime : stdgo.time.Time.date((1970 : stdgo.StdGoTypes.GoInt), (1 : stdgo.time.Time.Month), (1 : stdgo.StdGoTypes.GoInt), (12 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), stdgo.time.Time.utc)?.__copy__(), _isDir : true } : T_formatTest), _wantFileInfo : ("drwxr-xr-x 0 1970-01-01 12:00:00 home/gopher/" : stdgo.GoString), _wantDirEntry : ("d home/gopher/" : stdgo.GoString) } : T__struct_0), ({ _input : ({ _name : ("big" : stdgo.GoString), _size : (9223372036854775807i64 : stdgo.StdGoTypes.GoInt64), _mode : (524708u32 : stdgo.io.fs.Fs.FileMode), _modTime : stdgo.time.Time.date((1970 : stdgo.StdGoTypes.GoInt), (1 : stdgo.time.Time.Month), (1 : stdgo.StdGoTypes.GoInt), (12 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), stdgo.time.Time.utc)?.__copy__(), _isDir : false } : T_formatTest), _wantFileInfo : ("?rw-r--r-- 9223372036854775807 1970-01-01 12:00:00 big" : stdgo.GoString), _wantDirEntry : ("? big" : stdgo.GoString) } : T__struct_0), ({ _input : ({ _name : ("small" : stdgo.GoString), _size : (-9223372036854775808i64 : stdgo.StdGoTypes.GoInt64), _mode : (25166244u32 : stdgo.io.fs.Fs.FileMode), _modTime : stdgo.time.Time.date((1970 : stdgo.StdGoTypes.GoInt), (1 : stdgo.time.Time.Month), (1 : stdgo.StdGoTypes.GoInt), (12 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), stdgo.time.Time.utc)?.__copy__(), _isDir : false } : T_formatTest), _wantFileInfo : ("Surw-r--r-- -9223372036854775808 1970-01-01 12:00:00 small" : stdgo.GoString), _wantDirEntry : ("S small" : stdgo.GoString) } : T__struct_0)) : stdgo.Slice<T__struct_0>);
/**
...
({ _name : stdgo.Go.str(), _ok : false } : T__struct_1),
...
**/
var _tree : stdgo.StdGoTypes.Ref<stdgo.io.fs_test.Fs_test.Node> = (stdgo.Go.setRef((new Node(("testdata" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.Ref<stdgo.io.fs_test.Fs_test.Node>>(4, 4, (new stdgo.io.fs_test.Fs_test.Node(("a" : stdgo.GoString), (null : stdgo.Slice<stdgo.StdGoTypes.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.StdGoTypes.GoInt)) : stdgo.io.fs_test.Fs_test.Node), (new stdgo.io.fs_test.Fs_test.Node(("b" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.Ref<stdgo.io.fs_test.Fs_test.Node>>(0, 0) : stdgo.Slice<stdgo.StdGoTypes.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.StdGoTypes.GoInt)) : stdgo.io.fs_test.Fs_test.Node), (new stdgo.io.fs_test.Fs_test.Node(("c" : stdgo.GoString), (null : stdgo.Slice<stdgo.StdGoTypes.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.StdGoTypes.GoInt)) : stdgo.io.fs_test.Fs_test.Node), (new stdgo.io.fs_test.Fs_test.Node(("d" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.Ref<stdgo.io.fs_test.Fs_test.Node>>(3, 3, (new stdgo.io.fs_test.Fs_test.Node(("x" : stdgo.GoString), (null : stdgo.Slice<stdgo.StdGoTypes.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.StdGoTypes.GoInt)) : stdgo.io.fs_test.Fs_test.Node), (new stdgo.io.fs_test.Fs_test.Node(("y" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.Ref<stdgo.io.fs_test.Fs_test.Node>>(0, 0) : stdgo.Slice<stdgo.StdGoTypes.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.StdGoTypes.GoInt)) : stdgo.io.fs_test.Fs_test.Node), (new stdgo.io.fs_test.Fs_test.Node(("z" : stdgo.GoString), (new stdgo.Slice<stdgo.StdGoTypes.Ref<stdgo.io.fs_test.Fs_test.Node>>(2, 2, (new stdgo.io.fs_test.Fs_test.Node(("u" : stdgo.GoString), (null : stdgo.Slice<stdgo.StdGoTypes.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.StdGoTypes.GoInt)) : stdgo.io.fs_test.Fs_test.Node), (new stdgo.io.fs_test.Fs_test.Node(("v" : stdgo.GoString), (null : stdgo.Slice<stdgo.StdGoTypes.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.StdGoTypes.GoInt)) : stdgo.io.fs_test.Fs_test.Node)) : stdgo.Slice<stdgo.StdGoTypes.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.StdGoTypes.GoInt)) : stdgo.io.fs_test.Fs_test.Node)) : stdgo.Slice<stdgo.StdGoTypes.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.StdGoTypes.GoInt)) : stdgo.io.fs_test.Fs_test.Node)) : stdgo.Slice<stdgo.StdGoTypes.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.StdGoTypes.GoInt)) : Node)) : stdgo.StdGoTypes.Ref<stdgo.io.fs_test.Fs_test.Node>);
/**
...
function testFormatFileInfo(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (_i => _test in _formatTests) {
            var _got:stdgo.GoString = formatFileInfo(stdgo.Go.asInterface((stdgo.Go.setRef(_test._input) : stdgo.StdGoTypes.Ref<stdgo.io.fs_test.Fs_test.T_formatTest>)));
...
function testFormatDirEntry(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (_i => _test in _formatTests) {
            var _got:stdgo.GoString = formatDirEntry(stdgo.Go.asInterface((stdgo.Go.setRef(_test._input) : stdgo.StdGoTypes.Ref<stdgo.io.fs_test.Fs_test.T_formatTest>)));
...
function testGlob(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _tt in _globTests) {
            var __tmp__ = glob(_tt._fs, _tt._pattern), _matches:stdgo.Slice<stdgo.GoString> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
        ...
        for (__1 => _pattern in (new stdgo.Slice<stdgo.GoString>(3, 3, ("no_match" : stdgo.GoString), ("../*/no_match" : stdgo.GoString), ("\\*" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>)) {
            var __tmp__ = glob(stdgo.os.Os.dirFS(("." : stdgo.GoString)), _pattern), _matches:stdgo.Slice<stdgo.GoString> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
...
function testGlobError(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        for (__0 => _pattern in _bad) {
            var __tmp__ = glob(stdgo.os.Os.dirFS(("." : stdgo.GoString)), _pattern), __1:stdgo.Slice<stdgo.GoString> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
...
function testCVE202230630(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        var __tmp__ = glob(stdgo.os.Os.dirFS(("." : stdgo.GoString)), ("/*" : stdgo.GoString) + stdgo.strings.Strings.repeat(("/" : stdgo.GoString), (10001 : stdgo.StdGoTypes.GoInt))), __0:stdgo.Slice<stdgo.GoString> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (stdgo.Go.toInterface(_err) != (stdgo.Go.toInterface(stdgo.path.Path.errBadPattern))) {
...
function testGlobMethod(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        var __tmp__ = glob(stdgo.Go.asInterface((new T_globOnly(stdgo.Go.asInterface(_testFsys)) : T_globOnly)), ("*.txt" : stdgo.GoString)), _names:stdgo.Slice<stdgo.GoString> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        _check(("readDirOnly" : stdgo.GoString), _names, _err);
        {
            var __tmp__ = glob(stdgo.Go.asInterface((new T_openOnly(stdgo.Go.asInterface(_testFsys)) : T_openOnly)), ("*.txt" : stdgo.GoString));
            _names = __tmp__._0;
            _err = __tmp__._1;
        };
...
function testReadDir(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        var __tmp__ = readDir(stdgo.Go.asInterface((new T_readDirOnly(stdgo.Go.asInterface(_testFsys)) : T_readDirOnly)), ("." : stdgo.GoString)), _dirs:stdgo.Slice<stdgo.io.fs.Fs.DirEntry> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        _check(("readDirOnly" : stdgo.GoString), _dirs, _err);
        {
            var __tmp__ = readDir(stdgo.Go.asInterface((new T_openOnly(stdgo.Go.asInterface(_testFsys)) : T_openOnly)), ("." : stdgo.GoString));
            _dirs = __tmp__._0;
            _err = __tmp__._1;
        };
...
function testFileInfoToDirEntry(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        for (__0 => _test in _tests) {
            var _test:T__struct_3 = {
                final x = _test;
                ({ _path : x._path, _wantMode : x._wantMode, _wantDir : x._wantDir } : T__struct_3);
            };
            _t.run(_test._path, function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
                var __tmp__ = stat(stdgo.Go.asInterface(_testFs), _test._path), _fi:stdgo.io.fs.Fs.FileInfo = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    _t.fatal(stdgo.Go.toInterface(_err));
                };
                ...
                {
                    var __0:stdgo.GoString = _dirEntry.name(), __1:stdgo.GoString = _test._path, _w:stdgo.GoString = __1, _g:stdgo.GoString = __0;
                    if (_g != (_w)) {
...
function testReadFile(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        var __tmp__ = readFile(stdgo.Go.asInterface((new T_readFileOnly(stdgo.Go.asInterface(_testFsys)) : T_readFileOnly)), ("hello.txt" : stdgo.GoString)), _data:stdgo.Slice<stdgo.StdGoTypes.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        ...
        {
            var __tmp__ = readFile(stdgo.Go.asInterface((new T_openOnly(stdgo.Go.asInterface(_testFsys)) : T_openOnly)), ("hello.txt" : stdgo.GoString));
            _data = __tmp__._0;
            _err = __tmp__._1;
        };
        if (((_data : stdgo.GoString) != ("hello, world" : stdgo.GoString)) || (_err != null)) {
...
function testStat(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        var _check:(stdgo.GoString, stdgo.io.fs.Fs.FileInfo, stdgo.Error) -> Void = function(_desc:stdgo.GoString, _info:FileInfo, _err:stdgo.Error):Void {
            ...
            if (((_err != null) || (_info == null)) || (_info.mode() != (302u32 : stdgo.io.fs.Fs.FileMode))) {
                ...
                if (_info != null) {
                    _infoStr = stdgo.fmt.Fmt.sprintf(("FileInfo(Mode: %#o)" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_info.mode())));
                };
        ...
        var __tmp__ = stat(stdgo.Go.asInterface((new T_statOnly(stdgo.Go.asInterface(_testFsys)) : T_statOnly)), ("hello.txt" : stdgo.GoString)), _info:stdgo.io.fs.Fs.FileInfo = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        _check(("statOnly" : stdgo.GoString), _info, _err);
        {
            var __tmp__ = stat(stdgo.Go.asInterface((new T_openOnly(stdgo.Go.asInterface(_testFsys)) : T_openOnly)), ("hello.txt" : stdgo.GoString));
            _info = __tmp__._0;
            _err = __tmp__._1;
        };
...
function testSub(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        var __tmp__ = sub(stdgo.Go.asInterface((new T_subOnly(stdgo.Go.asInterface(_testFsys)) : T_subOnly)), ("sub" : stdgo.GoString)), _sub:stdgo.io.fs.Fs.FS = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        _check(("subOnly" : stdgo.GoString), _sub, _err);
        {
            var __tmp__ = sub(stdgo.Go.asInterface((new T_openOnly(stdgo.Go.asInterface(_testFsys)) : T_openOnly)), ("sub" : stdgo.GoString));
            _sub = __tmp__._0;
            _err = __tmp__._1;
        };
...
function _mark(_entry:DirEntry, _err:stdgo.Error, _errors:stdgo.StdGoTypes.Ref<stdgo.Slice<stdgo.Error>>, _clear:Bool):stdgo.Error {
        var _name:stdgo.GoString = _entry.name();
        _walkTree(_tree, _tree._name, function(_path:stdgo.GoString, _n:stdgo.StdGoTypes.Ref<Node>):Void {
            if (_n._name == (_name)) {
                _n._mark++;
            };
...
function testIssue51617(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        try {
            ...
            var _err:stdgo.Error = walkDir(stdgo.os.Os.dirFS(_dir), ("." : stdgo.GoString), function(_path:stdgo.GoString, _d:DirEntry, _err:stdgo.Error):stdgo.Error {
                if (_err != null) {
