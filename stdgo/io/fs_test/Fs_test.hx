...
**/
var _formatTests : stdgo.Slice<T__struct_0> = (new stdgo.Slice<T__struct_0>(4, 4, ({ _input : ({ _name : ("hello.go" : stdgo.GoString), _size : (100i64 : stdgo.GoInt64), _mode : (420u32 : stdgo.io.fs.Fs.FileMode), _modTime : stdgo.time.Time.date((1970 : stdgo.GoInt), (1 : stdgo.time.Time.Month), (1 : stdgo.GoInt), (12 : stdgo.GoInt), (0 : stdgo.GoInt), (0 : stdgo.GoInt), (0 : stdgo.GoInt), stdgo.time.Time.utc)?.__copy__(), _isDir : false } : stdgo.io.fs_test.Fs_test.T_formatTest), _wantFileInfo : ("-rw-r--r-- 100 1970-01-01 12:00:00 hello.go" : stdgo.GoString), _wantDirEntry : ("- hello.go" : stdgo.GoString) } : T__struct_0), ({ _input : ({ _name : ("home/gopher" : stdgo.GoString), _size : (0i64 : stdgo.GoInt64), _mode : (-2147483155u32 : stdgo.io.fs.Fs.FileMode), _modTime : stdgo.time.Time.date((1970 : stdgo.GoInt), (1 : stdgo.time.Time.Month), (1 : stdgo.GoInt), (12 : stdgo.GoInt), (0 : stdgo.GoInt), (0 : stdgo.GoInt), (0 : stdgo.GoInt), stdgo.time.Time.utc)?.__copy__(), _isDir : true } : stdgo.io.fs_test.Fs_test.T_formatTest), _wantFileInfo : ("drwxr-xr-x 0 1970-01-01 12:00:00 home/gopher/" : stdgo.GoString), _wantDirEntry : ("d home/gopher/" : stdgo.GoString) } : T__struct_0), ({ _input : ({ _name : ("big" : stdgo.GoString), _size : (9223372036854775807i64 : stdgo.GoInt64), _mode : (524708u32 : stdgo.io.fs.Fs.FileMode), _modTime : stdgo.time.Time.date((1970 : stdgo.GoInt), (1 : stdgo.time.Time.Month), (1 : stdgo.GoInt), (12 : stdgo.GoInt), (0 : stdgo.GoInt), (0 : stdgo.GoInt), (0 : stdgo.GoInt), stdgo.time.Time.utc)?.__copy__(), _isDir : false } : stdgo.io.fs_test.Fs_test.T_formatTest), _wantFileInfo : ("?rw-r--r-- 9223372036854775807 1970-01-01 12:00:00 big" : stdgo.GoString), _wantDirEntry : ("? big" : stdgo.GoString) } : T__struct_0), ({ _input : ({ _name : ("small" : stdgo.GoString), _size : (-9223372036854775808i64 : stdgo.GoInt64), _mode : (25166244u32 : stdgo.io.fs.Fs.FileMode), _modTime : stdgo.time.Time.date((1970 : stdgo.GoInt), (1 : stdgo.time.Time.Month), (1 : stdgo.GoInt), (12 : stdgo.GoInt), (0 : stdgo.GoInt), (0 : stdgo.GoInt), (0 : stdgo.GoInt), stdgo.time.Time.utc)?.__copy__(), _isDir : false } : stdgo.io.fs_test.Fs_test.T_formatTest), _wantFileInfo : ("Surw-r--r-- -9223372036854775808 1970-01-01 12:00:00 small" : stdgo.GoString), _wantDirEntry : ("S small" : stdgo.GoString) } : T__struct_0)) : stdgo.Slice<T__struct_0>);
/**
...
({ _name : ("x\\y" : stdgo.GoString), _ok : true } : T__struct_1),
({ _name : ("x:y" : stdgo.GoString), _ok : true } : T__struct_1),
({ _name : ("\\x" : stdgo.GoString), _ok : true } : T__struct_1)) : stdgo.Slice<T__struct_1>);
/**
    
    
    
**/
var _globTests : stdgo.Slice<T__struct_2> = (new stdgo.Slice<T__struct_2>(5, 5, ({ _fs : stdgo.os.Os.dirFS(("." : stdgo.GoString)), _pattern : ("glob.go" : stdgo.GoString), _result : ("glob.go" : stdgo.GoString) } : T__struct_2), ({ _fs : stdgo.os.Os.dirFS(("." : stdgo.GoString)), _pattern : ("gl?b.go" : stdgo.GoString), _result : ("glob.go" : stdgo.GoString) } : T__struct_2), ({ _fs : stdgo.os.Os.dirFS(("." : stdgo.GoString)), _pattern : ("gl\\ob.go" : stdgo.GoString), _result : ("glob.go" : stdgo.GoString) } : T__struct_2), ({ _fs : stdgo.os.Os.dirFS(("." : stdgo.GoString)), _pattern : ("*" : stdgo.GoString), _result : ("glob.go" : stdgo.GoString) } : T__struct_2), ({ _fs : stdgo.os.Os.dirFS((".." : stdgo.GoString)), _pattern : ("*/glob.go" : stdgo.GoString), _result : ("fs/glob.go" : stdgo.GoString) } : T__struct_2)) : stdgo.Slice<T__struct_2>);
/**
...
var _testFsys : stdgo.testing.fstest.Fstest.MapFS = ({
        final x = new stdgo.GoMap.GoStringMap<stdgo.Ref<stdgo.testing.fstest.Fstest.MapFile>>();
        x.__defaultValue__ = () -> (null : stdgo.Ref<stdgo.testing.fstest.Fstest.MapFile>);
        @:mergeBlock {
            x.set(("hello.txt" : stdgo.GoString), ({ data : (("hello, world" : stdgo.GoString) : stdgo.Slice<stdgo.GoByte>), mode : (302u32 : stdgo.io.fs.Fs.FileMode), modTime : stdgo.time.Time.now()?.__copy__(), sys : stdgo.Go.toInterface(stdgo.Go.pointer(_sysValue)) } : stdgo.testing.fstest.Fstest.MapFile));
            x.set(("sub/goodbye.txt" : stdgo.GoString), ({ data : (("goodbye, world" : stdgo.GoString) : stdgo.Slice<stdgo.GoByte>), mode : (302u32 : stdgo.io.fs.Fs.FileMode), modTime : stdgo.time.Time.now()?.__copy__(), sys : stdgo.Go.toInterface(stdgo.Go.pointer(_sysValue)) } : stdgo.testing.fstest.Fstest.MapFile));
        };
        x;
    } : stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.testing.fstest.Fstest.MapFile>>);
/**
...
**/
var _tree : stdgo.Ref<stdgo.io.fs_test.Fs_test.Node> = (stdgo.Go.setRef((new stdgo.io.fs_test.Fs_test.Node(("testdata" : stdgo.GoString), (new stdgo.Slice<stdgo.Ref<stdgo.io.fs_test.Fs_test.Node>>(4, 4, (new stdgo.io.fs_test.Fs_test.Node(("a" : stdgo.GoString), (null : stdgo.Slice<stdgo.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.GoInt)) : stdgo.io.fs_test.Fs_test.Node), (new stdgo.io.fs_test.Fs_test.Node(("b" : stdgo.GoString), (new stdgo.Slice<stdgo.Ref<stdgo.io.fs_test.Fs_test.Node>>(0, 0) : stdgo.Slice<stdgo.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.GoInt)) : stdgo.io.fs_test.Fs_test.Node), (new stdgo.io.fs_test.Fs_test.Node(("c" : stdgo.GoString), (null : stdgo.Slice<stdgo.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.GoInt)) : stdgo.io.fs_test.Fs_test.Node), (new stdgo.io.fs_test.Fs_test.Node(("d" : stdgo.GoString), (new stdgo.Slice<stdgo.Ref<stdgo.io.fs_test.Fs_test.Node>>(3, 3, (new stdgo.io.fs_test.Fs_test.Node(("x" : stdgo.GoString), (null : stdgo.Slice<stdgo.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.GoInt)) : stdgo.io.fs_test.Fs_test.Node), (new stdgo.io.fs_test.Fs_test.Node(("y" : stdgo.GoString), (new stdgo.Slice<stdgo.Ref<stdgo.io.fs_test.Fs_test.Node>>(0, 0) : stdgo.Slice<stdgo.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.GoInt)) : stdgo.io.fs_test.Fs_test.Node), (new stdgo.io.fs_test.Fs_test.Node(("z" : stdgo.GoString), (new stdgo.Slice<stdgo.Ref<stdgo.io.fs_test.Fs_test.Node>>(2, 2, (new stdgo.io.fs_test.Fs_test.Node(("u" : stdgo.GoString), (null : stdgo.Slice<stdgo.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.GoInt)) : stdgo.io.fs_test.Fs_test.Node), (new stdgo.io.fs_test.Fs_test.Node(("v" : stdgo.GoString), (null : stdgo.Slice<stdgo.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.GoInt)) : stdgo.io.fs_test.Fs_test.Node)) : stdgo.Slice<stdgo.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.GoInt)) : stdgo.io.fs_test.Fs_test.Node)) : stdgo.Slice<stdgo.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.GoInt)) : stdgo.io.fs_test.Fs_test.Node)) : stdgo.Slice<stdgo.Ref<stdgo.io.fs_test.Fs_test.Node>>), (0 : stdgo.GoInt)) : stdgo.io.fs_test.Fs_test.Node)) : stdgo.Ref<stdgo.io.fs_test.Fs_test.Node>);
/**
...
@:structInit @:private @:using(stdgo.io.fs_test.Fs_test.T_formatTest_static_extension) class T_formatTest {
    ...
    public function new(?_name:stdgo.GoString, ?_size:stdgo.GoInt64, ?_mode:stdgo.io.fs.Fs.FileMode, ?_modTime:stdgo.time.Time.Time, ?_isDir:Bool) {
...
@:structInit class Node {
    public var _name : stdgo.GoString = "";
    public var _entries : stdgo.Slice<stdgo.Ref<stdgo.io.fs_test.Fs_test.Node>> = (null : stdgo.Slice<stdgo.Ref<stdgo.io.fs_test.Fs_test.Node>>);
    public var _mark : stdgo.GoInt = 0;
    public function new(?_name:stdgo.GoString, ?_entries:stdgo.Slice<stdgo.Ref<stdgo.io.fs_test.Fs_test.Node>>, ?_mark:stdgo.GoInt) {
        if (_name != null) this._name = _name;
...
function exampleWalkDir():Void {
        ...
        fs.walkDir(_fileSystem, ("." : stdgo.GoString), function(_path:stdgo.GoString, _d:stdgo.io.fs.Fs.DirEntry, _err:stdgo.Error):stdgo.Error {
            if (_err != null) {
...
function testFormatFileInfo(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        for (_i => _test in _formatTests) {
            var _got:stdgo.GoString = formatFileInfo(stdgo.Go.asInterface((stdgo.Go.setRef(_test._input) : stdgo.Ref<stdgo.io.fs_test.Fs_test.T_formatTest>)))?.__copy__();
...
function testFormatDirEntry(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        for (_i => _test in _formatTests) {
            var _got:stdgo.GoString = formatDirEntry(stdgo.Go.asInterface((stdgo.Go.setRef(_test._input) : stdgo.Ref<stdgo.io.fs_test.Fs_test.T_formatTest>)))?.__copy__();
...
function testValidPath(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testGlob(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testGlobError(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        for (__0 => _pattern in _bad) {
            var __tmp__ = glob(stdgo.os.Os.dirFS(("." : stdgo.GoString)), _pattern?.__copy__()), __1:stdgo.Slice<stdgo.GoString> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
...
function testCVE202230630(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __tmp__ = glob(stdgo.os.Os.dirFS(("." : stdgo.GoString)), ("/*" : stdgo.GoString) + stdgo.strings.Strings.repeat(("/" : stdgo.GoString), (10001 : stdgo.GoInt))?.__copy__()?.__copy__()), __0:stdgo.Slice<stdgo.GoString> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (stdgo.Go.toInterface(_err) != (stdgo.Go.toInterface(stdgo.path.Path.errBadPattern))) {
            _t.fatalf(("Glob returned err=%v, want %v" : stdgo.GoString), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(stdgo.path.Path.errBadPattern));
        };
    }
/**
...
function testGlobMethod(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        var __tmp__ = glob(stdgo.Go.asInterface((new stdgo.io.fs_test.Fs_test.T_globOnly(stdgo.Go.asInterface(_testFsys)) : stdgo.io.fs_test.Fs_test.T_globOnly)), ("*.txt" : stdgo.GoString)), _names:stdgo.Slice<stdgo.GoString> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        _check(("readDirOnly" : stdgo.GoString), _names, _err);
        {
            var __tmp__ = glob(stdgo.Go.asInterface((new stdgo.io.fs_test.Fs_test.T_openOnly(stdgo.Go.asInterface(_testFsys)) : stdgo.io.fs_test.Fs_test.T_openOnly)), ("*.txt" : stdgo.GoString));
            _names = __tmp__._0;
            _err = __tmp__._1;
        };
...
function testReadDir(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        var __tmp__ = readDir(stdgo.Go.asInterface((new stdgo.io.fs_test.Fs_test.T_readDirOnly(stdgo.Go.asInterface(_testFsys)) : stdgo.io.fs_test.Fs_test.T_readDirOnly)), ("." : stdgo.GoString)), _dirs:stdgo.Slice<stdgo.io.fs.Fs.DirEntry> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        _check(("readDirOnly" : stdgo.GoString), _dirs, _err);
        {
            var __tmp__ = readDir(stdgo.Go.asInterface((new stdgo.io.fs_test.Fs_test.T_openOnly(stdgo.Go.asInterface(_testFsys)) : stdgo.io.fs_test.Fs_test.T_openOnly)), ("." : stdgo.GoString));
            _dirs = __tmp__._0;
            _err = __tmp__._1;
        };
        _check(("openOnly" : stdgo.GoString), _dirs, _err);
        var __tmp__ = sub(stdgo.Go.asInterface(_testFsys), ("." : stdgo.GoString)), _sub:stdgo.io.fs.Fs.FS = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
...
function testFileInfoToDirEntry(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _testFs:stdgo.testing.fstest.Fstest.MapFS = ({
            final x = new stdgo.GoMap.GoStringMap<stdgo.Ref<stdgo.testing.fstest.Fstest.MapFile>>();
            x.__defaultValue__ = () -> (null : stdgo.Ref<stdgo.testing.fstest.Fstest.MapFile>);
            @:mergeBlock {
                x.set(("notadir.txt" : stdgo.GoString), ({ data : (("hello, world" : stdgo.GoString) : stdgo.Slice<stdgo.GoByte>), mode : (0u32 : stdgo.io.fs.Fs.FileMode), modTime : stdgo.time.Time.now()?.__copy__(), sys : stdgo.Go.toInterface(stdgo.Go.pointer(_sysValue)) } : stdgo.testing.fstest.Fstest.MapFile));
                x.set(("adir" : stdgo.GoString), ({ data : (null : stdgo.Slice<stdgo.GoUInt8>), mode : (-2147483648u32 : stdgo.io.fs.Fs.FileMode), modTime : stdgo.time.Time.now()?.__copy__(), sys : stdgo.Go.toInterface(stdgo.Go.pointer(_sysValue)) } : stdgo.testing.fstest.Fstest.MapFile));
            };
            x;
        } : stdgo.GoMap<stdgo.GoString, stdgo.Ref<stdgo.testing.fstest.Fstest.MapFile>>);
        var _tests = (new stdgo.Slice<T__struct_3>(2, 2, ({ _path : ("notadir.txt" : stdgo.GoString), _wantMode : (0u32 : stdgo.io.fs.Fs.FileMode), _wantDir : false } : T__struct_3), ({ _path : ("adir" : stdgo.GoString), _wantMode : (-2147483648u32 : stdgo.io.fs.Fs.FileMode), _wantDir : true } : T__struct_3)) : stdgo.Slice<T__struct_3>);
        for (__0 => _test in _tests) {
            var _test:T__struct_3 = {
                final x = _test;
                ({ _path : x._path?.__copy__(), _wantMode : x._wantMode, _wantDir : x._wantDir } : T__struct_3);
            };
            _t.run(_test._path?.__copy__(), function(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testReadFile(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __tmp__ = readFile(stdgo.Go.asInterface((new stdgo.io.fs_test.Fs_test.T_readFileOnly(stdgo.Go.asInterface(_testFsys)) : stdgo.io.fs_test.Fs_test.T_readFileOnly)), ("hello.txt" : stdgo.GoString)), _data:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        ...
        {
            var __tmp__ = readFile(stdgo.Go.asInterface((new stdgo.io.fs_test.Fs_test.T_openOnly(stdgo.Go.asInterface(_testFsys)) : stdgo.io.fs_test.Fs_test.T_openOnly)), ("hello.txt" : stdgo.GoString));
            _data = __tmp__._0;
            _err = __tmp__._1;
        };
        if (((_data : stdgo.GoString) != ("hello, world" : stdgo.GoString)) || (_err != null)) {
...
function testStat(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _check:(stdgo.GoString, stdgo.io.fs.Fs.FileInfo, stdgo.Error) -> Void = function(_desc:stdgo.GoString, _info:FileInfo, _err:stdgo.Error):Void {
            ...
            if (((_err != null) || (_info == null)) || (_info.mode() != (302u32 : stdgo.io.fs.Fs.FileMode))) {
                ...
                if (_info != null) {
                    _infoStr = stdgo.fmt.Fmt.sprintf(("FileInfo(Mode: %#o)" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_info.mode())))?.__copy__();
                };
        ...
        var __tmp__ = stat(stdgo.Go.asInterface((new stdgo.io.fs_test.Fs_test.T_statOnly(stdgo.Go.asInterface(_testFsys)) : stdgo.io.fs_test.Fs_test.T_statOnly)), ("hello.txt" : stdgo.GoString)), _info:stdgo.io.fs.Fs.FileInfo = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        _check(("statOnly" : stdgo.GoString), _info, _err);
        {
            var __tmp__ = stat(stdgo.Go.asInterface((new stdgo.io.fs_test.Fs_test.T_openOnly(stdgo.Go.asInterface(_testFsys)) : stdgo.io.fs_test.Fs_test.T_openOnly)), ("hello.txt" : stdgo.GoString));
            _info = __tmp__._0;
            _err = __tmp__._1;
        };
...
function testSub(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        var __tmp__ = sub(stdgo.Go.asInterface((new stdgo.io.fs_test.Fs_test.T_subOnly(stdgo.Go.asInterface(_testFsys)) : stdgo.io.fs_test.Fs_test.T_subOnly)), ("sub" : stdgo.GoString)), _sub:stdgo.io.fs.Fs.FS = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        _check(("subOnly" : stdgo.GoString), _sub, _err);
        {
            var __tmp__ = sub(stdgo.Go.asInterface((new stdgo.io.fs_test.Fs_test.T_openOnly(stdgo.Go.asInterface(_testFsys)) : stdgo.io.fs_test.Fs_test.T_openOnly)), ("sub" : stdgo.GoString));
            _sub = __tmp__._0;
            _err = __tmp__._1;
        };
...
function _makeTree():FS {
        ...
        _walkTree(_tree, _tree._name?.__copy__(), function(_path:stdgo.GoString, _n:stdgo.Ref<Node>):Void {
            if (_n._entries == null) {
                _fsys[_path] = (stdgo.Go.setRef((new stdgo.testing.fstest.Fstest.MapFile() : stdgo.testing.fstest.Fstest.MapFile)) : stdgo.Ref<stdgo.testing.fstest.Fstest.MapFile>);
            } else {
                _fsys[_path] = (stdgo.Go.setRef(({ mode : (-2147483648u32 : stdgo.io.fs.Fs.FileMode) } : stdgo.testing.fstest.Fstest.MapFile)) : stdgo.Ref<stdgo.testing.fstest.Fstest.MapFile>);
            };
        });
...
function testWalkDir(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testIssue51617(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            ...
            var _bad:stdgo.GoString = stdgo.path.filepath.Filepath.join(_dir?.__copy__(), ("a" : stdgo.GoString), ("bad" : stdgo.GoString))?.__copy__();
            {
            ...
            var _err:stdgo.Error = walkDir(stdgo.os.Os.dirFS(_dir?.__copy__()), ("." : stdgo.GoString), function(_path:stdgo.GoString, _d:DirEntry, _err:stdgo.Error):stdgo.Error {
                if (_err != null) {
...
@:keep @:allow(stdgo.io.fs_test.Fs_test.T_formatTest_asInterface) class T_formatTest_static_extension {
    ...
    @:keep
    static public function modTime( _fs:stdgo.Ref<T_formatTest>):stdgo.time.Time.Time {
        @:recv var _fs:stdgo.Ref<T_formatTest> = _fs;
