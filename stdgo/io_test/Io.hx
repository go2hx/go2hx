...
function main():Void {
        var _m = stdgo.testing.Testing.mainStart({
            ...
            __self__.writeProfileTo = #if !macro function(_name:GoString, _w:Writer, _debug:GoInt):stdgo.Error return ((new stdgo.testing.internal.testdeps.Testdeps.TestDeps() : stdgo.testing.internal.testdeps.Testdeps.TestDeps)).writeProfileTo(_name, _w, _debug) #else null #end;
            __self__;
