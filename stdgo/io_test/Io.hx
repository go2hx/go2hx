...
private var _tests:Slice<stdgo.testing.Testing.InternalTest> = (new Slice<stdgo.testing.Testing.InternalTest>(0, 0,
	...
	(new stdgo.testing.Testing.InternalTest(("TestCopyReadErrWriteErr" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestReadAtLeastWithDataAndEOF" : GoString),
		stdgo.io_test.Io_test.testReadAtLeastWithDataAndEOF) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestReadAtLeastWithDataAndError" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestSectionReader_ReadAt" : GoString),
		stdgo.io_test.Io_test.testSectionReader_ReadAt) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestSectionReader_Seek" : GoString),
		stdgo.io_test.Io_test.testSectionReader_Seek) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestSectionReader_Size" : GoString),
		stdgo.io_test.Io_test.testSectionReader_Size) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestSectionReader_Max" : GoString),
		stdgo.io_test.Io_test.testSectionReader_Max) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestCopyLargeWriter" : GoString),
		stdgo.io_test.Io_test.testCopyLargeWriter) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestNopCloserWriterToForwarding" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestMultiReaderAsWriterTo" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestPipeWriteClose2" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestWriteAfterWriterClose" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestPipeConcurrent" : GoString),
...
private var _benchmarks:Slice<stdgo.testing.Testing.InternalBenchmark> = (new Slice<stdgo.testing.Testing.InternalBenchmark>(0, 0,
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkCopyNSmall" : GoString),
		stdgo.io_test.Io_test.benchmarkCopyNSmall) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkCopyNLarge" : GoString),
...
private var _examples:Slice<stdgo.testing.Testing.InternalExample> = (new Slice<stdgo.testing.Testing.InternalExample>(0, 0,
	(new stdgo.testing.Testing.InternalExample(("ExampleCopy" : GoString), stdgo.io_test.Io_test.exampleCopy,
		("some io.Reader stream to be read\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleCopyBuffer" : GoString), stdgo.io_test.Io_test.exampleCopyBuffer,
		("first reader\nsecond reader\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	...
	(new stdgo.testing.Testing.InternalExample(("ExampleReadAtLeast" : GoString), stdgo.io_test.Io_test.exampleReadAtLeast,
		("some io.Reader\nerror: short buffer\nerror: unexpected EOF\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleReadFull" : GoString), stdgo.io_test.Io_test.exampleReadFull,
		("some\nerror: unexpected EOF\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	...
	(new stdgo.testing.Testing.InternalExample(("ExampleLimitReader" : GoString), stdgo.io_test.Io_test.exampleLimitReader, ("some\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleMultiReader" : GoString), stdgo.io_test.Io_test.exampleMultiReader,
		("first reader second reader third reader\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleTeeReader" : GoString), stdgo.io_test.Io_test.exampleTeeReader,
		("some io.Reader stream to be read\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleSectionReader" : GoString), stdgo.io_test.Io_test.exampleSectionReader,
		("io.Reader stream\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleSectionReader_Read" : GoString), stdgo.io_test.Io_test.exampleSectionReader_Read,
		("io.Reader\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleSectionReader_ReadAt" : GoString), stdgo.io_test.Io_test.exampleSectionReader_ReadAt,
		("stream\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleSectionReader_Seek" : GoString), stdgo.io_test.Io_test.exampleSectionReader_Seek,
		("stream\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleSectionReader_Size" : GoString), stdgo.io_test.Io_test.exampleSectionReader_Size, ("17\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleSeeker_Seek" : GoString), stdgo.io_test.Io_test.exampleSeeker_Seek,
		("io.Reader stream to be read\nread\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleMultiWriter" : GoString), stdgo.io_test.Io_test.exampleMultiWriter,
		("some io.Reader stream to be read\nsome io.Reader stream to be read\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExamplePipe" : GoString), stdgo.io_test.Io_test.examplePipe,
		("some io.Reader stream to be read\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleReadAll" : GoString), stdgo.io_test.Io_test.exampleReadAll,
