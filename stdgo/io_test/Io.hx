...
function main():Void {
	var _m = stdgo.testing.Testing.mainStart({
		...
		__self__.startCPUProfile = #if !macro function(_w:Writer):stdgo.Error return
		...
		__self__.startTestLog = #if !macro function(_w:Writer):Void(new stdgo.testing.internal.testdeps.Testdeps.TestDeps()
		...
		__self__.writeProfileTo = #if !macro function(__0:GoString, __1:Writer,
