...
var _pipeTests:Slice<stdgo.io_test.Io_test.T_pipeTest> = (new Slice<stdgo.io_test.Io_test.T_pipeTest>(0, 0,
	...
	(new stdgo.io_test.Io_test.T_pipeTest(false, (null : stdgo.Error), false) : stdgo.io_test.Io_test.T_pipeTest),
	(new stdgo.io_test.Io_test.T_pipeTest(false, (null : stdgo.Error), true) : stdgo.io_test.Io_test.T_pipeTest),
...
@:structInit @:using(stdgo.io_test.Io_test.Buffer_static_extension) class Buffer {
	...
	@:embedded
	public function readByte():{var _0:GoUInt8; var _1:stdgo.Error;}
		return buffer.readByte();

	@:embedded
	public function readBytes(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
		return buffer.readBytes(_c);

	@:embedded
	public function readRune():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
		return buffer.readRune();

	@:embedded
	public function readString(_c:GoUInt8):{var _0:GoString; var _1:stdgo.Error;}
	...
	@:embedded
	public function unreadByte():stdgo.Error
		return buffer.unreadByte();

	@:embedded
	public function unreadRune():stdgo.Error
	...
	@:embedded
	public function writeRune(_new:GoInt32):{var _0:GoInt; var _1:stdgo.Error;}
		return buffer.writeRune(_new);

	@:embedded
	public function writeString(__0:GoString):{var _0:GoInt; var _1:stdgo.Error;}
	...
	@:embedded
	public function _readSlice(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
...
@:structInit @:using(stdgo.io_test.Io_test.T_writeToChecker_static_extension) private class T_writeToChecker {
	...
	@:embedded
	public function readFrom(_r:Reader):{var _0:GoInt64; var _1:stdgo.Error;}
...
@:structInit @:using(stdgo.io_test.Io_test.T_dataAndErrorBuffer_static_extension) private class T_dataAndErrorBuffer {
	...
	@:embedded
	public function writeTo(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
...
function exampleCopy():Void {
	var _r = stdgo.strings.Strings.newReader((Go.str("some io.Reader stream to be read\n") : GoString));
	{
		var __tmp__ = stdgo.io.Io.copy({
			...
			__self__.readAt = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
				return stdgo.os.Os.stdout.readAt(_p, _off) #else null #end;
			__self__.readDir = #if !macro function(_pid:GoInt):{var _0:Slice<stdgo.io.fs.Fs.DirEntry>; var _1:stdgo.Error;}
				return stdgo.os.Os.stdout.readDir(_pid) #else null #end;
			...
			__self__.readdir = #if !macro function(_pid:GoInt):{var _0:Slice<stdgo.io.fs.Fs.FileInfo>; var _1:stdgo.Error;}
				return stdgo.os.Os.stdout.readdir(_pid) #else null #end;
			__self__.readdirnames = #if !macro function(_pid:GoInt):{var _0:Slice<GoString>; var _1:stdgo.Error;}
				return stdgo.os.Os.stdout.readdirnames(_pid) #else null #end;
			...
			__self__.writeAt = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
				return stdgo.os.Os.stdout.writeAt(_p, _off) #else null #end;
			...
			__self__._pread = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
				return stdgo.os.Os.stdout._pread(_p, _off) #else null #end;
			__self__._pwrite = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
				return stdgo.os.Os.stdout._pwrite(_p, _off) #else null #end;
			...
			__self__._readFrom = #if !macro function(_r__:Reader):{var _0:GoInt64; var _1:Bool; var _2:stdgo.Error;}
			...
			final __self__ = new stdgo.strings.Strings.Reader_asInterface(_r);
			__self__.len = #if !macro function():GoInt return _r.len() #else null #end;
			__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
				return _r.read(_p) #else null #end;
			__self__.readAt = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
				return _r.readAt(_p, _off) #else null #end;
			...
			__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
...
function exampleCopyBuffer():Void {
	...
	var _buf = new Slice<GoUInt8>((8 : GoInt).toBasic(), 0, ...[for (i in 0...(8 : GoInt).toBasic()) (0 : GoUInt8)]);
	{
		var __tmp__ = stdgo.io.Io.copyBuffer({
			...
			__self__.readDir = #if !macro function(_pid:GoInt):{var _0:Slice<stdgo.io.fs.Fs.DirEntry>; var _1:stdgo.Error;}
				return stdgo.os.Os.stdout.readDir(_pid) #else null #end;
			__self__.readFrom = #if !macro function(_r:Reader):{var _0:GoInt64; var _1:stdgo.Error;}
			...
			__self__._read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
				return stdgo.os.Os.stdout._read(_p) #else null #end;
			__self__._readFrom = #if !macro function(_r:Reader):{var _0:GoInt64; var _1:Bool; var _2:stdgo.Error;}
			...
			final __self__ = new stdgo.strings.Strings.Reader_asInterface(_r1);
			__self__.len = #if !macro function():GoInt return _r1.len() #else null #end;
			__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
				return _r1.read(_p) #else null #end;
			__self__.readAt = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
				return _r1.readAt(_p, _off) #else null #end;
			__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
				return _r1.readByte() #else null #end;
			__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
				return _r1.readRune() #else null #end;
			__self__.reset = #if !macro function(__0:GoString):Void _r1.reset(__0) #else null #end;
			__self__.seek = #if !macro function(_offset:GoInt64, _whence:GoInt):{var _0:GoInt64; var _1:stdgo.Error;}
				return _r1.seek(_offset, _whence) #else null #end;
			...
			__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
				return _r1.writeTo(_w) #else null #end;
			__self__;
	...
	};
	{
		var __tmp__ = stdgo.io.Io.copyBuffer({
			...
			__self__._setWriteDeadline = #if !macro function(__0:stdgo.time.Time.Time):stdgo.Error return
				stdgo.os.Os.stdout._setWriteDeadline(__0) #else null #end;
			__self__._wrapErr = #if !macro function(_op:GoString, _err_:stdgo.Error):stdgo.Error return stdgo.os.Os.stdout._wrapErr(_op,
				_err_) #else null #end;
			__self__._write = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
				return stdgo.os.Os.stdout._write(_p) #else null #end;
			__self__;
		}, {
			final __self__ = new stdgo.strings.Strings.Reader_asInterface(_r2);
			__self__.len = #if !macro function():GoInt return _r2.len() #else null #end;
			__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
				return _r2.read(_p) #else null #end;
			__self__.readAt = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
				return _r2.readAt(_p, _off) #else null #end;
			__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
				return _r2.readByte() #else null #end;
			__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
				return _r2.readRune() #else null #end;
			__self__.reset = #if !macro function(__0:GoString):Void _r2.reset(__0) #else null #end;
			__self__.seek = #if !macro function(_offset:GoInt64, _whence:GoInt):{var _0:GoInt64; var _1:stdgo.Error;}
				return _r2.seek(_offset, _whence) #else null #end;
			...
			__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
				return _r2.writeTo(_w) #else null #end;
			__self__;
...
function exampleMultiReader():Void {
	...
	var _r:Reader = stdgo.io.Io.multiReader({
		...
		final __self__ = new stdgo.strings.Strings.Reader_asInterface(_r3);
		__self__.len = #if !macro function():GoInt return _r3.len() #else null #end;
		__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return _r3.read(_p) #else null #end;
		__self__.readAt = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
			return _r3.readAt(_p, _off) #else null #end;
		__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
			return _r3.readByte() #else null #end;
		__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
			return _r3.readRune() #else null #end;
		__self__.reset = #if !macro function(__0:GoString):Void _r3.reset(__0) #else null #end;
		__self__.seek = #if !macro function(_offset:GoInt64, _whence:GoInt):{var _0:GoInt64; var _1:stdgo.Error;}
			return _r3.seek(_offset, _whence) #else null #end;
		...
		__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
			return _r3.writeTo(_w) #else null #end;
		__self__;
	});
	{
		var __tmp__ = stdgo.io.Io.copy({
...
function exampleTeeReader():Void {
	var _r:Reader = {
		final __self__ = new stdgo.strings.Strings.Reader_asInterface(stdgo.strings.Strings.newReader((Go.str("some io.Reader stream to be read\n") : GoString)));
		__self__.len = #if !macro function():GoInt return stdgo.strings.Strings.newReader((Go.str("some io.Reader stream to be read\n") : GoString))
			.len() #else null #end;
		__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str("some io.Reader stream to be read\n") : GoString)).read(_p) #else null #end;
		__self__.readAt = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
		...
		__self__.size = #if !macro function():GoInt64 return stdgo.strings.Strings.newReader((Go.str("some io.Reader stream to be read\n") : GoString))
			.size() #else null #end;
		__self__.unreadByte = #if !macro function():stdgo.Error return
			stdgo.strings.Strings.newReader((Go.str("some io.Reader stream to be read\n") : GoString))
			.unreadByte() #else null #end;
		__self__.unreadRune = #if !macro function():stdgo.Error return
			stdgo.strings.Strings.newReader((Go.str("some io.Reader stream to be read\n") : GoString))
...
function exampleSectionReader():Void {
	...
	}, (5 : GoInt64), (17 : GoInt64));
	{
		var __tmp__ = stdgo.io.Io.copy({
			...
			final __self__ = new SectionReader_asInterface(_s);
			__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
				return _s.read(_p) #else null #end;
			__self__.readAt = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
				return _s.readAt(_p, _off) #else null #end;
			__self__.seek = #if !macro function(_offset:GoInt64, _whence:GoInt):{var _0:GoInt64; var _1:stdgo.Error;}
				return _s.seek(_offset, _whence) #else null #end;
...
function exampleMultiWriter():Void {
	...
	var _w:Writer = stdgo.io.Io.multiWriter({
		final __self__ = new stdgo.bytes.Bytes.Buffer_asInterface(_buf1);
		__self__.bytes = #if !macro function():Slice<GoUInt8> return _buf1.bytes() #else null #end;
		__self__.cap = #if !macro function():GoInt return _buf1.cap() #else null #end;
		...
		__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return _buf1.read(_p) #else null #end;
		__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
			return _buf1.readByte() #else null #end;
		__self__.readBytes = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
			return _buf1.readBytes(_c) #else null #end;
		__self__.readFrom = #if !macro function(_r_:Reader):{var _0:GoInt64; var _1:stdgo.Error;}
			return _buf1.readFrom(_r_) #else null #end;
		__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
			return _buf1.readRune() #else null #end;
		__self__.readString = #if !macro function(_c:GoUInt8):{var _0:GoString; var _1:stdgo.Error;}
			return _buf1.readString(_c) #else null #end;
		...
		__self__.write = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return _buf1.write(_p) #else null #end;
		...
		__self__.writeRune = #if !macro function(_new:GoInt32):{var _0:GoInt; var _1:stdgo.Error;}
			return _buf1.writeRune(_new) #else null #end;
		__self__.writeString = #if !macro function(__0:GoString):{var _0:GoInt; var _1:stdgo.Error;}
			return _buf1.writeString(__0) #else null #end;
		__self__.writeTo = #if !macro function(_w_:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
			return _buf1.writeTo(_w_) #else null #end;
		...
		__self__._readSlice = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
			return _buf1._readSlice(_c) #else null #end;
		__self__._tryGrowByReslice = #if !macro function(_pid:GoInt):{var _0:GoInt; var _1:Bool;}
			return _buf1._tryGrowByReslice(_pid) #else null #end;
		__self__;
	}, {
		final __self__ = new stdgo.bytes.Bytes.Buffer_asInterface(_buf2);
		__self__.bytes = #if !macro function():Slice<GoUInt8> return _buf2.bytes() #else null #end;
		__self__.cap = #if !macro function():GoInt return _buf2.cap() #else null #end;
		...
		__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return _buf2.read(_p) #else null #end;
		__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
			return _buf2.readByte() #else null #end;
		__self__.readBytes = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
			return _buf2.readBytes(_c) #else null #end;
		__self__.readFrom = #if !macro function(_r_:Reader):{var _0:GoInt64; var _1:stdgo.Error;}
			return _buf2.readFrom(_r_) #else null #end;
		__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
			return _buf2.readRune() #else null #end;
		__self__.readString = #if !macro function(_c:GoUInt8):{var _0:GoString; var _1:stdgo.Error;}
			return _buf2.readString(_c) #else null #end;
		...
		__self__.write = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return _buf2.write(_p) #else null #end;
		__self__.writeByte = #if !macro function(_c:GoUInt8):stdgo.Error return _buf2.writeByte(_c) #else null #end;
		__self__.writeRune = #if !macro function(_new:GoInt32):{var _0:GoInt; var _1:stdgo.Error;}
			return _buf2.writeRune(_new) #else null #end;
		__self__.writeString = #if !macro function(__0:GoString):{var _0:GoInt; var _1:stdgo.Error;}
			return _buf2.writeString(__0) #else null #end;
		__self__.writeTo = #if !macro function(_w_:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
			return _buf2.writeTo(_w_) #else null #end;
		...
		__self__._readSlice = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
			return _buf2._readSlice(_c) #else null #end;
		__self__._tryGrowByReslice = #if !macro function(_pid:GoInt):{var _0:GoInt; var _1:Bool;}
			return _buf2._tryGrowByReslice(_pid) #else null #end;
		__self__;
	});
	{
		var __tmp__ = stdgo.io.Io.copy(_w, {
			...
			__self__.unreadRune = #if !macro function():stdgo.Error return _r.unreadRune() #else null #end;
			__self__.writeTo = #if !macro function(_w_:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
				return _r.writeTo(_w_) #else null #end;
			__self__;
		}), _0:GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			stdgo.log.Log.fatal(Go.toInterface(_err));
...
function examplePipe():Void {
	...
	});
	{
		var __tmp__ = stdgo.io.Io.copy({
			...
			final __self__ = new PipeReader_asInterface(_r);
...
function testCopy(_t:stdgo.testing.Testing.T):Void {
	...
	copy({
		final __self__ = new stdgo.io_test.Io_test.Buffer_asInterface(_wb);
		__self__.bytes = #if !macro function():Slice<GoUInt8> return _wb.bytes() #else null #end;
		__self__.cap = #if !macro function():GoInt return _wb.cap() #else null #end;
		...
		__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return _wb.read(_p) #else null #end;
		__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
			return _wb.readByte() #else null #end;
		__self__.readBytes = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
			return _wb.readBytes(_c) #else null #end;
		__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
			return _wb.readRune() #else null #end;
		__self__.readString = #if !macro function(_c:GoUInt8):{var _0:GoString; var _1:stdgo.Error;}
			return _wb.readString(_c) #else null #end;
		...
		__self__.write = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return _wb.write(_p) #else null #end;
		__self__.writeByte = #if !macro function(_c:GoUInt8):stdgo.Error return _wb.writeByte(_c) #else null #end;
		__self__.writeRune = #if !macro function(_new:GoInt32):{var _0:GoInt; var _1:stdgo.Error;}
			return _wb.writeRune(_new) #else null #end;
		__self__.writeString = #if !macro function(__0:GoString):{var _0:GoInt; var _1:stdgo.Error;}
			return _wb.writeString(__0) #else null #end;
		...
		__self__._readSlice = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
			return _wb._readSlice(_c) #else null #end;
		__self__._tryGrowByReslice = #if !macro function(_pid:GoInt):{var _0:GoInt; var _1:Bool;}
			return _wb._tryGrowByReslice(_pid) #else null #end;
		__self__;
	}, {
		final __self__ = new stdgo.io_test.Io_test.Buffer_asInterface(_rb);
		__self__.bytes = #if !macro function():Slice<GoUInt8> return _rb.bytes() #else null #end;
		__self__.cap = #if !macro function():GoInt return _rb.cap() #else null #end;
		...
		__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return _rb.read(_p) #else null #end;
		__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
			return _rb.readByte() #else null #end;
		__self__.readBytes = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
			return _rb.readBytes(_c) #else null #end;
		__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
			return _rb.readRune() #else null #end;
		__self__.readString = #if !macro function(_c:GoUInt8):{var _0:GoString; var _1:stdgo.Error;}
			return _rb.readString(_c) #else null #end;
		...
		__self__.write = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return _rb.write(_p) #else null #end;
		__self__.writeByte = #if !macro function(_c:GoUInt8):stdgo.Error return _rb.writeByte(_c) #else null #end;
		__self__.writeRune = #if !macro function(_new:GoInt32):{var _0:GoInt; var _1:stdgo.Error;}
			return _rb.writeRune(_new) #else null #end;
		__self__.writeString = #if !macro function(__0:GoString):{var _0:GoInt; var _1:stdgo.Error;}
			return _rb.writeString(__0) #else null #end;
		...
		__self__._readSlice = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
			return _rb._readSlice(_c) #else null #end;
		__self__._tryGrowByReslice = #if !macro function(_pid:GoInt):{var _0:GoInt; var _1:Bool;}
			return _rb._tryGrowByReslice(_pid) #else null #end;
		__self__;
	});
...
function testCopyNegative(_t:stdgo.testing.Testing.T):Void {
	...
	copy({
		...
		final __self__ = new LimitedReader_asInterface(({
			r: {
				final __self__ = new stdgo.io_test.Io_test.Buffer_asInterface(_rb);
				__self__.bytes = #if !macro function():Slice<GoUInt8> return _rb.bytes() #else null #end;
				__self__.cap = #if !macro function():GoInt return _rb.cap() #else null #end;
		...
		__self__.read =
			#if !macro
			function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
				return ({
					r: {
						final __self__ = new stdgo.io_test.Io_test.Buffer_asInterface(_rb);
						__self__.bytes = #if !macro function():Slice<GoUInt8> return _rb.bytes() #else null #end;
...
function testCopyReadFrom(_t:stdgo.testing.Testing.T):Void {
	...
	_rb.writeString((Go.str("hello, world.") : GoString));
	copy({
		final __self__ = new stdgo.bytes.Bytes.Buffer_asInterface(_wb);
		__self__.bytes = #if !macro function():Slice<GoUInt8> return _wb.bytes() #else null #end;
		__self__.cap = #if !macro function():GoInt return _wb.cap() #else null #end;
		__self__.grow = #if !macro function(_pid:GoInt):Void _wb.grow(_pid) #else null #end;
		__self__.len = #if !macro function():GoInt return _wb.len() #else null #end;
		...
		__self__.readBytes = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
			return _wb.readBytes(_c) #else null #end;
		__self__.readFrom = #if !macro function(_r:Reader):{var _0:GoInt64; var _1:stdgo.Error;}
			return _wb.readFrom(_r) #else null #end;
		__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
			return _wb.readRune() #else null #end;
		__self__.readString = #if !macro function(_c:GoUInt8):{var _0:GoString; var _1:stdgo.Error;}
			return _wb.readString(_c) #else null #end;
		...
		__self__.writeString = #if !macro function(__0:GoString):{var _0:GoInt; var _1:stdgo.Error;}
			return _wb.writeString(__0) #else null #end;
		__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
			return _wb.writeTo(_w) #else null #end;
		__self__._empty = #if !macro function():Bool return _wb._empty() #else null #end;
		__self__._grow = #if !macro function(_pid:GoInt):GoInt return _wb._grow(_pid) #else null #end;
		__self__._readSlice = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
			return _wb._readSlice(_c) #else null #end;
...
function testCopyWriteTo(_t:stdgo.testing.Testing.T):Void {
	...
	copy({
		...
		final __self__ = new stdgo.bytes.Bytes.Buffer_asInterface(_rb);
		__self__.bytes = #if !macro function():Slice<GoUInt8> return _rb.bytes() #else null #end;
		__self__.cap = #if !macro function():GoInt return _rb.cap() #else null #end;
		__self__.grow = #if !macro function(_pid:GoInt):Void _rb.grow(_pid) #else null #end;
		__self__.len = #if !macro function():GoInt return _rb.len() #else null #end;
		...
		__self__.readBytes = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
			return _rb.readBytes(_c) #else null #end;
		__self__.readFrom = #if !macro function(_r:Reader):{var _0:GoInt64; var _1:stdgo.Error;}
			return _rb.readFrom(_r) #else null #end;
		__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
			return _rb.readRune() #else null #end;
		__self__.readString = #if !macro function(_c:GoUInt8):{var _0:GoString; var _1:stdgo.Error;}
			return _rb.readString(_c) #else null #end;
		...
		__self__.writeString = #if !macro function(__0:GoString):{var _0:GoInt; var _1:stdgo.Error;}
			return _rb.writeString(__0) #else null #end;
		__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
			return _rb.writeTo(_w) #else null #end;
		__self__._empty = #if !macro function():Bool return _rb._empty() #else null #end;
		__self__._grow = #if !macro function(_pid:GoInt):GoInt return _rb._grow(_pid) #else null #end;
		__self__._readSlice = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
			return _rb._readSlice(_c) #else null #end;
...
function testCopyPriority(_t:stdgo.testing.Testing.T):Void {
	...
	copy({
		...
		final __self__ = new stdgo.io_test.Io_test.T_writeToChecker_asInterface(_rb);
		__self__.bytes = #if !macro function():Slice<GoUInt8> return _rb.bytes() #else null #end;
		__self__.cap = #if !macro function():GoInt return _rb.cap() #else null #end;
		__self__.grow = #if !macro function(_pid:GoInt):Void _rb.grow(_pid) #else null #end;
		__self__.len = #if !macro function():GoInt return _rb.len() #else null #end;
...
function testCopyReadErrWriteErr(_t:stdgo.testing.Testing.T):Void {
	var _er:stdgo.Error = stdgo.errors.Errors.new_((Go.str("readError") : GoString)),
		_ew:stdgo.Error = stdgo.errors.Errors.new_((Go.str("writeError") : GoString));
	...
	var __tmp__ = copy({
		final __self__ = new stdgo.io_test.Io_test.T_errWriter_asInterface(_w);
		__self__.write = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return _w.write(_p) #else null #end;
		__self__;
	}, {
		final __self__ = new stdgo.io_test.Io_test.T_zeroErrReader_asInterface(_r);
		__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return _r.read(_p) #else null #end;
		__self__;
...
function benchmarkCopyNSmall(_b:stdgo.testing.Testing.B):Void {
	...
	_b.resetTimer();
	{
		...
		Go.cfor(_i < _b.n, _i++, {
			copyN({
				final __self__ = new stdgo.io_test.Io_test.Buffer_asInterface(_buf);
				...
				__self__.writeRune = #if !macro function(_new:GoInt32):{var _0:GoInt; var _1:stdgo.Error;}
					return _buf.writeRune(_new) #else null #end;
				__self__.writeString = #if !macro function(__0:GoString):{var _0:GoInt; var _1:stdgo.Error;}
				...
				__self__._tryGrowByReslice = #if !macro function(_pid:GoInt):{var _0:GoInt; var _1:Bool;}
					return _buf._tryGrowByReslice(_pid) #else null #end;
				__self__;
			}, {
				final __self__ = new stdgo.bytes.Bytes.Reader_asInterface(_rd);
				__self__.len = #if !macro function():GoInt return _rd.len() #else null #end;
				__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
					return _rd.read(_p) #else null #end;
				__self__.readAt = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
					return _rd.readAt(_p, _off) #else null #end;
				__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
					return _rd.readByte() #else null #end;
				__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
					return _rd.readRune() #else null #end;
				__self__.reset = #if !macro function(_p:Slice<GoUInt8>):Void _rd.reset(_p) #else null #end;
				__self__.seek = #if !macro function(_offset:GoInt64, _whence:GoInt):{var _0:GoInt64; var _1:stdgo.Error;}
					return _rd.seek(_offset, _whence) #else null #end;
				...
				__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
					return _rd.writeTo(_w) #else null #end;
				__self__;
			}, (512 : GoInt64));
			_rd.reset(_bs);
		});
...
function testCopyNEOF(_t:stdgo.testing.Testing.T):Void {
	...
	var __tmp__ = copyN({
		final __self__ = new stdgo.io_test.Io_test.T_noReadFrom_asInterface((new stdgo.io_test.Io_test.T_noReadFrom({
			...
			__self__._tryGrowByReslice = #if !macro function(_pid:GoInt):{var _0:GoInt; var _1:Bool;}
				return _b._tryGrowByReslice(_pid) #else null #end;
			__self__;
		}) : stdgo.io_test.Io_test.T_noReadFrom));
		__self__.write =
			#if !macro
			function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
				return (new stdgo.io_test.Io_test.T_noReadFrom({
					final __self__ = new stdgo.bytes.Bytes.Buffer_asInterface(_b);
					__self__.bytes = #if !macro function():Slice<GoUInt8> return _b.bytes() #else null #end;
					__self__.cap = #if !macro function():GoInt return _b.cap() #else null #end;
					__self__.grow = #if !macro function(_pid:GoInt):Void _b.grow(_pid) #else null #end;
					...
					__self__._tryGrowByReslice = #if !macro function(_pid:GoInt):{var _0:GoInt; var _1:Bool;}
						return _b._tryGrowByReslice(_pid) #else null #end;
					__self__;
				}) : stdgo.io_test.Io_test.T_noReadFrom).write(_p)
			#else
			null
			#end;
		__self__;
	}, {
		final __self__ = new stdgo.strings.Strings.Reader_asInterface(stdgo.strings.Strings.newReader((Go.str("foo") : GoString)));
		__self__.len = #if !macro function():GoInt return stdgo.strings.Strings.newReader((Go.str("foo") : GoString)).len() #else null #end;
		__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str("foo") : GoString)).read(_p) #else null #end;
		__self__.readAt = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str("foo") : GoString)).readAt(_p, _off) #else null #end;
		__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str("foo") : GoString)).readByte() #else null #end;
		__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str("foo") : GoString)).readRune() #else null #end;
		...
		__self__.seek = #if !macro function(_offset:GoInt64, _whence:GoInt):{var _0:GoInt64; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str("foo") : GoString)).seek(_offset, _whence) #else null #end;
		__self__.size = #if !macro function():GoInt64 return stdgo.strings.Strings.newReader((Go.str("foo") : GoString)).size() #else null #end;
		__self__.unreadByte = #if !macro function():stdgo.Error return stdgo.strings.Strings.newReader((Go.str("foo") : GoString))
			.unreadByte() #else null #end;
		__self__.unreadRune = #if !macro function():stdgo.Error return stdgo.strings.Strings.newReader((Go.str("foo") : GoString))
			.unreadRune() #else null #end;
		__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str("foo") : GoString)).writeTo(_w) #else null #end;
		__self__;
	...
	};
	{
		var __tmp__ = copyN({
			...
			final __self__ = new stdgo.io_test.Io_test.T_wantedAndErrReader_asInterface((new stdgo.io_test.Io_test.T_wantedAndErrReader() : stdgo.io_test.Io_test.T_wantedAndErrReader));
			__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
				return (new stdgo.io_test.Io_test.T_wantedAndErrReader() : stdgo.io_test.Io_test.T_wantedAndErrReader).read(_p) #else null #end;
			__self__;
		}, (5 : GoInt64));
		_n = __tmp__._0;
		_err = __tmp__._1;
...
function testReadAtLeastWithDataAndEOF(_t:stdgo.testing.Testing.T):Void {
	...
	_rb._err = eof;
	_testReadAtLeast(_t, {
		final __self__ = new stdgo.io_test.Io_test.T_dataAndErrorBuffer_asInterface(_rb);
		__self__.bytes = #if !macro function():Slice<GoUInt8> return _rb.bytes() #else null #end;
		__self__.cap = #if !macro function():GoInt return _rb.cap() #else null #end;
		__self__.grow = #if !macro function(_pid:GoInt):Void _rb.grow(_pid) #else null #end;
		__self__.len = #if !macro function():GoInt return _rb.len() #else null #end;
...
function testTeeReader(_t:stdgo.testing.Testing.T):Void {
	...
	var _r:Reader = teeReader({
		...
		__self__.readBytes = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
			return _rb.readBytes(_c) #else null #end;
		__self__.readFrom = #if !macro function(_r_:Reader):{var _0:GoInt64; var _1:stdgo.Error;}
			return _rb.readFrom(_r_) #else null #end;
		__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
			return _rb.readRune() #else null #end;
		__self__.readString = #if !macro function(_c:GoUInt8):{var _0:GoString; var _1:stdgo.Error;}
			return _rb.readString(_c) #else null #end;
		...
		__self__.readBytes = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
			return _wb.readBytes(_c) #else null #end;
		__self__.readFrom = #if !macro function(_r_:Reader):{var _0:GoInt64; var _1:stdgo.Error;}
			return _wb.readFrom(_r_) #else null #end;
		__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
			return _wb.readRune() #else null #end;
		__self__.readString = #if !macro function(_c:GoUInt8):{var _0:GoString; var _1:stdgo.Error;}
			return _wb.readString(_c) #else null #end;
	...
	});
	{
		...
		if ((_err != null) || (_n != _src.length)) {
			_t.fatalf((Go.str("ReadFull(r, dst) = %d, %v; want %d, nil") : GoString), Go.toInterface(_n), Go.toInterface(_err), Go.toInterface((_src.length)));
		};
	};
	...
	_r = teeReader({
		...
		final __self__ = new PipeWriter_asInterface(_pw);
		...
		__self__.write = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return _pw.write(_p) #else null #end;
		__self__;
	});
	{
		var __tmp__ = readFull(_r, _dst),
...
function testSectionReader_Seek(_t:stdgo.testing.Testing.T):Void {
	...
	var _sr = newSectionReader({
		final __self__ = new stdgo.bytes.Bytes.Reader_asInterface(_br);
		__self__.len = #if !macro function():GoInt return _br.len() #else null #end;
		__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return _br.read(_p) #else null #end;
		__self__.readAt = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
			return _br.readAt(_p, _off) #else null #end;
		__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
			return _br.readByte() #else null #end;
		__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
			return _br.readRune() #else null #end;
		__self__.reset = #if !macro function(_p:Slice<GoUInt8>):Void _br.reset(_p) #else null #end;
		__self__.seek = #if !macro function(_offset:GoInt64, _whence:GoInt):{var _0:GoInt64; var _1:stdgo.Error;}
			return _br.seek(_offset, _whence) #else null #end;
...
function testSectionReader_Size(_t:stdgo.testing.Testing.T):Void {
	var _tests = (new Slice<T__struct_2>(0, 0, ({_data: (Go.str("a long sample data, 1234567890") : GoString), _want: (30 : GoInt64)} : T__struct_2),
		({_data: (Go.str() : GoString), _want: (0 : GoInt64)} : T__struct_2)) : Slice<T__struct_2>);
	for (_0 => _tt in _tests) {
		...
		var _sr = newSectionReader({
			...
			__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
				return _r.writeTo(_w) #else null #end;
			__self__;
		}, (0 : GoInt64), (_tt._data.length : GoInt64));
		{
...
function testCopyLargeWriter(_t:stdgo.testing.Testing.T):Void {
	...
	{
		var __tmp__ = copy({
			final __self__ = new stdgo.io_test.Io_test.T_largeWriter_asInterface(_wb);
			__self__.write = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
				return _wb.write(_p) #else null #end;
			__self__;
		}, {
...
function testNopCloserWriterToForwarding(_t:stdgo.testing.Testing.T):Void {
	for (_0 => _tc in (new GoArray<T__struct_3>(({name: (Go.str("not a WriterTo") : GoString), _r: (null : Reader)} : T__struct_3),
		({name: (Go.str("a WriterTo") : GoString), _r: ({reader: (null : Reader),
		...
		if (_expected != _got) {
			_t.errorf((Go.str("NopCloser incorrectly forwards WriterTo for %s, got %t want %t") : GoString), Go.toInterface(_tc.name), Go.toInterface(_got),
...
function testMultiReader(_t:stdgo.testing.Testing.T):Void {
	...
	var _expectRead:(GoInt, GoString, stdgo.Error) -> Void = function(_size:GoInt, _expected:GoString, _eerr:Error):Void {
		...
		if (_n != (_expected.length)) {
			_t.errorf((Go.str("#%d, expected %d bytes; got %d") : GoString), Go.toInterface(_nread), Go.toInterface((_expected.length)), Go.toInterface(_n));
		};
...
function testMultiReaderAsWriterTo(_t:stdgo.testing.Testing.T):Void {
	var _mr:Reader = multiReader({
		...
		final __self__ = new stdgo.strings.Strings.Reader_asInterface(stdgo.strings.Strings.newReader((Go.str() : GoString)));
		__self__.len = #if !macro function():GoInt return stdgo.strings.Strings.newReader((Go.str() : GoString)).len() #else null #end;
		__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str() : GoString)).read(_p) #else null #end;
		__self__.readAt = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str() : GoString)).readAt(_p, _off) #else null #end;
		__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str() : GoString)).readByte() #else null #end;
		__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str() : GoString)).readRune() #else null #end;
		...
		__self__.seek = #if !macro function(_offset:GoInt64, _whence:GoInt):{var _0:GoInt64; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str() : GoString)).seek(_offset, _whence) #else null #end;
		...
		__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str() : GoString)).writeTo(_w) #else null #end;
		__self__;
	}, {
		final __self__ = new stdgo.strings.Strings.Reader_asInterface(stdgo.strings.Strings.newReader((Go.str("bar") : GoString)));
		__self__.len = #if !macro function():GoInt return stdgo.strings.Strings.newReader((Go.str("bar") : GoString)).len() #else null #end;
		__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str("bar") : GoString)).read(_p) #else null #end;
		__self__.readAt = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str("bar") : GoString)).readAt(_p, _off) #else null #end;
		__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str("bar") : GoString)).readByte() #else null #end;
		__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str("bar") : GoString)).readRune() #else null #end;
		...
		__self__.seek = #if !macro function(_offset:GoInt64, _whence:GoInt):{var _0:GoInt64; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str("bar") : GoString)).seek(_offset, _whence) #else null #end;
		__self__.size = #if !macro function():GoInt64 return stdgo.strings.Strings.newReader((Go.str("bar") : GoString)).size() #else null #end;
		__self__.unreadByte = #if !macro function():stdgo.Error return stdgo.strings.Strings.newReader((Go.str("bar") : GoString))
			.unreadByte() #else null #end;
		__self__.unreadRune = #if !macro function():stdgo.Error return stdgo.strings.Strings.newReader((Go.str("bar") : GoString))
			.unreadRune() #else null #end;
		__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str("bar") : GoString)).writeTo(_w) #else null #end;
		__self__;
	}));
	var __tmp__ = try {
	...
	var __tmp__ = _mrAsWriterTo.writeTo({
		final __self__ = new stdgo.strings.Strings.Builder_asInterface(_sink);
		__self__.cap = #if !macro function():GoInt return _sink.cap() #else null #end;
		...
		__self__.write = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return _sink.write(_p) #else null #end;
		__self__.writeByte = #if !macro function(_c:GoUInt8):stdgo.Error return _sink.writeByte(_c) #else null #end;
		__self__.writeRune = #if !macro function(_new:GoInt32):{var _0:GoInt; var _1:stdgo.Error;}
			return _sink.writeRune(_new) #else null #end;
		__self__.writeString = #if !macro function(__0:GoString):{var _0:GoInt; var _1:stdgo.Error;}
			return _sink.writeString(__0) #else null #end;
...
function testMultiWriter(_t:stdgo.testing.Testing.T):Void {
	...
	_testMultiWriter(_t, ({
		writer: {
			final __self__ = new stdgo.bytes.Bytes.Buffer_asInterface(_sink);
			...
			__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
				return _sink.read(_p) #else null #end;
			__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
				return _sink.readByte() #else null #end;
			__self__.readBytes = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
				return _sink.readBytes(_c) #else null #end;
			__self__.readFrom = #if !macro function(_r:Reader):{var _0:GoInt64; var _1:stdgo.Error;}
				return _sink.readFrom(_r) #else null #end;
			__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
				return _sink.readRune() #else null #end;
			__self__.readString = #if !macro function(_c:GoUInt8):{var _0:GoString; var _1:stdgo.Error;}
				return _sink.readString(_c) #else null #end;
			__self__.reset = #if !macro function():Void _sink.reset() #else null #end;
			__self__.string = #if !macro function():GoString return _sink.string() #else null #end;
			...
			__self__.writeString = #if !macro function(__0:GoString):{var _0:GoInt; var _1:stdgo.Error;}
				return _sink.writeString(__0) #else null #end;
			__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
				return _sink.writeTo(_w) #else null #end;
			...
			__self__._readSlice = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
				return _sink._readSlice(_c) #else null #end;
			__self__._tryGrowByReslice = #if !macro function(_pid:GoInt):{var _0:GoInt; var _1:Bool;}
				return _sink._tryGrowByReslice(_pid) #else null #end;
			__self__;
		},
		stringer: {
			final __self__ = new stdgo.bytes.Bytes.Buffer_asInterface(_sink);
...
function testMultiWriter_String(_t:stdgo.testing.Testing.T):Void {
	_testMultiWriter(_t, {
		final __self__ = new stdgo.bytes.Bytes.Buffer_asInterface(({} : stdgo.bytes.Bytes.Buffer));
		__self__.bytes = #if !macro function():Slice<GoUInt8> return ({} : stdgo.bytes.Bytes.Buffer).bytes() #else null #end;
		__self__.cap = #if !macro function():GoInt return ({} : stdgo.bytes.Bytes.Buffer).cap() #else null #end;
		...
		__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return ({} : stdgo.bytes.Bytes.Buffer).read(_p) #else null #end;
		__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
			return ({} : stdgo.bytes.Bytes.Buffer).readByte() #else null #end;
		__self__.readBytes = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
			return ({} : stdgo.bytes.Bytes.Buffer).readBytes(_c) #else null #end;
		__self__.readFrom = #if !macro function(_r:Reader):{var _0:GoInt64; var _1:stdgo.Error;}
			return ({} : stdgo.bytes.Bytes.Buffer).readFrom(_r) #else null #end;
		__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
			return ({} : stdgo.bytes.Bytes.Buffer).readRune() #else null #end;
		__self__.readString = #if !macro function(_c:GoUInt8):{var _0:GoString; var _1:stdgo.Error;}
			return ({} : stdgo.bytes.Bytes.Buffer).readString(_c) #else null #end;
		...
		__self__.write = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return ({} : stdgo.bytes.Bytes.Buffer).write(_p) #else null #end;
		__self__.writeByte = #if !macro function(_c:GoUInt8):stdgo.Error return ({} : stdgo.bytes.Bytes.Buffer).writeByte(_c) #else null #end;
		__self__.writeRune = #if !macro function(_new:GoInt32):{var _0:GoInt; var _1:stdgo.Error;}
			return ({} : stdgo.bytes.Bytes.Buffer).writeRune(_new) #else null #end;
		__self__.writeString = #if !macro function(__0:GoString):{var _0:GoInt; var _1:stdgo.Error;}
			return ({} : stdgo.bytes.Bytes.Buffer).writeString(__0) #else null #end;
		__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
			return ({} : stdgo.bytes.Bytes.Buffer).writeTo(_w) #else null #end;
		...
		__self__._readSlice = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
			return ({} : stdgo.bytes.Bytes.Buffer)._readSlice(_c) #else null #end;
		__self__._tryGrowByReslice = #if !macro function(_pid:GoInt):{var _0:GoInt; var _1:Bool;}
			return ({} : stdgo.bytes.Bytes.Buffer)._tryGrowByReslice(_pid) #else null #end;
		__self__;
	});
}
...
function testMultiWriter_WriteStringSingleAlloc(_t:stdgo.testing.Testing.T):Void {
	...
	var _mw:Writer = multiWriter({
		final __self__ = new stdgo.io_test.Io_test.T_simpleWriter_testMultiWriter_WriteStringSingleAlloc_0_asInterface((new stdgo.io_test.Io_test.T_simpleWriter_testMultiWriter_WriteStringSingleAlloc_0({
			final __self__ = new stdgo.bytes.Bytes.Buffer_asInterface(_sink1);
			__self__.bytes = #if !macro function():Slice<GoUInt8> return _sink1.bytes() #else null #end;
			__self__.cap = #if !macro function():GoInt return _sink1.cap() #else null #end;
			...
			__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
				return _sink1.read(_p) #else null #end;
			__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
				return _sink1.readByte() #else null #end;
			__self__.readBytes = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
				return _sink1.readBytes(_c) #else null #end;
			__self__.readFrom = #if !macro function(_r:Reader):{var _0:GoInt64; var _1:stdgo.Error;}
				return _sink1.readFrom(_r) #else null #end;
			__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
				return _sink1.readRune() #else null #end;
			__self__.readString = #if !macro function(_c:GoUInt8):{var _0:GoString; var _1:stdgo.Error;}
				return _sink1.readString(_c) #else null #end;
			...
			__self__.write = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
				return _sink1.write(_p) #else null #end;
			__self__.writeByte = #if !macro function(_c:GoUInt8):stdgo.Error return _sink1.writeByte(_c) #else null #end;
			__self__.writeRune = #if !macro function(_new:GoInt32):{var _0:GoInt; var _1:stdgo.Error;}
				return _sink1.writeRune(_new) #else null #end;
			__self__.writeString = #if !macro function(__0:GoString):{var _0:GoInt; var _1:stdgo.Error;}
				return _sink1.writeString(__0) #else null #end;
			__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
				return _sink1.writeTo(_w) #else null #end;
			...
			__self__._readSlice = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
				return _sink1._readSlice(_c) #else null #end;
			__self__._tryGrowByReslice = #if !macro function(_pid:GoInt):{var _0:GoInt; var _1:Bool;}
				return _sink1._tryGrowByReslice(_pid) #else null #end;
			__self__;
		}) : stdgo.io_test.Io_test.T_simpleWriter_testMultiWriter_WriteStringSingleAlloc_0));
		__self__.write =
			#if !macro
			function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
				return (new stdgo.io_test.Io_test.T_simpleWriter_testMultiWriter_WriteStringSingleAlloc_0({
					final __self__ = new stdgo.bytes.Bytes.Buffer_asInterface(_sink1);
					__self__.bytes = #if !macro function():Slice<GoUInt8> return _sink1.bytes() #else null #end;
					__self__.cap = #if !macro function():GoInt return _sink1.cap() #else null #end;
					__self__.grow = #if !macro function(_pid:GoInt):Void _sink1.grow(_pid) #else null #end;
					...
					__self__._tryGrowByReslice = #if !macro function(_pid:GoInt):{var _0:GoInt; var _1:Bool;}
						return _sink1._tryGrowByReslice(_pid) #else null #end;
					__self__;
				}) : stdgo.io_test.Io_test.T_simpleWriter_testMultiWriter_WriteStringSingleAlloc_0).write(_p)
			#else
			null
			#end;
		__self__;
		...
		final __self__ = new stdgo.io_test.Io_test.T_simpleWriter_testMultiWriter_WriteStringSingleAlloc_0_asInterface((new stdgo.io_test.Io_test.T_simpleWriter_testMultiWriter_WriteStringSingleAlloc_0({
			final __self__ = new stdgo.bytes.Bytes.Buffer_asInterface(_sink2);
			__self__.bytes = #if !macro function():Slice<GoUInt8> return _sink2.bytes() #else null #end;
			__self__.cap = #if !macro function():GoInt return _sink2.cap() #else null #end;
			...
			__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
				return _sink2.read(_p) #else null #end;
			__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
				return _sink2.readByte() #else null #end;
			__self__.readBytes = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
				return _sink2.readBytes(_c) #else null #end;
			__self__.readFrom = #if !macro function(_r:Reader):{var _0:GoInt64; var _1:stdgo.Error;}
				return _sink2.readFrom(_r) #else null #end;
			__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
				return _sink2.readRune() #else null #end;
			__self__.readString = #if !macro function(_c:GoUInt8):{var _0:GoString; var _1:stdgo.Error;}
				return _sink2.readString(_c) #else null #end;
			...
			__self__.write = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
				return _sink2.write(_p) #else null #end;
			__self__.writeByte = #if !macro function(_c:GoUInt8):stdgo.Error return _sink2.writeByte(_c) #else null #end;
			__self__.writeRune = #if !macro function(_new:GoInt32):{var _0:GoInt; var _1:stdgo.Error;}
				return _sink2.writeRune(_new) #else null #end;
			__self__.writeString = #if !macro function(__0:GoString):{var _0:GoInt; var _1:stdgo.Error;}
				return _sink2.writeString(__0) #else null #end;
			__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
				return _sink2.writeTo(_w) #else null #end;
			...
			__self__._readSlice = #if !macro function(_c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
				return _sink2._readSlice(_c) #else null #end;
			__self__._tryGrowByReslice = #if !macro function(_pid:GoInt):{var _0:GoInt; var _1:Bool;}
				return _sink2._tryGrowByReslice(_pid) #else null #end;
			__self__;
		}) : stdgo.io_test.Io_test.T_simpleWriter_testMultiWriter_WriteStringSingleAlloc_0));
		__self__.write =
			#if !macro
...
function testMultiWriter_StringCheckCall(_t:stdgo.testing.Testing.T):Void {
	...
	var _mw:Writer = multiWriter({
		final __self__ = new stdgo.io_test.Io_test.T_writeStringChecker_asInterface(_c);
		__self__.write = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return _c.write(_p) #else null #end;
		__self__.writeString = #if !macro function(__0:GoString):{var _0:GoInt; var _1:stdgo.Error;}
			return _c.writeString(__0) #else null #end;
		__self__;
	});
	writeString(_mw, (Go.str("foo") : GoString));
	if (!_c._called) {
...
function _testMultiWriter(_t:stdgo.testing.Testing.T, _sink:T__interface_0):Void {
	...
	var __tmp__ = copy(_mw, {
		final __self__ = new stdgo.strings.Strings.Reader_asInterface(_source);
		__self__.len = #if !macro function():GoInt return _source.len() #else null #end;
		__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return _source.read(_p) #else null #end;
		__self__.readAt = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
			return _source.readAt(_p, _off) #else null #end;
		__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
			return _source.readByte() #else null #end;
		__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
			return _source.readRune() #else null #end;
		__self__.reset = #if !macro function(__0:GoString):Void _source.reset(__0) #else null #end;
		__self__.seek = #if !macro function(_offset:GoInt64, _whence:GoInt):{var _0:GoInt64; var _1:stdgo.Error;}
			return _source.seek(_offset, _whence) #else null #end;
		...
		__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
			return _source.writeTo(_w) #else null #end;
		__self__;
	}), _written:GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
	if (_written != (_sourceString.length : GoInt64)) {
		_t.errorf((Go.str("short write of %d, not %d") : GoString), Go.toInterface(_written), Go.toInterface((_sourceString.length)));
	};
	if (_err != null) {
...
function testMultiWriterSingleChainFlatten(_t:stdgo.testing.Testing.T):Void {
	...
	var _w:Writer = multiWriter({
		final __self__ = new stdgo.io_test.Io_test.T_writerFunc_asInterface((function(_p:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
		...
		__self__.write = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return (function(_p:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
				var _n:GoInt = stdgo.runtime.Runtime.callers((1 : GoInt), _pc);
				_writeDepth = _writeDepth + (_callDepth((_pc.__slice__(0, _n) : Slice<GoUIntptr>)));
				return {_0: (0 : GoInt), _1: (null : stdgo.Error)};
...
function testMultiWriterError(_t:stdgo.testing.Testing.T):Void {
	...
	var _w:Writer = multiWriter({
		final __self__ = new stdgo.io_test.Io_test.T_writerFunc_asInterface(_f1);
		__self__.write = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return _f1.write(_p) #else null #end;
		__self__;
	}, {
		final __self__ = new stdgo.io_test.Io_test.T_writerFunc_asInterface(_f2);
		__self__.write = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return _f2.write(_p) #else null #end;
		__self__;
	});
...
function testMultiReaderCopy(_t:stdgo.testing.Testing.T):Void {
	var _slice = (new Slice<Reader>(0, 0, {
		final __self__ = new stdgo.strings.Strings.Reader_asInterface(stdgo.strings.Strings.newReader((Go.str("hello world") : GoString)));
		...
		__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str("hello world") : GoString)).read(_p) #else null #end;
		__self__.readAt = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str("hello world") : GoString)).readAt(_p, _off) #else null #end;
		__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str("hello world") : GoString)).readByte() #else null #end;
		__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str("hello world") : GoString)).readRune() #else null #end;
		...
		__self__.seek = #if !macro function(_offset:GoInt64, _whence:GoInt):{var _0:GoInt64; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str("hello world") : GoString)).seek(_offset, _whence) #else null #end;
		...
		__self__.unreadByte = #if !macro function():stdgo.Error return stdgo.strings.Strings.newReader((Go.str("hello world") : GoString))
			.unreadByte() #else null #end;
		__self__.unreadRune = #if !macro function():stdgo.Error return stdgo.strings.Strings.newReader((Go.str("hello world") : GoString))
			.unreadRune() #else null #end;
		__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
			return stdgo.strings.Strings.newReader((Go.str("hello world") : GoString)).writeTo(_w) #else null #end;
		__self__;
	}) : Slice<Reader>);
	...
	if ((_err != null) || ((_data : GoString) != (Go.str("hello world") : GoString))) {
		_t.errorf((Go.str("ReadAll() = %q, %v, want %q, nil") : GoString), Go.toInterface(_data), Go.toInterface(_err),
...
function testMultiWriterCopy(_t:stdgo.testing.Testing.T):Void {
	...
	if ((_buf.string() : GoString) != (Go.str("hello world") : GoString)) {
		_t.errorf((Go.str("buf.String() = %q, want %q") : GoString), Go.toInterface((_buf.string() : GoString)),
			Go.toInterface((Go.str("hello world") : GoString)));
	};
}
...
function testMultiReaderFlatten(_t:stdgo.testing.Testing.T):Void {
	...
	var _r:Reader = multiReader({
		final __self__ = new stdgo.io_test.Io_test.T_readerFunc_asInterface((function(_p:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
			var _n:GoInt = stdgo.runtime.Runtime.callers((1 : GoInt), _pc);
	...
	if (_readDepth != (_myDepth + (2 : GoInt))) {
		_t.errorf((Go.str("multiReader did not flatten chained multiReaders: expected readDepth %d, got %d") : GoString),
			Go.toInterface(_myDepth + (2 : GoInt)), Go.toInterface(_readDepth));
	};
}
...
function testMultiReaderSingleByteWithEOF(_t:stdgo.testing.Testing.T):Void {
	var __tmp__ = readAll(limitReader(multiReader({
		final __self__ = new stdgo.io_test.Io_test.T_byteAndEOFReader_asInterface((("a".code : stdgo.io_test.Io_test.T_byteAndEOFReader) : T_byteAndEOFReader));
		__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return (("a".code : stdgo.io_test.Io_test.T_byteAndEOFReader) : T_byteAndEOFReader).read(_p) #else null #end;
		__self__;
	}, {
		final __self__ = new stdgo.io_test.Io_test.T_byteAndEOFReader_asInterface((("b".code : stdgo.io_test.Io_test.T_byteAndEOFReader) : T_byteAndEOFReader));
		__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return (("b".code : stdgo.io_test.Io_test.T_byteAndEOFReader) : T_byteAndEOFReader).read(_p) #else null #end;
		__self__;
	}),
...
function testMultiReaderFinalEOF(_t:stdgo.testing.Testing.T):Void {
	var _r:Reader = multiReader({
		final __self__ = new stdgo.bytes.Bytes.Reader_asInterface(stdgo.bytes.Bytes.newReader((null : Slice<GoUInt8>)));
		__self__.len = #if !macro function():GoInt return stdgo.bytes.Bytes.newReader((null : Slice<GoUInt8>)).len() #else null #end;
		__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
			return stdgo.bytes.Bytes.newReader((null : Slice<GoUInt8>)).read(_p) #else null #end;
		__self__.readAt = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
			return stdgo.bytes.Bytes.newReader((null : Slice<GoUInt8>)).readAt(_p, _off) #else null #end;
		__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
			return stdgo.bytes.Bytes.newReader((null : Slice<GoUInt8>)).readByte() #else null #end;
		__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
			return stdgo.bytes.Bytes.newReader((null : Slice<GoUInt8>)).readRune() #else null #end;
		...
		__self__.seek = #if !macro function(_offset:GoInt64, _whence:GoInt):{var _0:GoInt64; var _1:stdgo.Error;}
			return stdgo.bytes.Bytes.newReader((null : Slice<GoUInt8>)).seek(_offset, _whence) #else null #end;
		...
		__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
			return stdgo.bytes.Bytes.newReader((null : Slice<GoUInt8>)).writeTo(_w) #else null #end;
		__self__;
	}, {
		final __self__ = new stdgo.io_test.Io_test.T_byteAndEOFReader_asInterface((("a".code : stdgo.io_test.Io_test.T_byteAndEOFReader) : T_byteAndEOFReader));
		__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
...
function testMultiReaderFreesExhaustedReaders(_t:stdgo.testing.Testing.T):Void {
	...
	var _closed = new Chan<T_wantedAndErrReader>(0, () -> ({} : T_wantedAndErrReader));
	{
		var a = function():Void {
			...
			_mr = multiReader({
				final __self__ = new stdgo.bytes.Bytes.Reader_asInterface(_buf1);
				__self__.len = #if !macro function():GoInt return _buf1.len() #else null #end;
				__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
					return _buf1.read(_p) #else null #end;
				__self__.readAt = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
					return _buf1.readAt(_p, _off) #else null #end;
				__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
					return _buf1.readByte() #else null #end;
				__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
					return _buf1.readRune() #else null #end;
				...
				__self__.seek = #if !macro function(_offset:GoInt64, _whence:GoInt):{var _0:GoInt64; var _1:stdgo.Error;}
					return _buf1.seek(_offset, _whence) #else null #end;
				__self__.size = #if !macro function():GoInt64 return _buf1.size() #else null #end;
				__self__.unreadByte = #if !macro function():stdgo.Error return _buf1.unreadByte() #else null #end;
				__self__.unreadRune = #if !macro function():stdgo.Error return _buf1.unreadRune() #else null #end;
				__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
					return _buf1.writeTo(_w) #else null #end;
				__self__;
			}, {
				final __self__ = new stdgo.bytes.Bytes.Reader_asInterface(_buf2);
				__self__.len = #if !macro function():GoInt return _buf2.len() #else null #end;
				__self__.read = #if !macro function(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
					return _buf2.read(_p) #else null #end;
				__self__.readAt = #if !macro function(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
					return _buf2.readAt(_p, _off) #else null #end;
				__self__.readByte = #if !macro function():{var _0:GoUInt8; var _1:stdgo.Error;}
					return _buf2.readByte() #else null #end;
				__self__.readRune = #if !macro function():{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
					return _buf2.readRune() #else null #end;
				...
				__self__.seek = #if !macro function(_offset:GoInt64, _whence:GoInt):{var _0:GoInt64; var _1:stdgo.Error;}
					return _buf2.seek(_offset, _whence) #else null #end;
				__self__.size = #if !macro function():GoInt64 return _buf2.size() #else null #end;
				__self__.unreadByte = #if !macro function():stdgo.Error return _buf2.unreadByte() #else null #end;
				__self__.unreadRune = #if !macro function():stdgo.Error return _buf2.unreadRune() #else null #end;
				__self__.writeTo = #if !macro function(_w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
					return _buf2.writeTo(_w) #else null #end;
				__self__;
			});
	...
	var _buf = new Slice<GoUInt8>((4 : GoInt).toBasic(), 0, ...[for (i in 0...(4 : GoInt).toBasic()) (0 : GoUInt8)]);
	{
		...
		if ((_err != null) || ((_buf : GoString) != (Go.str("foob") : GoString))) {
			_t.fatalf(("ReadFull = %d (%q), %v; want 3, \"foo\", nil" : GoString), Go.toInterface(_n),
				Go.toInterface((_buf.__slice__(0, _n) : Slice<GoUInt8>)), Go.toInterface(_err));
		};
	};
	stdgo.runtime.Runtime.gc();
	Go.select([
		stdgo.time.Time.after(("5000000000" : stdgo.time.Time.Duration)).__get__() => {
	...
	]);
	{
		...
		if ((_err != null) || (((_buf.__slice__(0, (2 : GoInt)) : Slice<GoUInt8>) : GoString) != (Go.str("ar") : GoString))) {
			_t.fatalf(("ReadFull = %d (%q), %v; want 2, \"ar\", nil" : GoString), Go.toInterface(_n),
				Go.toInterface((_buf.__slice__(0, _n) : Slice<GoUInt8>)), Go.toInterface(_err));
		};
	};
}
...
function _checkWrite(_t:stdgo.testing.Testing.T, _w:Writer, _data:Slice<GoByte>, _c:Chan<GoInt>):Void {
	...
	if (_n != (_data.length)) {
		_t.errorf((Go.str("short write: %d != %d") : GoString), Go.toInterface(_n), Go.toInterface((_data.length)));
	};
	_c.__send__((0 : GoInt));
}
...
function testPipe1(_t:stdgo.testing.Testing.T):Void {
	...
	Go.routine(() -> _checkWrite(_t, {
		final __self__ = new PipeWriter_asInterface(_w);
	...
	if (_err != null) {
		...
		|| (((_buf.__slice__((0 : GoInt), (12 : GoInt)) : Slice<GoUInt8>) : GoString) != (Go.str("hello, world") : GoString))) {
	...
	var _buf:Slice<GoUInt8> = new Slice<GoUInt8>((64 : GoInt).toBasic(), 0, ...[for (i in 0...(64 : GoInt).toBasic()) (0 : GoUInt8)]);
	{
		...
		Go.cfor(_i < (5:GoInt), _i++, {
			...
			var __tmp__ = _w.write(_p),
				...
				_err:stdgo.Error = __tmp__._1;
			if (_n != (_p.length)) {
				_t.errorf((Go.str("wrote %d, got %d") : GoString), Go.toInterface((_p.length)), Go.toInterface(_n));
			};
			if (_err != null) {
				_t.errorf((Go.str("write: %v") : GoString), Go.toInterface(_err));
			};
	...
	};
	{
		...
		Go.cfor(_i < (128:GoInt), _i++, {
			if (_rdat[_i] != (_i : GoByte)) {
				_t.fatalf((Go.str("rdat[%d] = %d") : GoString), Go.toInterface(_i), Go.toInterface(_rdat[_i]));
			};
		});
	};
}
...
function testPipeReadClose2(_t:stdgo.testing.Testing.T):Void {
	...
	Go.routine(() -> _delayClose(_t, {
		...
		(new stdgo.io_test.Io_test.T_pipeTest() : stdgo.io_test.Io_test.T_pipeTest)));
	var __tmp__ = _r.read(new Slice<GoUInt8>((64 : GoInt).toBasic(), 0, ...[for (i in 0...(64 : GoInt).toBasic()) (0 : GoUInt8)])),
		_n:GoInt = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	_c.__get__();
	if ((_n != (0 : GoInt)) || (_err != errClosedPipe)) {
		_t.errorf((Go.str("read from closed pipe: %v, %v want %v, %v") : GoString), Go.toInterface(_n), Go.toInterface(_err), Go.toInterface((0 : GoInt)),
...
function testPipeWriteClose2(_t:stdgo.testing.Testing.T):Void {
	...
	_c.__get__();
	if ((_n != (0 : GoInt)) || (_err != errClosedPipe)) {
		_t.errorf((Go.str("write to closed pipe: %v, %v want %v, %v") : GoString), Go.toInterface(_n), Go.toInterface(_err), Go.toInterface((0 : GoInt)),
			Go.toInterface(errClosedPipe));
	};
}
...
function testPipeCloseError(_t:stdgo.testing.Testing.T):Void {
	...
	var __tmp__ = pipe(),
		...
		_w:Ref<PipeWriter> = __tmp__._1;
	_r.closeWithError({
		final __self__ = new stdgo.io_test.Io_test.T_testError1_testPipeCloseError_0_asInterface((new stdgo.io_test.Io_test.T_testError1_testPipeCloseError_0() : stdgo.io_test.Io_test.T_testError1_testPipeCloseError_0));
		__self__.error = #if !macro function():GoString return
			(new stdgo.io_test.Io_test.T_testError1_testPipeCloseError_0() : stdgo.io_test.Io_test.T_testError1_testPipeCloseError_0).error() #else null #end;
		__self__;
	});
	{
	...
	_r.closeWithError({
		final __self__ = new stdgo.io_test.Io_test.T_testError2_testPipeCloseError_1_asInterface((new stdgo.io_test.Io_test.T_testError2_testPipeCloseError_1() : stdgo.io_test.Io_test.T_testError2_testPipeCloseError_1));
		__self__.error = #if !macro function():GoString return
			(new stdgo.io_test.Io_test.T_testError2_testPipeCloseError_1() : stdgo.io_test.Io_test.T_testError2_testPipeCloseError_1).error() #else null #end;
		__self__;
	});
	{
		var __tmp__ = _w.write((null : Slice<GoUInt8>)),
...
function testPipeConcurrent(_t:stdgo.testing.Testing.T):Void {
	var _input:GoString = (Go.str("0123456789abcdef") : GoString),
		_count:GoUnTypedInt = (8 : GoUnTypedInt),
		_readSize:GoUnTypedInt = (2 : GoUnTypedInt);
			...
			Go.cfor(_i < (8:GoInt), _i++, {
				Go.routine(() -> {
					var a = function():Void {
						stdgo.time.Time.sleep((1000000 : stdgo.time.Time.Duration));
						{
							var __tmp__ = _w.write(((Go.str("0123456789abcdef") : GoString) : Slice<GoByte>)), _n:GoInt = __tmp__._0,
								_err:stdgo.Error = __tmp__._1;
							if ((_n != (Go.str("0123456789abcdef") : GoString).length) || (_err != null)) {
								_t.errorf((Go.str("Write() = (%d, %v); want (%d, nil)") : GoString), Go.toInterface(_n), Go.toInterface(_err),
									Go.toInterface(((Go.str("0123456789abcdef") : GoString).length)));
							};
						};
					};
					a();
			...
			Go.cfor(_i < (_buf.length), _i = _i + ((2 : GoInt)), {
				{
					...
					if ((_n != (2 : GoInt)) || (_err != null)) {
						_t.errorf((Go.str("Read() = (%d, %v); want (%d, nil)") : GoString), Go.toInterface(_n), Go.toInterface(_err),
	...
	_t.run((Go.str("Read") : GoString), function(_t:stdgo.testing.Testing.T):Void {
		...
		};
		{
			...
			Go.cfor(_i < (8:GoInt), _i++, {
				{
					var __tmp__ = _w.write(((Go.str("0123456789abcdef") : GoString) : Slice<GoByte>)),
						_n:GoInt = __tmp__._0,
						_err:stdgo.Error = __tmp__._1;
					if ((_n != (Go.str("0123456789abcdef") : GoString).length) || (_err != null)) {
						_t.errorf((Go.str("Write() = (%d, %v); want (%d, nil)") : GoString), Go.toInterface(_n), Go.toInterface(_err),
...
@:keep class Buffer_static_extension {
	...
	@:embedded
	public static function _readSlice(__self__:Buffer, _c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
	...
	@:embedded
	public static function writeString(__self__:Buffer, __0:GoString):{var _0:GoInt; var _1:stdgo.Error;}
		return __self__.writeString(__0);

	@:embedded
	public static function writeRune(__self__:Buffer, _new:GoInt32):{var _0:GoInt; var _1:stdgo.Error;}
		return __self__.writeRune(_new);

	@:embedded
	public static function writeByte(__self__:Buffer, _c:GoUInt8):stdgo.Error
		return __self__.writeByte(_c);

	@:embedded
	public static function write(__self__:Buffer, _p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
		return __self__.write(_p);

	@:embedded
	public static function unreadRune(__self__:Buffer):stdgo.Error
		return __self__.unreadRune();

	@:embedded
	public static function unreadByte(__self__:Buffer):stdgo.Error
	...
	@:embedded
	public static function readString(__self__:Buffer, _c:GoUInt8):{var _0:GoString; var _1:stdgo.Error;}
		return __self__.readString(_c);

	@:embedded
	public static function readRune(__self__:Buffer):{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
		return __self__.readRune();

	@:embedded
	public static function readBytes(__self__:Buffer, _c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
		return __self__.readBytes(_c);

	@:embedded
	public static function readByte(__self__:Buffer):{var _0:GoUInt8; var _1:stdgo.Error;}
		return __self__.readByte();

	@:embedded
	public static function read(__self__:Buffer, _p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
...
@:keep private class T_writeToChecker_static_extension {
	@:keep
	...
	@:embedded
	public static function _readSlice(__self__:T_writeToChecker, _c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
		return __self__._readSlice(_c);
	...
	@:embedded
	public static function writeString(__self__:T_writeToChecker, __0:GoString):{var _0:GoInt; var _1:stdgo.Error;}
		return __self__.writeString(__0);

	@:embedded
	public static function writeRune(__self__:T_writeToChecker, _new:GoInt32):{var _0:GoInt; var _1:stdgo.Error;}
		return __self__.writeRune(_new);

	@:embedded
	public static function writeByte(__self__:T_writeToChecker, _c:GoUInt8):stdgo.Error
		return __self__.writeByte(_c);

	@:embedded
	public static function write(__self__:T_writeToChecker, _p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
		return __self__.write(_p);

	@:embedded
	public static function unreadRune(__self__:T_writeToChecker):stdgo.Error
		return __self__.unreadRune();

	@:embedded
	public static function unreadByte(__self__:T_writeToChecker):stdgo.Error
		return __self__.unreadByte();
	...
	@:embedded
	public static function readString(__self__:T_writeToChecker, _c:GoUInt8):{var _0:GoString; var _1:stdgo.Error;}
		return __self__.readString(_c);

	@:embedded
	public static function readRune(__self__:T_writeToChecker):{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
		return __self__.readRune();

	@:embedded
	public static function readFrom(__self__:T_writeToChecker, _r:Reader):{var _0:GoInt64; var _1:stdgo.Error;}
		return __self__.readFrom(_r);

	@:embedded
	public static function readBytes(__self__:T_writeToChecker, _c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
		return __self__.readBytes(_c);

	@:embedded
	public static function readByte(__self__:T_writeToChecker):{var _0:GoUInt8; var _1:stdgo.Error;}
		return __self__.readByte();

	@:embedded
	public static function read(__self__:T_writeToChecker, _p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
		return __self__.read(_p);
...
@:keep private class T_zeroErrReader_static_extension {
	@:keep
...
@:keep private class T_noReadFrom_static_extension {
	@:keep
...
@:keep private class T_wantedAndErrReader_static_extension {
	@:keep
	static public function read(_:T_wantedAndErrReader, _p:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
		return {_0: (_p.length), _1: stdgo.errors.Errors.new_((Go.str("wantedAndErrReader error") : GoString))};
	}
}
...
@:keep private class T_dataAndErrorBuffer_static_extension {
	@:keep
	...
	@:embedded
	public static function _readSlice(__self__:T_dataAndErrorBuffer, _c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
		return __self__._readSlice(_c);
	...
	@:embedded
	public static function writeTo(__self__:T_dataAndErrorBuffer, _w:Writer):{var _0:GoInt64; var _1:stdgo.Error;}
		return __self__.writeTo(_w);

	@:embedded
	public static function writeString(__self__:T_dataAndErrorBuffer, __0:GoString):{var _0:GoInt; var _1:stdgo.Error;}
		return __self__.writeString(__0);

	@:embedded
	public static function writeRune(__self__:T_dataAndErrorBuffer, _new:GoInt32):{var _0:GoInt; var _1:stdgo.Error;}
		return __self__.writeRune(_new);

	@:embedded
	public static function writeByte(__self__:T_dataAndErrorBuffer, _c:GoUInt8):stdgo.Error
		return __self__.writeByte(_c);

	@:embedded
	public static function write(__self__:T_dataAndErrorBuffer, _p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
		return __self__.write(_p);

	@:embedded
	public static function unreadRune(__self__:T_dataAndErrorBuffer):stdgo.Error
		return __self__.unreadRune();

	@:embedded
	public static function unreadByte(__self__:T_dataAndErrorBuffer):stdgo.Error
		return __self__.unreadByte();
	...
	@:embedded
	public static function readString(__self__:T_dataAndErrorBuffer, _c:GoUInt8):{var _0:GoString; var _1:stdgo.Error;}
		return __self__.readString(_c);

	@:embedded
	public static function readRune(__self__:T_dataAndErrorBuffer):{var _0:GoInt32; var _1:GoInt; var _2:stdgo.Error;}
		return __self__.readRune();

	@:embedded
	public static function readFrom(__self__:T_dataAndErrorBuffer, _r:Reader):{var _0:GoInt64; var _1:stdgo.Error;}
		return __self__.readFrom(_r);

	@:embedded
	public static function readBytes(__self__:T_dataAndErrorBuffer, _c:GoUInt8):{var _0:Slice<GoUInt8>; var _1:stdgo.Error;}
		return __self__.readBytes(_c);

	@:embedded
	public static function readByte(__self__:T_dataAndErrorBuffer):{var _0:GoUInt8; var _1:stdgo.Error;}
		return __self__.readByte();
...
@:keep private class T_largeWriter_static_extension {
	@:keep
...
@:keep private class T_writeStringChecker_static_extension {
	@:keep
...
@:keep private class T_pipeTest_static_extension {
	@:keep
	static public function string(_p:T_pipeTest):GoString {
		return stdgo.fmt.Fmt.sprintf((Go.str("async=%v err=%v closeWithError=%v") : GoString), Go.toInterface(_p._async), Go.toInterface(_p._err),
...
@:keep private class T_writerFunc_static_extension {
	@:keep
...
@:keep private class T_readerFunc_static_extension {
	@:keep
...
@:keep private class T_byteAndEOFReader_static_extension {
	@:keep
...
@:keep private class T_simpleWriter_testMultiWriter_WriteStringSingleAlloc_0_static_extension {
	@:embedded
	public static function write(__self__:T_simpleWriter_testMultiWriter_WriteStringSingleAlloc_0, _p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
		return __self__.write(_p);
}
...
@:keep private class T_testError1_testPipeCloseError_0_static_extension {
	@:embedded
...
@:keep private class T_testError2_testPipeCloseError_1_static_extension {
	@:embedded
