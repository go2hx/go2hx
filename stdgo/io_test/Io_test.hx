...
@:keep @:allow(stdgo.io_test.Io_test.T__struct_4_asInterface) class T__struct_4_static_extension {
    @:embedded
    public static function writeTo( __self__:T__struct_4, _w:stdgo.io.Io.Writer):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } return return __self__.writerTo.writeTo(_w);
    @:embedded
...
**/
@:named @:using(stdgo.io_test.Io_test.T_writerFunc_static_extension) typedef T_writerFunc = stdgo.Slice<stdgo.GoUInt8> -> { var _0 : stdgo.GoInt; var _1 : stdgo.Error; };
/**
    // readerFunc is a Reader implemented by the underlying func.
**/
@:named @:using(stdgo.io_test.Io_test.T_readerFunc_static_extension) typedef T_readerFunc = stdgo.Slice<stdgo.GoUInt8> -> { var _0 : stdgo.GoInt; var _1 : stdgo.Error; };
/**
    // byteAndEOFReader is a Reader which reads one byte (the underlying
    // byte) and EOF at once in its Read call.
**/
@:named @:using(stdgo.io_test.Io_test.T_byteAndEOFReader_static_extension) typedef T_byteAndEOFReader = stdgo.GoUInt8;
function exampleCopy():Void {
        var _r = stdgo.strings.Strings.newReader(("some io.Reader stream to be read\n" : stdgo.GoString));
        {
            var __tmp__ = stdgo.io.Io.copy(stdgo.Go.asInterface(stdgo.os.Os.stdout), stdgo.Go.asInterface(_r)), __0:stdgo.GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
...
function exampleCopyBuffer():Void {
        ...
        {
            var __tmp__ = stdgo.io.Io.copyBuffer(stdgo.Go.asInterface(stdgo.os.Os.stdout), stdgo.Go.asInterface(_r1), _buf), __0:stdgo.GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
            };
        };
        {
            var __tmp__ = stdgo.io.Io.copyBuffer(stdgo.Go.asInterface(stdgo.os.Os.stdout), stdgo.Go.asInterface(_r2), _buf), __1:stdgo.GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
            };
        };
...
function exampleCopyN():Void {
        ...
        {
            var __tmp__ = stdgo.io.Io.copyN(stdgo.Go.asInterface(stdgo.os.Os.stdout), stdgo.Go.asInterface(_r), (4i64 : stdgo.GoInt64)), __0:stdgo.GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
            };
        };
...
function exampleReadAtLeast():Void {
        ...
        {
            var __tmp__ = stdgo.io.Io.readAtLeast(stdgo.Go.asInterface(_r), _buf, (4 : stdgo.GoInt)), __0:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
            };
        };
        ...
        {
            var __tmp__ = stdgo.io.Io.readAtLeast(stdgo.Go.asInterface(_r), _shortBuf, (4 : stdgo.GoInt)), __1:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
        ...
        {
            var __tmp__ = stdgo.io.Io.readAtLeast(stdgo.Go.asInterface(_r), _longBuf, (64 : stdgo.GoInt)), __2:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                stdgo.fmt.Fmt.println(stdgo.Go.toInterface(("error:" : stdgo.GoString)), stdgo.Go.toInterface(_err));
            };
        };
...
function exampleReadFull():Void {
        ...
        {
            var __tmp__ = stdgo.io.Io.readFull(stdgo.Go.asInterface(_r), _buf), __0:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
            };
        };
        ...
        var _longBuf = new stdgo.Slice<stdgo.GoUInt8>((64 : stdgo.GoInt).toBasic(), 0).__setNumber32__();
        {
            var __tmp__ = stdgo.io.Io.readFull(stdgo.Go.asInterface(_r), _longBuf), __1:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                stdgo.fmt.Fmt.println(stdgo.Go.toInterface(("error:" : stdgo.GoString)), stdgo.Go.toInterface(_err));
            };
        };
...
function exampleWriteString():Void {
        {
            var __tmp__ = stdgo.io.Io.writeString(stdgo.Go.asInterface(stdgo.os.Os.stdout), ("Hello World" : stdgo.GoString)), __0:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
            };
        };
...
function exampleLimitReader():Void {
        var _r = stdgo.strings.Strings.newReader(("some io.Reader stream to be read\n" : stdgo.GoString));
        var _lr:stdgo.io.Io.Reader = stdgo.io.Io.limitReader(stdgo.Go.asInterface(_r), (4i64 : stdgo.GoInt64));
        {
            var __tmp__ = stdgo.io.Io.copy(stdgo.Go.asInterface(stdgo.os.Os.stdout), _lr), __0:stdgo.GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
            };
        };
...
function exampleMultiReader():Void {
        ...
        {
            var __tmp__ = stdgo.io.Io.copy(stdgo.Go.asInterface(stdgo.os.Os.stdout), _r), __0:stdgo.GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
            };
        };
...
function exampleTeeReader():Void {
        ...
        {
            var __tmp__ = stdgo.io.Io.readAll(_r), __0:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
            };
        };
...
function exampleSectionReader():Void {
        var _r = stdgo.strings.Strings.newReader(("some io.Reader stream to be read\n" : stdgo.GoString));
        var _s = stdgo.io.Io.newSectionReader(stdgo.Go.asInterface(_r), (5i64 : stdgo.GoInt64), (17i64 : stdgo.GoInt64));
        {
            var __tmp__ = stdgo.io.Io.copy(stdgo.Go.asInterface(stdgo.os.Os.stdout), stdgo.Go.asInterface(_s)), __0:stdgo.GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
            };
        };
...
function exampleSectionReader_Seek():Void {
        ...
        {
            var __tmp__ = stdgo.io.Io.copy(stdgo.Go.asInterface(stdgo.os.Os.stdout), stdgo.Go.asInterface(_s)), __1:stdgo.GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
            };
        };
...
function exampleSeeker_Seek():Void {
        ...
        {
            var __tmp__ = stdgo.io.Io.copy(stdgo.Go.asInterface(stdgo.os.Os.stdout), stdgo.Go.asInterface(_r)), __1:stdgo.GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
            };
        };
...
function exampleMultiWriter():Void {
        ...
        var _w:stdgo.io.Io.Writer = stdgo.io.Io.multiWriter(stdgo.Go.asInterface((stdgo.Go.setRef(_buf1) : stdgo.Ref<stdgo.strings.Strings.Builder>)), stdgo.Go.asInterface((stdgo.Go.setRef(_buf2) : stdgo.Ref<stdgo.strings.Strings.Builder>)));
        {
            var __tmp__ = stdgo.io.Io.copy(_w, stdgo.Go.asInterface(_r)), __0:stdgo.GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
            };
        };
...
function examplePipe():Void {
        var __tmp__ = stdgo.io.Io.pipe(), _r:stdgo.Ref<stdgo.io.Io.PipeReader> = __tmp__._0, _w:stdgo.Ref<stdgo.io.Io.PipeWriter> = __tmp__._1;
        stdgo.Go.routine(() -> {
            var a = function():Void {
...
function exampleReadAll():Void {
        ...
        var __tmp__ = stdgo.io.Io.readAll(stdgo.Go.asInterface(_r)), _b:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
        };
        stdgo.fmt.Fmt.printf(("%s" : stdgo.GoString), stdgo.Go.toInterface(_b));
    }
function testCopy(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _rb = (stdgo.Go.setRef(({} : stdgo.io_test.Io_test.Buffer)) : stdgo.Ref<stdgo.io_test.Io_test.Buffer>);
        var _wb = (stdgo.Go.setRef(({} : stdgo.io_test.Io_test.Buffer)) : stdgo.Ref<stdgo.io_test.Io_test.Buffer>);
...
function testCopyNegative(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _rb = (stdgo.Go.setRef(({} : stdgo.io_test.Io_test.Buffer)) : stdgo.Ref<stdgo.io_test.Io_test.Buffer>);
        var _wb = (stdgo.Go.setRef(({} : stdgo.io_test.Io_test.Buffer)) : stdgo.Ref<stdgo.io_test.Io_test.Buffer>);
        _rb.writeString(("hello" : stdgo.GoString));
        copy(stdgo.Go.asInterface(_wb), stdgo.Go.asInterface((stdgo.Go.setRef(({ r : stdgo.Go.asInterface(_rb), n : (-1i64 : stdgo.GoInt64) } : stdgo.io.Io.LimitedReader)) : stdgo.Ref<stdgo.io.Io.LimitedReader>)));
...
function testCopyBuffer(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _rb = (stdgo.Go.setRef(({} : stdgo.io_test.Io_test.Buffer)) : stdgo.Ref<stdgo.io_test.Io_test.Buffer>);
        var _wb = (stdgo.Go.setRef(({} : stdgo.io_test.Io_test.Buffer)) : stdgo.Ref<stdgo.io_test.Io_test.Buffer>);
        _rb.writeString(("hello, world." : stdgo.GoString));
...
function testCopyBufferNil(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _rb = (stdgo.Go.setRef(({} : stdgo.io_test.Io_test.Buffer)) : stdgo.Ref<stdgo.io_test.Io_test.Buffer>);
        var _wb = (stdgo.Go.setRef(({} : stdgo.io_test.Io_test.Buffer)) : stdgo.Ref<stdgo.io_test.Io_test.Buffer>);
        _rb.writeString(("hello, world." : stdgo.GoString));
...
function testCopyReadFrom(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _rb = (stdgo.Go.setRef(({} : stdgo.io_test.Io_test.Buffer)) : stdgo.Ref<stdgo.io_test.Io_test.Buffer>);
        var _wb = (stdgo.Go.setRef(({} : stdgo.bytes.Bytes.Buffer)) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>);
        _rb.writeString(("hello, world." : stdgo.GoString));
        copy(stdgo.Go.asInterface(_wb), stdgo.Go.asInterface(_rb));
        if ((_wb.string() : stdgo.GoString) != (("hello, world." : stdgo.GoString))) {
            _t.errorf(("Copy did not work properly" : stdgo.GoString));
...
function testCopyWriteTo(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _rb = (stdgo.Go.setRef(({} : stdgo.bytes.Bytes.Buffer)) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>);
        var _wb = (stdgo.Go.setRef(({} : stdgo.io_test.Io_test.Buffer)) : stdgo.Ref<stdgo.io_test.Io_test.Buffer>);
        _rb.writeString(("hello, world." : stdgo.GoString));
        copy(stdgo.Go.asInterface(_wb), stdgo.Go.asInterface(_rb));
        if ((_wb.string() : stdgo.GoString) != (("hello, world." : stdgo.GoString))) {
...
**/
function testCopyPriority(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _rb = (stdgo.Go.setRef(({} : stdgo.io_test.Io_test.T_writeToChecker)) : stdgo.Ref<stdgo.io_test.Io_test.T_writeToChecker>);
        var _wb = (stdgo.Go.setRef(({} : stdgo.bytes.Bytes.Buffer)) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>);
        _rb.writeString(("hello, world." : stdgo.GoString));
        copy(stdgo.Go.asInterface(_wb), stdgo.Go.asInterface(_rb));
        if ((_wb.string() : stdgo.GoString) != (("hello, world." : stdgo.GoString))) {
...
**/
function testCopyReadErrWriteErr(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        var __0:stdgo.io_test.Io_test.T_zeroErrReader = ({ _err : _er } : stdgo.io_test.Io_test.T_zeroErrReader), __1:stdgo.io_test.Io_test.T_errWriter = ({ _err : _ew } : stdgo.io_test.Io_test.T_errWriter), _w:stdgo.io_test.Io_test.T_errWriter = __1, _r:stdgo.io_test.Io_test.T_zeroErrReader = __0;
...
function testCopyN(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _rb = (stdgo.Go.setRef(({} : stdgo.io_test.Io_test.Buffer)) : stdgo.Ref<stdgo.io_test.Io_test.Buffer>);
        var _wb = (stdgo.Go.setRef(({} : stdgo.io_test.Io_test.Buffer)) : stdgo.Ref<stdgo.io_test.Io_test.Buffer>);
        _rb.writeString(("hello, world." : stdgo.GoString));
...
function testCopyNReadFrom(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _rb = (stdgo.Go.setRef(({} : stdgo.io_test.Io_test.Buffer)) : stdgo.Ref<stdgo.io_test.Io_test.Buffer>);
        var _wb = (stdgo.Go.setRef(({} : stdgo.bytes.Bytes.Buffer)) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>);
        _rb.writeString(("hello" : stdgo.GoString));
        copyN(stdgo.Go.asInterface(_wb), stdgo.Go.asInterface(_rb), (5i64 : stdgo.GoInt64));
...
function testCopyNWriteTo(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _rb = (stdgo.Go.setRef(({} : stdgo.bytes.Bytes.Buffer)) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>);
        var _wb = (stdgo.Go.setRef(({} : stdgo.io_test.Io_test.Buffer)) : stdgo.Ref<stdgo.io_test.Io_test.Buffer>);
        _rb.writeString(("hello, world." : stdgo.GoString));
        copyN(stdgo.Go.asInterface(_wb), stdgo.Go.asInterface(_rb), (5i64 : stdgo.GoInt64));
...
function benchmarkCopyNSmall(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _bs = stdgo.bytes.Bytes.repeat((new stdgo.Slice<stdgo.GoUInt8>(1, 1, (0 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>), (513 : stdgo.GoInt));
        var _rd = stdgo.bytes.Bytes.newReader(_bs);
        var _buf = (stdgo.Go.setRef(({} : stdgo.io_test.Io_test.Buffer)) : stdgo.Ref<stdgo.io_test.Io_test.Buffer>);
        _b.resetTimer();
        {
...
function benchmarkCopyNLarge(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _bs = stdgo.bytes.Bytes.repeat((new stdgo.Slice<stdgo.GoUInt8>(1, 1, (0 : stdgo.GoUInt8)) : stdgo.Slice<stdgo.GoUInt8>), (32769 : stdgo.GoInt));
        var _rd = stdgo.bytes.Bytes.newReader(_bs);
        var _buf = (stdgo.Go.setRef(({} : stdgo.io_test.Io_test.Buffer)) : stdgo.Ref<stdgo.io_test.Io_test.Buffer>);
        _b.resetTimer();
        {
...
function testCopyNEOF(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _b = (stdgo.Go.setRef(({} : stdgo.bytes.Bytes.Buffer)) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>);
        var __tmp__ = copyN(stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.io_test.Io_test.T_noReadFrom(stdgo.Go.asInterface(_b)) : stdgo.io_test.Io_test.T_noReadFrom)) : stdgo.Ref<stdgo.io_test.Io_test.T_noReadFrom>)), stdgo.Go.asInterface(stdgo.strings.Strings.newReader(("foo" : stdgo.GoString))), (3i64 : stdgo.GoInt64)), _n:stdgo.GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        ...
        {
            var __tmp__ = copyN(stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.io_test.Io_test.T_noReadFrom(stdgo.Go.asInterface(_b)) : stdgo.io_test.Io_test.T_noReadFrom)) : stdgo.Ref<stdgo.io_test.Io_test.T_noReadFrom>)), stdgo.Go.asInterface(stdgo.strings.Strings.newReader(("foo" : stdgo.GoString))), (4i64 : stdgo.GoInt64));
            _n = __tmp__._0;
            _err = __tmp__._1;
        };
        ...
        {
            var __tmp__ = copyN(stdgo.Go.asInterface(_b), stdgo.Go.asInterface(stdgo.strings.Strings.newReader(("foo" : stdgo.GoString))), (3i64 : stdgo.GoInt64));
            _n = __tmp__._0;
            _err = __tmp__._1;
        };
        if ((_n != (3i64 : stdgo.GoInt64)) || (_err != null)) {
        ...
        {
            var __tmp__ = copyN(stdgo.Go.asInterface(_b), stdgo.Go.asInterface(stdgo.strings.Strings.newReader(("foo" : stdgo.GoString))), (4i64 : stdgo.GoInt64));
            _n = __tmp__._0;
            _err = __tmp__._1;
        };
        if ((_n != (3i64 : stdgo.GoInt64)) || (stdgo.Go.toInterface(_err) != stdgo.Go.toInterface(eof))) {
        ...
        {
            var __tmp__ = copyN(stdgo.Go.asInterface(_b), stdgo.Go.asInterface((new stdgo.io_test.Io_test.T_wantedAndErrReader() : stdgo.io_test.Io_test.T_wantedAndErrReader)), (5i64 : stdgo.GoInt64));
            _n = __tmp__._0;
            _err = __tmp__._1;
        };
        ...
        {
            var __tmp__ = copyN(stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.io_test.Io_test.T_noReadFrom(stdgo.Go.asInterface(_b)) : stdgo.io_test.Io_test.T_noReadFrom)) : stdgo.Ref<stdgo.io_test.Io_test.T_noReadFrom>)), stdgo.Go.asInterface((new stdgo.io_test.Io_test.T_wantedAndErrReader() : stdgo.io_test.Io_test.T_wantedAndErrReader)), (5i64 : stdgo.GoInt64));
            _n = __tmp__._0;
            _err = __tmp__._1;
        };
        if ((_n != (5i64 : stdgo.GoInt64)) || (_err != null)) {
...
function testReadAtLeast(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _rb:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        _testReadAtLeast(_t, stdgo.Go.asInterface((stdgo.Go.setRef(_rb) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)));
    }
function testReadAtLeastWithDataAndEOF(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _rb:T_dataAndErrorBuffer = ({} : stdgo.io_test.Io_test.T_dataAndErrorBuffer);
        _rb._err = eof;
        _testReadAtLeast(_t, stdgo.Go.asInterface((stdgo.Go.setRef(_rb) : stdgo.Ref<stdgo.io_test.Io_test.T_dataAndErrorBuffer>)));
    }
function testReadAtLeastWithDataAndError(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _rb:T_dataAndErrorBuffer = ({} : stdgo.io_test.Io_test.T_dataAndErrorBuffer);
        _rb._err = stdgo.fmt.Fmt.errorf(("fake error" : stdgo.GoString));
        _testReadAtLeast(_t, stdgo.Go.asInterface((stdgo.Go.setRef(_rb) : stdgo.Ref<stdgo.io_test.Io_test.T_dataAndErrorBuffer>)));
    }
function _testReadAtLeast(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _rb:ReadWriter):Void {
        ...
        var _want:stdgo.Error = errUnexpectedEOF;
        {
            var __tmp__ = try {
                ...
                { _0 : (null : stdgo.Ref<stdgo.io_test.Io_test.T_dataAndErrorBuffer>), _1 : false };
...
function testTeeReader(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        var __tmp__ = pipe(), _pr:stdgo.Ref<stdgo.io.Io.PipeReader> = __tmp__._0, _pw:stdgo.Ref<stdgo.io.Io.PipeWriter> = __tmp__._1;
        _pr.close();
...
function testSectionReader_ReadAt(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testSectionReader_Seek(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _br = stdgo.bytes.Bytes.newReader((("foo" : stdgo.GoString) : stdgo.Slice<stdgo.GoByte>));
...
function testSectionReader_Size(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testSectionReader_Max(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testCopyLargeWriter(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        _rb = (stdgo.Go.setRef(({} : stdgo.io_test.Io_test.Buffer)) : stdgo.Ref<stdgo.io_test.Io_test.Buffer>);
...
function testNopCloserWriterToForwarding(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testOffsetWriter_Seek(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            var _tmpfilename:stdgo.GoString = ("TestOffsetWriter_Seek" : stdgo.GoString);
            var __tmp__ = stdgo.os.Os.createTemp(_t.tempDir()?.__copy__(), _tmpfilename?.__copy__()), _tmpfile:stdgo.Ref<stdgo.os.Os.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            ...
            _t.run(("errWhence" : stdgo.GoString), function(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
            ...
            _t.run(("errOffset" : stdgo.GoString), function(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
            ...
            _t.run(("normal" : stdgo.GoString), function(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testOffsetWriter_WriteAt(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
        var _contentSize:stdgo.GoInt64 = (("0123456789ABCDEF" : stdgo.GoString).length : stdgo.GoInt64);
        var __tmp__ = stdgo.os.Os.mkdirTemp(_t.tempDir()?.__copy__(), ("TestOffsetWriter_WriteAt" : stdgo.GoString)), _tmpdir:stdgo.GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
        ...
        var _work:(stdgo.GoInt64, stdgo.GoInt64) -> Void = function(_off:stdgo.GoInt64, _at:stdgo.GoInt64):Void {
            var __deferstack__:Array<Void -> Void> = [];
            try {
                var _position:stdgo.GoString = stdgo.fmt.Fmt.sprintf(("off_%d_at_%d" : stdgo.GoString), stdgo.Go.toInterface(_off), stdgo.Go.toInterface(_at))?.__copy__();
                var __tmp__ = stdgo.os.Os.createTemp(_tmpdir?.__copy__(), _position?.__copy__()), _tmpfile:stdgo.Ref<stdgo.os.Os.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if ((_err != null) || ((_tmpfile == null) || (_tmpfile : Dynamic).__nil__)) {
                ...
                for (_step => _value in (("0123456789ABCDEF" : stdgo.GoString) : stdgo.Slice<stdgo.GoByte>)) {
                    ...
                    stdgo.Go.routine(() -> {
                        var a = function(_wg:stdgo.Ref<stdgo.sync.Sync.WaitGroup>, _tmpfile:stdgo.Ref<stdgo.os.Os.File>, _value:stdgo.GoByte, _off:stdgo.GoInt64, _at:stdgo.GoInt64, _step:stdgo.GoInt):Void {
                            var __deferstack__:Array<Void -> Void> = [];
                            try {
                                ...
                                stdgo.sync.atomic_.Atomic_.addInt64(stdgo.Go.pointer(_writeN), (_n : stdgo.GoInt64));
                                {
                                    for (defer in __deferstack__) {
                                        defer();
                                    };
                        ...
                        a((stdgo.Go.setRef(_wg) : stdgo.Ref<stdgo.sync.Sync.WaitGroup>), _tmpfile, _value, _off, _at, _step);
                    });
                };
                _wg.wait_();
...
function testWriteAt_PositionPriorToBase(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            var _tmpdir:stdgo.GoString = _t.tempDir()?.__copy__();
            var _tmpfilename:stdgo.GoString = ("TestOffsetWriter_WriteAt" : stdgo.GoString);
            var __tmp__ = stdgo.os.Os.createTemp(_tmpdir?.__copy__(), _tmpfilename?.__copy__()), _tmpfile:stdgo.Ref<stdgo.os.Os.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                _t.fatalf(("CreateTemp(%s) failed: %v" : stdgo.GoString), stdgo.Go.toInterface(_tmpfilename), stdgo.Go.toInterface(_err));
            };
            __deferstack__.unshift(() -> _tmpfile.close());
...
function testOffsetWriter_Write(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
        var _contentSize:stdgo.GoInt = (("0123456789ABCDEF" : stdgo.GoString).length);
        var _tmpdir:stdgo.GoString = _t.tempDir()?.__copy__();
        var _makeOffsetWriter:stdgo.GoString -> { var _0 : stdgo.Ref<stdgo.io.Io.OffsetWriter>; var _1 : stdgo.Ref<stdgo.os.Os.File>; } = function(_name:stdgo.GoString):{ var _0 : stdgo.Ref<OffsetWriter>; var _1 : stdgo.Ref<stdgo.os.Os.File>; } {
        ...
        var _checkContent = function(_name:stdgo.GoString, _f:stdgo.Ref<stdgo.os.Os.File>):Void {
        ...
        _t.run(_name?.__copy__(), function(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
            var __deferstack__:Array<Void -> Void> = [];
            try {
                var __tmp__ = _makeOffsetWriter(_name?.__copy__()), _w:stdgo.Ref<stdgo.io.Io.OffsetWriter> = __tmp__._0, _f:stdgo.Ref<stdgo.os.Os.File> = __tmp__._1;
                ...
                var __tmp__ = _makeOffsetWriter(_name?.__copy__()), _w2:stdgo.Ref<stdgo.io.Io.OffsetWriter> = __tmp__._0, _f2:stdgo.Ref<stdgo.os.Os.File> = __tmp__._1;
...
function testMultiReader(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testMultiReaderAsWriterTo(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _mr:stdgo.io.Io.Reader = multiReader(stdgo.Go.asInterface(stdgo.strings.Strings.newReader(("foo " : stdgo.GoString))), multiReader(stdgo.Go.asInterface(stdgo.strings.Strings.newReader(stdgo.Go.str()?.__copy__())), stdgo.Go.asInterface(stdgo.strings.Strings.newReader(("bar" : stdgo.GoString)))));
        var __tmp__ = try {
        ...
        var _sink = (stdgo.Go.setRef((new stdgo.strings.Strings.Builder() : stdgo.strings.Strings.Builder)) : stdgo.Ref<stdgo.strings.Strings.Builder>);
...
function testMultiWriter(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _sink = (stdgo.Go.setRef(({} : stdgo.bytes.Bytes.Buffer)) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>);
...
function testMultiWriter_String(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        _testMultiWriter(_t, stdgo.Go.asInterface((stdgo.Go.setRef(({} : stdgo.bytes.Bytes.Buffer)) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)));
    }
/**
...
**/
@:structInit @:using(stdgo.io_test.Io_test.T_testMultiWriter_WriteStringSingleAlloc_3___localname___simpleWriter_static_extension) class T_testMultiWriter_WriteStringSingleAlloc_3___localname___simpleWriter {
    @:embedded
...
**/
function testMultiWriter_WriteStringSingleAlloc(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        {};
        var _mw:stdgo.io.Io.Writer = multiWriter(stdgo.Go.asInterface((new stdgo.io_test.Io_test.T_testMultiWriter_WriteStringSingleAlloc_3___localname___simpleWriter(stdgo.Go.asInterface((stdgo.Go.setRef(_sink1) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>))) : stdgo.io_test.Io_test.T_testMultiWriter_WriteStringSingleAlloc_3___localname___simpleWriter)), stdgo.Go.asInterface((new stdgo.io_test.Io_test.T_testMultiWriter_WriteStringSingleAlloc_3___localname___simpleWriter(stdgo.Go.asInterface((stdgo.Go.setRef(_sink2) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>))) : stdgo.io_test.Io_test.T_testMultiWriter_WriteStringSingleAlloc_3___localname___simpleWriter)));
        var _allocs:stdgo.GoInt = (stdgo.testing.Testing.allocsPerRun((1000 : stdgo.GoInt), function():Void {
...
function testMultiWriter_StringCheckCall(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _c:T_writeStringChecker = ({} : stdgo.io_test.Io_test.T_writeStringChecker);
        var _mw:stdgo.io.Io.Writer = multiWriter(stdgo.Go.asInterface((stdgo.Go.setRef(_c) : stdgo.Ref<stdgo.io_test.Io_test.T_writeStringChecker>)));
        writeString(_mw, ("foo" : stdgo.GoString));
        if (!_c._called) {
            _t.error(stdgo.Go.toInterface(("did not see WriteString call to writeStringChecker" : stdgo.GoString)));
        };
    }
function _testMultiWriter(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _sink:T__interface_0):Void {
        ...
        var _sha1hex:stdgo.GoString = stdgo.fmt.Fmt.sprintf(("%x" : stdgo.GoString), stdgo.Go.toInterface(_sha1.sum((null : stdgo.Slice<stdgo.GoUInt8>))))?.__copy__();
...
**/
function testMultiWriterSingleChainFlatten(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _pc = new stdgo.Slice<stdgo.GoUIntptr>((1000 : stdgo.GoInt).toBasic(), 0);
        var _n:stdgo.GoInt = stdgo.runtime.Runtime.callers((0 : stdgo.GoInt), _pc);
        ...
        var _w:Writer = multiWriter(stdgo.Go.asInterface((function(_p:stdgo.Slice<stdgo.GoByte>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
            var _n:stdgo.GoInt = stdgo.runtime.Runtime.callers((1 : stdgo.GoInt), _pc);
...
function testMultiWriterError(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _f1:stdgo.io_test.Io_test.T_writerFunc = (function(_p:stdgo.Slice<stdgo.GoByte>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
            return { _0 : (_p.length) / (2 : stdgo.GoInt), _1 : errShortWrite };
        } : T_writerFunc);
        var _f2:stdgo.io_test.Io_test.T_writerFunc = (function(_p:stdgo.Slice<stdgo.GoByte>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
...
**/
function testMultiReaderCopy(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        _slice[(0 : stdgo.GoInt)] = (null : stdgo.io.Io.Reader);
...
**/
function testMultiWriterCopy(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _buf:stdgo.strings.Strings.Builder = ({} : stdgo.strings.Strings.Builder);
        var _slice = (new stdgo.Slice<stdgo.io.Io.Writer>(1, 1, stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.strings.Strings.Builder>))) : stdgo.Slice<stdgo.io.Io.Writer>);
        var _w:stdgo.io.Io.Writer = multiWriter(..._slice.__toArray__());
        _slice[(0 : stdgo.GoInt)] = (null : stdgo.io.Io.Writer);
...
**/
function testMultiReaderFlatten(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _pc = new stdgo.Slice<stdgo.GoUIntptr>((1000 : stdgo.GoInt).toBasic(), 0);
        var _n:stdgo.GoInt = stdgo.runtime.Runtime.callers((0 : stdgo.GoInt), _pc);
        var _myDepth:stdgo.GoInt = _callDepth((_pc.__slice__(0, _n) : stdgo.Slice<stdgo.GoUIntptr>));
        ...
        var _r:Reader = multiReader(stdgo.Go.asInterface((function(_p:stdgo.Slice<stdgo.GoByte>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
            ...
            return { _0 : (0 : stdgo.GoInt), _1 : stdgo.errors.Errors.new_(("irrelevant" : stdgo.GoString)) };
        } : T_readerFunc)));
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < (100 : stdgo.GoInt), _i++, {
...
**/
function testMultiReaderSingleByteWithEOF(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __tmp__ = readAll(limitReader(multiReader(stdgo.Go.asInterface(((97 : stdgo.io_test.Io_test.T_byteAndEOFReader) : T_byteAndEOFReader)), stdgo.Go.asInterface(((98 : stdgo.io_test.Io_test.T_byteAndEOFReader) : T_byteAndEOFReader))), (10i64 : stdgo.GoInt64))), _got:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _t.fatal(stdgo.Go.toInterface(_err));
        };
        {};
...
/**
    ...
    // yielding a (0, EOF).
**/
function testMultiReaderFinalEOF(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _r:stdgo.io.Io.Reader = multiReader(stdgo.Go.asInterface(stdgo.bytes.Bytes.newReader((null : stdgo.Slice<stdgo.GoUInt8>))), stdgo.Go.asInterface(((97 : stdgo.io_test.Io_test.T_byteAndEOFReader) : T_byteAndEOFReader)));
        var _buf = new stdgo.Slice<stdgo.GoUInt8>((2 : stdgo.GoInt).toBasic(), 0).__setNumber32__();
...
function testMultiReaderFreesExhaustedReaders(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _mr:Reader = (null : stdgo.io.Io.Reader);
        var _closed = new stdgo.Chan<T_wantedAndErrReader>(0, () -> ({} : T_wantedAndErrReader));
        {
            var a = function():Void {
                var _buf1 = stdgo.bytes.Bytes.newReader((("foo" : stdgo.GoString) : stdgo.Slice<stdgo.GoByte>));
                var _buf2 = stdgo.bytes.Bytes.newReader((("bar" : stdgo.GoString) : stdgo.Slice<stdgo.GoByte>));
                _mr = multiReader(stdgo.Go.asInterface(_buf1), stdgo.Go.asInterface(_buf2));
                stdgo.runtime.Runtime.setFinalizer(stdgo.Go.toInterface(stdgo.Go.asInterface(_buf1)), stdgo.Go.toInterface(function(_0:stdgo.Ref<stdgo.bytes.Bytes.Reader>):Void {
...
function testInterleavedMultiReader(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function _checkWrite(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _w:Writer, _data:stdgo.Slice<stdgo.GoByte>, _c:stdgo.Chan<stdgo.GoInt>):Void {
...
**/
function testPipe1(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _c = new stdgo.Chan<stdgo.GoInt>(0, () -> (0 : stdgo.GoInt));
        var __tmp__ = pipe(), _r:stdgo.Ref<stdgo.io.Io.PipeReader> = __tmp__._0, _w:stdgo.Ref<stdgo.io.Io.PipeWriter> = __tmp__._1;
...
function _reader(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _r:Reader, _c:stdgo.Chan<stdgo.GoInt>):Void {
        var _buf:stdgo.Slice<stdgo.GoUInt8> = new stdgo.Slice<stdgo.GoUInt8>((64 : stdgo.GoInt).toBasic(), 0).__setNumber32__();
        while (true) {
            var __tmp__ = _r.read(_buf), _n:stdgo.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (stdgo.Go.toInterface(_err) == (stdgo.Go.toInterface(eof))) {
...
**/
function testPipe2(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _c = new stdgo.Chan<stdgo.GoInt>(0, () -> (0 : stdgo.GoInt));
        var __tmp__ = pipe(), _r:stdgo.Ref<stdgo.io.Io.PipeReader> = __tmp__._0, _w:stdgo.Ref<stdgo.io.Io.PipeWriter> = __tmp__._1;
...
function testPipe3(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function _delayClose(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _cl:T_closer, _ch:stdgo.Chan<stdgo.GoInt>, _tt:T_pipeTest):Void {
...
function testPipeReadClose(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
**/
function testPipeReadClose2(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _c = new stdgo.Chan<stdgo.GoInt>((1 : stdgo.GoInt).toBasic(), () -> (0 : stdgo.GoInt));
        var __tmp__ = pipe(), _r:stdgo.Ref<stdgo.io.Io.PipeReader> = __tmp__._0, __0:stdgo.Ref<stdgo.io.Io.PipeWriter> = __tmp__._1;
        stdgo.Go.routine(() -> _delayClose(_t, stdgo.Go.asInterface(_r), _c, (new stdgo.io_test.Io_test.T_pipeTest() : stdgo.io_test.Io_test.T_pipeTest)));
...
function testPipeWriteClose(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        for (__0 => _tt in _pipeTests) {
            var _c = new stdgo.Chan<stdgo.GoInt>((1 : stdgo.GoInt).toBasic(), () -> (0 : stdgo.GoInt));
            var __tmp__ = pipe(), _r:stdgo.Ref<stdgo.io.Io.PipeReader> = __tmp__._0, _w:stdgo.Ref<stdgo.io.Io.PipeWriter> = __tmp__._1;
            if (_tt._async) {
...
**/
function testPipeWriteClose2(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _c = new stdgo.Chan<stdgo.GoInt>((1 : stdgo.GoInt).toBasic(), () -> (0 : stdgo.GoInt));
        var __tmp__ = pipe(), __0:stdgo.Ref<stdgo.io.Io.PipeReader> = __tmp__._0, _w:stdgo.Ref<stdgo.io.Io.PipeWriter> = __tmp__._1;
        stdgo.Go.routine(() -> _delayClose(_t, stdgo.Go.asInterface(_w), _c, (new stdgo.io_test.Io_test.T_pipeTest() : stdgo.io_test.Io_test.T_pipeTest)));
...
function testWriteEmpty(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __tmp__ = pipe(), _r:stdgo.Ref<stdgo.io.Io.PipeReader> = __tmp__._0, _w:stdgo.Ref<stdgo.io.Io.PipeWriter> = __tmp__._1;
        stdgo.Go.routine(() -> {
            var a = function():Void {
...
function testWriteNil(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __tmp__ = pipe(), _r:stdgo.Ref<stdgo.io.Io.PipeReader> = __tmp__._0, _w:stdgo.Ref<stdgo.io.Io.PipeWriter> = __tmp__._1;
        stdgo.Go.routine(() -> {
            var a = function():Void {
...
function testWriteAfterWriterClose(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __tmp__ = pipe(), _r:stdgo.Ref<stdgo.io.Io.PipeReader> = __tmp__._0, _w:stdgo.Ref<stdgo.io.Io.PipeWriter> = __tmp__._1;
...
**/
@:structInit @:using(stdgo.io_test.Io_test.T_testPipeCloseError_4___localname___testError1_static_extension) class T_testPipeCloseError_4___localname___testError1 {
    @:embedded
...
**/
@:structInit @:using(stdgo.io_test.Io_test.T_testPipeCloseError_5___localname___testError2_static_extension) class T_testPipeCloseError_5___localname___testError2 {
    @:embedded
    public var _error : stdgo.Error = (null : stdgo.Error);
    public function new(?_error:stdgo.Error) {
        if (_error != null) this._error = _error;
...
function testPipeCloseError(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
        {};
        var __tmp__ = pipe(), _r:stdgo.Ref<stdgo.io.Io.PipeReader> = __tmp__._0, _w:stdgo.Ref<stdgo.io.Io.PipeWriter> = __tmp__._1;
        _r.closeWithError(stdgo.Go.asInterface((new stdgo.io_test.Io_test.T_testPipeCloseError_4___localname___testError1() : stdgo.io_test.Io_test.T_testPipeCloseError_4___localname___testError1)));
        {
...
function testPipeConcurrent(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
        _t.run(("Write" : stdgo.GoString), function(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
            var __tmp__ = pipe(), _r:stdgo.Ref<stdgo.io.Io.PipeReader> = __tmp__._0, _w:stdgo.Ref<stdgo.io.Io.PipeWriter> = __tmp__._1;
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            ...
            var _want:stdgo.GoString = stdgo.strings.Strings.repeat(("0123456789abcdef" : stdgo.GoString), (8 : stdgo.GoInt))?.__copy__();
            if (_got != (_want)) {
                _t.errorf(("got: %q; want: %q" : stdgo.GoString), stdgo.Go.toInterface(_got), stdgo.Go.toInterface(_want));
            };
        });
        _t.run(("Read" : stdgo.GoString), function(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
            var __tmp__ = pipe(), _r:stdgo.Ref<stdgo.io.Io.PipeReader> = __tmp__._0, _w:stdgo.Ref<stdgo.io.Io.PipeWriter> = __tmp__._1;
            ...
            var _want = stdgo.bytes.Bytes.repeat((("0123456789abcdef" : stdgo.GoString) : stdgo.Slice<stdgo.GoByte>), (8 : stdgo.GoInt));
...
function _sortBytesInGroups(_b:stdgo.Slice<stdgo.GoByte>, _n:stdgo.GoInt):stdgo.Slice<stdgo.GoByte> {
        ...
        stdgo.sort.Sort.slice(stdgo.Go.toInterface(_groups), function(_i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
            return stdgo.bytes.Bytes.compare(_groups[(_i : stdgo.GoInt)], _groups[(_j : stdgo.GoInt)]) < (0 : stdgo.GoInt);
        });
        return stdgo.bytes.Bytes.join(_groups, (null : stdgo.Slice<stdgo.GoUInt8>));
    }
...
@:keep @:allow(stdgo.io_test.Io_test.T_writeToChecker_asInterface) class T_writeToChecker_static_extension {
    ...
    @:embedded
    public static function readFrom( __self__:T_writeToChecker, _r:stdgo.io.Io.Reader):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } return __self__.readFrom(_r);
    @:embedded
...
@:keep @:allow(stdgo.io_test.Io_test.T_dataAndErrorBuffer_asInterface) class T_dataAndErrorBuffer_static_extension {
    ...
    @:embedded
    public static function writeTo( __self__:T_dataAndErrorBuffer, _w:stdgo.io.Io.Writer):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } return __self__.writeTo(_w);
    @:embedded
    ...
    @:embedded
    public static function readFrom( __self__:T_dataAndErrorBuffer, _r:stdgo.io.Io.Reader):{ var _0 : stdgo.GoInt64; var _1 : stdgo.Error; } return __self__.readFrom(_r);
    @:embedded
...
@:keep @:allow(stdgo.io_test.Io_test.T_pipeTest_asInterface) class T_pipeTest_static_extension {
    ...
    static public function string( _p:T_pipeTest):stdgo.GoString {
        ...
        return stdgo.fmt.Fmt.sprintf(("async=%v err=%v closeWithError=%v" : stdgo.GoString), stdgo.Go.toInterface(_p._async), stdgo.Go.toInterface(_p._err), stdgo.Go.toInterface(_p._closeWithError))?.__copy__();
    }
}
...
@:keep @:allow(stdgo.io_test.Io_test.T_testMultiWriter_WriteStringSingleAlloc_3___localname___simpleWriter_asInterface) class T_testMultiWriter_WriteStringSingleAlloc_3___localname___simpleWriter_static_extension {
    @:embedded
...
@:keep @:allow(stdgo.io_test.Io_test.T_testPipeCloseError_4___localname___testError1_asInterface) class T_testPipeCloseError_4___localname___testError1_static_extension {
    @:embedded
...
@:keep @:allow(stdgo.io_test.Io_test.T_testPipeCloseError_5___localname___testError2_asInterface) class T_testPipeCloseError_5___localname___testError2_static_extension {
    @:embedded
