...
function testSectionReader_Seek(_t:stdgo.testing.Testing.T):Void {
        ...
        var __tmp__ = _sr.read(new Slice<GoUInt8>((10 : GoInt).toBasic(), 0, ...[for (i in 0 ... (10 : GoInt).toBasic()) (0 : GoUInt8)])), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if ((_n != (0 : GoInt)) || (_err != eof)) {
...
function testSectionReader_Max(_t:stdgo.testing.Testing.T):Void {
        ...
        var __tmp__ = _sr.read(new Slice<GoUInt8>((3 : GoInt).toBasic(), 0, ...[for (i in 0 ... (3 : GoInt).toBasic()) (0 : GoUInt8)])), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
...
function testNopCloserWriterToForwarding(_t:stdgo.testing.Testing.T):Void {
        for (_0 => _tc in (new GoArray<T__struct_3>(({ name : (Go.str("not a WriterTo") : GoString), _r : (null : Reader) } : T__struct_3), ({ name : (Go.str("a WriterTo") : GoString), _r : ({ reader : (null : Reader), writerTo : (null : WriterTo) } : T__struct_4) } : T__struct_3)) : GoArray<T__struct_3>)) {
...
function testMultiWriterError(_t:stdgo.testing.Testing.T):Void {
        ...
        var __tmp__ = _w.write(new Slice<GoUInt8>((100 : GoInt).toBasic(), 0, ...[for (i in 0 ... (100 : GoInt).toBasic()) (0 : GoUInt8)])), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
...
function testPipeReadClose2(_t:stdgo.testing.Testing.T):Void {
        ...
        var __tmp__ = _r.read(new Slice<GoUInt8>((64 : GoInt).toBasic(), 0, ...[for (i in 0 ... (64 : GoInt).toBasic()) (0 : GoUInt8)])), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        _c.__get__();
        if ((_n != (0 : GoInt)) || (_err != errClosedPipe)) {
...
function testPipeWriteClose2(_t:stdgo.testing.Testing.T):Void {
        ...
        var __tmp__ = _w.write(new Slice<GoUInt8>((64 : GoInt).toBasic(), 0, ...[for (i in 0 ... (64 : GoInt).toBasic()) (0 : GoUInt8)])), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        _c.__get__();
        if ((_n != (0 : GoInt)) || (_err != errClosedPipe)) {
                        ...
                        var a = function():Void {
                            stdgo.time.Time.sleep((1000000 : stdgo.time.Time.Duration));
                            {
                                ...
                                if ((_n != (Go.str("0123456789abcdef") : GoString).length) || (_err != null)) {
                                    _t.errorf((Go.str("Write() = (%d, %v); want (%d, nil)") : GoString), Go.toInterface(_n), Go.toInterface(_err), Go.toInterface(((Go.str("0123456789abcdef") : GoString).length)));
                                };
                            };
                        };
                        a();
