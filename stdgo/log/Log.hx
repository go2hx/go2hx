...
**/
var _std : stdgo.Ref<stdgo.log.Log.Logger> = new_(stdgo.Go.asInterface(stdgo.os.Os.stderr), stdgo.Go.str()?.__copy__(), (3 : stdgo.GoInt));
/**
    
    
    
**/
var _bufferPool : stdgo.sync.Sync.Pool = ({ new_ : function():stdgo.AnyInterface {
...
14,
14,
(new stdgo.log.Log.T_tester((0 : stdgo.GoInt), stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()) : stdgo.log.Log.T_tester),
(new stdgo.log.Log.T_tester((0 : stdgo.GoInt), ("XXX" : stdgo.GoString), ("XXX" : stdgo.GoString)) : stdgo.log.Log.T_tester),
(new stdgo.log.Log.T_tester((1 : stdgo.GoInt), stdgo.Go.str()?.__copy__(), ("[0-9][0-9][0-9][0-9]/[0-9][0-9]/[0-9][0-9] " : stdgo.GoString)) : stdgo.log.Log.T_tester),
(new stdgo.log.Log.T_tester((2 : stdgo.GoInt), stdgo.Go.str()?.__copy__(), ("[0-9][0-9]:[0-9][0-9]:[0-9][0-9] " : stdgo.GoString)) : stdgo.log.Log.T_tester),
(new stdgo.log.Log.T_tester((66 : stdgo.GoInt), ("XXX" : stdgo.GoString), ("[0-9][0-9]:[0-9][0-9]:[0-9][0-9] XXX" : stdgo.GoString)) : stdgo.log.Log.T_tester),
(new stdgo.log.Log.T_tester((6 : stdgo.GoInt), stdgo.Go.str()?.__copy__(), ("[0-9][0-9]:[0-9][0-9]:[0-9][0-9]\\.[0-9][0-9][0-9][0-9][0-9][0-9] " : stdgo.GoString)) : stdgo.log.Log.T_tester),
(new stdgo.log.Log.T_tester((4 : stdgo.GoInt), stdgo.Go.str()?.__copy__(), ("[0-9][0-9]:[0-9][0-9]:[0-9][0-9]\\.[0-9][0-9][0-9][0-9][0-9][0-9] " : stdgo.GoString)) : stdgo.log.Log.T_tester),
(new stdgo.log.Log.T_tester((8 : stdgo.GoInt), stdgo.Go.str()?.__copy__(), (".*/[A-Za-z0-9_\\-]+\\.go:(63|65): " : stdgo.GoString)) : stdgo.log.Log.T_tester),
(new stdgo.log.Log.T_tester((16 : stdgo.GoInt), stdgo.Go.str()?.__copy__(), ("[A-Za-z0-9_\\-]+\\.go:(63|65): " : stdgo.GoString)) : stdgo.log.Log.T_tester),
(new stdgo.log.Log.T_tester((24 : stdgo.GoInt), stdgo.Go.str()?.__copy__(), ("[A-Za-z0-9_\\-]+\\.go:(63|65): " : stdgo.GoString)) : stdgo.log.Log.T_tester),
(new stdgo.log.Log.T_tester((15 : stdgo.GoInt), ("XXX" : stdgo.GoString), ("XXX[0-9][0-9][0-9][0-9]/[0-9][0-9]/[0-9][0-9] [0-9][0-9]:[0-9][0-9]:[0-9][0-9]\\.[0-9][0-9][0-9][0-9][0-9][0-9] .*/[A-Za-z0-9_\\-]+\\.go:(63|65): " : stdgo.GoString)) : stdgo.log.Log.T_tester),
(new stdgo.log.Log.T_tester((23 : stdgo.GoInt), ("XXX" : stdgo.GoString), ("XXX[0-9][0-9][0-9][0-9]/[0-9][0-9]/[0-9][0-9] [0-9][0-9]:[0-9][0-9]:[0-9][0-9]\\.[0-9][0-9][0-9][0-9][0-9][0-9] [A-Za-z0-9_\\-]+\\.go:(63|65): " : stdgo.GoString)) : stdgo.log.Log.T_tester),
(new stdgo.log.Log.T_tester((79 : stdgo.GoInt), ("XXX" : stdgo.GoString), ("[0-9][0-9][0-9][0-9]/[0-9][0-9]/[0-9][0-9] [0-9][0-9]:[0-9][0-9]:[0-9][0-9]\\.[0-9][0-9][0-9][0-9][0-9][0-9] .*/[A-Za-z0-9_\\-]+\\.go:(63|65): XXX" : stdgo.GoString)) : stdgo.log.Log.T_tester),
(new stdgo.log.Log.T_tester((87 : stdgo.GoInt), ("XXX" : stdgo.GoString), ("[0-9][0-9][0-9][0-9]/[0-9][0-9]/[0-9][0-9] [0-9][0-9]:[0-9][0-9]:[0-9][0-9]\\.[0-9][0-9][0-9][0-9][0-9][0-9] [A-Za-z0-9_\\-]+\\.go:(63|65): XXX" : stdgo.GoString)) : stdgo.log.Log.T_tester)) : stdgo.Slice<stdgo.log.Log.T_tester>);
/**
...
**/
function new_(_out:stdgo.io.Io.Writer, _prefix:stdgo.GoString, _flag:stdgo.GoInt):stdgo.Ref<Logger> {
        var _l = (stdgo.Go.setRef(({} : stdgo.log.Log.Logger)) : stdgo.Ref<stdgo.log.Log.Logger>);
        _l.setOutput(_out);
...
**/
function _formatHeader(_buf:stdgo.Ref<stdgo.Slice<stdgo.GoByte>>, _t:stdgo.time.Time.Time, _prefix:stdgo.GoString, _flag:stdgo.GoInt, _file:stdgo.GoString, _line:stdgo.GoInt):Void {
...
function fatal(_v:haxe.Rest<stdgo.AnyInterface>):Void {
        var _v = new stdgo.Slice<stdgo.AnyInterface>(_v.length, 0, ..._v);
        _std.output((2 : stdgo.GoInt), stdgo.fmt.Fmt.sprint(..._v.__toArray__())?.__copy__());
...
function fatalf(_format:stdgo.GoString, _v:haxe.Rest<stdgo.AnyInterface>):Void {
        var _v = new stdgo.Slice<stdgo.AnyInterface>(_v.length, 0, ..._v);
        _std.output((2 : stdgo.GoInt), stdgo.fmt.Fmt.sprintf(_format?.__copy__(), ..._v.__toArray__())?.__copy__());
        Sys.exit((1 : stdgo.GoInt));
    }
/**
...
function fatalln(_v:haxe.Rest<stdgo.AnyInterface>):Void {
        var _v = new stdgo.Slice<stdgo.AnyInterface>(_v.length, 0, ..._v);
        _std.output((2 : stdgo.GoInt), stdgo.fmt.Fmt.sprintln(..._v.__toArray__())?.__copy__());
        Sys.exit((1 : stdgo.GoInt));
    }
/**
...
**/
function _testPrint(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _flag:stdgo.GoInt, _prefix:stdgo.GoString, _pattern:stdgo.GoString, _useFormat:Bool):Void {
...
function testDefault(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {
            var _got = default_();
            if (_got != (_std)) {
...
function testAll(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testOutput(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
        var _b:stdgo.strings.Strings.Builder = ({} : stdgo.strings.Strings.Builder);
        var _l = new_(stdgo.Go.asInterface((stdgo.Go.setRef(_b) : stdgo.Ref<stdgo.strings.Strings.Builder>)), stdgo.Go.str()?.__copy__(), (0 : stdgo.GoInt));
...
function testNonNewLogger(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _l:Logger = ({} : stdgo.log.Log.Logger);
        _l.setOutput(stdgo.Go.asInterface((stdgo.Go.setRef(({} : stdgo.bytes.Bytes.Buffer)) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)));
        _l.print(stdgo.Go.toInterface(("hello" : stdgo.GoString)));
    }
function testOutputRace(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _b:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        var _l = new_(stdgo.Go.asInterface((stdgo.Go.setRef(_b) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), stdgo.Go.str()?.__copy__(), (0 : stdgo.GoInt));
...
function testFlagAndPrefixSetting(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _b:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        var _l = new_(stdgo.Go.asInterface((stdgo.Go.setRef(_b) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), ("Test:" : stdgo.GoString), (3 : stdgo.GoInt));
...
function testUTCFlag(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _b:stdgo.strings.Strings.Builder = ({} : stdgo.strings.Strings.Builder);
        var _l = new_(stdgo.Go.asInterface((stdgo.Go.setRef(_b) : stdgo.Ref<stdgo.strings.Strings.Builder>)), ("Test:" : stdgo.GoString), (3 : stdgo.GoInt));
...
function testEmptyPrintCreatesLine(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _b:stdgo.strings.Strings.Builder = ({} : stdgo.strings.Strings.Builder);
        var _l = new_(stdgo.Go.asInterface((stdgo.Go.setRef(_b) : stdgo.Ref<stdgo.strings.Strings.Builder>)), ("Header:" : stdgo.GoString), (3 : stdgo.GoInt));
        _l.print();
        _l.println(stdgo.Go.toInterface(("non-empty" : stdgo.GoString)));
        var _output:stdgo.GoString = (_b.string() : stdgo.GoString)?.__copy__();
        {
            var _n:stdgo.GoInt = stdgo.strings.Strings.count(_output?.__copy__(), ("Header" : stdgo.GoString));
            if (_n != ((2 : stdgo.GoInt))) {
                _t.errorf(("expected 2 headers, got %d" : stdgo.GoString), stdgo.Go.toInterface(_n));
            };
        };
        {
            var _n:stdgo.GoInt = stdgo.strings.Strings.count(_output?.__copy__(), ("\n" : stdgo.GoString));
            if (_n != ((2 : stdgo.GoInt))) {
                _t.errorf(("expected 2 lines, got %d" : stdgo.GoString), stdgo.Go.toInterface(_n));
            };
        };
    }
function testDiscard(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _l = new_(stdgo.io.Io.discard, stdgo.Go.str()?.__copy__(), (0 : stdgo.GoInt));
        var _s:stdgo.GoString = stdgo.strings.Strings.repeat(("a" : stdgo.GoString), (102400 : stdgo.GoInt))?.__copy__();
        var _c:stdgo.GoFloat64 = stdgo.testing.Testing.allocsPerRun((100 : stdgo.GoInt), function():Void {
...
function benchmarkItoa(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
...
function benchmarkPrintln(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {};
        var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        var _l = new_(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), stdgo.Go.str()?.__copy__(), (3 : stdgo.GoInt));
        _b.reportAllocs();
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
...
function benchmarkPrintlnNoFlags(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {};
        var _buf:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
        var _l = new_(stdgo.Go.asInterface((stdgo.Go.setRef(_buf) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)), stdgo.Go.str()?.__copy__(), (0 : stdgo.GoInt));
        _b.reportAllocs();
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
...
function benchmarkConcurrent(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _l = new_(stdgo.Go.asInterface((new stdgo.log.Log.T_discard() : stdgo.log.Log.T_discard)), ("prefix: " : stdgo.GoString), (79 : stdgo.GoInt));
        var _group:stdgo.sync.Sync.WaitGroup = ({} : stdgo.sync.Sync.WaitGroup);
        {
            var _i:stdgo.GoInt = stdgo.runtime.Runtime.numCPU();
            stdgo.Go.cfor(_i > (0 : stdgo.GoInt), _i--, {
...
function benchmarkDiscard(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _l = new_(stdgo.io.Io.discard, stdgo.Go.str()?.__copy__(), (19 : stdgo.GoInt));
        _b.reportAllocs();
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
...
@:keep var _ = {
        try {
            stdgo.log.internal.Internal.defaultOutput = function(_pc:stdgo.GoUIntptr, _data:stdgo.Slice<stdgo.GoByte>):stdgo.Error {
...
@:keep @:allow(stdgo.log.Log.Logger_asInterface) class Logger_static_extension {
    ...
    **/
    @:keep
    static public function writer( _l:stdgo.Ref<Logger>):stdgo.io.Io.Writer {
    ...
    **/
    ...
    static public function fatalln( _l:stdgo.Ref<Logger>, _v:haxe.Rest<stdgo.AnyInterface>):Void {
        var _v = new stdgo.Slice<stdgo.AnyInterface>(_v.length, 0, ..._v);
        @:recv var _l:stdgo.Ref<Logger> = _l;
        _l.output((2 : stdgo.GoInt), stdgo.fmt.Fmt.sprintln(..._v.__toArray__())?.__copy__());
        Sys.exit((1 : stdgo.GoInt));
    }
    /**
        // Fatalf is equivalent to l.Printf() followed by a call to os.Exit(1).
    **/
    ...
    static public function fatalf( _l:stdgo.Ref<Logger>, _format:stdgo.GoString, _v:haxe.Rest<stdgo.AnyInterface>):Void {
        var _v = new stdgo.Slice<stdgo.AnyInterface>(_v.length, 0, ..._v);
        @:recv var _l:stdgo.Ref<Logger> = _l;
        _l.output((2 : stdgo.GoInt), stdgo.fmt.Fmt.sprintf(_format?.__copy__(), ..._v.__toArray__())?.__copy__());
        Sys.exit((1 : stdgo.GoInt));
    }
    /**
        // Fatal is equivalent to l.Print() followed by a call to os.Exit(1).
    **/
    ...
    static public function fatal( _l:stdgo.Ref<Logger>, _v:haxe.Rest<stdgo.AnyInterface>):Void {
        var _v = new stdgo.Slice<stdgo.AnyInterface>(_v.length, 0, ..._v);
        @:recv var _l:stdgo.Ref<Logger> = _l;
        _l.output((2 : stdgo.GoInt), stdgo.fmt.Fmt.sprint(..._v.__toArray__())?.__copy__());
        Sys.exit((1 : stdgo.GoInt));
    }
    /**
        // Println calls l.Output to print to the logger.
        ...
        try {
            ...
            if (_flag & (24 : stdgo.GoInt) != ((0 : stdgo.GoInt))) {
                if (_pc == ((0 : stdgo.GoUIntptr))) {
                    ...
                    var _fs = stdgo.runtime.Runtime.callersFrames((new stdgo.Slice<stdgo.GoUIntptr>(1, 1, _pc) : stdgo.Slice<stdgo.GoUIntptr>));
    ...
    **/
    @:keep
    static public function setOutput( _l:stdgo.Ref<Logger>, _w:stdgo.io.Io.Writer):Void {
        @:recv var _l:stdgo.Ref<Logger> = _l;
        var __deferstack__:Array<Void -> Void> = [];
        try {
            _l._outMu.lock();
