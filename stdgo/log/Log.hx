...
@:structInit class Logger {
    ...
    public function output(_calldepth:GoInt, _s:GoString):Error {
        ...
        try {
            ...
            var __tmp__ = _l.value._out.write(_l.value._buf), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            {
                for (defer in deferstack) {
                    defer();
                };
    ...
    public function new(?_mu:stdgo.sync.Sync.Mutex, ?_prefix:GoString, ?_flag:GoInt, ?_out:stdgo.io.Io.Writer, ?_buf:Slice<GoUInt8>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_mu) + " " + Go.string(_prefix) + " " + Go.string(_flag) + " " + Go.string(_out) + " " + Go.string(_buf) + "}";
    }
...
function new_(_out:stdgo.io.Io.Writer, _prefix:GoString, _flag:GoInt):Pointer<Logger> {
        return Go.pointer((({ _out : _out, _prefix : _prefix, _flag : _flag, _mu : new stdgo.sync.Sync.Mutex(), _buf : new Slice<GoUInt8>().nil() } : Logger)));
    }
/**
...
class Logger_extension_fields {
    public function setOutput(__tmp__, _w:stdgo.io.Io.Writer):Void __tmp__.setOutput(_w);
    public function _formatHeader(__tmp__, _buf:Pointer<Slice<GoByte>>, _t:stdgo.time.Time.Time, _file:GoString, _line:GoInt):Void __tmp__._formatHeader(_buf, _t, _file, _line);
    public function output(__tmp__, _calldepth:GoInt, _s:GoString):Error return __tmp__.output(_calldepth, _s);
    public function printf(__tmp__, _format:GoString, _v:haxe.Rest<AnyInterface>):Void __tmp__.printf(_format, _v);
    public function print(__tmp__, _v:haxe.Rest<AnyInterface>):Void __tmp__.print(_v);
    public function println(__tmp__, _v:haxe.Rest<AnyInterface>):Void __tmp__.println(_v);
    public function fatal(__tmp__, _v:haxe.Rest<AnyInterface>):Void __tmp__.fatal(_v);
    public function fatalf(__tmp__, _format:GoString, _v:haxe.Rest<AnyInterface>):Void __tmp__.fatalf(_format, _v);
    public function fatalln(__tmp__, _v:haxe.Rest<AnyInterface>):Void __tmp__.fatalln(_v);
    public function panic(__tmp__, _v:haxe.Rest<AnyInterface>):Void __tmp__.panic(_v);
    public function panicf(__tmp__, _format:GoString, _v:haxe.Rest<AnyInterface>):Void __tmp__.panicf(_format, _v);
    public function panicln(__tmp__, _v:haxe.Rest<AnyInterface>):Void __tmp__.panicln(_v);
    public function flags(__tmp__):GoInt return __tmp__.flags();
    public function setFlags(__tmp__, _flag:GoInt):Void __tmp__.setFlags(_flag);
    public function prefix(__tmp__):GoString return __tmp__.prefix();
    public function setPrefix(__tmp__, _prefix:GoString):Void __tmp__.setPrefix(_prefix);
    public function writer(__tmp__):stdgo.io.Io.Writer return __tmp__.writer();
}
