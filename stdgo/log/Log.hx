...
private var _tests:Slice<T_tester> = (new Slice<T_tester>(0, 0, (new T_tester((0 : GoInt), Go.str(), Go.str()) : T_tester),
	(new T_tester((0 : GoInt), ("XXX" : GoString), ("XXX" : GoString)) : T_tester),
	(new T_tester((1 : GoInt), Go.str(), ("[0-9][0-9][0-9][0-9]/[0-9][0-9]/[0-9][0-9] " : GoString)) : T_tester),
	(new T_tester((2 : GoInt), Go.str(), ("[0-9][0-9]:[0-9][0-9]:[0-9][0-9] " : GoString)) : T_tester),
	(new T_tester((66 : GoInt), ("XXX" : GoString), ("[0-9][0-9]:[0-9][0-9]:[0-9][0-9] XXX" : GoString)) : T_tester),
	(new T_tester((6 : GoInt), Go.str(), ("[0-9][0-9]:[0-9][0-9]:[0-9][0-9]\\.[0-9][0-9][0-9][0-9][0-9][0-9] " : GoString)) : T_tester),
	(new T_tester((4 : GoInt), Go.str(), ("[0-9][0-9]:[0-9][0-9]:[0-9][0-9]\\.[0-9][0-9][0-9][0-9][0-9][0-9] " : GoString)) : T_tester),
	(new T_tester((8 : GoInt), Go.str(), (".*/[A-Za-z0-9_\\-]+\\.go:(61|63): " : GoString)) : T_tester),
	(new T_tester((16 : GoInt), Go.str(), ("[A-Za-z0-9_\\-]+\\.go:(61|63): " : GoString)) : T_tester),
	(new T_tester((24 : GoInt), Go.str(), ("[A-Za-z0-9_\\-]+\\.go:(61|63): " : GoString)) : T_tester),
	(new T_tester((15 : GoInt), ("XXX" : GoString),
		("XXX[0-9][0-9][0-9][0-9]/[0-9][0-9]/[0-9][0-9] [0-9][0-9]:[0-9][0-9]:[0-9][0-9]\\.[0-9][0-9][0-9][0-9][0-9][0-9] .*/[A-Za-z0-9_\\-]+\\.go:(61|63): " : GoString)) : T_tester),
	(new T_tester((23 : GoInt), ("XXX" : GoString),
		("XXX[0-9][0-9][0-9][0-9]/[0-9][0-9]/[0-9][0-9] [0-9][0-9]:[0-9][0-9]:[0-9][0-9]\\.[0-9][0-9][0-9][0-9][0-9][0-9] [A-Za-z0-9_\\-]+\\.go:(61|63): " : GoString)) : T_tester),
	(new T_tester((79 : GoInt), ("XXX" : GoString),
		("[0-9][0-9][0-9][0-9]/[0-9][0-9]/[0-9][0-9] [0-9][0-9]:[0-9][0-9]:[0-9][0-9]\\.[0-9][0-9][0-9][0-9][0-9][0-9] .*/[A-Za-z0-9_\\-]+\\.go:(61|63): XXX" : GoString)) : T_tester),
	(new T_tester((87 : GoInt), ("XXX" : GoString),
		("[0-9][0-9][0-9][0-9]/[0-9][0-9]/[0-9][0-9] [0-9][0-9]:[0-9][0-9]:[0-9][0-9]\\.[0-9][0-9][0-9][0-9][0-9][0-9] [A-Za-z0-9_\\-]+\\.go:(61|63): XXX" : GoString)) : T_tester)) : Slice<T_tester>);
...
final rdate:GoString = ("[0-9][0-9][0-9][0-9]/[0-9][0-9]/[0-9][0-9]" : GoString);
final rtime:GoString = ("[0-9][0-9]:[0-9][0-9]:[0-9][0-9]" : GoString);
final rmicroseconds:GoString = ("\\.[0-9][0-9][0-9][0-9][0-9][0-9]" : GoString);

/**
	// must update if the calls to l.Printf / l.Print below move
**/
final rline:GoString = ("(61|63):" : GoString);

final rlongfile:GoString = (".*/[A-Za-z0-9_\\-]+\\.go:(61|63):" : GoString);
final rshortfile:GoString = ("[A-Za-z0-9_\\-]+\\.go:(61|63):" : GoString);
...
function testEmptyPrintCreatesLine(_t:Ref<stdgo.testing.Testing.T>):Void {
	var _b:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer);
	var _l = new_(Go.asInterface((_b : Ref<stdgo.bytes.Bytes.Buffer>)), ("Header:" : GoString), (3 : GoInt));
	_l.print();
