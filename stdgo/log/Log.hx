...
**/
private var _tests = (new Slice<T_tester>(
0,
0,
(new T_tester((0 : GoInt), Go.str(), Go.str()) : T_tester),
...
(new T_tester((15 : GoInt), ("XXX" : GoString), ("XXX[0-9][0-9][0-9][0-9]/[0-9][0-9]/[0-9][0-9] [0-9][0-9]:[0-9][0-9]:[0-9][0-9]\\.[0-9][0-9][0-9][0-9][0-9][0-9] .*/[A-Za-z0-9_\\-]+\\.go:(61|63): " : GoString)) : T_tester),
(new T_tester((23 : GoInt), ("XXX" : GoString), ("XXX[0-9][0-9][0-9][0-9]/[0-9][0-9]/[0-9][0-9] [0-9][0-9]:[0-9][0-9]:[0-9][0-9]\\.[0-9][0-9][0-9][0-9][0-9][0-9] [A-Za-z0-9_\\-]+\\.go:(61|63): " : GoString)) : T_tester),
(new T_tester((79 : GoInt), ("XXX" : GoString), ("[0-9][0-9][0-9][0-9]/[0-9][0-9]/[0-9][0-9] [0-9][0-9]:[0-9][0-9]:[0-9][0-9]\\.[0-9][0-9][0-9][0-9][0-9][0-9] .*/[A-Za-z0-9_\\-]+\\.go:(61|63): XXX" : GoString)) : T_tester),
(new T_tester((87 : GoInt), ("XXX" : GoString), ("[0-9][0-9][0-9][0-9]/[0-9][0-9]/[0-9][0-9] [0-9][0-9]:[0-9][0-9]:[0-9][0-9]\\.[0-9][0-9][0-9][0-9][0-9][0-9] [A-Za-z0-9_\\-]+\\.go:(61|63): XXX" : GoString)) : T_tester)) : Slice<T_tester>);
/**
...
**/
final lmicroseconds = ("64" : GoUInt64);
/**
    // These flags define which text to prefix to each log entry generated by the Logger.
    // Bits are or'ed together to control what's printed.
    // With the exception of the Lmsgprefix flag, there is no
    ...
    **/
    ...
    static public function output( _l:Ref<Logger>, _calldepth:GoInt, _s:GoString):Error {
        ...
        try {
            ...
            var __tmp__ = _l._out.write(_l._buf), _28:GoInt = __tmp__._0, _err:Error = __tmp__._1;
            {
                for (defer in __deferstack__) {
                    defer();
                };
