...
private function set_defaultOutput(v:(stdgo.GoUIntptr, Array<std.UInt>) -> stdgo.Error):(stdgo.GoUIntptr, Array<std.UInt>) -> stdgo.Error {
        stdgo._internal.log.internal.Internal_defaultoutput.defaultOutput = (_0, _1) -> (v((_0 : stdgo.GoUIntptr), ([for (i in _1) (i : stdgo.GoUInt8)] : stdgo.Slice<stdgo.GoUInt8>)) : stdgo.Error);
        return v;
    }
/**
