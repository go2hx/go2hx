...
@:structInit class Writer {
	...
	public function _writeAndRetry(_p:Priority, _s:GoString):{var _0:GoInt; var _1:Error;} {
		...
		try {
			...
			if (_w.value._conn != null) {
				{
					var __tmp__ = _w.value._write(_pr, _s),
						_n:GoInt = __tmp__._0,
	...
	public function debug(_m:GoString):Error {
		var _w = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _w.value._writeAndRetry(log_DEBUG, _m),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		return _err;
	}
	...
	public function info(_m:GoString):Error {
		var _w = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _w.value._writeAndRetry(log_INFO, _m),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		return _err;
	}
	...
	public function notice(_m:GoString):Error {
		var _w = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _w.value._writeAndRetry(log_NOTICE, _m),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		return _err;
	}
	...
	public function warning(_m:GoString):Error {
		var _w = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _w.value._writeAndRetry(log_WARNING, _m),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		return _err;
	}
	...
	public function err(_m:GoString):Error {
		var _w = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _w.value._writeAndRetry(log_ERR, _m),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		return _err;
	}
	...
	public function crit(_m:GoString):Error {
		var _w = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _w.value._writeAndRetry(log_CRIT, _m),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		return _err;
	}
	...
	public function alert(_m:GoString):Error {
		var _w = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _w.value._writeAndRetry(log_ALERT, _m),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		return _err;
	}
	...
	public function emerg(_m:GoString):Error {
		var _w = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _w.value._writeAndRetry(log_EMERG, _m),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		return _err;
	}
	...
	public function _connect():Error {
		...
		if (_w.value._network == (("" : GoString))) {
			...
			if (_err == null) {
				_w.value._conn = Go.pointer((({_conn: _c, _local: _w.value._network == (("unixgram" : GoString))
					|| _w.value._network == (("unix" : GoString))} : T_netConn)))
					.value;
				if (_w.value._hostname == (("" : GoString))) {
	...
	public function new(?_priority:Priority, ?_tag:GoString, ?_hostname:GoString, ?_network:GoString, ?_raddr:GoString, ?_mu:stdgo.sync.Sync.Mutex,
			?_conn:T_serverConn)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_priority) + " " + Go.string(_tag) + " " + Go.string(_hostname) + " " + Go.string(_network) + " " + Go.string(_raddr) + " "
			+ Go.string(_mu) + " " + Go.string(_conn) + "}";
	}
...
@:structInit class T_netConn {
	...
	public function _writeString(_p:Priority, _hostname:GoString, _tag:GoString, _msg:GoString, _nl:GoString):Error {
		...
		if (_n.value._local) {
			...
			var __tmp__ = stdgo.fmt.Fmt.fprintf(_n.value._conn, "<%d>%s %s[%d]: %s%s", Go.toInterface(_p), Go.toInterface(_timestamp), Go.toInterface(_tag),
				Go.toInterface(stdgo.os.Os.getpid()), Go.toInterface(_msg), Go.toInterface(_nl)),
				_:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			return _err;
		};
		var _timestamp:GoString = stdgo.time.Time.now().format(stdgo.time.Time.rfc3339);
		var __tmp__ = stdgo.fmt.Fmt.fprintf(_n.value._conn, "<%d>%s %s %s[%d]: %s%s", Go.toInterface(_p), Go.toInterface(_timestamp),
			Go.toInterface(_hostname), Go.toInterface(_tag), Go.toInterface(stdgo.os.Os.getpid()), Go.toInterface(_msg), Go.toInterface(_nl)),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		return _err;
	}
	...
	public function new(?_local:Bool, ?_conn:stdgo.net.Net.Conn)
		stdgo.internal.Macro.initLocals();
...
function dial(_network:GoString, _raddr:GoString, _priority:Priority, _tag:GoString):{var _0:Pointer<Writer>; var _1:Error;} {
	...
	try {
		var __tmp__ = stdgo.os.Os.hostname(),
			_hostname:GoString = __tmp__._0,
			_:stdgo.Error = __tmp__._1;
		var _w:Pointer<Writer> = Go.pointer((({
			_priority: _priority,
			_tag: _tag,
			_hostname: _hostname,
			_network: _network,
...
function _unixSyslog():{var _0:T_serverConn; var _1:Error;} {
	var _conn:T_serverConn = ((null : T_serverConn)),
	...
	for (_network in _logTypes) {
		for (_path in _logPaths) {
			var __tmp__ = stdgo.net.Net.dial(_network, _path),
...
class Writer_extension_fields {
	public function _connect(__tmp__):Error
		return __tmp__._connect();
	...
	public function emerg(__tmp__, _m:GoString):Error
		return __tmp__.emerg(_m);

	public function alert(__tmp__, _m:GoString):Error
		return __tmp__.alert(_m);

	public function crit(__tmp__, _m:GoString):Error
		return __tmp__.crit(_m);

	public function err(__tmp__, _m:GoString):Error
		return __tmp__.err(_m);

	public function warning(__tmp__, _m:GoString):Error
		return __tmp__.warning(_m);

	public function notice(__tmp__, _m:GoString):Error
		return __tmp__.notice(_m);

	public function info(__tmp__, _m:GoString):Error
		return __tmp__.info(_m);

	public function debug(__tmp__, _m:GoString):Error
		return __tmp__.debug(_m);

	public function _writeAndRetry(__tmp__, _p:Priority, _s:GoString):{var _0:GoInt; var _1:Error;}
		return __tmp__._writeAndRetry(_p, _s);

	public function _write(__tmp__, _p:Priority, _msg:GoString):{var _0:GoInt; var _1:Error;}
		return __tmp__._write(_p, _msg);
}

class T_netConn_extension_fields {
	public function _writeString(__tmp__, _p:Priority, _hostname:GoString, _tag:GoString, _msg:GoString, _nl:GoString):Error
		return __tmp__._writeString(_p, _hostname, _tag, _msg, _nl);
