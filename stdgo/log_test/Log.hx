...
**/
private var _benchmarks = (new Slice<stdgo.testing.Testing.InternalBenchmark>(3, 3, (new stdgo.testing.Testing.InternalBenchmark(("BenchmarkItoa" : GoString), stdgo.log.Log.benchmarkItoa) : stdgo.testing.Testing.InternalBenchmark), (new stdgo.testing.Testing.InternalBenchmark(("BenchmarkPrintln" : GoString), stdgo.log.Log.benchmarkPrintln) : stdgo.testing.Testing.InternalBenchmark), (new stdgo.testing.Testing.InternalBenchmark(("BenchmarkPrintlnNoFlags" : GoString), stdgo.log.Log.benchmarkPrintlnNoFlags) : stdgo.testing.Testing.InternalBenchmark)) : Slice<stdgo.testing.Testing.InternalBenchmark>);
/**
