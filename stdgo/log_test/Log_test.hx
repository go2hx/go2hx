...
function exampleLogger():Void {
	var _0:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer),
		_1:Ref<Logger> = stdgo.log.Log.new_(Go.asInterface((_buf : Ref<stdgo.bytes.Bytes.Buffer>)), Go.str("logger: "), (16 : GoInt)),
...
function exampleLogger_Output():Void {
	var _0:stdgo.bytes.Bytes.Buffer = ({} : stdgo.bytes.Bytes.Buffer),
		_1:Ref<Logger> = stdgo.log.Log.new_(Go.asInterface((_buf : Ref<stdgo.bytes.Bytes.Buffer>)), Go.str("INFO: "), (16 : GoInt)),
