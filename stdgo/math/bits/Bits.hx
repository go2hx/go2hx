...
var _ntz8tab : GoString = (((((((((Go.str() : GoString) + (Go.str(8,
0,
1,
0,
2,
...
1,
0) : GoString);
var _pop8tab : GoString = (((((((((Go.str() : GoString) + (Go.str(0,
1,
1,
2,
1,
...
7,
8) : GoString);
var _rev8tab : GoString = (((((((((Go.str() : GoString) + (Go.str(0,
128,
64,
192,
32,
...
127,
255) : GoString);
var _len8tab : GoString = (((((((((Go.str() : GoString) + (Go.str(0,
1,
2,
2,
3,
...
"\x07",
6,
"\x07\x07\x08") : GoString)[_x >> (8 : GoUnTypedInt)] + (Go.str(0,
1,
1,
2,
1,
...
"\x07",
6,
"\x07\x07\x08") : GoString)[_x & (255 : GoUInt16)] : GoInt);
    }
/**
...
"\x07",
6,
"\x07\x07\x08") : GoString)[_x >> (24 : GoUnTypedInt)] + (Go.str(0,
1,
1,
2,
1,
...
"\x07",
6,
"\x07\x07\x08") : GoString)[(_x >> (16 : GoUnTypedInt)) & (255 : GoUInt32)] + (Go.str(0,
1,
1,
2,
1,
...
"\x07",
6,
"\x07\x07\x08") : GoString)[(_x >> (8 : GoUnTypedInt)) & (255 : GoUInt32)]) + (Go.str(0,
1,
1,
2,
1,
...
"\x07",
6,
"\x07\x07\x08") : GoString)[_x & (255 : GoUInt32)] : GoInt);
    }
/**
...
191,
127,
255) : GoString)[_x >> (8 : GoUnTypedInt)] : GoUInt16) | (((Go.str(0,
128,
"@",
192,
" ",
...
191,
127,
255) : GoString)[_x & (255 : GoUInt16)] : GoUInt16) << (8 : GoUnTypedInt));
    }
/**
...
function div64(_hi:GoUInt64, _lo:GoUInt64, _y:GoUInt64):{ var _0 : GoUInt64; var _1 : GoUInt64; } {
        ...
        var _two32:GoUnTypedInt = (1 : GoUnTypedInt) << (32 : GoUnTypedInt), _mask32:GoUnTypedInt = _two32 - (1 : GoUnTypedInt);
        if (_y == (0 : GoUInt64)) {
