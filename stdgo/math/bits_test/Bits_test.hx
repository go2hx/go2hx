...
function testUintSize(_t:stdgo.testing.Testing.T):Void {
        var _x:GoUInt = ((0 : GoUInt));
        {
            ...
            if (((32 : GoUIntptr)) != _want) {
                _t.fatalf(((((("UintSize = %d; want %d" : GoString))) : GoString)), Go.toInterface(((32 : GoInt))), Go.toInterface(_want));
            };
        };
    }
                ...
                var _nlz:GoInt = (_tab != null ? _tab[_i] : new T_entry())._nlz;
                {
                    ...
                    Go.cfor(_k < ((56 : GoInt)), _k++, {
                        ...
                        if (_x <= ((255 : GoUInt64))) {
                            ...
                            if (_got != _want) {
                                _t.fatalf(((((("LeadingZeros8(%#02x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                        };
                        if (_x <= ((65535 : GoUInt64))) {
                            ...
                            if (_got != _want) {
                                _t.fatalf(((((("LeadingZeros16(%#04x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                        };
                        if (_x <= (("4294967295" : GoUInt64))) {
                            ...
                            if (_got != _want) {
                                _t.fatalf(((((("LeadingZeros32(%#08x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                            if (true) {
                                _got = leadingZeros(((_x : GoUInt)));
                                if (_got != _want) {
                                    _t.fatalf(((((("LeadingZeros(%#08x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                                };
                            };
                        };
                        if (_x <= (("18446744073709551615" : GoUInt64))) {
                            ...
                            if (_got != _want) {
                                _t.fatalf(((((("LeadingZeros64(%#016x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                            if (false) {
                                _got = leadingZeros(((_x : GoUInt)));
                                if (_got != _want) {
                                    _t.fatalf(((((("LeadingZeros(%#016x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                                };
                            };
                        };
                    });
                ...
                var _ntz:GoInt = (_tab != null ? _tab[_i] : new T_entry())._ntz;
                {
                    ...
                    Go.cfor(_k < ((56 : GoInt)), _k++, {
                        ...
                        if (_x <= ((255 : GoUInt64))) {
                            ...
                            if (_got != _want) {
                                _t.fatalf(((((("TrailingZeros8(%#02x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                        };
                        if (_x <= ((65535 : GoUInt64))) {
                            ...
                            if (_got != _want) {
                                _t.fatalf(((((("TrailingZeros16(%#04x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                        };
                        if (_x <= (("4294967295" : GoUInt64))) {
                            ...
                            if (_got != _want) {
                                _t.fatalf(((((("TrailingZeros32(%#08x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                            if (true) {
                                _got = trailingZeros(((_x : GoUInt)));
                                if (_got != _want) {
                                    _t.fatalf(((((("TrailingZeros(%#08x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                                };
                            };
                        };
                        if (_x <= (("18446744073709551615" : GoUInt64))) {
                            ...
                            if (_got != _want) {
                                _t.fatalf(((((("TrailingZeros64(%#016x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                            if (false) {
                                _got = trailingZeros(((_x : GoUInt)));
                                if (_got != _want) {
                                    _t.fatalf(((((("TrailingZeros(%#016x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                                };
                            };
                        };
                    });
...
function _testOnesCount(_t:stdgo.testing.Testing.T, _x:GoUInt64, _want:GoInt):Void {
        if (_x <= ((255 : GoUInt64))) {
            ...
            if (_got != _want) {
                _t.fatalf(((((("OnesCount8(%#02x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(((_x : GoUInt8))), Go.toInterface(_got), Go.toInterface(_want));
            };
        };
        if (_x <= ((65535 : GoUInt64))) {
            var _got:GoInt = onesCount16(((_x : GoUInt16)));
            if (_got != _want) {
                _t.fatalf(((((("OnesCount16(%#04x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(((_x : GoUInt16))), Go.toInterface(_got), Go.toInterface(_want));
            };
        };
        if (_x <= (("4294967295" : GoUInt64))) {
            var _got:GoInt = onesCount32(((_x : GoUInt32)));
            if (_got != _want) {
                _t.fatalf(((((("OnesCount32(%#08x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(((_x : GoUInt32))), Go.toInterface(_got), Go.toInterface(_want));
            };
            if (true) {
                _got = onesCount(((_x : GoUInt)));
                if (_got != _want) {
                    _t.fatalf(((((("OnesCount(%#08x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(((_x : GoUInt32))), Go.toInterface(_got), Go.toInterface(_want));
                };
            };
        };
        if (_x <= (("18446744073709551615" : GoUInt64))) {
            ...
            if (_got != _want) {
                _t.fatalf(((((("OnesCount64(%#016x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
            };
            if (false) {
                _got = onesCount(((_x : GoUInt)));
                if (_got != _want) {
                    _t.fatalf(((((("OnesCount(%#016x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                };
            };
        };
    }
...
function testRotateLeft(_t:stdgo.testing.Testing.T):Void {
        var _m:GoUInt64 = (("285870213051353865" : GoUInt64));
        {
            ...
            Go.cfor(_k < ((128 : GoUInt)), _k++, {
                ...
                if (_got8 != _want8) {
                    _t.fatalf(((((("RotateLeft8(%#02x, %d) == %#02x; want %#02x" : GoString))) : GoString)), Go.toInterface(_x8), Go.toInterface(_k), Go.toInterface(_got8), Go.toInterface(_want8));
                };
                _got8 = rotateLeft8(_want8, -((_k : GoInt)));
                if (_got8 != _x8) {
                    _t.fatalf(((((("RotateLeft8(%#02x, -%d) == %#02x; want %#02x" : GoString))) : GoString)), Go.toInterface(_want8), Go.toInterface(_k), Go.toInterface(_got8), Go.toInterface(_x8));
                };
                ...
                if (_got16 != _want16) {
                    _t.fatalf(((((("RotateLeft16(%#04x, %d) == %#04x; want %#04x" : GoString))) : GoString)), Go.toInterface(_x16), Go.toInterface(_k), Go.toInterface(_got16), Go.toInterface(_want16));
                };
                _got16 = rotateLeft16(_want16, -((_k : GoInt)));
                if (_got16 != _x16) {
                    _t.fatalf(((((("RotateLeft16(%#04x, -%d) == %#04x; want %#04x" : GoString))) : GoString)), Go.toInterface(_want16), Go.toInterface(_k), Go.toInterface(_got16), Go.toInterface(_x16));
                };
                ...
                if (_got32 != _want32) {
                    _t.fatalf(((((("RotateLeft32(%#08x, %d) == %#08x; want %#08x" : GoString))) : GoString)), Go.toInterface(_x32), Go.toInterface(_k), Go.toInterface(_got32), Go.toInterface(_want32));
                };
                _got32 = rotateLeft32(_want32, -((_k : GoInt)));
                if (_got32 != _x32) {
                    _t.fatalf(((((("RotateLeft32(%#08x, -%d) == %#08x; want %#08x" : GoString))) : GoString)), Go.toInterface(_want32), Go.toInterface(_k), Go.toInterface(_got32), Go.toInterface(_x32));
                };
                if (true) {
                    ...
                    if (_got != _want) {
                        _t.fatalf(((((("RotateLeft(%#08x, %d) == %#08x; want %#08x" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_k), Go.toInterface(_got), Go.toInterface(_want));
                    };
                    _got = rotateLeft(_want, -((_k : GoInt)));
                    if (_got != _x) {
                        _t.fatalf(((((("RotateLeft(%#08x, -%d) == %#08x; want %#08x" : GoString))) : GoString)), Go.toInterface(_want), Go.toInterface(_k), Go.toInterface(_got), Go.toInterface(_x));
                    };
                };
                ...
                if (_got64 != _want64) {
                    _t.fatalf(((((("RotateLeft64(%#016x, %d) == %#016x; want %#016x" : GoString))) : GoString)), Go.toInterface(_x64), Go.toInterface(_k), Go.toInterface(_got64), Go.toInterface(_want64));
                };
                _got64 = rotateLeft64(_want64, -((_k : GoInt)));
                if (_got64 != _x64) {
                    _t.fatalf(((((("RotateLeft64(%#016x, -%d) == %#016x; want %#016x" : GoString))) : GoString)), Go.toInterface(_want64), Go.toInterface(_k), Go.toInterface(_got64), Go.toInterface(_x64));
                };
                if (false) {
                    var _x:GoUInt = ((_m : GoUInt));
                    var _got:GoUInt = rotateLeft(_x, ((_k : GoInt)));
                    ...
                    if (_got != _want) {
                        _t.fatalf(((((("RotateLeft(%#016x, %d) == %#016x; want %#016x" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_k), Go.toInterface(_got), Go.toInterface(_want));
                    };
                    _got = rotateLeft(_want, -((_k : GoInt)));
                    if (_got != _x) {
                        _t.fatalf(((((("RotateLeft(%#08x, -%d) == %#08x; want %#08x" : GoString))) : GoString)), Go.toInterface(_want), Go.toInterface(_k), Go.toInterface(_got), Go.toInterface(_x));
...
function _testReverse(_t:stdgo.testing.Testing.T, _x64:GoUInt64, _want64:GoUInt64):Void {
        ...
        if (_got8 != _want8) {
            _t.fatalf(((((("Reverse8(%#02x) == %#02x; want %#02x" : GoString))) : GoString)), Go.toInterface(_x8), Go.toInterface(_got8), Go.toInterface(_want8));
        };
        var _x16:GoUInt16 = ((_x64 : GoUInt16));
        var _got16:GoUInt16 = reverse16(_x16);
        var _want16:GoUInt16 = (((_want64 >> ((48 : GoUnTypedInt))) : GoUInt16));
        if (_got16 != _want16) {
            _t.fatalf(((((("Reverse16(%#04x) == %#04x; want %#04x" : GoString))) : GoString)), Go.toInterface(_x16), Go.toInterface(_got16), Go.toInterface(_want16));
        };
        var _x32:GoUInt32 = ((_x64 : GoUInt32));
        var _got32:GoUInt32 = reverse32(_x32);
        var _want32:GoUInt32 = (((_want64 >> ((32 : GoUnTypedInt))) : GoUInt32));
        if (_got32 != _want32) {
            _t.fatalf(((((("Reverse32(%#08x) == %#08x; want %#08x" : GoString))) : GoString)), Go.toInterface(_x32), Go.toInterface(_got32), Go.toInterface(_want32));
        };
        if (true) {
            ...
            if (_got != _want) {
                _t.fatalf(((((("Reverse(%#08x) == %#08x; want %#08x" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
            };
        };
        var _got64:GoUInt64 = reverse64(_x64);
        if (_got64 != _want64) {
            _t.fatalf(((((("Reverse64(%#016x) == %#016x; want %#016x" : GoString))) : GoString)), Go.toInterface(_x64), Go.toInterface(_got64), Go.toInterface(_want64));
        };
        if (false) {
            ...
            if (_got != _want) {
                _t.fatalf(((((("Reverse(%#08x) == %#016x; want %#016x" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
            };
        };
    }
...
function _testReverseBytes(_t:stdgo.testing.Testing.T, _x64:GoUInt64, _want64:GoUInt64):Void {
        ...
        var _want16:GoUInt16 = (((_want64 >> ((48 : GoUnTypedInt))) : GoUInt16));
        if (_got16 != _want16) {
            _t.fatalf(((((("ReverseBytes16(%#04x) == %#04x; want %#04x" : GoString))) : GoString)), Go.toInterface(_x16), Go.toInterface(_got16), Go.toInterface(_want16));
        };
        var _x32:GoUInt32 = ((_x64 : GoUInt32));
        var _got32:GoUInt32 = reverseBytes32(_x32);
        var _want32:GoUInt32 = (((_want64 >> ((32 : GoUnTypedInt))) : GoUInt32));
        if (_got32 != _want32) {
            _t.fatalf(((((("ReverseBytes32(%#08x) == %#08x; want %#08x" : GoString))) : GoString)), Go.toInterface(_x32), Go.toInterface(_got32), Go.toInterface(_want32));
        };
        if (true) {
            var _x:GoUInt = ((_x32 : GoUInt));
            ...
            var _want:GoUInt = ((_want32 : GoUInt));
            if (_got != _want) {
                _t.fatalf(((((("ReverseBytes(%#08x) == %#08x; want %#08x" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
            };
        };
        var _got64:GoUInt64 = reverseBytes64(_x64);
        if (_got64 != _want64) {
            _t.fatalf(((((("ReverseBytes64(%#016x) == %#016x; want %#016x" : GoString))) : GoString)), Go.toInterface(_x64), Go.toInterface(_got64), Go.toInterface(_want64));
        };
        if (false) {
            var _x:GoUInt = ((_x64 : GoUInt));
            var _got:GoUInt = reverseBytes(_x);
            var _want:GoUInt = ((_want64 : GoUInt));
            if (_got != _want) {
                _t.fatalf(((((("ReverseBytes(%#016x) == %#016x; want %#016x" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
            };
        };
    }
                ...
                var _len:GoInt = ((8 : GoInt)) - (_tab != null ? _tab[_i] : new T_entry())._nlz;
                {
                    ...
                    Go.cfor(_k < ((56 : GoInt)), _k++, {
                        ...
                        if (_x <= ((255 : GoUInt64))) {
                            ...
                            if (_got != _want) {
                                _t.fatalf(((((("Len8(%#02x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                        };
                        if (_x <= ((65535 : GoUInt64))) {
                            var _got:GoInt = len16(((_x : GoUInt16)));
                            if (_got != _want) {
                                _t.fatalf(((((("Len16(%#04x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                        };
                        if (_x <= (("4294967295" : GoUInt64))) {
                            var _got:GoInt = len32(((_x : GoUInt32)));
                            if (_got != _want) {
                                _t.fatalf(((((("Len32(%#08x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                            if (true) {
                                var _got:GoInt = len(((_x : GoUInt)));
                                if (_got != _want) {
                                    _t.fatalf(((((("Len(%#08x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                                };
                            };
                        };
                        if (_x <= (("18446744073709551615" : GoUInt64))) {
                            ...
                            if (_got != _want) {
                                _t.fatalf(((((("Len64(%#016x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                            if (false) {
                                var _got:GoInt = len(((_x : GoUInt)));
                                if (_got != _want) {
                                    _t.fatalf(((((("Len(%#016x) == %d; want %d" : GoString))) : GoString)), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                                };
                            };
                        };
                    });
...
function testAddSubUint(_t:stdgo.testing.Testing.T):Void {
        var _test:(GoString, (GoUInt, GoUInt, GoUInt) -> { var _0 : GoUInt; var _1 : GoUInt; }, GoUInt, GoUInt, GoUInt, GoUInt, GoUInt) -> Void = function(_msg:GoString, _f:(_x:GoUInt, _y:GoUInt, _c:GoUInt) -> { var _0 : GoUInt; var _1 : GoUInt; }, _x:GoUInt, _y:GoUInt, _c:GoUInt, _z:GoUInt, _cout:GoUInt):Void {
            ...
            if ((_z1 != _z) || (_cout1 != _cout)) {
                _t.errorf(((((("%s: got z:cout = %#x:%#x; want %#x:%#x" : GoString))) : GoString)), Go.toInterface(_msg), Go.toInterface(_z1), Go.toInterface(_cout1), Go.toInterface(_z), Go.toInterface(_cout));
            };
        };
...
((new T__struct_1((("4294967295" : GoUInt)), (("4294967295" : GoUInt)), ((1 : GoUInt)), (("4294967295" : GoUInt)), ((1 : GoUInt))) : T__struct_1))) : Slice<T__struct_1>))) {
            ...
            _test(((((("Sub symmetric" : GoString))) : GoString)), sub, _a._z, _a._y, _a._c, _a._x, _a._cout);
            _test(((((("Add intrinsic" : GoString))) : GoString)), function(_x:GoUInt, _y:GoUInt, _c:GoUInt):{ var _0 : GoUInt; var _1 : GoUInt; } {
                return add(_x, _y, _c);
            }, _a._x, _a._y, _a._c, _a._z, _a._cout);
            _test(((((("Add intrinsic symmetric" : GoString))) : GoString)), function(_x:GoUInt, _y:GoUInt, _c:GoUInt):{ var _0 : GoUInt; var _1 : GoUInt; } {
                return add(_x, _y, _c);
            }, _a._y, _a._x, _a._c, _a._z, _a._cout);
            _test(((((("Sub intrinsic" : GoString))) : GoString)), function(_x:GoUInt, _y:GoUInt, _c:GoUInt):{ var _0 : GoUInt; var _1 : GoUInt; } {
                return sub(_x, _y, _c);
            }, _a._z, _a._x, _a._c, _a._y, _a._cout);
            _test(((((("Sub intrinsic symmetric" : GoString))) : GoString)), function(_x:GoUInt, _y:GoUInt, _c:GoUInt):{ var _0 : GoUInt; var _1 : GoUInt; } {
                return sub(_x, _y, _c);
...
((new T__struct_2((("4294967295" : GoUInt32)), (("4294967295" : GoUInt32)), ((1 : GoUInt32)), (("4294967295" : GoUInt32)), ((1 : GoUInt32))) : T__struct_2))) : Slice<T__struct_2>))) {
            ...
            _test(((((("Sub32 symmetric" : GoString))) : GoString)), sub32, _a._z, _a._y, _a._c, _a._x, _a._cout);
        };
    }
...
((new T__struct_3((("18446744073709551615" : GoUInt64)), (("18446744073709551615" : GoUInt64)), ((1 : GoUInt64)), (("18446744073709551615" : GoUInt64)), ((1 : GoUInt64))) : T__struct_3))) : Slice<T__struct_3>))) {
            ...
            _test(((((("Sub64 symmetric" : GoString))) : GoString)), sub64, _a._z, _a._y, _a._c, _a._x, _a._cout);
            _test(((((("Add64 intrinsic" : GoString))) : GoString)), function(_x:GoUInt64, _y:GoUInt64, _c:GoUInt64):{ var _0 : GoUInt64; var _1 : GoUInt64; } {
                return add64(_x, _y, _c);
            }, _a._x, _a._y, _a._c, _a._z, _a._cout);
            _test(((((("Add64 intrinsic symmetric" : GoString))) : GoString)), function(_x:GoUInt64, _y:GoUInt64, _c:GoUInt64):{ var _0 : GoUInt64; var _1 : GoUInt64; } {
                return add64(_x, _y, _c);
            }, _a._y, _a._x, _a._c, _a._z, _a._cout);
            _test(((((("Sub64 intrinsic" : GoString))) : GoString)), function(_x:GoUInt64, _y:GoUInt64, _c:GoUInt64):{ var _0 : GoUInt64; var _1 : GoUInt64; } {
                return sub64(_x, _y, _c);
            }, _a._z, _a._x, _a._c, _a._y, _a._cout);
            _test(((((("Sub64 intrinsic symmetric" : GoString))) : GoString)), function(_x:GoUInt64, _y:GoUInt64, _c:GoUInt64):{ var _0 : GoUInt64; var _1 : GoUInt64; } {
                return sub64(_x, _y, _c);
            }, _a._z, _a._y, _a._c, _a._x, _a._cout);
        };
    }
function testAdd64OverflowPanic(_t:stdgo.testing.Testing.T):Void {
        var _tests = ((new Slice<(GoUInt64, GoUInt64) -> GoUInt64>(function(_a:GoUInt64, _b:GoUInt64):GoUInt64 {
            var __tmp__ = add64(_a, _b, ((0 : GoUInt64))), _x:GoUInt64 = __tmp__._0, _c:GoUInt64 = __tmp__._1;
            if (_c > ((0 : GoUInt64))) {
                throw Go.toInterface(((((("overflow" : GoString))) : GoString)));
            };
            return _x;
                    ...
                    __deferstack__.unshift(() -> {
                        var a = function():Void {
                            var __recover_exception__:AnyInterface = null;
                            {
                                ...
                                if (_err == null) {
                                    _t.fatalf(((((("expected panic" : GoString))) : GoString)));
                                };
                            };
                        };
                        a();
...
function testMulDiv(_t:stdgo.testing.Testing.T):Void {
        var _testMul:(GoString, (GoUInt, GoUInt) -> { var _0 : GoUInt; var _1 : GoUInt; }, GoUInt, GoUInt, GoUInt, GoUInt) -> Void = function(_msg:GoString, _f:(_x:GoUInt, _y:GoUInt) -> { var _0 : GoUInt; var _1 : GoUInt; }, _x:GoUInt, _y:GoUInt, _hi:GoUInt, _lo:GoUInt):Void {
            ...
            if ((_hi1 != _hi) || (_lo1 != _lo)) {
                _t.errorf(((((("%s: got hi:lo = %#x:%#x; want %#x:%#x" : GoString))) : GoString)), Go.toInterface(_msg), Go.toInterface(_hi1), Go.toInterface(_lo1), Go.toInterface(_hi), Go.toInterface(_lo));
            };
        };
        ...
        for (_0 => _a in ((new Slice<T__struct_4>(((new T__struct_4((("2147483648" : GoUInt)), ((2 : GoUInt)), ((1 : GoUInt)), ((0 : GoUInt)), ((1 : GoUInt))) : T__struct_4)), ((new T__struct_4((("4294967295" : GoUInt)), (("4294967295" : GoUInt)), (("4294967294" : GoUInt)), ((1 : GoUInt)), ((42 : GoUInt))) : T__struct_4))) : Slice<T__struct_4>))) {
            ...
            _testDiv(((((("Div symmetric" : GoString))) : GoString)), div, _a._hi, _a._lo + _a._r, _a._x, _a._y, _a._r);
            _testMul(((((("Mul intrinsic" : GoString))) : GoString)), function(_x:GoUInt, _y:GoUInt):{ var _0 : GoUInt; var _1 : GoUInt; } {
                return mul(_x, _y);
            }, _a._x, _a._y, _a._hi, _a._lo);
            _testMul(((((("Mul intrinsic symmetric" : GoString))) : GoString)), function(_x:GoUInt, _y:GoUInt):{ var _0 : GoUInt; var _1 : GoUInt; } {
                return mul(_x, _y);
            }, _a._y, _a._x, _a._hi, _a._lo);
            _testDiv(((((("Div intrinsic" : GoString))) : GoString)), function(_hi:GoUInt, _lo:GoUInt, _y:GoUInt):{ var _0 : GoUInt; var _1 : GoUInt; } {
                return div(_hi, _lo, _y);
            }, _a._hi, _a._lo + _a._r, _a._y, _a._x, _a._r);
            _testDiv(((((("Div intrinsic symmetric" : GoString))) : GoString)), function(_hi:GoUInt, _lo:GoUInt, _y:GoUInt):{ var _0 : GoUInt; var _1 : GoUInt; } {
                return div(_hi, _lo, _y);
...
function testMulDiv32(_t:stdgo.testing.Testing.T):Void {
        ...
        for (_0 => _a in ((new Slice<T__struct_5>(((new T__struct_5((("2147483648" : GoUInt32)), ((2 : GoUInt32)), ((1 : GoUInt32)), ((0 : GoUInt32)), ((1 : GoUInt32))) : T__struct_5)), ((new T__struct_5((("3296590476" : GoUInt32)), ((50911 : GoUInt32)), ((39076 : GoUInt32)), (("2575665140" : GoUInt32)), ((13 : GoUInt32))) : T__struct_5)), ((new T__struct_5((("4294967295" : GoUInt32)), (("4294967295" : GoUInt32)), (("4294967294" : GoUInt32)), ((1 : GoUInt32)), ((42 : GoUInt32))) : T__struct_5))) : Slice<T__struct_5>))) {
            ...
            _testDiv(((((("Div32 symmetric" : GoString))) : GoString)), div32, _a._hi, _a._lo + _a._r, _a._x, _a._y, _a._r);
        };
    }
function testMulDiv64(_t:stdgo.testing.Testing.T):Void {
        ...
        for (_0 => _a in ((new Slice<T__struct_6>(((new T__struct_6((("9223372036854775808" : GoUInt64)), ((2 : GoUInt64)), ((1 : GoUInt64)), ((0 : GoUInt64)), ((1 : GoUInt64))) : T__struct_6)), ((new T__struct_6((("15241578750190521" : GoUInt64)), (("975461057789971041" : GoUInt64)), (("805972396572648" : GoUInt64)), (("11373457362572903193" : GoUInt64)), ((13 : GoUInt64))) : T__struct_6)), ((new T__struct_6((("18446744073709551615" : GoUInt64)), (("18446744073709551615" : GoUInt64)), (("18446744073709551614" : GoUInt64)), ((1 : GoUInt64)), ((42 : GoUInt64))) : T__struct_6))) : Slice<T__struct_6>))) {
            ...
            _testDiv(((((("Div64 symmetric" : GoString))) : GoString)), div64, _a._hi, _a._lo + _a._r, _a._x, _a._y, _a._r);
            _testMul(((((("Mul64 intrinsic" : GoString))) : GoString)), function(_x:GoUInt64, _y:GoUInt64):{ var _0 : GoUInt64; var _1 : GoUInt64; } {
                return mul64(_x, _y);
            }, _a._x, _a._y, _a._hi, _a._lo);
            _testMul(((((("Mul64 intrinsic symmetric" : GoString))) : GoString)), function(_x:GoUInt64, _y:GoUInt64):{ var _0 : GoUInt64; var _1 : GoUInt64; } {
                return mul64(_x, _y);
            }, _a._y, _a._x, _a._hi, _a._lo);
            _testDiv(((((("Div64 intrinsic" : GoString))) : GoString)), function(_hi:GoUInt64, _lo:GoUInt64, _y:GoUInt64):{ var _0 : GoUInt64; var _1 : GoUInt64; } {
                return div64(_hi, _lo, _y);
            }, _a._hi, _a._lo + _a._r, _a._y, _a._x, _a._r);
            _testDiv(((((("Div64 intrinsic symmetric" : GoString))) : GoString)), function(_hi:GoUInt64, _lo:GoUInt64, _y:GoUInt64):{ var _0 : GoUInt64; var _1 : GoUInt64; } {
                return div64(_hi, _lo, _y);
            }, _a._hi, _a._lo + _a._r, _a._x, _a._y, _a._r);
        };
    }
function testDivPanicOverflow(_t:stdgo.testing.Testing.T):Void {
        ...
        try {
            __deferstack__.unshift(() -> {
                var a = function():Void {
                    var __recover_exception__:AnyInterface = null;
                    {
                        ...
                        if (_err == null) {
                            _t.error(Go.toInterface(((((("Div should have panicked when y<=hi" : GoString))) : GoString))));
                        } else {
                            var __tmp__ = try {
                            ...
                            if (!_ok || (_e.error() != ((((("runtime error: integer overflow" : GoString))) : GoString)))) {
                                _t.errorf(((((("Div expected panic: %q, got: %q " : GoString))) : GoString)), Go.toInterface(((((("runtime error: integer overflow" : GoString))) : GoString))), Go.toInterface(_e.error()));
                            };
                        };
                    };
                };
            ...
            _t.errorf(((((("undefined q, r = %v, %v calculated when Div should have panicked" : GoString))) : GoString)), Go.toInterface(_q), Go.toInterface(_r));
            for (defer in __deferstack__) {
                defer();
            };
            {
...
function testDiv32PanicOverflow(_t:stdgo.testing.Testing.T):Void {
        ...
        try {
            __deferstack__.unshift(() -> {
                var a = function():Void {
                    var __recover_exception__:AnyInterface = null;
                    {
                        ...
                        if (_err == null) {
                            _t.error(Go.toInterface(((((("Div32 should have panicked when y<=hi" : GoString))) : GoString))));
                        } else {
                            var __tmp__ = try {
                                { value : ((_err.value : stdgo.runtime.Runtime.T_error)), ok : true };
                            } catch(_) {
                            ...
                            if (!_ok || (_e.error() != ((((("runtime error: integer overflow" : GoString))) : GoString)))) {
                                _t.errorf(((((("Div32 expected panic: %q, got: %q " : GoString))) : GoString)), Go.toInterface(((((("runtime error: integer overflow" : GoString))) : GoString))), Go.toInterface(_e.error()));
                            };
                        };
                    };
                };
            ...
            _t.errorf(((((("undefined q, r = %v, %v calculated when Div32 should have panicked" : GoString))) : GoString)), Go.toInterface(_q), Go.toInterface(_r));
            for (defer in __deferstack__) {
                defer();
            };
            {
...
function testDiv64PanicOverflow(_t:stdgo.testing.Testing.T):Void {
        ...
        try {
            __deferstack__.unshift(() -> {
                var a = function():Void {
                    var __recover_exception__:AnyInterface = null;
                    {
                        ...
                        if (_err == null) {
                            _t.error(Go.toInterface(((((("Div64 should have panicked when y<=hi" : GoString))) : GoString))));
                        } else {
                            var __tmp__ = try {
                                { value : ((_err.value : stdgo.runtime.Runtime.T_error)), ok : true };
                            } catch(_) {
                            ...
                            if (!_ok || (_e.error() != ((((("runtime error: integer overflow" : GoString))) : GoString)))) {
                                _t.errorf(((((("Div64 expected panic: %q, got: %q " : GoString))) : GoString)), Go.toInterface(((((("runtime error: integer overflow" : GoString))) : GoString))), Go.toInterface(_e.error()));
                            };
                        };
                    };
                };
            ...
            _t.errorf(((((("undefined q, r = %v, %v calculated when Div64 should have panicked" : GoString))) : GoString)), Go.toInterface(_q), Go.toInterface(_r));
            for (defer in __deferstack__) {
                defer();
            };
            {
            ...
            __deferstack__.unshift(() -> {
                var a = function():Void {
                    var __recover_exception__:AnyInterface = null;
                    {
                        ...
                        if (_err == null) {
                            _t.error(Go.toInterface(((((("Div should have panicked when y==0" : GoString))) : GoString))));
                        } else {
                            var __tmp__ = try {
                                { value : ((_err.value : stdgo.runtime.Runtime.T_error)), ok : true };
                            } catch(_) {
                            ...
                            if (!_ok || (_e.error() != ((((("runtime error: integer divide by zero" : GoString))) : GoString)))) {
                                _t.errorf(((((("Div expected panic: %q, got: %q " : GoString))) : GoString)), Go.toInterface(((((("runtime error: integer divide by zero" : GoString))) : GoString))), Go.toInterface(_e.error()));
                            };
                        };
                    };
                };
            ...
            __deferstack__.unshift(() -> {
                var a = function():Void {
                    var __recover_exception__:AnyInterface = null;
                    {
                        ...
                        if (_err == null) {
                            _t.error(Go.toInterface(((((("Div32 should have panicked when y==0" : GoString))) : GoString))));
                        } else {
                            var __tmp__ = try {
                                { value : ((_err.value : stdgo.runtime.Runtime.T_error)), ok : true };
                            } catch(_) {
                            ...
                            if (!_ok || (_e.error() != ((((("runtime error: integer divide by zero" : GoString))) : GoString)))) {
                                _t.errorf(((((("Div32 expected panic: %q, got: %q " : GoString))) : GoString)), Go.toInterface(((((("runtime error: integer divide by zero" : GoString))) : GoString))), Go.toInterface(_e.error()));
                            };
                        };
                    };
                };
            ...
            __deferstack__.unshift(() -> {
                var a = function():Void {
                    var __recover_exception__:AnyInterface = null;
                    {
                        ...
                        if (_err == null) {
                            _t.error(Go.toInterface(((((("Div64 should have panicked when y==0" : GoString))) : GoString))));
                        } else {
                            var __tmp__ = try {
                                { value : ((_err.value : stdgo.runtime.Runtime.T_error)), ok : true };
                            } catch(_) {
                            ...
                            if (!_ok || (_e.error() != ((((("runtime error: integer divide by zero" : GoString))) : GoString)))) {
                                _t.errorf(((((("Div64 expected panic: %q, got: %q " : GoString))) : GoString)), Go.toInterface(((((("runtime error: integer divide by zero" : GoString))) : GoString))), Go.toInterface(_e.error()));
                            };
                        };
                    };
                };
...
function testRem32(_t:stdgo.testing.Testing.T):Void {
        var _hi:GoUInt32 = ((((510510 : GoUInt32)) : GoUInt32)), _lo:GoUInt32 = ((((9699690 : GoUInt32)) : GoUInt32)), _y:GoUInt32 = ((((510511 : GoUInt32)) : GoUInt32));
        {
            ...
            Go.cfor(_i < ((1000 : GoInt)), _i++, {
                ...
                if (_r != _r2) {
                    _t.errorf(((((("Rem32(%v, %v, %v) returned %v, but Div32 returned rem %v" : GoString))) : GoString)), Go.toInterface(_hi), Go.toInterface(_lo), Go.toInterface(_y), Go.toInterface(_r), Go.toInterface(_r2));
                };
                _y = _y + (((13 : GoUInt32)));
            });
        };
...
function testRem32Overflow(_t:stdgo.testing.Testing.T):Void {
        var _hi:GoUInt32 = ((((510510 : GoUInt32)) : GoUInt32)), _lo:GoUInt32 = ((((9699690 : GoUInt32)) : GoUInt32)), _y:GoUInt32 = ((((7 : GoUInt32)) : GoUInt32));
        {
            ...
            Go.cfor(_i < ((1000 : GoInt)), _i++, {
                ...
                if (_r != ((_r2 : GoUInt32))) {
                    _t.errorf(((((("Rem32(%v, %v, %v) returned %v, but Div64 returned rem %v" : GoString))) : GoString)), Go.toInterface(_hi), Go.toInterface(_lo), Go.toInterface(_y), Go.toInterface(_r), Go.toInterface(_r2));
                };
                _y = _y + (((13 : GoUInt32)));
            });
        };
...
function testRem64(_t:stdgo.testing.Testing.T):Void {
        var _hi:GoUInt64 = ((((510510 : GoUInt64)) : GoUInt64)), _lo:GoUInt64 = ((((9699690 : GoUInt64)) : GoUInt64)), _y:GoUInt64 = ((((510511 : GoUInt64)) : GoUInt64));
        {
            ...
            Go.cfor(_i < ((1000 : GoInt)), _i++, {
                ...
                if (_r != _r2) {
                    _t.errorf(((((("Rem64(%v, %v, %v) returned %v, but Div64 returned rem %v" : GoString))) : GoString)), Go.toInterface(_hi), Go.toInterface(_lo), Go.toInterface(_y), Go.toInterface(_r), Go.toInterface(_r2));
                };
                _y = _y + (((13 : GoUInt64)));
            });
        };
...
function testRem64Overflow(_t:stdgo.testing.Testing.T):Void {
        ...
        for (_0 => _rt in rem64Tests) {
            ...
            if (_rem != _rt._rem) {
                _t.errorf(((((("Rem64(%v, %v, %v) returned %v, wanted %v" : GoString))) : GoString)), Go.toInterface(_rt._hi), Go.toInterface(_rt._lo), Go.toInterface(_rt._y), Go.toInterface(_rem), Go.toInterface(_rt._rem));
            };
        };
    }
...
function exampleAdd32():Void {
        var _n1 = ((new Slice<GoUInt32>(((33 : GoUInt32)), ((12 : GoUInt32))) : Slice<GoUInt32>));
        var _n2 = ((new Slice<GoUInt32>(((21 : GoUInt32)), ((23 : GoUInt32))) : Slice<GoUInt32>));
        ...
        var _nsum = ((new Slice<GoUInt32>(_d0, _d1) : Slice<GoUInt32>));
        stdgo.fmt.Fmt.printf(((((("%v + %v = %v (carry bit was %v)\n" : GoString))) : GoString)), Go.toInterface(_n1), Go.toInterface(_n2), Go.toInterface(_nsum), Go.toInterface(_carry));
...
function exampleAdd64():Void {
        var _n1 = ((new Slice<GoUInt64>(((33 : GoUInt64)), ((12 : GoUInt64))) : Slice<GoUInt64>));
        var _n2 = ((new Slice<GoUInt64>(((21 : GoUInt64)), ((23 : GoUInt64))) : Slice<GoUInt64>));
        ...
        var _nsum = ((new Slice<GoUInt64>(_d0, _d1) : Slice<GoUInt64>));
        stdgo.fmt.Fmt.printf(((((("%v + %v = %v (carry bit was %v)\n" : GoString))) : GoString)), Go.toInterface(_n1), Go.toInterface(_n2), Go.toInterface(_nsum), Go.toInterface(_carry));
...
function exampleSub32():Void {
        var _n1 = ((new Slice<GoUInt32>(((33 : GoUInt32)), ((23 : GoUInt32))) : Slice<GoUInt32>));
        var _n2 = ((new Slice<GoUInt32>(((21 : GoUInt32)), ((12 : GoUInt32))) : Slice<GoUInt32>));
...
function exampleSub64():Void {
        var _n1 = ((new Slice<GoUInt64>(((33 : GoUInt64)), ((23 : GoUInt64))) : Slice<GoUInt64>));
        var _n2 = ((new Slice<GoUInt64>(((21 : GoUInt64)), ((12 : GoUInt64))) : Slice<GoUInt64>));
...
function exampleMul32():Void {
        var _n1 = ((new Slice<GoUInt32>(((0 : GoUInt32)), ((12 : GoUInt32))) : Slice<GoUInt32>));
        var _n2 = ((new Slice<GoUInt32>(((0 : GoUInt32)), ((12 : GoUInt32))) : Slice<GoUInt32>));
        ...
        var _nsum = ((new Slice<GoUInt32>(_hi, _lo) : Slice<GoUInt32>));
        stdgo.fmt.Fmt.printf(((((("%v * %v = %v\n" : GoString))) : GoString)), Go.toInterface((_n1 != null ? _n1[((1 : GoInt))] : ((0 : GoUInt32)))), Go.toInterface((_n2 != null ? _n2[((1 : GoInt))] : ((0 : GoUInt32)))), Go.toInterface(_nsum));
...
function exampleMul64():Void {
        var _n1 = ((new Slice<GoUInt64>(((0 : GoUInt64)), ((12 : GoUInt64))) : Slice<GoUInt64>));
        var _n2 = ((new Slice<GoUInt64>(((0 : GoUInt64)), ((12 : GoUInt64))) : Slice<GoUInt64>));
        ...
        var _nsum = ((new Slice<GoUInt64>(_hi, _lo) : Slice<GoUInt64>));
        stdgo.fmt.Fmt.printf(((((("%v * %v = %v\n" : GoString))) : GoString)), Go.toInterface((_n1 != null ? _n1[((1 : GoInt))] : ((0 : GoUInt64)))), Go.toInterface((_n2 != null ? _n2[((1 : GoInt))] : ((0 : GoUInt64)))), Go.toInterface(_nsum));
...
function exampleDiv32():Void {
        var _n1 = ((new Slice<GoUInt32>(((0 : GoUInt32)), ((6 : GoUInt32))) : Slice<GoUInt32>));
        var _n2 = ((new Slice<GoUInt32>(((0 : GoUInt32)), ((3 : GoUInt32))) : Slice<GoUInt32>));
        ...
        var _nsum = ((new Slice<GoUInt32>(_quo, _rem) : Slice<GoUInt32>));
        stdgo.fmt.Fmt.printf(((((("[%v %v] / %v = %v\n" : GoString))) : GoString)), Go.toInterface((_n1 != null ? _n1[((0 : GoInt))] : ((0 : GoUInt32)))), Go.toInterface((_n1 != null ? _n1[((1 : GoInt))] : ((0 : GoUInt32)))), Go.toInterface((_n2 != null ? _n2[((1 : GoInt))] : ((0 : GoUInt32)))), Go.toInterface(_nsum));
...
function exampleDiv64():Void {
        var _n1 = ((new Slice<GoUInt64>(((0 : GoUInt64)), ((6 : GoUInt64))) : Slice<GoUInt64>));
        var _n2 = ((new Slice<GoUInt64>(((0 : GoUInt64)), ((3 : GoUInt64))) : Slice<GoUInt64>));
        ...
        var _nsum = ((new Slice<GoUInt64>(_quo, _rem) : Slice<GoUInt64>));
        stdgo.fmt.Fmt.printf(((((("[%v %v] / %v = %v\n" : GoString))) : GoString)), Go.toInterface((_n1 != null ? _n1[((0 : GoInt))] : ((0 : GoUInt64)))), Go.toInterface((_n1 != null ? _n1[((1 : GoInt))] : ((0 : GoUInt64)))), Go.toInterface((_n2 != null ? _n2[((1 : GoInt))] : ((0 : GoUInt64)))), Go.toInterface(_nsum));
...
function exampleLeadingZeros8():Void {
        stdgo.fmt.Fmt.printf(((((("LeadingZeros8(%08b) = %d\n" : GoString))) : GoString)), Go.toInterface(((1 : GoInt))), Go.toInterface(stdgo.math.bits.Bits.leadingZeros8(((1 : GoUInt8)))));
    }
function exampleLeadingZeros16():Void {
        stdgo.fmt.Fmt.printf(((((("LeadingZeros16(%016b) = %d\n" : GoString))) : GoString)), Go.toInterface(((1 : GoInt))), Go.toInterface(stdgo.math.bits.Bits.leadingZeros16(((1 : GoUInt16)))));
    }
function exampleLeadingZeros32():Void {
        stdgo.fmt.Fmt.printf(((((("LeadingZeros32(%032b) = %d\n" : GoString))) : GoString)), Go.toInterface(((1 : GoInt))), Go.toInterface(stdgo.math.bits.Bits.leadingZeros32(((1 : GoUInt32)))));
    }
function exampleLeadingZeros64():Void {
        stdgo.fmt.Fmt.printf(((((("LeadingZeros64(%064b) = %d\n" : GoString))) : GoString)), Go.toInterface(((1 : GoInt))), Go.toInterface(stdgo.math.bits.Bits.leadingZeros64(((1 : GoUInt64)))));
    }
function exampleTrailingZeros8():Void {
        stdgo.fmt.Fmt.printf(((((("TrailingZeros8(%08b) = %d\n" : GoString))) : GoString)), Go.toInterface(((14 : GoInt))), Go.toInterface(stdgo.math.bits.Bits.trailingZeros8(((14 : GoUInt8)))));
    }
function exampleTrailingZeros16():Void {
        stdgo.fmt.Fmt.printf(((((("TrailingZeros16(%016b) = %d\n" : GoString))) : GoString)), Go.toInterface(((14 : GoInt))), Go.toInterface(stdgo.math.bits.Bits.trailingZeros16(((14 : GoUInt16)))));
    }
function exampleTrailingZeros32():Void {
        stdgo.fmt.Fmt.printf(((((("TrailingZeros32(%032b) = %d\n" : GoString))) : GoString)), Go.toInterface(((14 : GoInt))), Go.toInterface(stdgo.math.bits.Bits.trailingZeros32(((14 : GoUInt32)))));
    }
function exampleTrailingZeros64():Void {
        stdgo.fmt.Fmt.printf(((((("TrailingZeros64(%064b) = %d\n" : GoString))) : GoString)), Go.toInterface(((14 : GoInt))), Go.toInterface(stdgo.math.bits.Bits.trailingZeros64(((14 : GoUInt64)))));
    }
function exampleOnesCount():Void {
        stdgo.fmt.Fmt.printf(((((("OnesCount(%b) = %d\n" : GoString))) : GoString)), Go.toInterface(((14 : GoInt))), Go.toInterface(stdgo.math.bits.Bits.onesCount(((14 : GoUInt)))));
    }
function exampleOnesCount8():Void {
        stdgo.fmt.Fmt.printf(((((("OnesCount8(%08b) = %d\n" : GoString))) : GoString)), Go.toInterface(((14 : GoInt))), Go.toInterface(stdgo.math.bits.Bits.onesCount8(((14 : GoUInt8)))));
    }
function exampleOnesCount16():Void {
        stdgo.fmt.Fmt.printf(((((("OnesCount16(%016b) = %d\n" : GoString))) : GoString)), Go.toInterface(((14 : GoInt))), Go.toInterface(stdgo.math.bits.Bits.onesCount16(((14 : GoUInt16)))));
    }
function exampleOnesCount32():Void {
        stdgo.fmt.Fmt.printf(((((("OnesCount32(%032b) = %d\n" : GoString))) : GoString)), Go.toInterface(((14 : GoInt))), Go.toInterface(stdgo.math.bits.Bits.onesCount32(((14 : GoUInt32)))));
    }
function exampleOnesCount64():Void {
        stdgo.fmt.Fmt.printf(((((("OnesCount64(%064b) = %d\n" : GoString))) : GoString)), Go.toInterface(((14 : GoInt))), Go.toInterface(stdgo.math.bits.Bits.onesCount64(((14 : GoUInt64)))));
    }
function exampleRotateLeft8():Void {
        stdgo.fmt.Fmt.printf(((((("%08b\n" : GoString))) : GoString)), Go.toInterface(((15 : GoInt))));
        stdgo.fmt.Fmt.printf(((((("%08b\n" : GoString))) : GoString)), Go.toInterface(stdgo.math.bits.Bits.rotateLeft8(((15 : GoUInt8)), ((2 : GoInt)))));
        stdgo.fmt.Fmt.printf(((((("%08b\n" : GoString))) : GoString)), Go.toInterface(stdgo.math.bits.Bits.rotateLeft8(((15 : GoUInt8)), ((-2 : GoInt)))));
    }
function exampleRotateLeft16():Void {
        stdgo.fmt.Fmt.printf(((((("%016b\n" : GoString))) : GoString)), Go.toInterface(((15 : GoInt))));
        stdgo.fmt.Fmt.printf(((((("%016b\n" : GoString))) : GoString)), Go.toInterface(stdgo.math.bits.Bits.rotateLeft16(((15 : GoUInt16)), ((2 : GoInt)))));
        stdgo.fmt.Fmt.printf(((((("%016b\n" : GoString))) : GoString)), Go.toInterface(stdgo.math.bits.Bits.rotateLeft16(((15 : GoUInt16)), ((-2 : GoInt)))));
    }
function exampleRotateLeft32():Void {
        stdgo.fmt.Fmt.printf(((((("%032b\n" : GoString))) : GoString)), Go.toInterface(((15 : GoInt))));
        stdgo.fmt.Fmt.printf(((((("%032b\n" : GoString))) : GoString)), Go.toInterface(stdgo.math.bits.Bits.rotateLeft32(((15 : GoUInt32)), ((2 : GoInt)))));
        stdgo.fmt.Fmt.printf(((((("%032b\n" : GoString))) : GoString)), Go.toInterface(stdgo.math.bits.Bits.rotateLeft32(((15 : GoUInt32)), ((-2 : GoInt)))));
    }
function exampleRotateLeft64():Void {
        stdgo.fmt.Fmt.printf(((((("%064b\n" : GoString))) : GoString)), Go.toInterface(((15 : GoInt))));
        stdgo.fmt.Fmt.printf(((((("%064b\n" : GoString))) : GoString)), Go.toInterface(stdgo.math.bits.Bits.rotateLeft64(((15 : GoUInt64)), ((2 : GoInt)))));
        stdgo.fmt.Fmt.printf(((((("%064b\n" : GoString))) : GoString)), Go.toInterface(stdgo.math.bits.Bits.rotateLeft64(((15 : GoUInt64)), ((-2 : GoInt)))));
    }
function exampleReverse8():Void {
        stdgo.fmt.Fmt.printf(((((("%08b\n" : GoString))) : GoString)), Go.toInterface(((19 : GoInt))));
        stdgo.fmt.Fmt.printf(((((("%08b\n" : GoString))) : GoString)), Go.toInterface(stdgo.math.bits.Bits.reverse8(((19 : GoUInt8)))));
    }
function exampleReverse16():Void {
        stdgo.fmt.Fmt.printf(((((("%016b\n" : GoString))) : GoString)), Go.toInterface(((19 : GoInt))));
        stdgo.fmt.Fmt.printf(((((("%016b\n" : GoString))) : GoString)), Go.toInterface(stdgo.math.bits.Bits.reverse16(((19 : GoUInt16)))));
    }
function exampleReverse32():Void {
        stdgo.fmt.Fmt.printf(((((("%032b\n" : GoString))) : GoString)), Go.toInterface(((19 : GoInt))));
        stdgo.fmt.Fmt.printf(((((("%032b\n" : GoString))) : GoString)), Go.toInterface(stdgo.math.bits.Bits.reverse32(((19 : GoUInt32)))));
    }
function exampleReverse64():Void {
        stdgo.fmt.Fmt.printf(((((("%064b\n" : GoString))) : GoString)), Go.toInterface(((19 : GoInt))));
        stdgo.fmt.Fmt.printf(((((("%064b\n" : GoString))) : GoString)), Go.toInterface(stdgo.math.bits.Bits.reverse64(((19 : GoUInt64)))));
    }
function exampleReverseBytes16():Void {
        stdgo.fmt.Fmt.printf(((((("%016b\n" : GoString))) : GoString)), Go.toInterface(((15 : GoInt))));
        stdgo.fmt.Fmt.printf(((((("%016b\n" : GoString))) : GoString)), Go.toInterface(stdgo.math.bits.Bits.reverseBytes16(((15 : GoUInt16)))));
    }
function exampleReverseBytes32():Void {
        stdgo.fmt.Fmt.printf(((((("%032b\n" : GoString))) : GoString)), Go.toInterface(((15 : GoInt))));
        stdgo.fmt.Fmt.printf(((((("%032b\n" : GoString))) : GoString)), Go.toInterface(stdgo.math.bits.Bits.reverseBytes32(((15 : GoUInt32)))));
    }
function exampleReverseBytes64():Void {
        stdgo.fmt.Fmt.printf(((((("%064b\n" : GoString))) : GoString)), Go.toInterface(((15 : GoInt))));
        stdgo.fmt.Fmt.printf(((((("%064b\n" : GoString))) : GoString)), Go.toInterface(stdgo.math.bits.Bits.reverseBytes64(((15 : GoUInt64)))));
    }
function exampleLen8():Void {
        stdgo.fmt.Fmt.printf(((((("Len8(%08b) = %d\n" : GoString))) : GoString)), Go.toInterface(((8 : GoInt))), Go.toInterface(stdgo.math.bits.Bits.len8(((8 : GoUInt8)))));
    }
function exampleLen16():Void {
        stdgo.fmt.Fmt.printf(((((("Len16(%016b) = %d\n" : GoString))) : GoString)), Go.toInterface(((8 : GoInt))), Go.toInterface(stdgo.math.bits.Bits.len16(((8 : GoUInt16)))));
    }
function exampleLen32():Void {
        stdgo.fmt.Fmt.printf(((((("Len32(%032b) = %d\n" : GoString))) : GoString)), Go.toInterface(((8 : GoInt))), Go.toInterface(stdgo.math.bits.Bits.len32(((8 : GoUInt32)))));
    }
function exampleLen64():Void {
        stdgo.fmt.Fmt.printf(((((("Len64(%064b) = %d\n" : GoString))) : GoString)), Go.toInterface(((8 : GoInt))), Go.toInterface(stdgo.math.bits.Bits.len64(((8 : GoUInt64)))));
    }
@:keep var _ = {
        try {
