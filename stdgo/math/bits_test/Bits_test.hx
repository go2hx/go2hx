                ...
                var _nlz:GoInt = _tab[_i]._nlz;
                {
                    ...
                    Go.cfor(_k < (56 : GoInt), _k++, {
                        ...
                        if (_x <= (255 : GoUInt64)) {
                            ...
                            if (_got != _want) {
                                _t.fatalf((Go.str("LeadingZeros8(%#02x) == %d; want %d") : GoString), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                        };
                        if (_x <= (65535 : GoUInt64)) {
                            ...
                            if (_got != _want) {
                                _t.fatalf((Go.str("LeadingZeros16(%#04x) == %d; want %d") : GoString), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                        };
                        if (_x <= ("4294967295" : GoUInt64)) {
                            ...
                            if (_got != _want) {
                                _t.fatalf((Go.str("LeadingZeros32(%#08x) == %d; want %d") : GoString), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                            if (true) {
                                _got = leadingZeros((_x : GoUInt));
                                if (_got != _want) {
                                    _t.fatalf((Go.str("LeadingZeros(%#08x) == %d; want %d") : GoString), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                                };
                            };
                        };
                        if (_x <= ("18446744073709551615" : GoUInt64)) {
                            ...
                            if (_got != _want) {
                                _t.fatalf((Go.str("LeadingZeros64(%#016x) == %d; want %d") : GoString), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                            if (false) {
                                _got = leadingZeros((_x : GoUInt));
                                if (_got != _want) {
                                    _t.fatalf((Go.str("LeadingZeros(%#016x) == %d; want %d") : GoString), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                                };
                            };
                        };
                    });
                ...
                var _ntz:GoInt = _tab[_i]._ntz;
                {
                    ...
                    Go.cfor(_k < (56 : GoInt), _k++, {
                        ...
                        if (_x <= (255 : GoUInt64)) {
                            ...
                            if (_got != _want) {
                                _t.fatalf((Go.str("TrailingZeros8(%#02x) == %d; want %d") : GoString), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                        };
                        if (_x <= (65535 : GoUInt64)) {
                            ...
                            if (_got != _want) {
                                _t.fatalf((Go.str("TrailingZeros16(%#04x) == %d; want %d") : GoString), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                        };
                        if (_x <= ("4294967295" : GoUInt64)) {
                            ...
                            if (_got != _want) {
                                _t.fatalf((Go.str("TrailingZeros32(%#08x) == %d; want %d") : GoString), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                            if (true) {
                                _got = trailingZeros((_x : GoUInt));
                                if (_got != _want) {
                                    _t.fatalf((Go.str("TrailingZeros(%#08x) == %d; want %d") : GoString), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                                };
                            };
                        };
                        if (_x <= ("18446744073709551615" : GoUInt64)) {
                            ...
                            if (_got != _want) {
                                _t.fatalf((Go.str("TrailingZeros64(%#016x) == %d; want %d") : GoString), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                            };
                            if (false) {
                                _got = trailingZeros((_x : GoUInt));
                                if (_got != _want) {
                                    _t.fatalf((Go.str("TrailingZeros(%#016x) == %d; want %d") : GoString), Go.toInterface(_x), Go.toInterface(_got), Go.toInterface(_want));
                                };
                            };
                        };
                    });
...
function _testOnesCount(_t:stdgo.testing.Testing.T, _x:GoUInt64, _want:GoInt):Void {
        ...
        if (_x <= ("4294967295" : GoUInt64)) {
            ...
            if (true) {
                ...
                if (_got != _want) {
                    _t.fatalf((Go.str("OnesCount(%#08x) == %d; want %d") : GoString), Go.toInterface((_x : GoUInt32)), Go.toInterface(_got), Go.toInterface(_want));
                };
            };
        };
        if (_x <= ("18446744073709551615" : GoUInt64)) {
...
function testRotateLeft(_t:stdgo.testing.Testing.T):Void {
        var _m:GoUInt64 = ("285870213051353865" : GoUInt64);
        {
            ...
            Go.cfor(_k < (128 : GoUInt), _k++, {
                ...
                if (_got8 != _want8) {
                    _t.fatalf((Go.str("RotateLeft8(%#02x, %d) == %#02x; want %#02x") : GoString), Go.toInterface(_x8), Go.toInterface(_k), Go.toInterface(_got8), Go.toInterface(_want8));
                };
                _got8 = rotateLeft8(_want8, -(_k : GoInt));
                if (_got8 != _x8) {
                    _t.fatalf((Go.str("RotateLeft8(%#02x, -%d) == %#02x; want %#02x") : GoString), Go.toInterface(_want8), Go.toInterface(_k), Go.toInterface(_got8), Go.toInterface(_x8));
                };
                ...
                if (_got16 != _want16) {
                    _t.fatalf((Go.str("RotateLeft16(%#04x, %d) == %#04x; want %#04x") : GoString), Go.toInterface(_x16), Go.toInterface(_k), Go.toInterface(_got16), Go.toInterface(_want16));
                };
                _got16 = rotateLeft16(_want16, -(_k : GoInt));
                if (_got16 != _x16) {
                    _t.fatalf((Go.str("RotateLeft16(%#04x, -%d) == %#04x; want %#04x") : GoString), Go.toInterface(_want16), Go.toInterface(_k), Go.toInterface(_got16), Go.toInterface(_x16));
                };
                ...
                if (_got32 != _want32) {
                    _t.fatalf((Go.str("RotateLeft32(%#08x, %d) == %#08x; want %#08x") : GoString), Go.toInterface(_x32), Go.toInterface(_k), Go.toInterface(_got32), Go.toInterface(_want32));
                };
                _got32 = rotateLeft32(_want32, -(_k : GoInt));
                if (_got32 != _x32) {
                    _t.fatalf((Go.str("RotateLeft32(%#08x, -%d) == %#08x; want %#08x") : GoString), Go.toInterface(_want32), Go.toInterface(_k), Go.toInterface(_got32), Go.toInterface(_x32));
                };
                if (true) {
                    ...
                    if (_got != _want) {
                        _t.fatalf((Go.str("RotateLeft(%#08x, %d) == %#08x; want %#08x") : GoString), Go.toInterface(_x), Go.toInterface(_k), Go.toInterface(_got), Go.toInterface(_want));
                    };
                    _got = rotateLeft(_want, -(_k : GoInt));
                    if (_got != _x) {
                        _t.fatalf((Go.str("RotateLeft(%#08x, -%d) == %#08x; want %#08x") : GoString), Go.toInterface(_want), Go.toInterface(_k), Go.toInterface(_got), Go.toInterface(_x));
                    };
                };
                ...
                if (_got64 != _want64) {
                    _t.fatalf((Go.str("RotateLeft64(%#016x, %d) == %#016x; want %#016x") : GoString), Go.toInterface(_x64), Go.toInterface(_k), Go.toInterface(_got64), Go.toInterface(_want64));
                };
                _got64 = rotateLeft64(_want64, -(_k : GoInt));
                if (_got64 != _x64) {
                    _t.fatalf((Go.str("RotateLeft64(%#016x, -%d) == %#016x; want %#016x") : GoString), Go.toInterface(_want64), Go.toInterface(_k), Go.toInterface(_got64), Go.toInterface(_x64));
                };
                if (false) {
                    var _x:GoUInt = (_m : GoUInt);
                    var _got:GoUInt = rotateLeft(_x, (_k : GoInt));
                    ...
                    if (_got != _want) {
                        _t.fatalf((Go.str("RotateLeft(%#016x, %d) == %#016x; want %#016x") : GoString), Go.toInterface(_x), Go.toInterface(_k), Go.toInterface(_got), Go.toInterface(_want));
                    };
                    _got = rotateLeft(_want, -(_k : GoInt));
                    if (_got != _x) {
                        _t.fatalf((Go.str("RotateLeft(%#08x, -%d) == %#08x; want %#08x") : GoString), Go.toInterface(_want), Go.toInterface(_k), Go.toInterface(_got), Go.toInterface(_x));
...
function testAddSubUint(_t:stdgo.testing.Testing.T):Void {
        var _test:(GoString, (GoUInt, GoUInt, GoUInt) -> { var _0 : GoUInt; var _1 : GoUInt; }, GoUInt, GoUInt, GoUInt, GoUInt, GoUInt) -> Void = function(_msg:GoString, _f:(_x:GoUInt, _y:GoUInt, _c:GoUInt) -> { var _0 : GoUInt; var _1 : GoUInt; }, _x:GoUInt, _y:GoUInt, _c:GoUInt, _z:GoUInt, _cout:GoUInt):Void {
            ...
            if ((_z1 != _z) || (_cout1 != _cout)) {
                _t.errorf((Go.str("%s: got z:cout = %#x:%#x; want %#x:%#x") : GoString), Go.toInterface(_msg), Go.toInterface(_z1), Go.toInterface(_cout1), Go.toInterface(_z), Go.toInterface(_cout));
            };
        };
...
function testMulDiv(_t:stdgo.testing.Testing.T):Void {
        var _testMul:(GoString, (GoUInt, GoUInt) -> { var _0 : GoUInt; var _1 : GoUInt; }, GoUInt, GoUInt, GoUInt, GoUInt) -> Void = function(_msg:GoString, _f:(_x:GoUInt, _y:GoUInt) -> { var _0 : GoUInt; var _1 : GoUInt; }, _x:GoUInt, _y:GoUInt, _hi:GoUInt, _lo:GoUInt):Void {
            ...
            if ((_hi1 != _hi) || (_lo1 != _lo)) {
                _t.errorf((Go.str("%s: got hi:lo = %#x:%#x; want %#x:%#x") : GoString), Go.toInterface(_msg), Go.toInterface(_hi1), Go.toInterface(_lo1), Go.toInterface(_hi), Go.toInterface(_lo));
            };
        };
        var _testDiv:(GoString, (GoUInt, GoUInt, GoUInt) -> { var _0 : GoUInt; var _1 : GoUInt; }, GoUInt, GoUInt, GoUInt, GoUInt, GoUInt) -> Void = function(_msg:GoString, _f:(_hi:GoUInt, _lo:GoUInt, _y:GoUInt) -> { var _0 : GoUInt; var _1 : GoUInt; }, _hi:GoUInt, _lo:GoUInt, _y:GoUInt, _q:GoUInt, _r:GoUInt):Void {
            ...
            if ((_q1 != _q) || (_r1 != _r)) {
                _t.errorf((Go.str("%s: got q:r = %#x:%#x; want %#x:%#x") : GoString), Go.toInterface(_msg), Go.toInterface(_q1), Go.toInterface(_r1), Go.toInterface(_q), Go.toInterface(_r));
            };
        };
        for (_0 => _a in (new Slice<T__struct_4>(0, 0, ({ _x : ("2147483648" : GoUInt), _y : (2 : GoUInt), _hi : (1 : GoUInt), _lo : (0 : GoUInt), _r : (1 : GoUInt) } : T__struct_4), ({ _x : ("4294967295" : GoUInt), _y : ("4294967295" : GoUInt), _hi : ("4294967294" : GoUInt), _lo : (1 : GoUInt), _r : (42 : GoUInt) } : T__struct_4)) : Slice<T__struct_4>)) {
                    ...
                    var __recover_exception__:AnyInterface = null;
                    {
                        ...
                        if (_err == null) {
                            ...
                            if (!_ok || (_e.error() != (Go.str("runtime error: integer overflow") : GoString))) {
                                _t.errorf((Go.str("Div expected panic: %q, got: %q ") : GoString), Go.toInterface((Go.str("runtime error: integer overflow") : GoString)), Go.toInterface(_e.error()));
                            };
                        };
                    };
                };
                ...
                var a = function():Void {
                    var __recover_exception__:AnyInterface = null;
                    {
                        ...
                        if (_err == null) {
                            ...
                            if (!_ok || (_e.error() != (Go.str("runtime error: integer overflow") : GoString))) {
                                _t.errorf((Go.str("Div32 expected panic: %q, got: %q ") : GoString), Go.toInterface((Go.str("runtime error: integer overflow") : GoString)), Go.toInterface(_e.error()));
                            };
                        };
                    };
                };
                ...
                var a = function():Void {
                    var __recover_exception__:AnyInterface = null;
                    {
                        ...
                        if (_err == null) {
                            ...
                            if (!_ok || (_e.error() != (Go.str("runtime error: integer overflow") : GoString))) {
                                _t.errorf((Go.str("Div64 expected panic: %q, got: %q ") : GoString), Go.toInterface((Go.str("runtime error: integer overflow") : GoString)), Go.toInterface(_e.error()));
                            };
                        };
                    };
                };
                    ...
                    var __recover_exception__:AnyInterface = null;
                    {
                        ...
                        if (_err == null) {
                            ...
                            if (!_ok || (_e.error() != (Go.str("runtime error: integer divide by zero") : GoString))) {
                                _t.errorf((Go.str("Div expected panic: %q, got: %q ") : GoString), Go.toInterface((Go.str("runtime error: integer divide by zero") : GoString)), Go.toInterface(_e.error()));
                            };
                        };
                    };
                };
                ...
                var a = function():Void {
                    var __recover_exception__:AnyInterface = null;
                    {
                        ...
                        if (_err == null) {
                            ...
                            if (!_ok || (_e.error() != (Go.str("runtime error: integer divide by zero") : GoString))) {
                                _t.errorf((Go.str("Div32 expected panic: %q, got: %q ") : GoString), Go.toInterface((Go.str("runtime error: integer divide by zero") : GoString)), Go.toInterface(_e.error()));
                            };
                        };
                    };
                };
                ...
                var a = function():Void {
                    var __recover_exception__:AnyInterface = null;
                    {
                        ...
                        if (_err == null) {
                            ...
                            if (!_ok || (_e.error() != (Go.str("runtime error: integer divide by zero") : GoString))) {
                                _t.errorf((Go.str("Div64 expected panic: %q, got: %q ") : GoString), Go.toInterface((Go.str("runtime error: integer divide by zero") : GoString)), Go.toInterface(_e.error()));
                            };
                        };
                    };
                };
...
function testRem32(_t:stdgo.testing.Testing.T):Void {
        var _hi:GoUInt32 = (510510 : GoUInt32), _lo:GoUInt32 = (9699690 : GoUInt32), _y:GoUInt32 = (510511 : GoUInt32);
        {
            var _i:GoInt = (0 : GoInt);
            Go.cfor(_i < (1000 : GoInt), _i++, {
                ...
                if (_r != _r2) {
                    _t.errorf((Go.str("Rem32(%v, %v, %v) returned %v, but Div32 returned rem %v") : GoString), Go.toInterface(_hi), Go.toInterface(_lo), Go.toInterface(_y), Go.toInterface(_r), Go.toInterface(_r2));
                };
                _y = _y + ((13 : GoUInt32));
            });
        };
...
function testRem32Overflow(_t:stdgo.testing.Testing.T):Void {
        var _hi:GoUInt32 = (510510 : GoUInt32), _lo:GoUInt32 = (9699690 : GoUInt32), _y:GoUInt32 = (7 : GoUInt32);
        {
            var _i:GoInt = (0 : GoInt);
            Go.cfor(_i < (1000 : GoInt), _i++, {
                var _r:GoUInt32 = rem32(_hi, _lo, _y);
                ...
                if (_r != (_r2 : GoUInt32)) {
                    _t.errorf((Go.str("Rem32(%v, %v, %v) returned %v, but Div64 returned rem %v") : GoString), Go.toInterface(_hi), Go.toInterface(_lo), Go.toInterface(_y), Go.toInterface(_r), Go.toInterface(_r2));
                };
                _y = _y + ((13 : GoUInt32));
            });
        };
...
function testRem64(_t:stdgo.testing.Testing.T):Void {
        var _hi:GoUInt64 = (510510 : GoUInt64), _lo:GoUInt64 = (9699690 : GoUInt64), _y:GoUInt64 = (510511 : GoUInt64);
        {
            var _i:GoInt = (0 : GoInt);
            Go.cfor(_i < (1000 : GoInt), _i++, {
                ...
                if (_r != _r2) {
                    _t.errorf((Go.str("Rem64(%v, %v, %v) returned %v, but Div64 returned rem %v") : GoString), Go.toInterface(_hi), Go.toInterface(_lo), Go.toInterface(_y), Go.toInterface(_r), Go.toInterface(_r2));
                };
                _y = _y + ((13 : GoUInt64));
            });
        };
...
function testRem64Overflow(_t:stdgo.testing.Testing.T):Void {
        var rem64Tests = (new Slice<T__struct_7>(0, 0, ({ _hi : (42 : GoUInt64), _lo : (1119 : GoUInt64), _y : (42 : GoUInt64), _rem : (27 : GoUInt64) } : T__struct_7), ({ _hi : (42 : GoUInt64), _lo : (1119 : GoUInt64), _y : (38 : GoUInt64), _rem : (9 : GoUInt64) } : T__struct_7), ({ _hi : (42 : GoUInt64), _lo : (1119 : GoUInt64), _y : (26 : GoUInt64), _rem : (23 : GoUInt64) } : T__struct_7), ({ _hi : (469 : GoUInt64), _lo : (0 : GoUInt64), _y : (467 : GoUInt64), _rem : (271 : GoUInt64) } : T__struct_7), ({ _hi : (469 : GoUInt64), _lo : (0 : GoUInt64), _y : (113 : GoUInt64), _rem : (58 : GoUInt64) } : T__struct_7), ({ _hi : (111111 : GoUInt64), _lo : (111111 : GoUInt64), _y : (1171 : GoUInt64), _rem : (803 : GoUInt64) } : T__struct_7), ({ _hi : ("3968194946088682615" : GoUInt64), _lo : ("3192705705065114702" : GoUInt64), _y : (1000037 : GoUInt64), _rem : (56067 : GoUInt64) } : T__struct_7)) : Slice<T__struct_7>);
        for (_0 => _rt in rem64Tests) {
            if (_rt._hi < _rt._y) {
                _t.fatalf((Go.str("Rem64(%v, %v, %v) is not a test with quo overflow") : GoString), Go.toInterface(_rt._hi), Go.toInterface(_rt._lo), Go.toInterface(_rt._y));
            };
            var _rem:GoUInt64 = rem64(_rt._hi, _rt._lo, _rt._y);
            if (_rem != _rt._rem) {
                _t.errorf((Go.str("Rem64(%v, %v, %v) returned %v, wanted %v") : GoString), Go.toInterface(_rt._hi), Go.toInterface(_rt._lo), Go.toInterface(_rt._y), Go.toInterface(_rem), Go.toInterface(_rt._rem));
            };
        };
    }
...
function exampleAdd32():Void {
        ...
        var __tmp__ = stdgo.math.bits.Bits.add32(_n1[(1 : GoInt)], _n2[(1 : GoInt)], (0 : GoUInt32)), _d1:GoUInt32 = __tmp__._0, _carry:GoUInt32 = __tmp__._1;
        var __tmp__ = stdgo.math.bits.Bits.add32(_n1[(0 : GoInt)], _n2[(0 : GoInt)], _carry), _d0:GoUInt32 = __tmp__._0, _0:GoUInt32 = __tmp__._1;
...
function exampleAdd64():Void {
        ...
        var __tmp__ = stdgo.math.bits.Bits.add64(_n1[(1 : GoInt)], _n2[(1 : GoInt)], (0 : GoUInt64)), _d1:GoUInt64 = __tmp__._0, _carry:GoUInt64 = __tmp__._1;
        var __tmp__ = stdgo.math.bits.Bits.add64(_n1[(0 : GoInt)], _n2[(0 : GoInt)], _carry), _d0:GoUInt64 = __tmp__._0, _0:GoUInt64 = __tmp__._1;
...
function exampleSub32():Void {
        ...
        var __tmp__ = stdgo.math.bits.Bits.sub32(_n1[(1 : GoInt)], _n2[(1 : GoInt)], (0 : GoUInt32)), _d1:GoUInt32 = __tmp__._0, _carry:GoUInt32 = __tmp__._1;
        var __tmp__ = stdgo.math.bits.Bits.sub32(_n1[(0 : GoInt)], _n2[(0 : GoInt)], _carry), _d0:GoUInt32 = __tmp__._0, _0:GoUInt32 = __tmp__._1;
        var _nsum = (new Slice<GoUInt32>(0, 0, _d0, _d1) : Slice<GoUInt32>);
        stdgo.fmt.Fmt.printf((Go.str("%v - %v = %v (carry bit was %v)\n") : GoString), Go.toInterface(_n1), Go.toInterface(_n2), Go.toInterface(_nsum), Go.toInterface(_carry));
...
function exampleSub64():Void {
        ...
        var __tmp__ = stdgo.math.bits.Bits.sub64(_n1[(1 : GoInt)], _n2[(1 : GoInt)], (0 : GoUInt64)), _d1:GoUInt64 = __tmp__._0, _carry:GoUInt64 = __tmp__._1;
        var __tmp__ = stdgo.math.bits.Bits.sub64(_n1[(0 : GoInt)], _n2[(0 : GoInt)], _carry), _d0:GoUInt64 = __tmp__._0, _0:GoUInt64 = __tmp__._1;
        var _nsum = (new Slice<GoUInt64>(0, 0, _d0, _d1) : Slice<GoUInt64>);
        stdgo.fmt.Fmt.printf((Go.str("%v - %v = %v (carry bit was %v)\n") : GoString), Go.toInterface(_n1), Go.toInterface(_n2), Go.toInterface(_nsum), Go.toInterface(_carry));
