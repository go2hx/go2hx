...
function asin(_x:GoComplex128):GoComplex128 {
	{
		...
		if (_im == ((0 : GoFloat64)) && stdgo.math.Math.abs(_re) <= ((1 : GoFloat64))) {
			...
			if (stdgo.math.Math.isNaN(_re)) {
				...
				return new GoComplex128(stdgo.math.Math.copysign(stdgo.math.Math.pi / ((4 : GoUnTypedFloat)), _re), _im);
			} else {
				return new GoComplex128(stdgo.math.Math.copysign(((0 : GoFloat64)), _re), _im);
			};
		} else if (stdgo.math.Math.isInf(_re, ((0 : GoInt)))) {
			return new GoComplex128(stdgo.math.Math.copysign(stdgo.math.Math.pi / ((2 : GoUnTypedFloat)), _re), stdgo.math.Math.copysign(_re, _im));
		};
	};
...
function asinh(_x:GoComplex128):GoComplex128 {
	{
		...
		if (_im == ((0 : GoFloat64)) && stdgo.math.Math.abs(_re) <= ((1 : GoFloat64))) {
			...
			if (stdgo.math.Math.isInf(_im, ((0 : GoInt)))) {
				return new GoComplex128(_re, stdgo.math.Math.copysign(stdgo.math.Math.pi / ((4 : GoUnTypedFloat)), _im));
			} else if (stdgo.math.Math.isNaN(_im)) {
				return _x;
			} else {
			...
			return new GoComplex128(stdgo.math.Math.copysign(_im, _re), stdgo.math.Math.copysign(stdgo.math.Math.pi / ((2 : GoUnTypedFloat)), _im));
		};
	};
	var _xx:GoComplex128 = _x * _x;
	var _x1:GoComplex128 = new GoComplex128(((1 : GoFloat64)) + _xx.real, _xx.imag);
...
function acos(_x:GoComplex128):GoComplex128 {
	...
	return new GoComplex128(stdgo.math.Math.pi / ((2 : GoUnTypedFloat)) - _w.real, -_w.imag);
}
...
function acosh(_x:GoComplex128):GoComplex128 {
	if (_x == ((0 : GoComplex128))) {
		return new GoComplex128(((0 : GoFloat64)), stdgo.math.Math.copysign(stdgo.math.Math.pi / ((2 : GoUnTypedFloat)), _x.imag));
	};
...
function atan(_x:GoComplex128):GoComplex128 {
	{
		...
		if (_im == ((0 : GoFloat64))) {
			...
			return new GoComplex128(stdgo.math.Math.copysign(stdgo.math.Math.pi / ((2 : GoUnTypedFloat)), _re),
				stdgo.math.Math.copysign(((0 : GoFloat64)), _im));
...
function log10(_x:GoComplex128):GoComplex128 {
	...
	return new GoComplex128(stdgo.math.Math.log10E * _z.real, stdgo.math.Math.log10E * _z.imag);
}
...
function sqrt(_x:GoComplex128):GoComplex128 {
	...
	if (_x.real == ((0 : GoFloat64))) {
		if (_x.imag < ((0 : GoFloat64))) {
			var _r:GoFloat64 = stdgo.math.Math.sqrt(-((0.5 : GoUnTypedFloat)) * _x.imag);
...
function _reducePi(_x:GoFloat64):GoFloat64 {
	final _reduceThreshold:GoFloat64 = (((1 : GoUnTypedInt)) << ((30 : GoUnTypedInt)));
	if (stdgo.math.Math.abs(_x) < _reduceThreshold) {
		final pi1:GoUnTypedFloat = ((3.141592502593994 : GoUnTypedFloat)), pi2:GoUnTypedFloat = ((1.5099578831723193e-07 : GoUnTypedFloat)),
		pi3:GoUnTypedFloat = ((1.0780605716316238e-14 : GoUnTypedFloat));
		var _t:GoFloat64 = _x / stdgo.math.Math.pi;
		_t = _t + (((0.5 : GoFloat64)));
		_t = ((((_t : GoInt64)) : GoFloat64));
		return ((_x - _t * pi1) - _t * pi2) - _t * pi3;
	};
	final _mask:GoUnTypedInt = ((2047 : GoUnTypedInt)), _shift:GoUnTypedInt = ((64 : GoUnTypedInt)) - ((11 : GoUnTypedInt)) - ((1 : GoUnTypedInt)),
	_bias:GoUnTypedInt = ((1023 : GoUnTypedInt)), _fracMask:GoUnTypedInt = (((1 : GoUnTypedInt)) << _shift)
		- ((1 : GoUnTypedInt));
	...
	var _mPi:GoArray<GoUInt64> = new GoArray<GoUInt64>(((0 : GoUInt64)), (("5871781006564002452" : GoUInt64)), (("18308165927316385504" : GoUInt64)),
		(("7904181063698728992" : GoUInt64)), (("18386141011142107824" : GoUInt64)), (("15821769039155751280" : GoUInt64)),
		(("226472410124699918" : GoUInt64)), (("9155525084211106719" : GoUInt64)), (("8377006445469475394" : GoUInt64)), (("8416726409370648352" : GoUInt64)),
		(("11297538173999619322" : GoUInt64)), (("5639122210317440029" : GoUInt64)), (("10375251204153461767" : GoUInt64)),
		(("17840878831444244111" : GoUInt64)), (("13158180450388509915" : GoUInt64)), (("12079533480525952278" : GoUInt64)),
		(("13444332734028904637" : GoUInt64)), (("11422145685100251509" : GoUInt64)), (("3890458997777936004" : GoUInt64)),
...
function _tanSeries(_z:GoComplex128):GoFloat64 {
	final machep:GoUnTypedFloat = ((1 : GoUnTypedFloat)) / ((((1 : GoUnTypedInt)) << ((53 : GoUnTypedInt))));
	...
	while (true) {
		...
		_t = _t / (_f);
		_d = _d + (_t);
		if (!(stdgo.math.Math.abs(_t / _d) > machep)) {
			break;
		};
	};
	return _d;
