...
function atan(_x:GoComplex128):GoComplex128 {
    {
        ...
        if (_im == ((0 : GoFloat64))) {
            ...
            return new GoComplex128(stdgo.math.Math.copysign(stdgo.math.Math.pi / ((2 : GoUnTypedFloat)), _re), stdgo.math.Math.copysign(((0 : GoFloat64)), _im));
...
function _reducePi(_x:GoFloat64):GoFloat64 {
    ...
    if (stdgo.math.Math.abs(_x) < _reduceThreshold) {
        final pi1:GoUnTypedFloat = ((3.141592502593994 : GoUnTypedFloat)), pi2:GoUnTypedFloat = ((1.5099578831723193e-07 : GoUnTypedFloat)), pi3:GoUnTypedFloat = ((1.0780605716316238e-14 : GoUnTypedFloat));
        var _t:GoFloat64 = _x / stdgo.math.Math.pi;
        _t = _t + (((0.5 : GoFloat64)));
        _t = ((((_t : GoInt64)) : GoFloat64));
        return ((_x - _t * pi1) - _t * pi2) - _t * pi3;
    };
    final _mask:GoUnTypedInt = ((2047 : GoUnTypedInt)), _shift:GoUnTypedInt = ((64 : GoUnTypedInt)) - ((11 : GoUnTypedInt)) - ((1 : GoUnTypedInt)), _bias:GoUnTypedInt = ((1023 : GoUnTypedInt)), _fracMask:GoUnTypedInt = (((1 : GoUnTypedInt)) << _shift) - ((1 : GoUnTypedInt));
