...
private var _tests:Slice<stdgo.testing.Testing.InternalTest> = (new Slice<stdgo.testing.Testing.InternalTest>(0, 0,
	...
	(new stdgo.testing.Testing.InternalTest(("TestInfiniteLoopIntanSeries" : GoString),
		stdgo.math.cmplx.Cmplx.testInfiniteLoopIntanSeries) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestTanHuge" : GoString),
...
private var _benchmarks:Slice<stdgo.testing.Testing.InternalBenchmark> = (new Slice<stdgo.testing.Testing.InternalBenchmark>(0, 0,
	...
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkAcos" : GoString),
		stdgo.math.cmplx.Cmplx.benchmarkAcos) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkAcosh" : GoString),
		stdgo.math.cmplx.Cmplx.benchmarkAcosh) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkAsin" : GoString),
		stdgo.math.cmplx.Cmplx.benchmarkAsin) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkAsinh" : GoString),
		stdgo.math.cmplx.Cmplx.benchmarkAsinh) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkAtan" : GoString),
		stdgo.math.cmplx.Cmplx.benchmarkAtan) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkAtanh" : GoString),
		stdgo.math.cmplx.Cmplx.benchmarkAtanh) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkConj" : GoString),
		stdgo.math.cmplx.Cmplx.benchmarkConj) : stdgo.testing.Testing.InternalBenchmark),
	...
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkCosh" : GoString),
		stdgo.math.cmplx.Cmplx.benchmarkCosh) : stdgo.testing.Testing.InternalBenchmark),
	...
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkLog10" : GoString),
		stdgo.math.cmplx.Cmplx.benchmarkLog10) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkPhase" : GoString),
		stdgo.math.cmplx.Cmplx.benchmarkPhase) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkPolar" : GoString),
		stdgo.math.cmplx.Cmplx.benchmarkPolar) : stdgo.testing.Testing.InternalBenchmark),
	...
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkRect" : GoString),
		stdgo.math.cmplx.Cmplx.benchmarkRect) : stdgo.testing.Testing.InternalBenchmark),
	...
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkSinh" : GoString),
		stdgo.math.cmplx.Cmplx.benchmarkSinh) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkSqrt" : GoString),
		stdgo.math.cmplx.Cmplx.benchmarkSqrt) : stdgo.testing.Testing.InternalBenchmark),
...
private var _examples:Slice<stdgo.testing.Testing.InternalExample> = (new Slice<stdgo.testing.Testing.InternalExample>(0, 0,
	(new stdgo.testing.Testing.InternalExample(("ExampleAbs" : GoString), stdgo.math.cmplx_test.Cmplx_test.exampleAbs, ("5.0\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleExp" : GoString), stdgo.math.cmplx_test.Cmplx_test.exampleExp, ("(0.0+0.0i)\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExamplePolar" : GoString), stdgo.math.cmplx_test.Cmplx_test.examplePolar, ("r: 2.0, θ: 0.5*π\n" : GoString),
