...
@:structInit @:using(stdgo.math.rand.Rand.Rand_static_extension) class Rand {
    ...
    **/
    ...
    public function new(?_src:stdgo.math.rand.Rand.Source, ?_s64:stdgo.math.rand.Rand.Source64, ?_readVal:stdgo.GoInt64, ?_readPos:stdgo.GoInt8) {
...
@:structInit @:private @:using(stdgo.math.rand.Rand.T_lockedSource_static_extension) class T_lockedSource {
    ...
    public var _s : stdgo.Ref<stdgo.math.rand.Rand.T_rngSource> = (null : stdgo.Ref<stdgo.math.rand.Rand.T_rngSource>);
    public function new(?_lk:stdgo.sync.Sync.Mutex, ?_s:stdgo.Ref<stdgo.math.rand.Rand.T_rngSource>) {
...
@:structInit @:using(stdgo.math.rand.Rand.Zipf_static_extension) class Zipf {
    ...
    public function new(?_r:stdgo.Ref<stdgo.math.rand.Rand.Rand>, ?_imax:stdgo.GoFloat64, ?_v:stdgo.GoFloat64, ?_q:stdgo.GoFloat64, ?_s:stdgo.GoFloat64, ?_oneminusQ:stdgo.GoFloat64, ?_oneminusQinv:stdgo.GoFloat64, ?_hxm:stdgo.GoFloat64, ?_hx0minusHxm:stdgo.GoFloat64) {
...
function _newSource(_seed:stdgo.GoInt64):stdgo.Ref<T_rngSource> {
        ...
        _rng.seed(_seed);
        return (stdgo.Go.setRef(_rng) : stdgo.Ref<stdgo.math.rand.Rand.T_rngSource>);
    }
/**
...
function new_(_src:Source):stdgo.Ref<Rand> {
        ...
        return (stdgo.Go.setRef(({ _src : _src, _s64 : _s64 } : stdgo.math.rand.Rand.Rand)) : stdgo.Ref<stdgo.math.rand.Rand.Rand>);
    }
function _read(_p:stdgo.Slice<stdgo.GoByte>, _src:Source, _readVal:stdgo.Pointer<stdgo.GoInt64>, _readPos:stdgo.Pointer<stdgo.GoInt8>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        ...
        var __tmp__ = try {
            ...
            { _0 : (null : stdgo.Ref<stdgo.math.rand.Rand.T_rngSource>), _1 : false };
...
function _globalRand():stdgo.Ref<Rand> {
        ...
        var _r:stdgo.Ref<Rand> = (null : stdgo.Ref<stdgo.math.rand.Rand.Rand>);
        if (_randautoseed.value() == (("0" : stdgo.GoString))) {
            _randautoseed.incNonDefault();
            _r = new_(stdgo.Go.asInterface((stdgo.Go.setRef(({} : stdgo.math.rand.Rand.T_lockedSource)) : stdgo.Ref<stdgo.math.rand.Rand.T_lockedSource>)));
            _r.seed((1i64 : stdgo.GoInt64));
        } else {
            _r = (stdgo.Go.setRef(({ _src : stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.math.rand.Rand.T_fastSource() : stdgo.math.rand.Rand.T_fastSource)) : stdgo.Ref<stdgo.math.rand.Rand.T_fastSource>)), _s64 : stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.math.rand.Rand.T_fastSource() : stdgo.math.rand.Rand.T_fastSource)) : stdgo.Ref<stdgo.math.rand.Rand.T_fastSource>)) } : stdgo.math.rand.Rand.Rand)) : stdgo.Ref<stdgo.math.rand.Rand.Rand>);
        };
...
function seed(_seed:stdgo.GoInt64):Void {
        ...
        if (_orig != null && ((_orig : Dynamic).__nil__ == null || !(_orig : Dynamic).__nil__)) {
            {
                var __tmp__ = try {
                    ...
                    { _0 : (null : stdgo.Ref<stdgo.math.rand.Rand.T_lockedSource>), _1 : false };
        ...
        var _r = new_(stdgo.Go.asInterface((stdgo.Go.setRef(({} : stdgo.math.rand.Rand.T_lockedSource)) : stdgo.Ref<stdgo.math.rand.Rand.T_lockedSource>)));
        _r.seed(_seed);
...
function newZipf(_r:stdgo.Ref<Rand>, _s:stdgo.GoFloat64, _v:stdgo.GoFloat64, _imax:stdgo.GoUInt64):stdgo.Ref<Zipf> {
        var _z = (stdgo.Go.setRef(({} : stdgo.math.rand.Rand.Zipf)) : stdgo.Ref<stdgo.math.rand.Rand.Zipf>);
        ...
        _z._hx0minusHxm = (_z._h((0.5 : stdgo.GoFloat64)) - stdgo.math.Math.exp(stdgo.math.Math.log(_z._v) * (-_z._q))) - _z._hxm;
        _z._s = (1 : stdgo.GoFloat64) - _z._hinv(_z._h((1.5 : stdgo.GoFloat64)) - stdgo.math.Math.exp(-_z._q * stdgo.math.Math.log(_z._v + (1 : stdgo.GoFloat64))));
        return _z;
    }
    ...
    static public function read( _r:stdgo.Ref<Rand>, _p:stdgo.Slice<stdgo.GoByte>):{ var _0 : stdgo.GoInt; var _1 : stdgo.Error; } {
        ...
        var _n:stdgo.GoInt = (0 : stdgo.GoInt), _err:stdgo.Error = (null : stdgo.Error);
        {
            ...
            if (stdgo.Go.typeEquals((__type__ : stdgo.Ref<T_lockedSource>))) {
                var _src:stdgo.Ref<stdgo.math.rand.Rand.T_lockedSource> = __type__ == null ? (null : stdgo.Ref<stdgo.math.rand.Rand.T_lockedSource>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.math.rand.Rand.T_lockedSource>) : __type__ == null ? (null : stdgo.Ref<stdgo.math.rand.Rand.T_lockedSource>) : __type__.__underlying__().value;
                ...
                var _src:stdgo.Ref<stdgo.math.rand.Rand.T_fastSource> = __type__ == null ? (null : stdgo.Ref<stdgo.math.rand.Rand.T_fastSource>) : __type__.__underlying__() == null ? (null : stdgo.Ref<stdgo.math.rand.Rand.T_fastSource>) : __type__ == null ? (null : stdgo.Ref<stdgo.math.rand.Rand.T_fastSource>) : __type__.__underlying__().value;
                return _src._read(_p, stdgo.Go.pointer(_r._readVal), stdgo.Go.pointer(_r._readPos));
            };
        };
    ...
    **/
    ...
    static public function normFloat64( _r:stdgo.Ref<Rand>):stdgo.GoFloat64 {
        ...
        while (true) {
            ...
            if (_i == ((0 : stdgo.GoInt32))) {
                while (true) {
                    _x = -stdgo.math.Math.log(_r.float64()) * (0.29047645161474317 : stdgo.GoFloat64);
                    var _y:stdgo.GoFloat64 = -stdgo.math.Math.log(_r.float64());
                    if ((_y + _y) >= (_x * _x)) {
                        break;
                    };
                };
            ...
            if ((_fn[(_i : stdgo.GoInt)] + ((_r.float64() : stdgo.GoFloat32) * (_fn[(_i - (1 : stdgo.GoInt32) : stdgo.GoInt)] - _fn[(_i : stdgo.GoInt)]))) < (stdgo.math.Math.exp(((-0.5 : stdgo.GoFloat64) * _x) * _x) : stdgo.GoFloat32)) {
                return _x;
            };
        };
    }
    ...
    static public function expFloat64( _r:stdgo.Ref<Rand>):stdgo.GoFloat64 {
        ...
        while (true) {
            ...
            if (_i == ((0u32 : stdgo.GoUInt32))) {
                return (7.69711747013105 : stdgo.GoFloat64) - stdgo.math.Math.log(_r.float64());
            };
            if ((_fe[(_i : stdgo.GoInt)] + ((_r.float64() : stdgo.GoFloat32) * (_fe[(_i - (1u32 : stdgo.GoUInt32) : stdgo.GoInt)] - _fe[(_i : stdgo.GoInt)]))) < (stdgo.math.Math.exp(-_x) : stdgo.GoFloat32)) {
                return _x;
            };
        };
    }
    ...
    **/
    ...
    static public function uint64( _z:stdgo.Ref<Zipf>):stdgo.GoUInt64 {
        ...
        while (true) {
            ...
            _k = stdgo.math.Math.floor(_x + (0.5 : stdgo.GoFloat64));
            if ((_k - _x) <= _z._s) {
                break;
            };
            if (_ur >= (_z._h(_k + (0.5 : stdgo.GoFloat64)) - stdgo.math.Math.exp(-stdgo.math.Math.log(_k + _z._v) * _z._q))) {
                break;
            };
        };
