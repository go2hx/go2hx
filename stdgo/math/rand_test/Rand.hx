...
private var _tests:Slice<stdgo.testing.Testing.InternalTest> = (new Slice<stdgo.testing.Testing.InternalTest>(0, 0,
	...
	(new stdgo.testing.Testing.InternalTest(("TestReadUniformity" : GoString),
...
private var _examples:Slice<stdgo.testing.Testing.InternalExample> = (new Slice<stdgo.testing.Testing.InternalExample>(0, 0,
	(new stdgo.testing.Testing.InternalExample(("Example" : GoString), stdgo.math.rand_test.Rand_test.example,
		("Magic 8-Ball says: As I see it yes\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("Example_rand" : GoString), stdgo.math.rand_test.Rand_test.example_rand,
	...
	(new stdgo.testing.Testing.InternalExample(("ExamplePerm" : GoString), stdgo.math.rand_test.Rand_test.examplePerm, ("1\n2\n0\n" : GoString),
		true) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleShuffle" : GoString), stdgo.math.rand_test.Rand_test.exampleShuffle,
		("[mouth my the of runs corners from ink]\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleShuffle_slicesInUnison" : GoString), stdgo.math.rand_test.Rand_test.exampleShuffle_slicesInUnison,
		("C: 3\nD: 4\nA: 1\nE: 5\nB: 2\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleIntn" : GoString), stdgo.math.rand_test.Rand_test.exampleIntn, ("42\n76\n30\n" : GoString),
