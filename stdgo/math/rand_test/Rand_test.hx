...
private var _printgolden:Pointer<Bool> = stdgo.flag.Flag.bool_(("printgolden" : GoString), false, ("print golden results for regression test" : GoString));
...
function example():Void {
	...
	var _answers = (new Slice<GoString>(0, 0, ("It is certain" : GoString), ("It is decidedly so" : GoString), ("Without a doubt" : GoString),
		("Yes definitely" : GoString), ("You may rely on it" : GoString), ("As I see it yes" : GoString), ("Most likely" : GoString),
		("Outlook good" : GoString), ("Yes" : GoString), ("Signs point to yes" : GoString), ("Reply hazy try again" : GoString),
		("Ask again later" : GoString), ("Better not tell you now" : GoString), ("Cannot predict now" : GoString), ("Concentrate and ask again" : GoString),
		("Don\'t count on it" : GoString), ("My reply is no" : GoString), ("My sources say no" : GoString), ("Outlook not so good" : GoString),
...
function example_rand():Void {
	...
	try {
		...
		_show(("Int31n(10)" : GoString), Go.toInterface(_r.int31n((10 : GoInt32))), Go.toInterface(_r.int31n((10 : GoInt32))),
			Go.toInterface(_r.int31n((10 : GoInt32))));
		_show(("Int63n(10)" : GoString), Go.toInterface(_r.int63n(("10" : GoInt64))), Go.toInterface(_r.int63n(("10" : GoInt64))),
...
private function _checkSampleSliceDistributions(_t:Ref<stdgo.testing.Testing.T>, _samples:Slice<GoFloat64>, _nslices:GoInt,
		_expected:Ref<T_statsResults>):Void {
	_t.helper();
...
private function _testNormalDistribution(_t:Ref<stdgo.testing.Testing.T>, _nsamples:GoInt, _mean:GoFloat64, _stddev:GoFloat64, _seed:GoInt64):Void {
	...
	var _expected = ((new T_statsResults(_mean, _stddev, (0.1 : GoFloat64) * _errorScale,
		(0.08 : GoFloat64) * _errorScale) : T_statsResults) : Ref<stdgo.math.rand_test.Rand_test.T_statsResults>);
...
private function _testExponentialDistribution(_t:Ref<stdgo.testing.Testing.T>, _nsamples:GoInt, _rate:GoFloat64, _seed:GoInt64):Void {
	...
	var _expected = ((new T_statsResults(_mean, _stddev, (0.1 : GoFloat64) * _errorScale,
		(0.2 : GoFloat64) * _errorScale) : T_statsResults) : Ref<stdgo.math.rand_test.Rand_test.T_statsResults>);
	_checkSampleDistribution(_t, _samples, _expected);
	_checkSampleSliceDistributions(_t, _samples, (2 : GoInt), _expected);
	_checkSampleSliceDistributions(_t, _samples, (7 : GoInt), _expected);
}
...
function testNormTables(_t:Ref<stdgo.testing.Testing.T>):Void {
		...
		_testFn:Slice<GoFloat32> = __tmp__._2;
	{
		...
		if (_i >= (0 : GoInt)) {
			_t.errorf(("kn disagrees at index %v; %v != %v" : GoString), Go.toInterface(_i), Go.toInterface(_kn[(_i : GoInt)]),
				Go.toInterface(_testKn[(_i : GoInt)]));
		};
	};
	{
		var _i:GoInt = _compareFloat32Slices((_wn.__slice__((0 : GoInt)) : Slice<GoFloat32>), _testWn);
		if (_i >= (0 : GoInt)) {
			_t.errorf(("wn disagrees at index %v; %v != %v" : GoString), Go.toInterface(_i), Go.toInterface(_wn[(_i : GoInt)]),
				Go.toInterface(_testWn[(_i : GoInt)]));
		};
	};
	{
		var _i:GoInt = _compareFloat32Slices((_fn.__slice__((0 : GoInt)) : Slice<GoFloat32>), _testFn);
		if (_i >= (0 : GoInt)) {
			_t.errorf(("fn disagrees at index %v; %v != %v" : GoString), Go.toInterface(_i), Go.toInterface(_fn[(_i : GoInt)]),
				Go.toInterface(_testFn[(_i : GoInt)]));
		};
	};
}
...
function testExpTables(_t:Ref<stdgo.testing.Testing.T>):Void {
		...
		_testFe:Slice<GoFloat32> = __tmp__._2;
	{
		...
		if (_i >= (0 : GoInt)) {
			_t.errorf(("ke disagrees at index %v; %v != %v" : GoString), Go.toInterface(_i), Go.toInterface(_ke[(_i : GoInt)]),
				Go.toInterface(_testKe[(_i : GoInt)]));
		};
	};
	{
		var _i:GoInt = _compareFloat32Slices((_we.__slice__((0 : GoInt)) : Slice<GoFloat32>), _testWe);
		if (_i >= (0 : GoInt)) {
			_t.errorf(("we disagrees at index %v; %v != %v" : GoString), Go.toInterface(_i), Go.toInterface(_we[(_i : GoInt)]),
				Go.toInterface(_testWe[(_i : GoInt)]));
		};
	};
	{
		var _i:GoInt = _compareFloat32Slices((_fe.__slice__((0 : GoInt)) : Slice<GoFloat32>), _testFe);
		if (_i >= (0 : GoInt)) {
			_t.errorf(("fe disagrees at index %v; %v != %v" : GoString), Go.toInterface(_i), Go.toInterface(_fe[(_i : GoInt)]),
				Go.toInterface(_testFe[(_i : GoInt)]));
		};
	};
}
...
private function _hasSlowFloatingPoint():Bool {
	...
	} else if (("wasm" : GoString) == (("mips" : GoString))
		|| ("wasm" : GoString) == (("mipsle" : GoString))
			|| ("wasm" : GoString) == (("mips64" : GoString)) || ("wasm" : GoString) == (("mips64le" : GoString))) {
		return true;
	};
	return false;
}
...
function testFloat32(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _r = new_(newSource(("1" : GoInt64)));
	{
		...
		Go.cfor(_ct < _num, _ct++, {
			...
			if (_f >= (1 : GoFloat64)) {
				_t.fatal(Go.toInterface(("Float32() should be in range [0,1). ct:" : GoString)), Go.toInterface(_ct), Go.toInterface(("f:" : GoString)),
					Go.toInterface(_f));
			};
		});
	};
				...
				for (_0 => _test in _tests) {
					_t.run(_test._name, function(_t:Ref<stdgo.testing.Testing.T>):Void {
						...
						var _expected = (({_mean: _dof,
							_stddev: stdgo.math.Math.sqrt((2 : GoFloat64) * _dof)} : T_statsResults) : Ref<stdgo.math.rand_test.Rand_test.T_statsResults>);
...
function testRegress(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	var _rv:stdgo.reflect.Reflect.Value = (stdgo.reflect.Reflect.valueOf(Go.toInterface(Go.asInterface(_r))) == null ? null : stdgo.reflect.Reflect.valueOf(Go.toInterface(Go.asInterface(_r)))
		.__copy__());
			...
			_r.seed(("0" : GoInt64));
			{
				...
				Go.cfor(_repeat < (20:GoInt), _repeat++, {
					...
					if (_printgolden.value) {
						...
						if ((((_big : GoInt) : GoInt64) != _big)
							&& ((_m.name == ("Int" : GoString)) || (_m.name == ("Intn" : GoString)))) {
	...
	**/
	...
	static public function _checkSimilarDistribution(_this:Ref<T_statsResults>, _expected:Ref<T_statsResults>):Error {
		if (!_nearEqual(_this._mean, _expected._mean, _expected._closeEnough, _expected._maxError)) {
			var _s:GoString = stdgo.fmt.Fmt.sprintf(("mean %v != %v (allowed error %v, %v)" : GoString), Go.toInterface(_this._mean),
		...
		if (!_nearEqual(_this._stddev, _expected._stddev, _expected._closeEnough, _expected._maxError)) {
			var _s:GoString = stdgo.fmt.Fmt.sprintf(("stddev %v != %v (allowed error %v, %v)" : GoString), Go.toInterface(_this._stddev),
