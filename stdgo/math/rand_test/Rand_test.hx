...
**/
private var _testSeeds = (new Slice<GoInt64>(0, 0, ("1" : GoInt64), ("1754801282" : GoInt64), ("1698661970" : GoInt64), ("1550503961" : GoInt64)) : Slice<GoInt64>);
/**
...
**/
private final _numTestSamples = ("10000" : GoUInt64);
...
private function _testNormalDistribution(_t:Ref<stdgo.testing.Testing.T>, _nsamples:GoInt, _mean:GoFloat64, _stddev:GoFloat64, _seed:GoInt64):Void {
        ...
        var _expected = ((new T_statsResults(_mean, _stddev, (0.1 : GoFloat64) * _errorScale, (0.08 : GoFloat64) * _errorScale) : T_statsResults) : Ref<stdgo.math.rand_test.Rand_test.T_statsResults>);
...
private function _testExponentialDistribution(_t:Ref<stdgo.testing.Testing.T>, _nsamples:GoInt, _rate:GoFloat64, _seed:GoInt64):Void {
        ...
        var _expected = ((new T_statsResults(_mean, _stddev, (0.1 : GoFloat64) * _errorScale, (0.2 : GoFloat64) * _errorScale) : T_statsResults) : Ref<stdgo.math.rand_test.Rand_test.T_statsResults>);
        _checkSampleDistribution(_t, _samples, _expected);
        _checkSampleSliceDistributions(_t, _samples, (2 : GoInt), _expected);
        _checkSampleSliceDistributions(_t, _samples, (7 : GoInt), _expected);
    }
...
private function _initNorm():{ var _0 : Slice<GoUInt32>; var _1 : Slice<GoFloat32>; var _2 : Slice<GoFloat32>; } {
        ...
        {};
        var _0:GoFloat64 = _rn, _1:GoFloat64 = _dn, _2:GoFloat64 = (0.00991256303526217 : GoFloat64), _vn:GoFloat64 = _2, _tn:GoFloat64 = _1, _dn:GoFloat64 = _0;
...
private function _initExp():{ var _0 : Slice<GoUInt32>; var _1 : Slice<GoFloat32>; var _2 : Slice<GoFloat32>; } {
        ...
        {};
        var _0:GoFloat64 = _re, _1:GoFloat64 = _de, _2:GoFloat64 = (0.003949659822581557 : GoFloat64), _ve:GoFloat64 = _2, _te:GoFloat64 = _1, _de:GoFloat64 = _0;
...
private function _testReadUniformity(_t:Ref<stdgo.testing.Testing.T>, _n:GoInt, _seed:GoInt64):Void {
        ...
        var _0:GoFloat64 = (127.5 : GoFloat64), _1:GoFloat64 = (256 : GoFloat64) / stdgo.math.Math.sqrt((12 : GoFloat64)), _2:GoFloat64 = _stddev / stdgo.math.Math.sqrt((_n : GoFloat64)), _errorScale:GoFloat64 = _2, _stddev:GoFloat64 = _1, _mean:GoFloat64 = _0;
        var _expected = ((new T_statsResults(_mean, _stddev, (0.1 : GoFloat64) * _errorScale, (0.08 : GoFloat64) * _errorScale) : T_statsResults) : Ref<stdgo.math.rand_test.Rand_test.T_statsResults>);
...
function testReadByOneByte(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var __tmp__ = stdgo.io.Io.readFull(stdgo.testing.iotest.Iotest.oneByteReader(Go.asInterface(_r)), _b1), _0:GoInt = __tmp__._0, _err:Error = __tmp__._1;
        if (_err != null) {
                ...
                _t.run(stdgo.fmt.Fmt.sprintf(("n=%d" : GoString), Go.toInterface(_n)), function(_t:Ref<stdgo.testing.Testing.T>):Void {
                    ...
                    for (_0 => _test in _tests) {
                        _t.run(_test._name, function(_t:Ref<stdgo.testing.Testing.T>):Void {
                            ...
                            var _expected = (({ _mean : _dof, _stddev : stdgo.math.Math.sqrt((2 : GoFloat64) * _dof) } : T_statsResults) : Ref<stdgo.math.rand_test.Rand_test.T_statsResults>);
...
("9223372036854775807" : GoInt64)) : Slice<GoInt64>);
        ...
        var _rv:stdgo.reflect.Reflect.Value = (stdgo.reflect.Reflect.valueOf(Go.toInterface(Go.asInterface(_r))) == null ? null : stdgo.reflect.Reflect.valueOf(Go.toInterface(Go.asInterface(_r))).__copy__());
...
class T_statsResults_asInterface {
    ...
    **/
    @:keep
    public function _checkSimilarDistribution(_expected:Ref<T_statsResults>):Error return __self__.value._checkSimilarDistribution(_expected);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
