...
(new stdgo.testing.Testing.InternalTest((Go.str("TestNextafter32") : GoString), stdgo.math_test.Math_test.testNextafter32) : stdgo.testing.Testing.InternalTest),
(new stdgo.testing.Testing.InternalTest((Go.str("TestNextafter64") : GoString), stdgo.math_test.Math_test.testNextafter64) : stdgo.testing.Testing.InternalTest),
...
(new stdgo.testing.Testing.InternalTest((Go.str("TestRemainder") : GoString), stdgo.math_test.Math_test.testRemainder) : stdgo.testing.Testing.InternalTest),
...
(new stdgo.testing.Testing.InternalTest((Go.str("TestRoundToEven") : GoString), stdgo.math_test.Math_test.testRoundToEven) : stdgo.testing.Testing.InternalTest),
...
(new stdgo.testing.Testing.InternalTest((Go.str("TestLargeSincos") : GoString), stdgo.math_test.Math_test.testLargeSincos) : stdgo.testing.Testing.InternalTest),
...
(new stdgo.testing.Testing.InternalTest((Go.str("TestTrigReduce") : GoString), stdgo.math_test.Math_test.testTrigReduce) : stdgo.testing.Testing.InternalTest),
(new stdgo.testing.Testing.InternalTest((Go.str("TestFloatMinMax") : GoString), stdgo.math_test.Math_test.testFloatMinMax) : stdgo.testing.Testing.InternalTest),
(new stdgo.testing.Testing.InternalTest((Go.str("TestFloatMinima") : GoString), stdgo.math_test.Math_test.testFloatMinima) : stdgo.testing.Testing.InternalTest),
(new stdgo.testing.Testing.InternalTest((Go.str("TestFloat32Sqrt") : GoString), stdgo.math_test.Math_test.testFloat32Sqrt) : stdgo.testing.Testing.InternalTest),
...
(new stdgo.testing.Testing.InternalTest((Go.str("TestHugeSinCos") : GoString), stdgo.math_test.Math_test.testHugeSinCos) : stdgo.testing.Testing.InternalTest),
(new stdgo.testing.Testing.InternalTest((Go.str("TestHugeTan") : GoString), stdgo.math_test.Math_test.testHugeTan) : stdgo.testing.Testing.InternalTest)) : Slice<stdgo.testing.Testing.InternalTest>);
var _benchmarks : Slice<stdgo.testing.Testing.InternalBenchmark> = (new Slice<stdgo.testing.Testing.InternalBenchmark>(
0,
0,
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkAcos") : GoString), stdgo.math_test.Math_test.benchmarkAcos) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkAcosh") : GoString), stdgo.math_test.Math_test.benchmarkAcosh) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkAsin") : GoString), stdgo.math_test.Math_test.benchmarkAsin) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkAsinh") : GoString), stdgo.math_test.Math_test.benchmarkAsinh) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkAtan") : GoString), stdgo.math_test.Math_test.benchmarkAtan) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkAtanh") : GoString), stdgo.math_test.Math_test.benchmarkAtanh) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkAtan2") : GoString), stdgo.math_test.Math_test.benchmarkAtan2) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkCbrt") : GoString), stdgo.math_test.Math_test.benchmarkCbrt) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkCeil") : GoString), stdgo.math_test.Math_test.benchmarkCeil) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkCopysign") : GoString), stdgo.math_test.Math_test.benchmarkCopysign) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkCos") : GoString), stdgo.math_test.Math_test.benchmarkCos) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkCosh") : GoString), stdgo.math_test.Math_test.benchmarkCosh) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkErf") : GoString), stdgo.math_test.Math_test.benchmarkErf) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkErfc") : GoString), stdgo.math_test.Math_test.benchmarkErfc) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkErfinv") : GoString), stdgo.math_test.Math_test.benchmarkErfinv) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkErfcinv") : GoString), stdgo.math_test.Math_test.benchmarkErfcinv) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkExp") : GoString), stdgo.math_test.Math_test.benchmarkExp) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkExpGo") : GoString), stdgo.math_test.Math_test.benchmarkExpGo) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkExpm1") : GoString), stdgo.math_test.Math_test.benchmarkExpm1) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkExp2") : GoString), stdgo.math_test.Math_test.benchmarkExp2) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkExp2Go") : GoString), stdgo.math_test.Math_test.benchmarkExp2Go) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkAbs") : GoString), stdgo.math_test.Math_test.benchmarkAbs) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkDim") : GoString), stdgo.math_test.Math_test.benchmarkDim) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkFloor") : GoString), stdgo.math_test.Math_test.benchmarkFloor) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkMax") : GoString), stdgo.math_test.Math_test.benchmarkMax) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkMin") : GoString), stdgo.math_test.Math_test.benchmarkMin) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkMod") : GoString), stdgo.math_test.Math_test.benchmarkMod) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkFrexp") : GoString), stdgo.math_test.Math_test.benchmarkFrexp) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkGamma") : GoString), stdgo.math_test.Math_test.benchmarkGamma) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkHypot") : GoString), stdgo.math_test.Math_test.benchmarkHypot) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkHypotGo") : GoString), stdgo.math_test.Math_test.benchmarkHypotGo) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkIlogb") : GoString), stdgo.math_test.Math_test.benchmarkIlogb) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkJ0") : GoString), stdgo.math_test.Math_test.benchmarkJ0) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkJ1") : GoString), stdgo.math_test.Math_test.benchmarkJ1) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkJn") : GoString), stdgo.math_test.Math_test.benchmarkJn) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkLdexp") : GoString), stdgo.math_test.Math_test.benchmarkLdexp) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkLgamma") : GoString), stdgo.math_test.Math_test.benchmarkLgamma) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkLog") : GoString), stdgo.math_test.Math_test.benchmarkLog) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkLogb") : GoString), stdgo.math_test.Math_test.benchmarkLogb) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkLog1p") : GoString), stdgo.math_test.Math_test.benchmarkLog1p) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkLog10") : GoString), stdgo.math_test.Math_test.benchmarkLog10) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkLog2") : GoString), stdgo.math_test.Math_test.benchmarkLog2) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkModf") : GoString), stdgo.math_test.Math_test.benchmarkModf) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkNextafter32") : GoString), stdgo.math_test.Math_test.benchmarkNextafter32) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkNextafter64") : GoString), stdgo.math_test.Math_test.benchmarkNextafter64) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkPowInt") : GoString), stdgo.math_test.Math_test.benchmarkPowInt) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkPowFrac") : GoString), stdgo.math_test.Math_test.benchmarkPowFrac) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkPow10Pos") : GoString), stdgo.math_test.Math_test.benchmarkPow10Pos) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkPow10Neg") : GoString), stdgo.math_test.Math_test.benchmarkPow10Neg) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkRound") : GoString), stdgo.math_test.Math_test.benchmarkRound) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkRoundToEven") : GoString), stdgo.math_test.Math_test.benchmarkRoundToEven) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkRemainder") : GoString), stdgo.math_test.Math_test.benchmarkRemainder) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkSignbit") : GoString), stdgo.math_test.Math_test.benchmarkSignbit) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkSin") : GoString), stdgo.math_test.Math_test.benchmarkSin) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkSincos") : GoString), stdgo.math_test.Math_test.benchmarkSincos) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkSinh") : GoString), stdgo.math_test.Math_test.benchmarkSinh) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkSqrtIndirect") : GoString), stdgo.math_test.Math_test.benchmarkSqrtIndirect) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkSqrtLatency") : GoString), stdgo.math_test.Math_test.benchmarkSqrtLatency) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkSqrtIndirectLatency") : GoString), stdgo.math_test.Math_test.benchmarkSqrtIndirectLatency) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkSqrtGoLatency") : GoString), stdgo.math_test.Math_test.benchmarkSqrtGoLatency) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkSqrtPrime") : GoString), stdgo.math_test.Math_test.benchmarkSqrtPrime) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkTan") : GoString), stdgo.math_test.Math_test.benchmarkTan) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkTanh") : GoString), stdgo.math_test.Math_test.benchmarkTanh) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkTrunc") : GoString), stdgo.math_test.Math_test.benchmarkTrunc) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkY0") : GoString), stdgo.math_test.Math_test.benchmarkY0) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkY1") : GoString), stdgo.math_test.Math_test.benchmarkY1) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkYn") : GoString), stdgo.math_test.Math_test.benchmarkYn) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkFloat64bits") : GoString), stdgo.math_test.Math_test.benchmarkFloat64bits) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkFloat64frombits") : GoString), stdgo.math_test.Math_test.benchmarkFloat64frombits) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkFloat32bits") : GoString), stdgo.math_test.Math_test.benchmarkFloat32bits) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkFloat32frombits") : GoString), stdgo.math_test.Math_test.benchmarkFloat32frombits) : stdgo.testing.Testing.InternalBenchmark),
(new stdgo.testing.Testing.InternalBenchmark((Go.str("BenchmarkFMA") : GoString), stdgo.math_test.Math_test.benchmarkFMA) : stdgo.testing.Testing.InternalBenchmark)) : Slice<stdgo.testing.Testing.InternalBenchmark>);
...
(new stdgo.testing.Testing.InternalExample((Go.str("ExampleCopysign") : GoString), stdgo.math_test.Math_test.exampleCopysign, (Go.str("-3.20\n") : GoString), false) : stdgo.testing.Testing.InternalExample),
...
(new stdgo.testing.Testing.InternalExample((Go.str("ExampleSincos") : GoString), stdgo.math_test.Math_test.exampleSincos, (Go.str("0.00, 1.00\n") : GoString), false) : stdgo.testing.Testing.InternalExample),
...
(new stdgo.testing.Testing.InternalExample((Go.str("ExampleRound") : GoString), stdgo.math_test.Math_test.exampleRound, (Go.str("11.0\n-11.0\n") : GoString), false) : stdgo.testing.Testing.InternalExample),
(new stdgo.testing.Testing.InternalExample((Go.str("ExampleRoundToEven") : GoString), stdgo.math_test.Math_test.exampleRoundToEven, (Go.str("12.0\n12.0\n") : GoString), false) : stdgo.testing.Testing.InternalExample),
...
(new stdgo.testing.Testing.InternalExample((Go.str("ExampleRemainder") : GoString), stdgo.math_test.Math_test.exampleRemainder, (Go.str("10.0\n") : GoString), false) : stdgo.testing.Testing.InternalExample),
...
(new stdgo.testing.Testing.InternalExample((Go.str("ExampleExp") : GoString), stdgo.math_test.Math_test.exampleExp, (Go.str("2.72\n7.39\n0.37\n") : GoString), false) : stdgo.testing.Testing.InternalExample),
(new stdgo.testing.Testing.InternalExample((Go.str("ExampleExp2") : GoString), stdgo.math_test.Math_test.exampleExp2, (Go.str("2.00\n0.12\n") : GoString), false) : stdgo.testing.Testing.InternalExample),
(new stdgo.testing.Testing.InternalExample((Go.str("ExampleExpm1") : GoString), stdgo.math_test.Math_test.exampleExpm1, (Go.str("0.010050\n-0.632121\n") : GoString), false) : stdgo.testing.Testing.InternalExample),
(new stdgo.testing.Testing.InternalExample((Go.str("ExampleTrunc") : GoString), stdgo.math_test.Math_test.exampleTrunc, (Go.str("3.00\n-1.00\n") : GoString), false) : stdgo.testing.Testing.InternalExample),
(new stdgo.testing.Testing.InternalExample((Go.str("ExampleCbrt") : GoString), stdgo.math_test.Math_test.exampleCbrt, (Go.str("2.00\n3.00\n") : GoString), false) : stdgo.testing.Testing.InternalExample),
(new stdgo.testing.Testing.InternalExample((Go.str("ExampleModf") : GoString), stdgo.math_test.Math_test.exampleModf, (Go.str("3.00, 0.14\n-2.00, -0.71\n") : GoString), false) : stdgo.testing.Testing.InternalExample)) : Slice<stdgo.testing.Testing.InternalExample>);
function main():Void {
