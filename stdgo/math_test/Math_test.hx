...
var _floatTests : Slice<stdgo.math_test.Math_test.T_floatTest> = (new Slice<stdgo.math_test.Math_test.T_floatTest>(0, 0, (new stdgo.math_test.Math_test.T_floatTest(Go.toInterface((1.7976931348623157e+308 : GoFloat64)), (Go.str("MaxFloat64") : GoString), (Go.str("1.7976931348623157e+308") : GoString)) : stdgo.math_test.Math_test.T_floatTest), (new stdgo.math_test.Math_test.T_floatTest(Go.toInterface((5e-324 : GoFloat64)), (Go.str("SmallestNonzeroFloat64") : GoString), (Go.str("5e-324") : GoString)) : stdgo.math_test.Math_test.T_floatTest), (new stdgo.math_test.Math_test.T_floatTest(Go.toInterface((3.4028234663852886e+38 : GoFloat32)), (Go.str("MaxFloat32") : GoString), (Go.str("3.4028235e+38") : GoString)) : stdgo.math_test.Math_test.T_floatTest), (new stdgo.math_test.Math_test.T_floatTest(Go.toInterface((1.401298464324817e-45 : GoFloat32)), (Go.str("SmallestNonzeroFloat32") : GoString), (Go.str("1e-45") : GoString)) : stdgo.math_test.Math_test.T_floatTest)) : Slice<stdgo.math_test.Math_test.T_floatTest>);
...
function testAcos(_t:stdgo.testing.Testing.T):Void {
        {
            ...
            Go.cfor(_i < (_vf.length), _i++, {
                var _a:GoFloat64 = _vf[_i] / (10 : GoFloat64);
                {
...
function testAcosh(_t:stdgo.testing.Testing.T):Void {
        {
            var _i:GoInt = (0 : GoInt);
            Go.cfor(_i < (_vf.length), _i++, {
                var _a:GoFloat64 = (1 : GoFloat64) + abs(_vf[_i]);
                {
            ...
            Go.cfor(_i < (_vfacoshSC.length), _i++, {
                {
                    ...
                    if (!_alike(_acoshSC[_i], _f)) {
                        _t.errorf((Go.str("Acosh(%g) = %g, want %g") : GoString), Go.toInterface(_vfacoshSC[_i]), Go.toInterface(_f), Go.toInterface(_acoshSC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vfasinhSC.length), _i++, {
                {
                    ...
                    if (!_alike(_asinhSC[_i], _f)) {
                        _t.errorf((Go.str("Asinh(%g) = %g, want %g") : GoString), Go.toInterface(_vfasinhSC[_i]), Go.toInterface(_f), Go.toInterface(_asinhSC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vfatanhSC.length), _i++, {
                {
                    ...
                    if (!_alike(_atanhSC[_i], _f)) {
                        _t.errorf((Go.str("Atanh(%g) = %g, want %g") : GoString), Go.toInterface(_vfatanhSC[_i]), Go.toInterface(_f), Go.toInterface(_atanhSC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vfatan2SC.length), _i++, {
                {
                    ...
                    if (!_alike(_atan2SC[_i], _f)) {
                        _t.errorf((Go.str("Atan2(%g, %g) = %g, want %g") : GoString), Go.toInterface(_vfatan2SC[_i][(0 : GoInt)]), Go.toInterface(_vfatan2SC[_i][(1 : GoInt)]), Go.toInterface(_f), Go.toInterface(_atan2SC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vf.length), _i++, {
                {
                    ...
                    if (_copysign[_i] != _f) {
                        _t.errorf((Go.str("Copysign(%g, -1) = %g, want %g") : GoString), Go.toInterface(_vf[_i]), Go.toInterface(_f), Go.toInterface(_copysign[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vfcopysignSC.length), _i++, {
                {
                    ...
                    if (!_alike(_copysignSC[_i], _f)) {
                        _t.errorf((Go.str("Copysign(%g, -1) = %g, want %g") : GoString), Go.toInterface(_vfcopysignSC[_i]), Go.toInterface(_f), Go.toInterface(_copysignSC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vferfinvSC.length), _i++, {
                {
                    ...
                    if (!_alike(_erfinvSC[_i], _f)) {
                        _t.errorf((Go.str("Erfinv(%g) = %g, want %g") : GoString), Go.toInterface(_vferfinvSC[_i]), Go.toInterface(_f), Go.toInterface(_erfinvSC[_i]));
                    };
                };
            });
        };
...
function testErfcinv(_t:stdgo.testing.Testing.T):Void {
        {
            var _i:GoInt = (0 : GoInt);
            Go.cfor(_i < (_vf.length), _i++, {
                var _a:GoFloat64 = (1 : GoFloat64) - (_vf[_i] / (10 : GoFloat64));
                {
            ...
            Go.cfor(_i < (_vferfcinvSC.length), _i++, {
                {
                    ...
                    if (!_alike(_erfcinvSC[_i], _f)) {
                        _t.errorf((Go.str("Erfcinv(%g) = %g, want %g") : GoString), Go.toInterface(_vferfcinvSC[_i]), Go.toInterface(_f), Go.toInterface(_erfcinvSC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vf.length), _i++, {
                {
                    ...
                    if (!_veryclose(_exp[_i], _f)) {
                        _t.errorf((Go.str("%s(%g) = %g, want %g") : GoString), Go.toInterface(_name), Go.toInterface(_vf[_i]), Go.toInterface(_f), Go.toInterface(_exp[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vfexpSC.length), _i++, {
                {
                    ...
                    if (!_alike(_expSC[_i], _f)) {
                        _t.errorf((Go.str("%s(%g) = %g, want %g") : GoString), Go.toInterface(_name), Go.toInterface(_vfexpSC[_i]), Go.toInterface(_f), Go.toInterface(_expSC[_i]));
                    };
                };
            });
        };
...
function testExpm1(_t:stdgo.testing.Testing.T):Void {
        {
            var _i:GoInt = (0 : GoInt);
            Go.cfor(_i < (_vf.length), _i++, {
                var _a:GoFloat64 = _vf[_i] / (100 : GoFloat64);
                {
            ...
            Go.cfor(_i < (_vfexpm1SC.length), _i++, {
                {
                    ...
                    if (!_alike(_expm1SC[_i], _f)) {
                        _t.errorf((Go.str("Expm1(%g) = %g, want %g") : GoString), Go.toInterface(_vfexpm1SC[_i]), Go.toInterface(_f), Go.toInterface(_expm1SC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vf.length), _i++, {
                {
                    ...
                    if (!_close(_exp2[_i], _f)) {
                        _t.errorf((Go.str("%s(%g) = %g, want %g") : GoString), Go.toInterface(_name), Go.toInterface(_vf[_i]), Go.toInterface(_f), Go.toInterface(_exp2[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vfexp2SC.length), _i++, {
                {
                    ...
                    if (!_alike(_exp2SC[_i], _f)) {
                        _t.errorf((Go.str("%s(%g) = %g, want %g") : GoString), Go.toInterface(_name), Go.toInterface(_vfexp2SC[_i]), Go.toInterface(_f), Go.toInterface(_exp2SC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vf.length), _i++, {
                {
                    ...
                    if (_fdim[_i] != _f) {
                        _t.errorf((Go.str("Dim(%g, %g) = %g, want %g") : GoString), Go.toInterface(_vf[_i]), Go.toInterface((0 : GoFloat64)), Go.toInterface(_f), Go.toInterface(_fdim[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vffdimSC.length), _i++, {
                {
                    ...
                    if (!_alike(_fdimSC[_i], _f)) {
                        _t.errorf((Go.str("Dim(%g, %g) = %g, want %g") : GoString), Go.toInterface(_vffdimSC[_i][(0 : GoInt)]), Go.toInterface(_vffdimSC[_i][(1 : GoInt)]), Go.toInterface(_f), Go.toInterface(_fdimSC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vffdim2SC.length), _i++, {
                {
                    ...
                    if (!_alike(_fdimSC[_i], _f)) {
                        _t.errorf((Go.str("Dim(%g, %g) = %g, want %g") : GoString), Go.toInterface(_vffdim2SC[_i][(0 : GoInt)]), Go.toInterface(_vffdim2SC[_i][(1 : GoInt)]), Go.toInterface(_f), Go.toInterface(_fdimSC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vf.length), _i++, {
                {
                    ...
                    if (_ceil[_i] != _f) {
                        _t.errorf((Go.str("Max(%g, %g) = %g, want %g") : GoString), Go.toInterface(_vf[_i]), Go.toInterface(_ceil[_i]), Go.toInterface(_f), Go.toInterface(_ceil[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vffdimSC.length), _i++, {
                {
                    ...
                    if (!_alike(_fmaxSC[_i], _f)) {
                        _t.errorf((Go.str("Max(%g, %g) = %g, want %g") : GoString), Go.toInterface(_vffdimSC[_i][(0 : GoInt)]), Go.toInterface(_vffdimSC[_i][(1 : GoInt)]), Go.toInterface(_f), Go.toInterface(_fmaxSC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vffdim2SC.length), _i++, {
                {
                    ...
                    if (!_alike(_fmaxSC[_i], _f)) {
                        _t.errorf((Go.str("Max(%g, %g) = %g, want %g") : GoString), Go.toInterface(_vffdim2SC[_i][(0 : GoInt)]), Go.toInterface(_vffdim2SC[_i][(1 : GoInt)]), Go.toInterface(_f), Go.toInterface(_fmaxSC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vf.length), _i++, {
                {
                    ...
                    if (_floor[_i] != _f) {
                        _t.errorf((Go.str("Min(%g, %g) = %g, want %g") : GoString), Go.toInterface(_vf[_i]), Go.toInterface(_floor[_i]), Go.toInterface(_f), Go.toInterface(_floor[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vffdimSC.length), _i++, {
                {
                    ...
                    if (!_alike(_fminSC[_i], _f)) {
                        _t.errorf((Go.str("Min(%g, %g) = %g, want %g") : GoString), Go.toInterface(_vffdimSC[_i][(0 : GoInt)]), Go.toInterface(_vffdimSC[_i][(1 : GoInt)]), Go.toInterface(_f), Go.toInterface(_fminSC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vffdim2SC.length), _i++, {
                {
                    ...
                    if (!_alike(_fminSC[_i], _f)) {
                        _t.errorf((Go.str("Min(%g, %g) = %g, want %g") : GoString), Go.toInterface(_vffdim2SC[_i][(0 : GoInt)]), Go.toInterface(_vffdim2SC[_i][(1 : GoInt)]), Go.toInterface(_f), Go.toInterface(_fminSC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vffmodSC.length), _i++, {
                {
                    ...
                    if (!_alike(_fmodSC[_i], _f)) {
                        _t.errorf((Go.str("Mod(%g, %g) = %g, want %g") : GoString), Go.toInterface(_vffmodSC[_i][(0 : GoInt)]), Go.toInterface(_vffmodSC[_i][(1 : GoInt)]), Go.toInterface(_f), Go.toInterface(_fmodSC[_i]));
                    };
                };
            });
        };
...
function testFrexp(_t:stdgo.testing.Testing.T):Void {
        {
            ...
            Go.cfor(_i < (_vf.length), _i++, {
                {
                    var __tmp__ = frexp(_vf[_i]), _f:GoFloat64 = __tmp__._0, _j:GoInt = __tmp__._1;
                    if (!_veryclose(_frexp[_i]._f, _f) || (_frexp[_i]._i != _j)) {
                        _t.errorf((Go.str("Frexp(%g) = %g, %d, want %g, %d") : GoString), Go.toInterface(_vf[_i]), Go.toInterface(_f), Go.toInterface(_j), Go.toInterface(_frexp[_i]._f), Go.toInterface(_frexp[_i]._i));
                    };
                };
            });
        };
        {
            ...
            Go.cfor(_i < (_vffrexpSC.length), _i++, {
                {
                    var __tmp__ = frexp(_vffrexpSC[_i]), _f:GoFloat64 = __tmp__._0, _j:GoInt = __tmp__._1;
                    if (!_alike(_frexpSC[_i]._f, _f) || (_frexpSC[_i]._i != _j)) {
                        _t.errorf((Go.str("Frexp(%g) = %g, %d, want %g, %d") : GoString), Go.toInterface(_vffrexpSC[_i]), Go.toInterface(_f), Go.toInterface(_j), Go.toInterface(_frexpSC[_i]._f), Go.toInterface(_frexpSC[_i]._i));
                    };
                };
            });
        };
        {
            ...
            Go.cfor(_i < (_vffrexpBC.length), _i++, {
                {
                    var __tmp__ = frexp(_vffrexpBC[_i]), _f:GoFloat64 = __tmp__._0, _j:GoInt = __tmp__._1;
                    if (!_alike(_frexpBC[_i]._f, _f) || (_frexpBC[_i]._i != _j)) {
                        _t.errorf((Go.str("Frexp(%g) = %g, %d, want %g, %d") : GoString), Go.toInterface(_vffrexpBC[_i]), Go.toInterface(_f), Go.toInterface(_j), Go.toInterface(_frexpBC[_i]._f), Go.toInterface(_frexpBC[_i]._i));
                    };
                };
            });
        };
...
function testHypot(_t:stdgo.testing.Testing.T):Void {
        {
            var _i:GoInt = (0 : GoInt);
            Go.cfor(_i < (_vf.length), _i++, {
                var _a:GoFloat64 = abs(((1e+200 : GoFloat64) * _tanh[_i]) * sqrt((2 : GoFloat64)));
                {
                    var _f:GoFloat64 = hypot((1e+200 : GoFloat64) * _tanh[_i], (1e+200 : GoFloat64) * _tanh[_i]);
                    if (!_veryclose(_a, _f)) {
                        _t.errorf((Go.str("Hypot(%g, %g) = %g, want %g") : GoString), Go.toInterface((1e+200 : GoFloat64) * _tanh[_i]), Go.toInterface((1e+200 : GoFloat64) * _tanh[_i]), Go.toInterface(_f), Go.toInterface(_a));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vfhypotSC.length), _i++, {
                {
                    ...
                    if (!_alike(_hypotSC[_i], _f)) {
                        _t.errorf((Go.str("Hypot(%g, %g) = %g, want %g") : GoString), Go.toInterface(_vfhypotSC[_i][(0 : GoInt)]), Go.toInterface(_vfhypotSC[_i][(1 : GoInt)]), Go.toInterface(_f), Go.toInterface(_hypotSC[_i]));
                    };
                };
            });
        };
...
function testHypotGo(_t:stdgo.testing.Testing.T):Void {
        {
            ...
            Go.cfor(_i < (_vf.length), _i++, {
                var _a:GoFloat64 = abs(((1e+200 : GoFloat64) * _tanh[_i]) * sqrt((2 : GoFloat64)));
                {
                    ...
                    if (!_veryclose(_a, _f)) {
                        _t.errorf((Go.str("HypotGo(%g, %g) = %g, want %g") : GoString), Go.toInterface((1e+200 : GoFloat64) * _tanh[_i]), Go.toInterface((1e+200 : GoFloat64) * _tanh[_i]), Go.toInterface(_f), Go.toInterface(_a));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vfhypotSC.length), _i++, {
                {
                    ...
                    if (!_alike(_hypotSC[_i], _f)) {
                        _t.errorf((Go.str("HypotGo(%g, %g) = %g, want %g") : GoString), Go.toInterface(_vfhypotSC[_i][(0 : GoInt)]), Go.toInterface(_vfhypotSC[_i][(1 : GoInt)]), Go.toInterface(_f), Go.toInterface(_hypotSC[_i]));
                    };
                };
            });
        };
...
function testIlogb(_t:stdgo.testing.Testing.T):Void {
        {
            var _i:GoInt = (0 : GoInt);
            Go.cfor(_i < (_vf.length), _i++, {
                var _a:GoInt = _frexp[_i]._i - (1 : GoInt);
                {
            ...
            Go.cfor(_i < (_vffrexpBC.length), _i++, {
                {
                    ...
                    if ((_logbBC[_i] : GoInt) != _e) {
                        _t.errorf((Go.str("Ilogb(%g) = %d, want %d") : GoString), Go.toInterface(_vffrexpBC[_i]), Go.toInterface(_e), Go.toInterface((_logbBC[_i] : GoInt)));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vf.length), _i++, {
                {
                    ...
                    if (!_veryclose(_vf[_i], _f)) {
                        _t.errorf((Go.str("Ldexp(%g, %d) = %g, want %g") : GoString), Go.toInterface(_frexp[_i]._f), Go.toInterface(_frexp[_i]._i), Go.toInterface(_f), Go.toInterface(_vf[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vffrexpSC.length), _i++, {
                {
                    ...
                    if (!_alike(_vffrexpSC[_i], _f)) {
                        _t.errorf((Go.str("Ldexp(%g, %d) = %g, want %g") : GoString), Go.toInterface(_frexpSC[_i]._f), Go.toInterface(_frexpSC[_i]._i), Go.toInterface(_f), Go.toInterface(_vffrexpSC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vfldexpSC.length), _i++, {
                {
                    ...
                    if (!_alike(_ldexpSC[_i], _f)) {
                        _t.errorf((Go.str("Ldexp(%g, %d) = %g, want %g") : GoString), Go.toInterface(_vfldexpSC[_i]._f), Go.toInterface(_vfldexpSC[_i]._i), Go.toInterface(_f), Go.toInterface(_ldexpSC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vffrexpBC.length), _i++, {
                {
                    ...
                    if (!_alike(_vffrexpBC[_i], _f)) {
                        _t.errorf((Go.str("Ldexp(%g, %d) = %g, want %g") : GoString), Go.toInterface(_frexpBC[_i]._f), Go.toInterface(_frexpBC[_i]._i), Go.toInterface(_f), Go.toInterface(_vffrexpBC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vfldexpBC.length), _i++, {
                {
                    ...
                    if (!_alike(_ldexpBC[_i], _f)) {
                        _t.errorf((Go.str("Ldexp(%g, %d) = %g, want %g") : GoString), Go.toInterface(_vfldexpBC[_i]._f), Go.toInterface(_vfldexpBC[_i]._i), Go.toInterface(_f), Go.toInterface(_ldexpBC[_i]));
                    };
                };
            });
        };
...
function testLgamma(_t:stdgo.testing.Testing.T):Void {
        {
            ...
            Go.cfor(_i < (_vf.length), _i++, {
                {
                    var __tmp__ = lgamma(_vf[_i]), _f:GoFloat64 = __tmp__._0, _s:GoInt = __tmp__._1;
                    if (!_close(_lgamma[_i]._f, _f) || (_lgamma[_i]._i != _s)) {
                        _t.errorf((Go.str("Lgamma(%g) = %g, %d, want %g, %d") : GoString), Go.toInterface(_vf[_i]), Go.toInterface(_f), Go.toInterface(_s), Go.toInterface(_lgamma[_i]._f), Go.toInterface(_lgamma[_i]._i));
                    };
                };
            });
        };
        {
            ...
            Go.cfor(_i < (_vflgammaSC.length), _i++, {
                {
                    var __tmp__ = lgamma(_vflgammaSC[_i]), _f:GoFloat64 = __tmp__._0, _s:GoInt = __tmp__._1;
                    if (!_alike(_lgammaSC[_i]._f, _f) || (_lgammaSC[_i]._i != _s)) {
                        _t.errorf((Go.str("Lgamma(%g) = %g, %d, want %g, %d") : GoString), Go.toInterface(_vflgammaSC[_i]), Go.toInterface(_f), Go.toInterface(_s), Go.toInterface(_lgammaSC[_i]._f), Go.toInterface(_lgammaSC[_i]._i));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vflogSC.length), _i++, {
                {
                    ...
                    if (!_alike(_log1pSC[_i], _f)) {
                        _t.errorf((Go.str("Log1p(%g) = %g, want %g") : GoString), Go.toInterface(_vflog1pSC[_i]), Go.toInterface(_f), Go.toInterface(_log1pSC[_i]));
                    };
                };
            });
        };
...
function testModf(_t:stdgo.testing.Testing.T):Void {
        {
            ...
            Go.cfor(_i < (_vf.length), _i++, {
                {
                    var __tmp__ = modf(_vf[_i]), _f:GoFloat64 = __tmp__._0, _g:GoFloat64 = __tmp__._1;
                    if (!_veryclose(_modf[_i][(0 : GoInt)], _f) || !_veryclose(_modf[_i][(1 : GoInt)], _g)) {
                        _t.errorf((Go.str("Modf(%g) = %g, %g, want %g, %g") : GoString), Go.toInterface(_vf[_i]), Go.toInterface(_f), Go.toInterface(_g), Go.toInterface(_modf[_i][(0 : GoInt)]), Go.toInterface(_modf[_i][(1 : GoInt)]));
                    };
                };
            });
        };
        {
            ...
            Go.cfor(_i < (_vfmodfSC.length), _i++, {
                {
                    var __tmp__ = modf(_vfmodfSC[_i]), _f:GoFloat64 = __tmp__._0, _g:GoFloat64 = __tmp__._1;
                    if (!_alike(_modfSC[_i][(0 : GoInt)], _f) || !_alike(_modfSC[_i][(1 : GoInt)], _g)) {
                        _t.errorf((Go.str("Modf(%g) = %g, %g, want %g, %g") : GoString), Go.toInterface(_vfmodfSC[_i]), Go.toInterface(_f), Go.toInterface(_g), Go.toInterface(_modfSC[_i][(0 : GoInt)]), Go.toInterface(_modfSC[_i][(1 : GoInt)]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vf.length), _i++, {
                var _vfi:GoFloat32 = (_vf[_i] : GoFloat32);
                {
                    ...
                    if (_nextafter32[_i] != _f) {
                        _t.errorf((Go.str("Nextafter32(%g, %g) = %g want %g") : GoString), Go.toInterface(_vfi), Go.toInterface((10 : GoFloat64)), Go.toInterface(_f), Go.toInterface(_nextafter32[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vfnextafter32SC.length), _i++, {
                {
                    ...
                    if (!_alike((_nextafter32SC[_i] : GoFloat64), (_f : GoFloat64))) {
                        _t.errorf((Go.str("Nextafter32(%g, %g) = %g want %g") : GoString), Go.toInterface(_vfnextafter32SC[_i][(0 : GoInt)]), Go.toInterface(_vfnextafter32SC[_i][(1 : GoInt)]), Go.toInterface(_f), Go.toInterface(_nextafter32SC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vf.length), _i++, {
                {
                    ...
                    if (_nextafter64[_i] != _f) {
                        _t.errorf((Go.str("Nextafter64(%g, %g) = %g want %g") : GoString), Go.toInterface(_vf[_i]), Go.toInterface((10 : GoFloat64)), Go.toInterface(_f), Go.toInterface(_nextafter64[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vfnextafter64SC.length), _i++, {
                {
                    ...
                    if (!_alike(_nextafter64SC[_i], _f)) {
                        _t.errorf((Go.str("Nextafter64(%g, %g) = %g want %g") : GoString), Go.toInterface(_vfnextafter64SC[_i][(0 : GoInt)]), Go.toInterface(_vfnextafter64SC[_i][(1 : GoInt)]), Go.toInterface(_f), Go.toInterface(_nextafter64SC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vfpowSC.length), _i++, {
                {
                    ...
                    if (!_alike(_powSC[_i], _f)) {
                        _t.errorf((Go.str("Pow(%g, %g) = %g, want %g") : GoString), Go.toInterface(_vfpowSC[_i][(0 : GoInt)]), Go.toInterface(_vfpowSC[_i][(1 : GoInt)]), Go.toInterface(_f), Go.toInterface(_powSC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vfpow10SC.length), _i++, {
                {
                    ...
                    if (!_alike(_pow10SC[_i], _f)) {
                        _t.errorf((Go.str("Pow10(%d) = %g, want %g") : GoString), Go.toInterface(_vfpow10SC[_i]), Go.toInterface(_f), Go.toInterface(_pow10SC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vf.length), _i++, {
                {
                    ...
                    if (_remainder[_i] != _f) {
                        _t.errorf((Go.str("Remainder(10, %g) = %g, want %g") : GoString), Go.toInterface(_vf[_i]), Go.toInterface(_f), Go.toInterface(_remainder[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vffmodSC.length), _i++, {
                {
                    ...
                    if (!_alike(_fmodSC[_i], _f)) {
                        _t.errorf((Go.str("Remainder(%g, %g) = %g, want %g") : GoString), Go.toInterface(_vffmodSC[_i][(0 : GoInt)]), Go.toInterface(_vffmodSC[_i][(1 : GoInt)]), Go.toInterface(_f), Go.toInterface(_fmodSC[_i]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vfroundSC.length), _i++, {
                {
                    ...
                    if (!_alike(_vfroundSC[_i][(1 : GoInt)], _f)) {
                        _t.errorf((Go.str("Round(%g) = %g, want %g") : GoString), Go.toInterface(_vfroundSC[_i][(0 : GoInt)]), Go.toInterface(_f), Go.toInterface(_vfroundSC[_i][(1 : GoInt)]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vfroundEvenSC.length), _i++, {
                {
                    ...
                    if (!_alike(_vfroundEvenSC[_i][(1 : GoInt)], _f)) {
                        _t.errorf((Go.str("RoundToEven(%g) = %g, want %g") : GoString), Go.toInterface(_vfroundEvenSC[_i][(0 : GoInt)]), Go.toInterface(_f), Go.toInterface(_vfroundEvenSC[_i][(1 : GoInt)]));
                    };
                };
            });
        };
            ...
            Go.cfor(_i < (_vfsignbitSC.length), _i++, {
                {
                    ...
                    if (_signbitSC[_i] != _f) {
                        _t.errorf((Go.str("Signbit(%g) = %t, want %t") : GoString), Go.toInterface(_vfsignbitSC[_i]), Go.toInterface(_f), Go.toInterface(_signbitSC[_i]));
                    };
                };
            });
        };
...
function testSincos(_t:stdgo.testing.Testing.T):Void {
        {
            ...
            Go.cfor(_i < (_vf.length), _i++, {
                {
                    var __tmp__ = sincos(_vf[_i]), _s:GoFloat64 = __tmp__._0, _c:GoFloat64 = __tmp__._1;
                    if (!_veryclose(_sin[_i], _s) || !_veryclose(_cos[_i], _c)) {
                        _t.errorf((Go.str("Sincos(%g) = %g, %g want %g, %g") : GoString), Go.toInterface(_vf[_i]), Go.toInterface(_s), Go.toInterface(_c), Go.toInterface(_sin[_i]), Go.toInterface(_cos[_i]));
                    };
                };
            });
        };
...
function testLargeSincos(_t:stdgo.testing.Testing.T):Void {
        var _large:GoFloat64 = (314159.26535897935 : GoFloat64);
        {
            ...
            Go.cfor(_i < (_vf.length), _i++, {
                ...
                var __tmp__ = sincos(_vf[_i] + _large), _f2:GoFloat64 = __tmp__._0, _g2:GoFloat64 = __tmp__._1;
                if (!_close(_f1, _f2) || !_close(_g1, _g2)) {
                    _t.errorf((Go.str("Sincos(%g) = %g, %g, want %g, %g") : GoString), Go.toInterface(_vf[_i] + _large), Go.toInterface(_f2), Go.toInterface(_g2), Go.toInterface(_f1), Go.toInterface(_g1));
                };
            });
        };
    }
...
function testHugeSinCos(_t:stdgo.testing.Testing.T):Void {
        {
            ...
            Go.cfor(_i < (_trigHuge.length), _i++, {
                ...
                var __tmp__ = sincos(_trigHuge[_i]), _f2:GoFloat64 = __tmp__._0, _g2:GoFloat64 = __tmp__._1;
                if (!_close(_f1, _f2) || !_close(_g1, _g2)) {
                    _t.errorf((Go.str("Sincos(%g) = %g, %g, want %g, %g") : GoString), Go.toInterface(_trigHuge[_i]), Go.toInterface(_f2), Go.toInterface(_g2), Go.toInterface(_f1), Go.toInterface(_g1));
                };
            });
        };
    }
