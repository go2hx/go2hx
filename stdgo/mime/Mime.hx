...
@:named class WordEncoder {
	...
	public function _bEncode(_buf:Pointer<stdgo.strings.Strings.Builder>, _charset:GoString, _s:GoString):Void {
		...
		var _currentLen:GoInt = ((0 : GoInt)),
			_last:GoInt = ((0 : GoInt)),
			_runeLen:GoInt = ((0 : GoInt));
		{
			var _i:GoInt = ((0 : GoInt));
			Go.cfor(_i < _s.length, _i = _i + (_runeLen), {
				{
...
@:structInit class WordDecoder {
	public function _convert(_buf:Pointer<stdgo.strings.Strings.Builder>, _charset:GoString, _content:Slice<GoByte>):Error {
		...
		if (stdgo.strings.Strings.equalFold("utf-8", _charset)) {
			...
			var __tmp__ = _d.value.charsetReader(stdgo.strings.Strings.toLower(_charset), stdgo.bytes.Bytes.newReader(_content).value),
				_r:stdgo.io.Io.Reader = __tmp__._0,
	...
	public function decodeHeader(_header:GoString):{var _0:GoString; var _1:Error;} {
		...
		while (true) {
			...
			var __tmp__ = _decode(_encoding, _text),
				_content:Slice<GoUInt8> = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				_betweenWords = false;
	...
	public function decode(_word:GoString):{var _0:GoString; var _1:Error;} {
		var _d = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		if (_word.length < ((8 : GoInt))
			|| !stdgo.strings.Strings.hasPrefix(_word, "=?")
			|| !stdgo.strings.Strings.hasSuffix(_word, "?=")
			|| stdgo.strings.Strings.count(_word, "?") != ((4 : GoInt))) {
	...
	public var charsetReader:(GoString, stdgo.io.Io.Reader) -> {
		var _0:stdgo.io.Io.Reader;
		var _1:stdgo.Error;
	} = null;

	public function new(?charsetReader:(GoString, stdgo.io.Io.Reader) -> {
		var _0:stdgo.io.Io.Reader;
		var _1:stdgo.Error;
	})
...
var _builtinTypesLower:GoMap<GoString, GoString> = new GoMap<GoString,
	...
	{key: ".css", value: "text/css; charset=utf-8"}, {key: ".gif", value: "image/gif"}, {key: ".htm", value: "text/html; charset=utf-8"},
	{key: ".html", value: "text/html; charset=utf-8"}, {key: ".jpeg", value: "image/jpeg"}, {key: ".jpg", value: "image/jpeg"},
	{key: ".js", value: "text/javascript; charset=utf-8"}, {key: ".json", value: "application/json"}, {key: ".mjs", value: "text/javascript; charset=utf-8"},
	{key: ".pdf", value: "application/pdf"}, {key: ".png", value: "image/png"}, {key: ".svg", value: "image/svg+xml"},
	{key: ".wasm", value: "application/wasm"}, {key: ".webp", value: "image/webp"}, {key: ".xml", value: "text/xml; charset=utf-8"});
		...
		Go.cfor(_i < _s.length, _i++, {
			{
				...
				} else if (_b >= (("!".code : GoRune)) && _b <= (("~".code : GoRune)) && _b != (("=".code : GoRune)) && _b != (("?".code : GoRune))
					&& _b != (("_".code : GoRune))) {
		...
		Go.cfor(_i < _s.length, _i++, {
			{
				...
				if (_c == (("_".code : GoRune))) {
					...
					var __tmp__ = _readHexByte(_s[_i + ((1 : GoInt))], _s[_i + ((2 : GoInt))]),
...
function formatMediaType(_t:GoString, _param:GoMap<GoString, GoString>):GoString {
	var _b:stdgo.strings.Strings.Builder = new stdgo.strings.Strings.Builder();
	{
		...
		if (_slash == -((1 : GoUnTypedInt))) {
			...
			var _major:GoString = _t.__slice__(0, _slash),
				_sub:GoString = _t.__slice__(_slash + ((1 : GoInt)));
	...
	var _attrs:Slice<GoString> = new Slice<GoString>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) (("" : GoString))])
		.setCap((((_param == null ? 0 : _param.length) : GoInt)).toBasic());
	for (_a => _ in _param) {
		...
		if (_needEnc) {
			...
			var _offset:GoInt = ((0 : GoInt));
			{
				...
				Go.cfor(_index < _value.length, _index++, {
					...
					if (_ch <= ((" ".code : GoRune)) || _ch >= ((127 : GoUInt8)) || _ch == (("*".code : GoRune)) || _ch == (("\'".code : GoRune))
						|| _ch == (("%".code : GoRune)) || _isTSpecial(((_ch : GoRune)))) {
...
function _checkMediaTypeDisposition(_s:GoString):Error {
	var __tmp__ = _consumeToken(_s),
		_typ:GoString = __tmp__._0,
		_rest:GoString = __tmp__._1;
	if (_typ == (("" : GoString))) {
	...
	var __tmp__ = _consumeToken(_rest.__slice__(((1 : GoInt)))),
		_subtype:GoString = __tmp__._0,
		_rest:GoString = __tmp__._1;
...
function parseMediaType(_v:GoString):{var _0:GoString; var _1:GoMap<GoString, GoString>; var _2:Error;} {
	var _mediatype:GoString = (("" : GoString)),
		_params:GoMap<GoString, GoString> = new GoMap<GoString,
			GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
	...
	if (_err != null) {
		return {_0: "", _1: new GoMap<GoString,
			GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
				stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil(), _2: _err};
	};
	_params = new GoMap<GoString,
		GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
			stdgo.reflect.Reflect.GoType.basic(string_kind))));
	var _continuation:GoMap<GoString, GoMap<GoString, GoString>> = new GoMap<GoString, GoMap<GoString,
		GoString>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
		stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.basic(string_kind))))).nil();
	_v = _v.__slice__(_i);
	while (_v.length > ((0 : GoInt))) {
		...
		var __tmp__ = _consumeMediaParam(_v),
			_key:GoString = __tmp__._0,
			_value:GoString = __tmp__._1,
			_rest:GoString = __tmp__._2;
		if (_key == (("" : GoString))) {
			if (stdgo.strings.Strings.trimSpace(_rest) == ((";" : GoString))) {
				return {_0: _mediatype, _1: _params, _2: _err};
			};
			return {_0: _mediatype, _1: new GoMap<GoString,
				GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
					stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil(), _2: errInvalidMediaParameter};
		};
		var _pmap:GoMap<GoString, GoString> = _params;
		{
			...
			if (_idx != -((1 : GoUnTypedInt))) {
				...
				if ((_continuation == null || _continuation.isNil())) {
					_continuation = new GoMap<GoString, GoMap<GoString,
						GoString>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
				...
				{
					{
						var __tmp__ = _continuation.exists(_baseName) ? {value: _continuation[_baseName], ok: true} : {value: _continuation.defaultValue(),
							ok: false};
						_pmap = __tmp__.value;
						_ok = __tmp__.ok;
					};
					if (!_ok) {
						_continuation[_baseName] = new GoMap<GoString,
							GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
								stdgo.reflect.Reflect.GoType.basic(string_kind))));
		...
		{
			var __tmp__ = _pmap.exists(_key) ? {value: _pmap[_key], ok: true} : {value: _pmap.defaultValue(), ok: false},
				_:GoString = __tmp__.value,
				_exists:Bool = __tmp__.ok;
			if (_exists) {
				return {_0: "", _1: new GoMap<GoString,
					GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
					stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil(), _2: stdgo.errors.Errors.new_("mime: duplicate parameter name")};
			};
		};
		_pmap[_key] = _value;
		_v = _rest;
	...
	for (_key => _pieceMap in _continuation) {
		...
		{
			var __tmp__ = _pieceMap.exists(_singlePartKey) ? {value: _pieceMap[_singlePartKey], ok: true} : {value: _pieceMap.defaultValue(), ok: false},
				_v:GoString = __tmp__.value,
				_ok:Bool = __tmp__.ok;
			if (_ok) {
				{
					var __tmp__ = _decode2231Enc(_v),
						_decv:GoString = __tmp__._0,
						_ok:Bool = __tmp__._1;
					if (_ok) {
						_params[_key] = _decv;
					};
		...
		var _valid:Bool = false;
		{
			...
			Go.cfor(true, _n++, {
				...
				{
					var __tmp__ = _pieceMap.exists(_simplePart) ? {value: _pieceMap[_simplePart], ok: true} : {value: _pieceMap.defaultValue(), ok: false},
						_v:GoString = __tmp__.value,
						_ok:Bool = __tmp__.ok;
					if (_ok) {
						_valid = true;
				...
				var __tmp__ = _pieceMap.exists(_encodedPart) ? {value: _pieceMap[_encodedPart], ok: true} : {value: _pieceMap.defaultValue(), ok: false},
					_v:GoString = __tmp__.value,
					_ok:Bool = __tmp__.ok;
				if (!_ok) {
					break;
				...
				if (_n == ((0 : GoInt))) {
					...
					var __tmp__ = _percentHexUnescape(_v),
						_decv:GoString = __tmp__._0,
...
function _decode2231Enc(_v:GoString):{var _0:GoString; var _1:Bool;} {
	...
	var __tmp__ = _percentHexUnescape(_sv[((2 : GoInt))]),
		_encv:GoString = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
		return {_0: "", _1: false};
	};
...
function _consumeMediaParam(_v:GoString):{var _0:GoString; var _1:GoString; var _2:GoString;} {
	var _param:GoString = (("" : GoString)),
		_value:GoString = (("" : GoString)),
		_rest:GoString = (("" : GoString));
	...
	_rest = _rest.__slice__(((1 : GoInt)));
	_rest = stdgo.strings.Strings.trimLeftFunc(_rest, stdgo.unicode.Unicode.isSpace);
	var __tmp__ = _consumeValue(_rest),
		_value:GoString = __tmp__._0,
		_rest2:GoString = __tmp__._1;
...
function _percentHexUnescape(_s:GoString):{var _0:GoString; var _1:Error;} {
	...
	var _t:Slice<GoUInt8> = new Slice<GoUInt8>(...[
		for (i in 0...((_s.length - ((2 : GoInt)) * _percents:GoInt)).toBasic()) ((0 : GoUInt8))
	]);
...
function _setMimeTypes(_lowerExt:GoMap<GoString, GoString>, _mixExt:GoMap<GoString, GoString>):Void {
	...
	try {
		...
		for (_k => _v in _lowerExt) {
			var __tmp__ = parseMediaType(_v),
				_justType:GoString = __tmp__._0,
				_:GoMap<GoString, GoString> = __tmp__._1,
			...
			{
				var __tmp__ = _extensions.load(Go.toInterface(_justType)),
					_ei:AnyInterface = __tmp__._0,
					_ok:Bool = __tmp__._1;
				if (_ok) {
...
function typeByExtension(_ext:GoString):GoString {
	_once.do_(_initMime);
	{
		var __tmp__ = _mimeTypes.load(Go.toInterface(_ext)),
	...
	final _utf8RuneSelf:GoUnTypedInt = ((128 : GoUnTypedInt));
	{
		...
		Go.cfor(_i < _ext.length, _i++, {
			...
			if (_c >= _utf8RuneSelf) {
				var __tmp__ = _mimeTypesLower.load(Go.toInterface(stdgo.strings.Strings.toLower(_ext))),
					_si:AnyInterface = __tmp__._0,
					_:Bool = __tmp__._1;
				var __tmp__ = try {
	...
	var __tmp__ = _mimeTypesLower.load(Go.toInterface(((_lower : GoString)))),
		_si:AnyInterface = __tmp__._0,
		_:Bool = __tmp__._1;
	var __tmp__ = try {
		{value: ((_si.value : GoString)), ok: true};
...
function extensionsByType(_typ:GoString):{var _0:Slice<GoString>; var _1:Error;} {
	var __tmp__ = parseMediaType(_typ),
		_justType:GoString = __tmp__._0,
		_:GoMap<GoString, GoString> = __tmp__._1,
		_err:stdgo.Error = __tmp__._2;
	if (_err != null) {
...
function _setExtensionType(_extension:GoString, _mimeType:GoString):Error {
	var recover_exception:Error = null;
	var deferstack:Array<Void->Void> = [];
	var __tmp__ = parseMediaType(_mimeType),
		_justType:GoString = __tmp__._0,
		_param:GoMap<GoString, GoString> = __tmp__._1,
		_err:stdgo.Error = __tmp__._2;
	try {
		if (_err != null) {
			return _err;
...
function _loadMimeGlobsFile(_filename:GoString):Error {
	...
	try {
		...
		while (_scanner.value.scan()) {
			...
			if (_fields.length < ((3 : GoInt))
				|| _fields[((0 : GoInt))].length < ((1 : GoInt))
				|| _fields[((2 : GoInt))].length < ((2 : GoInt))) {
				continue;
			} else if (_fields[((0 : GoInt))][((0 : GoInt))] == (("#".code : GoRune))
				|| _fields[((2 : GoInt))][((0 : GoInt))] != (("*".code : GoRune))) {
				continue;
			};
			var _extension:GoString = _fields[((2 : GoInt))].__slice__(((1 : GoInt)));
			{
				var __tmp__ = _mimeTypes.load(Go.toInterface(_extension)),
...
function _initMimeForTests():GoMap<GoString, GoString> {
	...
	return new GoMap<GoString, GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
		stdgo.reflect.Reflect.GoType.basic(string_kind))),
		{
			key: ".T1",
			value: "application/test"
		}, {key: ".t2", value: "text/test; charset=utf-8"},
...
class WordEncoder_extension_fields {
	public function encode(__tmp__, _charset:GoString, _s:GoString):GoString
		return __tmp__.encode(_charset, _s);

	public function _encodeWord(__tmp__, _charset:GoString, _s:GoString):GoString
		return __tmp__._encodeWord(_charset, _s);

	public function _bEncode(__tmp__, _buf:Pointer<stdgo.strings.Strings.Builder>, _charset:GoString, _s:GoString):Void
		__tmp__._bEncode(_buf, _charset, _s);

	public function _qEncode(__tmp__, _buf:Pointer<stdgo.strings.Strings.Builder>, _charset:GoString, _s:GoString):Void
		__tmp__._qEncode(_buf, _charset, _s);

	public function _openWord(__tmp__, _buf:Pointer<stdgo.strings.Strings.Builder>, _charset:GoString):Void
		__tmp__._openWord(_buf, _charset);

	public function _splitWord(__tmp__, _buf:Pointer<stdgo.strings.Strings.Builder>, _charset:GoString):Void
		__tmp__._splitWord(_buf, _charset);
}

class WordDecoder_extension_fields {
	public function decode(__tmp__, _word:GoString):{var _0:GoString; var _1:Error;}
		return __tmp__.decode(_word);

	public function decodeHeader(__tmp__, _header:GoString):{var _0:GoString; var _1:Error;}
		return __tmp__.decodeHeader(_header);

	public function _convert(__tmp__, _buf:Pointer<stdgo.strings.Strings.Builder>, _charset:GoString, _content:Slice<GoByte>):Error
		return __tmp__._convert(_buf, _charset, _content);
}
