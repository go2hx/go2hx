...
class Mime {
    ...
    **/
    static public function formatMediaType(_t:String, _param:stdgo.GoMap<stdgo.GoString, stdgo.GoString>):String {
    ...
    **/
    static public function parseMediaType(_v:String):stdgo.Tuple.Tuple3<String, stdgo.GoMap<stdgo.GoString, stdgo.GoString>, stdgo.Error> {
        return {
    ...
    **/
    static public function typeByExtension(_ext:String):String {
    ...
    /**
        ...
        nil slice.
    **/
    static public function extensionsByType(_typ:String):stdgo.Tuple<Array<String>, stdgo.Error> {
        return {
    ...
    **/
    static public function addExtensionType(_ext:String, _typ:String):stdgo.Error {
