...
@:structInit class Form {
	...
	public var value:GoMap<GoString, Slice<GoString>> = new GoMap<GoString,
	...
	public var file:GoMap<GoString, Slice<Pointer<FileHeader>>> = new GoMap<GoString,
		Slice<Pointer<FileHeader>>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
		stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("FileHeader", [],
			stdgo.reflect.Reflect.GoType.structType([
				...
				},
				{
					...
					embedded: false,
					tag: "",
					type: stdgo.reflect.Reflect.GoType.named("stdgo.net.textproto.Textproto.MIMEHeader", [],
	...
	public function new(?value:GoMap<GoString, Slice<GoString>>, ?file:GoMap<GoString, Slice<Pointer<FileHeader>>>)
...
@:structInit class FileHeader {
	public function open():{var _0:File; var _1:Error;} {
		var _fh = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		{
			...
			if ((_b != null && !_b.isNil())) {
				var _r:Pointer<stdgo.io.Io.SectionReader> = stdgo.io.Io.newSectionReader(stdgo.bytes.Bytes.newReader(_b).value, ((0 : GoInt64)),
					((_b.length : GoInt64)));
	...
	public function new(?filename:GoString, ?header:stdgo.net.textproto.Textproto.MIMEHeader, ?size:GoInt64, ?_content:Slice<GoUInt8>, ?_tmpfile:GoString)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_sectionReadCloser {
	...
	public function new(?sectionReader:Pointer<stdgo.io.Io.SectionReader>)
		stdgo.internal.Macro.initLocals();
	...
	public function read(_p:Slice<GoUInt8>):{var _0:GoInt; var _1:stdgo.Error;}
		return sectionReader.read(_0);

	public function readAt(_p:Slice<GoUInt8>, _off:GoInt64):{var _0:GoInt; var _1:stdgo.Error;}
		return sectionReader.readAt(_0, _1);

	public function seek(_offset:GoInt64, _whence:GoInt):{var _0:(GoInt64, GoInt) -> {
		var _0:GoInt64;
		var _1:stdgo.Error;
	}; var _1:(GoInt64, GoInt) -> {
		var _0:GoInt64;
		var _1:stdgo.Error;
		};}
		return sectionReader.seek(_0, _1);
...
@:structInit class Part {
	...
	public function _populateHeaders():Error {
		...
		var __tmp__ = _r.value.readMIMEHeader(),
			_header:stdgo.net.textproto.Textproto.MIMEHeader = __tmp__._0,
	...
	public var _dispositionParams:GoMap<GoString, GoString> = new GoMap<GoString,
	...
	public function new(?header:stdgo.net.textproto.Textproto.MIMEHeader, ?_mr:Pointer<Reader>, ?_disposition:GoString,
			?_dispositionParams:GoMap<GoString, GoString>, ?_r:stdgo.io.Io.Reader, ?_n:GoInt, ?_total:GoInt64, ?_err:stdgo.Error, ?_readErr:stdgo.Error)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(header) + " " + Go.string(_mr) + " " + Go.string(_disposition) + " " + Go.string(_dispositionParams) + " " + Go.string(_r)
			+ " " + Go.string(_n) + " " + Go.string(_total) + " " + Go.string(_err) + " " + Go.string(_readErr) + "}";
	}
...
@:structInit class T_stickyErrorReader {
	...
	public function new(?_r:stdgo.io.Io.Reader, ?_err:stdgo.Error)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_partReader {
	public function read(_d:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
		...
		while (_p.value._n == ((0 : GoInt)) && _p.value._err == null) {
			var __tmp__ = _br.value.peek(_br.value.buffered()),
				_peek:Slice<GoUInt8> = __tmp__._0,
				_:stdgo.Error = __tmp__._1;
			{
				var __tmp__ = _scanUntilBoundary(_peek, _p.value._mr.value._dashBoundary, _p.value._mr.value._nlDashBoundary, _p.value._total,
					_p.value._readErr);
	...
	public function new(?_p:Pointer<Part>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Reader {
	...
	public function _nextPart(_rawPart:Bool):{var _0:Pointer<Part>; var _1:Error;} {
		...
		while (true) {
			...
			if (_r.value._isBoundaryDelimiterLine(_line)) {
				_r.value._partsRead++;
				var __tmp__ = _newPart(_r, _rawPart),
					_bp:Pointer<Part> = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null) {
			...
			if (_expectNewPart) {
				return {_0: new Pointer<Part>().nil(), _1: stdgo.fmt.Fmt.errorf("multipart: expecting a new Part; got line %q",
	...
	public function _readForm(_maxMemory:GoInt64):{var _0:Pointer<Form>; var _1:Error;} {
		...
		var _0:Pointer<Form> = new Pointer<Form>().nil(),
			_err:Error = ((null : stdgo.Error));
		var _form:Pointer<Form> = Go.pointer(new Form(new GoMap<GoString,
			Slice<GoString>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
				stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind))))),
			new GoMap<GoString,
				Slice<Pointer<FileHeader>>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
				stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("FileHeader", [],
					stdgo.reflect.Reflect.GoType.named("FileHeader", [], stdgo.reflect.Reflect.GoType.structType([
						{
							name: "filename",
							embedded: false,
							tag: "",
		...
		try {
			...
			while (true) {
				var __tmp__ = _r.value.nextPart(),
					_p:Pointer<Part> = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				...
				if (_filename == (("" : GoString))) {
					var __tmp__ = stdgo.io.Io.copyN(Go.pointer(_b).value, _p.value, _maxValueBytes + ((1 : GoInt64))),
				...
				var _fh:Pointer<FileHeader> = Go.pointer((({
					filename: _filename,
					header: _p.value.header.__copy__(),
					size: 0,
					_content: new Slice<GoUInt8>().nil(),
					_tmpfile: ""
				} : FileHeader)));
				var __tmp__ = stdgo.io.Io.copyN(Go.pointer(_b).value, _p.value, _maxMemory + ((1 : GoInt64))),
					_n:GoInt64 = __tmp__._0,
					_err:stdgo.Error = __tmp__._1;
				if (_err != null && Go.toInterface(_err) != Go.toInterface(stdgo.io.Io.eof)) {
					{
				...
				if (_n > _maxMemory) {
					var __tmp__ = stdgo.os.Os.createTemp("", "multipart-"),
						_file:Pointer<stdgo.os.Os.File> = __tmp__._0,
						_err:stdgo.Error = __tmp__._1;
					if (_err != null) {
						{
							for (defer in deferstack) {
					...
					var __tmp__ = stdgo.io.Io.copy(_file.value, stdgo.io.Io.multiReader(Go.pointer(_b).value, _p.value)),
	...
	public function new(?_bufReader:Pointer<bufio.Bufio.Reader>, ?_currentPart:Pointer<Part>, ?_partsRead:GoInt, ?_nl:Slice<GoUInt8>,
			?_nlDashBoundary:Slice<GoUInt8>, ?_dashBoundaryDash:Slice<GoUInt8>, ?_dashBoundary:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_bufReader) + " " + Go.string(_currentPart) + " " + Go.string(_partsRead) + " " + Go.string(_nl) + " "
			+ Go.string(_nlDashBoundary) + " " + Go.string(_dashBoundaryDash) + " " + Go.string(_dashBoundary) + "}";
	}
...
@:structInit class Writer {
	...
	public function writeField(_fieldname:GoString, _value:GoString):Error {
		var _w = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _w.value.createFormField(_fieldname),
			_p:stdgo.io.Io.Writer = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return _err;
		};
	...
	public function createFormField(_fieldname:GoString):{var _0:stdgo.io.Io.Writer; var _1:Error;} {
		var _w = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _h:stdgo.net.textproto.Textproto.MIMEHeader = new stdgo.net.textproto.Textproto.MIMEHeader(new GoMap<GoString,
			Slice<GoString>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
	...
	public function createFormFile(_fieldname:GoString, _filename:GoString):{var _0:stdgo.io.Io.Writer; var _1:Error;} {
		...
		var _h:stdgo.net.textproto.Textproto.MIMEHeader = new stdgo.net.textproto.Textproto.MIMEHeader(new GoMap<GoString,
			Slice<GoString>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
			stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)))))).__copy__();
		_h.set("Content-Disposition",
			stdgo.fmt.Fmt.sprintf("form-data; name=\"%s\"; filename=\"%s\"", Go.toInterface(_escapeQuotes(_fieldname)),
				Go.toInterface(_escapeQuotes(_filename))));
	...
	public function createPart(_header:stdgo.net.textproto.Textproto.MIMEHeader):{var _0:stdgo.io.Io.Writer; var _1:Error;} {
		...
		var _keys:Slice<GoString> = new Slice<GoString>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) (("" : GoString))])
			.setCap((((_header.__t__ == null ? 0 : _header.__t__.length) : GoInt)).toBasic());
		...
		stdgo.fmt.Fmt.fprintf(Go.pointer(_b).value, "\r\n");
		var __tmp__ = stdgo.io.Io.copy(_w.value._w, Go.pointer(_b).value),
	...
	public function setBoundary(_boundary:GoString):Error {
		...
		for (_i => _b in _boundary) {
			if ((("A".code : GoRune)) <= _b
				...
				|| (("a".code : GoRune)) <= _b
					&& _b <= (("z".code : GoRune))
					|| (("0".code : GoRune)) <= _b && _b <= (("9".code : GoRune))) {
				continue;
			};
			if (_b == (("\'".code : GoRune)) || _b == (("(".code : GoRune)) || _b == ((")".code : GoRune)) || _b == (("+".code : GoRune))
				|| _b == (("_".code : GoRune)) || _b == ((",".code : GoRune)) || _b == (("-".code : GoRune)) || _b == ((".".code : GoRune))
	...
	public function new(?_w:stdgo.io.Io.Writer, ?_boundary:GoString, ?_lastpart:Pointer<T_part>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_part {
	...
	public function new(?_mw:Pointer<Writer>, ?_closed:Bool, ?_we:stdgo.Error)
		stdgo.internal.Macro.initLocals();
...
var _emptyParams:GoMap<GoString, GoString> = new GoMap<GoString,
	GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
...
function newReader(_r:stdgo.io.Io.Reader, _boundary:GoString):Pointer<Reader> {
	...
	return Go.pointer((({
		_bufReader: bufio.Bufio.newReaderSize(Go.pointer((({_r: _r, _err: ((null : stdgo.Error))} : T_stickyErrorReader))).value, _peekBufferSize),
		_nl: _b.__slice__(0, ((2 : GoInt))),
		_nlDashBoundary: _b.__slice__(0, _b.length - ((2 : GoInt))),
		_dashBoundaryDash: _b.__slice__(((2 : GoInt))),
		_dashBoundary: _b.__slice__(((2 : GoInt)), _b.length - ((2 : GoInt))),
		_currentPart: new Pointer<Part>().nil(),
		_partsRead: 0
	} : Reader)));
}

function _newPart(_mr:Pointer<Reader>, _rawPart:Bool):{var _0:Pointer<Part>; var _1:Error;} {
	var _bp:Pointer<Part> = Go.pointer((({
		header: new stdgo.net.textproto.Textproto.MIMEHeader(new GoMap<GoString,
			Slice<GoString>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
				stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)))))),
		_mr: _mr,
		_disposition: "",
		_dispositionParams: new GoMap<GoString,
			GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
				stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil(),
		_r: ((null : stdgo.io.Io.Reader)),
		_n: 0,
		_total: 0,
...
**/
function _scanUntilBoundary(_buf:Slice<GoByte>, _dashBoundary:Slice<GoByte>, _nlDashBoundary:Slice<GoByte>, _total:GoInt64,
		_readErr:Error):{var _0:GoInt; var _1:Error;} {
	if (_total == ((0 : GoInt64))) {
...
function _randomBoundary():GoString {
	...
	var __tmp__ = stdgo.io.Io.readFull(stdgo.crypto.rand.Rand.reader, _buf.__slice__(0)),
		_:GoInt = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
		throw _err;
...
class Form_extension_fields {
	public function removeAll(__tmp__):Error
		return __tmp__.removeAll();
}

class FileHeader_extension_fields {
	public function open(__tmp__):{var _0:File; var _1:Error;}
		return __tmp__.open();
}
...
class Part_extension_fields {
	public function formName(__tmp__):GoString
		return __tmp__.formName();

	public function fileName(__tmp__):GoString
		return __tmp__.fileName();

	public function _parseContentDisposition(__tmp__):Void
		__tmp__._parseContentDisposition();

	public function _populateHeaders(__tmp__):Error
		return __tmp__._populateHeaders();

	public function read(__tmp__, _d:Slice<GoByte>):{var _0:GoInt; var _1:Error;}
		return __tmp__.read(_d);
...
class Reader_extension_fields {
	public function readForm(__tmp__, _maxMemory:GoInt64):{var _0:Pointer<Form>; var _1:Error;}
		return __tmp__.readForm(_maxMemory);

	public function _readForm(__tmp__, _maxMemory:GoInt64):{var _0:Pointer<Form>; var _1:Error;}
		return __tmp__._readForm(_maxMemory);

	public function nextPart(__tmp__):{var _0:Pointer<Part>; var _1:Error;}
		return __tmp__.nextPart();

	public function nextRawPart(__tmp__):{var _0:Pointer<Part>; var _1:Error;}
		return __tmp__.nextRawPart();

	public function _nextPart(__tmp__, _rawPart:Bool):{var _0:Pointer<Part>; var _1:Error;}
		return __tmp__._nextPart(_rawPart);

	public function _isFinalBoundary(__tmp__, _line:Slice<GoByte>):Bool
		return __tmp__._isFinalBoundary(_line);

	public function _isBoundaryDelimiterLine(__tmp__, _line:Slice<GoByte>):Bool
		return __tmp__._isBoundaryDelimiterLine(_line);
}

class Writer_extension_fields {
	public function boundary(__tmp__):GoString
		return __tmp__.boundary();

	public function setBoundary(__tmp__, _boundary:GoString):Error
		return __tmp__.setBoundary(_boundary);

	public function formDataContentType(__tmp__):GoString
		return __tmp__.formDataContentType();

	public function createPart(__tmp__, _header:stdgo.net.textproto.Textproto.MIMEHeader):{var _0:stdgo.io.Io.Writer; var _1:Error;}
		return __tmp__.createPart(_header);

	public function createFormFile(__tmp__, _fieldname:GoString, _filename:GoString):{var _0:stdgo.io.Io.Writer; var _1:Error;}
		return __tmp__.createFormFile(_fieldname, _filename);

	public function createFormField(__tmp__, _fieldname:GoString):{var _0:stdgo.io.Io.Writer; var _1:Error;}
		return __tmp__.createFormField(_fieldname);

	public function writeField(__tmp__, _fieldname:GoString, _value:GoString):Error
		return __tmp__.writeField(_fieldname, _value);
...
class T_part_extension_fields {
	...
	public function write(__tmp__, _d:Slice<GoByte>):{var _0:GoInt; var _1:Error;}
		return __tmp__.write(_d);
}
