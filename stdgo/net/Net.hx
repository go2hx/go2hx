...
@:named class T_addrinfoErrno {
    ...
    public function __copy__() return new T_addrinfoErrno(__t__);
}
@:structInit class Dialer {
    public function dialContext(_ctx:stdgo.context.Context.Context, _network:GoString, _address:GoString):{ var _0 : Conn; var _1 : Error; } {
        ...
        try {
            if (!_deadline.isZero()) {
                {
                    var __tmp__ = _ctx.deadline(), _d:stdgo.time.Time.Time = __tmp__._0, _ok:Bool = __tmp__._1;
                    if (!_ok || _deadline.before(_d.__copy__())) {
                        var __tmp__ = stdgo.context.Context.withDeadline(_ctx, _deadline.__copy__()), _subCtx:stdgo.context.Context.Context = __tmp__._0, _cancel:stdgo.context.Context.CancelFunc = __tmp__._1;
            ...
            };
            {
                ...
                if (_oldCancel != null && !_oldCancel.isNil()) {
                    var __tmp__ = stdgo.context.Context.withCancel(_ctx), _subCtx:stdgo.context.Context.Context = __tmp__._0, _cancel:stdgo.context.Context.CancelFunc = __tmp__._1;
                    deferstack.unshift(() -> _cancel.__t__());
                    Go.routine({
                        var a = function():Void {
                            {
            ...
            {
                var __tmp__ = try {
                    { value : ((_ctx.value(Go.toInterface(new internal.nettrace.Nettrace.TraceKey().__copy__())).value : Pointer<internal.nettrace.Nettrace.Trace>)), ok : true };
                } catch(_) {
                ...
                if (_trace != null && !_trace.isNil()) {
                    ...
                    _resolveCtx = stdgo.context.Context.withValue(_resolveCtx, Go.toInterface(new internal.nettrace.Nettrace.TraceKey().__copy__()), Go.toInterface(Go.pointer(_shadow)));
                };
            };
            var __tmp__ = _d.value._resolver().value._resolveAddrList(_resolveCtx, "dial", _network, _address, _d.value.localAddr), _addrs:T_addrList = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                {
                    for (defer in deferstack) {
                        defer();
                    };
                    return { _0 : ((null : Conn)), _1 : Go.pointer((({ op : "dial", net : _network, source : ((null : Addr)), addr : ((null : Addr)), err : _err } : OpError))).value };
                };
            };
            var _sd:Pointer<T_sysDialer> = Go.pointer((({ dialer : _d.value.__copy__(), _network : _network, _address : _address } : T_sysDialer)));
            var _primaries:T_addrList = new T_addrList(), _fallbacks:T_addrList = new T_addrList();
    ...
    public function new(?timeout:stdgo.time.Time.Duration, ?deadline:stdgo.time.Time.Time, ?localAddr:Addr, ?dualStack:Bool, ?fallbackDelay:stdgo.time.Time.Duration, ?keepAlive:stdgo.time.Time.Duration, ?resolver:Pointer<Resolver>, ?cancel:Chan<{ }>, ?control:(GoString, GoString, stdgo.syscall.Syscall.RawConn) -> stdgo.Error) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(timeout) + " " + Go.string(deadline) + " " + Go.string(localAddr) + " " + Go.string(dualStack) + " " + Go.string(fallbackDelay) + " " + Go.string(keepAlive) + " " + Go.string(resolver) + " " + Go.string(cancel) + " " + Go.string(control) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
...
@:structInit class T_sysDialer {
    public function _dialUnix(_ctx:stdgo.context.Context.Context, _laddr:Pointer<UnixAddr>, _raddr:Pointer<UnixAddr>):{ var _0 : Pointer<UnixConn>; var _1 : Error; } {
        var _sd = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _unixSocket(_ctx, _sd.value._network, _laddr.value, _raddr.value, "dial", _sd.value.dialer.control), _fd:Pointer<T_netFD> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
    ...
    public function _dialUDP(_ctx:stdgo.context.Context.Context, _laddr:Pointer<UDPAddr>, _raddr:Pointer<UDPAddr>):{ var _0 : Pointer<UDPConn>; var _1 : Error; } {
        var _sd = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _internetSocket(_ctx, _sd.value._network, _laddr.value, _raddr.value, stdgo.syscall.Syscall.sock_DGRAM, ((0 : GoInt)), "dial", _sd.value.dialer.control), _fd:Pointer<T_netFD> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
    ...
    public function _doDialTCP(_ctx:stdgo.context.Context.Context, _laddr:Pointer<TCPAddr>, _raddr:Pointer<TCPAddr>):{ var _0 : Pointer<TCPConn>; var _1 : Error; } {
        var _sd = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _internetSocket(_ctx, _sd.value._network, _laddr.value, _raddr.value, stdgo.syscall.Syscall.sock_STREAM, ((0 : GoInt)), "dial", _sd.value.dialer.control), _fd:Pointer<T_netFD> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        {
            var _i:GoInt = ((0 : GoInt));
            Go.cfor(_i < ((2 : GoInt)) && (_laddr == null || _laddr.isNil() || _laddr.value.port == ((0 : GoInt))) && (_selfConnect(_fd, _err) || _spuriousENOTAVAIL(_err)), _i++, {
                if (_err == null) {
                    _fd.value.close();
                };
                {
                    var __tmp__ = _internetSocket(_ctx, _sd.value._network, _laddr.value, _raddr.value, stdgo.syscall.Syscall.sock_STREAM, ((0 : GoInt)), "dial", _sd.value.dialer.control);
                    _fd = __tmp__._0;
                    _err = __tmp__._1;
                };
            });
    ...
    public function _dialIP(_ctx:stdgo.context.Context.Context, _laddr:Pointer<IPAddr>, _raddr:Pointer<IPAddr>):{ var _0 : Pointer<IPConn>; var _1 : Error; } {
        var _sd = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _parseNetwork(_ctx, _sd.value._network, true), _network:GoString = __tmp__._0, _proto:GoInt = __tmp__._1, _err:stdgo.Error = __tmp__._2;
        if (_err != null) {
        ...
        var __tmp__ = _internetSocket(_ctx, _network, _laddr.value, _raddr.value, stdgo.syscall.Syscall.sock_RAW, _proto, "dial", _sd.value.dialer.control), _fd:Pointer<T_netFD> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<IPConn>().nil(), _1 : _err };
        };
        ...
        try {
            ...
            if (Go.assertable(((_ra : Pointer<TCPAddr>)))) {
                ...
                var _ra:Addr = _ra == null ? null : _ra.__underlying__() == null ? null : _ra == null ? null : _ra.__underlying__().value;
                {
                    ...
                    return { _0 : ((null : Conn)), _1 : Go.pointer((({ op : "dial", net : _sd.value._network, source : _la, addr : _ra, err : Go.pointer((({ err : "unexpected address type", addr : _sd.value._address } : AddrError))).value } : OpError))).value };
                };
            };
            if (_err != null) {
                {
                    ...
                    return { _0 : ((null : Conn)), _1 : Go.pointer((({ op : "dial", net : _sd.value._network, source : _la, addr : _ra, err : _err } : OpError))).value };
                };
            };
            {
                for (defer in deferstack) {
    ...
    public function _dialSerial(_ctx:stdgo.context.Context.Context, _ras:T_addrList):{ var _0 : Conn; var _1 : Error; } {
        ...
        var _firstErr:Error = ((null : stdgo.Error));
        {
            ...
            for (_obj in _ras.__t__.keyValueIterator()) {
                ...
                _ra = _obj.value;
                {
                    {
                        _ctx.done().get();
                        return { _0 : ((null : Conn)), _1 : Go.pointer((({ op : "dial", net : _sd.value._network, source : _sd.value.dialer.localAddr, addr : _ra, err : _mapErr(_ctx.err()) } : OpError))).value };
                    };
                    null;
                };
                var _dialCtx:stdgo.context.Context.Context = _ctx;
                {
                    var __tmp__ = _ctx.deadline(), _deadline:stdgo.time.Time.Time = __tmp__._0, _hasDeadline:Bool = __tmp__._1;
                    if (_hasDeadline) {
                        var __tmp__ = _partialDeadline(stdgo.time.Time.now().__copy__(), _deadline.__copy__(), _ras.__t__.length - _i), _partialDeadline:stdgo.time.Time.Time = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                        if (_err != null) {
                            if (_firstErr == null) {
                                _firstErr = Go.pointer((({ op : "dial", net : _sd.value._network, source : _sd.value.dialer.localAddr, addr : _ra, err : _err } : OpError))).value;
                            };
                            break;
                        };
                ...
                var __tmp__ = _sd.value._dialSingle(_dialCtx, _ra), _c:Conn = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err == null) {
                    {
                        for (defer in deferstack) {
                            defer();
        ...
        try {
            if (_firstErr == null) {
                _firstErr = Go.pointer((({ op : "dial", net : _sd.value._network, source : ((null : Addr)), addr : ((null : Addr)), err : _errMissingAddress } : OpError))).value;
            };
            {
                for (defer in deferstack) {
                    defer();
    ...
    public function _dialParallel(_ctx:stdgo.context.Context.Context, _primaries:T_addrList, _fallbacks:T_addrList):{ var _0 : Conn; var _1 : Error; } {
        ...
        try {
            ...
            var _startRacer:(stdgo.context.Context.Context, Bool) -> Void = function(_ctx:stdgo.context.Context.Context, _primary:Bool):Void {
                ...
                {
                    _results.send((({ conn : _c, _error : _err, _primary : _primary, _done : true } : T_dialResult__dialParallel_0)));
                    {
                        _returned.get();
                        if (_c != null) {
                            _c.close();
            ...
            var _primary:T_dialResult__dialParallel_0 = new T_dialResult__dialParallel_0(), _fallback:T_dialResult__dialParallel_0 = new T_dialResult__dialParallel_0();
            var __tmp__ = stdgo.context.Context.withCancel(_ctx), _primaryCtx:stdgo.context.Context.Context = __tmp__._0, _primaryCancel:stdgo.context.Context.CancelFunc = __tmp__._1;
                ...
                {
                    {
                        ...
                        var __tmp__ = stdgo.context.Context.withCancel(_ctx), _fallbackCtx:stdgo.context.Context.Context = __tmp__._0, _fallbackCancel:stdgo.context.Context.CancelFunc = __tmp__._1;
    ...
    public function new(?dialer:Dialer, ?_network:GoString, ?_address:GoString) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(dialer) + " " + Go.string(_network) + " " + Go.string(_address) + "}";
    }
    public function dial(_network:GoString, _address:GoString):{ var _0 : (GoString, GoString) -> { var _0 : Conn; var _1 : stdgo.Error; }; var _1 : (GoString, GoString) -> { var _0 : Conn; var _1 : stdgo.Error; }; } return dialer.dial(_0, _1);
    public function dialContext(_ctx:stdgo.context.Context.Context, _network:GoString, _address:GoString):{ var _0 : (stdgo.context.Context.Context, GoString, GoString) -> { var _0 : Conn; var _1 : stdgo.Error; }; var _1 : (stdgo.context.Context.Context, GoString, GoString) -> { var _0 : Conn; var _1 : stdgo.Error; }; } return dialer.dialContext(_0, _1, _2);
    public function _deadline(_ctx:stdgo.context.Context.Context, _now:stdgo.time.Time.Time):stdgo.time.Time.Time return dialer._deadline(_0, _1);
    public function _dualStack():Bool return dialer._dualStack();
    public function _fallbackDelay():stdgo.time.Time.Duration return dialer._fallbackDelay();
    public function _resolver():Pointer<Resolver> return dialer._resolver();
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class ListenConfig {
    public function listenPacket(_ctx:stdgo.context.Context.Context, _network:GoString, _address:GoString):{ var _0 : PacketConn; var _1 : Error; } {
        ...
        var __tmp__ = defaultResolver.value._resolveAddrList(_ctx, "listen", _network, _address, ((null : Addr))), _addrs:T_addrList = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : ((null : PacketConn)), _1 : Go.pointer((({ op : "listen", net : _network, source : ((null : Addr)), addr : ((null : Addr)), err : _err } : OpError))).value };
        };
        ...
        if (Go.assertable(((_la : Pointer<UDPAddr>)))) {
            ...
            return { _0 : ((null : PacketConn)), _1 : Go.pointer((({ op : "listen", net : _sl.value._network, source : ((null : Addr)), addr : _la, err : Go.pointer((({ err : "unexpected address type", addr : _address } : AddrError))).value } : OpError))).value };
        };
        if (_err != null) {
            return { _0 : ((null : PacketConn)), _1 : Go.pointer((({ op : "listen", net : _sl.value._network, source : ((null : Addr)), addr : _la, err : _err } : OpError))).value };
        };
        return { _0 : _c, _1 : ((null : stdgo.Error)) };
    }
    public function listen(_ctx:stdgo.context.Context.Context, _network:GoString, _address:GoString):{ var _0 : Listener; var _1 : Error; } {
        ...
        var __tmp__ = defaultResolver.value._resolveAddrList(_ctx, "listen", _network, _address, ((null : Addr))), _addrs:T_addrList = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : ((null : Listener)), _1 : Go.pointer((({ op : "listen", net : _network, source : ((null : Addr)), addr : ((null : Addr)), err : _err } : OpError))).value };
        };
        var _sl:Pointer<T_sysListener> = Go.pointer((({ listenConfig : _lc.value.__copy__(), _network : _network, _address : _address } : T_sysListener)));
        ...
        if (Go.assertable(((_la : Pointer<TCPAddr>)))) {
            ...
            var _la:Addr = _la == null ? null : _la.__underlying__() == null ? null : _la == null ? null : _la.__underlying__().value;
            return { _0 : ((null : Listener)), _1 : Go.pointer((({ op : "listen", net : _sl.value._network, source : ((null : Addr)), addr : _la, err : Go.pointer((({ err : "unexpected address type", addr : _address } : AddrError))).value } : OpError))).value };
        };
        if (_err != null) {
            return { _0 : ((null : Listener)), _1 : Go.pointer((({ op : "listen", net : _sl.value._network, source : ((null : Addr)), addr : _la, err : _err } : OpError))).value };
        };
        return { _0 : _l, _1 : ((null : stdgo.Error)) };
    }
    public var control : (GoString, GoString, stdgo.syscall.Syscall.RawConn) -> stdgo.Error = null;
    public var keepAlive : stdgo.time.Time.Duration = new stdgo.time.Time.Duration();
    public function new(?control:(GoString, GoString, stdgo.syscall.Syscall.RawConn) -> stdgo.Error, ?keepAlive:stdgo.time.Time.Duration) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_sysListener {
    public function _listenUnixgram(_ctx:stdgo.context.Context.Context, _laddr:Pointer<UnixAddr>):{ var _0 : Pointer<UnixConn>; var _1 : Error; } {
        ...
        var __tmp__ = _unixSocket(_ctx, _sl.value._network, _laddr.value, ((null : T_sockaddr)), "listen", _sl.value.listenConfig.control), _fd:Pointer<T_netFD> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<UnixConn>().nil(), _1 : _err };
        };
        return { _0 : _newUnixConn(_fd), _1 : ((null : stdgo.Error)) };
    ...
    public function _listenUnix(_ctx:stdgo.context.Context.Context, _laddr:Pointer<UnixAddr>):{ var _0 : Pointer<UnixListener>; var _1 : Error; } {
        ...
        return { _0 : Go.pointer((({ _fd : _fd, _path : _fd.value._laddr.toString(), _unlink : true, _unlinkOnce : new stdgo.sync.Sync.Once() } : UnixListener))), _1 : ((null : stdgo.Error)) };
    }
    public function _listenMulticastUDP(_ctx:stdgo.context.Context.Context, _ifi:Pointer<Interface>, _gaddr:Pointer<UDPAddr>):{ var _0 : Pointer<UDPConn>; var _1 : Error; } {
        var _sl = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _internetSocket(_ctx, _sl.value._network, _gaddr.value, ((null : T_sockaddr)), stdgo.syscall.Syscall.sock_DGRAM, ((0 : GoInt)), "listen", _sl.value.listenConfig.control), _fd:Pointer<T_netFD> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<UDPConn>().nil(), _1 : _err };
        };
    ...
    public function _listenUDP(_ctx:stdgo.context.Context.Context, _laddr:Pointer<UDPAddr>):{ var _0 : Pointer<UDPConn>; var _1 : Error; } {
        var _sl = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _internetSocket(_ctx, _sl.value._network, _laddr.value, ((null : T_sockaddr)), stdgo.syscall.Syscall.sock_DGRAM, ((0 : GoInt)), "listen", _sl.value.listenConfig.control), _fd:Pointer<T_netFD> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<UDPConn>().nil(), _1 : _err };
        };
        return { _0 : _newUDPConn(_fd), _1 : ((null : stdgo.Error)) };
    ...
    public function _listenTCP(_ctx:stdgo.context.Context.Context, _laddr:Pointer<TCPAddr>):{ var _0 : Pointer<TCPListener>; var _1 : Error; } {
        var _sl = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _internetSocket(_ctx, _sl.value._network, _laddr.value, ((null : T_sockaddr)), stdgo.syscall.Syscall.sock_STREAM, ((0 : GoInt)), "listen", _sl.value.listenConfig.control), _fd:Pointer<T_netFD> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
    ...
    public function _listenIP(_ctx:stdgo.context.Context.Context, _laddr:Pointer<IPAddr>):{ var _0 : Pointer<IPConn>; var _1 : Error; } {
        var _sl = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _parseNetwork(_ctx, _sl.value._network, true), _network:GoString = __tmp__._0, _proto:GoInt = __tmp__._1, _err:stdgo.Error = __tmp__._2;
        if (_err != null) {
            return { _0 : new Pointer<IPConn>().nil(), _1 : _err };
        };
        if (_network == (("ip" : GoString)) || _network == (("ip4" : GoString)) || _network == (("ip6" : GoString))) {} else {
        ...
        var __tmp__ = _internetSocket(_ctx, _network, _laddr.value, ((null : T_sockaddr)), stdgo.syscall.Syscall.sock_RAW, _proto, "listen", _sl.value.listenConfig.control), _fd:Pointer<T_netFD> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<IPConn>().nil(), _1 : _err };
        };
        return { _0 : _newIPConn(_fd), _1 : ((null : stdgo.Error)) };
    ...
    public var _network : GoString = (("" : GoString));
    public var _address : GoString = (("" : GoString));
    public function new(?listenConfig:ListenConfig, ?_network:GoString, ?_address:GoString) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(listenConfig) + " " + Go.string(_network) + " " + Go.string(_address) + "}";
    }
    public function listen(_ctx:stdgo.context.Context.Context, _network:GoString, _address:GoString):{ var _0 : (stdgo.context.Context.Context, GoString, GoString) -> { var _0 : Listener; var _1 : stdgo.Error; }; var _1 : (stdgo.context.Context.Context, GoString, GoString) -> { var _0 : Listener; var _1 : stdgo.Error; }; } return listenConfig.listen(_0, _1, _2);
    public function listenPacket(_ctx:stdgo.context.Context.Context, _network:GoString, _address:GoString):{ var _0 : (stdgo.context.Context.Context, GoString, GoString) -> { var _0 : PacketConn; var _1 : stdgo.Error; }; var _1 : (stdgo.context.Context.Context, GoString, GoString) -> { var _0 : PacketConn; var _1 : stdgo.Error; }; } return listenConfig.listenPacket(_0, _1, _2);
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class SRV {
    ...
    public function new(?target:GoString, ?port:GoUInt16, ?priority:GoUInt16, ?weight:GoUInt16) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:named class T_byPriorityWeight {
    ...
    public function less(_i:GoInt, _j:GoInt):Bool {
        var _s = this.__copy__();
        return _s.__t__[_i].value.priority < _s.__t__[_j].value.priority || (_s.__t__[_i].value.priority == _s.__t__[_j].value.priority && _s.__t__[_i].value.weight < _s.__t__[_j].value.weight);
    }
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new T_byPriorityWeight(__t__);
    public function __append__(args:haxe.Rest<Pointer<SRV>>) return new T_byPriorityWeight(this.__t__.__append__(...args));
    public function __slice__(low:GoInt, high:GoInt = -1) return new T_byPriorityWeight(this.__t__.__slice__(low, high));
}
@:structInit class MX {
    public var host : GoString = (("" : GoString));
    public var pref : GoUInt16 = ((0 : GoUInt16));
    public function new(?host:GoString, ?pref:GoUInt16) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:named class T_byPref {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new T_byPref(__t__);
    public function __append__(args:haxe.Rest<Pointer<MX>>) return new T_byPref(this.__t__.__append__(...args));
    public function __slice__(low:GoInt, high:GoInt = -1) return new T_byPref(this.__t__.__slice__(low, high));
}
@:structInit class NS {
    public var host : GoString = (("" : GoString));
...
@:named class T_fileAddr {
    ...
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() return new T_fileAddr(__t__);
}
@:structInit class Interface {
    public function multicastAddrs():{ var _0 : Slice<Addr>; var _1 : Error; } {
        ...
        if (_ifi == null || _ifi.isNil()) {
            return { _0 : new Slice<Addr>().nil(), _1 : Go.pointer((({ op : "route", net : "ip+net", source : ((null : Addr)), addr : ((null : Addr)), err : _errInvalidInterface } : OpError))).value };
        };
        var __tmp__ = _interfaceMulticastAddrTable(_ifi), _ifat:Slice<Addr> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _err = Go.pointer((({ op : "route", net : "ip+net", source : ((null : Addr)), addr : ((null : Addr)), err : _err } : OpError))).value;
        };
    ...
    public function addrs():{ var _0 : Slice<Addr>; var _1 : Error; } {
        ...
        var __tmp__ = _interfaceAddrTable(_ifi), _ifat:Slice<Addr> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _err = Go.pointer((({ op : "route", net : "ip+net", source : ((null : Addr)), addr : ((null : Addr)), err : _err } : OpError))).value;
        };
        return { _0 : _ifat, _1 : _err };
    ...
    public function new(?index:GoInt, ?mtu:GoInt, ?name:GoString, ?hardwareAddr:HardwareAddr, ?flags:Flags) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(index) + " " + Go.string(mtu) + " " + Go.string(name) + " " + Go.string(hardwareAddr) + " " + Go.string(flags) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:named class Flags {
    ...
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() return new Flags(__t__);
}
@:structInit class T_ipv6ZoneCache {
    public function _index(_name:GoString):GoInt {
        ...
        _zoneCache.rlock();
        var __tmp__ = _zoneCache._toIndex.exists(_name) ? { value : _zoneCache._toIndex[_name], ok : true } : { value : _zoneCache._toIndex.defaultValue(), ok : false }, _index:GoInt = __tmp__.value, _ok:Bool = __tmp__.ok;
        _zoneCache.runlock();
        if (!_ok && !_updated) {
            _zoneCache._update(new Slice<Interface>().nil(), true);
            _zoneCache.rlock();
            {
                var __tmp__ = _zoneCache._toIndex.exists(_name) ? { value : _zoneCache._toIndex[_name], ok : true } : { value : _zoneCache._toIndex.defaultValue(), ok : false };
    ...
    public function _name(_index:GoInt):GoString {
        ...
        var _updated:Bool = _zoneCache._update(new Slice<Interface>().nil(), false);
        _zoneCache.rlock();
        var __tmp__ = _zoneCache._toName.exists(_index) ? { value : _zoneCache._toName[_index], ok : true } : { value : _zoneCache._toName.defaultValue(), ok : false }, _name:GoString = __tmp__.value, _ok:Bool = __tmp__.ok;
        _zoneCache.runlock();
        if (!_ok && !_updated) {
            _zoneCache._update(new Slice<Interface>().nil(), true);
            _zoneCache.rlock();
    ...
    public function _update(_ift:Slice<Interface>, _force:Bool):Bool {
        ...
        try {
            ...
            if (!_force && _zc.value._lastFetched.after(_now.add(new stdgo.time.Time.Duration(-((60 : GoUnTypedInt)) * stdgo.time.Time.second.__t__)).__copy__())) {
                {
                    for (defer in deferstack) {
                        defer();
                    };
            ...
            _zc.value._toIndex = new GoMap<GoString, GoInt>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.basic(int_kind))));
            _zc.value._toName = new GoMap<GoInt, GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(int_kind), stdgo.reflect.Reflect.GoType.basic(string_kind))));
            for (_ifi in _ift) {
                _zc.value._toIndex[_ifi.name] = _ifi.index;
                {
                    var __tmp__ = _zc.value._toName.exists(_ifi.index) ? { value : _zc.value._toName[_ifi.index], ok : true } : { value : _zc.value._toName.defaultValue(), ok : false }, _:GoString = __tmp__.value, _ok:Bool = __tmp__.ok;
                    if (!_ok) {
    ...
    public var _toIndex : GoMap<GoString, GoInt> = new GoMap<GoString, GoInt>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.basic(int_kind)))).nil();
    public var _toName : GoMap<GoInt, GoString> = new GoMap<GoInt, GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(int_kind), stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil();
    public function new(?rwmutex:stdgo.sync.Sync.RWMutex, ?_lastFetched:stdgo.time.Time.Time, ?_toIndex:GoMap<GoString, GoInt>, ?_toName:GoMap<GoInt, GoString>) stdgo.internal.Macro.initLocals();
    public function toString() {
    ...
    public function _rUnlockSlow(_r:GoInt32) rwmutex._rUnlockSlow(_0);
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:named class IP {
    public function _matchAddrFamily(_x:IP):Bool {
        ...
        return _ip.to4().__t__ != null && !_ip.to4().__t__.isNil() && _x.to4().__t__ != null && !_x.to4().__t__.isNil() || _ip.to16().__t__ != null && !_ip.to16().__t__.isNil() && _ip.to4().__t__ == null || _ip.to4().__t__.isNil() && _x.to16().__t__ != null && !_x.to16().__t__.isNil() && _x.to4().__t__ == null || _x.to4().__t__.isNil();
    }
    public function equal(_x:IP):Bool {
        ...
        if (_ip.__t__.length == ipv4len && _x.__t__.length == ipv6len) {
            return internal.bytealg.Bytealg.equal(_x.__slice__(((0 : GoInt)), ((12 : GoInt))).__copy__().__t__, _v4InV6Prefix) && internal.bytealg.Bytealg.equal(_ip.__copy__().__t__, _x.__slice__(((12 : GoInt))).__copy__().__t__);
        };
        if (_ip.__t__.length == ipv6len && _x.__t__.length == ipv4len) {
            return internal.bytealg.Bytealg.equal(_ip.__slice__(((0 : GoInt)), ((12 : GoInt))).__copy__().__t__, _v4InV6Prefix) && internal.bytealg.Bytealg.equal(_ip.__slice__(((12 : GoInt))).__copy__().__t__, _x.__copy__().__t__);
        };
        return false;
    }
    ...
    public function toString():GoString {
        ...
        var _b:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((_maxLen : GoInt)).toBasic());
        {
            var _i:GoInt = ((0 : GoInt));
            Go.cfor(_i < ipv6len, _i = _i + (((2 : GoInt))), {
                if (_i == _e0) {
    ...
    public function mask(_mask:IPMask):IP {
        ...
        if (_mask.__t__.length == ipv4len && _ip.__t__.length == ipv6len && internal.bytealg.Bytealg.equal(_ip.__slice__(0, ((12 : GoInt))).__copy__().__t__, _v4InV6Prefix)) {
    ...
    public function to4():IP {
        ...
        if (_ip.__t__.length == ipv6len && _isZeros(_ip.__slice__(((0 : GoInt)), ((10 : GoInt))).__copy__()) && _ip.__t__[((10 : GoInt))] == ((255 : GoUInt8)) && _ip.__t__[((11 : GoInt))] == ((255 : GoUInt8))) {
    ...
    public function isGlobalUnicast():Bool {
        var _ip = this.__copy__();
        return (_ip.__t__.length == ipv4len || _ip.__t__.length == ipv6len) && !_ip.equal(ipv4bcast.__copy__()) && !_ip.isUnspecified() && !_ip.isLoopback() && !_ip.isMulticast() && !_ip.isLinkLocalUnicast();
    }
    public function isLinkLocalUnicast():Bool {
        ...
        return _ip.__t__.length == ipv6len && _ip.__t__[((0 : GoInt))] == ((254 : GoUInt8)) && _ip.__t__[((1 : GoInt))] & ((192 : GoUInt8)) == ((128 : GoUInt8));
    }
    public function isLinkLocalMulticast():Bool {
        var _ip = this.__copy__();
        {
            var _ip4:IP = _ip.to4().__copy__();
            if (_ip4.__t__ != null && !_ip4.__t__.isNil()) {
                return _ip4.__t__[((0 : GoInt))] == ((224 : GoUInt8)) && _ip4.__t__[((1 : GoInt))] == ((0 : GoUInt8)) && _ip4.__t__[((2 : GoInt))] == ((0 : GoUInt8));
            };
        };
        return _ip.__t__.length == ipv6len && _ip.__t__[((0 : GoInt))] == ((255 : GoUInt8)) && _ip.__t__[((1 : GoInt))] & ((15 : GoUInt8)) == ((2 : GoUInt8));
    }
    public function isInterfaceLocalMulticast():Bool {
        var _ip = this.__copy__();
        return _ip.__t__.length == ipv6len && _ip.__t__[((0 : GoInt))] == ((255 : GoUInt8)) && _ip.__t__[((1 : GoInt))] & ((15 : GoUInt8)) == ((1 : GoUInt8));
    }
    ...
    public function isPrivate():Bool {
        var _ip = this.__copy__();
        {
            var _ip4:IP = _ip.to4().__copy__();
            if (_ip4.__t__ != null && !_ip4.__t__.isNil()) {
                return _ip4.__t__[((0 : GoInt))] == ((10 : GoUInt8)) || (_ip4.__t__[((0 : GoInt))] == ((172 : GoUInt8)) && _ip4.__t__[((1 : GoInt))] & ((240 : GoUInt8)) == ((16 : GoUInt8))) || (_ip4.__t__[((0 : GoInt))] == ((192 : GoUInt8)) && _ip4.__t__[((1 : GoInt))] == ((168 : GoUInt8)));
            };
        };
    ...
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() return new IP(__t__);
    public function __append__(args:haxe.Rest<GoUInt8>) return new IP(this.__t__.__append__(...args));
    public function __slice__(low:GoInt, high:GoInt = -1) return new IP(this.__t__.__slice__(low, high));
}
@:named class IPMask {
    public function toString():GoString {
    ...
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() return new IPMask(__t__);
    public function __append__(args:haxe.Rest<GoUInt8>) return new IPMask(this.__t__.__append__(...args));
    public function __slice__(low:GoInt, high:GoInt = -1) return new IPMask(this.__t__.__slice__(low, high));
}
@:structInit class IPNet {
    public function toString():GoString {
        var _n = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _networkNumberAndMask(_n), _nn:IP = __tmp__._0, _m:IPMask = __tmp__._1;
    ...
    public function new(?ip:IP, ?mask:IPMask) stdgo.internal.Macro.initLocals();
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class IPAddr {
    ...
    public function new(?ip:IP, ?zone:GoString) stdgo.internal.Macro.initLocals();
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class IPConn {
    public function _writeMsg(_b:Slice<GoByte>, _oob:Slice<GoByte>, _addr:Pointer<IPAddr>):{ var _0 : GoInt; var _1 : GoInt; var _2 : Error; } {
        ...
        var _n:GoInt = ((0 : GoInt)), _oobn:GoInt = ((0 : GoInt)), _err:Error = ((null : stdgo.Error));
        ...
        var __tmp__ = _addr.value._sockaddr(_c.value._conn._fd.value._family), _sa:stdgo.syscall.Syscall.Sockaddr = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
    ...
    public function _readMsg(_b:Slice<GoByte>, _oob:Slice<GoByte>):{ var _0 : GoInt; var _1 : GoInt; var _2 : GoInt; var _3 : Pointer<IPAddr>; var _4 : Error; } {
        var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _n:GoInt = ((0 : GoInt)), _oobn:GoInt = ((0 : GoInt)), _flags:GoInt = ((0 : GoInt)), _addr:Pointer<IPAddr> = new Pointer<IPAddr>().nil(), _err:Error = ((null : stdgo.Error));
        ...
        if (Go.assertable(((_sa : Pointer<stdgo.syscall.Syscall.SockaddrInet4>)))) {
            var _sa:Pointer<stdgo.syscall.Syscall.SockaddrInet4> = _sa == null ? null : _sa.__underlying__() == null ? null : _sa == null ? null : _sa.__underlying__().value;
            ...
            var _sa:Pointer<stdgo.syscall.Syscall.SockaddrInet6> = _sa == null ? null : _sa.__underlying__() == null ? null : _sa == null ? null : _sa.__underlying__().value;
    ...
    public function _readFrom(_b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Pointer<IPAddr>; var _2 : Error; } {
        ...
        var __tmp__ = _c.value._conn._fd.value._readFrom(_b), _n:GoInt = __tmp__._0, _sa:stdgo.syscall.Syscall.Sockaddr = __tmp__._1, _err:stdgo.Error = __tmp__._2;
        if (Go.assertable(((_sa : Pointer<stdgo.syscall.Syscall.SockaddrInet4>)))) {
            var _sa:Pointer<stdgo.syscall.Syscall.SockaddrInet4> = _sa == null ? null : _sa.__underlying__() == null ? null : _sa == null ? null : _sa.__underlying__().value;
            _addr = Go.pointer((({ ip : new IP(_sa.value.addr.__slice__(((0 : GoInt)))), zone : "" } : IPAddr)));
    ...
    public function writeMsgIP(_b:Slice<GoByte>, _oob:Slice<GoByte>, _addr:Pointer<IPAddr>):{ var _0 : GoInt; var _1 : GoInt; var _2 : Error; } {
        ...
        if (_err != null) {
            _err = Go.pointer((({ op : "write", net : _c.value._conn._fd.value._net, source : _c.value._conn._fd.value._laddr, addr : _addr.value._opAddr(), err : _err } : OpError))).value;
        };
    ...
    public function writeTo(_b:Slice<GoByte>, _addr:Addr):{ var _0 : GoInt; var _1 : Error; } {
        ...
        if (!_ok) {
            return { _0 : ((0 : GoInt)), _1 : Go.pointer((({ op : "write", net : _c.value._conn._fd.value._net, source : _c.value._conn._fd.value._laddr, addr : _addr, err : stdgo.syscall.Syscall.einval } : OpError))).value };
        };
        var __tmp__ = _c.value._writeTo(_b, _a), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _err = Go.pointer((({ op : "write", net : _c.value._conn._fd.value._net, source : _c.value._conn._fd.value._laddr, addr : _a.value._opAddr(), err : _err } : OpError))).value;
        };
    ...
    public function writeToIP(_b:Slice<GoByte>, _addr:Pointer<IPAddr>):{ var _0 : GoInt; var _1 : Error; } {
        ...
        var __tmp__ = _c.value._writeTo(_b, _addr), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _err = Go.pointer((({ op : "write", net : _c.value._conn._fd.value._net, source : _c.value._conn._fd.value._laddr, addr : _addr.value._opAddr(), err : _err } : OpError))).value;
        };
        return { _0 : _n, _1 : _err };
    }
    public function readMsgIP(_b:Slice<GoByte>, _oob:Slice<GoByte>):{ var _0 : GoInt; var _1 : GoInt; var _2 : GoInt; var _3 : Pointer<IPAddr>; var _4 : Error; } {
        var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _n:GoInt = ((0 : GoInt)), _oobn:GoInt = ((0 : GoInt)), _flags:GoInt = ((0 : GoInt)), _addr:Pointer<IPAddr> = new Pointer<IPAddr>().nil(), _err:Error = ((null : stdgo.Error));
        if (!_c.value._ok()) {
            return { _0 : ((0 : GoInt)), _1 : ((0 : GoInt)), _2 : ((0 : GoInt)), _3 : new Pointer<IPAddr>().nil(), _4 : stdgo.syscall.Syscall.einval };
        };
        {
        ...
        if (_err != null) {
            _err = Go.pointer((({ op : "read", net : _c.value._conn._fd.value._net, source : _c.value._conn._fd.value._laddr, addr : _c.value._conn._fd.value._raddr, err : _err } : OpError))).value;
        };
        return { _0 : _n, _1 : _oobn, _2 : _flags, _3 : _addr, _4 : _err };
    }
    public function readFrom(_b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Addr; var _2 : Error; } {
        ...
        var __tmp__ = _c.value._readFrom(_b), _n:GoInt = __tmp__._0, _addr:Pointer<IPAddr> = __tmp__._1, _err:stdgo.Error = __tmp__._2;
        if (_err != null) {
            _err = Go.pointer((({ op : "read", net : _c.value._conn._fd.value._net, source : _c.value._conn._fd.value._laddr, addr : _c.value._conn._fd.value._raddr, err : _err } : OpError))).value;
        };
        if (_addr == null || _addr.isNil()) {
    ...
    public function new(?_conn:T_conn) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_conn) + "}";
    }
    public function close():stdgo.Error return _conn.close();
    public function file():{ var _0 : Pointer<stdgo.os.Os.File>; var _1 : stdgo.Error; } return _conn.file();
    public function localAddr():Addr return _conn.localAddr();
    public function read(_b:Slice<GoUInt8>):{ var _0 : Slice<GoUInt8> -> { var _0 : GoInt; var _1 : stdgo.Error; }; var _1 : Slice<GoUInt8> -> { var _0 : GoInt; var _1 : stdgo.Error; }; } return _conn.read(_0);
    public function remoteAddr():Addr return _conn.remoteAddr();
    public function setDeadline(_t:stdgo.time.Time.Time):stdgo.Error return _conn.setDeadline(_0);
    public function setReadBuffer(_bytes:GoInt):stdgo.Error return _conn.setReadBuffer(_0);
    public function setReadDeadline(_t:stdgo.time.Time.Time):stdgo.Error return _conn.setReadDeadline(_0);
    public function setWriteBuffer(_bytes:GoInt):stdgo.Error return _conn.setWriteBuffer(_0);
    public function setWriteDeadline(_t:stdgo.time.Time.Time):stdgo.Error return _conn.setWriteDeadline(_0);
    public function write(_b:Slice<GoUInt8>):{ var _0 : Slice<GoUInt8> -> { var _0 : GoInt; var _1 : stdgo.Error; }; var _1 : Slice<GoUInt8> -> { var _0 : GoInt; var _1 : stdgo.Error; }; } return _conn.write(_0);
    public function _ok():Bool return _conn._ok();
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_ipStackCapabilities {
    public function _probe():Void {
        ...
        var deferstack:Array<Void -> Void> = [];
        try {
            var __tmp__ = _sysSocket(stdgo.syscall.Syscall.af_INET, stdgo.syscall.Syscall.sock_STREAM, stdgo.syscall.Syscall.ipproto_TCP), _s:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (Go.toInterface(_err) == Go.toInterface(stdgo.syscall.Syscall.eafnosupport.__t__) || Go.toInterface(_err) == Go.toInterface(stdgo.syscall.Syscall.eprotonosupport.__t__)) {} else if (_err == null) {
                internal.poll.Poll.closeFunc(_s);
                _p.value._ipv4Enabled = true;
            };
            var _probes:Slice<T__struct_46> = new Slice<T__struct_46>((({ _laddr : (({ ip : parseIP("::1").__copy__(), port : 0, zone : "" } : TCPAddr)).__copy__(), _value : ((1 : GoInt)) } : T__struct_46)).__copy__(), (({ _laddr : (({ ip : ipv4(((127 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((1 : GoUInt8))).__copy__(), port : 0, zone : "" } : TCPAddr)).__copy__(), _value : ((0 : GoInt)) } : T__struct_46)).__copy__());
            ...
            };
            {
                ...
                for (_obj in _probes.keyValueIterator()) {
                    _i = _obj.key;
                    var __tmp__ = _sysSocket(stdgo.syscall.Syscall.af_INET6, stdgo.syscall.Syscall.sock_STREAM, stdgo.syscall.Syscall.ipproto_TCP), _s:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                    if (_err != null) {
                        continue;
                    };
                    {
                    ...
                    var __tmp__ = _probes[_i]._laddr._sockaddr(stdgo.syscall.Syscall.af_INET6), _sa:stdgo.syscall.Syscall.Sockaddr = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                    if (_err != null) {
                        continue;
                    };
                    {
    ...
    public function new(?once:stdgo.sync.Sync.Once, ?_ipv4Enabled:Bool, ?_ipv6Enabled:Bool, ?_ipv4MappedIPv6Enabled:Bool) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(once) + " " + Go.string(_ipv4Enabled) + " " + Go.string(_ipv6Enabled) + " " + Go.string(_ipv4MappedIPv6Enabled) + "}";
    }
...
@:named class T_addrList {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new T_addrList(__t__);
    public function __append__(args:haxe.Rest<Addr>) return new T_addrList(this.__t__.__append__(...args));
    public function __slice__(low:GoInt, high:GoInt = -1) return new T_addrList(this.__t__.__slice__(low, high));
}
@:structInit class Resolver {
    public function _lookupAddr(_ctx:stdgo.context.Context.Context, _addr:GoString):{ var _0 : Slice<GoString>; var _1 : Error; } {
        var _ptrs:Slice<GoString> = new Slice<GoString>().nil(), _err:Error = ((null : stdgo.Error));
    ...
    public function _lookupTXT(_ctx:stdgo.context.Context.Context, _name:GoString):{ var _0 : Slice<GoString>; var _1 : Error; } {
        var _txts:Slice<GoString> = new Slice<GoString>().nil(), _err:Error = ((null : stdgo.Error));
        return { _0 : new Slice<GoString>().nil(), _1 : stdgo.syscall.Syscall.enoprotoopt };
    }
    public function _lookupNS(_ctx:stdgo.context.Context.Context, _name:GoString):{ var _0 : Slice<Pointer<NS>>; var _1 : Error; } {
        var _nss:Slice<Pointer<NS>> = new Slice<Pointer<NS>>().nil(), _err:Error = ((null : stdgo.Error));
    ...
    public function _lookupMX(_ctx:stdgo.context.Context.Context, _name:GoString):{ var _0 : Slice<Pointer<MX>>; var _1 : Error; } {
        var _mxs:Slice<Pointer<MX>> = new Slice<Pointer<MX>>().nil(), _err:Error = ((null : stdgo.Error));
        return { _0 : new Slice<Pointer<MX>>().nil(), _1 : stdgo.syscall.Syscall.enoprotoopt };
    }
    public function _lookupSRV(_ctx:stdgo.context.Context.Context, _service:GoString, _proto:GoString, _name:GoString):{ var _0 : GoString; var _1 : Slice<Pointer<SRV>>; var _2 : Error; } {
        var _cname:GoString = (("" : GoString)), _srvs:Slice<Pointer<SRV>> = new Slice<Pointer<SRV>>().nil(), _err:Error = ((null : stdgo.Error));
    ...
    public function _lookupCNAME(_ctx:stdgo.context.Context.Context, _name:GoString):{ var _0 : GoString; var _1 : Error; } {
        var _cname:GoString = (("" : GoString)), _err:Error = ((null : stdgo.Error));
    ...
    public function _lookupIP(_ctx:stdgo.context.Context.Context, _network:GoString, _host:GoString):{ var _0 : Slice<IPAddr>; var _1 : Error; } {
        var _addrs:Slice<IPAddr> = new Slice<IPAddr>().nil(), _err:Error = ((null : stdgo.Error));
    ...
    public function _lookupHost(_ctx:stdgo.context.Context.Context, _host:GoString):{ var _0 : Slice<GoString>; var _1 : Error; } {
        var _addrs:Slice<GoString> = new Slice<GoString>().nil(), _err:Error = ((null : stdgo.Error));
        return { _0 : new Slice<GoString>().nil(), _1 : stdgo.syscall.Syscall.enoprotoopt };
    }
    public function lookupAddr(_ctx:stdgo.context.Context.Context, _addr:GoString):{ var _0 : Slice<GoString>; var _1 : Error; } {
        ...
        var __tmp__ = _r.value._lookupAddr(_ctx, _addr), _names:Slice<GoString> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<GoString>().nil(), _1 : _err };
        };
        var _filteredNames:Slice<GoString> = new Slice<GoString>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) (("" : GoString))]).setCap(((_names.length : GoInt)).toBasic());
        for (_name in _names) {
        ...
        if (_names.length != _filteredNames.length) {
            return { _0 : _filteredNames, _1 : Go.pointer((({ err : _errMalformedDNSRecordsDetail, name : _addr, server : "", isTimeout : false, isTemporary : false, isNotFound : false } : DNSError))).value };
        };
    ...
    public function lookupNS(_ctx:stdgo.context.Context.Context, _name:GoString):{ var _0 : Slice<Pointer<NS>>; var _1 : Error; } {
        var _r = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _r.value._lookupNS(_ctx, _name), _records:Slice<Pointer<NS>> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<Pointer<NS>>().nil(), _1 : _err };
        };
        var _filteredNS:Slice<Pointer<NS>> = new Slice<Pointer<NS>>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) new Pointer<NS>().nil()]).setCap(((_records.length : GoInt)).toBasic());
        for (_ns in _records) {
        ...
        if (_records.length != _filteredNS.length) {
            return { _0 : _filteredNS, _1 : Go.pointer((({ err : _errMalformedDNSRecordsDetail, name : _name, server : "", isTimeout : false, isTemporary : false, isNotFound : false } : DNSError))).value };
        };
    ...
    public function lookupMX(_ctx:stdgo.context.Context.Context, _name:GoString):{ var _0 : Slice<Pointer<MX>>; var _1 : Error; } {
        var _r = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _r.value._lookupMX(_ctx, _name), _records:Slice<Pointer<MX>> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<Pointer<MX>>().nil(), _1 : _err };
        };
        var _filteredMX:Slice<Pointer<MX>> = new Slice<Pointer<MX>>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) new Pointer<MX>().nil()]).setCap(((_records.length : GoInt)).toBasic());
        for (_mx in _records) {
        ...
        if (_records.length != _filteredMX.length) {
            return { _0 : _filteredMX, _1 : Go.pointer((({ err : _errMalformedDNSRecordsDetail, name : _name, server : "", isTimeout : false, isTemporary : false, isNotFound : false } : DNSError))).value };
        };
        return { _0 : _filteredMX, _1 : ((null : stdgo.Error)) };
    }
    public function lookupSRV(_ctx:stdgo.context.Context.Context, _service:GoString, _proto:GoString, _name:GoString):{ var _0 : GoString; var _1 : Slice<Pointer<SRV>>; var _2 : Error; } {
        var _r = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _r.value._lookupSRV(_ctx, _service, _proto, _name), _cname:GoString = __tmp__._0, _addrs:Slice<Pointer<SRV>> = __tmp__._1, _err:stdgo.Error = __tmp__._2;
        if (_err != null) {
            return { _0 : "", _1 : new Slice<Pointer<SRV>>().nil(), _2 : _err };
        };
        if (_cname != (("" : GoString)) && !_isDomainName(_cname)) {
            return { _0 : "", _1 : new Slice<Pointer<SRV>>().nil(), _2 : Go.pointer((({ err : "SRV header name is invalid", name : _name, server : "", isTimeout : false, isTemporary : false, isNotFound : false } : DNSError))).value };
        };
        var _filteredAddrs:Slice<Pointer<SRV>> = new Slice<Pointer<SRV>>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) new Pointer<SRV>().nil()]).setCap(((_addrs.length : GoInt)).toBasic());
        for (_addr in _addrs) {
            if (_addr == null || _addr.isNil()) {
                continue;
            };
        ...
        if (_addrs.length != _filteredAddrs.length) {
            return { _0 : _cname, _1 : _filteredAddrs, _2 : Go.pointer((({ err : _errMalformedDNSRecordsDetail, name : _name, server : "", isTimeout : false, isTemporary : false, isNotFound : false } : DNSError))).value };
        };
    ...
    public function lookupCNAME(_ctx:stdgo.context.Context.Context, _host:GoString):{ var _0 : GoString; var _1 : Error; } {
        var _r = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _r.value._lookupCNAME(_ctx, _host), _cname:GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : "", _1 : _err };
        };
        if (!_isDomainName(_cname)) {
            return { _0 : "", _1 : Go.pointer((({ err : _errMalformedDNSRecordsDetail, name : _host, server : "", isTimeout : false, isTemporary : false, isNotFound : false } : DNSError))).value };
        };
    ...
    public function lookupPort(_ctx:stdgo.context.Context.Context, _network:GoString, _service:GoString):{ var _0 : GoInt; var _1 : Error; } {
        var _r = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _port:GoInt = ((0 : GoInt)), _err:Error = ((null : stdgo.Error));
        var __tmp__ = _parsePort(_service), _port:GoInt = __tmp__._0, _needsLookup:Bool = __tmp__._1;
        if (_needsLookup) {
            if (_network == (("tcp" : GoString)) || _network == (("tcp4" : GoString)) || _network == (("tcp6" : GoString)) || _network == (("udp" : GoString)) || _network == (("udp4" : GoString)) || _network == (("udp6" : GoString))) {} else if (_network == (("" : GoString))) {
                _network = "ip";
            } else {
    ...
    public function _lookupIPAddr(_ctx:stdgo.context.Context.Context, _network:GoString, _host:GoString):{ var _0 : Slice<IPAddr>; var _1 : Error; } {
        var _r = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        if (_host == (("" : GoString))) {
            return { _0 : new Slice<IPAddr>().nil(), _1 : Go.pointer((({ err : _errNoSuchHost.error(), name : _host, isNotFound : true, server : "", isTimeout : false, isTemporary : false } : DNSError))).value };
        };
        {
            var __tmp__ = _parseIPZone(_host), _ip:IP = __tmp__._0, _zone:GoString = __tmp__._1;
            if (_ip.__t__ != null && !_ip.__t__.isNil()) {
        ...
        var _resolverFunc:(stdgo.context.Context.Context, GoString, GoString) -> { var _0 : Slice<IPAddr>; var _1 : stdgo.Error; } = _r.value._lookupIP;
        {
            var __tmp__ = try {
                { value : ((_ctx.value(Go.toInterface(new internal.nettrace.Nettrace.LookupIPAltResolverKey().__copy__())).value : (stdgo.context.Context.Context, GoString, GoString) -> { var _0 : Slice<IPAddr>; var _1 : Error; })), ok : true };
            } catch(_) {
                { value : null, ok : false };
        ...
        var __tmp__ = stdgo.context.Context.withCancel(_withUnexpiredValuesPreserved(_ctx)), _lookupGroupCtx:stdgo.context.Context.Context = __tmp__._0, _lookupGroupCancel:stdgo.context.Context.CancelFunc = __tmp__._1;
        ...
        }), _ch:Chan<internal.singleflight.Singleflight.Result> = __tmp__._0, _called:Bool = __tmp__._1;
        if (!_called) {
            _dnsWaitGroup.done();
        };
        {
    ...
    public function lookupIP(_ctx:stdgo.context.Context.Context, _network:GoString, _host:GoString):{ var _0 : Slice<IP>; var _1 : Error; } {
        var _r = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _parseNetwork(_ctx, _network, false), _afnet:GoString = __tmp__._0, _:GoInt = __tmp__._1, _err:stdgo.Error = __tmp__._2;
        if (_err != null) {
        ...
        var __tmp__ = _r.value._internetAddrList(_ctx, _afnet, _host), _addrs:T_addrList = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<IP>().nil(), _1 : _err };
        };
    ...
    public function lookupHost(_ctx:stdgo.context.Context.Context, _host:GoString):{ var _0 : Slice<GoString>; var _1 : Error; } {
        ...
        var _addrs:Slice<GoString> = new Slice<GoString>().nil(), _err:Error = ((null : stdgo.Error));
        if (_host == (("" : GoString))) {
            return { _0 : new Slice<GoString>().nil(), _1 : Go.pointer((({ err : _errNoSuchHost.error(), name : _host, isNotFound : true, server : "", isTimeout : false, isTemporary : false } : DNSError))).value };
        };
        {
            var __tmp__ = _parseIPZone(_host), _ip:IP = __tmp__._0, _:GoString = __tmp__._1;
            if (_ip.__t__ != null && !_ip.__t__.isNil()) {
    ...
    public function _internetAddrList(_ctx:stdgo.context.Context.Context, _net:GoString, _addr:GoString):{ var _0 : T_addrList; var _1 : Error; } {
        var _r = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _err:Error = ((null : stdgo.Error)), _host:GoString = (("" : GoString)), _port:GoString = (("" : GoString)), _portnum:GoInt = ((0 : GoInt));
        if (_net == (("tcp" : GoString)) || _net == (("tcp4" : GoString)) || _net == (("tcp6" : GoString)) || _net == (("udp" : GoString)) || _net == (("udp4" : GoString)) || _net == (("udp6" : GoString))) {
            if (_addr != (("" : GoString))) {
                {
                    {
        ...
        var __tmp__ = _r.value._lookupIPAddr(_ctx, _net, _host), _ips:Slice<IPAddr> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new T_addrList(), _1 : _err };
        };
    ...
    public function _resolveAddrList(_ctx:stdgo.context.Context.Context, _op:GoString, _network:GoString, _addr:GoString, _hint:Addr):{ var _0 : T_addrList; var _1 : Error; } {
        var _r = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _parseNetwork(_ctx, _network, true), _afnet:GoString = __tmp__._0, _:GoInt = __tmp__._1, _err:stdgo.Error = __tmp__._2;
        if (_err != null) {
            return { _0 : new T_addrList(), _1 : _err };
        };
        ...
        if (_afnet == (("unix" : GoString)) || _afnet == (("unixgram" : GoString)) || _afnet == (("unixpacket" : GoString))) {
            var __tmp__ = resolveUnixAddr(_afnet, _addr), _addr:Pointer<UnixAddr> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return { _0 : new T_addrList(), _1 : _err };
            };
        ...
        var __tmp__ = _r.value._internetAddrList(_ctx, _afnet, _addr), _addrs:T_addrList = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null || _op != (("dial" : GoString)) || _hint == null) {
            return { _0 : _addrs.__copy__(), _1 : _err };
        };
        var _tcp:Pointer<TCPAddr> = new Pointer<TCPAddr>().nil(), _udp:Pointer<UDPAddr> = new Pointer<UDPAddr>().nil(), _ip:Pointer<IPAddr> = new Pointer<IPAddr>().nil(), _wildcard:Bool = false;
    ...
    public var dial : (stdgo.context.Context.Context, GoString, GoString) -> { var _0 : Conn; var _1 : stdgo.Error; } = null;
    public var _lookupGroup : internal.singleflight.Singleflight.Group = new internal.singleflight.Singleflight.Group();
    public function new(?preferGo:Bool, ?strictErrors:Bool, ?dial:(stdgo.context.Context.Context, GoString, GoString) -> { var _0 : Conn; var _1 : stdgo.Error; }, ?_lookupGroup:internal.singleflight.Singleflight.Group) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_onlyValuesCtx {
    ...
    public function new(?context:stdgo.context.Context.Context, ?_lookupValues:stdgo.context.Context.Context) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(context) + " " + Go.string(_lookupValues) + "}";
    }
    public function deadline():{ var _0 : stdgo.time.Time.Time; var _1 : Bool; } return context.deadline();
    public function done():Chan<{ }> return context.done();
    public function err():stdgo.Error return context.err();
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:named class HardwareAddr {
    public function toString():GoString {
        ...
        var _buf:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((_a.__t__.length * ((3 : GoInt)) - ((1 : GoInt)) : GoInt)).toBasic());
        {
            var _i;
            var _b;
    ...
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() return new HardwareAddr(__t__);
    public function __append__(args:haxe.Rest<GoUInt8>) return new HardwareAddr(this.__t__.__append__(...args));
    public function __slice__(low:GoInt, high:GoInt = -1) return new HardwareAddr(this.__t__.__slice__(low, high));
}
@:structInit class T_conn {
    public function file():{ var _0 : Pointer<stdgo.os.Os.File>; var _1 : Error; } {
        var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _f:Pointer<stdgo.os.Os.File> = new Pointer<stdgo.os.Os.File>().nil(), _err:Error = ((null : stdgo.Error));
        {
        ...
        if (_err != null) {
            _err = Go.pointer((({ op : "file", net : _c.value._fd.value._net, source : _c.value._fd.value._laddr, addr : _c.value._fd.value._raddr, err : _err } : OpError))).value;
        };
    ...
    public function setWriteBuffer(_bytes:GoInt):Error {
        ...
        };
        {
            ...
            if (_err != null) {
                return Go.pointer((({ op : "set", net : _c.value._fd.value._net, source : ((null : Addr)), addr : _c.value._fd.value._laddr, err : _err } : OpError))).value;
            };
        };
        return ((null : stdgo.Error));
    }
    ...
    public function close():Error {
        ...
        if (_err != null) {
            _err = Go.pointer((({ op : "close", net : _c.value._fd.value._net, source : _c.value._fd.value._laddr, addr : _c.value._fd.value._raddr, err : _err } : OpError))).value;
        };
        return _err;
    }
    public function write(_b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } {
        ...
        var __tmp__ = _c.value._fd.value.write(_b), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _err = Go.pointer((({ op : "write", net : _c.value._fd.value._net, source : _c.value._fd.value._laddr, addr : _c.value._fd.value._raddr, err : _err } : OpError))).value;
        };
        return { _0 : _n, _1 : _err };
    }
    public function read(_b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } {
        ...
        var __tmp__ = _c.value._fd.value.read(_b), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null && Go.toInterface(_err) != Go.toInterface(stdgo.io.Io.eof)) {
            _err = Go.pointer((({ op : "read", net : _c.value._fd.value._net, source : _c.value._fd.value._laddr, addr : _c.value._fd.value._raddr, err : _err } : OpError))).value;
        };
        return { _0 : _n, _1 : _err };
    }
    ...
    public function new(?_fd:Pointer<T_netFD>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class OpError {
    ...
    public function new(?op:GoString, ?net:GoString, ?source:Addr, ?addr:Addr, ?err:stdgo.Error) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(op) + " " + Go.string(net) + " " + Go.string(source) + " " + Go.string(addr) + " " + Go.string(err) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class ParseError {
    ...
    public function new(?type:GoString, ?text:GoString) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class AddrError {
    ...
    public function new(?err:GoString, ?addr:GoString) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:named class UnknownNetworkError {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new UnknownNetworkError(__t__);
}
@:named class InvalidAddrError {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new InvalidAddrError(__t__);
}
...
@:structInit class DNSError {
    ...
    public function new(?err:GoString, ?name:GoString, ?server:GoString, ?isTimeout:Bool, ?isTemporary:Bool, ?isNotFound:Bool) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(err) + " " + Go.string(name) + " " + Go.string(server) + " " + Go.string(isTimeout) + " " + Go.string(isTemporary) + " " + Go.string(isNotFound) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:named class Buffers {
    ...
    public function writeTo(_w:stdgo.io.Io.Writer):{ var _0 : GoInt64; var _1 : Error; } {
        ...
        for (_b in _v.value.__t__) {
            var __tmp__ = _w.write(_b), _nb:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            _n = _n + (((_nb : GoInt64)));
            if (_err != null) {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new Buffers(__t__);
    public function __append__(args:haxe.Rest<Slice<GoUInt8>>) return new Buffers(this.__t__.__append__(...args));
    public function __slice__(low:GoInt, high:GoInt = -1) return new Buffers(this.__t__.__slice__(low, high));
}
@:structInit class T_netFD {
    ...
    public function _readMsg(_p:Slice<GoByte>, _oob:Slice<GoByte>, _flags:GoInt):{ var _0 : GoInt; var _1 : GoInt; var _2 : GoInt; var _3 : stdgo.syscall.Syscall.Sockaddr; var _4 : Error; } {
        var _fd = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _n:GoInt = ((0 : GoInt)), _oobn:GoInt = ((0 : GoInt)), _retflags:GoInt = ((0 : GoInt)), _sa:stdgo.syscall.Syscall.Sockaddr = ((null : stdgo.syscall.Syscall.Sockaddr)), _err:Error = ((null : stdgo.Error));
        return { _0 : ((0 : GoInt)), _1 : ((0 : GoInt)), _2 : ((0 : GoInt)), _3 : ((null : stdgo.syscall.Syscall.Sockaddr)), _4 : stdgo.syscall.Syscall.enosys };
    }
    public function _readFrom(_p:Slice<GoByte>):{ var _0 : GoInt; var _1 : stdgo.syscall.Syscall.Sockaddr; var _2 : Error; } {
        var _fd = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _n:GoInt = ((0 : GoInt)), _sa:stdgo.syscall.Syscall.Sockaddr = ((null : stdgo.syscall.Syscall.Sockaddr)), _err:Error = ((null : stdgo.Error));
    ...
    public function _accept():{ var _0 : Pointer<T_netFD>; var _1 : Error; } {
        var _fd = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _fd.value._incoming.smartGet(), _c = __tmp__.value, _ok = __tmp__.ok;
        if (!_ok) {
    ...
    public function new(?_r:Pointer<T_bufferedPipe>, ?_w:Pointer<T_bufferedPipe>, ?_incoming:Chan<Pointer<T_netFD>>, ?_closedMu:stdgo.sync.Sync.Mutex, ?_closed:Bool, ?_listener:Bool, ?_family:GoInt, ?_sotype:GoInt, ?_net:GoString, ?_laddr:Addr, ?_raddr:Addr, ?_pfd:internal.poll.Poll.FD, ?_isConnected:Bool) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_r) + " " + Go.string(_w) + " " + Go.string(_incoming) + " " + Go.string(_closedMu) + " " + Go.string(_closed) + " " + Go.string(_listener) + " " + Go.string(_family) + " " + Go.string(_sotype) + " " + Go.string(_net) + " " + Go.string(_laddr) + " " + Go.string(_raddr) + " " + Go.string(_pfd) + " " + Go.string(_isConnected) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
        return new T_netFD(
...
@:structInit class T_bufferedPipe {
    ...
    public function new(?_softLimit:GoInt, ?_mu:stdgo.sync.Sync.Mutex, ?_buf:Slice<GoUInt8>, ?_closed:Bool, ?_rCond:stdgo.sync.Sync.Cond, ?_wCond:stdgo.sync.Sync.Cond, ?_rDeadline:stdgo.time.Time.Time, ?_wDeadline:stdgo.time.Time.Time) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_softLimit) + " " + Go.string(_mu) + " " + Go.string(_buf) + " " + Go.string(_closed) + " " + Go.string(_rCond) + " " + Go.string(_wCond) + " " + Go.string(_rDeadline) + " " + Go.string(_wDeadline) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_file {
    public function _readLine():{ var _0 : GoString; var _1 : Bool; } {
        ...
        if (_f.value._data.length < _f.value._data.cap()) {
            ...
            var __tmp__ = stdgo.io.Io.readFull(_f.value._file.value, _f.value._data.__slice__(_ln, _f.value._data.cap())), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_n >= ((0 : GoInt))) {
    ...
    public function new(?_file:Pointer<stdgo.os.Os.File>, ?_data:Slice<GoUInt8>, ?_atEOF:Bool) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_pipeDeadline {
    ...
    public function new(?_mu:stdgo.sync.Sync.Mutex, ?_timer:Pointer<stdgo.time.Time.Timer>, ?_cancel:Chan<T_timeoutError>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_pipe {
    ...
    public function write(_b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } {
        var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _p.value._write(_b), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null && Go.toInterface(_err) != Go.toInterface(stdgo.io.Io.errClosedPipe)) {
            _err = Go.pointer((({ op : "write", net : "pipe", err : _err, source : ((null : Addr)), addr : ((null : Addr)) } : OpError))).value;
        };
        return { _0 : _n, _1 : _err };
    }
    ...
    public function read(_b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } {
        var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _p.value._read(_b), _n:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null && Go.toInterface(_err) != Go.toInterface(stdgo.io.Io.eof) && Go.toInterface(_err) != Go.toInterface(stdgo.io.Io.errClosedPipe)) {
            _err = Go.pointer((({ op : "read", net : "pipe", err : _err, source : ((null : Addr)), addr : ((null : Addr)) } : OpError))).value;
        };
        return { _0 : _n, _1 : _err };
    }
    public function remoteAddr():Addr {
    ...
    public function new(?_wrMu:stdgo.sync.Sync.Mutex, ?_rdRx:Chan<Slice<GoUInt8>>, ?_rdTx:Chan<GoInt>, ?_wrTx:Chan<Slice<GoUInt8>>, ?_wrRx:Chan<GoInt>, ?_once:stdgo.sync.Sync.Once, ?_localDone:Chan<T_timeoutError>, ?_remoteDone:Chan<T_timeoutError>, ?_readDeadline:T_pipeDeadline, ?_writeDeadline:T_pipeDeadline) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_wrMu) + " " + Go.string(_rdRx) + " " + Go.string(_rdTx) + " " + Go.string(_wrTx) + " " + Go.string(_wrRx) + " " + Go.string(_once) + " " + Go.string(_localDone) + " " + Go.string(_remoteDone) + " " + Go.string(_readDeadline) + " " + Go.string(_writeDeadline) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_rawConn {
    public function write(_f:GoUIntptr -> Bool):Error {
        ...
        if (_err != null) {
            _err = Go.pointer((({ op : "raw-write", net : _c.value._fd.value._net, source : _c.value._fd.value._laddr, addr : _c.value._fd.value._raddr, err : _err } : OpError))).value;
        };
        return _err;
    }
    public function read(_f:GoUIntptr -> Bool):Error {
        ...
        stdgo.runtime.Runtime.keepAlive(Go.toInterface(_c.value._fd));
        if (_err != null) {
            _err = Go.pointer((({ op : "raw-read", net : _c.value._fd.value._net, source : _c.value._fd.value._laddr, addr : _c.value._fd.value._raddr, err : _err } : OpError))).value;
        };
        return _err;
    }
    public function control(_f:GoUIntptr -> Void):Error {
        ...
        stdgo.runtime.Runtime.keepAlive(Go.toInterface(_c.value._fd));
        if (_err != null) {
            _err = Go.pointer((({ op : "raw-control", net : _c.value._fd.value._net, source : ((null : Addr)), addr : _c.value._fd.value._laddr, err : _err } : OpError))).value;
        };
        return _err;
    }
    public function _ok():Bool {
...
@:structInit class T_rawListener {
    ...
    public function new(?_rawConn:T_rawConn) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_rawConn) + "}";
    }
    public function control(_f:GoUIntptr -> Void):stdgo.Error return _rawConn.control(_0);
    public function _ok():Bool return _rawConn._ok();
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class TCPAddr {
    ...
    public var zone : GoString = (("" : GoString));
    public function new(?ip:IP, ?port:GoInt, ?zone:GoString) stdgo.internal.Macro.initLocals();
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class TCPConn {
    public function _readFrom(_r:stdgo.io.Io.Reader):{ var _0 : GoInt64; var _1 : Error; } {
        var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        {
            var __tmp__ = _splice(_c.value._conn._fd, _r), _n:GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1, _handled:Bool = __tmp__._2;
            if (_handled) {
                return { _0 : _n, _1 : _err };
            };
        };
        {
            var __tmp__ = _sendFile(_c.value._conn._fd, _r), _n:GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1, _handled:Bool = __tmp__._2;
            if (_handled) {
                return { _0 : _n, _1 : _err };
            };
        };
    ...
    public function setNoDelay(_noDelay:Bool):Error {
        ...
        };
        {
            ...
            if (_err != null) {
                return Go.pointer((({ op : "set", net : _c.value._conn._fd.value._net, source : _c.value._conn._fd.value._laddr, addr : _c.value._conn._fd.value._raddr, err : _err } : OpError))).value;
            };
        };
        return ((null : stdgo.Error));
    }
    ...
    public function closeWrite():Error {
        ...
        };
        {
            ...
            if (_err != null) {
                return Go.pointer((({ op : "close", net : _c.value._conn._fd.value._net, source : _c.value._conn._fd.value._laddr, addr : _c.value._conn._fd.value._raddr, err : _err } : OpError))).value;
            };
        };
        return ((null : stdgo.Error));
    }
    ...
    public function readFrom(_r:stdgo.io.Io.Reader):{ var _0 : GoInt64; var _1 : Error; } {
        ...
        var __tmp__ = _c.value._readFrom(_r), _n:GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null && Go.toInterface(_err) != Go.toInterface(stdgo.io.Io.eof)) {
            _err = Go.pointer((({ op : "readfrom", net : _c.value._conn._fd.value._net, source : _c.value._conn._fd.value._laddr, addr : _c.value._conn._fd.value._raddr, err : _err } : OpError))).value;
        };
        return { _0 : _n, _1 : _err };
    }
    public function syscallConn():{ var _0 : stdgo.syscall.Syscall.RawConn; var _1 : Error; } {
...
@:structInit class TCPListener {
    public function _file():{ var _0 : Pointer<stdgo.os.Os.File>; var _1 : Error; } {
        ...
        var __tmp__ = _ln.value._fd.value._dup(), _f:Pointer<stdgo.os.Os.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
    ...
    public function _accept():{ var _0 : Pointer<TCPConn>; var _1 : Error; } {
        var _ln = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _ln.value._fd.value._accept(), _fd:Pointer<T_netFD> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<TCPConn>().nil(), _1 : _err };
        };
    ...
    public function file():{ var _0 : Pointer<stdgo.os.Os.File>; var _1 : Error; } {
        ...
        if (_err != null) {
            return { _0 : new Pointer<stdgo.os.Os.File>().nil(), _1 : Go.pointer((({ op : "file", net : _l.value._fd.value._net, source : ((null : Addr)), addr : _l.value._fd.value._laddr, err : _err } : OpError))).value };
        };
        return { _0 : _f, _1 : _err };
    }
    public function setDeadline(_t:stdgo.time.Time.Time):Error {
        ...
        };
        {
            ...
            if (_err != null) {
                return Go.pointer((({ op : "set", net : _l.value._fd.value._net, source : ((null : Addr)), addr : _l.value._fd.value._laddr, err : _err } : OpError))).value;
            };
        };
        return ((null : stdgo.Error));
    }
    ...
    public function close():Error {
        ...
        };
        {
            ...
            if (_err != null) {
                return Go.pointer((({ op : "close", net : _l.value._fd.value._net, source : ((null : Addr)), addr : _l.value._fd.value._laddr, err : _err } : OpError))).value;
            };
        };
        return ((null : stdgo.Error));
    }
    public function accept():{ var _0 : Conn; var _1 : Error; } {
        ...
        var __tmp__ = _l.value._accept(), _c:Pointer<TCPConn> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : ((null : Conn)), _1 : Go.pointer((({ op : "accept", net : _l.value._fd.value._net, source : ((null : Addr)), addr : _l.value._fd.value._laddr, err : _err } : OpError))).value };
        };
    ...
    public function acceptTCP():{ var _0 : Pointer<TCPConn>; var _1 : Error; } {
        ...
        var __tmp__ = _l.value._accept(), _c:Pointer<TCPConn> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<TCPConn>().nil(), _1 : Go.pointer((({ op : "accept", net : _l.value._fd.value._net, source : ((null : Addr)), addr : _l.value._fd.value._laddr, err : _err } : OpError))).value };
        };
        return { _0 : _c, _1 : ((null : stdgo.Error)) };
    }
    public function syscallConn():{ var _0 : stdgo.syscall.Syscall.RawConn; var _1 : Error; } {
    ...
    public function new(?_fd:Pointer<T_netFD>, ?_lc:ListenConfig) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class UDPConn {
    ...
    public function _readMsg(_b:Slice<GoByte>, _oob:Slice<GoByte>):{ var _0 : GoInt; var _1 : GoInt; var _2 : GoInt; var _3 : Pointer<UDPAddr>; var _4 : Error; } {
        var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _n:GoInt = ((0 : GoInt)), _oobn:GoInt = ((0 : GoInt)), _flags:GoInt = ((0 : GoInt)), _addr:Pointer<UDPAddr> = new Pointer<UDPAddr>().nil(), _err:Error = ((null : stdgo.Error));
        var _sa:stdgo.syscall.Syscall.Sockaddr = ((null : stdgo.syscall.Syscall.Sockaddr));
        {
            var __tmp__ = _c.value._conn._fd.value._readMsg(_b, _oob, ((0 : GoInt)));
            _n = __tmp__._0;
        ...
        if (Go.assertable(((_sa : Pointer<stdgo.syscall.Syscall.SockaddrInet4>)))) {
            ...
            var _sa:Pointer<stdgo.syscall.Syscall.SockaddrInet6> = _sa == null ? null : _sa.__underlying__() == null ? null : _sa == null ? null : _sa.__underlying__().value;
            _addr = Go.pointer((({ ip : new IP(_sa.value.addr.__slice__(((0 : GoInt)))), port : _sa.value.port, zone : _zoneCache._name(((_sa.value.zoneId : GoInt))) } : UDPAddr)));
        };
        return { _0 : _n, _1 : _oobn, _2 : _flags, _3 : _addr, _4 : _err };
    }
    public function _readFrom(_b:Slice<GoByte>, _addr:Pointer<UDPAddr>):{ var _0 : GoInt; var _1 : Pointer<UDPAddr>; var _2 : Error; } {
        ...
        if (Go.assertable(((_sa : Pointer<stdgo.syscall.Syscall.SockaddrInet4>)))) {
            ...
            var _sa:Pointer<stdgo.syscall.Syscall.SockaddrInet6> = _sa == null ? null : _sa.__underlying__() == null ? null : _sa == null ? null : _sa.__underlying__().value;
            _addr.value = (({ ip : new IP(_sa.value.addr.__slice__(((0 : GoInt)))), port : _sa.value.port, zone : _zoneCache._name(((_sa.value.zoneId : GoInt))) } : UDPAddr)).__copy__();
        } else {
    ...
    public function readMsgUDP(_b:Slice<GoByte>, _oob:Slice<GoByte>):{ var _0 : GoInt; var _1 : GoInt; var _2 : GoInt; var _3 : Pointer<UDPAddr>; var _4 : Error; } {
        var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _n:GoInt = ((0 : GoInt)), _oobn:GoInt = ((0 : GoInt)), _flags:GoInt = ((0 : GoInt)), _addr:Pointer<UDPAddr> = new Pointer<UDPAddr>().nil(), _err:Error = ((null : stdgo.Error));
        if (!_c.value._ok()) {
            return { _0 : ((0 : GoInt)), _1 : ((0 : GoInt)), _2 : ((0 : GoInt)), _3 : new Pointer<UDPAddr>().nil(), _4 : stdgo.syscall.Syscall.einval };
        };
        {
            var __tmp__ = _c.value._readMsg(_b, _oob);
            _n = __tmp__._0;
    ...
    public function readFrom(_b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Addr; var _2 : Error; } {
        var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _c.value._readFromUDP(_b, Go.pointer(new UDPAddr())), _n:GoInt = __tmp__._0, _addr:Pointer<UDPAddr> = __tmp__._1, _err:stdgo.Error = __tmp__._2;
        if (_addr == null || _addr.isNil()) {
            return { _0 : _n, _1 : ((null : Addr)), _2 : _err };
        };
        return { _0 : _n, _1 : _addr.value, _2 : _err };
    ...
    public function _readFromUDP(_b:Slice<GoByte>, _addr:Pointer<UDPAddr>):{ var _0 : GoInt; var _1 : Pointer<UDPAddr>; var _2 : Error; } {
        ...
        var __tmp__ = _c.value._readFrom(_b, _addr), _n:GoInt = __tmp__._0, _addr:Pointer<UDPAddr> = __tmp__._1, _err:stdgo.Error = __tmp__._2;
        if (_err != null) {
            _err = Go.pointer((({ op : "read", net : _c.value._conn._fd.value._net, source : _c.value._conn._fd.value._laddr, addr : _c.value._conn._fd.value._raddr, err : _err } : OpError))).value;
        };
        return { _0 : _n, _1 : _addr, _2 : _err };
    ...
    public function readFromUDP(_b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Pointer<UDPAddr>; var _2 : Error; } {
        var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _n:GoInt = ((0 : GoInt)), _addr:Pointer<UDPAddr> = new Pointer<UDPAddr>().nil(), _err:Error = ((null : stdgo.Error));
...
@:structInit class UnixAddr {
    ...
    public var name : GoString = (("" : GoString));
    public var net : GoString = (("" : GoString));
    public function new(?name:GoString, ?net:GoString) stdgo.internal.Macro.initLocals();
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class UnixConn {
    ...
    public function _readMsg(_b:Slice<GoByte>, _oob:Slice<GoByte>):{ var _0 : GoInt; var _1 : GoInt; var _2 : GoInt; var _3 : Pointer<UnixAddr>; var _4 : Error; } {
        var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _n:GoInt = ((0 : GoInt)), _oobn:GoInt = ((0 : GoInt)), _flags:GoInt = ((0 : GoInt)), _addr:Pointer<UnixAddr> = new Pointer<UnixAddr>().nil(), _err:Error = ((null : stdgo.Error));
        var _sa:stdgo.syscall.Syscall.Sockaddr = ((null : stdgo.syscall.Syscall.Sockaddr));
        {
        ...
        if (Go.assertable(((_sa : Pointer<stdgo.syscall.Syscall.SockaddrUnix>)))) {
            var _sa:Pointer<stdgo.syscall.Syscall.SockaddrUnix> = _sa == null ? null : _sa.__underlying__() == null ? null : _sa == null ? null : _sa.__underlying__().value;
    ...
    public function readMsgUnix(_b:Slice<GoByte>, _oob:Slice<GoByte>):{ var _0 : GoInt; var _1 : GoInt; var _2 : GoInt; var _3 : Pointer<UnixAddr>; var _4 : Error; } {
        var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _n:GoInt = ((0 : GoInt)), _oobn:GoInt = ((0 : GoInt)), _flags:GoInt = ((0 : GoInt)), _addr:Pointer<UnixAddr> = new Pointer<UnixAddr>().nil(), _err:Error = ((null : stdgo.Error));
        if (!_c.value._ok()) {
            return { _0 : ((0 : GoInt)), _1 : ((0 : GoInt)), _2 : ((0 : GoInt)), _3 : new Pointer<UnixAddr>().nil(), _4 : stdgo.syscall.Syscall.einval };
        };
        {
            var __tmp__ = _c.value._readMsg(_b, _oob);
            _n = __tmp__._0;
    ...
    public function readFrom(_b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Addr; var _2 : Error; } {
        ...
        var __tmp__ = _c.value._readFrom(_b), _n:GoInt = __tmp__._0, _addr:Pointer<UnixAddr> = __tmp__._1, _err:stdgo.Error = __tmp__._2;
        if (_err != null) {
            _err = Go.pointer((({ op : "read", net : _c.value._conn._fd.value._net, source : _c.value._conn._fd.value._laddr, addr : _c.value._conn._fd.value._raddr, err : _err } : OpError))).value;
        };
        if (_addr == null || _addr.isNil()) {
...
@:structInit class UnixListener {
    ...
    public function file():{ var _0 : Pointer<stdgo.os.Os.File>; var _1 : Error; } {
        ...
        if (_err != null) {
            _err = Go.pointer((({ op : "file", net : _l.value._fd.value._net, source : ((null : Addr)), addr : _l.value._fd.value._laddr, err : _err } : OpError))).value;
        };
        return { _0 : _f, _1 : _err };
    }
    public function setDeadline(_t:stdgo.time.Time.Time):Error {
    ...
    public function accept():{ var _0 : Conn; var _1 : Error; } {
        ...
        var __tmp__ = _l.value._accept(), _c:Pointer<UnixConn> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : ((null : Conn)), _1 : Go.pointer((({ op : "accept", net : _l.value._fd.value._net, source : ((null : Addr)), addr : _l.value._fd.value._laddr, err : _err } : OpError))).value };
        };
        return { _0 : _c.value, _1 : ((null : stdgo.Error)) };
    ...
    public function acceptUnix():{ var _0 : Pointer<UnixConn>; var _1 : Error; } {
        ...
        var __tmp__ = _l.value._accept(), _c:Pointer<UnixConn> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<UnixConn>().nil(), _1 : Go.pointer((({ op : "accept", net : _l.value._fd.value._net, source : ((null : Addr)), addr : _l.value._fd.value._laddr, err : _err } : OpError))).value };
        };
        return { _0 : _c, _1 : ((null : stdgo.Error)) };
    }
    public function syscallConn():{ var _0 : stdgo.syscall.Syscall.RawConn; var _1 : Error; } {
    ...
    public function new(?_fd:Pointer<T_netFD>, ?_path:GoString, ?_unlink:Bool, ?_unlinkOnce:stdgo.sync.Sync.Once) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit @:local class T__struct_45 {
    ...
    public var _byName : GoMap<GoString, Slice<GoString>> = new GoMap<GoString, Slice<GoString>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind))))).nil();
    public var _byAddr : GoMap<GoString, Slice<GoString>> = new GoMap<GoString, Slice<GoString>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind))))).nil();
    ...
    public function new(?mutex:stdgo.sync.Sync.Mutex, ?_byName:GoMap<GoString, Slice<GoString>>, ?_byAddr:GoMap<GoString, Slice<GoString>>, ?_expire:stdgo.time.Time.Time, ?_path:GoString, ?_mtime:stdgo.time.Time.Time, ?_size:GoInt64) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(mutex) + " " + Go.string(_byName) + " " + Go.string(_byAddr) + " " + Go.string(_expire) + " " + Go.string(_path) + " " + Go.string(_mtime) + " " + Go.string(_size) + "}";
    }
...
@:structInit @:local class T__struct_46 {
    ...
    public function new(?_laddr:TCPAddr, ?_value:GoInt) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit @:local class T__struct_47 {
    ...
    public function new(?once:stdgo.sync.Sync.Once, ?_val:GoInt) stdgo.internal.Macro.initLocals();
    public function toString() {
...
var _testHookLookupIP : (stdgo.context.Context.Context, (stdgo.context.Context.Context, GoString, GoString) -> { var _0 : Slice<IPAddr>; var _1 : stdgo.Error; }, GoString, GoString) -> { var _0 : Slice<IPAddr>; var _1 : stdgo.Error; } = function(_ctx:stdgo.context.Context.Context, _fn:(stdgo.context.Context.Context, GoString, GoString) -> { var _0 : Slice<IPAddr>; var _1 : Error; }, _network:GoString, _host:GoString):{ var _0 : Slice<IPAddr>; var _1 : Error; } {
...
var ipv6unspecified : IP = new IP(new Slice<GoUInt8>(
((0 : GoUInt8)),
((0 : GoUInt8)),
((0 : GoUInt8)),
((0 : GoUInt8)),
...
var _services : GoMap<GoString, GoMap<GoString, GoInt>> = new GoMap<GoString, GoMap<GoString, GoInt>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.basic(int_kind)))), { key : "udp", value : new GoMap<GoString, GoInt>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.basic(int_kind))), { key : "domain", value : ((53 : GoInt)) }) }, { key : "tcp", value : new GoMap<GoString, GoInt>(
new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.basic(int_kind))),
{ key : "ftp", value : ((21 : GoInt)) },
{ key : "ftps", value : ((990 : GoInt)) },
{ key : "gopher", value : ((70 : GoInt)) },
{ key : "http", value : ((80 : GoInt)) },
{ key : "https", value : ((443 : GoInt)) },
{ key : "imap2", value : ((143 : GoInt)) },
{ key : "imap3", value : ((220 : GoInt)) },
{ key : "imaps", value : ((993 : GoInt)) },
{ key : "pop3", value : ((110 : GoInt)) },
{ key : "pop3s", value : ((995 : GoInt)) },
{ key : "smtp", value : ((25 : GoInt)) },
{ key : "ssh", value : ((22 : GoInt)) },
{ key : "telnet", value : ((23 : GoInt)) }) });
...
var _listeners : GoMap<GoString, Pointer<T_netFD>> = new GoMap<GoString, Pointer<T_netFD>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net.netFD", [], stdgo.reflect.Reflect.GoType.named("net.netFD", [], stdgo.reflect.Reflect.GoType.structType([
{ name : "_r", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net.bufferedPipe", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_softLimit", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }, { name : "_mu", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.Mutex", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_state", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int32_kind) }, { name : "_sema", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }])) }, { name : "_buf", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) }, { name : "_closed", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }, { name : "_rCond", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.Cond", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_noCopy", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.noCopy", [], stdgo.reflect.Reflect.GoType.named("net.timeoutError", [], stdgo.reflect.Reflect.GoType.structType([]))) }, { name : "l", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.Locker", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }, { name : "_notify", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.notifyList", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_wait", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }, { name : "_notify", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }, { name : "_lock", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uintptr_kind) }, { name : "_head", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(unsafepointer_kind) }, { name : "_tail", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(unsafepointer_kind) }])) }, { name : "_checker", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.copyChecker", [], stdgo.reflect.Reflect.GoType.basic(uintptr_kind)) }])) }, { name : "_wCond", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.Cond", [], stdgo.reflect.Reflect.GoType.invalidType) }, { name : "_rDeadline", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("time.Time", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_wall", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint64_kind) }, { name : "_ext", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_loc", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("time.Location", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_name", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_zone", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("time.zone", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_name", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_offset", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }, { name : "_isDST", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }]))) }, { name : "_tx", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("time.zoneTrans", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_when", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_index", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint8_kind) }, { name : "_isstd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }, { name : "_isutc", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }]))) }, { name : "_extend", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_cacheStart", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_cacheEnd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_cacheZone", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("time.zone", [], stdgo.reflect.Reflect.GoType.invalidType)) }]))) }])) }, { name : "_wDeadline", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("time.Time", [], stdgo.reflect.Reflect.GoType.invalidType) }]))) },
{ name : "_w", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net.bufferedPipe", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_softLimit", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }, { name : "_mu", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.Mutex", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_state", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int32_kind) }, { name : "_sema", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }])) }, { name : "_buf", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) }, { name : "_closed", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }, { name : "_rCond", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.Cond", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_noCopy", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.noCopy", [], stdgo.reflect.Reflect.GoType.named("net.timeoutError", [], stdgo.reflect.Reflect.GoType.structType([]))) }, { name : "l", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.Locker", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }, { name : "_notify", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.notifyList", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_wait", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }, { name : "_notify", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }, { name : "_lock", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uintptr_kind) }, { name : "_head", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(unsafepointer_kind) }, { name : "_tail", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(unsafepointer_kind) }])) }, { name : "_checker", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.copyChecker", [], stdgo.reflect.Reflect.GoType.basic(uintptr_kind)) }])) }, { name : "_wCond", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.Cond", [], stdgo.reflect.Reflect.GoType.invalidType) }, { name : "_rDeadline", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("time.Time", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_wall", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint64_kind) }, { name : "_ext", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_loc", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("time.Location", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_name", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_zone", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("time.zone", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_name", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_offset", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }, { name : "_isDST", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }]))) }, { name : "_tx", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("time.zoneTrans", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_when", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_index", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint8_kind) }, { name : "_isstd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }, { name : "_isutc", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }]))) }, { name : "_extend", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_cacheStart", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_cacheEnd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_cacheZone", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("time.zone", [], stdgo.reflect.Reflect.GoType.invalidType)) }]))) }])) }, { name : "_wDeadline", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("time.Time", [], stdgo.reflect.Reflect.GoType.invalidType) }]))) },
{ name : "_incoming", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.chanType(0, stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net.netFD", [], stdgo.reflect.Reflect.GoType.structType([
{ name : "_r", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net.bufferedPipe", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_softLimit", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }, { name : "_mu", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.Mutex", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_state", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int32_kind) }, { name : "_sema", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }])) }, { name : "_buf", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) }, { name : "_closed", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }, { name : "_rCond", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.Cond", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_noCopy", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.noCopy", [], stdgo.reflect.Reflect.GoType.named("net.timeoutError", [], stdgo.reflect.Reflect.GoType.structType([]))) }, { name : "l", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.Locker", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }, { name : "_notify", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.notifyList", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_wait", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }, { name : "_notify", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }, { name : "_lock", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uintptr_kind) }, { name : "_head", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(unsafepointer_kind) }, { name : "_tail", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(unsafepointer_kind) }])) }, { name : "_checker", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.copyChecker", [], stdgo.reflect.Reflect.GoType.basic(uintptr_kind)) }])) }, { name : "_wCond", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.Cond", [], stdgo.reflect.Reflect.GoType.invalidType) }, { name : "_rDeadline", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("time.Time", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_wall", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint64_kind) }, { name : "_ext", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_loc", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("time.Location", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_name", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_zone", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("time.zone", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_name", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_offset", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }, { name : "_isDST", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }]))) }, { name : "_tx", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("time.zoneTrans", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_when", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_index", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint8_kind) }, { name : "_isstd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }, { name : "_isutc", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }]))) }, { name : "_extend", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_cacheStart", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_cacheEnd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_cacheZone", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("time.zone", [], stdgo.reflect.Reflect.GoType.invalidType)) }]))) }])) }, { name : "_wDeadline", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("time.Time", [], stdgo.reflect.Reflect.GoType.invalidType) }]))) },
{ name : "_w", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net.bufferedPipe", [], stdgo.reflect.Reflect.GoType.invalidType)) },
{ name : "_incoming", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.chanType(0, stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net.netFD", [], stdgo.reflect.Reflect.GoType.invalidType))) },
{ name : "_closedMu", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.Mutex", [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "_closed", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) },
{ name : "_listener", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) },
{ name : "_family", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) },
{ name : "_sotype", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) },
{ name : "_net", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "_laddr", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net.Addr", [], stdgo.reflect.Reflect.GoType.named("net.Addr", [], stdgo.reflect.Reflect.GoType.interfaceType(false, []))) },
{ name : "_raddr", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net.Addr", [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "_pfd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("internal/poll.FD", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_fdmu", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("internal/poll.fdMutex", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_state", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint64_kind) }, { name : "_rsema", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }, { name : "_wsema", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }])) }, { name : "sysfd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }, { name : "_pd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("internal/poll.pollDesc", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_fd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("internal/poll.FD", [], stdgo.reflect.Reflect.GoType.invalidType)) }, { name : "_closing", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }])) }, { name : "_iovecs", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("syscall.Iovec", [], stdgo.reflect.Reflect.GoType.named("net.timeoutError", [], stdgo.reflect.Reflect.GoType.structType([]))))) }, { name : "_csema", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }, { name : "_isBlocking", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }, { name : "isStream", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }, { name : "zeroReadIsEOF", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }, { name : "_isFile", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }])) },
{ name : "_isConnected", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }])))) },
{ name : "_closedMu", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.Mutex", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_state", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int32_kind) }, { name : "_sema", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }])) },
{ name : "_closed", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) },
{ name : "_listener", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) },
{ name : "_family", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) },
{ name : "_sotype", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) },
{ name : "_net", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "_laddr", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net.Addr", [], stdgo.reflect.Reflect.GoType.named("net.Addr", [], stdgo.reflect.Reflect.GoType.interfaceType(false, []))) },
{ name : "_raddr", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net.Addr", [], stdgo.reflect.Reflect.GoType.named("net.Addr", [], stdgo.reflect.Reflect.GoType.interfaceType(false, []))) },
{ name : "_pfd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("internal/poll.FD", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_fdmu", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("internal/poll.fdMutex", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_state", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint64_kind) }, { name : "_rsema", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }, { name : "_wsema", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }])) }, { name : "sysfd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }, { name : "_pd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("internal/poll.pollDesc", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_fd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("internal/poll.FD", [], stdgo.reflect.Reflect.GoType.invalidType)) }, { name : "_closing", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }])) }, { name : "_iovecs", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("syscall.Iovec", [], stdgo.reflect.Reflect.GoType.named("net.timeoutError", [], stdgo.reflect.Reflect.GoType.structType([]))))) }, { name : "_csema", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }, { name : "_isBlocking", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }, { name : "isStream", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }, { name : "zeroReadIsEOF", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }, { name : "_isFile", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }])) },
{ name : "_isConnected", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }])))))));
...
var _testHookDialTCP : (_ctx:stdgo.context.Context.Context, _net:GoString, _laddr:Pointer<TCPAddr>, _raddr:Pointer<TCPAddr>) -> { var _0 : Pointer<TCPConn>; var _1 : Error; } = null;
var _v4InV6Prefix : Slice<GoUInt8> = new Slice<GoUInt8>(
((0 : GoUInt8)),
((0 : GoUInt8)),
((0 : GoUInt8)),
((0 : GoUInt8)),
...
var ipv6linklocalallrouters : IP = new IP(new Slice<GoUInt8>(
((255 : GoUInt8)),
((2 : GoUInt8)),
((0 : GoUInt8)),
((0 : GoUInt8)),
...
((0 : GoUInt8)),
((2 : GoUInt8)))).__copy__();
var ipv6zero : IP = new IP(new Slice<GoUInt8>(
((0 : GoUInt8)),
((0 : GoUInt8)),
((0 : GoUInt8)),
((0 : GoUInt8)),
...
var _zoneCache : T_ipv6ZoneCache = (({ _toIndex : new GoMap<GoString, GoInt>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.basic(int_kind)))), _toName : new GoMap<GoInt, GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(int_kind), stdgo.reflect.Reflect.GoType.basic(string_kind)))), rwmutex : new stdgo.sync.Sync.RWMutex(), _lastFetched : new stdgo.time.Time.Time() } : T_ipv6ZoneCache)).__copy__();
var _getsockoptIntFunc : (GoInt, GoInt, GoInt) -> { var _0 : GoInt; var _1 : Error; } = stdgo.syscall.Syscall.getsockoptInt;
...
var ipv6loopback : IP = new IP(new Slice<GoUInt8>(
((0 : GoUInt8)),
((0 : GoUInt8)),
((0 : GoUInt8)),
((0 : GoUInt8)),
...
var ipv6linklocalallnodes : IP = new IP(new Slice<GoUInt8>(
((255 : GoUInt8)),
((2 : GoUInt8)),
((0 : GoUInt8)),
((0 : GoUInt8)),
...
var ipv6interfacelocalallnodes : IP = new IP(new Slice<GoUInt8>(
((255 : GoUInt8)),
((1 : GoUInt8)),
((0 : GoUInt8)),
((0 : GoUInt8)),
...
var _protocols : GoMap<GoString, GoInt> = new GoMap<GoString, GoInt>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.basic(int_kind))), { key : "icmp", value : ((1 : GoInt)) }, { key : "igmp", value : ((2 : GoInt)) }, { key : "tcp", value : ((6 : GoInt)) }, { key : "udp", value : ((17 : GoInt)) }, { key : "ipv6-icmp", value : ((58 : GoInt)) });
var _socketFunc : (GoInt, GoInt, GoInt) -> { var _0 : GoInt; var _1 : Error; } = stdgo.syscall.Syscall.socket;
...
function _cgoLookupHost(_ctx:stdgo.context.Context.Context, _name:GoString):{ var _0 : Slice<GoString>; var _1 : Error; var _2 : Bool; } {
        var _addrs:Slice<GoString> = new Slice<GoString>().nil(), _err:Error = ((null : stdgo.Error)), _completed:Bool = false;
...
function _cgoLookupPort(_ctx:stdgo.context.Context.Context, _network:GoString, _service:GoString):{ var _0 : GoInt; var _1 : Error; var _2 : Bool; } {
        var _port:GoInt = ((0 : GoInt)), _err:Error = ((null : stdgo.Error)), _completed:Bool = false;
...
function _cgoLookupIP(_ctx:stdgo.context.Context.Context, _network:GoString, _name:GoString):{ var _0 : Slice<IPAddr>; var _1 : Error; var _2 : Bool; } {
        var _addrs:Slice<IPAddr> = new Slice<IPAddr>().nil(), _err:Error = ((null : stdgo.Error)), _completed:Bool = false;
...
function _cgoLookupCNAME(_ctx:stdgo.context.Context.Context, _name:GoString):{ var _0 : GoString; var _1 : Error; var _2 : Bool; } {
        var _cname:GoString = (("" : GoString)), _err:Error = ((null : stdgo.Error)), _completed:Bool = false;
...
function _cgoLookupPTR(_ctx:stdgo.context.Context.Context, _addr:GoString):{ var _0 : Slice<GoString>; var _1 : Error; var _2 : Bool; } {
        var _ptrs:Slice<GoString> = new Slice<GoString>().nil(), _err:Error = ((null : stdgo.Error)), _completed:Bool = false;
        return { _0 : new Slice<GoString>().nil(), _1 : ((null : stdgo.Error)), _2 : false };
    }
...
function _parseNetwork(_ctx:stdgo.context.Context.Context, _network:GoString, _needsProto:Bool):{ var _0 : GoString; var _1 : GoInt; var _2 : Error; } {
        var _afnet:GoString = (("" : GoString)), _proto:GoInt = ((0 : GoInt)), _err:Error = ((null : stdgo.Error));
        var _i:GoInt = _last(_network, ((":".code : GoRune)));
        if (_i < ((0 : GoInt))) {
            if (_network == (("tcp" : GoString)) || _network == (("tcp4" : GoString)) || _network == (("tcp6" : GoString))) {} else if (_network == (("udp" : GoString)) || _network == (("udp4" : GoString)) || _network == (("udp6" : GoString))) {} else if (_network == (("ip" : GoString)) || _network == (("ip4" : GoString)) || _network == (("ip6" : GoString))) {
                if (_needsProto) {
                    return { _0 : "", _1 : ((0 : GoInt)), _2 : new UnknownNetworkError(_network) };
                };
            } else if (_network == (("unix" : GoString)) || _network == (("unixgram" : GoString)) || _network == (("unixpacket" : GoString))) {} else {
                return { _0 : "", _1 : ((0 : GoInt)), _2 : new UnknownNetworkError(_network) };
            };
        ...
        if (_afnet == (("ip" : GoString)) || _afnet == (("ip4" : GoString)) || _afnet == (("ip6" : GoString))) {
            ...
            var __tmp__ = _dtoi(_protostr), _proto:GoInt = __tmp__._0, _i:GoInt = __tmp__._1, _ok:Bool = __tmp__._2;
...
function dialTimeout(_network:GoString, _address:GoString, _timeout:stdgo.time.Time.Duration):{ var _0 : Conn; var _1 : Error; } {
        var _d:Dialer = (({ timeout : _timeout, deadline : new stdgo.time.Time.Time(), localAddr : ((null : Addr)), dualStack : false, fallbackDelay : new stdgo.time.Time.Duration(), keepAlive : new stdgo.time.Time.Duration(), resolver : new Pointer<Resolver>().nil(), cancel : new Chan<{ }>(0, () -> null, true), control : null } : Dialer)).__copy__();
        return _d.dial(_network, _address);
    }
/**
...
/**
    // provided by runtime
**/
function _fastrand():GoUInt32 throw "not implemeneted";
...
function _reverseaddr(_addr:GoString):{ var _0 : GoString; var _1 : Error; } {
        var _arpa:GoString = (("" : GoString)), _err:Error = ((null : stdgo.Error));
        var _ip:IP = parseIP(_addr).__copy__();
        if (_ip.__t__ == null || _ip.__t__.isNil()) {
            return { _0 : "", _1 : Go.pointer((({ err : "unrecognized address", name : _addr, server : "", isTimeout : false, isTemporary : false, isNotFound : false } : DNSError))).value };
        };
        if (_ip.to4().__t__ != null && !_ip.to4().__t__.isNil()) {
            return { _0 : internal.itoa.Itoa.uitoa(((_ip.__t__[((15 : GoInt))] : GoUInt))) + (("." : GoString)) + internal.itoa.Itoa.uitoa(((_ip.__t__[((14 : GoInt))] : GoUInt))) + (("." : GoString)) + internal.itoa.Itoa.uitoa(((_ip.__t__[((13 : GoInt))] : GoUInt))) + (("." : GoString)) + internal.itoa.Itoa.uitoa(((_ip.__t__[((12 : GoInt))] : GoUInt))) + ((".in-addr.arpa." : GoString)), _1 : ((null : stdgo.Error)) };
        };
        var _buf:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((_ip.__t__.length * ((4 : GoInt)) + "ip6.arpa.".length : GoInt)).toBasic());
        {
...
function _isDomainName(_s:GoString):Bool {
        ...
        var _partlen:GoInt = ((0 : GoInt));
        {
            ...
            Go.cfor(_i < _s.length, _i++, {
                ...
                if ((("a".code : GoRune)) <= _c && _c <= (("z".code : GoRune)) || (("A".code : GoRune)) <= _c && _c <= (("Z".code : GoRune)) || _c == (("_".code : GoRune))) {
                    _nonNumeric = true;
                    _partlen++;
...
function fileConn(_f:Pointer<stdgo.os.Os.File>):{ var _0 : Conn; var _1 : Error; } {
        ...
        if (_err != null) {
            _err = Go.pointer((({ op : "file", net : "file+net", source : ((null : Addr)), addr : new T_fileAddr(_f.value.name()), err : _err } : OpError))).value;
        };
        return { _0 : _c, _1 : _err };
    }
/**
...
function fileListener(_f:Pointer<stdgo.os.Os.File>):{ var _0 : Listener; var _1 : Error; } {
        var _ln:Listener = ((null : Listener)), _err:Error = ((null : stdgo.Error));
        {
...
function filePacketConn(_f:Pointer<stdgo.os.Os.File>):{ var _0 : PacketConn; var _1 : Error; } {
        var _c:PacketConn = ((null : PacketConn)), _err:Error = ((null : stdgo.Error));
        {
...
function _readHosts():Void {
        ...
        if (_now.before(_hosts._expire.__copy__()) && _hosts._path == _hp && (_hosts._byName == null ? 0 : _hosts._byName.length) > ((0 : GoInt))) {
            return;
        };
        var __tmp__ = _stat(_hp), _mtime:stdgo.time.Time.Time = __tmp__._0, _size:GoInt64 = __tmp__._1, _err:stdgo.Error = __tmp__._2;
        ...
        var _hs:GoMap<GoString, Slice<GoString>> = new GoMap<GoString, Slice<GoString>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)))));
        var _is:GoMap<GoString, Slice<GoString>> = new GoMap<GoString, Slice<GoString>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)))));
        ...
        {
            var __tmp__ = _file.value._readLine(), _line:GoString = __tmp__._0, _ok:Bool = __tmp__._1;
            Go.cfor(_ok, {
...
function _lookupStaticHost(_host:GoString):Slice<GoString> {
        ...
        try {
            ...
            if ((_hosts._byName == null ? 0 : _hosts._byName.length) != ((0 : GoInt))) {
                ...
                {
                    var __tmp__ = _hosts._byName.exists(_absDomainName(_lowerHost)) ? { value : _hosts._byName[_absDomainName(_lowerHost)], ok : true } : { value : _hosts._byName.defaultValue(), ok : false }, _ips:Slice<GoString> = __tmp__.value, _ok:Bool = __tmp__.ok;
                    if (_ok) {
...
function _lookupStaticAddr(_addr:GoString):Slice<GoString> {
        ...
        try {
            ...
            if ((_hosts._byAddr == null ? 0 : _hosts._byAddr.length) != ((0 : GoInt))) {
                {
                    var __tmp__ = _hosts._byAddr.exists(_addr) ? { value : _hosts._byAddr[_addr], ok : true } : { value : _hosts._byAddr.defaultValue(), ok : false }, _hosts:Slice<GoString> = __tmp__.value, _ok:Bool = __tmp__.ok;
                    if (_ok) {
...
function interfaces():{ var _0 : Slice<Interface>; var _1 : Error; } {
        var __tmp__ = _interfaceTable(((0 : GoInt))), _ift:Slice<Interface> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<Interface>().nil(), _1 : Go.pointer((({ op : "route", net : "ip+net", source : ((null : Addr)), addr : ((null : Addr)), err : _err } : OpError))).value };
        };
        if (_ift.length != ((0 : GoInt))) {
...
function interfaceAddrs():{ var _0 : Slice<Addr>; var _1 : Error; } {
        var __tmp__ = _interfaceAddrTable(new Pointer<Interface>().nil()), _ifat:Slice<Addr> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _err = Go.pointer((({ op : "route", net : "ip+net", source : ((null : Addr)), addr : ((null : Addr)), err : _err } : OpError))).value;
        };
        return { _0 : _ifat, _1 : _err };
...
function interfaceByIndex(_index:GoInt):{ var _0 : Pointer<Interface>; var _1 : Error; } {
        if (_index <= ((0 : GoInt))) {
            return { _0 : new Pointer<Interface>().nil(), _1 : Go.pointer((({ op : "route", net : "ip+net", source : ((null : Addr)), addr : ((null : Addr)), err : _errInvalidInterfaceIndex } : OpError))).value };
        };
        var __tmp__ = _interfaceTable(_index), _ift:Slice<Interface> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<Interface>().nil(), _1 : Go.pointer((({ op : "route", net : "ip+net", source : ((null : Addr)), addr : ((null : Addr)), err : _err } : OpError))).value };
        };
        var __tmp__ = _interfaceByIndex(_ift, _index), _ifi:Pointer<Interface> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _err = Go.pointer((({ op : "route", net : "ip+net", source : ((null : Addr)), addr : ((null : Addr)), err : _err } : OpError))).value;
        };
...
function interfaceByName(_name:GoString):{ var _0 : Pointer<Interface>; var _1 : Error; } {
        if (_name == (("" : GoString))) {
            return { _0 : new Pointer<Interface>().nil(), _1 : Go.pointer((({ op : "route", net : "ip+net", source : ((null : Addr)), addr : ((null : Addr)), err : _errInvalidInterfaceName } : OpError))).value };
        };
        var __tmp__ = _interfaceTable(((0 : GoInt))), _ift:Slice<Interface> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<Interface>().nil(), _1 : Go.pointer((({ op : "route", net : "ip+net", source : ((null : Addr)), addr : ((null : Addr)), err : _err } : OpError))).value };
        ...
        return { _0 : new Pointer<Interface>().nil(), _1 : Go.pointer((({ op : "route", net : "ip+net", source : ((null : Addr)), addr : ((null : Addr)), err : _errNoSuchInterface } : OpError))).value };
    }
/**
...
function _parseIPv4(_s:GoString):IP {
        var _p:GoArray<GoByte> = new GoArray<GoUInt8>(...[for (i in 0 ... 4) ((0 : GoUInt8))]);
        {
            ...
            Go.cfor(_i < ipv4len, _i++, {
                ...
                var __tmp__ = _dtoi(_s), _n:GoInt = __tmp__._0, _c:GoInt = __tmp__._1, _ok:Bool = __tmp__._2;
                if (!_ok || _n > ((255 : GoInt))) {
                    return new IP();
                };
...
function _parseIPv6Zone(_s:GoString):{ var _0 : IP; var _1 : GoString; } {
        var __tmp__ = _splitHostZone(_s), _s:GoString = __tmp__._0, _zone:GoString = __tmp__._1;
...
function _parseIPv6(_s:GoString):IP {
        ...
        var _i:GoInt = ((0 : GoInt));
        while (_i < ipv6len) {
            var __tmp__ = _xtoi(_s), _n:GoInt = __tmp__._0, _c:GoInt = __tmp__._1, _ok:Bool = __tmp__._2;
...
function parseCIDR(_s:GoString):{ var _0 : IP; var _1 : Pointer<IPNet>; var _2 : Error; } {
        ...
        var _addr:GoString = _s.__slice__(0, _i), _mask:GoString = _s.__slice__(_i + ((1 : GoInt)));
        ...
        var __tmp__ = _dtoi(_mask), _n:GoInt = __tmp__._0, _i:GoInt = __tmp__._1, _ok:Bool = __tmp__._2;
        if (_ip.__t__ == null || _ip.__t__.isNil() || !_ok || _i != _mask.length || _n < ((0 : GoInt)) || _n > ((8 : GoInt)) * _iplen) {
            return { _0 : new IP(), _1 : new Pointer<IPNet>().nil(), _2 : Go.pointer((({ type : "CIDR address", text : _s } : ParseError))).value };
        };
...
function resolveIPAddr(_network:GoString, _address:GoString):{ var _0 : Pointer<IPAddr>; var _1 : Error; } {
        ...
        var __tmp__ = _parseNetwork(stdgo.context.Context.background(), _network, false), _afnet:GoString = __tmp__._0, _:GoInt = __tmp__._1, _err:stdgo.Error = __tmp__._2;
        if (_err != null) {
        ...
        var __tmp__ = defaultResolver.value._internetAddrList(stdgo.context.Context.background(), _afnet, _address), _addrs:T_addrList = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<IPAddr>().nil(), _1 : _err };
        };
...
function dialIP(_network:GoString, _laddr:Pointer<IPAddr>, _raddr:Pointer<IPAddr>):{ var _0 : Pointer<IPConn>; var _1 : Error; } {
        if (_raddr == null || _raddr.isNil()) {
            return { _0 : new Pointer<IPConn>().nil(), _1 : Go.pointer((({ op : "dial", net : _network, source : _laddr.value._opAddr(), addr : ((null : Addr)), err : _errMissingAddress } : OpError))).value };
        };
        var _sd:Pointer<T_sysDialer> = Go.pointer((({ _network : _network, _address : _raddr.value.toString(), dialer : new Dialer() } : T_sysDialer)));
        var __tmp__ = _sd.value._dialIP(stdgo.context.Context.background(), _laddr, _raddr), _c:Pointer<IPConn> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<IPConn>().nil(), _1 : Go.pointer((({ op : "dial", net : _network, source : _laddr.value._opAddr(), addr : _raddr.value._opAddr(), err : _err } : OpError))).value };
        };
        return { _0 : _c, _1 : ((null : stdgo.Error)) };
    }
/**
...
function listenIP(_network:GoString, _laddr:Pointer<IPAddr>):{ var _0 : Pointer<IPConn>; var _1 : Error; } {
        ...
        var __tmp__ = _sl.value._listenIP(stdgo.context.Context.background(), _laddr), _c:Pointer<IPConn> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<IPConn>().nil(), _1 : Go.pointer((({ op : "listen", net : _network, source : ((null : Addr)), addr : _laddr.value._opAddr(), err : _err } : OpError))).value };
        };
        return { _0 : _c, _1 : ((null : stdgo.Error)) };
    }
...
function splitHostPort(_hostport:GoString):{ var _0 : GoString; var _1 : GoString; var _2 : Error; } {
        ...
        var _addrErr:(GoString, GoString) -> { var _0 : GoString; var _1 : GoString; var _2 : stdgo.Error; } = function(_addr:GoString, _why:GoString):{ var _0 : GoString; var _1 : GoString; var _2 : Error; } {
            var _host:GoString = (("" : GoString)), _port:GoString = (("" : GoString)), _err:Error = ((null : stdgo.Error));
...
function _favoriteAddrFamily(_network:GoString, _laddr:T_sockaddr, _raddr:T_sockaddr, _mode:GoString):{ var _0 : GoInt; var _1 : Bool; } {
        ...
        if ((_laddr == null || _laddr._family() == stdgo.syscall.Syscall.af_INET) && (_raddr == null || _raddr._family() == stdgo.syscall.Syscall.af_INET)) {
            return { _0 : stdgo.syscall.Syscall.af_INET, _1 : false };
        };
        return { _0 : stdgo.syscall.Syscall.af_INET6, _1 : false };
    }
function _internetSocket(_ctx:stdgo.context.Context.Context, _net:GoString, _laddr:T_sockaddr, _raddr:T_sockaddr, _sotype:GoInt, _proto:GoInt, _mode:GoString, _ctrlFn:(GoString, GoString, stdgo.syscall.Syscall.RawConn) -> Error):{ var _0 : Pointer<T_netFD>; var _1 : Error; } {
        var _fd:Pointer<T_netFD> = new Pointer<T_netFD>().nil(), _err:Error = ((null : stdgo.Error));
        if ((stdgo.runtime.Runtime.goos == (("aix" : GoString)) || stdgo.runtime.Runtime.goos == (("windows" : GoString)) || stdgo.runtime.Runtime.goos == (("openbsd" : GoString))) && _mode == (("dial" : GoString)) && _raddr._isWildcard()) {
            _raddr = _raddr._toLocal(_net);
        };
        var __tmp__ = _favoriteAddrFamily(_net, _laddr, _raddr, _mode), _family:GoInt = __tmp__._0, _ipv6only:Bool = __tmp__._1;
...
function _ipToSockaddr(_family:GoInt, _ip:IP, _port:GoInt, _zone:GoString):{ var _0 : stdgo.syscall.Syscall.Sockaddr; var _1 : Error; } {
        if (_family == stdgo.syscall.Syscall.af_INET) {
            ...
            var _sa:Pointer<stdgo.syscall.Syscall.SockaddrInet4> = Go.pointer((({ port : _port, addr : new GoArray<GoUInt8>(...[for (i in 0 ... 4) ((0 : GoUInt8))]) } : stdgo.syscall.Syscall.SockaddrInet4)));
            ...
            var _sa:Pointer<stdgo.syscall.Syscall.SockaddrInet6> = Go.pointer((({ port : _port, zoneId : ((_zoneCache._index(_zone) : GoUInt32)), addr : new GoArray<GoUInt8>(...[for (i in 0 ... 16) ((0 : GoUInt8))]) } : stdgo.syscall.Syscall.SockaddrInet6)));
...
function _lookupProtocolMap(_name:GoString):{ var _0 : GoInt; var _1 : Error; } {
        ...
        var __tmp__ = _protocols.exists(((_lowerProtocol.__slice__(0, _n) : GoString))) ? { value : _protocols[((_lowerProtocol.__slice__(0, _n) : GoString))], ok : true } : { value : _protocols.defaultValue(), ok : false }, _proto:GoInt = __tmp__.value, _found:Bool = __tmp__.ok;
...
function _lookupPortMap(_network:GoString, _service:GoString):{ var _0 : GoInt; var _1 : Error; } {
        ...
        {
            var __tmp__ = _services.exists(_network) ? { value : _services[_network], ok : true } : { value : _services.defaultValue(), ok : false }, _m:GoMap<GoString, GoInt> = __tmp__.value, _ok:Bool = __tmp__.ok;
            if (_ok) {
                ...
                {
                    var __tmp__ = _m.exists(((_lowerService.__slice__(0, _n) : GoString))) ? { value : _m[((_lowerService.__slice__(0, _n) : GoString))], ok : true } : { value : _m.defaultValue(), ok : false }, _port:GoInt = __tmp__.value, _ok:Bool = __tmp__.ok;
...
function lookupIP(_host:GoString):{ var _0 : Slice<IP>; var _1 : Error; } {
        var __tmp__ = defaultResolver.value.lookupIPAddr(stdgo.context.Context.background(), _host), _addrs:Slice<IPAddr> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Slice<IP>().nil(), _1 : _err };
        };
...
function lookupSRV(_service:GoString, _proto:GoString, _name:GoString):{ var _0 : GoString; var _1 : Slice<Pointer<SRV>>; var _2 : Error; } {
        var _cname:GoString = (("" : GoString)), _addrs:Slice<Pointer<SRV>> = new Slice<Pointer<SRV>>().nil(), _err:Error = ((null : stdgo.Error));
...
function lookupAddr(_addr:GoString):{ var _0 : Slice<GoString>; var _1 : Error; } {
        var _names:Slice<GoString> = new Slice<GoString>().nil(), _err:Error = ((null : stdgo.Error));
...
function parseMAC(_s:GoString):{ var _0 : HardwareAddr; var _1 : Error; } {
        return stdgo.internal.Macro.controlFlow({
            var _hw:HardwareAddr = new HardwareAddr(), _err:Error = ((null : stdgo.Error));
...
**/
function _socket(_ctx:stdgo.context.Context.Context, _net:GoString, _family:GoInt, _sotype:GoInt, _proto:GoInt, _ipv6only:Bool, _laddr:T_sockaddr, _raddr:T_sockaddr, _ctrlFn:(GoString, GoString, stdgo.syscall.Syscall.RawConn) -> Error):{ var _0 : Pointer<T_netFD>; var _1 : Error; } {
        var _fd:Pointer<T_netFD> = Go.pointer((({ _family : _family, _sotype : _sotype, _net : _net, _r : new Pointer<T_bufferedPipe>().nil(), _w : new Pointer<T_bufferedPipe>().nil(), _incoming : new Chan<Pointer<T_netFD>>(0, () -> new Pointer<T_netFD>().nil(), true), _closedMu : new stdgo.sync.Sync.Mutex(), _closed : false, _listener : false, _laddr : ((null : Addr)), _raddr : ((null : Addr)), _pfd : new internal.poll.Poll.FD(), _isConnected : false } : T_netFD)));
        ...
        _fd.value._laddr = Go.pointer((({ ip : ipv4(((127 : GoUInt8)), ((0 : GoUInt8)), ((0 : GoUInt8)), ((1 : GoUInt8))).__copy__(), port : _nextPort(), zone : "" } : TCPAddr))).value;
        _fd.value._raddr = _raddr;
        _fd.value._r = _newBufferedPipe(((65536 : GoInt)));
        _fd.value._w = _newBufferedPipe(((65536 : GoInt)));
        var _fd2:Pointer<T_netFD> = Go.pointer((({ _family : _fd.value._family, _sotype : _sotype, _net : _net, _r : new Pointer<T_bufferedPipe>().nil(), _w : new Pointer<T_bufferedPipe>().nil(), _incoming : new Chan<Pointer<T_netFD>>(0, () -> new Pointer<T_netFD>().nil(), true), _closedMu : new stdgo.sync.Sync.Mutex(), _closed : false, _listener : false, _laddr : ((null : Addr)), _raddr : ((null : Addr)), _pfd : new internal.poll.Poll.FD(), _isConnected : false } : T_netFD)));
        _fd2.value._laddr = _fd.value._raddr;
        _fd2.value._raddr = _fd.value._laddr;
        _fd2.value._r = _fd.value._w;
        _fd2.value._w = _fd.value._r;
        _listenersMu.lock();
        var __tmp__ = _listeners.exists(((_fd.value._raddr.__underlying__().value : TCPAddr)).value.toString()) ? { value : _listeners[((_fd.value._raddr.__underlying__().value : TCPAddr)).value.toString()], ok : true } : { value : _listeners.defaultValue(), ok : false }, _l:Pointer<T_netFD> = __tmp__.value, _ok:Bool = __tmp__.ok;
        if (!_ok) {
            _listenersMu.unlock();
...
function _newBufferedPipe(_softLimit:GoInt):Pointer<T_bufferedPipe> {
        var _p:Pointer<T_bufferedPipe> = Go.pointer((({ _softLimit : _softLimit, _mu : new stdgo.sync.Sync.Mutex(), _buf : new Slice<GoUInt8>().nil(), _closed : false, _rCond : new stdgo.sync.Sync.Cond(), _wCond : new stdgo.sync.Sync.Cond(), _rDeadline : new stdgo.time.Time.Time(), _wDeadline : new stdgo.time.Time.Time() } : T_bufferedPipe)));
...
function _open(_name:GoString):{ var _0 : Pointer<T_file>; var _1 : Error; } {
        var __tmp__ = stdgo.os.Os.open(_name), _fd:Pointer<stdgo.os.Os.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<T_file>().nil(), _1 : _err };
        };
        return { _0 : Go.pointer(new T_file(_fd, new Slice<GoUInt8>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((((64 : GoUnTypedInt)) * ((1024 : GoUnTypedInt)) : GoInt)).toBasic()), false)), _1 : ((null : stdgo.Error)) };
    }
function _stat(_name:GoString):{ var _0 : stdgo.time.Time.Time; var _1 : GoInt64; var _2 : Error; } {
        var _mtime:stdgo.time.Time.Time = new stdgo.time.Time.Time(), _size:GoInt64 = ((0 : GoInt64)), _err:Error = ((null : stdgo.Error));
        var __tmp__ = stdgo.os.Os.stat(_name), _st:io.fs.Fs.FileInfo = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
...
function _splitAtBytes(_s:GoString, _t:GoString):Slice<GoString> {
        var _a:Slice<GoString> = new Slice<GoString>(...[for (i in 0 ... ((((1 : GoInt)) + _countAnyByte(_s, _t) : GoInt)).toBasic()) (("" : GoString))]);
        var _n:GoInt = ((0 : GoInt));
...
function _xtoi2(_s:GoString, _e:GoByte):{ var _0 : GoByte; var _1 : Bool; } {
        ...
        var __tmp__ = _xtoi(_s.__slice__(0, ((2 : GoInt)))), _n:GoInt = __tmp__._0, _ei:GoInt = __tmp__._1, _ok:Bool = __tmp__._2;
...
function _readFull(_r:stdgo.io.Io.Reader):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        var _all:Slice<GoByte> = new Slice<GoUInt8>().nil(), _err:Error = ((null : stdgo.Error));
...
function _makePipeDeadline():T_pipeDeadline {
        return (({ _cancel : new Chan<T_timeoutError>(0, () -> new T_timeoutError()), _mu : new stdgo.sync.Sync.Mutex(), _timer : new Pointer<stdgo.time.Time.Timer>().nil() } : T_pipeDeadline)).__copy__();
    }
...
function pipe():{ var _0 : Conn; var _1 : Conn; } {
        ...
        var _p1:Pointer<T_pipe> = Go.pointer((({ _rdRx : _cb1, _rdTx : _cn1, _wrTx : _cb2, _wrRx : _cn2, _localDone : _done1, _remoteDone : _done2, _readDeadline : _makePipeDeadline().__copy__(), _writeDeadline : _makePipeDeadline().__copy__(), _wrMu : new stdgo.sync.Sync.Mutex(), _once : new stdgo.sync.Sync.Once() } : T_pipe)));
        var _p2:Pointer<T_pipe> = Go.pointer((({ _rdRx : _cb2, _rdTx : _cn2, _wrTx : _cb1, _wrRx : _cn1, _localDone : _done2, _remoteDone : _done1, _readDeadline : _makePipeDeadline().__copy__(), _writeDeadline : _makePipeDeadline().__copy__(), _wrMu : new stdgo.sync.Sync.Mutex(), _once : new stdgo.sync.Sync.Once() } : T_pipe)));
...
function _parsePort(_service:GoString):{ var _0 : GoInt; var _1 : Bool; } {
        ...
        final _max:GoUInt32 = ((((((1 : GoUnTypedInt)) << ((32 : GoUnTypedInt))) - ((1 : GoUnTypedInt))) : GoUInt32)), _cutoff:GoUInt32 = (((((1 : GoUnTypedInt)) << ((30 : GoUnTypedInt))) : GoUInt32));
        var _neg:Bool = false;
...
function _readServices():Void {
        ...
        var deferstack:Array<Void -> Void> = [];
        try {
            var __tmp__ = _open("/etc/services"), _file:Pointer<T_file> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return;
            };
            deferstack.unshift(() -> _file.value._close());
            {
                ...
                Go.cfor(_ok, {
                    ...
                    var __tmp__ = _dtoi(_portnet), _port:GoInt = __tmp__._0, _j:GoInt = __tmp__._1, _ok:Bool = __tmp__._2;
                    if (!_ok || _port <= ((0 : GoInt)) || _j >= _portnet.length || _portnet[_j] != (("/".code : GoRune))) {
                        continue;
                    };
                    var _netw:GoString = _portnet.__slice__(_j + ((1 : GoInt)));
                    var __tmp__ = _services.exists(_netw) ? { value : _services[_netw], ok : true } : { value : _services.defaultValue(), ok : false }, _m:GoMap<GoString, GoInt> = __tmp__.value, _ok1:Bool = __tmp__.ok;
                    if (!_ok1) {
                        _m = new GoMap<GoString, GoInt>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.basic(int_kind))));
                        _services[_netw] = _m;
                    };
                    {
                        var _i:GoInt = ((0 : GoInt));
...
function _sendFile(_c:Pointer<T_netFD>, _r:stdgo.io.Io.Reader):{ var _0 : GoInt64; var _1 : Error; var _2 : Bool; } {
        var _n:GoInt64 = ((0 : GoInt64)), _err:Error = ((null : stdgo.Error)), _handled:Bool = false;
...
function resolveTCPAddr(_network:GoString, _address:GoString):{ var _0 : Pointer<TCPAddr>; var _1 : Error; } {
        ...
        var __tmp__ = defaultResolver.value._internetAddrList(stdgo.context.Context.background(), _network, _address), _addrs:T_addrList = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
...
function dialTCP(_network:GoString, _laddr:Pointer<TCPAddr>, _raddr:Pointer<TCPAddr>):{ var _0 : Pointer<TCPConn>; var _1 : Error; } {
        if (_network == (("tcp" : GoString)) || _network == (("tcp4" : GoString)) || _network == (("tcp6" : GoString))) {} else {
            return { _0 : new Pointer<TCPConn>().nil(), _1 : Go.pointer((({ op : "dial", net : _network, source : _laddr.value._opAddr(), addr : _raddr.value._opAddr(), err : new UnknownNetworkError(_network) } : OpError))).value };
        };
        if (_raddr == null || _raddr.isNil()) {
            return { _0 : new Pointer<TCPConn>().nil(), _1 : Go.pointer((({ op : "dial", net : _network, source : _laddr.value._opAddr(), addr : ((null : Addr)), err : _errMissingAddress } : OpError))).value };
        };
        var _sd:Pointer<T_sysDialer> = Go.pointer((({ _network : _network, _address : _raddr.value.toString(), dialer : new Dialer() } : T_sysDialer)));
        var __tmp__ = _sd.value._dialTCP(stdgo.context.Context.background(), _laddr, _raddr), _c:Pointer<TCPConn> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<TCPConn>().nil(), _1 : Go.pointer((({ op : "dial", net : _network, source : _laddr.value._opAddr(), addr : _raddr.value._opAddr(), err : _err } : OpError))).value };
        };
        return { _0 : _c, _1 : ((null : stdgo.Error)) };
    }
/**
...
function listenTCP(_network:GoString, _laddr:Pointer<TCPAddr>):{ var _0 : Pointer<TCPListener>; var _1 : Error; } {
        if (_network == (("tcp" : GoString)) || _network == (("tcp4" : GoString)) || _network == (("tcp6" : GoString))) {} else {
            return { _0 : new Pointer<TCPListener>().nil(), _1 : Go.pointer((({ op : "listen", net : _network, source : ((null : Addr)), addr : _laddr.value._opAddr(), err : new UnknownNetworkError(_network) } : OpError))).value };
        };
        if (_laddr == null || _laddr.isNil()) {
            _laddr = Go.pointer(new TCPAddr());
        };
        var _sl:Pointer<T_sysListener> = Go.pointer((({ _network : _network, _address : _laddr.value.toString(), listenConfig : new ListenConfig() } : T_sysListener)));
        var __tmp__ = _sl.value._listenTCP(stdgo.context.Context.background(), _laddr), _ln:Pointer<TCPListener> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<TCPListener>().nil(), _1 : Go.pointer((({ op : "listen", net : _network, source : ((null : Addr)), addr : _laddr.value._opAddr(), err : _err } : OpError))).value };
        };
...
function _roundDurationUp(_d:stdgo.time.Time.Duration, _to:stdgo.time.Time.Duration):stdgo.time.Time.Duration {
        return new stdgo.time.Time.Duration((new stdgo.time.Time.Duration(new stdgo.time.Time.Duration(_d.__t__ + _to.__t__).__t__ - ((1 : GoInt64)))).__t__ / _to.__t__);
    }
function _sockaddrToTCP(_sa:stdgo.syscall.Syscall.Sockaddr):Addr {
        if (Go.assertable(((_sa : Pointer<stdgo.syscall.Syscall.SockaddrInet4>)))) {
            ...
            var _sa:Pointer<stdgo.syscall.Syscall.SockaddrInet6> = _sa == null ? null : _sa.__underlying__() == null ? null : _sa == null ? null : _sa.__underlying__().value;
            return Go.pointer((({ ip : new IP(_sa.value.addr.__slice__(((0 : GoInt)))), port : _sa.value.port, zone : _zoneCache._name(((_sa.value.zoneId : GoInt))) } : TCPAddr))).value;
        };
        return ((null : Addr));
    }
...
function dialUDP(_network:GoString, _laddr:Pointer<UDPAddr>, _raddr:Pointer<UDPAddr>):{ var _0 : Pointer<UDPConn>; var _1 : Error; } {
        if (_network == (("udp" : GoString)) || _network == (("udp4" : GoString)) || _network == (("udp6" : GoString))) {} else {
            return { _0 : new Pointer<UDPConn>().nil(), _1 : Go.pointer((({ op : "dial", net : _network, source : _laddr.value._opAddr(), addr : _raddr.value._opAddr(), err : new UnknownNetworkError(_network) } : OpError))).value };
        };
        if (_raddr == null || _raddr.isNil()) {
            return { _0 : new Pointer<UDPConn>().nil(), _1 : Go.pointer((({ op : "dial", net : _network, source : _laddr.value._opAddr(), addr : ((null : Addr)), err : _errMissingAddress } : OpError))).value };
        };
        var _sd:Pointer<T_sysDialer> = Go.pointer((({ _network : _network, _address : _raddr.value.toString(), dialer : new Dialer() } : T_sysDialer)));
        var __tmp__ = _sd.value._dialUDP(stdgo.context.Context.background(), _laddr, _raddr), _c:Pointer<UDPConn> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<UDPConn>().nil(), _1 : Go.pointer((({ op : "dial", net : _network, source : _laddr.value._opAddr(), addr : _raddr.value._opAddr(), err : _err } : OpError))).value };
        };
        return { _0 : _c, _1 : ((null : stdgo.Error)) };
    }
/**
...
function listenUDP(_network:GoString, _laddr:Pointer<UDPAddr>):{ var _0 : Pointer<UDPConn>; var _1 : Error; } {
        if (_network == (("udp" : GoString)) || _network == (("udp4" : GoString)) || _network == (("udp6" : GoString))) {} else {
            return { _0 : new Pointer<UDPConn>().nil(), _1 : Go.pointer((({ op : "listen", net : _network, source : ((null : Addr)), addr : _laddr.value._opAddr(), err : new UnknownNetworkError(_network) } : OpError))).value };
        };
        if (_laddr == null || _laddr.isNil()) {
            _laddr = Go.pointer(new UDPAddr());
        };
        var _sl:Pointer<T_sysListener> = Go.pointer((({ _network : _network, _address : _laddr.value.toString(), listenConfig : new ListenConfig() } : T_sysListener)));
        var __tmp__ = _sl.value._listenUDP(stdgo.context.Context.background(), _laddr), _c:Pointer<UDPConn> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<UDPConn>().nil(), _1 : Go.pointer((({ op : "listen", net : _network, source : ((null : Addr)), addr : _laddr.value._opAddr(), err : _err } : OpError))).value };
        };
        return { _0 : _c, _1 : ((null : stdgo.Error)) };
    }
/**
...
function listenMulticastUDP(_network:GoString, _ifi:Pointer<Interface>, _gaddr:Pointer<UDPAddr>):{ var _0 : Pointer<UDPConn>; var _1 : Error; } {
        if (_network == (("udp" : GoString)) || _network == (("udp4" : GoString)) || _network == (("udp6" : GoString))) {} else {
            return { _0 : new Pointer<UDPConn>().nil(), _1 : Go.pointer((({ op : "listen", net : _network, source : ((null : Addr)), addr : _gaddr.value._opAddr(), err : new UnknownNetworkError(_network) } : OpError))).value };
        };
        if (_gaddr == null || _gaddr.isNil() || _gaddr.value.ip.__t__ == null || _gaddr.value.ip.__t__.isNil()) {
            return { _0 : new Pointer<UDPConn>().nil(), _1 : Go.pointer((({ op : "listen", net : _network, source : ((null : Addr)), addr : _gaddr.value._opAddr(), err : _errMissingAddress } : OpError))).value };
        };
        ...
        var __tmp__ = _sl.value._listenMulticastUDP(stdgo.context.Context.background(), _ifi, _gaddr), _c:Pointer<UDPConn> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<UDPConn>().nil(), _1 : Go.pointer((({ op : "listen", net : _network, source : ((null : Addr)), addr : _gaddr.value._opAddr(), err : _err } : OpError))).value };
        };
        return { _0 : _c, _1 : ((null : stdgo.Error)) };
    }
function _sockaddrToUDP(_sa:stdgo.syscall.Syscall.Sockaddr):Addr {
        if (Go.assertable(((_sa : Pointer<stdgo.syscall.Syscall.SockaddrInet4>)))) {
            ...
            var _sa:Pointer<stdgo.syscall.Syscall.SockaddrInet6> = _sa == null ? null : _sa.__underlying__() == null ? null : _sa == null ? null : _sa.__underlying__().value;
            return Go.pointer((({ ip : new IP(_sa.value.addr.__slice__(((0 : GoInt)))), port : _sa.value.port, zone : _zoneCache._name(((_sa.value.zoneId : GoInt))) } : UDPAddr))).value;
        };
        return ((null : Addr));
    }
...
function dialUnix(_network:GoString, _laddr:Pointer<UnixAddr>, _raddr:Pointer<UnixAddr>):{ var _0 : Pointer<UnixConn>; var _1 : Error; } {
        if (_network == (("unix" : GoString)) || _network == (("unixgram" : GoString)) || _network == (("unixpacket" : GoString))) {} else {
            return { _0 : new Pointer<UnixConn>().nil(), _1 : Go.pointer((({ op : "dial", net : _network, source : _laddr.value._opAddr(), addr : _raddr.value._opAddr(), err : new UnknownNetworkError(_network) } : OpError))).value };
        };
        var _sd:Pointer<T_sysDialer> = Go.pointer((({ _network : _network, _address : _raddr.value.toString(), dialer : new Dialer() } : T_sysDialer)));
        var __tmp__ = _sd.value._dialUnix(stdgo.context.Context.background(), _laddr, _raddr), _c:Pointer<UnixConn> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<UnixConn>().nil(), _1 : Go.pointer((({ op : "dial", net : _network, source : _laddr.value._opAddr(), addr : _raddr.value._opAddr(), err : _err } : OpError))).value };
        };
        return { _0 : _c, _1 : ((null : stdgo.Error)) };
    }
/**
...
function listenUnix(_network:GoString, _laddr:Pointer<UnixAddr>):{ var _0 : Pointer<UnixListener>; var _1 : Error; } {
        if (_network == (("unix" : GoString)) || _network == (("unixpacket" : GoString))) {} else {
            return { _0 : new Pointer<UnixListener>().nil(), _1 : Go.pointer((({ op : "listen", net : _network, source : ((null : Addr)), addr : _laddr.value._opAddr(), err : new UnknownNetworkError(_network) } : OpError))).value };
        };
        if (_laddr == null || _laddr.isNil()) {
            return { _0 : new Pointer<UnixListener>().nil(), _1 : Go.pointer((({ op : "listen", net : _network, source : ((null : Addr)), addr : _laddr.value._opAddr(), err : _errMissingAddress } : OpError))).value };
        };
        var _sl:Pointer<T_sysListener> = Go.pointer((({ _network : _network, _address : _laddr.value.toString(), listenConfig : new ListenConfig() } : T_sysListener)));
        var __tmp__ = _sl.value._listenUnix(stdgo.context.Context.background(), _laddr), _ln:Pointer<UnixListener> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<UnixListener>().nil(), _1 : Go.pointer((({ op : "listen", net : _network, source : ((null : Addr)), addr : _laddr.value._opAddr(), err : _err } : OpError))).value };
        };
        return { _0 : _ln, _1 : ((null : stdgo.Error)) };
    }
/**
...
function listenUnixgram(_network:GoString, _laddr:Pointer<UnixAddr>):{ var _0 : Pointer<UnixConn>; var _1 : Error; } {
        if (_network == (("unixgram" : GoString))) {} else {
            return { _0 : new Pointer<UnixConn>().nil(), _1 : Go.pointer((({ op : "listen", net : _network, source : ((null : Addr)), addr : _laddr.value._opAddr(), err : new UnknownNetworkError(_network) } : OpError))).value };
        };
        if (_laddr == null || _laddr.isNil()) {
            return { _0 : new Pointer<UnixConn>().nil(), _1 : Go.pointer((({ op : "listen", net : _network, source : ((null : Addr)), addr : ((null : Addr)), err : _errMissingAddress } : OpError))).value };
        };
        var _sl:Pointer<T_sysListener> = Go.pointer((({ _network : _network, _address : _laddr.value.toString(), listenConfig : new ListenConfig() } : T_sysListener)));
        var __tmp__ = _sl.value._listenUnixgram(stdgo.context.Context.background(), _laddr), _c:Pointer<UnixConn> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<UnixConn>().nil(), _1 : Go.pointer((({ op : "listen", net : _network, source : ((null : Addr)), addr : _laddr.value._opAddr(), err : _err } : OpError))).value };
        };
        return { _0 : _c, _1 : ((null : stdgo.Error)) };
    }
function _unixSocket(_ctx:stdgo.context.Context.Context, _net:GoString, _laddr:T_sockaddr, _raddr:T_sockaddr, _mode:GoString, _ctrlFn:(GoString, GoString, stdgo.syscall.Syscall.RawConn) -> Error):{ var _0 : Pointer<T_netFD>; var _1 : Error; } {
        ...
        var __tmp__ = _socket(_ctx, _net, stdgo.syscall.Syscall.af_UNIX, _sotype, ((0 : GoInt)), false, _laddr, _raddr, _ctrlFn), _fd:Pointer<T_netFD> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
...
class Dialer_extension_fields {
    public function _dualStack(__tmp__):Bool return __tmp__._dualStack();
    public function _deadline(__tmp__, _ctx:stdgo.context.Context.Context, _now:stdgo.time.Time.Time):stdgo.time.Time.Time return __tmp__._deadline(_ctx, _now);
    public function _resolver(__tmp__):Pointer<Resolver> return __tmp__._resolver();
    public function _fallbackDelay(__tmp__):stdgo.time.Time.Duration return __tmp__._fallbackDelay();
    public function dial(__tmp__, _network:GoString, _address:GoString):{ var _0 : Conn; var _1 : Error; } return __tmp__.dial(_network, _address);
    public function dialContext(__tmp__, _ctx:stdgo.context.Context.Context, _network:GoString, _address:GoString):{ var _0 : Conn; var _1 : Error; } return __tmp__.dialContext(_ctx, _network, _address);
}
class T_sysDialer_extension_fields {
    public function _dialParallel(__tmp__, _ctx:stdgo.context.Context.Context, _primaries:T_addrList, _fallbacks:T_addrList):{ var _0 : Conn; var _1 : Error; } return __tmp__._dialParallel(_ctx, _primaries, _fallbacks);
    public function _dialSerial(__tmp__, _ctx:stdgo.context.Context.Context, _ras:T_addrList):{ var _0 : Conn; var _1 : Error; } return __tmp__._dialSerial(_ctx, _ras);
    public function _dialSingle(__tmp__, _ctx:stdgo.context.Context.Context, _ra:Addr):{ var _0 : Conn; var _1 : Error; } return __tmp__._dialSingle(_ctx, _ra);
    public function _dialIP(__tmp__, _ctx:stdgo.context.Context.Context, _laddr:Pointer<IPAddr>, _raddr:Pointer<IPAddr>):{ var _0 : Pointer<IPConn>; var _1 : Error; } return __tmp__._dialIP(_ctx, _laddr, _raddr);
    public function _dialTCP(__tmp__, _ctx:stdgo.context.Context.Context, _laddr:Pointer<TCPAddr>, _raddr:Pointer<TCPAddr>):{ var _0 : Pointer<TCPConn>; var _1 : Error; } return __tmp__._dialTCP(_ctx, _laddr, _raddr);
    public function _doDialTCP(__tmp__, _ctx:stdgo.context.Context.Context, _laddr:Pointer<TCPAddr>, _raddr:Pointer<TCPAddr>):{ var _0 : Pointer<TCPConn>; var _1 : Error; } return __tmp__._doDialTCP(_ctx, _laddr, _raddr);
    public function _dialUDP(__tmp__, _ctx:stdgo.context.Context.Context, _laddr:Pointer<UDPAddr>, _raddr:Pointer<UDPAddr>):{ var _0 : Pointer<UDPConn>; var _1 : Error; } return __tmp__._dialUDP(_ctx, _laddr, _raddr);
    public function _dialUnix(__tmp__, _ctx:stdgo.context.Context.Context, _laddr:Pointer<UnixAddr>, _raddr:Pointer<UnixAddr>):{ var _0 : Pointer<UnixConn>; var _1 : Error; } return __tmp__._dialUnix(_ctx, _laddr, _raddr);
}
@:structInit class T_dialResult__dialParallel_0 {
    ...
    public function new(?conn:Conn, ?_error:stdgo.Error, ?_primary:Bool, ?_done:Bool) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(conn) + " " + Go.string(_error) + " " + Go.string(_primary) + " " + Go.string(_done) + "}";
    }
    public function close():stdgo.Error return conn.close();
    public function error():GoString return _error.error();
    public function localAddr():Addr return conn.localAddr();
    public function read(_b:Slice<GoUInt8>):{ var _0 : GoInt; var _1 : stdgo.Error; } return conn.read(_0);
    public function remoteAddr():Addr return conn.remoteAddr();
    public function setDeadline(_t:stdgo.time.Time.Time):stdgo.Error return conn.setDeadline(_0);
    public function setReadDeadline(_t:stdgo.time.Time.Time):stdgo.Error return conn.setReadDeadline(_0);
    public function setWriteDeadline(_t:stdgo.time.Time.Time):stdgo.Error return conn.setWriteDeadline(_0);
    public function write(_b:Slice<GoUInt8>):{ var _0 : GoInt; var _1 : stdgo.Error; } return conn.write(_0);
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
class ListenConfig_extension_fields {
    public function listen(__tmp__, _ctx:stdgo.context.Context.Context, _network:GoString, _address:GoString):{ var _0 : Listener; var _1 : Error; } return __tmp__.listen(_ctx, _network, _address);
    public function listenPacket(__tmp__, _ctx:stdgo.context.Context.Context, _network:GoString, _address:GoString):{ var _0 : PacketConn; var _1 : Error; } return __tmp__.listenPacket(_ctx, _network, _address);
}
class T_sysListener_extension_fields {
    public function _listenIP(__tmp__, _ctx:stdgo.context.Context.Context, _laddr:Pointer<IPAddr>):{ var _0 : Pointer<IPConn>; var _1 : Error; } return __tmp__._listenIP(_ctx, _laddr);
    public function _listenTCP(__tmp__, _ctx:stdgo.context.Context.Context, _laddr:Pointer<TCPAddr>):{ var _0 : Pointer<TCPListener>; var _1 : Error; } return __tmp__._listenTCP(_ctx, _laddr);
    public function _listenUDP(__tmp__, _ctx:stdgo.context.Context.Context, _laddr:Pointer<UDPAddr>):{ var _0 : Pointer<UDPConn>; var _1 : Error; } return __tmp__._listenUDP(_ctx, _laddr);
    public function _listenMulticastUDP(__tmp__, _ctx:stdgo.context.Context.Context, _ifi:Pointer<Interface>, _gaddr:Pointer<UDPAddr>):{ var _0 : Pointer<UDPConn>; var _1 : Error; } return __tmp__._listenMulticastUDP(_ctx, _ifi, _gaddr);
    public function _listenUnix(__tmp__, _ctx:stdgo.context.Context.Context, _laddr:Pointer<UnixAddr>):{ var _0 : Pointer<UnixListener>; var _1 : Error; } return __tmp__._listenUnix(_ctx, _laddr);
    public function _listenUnixgram(__tmp__, _ctx:stdgo.context.Context.Context, _laddr:Pointer<UnixAddr>):{ var _0 : Pointer<UnixConn>; var _1 : Error; } return __tmp__._listenUnixgram(_ctx, _laddr);
}
class T_byPriorityWeight_extension_fields {
    ...
    public function _shuffleByWeight(__tmp__):Void __tmp__._shuffleByWeight();
    public function _sort(__tmp__):Void __tmp__._sort();
}
...
class T_fileAddr_extension_fields {
    public function network(__tmp__):GoString return __tmp__.network();
    public function toString(__tmp__):GoString return __tmp__.toString();
}
class Interface_extension_fields {
    public function addrs(__tmp__):{ var _0 : Slice<Addr>; var _1 : Error; } return __tmp__.addrs();
    public function multicastAddrs(__tmp__):{ var _0 : Slice<Addr>; var _1 : Error; } return __tmp__.multicastAddrs();
}
class Flags_extension_fields {
    public function toString(__tmp__):GoString return __tmp__.toString();
}
class T_ipv6ZoneCache_extension_fields {
    public function _update(__tmp__, _ift:Slice<Interface>, _force:Bool):Bool return __tmp__._update(_ift, _force);
    public function _name(__tmp__, _index:GoInt):GoString return __tmp__._name(_index);
    public function _index(__tmp__, _name:GoString):GoInt return __tmp__._index(_name);
}
class IP_extension_fields {
    public function isUnspecified(__tmp__):Bool return __tmp__.isUnspecified();
    public function isLoopback(__tmp__):Bool return __tmp__.isLoopback();
    public function isPrivate(__tmp__):Bool return __tmp__.isPrivate();
    public function isMulticast(__tmp__):Bool return __tmp__.isMulticast();
    public function isInterfaceLocalMulticast(__tmp__):Bool return __tmp__.isInterfaceLocalMulticast();
    public function isLinkLocalMulticast(__tmp__):Bool return __tmp__.isLinkLocalMulticast();
    public function isLinkLocalUnicast(__tmp__):Bool return __tmp__.isLinkLocalUnicast();
    public function isGlobalUnicast(__tmp__):Bool return __tmp__.isGlobalUnicast();
    public function to4(__tmp__):IP return __tmp__.to4();
    public function to16(__tmp__):IP return __tmp__.to16();
    public function defaultMask(__tmp__):IPMask return __tmp__.defaultMask();
    public function mask(__tmp__, _mask:IPMask):IP return __tmp__.mask(_mask);
    public function toString(__tmp__):GoString return __tmp__.toString();
    ...
    public function equal(__tmp__, _x:IP):Bool return __tmp__.equal(_x);
    public function _matchAddrFamily(__tmp__, _x:IP):Bool return __tmp__._matchAddrFamily(_x);
}
class IPMask_extension_fields {
    public function size(__tmp__):{ var _0 : GoInt; var _1 : GoInt; } return __tmp__.size();
    public function toString(__tmp__):GoString return __tmp__.toString();
}
class IPNet_extension_fields {
    public function contains(__tmp__, _ip:IP):Bool return __tmp__.contains(_ip);
    public function network(__tmp__):GoString return __tmp__.network();
    public function toString(__tmp__):GoString return __tmp__.toString();
}
class IPAddr_extension_fields {
    public function network(__tmp__):GoString return __tmp__.network();
    public function toString(__tmp__):GoString return __tmp__.toString();
    public function _isWildcard(__tmp__):Bool return __tmp__._isWildcard();
    public function _opAddr(__tmp__):Addr return __tmp__._opAddr();
    public function _family(__tmp__):GoInt return __tmp__._family();
    public function _sockaddr(__tmp__, _family:GoInt):{ var _0 : stdgo.syscall.Syscall.Sockaddr; var _1 : Error; } return __tmp__._sockaddr(_family);
    public function _toLocal(__tmp__, _net:GoString):T_sockaddr return __tmp__._toLocal(_net);
}
class IPConn_extension_fields {
    public function syscallConn(__tmp__):{ var _0 : stdgo.syscall.Syscall.RawConn; var _1 : Error; } return __tmp__.syscallConn();
    public function readFromIP(__tmp__, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Pointer<IPAddr>; var _2 : Error; } return __tmp__.readFromIP(_b);
    public function readFrom(__tmp__, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Addr; var _2 : Error; } return __tmp__.readFrom(_b);
    public function readMsgIP(__tmp__, _b:Slice<GoByte>, _oob:Slice<GoByte>):{ var _0 : GoInt; var _1 : GoInt; var _2 : GoInt; var _3 : Pointer<IPAddr>; var _4 : Error; } return __tmp__.readMsgIP(_b, _oob);
    public function writeToIP(__tmp__, _b:Slice<GoByte>, _addr:Pointer<IPAddr>):{ var _0 : GoInt; var _1 : Error; } return __tmp__.writeToIP(_b, _addr);
    public function writeTo(__tmp__, _b:Slice<GoByte>, _addr:Addr):{ var _0 : GoInt; var _1 : Error; } return __tmp__.writeTo(_b, _addr);
    public function writeMsgIP(__tmp__, _b:Slice<GoByte>, _oob:Slice<GoByte>, _addr:Pointer<IPAddr>):{ var _0 : GoInt; var _1 : GoInt; var _2 : Error; } return __tmp__.writeMsgIP(_b, _oob, _addr);
    public function _readFrom(__tmp__, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Pointer<IPAddr>; var _2 : Error; } return __tmp__._readFrom(_b);
    public function _readMsg(__tmp__, _b:Slice<GoByte>, _oob:Slice<GoByte>):{ var _0 : GoInt; var _1 : GoInt; var _2 : GoInt; var _3 : Pointer<IPAddr>; var _4 : Error; } return __tmp__._readMsg(_b, _oob);
    public function _writeTo(__tmp__, _b:Slice<GoByte>, _addr:Pointer<IPAddr>):{ var _0 : GoInt; var _1 : Error; } return __tmp__._writeTo(_b, _addr);
    public function _writeMsg(__tmp__, _b:Slice<GoByte>, _oob:Slice<GoByte>, _addr:Pointer<IPAddr>):{ var _0 : GoInt; var _1 : GoInt; var _2 : Error; } return __tmp__._writeMsg(_b, _oob, _addr);
}
class T_ipStackCapabilities_extension_fields {
    public function _probe(__tmp__):Void __tmp__._probe();
}
class T_addrList_extension_fields {
    public function _forResolve(__tmp__, _network:GoString, _addr:GoString):Addr return __tmp__._forResolve(_network, _addr);
    public function _first(__tmp__, _strategy:Addr -> Bool):Addr return __tmp__._first(_strategy);
    public function _partition(__tmp__, _strategy:Addr -> Bool):{ var _0 : T_addrList; var _1 : T_addrList; } return __tmp__._partition(_strategy);
}
class Resolver_extension_fields {
    public function _resolveAddrList(__tmp__, _ctx:stdgo.context.Context.Context, _op:GoString, _network:GoString, _addr:GoString, _hint:Addr):{ var _0 : T_addrList; var _1 : Error; } return __tmp__._resolveAddrList(_ctx, _op, _network, _addr, _hint);
    public function _internetAddrList(__tmp__, _ctx:stdgo.context.Context.Context, _net:GoString, _addr:GoString):{ var _0 : T_addrList; var _1 : Error; } return __tmp__._internetAddrList(_ctx, _net, _addr);
    public function _preferGo(__tmp__):Bool return __tmp__._preferGo();
    public function _strictErrors(__tmp__):Bool return __tmp__._strictErrors();
    public function _getLookupGroup(__tmp__):Pointer<internal.singleflight.Singleflight.Group> return __tmp__._getLookupGroup();
    public function lookupHost(__tmp__, _ctx:stdgo.context.Context.Context, _host:GoString):{ var _0 : Slice<GoString>; var _1 : Error; } return __tmp__.lookupHost(_ctx, _host);
    public function lookupIPAddr(__tmp__, _ctx:stdgo.context.Context.Context, _host:GoString):{ var _0 : Slice<IPAddr>; var _1 : Error; } return __tmp__.lookupIPAddr(_ctx, _host);
    public function lookupIP(__tmp__, _ctx:stdgo.context.Context.Context, _network:GoString, _host:GoString):{ var _0 : Slice<IP>; var _1 : Error; } return __tmp__.lookupIP(_ctx, _network, _host);
    public function _lookupIPAddr(__tmp__, _ctx:stdgo.context.Context.Context, _network:GoString, _host:GoString):{ var _0 : Slice<IPAddr>; var _1 : Error; } return __tmp__._lookupIPAddr(_ctx, _network, _host);
    public function lookupPort(__tmp__, _ctx:stdgo.context.Context.Context, _network:GoString, _service:GoString):{ var _0 : GoInt; var _1 : Error; } return __tmp__.lookupPort(_ctx, _network, _service);
    public function lookupCNAME(__tmp__, _ctx:stdgo.context.Context.Context, _host:GoString):{ var _0 : GoString; var _1 : Error; } return __tmp__.lookupCNAME(_ctx, _host);
    public function lookupSRV(__tmp__, _ctx:stdgo.context.Context.Context, _service:GoString, _proto:GoString, _name:GoString):{ var _0 : GoString; var _1 : Slice<Pointer<SRV>>; var _2 : Error; } return __tmp__.lookupSRV(_ctx, _service, _proto, _name);
    public function lookupMX(__tmp__, _ctx:stdgo.context.Context.Context, _name:GoString):{ var _0 : Slice<Pointer<MX>>; var _1 : Error; } return __tmp__.lookupMX(_ctx, _name);
    public function lookupNS(__tmp__, _ctx:stdgo.context.Context.Context, _name:GoString):{ var _0 : Slice<Pointer<NS>>; var _1 : Error; } return __tmp__.lookupNS(_ctx, _name);
    public function lookupTXT(__tmp__, _ctx:stdgo.context.Context.Context, _name:GoString):{ var _0 : Slice<GoString>; var _1 : Error; } return __tmp__.lookupTXT(_ctx, _name);
    public function lookupAddr(__tmp__, _ctx:stdgo.context.Context.Context, _addr:GoString):{ var _0 : Slice<GoString>; var _1 : Error; } return __tmp__.lookupAddr(_ctx, _addr);
    public function _lookupHost(__tmp__, _ctx:stdgo.context.Context.Context, _host:GoString):{ var _0 : Slice<GoString>; var _1 : Error; } return __tmp__._lookupHost(_ctx, _host);
    public function _lookupIP(__tmp__, _ctx:stdgo.context.Context.Context, _network:GoString, _host:GoString):{ var _0 : Slice<IPAddr>; var _1 : Error; } return __tmp__._lookupIP(_ctx, _network, _host);
    public function _lookupPort(__tmp__, _ctx:stdgo.context.Context.Context, _network:GoString, _service:GoString):{ var _0 : GoInt; var _1 : Error; } return __tmp__._lookupPort(_ctx, _network, _service);
    public function _lookupCNAME(__tmp__, _ctx:stdgo.context.Context.Context, _name:GoString):{ var _0 : GoString; var _1 : Error; } return __tmp__._lookupCNAME(_ctx, _name);
    public function _lookupSRV(__tmp__, _ctx:stdgo.context.Context.Context, _service:GoString, _proto:GoString, _name:GoString):{ var _0 : GoString; var _1 : Slice<Pointer<SRV>>; var _2 : Error; } return __tmp__._lookupSRV(_ctx, _service, _proto, _name);
    public function _lookupMX(__tmp__, _ctx:stdgo.context.Context.Context, _name:GoString):{ var _0 : Slice<Pointer<MX>>; var _1 : Error; } return __tmp__._lookupMX(_ctx, _name);
    public function _lookupNS(__tmp__, _ctx:stdgo.context.Context.Context, _name:GoString):{ var _0 : Slice<Pointer<NS>>; var _1 : Error; } return __tmp__._lookupNS(_ctx, _name);
    public function _lookupTXT(__tmp__, _ctx:stdgo.context.Context.Context, _name:GoString):{ var _0 : Slice<GoString>; var _1 : Error; } return __tmp__._lookupTXT(_ctx, _name);
    public function _lookupAddr(__tmp__, _ctx:stdgo.context.Context.Context, _addr:GoString):{ var _0 : Slice<GoString>; var _1 : Error; } return __tmp__._lookupAddr(_ctx, _addr);
}
class T_onlyValuesCtx_extension_fields {
    public function value(__tmp__, _key:AnyInterface):AnyInterface return __tmp__.value(_key);
}
class HardwareAddr_extension_fields {
    public function toString(__tmp__):GoString return __tmp__.toString();
}
class T_conn_extension_fields {
    public function _ok(__tmp__):Bool return __tmp__._ok();
    ...
    public function localAddr(__tmp__):Addr return __tmp__.localAddr();
    public function remoteAddr(__tmp__):Addr return __tmp__.remoteAddr();
    ...
    public function setReadBuffer(__tmp__, _bytes:GoInt):Error return __tmp__.setReadBuffer(_bytes);
    public function setWriteBuffer(__tmp__, _bytes:GoInt):Error return __tmp__.setWriteBuffer(_bytes);
    public function file(__tmp__):{ var _0 : Pointer<stdgo.os.Os.File>; var _1 : Error; } return __tmp__.file();
}
...
class Buffers_extension_fields {
    ...
    public function _consume(__tmp__, _n:GoInt64):Void __tmp__._consume(_n);
}
class T_netFD_extension_fields {
    ...
    public function close(__tmp__):Error return __tmp__.close();
    public function _closeRead(__tmp__):Error return __tmp__._closeRead();
    public function _closeWrite(__tmp__):Error return __tmp__._closeWrite();
    public function _accept(__tmp__):{ var _0 : Pointer<T_netFD>; var _1 : Error; } return __tmp__._accept();
    public function setDeadline(__tmp__, _t:stdgo.time.Time.Time):Error return __tmp__.setDeadline(_t);
    public function setReadDeadline(__tmp__, _t:stdgo.time.Time.Time):Error return __tmp__.setReadDeadline(_t);
    public function setWriteDeadline(__tmp__, _t:stdgo.time.Time.Time):Error return __tmp__.setWriteDeadline(_t);
    public function _readFrom(__tmp__, _p:Slice<GoByte>):{ var _0 : GoInt; var _1 : stdgo.syscall.Syscall.Sockaddr; var _2 : Error; } return __tmp__._readFrom(_p);
    public function _readMsg(__tmp__, _p:Slice<GoByte>, _oob:Slice<GoByte>, _flags:GoInt):{ var _0 : GoInt; var _1 : GoInt; var _2 : GoInt; var _3 : stdgo.syscall.Syscall.Sockaddr; var _4 : Error; } return __tmp__._readMsg(_p, _oob, _flags);
    public function _writeTo(__tmp__, _p:Slice<GoByte>, _sa:stdgo.syscall.Syscall.Sockaddr):{ var _0 : GoInt; var _1 : Error; } return __tmp__._writeTo(_p, _sa);
    public function _writeMsg(__tmp__, _p:Slice<GoByte>, _oob:Slice<GoByte>, _sa:stdgo.syscall.Syscall.Sockaddr):{ var _0 : GoInt; var _1 : GoInt; var _2 : Error; } return __tmp__._writeMsg(_p, _oob, _sa);
    public function _dup(__tmp__):{ var _0 : Pointer<stdgo.os.Os.File>; var _1 : Error; } return __tmp__._dup();
}
class T_bufferedPipe_extension_fields {
    public function read(__tmp__, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } return __tmp__.read(_b);
    public function write(__tmp__, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } return __tmp__.write(_b);
    public function close(__tmp__):Void __tmp__.close();
    public function setReadDeadline(__tmp__, _t:stdgo.time.Time.Time):Void __tmp__.setReadDeadline(_t);
    public function setWriteDeadline(__tmp__, _t:stdgo.time.Time.Time):Void __tmp__.setWriteDeadline(_t);
}
class T_file_extension_fields {
    public function _close(__tmp__):Void __tmp__._close();
    public function _getLineFromData(__tmp__):{ var _0 : GoString; var _1 : Bool; } return __tmp__._getLineFromData();
    public function _readLine(__tmp__):{ var _0 : GoString; var _1 : Bool; } return __tmp__._readLine();
}
class T_pipeDeadline_extension_fields {
    public function _set(__tmp__, _t:stdgo.time.Time.Time):Void __tmp__._set(_t);
    public function _wait(__tmp__):Chan<T__struct_44> return __tmp__._wait();
}
...
class T_pipe_extension_fields {
    ...
    public function remoteAddr(__tmp__):Addr return __tmp__.remoteAddr();
    public function read(__tmp__, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } return __tmp__.read(_b);
    public function _read(__tmp__, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } return __tmp__._read(_b);
    public function write(__tmp__, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } return __tmp__.write(_b);
...
class T_rawConn_extension_fields {
    public function _ok(__tmp__):Bool return __tmp__._ok();
    public function control(__tmp__, _f:GoUIntptr -> Void):Error return __tmp__.control(_f);
    public function read(__tmp__, _f:GoUIntptr -> Bool):Error return __tmp__.read(_f);
    public function write(__tmp__, _f:GoUIntptr -> Bool):Error return __tmp__.write(_f);
}
class T_rawListener_extension_fields {
    public function read(__tmp__, arg0:GoUIntptr -> Bool):Error return __tmp__.read(arg0);
    public function write(__tmp__, arg0:GoUIntptr -> Bool):Error return __tmp__.write(arg0);
}
...
class TCPConn_extension_fields {
    ...
    public function closeRead(__tmp__):Error return __tmp__.closeRead();
    public function closeWrite(__tmp__):Error return __tmp__.closeWrite();
    public function setLinger(__tmp__, _sec:GoInt):Error return __tmp__.setLinger(_sec);
    public function setKeepAlive(__tmp__, _keepalive:Bool):Error return __tmp__.setKeepAlive(_keepalive);
    public function setKeepAlivePeriod(__tmp__, _d:stdgo.time.Time.Duration):Error return __tmp__.setKeepAlivePeriod(_d);
    public function setNoDelay(__tmp__, _noDelay:Bool):Error return __tmp__.setNoDelay(_noDelay);
...
class TCPListener_extension_fields {
    public function syscallConn(__tmp__):{ var _0 : stdgo.syscall.Syscall.RawConn; var _1 : Error; } return __tmp__.syscallConn();
    public function acceptTCP(__tmp__):{ var _0 : Pointer<TCPConn>; var _1 : Error; } return __tmp__.acceptTCP();
    public function accept(__tmp__):{ var _0 : Conn; var _1 : Error; } return __tmp__.accept();
    public function close(__tmp__):Error return __tmp__.close();
    public function addr(__tmp__):Addr return __tmp__.addr();
    public function setDeadline(__tmp__, _t:stdgo.time.Time.Time):Error return __tmp__.setDeadline(_t);
    public function file(__tmp__):{ var _0 : Pointer<stdgo.os.Os.File>; var _1 : Error; } return __tmp__.file();
    public function _ok(__tmp__):Bool return __tmp__._ok();
    public function _accept(__tmp__):{ var _0 : Pointer<TCPConn>; var _1 : Error; } return __tmp__._accept();
    public function _close(__tmp__):Error return __tmp__._close();
    public function _file(__tmp__):{ var _0 : Pointer<stdgo.os.Os.File>; var _1 : Error; } return __tmp__._file();
}
...
class UDPConn_extension_fields {
    public function syscallConn(__tmp__):{ var _0 : stdgo.syscall.Syscall.RawConn; var _1 : Error; } return __tmp__.syscallConn();
    public function readFromUDP(__tmp__, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Pointer<UDPAddr>; var _2 : Error; } return __tmp__.readFromUDP(_b);
    public function _readFromUDP(__tmp__, _b:Slice<GoByte>, _addr:Pointer<UDPAddr>):{ var _0 : GoInt; var _1 : Pointer<UDPAddr>; var _2 : Error; } return __tmp__._readFromUDP(_b, _addr);
    public function readFrom(__tmp__, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Addr; var _2 : Error; } return __tmp__.readFrom(_b);
    public function readMsgUDP(__tmp__, _b:Slice<GoByte>, _oob:Slice<GoByte>):{ var _0 : GoInt; var _1 : GoInt; var _2 : GoInt; var _3 : Pointer<UDPAddr>; var _4 : Error; } return __tmp__.readMsgUDP(_b, _oob);
    public function writeToUDP(__tmp__, _b:Slice<GoByte>, _addr:Pointer<UDPAddr>):{ var _0 : GoInt; var _1 : Error; } return __tmp__.writeToUDP(_b, _addr);
    public function writeTo(__tmp__, _b:Slice<GoByte>, _addr:Addr):{ var _0 : GoInt; var _1 : Error; } return __tmp__.writeTo(_b, _addr);
    public function writeMsgUDP(__tmp__, _b:Slice<GoByte>, _oob:Slice<GoByte>, _addr:Pointer<UDPAddr>):{ var _0 : GoInt; var _1 : GoInt; var _2 : Error; } return __tmp__.writeMsgUDP(_b, _oob, _addr);
    public function _readFrom(__tmp__, _b:Slice<GoByte>, _addr:Pointer<UDPAddr>):{ var _0 : GoInt; var _1 : Pointer<UDPAddr>; var _2 : Error; } return __tmp__._readFrom(_b, _addr);
    public function _readMsg(__tmp__, _b:Slice<GoByte>, _oob:Slice<GoByte>):{ var _0 : GoInt; var _1 : GoInt; var _2 : GoInt; var _3 : Pointer<UDPAddr>; var _4 : Error; } return __tmp__._readMsg(_b, _oob);
    public function _writeTo(__tmp__, _b:Slice<GoByte>, _addr:Pointer<UDPAddr>):{ var _0 : GoInt; var _1 : Error; } return __tmp__._writeTo(_b, _addr);
    public function _writeMsg(__tmp__, _b:Slice<GoByte>, _oob:Slice<GoByte>, _addr:Pointer<UDPAddr>):{ var _0 : GoInt; var _1 : GoInt; var _2 : Error; } return __tmp__._writeMsg(_b, _oob, _addr);
}
...
class UnixConn_extension_fields {
    ...
    public function closeRead(__tmp__):Error return __tmp__.closeRead();
    public function closeWrite(__tmp__):Error return __tmp__.closeWrite();
    public function readFromUnix(__tmp__, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Pointer<UnixAddr>; var _2 : Error; } return __tmp__.readFromUnix(_b);
    public function readFrom(__tmp__, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Addr; var _2 : Error; } return __tmp__.readFrom(_b);
    public function readMsgUnix(__tmp__, _b:Slice<GoByte>, _oob:Slice<GoByte>):{ var _0 : GoInt; var _1 : GoInt; var _2 : GoInt; var _3 : Pointer<UnixAddr>; var _4 : Error; } return __tmp__.readMsgUnix(_b, _oob);
    public function writeToUnix(__tmp__, _b:Slice<GoByte>, _addr:Pointer<UnixAddr>):{ var _0 : GoInt; var _1 : Error; } return __tmp__.writeToUnix(_b, _addr);
    public function writeTo(__tmp__, _b:Slice<GoByte>, _addr:Addr):{ var _0 : GoInt; var _1 : Error; } return __tmp__.writeTo(_b, _addr);
    public function writeMsgUnix(__tmp__, _b:Slice<GoByte>, _oob:Slice<GoByte>, _addr:Pointer<UnixAddr>):{ var _0 : GoInt; var _1 : GoInt; var _2 : Error; } return __tmp__.writeMsgUnix(_b, _oob, _addr);
    public function _readFrom(__tmp__, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Pointer<UnixAddr>; var _2 : Error; } return __tmp__._readFrom(_b);
    public function _readMsg(__tmp__, _b:Slice<GoByte>, _oob:Slice<GoByte>):{ var _0 : GoInt; var _1 : GoInt; var _2 : GoInt; var _3 : Pointer<UnixAddr>; var _4 : Error; } return __tmp__._readMsg(_b, _oob);
    public function _writeTo(__tmp__, _b:Slice<GoByte>, _addr:Pointer<UnixAddr>):{ var _0 : GoInt; var _1 : Error; } return __tmp__._writeTo(_b, _addr);
    public function _writeMsg(__tmp__, _b:Slice<GoByte>, _oob:Slice<GoByte>, _addr:Pointer<UnixAddr>):{ var _0 : GoInt; var _1 : GoInt; var _2 : Error; } return __tmp__._writeMsg(_b, _oob, _addr);
}
class UnixListener_extension_fields {
    public function _ok(__tmp__):Bool return __tmp__._ok();
    public function syscallConn(__tmp__):{ var _0 : stdgo.syscall.Syscall.RawConn; var _1 : Error; } return __tmp__.syscallConn();
    public function acceptUnix(__tmp__):{ var _0 : Pointer<UnixConn>; var _1 : Error; } return __tmp__.acceptUnix();
    public function accept(__tmp__):{ var _0 : Conn; var _1 : Error; } return __tmp__.accept();
    public function close(__tmp__):Error return __tmp__.close();
    public function addr(__tmp__):Addr return __tmp__.addr();
    public function setDeadline(__tmp__, _t:stdgo.time.Time.Time):Error return __tmp__.setDeadline(_t);
    public function file(__tmp__):{ var _0 : Pointer<stdgo.os.Os.File>; var _1 : Error; } return __tmp__.file();
    public function _accept(__tmp__):{ var _0 : Pointer<UnixConn>; var _1 : Error; } return __tmp__._accept();
    public function _close(__tmp__):Error return __tmp__._close();
    public function _file(__tmp__):{ var _0 : Pointer<stdgo.os.Os.File>; var _1 : Error; } return __tmp__._file();
    public function setUnlinkOnClose(__tmp__, _unlink:Bool):Void __tmp__.setUnlinkOnClose(_unlink);
}
