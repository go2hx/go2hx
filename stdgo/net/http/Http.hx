...
/**
    /|*{
    	...
    	_ = gotoNext == 7875426
    	n = 0
    	cutoff_7874841 = http2cutoff64(base)
    	maxVal_7874849 = 1<<uint(bitSize) - 1
    	i_7875499 = 0
    	gotoNext = 7875495
    	_ = gotoNext == 7875495
    	if i_7875499 < len(s) {
    		gotoNext = 7875523
    		_ = gotoNext == 7875523
    		d_7875540 = s[i_7875499]
    		gotoNext = 7875552
    		_ = gotoNext == 7875552
    		switch {
    		case 48 <= d_7875540 && d_7875540 <= 57:
    			gotoNext = 7875563
    			_ = gotoNext == 7875563
    			v_7875531 = d_7875540 - 48
    			gotoNext = 7875770
    		case 97 <= d_7875540 && d_7875540 <= 122:
    			gotoNext = 7875607
    			_ = gotoNext == 7875607
    			v_7875531 = d_7875540 - 97 + 10
    			gotoNext = 7875770
    		case 65 <= d_7875540 && d_7875540 <= 90:
    			gotoNext = 7875656
    			_ = gotoNext == 7875656
    			v_7875531 = d_7875540 - 65 + 10
    			gotoNext = 7875770
    		default:
    			gotoNext = 7875705
    			_ = gotoNext == 7875705
    		...
    		_ = gotoNext == 7875950
    		n *= uint64(base)
    		n1_7875971 = n + uint64(v_7875531)
    		if n1_7875971 < n || n1_7875971 > maxVal_7874849 {
    			gotoNext = 7876018
    			_ = gotoNext == 7876018
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7876130
    	_ = gotoNext == 7876130
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7874921), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
