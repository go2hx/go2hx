...
/**
    /|*{
    	...
    	_ = gotoNext == 7596422
    	n = 0
    	cutoff_7595837 = http2cutoff64(base)
    	maxVal_7595845 = 1<<uint(bitSize) - 1
    	i_7596495 = 0
    	gotoNext = 7596491
    	_ = gotoNext == 7596491
    	if i_7596495 < len(s) {
    		gotoNext = 7596519
    		_ = gotoNext == 7596519
    		d_7596536 = s[i_7596495]
    		gotoNext = 7596548
    		_ = gotoNext == 7596548
    		switch {
    		case 48 <= d_7596536 && d_7596536 <= 57:
    			gotoNext = 7596559
    			_ = gotoNext == 7596559
    			v_7596527 = d_7596536 - 48
    			gotoNext = 7596766
    		case 97 <= d_7596536 && d_7596536 <= 122:
    			gotoNext = 7596603
    			_ = gotoNext == 7596603
    			v_7596527 = d_7596536 - 97 + 10
    			gotoNext = 7596766
    		case 65 <= d_7596536 && d_7596536 <= 90:
    			gotoNext = 7596652
    			_ = gotoNext == 7596652
    			v_7596527 = d_7596536 - 65 + 10
    			gotoNext = 7596766
    		default:
    			gotoNext = 7596701
    			_ = gotoNext == 7596701
    		...
    		_ = gotoNext == 7596946
    		n *= uint64(base)
    		n1_7596967 = n + uint64(v_7596527)
    		if n1_7596967 < n || n1_7596967 > maxVal_7595845 {
    			gotoNext = 7597014
    			_ = gotoNext == 7597014
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7597126
    	_ = gotoNext == 7597126
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7595917), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
