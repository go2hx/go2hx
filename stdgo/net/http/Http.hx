...
/**
    /|*{
    	...
    	_ = gotoNext == 7627724
    	n = 0
    	cutoff_7627139 = http2cutoff64(base)
    	maxVal_7627147 = 1<<uint(bitSize) - 1
    	i_7627797 = 0
    	gotoNext = 7627793
    	_ = gotoNext == 7627793
    	if i_7627797 < len(s) {
    		gotoNext = 7627821
    		_ = gotoNext == 7627821
    		d_7627838 = s[i_7627797]
    		_ = 0
    		gotoNext = 7627850
    		_ = gotoNext == 7627850
    		switch {
    		case 48 <= d_7627838 && d_7627838 <= 57:
    			gotoNext = 7627861
    			_ = gotoNext == 7627861
    			v_7627829 = d_7627838 - 48
    			gotoNext = 7628068
    		case 97 <= d_7627838 && d_7627838 <= 122:
    			gotoNext = 7627905
    			_ = gotoNext == 7627905
    			v_7627829 = d_7627838 - 97 + 10
    			gotoNext = 7628068
    		case 65 <= d_7627838 && d_7627838 <= 90:
    			gotoNext = 7627954
    			_ = gotoNext == 7627954
    			v_7627829 = d_7627838 - 65 + 10
    			gotoNext = 7628068
    		default:
    			gotoNext = 7628003
    			_ = gotoNext == 7628003
    		...
    		_ = gotoNext == 7628248
    		n *= uint64(base)
    		n1_7628269 = n + uint64(v_7627829)
    		if n1_7628269 < n || n1_7628269 > maxVal_7627147 {
    			gotoNext = 7628316
    			_ = gotoNext == 7628316
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7628428
    	_ = gotoNext == 7628428
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7627219), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
