...
/**
    /|*{
    	...
    	_ = gotoNext == 7687358
    	n = 0
    	cutoff_7686773 = http2cutoff64(base)
    	maxVal_7686781 = 1<<uint(bitSize) - 1
    	i_7687431 = 0
    	gotoNext = 7687427
    	_ = gotoNext == 7687427
    	if i_7687431 < len(s) {
    		gotoNext = 7687455
    		_ = gotoNext == 7687455
    		d_7687472 = s[i_7687431]
    		gotoNext = 7687484
    		_ = gotoNext == 7687484
    		switch {
    		case 48 <= d_7687472 && d_7687472 <= 57:
    			gotoNext = 7687495
    			_ = gotoNext == 7687495
    			v_7687463 = d_7687472 - 48
    			gotoNext = 7687702
    		case 97 <= d_7687472 && d_7687472 <= 122:
    			gotoNext = 7687539
    			_ = gotoNext == 7687539
    			v_7687463 = d_7687472 - 97 + 10
    			gotoNext = 7687702
    		case 65 <= d_7687472 && d_7687472 <= 90:
    			gotoNext = 7687588
    			_ = gotoNext == 7687588
    			v_7687463 = d_7687472 - 65 + 10
    			gotoNext = 7687702
    		default:
    			gotoNext = 7687637
    			_ = gotoNext == 7687637
    		...
    		_ = gotoNext == 7687882
    		n *= uint64(base)
    		n1_7687903 = n + uint64(v_7687463)
    		if n1_7687903 < n || n1_7687903 > maxVal_7686781 {
    			gotoNext = 7687950
    			_ = gotoNext == 7687950
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7688062
    	_ = gotoNext == 7688062
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7686853), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
