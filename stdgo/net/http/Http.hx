...
/**
    /|*{
    	...
    	_ = gotoNext == 7697700
    	n = 0
    	cutoff_7697115 = http2cutoff64(base)
    	maxVal_7697123 = 1<<uint(bitSize) - 1
    	i_7697773 = 0
    	gotoNext = 7697769
    	_ = gotoNext == 7697769
    	if i_7697773 < len(s) {
    		gotoNext = 7697797
    		_ = gotoNext == 7697797
    		d_7697814 = s[i_7697773]
    		_ = 0
    		gotoNext = 7697826
    		_ = gotoNext == 7697826
    		switch {
    		case 48 <= d_7697814 && d_7697814 <= 57:
    			gotoNext = 7697837
    			_ = gotoNext == 7697837
    			v_7697805 = d_7697814 - 48
    			gotoNext = 7698044
    		case 97 <= d_7697814 && d_7697814 <= 122:
    			gotoNext = 7697881
    			_ = gotoNext == 7697881
    			v_7697805 = d_7697814 - 97 + 10
    			gotoNext = 7698044
    		case 65 <= d_7697814 && d_7697814 <= 90:
    			gotoNext = 7697930
    			_ = gotoNext == 7697930
    			v_7697805 = d_7697814 - 65 + 10
    			gotoNext = 7698044
    		default:
    			gotoNext = 7697979
    			_ = gotoNext == 7697979
    		...
    		_ = gotoNext == 7698224
    		n *= uint64(base)
    		n1_7698245 = n + uint64(v_7697805)
    		if n1_7698245 < n || n1_7698245 > maxVal_7697123 {
    			gotoNext = 7698292
    			_ = gotoNext == 7698292
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7698404
    	_ = gotoNext == 7698404
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7697195), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
