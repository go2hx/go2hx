...
/**
    /|*{
    	...
    	_ = gotoNext == 7835533
    	n = 0
    	cutoff_7834948 = http2cutoff64(base)
    	maxVal_7834956 = 1<<uint(bitSize) - 1
    	i_7835606 = 0
    	gotoNext = 7835602
    	_ = gotoNext == 7835602
    	if i_7835606 < len(s) {
    		gotoNext = 7835630
    		_ = gotoNext == 7835630
    		d_7835647 = s[i_7835606]
    		gotoNext = 7835659
    		_ = gotoNext == 7835659
    		switch {
    		case 48 <= d_7835647 && d_7835647 <= 57:
    			gotoNext = 7835670
    			_ = gotoNext == 7835670
    			v_7835638 = d_7835647 - 48
    			gotoNext = 7835877
    		case 97 <= d_7835647 && d_7835647 <= 122:
    			gotoNext = 7835714
    			_ = gotoNext == 7835714
    			v_7835638 = d_7835647 - 97 + 10
    			gotoNext = 7835877
    		case 65 <= d_7835647 && d_7835647 <= 90:
    			gotoNext = 7835763
    			_ = gotoNext == 7835763
    			v_7835638 = d_7835647 - 65 + 10
    			gotoNext = 7835877
    		default:
    			gotoNext = 7835812
    			_ = gotoNext == 7835812
    		...
    		_ = gotoNext == 7836057
    		n *= uint64(base)
    		n1_7836078 = n + uint64(v_7835638)
    		if n1_7836078 < n || n1_7836078 > maxVal_7834956 {
    			gotoNext = 7836125
    			_ = gotoNext == 7836125
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7836237
    	_ = gotoNext == 7836237
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7835028), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
