...
/**
    /|*{
    	...
    	_ = gotoNext == 7778088
    	n = 0
    	cutoff_7777503 = http2cutoff64(base)
    	maxVal_7777511 = 1<<uint(bitSize) - 1
    	i_7778161 = 0
    	gotoNext = 7778157
    	_ = gotoNext == 7778157
    	if i_7778161 < len(s) {
    		gotoNext = 7778185
    		_ = gotoNext == 7778185
    		d_7778202 = s[i_7778161]
    		gotoNext = 7778214
    		_ = gotoNext == 7778214
    		switch {
    		case 48 <= d_7778202 && d_7778202 <= 57:
    			gotoNext = 7778225
    			_ = gotoNext == 7778225
    			v_7778193 = d_7778202 - 48
    			gotoNext = 7778432
    		case 97 <= d_7778202 && d_7778202 <= 122:
    			gotoNext = 7778269
    			_ = gotoNext == 7778269
    			v_7778193 = d_7778202 - 97 + 10
    			gotoNext = 7778432
    		case 65 <= d_7778202 && d_7778202 <= 90:
    			gotoNext = 7778318
    			_ = gotoNext == 7778318
    			v_7778193 = d_7778202 - 65 + 10
    			gotoNext = 7778432
    		default:
    			gotoNext = 7778367
    			_ = gotoNext == 7778367
    		...
    		_ = gotoNext == 7778612
    		n *= uint64(base)
    		n1_7778633 = n + uint64(v_7778193)
    		if n1_7778633 < n || n1_7778633 > maxVal_7777511 {
    			gotoNext = 7778680
    			_ = gotoNext == 7778680
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7778792
    	_ = gotoNext == 7778792
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7777583), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
