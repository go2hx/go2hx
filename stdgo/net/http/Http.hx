...
/**
    /|*{
    	...
    	_ = gotoNext == 7741932
    	n = 0
    	cutoff_7741347 = http2cutoff64(base)
    	maxVal_7741355 = 1<<uint(bitSize) - 1
    	i_7742005 = 0
    	gotoNext = 7742001
    	_ = gotoNext == 7742001
    	if i_7742005 < len(s) {
    		gotoNext = 7742029
    		_ = gotoNext == 7742029
    		d_7742046 = s[i_7742005]
    		gotoNext = 7742058
    		_ = gotoNext == 7742058
    		switch {
    		case 48 <= d_7742046 && d_7742046 <= 57:
    			gotoNext = 7742069
    			_ = gotoNext == 7742069
    			v_7742037 = d_7742046 - 48
    			gotoNext = 7742276
    		case 97 <= d_7742046 && d_7742046 <= 122:
    			gotoNext = 7742113
    			_ = gotoNext == 7742113
    			v_7742037 = d_7742046 - 97 + 10
    			gotoNext = 7742276
    		case 65 <= d_7742046 && d_7742046 <= 90:
    			gotoNext = 7742162
    			_ = gotoNext == 7742162
    			v_7742037 = d_7742046 - 65 + 10
    			gotoNext = 7742276
    		default:
    			gotoNext = 7742211
    			_ = gotoNext == 7742211
    		...
    		_ = gotoNext == 7742456
    		n *= uint64(base)
    		n1_7742477 = n + uint64(v_7742037)
    		if n1_7742477 < n || n1_7742477 > maxVal_7741355 {
    			gotoNext = 7742524
    			_ = gotoNext == 7742524
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7742636
    	_ = gotoNext == 7742636
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7741427), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
