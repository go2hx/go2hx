...
/**
    /|*{
    	...
    	_ = gotoNext == 7834395
    	n = 0
    	cutoff_7833810 = http2cutoff64(base)
    	maxVal_7833818 = 1<<uint(bitSize) - 1
    	i_7834468 = 0
    	gotoNext = 7834464
    	_ = gotoNext == 7834464
    	if i_7834468 < len(s) {
    		gotoNext = 7834492
    		_ = gotoNext == 7834492
    		d_7834509 = s[i_7834468]
    		_ = 0
    		gotoNext = 7834521
    		_ = gotoNext == 7834521
    		switch {
    		case 48 <= d_7834509 && d_7834509 <= 57:
    			gotoNext = 7834532
    			_ = gotoNext == 7834532
    			v_7834500 = d_7834509 - 48
    			gotoNext = 7834739
    		case 97 <= d_7834509 && d_7834509 <= 122:
    			gotoNext = 7834576
    			_ = gotoNext == 7834576
    			v_7834500 = d_7834509 - 97 + 10
    			gotoNext = 7834739
    		case 65 <= d_7834509 && d_7834509 <= 90:
    			gotoNext = 7834625
    			_ = gotoNext == 7834625
    			v_7834500 = d_7834509 - 65 + 10
    			gotoNext = 7834739
    		default:
    			gotoNext = 7834674
    			_ = gotoNext == 7834674
    		...
    		_ = gotoNext == 7834919
    		n *= uint64(base)
    		n1_7834940 = n + uint64(v_7834500)
    		if n1_7834940 < n || n1_7834940 > maxVal_7833818 {
    			gotoNext = 7834987
    			_ = gotoNext == 7834987
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7835099
    	_ = gotoNext == 7835099
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7833890), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
