...
/**
    /|*{
    	...
    	_ = gotoNext == 7823380
    	n = 0
    	cutoff_7822795 = http2cutoff64(base)
    	maxVal_7822803 = 1<<uint(bitSize) - 1
    	i_7823453 = 0
    	gotoNext = 7823449
    	_ = gotoNext == 7823449
    	if i_7823453 < len(s) {
    		gotoNext = 7823477
    		_ = gotoNext == 7823477
    		d_7823494 = s[i_7823453]
    		_ = 0
    		gotoNext = 7823506
    		_ = gotoNext == 7823506
    		switch {
    		case 48 <= d_7823494 && d_7823494 <= 57:
    			gotoNext = 7823517
    			_ = gotoNext == 7823517
    			v_7823485 = d_7823494 - 48
    			gotoNext = 7823724
    		case 97 <= d_7823494 && d_7823494 <= 122:
    			gotoNext = 7823561
    			_ = gotoNext == 7823561
    			v_7823485 = d_7823494 - 97 + 10
    			gotoNext = 7823724
    		case 65 <= d_7823494 && d_7823494 <= 90:
    			gotoNext = 7823610
    			_ = gotoNext == 7823610
    			v_7823485 = d_7823494 - 65 + 10
    			gotoNext = 7823724
    		default:
    			gotoNext = 7823659
    			_ = gotoNext == 7823659
    		...
    		_ = gotoNext == 7823904
    		n *= uint64(base)
    		n1_7823925 = n + uint64(v_7823485)
    		if n1_7823925 < n || n1_7823925 > maxVal_7822803 {
    			gotoNext = 7823972
    			_ = gotoNext == 7823972
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7824084
    	_ = gotoNext == 7824084
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7822875), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
