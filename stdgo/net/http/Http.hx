...
/**
    /|*{
    	...
    	_ = gotoNext == 7593823
    	n = 0
    	cutoff_7593238 = http2cutoff64(base)
    	maxVal_7593246 = 1<<uint(bitSize) - 1
    	i_7593896 = 0
    	gotoNext = 7593892
    	_ = gotoNext == 7593892
    	if i_7593896 < len(s) {
    		gotoNext = 7593920
    		_ = gotoNext == 7593920
    		d_7593937 = s[i_7593896]
    		gotoNext = 7593949
    		_ = gotoNext == 7593949
    		switch {
    		case 48 <= d_7593937 && d_7593937 <= 57:
    			gotoNext = 7593960
    			_ = gotoNext == 7593960
    			v_7593928 = d_7593937 - 48
    			gotoNext = 7594167
    		case 97 <= d_7593937 && d_7593937 <= 122:
    			gotoNext = 7594004
    			_ = gotoNext == 7594004
    			v_7593928 = d_7593937 - 97 + 10
    			gotoNext = 7594167
    		case 65 <= d_7593937 && d_7593937 <= 90:
    			gotoNext = 7594053
    			_ = gotoNext == 7594053
    			v_7593928 = d_7593937 - 65 + 10
    			gotoNext = 7594167
    		default:
    			gotoNext = 7594102
    			_ = gotoNext == 7594102
    		...
    		_ = gotoNext == 7594347
    		n *= uint64(base)
    		n1_7594368 = n + uint64(v_7593928)
    		if n1_7594368 < n || n1_7594368 > maxVal_7593246 {
    			gotoNext = 7594415
    			_ = gotoNext == 7594415
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7594527
    	_ = gotoNext == 7594527
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7593318), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
