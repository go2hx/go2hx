...
/**
    /|*{
    	...
    	_ = gotoNext == 7957201
    	n = 0
    	cutoff_7956616 = http2cutoff64(base)
    	maxVal_7956624 = 1<<uint(bitSize) - 1
    	i_7957274 = 0
    	gotoNext = 7957270
    	_ = gotoNext == 7957270
    	if i_7957274 < len(s) {
    		gotoNext = 7957298
    		_ = gotoNext == 7957298
    		d_7957315 = s[i_7957274]
    		gotoNext = 7957327
    		_ = gotoNext == 7957327
    		switch {
    		case 48 <= d_7957315 && d_7957315 <= 57:
    			gotoNext = 7957338
    			_ = gotoNext == 7957338
    			v_7957306 = d_7957315 - 48
    			gotoNext = 7957545
    		case 97 <= d_7957315 && d_7957315 <= 122:
    			gotoNext = 7957382
    			_ = gotoNext == 7957382
    			v_7957306 = d_7957315 - 97 + 10
    			gotoNext = 7957545
    		case 65 <= d_7957315 && d_7957315 <= 90:
    			gotoNext = 7957431
    			_ = gotoNext == 7957431
    			v_7957306 = d_7957315 - 65 + 10
    			gotoNext = 7957545
    		default:
    			gotoNext = 7957480
    			_ = gotoNext == 7957480
    		...
    		_ = gotoNext == 7957725
    		n *= uint64(base)
    		n1_7957746 = n + uint64(v_7957306)
    		if n1_7957746 < n || n1_7957746 > maxVal_7956624 {
    			gotoNext = 7957793
    			_ = gotoNext == 7957793
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7957905
    	_ = gotoNext == 7957905
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7956696), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
