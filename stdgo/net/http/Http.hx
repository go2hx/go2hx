...
/**
    /|*{
    	...
    	_ = gotoNext == 7883503
    	n = 0
    	cutoff_7882918 = http2cutoff64(base)
    	maxVal_7882926 = 1<<uint(bitSize) - 1
    	i_7883576 = 0
    	gotoNext = 7883572
    	_ = gotoNext == 7883572
    	if i_7883576 < len(s) {
    		gotoNext = 7883600
    		_ = gotoNext == 7883600
    		d_7883617 = s[i_7883576]
    		gotoNext = 7883629
    		_ = gotoNext == 7883629
    		switch {
    		case 48 <= d_7883617 && d_7883617 <= 57:
    			gotoNext = 7883640
    			_ = gotoNext == 7883640
    			v_7883608 = d_7883617 - 48
    			gotoNext = 7883847
    		case 97 <= d_7883617 && d_7883617 <= 122:
    			gotoNext = 7883684
    			_ = gotoNext == 7883684
    			v_7883608 = d_7883617 - 97 + 10
    			gotoNext = 7883847
    		case 65 <= d_7883617 && d_7883617 <= 90:
    			gotoNext = 7883733
    			_ = gotoNext == 7883733
    			v_7883608 = d_7883617 - 65 + 10
    			gotoNext = 7883847
    		default:
    			gotoNext = 7883782
    			_ = gotoNext == 7883782
    		...
    		_ = gotoNext == 7884027
    		n *= uint64(base)
    		n1_7884048 = n + uint64(v_7883608)
    		if n1_7884048 < n || n1_7884048 > maxVal_7882926 {
    			gotoNext = 7884095
    			_ = gotoNext == 7884095
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7884207
    	_ = gotoNext == 7884207
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7882998), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
