...
/**
    /|*{
    	...
    	_ = gotoNext == 7593458
    	n = 0
    	cutoff_7592873 = http2cutoff64(base)
    	maxVal_7592881 = 1<<uint(bitSize) - 1
    	i_7593531 = 0
    	gotoNext = 7593527
    	_ = gotoNext == 7593527
    	if i_7593531 < len(s) {
    		gotoNext = 7593555
    		_ = gotoNext == 7593555
    		d_7593572 = s[i_7593531]
    		gotoNext = 7593584
    		_ = gotoNext == 7593584
    		switch {
    		case 48 <= d_7593572 && d_7593572 <= 57:
    			gotoNext = 7593595
    			_ = gotoNext == 7593595
    			v_7593563 = d_7593572 - 48
    			gotoNext = 7593802
    		case 97 <= d_7593572 && d_7593572 <= 122:
    			gotoNext = 7593639
    			_ = gotoNext == 7593639
    			v_7593563 = d_7593572 - 97 + 10
    			gotoNext = 7593802
    		case 65 <= d_7593572 && d_7593572 <= 90:
    			gotoNext = 7593688
    			_ = gotoNext == 7593688
    			v_7593563 = d_7593572 - 65 + 10
    			gotoNext = 7593802
    		default:
    			gotoNext = 7593737
    			_ = gotoNext == 7593737
    		...
    		_ = gotoNext == 7593982
    		n *= uint64(base)
    		n1_7594003 = n + uint64(v_7593563)
    		if n1_7594003 < n || n1_7594003 > maxVal_7592881 {
    			gotoNext = 7594050
    			_ = gotoNext == 7594050
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7594162
    	_ = gotoNext == 7594162
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7592953), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
