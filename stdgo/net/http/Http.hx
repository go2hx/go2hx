...
/**
    /|*{
    	...
    	_ = gotoNext == 7660725
    	n = 0
    	cutoff_7660140 = http2cutoff64(base)
    	maxVal_7660148 = 1<<uint(bitSize) - 1
    	i_7660798 = 0
    	gotoNext = 7660794
    	_ = gotoNext == 7660794
    	if i_7660798 < len(s) {
    		gotoNext = 7660822
    		_ = gotoNext == 7660822
    		d_7660839 = s[i_7660798]
    		gotoNext = 7660851
    		_ = gotoNext == 7660851
    		switch {
    		case 48 <= d_7660839 && d_7660839 <= 57:
    			gotoNext = 7660862
    			_ = gotoNext == 7660862
    			v_7660830 = d_7660839 - 48
    			gotoNext = 7661069
    		case 97 <= d_7660839 && d_7660839 <= 122:
    			gotoNext = 7660906
    			_ = gotoNext == 7660906
    			v_7660830 = d_7660839 - 97 + 10
    			gotoNext = 7661069
    		case 65 <= d_7660839 && d_7660839 <= 90:
    			gotoNext = 7660955
    			_ = gotoNext == 7660955
    			v_7660830 = d_7660839 - 65 + 10
    			gotoNext = 7661069
    		default:
    			gotoNext = 7661004
    			_ = gotoNext == 7661004
    		...
    		_ = gotoNext == 7661249
    		n *= uint64(base)
    		n1_7661270 = n + uint64(v_7660830)
    		if n1_7661270 < n || n1_7661270 > maxVal_7660148 {
    			gotoNext = 7661317
    			_ = gotoNext == 7661317
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7661429
    	_ = gotoNext == 7661429
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7660220), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
