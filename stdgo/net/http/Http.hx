...
/**
    /|*{
    	...
    	_ = gotoNext == 7641202
    	n = 0
    	cutoff_7640617 = http2cutoff64(base)
    	maxVal_7640625 = 1<<uint(bitSize) - 1
    	i_7641275 = 0
    	gotoNext = 7641271
    	_ = gotoNext == 7641271
    	if i_7641275 < len(s) {
    		gotoNext = 7641299
    		_ = gotoNext == 7641299
    		d_7641316 = s[i_7641275]
    		gotoNext = 7641328
    		_ = gotoNext == 7641328
    		switch {
    		case 48 <= d_7641316 && d_7641316 <= 57:
    			gotoNext = 7641339
    			_ = gotoNext == 7641339
    			v_7641307 = d_7641316 - 48
    			gotoNext = 7641546
    		case 97 <= d_7641316 && d_7641316 <= 122:
    			gotoNext = 7641383
    			_ = gotoNext == 7641383
    			v_7641307 = d_7641316 - 97 + 10
    			gotoNext = 7641546
    		case 65 <= d_7641316 && d_7641316 <= 90:
    			gotoNext = 7641432
    			_ = gotoNext == 7641432
    			v_7641307 = d_7641316 - 65 + 10
    			gotoNext = 7641546
    		default:
    			gotoNext = 7641481
    			_ = gotoNext == 7641481
    		...
    		_ = gotoNext == 7641726
    		n *= uint64(base)
    		n1_7641747 = n + uint64(v_7641307)
    		if n1_7641747 < n || n1_7641747 > maxVal_7640625 {
    			gotoNext = 7641794
    			_ = gotoNext == 7641794
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7641906
    	_ = gotoNext == 7641906
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7640697), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
