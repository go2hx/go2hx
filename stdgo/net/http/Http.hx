...
/**
    /|*{
    	...
    	_ = gotoNext == 7702454
    	n = 0
    	cutoff_7701869 = http2cutoff64(base)
    	maxVal_7701877 = 1<<uint(bitSize) - 1
    	i_7702527 = 0
    	gotoNext = 7702523
    	_ = gotoNext == 7702523
    	if i_7702527 < len(s) {
    		gotoNext = 7702551
    		_ = gotoNext == 7702551
    		d_7702568 = s[i_7702527]
    		_ = 0
    		gotoNext = 7702580
    		_ = gotoNext == 7702580
    		switch {
    		case 48 <= d_7702568 && d_7702568 <= 57:
    			gotoNext = 7702591
    			_ = gotoNext == 7702591
    			v_7702559 = d_7702568 - 48
    			gotoNext = 7702798
    		case 97 <= d_7702568 && d_7702568 <= 122:
    			gotoNext = 7702635
    			_ = gotoNext == 7702635
    			v_7702559 = d_7702568 - 97 + 10
    			gotoNext = 7702798
    		case 65 <= d_7702568 && d_7702568 <= 90:
    			gotoNext = 7702684
    			_ = gotoNext == 7702684
    			v_7702559 = d_7702568 - 65 + 10
    			gotoNext = 7702798
    		default:
    			gotoNext = 7702733
    			_ = gotoNext == 7702733
    		...
    		_ = gotoNext == 7702978
    		n *= uint64(base)
    		n1_7702999 = n + uint64(v_7702559)
    		if n1_7702999 < n || n1_7702999 > maxVal_7701877 {
    			gotoNext = 7703046
    			_ = gotoNext == 7703046
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7703158
    	_ = gotoNext == 7703158
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7701949), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
