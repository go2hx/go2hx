...
/**
    /|*{
    	...
    	_ = gotoNext == 7691276
    	n = 0
    	cutoff_7690691 = http2cutoff64(base)
    	maxVal_7690699 = 1<<uint(bitSize) - 1
    	i_7691349 = 0
    	gotoNext = 7691345
    	_ = gotoNext == 7691345
    	if i_7691349 < len(s) {
    		gotoNext = 7691373
    		_ = gotoNext == 7691373
    		d_7691390 = s[i_7691349]
    		gotoNext = 7691402
    		_ = gotoNext == 7691402
    		switch {
    		case 48 <= d_7691390 && d_7691390 <= 57:
    			gotoNext = 7691413
    			_ = gotoNext == 7691413
    			v_7691381 = d_7691390 - 48
    			gotoNext = 7691620
    		case 97 <= d_7691390 && d_7691390 <= 122:
    			gotoNext = 7691457
    			_ = gotoNext == 7691457
    			v_7691381 = d_7691390 - 97 + 10
    			gotoNext = 7691620
    		case 65 <= d_7691390 && d_7691390 <= 90:
    			gotoNext = 7691506
    			_ = gotoNext == 7691506
    			v_7691381 = d_7691390 - 65 + 10
    			gotoNext = 7691620
    		default:
    			gotoNext = 7691555
    			_ = gotoNext == 7691555
    		...
    		_ = gotoNext == 7691800
    		n *= uint64(base)
    		n1_7691821 = n + uint64(v_7691381)
    		if n1_7691821 < n || n1_7691821 > maxVal_7690699 {
    			gotoNext = 7691868
    			_ = gotoNext == 7691868
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7691980
    	_ = gotoNext == 7691980
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7690771), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
