...
/**
    /|*{
    	...
    	_ = gotoNext == 7580752
    	n = 0
    	cutoff_7580167 = http2cutoff64(base)
    	maxVal_7580175 = 1<<uint(bitSize) - 1
    	i_7580825 = 0
    	gotoNext = 7580821
    	_ = gotoNext == 7580821
    	if i_7580825 < len(s) {
    		gotoNext = 7580849
    		_ = gotoNext == 7580849
    		d_7580866 = s[i_7580825]
    		gotoNext = 7580878
    		_ = gotoNext == 7580878
    		switch {
    		case 48 <= d_7580866 && d_7580866 <= 57:
    			gotoNext = 7580889
    			_ = gotoNext == 7580889
    			v_7580857 = d_7580866 - 48
    			gotoNext = 7581096
    		case 97 <= d_7580866 && d_7580866 <= 122:
    			gotoNext = 7580933
    			_ = gotoNext == 7580933
    			v_7580857 = d_7580866 - 97 + 10
    			gotoNext = 7581096
    		case 65 <= d_7580866 && d_7580866 <= 90:
    			gotoNext = 7580982
    			_ = gotoNext == 7580982
    			v_7580857 = d_7580866 - 65 + 10
    			gotoNext = 7581096
    		default:
    			gotoNext = 7581031
    			_ = gotoNext == 7581031
    		...
    		_ = gotoNext == 7581276
    		n *= uint64(base)
    		n1_7581297 = n + uint64(v_7580857)
    		if n1_7581297 < n || n1_7581297 > maxVal_7580175 {
    			gotoNext = 7581344
    			_ = gotoNext == 7581344
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7581456
    	_ = gotoNext == 7581456
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7580247), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
