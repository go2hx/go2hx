...
/**
    /|*{
    	...
    	_ = gotoNext == 7593442
    	n = 0
    	cutoff_7592857 = http2cutoff64(base)
    	maxVal_7592865 = 1<<uint(bitSize) - 1
    	i_7593515 = 0
    	gotoNext = 7593511
    	_ = gotoNext == 7593511
    	if i_7593515 < len(s) {
    		gotoNext = 7593539
    		_ = gotoNext == 7593539
    		d_7593556 = s[i_7593515]
    		_ = 0
    		gotoNext = 7593568
    		_ = gotoNext == 7593568
    		switch {
    		case 48 <= d_7593556 && d_7593556 <= 57:
    			gotoNext = 7593579
    			_ = gotoNext == 7593579
    			v_7593547 = d_7593556 - 48
    			gotoNext = 7593786
    		case 97 <= d_7593556 && d_7593556 <= 122:
    			gotoNext = 7593623
    			_ = gotoNext == 7593623
    			v_7593547 = d_7593556 - 97 + 10
    			gotoNext = 7593786
    		case 65 <= d_7593556 && d_7593556 <= 90:
    			gotoNext = 7593672
    			_ = gotoNext == 7593672
    			v_7593547 = d_7593556 - 65 + 10
    			gotoNext = 7593786
    		default:
    			gotoNext = 7593721
    			_ = gotoNext == 7593721
    		...
    		_ = gotoNext == 7593966
    		n *= uint64(base)
    		n1_7593987 = n + uint64(v_7593547)
    		if n1_7593987 < n || n1_7593987 > maxVal_7592865 {
    			gotoNext = 7594034
    			_ = gotoNext == 7594034
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7594146
    	_ = gotoNext == 7594146
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7592937), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
