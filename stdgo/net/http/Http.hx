...
/**
    /|*{
    	...
    	_ = gotoNext == 7815821
    	n = 0
    	cutoff_7815236 = http2cutoff64(base)
    	maxVal_7815244 = 1<<uint(bitSize) - 1
    	i_7815894 = 0
    	gotoNext = 7815890
    	_ = gotoNext == 7815890
    	if i_7815894 < len(s) {
    		gotoNext = 7815918
    		_ = gotoNext == 7815918
    		d_7815935 = s[i_7815894]
    		gotoNext = 7815947
    		_ = gotoNext == 7815947
    		switch {
    		case 48 <= d_7815935 && d_7815935 <= 57:
    			gotoNext = 7815958
    			_ = gotoNext == 7815958
    			v_7815926 = d_7815935 - 48
    			gotoNext = 7816165
    		case 97 <= d_7815935 && d_7815935 <= 122:
    			gotoNext = 7816002
    			_ = gotoNext == 7816002
    			v_7815926 = d_7815935 - 97 + 10
    			gotoNext = 7816165
    		case 65 <= d_7815935 && d_7815935 <= 90:
    			gotoNext = 7816051
    			_ = gotoNext == 7816051
    			v_7815926 = d_7815935 - 65 + 10
    			gotoNext = 7816165
    		default:
    			gotoNext = 7816100
    			_ = gotoNext == 7816100
    		...
    		_ = gotoNext == 7816345
    		n *= uint64(base)
    		n1_7816366 = n + uint64(v_7815926)
    		if n1_7816366 < n || n1_7816366 > maxVal_7815244 {
    			gotoNext = 7816413
    			_ = gotoNext == 7816413
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7816525
    	_ = gotoNext == 7816525
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7815316), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
