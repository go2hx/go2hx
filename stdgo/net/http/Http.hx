...
/**
    /|*{
    	...
    	_ = gotoNext == 7749533
    	n = 0
    	cutoff_7748948 = http2cutoff64(base)
    	maxVal_7748956 = 1<<uint(bitSize) - 1
    	i_7749606 = 0
    	gotoNext = 7749602
    	_ = gotoNext == 7749602
    	if i_7749606 < len(s) {
    		gotoNext = 7749630
    		_ = gotoNext == 7749630
    		d_7749647 = s[i_7749606]
    		gotoNext = 7749659
    		_ = gotoNext == 7749659
    		switch {
    		case 48 <= d_7749647 && d_7749647 <= 57:
    			gotoNext = 7749670
    			_ = gotoNext == 7749670
    			v_7749638 = d_7749647 - 48
    			gotoNext = 7749877
    		case 97 <= d_7749647 && d_7749647 <= 122:
    			gotoNext = 7749714
    			_ = gotoNext == 7749714
    			v_7749638 = d_7749647 - 97 + 10
    			gotoNext = 7749877
    		case 65 <= d_7749647 && d_7749647 <= 90:
    			gotoNext = 7749763
    			_ = gotoNext == 7749763
    			v_7749638 = d_7749647 - 65 + 10
    			gotoNext = 7749877
    		default:
    			gotoNext = 7749812
    			_ = gotoNext == 7749812
    		...
    		_ = gotoNext == 7750057
    		n *= uint64(base)
    		n1_7750078 = n + uint64(v_7749638)
    		if n1_7750078 < n || n1_7750078 > maxVal_7748956 {
    			gotoNext = 7750125
    			_ = gotoNext == 7750125
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7750237
    	_ = gotoNext == 7750237
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7749028), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
