...
/**
    /|*{
    	...
    	_ = gotoNext == 7675104
    	n = 0
    	cutoff_7674519 = http2cutoff64(base)
    	maxVal_7674527 = 1<<uint(bitSize) - 1
    	i_7675177 = 0
    	gotoNext = 7675173
    	_ = gotoNext == 7675173
    	if i_7675177 < len(s) {
    		gotoNext = 7675201
    		_ = gotoNext == 7675201
    		d_7675218 = s[i_7675177]
    		_ = 0
    		gotoNext = 7675230
    		_ = gotoNext == 7675230
    		switch {
    		case 48 <= d_7675218 && d_7675218 <= 57:
    			gotoNext = 7675241
    			_ = gotoNext == 7675241
    			v_7675209 = d_7675218 - 48
    			gotoNext = 7675448
    		case 97 <= d_7675218 && d_7675218 <= 122:
    			gotoNext = 7675285
    			_ = gotoNext == 7675285
    			v_7675209 = d_7675218 - 97 + 10
    			gotoNext = 7675448
    		case 65 <= d_7675218 && d_7675218 <= 90:
    			gotoNext = 7675334
    			_ = gotoNext == 7675334
    			v_7675209 = d_7675218 - 65 + 10
    			gotoNext = 7675448
    		default:
    			gotoNext = 7675383
    			_ = gotoNext == 7675383
    		...
    		_ = gotoNext == 7675628
    		n *= uint64(base)
    		n1_7675649 = n + uint64(v_7675209)
    		if n1_7675649 < n || n1_7675649 > maxVal_7674527 {
    			gotoNext = 7675696
    			_ = gotoNext == 7675696
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7675808
    	_ = gotoNext == 7675808
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7674599), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
