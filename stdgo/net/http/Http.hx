...
/**
    /|*{
    	...
    	_ = gotoNext == 7833018
    	n = 0
    	cutoff_7832433 = http2cutoff64(base)
    	maxVal_7832441 = 1<<uint(bitSize) - 1
    	i_7833091 = 0
    	gotoNext = 7833087
    	_ = gotoNext == 7833087
    	if i_7833091 < len(s) {
    		gotoNext = 7833115
    		_ = gotoNext == 7833115
    		d_7833132 = s[i_7833091]
    		gotoNext = 7833144
    		_ = gotoNext == 7833144
    		switch {
    		case 48 <= d_7833132 && d_7833132 <= 57:
    			gotoNext = 7833155
    			_ = gotoNext == 7833155
    			v_7833123 = d_7833132 - 48
    			gotoNext = 7833362
    		case 97 <= d_7833132 && d_7833132 <= 122:
    			gotoNext = 7833199
    			_ = gotoNext == 7833199
    			v_7833123 = d_7833132 - 97 + 10
    			gotoNext = 7833362
    		case 65 <= d_7833132 && d_7833132 <= 90:
    			gotoNext = 7833248
    			_ = gotoNext == 7833248
    			v_7833123 = d_7833132 - 65 + 10
    			gotoNext = 7833362
    		default:
    			gotoNext = 7833297
    			_ = gotoNext == 7833297
    		...
    		_ = gotoNext == 7833542
    		n *= uint64(base)
    		n1_7833563 = n + uint64(v_7833123)
    		if n1_7833563 < n || n1_7833563 > maxVal_7832441 {
    			gotoNext = 7833610
    			_ = gotoNext == 7833610
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7833722
    	_ = gotoNext == 7833722
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7832513), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
