...
/**
    /|*{
    	...
    	_ = gotoNext == 7966022
    	n = 0
    	cutoff_7965437 = http2cutoff64(base)
    	maxVal_7965445 = 1<<uint(bitSize) - 1
    	i_7966095 = 0
    	gotoNext = 7966091
    	_ = gotoNext == 7966091
    	if i_7966095 < len(s) {
    		gotoNext = 7966119
    		_ = gotoNext == 7966119
    		d_7966136 = s[i_7966095]
    		gotoNext = 7966148
    		_ = gotoNext == 7966148
    		switch {
    		case 48 <= d_7966136 && d_7966136 <= 57:
    			gotoNext = 7966159
    			_ = gotoNext == 7966159
    			v_7966127 = d_7966136 - 48
    			gotoNext = 7966366
    		case 97 <= d_7966136 && d_7966136 <= 122:
    			gotoNext = 7966203
    			_ = gotoNext == 7966203
    			v_7966127 = d_7966136 - 97 + 10
    			gotoNext = 7966366
    		case 65 <= d_7966136 && d_7966136 <= 90:
    			gotoNext = 7966252
    			_ = gotoNext == 7966252
    			v_7966127 = d_7966136 - 65 + 10
    			gotoNext = 7966366
    		default:
    			gotoNext = 7966301
    			_ = gotoNext == 7966301
    		...
    		_ = gotoNext == 7966546
    		n *= uint64(base)
    		n1_7966567 = n + uint64(v_7966127)
    		if n1_7966567 < n || n1_7966567 > maxVal_7965445 {
    			gotoNext = 7966614
    			_ = gotoNext == 7966614
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7966726
    	_ = gotoNext == 7966726
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7965517), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
