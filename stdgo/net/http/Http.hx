...
/**
    /|*{
    	...
    	_ = gotoNext == 7975929
    	n = 0
    	cutoff_7975344 = http2cutoff64(base)
    	maxVal_7975352 = 1<<uint(bitSize) - 1
    	i_7976002 = 0
    	gotoNext = 7975998
    	_ = gotoNext == 7975998
    	if i_7976002 < len(s) {
    		gotoNext = 7976026
    		_ = gotoNext == 7976026
    		d_7976043 = s[i_7976002]
    		_ = 0
    		gotoNext = 7976055
    		_ = gotoNext == 7976055
    		switch {
    		case 48 <= d_7976043 && d_7976043 <= 57:
    			gotoNext = 7976066
    			_ = gotoNext == 7976066
    			v_7976034 = d_7976043 - 48
    			gotoNext = 7976273
    		case 97 <= d_7976043 && d_7976043 <= 122:
    			gotoNext = 7976110
    			_ = gotoNext == 7976110
    			v_7976034 = d_7976043 - 97 + 10
    			gotoNext = 7976273
    		case 65 <= d_7976043 && d_7976043 <= 90:
    			gotoNext = 7976159
    			_ = gotoNext == 7976159
    			v_7976034 = d_7976043 - 65 + 10
    			gotoNext = 7976273
    		default:
    			gotoNext = 7976208
    			_ = gotoNext == 7976208
    		...
    		_ = gotoNext == 7976453
    		n *= uint64(base)
    		n1_7976474 = n + uint64(v_7976034)
    		if n1_7976474 < n || n1_7976474 > maxVal_7975352 {
    			gotoNext = 7976521
    			_ = gotoNext == 7976521
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7976633
    	_ = gotoNext == 7976633
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7975424), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
