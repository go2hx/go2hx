...
/**
    /|*{
    	...
    	_ = gotoNext == 7965121
    	n = 0
    	cutoff_7964536 = http2cutoff64(base)
    	maxVal_7964544 = 1<<uint(bitSize) - 1
    	i_7965194 = 0
    	gotoNext = 7965190
    	_ = gotoNext == 7965190
    	if i_7965194 < len(s) {
    		gotoNext = 7965218
    		_ = gotoNext == 7965218
    		d_7965235 = s[i_7965194]
    		gotoNext = 7965247
    		_ = gotoNext == 7965247
    		switch {
    		case 48 <= d_7965235 && d_7965235 <= 57:
    			gotoNext = 7965258
    			_ = gotoNext == 7965258
    			v_7965226 = d_7965235 - 48
    			gotoNext = 7965465
    		case 97 <= d_7965235 && d_7965235 <= 122:
    			gotoNext = 7965302
    			_ = gotoNext == 7965302
    			v_7965226 = d_7965235 - 97 + 10
    			gotoNext = 7965465
    		case 65 <= d_7965235 && d_7965235 <= 90:
    			gotoNext = 7965351
    			_ = gotoNext == 7965351
    			v_7965226 = d_7965235 - 65 + 10
    			gotoNext = 7965465
    		default:
    			gotoNext = 7965400
    			_ = gotoNext == 7965400
    		...
    		_ = gotoNext == 7965645
    		n *= uint64(base)
    		n1_7965666 = n + uint64(v_7965226)
    		if n1_7965666 < n || n1_7965666 > maxVal_7964544 {
    			gotoNext = 7965713
    			_ = gotoNext == 7965713
    			n = 18446744073709551615
    			err = strconv.ErrRange
    	...
    	gotoNext = 7965825
    	_ = gotoNext == 7965825
    	return n, &strconv.NumError{Func: "ParseUint", Num: string(s0_7964616), Err: err}
    	gotoNext = -1
    }*|/
**/
class Http {
