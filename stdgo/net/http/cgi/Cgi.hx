...
@:structInit class T_response {
	...
	public function new(?_req:Pointer<stdgo.net.http.Http.Request>, ?_header:stdgo.net.http.Http.Header, ?_code:GoInt, ?_wroteHeader:Bool,
			?_wroteCGIHeader:Bool, ?_bufw:Pointer<bufio.Bufio.Writer>)
...
@:structInit class Handler {
	public function _handleInternalRedirect(_rw:stdgo.net.http.Http.ResponseWriter, _req:Pointer<stdgo.net.http.Http.Request>, _path:GoString):Void {
		...
		var __tmp__ = _req.value.url.value.parse(_path),
			_url:Pointer<stdgo.net.url.Url.URL> = __tmp__._0,
		...
		var _newReq:Pointer<stdgo.net.http.Http.Request> = Go.pointer((({
			method: "GET",
			url: _url,
			proto: "HTTP/1.1",
			protoMajor: ((1 : GoInt)),
			protoMinor: ((1 : GoInt)),
			header: new stdgo.net.http.Http.Header(new GoMap<GoString,
			...
			host: _url.value.host,
			remoteAddr: _req.value.remoteAddr,
			tls: _req.value.tls,
	...
	public function serveHTTP(_rw:stdgo.net.http.Http.ResponseWriter, _req:Pointer<stdgo.net.http.Http.Request>):Void {
		...
		try {
			...
			var _env:Slice<GoString> = new Slice<GoString>("SERVER_SOFTWARE=go", (("SERVER_NAME=" : GoString))
				+ _req.value.host, "SERVER_PROTOCOL=HTTP/1.1",
				(("HTTP_HOST=" : GoString))
				+ _req.value.host, "GATEWAY_INTERFACE=CGI/1.1", (("REQUEST_METHOD=" : GoString))
				+ _req.value.method,
				(("QUERY_STRING=" : GoString))
				+ _req.value.url.value.rawQuery, (("REQUEST_URI=" : GoString))
				+ _req.value.url.value.requestURI(),
				(("PATH_INFO=" : GoString))
				+ _pathInfo, (("SCRIPT_NAME=" : GoString))
				+ _root, (("SCRIPT_FILENAME=" : GoString))
				+ _h.value.path,
				(("SERVER_PORT=" : GoString))
				+ _port);
			{
				var __tmp__ = stdgo.net.Net.splitHostPort(_req.value.remoteAddr),
					_remoteIP:GoString = __tmp__._0,
					_remotePort:GoString = __tmp__._1,
					_err:stdgo.Error = __tmp__._2;
				if (_err == null) {
					_env = _env.__append__((("REMOTE_ADDR=" : GoString))
						+ _remoteIP, (("REMOTE_HOST=" : GoString))
						+ _remoteIP,
						(("REMOTE_PORT=" : GoString))
						+ _remotePort);
				} else {
			...
			var _cmd:Pointer<stdgo.os.exec.Exec.Cmd> = Go.pointer((({
				path: _path,
				args: new Slice<GoString>(_h.value.path).__append__(..._h.value.args.toArray()),
				dir: _cwd,
				env: _env,
				stderr: new stdgo.io.Io.Writer(_h.value._stderr()),
				stdin: ((null : stdgo.io.Io.Reader)),
				stdout: ((null : stdgo.io.Io.Writer)),
				extraFiles: new Slice<Pointer<stdgo.os.Os.File>>().nil(),
				sysProcAttr: new Pointer<stdgo.syscall.Syscall.SysProcAttr>().nil(),
				process: new Pointer<stdgo.os.Os.Process>().nil(),
				processState: new Pointer<stdgo.os.Os.ProcessState>().nil(),
				_ctx: ((null : stdgo.context.Context.Context)),
				_lookPathErr: ((null : stdgo.Error)),
				_finished: false,
				_childFiles: new Slice<Pointer<stdgo.os.Os.File>>().nil(),
				_closeAfterStart: new Slice<stdgo.io.Io.Closer>().nil(),
				_closeAfterWait: new Slice<stdgo.io.Io.Closer>().nil(),
				_goroutine: new Slice<() -> stdgo.Error>().nil(),
				_errch: new Chan<stdgo.Error>(0, () -> ((null : stdgo.Error)), true),
				_waitDone: new Chan<{}>(0, () -> null, true)
			} : stdgo.os.exec.Exec.Cmd)));
			if (_req.value.contentLength != ((0 : GoInt64))) {
				_cmd.value.stdin = _req.value.body;
			};
			var __tmp__ = _cmd.value.stdoutPipe(),
				_stdoutRead:stdgo.io.Io.ReadCloser = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				_internalError(_err);
				return;
			...
			var _headers:stdgo.net.http.Http.Header = new stdgo.net.http.Http.Header(new GoMap<GoString,
				Slice<GoString>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
				stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)))))).__copy__();
			...
			while (true) {
				var __tmp__ = _linebody.value.readLine(),
				...
				var _header:GoString = _parts[((0 : GoInt))],
					_val:GoString = _parts[((1 : GoInt))];
				...
				if (_header == (("Status" : GoString))) {
					...
					var __tmp__ = stdgo.strconv.Strconv.atoi(_val.__slice__(((0 : GoInt)), ((3 : GoInt)))),
	...
	public function new(?path:GoString, ?root:GoString, ?dir:GoString, ?env:Slice<GoString>, ?inheritEnv:Slice<GoString>,
			?logger:Pointer<stdgo.log.Log.Logger>, ?args:Slice<GoString>, ?stderr:stdgo.io.Io.Writer, ?pathLocationHandler:stdgo.net.http.Http.Handler)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(path) + " " + Go.string(root) + " " + Go.string(dir) + " " + Go.string(env) + " " + Go.string(inheritEnv) + " "
			+ Go.string(logger) + " " + Go.string(args) + " " + Go.string(stderr) + " " + Go.string(pathLocationHandler) + "}";
	}
...
var _osDefaultInheritEnv:Slice<GoString> = {
	var a = function():Slice<GoString> {
		...
		} else if (stdgo.runtime.Runtime.goos == (("linux" : GoString))
			|| stdgo.runtime.Runtime.goos == (("freebsd" : GoString))
			|| stdgo.runtime.Runtime.goos == (("netbsd" : GoString))
...
function request():{var _0:Pointer<stdgo.net.http.Http.Request>; var _1:Error;} {
	var __tmp__ = requestFromMap(_envMap(stdgo.os.Os.environ())),
		_r:Pointer<stdgo.net.http.Http.Request> = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
...
function _envMap(_env:Slice<GoString>):GoMap<GoString, GoString> {
	var _m:GoMap<GoString, GoString> = new GoMap<GoString,
...
function requestFromMap(_params:GoMap<GoString, GoString>):{var _0:Pointer<stdgo.net.http.Http.Request>; var _1:Error;} {
	...
	_r.value.close = true;
	_r.value.trailer = new stdgo.net.http.Http.Header(new GoMap<GoString,
		Slice<GoString>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
		stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)))))).__copy__();
	_r.value.header = new stdgo.net.http.Http.Header(new GoMap<GoString,
		Slice<GoString>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
		stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)))))).__copy__();
	_r.value.host = _params["HTTP_HOST"];
	{
		...
		if (_lenstr != (("" : GoString))) {
			var __tmp__ = stdgo.strconv.Strconv.parseInt(_lenstr, ((10 : GoInt)), ((64 : GoInt))),
				_clen:GoInt64 = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return {_0: new Pointer<stdgo.net.http.Http.Request>().nil(),
					_1: stdgo.errors.Errors.new_((("cgi: bad CONTENT_LENGTH in environment: " : GoString))
					+ _lenstr)};
			};
	...
	};
	{
		...
		if (_s == (("on" : GoString)) || _s == (("ON" : GoString)) || _s == (("1" : GoString))) {
			_r.value.tls = Go.pointer((({
				...
				serverName: "",
				peerCertificates: new Slice<Pointer<stdgo.crypto.x509.X509.Certificate>>().nil(),
				verifiedChains: new Slice<Slice<Pointer<stdgo.crypto.x509.X509.Certificate>>>().nil(),
				signedCertificateTimestamps: new Slice<Slice<GoUInt8>>().nil(),
				ocspresponse: new Slice<GoUInt8>().nil(),
				tlsunique: new Slice<GoUInt8>().nil(),
				_ekm: null
			} : stdgo.crypto.tls.Tls.ConnectionState)));
		};
	};
	if (_r.value.host != (("" : GoString))) {
		...
		var __tmp__ = stdgo.net.url.Url.parse(_rawurl),
			_url:Pointer<stdgo.net.url.Url.URL> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new Pointer<stdgo.net.http.Http.Request>().nil(),
				_1: stdgo.errors.Errors.new_((("cgi: failed to parse host and REQUEST_URI into a URL: " : GoString))
				+ _rawurl)};
		};
		_r.value.url = _url;
	};
	if (_r.value.url == null || _r.value.url.isNil()) {
		var __tmp__ = _url.parse(_uriStr),
			_url:Pointer<stdgo.net.url.Url.URL> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new Pointer<stdgo.net.http.Http.Request>().nil(),
				_1: stdgo.errors.Errors.new_((("cgi: failed to parse REQUEST_URI into a URL: " : GoString))
				+ _uriStr)};
		};
		_r.value.url = _url;
	};
	var __tmp__ = stdgo.strconv.Strconv.atoi(_params["REMOTE_PORT"]),
		_remotePort:GoInt = __tmp__._0,
...
function serve(_handler:stdgo.net.http.Http.Handler):Error {
	var __tmp__ = request(),
		_req:Pointer<stdgo.net.http.Http.Request> = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
		return _err;
	};
	...
	var _rw:Pointer<T_response> = Go.pointer((({
		_req: _req,
		_header: new stdgo.net.http.Http.Header(new GoMap<GoString,
			Slice<GoString>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
			stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)))))).__copy__(),
		_bufw: bufio.Bufio.newWriter(stdgo.os.Os.stdout.value),
		_code: 0,
		_wroteHeader: false,
...
class Handler_extension_fields {
	public function _stderr(__tmp__):stdgo.io.Io.Writer
		return __tmp__._stderr();
	...
	public function _printf(__tmp__, _format:GoString, _v:haxe.Rest<AnyInterface>):Void
		__tmp__._printf(_format, _v);

	public function _handleInternalRedirect(__tmp__, _rw:stdgo.net.http.Http.ResponseWriter, _req:Pointer<stdgo.net.http.Http.Request>, _path:GoString):Void
		__tmp__._handleInternalRedirect(_rw, _req, _path);
}
