...
@:structInit class Options {
    ...
    public function new(?publicSuffixList:PublicSuffixList) stdgo.internal.Macro.initLocals();
...
@:structInit class Jar {
    public function _domainAndType(_host:GoString, _domain:GoString):{ var _0 : GoString; var _1 : Bool; var _2 : Error; } {
        ...
        var __tmp__ = net.http.internal.ascii.Ascii.toLower(_domain), _domain:GoString = __tmp__._0, _isASCII:Bool = __tmp__._1;
        if (!_isASCII) {
            return { _0 : "", _1 : false, _2 : _errMalformedDomain };
        };
    ...
    public function _newEntry(_c:Pointer<stdgo.net.http.Http.Cookie>, _now:stdgo.time.Time.Time, _defPath:GoString, _host:GoString):{ var _0 : T_entry; var _1 : Bool; var _2 : Error; } {
        var _j = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _e:T_entry = new T_entry(), _remove:Bool = false, _err:Error = ((null : stdgo.Error));
    ...
    public function _setCookies(_u:Pointer<stdgo.net.url.Url.URL>, _cookies:Slice<Pointer<stdgo.net.http.Http.Cookie>>, _now:stdgo.time.Time.Time):Void {
        ...
        try {
            ...
            var __tmp__ = _canonicalHost(_u.value.host), _host:GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return;
            };
            ...
            for (_cookie in _cookies) {
                var __tmp__ = _j.value._newEntry(_cookie, _now.__copy__(), _defPath, _host), _e:T_entry = __tmp__._0, _remove:Bool = __tmp__._1, _err:stdgo.Error = __tmp__._2;
                if (_err != null) {
                    continue;
                };
                ...
                if (_remove) {
                    if (_submap != null && !_submap.isNil()) {
                        {
                            var __tmp__ = _submap.exists(_id) ? { value : _submap[_id], ok : true } : { value : _submap.defaultValue(), ok : false }, _:T_entry = __tmp__.value, _ok:Bool = __tmp__.ok;
                            if (_ok) {
                                _submap.remove(_id);
                                _modified = true;
                            };
...
{ name : "_seqNum", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint64_kind) }]))))));
    ...
    public function _cookies(_u:Pointer<stdgo.net.url.Url.URL>, _now:stdgo.time.Time.Time):Slice<Pointer<stdgo.net.http.Http.Cookie>> {
        ...
        try {
            ...
            for (_e in _selected) {
                _cookies = _cookies.__append__(Go.pointer((({ name : _e.name, value : _e.value, path : "", domain : "", expires : new stdgo.time.Time.Time(), rawExpires : "", maxAge : 0, secure : false, httpOnly : false, sameSite : new stdgo.net.http.Http.SameSite(), raw : "", unparsed : new Slice<GoString>().nil() } : stdgo.net.http.Http.Cookie))));
            };
            {
                for (defer in deferstack) {
                    defer();
    ...
    public var _entries : GoMap<GoString, GoMap<GoString, T_entry>> = new GoMap<GoString, GoMap<GoString, T_entry>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.named("net/http/cookiejar.entry", [], stdgo.reflect.Reflect.GoType.structType([
{ name : "name", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "value", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "domain", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "path", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
...
{ name : "hostOnly", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) },
{ name : "expires", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("time.Time", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_wall", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint64_kind) }, { name : "_ext", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_loc", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("time.Location", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_name", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_zone", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("time.zone", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_name", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_offset", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }, { name : "_isDST", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }]))) }, { name : "_tx", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("time.zoneTrans", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_when", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_index", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint8_kind) }, { name : "_isstd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }, { name : "_isutc", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }]))) }, { name : "_extend", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_cacheStart", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_cacheEnd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_cacheZone", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("time.zone", [], stdgo.reflect.Reflect.GoType.invalidType)) }]))) }])) },
{ name : "creation", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("time.Time", [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "lastAccess", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("time.Time", [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "_seqNum", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint64_kind) }])))))).nil();
    public var _nextSeqNum : GoUInt64 = ((0 : GoUInt64));
    public function new(?_psList:PublicSuffixList, ?_mu:stdgo.sync.Sync.Mutex, ?_entries:GoMap<GoString, GoMap<GoString, T_entry>>, ?_nextSeqNum:GoUInt64) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_entry {
    ...
    public function new(?name:GoString, ?value:GoString, ?domain:GoString, ?path:GoString, ?sameSite:GoString, ?secure:Bool, ?httpOnly:Bool, ?persistent:Bool, ?hostOnly:Bool, ?expires:stdgo.time.Time.Time, ?creation:stdgo.time.Time.Time, ?lastAccess:stdgo.time.Time.Time, ?_seqNum:GoUInt64) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(name) + " " + Go.string(value) + " " + Go.string(domain) + " " + Go.string(path) + " " + Go.string(sameSite) + " " + Go.string(secure) + " " + Go.string(httpOnly) + " " + Go.string(persistent) + " " + Go.string(hostOnly) + " " + Go.string(expires) + " " + Go.string(creation) + " " + Go.string(lastAccess) + " " + Go.string(_seqNum) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
        return new T_entry(
...
var _endOfTime : stdgo.time.Time.Time = stdgo.time.Time.date(((9999 : GoInt)), new stdgo.time.Time.Month(((12 : GoInt))), ((31 : GoInt)), ((23 : GoInt)), ((59 : GoInt)), ((59 : GoInt)), ((0 : GoInt)), stdgo.time.Time.utc).__copy__();
...
function new_(_o:Pointer<Options>):{ var _0 : Pointer<Jar>; var _1 : Error; } {
        var _jar:Pointer<Jar> = Go.pointer((({ _entries : new GoMap<GoString, GoMap<GoString, T_entry>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.named("net/http/cookiejar.entry", [], stdgo.reflect.Reflect.GoType.named("net/http/cookiejar.entry", [], stdgo.reflect.Reflect.GoType.structType([
{ name : "name", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "value", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "domain", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "path", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
...
{ name : "creation", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("time.Time", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_wall", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint64_kind) }, { name : "_ext", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_loc", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("time.Location", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_name", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_zone", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("time.zone", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_name", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_offset", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }, { name : "_isDST", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }]))) }, { name : "_tx", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("time.zoneTrans", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_when", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_index", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint8_kind) }, { name : "_isstd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }, { name : "_isutc", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }]))) }, { name : "_extend", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_cacheStart", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_cacheEnd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_cacheZone", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("time.zone", [], stdgo.reflect.Reflect.GoType.invalidType)) }]))) }])) },
{ name : "lastAccess", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("time.Time", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_wall", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint64_kind) }, { name : "_ext", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_loc", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("time.Location", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_name", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_zone", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("time.zone", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_name", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_offset", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }, { name : "_isDST", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }]))) }, { name : "_tx", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.named("time.zoneTrans", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_when", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_index", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint8_kind) }, { name : "_isstd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }, { name : "_isutc", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }]))) }, { name : "_extend", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_cacheStart", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_cacheEnd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_cacheZone", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("time.zone", [], stdgo.reflect.Reflect.GoType.invalidType)) }]))) }])) },
{ name : "_seqNum", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint64_kind) }]))))))), _psList : ((null : PublicSuffixList)), _mu : new stdgo.sync.Sync.Mutex(), _nextSeqNum : 0 } : Jar)));
        if (_o != null && !_o.isNil()) {
...
function _hasDotSuffix(_s:GoString, _suffix:GoString):Bool {
        return _s.length > _suffix.length && _s[_s.length - _suffix.length - ((1 : GoInt))] == ((".".code : GoRune)) && _s.__slice__(_s.length - _suffix.length) == _suffix;
    }
/**
...
function _canonicalHost(_host:GoString):{ var _0 : GoString; var _1 : Error; } {
        ...
        var __tmp__ = _toASCII(_host), _encoded:GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : "", _1 : _err };
        };
        var __tmp__ = net.http.internal.ascii.Ascii.toLower(_encoded), _lower:GoString = __tmp__._0, _:Bool = __tmp__._1;
        ...
        var _labels:Slice<GoString> = stdgo.strings.Strings.split(_s, ".");
        {
            ...
            for (_obj in _labels.keyValueIterator()) {
                ...
                if (!net.http.internal.ascii.Ascii.is_(_label)) {
                    var __tmp__ = _encode(_acePrefix, _label), _a:GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                    if (_err != null) {
                        return { _0 : "", _1 : _err };
                    };
                    _labels[_i] = _a;
...
class Jar_extension_fields {
    public function cookies(__tmp__, _u:Pointer<stdgo.net.url.Url.URL>):Slice<Pointer<stdgo.net.http.Http.Cookie>> return __tmp__.cookies(_u);
    public function _cookies(__tmp__, _u:Pointer<stdgo.net.url.Url.URL>, _now:stdgo.time.Time.Time):Slice<Pointer<stdgo.net.http.Http.Cookie>> return __tmp__._cookies(_u, _now);
    public function setCookies(__tmp__, _u:Pointer<stdgo.net.url.Url.URL>, _cookies:Slice<Pointer<stdgo.net.http.Http.Cookie>>):Void __tmp__.setCookies(_u, _cookies);
    public function _setCookies(__tmp__, _u:Pointer<stdgo.net.url.Url.URL>, _cookies:Slice<Pointer<stdgo.net.http.Http.Cookie>>, _now:stdgo.time.Time.Time):Void __tmp__._setCookies(_u, _cookies, _now);
    public function _newEntry(__tmp__, _c:Pointer<stdgo.net.http.Http.Cookie>, _now:stdgo.time.Time.Time, _defPath:GoString, _host:GoString):{ var _0 : T_entry; var _1 : Bool; var _2 : Error; } return __tmp__._newEntry(_c, _now, _defPath, _host);
    public function _domainAndType(__tmp__, _host:GoString, _domain:GoString):{ var _0 : GoString; var _1 : Bool; var _2 : Error; } return __tmp__._domainAndType(_host, _domain);
}
class T_entry_extension_fields {
    public function _id(__tmp__):GoString return __tmp__._id();
    public function _shouldSend(__tmp__, _https:Bool, _host:GoString, _path:GoString):Bool return __tmp__._shouldSend(_https, _host, _path);
    public function _domainMatch(__tmp__, _host:GoString):Bool return __tmp__._domainMatch(_host);
    public function _pathMatch(__tmp__, _requestPath:GoString):Bool return __tmp__._pathMatch(_requestPath);
}
