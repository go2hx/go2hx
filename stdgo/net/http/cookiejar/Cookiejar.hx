...
@:structInit @:using(cookiejar.Cookiejar.Options_static_extension) abstract Options(stdgo._internal.net.http.cookiejar.Cookiejar_options.Options) from stdgo._internal.net.http.cookiejar.Cookiejar_options.Options to stdgo._internal.net.http.cookiejar.Cookiejar_options.Options {
...
@:structInit @:using(cookiejar.Cookiejar.Jar_static_extension) abstract Jar(stdgo._internal.net.http.cookiejar.Cookiejar_jar.Jar) from stdgo._internal.net.http.cookiejar.Cookiejar_jar.Jar to stdgo._internal.net.http.cookiejar.Cookiejar_jar.Jar {
...
@:structInit @:using(cookiejar.Cookiejar.T_entry_static_extension) @:dox(hide) abstract T_entry(stdgo._internal.net.http.cookiejar.Cookiejar_t_entry.T_entry) from stdgo._internal.net.http.cookiejar.Cookiejar_t_entry.T_entry to stdgo._internal.net.http.cookiejar.Cookiejar_t_entry.T_entry {
