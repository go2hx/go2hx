...
@:structInit @:using(httptest.Httptest.Server_static_extension) abstract Server(stdgo._internal.net.http.httptest.Httptest_server.Server) from stdgo._internal.net.http.httptest.Httptest_server.Server to stdgo._internal.net.http.httptest.Httptest_server.Server {
