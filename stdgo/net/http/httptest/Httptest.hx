...
class Httptest {
    ...
    **/
    static public function newRequest(_method:String, _target:String, _body:stdgo._internal.io.Io_Reader.Reader):stdgo._internal.net.http.Http_Request.Request {
        return stdgo._internal.net.http.httptest.Httptest_newRequest.newRequest(_method, _target, _body);
    }
    /**
        NewRecorder returns an initialized ResponseRecorder.
    **/
    static public function newRecorder():ResponseRecorder {
    ...
    **/
    static public function newServer(_handler:stdgo._internal.net.http.Http_Handler.Handler):Server {
    ...
    /**
        ...
        The caller should call Close when finished, to shut it down.
    **/
    static public function newUnstartedServer(_handler:stdgo._internal.net.http.Http_Handler.Handler):Server {
    ...
    /**
        ...
        The caller should call Close when finished, to shut it down.
    **/
    static public function newTLSServer(_handler:stdgo._internal.net.http.Http_Handler.Handler):Server {
