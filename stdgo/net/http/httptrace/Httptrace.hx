...
@:structInit @:using(httptrace.Httptrace.ClientTrace_static_extension) abstract ClientTrace(stdgo._internal.net.http.httptrace.Httptrace_clienttrace.ClientTrace) from stdgo._internal.net.http.httptrace.Httptrace_clienttrace.ClientTrace to stdgo._internal.net.http.httptrace.Httptrace_clienttrace.ClientTrace {
