...
@:structInit class T_dumpConn {
    ...
    public function new(?writer:stdgo.io.Io.Writer, ?reader:stdgo.io.Io.Reader) stdgo.internal.Macro.initLocals();
...
@:named class T_neverEnding {
    ...
    public function __copy__() return new T_neverEnding(__t__);
}
@:structInit class T_delegateReader {
    ...
    public function new(?_c:Chan<stdgo.io.Io.Reader>, ?_err:stdgo.Error, ?_r:stdgo.io.Io.Reader) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class ServerConn {
    public function write(_req:Pointer<stdgo.net.http.Http.Request>, _resp:Pointer<stdgo.net.http.Http.Response>):Error {
        ...
        _sc.value._mu.lock();
        try {
            var __tmp__ = _sc.value._pipereq.exists(_req) ? { value : _sc.value._pipereq[_req], ok : true } : { value : _sc.value._pipereq.defaultValue(), ok : false }, _id:GoUInt = __tmp__.value, _ok:Bool = __tmp__.ok;
    ...
    public function close():Error {
        var _sc = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _sc.value.hijack(), _c:stdgo.net.Net.Conn = __tmp__._0, _:Pointer<bufio.Bufio.Reader> = __tmp__._1;
        if (_c != null) {
            return _c.close();
        };
        return ((null : stdgo.Error));
    ...
    public var _pipereq : GoMap<Pointer<stdgo.net.http.Http.Request>, GoUInt> = new GoMap<Pointer<stdgo.net.http.Http.Request>, GoUInt>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/http.Request", [], stdgo.reflect.Reflect.GoType.structType([
{ name : "method", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "url", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/url.URL", [], stdgo.reflect.Reflect.GoType.structType([{ name : "scheme", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "opaque", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "user", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/url.Userinfo", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_username", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_password", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_passwordSet", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }]))) }, { name : "host", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "path", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "rawPath", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "forceQuery", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }, { name : "rawQuery", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "fragment", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "rawFragment", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }]))) },
{ name : "proto", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "protoMajor", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) },
{ name : "protoMinor", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) },
{ name : "header", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net/http.Header", [], stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)))) },
{ name : "body", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("io.ReadCloser", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) },
{ name : "getBody", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "contentLength", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) },
{ name : "transferEncoding", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)) },
{ name : "close", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) },
{ name : "host", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "form", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net/url.Values", [], stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)))) },
{ name : "postForm", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net/url.Values", [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "multipartForm", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("mime/multipart.Form", [], stdgo.reflect.Reflect.GoType.structType([{ name : "value", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind))) }, { name : "file", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("mime/multipart.FileHeader", [], stdgo.reflect.Reflect.GoType.structType([{ name : "filename", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "header", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net/textproto.MIMEHeader", [], stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)))) }, { name : "size", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_content", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) }, { name : "_tmpfile", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }]))))) }]))) },
{ name : "trailer", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net/http.Header", [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "remoteAddr", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "requestURI", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "tls", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("crypto/tls.ConnectionState", [], stdgo.reflect.Reflect.GoType.structType([
{ name : "version", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint16_kind) },
{ name : "handshakeComplete", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) },
{ name : "didResume", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) },
{ name : "cipherSuite", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint16_kind) },
{ name : "negotiatedProtocol", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "negotiatedProtocolIsMutual", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) },
{ name : "serverName", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "peerCertificates", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("crypto/x509.Certificate", [], stdgo.reflect.Reflect.GoType.structType([
...
{ name : "uris", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/url.URL", [], stdgo.reflect.Reflect.GoType.invalidType))) },
...
{ name : "verifiedChains", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("crypto/x509.Certificate", [], stdgo.reflect.Reflect.GoType.invalidType)))) },
{ name : "signedCertificateTimestamps", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind))) },
{ name : "ocspresponse", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) },
{ name : "tlsunique", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) },
{ name : "_ekm", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) }]))) },
{ name : "cancel", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.chanType(2, stdgo.reflect.Reflect.GoType.named("net/http/httputil.failureToReadBody", [], stdgo.reflect.Reflect.GoType.structType([]))) },
{ name : "response", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/http.Response", [], stdgo.reflect.Reflect.GoType.structType([
{ name : "status", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "statusCode", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) },
{ name : "proto", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "protoMajor", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) },
{ name : "protoMinor", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) },
{ name : "header", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net/http.Header", [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "body", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("io.ReadCloser", [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "contentLength", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) },
{ name : "transferEncoding", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)) },
{ name : "close", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) },
{ name : "uncompressed", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) },
{ name : "trailer", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net/http.Header", [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "request", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/http.Request", [], stdgo.reflect.Reflect.GoType.invalidType)) },
{ name : "tls", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("crypto/tls.ConnectionState", [], stdgo.reflect.Reflect.GoType.invalidType)) }]))) },
{ name : "_ctx", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("context.Context", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }]))), stdgo.reflect.Reflect.GoType.basic(uint_kind)))).nil();
    public var _pipe : stdgo.net.textproto.Textproto.Pipeline = new stdgo.net.textproto.Textproto.Pipeline();
    public function new(?_mu:stdgo.sync.Sync.Mutex, ?_c:stdgo.net.Net.Conn, ?_r:Pointer<bufio.Bufio.Reader>, ?_re:stdgo.Error, ?_we:stdgo.Error, ?_lastbody:stdgo.io.Io.ReadCloser, ?_nread:GoInt, ?_nwritten:GoInt, ?_pipereq:GoMap<Pointer<stdgo.net.http.Http.Request>, GoUInt>, ?_pipe:stdgo.net.textproto.Textproto.Pipeline) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_mu) + " " + Go.string(_c) + " " + Go.string(_r) + " " + Go.string(_re) + " " + Go.string(_we) + " " + Go.string(_lastbody) + " " + Go.string(_nread) + " " + Go.string(_nwritten) + " " + Go.string(_pipereq) + " " + Go.string(_pipe) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class ClientConn {
    ...
    public function read(_req:Pointer<stdgo.net.http.Http.Request>):{ var _0 : Pointer<stdgo.net.http.Http.Response>; var _1 : Error; } {
        ...
        var recover_exception:Error = null;
        var deferstack:Array<Void -> Void> = [];
        var _resp:Pointer<stdgo.net.http.Http.Response> = new Pointer<stdgo.net.http.Http.Response>().nil(), _err:Error = ((null : stdgo.Error));
        _cc.value._mu.lock();
        try {
            var __tmp__ = _cc.value._pipereq.exists(_req) ? { value : _cc.value._pipereq[_req], ok : true } : { value : _cc.value._pipereq.defaultValue(), ok : false }, _id:GoUInt = __tmp__.value, _ok:Bool = __tmp__.ok;
    ...
    public function close():Error {
        var _cc = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _cc.value.hijack(), _c:stdgo.net.Net.Conn = __tmp__._0, _:Pointer<bufio.Bufio.Reader> = __tmp__._1;
        if (_c != null) {
            return _c.close();
        };
        return ((null : stdgo.Error));
    ...
    public function hijack():{ var _0 : stdgo.net.Net.Conn; var _1 : Pointer<bufio.Bufio.Reader>; } {
        ...
        var recover_exception:Error = null;
        var deferstack:Array<Void -> Void> = [];
        var _c:stdgo.net.Net.Conn = ((null : stdgo.net.Net.Conn)), _r:Pointer<bufio.Bufio.Reader> = new Pointer<bufio.Bufio.Reader>().nil();
        _cc.value._mu.lock();
        try {
            deferstack.unshift(() -> _cc.value._mu.unlock());
            _c = _cc.value._c;
...
{ name : "_ctx", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("context.Context", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }]))), stdgo.reflect.Reflect.GoType.basic(uint_kind)))).nil();
    ...
    public function new(?_mu:stdgo.sync.Sync.Mutex, ?_c:stdgo.net.Net.Conn, ?_r:Pointer<bufio.Bufio.Reader>, ?_re:stdgo.Error, ?_we:stdgo.Error, ?_lastbody:stdgo.io.Io.ReadCloser, ?_nread:GoInt, ?_nwritten:GoInt, ?_pipereq:GoMap<Pointer<stdgo.net.http.Http.Request>, GoUInt>, ?_pipe:stdgo.net.textproto.Textproto.Pipeline, ?_writeReq:(Pointer<stdgo.net.http.Http.Request>, stdgo.io.Io.Writer) -> stdgo.Error) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_mu) + " " + Go.string(_c) + " " + Go.string(_r) + " " + Go.string(_re) + " " + Go.string(_we) + " " + Go.string(_lastbody) + " " + Go.string(_nread) + " " + Go.string(_nwritten) + " " + Go.string(_pipereq) + " " + Go.string(_pipe) + " " + Go.string(_writeReq) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class ReverseProxy {
    public function _handleUpgradeResponse(_rw:stdgo.net.http.Http.ResponseWriter, _req:Pointer<stdgo.net.http.Http.Request>, _res:Pointer<stdgo.net.http.Http.Response>):Void {
        ...
        try {
            ...
            if (!net.http.internal.ascii.Ascii.equalFold(_reqUpType, _resUpType)) {
                _p.value._getErrorHandler()(_rw, _req, stdgo.fmt.Fmt.errorf("backend tried to switch protocol %q when %q was requested", Go.toInterface(_resUpType), Go.toInterface(_reqUpType)));
                return;
            };
            var __tmp__ = try {
            ...
            if (!_ok) {
                _p.value._getErrorHandler()(_rw, _req, stdgo.fmt.Fmt.errorf("can\'t switch protocols using non-Hijacker ResponseWriter type %T", Go.toInterface(_rw)));
                return;
            };
            var __tmp__ = try {
            ...
            var __tmp__ = _hj.hijack(), _conn:stdgo.net.Net.Conn = __tmp__._0, _brw:Pointer<bufio.Bufio.ReadWriter> = __tmp__._1, _err:stdgo.Error = __tmp__._2;
            if (_err != null) {
    ...
    public function _copyBuffer(_dst:stdgo.io.Io.Writer, _src:stdgo.io.Io.Reader, _buf:Slice<GoByte>):{ var _0 : GoInt64; var _1 : Error; } {
        ...
        if (_buf.length == ((0 : GoInt))) {
            _buf = new Slice<GoUInt8>(...[for (i in 0 ... ((((32 : GoUnTypedInt)) * ((1024 : GoUnTypedInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]);
        };
        var _written:GoInt64 = ((0 : GoInt64));
        while (true) {
            var __tmp__ = _src.read(_buf), _nr:GoInt = __tmp__._0, _rerr:stdgo.Error = __tmp__._1;
            if (_rerr != null && Go.toInterface(_rerr) != Go.toInterface(stdgo.io.Io.eof) && Go.toInterface(_rerr) != Go.toInterface(stdgo.context.Context.canceled)) {
                _p.value._logf("httputil: ReverseProxy read error during body copy: %v", Go.toInterface(_rerr));
            };
            if (_nr > ((0 : GoInt))) {
                var __tmp__ = _dst.write(_buf.__slice__(0, _nr)), _nw:GoInt = __tmp__._0, _werr:stdgo.Error = __tmp__._1;
                if (_nw > ((0 : GoInt))) {
    ...
    public function _copyResponse(_dst:stdgo.io.Io.Writer, _src:stdgo.io.Io.Reader, _flushInterval:stdgo.time.Time.Duration):Error {
        ...
        if (_flushInterval.__t__ != ((0 : GoInt64))) {
            {
                ...
                if (_ok) {
                    var _mlw:Pointer<T_maxLatencyWriter> = Go.pointer((({ _dst : _wf, _latency : _flushInterval, _mu : new stdgo.sync.Sync.Mutex(), _t : new Pointer<stdgo.time.Time.Timer>().nil(), _flushPending : false } : T_maxLatencyWriter)));
        ...
        try {
            ...
            var __tmp__ = _p.value._copyBuffer(_dst, _src, _buf), _:GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            {
                for (defer in deferstack) {
                    defer();
                };
    ...
    public function serveHTTP(_rw:stdgo.net.http.Http.ResponseWriter, _req:Pointer<stdgo.net.http.Http.Request>):Void {
        ...
        try {
            ...
            if (_outreq.value.header.__t__ == null || _outreq.value.header.__t__.isNil()) {
                _outreq.value.header = new stdgo.net.http.Http.Header(new GoMap<GoString, Slice<GoString>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)))))).__copy__();
            };
            ...
            {
                var __tmp__ = stdgo.net.Net.splitHostPort(_req.value.remoteAddr), _clientIP:GoString = __tmp__._0, _:GoString = __tmp__._1, _err:stdgo.Error = __tmp__._2;
                if (_err == null) {
                    var __tmp__ = _outreq.value.header.exists("X-Forwarded-For") ? { value : _outreq.value.header["X-Forwarded-For"], ok : true } : { value : _outreq.value.header.defaultValue(), ok : false }, _prior:Slice<GoString> = __tmp__.value, _ok:Bool = __tmp__.ok;
            ...
            var __tmp__ = _transport.roundTrip(_outreq), _res:Pointer<stdgo.net.http.Http.Response> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
            ...
            if (_announcedTrailers > ((0 : GoInt))) {
                var _trailerKeys:Slice<GoString> = new Slice<GoString>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) (("" : GoString))]).setCap((((_res.value.trailer.__t__ == null ? 0 : _res.value.trailer.__t__.length) : GoInt)).toBasic());
                {
                    var _k;
    ...
    public function _modifyResponse(_rw:stdgo.net.http.Http.ResponseWriter, _res:Pointer<stdgo.net.http.Http.Response>, _req:Pointer<stdgo.net.http.Http.Request>):Bool {
        var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
    ...
    public function new(?director:Pointer<stdgo.net.http.Http.Request> -> Void, ?transport:stdgo.net.http.Http.RoundTripper, ?flushInterval:stdgo.time.Time.Duration, ?errorLog:Pointer<stdgo.log.Log.Logger>, ?bufferPool:BufferPool, ?modifyResponse:Pointer<stdgo.net.http.Http.Response> -> stdgo.Error, ?errorHandler:(stdgo.net.http.Http.ResponseWriter, Pointer<stdgo.net.http.Http.Request>, stdgo.Error) -> Void) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(director) + " " + Go.string(transport) + " " + Go.string(flushInterval) + " " + Go.string(errorLog) + " " + Go.string(bufferPool) + " " + Go.string(modifyResponse) + " " + Go.string(errorHandler) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_maxLatencyWriter {
    ...
    public function new(?_dst:T_writeFlusher, ?_latency:stdgo.time.Time.Duration, ?_mu:stdgo.sync.Sync.Mutex, ?_t:Pointer<stdgo.time.Time.Timer>, ?_flushPending:Bool) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_dst) + " " + Go.string(_latency) + " " + Go.string(_mu) + " " + Go.string(_t) + " " + Go.string(_flushPending) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_switchProtocolCopier {
    public function _copyToBackend(_errc:Chan<Error>):Void {
        ...
        var __tmp__ = stdgo.io.Io.copy(_c._backend, _c._user), _:GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        _errc.send(_err);
    }
    public function _copyFromBackend(_errc:Chan<Error>):Void {
        var _c = this.__copy__();
        var __tmp__ = stdgo.io.Io.copy(_c._user, _c._backend), _:GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        _errc.send(_err);
    }
    ...
    public function new(?_user:stdgo.io.Io.ReadWriter, ?_backend:stdgo.io.Io.ReadWriter) stdgo.internal.Macro.initLocals();
    public function toString() {
...
var _hopHeaders : Slice<GoString> = new Slice<GoString>("Connection", "Proxy-Connection", "Keep-Alive", "Proxy-Authenticate", "Proxy-Authorization", "Te", "Trailer", "Transfer-Encoding", "Upgrade");
var _emptyBody : stdgo.io.Io.ReadCloser = stdgo.io.Io.nopCloser(stdgo.strings.Strings.newReader("").value);
var _reqWriteExcludeHeaderDump : GoMap<GoString, Bool> = new GoMap<GoString, Bool>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.basic(bool_kind))), { key : "Host", value : true }, { key : "Transfer-Encoding", value : true }, { key : "Trailer", value : true });
...
function _drainBody(_b:stdgo.io.Io.ReadCloser):{ var _0 : stdgo.io.Io.ReadCloser; var _1 : stdgo.io.Io.ReadCloser; var _2 : Error; } {
        var _r1:stdgo.io.Io.ReadCloser = ((null : stdgo.io.Io.ReadCloser)), _r2:stdgo.io.Io.ReadCloser = ((null : stdgo.io.Io.ReadCloser)), _err:Error = ((null : stdgo.Error));
        ...
        return { _0 : stdgo.io.Io.nopCloser(Go.pointer(_buf).value), _1 : stdgo.io.Io.nopCloser(stdgo.bytes.Bytes.newReader(_buf.bytes()).value), _2 : ((null : stdgo.Error)) };
    }
/**
...
function dumpRequestOut(_req:Pointer<stdgo.net.http.Http.Request>, _body:Bool):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        ...
        try {
            ...
            var _buf:stdgo.bytes.Bytes.Buffer = new stdgo.bytes.Bytes.Buffer();
            var __tmp__ = stdgo.io.Io.pipe(), _pr:Pointer<stdgo.io.Io.PipeReader> = __tmp__._0, _pw:Pointer<stdgo.io.Io.PipeWriter> = __tmp__._1;
            deferstack.unshift(() -> _pr.value.close());
            deferstack.unshift(() -> _pw.value.close());
            var _dr:Pointer<T_delegateReader> = Go.pointer((({ _c : new Chan<stdgo.io.Io.Reader>(0, () -> ((null : stdgo.io.Io.Reader))), _err : ((null : stdgo.Error)), _r : ((null : stdgo.io.Io.Reader)) } : T_delegateReader)));
            var _t:Pointer<stdgo.net.http.Http.Transport> = Go.pointer((({ dial : function(_net:GoString, _addr:GoString):{ var _0 : _net.Conn; var _1 : Error; } {
                return { _0 : Go.pointer(new T_dumpConn(stdgo.io.Io.multiWriter(Go.pointer(_buf).value, _pw.value), _dr.value)).value, _1 : ((null : stdgo.Error)) };
            }, _idleMu : new stdgo.sync.Sync.Mutex(), _closeIdle : false, _idleConn : new GoMap<stdgo.net.http.Http.T_connectMethodKey, Slice<Pointer<stdgo.net.http.Http.T_persistConn>>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("net/http.connectMethodKey", [], stdgo.reflect.Reflect.GoType.invalidType), stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/http.persistConn", [], stdgo.reflect.Reflect.GoType.structType([
{ name : "_alt", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net/http.RoundTripper", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) },
{ name : "_t", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/http.Transport", [], stdgo.reflect.Reflect.GoType.invalidType)) },
{ name : "_cacheKey", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net/http.connectMethodKey", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_proxy", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_scheme", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_addr", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_onlyH1", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }])) },
{ name : "_conn", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net.Conn", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) },
{ name : "_tlsState", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("crypto/tls.ConnectionState", [], stdgo.reflect.Reflect.GoType.structType([
{ name : "version", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint16_kind) },
{ name : "handshakeComplete", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) },
{ name : "didResume", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) },
{ name : "cipherSuite", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint16_kind) },
...
{ name : "tlsunique", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) },
{ name : "_ekm", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) }]))) },
{ name : "_br", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("bufio.Reader", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_buf", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) }, { name : "_rd", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("io.Reader", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }, { name : "_r", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }, { name : "_w", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }, { name : "_err", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("error", [], stdgo.reflect.Reflect.GoType.invalidType) }, { name : "_lastByte", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }, { name : "_lastRuneSize", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }]))) },
{ name : "_bw", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("bufio.Writer", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_err", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("error", [], stdgo.reflect.Reflect.GoType.invalidType) }, { name : "_buf", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) }, { name : "_n", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }, { name : "_wr", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("io.Writer", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }]))) },
{ name : "_nwrite", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) },
{ name : "_reqch", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.chanType(0, stdgo.reflect.Reflect.GoType.named("net/http.requestAndChan", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net/http.incomparable", [], stdgo.reflect.Reflect.GoType.arrayType(stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType), 0)) }, { name : "_req", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/http.Request", [], stdgo.reflect.Reflect.GoType.structType([
{ name : "method", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "url", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/url.URL", [], stdgo.reflect.Reflect.GoType.invalidType)) },
{ name : "proto", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "protoMajor", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) },
{ name : "protoMinor", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) },
{ name : "header", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net/http.Header", [], stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)))) },
...
{ name : "request", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/http.Request", [], stdgo.reflect.Reflect.GoType.invalidType)) },
{ name : "tls", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("crypto/tls.ConnectionState", [], stdgo.reflect.Reflect.GoType.invalidType)) }]))) },
{ name : "_ctx", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("context.Context", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }]))) }, { name : "_cancelKey", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net/http.cancelKey", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_req", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/http.Request", [], stdgo.reflect.Reflect.GoType.invalidType)) }])) }, { name : "_ch", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.chanType(0, stdgo.reflect.Reflect.GoType.named("net/http.responseAndError", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net/http.incomparable", [], stdgo.reflect.Reflect.GoType.invalidType) }, { name : "_res", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/http.Response", [], stdgo.reflect.Reflect.GoType.invalidType)) }, { name : "_err", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("error", [], stdgo.reflect.Reflect.GoType.invalidType) }]))) }, { name : "_addedGzip", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }, { name : "_continueCh", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.chanType(1, stdgo.reflect.Reflect.GoType.named("net/http/httputil.failureToReadBody", [], stdgo.reflect.Reflect.GoType.structType([]))) }, { name : "_callerGone", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.chanType(2, stdgo.reflect.Reflect.GoType.named("net/http/httputil.failureToReadBody", [], stdgo.reflect.Reflect.GoType.structType([]))) }]))) },
{ name : "_writech", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.chanType(0, stdgo.reflect.Reflect.GoType.named("net/http.writeRequest", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_req", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/http.transportRequest", [], stdgo.reflect.Reflect.GoType.structType([{ name : "request", embedded : true, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/http.Request", [], stdgo.reflect.Reflect.GoType.invalidType)) }, { name : "_extra", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net/http.Header", [], stdgo.reflect.Reflect.GoType.invalidType) }, { name : "_trace", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/http/httptrace.ClientTrace", [], stdgo.reflect.Reflect.GoType.structType([
{ name : "getConn", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "gotConn", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "putIdleConn", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "gotFirstResponseByte", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "got100Continue", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "got1xxResponse", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "dnsstart", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "dnsdone", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "connectStart", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "connectDone", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "tlshandshakeStart", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "tlshandshakeDone", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "wroteHeaderField", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "wroteHeaders", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "wait100Continue", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "wroteRequest", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) }]))) }, { name : "_cancelKey", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net/http.cancelKey", [], stdgo.reflect.Reflect.GoType.invalidType) }, { name : "_mu", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.Mutex", [], stdgo.reflect.Reflect.GoType.invalidType) }, { name : "_err", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("error", [], stdgo.reflect.Reflect.GoType.invalidType) }]))) }, { name : "_ch", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.chanType(1, stdgo.reflect.Reflect.GoType.named("error", [], stdgo.reflect.Reflect.GoType.invalidType)) }, { name : "_continueCh", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.chanType(2, stdgo.reflect.Reflect.GoType.named("net/http/httputil.failureToReadBody", [], stdgo.reflect.Reflect.GoType.structType([]))) }]))) },
{ name : "_closech", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.chanType(0, stdgo.reflect.Reflect.GoType.named("net/http/httputil.failureToReadBody", [], stdgo.reflect.Reflect.GoType.structType([]))) },
{ name : "_isProxy", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) },
{ name : "_sawEOF", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) },
{ name : "_readLimit", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) },
{ name : "_writeErrCh", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.chanType(0, stdgo.reflect.Reflect.GoType.named("error", [], stdgo.reflect.Reflect.GoType.invalidType)) },
{ name : "_writeLoopDone", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.chanType(0, stdgo.reflect.Reflect.GoType.named("net/http/httputil.failureToReadBody", [], stdgo.reflect.Reflect.GoType.structType([]))) },
{ name : "_idleAt", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("time.Time", [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "_idleTimer", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("time.Timer", [], stdgo.reflect.Reflect.GoType.structType([{ name : "c", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.chanType(2, stdgo.reflect.Reflect.GoType.named("time.Time", [], stdgo.reflect.Reflect.GoType.invalidType)) }, { name : "_r", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("time.runtimeTimer", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_pp", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uintptr_kind) }, { name : "_when", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_period", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_f", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) }, { name : "_arg", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.interfaceType(true, []) }, { name : "_seq", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uintptr_kind) }, { name : "_nextwhen", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int64_kind) }, { name : "_status", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }])) }]))) },
{ name : "_mu", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.Mutex", [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "_numExpectedResponses", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) },
{ name : "_closed", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("error", [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "_canceledErr", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("error", [], stdgo.reflect.Reflect.GoType.invalidType) },
{ name : "_broken", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) },
{ name : "_reused", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) },
{ name : "_mutateHeaderFunc", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) }]))))))).nil(), _idleConnWait : new GoMap<stdgo.net.http.Http.T_connectMethodKey, stdgo.net.http.Http.T_wantConnQueue>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("net/http.connectMethodKey", [], stdgo.reflect.Reflect.GoType.invalidType), stdgo.reflect.Reflect.GoType.named("net/http.wantConnQueue", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_head", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/http.wantConn", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_cm", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net/http.connectMethod", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net/http.incomparable", [], stdgo.reflect.Reflect.GoType.invalidType) }, { name : "_proxyURL", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/url.URL", [], stdgo.reflect.Reflect.GoType.invalidType)) }, { name : "_targetScheme", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_targetAddr", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_onlyH1", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }])) }, { name : "_key", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("net/http.connectMethodKey", [], stdgo.reflect.Reflect.GoType.invalidType) }, { name : "_ctx", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("context.Context", [], stdgo.reflect.Reflect.GoType.invalidType) }, { name : "_ready", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.chanType(0, stdgo.reflect.Reflect.GoType.named("net/http/httputil.failureToReadBody", [], stdgo.reflect.Reflect.GoType.structType([]))) }, { name : "_beforeDial", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) }, { name : "_afterDial", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType) }, { name : "_mu", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.Mutex", [], stdgo.reflect.Reflect.GoType.invalidType) }, { name : "_pc", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/http.persistConn", [], stdgo.reflect.Reflect.GoType.invalidType)) }, { name : "_err", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("error", [], stdgo.reflect.Reflect.GoType.invalidType) }])))) }, { name : "_headPos", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }, { name : "_tail", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/http.wantConn", [], stdgo.reflect.Reflect.GoType.invalidType))) }]))))).nil(), _idleLRU : new stdgo.net.http.Http.T_connLRU(), _reqMu : ((null : stdgo.sync.Sync.Mutex)), _reqCanceler : new GoMap<stdgo.net.http.Http.T_cancelKey, stdgo.Error -> Void>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("net/http.cancelKey", [], stdgo.reflect.Reflect.GoType.invalidType), stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType)))).nil(), _altMu : ((null : stdgo.sync.Sync.Mutex)), _altProto : new stdgo.sync.atomic.Atomic.Value(), _connsPerHostMu : ((null : stdgo.sync.Sync.Mutex)), _connsPerHost : new GoMap<stdgo.net.http.Http.T_connectMethodKey, GoInt>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("net/http.connectMethodKey", [], stdgo.reflect.Reflect.GoType.invalidType), stdgo.reflect.Reflect.GoType.basic(int_kind)))).nil(), _connsPerHostWait : new GoMap<stdgo.net.http.Http.T_connectMethodKey, stdgo.net.http.Http.T_wantConnQueue>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("net/http.connectMethodKey", [], stdgo.reflect.Reflect.GoType.invalidType), stdgo.reflect.Reflect.GoType.named("net/http.wantConnQueue", [], stdgo.reflect.Reflect.GoType.invalidType)))).nil(), proxy : null, dialContext : null, dialTLSContext : null, dialTLS : null, tlsclientConfig : new Pointer<stdgo.crypto.tls.Tls.Config>().nil(), tlshandshakeTimeout : ((null : stdgo.time.Time.Duration)), disableKeepAlives : false, disableCompression : false, maxIdleConns : 0, maxIdleConnsPerHost : 0, maxConnsPerHost : 0, idleConnTimeout : ((null : stdgo.time.Time.Duration)), responseHeaderTimeout : ((null : stdgo.time.Time.Duration)), expectContinueTimeout : ((null : stdgo.time.Time.Duration)), tlsnextProto : new GoMap<GoString, (GoString, Pointer<stdgo.crypto.tls.Tls.Conn>) -> stdgo.net.http.Http.RoundTripper>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.signature(false, [], [], stdgo.reflect.Reflect.GoType.invalidType)))).nil(), proxyConnectHeader : ((null : stdgo.net.http.Http.Header)), getProxyConnectHeader : null, maxResponseHeaderBytes : 0, writeBufferSize : 0, readBufferSize : 0, _nextProtoOnce : new stdgo.sync.Sync.Once(), _h2transport : ((null : stdgo.net.http.Http.T_h2Transport)), _tlsNextProtoWasNil : false, forceAttemptHTTP2 : false } : stdgo.net.http.Http.Transport)));
            ...
            Go.routine({
                var a = function():Void {
                    var __tmp__ = stdgo.net.http.Http.readRequest(bufio.Bufio.newReader(_pr.value)), _req:Pointer<stdgo.net.http.Http.Request> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                    if (_err == null) {
            ...
            var __tmp__ = _t.value.roundTrip(_reqSend), _:Pointer<stdgo.net.http.Http.Response> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
...
function dumpRequest(_req:Pointer<stdgo.net.http.Http.Request>, _body:Bool):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        ...
        stdgo.fmt.Fmt.fprintf(Go.pointer(_b).value, "%s %s HTTP/%d.%d\r\n", Go.toInterface(_valueOrDefault(_req.value.method, "GET")), Go.toInterface(_reqURI), Go.toInterface(_req.value.protoMajor), Go.toInterface(_req.value.protoMinor));
        var _absRequestURI:Bool = stdgo.strings.Strings.hasPrefix(_req.value.requestURI, "http://") || stdgo.strings.Strings.hasPrefix(_req.value.requestURI, "https://");
        if (!_absRequestURI) {
        ...
        var _chunked:Bool = _req.value.transferEncoding.length > ((0 : GoInt)) && _req.value.transferEncoding[((0 : GoInt))] == (("chunked" : GoString));
...
function newServerConn(_c:stdgo.net.Net.Conn, _r:Pointer<bufio.Bufio.Reader>):Pointer<ServerConn> {
        ...
        return Go.pointer((({ _c : _c, _r : _r, _pipereq : new GoMap<Pointer<stdgo.net.http.Http.Request>, GoUInt>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/http.Request", [], stdgo.reflect.Reflect.GoType.structType([
{ name : "method", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "url", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/url.URL", [], stdgo.reflect.Reflect.GoType.structType([{ name : "scheme", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "opaque", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "user", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/url.Userinfo", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_username", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_password", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "_passwordSet", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }]))) }, { name : "host", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "path", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "rawPath", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "forceQuery", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(bool_kind) }, { name : "rawQuery", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "fragment", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "rawFragment", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }]))) },
{ name : "proto", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) },
{ name : "protoMajor", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) },
...
{ name : "request", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/http.Request", [], stdgo.reflect.Reflect.GoType.invalidType)) },
{ name : "tls", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("crypto/tls.ConnectionState", [], stdgo.reflect.Reflect.GoType.invalidType)) }]))) },
{ name : "_ctx", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("context.Context", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }]))), stdgo.reflect.Reflect.GoType.basic(uint_kind)))), _mu : new stdgo.sync.Sync.Mutex(), _re : ((null : stdgo.Error)), _we : ((null : stdgo.Error)), _lastbody : ((null : stdgo.io.Io.ReadCloser)), _nread : 0, _nwritten : 0, _pipe : new stdgo.net.textproto.Textproto.Pipeline() } : ServerConn)));
    }
/**
...
{ name : "request", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/http.Request", [], stdgo.reflect.Reflect.GoType.invalidType)) },
{ name : "tls", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("crypto/tls.ConnectionState", [], stdgo.reflect.Reflect.GoType.invalidType)) }]))) },
{ name : "_ctx", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("context.Context", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }]))), stdgo.reflect.Reflect.GoType.basic(uint_kind)))), _writeReq : (stdgo.net.http.Http.request.value).value.write, _mu : new stdgo.sync.Sync.Mutex(), _re : ((null : stdgo.Error)), _we : ((null : stdgo.Error)), _lastbody : ((null : stdgo.io.Io.ReadCloser)), _nread : 0, _nwritten : 0, _pipe : new stdgo.net.textproto.Textproto.Pipeline() } : ClientConn)));
    }
/**
...
function _joinURLPath(_a:Pointer<stdgo.net.url.Url.URL>, _b:Pointer<stdgo.net.url.Url.URL>):{ var _0 : GoString; var _1 : GoString; } {
        var _path:GoString = (("" : GoString)), _rawpath:GoString = (("" : GoString));
...
function newSingleHostReverseProxy(_target:Pointer<stdgo.net.url.Url.URL>):Pointer<ReverseProxy> {
        ...
        var _director:Pointer<stdgo.net.http.Http.Request> -> Void = function(_req:Pointer<stdgo.net.http.Http.Request>):Void {
            ...
            {
                var __tmp__ = _req.value.header.exists("User-Agent") ? { value : _req.value.header["User-Agent"], ok : true } : { value : _req.value.header.defaultValue(), ok : false }, _:Slice<GoString> = __tmp__.value, _ok:Bool = __tmp__.ok;
                if (!_ok) {
                    _req.value.header.set("User-Agent", "");
                };
            };
        };
        return Go.pointer((({ director : _director, transport : ((null : stdgo.net.http.Http.RoundTripper)), flushInterval : new stdgo.time.Time.Duration(), errorLog : new Pointer<stdgo.log.Log.Logger>().nil(), bufferPool : ((null : BufferPool)), modifyResponse : null, errorHandler : null } : ReverseProxy)));
    }
...
class ServerConn_extension_fields {
    public function hijack(__tmp__):{ var _0 : stdgo.net.Net.Conn; var _1 : Pointer<bufio.Bufio.Reader>; } return __tmp__.hijack();
    public function close(__tmp__):Error return __tmp__.close();
    public function read(__tmp__):{ var _0 : Pointer<stdgo.net.http.Http.Request>; var _1 : Error; } return __tmp__.read();
    public function pending(__tmp__):GoInt return __tmp__.pending();
    public function write(__tmp__, _req:Pointer<stdgo.net.http.Http.Request>, _resp:Pointer<stdgo.net.http.Http.Response>):Error return __tmp__.write(_req, _resp);
}
class ClientConn_extension_fields {
    public function hijack(__tmp__):{ var _0 : stdgo.net.Net.Conn; var _1 : Pointer<bufio.Bufio.Reader>; } return __tmp__.hijack();
    public function close(__tmp__):Error return __tmp__.close();
    public function write(__tmp__, _req:Pointer<stdgo.net.http.Http.Request>):Error return __tmp__.write(_req);
    public function pending(__tmp__):GoInt return __tmp__.pending();
    public function read(__tmp__, _req:Pointer<stdgo.net.http.Http.Request>):{ var _0 : Pointer<stdgo.net.http.Http.Response>; var _1 : Error; } return __tmp__.read(_req);
    public function do_(__tmp__, _req:Pointer<stdgo.net.http.Http.Request>):{ var _0 : Pointer<stdgo.net.http.Http.Response>; var _1 : Error; } return __tmp__.do_(_req);
}
class ReverseProxy_extension_fields {
    public function _defaultErrorHandler(__tmp__, _rw:stdgo.net.http.Http.ResponseWriter, _req:Pointer<stdgo.net.http.Http.Request>, _err:Error):Void __tmp__._defaultErrorHandler(_rw, _req, _err);
    public function _getErrorHandler(__tmp__):(stdgo.net.http.Http.ResponseWriter, Pointer<stdgo.net.http.Http.Request>, Error) -> Void return __tmp__._getErrorHandler();
    public function _modifyResponse(__tmp__, _rw:stdgo.net.http.Http.ResponseWriter, _res:Pointer<stdgo.net.http.Http.Response>, _req:Pointer<stdgo.net.http.Http.Request>):Bool return __tmp__._modifyResponse(_rw, _res, _req);
    ...
    public function _flushInterval(__tmp__, _res:Pointer<stdgo.net.http.Http.Response>):stdgo.time.Time.Duration return __tmp__._flushInterval(_res);
    public function _copyResponse(__tmp__, _dst:stdgo.io.Io.Writer, _src:stdgo.io.Io.Reader, _flushInterval:stdgo.time.Time.Duration):Error return __tmp__._copyResponse(_dst, _src, _flushInterval);
    public function _copyBuffer(__tmp__, _dst:stdgo.io.Io.Writer, _src:stdgo.io.Io.Reader, _buf:Slice<GoByte>):{ var _0 : GoInt64; var _1 : Error; } return __tmp__._copyBuffer(_dst, _src, _buf);
    public function _logf(__tmp__, _format:GoString, _args:haxe.Rest<AnyInterface>):Void __tmp__._logf(_format, _args);
    public function _handleUpgradeResponse(__tmp__, _rw:stdgo.net.http.Http.ResponseWriter, _req:Pointer<stdgo.net.http.Http.Request>, _res:Pointer<stdgo.net.http.Http.Response>):Void __tmp__._handleUpgradeResponse(_rw, _req, _res);
}
class T_maxLatencyWriter_extension_fields {
    ...
    public function _delayedFlush(__tmp__):Void __tmp__._delayedFlush();
    public function _stop(__tmp__):Void __tmp__._stop();
}
class T_switchProtocolCopier_extension_fields {
    public function _copyFromBackend(__tmp__, _errc:Chan<Error>):Void __tmp__._copyFromBackend(_errc);
    public function _copyToBackend(__tmp__, _errc:Chan<Error>):Void __tmp__._copyToBackend(_errc);
}
