...
@:structInit class T_chunkedReader {
	...
	public function _chunkHeaderAvailable():Bool {
		...
		if (_n > ((0 : GoInt))) {
			var __tmp__ = _cr.value._r.value.peek(_n),
	...
	public function new(?_r:Pointer<bufio.Bufio.Reader>, ?_n:GoUInt64, ?_err:stdgo.Error, ?_buf:GoArray<GoUInt8>, ?_checkEnd:Bool)
...
@:structInit class T_chunkedWriter {
	...
	public function new(?wire:stdgo.io.Io.Writer)
		stdgo.internal.Macro.initLocals();
...
@:structInit class FlushAfterChunkWriter {
	...
	public function new(?writer:Pointer<bufio.Bufio.Writer>)
		stdgo.internal.Macro.initLocals();
...
function newChunkedReader(_r:stdgo.io.Io.Reader):stdgo.io.Io.Reader {
	...
	return Go.pointer((({
		...
		_buf: new GoArray<GoUInt8>(...[for (i in 0...2) ((0 : GoUInt8))]),
		_checkEnd: false
	} : T_chunkedReader))).value;
}
...
class T_chunkedReader_extension_fields {
	public function _beginChunk(__tmp__):Void
		__tmp__._beginChunk();

	public function _chunkHeaderAvailable(__tmp__):Bool
		return __tmp__._chunkHeaderAvailable();

	public function read(__tmp__, _b:Slice<GoUInt8>):{var _0:GoInt; var _1:Error;}
