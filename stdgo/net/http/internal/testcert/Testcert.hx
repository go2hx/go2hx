...
private function set_localhostCert(v:Array<std.UInt>):Array<std.UInt> {
        stdgo._internal.net.http.internal.testcert.Testcert_localhostCert.localhostCert = ([for (i in v) i] : stdgo.Slice<stdgo.GoUInt8>);
        return v;
    }
...
private function set_localhostKey(v:Array<std.UInt>):Array<std.UInt> {
        stdgo._internal.net.http.internal.testcert.Testcert_localhostKey.localhostKey = ([for (i in v) i] : stdgo.Slice<stdgo.GoUInt8>);
        return v;
    }
/**
