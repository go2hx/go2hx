...
@:named class T_handler {
    public function _serveDeltaProfile(_w:stdgo.net.http.Http.ResponseWriter, _r:Pointer<stdgo.net.http.Http.Request>, _p:Pointer<stdgo.runtime.pprof.Pprof.Profile>, _secStr:GoString):Void {
        var _name = this.__copy__();
        var recover_exception:Error = null;
        var deferstack:Array<Void -> Void> = [];
        try {
            var __tmp__ = stdgo.strconv.Strconv.parseInt(_secStr, ((10 : GoInt)), ((64 : GoInt))), _sec:GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            ...
            var __tmp__ = stdgo.strconv.Strconv.atoi(_r.value.formValue("debug")), _debug:GoInt = __tmp__._0, _:stdgo.Error = __tmp__._1;
            if (_debug != ((0 : GoInt))) {
                _serveError(_w, stdgo.net.http.Http.statusBadRequest, "seconds and debug params are incompatible");
                return;
            };
            var __tmp__ = _collectProfile(_p), _p0:Pointer<internal.profile.Profile.Profile> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                _serveError(_w, stdgo.net.http.Http.statusInternalServerError, "failed to collect profile");
                return;
            };
            var _t:Pointer<stdgo.time.Time.Timer> = stdgo.time.Time.newTimer(new stdgo.time.Time.Duration(new stdgo.time.Time.Duration(_sec).__t__ * stdgo.time.Time.second.__t__));
            ...
            var __tmp__ = _collectProfile(_p), _p1:Pointer<internal.profile.Profile.Profile> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                _serveError(_w, stdgo.net.http.Http.statusInternalServerError, "failed to collect profile");
                {
                    for (defer in deferstack) {
    ...
    public function serveHTTP(_w:stdgo.net.http.Http.ResponseWriter, _r:Pointer<stdgo.net.http.Http.Request>):Void {
        ...
        var __tmp__ = stdgo.strconv.Strconv.atoi(_r.value.formValue("gc")), _gc:GoInt = __tmp__._0, _:stdgo.Error = __tmp__._1;
    ...
    public function __copy__() return new T_handler(__t__);
}
@:structInit class T_profileEntry {
    ...
    public function new(?name:GoString, ?href:GoString, ?desc:GoString, ?count:GoInt) stdgo.internal.Macro.initLocals();
...
var _profileDescriptions : GoMap<GoString, GoString> = new GoMap<GoString, GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.basic(string_kind))), { key : "allocs", value : "A sampling of all past memory allocations" }, { key : "block", value : "Stack traces that led to blocking on synchronization primitives" }, { key : "cmdline", value : "The command line invocation of the current program" }, { key : "goroutine", value : "Stack traces of all current goroutines" }, { key : "heap", value : "A sampling of memory allocations of live objects. You can specify the gc GET parameter to run GC before taking the heap sample." }, { key : "mutex", value : "Stack traces of holders of contended mutexes" }, { key : "profile", value : "CPU profile. You can specify the duration in the seconds GET parameter. After you get the profile file, use the go tool pprof command to investigate the profile." }, { key : "threadcreate", value : "Stack traces that led to the creation of new OS threads" }, { key : "trace", value : "A trace of execution of the current program. You can specify the duration in the seconds GET parameter. After you get the trace file, use the go tool trace command to investigate the trace." });
var _profileSupportsDelta : GoMap<T_handler, Bool> = new GoMap<T_handler, Bool>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("net/http/pprof.handler", [], stdgo.reflect.Reflect.GoType.basic(string_kind)), stdgo.reflect.Reflect.GoType.basic(bool_kind))), { key : new T_handler("allocs"), value : true }, { key : new T_handler("block"), value : true }, { key : new T_handler("goroutine"), value : true }, { key : new T_handler("heap"), value : true }, { key : new T_handler("mutex"), value : true }, { key : new T_handler("threadcreate"), value : true });
/**
...
function profile(_w:stdgo.net.http.Http.ResponseWriter, _r:Pointer<stdgo.net.http.Http.Request>):Void {
        _w.header().set("X-Content-Type-Options", "nosniff");
        var __tmp__ = stdgo.strconv.Strconv.parseInt(_r.value.formValue("seconds"), ((10 : GoInt)), ((64 : GoInt))), _sec:GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
...
function trace(_w:stdgo.net.http.Http.ResponseWriter, _r:Pointer<stdgo.net.http.Http.Request>):Void {
        _w.header().set("X-Content-Type-Options", "nosniff");
        var __tmp__ = stdgo.strconv.Strconv.parseFloat(_r.value.formValue("seconds"), ((64 : GoInt))), _sec:GoFloat64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
...
function symbol(_w:stdgo.net.http.Http.ResponseWriter, _r:Pointer<stdgo.net.http.Http.Request>):Void {
        ...
        while (true) {
            var __tmp__ = _b.value.readSlice((("+".code : GoRune))), _word:Slice<GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err == null) {
                _word = _word.__slice__(((0 : GoInt)), _word.length - ((1 : GoInt)));
            };
            var __tmp__ = stdgo.strconv.Strconv.parseUint(((_word : GoString)), ((0 : GoInt)), ((64 : GoInt))), _pc:GoUInt64 = __tmp__._0, _:stdgo.Error = __tmp__._1;
            if (_pc != ((0 : GoUInt64))) {
...
function _collectProfile(_p:Pointer<stdgo.runtime.pprof.Pprof.Profile>):{ var _0 : Pointer<internal.profile.Profile.Profile>; var _1 : Error; } {
        ...
        var __tmp__ = internal.profile.Profile.parse(Go.pointer(_buf).value), _p0:Pointer<internal.profile.Profile.Profile> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<internal.profile.Profile.Profile>().nil(), _1 : _err };
        };
...
function index(_w:stdgo.net.http.Http.ResponseWriter, _r:Pointer<stdgo.net.http.Http.Request>):Void {
        ...
        for (_p in stdgo.runtime.pprof.Pprof.profiles()) {
            _profiles = _profiles.__append__((({ name : _p.value.name(), href : _p.value.name(), desc : _profileDescriptions[_p.value.name()], count : _p.value.count() } : T_profileEntry)).__copy__());
        };
        for (_p in new Slice<GoString>("cmdline", "profile", "trace")) {
            _profiles = _profiles.__append__((({ name : _p, href : _p, desc : _profileDescriptions[_p], count : 0 } : T_profileEntry)).__copy__());
        };
...
function _indexTmplExecute(_w:stdgo.io.Io.Writer, _profiles:Slice<T_profileEntry>):Error {
        ...
        for (_profile in _profiles) {
            var _link:Pointer<stdgo.net.url.Url.URL> = Go.pointer((({ path : _profile.href, rawQuery : "debug=1", scheme : "", opaque : "", user : new Pointer<stdgo.net.url.Url.Userinfo>().nil(), host : "", rawPath : "", forceQuery : false, fragment : "", rawFragment : "" } : stdgo.net.url.Url.URL)));
            stdgo.fmt.Fmt.fprintf(Go.pointer(_b).value, "<tr><td>%d</td><td><a href=\'%s\'>%s</a></td></tr>\n", Go.toInterface(_profile.count), Go.toInterface(_link), Go.toInterface(stdgo.html.Html.escapeString(_profile.name)));
        };
        ...
        _b.writeString("</ul>\n</p>\n</body>\n</html>");
        var __tmp__ = _w.write(_b.bytes()), _:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        return _err;
    }
@:keep var _ = {
        try {
...
class T_handler_extension_fields {
    public function serveHTTP(__tmp__, _w:stdgo.net.http.Http.ResponseWriter, _r:Pointer<stdgo.net.http.Http.Request>):Void __tmp__.serveHTTP(_w, _r);
    public function _serveDeltaProfile(__tmp__, _w:stdgo.net.http.Http.ResponseWriter, _r:Pointer<stdgo.net.http.Http.Request>, _p:Pointer<stdgo.runtime.pprof.Pprof.Profile>, _secStr:GoString):Void __tmp__._serveDeltaProfile(_w, _r, _p, _secStr);
}
