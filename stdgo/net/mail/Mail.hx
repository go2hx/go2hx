...
@:structInit class Message {
	...
	public function new(?header:Header, ?body:stdgo.io.Io.Reader)
...
@:structInit class Address {
	public function toString():GoString {
		...
		var _local:GoString = (("" : GoString)),
			_domain:GoString = (("" : GoString));
		if (_at < ((0 : GoInt))) {
	...
	public function new(?name:GoString, ?address:GoString)
		stdgo.internal.Macro.initLocals();
...
@:structInit class AddressParser {
	...
	public function new(?wordDecoder:Pointer<stdgo.mime.Mime.WordDecoder>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_addrParser {
	...
	public function _skipCFWS():Bool {
		...
		while (true) {
			...
			{
				var __tmp__ = _p.value._consumeComment(),
		...
		});
		{
			...
			for (_obj in _words.keyValueIterator()) {
				...
				var __tmp__ = _p.value._decodeRFC2047Word(_word),
					_decoded:GoString = __tmp__._0,
					_isEncoded:Bool = __tmp__._1,
	...
	public function _consumeAtom(_dot:Bool, _permissive:Bool):{var _0:GoString; var _1:Error;} {
		...
		return stdgo.internal.Macro.controlFlow({
			var _atom:GoString = (("" : GoString)),
				_err:Error = ((null : stdgo.Error));
			var _i:GoInt = ((0 : GoInt));
			@:label("Loop") while (true) {
				var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRuneInString(_p.value._s.__slice__(_i)),
	...
	public function _consumeQuotedString():{var _0:GoString; var _1:Error;} {
		var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		return stdgo.internal.Macro.controlFlow({
			var _qs:GoString = (("" : GoString)),
				_err:Error = ((null : stdgo.Error));
			var _i:GoInt = ((1 : GoInt));
			var _qsb:Slice<GoInt32> = new Slice<GoInt32>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoInt32))])
				.setCap(((((10 : GoInt)) : GoInt)).toBasic());
	...
	public function _consumeGroupList():{var _0:Slice<Pointer<Address>>; var _1:Error;} {
		...
		while (true) {
			_p.value._skipSpace();
			var __tmp__ = _p.value._parseAddress(false),
				_addrs:Slice<Pointer<Address>> = __tmp__._0,
	...
	public function _parseSingleAddress():{var _0:Pointer<Address>; var _1:Error;} {
		var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _p.value._parseAddress(true),
			_addrs:Slice<Pointer<Address>> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
	...
	public function new(?_s:GoString, ?_dec:Pointer<stdgo.mime.Mime.WordDecoder>)
		stdgo.internal.Macro.initLocals();
...
@:named class T_charsetError {
	...
	public function __copy__()
		return new T_charsetError(__t__);
}
...
var _rfc2047Decoder:stdgo.mime.Mime.WordDecoder = (({
	charsetReader: function(_charset:GoString, _input:stdgo.io.Io.Reader):{var _0:stdgo.io.Io.Reader; var _1:Error;} {
...
function readMessage(_r:stdgo.io.Io.Reader):{var _0:Pointer<Message>; var _1:Error;} {
	var _msg:Pointer<Message> = new Pointer<Message>().nil(),
		_err:Error = ((null : stdgo.Error));
	var _tp:Pointer<stdgo.net.textproto.Textproto.Reader> = stdgo.net.textproto.Textproto.newReader(bufio.Bufio.newReader(_r));
	var __tmp__ = _tp.value.readMIMEHeader(),
		_hdr:stdgo.net.textproto.Textproto.MIMEHeader = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
...
function parseDate(_date:GoString):{var _0:stdgo.time.Time.Time; var _1:Error;} {
	...
	for (_layout in _dateLayouts) {
		var __tmp__ = stdgo.time.Time.parse(_layout, _date),
			_t:stdgo.time.Time.Time = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err == null) {
...
class T_debugT_extension_fields {
	public function printf(__tmp__, _format:GoString, _args:haxe.Rest<AnyInterface>):Void
		__tmp__.printf(_format, _args);
}
...
class Header_extension_fields {
	...
	public function date(__tmp__):{var _0:stdgo.time.Time.Time; var _1:Error;}
		return __tmp__.date();

	public function addressList(__tmp__, _key:GoString):{var _0:Slice<Pointer<Address>>; var _1:Error;}
		return __tmp__.addressList(_key);
}
...
class AddressParser_extension_fields {
	public function parse(__tmp__, _address:GoString):{var _0:Pointer<Address>; var _1:Error;}
		return __tmp__.parse(_address);

	public function parseList(__tmp__, _list:GoString):{var _0:Slice<Pointer<Address>>; var _1:Error;}
		return __tmp__.parseList(_list);
}

class T_addrParser_extension_fields {
	public function _parseAddressList(__tmp__):{var _0:Slice<Pointer<Address>>; var _1:Error;}
		return __tmp__._parseAddressList();

	public function _parseSingleAddress(__tmp__):{var _0:Pointer<Address>; var _1:Error;}
		return __tmp__._parseSingleAddress();

	public function _parseAddress(__tmp__, _handleGroup:Bool):{var _0:Slice<Pointer<Address>>; var _1:Error;}
		return __tmp__._parseAddress(_handleGroup);

	public function _consumeGroupList(__tmp__):{var _0:Slice<Pointer<Address>>; var _1:Error;}
		return __tmp__._consumeGroupList();

	public function _consumeAddrSpec(__tmp__):{var _0:GoString; var _1:Error;}
		return __tmp__._consumeAddrSpec();

	public function _consumePhrase(__tmp__):{var _0:GoString; var _1:Error;}
		return __tmp__._consumePhrase();

	public function _consumeQuotedString(__tmp__):{var _0:GoString; var _1:Error;}
		return __tmp__._consumeQuotedString();

	public function _consumeAtom(__tmp__, _dot:Bool, _permissive:Bool):{var _0:GoString; var _1:Error;}
		return __tmp__._consumeAtom(_dot, _permissive);

	public function _consumeDisplayNameComment(__tmp__):{var _0:GoString; var _1:Error;}
		return __tmp__._consumeDisplayNameComment();

	public function _consume(__tmp__, _c:GoByte):Bool
		return __tmp__._consume(_c);

	public function _skipSpace(__tmp__):Void
		__tmp__._skipSpace();

	public function _peek(__tmp__):GoByte
		return __tmp__._peek();
	...
	public function _skipCFWS(__tmp__):Bool
		return __tmp__._skipCFWS();

	public function _consumeComment(__tmp__):{var _0:GoString; var _1:Bool;}
		return __tmp__._consumeComment();

	public function _decodeRFC2047Word(__tmp__, _s:GoString):{var _0:GoString; var _1:Bool; var _2:Error;}
		return __tmp__._decodeRFC2047Word(_s);
}
