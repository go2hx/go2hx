...
@:named class ServerError {
    ...
    public function __copy__() return new ServerError(__t__);
}
@:structInit class Call {
    ...
    public function new(?serviceMethod:GoString, ?args:AnyInterface, ?reply:AnyInterface, ?error:stdgo.Error, ?done:Chan<Pointer<Call>>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(serviceMethod) + " " + Go.string(args) + " " + Go.string(reply) + " " + Go.string(error) + " " + Go.string(done) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
...
@:structInit class Client {
    public function call(_serviceMethod:GoString, _args:AnyInterface, _reply:AnyInterface):Error {
        ...
        var _call:Pointer<Call> = _client.value.go(_serviceMethod, Go.toInterface(_args), Go.toInterface(_reply), new Chan<Pointer<Call>>(((((1 : GoInt)) : GoInt)).toBasic(), () -> new Pointer<Call>().nil())).value.done.get();
    ...
    public var _pending : GoMap<GoUInt64, Pointer<Call>> = new GoMap<GoUInt64, Pointer<Call>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(uint64_kind), stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/rpc.Call", [], stdgo.reflect.Reflect.GoType.named("net/rpc.Call", [], stdgo.reflect.Reflect.GoType.structType([{ name : "serviceMethod", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "args", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.interfaceType(true, []) }, { name : "reply", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.interfaceType(true, []) }, { name : "error", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("error", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }, { name : "done", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.chanType(0, stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/rpc.Call", [], stdgo.reflect.Reflect.GoType.structType([{ name : "serviceMethod", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "args", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.interfaceType(true, []) }, { name : "reply", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.interfaceType(true, []) }, { name : "error", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("error", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }, { name : "done", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.chanType(0, stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/rpc.Call", [], stdgo.reflect.Reflect.GoType.invalidType))) }])))) }]))))))).nil();
    public var _closing : Bool = false;
    public var _shutdown : Bool = false;
    public function new(?_codec:ClientCodec, ?_reqMutex:stdgo.sync.Sync.Mutex, ?_request:Request, ?_mutex:stdgo.sync.Sync.Mutex, ?_seq:GoUInt64, ?_pending:GoMap<GoUInt64, Pointer<Call>>, ?_closing:Bool, ?_shutdown:Bool) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_codec) + " " + Go.string(_reqMutex) + " " + Go.string(_request) + " " + Go.string(_mutex) + " " + Go.string(_seq) + " " + Go.string(_pending) + " " + Go.string(_closing) + " " + Go.string(_shutdown) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_gobClientCodec {
    ...
    public function new(?_rwc:stdgo.io.Io.ReadWriteCloser, ?_dec:Pointer<stdgo.encoding.gob.Gob.Decoder>, ?_enc:Pointer<stdgo.encoding.gob.Gob.Encoder>, ?_encBuf:Pointer<bufio.Bufio.Writer>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_debugMethod {
    ...
    public function new(?type:Pointer<T_methodType>, ?name:GoString) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:named class T_methodArray {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new T_methodArray(__t__);
    public function __append__(args:haxe.Rest<T_debugMethod>) return new T_methodArray(this.__t__.__append__(...args));
    public function __slice__(low:GoInt, high:GoInt = -1) return new T_methodArray(this.__t__.__slice__(low, high));
}
@:structInit class T_debugService {
    ...
    public function new(?service:Pointer<T_service>, ?name:GoString, ?method:T_methodArray) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:named class T_serviceArray {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new T_serviceArray(__t__);
    public function __append__(args:haxe.Rest<T_debugService>) return new T_serviceArray(this.__t__.__append__(...args));
    public function __slice__(low:GoInt, high:GoInt = -1) return new T_serviceArray(this.__t__.__slice__(low, high));
}
@:structInit class T_debugHTTP {
    public function serveHTTP(_w:stdgo.net.http.Http.ResponseWriter, _req:Pointer<stdgo.net.http.Http.Request>):Void {
        ...
        _server.server.value._serviceMap.range(function(_snamei:AnyInterface, _svci:AnyInterface):Bool {
            ...
            var _ds:T_debugService = new T_debugService(_svc, ((_snamei.value : GoString)), new T_methodArray(new Slice<T_debugMethod>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) new T_debugMethod()]).setCap((((_svc.value._method == null ? 0 : _svc.value._method.length) : GoInt)).toBasic())).__copy__()).__copy__();
            {
                var _mname;
                var _method;
    ...
    public function new(?server:Pointer<Server>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(server) + "}";
    }
    public function accept(_lis:stdgo.net.Net.Listener) server.accept(_0);
    public function handleHTTP(_rpcPath:GoString, _debugPath:GoString) server.handleHTTP(_0, _1);
    public function register(_rcvr:AnyInterface):stdgo.Error return server.register(_0);
    public function registerName(_name:GoString, _rcvr:AnyInterface):stdgo.Error return server.registerName(_0, _1);
    public function serveCodec(_codec:ServerCodec) server.serveCodec(_0);
    public function serveConn(_conn:stdgo.io.Io.ReadWriteCloser) server.serveConn(_0);
    public function serveRequest(_codec:ServerCodec):stdgo.Error return server.serveRequest(_0);
    public function _freeRequest(_req:Pointer<Request>) server._freeRequest(_0);
    public function _freeResponse(_resp:Pointer<Response>) server._freeResponse(_0);
    public function _getRequest():Pointer<Request> return server._getRequest();
    public function _getResponse():Pointer<Response> return server._getResponse();
    public function _readRequest(_codec:ServerCodec):{ var _0 : Pointer<T_service>; var _1 : Pointer<T_methodType>; var _2 : Pointer<Request>; var _3 : stdgo.reflect.Reflect.Value; var _4 : stdgo.reflect.Reflect.Value; var _5 : Bool; var _6 : stdgo.Error; } return server._readRequest(_0);
    public function _readRequestHeader(_codec:ServerCodec):{ var _0 : Pointer<T_service>; var _1 : Pointer<T_methodType>; var _2 : Pointer<Request>; var _3 : Bool; var _4 : stdgo.Error; } return server._readRequestHeader(_0);
    public function _register(_rcvr:AnyInterface, _name:GoString, _useName:Bool):stdgo.Error return server._register(_0, _1, _2);
    public function _sendResponse(_sending:Pointer<stdgo.sync.Sync.Mutex>, _req:Pointer<Request>, _reply:AnyInterface, _codec:ServerCodec, _errmsg:GoString) server._sendResponse(_0, _1, _2, _3, _4);
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_methodType {
    ...
    public function new(?mutex:stdgo.sync.Sync.Mutex, ?_method:stdgo.reflect.Reflect.Method, ?argType:stdgo.reflect.Reflect.Type, ?replyType:stdgo.reflect.Reflect.Type, ?_numCalls:GoUInt) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(mutex) + " " + Go.string(_method) + " " + Go.string(argType) + " " + Go.string(replyType) + " " + Go.string(_numCalls) + "}";
    }
...
@:structInit class T_service {
    public function _call(_server:Pointer<Server>, _sending:Pointer<stdgo.sync.Sync.Mutex>, _wg:Pointer<stdgo.sync.Sync.WaitGroup>, _mtype:Pointer<T_methodType>, _req:Pointer<Request>, _argv:stdgo.reflect.Reflect.Value, _replyv:stdgo.reflect.Reflect.Value, _codec:ServerCodec):Void {
        ...
        try {
            ...
            var _returnValues:Slice<stdgo.reflect.Reflect.Value> = _function.call(new Slice<stdgo.reflect.Reflect.Value>(_s.value._rcvr.__copy__(), _argv.__copy__(), _replyv.__copy__()));
    ...
    public var _method : GoMap<GoString, Pointer<T_methodType>> = new GoMap<GoString, Pointer<T_methodType>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/rpc.methodType", [], stdgo.reflect.Reflect.GoType.named("net/rpc.methodType", [], stdgo.reflect.Reflect.GoType.structType([{ name : "mutex", embedded : true, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.Mutex", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_state", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int32_kind) }, { name : "_sema", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }])) }, { name : "_method", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("reflect.Method", [], stdgo.reflect.Reflect.GoType.structType([{ name : "name", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "pkgPath", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "type", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("reflect.Type", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }, { name : "func", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("reflect.Value", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_typ", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("reflect.rtype", [], stdgo.reflect.Reflect.GoType.structType([
...
{ name : "_ptrToThis", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("reflect.typeOff", [], stdgo.reflect.Reflect.GoType.basic(int32_kind)) }]))) }, { name : "_ptr", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(unsafepointer_kind) }, { name : "_flag", embedded : true, tag : "", type : stdgo.reflect.Reflect.GoType.named("reflect.flag", [], stdgo.reflect.Reflect.GoType.basic(uintptr_kind)) }])) }, { name : "index", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }])) }, { name : "argType", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("reflect.Type", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }, { name : "replyType", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("reflect.Type", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }, { name : "_numCalls", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint_kind) }]))))))).nil();
    public function new(?_name:GoString, ?_rcvr:stdgo.reflect.Reflect.Value, ?_typ:stdgo.reflect.Reflect.Type, ?_method:GoMap<GoString, Pointer<T_methodType>>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class Request {
    ...
    public function new(?serviceMethod:GoString, ?seq:GoUInt64, ?_next:Pointer<Request>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class Response {
    ...
    public function new(?serviceMethod:GoString, ?seq:GoUInt64, ?error:GoString, ?_next:Pointer<Response>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class Server {
    ...
    public function serveHTTP(_w:stdgo.net.http.Http.ResponseWriter, _req:Pointer<stdgo.net.http.Http.Request>):Void {
        ...
        var __tmp__ = ((_w.__underlying__().value : stdgo.net.http.Http.Hijacker)).hijack(), _conn:stdgo.net.Net.Conn = __tmp__._0, _:Pointer<bufio.Bufio.ReadWriter> = __tmp__._1, _err:stdgo.Error = __tmp__._2;
        if (_err != null) {
    ...
    public function accept(_lis:stdgo.net.Net.Listener):Void {
        var _server = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        while (true) {
            var __tmp__ = _lis.accept(), _conn:stdgo.net.Net.Conn = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
    ...
    public function _readRequestHeader(_codec:ServerCodec):{ var _0 : Pointer<T_service>; var _1 : Pointer<T_methodType>; var _2 : Pointer<Request>; var _3 : Bool; var _4 : Error; } {
        var _server = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _svc:Pointer<T_service> = new Pointer<T_service>().nil(), _mtype:Pointer<T_methodType> = new Pointer<T_methodType>().nil(), _req:Pointer<Request> = new Pointer<Request>().nil(), _keepReading:Bool = false, _err:Error = ((null : stdgo.Error));
        ...
        var __tmp__ = _server.value._serviceMap.load(Go.toInterface(_serviceName)), _svci:AnyInterface = __tmp__._0, _ok:Bool = __tmp__._1;
        if (!_ok) {
    ...
    public function _readRequest(_codec:ServerCodec):{ var _0 : Pointer<T_service>; var _1 : Pointer<T_methodType>; var _2 : Pointer<Request>; var _3 : stdgo.reflect.Reflect.Value; var _4 : stdgo.reflect.Reflect.Value; var _5 : Bool; var _6 : Error; } {
        var _server = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _service:Pointer<T_service> = new Pointer<T_service>().nil(), _mtype:Pointer<T_methodType> = new Pointer<T_methodType>().nil(), _req:Pointer<Request> = new Pointer<Request>().nil(), _argv:stdgo.reflect.Reflect.Value = new stdgo.reflect.Reflect.Value(), _replyv:stdgo.reflect.Reflect.Value = new stdgo.reflect.Reflect.Value(), _keepReading:Bool = false, _err:Error = ((null : stdgo.Error));
        {
    ...
    public function serveRequest(_codec:ServerCodec):Error {
        ...
        var __tmp__ = _server.value._readRequest(_codec), _service:Pointer<T_service> = __tmp__._0, _mtype:Pointer<T_methodType> = __tmp__._1, _req:Pointer<Request> = __tmp__._2, _argv:stdgo.reflect.Reflect.Value = __tmp__._3, _replyv:stdgo.reflect.Reflect.Value = __tmp__._4, _keepReading:Bool = __tmp__._5, _err:stdgo.Error = __tmp__._6;
        if (_err != null) {
            if (!_keepReading) {
                return _err;
            };
    ...
    public function serveConn(_conn:stdgo.io.Io.ReadWriteCloser):Void {
        ...
        var _srv:Pointer<T_gobServerCodec> = Go.pointer((({ _rwc : _conn, _dec : stdgo.encoding.gob.Gob.newDecoder(_conn), _enc : stdgo.encoding.gob.Gob.newEncoder(_buf.value), _encBuf : _buf, _closed : false } : T_gobServerCodec)));
        _server.value.serveCodec(_srv.value);
    }
    public function _sendResponse(_sending:Pointer<stdgo.sync.Sync.Mutex>, _req:Pointer<Request>, _reply:AnyInterface, _codec:ServerCodec, _errmsg:GoString):Void {
        var _server = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
    ...
    public function _register(_rcvr:AnyInterface, _name:GoString, _useName:Bool):Error {
        ...
        if ((_s.value._method == null ? 0 : _s.value._method.length) == ((0 : GoInt))) {
            ...
            if ((_method == null ? 0 : _method.length) != ((0 : GoInt))) {
                _str = (("rpc.Register: type " : GoString)) + _sname + ((" has no exported methods of suitable type (hint: pass a pointer to value of that type)" : GoString));
            } else {
        ...
        {
            var __tmp__ = _server.value._serviceMap.loadOrStore(Go.toInterface(_sname), Go.toInterface(_s)), _:AnyInterface = __tmp__._0, _dup:Bool = __tmp__._1;
            if (_dup) {
    ...
    public function new(?_serviceMap:stdgo.sync.Sync.Map_, ?_reqLock:stdgo.sync.Sync.Mutex, ?_freeReq:Pointer<Request>, ?_respLock:stdgo.sync.Sync.Mutex, ?_freeResp:Pointer<Response>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_serviceMap) + " " + Go.string(_reqLock) + " " + Go.string(_freeReq) + " " + Go.string(_respLock) + " " + Go.string(_freeResp) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_gobServerCodec {
    ...
    public function new(?_rwc:stdgo.io.Io.ReadWriteCloser, ?_dec:Pointer<stdgo.encoding.gob.Gob.Decoder>, ?_enc:Pointer<stdgo.encoding.gob.Gob.Encoder>, ?_encBuf:Pointer<bufio.Bufio.Writer>, ?_closed:Bool) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_rwc) + " " + Go.string(_dec) + " " + Go.string(_enc) + " " + Go.string(_encBuf) + " " + Go.string(_closed) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
function newClient(_conn:stdgo.io.Io.ReadWriteCloser):Pointer<Client> {
        ...
        var _client:Pointer<T_gobClientCodec> = Go.pointer(new T_gobClientCodec(_conn, stdgo.encoding.gob.Gob.newDecoder(_conn), stdgo.encoding.gob.Gob.newEncoder(_encBuf.value), _encBuf));
...
function newClientWithCodec(_codec:ClientCodec):Pointer<Client> {
        var _client:Pointer<Client> = Go.pointer((({ _codec : _codec, _pending : new GoMap<GoUInt64, Pointer<Call>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(uint64_kind), stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/rpc.Call", [], stdgo.reflect.Reflect.GoType.named("net/rpc.Call", [], stdgo.reflect.Reflect.GoType.structType([{ name : "serviceMethod", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "args", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.interfaceType(true, []) }, { name : "reply", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.interfaceType(true, []) }, { name : "error", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("error", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }, { name : "done", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.chanType(0, stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/rpc.Call", [], stdgo.reflect.Reflect.GoType.structType([{ name : "serviceMethod", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "args", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.interfaceType(true, []) }, { name : "reply", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.interfaceType(true, []) }, { name : "error", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("error", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }, { name : "done", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.chanType(0, stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/rpc.Call", [], stdgo.reflect.Reflect.GoType.invalidType))) }])))) }]))))))), _reqMutex : new stdgo.sync.Sync.Mutex(), _request : new Request(), _mutex : new stdgo.sync.Sync.Mutex(), _seq : 0, _closing : false, _shutdown : false } : Client)));
...
function dialHTTPPath(_network:GoString, _address:GoString, _path:GoString):{ var _0 : Pointer<Client>; var _1 : Error; } {
        ...
        var __tmp__ = stdgo.net.http.Http.readResponse(bufio.Bufio.newReader(_conn), Go.pointer((({ method : "CONNECT", url : new Pointer<stdgo.net.url.Url.URL>().nil(), proto : "", protoMajor : 0, protoMinor : 0, header : ((null : stdgo.net.http.Http.Header)), body : ((null : stdgo.io.Io.ReadCloser)), getBody : null, contentLength : 0, transferEncoding : new Slice<GoString>().nil(), close : false, host : "", form : ((null : stdgo.net.url.Url.Values)), postForm : ((null : stdgo.net.url.Url.Values)), multipartForm : new Pointer<stdgo.mime.multipart.Multipart.Form>().nil(), trailer : ((null : stdgo.net.http.Http.Header)), remoteAddr : "", requestURI : "", tls : new Pointer<stdgo.crypto.tls.Tls.ConnectionState>().nil(), cancel : new Chan<T__struct_81>(0, () -> new T__struct_81(), true), response : new Pointer<stdgo.net.http.Http.Response>().nil(), _ctx : ((null : stdgo.context.Context.Context)) } : stdgo.net.http.Http.Request)))), _resp:Pointer<stdgo.net.http.Http.Response> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        ...
        _conn.close();
        return { _0 : new Pointer<Client>().nil(), _1 : Go.pointer((({ op : "dial-http", net : _network + ((" " : GoString)) + _address, addr : ((null : stdgo.net.Net.Addr)), err : _err, source : ((null : stdgo.net.Net.Addr)) } : stdgo.net.Net.OpError))).value };
    }
/**
...
function _suitableMethods(_typ:stdgo.reflect.Reflect.Type, _reportErr:Bool):GoMap<GoString, Pointer<T_methodType>> {
        var _methods:GoMap<GoString, Pointer<T_methodType>> = new GoMap<GoString, Pointer<T_methodType>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("net/rpc.methodType", [], stdgo.reflect.Reflect.GoType.named("net/rpc.methodType", [], stdgo.reflect.Reflect.GoType.structType([{ name : "mutex", embedded : true, tag : "", type : stdgo.reflect.Reflect.GoType.named("sync.Mutex", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_state", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int32_kind) }, { name : "_sema", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) }])) }, { name : "_method", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("reflect.Method", [], stdgo.reflect.Reflect.GoType.structType([{ name : "name", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "pkgPath", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(string_kind) }, { name : "type", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("reflect.Type", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }, { name : "func", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("reflect.Value", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_typ", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("reflect.rtype", [], stdgo.reflect.Reflect.GoType.structType([
{ name : "_size", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uintptr_kind) },
{ name : "_ptrdata", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uintptr_kind) },
{ name : "_hash", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint32_kind) },
{ name : "_tflag", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("reflect.tflag", [], stdgo.reflect.Reflect.GoType.basic(uint8_kind)) },
...
{ name : "_gcdata", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.basic(uint8_kind)) },
{ name : "_str", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("reflect.nameOff", [], stdgo.reflect.Reflect.GoType.basic(int32_kind)) },
{ name : "_ptrToThis", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("reflect.typeOff", [], stdgo.reflect.Reflect.GoType.basic(int32_kind)) }]))) }, { name : "_ptr", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(unsafepointer_kind) }, { name : "_flag", embedded : true, tag : "", type : stdgo.reflect.Reflect.GoType.named("reflect.flag", [], stdgo.reflect.Reflect.GoType.basic(uintptr_kind)) }])) }, { name : "index", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(int_kind) }])) }, { name : "argType", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("reflect.Type", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }, { name : "replyType", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.named("reflect.Type", [], stdgo.reflect.Reflect.GoType.interfaceType(false, [])) }, { name : "_numCalls", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.basic(uint_kind) }])))))));
        {
            ...
            Go.cfor(_m < _typ.numMethod(), _m++, {
                ...
                };
                {
                    ...
                    if (!(_returnType.toString() == _typeOfError.toString())) {
                        if (_reportErr) {
                            stdgo.log.Log.printf("rpc.Register: return type of method %q is %q, must be error\n", Go.toInterface(_mname), Go.toInterface(_returnType));
                        };
                        continue;
                    };
                };
                _methods[_mname] = Go.pointer((({ _method : _method.__copy__(), argType : _argType, replyType : _replyType, mutex : new stdgo.sync.Sync.Mutex(), _numCalls : 0 } : T_methodType)));
            });
        };
        return _methods;
    }
...
class Call_extension_fields {
    public function _done(__tmp__):Void __tmp__._done();
}
class Client_extension_fields {
    public function _send(__tmp__, _call:Pointer<Call>):Void __tmp__._send(_call);
    public function _input(__tmp__):Void __tmp__._input();
    public function close(__tmp__):Error return __tmp__.close();
    public function go(__tmp__, _serviceMethod:GoString, _args:AnyInterface, _reply:AnyInterface, _done:Chan<Pointer<Call>>):Pointer<Call> return __tmp__.go(_serviceMethod, _args, _reply, _done);
    public function call(__tmp__, _serviceMethod:GoString, _args:AnyInterface, _reply:AnyInterface):Error return __tmp__.call(_serviceMethod, _args, _reply);
}
class T_gobClientCodec_extension_fields {
    public function writeRequest(__tmp__, _r:Pointer<Request>, _body:AnyInterface):Error return __tmp__.writeRequest(_r, _body);
    public function readResponseHeader(__tmp__, _r:Pointer<Response>):Error return __tmp__.readResponseHeader(_r);
    public function readResponseBody(__tmp__, _body:AnyInterface):Error return __tmp__.readResponseBody(_body);
    public function close(__tmp__):Error return __tmp__.close();
}
...
class T_debugHTTP_extension_fields {
    public function serveHTTP(__tmp__, _w:stdgo.net.http.Http.ResponseWriter, _req:Pointer<stdgo.net.http.Http.Request>):Void __tmp__.serveHTTP(_w, _req);
}
class T_methodType_extension_fields {
    public function numCalls(__tmp__):GoUInt return __tmp__.numCalls();
}
class T_service_extension_fields {
    public function _call(__tmp__, _server:Pointer<Server>, _sending:Pointer<stdgo.sync.Sync.Mutex>, _wg:Pointer<stdgo.sync.Sync.WaitGroup>, _mtype:Pointer<T_methodType>, _req:Pointer<Request>, _argv:stdgo.reflect.Reflect.Value, _replyv:stdgo.reflect.Reflect.Value, _codec:ServerCodec):Void __tmp__._call(_server, _sending, _wg, _mtype, _req, _argv, _replyv, _codec);
}
class Server_extension_fields {
    public function register(__tmp__, _rcvr:AnyInterface):Error return __tmp__.register(_rcvr);
    public function registerName(__tmp__, _name:GoString, _rcvr:AnyInterface):Error return __tmp__.registerName(_name, _rcvr);
    public function _register(__tmp__, _rcvr:AnyInterface, _name:GoString, _useName:Bool):Error return __tmp__._register(_rcvr, _name, _useName);
    public function _sendResponse(__tmp__, _sending:Pointer<stdgo.sync.Sync.Mutex>, _req:Pointer<Request>, _reply:AnyInterface, _codec:ServerCodec, _errmsg:GoString):Void __tmp__._sendResponse(_sending, _req, _reply, _codec, _errmsg);
    public function serveConn(__tmp__, _conn:stdgo.io.Io.ReadWriteCloser):Void __tmp__.serveConn(_conn);
    public function serveCodec(__tmp__, _codec:ServerCodec):Void __tmp__.serveCodec(_codec);
    public function serveRequest(__tmp__, _codec:ServerCodec):Error return __tmp__.serveRequest(_codec);
    public function _getRequest(__tmp__):Pointer<Request> return __tmp__._getRequest();
    public function _freeRequest(__tmp__, _req:Pointer<Request>):Void __tmp__._freeRequest(_req);
    public function _getResponse(__tmp__):Pointer<Response> return __tmp__._getResponse();
    public function _freeResponse(__tmp__, _resp:Pointer<Response>):Void __tmp__._freeResponse(_resp);
    public function _readRequest(__tmp__, _codec:ServerCodec):{ var _0 : Pointer<T_service>; var _1 : Pointer<T_methodType>; var _2 : Pointer<Request>; var _3 : stdgo.reflect.Reflect.Value; var _4 : stdgo.reflect.Reflect.Value; var _5 : Bool; var _6 : Error; } return __tmp__._readRequest(_codec);
    public function _readRequestHeader(__tmp__, _codec:ServerCodec):{ var _0 : Pointer<T_service>; var _1 : Pointer<T_methodType>; var _2 : Pointer<Request>; var _3 : Bool; var _4 : Error; } return __tmp__._readRequestHeader(_codec);
    public function accept(__tmp__, _lis:stdgo.net.Net.Listener):Void __tmp__.accept(_lis);
    public function serveHTTP(__tmp__, _w:stdgo.net.http.Http.ResponseWriter, _req:Pointer<stdgo.net.http.Http.Request>):Void __tmp__.serveHTTP(_w, _req);
    public function handleHTTP(__tmp__, _rpcPath:GoString, _debugPath:GoString):Void __tmp__.handleHTTP(_rpcPath, _debugPath);
}
class T_gobServerCodec_extension_fields {
    public function readRequestHeader(__tmp__, _r:Pointer<Request>):Error return __tmp__.readRequestHeader(_r);
    public function readRequestBody(__tmp__, _body:AnyInterface):Error return __tmp__.readRequestBody(_body);
    public function writeResponse(__tmp__, _r:Pointer<Response>, _body:AnyInterface):Error return __tmp__.writeResponse(_r, _body);
    public function close(__tmp__):Error return __tmp__.close();
}
