...
@:structInit @:using(stdgo.net.rpc.jsonrpc.Jsonrpc.T_clientCodec_static_extension) abstract T_clientCodec(stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_clientCodec.T_clientCodec) from stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_clientCodec.T_clientCodec to stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_clientCodec.T_clientCodec {
    ...
    public function new(?_dec:stdgo._internal.encoding.json.Json_Decoder.Decoder, ?_enc:stdgo._internal.encoding.json.Json_Encoder.Encoder, ?_c:stdgo._internal.io.Io_Closer.Closer, ?_req:T_clientRequest, ?_resp:T_clientResponse, ?_mutex:stdgo._internal.sync.Sync_Mutex.Mutex, ?_pending:stdgo.GoMap<stdgo.GoUInt64, stdgo.GoString>) this = new stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_clientCodec.T_clientCodec(_dec, _enc, _c, _req, _resp, _mutex, _pending);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_clientRequest(stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_clientRequest.T_clientRequest) from stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_clientRequest.T_clientRequest to stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_clientRequest.T_clientRequest {
    ...
    function set_params(v:haxe.ds.Vector<stdgo.AnyInterface>):haxe.ds.Vector<stdgo.AnyInterface> {
        this.params = ([for (i in v) i] : stdgo.GoArray<stdgo.AnyInterface>);
        return v;
    }
    ...
    public function new(?method:String, ?params:haxe.ds.Vector<stdgo.AnyInterface>, ?id:haxe.UInt64) this = new stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_clientRequest.T_clientRequest(method, ([for (i in params) i] : stdgo.GoArray<stdgo.AnyInterface>), id);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.net.rpc.jsonrpc.Jsonrpc.T_clientResponse_static_extension) abstract T_clientResponse(stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_clientResponse.T_clientResponse) from stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_clientResponse.T_clientResponse to stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_clientResponse.T_clientResponse {
    ...
    public function new(?id:haxe.UInt64, ?result:stdgo._internal.encoding.json.Json_RawMessage.RawMessage, ?error:stdgo.AnyInterface) this = new stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_clientResponse.T_clientResponse(id, result, error);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
@:structInit @:using(stdgo.net.rpc.jsonrpc.Jsonrpc.T_serverRequest_static_extension) abstract T_serverRequest(stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_serverRequest.T_serverRequest) from stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_serverRequest.T_serverRequest to stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_serverRequest.T_serverRequest {
    ...
    public function new(?method:String, ?params:stdgo._internal.encoding.json.Json_RawMessage.RawMessage, ?id:stdgo._internal.encoding.json.Json_RawMessage.RawMessage) this = new stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_serverRequest.T_serverRequest(method, params, id);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_serverResponse(stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_serverResponse.T_serverResponse) from stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_serverResponse.T_serverResponse to stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_serverResponse.T_serverResponse {
    public var id(get, set) : stdgo._internal.encoding.json.Json_RawMessage.RawMessage;
    function get_id():stdgo._internal.encoding.json.Json_RawMessage.RawMessage return this.id;
    function set_id(v:stdgo._internal.encoding.json.Json_RawMessage.RawMessage):stdgo._internal.encoding.json.Json_RawMessage.RawMessage {
        this.id = v;
    ...
    public function new(?id:stdgo._internal.encoding.json.Json_RawMessage.RawMessage, ?result:stdgo.AnyInterface, ?error:stdgo.AnyInterface) this = new stdgo._internal.net.rpc.jsonrpc.Jsonrpc_T_serverResponse.T_serverResponse(id, result, error);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
class Jsonrpc {
    ...
    **/
    static public function newClientCodec(_conn:stdgo._internal.io.Io_ReadWriteCloser.ReadWriteCloser):stdgo._internal.net.rpc.Rpc_ClientCodec.ClientCodec {
    ...
    **/
    static public function newClient(_conn:stdgo._internal.io.Io_ReadWriteCloser.ReadWriteCloser):stdgo._internal.net.rpc.Rpc_Client.Client {
        return stdgo._internal.net.rpc.jsonrpc.Jsonrpc_newClient.newClient(_conn);
    }
    /**
        Dial connects to a JSON-RPC server at the specified network address.
    **/
    static public function dial(_network:String, _address:String):stdgo.Tuple<stdgo._internal.net.rpc.Rpc_Client.Client, stdgo.Error> {
        return {
    ...
    **/
    static public function newServerCodec(_conn:stdgo._internal.io.Io_ReadWriteCloser.ReadWriteCloser):stdgo._internal.net.rpc.Rpc_ServerCodec.ServerCodec {
