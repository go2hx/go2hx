...
@:structInit class T_clientCodec {
	...
	public var _pending:GoMap<GoUInt64, GoString> = new GoMap<GoUInt64,
		GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(uint64_kind),
			stdgo.reflect.Reflect.GoType.basic(string_kind)))).nil();

	public function new(?_dec:Pointer<stdgo.encoding.json.Json.Decoder>, ?_enc:Pointer<stdgo.encoding.json.Json.Encoder>, ?_c:stdgo.io.Io.Closer,
			?_req:T_clientRequest, ?_resp:T_clientResponse, ?_mutex:stdgo.sync.Sync.Mutex, ?_pending:GoMap<GoUInt64, GoString>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_dec) + " " + Go.string(_enc) + " " + Go.string(_c) + " " + Go.string(_req) + " " + Go.string(_resp) + " "
			+ Go.string(_mutex) + " " + Go.string(_pending) + "}";
	}
...
@:structInit class T_clientRequest {
	...
	public function new(?method:GoString, ?params:GoArray<AnyInterface>, ?id:GoUInt64)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_clientResponse {
	...
	public function new(?id:GoUInt64, ?result:Pointer<stdgo.encoding.json.Json.RawMessage>, ?error:AnyInterface)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_serverCodec {
	...
	public function writeResponse(_r:Pointer<stdgo.net.rpc.Rpc.Response>, _x:AnyInterface):Error {
		var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		_c.value._mutex.lock();
		var __tmp__ = _c.value._pending.exists(_r.value.seq) ? {value: _c.value._pending[_r.value.seq], ok: true} : {value: _c.value._pending.defaultValue(),
			ok: false},
			_b:Pointer<stdgo.encoding.json.Json.RawMessage> = __tmp__.value,
			_ok:Bool = __tmp__.ok;
		if (!_ok) {
			_c.value._mutex.unlock();
	...
	public var _pending:GoMap<GoUInt64, Pointer<stdgo.encoding.json.Json.RawMessage>> = new GoMap<GoUInt64,
		Pointer<stdgo.encoding.json.Json.RawMessage>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(uint64_kind),
		stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("encoding/json.RawMessage", [],
			stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(uint8_kind))))))).nil();

	public function new(?_dec:Pointer<stdgo.encoding.json.Json.Decoder>, ?_enc:Pointer<stdgo.encoding.json.Json.Encoder>, ?_c:stdgo.io.Io.Closer,
			?_req:T_serverRequest, ?_mutex:stdgo.sync.Sync.Mutex, ?_seq:GoUInt64, ?_pending:GoMap<GoUInt64, Pointer<stdgo.encoding.json.Json.RawMessage>>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_dec) + " " + Go.string(_enc) + " " + Go.string(_c) + " " + Go.string(_req) + " " + Go.string(_mutex) + " " + Go.string(_seq)
			+ " " + Go.string(_pending) + "}";
	}
...
@:structInit class T_serverRequest {
	...
	public function new(?method:GoString, ?params:Pointer<stdgo.encoding.json.Json.RawMessage>, ?id:Pointer<stdgo.encoding.json.Json.RawMessage>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_serverResponse {
	...
	public function new(?id:Pointer<stdgo.encoding.json.Json.RawMessage>, ?result:AnyInterface, ?error:AnyInterface)
		stdgo.internal.Macro.initLocals();
...
function newClientCodec(_conn:stdgo.io.Io.ReadWriteCloser):stdgo.net.rpc.Rpc.ClientCodec {
	return Go.pointer((({
		_dec: stdgo.encoding.json.Json.newDecoder(_conn),
		_enc: stdgo.encoding.json.Json.newEncoder(_conn),
		_c: _conn,
		_pending: new GoMap<GoUInt64,
			GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(uint64_kind),
				stdgo.reflect.Reflect.GoType.basic(string_kind)))),
		_req: new T_clientRequest(),
		_resp: new T_clientResponse(),
...
class T_clientCodec_extension_fields {
	public function writeRequest(__tmp__, _r:Pointer<stdgo.net.rpc.Rpc.Request>, _param:AnyInterface):Error
		return __tmp__.writeRequest(_r, _param);

	public function readResponseHeader(__tmp__, _r:Pointer<stdgo.net.rpc.Rpc.Response>):Error
		return __tmp__.readResponseHeader(_r);

	public function readResponseBody(__tmp__, _x:AnyInterface):Error
		return __tmp__.readResponseBody(_x);
...
class T_serverCodec_extension_fields {
	public function readRequestHeader(__tmp__, _r:Pointer<stdgo.net.rpc.Rpc.Request>):Error
		return __tmp__.readRequestHeader(_r);

	public function readRequestBody(__tmp__, _x:AnyInterface):Error
		return __tmp__.readRequestBody(_x);

	public function writeResponse(__tmp__, _r:Pointer<stdgo.net.rpc.Rpc.Response>, _x:AnyInterface):Error
		return __tmp__.writeResponse(_r, _x);
