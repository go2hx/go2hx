# Module stdgo.net.smtp has compilation errors, please do not use:
```
[30;41m ERROR [0m [31m(macro) [0mstdgo/_internal/crypto/tls/Tls_Conn_static_extension.hx:837: characters 209-257
