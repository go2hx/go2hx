...
@:structInit class Pipeline {
	...
	public function new(?_mu:stdgo.sync.Sync.Mutex, ?_id:GoUInt, ?_request:T_sequencer, ?_response:T_sequencer)
...
@:structInit class T_sequencer {
	public function end(_id:GoUInt):Void {
		...
		if (_s.value._wait == null || _s.value._wait.isNil()) {
			_s.value._wait = new GoMap<GoUInt,
				Chan<T__struct_50>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(uint_kind),
				stdgo.reflect.Reflect.GoType.chanType(0,
					stdgo.reflect.Reflect.GoType.named("net/textproto._struct_50", [], stdgo.reflect.Reflect.GoType.structType([]))))));
		};
		var __tmp__ = _s.value._wait.exists(_id) ? {value: _s.value._wait[_id], ok: true} : {value: _s.value._wait.defaultValue(), ok: false},
			_c:Chan<T__struct_50> = __tmp__.value,
			_ok:Bool = __tmp__.ok;
		if (_ok) {
	...
	public var _mu:stdgo.sync.Sync.Mutex = new stdgo.sync.Sync.Mutex();
	public var _id:GoUInt = ((0 : GoUInt));
	public var _wait:GoMap<GoUInt, Chan<{}>> = new GoMap<GoUInt,
		Chan<{}>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(uint_kind),
			stdgo.reflect.Reflect.GoType.chanType(0, stdgo.reflect.Reflect.GoType.structType([]))))).nil();

	public function new(?_mu:stdgo.sync.Sync.Mutex, ?_id:GoUInt, ?_wait:GoMap<GoUInt, Chan<{}>>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Reader {
	public function _upcomingHeaderNewlines():GoInt {
		...
		var __tmp__ = _r.value.r.value.peek(_s),
			_peek:Slice<GoUInt8> = __tmp__._0,
	...
	public function readMIMEHeader():{var _0:MIMEHeader; var _1:Error;} {
		...
		while (true) {
			var __tmp__ = _r.value._readContinuedLineSlice(_mustHaveFieldNameColon),
				_kv:Slice<GoUInt8> = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
	...
	public function readResponse(_expectCode:GoInt):{var _0:GoInt; var _1:GoString; var _2:Error;} {
		...
		var _code:GoInt = ((0 : GoInt)),
			_message:GoString = (("" : GoString)),
			_err:Error = ((null : stdgo.Error));
		var __tmp__ = _r.value._readCodeLine(_expectCode),
			_code:GoInt = __tmp__._0,
			_continued:Bool = __tmp__._1,
			_message:GoString = __tmp__._2,
	...
	public function _readCodeLine(_expectCode:GoInt):{
		var _0:GoInt;
		var _1:Bool;
		var _2:GoString;
		var _3:Error;
	...
	public function _skipSpace():GoInt {
		...
		var _n:GoInt = ((0 : GoInt));
		while (true) {
			var __tmp__ = _r.value.r.value.readByte(),
	...
	public function _readContinuedLineSlice(_validateFirstLine:Slice<GoByte>->Error):{var _0:Slice<GoByte>; var _1:Error;} {
		...
		if (_r.value.r.value.buffered() > ((1 : GoInt))) {
			var __tmp__ = _r.value.r.value.peek(((2 : GoInt))),
				_peek:Slice<GoUInt8> = __tmp__._0,
				_:stdgo.Error = __tmp__._1;
			if (_peek.length > ((0 : GoInt))
				&& (_isASCIILetter(_peek[((0 : GoInt))]) || _peek[((0 : GoInt))] == (("\n".code : GoRune)))
				|| _peek.length == ((2 : GoInt))
				&& _peek[((0 : GoInt))] == (("\r".code : GoRune))
				&& _peek[((1 : GoInt))] == (("\n".code : GoRune))) {
	...
	public function readContinuedLineBytes():{var _0:Slice<GoByte>; var _1:Error;} {
		var _r = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _r.value._readContinuedLineSlice(_noValidation),
			_line:Slice<GoUInt8> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
	...
	public function _readLineSlice():{var _0:Slice<GoByte>; var _1:Error;} {
		...
		while (true) {
			var __tmp__ = _r.value.r.value.readLine(),
	...
	public function new(?r:Pointer<bufio.Bufio.Reader>, ?_dot:Pointer<T_dotReader>, ?_buf:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_dotReader {
	public function read(_b:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
		...
		final _stateBeginLine:GoUnTypedInt = (0 : GoUnTypedInt), _stateDot:GoUnTypedInt = (1 : GoUnTypedInt), _stateDotCR:GoUnTypedInt = (2 : GoUnTypedInt),
		_stateCR:GoUnTypedInt = (3 : GoUnTypedInt), _stateData:GoUnTypedInt = (4 : GoUnTypedInt), _stateEOF:GoUnTypedInt = (5 : GoUnTypedInt);
	...
	public function new(?_r:Pointer<Reader>, ?_state:GoInt)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Error {
	...
	public function new(?code:GoInt, ?msg:GoString)
		stdgo.internal.Macro.initLocals();
...
@:named class ProtocolError {
	...
	public function __copy__()
		return new ProtocolError(__t__);
}
...
@:structInit class Conn {
	...
	public function new(?reader:Reader, ?writer:Writer, ?pipeline:Pipeline, ?_conn:stdgo.io.Io.ReadWriteCloser)
		stdgo.internal.Macro.initLocals();
	...
	public function dotReader():stdgo.io.Io.Reader
		return reader.dotReader();

	public function dotWriter():stdgo.io.Io.WriteCloser
		return writer.dotWriter();

	public function endRequest(_id:GoUInt)
		pipeline.endRequest(_0);

	public function endResponse(_id:GoUInt)
		pipeline.endResponse(_0);

	public function next():GoUInt
		return pipeline.next();

	public function printfLine(_format:GoString, _args:Slice<AnyInterface>):stdgo.Error
		return writer.printfLine(_0, _1);

	public function readCodeLine(_expectCode:GoInt):{var _0:GoInt; var _1:GoString; var _2:stdgo.Error;}
		return reader.readCodeLine(_0);

	public function readContinuedLine():{var _0:() -> {
		var _0:GoString;
		var _1:stdgo.Error;
	}; var _1:() -> {
		var _0:GoString;
		...
		return reader.readContinuedLine();

	public function readContinuedLineBytes():{var _0:() -> {
		...
		return reader.readContinuedLineBytes();

	public function readDotBytes():{var _0:() -> {
		var _0:Slice<GoUInt8>;
		var _1:stdgo.Error;
	}; var _1:() -> {
		var _0:Slice<GoUInt8>;
		...
		return reader.readDotBytes();

	public function readDotLines():{var _0:() -> {
		...
		return reader.readDotLines();

	public function readLine():{var _0:() -> {
		var _0:GoString;
		var _1:stdgo.Error;
	}; var _1:() -> {
		var _0:GoString;
	...
	public function readLineBytes():{var _0:() -> {
		var _0:Slice<GoUInt8>;
		var _1:stdgo.Error;
	}; var _1:() -> {
		var _0:Slice<GoUInt8>;
		...
		return reader.readLineBytes();

	public function readMIMEHeader():{var _0:() -> {
		var _0:MIMEHeader;
		var _1:stdgo.Error;
	}; var _1:() -> {
		var _0:MIMEHeader;
	...
	public function readResponse(_expectCode:GoInt):{var _0:GoInt; var _1:GoString; var _2:stdgo.Error;}
		return reader.readResponse(_0);

	public function startRequest(_id:GoUInt)
		pipeline.startRequest(_0);

	public function startResponse(_id:GoUInt)
		pipeline.startResponse(_0);
	...
	public function _readCodeLine(_expectCode:GoInt):{
		...
		return reader._readCodeLine(_0);

	public function _readContinuedLineSlice(_validateFirstLine:Slice<GoUInt8>->stdgo.Error):{var _0:(Slice<GoUInt8>->stdgo.Error) -> {
		var _0:Slice<GoUInt8>;
		var _1:stdgo.Error;
	}; var _1:(Slice<GoUInt8>->stdgo.Error) -> {
		var _0:Slice<GoUInt8>;
		var _1:stdgo.Error;
		};}
		return reader._readContinuedLineSlice(_0);

	public function _readLineSlice():{var _0:() -> {
		var _0:Slice<GoUInt8>;
		var _1:stdgo.Error;
	}; var _1:() -> {
		var _0:Slice<GoUInt8>;
		...
		return reader._readLineSlice();

	public function _skipSpace():GoInt
		return reader._skipSpace();

	public function _upcomingHeaderNewlines():GoInt
		return reader._upcomingHeaderNewlines();
...
@:structInit class Writer {
	...
	public function new(?w:Pointer<bufio.Bufio.Writer>, ?_dot:Pointer<T_dotWriter>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_dotWriter {
			...
			var _c:GoUInt8 = _b[_n];
			{
				...
				while (true) {
					if (__switchIndex__ == 0
						|| (__switchIndex__ == -1 && _d.value._state == _wstateBegin || _d.value._state == _wstateBeginLine)) {
	...
	public function new(?_w:Pointer<Writer>, ?_state:GoInt)
		stdgo.internal.Macro.initLocals();
...
var _commonHeader:GoMap<GoString, GoString> = new GoMap<GoString,
...
function _parseCodeLine(_line:GoString, _expectCode:GoInt):{
	var _0:GoInt;
	var _1:Bool;
	var _2:GoString;
	var _3:Error;
	...
	if (((1 : GoInt)) <= _expectCode
		&& _expectCode < ((10 : GoInt))
		&& _code / ((100 : GoInt)) != _expectCode
			|| ((10 : GoInt)) <= _expectCode
				&& _expectCode < ((100 : GoInt))
				&& _code / ((10 : GoInt)) != _expectCode
					|| ((100 : GoInt)) <= _expectCode && _expectCode < ((1000 : GoInt)) && _code != _expectCode) {
		_err = Go.pointer(new Error(_code, _message)).value;
	};
	return {
		_0: _code,
...
function _initCommonHeader():Void {
	_commonHeader = new GoMap<GoString,
		GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
			stdgo.reflect.Reflect.GoType.basic(string_kind))));
	for (_v in new Slice<GoString>("Accept", "Accept-Charset", "Accept-Encoding", "Accept-Language", "Accept-Ranges", "Cache-Control", "Cc", "Connection",
		"Content-Id", "Content-Language", "Content-Length", "Content-Transfer-Encoding", "Content-Type", "Cookie", "Date", "Dkim-Signature", "Etag",
		"Expires", "From", "Host", "If-Modified-Since", "If-None-Match", "In-Reply-To", "Last-Modified", "Location", "Message-Id", "Mime-Version", "Pragma",
		"Received", "Return-Path", "Server", "Set-Cookie", "Subject", "To", "User-Agent", "Via", "X-Forwarded-For", "X-Imforwards", "X-Powered-By")) {
		_commonHeader[_v] = _v;
	};
}
...
function newConn(_conn:stdgo.io.Io.ReadWriteCloser):Pointer<Conn> {
	return Go.pointer((({
		reader: (({r: bufio.Bufio.newReader(_conn), _dot: new Pointer<T_dotReader>().nil(), _buf: new Slice<GoUInt8>().nil()} : Reader)).__copy__(),
		writer: (({w: bufio.Bufio.newWriter(_conn), _dot: new Pointer<T_dotWriter>().nil()} : Writer)).__copy__(),
		_conn: _conn,
...
function dial(_network:GoString, _addr:GoString):{var _0:Pointer<Conn>; var _1:Error;} {
	var __tmp__ = stdgo.net.Net.dial(_network, _addr),
...
class MIMEHeader_extension_fields {
	...
	public function values(__tmp__, _key:GoString):Slice<GoString>
		return __tmp__.values(_key);
...
class Pipeline_extension_fields {
	public function next(__tmp__):GoUInt
		return __tmp__.next();

	public function startRequest(__tmp__, _id:GoUInt):Void
		__tmp__.startRequest(_id);

	public function endRequest(__tmp__, _id:GoUInt):Void
		__tmp__.endRequest(_id);

	public function startResponse(__tmp__, _id:GoUInt):Void
		__tmp__.startResponse(_id);

	public function endResponse(__tmp__, _id:GoUInt):Void
		__tmp__.endResponse(_id);
}

class T_sequencer_extension_fields {
	public function start(__tmp__, _id:GoUInt):Void
		__tmp__.start(_id);

	public function end(__tmp__, _id:GoUInt):Void
		__tmp__.end(_id);
}

class Reader_extension_fields {
	public function readLine(__tmp__):{var _0:GoString; var _1:Error;}
		return __tmp__.readLine();

	public function readLineBytes(__tmp__):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__.readLineBytes();

	public function _readLineSlice(__tmp__):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__._readLineSlice();

	public function readContinuedLine(__tmp__):{var _0:GoString; var _1:Error;}
		return __tmp__.readContinuedLine();

	public function readContinuedLineBytes(__tmp__):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__.readContinuedLineBytes();

	public function _readContinuedLineSlice(__tmp__, _validateFirstLine:Slice<GoByte>->Error):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__._readContinuedLineSlice(_validateFirstLine);

	public function _skipSpace(__tmp__):GoInt
		return __tmp__._skipSpace();

	public function _readCodeLine(__tmp__, _expectCode:GoInt):{
		var _0:GoInt;
		var _1:Bool;
		var _2:GoString;
		var _3:Error;
	}
		return __tmp__._readCodeLine(_expectCode);

	public function readCodeLine(__tmp__, _expectCode:GoInt):{var _0:GoInt; var _1:GoString; var _2:Error;}
		return __tmp__.readCodeLine(_expectCode);

	public function readResponse(__tmp__, _expectCode:GoInt):{var _0:GoInt; var _1:GoString; var _2:Error;}
		return __tmp__.readResponse(_expectCode);

	public function dotReader(__tmp__):stdgo.io.Io.Reader
		return __tmp__.dotReader();

	public function _closeDot(__tmp__):Void
		__tmp__._closeDot();

	public function readDotBytes(__tmp__):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__.readDotBytes();

	public function readDotLines(__tmp__):{var _0:Slice<GoString>; var _1:Error;}
		return __tmp__.readDotLines();

	public function readMIMEHeader(__tmp__):{var _0:MIMEHeader; var _1:Error;}
		return __tmp__.readMIMEHeader();

	public function _upcomingHeaderNewlines(__tmp__):GoInt
		return __tmp__._upcomingHeaderNewlines();
}
...
class Conn_extension_fields {
	...
	public function cmd(__tmp__, _format:GoString, _args:haxe.Rest<AnyInterface>):{var _0:GoUInt; var _1:Error;}
		return __tmp__.cmd(_format, _args);
}

class Writer_extension_fields {
	public function printfLine(__tmp__, _format:GoString, _args:haxe.Rest<AnyInterface>):Error
		return __tmp__.printfLine(_format, _args);

	public function dotWriter(__tmp__):stdgo.io.Io.WriteCloser
		return __tmp__.dotWriter();
