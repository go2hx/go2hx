...
@:structInit class T_error {
    ...
    public function new(?op:GoString, ?url:GoString, ?err:stdgo.Error) stdgo.internal.Macro.initLocals();
...
@:named class T_encoding {
    ...
    public function __copy__() return new T_encoding(__t__);
}
@:named class EscapeError {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new EscapeError(__t__);
}
@:named class InvalidHostError {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new InvalidHostError(__t__);
}
@:structInit class URL {
    public function unmarshalBinary(_text:Slice<GoByte>):Error {
        ...
        var __tmp__ = Url.parse(((_text : GoString))), _u1:Pointer<URL> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return _err;
        };
    ...
    public function port():GoString {
        var _u = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _splitHostPort(_u.value.host), _:GoString = __tmp__._0, _port:GoString = __tmp__._1;
        return _port;
    }
    public function hostname():GoString {
        var _u = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _splitHostPort(_u.value.host), _host:GoString = __tmp__._0, _:GoString = __tmp__._1;
        return _host;
    }
    ...
    public function query():Values {
        var _u = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = parseQuery(_u.value.rawQuery), _v:Values = __tmp__._0, _:stdgo.Error = __tmp__._1;
        return _v.__copy__();
    }
    public function resolveReference(_ref:Pointer<URL>):Pointer<URL> {
        ...
        if (_ref.value.scheme != (("" : GoString)) || _ref.value.host != (("" : GoString)) || _ref.value.user != null && !_ref.value.user.isNil()) {
    ...
    public function parse(_ref:GoString):{ var _0 : Pointer<URL>; var _1 : Error; } {
        var _u = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = Url.parse(_ref), _refURL:Pointer<URL> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
    ...
    public function redacted():GoString {
        ...
        {
            var __tmp__ = _ru.user.value.password(), _:GoString = __tmp__._0, _has:Bool = __tmp__._1;
            if (_has) {
    ...
    public function toString():GoString {
        ...
        if (_u.value.opaque != (("" : GoString))) {
            ...
            if (_u.value.scheme != (("" : GoString)) || _u.value.host != (("" : GoString)) || _u.value.user != null && !_u.value.user.isNil()) {
            ...
            if (_buf.len() == ((0 : GoInt))) {
                {
                    ...
                    if (_i > -((1 : GoUnTypedInt)) && stdgo.strings.Strings.indexByte(_path.__slice__(0, _i), (("/".code : GoRune))) == -((1 : GoUnTypedInt))) {
                        _buf.writeString("./");
                    };
                };
            };
    ...
    public function escapedFragment():GoString {
        ...
        if (_u.value.rawFragment != (("" : GoString)) && _validEncoded(_u.value.rawFragment, _encodeFragment)) {
            var __tmp__ = _unescape(_u.value.rawFragment, _encodeFragment), _f:GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
    ...
    public function _setFragment(_f:GoString):Error {
        var _u = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _unescape(_f, _encodeFragment), _frag:GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return _err;
        };
    ...
    public function escapedPath():GoString {
        ...
        if (_u.value.rawPath != (("" : GoString)) && _validEncoded(_u.value.rawPath, _encodePath)) {
            var __tmp__ = _unescape(_u.value.rawPath, _encodePath), _p:GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
    ...
    public function _setPath(_p:GoString):Error {
        var _u = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var __tmp__ = _unescape(_p, _encodePath), _path:GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return _err;
        };
        _u.value.path = _path;
    ...
    public function new(?scheme:GoString, ?opaque:GoString, ?user:Pointer<Userinfo>, ?host:GoString, ?path:GoString, ?rawPath:GoString, ?forceQuery:Bool, ?rawQuery:GoString, ?fragment:GoString, ?rawFragment:GoString) stdgo.internal.Macro.initLocals();
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class Userinfo {
    ...
    public function new(?_username:GoString, ?_password:GoString, ?_passwordSet:Bool) stdgo.internal.Macro.initLocals();
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:named class Values {
    public function encode():GoString {
        ...
        var _buf:stdgo.strings.Strings.Builder = new stdgo.strings.Strings.Builder();
        var _keys:Slice<GoString> = new Slice<GoString>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) (("" : GoString))]).setCap((((_v.__t__ == null ? 0 : _v.__t__.length) : GoInt)).toBasic());
        {
            var _k;
    ...
    public function has(_key:GoString):Bool {
        var _v = this.__copy__();
        var __tmp__ = _v.exists(_key) ? { value : _v[_key], ok : true } : { value : _v.defaultValue(), ok : false }, _:Slice<GoString> = __tmp__.value, _ok:Bool = __tmp__.ok;
        return _ok;
    }
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new Values(__t__);
}
...
function _shouldEscape(_c:GoByte, _mode:T_encoding):Bool {
        if ((("a".code : GoRune)) <= _c && _c <= (("z".code : GoRune)) || (("A".code : GoRune)) <= _c && _c <= (("Z".code : GoRune)) || (("0".code : GoRune)) <= _c && _c <= (("9".code : GoRune))) {
            return false;
        };
        if (_mode.__t__ == _encodeHost.__t__ || _mode.__t__ == _encodeZone.__t__) {
            if (_c == (("!".code : GoRune)) || _c == (("$".code : GoRune)) || _c == (("&".code : GoRune)) || _c == (("\'".code : GoRune)) || _c == (("(".code : GoRune)) || _c == ((")".code : GoRune)) || _c == (("*".code : GoRune)) || _c == (("+".code : GoRune)) || _c == ((",".code : GoRune)) || _c == ((";".code : GoRune)) || _c == (("=".code : GoRune)) || _c == ((":".code : GoRune)) || _c == (("[".code : GoRune)) || _c == (("]".code : GoRune)) || _c == (("<".code : GoRune)) || _c == ((">".code : GoRune)) || _c == (("\"".code : GoRune))) {
                return false;
            };
        };
        ...
        var _hasPlus:Bool = false;
        {
            ...
            while (_i < _s.length) {
                if (_s[_i] == (("%".code : GoRune))) {
                    ...
                    if (_mode.__t__ == _encodeHost.__t__ && _unhex(_s[_i + ((1 : GoInt))]) < ((8 : GoUInt8)) && _s.__slice__(_i, _i + ((3 : GoInt))) != (("%25" : GoString))) {
                    ...
                    if (_mode.__t__ == _encodeZone.__t__) {
                        ...
                        if (_s.__slice__(_i, _i + ((3 : GoInt))) != (("%25" : GoString)) && _v != ((" ".code : GoRune)) && _shouldEscape(_v, _encodeHost)) {
                            return { _0 : "", _1 : new EscapeError(_s.__slice__(_i, _i + ((3 : GoInt)))) };
                        };
                    };
                    _i = _i + (((3 : GoInt)));
                    ...
                    if ((_mode.__t__ == _encodeHost.__t__ || _mode.__t__ == _encodeZone.__t__) && _s[_i] < ((128 : GoUInt8)) && _shouldEscape(_s[_i], _mode)) {
...
function _getScheme(_rawURL:GoString):{ var _0 : GoString; var _1 : GoString; var _2 : Error; } {
        var _scheme:GoString = (("" : GoString)), _path:GoString = (("" : GoString)), _err:Error = ((null : stdgo.Error));
        {
            ...
            Go.cfor(_i < _rawURL.length, _i++, {
                ...
                if ((("a".code : GoRune)) <= _c && _c <= (("z".code : GoRune)) || (("A".code : GoRune)) <= _c && _c <= (("Z".code : GoRune))) {} else if ((("0".code : GoRune)) <= _c && _c <= (("9".code : GoRune)) || _c == (("+".code : GoRune)) || _c == (("-".code : GoRune)) || _c == ((".".code : GoRune))) {
                    if (_i == ((0 : GoInt))) {
...
function parse(_rawURL:GoString):{ var _0 : Pointer<URL>; var _1 : Error; } {
        var __tmp__ = _split(_rawURL, (("#".code : GoRune)), true), _u:GoString = __tmp__._0, _frag:GoString = __tmp__._1;
        var __tmp__ = _parse(_u, false), _url:Pointer<URL> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
...
function parseRequestURI(_rawURL:GoString):{ var _0 : Pointer<URL>; var _1 : Error; } {
        var __tmp__ = _parse(_rawURL, true), _url:Pointer<URL> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Pointer<URL>().nil(), _1 : Go.pointer(new T_error("parse", _rawURL, _err)).value };
        };
        return { _0 : _url, _1 : ((null : stdgo.Error)) };
...
function _parse(_rawURL:GoString, _viaRequest:Bool):{ var _0 : Pointer<URL>; var _1 : Error; } {
        ...
        if ((_url.value.scheme != (("" : GoString)) || !_viaRequest && !stdgo.strings.Strings.hasPrefix(_rest, "///")) && stdgo.strings.Strings.hasPrefix(_rest, "//")) {
...
function _parseAuthority(_authority:GoString):{ var _0 : Pointer<Userinfo>; var _1 : GoString; var _2 : Error; } {
        var _user:Pointer<Userinfo> = new Pointer<Userinfo>().nil(), _host:GoString = (("" : GoString)), _err:Error = ((null : stdgo.Error));
        ...
        if (!stdgo.strings.Strings.contains(_userinfo, ":")) {
            ...
            var __tmp__ = _split(_userinfo, ((":".code : GoRune)), true), _username:GoString = __tmp__._0, _password:GoString = __tmp__._1;
            {
                {
...
function _parseHost(_host:GoString):{ var _0 : GoString; var _1 : Error; } {
        if (stdgo.strings.Strings.hasPrefix(_host, "[")) {
            ...
            if (_zone >= ((0 : GoInt))) {
                var __tmp__ = _unescape(_host.__slice__(0, _zone), _encodeHost), _host1:GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    return { _0 : "", _1 : _err };
                };
                var __tmp__ = _unescape(_host.__slice__(_zone, _i), _encodeZone), _host2:GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    return { _0 : "", _1 : _err };
                };
                var __tmp__ = _unescape(_host.__slice__(_i), _encodeHost), _host3:GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    return { _0 : "", _1 : _err };
                };
...
function _validEncoded(_s:GoString, _mode:T_encoding):Bool {
        {
            var _i:GoInt = ((0 : GoInt));
            Go.cfor(_i < _s.length, _i++, {
                if (_s[_i] == (("!".code : GoRune)) || _s[_i] == (("$".code : GoRune)) || _s[_i] == (("&".code : GoRune)) || _s[_i] == (("\'".code : GoRune)) || _s[_i] == (("(".code : GoRune)) || _s[_i] == ((")".code : GoRune)) || _s[_i] == (("*".code : GoRune)) || _s[_i] == (("+".code : GoRune)) || _s[_i] == ((",".code : GoRune)) || _s[_i] == ((";".code : GoRune)) || _s[_i] == (("=".code : GoRune)) || _s[_i] == ((":".code : GoRune)) || _s[_i] == (("@".code : GoRune))) {} else if (_s[_i] == (("[".code : GoRune)) || _s[_i] == (("]".code : GoRune))) {} else if (_s[_i] == (("%".code : GoRune))) {} else {
...
function parseQuery(_query:GoString):{ var _0 : Values; var _1 : Error; } {
        var _m:Values = new Values(new GoMap<GoString, Slice<GoString>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind), stdgo.reflect.Reflect.GoType.sliceType(stdgo.reflect.Reflect.GoType.basic(string_kind)))))).__copy__();
...
function _resolvePath(_base:GoString, _ref:GoString):GoString {
        ...
        var _last:GoString = (("" : GoString)), _elem:GoString = (("" : GoString)), _i:GoInt = ((0 : GoInt)), _dst:stdgo.strings.Strings.Builder = new stdgo.strings.Strings.Builder();
...
function _validUserinfo(_s:GoString):Bool {
        for (_r in _s) {
            ...
            if (_r == (("-".code : GoRune)) || _r == ((".".code : GoRune)) || _r == (("_".code : GoRune)) || _r == ((":".code : GoRune)) || _r == (("~".code : GoRune)) || _r == (("!".code : GoRune)) || _r == (("$".code : GoRune)) || _r == (("&".code : GoRune)) || _r == (("\'".code : GoRune)) || _r == (("(".code : GoRune)) || _r == ((")".code : GoRune)) || _r == (("*".code : GoRune)) || _r == (("+".code : GoRune)) || _r == ((",".code : GoRune)) || _r == ((";".code : GoRune)) || _r == (("=".code : GoRune)) || _r == (("%".code : GoRune)) || _r == (("@".code : GoRune))) {
                continue;
            } else {
                return false;
            };
...
class URL_extension_fields {
    public function _setPath(__tmp__, _p:GoString):Error return __tmp__._setPath(_p);
    public function escapedPath(__tmp__):GoString return __tmp__.escapedPath();
    public function _setFragment(__tmp__, _f:GoString):Error return __tmp__._setFragment(_f);
    public function escapedFragment(__tmp__):GoString return __tmp__.escapedFragment();
    public function toString(__tmp__):GoString return __tmp__.toString();
    public function redacted(__tmp__):GoString return __tmp__.redacted();
    public function isAbs(__tmp__):Bool return __tmp__.isAbs();
    public function parse(__tmp__, _ref:GoString):{ var _0 : Pointer<URL>; var _1 : Error; } return __tmp__.parse(_ref);
    public function resolveReference(__tmp__, _ref:Pointer<URL>):Pointer<URL> return __tmp__.resolveReference(_ref);
    public function query(__tmp__):Values return __tmp__.query();
    public function requestURI(__tmp__):GoString return __tmp__.requestURI();
    public function hostname(__tmp__):GoString return __tmp__.hostname();
    public function port(__tmp__):GoString return __tmp__.port();
    public function marshalBinary(__tmp__):{ var _0 : Slice<GoByte>; var _1 : Error; } return __tmp__.marshalBinary();
    public function unmarshalBinary(__tmp__, _text:Slice<GoByte>):Error return __tmp__.unmarshalBinary(_text);
}
class Userinfo_extension_fields {
    public function username(__tmp__):GoString return __tmp__.username();
    public function password(__tmp__):{ var _0 : GoString; var _1 : Bool; } return __tmp__.password();
    public function toString(__tmp__):GoString return __tmp__.toString();
}
class Values_extension_fields {
    ...
    public function has(__tmp__, _key:GoString):Bool return __tmp__.has(_key);
    public function encode(__tmp__):GoString return __tmp__.encode();
}
