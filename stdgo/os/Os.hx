...
var errInvalid(get_errInvalid, set_errInvalid) : stdgo.Error;
...
var errPermission(get_errPermission, set_errPermission) : stdgo.Error;
...
var errExist(get_errExist, set_errExist) : stdgo.Error;
...
var errNotExist(get_errNotExist, set_errNotExist) : stdgo.Error;
...
var errClosed(get_errClosed, set_errClosed) : stdgo.Error;
...
var errProcessDone(get_errProcessDone, set_errProcessDone) : stdgo.Error;
...
var interrupt(get_interrupt, set_interrupt) : stdgo._internal.os.Os.Signal;
...
var kill(get_kill, set_kill) : stdgo._internal.os.Os.Signal;
...
var stdin(get_stdin, set_stdin) : stdgo._internal.os.Os.File;
...
var stdout(get_stdout, set_stdout) : stdgo._internal.os.Os.File;
...
var stderr(get_stderr, set_stderr) : stdgo._internal.os.Os.File;
...
var atime(get_atime, set_atime) : stdgo._internal.io.fs.Fs.FileInfo -> stdgo._internal.time.Time.Time;
...
var errWriteAtInAppendMode(get_errWriteAtInAppendMode, set_errWriteAtInAppendMode) : stdgo.Error;
...
var testingForceReadDirLstat(get_testingForceReadDirLstat, set_testingForceReadDirLstat) : stdgo.Pointer<Bool>;
...
var errPatternHasSeparator(get_errPatternHasSeparator, set_errPatternHasSeparator) : stdgo.Error;
...
var splitPath(get_splitPath, set_splitPath) : stdgo.GoString -> { var _0 : stdgo.GoString; var _1 : stdgo.GoString; };
...
var args(get_args, set_args) : Array<String>;
