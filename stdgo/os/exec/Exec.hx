...
@:structInit @:using(stdgo.os.exec.Exec.Error_static_extension) abstract Error(stdgo._internal.os.exec.Exec.Error) from stdgo._internal.os.exec.Exec.Error to stdgo._internal.os.exec.Exec.Error {
...
@:structInit @:private @:using(stdgo.os.exec.Exec.T_wrappedError_static_extension) abstract T_wrappedError(stdgo._internal.os.exec.Exec.T_wrappedError) from stdgo._internal.os.exec.Exec.T_wrappedError to stdgo._internal.os.exec.Exec.T_wrappedError {
...
@:structInit @:using(stdgo.os.exec.Exec.Cmd_static_extension) abstract Cmd(stdgo._internal.os.exec.Exec.Cmd) from stdgo._internal.os.exec.Exec.Cmd to stdgo._internal.os.exec.Exec.Cmd {
...
@:structInit @:private abstract T_ctxResult(stdgo._internal.os.exec.Exec.T_ctxResult) from stdgo._internal.os.exec.Exec.T_ctxResult to stdgo._internal.os.exec.Exec.T_ctxResult {
    public var _err(get, set) : stdgo.Error;
    function get__err():stdgo.Error return this._err;
    function set__err(v:stdgo.Error):stdgo.Error {
        this._err = v;
...
@:structInit @:using(stdgo.os.exec.Exec.ExitError_static_extension) abstract ExitError(stdgo._internal.os.exec.Exec.ExitError) from stdgo._internal.os.exec.Exec.ExitError to stdgo._internal.os.exec.Exec.ExitError {
    public var processState(get, set) : stdgo._internal.os.Os.ProcessState;
    function get_processState():stdgo._internal.os.Os.ProcessState return this.processState;
    function set_processState(v:stdgo._internal.os.Os.ProcessState):stdgo._internal.os.Os.ProcessState {
        this.processState = v;
...
@:structInit @:private @:using(stdgo.os.exec.Exec.T_prefixSuffixSaver_static_extension) abstract T_prefixSuffixSaver(stdgo._internal.os.exec.Exec.T_prefixSuffixSaver) from stdgo._internal.os.exec.Exec.T_prefixSuffixSaver to stdgo._internal.os.exec.Exec.T_prefixSuffixSaver {
