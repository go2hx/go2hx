...
(new stdgo._internal.testing.Testing.InternalTest(("TestConcurrentExec" : stdgo.GoString), stdgo._internal.os.exec_test.Exec_test.testConcurrentExec) : stdgo._internal.testing.Testing.InternalTest)) : stdgo.Slice<stdgo._internal.testing.Testing.InternalTest>);
var _benchmarks : stdgo.Slice<stdgo._internal.testing.Testing.InternalBenchmark> = (new stdgo.Slice<stdgo._internal.testing.Testing.InternalBenchmark>(1, 1, (new stdgo._internal.testing.Testing.InternalBenchmark(("BenchmarkExecHostname" : stdgo.GoString), stdgo._internal.os.exec.Exec.benchmarkExecHostname) : stdgo._internal.testing.Testing.InternalBenchmark)) : stdgo.Slice<stdgo._internal.testing.Testing.InternalBenchmark>);
