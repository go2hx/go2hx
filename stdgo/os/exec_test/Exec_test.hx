...
var _pathVar : stdgo.GoString = {
        var a = function():stdgo.GoString {
            if (false) {
                return ("path" : stdgo.GoString)?.__copy__();
            };
            return ("PATH" : stdgo.GoString)?.__copy__();
        };
        a();
...
function testLookPath(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        try {
            ...
            var _tmpDir:stdgo.GoString = stdgo.path.filepath.Filepath.join(_t.tempDir()?.__copy__(), ("testdir" : stdgo.GoString)?.__copy__())?.__copy__();
            {
                var _err:stdgo.Error = stdgo.os.Os.mkdir(_tmpDir?.__copy__(), (511u32 : stdgo.io.fs.Fs.FileMode));
                if (_err != null) {
                    _t.fatal(stdgo.Go.toInterface(_err));
                };
            };
            var _executable:stdgo.GoString = ("execabs-test" : stdgo.GoString)?.__copy__();
            if (false) {
                _executable = _executable + ((".exe" : stdgo.GoString))?.__copy__();
            };
            {
                var _err:stdgo.Error = stdgo.os.Os.writeFile(stdgo.path.filepath.Filepath.join(_tmpDir?.__copy__(), _executable?.__copy__())?.__copy__(), (new stdgo.Slice<stdgo.StdGoTypes.GoUInt8>(3, 3, (1 : stdgo.StdGoTypes.GoUInt8), (2 : stdgo.StdGoTypes.GoUInt8), (3 : stdgo.StdGoTypes.GoUInt8)) : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>), (511u32 : stdgo.io.fs.Fs.FileMode));
                if (_err != null) {
                    _t.fatal(stdgo.Go.toInterface(_err));
                };
            };
            ...
            __deferstack__.unshift(() -> {
                var a = function():Void {
                    {
                        var _err:stdgo.Error = stdgo.os.Os.chdir(_cwd?.__copy__());
                        if (_err != null) {
            ...
            _t.setenv(("PWD" : stdgo.GoString)?.__copy__(), _tmpDir?.__copy__());
            _t.logf((". is %#q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_tmpDir));
            var _origPath:stdgo.GoString = stdgo.os.Os.getenv(_pathVar?.__copy__())?.__copy__();
            for (__0 => _errdot in (new stdgo.Slice<stdgo.GoString>(2, 2, ("1" : stdgo.GoString)?.__copy__(), ("0" : stdgo.GoString)?.__copy__()) : stdgo.Slice<stdgo.GoString>)) {
                _t.run(("GODEBUG=execerrdot=" : stdgo.GoString) + _errdot?.__copy__()?.__copy__(), function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
                    _t.setenv(("GODEBUG" : stdgo.GoString)?.__copy__(), ("execerrdot=" : stdgo.GoString) + _errdot?.__copy__() + (",execwait=2" : stdgo.GoString)?.__copy__()?.__copy__());
                    for (__0 => _dir in (new stdgo.Slice<stdgo.GoString>(2, 2, ("." : stdgo.GoString)?.__copy__(), ("../testdir" : stdgo.GoString)?.__copy__()) : stdgo.Slice<stdgo.GoString>)) {
                        _t.run(_pathVar + ("=" : stdgo.GoString)?.__copy__() + _dir?.__copy__()?.__copy__(), function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
                            ...
                            var _good:stdgo.GoString = _dir + ("/execabs-test" : stdgo.GoString)?.__copy__()?.__copy__();
                            {
                                ...
                                if ((_err != null) || !stdgo.strings.Strings.hasPrefix(_found?.__copy__(), _good?.__copy__())) {
                                    _t.fatalf(("LookPath(%#q) = %#q, %v, want \"%s...\", nil" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_good), stdgo.Go.toInterface(_found), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(_good));
                                };
                            };
                            if (false) {
                                _good = _dir + ("\\execabs-test" : stdgo.GoString)?.__copy__()?.__copy__();
                                {
                                    var __tmp__ = lookPath(_good?.__copy__()), _found:stdgo.GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                                    if ((_err != null) || !stdgo.strings.Strings.hasPrefix(_found?.__copy__(), _good?.__copy__())) {
                                        _t.fatalf(("LookPath(%#q) = %#q, %v, want \"%s...\", nil" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_good), stdgo.Go.toInterface(_found), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(_good));
                            ...
                            var __tmp__ = lookPath(("execabs-test" : stdgo.GoString)?.__copy__()), __0:stdgo.GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                            if (_errdot == (("1" : stdgo.GoString))) {
                                if (_err == null) {
                                    _t.fatalf(("LookPath didn\'t fail when finding a non-relative path" : stdgo.GoString)?.__copy__());
                                } else if (!stdgo.errors.Errors.is_(_err, errDot)) {
                                    _t.fatalf(("LookPath returned unexpected error: want Is ErrDot, got %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
                                };
                            } else {
                                if (_err != null) {
                                    _t.fatalf(("LookPath failed unexpectedly: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
                                };
                            };
                            var _cmd = command(("execabs-test" : stdgo.GoString)?.__copy__());
                            if (_errdot == (("1" : stdgo.GoString))) {
                                if (_cmd.err == null) {
                                    _t.fatalf(("Command didn\'t fail when finding a non-relative path" : stdgo.GoString)?.__copy__());
                                } else if (!stdgo.errors.Errors.is_(_cmd.err, errDot)) {
                                    _t.fatalf(("Command returned unexpected error: want Is ErrDot, got %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_cmd.err));
                                };
                                _cmd.err = (null : stdgo.Error);
                            } else {
                                if (_cmd.err != null) {
                                    _t.fatalf(("Command failed unexpectedly: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
                                };
                            };
                            {
                                var _err:stdgo.Error = _cmd.run();
                                if (_err == null) {
                                    _t.fatalf(("Run did not fail: expected exec error" : stdgo.GoString)?.__copy__());
                                } else if (stdgo.errors.Errors.is_(_err, errDot)) {
                                    _t.fatalf(("Run returned unexpected error ErrDot: want error like ENOEXEC: %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
                                };
                            };
                        });
                    };
            ...
            _t.run(_pathVar + ("=$PWD" : stdgo.GoString)?.__copy__()?.__copy__(), function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
                _t.setenv(_pathVar?.__copy__(), _tmpDir + ((58 : stdgo.StdGoTypes.GoInt32) : stdgo.GoString)?.__copy__() + _origPath?.__copy__()?.__copy__());
                var _good:stdgo.GoString = stdgo.path.filepath.Filepath.join(_tmpDir?.__copy__(), ("execabs-test" : stdgo.GoString)?.__copy__())?.__copy__();
                {
                    var __tmp__ = lookPath(_good?.__copy__()), _found:stdgo.GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                    if ((_err != null) || !stdgo.strings.Strings.hasPrefix(_found?.__copy__(), _good?.__copy__())) {
                        _t.fatalf(("LookPath(%#q) = %#q, %v, want \\\"%s...\\\", nil" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_good), stdgo.Go.toInterface(_found), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(_good));
                ...
                {
                    var __tmp__ = lookPath(("execabs-test" : stdgo.GoString)?.__copy__()), _found:stdgo.GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                    if ((_err != null) || !stdgo.strings.Strings.hasPrefix(_found?.__copy__(), _good?.__copy__())) {
                        _t.fatalf(("LookPath(%#q) = %#q, %v, want \\\"%s...\\\", nil" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(("execabs-test" : stdgo.GoString)), stdgo.Go.toInterface(_found), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(_good));
                    };
                };
                var _cmd = command(("execabs-test" : stdgo.GoString)?.__copy__());
                if (_cmd.err != null) {
                    _t.fatalf(("Command(%#q).Err = %v; want nil" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(("execabs-test" : stdgo.GoString)), stdgo.Go.toInterface(_cmd.err));
                };
            });
            _t.run(_pathVar + ("=$OTHER" : stdgo.GoString)?.__copy__()?.__copy__(), function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
                ...
                _t.setenv(_pathVar?.__copy__(), stdgo.Go.str()?.__copy__());
                {
                    ...
                    if (stdgo.errors.Errors.is_(_err, errDot)) {
                        ...
                        _t.fatalf(("with PATH=\'\', LookPath(%#q) = %#q; want non-nil error" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(("execabs-test" : stdgo.GoString)), stdgo.Go.toInterface(_found));
                    };
                };
                ...
                {
                    var _err:stdgo.Error = stdgo.os.Os.writeFile(stdgo.path.filepath.Filepath.join(_dir?.__copy__(), _executable?.__copy__())?.__copy__(), (new stdgo.Slice<stdgo.StdGoTypes.GoUInt8>(3, 3, (1 : stdgo.StdGoTypes.GoUInt8), (2 : stdgo.StdGoTypes.GoUInt8), (3 : stdgo.StdGoTypes.GoUInt8)) : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>), (511u32 : stdgo.io.fs.Fs.FileMode));
                    if (_err != null) {
                        _t.fatal(stdgo.Go.toInterface(_err));
                    };
                };
                ...
                var __tmp__ = lookPath(("execabs-test" : stdgo.GoString)?.__copy__()), _found:stdgo.GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_wantErrDot) {
                    var _wantFound:stdgo.GoString = stdgo.path.filepath.Filepath.join(("." : stdgo.GoString)?.__copy__(), _executable?.__copy__())?.__copy__();
                    if ((_found != _wantFound) || !stdgo.errors.Errors.is_(_err, errDot)) {
                        _t.fatalf(("LookPath(%#q) = %#q, %v, want %#q, Is ErrDot" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(("execabs-test" : stdgo.GoString)), stdgo.Go.toInterface(_found), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(_wantFound));
                    };
                } else {
                    var _wantFound:stdgo.GoString = stdgo.path.filepath.Filepath.join(_dir?.__copy__(), _executable?.__copy__())?.__copy__();
                    if ((_found != _wantFound) || (_err != null)) {
                        _t.fatalf(("LookPath(%#q) = %#q, %v, want %#q, nil" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(("execabs-test" : stdgo.GoString)), stdgo.Go.toInterface(_found), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(_wantFound));
                    };
                };
            });
...
function exampleLookPath():Void {
        var __tmp__ = stdgo.os.exec.Exec.lookPath(("fortune" : stdgo.GoString)?.__copy__()), _path:stdgo.GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            stdgo.log.Log.fatal(stdgo.Go.toInterface(("installing fortune is in your future" : stdgo.GoString)));
        };
        stdgo.fmt.Fmt.printf(("fortune is available at %s\n" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_path));
    }
function exampleCommand():Void {
        var _cmd = stdgo.os.exec.Exec.command(("tr" : stdgo.GoString)?.__copy__(), ("a-z" : stdgo.GoString)?.__copy__(), ("A-Z" : stdgo.GoString)?.__copy__());
        _cmd.stdin = stdgo.Go.asInterface(stdgo.strings.Strings.newReader(("some input" : stdgo.GoString)?.__copy__()));
        ...
        stdgo.fmt.Fmt.printf(("in all caps: %q\n" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface((_out.string() : stdgo.GoString)));
    }
function exampleCommand_environment():Void {
        var _cmd = stdgo.os.exec.Exec.command(("prog" : stdgo.GoString)?.__copy__());
        _cmd.env = (stdgo.os.Os.environ().__append__(("FOO=duplicate_value" : stdgo.GoString)?.__copy__(), ("FOO=actual_value" : stdgo.GoString)?.__copy__()));
        {
            var _err:stdgo.Error = _cmd.run();
            if (_err != null) {
                stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
...
function exampleCmd_Output():Void {
        var __tmp__ = stdgo.os.exec.Exec.command(("date" : stdgo.GoString)?.__copy__()).output(), _out:stdgo.Slice<stdgo.StdGoTypes.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
        };
        stdgo.fmt.Fmt.printf(("The date is %s\n" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_out));
    }
function exampleCmd_Run():Void {
        var _cmd = stdgo.os.exec.Exec.command(("sleep" : stdgo.GoString)?.__copy__(), ("1" : stdgo.GoString)?.__copy__());
        stdgo.log.Log.printf(("Running command and waiting for it to finish..." : stdgo.GoString)?.__copy__());
        var _err:stdgo.Error = _cmd.run();
        stdgo.log.Log.printf(("Command finished with error: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
    }
function exampleCmd_Start():Void {
        var _cmd = stdgo.os.exec.Exec.command(("sleep" : stdgo.GoString)?.__copy__(), ("5" : stdgo.GoString)?.__copy__());
        var _err:stdgo.Error = _cmd.start();
        if (_err != null) {
            stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
        };
        stdgo.log.Log.printf(("Waiting for command to finish..." : stdgo.GoString)?.__copy__());
        _err = _cmd.wait_();
        stdgo.log.Log.printf(("Command finished with error: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
    }
function exampleCmd_StdoutPipe():Void {
        var _cmd = stdgo.os.exec.Exec.command(("echo" : stdgo.GoString)?.__copy__(), ("-n" : stdgo.GoString)?.__copy__(), ("{\"Name\": \"Bob\", \"Age\": 32}" : stdgo.GoString)?.__copy__());
        ...
        stdgo.fmt.Fmt.printf(("%s is %d years old\n" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_person.name), stdgo.Go.toInterface(_person.age));
    }
function exampleCmd_StdinPipe():Void {
        var _cmd = stdgo.os.exec.Exec.command(("cat" : stdgo.GoString)?.__copy__());
        ...
        stdgo.Go.routine(() -> {
            var a = function():Void {
                ...
                try {
                    ...
                    stdgo.io.Io.writeString(_stdin, ("values written to stdin are passed to cmd\'s standard input" : stdgo.GoString)?.__copy__());
                    for (defer in __deferstack__) {
                        defer();
                    };
                    {
...
function exampleCmd_StderrPipe():Void {
        var _cmd = stdgo.os.exec.Exec.command(("sh" : stdgo.GoString)?.__copy__(), ("-c" : stdgo.GoString)?.__copy__(), ("echo stdout; echo 1>&2 stderr" : stdgo.GoString)?.__copy__());
        ...
        stdgo.fmt.Fmt.printf(("%s\n" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_slurp));
        {
            var _err:stdgo.Error = _cmd.wait_();
            if (_err != null) {
                stdgo.log.Log.fatal(stdgo.Go.toInterface(_err));
...
function exampleCmd_CombinedOutput():Void {
        ...
        stdgo.fmt.Fmt.printf(("%s\n" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_stdoutStderr));
    }
function exampleCmd_Environ():Void {
        var _cmd = stdgo.os.exec.Exec.command(("pwd" : stdgo.GoString)?.__copy__());
        _cmd.dir = (".." : stdgo.GoString)?.__copy__();
        _cmd.env = (_cmd.environ().__append__(("POSIXLY_CORRECT=1" : stdgo.GoString)?.__copy__()));
...
function exampleCommandContext():Void {
        ...
        try {
            ...
            {
                var _err:stdgo.Error = stdgo.os.exec.Exec.commandContext(_ctx, ("sleep" : stdgo.GoString)?.__copy__(), ("5" : stdgo.GoString)?.__copy__()).run();
                if (_err != null) {};
            };
            for (defer in __deferstack__) {
                defer();
...
function testMain(_m:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.M>):Void {
        ...
        if (stdgo.os.Os.getenv(("GO_EXEC_TEST_PID" : stdgo.GoString)?.__copy__()) == (stdgo.Go.str())) {
            stdgo.os.Os.setenv(("GO_EXEC_TEST_PID" : stdgo.GoString)?.__copy__(), stdgo.strconv.Strconv.itoa(_pid)?.__copy__());
            var _code:stdgo.StdGoTypes.GoInt = _m.run();
            if (((_code == (0 : stdgo.StdGoTypes.GoInt)) && ((stdgo.flag.Flag.lookup(("test.run" : stdgo.GoString)?.__copy__()).value.string() : stdgo.GoString) == stdgo.Go.str())) && ((stdgo.flag.Flag.lookup(("test.list" : stdgo.GoString)?.__copy__()).value.string() : stdgo.GoString) == stdgo.Go.str())) {
...
function _registerHelperCommand(_name:stdgo.GoString, _f:haxe.Rest<stdgo.GoString> -> Void):Void {
        if ((_helperCommands[_name?.__copy__()] ?? null) != null) {
            throw stdgo.Go.toInterface(("duplicate command registered: " : stdgo.GoString) + _name?.__copy__());
        };
        _helperCommands[_name?.__copy__()] = _f;
    }
/**
...
function _helperCommand(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>, _name:stdgo.GoString, _args:haxe.Rest<stdgo.GoString>):stdgo.StdGoTypes.Ref<stdgo.os.exec.Exec.Cmd> {
        ...
        _t.helper();
        return _helperCommandContext(_t, (null : stdgo.context.Context.Context), _name?.__copy__(), ..._args.__toArray__());
    }
/**
...
function _helperCommandContext(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>, _ctx:stdgo.context.Context.Context, _name:stdgo.GoString, _args:haxe.Rest<stdgo.GoString>):stdgo.StdGoTypes.Ref<stdgo.os.exec.Exec.Cmd> {
        ...
        if (_ctx != null) {
            _cmd = stdgo.os.exec.Exec.commandContext(_ctx, _exePath(stdgo.Go.asInterface(_t))?.__copy__(), ..._cs.__toArray__());
        } else {
            _cmd = stdgo.os.exec.Exec.command(_exePath(stdgo.Go.asInterface(_t))?.__copy__(), ..._cs.__toArray__());
        };
        return _cmd;
    }
/**
...
function _cmdEchoEnv(_args:haxe.Rest<stdgo.GoString>):Void {
        var _args = new stdgo.Slice<stdgo.GoString>(_args.length, 0, ..._args);
        for (__0 => _s in _args) {
            stdgo.fmt.Fmt.println(stdgo.Go.toInterface(stdgo.os.Os.getenv(_s?.__copy__())));
        };
    }
function _cmdCat(_args:haxe.Rest<stdgo.GoString>):Void {
        ...
        try {
            ...
            for (__0 => _fn in _args) {
                var __tmp__ = stdgo.os.Os.open(_fn?.__copy__()), _f:stdgo.StdGoTypes.Ref<stdgo.os.Os.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    stdgo.fmt.Fmt.fprintf(stdgo.Go.asInterface(stdgo.os.Os.stderr), ("Error: %v\n" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
...
function _cmdStdinClose(_0:haxe.Rest<stdgo.GoString>):Void {
        ...
        };
        {
            ...
            if (_s != (("Some test string." : stdgo.GoString))) {
                stdgo.fmt.Fmt.fprintf(stdgo.Go.asInterface(stdgo.os.Os.stderr), ("Error: Read %q, want %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_s), stdgo.Go.toInterface(("Some test string." : stdgo.GoString)));
                Sys.exit((1 : stdgo.StdGoTypes.GoInt));
            };
        };
    }
function _cmdExit(_args:haxe.Rest<stdgo.GoString>):Void {
        var _args = new stdgo.Slice<stdgo.GoString>(_args.length, 0, ..._args);
        var __tmp__ = stdgo.strconv.Strconv.atoi(_args[(0 : stdgo.StdGoTypes.GoInt)]?.__copy__()), _n:stdgo.StdGoTypes.GoInt = __tmp__._0, __0:stdgo.Error = __tmp__._1;
        Sys.exit(_n);
    }
function _cmdDescribeFiles(_args:haxe.Rest<stdgo.GoString>):Void {
        var _args = new stdgo.Slice<stdgo.GoString>(_args.length, 0, ..._args);
        var _f = stdgo.os.Os.newFile((3 : stdgo.StdGoTypes.GoUIntptr), stdgo.fmt.Fmt.sprintf(("fd3" : stdgo.GoString)?.__copy__())?.__copy__());
        var __tmp__ = stdgo.net.Net.fileListener(_f), _ln:stdgo.net.Net.Listener = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err == null) {
            stdgo.fmt.Fmt.printf(("fd3: listener %s\n" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_ln.addr()));
            _ln.close();
        };
    }
...
function _cmdYes(_args:haxe.Rest<stdgo.GoString>):Void {
        var _args = new stdgo.Slice<stdgo.GoString>(_args.length, 0, ..._args);
        if ((_args.length) == ((0 : stdgo.StdGoTypes.GoInt))) {
            _args = (new stdgo.Slice<stdgo.GoString>(1, 1, ("y" : stdgo.GoString)?.__copy__()) : stdgo.Slice<stdgo.GoString>);
        };
        var _s:stdgo.GoString = stdgo.strings.Strings.join(_args, (" " : stdgo.GoString)?.__copy__()) + ("\n" : stdgo.GoString)?.__copy__()?.__copy__();
        while (true) {
            var __tmp__ = stdgo.os.Os.stdout.writeString(_s?.__copy__()), __0:stdgo.StdGoTypes.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                Sys.exit((1 : stdgo.StdGoTypes.GoInt));
            };
        };
...
function testEcho(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        _t.parallel();
        var __tmp__ = _helperCommand(_t, ("echo" : stdgo.GoString)?.__copy__(), ("foo bar" : stdgo.GoString)?.__copy__(), ("baz" : stdgo.GoString)?.__copy__()).output(), _bs:stdgo.Slice<stdgo.StdGoTypes.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _t.errorf(("echo: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
        };
        {
            var __0:stdgo.GoString = (_bs : stdgo.GoString)?.__copy__(), __1:stdgo.GoString = ("foo bar baz\n" : stdgo.GoString)?.__copy__(), _e:stdgo.GoString = __1, _g:stdgo.GoString = __0;
            if (_g != (_e)) {
                _t.errorf(("echo: want %q, got %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_e), stdgo.Go.toInterface(_g));
            };
        };
    }
function testCommandRelativeName(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        _t.parallel();
        var _cmd = _helperCommand(_t, ("echo" : stdgo.GoString)?.__copy__(), ("foo" : stdgo.GoString)?.__copy__());
        var _base:stdgo.GoString = stdgo.path.filepath.Filepath.base(stdgo.os.Os.args[(0 : stdgo.StdGoTypes.GoInt)]?.__copy__())?.__copy__();
        var _dir:stdgo.GoString = stdgo.path.filepath.Filepath.dir(stdgo.os.Os.args[(0 : stdgo.StdGoTypes.GoInt)]?.__copy__())?.__copy__();
        if (_dir == (("." : stdgo.GoString))) {
            _t.skip(stdgo.Go.toInterface(("skipping; running test at root somehow" : stdgo.GoString)));
        };
        var _parentDir:stdgo.GoString = stdgo.path.filepath.Filepath.dir(_dir?.__copy__())?.__copy__();
        var _dirBase:stdgo.GoString = stdgo.path.filepath.Filepath.base(_dir?.__copy__())?.__copy__();
        if (_dirBase == (("." : stdgo.GoString))) {
            _t.skipf(("skipping; unexpected shallow dir of %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_dir));
        };
        _cmd.path = stdgo.path.filepath.Filepath.join(_dirBase?.__copy__(), _base?.__copy__())?.__copy__();
...
function testCatStdin(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        _t.parallel();
        var _input:stdgo.GoString = ("Input string\nLine 2" : stdgo.GoString)?.__copy__();
        var _p = _helperCommand(_t, ("cat" : stdgo.GoString)?.__copy__());
        _p.stdin = stdgo.Go.asInterface(stdgo.strings.Strings.newReader(_input?.__copy__()));
        var __tmp__ = _p.output(), _bs:stdgo.Slice<stdgo.StdGoTypes.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _t.errorf(("cat: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
        };
        var _s:stdgo.GoString = (_bs : stdgo.GoString)?.__copy__();
        if (_s != (_input)) {
            _t.errorf(("cat: want %q, got %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_input), stdgo.Go.toInterface(_s));
        };
    }
function testEchoFileRace(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        _t.parallel();
        var _cmd = _helperCommand(_t, ("echo" : stdgo.GoString)?.__copy__());
        var __tmp__ = _cmd.stdinPipe(), _stdin:stdgo.io.Io.WriteCloser = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _t.fatalf(("StdinPipe: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
        };
        {
            var _err:stdgo.Error = _cmd.start();
            if (_err != null) {
                _t.fatalf(("Start: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
            };
        };
        ...
        });
        {
            var _err:stdgo.Error = _cmd.wait_();
            if (_err != null) {
                _t.fatalf(("Wait: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
            };
        };
        _wrote.__get__();
    }
function testCatGoodAndBadFile(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        _t.parallel();
        var __tmp__ = _helperCommand(_t, ("cat" : stdgo.GoString)?.__copy__(), ("/bogus/file.foo" : stdgo.GoString)?.__copy__(), ("exec_test.go" : stdgo.GoString)?.__copy__()).combinedOutput(), _bs:stdgo.Slice<stdgo.StdGoTypes.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        {
            var __tmp__ = try {
            ...
            if (!_ok) {
                _t.errorf(("expected *exec.ExitError from cat combined; got %T: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(_err));
            };
        };
        var __tmp__ = stdgo.strings.Strings.cut((_bs : stdgo.GoString)?.__copy__(), ("\n" : stdgo.GoString)?.__copy__()), _errLine:stdgo.GoString = __tmp__._0, _body:stdgo.GoString = __tmp__._1, _ok:Bool = __tmp__._2;
        if (!_ok) {
            _t.fatalf(("expected two lines from cat; got %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_bs));
        };
        if (!stdgo.strings.Strings.hasPrefix(_errLine?.__copy__(), ("Error: open /bogus/file.foo" : stdgo.GoString)?.__copy__())) {
            _t.errorf(("expected stderr to complain about file; got %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_errLine));
        };
        if (!stdgo.strings.Strings.contains(_body?.__copy__(), ("func TestCatGoodAndBadFile(t *testing.T)" : stdgo.GoString)?.__copy__())) {
            _t.errorf(("expected test code; got %q (len %d)" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_body), stdgo.Go.toInterface((_body.length)));
        };
    }
function testNoExistExecutable(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        _t.parallel();
        var _err:stdgo.Error = stdgo.os.exec.Exec.command(("/no-exist-executable" : stdgo.GoString)?.__copy__()).run();
        if (_err == null) {
...
function testExitStatus(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        _t.parallel();
        var _cmd = _helperCommand(_t, ("exit" : stdgo.GoString)?.__copy__(), ("42" : stdgo.GoString)?.__copy__());
        var _err:stdgo.Error = _cmd.run();
        var _want:stdgo.GoString = ("exit status 42" : stdgo.GoString)?.__copy__();
        {
            final __value__ = ("js" : stdgo.GoString);
            if (__value__ == (("plan9" : stdgo.GoString))) {
                _want = stdgo.fmt.Fmt.sprintf(("exit status: \'%s %d: 42\'" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(stdgo.path.filepath.Filepath.base(_cmd.path?.__copy__())), stdgo.Go.toInterface(_cmd.processState.pid()))?.__copy__();
            };
        };
        {
            var __tmp__ = try {
            ...
            if (_ok) {
                {
                    ...
                    if (_s != (_want)) {
                        _t.errorf(("from exit 42 got exit %q, want %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_s), stdgo.Go.toInterface(_want));
                    };
                };
            } else {
                _t.fatalf(("expected *exec.ExitError from exit 42; got %T: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(_err));
            };
        };
    }
function testExitCode(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        if (_want != (_got)) {
            _t.errorf(("ExitCode got %d, want %d" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_got), stdgo.Go.toInterface(_want));
        };
        _cmd = _helperCommand(_t, ("/no-exist-executable" : stdgo.GoString)?.__copy__());
        _cmd.run();
        ...
        _cmd = _helperCommand(_t, ("exit" : stdgo.GoString)?.__copy__(), ("255" : stdgo.GoString)?.__copy__());
        _cmd.run();
        ...
        _cmd = _helperCommand(_t, ("cat" : stdgo.GoString)?.__copy__());
        _cmd.run();
...
function testPipes(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _check:(stdgo.GoString, stdgo.Error) -> Void = function(_what:stdgo.GoString, _err:stdgo.Error):Void {
            if (_err != null) {
                _t.fatalf(("%s: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_what), stdgo.Go.toInterface(_err));
            };
        };
        var _c = _helperCommand(_t, ("pipetest" : stdgo.GoString)?.__copy__());
        var __tmp__ = _c.stdinPipe(), _stdin:stdgo.io.Io.WriteCloser = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        _check(("StdinPipe" : stdgo.GoString)?.__copy__(), _err);
        var __tmp__ = _c.stdoutPipe(), _stdout:stdgo.io.Io.ReadCloser = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        _check(("StdoutPipe" : stdgo.GoString)?.__copy__(), _err);
        var __tmp__ = _c.stderrPipe(), _stderr:stdgo.io.Io.ReadCloser = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        _check(("StderrPipe" : stdgo.GoString)?.__copy__(), _err);
        ...
        _err = _c.start();
        _check(("Start" : stdgo.GoString)?.__copy__(), _err);
        {
            var __tmp__ = _stdin.write((("O:I am output\n" : stdgo.GoString) : stdgo.Slice<stdgo.StdGoTypes.GoByte>));
            _err = __tmp__._1;
        };
        _check(("first stdin Write" : stdgo.GoString)?.__copy__(), _err);
        {
            var __0:stdgo.GoString = _line(("first output line" : stdgo.GoString)?.__copy__(), _outbr)?.__copy__(), __1:stdgo.GoString = ("O:I am output" : stdgo.GoString)?.__copy__(), _e:stdgo.GoString = __1, _g:stdgo.GoString = __0;
            if (_g != (_e)) {
                _t.errorf(("got %q, want %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_g), stdgo.Go.toInterface(_e));
            };
        };
        {
        ...
        _check(("second stdin Write" : stdgo.GoString)?.__copy__(), _err);
        {
            var __0:stdgo.GoString = _line(("first error line" : stdgo.GoString)?.__copy__(), _errbr)?.__copy__(), __1:stdgo.GoString = ("E:I am error" : stdgo.GoString)?.__copy__(), _e:stdgo.GoString = __1, _g:stdgo.GoString = __0;
            if (_g != (_e)) {
                _t.errorf(("got %q, want %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_g), stdgo.Go.toInterface(_e));
            };
        };
        ...
        _check(("third stdin Write 3" : stdgo.GoString)?.__copy__(), _err);
        {
            var __0:stdgo.GoString = _line(("second output line" : stdgo.GoString)?.__copy__(), _outbr)?.__copy__(), __1:stdgo.GoString = ("O:I am output2" : stdgo.GoString)?.__copy__(), _e:stdgo.GoString = __1, _g:stdgo.GoString = __0;
            if (_g != (_e)) {
                _t.errorf(("got %q, want %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_g), stdgo.Go.toInterface(_e));
            };
        };
        _stdin.close();
        _err = _c.wait_();
        _check(("Wait" : stdgo.GoString)?.__copy__(), _err);
    }
/**
    // Issue 6270.
**/
function testStdinClose(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        try {
            ...
            var _cmd = _helperCommand(_t, ("stdinClose" : stdgo.GoString)?.__copy__());
            var __tmp__ = _cmd.stdinPipe(), _stdin:stdgo.io.Io.WriteCloser = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            _check(("StdinPipe" : stdgo.GoString)?.__copy__(), _err);
            {
                var __tmp__ = try {
            ...
            _check(("Start" : stdgo.GoString)?.__copy__(), _cmd.start());
            ...
            stdgo.Go.routine(() -> {
                var a = function():Void {
                    ...
                    try {
                        ...
                        var __tmp__ = stdgo.io.Io.copy(_stdin, stdgo.Go.asInterface(stdgo.strings.Strings.newReader(("Some test string." : stdgo.GoString)?.__copy__()))), __0:stdgo.StdGoTypes.GoInt64 = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                        _check(("Copy" : stdgo.GoString)?.__copy__(), _err);
                        {
                            var _err:stdgo.Error = _stdin.close();
                            if ((_err != null) && !stdgo.errors.Errors.is_(_err, stdgo.os.Os.errClosed)) {
                                _t.errorf(("Close: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
                            };
                        };
                        for (defer in __deferstack__) {
                            defer();
            ...
            _check(("Wait" : stdgo.GoString)?.__copy__(), _cmd.wait_());
            for (defer in __deferstack__) {
                defer();
            };
            {
        ...
        try {
            ...
            stdgo.Go.routine(() -> {
                var a = function():Void {
                    ...
                    try {
                        __deferstack__.unshift(() -> _wg.done());
                        stdgo.io.Io.copy(_stdin, stdgo.Go.asInterface(stdgo.strings.Strings.newReader(("unexpected string" : stdgo.GoString)?.__copy__())));
                        {
                            var _err:stdgo.Error = _stdin.close();
                            if ((_err != null) && !stdgo.errors.Errors.is_(_err, stdgo.os.Os.errClosed)) {
                                _t.errorf(("stdin.Close: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
                            };
                        };
                        for (defer in __deferstack__) {
                            defer();
            ...
            });
            {
                var _err:stdgo.Error = _cmd.wait_();
                if (_err == null) {
                    _t.fatalf(("Wait: succeeded unexpectedly" : stdgo.GoString)?.__copy__());
                };
            };
            for (defer in __deferstack__) {
                defer();
...
function testPipeLookPathLeak(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        };
        {
            ...
            stdgo.Go.cfor(_i < (6 : stdgo.StdGoTypes.GoInt), _i++, {
                var _cmd = stdgo.os.exec.Exec.command(("something-that-does-not-exist-executable" : stdgo.GoString)?.__copy__());
                _cmd.stdoutPipe();
                _cmd.stderrPipe();
                _cmd.stdinPipe();
                {
        ...
        for (__1 => _fd in _openFDs()) {
            if (!(_old[_fd] ?? false)) {
                _t.errorf(("leaked file descriptor %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_fd));
            };
        };
    }
function testExtraFiles(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        try {
            if (stdgo.testing.Testing.short()) {
                _t.skipf(("skipping test in short mode that would build a helper binary" : stdgo.GoString)?.__copy__());
            };
            ...
            if (false) {
                _t.skipf(("skipping test on %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(("js" : stdgo.GoString)));
            };
            var __tmp__ = stdgo.net.Net.listen(("tcp" : stdgo.GoString)?.__copy__(), ("127.0.0.1:0" : stdgo.GoString)?.__copy__()), _ln:stdgo.net.Net.Listener = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                _t.fatal(stdgo.Go.toInterface(_err));
            };
            ...
            _ts.config.errorLog = stdgo.log.Log.new_(stdgo.io.Io.discard, stdgo.Go.str()?.__copy__(), (0 : stdgo.StdGoTypes.GoInt));
            _ts.startTLS();
            __deferstack__.unshift(() -> _ts.close());
            {
                var __tmp__ = stdgo.net.http.Http.get(_ts.url?.__copy__());
                _err = __tmp__._1;
            };
            if (_err == null) {
                _t.errorf(("success trying to fetch %s; want an error" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_ts.url));
            };
            var __tmp__ = stdgo.os.Os.createTemp(stdgo.Go.str()?.__copy__(), stdgo.Go.str()?.__copy__()), _tf:stdgo.StdGoTypes.Ref<stdgo.os.Os.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                _t.fatalf(("TempFile: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
            };
            {
                var _a0 = _tf.name();
            ...
            if (_err != null) {
                _t.fatalf(("Write: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
            };
            {
            ...
            if (_err != null) {
                _t.fatalf(("Seek: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
            };
            var _tempdir:stdgo.GoString = _t.tempDir()?.__copy__();
            var _exe:stdgo.GoString = stdgo.path.filepath.Filepath.join(_tempdir?.__copy__(), ("read3.exe" : stdgo.GoString)?.__copy__())?.__copy__();
            var _c = stdgo.internal.testenv.Testenv.command(stdgo.Go.asInterface(_t), stdgo.internal.testenv.Testenv.goToolPath(stdgo.Go.asInterface(_t))?.__copy__(), ("build" : stdgo.GoString)?.__copy__(), ("-o" : stdgo.GoString)?.__copy__(), _exe?.__copy__(), ("read3.go" : stdgo.GoString)?.__copy__());
            _c.env = (stdgo.os.Os.environ().__append__(("CGO_ENABLED=0" : stdgo.GoString)?.__copy__()));
            {
                var __tmp__ = _c.combinedOutput(), _output:stdgo.Slice<stdgo.StdGoTypes.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    _t.logf(("go build -o %s read3.go\n%s" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_exe), stdgo.Go.toInterface(_output));
                    _t.fatalf(("go build failed: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
                };
            };
            ...
            _c = stdgo.os.exec.Exec.commandContext(_ctx, _exe?.__copy__());
            ...
            if (false) {
                _c.env = (stdgo.os.Os.environ().__append__(("GOMAXPROCS=1" : stdgo.GoString)?.__copy__()));
            };
            _err = _c.run();
            if (_err != null) {
                _t.fatalf(("Run: %v\n--- stdout:\n%s--- stderr:\n%s" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err), stdgo.Go.toInterface((_stdout.string() : stdgo.GoString)), stdgo.Go.toInterface((_stderr.string() : stdgo.GoString)));
            };
            if ((_stdout.string() : stdgo.GoString) != (("Hello, fd 3!" : stdgo.GoString))) {
                _t.errorf(("got stdout %q, stderr %q; want %q on stdout" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface((_stdout.string() : stdgo.GoString)), stdgo.Go.toInterface((_stderr.string() : stdgo.GoString)), stdgo.Go.toInterface(("Hello, fd 3!" : stdgo.GoString)));
            };
            for (defer in __deferstack__) {
                defer();
            };
...
function testExtraFilesRace(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        if (false) {
            _maySkipHelperCommand(("describefiles" : stdgo.GoString)?.__copy__());
        ...
        var _runCommand = function(_c:stdgo.StdGoTypes.Ref<stdgo.os.exec.Exec.Cmd>, _out:stdgo.Chan<stdgo.GoString>):Void {
            ...
            if (_err != null) {
                _out.__send__(("ERROR:" : stdgo.GoString) + _err.error()?.__copy__());
            } else {
        ...
        };
        {
            ...
            stdgo.Go.cfor(_i < (10 : stdgo.StdGoTypes.GoInt), _i++, {
                ...
                var _ca = _helperCommand(_t, ("describefiles" : stdgo.GoString)?.__copy__());
                ...
                var _cb = _helperCommand(_t, ("describefiles" : stdgo.GoString)?.__copy__());
                ...
                {
                    var __0:stdgo.GoString = _ares.__get__()?.__copy__(), __1:stdgo.GoString = stdgo.fmt.Fmt.sprintf(("fd3: listener %s\n" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_la.addr()))?.__copy__(), _want:stdgo.GoString = __1, _got:stdgo.GoString = __0;
                    if (_got != (_want)) {
                        _t.errorf(("iteration %d, process A got:\n%s\nwant:\n%s\n" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_i), stdgo.Go.toInterface(_got), stdgo.Go.toInterface(_want));
                    };
                };
                {
                    var __0:stdgo.GoString = _bres.__get__()?.__copy__(), __1:stdgo.GoString = stdgo.fmt.Fmt.sprintf(("fd3: listener %s\n" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_lb.addr()))?.__copy__(), _want:stdgo.GoString = __1, _got:stdgo.GoString = __0;
                    if (_got != (_want)) {
...
function testIgnorePipeErrorOnSuccess(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _testWith = function(_r:stdgo.io.Io.Reader):stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T> -> Void {
            return function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
                ...
                {
                    var __0:stdgo.GoString = (_out.string() : stdgo.GoString)?.__copy__(), __1:stdgo.GoString = ("foo\n" : stdgo.GoString)?.__copy__(), _want:stdgo.GoString = __1, _got:stdgo.GoString = __0;
                    if (_got != (_want)) {
                        _t.errorf(("output = %q; want %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_got), stdgo.Go.toInterface(_want));
                    };
                };
            };
        };
...
function testClosePipeOnCopyError(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        _t.parallel();
        var _cmd = _helperCommand(_t, ("yes" : stdgo.GoString)?.__copy__());
        ...
        var _err:stdgo.Error = _cmd.run();
        if (_err == null) {
            _t.errorf(("yes unexpectedly completed successfully" : stdgo.GoString)?.__copy__());
        };
    }
function testOutputStderrCapture(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        _t.parallel();
        var _cmd = _helperCommand(_t, ("stderrfail" : stdgo.GoString)?.__copy__());
        ...
        if (!_ok) {
            _t.fatalf(("Output error type = %T; want ExitError" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
        };
        var _got:stdgo.GoString = (_ee.stderr : stdgo.GoString)?.__copy__();
        var _want:stdgo.GoString = ("some stderr text\n" : stdgo.GoString)?.__copy__();
        if (_got != (_want)) {
            _t.errorf(("ExitError.Stderr = %q; want %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_got), stdgo.Go.toInterface(_want));
        };
    }
function testContext(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _c = _helperCommandContext(_t, _ctx, ("pipetest" : stdgo.GoString)?.__copy__());
        var __tmp__ = _c.stdinPipe(), _stdin:stdgo.io.Io.WriteCloser = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _t.fatal(stdgo.Go.toInterface(_err));
        };
        ...
        if (((_n != (_buf.length)) || (_err != null)) || ((_buf : stdgo.GoString) != ("O:hi\n" : stdgo.GoString))) {
            _t.fatalf(("ReadFull = %d, %v, %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_n), stdgo.Go.toInterface(_err), stdgo.Go.toInterface((_buf.__slice__(0, _n) : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>)));
        };
...
function testContextCancel(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        try {
            if (false) {
                _maySkipHelperCommand(("cat" : stdgo.GoString)?.__copy__());
                stdgo.internal.testenv.Testenv.skipFlaky(stdgo.Go.asInterface(_t), (42061 : stdgo.StdGoTypes.GoInt));
            };
            _t.parallel();
            var __tmp__ = stdgo.context.Context.withCancel(stdgo.context.Context.background()), _ctx:stdgo.context.Context.Context = __tmp__._0, _cancel:stdgo.context.Context.CancelFunc = __tmp__._1;
            __deferstack__.unshift(() -> _cancel());
            var _c = _helperCommandContext(_t, _ctx, ("cat" : stdgo.GoString)?.__copy__());
            var __tmp__ = _c.stdinPipe(), _stdin:stdgo.io.Io.WriteCloser = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                _t.fatal(stdgo.Go.toInterface(_err));
            };
            ...
            {
                var __tmp__ = stdgo.io.Io.writeString(_stdin, ("echo" : stdgo.GoString)?.__copy__()), __0:stdgo.StdGoTypes.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    _t.fatal(stdgo.Go.toInterface(_err));
                };
            };
            ...
            while (true) {
                {
                    var __tmp__ = stdgo.io.Io.writeString(_stdin, ("echo" : stdgo.GoString)?.__copy__()), __1:stdgo.StdGoTypes.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                    if (_err != null) {
                        break;
                    };
                };
                if (stdgo.time.Time.since(_start?.__copy__()) > (60000000000i64 : stdgo.time.Time.Duration)) {
                    stdgo.runtime.debug.Debug.setTraceback(("system" : stdgo.GoString)?.__copy__());
            ...
            };
            {
                ...
                if (_err == null) {
                    ...
                    _t.logf(("exit status: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
                };
            };
            for (defer in __deferstack__) {
                defer();
...
function testDedupEnvEcho(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        _t.parallel();
        var _cmd = _helperCommand(_t, ("echoenv" : stdgo.GoString)?.__copy__(), ("FOO" : stdgo.GoString)?.__copy__());
        _cmd.env = (_cmd.environ().__append__(("FOO=bad" : stdgo.GoString)?.__copy__(), ("FOO=good" : stdgo.GoString)?.__copy__()));
        var __tmp__ = _cmd.combinedOutput(), _out:stdgo.Slice<stdgo.StdGoTypes.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _t.fatal(stdgo.Go.toInterface(_err));
        };
        {
            var __0:stdgo.GoString = stdgo.strings.Strings.trimSpace((_out : stdgo.GoString)?.__copy__())?.__copy__(), __1:stdgo.GoString = ("good" : stdgo.GoString)?.__copy__(), _want:stdgo.GoString = __1, _got:stdgo.GoString = __0;
            if (_got != (_want)) {
                _t.errorf(("output = %q; want %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_got), stdgo.Go.toInterface(_want));
            };
        };
...
function testEnvNULCharacter(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _cmd = _helperCommand(_t, ("echoenv" : stdgo.GoString)?.__copy__(), ("FOO" : stdgo.GoString)?.__copy__(), ("BAR" : stdgo.GoString)?.__copy__());
        _cmd.env = (_cmd.environ().__append__(stdgo.Go.str("FOO=foo", 0, "BAR=bar")?.__copy__()));
        var __tmp__ = _cmd.combinedOutput(), _out:stdgo.Slice<stdgo.StdGoTypes.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err == null) {
            _t.errorf(("output = %q; want error" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface((_out : stdgo.GoString)));
        };
    }
function testString(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        _t.parallel();
        var __tmp__ = stdgo.os.exec.Exec.lookPath(("echo" : stdgo.GoString)?.__copy__()), _echoPath:stdgo.GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            _t.skip(stdgo.Go.toInterface(_err));
        };
        var _tests = (new stdgo.GoArray<T__struct_2>(({ _path : ("echo" : stdgo.GoString)?.__copy__(), _args : (null : stdgo.Slice<stdgo.GoString>), _want : _echoPath?.__copy__() } : T__struct_2), ({ _path : ("echo" : stdgo.GoString)?.__copy__(), _args : (new stdgo.Slice<stdgo.GoString>(1, 1, ("a" : stdgo.GoString)?.__copy__()) : stdgo.Slice<stdgo.GoString>), _want : _echoPath + (" a" : stdgo.GoString)?.__copy__()?.__copy__() } : T__struct_2), ({ _path : ("echo" : stdgo.GoString)?.__copy__(), _args : (new stdgo.Slice<stdgo.GoString>(2, 2, ("a" : stdgo.GoString)?.__copy__(), ("b" : stdgo.GoString)?.__copy__()) : stdgo.Slice<stdgo.GoString>), _want : _echoPath + (" a b" : stdgo.GoString)?.__copy__()?.__copy__() } : T__struct_2)) : stdgo.GoArray<T__struct_2>);
        for (__0 => _test in _tests) {
            var _cmd = stdgo.os.exec.Exec.command(_test._path?.__copy__(), ..._test._args.__toArray__());
            {
                var _got:stdgo.GoString = (_cmd.string() : stdgo.GoString)?.__copy__();
                if (_got != (_test._want)) {
                    _t.errorf(("String(%q, %q) = %q, want %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_test._path), stdgo.Go.toInterface(_test._args), stdgo.Go.toInterface(_got), stdgo.Go.toInterface(_test._want));
                };
            };
        };
    }
function testStringPathNotResolved(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        _t.parallel();
        var __tmp__ = stdgo.os.exec.Exec.lookPath(("makemeasandwich" : stdgo.GoString)?.__copy__()), __0:stdgo.GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err == null) {
            _t.skip(stdgo.Go.toInterface(("wow, thanks" : stdgo.GoString)));
        };
        var _cmd = stdgo.os.exec.Exec.command(("makemeasandwich" : stdgo.GoString)?.__copy__(), ("-lettuce" : stdgo.GoString)?.__copy__());
        var _want:stdgo.GoString = ("makemeasandwich -lettuce" : stdgo.GoString)?.__copy__();
        {
            var _got:stdgo.GoString = (_cmd.string() : stdgo.GoString)?.__copy__();
            if (_got != (_want)) {
                _t.errorf(("String(%q, %q) = %q, want %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(("makemeasandwich" : stdgo.GoString)), stdgo.Go.toInterface(("-lettuce" : stdgo.GoString)), stdgo.Go.toInterface(_got), stdgo.Go.toInterface(_want));
            };
        };
    }
function testNoPath(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _want:stdgo.GoString = ("exec: no command" : stdgo.GoString)?.__copy__();
        if ((_err == null) || (_err.error() != _want)) {
            _t.errorf(("new(Cmd).Start() = %v, want %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(_want));
        };
    }
/**
...
function testDoubleStartLeavesPipesOpen(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        _t.parallel();
        var _cmd = _helperCommand(_t, ("pipetest" : stdgo.GoString)?.__copy__());
        ...
        {
            var _err:stdgo.Error = _cmd.start();
            if ((_err == null) || !stdgo.strings.Strings.hasSuffix(_err.error()?.__copy__(), ("already started" : stdgo.GoString)?.__copy__())) {
                _t.fatalf(("second call to Start returned a nil; want an \'already started\' error" : stdgo.GoString)?.__copy__());
            };
        };
        ...
        if (!stdgo.bytes.Bytes.equal(_b, (("O:Hello, pipe!\n" : stdgo.GoString) : stdgo.Slice<stdgo.StdGoTypes.GoByte>))) {
            _t.fatalf(("read %q from stdout pipe; want %q" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_b), stdgo.Go.toInterface(("O:Hello, pipe!\n" : stdgo.GoString)));
        };
    }
function _cmdHang(_args:haxe.Rest<stdgo.GoString>):Void {
        var _args = new stdgo.Slice<stdgo.GoString>(_args.length, 0, ..._args);
        var __tmp__ = stdgo.time.Time.parseDuration(_args[(0 : stdgo.StdGoTypes.GoInt)]?.__copy__()), _sleep:stdgo.time.Time.Duration = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            throw stdgo.Go.toInterface(_err);
        };
        var _fs = stdgo.flag.Flag.newFlagSet(("hang" : stdgo.GoString)?.__copy__(), (1 : stdgo.flag.Flag.ErrorHandling));
        var _exitOnInterrupt = _fs.bool_(("interrupt" : stdgo.GoString)?.__copy__(), false, ("if true, commands should exit 0 on os.Interrupt" : stdgo.GoString)?.__copy__());
        var _subsleep = _fs.duration(("subsleep" : stdgo.GoString)?.__copy__(), (0i64 : stdgo.time.Time.Duration), ("amount of time for the \'hang\' helper to leave an orphaned subprocess sleeping with stderr open" : stdgo.GoString)?.__copy__());
        var _probe = _fs.duration(("probe" : stdgo.GoString)?.__copy__(), (0i64 : stdgo.time.Time.Duration), ("if nonzero, the \'hang\' helper should write to stderr at this interval, and exit nonzero if a write fails" : stdgo.GoString)?.__copy__());
        var _read = _fs.bool_(("read" : stdgo.GoString)?.__copy__(), false, ("if true, the \'hang\' helper should read stdin to completion before sleeping" : stdgo.GoString)?.__copy__());
        ...
        if (_subsleep.value != ((0i64 : stdgo.time.Time.Duration))) {
            var _cmd = stdgo.os.exec.Exec.command(_exePath((null : stdgo.testing.Testing.TB))?.__copy__(), ("hang" : stdgo.GoString)?.__copy__(), (_subsleep.value.string() : stdgo.GoString)?.__copy__(), ("-read=true" : stdgo.GoString)?.__copy__(), ("-probe=" : stdgo.GoString) + (_probe.value.string() : stdgo.GoString)?.__copy__()?.__copy__());
            ...
            stdgo.fmt.Fmt.fprintf(stdgo.Go.asInterface(stdgo.os.Os.stderr), ("%d: started %d: %v\n" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_pid), stdgo.Go.toInterface(_cmd.process.pid), stdgo.Go.toInterface(stdgo.Go.asInterface(_cmd)));
        ...
        if (_exitOnInterrupt.value) {
            ...
            stdgo.Go.routine(() -> {
                var a = function():Void {
                    ...
                    stdgo.fmt.Fmt.fprintf(stdgo.Go.asInterface(stdgo.os.Os.stderr), ("%d: received %v\n" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_pid), stdgo.Go.toInterface(_sig));
                    Sys.exit((0 : stdgo.StdGoTypes.GoInt));
                };
                a();
            });
        ...
        if (_read.value) {
            ...
            while (true) {
                ...
                if ((_line.length) > (0 : stdgo.StdGoTypes.GoInt)) {
                    stdgo.fmt.Fmt.fprintf(stdgo.Go.asInterface(stdgo.os.Os.stderr), ("%d: read %s" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_pid), stdgo.Go.toInterface(_line));
                };
                if (_err != null) {
                    stdgo.fmt.Fmt.fprintf(stdgo.Go.asInterface(stdgo.os.Os.stderr), ("%d: finished read: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_pid), stdgo.Go.toInterface(_err));
                    break;
                };
            };
        };
            ...
            stdgo.Go.routine(() -> {
                var a = function():Void {
                    for (_ => _ in _ticker.c) {
                        {
                            var __tmp__ = stdgo.fmt.Fmt.fprintf(stdgo.Go.asInterface(stdgo.os.Os.stderr), ("%d: ok\n" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_pid)), __0:stdgo.StdGoTypes.GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                            if (_err != null) {
                                Sys.exit((1 : stdgo.StdGoTypes.GoInt));
                            };
                        };
        ...
        if (_sleep != ((0i64 : stdgo.time.Time.Duration))) {
            ...
            stdgo.fmt.Fmt.fprintf(stdgo.Go.asInterface(stdgo.os.Os.stderr), ("%d: slept %v\n" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_pid), stdgo.Go.toInterface(stdgo.Go.asInterface(_sleep)));
        };
    }
...
function _startHang(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>, _ctx:stdgo.context.Context.Context, _hangTime:stdgo.time.Time.Duration, _interrupt:stdgo.os.Os.Signal, _waitDelay:stdgo.time.Time.Duration, _flags:haxe.Rest<stdgo.GoString>):stdgo.StdGoTypes.Ref<stdgo.os.exec.Exec.Cmd> {
        ...
        var _cmd = _helperCommandContext(_t, _ctx, ("hang" : stdgo.GoString)?.__copy__(), ..._args.__toArray__());
        ...
        if (_buf.len() > (0 : stdgo.StdGoTypes.GoInt)) {
            _t.logf(("stdout %v:\n%s" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_cmd.args), stdgo.Go.toInterface(stdgo.Go.asInterface(_buf)));
        };
        return _cmd;
    }
function testWaitInterrupt(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        _t.parallel();
        {};
        _t.run(("Wait" : stdgo.GoString)?.__copy__(), function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
            _t.parallel();
            ...
            var _err:stdgo.Error = _cmd.wait_();
            _t.logf(("stderr:\n%s" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_cmd.stderr));
            _t.logf(("[%d] %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_cmd.process.pid), stdgo.Go.toInterface(_err));
            if (_err != null) {
                _t.errorf(("Wait: %v; want <nil>" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
            };
            {
                var _ps = _cmd.processState;
                if (!_ps.exited()) {
                    _t.errorf(("cmd did not exit: %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(stdgo.Go.asInterface(_ps)));
                } else {
                    var _code:stdgo.StdGoTypes.GoInt = _ps.exitCode();
                    if (_code != ((0 : stdgo.StdGoTypes.GoInt))) {
                        _t.errorf(("cmd.ProcessState.ExitCode() = %v; want 0" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_code));
                    };
                };
            };
        });
        _t.run(("WaitDelay" : stdgo.GoString)?.__copy__(), function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
            if (false) {
                _t.skipf(("skipping: os.Interrupt is not implemented on Windows" : stdgo.GoString)?.__copy__());
            };
            _t.parallel();
            var __tmp__ = stdgo.context.Context.withCancel(stdgo.context.Context.background()), _ctx:stdgo.context.Context.Context = __tmp__._0, _cancel:stdgo.context.Context.CancelFunc = __tmp__._1;
            var _cmd = _startHang(_t, _ctx, (600000000000i64 : stdgo.time.Time.Duration), (null : stdgo.os.Os.Signal), (600000000000i64 : stdgo.time.Time.Duration), ("-interrupt=true" : stdgo.GoString)?.__copy__());
            _cancel();
        ...
        _t.run(("SIGKILL-hang" : stdgo.GoString)?.__copy__(), function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
            _t.parallel();
            var __tmp__ = stdgo.context.Context.withCancel(stdgo.context.Context.background()), _ctx:stdgo.context.Context.Context = __tmp__._0, _cancel:stdgo.context.Context.CancelFunc = __tmp__._1;
            var _cmd = _startHang(_t, _ctx, (600000000000i64 : stdgo.time.Time.Duration), stdgo.os.Os.kill, (10000000i64 : stdgo.time.Time.Duration), ("-subsleep=10m" : stdgo.GoString)?.__copy__(), ("-probe=1ms" : stdgo.GoString)?.__copy__());
            _cancel();
            var _err:stdgo.Error = _cmd.wait_();
            _t.logf(("stderr:\n%s" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_cmd.stderr));
            _t.logf(("[%d] %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_cmd.process.pid), stdgo.Go.toInterface(_err));
            {
                ...
                if (!stdgo.errors.Errors.as(_err, stdgo.Go.toInterface(_ee))) {
                    _t.errorf(("Wait error = %v; want %T" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(stdgo.Go.asInterface((_ee : stdgo.StdGoTypes.Ref<stdgo.os.exec.Exec.ExitError>))));
                };
            };
        });
        _t.run(("Exit-hang" : stdgo.GoString)?.__copy__(), function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
            _t.parallel();
            var _cmd = _startHang(_t, stdgo.context.Context.background(), (1000000i64 : stdgo.time.Time.Duration), (null : stdgo.os.Os.Signal), (10000000i64 : stdgo.time.Time.Duration), ("-subsleep=10m" : stdgo.GoString)?.__copy__(), ("-probe=1ms" : stdgo.GoString)?.__copy__());
            var _err:stdgo.Error = _cmd.wait_();
            _t.logf(("stderr:\n%s" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_cmd.stderr));
            _t.logf(("[%d] %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_cmd.process.pid), stdgo.Go.toInterface(_err));
            if (!stdgo.errors.Errors.is_(_err, stdgo.os.exec.Exec.errWaitDelay)) {
                _t.errorf(("Wait error = %v; want %T" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(stdgo.os.exec.Exec.errWaitDelay));
            };
        });
        _t.run(("SIGINT-ignored" : stdgo.GoString)?.__copy__(), function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
            if (false) {
                _t.skipf(("skipping: os.Interrupt is not implemented on Windows" : stdgo.GoString)?.__copy__());
            };
            _t.parallel();
            var __tmp__ = stdgo.context.Context.withCancel(stdgo.context.Context.background()), _ctx:stdgo.context.Context.Context = __tmp__._0, _cancel:stdgo.context.Context.CancelFunc = __tmp__._1;
            var _cmd = _startHang(_t, _ctx, (600000000000i64 : stdgo.time.Time.Duration), stdgo.os.Os.interrupt, (10000000i64 : stdgo.time.Time.Duration), ("-interrupt=false" : stdgo.GoString)?.__copy__());
            _cancel();
            var _err:stdgo.Error = _cmd.wait_();
            _t.logf(("stderr:\n%s" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_cmd.stderr));
            _t.logf(("[%d] %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_cmd.process.pid), stdgo.Go.toInterface(_err));
        ...
        _t.run(("SIGINT-handled" : stdgo.GoString)?.__copy__(), function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
            if (false) {
                _t.skipf(("skipping: os.Interrupt is not implemented on Windows" : stdgo.GoString)?.__copy__());
            };
            _t.parallel();
            var __tmp__ = stdgo.context.Context.withCancel(stdgo.context.Context.background()), _ctx:stdgo.context.Context.Context = __tmp__._0, _cancel:stdgo.context.Context.CancelFunc = __tmp__._1;
            var _cmd = _startHang(_t, _ctx, (600000000000i64 : stdgo.time.Time.Duration), stdgo.os.Os.interrupt, (0i64 : stdgo.time.Time.Duration), ("-interrupt=true" : stdgo.GoString)?.__copy__());
            _cancel();
            var _err:stdgo.Error = _cmd.wait_();
            _t.logf(("stderr:\n%s" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_cmd.stderr));
            _t.logf(("[%d] %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_cmd.process.pid), stdgo.Go.toInterface(_err));
            if (!stdgo.errors.Errors.is_(_err, _ctx.err())) {
                _t.errorf(("Wait error = %v; want %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(_ctx.err()));
            };
            {
                var _ps = _cmd.processState;
                if (!_ps.exited()) {
        ...
        _t.run(("SIGQUIT" : stdgo.GoString)?.__copy__(), function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
            if (_quitSignal == null) {
                _t.skipf(("skipping: SIGQUIT is not supported on %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(("js" : stdgo.GoString)));
            };
            _t.parallel();
            var __tmp__ = stdgo.context.Context.withCancel(stdgo.context.Context.background()), _ctx:stdgo.context.Context.Context = __tmp__._0, _cancel:stdgo.context.Context.CancelFunc = __tmp__._1;
            ...
            };
            {
                ...
                if (!_ps.exited()) {
                    ...
                    if (_code != ((2 : stdgo.StdGoTypes.GoInt))) {
                        _t.errorf(("cmd.ProcessState.ExitCode() = %v; want 2" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_code));
                    };
                };
            };
            if (!stdgo.strings.Strings.contains(stdgo.fmt.Fmt.sprint(stdgo.Go.toInterface(_cmd.stderr))?.__copy__(), ("\n\ngoroutine " : stdgo.GoString)?.__copy__())) {
                _t.errorf(("cmd.Stderr does not contain a goroutine dump" : stdgo.GoString)?.__copy__());
            };
        });
    }
function testCancelErrors(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        _t.parallel();
        _t.run(("success after error" : stdgo.GoString)?.__copy__(), function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
            var __deferstack__:Array<Void -> Void> = [];
            try {
                _t.parallel();
                var __tmp__ = stdgo.context.Context.withCancel(stdgo.context.Context.background()), _ctx:stdgo.context.Context.Context = __tmp__._0, _cancel:stdgo.context.Context.CancelFunc = __tmp__._1;
                __deferstack__.unshift(() -> _cancel());
                var _cmd = _helperCommandContext(_t, _ctx, ("pipetest" : stdgo.GoString)?.__copy__());
                var __tmp__ = _cmd.stdinPipe(), _stdin:stdgo.io.Io.WriteCloser = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    _t.fatal(stdgo.Go.toInterface(_err));
                };
                ...
                _cmd.cancel = function():stdgo.Error {
                    _stdin.close();
                    _t.logf(("Cancel returning %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_errArbitrary));
                ...
                if (!stdgo.errors.Errors.is_(_err, _errArbitrary) || (stdgo.Go.toInterface(_err) == stdgo.Go.toInterface(_errArbitrary))) {
                    _t.errorf(("Wait error = %v; want an error wrapping %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(_errArbitrary));
                };
                for (defer in __deferstack__) {
                    defer();
                };
        ...
        _t.run(("success after ErrProcessDone" : stdgo.GoString)?.__copy__(), function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
            var __deferstack__:Array<Void -> Void> = [];
            try {
                _t.parallel();
                var __tmp__ = stdgo.context.Context.withCancel(stdgo.context.Context.background()), _ctx:stdgo.context.Context.Context = __tmp__._0, _cancel:stdgo.context.Context.CancelFunc = __tmp__._1;
                ...
                _cmd.cancel = function():stdgo.Error {
                    ...
                    return stdgo.fmt.Fmt.errorf(("%w: stdout closed" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(stdgo.os.Os.errProcessDone));
                };
                {
                    var _err:stdgo.Error = _cmd.start();
                    if (_err != null) {
                ...
                _t.logf(("[%d] %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_cmd.process.pid), stdgo.Go.toInterface(_err));
                if (_err != null) {
                    _t.errorf(("Wait error = %v; want nil" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
                };
                for (defer in __deferstack__) {
                    defer();
                };
        ...
        _t.run(("killed after error" : stdgo.GoString)?.__copy__(), function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
            var __deferstack__:Array<Void -> Void> = [];
            try {
                _t.parallel();
                var __tmp__ = stdgo.context.Context.withCancel(stdgo.context.Context.background()), _ctx:stdgo.context.Context.Context = __tmp__._0, _cancel:stdgo.context.Context.CancelFunc = __tmp__._1;
                ...
                if (!_interruptCalled.load()) {
                    _t.errorf(("Cancel was not called when the context was canceled" : stdgo.GoString)?.__copy__());
                };
                {
                    var __tmp__ = try {
                        { value : (stdgo.Go.typeAssert((stdgo.Go.toInterface(_err) : stdgo.StdGoTypes.Ref<stdgo.os.exec.Exec.ExitError>)) : stdgo.StdGoTypes.Ref<stdgo.os.exec.Exec.ExitError>), ok : true };
                    ...
                    if (!_ok) {
                        _t.errorf(("Wait error = %v; want %T" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(stdgo.Go.asInterface((_ee : stdgo.os.exec.Exec.ExitError))));
                    };
                };
                for (defer in __deferstack__) {
                    defer();
        ...
        _t.run(("killed after spurious ErrProcessDone" : stdgo.GoString)?.__copy__(), function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
            var __deferstack__:Array<Void -> Void> = [];
            try {
                _t.parallel();
                var __tmp__ = stdgo.context.Context.withCancel(stdgo.context.Context.background()), _ctx:stdgo.context.Context.Context = __tmp__._0, _cancel:stdgo.context.Context.CancelFunc = __tmp__._1;
                ...
                };
                {
                    ...
                    if (!_ok) {
                        _t.errorf(("Wait error of type %T; want %T" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err), stdgo.Go.toInterface(stdgo.Go.asInterface(_ee)));
                    };
                };
                for (defer in __deferstack__) {
                    defer();
        ...
        _t.run(("nonzero exit after error" : stdgo.GoString)?.__copy__(), function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
            var __deferstack__:Array<Void -> Void> = [];
            try {
                _t.parallel();
                var __tmp__ = stdgo.context.Context.withCancel(stdgo.context.Context.background()), _ctx:stdgo.context.Context.Context = __tmp__._0, _cancel:stdgo.context.Context.CancelFunc = __tmp__._1;
                __deferstack__.unshift(() -> _cancel());
                var _cmd = _helperCommandContext(_t, _ctx, ("stderrfail" : stdgo.GoString)?.__copy__());
                var __tmp__ = _cmd.stderrPipe(), _stderr:stdgo.io.Io.ReadCloser = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                    _t.fatal(stdgo.Go.toInterface(_err));
                };
                ...
                _t.logf(("[%d] %v" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_cmd.process.pid), stdgo.Go.toInterface(_err));
                {
                    ...
                    if (!_ok || (_ee.processState.exitCode() != (1 : stdgo.StdGoTypes.GoInt))) {
                        _t.errorf(("Wait error = %v; want exit status 1" : stdgo.GoString)?.__copy__(), stdgo.Go.toInterface(_err));
                    };
                };
                for (defer in __deferstack__) {
                    defer();
                ...
                stdgo.Go.routine(() -> {
                    var a = function():Void {
                        ...
                        try {
                            ...
                            var _cmd = _helperCommandContext(_t, _ctx, ("exit" : stdgo.GoString)?.__copy__(), ("0" : stdgo.GoString)?.__copy__());
                            _ready.done();
                            _ready.wait_();
                            {
                                var _err:stdgo.Error = _cmd.run();
...
@:keep var _ = {
        try {
            var _godebug:stdgo.GoString = stdgo.os.Os.getenv(("GODEBUG" : stdgo.GoString)?.__copy__())?.__copy__();
            if (_godebug != (stdgo.Go.str())) {
                _godebug = _godebug + (("," : stdgo.GoString))?.__copy__();
            };
            _godebug = _godebug + (("execwait=2" : stdgo.GoString))?.__copy__();
            stdgo.os.Os.setenv(("GODEBUG" : stdgo.GoString)?.__copy__(), _godebug?.__copy__());
            if (stdgo.os.Os.getenv(("GO_EXEC_TEST_PID" : stdgo.GoString)?.__copy__()) != (stdgo.Go.str())) {
                throw "__return__";
            };
            if (false) {
