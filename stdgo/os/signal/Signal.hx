...
@:structInit class T_stopping {
    ...
    public function new(?_c:Chan<stdgo.os.Os.Signal>, ?_h:Pointer<T_handler>) stdgo.internal.Macro.initLocals();
...
@:structInit class T_handler {
    ...
    public function new(?_mask:GoArray<GoUInt32>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class T_signalCtx {
    ...
    public function new(?context:stdgo.context.Context.Context, ?_cancel:stdgo.context.Context.CancelFunc, ?_signals:Slice<stdgo.os.Os.Signal>, ?_ch:Chan<stdgo.os.Os.Signal>) stdgo.internal.Macro.initLocals();
    ...
    public function value(_key:AnyInterface):AnyInterface return context.value(_0);
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit @:local class T__struct_40 {
    ...
    public var _m : GoMap<Chan<stdgo.os.Os.Signal>, Pointer<T_handler>> = new GoMap<Chan<stdgo.os.Os.Signal>, Pointer<T_handler>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.chanType(1, stdgo.reflect.Reflect.GoType.named("os.Signal", [], stdgo.reflect.Reflect.GoType.interfaceType(false, []))), stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("os/signal.handler", [], stdgo.reflect.Reflect.GoType.named("os/signal.handler", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_mask", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.arrayType(stdgo.reflect.Reflect.GoType.basic(uint32_kind), 3) }]))))))).nil();
    ...
    public function new(?mutex:stdgo.sync.Sync.Mutex, ?_m:GoMap<Chan<stdgo.os.Os.Signal>, Pointer<T_handler>>, ?_ref:GoArray<GoInt64>, ?_stopping:Slice<T_stopping>) stdgo.internal.Macro.initLocals();
    public function toString() {
        ...
        try {
            ...
            if (_h == null || _h.isNil()) {
                if (_handlers._m == null || _handlers._m.isNil()) {
                    _handlers._m = new GoMap<Chan<stdgo.os.Os.Signal>, Pointer<T_handler>>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.chanType(1, stdgo.reflect.Reflect.GoType.named("os.Signal", [], stdgo.reflect.Reflect.GoType.interfaceType(false, []))), stdgo.reflect.Reflect.GoType.pointer(stdgo.reflect.Reflect.GoType.named("os/signal.handler", [], stdgo.reflect.Reflect.GoType.named("os/signal.handler", [], stdgo.reflect.Reflect.GoType.structType([{ name : "_mask", embedded : false, tag : "", type : stdgo.reflect.Reflect.GoType.arrayType(stdgo.reflect.Reflect.GoType.basic(uint32_kind), 3) }])))))));
                };
...
**/
function notifyContext(_parent:stdgo.context.Context.Context, _signals:haxe.Rest<stdgo.os.Os.Signal>):{ var _0 : stdgo.context.Context.Context; var _1 : stdgo.context.Context.CancelFunc; } {
        var _signals = new Slice<stdgo.os.Os.Signal>(..._signals);
        var _ctx:stdgo.context.Context.Context = ((null : stdgo.context.Context.Context)), _stop:stdgo.context.Context.CancelFunc = new stdgo.context.Context.CancelFunc();
        var __tmp__ = stdgo.context.Context.withCancel(_parent), _ctx:stdgo.context.Context.Context = __tmp__._0, _cancel:stdgo.context.Context.CancelFunc = __tmp__._1;
        var _c:Pointer<T_signalCtx> = Go.pointer((({ context : _ctx, _cancel : _cancel.__copy__(), _signals : _signals, _ch : new Chan<stdgo.os.Os.Signal>(0, () -> ((null : stdgo.os.Os.Signal)), true) } : T_signalCtx)));
...
function _signal_ignored(arg0:GoUInt32):Bool throw "not implemeneted";
function _signal_recv():GoUInt32 throw "not implemeneted";
function _loop():Void {
        while (true) {
...
class T_handler_extension_fields {
    public function _want(__tmp__, _sig:GoInt):Bool return __tmp__._want(_sig);
    public function _set(__tmp__, _sig:GoInt):Void __tmp__._set(_sig);
    public function _clear(__tmp__, _sig:GoInt):Void __tmp__._clear(_sig);
}
