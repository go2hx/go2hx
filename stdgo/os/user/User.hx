...
@:structInit class User {
	...
	public function new(?uid:GoString, ?gid:GoString, ?username:GoString, ?name:GoString, ?homeDir:GoString)
...
@:structInit class Group {
	...
	public function new(?gid:GoString, ?name:GoString)
		stdgo.internal.Macro.initLocals();
...
@:named class UnknownUserIdError {
	...
	public function __copy__()
		return new UnknownUserIdError(__t__);
}
...
@:named class UnknownUserError {
	...
	public function __copy__()
		return new UnknownUserError(__t__);
}
...
@:named class UnknownGroupIdError {
	...
	public function __copy__()
		return new UnknownGroupIdError(__t__);
}
...
@:named class UnknownGroupError {
	...
	public function __copy__()
		return new UnknownGroupError(__t__);
}
...
@:structInit @:local class T__struct_43 {
	...
	public function new(?once:stdgo.sync.Sync.Once, ?_u:Pointer<User>, ?_err:stdgo.Error)
		stdgo.internal.Macro.initLocals();
...
function _current():{var _0:Pointer<User>; var _1:Error;} {
	...
	var __tmp__ = _lookupUserId(_uid),
		_u:Pointer<User> = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err == null) {
		return {_0: _u, _1: ((null : stdgo.Error))};
	};
	var __tmp__ = stdgo.os.Os.userHomeDir(),
		_homeDir:GoString = __tmp__._0,
		_:stdgo.Error = __tmp__._1;
	_u = Go.pointer((({
		uid: _uid,
		gid: _currentGID(),
		username: stdgo.os.Os.getenv("USER"),
		name: "",
		homeDir: _homeDir
	} : User)));
...
function _readColonFile(_r:stdgo.io.Io.Reader, _fn:T_lineFunc, _readCols:GoInt):{var _0:AnyInterface; var _1:Error;} {
	var _v:AnyInterface = ((null : AnyInterface)),
...
function _matchGroupIndexValue(_value:GoString, _idx:GoInt):T_lineFunc {
	...
	return new T_lineFunc(function(_line:Slice<GoByte>):{var _0:AnyInterface; var _1:Error;} {
		...
		if (_parts.length < ((4 : GoInt))
			|| _parts[((0 : GoInt))] == (("" : GoString))
			|| _parts[_idx] != _value
			|| _parts[((0 : GoInt))][((0 : GoInt))] == (("+".code : GoRune))
			|| _parts[((0 : GoInt))][((0 : GoInt))] == (("-".code : GoRune))) {
			return {_0: _v, _1: _err};
		};
		{
			var __tmp__ = stdgo.strconv.Strconv.atoi(_parts[((2 : GoInt))]),
				_:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
...
function _findGroupId(_id:GoString, _r:stdgo.io.Io.Reader):{var _0:Pointer<Group>; var _1:Error;} {
	{
		var __tmp__ = _readColonFile(_r, _matchGroupIndexValue(_id, ((2 : GoInt))).__copy__(), ((3 : GoInt))),
...
function _findGroupName(_name:GoString, _r:stdgo.io.Io.Reader):{var _0:Pointer<Group>; var _1:Error;} {
	{
		var __tmp__ = _readColonFile(_r, _matchGroupIndexValue(_name, ((0 : GoInt))).__copy__(), ((3 : GoInt))),
			_v:AnyInterface = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new Pointer<Group>().nil(), _1: _err};
...
function _matchUserIndexValue(_value:GoString, _idx:GoInt):T_lineFunc {
	...
	return new T_lineFunc(function(_line:Slice<GoByte>):{var _0:AnyInterface; var _1:Error;} {
		...
		{
			var __tmp__ = stdgo.strconv.Strconv.atoi(_parts[((3 : GoInt))]),
				_:GoInt = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (_err != null) {
				return {_0: ((null : AnyInterface)), _1: ((null : stdgo.Error))};
		...
		var _u:Pointer<User> = Go.pointer((({
			username: _parts[((0 : GoInt))],
			uid: _parts[((2 : GoInt))],
			gid: _parts[((3 : GoInt))],
			name: _parts[((4 : GoInt))],
			homeDir: _parts[((5 : GoInt))]
		} : User)));
		{
...
function _findUserId(_uid:GoString, _r:stdgo.io.Io.Reader):{var _0:Pointer<User>; var _1:Error;} {
	var __tmp__ = stdgo.strconv.Strconv.atoi(_uid),
		_i:GoInt = __tmp__._0,
	...
	{
		var __tmp__ = _readColonFile(_r, _matchUserIndexValue(_uid, ((2 : GoInt))).__copy__(), ((6 : GoInt))),
			_v:AnyInterface = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
...
function _findUsername(_name:GoString, _r:stdgo.io.Io.Reader):{var _0:Pointer<User>; var _1:Error;} {
	{
		var __tmp__ = _readColonFile(_r, _matchUserIndexValue(_name, ((0 : GoInt))).__copy__(), ((6 : GoInt))),
			_v:AnyInterface = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new Pointer<User>().nil(), _1: _err};
...
function _lookupGroup(_groupname:GoString):{var _0:Pointer<Group>; var _1:Error;} {
	...
	var __tmp__ = stdgo.os.Os.open(_groupFile),
...
function _lookupUser(_username:GoString):{var _0:Pointer<User>; var _1:Error;} {
	var recover_exception:Error = null;
	var deferstack:Array<Void->Void> = [];
	var __tmp__ = stdgo.os.Os.open(_userFile),
		_f:Pointer<stdgo.os.Os.File> = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
		return {_0: new Pointer<User>().nil(), _1: _err};
...
class User_extension_fields {
	public function groupIds(__tmp__):{var _0:Slice<GoString>; var _1:Error;}
		return __tmp__.groupIds();
}
