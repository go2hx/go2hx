...
private var _tests:Slice<stdgo.testing.Testing.InternalTest> = (new Slice<stdgo.testing.Testing.InternalTest>(0, 0,
	...
	(new stdgo.testing.Testing.InternalTest(("TestConsistentEnviron" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestEnvironConsistency" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestPathErrorUnwrap" : GoString),
		stdgo.os_test.Os_test.testPathErrorUnwrap) : stdgo.testing.Testing.InternalTest),
	...
	(new stdgo.testing.Testing.InternalTest(("TestExecutableDeleted" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestStatSymlinkLoop" : GoString),
		stdgo.os_test.Os_test.testStatSymlinkLoop) : stdgo.testing.Testing.InternalTest),
	...
	(new stdgo.testing.Testing.InternalTest(("TestFileReaddirnames" : GoString),
		stdgo.os_test.Os_test.testFileReaddirnames) : stdgo.testing.Testing.InternalTest),
	...
	(new stdgo.testing.Testing.InternalTest(("TestFileReadDir" : GoString), stdgo.os_test.Os_test.testFileReadDir) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestReaddirnamesOneAtATime" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestReaddirStatFailures" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestRenameOverwriteDest" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestRenameNotExisting" : GoString),
		stdgo.os_test.Os_test.testRenameNotExisting) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestRenameToDirFailed" : GoString),
		stdgo.os_test.Os_test.testRenameToDirFailed) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestRenameCaseDifference" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestReadAtNegativeOffset" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestWriteAtNegativeOffset" : GoString),
		stdgo.os_test.Os_test.testWriteAtNegativeOffset) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestWriteAtInAppendMode" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestStatDirWithTrailingSlash" : GoString),
		stdgo.os_test.Os_test.testStatDirWithTrailingSlash) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestNilProcessStateString" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestLargeWriteToConsole" : GoString),
		stdgo.os_test.Os_test.testLargeWriteToConsole) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestStatDirModeExec" : GoString),
		stdgo.os_test.Os_test.testStatDirModeExec) : stdgo.testing.Testing.InternalTest),
	...
	(new stdgo.testing.Testing.InternalTest(("TestStatRelativeSymlink" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestKillStartProcess" : GoString),
		stdgo.os_test.Os_test.testKillStartProcess) : stdgo.testing.Testing.InternalTest),
	...
	(new stdgo.testing.Testing.InternalTest(("TestKillFindProcess" : GoString),
		stdgo.os_test.Os_test.testKillFindProcess) : stdgo.testing.Testing.InternalTest),
	...
	(new stdgo.testing.Testing.InternalTest(("TestDoubleCloseError" : GoString),
		stdgo.os_test.Os_test.testDoubleCloseError) : stdgo.testing.Testing.InternalTest),
	...
	(new stdgo.testing.Testing.InternalTest(("TestReaddirSmallSeek" : GoString),
		stdgo.os_test.Os_test.testReaddirSmallSeek) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestOpenFileKeepsPermissions" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestDirFSPathsValid" : GoString),
		stdgo.os_test.Os_test.testDirFSPathsValid) : stdgo.testing.Testing.InternalTest),
	...
	(new stdgo.testing.Testing.InternalTest(("TestWriteStringAlloc" : GoString),
		stdgo.os_test.Os_test.testWriteStringAlloc) : stdgo.testing.Testing.InternalTest),
	...
	(new stdgo.testing.Testing.InternalTest(("TestReaddirRemoveRace" : GoString),
		stdgo.os_test.Os_test.testReaddirRemoveRace) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestMkdirStickyUmask" : GoString),
		stdgo.os_test.Os_test.testMkdirStickyUmask) : stdgo.testing.Testing.InternalTest),
	...
	(new stdgo.testing.Testing.InternalTest(("TestNewFileNonBlock" : GoString),
		stdgo.os_test.Os_test.testNewFileNonBlock) : stdgo.testing.Testing.InternalTest),
	...
	(new stdgo.testing.Testing.InternalTest(("TestMkdirAllWithSymlink" : GoString),
		stdgo.os_test.Os_test.testMkdirAllWithSymlink) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestMkdirAllAtSlash" : GoString),
		stdgo.os_test.Os_test.testMkdirAllAtSlash) : stdgo.testing.Testing.InternalTest),
	...
	(new stdgo.testing.Testing.InternalTest(("TestReadOnlyWriteFile" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestRemoveAllLongPath" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestRemoveAllDotDot" : GoString),
		stdgo.os_test.Os_test.testRemoveAllDotDot) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestRemoveReadOnlyDir" : GoString),
		stdgo.os_test.Os_test.testRemoveReadOnlyDir) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestRemoveAllButReadOnlyAndPathError" : GoString),
		stdgo.os_test.Os_test.testRemoveAllButReadOnlyAndPathError) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestRemoveUnreadableDir" : GoString),
		stdgo.os_test.Os_test.testRemoveUnreadableDir) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestRemoveAllWithMoreErrorThanReqSize" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestDirAndSymlinkStats" : GoString),
		stdgo.os_test.Os_test.testDirAndSymlinkStats) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestFileAndSymlinkStats" : GoString),
		stdgo.os_test.Os_test.testFileAndSymlinkStats) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestSymlinkWithTrailingSlash" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestCreateTempPattern" : GoString),
		stdgo.os_test.Os_test.testCreateTempPattern) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestCreateTempBadPattern" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestMkdirTempBadDir" : GoString),
		stdgo.os_test.Os_test.testMkdirTempBadDir) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestMkdirTempBadPattern" : GoString),
...
private var _benchmarks:Slice<stdgo.testing.Testing.InternalBenchmark> = (new Slice<stdgo.testing.Testing.InternalBenchmark>(0, 0,
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkExpand" : GoString),
		stdgo.os_test.Os_test.benchmarkExpand) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkReaddirname" : GoString),
		stdgo.os_test.Os_test.benchmarkReaddirname) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkReaddir" : GoString),
		stdgo.os_test.Os_test.benchmarkReaddir) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkReadDir" : GoString),
		stdgo.os_test.Os_test.benchmarkReadDir) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkStatDot" : GoString),
		stdgo.os_test.Os_test.benchmarkStatDot) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkStatFile" : GoString),
		stdgo.os_test.Os_test.benchmarkStatFile) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkStatDir" : GoString),
		stdgo.os_test.Os_test.benchmarkStatDir) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkLstatDot" : GoString),
		stdgo.os_test.Os_test.benchmarkLstatDot) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkLstatFile" : GoString),
		stdgo.os_test.Os_test.benchmarkLstatFile) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkLstatDir" : GoString),
...
private var _examples:Slice<stdgo.testing.Testing.InternalExample> = (new Slice<stdgo.testing.Testing.InternalExample>(0, 0,
	(new stdgo.testing.Testing.InternalExample(("ExampleErrNotExist" : GoString), stdgo.os_test.Os_test.exampleErrNotExist,
		("file does not exist\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleExpand" : GoString), stdgo.os_test.Os_test.exampleExpand, ("Good morning, Gopher!\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleExpandEnv" : GoString), stdgo.os_test.Os_test.exampleExpandEnv,
		("gopher lives in /usr/gopher.\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleLookupEnv" : GoString), stdgo.os_test.Os_test.exampleLookupEnv,
		("SOME_KEY=value\nEMPTY_KEY=\nMISSING_KEY not set\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleGetenv" : GoString), stdgo.os_test.Os_test.exampleGetenv,
		("gopher lives in /usr/gopher.\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleReadFile" : GoString), stdgo.os_test.Os_test.exampleReadFile, ("Hello, Gophers!\n" : GoString),
