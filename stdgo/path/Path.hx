...
/**
    /|*{
    	...
    	gotoNext = 2626977
    	_ = gotoNext == 2626977
    	if !ScanBreak && (i_2626964 < len(pattern)) {
    		gotoNext = 2627010
    		_ = gotoNext == 2627010
    		_ = 0
    		gotoNext = 2627014
    		_ = gotoNext == 2627014
    		switch pattern[i_2626964] {
    		case 92:
    			gotoNext = 2627036
    			_ = gotoNext == 2627036
    			if i_2626964+1 < len(pattern) {
    				gotoNext = 2627126
    				_ = gotoNext == 2627126
    				i_2626964++
    				gotoNext = 2627006
    	...
    	_ = gotoNext == 2627259
    	return star, pattern[0:i_2626964], pattern[i_2626964:]
    	gotoNext = -1
    }*|/
**/
class Path {
