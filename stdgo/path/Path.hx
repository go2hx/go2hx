...
/**
    /|*{
    	...
    	gotoNext = 2707425
    	_ = gotoNext == 2707425
    	if !ScanBreak && (i_2707412 < len(pattern)) {
    		gotoNext = 2707458
    		_ = gotoNext == 2707458
    		gotoNext = 2707462
    		_ = gotoNext == 2707462
    		switch pattern[i_2707412] {
    		case 92:
    			gotoNext = 2707484
    			_ = gotoNext == 2707484
    			if i_2707412+1 < len(pattern) {
    				gotoNext = 2707574
    				_ = gotoNext == 2707574
    				i_2707412++
    				gotoNext = 2707454
    	...
    	_ = gotoNext == 2707707
    	return star, pattern[0:i_2707412], pattern[i_2707412:]
    	gotoNext = -1
    }*|/
**/
class Path {
