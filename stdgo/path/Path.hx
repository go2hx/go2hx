...
/**
    /|*{
    	...
    	gotoNext = 2985951
    	_ = gotoNext == 2985951
    	if !ScanBreak && (i_2985938 < len(pattern)) {
    		gotoNext = 2985984
    		_ = gotoNext == 2985984
    		gotoNext = 2985988
    		_ = gotoNext == 2985988
    		switch pattern[i_2985938] {
    		case 92:
    			gotoNext = 2986010
    			_ = gotoNext == 2986010
    			if i_2985938+1 < len(pattern) {
    				gotoNext = 2986100
    				_ = gotoNext == 2986100
    				i_2985938++
    				gotoNext = 2985980
    	...
    	_ = gotoNext == 2986233
    	return star, pattern[0:i_2985938], pattern[i_2985938:]
    	gotoNext = -1
    }*|/
**/
class Path {
