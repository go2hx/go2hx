...
/**
    /|*{
    	...
    	gotoNext = 2567784
    	_ = gotoNext == 2567784
    	if !ScanBreak && (i_2567771 < len(pattern)) {
    		gotoNext = 2567817
    		_ = gotoNext == 2567817
    		_ = 0
    		gotoNext = 2567821
    		_ = gotoNext == 2567821
    		switch pattern[i_2567771] {
    		case 92:
    			gotoNext = 2567843
    			_ = gotoNext == 2567843
    			if i_2567771+1 < len(pattern) {
    				gotoNext = 2567933
    				_ = gotoNext == 2567933
    				i_2567771++
    				gotoNext = 2567813
    	...
    	_ = gotoNext == 2568066
    	return star, pattern[0:i_2567771], pattern[i_2567771:]
    	gotoNext = -1
    }*|/
**/
class Path {
