...
/**
    /|*{
    	...
    	gotoNext = 2538524
    	_ = gotoNext == 2538524
    	if !ScanBreak && (i_2538511 < len(pattern)) {
    		gotoNext = 2538557
    		_ = gotoNext == 2538557
    		gotoNext = 2538561
    		_ = gotoNext == 2538561
    		switch pattern[i_2538511] {
    		case 92:
    			gotoNext = 2538583
    			_ = gotoNext == 2538583
    			if i_2538511+1 < len(pattern) {
    				gotoNext = 2538673
    				_ = gotoNext == 2538673
    				i_2538511++
    				gotoNext = 2538553
    	...
    	_ = gotoNext == 2538806
    	return star, pattern[0:i_2538511], pattern[i_2538511:]
    	gotoNext = -1
    }*|/
**/
class Path {
