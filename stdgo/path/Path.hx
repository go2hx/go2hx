...
/**
    /|*{
    	...
    	gotoNext = 2557043
    	_ = gotoNext == 2557043
    	if !ScanBreak && (i_2557030 < len(pattern)) {
    		gotoNext = 2557076
    		_ = gotoNext == 2557076
    		gotoNext = 2557080
    		_ = gotoNext == 2557080
    		switch pattern[i_2557030] {
    		case 92:
    			gotoNext = 2557102
    			_ = gotoNext == 2557102
    			if i_2557030+1 < len(pattern) {
    				gotoNext = 2557192
    				_ = gotoNext == 2557192
    				i_2557030++
    				gotoNext = 2557072
    	...
    	_ = gotoNext == 2557325
    	return star, pattern[0:i_2557030], pattern[i_2557030:]
    	gotoNext = -1
    }*|/
**/
class Path {
