...
/**
    /|*{
    	...
    	gotoNext = 3004483
    	_ = gotoNext == 3004483
    	if !ScanBreak && (i_3004470 < len(pattern)) {
    		gotoNext = 3004516
    		_ = gotoNext == 3004516
    		gotoNext = 3004520
    		_ = gotoNext == 3004520
    		switch pattern[i_3004470] {
    		case 92:
    			gotoNext = 3004542
    			_ = gotoNext == 3004542
    			if i_3004470+1 < len(pattern) {
    				gotoNext = 3004632
    				_ = gotoNext == 3004632
    				i_3004470++
    				gotoNext = 3004512
    	...
    	_ = gotoNext == 3004765
    	return star, pattern[0:i_3004470], pattern[i_3004470:]
    	gotoNext = -1
    }*|/
**/
class Path {
