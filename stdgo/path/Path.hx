...
/**
    /|*{
    	...
    	gotoNext = 3023038
    	_ = gotoNext == 3023038
    	if !ScanBreak && (i_3023025 < len(pattern)) {
    		gotoNext = 3023071
    		_ = gotoNext == 3023071
    		gotoNext = 3023075
    		_ = gotoNext == 3023075
    		switch pattern[i_3023025] {
    		case 92:
    			gotoNext = 3023097
    			_ = gotoNext == 3023097
    			if i_3023025+1 < len(pattern) {
    				gotoNext = 3023187
    				_ = gotoNext == 3023187
    				i_3023025++
    				gotoNext = 3023067
    	...
    	_ = gotoNext == 3023320
    	return star, pattern[0:i_3023025], pattern[i_3023025:]
    	gotoNext = -1
    }*|/
**/
class Path {
