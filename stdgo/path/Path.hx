...
/**
    /|*{
    	...
    	gotoNext = 2891259
    	_ = gotoNext == 2891259
    	if !ScanBreak && (i_2891246 < len(pattern)) {
    		gotoNext = 2891292
    		_ = gotoNext == 2891292
    		gotoNext = 2891296
    		_ = gotoNext == 2891296
    		switch pattern[i_2891246] {
    		case 92:
    			gotoNext = 2891318
    			_ = gotoNext == 2891318
    			if i_2891246+1 < len(pattern) {
    				gotoNext = 2891408
    				_ = gotoNext == 2891408
    				i_2891246++
    				gotoNext = 2891288
    	...
    	_ = gotoNext == 2891541
    	return star, pattern[0:i_2891246], pattern[i_2891246:]
    	gotoNext = -1
    }*|/
**/
class Path {
