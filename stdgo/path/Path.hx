...
/**
    /|*{
    	...
    	gotoNext = 2773627
    	_ = gotoNext == 2773627
    	if !ScanBreak && (i_2773614 < len(pattern)) {
    		gotoNext = 2773660
    		_ = gotoNext == 2773660
    		gotoNext = 2773664
    		_ = gotoNext == 2773664
    		switch pattern[i_2773614] {
    		case 92:
    			gotoNext = 2773686
    			_ = gotoNext == 2773686
    			if i_2773614+1 < len(pattern) {
    				gotoNext = 2773776
    				_ = gotoNext == 2773776
    				i_2773614++
    				gotoNext = 2773656
    	...
    	_ = gotoNext == 2773909
    	return star, pattern[0:i_2773614], pattern[i_2773614:]
    	gotoNext = -1
    }*|/
**/
class Path {
