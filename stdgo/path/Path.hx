...
/**
    /|*{
    	...
    	gotoNext = 2597028
    	_ = gotoNext == 2597028
    	if !ScanBreak && (i_2597015 < len(pattern)) {
    		gotoNext = 2597061
    		_ = gotoNext == 2597061
    		_ = 0
    		gotoNext = 2597065
    		_ = gotoNext == 2597065
    		switch pattern[i_2597015] {
    		case 92:
    			gotoNext = 2597087
    			_ = gotoNext == 2597087
    			if i_2597015+1 < len(pattern) {
    				gotoNext = 2597177
    				_ = gotoNext == 2597177
    				i_2597015++
    				gotoNext = 2597057
    	...
    	_ = gotoNext == 2597310
    	return star, pattern[0:i_2597015], pattern[i_2597015:]
    	gotoNext = -1
    }*|/
**/
class Path {
