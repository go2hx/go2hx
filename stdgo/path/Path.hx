...
/**
    /|*{
    	...
    	gotoNext = 2770986
    	_ = gotoNext == 2770986
    	if !ScanBreak && (i_2770973 < len(pattern)) {
    		gotoNext = 2771019
    		_ = gotoNext == 2771019
    		_ = 0
    		gotoNext = 2771023
    		_ = gotoNext == 2771023
    		switch pattern[i_2770973] {
    		case 92:
    			gotoNext = 2771045
    			_ = gotoNext == 2771045
    			if i_2770973+1 < len(pattern) {
    				gotoNext = 2771135
    				_ = gotoNext == 2771135
    				i_2770973++
    				gotoNext = 2771015
    	...
    	_ = gotoNext == 2771268
    	return star, pattern[0:i_2770973], pattern[i_2770973:]
    	gotoNext = -1
    }*|/
**/
class Path {
