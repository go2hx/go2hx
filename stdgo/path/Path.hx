...
@:structInit class T_lazybuf {
    ...
    public function new(?_s:GoString, ?_buf:Slice<GoUInt8>, ?_w:GoInt) stdgo.internal.Macro.initLocals();
        ...
        return stdgo.internal.Macro.controlFlow({
            ...
            @:label("Pattern") while (_pattern.length > ((0 : GoInt))) {
                ...
                while (_pattern.length > ((0 : GoInt))) {
                    ...
                    {
                        var __tmp__ = _matchChunk(_chunk, ""), _:GoString = __tmp__._0, _:Bool = __tmp__._1, _err:stdgo.Error = __tmp__._2;
                        if (_err != null) {
                            return { _0 : false, _1 : _err };
                        };
                    };
                ...
                while (true) {
                    if (__switchIndex__ == 0 || (__switchIndex__ == -1 && _chunk[((0 : GoInt))] == (("[".code : GoRune)))) {
                        ...
                        if (!_failed) {
                            ...
                            var __tmp__ = unicode.utf8.Utf8.decodeRuneInString(_s), _:GoInt32 = __tmp__._0, _n:GoInt = __tmp__._1;
                            _s = _s.__slice__(_n);
                        };
                        _chunk = _chunk.__slice__(((1 : GoInt)));
                        break;
...
function _getEsc(_chunk:GoString):{ var _0 : GoRune; var _1 : GoString; var _2 : Error; } {
        ...
        if (_chunk.length == ((0 : GoInt)) || _chunk[((0 : GoInt))] == (("-".code : GoRune)) || _chunk[((0 : GoInt))] == (("]".code : GoRune))) {
            _err = errBadPattern;
        ...
        var __tmp__ = unicode.utf8.Utf8.decodeRuneInString(_chunk), _r:GoInt32 = __tmp__._0, _n:GoInt = __tmp__._1;
...
function clean(_path:GoString):GoString {
        ...
        while (_r < _n) {
            if (_path[_r] == (("/".code : GoRune))) {
                _r++;
            } else if (_path[_r] == ((".".code : GoRune)) && (_r + ((1 : GoInt)) == _n || _path[_r + ((1 : GoInt))] == (("/".code : GoRune)))) {
                _r++;
            } else if (_path[_r] == ((".".code : GoRune)) && _path[_r + ((1 : GoInt))] == ((".".code : GoRune)) && (_r + ((2 : GoInt)) == _n || _path[_r + ((2 : GoInt))] == (("/".code : GoRune)))) {
                _r = _r + (((2 : GoInt)));
                if (_out._w > _dotdot) {
                    _out._w--;
...
function join(_elem:haxe.Rest<GoString>):GoString {
        ...
        var _buf:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0 ... ((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((_size + _elem.length - ((1 : GoInt)) : GoInt)).toBasic());
        for (_e in _elem) {
...
function dir(_path:GoString):GoString {
        var __tmp__ = split(_path), _dir:GoString = __tmp__._0, _:GoString = __tmp__._1;
        return clean(_dir);
    }
