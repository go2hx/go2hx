...
/**
    /|*{
    	...
    	gotoNext = 2618494
    	_ = gotoNext == 2618494
    	if !ScanBreak && (i_2618481 < len(pattern)) {
    		gotoNext = 2618527
    		_ = gotoNext == 2618527
    		gotoNext = 2618531
    		_ = gotoNext == 2618531
    		switch pattern[i_2618481] {
    		case 92:
    			gotoNext = 2618553
    			_ = gotoNext == 2618553
    			if i_2618481+1 < len(pattern) {
    				gotoNext = 2618643
    				_ = gotoNext == 2618643
    				i_2618481++
    				gotoNext = 2618523
    	...
    	_ = gotoNext == 2618776
    	return star, pattern[0:i_2618481], pattern[i_2618481:]
    	gotoNext = -1
    }*|/
**/
class Path {
