...
/**
    /|*{
    	...
    	gotoNext = 2811072
    	_ = gotoNext == 2811072
    	if !ScanBreak && (i_2811059 < len(pattern)) {
    		gotoNext = 2811105
    		_ = gotoNext == 2811105
    		_ = 0
    		gotoNext = 2811109
    		_ = gotoNext == 2811109
    		switch pattern[i_2811059] {
    		case 92:
    			gotoNext = 2811131
    			_ = gotoNext == 2811131
    			if i_2811059+1 < len(pattern) {
    				gotoNext = 2811221
    				_ = gotoNext == 2811221
    				i_2811059++
    				gotoNext = 2811101
    	...
    	_ = gotoNext == 2811354
    	return star, pattern[0:i_2811059], pattern[i_2811059:]
    	gotoNext = -1
    }*|/
**/
class Path {
