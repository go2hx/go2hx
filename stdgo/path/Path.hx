...
/**
    /|*{
    	...
    	gotoNext = 2602475
    	_ = gotoNext == 2602475
    	if !ScanBreak && (i_2602462 < len(pattern)) {
    		gotoNext = 2602508
    		_ = gotoNext == 2602508
    		gotoNext = 2602512
    		_ = gotoNext == 2602512
    		switch pattern[i_2602462] {
    		case 92:
    			gotoNext = 2602534
    			_ = gotoNext == 2602534
    			if i_2602462+1 < len(pattern) {
    				gotoNext = 2602624
    				_ = gotoNext == 2602624
    				i_2602462++
    				gotoNext = 2602504
    	...
    	_ = gotoNext == 2602757
    	return star, pattern[0:i_2602462], pattern[i_2602462:]
    	gotoNext = -1
    }*|/
**/
class Path {
