...
/**
    /|*{
    	...
    	gotoNext = 2672643
    	_ = gotoNext == 2672643
    	if !ScanBreak && (i_2672630 < len(pattern)) {
    		gotoNext = 2672676
    		_ = gotoNext == 2672676
    		gotoNext = 2672680
    		_ = gotoNext == 2672680
    		switch pattern[i_2672630] {
    		case 92:
    			gotoNext = 2672702
    			_ = gotoNext == 2672702
    			if i_2672630+1 < len(pattern) {
    				gotoNext = 2672792
    				_ = gotoNext == 2672792
    				i_2672630++
    				gotoNext = 2672672
    	...
    	_ = gotoNext == 2672925
    	return star, pattern[0:i_2672630], pattern[i_2672630:]
    	gotoNext = -1
    }*|/
**/
class Path {
