...
/**
    /|*{
    	...
    	gotoNext = 2974779
    	_ = gotoNext == 2974779
    	if !ScanBreak && (i_2974766 < len(pattern)) {
    		gotoNext = 2974812
    		_ = gotoNext == 2974812
    		gotoNext = 2974816
    		_ = gotoNext == 2974816
    		switch pattern[i_2974766] {
    		case 92:
    			gotoNext = 2974838
    			_ = gotoNext == 2974838
    			if i_2974766+1 < len(pattern) {
    				gotoNext = 2974928
    				_ = gotoNext == 2974928
    				i_2974766++
    				gotoNext = 2974808
    	...
    	_ = gotoNext == 2975061
    	return star, pattern[0:i_2974766], pattern[i_2974766:]
    	gotoNext = -1
    }*|/
**/
class Path {
