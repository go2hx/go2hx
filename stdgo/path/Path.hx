...
/**
    /|*{
    	...
    	gotoNext = 2829914
    	_ = gotoNext == 2829914
    	if !ScanBreak && (i_2829901 < len(pattern)) {
    		gotoNext = 2829947
    		_ = gotoNext == 2829947
    		_ = 0
    		gotoNext = 2829951
    		_ = gotoNext == 2829951
    		switch pattern[i_2829901] {
    		case 92:
    			gotoNext = 2829973
    			_ = gotoNext == 2829973
    			if i_2829901+1 < len(pattern) {
    				gotoNext = 2830063
    				_ = gotoNext == 2830063
    				i_2829901++
    				gotoNext = 2829943
    	...
    	_ = gotoNext == 2830196
    	return star, pattern[0:i_2829901], pattern[i_2829901:]
    	gotoNext = -1
    }*|/
**/
class Path {
