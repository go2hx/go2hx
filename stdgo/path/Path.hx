...
/**
    /|*{
    	...
    	gotoNext = 2669240
    	_ = gotoNext == 2669240
    	if !ScanBreak && (i_2669227 < len(pattern)) {
    		gotoNext = 2669273
    		_ = gotoNext == 2669273
    		gotoNext = 2669277
    		_ = gotoNext == 2669277
    		switch pattern[i_2669227] {
    		case 92:
    			gotoNext = 2669299
    			_ = gotoNext == 2669299
    			if i_2669227+1 < len(pattern) {
    				gotoNext = 2669389
    				_ = gotoNext == 2669389
    				i_2669227++
    				gotoNext = 2669269
    	...
    	_ = gotoNext == 2669522
    	return star, pattern[0:i_2669227], pattern[i_2669227:]
    	gotoNext = -1
    }*|/
**/
class Path {
