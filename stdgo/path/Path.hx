...
/**
    /|*{
    	...
    	gotoNext = 2599158
    	_ = gotoNext == 2599158
    	if !ScanBreak && (i_2599145 < len(pattern)) {
    		gotoNext = 2599191
    		_ = gotoNext == 2599191
    		gotoNext = 2599195
    		_ = gotoNext == 2599195
    		switch pattern[i_2599145] {
    		case 92:
    			gotoNext = 2599217
    			_ = gotoNext == 2599217
    			if i_2599145+1 < len(pattern) {
    				gotoNext = 2599307
    				_ = gotoNext == 2599307
    				i_2599145++
    				gotoNext = 2599187
    	...
    	_ = gotoNext == 2599440
    	return star, pattern[0:i_2599145], pattern[i_2599145:]
    	gotoNext = -1
    }*|/
**/
class Path {
