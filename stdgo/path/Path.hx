...
/**
    /|*{
    	...
    	gotoNext = 2855816
    	_ = gotoNext == 2855816
    	if !ScanBreak && (i_2855803 < len(pattern)) {
    		gotoNext = 2855849
    		_ = gotoNext == 2855849
    		gotoNext = 2855853
    		_ = gotoNext == 2855853
    		switch pattern[i_2855803] {
    		case 92:
    			gotoNext = 2855875
    			_ = gotoNext == 2855875
    			if i_2855803+1 < len(pattern) {
    				gotoNext = 2855965
    				_ = gotoNext == 2855965
    				i_2855803++
    				gotoNext = 2855845
    	...
    	_ = gotoNext == 2856098
    	return star, pattern[0:i_2855803], pattern[i_2855803:]
    	gotoNext = -1
    }*|/
**/
class Path {
