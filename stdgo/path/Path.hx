...
@:structInit @:private @:using(stdgo.path.Path.T_lazybuf_static_extension) abstract T_lazybuf(stdgo._internal.path.Path.T_lazybuf) from stdgo._internal.path.Path.T_lazybuf to stdgo._internal.path.Path.T_lazybuf {
