...
/**
    /|*{
    	...
    	gotoNext = 2631786
    	_ = gotoNext == 2631786
    	if !ScanBreak && (i_2631773 < len(pattern)) {
    		gotoNext = 2631819
    		_ = gotoNext == 2631819
    		gotoNext = 2631823
    		_ = gotoNext == 2631823
    		switch pattern[i_2631773] {
    		case 92:
    			gotoNext = 2631845
    			_ = gotoNext == 2631845
    			if i_2631773+1 < len(pattern) {
    				gotoNext = 2631935
    				_ = gotoNext == 2631935
    				i_2631773++
    				gotoNext = 2631815
    	...
    	_ = gotoNext == 2632068
    	return star, pattern[0:i_2631773], pattern[i_2631773:]
    	gotoNext = -1
    }*|/
**/
class Path {
