...
/**
    /|*{
    	...
    	gotoNext = 2580155
    	_ = gotoNext == 2580155
    	if !ScanBreak && (i_2580142 < len(pattern)) {
    		gotoNext = 2580188
    		_ = gotoNext == 2580188
    		gotoNext = 2580192
    		_ = gotoNext == 2580192
    		switch pattern[i_2580142] {
    		case 92:
    			gotoNext = 2580214
    			_ = gotoNext == 2580214
    			if i_2580142+1 < len(pattern) {
    				gotoNext = 2580304
    				_ = gotoNext == 2580304
    				i_2580142++
    				gotoNext = 2580184
    	...
    	_ = gotoNext == 2580437
    	return star, pattern[0:i_2580142], pattern[i_2580142:]
    	gotoNext = -1
    }*|/
**/
class Path {
