...
/**
    /|*{
    	...
    	gotoNext = 2556900
    	_ = gotoNext == 2556900
    	if !ScanBreak && (i_2556887 < len(pattern)) {
    		gotoNext = 2556933
    		_ = gotoNext == 2556933
    		gotoNext = 2556937
    		_ = gotoNext == 2556937
    		switch pattern[i_2556887] {
    		case 92:
    			gotoNext = 2556959
    			_ = gotoNext == 2556959
    			if i_2556887+1 < len(pattern) {
    				gotoNext = 2557049
    				_ = gotoNext == 2557049
    				i_2556887++
    				gotoNext = 2556929
    	...
    	_ = gotoNext == 2557182
    	return star, pattern[0:i_2556887], pattern[i_2556887:]
    	gotoNext = -1
    }*|/
**/
class Path {
