...
/**
    /|*{
    	...
    	gotoNext = 2892587
    	_ = gotoNext == 2892587
    	if !ScanBreak && (i_2892574 < len(pattern)) {
    		gotoNext = 2892620
    		_ = gotoNext == 2892620
    		gotoNext = 2892624
    		_ = gotoNext == 2892624
    		switch pattern[i_2892574] {
    		case 92:
    			gotoNext = 2892646
    			_ = gotoNext == 2892646
    			if i_2892574+1 < len(pattern) {
    				gotoNext = 2892736
    				_ = gotoNext == 2892736
    				i_2892574++
    				gotoNext = 2892616
    	...
    	_ = gotoNext == 2892869
    	return star, pattern[0:i_2892574], pattern[i_2892574:]
    	gotoNext = -1
    }*|/
**/
class Path {
