...
/**
    /|*{
    	...
    	gotoNext = 2669218
    	_ = gotoNext == 2669218
    	if !ScanBreak && (i_2669205 < len(pattern)) {
    		gotoNext = 2669251
    		_ = gotoNext == 2669251
    		gotoNext = 2669255
    		_ = gotoNext == 2669255
    		switch pattern[i_2669205] {
    		case 92:
    			gotoNext = 2669277
    			_ = gotoNext == 2669277
    			if i_2669205+1 < len(pattern) {
    				gotoNext = 2669367
    				_ = gotoNext == 2669367
    				i_2669205++
    				gotoNext = 2669247
    	...
    	_ = gotoNext == 2669500
    	return star, pattern[0:i_2669205], pattern[i_2669205:]
    	gotoNext = -1
    }*|/
**/
class Path {
