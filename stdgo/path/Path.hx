...
/**
    /|*{
    	...
    	gotoNext = 2780121
    	_ = gotoNext == 2780121
    	if !ScanBreak && (i_2780108 < len(pattern)) {
    		gotoNext = 2780154
    		_ = gotoNext == 2780154
    		gotoNext = 2780158
    		_ = gotoNext == 2780158
    		switch pattern[i_2780108] {
    		case 92:
    			gotoNext = 2780180
    			_ = gotoNext == 2780180
    			if i_2780108+1 < len(pattern) {
    				gotoNext = 2780270
    				_ = gotoNext == 2780270
    				i_2780108++
    				gotoNext = 2780150
    	...
    	_ = gotoNext == 2780403
    	return star, pattern[0:i_2780108], pattern[i_2780108:]
    	gotoNext = -1
    }*|/
**/
class Path {
