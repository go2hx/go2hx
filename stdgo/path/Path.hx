...
/**
    /|*{
    	...
    	gotoNext = 2643325
    	_ = gotoNext == 2643325
    	if !ScanBreak && (i_2643312 < len(pattern)) {
    		gotoNext = 2643358
    		_ = gotoNext == 2643358
    		gotoNext = 2643362
    		_ = gotoNext == 2643362
    		switch pattern[i_2643312] {
    		case 92:
    			gotoNext = 2643384
    			_ = gotoNext == 2643384
    			if i_2643312+1 < len(pattern) {
    				gotoNext = 2643474
    				_ = gotoNext == 2643474
    				i_2643312++
    				gotoNext = 2643354
    	...
    	_ = gotoNext == 2643607
    	return star, pattern[0:i_2643312], pattern[i_2643312:]
    	gotoNext = -1
    }*|/
**/
class Path {
