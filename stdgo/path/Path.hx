...
/**
    /|*{
    	...
    	gotoNext = 2696364
    	_ = gotoNext == 2696364
    	if !ScanBreak && (i_2696351 < len(pattern)) {
    		gotoNext = 2696397
    		_ = gotoNext == 2696397
    		gotoNext = 2696401
    		_ = gotoNext == 2696401
    		switch pattern[i_2696351] {
    		case 92:
    			gotoNext = 2696423
    			_ = gotoNext == 2696423
    			if i_2696351+1 < len(pattern) {
    				gotoNext = 2696513
    				_ = gotoNext == 2696513
    				i_2696351++
    				gotoNext = 2696393
    	...
    	_ = gotoNext == 2696646
    	return star, pattern[0:i_2696351], pattern[i_2696351:]
    	gotoNext = -1
    }*|/
**/
class Path {
