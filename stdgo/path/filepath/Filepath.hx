...
/**
    /|*{
    	...
    	gotoNext = 4096252
    	_ = gotoNext == 4096252
    	if !ScanBreak && (i_4096239 < len(pattern)) {
    		gotoNext = 4096285
    		_ = gotoNext == 4096285
    		gotoNext = 4096289
    		_ = gotoNext == 4096289
    		switch pattern[i_4096239] {
    		case 92:
    			gotoNext = 4096311
    			_ = gotoNext == 4096311
    			if true {
    	...
    	_ = gotoNext == 4096577
    	return star, pattern[0:i_4096239], pattern[i_4096239:]
    	gotoNext = -1
    }*|/
**/
class Filepath {
