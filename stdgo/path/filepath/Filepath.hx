...
/**
    /|*{
    	...
    	gotoNext = 4099392
    	_ = gotoNext == 4099392
    	if !ScanBreak && (i_4099379 < len(pattern)) {
    		gotoNext = 4099425
    		_ = gotoNext == 4099425
    		_ = 0
    		gotoNext = 4099429
    		_ = gotoNext == 4099429
    		switch pattern[i_4099379] {
    		case 92:
    			gotoNext = 4099451
    			_ = gotoNext == 4099451
    			if true {
    	...
    	_ = gotoNext == 4099717
    	return star, pattern[0:i_4099379], pattern[i_4099379:]
    	gotoNext = -1
    }*|/
**/
class Filepath {
