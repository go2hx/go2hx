...
/**
    /|*{
    	...
    	gotoNext = 3869587
    	_ = gotoNext == 3869587
    	if !ScanBreak && (i_3869574 < len(pattern)) {
    		gotoNext = 3869620
    		_ = gotoNext == 3869620
    		_ = 0
    		gotoNext = 3869624
    		_ = gotoNext == 3869624
    		switch pattern[i_3869574] {
    		case 92:
    			gotoNext = 3869646
    			_ = gotoNext == 3869646
    			if true {
    	...
    	_ = gotoNext == 3869912
    	return star, pattern[0:i_3869574], pattern[i_3869574:]
    	gotoNext = -1
    }*|/
**/
class Filepath {
