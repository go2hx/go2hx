...
/**
    /|*{
    	...
    	gotoNext = 3974728
    	_ = gotoNext == 3974728
    	if !ScanBreak && (i_3974715 < len(pattern)) {
    		gotoNext = 3974761
    		_ = gotoNext == 3974761
    		gotoNext = 3974765
    		_ = gotoNext == 3974765
    		switch pattern[i_3974715] {
    		case 92:
    			gotoNext = 3974787
    			_ = gotoNext == 3974787
    			if true {
    	...
    	_ = gotoNext == 3975053
    	return star, pattern[0:i_3974715], pattern[i_3974715:]
    	gotoNext = -1
    }*|/
**/
class Filepath {
