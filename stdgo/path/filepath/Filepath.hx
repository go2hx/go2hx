...
/**
    /|*{
    	...
    	gotoNext = 4055693
    	_ = gotoNext == 4055693
    	if !ScanBreak && (i_4055680 < len(pattern)) {
    		gotoNext = 4055726
    		_ = gotoNext == 4055726
    		gotoNext = 4055730
    		_ = gotoNext == 4055730
    		switch pattern[i_4055680] {
    		case 92:
    			gotoNext = 4055752
    			_ = gotoNext == 4055752
    			if true {
    	...
    	_ = gotoNext == 4056018
    	return star, pattern[0:i_4055680], pattern[i_4055680:]
    	gotoNext = -1
    }*|/
**/
class Filepath {
