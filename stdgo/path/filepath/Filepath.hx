...
/**
    /|*{
    	...
    	gotoNext = 4068349
    	_ = gotoNext == 4068349
    	if !ScanBreak && (i_4068336 < len(pattern)) {
    		gotoNext = 4068382
    		_ = gotoNext == 4068382
    		_ = 0
    		gotoNext = 4068386
    		_ = gotoNext == 4068386
    		switch pattern[i_4068336] {
    		case 92:
    			gotoNext = 4068408
    			_ = gotoNext == 4068408
    			if true {
    	...
    	_ = gotoNext == 4068674
    	return star, pattern[0:i_4068336], pattern[i_4068336:]
    	gotoNext = -1
    }*|/
**/
class Filepath {
