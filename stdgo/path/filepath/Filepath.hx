...
/**
    /|*{
    	...
    	gotoNext = 3989528
    	_ = gotoNext == 3989528
    	if !ScanBreak && (i_3989515 < len(pattern)) {
    		gotoNext = 3989561
    		_ = gotoNext == 3989561
    		gotoNext = 3989565
    		_ = gotoNext == 3989565
    		switch pattern[i_3989515] {
    		case 92:
    			gotoNext = 3989587
    			_ = gotoNext == 3989587
    			if true {
    	...
    	_ = gotoNext == 3989853
    	return star, pattern[0:i_3989515], pattern[i_3989515:]
    	gotoNext = -1
    }*|/
**/
class Filepath {
