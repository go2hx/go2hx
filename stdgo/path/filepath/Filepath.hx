...
/**
    /|*{
    	...
    	gotoNext = 4032442
    	_ = gotoNext == 4032442
    	if !ScanBreak && (i_4032429 < len(pattern)) {
    		gotoNext = 4032475
    		_ = gotoNext == 4032475
    		gotoNext = 4032479
    		_ = gotoNext == 4032479
    		switch pattern[i_4032429] {
    		case 92:
    			gotoNext = 4032501
    			_ = gotoNext == 4032501
    			if true {
    	...
    	_ = gotoNext == 4032767
    	return star, pattern[0:i_4032429], pattern[i_4032429:]
    	gotoNext = -1
    }*|/
**/
class Filepath {
