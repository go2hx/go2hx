...
/**
    /|*{
    	...
    	gotoNext = 3974515
    	_ = gotoNext == 3974515
    	if !ScanBreak && (i_3974502 < len(pattern)) {
    		gotoNext = 3974548
    		_ = gotoNext == 3974548
    		gotoNext = 3974552
    		_ = gotoNext == 3974552
    		switch pattern[i_3974502] {
    		case 92:
    			gotoNext = 3974574
    			_ = gotoNext == 3974574
    			if true {
    	...
    	_ = gotoNext == 3974840
    	return star, pattern[0:i_3974502], pattern[i_3974502:]
    	gotoNext = -1
    }*|/
**/
class Filepath {
