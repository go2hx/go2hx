...
/**
    /|*{
    	...
    	gotoNext = 4047000
    	_ = gotoNext == 4047000
    	if !ScanBreak && (i_4046987 < len(pattern)) {
    		gotoNext = 4047033
    		_ = gotoNext == 4047033
    		gotoNext = 4047037
    		_ = gotoNext == 4047037
    		switch pattern[i_4046987] {
    		case 92:
    			gotoNext = 4047059
    			_ = gotoNext == 4047059
    			if true {
    	...
    	_ = gotoNext == 4047325
    	return star, pattern[0:i_4046987], pattern[i_4046987:]
    	gotoNext = -1
    }*|/
**/
class Filepath {
