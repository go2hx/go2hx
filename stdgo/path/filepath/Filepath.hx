...
/**
    /|*{
    	...
    	gotoNext = 4040955
    	_ = gotoNext == 4040955
    	if !ScanBreak && (i_4040942 < len(pattern)) {
    		gotoNext = 4040988
    		_ = gotoNext == 4040988
    		gotoNext = 4040992
    		_ = gotoNext == 4040992
    		switch pattern[i_4040942] {
    		case 92:
    			gotoNext = 4041014
    			_ = gotoNext == 4041014
    			if true {
    	...
    	_ = gotoNext == 4041280
    	return star, pattern[0:i_4040942], pattern[i_4040942:]
    	gotoNext = -1
    }*|/
**/
class Filepath {
