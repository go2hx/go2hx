...
/**
    /|*{
    	...
    	gotoNext = 3981783
    	_ = gotoNext == 3981783
    	if !ScanBreak && (i_3981770 < len(pattern)) {
    		gotoNext = 3981816
    		_ = gotoNext == 3981816
    		_ = 0
    		gotoNext = 3981820
    		_ = gotoNext == 3981820
    		switch pattern[i_3981770] {
    		case 92:
    			gotoNext = 3981842
    			_ = gotoNext == 3981842
    			if true {
    	...
    	_ = gotoNext == 3982108
    	return star, pattern[0:i_3981770], pattern[i_3981770:]
    	gotoNext = -1
    }*|/
**/
class Filepath {
