...
/**
    /|*{
    	...
    	gotoNext = 4024268
    	_ = gotoNext == 4024268
    	if !ScanBreak && (i_4024255 < len(pattern)) {
    		gotoNext = 4024301
    		_ = gotoNext == 4024301
    		gotoNext = 4024305
    		_ = gotoNext == 4024305
    		switch pattern[i_4024255] {
    		case 92:
    			gotoNext = 4024327
    			_ = gotoNext == 4024327
    			if true {
    	...
    	_ = gotoNext == 4024593
    	return star, pattern[0:i_4024255], pattern[i_4024255:]
    	gotoNext = -1
    }*|/
**/
class Filepath {
