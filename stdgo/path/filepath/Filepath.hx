        ...
        stdgo.internal.Macro.controlFlow({
            ...
            @:label("Pattern") while ((_pattern.length) > (0 : stdgo.GoInt)) {
                ...
                if (_star && (_chunk == stdgo.Go.str())) {
                    return { _0 : !stdgo.strings.Strings.contains(_name?.__copy__(), ((47 : stdgo.GoInt32) : stdgo.GoString)), _1 : (null : stdgo.Error) };
                };
                ...
                if (_ok && ((_t.length == (0 : stdgo.GoInt)) || (_pattern.length > (0 : stdgo.GoInt)))) {
                    _name = _t?.__copy__();
                    continue;
                };
                if (_err != null) {
                ...
                if (_star) {
                    {
                        ...
                        stdgo.Go.cfor((_i < _name.length) && (_name[(_i : stdgo.GoInt)] != (47 : stdgo.GoUInt8)), _i++, {
                            var __tmp__ = _matchChunk(_chunk?.__copy__(), (_name.__slice__(_i + (1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__()), _t:stdgo.GoString = __tmp__._0, _ok:Bool = __tmp__._1, _err:stdgo.Error = __tmp__._2;
                            if (_ok) {
                                if ((_pattern.length == (0 : stdgo.GoInt)) && (_t.length > (0 : stdgo.GoInt))) {
                                    continue;
                                };
                                _name = _t?.__copy__();
...
function _scanChunk(_pattern:stdgo.GoString):{ var _0 : Bool; var _1 : stdgo.GoString; var _2 : stdgo.GoString; } {
        stdgo.internal.Macro.controlFlow({
            ...
            while ((_pattern.length > (0 : stdgo.GoInt)) && (_pattern[(0 : stdgo.GoInt)] == (42 : stdgo.GoUInt8))) {
                        ...
                        while (__run__) {
                            __run__ = false;
                            {
                                ...
                                if (__value__ == ((92 : stdgo.GoUInt8))) {
                                    if (true) {
                                        if ((_i + (1 : stdgo.GoInt)) < (_pattern.length)) {
                                            _i++;
                                        };
                                    };
                                    break;
...
function _matchChunk(_chunk:stdgo.GoString, _s:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : Bool; var _2 : stdgo.Error; } {
        ...
        while ((_chunk.length) > (0 : stdgo.GoInt)) {
            if (!_failed && (_s.length == (0 : stdgo.GoInt))) {
                _failed = true;
            };
            {
                var __switchIndex__ = -1;
                ...
                while (__run__) {
                    __run__ = false;
                    {
                        ...
                        if (__switchIndex__ == 0 || (__switchIndex__ == -1 && (__value__ == (91 : stdgo.GoUInt8)))) {
                            ...
                            if ((_chunk.length > (0 : stdgo.GoInt)) && (_chunk[(0 : stdgo.GoInt)] == (94 : stdgo.GoUInt8))) {
                                _negated = true;
                                _chunk = (_chunk.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                            };
                            var _match:Bool = false;
                            var _nrange:stdgo.GoInt = (0 : stdgo.GoInt);
                            while (true) {
                                if (((_chunk.length > (0 : stdgo.GoInt)) && (_chunk[(0 : stdgo.GoInt)] == (93 : stdgo.GoUInt8))) && (_nrange > (0 : stdgo.GoInt))) {
                                    _chunk = (_chunk.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                                    break;
                                };
                            ...
                            if (!_failed) {
                                ...
                                var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRuneInString(_s?.__copy__()), __0:stdgo.GoInt32 = __tmp__._0, _n:stdgo.GoInt = __tmp__._1;
                                _s = (_s.__slice__(_n) : stdgo.GoString)?.__copy__();
                            };
                            _chunk = (_chunk.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
                            break;
...
function _getEsc(_chunk:stdgo.GoString):{ var _0 : stdgo.GoRune; var _1 : stdgo.GoString; var _2 : stdgo.Error; } {
        var _r:stdgo.GoRune = (0 : stdgo.GoInt32), _nchunk:stdgo.GoString = ("" : stdgo.GoString), _err:stdgo.Error = (null : stdgo.Error);
        if (((_chunk.length == (0 : stdgo.GoInt)) || (_chunk[(0 : stdgo.GoInt)] == (45 : stdgo.GoUInt8))) || (_chunk[(0 : stdgo.GoInt)] == (93 : stdgo.GoUInt8))) {
            _err = errBadPattern;
            return { _0 : _r, _1 : _nchunk, _2 : _err };
        };
        if ((_chunk[(0 : stdgo.GoInt)] == (92 : stdgo.GoUInt8)) && true) {
            _chunk = (_chunk.__slice__((1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
            if ((_chunk.length) == ((0 : stdgo.GoInt))) {
                _err = errBadPattern;
                return { _0 : _r, _1 : _nchunk, _2 : _err };
        ...
        var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRuneInString(_chunk?.__copy__()), _r:stdgo.GoInt32 = __tmp__._0, _n:stdgo.GoInt = __tmp__._1;
        if ((_r == (65533 : stdgo.GoInt32)) && (_n == (1 : stdgo.GoInt))) {
            _err = errBadPattern;
        };
...
function _globWithLimit(_pattern:stdgo.GoString, _depth:stdgo.GoInt):{ var _0 : stdgo.Slice<stdgo.GoString>; var _1 : stdgo.Error; } {
        ...
        {
            var __tmp__ = _globWithLimit(_dir?.__copy__(), _depth + (1 : stdgo.GoInt));
            _m = __tmp__._0;
            _err = __tmp__._1;
        };
        if (_err != null) {
...
function _cleanGlobPathWindows(_path:stdgo.GoString):{ var _0 : stdgo.GoInt; var _1 : stdgo.GoString; } {
        var _prefixLen:stdgo.GoInt = (0 : stdgo.GoInt), _cleaned:stdgo.GoString = ("" : stdgo.GoString);
        var _vollen:stdgo.GoInt = _volumeNameLen(_path?.__copy__());
        if (_path == (stdgo.Go.str())) {
            return { _0 : (0 : stdgo.GoInt), _1 : ("." : stdgo.GoString) };
        } else if (((_vollen + (1 : stdgo.GoInt)) == (_path.length)) && stdgo.os.Os.isPathSeparator(_path[((_path.length) - (1 : stdgo.GoInt) : stdgo.GoInt)])) {
            return { _0 : _vollen + (1 : stdgo.GoInt), _1 : _path?.__copy__() };
        } else if ((_vollen == (_path.length)) && (_path.length == (2 : stdgo.GoInt))) {
            return { _0 : _vollen, _1 : _path + ("." : stdgo.GoString)?.__copy__()?.__copy__() };
        } else {
            if (_vollen >= (_path.length)) {
                _vollen = (_path.length) - (1 : stdgo.GoInt);
            };
            return { _0 : _vollen, _1 : (_path.__slice__((0 : stdgo.GoInt), (_path.length) - (1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__() };
        };
    }
/**
...
function _glob(_dir:stdgo.GoString, _pattern:stdgo.GoString, _matches:stdgo.Slice<stdgo.GoString>):{ var _0 : stdgo.Slice<stdgo.GoString>; var _1 : stdgo.Error; } {
        ...
        try {
            ...
            var __tmp__ = stdgo.os.Os.open(_dir?.__copy__()), _d:stdgo.Ref<stdgo.os.Os.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                return { _0 : _m, _1 : _e };
            };
...
function clean(_path:stdgo.GoString):stdgo.GoString {
        ...
        if (_path == (stdgo.Go.str())) {
            if (((_volLen > (1 : stdgo.GoInt)) && stdgo.os.Os.isPathSeparator(_originalPath[(0 : stdgo.GoInt)])) && stdgo.os.Os.isPathSeparator(_originalPath[(1 : stdgo.GoInt)])) {
                return fromSlash(_originalPath?.__copy__())?.__copy__();
            };
            return _originalPath + ("." : stdgo.GoString)?.__copy__()?.__copy__();
        };
        var _rooted:Bool = stdgo.os.Os.isPathSeparator(_path[(0 : stdgo.GoInt)]);
        var _n:stdgo.GoInt = (_path.length);
        ...
        var __0:stdgo.GoInt = (0 : stdgo.GoInt), __1:stdgo.GoInt = (0 : stdgo.GoInt), _dotdot:stdgo.GoInt = __1, _r:stdgo.GoInt = __0;
        if (_rooted) {
        ...
        while (_r < _n) {
            if (stdgo.os.Os.isPathSeparator(_path[(_r : stdgo.GoInt)])) {
                _r++;
            } else if ((_path[(_r : stdgo.GoInt)] == (46 : stdgo.GoUInt8)) && (((_r + (1 : stdgo.GoInt)) == _n) || stdgo.os.Os.isPathSeparator(_path[(_r + (1 : stdgo.GoInt) : stdgo.GoInt)]))) {
                _r++;
            } else if (((_path[(_r : stdgo.GoInt)] == (46 : stdgo.GoUInt8)) && (_path[(_r + (1 : stdgo.GoInt) : stdgo.GoInt)] == (46 : stdgo.GoUInt8))) && (((_r + (2 : stdgo.GoInt)) == _n) || stdgo.os.Os.isPathSeparator(_path[(_r + (2 : stdgo.GoInt) : stdgo.GoInt)]))) {
                _r = _r + ((2 : stdgo.GoInt));
                if (_out._w > _dotdot) {
                    _out._w--;
                ...
                if ((_rooted && (_out._w != (1 : stdgo.GoInt))) || (!_rooted && (_out._w != (0 : stdgo.GoInt)))) {
                    _out._append((47 : stdgo.GoUInt8));
                };
                stdgo.Go.cfor((_r < _n) && !stdgo.os.Os.isPathSeparator(_path[(_r : stdgo.GoInt)]), _r++, {
        ...
        if ((false && (_out._volLen == (0 : stdgo.GoInt))) && (_out._buf != null)) {
...
function toSlash(_path:stdgo.GoString):stdgo.GoString {
        ...
        return stdgo.strings.Strings.replaceAll(_path?.__copy__(), ((47 : stdgo.GoInt32) : stdgo.GoString), ("/" : stdgo.GoString))?.__copy__();
    }
/**
...
function fromSlash(_path:stdgo.GoString):stdgo.GoString {
        ...
        return stdgo.strings.Strings.replaceAll(_path?.__copy__(), ("/" : stdgo.GoString), ((47 : stdgo.GoInt32) : stdgo.GoString))?.__copy__();
    }
/**
...
function split(_path:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : stdgo.GoString; } {
        ...
        var _i:stdgo.GoInt = (_path.length) - (1 : stdgo.GoInt);
        while ((_i >= _vol.length) && !stdgo.os.Os.isPathSeparator(_path[(_i : stdgo.GoInt)])) {
            _i--;
        };
        return { _0 : (_path.__slice__(0, _i + (1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__(), _1 : (_path.__slice__(_i + (1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__() };
    }
/**
...
function ext(_path:stdgo.GoString):stdgo.GoString {
        {
            var _i:stdgo.GoInt = (_path.length) - (1 : stdgo.GoInt);
            stdgo.Go.cfor((_i >= (0 : stdgo.GoInt)) && !stdgo.os.Os.isPathSeparator(_path[(_i : stdgo.GoInt)]), _i--, {
...
function rel(_basepath:stdgo.GoString, _targpath:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : stdgo.Error; } {
        ...
        } else if ((_base == stdgo.Go.str()) && (_volumeNameLen(_baseVol?.__copy__()) > (2 : stdgo.GoInt))) {
            _base = ((47 : stdgo.GoInt32) : stdgo.GoString);
        };
        var _baseSlashed:Bool = (_base.length > (0 : stdgo.GoInt)) && (_base[(0 : stdgo.GoInt)] == (47 : stdgo.GoUInt8));
        var _targSlashed:Bool = (_targ.length > (0 : stdgo.GoInt)) && (_targ[(0 : stdgo.GoInt)] == (47 : stdgo.GoUInt8));
        ...
        var _bl:stdgo.GoInt = (_base.length);
        var _tl:stdgo.GoInt = (_targ.length);
        var __0:stdgo.GoInt = (0 : stdgo.GoInt), __1:stdgo.GoInt = (0 : stdgo.GoInt), __2:stdgo.GoInt = (0 : stdgo.GoInt), __3:stdgo.GoInt = (0 : stdgo.GoInt), _ti:stdgo.GoInt = __3, _t0:stdgo.GoInt = __2, _bi:stdgo.GoInt = __1, _b0:stdgo.GoInt = __0;
        while (true) {
            while ((_bi < _bl) && (_base[(_bi : stdgo.GoInt)] != (47 : stdgo.GoUInt8))) {
                _bi++;
            };
            while ((_ti < _tl) && (_targ[(_ti : stdgo.GoInt)] != (47 : stdgo.GoUInt8))) {
                _ti++;
            };
        ...
        if (_b0 != (_bl)) {
            var _seps:stdgo.GoInt = stdgo.strings.Strings.count((_base.__slice__(_b0, _bl) : stdgo.GoString)?.__copy__(), ((47 : stdgo.GoInt32) : stdgo.GoString));
            var _size:stdgo.GoInt = (2 : stdgo.GoInt) + (_seps * (3 : stdgo.GoInt));
            if (_tl != (_t0)) {
                _size = _size + (((1 : stdgo.GoInt) + _tl) - _t0);
            };
            ...
            var _n:stdgo.GoInt = stdgo.Go.copySlice(_buf, (".." : stdgo.GoString));
            {
                ...
                stdgo.Go.cfor(_i < _seps, _i++, {
                    ...
                    stdgo.Go.copySlice((_buf.__slice__(_n + (1 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>), (".." : stdgo.GoString));
                    _n = _n + ((3 : stdgo.GoInt));
                });
            };
            if (_t0 != (_tl)) {
                _buf[(_n : stdgo.GoInt)] = (47 : stdgo.GoUInt8);
                stdgo.Go.copySlice((_buf.__slice__(_n + (1 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoUInt8>), (_targ.__slice__(_t0) : stdgo.GoString));
            };
...
function walkDir(_root:stdgo.GoString, _fn:stdgo.io.fs.Fs.WalkDirFunc):stdgo.Error {
        ...
        if (_err != null) {
            ...
            _err = _walkDir(_root?.__copy__(), stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.path.filepath.Filepath.T_statDirEntry(_info) : stdgo.path.filepath.Filepath.T_statDirEntry)) : stdgo.Ref<stdgo.path.filepath.Filepath.T_statDirEntry>)), _fn);
        };
...
function _readDir(_dirname:stdgo.GoString):{ var _0 : stdgo.Slice<stdgo.io.fs.Fs.DirEntry>; var _1 : stdgo.Error; } {
        var __tmp__ = stdgo.os.Os.open(_dirname?.__copy__()), _f:stdgo.Ref<stdgo.os.Os.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : (null : stdgo.Slice<stdgo.io.fs.Fs.DirEntry>), _1 : _err };
        };
        var __tmp__ = _f.readDir((-1 : stdgo.GoInt)), _dirs:stdgo.Slice<stdgo.io.fs.Fs.DirEntry> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        _f.close();
        if (_err != null) {
            return { _0 : (null : stdgo.Slice<stdgo.io.fs.Fs.DirEntry>), _1 : _err };
        };
        stdgo.sort.Sort.slice(stdgo.Go.toInterface(_dirs), function(_i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
            return _dirs[(_i : stdgo.GoInt)].name() < _dirs[(_j : stdgo.GoInt)].name();
        });
...
function base(_path:stdgo.GoString):stdgo.GoString {
        ...
        while ((_path.length > (0 : stdgo.GoInt)) && stdgo.os.Os.isPathSeparator(_path[((_path.length) - (1 : stdgo.GoInt) : stdgo.GoInt)])) {
            _path = (_path.__slice__((0 : stdgo.GoInt), (_path.length) - (1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
        };
        _path = (_path.__slice__((volumeName(_path?.__copy__()).length)) : stdgo.GoString)?.__copy__();
        var _i:stdgo.GoInt = (_path.length) - (1 : stdgo.GoInt);
        while ((_i >= (0 : stdgo.GoInt)) && !stdgo.os.Os.isPathSeparator(_path[(_i : stdgo.GoInt)])) {
            _i--;
        };
        if (_i >= (0 : stdgo.GoInt)) {
            _path = (_path.__slice__(_i + (1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__();
        };
        if (_path == (stdgo.Go.str())) {
...
function dir(_path:stdgo.GoString):stdgo.GoString {
        ...
        var _dir:stdgo.GoString = clean((_path.__slice__((_vol.length), _i + (1 : stdgo.GoInt)) : stdgo.GoString)?.__copy__())?.__copy__();
        if ((_dir == ("." : stdgo.GoString)) && (_vol.length > (2 : stdgo.GoInt))) {
...
function _splitList(_path:stdgo.GoString):stdgo.Slice<stdgo.GoString> {
        ...
        return stdgo.strings.Strings.split(_path?.__copy__(), ((58 : stdgo.GoInt32) : stdgo.GoString));
    }
...
function _join(_elem:stdgo.Slice<stdgo.GoString>):stdgo.GoString {
        for (_i => _e in _elem) {
            if (_e != (stdgo.Go.str())) {
                return clean(stdgo.strings.Strings.join((_elem.__slice__(_i) : stdgo.Slice<stdgo.GoString>), ((47 : stdgo.GoInt32) : stdgo.GoString))?.__copy__())?.__copy__();
            };
        };
        return stdgo.Go.str()?.__copy__();
    }
...
function _walkSymlinks(_path:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : stdgo.Error; } {
        ...
        if ((_volLen < _path.length) && stdgo.os.Os.isPathSeparator(_path[(_volLen : stdgo.GoInt)])) {
            _volLen++;
        };
        var _vol:stdgo.GoString = (_path.__slice__(0, _volLen) : stdgo.GoString)?.__copy__();
        var _dest:stdgo.GoString = _vol?.__copy__();
        var _linksWalked:stdgo.GoInt = (0 : stdgo.GoInt);
        {
            var __0:stdgo.GoInt = _volLen, __1:stdgo.GoInt = _volLen, _end:stdgo.GoInt = __1, _start:stdgo.GoInt = __0;
            stdgo.Go.cfor(_start < (_path.length), _start = _end, {
                while ((_start < _path.length) && stdgo.os.Os.isPathSeparator(_path[(_start : stdgo.GoInt)])) {
                    _start++;
                };
                _end = _start;
                while ((_end < _path.length) && !stdgo.os.Os.isPathSeparator(_path[(_end : stdgo.GoInt)])) {
                    _end++;
                };
                ...
                if (_end == (_start)) {
                    ...
                    {
                        _r = (_dest.length) - (1 : stdgo.GoInt);
                        stdgo.Go.cfor(_r >= _volLen, _r--, {
                            if (stdgo.os.Os.isPathSeparator(_dest[(_r : stdgo.GoInt)])) {
                                break;
                            };
                        });
                    };
                    if ((_r < _volLen) || ((_dest.__slice__(_r + (1 : stdgo.GoInt)) : stdgo.GoString) == (".." : stdgo.GoString))) {
                ...
                if ((_dest.length > _volumeNameLen(_dest?.__copy__())) && !stdgo.os.Os.isPathSeparator(_dest[((_dest.length) - (1 : stdgo.GoInt) : stdgo.GoInt)])) {
                    _dest = _dest + (_pathSeparator)?.__copy__();
                };
                ...
                _linksWalked++;
                if (_linksWalked > (255 : stdgo.GoInt)) {
                ...
                var _v:stdgo.GoInt = _volumeNameLen(_link?.__copy__());
                if (_v > (0 : stdgo.GoInt)) {
                    if ((_v < _link.length) && stdgo.os.Os.isPathSeparator(_link[(_v : stdgo.GoInt)])) {
                        _v++;
                    };
                    _vol = (_link.__slice__(0, _v) : stdgo.GoString)?.__copy__();
                    _dest = _vol?.__copy__();
                    _end = (_vol.length);
                } else if ((_link.length > (0 : stdgo.GoInt)) && stdgo.os.Os.isPathSeparator(_link[(0 : stdgo.GoInt)])) {
...
@:keep @:allow(stdgo.path.filepath.Filepath.T_lazybuf_asInterface) class T_lazybuf_static_extension {
    ...
    static public function _string( _b:stdgo.Ref<T_lazybuf>):stdgo.GoString {
        ...
        return (_b._volAndPath.__slice__(0, _b._volLen) : stdgo.GoString) + ((_b._buf.__slice__(0, _b._w) : stdgo.Slice<stdgo.GoUInt8>) : stdgo.GoString)?.__copy__()?.__copy__();
    }
    @:keep
    ...
    static public function _append( _b:stdgo.Ref<T_lazybuf>, _c:stdgo.GoByte):Void {
        @:recv var _b:stdgo.Ref<T_lazybuf> = _b;
        if (_b._buf == null) {
            if ((_b._w < _b._path.length) && (_b._path[(_b._w : stdgo.GoInt)] == _c)) {
                _b._w++;
                return;
            };
...
@:keep @:allow(stdgo.path.filepath.Filepath.T_statDirEntry_asInterface) class T_statDirEntry_static_extension {
    ...
    @:keep
    static public function info( _d:stdgo.Ref<T_statDirEntry>):{ var _0 : stdgo.io.fs.Fs.FileInfo; var _1 : stdgo.Error; } {
        @:recv var _d:stdgo.Ref<T_statDirEntry> = _d;
        return { _0 : _d._info, _1 : (null : stdgo.Error) };
    }
    @:keep
    static public function type( _d:stdgo.Ref<T_statDirEntry>):stdgo.io.fs.Fs.FileMode {
        @:recv var _d:stdgo.Ref<T_statDirEntry> = _d;
