...
/**
    /|*{
    	...
    	gotoNext = 3944730
    	_ = gotoNext == 3944730
    	if !ScanBreak && (i_3944717 < len(pattern)) {
    		gotoNext = 3944763
    		_ = gotoNext == 3944763
    		_ = 0
    		gotoNext = 3944767
    		_ = gotoNext == 3944767
    		switch pattern[i_3944717] {
    		case 92:
    			gotoNext = 3944789
    			_ = gotoNext == 3944789
    			if true {
    	...
    	_ = gotoNext == 3945055
    	return star, pattern[0:i_3944717], pattern[i_3944717:]
    	gotoNext = -1
    }*|/
**/
class Filepath {
