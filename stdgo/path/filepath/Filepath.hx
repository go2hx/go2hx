...
/**
    /|*{
    	...
    	gotoNext = 3943785
    	_ = gotoNext == 3943785
    	if !ScanBreak && (i_3943772 < len(pattern)) {
    		gotoNext = 3943818
    		_ = gotoNext == 3943818
    		gotoNext = 3943822
    		_ = gotoNext == 3943822
    		switch pattern[i_3943772] {
    		case 92:
    			gotoNext = 3943844
    			_ = gotoNext == 3943844
    			if true {
    	...
    	_ = gotoNext == 3944110
    	return star, pattern[0:i_3943772], pattern[i_3943772:]
    	gotoNext = -1
    }*|/
**/
class Filepath {
