...
/**
    /|*{
    	...
    	gotoNext = 3994925
    	_ = gotoNext == 3994925
    	if !ScanBreak && (i_3994912 < len(pattern)) {
    		gotoNext = 3994958
    		_ = gotoNext == 3994958
    		gotoNext = 3994962
    		_ = gotoNext == 3994962
    		switch pattern[i_3994912] {
    		case 92:
    			gotoNext = 3994984
    			_ = gotoNext == 3994984
    			if true {
    	...
    	_ = gotoNext == 3995250
    	return star, pattern[0:i_3994912], pattern[i_3994912:]
    	gotoNext = -1
    }*|/
**/
class Filepath {
