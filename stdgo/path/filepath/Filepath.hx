...
/**
    /|*{
    	...
    	gotoNext = 3868752
    	_ = gotoNext == 3868752
    	if !ScanBreak && (i_3868739 < len(pattern)) {
    		gotoNext = 3868785
    		_ = gotoNext == 3868785
    		gotoNext = 3868789
    		_ = gotoNext == 3868789
    		switch pattern[i_3868739] {
    		case 92:
    			gotoNext = 3868811
    			_ = gotoNext == 3868811
    			if true {
    	...
    	_ = gotoNext == 3869077
    	return star, pattern[0:i_3868739], pattern[i_3868739:]
    	gotoNext = -1
    }*|/
**/
class Filepath {
