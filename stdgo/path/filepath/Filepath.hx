...
/**
    /|*{
    	...
    	gotoNext = 4036729
    	_ = gotoNext == 4036729
    	if !ScanBreak && (i_4036716 < len(pattern)) {
    		gotoNext = 4036762
    		_ = gotoNext == 4036762
    		gotoNext = 4036766
    		_ = gotoNext == 4036766
    		switch pattern[i_4036716] {
    		case 92:
    			gotoNext = 4036788
    			_ = gotoNext == 4036788
    			if true {
    	...
    	_ = gotoNext == 4037054
    	return star, pattern[0:i_4036716], pattern[i_4036716:]
    	gotoNext = -1
    }*|/
**/
class Filepath {
