...
(new stdgo.testing.Testing.InternalTest(("TestCVE202230632" : GoString), stdgo.path.filepath_test.Filepath_test.testCVE202230632) : stdgo.testing.Testing.InternalTest),
...
(new stdgo.testing.Testing.InternalTest(("TestIsLocal" : GoString), stdgo.path.filepath_test.Filepath_test.testIsLocal) : stdgo.testing.Testing.InternalTest),
...
(new stdgo.testing.Testing.InternalTest(("TestWalkSkipAllOnFile" : GoString), stdgo.path.filepath_test.Filepath_test.testWalkSkipAllOnFile) : stdgo.testing.Testing.InternalTest),
...
(new stdgo.testing.Testing.InternalTest(("TestEvalSymlinksAboveRootChdir" : GoString), stdgo.path.filepath_test.Filepath_test.testEvalSymlinksAboveRootChdir) : stdgo.testing.Testing.InternalTest),
(new stdgo.testing.Testing.InternalTest(("TestIssue51617" : GoString), stdgo.path.filepath_test.Filepath_test.testIssue51617) : stdgo.testing.Testing.InternalTest)) : Slice<stdgo.testing.Testing.InternalTest>);
/**
...
10,
10,
(new stdgo.testing.Testing.InternalExample(("ExampleExt" : GoString), stdgo.path.filepath_test.Filepath_test.exampleExt, ("No dots: \"\"\nOne dot: \".js\"\nTwo dots: \".js\"\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
(new stdgo.testing.Testing.InternalExample(("ExampleSplitList" : GoString), stdgo.path.filepath_test.Filepath_test.exampleSplitList, ("On Unix: [/a/b/c /usr/bin]\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
(new stdgo.testing.Testing.InternalExample(("ExampleRel" : GoString), stdgo.path.filepath_test.Filepath_test.exampleRel, ("On Unix:\n\"/a/b/c\": \"b/c\" <nil>\n\"/b/c\": \"../b/c\" <nil>\n\"./b/c\": \"\" Rel: can\'t make ./b/c relative to /a\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
(new stdgo.testing.Testing.InternalExample(("ExampleSplit" : GoString), stdgo.path.filepath_test.Filepath_test.exampleSplit, ("On Unix:\ninput: \"/home/arnie/amelia.jpg\"\n\tdir: \"/home/arnie/\"\n\tfile: \"amelia.jpg\"\ninput: \"/mnt/photos/\"\n\tdir: \"/mnt/photos/\"\n\tfile: \"\"\ninput: \"rabbit.jpg\"\n\tdir: \"\"\n\tfile: \"rabbit.jpg\"\ninput: \"/usr/local//go\"\n\tdir: \"/usr/local//\"\n\tfile: \"go\"\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
(new stdgo.testing.Testing.InternalExample(("ExampleJoin" : GoString), stdgo.path.filepath_test.Filepath_test.exampleJoin, ("On Unix:\na/b/c\na/b/c\na/b/c\na/b/c\n../xyz\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
(new stdgo.testing.Testing.InternalExample(("ExampleMatch" : GoString), stdgo.path.filepath_test.Filepath_test.exampleMatch, ("On Unix:\ntrue <nil>\nfalse <nil>\ntrue <nil>\ntrue <nil>\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
(new stdgo.testing.Testing.InternalExample(("ExampleBase" : GoString), stdgo.path.filepath_test.Filepath_test.exampleBase, ("On Unix:\nbaz.js\nbaz\nbaz\ndev.txt\ntodo.txt\n..\n.\n/\n.\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
(new stdgo.testing.Testing.InternalExample(("ExampleDir" : GoString), stdgo.path.filepath_test.Filepath_test.exampleDir, ("On Unix:\n/foo/bar\n/foo/bar\n/foo/bar/baz\n/dirty/path\n.\n..\n.\n.\n/\n.\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
(new stdgo.testing.Testing.InternalExample(("ExampleIsAbs" : GoString), stdgo.path.filepath_test.Filepath_test.exampleIsAbs, ("On Unix:\ntrue\nfalse\nfalse\nfalse\ntrue\nfalse\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
(new stdgo.testing.Testing.InternalExample(("ExampleWalk" : GoString), stdgo.path.filepath_test.Filepath_test.exampleWalk, ("On Unix:\nvisited file or dir: \".\"\nvisited file or dir: \"dir\"\nvisited file or dir: \"dir/to\"\nvisited file or dir: \"dir/to/walk\"\nskipping a dir without errors: skip\n" : GoString), false) : stdgo.testing.Testing.InternalExample)) : Slice<stdgo.testing.Testing.InternalExample>);
