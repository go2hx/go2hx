...
private var _matchTests:Slice<stdgo.path_test.Path_test.MatchTest> = (new Slice<stdgo.path_test.Path_test.MatchTest>(0, 0,
	...
	(new stdgo.path_test.Path_test.MatchTest(("a*b*c*d*e*/f" : GoString), ("axbxcxdxe/f" : GoString), true,
		(null : Error)) : stdgo.path_test.Path_test.MatchTest),
	(new stdgo.path_test.Path_test.MatchTest(("a*b*c*d*e*/f" : GoString), ("axbxcxdxexxx/f" : GoString), true,
		(null : Error)) : stdgo.path_test.Path_test.MatchTest),
	(new stdgo.path_test.Path_test.MatchTest(("a*b*c*d*e*/f" : GoString), ("axbxcxdxe/xxx/f" : GoString), false,
		(null : Error)) : stdgo.path_test.Path_test.MatchTest),
	(new stdgo.path_test.Path_test.MatchTest(("a*b*c*d*e*/f" : GoString), ("axbxcxdxexxx/fff" : GoString), false,
		(null : Error)) : stdgo.path_test.Path_test.MatchTest),
	(new stdgo.path_test.Path_test.MatchTest(("a*b?c*x" : GoString), ("abxbbxdbxebxczzx" : GoString), true,
		(null : Error)) : stdgo.path_test.Path_test.MatchTest),
	(new stdgo.path_test.Path_test.MatchTest(("a*b?c*x" : GoString), ("abxbbxdbxebxczzy" : GoString), false,
		(null : Error)) : stdgo.path_test.Path_test.MatchTest),
	...
	(new stdgo.path_test.Path_test.MatchTest(("*x" : GoString), ("xxx" : GoString), true,
...
private var _cleantests:Slice<stdgo.path_test.Path_test.PathTest> = (new Slice<stdgo.path_test.Path_test.PathTest>(0, 0,
	...
	(new stdgo.path_test.Path_test.PathTest(("abc/def/../../.." : GoString), (".." : GoString)) : stdgo.path_test.Path_test.PathTest),
	(new stdgo.path_test.Path_test.PathTest(("/abc/def/../../.." : GoString), ("/" : GoString)) : stdgo.path_test.Path_test.PathTest),
	(new stdgo.path_test.Path_test.PathTest(("abc/def/../../../ghi/jkl/../../../mno" : GoString),
		("../../mno" : GoString)) : stdgo.path_test.Path_test.PathTest),
	(new stdgo.path_test.Path_test.PathTest(("abc/./../def" : GoString), ("def" : GoString)) : stdgo.path_test.Path_test.PathTest),
	(new stdgo.path_test.Path_test.PathTest(("abc//./../def" : GoString), ("def" : GoString)) : stdgo.path_test.Path_test.PathTest),
	(new stdgo.path_test.Path_test.PathTest(("abc/../../././../def" : GoString),
		("../../def" : GoString)) : stdgo.path_test.Path_test.PathTest)) : Slice<stdgo.path_test.Path_test.PathTest>);

private var _splittests:Slice<stdgo.path_test.Path_test.SplitTest> = (new Slice<stdgo.path_test.Path_test.SplitTest>(0, 0,
	(new stdgo.path_test.Path_test.SplitTest(("a/b" : GoString), ("a/" : GoString), ("b" : GoString)) : stdgo.path_test.Path_test.SplitTest),
	(new stdgo.path_test.Path_test.SplitTest(("a/b/" : GoString), ("a/b/" : GoString), Go.str()) : stdgo.path_test.Path_test.SplitTest),
	(new stdgo.path_test.Path_test.SplitTest(("a/" : GoString), ("a/" : GoString), Go.str()) : stdgo.path_test.Path_test.SplitTest),
	(new stdgo.path_test.Path_test.SplitTest(("a" : GoString), Go.str(), ("a" : GoString)) : stdgo.path_test.Path_test.SplitTest),
	(new stdgo.path_test.Path_test.SplitTest(("/" : GoString), ("/" : GoString),
...
private var _jointests:Slice<stdgo.path_test.Path_test.JoinTest> = (new Slice<stdgo.path_test.Path_test.JoinTest>(0, 0,
	...
	(new stdgo.path_test.Path_test.JoinTest((new Slice<GoString>(0, 0, ("a" : GoString)) : Slice<GoString>),
		("a" : GoString)) : stdgo.path_test.Path_test.JoinTest),
	(new stdgo.path_test.Path_test.JoinTest((new Slice<GoString>(0, 0, ("a" : GoString), ("b" : GoString)) : Slice<GoString>),
		("a/b" : GoString)) : stdgo.path_test.Path_test.JoinTest),
	(new stdgo.path_test.Path_test.JoinTest((new Slice<GoString>(0, 0, ("a" : GoString), Go.str()) : Slice<GoString>),
		("a" : GoString)) : stdgo.path_test.Path_test.JoinTest),
	(new stdgo.path_test.Path_test.JoinTest((new Slice<GoString>(0, 0, Go.str(), ("b" : GoString)) : Slice<GoString>),
		("b" : GoString)) : stdgo.path_test.Path_test.JoinTest),
	(new stdgo.path_test.Path_test.JoinTest((new Slice<GoString>(0, 0, ("/" : GoString), ("a" : GoString)) : Slice<GoString>),
		("/a" : GoString)) : stdgo.path_test.Path_test.JoinTest),
	(new stdgo.path_test.Path_test.JoinTest((new Slice<GoString>(0, 0, ("/" : GoString), Go.str()) : Slice<GoString>),
		("/" : GoString)) : stdgo.path_test.Path_test.JoinTest),
	(new stdgo.path_test.Path_test.JoinTest((new Slice<GoString>(0, 0, ("a/" : GoString), ("b" : GoString)) : Slice<GoString>),
		("a/b" : GoString)) : stdgo.path_test.Path_test.JoinTest),
	(new stdgo.path_test.Path_test.JoinTest((new Slice<GoString>(0, 0, ("a/" : GoString), Go.str()) : Slice<GoString>),
		("a" : GoString)) : stdgo.path_test.Path_test.JoinTest),
...
private var _exttests:Slice<stdgo.path_test.Path_test.ExtTest> = (new Slice<stdgo.path_test.Path_test.ExtTest>(0, 0,
	(new stdgo.path_test.Path_test.ExtTest(("path.go" : GoString), (".go" : GoString)) : stdgo.path_test.Path_test.ExtTest),
	(new stdgo.path_test.Path_test.ExtTest(("path.pb.go" : GoString), (".go" : GoString)) : stdgo.path_test.Path_test.ExtTest),
	(new stdgo.path_test.Path_test.ExtTest(("a.dir/b" : GoString), Go.str()) : stdgo.path_test.Path_test.ExtTest),
	(new stdgo.path_test.Path_test.ExtTest(("a.dir/b.go" : GoString), (".go" : GoString)) : stdgo.path_test.Path_test.ExtTest),
	(new stdgo.path_test.Path_test.ExtTest(("a.dir/" : GoString), Go.str()) : stdgo.path_test.Path_test.ExtTest)) : Slice<stdgo.path_test.Path_test.ExtTest>);
...
private var _basetests:Slice<stdgo.path_test.Path_test.PathTest> = (new Slice<stdgo.path_test.Path_test.PathTest>(0, 0,
	...
	(new stdgo.path_test.Path_test.PathTest(("a/b/c.x" : GoString),
		("c.x" : GoString)) : stdgo.path_test.Path_test.PathTest)) : Slice<stdgo.path_test.Path_test.PathTest>);
...
private var _dirtests:Slice<stdgo.path_test.Path_test.PathTest> = (new Slice<stdgo.path_test.Path_test.PathTest>(0, 0,
	...
	(new stdgo.path_test.Path_test.PathTest(("a/b/c.x" : GoString),
		("a/b" : GoString)) : stdgo.path_test.Path_test.PathTest)) : Slice<stdgo.path_test.Path_test.PathTest>);
...
private var _isAbsTests:Slice<stdgo.path_test.Path_test.IsAbsTest> = (new Slice<stdgo.path_test.Path_test.IsAbsTest>(0, 0,
	...
	(new stdgo.path_test.Path_test.IsAbsTest(("/" : GoString), true) : stdgo.path_test.Path_test.IsAbsTest),
	(new stdgo.path_test.Path_test.IsAbsTest(("/usr/bin/gcc" : GoString), true) : stdgo.path_test.Path_test.IsAbsTest),
	(new stdgo.path_test.Path_test.IsAbsTest((".." : GoString), false) : stdgo.path_test.Path_test.IsAbsTest),
	(new stdgo.path_test.Path_test.IsAbsTest(("/a/../bb" : GoString), true) : stdgo.path_test.Path_test.IsAbsTest),
	(new stdgo.path_test.Path_test.IsAbsTest(("." : GoString), false) : stdgo.path_test.Path_test.IsAbsTest),
	(new stdgo.path_test.Path_test.IsAbsTest(("./" : GoString), false) : stdgo.path_test.Path_test.IsAbsTest),
	(new stdgo.path_test.Path_test.IsAbsTest(("lala" : GoString), false) : stdgo.path_test.Path_test.IsAbsTest)) : Slice<stdgo.path_test.Path_test.IsAbsTest>);
...
function testMatch(_t:Ref<stdgo.testing.Testing.T>):Void {
	for (_0 => _tt in _matchTests) {
		...
		if ((_ok != _tt._match) || (Go.toInterface(_err) != Go.toInterface(_tt._err))) {
			_t.errorf(("Match(%#q, %#q) = %v, %v want %v, %v" : GoString), Go.toInterface(_tt._pattern), Go.toInterface(_tt._s), Go.toInterface(_ok),
	...
	for (_0 => _test in _splittests) {
		{
			...
			if ((_d != _test._dir) || (_f != _test._file)) {
				_t.errorf(("Split(%q) = %q, %q, want %q, %q" : GoString), Go.toInterface(_test._path), Go.toInterface(_d), Go.toInterface(_f),
