...
36,
36,
(new stdgo.path_test.Path_test.PathTest(stdgo.Go.str()?.__copy__(), ("." : stdgo.GoString)) : stdgo.path_test.Path_test.PathTest),
...
**/
var _splittests : stdgo.Slice<stdgo.path_test.Path_test.SplitTest> = (new stdgo.Slice<stdgo.path_test.Path_test.SplitTest>(5, 5, (new stdgo.path_test.Path_test.SplitTest(("a/b" : stdgo.GoString), ("a/" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo.path_test.Path_test.SplitTest), (new stdgo.path_test.Path_test.SplitTest(("a/b/" : stdgo.GoString), ("a/b/" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.path_test.Path_test.SplitTest), (new stdgo.path_test.Path_test.SplitTest(("a/" : stdgo.GoString), ("a/" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.path_test.Path_test.SplitTest), (new stdgo.path_test.Path_test.SplitTest(("a" : stdgo.GoString), stdgo.Go.str()?.__copy__(), ("a" : stdgo.GoString)) : stdgo.path_test.Path_test.SplitTest), (new stdgo.path_test.Path_test.SplitTest(("/" : stdgo.GoString), ("/" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.path_test.Path_test.SplitTest)) : stdgo.Slice<stdgo.path_test.Path_test.SplitTest>);
/**
...
(new stdgo.path_test.Path_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("a" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), ("a" : stdgo.GoString)) : stdgo.path_test.Path_test.JoinTest),
(new stdgo.path_test.Path_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, stdgo.Go.str()?.__copy__(), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("b" : stdgo.GoString)) : stdgo.path_test.Path_test.JoinTest),
...
(new stdgo.path_test.Path_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("/" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), ("/" : stdgo.GoString)) : stdgo.path_test.Path_test.JoinTest),
(new stdgo.path_test.Path_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("a/" : stdgo.GoString), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), ("a/b" : stdgo.GoString)) : stdgo.path_test.Path_test.JoinTest),
(new stdgo.path_test.Path_test.JoinTest((new stdgo.Slice<stdgo.GoString>(2, 2, ("a/" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.Slice<stdgo.GoString>), ("a" : stdgo.GoString)) : stdgo.path_test.Path_test.JoinTest),
...
**/
var _exttests : stdgo.Slice<stdgo.path_test.Path_test.ExtTest> = (new stdgo.Slice<stdgo.path_test.Path_test.ExtTest>(5, 5, (new stdgo.path_test.Path_test.ExtTest(("path.go" : stdgo.GoString), (".go" : stdgo.GoString)) : stdgo.path_test.Path_test.ExtTest), (new stdgo.path_test.Path_test.ExtTest(("path.pb.go" : stdgo.GoString), (".go" : stdgo.GoString)) : stdgo.path_test.Path_test.ExtTest), (new stdgo.path_test.Path_test.ExtTest(("a.dir/b" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.path_test.Path_test.ExtTest), (new stdgo.path_test.Path_test.ExtTest(("a.dir/b.go" : stdgo.GoString), (".go" : stdgo.GoString)) : stdgo.path_test.Path_test.ExtTest), (new stdgo.path_test.Path_test.ExtTest(("a.dir/" : stdgo.GoString), stdgo.Go.str()?.__copy__()) : stdgo.path_test.Path_test.ExtTest)) : stdgo.Slice<stdgo.path_test.Path_test.ExtTest>);
/**
...
**/
var _isAbsTests : stdgo.Slice<stdgo.path_test.Path_test.IsAbsTest> = (new stdgo.Slice<stdgo.path_test.Path_test.IsAbsTest>(8, 8, (new stdgo.path_test.Path_test.IsAbsTest(stdgo.Go.str()?.__copy__(), false) : stdgo.path_test.Path_test.IsAbsTest), (new stdgo.path_test.Path_test.IsAbsTest(("/" : stdgo.GoString), true) : stdgo.path_test.Path_test.IsAbsTest), (new stdgo.path_test.Path_test.IsAbsTest(("/usr/bin/gcc" : stdgo.GoString), true) : stdgo.path_test.Path_test.IsAbsTest), (new stdgo.path_test.Path_test.IsAbsTest((".." : stdgo.GoString), false) : stdgo.path_test.Path_test.IsAbsTest), (new stdgo.path_test.Path_test.IsAbsTest(("/a/../bb" : stdgo.GoString), true) : stdgo.path_test.Path_test.IsAbsTest), (new stdgo.path_test.Path_test.IsAbsTest(("." : stdgo.GoString), false) : stdgo.path_test.Path_test.IsAbsTest), (new stdgo.path_test.Path_test.IsAbsTest(("./" : stdgo.GoString), false) : stdgo.path_test.Path_test.IsAbsTest), (new stdgo.path_test.Path_test.IsAbsTest(("lala" : stdgo.GoString), false) : stdgo.path_test.Path_test.IsAbsTest)) : stdgo.Slice<stdgo.path_test.Path_test.IsAbsTest>);
/**
...
function exampleClean():Void {
        ...
        for (__0 => _p in _paths) {
            stdgo.fmt.Fmt.printf(("Clean(%q) = %q\n" : stdgo.GoString), stdgo.Go.toInterface(_p), stdgo.Go.toInterface(stdgo.path.Path.clean(_p?.__copy__())));
        };
    }
...
function exampleJoin():Void {
        ...
        stdgo.fmt.Fmt.println(stdgo.Go.toInterface(stdgo.path.Path.join(("a" : stdgo.GoString), stdgo.Go.str()?.__copy__())));
