...
@:structInit class Plugin {
	...
	public var _syms:GoMap<GoString, Symbol> = new GoMap<GoString,
		Symbol>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
		stdgo.reflect.Reflect.GoType.named("plugin.Symbol", [], stdgo.reflect.Reflect.GoType.interfaceType(true, []))))).nil();

	public function new(?_pluginpath:GoString, ?_err:GoString, ?_loaded:Chan<{}>, ?_syms:GoMap<GoString, Symbol>)
...
class Plugin_extension_fields {
	public function lookup(__tmp__, _symName:GoString):{var _0:Symbol; var _1:Error;}
		return __tmp__.lookup(_symName);
}
