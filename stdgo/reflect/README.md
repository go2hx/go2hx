...
- [class MapIter](<#class-mapiter>)
  ...
  - [`function new(?map:stdgo.GoMap<Dynamic, Dynamic>, ?keys:Array<Dynamic>, ?index:Int):Void`](<#mapiter-function-new>)
...
```haxe
function new(?map:stdgo.GoMap<Dynamic, Dynamic>, ?keys:Array<Dynamic>, ?index:Int):Void
```
