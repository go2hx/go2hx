...
=== RUN  TestGoodCompile
Exception: regexp.testGoodCompile is not yet implemented
...
=== RUN  TestGoodCompile
Exception: regexp.testGoodCompile is not yet implemented
Called from stdgo.regexp._Regexp.Regexp_Fields_.testGoodCompile (stdgo/regexp/Regexp.hx line 994 column 64)
```
</p>
</details>
