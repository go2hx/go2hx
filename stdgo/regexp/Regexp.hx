...
(new stdgo.regexp.Regexp.T_stringError(stdgo.strings.Strings.repeat(("\\pL" : stdgo.GoString), (27000 : stdgo.StdGoTypes.GoInt)), ("expression too large" : stdgo.GoString)) : stdgo.regexp.Regexp.T_stringError)) : stdgo.Slice<stdgo.regexp.Regexp.T_stringError>);
/**
...
72,
72,
(new stdgo.regexp.Regexp.ReplaceTest(stdgo.Go.str(), stdgo.Go.str(), stdgo.Go.str(), stdgo.Go.str()) : stdgo.regexp.Regexp.ReplaceTest),
(new stdgo.regexp.Regexp.ReplaceTest(stdgo.Go.str(), ("x" : stdgo.GoString), stdgo.Go.str(), ("x" : stdgo.GoString)) : stdgo.regexp.Regexp.ReplaceTest),
(new stdgo.regexp.Regexp.ReplaceTest(stdgo.Go.str(), stdgo.Go.str(), ("abc" : stdgo.GoString), ("abc" : stdgo.GoString)) : stdgo.regexp.Regexp.ReplaceTest),
(new stdgo.regexp.Regexp.ReplaceTest(stdgo.Go.str(), ("x" : stdgo.GoString), ("abc" : stdgo.GoString), ("xaxbxcx" : stdgo.GoString)) : stdgo.regexp.Regexp.ReplaceTest),
(new stdgo.regexp.Regexp.ReplaceTest(("b" : stdgo.GoString), stdgo.Go.str(), stdgo.Go.str(), stdgo.Go.str()) : stdgo.regexp.Regexp.ReplaceTest),
(new stdgo.regexp.Regexp.ReplaceTest(("b" : stdgo.GoString), ("x" : stdgo.GoString), stdgo.Go.str(), stdgo.Go.str()) : stdgo.regexp.Regexp.ReplaceTest),
(new stdgo.regexp.Regexp.ReplaceTest(("b" : stdgo.GoString), stdgo.Go.str(), ("abc" : stdgo.GoString), ("ac" : stdgo.GoString)) : stdgo.regexp.Regexp.ReplaceTest),
...
(new stdgo.regexp.Regexp.ReplaceTest(("y" : stdgo.GoString), stdgo.Go.str(), stdgo.Go.str(), stdgo.Go.str()) : stdgo.regexp.Regexp.ReplaceTest),
(new stdgo.regexp.Regexp.ReplaceTest(("y" : stdgo.GoString), ("x" : stdgo.GoString), stdgo.Go.str(), stdgo.Go.str()) : stdgo.regexp.Regexp.ReplaceTest),
(new stdgo.regexp.Regexp.ReplaceTest(("y" : stdgo.GoString), stdgo.Go.str(), ("abc" : stdgo.GoString), ("abc" : stdgo.GoString)) : stdgo.regexp.Regexp.ReplaceTest),
...
(new stdgo.regexp.Regexp.ReplaceTest(("^[a-c]*" : stdgo.GoString), ("x" : stdgo.GoString), stdgo.Go.str(), ("x" : stdgo.GoString)) : stdgo.regexp.Regexp.ReplaceTest),
(new stdgo.regexp.Regexp.ReplaceTest(("[a-c]*$" : stdgo.GoString), ("x" : stdgo.GoString), stdgo.Go.str(), ("x" : stdgo.GoString)) : stdgo.regexp.Regexp.ReplaceTest),
(new stdgo.regexp.Regexp.ReplaceTest(("^[a-c]*$" : stdgo.GoString), ("x" : stdgo.GoString), stdgo.Go.str(), ("x" : stdgo.GoString)) : stdgo.regexp.Regexp.ReplaceTest),
(new stdgo.regexp.Regexp.ReplaceTest(("^[a-c]+" : stdgo.GoString), ("x" : stdgo.GoString), ("abcdabc" : stdgo.GoString), ("xdabc" : stdgo.GoString)) : stdgo.regexp.Regexp.ReplaceTest),
(new stdgo.regexp.Regexp.ReplaceTest(("[a-c]+$" : stdgo.GoString), ("x" : stdgo.GoString), ("abcdabc" : stdgo.GoString), ("abcdx" : stdgo.GoString)) : stdgo.regexp.Regexp.ReplaceTest),
...
(new stdgo.regexp.Regexp.ReplaceTest(("[a-c]+$" : stdgo.GoString), ("x" : stdgo.GoString), ("dabce" : stdgo.GoString), ("dabce" : stdgo.GoString)) : stdgo.regexp.Regexp.ReplaceTest),
(new stdgo.regexp.Regexp.ReplaceTest(("^[a-c]+$" : stdgo.GoString), ("x" : stdgo.GoString), ("dabce" : stdgo.GoString), ("dabce" : stdgo.GoString)) : stdgo.regexp.Regexp.ReplaceTest),
(new stdgo.regexp.Regexp.ReplaceTest(("^[a-c]+" : stdgo.GoString), ("x" : stdgo.GoString), stdgo.Go.str(), stdgo.Go.str()) : stdgo.regexp.Regexp.ReplaceTest),
(new stdgo.regexp.Regexp.ReplaceTest(("[a-c]+$" : stdgo.GoString), ("x" : stdgo.GoString), stdgo.Go.str(), stdgo.Go.str()) : stdgo.regexp.Regexp.ReplaceTest),
(new stdgo.regexp.Regexp.ReplaceTest(("^[a-c]+$" : stdgo.GoString), ("x" : stdgo.GoString), stdgo.Go.str(), stdgo.Go.str()) : stdgo.regexp.Regexp.ReplaceTest),
...
(new stdgo.regexp.Regexp.ReplaceTest(("abc" : stdgo.GoString), stdgo.Go.str(), ("abcdabc" : stdgo.GoString), ("d" : stdgo.GoString)) : stdgo.regexp.Regexp.ReplaceTest),
...
(new stdgo.regexp.Regexp.ReplaceTest(("abc" : stdgo.GoString), ("d" : stdgo.GoString), stdgo.Go.str(), stdgo.Go.str()) : stdgo.regexp.Regexp.ReplaceTest),
...
(new stdgo.regexp.Regexp.ReplaceTest(("(?P<x>hi)|(?P<x>bye)" : stdgo.GoString), ("$xyz" : stdgo.GoString), ("hi" : stdgo.GoString), stdgo.Go.str()) : stdgo.regexp.Regexp.ReplaceTest),
...
var _replaceFuncTests : stdgo.Slice<stdgo.regexp.Regexp.ReplaceFuncTest> = (new stdgo.Slice<stdgo.regexp.Regexp.ReplaceFuncTest>(3, 3, (new stdgo.regexp.Regexp.ReplaceFuncTest(("[a-c]" : stdgo.GoString), function(_s:stdgo.GoString):stdgo.GoString {
        return (("x" : stdgo.GoString) + _s) + ("y" : stdgo.GoString);
...
11,
11,
(new stdgo.regexp.Regexp.MetaTest(("^0^0$" : stdgo.GoString), stdgo.Go.str(), ("0" : stdgo.GoString), false) : stdgo.regexp.Regexp.MetaTest),
(new stdgo.regexp.Regexp.MetaTest(("^0^" : stdgo.GoString), stdgo.Go.str(), stdgo.Go.str(), false) : stdgo.regexp.Regexp.MetaTest),
(new stdgo.regexp.Regexp.MetaTest(("^0$" : stdgo.GoString), stdgo.Go.str(), ("0" : stdgo.GoString), true) : stdgo.regexp.Regexp.MetaTest),
(new stdgo.regexp.Regexp.MetaTest(("$0^" : stdgo.GoString), stdgo.Go.str(), stdgo.Go.str(), false) : stdgo.regexp.Regexp.MetaTest),
(new stdgo.regexp.Regexp.MetaTest(("$0$" : stdgo.GoString), stdgo.Go.str(), stdgo.Go.str(), false) : stdgo.regexp.Regexp.MetaTest),
(new stdgo.regexp.Regexp.MetaTest(("^^0$$" : stdgo.GoString), stdgo.Go.str(), stdgo.Go.str(), false) : stdgo.regexp.Regexp.MetaTest),
(new stdgo.regexp.Regexp.MetaTest(("^$^$" : stdgo.GoString), stdgo.Go.str(), stdgo.Go.str(), false) : stdgo.regexp.Regexp.MetaTest),
(new stdgo.regexp.Regexp.MetaTest(("$$0^^" : stdgo.GoString), stdgo.Go.str(), stdgo.Go.str(), false) : stdgo.regexp.Regexp.MetaTest),
(new stdgo.regexp.Regexp.MetaTest(("a\\x{fffd}b" : stdgo.GoString), stdgo.Go.str(), ("a" : stdgo.GoString), false) : stdgo.regexp.Regexp.MetaTest),
(new stdgo.regexp.Regexp.MetaTest(("\\x{fffd}b" : stdgo.GoString), stdgo.Go.str(), stdgo.Go.str(), false) : stdgo.regexp.Regexp.MetaTest),
(new stdgo.regexp.Regexp.MetaTest(("�" : stdgo.GoString), stdgo.Go.str(), stdgo.Go.str(), false) : stdgo.regexp.Regexp.MetaTest)) : stdgo.Slice<stdgo.regexp.Regexp.MetaTest>);
/**
    
    
    
**/
var _emptySubexpIndices : stdgo.Slice<stdgo.regexp.Regexp.T_subexpIndex> = (new stdgo.Slice<stdgo.regexp.Regexp.T_subexpIndex>(2, 2, (new stdgo.regexp.Regexp.T_subexpIndex(stdgo.Go.str(), (-1 : stdgo.StdGoTypes.GoInt)) : stdgo.regexp.Regexp.T_subexpIndex), (new stdgo.regexp.Regexp.T_subexpIndex(("missing" : stdgo.GoString), (-1 : stdgo.StdGoTypes.GoInt)) : stdgo.regexp.Regexp.T_subexpIndex)) : stdgo.Slice<stdgo.regexp.Regexp.T_subexpIndex>);
/**
...
11,
11,
(new stdgo.regexp.Regexp.T_subexpCase(stdgo.Go.str(), (0 : stdgo.StdGoTypes.GoInt), (null : stdgo.Slice<stdgo.GoString>), _emptySubexpIndices) : stdgo.regexp.Regexp.T_subexpCase),
...
(new stdgo.regexp.Regexp.T_subexpCase(("ab(b)a" : stdgo.GoString), (1 : stdgo.StdGoTypes.GoInt), (new stdgo.Slice<stdgo.GoString>(2, 2, stdgo.Go.str(), stdgo.Go.str()) : stdgo.Slice<stdgo.GoString>), _emptySubexpIndices) : stdgo.regexp.Regexp.T_subexpCase),
(new stdgo.regexp.Regexp.T_subexpCase(("ab(.*)a" : stdgo.GoString), (1 : stdgo.StdGoTypes.GoInt), (new stdgo.Slice<stdgo.GoString>(2, 2, stdgo.Go.str(), stdgo.Go.str()) : stdgo.Slice<stdgo.GoString>), _emptySubexpIndices) : stdgo.regexp.Regexp.T_subexpCase),
(new stdgo.regexp.Regexp.T_subexpCase(("(.*)ab(.*)a" : stdgo.GoString), (2 : stdgo.StdGoTypes.GoInt), (new stdgo.Slice<stdgo.GoString>(3, 3, stdgo.Go.str(), stdgo.Go.str(), stdgo.Go.str()) : stdgo.Slice<stdgo.GoString>), _emptySubexpIndices) : stdgo.regexp.Regexp.T_subexpCase),
(new stdgo.regexp.Regexp.T_subexpCase(("(.*)(ab)(.*)a" : stdgo.GoString), (3 : stdgo.StdGoTypes.GoInt), (new stdgo.Slice<stdgo.GoString>(4, 4, stdgo.Go.str(), stdgo.Go.str(), stdgo.Go.str(), stdgo.Go.str()) : stdgo.Slice<stdgo.GoString>), _emptySubexpIndices) : stdgo.regexp.Regexp.T_subexpCase),
(new stdgo.regexp.Regexp.T_subexpCase(("(.*)((a)b)(.*)a" : stdgo.GoString), (4 : stdgo.StdGoTypes.GoInt), (new stdgo.Slice<stdgo.GoString>(5, 5, stdgo.Go.str(), stdgo.Go.str(), stdgo.Go.str(), stdgo.Go.str(), stdgo.Go.str()) : stdgo.Slice<stdgo.GoString>), _emptySubexpIndices) : stdgo.regexp.Regexp.T_subexpCase),
(new stdgo.regexp.Regexp.T_subexpCase(("(.*)(\\(ab)(.*)a" : stdgo.GoString), (3 : stdgo.StdGoTypes.GoInt), (new stdgo.Slice<stdgo.GoString>(4, 4, stdgo.Go.str(), stdgo.Go.str(), stdgo.Go.str(), stdgo.Go.str()) : stdgo.Slice<stdgo.GoString>), _emptySubexpIndices) : stdgo.regexp.Regexp.T_subexpCase),
(new stdgo.regexp.Regexp.T_subexpCase(("(.*)(\\(a\\)b)(.*)a" : stdgo.GoString), (3 : stdgo.StdGoTypes.GoInt), (new stdgo.Slice<stdgo.GoString>(4, 4, stdgo.Go.str(), stdgo.Go.str(), stdgo.Go.str(), stdgo.Go.str()) : stdgo.Slice<stdgo.GoString>), _emptySubexpIndices) : stdgo.regexp.Regexp.T_subexpCase),
(new stdgo.regexp.Regexp.T_subexpCase(("(?P<foo>.*)(?P<bar>(a)b)(?P<foo>.*)a" : stdgo.GoString), (4 : stdgo.StdGoTypes.GoInt), (new stdgo.Slice<stdgo.GoString>(5, 5, stdgo.Go.str(), ("foo" : stdgo.GoString), ("bar" : stdgo.GoString), stdgo.Go.str(), ("foo" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>), (new stdgo.Slice<stdgo.regexp.Regexp.T_subexpIndex>(4, 4, (new stdgo.regexp.Regexp.T_subexpIndex(stdgo.Go.str(), (-1 : stdgo.StdGoTypes.GoInt)) : stdgo.regexp.Regexp.T_subexpIndex), (new stdgo.regexp.Regexp.T_subexpIndex(("missing" : stdgo.GoString), (-1 : stdgo.StdGoTypes.GoInt)) : stdgo.regexp.Regexp.T_subexpIndex), (new stdgo.regexp.Regexp.T_subexpIndex(("foo" : stdgo.GoString), (1 : stdgo.StdGoTypes.GoInt)) : stdgo.regexp.Regexp.T_subexpIndex), (new stdgo.regexp.Regexp.T_subexpIndex(("bar" : stdgo.GoString), (2 : stdgo.StdGoTypes.GoInt)) : stdgo.regexp.Regexp.T_subexpIndex)) : stdgo.Slice<stdgo.regexp.Regexp.T_subexpIndex>)) : stdgo.regexp.Regexp.T_subexpCase)) : stdgo.Slice<stdgo.regexp.Regexp.T_subexpCase>);
/**
...
({ _s : ("foo:and:bar" : stdgo.GoString), _r : ("foo" : stdgo.GoString), _n : (-1 : stdgo.StdGoTypes.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(2, 2, stdgo.Go.str(), (":and:bar" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("foo:and:bar" : stdgo.GoString), _r : ("bar" : stdgo.GoString), _n : (-1 : stdgo.StdGoTypes.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(2, 2, ("foo:and:" : stdgo.GoString), stdgo.Go.str()) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
...
({ _s : ("baabaab" : stdgo.GoString), _r : ("a" : stdgo.GoString), _n : (-1 : stdgo.StdGoTypes.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(5, 5, ("b" : stdgo.GoString), stdgo.Go.str(), ("b" : stdgo.GoString), stdgo.Go.str(), ("b" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
...
({ _s : ("baabaab" : stdgo.GoString), _r : ("ba*" : stdgo.GoString), _n : (-1 : stdgo.StdGoTypes.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(4, 4, stdgo.Go.str(), stdgo.Go.str(), stdgo.Go.str(), stdgo.Go.str()) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("foobar" : stdgo.GoString), _r : ("f*b*" : stdgo.GoString), _n : (-1 : stdgo.StdGoTypes.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(5, 5, stdgo.Go.str(), ("o" : stdgo.GoString), ("o" : stdgo.GoString), ("a" : stdgo.GoString), ("r" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("foobar" : stdgo.GoString), _r : ("f+.*b+" : stdgo.GoString), _n : (-1 : stdgo.StdGoTypes.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(2, 2, stdgo.Go.str(), ("ar" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
...
({ _s : ("," : stdgo.GoString), _r : ("," : stdgo.GoString), _n : (-1 : stdgo.StdGoTypes.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(2, 2, stdgo.Go.str(), stdgo.Go.str()) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : (",,," : stdgo.GoString), _r : ("," : stdgo.GoString), _n : (-1 : stdgo.StdGoTypes.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(4, 4, stdgo.Go.str(), stdgo.Go.str(), stdgo.Go.str(), stdgo.Go.str()) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : stdgo.Go.str(), _r : ("," : stdgo.GoString), _n : (-1 : stdgo.StdGoTypes.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(1, 1, stdgo.Go.str()) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : stdgo.Go.str(), _r : (".*" : stdgo.GoString), _n : (-1 : stdgo.StdGoTypes.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(1, 1, stdgo.Go.str()) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : stdgo.Go.str(), _r : (".+" : stdgo.GoString), _n : (-1 : stdgo.StdGoTypes.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(1, 1, stdgo.Go.str()) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : stdgo.Go.str(), _r : stdgo.Go.str(), _n : (-1 : stdgo.StdGoTypes.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(0, 0) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("foobar" : stdgo.GoString), _r : stdgo.Go.str(), _n : (-1 : stdgo.StdGoTypes.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(6, 6, ("f" : stdgo.GoString), ("o" : stdgo.GoString), ("o" : stdgo.GoString), ("b" : stdgo.GoString), ("a" : stdgo.GoString), ("r" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : ("abaabaccadaaae" : stdgo.GoString), _r : ("a*" : stdgo.GoString), _n : (5 : stdgo.StdGoTypes.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(5, 5, stdgo.Go.str(), ("b" : stdgo.GoString), ("b" : stdgo.GoString), ("c" : stdgo.GoString), ("cadaaae" : stdgo.GoString)) : stdgo.Slice<stdgo.GoString>) } : T__struct_0),
({ _s : (":x:y:z:" : stdgo.GoString), _r : (":" : stdgo.GoString), _n : (-1 : stdgo.StdGoTypes.GoInt), _out : (new stdgo.Slice<stdgo.GoString>(5, 5, stdgo.Go.str(), ("x" : stdgo.GoString), ("y" : stdgo.GoString), ("z" : stdgo.GoString), stdgo.Go.str()) : stdgo.Slice<stdgo.GoString>) } : T__struct_0)) : stdgo.Slice<T__struct_0>);
/**
    
    
    
**/
var _compileBenchData : stdgo.Slice<T__struct_2> = (new stdgo.Slice<T__struct_2>(3, 3, ({ _name : ("Onepass" : stdgo.GoString), _re : ("^a.[l-nA-Cg-j]?e$" : stdgo.GoString) } : T__struct_2), ({ _name : ("Medium" : stdgo.GoString), _re : ("^((a|b|[d-z0-9])*(日){4,5}.)+$" : stdgo.GoString) } : T__struct_2), ({ _name : ("Hard" : stdgo.GoString), _re : stdgo.strings.Strings.repeat(("((abc)*|" : stdgo.GoString), (50 : stdgo.StdGoTypes.GoInt)) + stdgo.strings.Strings.repeat((")" : stdgo.GoString), (50 : stdgo.StdGoTypes.GoInt)) } : T__struct_2)) : stdgo.Slice<T__struct_2>);
/**
...
12,
12,
({ regexp : stdgo.Go.str(), _min : (0 : stdgo.StdGoTypes.GoInt) } : T__struct_3),
...
85,
85,
(new stdgo.regexp.Regexp.FindTest(stdgo.Go.str(), stdgo.Go.str(), _build((1 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt))) : stdgo.regexp.Regexp.FindTest),
...
(new stdgo.regexp.Regexp.FindTest(("()" : stdgo.GoString), stdgo.Go.str(), _build((1 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt))) : stdgo.regexp.Regexp.FindTest),
...
(new stdgo.regexp.Regexp.FindTest(("(?:.|(?:.a))" : stdgo.GoString), stdgo.Go.str(), (null : stdgo.Slice<stdgo.Slice<stdgo.StdGoTypes.GoInt>>)) : stdgo.regexp.Regexp.FindTest),
...
(new stdgo.regexp.Regexp.FindTest(("(a){0}" : stdgo.GoString), stdgo.Go.str(), _build((1 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (-1 : stdgo.StdGoTypes.GoInt), (-1 : stdgo.StdGoTypes.GoInt))) : stdgo.regexp.Regexp.FindTest),
...
(new stdgo.regexp.Regexp.FindTest(("\\`" : stdgo.GoString), ("`" : stdgo.GoString), _build((1 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (1 : stdgo.StdGoTypes.GoInt))) : stdgo.regexp.Regexp.FindTest),
(new stdgo.regexp.Regexp.FindTest(("[\\`]+" : stdgo.GoString), ("`" : stdgo.GoString), _build((1 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (1 : stdgo.StdGoTypes.GoInt))) : stdgo.regexp.Regexp.FindTest),
(new stdgo.regexp.Regexp.FindTest(("�" : stdgo.GoString), stdgo.Go.str(255), _build((1 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (1 : stdgo.StdGoTypes.GoInt))) : stdgo.regexp.Regexp.FindTest),
(new stdgo.regexp.Regexp.FindTest(("�" : stdgo.GoString), stdgo.Go.str("hello", 255, "world"), _build((1 : stdgo.StdGoTypes.GoInt), (5 : stdgo.StdGoTypes.GoInt), (6 : stdgo.StdGoTypes.GoInt))) : stdgo.regexp.Regexp.FindTest),
(new stdgo.regexp.Regexp.FindTest((".*" : stdgo.GoString), stdgo.Go.str("hello", 255, "world"), _build((1 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (11 : stdgo.StdGoTypes.GoInt))) : stdgo.regexp.Regexp.FindTest),
(new stdgo.regexp.Regexp.FindTest(("\\x{fffd}" : stdgo.GoString), stdgo.Go.str(194, 0), _build((1 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (1 : stdgo.StdGoTypes.GoInt))) : stdgo.regexp.Regexp.FindTest),
(new stdgo.regexp.Regexp.FindTest(("[�]" : stdgo.GoString), stdgo.Go.str(255), _build((1 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (1 : stdgo.StdGoTypes.GoInt))) : stdgo.regexp.Regexp.FindTest),
(new stdgo.regexp.Regexp.FindTest(("[\\x{fffd}]" : stdgo.GoString), stdgo.Go.str(194, 0), _build((1 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (1 : stdgo.StdGoTypes.GoInt))) : stdgo.regexp.Regexp.FindTest),
...
({ _re : (("^l" : stdgo.GoString) + stdgo.strings.Strings.repeat(("o" : stdgo.GoString), (512 : stdgo.StdGoTypes.GoInt))) + ("ng$" : stdgo.GoString), _isOnePass : true } : T__struct_6)) : stdgo.Slice<T__struct_6>);
/**
...
function _compileTest(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>, _expr:stdgo.GoString, _error:stdgo.GoString):stdgo.StdGoTypes.Ref<Regexp> {
        var __tmp__ = compile(_expr), _re:stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.Regexp> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        ...
        } else if ((_error != stdgo.Go.str()) && !stdgo.strings.Strings.contains(_err.error(), _error)) {
...
function testGoodCompile(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        {
            ...
            stdgo.Go.cfor(_i < (_goodRe.length), _i++, {
                _compileTest(_t, _goodRe[(_i : stdgo.StdGoTypes.GoInt)], stdgo.Go.str());
            });
        };
    }
function testBadCompile(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        {
            ...
            stdgo.Go.cfor(_i < (_badRe.length), _i++, {
                _compileTest(_t, _badRe[(_i : stdgo.StdGoTypes.GoInt)]._re, _badRe[(_i : stdgo.StdGoTypes.GoInt)]._err);
            });
        };
    }
function _matchTest(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>, _test:stdgo.StdGoTypes.Ref<FindTest>):Void {
        var _re = _compileTest(_t, _test._pat, stdgo.Go.str());
...
function _matchFunctionTest(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>, _test:stdgo.StdGoTypes.Ref<FindTest>):Void {
        var __tmp__ = matchString(_test._pat, _test._text), _m:Bool = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err == null) {
            return;
        };
        if (_m != ((_test._matches.length > (0 : stdgo.StdGoTypes.GoInt)))) {
...
function testReplaceAll(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _tc in _replaceTests) {
            var __tmp__ = compile(_tc._pattern), _re:stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.Regexp> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                _t.errorf(("Unexpected error compiling %q: %v" : stdgo.GoString), stdgo.Go.toInterface(_tc._pattern), stdgo.Go.toInterface(_err));
                continue;
            };
            var _actual:stdgo.GoString = _re.replaceAllString(_tc._input, _tc._replacement);
            ...
            _actual = (_re.replaceAll((_tc._input : stdgo.Slice<stdgo.StdGoTypes.GoByte>), (_tc._replacement : stdgo.Slice<stdgo.StdGoTypes.GoByte>)) : stdgo.GoString);
            if (_actual != (_tc._output)) {
...
function testReplaceAllLiteral(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _tc in _replaceTests) {
            if (stdgo.strings.Strings.contains(_tc._replacement, ("$" : stdgo.GoString))) {
                continue;
            };
            var __tmp__ = compile(_tc._pattern), _re:stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.Regexp> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
            ...
            var _actual:stdgo.GoString = _re.replaceAllLiteralString(_tc._input, _tc._replacement);
            if (_actual != (_tc._output)) {
            ...
            _actual = (_re.replaceAllLiteral((_tc._input : stdgo.Slice<stdgo.StdGoTypes.GoByte>), (_tc._replacement : stdgo.Slice<stdgo.StdGoTypes.GoByte>)) : stdgo.GoString);
            if (_actual != (_tc._output)) {
...
function testReplaceAllFunc(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _tc in _replaceFuncTests) {
            ...
            var _actual:stdgo.GoString = _re.replaceAllStringFunc(_tc._input, _tc._replacement);
            if (_actual != (_tc._output)) {
            ...
            _actual = (_re.replaceAllFunc((_tc._input : stdgo.Slice<stdgo.StdGoTypes.GoByte>), function(_s:stdgo.Slice<stdgo.StdGoTypes.GoByte>):stdgo.Slice<stdgo.StdGoTypes.GoByte> {
                return (_tc._replacement((_s : stdgo.GoString)) : stdgo.Slice<stdgo.StdGoTypes.GoByte>);
            }) : stdgo.GoString);
            if (_actual != (_tc._output)) {
                _t.errorf(("%q.ReplaceFunc(%q,fn) = %q; want %q" : stdgo.GoString), stdgo.Go.toInterface(_tc._pattern), stdgo.Go.toInterface(_tc._input), stdgo.Go.toInterface(_actual), stdgo.Go.toInterface(_tc._output));
            };
...
function testQuoteMeta(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _tc in _metaTests) {
            var _quoted:stdgo.GoString = quoteMeta(_tc._pattern);
            ...
            if (_tc._pattern != (stdgo.Go.str())) {
                var __tmp__ = compile(_quoted), _re:stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.Regexp> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                if (_err != null) {
                ...
                var _src:stdgo.GoString = (("abc" : stdgo.GoString) + _tc._pattern) + ("def" : stdgo.GoString);
                var _repl:stdgo.GoString = ("xyz" : stdgo.GoString);
                var _replaced:stdgo.GoString = _re.replaceAllString(_src, _repl);
...
function testSubexp(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _c in _subexpCases) {
            ...
            for (__1 => _subexp in _c._indices) {
                var _index:stdgo.StdGoTypes.GoInt = _re.subexpIndex(_subexp._name);
...
function testSplit(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (_i => _test in _splitTests) {
            var __tmp__ = compile(_test._r), _re:stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.Regexp> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
...
function testParseAndCompile(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        for (_i => _tc in (new stdgo.Slice<T__struct_1>(2, 2, ({ _reFlags : (212 : stdgo.regexp.syntax.Syntax.Flags), _expMatch : false } : T__struct_1), ({ _reFlags : (196 : stdgo.regexp.syntax.Syntax.Flags), _expMatch : true } : T__struct_1)) : stdgo.Slice<T__struct_1>)) {
            var __tmp__ = stdgo.regexp.syntax.Syntax.parse(_expr, _tc._reFlags), _parsed:stdgo.StdGoTypes.Ref<stdgo.regexp.syntax.Syntax.Regexp> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                _t.fatalf(("%d: parse: %v" : stdgo.GoString), stdgo.Go.toInterface(_i), stdgo.Go.toInterface(_err));
            };
            var __tmp__ = compile((_parsed.string() : stdgo.GoString)), _re:stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.Regexp> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
...
function benchmarkFind(_b:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.B>):Void {
        ...
        var _s = ((("acbb" : stdgo.GoString) + _wantSubs) + ("dd" : stdgo.GoString) : stdgo.Slice<stdgo.StdGoTypes.GoByte>);
        _b.startTimer();
        _b.reportAllocs();
        {
            var _i:stdgo.StdGoTypes.GoInt = (0 : stdgo.StdGoTypes.GoInt);
...
function benchmarkFindString(_b:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.B>):Void {
        ...
        var _re = mustCompile(("a+b+" : stdgo.GoString));
        var _wantSubs:stdgo.GoString = ("aaabb" : stdgo.GoString);
        var _s:stdgo.GoString = (("acbb" : stdgo.GoString) + _wantSubs) + ("dd" : stdgo.GoString);
        _b.startTimer();
        _b.reportAllocs();
        {
            var _i:stdgo.StdGoTypes.GoInt = (0 : stdgo.StdGoTypes.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
                var _subs:stdgo.GoString = _re.findString(_s);
                if (_subs != (_wantSubs)) {
...
function benchmarkLiteral(_b:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.B>):Void {
        var _x:stdgo.GoString = stdgo.strings.Strings.repeat(("x" : stdgo.GoString), (50 : stdgo.StdGoTypes.GoInt)) + ("y" : stdgo.GoString);
        _b.stopTimer();
...
function benchmarkMatchClass(_b:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.B>):Void {
        _b.stopTimer();
        var _x:stdgo.GoString = stdgo.strings.Strings.repeat(("xxxx" : stdgo.GoString), (20 : stdgo.StdGoTypes.GoInt)) + ("w" : stdgo.GoString);
...
function benchmarkMatchClass_InRange(_b:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.B>):Void {
        _b.stopTimer();
        var _x:stdgo.GoString = stdgo.strings.Strings.repeat(("bbbb" : stdgo.GoString), (20 : stdgo.StdGoTypes.GoInt)) + ("c" : stdgo.GoString);
...
function benchmarkReplaceAll(_b:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.B>):Void {
        ...
        _b.startTimer();
        {
            var _i:stdgo.StdGoTypes.GoInt = (0 : stdgo.StdGoTypes.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
                _re.replaceAllString(_x, stdgo.Go.str());
            });
        };
    }
...
function benchmarkQuoteMetaAll(_b:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.B>):Void {
        ...
        var _s:stdgo.GoString = (_specials : stdgo.GoString);
...
function benchmarkCompile(_b:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.B>):Void {
        for (__0 => _data in _compileBenchData) {
            _b.run(_data._name, function(_b:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.B>):Void {
                _b.reportAllocs();
                {
                    var _i:stdgo.StdGoTypes.GoInt = (0 : stdgo.StdGoTypes.GoInt);
                    stdgo.Go.cfor(_i < _b.n, _i++, {
                        {
                            var __tmp__ = compile(_data._re), __8:stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.Regexp> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                            if (_err != null) {
...
function testDeepEqual(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        _re2.matchString(stdgo.strings.Strings.repeat(("abcdefghijklmn" : stdgo.GoString), (100 : stdgo.StdGoTypes.GoInt)));
        if (!stdgo.reflect.Reflect.deepEqual(stdgo.Go.toInterface(stdgo.Go.asInterface(_re1)), stdgo.Go.toInterface(stdgo.Go.asInterface(_re2)))) {
            _t.errorf(("DeepEqual(re1, re2) = false, want true" : stdgo.GoString));
        };
    }
function testMinInputLen(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _tt in _minInputLenTests) {
            var __tmp__ = stdgo.regexp.syntax.Syntax.parse(_tt.regexp, (212 : stdgo.regexp.syntax.Syntax.Flags)), _re:stdgo.StdGoTypes.Ref<stdgo.regexp.syntax.Syntax.Regexp> = __tmp__._0, __1:stdgo.Error = __tmp__._1;
...
function testUnmarshalText(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        for (_i in 0 ... _goodRe.length.toBasic()) {
            var _re = _compileTest(_t, _goodRe[(_i : stdgo.StdGoTypes.GoInt)], stdgo.Go.str());
...
function _testRE2(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>, _file:stdgo.GoString):Void {
        ...
        try {
            var __tmp__ = stdgo.os.Os.open(_file), _f:stdgo.StdGoTypes.Ref<stdgo.os.Os.File> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
                _t.fatal(stdgo.Go.toInterface(_err));
            };
            __deferstack__.unshift(() -> _f.close());
            var _txt:stdgo.io.Io.Reader = (null : stdgo.io.Io.Reader);
            if (stdgo.strings.Strings.hasSuffix(_file, (".bz2" : stdgo.GoString))) {
                var _z:stdgo.io.Io.Reader = stdgo.compress.bzip2.Bzip2.newReader(stdgo.Go.asInterface(_f));
                _txt = _z;
                _file = (_file.__slice__(0, (_file.length) - ((".bz2" : stdgo.GoString).length)) : stdgo.GoString);
            } else {
            ...
            var __0:stdgo.Slice<stdgo.GoString> = (null : stdgo.Slice<stdgo.GoString>), __1:stdgo.Slice<stdgo.GoString> = (null : stdgo.Slice<stdgo.GoString>), __2:Bool = false, __3:stdgo.StdGoTypes.Ref<Regexp> = (null : stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.Regexp>), __4:stdgo.StdGoTypes.Ref<Regexp> = (null : stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.Regexp>), __5:stdgo.StdGoTypes.GoInt = (0 : stdgo.StdGoTypes.GoInt), __6:stdgo.StdGoTypes.GoInt = (0 : stdgo.StdGoTypes.GoInt), _ncase:stdgo.StdGoTypes.GoInt = __6, _nfail:stdgo.StdGoTypes.GoInt = __5, _refull:stdgo.StdGoTypes.Ref<Regexp> = __4, _re:stdgo.StdGoTypes.Ref<Regexp> = __3, _inStrings:Bool = __2, _input:stdgo.Slice<stdgo.GoString> = __1, _str:stdgo.Slice<stdgo.GoString> = __0;
            {
                ...
                stdgo.Go.cfor(_scanner.scan(), _lineno++, {
                    var _line:stdgo.GoString = _scanner.text();
                    if (_line == (stdgo.Go.str())) {
                        ...
                        var __tmp__ = stdgo.strconv.Strconv.unquote(_line), _q:stdgo.GoString = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                        if (_err != null) {
                        ...
                        var _full:stdgo.GoString = (("\\A(?:" : stdgo.GoString) + _q) + (")\\z" : stdgo.GoString);
                        {
                        ...
                        {
                            final __tmp__0 = _input[(0 : stdgo.StdGoTypes.GoInt)];
                            final __tmp__1 = (_input.__slice__((1 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.GoString>);
                            _text = __tmp__0;
                            _input = __tmp__1;
                        };
                        if (!_isSingleBytes(_text) && stdgo.strings.Strings.contains((_re.string() : stdgo.GoString), ("\\B" : stdgo.GoString))) {
                            continue;
                        };
                        var _res = stdgo.strings.Strings.split(_line, (";" : stdgo.GoString));
                        ...
                        for (_i in 0 ... _res.length.toBasic()) {
                            var __tmp__ = _run[(_i : stdgo.StdGoTypes.GoInt)](_re, _refull, _text), _have:stdgo.Slice<stdgo.StdGoTypes.GoInt> = __tmp__._0, _suffix:stdgo.GoString = __tmp__._1;
                            var _want = _parseResult(_t, _file, _lineno, _res[(_i : stdgo.StdGoTypes.GoInt)]);
                            ...
                            var __tmp__ = _match[(_i : stdgo.StdGoTypes.GoInt)](_re, _refull, _text), _b:Bool = __tmp__._0, _suffix:stdgo.GoString = __tmp__._1;
                            if (_b != ((_want != null))) {
...
function _runFull(_re:stdgo.StdGoTypes.Ref<Regexp>, _refull:stdgo.StdGoTypes.Ref<Regexp>, _text:stdgo.GoString):{ var _0 : stdgo.Slice<stdgo.StdGoTypes.GoInt>; var _1 : stdgo.GoString; } {
        ...
        return { _0 : _refull.findStringSubmatchIndex(_text), _1 : ("[full]" : stdgo.GoString) };
    }
function _runPartial(_re:stdgo.StdGoTypes.Ref<Regexp>, _refull:stdgo.StdGoTypes.Ref<Regexp>, _text:stdgo.GoString):{ var _0 : stdgo.Slice<stdgo.StdGoTypes.GoInt>; var _1 : stdgo.GoString; } {
        _re._longest = false;
        return { _0 : _re.findStringSubmatchIndex(_text), _1 : stdgo.Go.str() };
    }
function _runFullLongest(_re:stdgo.StdGoTypes.Ref<Regexp>, _refull:stdgo.StdGoTypes.Ref<Regexp>, _text:stdgo.GoString):{ var _0 : stdgo.Slice<stdgo.StdGoTypes.GoInt>; var _1 : stdgo.GoString; } {
        ...
        return { _0 : _refull.findStringSubmatchIndex(_text), _1 : ("[full,longest]" : stdgo.GoString) };
    }
function _runPartialLongest(_re:stdgo.StdGoTypes.Ref<Regexp>, _refull:stdgo.StdGoTypes.Ref<Regexp>, _text:stdgo.GoString):{ var _0 : stdgo.Slice<stdgo.StdGoTypes.GoInt>; var _1 : stdgo.GoString; } {
        _re._longest = true;
        return { _0 : _re.findStringSubmatchIndex(_text), _1 : ("[longest]" : stdgo.GoString) };
    }
function _matchFull(_re:stdgo.StdGoTypes.Ref<Regexp>, _refull:stdgo.StdGoTypes.Ref<Regexp>, _text:stdgo.GoString):{ var _0 : Bool; var _1 : stdgo.GoString; } {
        _refull._longest = false;
        return { _0 : _refull.matchString(_text), _1 : ("[full]" : stdgo.GoString) };
    }
function _matchPartial(_re:stdgo.StdGoTypes.Ref<Regexp>, _refull:stdgo.StdGoTypes.Ref<Regexp>, _text:stdgo.GoString):{ var _0 : Bool; var _1 : stdgo.GoString; } {
        _re._longest = false;
        return { _0 : _re.matchString(_text), _1 : stdgo.Go.str() };
    }
function _matchFullLongest(_re:stdgo.StdGoTypes.Ref<Regexp>, _refull:stdgo.StdGoTypes.Ref<Regexp>, _text:stdgo.GoString):{ var _0 : Bool; var _1 : stdgo.GoString; } {
        _refull._longest = true;
        return { _0 : _refull.matchString(_text), _1 : ("[full,longest]" : stdgo.GoString) };
    }
function _matchPartialLongest(_re:stdgo.StdGoTypes.Ref<Regexp>, _refull:stdgo.StdGoTypes.Ref<Regexp>, _text:stdgo.GoString):{ var _0 : Bool; var _1 : stdgo.GoString; } {
        _re._longest = true;
        return { _0 : _re.matchString(_text), _1 : ("[longest]" : stdgo.GoString) };
    }
        ...
        _n = (0 : stdgo.StdGoTypes.GoInt);
        {
            ...
            stdgo.Go.cfor(_j <= (_res.length), _j++, {
                if ((_j == (_res.length)) || (_res[(_j : stdgo.StdGoTypes.GoInt)] == (32 : stdgo.StdGoTypes.GoUInt8))) {
                    var _pair:stdgo.GoString = (_res.__slice__(_i, _j) : stdgo.GoString);
                    if (_pair == (("-" : stdgo.GoString))) {
                        ...
                        var __tmp__ = stdgo.strings.Strings.cut(_pair, ("-" : stdgo.GoString)), _loStr:stdgo.GoString = __tmp__._0, _hiStr:stdgo.GoString = __tmp__._1, __0:Bool = __tmp__._2;
                        var __tmp__ = stdgo.strconv.Strconv.atoi(_loStr), _lo:stdgo.StdGoTypes.GoInt = __tmp__._0, _err1:stdgo.Error = __tmp__._1;
                        var __tmp__ = stdgo.strconv.Strconv.atoi(_hiStr), _hi:stdgo.StdGoTypes.GoInt = __tmp__._0, _err2:stdgo.Error = __tmp__._1;
...
function _testFowler(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>, _file:stdgo.GoString):Void {
        stdgo.internal.Macro.controlFlow({
            ...
            try {
                ...
                var _lineno:stdgo.StdGoTypes.GoInt = (0 : stdgo.StdGoTypes.GoInt);
                var _lastRegexp:stdgo.GoString = stdgo.Go.str();
                @:label("Reading") while (true) {
                    ...
                    _line = (_line.__slice__(0, (_line.length) - (1 : stdgo.StdGoTypes.GoInt)) : stdgo.GoString);
                    var _field = _notab.findAllString(_line, (-1 : stdgo.StdGoTypes.GoInt));
                    for (_i => _f in _field) {
                        if (_f == (("NULL" : stdgo.GoString))) {
                            _field[(_i : stdgo.StdGoTypes.GoInt)] = stdgo.Go.str();
                        };
                    ...
                    var _flag:stdgo.GoString = _field[(0 : stdgo.StdGoTypes.GoInt)];
                    {
                        ...
                        if (__value__ == ((63 : stdgo.StdGoTypes.GoUInt8)) || __value__ == ((38 : stdgo.StdGoTypes.GoUInt8)) || __value__ == ((124 : stdgo.StdGoTypes.GoUInt8)) || __value__ == ((59 : stdgo.StdGoTypes.GoUInt8)) || __value__ == ((123 : stdgo.StdGoTypes.GoUInt8)) || __value__ == ((125 : stdgo.StdGoTypes.GoUInt8))) {
                            _flag = (_flag.__slice__((1 : stdgo.StdGoTypes.GoInt)) : stdgo.GoString);
                            ...
                            {
                                {
                                    var __tmp__ = stdgo.strings.Strings.cut((_flag.__slice__((1 : stdgo.StdGoTypes.GoInt)) : stdgo.GoString), (":" : stdgo.GoString));
                                    _flag = __tmp__._1;
                                    _ok = __tmp__._2;
                                };
                                if (!_ok) {
                    ...
                    if (stdgo.strings.Strings.contains(_flag, ("$" : stdgo.GoString))) {
                        var _f:stdgo.GoString = (("\"" : stdgo.GoString) + _field[(1 : stdgo.StdGoTypes.GoInt)]) + ("\"" : stdgo.GoString);
                        {
                            {
                                var __tmp__ = stdgo.strconv.Strconv.unquote(_f);
                                _field[(1 : stdgo.StdGoTypes.GoInt)] = __tmp__._0;
                                _err = __tmp__._1;
                            };
                            if (_err != null) {
                        ...
                        _f = (("\"" : stdgo.GoString) + _field[(2 : stdgo.StdGoTypes.GoInt)]) + ("\"" : stdgo.GoString);
                        {
                            {
                                var __tmp__ = stdgo.strconv.Strconv.unquote(_f);
                                _field[(2 : stdgo.StdGoTypes.GoInt)] = __tmp__._0;
                                _err = __tmp__._1;
                            };
                            if (_err != null) {
                                _t.errorf(("%s:%d: cannot unquote %s" : stdgo.GoString), stdgo.Go.toInterface(_file), stdgo.Go.toInterface(_lineno), stdgo.Go.toInterface(_f));
                    ...
                    if (_field[(1 : stdgo.StdGoTypes.GoInt)] == (("SAME" : stdgo.GoString))) {
                        _field[(1 : stdgo.StdGoTypes.GoInt)] = _lastRegexp;
                    };
                    _lastRegexp = _field[(1 : stdgo.StdGoTypes.GoInt)];
                    var _text:stdgo.GoString = _field[(2 : stdgo.StdGoTypes.GoInt)];
                    var __tmp__ = _parseFowlerResult(_field[(3 : stdgo.StdGoTypes.GoInt)]), _ok:Bool = __tmp__._0, _shouldCompile:Bool = __tmp__._1, _shouldMatch:Bool = __tmp__._2, _pos:stdgo.Slice<stdgo.StdGoTypes.GoInt> = __tmp__._3;
                    if (!_ok) {
                    ...
                    @:label("Testing") for (__0 => _c in _flag) {
                        var _pattern:stdgo.GoString = _field[(1 : stdgo.StdGoTypes.GoInt)];
                        ...
                        var __tmp__ = _compile(_pattern, _syn, true), _re:stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.Regexp> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                        if (_err != null) {
                            if (_shouldCompile) {
...
function _parseFowlerResult(_s:stdgo.GoString):{ var _0 : Bool; var _1 : Bool; var _2 : Bool; var _3 : stdgo.Slice<stdgo.StdGoTypes.GoInt>; } {
        ...
        while (_s != (stdgo.Go.str())) {
            ...
            if ((_s.__slice__(0, _i) : stdgo.GoString) != (("?" : stdgo.GoString))) {
                {
                    var __tmp__ = stdgo.strconv.Strconv.atoi((_s.__slice__(0, _i) : stdgo.GoString));
                    _v = __tmp__._0;
                    _err = __tmp__._1;
                };
                if (_err != null) {
            ...
            _x = (_x.__append__(_v));
            _s = (_s.__slice__(_i + (1 : stdgo.StdGoTypes.GoInt)) : stdgo.GoString);
        };
        if ((_x.length) % (2 : stdgo.StdGoTypes.GoInt) != ((0 : stdgo.StdGoTypes.GoInt))) {
            _ok = false;
            return { _0 : _ok, _1 : _compiled, _2 : _matched, _3 : _pos };
...
function benchmarkMatch(_b:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.B>):Void {
        ...
        for (__0 => _data in _benchData) {
            ...
            for (__1 => _size in _benchSizes) {
                ...
                _b.run((_data._name + ("/" : stdgo.GoString)) + _size._name, function(_b:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.B>):Void {
...
function benchmarkMatch_onepass_regex(_b:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.B>):Void {
        ...
        for (__0 => _size in _benchSizes) {
            ...
            var _t = _makeText(_size._n);
            _b.run(_size._name, function(_b:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.B>):Void {
                _b.setBytes((_size._n : stdgo.StdGoTypes.GoInt64));
                _b.reportAllocs();
                {
                    var _i:stdgo.StdGoTypes.GoInt = (0 : stdgo.StdGoTypes.GoInt);
...
function testLongest(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        {
            var __0:stdgo.GoString = _re.findString(("ab" : stdgo.GoString)), __1:stdgo.GoString = ("a" : stdgo.GoString), _w:stdgo.GoString = __1, _g:stdgo.GoString = __0;
            if (_g != (_w)) {
        ...
        _re.longest();
        {
            var __0:stdgo.GoString = _re.findString(("ab" : stdgo.GoString)), __1:stdgo.GoString = ("ab" : stdgo.GoString), _w:stdgo.GoString = __1, _g:stdgo.GoString = __0;
            if (_g != (_w)) {
...
function testFind(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _test in _findTests) {
            ...
            if ((_test._matches.length == (0 : stdgo.StdGoTypes.GoInt)) && (_result.length == (0 : stdgo.StdGoTypes.GoInt))) {} else if ((_test._matches == null) && (_result != null)) {
                ...
                var _expect:stdgo.GoString = (_test._text.__slice__(_test._matches[(0 : stdgo.StdGoTypes.GoInt)][(0 : stdgo.StdGoTypes.GoInt)], _test._matches[(0 : stdgo.StdGoTypes.GoInt)][(1 : stdgo.StdGoTypes.GoInt)]) : stdgo.GoString);
...
function testFindString(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _test in _findTests) {
            var _result:stdgo.GoString = mustCompile(_test._pat).findString(_test._text);
...
function testFindIndex(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _test in _findTests) {
            _testFindIndex((stdgo.Go.setRef(_test) : stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.FindTest>), mustCompile(_test._pat).findIndex((_test._text : stdgo.Slice<stdgo.StdGoTypes.GoByte>)), _t);
        };
    }
function testFindStringIndex(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _test in _findTests) {
            _testFindIndex((stdgo.Go.setRef(_test) : stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.FindTest>), mustCompile(_test._pat).findStringIndex(_test._text), _t);
        };
    }
function testFindReaderIndex(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _test in _findTests) {
            _testFindIndex((stdgo.Go.setRef(_test) : stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.FindTest>), mustCompile(_test._pat).findReaderIndex(stdgo.Go.asInterface(stdgo.strings.Strings.newReader(_test._text))), _t);
        };
    }
function testFindAll(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _test in _findTests) {
            var _result = mustCompile(_test._pat).findAll((_test._text : stdgo.Slice<stdgo.StdGoTypes.GoByte>), (-1 : stdgo.StdGoTypes.GoInt));
            if ((_test._matches == null) && (_result == null)) {} else if ((_test._matches == null) && (_result != null)) {
                ...
                for (_k => _e in _test._matches) {
                    ...
                    var _expect:stdgo.GoString = (_test._text.__slice__(_e[(0 : stdgo.StdGoTypes.GoInt)], _e[(1 : stdgo.StdGoTypes.GoInt)]) : stdgo.GoString);
...
function testFindAllString(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _test in _findTests) {
            var _result = mustCompile(_test._pat).findAllString(_test._text, (-1 : stdgo.StdGoTypes.GoInt));
            if ((_test._matches == null) && (_result == null)) {} else if ((_test._matches == null) && (_result != null)) {
                _t.errorf(("expected no match; got one: %s" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_test)));
            } else if ((_test._matches != null) && (_result == null)) {
                _t.errorf(("expected match; got none: %s" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_test)));
...
function testFindAllIndex(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _test in _findTests) {
            _testFindAllIndex((stdgo.Go.setRef(_test) : stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.FindTest>), mustCompile(_test._pat).findAllIndex((_test._text : stdgo.Slice<stdgo.StdGoTypes.GoByte>), (-1 : stdgo.StdGoTypes.GoInt)), _t);
        };
    }
function testFindAllStringIndex(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _test in _findTests) {
            _testFindAllIndex((stdgo.Go.setRef(_test) : stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.FindTest>), mustCompile(_test._pat).findAllStringIndex(_test._text, (-1 : stdgo.StdGoTypes.GoInt)), _t);
        };
    }
function _testSubmatchBytes(_test:stdgo.StdGoTypes.Ref<FindTest>, _n:stdgo.StdGoTypes.GoInt, _submatches:stdgo.Slice<stdgo.StdGoTypes.GoInt>, _result:stdgo.Slice<stdgo.Slice<stdgo.StdGoTypes.GoByte>>, _t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        };
        {
            ...
            stdgo.Go.cfor(_k < (_submatches.length), _k = _k + ((2 : stdgo.StdGoTypes.GoInt)), {
                ...
                var _expect:stdgo.GoString = (_test._text.__slice__(_submatches[(_k : stdgo.StdGoTypes.GoInt)], _submatches[(_k + (1 : stdgo.StdGoTypes.GoInt) : stdgo.StdGoTypes.GoInt)]) : stdgo.GoString);
                if (_expect != ((_got : stdgo.GoString))) {
...
function testFindSubmatch(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _test in _findTests) {
            var _result = mustCompile(_test._pat).findSubmatch((_test._text : stdgo.Slice<stdgo.StdGoTypes.GoByte>));
            if ((_test._matches == null) && (_result == null)) {} else if ((_test._matches == null) && (_result != null)) {
                _t.errorf(("expected no match; got one: %s" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_test)));
            } else if ((_test._matches != null) && (_result == null)) {
                _t.errorf(("expected match; got none: %s" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_test)));
...
function testFindSubmatchIndex(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _test in _findTests) {
            _testFindSubmatchIndex((stdgo.Go.setRef(_test) : stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.FindTest>), mustCompile(_test._pat).findSubmatchIndex((_test._text : stdgo.Slice<stdgo.StdGoTypes.GoByte>)), _t);
        };
    }
function testFindStringSubmatchIndex(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _test in _findTests) {
            _testFindSubmatchIndex((stdgo.Go.setRef(_test) : stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.FindTest>), mustCompile(_test._pat).findStringSubmatchIndex(_test._text), _t);
        };
    }
function testFindReaderSubmatchIndex(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _test in _findTests) {
            _testFindSubmatchIndex((stdgo.Go.setRef(_test) : stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.FindTest>), mustCompile(_test._pat).findReaderSubmatchIndex(stdgo.Go.asInterface(stdgo.strings.Strings.newReader(_test._text))), _t);
        };
    }
function testFindAllSubmatch(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _test in _findTests) {
            var _result = mustCompile(_test._pat).findAllSubmatch((_test._text : stdgo.Slice<stdgo.StdGoTypes.GoByte>), (-1 : stdgo.StdGoTypes.GoInt));
            if ((_test._matches == null) && (_result == null)) {} else if ((_test._matches == null) && (_result != null)) {
                _t.errorf(("expected no match; got one: %s" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_test)));
            } else if ((_test._matches != null) && (_result == null)) {
                _t.errorf(("expected match; got none: %s" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_test)));
...
function testFindAllStringSubmatch(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _test in _findTests) {
            var _result = mustCompile(_test._pat).findAllStringSubmatch(_test._text, (-1 : stdgo.StdGoTypes.GoInt));
            if ((_test._matches == null) && (_result == null)) {} else if ((_test._matches == null) && (_result != null)) {
                _t.errorf(("expected no match; got one: %s" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_test)));
            } else if ((_test._matches != null) && (_result == null)) {
                _t.errorf(("expected match; got none: %s" : stdgo.GoString), stdgo.Go.toInterface(stdgo.Go.asInterface(_test)));
...
function testFindAllSubmatchIndex(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _test in _findTests) {
            _testFindAllSubmatchIndex((stdgo.Go.setRef(_test) : stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.FindTest>), mustCompile(_test._pat).findAllSubmatchIndex((_test._text : stdgo.Slice<stdgo.StdGoTypes.GoByte>), (-1 : stdgo.StdGoTypes.GoInt)), _t);
        };
    }
function testFindAllStringSubmatchIndex(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _test in _findTests) {
            _testFindAllSubmatchIndex((stdgo.Go.setRef(_test) : stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.FindTest>), mustCompile(_test._pat).findAllStringSubmatchIndex(_test._text, (-1 : stdgo.StdGoTypes.GoInt)), _t);
        };
    }
/**
...
function _onePassPrefix(_p:stdgo.StdGoTypes.Ref<stdgo.regexp.syntax.Syntax.Prog>):{ var _0 : stdgo.GoString; var _1 : Bool; var _2 : stdgo.StdGoTypes.GoUInt32; } {
        ...
        if ((_i.op != (3 : stdgo.regexp.syntax.Syntax.InstOp)) || (((_i.arg : stdgo.regexp.syntax.Syntax.EmptyOp) & (4 : stdgo.regexp.syntax.Syntax.EmptyOp)) == (0 : stdgo.regexp.syntax.Syntax.EmptyOp))) {
            return { _0 : stdgo.Go.str(), _1 : _i.op == ((4 : stdgo.regexp.syntax.Syntax.InstOp)), _2 : (_p.start : stdgo.StdGoTypes.GoUInt32) };
        };
        _pc = _i.out;
        ...
        return { _0 : (_buf.string() : stdgo.GoString), _1 : _complete, _2 : _pc };
    }
/**
...
function testRunOnePass(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        for (__0 => _test in _onePassTests1) {
            var __tmp__ = compile(_test._re), _re:stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.Regexp> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
            if (_err != null) {
...
function _compile(_expr:stdgo.GoString, _mode:stdgo.regexp.syntax.Syntax.Flags, _longest:Bool):{ var _0 : stdgo.StdGoTypes.Ref<Regexp>; var _1 : stdgo.Error; } {
        var __tmp__ = stdgo.regexp.syntax.Syntax.parse(_expr, _mode), _re:stdgo.StdGoTypes.Ref<stdgo.regexp.syntax.Syntax.Regexp> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
        ...
        var _regexp = (stdgo.Go.setRef(({ _expr : _expr, _prog : _prog, _onepass : _compileOnePass(_prog), _numSubexp : _maxCap, _subexpNames : _capNames, _matchcap : _matchcap, _cond : _prog.startCond(), _minInputLen : _minInputLen(_re), _longest : _longest } : Regexp)) : stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.Regexp>);
...
function mustCompile(_str:stdgo.GoString):stdgo.StdGoTypes.Ref<Regexp> {
        var __tmp__ = compile(_str), _regexp:stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.Regexp> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            throw stdgo.Go.toInterface(((("regexp: Compile(" : stdgo.GoString) + _quote(_str)) + ("): " : stdgo.GoString)) + _err.error());
        };
        return _regexp;
    }
/**
...
function mustCompilePOSIX(_str:stdgo.GoString):stdgo.StdGoTypes.Ref<Regexp> {
        var __tmp__ = compilePOSIX(_str), _regexp:stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.Regexp> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            throw stdgo.Go.toInterface(((("regexp: CompilePOSIX(" : stdgo.GoString) + _quote(_str)) + ("): " : stdgo.GoString)) + _err.error());
        };
        return _regexp;
    }
function _quote(_s:stdgo.GoString):stdgo.GoString {
        if (stdgo.strconv.Strconv.canBackquote(_s)) {
            return (("`" : stdgo.GoString) + _s) + ("`" : stdgo.GoString);
        };
...
function matchReader(_pattern:stdgo.GoString, _r:stdgo.io.Io.RuneReader):{ var _0 : Bool; var _1 : stdgo.Error; } {
        ...
        var __tmp__ = compile(_pattern), _re:stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.Regexp> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
...
function quoteMeta(_s:stdgo.GoString):stdgo.GoString {
        ...
        return ((_b.__slice__(0, _j) : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>) : stdgo.GoString);
    }
/**
...
function _extract(_str:stdgo.GoString):{ var _0 : stdgo.GoString; var _1 : stdgo.StdGoTypes.GoInt; var _2 : stdgo.GoString; var _3 : Bool; } {
        ...
        if (_str[(0 : stdgo.StdGoTypes.GoInt)] == ((123 : stdgo.StdGoTypes.GoUInt8))) {
            _brace = true;
            _str = (_str.__slice__((1 : stdgo.StdGoTypes.GoInt)) : stdgo.GoString);
        };
        var _i:stdgo.StdGoTypes.GoInt = (0 : stdgo.StdGoTypes.GoInt);
        while (_i < (_str.length)) {
            var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRuneInString((_str.__slice__(_i) : stdgo.GoString)), _rune:stdgo.StdGoTypes.GoInt32 = __tmp__._0, _size:stdgo.StdGoTypes.GoInt = __tmp__._1;
        ...
        _name = (_str.__slice__(0, _i) : stdgo.GoString);
        if (_brace) {
        ...
        _rest = (_str.__slice__(_i) : stdgo.GoString);
        _ok = true;
        return { _0 : _name, _1 : _num, _2 : _rest, _3 : _ok };
    }
@:keep var _ = {
...
@:keep @:allow(stdgo.regexp.Regexp.FindTest_asInterface) class FindTest_static_extension {
    ...
    static public function string( _t:FindTest):stdgo.GoString {
        ...
        return stdgo.fmt.Fmt.sprintf(("pat: %#q text: %#q" : stdgo.GoString), stdgo.Go.toInterface(_t._pat), stdgo.Go.toInterface(_t._text));
    }
}
...
@:keep @:allow(stdgo.regexp.Regexp.Regexp_asInterface) class Regexp_static_extension {
    ...
    **/
    ...
    static public function unmarshalText( _re:stdgo.StdGoTypes.Ref<Regexp>, _text:stdgo.Slice<stdgo.StdGoTypes.GoByte>):stdgo.Error {
        ...
        var __tmp__ = compile((_text : stdgo.GoString)), _newRE:stdgo.StdGoTypes.Ref<stdgo.regexp.Regexp.Regexp> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return _err;
        };
        {
    ...
    **/
    ...
    static public function split( _re:stdgo.StdGoTypes.Ref<Regexp>, _s:stdgo.GoString, _n:stdgo.StdGoTypes.GoInt):stdgo.Slice<stdgo.GoString> {
        ...
        if ((_re._expr.length > (0 : stdgo.StdGoTypes.GoInt)) && (_s.length == (0 : stdgo.StdGoTypes.GoInt))) {
            return (new stdgo.Slice<stdgo.GoString>(1, 1, stdgo.Go.str()) : stdgo.Slice<stdgo.GoString>);
        };
    ...
    **/
    ...
    static public function findAllStringSubmatchIndex( _re:stdgo.StdGoTypes.Ref<Regexp>, _s:stdgo.GoString, _n:stdgo.StdGoTypes.GoInt):stdgo.Slice<stdgo.Slice<stdgo.StdGoTypes.GoInt>> {
        ...
        _re._allMatches(_s, (null : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>), _n, function(_match:stdgo.Slice<stdgo.StdGoTypes.GoInt>):Void {
            if (_result == null) {
        ...
        _re._allMatches(_s, (null : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>), _n, function(_match:stdgo.Slice<stdgo.StdGoTypes.GoInt>):Void {
            ...
            for (_j in 0 ... _slice.length.toBasic()) {
                if (_match[((2 : stdgo.StdGoTypes.GoInt) * _j : stdgo.StdGoTypes.GoInt)] >= (0 : stdgo.StdGoTypes.GoInt)) {
                    _slice[(_j : stdgo.StdGoTypes.GoInt)] = (_s.__slice__(_match[((2 : stdgo.StdGoTypes.GoInt) * _j : stdgo.StdGoTypes.GoInt)], _match[(((2 : stdgo.StdGoTypes.GoInt) * _j) + (1 : stdgo.StdGoTypes.GoInt) : stdgo.StdGoTypes.GoInt)]) : stdgo.GoString);
                };
            };
    ...
    **/
    ...
    static public function findAllSubmatchIndex( _re:stdgo.StdGoTypes.Ref<Regexp>, _b:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _n:stdgo.StdGoTypes.GoInt):stdgo.Slice<stdgo.Slice<stdgo.StdGoTypes.GoInt>> {
        ...
        var _result:stdgo.Slice<stdgo.Slice<stdgo.StdGoTypes.GoInt>> = (null : stdgo.Slice<stdgo.Slice<stdgo.StdGoTypes.GoInt>>);
        _re._allMatches(stdgo.Go.str(), _b, _n, function(_match:stdgo.Slice<stdgo.StdGoTypes.GoInt>):Void {
            if (_result == null) {
                _result = new stdgo.Slice<stdgo.Slice<stdgo.StdGoTypes.GoInt>>((0 : stdgo.StdGoTypes.GoInt).toBasic(), (10 : stdgo.StdGoTypes.GoInt));
            };
            _result = (_result.__append__(_match));
    ...
    **/
    ...
    static public function findAllString( _re:stdgo.StdGoTypes.Ref<Regexp>, _s:stdgo.GoString, _n:stdgo.StdGoTypes.GoInt):stdgo.Slice<stdgo.GoString> {
        ...
        _re._allMatches(_s, (null : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>), _n, function(_match:stdgo.Slice<stdgo.StdGoTypes.GoInt>):Void {
            ...
            _result = (_result.__append__((_s.__slice__(_match[(0 : stdgo.StdGoTypes.GoInt)], _match[(1 : stdgo.StdGoTypes.GoInt)]) : stdgo.GoString)));
        });
        return _result;
    }
    /**
    ...
    **/
    ...
    static public function findReaderSubmatchIndex( _re:stdgo.StdGoTypes.Ref<Regexp>, _r:stdgo.io.Io.RuneReader):stdgo.Slice<stdgo.StdGoTypes.GoInt> {
        @:recv var _re:stdgo.StdGoTypes.Ref<Regexp> = _re;
        return _re._pad(_re._doExecute(_r, (null : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>), stdgo.Go.str(), (0 : stdgo.StdGoTypes.GoInt), _re._prog.numCap, (null : stdgo.Slice<stdgo.StdGoTypes.GoInt>)));
    }
    /**
        // FindStringSubmatchIndex returns a slice holding the index pairs
        // identifying the leftmost match of the regular expression in s and the
    ...
    **/
    ...
    static public function findStringSubmatchIndex( _re:stdgo.StdGoTypes.Ref<Regexp>, _s:stdgo.GoString):stdgo.Slice<stdgo.StdGoTypes.GoInt> {
        @:recv var _re:stdgo.StdGoTypes.Ref<Regexp> = _re;
        return _re._pad(_re._doExecute((null : stdgo.io.Io.RuneReader), (null : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>), _s, (0 : stdgo.StdGoTypes.GoInt), _re._prog.numCap, (null : stdgo.Slice<stdgo.StdGoTypes.GoInt>)));
    }
    /**
        // FindStringSubmatch returns a slice of strings holding the text of the
        // leftmost match of the regular expression in s and the matches, if any, of
    ...
    **/
    ...
    static public function findStringSubmatch( _re:stdgo.StdGoTypes.Ref<Regexp>, _s:stdgo.GoString):stdgo.Slice<stdgo.GoString> {
        ...
        var _a = _re._doExecute((null : stdgo.io.Io.RuneReader), (null : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>), _s, (0 : stdgo.StdGoTypes.GoInt), _re._prog.numCap, (_dstCap.__slice__(0, (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>));
        if (_a == null) {
            return (null : stdgo.Slice<stdgo.GoString>);
        };
        ...
        for (_i in 0 ... _ret.length.toBasic()) {
            if ((((2 : stdgo.StdGoTypes.GoInt) * _i) < _a.length) && (_a[((2 : stdgo.StdGoTypes.GoInt) * _i : stdgo.StdGoTypes.GoInt)] >= (0 : stdgo.StdGoTypes.GoInt))) {
                _ret[(_i : stdgo.StdGoTypes.GoInt)] = (_s.__slice__(_a[((2 : stdgo.StdGoTypes.GoInt) * _i : stdgo.StdGoTypes.GoInt)], _a[(((2 : stdgo.StdGoTypes.GoInt) * _i) + (1 : stdgo.StdGoTypes.GoInt) : stdgo.StdGoTypes.GoInt)]) : stdgo.GoString);
            };
        };
        return _ret;
    }
    ...
    **/
    ...
    static public function findSubmatchIndex( _re:stdgo.StdGoTypes.Ref<Regexp>, _b:stdgo.Slice<stdgo.StdGoTypes.GoByte>):stdgo.Slice<stdgo.StdGoTypes.GoInt> {
        @:recv var _re:stdgo.StdGoTypes.Ref<Regexp> = _re;
        return _re._pad(_re._doExecute((null : stdgo.io.Io.RuneReader), _b, stdgo.Go.str(), (0 : stdgo.StdGoTypes.GoInt), _re._prog.numCap, (null : stdgo.Slice<stdgo.StdGoTypes.GoInt>)));
    }
    @:keep
    static public function _expand( _re:stdgo.StdGoTypes.Ref<Regexp>, _dst:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _template:stdgo.GoString, _bsrc:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _src:stdgo.GoString, _match:stdgo.Slice<stdgo.StdGoTypes.GoInt>):stdgo.Slice<stdgo.StdGoTypes.GoByte> {
        ...
        while ((_template.length) > (0 : stdgo.StdGoTypes.GoInt)) {
            var __tmp__ = stdgo.strings.Strings.cut(_template, ("$" : stdgo.GoString)), _before:stdgo.GoString = __tmp__._0, _after:stdgo.GoString = __tmp__._1, _ok:Bool = __tmp__._2;
            if (!_ok) {
                break;
            };
            ...
            if ((_template != stdgo.Go.str()) && (_template[(0 : stdgo.StdGoTypes.GoInt)] == (36 : stdgo.StdGoTypes.GoUInt8))) {
                ...
                _template = (_template.__slice__((1 : stdgo.StdGoTypes.GoInt)) : stdgo.GoString);
                continue;
            };
            var __tmp__ = _extract(_template), _name:stdgo.GoString = __tmp__._0, _num:stdgo.StdGoTypes.GoInt = __tmp__._1, _rest:stdgo.GoString = __tmp__._2, _ok:Bool = __tmp__._3;
            if (!_ok) {
                _dst = (_dst.__append__((36 : stdgo.StdGoTypes.GoUInt8)));
                continue;
            };
    ...
    **/
    ...
    static public function expandString( _re:stdgo.StdGoTypes.Ref<Regexp>, _dst:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _template:stdgo.GoString, _src:stdgo.GoString, _match:stdgo.Slice<stdgo.StdGoTypes.GoInt>):stdgo.Slice<stdgo.StdGoTypes.GoByte> {
        @:recv var _re:stdgo.StdGoTypes.Ref<Regexp> = _re;
        return _re._expand(_dst, _template, (null : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>), _src, _match);
    }
    /**
        // Expand appends template to dst and returns the result; during the
        // append, Expand replaces variables in the template with corresponding
    ...
    **/
    ...
    static public function expand( _re:stdgo.StdGoTypes.Ref<Regexp>, _dst:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _template:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _src:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _match:stdgo.Slice<stdgo.StdGoTypes.GoInt>):stdgo.Slice<stdgo.StdGoTypes.GoByte> {
        @:recv var _re:stdgo.StdGoTypes.Ref<Regexp> = _re;
        return _re._expand(_dst, (_template : stdgo.GoString), _src, stdgo.Go.str(), _match);
    }
    /**
        // FindSubmatch returns a slice of slices holding the text of the leftmost
        // match of the regular expression in b and the matches, if any, of its
    ...
    **/
    ...
    static public function findSubmatch( _re:stdgo.StdGoTypes.Ref<Regexp>, _b:stdgo.Slice<stdgo.StdGoTypes.GoByte>):stdgo.Slice<stdgo.Slice<stdgo.StdGoTypes.GoByte>> {
        @:recv var _re:stdgo.StdGoTypes.Ref<Regexp> = _re;
        var _dstCap:stdgo.GoArray<stdgo.StdGoTypes.GoInt> = new stdgo.GoArray<stdgo.StdGoTypes.GoInt>(...[for (i in 0 ... 4) (0 : stdgo.StdGoTypes.GoInt)]);
        var _a = _re._doExecute((null : stdgo.io.Io.RuneReader), _b, stdgo.Go.str(), (0 : stdgo.StdGoTypes.GoInt), _re._prog.numCap, (_dstCap.__slice__(0, (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>));
        if (_a == null) {
    ...
    **/
    ...
    static public function findReaderIndex( _re:stdgo.StdGoTypes.Ref<Regexp>, _r:stdgo.io.Io.RuneReader):stdgo.Slice<stdgo.StdGoTypes.GoInt> {
        ...
        var _a = _re._doExecute(_r, (null : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>), stdgo.Go.str(), (0 : stdgo.StdGoTypes.GoInt), (2 : stdgo.StdGoTypes.GoInt), (null : stdgo.Slice<stdgo.StdGoTypes.GoInt>));
        if (_a == null) {
            return (null : stdgo.Slice<stdgo.StdGoTypes.GoInt>);
        };
    ...
    **/
    ...
    static public function findStringIndex( _re:stdgo.StdGoTypes.Ref<Regexp>, _s:stdgo.GoString):stdgo.Slice<stdgo.StdGoTypes.GoInt> {
        @:recv var _re:stdgo.StdGoTypes.Ref<Regexp> = _re;
        var _loc:stdgo.Slice<stdgo.StdGoTypes.GoInt> = (null : stdgo.Slice<stdgo.StdGoTypes.GoInt>);
        var _a = _re._doExecute((null : stdgo.io.Io.RuneReader), (null : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>), _s, (0 : stdgo.StdGoTypes.GoInt), (2 : stdgo.StdGoTypes.GoInt), (null : stdgo.Slice<stdgo.StdGoTypes.GoInt>));
        if (_a == null) {
            return (null : stdgo.Slice<stdgo.StdGoTypes.GoInt>);
        };
        return (_a.__slice__((0 : stdgo.StdGoTypes.GoInt), (2 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>);
    ...
    **/
    ...
    static public function findString( _re:stdgo.StdGoTypes.Ref<Regexp>, _s:stdgo.GoString):stdgo.GoString {
        ...
        var _a = _re._doExecute((null : stdgo.io.Io.RuneReader), (null : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>), _s, (0 : stdgo.StdGoTypes.GoInt), (2 : stdgo.StdGoTypes.GoInt), (_dstCap.__slice__(0, (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>));
        if (_a == null) {
            return stdgo.Go.str();
        };
        return (_s.__slice__(_a[(0 : stdgo.StdGoTypes.GoInt)], _a[(1 : stdgo.StdGoTypes.GoInt)]) : stdgo.GoString);
    }
    /**
        // FindIndex returns a two-element slice of integers defining the location of
        // the leftmost match in b of the regular expression. The match itself is at
    ...
    **/
    ...
    static public function findIndex( _re:stdgo.StdGoTypes.Ref<Regexp>, _b:stdgo.Slice<stdgo.StdGoTypes.GoByte>):stdgo.Slice<stdgo.StdGoTypes.GoInt> {
        @:recv var _re:stdgo.StdGoTypes.Ref<Regexp> = _re;
        var _loc:stdgo.Slice<stdgo.StdGoTypes.GoInt> = (null : stdgo.Slice<stdgo.StdGoTypes.GoInt>);
        var _a = _re._doExecute((null : stdgo.io.Io.RuneReader), _b, stdgo.Go.str(), (0 : stdgo.StdGoTypes.GoInt), (2 : stdgo.StdGoTypes.GoInt), (null : stdgo.Slice<stdgo.StdGoTypes.GoInt>));
        if (_a == null) {
            return (null : stdgo.Slice<stdgo.StdGoTypes.GoInt>);
        };
        return (_a.__slice__((0 : stdgo.StdGoTypes.GoInt), (2 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>);
    ...
    **/
    ...
    static public function find( _re:stdgo.StdGoTypes.Ref<Regexp>, _b:stdgo.Slice<stdgo.StdGoTypes.GoByte>):stdgo.Slice<stdgo.StdGoTypes.GoByte> {
        @:recv var _re:stdgo.StdGoTypes.Ref<Regexp> = _re;
        var _dstCap:stdgo.GoArray<stdgo.StdGoTypes.GoInt> = new stdgo.GoArray<stdgo.StdGoTypes.GoInt>(...[for (i in 0 ... 2) (0 : stdgo.StdGoTypes.GoInt)]);
        var _a = _re._doExecute((null : stdgo.io.Io.RuneReader), _b, stdgo.Go.str(), (0 : stdgo.StdGoTypes.GoInt), (2 : stdgo.StdGoTypes.GoInt), (_dstCap.__slice__(0, (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>));
        if (_a == null) {
    ...
    static public function _allMatches( _re:stdgo.StdGoTypes.Ref<Regexp>, _s:stdgo.GoString, _b:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _n:stdgo.StdGoTypes.GoInt, _deliver:stdgo.Slice<stdgo.StdGoTypes.GoInt> -> Void):Void {
        ...
        };
        {
            ...
            while ((_i < _n) && (_pos <= _end)) {
                var _matches = _re._doExecute((null : stdgo.io.Io.RuneReader), _b, _s, _pos, _re._prog.numCap, (null : stdgo.Slice<stdgo.StdGoTypes.GoInt>));
    ...
    **/
    ...
    static public function replaceAllFunc( _re:stdgo.StdGoTypes.Ref<Regexp>, _src:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _repl:stdgo.Slice<stdgo.StdGoTypes.GoByte> -> stdgo.Slice<stdgo.StdGoTypes.GoByte>):stdgo.Slice<stdgo.StdGoTypes.GoByte> {
        @:recv var _re:stdgo.StdGoTypes.Ref<Regexp> = _re;
        return _re._replaceAll(_src, stdgo.Go.str(), (2 : stdgo.StdGoTypes.GoInt), function(_dst:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _match:stdgo.Slice<stdgo.StdGoTypes.GoInt>):stdgo.Slice<stdgo.StdGoTypes.GoByte> {
    ...
    **/
    ...
    static public function replaceAll( _re:stdgo.StdGoTypes.Ref<Regexp>, _src:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _repl:stdgo.Slice<stdgo.StdGoTypes.GoByte>):stdgo.Slice<stdgo.StdGoTypes.GoByte> {
        ...
        var _srepl:stdgo.GoString = stdgo.Go.str();
        var _b = _re._replaceAll(_src, stdgo.Go.str(), _n, function(_dst:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _match:stdgo.Slice<stdgo.StdGoTypes.GoInt>):stdgo.Slice<stdgo.StdGoTypes.GoByte> {
            if ((_srepl.length) != ((_repl.length))) {
                _srepl = (_repl : stdgo.GoString);
            };
            return _re._expand(_dst, _srepl, _src, stdgo.Go.str(), _match);
        });
        return _b;
    }
    @:keep
    static public function _replaceAll( _re:stdgo.StdGoTypes.Ref<Regexp>, _bsrc:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _src:stdgo.GoString, _nmatch:stdgo.StdGoTypes.GoInt, _repl:(_dst:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _m:stdgo.Slice<stdgo.StdGoTypes.GoInt>) -> stdgo.Slice<stdgo.StdGoTypes.GoByte>):stdgo.Slice<stdgo.StdGoTypes.GoByte> {
        ...
        while (_searchPos <= _endPos) {
            var _a = _re._doExecute((null : stdgo.io.Io.RuneReader), _bsrc, _src, _searchPos, _nmatch, (_dstCap.__slice__(0, (0 : stdgo.StdGoTypes.GoInt)) : stdgo.Slice<stdgo.StdGoTypes.GoInt>));
            ...
            if (_bsrc != null) {
                ...
                {
                    var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRuneInString((_src.__slice__(_searchPos) : stdgo.GoString));
                    _width = __tmp__._1;
                };
            };
    ...
    **/
    ...
    static public function replaceAllStringFunc( _re:stdgo.StdGoTypes.Ref<Regexp>, _src:stdgo.GoString, _repl:stdgo.GoString -> stdgo.GoString):stdgo.GoString {
        @:recv var _re:stdgo.StdGoTypes.Ref<Regexp> = _re;
        var _b = _re._replaceAll((null : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>), _src, (2 : stdgo.StdGoTypes.GoInt), function(_dst:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _match:stdgo.Slice<stdgo.StdGoTypes.GoInt>):stdgo.Slice<stdgo.StdGoTypes.GoByte> {
            return (_dst.__append__(..._repl((_src.__slice__(_match[(0 : stdgo.StdGoTypes.GoInt)], _match[(1 : stdgo.StdGoTypes.GoInt)]) : stdgo.GoString)).__toArray__()));
        });
    ...
    **/
    ...
    static public function replaceAllLiteralString( _re:stdgo.StdGoTypes.Ref<Regexp>, _src:stdgo.GoString, _repl:stdgo.GoString):stdgo.GoString {
        @:recv var _re:stdgo.StdGoTypes.Ref<Regexp> = _re;
        return (_re._replaceAll((null : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>), _src, (2 : stdgo.StdGoTypes.GoInt), function(_dst:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _match:stdgo.Slice<stdgo.StdGoTypes.GoInt>):stdgo.Slice<stdgo.StdGoTypes.GoByte> {
            return (_dst.__append__(..._repl.__toArray__()));
        }) : stdgo.GoString);
    }
    /**
    ...
    **/
    ...
    static public function replaceAllString( _re:stdgo.StdGoTypes.Ref<Regexp>, _src:stdgo.GoString, _repl:stdgo.GoString):stdgo.GoString {
        @:recv var _re:stdgo.StdGoTypes.Ref<Regexp> = _re;
        var _n:stdgo.StdGoTypes.GoInt = (2 : stdgo.StdGoTypes.GoInt);
        if (stdgo.strings.Strings.contains(_repl, ("$" : stdgo.GoString))) {
            _n = (2 : stdgo.StdGoTypes.GoInt) * (_re._numSubexp + (1 : stdgo.StdGoTypes.GoInt));
        };
        var _b = _re._replaceAll((null : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>), _src, _n, function(_dst:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _match:stdgo.Slice<stdgo.StdGoTypes.GoInt>):stdgo.Slice<stdgo.StdGoTypes.GoByte> {
            return _re._expand(_dst, _repl, (null : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>), _src, _match);
        });
        return (_b : stdgo.GoString);
    }
    /**
    ...
    **/
    ...
    static public function match( _re:stdgo.StdGoTypes.Ref<Regexp>, _b:stdgo.Slice<stdgo.StdGoTypes.GoByte>):Bool {
        @:recv var _re:stdgo.StdGoTypes.Ref<Regexp> = _re;
        return _re._doMatch((null : stdgo.io.Io.RuneReader), _b, stdgo.Go.str());
    }
    /**
        // MatchString reports whether the string s
        // contains any match of the regular expression re.
    **/
    ...
    static public function matchString( _re:stdgo.StdGoTypes.Ref<Regexp>, _s:stdgo.GoString):Bool {
        @:recv var _re:stdgo.StdGoTypes.Ref<Regexp> = _re;
        return _re._doMatch((null : stdgo.io.Io.RuneReader), (null : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>), _s);
    }
    /**
        // MatchReader reports whether the text returned by the RuneReader
        // contains any match of the regular expression re.
    **/
    ...
    static public function matchReader( _re:stdgo.StdGoTypes.Ref<Regexp>, _r:stdgo.io.Io.RuneReader):Bool {
        @:recv var _re:stdgo.StdGoTypes.Ref<Regexp> = _re;
        return _re._doMatch(_r, (null : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>), stdgo.Go.str());
    }
    /**
        // LiteralPrefix returns a literal string that must begin any match
        // of the regular expression re. It returns the boolean true if the
    ...
    **/
    ...
    static public function _doExecute( _re:stdgo.StdGoTypes.Ref<Regexp>, _r:stdgo.io.Io.RuneReader, _b:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _s:stdgo.GoString, _pos:stdgo.StdGoTypes.GoInt, _ncap:stdgo.StdGoTypes.GoInt, _dstCap:stdgo.Slice<stdgo.StdGoTypes.GoInt>):stdgo.Slice<stdgo.StdGoTypes.GoInt> {
        ...
        var _m = _re._get();
        var __tmp__ = _m._inputs._init(_r, _b, _s), _i:stdgo.regexp.Regexp.T_input = __tmp__._0, __0:stdgo.StdGoTypes.GoInt = __tmp__._1;
        _m._init(_ncap);
    ...
    **/
    ...
    static public function _doMatch( _re:stdgo.StdGoTypes.Ref<Regexp>, _r:stdgo.io.Io.RuneReader, _b:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _s:stdgo.GoString):Bool {
        @:recv var _re:stdgo.StdGoTypes.Ref<Regexp> = _re;
        return _re._doExecute(_r, _b, _s, (0 : stdgo.StdGoTypes.GoInt), (0 : stdgo.StdGoTypes.GoInt), (null : stdgo.Slice<stdgo.StdGoTypes.GoInt>)) != null;
    }
    /**
        // doOnePass implements r.doExecute using the one-pass execution engine.
    **/
    ...
    static public function _doOnePass( _re:stdgo.StdGoTypes.Ref<Regexp>, _ir:stdgo.io.Io.RuneReader, _ib:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _is:stdgo.GoString, _pos:stdgo.StdGoTypes.GoInt, _ncap:stdgo.StdGoTypes.GoInt, _dstCap:stdgo.Slice<stdgo.StdGoTypes.GoInt>):stdgo.Slice<stdgo.StdGoTypes.GoInt> {
        stdgo.internal.Macro.controlFlow({
            ...
            var __tmp__ = _m._inputs._init(_ir, _ib, _is), _i:stdgo.regexp.Regexp.T_input = __tmp__._0, __0:stdgo.StdGoTypes.GoInt = __tmp__._1;
            var __0:stdgo.StdGoTypes.GoInt32 = (-1 : stdgo.StdGoTypes.GoInt32), __1:stdgo.StdGoTypes.GoInt32 = (-1 : stdgo.StdGoTypes.GoInt32), _r1:stdgo.StdGoTypes.GoInt32 = __1, _r:stdgo.StdGoTypes.GoInt32 = __0;
            var __0:stdgo.StdGoTypes.GoInt = (0 : stdgo.StdGoTypes.GoInt), __1:stdgo.StdGoTypes.GoInt = (0 : stdgo.StdGoTypes.GoInt), _width1:stdgo.StdGoTypes.GoInt = __1, _width:stdgo.StdGoTypes.GoInt = __0;
            {
                var __tmp__ = _i._step(_pos);
    ...
    **/
    ...
    static public function _backtrack( _re:stdgo.StdGoTypes.Ref<Regexp>, _ib:stdgo.Slice<stdgo.StdGoTypes.GoByte>, _is:stdgo.GoString, _pos:stdgo.StdGoTypes.GoInt, _ncap:stdgo.StdGoTypes.GoInt, _dstCap:stdgo.Slice<stdgo.StdGoTypes.GoInt>):stdgo.Slice<stdgo.StdGoTypes.GoInt> {
        stdgo.internal.Macro.controlFlow({
            ...
            var _b = _newBitState();
            var __tmp__ = _b._inputs._init((null : stdgo.io.Io.RuneReader), _ib, _is), _i:stdgo.regexp.Regexp.T_input = __tmp__._0, _end:stdgo.StdGoTypes.GoInt = __tmp__._1;
...
@:keep @:allow(stdgo.regexp.Regexp.T_inputString_asInterface) class T_inputString_static_extension {
    ...
    static public function _context( _i:stdgo.StdGoTypes.Ref<T_inputString>, _pos:stdgo.StdGoTypes.GoInt):T_lazyFlag {
        ...
        if ((_pos - (1 : stdgo.StdGoTypes.GoInt) : stdgo.StdGoTypes.GoUInt) < (_i._str.length : stdgo.StdGoTypes.GoUInt)) {
            ...
            if (_r1 >= (128 : stdgo.StdGoTypes.GoInt32)) {
                {
                    var __tmp__ = stdgo.unicode.utf8.Utf8.decodeLastRuneInString((_i._str.__slice__(0, _pos) : stdgo.GoString));
                    _r1 = __tmp__._0;
                };
            };
        };
        if ((_pos : stdgo.StdGoTypes.GoUInt) < (_i._str.length : stdgo.StdGoTypes.GoUInt)) {
            ...
            if (_r2 >= (128 : stdgo.StdGoTypes.GoInt32)) {
                {
                    var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRuneInString((_i._str.__slice__(_pos) : stdgo.GoString));
                    _r2 = __tmp__._0;
                };
            };
        };
    ...
    static public function _index( _i:stdgo.StdGoTypes.Ref<T_inputString>, _re:stdgo.StdGoTypes.Ref<Regexp>, _pos:stdgo.StdGoTypes.GoInt):stdgo.StdGoTypes.GoInt {
        @:recv var _i:stdgo.StdGoTypes.Ref<T_inputString> = _i;
        return stdgo.strings.Strings.index((_i._str.__slice__(_pos) : stdgo.GoString), _re._prefix);
    }
    @:keep
    ...
    static public function _step( _i:stdgo.StdGoTypes.Ref<T_inputString>, _pos:stdgo.StdGoTypes.GoInt):{ var _0 : stdgo.StdGoTypes.GoRune; var _1 : stdgo.StdGoTypes.GoInt; } {
        ...
        if (_pos < (_i._str.length)) {
            ...
            return stdgo.unicode.utf8.Utf8.decodeRuneInString((_i._str.__slice__(_pos) : stdgo.GoString));
        };
