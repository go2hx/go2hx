...
- [class Debug](<#class-debug>)
  ...
  - [`function parseBuildInfo(data:String):stdgo.Tuple<stdgo.runtime.BuildInfo, stdgo.Error>`](<#debug-function-parsebuildinfo>)

  - [`function printStack():Void`](<#debug-function-printstack>)

  - [`function readBuildInfo():stdgo.Tuple<stdgo.runtime.BuildInfo, Bool>`](<#debug-function-readbuildinfo>)

  - [`function readGCStats(stats:stdgo.runtime.GCStats):Void`](<#debug-function-readgcstats>)
...
```haxe
function parseBuildInfo(data:String):stdgo.Tuple<stdgo.runtime.BuildInfo, stdgo.Error>
```


[\(view code\)](<./Debug.hx#L322>)
...
```haxe
function readBuildInfo():stdgo.Tuple<stdgo.runtime.BuildInfo, Bool>
```
...
```haxe
function readGCStats(stats:stdgo.runtime.GCStats):Void
```
