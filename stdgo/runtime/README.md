...
madvdontneed: setting madvdontneed=0 will use MADV\_FREE  



instead of MADV\_DONTNEED on Linux when returning memory to the  
...
Illumos/Solaris, setting madvdontneed=1 will use MADV\_DONTNEED instead  



of MADV\_FREE. This is less efficient, but causes RSS numbers to drop  
...
d, err := syscall.Open\("/file/path", syscall.O\_RDONLY, 0\)  
