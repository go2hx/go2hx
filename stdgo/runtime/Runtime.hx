...
**/
final compiler:GoString = ("" : GoString);
...
@:structInit class MemStats {
	...
	**/
	public var bySize:GoArray<{var size:GoUInt32; var mallocs:GoUInt64; var frees:GoUInt64;}> = new GoArray<{var size:GoUInt32; var mallocs:GoUInt64; var frees:GoUInt64;}>(...[
		for (i in 0...61) {size: (0 : GoUInt32), mallocs: (0 : GoUInt64), frees: (0 : GoUInt64)}
	]);

	public function new(?alloc:GoUInt64, ?totalAlloc:GoUInt64, ?sys:GoUInt64, ?lookups:GoUInt64, ?mallocs:GoUInt64, ?frees:GoUInt64, ?heapAlloc:GoUInt64,
			?heapSys:GoUInt64, ?heapIdle:GoUInt64, ?heapInuse:GoUInt64, ?heapReleased:GoUInt64, ?heapObjects:GoUInt64, ?stackInuse:GoUInt64,
			?stackSys:GoUInt64, ?mspanInuse:GoUInt64, ?mspanSys:GoUInt64, ?mcacheInuse:GoUInt64, ?mcacheSys:GoUInt64, ?buckHashSys:GoUInt64, ?gcsys:GoUInt64,
			?otherSys:GoUInt64, ?nextGC:GoUInt64, ?lastGC:GoUInt64, ?pauseTotalNs:GoUInt64, ?pauseNs:GoArray<GoUInt64>, ?pauseEnd:GoArray<GoUInt64>,
			?numGC:GoUInt32, ?numForcedGC:GoUInt32, ?gccpufraction:GoFloat64, ?enableGC:Bool, ?debugGC:Bool,
			?bySize:GoArray<{var size:GoUInt32; var mallocs:GoUInt64; var frees:GoUInt64;
		}>) {
		if (alloc != null)
			this.alloc = alloc;
		if (totalAlloc != null)
	...
	public function __copy__() {
		return new MemStats(alloc, totalAlloc, sys, lookups, mallocs, frees, heapAlloc, heapSys, heapIdle, heapInuse, heapReleased, heapObjects, stackInuse,
			...
			numForcedGC, gccpufraction, enableGC, debugGC, bySize);
	}
}
...
**/
function setCPUProfileRate(_hz:GoInt):Void
	throw "runtime.setCPUProfileRate is not yet implemented";
...
**/
function cpuprofile():Slice<GoByte>
	throw "runtime.cpuprofile is not yet implemented";
...
**/
function gomaxprocs(_n:GoInt):GoInt
	return 1;
...
**/
function numCPU():GoInt
	throw "runtime.numCPU is not yet implemented";

/**
	// NumCgoCall returns the number of cgo calls made by the current process.
**/
function numCgoCall():GoInt64
	throw "runtime.numCgoCall is not yet implemented";

/**
	// NumGoroutine returns the number of goroutines that currently exist.
**/
function numGoroutine():GoInt
	throw "runtime.numGoroutine is not yet implemented";
...
**/
function caller(_skip:GoInt):{
	var _0:GoUIntptr;
	var _1:GoString;
	var _2:GoInt;
	var _3:Bool;
}
	throw "runtime.caller is not yet implemented";
...
**/
function callers(_skip:GoInt, _pc:Slice<GoUIntptr>):GoInt
	throw "runtime.callers is not yet implemented";
...
function goroot():GoString
	throw "runtime.goroot is not yet implemented";
...
**/
function version():GoString
	throw "runtime.version is not yet implemented";
...
**/
function setFinalizer(_obj:AnyInterface, _finalizer:AnyInterface):Void
	throw "runtime.setFinalizer is not yet implemented";
...
**/
function keepAlive(_x:AnyInterface):Void
	throw "runtime.keepAlive is not yet implemented";
...
**/
function gc():Void
	throw "runtime.gc is not yet implemented";
...
**/
function setBlockProfileRate(_rate:GoInt):Void
	throw "runtime.setBlockProfileRate is not yet implemented";
...
**/
function setMutexProfileFraction(_rate:GoInt):GoInt
	throw "runtime.setMutexProfileFraction is not yet implemented";
...
**/
function memProfile(_p:Slice<MemProfileRecord>, _inuseZero:Bool):{var _0:GoInt; var _1:Bool;}
	throw "runtime.memProfile is not yet implemented";
...
**/
function blockProfile(_p:Slice<BlockProfileRecord>):{var _0:GoInt; var _1:Bool;}
	throw "runtime.blockProfile is not yet implemented";
...
**/
function mutexProfile(_p:Slice<BlockProfileRecord>):{var _0:GoInt; var _1:Bool;}
	throw "runtime.mutexProfile is not yet implemented";
...
**/
function threadCreateProfile(_p:Slice<StackRecord>):{var _0:GoInt; var _1:Bool;}
	throw "runtime.threadCreateProfile is not yet implemented";
...
**/
function goroutineProfile(_p:Slice<StackRecord>):{var _0:GoInt; var _1:Bool;}
	throw "runtime.goroutineProfile is not yet implemented";
...
**/
function stack(_buf:Slice<GoByte>, _all:Bool):GoInt
	throw "runtime.stack is not yet implemented";
...
/**
	...
	// collection cycle.
**/
function readMemStats(_m:Ref<MemStats>):Void
	throw "runtime.readMemStats is not yet implemented";
...
function goexit():Void
	throw "runtime.goexit is not yet implemented";
...
function gosched():Void
	throw "runtime.gosched is not yet implemented";

/**
	// Breakpoint executes a breakpoint trap.
**/
function breakpoint():Void
	throw "runtime.breakpoint is not yet implemented";
...
function lockOSThread():Void
	throw "runtime.lockOSThread is not yet implemented";
...
function unlockOSThread():Void
	throw "runtime.unlockOSThread is not yet implemented";
...
**/
function callersFrames(_callers:Slice<GoUIntptr>):Ref<Frames>
	throw "runtime.callersFrames is not yet implemented";
...
**/
function funcForPC(_pc:GoUIntptr):Ref<Func>
	throw "runtime.funcForPC is not yet implemented";
...
**/
function startTrace():Error
	throw "runtime.startTrace is not yet implemented";
...
function stopTrace():Void
	throw "runtime.stopTrace is not yet implemented";
...
**/
function readTrace():Slice<GoByte>
	throw "runtime.readTrace is not yet implemented";
...
**/
function setCgoTraceback(_version:GoInt, _traceback:stdgo.unsafe.Unsafe.UnsafePointer, _context:stdgo.unsafe.Unsafe.UnsafePointer,
		_symbolizer:stdgo.unsafe.Unsafe.UnsafePointer):Void
	throw "runtime.setCgoTraceback is not yet implemented";
...
@:keep @:allow(stdgo.runtime.Runtime.TypeAssertionError_asInterface) class TypeAssertionError_static_extension {
	@:keep
	static public function error(_e:Ref<TypeAssertionError>):GoString
		throw "runtime.error is not yet implemented";

	@:keep
	static public function runtimeError(_:Ref<TypeAssertionError>):Void
		throw "runtime.runtimeError is not yet implemented";
}
...
@:keep @:allow(stdgo.runtime.Runtime.StackRecord_asInterface) class StackRecord_static_extension {
	...
	**/
	@:keep
	static public function stack(_r:Ref<StackRecord>):Slice<GoUIntptr>
		throw "runtime.stack is not yet implemented";
}
...
@:keep @:allow(stdgo.runtime.Runtime.MemProfileRecord_asInterface) class MemProfileRecord_static_extension {
	...
	**/
	@:keep
	static public function stack(_r:Ref<MemProfileRecord>):Slice<GoUIntptr>
		throw "runtime.stack is not yet implemented";
	...
	**/
	@:keep
	static public function inUseObjects(_r:Ref<MemProfileRecord>):GoInt64
		throw "runtime.inUseObjects is not yet implemented";

	/**
		// InUseBytes returns the number of bytes in use (AllocBytes - FreeBytes).
	**/
	@:keep
	static public function inUseBytes(_r:Ref<MemProfileRecord>):GoInt64
		throw "runtime.inUseBytes is not yet implemented";
}
...
@:keep @:allow(stdgo.runtime.Runtime.BlockProfileRecord_asInterface) class BlockProfileRecord_static_extension {
	@:embedded
	public static function stack(__self__:BlockProfileRecord):Slice<GoUIntptr>
		return __self__.stack();
}
...
@:keep @:allow(stdgo.runtime.Runtime.Frames_asInterface) class Frames_static_extension {
	...
	**/
	@:keep
	static public function next(_ci:Ref<Frames>):{var _0:Frame; var _1:Bool;}
		throw "runtime.next is not yet implemented";
}
...
@:keep @:allow(stdgo.runtime.Runtime.Func_asInterface) class Func_static_extension {
	...
	**/
	@:keep
	static public function fileLine(_f:Ref<Func>, _pc:GoUIntptr):{var _0:GoString; var _1:GoInt;}
		throw "runtime.fileLine is not yet implemented";

	/**
		// Entry returns the entry address of the function.
	**/
	@:keep
	static public function entry(_f:Ref<Func>):GoUIntptr
		throw "runtime.entry is not yet implemented";

	/**
		// Name returns the name of the function.
	**/
	@:keep
	static public function name(_f:Ref<Func>):GoString
		throw "runtime.name is not yet implemented";
}
