...
@:named class Handle {
	public function delete():Void {
		...
		var __tmp__ = _handles.loadAndDelete(Go.toInterface(_h.__t__)),
	...
	public function value():AnyInterface {
		var _h = this.__copy__();
		var __tmp__ = _handles.load(Go.toInterface(_h.__t__)),
...
class Handle_extension_fields {
	...
	public function delete(__tmp__):Void
		__tmp__.delete();
}
