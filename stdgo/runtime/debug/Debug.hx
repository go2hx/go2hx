...
**/
inline function readGCStats(stats:GCStats):Void throw "not implemented";
/**
...
**/
inline function setGCPercent(percent:Int):Int throw "not implemented";
/**
...
**/
inline function freeOSMemory():Void throw "not implemented";
/**
    ...
    // stack growth.
**/
inline function setMaxStack(bytes:Int):Int throw "not implemented";
/**
...
**/
inline function setMaxThreads(threads:Int):Int throw "not implemented";
/**
...
**/
inline function setPanicOnFault(enabled:Bool):Bool throw "not implemented";
/**
...
**/
inline function writeHeapDump(fd:stdgo.GoUIntptr):Void throw "not implemented";
/**
...
**/
inline function setTraceback(level:String):Void throw "not implemented";
/**
...
**/
inline function setMemoryLimit(limit:haxe.Int64):haxe.Int64 throw "not implemented";
/**
...
**/
inline function printStack():Void throw "not implemented";
/**
    // Stack returns a formatted stack trace of the goroutine that calls it.
    // It calls runtime.Stack with a large enough buffer to capture the entire trace.
**/
inline function stack():Array<Int> throw "not implemented";
