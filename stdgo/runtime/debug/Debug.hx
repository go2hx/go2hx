...
@:structInit abstract GCStats(stdgo._internal.runtime.debug.Debug.GCStats) from stdgo._internal.runtime.debug.Debug.GCStats to stdgo._internal.runtime.debug.Debug.GCStats {
...
@:structInit @:using(stdgo.runtime.debug.Debug.BuildInfo_static_extension) abstract BuildInfo(stdgo._internal.runtime.debug.Debug.BuildInfo) from stdgo._internal.runtime.debug.Debug.BuildInfo to stdgo._internal.runtime.debug.Debug.BuildInfo {
...
@:structInit abstract Module(stdgo._internal.runtime.debug.Debug.Module) from stdgo._internal.runtime.debug.Debug.Module to stdgo._internal.runtime.debug.Debug.Module {
    public var path(get, set) : String;
    function get_path():String return this.path;
    function set_path(v:String):String {
        this.path = v;
...
@:structInit abstract BuildSetting(stdgo._internal.runtime.debug.Debug.BuildSetting) from stdgo._internal.runtime.debug.Debug.BuildSetting to stdgo._internal.runtime.debug.Debug.BuildSetting {
