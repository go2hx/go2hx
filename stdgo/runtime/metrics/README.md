...
- [class Metrics](<#class-metrics>)
  ...
  - [`function all():Array<stdgo.runtime.metrics.Description>`](<#metrics-function-all>)

  - [`function read(_m:Array<stdgo.runtime.metrics.Sample>):Void`](<#metrics-function-read>)

- [typedef ValueKind](<#typedef-valuekind>)

- [abstract Description](<#abstract-description>)

- [abstract Float64Histogram](<#abstract-float64histogram>)

- [abstract Sample](<#abstract-sample>)
...
[\(view file containing code\)](<./Metrics.hx>)
