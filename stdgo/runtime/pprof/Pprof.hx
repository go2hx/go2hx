...
/**
    /|*{
    	...
    	if 0 < len(stk) {
    		gotoNext = 3892172
    		_ = gotoNext == 3892172
    		i_3892088_0, x_3892083 = 0, stk[0]
    		gotoNext = 3892173
    		_ = gotoNext == 3892173
    		if i_3892088_0 < len(stk) {
    			gotoNext = 3892098
    			_ = gotoNext == 3892098
    			x_3892083 = stk[i_3892088_0]
    			h_3892059 = h_3892059<<8 | (h_3892059 >> 24)
    			h_3892059 += uintptr(x_3892083) * 41
    			i_3892088_0++
    			gotoNext = 3892173
    		} else {
    			gotoNext = 3892176
    	...
    	_ = gotoNext == 3892176
    	h_3892059 = h_3892059<<8 | (h_3892059 >> 24)
    	h_3892059 += uintptr(tag) * 41
    	gotoNext = 3892299
    	_ = gotoNext == 3892299
    	e_3892312 = m.hash[h_3892059]
    	SearchBreak = false
    	gotoNext = 3892308
    	_ = gotoNext == 3892308
    	if !SearchBreak && (e_3892312 != nil) {
    		gotoNext = 3892362
    		_ = gotoNext == 3892362
    		if len(e_3892312.stk) != len(stk) || e_3892312.tag != tag {
    			gotoNext = 3892408
    			_ = gotoNext == 3892408
    			last_3892280, e_3892312 = e_3892312, e_3892312.nextHash
    			gotoNext = 3892308
    			gotoNext = 3892428
    		} else {
    			gotoNext = 3892428
    		...
    		if 0 < len(stk) {
    			...
    			gotoNext = 3892512
    			_ = gotoNext == 3892512
    			if j_3892432 < len(stk) {
    				gotoNext = 3892447
    				_ = gotoNext == 3892447
    				if e_3892312.stk[j_3892432] != uintptr(stk[j_3892432]) {
    					gotoNext = 3892483
    					_ = gotoNext == 3892483
    					last_3892280, e_3892312 = e_3892312, e_3892312.nextHash
    					gotoNext = 3892308
    		...
    		if last_3892280 != nil {
    			gotoNext = 3892551
    			_ = gotoNext == 3892551
    			last_3892280.nextHash = e_3892312.nextHash
    			e_3892312.nextHash = m.hash[h_3892059]
    			m.hash[h_3892059] = e_3892312
    			gotoNext = 3892632
    		} else {
    			gotoNext = 3892632
    		}
    	...
    	e_3892727 = &m.free[0]
    	m.free = m.free[1:]
    	e_3892727.nextHash = m.hash[h_3892059]
    	e_3892727.tag = tag
    	...
    	_ = gotoNext == 3892931
    	e_3892727.stk = m.freeStk[:len(stk):len(stk)]
    	...
    	if 0 < len(stk) {
    		...
    		gotoNext = 3893056
    		_ = gotoNext == 3893056
    		if j_3893009 < len(stk) {
    			gotoNext = 3893024
    			_ = gotoNext == 3893024
    			e_3892727.stk[j_3893009] = uintptr(stk[j_3893009])
    			j_3893009++
    			gotoNext = 3893056
    		} else {
    			gotoNext = 3893059
