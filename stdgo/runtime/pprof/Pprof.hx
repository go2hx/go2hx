...
/**
    /|*{
    	...
    	if 0 < len(stk) {
    		gotoNext = 3828518
    		_ = gotoNext == 3828518
    		i_3828434_0, x_3828429 = 0, stk[0]
    		gotoNext = 3828519
    		_ = gotoNext == 3828519
    		if i_3828434_0 < len(stk) {
    			gotoNext = 3828444
    			_ = gotoNext == 3828444
    			x_3828429 = stk[i_3828434_0]
    			h_3828405 = h_3828405<<8 | (h_3828405 >> 24)
    			h_3828405 += uintptr(x_3828429) * 41
    			i_3828434_0++
    			gotoNext = 3828519
    		} else {
    			gotoNext = 3828522
    	...
    	_ = gotoNext == 3828522
    	h_3828405 = h_3828405<<8 | (h_3828405 >> 24)
    	h_3828405 += uintptr(tag) * 41
    	gotoNext = 3828645
    	_ = gotoNext == 3828645
    	e_3828658 = m.hash[h_3828405]
    	SearchBreak = false
    	gotoNext = 3828654
    	_ = gotoNext == 3828654
    	if !SearchBreak && (e_3828658 != nil) {
    		gotoNext = 3828708
    		_ = gotoNext == 3828708
    		if len(e_3828658.stk) != len(stk) || e_3828658.tag != tag {
    			gotoNext = 3828754
    			_ = gotoNext == 3828754
    			last_3828626, e_3828658 = e_3828658, e_3828658.nextHash
    			gotoNext = 3828654
    			gotoNext = 3828774
    		} else {
    			gotoNext = 3828774
    		...
    		if 0 < len(stk) {
    			...
    			gotoNext = 3828858
    			_ = gotoNext == 3828858
    			if j_3828778 < len(stk) {
    				gotoNext = 3828793
    				_ = gotoNext == 3828793
    				if e_3828658.stk[j_3828778] != uintptr(stk[j_3828778]) {
    					gotoNext = 3828829
    					_ = gotoNext == 3828829
    					last_3828626, e_3828658 = e_3828658, e_3828658.nextHash
    					gotoNext = 3828654
    		...
    		if last_3828626 != nil {
    			gotoNext = 3828897
    			_ = gotoNext == 3828897
    			last_3828626.nextHash = e_3828658.nextHash
    			e_3828658.nextHash = m.hash[h_3828405]
    			m.hash[h_3828405] = e_3828658
    			gotoNext = 3828978
    		} else {
    			gotoNext = 3828978
    		}
    	...
    	e_3829073 = &m.free[0]
    	m.free = m.free[1:]
    	e_3829073.nextHash = m.hash[h_3828405]
    	e_3829073.tag = tag
    	...
    	_ = gotoNext == 3829277
    	e_3829073.stk = m.freeStk[:len(stk):len(stk)]
    	...
    	if 0 < len(stk) {
    		...
    		gotoNext = 3829402
    		_ = gotoNext == 3829402
    		if j_3829355 < len(stk) {
    			gotoNext = 3829370
    			_ = gotoNext == 3829370
    			e_3829073.stk[j_3829355] = uintptr(stk[j_3829355])
    			j_3829355++
    			gotoNext = 3829402
    		} else {
    			gotoNext = 3829405
