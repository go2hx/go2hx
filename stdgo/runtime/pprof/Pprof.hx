...
/**
    /|*{
    	...
    	if 0 < len(stk) {
    		gotoNext = 3862874
    		_ = gotoNext == 3862874
    		i_3862790_0, x_3862785 = 0, stk[0]
    		gotoNext = 3862875
    		_ = gotoNext == 3862875
    		if i_3862790_0 < len(stk) {
    			gotoNext = 3862800
    			_ = gotoNext == 3862800
    			x_3862785 = stk[i_3862790_0]
    			h_3862761 = h_3862761<<8 | (h_3862761 >> 24)
    			h_3862761 += uintptr(x_3862785) * 41
    			i_3862790_0++
    			gotoNext = 3862875
    		} else {
    			gotoNext = 3862878
    	...
    	_ = gotoNext == 3862878
    	h_3862761 = h_3862761<<8 | (h_3862761 >> 24)
    	h_3862761 += uintptr(tag) * 41
    	gotoNext = 3863001
    	_ = gotoNext == 3863001
    	e_3863014 = m.hash[h_3862761]
    	SearchBreak = false
    	gotoNext = 3863010
    	_ = gotoNext == 3863010
    	if !SearchBreak && (e_3863014 != nil) {
    		gotoNext = 3863064
    		_ = gotoNext == 3863064
    		if len(e_3863014.stk) != len(stk) || e_3863014.tag != tag {
    			gotoNext = 3863110
    			_ = gotoNext == 3863110
    			last_3862982, e_3863014 = e_3863014, e_3863014.nextHash
    			gotoNext = 3863010
    			gotoNext = 3863130
    		} else {
    			gotoNext = 3863130
    		...
    		if 0 < len(stk) {
    			...
    			gotoNext = 3863214
    			_ = gotoNext == 3863214
    			if j_3863134 < len(stk) {
    				gotoNext = 3863149
    				_ = gotoNext == 3863149
    				if e_3863014.stk[j_3863134] != uintptr(stk[j_3863134]) {
    					gotoNext = 3863185
    					_ = gotoNext == 3863185
    					last_3862982, e_3863014 = e_3863014, e_3863014.nextHash
    					gotoNext = 3863010
    		...
    		if last_3862982 != nil {
    			gotoNext = 3863253
    			_ = gotoNext == 3863253
    			last_3862982.nextHash = e_3863014.nextHash
    			e_3863014.nextHash = m.hash[h_3862761]
    			m.hash[h_3862761] = e_3863014
    			gotoNext = 3863334
    		} else {
    			gotoNext = 3863334
    		}
    	...
    	e_3863429 = &m.free[0]
    	m.free = m.free[1:]
    	e_3863429.nextHash = m.hash[h_3862761]
    	e_3863429.tag = tag
    	...
    	_ = gotoNext == 3863633
    	e_3863429.stk = m.freeStk[:len(stk):len(stk)]
    	...
    	if 0 < len(stk) {
    		...
    		gotoNext = 3863758
    		_ = gotoNext == 3863758
    		if j_3863711 < len(stk) {
    			gotoNext = 3863726
    			_ = gotoNext == 3863726
    			e_3863429.stk[j_3863711] = uintptr(stk[j_3863711])
    			j_3863711++
    			gotoNext = 3863758
    		} else {
    			gotoNext = 3863761
