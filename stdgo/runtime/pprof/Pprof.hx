...
/**
    /|*{
    	...
    	if 0 < len(stk) {
    		gotoNext = 3864532
    		_ = gotoNext == 3864532
    		i_3864448_0, x_3864443 = 0, stk[0]
    		gotoNext = 3864533
    		_ = gotoNext == 3864533
    		if i_3864448_0 < len(stk) {
    			gotoNext = 3864458
    			_ = gotoNext == 3864458
    			x_3864443 = stk[i_3864448_0]
    			h_3864419 = h_3864419<<8 | (h_3864419 >> 24)
    			h_3864419 += uintptr(x_3864443) * 41
    			i_3864448_0++
    			gotoNext = 3864533
    		} else {
    			gotoNext = 3864536
    	...
    	_ = gotoNext == 3864536
    	h_3864419 = h_3864419<<8 | (h_3864419 >> 24)
    	h_3864419 += uintptr(tag) * 41
    	gotoNext = 3864659
    	_ = gotoNext == 3864659
    	e_3864672 = m.hash[h_3864419]
    	SearchBreak = false
    	gotoNext = 3864668
    	_ = gotoNext == 3864668
    	if !SearchBreak && (e_3864672 != nil) {
    		gotoNext = 3864722
    		_ = gotoNext == 3864722
    		if len(e_3864672.stk) != len(stk) || e_3864672.tag != tag {
    			gotoNext = 3864768
    			_ = gotoNext == 3864768
    			last_3864640, e_3864672 = e_3864672, e_3864672.nextHash
    			gotoNext = 3864668
    			gotoNext = 3864788
    		} else {
    			gotoNext = 3864788
    		...
    		if 0 < len(stk) {
    			...
    			gotoNext = 3864872
    			_ = gotoNext == 3864872
    			if j_3864792 < len(stk) {
    				gotoNext = 3864807
    				_ = gotoNext == 3864807
    				if e_3864672.stk[j_3864792] != uintptr(stk[j_3864792]) {
    					gotoNext = 3864843
    					_ = gotoNext == 3864843
    					last_3864640, e_3864672 = e_3864672, e_3864672.nextHash
    					gotoNext = 3864668
    		...
    		if last_3864640 != nil {
    			gotoNext = 3864911
    			_ = gotoNext == 3864911
    			last_3864640.nextHash = e_3864672.nextHash
    			e_3864672.nextHash = m.hash[h_3864419]
    			m.hash[h_3864419] = e_3864672
    			gotoNext = 3864992
    		} else {
    			gotoNext = 3864992
    		}
    	...
    	e_3865087 = &m.free[0]
    	m.free = m.free[1:]
    	e_3865087.nextHash = m.hash[h_3864419]
    	e_3865087.tag = tag
    	...
    	_ = gotoNext == 3865291
    	e_3865087.stk = m.freeStk[:len(stk):len(stk)]
    	...
    	if 0 < len(stk) {
    		...
    		gotoNext = 3865416
    		_ = gotoNext == 3865416
    		if j_3865369 < len(stk) {
    			gotoNext = 3865384
    			_ = gotoNext == 3865384
    			e_3865087.stk[j_3865369] = uintptr(stk[j_3865369])
    			j_3865369++
    			gotoNext = 3865416
    		} else {
    			gotoNext = 3865419
