...
/**
    /|*{
    	...
    	if 0 < len(stk) {
    		gotoNext = 3894793
    		_ = gotoNext == 3894793
    		i_3894709_0, x_3894704 = 0, stk[0]
    		gotoNext = 3894794
    		_ = gotoNext == 3894794
    		if i_3894709_0 < len(stk) {
    			gotoNext = 3894719
    			_ = gotoNext == 3894719
    			x_3894704 = stk[i_3894709_0]
    			h_3894680 = h_3894680<<8 | (h_3894680 >> 24)
    			h_3894680 += uintptr(x_3894704) * 41
    			i_3894709_0++
    			gotoNext = 3894794
    		} else {
    			gotoNext = 3894797
    	...
    	_ = gotoNext == 3894797
    	h_3894680 = h_3894680<<8 | (h_3894680 >> 24)
    	h_3894680 += uintptr(tag) * 41
    	gotoNext = 3894920
    	_ = gotoNext == 3894920
    	e_3894933 = m.hash[h_3894680]
    	SearchBreak = false
    	gotoNext = 3894929
    	_ = gotoNext == 3894929
    	if !SearchBreak && (e_3894933 != nil) {
    		gotoNext = 3894983
    		_ = gotoNext == 3894983
    		if len(e_3894933.stk) != len(stk) || e_3894933.tag != tag {
    			gotoNext = 3895029
    			_ = gotoNext == 3895029
    			last_3894901, e_3894933 = e_3894933, e_3894933.nextHash
    			gotoNext = 3894929
    			gotoNext = 3895049
    		} else {
    			gotoNext = 3895049
    		...
    		if 0 < len(stk) {
    			...
    			gotoNext = 3895133
    			_ = gotoNext == 3895133
    			if j_3895053 < len(stk) {
    				gotoNext = 3895068
    				_ = gotoNext == 3895068
    				if e_3894933.stk[j_3895053] != uintptr(stk[j_3895053]) {
    					gotoNext = 3895104
    					_ = gotoNext == 3895104
    					last_3894901, e_3894933 = e_3894933, e_3894933.nextHash
    					gotoNext = 3894929
    		...
    		if last_3894901 != nil {
    			gotoNext = 3895172
    			_ = gotoNext == 3895172
    			last_3894901.nextHash = e_3894933.nextHash
    			e_3894933.nextHash = m.hash[h_3894680]
    			m.hash[h_3894680] = e_3894933
    			gotoNext = 3895253
    		} else {
    			gotoNext = 3895253
    		}
    	...
    	e_3895348 = &m.free[0]
    	m.free = m.free[1:]
    	e_3895348.nextHash = m.hash[h_3894680]
    	e_3895348.tag = tag
    	...
    	_ = gotoNext == 3895552
    	e_3895348.stk = m.freeStk[:len(stk):len(stk)]
    	...
    	if 0 < len(stk) {
    		...
    		gotoNext = 3895677
    		_ = gotoNext == 3895677
    		if j_3895630 < len(stk) {
    			gotoNext = 3895645
    			_ = gotoNext == 3895645
    			e_3895348.stk[j_3895630] = uintptr(stk[j_3895630])
    			j_3895630++
    			gotoNext = 3895677
    		} else {
    			gotoNext = 3895680
