...
/**
    /|*{
    	...
    	if 0 < len(stk) {
    		gotoNext = 3833574
    		_ = gotoNext == 3833574
    		i_3833490_0, x_3833485 = 0, stk[0]
    		gotoNext = 3833575
    		_ = gotoNext == 3833575
    		if i_3833490_0 < len(stk) {
    			gotoNext = 3833500
    			_ = gotoNext == 3833500
    			x_3833485 = stk[i_3833490_0]
    			h_3833461 = h_3833461<<8 | (h_3833461 >> 24)
    			h_3833461 += uintptr(x_3833485) * 41
    			i_3833490_0++
    			gotoNext = 3833575
    		} else {
    			gotoNext = 3833578
    	...
    	_ = gotoNext == 3833578
    	h_3833461 = h_3833461<<8 | (h_3833461 >> 24)
    	h_3833461 += uintptr(tag) * 41
    	gotoNext = 3833701
    	_ = gotoNext == 3833701
    	e_3833714 = m.hash[h_3833461]
    	SearchBreak = false
    	gotoNext = 3833710
    	_ = gotoNext == 3833710
    	if !SearchBreak && (e_3833714 != nil) {
    		gotoNext = 3833764
    		_ = gotoNext == 3833764
    		if len(e_3833714.stk) != len(stk) || e_3833714.tag != tag {
    			gotoNext = 3833810
    			_ = gotoNext == 3833810
    			last_3833682, e_3833714 = e_3833714, e_3833714.nextHash
    			gotoNext = 3833710
    			gotoNext = 3833830
    		} else {
    			gotoNext = 3833830
    		...
    		if 0 < len(stk) {
    			...
    			gotoNext = 3833914
    			_ = gotoNext == 3833914
    			if j_3833834 < len(stk) {
    				gotoNext = 3833849
    				_ = gotoNext == 3833849
    				if e_3833714.stk[j_3833834] != uintptr(stk[j_3833834]) {
    					gotoNext = 3833885
    					_ = gotoNext == 3833885
    					last_3833682, e_3833714 = e_3833714, e_3833714.nextHash
    					gotoNext = 3833710
    		...
    		if last_3833682 != nil {
    			gotoNext = 3833953
    			_ = gotoNext == 3833953
    			last_3833682.nextHash = e_3833714.nextHash
    			e_3833714.nextHash = m.hash[h_3833461]
    			m.hash[h_3833461] = e_3833714
    			gotoNext = 3834034
    		} else {
    			gotoNext = 3834034
    		}
    	...
    	e_3834129 = &m.free[0]
    	m.free = m.free[1:]
    	e_3834129.nextHash = m.hash[h_3833461]
    	e_3834129.tag = tag
    	...
    	_ = gotoNext == 3834333
    	e_3834129.stk = m.freeStk[:len(stk):len(stk)]
    	...
    	if 0 < len(stk) {
    		...
    		gotoNext = 3834458
    		_ = gotoNext == 3834458
    		if j_3834411 < len(stk) {
    			gotoNext = 3834426
    			_ = gotoNext == 3834426
    			e_3834129.stk[j_3834411] = uintptr(stk[j_3834411])
    			j_3834411++
    			gotoNext = 3834458
    		} else {
    			gotoNext = 3834461
