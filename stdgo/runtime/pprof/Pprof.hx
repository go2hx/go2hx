...
/**
    /|*{
    	...
    	if 0 < len(stk) {
    		gotoNext = 3887563
    		_ = gotoNext == 3887563
    		i_3887479_0, x_3887474 = 0, stk[0]
    		gotoNext = 3887564
    		_ = gotoNext == 3887564
    		if i_3887479_0 < len(stk) {
    			gotoNext = 3887489
    			_ = gotoNext == 3887489
    			x_3887474 = stk[i_3887479_0]
    			h_3887450 = h_3887450<<8 | (h_3887450 >> 24)
    			h_3887450 += uintptr(x_3887474) * 41
    			i_3887479_0++
    			gotoNext = 3887564
    		} else {
    			gotoNext = 3887567
    	...
    	_ = gotoNext == 3887567
    	h_3887450 = h_3887450<<8 | (h_3887450 >> 24)
    	h_3887450 += uintptr(tag) * 41
    	gotoNext = 3887690
    	_ = gotoNext == 3887690
    	e_3887703 = m.hash[h_3887450]
    	SearchBreak = false
    	gotoNext = 3887699
    	_ = gotoNext == 3887699
    	if !SearchBreak && (e_3887703 != nil) {
    		gotoNext = 3887753
    		_ = gotoNext == 3887753
    		if len(e_3887703.stk) != len(stk) || e_3887703.tag != tag {
    			gotoNext = 3887799
    			_ = gotoNext == 3887799
    			last_3887671, e_3887703 = e_3887703, e_3887703.nextHash
    			gotoNext = 3887699
    			gotoNext = 3887819
    		} else {
    			gotoNext = 3887819
    		...
    		if 0 < len(stk) {
    			...
    			gotoNext = 3887903
    			_ = gotoNext == 3887903
    			if j_3887823 < len(stk) {
    				gotoNext = 3887838
    				_ = gotoNext == 3887838
    				if e_3887703.stk[j_3887823] != uintptr(stk[j_3887823]) {
    					gotoNext = 3887874
    					_ = gotoNext == 3887874
    					last_3887671, e_3887703 = e_3887703, e_3887703.nextHash
    					gotoNext = 3887699
    		...
    		if last_3887671 != nil {
    			gotoNext = 3887942
    			_ = gotoNext == 3887942
    			last_3887671.nextHash = e_3887703.nextHash
    			e_3887703.nextHash = m.hash[h_3887450]
    			m.hash[h_3887450] = e_3887703
    			gotoNext = 3888023
    		} else {
    			gotoNext = 3888023
    		}
    	...
    	e_3888118 = &m.free[0]
    	m.free = m.free[1:]
    	e_3888118.nextHash = m.hash[h_3887450]
    	e_3888118.tag = tag
    	...
    	_ = gotoNext == 3888322
    	e_3888118.stk = m.freeStk[:len(stk):len(stk)]
    	...
    	if 0 < len(stk) {
    		...
    		gotoNext = 3888447
    		_ = gotoNext == 3888447
    		if j_3888400 < len(stk) {
    			gotoNext = 3888415
    			_ = gotoNext == 3888415
    			e_3888118.stk[j_3888400] = uintptr(stk[j_3888400])
    			j_3888400++
    			gotoNext = 3888447
    		} else {
    			gotoNext = 3888450
