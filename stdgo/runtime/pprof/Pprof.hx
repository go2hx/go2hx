...
/**
    /|*{
    	...
    	if 0 < len(stk) {
    		gotoNext = 3897773
    		_ = gotoNext == 3897773
    		i_3897689_0, x_3897684 = 0, stk[0]
    		gotoNext = 3897774
    		_ = gotoNext == 3897774
    		if i_3897689_0 < len(stk) {
    			gotoNext = 3897699
    			_ = gotoNext == 3897699
    			x_3897684 = stk[i_3897689_0]
    			h_3897660 = h_3897660<<8 | (h_3897660 >> 24)
    			h_3897660 += uintptr(x_3897684) * 41
    			i_3897689_0++
    			gotoNext = 3897774
    		} else {
    			gotoNext = 3897777
    	...
    	_ = gotoNext == 3897777
    	h_3897660 = h_3897660<<8 | (h_3897660 >> 24)
    	h_3897660 += uintptr(tag) * 41
    	gotoNext = 3897900
    	_ = gotoNext == 3897900
    	e_3897913 = m.hash[h_3897660]
    	SearchBreak = false
    	gotoNext = 3897909
    	_ = gotoNext == 3897909
    	if !SearchBreak && (e_3897913 != nil) {
    		gotoNext = 3897963
    		_ = gotoNext == 3897963
    		if len(e_3897913.stk) != len(stk) || e_3897913.tag != tag {
    			gotoNext = 3898009
    			_ = gotoNext == 3898009
    			last_3897881, e_3897913 = e_3897913, e_3897913.nextHash
    			gotoNext = 3897909
    			gotoNext = 3898029
    		} else {
    			gotoNext = 3898029
    		...
    		if 0 < len(stk) {
    			...
    			gotoNext = 3898113
    			_ = gotoNext == 3898113
    			if j_3898033 < len(stk) {
    				gotoNext = 3898048
    				_ = gotoNext == 3898048
    				if e_3897913.stk[j_3898033] != uintptr(stk[j_3898033]) {
    					gotoNext = 3898084
    					_ = gotoNext == 3898084
    					last_3897881, e_3897913 = e_3897913, e_3897913.nextHash
    					gotoNext = 3897909
    		...
    		if last_3897881 != nil {
    			gotoNext = 3898152
    			_ = gotoNext == 3898152
    			last_3897881.nextHash = e_3897913.nextHash
    			e_3897913.nextHash = m.hash[h_3897660]
    			m.hash[h_3897660] = e_3897913
    			gotoNext = 3898233
    		} else {
    			gotoNext = 3898233
    		}
    	...
    	e_3898328 = &m.free[0]
    	m.free = m.free[1:]
    	e_3898328.nextHash = m.hash[h_3897660]
    	e_3898328.tag = tag
    	...
    	_ = gotoNext == 3898532
    	e_3898328.stk = m.freeStk[:len(stk):len(stk)]
    	...
    	if 0 < len(stk) {
    		...
    		gotoNext = 3898657
    		_ = gotoNext == 3898657
    		if j_3898610 < len(stk) {
    			gotoNext = 3898625
    			_ = gotoNext == 3898625
    			e_3898328.stk[j_3898610] = uintptr(stk[j_3898610])
    			j_3898610++
    			gotoNext = 3898657
    		} else {
    			gotoNext = 3898660
