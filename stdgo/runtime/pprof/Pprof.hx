...
/**
    /|*{
    	...
    	if 0 < len(stk) {
    		gotoNext = 3895970
    		_ = gotoNext == 3895970
    		i_3895886_0, x_3895881 = 0, stk[0]
    		gotoNext = 3895971
    		_ = gotoNext == 3895971
    		if i_3895886_0 < len(stk) {
    			gotoNext = 3895896
    			_ = gotoNext == 3895896
    			x_3895881 = stk[i_3895886_0]
    			h_3895857 = h_3895857<<8 | (h_3895857 >> 24)
    			h_3895857 += uintptr(x_3895881) * 41
    			i_3895886_0++
    			gotoNext = 3895971
    		} else {
    			gotoNext = 3895974
    	...
    	_ = gotoNext == 3895974
    	h_3895857 = h_3895857<<8 | (h_3895857 >> 24)
    	h_3895857 += uintptr(tag) * 41
    	gotoNext = 3896097
    	_ = gotoNext == 3896097
    	e_3896110 = m.hash[h_3895857]
    	SearchBreak = false
    	gotoNext = 3896106
    	_ = gotoNext == 3896106
    	if !SearchBreak && (e_3896110 != nil) {
    		gotoNext = 3896160
    		_ = gotoNext == 3896160
    		if len(e_3896110.stk) != len(stk) || e_3896110.tag != tag {
    			gotoNext = 3896206
    			_ = gotoNext == 3896206
    			last_3896078, e_3896110 = e_3896110, e_3896110.nextHash
    			gotoNext = 3896106
    			gotoNext = 3896226
    		} else {
    			gotoNext = 3896226
    		...
    		if 0 < len(stk) {
    			...
    			gotoNext = 3896310
    			_ = gotoNext == 3896310
    			if j_3896230 < len(stk) {
    				gotoNext = 3896245
    				_ = gotoNext == 3896245
    				if e_3896110.stk[j_3896230] != uintptr(stk[j_3896230]) {
    					gotoNext = 3896281
    					_ = gotoNext == 3896281
    					last_3896078, e_3896110 = e_3896110, e_3896110.nextHash
    					gotoNext = 3896106
    		...
    		if last_3896078 != nil {
    			gotoNext = 3896349
    			_ = gotoNext == 3896349
    			last_3896078.nextHash = e_3896110.nextHash
    			e_3896110.nextHash = m.hash[h_3895857]
    			m.hash[h_3895857] = e_3896110
    			gotoNext = 3896430
    		} else {
    			gotoNext = 3896430
    		}
    	...
    	e_3896525 = &m.free[0]
    	m.free = m.free[1:]
    	e_3896525.nextHash = m.hash[h_3895857]
    	e_3896525.tag = tag
    	...
    	_ = gotoNext == 3896729
    	e_3896525.stk = m.freeStk[:len(stk):len(stk)]
    	...
    	if 0 < len(stk) {
    		...
    		gotoNext = 3896854
    		_ = gotoNext == 3896854
    		if j_3896807 < len(stk) {
    			gotoNext = 3896822
    			_ = gotoNext == 3896822
    			e_3896525.stk[j_3896807] = uintptr(stk[j_3896807])
    			j_3896807++
    			gotoNext = 3896854
    		} else {
    			gotoNext = 3896857
