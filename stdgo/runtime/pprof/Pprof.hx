...
/**
    /|*{
    	...
    	if 0 < len(stk) {
    		gotoNext = 3889954
    		_ = gotoNext == 3889954
    		i_3889870_0, x_3889865 = 0, stk[0]
    		gotoNext = 3889955
    		_ = gotoNext == 3889955
    		if i_3889870_0 < len(stk) {
    			gotoNext = 3889880
    			_ = gotoNext == 3889880
    			x_3889865 = stk[i_3889870_0]
    			h_3889841 = h_3889841<<8 | (h_3889841 >> 24)
    			h_3889841 += uintptr(x_3889865) * 41
    			i_3889870_0++
    			gotoNext = 3889955
    		} else {
    			gotoNext = 3889958
    	...
    	_ = gotoNext == 3889958
    	h_3889841 = h_3889841<<8 | (h_3889841 >> 24)
    	h_3889841 += uintptr(tag) * 41
    	gotoNext = 3890081
    	_ = gotoNext == 3890081
    	e_3890094 = m.hash[h_3889841]
    	SearchBreak = false
    	gotoNext = 3890090
    	_ = gotoNext == 3890090
    	if !SearchBreak && (e_3890094 != nil) {
    		gotoNext = 3890144
    		_ = gotoNext == 3890144
    		if len(e_3890094.stk) != len(stk) || e_3890094.tag != tag {
    			gotoNext = 3890190
    			_ = gotoNext == 3890190
    			last_3890062, e_3890094 = e_3890094, e_3890094.nextHash
    			gotoNext = 3890090
    			gotoNext = 3890210
    		} else {
    			gotoNext = 3890210
    		...
    		if 0 < len(stk) {
    			...
    			gotoNext = 3890294
    			_ = gotoNext == 3890294
    			if j_3890214 < len(stk) {
    				gotoNext = 3890229
    				_ = gotoNext == 3890229
    				if e_3890094.stk[j_3890214] != uintptr(stk[j_3890214]) {
    					gotoNext = 3890265
    					_ = gotoNext == 3890265
    					last_3890062, e_3890094 = e_3890094, e_3890094.nextHash
    					gotoNext = 3890090
    		...
    		if last_3890062 != nil {
    			gotoNext = 3890333
    			_ = gotoNext == 3890333
    			last_3890062.nextHash = e_3890094.nextHash
    			e_3890094.nextHash = m.hash[h_3889841]
    			m.hash[h_3889841] = e_3890094
    			gotoNext = 3890414
    		} else {
    			gotoNext = 3890414
    		}
    	...
    	e_3890509 = &m.free[0]
    	m.free = m.free[1:]
    	e_3890509.nextHash = m.hash[h_3889841]
    	e_3890509.tag = tag
    	...
    	_ = gotoNext == 3890713
    	e_3890509.stk = m.freeStk[:len(stk):len(stk)]
    	...
    	if 0 < len(stk) {
    		...
    		gotoNext = 3890838
    		_ = gotoNext == 3890838
    		if j_3890791 < len(stk) {
    			gotoNext = 3890806
    			_ = gotoNext == 3890806
    			e_3890509.stk[j_3890791] = uintptr(stk[j_3890791])
    			j_3890791++
    			gotoNext = 3890838
    		} else {
    			gotoNext = 3890841
