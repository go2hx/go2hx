...
/**
    /|*{
    	...
    	if 0 < len(stk) {
    		gotoNext = 3862881
    		_ = gotoNext == 3862881
    		i_3862797_0, x_3862792 = 0, stk[0]
    		gotoNext = 3862882
    		_ = gotoNext == 3862882
    		if i_3862797_0 < len(stk) {
    			gotoNext = 3862807
    			_ = gotoNext == 3862807
    			x_3862792 = stk[i_3862797_0]
    			h_3862768 = h_3862768<<8 | (h_3862768 >> 24)
    			h_3862768 += uintptr(x_3862792) * 41
    			i_3862797_0++
    			gotoNext = 3862882
    		} else {
    			gotoNext = 3862885
    	...
    	_ = gotoNext == 3862885
    	h_3862768 = h_3862768<<8 | (h_3862768 >> 24)
    	h_3862768 += uintptr(tag) * 41
    	gotoNext = 3863008
    	_ = gotoNext == 3863008
    	e_3863021 = m.hash[h_3862768]
    	SearchBreak = false
    	gotoNext = 3863017
    	_ = gotoNext == 3863017
    	if !SearchBreak && (e_3863021 != nil) {
    		gotoNext = 3863071
    		_ = gotoNext == 3863071
    		if len(e_3863021.stk) != len(stk) || e_3863021.tag != tag {
    			gotoNext = 3863117
    			_ = gotoNext == 3863117
    			last_3862989, e_3863021 = e_3863021, e_3863021.nextHash
    			gotoNext = 3863017
    			gotoNext = 3863137
    		} else {
    			gotoNext = 3863137
    		...
    		if 0 < len(stk) {
    			...
    			gotoNext = 3863221
    			_ = gotoNext == 3863221
    			if j_3863141 < len(stk) {
    				gotoNext = 3863156
    				_ = gotoNext == 3863156
    				if e_3863021.stk[j_3863141] != uintptr(stk[j_3863141]) {
    					gotoNext = 3863192
    					_ = gotoNext == 3863192
    					last_3862989, e_3863021 = e_3863021, e_3863021.nextHash
    					gotoNext = 3863017
    		...
    		if last_3862989 != nil {
    			gotoNext = 3863260
    			_ = gotoNext == 3863260
    			last_3862989.nextHash = e_3863021.nextHash
    			e_3863021.nextHash = m.hash[h_3862768]
    			m.hash[h_3862768] = e_3863021
    			gotoNext = 3863341
    		} else {
    			gotoNext = 3863341
    		}
    	...
    	e_3863436 = &m.free[0]
    	m.free = m.free[1:]
    	e_3863436.nextHash = m.hash[h_3862768]
    	e_3863436.tag = tag
    	...
    	_ = gotoNext == 3863640
    	e_3863436.stk = m.freeStk[:len(stk):len(stk)]
    	...
    	if 0 < len(stk) {
    		...
    		gotoNext = 3863765
    		_ = gotoNext == 3863765
    		if j_3863718 < len(stk) {
    			gotoNext = 3863733
    			_ = gotoNext == 3863733
    			e_3863436.stk[j_3863718] = uintptr(stk[j_3863718])
    			j_3863718++
    			gotoNext = 3863765
    		} else {
    			gotoNext = 3863768
