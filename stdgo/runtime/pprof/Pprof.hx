...
/**
    /|*{
    	...
    	if 0 < len(stk) {
    		gotoNext = 3868937
    		_ = gotoNext == 3868937
    		i_3868853_0, x_3868848 = 0, stk[0]
    		gotoNext = 3868938
    		_ = gotoNext == 3868938
    		if i_3868853_0 < len(stk) {
    			gotoNext = 3868863
    			_ = gotoNext == 3868863
    			x_3868848 = stk[i_3868853_0]
    			h_3868824 = h_3868824<<8 | (h_3868824 >> 24)
    			h_3868824 += uintptr(x_3868848) * 41
    			i_3868853_0++
    			gotoNext = 3868938
    		} else {
    			gotoNext = 3868941
    	...
    	_ = gotoNext == 3868941
    	h_3868824 = h_3868824<<8 | (h_3868824 >> 24)
    	h_3868824 += uintptr(tag) * 41
    	gotoNext = 3869064
    	_ = gotoNext == 3869064
    	e_3869077 = m.hash[h_3868824]
    	SearchBreak = false
    	gotoNext = 3869073
    	_ = gotoNext == 3869073
    	if !SearchBreak && (e_3869077 != nil) {
    		gotoNext = 3869127
    		_ = gotoNext == 3869127
    		if len(e_3869077.stk) != len(stk) || e_3869077.tag != tag {
    			gotoNext = 3869173
    			_ = gotoNext == 3869173
    			last_3869045, e_3869077 = e_3869077, e_3869077.nextHash
    			gotoNext = 3869073
    			gotoNext = 3869193
    		} else {
    			gotoNext = 3869193
    		...
    		if 0 < len(stk) {
    			...
    			gotoNext = 3869277
    			_ = gotoNext == 3869277
    			if j_3869197 < len(stk) {
    				gotoNext = 3869212
    				_ = gotoNext == 3869212
    				if e_3869077.stk[j_3869197] != uintptr(stk[j_3869197]) {
    					gotoNext = 3869248
    					_ = gotoNext == 3869248
    					last_3869045, e_3869077 = e_3869077, e_3869077.nextHash
    					gotoNext = 3869073
    		...
    		if last_3869045 != nil {
    			gotoNext = 3869316
    			_ = gotoNext == 3869316
    			last_3869045.nextHash = e_3869077.nextHash
    			e_3869077.nextHash = m.hash[h_3868824]
    			m.hash[h_3868824] = e_3869077
    			gotoNext = 3869397
    		} else {
    			gotoNext = 3869397
    		}
    	...
    	e_3869492 = &m.free[0]
    	m.free = m.free[1:]
    	e_3869492.nextHash = m.hash[h_3868824]
    	e_3869492.tag = tag
    	...
    	_ = gotoNext == 3869696
    	e_3869492.stk = m.freeStk[:len(stk):len(stk)]
    	...
    	if 0 < len(stk) {
    		...
    		gotoNext = 3869821
    		_ = gotoNext == 3869821
    		if j_3869774 < len(stk) {
    			gotoNext = 3869789
    			_ = gotoNext == 3869789
    			e_3869492.stk[j_3869774] = uintptr(stk[j_3869774])
    			j_3869774++
    			gotoNext = 3869821
    		} else {
    			gotoNext = 3869824
