...
/**
    /|*{
    	...
    	if 0 < len(stk) {
    		gotoNext = 3866425
    		_ = gotoNext == 3866425
    		i_3866341_0, x_3866336 = 0, stk[0]
    		gotoNext = 3866426
    		_ = gotoNext == 3866426
    		if i_3866341_0 < len(stk) {
    			gotoNext = 3866351
    			_ = gotoNext == 3866351
    			x_3866336 = stk[i_3866341_0]
    			h_3866312 = h_3866312<<8 | (h_3866312 >> 24)
    			h_3866312 += uintptr(x_3866336) * 41
    			i_3866341_0++
    			gotoNext = 3866426
    		} else {
    			gotoNext = 3866429
    	...
    	_ = gotoNext == 3866429
    	h_3866312 = h_3866312<<8 | (h_3866312 >> 24)
    	h_3866312 += uintptr(tag) * 41
    	gotoNext = 3866552
    	_ = gotoNext == 3866552
    	e_3866565 = m.hash[h_3866312]
    	SearchBreak = false
    	gotoNext = 3866561
    	_ = gotoNext == 3866561
    	if !SearchBreak && (e_3866565 != nil) {
    		gotoNext = 3866615
    		_ = gotoNext == 3866615
    		if len(e_3866565.stk) != len(stk) || e_3866565.tag != tag {
    			gotoNext = 3866661
    			_ = gotoNext == 3866661
    			last_3866533, e_3866565 = e_3866565, e_3866565.nextHash
    			gotoNext = 3866561
    			gotoNext = 3866681
    		} else {
    			gotoNext = 3866681
    		...
    		if 0 < len(stk) {
    			...
    			gotoNext = 3866765
    			_ = gotoNext == 3866765
    			if j_3866685 < len(stk) {
    				gotoNext = 3866700
    				_ = gotoNext == 3866700
    				if e_3866565.stk[j_3866685] != uintptr(stk[j_3866685]) {
    					gotoNext = 3866736
    					_ = gotoNext == 3866736
    					last_3866533, e_3866565 = e_3866565, e_3866565.nextHash
    					gotoNext = 3866561
    		...
    		if last_3866533 != nil {
    			gotoNext = 3866804
    			_ = gotoNext == 3866804
    			last_3866533.nextHash = e_3866565.nextHash
    			e_3866565.nextHash = m.hash[h_3866312]
    			m.hash[h_3866312] = e_3866565
    			gotoNext = 3866885
    		} else {
    			gotoNext = 3866885
    		}
    	...
    	e_3866980 = &m.free[0]
    	m.free = m.free[1:]
    	e_3866980.nextHash = m.hash[h_3866312]
    	e_3866980.tag = tag
    	...
    	_ = gotoNext == 3867184
    	e_3866980.stk = m.freeStk[:len(stk):len(stk)]
    	...
    	if 0 < len(stk) {
    		...
    		gotoNext = 3867309
    		_ = gotoNext == 3867309
    		if j_3867262 < len(stk) {
    			gotoNext = 3867277
    			_ = gotoNext == 3867277
    			e_3866980.stk[j_3867262] = uintptr(stk[j_3867262])
    			j_3867262++
    			gotoNext = 3867309
    		} else {
    			gotoNext = 3867312
