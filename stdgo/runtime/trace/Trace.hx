...
@:structInit class Task {
	...
	public function new(?_id:GoUInt64)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Region {
	...
	public function new(?_id:GoUInt64, ?_regionType:GoString)
		stdgo.internal.Macro.initLocals();
...
@:structInit @:local class T__struct_48 {
	...
	public function new(?mutex:stdgo.sync.Sync.Mutex, ?_enabled:GoInt32)
		stdgo.internal.Macro.initLocals();
...
function newTask(_pctx:stdgo.context.Context.Context, _taskType:GoString):{var _0:stdgo.context.Context.Context; var _1:Pointer<Task>;} {
	var _ctx:stdgo.context.Context.Context = ((null : stdgo.context.Context.Context)),
		_task:Pointer<Task> = new Pointer<Task>().nil();
...
class Task_extension_fields {
	public function end(__tmp__):Void
		__tmp__.end();
}
