package stdgo.runtime.trace_;
@:structInit @:using(stdgo.runtime.trace_.Trace_.T_traceContextKey_static_extension) abstract T_traceContextKey(stdgo._internal.runtime.trace_.Trace__T_traceContextKey.T_traceContextKey) from stdgo._internal.runtime.trace_.Trace__T_traceContextKey.T_traceContextKey to stdgo._internal.runtime.trace_.Trace__T_traceContextKey.T_traceContextKey {
    public function new() this = new stdgo._internal.runtime.trace_.Trace__T_traceContextKey.T_traceContextKey();
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.runtime.trace_.Trace_.Task_static_extension) abstract Task(stdgo._internal.runtime.trace_.Trace__Task.Task) from stdgo._internal.runtime.trace_.Trace__Task.Task to stdgo._internal.runtime.trace_.Trace__Task.Task {
    ...
    public function new(?_id:haxe.UInt64) this = new stdgo._internal.runtime.trace_.Trace__Task.Task((_id : stdgo.GoUInt64));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.runtime.trace_.Trace_.Region_static_extension) abstract Region(stdgo._internal.runtime.trace_.Trace__Region.Region) from stdgo._internal.runtime.trace_.Trace__Region.Region to stdgo._internal.runtime.trace_.Trace__Region.Region {
    public var _id(get, set) : haxe.UInt64;
    function get__id():haxe.UInt64 return this._id;
    function set__id(v:haxe.UInt64):haxe.UInt64 {
        this._id = (v : stdgo.GoUInt64);
    ...
    public function new(?_id:haxe.UInt64, ?_regionType:String) this = new stdgo._internal.runtime.trace_.Trace__Region.Region((_id : stdgo.GoUInt64), (_regionType : stdgo.GoString));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
typedef T__struct_0Pointer = stdgo._internal.runtime.trace_.Trace__T__struct_0Pointer.T__struct_0Pointer;
class T__struct_0_static_extension {
    public static function _unlockSlow(__self__:stdgo._internal.runtime.trace_.Trace__T__struct_0.T__struct_0, _0:StdTypes.Int):Void {
        final _0 = (_0 : stdgo.GoInt32);
        stdgo._internal.runtime.trace_.Trace__T__struct_0_static_extension.T__struct_0_static_extension._unlockSlow(__self__, _0);
    }
    public static function _lockSlow(__self__:stdgo._internal.runtime.trace_.Trace__T__struct_0.T__struct_0):Void {
        stdgo._internal.runtime.trace_.Trace__T__struct_0_static_extension.T__struct_0_static_extension._lockSlow(__self__);
    }
    public static function unlock(__self__:stdgo._internal.runtime.trace_.Trace__T__struct_0.T__struct_0):Void {
        stdgo._internal.runtime.trace_.Trace__T__struct_0_static_extension.T__struct_0_static_extension.unlock(__self__);
    }
    public static function tryLock(__self__:stdgo._internal.runtime.trace_.Trace__T__struct_0.T__struct_0):Bool {
        return stdgo._internal.runtime.trace_.Trace__T__struct_0_static_extension.T__struct_0_static_extension.tryLock(__self__);
    }
    public static function lock(__self__:stdgo._internal.runtime.trace_.Trace__T__struct_0.T__struct_0):Void {
        stdgo._internal.runtime.trace_.Trace__T__struct_0_static_extension.T__struct_0_static_extension.lock(__self__);
    }
}
typedef T__struct_0 = stdgo._internal.runtime.trace_.Trace__T__struct_0.T__struct_0;
typedef T_traceContextKeyPointer = stdgo._internal.runtime.trace_.Trace__T_traceContextKeyPointer.T_traceContextKeyPointer;
class T_traceContextKey_static_extension {

}
typedef TaskPointer = stdgo._internal.runtime.trace_.Trace__TaskPointer.TaskPointer;
class Task_static_extension {
    static public function end(_t:Task):Void {
        final _t = (_t : stdgo.Ref<stdgo._internal.runtime.trace_.Trace_Task.Task>);
        stdgo._internal.runtime.trace_.Trace__Task_static_extension.Task_static_extension.end(_t);
    }
}
typedef RegionPointer = stdgo._internal.runtime.trace_.Trace__RegionPointer.RegionPointer;
class Region_static_extension {
    static public function end(_r:Region):Void {
        final _r = (_r : stdgo.Ref<stdgo._internal.runtime.trace_.Trace_Region.Region>);
        stdgo._internal.runtime.trace_.Trace__Region_static_extension.Region_static_extension.end(_r);
    }
}
typedef T__struct_0PointerPointer = stdgo._internal.runtime.trace_.Trace__T__struct_0PointerPointer.T__struct_0PointerPointer;
...
class Trace_ {
    ...
    **/
    static public inline function newTask(_pctx:stdgo._internal.context.Context_Context.Context, _taskType:String):stdgo.Tuple<stdgo._internal.context.Context_Context.Context, Task> {
        ...
        return {
            final obj = stdgo._internal.runtime.trace_.Trace__newTask.newTask(_pctx, _taskType);
            { _0 : obj._0, _1 : obj._1 };
        };
    }
    /**
    ...
    **/
    static public inline function log(_ctx:stdgo._internal.context.Context_Context.Context, _category:String, _message:String):Void {
        ...
        stdgo._internal.runtime.trace_.Trace__log.log(_ctx, _category, _message);
    }
    /**
    ...
    **/
    static public inline function logf(_ctx:stdgo._internal.context.Context_Context.Context, _category:String, _format:String, _args:haxe.Rest<stdgo.AnyInterface>):Void {
        ...
        stdgo._internal.runtime.trace_.Trace__logf.logf(_ctx, _category, _format, ...[for (i in _args) i]);
    }
    /**
    ...
    **/
    static public inline function withRegion(_ctx:stdgo._internal.context.Context_Context.Context, _regionType:String, _fn:() -> Void):Void {
        ...
        final _fn = _fn;
        stdgo._internal.runtime.trace_.Trace__withRegion.withRegion(_ctx, _regionType, _fn);
    }
    /**
    ...
    **/
    static public inline function startRegion(_ctx:stdgo._internal.context.Context_Context.Context, _regionType:String):Region {
        final _regionType = (_regionType : stdgo.GoString);
        return stdgo._internal.runtime.trace_.Trace__startRegion.startRegion(_ctx, _regionType);
    }
    /**
    ...
    **/
    static public inline function isEnabled():Bool {
        return stdgo._internal.runtime.trace_.Trace__isEnabled.isEnabled();
    }
    /**
    ...
    **/
    static public inline function start(_w:stdgo._internal.io.Io_Writer.Writer):stdgo.Error {
        return stdgo._internal.runtime.trace_.Trace__start.start(_w);
    }
    /**
