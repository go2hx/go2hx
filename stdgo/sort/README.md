...
```
=== RUN   TestSearch
--- PASS: TestSearch (0.000370025634765625)
=== RUN   TestFind
--- PASS: TestFind (0.000111103057861328)
=== RUN   TestSearchEfficiency
--- PASS: TestSearchEfficiency (0.020906925201416)
=== RUN   TestSearchWrappers
--- PASS: TestSearchWrappers (4.00543212890625e-05)
=== RUN   TestSearchWrappersDontAlloc
--- PASS: TestSearchWrappersDontAlloc (3.09944152832031e-05)
=== RUN   TestSearchExhaustive
--- PASS: TestSearchExhaustive (0.043330192565918)
=== RUN   TestFindExhaustive
--- PASS: TestFindExhaustive (0.154783010482788)
=== RUN   TestSortIntSlice
--- PASS: TestSortIntSlice (9.08374786376953e-05)
=== RUN   TestSortFloat64Slice
--- PASS: TestSortFloat64Slice (7.79628753662109e-05)
=== RUN   TestSortStringSlice
--- PASS: TestSortStringSlice (0.000100135803222656)
=== RUN   TestInts
--- PASS: TestInts (5.69820404052734e-05)
=== RUN   TestFloat64s
--- PASS: TestFloat64s (5.88893890380859e-05)
=== RUN   TestStrings
--- PASS: TestStrings (0.000108003616333008)
=== RUN   TestSlice
--- PASS: TestSlice (0.000235080718994141)
=== RUN   TestSortLarge_Random
--- PASS: TestSortLarge_Random (0.255923986434937)
=== RUN   TestReverseSortIntSlice
--- PASS: TestReverseSortIntSlice (7.60555267333984e-05)
=== RUN   TestBreakPatterns
--- PASS: TestBreakPatterns (0.000108957290649414)
=== RUN   TestReverseRange
--- PASS: TestReverseRange (3.09944152832031e-05)
=== RUN   TestNonDeterministicComparison
--- PASS: TestNonDeterministicComparison (9.01805806159973)
=== RUN   TestSortBM
--- PASS: TestSortBM (0.422701835632324)
=== RUN   TestHeapsortBM
--- PASS: TestHeapsortBM (0.66537880897522)
=== RUN   TestStableBM
--- PASS: TestStableBM (1.07467699050903)
=== RUN   TestAdversary
--- PASS: TestAdversary (0.0536758899688721)
=== RUN   TestStableInts
--- PASS: TestStableInts (7.89165496826172e-05)
=== RUN   TestStability
--- PASS: TestStability (0.0903329849243164)
=== RUN   TestCountStableOps
--- PASS: TestCountStableOps (0.901220083236694)
=== RUN   TestCountSortOps
--- PASS: TestCountSortOps (0.420186996459961)
```
</p>
</details>
...
```
=== RUN   TestSearch
--- PASS: TestSearch (0.00161004066467285156)
=== RUN   TestFind
--- PASS: TestFind (0.00016880035400390625)
=== RUN   TestSearchEfficiency
--- PASS: TestSearchEfficiency (0.124053955078125)
=== RUN   TestSearchWrappers
--- PASS: TestSearchWrappers (3.814697265625e-05)
=== RUN   TestSearchWrappersDontAlloc
--- PASS: TestSearchWrappersDontAlloc (2.50339508056640625e-05)
=== RUN   TestSearchExhaustive
--- PASS: TestSearchExhaustive (0.271585941314697266)
=== RUN   TestFindExhaustive
--- PASS: TestFindExhaustive (0.542702913284301758)
=== RUN   TestSortIntSlice
--- PASS: TestSortIntSlice (0.000341892242431640625)
=== RUN   TestSortFloat64Slice
--- PASS: TestSortFloat64Slice (0.000317096710205078125)
=== RUN   TestSortStringSlice
--- PASS: TestSortStringSlice (0.000164031982421875)
=== RUN   TestInts
--- PASS: TestInts (0.000249147415161132812)
=== RUN   TestFloat64s
--- PASS: TestFloat64s (0.000286102294921875)
=== RUN   TestStrings
--- PASS: TestStrings (0.00018310546875)
=== RUN   TestSlice
--- PASS: TestSlice (0.000571012496948242188)
=== RUN   TestSortLarge_Random
--- PASS: TestSortLarge_Random (1.34785103797912598)
=== RUN   TestReverseSortIntSlice
--- PASS: TestReverseSortIntSlice (0.000547170639038085938)
=== RUN   TestBreakPatterns
--- PASS: TestBreakPatterns (0.00067615509033203125)
=== RUN   TestReverseRange
--- PASS: TestReverseRange (7.89165496826171875e-05)
=== RUN   TestNonDeterministicComparison
--- PASS: TestNonDeterministicComparison (48.927299976348877)
=== RUN   TestSortBM
--- PASS: TestSortBM (3.42535901069641113)
=== RUN   TestHeapsortBM
--- PASS: TestHeapsortBM (6.46826696395874)
=== RUN   TestStableBM
--- PASS: TestStableBM (7.52993988990783691)
=== RUN   TestAdversary
--- PASS: TestAdversary (0.413495063781738281)
=== RUN   TestStableInts
--- PASS: TestStableInts (0.00032901763916015625)
=== RUN   TestStability
--- PASS: TestStability (0.451448917388916)
=== RUN   TestCountStableOps
--- PASS: TestCountStableOps (5.65585517883300781)
=== RUN   TestCountSortOps
--- PASS: TestCountSortOps (2.2008059024810791)
```
</p>
</details>
