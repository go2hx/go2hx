...
@:structInit @:using(stdgo.sort.Sort.T_reverse_static_extension) private class T_reverse {
	...
	**/
	...
	@:embedded
	public function swap(_i_:GoInt, _j_:GoInt)
		interface_.swap(_i_, _j_);
...
private function _pdqsort_func(_data:T_lessSwap, _a:GoInt, _b:GoInt, _limit:GoInt):Void {
	...
	while (true) {
		...
		var __tmp__ = _partition_func((_data == null ? null : _data.__copy__()), _a, _b, _pivot),
...
private function _pdqsort(_data:Interface, _a:GoInt, _b:GoInt, _limit:GoInt):Void {
	...
	while (true) {
		...
		var __tmp__ = _partition(_data, _a, _b, _pivot),
			_mid:GoInt = __tmp__._0,
			_alreadyPartitioned:Bool = __tmp__._1;
		_wasPartitioned = _alreadyPartitioned;
		var _0:GoInt = _mid - _a,
...
@:keep @:allow(stdgo.sort.Sort.T_reverse_asInterface) class T_reverse_static_extension {
	...
	**/
	...
	@:embedded
	public static function swap(__self__:T_reverse, _i_:GoInt, _j_:GoInt)
		__self__.swap(_i_, _j_);

	@:embedded
	public static function len(__self__:T_reverse):GoInt
		return __self__.len();
}
