...
((new stdgo.testing.Testing.InternalTest(((((("TestFind" : GoString))) : GoString)), stdgo.sort_test.Sort_test.testFind) : stdgo.testing.Testing.InternalTest)),
...
((new stdgo.testing.Testing.InternalTest(((((("TestFindExhaustive" : GoString))) : GoString)), stdgo.sort_test.Sort_test.testFindExhaustive) : stdgo.testing.Testing.InternalTest)),
...
((new stdgo.testing.Testing.InternalTest(((((("TestBreakPatterns" : GoString))) : GoString)), stdgo.sort_test.Sort_test.testBreakPatterns) : stdgo.testing.Testing.InternalTest)),
((new stdgo.testing.Testing.InternalTest(((((("TestReverseRange" : GoString))) : GoString)), stdgo.sort_test.Sort_test.testReverseRange) : stdgo.testing.Testing.InternalTest)),
...
((new stdgo.testing.Testing.InternalBenchmark(((((("BenchmarkSortInt1K_Sorted" : GoString))) : GoString)), stdgo.sort_test.Sort_test.benchmarkSortInt1K_Sorted) : stdgo.testing.Testing.InternalBenchmark)),
((new stdgo.testing.Testing.InternalBenchmark(((((("BenchmarkSortInt1K_Reversed" : GoString))) : GoString)), stdgo.sort_test.Sort_test.benchmarkSortInt1K_Reversed) : stdgo.testing.Testing.InternalBenchmark)),
((new stdgo.testing.Testing.InternalBenchmark(((((("BenchmarkSortInt1K_Mod8" : GoString))) : GoString)), stdgo.sort_test.Sort_test.benchmarkSortInt1K_Mod8) : stdgo.testing.Testing.InternalBenchmark)),
