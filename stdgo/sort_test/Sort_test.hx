...
**/
var _strings : stdgo.GoArray<stdgo.GoString> = (new stdgo.GoArray<stdgo.GoString>(stdgo.Go.str(), ("Hello" : stdgo.GoString), ("foo" : stdgo.GoString), ("bar" : stdgo.GoString), ("foo" : stdgo.GoString), ("f00" : stdgo.GoString), ("%*&^*&^&" : stdgo.GoString), ("***" : stdgo.GoString)) : stdgo.GoArray<stdgo.GoString>);
/**
...
({ _data : (new stdgo.Slice<stdgo.GoString>(0, 0) : stdgo.Slice<stdgo.GoString>), _target : stdgo.Go.str(), _wantPos : (0 : stdgo.StdGoTypes.GoInt), _wantFound : false } : T__struct_2),
...
({ _data : _strSame, _target : ("zz" : stdgo.GoString), _wantPos : (3 : stdgo.StdGoTypes.GoInt), _wantFound : false } : T__struct_2)) : stdgo.Slice<T__struct_2>);
        for (__0 => _tt in _tests) {
            _t.run(_tt._target, function(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
                var _cmp:stdgo.StdGoTypes.GoInt -> stdgo.StdGoTypes.GoInt = function(_i:stdgo.StdGoTypes.GoInt):stdgo.StdGoTypes.GoInt {
                    return stdgo.strings.Strings.compare(_tt._target, _tt._data[(_i : stdgo.StdGoTypes.GoInt)]);
                };
...
function _runSearchWrappers():Void {
        ...
        searchStrings(_sdata, stdgo.Go.str());
...
function benchmarkSortString1K(_b:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.B>):Void {
        ...
        for (_i in 0 ... _unsorted.length.toBasic()) {
            _unsorted[(_i : stdgo.StdGoTypes.GoInt)] = stdgo.strconv.Strconv.itoa(_i ^ (716 : stdgo.StdGoTypes.GoInt));
        };
                        ...
                        stdgo.Go.cfor(_dist < (5 : stdgo.StdGoTypes.GoInt), _dist++, {
                            ...
                            var _mdata = (_tmp2.__slice__((0 : stdgo.StdGoTypes.GoInt), _n) : stdgo.Slice<stdgo.StdGoTypes.GoInt>);
                            {
                                ...
                                stdgo.Go.cfor(_mode < (6 : stdgo.StdGoTypes.GoInt), _mode++, {
                                    ...
                                    var _desc:stdgo.GoString = stdgo.fmt.Fmt.sprintf(("n=%d m=%d dist=%s mode=%s" : stdgo.GoString), stdgo.Go.toInterface(_n), stdgo.Go.toInterface(_m), stdgo.Go.toInterface(_dists[(_dist : stdgo.StdGoTypes.GoInt)]), stdgo.Go.toInterface(_modes[(_mode : stdgo.StdGoTypes.GoInt)]));
                                    var _d = (stdgo.Go.setRef(({ _desc : _desc, _t : _t, _data : (_mdata.__slice__((0 : stdgo.StdGoTypes.GoInt), _n) : stdgo.Slice<stdgo.StdGoTypes.GoInt>), _maxswap : _maxswap(_n) } : T_testingData)) : stdgo.StdGoTypes.Ref<stdgo.sort_test.Sort_test.T_testingData>);
...
function _countOps(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>, _algo:Interface -> Void, _name:stdgo.GoString):Void {
        ...
        for (__0 => _n in _sizes) {
            var _td:stdgo.sort_test.Sort_test.T_testingData = ({ _desc : _name, _t : _t, _data : new stdgo.Slice<stdgo.StdGoTypes.GoInt>((_n : stdgo.StdGoTypes.GoInt).toBasic(), 0).__setNumber32__(), _maxswap : (2147483647 : stdgo.StdGoTypes.GoInt) } : T_testingData);
            {
                var _i:stdgo.StdGoTypes.GoInt = (0 : stdgo.StdGoTypes.GoInt);
                stdgo.Go.cfor(_i < _n, _i++, {
...
function _bench(_b:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.B>, _size:stdgo.StdGoTypes.GoInt, _algo:Interface -> Void, _name:stdgo.GoString):Void {
        if (stdgo.strings.Strings.hasSuffix(stdgo.internal.testenv.Testenv.builder(), ("-race" : stdgo.GoString)) && (_size > (10000 : stdgo.StdGoTypes.GoInt))) {
