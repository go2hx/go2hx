...
**/
var _planets : stdgo.Slice<stdgo.sort_test.Sort_test.Planet> = (new stdgo.Slice<stdgo.sort_test.Sort_test.Planet>(4, 4, (new stdgo.sort_test.Sort_test.Planet(("Mercury" : stdgo.GoString), (0.055 : stdgo.GoFloat64), (0.4 : stdgo.GoFloat64)) : stdgo.sort_test.Sort_test.Planet), (new stdgo.sort_test.Sort_test.Planet(("Venus" : stdgo.GoString), (0.815 : stdgo.GoFloat64), (0.7 : stdgo.GoFloat64)) : stdgo.sort_test.Sort_test.Planet), (new stdgo.sort_test.Sort_test.Planet(("Earth" : stdgo.GoString), (1 : stdgo.GoFloat64), (1 : stdgo.GoFloat64)) : stdgo.sort_test.Sort_test.Planet), (new stdgo.sort_test.Sort_test.Planet(("Mars" : stdgo.GoString), (0.107 : stdgo.GoFloat64), (1.5 : stdgo.GoFloat64)) : stdgo.sort_test.Sort_test.Planet)) : stdgo.Slice<stdgo.sort_test.Sort_test.Planet>);
/**
...
9,
9,
(new stdgo.sort_test.Sort_test.Change(("gri" : stdgo.GoString), ("Go" : stdgo.GoString), (100 : stdgo.GoInt)) : stdgo.sort_test.Sort_test.Change),
(new stdgo.sort_test.Sort_test.Change(("ken" : stdgo.GoString), ("C" : stdgo.GoString), (150 : stdgo.GoInt)) : stdgo.sort_test.Sort_test.Change),
(new stdgo.sort_test.Sort_test.Change(("glenda" : stdgo.GoString), ("Go" : stdgo.GoString), (200 : stdgo.GoInt)) : stdgo.sort_test.Sort_test.Change),
(new stdgo.sort_test.Sort_test.Change(("rsc" : stdgo.GoString), ("Go" : stdgo.GoString), (200 : stdgo.GoInt)) : stdgo.sort_test.Sort_test.Change),
(new stdgo.sort_test.Sort_test.Change(("r" : stdgo.GoString), ("Go" : stdgo.GoString), (100 : stdgo.GoInt)) : stdgo.sort_test.Sort_test.Change),
(new stdgo.sort_test.Sort_test.Change(("ken" : stdgo.GoString), ("Go" : stdgo.GoString), (200 : stdgo.GoInt)) : stdgo.sort_test.Sort_test.Change),
(new stdgo.sort_test.Sort_test.Change(("dmr" : stdgo.GoString), ("C" : stdgo.GoString), (100 : stdgo.GoInt)) : stdgo.sort_test.Sort_test.Change),
(new stdgo.sort_test.Sort_test.Change(("r" : stdgo.GoString), ("C" : stdgo.GoString), (150 : stdgo.GoInt)) : stdgo.sort_test.Sort_test.Change),
(new stdgo.sort_test.Sort_test.Change(("gri" : stdgo.GoString), ("Smalltalk" : stdgo.GoString), (80 : stdgo.GoInt)) : stdgo.sort_test.Sort_test.Change)) : stdgo.Slice<stdgo.sort_test.Sort_test.Change>);
/**
...
({ _name : ("descending a" : stdgo.GoString), _n : (7 : stdgo.GoInt), _f : function(_i:stdgo.GoInt):Bool {
        return (new stdgo.Slice<stdgo.GoInt>(8, 8, (99 : stdgo.GoInt), (99 : stdgo.GoInt), (59 : stdgo.GoInt), (42 : stdgo.GoInt), (7 : stdgo.GoInt), (0 : stdgo.GoInt), (-1 : stdgo.GoInt), (-1 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>)[(_i : stdgo.GoInt)] <= (7 : stdgo.GoInt);
    }, _i : (4 : stdgo.GoInt) } : T__struct_1),
({ _name : ("descending 7" : stdgo.GoString), _n : (1000000000 : stdgo.GoInt), _f : function(_i:stdgo.GoInt):Bool {
        return ((1000000000 : stdgo.GoInt) - _i) <= (7 : stdgo.GoInt);
...
({ _name : ("overflow" : stdgo.GoString), _n : (2000000000 : stdgo.GoInt), _f : function(_i:stdgo.GoInt):Bool {
        return false;
    }, _i : (2000000000 : stdgo.GoInt) } : T__struct_1)) : stdgo.Slice<T__struct_1>);
/**
...
@:structInit class Planet {
    ...
    public var _mass : stdgo.sort_test.Sort_test.T_earthMass = ((0 : stdgo.GoFloat64) : stdgo.sort_test.Sort_test.T_earthMass);
    public var _distance : stdgo.sort_test.Sort_test.T_au = ((0 : stdgo.GoFloat64) : stdgo.sort_test.Sort_test.T_au);
...
@:structInit @:private @:using(stdgo.sort_test.Sort_test.T_planetSorter_static_extension) class T_planetSorter {
    ...
    public var _by : (stdgo.Ref<stdgo.sort_test.Sort_test.Planet>, stdgo.Ref<stdgo.sort_test.Sort_test.Planet>) -> Bool = null;
    public function new(?_planets:stdgo.Slice<stdgo.sort_test.Sort_test.Planet>, ?_by:(stdgo.Ref<stdgo.sort_test.Sort_test.Planet>, stdgo.Ref<stdgo.sort_test.Sort_test.Planet>) -> Bool) {
...
@:structInit class Organ {
    public var name : stdgo.GoString = "";
    public var weight : stdgo.sort_test.Sort_test.Grams = ((0 : stdgo.GoInt) : stdgo.sort_test.Sort_test.Grams);
...
@:structInit @:private @:using(stdgo.sort_test.Sort_test.T_nonDeterministicTestingData_static_extension) class T_nonDeterministicTestingData {
    public var _r : stdgo.Ref<stdgo.math.rand.Rand.Rand> = (null : stdgo.Ref<stdgo.math.rand.Rand.Rand>);
    public function new(?_r:stdgo.Ref<stdgo.math.rand.Rand.Rand>) {
...
@:structInit @:private @:using(stdgo.sort_test.Sort_test.T_testingData_static_extension) class T_testingData {
    ...
    public var _t : stdgo.Ref<stdgo.testing.Testing.T_> = (null : stdgo.Ref<stdgo.testing.Testing.T_>);
    ...
    public function new(?_desc:stdgo.GoString, ?_t:stdgo.Ref<stdgo.testing.Testing.T_>, ?_data:stdgo.Slice<stdgo.GoInt>, ?_maxswap:stdgo.GoInt, ?_ncmp:stdgo.GoInt, ?_nswap:stdgo.GoInt) {
...
@:structInit @:private @:using(stdgo.sort_test.Sort_test.T_adversaryTestingData_static_extension) class T_adversaryTestingData {
    ...
    public function new(?_t:stdgo.Ref<stdgo.testing.Testing.T_>, ?_data:stdgo.Slice<stdgo.GoInt>, ?_maxcmp:stdgo.GoInt, ?_ncmp:stdgo.GoInt, ?_nsolid:stdgo.GoInt, ?_candidate:stdgo.GoInt, ?_gas:stdgo.GoInt) {
        if (_t != null) this._t = _t;
        if (_data != null) this._data = _data;
...
**/
@:named @:using(stdgo.sort_test.Sort_test.By_static_extension) typedef By = (stdgo.Ref<stdgo.sort_test.Sort_test.Planet>, stdgo.Ref<stdgo.sort_test.Sort_test.Planet>) -> Bool;
@:named typedef T_lessFunc = (stdgo.Ref<stdgo.sort_test.Sort_test.Change>, stdgo.Ref<stdgo.sort_test.Sort_test.Change>) -> Bool;
@:named @:using(stdgo.sort_test.Sort_test.Grams_static_extension) typedef Grams = stdgo.GoInt;
@:named @:using(stdgo.sort_test.Sort_test.Organs_static_extension) typedef Organs = stdgo.Slice<stdgo.Ref<stdgo.sort_test.Sort_test.Organ>>;
@:named @:using(stdgo.sort_test.Sort_test.T_intPairs_static_extension) typedef T_intPairs = stdgo.Slice<T__struct_4>;
function example():Void {
        var _people = (new stdgo.Slice<stdgo.sort_test.Sort_test.Person>(4, 4, (new stdgo.sort_test.Sort_test.Person(("Bob" : stdgo.GoString), (31 : stdgo.GoInt)) : stdgo.sort_test.Sort_test.Person), (new stdgo.sort_test.Sort_test.Person(("John" : stdgo.GoString), (42 : stdgo.GoInt)) : stdgo.sort_test.Sort_test.Person), (new stdgo.sort_test.Sort_test.Person(("Michael" : stdgo.GoString), (17 : stdgo.GoInt)) : stdgo.sort_test.Sort_test.Person), (new stdgo.sort_test.Sort_test.Person(("Jenny" : stdgo.GoString), (26 : stdgo.GoInt)) : stdgo.sort_test.Sort_test.Person)) : stdgo.Slice<stdgo.sort_test.Sort_test.Person>);
...
function orderedBy(_less:haxe.Rest<T_lessFunc>):stdgo.Ref<T_multiSorter> {
        ...
        return (stdgo.Go.setRef(({ _less : _less } : stdgo.sort_test.Sort_test.T_multiSorter)) : stdgo.Ref<stdgo.sort_test.Sort_test.T_multiSorter>);
    }
/**
...
function testSearch(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        for (__0 => _e in _tests) {
            var _i:stdgo.GoInt = search(_e._n, _e._f);
            if (_i != (_e._i)) {
...
function testFind(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
34,
34,
({ _data : (new stdgo.Slice<stdgo.GoString>(0, 0) : stdgo.Slice<stdgo.GoString>), _target : ("foo" : stdgo.GoString), _wantPos : (0 : stdgo.GoInt), _wantFound : false } : T__struct_2),
({ _data : (new stdgo.Slice<stdgo.GoString>(0, 0) : stdgo.Slice<stdgo.GoString>), _target : stdgo.Go.str()?.__copy__(), _wantPos : (0 : stdgo.GoInt), _wantFound : false } : T__struct_2),
...
({ _data : _strSame, _target : ("zz" : stdgo.GoString), _wantPos : (3 : stdgo.GoInt), _wantFound : false } : T__struct_2)) : stdgo.Slice<T__struct_2>);
        for (__0 => _tt in _tests) {
            _t.run(_tt._target?.__copy__(), function(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
                var _cmp:stdgo.GoInt -> stdgo.GoInt = function(_i:stdgo.GoInt):stdgo.GoInt {
                    return stdgo.strings.Strings.compare(_tt._target?.__copy__(), _tt._data[(_i : stdgo.GoInt)]?.__copy__());
                };
...
function _log2(_x:stdgo.GoInt):stdgo.GoInt {
        ...
        {
            var _p:stdgo.GoInt = (1 : stdgo.GoInt);
...
function testSearchEfficiency(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _n:stdgo.GoInt = (100 : stdgo.GoInt);
        var _step:stdgo.GoInt = (1 : stdgo.GoInt);
        {
            var _exp:stdgo.GoInt = (2 : stdgo.GoInt);
            stdgo.Go.cfor(_exp < (10 : stdgo.GoInt), _exp++, {
                var _max:stdgo.GoInt = _log2(_n);
                {
                    var _x:stdgo.GoInt = (0 : stdgo.GoInt);
                    stdgo.Go.cfor(_x < _n, _x = _x + (_step), {
                        var _count:stdgo.GoInt = (0 : stdgo.GoInt);
                        var _i:stdgo.GoInt = search(_n, function(_i:stdgo.GoInt):Bool {
                            _count++;
                            return _i >= _x;
                        });
                        if (_i != (_x)) {
                ...
                _n = _n * ((10 : stdgo.GoInt));
                _step = _step * ((10 : stdgo.GoInt));
            });
        };
    }
function testSearchWrappers(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testSearchWrappersDontAlloc(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        var _allocs:stdgo.GoFloat64 = stdgo.testing.Testing.allocsPerRun((100 : stdgo.GoInt), _runSearchWrappers);
...
function benchmarkSearchWrappers(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {
...
**/
function testSearchExhaustive(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {
            var _size:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_size <= (100 : stdgo.GoInt), _size++, {
                {
                    var _targ:stdgo.GoInt = (0 : stdgo.GoInt);
                    stdgo.Go.cfor(_targ <= _size, _targ++, {
                        var _i:stdgo.GoInt = search(_size, function(_i:stdgo.GoInt):Bool {
                            return _i >= _targ;
                        });
                        if (_i != (_targ)) {
...
**/
function testFindExhaustive(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {
            var _size:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_size <= (100 : stdgo.GoInt), _size++, {
                {
                    var _x:stdgo.GoInt = (1 : stdgo.GoInt);
                    stdgo.Go.cfor(_x <= ((_size * (2 : stdgo.GoInt)) + (1 : stdgo.GoInt)), _x++, {
                        var _wantFound:Bool = false;
                        var _wantPos:stdgo.GoInt = (0 : stdgo.GoInt);
                        var _cmp:stdgo.GoInt -> stdgo.GoInt = function(_i:stdgo.GoInt):stdgo.GoInt {
                            return _x - ((_i + (1 : stdgo.GoInt)) * (2 : stdgo.GoInt));
                        };
                        var __tmp__ = find(_size, _cmp), _pos:stdgo.GoInt = __tmp__._0, _found:Bool = __tmp__._1;
                        if (_x % (2 : stdgo.GoInt) == ((0 : stdgo.GoInt))) {
                            _wantPos = (_x / (2 : stdgo.GoInt)) - (1 : stdgo.GoInt);
                            _wantFound = true;
                        } else {
                            _wantPos = _x / (2 : stdgo.GoInt);
                            _wantFound = false;
                        };
...
function testSortIntSlice(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        var _a:stdgo.sort.Sort.IntSlice = ((_data.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>) : IntSlice);
...
function testSortFloat64Slice(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        var _a:stdgo.sort.Sort.Float64Slice = ((_data.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoFloat64>) : Float64Slice);
        sort(stdgo.Go.asInterface(_a));
        if (!isSorted(stdgo.Go.asInterface(_a))) {
...
function testSortStringSlice(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        var _a:stdgo.sort.Sort.StringSlice = ((_data.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoString>) : StringSlice);
        sort(stdgo.Go.asInterface(_a));
        if (!isSorted(stdgo.Go.asInterface(_a))) {
...
function testInts(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _data = _ints?.__copy__();
...
function testFloat64s(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _data = _float64s?.__copy__();
...
function testStrings(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _data = _strings?.__copy__();
...
function testReverseSortIntSlice(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _data = _ints?.__copy__();
        var _data1 = _ints?.__copy__();
        var _a:stdgo.sort.Sort.IntSlice = ((_data.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>) : IntSlice);
        sort(stdgo.Go.asInterface(_a));
        var _r:stdgo.sort.Sort.IntSlice = ((_data1.__slice__((0 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>) : IntSlice);
        sort(reverse(stdgo.Go.asInterface(_r)));
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < (_data.length), _i++, {
                if (_a[(_i : stdgo.GoInt)] != (_r[((12 : stdgo.GoInt) - _i : stdgo.GoInt)])) {
...
function testBreakPatterns(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        _data[((_data.length / (4 : stdgo.GoInt)) * (2 : stdgo.GoInt) : stdgo.GoInt)] = (1 : stdgo.GoInt);
        _data[((_data.length / (4 : stdgo.GoInt)) * (3 : stdgo.GoInt) : stdgo.GoInt)] = (2 : stdgo.GoInt);
        sort(stdgo.Go.asInterface((_data : IntSlice)));
    }
function testReverseRange(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _data = (new stdgo.Slice<stdgo.GoInt>(7, 7, (1 : stdgo.GoInt), (2 : stdgo.GoInt), (3 : stdgo.GoInt), (4 : stdgo.GoInt), (5 : stdgo.GoInt), (6 : stdgo.GoInt), (7 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>);
        reverseRange(stdgo.Go.asInterface((_data : IntSlice)), (0 : stdgo.GoInt), (_data.length));
        {
            var _i:stdgo.GoInt = (_data.length) - (1 : stdgo.GoInt);
            stdgo.Go.cfor(_i > (0 : stdgo.GoInt), _i--, {
                if (_data[(_i : stdgo.GoInt)] > _data[(_i - (1 : stdgo.GoInt) : stdgo.GoInt)]) {
                    _t.fatalf(("reverseRange didn\'t work" : stdgo.GoString));
                };
            });
        };
        var _data1 = (new stdgo.Slice<stdgo.GoInt>(7, 7, (1 : stdgo.GoInt), (2 : stdgo.GoInt), (3 : stdgo.GoInt), (4 : stdgo.GoInt), (5 : stdgo.GoInt), (6 : stdgo.GoInt), (7 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>);
        var _data2 = (new stdgo.Slice<stdgo.GoInt>(7, 7, (1 : stdgo.GoInt), (2 : stdgo.GoInt), (5 : stdgo.GoInt), (4 : stdgo.GoInt), (3 : stdgo.GoInt), (6 : stdgo.GoInt), (7 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>);
...
function testNonDeterministicComparison(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        try {
            ...
            var _td = (stdgo.Go.setRef(({ _r : stdgo.math.rand.Rand.new_(stdgo.math.rand.Rand.newSource((0i64 : stdgo.GoInt64))) } : stdgo.sort_test.Sort_test.T_nonDeterministicTestingData)) : stdgo.Ref<stdgo.sort_test.Sort_test.T_nonDeterministicTestingData>);
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
...
function benchmarkSortInt1K(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.stopTimer();
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
                var _data = new stdgo.Slice<stdgo.GoInt>((1024 : stdgo.GoInt).toBasic(), 0).__setNumber32__();
                {
                    var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                    stdgo.Go.cfor(_i < (_data.length), _i++, {
                        _data[(_i : stdgo.GoInt)] = _i ^ (716 : stdgo.GoInt);
                    });
                };
                _b.startTimer();
                ints(_data);
...
function benchmarkSortInt1K_Sorted(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.stopTimer();
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
...
function benchmarkSortInt1K_Reversed(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.stopTimer();
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
                var _data = new stdgo.Slice<stdgo.GoInt>((1024 : stdgo.GoInt).toBasic(), 0).__setNumber32__();
                {
                    var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                    stdgo.Go.cfor(_i < (_data.length), _i++, {
                        _data[(_i : stdgo.GoInt)] = (_data.length) - _i;
                    });
                };
                _b.startTimer();
                ints(_data);
...
function benchmarkSortInt1K_Mod8(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.stopTimer();
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
                var _data = new stdgo.Slice<stdgo.GoInt>((1024 : stdgo.GoInt).toBasic(), 0).__setNumber32__();
                {
                    var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                    stdgo.Go.cfor(_i < (_data.length), _i++, {
                        _data[(_i : stdgo.GoInt)] = _i % (8 : stdgo.GoInt);
                    });
                };
                _b.startTimer();
                ints(_data);
...
function benchmarkSortInt64K(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.stopTimer();
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
                var _data = new stdgo.Slice<stdgo.GoInt>((65536 : stdgo.GoInt).toBasic(), 0).__setNumber32__();
                {
                    var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                    stdgo.Go.cfor(_i < (_data.length), _i++, {
                        _data[(_i : stdgo.GoInt)] = _i ^ (52428 : stdgo.GoInt);
                    });
                };
                _b.startTimer();
                ints(_data);
...
function benchmarkSortInt64K_Slice(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.stopTimer();
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
...
function benchmarkStableInt64K(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.stopTimer();
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
...
function _lg(_n:stdgo.GoInt):stdgo.GoInt {
        var _i:stdgo.GoInt = (0 : stdgo.GoInt);
        while (((1 : stdgo.GoInt) << (_i : stdgo.GoUInt)) < _n) {
            _i++;
        };
        return _i;
    }
function _testBentleyMcIlroy(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _sort:Interface -> Void, _maxswap:stdgo.GoInt -> stdgo.GoInt):Void {
        var _sizes = (new stdgo.Slice<stdgo.GoInt>(4, 4, (100 : stdgo.GoInt), (1023 : stdgo.GoInt), (1024 : stdgo.GoInt), (1025 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>);
        if (stdgo.testing.Testing.short()) {
            _sizes = (new stdgo.Slice<stdgo.GoInt>(4, 4, (100 : stdgo.GoInt), (127 : stdgo.GoInt), (128 : stdgo.GoInt), (129 : stdgo.GoInt)) : stdgo.Slice<stdgo.GoInt>);
        };
        ...
        var __0:stdgo.GoArray<stdgo.GoInt> = new stdgo.GoArray<stdgo.GoInt>(...[for (i in 0 ... 1025) (0 : stdgo.GoInt)]), __1:stdgo.GoArray<stdgo.GoInt> = new stdgo.GoArray<stdgo.GoInt>(...[for (i in 0 ... 1025) (0 : stdgo.GoInt)]), _tmp2:stdgo.GoArray<stdgo.GoInt> = __1, _tmp1:stdgo.GoArray<stdgo.GoInt> = __0;
        for (__0 => _n in _sizes) {
            {
                var _m:stdgo.GoInt = (1 : stdgo.GoInt);
                stdgo.Go.cfor(_m < ((2 : stdgo.GoInt) * _n), _m = _m * ((2 : stdgo.GoInt)), {
                    {
                        var _dist:stdgo.GoInt = (0 : stdgo.GoInt);
                        stdgo.Go.cfor(_dist < (5 : stdgo.GoInt), _dist++, {
                                ...
                                stdgo.Go.cfor(_i < _n, _i++, {
                                    {
                                        ...
                                        if (__value__ == ((0 : stdgo.GoInt))) {
                                            _data[(_i : stdgo.GoInt)] = _i % _m;
                                        } else if (__value__ == ((1 : stdgo.GoInt))) {
                                            _data[(_i : stdgo.GoInt)] = stdgo.math.rand.Rand.intn(_m);
                                        } else if (__value__ == ((2 : stdgo.GoInt))) {
                                            _data[(_i : stdgo.GoInt)] = ((_i * _m) + _i) % _n;
                                        } else if (__value__ == ((3 : stdgo.GoInt))) {
                                            _data[(_i : stdgo.GoInt)] = _min(_i, _m);
                                        } else if (__value__ == ((4 : stdgo.GoInt))) {
                                            if (stdgo.math.rand.Rand.intn(_m) != ((0 : stdgo.GoInt))) {
                                                _j = _j + ((2 : stdgo.GoInt));
                            ...
                            var _mdata = (_tmp2.__slice__((0 : stdgo.GoInt), _n) : stdgo.Slice<stdgo.GoInt>);
                            {
                                ...
                                stdgo.Go.cfor(_mode < (6 : stdgo.GoInt), _mode++, {
                                    {
                                        ...
                                        if (__value__ == ((0 : stdgo.GoInt))) {
                                        ...
                                        } else if (__value__ == ((1 : stdgo.GoInt))) {
                                            {
                                                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                                                stdgo.Go.cfor(_i < _n, _i++, {
                                                    _mdata[(_i : stdgo.GoInt)] = _data[((_n - _i) - (1 : stdgo.GoInt) : stdgo.GoInt)];
                                                });
                                            };
                                        } else if (__value__ == ((2 : stdgo.GoInt))) {
                                            {
                                                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                                                stdgo.Go.cfor(_i < (_n / (2 : stdgo.GoInt)), _i++, {
                                                    _mdata[(_i : stdgo.GoInt)] = _data[(((_n / (2 : stdgo.GoInt)) - _i) - (1 : stdgo.GoInt) : stdgo.GoInt)];
                                                });
                                            };
                                            {
                                                var _i:stdgo.GoInt = _n / (2 : stdgo.GoInt);
                                                stdgo.Go.cfor(_i < _n, _i++, {
                                                    _mdata[(_i : stdgo.GoInt)] = _data[(_i : stdgo.GoInt)];
                                                });
                                            };
                                            ...
                                            };
                                            {
                                                var _i:stdgo.GoInt = _n / (2 : stdgo.GoInt);
                                                stdgo.Go.cfor(_i < _n, _i++, {
                                                    _mdata[(_i : stdgo.GoInt)] = _data[((_n - (_i - (_n / (2 : stdgo.GoInt)))) - (1 : stdgo.GoInt) : stdgo.GoInt)];
                                                });
                                            };
                                        } else if (__value__ == ((4 : stdgo.GoInt))) {
                                            {
                                        ...
                                        } else if (__value__ == ((5 : stdgo.GoInt))) {
                                            {
                                                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                                                stdgo.Go.cfor(_i < _n, _i++, {
                                                    _mdata[(_i : stdgo.GoInt)] = _data[(_i : stdgo.GoInt)] + (_i % (5 : stdgo.GoInt));
                                                });
                                            };
                                        };
                                    };
                                    var _desc:stdgo.GoString = stdgo.fmt.Fmt.sprintf(("n=%d m=%d dist=%s mode=%s" : stdgo.GoString), stdgo.Go.toInterface(_n), stdgo.Go.toInterface(_m), stdgo.Go.toInterface(_dists[(_dist : stdgo.GoInt)]), stdgo.Go.toInterface(_modes[(_mode : stdgo.GoInt)]))?.__copy__();
                                    var _d = (stdgo.Go.setRef(({ _desc : _desc?.__copy__(), _t : _t, _data : (_mdata.__slice__((0 : stdgo.GoInt), _n) : stdgo.Slice<stdgo.GoInt>), _maxswap : _maxswap(_n) } : stdgo.sort_test.Sort_test.T_testingData)) : stdgo.Ref<stdgo.sort_test.Sort_test.T_testingData>);
...
function testSortBM(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        _testBentleyMcIlroy(_t, sort, function(_n:stdgo.GoInt):stdgo.GoInt {
            return ((_n * _lg(_n)) * (12 : stdgo.GoInt)) / (10 : stdgo.GoInt);
        });
    }
function testHeapsortBM(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        _testBentleyMcIlroy(_t, heapsort, function(_n:stdgo.GoInt):stdgo.GoInt {
            return ((_n * _lg(_n)) * (12 : stdgo.GoInt)) / (10 : stdgo.GoInt);
        });
    }
function testStableBM(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        _testBentleyMcIlroy(_t, stable, function(_n:stdgo.GoInt):stdgo.GoInt {
            return ((_n * _lg(_n)) * _lg(_n)) / (3 : stdgo.GoInt);
        });
    }
function _newAdversaryTestingData(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _size:stdgo.GoInt, _maxcmp:stdgo.GoInt):stdgo.Ref<T_adversaryTestingData> {
        var _gas:stdgo.GoInt = _size - (1 : stdgo.GoInt);
        var _data = new stdgo.Slice<stdgo.GoInt>((_size : stdgo.GoInt).toBasic(), 0).__setNumber32__();
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
        ...
        return (stdgo.Go.setRef(({ _t : _t, _data : _data, _maxcmp : _maxcmp, _gas : _gas } : stdgo.sort_test.Sort_test.T_adversaryTestingData)) : stdgo.Ref<stdgo.sort_test.Sort_test.T_adversaryTestingData>);
    }
function testAdversary(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
        var _maxcmp:stdgo.GoInt = ((10000 : stdgo.GoInt) * _lg((10000 : stdgo.GoInt))) * (4 : stdgo.GoInt);
...
function testStableInts(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _data = _ints?.__copy__();
...
function testStability(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        var _data:stdgo.sort_test.Sort_test.T_intPairs = new stdgo.Slice<T__struct_4>((_n : stdgo.GoInt).toBasic(), 0, ...[for (i in 0 ... ((_n : stdgo.GoInt).toBasic() > 0 ? (_n : stdgo.GoInt).toBasic() : 0 : stdgo.GoInt).toBasic()) ({ _a : (0 : stdgo.GoInt), _b : (0 : stdgo.GoInt) } : T__struct_4)]);
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < (_data.length), _i++, {
...
function _countOps(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _algo:Interface -> Void, _name:stdgo.GoString):Void {
        ...
        for (__8 => _n in _sizes) {
            var _td:stdgo.sort_test.Sort_test.T_testingData = ({ _desc : _name?.__copy__(), _t : _t, _data : new stdgo.Slice<stdgo.GoInt>((_n : stdgo.GoInt).toBasic(), 0).__setNumber32__(), _maxswap : (2147483647 : stdgo.GoInt) } : stdgo.sort_test.Sort_test.T_testingData);
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_i < _n, _i++, {
                    _td._data[(_i : stdgo.GoInt)] = stdgo.math.rand.Rand.intn(_n / (5 : stdgo.GoInt));
                });
            };
            _algo(stdgo.Go.asInterface((stdgo.Go.setRef(_td) : stdgo.Ref<stdgo.sort_test.Sort_test.T_testingData>)));
...
function testCountStableOps(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        _countOps(_t, stable, ("Stable" : stdgo.GoString));
    }
function testCountSortOps(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        _countOps(_t, sort, ("Sort  " : stdgo.GoString));
    }
function _bench(_b:stdgo.Ref<stdgo.testing.Testing.B>, _size:stdgo.GoInt, _algo:Interface -> Void, _name:stdgo.GoString):Void {
        if (stdgo.strings.Strings.hasSuffix(stdgo.internal.testenv.Testenv.builder()?.__copy__(), ("-race" : stdgo.GoString)) && (_size > (10000 : stdgo.GoInt))) {
            _b.skip(stdgo.Go.toInterface(("skipping slow benchmark on race builder" : stdgo.GoString)));
        };
        _b.stopTimer();
        var _data:stdgo.sort_test.Sort_test.T_intPairs = new stdgo.Slice<T__struct_4>((_size : stdgo.GoInt).toBasic(), 0, ...[for (i in 0 ... ((_size : stdgo.GoInt).toBasic() > 0 ? (_size : stdgo.GoInt).toBasic() : 0 : stdgo.GoInt).toBasic()) ({ _a : (0 : stdgo.GoInt), _b : (0 : stdgo.GoInt) } : T__struct_4)]);
        var _x:stdgo.GoUInt32 = (-1u32 : stdgo.GoUInt32);
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
                {
                    var _n:stdgo.GoInt = _size - (3 : stdgo.GoInt);
                    stdgo.Go.cfor(_n <= (_size + (3 : stdgo.GoInt)), _n++, {
                        {
                            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                            stdgo.Go.cfor(_i < (_data.length), _i++, {
                                _x = _x + (_x);
                                ...
                                _data[(_i : stdgo.GoInt)]._a = (_x % (_n / (5 : stdgo.GoInt) : stdgo.GoUInt32) : stdgo.GoInt);
                            });
                        };
                        _data._initB();
                        _b.startTimer();
...
function benchmarkSort1e2(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _bench(_b, (100 : stdgo.GoInt), sort, ("Sort" : stdgo.GoString));
    }
function benchmarkStable1e2(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _bench(_b, (100 : stdgo.GoInt), stable, ("Stable" : stdgo.GoString));
    }
function benchmarkSort1e4(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _bench(_b, (10000 : stdgo.GoInt), sort, ("Sort" : stdgo.GoString));
    }
function benchmarkStable1e4(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _bench(_b, (10000 : stdgo.GoInt), stable, ("Stable" : stdgo.GoString));
    }
function benchmarkSort1e6(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _bench(_b, (1000000 : stdgo.GoInt), sort, ("Sort" : stdgo.GoString));
    }
function benchmarkStable1e6(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
...
@:keep @:allow(stdgo.sort_test.Sort_test.T_planetSorter_asInterface) class T_planetSorter_static_extension {
    ...
    **/
    ...
    static public function less( _s:stdgo.Ref<T_planetSorter>, _i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
        ...
        return _s._by((stdgo.Go.setRef(_s._planets[(_i : stdgo.GoInt)]) : stdgo.Ref<stdgo.sort_test.Sort_test.Planet>), (stdgo.Go.setRef(_s._planets[(_j : stdgo.GoInt)]) : stdgo.Ref<stdgo.sort_test.Sort_test.Planet>));
    }
    /**
        // Swap is part of sort.Interface.
    **/
...
@:keep @:allow(stdgo.sort_test.Sort_test.T_multiSorter_asInterface) class T_multiSorter_static_extension {
    ...
    **/
    ...
    static public function less( _ms:stdgo.Ref<T_multiSorter>, _i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
        ...
        var __0 = (stdgo.Go.setRef(_ms._changes[(_i : stdgo.GoInt)]) : stdgo.Ref<stdgo.sort_test.Sort_test.Change>), __1 = (stdgo.Go.setRef(_ms._changes[(_j : stdgo.GoInt)]) : stdgo.Ref<stdgo.sort_test.Sort_test.Change>), _q = __1, _p = __0;
        var _k:stdgo.GoInt = (0 : stdgo.GoInt);
        {
            _k = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_k < (_ms._less.length - (1 : stdgo.GoInt)), _k++, {
                var _less:stdgo.sort_test.Sort_test.T_lessFunc = _ms._less[(_k : stdgo.GoInt)];
                if (_less(_p, _q)) {
                    return true;
                } else if (_less(_q, _p)) {
                    return false;
...
@:keep @:allow(stdgo.sort_test.Sort_test.ByName_asInterface) class ByName_static_extension {
    ...
    static public function less( _s:ByName, _i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
        ...
        return _s.organs[(_i : stdgo.GoInt)].name < _s.organs[(_j : stdgo.GoInt)].name;
    }
    @:embedded
...
@:keep @:allow(stdgo.sort_test.Sort_test.ByWeight_asInterface) class ByWeight_static_extension {
    ...
    static public function less( _s:ByWeight, _i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
        ...
        return _s.organs[(_i : stdgo.GoInt)].weight < _s.organs[(_j : stdgo.GoInt)].weight;
    }
    @:embedded
...
@:keep @:allow(stdgo.sort_test.Sort_test.T_nonDeterministicTestingData_asInterface) class T_nonDeterministicTestingData_static_extension {
    ...
    static public function swap( _t:stdgo.Ref<T_nonDeterministicTestingData>, _i:stdgo.GoInt, _j:stdgo.GoInt):Void {
        ...
        if ((((_i < (0 : stdgo.GoInt)) || (_j < (0 : stdgo.GoInt))) || (_i >= _t.len())) || (_j >= _t.len())) {
    ...
    static public function less( _t:stdgo.Ref<T_nonDeterministicTestingData>, _i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
        ...
        return _t._r.float32() < (0.5 : stdgo.GoFloat64);
    }
    @:keep
...
@:keep @:allow(stdgo.sort_test.Sort_test.T_testingData_asInterface) class T_testingData_static_extension {
    ...
    static public function less( _d:stdgo.Ref<T_testingData>, _i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
        @:recv var _d:stdgo.Ref<T_testingData> = _d;
        _d._ncmp++;
        return _d._data[(_i : stdgo.GoInt)] < _d._data[(_j : stdgo.GoInt)];
    }
    @:keep
...
@:keep @:allow(stdgo.sort_test.Sort_test.T_adversaryTestingData_asInterface) class T_adversaryTestingData_static_extension {
    ...
    static public function less( _d:stdgo.Ref<T_adversaryTestingData>, _i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
        ...
        _d._ncmp++;
        if ((_d._data[(_i : stdgo.GoInt)] == _d._gas) && (_d._data[(_j : stdgo.GoInt)] == _d._gas)) {
            if (_i == (_d._candidate)) {
...
@:keep @:allow(stdgo.sort_test.Sort_test.ByAge_asInterface) class ByAge_static_extension {
    ...
    static public function less( _a:ByAge, _i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
        ...
        return _a[(_i : stdgo.GoInt)].age < _a[(_j : stdgo.GoInt)].age;
    }
    @:keep
...
@:keep @:allow(stdgo.sort_test.Sort_test.By_asInterface) class By_static_extension {
    ...
    **/
    ...
    static public function sort( _by:By, _planets:stdgo.Slice<Planet>):Void {
        @:recv var _by:By = _by;
        var _ps = (stdgo.Go.setRef(({ _planets : _planets, _by : _by } : stdgo.sort_test.Sort_test.T_planetSorter)) : stdgo.Ref<stdgo.sort_test.Sort_test.T_planetSorter>);
...
@:keep @:allow(stdgo.sort_test.Sort_test.Grams_asInterface) class Grams_static_extension {
    ...
    static public function string( _g:Grams):stdgo.GoString {
        ...
        return stdgo.fmt.Fmt.sprintf(("%dg" : stdgo.GoString), stdgo.Go.toInterface((_g : stdgo.GoInt)))?.__copy__();
    }
}
...
@:keep @:allow(stdgo.sort_test.Sort_test.T_intPairs_asInterface) class T_intPairs_static_extension {
    ...
    **/
    ...
    static public function less( _d:T_intPairs, _i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
        @:recv var _d:T_intPairs = _d;
        return _d[(_i : stdgo.GoInt)]._a < _d[(_j : stdgo.GoInt)]._a;
    }
    /**
        // IntPairs compare on a only.
    **/
