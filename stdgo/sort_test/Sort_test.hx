...
**/
private var _data = {
        var s = new Slice<GoInt>(14, 0).__setNumber32__();
        s[0] = (-10 : GoInt);
        s[1] = (-5 : GoInt);
        s[2] = (0 : GoInt);
        s[3] = (1 : GoInt);
...
({ _name : ("descending a" : GoString), _n : (7 : GoInt), _f : function(_i:GoInt):Bool {
        return (new Slice<GoInt>(8, 8, (99 : GoInt), (99 : GoInt), (59 : GoInt), (42 : GoInt), (7 : GoInt), (0 : GoInt), (-1 : GoInt), (-1 : GoInt)) : Slice<GoInt>)[(_i : GoInt)] <= (7 : GoInt);
...
**/
private var _fdata = {
        var s = new Slice<GoFloat64>(5, 0).__setNumber32__();
        s[0] = (-3.14 : GoFloat64);
        s[1] = (0 : GoFloat64);
        s[2] = (1 : GoFloat64);
        s[3] = (2 : GoFloat64);
...
**/
private var _sdata = {
        var s = new Slice<GoString>(4, 0).__setString__();
        s[0] = ("f" : GoString);
        s[1] = ("foo" : GoString);
        s[2] = ("foobar" : GoString);
        s[3] = ("x" : GoString);
...
**/
private final __Sawtooth = (5i64 : GoUInt64);
/**
    
    
    
**/
private final __Rand = (5i64 : GoUInt64);
/**
    
    
    
**/
private final __Stagger = (5i64 : GoUInt64);
/**
    
    
    
**/
private final __Plateau = (5i64 : GoUInt64);
/**
    
    
    
**/
private final __Shuffle = (5i64 : GoUInt64);
/**
    
    
    
**/
private final __NDist = (5i64 : GoUInt64);
/**
    
    
    
**/
private final __Copy = (6i64 : GoUInt64);
/**
    
    
    
**/
private final __Reverse = (6i64 : GoUInt64);
/**
    
    
    
**/
private final __ReverseFirstHalf = (6i64 : GoUInt64);
/**
    
    
    
**/
private final __ReverseSecondHalf = (6i64 : GoUInt64);
/**
    
    
    
**/
private final __Sorted = (6i64 : GoUInt64);
/**
    
    
    
**/
private final __Dither = (6i64 : GoUInt64);
/**
    
    
    
**/
private final __NMode = (6i64 : GoUInt64);
/**
...
function orderedBy(_less:haxe.Rest<T_lessFunc>):Ref<T_multiSorter> {
        ...
        return (Go.setRef(({ _less : _less } : T_multiSorter)) : Ref<stdgo.sort_test.Sort_test.T_multiSorter>);
    }
/**
...
function testFind(_t:Ref<stdgo.testing.Testing.T>):Void {
        var _str1 = (new Slice<GoString>(1, 1, ("foo" : GoString)) : Slice<GoString>);
        var _str2 = (new Slice<GoString>(2, 2, ("ab" : GoString), ("ca" : GoString)) : Slice<GoString>);
        var _str3 = (new Slice<GoString>(3, 3, ("mo" : GoString), ("qo" : GoString), ("vo" : GoString)) : Slice<GoString>);
        var _str4 = (new Slice<GoString>(4, 4, ("ab" : GoString), ("ad" : GoString), ("ca" : GoString), ("xy" : GoString)) : Slice<GoString>);
...
("ta" : GoString)) : Slice<GoString>);
        var _strSame = (new Slice<GoString>(3, 3, ("xx" : GoString), ("xx" : GoString), ("xx" : GoString)) : Slice<GoString>);
...
function testSortIntSlice(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _a:stdgo.sort.Sort.IntSlice = ((_data.__slice__((0 : GoInt)) : Slice<GoInt>) : IntSlice);
...
function testSortFloat64Slice(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _a:stdgo.sort.Sort.Float64Slice = ((_data.__slice__((0 : GoInt)) : Slice<GoFloat64>) : Float64Slice);
        sort(Go.asInterface(_a));
        if (!isSorted(Go.asInterface(_a))) {
...
function testSortStringSlice(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _a:stdgo.sort.Sort.StringSlice = ((_data.__slice__((0 : GoInt)) : Slice<GoString>) : StringSlice);
        sort(Go.asInterface(_a));
        if (!isSorted(Go.asInterface(_a))) {
...
function testSortLarge_Random(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _data = new Slice<GoInt>((_n : GoInt).toBasic(), 0).__setNumber32__();
        {
            var _i:GoInt = (0 : GoInt);
...
function testReverseSortIntSlice(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _a:stdgo.sort.Sort.IntSlice = ((_data.__slice__((0 : GoInt)) : Slice<GoInt>) : IntSlice);
        sort(Go.asInterface(_a));
        var _r:stdgo.sort.Sort.IntSlice = ((_data1.__slice__((0 : GoInt)) : Slice<GoInt>) : IntSlice);
...
function testBreakPatterns(_t:Ref<stdgo.testing.Testing.T>):Void {
        var _data = new Slice<GoInt>((30 : GoInt).toBasic(), 0).__setNumber32__();
...
function testReverseRange(_t:Ref<stdgo.testing.Testing.T>):Void {
        var _data = (new Slice<GoInt>(7, 7, (1 : GoInt), (2 : GoInt), (3 : GoInt), (4 : GoInt), (5 : GoInt), (6 : GoInt), (7 : GoInt)) : Slice<GoInt>);
        ...
        var _data1 = (new Slice<GoInt>(7, 7, (1 : GoInt), (2 : GoInt), (3 : GoInt), (4 : GoInt), (5 : GoInt), (6 : GoInt), (7 : GoInt)) : Slice<GoInt>);
        var _data2 = (new Slice<GoInt>(7, 7, (1 : GoInt), (2 : GoInt), (5 : GoInt), (4 : GoInt), (3 : GoInt), (6 : GoInt), (7 : GoInt)) : Slice<GoInt>);
...
function testNonDeterministicComparison(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        try {
            ...
            var _td = (Go.setRef(({ _r : stdgo.math.rand.Rand.new_(stdgo.math.rand.Rand.newSource((0i64 : GoInt64))) } : T_nonDeterministicTestingData)) : Ref<stdgo.sort_test.Sort_test.T_nonDeterministicTestingData>);
            {
                var _i:GoInt = (0 : GoInt);
...
function benchmarkSortString1K(_b:Ref<stdgo.testing.Testing.B>):Void {
        _b.stopTimer();
        var _unsorted = new Slice<GoString>((1024 : GoInt).toBasic(), 0).__setString__();
        for (_i in 0 ... _unsorted.length.toBasic()) {
            _unsorted[(_i : GoInt)] = stdgo.strconv.Strconv.itoa(_i ^ (716 : GoInt));
        };
        var _data = new Slice<GoString>((_unsorted.length : GoInt).toBasic(), 0).__setString__();
        {
            var _i:GoInt = (0 : GoInt);
            Go.cfor(_i < _b.n, _i++, {
...
function benchmarkSortInt1K(_b:Ref<stdgo.testing.Testing.B>):Void {
        _b.stopTimer();
        {
            var _i:GoInt = (0 : GoInt);
            Go.cfor(_i < _b.n, _i++, {
                var _data = new Slice<GoInt>((1024 : GoInt).toBasic(), 0).__setNumber32__();
                {
                    var _i:GoInt = (0 : GoInt);
                    Go.cfor(_i < (_data.length), _i++, {
...
function benchmarkStableInt1K(_b:Ref<stdgo.testing.Testing.B>):Void {
        _b.stopTimer();
        var _unsorted = new Slice<GoInt>((1024 : GoInt).toBasic(), 0).__setNumber32__();
        for (_i in 0 ... _unsorted.length.toBasic()) {
            _unsorted[(_i : GoInt)] = _i ^ (716 : GoInt);
        };
        var _data = new Slice<GoInt>((_unsorted.length : GoInt).toBasic(), 0).__setNumber32__();
        {
            var _i:GoInt = (0 : GoInt);
            Go.cfor(_i < _b.n, _i++, {
                Go.copySlice(_data, _unsorted);
...
function benchmarkSortInt64K(_b:Ref<stdgo.testing.Testing.B>):Void {
        _b.stopTimer();
        {
            var _i:GoInt = (0 : GoInt);
            Go.cfor(_i < _b.n, _i++, {
                var _data = new Slice<GoInt>((65536 : GoInt).toBasic(), 0).__setNumber32__();
                {
                    var _i:GoInt = (0 : GoInt);
                    Go.cfor(_i < (_data.length), _i++, {
...
private function _testBentleyMcIlroy(_t:Ref<stdgo.testing.Testing.T>, _sort:Interface -> Void, _maxswap:GoInt -> GoInt):Void {
        var _sizes = (new Slice<GoInt>(4, 4, (100 : GoInt), (1023 : GoInt), (1024 : GoInt), (1025 : GoInt)) : Slice<GoInt>);
        if (stdgo.testing.Testing.short()) {
            _sizes = (new Slice<GoInt>(4, 4, (100 : GoInt), (127 : GoInt), (128 : GoInt), (129 : GoInt)) : Slice<GoInt>);
        };
        var _dists = (new Slice<GoString>(5, 5, ("sawtooth" : GoString), ("rand" : GoString), ("stagger" : GoString), ("plateau" : GoString), ("shuffle" : GoString)) : Slice<GoString>);
        var _modes = (new Slice<GoString>(6, 6, ("copy" : GoString), ("reverse" : GoString), ("reverse1" : GoString), ("reverse2" : GoString), ("sort" : GoString), ("dither" : GoString)) : Slice<GoString>);
        var __0:GoArray<GoInt> = new GoArray<GoInt>(...[for (i in 0 ... 1025) (0 : GoInt)]), __1:GoArray<GoInt> = new GoArray<GoInt>(...[for (i in 0 ... 1025) (0 : GoInt)]), _tmp2:GoArray<GoInt> = __1, _tmp1:GoArray<GoInt> = __0;
                        ...
                        Go.cfor(_dist < (5 : GoInt), _dist++, {
                            ...
                            var _mdata = (_tmp2.__slice__((0 : GoInt), _n) : Slice<GoInt>);
                            {
                                ...
                                Go.cfor(_mode < (6 : GoInt), _mode++, {
                                    ...
                                    var _d = (Go.setRef(({ _desc : _desc, _t : _t, _data : (_mdata.__slice__((0 : GoInt), _n) : Slice<GoInt>), _maxswap : _maxswap(_n) } : T_testingData)) : Ref<stdgo.sort_test.Sort_test.T_testingData>);
...
private function _newAdversaryTestingData(_t:Ref<stdgo.testing.Testing.T>, _size:GoInt, _maxcmp:GoInt):Ref<T_adversaryTestingData> {
        ...
        var _data = new Slice<GoInt>((_size : GoInt).toBasic(), 0).__setNumber32__();
        {
            var _i:GoInt = (0 : GoInt);
            Go.cfor(_i < _size, _i++, {
                _data[(_i : GoInt)] = _gas;
        ...
        return (Go.setRef(({ _t : _t, _data : _data, _maxcmp : _maxcmp, _gas : _gas } : T_adversaryTestingData)) : Ref<stdgo.sort_test.Sort_test.T_adversaryTestingData>);
    }
...
function testStability(_t:Ref<stdgo.testing.Testing.T>):Void {
        var __0:GoInt = (100000 : GoInt), __1:GoInt = (1000 : GoInt), _m:GoInt = __1, _n:GoInt = __0;
        if (stdgo.testing.Testing.short()) {
            {
        ...
        var _data:stdgo.sort_test.Sort_test.T_intPairs = new Slice<T__struct_4>((_n : GoInt).toBasic(), 0, ...[for (i in 0 ... ((_n : GoInt).toBasic() > 0 ? (_n : GoInt).toBasic() : 0 : GoInt).toBasic()) ({ _a : (0 : GoInt), _b : (0 : GoInt) } : T__struct_4)]);
        {
            var _i:GoInt = (0 : GoInt);
            Go.cfor(_i < (_data.length), _i++, {
...
private function _countOps(_t:Ref<stdgo.testing.Testing.T>, _algo:Interface -> Void, _name:GoString):Void {
        ...
        for (__0 => _n in _sizes) {
            var _td:stdgo.sort_test.Sort_test.T_testingData = ({ _desc : _name, _t : _t, _data : new Slice<GoInt>((_n : GoInt).toBasic(), 0).__setNumber32__(), _maxswap : (2147483647 : GoInt) } : T_testingData);
            {
                var _i:GoInt = (0 : GoInt);
                Go.cfor(_i < _n, _i++, {
            ...
            _algo(Go.asInterface((Go.setRef(_td) : Ref<stdgo.sort_test.Sort_test.T_testingData>)));
...
private function _bench(_b:Ref<stdgo.testing.Testing.B>, _size:GoInt, _algo:Interface -> Void, _name:GoString):Void {
        ...
        _b.stopTimer();
        var _data:stdgo.sort_test.Sort_test.T_intPairs = new Slice<T__struct_4>((_size : GoInt).toBasic(), 0, ...[for (i in 0 ... ((_size : GoInt).toBasic() > 0 ? (_size : GoInt).toBasic() : 0 : GoInt).toBasic()) ({ _a : (0 : GoInt), _b : (0 : GoInt) } : T__struct_4)]);
...
@:keep @:allow(stdgo.sort_test.Sort_test.T_planetSorter_asInterface) class T_planetSorter_static_extension {
    ...
    **/
    ...
    static public function less( _s:Ref<T_planetSorter>, _i:GoInt, _j:GoInt):Bool {
        return _s._by((Go.setRef(_s._planets[(_i : GoInt)]) : Ref<stdgo.sort_test.Sort_test.Planet>), (Go.setRef(_s._planets[(_j : GoInt)]) : Ref<stdgo.sort_test.Sort_test.Planet>));
    }
    /**
        // Swap is part of sort.Interface.
    **/
    ...
    static public function swap( _s:Ref<T_planetSorter>, _i:GoInt, _j:GoInt):Void {
        {
            final __tmp__0 = _s._planets[(_j : GoInt)];
            final __tmp__1 = _s._planets[(_i : GoInt)];
...
class T_multiSorter_asInterface {
    ...
    **/
    @:keep
    public dynamic function sort(_changes:Slice<Change>):Void __self__.value.sort(_changes);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
@:keep @:allow(stdgo.sort_test.Sort_test.T_multiSorter_asInterface) class T_multiSorter_static_extension {
    ...
    **/
    ...
    static public function less( _ms:Ref<T_multiSorter>, _i:GoInt, _j:GoInt):Bool {
        var __0 = (Go.setRef(_ms._changes[(_i : GoInt)]) : Ref<stdgo.sort_test.Sort_test.Change>), __1 = (Go.setRef(_ms._changes[(_j : GoInt)]) : Ref<stdgo.sort_test.Sort_test.Change>), _q = __1, _p = __0;
    ...
    **/
    ...
    static public function swap( _ms:Ref<T_multiSorter>, _i:GoInt, _j:GoInt):Void {
        {
            final __tmp__0 = _ms._changes[(_j : GoInt)];
            final __tmp__1 = _ms._changes[(_i : GoInt)];
...
class By_asInterface {
    ...
    **/
    @:keep
    public dynamic function sort(_planets:Slice<Planet>):Void __self__.value.sort(_planets);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
@:keep @:allow(stdgo.sort_test.Sort_test.By_asInterface) class By_static_extension {
    ...
    **/
    ...
    static public function sort( _by:By, _planets:Slice<Planet>):Void {
        var _ps = (Go.setRef(({ _planets : _planets, _by : _by } : T_planetSorter)) : Ref<stdgo.sort_test.Sort_test.T_planetSorter>);
...
@:keep @:allow(stdgo.sort_test.Sort_test.T_intPairs_asInterface) class T_intPairs_static_extension {
    ...
    **/
    ...
    static public function _inOrder( _d:T_intPairs):Bool {
        var __0:GoInt = (-1 : GoInt), __1:GoInt = (0 : GoInt), _lastB:GoInt = __1, _lastA:GoInt = __0;
        {
            var _i:GoInt = (0 : GoInt);
