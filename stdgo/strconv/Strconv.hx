    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2706869
    			_ = gotoNext == 2706869
    			n_2706817 = powtab[d.dp]
    			gotoNext = 2706897
    		}
    		_ = gotoNext == 2706897
    		d.Shift(-n_2706817)
    		exp_2706359 += n_2706817
    		gotoNext = 2706796
    	} else {
    		gotoNext = 2706924
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2707027
    			_ = gotoNext == 2707027
    			n_2706974 = powtab[-d.dp]
    			gotoNext = 2707056
    		}
    		_ = gotoNext == 2707056
    		d.Shift(n_2706974)
    		exp_2706359 -= n_2706974
    		gotoNext = 2706924
    	} else {
    		gotoNext = 2707143
    	}
    	_ = gotoNext == 2707143
    	exp_2706359--
    	if exp_2706359 < flt.bias+1 {
    		gotoNext = 2707294
    		_ = gotoNext == 2707294
    		n_2707298 = flt.bias + 1 - exp_2706359
    		d.Shift(-n_2707298)
    		exp_2706359 += n_2707298
    		gotoNext = 2707352
    	} else {
    		gotoNext = 2707352
    	}
    	_ = gotoNext == 2707352
    	if exp_2706359-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2707388
    		_ = gotoNext == 2707388
    		gotoNext = 2707751
    		gotoNext = 2707444
    	...
    	mant_2706372 = d.RoundedInteger()
    	if mant_2706372 == 2<<flt.mantbits {
    		gotoNext = 2707580
    		_ = gotoNext == 2707580
    		mant_2706372 >>= 1
    		exp_2706359++
    	...
    	_ = gotoNext == 2707687
    	if mant_2706372&(1<<flt.mantbits) == 0 {
    		gotoNext = 2707718
    		_ = gotoNext == 2707718
    		exp_2706359 = flt.bias
    		gotoNext = 2707741
    	...
    	_ = gotoNext == 2707751
    	mant_2706372 = 0
    	exp_2706359 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2707836
    	_ = gotoNext == 2707836
    	bits_2707861 = mant_2706372 & (uint64(1)<<flt.mantbits - 1)
    	bits_2707861 |= uint64((exp_2706359-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2707983
    		_ = gotoNext == 2707983
    		bits_2707861 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2708032
    	} else {
    		gotoNext = 2708032
    	}
    	_ = gotoNext == 2708032
    	return bits_2707861, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
