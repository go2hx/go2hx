    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2862310
    			_ = gotoNext == 2862310
    			n_2862258 = powtab[d.dp]
    			gotoNext = 2862338
    		}
    		_ = gotoNext == 2862338
    		d.Shift(-n_2862258)
    		exp_2861800 += n_2862258
    		gotoNext = 2862237
    	} else {
    		gotoNext = 2862365
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2862468
    			_ = gotoNext == 2862468
    			n_2862415 = powtab[-d.dp]
    			gotoNext = 2862497
    		}
    		_ = gotoNext == 2862497
    		d.Shift(n_2862415)
    		exp_2861800 -= n_2862415
    		gotoNext = 2862365
    	} else {
    		gotoNext = 2862584
    	}
    	_ = gotoNext == 2862584
    	exp_2861800--
    	if exp_2861800 < flt.bias+1 {
    		gotoNext = 2862735
    		_ = gotoNext == 2862735
    		n_2862739 = flt.bias + 1 - exp_2861800
    		d.Shift(-n_2862739)
    		exp_2861800 += n_2862739
    		gotoNext = 2862793
    	} else {
    		gotoNext = 2862793
    	}
    	_ = gotoNext == 2862793
    	if exp_2861800-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2862829
    		_ = gotoNext == 2862829
    		gotoNext = 2863192
    		gotoNext = 2862885
    	...
    	mant_2861813 = d.RoundedInteger()
    	if mant_2861813 == 2<<flt.mantbits {
    		gotoNext = 2863021
    		_ = gotoNext == 2863021
    		mant_2861813 >>= 1
    		exp_2861800++
    	...
    	_ = gotoNext == 2863128
    	if mant_2861813&(1<<flt.mantbits) == 0 {
    		gotoNext = 2863159
    		_ = gotoNext == 2863159
    		exp_2861800 = flt.bias
    		gotoNext = 2863182
    	...
    	_ = gotoNext == 2863192
    	mant_2861813 = 0
    	exp_2861800 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2863277
    	_ = gotoNext == 2863277
    	bits_2863302 = mant_2861813 & (uint64(1)<<flt.mantbits - 1)
    	bits_2863302 |= uint64((exp_2861800-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2863424
    		_ = gotoNext == 2863424
    		bits_2863302 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2863473
    	} else {
    		gotoNext = 2863473
    	}
    	_ = gotoNext == 2863473
    	return bits_2863302, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
