    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2636810
    			_ = gotoNext == 2636810
    			n_2636758 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2636838
    		}
    		_ = gotoNext == 2636838
    		d.Shift(-n_2636758)
    		exp_2636300 += n_2636758
    		gotoNext = 2636737
    	} else {
    		gotoNext = 2636865
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2636968
    			_ = gotoNext == 2636968
    			n_2636915 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2636997
    		}
    		_ = gotoNext == 2636997
    		d.Shift(n_2636915)
    		exp_2636300 -= n_2636915
    		gotoNext = 2636865
    	} else {
    		gotoNext = 2637084
    	}
    	_ = gotoNext == 2637084
    	exp_2636300--
    	if exp_2636300 < flt.bias+1 {
    		gotoNext = 2637235
    		_ = gotoNext == 2637235
    		n_2637239 = flt.bias + 1 - exp_2636300
    		d.Shift(-n_2637239)
    		exp_2636300 += n_2637239
    		gotoNext = 2637293
    	} else {
    		gotoNext = 2637293
    	}
    	_ = gotoNext == 2637293
    	if exp_2636300-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2637329
    		_ = gotoNext == 2637329
    		gotoNext = 2637692
    		gotoNext = 2637385
    	...
    	mant_2636313 = d.RoundedInteger()
    	if mant_2636313 == 2<<flt.mantbits {
    		gotoNext = 2637521
    		_ = gotoNext == 2637521
    		mant_2636313 >>= 1
    		exp_2636300++
    	...
    	_ = gotoNext == 2637628
    	if mant_2636313&(1<<flt.mantbits) == 0 {
    		gotoNext = 2637659
    		_ = gotoNext == 2637659
    		exp_2636300 = flt.bias
    		gotoNext = 2637682
    	...
    	_ = gotoNext == 2637692
    	mant_2636313 = 0
    	exp_2636300 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2637777
    	_ = gotoNext == 2637777
    	bits_2637802 = mant_2636313 & (uint64(1)<<flt.mantbits - 1)
    	bits_2637802 |= uint64((exp_2636300-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2637924
    		_ = gotoNext == 2637924
    		bits_2637802 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2637973
    	} else {
    		gotoNext = 2637973
    	}
    	_ = gotoNext == 2637973
    	return bits_2637802, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
