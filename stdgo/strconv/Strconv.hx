    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2837458
    			_ = gotoNext == 2837458
    			n_2837406 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2837486
    		}
    		_ = gotoNext == 2837486
    		d.Shift(-n_2837406)
    		exp_2836948 += n_2837406
    		gotoNext = 2837385
    	} else {
    		gotoNext = 2837513
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2837616
    			_ = gotoNext == 2837616
    			n_2837563 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2837645
    		}
    		_ = gotoNext == 2837645
    		d.Shift(n_2837563)
    		exp_2836948 -= n_2837563
    		gotoNext = 2837513
    	} else {
    		gotoNext = 2837732
    	}
    	_ = gotoNext == 2837732
    	exp_2836948--
    	if exp_2836948 < flt.bias+1 {
    		gotoNext = 2837883
    		_ = gotoNext == 2837883
    		n_2837887 = flt.bias + 1 - exp_2836948
    		d.Shift(-n_2837887)
    		exp_2836948 += n_2837887
    		gotoNext = 2837941
    	} else {
    		gotoNext = 2837941
    	}
    	_ = gotoNext == 2837941
    	if exp_2836948-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2837977
    		_ = gotoNext == 2837977
    		gotoNext = 2838340
    		gotoNext = 2838033
    	...
    	mant_2836961 = d.RoundedInteger()
    	if mant_2836961 == 2<<flt.mantbits {
    		gotoNext = 2838169
    		_ = gotoNext == 2838169
    		mant_2836961 >>= 1
    		exp_2836948++
    	...
    	_ = gotoNext == 2838276
    	if mant_2836961&(1<<flt.mantbits) == 0 {
    		gotoNext = 2838307
    		_ = gotoNext == 2838307
    		exp_2836948 = flt.bias
    		gotoNext = 2838330
    	...
    	_ = gotoNext == 2838340
    	mant_2836961 = 0
    	exp_2836948 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2838425
    	_ = gotoNext == 2838425
    	bits_2838450 = mant_2836961 & (uint64(1)<<flt.mantbits - 1)
    	bits_2838450 |= uint64((exp_2836948-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2838572
    		_ = gotoNext == 2838572
    		bits_2838450 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2838621
    	} else {
    		gotoNext = 2838621
    	}
    	_ = gotoNext == 2838621
    	return bits_2838450, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
