    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2661338
    			_ = gotoNext == 2661338
    			n_2661286 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2661366
    		}
    		_ = gotoNext == 2661366
    		d.Shift(-n_2661286)
    		exp_2660828 += n_2661286
    		gotoNext = 2661265
    	} else {
    		gotoNext = 2661393
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2661496
    			_ = gotoNext == 2661496
    			n_2661443 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2661525
    		}
    		_ = gotoNext == 2661525
    		d.Shift(n_2661443)
    		exp_2660828 -= n_2661443
    		gotoNext = 2661393
    	} else {
    		gotoNext = 2661612
    	}
    	_ = gotoNext == 2661612
    	exp_2660828--
    	if exp_2660828 < flt.bias+1 {
    		gotoNext = 2661763
    		_ = gotoNext == 2661763
    		n_2661767 = flt.bias + 1 - exp_2660828
    		d.Shift(-n_2661767)
    		exp_2660828 += n_2661767
    		gotoNext = 2661821
    	} else {
    		gotoNext = 2661821
    	}
    	_ = gotoNext == 2661821
    	if exp_2660828-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2661857
    		_ = gotoNext == 2661857
    		gotoNext = 2662220
    		gotoNext = 2661913
    	...
    	mant_2660841 = d.RoundedInteger()
    	if mant_2660841 == 2<<flt.mantbits {
    		gotoNext = 2662049
    		_ = gotoNext == 2662049
    		mant_2660841 >>= 1
    		exp_2660828++
    	...
    	_ = gotoNext == 2662156
    	if mant_2660841&(1<<flt.mantbits) == 0 {
    		gotoNext = 2662187
    		_ = gotoNext == 2662187
    		exp_2660828 = flt.bias
    		gotoNext = 2662210
    	...
    	_ = gotoNext == 2662220
    	mant_2660841 = 0
    	exp_2660828 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2662305
    	_ = gotoNext == 2662305
    	bits_2662330 = mant_2660841 & (uint64(1)<<flt.mantbits - 1)
    	bits_2662330 |= uint64((exp_2660828-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2662452
    		_ = gotoNext == 2662452
    		bits_2662330 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2662501
    	} else {
    		gotoNext = 2662501
    	}
    	_ = gotoNext == 2662501
    	return bits_2662330, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
