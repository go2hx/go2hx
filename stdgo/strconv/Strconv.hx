    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2746606
    			_ = gotoNext == 2746606
    			n_2746554 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2746634
    		}
    		_ = gotoNext == 2746634
    		d.Shift(-n_2746554)
    		exp_2746096 += n_2746554
    		gotoNext = 2746533
    	} else {
    		gotoNext = 2746661
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2746764
    			_ = gotoNext == 2746764
    			n_2746711 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2746793
    		}
    		_ = gotoNext == 2746793
    		d.Shift(n_2746711)
    		exp_2746096 -= n_2746711
    		gotoNext = 2746661
    	} else {
    		gotoNext = 2746880
    	}
    	_ = gotoNext == 2746880
    	exp_2746096--
    	if exp_2746096 < flt.bias+1 {
    		gotoNext = 2747031
    		_ = gotoNext == 2747031
    		n_2747035 = flt.bias + 1 - exp_2746096
    		d.Shift(-n_2747035)
    		exp_2746096 += n_2747035
    		gotoNext = 2747089
    	} else {
    		gotoNext = 2747089
    	}
    	_ = gotoNext == 2747089
    	if exp_2746096-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2747125
    		_ = gotoNext == 2747125
    		gotoNext = 2747488
    		gotoNext = 2747181
    	...
    	mant_2746109 = d.RoundedInteger()
    	if mant_2746109 == 2<<flt.mantbits {
    		gotoNext = 2747317
    		_ = gotoNext == 2747317
    		mant_2746109 >>= 1
    		exp_2746096++
    	...
    	_ = gotoNext == 2747424
    	if mant_2746109&(1<<flt.mantbits) == 0 {
    		gotoNext = 2747455
    		_ = gotoNext == 2747455
    		exp_2746096 = flt.bias
    		gotoNext = 2747478
    	...
    	_ = gotoNext == 2747488
    	mant_2746109 = 0
    	exp_2746096 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2747573
    	_ = gotoNext == 2747573
    	bits_2747598 = mant_2746109 & (uint64(1)<<flt.mantbits - 1)
    	bits_2747598 |= uint64((exp_2746096-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2747720
    		_ = gotoNext == 2747720
    		bits_2747598 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2747769
    	} else {
    		gotoNext = 2747769
    	}
    	_ = gotoNext == 2747769
    	return bits_2747598, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
