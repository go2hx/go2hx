    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2634341
    			_ = gotoNext == 2634341
    			n_2634289 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2634369
    		}
    		_ = gotoNext == 2634369
    		d.Shift(-n_2634289)
    		exp_2633831 += n_2634289
    		gotoNext = 2634268
    	} else {
    		gotoNext = 2634396
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2634499
    			_ = gotoNext == 2634499
    			n_2634446 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2634528
    		}
    		_ = gotoNext == 2634528
    		d.Shift(n_2634446)
    		exp_2633831 -= n_2634446
    		gotoNext = 2634396
    	} else {
    		gotoNext = 2634615
    	}
    	_ = gotoNext == 2634615
    	exp_2633831--
    	if exp_2633831 < flt.bias+1 {
    		gotoNext = 2634766
    		_ = gotoNext == 2634766
    		n_2634770 = flt.bias + 1 - exp_2633831
    		d.Shift(-n_2634770)
    		exp_2633831 += n_2634770
    		gotoNext = 2634824
    	} else {
    		gotoNext = 2634824
    	}
    	_ = gotoNext == 2634824
    	if exp_2633831-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2634860
    		_ = gotoNext == 2634860
    		gotoNext = 2635223
    		gotoNext = 2634916
    	...
    	mant_2633844 = d.RoundedInteger()
    	if mant_2633844 == 2<<flt.mantbits {
    		gotoNext = 2635052
    		_ = gotoNext == 2635052
    		mant_2633844 >>= 1
    		exp_2633831++
    	...
    	_ = gotoNext == 2635159
    	if mant_2633844&(1<<flt.mantbits) == 0 {
    		gotoNext = 2635190
    		_ = gotoNext == 2635190
    		exp_2633831 = flt.bias
    		gotoNext = 2635213
    	...
    	_ = gotoNext == 2635223
    	mant_2633844 = 0
    	exp_2633831 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2635308
    	_ = gotoNext == 2635308
    	bits_2635333 = mant_2633844 & (uint64(1)<<flt.mantbits - 1)
    	bits_2635333 |= uint64((exp_2633831-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2635455
    		_ = gotoNext == 2635455
    		bits_2635333 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2635504
    	} else {
    		gotoNext = 2635504
    	}
    	_ = gotoNext == 2635504
    	return bits_2635333, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
