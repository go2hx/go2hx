...
private function set_bitSizeError(v:(String, String, StdTypes.Int) -> NumError):(String, String, StdTypes.Int) -> NumError {
        stdgo._internal.strconv.Strconv_bitsizeerror.bitSizeError = (_0, _1, _2) -> (v((_0 : stdgo.GoString), (_1 : stdgo.GoString), (_2 : stdgo.GoInt)) : stdgo.Ref<stdgo._internal.strconv.Strconv_numerror.NumError>);
        return v;
    }
...
private function set_baseError(v:(String, String, StdTypes.Int) -> NumError):(String, String, StdTypes.Int) -> NumError {
        stdgo._internal.strconv.Strconv_baseerror.baseError = (_0, _1, _2) -> (v((_0 : stdgo.GoString), (_1 : stdgo.GoString), (_2 : stdgo.GoInt)) : stdgo.Ref<stdgo._internal.strconv.Strconv_numerror.NumError>);
        return v;
    }
