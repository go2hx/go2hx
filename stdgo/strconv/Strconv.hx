    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2631609
    			_ = gotoNext == 2631609
    			n_2631557 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2631637
    		}
    		_ = gotoNext == 2631637
    		d.Shift(-n_2631557)
    		exp_2631099 += n_2631557
    		gotoNext = 2631536
    	} else {
    		gotoNext = 2631664
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2631767
    			_ = gotoNext == 2631767
    			n_2631714 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2631796
    		}
    		_ = gotoNext == 2631796
    		d.Shift(n_2631714)
    		exp_2631099 -= n_2631714
    		gotoNext = 2631664
    	} else {
    		gotoNext = 2631883
    	}
    	_ = gotoNext == 2631883
    	exp_2631099--
    	if exp_2631099 < flt.bias+1 {
    		gotoNext = 2632034
    		_ = gotoNext == 2632034
    		n_2632038 = flt.bias + 1 - exp_2631099
    		d.Shift(-n_2632038)
    		exp_2631099 += n_2632038
    		gotoNext = 2632092
    	} else {
    		gotoNext = 2632092
    	}
    	_ = gotoNext == 2632092
    	if exp_2631099-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2632128
    		_ = gotoNext == 2632128
    		gotoNext = 2632491
    		gotoNext = 2632184
    	...
    	mant_2631112 = d.RoundedInteger()
    	if mant_2631112 == 2<<flt.mantbits {
    		gotoNext = 2632320
    		_ = gotoNext == 2632320
    		mant_2631112 >>= 1
    		exp_2631099++
    	...
    	_ = gotoNext == 2632427
    	if mant_2631112&(1<<flt.mantbits) == 0 {
    		gotoNext = 2632458
    		_ = gotoNext == 2632458
    		exp_2631099 = flt.bias
    		gotoNext = 2632481
    	...
    	_ = gotoNext == 2632491
    	mant_2631112 = 0
    	exp_2631099 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2632576
    	_ = gotoNext == 2632576
    	bits_2632601 = mant_2631112 & (uint64(1)<<flt.mantbits - 1)
    	bits_2632601 |= uint64((exp_2631099-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2632723
    		_ = gotoNext == 2632723
    		bits_2632601 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2632772
    	} else {
    		gotoNext = 2632772
    	}
    	_ = gotoNext == 2632772
    	return bits_2632601, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
