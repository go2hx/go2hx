    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2685411
    			_ = gotoNext == 2685411
    			n_2685359 = powtab[d.dp]
    			gotoNext = 2685439
    		}
    		_ = gotoNext == 2685439
    		d.Shift(-n_2685359)
    		exp_2684901 += n_2685359
    		gotoNext = 2685338
    	} else {
    		gotoNext = 2685466
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2685569
    			_ = gotoNext == 2685569
    			n_2685516 = powtab[-d.dp]
    			gotoNext = 2685598
    		}
    		_ = gotoNext == 2685598
    		d.Shift(n_2685516)
    		exp_2684901 -= n_2685516
    		gotoNext = 2685466
    	} else {
    		gotoNext = 2685685
    	}
    	_ = gotoNext == 2685685
    	exp_2684901--
    	if exp_2684901 < flt.bias+1 {
    		gotoNext = 2685836
    		_ = gotoNext == 2685836
    		n_2685840 = flt.bias + 1 - exp_2684901
    		d.Shift(-n_2685840)
    		exp_2684901 += n_2685840
    		gotoNext = 2685894
    	} else {
    		gotoNext = 2685894
    	}
    	_ = gotoNext == 2685894
    	if exp_2684901-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2685930
    		_ = gotoNext == 2685930
    		gotoNext = 2686293
    		gotoNext = 2685986
    	...
    	mant_2684914 = d.RoundedInteger()
    	if mant_2684914 == 2<<flt.mantbits {
    		gotoNext = 2686122
    		_ = gotoNext == 2686122
    		mant_2684914 >>= 1
    		exp_2684901++
    	...
    	_ = gotoNext == 2686229
    	if mant_2684914&(1<<flt.mantbits) == 0 {
    		gotoNext = 2686260
    		_ = gotoNext == 2686260
    		exp_2684901 = flt.bias
    		gotoNext = 2686283
    	...
    	_ = gotoNext == 2686293
    	mant_2684914 = 0
    	exp_2684901 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2686378
    	_ = gotoNext == 2686378
    	bits_2686403 = mant_2684914 & (uint64(1)<<flt.mantbits - 1)
    	bits_2686403 |= uint64((exp_2684901-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2686525
    		_ = gotoNext == 2686525
    		bits_2686403 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2686574
    	} else {
    		gotoNext = 2686574
    	}
    	_ = gotoNext == 2686574
    	return bits_2686403, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
