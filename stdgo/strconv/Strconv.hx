    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2661800
    			_ = gotoNext == 2661800
    			n_2661748 = powtab[d.dp]
    			gotoNext = 2661828
    		}
    		_ = gotoNext == 2661828
    		d.Shift(-n_2661748)
    		exp_2661290 += n_2661748
    		gotoNext = 2661727
    	} else {
    		gotoNext = 2661855
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2661958
    			_ = gotoNext == 2661958
    			n_2661905 = powtab[-d.dp]
    			gotoNext = 2661987
    		}
    		_ = gotoNext == 2661987
    		d.Shift(n_2661905)
    		exp_2661290 -= n_2661905
    		gotoNext = 2661855
    	} else {
    		gotoNext = 2662074
    	}
    	_ = gotoNext == 2662074
    	exp_2661290--
    	if exp_2661290 < flt.bias+1 {
    		gotoNext = 2662225
    		_ = gotoNext == 2662225
    		n_2662229 = flt.bias + 1 - exp_2661290
    		d.Shift(-n_2662229)
    		exp_2661290 += n_2662229
    		gotoNext = 2662283
    	} else {
    		gotoNext = 2662283
    	}
    	_ = gotoNext == 2662283
    	if exp_2661290-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2662319
    		_ = gotoNext == 2662319
    		gotoNext = 2662682
    		gotoNext = 2662375
    	...
    	mant_2661303 = d.RoundedInteger()
    	if mant_2661303 == 2<<flt.mantbits {
    		gotoNext = 2662511
    		_ = gotoNext == 2662511
    		mant_2661303 >>= 1
    		exp_2661290++
    	...
    	_ = gotoNext == 2662618
    	if mant_2661303&(1<<flt.mantbits) == 0 {
    		gotoNext = 2662649
    		_ = gotoNext == 2662649
    		exp_2661290 = flt.bias
    		gotoNext = 2662672
    	...
    	_ = gotoNext == 2662682
    	mant_2661303 = 0
    	exp_2661290 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2662767
    	_ = gotoNext == 2662767
    	bits_2662792 = mant_2661303 & (uint64(1)<<flt.mantbits - 1)
    	bits_2662792 |= uint64((exp_2661290-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2662914
    		_ = gotoNext == 2662914
    		bits_2662792 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2662963
    	} else {
    		gotoNext = 2662963
    	}
    	_ = gotoNext == 2662963
    	return bits_2662792, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
