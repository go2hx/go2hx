    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2603100
    			_ = gotoNext == 2603100
    			n_2603048 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2603128
    		}
    		_ = gotoNext == 2603128
    		d.Shift(-n_2603048)
    		exp_2602590 += n_2603048
    		gotoNext = 2603027
    	} else {
    		gotoNext = 2603155
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2603258
    			_ = gotoNext == 2603258
    			n_2603205 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2603287
    		}
    		_ = gotoNext == 2603287
    		d.Shift(n_2603205)
    		exp_2602590 -= n_2603205
    		gotoNext = 2603155
    	} else {
    		gotoNext = 2603374
    	}
    	_ = gotoNext == 2603374
    	exp_2602590--
    	if exp_2602590 < flt.bias+1 {
    		gotoNext = 2603525
    		_ = gotoNext == 2603525
    		n_2603529 = flt.bias + 1 - exp_2602590
    		d.Shift(-n_2603529)
    		exp_2602590 += n_2603529
    		gotoNext = 2603583
    	} else {
    		gotoNext = 2603583
    	}
    	_ = gotoNext == 2603583
    	if exp_2602590-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2603619
    		_ = gotoNext == 2603619
    		gotoNext = 2603982
    		gotoNext = 2603675
    	...
    	mant_2602603 = d.RoundedInteger()
    	if mant_2602603 == 2<<flt.mantbits {
    		gotoNext = 2603811
    		_ = gotoNext == 2603811
    		mant_2602603 >>= 1
    		exp_2602590++
    	...
    	_ = gotoNext == 2603918
    	if mant_2602603&(1<<flt.mantbits) == 0 {
    		gotoNext = 2603949
    		_ = gotoNext == 2603949
    		exp_2602590 = flt.bias
    		gotoNext = 2603972
    	...
    	_ = gotoNext == 2603982
    	mant_2602603 = 0
    	exp_2602590 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2604067
    	_ = gotoNext == 2604067
    	bits_2604092 = mant_2602603 & (uint64(1)<<flt.mantbits - 1)
    	bits_2604092 |= uint64((exp_2602590-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2604214
    		_ = gotoNext == 2604214
    		bits_2604092 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2604263
    	} else {
    		gotoNext = 2604263
    	}
    	_ = gotoNext == 2604263
    	return bits_2604092, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
