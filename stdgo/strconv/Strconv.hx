    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2641493
    			_ = gotoNext == 2641493
    			n_2641441 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2641521
    		}
    		_ = gotoNext == 2641521
    		d.Shift(-n_2641441)
    		exp_2640983 += n_2641441
    		gotoNext = 2641420
    	} else {
    		gotoNext = 2641548
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2641651
    			_ = gotoNext == 2641651
    			n_2641598 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2641680
    		}
    		_ = gotoNext == 2641680
    		d.Shift(n_2641598)
    		exp_2640983 -= n_2641598
    		gotoNext = 2641548
    	} else {
    		gotoNext = 2641767
    	}
    	_ = gotoNext == 2641767
    	exp_2640983--
    	if exp_2640983 < flt.bias+1 {
    		gotoNext = 2641918
    		_ = gotoNext == 2641918
    		n_2641922 = flt.bias + 1 - exp_2640983
    		d.Shift(-n_2641922)
    		exp_2640983 += n_2641922
    		gotoNext = 2641976
    	} else {
    		gotoNext = 2641976
    	}
    	_ = gotoNext == 2641976
    	if exp_2640983-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2642012
    		_ = gotoNext == 2642012
    		gotoNext = 2642375
    		gotoNext = 2642068
    	...
    	mant_2640996 = d.RoundedInteger()
    	if mant_2640996 == 2<<flt.mantbits {
    		gotoNext = 2642204
    		_ = gotoNext == 2642204
    		mant_2640996 >>= 1
    		exp_2640983++
    	...
    	_ = gotoNext == 2642311
    	if mant_2640996&(1<<flt.mantbits) == 0 {
    		gotoNext = 2642342
    		_ = gotoNext == 2642342
    		exp_2640983 = flt.bias
    		gotoNext = 2642365
    	...
    	_ = gotoNext == 2642375
    	mant_2640996 = 0
    	exp_2640983 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2642460
    	_ = gotoNext == 2642460
    	bits_2642485 = mant_2640996 & (uint64(1)<<flt.mantbits - 1)
    	bits_2642485 |= uint64((exp_2640983-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2642607
    		_ = gotoNext == 2642607
    		bits_2642485 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2642656
    	} else {
    		gotoNext = 2642656
    	}
    	_ = gotoNext == 2642656
    	return bits_2642485, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
