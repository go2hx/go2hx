    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2692727
    			_ = gotoNext == 2692727
    			n_2692675 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2692755
    		}
    		_ = gotoNext == 2692755
    		d.Shift(-n_2692675)
    		exp_2692217 += n_2692675
    		gotoNext = 2692654
    	} else {
    		gotoNext = 2692782
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2692885
    			_ = gotoNext == 2692885
    			n_2692832 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2692914
    		}
    		_ = gotoNext == 2692914
    		d.Shift(n_2692832)
    		exp_2692217 -= n_2692832
    		gotoNext = 2692782
    	} else {
    		gotoNext = 2693001
    	}
    	_ = gotoNext == 2693001
    	exp_2692217--
    	if exp_2692217 < flt.bias+1 {
    		gotoNext = 2693152
    		_ = gotoNext == 2693152
    		n_2693156 = flt.bias + 1 - exp_2692217
    		d.Shift(-n_2693156)
    		exp_2692217 += n_2693156
    		gotoNext = 2693210
    	} else {
    		gotoNext = 2693210
    	}
    	_ = gotoNext == 2693210
    	if exp_2692217-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2693246
    		_ = gotoNext == 2693246
    		gotoNext = 2693609
    		gotoNext = 2693302
    	...
    	mant_2692230 = d.RoundedInteger()
    	if mant_2692230 == 2<<flt.mantbits {
    		gotoNext = 2693438
    		_ = gotoNext == 2693438
    		mant_2692230 >>= 1
    		exp_2692217++
    	...
    	_ = gotoNext == 2693545
    	if mant_2692230&(1<<flt.mantbits) == 0 {
    		gotoNext = 2693576
    		_ = gotoNext == 2693576
    		exp_2692217 = flt.bias
    		gotoNext = 2693599
    	...
    	_ = gotoNext == 2693609
    	mant_2692230 = 0
    	exp_2692217 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2693694
    	_ = gotoNext == 2693694
    	bits_2693719 = mant_2692230 & (uint64(1)<<flt.mantbits - 1)
    	bits_2693719 |= uint64((exp_2692217-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2693841
    		_ = gotoNext == 2693841
    		bits_2693719 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2693890
    	} else {
    		gotoNext = 2693890
    	}
    	_ = gotoNext == 2693890
    	return bits_2693719, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
