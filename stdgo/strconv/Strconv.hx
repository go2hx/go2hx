    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2739302
    			_ = gotoNext == 2739302
    			n_2739250 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2739330
    		}
    		_ = gotoNext == 2739330
    		d.Shift(-n_2739250)
    		exp_2738792 += n_2739250
    		gotoNext = 2739229
    	} else {
    		gotoNext = 2739357
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2739460
    			_ = gotoNext == 2739460
    			n_2739407 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2739489
    		}
    		_ = gotoNext == 2739489
    		d.Shift(n_2739407)
    		exp_2738792 -= n_2739407
    		gotoNext = 2739357
    	} else {
    		gotoNext = 2739576
    	}
    	_ = gotoNext == 2739576
    	exp_2738792--
    	if exp_2738792 < flt.bias+1 {
    		gotoNext = 2739727
    		_ = gotoNext == 2739727
    		n_2739731 = flt.bias + 1 - exp_2738792
    		d.Shift(-n_2739731)
    		exp_2738792 += n_2739731
    		gotoNext = 2739785
    	} else {
    		gotoNext = 2739785
    	}
    	_ = gotoNext == 2739785
    	if exp_2738792-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2739821
    		_ = gotoNext == 2739821
    		gotoNext = 2740184
    		gotoNext = 2739877
    	...
    	mant_2738805 = d.RoundedInteger()
    	if mant_2738805 == 2<<flt.mantbits {
    		gotoNext = 2740013
    		_ = gotoNext == 2740013
    		mant_2738805 >>= 1
    		exp_2738792++
    	...
    	_ = gotoNext == 2740120
    	if mant_2738805&(1<<flt.mantbits) == 0 {
    		gotoNext = 2740151
    		_ = gotoNext == 2740151
    		exp_2738792 = flt.bias
    		gotoNext = 2740174
    	...
    	_ = gotoNext == 2740184
    	mant_2738805 = 0
    	exp_2738792 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2740269
    	_ = gotoNext == 2740269
    	bits_2740294 = mant_2738805 & (uint64(1)<<flt.mantbits - 1)
    	bits_2740294 |= uint64((exp_2738792-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2740416
    		_ = gotoNext == 2740416
    		bits_2740294 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2740465
    	} else {
    		gotoNext = 2740465
    	}
    	_ = gotoNext == 2740465
    	return bits_2740294, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
