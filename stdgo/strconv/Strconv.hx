    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2678508
    			_ = gotoNext == 2678508
    			n_2678456 = powtab[d.dp]
    			gotoNext = 2678536
    		}
    		_ = gotoNext == 2678536
    		d.Shift(-n_2678456)
    		exp_2677998 += n_2678456
    		gotoNext = 2678435
    	} else {
    		gotoNext = 2678563
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2678666
    			_ = gotoNext == 2678666
    			n_2678613 = powtab[-d.dp]
    			gotoNext = 2678695
    		}
    		_ = gotoNext == 2678695
    		d.Shift(n_2678613)
    		exp_2677998 -= n_2678613
    		gotoNext = 2678563
    	} else {
    		gotoNext = 2678782
    	}
    	_ = gotoNext == 2678782
    	exp_2677998--
    	if exp_2677998 < flt.bias+1 {
    		gotoNext = 2678933
    		_ = gotoNext == 2678933
    		n_2678937 = flt.bias + 1 - exp_2677998
    		d.Shift(-n_2678937)
    		exp_2677998 += n_2678937
    		gotoNext = 2678991
    	} else {
    		gotoNext = 2678991
    	}
    	_ = gotoNext == 2678991
    	if exp_2677998-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2679027
    		_ = gotoNext == 2679027
    		gotoNext = 2679390
    		gotoNext = 2679083
    	...
    	mant_2678011 = d.RoundedInteger()
    	if mant_2678011 == 2<<flt.mantbits {
    		gotoNext = 2679219
    		_ = gotoNext == 2679219
    		mant_2678011 >>= 1
    		exp_2677998++
    	...
    	_ = gotoNext == 2679326
    	if mant_2678011&(1<<flt.mantbits) == 0 {
    		gotoNext = 2679357
    		_ = gotoNext == 2679357
    		exp_2677998 = flt.bias
    		gotoNext = 2679380
    	...
    	_ = gotoNext == 2679390
    	mant_2678011 = 0
    	exp_2677998 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2679475
    	_ = gotoNext == 2679475
    	bits_2679500 = mant_2678011 & (uint64(1)<<flt.mantbits - 1)
    	bits_2679500 |= uint64((exp_2677998-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2679622
    		_ = gotoNext == 2679622
    		bits_2679500 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2679671
    	} else {
    		gotoNext = 2679671
    	}
    	_ = gotoNext == 2679671
    	return bits_2679500, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
