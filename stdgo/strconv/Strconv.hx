    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2634521
    			_ = gotoNext == 2634521
    			n_2634469 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2634549
    		}
    		_ = gotoNext == 2634549
    		d.Shift(-n_2634469)
    		exp_2634011 += n_2634469
    		gotoNext = 2634448
    	} else {
    		gotoNext = 2634576
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2634679
    			_ = gotoNext == 2634679
    			n_2634626 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2634708
    		}
    		_ = gotoNext == 2634708
    		d.Shift(n_2634626)
    		exp_2634011 -= n_2634626
    		gotoNext = 2634576
    	} else {
    		gotoNext = 2634795
    	}
    	_ = gotoNext == 2634795
    	exp_2634011--
    	if exp_2634011 < flt.bias+1 {
    		gotoNext = 2634946
    		_ = gotoNext == 2634946
    		n_2634950 = flt.bias + 1 - exp_2634011
    		d.Shift(-n_2634950)
    		exp_2634011 += n_2634950
    		gotoNext = 2635004
    	} else {
    		gotoNext = 2635004
    	}
    	_ = gotoNext == 2635004
    	if exp_2634011-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2635040
    		_ = gotoNext == 2635040
    		gotoNext = 2635403
    		gotoNext = 2635096
    	...
    	mant_2634024 = d.RoundedInteger()
    	if mant_2634024 == 2<<flt.mantbits {
    		gotoNext = 2635232
    		_ = gotoNext == 2635232
    		mant_2634024 >>= 1
    		exp_2634011++
    	...
    	_ = gotoNext == 2635339
    	if mant_2634024&(1<<flt.mantbits) == 0 {
    		gotoNext = 2635370
    		_ = gotoNext == 2635370
    		exp_2634011 = flt.bias
    		gotoNext = 2635393
    	...
    	_ = gotoNext == 2635403
    	mant_2634024 = 0
    	exp_2634011 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2635488
    	_ = gotoNext == 2635488
    	bits_2635513 = mant_2634024 & (uint64(1)<<flt.mantbits - 1)
    	bits_2635513 |= uint64((exp_2634011-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2635635
    		_ = gotoNext == 2635635
    		bits_2635513 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2635684
    	} else {
    		gotoNext = 2635684
    	}
    	_ = gotoNext == 2635684
    	return bits_2635513, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
