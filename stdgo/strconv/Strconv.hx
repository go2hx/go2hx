    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2687634
    			_ = gotoNext == 2687634
    			n_2687582 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2687662
    		}
    		_ = gotoNext == 2687662
    		d.Shift(-n_2687582)
    		exp_2687124 += n_2687582
    		gotoNext = 2687561
    	} else {
    		gotoNext = 2687689
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2687792
    			_ = gotoNext == 2687792
    			n_2687739 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2687821
    		}
    		_ = gotoNext == 2687821
    		d.Shift(n_2687739)
    		exp_2687124 -= n_2687739
    		gotoNext = 2687689
    	} else {
    		gotoNext = 2687908
    	}
    	_ = gotoNext == 2687908
    	exp_2687124--
    	if exp_2687124 < flt.bias+1 {
    		gotoNext = 2688059
    		_ = gotoNext == 2688059
    		n_2688063 = flt.bias + 1 - exp_2687124
    		d.Shift(-n_2688063)
    		exp_2687124 += n_2688063
    		gotoNext = 2688117
    	} else {
    		gotoNext = 2688117
    	}
    	_ = gotoNext == 2688117
    	if exp_2687124-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2688153
    		_ = gotoNext == 2688153
    		gotoNext = 2688516
    		gotoNext = 2688209
    	...
    	mant_2687137 = d.RoundedInteger()
    	if mant_2687137 == 2<<flt.mantbits {
    		gotoNext = 2688345
    		_ = gotoNext == 2688345
    		mant_2687137 >>= 1
    		exp_2687124++
    	...
    	_ = gotoNext == 2688452
    	if mant_2687137&(1<<flt.mantbits) == 0 {
    		gotoNext = 2688483
    		_ = gotoNext == 2688483
    		exp_2687124 = flt.bias
    		gotoNext = 2688506
    	...
    	_ = gotoNext == 2688516
    	mant_2687137 = 0
    	exp_2687124 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2688601
    	_ = gotoNext == 2688601
    	bits_2688626 = mant_2687137 & (uint64(1)<<flt.mantbits - 1)
    	bits_2688626 |= uint64((exp_2687124-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2688748
    		_ = gotoNext == 2688748
    		bits_2688626 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2688797
    	} else {
    		gotoNext = 2688797
    	}
    	_ = gotoNext == 2688797
    	return bits_2688626, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
