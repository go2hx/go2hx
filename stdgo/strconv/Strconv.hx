    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2678749
    			_ = gotoNext == 2678749
    			n_2678697 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2678777
    		}
    		_ = gotoNext == 2678777
    		d.Shift(-n_2678697)
    		exp_2678239 += n_2678697
    		gotoNext = 2678676
    	} else {
    		gotoNext = 2678804
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2678907
    			_ = gotoNext == 2678907
    			n_2678854 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2678936
    		}
    		_ = gotoNext == 2678936
    		d.Shift(n_2678854)
    		exp_2678239 -= n_2678854
    		gotoNext = 2678804
    	} else {
    		gotoNext = 2679023
    	}
    	_ = gotoNext == 2679023
    	exp_2678239--
    	if exp_2678239 < flt.bias+1 {
    		gotoNext = 2679174
    		_ = gotoNext == 2679174
    		n_2679178 = flt.bias + 1 - exp_2678239
    		d.Shift(-n_2679178)
    		exp_2678239 += n_2679178
    		gotoNext = 2679232
    	} else {
    		gotoNext = 2679232
    	}
    	_ = gotoNext == 2679232
    	if exp_2678239-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2679268
    		_ = gotoNext == 2679268
    		gotoNext = 2679631
    		gotoNext = 2679324
    	...
    	mant_2678252 = d.RoundedInteger()
    	if mant_2678252 == 2<<flt.mantbits {
    		gotoNext = 2679460
    		_ = gotoNext == 2679460
    		mant_2678252 >>= 1
    		exp_2678239++
    	...
    	_ = gotoNext == 2679567
    	if mant_2678252&(1<<flt.mantbits) == 0 {
    		gotoNext = 2679598
    		_ = gotoNext == 2679598
    		exp_2678239 = flt.bias
    		gotoNext = 2679621
    	...
    	_ = gotoNext == 2679631
    	mant_2678252 = 0
    	exp_2678239 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2679716
    	_ = gotoNext == 2679716
    	bits_2679741 = mant_2678252 & (uint64(1)<<flt.mantbits - 1)
    	bits_2679741 |= uint64((exp_2678239-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2679863
    		_ = gotoNext == 2679863
    		bits_2679741 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2679912
    	} else {
    		gotoNext = 2679912
    	}
    	_ = gotoNext == 2679912
    	return bits_2679741, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
