    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2659287
    			_ = gotoNext == 2659287
    			n_2659235 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2659315
    		}
    		_ = gotoNext == 2659315
    		d.Shift(-n_2659235)
    		exp_2658777 += n_2659235
    		gotoNext = 2659214
    	} else {
    		gotoNext = 2659342
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2659445
    			_ = gotoNext == 2659445
    			n_2659392 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2659474
    		}
    		_ = gotoNext == 2659474
    		d.Shift(n_2659392)
    		exp_2658777 -= n_2659392
    		gotoNext = 2659342
    	} else {
    		gotoNext = 2659561
    	}
    	_ = gotoNext == 2659561
    	exp_2658777--
    	if exp_2658777 < flt.bias+1 {
    		gotoNext = 2659712
    		_ = gotoNext == 2659712
    		n_2659716 = flt.bias + 1 - exp_2658777
    		d.Shift(-n_2659716)
    		exp_2658777 += n_2659716
    		gotoNext = 2659770
    	} else {
    		gotoNext = 2659770
    	}
    	_ = gotoNext == 2659770
    	if exp_2658777-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2659806
    		_ = gotoNext == 2659806
    		gotoNext = 2660169
    		gotoNext = 2659862
    	...
    	mant_2658790 = d.RoundedInteger()
    	if mant_2658790 == 2<<flt.mantbits {
    		gotoNext = 2659998
    		_ = gotoNext == 2659998
    		mant_2658790 >>= 1
    		exp_2658777++
    	...
    	_ = gotoNext == 2660105
    	if mant_2658790&(1<<flt.mantbits) == 0 {
    		gotoNext = 2660136
    		_ = gotoNext == 2660136
    		exp_2658777 = flt.bias
    		gotoNext = 2660159
    	...
    	_ = gotoNext == 2660169
    	mant_2658790 = 0
    	exp_2658777 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2660254
    	_ = gotoNext == 2660254
    	bits_2660279 = mant_2658790 & (uint64(1)<<flt.mantbits - 1)
    	bits_2660279 |= uint64((exp_2658777-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2660401
    		_ = gotoNext == 2660401
    		bits_2660279 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2660450
    	} else {
    		gotoNext = 2660450
    	}
    	_ = gotoNext == 2660450
    	return bits_2660279, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
