    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2698670
    			_ = gotoNext == 2698670
    			n_2698618 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2698698
    		}
    		_ = gotoNext == 2698698
    		d.Shift(-n_2698618)
    		exp_2698160 += n_2698618
    		gotoNext = 2698597
    	} else {
    		gotoNext = 2698725
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2698828
    			_ = gotoNext == 2698828
    			n_2698775 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2698857
    		}
    		_ = gotoNext == 2698857
    		d.Shift(n_2698775)
    		exp_2698160 -= n_2698775
    		gotoNext = 2698725
    	} else {
    		gotoNext = 2698944
    	}
    	_ = gotoNext == 2698944
    	exp_2698160--
    	if exp_2698160 < flt.bias+1 {
    		gotoNext = 2699095
    		_ = gotoNext == 2699095
    		n_2699099 = flt.bias + 1 - exp_2698160
    		d.Shift(-n_2699099)
    		exp_2698160 += n_2699099
    		gotoNext = 2699153
    	} else {
    		gotoNext = 2699153
    	}
    	_ = gotoNext == 2699153
    	if exp_2698160-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2699189
    		_ = gotoNext == 2699189
    		gotoNext = 2699552
    		gotoNext = 2699245
    	...
    	mant_2698173 = d.RoundedInteger()
    	if mant_2698173 == 2<<flt.mantbits {
    		gotoNext = 2699381
    		_ = gotoNext == 2699381
    		mant_2698173 >>= 1
    		exp_2698160++
    	...
    	_ = gotoNext == 2699488
    	if mant_2698173&(1<<flt.mantbits) == 0 {
    		gotoNext = 2699519
    		_ = gotoNext == 2699519
    		exp_2698160 = flt.bias
    		gotoNext = 2699542
    	...
    	_ = gotoNext == 2699552
    	mant_2698173 = 0
    	exp_2698160 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2699637
    	_ = gotoNext == 2699637
    	bits_2699662 = mant_2698173 & (uint64(1)<<flt.mantbits - 1)
    	bits_2699662 |= uint64((exp_2698160-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2699784
    		_ = gotoNext == 2699784
    		bits_2699662 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2699833
    	} else {
    		gotoNext = 2699833
    	}
    	_ = gotoNext == 2699833
    	return bits_2699662, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
