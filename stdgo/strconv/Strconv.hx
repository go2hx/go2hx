    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2666886
    			_ = gotoNext == 2666886
    			n_2666834 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2666914
    		}
    		_ = gotoNext == 2666914
    		d.Shift(-n_2666834)
    		exp_2666376 += n_2666834
    		gotoNext = 2666813
    	} else {
    		gotoNext = 2666941
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2667044
    			_ = gotoNext == 2667044
    			n_2666991 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2667073
    		}
    		_ = gotoNext == 2667073
    		d.Shift(n_2666991)
    		exp_2666376 -= n_2666991
    		gotoNext = 2666941
    	} else {
    		gotoNext = 2667160
    	}
    	_ = gotoNext == 2667160
    	exp_2666376--
    	if exp_2666376 < flt.bias+1 {
    		gotoNext = 2667311
    		_ = gotoNext == 2667311
    		n_2667315 = flt.bias + 1 - exp_2666376
    		d.Shift(-n_2667315)
    		exp_2666376 += n_2667315
    		gotoNext = 2667369
    	} else {
    		gotoNext = 2667369
    	}
    	_ = gotoNext == 2667369
    	if exp_2666376-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2667405
    		_ = gotoNext == 2667405
    		gotoNext = 2667768
    		gotoNext = 2667461
    	...
    	mant_2666389 = d.RoundedInteger()
    	if mant_2666389 == 2<<flt.mantbits {
    		gotoNext = 2667597
    		_ = gotoNext == 2667597
    		mant_2666389 >>= 1
    		exp_2666376++
    	...
    	_ = gotoNext == 2667704
    	if mant_2666389&(1<<flt.mantbits) == 0 {
    		gotoNext = 2667735
    		_ = gotoNext == 2667735
    		exp_2666376 = flt.bias
    		gotoNext = 2667758
    	...
    	_ = gotoNext == 2667768
    	mant_2666389 = 0
    	exp_2666376 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2667853
    	_ = gotoNext == 2667853
    	bits_2667878 = mant_2666389 & (uint64(1)<<flt.mantbits - 1)
    	bits_2667878 |= uint64((exp_2666376-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2668000
    		_ = gotoNext == 2668000
    		bits_2667878 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2668049
    	} else {
    		gotoNext = 2668049
    	}
    	_ = gotoNext == 2668049
    	return bits_2667878, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
