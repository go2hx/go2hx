    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2615297
    			_ = gotoNext == 2615297
    			n_2615245 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2615325
    		}
    		_ = gotoNext == 2615325
    		d.Shift(-n_2615245)
    		exp_2614787 += n_2615245
    		gotoNext = 2615224
    	} else {
    		gotoNext = 2615352
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2615455
    			_ = gotoNext == 2615455
    			n_2615402 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2615484
    		}
    		_ = gotoNext == 2615484
    		d.Shift(n_2615402)
    		exp_2614787 -= n_2615402
    		gotoNext = 2615352
    	} else {
    		gotoNext = 2615571
    	}
    	_ = gotoNext == 2615571
    	exp_2614787--
    	if exp_2614787 < flt.bias+1 {
    		gotoNext = 2615722
    		_ = gotoNext == 2615722
    		n_2615726 = flt.bias + 1 - exp_2614787
    		d.Shift(-n_2615726)
    		exp_2614787 += n_2615726
    		gotoNext = 2615780
    	} else {
    		gotoNext = 2615780
    	}
    	_ = gotoNext == 2615780
    	if exp_2614787-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2615816
    		_ = gotoNext == 2615816
    		gotoNext = 2616179
    		gotoNext = 2615872
    	...
    	mant_2614800 = d.RoundedInteger()
    	if mant_2614800 == 2<<flt.mantbits {
    		gotoNext = 2616008
    		_ = gotoNext == 2616008
    		mant_2614800 >>= 1
    		exp_2614787++
    	...
    	_ = gotoNext == 2616115
    	if mant_2614800&(1<<flt.mantbits) == 0 {
    		gotoNext = 2616146
    		_ = gotoNext == 2616146
    		exp_2614787 = flt.bias
    		gotoNext = 2616169
    	...
    	_ = gotoNext == 2616179
    	mant_2614800 = 0
    	exp_2614787 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2616264
    	_ = gotoNext == 2616264
    	bits_2616289 = mant_2614800 & (uint64(1)<<flt.mantbits - 1)
    	bits_2616289 |= uint64((exp_2614787-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2616411
    		_ = gotoNext == 2616411
    		bits_2616289 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2616460
    	} else {
    		gotoNext = 2616460
    	}
    	_ = gotoNext == 2616460
    	return bits_2616289, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
