    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2697386
    			_ = gotoNext == 2697386
    			n_2697334 = powtab[d.dp]
    			gotoNext = 2697414
    		}
    		_ = gotoNext == 2697414
    		d.Shift(-n_2697334)
    		exp_2696876 += n_2697334
    		gotoNext = 2697313
    	} else {
    		gotoNext = 2697441
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2697544
    			_ = gotoNext == 2697544
    			n_2697491 = powtab[-d.dp]
    			gotoNext = 2697573
    		}
    		_ = gotoNext == 2697573
    		d.Shift(n_2697491)
    		exp_2696876 -= n_2697491
    		gotoNext = 2697441
    	} else {
    		gotoNext = 2697660
    	}
    	_ = gotoNext == 2697660
    	exp_2696876--
    	if exp_2696876 < flt.bias+1 {
    		gotoNext = 2697811
    		_ = gotoNext == 2697811
    		n_2697815 = flt.bias + 1 - exp_2696876
    		d.Shift(-n_2697815)
    		exp_2696876 += n_2697815
    		gotoNext = 2697869
    	} else {
    		gotoNext = 2697869
    	}
    	_ = gotoNext == 2697869
    	if exp_2696876-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2697905
    		_ = gotoNext == 2697905
    		gotoNext = 2698268
    		gotoNext = 2697961
    	...
    	mant_2696889 = d.RoundedInteger()
    	if mant_2696889 == 2<<flt.mantbits {
    		gotoNext = 2698097
    		_ = gotoNext == 2698097
    		mant_2696889 >>= 1
    		exp_2696876++
    	...
    	_ = gotoNext == 2698204
    	if mant_2696889&(1<<flt.mantbits) == 0 {
    		gotoNext = 2698235
    		_ = gotoNext == 2698235
    		exp_2696876 = flt.bias
    		gotoNext = 2698258
    	...
    	_ = gotoNext == 2698268
    	mant_2696889 = 0
    	exp_2696876 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2698353
    	_ = gotoNext == 2698353
    	bits_2698378 = mant_2696889 & (uint64(1)<<flt.mantbits - 1)
    	bits_2698378 |= uint64((exp_2696876-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2698500
    		_ = gotoNext == 2698500
    		bits_2698378 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2698549
    	} else {
    		gotoNext = 2698549
    	}
    	_ = gotoNext == 2698549
    	return bits_2698378, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
