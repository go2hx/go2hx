    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2805046
    			_ = gotoNext == 2805046
    			n_2804994 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2805074
    		}
    		_ = gotoNext == 2805074
    		d.Shift(-n_2804994)
    		exp_2804536 += n_2804994
    		gotoNext = 2804973
    	} else {
    		gotoNext = 2805101
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2805204
    			_ = gotoNext == 2805204
    			n_2805151 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2805233
    		}
    		_ = gotoNext == 2805233
    		d.Shift(n_2805151)
    		exp_2804536 -= n_2805151
    		gotoNext = 2805101
    	} else {
    		gotoNext = 2805320
    	}
    	_ = gotoNext == 2805320
    	exp_2804536--
    	if exp_2804536 < flt.bias+1 {
    		gotoNext = 2805471
    		_ = gotoNext == 2805471
    		n_2805475 = flt.bias + 1 - exp_2804536
    		d.Shift(-n_2805475)
    		exp_2804536 += n_2805475
    		gotoNext = 2805529
    	} else {
    		gotoNext = 2805529
    	}
    	_ = gotoNext == 2805529
    	if exp_2804536-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2805565
    		_ = gotoNext == 2805565
    		gotoNext = 2805928
    		gotoNext = 2805621
    	...
    	mant_2804549 = d.RoundedInteger()
    	if mant_2804549 == 2<<flt.mantbits {
    		gotoNext = 2805757
    		_ = gotoNext == 2805757
    		mant_2804549 >>= 1
    		exp_2804536++
    	...
    	_ = gotoNext == 2805864
    	if mant_2804549&(1<<flt.mantbits) == 0 {
    		gotoNext = 2805895
    		_ = gotoNext == 2805895
    		exp_2804536 = flt.bias
    		gotoNext = 2805918
    	...
    	_ = gotoNext == 2805928
    	mant_2804549 = 0
    	exp_2804536 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2806013
    	_ = gotoNext == 2806013
    	bits_2806038 = mant_2804549 & (uint64(1)<<flt.mantbits - 1)
    	bits_2806038 |= uint64((exp_2804536-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2806160
    		_ = gotoNext == 2806160
    		bits_2806038 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2806209
    	} else {
    		gotoNext = 2806209
    	}
    	_ = gotoNext == 2806209
    	return bits_2806038, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
