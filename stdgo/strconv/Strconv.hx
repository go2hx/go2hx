    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2738871
    			_ = gotoNext == 2738871
    			n_2738819 = powtab[d.dp]
    			gotoNext = 2738899
    		}
    		_ = gotoNext == 2738899
    		d.Shift(-n_2738819)
    		exp_2738361 += n_2738819
    		gotoNext = 2738798
    	} else {
    		gotoNext = 2738926
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2739029
    			_ = gotoNext == 2739029
    			n_2738976 = powtab[-d.dp]
    			gotoNext = 2739058
    		}
    		_ = gotoNext == 2739058
    		d.Shift(n_2738976)
    		exp_2738361 -= n_2738976
    		gotoNext = 2738926
    	} else {
    		gotoNext = 2739145
    	}
    	_ = gotoNext == 2739145
    	exp_2738361--
    	if exp_2738361 < flt.bias+1 {
    		gotoNext = 2739296
    		_ = gotoNext == 2739296
    		n_2739300 = flt.bias + 1 - exp_2738361
    		d.Shift(-n_2739300)
    		exp_2738361 += n_2739300
    		gotoNext = 2739354
    	} else {
    		gotoNext = 2739354
    	}
    	_ = gotoNext == 2739354
    	if exp_2738361-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2739390
    		_ = gotoNext == 2739390
    		gotoNext = 2739753
    		gotoNext = 2739446
    	...
    	mant_2738374 = d.RoundedInteger()
    	if mant_2738374 == 2<<flt.mantbits {
    		gotoNext = 2739582
    		_ = gotoNext == 2739582
    		mant_2738374 >>= 1
    		exp_2738361++
    	...
    	_ = gotoNext == 2739689
    	if mant_2738374&(1<<flt.mantbits) == 0 {
    		gotoNext = 2739720
    		_ = gotoNext == 2739720
    		exp_2738361 = flt.bias
    		gotoNext = 2739743
    	...
    	_ = gotoNext == 2739753
    	mant_2738374 = 0
    	exp_2738361 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2739838
    	_ = gotoNext == 2739838
    	bits_2739863 = mant_2738374 & (uint64(1)<<flt.mantbits - 1)
    	bits_2739863 |= uint64((exp_2738361-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2739985
    		_ = gotoNext == 2739985
    		bits_2739863 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2740034
    	} else {
    		gotoNext = 2740034
    	}
    	_ = gotoNext == 2740034
    	return bits_2739863, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
