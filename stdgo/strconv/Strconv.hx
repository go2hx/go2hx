    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2614736
    			_ = gotoNext == 2614736
    			n_2614684 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2614764
    		}
    		_ = gotoNext == 2614764
    		d.Shift(-n_2614684)
    		exp_2614226 += n_2614684
    		gotoNext = 2614663
    	} else {
    		gotoNext = 2614791
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2614894
    			_ = gotoNext == 2614894
    			n_2614841 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2614923
    		}
    		_ = gotoNext == 2614923
    		d.Shift(n_2614841)
    		exp_2614226 -= n_2614841
    		gotoNext = 2614791
    	} else {
    		gotoNext = 2615010
    	}
    	_ = gotoNext == 2615010
    	exp_2614226--
    	if exp_2614226 < flt.bias+1 {
    		gotoNext = 2615161
    		_ = gotoNext == 2615161
    		n_2615165 = flt.bias + 1 - exp_2614226
    		d.Shift(-n_2615165)
    		exp_2614226 += n_2615165
    		gotoNext = 2615219
    	} else {
    		gotoNext = 2615219
    	}
    	_ = gotoNext == 2615219
    	if exp_2614226-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2615255
    		_ = gotoNext == 2615255
    		gotoNext = 2615618
    		gotoNext = 2615311
    	...
    	mant_2614239 = d.RoundedInteger()
    	if mant_2614239 == 2<<flt.mantbits {
    		gotoNext = 2615447
    		_ = gotoNext == 2615447
    		mant_2614239 >>= 1
    		exp_2614226++
    	...
    	_ = gotoNext == 2615554
    	if mant_2614239&(1<<flt.mantbits) == 0 {
    		gotoNext = 2615585
    		_ = gotoNext == 2615585
    		exp_2614226 = flt.bias
    		gotoNext = 2615608
    	...
    	_ = gotoNext == 2615618
    	mant_2614239 = 0
    	exp_2614226 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2615703
    	_ = gotoNext == 2615703
    	bits_2615728 = mant_2614239 & (uint64(1)<<flt.mantbits - 1)
    	bits_2615728 |= uint64((exp_2614226-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2615850
    		_ = gotoNext == 2615850
    		bits_2615728 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2615899
    	} else {
    		gotoNext = 2615899
    	}
    	_ = gotoNext == 2615899
    	return bits_2615728, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
