    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2742724
    			_ = gotoNext == 2742724
    			n_2742672 = powtab[d.dp]
    			gotoNext = 2742752
    		}
    		_ = gotoNext == 2742752
    		d.Shift(-n_2742672)
    		exp_2742214 += n_2742672
    		gotoNext = 2742651
    	} else {
    		gotoNext = 2742779
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2742882
    			_ = gotoNext == 2742882
    			n_2742829 = powtab[-d.dp]
    			gotoNext = 2742911
    		}
    		_ = gotoNext == 2742911
    		d.Shift(n_2742829)
    		exp_2742214 -= n_2742829
    		gotoNext = 2742779
    	} else {
    		gotoNext = 2742998
    	}
    	_ = gotoNext == 2742998
    	exp_2742214--
    	if exp_2742214 < flt.bias+1 {
    		gotoNext = 2743149
    		_ = gotoNext == 2743149
    		n_2743153 = flt.bias + 1 - exp_2742214
    		d.Shift(-n_2743153)
    		exp_2742214 += n_2743153
    		gotoNext = 2743207
    	} else {
    		gotoNext = 2743207
    	}
    	_ = gotoNext == 2743207
    	if exp_2742214-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2743243
    		_ = gotoNext == 2743243
    		gotoNext = 2743606
    		gotoNext = 2743299
    	...
    	mant_2742227 = d.RoundedInteger()
    	if mant_2742227 == 2<<flt.mantbits {
    		gotoNext = 2743435
    		_ = gotoNext == 2743435
    		mant_2742227 >>= 1
    		exp_2742214++
    	...
    	_ = gotoNext == 2743542
    	if mant_2742227&(1<<flt.mantbits) == 0 {
    		gotoNext = 2743573
    		_ = gotoNext == 2743573
    		exp_2742214 = flt.bias
    		gotoNext = 2743596
    	...
    	_ = gotoNext == 2743606
    	mant_2742227 = 0
    	exp_2742214 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2743691
    	_ = gotoNext == 2743691
    	bits_2743716 = mant_2742227 & (uint64(1)<<flt.mantbits - 1)
    	bits_2743716 |= uint64((exp_2742214-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2743838
    		_ = gotoNext == 2743838
    		bits_2743716 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2743887
    	} else {
    		gotoNext = 2743887
    	}
    	_ = gotoNext == 2743887
    	return bits_2743716, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
