    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2645041
    			_ = gotoNext == 2645041
    			n_2644989 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2645069
    		}
    		_ = gotoNext == 2645069
    		d.Shift(-n_2644989)
    		exp_2644531 += n_2644989
    		gotoNext = 2644968
    	} else {
    		gotoNext = 2645096
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2645199
    			_ = gotoNext == 2645199
    			n_2645146 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2645228
    		}
    		_ = gotoNext == 2645228
    		d.Shift(n_2645146)
    		exp_2644531 -= n_2645146
    		gotoNext = 2645096
    	} else {
    		gotoNext = 2645315
    	}
    	_ = gotoNext == 2645315
    	exp_2644531--
    	if exp_2644531 < flt.bias+1 {
    		gotoNext = 2645466
    		_ = gotoNext == 2645466
    		n_2645470 = flt.bias + 1 - exp_2644531
    		d.Shift(-n_2645470)
    		exp_2644531 += n_2645470
    		gotoNext = 2645524
    	} else {
    		gotoNext = 2645524
    	}
    	_ = gotoNext == 2645524
    	if exp_2644531-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2645560
    		_ = gotoNext == 2645560
    		gotoNext = 2645923
    		gotoNext = 2645616
    	...
    	mant_2644544 = d.RoundedInteger()
    	if mant_2644544 == 2<<flt.mantbits {
    		gotoNext = 2645752
    		_ = gotoNext == 2645752
    		mant_2644544 >>= 1
    		exp_2644531++
    	...
    	_ = gotoNext == 2645859
    	if mant_2644544&(1<<flt.mantbits) == 0 {
    		gotoNext = 2645890
    		_ = gotoNext == 2645890
    		exp_2644531 = flt.bias
    		gotoNext = 2645913
    	...
    	_ = gotoNext == 2645923
    	mant_2644544 = 0
    	exp_2644531 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2646008
    	_ = gotoNext == 2646008
    	bits_2646033 = mant_2644544 & (uint64(1)<<flt.mantbits - 1)
    	bits_2646033 |= uint64((exp_2644531-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2646155
    		_ = gotoNext == 2646155
    		bits_2646033 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2646204
    	} else {
    		gotoNext = 2646204
    	}
    	_ = gotoNext == 2646204
    	return bits_2646033, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
