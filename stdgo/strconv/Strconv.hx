    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2683876
    			_ = gotoNext == 2683876
    			n_2683824 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2683904
    		}
    		_ = gotoNext == 2683904
    		d.Shift(-n_2683824)
    		exp_2683366 += n_2683824
    		gotoNext = 2683803
    	} else {
    		gotoNext = 2683931
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2684034
    			_ = gotoNext == 2684034
    			n_2683981 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2684063
    		}
    		_ = gotoNext == 2684063
    		d.Shift(n_2683981)
    		exp_2683366 -= n_2683981
    		gotoNext = 2683931
    	} else {
    		gotoNext = 2684150
    	}
    	_ = gotoNext == 2684150
    	exp_2683366--
    	if exp_2683366 < flt.bias+1 {
    		gotoNext = 2684301
    		_ = gotoNext == 2684301
    		n_2684305 = flt.bias + 1 - exp_2683366
    		d.Shift(-n_2684305)
    		exp_2683366 += n_2684305
    		gotoNext = 2684359
    	} else {
    		gotoNext = 2684359
    	}
    	_ = gotoNext == 2684359
    	if exp_2683366-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2684395
    		_ = gotoNext == 2684395
    		gotoNext = 2684758
    		gotoNext = 2684451
    	...
    	mant_2683379 = d.RoundedInteger()
    	if mant_2683379 == 2<<flt.mantbits {
    		gotoNext = 2684587
    		_ = gotoNext == 2684587
    		mant_2683379 >>= 1
    		exp_2683366++
    	...
    	_ = gotoNext == 2684694
    	if mant_2683379&(1<<flt.mantbits) == 0 {
    		gotoNext = 2684725
    		_ = gotoNext == 2684725
    		exp_2683366 = flt.bias
    		gotoNext = 2684748
    	...
    	_ = gotoNext == 2684758
    	mant_2683379 = 0
    	exp_2683366 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2684843
    	_ = gotoNext == 2684843
    	bits_2684868 = mant_2683379 & (uint64(1)<<flt.mantbits - 1)
    	bits_2684868 |= uint64((exp_2683366-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2684990
    		_ = gotoNext == 2684990
    		bits_2684868 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2685039
    	} else {
    		gotoNext = 2685039
    	}
    	_ = gotoNext == 2685039
    	return bits_2684868, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
