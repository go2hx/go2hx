    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2617800
    			_ = gotoNext == 2617800
    			n_2617748 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2617828
    		}
    		_ = gotoNext == 2617828
    		d.Shift(-n_2617748)
    		exp_2617290 += n_2617748
    		gotoNext = 2617727
    	} else {
    		gotoNext = 2617855
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2617958
    			_ = gotoNext == 2617958
    			n_2617905 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2617987
    		}
    		_ = gotoNext == 2617987
    		d.Shift(n_2617905)
    		exp_2617290 -= n_2617905
    		gotoNext = 2617855
    	} else {
    		gotoNext = 2618074
    	}
    	_ = gotoNext == 2618074
    	exp_2617290--
    	if exp_2617290 < flt.bias+1 {
    		gotoNext = 2618225
    		_ = gotoNext == 2618225
    		n_2618229 = flt.bias + 1 - exp_2617290
    		d.Shift(-n_2618229)
    		exp_2617290 += n_2618229
    		gotoNext = 2618283
    	} else {
    		gotoNext = 2618283
    	}
    	_ = gotoNext == 2618283
    	if exp_2617290-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2618319
    		_ = gotoNext == 2618319
    		gotoNext = 2618682
    		gotoNext = 2618375
    	...
    	mant_2617303 = d.RoundedInteger()
    	if mant_2617303 == 2<<flt.mantbits {
    		gotoNext = 2618511
    		_ = gotoNext == 2618511
    		mant_2617303 >>= 1
    		exp_2617290++
    	...
    	_ = gotoNext == 2618618
    	if mant_2617303&(1<<flt.mantbits) == 0 {
    		gotoNext = 2618649
    		_ = gotoNext == 2618649
    		exp_2617290 = flt.bias
    		gotoNext = 2618672
    	...
    	_ = gotoNext == 2618682
    	mant_2617303 = 0
    	exp_2617290 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2618767
    	_ = gotoNext == 2618767
    	bits_2618792 = mant_2617303 & (uint64(1)<<flt.mantbits - 1)
    	bits_2618792 |= uint64((exp_2617290-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2618914
    		_ = gotoNext == 2618914
    		bits_2618792 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2618963
    	} else {
    		gotoNext = 2618963
    	}
    	_ = gotoNext == 2618963
    	return bits_2618792, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
