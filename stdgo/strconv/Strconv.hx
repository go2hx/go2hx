    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2661927
    			_ = gotoNext == 2661927
    			n_2661875 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2661955
    		}
    		_ = gotoNext == 2661955
    		d.Shift(-n_2661875)
    		exp_2661417 += n_2661875
    		gotoNext = 2661854
    	} else {
    		gotoNext = 2661982
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2662085
    			_ = gotoNext == 2662085
    			n_2662032 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2662114
    		}
    		_ = gotoNext == 2662114
    		d.Shift(n_2662032)
    		exp_2661417 -= n_2662032
    		gotoNext = 2661982
    	} else {
    		gotoNext = 2662201
    	}
    	_ = gotoNext == 2662201
    	exp_2661417--
    	if exp_2661417 < flt.bias+1 {
    		gotoNext = 2662352
    		_ = gotoNext == 2662352
    		n_2662356 = flt.bias + 1 - exp_2661417
    		d.Shift(-n_2662356)
    		exp_2661417 += n_2662356
    		gotoNext = 2662410
    	} else {
    		gotoNext = 2662410
    	}
    	_ = gotoNext == 2662410
    	if exp_2661417-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2662446
    		_ = gotoNext == 2662446
    		gotoNext = 2662809
    		gotoNext = 2662502
    	...
    	mant_2661430 = d.RoundedInteger()
    	if mant_2661430 == 2<<flt.mantbits {
    		gotoNext = 2662638
    		_ = gotoNext == 2662638
    		mant_2661430 >>= 1
    		exp_2661417++
    	...
    	_ = gotoNext == 2662745
    	if mant_2661430&(1<<flt.mantbits) == 0 {
    		gotoNext = 2662776
    		_ = gotoNext == 2662776
    		exp_2661417 = flt.bias
    		gotoNext = 2662799
    	...
    	_ = gotoNext == 2662809
    	mant_2661430 = 0
    	exp_2661417 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2662894
    	_ = gotoNext == 2662894
    	bits_2662919 = mant_2661430 & (uint64(1)<<flt.mantbits - 1)
    	bits_2662919 |= uint64((exp_2661417-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2663041
    		_ = gotoNext == 2663041
    		bits_2662919 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2663090
    	} else {
    		gotoNext = 2663090
    	}
    	_ = gotoNext == 2663090
    	return bits_2662919, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
