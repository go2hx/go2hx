    ...
    /|*{
    	...
    	if d.dp > 0 {
    		...
    		if d.dp >= len(powtab) {
    			...
    			gotoNext = 2686965
    			_ = gotoNext == 2686965
    			n_2686913 = powtab[d.dp]
    			_ = 0
    			gotoNext = 2686993
    		}
    		_ = gotoNext == 2686993
    		d.Shift(-n_2686913)
    		exp_2686455 += n_2686913
    		gotoNext = 2686892
    	} else {
    		gotoNext = 2687020
    	}
    	...
    	if d.dp < 0 || d.dp == 0 && d.d[0] < 53 {
    		...
    		if -d.dp >= len(powtab) {
    			...
    			gotoNext = 2687123
    			_ = gotoNext == 2687123
    			n_2687070 = powtab[-d.dp]
    			_ = 0
    			gotoNext = 2687152
    		}
    		_ = gotoNext == 2687152
    		d.Shift(n_2687070)
    		exp_2686455 -= n_2687070
    		gotoNext = 2687020
    	} else {
    		gotoNext = 2687239
    	}
    	_ = gotoNext == 2687239
    	exp_2686455--
    	if exp_2686455 < flt.bias+1 {
    		gotoNext = 2687390
    		_ = gotoNext == 2687390
    		n_2687394 = flt.bias + 1 - exp_2686455
    		d.Shift(-n_2687394)
    		exp_2686455 += n_2687394
    		gotoNext = 2687448
    	} else {
    		gotoNext = 2687448
    	}
    	_ = gotoNext == 2687448
    	if exp_2686455-flt.bias >= 1<<flt.expbits-1 {
    		gotoNext = 2687484
    		_ = gotoNext == 2687484
    		gotoNext = 2687847
    		gotoNext = 2687540
    	...
    	mant_2686468 = d.RoundedInteger()
    	if mant_2686468 == 2<<flt.mantbits {
    		gotoNext = 2687676
    		_ = gotoNext == 2687676
    		mant_2686468 >>= 1
    		exp_2686455++
    	...
    	_ = gotoNext == 2687783
    	if mant_2686468&(1<<flt.mantbits) == 0 {
    		gotoNext = 2687814
    		_ = gotoNext == 2687814
    		exp_2686455 = flt.bias
    		gotoNext = 2687837
    	...
    	_ = gotoNext == 2687847
    	mant_2686468 = 0
    	exp_2686455 = 1<<flt.expbits - 1 + flt.bias
    	overflow = true
    	gotoNext = 2687932
    	_ = gotoNext == 2687932
    	bits_2687957 = mant_2686468 & (uint64(1)<<flt.mantbits - 1)
    	bits_2687957 |= uint64((exp_2686455-flt.bias)&(1<<flt.expbits-1)) << flt.mantbits
    	if d.neg {
    		gotoNext = 2688079
    		_ = gotoNext == 2688079
    		bits_2687957 |= 1 << flt.mantbits << flt.expbits
    		gotoNext = 2688128
    	} else {
    		gotoNext = 2688128
    	}
    	_ = gotoNext == 2688128
    	return bits_2687957, overflow
    	gotoNext = -1
    }*|/
**/
class Strconv {
