...
private var _tests:Slice<stdgo.testing.Testing.InternalTest> = (new Slice<stdgo.testing.Testing.InternalTest>(0, 0,
	...
	(new stdgo.testing.Testing.InternalTest(("TestAtofRandom" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestParseIntBitSize" : GoString),
		stdgo.strconv_test.Strconv_test.testParseIntBitSize) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestParseUintBitSize" : GoString),
		stdgo.strconv_test.Strconv_test.testParseUintBitSize) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestParseIntBase" : GoString),
		stdgo.strconv_test.Strconv_test.testParseIntBase) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestParseUintBase" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestFormatUintVarlen" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestQuoteToASCII" : GoString),
		stdgo.strconv_test.Strconv_test.testQuoteToASCII) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestQuoteToGraphic" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestQuoteRuneToASCII" : GoString),
		stdgo.strconv_test.Strconv_test.testQuoteRuneToASCII) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestQuoteRuneToGraphic" : GoString),
		stdgo.strconv_test.Strconv_test.testQuoteRuneToGraphic) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestCanBackquote" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestUnquoteInvalidUTF8" : GoString),
		stdgo.strconv_test.Strconv_test.testUnquoteInvalidUTF8) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestCountMallocs" : GoString),
		stdgo.strconv_test.Strconv_test.testCountMallocs) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestErrorPrefixes" : GoString),
...
private var _examples:Slice<stdgo.testing.Testing.InternalExample> = (new Slice<stdgo.testing.Testing.InternalExample>(0, 0,
	(new stdgo.testing.Testing.InternalExample(("ExampleAppendBool" : GoString), stdgo.strconv_test.Strconv_test.exampleAppendBool,
		("bool:true\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleAppendFloat" : GoString), stdgo.strconv_test.Strconv_test.exampleAppendFloat,
		("float32:3.1415927E+00\nfloat64:3.1415926535E+00\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleAppendInt" : GoString), stdgo.strconv_test.Strconv_test.exampleAppendInt,
		("int (base 10):-42\nint (base 16):-2a\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleAppendQuote" : GoString), stdgo.strconv_test.Strconv_test.exampleAppendQuote,
		("quote:\"\\\"Fran & Freddie\'s Diner\\\"\"\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleAppendQuoteRune" : GoString), stdgo.strconv_test.Strconv_test.exampleAppendQuoteRune,
		("rune:\'☺\'\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleAppendQuoteRuneToASCII" : GoString), stdgo.strconv_test.Strconv_test.exampleAppendQuoteRuneToASCII,
		("rune (ascii):\'\\u263a\'\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleAppendQuoteToASCII" : GoString), stdgo.strconv_test.Strconv_test.exampleAppendQuoteToASCII,
		("quote (ascii):\"\\\"Fran & Freddie\'s Diner\\\"\"\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleAppendUint" : GoString), stdgo.strconv_test.Strconv_test.exampleAppendUint,
		("uint (base 10):42\nuint (base 16):2a\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	...
	(new stdgo.testing.Testing.InternalExample(("ExampleCanBackquote" : GoString), stdgo.strconv_test.Strconv_test.exampleCanBackquote,
		("true\nfalse\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleFormatBool" : GoString), stdgo.strconv_test.Strconv_test.exampleFormatBool,
		("string, true\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleFormatFloat" : GoString), stdgo.strconv_test.Strconv_test.exampleFormatFloat,
		("string, 3.1415927E+00\nstring, 3.1415926535E+00\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleFormatInt" : GoString), stdgo.strconv_test.Strconv_test.exampleFormatInt,
		("string, -42\nstring, -2a\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleFormatUint" : GoString), stdgo.strconv_test.Strconv_test.exampleFormatUint,
		("string, 42\nstring, 2a\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleIsGraphic" : GoString), stdgo.strconv_test.Strconv_test.exampleIsGraphic,
		("true\ntrue\nfalse\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	...
	(new stdgo.testing.Testing.InternalExample(("ExampleParseBool" : GoString), stdgo.strconv_test.Strconv_test.exampleParseBool, ("bool, true\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleParseFloat" : GoString), stdgo.strconv_test.Strconv_test.exampleParseFloat,
		("float64, 3.1415927410125732\nfloat64, 3.1415926535\nfloat64, NaN\nfloat64, NaN\nfloat64, +Inf\nfloat64, +Inf\nfloat64, -Inf\nfloat64, -0\nfloat64, 0\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleParseInt" : GoString), stdgo.strconv_test.Strconv_test.exampleParseInt,
		("int64, -354634382\nint64, -3546343826724305832\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleParseUint" : GoString), stdgo.strconv_test.Strconv_test.exampleParseUint,
		("uint64, 42\nuint64, 42\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleQuote" : GoString), stdgo.strconv_test.Strconv_test.exampleQuote,
	...
	(new stdgo.testing.Testing.InternalExample(("ExampleQuoteRuneToGraphic" : GoString), stdgo.strconv_test.Strconv_test.exampleQuoteRuneToGraphic,
		("\'☺\'\n\'☺\'\n\'\\n\'\n\'\\t\'\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleQuoteToASCII" : GoString), stdgo.strconv_test.Strconv_test.exampleQuoteToASCII,
		("\"\\\"Fran & Freddie\'s Diner\\t\\u263a\\\"\"\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleQuoteToGraphic" : GoString), stdgo.strconv_test.Strconv_test.exampleQuoteToGraphic,
		("\"☺\"\n\"This is a ☺\\t\\n\"\n\"\\\" This is a ☺ \\\\n \\\"\"\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleUnquote" : GoString), stdgo.strconv_test.Strconv_test.exampleUnquote,
		("\"\", invalid syntax\n\"The string must be either double-quoted\", <nil>\n\"or backquoted.\", <nil>\n\"☺\", <nil>\n\"\", invalid syntax\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleUnquoteChar" : GoString), stdgo.strconv_test.Strconv_test.exampleUnquoteChar,
		("value: \"\nmultibyte: false\ntail: Fran & Freddie\'s Diner\\\"\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleNumError" : GoString), stdgo.strconv_test.Strconv_test.exampleNumError,
