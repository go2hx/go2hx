...
```
{
    	...
    	gotoNext = 2734674
    	_ = gotoNext == 2734674
    	if i_2734666 < len(s) && i_2734666 < len(t) {
    		gotoNext = 2734710
    		_ = gotoNext == 2734710
    		sr_2734714 = s[i_2734666]
    		tr_2734727 = t[i_2734666]
    		if sr_2734714|tr_2734727 >= 128 {
    			gotoNext = 2734766
    			_ = gotoNext == 2734766
    			gotoNext = 2735124
    			gotoNext = 2734810
    		...
    		if tr_2734727 < sr_2734714 {
    			gotoNext = 2734898
    			_ = gotoNext == 2734898
    			tr_2734727, sr_2734714 = sr_2734714, tr_2734727
    			gotoNext = 2734973
    		} else {
    			gotoNext = 2734973
}
    		_ = gotoNext == 2734973
    		if 65 <= sr_2734714 && sr_2734714 <= 90 && tr_2734727 == sr_2734714+97-65 {
    			gotoNext = 2735019
    			_ = gotoNext == 2735019
    			i_2734666++
    			gotoNext = 2734674
    	...
    	for key, value := range s {
    		keys_2735159 = append(keys_2735159, key)
    		values_2735159 = append(values_2735159, value)
}
    	if 0 < len(keys_2735159) {
    		gotoNext = 2736090
    		_ = gotoNext == 2736090
    		i_2735172 = 0
    		gotoNext = 2736091
    		_ = gotoNext == 2736091
    		if i_2735172 < len(keys_2735159) {
    			gotoNext = 2735180
    			_ = gotoNext == 2735180
    			sr_2735166 = values_2735159[i_2735172]
    			_ = keys_2735159[i_2735172]
    			if len(t) == 0 {
    				gotoNext = 2735249
    				_ = gotoNext == 2735249
    				return false
    			...
    			if t[0] < 128 {
    				gotoNext = 2735356
    				_ = gotoNext == 2735356
    				tr_2735322, t = rune(t[0]), t[1:]
    				gotoNext = 2735540
    			} else {
    				gotoNext = 2735396
    				_ = gotoNext == 2735396
    				r_2735401, size_2735404 = utf8.DecodeRuneInString(t)
    				tr_2735322, t = r_2735401, t[size_2735404:]
    				gotoNext = 2735540
}
    			_ = gotoNext == 2735540
    			if tr_2735322 == sr_2735166 {
    				gotoNext = 2735552
    				_ = gotoNext == 2735552
    				i_2735172++
    				gotoNext = 2736091
    			...
    			if tr_2735322 < sr_2735166 {
    				gotoNext = 2735628
    				_ = gotoNext == 2735628
    				tr_2735322, sr_2735166 = sr_2735166, tr_2735322
    				gotoNext = 2735682
    			} else {
    				gotoNext = 2735682
}
    			...
    			if tr_2735322 < 128 {
    				gotoNext = 2735704
    				_ = gotoNext == 2735704
    				if 65 <= sr_2735166 && sr_2735166 <= 90 && tr_2735322 == sr_2735166+97-65 {
    					gotoNext = 2735804
    					_ = gotoNext == 2735804
    					i_2735172++
    					gotoNext = 2736091
    			...
    			_ = gotoNext == 2735957
    			r_2735957 = unicode.SimpleFold(sr_2735166)
    			_ = 0
    			gotoNext = 2735987
    			_ = gotoNext == 2735987
    			if r_2735957 != sr_2735166 && r_2735957 < tr_2735322 {
    				gotoNext = 2736009
    				_ = gotoNext == 2736009
    				r_2735957 = unicode.SimpleFold(r_2735957)
    				gotoNext = 2735987
    			} else {
    				gotoNext = 2736046
}
    			_ = gotoNext == 2736046
    			if r_2735957 == tr_2735322 {
    				gotoNext = 2736057
    				_ = gotoNext == 2736057
    				i_2735172++
    				gotoNext = 2736091
