...
```
{
    	...
    	gotoNext = 2980711
    	_ = gotoNext == 2980711
    	if i_2980703 < len(s) && i_2980703 < len(t) {
    		gotoNext = 2980747
    		_ = gotoNext == 2980747
    		sr_2980751 = s[i_2980703]
    		tr_2980764 = t[i_2980703]
    		if sr_2980751|tr_2980764 >= 128 {
    			gotoNext = 2980803
    			_ = gotoNext == 2980803
    			gotoNext = 2981161
    			gotoNext = 2980847
    		...
    		if tr_2980764 < sr_2980751 {
    			gotoNext = 2980935
    			_ = gotoNext == 2980935
    			tr_2980764, sr_2980751 = sr_2980751, tr_2980764
    			gotoNext = 2981010
    		} else {
    			gotoNext = 2981010
}
    		_ = gotoNext == 2981010
    		if 65 <= sr_2980751 && sr_2980751 <= 90 && tr_2980764 == sr_2980751+97-65 {
    			gotoNext = 2981056
    			_ = gotoNext == 2981056
    			i_2980703++
    			gotoNext = 2980711
    	...
    	for key, value := range s {
    		keys_2981196 = append(keys_2981196, key)
    		values_2981196 = append(values_2981196, value)
}
    	if 0 < len(keys_2981196) {
    		gotoNext = 2982127
    		_ = gotoNext == 2982127
    		i_2981209 = 0
    		gotoNext = 2982128
    		_ = gotoNext == 2982128
    		if i_2981209 < len(keys_2981196) {
    			gotoNext = 2981217
    			_ = gotoNext == 2981217
    			sr_2981203 = values_2981196[i_2981209]
    			_ = keys_2981196[i_2981209]
    			if len(t) == 0 {
    				gotoNext = 2981286
    				_ = gotoNext == 2981286
    				return false
    			...
    			if t[0] < 128 {
    				gotoNext = 2981393
    				_ = gotoNext == 2981393
    				tr_2981359, t = rune(t[0]), t[1:]
    				gotoNext = 2981577
    			} else {
    				gotoNext = 2981433
    				_ = gotoNext == 2981433
    				r_2981438, size_2981441 = utf8.DecodeRuneInString(t)
    				tr_2981359, t = r_2981438, t[size_2981441:]
    				gotoNext = 2981577
}
    			_ = gotoNext == 2981577
    			if tr_2981359 == sr_2981203 {
    				gotoNext = 2981589
    				_ = gotoNext == 2981589
    				i_2981209++
    				gotoNext = 2982128
    			...
    			if tr_2981359 < sr_2981203 {
    				gotoNext = 2981665
    				_ = gotoNext == 2981665
    				tr_2981359, sr_2981203 = sr_2981203, tr_2981359
    				gotoNext = 2981719
    			} else {
    				gotoNext = 2981719
}
    			...
    			if tr_2981359 < 128 {
    				gotoNext = 2981741
    				_ = gotoNext == 2981741
    				if 65 <= sr_2981203 && sr_2981203 <= 90 && tr_2981359 == sr_2981203+97-65 {
    					gotoNext = 2981841
    					_ = gotoNext == 2981841
    					i_2981209++
    					gotoNext = 2982128
    			...
    			_ = gotoNext == 2981994
    			r_2981994 = unicode.SimpleFold(sr_2981203)
    			_ = 0
    			gotoNext = 2982024
    			_ = gotoNext == 2982024
    			if r_2981994 != sr_2981203 && r_2981994 < tr_2981359 {
    				gotoNext = 2982046
    				_ = gotoNext == 2982046
    				r_2981994 = unicode.SimpleFold(r_2981994)
    				gotoNext = 2982024
    			} else {
    				gotoNext = 2982083
}
    			_ = gotoNext == 2982083
    			if r_2981994 == tr_2981359 {
    				gotoNext = 2982094
    				_ = gotoNext == 2982094
    				i_2981209++
    				gotoNext = 2982128
