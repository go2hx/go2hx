...
Called from stdgo.SliceData.set (stdgo/Slice.hx line 226)
Called from stdgo._Slice.$Slice_Impl_.__append__ (stdgo/Slice.hx line 141)
Called from stdgo.strings.$Builder_static_extension.writeString (stdgo/strings/Strings.hx line 2045)
Called from stdgo.strings_test._Strings_test.$Strings_test_Fields_.testBuilderString (stdgo/strings_test/Strings_test.hx line 1442)
...
```
=== RUN   TestBuilder
--- PASS: TestBuilder (0.000162839889526367188)
=== RUN   TestBuilderString
Exception: slice out of bounds, index: 8 length: 8
Called from stdgo.strings_test._Strings_test.Strings_test_Fields_.testBuilderString (stdgo/strings_test/Strings_test.hx line 1442 column 2)
Called from stdgo.strings.Builder_static_extension.writeString (stdgo/strings/Strings.hx line 2045 column 13)
Called from stdgo._Slice.Slice_Impl_.__append__ (stdgo/Slice.hx line 141 column 4)
Called from stdgo.SliceData.set (stdgo/Slice.hx line 226 column 3)
Called from stdgo.SliceData.boundsCheck (stdgo/Slice.hx line 214 column 4)
```
</p>
</details>
