...
```
{
    	...
    	gotoNext = 2766691
    	_ = gotoNext == 2766691
    	if i_2766683 < len(s) && i_2766683 < len(t) {
    		gotoNext = 2766727
    		_ = gotoNext == 2766727
    		sr_2766731 = s[i_2766683]
    		tr_2766744 = t[i_2766683]
    		if sr_2766731|tr_2766744 >= 128 {
    			gotoNext = 2766783
    			_ = gotoNext == 2766783
    			gotoNext = 2767141
    			gotoNext = 2766827
    		...
    		if tr_2766744 < sr_2766731 {
    			gotoNext = 2766915
    			_ = gotoNext == 2766915
    			tr_2766744, sr_2766731 = sr_2766731, tr_2766744
    			gotoNext = 2766990
    		} else {
    			gotoNext = 2766990
}
    		_ = gotoNext == 2766990
    		if 65 <= sr_2766731 && sr_2766731 <= 90 && tr_2766744 == sr_2766731+97-65 {
    			gotoNext = 2767036
    			_ = gotoNext == 2767036
    			i_2766683++
    			gotoNext = 2766691
    	...
    	for key, value := range s {
    		keys_2767176 = append(keys_2767176, key)
    		values_2767176 = append(values_2767176, value)
}
    	if 0 < len(keys_2767176) {
    		gotoNext = 2768107
    		_ = gotoNext == 2768107
    		i_2767189 = 0
    		gotoNext = 2768108
    		_ = gotoNext == 2768108
    		if i_2767189 < len(keys_2767176) {
    			gotoNext = 2767197
    			_ = gotoNext == 2767197
    			sr_2767183 = values_2767176[i_2767189]
    			_ = keys_2767176[i_2767189]
    			if len(t) == 0 {
    				gotoNext = 2767266
    				_ = gotoNext == 2767266
    				return false
    			...
    			if t[0] < 128 {
    				gotoNext = 2767373
    				_ = gotoNext == 2767373
    				tr_2767339, t = rune(t[0]), t[1:]
    				gotoNext = 2767557
    			} else {
    				gotoNext = 2767413
    				_ = gotoNext == 2767413
    				r_2767418, size_2767421 = utf8.DecodeRuneInString(t)
    				tr_2767339, t = r_2767418, t[size_2767421:]
    				gotoNext = 2767557
}
    			_ = gotoNext == 2767557
    			if tr_2767339 == sr_2767183 {
    				gotoNext = 2767569
    				_ = gotoNext == 2767569
    				i_2767189++
    				gotoNext = 2768108
    			...
    			if tr_2767339 < sr_2767183 {
    				gotoNext = 2767645
    				_ = gotoNext == 2767645
    				tr_2767339, sr_2767183 = sr_2767183, tr_2767339
    				gotoNext = 2767699
    			} else {
    				gotoNext = 2767699
}
    			...
    			if tr_2767339 < 128 {
    				gotoNext = 2767721
    				_ = gotoNext == 2767721
    				if 65 <= sr_2767183 && sr_2767183 <= 90 && tr_2767339 == sr_2767183+97-65 {
    					gotoNext = 2767821
    					_ = gotoNext == 2767821
    					i_2767189++
    					gotoNext = 2768108
    			...
    			_ = gotoNext == 2767974
    			r_2767974 = unicode.SimpleFold(sr_2767183)
    			_ = 0
    			gotoNext = 2768004
    			_ = gotoNext == 2768004
    			if r_2767974 != sr_2767183 && r_2767974 < tr_2767339 {
    				gotoNext = 2768026
    				_ = gotoNext == 2768026
    				r_2767974 = unicode.SimpleFold(r_2767974)
    				gotoNext = 2768004
    			} else {
    				gotoNext = 2768063
}
    			_ = gotoNext == 2768063
    			if r_2767974 == tr_2767339 {
    				gotoNext = 2768074
    				_ = gotoNext == 2768074
    				i_2767189++
    				gotoNext = 2768108
