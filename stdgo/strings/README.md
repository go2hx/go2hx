...
```
{
    	...
    	gotoNext = 2770402
    	_ = gotoNext == 2770402
    	if i_2770394 < len(s) && i_2770394 < len(t) {
    		gotoNext = 2770438
    		_ = gotoNext == 2770438
    		sr_2770442 = s[i_2770394]
    		tr_2770455 = t[i_2770394]
    		if sr_2770442|tr_2770455 >= 128 {
    			gotoNext = 2770494
    			_ = gotoNext == 2770494
    			gotoNext = 2770852
    			gotoNext = 2770538
    		...
    		if tr_2770455 < sr_2770442 {
    			gotoNext = 2770626
    			_ = gotoNext == 2770626
    			tr_2770455, sr_2770442 = sr_2770442, tr_2770455
    			gotoNext = 2770701
    		} else {
    			gotoNext = 2770701
}
    		_ = gotoNext == 2770701
    		if 65 <= sr_2770442 && sr_2770442 <= 90 && tr_2770455 == sr_2770442+97-65 {
    			gotoNext = 2770747
    			_ = gotoNext == 2770747
    			i_2770394++
    			gotoNext = 2770402
    	...
    	for key, value := range s {
    		keys_2770887 = append(keys_2770887, key)
    		values_2770887 = append(values_2770887, value)
}
    	if 0 < len(keys_2770887) {
    		gotoNext = 2771818
    		_ = gotoNext == 2771818
    		i_2770900 = 0
    		gotoNext = 2771819
    		_ = gotoNext == 2771819
    		if i_2770900 < len(keys_2770887) {
    			gotoNext = 2770908
    			_ = gotoNext == 2770908
    			sr_2770894 = values_2770887[i_2770900]
    			_ = keys_2770887[i_2770900]
    			if len(t) == 0 {
    				gotoNext = 2770977
    				_ = gotoNext == 2770977
    				return false
    			...
    			if t[0] < 128 {
    				gotoNext = 2771084
    				_ = gotoNext == 2771084
    				tr_2771050, t = rune(t[0]), t[1:]
    				gotoNext = 2771268
    			} else {
    				gotoNext = 2771124
    				_ = gotoNext == 2771124
    				r_2771129, size_2771132 = utf8.DecodeRuneInString(t)
    				tr_2771050, t = r_2771129, t[size_2771132:]
    				gotoNext = 2771268
}
    			_ = gotoNext == 2771268
    			if tr_2771050 == sr_2770894 {
    				gotoNext = 2771280
    				_ = gotoNext == 2771280
    				i_2770900++
    				gotoNext = 2771819
    			...
    			if tr_2771050 < sr_2770894 {
    				gotoNext = 2771356
    				_ = gotoNext == 2771356
    				tr_2771050, sr_2770894 = sr_2770894, tr_2771050
    				gotoNext = 2771410
    			} else {
    				gotoNext = 2771410
}
    			...
    			if tr_2771050 < 128 {
    				gotoNext = 2771432
    				_ = gotoNext == 2771432
    				if 65 <= sr_2770894 && sr_2770894 <= 90 && tr_2771050 == sr_2770894+97-65 {
    					gotoNext = 2771532
    					_ = gotoNext == 2771532
    					i_2770900++
    					gotoNext = 2771819
    			...
    			_ = gotoNext == 2771685
    			r_2771685 = unicode.SimpleFold(sr_2770894)
    			_ = 0
    			gotoNext = 2771715
    			_ = gotoNext == 2771715
    			if r_2771685 != sr_2770894 && r_2771685 < tr_2771050 {
    				gotoNext = 2771737
    				_ = gotoNext == 2771737
    				r_2771685 = unicode.SimpleFold(r_2771685)
    				gotoNext = 2771715
    			} else {
    				gotoNext = 2771774
}
    			_ = gotoNext == 2771774
    			if r_2771685 == tr_2771050 {
    				gotoNext = 2771785
    				_ = gotoNext == 2771785
    				i_2770900++
    				gotoNext = 2771819
