...
/**
    /|*{
    	...
    	gotoNext = 2925453
    	_ = gotoNext == 2925453
    	if i_2925445 < len(s) && i_2925445 < len(t) {
    		gotoNext = 2925489
    		_ = gotoNext == 2925489
    		sr_2925493 = s[i_2925445]
    		tr_2925506 = t[i_2925445]
    		if sr_2925493|tr_2925506 >= 128 {
    			gotoNext = 2925545
    			_ = gotoNext == 2925545
    			gotoNext = 2925903
    			gotoNext = 2925589
    		...
    		if tr_2925506 < sr_2925493 {
    			gotoNext = 2925677
    			_ = gotoNext == 2925677
    			tr_2925506, sr_2925493 = sr_2925493, tr_2925506
    			gotoNext = 2925752
    		} else {
    			gotoNext = 2925752
    		}
    		_ = gotoNext == 2925752
    		if 65 <= sr_2925493 && sr_2925493 <= 90 && tr_2925506 == sr_2925493+97-65 {
    			gotoNext = 2925798
    			_ = gotoNext == 2925798
    			i_2925445++
    			gotoNext = 2925453
    	...
    	for key, value := range s {
    		keys_2925938 = append(keys_2925938, key)
    		values_2925938 = append(values_2925938, value)
    	}
    	if 0 < len(keys_2925938) {
    		gotoNext = 2926869
    		_ = gotoNext == 2926869
    		i_2925951 = 0
    		gotoNext = 2926870
    		_ = gotoNext == 2926870
    		if i_2925951 < len(keys_2925938) {
    			gotoNext = 2925959
    			_ = gotoNext == 2925959
    			sr_2925945 = values_2925938[i_2925951]
    			_ = keys_2925938[i_2925951]
    			if len(t) == 0 {
    				gotoNext = 2926028
    				_ = gotoNext == 2926028
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 2926175
    				_ = gotoNext == 2926175
    				r_2926180, size_2926183 = utf8.DecodeRuneInString(t)
    				tr_2926101, t = r_2926180, t[size_2926183:]
    				_ = 0
    				gotoNext = 2926319
    			}
    			_ = gotoNext == 2926319
    			if tr_2926101 == sr_2925945 {
    				gotoNext = 2926331
    				_ = gotoNext == 2926331
    				i_2925951++
    				gotoNext = 2926870
    			...
    			if tr_2926101 < sr_2925945 {
    				gotoNext = 2926407
    				_ = gotoNext == 2926407
    				tr_2926101, sr_2925945 = sr_2925945, tr_2926101
    				gotoNext = 2926461
    			} else {
    				gotoNext = 2926461
    			}
    			...
    			if tr_2926101 < 128 {
    				gotoNext = 2926483
    				_ = gotoNext == 2926483
    				if 65 <= sr_2925945 && sr_2925945 <= 90 && tr_2926101 == sr_2925945+97-65 {
    					gotoNext = 2926583
    					_ = gotoNext == 2926583
    					i_2925951++
    					gotoNext = 2926870
    			...
    			_ = gotoNext == 2926736
    			r_2926736 = unicode.SimpleFold(sr_2925945)
    			_ = 0
    			gotoNext = 2926766
    			_ = gotoNext == 2926766
    			if r_2926736 != sr_2925945 && r_2926736 < tr_2926101 {
    				gotoNext = 2926788
    				_ = gotoNext == 2926788
    				r_2926736 = unicode.SimpleFold(r_2926736)
    				gotoNext = 2926766
    			} else {
    				gotoNext = 2926825
    			}
    			_ = gotoNext == 2926825
    			if r_2926736 == tr_2926101 {
    				gotoNext = 2926836
    				_ = gotoNext == 2926836
    				i_2925951++
    				gotoNext = 2926870
