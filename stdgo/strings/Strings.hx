...
/**
    /|*{
    	...
    	gotoNext = 2844856
    	_ = gotoNext == 2844856
    	if i_2844848 < len(s) && i_2844848 < len(t) {
    		gotoNext = 2844892
    		_ = gotoNext == 2844892
    		sr_2844896 = s[i_2844848]
    		tr_2844909 = t[i_2844848]
    		if sr_2844896|tr_2844909 >= 128 {
    			gotoNext = 2844948
    			_ = gotoNext == 2844948
    			gotoNext = 2845306
    			gotoNext = 2844992
    		...
    		if tr_2844909 < sr_2844896 {
    			gotoNext = 2845080
    			_ = gotoNext == 2845080
    			tr_2844909, sr_2844896 = sr_2844896, tr_2844909
    			gotoNext = 2845155
    		} else {
    			gotoNext = 2845155
    		}
    		_ = gotoNext == 2845155
    		if 65 <= sr_2844896 && sr_2844896 <= 90 && tr_2844909 == sr_2844896+97-65 {
    			gotoNext = 2845201
    			_ = gotoNext == 2845201
    			i_2844848++
    			gotoNext = 2844856
    	...
    	for key, value := range s {
    		keys_2845341 = append(keys_2845341, key)
    		values_2845341 = append(values_2845341, value)
    	}
    	if 0 < len(keys_2845341) {
    		gotoNext = 2846272
    		_ = gotoNext == 2846272
    		i_2845354 = 0
    		gotoNext = 2846273
    		_ = gotoNext == 2846273
    		if i_2845354 < len(keys_2845341) {
    			gotoNext = 2845362
    			_ = gotoNext == 2845362
    			sr_2845348 = values_2845341[i_2845354]
    			_ = keys_2845341[i_2845354]
    			if len(t) == 0 {
    				gotoNext = 2845431
    				_ = gotoNext == 2845431
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 2845578
    				_ = gotoNext == 2845578
    				r_2845583, size_2845586 = utf8.DecodeRuneInString(t)
    				tr_2845504, t = r_2845583, t[size_2845586:]
    				_ = 0
    				gotoNext = 2845722
    			}
    			_ = gotoNext == 2845722
    			if tr_2845504 == sr_2845348 {
    				gotoNext = 2845734
    				_ = gotoNext == 2845734
    				i_2845354++
    				gotoNext = 2846273
    			...
    			if tr_2845504 < sr_2845348 {
    				gotoNext = 2845810
    				_ = gotoNext == 2845810
    				tr_2845504, sr_2845348 = sr_2845348, tr_2845504
    				gotoNext = 2845864
    			} else {
    				gotoNext = 2845864
    			}
    			...
    			if tr_2845504 < 128 {
    				gotoNext = 2845886
    				_ = gotoNext == 2845886
    				if 65 <= sr_2845348 && sr_2845348 <= 90 && tr_2845504 == sr_2845348+97-65 {
    					gotoNext = 2845986
    					_ = gotoNext == 2845986
    					i_2845354++
    					gotoNext = 2846273
    			...
    			_ = gotoNext == 2846139
    			r_2846139 = unicode.SimpleFold(sr_2845348)
    			_ = 0
    			gotoNext = 2846169
    			_ = gotoNext == 2846169
    			if r_2846139 != sr_2845348 && r_2846139 < tr_2845504 {
    				gotoNext = 2846191
    				_ = gotoNext == 2846191
    				r_2846139 = unicode.SimpleFold(r_2846139)
    				gotoNext = 2846169
    			} else {
    				gotoNext = 2846228
    			}
    			_ = gotoNext == 2846228
    			if r_2846139 == tr_2845504 {
    				gotoNext = 2846239
    				_ = gotoNext == 2846239
    				i_2845354++
    				gotoNext = 2846273
