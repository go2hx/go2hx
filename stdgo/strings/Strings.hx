...
/**
    /|*{
    	...
    	gotoNext = 2807061
    	_ = gotoNext == 2807061
    	if i_2807053 < len(s) && i_2807053 < len(t) {
    		gotoNext = 2807097
    		_ = gotoNext == 2807097
    		sr_2807101 = s[i_2807053]
    		tr_2807114 = t[i_2807053]
    		if sr_2807101|tr_2807114 >= 128 {
    			gotoNext = 2807153
    			_ = gotoNext == 2807153
    			gotoNext = 2807511
    			gotoNext = 2807197
    		...
    		if tr_2807114 < sr_2807101 {
    			gotoNext = 2807285
    			_ = gotoNext == 2807285
    			tr_2807114, sr_2807101 = sr_2807101, tr_2807114
    			gotoNext = 2807360
    		} else {
    			gotoNext = 2807360
    		}
    		_ = gotoNext == 2807360
    		if 65 <= sr_2807101 && sr_2807101 <= 90 && tr_2807114 == sr_2807101+97-65 {
    			gotoNext = 2807406
    			_ = gotoNext == 2807406
    			i_2807053++
    			gotoNext = 2807061
    	...
    	for key, value := range s {
    		keys_2807546 = append(keys_2807546, key)
    		values_2807546 = append(values_2807546, value)
    	}
    	if 0 < len(keys_2807546) {
    		gotoNext = 2808477
    		_ = gotoNext == 2808477
    		i_2807559 = 0
    		gotoNext = 2808478
    		_ = gotoNext == 2808478
    		if i_2807559 < len(keys_2807546) {
    			gotoNext = 2807567
    			_ = gotoNext == 2807567
    			sr_2807553 = values_2807546[i_2807559]
    			_ = keys_2807546[i_2807559]
    			if len(t) == 0 {
    				gotoNext = 2807636
    				_ = gotoNext == 2807636
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 2807783
    				_ = gotoNext == 2807783
    				r_2807788, size_2807791 = utf8.DecodeRuneInString(t)
    				tr_2807709, t = r_2807788, t[size_2807791:]
    				_ = 0
    				gotoNext = 2807927
    			}
    			_ = gotoNext == 2807927
    			if tr_2807709 == sr_2807553 {
    				gotoNext = 2807939
    				_ = gotoNext == 2807939
    				i_2807559++
    				gotoNext = 2808478
    			...
    			if tr_2807709 < sr_2807553 {
    				gotoNext = 2808015
    				_ = gotoNext == 2808015
    				tr_2807709, sr_2807553 = sr_2807553, tr_2807709
    				gotoNext = 2808069
    			} else {
    				gotoNext = 2808069
    			}
    			...
    			if tr_2807709 < 128 {
    				gotoNext = 2808091
    				_ = gotoNext == 2808091
    				if 65 <= sr_2807553 && sr_2807553 <= 90 && tr_2807709 == sr_2807553+97-65 {
    					gotoNext = 2808191
    					_ = gotoNext == 2808191
    					i_2807559++
    					gotoNext = 2808478
    			...
    			_ = gotoNext == 2808344
    			r_2808344 = unicode.SimpleFold(sr_2807553)
    			_ = 0
    			gotoNext = 2808374
    			_ = gotoNext == 2808374
    			if r_2808344 != sr_2807553 && r_2808344 < tr_2807709 {
    				gotoNext = 2808396
    				_ = gotoNext == 2808396
    				r_2808344 = unicode.SimpleFold(r_2808344)
    				gotoNext = 2808374
    			} else {
    				gotoNext = 2808433
    			}
    			_ = gotoNext == 2808433
    			if r_2808344 == tr_2807709 {
    				gotoNext = 2808444
    				_ = gotoNext == 2808444
    				i_2807559++
    				gotoNext = 2808478
