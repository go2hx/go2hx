...
/**
    /|*{
    	...
    	gotoNext = 2814912
    	_ = gotoNext == 2814912
    	if i_2814904 < len(s) && i_2814904 < len(t) {
    		gotoNext = 2814948
    		_ = gotoNext == 2814948
    		sr_2814952 = s[i_2814904]
    		tr_2814965 = t[i_2814904]
    		if sr_2814952|tr_2814965 >= 128 {
    			gotoNext = 2815004
    			_ = gotoNext == 2815004
    			gotoNext = 2815362
    			gotoNext = 2815048
    		...
    		if tr_2814965 < sr_2814952 {
    			gotoNext = 2815136
    			_ = gotoNext == 2815136
    			tr_2814965, sr_2814952 = sr_2814952, tr_2814965
    			gotoNext = 2815211
    		} else {
    			gotoNext = 2815211
    		}
    		_ = gotoNext == 2815211
    		if 65 <= sr_2814952 && sr_2814952 <= 90 && tr_2814965 == sr_2814952+97-65 {
    			gotoNext = 2815257
    			_ = gotoNext == 2815257
    			i_2814904++
    			gotoNext = 2814912
    	...
    	for key, value := range s {
    		keys_2815397 = append(keys_2815397, key)
    		values_2815397 = append(values_2815397, value)
    	}
    	if 0 < len(keys_2815397) {
    		gotoNext = 2816328
    		_ = gotoNext == 2816328
    		i_2815410 = 0
    		gotoNext = 2816329
    		_ = gotoNext == 2816329
    		if i_2815410 < len(keys_2815397) {
    			gotoNext = 2815418
    			_ = gotoNext == 2815418
    			sr_2815404 = values_2815397[i_2815410]
    			_ = keys_2815397[i_2815410]
    			if len(t) == 0 {
    				gotoNext = 2815487
    				_ = gotoNext == 2815487
    				return false
    			...
    			if t[0] < 128 {
    				gotoNext = 2815594
    				_ = gotoNext == 2815594
    				tr_2815560, t = rune(t[0]), t[1:]
    				gotoNext = 2815778
    			} else {
    				gotoNext = 2815634
    				_ = gotoNext == 2815634
    				r_2815639, size_2815642 = utf8.DecodeRuneInString(t)
    				tr_2815560, t = r_2815639, t[size_2815642:]
    				gotoNext = 2815778
    			}
    			_ = gotoNext == 2815778
    			if tr_2815560 == sr_2815404 {
    				gotoNext = 2815790
    				_ = gotoNext == 2815790
    				i_2815410++
    				gotoNext = 2816329
    			...
    			if tr_2815560 < sr_2815404 {
    				gotoNext = 2815866
    				_ = gotoNext == 2815866
    				tr_2815560, sr_2815404 = sr_2815404, tr_2815560
    				gotoNext = 2815920
    			} else {
    				gotoNext = 2815920
    			}
    			...
    			if tr_2815560 < 128 {
    				gotoNext = 2815942
    				_ = gotoNext == 2815942
    				if 65 <= sr_2815404 && sr_2815404 <= 90 && tr_2815560 == sr_2815404+97-65 {
    					gotoNext = 2816042
    					_ = gotoNext == 2816042
    					i_2815410++
    					gotoNext = 2816329
    			...
    			_ = gotoNext == 2816195
    			r_2816195 = unicode.SimpleFold(sr_2815404)
    			_ = 0
    			gotoNext = 2816225
    			_ = gotoNext == 2816225
    			if r_2816195 != sr_2815404 && r_2816195 < tr_2815560 {
    				gotoNext = 2816247
    				_ = gotoNext == 2816247
    				r_2816195 = unicode.SimpleFold(r_2816195)
    				gotoNext = 2816225
    			} else {
    				gotoNext = 2816284
    			}
    			_ = gotoNext == 2816284
    			if r_2816195 == tr_2815560 {
    				gotoNext = 2816295
    				_ = gotoNext == 2816295
    				i_2815410++
    				gotoNext = 2816329
