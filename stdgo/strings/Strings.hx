...
/**
    /|*{
    	...
    	gotoNext = 2787323
    	_ = gotoNext == 2787323
    	if i_2787315 < len(s) && i_2787315 < len(t) {
    		gotoNext = 2787359
    		_ = gotoNext == 2787359
    		sr_2787363 = s[i_2787315]
    		tr_2787376 = t[i_2787315]
    		if sr_2787363|tr_2787376 >= 128 {
    			gotoNext = 2787415
    			_ = gotoNext == 2787415
    			gotoNext = 2787773
    			gotoNext = 2787459
    		...
    		if tr_2787376 < sr_2787363 {
    			gotoNext = 2787547
    			_ = gotoNext == 2787547
    			tr_2787376, sr_2787363 = sr_2787363, tr_2787376
    			gotoNext = 2787622
    		} else {
    			gotoNext = 2787622
    		}
    		_ = gotoNext == 2787622
    		if 65 <= sr_2787363 && sr_2787363 <= 90 && tr_2787376 == sr_2787363+97-65 {
    			gotoNext = 2787668
    			_ = gotoNext == 2787668
    			i_2787315++
    			gotoNext = 2787323
    	...
    	for key, value := range s {
    		keys_2787808 = append(keys_2787808, key)
    		values_2787808 = append(values_2787808, value)
    	}
    	if 0 < len(keys_2787808) {
    		gotoNext = 2788739
    		_ = gotoNext == 2788739
    		i_2787821 = 0
    		gotoNext = 2788740
    		_ = gotoNext == 2788740
    		if i_2787821 < len(keys_2787808) {
    			gotoNext = 2787829
    			_ = gotoNext == 2787829
    			sr_2787815 = values_2787808[i_2787821]
    			_ = keys_2787808[i_2787821]
    			if len(t) == 0 {
    				gotoNext = 2787898
    				_ = gotoNext == 2787898
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 2788045
    				_ = gotoNext == 2788045
    				r_2788050, size_2788053 = utf8.DecodeRuneInString(t)
    				tr_2787971, t = r_2788050, t[size_2788053:]
    				_ = 0
    				gotoNext = 2788189
    			}
    			_ = gotoNext == 2788189
    			if tr_2787971 == sr_2787815 {
    				gotoNext = 2788201
    				_ = gotoNext == 2788201
    				i_2787821++
    				gotoNext = 2788740
    			...
    			if tr_2787971 < sr_2787815 {
    				gotoNext = 2788277
    				_ = gotoNext == 2788277
    				tr_2787971, sr_2787815 = sr_2787815, tr_2787971
    				gotoNext = 2788331
    			} else {
    				gotoNext = 2788331
    			}
    			...
    			if tr_2787971 < 128 {
    				gotoNext = 2788353
    				_ = gotoNext == 2788353
    				if 65 <= sr_2787815 && sr_2787815 <= 90 && tr_2787971 == sr_2787815+97-65 {
    					gotoNext = 2788453
    					_ = gotoNext == 2788453
    					i_2787821++
    					gotoNext = 2788740
    			...
    			_ = gotoNext == 2788606
    			r_2788606 = unicode.SimpleFold(sr_2787815)
    			_ = 0
    			gotoNext = 2788636
    			_ = gotoNext == 2788636
    			if r_2788606 != sr_2787815 && r_2788606 < tr_2787971 {
    				gotoNext = 2788658
    				_ = gotoNext == 2788658
    				r_2788606 = unicode.SimpleFold(r_2788606)
    				gotoNext = 2788636
    			} else {
    				gotoNext = 2788695
    			}
    			_ = gotoNext == 2788695
    			if r_2788606 == tr_2787971 {
    				gotoNext = 2788706
    				_ = gotoNext == 2788706
    				i_2787821++
    				gotoNext = 2788740
