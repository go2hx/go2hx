...
/**
    /|*{
    	...
    	gotoNext = 2932609
    	_ = gotoNext == 2932609
    	if i_2932601 < len(s) && i_2932601 < len(t) {
    		gotoNext = 2932645
    		_ = gotoNext == 2932645
    		sr_2932649 = s[i_2932601]
    		tr_2932662 = t[i_2932601]
    		if sr_2932649|tr_2932662 >= 128 {
    			gotoNext = 2932701
    			_ = gotoNext == 2932701
    			gotoNext = 2933059
    			gotoNext = 2932745
    		...
    		if tr_2932662 < sr_2932649 {
    			gotoNext = 2932833
    			_ = gotoNext == 2932833
    			tr_2932662, sr_2932649 = sr_2932649, tr_2932662
    			gotoNext = 2932908
    		} else {
    			gotoNext = 2932908
    		}
    		_ = gotoNext == 2932908
    		if 65 <= sr_2932649 && sr_2932649 <= 90 && tr_2932662 == sr_2932649+97-65 {
    			gotoNext = 2932954
    			_ = gotoNext == 2932954
    			i_2932601++
    			gotoNext = 2932609
    	...
    	for key, value := range s {
    		keys_2933094 = append(keys_2933094, key)
    		values_2933094 = append(values_2933094, value)
    	}
    	if 0 < len(keys_2933094) {
    		gotoNext = 2934025
    		_ = gotoNext == 2934025
    		i_2933107 = 0
    		gotoNext = 2934026
    		_ = gotoNext == 2934026
    		if i_2933107 < len(keys_2933094) {
    			gotoNext = 2933115
    			_ = gotoNext == 2933115
    			sr_2933101 = values_2933094[i_2933107]
    			_ = keys_2933094[i_2933107]
    			if len(t) == 0 {
    				gotoNext = 2933184
    				_ = gotoNext == 2933184
    				return false
    			...
    			if t[0] < 128 {
    				gotoNext = 2933291
    				_ = gotoNext == 2933291
    				tr_2933257, t = rune(t[0]), t[1:]
    				gotoNext = 2933475
    			} else {
    				gotoNext = 2933331
    				_ = gotoNext == 2933331
    				r_2933336, size_2933339 = utf8.DecodeRuneInString(t)
    				tr_2933257, t = r_2933336, t[size_2933339:]
    				gotoNext = 2933475
    			}
    			_ = gotoNext == 2933475
    			if tr_2933257 == sr_2933101 {
    				gotoNext = 2933487
    				_ = gotoNext == 2933487
    				i_2933107++
    				gotoNext = 2934026
    			...
    			if tr_2933257 < sr_2933101 {
    				gotoNext = 2933563
    				_ = gotoNext == 2933563
    				tr_2933257, sr_2933101 = sr_2933101, tr_2933257
    				gotoNext = 2933617
    			} else {
    				gotoNext = 2933617
    			}
    			...
    			if tr_2933257 < 128 {
    				gotoNext = 2933639
    				_ = gotoNext == 2933639
    				if 65 <= sr_2933101 && sr_2933101 <= 90 && tr_2933257 == sr_2933101+97-65 {
    					gotoNext = 2933739
    					_ = gotoNext == 2933739
    					i_2933107++
    					gotoNext = 2934026
    			...
    			_ = gotoNext == 2933892
    			r_2933892 = unicode.SimpleFold(sr_2933101)
    			_ = 0
    			gotoNext = 2933922
    			_ = gotoNext == 2933922
    			if r_2933892 != sr_2933101 && r_2933892 < tr_2933257 {
    				gotoNext = 2933944
    				_ = gotoNext == 2933944
    				r_2933892 = unicode.SimpleFold(r_2933892)
    				gotoNext = 2933922
    			} else {
    				gotoNext = 2933981
    			}
    			_ = gotoNext == 2933981
    			if r_2933892 == tr_2933257 {
    				gotoNext = 2933992
    				_ = gotoNext == 2933992
    				i_2933107++
    				gotoNext = 2934026
