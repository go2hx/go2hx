...
/**
    /|*{
    	...
    	gotoNext = 3021340
    	_ = gotoNext == 3021340
    	if i_3021332 < len(s) && i_3021332 < len(t) {
    		gotoNext = 3021376
    		_ = gotoNext == 3021376
    		sr_3021380 = s[i_3021332]
    		tr_3021393 = t[i_3021332]
    		if sr_3021380|tr_3021393 >= 128 {
    			gotoNext = 3021432
    			_ = gotoNext == 3021432
    			gotoNext = 3021790
    			gotoNext = 3021476
    		...
    		if tr_3021393 < sr_3021380 {
    			gotoNext = 3021564
    			_ = gotoNext == 3021564
    			tr_3021393, sr_3021380 = sr_3021380, tr_3021393
    			gotoNext = 3021639
    		} else {
    			gotoNext = 3021639
    		}
    		_ = gotoNext == 3021639
    		if 65 <= sr_3021380 && sr_3021380 <= 90 && tr_3021393 == sr_3021380+97-65 {
    			gotoNext = 3021685
    			_ = gotoNext == 3021685
    			i_3021332++
    			gotoNext = 3021340
    	...
    	for key, value := range s {
    		keys_3021825 = append(keys_3021825, key)
    		values_3021825 = append(values_3021825, value)
    	}
    	if 0 < len(keys_3021825) {
    		gotoNext = 3022756
    		_ = gotoNext == 3022756
    		i_3021838 = 0
    		gotoNext = 3022757
    		_ = gotoNext == 3022757
    		if i_3021838 < len(keys_3021825) {
    			gotoNext = 3021846
    			_ = gotoNext == 3021846
    			sr_3021832 = values_3021825[i_3021838]
    			_ = keys_3021825[i_3021838]
    			if len(t) == 0 {
    				gotoNext = 3021915
    				_ = gotoNext == 3021915
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 3022062
    				_ = gotoNext == 3022062
    				r_3022067, size_3022070 = utf8.DecodeRuneInString(t)
    				tr_3021988, t = r_3022067, t[size_3022070:]
    				_ = 0
    				gotoNext = 3022206
    			}
    			_ = gotoNext == 3022206
    			if tr_3021988 == sr_3021832 {
    				gotoNext = 3022218
    				_ = gotoNext == 3022218
    				i_3021838++
    				gotoNext = 3022757
    			...
    			if tr_3021988 < sr_3021832 {
    				gotoNext = 3022294
    				_ = gotoNext == 3022294
    				tr_3021988, sr_3021832 = sr_3021832, tr_3021988
    				gotoNext = 3022348
    			} else {
    				gotoNext = 3022348
    			}
    			...
    			if tr_3021988 < 128 {
    				gotoNext = 3022370
    				_ = gotoNext == 3022370
    				if 65 <= sr_3021832 && sr_3021832 <= 90 && tr_3021988 == sr_3021832+97-65 {
    					gotoNext = 3022470
    					_ = gotoNext == 3022470
    					i_3021838++
    					gotoNext = 3022757
    			...
    			_ = gotoNext == 3022623
    			r_3022623 = unicode.SimpleFold(sr_3021832)
    			_ = 0
    			gotoNext = 3022653
    			_ = gotoNext == 3022653
    			if r_3022623 != sr_3021832 && r_3022623 < tr_3021988 {
    				gotoNext = 3022675
    				_ = gotoNext == 3022675
    				r_3022623 = unicode.SimpleFold(r_3022623)
    				gotoNext = 3022653
    			} else {
    				gotoNext = 3022712
    			}
    			_ = gotoNext == 3022712
    			if r_3022623 == tr_3021988 {
    				gotoNext = 3022723
    				_ = gotoNext == 3022723
    				i_3021838++
    				gotoNext = 3022757
