...
function _makeStringFinder(_pattern:GoString):T_stringFinder {
        var _f = ({ _pattern : _pattern, _goodSuffixSkip : new Slice<GoInt>((_pattern.length : GoInt).toBasic(), 0, ...[for (i in 0 ... (_pattern.length : GoInt).toBasic()) (0 : GoInt)]) } : T_stringFinder);
    ...
    static public function _build( _b:Replacer):T_replacer {
        ...
        if ((_oldnew.length == (2 : GoInt)) && (_oldnew[(0 : GoInt)].length > (1 : GoInt))) {
            return {
                ...
                __self__.replace = #if !macro function(__0:GoString):GoString return _makeSingleStringReplacer(_oldnew[(0 : GoInt)], _oldnew[(1 : GoInt)]).replace(__0) #else null #end;
                __self__.writeString = #if !macro function(_w_:stdgo.io.Io.Writer, _s_:GoString):{ var _0 : GoInt; var _1 : stdgo.Error; } return _makeSingleStringReplacer(_oldnew[(0 : GoInt)], _oldnew[(1 : GoInt)]).writeString(_w_, _s_) #else null #end;
                __self__;
            };
        };
    ...
    static public function writeString( _r:T_byteStringReplacer, _w:stdgo.io.Io.Writer, _s:GoString):{ var _0 : GoInt; var _1 : Error; } {
        ...
        var _last:GoInt = (0 : GoInt);
        {
            ...
            Go.cfor(_i < (_s.length), _i++, {
                ...
                _last = _i + (1 : GoInt);
                var __tmp__ = _w.write(_r._replacements[_b]), _nw:GoInt = __tmp__._0, _err:stdgo.Error = __tmp__._1;
                _n = _n + (_nw);
                if (_err != null) {
                    return { _0 : _n, _1 : _err };
                };
