...
/**
    /|*{
    	...
    	gotoNext = 2881316
    	_ = gotoNext == 2881316
    	if i_2881308 < len(s) && i_2881308 < len(t) {
    		gotoNext = 2881352
    		_ = gotoNext == 2881352
    		sr_2881356 = s[i_2881308]
    		tr_2881369 = t[i_2881308]
    		if sr_2881356|tr_2881369 >= 128 {
    			gotoNext = 2881408
    			_ = gotoNext == 2881408
    			gotoNext = 2881766
    			gotoNext = 2881452
    		...
    		if tr_2881369 < sr_2881356 {
    			gotoNext = 2881540
    			_ = gotoNext == 2881540
    			tr_2881369, sr_2881356 = sr_2881356, tr_2881369
    			gotoNext = 2881615
    		} else {
    			gotoNext = 2881615
    		}
    		_ = gotoNext == 2881615
    		if 65 <= sr_2881356 && sr_2881356 <= 90 && tr_2881369 == sr_2881356+97-65 {
    			gotoNext = 2881661
    			_ = gotoNext == 2881661
    			i_2881308++
    			gotoNext = 2881316
    	...
    	for key, value := range s {
    		keys_2881801 = append(keys_2881801, key)
    		values_2881801 = append(values_2881801, value)
    	}
    	if 0 < len(keys_2881801) {
    		gotoNext = 2882732
    		_ = gotoNext == 2882732
    		i_2881814 = 0
    		gotoNext = 2882733
    		_ = gotoNext == 2882733
    		if i_2881814 < len(keys_2881801) {
    			gotoNext = 2881822
    			_ = gotoNext == 2881822
    			sr_2881808 = values_2881801[i_2881814]
    			_ = keys_2881801[i_2881814]
    			if len(t) == 0 {
    				gotoNext = 2881891
    				_ = gotoNext == 2881891
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 2882038
    				_ = gotoNext == 2882038
    				r_2882043, size_2882046 = utf8.DecodeRuneInString(t)
    				tr_2881964, t = r_2882043, t[size_2882046:]
    				_ = 0
    				gotoNext = 2882182
    			}
    			_ = gotoNext == 2882182
    			if tr_2881964 == sr_2881808 {
    				gotoNext = 2882194
    				_ = gotoNext == 2882194
    				i_2881814++
    				gotoNext = 2882733
    			...
    			if tr_2881964 < sr_2881808 {
    				gotoNext = 2882270
    				_ = gotoNext == 2882270
    				tr_2881964, sr_2881808 = sr_2881808, tr_2881964
    				gotoNext = 2882324
    			} else {
    				gotoNext = 2882324
    			}
    			...
    			if tr_2881964 < 128 {
    				gotoNext = 2882346
    				_ = gotoNext == 2882346
    				if 65 <= sr_2881808 && sr_2881808 <= 90 && tr_2881964 == sr_2881808+97-65 {
    					gotoNext = 2882446
    					_ = gotoNext == 2882446
    					i_2881814++
    					gotoNext = 2882733
    			...
    			_ = gotoNext == 2882599
    			r_2882599 = unicode.SimpleFold(sr_2881808)
    			_ = 0
    			gotoNext = 2882629
    			_ = gotoNext == 2882629
    			if r_2882599 != sr_2881808 && r_2882599 < tr_2881964 {
    				gotoNext = 2882651
    				_ = gotoNext == 2882651
    				r_2882599 = unicode.SimpleFold(r_2882599)
    				gotoNext = 2882629
    			} else {
    				gotoNext = 2882688
    			}
    			_ = gotoNext == 2882688
    			if r_2882599 == tr_2881964 {
    				gotoNext = 2882699
    				_ = gotoNext == 2882699
    				i_2881814++
    				gotoNext = 2882733
