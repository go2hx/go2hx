...
/**
    /|*{
    	...
    	gotoNext = 2998161
    	_ = gotoNext == 2998161
    	if i_2998153 < len(s) && i_2998153 < len(t) {
    		gotoNext = 2998197
    		_ = gotoNext == 2998197
    		sr_2998201 = s[i_2998153]
    		tr_2998214 = t[i_2998153]
    		if sr_2998201|tr_2998214 >= 128 {
    			gotoNext = 2998253
    			_ = gotoNext == 2998253
    			gotoNext = 2998611
    			gotoNext = 2998297
    		...
    		if tr_2998214 < sr_2998201 {
    			gotoNext = 2998385
    			_ = gotoNext == 2998385
    			tr_2998214, sr_2998201 = sr_2998201, tr_2998214
    			gotoNext = 2998460
    		} else {
    			gotoNext = 2998460
    		}
    		_ = gotoNext == 2998460
    		if 65 <= sr_2998201 && sr_2998201 <= 90 && tr_2998214 == sr_2998201+97-65 {
    			gotoNext = 2998506
    			_ = gotoNext == 2998506
    			i_2998153++
    			gotoNext = 2998161
    	...
    	for key, value := range s {
    		keys_2998646 = append(keys_2998646, key)
    		values_2998646 = append(values_2998646, value)
    	}
    	if 0 < len(keys_2998646) {
    		gotoNext = 2999577
    		_ = gotoNext == 2999577
    		i_2998659 = 0
    		gotoNext = 2999578
    		_ = gotoNext == 2999578
    		if i_2998659 < len(keys_2998646) {
    			gotoNext = 2998667
    			_ = gotoNext == 2998667
    			sr_2998653 = values_2998646[i_2998659]
    			_ = keys_2998646[i_2998659]
    			if len(t) == 0 {
    				gotoNext = 2998736
    				_ = gotoNext == 2998736
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 2998883
    				_ = gotoNext == 2998883
    				r_2998888, size_2998891 = utf8.DecodeRuneInString(t)
    				tr_2998809, t = r_2998888, t[size_2998891:]
    				_ = 0
    				gotoNext = 2999027
    			}
    			_ = gotoNext == 2999027
    			if tr_2998809 == sr_2998653 {
    				gotoNext = 2999039
    				_ = gotoNext == 2999039
    				i_2998659++
    				gotoNext = 2999578
    			...
    			if tr_2998809 < sr_2998653 {
    				gotoNext = 2999115
    				_ = gotoNext == 2999115
    				tr_2998809, sr_2998653 = sr_2998653, tr_2998809
    				gotoNext = 2999169
    			} else {
    				gotoNext = 2999169
    			}
    			...
    			if tr_2998809 < 128 {
    				gotoNext = 2999191
    				_ = gotoNext == 2999191
    				if 65 <= sr_2998653 && sr_2998653 <= 90 && tr_2998809 == sr_2998653+97-65 {
    					gotoNext = 2999291
    					_ = gotoNext == 2999291
    					i_2998659++
    					gotoNext = 2999578
    			...
    			_ = gotoNext == 2999444
    			r_2999444 = unicode.SimpleFold(sr_2998653)
    			_ = 0
    			gotoNext = 2999474
    			_ = gotoNext == 2999474
    			if r_2999444 != sr_2998653 && r_2999444 < tr_2998809 {
    				gotoNext = 2999496
    				_ = gotoNext == 2999496
    				r_2999444 = unicode.SimpleFold(r_2999444)
    				gotoNext = 2999474
    			} else {
    				gotoNext = 2999533
    			}
    			_ = gotoNext == 2999533
    			if r_2999444 == tr_2998809 {
    				gotoNext = 2999544
    				_ = gotoNext == 2999544
    				i_2998659++
    				gotoNext = 2999578
