...
/**
    /|*{
    	...
    	gotoNext = 3041166
    	_ = gotoNext == 3041166
    	if i_3041158 < len(s) && i_3041158 < len(t) {
    		gotoNext = 3041202
    		_ = gotoNext == 3041202
    		sr_3041206 = s[i_3041158]
    		tr_3041219 = t[i_3041158]
    		if sr_3041206|tr_3041219 >= 128 {
    			gotoNext = 3041258
    			_ = gotoNext == 3041258
    			gotoNext = 3041616
    			gotoNext = 3041302
    		...
    		if tr_3041219 < sr_3041206 {
    			gotoNext = 3041390
    			_ = gotoNext == 3041390
    			tr_3041219, sr_3041206 = sr_3041206, tr_3041219
    			gotoNext = 3041465
    		} else {
    			gotoNext = 3041465
    		}
    		_ = gotoNext == 3041465
    		if 65 <= sr_3041206 && sr_3041206 <= 90 && tr_3041219 == sr_3041206+97-65 {
    			gotoNext = 3041511
    			_ = gotoNext == 3041511
    			i_3041158++
    			gotoNext = 3041166
    	...
    	for key, value := range s {
    		keys_3041651 = append(keys_3041651, key)
    		values_3041651 = append(values_3041651, value)
    	}
    	if 0 < len(keys_3041651) {
    		gotoNext = 3042582
    		_ = gotoNext == 3042582
    		i_3041664 = 0
    		gotoNext = 3042583
    		_ = gotoNext == 3042583
    		if i_3041664 < len(keys_3041651) {
    			gotoNext = 3041672
    			_ = gotoNext == 3041672
    			sr_3041658 = values_3041651[i_3041664]
    			_ = keys_3041651[i_3041664]
    			if len(t) == 0 {
    				gotoNext = 3041741
    				_ = gotoNext == 3041741
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 3041888
    				_ = gotoNext == 3041888
    				r_3041893, size_3041896 = utf8.DecodeRuneInString(t)
    				tr_3041814, t = r_3041893, t[size_3041896:]
    				_ = 0
    				gotoNext = 3042032
    			}
    			_ = gotoNext == 3042032
    			if tr_3041814 == sr_3041658 {
    				gotoNext = 3042044
    				_ = gotoNext == 3042044
    				i_3041664++
    				gotoNext = 3042583
    			...
    			if tr_3041814 < sr_3041658 {
    				gotoNext = 3042120
    				_ = gotoNext == 3042120
    				tr_3041814, sr_3041658 = sr_3041658, tr_3041814
    				gotoNext = 3042174
    			} else {
    				gotoNext = 3042174
    			}
    			...
    			if tr_3041814 < 128 {
    				gotoNext = 3042196
    				_ = gotoNext == 3042196
    				if 65 <= sr_3041658 && sr_3041658 <= 90 && tr_3041814 == sr_3041658+97-65 {
    					gotoNext = 3042296
    					_ = gotoNext == 3042296
    					i_3041664++
    					gotoNext = 3042583
    			...
    			_ = gotoNext == 3042449
    			r_3042449 = unicode.SimpleFold(sr_3041658)
    			_ = 0
    			gotoNext = 3042479
    			_ = gotoNext == 3042479
    			if r_3042449 != sr_3041658 && r_3042449 < tr_3041814 {
    				gotoNext = 3042501
    				_ = gotoNext == 3042501
    				r_3042449 = unicode.SimpleFold(r_3042449)
    				gotoNext = 3042479
    			} else {
    				gotoNext = 3042538
    			}
    			_ = gotoNext == 3042538
    			if r_3042449 == tr_3041814 {
    				gotoNext = 3042549
    				_ = gotoNext == 3042549
    				i_3041664++
    				gotoNext = 3042583
