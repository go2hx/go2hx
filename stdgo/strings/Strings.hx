...
/**
    /|*{
    	...
    	gotoNext = 2882962
    	_ = gotoNext == 2882962
    	if i_2882954 < len(s) && i_2882954 < len(t) {
    		gotoNext = 2882998
    		_ = gotoNext == 2882998
    		sr_2883002 = s[i_2882954]
    		tr_2883015 = t[i_2882954]
    		if sr_2883002|tr_2883015 >= 128 {
    			gotoNext = 2883054
    			_ = gotoNext == 2883054
    			gotoNext = 2883412
    			gotoNext = 2883098
    		...
    		if tr_2883015 < sr_2883002 {
    			gotoNext = 2883186
    			_ = gotoNext == 2883186
    			tr_2883015, sr_2883002 = sr_2883002, tr_2883015
    			gotoNext = 2883261
    		} else {
    			gotoNext = 2883261
    		}
    		_ = gotoNext == 2883261
    		if 65 <= sr_2883002 && sr_2883002 <= 90 && tr_2883015 == sr_2883002+97-65 {
    			gotoNext = 2883307
    			_ = gotoNext == 2883307
    			i_2882954++
    			gotoNext = 2882962
    	...
    	for key, value := range s {
    		keys_2883447 = append(keys_2883447, key)
    		values_2883447 = append(values_2883447, value)
    	}
    	if 0 < len(keys_2883447) {
    		gotoNext = 2884378
    		_ = gotoNext == 2884378
    		i_2883460 = 0
    		gotoNext = 2884379
    		_ = gotoNext == 2884379
    		if i_2883460 < len(keys_2883447) {
    			gotoNext = 2883468
    			_ = gotoNext == 2883468
    			sr_2883454 = values_2883447[i_2883460]
    			_ = keys_2883447[i_2883460]
    			if len(t) == 0 {
    				gotoNext = 2883537
    				_ = gotoNext == 2883537
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 2883684
    				_ = gotoNext == 2883684
    				r_2883689, size_2883692 = utf8.DecodeRuneInString(t)
    				tr_2883610, t = r_2883689, t[size_2883692:]
    				_ = 0
    				gotoNext = 2883828
    			}
    			_ = gotoNext == 2883828
    			if tr_2883610 == sr_2883454 {
    				gotoNext = 2883840
    				_ = gotoNext == 2883840
    				i_2883460++
    				gotoNext = 2884379
    			...
    			if tr_2883610 < sr_2883454 {
    				gotoNext = 2883916
    				_ = gotoNext == 2883916
    				tr_2883610, sr_2883454 = sr_2883454, tr_2883610
    				gotoNext = 2883970
    			} else {
    				gotoNext = 2883970
    			}
    			...
    			if tr_2883610 < 128 {
    				gotoNext = 2883992
    				_ = gotoNext == 2883992
    				if 65 <= sr_2883454 && sr_2883454 <= 90 && tr_2883610 == sr_2883454+97-65 {
    					gotoNext = 2884092
    					_ = gotoNext == 2884092
    					i_2883460++
    					gotoNext = 2884379
    			...
    			_ = gotoNext == 2884245
    			r_2884245 = unicode.SimpleFold(sr_2883454)
    			_ = 0
    			gotoNext = 2884275
    			_ = gotoNext == 2884275
    			if r_2884245 != sr_2883454 && r_2884245 < tr_2883610 {
    				gotoNext = 2884297
    				_ = gotoNext == 2884297
    				r_2884245 = unicode.SimpleFold(r_2884245)
    				gotoNext = 2884275
    			} else {
    				gotoNext = 2884334
    			}
    			_ = gotoNext == 2884334
    			if r_2884245 == tr_2883610 {
    				gotoNext = 2884345
    				_ = gotoNext == 2884345
    				i_2883460++
    				gotoNext = 2884379
