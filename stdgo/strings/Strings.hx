...
/**
    /|*{
    	...
    	gotoNext = 2957378
    	_ = gotoNext == 2957378
    	if i_2957370 < len(s) && i_2957370 < len(t) {
    		gotoNext = 2957414
    		_ = gotoNext == 2957414
    		sr_2957418 = s[i_2957370]
    		tr_2957431 = t[i_2957370]
    		if sr_2957418|tr_2957431 >= 128 {
    			gotoNext = 2957470
    			_ = gotoNext == 2957470
    			gotoNext = 2957828
    			gotoNext = 2957514
    		...
    		if tr_2957431 < sr_2957418 {
    			gotoNext = 2957602
    			_ = gotoNext == 2957602
    			tr_2957431, sr_2957418 = sr_2957418, tr_2957431
    			gotoNext = 2957677
    		} else {
    			gotoNext = 2957677
    		}
    		_ = gotoNext == 2957677
    		if 65 <= sr_2957418 && sr_2957418 <= 90 && tr_2957431 == sr_2957418+97-65 {
    			gotoNext = 2957723
    			_ = gotoNext == 2957723
    			i_2957370++
    			gotoNext = 2957378
    	...
    	for key, value := range s {
    		keys_2957863 = append(keys_2957863, key)
    		values_2957863 = append(values_2957863, value)
    	}
    	if 0 < len(keys_2957863) {
    		gotoNext = 2958794
    		_ = gotoNext == 2958794
    		i_2957876 = 0
    		gotoNext = 2958795
    		_ = gotoNext == 2958795
    		if i_2957876 < len(keys_2957863) {
    			gotoNext = 2957884
    			_ = gotoNext == 2957884
    			sr_2957870 = values_2957863[i_2957876]
    			_ = keys_2957863[i_2957876]
    			if len(t) == 0 {
    				gotoNext = 2957953
    				_ = gotoNext == 2957953
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 2958100
    				_ = gotoNext == 2958100
    				r_2958105, size_2958108 = utf8.DecodeRuneInString(t)
    				tr_2958026, t = r_2958105, t[size_2958108:]
    				_ = 0
    				gotoNext = 2958244
    			}
    			_ = gotoNext == 2958244
    			if tr_2958026 == sr_2957870 {
    				gotoNext = 2958256
    				_ = gotoNext == 2958256
    				i_2957876++
    				gotoNext = 2958795
    			...
    			if tr_2958026 < sr_2957870 {
    				gotoNext = 2958332
    				_ = gotoNext == 2958332
    				tr_2958026, sr_2957870 = sr_2957870, tr_2958026
    				gotoNext = 2958386
    			} else {
    				gotoNext = 2958386
    			}
    			...
    			if tr_2958026 < 128 {
    				gotoNext = 2958408
    				_ = gotoNext == 2958408
    				if 65 <= sr_2957870 && sr_2957870 <= 90 && tr_2958026 == sr_2957870+97-65 {
    					gotoNext = 2958508
    					_ = gotoNext == 2958508
    					i_2957876++
    					gotoNext = 2958795
    			...
    			_ = gotoNext == 2958661
    			r_2958661 = unicode.SimpleFold(sr_2957870)
    			_ = 0
    			gotoNext = 2958691
    			_ = gotoNext == 2958691
    			if r_2958661 != sr_2957870 && r_2958661 < tr_2958026 {
    				gotoNext = 2958713
    				_ = gotoNext == 2958713
    				r_2958661 = unicode.SimpleFold(r_2958661)
    				gotoNext = 2958691
    			} else {
    				gotoNext = 2958750
    			}
    			_ = gotoNext == 2958750
    			if r_2958661 == tr_2958026 {
    				gotoNext = 2958761
    				_ = gotoNext == 2958761
    				i_2957876++
    				gotoNext = 2958795
