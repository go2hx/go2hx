...
/**
    /|*{
    	...
    	gotoNext = 2830752
    	_ = gotoNext == 2830752
    	if i_2830744 < len(s) && i_2830744 < len(t) {
    		gotoNext = 2830788
    		_ = gotoNext == 2830788
    		sr_2830792 = s[i_2830744]
    		tr_2830805 = t[i_2830744]
    		if sr_2830792|tr_2830805 >= 128 {
    			gotoNext = 2830844
    			_ = gotoNext == 2830844
    			gotoNext = 2831202
    			gotoNext = 2830888
    		...
    		if tr_2830805 < sr_2830792 {
    			gotoNext = 2830976
    			_ = gotoNext == 2830976
    			tr_2830805, sr_2830792 = sr_2830792, tr_2830805
    			gotoNext = 2831051
    		} else {
    			gotoNext = 2831051
    		}
    		_ = gotoNext == 2831051
    		if 65 <= sr_2830792 && sr_2830792 <= 90 && tr_2830805 == sr_2830792+97-65 {
    			gotoNext = 2831097
    			_ = gotoNext == 2831097
    			i_2830744++
    			gotoNext = 2830752
    	...
    	for key, value := range s {
    		keys_2831237 = append(keys_2831237, key)
    		values_2831237 = append(values_2831237, value)
    	}
    	if 0 < len(keys_2831237) {
    		gotoNext = 2832168
    		_ = gotoNext == 2832168
    		i_2831250 = 0
    		gotoNext = 2832169
    		_ = gotoNext == 2832169
    		if i_2831250 < len(keys_2831237) {
    			gotoNext = 2831258
    			_ = gotoNext == 2831258
    			sr_2831244 = values_2831237[i_2831250]
    			_ = keys_2831237[i_2831250]
    			if len(t) == 0 {
    				gotoNext = 2831327
    				_ = gotoNext == 2831327
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 2831474
    				_ = gotoNext == 2831474
    				r_2831479, size_2831482 = utf8.DecodeRuneInString(t)
    				tr_2831400, t = r_2831479, t[size_2831482:]
    				_ = 0
    				gotoNext = 2831618
    			}
    			_ = gotoNext == 2831618
    			if tr_2831400 == sr_2831244 {
    				gotoNext = 2831630
    				_ = gotoNext == 2831630
    				i_2831250++
    				gotoNext = 2832169
    			...
    			if tr_2831400 < sr_2831244 {
    				gotoNext = 2831706
    				_ = gotoNext == 2831706
    				tr_2831400, sr_2831244 = sr_2831244, tr_2831400
    				gotoNext = 2831760
    			} else {
    				gotoNext = 2831760
    			}
    			...
    			if tr_2831400 < 128 {
    				gotoNext = 2831782
    				_ = gotoNext == 2831782
    				if 65 <= sr_2831244 && sr_2831244 <= 90 && tr_2831400 == sr_2831244+97-65 {
    					gotoNext = 2831882
    					_ = gotoNext == 2831882
    					i_2831250++
    					gotoNext = 2832169
    			...
    			_ = gotoNext == 2832035
    			r_2832035 = unicode.SimpleFold(sr_2831244)
    			_ = 0
    			gotoNext = 2832065
    			_ = gotoNext == 2832065
    			if r_2832035 != sr_2831244 && r_2832035 < tr_2831400 {
    				gotoNext = 2832087
    				_ = gotoNext == 2832087
    				r_2832035 = unicode.SimpleFold(r_2832035)
    				gotoNext = 2832065
    			} else {
    				gotoNext = 2832124
    			}
    			_ = gotoNext == 2832124
    			if r_2832035 == tr_2831400 {
    				gotoNext = 2832135
    				_ = gotoNext == 2832135
    				i_2831250++
    				gotoNext = 2832169
