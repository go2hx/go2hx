...
/**
    /|*{
    	...
    	gotoNext = 2934728
    	_ = gotoNext == 2934728
    	if i_2934720 < len(s) && i_2934720 < len(t) {
    		gotoNext = 2934764
    		_ = gotoNext == 2934764
    		sr_2934768 = s[i_2934720]
    		tr_2934781 = t[i_2934720]
    		if sr_2934768|tr_2934781 >= 128 {
    			gotoNext = 2934820
    			_ = gotoNext == 2934820
    			gotoNext = 2935178
    			gotoNext = 2934864
    		...
    		if tr_2934781 < sr_2934768 {
    			gotoNext = 2934952
    			_ = gotoNext == 2934952
    			tr_2934781, sr_2934768 = sr_2934768, tr_2934781
    			gotoNext = 2935027
    		} else {
    			gotoNext = 2935027
    		}
    		_ = gotoNext == 2935027
    		if 65 <= sr_2934768 && sr_2934768 <= 90 && tr_2934781 == sr_2934768+97-65 {
    			gotoNext = 2935073
    			_ = gotoNext == 2935073
    			i_2934720++
    			gotoNext = 2934728
    	...
    	for key, value := range s {
    		keys_2935213 = append(keys_2935213, key)
    		values_2935213 = append(values_2935213, value)
    	}
    	if 0 < len(keys_2935213) {
    		gotoNext = 2936144
    		_ = gotoNext == 2936144
    		i_2935226 = 0
    		gotoNext = 2936145
    		_ = gotoNext == 2936145
    		if i_2935226 < len(keys_2935213) {
    			gotoNext = 2935234
    			_ = gotoNext == 2935234
    			sr_2935220 = values_2935213[i_2935226]
    			_ = keys_2935213[i_2935226]
    			if len(t) == 0 {
    				gotoNext = 2935303
    				_ = gotoNext == 2935303
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 2935450
    				_ = gotoNext == 2935450
    				r_2935455, size_2935458 = utf8.DecodeRuneInString(t)
    				tr_2935376, t = r_2935455, t[size_2935458:]
    				_ = 0
    				gotoNext = 2935594
    			}
    			_ = gotoNext == 2935594
    			if tr_2935376 == sr_2935220 {
    				gotoNext = 2935606
    				_ = gotoNext == 2935606
    				i_2935226++
    				gotoNext = 2936145
    			...
    			if tr_2935376 < sr_2935220 {
    				gotoNext = 2935682
    				_ = gotoNext == 2935682
    				tr_2935376, sr_2935220 = sr_2935220, tr_2935376
    				gotoNext = 2935736
    			} else {
    				gotoNext = 2935736
    			}
    			...
    			if tr_2935376 < 128 {
    				gotoNext = 2935758
    				_ = gotoNext == 2935758
    				if 65 <= sr_2935220 && sr_2935220 <= 90 && tr_2935376 == sr_2935220+97-65 {
    					gotoNext = 2935858
    					_ = gotoNext == 2935858
    					i_2935226++
    					gotoNext = 2936145
    			...
    			_ = gotoNext == 2936011
    			r_2936011 = unicode.SimpleFold(sr_2935220)
    			_ = 0
    			gotoNext = 2936041
    			_ = gotoNext == 2936041
    			if r_2936011 != sr_2935220 && r_2936011 < tr_2935376 {
    				gotoNext = 2936063
    				_ = gotoNext == 2936063
    				r_2936011 = unicode.SimpleFold(r_2936011)
    				gotoNext = 2936041
    			} else {
    				gotoNext = 2936100
    			}
    			_ = gotoNext == 2936100
    			if r_2936011 == tr_2935376 {
    				gotoNext = 2936111
    				_ = gotoNext == 2936111
    				i_2935226++
    				gotoNext = 2936145
