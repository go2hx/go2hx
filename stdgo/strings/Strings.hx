...
/**
    /|*{
    	...
    	gotoNext = 2899716
    	_ = gotoNext == 2899716
    	if i_2899708 < len(s) && i_2899708 < len(t) {
    		gotoNext = 2899752
    		_ = gotoNext == 2899752
    		sr_2899756 = s[i_2899708]
    		tr_2899769 = t[i_2899708]
    		if sr_2899756|tr_2899769 >= 128 {
    			gotoNext = 2899808
    			_ = gotoNext == 2899808
    			gotoNext = 2900166
    			gotoNext = 2899852
    		...
    		if tr_2899769 < sr_2899756 {
    			gotoNext = 2899940
    			_ = gotoNext == 2899940
    			tr_2899769, sr_2899756 = sr_2899756, tr_2899769
    			gotoNext = 2900015
    		} else {
    			gotoNext = 2900015
    		}
    		_ = gotoNext == 2900015
    		if 65 <= sr_2899756 && sr_2899756 <= 90 && tr_2899769 == sr_2899756+97-65 {
    			gotoNext = 2900061
    			_ = gotoNext == 2900061
    			i_2899708++
    			gotoNext = 2899716
    	...
    	for key, value := range s {
    		keys_2900201 = append(keys_2900201, key)
    		values_2900201 = append(values_2900201, value)
    	}
    	if 0 < len(keys_2900201) {
    		gotoNext = 2901132
    		_ = gotoNext == 2901132
    		i_2900214 = 0
    		gotoNext = 2901133
    		_ = gotoNext == 2901133
    		if i_2900214 < len(keys_2900201) {
    			gotoNext = 2900222
    			_ = gotoNext == 2900222
    			sr_2900208 = values_2900201[i_2900214]
    			_ = keys_2900201[i_2900214]
    			if len(t) == 0 {
    				gotoNext = 2900291
    				_ = gotoNext == 2900291
    				return false
    			...
    			if t[0] < 128 {
    				gotoNext = 2900398
    				_ = gotoNext == 2900398
    				tr_2900364, t = rune(t[0]), t[1:]
    				gotoNext = 2900582
    			} else {
    				gotoNext = 2900438
    				_ = gotoNext == 2900438
    				r_2900443, size_2900446 = utf8.DecodeRuneInString(t)
    				tr_2900364, t = r_2900443, t[size_2900446:]
    				_ = 0
    				gotoNext = 2900582
    			}
    			_ = gotoNext == 2900582
    			if tr_2900364 == sr_2900208 {
    				gotoNext = 2900594
    				_ = gotoNext == 2900594
    				i_2900214++
    				gotoNext = 2901133
    			...
    			if tr_2900364 < sr_2900208 {
    				gotoNext = 2900670
    				_ = gotoNext == 2900670
    				tr_2900364, sr_2900208 = sr_2900208, tr_2900364
    				gotoNext = 2900724
    			} else {
    				gotoNext = 2900724
    			}
    			...
    			if tr_2900364 < 128 {
    				gotoNext = 2900746
    				_ = gotoNext == 2900746
    				if 65 <= sr_2900208 && sr_2900208 <= 90 && tr_2900364 == sr_2900208+97-65 {
    					gotoNext = 2900846
    					_ = gotoNext == 2900846
    					i_2900214++
    					gotoNext = 2901133
    			...
    			_ = gotoNext == 2900999
    			r_2900999 = unicode.SimpleFold(sr_2900208)
    			_ = 0
    			gotoNext = 2901029
    			_ = gotoNext == 2901029
    			if r_2900999 != sr_2900208 && r_2900999 < tr_2900364 {
    				gotoNext = 2901051
    				_ = gotoNext == 2901051
    				r_2900999 = unicode.SimpleFold(r_2900999)
    				gotoNext = 2901029
    			} else {
    				gotoNext = 2901088
    			}
    			_ = gotoNext == 2901088
    			if r_2900999 == tr_2900364 {
    				gotoNext = 2901099
    				_ = gotoNext == 2901099
    				i_2900214++
    				gotoNext = 2901133
