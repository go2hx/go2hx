...
/**
    /|*{
    	...
    	gotoNext = 2888141
    	_ = gotoNext == 2888141
    	if i_2888133 < len(s) && i_2888133 < len(t) {
    		gotoNext = 2888177
    		_ = gotoNext == 2888177
    		sr_2888181 = s[i_2888133]
    		tr_2888194 = t[i_2888133]
    		if sr_2888181|tr_2888194 >= 128 {
    			gotoNext = 2888233
    			_ = gotoNext == 2888233
    			gotoNext = 2888591
    			gotoNext = 2888277
    		...
    		if tr_2888194 < sr_2888181 {
    			gotoNext = 2888365
    			_ = gotoNext == 2888365
    			tr_2888194, sr_2888181 = sr_2888181, tr_2888194
    			gotoNext = 2888440
    		} else {
    			gotoNext = 2888440
    		}
    		_ = gotoNext == 2888440
    		if 65 <= sr_2888181 && sr_2888181 <= 90 && tr_2888194 == sr_2888181+97-65 {
    			gotoNext = 2888486
    			_ = gotoNext == 2888486
    			i_2888133++
    			gotoNext = 2888141
    	...
    	for key, value := range s {
    		keys_2888626 = append(keys_2888626, key)
    		values_2888626 = append(values_2888626, value)
    	}
    	if 0 < len(keys_2888626) {
    		gotoNext = 2889557
    		_ = gotoNext == 2889557
    		i_2888639 = 0
    		gotoNext = 2889558
    		_ = gotoNext == 2889558
    		if i_2888639 < len(keys_2888626) {
    			gotoNext = 2888647
    			_ = gotoNext == 2888647
    			sr_2888633 = values_2888626[i_2888639]
    			_ = keys_2888626[i_2888639]
    			if len(t) == 0 {
    				gotoNext = 2888716
    				_ = gotoNext == 2888716
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 2888863
    				_ = gotoNext == 2888863
    				r_2888868, size_2888871 = utf8.DecodeRuneInString(t)
    				tr_2888789, t = r_2888868, t[size_2888871:]
    				_ = 0
    				gotoNext = 2889007
    			}
    			_ = gotoNext == 2889007
    			if tr_2888789 == sr_2888633 {
    				gotoNext = 2889019
    				_ = gotoNext == 2889019
    				i_2888639++
    				gotoNext = 2889558
    			...
    			if tr_2888789 < sr_2888633 {
    				gotoNext = 2889095
    				_ = gotoNext == 2889095
    				tr_2888789, sr_2888633 = sr_2888633, tr_2888789
    				gotoNext = 2889149
    			} else {
    				gotoNext = 2889149
    			}
    			...
    			if tr_2888789 < 128 {
    				gotoNext = 2889171
    				_ = gotoNext == 2889171
    				if 65 <= sr_2888633 && sr_2888633 <= 90 && tr_2888789 == sr_2888633+97-65 {
    					gotoNext = 2889271
    					_ = gotoNext == 2889271
    					i_2888639++
    					gotoNext = 2889558
    			...
    			_ = gotoNext == 2889424
    			r_2889424 = unicode.SimpleFold(sr_2888633)
    			_ = 0
    			gotoNext = 2889454
    			_ = gotoNext == 2889454
    			if r_2889424 != sr_2888633 && r_2889424 < tr_2888789 {
    				gotoNext = 2889476
    				_ = gotoNext == 2889476
    				r_2889424 = unicode.SimpleFold(r_2889424)
    				gotoNext = 2889454
    			} else {
    				gotoNext = 2889513
    			}
    			_ = gotoNext == 2889513
    			if r_2889424 == tr_2888789 {
    				gotoNext = 2889524
    				_ = gotoNext == 2889524
    				i_2888639++
    				gotoNext = 2889558
