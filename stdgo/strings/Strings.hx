...
**/
private final _countCutOff = ("8" : GoUInt64);
/**
...
private function _makeGenericReplacer(_oldnew:Slice<GoString>):Ref<T_genericReplacer> {
        ...
        _r._root._table = new Slice<Ref<T_trieNode>>((_r._tableSize : GoInt).toBasic(), 0, ...[for (i in 0 ... (_r._tableSize : GoInt).toBasic()) (null : Ref<T_trieNode>)]);
        {
            var _i:GoInt = (0 : GoInt);
            Go.cfor(_i < (_oldnew.length), _i = _i + ((2 : GoInt)), {
...
private function _makeStringFinder(_pattern:GoString):Ref<T_stringFinder> {
        var _f = (({ _pattern : _pattern, _goodSuffixSkip : new Slice<GoInt>((_pattern.length : GoInt).toBasic(), 0, ...[for (i in 0 ... (_pattern.length : GoInt).toBasic()) (0 : GoInt)]) } : T_stringFinder) : Ref<T_stringFinder>);
...
private function _explode(_s:GoString, _n:GoInt):Slice<GoString> {
        ...
        var _a = new Slice<GoString>((_n : GoInt).toBasic(), 0, ...[for (i in 0 ... (_n : GoInt).toBasic()) ("" : GoString)]);
        {
            ...
            Go.cfor(_i < (_n - (1 : GoInt)), _i++, {
                var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRuneInString(_s), _0:GoInt32 = __tmp__._0, _size:GoInt = __tmp__._1;
...
function toUpper(_s:GoString):GoString {
        ...
        if (_isASCII) {
            ...
            var _0:Builder = ({} : Builder), _1:GoInt = (0 : GoInt), _pos:GoInt = _1, _b:Builder = _0;
            _b.grow((_s.length));
            {
                var _i:GoInt = (0 : GoInt);
                Go.cfor(_i < (_s.length), _i++, {
...
class Builder_asInterface {
    ...
    **/
    @:keep
    public function _grow(_n:GoInt):Void __self__.value._grow(_n);
    /**
    ...
    **/
    ...
    @:keep
    public function _copyCheck():Void __self__.value._copyCheck();
...
@:keep @:allow(stdgo.strings.Strings.Builder_asInterface) class Builder_static_extension {
    ...
    **/
    ...
    static public function _grow( _b:Ref<Builder>, _n:GoInt):Void {
        var _buf = new Slice<GoUInt8>((_b._buf.length : GoInt).toBasic(), ((2 : GoInt) * _b._buf.capacity) + _n, ...[for (i in 0 ... (_b._buf.length : GoInt).toBasic()) (0 : GoUInt8)]);
...
class Reader_asInterface {
    ...
    **/
    @:keep
    public function reset(_s:GoString):Void __self__.value.reset(_s);
    /**
...
class Replacer_asInterface {
    ...
    **/
    @:keep
    public function writeString(_w:stdgo.io.Io.Writer, _s:GoString):{ var _0 : GoInt; var _1 : Error; } return __self__.value.writeString(_w, _s);
    /**
        // Replace returns a copy of s with all replacements performed.
    **/
    @:keep
    public function replace(_s:GoString):GoString return __self__.value.replace(_s);
    @:keep
    public function _build():T_replacer return __self__.value._build();
    @:keep
    public function _buildOnce():Void __self__.value._buildOnce();
    @:keep
    public function printTrie():GoString return __self__.value.printTrie();
    @:keep
    public function replacer():AnyInterface return __self__.value.replacer();
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
@:keep @:allow(stdgo.strings.Strings.Replacer_asInterface) class Replacer_static_extension {
    ...
    **/
    ...
    static public function _build( _b:Ref<Replacer>):T_replacer {
        ...
        var _r:T_byteStringReplacer = ({ _toReplace : new Slice<GoString>((0 : GoInt).toBasic(), (_oldnew.length) / (2 : GoInt), ...[for (i in 0 ... (0 : GoInt).toBasic()) ("" : GoString)]) } : T_byteStringReplacer);
        {
            var _i:GoInt = (_oldnew.length) - (2 : GoInt);
            Go.cfor(_i >= (0 : GoInt), _i = _i - ((2 : GoInt)), {
                var _o:GoUInt8 = _oldnew[(_i : GoInt)][(0 : GoInt)];
...
class T_trieNode_asInterface {
    @:keep
    public function _add(_key:GoString, _val:GoString, _priority:GoInt, _r:Ref<T_genericReplacer>):Void __self__.value._add(_key, _val, _priority, _r);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
class T_genericReplacer_asInterface {
    ...
    public function replace(_s:GoString):GoString return __self__.value.replace(_s);
    @:keep
    public function _lookup(_s:GoString, _ignoreRoot:Bool):{ var _0 : GoString; var _1 : GoInt; var _2 : Bool; } return __self__.value._lookup(_s, _ignoreRoot);
    @:keep
    public function _printNode(_t:Ref<T_trieNode>, _depth:GoInt):GoString return __self__.value._printNode(_t, _depth);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
@:keep @:allow(stdgo.strings.Strings.T_genericReplacer_asInterface) class T_genericReplacer_static_extension {
    ...
    static public function writeString( _r:Ref<T_genericReplacer>, _w:stdgo.io.Io.Writer, _s:GoString):{ var _0 : GoInt; var _1 : Error; } {
        ...
        var _0:GoInt = (0 : GoInt), _1:GoInt = (0 : GoInt), _wn:GoInt = _1, _last:GoInt = _0;
        var _prevMatchEmpty:Bool = false;
        {
            ...
            while (_i <= (_s.length)) {
                if ((_i != (_s.length)) && (_r._root._priority == (0 : GoInt))) {
                    ...
                    if ((_index == _r._tableSize) || (_r._root._table[(_index : GoInt)] == null)) {
                        _i++;
                        continue;
                    };
                };
    ...
    static public function _printNode( _r:Ref<T_genericReplacer>, _t:Ref<T_trieNode>, _depth:GoInt):GoString {
        ...
        if (_t._prefix != (Go.str())) {
            ...
            for (_b => _m in _r._mapping) {
                if (((_m : GoInt) != _r._tableSize) && (_t._table[(_m : GoInt)] != null)) {
...
@:keep @:allow(stdgo.strings.Strings.T_singleStringReplacer_asInterface) class T_singleStringReplacer_static_extension {
    ...
    static public function writeString( _r:Ref<T_singleStringReplacer>, _w:stdgo.io.Io.Writer, _s:GoString):{ var _0 : GoInt; var _1 : Error; } {
        var _n:GoInt = (0 : GoInt), _err:Error = (null : Error);
        var _sw:stdgo.io.Io.StringWriter = _getStringWriter(_w);
        var _0:GoInt = (0 : GoInt), _1:GoInt = (0 : GoInt), _wn:GoInt = _1, _i:GoInt = _0;
        while (true) {
    ...
    static public function replace( _r:Ref<T_singleStringReplacer>, _s:GoString):GoString {
        ...
        var _0:GoInt = (0 : GoInt), _1:Bool = false, _matched:Bool = _1, _i:GoInt = _0;
        while (true) {
            var _match:GoInt = _r._finder._next((_s.__slice__(_i) : GoString));
            if (_match == ((-1 : GoInt))) {
                break;
...
class T_stringFinder_asInterface {
    ...
    **/
    @:keep
    public function _next(_text:GoString):GoInt return __self__.value._next(_text);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
@:keep @:allow(stdgo.strings.Strings.T_appendSliceWriter_asInterface) class T_appendSliceWriter_static_extension {
    ...
    **/
    ...
    static public function writeString( _w:Ref<T_appendSliceWriter>, _s:GoString):{ var _0 : GoInt; var _1 : Error; } {
        _w.__setData__(_w.__appendref__(..._s.__toArray__()));
        return { _0 : (_s.length), _1 : (null : Error) };
    }
    /**
        // Write writes to the buffer to satisfy io.Writer.
    **/
    ...
    static public function write( _w:Ref<T_appendSliceWriter>, _p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } {
        _w.__setData__(_w.__appendref__(..._p.__toArray__()));
        return { _0 : (_p.length), _1 : (null : Error) };
    }
}
