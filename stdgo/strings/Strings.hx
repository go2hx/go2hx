...
/**
    /|*{
    	...
    	gotoNext = 2776096
    	_ = gotoNext == 2776096
    	if i_2776088 < len(s) && i_2776088 < len(t) {
    		gotoNext = 2776132
    		_ = gotoNext == 2776132
    		sr_2776136 = s[i_2776088]
    		tr_2776149 = t[i_2776088]
    		if sr_2776136|tr_2776149 >= 128 {
    			gotoNext = 2776188
    			_ = gotoNext == 2776188
    			gotoNext = 2776546
    			gotoNext = 2776232
    		...
    		if tr_2776149 < sr_2776136 {
    			gotoNext = 2776320
    			_ = gotoNext == 2776320
    			tr_2776149, sr_2776136 = sr_2776136, tr_2776149
    			gotoNext = 2776395
    		} else {
    			gotoNext = 2776395
    		}
    		_ = gotoNext == 2776395
    		if 65 <= sr_2776136 && sr_2776136 <= 90 && tr_2776149 == sr_2776136+97-65 {
    			gotoNext = 2776441
    			_ = gotoNext == 2776441
    			i_2776088++
    			gotoNext = 2776096
    	...
    	for key, value := range s {
    		keys_2776581 = append(keys_2776581, key)
    		values_2776581 = append(values_2776581, value)
    	}
    	if 0 < len(keys_2776581) {
    		gotoNext = 2777512
    		_ = gotoNext == 2777512
    		i_2776594 = 0
    		gotoNext = 2777513
    		_ = gotoNext == 2777513
    		if i_2776594 < len(keys_2776581) {
    			gotoNext = 2776602
    			_ = gotoNext == 2776602
    			sr_2776588 = values_2776581[i_2776594]
    			_ = keys_2776581[i_2776594]
    			if len(t) == 0 {
    				gotoNext = 2776671
    				_ = gotoNext == 2776671
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 2776818
    				_ = gotoNext == 2776818
    				r_2776823, size_2776826 = utf8.DecodeRuneInString(t)
    				tr_2776744, t = r_2776823, t[size_2776826:]
    				_ = 0
    				gotoNext = 2776962
    			}
    			_ = gotoNext == 2776962
    			if tr_2776744 == sr_2776588 {
    				gotoNext = 2776974
    				_ = gotoNext == 2776974
    				i_2776594++
    				gotoNext = 2777513
    			...
    			if tr_2776744 < sr_2776588 {
    				gotoNext = 2777050
    				_ = gotoNext == 2777050
    				tr_2776744, sr_2776588 = sr_2776588, tr_2776744
    				gotoNext = 2777104
    			} else {
    				gotoNext = 2777104
    			}
    			...
    			if tr_2776744 < 128 {
    				gotoNext = 2777126
    				_ = gotoNext == 2777126
    				if 65 <= sr_2776588 && sr_2776588 <= 90 && tr_2776744 == sr_2776588+97-65 {
    					gotoNext = 2777226
    					_ = gotoNext == 2777226
    					i_2776594++
    					gotoNext = 2777513
    			...
    			_ = gotoNext == 2777379
    			r_2777379 = unicode.SimpleFold(sr_2776588)
    			_ = 0
    			gotoNext = 2777409
    			_ = gotoNext == 2777409
    			if r_2777379 != sr_2776588 && r_2777379 < tr_2776744 {
    				gotoNext = 2777431
    				_ = gotoNext == 2777431
    				r_2777379 = unicode.SimpleFold(r_2777379)
    				gotoNext = 2777409
    			} else {
    				gotoNext = 2777468
    			}
    			_ = gotoNext == 2777468
    			if r_2777379 == tr_2776744 {
    				gotoNext = 2777479
    				_ = gotoNext == 2777479
    				i_2776594++
    				gotoNext = 2777513
