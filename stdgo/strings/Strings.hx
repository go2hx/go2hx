...
/**
    /|*{
    	...
    	gotoNext = 3030757
    	_ = gotoNext == 3030757
    	if i_3030749 < len(s) && i_3030749 < len(t) {
    		gotoNext = 3030793
    		_ = gotoNext == 3030793
    		sr_3030797 = s[i_3030749]
    		tr_3030810 = t[i_3030749]
    		if sr_3030797|tr_3030810 >= 128 {
    			gotoNext = 3030849
    			_ = gotoNext == 3030849
    			gotoNext = 3031207
    			gotoNext = 3030893
    		...
    		if tr_3030810 < sr_3030797 {
    			gotoNext = 3030981
    			_ = gotoNext == 3030981
    			tr_3030810, sr_3030797 = sr_3030797, tr_3030810
    			gotoNext = 3031056
    		} else {
    			gotoNext = 3031056
    		}
    		_ = gotoNext == 3031056
    		if 65 <= sr_3030797 && sr_3030797 <= 90 && tr_3030810 == sr_3030797+97-65 {
    			gotoNext = 3031102
    			_ = gotoNext == 3031102
    			i_3030749++
    			gotoNext = 3030757
    	...
    	for key, value := range s {
    		keys_3031242 = append(keys_3031242, key)
    		values_3031242 = append(values_3031242, value)
    	}
    	if 0 < len(keys_3031242) {
    		gotoNext = 3032173
    		_ = gotoNext == 3032173
    		i_3031255 = 0
    		gotoNext = 3032174
    		_ = gotoNext == 3032174
    		if i_3031255 < len(keys_3031242) {
    			gotoNext = 3031263
    			_ = gotoNext == 3031263
    			sr_3031249 = values_3031242[i_3031255]
    			_ = keys_3031242[i_3031255]
    			if len(t) == 0 {
    				gotoNext = 3031332
    				_ = gotoNext == 3031332
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 3031479
    				_ = gotoNext == 3031479
    				r_3031484, size_3031487 = utf8.DecodeRuneInString(t)
    				tr_3031405, t = r_3031484, t[size_3031487:]
    				_ = 0
    				gotoNext = 3031623
    			}
    			_ = gotoNext == 3031623
    			if tr_3031405 == sr_3031249 {
    				gotoNext = 3031635
    				_ = gotoNext == 3031635
    				i_3031255++
    				gotoNext = 3032174
    			...
    			if tr_3031405 < sr_3031249 {
    				gotoNext = 3031711
    				_ = gotoNext == 3031711
    				tr_3031405, sr_3031249 = sr_3031249, tr_3031405
    				gotoNext = 3031765
    			} else {
    				gotoNext = 3031765
    			}
    			...
    			if tr_3031405 < 128 {
    				gotoNext = 3031787
    				_ = gotoNext == 3031787
    				if 65 <= sr_3031249 && sr_3031249 <= 90 && tr_3031405 == sr_3031249+97-65 {
    					gotoNext = 3031887
    					_ = gotoNext == 3031887
    					i_3031255++
    					gotoNext = 3032174
    			...
    			_ = gotoNext == 3032040
    			r_3032040 = unicode.SimpleFold(sr_3031249)
    			_ = 0
    			gotoNext = 3032070
    			_ = gotoNext == 3032070
    			if r_3032040 != sr_3031249 && r_3032040 < tr_3031405 {
    				gotoNext = 3032092
    				_ = gotoNext == 3032092
    				r_3032040 = unicode.SimpleFold(r_3032040)
    				gotoNext = 3032070
    			} else {
    				gotoNext = 3032129
    			}
    			_ = gotoNext == 3032129
    			if r_3032040 == tr_3031405 {
    				gotoNext = 3032140
    				_ = gotoNext == 3032140
    				i_3031255++
    				gotoNext = 3032174
