...
/**
    /|*{
    	...
    	gotoNext = 2888585
    	_ = gotoNext == 2888585
    	if i_2888577 < len(s) && i_2888577 < len(t) {
    		gotoNext = 2888621
    		_ = gotoNext == 2888621
    		sr_2888625 = s[i_2888577]
    		tr_2888638 = t[i_2888577]
    		if sr_2888625|tr_2888638 >= 128 {
    			gotoNext = 2888677
    			_ = gotoNext == 2888677
    			gotoNext = 2889035
    			gotoNext = 2888721
    		...
    		if tr_2888638 < sr_2888625 {
    			gotoNext = 2888809
    			_ = gotoNext == 2888809
    			tr_2888638, sr_2888625 = sr_2888625, tr_2888638
    			gotoNext = 2888884
    		} else {
    			gotoNext = 2888884
    		}
    		_ = gotoNext == 2888884
    		if 65 <= sr_2888625 && sr_2888625 <= 90 && tr_2888638 == sr_2888625+97-65 {
    			gotoNext = 2888930
    			_ = gotoNext == 2888930
    			i_2888577++
    			gotoNext = 2888585
    	...
    	for key, value := range s {
    		keys_2889070 = append(keys_2889070, key)
    		values_2889070 = append(values_2889070, value)
    	}
    	if 0 < len(keys_2889070) {
    		gotoNext = 2890001
    		_ = gotoNext == 2890001
    		i_2889083 = 0
    		gotoNext = 2890002
    		_ = gotoNext == 2890002
    		if i_2889083 < len(keys_2889070) {
    			gotoNext = 2889091
    			_ = gotoNext == 2889091
    			sr_2889077 = values_2889070[i_2889083]
    			_ = keys_2889070[i_2889083]
    			if len(t) == 0 {
    				gotoNext = 2889160
    				_ = gotoNext == 2889160
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 2889307
    				_ = gotoNext == 2889307
    				r_2889312, size_2889315 = utf8.DecodeRuneInString(t)
    				tr_2889233, t = r_2889312, t[size_2889315:]
    				_ = 0
    				gotoNext = 2889451
    			}
    			_ = gotoNext == 2889451
    			if tr_2889233 == sr_2889077 {
    				gotoNext = 2889463
    				_ = gotoNext == 2889463
    				i_2889083++
    				gotoNext = 2890002
    			...
    			if tr_2889233 < sr_2889077 {
    				gotoNext = 2889539
    				_ = gotoNext == 2889539
    				tr_2889233, sr_2889077 = sr_2889077, tr_2889233
    				gotoNext = 2889593
    			} else {
    				gotoNext = 2889593
    			}
    			...
    			if tr_2889233 < 128 {
    				gotoNext = 2889615
    				_ = gotoNext == 2889615
    				if 65 <= sr_2889077 && sr_2889077 <= 90 && tr_2889233 == sr_2889077+97-65 {
    					gotoNext = 2889715
    					_ = gotoNext == 2889715
    					i_2889083++
    					gotoNext = 2890002
    			...
    			_ = gotoNext == 2889868
    			r_2889868 = unicode.SimpleFold(sr_2889077)
    			_ = 0
    			gotoNext = 2889898
    			_ = gotoNext == 2889898
    			if r_2889868 != sr_2889077 && r_2889868 < tr_2889233 {
    				gotoNext = 2889920
    				_ = gotoNext == 2889920
    				r_2889868 = unicode.SimpleFold(r_2889868)
    				gotoNext = 2889898
    			} else {
    				gotoNext = 2889957
    			}
    			_ = gotoNext == 2889957
    			if r_2889868 == tr_2889233 {
    				gotoNext = 2889968
    				_ = gotoNext == 2889968
    				i_2889083++
    				gotoNext = 2890002
