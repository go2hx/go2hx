...
/**
    /|*{
    	...
    	gotoNext = 2934888
    	_ = gotoNext == 2934888
    	if i_2934880 < len(s) && i_2934880 < len(t) {
    		gotoNext = 2934924
    		_ = gotoNext == 2934924
    		sr_2934928 = s[i_2934880]
    		tr_2934941 = t[i_2934880]
    		if sr_2934928|tr_2934941 >= 128 {
    			gotoNext = 2934980
    			_ = gotoNext == 2934980
    			gotoNext = 2935338
    			gotoNext = 2935024
    		...
    		if tr_2934941 < sr_2934928 {
    			gotoNext = 2935112
    			_ = gotoNext == 2935112
    			tr_2934941, sr_2934928 = sr_2934928, tr_2934941
    			gotoNext = 2935187
    		} else {
    			gotoNext = 2935187
    		}
    		_ = gotoNext == 2935187
    		if 65 <= sr_2934928 && sr_2934928 <= 90 && tr_2934941 == sr_2934928+97-65 {
    			gotoNext = 2935233
    			_ = gotoNext == 2935233
    			i_2934880++
    			gotoNext = 2934888
    	...
    	for key, value := range s {
    		keys_2935373 = append(keys_2935373, key)
    		values_2935373 = append(values_2935373, value)
    	}
    	if 0 < len(keys_2935373) {
    		gotoNext = 2936304
    		_ = gotoNext == 2936304
    		i_2935386 = 0
    		gotoNext = 2936305
    		_ = gotoNext == 2936305
    		if i_2935386 < len(keys_2935373) {
    			gotoNext = 2935394
    			_ = gotoNext == 2935394
    			sr_2935380 = values_2935373[i_2935386]
    			_ = keys_2935373[i_2935386]
    			if len(t) == 0 {
    				gotoNext = 2935463
    				_ = gotoNext == 2935463
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 2935610
    				_ = gotoNext == 2935610
    				r_2935615, size_2935618 = utf8.DecodeRuneInString(t)
    				tr_2935536, t = r_2935615, t[size_2935618:]
    				_ = 0
    				gotoNext = 2935754
    			}
    			_ = gotoNext == 2935754
    			if tr_2935536 == sr_2935380 {
    				gotoNext = 2935766
    				_ = gotoNext == 2935766
    				i_2935386++
    				gotoNext = 2936305
    			...
    			if tr_2935536 < sr_2935380 {
    				gotoNext = 2935842
    				_ = gotoNext == 2935842
    				tr_2935536, sr_2935380 = sr_2935380, tr_2935536
    				gotoNext = 2935896
    			} else {
    				gotoNext = 2935896
    			}
    			...
    			if tr_2935536 < 128 {
    				gotoNext = 2935918
    				_ = gotoNext == 2935918
    				if 65 <= sr_2935380 && sr_2935380 <= 90 && tr_2935536 == sr_2935380+97-65 {
    					gotoNext = 2936018
    					_ = gotoNext == 2936018
    					i_2935386++
    					gotoNext = 2936305
    			...
    			_ = gotoNext == 2936171
    			r_2936171 = unicode.SimpleFold(sr_2935380)
    			_ = 0
    			gotoNext = 2936201
    			_ = gotoNext == 2936201
    			if r_2936171 != sr_2935380 && r_2936171 < tr_2935536 {
    				gotoNext = 2936223
    				_ = gotoNext == 2936223
    				r_2936171 = unicode.SimpleFold(r_2936171)
    				gotoNext = 2936201
    			} else {
    				gotoNext = 2936260
    			}
    			_ = gotoNext == 2936260
    			if r_2936171 == tr_2935536 {
    				gotoNext = 2936271
    				_ = gotoNext == 2936271
    				i_2935386++
    				gotoNext = 2936305
