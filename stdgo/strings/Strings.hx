...
/**
    /|*{
    	...
    	gotoNext = 2979819
    	_ = gotoNext == 2979819
    	if i_2979811 < len(s) && i_2979811 < len(t) {
    		gotoNext = 2979855
    		_ = gotoNext == 2979855
    		sr_2979859 = s[i_2979811]
    		tr_2979872 = t[i_2979811]
    		if sr_2979859|tr_2979872 >= 128 {
    			gotoNext = 2979911
    			_ = gotoNext == 2979911
    			gotoNext = 2980269
    			gotoNext = 2979955
    		...
    		if tr_2979872 < sr_2979859 {
    			gotoNext = 2980043
    			_ = gotoNext == 2980043
    			tr_2979872, sr_2979859 = sr_2979859, tr_2979872
    			gotoNext = 2980118
    		} else {
    			gotoNext = 2980118
    		}
    		_ = gotoNext == 2980118
    		if 65 <= sr_2979859 && sr_2979859 <= 90 && tr_2979872 == sr_2979859+97-65 {
    			gotoNext = 2980164
    			_ = gotoNext == 2980164
    			i_2979811++
    			gotoNext = 2979819
    	...
    	for key, value := range s {
    		keys_2980304 = append(keys_2980304, key)
    		values_2980304 = append(values_2980304, value)
    	}
    	if 0 < len(keys_2980304) {
    		gotoNext = 2981235
    		_ = gotoNext == 2981235
    		i_2980317 = 0
    		gotoNext = 2981236
    		_ = gotoNext == 2981236
    		if i_2980317 < len(keys_2980304) {
    			gotoNext = 2980325
    			_ = gotoNext == 2980325
    			sr_2980311 = values_2980304[i_2980317]
    			_ = keys_2980304[i_2980317]
    			if len(t) == 0 {
    				gotoNext = 2980394
    				_ = gotoNext == 2980394
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 2980541
    				_ = gotoNext == 2980541
    				r_2980546, size_2980549 = utf8.DecodeRuneInString(t)
    				tr_2980467, t = r_2980546, t[size_2980549:]
    				_ = 0
    				gotoNext = 2980685
    			}
    			_ = gotoNext == 2980685
    			if tr_2980467 == sr_2980311 {
    				gotoNext = 2980697
    				_ = gotoNext == 2980697
    				i_2980317++
    				gotoNext = 2981236
    			...
    			if tr_2980467 < sr_2980311 {
    				gotoNext = 2980773
    				_ = gotoNext == 2980773
    				tr_2980467, sr_2980311 = sr_2980311, tr_2980467
    				gotoNext = 2980827
    			} else {
    				gotoNext = 2980827
    			}
    			...
    			if tr_2980467 < 128 {
    				gotoNext = 2980849
    				_ = gotoNext == 2980849
    				if 65 <= sr_2980311 && sr_2980311 <= 90 && tr_2980467 == sr_2980311+97-65 {
    					gotoNext = 2980949
    					_ = gotoNext == 2980949
    					i_2980317++
    					gotoNext = 2981236
    			...
    			_ = gotoNext == 2981102
    			r_2981102 = unicode.SimpleFold(sr_2980311)
    			_ = 0
    			gotoNext = 2981132
    			_ = gotoNext == 2981132
    			if r_2981102 != sr_2980311 && r_2981102 < tr_2980467 {
    				gotoNext = 2981154
    				_ = gotoNext == 2981154
    				r_2981102 = unicode.SimpleFold(r_2981102)
    				gotoNext = 2981132
    			} else {
    				gotoNext = 2981191
    			}
    			_ = gotoNext == 2981191
    			if r_2981102 == tr_2980467 {
    				gotoNext = 2981202
    				_ = gotoNext == 2981202
    				i_2980317++
    				gotoNext = 2981236
