...
/**
    /|*{
    	...
    	gotoNext = 2774895
    	_ = gotoNext == 2774895
    	if i_2774887 < len(s) && i_2774887 < len(t) {
    		gotoNext = 2774931
    		_ = gotoNext == 2774931
    		sr_2774935 = s[i_2774887]
    		tr_2774948 = t[i_2774887]
    		if sr_2774935|tr_2774948 >= 128 {
    			gotoNext = 2774987
    			_ = gotoNext == 2774987
    			gotoNext = 2775345
    			gotoNext = 2775031
    		...
    		if tr_2774948 < sr_2774935 {
    			gotoNext = 2775119
    			_ = gotoNext == 2775119
    			tr_2774948, sr_2774935 = sr_2774935, tr_2774948
    			gotoNext = 2775194
    		} else {
    			gotoNext = 2775194
    		}
    		_ = gotoNext == 2775194
    		if 65 <= sr_2774935 && sr_2774935 <= 90 && tr_2774948 == sr_2774935+97-65 {
    			gotoNext = 2775240
    			_ = gotoNext == 2775240
    			i_2774887++
    			gotoNext = 2774895
    	...
    	for key, value := range s {
    		keys_2775380 = append(keys_2775380, key)
    		values_2775380 = append(values_2775380, value)
    	}
    	if 0 < len(keys_2775380) {
    		gotoNext = 2776311
    		_ = gotoNext == 2776311
    		i_2775393 = 0
    		gotoNext = 2776312
    		_ = gotoNext == 2776312
    		if i_2775393 < len(keys_2775380) {
    			gotoNext = 2775401
    			_ = gotoNext == 2775401
    			sr_2775387 = values_2775380[i_2775393]
    			_ = keys_2775380[i_2775393]
    			if len(t) == 0 {
    				gotoNext = 2775470
    				_ = gotoNext == 2775470
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 2775617
    				_ = gotoNext == 2775617
    				r_2775622, size_2775625 = utf8.DecodeRuneInString(t)
    				tr_2775543, t = r_2775622, t[size_2775625:]
    				_ = 0
    				gotoNext = 2775761
    			}
    			_ = gotoNext == 2775761
    			if tr_2775543 == sr_2775387 {
    				gotoNext = 2775773
    				_ = gotoNext == 2775773
    				i_2775393++
    				gotoNext = 2776312
    			...
    			if tr_2775543 < sr_2775387 {
    				gotoNext = 2775849
    				_ = gotoNext == 2775849
    				tr_2775543, sr_2775387 = sr_2775387, tr_2775543
    				gotoNext = 2775903
    			} else {
    				gotoNext = 2775903
    			}
    			...
    			if tr_2775543 < 128 {
    				gotoNext = 2775925
    				_ = gotoNext == 2775925
    				if 65 <= sr_2775387 && sr_2775387 <= 90 && tr_2775543 == sr_2775387+97-65 {
    					gotoNext = 2776025
    					_ = gotoNext == 2776025
    					i_2775393++
    					gotoNext = 2776312
    			...
    			_ = gotoNext == 2776178
    			r_2776178 = unicode.SimpleFold(sr_2775387)
    			_ = 0
    			gotoNext = 2776208
    			_ = gotoNext == 2776208
    			if r_2776178 != sr_2775387 && r_2776178 < tr_2775543 {
    				gotoNext = 2776230
    				_ = gotoNext == 2776230
    				r_2776178 = unicode.SimpleFold(r_2776178)
    				gotoNext = 2776208
    			} else {
    				gotoNext = 2776267
    			}
    			_ = gotoNext == 2776267
    			if r_2776178 == tr_2775543 {
    				gotoNext = 2776278
    				_ = gotoNext == 2776278
    				i_2775393++
    				gotoNext = 2776312
