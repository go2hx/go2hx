...
/**
    /|*{
    	...
    	gotoNext = 2758905
    	_ = gotoNext == 2758905
    	if i_2758897 < len(s) && i_2758897 < len(t) {
    		gotoNext = 2758941
    		_ = gotoNext == 2758941
    		sr_2758945 = s[i_2758897]
    		tr_2758958 = t[i_2758897]
    		if sr_2758945|tr_2758958 >= 128 {
    			gotoNext = 2758997
    			_ = gotoNext == 2758997
    			gotoNext = 2759355
    			gotoNext = 2759041
    		...
    		if tr_2758958 < sr_2758945 {
    			gotoNext = 2759129
    			_ = gotoNext == 2759129
    			tr_2758958, sr_2758945 = sr_2758945, tr_2758958
    			gotoNext = 2759204
    		} else {
    			gotoNext = 2759204
    		}
    		_ = gotoNext == 2759204
    		if 65 <= sr_2758945 && sr_2758945 <= 90 && tr_2758958 == sr_2758945+97-65 {
    			gotoNext = 2759250
    			_ = gotoNext == 2759250
    			i_2758897++
    			gotoNext = 2758905
    	...
    	for key, value := range s {
    		keys_2759390 = append(keys_2759390, key)
    		values_2759390 = append(values_2759390, value)
    	}
    	if 0 < len(keys_2759390) {
    		gotoNext = 2760321
    		_ = gotoNext == 2760321
    		i_2759403 = 0
    		gotoNext = 2760322
    		_ = gotoNext == 2760322
    		if i_2759403 < len(keys_2759390) {
    			gotoNext = 2759411
    			_ = gotoNext == 2759411
    			sr_2759397 = values_2759390[i_2759403]
    			_ = keys_2759390[i_2759403]
    			if len(t) == 0 {
    				gotoNext = 2759480
    				_ = gotoNext == 2759480
    				return false
    			...
    			if t[0] < 128 {
    				...
    				gotoNext = 2759627
    				_ = gotoNext == 2759627
    				r_2759632, size_2759635 = utf8.DecodeRuneInString(t)
    				tr_2759553, t = r_2759632, t[size_2759635:]
    				_ = 0
    				gotoNext = 2759771
    			}
    			_ = gotoNext == 2759771
    			if tr_2759553 == sr_2759397 {
    				gotoNext = 2759783
    				_ = gotoNext == 2759783
    				i_2759403++
    				gotoNext = 2760322
    			...
    			if tr_2759553 < sr_2759397 {
    				gotoNext = 2759859
    				_ = gotoNext == 2759859
    				tr_2759553, sr_2759397 = sr_2759397, tr_2759553
    				gotoNext = 2759913
    			} else {
    				gotoNext = 2759913
    			}
    			...
    			if tr_2759553 < 128 {
    				gotoNext = 2759935
    				_ = gotoNext == 2759935
    				if 65 <= sr_2759397 && sr_2759397 <= 90 && tr_2759553 == sr_2759397+97-65 {
    					gotoNext = 2760035
    					_ = gotoNext == 2760035
    					i_2759403++
    					gotoNext = 2760322
    			...
    			_ = gotoNext == 2760188
    			r_2760188 = unicode.SimpleFold(sr_2759397)
    			_ = 0
    			gotoNext = 2760218
    			_ = gotoNext == 2760218
    			if r_2760188 != sr_2759397 && r_2760188 < tr_2759553 {
    				gotoNext = 2760240
    				_ = gotoNext == 2760240
    				r_2760188 = unicode.SimpleFold(r_2760188)
    				gotoNext = 2760218
    			} else {
    				gotoNext = 2760277
    			}
    			_ = gotoNext == 2760277
    			if r_2760188 == tr_2759553 {
    				gotoNext = 2760288
    				_ = gotoNext == 2760288
    				i_2759403++
    				gotoNext = 2760322
