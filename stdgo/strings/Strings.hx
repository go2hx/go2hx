...
/**
    /|*{
    	...
    	gotoNext = 2748685
    	_ = gotoNext == 2748685
    	if i_2748677 < len(s) && i_2748677 < len(t) {
    		gotoNext = 2748721
    		_ = gotoNext == 2748721
    		sr_2748725 = s[i_2748677]
    		tr_2748738 = t[i_2748677]
    		if sr_2748725|tr_2748738 >= 128 {
    			gotoNext = 2748777
    			_ = gotoNext == 2748777
    			gotoNext = 2749135
    			gotoNext = 2748821
    		...
    		if tr_2748738 < sr_2748725 {
    			gotoNext = 2748909
    			_ = gotoNext == 2748909
    			tr_2748738, sr_2748725 = sr_2748725, tr_2748738
    			gotoNext = 2748984
    		} else {
    			gotoNext = 2748984
    		}
    		_ = gotoNext == 2748984
    		if 65 <= sr_2748725 && sr_2748725 <= 90 && tr_2748738 == sr_2748725+97-65 {
    			gotoNext = 2749030
    			_ = gotoNext == 2749030
    			i_2748677++
    			gotoNext = 2748685
    	...
    	for key, value := range s {
    		keys_2749170 = append(keys_2749170, key)
    		values_2749170 = append(values_2749170, value)
    	}
    	if 0 < len(keys_2749170) {
    		gotoNext = 2750101
    		_ = gotoNext == 2750101
    		i_2749183 = 0
    		gotoNext = 2750102
    		_ = gotoNext == 2750102
    		if i_2749183 < len(keys_2749170) {
    			gotoNext = 2749191
    			_ = gotoNext == 2749191
    			sr_2749177 = values_2749170[i_2749183]
    			_ = keys_2749170[i_2749183]
    			if len(t) == 0 {
    				gotoNext = 2749260
    				_ = gotoNext == 2749260
    				return false
    			...
    			if t[0] < 128 {
    				gotoNext = 2749367
    				_ = gotoNext == 2749367
    				tr_2749333, t = rune(t[0]), t[1:]
    				gotoNext = 2749551
    			} else {
    				gotoNext = 2749407
    				_ = gotoNext == 2749407
    				r_2749412, size_2749415 = utf8.DecodeRuneInString(t)
    				tr_2749333, t = r_2749412, t[size_2749415:]
    				gotoNext = 2749551
    			}
    			_ = gotoNext == 2749551
    			if tr_2749333 == sr_2749177 {
    				gotoNext = 2749563
    				_ = gotoNext == 2749563
    				i_2749183++
    				gotoNext = 2750102
    			...
    			if tr_2749333 < sr_2749177 {
    				gotoNext = 2749639
    				_ = gotoNext == 2749639
    				tr_2749333, sr_2749177 = sr_2749177, tr_2749333
    				gotoNext = 2749693
    			} else {
    				gotoNext = 2749693
    			}
    			...
    			if tr_2749333 < 128 {
    				gotoNext = 2749715
    				_ = gotoNext == 2749715
    				if 65 <= sr_2749177 && sr_2749177 <= 90 && tr_2749333 == sr_2749177+97-65 {
    					gotoNext = 2749815
    					_ = gotoNext == 2749815
    					i_2749183++
    					gotoNext = 2750102
    			...
    			_ = gotoNext == 2749968
    			r_2749968 = unicode.SimpleFold(sr_2749177)
    			_ = 0
    			gotoNext = 2749998
    			_ = gotoNext == 2749998
    			if r_2749968 != sr_2749177 && r_2749968 < tr_2749333 {
    				gotoNext = 2750020
    				_ = gotoNext == 2750020
    				r_2749968 = unicode.SimpleFold(r_2749968)
    				gotoNext = 2749998
    			} else {
    				gotoNext = 2750057
    			}
    			_ = gotoNext == 2750057
    			if r_2749968 == tr_2749333 {
    				gotoNext = 2750068
    				_ = gotoNext == 2750068
    				i_2749183++
    				gotoNext = 2750102
