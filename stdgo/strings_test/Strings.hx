...
private var _tests:Slice<stdgo.testing.Testing.InternalTest> = (new Slice<stdgo.testing.Testing.InternalTest>(0, 0,
	...
	(new stdgo.testing.Testing.InternalTest(("TestCompareIdenticalString" : GoString),
		stdgo.strings_test.Strings_test.testCompareIdenticalString) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestCompareStrings" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestReaderReset" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestIndexRandom" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestSplitAfter" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestFieldsFunc" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestToValidUTF8" : GoString),
		stdgo.strings_test.Strings_test.testToValidUTF8) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestSpecialCase" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestCaseConsistency" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestContainsAny" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestCut" : GoString),
...
private var _benchmarks:Slice<stdgo.testing.Testing.InternalBenchmark> = (new Slice<stdgo.testing.Testing.InternalBenchmark>(0, 0,
	...
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkIndexRuneLongString" : GoString),
		stdgo.strings_test.Strings_test.benchmarkIndexRuneLongString) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkIndexRuneFastPath" : GoString),
	...
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkLastIndex" : GoString),
	...
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkMapNoChanges" : GoString),
		stdgo.strings_test.Strings_test.benchmarkMapNoChanges) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkTrim" : GoString),
	...
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkEqualFold" : GoString),
	...
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkIndexTorture" : GoString),
		stdgo.strings_test.Strings_test.benchmarkIndexTorture) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkCountTorture" : GoString),
		stdgo.strings_test.Strings_test.benchmarkCountTorture) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkCountTortureOverlapping" : GoString),
		stdgo.strings_test.Strings_test.benchmarkCountTortureOverlapping) : stdgo.testing.Testing.InternalBenchmark),
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkCountByte" : GoString),
	...
	(new stdgo.testing.Testing.InternalBenchmark(("BenchmarkJoin" : GoString),
...
private var _examples:Slice<stdgo.testing.Testing.InternalExample> = (new Slice<stdgo.testing.Testing.InternalExample>(0, 0,
	(new stdgo.testing.Testing.InternalExample(("ExampleBuilder" : GoString), stdgo.strings_test.Strings_test.exampleBuilder,
	...
	(new stdgo.testing.Testing.InternalExample(("ExampleContains" : GoString), stdgo.strings_test.Strings_test.exampleContains,
		("true\nfalse\ntrue\ntrue\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleContainsAny" : GoString), stdgo.strings_test.Strings_test.exampleContainsAny,
		("false\ntrue\ntrue\ntrue\nfalse\nfalse\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleContainsRune" : GoString), stdgo.strings_test.Strings_test.exampleContainsRune,
		("true\nfalse\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleCount" : GoString), stdgo.strings_test.Strings_test.exampleCount, ("3\n5\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleCut" : GoString), stdgo.strings_test.Strings_test.exampleCut,
		("Cut(\"Gopher\", \"Go\") = \"\", \"pher\", true\nCut(\"Gopher\", \"ph\") = \"Go\", \"er\", true\nCut(\"Gopher\", \"er\") = \"Goph\", \"\", true\nCut(\"Gopher\", \"Badger\") = \"Gopher\", \"\", false\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleEqualFold" : GoString), stdgo.strings_test.Strings_test.exampleEqualFold,
		("true\ntrue\nfalse\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleFields" : GoString), stdgo.strings_test.Strings_test.exampleFields,
		("Fields are: [\"foo\" \"bar\" \"baz\"]\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleFieldsFunc" : GoString), stdgo.strings_test.Strings_test.exampleFieldsFunc,
		("Fields are: [\"foo1\" \"bar2\" \"baz3\"]\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleHasPrefix" : GoString), stdgo.strings_test.Strings_test.exampleHasPrefix,
		("true\nfalse\ntrue\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleHasSuffix" : GoString), stdgo.strings_test.Strings_test.exampleHasSuffix,
		("true\nfalse\nfalse\ntrue\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	...
	(new stdgo.testing.Testing.InternalExample(("ExampleLastIndex" : GoString), stdgo.strings_test.Strings_test.exampleLastIndex, ("0\n3\n-1\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleLastIndexAny" : GoString), stdgo.strings_test.Strings_test.exampleLastIndexAny,
		("4\n8\n-1\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleLastIndexByte" : GoString), stdgo.strings_test.Strings_test.exampleLastIndexByte,
		("10\n8\n-1\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleLastIndexFunc" : GoString), stdgo.strings_test.Strings_test.exampleLastIndexFunc,
		("5\n2\n-1\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	...
	(new stdgo.testing.Testing.InternalExample(("ExampleRepeat" : GoString), stdgo.strings_test.Strings_test.exampleRepeat, ("banana\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleReplace" : GoString), stdgo.strings_test.Strings_test.exampleReplace,
		("oinky oinky oink\nmoo moo moo\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleReplaceAll" : GoString), stdgo.strings_test.Strings_test.exampleReplaceAll,
		("moo moo moo\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleSplit" : GoString), stdgo.strings_test.Strings_test.exampleSplit,
		("[\"a\" \"b\" \"c\"]\n[\"\" \"man \" \"plan \" \"canal panama\"]\n[\" \" \"x\" \"y\" \"z\" \" \"]\n[\"\"]\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleSplitN" : GoString), stdgo.strings_test.Strings_test.exampleSplitN,
		("[\"a\" \"b,c\"]\n[] (nil = true)\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleSplitAfter" : GoString), stdgo.strings_test.Strings_test.exampleSplitAfter,
		("[\"a,\" \"b,\" \"c\"]\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleSplitAfterN" : GoString), stdgo.strings_test.Strings_test.exampleSplitAfterN,
		("[\"a,\" \"b,c\"]\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleTitle" : GoString), stdgo.strings_test.Strings_test.exampleTitle,
		("Her Royal Highness\nLoud Noises\nХлеб\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleToTitle" : GoString), stdgo.strings_test.Strings_test.exampleToTitle,
		("HER ROYAL HIGHNESS\nLOUD NOISES\nХЛЕБ\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleToTitleSpecial" : GoString), stdgo.strings_test.Strings_test.exampleToTitleSpecial,
		("DÜNYANIN İLK BORSA YAPISI AİZONAİ KABUL EDİLİR\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleMap" : GoString), stdgo.strings_test.Strings_test.exampleMap,
		("\'Gjnf oevyyvt naq gur fyvgul tbcure...\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleNewReplacer" : GoString), stdgo.strings_test.Strings_test.exampleNewReplacer,
		("This is &lt;b&gt;HTML&lt;/b&gt;!\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleToUpper" : GoString), stdgo.strings_test.Strings_test.exampleToUpper, ("GOPHER\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleToUpperSpecial" : GoString), stdgo.strings_test.Strings_test.exampleToUpperSpecial,
		("ÖRNEK İŞ\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleToLower" : GoString), stdgo.strings_test.Strings_test.exampleToLower, ("gopher\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleToLowerSpecial" : GoString), stdgo.strings_test.Strings_test.exampleToLowerSpecial,
		("önnek iş\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleTrim" : GoString), stdgo.strings_test.Strings_test.exampleTrim, ("Hello, Gophers\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleTrimSpace" : GoString), stdgo.strings_test.Strings_test.exampleTrimSpace,
		("Hello, Gophers\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleTrimPrefix" : GoString), stdgo.strings_test.Strings_test.exampleTrimPrefix,
		("Gophers!!!\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleTrimSuffix" : GoString), stdgo.strings_test.Strings_test.exampleTrimSuffix, ("¡¡¡Hello\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleTrimFunc" : GoString), stdgo.strings_test.Strings_test.exampleTrimFunc,
		("Hello, Gophers\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleTrimLeft" : GoString), stdgo.strings_test.Strings_test.exampleTrimLeft,
		("Hello, Gophers!!!\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleTrimLeftFunc" : GoString), stdgo.strings_test.Strings_test.exampleTrimLeftFunc,
		("Hello, Gophers!!!\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleTrimRight" : GoString), stdgo.strings_test.Strings_test.exampleTrimRight,
		("¡¡¡Hello, Gophers\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleTrimRightFunc" : GoString), stdgo.strings_test.Strings_test.exampleTrimRightFunc,
