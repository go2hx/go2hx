...
var _algorithmTestCases : Slice<T__struct_5> = ((new Slice<T__struct_5>(((new T__struct_5(_capitalLetters, ((((("*strings.byteReplacer" : GoString))) : GoString))) : T__struct_5)), ((new T__struct_5(_htmlEscaper, ((((("*strings.byteStringReplacer" : GoString))) : GoString))) : T__struct_5)), ((new T__struct_5(newReplacer(((((("12" : GoString))) : GoString)), ((((("123" : GoString))) : GoString))), ((((("*strings.singleStringReplacer" : GoString))) : GoString))) : T__struct_5)), ((new T__struct_5(newReplacer(((((("1" : GoString))) : GoString)), ((((("12" : GoString))) : GoString))), ((((("*strings.byteStringReplacer" : GoString))) : GoString))) : T__struct_5)), ((new T__struct_5(newReplacer(((((("" : GoString))) : GoString)), ((((("X" : GoString))) : GoString))), ((((("*strings.genericReplacer" : GoString))) : GoString))) : T__struct_5)), ((new T__struct_5(newReplacer(((((("a" : GoString))) : GoString)), ((((("1" : GoString))) : GoString)), ((((("b" : GoString))) : GoString)), ((((("12" : GoString))) : GoString)), ((((("cde" : GoString))) : GoString)), ((((("123" : GoString))) : GoString))), ((((("*strings.genericReplacer" : GoString))) : GoString))) : T__struct_5))) : Slice<T__struct_5>));
var _mapdata : Slice<T__struct_7> = ((new Slice<T__struct_7>(((new T__struct_7(((((("ASCII" : GoString))) : GoString)), ((((("a b c d e f g h i j k l m n o p q r s t u v w x y z" : GoString))) : GoString))) : T__struct_7)), ((new T__struct_7(((((("Greek" : GoString))) : GoString)), ((((("α β γ δ ε ζ η θ ι κ λ μ ν ξ ο π ρ ς σ τ υ φ χ ψ ω" : GoString))) : GoString))) : T__struct_7))) : Slice<T__struct_7>));
...
var _stringdata : Slice<T__struct_7> = ((new Slice<T__struct_7>(((new T__struct_7(((((("ASCII" : GoString))) : GoString)), _makeFieldsInputASCII()) : T__struct_7)), ((new T__struct_7(((((("Mixed" : GoString))) : GoString)), _makeFieldsInput()) : T__struct_7))) : Slice<T__struct_7>));
...
function testRepeatCatchesOverflow(_t:stdgo.testing.Testing.T):Void {
        var _tests = {
            var s:GoArray<T__struct_18> = new GoArray<T__struct_18>(...[for (i in 0 ... 7) new T__struct_18()]);
