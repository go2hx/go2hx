...
(new stdgo.strings_test.Strings_test.IndexTest((Go.str("a☺b☻c☹d") : GoString), (Go.str("cx") : GoString), ((Go.str("a☺b☻") : GoString).length)) : stdgo.strings_test.Strings_test.IndexTest),
(new stdgo.strings_test.Strings_test.IndexTest((Go.str("a☺b☻c☹d") : GoString), (Go.str("uvw☻xyz") : GoString), ((Go.str("a☺b") : GoString).length)) : stdgo.strings_test.Strings_test.IndexTest),
...
function testBuilderWrite2(_t:stdgo.testing.Testing.T):Void {
        ...
        }, _n : ((Go.str("hello 世界") : GoString).length), _want : (Go.str("hello 世界") : GoString) } : T__struct_0)) : Slice<T__struct_0>)) {
...
(Go.str("Z") : GoString));
        ...
        _testCases = (_testCases.__append__((new stdgo.strings_test.Strings_test.T_testCase_testReplacer_0(_blankToX1, (Go.str("foo") : GoString), (Go.str("XfXoXoX") : GoString)) : stdgo.strings_test.Strings_test.T_testCase_testReplacer_0),
...
(new stdgo.strings_test.Strings_test.T_testCase_testReplacer_0(_blankFoo, (Go.str() : GoString), (Go.str("X") : GoString)) : stdgo.strings_test.Strings_test.T_testCase_testReplacer_0)));
        ...
        for (_i => _tc in _testCases) {
            ...
            if (_n != (_tc._out.length)) {
                _t.errorf((Go.str("%d. WriteString(%q) wrote correct string but reported %d bytes; want %d (%q)") : GoString), Go.toInterface(_i), Go.toInterface(_tc._in), Go.toInterface(_n), Go.toInterface((_tc._out.length)), Go.toInterface(_tc._out));
            };
        };
    }
/**
...
function testLastIndexByte(_t:stdgo.testing.Testing.T):Void {
        var _testCases = (new Slice<stdgo.strings_test.Strings_test.IndexTest>(0, 0, (new stdgo.strings_test.Strings_test.IndexTest((Go.str() : GoString), (Go.str("q") : GoString), (-1 : GoInt)) : stdgo.strings_test.Strings_test.IndexTest), (new stdgo.strings_test.Strings_test.IndexTest((Go.str("abcdef") : GoString), (Go.str("q") : GoString), (-1 : GoInt)) : stdgo.strings_test.Strings_test.IndexTest), (new stdgo.strings_test.Strings_test.IndexTest((Go.str("abcdefabcdef") : GoString), (Go.str("a") : GoString), ((Go.str("abcdef") : GoString).length)) : stdgo.strings_test.Strings_test.IndexTest), (new stdgo.strings_test.Strings_test.IndexTest((Go.str("abcdefabcdef") : GoString), (Go.str("f") : GoString), ((Go.str("abcdefabcde") : GoString).length)) : stdgo.strings_test.Strings_test.IndexTest), (new stdgo.strings_test.Strings_test.IndexTest((Go.str("zabcdefabcdef") : GoString), (Go.str("z") : GoString), (0 : GoInt)) : stdgo.strings_test.Strings_test.IndexTest), (new stdgo.strings_test.Strings_test.IndexTest((Go.str("a☺b☻c☹d") : GoString), (Go.str("b") : GoString), ((Go.str("a☺") : GoString).length)) : stdgo.strings_test.Strings_test.IndexTest)) : Slice<stdgo.strings_test.Strings_test.IndexTest>);
        for (_0 => _test in _testCases) {
            var _actual:GoInt = lastIndexByte(_test._s, _test._sep[(0 : GoInt)]);
            if (_actual != _test._out) {
                _t.errorf((Go.str("LastIndexByte(%q,%c) = %v; want %v") : GoString), Go.toInterface(_test._s), Go.toInterface(_test._sep[(0 : GoInt)]), Go.toInterface(_actual), Go.toInterface(_test._out));
            };
        };
    }
            ...
            Go.cfor(_times < (10 : GoInt), _times++, {
                {
                    ...
                    Go.cfor(_strLen < (140 : GoInt), _strLen = _strLen + ((10 : GoInt)), {
                        ...
                        for (_i => _ in _s1) {
                            _s1[_i] = (Go.str("abcdefghijklmnopqrstuvwxyz0123456789") : GoString)[stdgo.math.rand.Rand.intn(((Go.str("abcdefghijklmnopqrstuvwxyz0123456789") : GoString).length))];
                        };
...
function _equal(_m:GoString, _s1:GoString, _s2:GoString, _t:stdgo.testing.Testing.T):Bool {
        ...
        for (_i => _c1 in _e1) {
            ...
            var __tmp__ = stdgo.unicode.utf8.Utf8.decodeRuneInString(_e2[_i]), _r2:GoInt32 = __tmp__._0, _1:GoInt = __tmp__._1;
            if (_r1 != _r2) {
...
function testRepeatCatchesOverflow(_t:stdgo.testing.Testing.T):Void {
        var _tests = {
            ...
            s[6] = ({ _s : (new Slice<GoUInt8>((255 : GoInt).toBasic(), 0, ...[for (i in 0 ... (255 : GoInt).toBasic()) (0 : GoUInt8)]) : GoString), _count : ((16843010 : GoUInt) : GoInt), _errStr : (Go.str("overflow") : GoString) } : T__struct_18);
            s;
        };
        for (_i => _tt in _tests) {
...
function benchmarkCountByte(_b:stdgo.testing.Testing.B):Void {
        ...
        var _benchStr:GoString = repeat((Go.str("some_text=some☺value") : GoString), (_indexSizes[(_indexSizes.length) - (1 : GoInt)] + ((Go.str("some_text=some☺value") : GoString).length) - (1 : GoInt)) / ((Go.str("some_text=some☺value") : GoString).length));
