...
@:structInit @:using(stdgo.sync.Sync.Map__static_extension) abstract Map_(stdgo._internal.sync.Sync_Map_.Map_) from stdgo._internal.sync.Sync_Map_.Map_ to stdgo._internal.sync.Sync_Map_.Map_ {
    ...
    public function new(?_mu:Mutex, ?_read:Pointer_<T_readOnly>, ?_dirty:stdgo.GoMap<stdgo.AnyInterface, stdgo.Ref<stdgo._internal.sync.Sync_T_entry.T_entry>>, ?_misses:StdTypes.Int) this = new stdgo._internal.sync.Sync_Map_.Map_(_mu, _read, _dirty, _misses);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_readOnly(stdgo._internal.sync.Sync_T_readOnly.T_readOnly) from stdgo._internal.sync.Sync_T_readOnly.T_readOnly to stdgo._internal.sync.Sync_T_readOnly.T_readOnly {
    ...
    public function new(?_m:stdgo.GoMap<stdgo.AnyInterface, stdgo.Ref<stdgo._internal.sync.Sync_T_entry.T_entry>>, ?_amended:Bool) this = new stdgo._internal.sync.Sync_T_readOnly.T_readOnly(_m, _amended);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
@:structInit @:using(stdgo.sync.Sync.Mutex_static_extension) abstract Mutex(stdgo._internal.sync.Sync_Mutex.Mutex) from stdgo._internal.sync.Sync_Mutex.Mutex to stdgo._internal.sync.Sync_Mutex.Mutex {
    ...
    public function new(?_state:StdTypes.Int, ?_sema:std.UInt, ?mutex) this = new stdgo._internal.sync.Sync_Mutex.Mutex(_state, _sema, mutex);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.sync.Sync.Once_static_extension) abstract Once(stdgo._internal.sync.Sync_Once.Once) from stdgo._internal.sync.Sync_Once.Once to stdgo._internal.sync.Sync_Once.Once {
    ...
    public function new(?_done:std.UInt, ?_m:Mutex) this = new stdgo._internal.sync.Sync_Once.Once(_done, _m);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.sync.Sync.Pool_static_extension) abstract Pool(stdgo._internal.sync.Sync_Pool.Pool) from stdgo._internal.sync.Sync_Pool.Pool to stdgo._internal.sync.Sync_Pool.Pool {
    ...
    public function new(?_noCopy:T_noCopy, ?_local:stdgo._internal.unsafe.Unsafe.UnsafePointer, ?_localSize:stdgo.GoUIntptr, ?_victim:stdgo._internal.unsafe.Unsafe.UnsafePointer, ?_victimSize:stdgo.GoUIntptr, ?new_:() -> stdgo.AnyInterface, ?pool) this = new stdgo._internal.sync.Sync_Pool.Pool(_noCopy, _local, _localSize, _victim, _victimSize, new_, pool);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_poolLocalInternal(stdgo._internal.sync.Sync_T_poolLocalInternal.T_poolLocalInternal) from stdgo._internal.sync.Sync_T_poolLocalInternal.T_poolLocalInternal to stdgo._internal.sync.Sync_T_poolLocalInternal.T_poolLocalInternal {
    ...
    public function new(?_private:stdgo.AnyInterface, ?_shared:T_poolChain) this = new stdgo._internal.sync.Sync_T_poolLocalInternal.T_poolLocalInternal(_private, _shared);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.sync.Sync.T_poolLocal_static_extension) abstract T_poolLocal(stdgo._internal.sync.Sync_T_poolLocal.T_poolLocal) from stdgo._internal.sync.Sync_T_poolLocal.T_poolLocal to stdgo._internal.sync.Sync_T_poolLocal.T_poolLocal {
    ...
    public function new(?_poolLocalInternal:T_poolLocalInternal, ?_pad:haxe.ds.Vector<std.UInt>) this = new stdgo._internal.sync.Sync_T_poolLocal.T_poolLocal(_poolLocalInternal, ([for (i in _pad) i] : stdgo.GoArray<stdgo.GoUInt8>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.sync.Sync.T_poolDequeue_static_extension) abstract T_poolDequeue(stdgo._internal.sync.Sync_T_poolDequeue.T_poolDequeue) from stdgo._internal.sync.Sync_T_poolDequeue.T_poolDequeue to stdgo._internal.sync.Sync_T_poolDequeue.T_poolDequeue {
    ...
    public function new(?_headTail:haxe.UInt64, ?_vals:Array<T_eface>) this = new stdgo._internal.sync.Sync_T_poolDequeue.T_poolDequeue(_headTail, ([for (i in _vals) i] : stdgo.Slice<stdgo._internal.sync.Sync_T_eface.T_eface>));
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_eface(stdgo._internal.sync.Sync_T_eface.T_eface) from stdgo._internal.sync.Sync_T_eface.T_eface to stdgo._internal.sync.Sync_T_eface.T_eface {
...
@:structInit @:using(stdgo.sync.Sync.T_poolChain_static_extension) abstract T_poolChain(stdgo._internal.sync.Sync_T_poolChain.T_poolChain) from stdgo._internal.sync.Sync_T_poolChain.T_poolChain to stdgo._internal.sync.Sync_T_poolChain.T_poolChain {
    ...
    public function new(?_head:T_poolChainElt, ?_tail:T_poolChainElt) this = new stdgo._internal.sync.Sync_T_poolChain.T_poolChain(_head, _tail);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.sync.Sync.T_poolChainElt_static_extension) abstract T_poolChainElt(stdgo._internal.sync.Sync_T_poolChainElt.T_poolChainElt) from stdgo._internal.sync.Sync_T_poolChainElt.T_poolChainElt to stdgo._internal.sync.Sync_T_poolChainElt.T_poolChainElt {
    ...
    public function new(?_poolDequeue:T_poolDequeue, ?_next:T_poolChainElt, ?_prev:T_poolChainElt) this = new stdgo._internal.sync.Sync_T_poolChainElt.T_poolChainElt(_poolDequeue, _next, _prev);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract T_notifyList(stdgo._internal.sync.Sync_T_notifyList.T_notifyList) from stdgo._internal.sync.Sync_T_notifyList.T_notifyList to stdgo._internal.sync.Sync_T_notifyList.T_notifyList {
    ...
    public function new(?_wait:std.UInt, ?_notify:std.UInt, ?_lock:stdgo.GoUIntptr, ?_head:stdgo._internal.unsafe.Unsafe.UnsafePointer, ?_tail:stdgo._internal.unsafe.Unsafe.UnsafePointer) this = new stdgo._internal.sync.Sync_T_notifyList.T_notifyList(_wait, _notify, _lock, _head, _tail);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.sync.Sync.RWMutex_static_extension) abstract RWMutex(stdgo._internal.sync.Sync_RWMutex.RWMutex) from stdgo._internal.sync.Sync_RWMutex.RWMutex to stdgo._internal.sync.Sync_RWMutex.RWMutex {
    ...
    public function new(?_w:Mutex, ?_writerSem:std.UInt, ?_readerSem:std.UInt, ?_readerCount:Int32, ?_readerWait:Int32, ?mutex) this = new stdgo._internal.sync.Sync_RWMutex.RWMutex(_w, _writerSem, _readerSem, _readerCount, _readerWait, mutex);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(stdgo.sync.Sync.WaitGroup_static_extension) abstract WaitGroup(stdgo._internal.sync.Sync_WaitGroup.WaitGroup) from stdgo._internal.sync.Sync_WaitGroup.WaitGroup to stdgo._internal.sync.Sync_WaitGroup.WaitGroup {
    ...
    public function new(?_noCopy:T_noCopy, ?_state:Uint64, ?_sema:std.UInt, ?lock, ?counter:std.UInt) this = new stdgo._internal.sync.Sync_WaitGroup.WaitGroup(_noCopy, _state, _sema, lock, counter);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
...
class T_poolChainElt_static_extension {
    public static function _unpack(__self__:stdgo._internal.sync.Sync_T_poolChainElt.T_poolChainElt, __0:haxe.UInt64):stdgo.Tuple<std.UInt, std.UInt> {
        return {
            final obj = stdgo._internal.sync.Sync_T_poolChainElt_static_extension.T_poolChainElt_static_extension._unpack(__self__, __0);
            { _0 : obj._0, _1 : obj._1 };
        };
    }
    public static function _pushHead(__self__:stdgo._internal.sync.Sync_T_poolChainElt.T_poolChainElt, _val:stdgo.AnyInterface):Bool {
        return stdgo._internal.sync.Sync_T_poolChainElt_static_extension.T_poolChainElt_static_extension._pushHead(__self__, _val);
    }
    ...
    public static function _pack(__self__:stdgo._internal.sync.Sync_T_poolChainElt.T_poolChainElt, _head:std.UInt, _tail:std.UInt):haxe.UInt64 {
        return stdgo._internal.sync.Sync_T_poolChainElt_static_extension.T_poolChainElt_static_extension._pack(__self__, _head, _tail);
    }
    public static function pushHead(__self__:stdgo._internal.sync.Sync_T_poolChainElt.T_poolChainElt, _val:stdgo.AnyInterface):Bool {
        return stdgo._internal.sync.Sync_T_poolChainElt_static_extension.T_poolChainElt_static_extension.pushHead(__self__, _val);
    }
...
class T_copyChecker_static_extension {
    static public function _check(____:T_copyChecker, _c:stdgo.Pointer<T_copyChecker>):Void {
        stdgo._internal.sync.Sync_T_copyChecker_static_extension.T_copyChecker_static_extension._check(____, _c);
    }
}
