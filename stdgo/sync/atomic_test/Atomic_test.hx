...
**/
var value_SwapTests : stdgo.Slice<T__struct_14> = (new stdgo.Slice<T__struct_14>(4, 4, ({ _init : (null : stdgo.AnyInterface), _new : (null : stdgo.AnyInterface), _want : (null : stdgo.AnyInterface), _err : stdgo.Go.toInterface(("sync/atomic: swap of nil value into Value" : stdgo.GoString)) } : T__struct_14), ({ _init : (null : stdgo.AnyInterface), _new : stdgo.Go.toInterface(true), _want : (null : stdgo.AnyInterface), _err : (null : stdgo.AnyInterface) } : T__struct_14), ({ _init : stdgo.Go.toInterface(true), _new : stdgo.Go.toInterface(stdgo.Go.str()), _want : (null : stdgo.AnyInterface), _err : stdgo.Go.toInterface(("sync/atomic: swap of inconsistently typed value into Value" : stdgo.GoString)) } : T__struct_14), ({ _init : stdgo.Go.toInterface(true), _new : stdgo.Go.toInterface(false), _want : stdgo.Go.toInterface(true), _err : (null : stdgo.AnyInterface) } : T__struct_14)) : stdgo.Slice<T__struct_14>);
/**
...
**/
var value_CompareAndSwapTests : stdgo.Slice<T__struct_16> = (new stdgo.Slice<T__struct_16>(8, 8, ({ _init : (null : stdgo.AnyInterface), _new : (null : stdgo.AnyInterface), _old : (null : stdgo.AnyInterface), _want : false, _err : stdgo.Go.toInterface(("sync/atomic: compare and swap of nil value into Value" : stdgo.GoString)) } : T__struct_16), ({ _init : (null : stdgo.AnyInterface), _new : stdgo.Go.toInterface(true), _old : stdgo.Go.toInterface(stdgo.Go.str()), _want : false, _err : stdgo.Go.toInterface(("sync/atomic: compare and swap of inconsistently typed values into Value" : stdgo.GoString)) } : T__struct_16), ({ _init : (null : stdgo.AnyInterface), _new : stdgo.Go.toInterface(true), _old : stdgo.Go.toInterface(true), _want : false, _err : (null : stdgo.AnyInterface) } : T__struct_16), ({ _init : (null : stdgo.AnyInterface), _new : stdgo.Go.toInterface(true), _old : (null : stdgo.AnyInterface), _want : true, _err : (null : stdgo.AnyInterface) } : T__struct_16), ({ _init : stdgo.Go.toInterface(true), _new : stdgo.Go.toInterface(stdgo.Go.str()), _old : (null : stdgo.AnyInterface), _want : false, _err : stdgo.Go.toInterface(("sync/atomic: compare and swap of inconsistently typed value into Value" : stdgo.GoString)) } : T__struct_16), ({ _init : stdgo.Go.toInterface(true), _new : stdgo.Go.toInterface(true), _old : stdgo.Go.toInterface(false), _want : false, _err : (null : stdgo.AnyInterface) } : T__struct_16), ({ _init : stdgo.Go.toInterface(true), _new : stdgo.Go.toInterface(true), _old : stdgo.Go.toInterface(true), _want : true, _err : (null : stdgo.AnyInterface) } : T__struct_16), ({ _init : stdgo.Go.toInterface(stdgo.Go.asInterface(_heapA)), _new : stdgo.Go.toInterface(stdgo.Go.asInterface(({ _uint : (1u32 : stdgo.GoUInt) } : T__struct_15))), _old : stdgo.Go.toInterface(stdgo.Go.asInterface(_heapB)), _want : true, _err : (null : stdgo.AnyInterface) } : T__struct_16)) : stdgo.Slice<T__struct_16>);
/**
...
**/
var _global : stdgo.GoArray<stdgo.GoByte> = new stdgo.GoArray<stdgo.GoUInt8>(...[for (i in 0 ... 1024) (0 : stdgo.GoUInt8)]);
/**
...
@:local @:using(stdgo.sync.atomic_test.Atomic_test.T__struct_11_static_extension) typedef T__struct_11 = {
    public var _before : stdgo.GoUIntptr;
    public var _i : stdgo.sync.atomic_.Atomic_.Pointer_<stdgo.GoUInt8>;
    public var _after : stdgo.GoUIntptr;
};
...
function testSwapInt32(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        if ((_x._before != (233684719 : stdgo.GoInt32)) || (_x._after != (233684719 : stdgo.GoInt32))) {
...
function testSwapInt32Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_1 = ({ _before : (0 : stdgo.GoInt32), _i : ({} : stdgo.sync.atomic_.Atomic_.Int32), _after : (0 : stdgo.GoInt32) } : T__struct_1);
        _x._before = (233684719 : stdgo.GoInt32);
        _x._after = (233684719 : stdgo.GoInt32);
        var _j:stdgo.GoInt32 = (0 : stdgo.GoInt32);
        {
...
function testSwapUint32(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        if ((_x._before != (233684719u32 : stdgo.GoUInt32)) || (_x._after != (233684719u32 : stdgo.GoUInt32))) {
            _t.fatalf(("wrong magic: %#x _ %#x != %#x _ %#x" : stdgo.GoString), stdgo.Go.toInterface(_x._before), stdgo.Go.toInterface(_x._after), stdgo.Go.toInterface((233684719 : stdgo.GoInt)), stdgo.Go.toInterface((233684719 : stdgo.GoInt)));
        };
    }
function testSwapUint32Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_3 = ({ _before : (0 : stdgo.GoUInt32), _i : ({} : stdgo.sync.atomic_.Atomic_.Uint32), _after : (0 : stdgo.GoUInt32) } : T__struct_3);
        _x._before = (233684719u32 : stdgo.GoUInt32);
        _x._after = (233684719u32 : stdgo.GoUInt32);
        var _j:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
        {
...
function testSwapInt64(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testSwapInt64Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_5 = ({ _before : (0 : stdgo.GoInt64), _i : ({} : stdgo.sync.atomic_.Atomic_.Int64_), _after : (0 : stdgo.GoInt64) } : T__struct_5);
        var _magic64:stdgo.GoInt64 = (1003703129787580143i64 : stdgo.GoInt64);
        _x._before = _magic64;
        _x._after = _magic64;
        var _j:stdgo.GoInt64 = (0 : stdgo.GoInt64);
...
function testSwapUint64(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testSwapUint64Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_7 = ({ _before : (0 : stdgo.GoUInt64), _i : ({} : stdgo.sync.atomic_.Atomic_.Uint64), _after : (0 : stdgo.GoUInt64) } : T__struct_7);
        var _magic64:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        _x._before = _magic64;
        _x._after = _magic64;
        var _j:stdgo.GoUInt64 = (0 : stdgo.GoUInt64);
...
function testSwapUintptr(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testSwapUintptrMethod(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_9 = ({ _before : (0 : stdgo.GoUIntptr), _i : ({} : stdgo.sync.atomic_.Atomic_.Uintptr), _after : (0 : stdgo.GoUIntptr) } : T__struct_9);
        var _m:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        var _magicptr:stdgo.GoUIntptr = (_m : stdgo.GoUIntptr);
        _x._before = _magicptr;
        _x._after = _magicptr;
...
function _testPointers():stdgo.Slice<stdgo.unsafe.Unsafe.UnsafePointer> {
        var _pointers:stdgo.Slice<stdgo.unsafe.Unsafe.UnsafePointer> = (null : stdgo.Slice<stdgo.unsafe.Unsafe.UnsafePointer>);
        {
            ...
            stdgo.Go.cfor(_i < (10 : stdgo.GoInt), _i++, {
                _pointers = (_pointers.__append__((stdgo.Go.toInterface(stdgo.Go.pointer(_global[(((1 : stdgo.GoInt) << _i) - (1 : stdgo.GoInt) : stdgo.GoInt)])) : stdgo.unsafe.Unsafe.UnsafePointer)));
            });
        };
        _pointers = (_pointers.__append__((stdgo.Go.toInterface(stdgo.Go.pointer((0 : stdgo.GoUInt8))) : stdgo.unsafe.Unsafe.UnsafePointer)));
        _pointers = (_pointers.__append__(@:default_value null));
        return _pointers;
    }
function testSwapPointer(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testSwapPointerMethod(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_11 = ({ _before : (0 : stdgo.GoUIntptr), _i : ({} : stdgo.sync.atomic_.Atomic_.Pointer_<stdgo.GoUInt8>), _after : (0 : stdgo.GoUIntptr) } : T__struct_11);
        var _m:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        var _magicptr:stdgo.GoUIntptr = (_m : stdgo.GoUIntptr);
        _x._before = _magicptr;
        _x._after = _magicptr;
        ...
        for (__34 => _p in _testPointers()) {
            var _p = (_p.__convert__(stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) })) : stdgo.Pointer<stdgo.GoByte>);
            var _k = _x._i.swap((0 : stdgo.GoUInt8), _p);
            if ((_x._i.load((0 : stdgo.GoUInt8)) != _p) || (_k != _j)) {
...
function testAddInt32(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_0 = ({ _before : (0 : stdgo.GoInt32), _i : (0 : stdgo.GoInt32), _after : (0 : stdgo.GoInt32) } : T__struct_0);
        _x._before = (233684719 : stdgo.GoInt32);
        _x._after = (233684719 : stdgo.GoInt32);
        var _j:stdgo.GoInt32 = (0 : stdgo.GoInt32);
...
function testAddInt32Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_1 = ({ _before : (0 : stdgo.GoInt32), _i : ({} : stdgo.sync.atomic_.Atomic_.Int32), _after : (0 : stdgo.GoInt32) } : T__struct_1);
        _x._before = (233684719 : stdgo.GoInt32);
        _x._after = (233684719 : stdgo.GoInt32);
        var _j:stdgo.GoInt32 = (0 : stdgo.GoInt32);
...
function testAddUint32(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_2 = ({ _before : (0 : stdgo.GoUInt32), _i : (0 : stdgo.GoUInt32), _after : (0 : stdgo.GoUInt32) } : T__struct_2);
        _x._before = (233684719u32 : stdgo.GoUInt32);
        _x._after = (233684719u32 : stdgo.GoUInt32);
        var _j:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
...
function testAddUint32Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_3 = ({ _before : (0 : stdgo.GoUInt32), _i : ({} : stdgo.sync.atomic_.Atomic_.Uint32), _after : (0 : stdgo.GoUInt32) } : T__struct_3);
        _x._before = (233684719u32 : stdgo.GoUInt32);
        _x._after = (233684719u32 : stdgo.GoUInt32);
        var _j:stdgo.GoUInt32 = (0 : stdgo.GoUInt32);
...
function testAddInt64(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_4 = ({ _before : (0 : stdgo.GoInt64), _i : (0 : stdgo.GoInt64), _after : (0 : stdgo.GoInt64) } : T__struct_4);
        var _magic64:stdgo.GoInt64 = (1003703129787580143i64 : stdgo.GoInt64);
        _x._before = _magic64;
        _x._after = _magic64;
...
function testAddInt64Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_5 = ({ _before : (0 : stdgo.GoInt64), _i : ({} : stdgo.sync.atomic_.Atomic_.Int64_), _after : (0 : stdgo.GoInt64) } : T__struct_5);
        var _magic64:stdgo.GoInt64 = (1003703129787580143i64 : stdgo.GoInt64);
        _x._before = _magic64;
        _x._after = _magic64;
...
function testAddUint64(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_6 = ({ _before : (0 : stdgo.GoUInt64), _i : (0 : stdgo.GoUInt64), _after : (0 : stdgo.GoUInt64) } : T__struct_6);
        var _magic64:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        _x._before = _magic64;
        _x._after = _magic64;
...
function testAddUint64Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_7 = ({ _before : (0 : stdgo.GoUInt64), _i : ({} : stdgo.sync.atomic_.Atomic_.Uint64), _after : (0 : stdgo.GoUInt64) } : T__struct_7);
        var _magic64:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        _x._before = _magic64;
        _x._after = _magic64;
...
function testAddUintptr(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_8 = ({ _before : (0 : stdgo.GoUIntptr), _i : (0 : stdgo.GoUIntptr), _after : (0 : stdgo.GoUIntptr) } : T__struct_8);
        var _m:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        var _magicptr:stdgo.GoUIntptr = (_m : stdgo.GoUIntptr);
        _x._before = _magicptr;
...
function testAddUintptrMethod(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_9 = ({ _before : (0 : stdgo.GoUIntptr), _i : ({} : stdgo.sync.atomic_.Atomic_.Uintptr), _after : (0 : stdgo.GoUIntptr) } : T__struct_9);
        var _m:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        var _magicptr:stdgo.GoUIntptr = (_m : stdgo.GoUIntptr);
        _x._before = _magicptr;
...
function testCompareAndSwapInt32(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_0 = ({ _before : (0 : stdgo.GoInt32), _i : (0 : stdgo.GoInt32), _after : (0 : stdgo.GoInt32) } : T__struct_0);
        _x._before = (233684719 : stdgo.GoInt32);
        _x._after = (233684719 : stdgo.GoInt32);
        {
            ...
            stdgo.Go.cfor((_val + _val) > _val, _val = _val + (_val), {
                _x._i = _val;
                if (!compareAndSwapInt32(stdgo.Go.pointer(_x._i), _val, _val + (1 : stdgo.GoInt32))) {
                    _t.fatalf(("should have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (1 : stdgo.GoInt32)));
                };
                if (_x._i != (_val + (1 : stdgo.GoInt32))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i), stdgo.Go.toInterface(_val + (1 : stdgo.GoInt32)));
                };
                _x._i = _val + (1 : stdgo.GoInt32);
                if (compareAndSwapInt32(stdgo.Go.pointer(_x._i), _val, _val + (2 : stdgo.GoInt32))) {
                    _t.fatalf(("should not have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (2 : stdgo.GoInt32)));
                };
                if (_x._i != (_val + (1 : stdgo.GoInt32))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i), stdgo.Go.toInterface(_val + (1 : stdgo.GoInt32)));
                };
...
function testCompareAndSwapInt32Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_1 = ({ _before : (0 : stdgo.GoInt32), _i : ({} : stdgo.sync.atomic_.Atomic_.Int32), _after : (0 : stdgo.GoInt32) } : T__struct_1);
        _x._before = (233684719 : stdgo.GoInt32);
        _x._after = (233684719 : stdgo.GoInt32);
        {
            ...
            stdgo.Go.cfor((_val + _val) > _val, _val = _val + (_val), {
                _x._i.store(_val);
                if (!_x._i.compareAndSwap(_val, _val + (1 : stdgo.GoInt32))) {
                    _t.fatalf(("should have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (1 : stdgo.GoInt32)));
                };
                if (_x._i.load() != (_val + (1 : stdgo.GoInt32))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i.load()), stdgo.Go.toInterface(_val + (1 : stdgo.GoInt32)));
                };
                _x._i.store(_val + (1 : stdgo.GoInt32));
                if (_x._i.compareAndSwap(_val, _val + (2 : stdgo.GoInt32))) {
                    _t.fatalf(("should not have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (2 : stdgo.GoInt32)));
                };
                if (_x._i.load() != (_val + (1 : stdgo.GoInt32))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i.load()), stdgo.Go.toInterface(_val + (1 : stdgo.GoInt32)));
...
function testCompareAndSwapUint32(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_2 = ({ _before : (0 : stdgo.GoUInt32), _i : (0 : stdgo.GoUInt32), _after : (0 : stdgo.GoUInt32) } : T__struct_2);
        _x._before = (233684719u32 : stdgo.GoUInt32);
        _x._after = (233684719u32 : stdgo.GoUInt32);
        {
            ...
            stdgo.Go.cfor((_val + _val) > _val, _val = _val + (_val), {
                _x._i = _val;
                if (!compareAndSwapUint32(stdgo.Go.pointer(_x._i), _val, _val + (1u32 : stdgo.GoUInt32))) {
                    _t.fatalf(("should have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (1u32 : stdgo.GoUInt32)));
                };
                if (_x._i != (_val + (1u32 : stdgo.GoUInt32))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i), stdgo.Go.toInterface(_val + (1u32 : stdgo.GoUInt32)));
                };
                _x._i = _val + (1u32 : stdgo.GoUInt32);
                if (compareAndSwapUint32(stdgo.Go.pointer(_x._i), _val, _val + (2u32 : stdgo.GoUInt32))) {
                    _t.fatalf(("should not have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (2u32 : stdgo.GoUInt32)));
                };
                if (_x._i != (_val + (1u32 : stdgo.GoUInt32))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i), stdgo.Go.toInterface(_val + (1u32 : stdgo.GoUInt32)));
                };
...
function testCompareAndSwapUint32Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_3 = ({ _before : (0 : stdgo.GoUInt32), _i : ({} : stdgo.sync.atomic_.Atomic_.Uint32), _after : (0 : stdgo.GoUInt32) } : T__struct_3);
        _x._before = (233684719u32 : stdgo.GoUInt32);
        _x._after = (233684719u32 : stdgo.GoUInt32);
        {
            ...
            stdgo.Go.cfor((_val + _val) > _val, _val = _val + (_val), {
                _x._i.store(_val);
                if (!_x._i.compareAndSwap(_val, _val + (1u32 : stdgo.GoUInt32))) {
                    _t.fatalf(("should have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (1u32 : stdgo.GoUInt32)));
                };
                if (_x._i.load() != (_val + (1u32 : stdgo.GoUInt32))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i.load()), stdgo.Go.toInterface(_val + (1u32 : stdgo.GoUInt32)));
                };
                _x._i.store(_val + (1u32 : stdgo.GoUInt32));
                if (_x._i.compareAndSwap(_val, _val + (2u32 : stdgo.GoUInt32))) {
                    _t.fatalf(("should not have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (2u32 : stdgo.GoUInt32)));
                };
                if (_x._i.load() != (_val + (1u32 : stdgo.GoUInt32))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i.load()), stdgo.Go.toInterface(_val + (1u32 : stdgo.GoUInt32)));
...
function testCompareAndSwapInt64(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_4 = ({ _before : (0 : stdgo.GoInt64), _i : (0 : stdgo.GoInt64), _after : (0 : stdgo.GoInt64) } : T__struct_4);
        var _magic64:stdgo.GoInt64 = (1003703129787580143i64 : stdgo.GoInt64);
        _x._before = _magic64;
        _x._after = _magic64;
        {
            ...
            stdgo.Go.cfor((_val + _val) > _val, _val = _val + (_val), {
                _x._i = _val;
                if (!compareAndSwapInt64(stdgo.Go.pointer(_x._i), _val, _val + (1i64 : stdgo.GoInt64))) {
                    _t.fatalf(("should have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (1i64 : stdgo.GoInt64)));
                };
                if (_x._i != (_val + (1i64 : stdgo.GoInt64))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i), stdgo.Go.toInterface(_val + (1i64 : stdgo.GoInt64)));
                };
                _x._i = _val + (1i64 : stdgo.GoInt64);
                if (compareAndSwapInt64(stdgo.Go.pointer(_x._i), _val, _val + (2i64 : stdgo.GoInt64))) {
                    _t.fatalf(("should not have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (2i64 : stdgo.GoInt64)));
                };
                if (_x._i != (_val + (1i64 : stdgo.GoInt64))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i), stdgo.Go.toInterface(_val + (1i64 : stdgo.GoInt64)));
                };
...
function testCompareAndSwapInt64Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_5 = ({ _before : (0 : stdgo.GoInt64), _i : ({} : stdgo.sync.atomic_.Atomic_.Int64_), _after : (0 : stdgo.GoInt64) } : T__struct_5);
        var _magic64:stdgo.GoInt64 = (1003703129787580143i64 : stdgo.GoInt64);
        _x._before = _magic64;
        _x._after = _magic64;
        {
            ...
            stdgo.Go.cfor((_val + _val) > _val, _val = _val + (_val), {
                _x._i.store(_val);
                if (!_x._i.compareAndSwap(_val, _val + (1i64 : stdgo.GoInt64))) {
                    _t.fatalf(("should have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (1i64 : stdgo.GoInt64)));
                };
                if (_x._i.load() != (_val + (1i64 : stdgo.GoInt64))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i.load()), stdgo.Go.toInterface(_val + (1i64 : stdgo.GoInt64)));
                };
                _x._i.store(_val + (1i64 : stdgo.GoInt64));
                if (_x._i.compareAndSwap(_val, _val + (2i64 : stdgo.GoInt64))) {
                    _t.fatalf(("should not have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (2i64 : stdgo.GoInt64)));
                };
                if (_x._i.load() != (_val + (1i64 : stdgo.GoInt64))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i.load()), stdgo.Go.toInterface(_val + (1i64 : stdgo.GoInt64)));
...
function _testCompareAndSwapUint64(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _cas:(stdgo.Pointer<stdgo.GoUInt64>, stdgo.GoUInt64, stdgo.GoUInt64) -> Bool):Void {
        var _x:T__struct_6 = ({ _before : (0 : stdgo.GoUInt64), _i : (0 : stdgo.GoUInt64), _after : (0 : stdgo.GoUInt64) } : T__struct_6);
        var _magic64:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        _x._before = _magic64;
        _x._after = _magic64;
        {
            ...
            stdgo.Go.cfor((_val + _val) > _val, _val = _val + (_val), {
                _x._i = _val;
                if (!_cas(stdgo.Go.pointer(_x._i), _val, _val + (1i64 : stdgo.GoUInt64))) {
                    _t.fatalf(("should have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (1i64 : stdgo.GoUInt64)));
                };
                if (_x._i != (_val + (1i64 : stdgo.GoUInt64))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i), stdgo.Go.toInterface(_val + (1i64 : stdgo.GoUInt64)));
                };
                _x._i = _val + (1i64 : stdgo.GoUInt64);
                if (_cas(stdgo.Go.pointer(_x._i), _val, _val + (2i64 : stdgo.GoUInt64))) {
                    _t.fatalf(("should not have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (2i64 : stdgo.GoUInt64)));
                };
                if (_x._i != (_val + (1i64 : stdgo.GoUInt64))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i), stdgo.Go.toInterface(_val + (1i64 : stdgo.GoUInt64)));
                };
...
function testCompareAndSwapUint64(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        _testCompareAndSwapUint64(_t, compareAndSwapUint64);
    }
function testCompareAndSwapUint64Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_7 = ({ _before : (0 : stdgo.GoUInt64), _i : ({} : stdgo.sync.atomic_.Atomic_.Uint64), _after : (0 : stdgo.GoUInt64) } : T__struct_7);
        var _magic64:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        _x._before = _magic64;
        _x._after = _magic64;
        {
            ...
            stdgo.Go.cfor((_val + _val) > _val, _val = _val + (_val), {
                _x._i.store(_val);
                if (!_x._i.compareAndSwap(_val, _val + (1i64 : stdgo.GoUInt64))) {
                    _t.fatalf(("should have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (1i64 : stdgo.GoUInt64)));
                };
                if (_x._i.load() != (_val + (1i64 : stdgo.GoUInt64))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i.load()), stdgo.Go.toInterface(_val + (1i64 : stdgo.GoUInt64)));
                };
                _x._i.store(_val + (1i64 : stdgo.GoUInt64));
                if (_x._i.compareAndSwap(_val, _val + (2i64 : stdgo.GoUInt64))) {
                    _t.fatalf(("should not have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (2i64 : stdgo.GoUInt64)));
                };
                if (_x._i.load() != (_val + (1i64 : stdgo.GoUInt64))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i.load()), stdgo.Go.toInterface(_val + (1i64 : stdgo.GoUInt64)));
...
function testCompareAndSwapUintptr(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_8 = ({ _before : (0 : stdgo.GoUIntptr), _i : (0 : stdgo.GoUIntptr), _after : (0 : stdgo.GoUIntptr) } : T__struct_8);
        var _m:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        var _magicptr:stdgo.GoUIntptr = (_m : stdgo.GoUIntptr);
        _x._before = _magicptr;
        _x._after = _magicptr;
        {
            ...
            stdgo.Go.cfor((_val + _val) > _val, _val = _val + (_val), {
                _x._i = _val;
                if (!compareAndSwapUintptr(stdgo.Go.pointer(_x._i), _val, _val + (1 : stdgo.GoUIntptr))) {
                    _t.fatalf(("should have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (1 : stdgo.GoUIntptr)));
                };
                if (_x._i != (_val + (1 : stdgo.GoUIntptr))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i), stdgo.Go.toInterface(_val + (1 : stdgo.GoUIntptr)));
                };
                _x._i = _val + (1 : stdgo.GoUIntptr);
                if (compareAndSwapUintptr(stdgo.Go.pointer(_x._i), _val, _val + (2 : stdgo.GoUIntptr))) {
                    _t.fatalf(("should not have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (2 : stdgo.GoUIntptr)));
                };
                if (_x._i != (_val + (1 : stdgo.GoUIntptr))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i), stdgo.Go.toInterface(_val + (1 : stdgo.GoUIntptr)));
                };
...
function testCompareAndSwapUintptrMethod(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_9 = ({ _before : (0 : stdgo.GoUIntptr), _i : ({} : stdgo.sync.atomic_.Atomic_.Uintptr), _after : (0 : stdgo.GoUIntptr) } : T__struct_9);
        var _m:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        var _magicptr:stdgo.GoUIntptr = (_m : stdgo.GoUIntptr);
        _x._before = _magicptr;
        _x._after = _magicptr;
        {
            ...
            stdgo.Go.cfor((_val + _val) > _val, _val = _val + (_val), {
                _x._i.store(_val);
                if (!_x._i.compareAndSwap(_val, _val + (1 : stdgo.GoUIntptr))) {
                    _t.fatalf(("should have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (1 : stdgo.GoUIntptr)));
                };
                if (_x._i.load() != (_val + (1 : stdgo.GoUIntptr))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i.load()), stdgo.Go.toInterface(_val + (1 : stdgo.GoUIntptr)));
                };
                _x._i.store(_val + (1 : stdgo.GoUIntptr));
                if (_x._i.compareAndSwap(_val, _val + (2 : stdgo.GoUIntptr))) {
                    _t.fatalf(("should not have swapped %#x %#x" : stdgo.GoString), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_val + (2 : stdgo.GoUIntptr)));
                };
                if (_x._i.load() != (_val + (1 : stdgo.GoUIntptr))) {
                    _t.fatalf(("wrong x.i after swap: x.i=%#x val+1=%#x" : stdgo.GoString), stdgo.Go.toInterface(_x._i.load()), stdgo.Go.toInterface(_val + (1 : stdgo.GoUIntptr)));
...
function testCompareAndSwapPointer(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_10 = ({ _before : (0 : stdgo.GoUIntptr), _i : @:default_value null, _after : (0 : stdgo.GoUIntptr) } : T__struct_10);
        var _m:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        var _magicptr:stdgo.GoUIntptr = (_m : stdgo.GoUIntptr);
        _x._before = _magicptr;
        _x._after = _magicptr;
        var _q:stdgo.unsafe.Unsafe.UnsafePointer = (stdgo.Go.toInterface(stdgo.Go.pointer((0 : stdgo.GoUInt8))) : stdgo.unsafe.Unsafe.UnsafePointer);
        for (__34 => _p in _testPointers()) {
            _x._i = _p;
...
function testCompareAndSwapPointerMethod(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_11 = ({ _before : (0 : stdgo.GoUIntptr), _i : ({} : stdgo.sync.atomic_.Atomic_.Pointer_<stdgo.GoUInt8>), _after : (0 : stdgo.GoUIntptr) } : T__struct_11);
        var _m:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        var _magicptr:stdgo.GoUIntptr = (_m : stdgo.GoUIntptr);
        _x._before = _magicptr;
...
function testLoadInt32(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_0 = ({ _before : (0 : stdgo.GoInt32), _i : (0 : stdgo.GoInt32), _after : (0 : stdgo.GoInt32) } : T__struct_0);
        _x._before = (233684719 : stdgo.GoInt32);
        _x._after = (233684719 : stdgo.GoInt32);
        {
...
function testLoadInt32Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_1 = ({ _before : (0 : stdgo.GoInt32), _i : ({} : stdgo.sync.atomic_.Atomic_.Int32), _after : (0 : stdgo.GoInt32) } : T__struct_1);
        _x._before = (233684719 : stdgo.GoInt32);
        _x._after = (233684719 : stdgo.GoInt32);
...
function testLoadUint32(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_2 = ({ _before : (0 : stdgo.GoUInt32), _i : (0 : stdgo.GoUInt32), _after : (0 : stdgo.GoUInt32) } : T__struct_2);
        _x._before = (233684719u32 : stdgo.GoUInt32);
        _x._after = (233684719u32 : stdgo.GoUInt32);
        {
...
function testLoadUint32Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_3 = ({ _before : (0 : stdgo.GoUInt32), _i : ({} : stdgo.sync.atomic_.Atomic_.Uint32), _after : (0 : stdgo.GoUInt32) } : T__struct_3);
        _x._before = (233684719u32 : stdgo.GoUInt32);
        _x._after = (233684719u32 : stdgo.GoUInt32);
...
function testLoadInt64(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_4 = ({ _before : (0 : stdgo.GoInt64), _i : (0 : stdgo.GoInt64), _after : (0 : stdgo.GoInt64) } : T__struct_4);
        var _magic64:stdgo.GoInt64 = (1003703129787580143i64 : stdgo.GoInt64);
        _x._before = _magic64;
        _x._after = _magic64;
...
function testLoadInt64Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_5 = ({ _before : (0 : stdgo.GoInt64), _i : ({} : stdgo.sync.atomic_.Atomic_.Int64_), _after : (0 : stdgo.GoInt64) } : T__struct_5);
        var _magic64:stdgo.GoInt64 = (1003703129787580143i64 : stdgo.GoInt64);
        _x._before = _magic64;
        _x._after = _magic64;
...
function testLoadUint64(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_6 = ({ _before : (0 : stdgo.GoUInt64), _i : (0 : stdgo.GoUInt64), _after : (0 : stdgo.GoUInt64) } : T__struct_6);
        var _magic64:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        _x._before = _magic64;
        _x._after = _magic64;
...
function testLoadUint64Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_7 = ({ _before : (0 : stdgo.GoUInt64), _i : ({} : stdgo.sync.atomic_.Atomic_.Uint64), _after : (0 : stdgo.GoUInt64) } : T__struct_7);
        var _magic64:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        _x._before = _magic64;
        _x._after = _magic64;
...
function testLoadUintptr(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_8 = ({ _before : (0 : stdgo.GoUIntptr), _i : (0 : stdgo.GoUIntptr), _after : (0 : stdgo.GoUIntptr) } : T__struct_8);
        var _m:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        var _magicptr:stdgo.GoUIntptr = (_m : stdgo.GoUIntptr);
        _x._before = _magicptr;
...
function testLoadUintptrMethod(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_9 = ({ _before : (0 : stdgo.GoUIntptr), _i : ({} : stdgo.sync.atomic_.Atomic_.Uintptr), _after : (0 : stdgo.GoUIntptr) } : T__struct_9);
        var _m:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        var _magicptr:stdgo.GoUIntptr = (_m : stdgo.GoUIntptr);
        _x._before = _magicptr;
...
function testLoadPointer(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_10 = ({ _before : (0 : stdgo.GoUIntptr), _i : @:default_value null, _after : (0 : stdgo.GoUIntptr) } : T__struct_10);
        var _m:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        var _magicptr:stdgo.GoUIntptr = (_m : stdgo.GoUIntptr);
        _x._before = _magicptr;
...
function testLoadPointerMethod(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_11 = ({ _before : (0 : stdgo.GoUIntptr), _i : ({} : stdgo.sync.atomic_.Atomic_.Pointer_<stdgo.GoUInt8>), _after : (0 : stdgo.GoUIntptr) } : T__struct_11);
        var _m:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        var _magicptr:stdgo.GoUIntptr = (_m : stdgo.GoUIntptr);
        _x._before = _magicptr;
...
function testStoreInt32(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_0 = ({ _before : (0 : stdgo.GoInt32), _i : (0 : stdgo.GoInt32), _after : (0 : stdgo.GoInt32) } : T__struct_0);
        _x._before = (233684719 : stdgo.GoInt32);
        _x._after = (233684719 : stdgo.GoInt32);
...
function testStoreInt32Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_1 = ({ _before : (0 : stdgo.GoInt32), _i : ({} : stdgo.sync.atomic_.Atomic_.Int32), _after : (0 : stdgo.GoInt32) } : T__struct_1);
        _x._before = (233684719 : stdgo.GoInt32);
        _x._after = (233684719 : stdgo.GoInt32);
        var _v:stdgo.GoInt32 = (0 : stdgo.GoInt32);
...
function testStoreUint32(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_2 = ({ _before : (0 : stdgo.GoUInt32), _i : (0 : stdgo.GoUInt32), _after : (0 : stdgo.GoUInt32) } : T__struct_2);
        _x._before = (233684719u32 : stdgo.GoUInt32);
        _x._after = (233684719u32 : stdgo.GoUInt32);
...
function testStoreUint32Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_3 = ({ _before : (0 : stdgo.GoUInt32), _i : ({} : stdgo.sync.atomic_.Atomic_.Uint32), _after : (0 : stdgo.GoUInt32) } : T__struct_3);
        _x._before = (233684719u32 : stdgo.GoUInt32);
        _x._after = (233684719u32 : stdgo.GoUInt32);
        var _v:stdgo.GoUInt32 = (0u32 : stdgo.GoUInt32);
...
function testStoreInt64(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_4 = ({ _before : (0 : stdgo.GoInt64), _i : (0 : stdgo.GoInt64), _after : (0 : stdgo.GoInt64) } : T__struct_4);
        var _magic64:stdgo.GoInt64 = (1003703129787580143i64 : stdgo.GoInt64);
        _x._before = _magic64;
        _x._after = _magic64;
...
function testStoreInt64Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_5 = ({ _before : (0 : stdgo.GoInt64), _i : ({} : stdgo.sync.atomic_.Atomic_.Int64_), _after : (0 : stdgo.GoInt64) } : T__struct_5);
        var _magic64:stdgo.GoInt64 = (1003703129787580143i64 : stdgo.GoInt64);
        _x._before = _magic64;
        _x._after = _magic64;
...
function testStoreUint64(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_6 = ({ _before : (0 : stdgo.GoUInt64), _i : (0 : stdgo.GoUInt64), _after : (0 : stdgo.GoUInt64) } : T__struct_6);
        var _magic64:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        _x._before = _magic64;
        _x._after = _magic64;
...
function testStoreUint64Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_7 = ({ _before : (0 : stdgo.GoUInt64), _i : ({} : stdgo.sync.atomic_.Atomic_.Uint64), _after : (0 : stdgo.GoUInt64) } : T__struct_7);
        var _magic64:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        _x._before = _magic64;
        _x._after = _magic64;
...
function testStoreUintptr(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_8 = ({ _before : (0 : stdgo.GoUIntptr), _i : (0 : stdgo.GoUIntptr), _after : (0 : stdgo.GoUIntptr) } : T__struct_8);
        var _m:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        var _magicptr:stdgo.GoUIntptr = (_m : stdgo.GoUIntptr);
        _x._before = _magicptr;
...
function testStoreUintptrMethod(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_9 = ({ _before : (0 : stdgo.GoUIntptr), _i : ({} : stdgo.sync.atomic_.Atomic_.Uintptr), _after : (0 : stdgo.GoUIntptr) } : T__struct_9);
        var _m:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        var _magicptr:stdgo.GoUIntptr = (_m : stdgo.GoUIntptr);
        _x._before = _magicptr;
...
function testStorePointer(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_10 = ({ _before : (0 : stdgo.GoUIntptr), _i : @:default_value null, _after : (0 : stdgo.GoUIntptr) } : T__struct_10);
        var _m:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        var _magicptr:stdgo.GoUIntptr = (_m : stdgo.GoUIntptr);
        _x._before = _magicptr;
...
function testStorePointerMethod(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:T__struct_11 = ({ _before : (0 : stdgo.GoUIntptr), _i : ({} : stdgo.sync.atomic_.Atomic_.Pointer_<stdgo.GoUInt8>), _after : (0 : stdgo.GoUIntptr) } : T__struct_11);
        var _m:stdgo.GoUInt64 = (1003703129787580143i64 : stdgo.GoUInt64);
        var _magicptr:stdgo.GoUIntptr = (_m : stdgo.GoUIntptr);
        _x._before = _magicptr;
...
function _hammerSwapInt32(_uaddr:stdgo.Pointer<stdgo.GoUInt32>, _count:stdgo.GoInt):Void {
        var _addr = ((stdgo.Go.toInterface(_uaddr) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(int32_kind) })) : stdgo.Pointer<stdgo.GoInt32>);
        var _seed:stdgo.GoInt = (((stdgo.Go.toInterface(stdgo.Go.pointer(_count)) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind)) : stdgo.GoUIntptr) : stdgo.GoInt);
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _count, _i++, {
                var _new:stdgo.GoUInt32 = ((_seed + _i : stdgo.GoUInt32) << (16i64 : stdgo.GoUInt64)) | (((_seed + _i : stdgo.GoUInt32) << (16i64 : stdgo.GoUInt64)) >> (16i64 : stdgo.GoUInt64));
                var _old:stdgo.GoUInt32 = (swapInt32(_addr, (_new : stdgo.GoInt32)) : stdgo.GoUInt32);
                if (_old >> (16i64 : stdgo.GoUInt64) != (_old << (16i64 : stdgo.GoUInt64) >> (16i64 : stdgo.GoUInt64))) {
...
function _hammerSwapUintptr32(_uaddr:stdgo.Pointer<stdgo.GoUInt32>, _count:stdgo.GoInt):Void {
        var _addr = ((stdgo.Go.toInterface(_uaddr) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) })) : stdgo.Pointer<stdgo.GoUIntptr>);
        var _seed:stdgo.GoInt = (((stdgo.Go.toInterface(stdgo.Go.pointer(_count)) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind)) : stdgo.GoUIntptr) : stdgo.GoInt);
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _count, _i++, {
                var _new:stdgo.GoUIntptr = ((_seed + _i : stdgo.GoUIntptr) << (16i64 : stdgo.GoUInt64)) | (((_seed + _i : stdgo.GoUIntptr) << (16i64 : stdgo.GoUInt64)) >> (16i64 : stdgo.GoUInt64));
        ...
        var _addr = ((stdgo.Go.toInterface(_uaddr) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(int32_kind) })) : stdgo.Pointer<stdgo.GoInt32>);
        {
            ...
            stdgo.Go.cfor(_i < _count, _i++, {
                while (true) {
                    ...
                    if (compareAndSwapInt32(_addr, _v, _v + (1 : stdgo.GoInt32))) {
                        break;
                    };
                };
            });
        ...
        var _addr = ((stdgo.Go.toInterface(_uaddr) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.refType({ get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.Int32", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "__36", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.T_noCopy", [], stdgo.internal.reflect.Reflect.GoType.structType([]), false, { get : () -> null }) }, optional : false }, { name : "_v", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(int32_kind) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<Int32>);
        {
            ...
            stdgo.Go.cfor(_i < _count, _i++, {
                while (true) {
                    ...
                    if (_addr.compareAndSwap(_v, _v + (1 : stdgo.GoInt32))) {
                        break;
                    };
                };
            });
...
function _hammerCompareAndSwapUint32(_addr:stdgo.Pointer<stdgo.GoUInt32>, _count:stdgo.GoInt):Void {
        {
            ...
            stdgo.Go.cfor(_i < _count, _i++, {
                while (true) {
                    ...
                    if (compareAndSwapUint32(_addr, _v, _v + (1u32 : stdgo.GoUInt32))) {
                        break;
                    };
                };
            });
        ...
        var _addr = ((stdgo.Go.toInterface(_uaddr) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.refType({ get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.Uint32", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "__36", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.T_noCopy", [], stdgo.internal.reflect.Reflect.GoType.structType([]), false, { get : () -> null }) }, optional : false }, { name : "_v", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<Uint32>);
        {
            ...
            stdgo.Go.cfor(_i < _count, _i++, {
                while (true) {
                    ...
                    if (_addr.compareAndSwap(_v, _v + (1u32 : stdgo.GoUInt32))) {
                        break;
                    };
                };
            });
        ...
        var _addr = ((stdgo.Go.toInterface(_uaddr) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) })) : stdgo.Pointer<stdgo.GoUIntptr>);
        {
            ...
            stdgo.Go.cfor(_i < _count, _i++, {
                while (true) {
                    ...
                    if (compareAndSwapUintptr(_addr, _v, _v + (1 : stdgo.GoUIntptr))) {
                        break;
                    };
                };
            });
        ...
        var _addr = ((stdgo.Go.toInterface(_uaddr) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.refType({ get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.Uintptr", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "__36", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.T_noCopy", [], stdgo.internal.reflect.Reflect.GoType.structType([]), false, { get : () -> null }) }, optional : false }, { name : "_v", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<Uintptr>);
        {
            ...
            stdgo.Go.cfor(_i < _count, _i++, {
                while (true) {
                    ...
                    if (_addr.compareAndSwap(_v, _v + (1 : stdgo.GoUIntptr))) {
                        break;
                    };
                };
            });
...
function testHammer32(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        try {
            ...
            for (_name => _testf in _hammer32) {
                ...
                if (!stdgo.strings.Strings.hasPrefix(_name?.__copy__(), ("Swap" : stdgo.GoString)) && (_val != ((_n : stdgo.GoUInt32) * (4u32 : stdgo.GoUInt32)))) {
                    _t.fatalf(("%s: val=%d want %d" : stdgo.GoString), stdgo.Go.toInterface(_name), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_n * (4 : stdgo.GoInt)));
                };
            };
            {
                for (defer in __deferstack__) {
...
function _hammerSwapInt64(_uaddr:stdgo.Pointer<stdgo.GoUInt64>, _count:stdgo.GoInt):Void {
        var _addr = ((stdgo.Go.toInterface(_uaddr) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(int64_kind) })) : stdgo.Pointer<stdgo.GoInt64>);
        var _seed:stdgo.GoInt = (((stdgo.Go.toInterface(stdgo.Go.pointer(_count)) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind)) : stdgo.GoUIntptr) : stdgo.GoInt);
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _count, _i++, {
                var _new:stdgo.GoUInt64 = ((_seed + _i : stdgo.GoUInt64) << (32i64 : stdgo.GoUInt64)) | (((_seed + _i : stdgo.GoUInt64) << (32i64 : stdgo.GoUInt64)) >> (32i64 : stdgo.GoUInt64));
                var _old:stdgo.GoUInt64 = (swapInt64(_addr, (_new : stdgo.GoInt64)) : stdgo.GoUInt64);
                if (_old >> (32i64 : stdgo.GoUInt64) != (_old << (32i64 : stdgo.GoUInt64) >> (32i64 : stdgo.GoUInt64))) {
...
function _hammerSwapUintptr64(_uaddr:stdgo.Pointer<stdgo.GoUInt64>, _count:stdgo.GoInt):Void {
        if (false) {
            ...
            var _seed:stdgo.GoInt = (((stdgo.Go.toInterface(stdgo.Go.pointer(_count)) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind)) : stdgo.GoUIntptr) : stdgo.GoInt);
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_i < _count, _i++, {
                    var _new:stdgo.GoUIntptr = ((_seed + _i : stdgo.GoUIntptr) << (32i64 : stdgo.GoUInt64)) | (((_seed + _i : stdgo.GoUIntptr) << (32i64 : stdgo.GoUInt64)) >> (32i64 : stdgo.GoUInt64));
                    var _old:stdgo.GoUIntptr = swapUintptr(_addr, _new);
                    if (_old >> (32i64 : stdgo.GoUInt64) != (_old << (32i64 : stdgo.GoUInt64) >> (32i64 : stdgo.GoUInt64))) {
        ...
        var _addr = ((stdgo.Go.toInterface(_uaddr) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(int64_kind) })) : stdgo.Pointer<stdgo.GoInt64>);
        {
            ...
            stdgo.Go.cfor(_i < _count, _i++, {
                while (true) {
                    ...
                    if (compareAndSwapInt64(_addr, _v, _v + (1i64 : stdgo.GoInt64))) {
                        break;
                    };
                };
            });
        ...
        var _addr = ((stdgo.Go.toInterface(_uaddr) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.refType({ get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.Int64_", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "__38", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.T_noCopy", [], stdgo.internal.reflect.Reflect.GoType.structType([]), false, { get : () -> null }) }, optional : false }, { name : "__39", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.T_align64", [], stdgo.internal.reflect.Reflect.GoType.structType([]), false, { get : () -> null }) }, optional : false }, { name : "_v", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(int64_kind) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<Int64_>);
        {
            ...
            stdgo.Go.cfor(_i < _count, _i++, {
                while (true) {
                    ...
                    if (_addr.compareAndSwap(_v, _v + (1i64 : stdgo.GoInt64))) {
                        break;
                    };
                };
            });
...
function _hammerCompareAndSwapUint64(_addr:stdgo.Pointer<stdgo.GoUInt64>, _count:stdgo.GoInt):Void {
        {
            ...
            stdgo.Go.cfor(_i < _count, _i++, {
                while (true) {
                    ...
                    if (compareAndSwapUint64(_addr, _v, _v + (1i64 : stdgo.GoUInt64))) {
                        break;
                    };
                };
            });
        ...
        var _addr = ((stdgo.Go.toInterface(_uaddr) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.refType({ get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.Uint64", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "__38", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.T_noCopy", [], stdgo.internal.reflect.Reflect.GoType.structType([]), false, { get : () -> null }) }, optional : false }, { name : "__39", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.T_align64", [], stdgo.internal.reflect.Reflect.GoType.structType([]), false, { get : () -> null }) }, optional : false }, { name : "_v", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint64_kind) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<Uint64>);
        {
            ...
            stdgo.Go.cfor(_i < _count, _i++, {
                while (true) {
                    ...
                    if (_addr.compareAndSwap(_v, _v + (1i64 : stdgo.GoUInt64))) {
                        break;
                    };
                };
            });
...
function testHammer64(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            {};
            var _n:stdgo.GoInt = (100000 : stdgo.GoInt);
            ...
            for (_name => _testf in _hammer64) {
                ...
                if (!stdgo.strings.Strings.hasPrefix(_name?.__copy__(), ("Swap" : stdgo.GoString)) && (_val != ((_n : stdgo.GoUInt64) * (4i64 : stdgo.GoUInt64)))) {
                    _t.fatalf(("%s: val=%d want %d" : stdgo.GoString), stdgo.Go.toInterface(_name), stdgo.Go.toInterface(_val), stdgo.Go.toInterface(_n * (4 : stdgo.GoInt)));
                };
            };
            {
...
function _hammerStoreLoadInt32(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _paddr:stdgo.unsafe.Unsafe.UnsafePointer):Void {
        var _addr = (_paddr.__convert__(stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(int32_kind) })) : stdgo.Pointer<stdgo.GoInt32>);
        var _v:stdgo.GoInt32 = loadInt32(_addr);
        var _vlo:stdgo.GoInt32 = _v & (65535 : stdgo.GoInt32);
        var _vhi:stdgo.GoInt32 = _v >> (16i64 : stdgo.GoUInt64);
        if (_vlo != (_vhi)) {
            _t.fatalf(("Int32: %#x != %#x" : stdgo.GoString), stdgo.Go.toInterface(_vlo), stdgo.Go.toInterface(_vhi));
        };
        var _new:stdgo.GoInt32 = (_v + (1 : stdgo.GoInt32)) + (65536 : stdgo.GoInt32);
        if (_vlo == ((10000 : stdgo.GoInt32))) {
            _new = (0 : stdgo.GoInt32);
        };
        storeInt32(_addr, _new);
    }
function _hammerStoreLoadInt32Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _paddr:stdgo.unsafe.Unsafe.UnsafePointer):Void {
        var _addr = (_paddr.__convert__(stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(int32_kind) })) : stdgo.Pointer<stdgo.GoInt32>);
        var _v:stdgo.GoInt32 = loadInt32(_addr);
        var _vlo:stdgo.GoInt32 = _v & (65535 : stdgo.GoInt32);
        var _vhi:stdgo.GoInt32 = _v >> (16i64 : stdgo.GoUInt64);
...
function _hammerStoreLoadUint32(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _paddr:stdgo.unsafe.Unsafe.UnsafePointer):Void {
        var _addr = (_paddr.__convert__(stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint32_kind) })) : stdgo.Pointer<stdgo.GoUInt32>);
        var _v:stdgo.GoUInt32 = loadUint32(_addr);
        var _vlo:stdgo.GoUInt32 = _v & (65535u32 : stdgo.GoUInt32);
        var _vhi:stdgo.GoUInt32 = _v >> (16i64 : stdgo.GoUInt64);
        if (_vlo != (_vhi)) {
            _t.fatalf(("Uint32: %#x != %#x" : stdgo.GoString), stdgo.Go.toInterface(_vlo), stdgo.Go.toInterface(_vhi));
        };
        var _new:stdgo.GoUInt32 = (_v + (1u32 : stdgo.GoUInt32)) + (65536u32 : stdgo.GoUInt32);
        if (_vlo == ((10000u32 : stdgo.GoUInt32))) {
            _new = (0u32 : stdgo.GoUInt32);
        };
        storeUint32(_addr, _new);
    }
function _hammerStoreLoadUint32Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _paddr:stdgo.unsafe.Unsafe.UnsafePointer):Void {
...
function _hammerStoreLoadInt64(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _paddr:stdgo.unsafe.Unsafe.UnsafePointer):Void {
        var _addr = (_paddr.__convert__(stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(int64_kind) })) : stdgo.Pointer<stdgo.GoInt64>);
        var _v:stdgo.GoInt64 = loadInt64(_addr);
        var _vlo:stdgo.GoInt64 = _v & (4294967295i64 : stdgo.GoInt64);
        var _vhi:stdgo.GoInt64 = _v >> (32i64 : stdgo.GoUInt64);
        if (_vlo != (_vhi)) {
            _t.fatalf(("Int64: %#x != %#x" : stdgo.GoString), stdgo.Go.toInterface(_vlo), stdgo.Go.toInterface(_vhi));
        };
        var _new:stdgo.GoInt64 = (_v + (1i64 : stdgo.GoInt64)) + (4294967296i64 : stdgo.GoInt64);
        storeInt64(_addr, _new);
    }
function _hammerStoreLoadInt64Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _paddr:stdgo.unsafe.Unsafe.UnsafePointer):Void {
...
function _hammerStoreLoadUint64(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _paddr:stdgo.unsafe.Unsafe.UnsafePointer):Void {
        var _addr = (_paddr.__convert__(stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint64_kind) })) : stdgo.Pointer<stdgo.GoUInt64>);
        var _v:stdgo.GoUInt64 = loadUint64(_addr);
        var _vlo:stdgo.GoUInt64 = _v & (4294967295i64 : stdgo.GoUInt64);
        var _vhi:stdgo.GoUInt64 = _v >> (32i64 : stdgo.GoUInt64);
        if (_vlo != (_vhi)) {
            _t.fatalf(("Uint64: %#x != %#x" : stdgo.GoString), stdgo.Go.toInterface(_vlo), stdgo.Go.toInterface(_vhi));
        };
        var _new:stdgo.GoUInt64 = (_v + (1i64 : stdgo.GoUInt64)) + (4294967296i64 : stdgo.GoUInt64);
        storeUint64(_addr, _new);
    }
function _hammerStoreLoadUint64Method(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _paddr:stdgo.unsafe.Unsafe.UnsafePointer):Void {
...
function _hammerStoreLoadUintptr(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _paddr:stdgo.unsafe.Unsafe.UnsafePointer):Void {
        var _addr = (_paddr.__convert__(stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind) })) : stdgo.Pointer<stdgo.GoUIntptr>);
        var _v:stdgo.GoUIntptr = loadUintptr(_addr);
        var _new:stdgo.GoUIntptr = _v;
        if (true) {
            var _vlo:stdgo.GoUIntptr = _v & (65535 : stdgo.GoUIntptr);
            var _vhi:stdgo.GoUIntptr = _v >> (16i64 : stdgo.GoUInt64);
            if (_vlo != (_vhi)) {
                _t.fatalf(("Uintptr: %#x != %#x" : stdgo.GoString), stdgo.Go.toInterface(_vlo), stdgo.Go.toInterface(_vhi));
            };
            _new = (_v + (1 : stdgo.GoUIntptr)) + (65536 : stdgo.GoUIntptr);
            if (_vlo == ((10000 : stdgo.GoUIntptr))) {
                _new = (0 : stdgo.GoUIntptr);
            };
        } else {
            var _vlo:stdgo.GoUIntptr = _v & (4294967295 : stdgo.GoUIntptr);
            var _vhi:stdgo.GoUIntptr = _v >> (32i64 : stdgo.GoUInt64);
            if (_vlo != (_vhi)) {
                _t.fatalf(("Uintptr: %#x != %#x" : stdgo.GoString), stdgo.Go.toInterface(_vlo), stdgo.Go.toInterface(_vhi));
            };
            var _inc:stdgo.GoUInt64 = (4294967297i64 : stdgo.GoUInt64);
            _new = _v + (_inc : stdgo.GoUIntptr);
        };
...
/**
    //go:nocheckptr
**/
function _hammerStoreLoadUintptrMethod(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _paddr:stdgo.unsafe.Unsafe.UnsafePointer):Void {
...
/**
    ...
    //go:nocheckptr
**/
function _hammerStoreLoadPointer(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _paddr:stdgo.unsafe.Unsafe.UnsafePointer):Void {
        ...
        var _v:stdgo.GoUIntptr = (loadPointer(_addr).__convert__(stdgo.internal.reflect.Reflect.GoType.basic(uintptr_kind)) : stdgo.GoUIntptr);
        var _new:stdgo.GoUIntptr = _v;
        if (true) {
            var _vlo:stdgo.GoUIntptr = _v & (65535 : stdgo.GoUIntptr);
            var _vhi:stdgo.GoUIntptr = _v >> (16i64 : stdgo.GoUInt64);
...
function _hammerStoreLoadPointerMethod(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _paddr:stdgo.unsafe.Unsafe.UnsafePointer):Void {
        ...
        _addr.store(((stdgo.Go.toInterface(_new) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.pointerType({ get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint8_kind) })) : stdgo.Pointer<stdgo.GoByte>));
    }
function testHammerStoreLoad(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            var _tests = (new stdgo.Slice<(stdgo.Ref<stdgo.testing.Testing.T_>, stdgo.unsafe.Unsafe.UnsafePointer) -> Void>(
12,
12,
...
_hammerStoreLoadUint64Method) : stdgo.Slice<(stdgo.Ref<stdgo.testing.Testing.T_>, stdgo.unsafe.Unsafe.UnsafePointer) -> Void>);
            ...
            {};
            {
                var _a0 = stdgo.runtime.Runtime.gomaxprocs((8 : stdgo.GoInt));
                __deferstack__.unshift(() -> stdgo.runtime.Runtime.gomaxprocs(_a0));
            };
            {
                var _a0 = stdgo.runtime.debug.Debug.setGCPercent((-1 : stdgo.GoInt));
            ...
            for (__34 => _tt in _tests) {
                ...
                var _val:stdgo.GoUInt64 = (0 : stdgo.GoUInt64);
                {
                    ...
                    stdgo.Go.cfor(_p < (8 : stdgo.GoInt), _p++, {
                        stdgo.Go.routine(() -> {
                            var a = function():Void {
                                {
                                    var _i:stdgo.GoInt = (0 : stdgo.GoInt);
...
function testStoreLoadSeqCst32(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            if (stdgo.runtime.Runtime.numCPU() == ((1 : stdgo.GoInt))) {
            ...
            var x = (new stdgo.GoArray<stdgo.GoInt32>(...([].concat([for (i in 0 ... 2) (0 : stdgo.GoInt32)]))) : stdgo.GoArray<stdgo.GoInt32>);
            var _ack = (new stdgo.GoArray<stdgo.GoArray<stdgo.GoInt32>>((new stdgo.GoArray<stdgo.GoInt32>((-1 : stdgo.GoInt32), (-1 : stdgo.GoInt32), (-1 : stdgo.GoInt32)) : stdgo.GoArray<stdgo.GoInt32>), (new stdgo.GoArray<stdgo.GoInt32>((-1 : stdgo.GoInt32), (-1 : stdgo.GoInt32), (-1 : stdgo.GoInt32)) : stdgo.GoArray<stdgo.GoInt32>)) : stdgo.GoArray<stdgo.GoArray<stdgo.GoInt32>>);
            {
                var _p:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_p < (2 : stdgo.GoInt), _p++, {
                    stdgo.Go.routine(() -> {
                        var a = function(_me:stdgo.GoInt):Void {
                            var _he:stdgo.GoInt = (1 : stdgo.GoInt) - _me;
                            {
                                ...
                                stdgo.Go.cfor(_i < n, _i++, {
                                    ...
                                    storeInt32(stdgo.Go.pointer(_ack[(_me : stdgo.GoInt)][(_i % (3 : stdgo.GoInt32) : stdgo.GoInt)]), _my);
                                    {
                                        var _w:stdgo.GoInt = (1 : stdgo.GoInt);
                                        stdgo.Go.cfor(loadInt32(stdgo.Go.pointer(_ack[(_he : stdgo.GoInt)][(_i % (3 : stdgo.GoInt32) : stdgo.GoInt)])) == ((-1 : stdgo.GoInt32)), _w++, {
                                            if (_w % (1000 : stdgo.GoInt) == ((0 : stdgo.GoInt))) {
                                                stdgo.runtime.Runtime.gosched();
                                            };
                                        });
                                    };
                                    var _his:stdgo.GoInt32 = loadInt32(stdgo.Go.pointer(_ack[(_he : stdgo.GoInt)][(_i % (3 : stdgo.GoInt32) : stdgo.GoInt)]));
                                    if (((_my != _i) && (_my != (_i - (1 : stdgo.GoInt32)))) || ((_his != _i) && (_his != (_i - (1 : stdgo.GoInt32))))) {
                                    ...
                                    storeInt32(stdgo.Go.pointer(_ack[(_me : stdgo.GoInt)][((_i - (1 : stdgo.GoInt32)) % (3 : stdgo.GoInt32) : stdgo.GoInt)]), (-1 : stdgo.GoInt32));
                                });
                            };
                            _c.__send__(true);
                        };
...
function testStoreLoadSeqCst64(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            if (stdgo.runtime.Runtime.numCPU() == ((1 : stdgo.GoInt))) {
                _t.skipf(("Skipping test on %v processor machine" : stdgo.GoString), stdgo.Go.toInterface(stdgo.runtime.Runtime.numCPU()));
            ...
            var _c = new stdgo.Chan<Bool>((2 : stdgo.GoInt).toBasic(), () -> false);
            var x = (new stdgo.GoArray<stdgo.GoInt64>(...([].concat([for (i in 0 ... 2) (0 : stdgo.GoInt64)]))) : stdgo.GoArray<stdgo.GoInt64>);
            var _ack = (new stdgo.GoArray<stdgo.GoArray<stdgo.GoInt64>>((new stdgo.GoArray<stdgo.GoInt64>((-1i64 : stdgo.GoInt64), (-1i64 : stdgo.GoInt64), (-1i64 : stdgo.GoInt64)) : stdgo.GoArray<stdgo.GoInt64>), (new stdgo.GoArray<stdgo.GoInt64>((-1i64 : stdgo.GoInt64), (-1i64 : stdgo.GoInt64), (-1i64 : stdgo.GoInt64)) : stdgo.GoArray<stdgo.GoInt64>)) : stdgo.GoArray<stdgo.GoArray<stdgo.GoInt64>>);
            {
                var _p:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_p < (2 : stdgo.GoInt), _p++, {
                    stdgo.Go.routine(() -> {
                        var a = function(_me:stdgo.GoInt):Void {
                            var _he:stdgo.GoInt = (1 : stdgo.GoInt) - _me;
                            {
                                ...
                                stdgo.Go.cfor(_i < n, _i++, {
                                    ...
                                    storeInt64(stdgo.Go.pointer(_ack[(_me : stdgo.GoInt)][(_i % (3i64 : stdgo.GoInt64) : stdgo.GoInt)]), _my);
                                    {
                                        var _w:stdgo.GoInt = (1 : stdgo.GoInt);
                                        stdgo.Go.cfor(loadInt64(stdgo.Go.pointer(_ack[(_he : stdgo.GoInt)][(_i % (3i64 : stdgo.GoInt64) : stdgo.GoInt)])) == ((-1i64 : stdgo.GoInt64)), _w++, {
                                            if (_w % (1000 : stdgo.GoInt) == ((0 : stdgo.GoInt))) {
                                                stdgo.runtime.Runtime.gosched();
                                            };
                                        });
                                    };
                                    var _his:stdgo.GoInt64 = loadInt64(stdgo.Go.pointer(_ack[(_he : stdgo.GoInt)][(_i % (3i64 : stdgo.GoInt64) : stdgo.GoInt)]));
                                    if (((_my != _i) && (_my != (_i - (1i64 : stdgo.GoInt64)))) || ((_his != _i) && (_his != (_i - (1i64 : stdgo.GoInt64))))) {
                                        _t.errorf(("invalid values: %d/%d (%d)" : stdgo.GoString), stdgo.Go.toInterface(_my), stdgo.Go.toInterface(_his), stdgo.Go.toInterface(_i));
                                        break;
                                    };
                                    if ((_my != _i) && (_his != _i)) {
                                    ...
                                    storeInt64(stdgo.Go.pointer(_ack[(_me : stdgo.GoInt)][((_i - (1i64 : stdgo.GoInt64)) % (3i64 : stdgo.GoInt64) : stdgo.GoInt)]), (-1i64 : stdgo.GoInt64));
                                });
                            };
                            _c.__send__(true);
                        };
...
**/
@:structInit class T_testStoreLoadRelAcq32_26___localname___Data {
    public var _signal : stdgo.GoInt32 = 0;
    public var _pad1 : stdgo.GoArray<stdgo.GoInt8> = new stdgo.GoArray<stdgo.GoInt8>(...[for (i in 0 ... 128) (0 : stdgo.GoInt8)]);
    public var _data1 : stdgo.GoInt32 = 0;
    public var _pad2 : stdgo.GoArray<stdgo.GoInt8> = new stdgo.GoArray<stdgo.GoInt8>(...[for (i in 0 ... 128) (0 : stdgo.GoInt8)]);
    ...
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() {
        return new T_testStoreLoadRelAcq32_26___localname___Data(_signal, _pad1, _data1, _pad2, _data2);
    }
}
function testStoreLoadRelAcq32(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            if (stdgo.runtime.Runtime.numCPU() == ((1 : stdgo.GoInt))) {
                _t.skipf(("Skipping test on %v processor machine" : stdgo.GoString), stdgo.Go.toInterface(stdgo.runtime.Runtime.numCPU()));
            ...
            var _c = new stdgo.Chan<Bool>((2 : stdgo.GoInt).toBasic(), () -> false);
            {};
            var x:T_testStoreLoadRelAcq32_26___localname___Data = ({} : stdgo.sync.atomic_test.Atomic_test.T_testStoreLoadRelAcq32_26___localname___Data);
            {
                var _p:stdgo.GoInt32 = (0 : stdgo.GoInt32);
                stdgo.Go.cfor(_p < (2 : stdgo.GoInt32), _p++, {
                    stdgo.Go.routine(() -> {
                        var a = function(_p:stdgo.GoInt32):Void {
                            {
                                var _i:stdgo.GoInt32 = (1 : stdgo.GoInt32);
                                stdgo.Go.cfor(_i < n, _i++, {
                                    if ((_i + _p) % (2 : stdgo.GoInt32) == ((0 : stdgo.GoInt32))) {
                                        x._data1 = _i;
                                        ...
                                        if ((_d1 != _i) || (_d2 != (_i : stdgo.GoFloat32))) {
...
**/
@:structInit class T_testStoreLoadRelAcq64_27___localname___Data {
    ...
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() {
        return new T_testStoreLoadRelAcq64_27___localname___Data(_signal, _pad1, _data1, _pad2, _data2);
    }
}
function testStoreLoadRelAcq64(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            if (stdgo.runtime.Runtime.numCPU() == ((1 : stdgo.GoInt))) {
                _t.skipf(("Skipping test on %v processor machine" : stdgo.GoString), stdgo.Go.toInterface(stdgo.runtime.Runtime.numCPU()));
            ...
            var _c = new stdgo.Chan<Bool>((2 : stdgo.GoInt).toBasic(), () -> false);
            {};
            var x:T_testStoreLoadRelAcq64_27___localname___Data = ({} : stdgo.sync.atomic_test.Atomic_test.T_testStoreLoadRelAcq64_27___localname___Data);
            {
                var _p:stdgo.GoInt64 = (0i64 : stdgo.GoInt64);
                stdgo.Go.cfor(_p < (2i64 : stdgo.GoInt64), _p++, {
                    stdgo.Go.routine(() -> {
                        var a = function(_p:stdgo.GoInt64):Void {
                            {
                                var _i:stdgo.GoInt64 = (1i64 : stdgo.GoInt64);
                                stdgo.Go.cfor(_i < n, _i++, {
                                    if ((_i + _p) % (2i64 : stdgo.GoInt64) == ((0i64 : stdgo.GoInt64))) {
                                        x._data1 = _i;
                                        ...
                                        if ((_d1 != _i) || (_d2 != (_i : stdgo.GoFloat64))) {
                                            _t.errorf(("incorrect data: %d/%g (%d)" : stdgo.GoString), stdgo.Go.toInterface(_d1), stdgo.Go.toInterface(_d2), stdgo.Go.toInterface(_i));
                                            break;
                                        };
                                    };
...
function _shouldPanic(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _name:stdgo.GoString, _f:() -> Void):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            __deferstack__.unshift(() -> {
                var a = function():Void {
...
function testUnaligned64(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        if (false) {
        ...
        _shouldPanic(_t, ("StoreUint64Method" : stdgo.GoString), function():Void {
            ((stdgo.Go.toInterface(_p) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.refType({ get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.Uint64", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "__50", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.T_noCopy", [], stdgo.internal.reflect.Reflect.GoType.structType([]), false, { get : () -> null }) }, optional : false }, { name : "__51", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.T_align64", [], stdgo.internal.reflect.Reflect.GoType.structType([]), false, { get : () -> null }) }, optional : false }, { name : "_v", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint64_kind) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<Uint64>).store((1i64 : stdgo.GoUInt64));
        });
        ...
        _shouldPanic(_t, ("CompareAndSwapUint64Method" : stdgo.GoString), function():Void {
            ((stdgo.Go.toInterface(_p) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.refType({ get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.Uint64", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "__50", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.T_noCopy", [], stdgo.internal.reflect.Reflect.GoType.structType([]), false, { get : () -> null }) }, optional : false }, { name : "__51", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.T_align64", [], stdgo.internal.reflect.Reflect.GoType.structType([]), false, { get : () -> null }) }, optional : false }, { name : "_v", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint64_kind) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<Uint64>).compareAndSwap((1i64 : stdgo.GoUInt64), (2i64 : stdgo.GoUInt64));
        });
        ...
        _shouldPanic(_t, ("AddUint64Method" : stdgo.GoString), function():Void {
            ((stdgo.Go.toInterface(_p) : stdgo.unsafe.Unsafe.UnsafePointer).__convert__(stdgo.internal.reflect.Reflect.GoType.refType({ get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.Uint64", [], stdgo.internal.reflect.Reflect.GoType.structType([{ name : "__50", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.T_noCopy", [], stdgo.internal.reflect.Reflect.GoType.structType([]), false, { get : () -> null }) }, optional : false }, { name : "__51", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.named("stdgo.sync.atomic_.Atomic_.T_align64", [], stdgo.internal.reflect.Reflect.GoType.structType([]), false, { get : () -> null }) }, optional : false }, { name : "_v", embedded : false, tag : "", type : { get : () -> stdgo.internal.reflect.Reflect.GoType.basic(uint64_kind) }, optional : false }]), false, { get : () -> null }) })) : stdgo.Ref<Uint64>).add((3i64 : stdgo.GoUInt64));
        });
    }
function testAutoAligned64(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _signed:T__struct_12 = ({ _i : ({} : stdgo.sync.atomic_.Atomic_.Int64_) } : T__struct_12);
        {
            var _o:stdgo.GoUIntptr = stdgo.reflect.Reflect.typeOf(stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_signed) : stdgo.Ref<T__struct_12>)))).elem().field((1 : stdgo.GoInt)).offset;
            if (_o != ((8 : stdgo.GoUIntptr))) {
                _t.fatalf(("Int64 offset = %d, want 8" : stdgo.GoString), stdgo.Go.toInterface(_o));
            };
        };
        {
            var _p:stdgo.GoUIntptr = stdgo.reflect.Reflect.valueOf(stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_signed) : stdgo.Ref<T__struct_12>)))).elem().field((1 : stdgo.GoInt)).addr().pointer();
            if (_p & (7 : stdgo.GoUIntptr) != ((0 : stdgo.GoUIntptr))) {
        ...
        {
            var _o:stdgo.GoUIntptr = stdgo.reflect.Reflect.typeOf(stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_unsigned) : stdgo.Ref<T__struct_13>)))).elem().field((1 : stdgo.GoInt)).offset;
            if (_o != ((8 : stdgo.GoUIntptr))) {
                _t.fatalf(("Uint64 offset = %d, want 8" : stdgo.GoString), stdgo.Go.toInterface(_o));
            };
        };
        {
            var _p:stdgo.GoUIntptr = stdgo.reflect.Reflect.valueOf(stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_unsigned) : stdgo.Ref<T__struct_13>)))).elem().field((1 : stdgo.GoInt)).addr().pointer();
            if (_p & (7 : stdgo.GoUIntptr) != ((0 : stdgo.GoUIntptr))) {
                _t.fatalf(("Int64 pointer = %#x, want 8-aligned" : stdgo.GoString), stdgo.Go.toInterface(_p));
            };
        };
    }
function testNilDeref(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _funcs = (new stdgo.GoArray<() -> Void>(
function():Void {
            compareAndSwapInt32((null : stdgo.Pointer<stdgo.GoInt32>), (0 : stdgo.GoInt32), (0 : stdgo.GoInt32));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Int32>) : stdgo.Ref<Int32>).compareAndSwap((0 : stdgo.GoInt32), (0 : stdgo.GoInt32));
        },
function():Void {
            compareAndSwapInt64((null : stdgo.Pointer<stdgo.GoInt64>), (0i64 : stdgo.GoInt64), (0i64 : stdgo.GoInt64));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Int64_>) : stdgo.Ref<Int64_>).compareAndSwap((0i64 : stdgo.GoInt64), (0i64 : stdgo.GoInt64));
        },
function():Void {
            compareAndSwapUint32((null : stdgo.Pointer<stdgo.GoUInt32>), (0u32 : stdgo.GoUInt32), (0u32 : stdgo.GoUInt32));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Uint32>) : stdgo.Ref<Uint32>).compareAndSwap((0u32 : stdgo.GoUInt32), (0u32 : stdgo.GoUInt32));
        },
function():Void {
            compareAndSwapUint64((null : stdgo.Pointer<stdgo.GoUInt64>), (0i64 : stdgo.GoUInt64), (0i64 : stdgo.GoUInt64));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Uint64>) : stdgo.Ref<Uint64>).compareAndSwap((0i64 : stdgo.GoUInt64), (0i64 : stdgo.GoUInt64));
        },
function():Void {
            compareAndSwapUintptr((null : stdgo.Pointer<stdgo.GoUIntptr>), (0 : stdgo.GoUIntptr), (0 : stdgo.GoUIntptr));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Uintptr>) : stdgo.Ref<Uintptr>).compareAndSwap((0 : stdgo.GoUIntptr), (0 : stdgo.GoUIntptr));
        },
function():Void {
            compareAndSwapPointer((null : stdgo.Pointer<stdgo.unsafe.Unsafe.UnsafePointer>), @:default_value null, @:default_value null);
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Pointer_<stdgo.GoUInt8>>) : stdgo.Ref<Pointer_<stdgo.GoByte>>).compareAndSwap((null : stdgo.Pointer<stdgo.GoUInt8>), (null : stdgo.Pointer<stdgo.GoUInt8>));
        },
function():Void {
            swapInt32((null : stdgo.Pointer<stdgo.GoInt32>), (0 : stdgo.GoInt32));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Int32>) : stdgo.Ref<Int32>).swap((0 : stdgo.GoInt32));
        },
function():Void {
            swapUint32((null : stdgo.Pointer<stdgo.GoUInt32>), (0u32 : stdgo.GoUInt32));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Uint32>) : stdgo.Ref<Uint32>).swap((0u32 : stdgo.GoUInt32));
        },
function():Void {
            swapInt64((null : stdgo.Pointer<stdgo.GoInt64>), (0i64 : stdgo.GoInt64));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Int64_>) : stdgo.Ref<Int64_>).swap((0i64 : stdgo.GoInt64));
        },
function():Void {
            swapUint64((null : stdgo.Pointer<stdgo.GoUInt64>), (0i64 : stdgo.GoUInt64));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Uint64>) : stdgo.Ref<Uint64>).swap((0i64 : stdgo.GoUInt64));
        },
function():Void {
            swapUintptr((null : stdgo.Pointer<stdgo.GoUIntptr>), (0 : stdgo.GoUIntptr));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Uintptr>) : stdgo.Ref<Uintptr>).swap((0 : stdgo.GoUIntptr));
        },
function():Void {
            swapPointer((null : stdgo.Pointer<stdgo.unsafe.Unsafe.UnsafePointer>), @:default_value null);
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Pointer_<stdgo.GoUInt8>>) : stdgo.Ref<Pointer_<stdgo.GoByte>>).swap((null : stdgo.Pointer<stdgo.GoUInt8>));
        },
function():Void {
            addInt32((null : stdgo.Pointer<stdgo.GoInt32>), (0 : stdgo.GoInt32));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Int32>) : stdgo.Ref<Int32>).add((0 : stdgo.GoInt32));
        },
function():Void {
            addUint32((null : stdgo.Pointer<stdgo.GoUInt32>), (0u32 : stdgo.GoUInt32));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Uint32>) : stdgo.Ref<Uint32>).add((0u32 : stdgo.GoUInt32));
        },
function():Void {
            addInt64((null : stdgo.Pointer<stdgo.GoInt64>), (0i64 : stdgo.GoInt64));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Int64_>) : stdgo.Ref<Int64_>).add((0i64 : stdgo.GoInt64));
        },
function():Void {
            addUint64((null : stdgo.Pointer<stdgo.GoUInt64>), (0i64 : stdgo.GoUInt64));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Uint64>) : stdgo.Ref<Uint64>).add((0i64 : stdgo.GoUInt64));
        },
function():Void {
            addUintptr((null : stdgo.Pointer<stdgo.GoUIntptr>), (0 : stdgo.GoUIntptr));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Uintptr>) : stdgo.Ref<Uintptr>).add((0 : stdgo.GoUIntptr));
        },
function():Void {
            loadInt32((null : stdgo.Pointer<stdgo.GoInt32>));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Int32>) : stdgo.Ref<Int32>).load();
        },
function():Void {
            loadInt64((null : stdgo.Pointer<stdgo.GoInt64>));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Int64_>) : stdgo.Ref<Int64_>).load();
        },
function():Void {
            loadUint32((null : stdgo.Pointer<stdgo.GoUInt32>));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Uint32>) : stdgo.Ref<Uint32>).load();
        },
function():Void {
            loadUint64((null : stdgo.Pointer<stdgo.GoUInt64>));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Uint64>) : stdgo.Ref<Uint64>).load();
        },
function():Void {
            loadUintptr((null : stdgo.Pointer<stdgo.GoUIntptr>));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Uintptr>) : stdgo.Ref<Uintptr>).load();
        },
function():Void {
            loadPointer((null : stdgo.Pointer<stdgo.unsafe.Unsafe.UnsafePointer>));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Pointer_<stdgo.GoUInt8>>) : stdgo.Ref<Pointer_<stdgo.GoByte>>).load();
        },
function():Void {
            storeInt32((null : stdgo.Pointer<stdgo.GoInt32>), (0 : stdgo.GoInt32));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Int32>) : stdgo.Ref<Int32>).store((0 : stdgo.GoInt32));
        },
function():Void {
            storeInt64((null : stdgo.Pointer<stdgo.GoInt64>), (0i64 : stdgo.GoInt64));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Int64_>) : stdgo.Ref<Int64_>).store((0i64 : stdgo.GoInt64));
        },
function():Void {
            storeUint32((null : stdgo.Pointer<stdgo.GoUInt32>), (0u32 : stdgo.GoUInt32));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Uint32>) : stdgo.Ref<Uint32>).store((0u32 : stdgo.GoUInt32));
        },
function():Void {
            storeUint64((null : stdgo.Pointer<stdgo.GoUInt64>), (0i64 : stdgo.GoUInt64));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Uint64>) : stdgo.Ref<Uint64>).store((0i64 : stdgo.GoUInt64));
        },
function():Void {
            storeUintptr((null : stdgo.Pointer<stdgo.GoUIntptr>), (0 : stdgo.GoUIntptr));
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Uintptr>) : stdgo.Ref<Uintptr>).store((0 : stdgo.GoUIntptr));
        },
function():Void {
            storePointer((null : stdgo.Pointer<stdgo.unsafe.Unsafe.UnsafePointer>), @:default_value null);
        },
function():Void {
            ((null : stdgo.Ref<stdgo.sync.atomic_.Atomic_.Pointer_<stdgo.GoUInt8>>) : stdgo.Ref<Pointer_<stdgo.GoByte>>).store((null : stdgo.Pointer<stdgo.GoUInt8>));
        }) : stdgo.GoArray<() -> Void>);
...
@:named typedef T_exampleValue_readMostly_28___localname___Map = stdgo.GoMap<stdgo.GoString, stdgo.GoString>;
/**
...
function exampleValue_readMostly():Void {
        ...
        var _read:stdgo.GoString -> stdgo.GoString = function(_key:stdgo.GoString):stdgo.GoString {
            ...
            var _m1:stdgo.sync.atomic_test.Atomic_test.T_exampleValue_readMostly_28___localname___Map = (stdgo.Go.typeAssert((_m.load() : T_exampleValue_readMostly_28___localname___Map)) : T_exampleValue_readMostly_28___localname___Map);
        ...
        var _insert:(stdgo.GoString, stdgo.GoString) -> Void = function(_key:stdgo.GoString, _val:stdgo.GoString):Void {
            ...
            try {
                ...
                var _m1:stdgo.sync.atomic_test.Atomic_test.T_exampleValue_readMostly_28___localname___Map = (stdgo.Go.typeAssert((_m.load() : T_exampleValue_readMostly_28___localname___Map)) : T_exampleValue_readMostly_28___localname___Map);
                var _m2:stdgo.sync.atomic_test.Atomic_test.T_exampleValue_readMostly_28___localname___Map = ({
                    final x = new stdgo.GoMap.GoStringMap<stdgo.GoString>();
                    x.__defaultValue__ = () -> ("" : stdgo.GoString);
                    @:mergeBlock {};
                    x;
...
function testValue(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        _x = _v.load();
        {
            ...
            if (!_ok || (_xx != (84 : stdgo.GoInt))) {
                _t.fatalf(("wrong value: got %+v, want 84" : stdgo.GoString), _x);
            };
        };
    }
function testValueLarge(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _v:Value = ({} : stdgo.sync.atomic_.Atomic_.Value);
...
function testValuePanic(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
        {};
        var _v:Value = ({} : stdgo.sync.atomic_.Atomic_.Value);
        {
...
function testValueConcurrent(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        var _p:stdgo.GoInt = (4 : stdgo.GoInt) * stdgo.runtime.Runtime.gomaxprocs((0 : stdgo.GoInt));
...
function benchmarkValueRead(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _v:Value = ({} : stdgo.sync.atomic_.Atomic_.Value);
...
function testValue_Swap(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testValueSwapConcurrent(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _v:Value = ({} : stdgo.sync.atomic_.Atomic_.Value);
                            ...
                            stdgo.Go.cfor(_new < (_i + _n), _new++, {
                                {
                                    ...
                                    if (_old != null) {
                                        _c = _c + ((stdgo.Go.typeAssert((_old : stdgo.GoUInt64)) : stdgo.GoUInt64));
                                    };
                                };
                            });
                        };
        ...
        _g.wait_();
        {
            var __0:stdgo.GoUInt64 = (((_m * _n) - (1i64 : stdgo.GoUInt64)) * (_m * _n)) / (2i64 : stdgo.GoUInt64), __1:stdgo.GoUInt64 = _count + (stdgo.Go.typeAssert((_v.load() : stdgo.GoUInt64)) : stdgo.GoUInt64), _got:stdgo.GoUInt64 = __1, _want:stdgo.GoUInt64 = __0;
            if (_got != (_want)) {
                _t.errorf(("sum from 0 to %d was %d, want %v" : stdgo.GoString), stdgo.Go.toInterface((_m * _n) - (1i64 : stdgo.GoUInt64)), stdgo.Go.toInterface(_got), stdgo.Go.toInterface(_want));
            };
        };
    }
function testValue_CompareAndSwap(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testValueCompareAndSwapConcurrent(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _v:Value = ({} : stdgo.sync.atomic_.Atomic_.Value);
                    ...
                    var a = function():Void {
                        {
                            ...
                            stdgo.Go.cfor(_j < (_m * _n), stdgo.runtime.Runtime.gosched(), {
                                if (_v.compareAndSwap(stdgo.Go.toInterface(_j), stdgo.Go.toInterface(_j + (1 : stdgo.GoInt)))) {
                                    _j = _j + (_m);
                                };
                            });
                        };
