...
**/
var _bufPool : stdgo.sync.Sync.Pool = ({ new_ : function():stdgo.AnyInterface {
...
**/
var __2 : stdgo.sync_test.Sync_test.T_mapInterface = stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.sync_test.Sync_test.RWMutexMap() : stdgo.sync_test.Sync_test.RWMutexMap)) : stdgo.Ref<stdgo.sync_test.Sync_test.RWMutexMap>));
/**
    
    
    
**/
var __3 : stdgo.sync_test.Sync_test.T_mapInterface = stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.sync_test.Sync_test.DeepCopyMap() : stdgo.sync_test.Sync_test.DeepCopyMap)) : stdgo.Ref<stdgo.sync_test.Sync_test.DeepCopyMap>));
/**
...
@:structInit @:private class T_bench {
    public var _setup : (stdgo.Ref<stdgo.testing.Testing.B>, stdgo.sync_test.Sync_test.T_mapInterface) -> Void = null;
    public var _perG : (stdgo.Ref<stdgo.testing.Testing.B>, stdgo.Ref<stdgo.testing.Testing.PB>, stdgo.GoInt, stdgo.sync_test.Sync_test.T_mapInterface) -> Void = null;
    public function new(?_setup:(stdgo.Ref<stdgo.testing.Testing.B>, stdgo.sync_test.Sync_test.T_mapInterface) -> Void, ?_perG:(stdgo.Ref<stdgo.testing.Testing.B>, stdgo.Ref<stdgo.testing.Testing.PB>, stdgo.GoInt, stdgo.sync_test.Sync_test.T_mapInterface) -> Void) {
...
@:structInit @:using(stdgo.sync_test.Sync_test.RWMutexMap_static_extension) class RWMutexMap {
    ...
    public function new(?_mu:stdgo.sync.Sync.RWMutex, ?_dirty:stdgo.GoMap<stdgo.AnyInterface, stdgo.AnyInterface>) {
...
@:structInit @:private @:using(stdgo.sync_test.Sync_test.T_mapCall_static_extension) class T_mapCall {
    ...
    public function new(?_op:stdgo.sync_test.Sync_test.T_mapOp, ?_k:stdgo.AnyInterface, ?_v:stdgo.AnyInterface) {
...
@:named @:using(stdgo.sync_test.Sync_test.T_one_static_extension) typedef T_one = stdgo.GoInt;
function testCondSignal(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _m:Mutex = ({} : stdgo.sync.Sync.Mutex);
        var _c = newCond(stdgo.Go.asInterface((stdgo.Go.setRef(_m) : stdgo.Ref<stdgo.sync.Sync.Mutex>)));
...
function testCondSignalGenerations(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _m:Mutex = ({} : stdgo.sync.Sync.Mutex);
        var _c = newCond(stdgo.Go.asInterface((stdgo.Go.setRef(_m) : stdgo.Ref<stdgo.sync.Sync.Mutex>)));
        ...
        var _awake = new stdgo.Chan<stdgo.GoInt>((_n : stdgo.GoInt).toBasic(), () -> (0 : stdgo.GoInt));
        {
            ...
            stdgo.Go.cfor(_i < _n, _i++, {
                ...
                if (_i > (0 : stdgo.GoInt)) {
                    var _a:stdgo.GoInt = _awake.__get__();
                    if (_a != (_i - (1 : stdgo.GoInt))) {
                        _t.fatalf(("wrong goroutine woke up: want %d, got %d" : stdgo.GoString), stdgo.Go.toInterface(_i - (1 : stdgo.GoInt)), stdgo.Go.toInterface(_a));
                    };
                };
                _running.__get__();
                _m.lock();
...
function testCondBroadcast(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _m:Mutex = ({} : stdgo.sync.Sync.Mutex);
        var _c = newCond(stdgo.Go.asInterface((stdgo.Go.setRef(_m) : stdgo.Ref<stdgo.sync.Sync.Mutex>)));
        ...
        };
        {
            ...
            stdgo.Go.cfor(_i < _n, _i++, {
                ...
                var _seen = new stdgo.Slice<Bool>((_n : stdgo.GoInt).toBasic(), 0);
                {
                    var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                    stdgo.Go.cfor(_i < _n, _i++, {
                        var _g:stdgo.GoInt = _awake.__get__();
...
function testRace(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _x:stdgo.GoInt = (0 : stdgo.GoInt);
        var _c = newCond(stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.sync.Sync.Mutex() : stdgo.sync.Sync.Mutex)) : stdgo.Ref<stdgo.sync.Sync.Mutex>)));
...
function testCondSignalStealing(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {
            var _iters:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_iters < (1000 : stdgo.GoInt), _iters++, {
                var _m:Mutex = ({} : stdgo.sync.Sync.Mutex);
                var _cond = newCond(stdgo.Go.asInterface((stdgo.Go.setRef(_m) : stdgo.Ref<stdgo.sync.Sync.Mutex>)));
...
function testCondCopy(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        try {
            ...
            var _c:stdgo.sync.Sync.Cond = ({ l : stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.sync.Sync.Mutex() : stdgo.sync.Sync.Mutex)) : stdgo.Ref<stdgo.sync.Sync.Mutex>)) } : stdgo.sync.Sync.Cond);
            _c.signal();
            var _c2:Cond = ({} : stdgo.sync.Sync.Cond);
            stdgo.reflect.Reflect.valueOf(stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_c2) : stdgo.Ref<stdgo.sync.Sync.Cond>)))).elem().set(stdgo.reflect.Reflect.valueOf(stdgo.Go.toInterface(stdgo.Go.asInterface((stdgo.Go.setRef(_c) : stdgo.Ref<stdgo.sync.Sync.Cond>)))).elem()?.__copy__());
            _c2.signal();
            {
...
function benchmarkCond1(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkCond(_b, (1 : stdgo.GoInt));
    }
function benchmarkCond2(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkCond(_b, (2 : stdgo.GoInt));
    }
function benchmarkCond4(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkCond(_b, (4 : stdgo.GoInt));
    }
function benchmarkCond8(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkCond(_b, (8 : stdgo.GoInt));
    }
function benchmarkCond16(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkCond(_b, (16 : stdgo.GoInt));
    }
function benchmarkCond32(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkCond(_b, (32 : stdgo.GoInt));
    }
function _benchmarkCond(_b:stdgo.Ref<stdgo.testing.Testing.B>, _waiters:stdgo.GoInt):Void {
        var _c = newCond(stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.sync.Sync.Mutex() : stdgo.sync.Sync.Mutex)) : stdgo.Ref<stdgo.sync.Sync.Mutex>)));
        var _done = new stdgo.Chan<Bool>(0, () -> false);
        var _id:stdgo.GoInt = (0 : stdgo.GoInt);
        {
            var _routine:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_routine < (_waiters + (1 : stdgo.GoInt)), _routine++, {
                stdgo.Go.routine(() -> {
                    var a = function():Void {
                        {
                            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
...
function _timeNow():stdgo.time.Time.Time {
        return stdgo.time.Time.unix((1136214245i64 : stdgo.GoInt64), (0i64 : stdgo.GoInt64))?.__copy__();
    }
function log(_w:stdgo.io.Io.Writer, _key:stdgo.GoString, _val:stdgo.GoString):Void {
        var _b = (stdgo.Go.typeAssert((_bufPool.get() : stdgo.Ref<stdgo.bytes.Bytes.Buffer>)) : stdgo.Ref<stdgo.bytes.Bytes.Buffer>);
        _b.reset();
...
function _benchMap(_b:stdgo.Ref<stdgo.testing.Testing.B>, _bench:T_bench):Void {
        for (__4 => _m in (new stdgo.GoArray<stdgo.sync_test.Sync_test.T_mapInterface>(stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.sync_test.Sync_test.DeepCopyMap() : stdgo.sync_test.Sync_test.DeepCopyMap)) : stdgo.Ref<stdgo.sync_test.Sync_test.DeepCopyMap>)), stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.sync_test.Sync_test.RWMutexMap() : stdgo.sync_test.Sync_test.RWMutexMap)) : stdgo.Ref<stdgo.sync_test.Sync_test.RWMutexMap>)), stdgo.Go.asInterface((stdgo.Go.setRef((new stdgo.sync.Sync.Map_() : stdgo.sync.Sync.Map_)) : stdgo.Ref<stdgo.sync.Sync.Map_>))) : stdgo.GoArray<stdgo.sync_test.Sync_test.T_mapInterface>)) {
            _b.run(stdgo.fmt.Fmt.sprintf(("%T" : stdgo.GoString), stdgo.Go.toInterface(_m))?.__copy__(), function(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
                ...
                _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
                    var _id:stdgo.GoInt = (stdgo.sync.atomic_.Atomic_.addInt64(stdgo.Go.pointer(_i), (1i64 : stdgo.GoInt64)) - (1i64 : stdgo.GoInt64) : stdgo.GoInt);
                    _bench._perG(_b, _pb, _id * _b.n, _m);
                });
            });
        };
    }
function benchmarkLoadMostlyHits(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {};
        _benchMap(_b, ({ _setup : function(__4:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_i < (1023 : stdgo.GoInt), _i++, {
                    _m.loadOrStore(stdgo.Go.toInterface(_i), stdgo.Go.toInterface(_i));
                });
            };
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_i < (2046 : stdgo.GoInt), _i++, {
                    _m.load(stdgo.Go.toInterface(_i % (1023 : stdgo.GoInt)));
                });
            };
        }, _perG : function(_b:stdgo.Ref<stdgo.testing.Testing.B>, _pb:stdgo.Ref<stdgo.testing.Testing.PB>, _i:stdgo.GoInt, _m:T_mapInterface):Void {
            stdgo.Go.cfor(_pb.next(), _i++, {
                _m.load(stdgo.Go.toInterface(_i % (1024 : stdgo.GoInt)));
            });
        } } : stdgo.sync_test.Sync_test.T_bench));
    }
function benchmarkLoadMostlyMisses(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {};
        _benchMap(_b, ({ _setup : function(__4:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            ...
            };
            {
                ...
                stdgo.Go.cfor(_i < (2 : stdgo.GoInt), _i++, {
                    _m.load(stdgo.Go.toInterface(_i % (1 : stdgo.GoInt)));
                });
            };
        }, _perG : function(_b:stdgo.Ref<stdgo.testing.Testing.B>, _pb:stdgo.Ref<stdgo.testing.Testing.PB>, _i:stdgo.GoInt, _m:T_mapInterface):Void {
            stdgo.Go.cfor(_pb.next(), _i++, {
...
function benchmarkLoadOrStoreBalanced(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {};
        _benchMap(_b, ({ _setup : function(_b:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            {
                var __tmp__ = try {
                    { _0 : (stdgo.Go.typeAssert((stdgo.Go.toInterface(_m) : stdgo.Ref<DeepCopyMap>)) : stdgo.Ref<DeepCopyMap>), _1 : true };
                } catch(_) {
                    { _0 : (null : stdgo.Ref<stdgo.sync_test.Sync_test.DeepCopyMap>), _1 : false };
            ...
            };
            {
                ...
                stdgo.Go.cfor(_i < (256 : stdgo.GoInt), _i++, {
                    _m.load(stdgo.Go.toInterface(_i % (128 : stdgo.GoInt)));
                });
            };
        }, _perG : function(_b:stdgo.Ref<stdgo.testing.Testing.B>, _pb:stdgo.Ref<stdgo.testing.Testing.PB>, _i:stdgo.GoInt, _m:T_mapInterface):Void {
            stdgo.Go.cfor(_pb.next(), _i++, {
                var _j:stdgo.GoInt = _i % (256 : stdgo.GoInt);
                if (_j < (128 : stdgo.GoInt)) {
                    {
...
function benchmarkLoadOrStoreUnique(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchMap(_b, ({ _setup : function(_b:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            {
                var __tmp__ = try {
                    { _0 : (stdgo.Go.typeAssert((stdgo.Go.toInterface(_m) : stdgo.Ref<DeepCopyMap>)) : stdgo.Ref<DeepCopyMap>), _1 : true };
...
function benchmarkLoadOrStoreCollision(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchMap(_b, ({ _setup : function(__4:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
...
function benchmarkLoadAndDeleteBalanced(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {};
        _benchMap(_b, ({ _setup : function(_b:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            {
                var __tmp__ = try {
...
function benchmarkLoadAndDeleteUnique(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchMap(_b, ({ _setup : function(_b:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            {
                var __tmp__ = try {
                    { _0 : (stdgo.Go.typeAssert((stdgo.Go.toInterface(_m) : stdgo.Ref<DeepCopyMap>)) : stdgo.Ref<DeepCopyMap>), _1 : true };
...
function benchmarkLoadAndDeleteCollision(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchMap(_b, ({ _setup : function(__4:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            _m.loadOrStore(stdgo.Go.toInterface((0 : stdgo.GoInt)), stdgo.Go.toInterface((0 : stdgo.GoInt)));
        }, _perG : function(_b:stdgo.Ref<stdgo.testing.Testing.B>, _pb:stdgo.Ref<stdgo.testing.Testing.PB>, _i:stdgo.GoInt, _m:T_mapInterface):Void {
            stdgo.Go.cfor(_pb.next(), _i++, {
...
function benchmarkRange(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {};
        _benchMap(_b, ({ _setup : function(__4:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
...
**/
function benchmarkAdversarialAlloc(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchMap(_b, ({ _perG : function(_b:stdgo.Ref<stdgo.testing.Testing.B>, _pb:stdgo.Ref<stdgo.testing.Testing.PB>, _i:stdgo.GoInt, _m:T_mapInterface):Void {
            var __0:stdgo.GoInt64 = (0 : stdgo.GoInt64), __1:stdgo.GoInt64 = (0 : stdgo.GoInt64), _loadsSinceStore:stdgo.GoInt64 = __1, _stores:stdgo.GoInt64 = __0;
            stdgo.Go.cfor(_pb.next(), _i++, {
...
**/
function benchmarkAdversarialDelete(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {};
        _benchMap(_b, ({ _setup : function(__4:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            ...
            stdgo.Go.cfor(_pb.next(), _i++, {
                _m.load(stdgo.Go.toInterface(_i));
                if (_i % (1024 : stdgo.GoInt) == ((0 : stdgo.GoInt))) {
...
function benchmarkDeleteCollision(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchMap(_b, ({ _setup : function(__4:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            _m.loadOrStore(stdgo.Go.toInterface((0 : stdgo.GoInt)), stdgo.Go.toInterface((0 : stdgo.GoInt)));
        }, _perG : function(_b:stdgo.Ref<stdgo.testing.Testing.B>, _pb:stdgo.Ref<stdgo.testing.Testing.PB>, _i:stdgo.GoInt, _m:T_mapInterface):Void {
            stdgo.Go.cfor(_pb.next(), _i++, {
...
function benchmarkSwapCollision(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchMap(_b, ({ _setup : function(__4:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            _m.loadOrStore(stdgo.Go.toInterface((0 : stdgo.GoInt)), stdgo.Go.toInterface((0 : stdgo.GoInt)));
        }, _perG : function(_b:stdgo.Ref<stdgo.testing.Testing.B>, _pb:stdgo.Ref<stdgo.testing.Testing.PB>, _i:stdgo.GoInt, _m:T_mapInterface):Void {
            stdgo.Go.cfor(_pb.next(), _i++, {
...
function benchmarkSwapMostlyHits(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {};
        _benchMap(_b, ({ _setup : function(__4:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            ...
            stdgo.Go.cfor(_pb.next(), _i++, {
                if ((_i % (1024 : stdgo.GoInt)) < (1023 : stdgo.GoInt)) {
                    var _v:stdgo.GoInt = _i % (1024 : stdgo.GoInt);
...
function benchmarkSwapMostlyMisses(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {};
        _benchMap(_b, ({ _setup : function(__4:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            ...
            stdgo.Go.cfor(_pb.next(), _i++, {
                if ((_i % (1024 : stdgo.GoInt)) < (1 : stdgo.GoInt)) {
                    var _v:stdgo.GoInt = _i % (1024 : stdgo.GoInt);
                    _m.swap(stdgo.Go.toInterface(_v), stdgo.Go.toInterface(_v));
                } else {
                    _m.swap(stdgo.Go.toInterface(_i), stdgo.Go.toInterface(_i));
...
function benchmarkCompareAndSwapCollision(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchMap(_b, ({ _setup : function(__4:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            _m.loadOrStore(stdgo.Go.toInterface((0 : stdgo.GoInt)), stdgo.Go.toInterface((0 : stdgo.GoInt)));
        }, _perG : function(_b:stdgo.Ref<stdgo.testing.Testing.B>, _pb:stdgo.Ref<stdgo.testing.Testing.PB>, _i:stdgo.GoInt, _m:T_mapInterface):Void {
            while (_pb.next()) {
...
function benchmarkCompareAndSwapNoExistingKey(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchMap(_b, ({ _perG : function(_b:stdgo.Ref<stdgo.testing.Testing.B>, _pb:stdgo.Ref<stdgo.testing.Testing.PB>, _i:stdgo.GoInt, _m:T_mapInterface):Void {
            stdgo.Go.cfor(_pb.next(), _i++, {
...
function benchmarkCompareAndSwapValueNotEqual(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchMap(_b, ({ _setup : function(__4:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            _m.store(stdgo.Go.toInterface((0 : stdgo.GoInt)), stdgo.Go.toInterface((0 : stdgo.GoInt)));
        }, _perG : function(_b:stdgo.Ref<stdgo.testing.Testing.B>, _pb:stdgo.Ref<stdgo.testing.Testing.PB>, _i:stdgo.GoInt, _m:T_mapInterface):Void {
            stdgo.Go.cfor(_pb.next(), _i++, {
...
function benchmarkCompareAndSwapMostlyHits(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {};
        _benchMap(_b, ({ _setup : function(_b:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            {
                var __tmp__ = try {
            ...
            stdgo.Go.cfor(_pb.next(), _i++, {
                var _v:stdgo.GoInt = _i;
                if ((_i % (1024 : stdgo.GoInt)) < (1023 : stdgo.GoInt)) {
                    _v = _i % (1024 : stdgo.GoInt);
                };
                _m.compareAndSwap(stdgo.Go.toInterface(_v), stdgo.Go.toInterface(_v), stdgo.Go.toInterface(_v));
            });
        } } : stdgo.sync_test.Sync_test.T_bench));
    }
function benchmarkCompareAndSwapMostlyMisses(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {};
        _benchMap(_b, ({ _setup : function(__4:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
...
function benchmarkCompareAndDeleteCollision(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchMap(_b, ({ _setup : function(__4:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            _m.loadOrStore(stdgo.Go.toInterface((0 : stdgo.GoInt)), stdgo.Go.toInterface((0 : stdgo.GoInt)));
        }, _perG : function(_b:stdgo.Ref<stdgo.testing.Testing.B>, _pb:stdgo.Ref<stdgo.testing.Testing.PB>, _i:stdgo.GoInt, _m:T_mapInterface):Void {
            stdgo.Go.cfor(_pb.next(), _i++, {
...
function benchmarkCompareAndDeleteMostlyHits(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {};
        _benchMap(_b, ({ _setup : function(_b:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            {
                var __tmp__ = try {
...
function benchmarkCompareAndDeleteMostlyMisses(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {};
        _benchMap(_b, ({ _setup : function(__4:stdgo.Ref<stdgo.testing.Testing.B>, _m:T_mapInterface):Void {
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
...
function _randValue(_r:stdgo.Ref<stdgo.math.rand.Rand.Rand>):stdgo.AnyInterface {
        var _b = new stdgo.Slice<stdgo.GoUInt8>((_r.intn((4 : stdgo.GoInt)) : stdgo.GoInt).toBasic(), 0).__setNumber32__();
        for (_i => _ in _b) {
            _b[(_i : stdgo.GoInt)] = (97 : stdgo.GoUInt8) + (stdgo.math.rand.Rand.intn((26 : stdgo.GoInt)) : stdgo.GoByte);
        };
...
function _applyCalls(_m:T_mapInterface, _calls:stdgo.Slice<T_mapCall>):{ var _0 : stdgo.Slice<T_mapResult>; var _1 : stdgo.GoMap<stdgo.AnyInterface, stdgo.AnyInterface>; } {
        var _results:stdgo.Slice<T_mapResult> = (null : stdgo.Slice<stdgo.sync_test.Sync_test.T_mapResult>), _final:stdgo.GoMap<stdgo.AnyInterface, stdgo.AnyInterface> = (null : stdgo.GoMap<stdgo.AnyInterface, stdgo.AnyInterface>);
...
function testMapMatchesRWMutex(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {
...
function testMapMatchesDeepCopy(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {
...
function testConcurrentRange(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            {};
            var _m = _new(stdgo.sync.Sync.map_);
            {
                var _n:stdgo.GoInt64 = (1i64 : stdgo.GoInt64);
                stdgo.Go.cfor(_n <= (1024i64 : stdgo.GoInt64), _n++, {
            ...
            {
                var _g:stdgo.GoInt64 = (stdgo.runtime.Runtime.gomaxprocs((0 : stdgo.GoInt)) : stdgo.GoInt64);
                stdgo.Go.cfor(_g > (0i64 : stdgo.GoInt64), _g--, {
            ...
            var _iters:stdgo.GoInt = (1024 : stdgo.GoInt);
            if (stdgo.testing.Testing.short()) {
                _iters = (16 : stdgo.GoInt);
            };
            {
                var _n:stdgo.GoInt = _iters;
                stdgo.Go.cfor(_n > (0 : stdgo.GoInt), _n--, {
                    ...
                    _m.range(function(_ki:stdgo.AnyInterface, _vi:stdgo.AnyInterface):Bool {
                        var __0:stdgo.GoInt64 = (stdgo.Go.typeAssert((_ki : stdgo.GoInt64)) : stdgo.GoInt64), __1:stdgo.GoInt64 = (stdgo.Go.typeAssert((_vi : stdgo.GoInt64)) : stdgo.GoInt64), _v:stdgo.GoInt64 = __1, _k:stdgo.GoInt64 = __0;
                        if (_v % _k != ((0i64 : stdgo.GoInt64))) {
...
function testIssue40999(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        ...
        while (stdgo.sync.atomic_.Atomic_.loadUint32(stdgo.Go.pointer(_finalized)) == ((0u32 : stdgo.GoUInt32))) {
            var _p = _new(_int);
            stdgo.runtime.Runtime.setFinalizer(stdgo.Go.toInterface(_p), stdgo.Go.toInterface(function(_0:stdgo.Pointer<stdgo.GoInt>):Void {
                stdgo.sync.atomic_.Atomic_.addUint32(stdgo.Go.pointer(_finalized), (1u32 : stdgo.GoUInt32));
            }));
...
function testMapRangeNestedCall(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _m:stdgo.sync.Sync.Map_ = ({} : stdgo.sync.Sync.Map_);
...
function testCompareAndSwap_NonExistingKey(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _m = (stdgo.Go.setRef((new stdgo.sync.Sync.Map_() : stdgo.sync.Sync.Map_)) : stdgo.Ref<stdgo.sync.Sync.Map_>);
...
function testSemaphore(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _s = _new(_uint32);
...
function benchmarkUncontendedSemaphore(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _s = _new(_uint32);
        _s.value = (1u32 : stdgo.GoUInt32);
        hammerSemaphore(_s, _b.n, new stdgo.Chan<Bool>((2 : stdgo.GoInt).toBasic(), () -> false));
    }
function benchmarkContendedSemaphore(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            _b.stopTimer();
            var _s = _new(_uint32);
            ...
            var _c = new stdgo.Chan<Bool>(0, () -> false);
            {
                var _a0 = stdgo.runtime.Runtime.gomaxprocs((2 : stdgo.GoInt));
                __deferstack__.unshift(() -> stdgo.runtime.Runtime.gomaxprocs(_a0));
            };
            _b.startTimer();
            stdgo.Go.routine(() -> hammerSemaphore(_s, _b.n / (2 : stdgo.GoInt), _c));
            stdgo.Go.routine(() -> hammerSemaphore(_s, _b.n / (2 : stdgo.GoInt), _c));
            _c.__get__();
            _c.__get__();
            {
...
function hammerMutex(_m:stdgo.Ref<Mutex>, _loops:stdgo.GoInt, _cdone:stdgo.Chan<Bool>):Void {
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _loops, _i++, {
                if (_i % (3 : stdgo.GoInt) == ((0 : stdgo.GoInt))) {
                    if (_m.tryLock()) {
                        _m.unlock();
                    };
                    continue;
...
function testMutex(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            {
                var _n:stdgo.GoInt = stdgo.runtime.Runtime.setMutexProfileFraction((1 : stdgo.GoInt));
                if (_n != ((0 : stdgo.GoInt))) {
...
function testMutexMisuse(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        stdgo.internal.testenv.Testenv.mustHaveExec(stdgo.Go.asInterface(_t));
        for (__4 => _test in _misuseTests) {
            var __tmp__ = stdgo.os.exec.Exec.command(stdgo.os.Os.args[(0 : stdgo.GoInt)]?.__copy__(), ("TESTMISUSE" : stdgo.GoString), _test._name?.__copy__()).combinedOutput(), _out:stdgo.Slice<stdgo.GoUInt8> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
...
function testMutexFairness(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            var _mu:Mutex = ({} : stdgo.sync.Sync.Mutex);
...
**/
@:structInit @:using(stdgo.sync_test.Sync_test.T_benchmarkMutexUncontended_30___localname___PaddedMutex_static_extension) class T_benchmarkMutexUncontended_30___localname___PaddedMutex {
    @:embedded
    public var mutex : stdgo.sync.Sync.Mutex = ({} : stdgo.sync.Sync.Mutex);
    public var _pad : stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(...[for (i in 0 ... 128) (0 : stdgo.GoUInt8)]);
    public function new(?mutex:stdgo.sync.Sync.Mutex, ?_pad:stdgo.GoArray<stdgo.GoUInt8>) {
    ...
    @:embedded
    public function _unlockSlow(__0:stdgo.GoInt32) mutex._unlockSlow(__0);
    public function __copy__() {
        return new T_benchmarkMutexUncontended_30___localname___PaddedMutex(mutex, _pad);
    }
}
function benchmarkMutexUncontended(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {};
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            var _mu:T_benchmarkMutexUncontended_30___localname___PaddedMutex = ({} : stdgo.sync_test.Sync_test.T_benchmarkMutexUncontended_30___localname___PaddedMutex);
            while (_pb.next()) {
                _mu.lock();
                _mu.unlock();
            };
...
function _benchmarkMutex(_b:stdgo.Ref<stdgo.testing.Testing.B>, _slack:Bool, _work:Bool):Void {
        var _mu:Mutex = ({} : stdgo.sync.Sync.Mutex);
        if (_slack) {
            _b.setParallelism((10 : stdgo.GoInt));
        };
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            var _foo:stdgo.GoInt = (0 : stdgo.GoInt);
            while (_pb.next()) {
                _mu.lock();
                _mu.unlock();
                if (_work) {
...
function benchmarkMutex(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkMutex(_b, false, false);
    }
function benchmarkMutexSlack(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkMutex(_b, true, false);
    }
function benchmarkMutexWork(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkMutex(_b, false, true);
    }
function benchmarkMutexWorkSlack(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkMutex(_b, true, true);
    }
function benchmarkMutexNoSpin(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _m:Mutex = ({} : stdgo.sync.Sync.Mutex);
        ...
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            var _c = new stdgo.Chan<Bool>(0, () -> false);
            var _data:stdgo.GoArray<stdgo.GoUInt64> = new stdgo.GoArray<stdgo.GoUInt64>(...[for (i in 0 ... 4096) (0 : stdgo.GoUInt64)]);
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_pb.next(), _i++, {
                    if (_i % (4 : stdgo.GoInt) == ((0 : stdgo.GoInt))) {
                        _m.lock();
                        _acc0 = _acc0 - ((100i64 : stdgo.GoUInt64));
                        _acc1 = _acc1 + ((100i64 : stdgo.GoUInt64));
                        _m.unlock();
                    } else {
                        {
                            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                            stdgo.Go.cfor(_i < (_data.length), _i = _i + ((4 : stdgo.GoInt)), {
...
function benchmarkMutexSpin(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _m:Mutex = ({} : stdgo.sync.Sync.Mutex);
        var __0:stdgo.GoUInt64 = (0 : stdgo.GoUInt64), __1:stdgo.GoUInt64 = (0 : stdgo.GoUInt64), _acc1:stdgo.GoUInt64 = __1, _acc0:stdgo.GoUInt64 = __0;
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            var _data:stdgo.GoArray<stdgo.GoUInt64> = new stdgo.GoArray<stdgo.GoUInt64>(...[for (i in 0 ... 16384) (0 : stdgo.GoUInt64)]);
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_pb.next(), _i++, {
                    _m.lock();
...
function _run(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _once:stdgo.Ref<Once>, _o:stdgo.Pointer<T_one>, _c:stdgo.Chan<Bool>):Void {
...
function testOnce(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _o = _new(_one);
        var _once = _new(once);
        var _c = new stdgo.Chan<Bool>(0, () -> false);
        {};
...
function testOncePanic(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function benchmarkOnce(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _once:Once = ({} : stdgo.sync.Sync.Once);
...
function testOnceFunc(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _calls:stdgo.GoInt = (0 : stdgo.GoInt);
        var _f:() -> Void = stdgo.sync.Sync.onceFunc(function():Void {
            _calls++;
        });
        var _allocs:stdgo.GoFloat64 = stdgo.testing.Testing.allocsPerRun((10 : stdgo.GoInt), _f);
...
function testOnceValue(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _calls:stdgo.GoInt = (0 : stdgo.GoInt);
        var _f:() -> stdgo.GoInt = stdgo.sync.Sync.onceValue((0 : stdgo.GoInt), function():stdgo.GoInt {
            _calls++;
            return _calls;
        });
        var _allocs:stdgo.GoFloat64 = stdgo.testing.Testing.allocsPerRun((10 : stdgo.GoInt), function():Void {
            _f();
        });
        var _value:stdgo.GoInt = _f();
        if (_calls != ((1 : stdgo.GoInt))) {
            _t.errorf(("want calls==1, got %d" : stdgo.GoString), stdgo.Go.toInterface(_calls));
        };
...
function testOnceValues(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _calls:stdgo.GoInt = (0 : stdgo.GoInt);
        var _f:() -> { var _0 : stdgo.GoInt; var _1 : stdgo.GoInt; } = stdgo.sync.Sync.onceValues((0 : stdgo.GoInt), (0 : stdgo.GoInt), function():{ var _0 : stdgo.GoInt; var _1 : stdgo.GoInt; } {
            _calls++;
            return { _0 : _calls, _1 : _calls + (1 : stdgo.GoInt) };
        });
        var _allocs:stdgo.GoFloat64 = stdgo.testing.Testing.allocsPerRun((10 : stdgo.GoInt), function():Void {
            _f();
        });
        ...
        if ((_v1 != (1 : stdgo.GoInt)) || (_v2 != (2 : stdgo.GoInt))) {
...
function _testOncePanicX(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _calls:stdgo.Pointer<stdgo.GoInt>, _f:() -> Void):Void {
...
function _testOncePanicWith(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _calls:stdgo.Pointer<stdgo.GoInt>, _f:() -> Void, _check:(_label:stdgo.GoString, _p:stdgo.AnyInterface) -> Void):Void {
...
function testOnceFuncPanic(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _calls:stdgo.GoInt = (0 : stdgo.GoInt);
        var _f:() -> Void = stdgo.sync.Sync.onceFunc(function():Void {
            _calls++;
...
function testOnceValuePanic(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _calls:stdgo.GoInt = (0 : stdgo.GoInt);
        var _f:() -> stdgo.GoInt = stdgo.sync.Sync.onceValue((0 : stdgo.GoInt), function():stdgo.GoInt {
            _calls++;
            throw stdgo.Go.toInterface(("x" : stdgo.GoString));
...
function testOnceValuesPanic(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _calls:stdgo.GoInt = (0 : stdgo.GoInt);
        var _f:() -> { var _0 : stdgo.GoInt; var _1 : stdgo.GoInt; } = stdgo.sync.Sync.onceValues((0 : stdgo.GoInt), (0 : stdgo.GoInt), function():{ var _0 : stdgo.GoInt; var _1 : stdgo.GoInt; } {
            _calls++;
            throw stdgo.Go.toInterface(("x" : stdgo.GoString));
...
function testOnceFuncPanicNil(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _calls:stdgo.GoInt = (0 : stdgo.GoInt);
        var _f:() -> Void = stdgo.sync.Sync.onceFunc(function():Void {
            _calls++;
        ...
        _testOncePanicWith(_t, stdgo.Go.pointer(_calls), _f, function(_label:stdgo.GoString, _p:stdgo.AnyInterface):Void {
            {
                final __type__ = _p;
                if (__type__ == null || stdgo.Go.typeEquals((__type__ : stdgo.Ref<stdgo.runtime.Runtime.PanicNilError>))) {
                    return;
                };
            };
...
function testOnceFuncGoexit(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _calls:stdgo.GoInt = (0 : stdgo.GoInt);
        var _f:() -> Void = stdgo.sync.Sync.onceFunc(function():Void {
            _calls++;
...
function testOnceFuncPanicTraceback(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            ...
            __deferstack__.unshift(() -> {
                var a = function():Void {
                    ...
                    if (!stdgo.bytes.Bytes.contains(_stack, (_want : stdgo.Slice<stdgo.GoByte>))) {
...
function benchmarkOnceFunc(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.run(("v=Once" : stdgo.GoString), function(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
            _b.reportAllocs();
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_i < _b.n, _i++, {
        ...
        _b.run(("v=Global" : stdgo.GoString), function(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
            _b.reportAllocs();
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_i < _b.n, _i++, {
        ...
        _b.run(("v=Local" : stdgo.GoString), function(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
            _b.reportAllocs();
            var _f:() -> Void = stdgo.sync.Sync.onceFunc(function():Void {});
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
...
function benchmarkOnceValue(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.run(("v=Once" : stdgo.GoString), function(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
            _b.reportAllocs();
            {
                var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_i < _b.n, _i++, {
                    {
                        var __0:stdgo.GoInt = (42 : stdgo.GoInt), __1:stdgo.GoInt = _doOnceValue(), _got:stdgo.GoInt = __1, _want:stdgo.GoInt = __0;
                        if (_want != (_got)) {
        ...
        _b.run(("v=Global" : stdgo.GoString), function(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
            _b.reportAllocs();
            {
                ...
                stdgo.Go.cfor(_i < _b.n, _i++, {
                    {
                        var __0:stdgo.GoInt = (42 : stdgo.GoInt), __1:stdgo.GoInt = _onceValue(), _got:stdgo.GoInt = __1, _want:stdgo.GoInt = __0;
                        if (_want != (_got)) {
                            _b.fatalf(("want %d, got %d" : stdgo.GoString), stdgo.Go.toInterface(_want), stdgo.Go.toInterface(_got));
                        };
                    };
...
function testPool(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            {
            ...
            {
                var _g:stdgo.AnyInterface = _p.get();
...
function testPoolNew(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            {
                var _a0 = stdgo.runtime.debug.Debug.setGCPercent((-1 : stdgo.GoInt));
            ...
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            var _p:stdgo.sync.Sync.Pool = ({ new_ : function():stdgo.AnyInterface {
                _i++;
                return stdgo.Go.toInterface(_i);
            } } : stdgo.sync.Sync.Pool);
            {
                var _v:stdgo.AnyInterface = _p.get();
...
**/
function testPoolGC(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        _testPool(_t, true);
    }
/**
    // Test that Pool releases resources on GC.
**/
function testPoolRelease(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        _testPool(_t, false);
    }
function _testPool(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _drain:Bool):Void {
        stdgo.internal.Macro.controlFlow({
            var _p:Pool = ({} : stdgo.sync.Sync.Pool);
            {};
            @:label("loop") {
                var _try:stdgo.GoInt = (0 : stdgo.GoInt);
                stdgo.Go.cfor(_try < (3 : stdgo.GoInt), _try++, {
                    if ((_try == (1 : stdgo.GoInt)) && stdgo.testing.Testing.short()) {
                        break;
                    };
                    var __0:stdgo.GoUInt32 = (0 : stdgo.GoUInt32), __1:stdgo.GoUInt32 = (0 : stdgo.GoUInt32), _fin1:stdgo.GoUInt32 = __1, _fin:stdgo.GoUInt32 = __0;
                    {
                        var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                        stdgo.Go.cfor(_i < (100 : stdgo.GoInt), _i++, {
                            var _v = _new(_string);
                            stdgo.runtime.Runtime.setFinalizer(stdgo.Go.toInterface(_v), stdgo.Go.toInterface(function(_vv:stdgo.Pointer<stdgo.GoString>):Void {
                                stdgo.sync.atomic_.Atomic_.addUint32(stdgo.Go.pointer(_fin), (1u32 : stdgo.GoUInt32));
                            }));
                    ...
                    };
                    {
                        ...
                        stdgo.Go.cfor(_i < (5 : stdgo.GoInt), _i++, {
                            stdgo.runtime.Runtime.gc();
                            stdgo.time.Time.sleep(((_i * (100 : stdgo.GoInt)) + (10 : stdgo.GoInt) : stdgo.time.Time.Duration) * (1000000i64 : stdgo.time.Time.Duration));
                            {
                                _fin1 = stdgo.sync.atomic_.Atomic_.loadUint32(stdgo.Go.pointer(_fin));
                                if (_fin1 >= (99u32 : stdgo.GoUInt32)) {
                                    @:jump("loop") continue;
                                };
                            };
                        });
...
function testPoolStress(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
        var n:stdgo.GoInt = (1000000 : stdgo.GoInt);
        if (stdgo.testing.Testing.short()) {
            n = n / ((100 : stdgo.GoInt));
        };
        var _p:Pool = ({} : stdgo.sync.Sync.Pool);
                    ...
                    var a = function():Void {
                        var _v:stdgo.AnyInterface = stdgo.Go.toInterface((0 : stdgo.GoInt));
                        {
                            ...
                            stdgo.Go.cfor(_j < n, _j++, {
                                ...
                                _p.put(_v);
                                _v = _p.get();
                                if ((_v != null) && ((stdgo.Go.typeAssert((_v : stdgo.GoInt)) : stdgo.GoInt) != (0 : stdgo.GoInt))) {
...
function testPoolDequeue(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        _testPoolDequeue(_t, newPoolDequeue((16 : stdgo.GoInt)));
    }
function testPoolChain(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        _testPoolDequeue(_t, newPoolChain());
    }
function _testPoolDequeue(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _d:PoolDequeue):Void {
        {};
        ...
        var _record:stdgo.GoInt -> Void = function(_val:stdgo.GoInt):Void {
            stdgo.sync.atomic_.Atomic_.addInt32(stdgo.Go.pointer(_have[(_val : stdgo.GoInt)]), (1 : stdgo.GoInt32));
            if (_val == (n - (1 : stdgo.GoInt))) {
                stdgo.sync.atomic_.Atomic_.storeInt32(stdgo.Go.pointer(_stop), (1 : stdgo.GoInt32));
            };
        };
        {
            ...
            stdgo.Go.cfor(_i < (10 : stdgo.GoInt), _i++, {
                ...
                stdgo.Go.routine(() -> {
                    var a = function():Void {
                        ...
                        while (stdgo.sync.atomic_.Atomic_.loadInt32(stdgo.Go.pointer(_stop)) == ((0 : stdgo.GoInt32))) {
                            ...
                            if (_ok) {
                                ...
                                {
                                    _fail++;
                                    if (_fail % (100 : stdgo.GoInt) == ((0 : stdgo.GoInt))) {
                                        stdgo.runtime.Runtime.gosched();
                                    };
                                };
                            };
        ...
        var _nPopHead:stdgo.GoInt = (0 : stdgo.GoInt);
        _wg.add((1 : stdgo.GoInt));
        stdgo.Go.routine(() -> {
            var a = function():Void {
                {
                    ...
                    stdgo.Go.cfor(_j < n, _j++, {
                        ...
                        if (_j % (10 : stdgo.GoInt) == ((0 : stdgo.GoInt))) {
        ...
        if (!stdgo.testing.Testing.short() && (_nPopHead == (0 : stdgo.GoInt))) {
            _t.errorf(("popHead never succeeded" : stdgo.GoString));
        };
    }
function benchmarkPool(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _p:Pool = ({} : stdgo.sync.Sync.Pool);
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            while (_pb.next()) {
...
function benchmarkPoolOverflow(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _p:Pool = ({} : stdgo.sync.Sync.Pool);
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            while (_pb.next()) {
                {
                    var _b:stdgo.GoInt = (0 : stdgo.GoInt);
                    stdgo.Go.cfor(_b < (100 : stdgo.GoInt), _b++, {
                        _p.put(stdgo.Go.toInterface((1 : stdgo.GoInt)));
                    });
                };
                {
...
/**
    ...
    // from other Ps.
**/
function benchmarkPoolStarvation(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _p:Pool = ({} : stdgo.sync.Sync.Pool);
        var _count:stdgo.GoInt = (100 : stdgo.GoInt);
        var _countStarved:stdgo.GoInt = _count - ((_count : stdgo.GoFloat32) * (0.33000001311302185 : stdgo.GoFloat64) : stdgo.GoInt);
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            while (_pb.next()) {
                {
                    var _b:stdgo.GoInt = (0 : stdgo.GoInt);
...
function benchmarkPoolSTW(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            {
                var _a0 = stdgo.runtime.debug.Debug.setGCPercent((-1 : stdgo.GoInt));
            ...
            var _p:Pool = ({} : stdgo.sync.Sync.Pool);
            {
                ...
                stdgo.Go.cfor(_i < _b.n, _i++, {
                    ...
                    {
                        var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                        stdgo.Go.cfor(_i < (100000 : stdgo.GoInt), _i++, {
                            _p.put(_item);
                        });
                    };
                    stdgo.runtime.Runtime.gc();
                    stdgo.runtime.Runtime.readMemStats((stdgo.Go.setRef(_mstats) : stdgo.Ref<stdgo.runtime.Runtime.MemStats>));
                    _pauses = (_pauses.__append__(_mstats.pauseNs[((_mstats.numGC + (255u32 : stdgo.GoUInt32)) % (256u32 : stdgo.GoUInt32) : stdgo.GoInt)]));
                });
            };
            stdgo.sort.Sort.slice(stdgo.Go.toInterface(_pauses), function(_i:stdgo.GoInt, _j:stdgo.GoInt):Bool {
                return _pauses[(_i : stdgo.GoInt)] < _pauses[(_j : stdgo.GoInt)];
            });
            var _total:stdgo.GoUInt64 = (0 : stdgo.GoUInt64);
            for (__12 => _ns in _pauses) {
                _total = _total + (_ns);
            };
            _b.reportMetric((_total : stdgo.GoFloat64) / (_b.n : stdgo.GoFloat64), ("ns/op" : stdgo.GoString));
            _b.reportMetric((_pauses[((_pauses.length * (95 : stdgo.GoInt)) / (100 : stdgo.GoInt) : stdgo.GoInt)] : stdgo.GoFloat64), ("p95-ns/STW" : stdgo.GoString));
            _b.reportMetric((_pauses[((_pauses.length * (50 : stdgo.GoInt)) / (100 : stdgo.GoInt) : stdgo.GoInt)] : stdgo.GoFloat64), ("p50-ns/STW" : stdgo.GoString));
            {
                for (defer in __deferstack__) {
                    defer();
                };
...
function benchmarkPoolExpensiveNew(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            ...
            _p.new_ = function():stdgo.AnyInterface {
                stdgo.sync.atomic_.Atomic_.addUint64(stdgo.Go.pointer(_nNew), (1i64 : stdgo.GoUInt64));
            ...
            stdgo.runtime.Runtime.readMemStats((stdgo.Go.setRef(_mstats1) : stdgo.Ref<stdgo.runtime.Runtime.MemStats>));
            _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            ...
            stdgo.runtime.Runtime.readMemStats((stdgo.Go.setRef(_mstats2) : stdgo.Ref<stdgo.runtime.Runtime.MemStats>));
            _b.reportMetric((_mstats2.numGC - _mstats1.numGC : stdgo.GoFloat64) / (_b.n : stdgo.GoFloat64), ("GCs/op" : stdgo.GoString));
            _b.reportMetric((_nNew : stdgo.GoFloat64) / (_b.n : stdgo.GoFloat64), ("New/op" : stdgo.GoString));
            {
                for (defer in __deferstack__) {
                    defer();
                };
...
**/
@:structInit class T_benchmarkSemaUncontended_31___localname___PaddedSem {
    public var _sem : stdgo.GoUInt32 = 0;
    public var _pad : stdgo.GoArray<stdgo.GoUInt32> = new stdgo.GoArray<stdgo.GoUInt32>(...[for (i in 0 ... 32) (0 : stdgo.GoUInt32)]);
    ...
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() {
        return new T_benchmarkSemaUncontended_31___localname___PaddedSem(_sem, _pad);
    }
}
function benchmarkSemaUncontended(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {};
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
...
function _benchmarkSema(_b:stdgo.Ref<stdgo.testing.Testing.B>, _block:Bool, _work:Bool):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
                    ...
                    var a = function():Void {
                        {
                            ...
                            stdgo.Go.cfor(_p < (stdgo.runtime.Runtime.gomaxprocs((0 : stdgo.GoInt)) / (2 : stdgo.GoInt)), _p++, {
...
function benchmarkSemaSyntNonblock(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkSema(_b, false, false);
    }
function benchmarkSemaSyntBlock(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkSema(_b, true, false);
    }
function benchmarkSemaWorkNonblock(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkSema(_b, false, true);
    }
function benchmarkSemaWorkBlock(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
...
function _doTestParallelReaders(_numReaders:stdgo.GoInt, _gomaxprocs:stdgo.GoInt):Void {
        ...
        var _cdone = new stdgo.Chan<Bool>(0, () -> false);
        {
            ...
            stdgo.Go.cfor(_i < _numReaders, _i++, {
                stdgo.Go.routine(() -> _parallelReader((stdgo.Go.setRef(_m) : stdgo.Ref<stdgo.sync.Sync.RWMutex>), _clocked, _cunlock, _cdone));
            });
        };
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
...
function testParallelReaders(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            {
                var _a0 = stdgo.runtime.Runtime.gomaxprocs((-1 : stdgo.GoInt));
                __deferstack__.unshift(() -> stdgo.runtime.Runtime.gomaxprocs(_a0));
            };
...
function _reader(_rwm:stdgo.Ref<RWMutex>, _num_iterations:stdgo.GoInt, _activity:stdgo.Pointer<stdgo.GoInt32>, _cdone:stdgo.Chan<Bool>):Void {
        {
            ...
            stdgo.Go.cfor(_i < _num_iterations, _i++, {
                _rwm.rlock();
                var _n:stdgo.GoInt32 = stdgo.sync.atomic_.Atomic_.addInt32(_activity, (1 : stdgo.GoInt32));
                if ((_n < (1 : stdgo.GoInt32)) || (_n >= (10000 : stdgo.GoInt32))) {
                    _rwm.runlock();
                ...
                stdgo.sync.atomic_.Atomic_.addInt32(_activity, (-1 : stdgo.GoInt32));
                _rwm.runlock();
            });
        };
        _cdone.__send__(true);
...
function _writer(_rwm:stdgo.Ref<RWMutex>, _num_iterations:stdgo.GoInt, _activity:stdgo.Pointer<stdgo.GoInt32>, _cdone:stdgo.Chan<Bool>):Void {
        {
            ...
            stdgo.Go.cfor(_i < _num_iterations, _i++, {
                _rwm.lock();
                var _n:stdgo.GoInt32 = stdgo.sync.atomic_.Atomic_.addInt32(_activity, (10000 : stdgo.GoInt32));
                ...
                stdgo.sync.atomic_.Atomic_.addInt32(_activity, (-10000 : stdgo.GoInt32));
                _rwm.unlock();
            });
        };
        _cdone.__send__(true);
...
function hammerRWMutex(_gomaxprocs:stdgo.GoInt, _numReaders:stdgo.GoInt, _num_iterations:stdgo.GoInt):Void {
        ...
        var _cdone = new stdgo.Chan<Bool>(0, () -> false);
        stdgo.Go.routine(() -> _writer((stdgo.Go.setRef(_rwm) : stdgo.Ref<stdgo.sync.Sync.RWMutex>), _num_iterations, stdgo.Go.pointer(_activity), _cdone));
        var _i:stdgo.GoInt = (0 : stdgo.GoInt);
        {
            _i = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < (_numReaders / (2 : stdgo.GoInt)), _i++, {
                stdgo.Go.routine(() -> _reader((stdgo.Go.setRef(_rwm) : stdgo.Ref<stdgo.sync.Sync.RWMutex>), _num_iterations, stdgo.Go.pointer(_activity), _cdone));
            });
        };
        stdgo.Go.routine(() -> _writer((stdgo.Go.setRef(_rwm) : stdgo.Ref<stdgo.sync.Sync.RWMutex>), _num_iterations, stdgo.Go.pointer(_activity), _cdone));
        stdgo.Go.cfor(_i < _numReaders, _i++, {
        ...
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < ((2 : stdgo.GoInt) + _numReaders), _i++, {
                _cdone.__get__();
            });
        };
    }
function testRWMutex(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            var _m:RWMutex = ({} : stdgo.sync.Sync.RWMutex);
            _m.lock();
            ...
            var _n:stdgo.GoInt = (1000 : stdgo.GoInt);
            if (stdgo.testing.Testing.short()) {
                _n = (5 : stdgo.GoInt);
            };
...
function testRLocker(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
**/
@:structInit @:using(stdgo.sync_test.Sync_test.T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex_static_extension) class T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex {
    @:embedded
    public var rwmutex : stdgo.sync.Sync.RWMutex = ({} : stdgo.sync.Sync.RWMutex);
    public var _pad : stdgo.GoArray<stdgo.GoUInt32> = new stdgo.GoArray<stdgo.GoUInt32>(...[for (i in 0 ... 32) (0 : stdgo.GoUInt32)]);
    public function new(?rwmutex:stdgo.sync.Sync.RWMutex, ?_pad:stdgo.GoArray<stdgo.GoUInt32>) {
    ...
    @:embedded
    public function _rUnlockSlow(__0:stdgo.GoInt32) rwmutex._rUnlockSlow(__0);
    public function __copy__() {
        return new T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex(rwmutex, _pad);
    }
}
function benchmarkRWMutexUncontended(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {};
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            var _rwm:T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex = ({} : stdgo.sync_test.Sync_test.T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex);
            while (_pb.next()) {
                _rwm.rlock();
                _rwm.rlock();
                _rwm.runlock();
...
function _benchmarkRWMutex(_b:stdgo.Ref<stdgo.testing.Testing.B>, _localWork:stdgo.GoInt, _writeRatio:stdgo.GoInt):Void {
        var _rwm:RWMutex = ({} : stdgo.sync.Sync.RWMutex);
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            var _foo:stdgo.GoInt = (0 : stdgo.GoInt);
            while (_pb.next()) {
                _foo++;
                if (_foo % _writeRatio == ((0 : stdgo.GoInt))) {
                    _rwm.lock();
                    _rwm.unlock();
                } else {
                    _rwm.rlock();
                    {
                        var _i:stdgo.GoInt = (0 : stdgo.GoInt);
                        stdgo.Go.cfor(_i != (_localWork), _i = _i + ((1 : stdgo.GoInt)), {
                            _foo = _foo * ((2 : stdgo.GoInt));
                            _foo = _foo / ((2 : stdgo.GoInt));
                        });
                    };
...
function benchmarkRWMutexWrite100(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkRWMutex(_b, (0 : stdgo.GoInt), (100 : stdgo.GoInt));
    }
function benchmarkRWMutexWrite10(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkRWMutex(_b, (0 : stdgo.GoInt), (10 : stdgo.GoInt));
    }
function benchmarkRWMutexWorkWrite100(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkRWMutex(_b, (100 : stdgo.GoInt), (100 : stdgo.GoInt));
    }
function benchmarkRWMutexWorkWrite10(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkRWMutex(_b, (100 : stdgo.GoInt), (10 : stdgo.GoInt));
    }
function _testWaitGroup(_t:stdgo.Ref<stdgo.testing.Testing.T_>, _wg1:stdgo.Ref<WaitGroup>, _wg2:stdgo.Ref<WaitGroup>):Void {
...
function testWaitGroup(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var _wg1 = (stdgo.Go.setRef((new stdgo.sync.Sync.WaitGroup() : stdgo.sync.Sync.WaitGroup)) : stdgo.Ref<stdgo.sync.Sync.WaitGroup>);
        var _wg2 = (stdgo.Go.setRef((new stdgo.sync.Sync.WaitGroup() : stdgo.sync.Sync.WaitGroup)) : stdgo.Ref<stdgo.sync.Sync.WaitGroup>);
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
...
function testWaitGroupMisuse(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        var __deferstack__:Array<Void -> Void> = [];
        try {
            __deferstack__.unshift(() -> {
                var a = function():Void {
            ...
            var _wg = (stdgo.Go.setRef((new stdgo.sync.Sync.WaitGroup() : stdgo.sync.Sync.WaitGroup)) : stdgo.Ref<stdgo.sync.Sync.WaitGroup>);
            _wg.add((1 : stdgo.GoInt));
            _wg.done();
            _wg.done();
...
function testWaitGroupRace(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < (1000 : stdgo.GoInt), _i++, {
                ...
                stdgo.Go.routine(() -> {
                    var a = function():Void {
                        stdgo.sync.atomic_.Atomic_.addInt32(_n, (1 : stdgo.GoInt32));
                        _wg.done();
                    };
                    a();
                });
                ...
                _wg.wait_();
                if (stdgo.sync.atomic_.Atomic_.loadInt32(_n) != ((2 : stdgo.GoInt32))) {
...
**/
@:structInit class T_testWaitGroupAlign_33___localname___X {
    public var _x : stdgo.GoUInt8 = 0;
    public var _wg : stdgo.sync.Sync.WaitGroup = ({} : stdgo.sync.Sync.WaitGroup);
    public function new(?_x:stdgo.GoUInt8, ?_wg:stdgo.sync.Sync.WaitGroup) {
        if (_x != null) this._x = _x;
        if (_wg != null) this._wg = _wg;
    }
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() {
        return new T_testWaitGroupAlign_33___localname___X(_x, _wg);
    }
}
function testWaitGroupAlign(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        {};
        var _x:T_testWaitGroupAlign_33___localname___X = ({} : stdgo.sync_test.Sync_test.T_testWaitGroupAlign_33___localname___X);
        _x._wg.add((1 : stdgo.GoInt));
        stdgo.Go.routine(() -> {
            var a = function(_x:stdgo.Ref<T_testWaitGroupAlign_33___localname___X>):Void {
                _x._wg.done();
            };
            a((stdgo.Go.setRef(_x) : stdgo.Ref<stdgo.sync_test.Sync_test.T_testWaitGroupAlign_33___localname___X>));
        });
        _x._wg.wait_();
    }
/**
...
**/
@:structInit @:using(stdgo.sync_test.Sync_test.T_benchmarkWaitGroupUncontended_34___localname___PaddedWaitGroup_static_extension) class T_benchmarkWaitGroupUncontended_34___localname___PaddedWaitGroup {
    @:embedded
    public var waitGroup : stdgo.sync.Sync.WaitGroup = ({} : stdgo.sync.Sync.WaitGroup);
    public var _pad : stdgo.GoArray<stdgo.GoUInt8> = new stdgo.GoArray<stdgo.GoUInt8>(...[for (i in 0 ... 128) (0 : stdgo.GoUInt8)]);
    public function new(?waitGroup:stdgo.sync.Sync.WaitGroup, ?_pad:stdgo.GoArray<stdgo.GoUInt8>) {
        if (waitGroup != null) this.waitGroup = waitGroup;
        if (_pad != null) this._pad = _pad;
    }
    public function __underlying__() return stdgo.Go.toInterface(this);
    @:embedded
    public function add(__0:stdgo.GoInt) waitGroup.add(__0);
    @:embedded
    public function done() waitGroup.done();
    @:embedded
    public function wait_() waitGroup.wait_();
    public function __copy__() {
        return new T_benchmarkWaitGroupUncontended_34___localname___PaddedWaitGroup(waitGroup, _pad);
    }
}
function benchmarkWaitGroupUncontended(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {};
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            var _wg:T_benchmarkWaitGroupUncontended_34___localname___PaddedWaitGroup = ({} : stdgo.sync_test.Sync_test.T_benchmarkWaitGroupUncontended_34___localname___PaddedWaitGroup);
            while (_pb.next()) {
                _wg.add((1 : stdgo.GoInt));
                _wg.done();
                _wg.wait_();
...
function _benchmarkWaitGroupAddDone(_b:stdgo.Ref<stdgo.testing.Testing.B>, _localWork:stdgo.GoInt):Void {
        var _wg:WaitGroup = ({} : stdgo.sync.Sync.WaitGroup);
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            var _foo:stdgo.GoInt = (0 : stdgo.GoInt);
            while (_pb.next()) {
...
function benchmarkWaitGroupAddDone(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkWaitGroupAddDone(_b, (0 : stdgo.GoInt));
    }
function benchmarkWaitGroupAddDoneWork(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkWaitGroupAddDone(_b, (100 : stdgo.GoInt));
    }
function _benchmarkWaitGroupWait(_b:stdgo.Ref<stdgo.testing.Testing.B>, _localWork:stdgo.GoInt):Void {
        var _wg:WaitGroup = ({} : stdgo.sync.Sync.WaitGroup);
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            var _foo:stdgo.GoInt = (0 : stdgo.GoInt);
            while (_pb.next()) {
...
function benchmarkWaitGroupWait(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkWaitGroupWait(_b, (0 : stdgo.GoInt));
    }
function benchmarkWaitGroupWaitWork(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _benchmarkWaitGroupWait(_b, (100 : stdgo.GoInt));
    }
function benchmarkWaitGroupActuallyWait(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        _b.reportAllocs();
        _b.runParallel(function(_pb:stdgo.Ref<stdgo.testing.Testing.PB>):Void {
            while (_pb.next()) {
                var _wg:WaitGroup = ({} : stdgo.sync.Sync.WaitGroup);
...
@:keep var _ = {
        try {
            if ((stdgo.os.Os.args.length == (3 : stdgo.GoInt)) && (stdgo.os.Os.args[(1 : stdgo.GoInt)] == ("TESTMISUSE" : stdgo.GoString))) {
                for (__4 => _test in _misuseTests) {
                    if (_test._name == (stdgo.os.Os.args[((2 : stdgo.GoInt) : stdgo.GoInt)])) {
                        {
                            var a = function():Void {
                                var __deferstack__:Array<Void -> Void> = [];
                                try {
...
class T_mapCall_asInterface {
    @:keep
    public dynamic function generate(_r:stdgo.Ref<stdgo.math.rand.Rand.Rand>, _size:stdgo.GoInt):stdgo.reflect.Reflect.Value return __self__.value.generate(_r, _size);
    @:keep
...
@:keep @:allow(stdgo.sync_test.Sync_test.T_mapCall_asInterface) class T_mapCall_static_extension {
    @:keep
    static public function generate( _:T_mapCall, _r:stdgo.Ref<stdgo.math.rand.Rand.Rand>, _size:stdgo.GoInt):stdgo.reflect.Reflect.Value {
        @:recv var _:T_mapCall = _?.__copy__();
        var _c:stdgo.sync_test.Sync_test.T_mapCall = ({ _op : _mapOps[(stdgo.math.rand.Rand.intn((_mapOps.length)) : stdgo.GoInt)], _k : _randValue(_r) } : stdgo.sync_test.Sync_test.T_mapCall);
        {
...
class T_benchmarkMutexUncontended_30___localname___PaddedMutex_asInterface {
    @:embedded
    ...
    public function __underlying__() return new stdgo.AnyInterface((__type__.kind() == stdgo.internal.reflect.Reflect.KindType.pointer && !stdgo.internal.reflect.Reflect.isReflectTypeRef(__type__)) ? (__self__ : Dynamic) : (__self__.value : Dynamic), __type__);
    var __self__ : stdgo.Pointer<T_benchmarkMutexUncontended_30___localname___PaddedMutex>;
    var __type__ : stdgo.internal.reflect.Reflect._Type;
}
@:keep @:allow(stdgo.sync_test.Sync_test.T_benchmarkMutexUncontended_30___localname___PaddedMutex_asInterface) class T_benchmarkMutexUncontended_30___localname___PaddedMutex_static_extension {
    @:embedded
    public static function _unlockSlow( __self__:T_benchmarkMutexUncontended_30___localname___PaddedMutex, __0:stdgo.GoInt32) __self__._unlockSlow(__0);
    @:embedded
    public static function _lockSlow( __self__:T_benchmarkMutexUncontended_30___localname___PaddedMutex) __self__._lockSlow();
    @:embedded
    public static function unlock( __self__:T_benchmarkMutexUncontended_30___localname___PaddedMutex) __self__.unlock();
    @:embedded
    public static function tryLock( __self__:T_benchmarkMutexUncontended_30___localname___PaddedMutex):Bool return __self__.tryLock();
    @:embedded
    public static function lock( __self__:T_benchmarkMutexUncontended_30___localname___PaddedMutex) __self__.lock();
}
class T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex_asInterface {
    @:embedded
    public dynamic function _rUnlockSlow(__0:stdgo.GoInt32):Void __self__.value._rUnlockSlow(__0);
    @:embedded
    public dynamic function unlock():Void __self__.value.unlock();
    @:embedded
    ...
    public function __underlying__() return new stdgo.AnyInterface((__type__.kind() == stdgo.internal.reflect.Reflect.KindType.pointer && !stdgo.internal.reflect.Reflect.isReflectTypeRef(__type__)) ? (__self__ : Dynamic) : (__self__.value : Dynamic), __type__);
    var __self__ : stdgo.Pointer<T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex>;
    var __type__ : stdgo.internal.reflect.Reflect._Type;
}
@:keep @:allow(stdgo.sync_test.Sync_test.T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex_asInterface) class T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex_static_extension {
    @:embedded
    public static function _rUnlockSlow( __self__:T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex, __0:stdgo.GoInt32) __self__._rUnlockSlow(__0);
    @:embedded
    public static function unlock( __self__:T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex) __self__.unlock();
    @:embedded
    public static function tryRLock( __self__:T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex):Bool return __self__.tryRLock();
    @:embedded
    public static function tryLock( __self__:T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex):Bool return __self__.tryLock();
    @:embedded
    public static function runlock( __self__:T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex) __self__.runlock();
    @:embedded
    public static function rlocker( __self__:T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex):stdgo.sync.Sync.Locker return __self__.rlocker();
    @:embedded
    public static function rlock( __self__:T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex) __self__.rlock();
    @:embedded
    public static function lock( __self__:T_benchmarkRWMutexUncontended_32___localname___PaddedRWMutex) __self__.lock();
}
class T_benchmarkWaitGroupUncontended_34___localname___PaddedWaitGroup_asInterface {
    @:embedded
    public dynamic function wait_():Void __self__.value.wait_();
    @:embedded
    public dynamic function done():Void __self__.value.done();
    @:embedded
    public dynamic function add(__0:stdgo.GoInt):Void __self__.value.add(__0);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
    public function __underlying__() return new stdgo.AnyInterface((__type__.kind() == stdgo.internal.reflect.Reflect.KindType.pointer && !stdgo.internal.reflect.Reflect.isReflectTypeRef(__type__)) ? (__self__ : Dynamic) : (__self__.value : Dynamic), __type__);
    var __self__ : stdgo.Pointer<T_benchmarkWaitGroupUncontended_34___localname___PaddedWaitGroup>;
    var __type__ : stdgo.internal.reflect.Reflect._Type;
}
@:keep @:allow(stdgo.sync_test.Sync_test.T_benchmarkWaitGroupUncontended_34___localname___PaddedWaitGroup_asInterface) class T_benchmarkWaitGroupUncontended_34___localname___PaddedWaitGroup_static_extension {
    @:embedded
    public static function wait_( __self__:T_benchmarkWaitGroupUncontended_34___localname___PaddedWaitGroup) __self__.wait_();
    @:embedded
    public static function done( __self__:T_benchmarkWaitGroupUncontended_34___localname___PaddedWaitGroup) __self__.done();
    @:embedded
    public static function add( __self__:T_benchmarkWaitGroupUncontended_34___localname___PaddedWaitGroup, __0:stdgo.GoInt) __self__.add(__0);
}
