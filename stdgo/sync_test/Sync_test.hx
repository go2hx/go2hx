...
function testMapRangeNestedCall(_t:stdgo.StdGoTypes.Ref<stdgo.testing.Testing.T>):Void {
        ...
        _m.range(function(_key:stdgo.StdGoTypes.AnyInterface, _value:stdgo.StdGoTypes.AnyInterface):Bool {
            _m.range(function(_key:stdgo.StdGoTypes.AnyInterface, _value:stdgo.StdGoTypes.AnyInterface):Bool {
                ...
                {
                    var __tmp__ = _m.loadOrStore(stdgo.Go.toInterface((42 : stdgo.StdGoTypes.GoInt)), stdgo.Go.toInterface(("dummy" : stdgo.GoString))), __16:stdgo.StdGoTypes.AnyInterface = __tmp__._0, _loaded:Bool = __tmp__._1;
                    if (_loaded) {
