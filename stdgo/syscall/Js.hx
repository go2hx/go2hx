...
**/
function funcOf(fn:(_this:Value, _args:stdgo.Slice<Value>) -> stdgo.AnyInterface):Func {
        final fn = fn;
...
**/
function valueOf(x:stdgo.AnyInterface):Value {
...
**/
function copyBytesToGo(dst:Array<StdTypes.Int>, src:Value):StdTypes.Int {
...
/**
    ...
    It returns the number of bytes copied, which will be the minimum of the lengths of src and dst.
**/
function copyBytesToJS(dst:Value, src:Array<StdTypes.Int>):StdTypes.Int {
