...
final eperm : Errno = stdgo._internal.syscall.Syscall.eperm;
final enoent : Errno = stdgo._internal.syscall.Syscall.enoent;
final esrch : Errno = stdgo._internal.syscall.Syscall.esrch;
final eintr : Errno = stdgo._internal.syscall.Syscall.eintr;
final eio : Errno = stdgo._internal.syscall.Syscall.eio;
final enxio : Errno = stdgo._internal.syscall.Syscall.enxio;
final e2big : Errno = stdgo._internal.syscall.Syscall.e2big;
final enoexec : Errno = stdgo._internal.syscall.Syscall.enoexec;
final ebadf : Errno = stdgo._internal.syscall.Syscall.ebadf;
final echild : Errno = stdgo._internal.syscall.Syscall.echild;
final eagain : Errno = stdgo._internal.syscall.Syscall.eagain;
final enomem : Errno = stdgo._internal.syscall.Syscall.enomem;
final eacces : Errno = stdgo._internal.syscall.Syscall.eacces;
final efault : Errno = stdgo._internal.syscall.Syscall.efault;
final ebusy : Errno = stdgo._internal.syscall.Syscall.ebusy;
final eexist : Errno = stdgo._internal.syscall.Syscall.eexist;
final exdev : Errno = stdgo._internal.syscall.Syscall.exdev;
final enodev : Errno = stdgo._internal.syscall.Syscall.enodev;
final enotdir : Errno = stdgo._internal.syscall.Syscall.enotdir;
final eisdir : Errno = stdgo._internal.syscall.Syscall.eisdir;
final einval : Errno = stdgo._internal.syscall.Syscall.einval;
final enfile : Errno = stdgo._internal.syscall.Syscall.enfile;
final emfile : Errno = stdgo._internal.syscall.Syscall.emfile;
final enotty : Errno = stdgo._internal.syscall.Syscall.enotty;
final efbig : Errno = stdgo._internal.syscall.Syscall.efbig;
final enospc : Errno = stdgo._internal.syscall.Syscall.enospc;
final espipe : Errno = stdgo._internal.syscall.Syscall.espipe;
final erofs : Errno = stdgo._internal.syscall.Syscall.erofs;
final emlink : Errno = stdgo._internal.syscall.Syscall.emlink;
final epipe : Errno = stdgo._internal.syscall.Syscall.epipe;
final enametoolong : Errno = stdgo._internal.syscall.Syscall.enametoolong;
final enosys : Errno = stdgo._internal.syscall.Syscall.enosys;
final edquot : Errno = stdgo._internal.syscall.Syscall.edquot;
final edom : Errno = stdgo._internal.syscall.Syscall.edom;
final erange : Errno = stdgo._internal.syscall.Syscall.erange;
final edeadlk : Errno = stdgo._internal.syscall.Syscall.edeadlk;
final enolck : Errno = stdgo._internal.syscall.Syscall.enolck;
final enotempty : Errno = stdgo._internal.syscall.Syscall.enotempty;
final eloop : Errno = stdgo._internal.syscall.Syscall.eloop;
final enomsg : Errno = stdgo._internal.syscall.Syscall.enomsg;
final eidrm : Errno = stdgo._internal.syscall.Syscall.eidrm;
final echrng : Errno = stdgo._internal.syscall.Syscall.echrng;
final el2nsync : Errno = stdgo._internal.syscall.Syscall.el2nsync;
final el3hlt : Errno = stdgo._internal.syscall.Syscall.el3hlt;
final el3rst : Errno = stdgo._internal.syscall.Syscall.el3rst;
final elnrng : Errno = stdgo._internal.syscall.Syscall.elnrng;
final eunatch : Errno = stdgo._internal.syscall.Syscall.eunatch;
final enocsi : Errno = stdgo._internal.syscall.Syscall.enocsi;
final el2hlt : Errno = stdgo._internal.syscall.Syscall.el2hlt;
final ebade : Errno = stdgo._internal.syscall.Syscall.ebade;
final ebadr : Errno = stdgo._internal.syscall.Syscall.ebadr;
final exfull : Errno = stdgo._internal.syscall.Syscall.exfull;
final enoano : Errno = stdgo._internal.syscall.Syscall.enoano;
final ebadrqc : Errno = stdgo._internal.syscall.Syscall.ebadrqc;
final ebadslt : Errno = stdgo._internal.syscall.Syscall.ebadslt;
final edeadlock : Errno = stdgo._internal.syscall.Syscall.edeadlock;
final ebfont : Errno = stdgo._internal.syscall.Syscall.ebfont;
final enostr : Errno = stdgo._internal.syscall.Syscall.enostr;
final enodata : Errno = stdgo._internal.syscall.Syscall.enodata;
final etime : Errno = stdgo._internal.syscall.Syscall.etime;
final enosr : Errno = stdgo._internal.syscall.Syscall.enosr;
final enonet : Errno = stdgo._internal.syscall.Syscall.enonet;
final enopkg : Errno = stdgo._internal.syscall.Syscall.enopkg;
final eremote : Errno = stdgo._internal.syscall.Syscall.eremote;
final enolink : Errno = stdgo._internal.syscall.Syscall.enolink;
final eadv : Errno = stdgo._internal.syscall.Syscall.eadv;
final esrmnt : Errno = stdgo._internal.syscall.Syscall.esrmnt;
final ecomm : Errno = stdgo._internal.syscall.Syscall.ecomm;
final eproto : Errno = stdgo._internal.syscall.Syscall.eproto;
final emultihop : Errno = stdgo._internal.syscall.Syscall.emultihop;
final edotdot : Errno = stdgo._internal.syscall.Syscall.edotdot;
final ebadmsg : Errno = stdgo._internal.syscall.Syscall.ebadmsg;
final eoverflow : Errno = stdgo._internal.syscall.Syscall.eoverflow;
final enotuniq : Errno = stdgo._internal.syscall.Syscall.enotuniq;
final ebadfd : Errno = stdgo._internal.syscall.Syscall.ebadfd;
final eremchg : Errno = stdgo._internal.syscall.Syscall.eremchg;
final elibacc : Errno = stdgo._internal.syscall.Syscall.elibacc;
final elibbad : Errno = stdgo._internal.syscall.Syscall.elibbad;
final elibscn : Errno = stdgo._internal.syscall.Syscall.elibscn;
final elibmax : Errno = stdgo._internal.syscall.Syscall.elibmax;
final elibexec : Errno = stdgo._internal.syscall.Syscall.elibexec;
final eilseq : Errno = stdgo._internal.syscall.Syscall.eilseq;
final eusers : Errno = stdgo._internal.syscall.Syscall.eusers;
final enotsock : Errno = stdgo._internal.syscall.Syscall.enotsock;
final edestaddrreq : Errno = stdgo._internal.syscall.Syscall.edestaddrreq;
final emsgsize : Errno = stdgo._internal.syscall.Syscall.emsgsize;
final eprototype : Errno = stdgo._internal.syscall.Syscall.eprototype;
final enoprotoopt : Errno = stdgo._internal.syscall.Syscall.enoprotoopt;
final eprotonosupport : Errno = stdgo._internal.syscall.Syscall.eprotonosupport;
final esocktnosupport : Errno = stdgo._internal.syscall.Syscall.esocktnosupport;
final eopnotsupp : Errno = stdgo._internal.syscall.Syscall.eopnotsupp;
final epfnosupport : Errno = stdgo._internal.syscall.Syscall.epfnosupport;
final eafnosupport : Errno = stdgo._internal.syscall.Syscall.eafnosupport;
final eaddrinuse : Errno = stdgo._internal.syscall.Syscall.eaddrinuse;
final eaddrnotavail : Errno = stdgo._internal.syscall.Syscall.eaddrnotavail;
final enetdown : Errno = stdgo._internal.syscall.Syscall.enetdown;
final enetunreach : Errno = stdgo._internal.syscall.Syscall.enetunreach;
final enetreset : Errno = stdgo._internal.syscall.Syscall.enetreset;
final econnaborted : Errno = stdgo._internal.syscall.Syscall.econnaborted;
final econnreset : Errno = stdgo._internal.syscall.Syscall.econnreset;
final enobufs : Errno = stdgo._internal.syscall.Syscall.enobufs;
final eisconn : Errno = stdgo._internal.syscall.Syscall.eisconn;
final enotconn : Errno = stdgo._internal.syscall.Syscall.enotconn;
final eshutdown : Errno = stdgo._internal.syscall.Syscall.eshutdown;
final etoomanyrefs : Errno = stdgo._internal.syscall.Syscall.etoomanyrefs;
final etimedout : Errno = stdgo._internal.syscall.Syscall.etimedout;
final econnrefused : Errno = stdgo._internal.syscall.Syscall.econnrefused;
final ehostdown : Errno = stdgo._internal.syscall.Syscall.ehostdown;
final ehostunreach : Errno = stdgo._internal.syscall.Syscall.ehostunreach;
final ealready : Errno = stdgo._internal.syscall.Syscall.ealready;
final einprogress : Errno = stdgo._internal.syscall.Syscall.einprogress;
final estale : Errno = stdgo._internal.syscall.Syscall.estale;
final enotsup : Errno = stdgo._internal.syscall.Syscall.enotsup;
final enomedium : Errno = stdgo._internal.syscall.Syscall.enomedium;
final ecanceled : Errno = stdgo._internal.syscall.Syscall.ecanceled;
final elbin : Errno = stdgo._internal.syscall.Syscall.elbin;
final eftype : Errno = stdgo._internal.syscall.Syscall.eftype;
final enmfile : Errno = stdgo._internal.syscall.Syscall.enmfile;
final eproclim : Errno = stdgo._internal.syscall.Syscall.eproclim;
final enoshare : Errno = stdgo._internal.syscall.Syscall.enoshare;
final ecaseclash : Errno = stdgo._internal.syscall.Syscall.ecaseclash;
final ewouldblock : Errno = stdgo._internal.syscall.Syscall.ewouldblock;
...
@:structInit abstract Rusage(stdgo._internal.syscall.Syscall.Rusage) from stdgo._internal.syscall.Syscall.Rusage to stdgo._internal.syscall.Syscall.Rusage {
    ...
    public function new(?utime:Timeval, ?stime:Timeval) this = new stdgo._internal.syscall.Syscall.Rusage(utime, stime);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit abstract ProcAttr(stdgo._internal.syscall.Syscall.ProcAttr) from stdgo._internal.syscall.Syscall.ProcAttr to stdgo._internal.syscall.Syscall.ProcAttr {
    ...
    public function new(?dir:String, ?env:Array<String>, ?files:Array<stdgo.GoUIntptr>, ?sys:SysProcAttr) this = new stdgo._internal.syscall.Syscall.ProcAttr(dir, ([for (i in env) i] : stdgo.Slice<stdgo.GoString>), ([for (i in files) i] : stdgo.Slice<stdgo.GoUIntptr>), sys);
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
