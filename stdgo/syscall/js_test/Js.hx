...
((new stdgo.testing.Testing.InternalTest(((("TestIntConversion" : GoString))), stdgo.syscall.js_test.Js_test.testIntConversion) : stdgo.testing.Testing.InternalTest)),
...
((new stdgo.testing.Testing.InternalTest(((("TestFrozenObject" : GoString))), stdgo.syscall.js_test.Js_test.testFrozenObject) : stdgo.testing.Testing.InternalTest)),
...
((new stdgo.testing.Testing.InternalTest(((("TestInvokeFunction" : GoString))), stdgo.syscall.js_test.Js_test.testInvokeFunction) : stdgo.testing.Testing.InternalTest)),
((new stdgo.testing.Testing.InternalTest(((("TestInterleavedFunctions" : GoString))), stdgo.syscall.js_test.Js_test.testInterleavedFunctions) : stdgo.testing.Testing.InternalTest)),
...
((new stdgo.testing.Testing.InternalTest(((("TestCopyBytesToGo" : GoString))), stdgo.syscall.js_test.Js_test.testCopyBytesToGo) : stdgo.testing.Testing.InternalTest)),
((new stdgo.testing.Testing.InternalTest(((("TestCopyBytesToJS" : GoString))), stdgo.syscall.js_test.Js_test.testCopyBytesToJS) : stdgo.testing.Testing.InternalTest)),
((new stdgo.testing.Testing.InternalTest(((("TestGarbageCollection" : GoString))), stdgo.syscall.js_test.Js_test.testGarbageCollection) : stdgo.testing.Testing.InternalTest)),
((new stdgo.testing.Testing.InternalTest(((("TestGlobal" : GoString))), stdgo.syscall.js_test.Js_test.testGlobal) : stdgo.testing.Testing.InternalTest))) : Slice<stdgo.testing.Testing.InternalTest>));
var _benchmarks : Slice<stdgo.testing.Testing.InternalBenchmark> = ((new Slice<stdgo.testing.Testing.InternalBenchmark>(((new stdgo.testing.Testing.InternalBenchmark(((("BenchmarkDOM" : GoString))), stdgo.syscall.js_test.Js_test.benchmarkDOM) : stdgo.testing.Testing.InternalBenchmark))) : Slice<stdgo.testing.Testing.InternalBenchmark>));
