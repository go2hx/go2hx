...
function testExecErrPermutedFds(_t:Ref<stdgo.testing.Testing.T>):Void {
        ...
        var _attr = (({ files : (new Slice<Ref<stdgo.os.Os.File>>(0, 0, stdgo.os.Os.stdin, stdgo.os.Os.stderr, stdgo.os.Os.stdout) : Slice<Ref<stdgo.os.Os.File>>) } : stdgo.os.Os.ProcAttr) : Ref<stdgo.os.Os.ProcAttr>);
