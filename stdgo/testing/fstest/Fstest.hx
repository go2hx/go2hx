...
@:structInit @:using(stdgo.testing.fstest.Fstest.T_fsOnly_static_extension) class T_fsOnly {
    ...
    @:embedded
    public function open(_pattern:GoString):{ var _0 : stdgo.io.fs.Fs.File; var _1 : stdgo.Error; } return null;
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit @:using(stdgo.testing.fstest.Fstest.T_noSub_static_extension) class T_noSub {
    ...
    @:embedded
    public function glob(_pattern:GoString):{ var _0 : Slice<GoString>; var _1 : stdgo.Error; } return null;
    @:embedded
    public function open(_pattern:GoString):{ var _0 : stdgo.io.fs.Fs.File; var _1 : stdgo.Error; } return null;
    @:embedded
    public function readDir(_pattern:GoString):{ var _0 : Slice<stdgo.io.fs.Fs.DirEntry>; var _1 : stdgo.Error; } return null;
    @:embedded
    public function readFile(_pattern:GoString):{ var _0 : Slice<GoUInt8>; var _1 : stdgo.Error; } return null;
    @:embedded
    public function stat(_pattern:GoString):{ var _0 : stdgo.io.fs.Fs.FileInfo; var _1 : stdgo.Error; } return null;
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit @:using(stdgo.testing.fstest.Fstest.T_openMapFile_static_extension) class T_openMapFile {
    ...
    @:embedded
    public function info():{ var _0 : stdgo.io.fs.Fs.FileInfo; var _1 : stdgo.Error; } return null;
    @:embedded
...
function testMapFS(_t:stdgo.testing.Testing.T):Void throw "testing.fstest.testMapFS is not yet implemented";
function testMapFSChmodDot(_t:stdgo.testing.Testing.T):Void throw "testing.fstest.testMapFSChmodDot is not yet implemented";
/**
...
function _testFS(_fsys:stdgo.io.fs.Fs.FS, _expected:haxe.Rest<GoString>):Error throw "testing.fstest._testFS is not yet implemented";
/**
    // formatEntry formats an fs.DirEntry into a string for error messages and comparison.
**/
function _formatEntry(_entry:stdgo.io.fs.Fs.DirEntry):GoString throw "testing.fstest._formatEntry is not yet implemented";
/**
    // formatInfoEntry formats an fs.FileInfo into a string like the result of formatEntry, for error messages and comparison.
**/
function _formatInfoEntry(_info:stdgo.io.fs.Fs.FileInfo):GoString throw "testing.fstest._formatInfoEntry is not yet implemented";
/**
...
@:keep class T_mapFileInfo_static_extension {
    ...
    @:keep
    static public function sys( _i:T_mapFileInfo):AnyInterface throw "testing.fstest.sys is not yet implemented";
    @:keep
    static public function isDir( _i:T_mapFileInfo):Bool throw "testing.fstest.isDir is not yet implemented";
    @:keep
    static public function modTime( _i:T_mapFileInfo):stdgo.time.Time.Time throw "testing.fstest.modTime is not yet implemented";
    @:keep
    static public function type( _i:T_mapFileInfo):stdgo.io.fs.Fs.FileMode throw "testing.fstest.type is not yet implemented";
    @:keep
    static public function mode( _i:T_mapFileInfo):stdgo.io.fs.Fs.FileMode throw "testing.fstest.mode is not yet implemented";
    @:keep
    static public function size( _i:T_mapFileInfo):GoInt64 throw "testing.fstest.size is not yet implemented";
    @:keep
...
@:keep class T_openMapFile_static_extension {
    ...
    @:keep
    static public function seek( _f:T_openMapFile, _offset:GoInt64, _whence:GoInt):{ var _0 : GoInt64; var _1 : Error; } throw "testing.fstest.seek is not yet implemented";
    @:keep
    static public function read( _f:T_openMapFile, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } throw "testing.fstest.read is not yet implemented";
    @:keep
    static public function close( _f:T_openMapFile):Error throw "testing.fstest.close is not yet implemented";
    @:keep
    static public function stat( _f:T_openMapFile):{ var _0 : stdgo.io.fs.Fs.FileInfo; var _1 : Error; } throw "testing.fstest.stat is not yet implemented";
    @:embedded
...
@:keep class T_mapDir_static_extension {
    ...
    @:keep
    static public function read( _d:T_mapDir, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } throw "testing.fstest.read is not yet implemented";
    @:keep
    static public function close( _d:T_mapDir):Error throw "testing.fstest.close is not yet implemented";
    @:keep
    static public function stat( _d:T_mapDir):{ var _0 : stdgo.io.fs.Fs.FileInfo; var _1 : Error; } throw "testing.fstest.stat is not yet implemented";
    @:embedded
...
@:keep class T_fsTester_static_extension {
    ...
    **/
    @:keep
    static public function _checkBadPath( _t:T_fsTester, _file:GoString, _desc:GoString, _open:GoString -> Error):Void throw "testing.fstest._checkBadPath is not yet implemented";
    /**
        // checkBadPath checks that various invalid forms of file's name cannot be opened using t.fsys.Open.
    **/
    @:keep
    static public function _checkOpen( _t:T_fsTester, _file:GoString):Void throw "testing.fstest._checkOpen is not yet implemented";
    @:keep
    static public function _checkFileRead( _t:T_fsTester, _file:GoString, _desc:GoString, _data1:Slice<GoByte>, _data2:Slice<GoByte>):Void throw "testing.fstest._checkFileRead is not yet implemented";
    /**
        // checkFile checks that basic file reading works correctly.
    **/
    @:keep
    static public function _checkFile( _t:T_fsTester, _file:GoString):Void throw "testing.fstest._checkFile is not yet implemented";
    /**
        // checkDirList checks that two directory lists contain the same files and file info.
        // The order of the lists need not match.
    **/
    @:keep
    static public function _checkDirList( _t:T_fsTester, _dir:GoString, _desc:GoString, _list1:Slice<stdgo.io.fs.Fs.DirEntry>, _list2:Slice<stdgo.io.fs.Fs.DirEntry>):Void throw "testing.fstest._checkDirList is not yet implemented";
    /**
        // checkStat checks that a direct stat of path matches entry,
        // which was found in the parent's directory listing.
    **/
    @:keep
    static public function _checkStat( _t:T_fsTester, _path:GoString, _entry:stdgo.io.fs.Fs.DirEntry):Void throw "testing.fstest._checkStat is not yet implemented";
    /**
        // checkGlob checks that various glob patterns work if the file system implements GlobFS.
    **/
    @:keep
    static public function _checkGlob( _t:T_fsTester, _dir:GoString, _list:Slice<stdgo.io.fs.Fs.DirEntry>):Void throw "testing.fstest._checkGlob is not yet implemented";
    /**
    ...
    **/
    @:keep
    static public function _checkDir( _t:T_fsTester, _dir:GoString):Void throw "testing.fstest._checkDir is not yet implemented";
    @:keep
    static public function _openDir( _t:T_fsTester, _dir:GoString):stdgo.io.fs.Fs.ReadDirFile throw "testing.fstest._openDir is not yet implemented";
    /**
