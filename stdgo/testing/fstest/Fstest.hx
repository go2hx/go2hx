...
@:structInit @:private @:using(stdgo.testing.fstest.Fstest.T_fsOnly_static_extension) class T_fsOnly {
    ...
    public function __underlying__() return Go.toInterface(this);
    @:embedded
    public function open(_pattern:GoString):{ var _0 : stdgo.io.fs.Fs.File; var _1 : Error; } return null;
    public function __copy__() {
...
@:structInit @:private @:using(stdgo.testing.fstest.Fstest.T_noSub_static_extension) class T_noSub {
    ...
    public function __underlying__() return Go.toInterface(this);
    @:embedded
    public function glob(_pattern:GoString):{ var _0 : Slice<GoString>; var _1 : Error; } return null;
    @:embedded
    public function open(_pattern:GoString):{ var _0 : stdgo.io.fs.Fs.File; var _1 : Error; } return null;
    @:embedded
    public function readDir(_pattern:GoString):{ var _0 : Slice<stdgo.io.fs.Fs.DirEntry>; var _1 : Error; } return null;
    @:embedded
    public function readFile(_pattern:GoString):{ var _0 : Slice<GoUInt8>; var _1 : Error; } return null;
    @:embedded
    public function stat(_pattern:GoString):{ var _0 : stdgo.io.fs.Fs.FileInfo; var _1 : Error; } return null;
    public function __copy__() {
...
@:structInit @:private @:using(stdgo.testing.fstest.Fstest.T_openMapFile_static_extension) class T_openMapFile {
    ...
    public function __underlying__() return Go.toInterface(this);
    @:embedded
    public function info():{ var _0 : stdgo.io.fs.Fs.FileInfo; var _1 : Error; } return null;
    @:embedded
...
/**
    ...
    //	}
**/
function testFS(_fsys:stdgo.io.fs.Fs.FS, _expected:haxe.Rest<GoString>):Error throw "testing.fstest.testFS is not yet implemented";
private function _testFS(_fsys:stdgo.io.fs.Fs.FS, _expected:haxe.Rest<GoString>):Error throw "testing.fstest._testFS is not yet implemented";
/**
    // formatEntry formats an fs.DirEntry into a string for error messages and comparison.
**/
private function _formatEntry(_entry:stdgo.io.fs.Fs.DirEntry):GoString throw "testing.fstest._formatEntry is not yet implemented";
/**
    // formatInfoEntry formats an fs.FileInfo into a string like the result of formatEntry, for error messages and comparison.
**/
private function _formatInfoEntry(_info:stdgo.io.fs.Fs.FileInfo):GoString throw "testing.fstest._formatInfoEntry is not yet implemented";
/**
    // formatInfo formats an fs.FileInfo into a string for error messages and comparison.
**/
private function _formatInfo(_info:stdgo.io.fs.Fs.FileInfo):GoString throw "testing.fstest._formatInfo is not yet implemented";
function testSymlink(_t:Ref<stdgo.testing.Testing.T>):Void throw "testing.fstest.testSymlink is not yet implemented";
...
@:keep @:allow(stdgo.testing.fstest.Fstest.T_fsOnly_asInterface) class T_fsOnly_static_extension {
    @:embedded
    public static function open( __self__:T_fsOnly, _pattern:GoString):{ var _0 : stdgo.io.fs.Fs.File; var _1 : Error; } return __self__.open(_pattern);
}
...
@:keep @:allow(stdgo.testing.fstest.Fstest.T_noSub_asInterface) class T_noSub_static_extension {
    ...
    @:embedded
    public static function stat( __self__:T_noSub, _pattern:GoString):{ var _0 : stdgo.io.fs.Fs.FileInfo; var _1 : Error; } return __self__.stat(_pattern);
    @:embedded
    public static function readFile( __self__:T_noSub, _pattern:GoString):{ var _0 : Slice<GoUInt8>; var _1 : Error; } return __self__.readFile(_pattern);
    @:embedded
    public static function readDir( __self__:T_noSub, _pattern:GoString):{ var _0 : Slice<stdgo.io.fs.Fs.DirEntry>; var _1 : Error; } return __self__.readDir(_pattern);
    @:embedded
    public static function open( __self__:T_noSub, _pattern:GoString):{ var _0 : stdgo.io.fs.Fs.File; var _1 : Error; } return __self__.open(_pattern);
    @:embedded
    public static function glob( __self__:T_noSub, _pattern:GoString):{ var _0 : Slice<GoString>; var _1 : Error; } return __self__.glob(_pattern);
}
...
@:keep @:allow(stdgo.testing.fstest.Fstest.T_mapFileInfo_asInterface) class T_mapFileInfo_static_extension {
    @:keep
    static public function info( _i:Ref<T_mapFileInfo>):{ var _0 : stdgo.io.fs.Fs.FileInfo; var _1 : Error; } throw "testing.fstest.info is not yet implemented";
    @:keep
    static public function sys( _i:Ref<T_mapFileInfo>):AnyInterface throw "testing.fstest.sys is not yet implemented";
    @:keep
    static public function isDir( _i:Ref<T_mapFileInfo>):Bool throw "testing.fstest.isDir is not yet implemented";
    @:keep
    static public function modTime( _i:Ref<T_mapFileInfo>):stdgo.time.Time.Time throw "testing.fstest.modTime is not yet implemented";
    @:keep
    static public function type( _i:Ref<T_mapFileInfo>):stdgo.io.fs.Fs.FileMode throw "testing.fstest.type is not yet implemented";
    @:keep
    static public function mode( _i:Ref<T_mapFileInfo>):stdgo.io.fs.Fs.FileMode throw "testing.fstest.mode is not yet implemented";
    @:keep
    static public function size( _i:Ref<T_mapFileInfo>):GoInt64 throw "testing.fstest.size is not yet implemented";
    @:keep
    static public function name( _i:Ref<T_mapFileInfo>):GoString throw "testing.fstest.name is not yet implemented";
}
...
@:keep @:allow(stdgo.testing.fstest.Fstest.T_openMapFile_asInterface) class T_openMapFile_static_extension {
    @:keep
    static public function readAt( _f:Ref<T_openMapFile>, _b:Slice<GoByte>, _offset:GoInt64):{ var _0 : GoInt; var _1 : Error; } throw "testing.fstest.readAt is not yet implemented";
    @:keep
    static public function seek( _f:Ref<T_openMapFile>, _offset:GoInt64, _whence:GoInt):{ var _0 : GoInt64; var _1 : Error; } throw "testing.fstest.seek is not yet implemented";
    @:keep
    static public function read( _f:Ref<T_openMapFile>, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } throw "testing.fstest.read is not yet implemented";
    @:keep
    static public function close( _f:Ref<T_openMapFile>):Error throw "testing.fstest.close is not yet implemented";
    @:keep
    static public function stat( _f:Ref<T_openMapFile>):{ var _0 : stdgo.io.fs.Fs.FileInfo; var _1 : Error; } throw "testing.fstest.stat is not yet implemented";
    @:embedded
    ...
    @:embedded
    public static function info( __self__:T_openMapFile):{ var _0 : stdgo.io.fs.Fs.FileInfo; var _1 : Error; } return __self__.info();
}
...
@:keep @:allow(stdgo.testing.fstest.Fstest.T_mapDir_asInterface) class T_mapDir_static_extension {
    @:keep
    static public function readDir( _d:Ref<T_mapDir>, _count:GoInt):{ var _0 : Slice<stdgo.io.fs.Fs.DirEntry>; var _1 : Error; } throw "testing.fstest.readDir is not yet implemented";
    @:keep
    static public function read( _d:Ref<T_mapDir>, _b:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } throw "testing.fstest.read is not yet implemented";
    @:keep
    static public function close( _d:Ref<T_mapDir>):Error throw "testing.fstest.close is not yet implemented";
    @:keep
    static public function stat( _d:Ref<T_mapDir>):{ var _0 : stdgo.io.fs.Fs.FileInfo; var _1 : Error; } throw "testing.fstest.stat is not yet implemented";
    @:embedded
    ...
    @:embedded
    public static function info( __self__:T_mapDir):{ var _0 : stdgo.io.fs.Fs.FileInfo; var _1 : Error; } return __self__.info();
}
...
@:keep @:allow(stdgo.testing.fstest.Fstest.T_fsTester_asInterface) class T_fsTester_static_extension {
    ...
    **/
    @:keep
    static public function _checkBadPath( _t:Ref<T_fsTester>, _file:GoString, _desc:GoString, _open:GoString -> Error):Void throw "testing.fstest._checkBadPath is not yet implemented";
    /**
        // checkBadPath checks that various invalid forms of file's name cannot be opened using t.fsys.Open.
    **/
    @:keep
    static public function _checkOpen( _t:Ref<T_fsTester>, _file:GoString):Void throw "testing.fstest._checkOpen is not yet implemented";
    @:keep
    static public function _checkFileRead( _t:Ref<T_fsTester>, _file:GoString, _desc:GoString, _data1:Slice<GoByte>, _data2:Slice<GoByte>):Void throw "testing.fstest._checkFileRead is not yet implemented";
    /**
        // checkFile checks that basic file reading works correctly.
    **/
    @:keep
    static public function _checkFile( _t:Ref<T_fsTester>, _file:GoString):Void throw "testing.fstest._checkFile is not yet implemented";
    /**
        // checkDirList checks that two directory lists contain the same files and file info.
        // The order of the lists need not match.
    **/
    @:keep
    static public function _checkDirList( _t:Ref<T_fsTester>, _dir:GoString, _desc:GoString, _list1:Slice<stdgo.io.fs.Fs.DirEntry>, _list2:Slice<stdgo.io.fs.Fs.DirEntry>):Void throw "testing.fstest._checkDirList is not yet implemented";
    /**
        // checkStat checks that a direct stat of path matches entry,
        // which was found in the parent's directory listing.
    **/
    @:keep
    static public function _checkStat( _t:Ref<T_fsTester>, _path:GoString, _entry:stdgo.io.fs.Fs.DirEntry):Void throw "testing.fstest._checkStat is not yet implemented";
    /**
        // checkGlob checks that various glob patterns work if the file system implements GlobFS.
    **/
    @:keep
    static public function _checkGlob( _t:Ref<T_fsTester>, _dir:GoString, _list:Slice<stdgo.io.fs.Fs.DirEntry>):Void throw "testing.fstest._checkGlob is not yet implemented";
    /**
        // checkDir checks the directory dir, which is expected to exist
        // (it is either the root or was found in a directory listing with IsDir true).
    **/
    @:keep
    static public function _checkDir( _t:Ref<T_fsTester>, _dir:GoString):Void throw "testing.fstest._checkDir is not yet implemented";
    @:keep
    static public function _openDir( _t:Ref<T_fsTester>, _dir:GoString):stdgo.io.fs.Fs.ReadDirFile throw "testing.fstest._openDir is not yet implemented";
    /**
        // errorf adds an error line to errText.
    **/
    @:keep
    static public function _errorf( _t:Ref<T_fsTester>, _format:GoString, _args:haxe.Rest<AnyInterface>):Void throw "testing.fstest._errorf is not yet implemented";
}
...
@:keep @:allow(stdgo.testing.fstest.Fstest.MapFS_asInterface) class MapFS_static_extension {
    ...
    @:keep
    static public function glob( _fsys:MapFS, _pattern:GoString):{ var _0 : Slice<GoString>; var _1 : Error; } throw "testing.fstest.glob is not yet implemented";
    @:keep
    static public function readDir( _fsys:MapFS, _name:GoString):{ var _0 : Slice<stdgo.io.fs.Fs.DirEntry>; var _1 : Error; } throw "testing.fstest.readDir is not yet implemented";
    @:keep
    static public function stat( _fsys:MapFS, _name:GoString):{ var _0 : stdgo.io.fs.Fs.FileInfo; var _1 : Error; } throw "testing.fstest.stat is not yet implemented";
    @:keep
    static public function readFile( _fsys:MapFS, _name:GoString):{ var _0 : Slice<GoByte>; var _1 : Error; } throw "testing.fstest.readFile is not yet implemented";
    /**
        // Open opens the named file.
    **/
    @:keep
