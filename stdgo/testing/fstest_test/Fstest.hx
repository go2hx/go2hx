...
function main():Void {
        var _m = stdgo.testing.Testing.mainStart({
            ...
            __self__.matchString = #if !macro function(_s:GoString, _substr:GoString):{ var _0 : Bool; var _1 : stdgo.Error; } return ((new stdgo.testing.internal.testdeps.Testdeps.TestDeps() : stdgo.testing.internal.testdeps.Testdeps.TestDeps)).matchString(_s, _substr) #else null #end;
