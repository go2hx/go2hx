...
class TestDeps_asInterface {
    ...
    @:keep
    public dynamic function checkCorpus(_vals:stdgo.Slice<stdgo.StdGoTypes.AnyInterface>, _types:stdgo.Slice<stdgo.reflect.Reflect.Type_>):stdgo.Error return __self__.value.checkCorpus(_vals, _types);
    @:keep
    public dynamic function readCorpus(_dir:stdgo.GoString, _types:stdgo.Slice<stdgo.reflect.Reflect.Type_>):{ var _0 : stdgo.Slice<{ var parent : stdgo.GoString; var path : stdgo.GoString; var data : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>; var values : stdgo.Slice<stdgo.StdGoTypes.AnyInterface>; var generation : stdgo.StdGoTypes.GoInt; var isSeed : Bool; }>; var _1 : stdgo.Error; } return __self__.value.readCorpus(_dir, _types);
    @:keep
    ...
    @:keep
    public dynamic function coordinateFuzzing(_timeout:stdgo.time.Time.Duration, _limit:stdgo.StdGoTypes.GoInt64, _minimizeTimeout:stdgo.time.Time.Duration, _minimizeLimit:stdgo.StdGoTypes.GoInt64, _parallel:stdgo.StdGoTypes.GoInt, _seed:stdgo.Slice<{ var parent : stdgo.GoString; var path : stdgo.GoString; var data : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>; var values : stdgo.Slice<stdgo.StdGoTypes.AnyInterface>; var generation : stdgo.StdGoTypes.GoInt; var isSeed : Bool; }>, _types:stdgo.Slice<stdgo.reflect.Reflect.Type_>, _corpusDir:stdgo.GoString, _cacheDir:stdgo.GoString):stdgo.Error return __self__.value.coordinateFuzzing(_timeout, _limit, _minimizeTimeout, _minimizeLimit, _parallel, _seed, _types, _corpusDir, _cacheDir);
    /**
...
@:keep @:allow(stdgo.testing.internal.testdeps.Testdeps.TestDeps_asInterface) class TestDeps_static_extension {
    ...
    @:keep
    static public function checkCorpus( _:TestDeps, _vals:stdgo.Slice<stdgo.StdGoTypes.AnyInterface>, _types:stdgo.Slice<stdgo.reflect.Reflect.Type_>):stdgo.Error throw "TestDeps:testing.internal.testdeps.checkCorpus is not yet implemented";
    @:keep
    static public function readCorpus( _:TestDeps, _dir:stdgo.GoString, _types:stdgo.Slice<stdgo.reflect.Reflect.Type_>):{ var _0 : stdgo.Slice<{ var parent : stdgo.GoString; var path : stdgo.GoString; var data : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>; var values : stdgo.Slice<stdgo.StdGoTypes.AnyInterface>; var generation : stdgo.StdGoTypes.GoInt; var isSeed : Bool; }>; var _1 : stdgo.Error; } throw "TestDeps:testing.internal.testdeps.readCorpus is not yet implemented";
    @:keep
    ...
    @:keep
    static public function coordinateFuzzing( _:TestDeps, _timeout:stdgo.time.Time.Duration, _limit:stdgo.StdGoTypes.GoInt64, _minimizeTimeout:stdgo.time.Time.Duration, _minimizeLimit:stdgo.StdGoTypes.GoInt64, _parallel:stdgo.StdGoTypes.GoInt, _seed:stdgo.Slice<{ var parent : stdgo.GoString; var path : stdgo.GoString; var data : stdgo.Slice<stdgo.StdGoTypes.GoUInt8>; var values : stdgo.Slice<stdgo.StdGoTypes.AnyInterface>; var generation : stdgo.StdGoTypes.GoInt; var isSeed : Bool; }>, _types:stdgo.Slice<stdgo.reflect.Reflect.Type_>, _corpusDir:stdgo.GoString, _cacheDir:stdgo.GoString):stdgo.Error throw "TestDeps:testing.internal.testdeps.coordinateFuzzing is not yet implemented";
    /**
        // SetPanicOnExit0 tells the os package whether to panic on os.Exit(0).
    **/
    @:keep
