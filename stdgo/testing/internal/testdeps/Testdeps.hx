...
@:keep @:allow(stdgo.testing.internal.testdeps.Testdeps.TestDeps_asInterface) class TestDeps_static_extension {
    @:keep
    static public function snapshotCoverage( _:TestDeps):Void throw "testing.internal.testdeps.snapshotCoverage is not yet implemented";
    @:keep
    static public function resetCoverage( _:TestDeps):Void throw "testing.internal.testdeps.resetCoverage is not yet implemented";
    @:keep
    static public function checkCorpus( _:TestDeps, _vals:Slice<AnyInterface>, _types:Slice<stdgo.reflect.Reflect.Type>):Error throw "testing.internal.testdeps.checkCorpus is not yet implemented";
    @:keep
    static public function readCorpus( _:TestDeps, _dir:GoString, _types:Slice<stdgo.reflect.Reflect.Type>):{ var _0 : Slice<{ var parent : GoString; var path : GoString; var data : Slice<GoUInt8>; var values : Slice<AnyInterface>; var generation : GoInt; var isSeed : Bool; }>; var _1 : Error; } throw "testing.internal.testdeps.readCorpus is not yet implemented";
    @:keep
    static public function runFuzzWorker( _:TestDeps, _fn:({ var parent : GoString; var path : GoString; var data : Slice<GoUInt8>; var values : Slice<AnyInterface>; var generation : GoInt; var isSeed : Bool; }) -> Error):Error throw "testing.internal.testdeps.runFuzzWorker is not yet implemented";
    @:keep
    static public function coordinateFuzzing( _:TestDeps, _timeout:stdgo.time.Time.Duration, _limit:GoInt64, _minimizeTimeout:stdgo.time.Time.Duration, _minimizeLimit:GoInt64, _parallel:GoInt, _seed:Slice<{ var parent : GoString; var path : GoString; var data : Slice<GoUInt8>; var values : Slice<AnyInterface>; var generation : GoInt; var isSeed : Bool; }>, _types:Slice<stdgo.reflect.Reflect.Type>, _corpusDir:GoString, _cacheDir:GoString):Error throw "testing.internal.testdeps.coordinateFuzzing is not yet implemented";
    /**
        // SetPanicOnExit0 tells the os package whether to panic on os.Exit(0).
    **/
    @:keep
    static public function setPanicOnExit0( _:TestDeps, _v:Bool):Void throw "testing.internal.testdeps.setPanicOnExit0 is not yet implemented";
    @:keep
    static public function stopTestLog( _:TestDeps):Error throw "testing.internal.testdeps.stopTestLog is not yet implemented";
    @:keep
    static public function startTestLog( _:TestDeps, _w:stdgo.io.Io.Writer):Void throw "testing.internal.testdeps.startTestLog is not yet implemented";
    @:keep
    static public function importPath( _:TestDeps):GoString throw "testing.internal.testdeps.importPath is not yet implemented";
    @:keep
    static public function writeProfileTo( _:TestDeps, _name:GoString, _w:stdgo.io.Io.Writer, _debug:GoInt):Error throw "testing.internal.testdeps.writeProfileTo is not yet implemented";
    @:keep
    static public function stopCPUProfile( _:TestDeps):Void throw "testing.internal.testdeps.stopCPUProfile is not yet implemented";
    @:keep
    static public function startCPUProfile( _:TestDeps, _w:stdgo.io.Io.Writer):Error throw "testing.internal.testdeps.startCPUProfile is not yet implemented";
    @:keep
    static public function matchString( _:TestDeps, _pat:GoString, _str:GoString):{ var _0 : Bool; var _1 : Error; } throw "testing.internal.testdeps.matchString is not yet implemented";
}
...
@:keep @:allow(stdgo.testing.internal.testdeps.Testdeps.T_testLog_asInterface) class T_testLog_static_extension {
    ...
    **/
    @:keep
    static public function _add( _l:Ref<T_testLog>, _op:GoString, _name:GoString):Void throw "testing.internal.testdeps._add is not yet implemented";
    @:keep
    static public function chdir( _l:Ref<T_testLog>, _name:GoString):Void throw "testing.internal.testdeps.chdir is not yet implemented";
    @:keep
    static public function stat( _l:Ref<T_testLog>, _name:GoString):Void throw "testing.internal.testdeps.stat is not yet implemented";
    @:keep
    static public function open( _l:Ref<T_testLog>, _name:GoString):Void throw "testing.internal.testdeps.open is not yet implemented";
    @:keep
    static public function getenv( _l:Ref<T_testLog>, _key:GoString):Void throw "testing.internal.testdeps.getenv is not yet implemented";
}
