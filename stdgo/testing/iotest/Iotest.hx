...
function testWriteLogger(_t:stdgo.testing.Testing.T):Void throw "testing.iotest.testWriteLogger is not yet implemented";
function testWriteLogger_errorOnWrite(_t:stdgo.testing.Testing.T):Void throw "testing.iotest.testWriteLogger_errorOnWrite is not yet implemented";
function testReadLogger(_t:stdgo.testing.Testing.T):Void throw "testing.iotest.testReadLogger is not yet implemented";
function testReadLogger_errorOnRead(_t:stdgo.testing.Testing.T):Void throw "testing.iotest.testReadLogger_errorOnRead is not yet implemented";
/**
...
function testOneByteReader_nonEmptyReader(_t:stdgo.testing.Testing.T):Void throw "testing.iotest.testOneByteReader_nonEmptyReader is not yet implemented";
function testOneByteReader_emptyReader(_t:stdgo.testing.Testing.T):Void throw "testing.iotest.testOneByteReader_emptyReader is not yet implemented";
function testHalfReader_nonEmptyReader(_t:stdgo.testing.Testing.T):Void throw "testing.iotest.testHalfReader_nonEmptyReader is not yet implemented";
function testHalfReader_emptyReader(_t:stdgo.testing.Testing.T):Void throw "testing.iotest.testHalfReader_emptyReader is not yet implemented";
function testTimeOutReader_nonEmptyReader(_t:stdgo.testing.Testing.T):Void throw "testing.iotest.testTimeOutReader_nonEmptyReader is not yet implemented";
function testTimeOutReader_emptyReader(_t:stdgo.testing.Testing.T):Void throw "testing.iotest.testTimeOutReader_emptyReader is not yet implemented";
function testDataErrReader_nonEmptyReader(_t:stdgo.testing.Testing.T):Void throw "testing.iotest.testDataErrReader_nonEmptyReader is not yet implemented";
function testDataErrReader_emptyReader(_t:stdgo.testing.Testing.T):Void throw "testing.iotest.testDataErrReader_emptyReader is not yet implemented";
function testErrReader(_t:stdgo.testing.Testing.T):Void throw "testing.iotest.testErrReader is not yet implemented";
function testStringsReader(_t:stdgo.testing.Testing.T):Void throw "testing.iotest.testStringsReader is not yet implemented";
/**
