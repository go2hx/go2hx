...
@:structInit @:private @:using(stdgo.testing.iotest.Iotest.T_dataErrReader_static_extension) class T_dataErrReader {
    ...
    public function new(?_r:stdgo.io.Io.Reader, ?_unread:stdgo.Slice<stdgo.GoUInt8>, ?_data:stdgo.Slice<stdgo.GoUInt8>) {
        if (_r != null) this._r = _r;
...
@:structInit @:private @:using(stdgo.testing.iotest.Iotest.T_timeoutReader_static_extension) class T_timeoutReader {
    ...
    public function new(?_r:stdgo.io.Io.Reader, ?_count:stdgo.GoInt) {
        if (_r != null) this._r = _r;
...
@:structInit @:private @:using(stdgo.testing.iotest.Iotest.T_smallByteReader_static_extension) class T_smallByteReader {
    ...
    public function new(?_r:stdgo.io.Io.Reader, ?_off:stdgo.GoInt, ?_n:stdgo.GoInt) {
        if (_r != null) this._r = _r;
...
@:structInit @:private @:using(stdgo.testing.iotest.Iotest.T_truncateWriter_static_extension) class T_truncateWriter {
    ...
    public function new(?_w:stdgo.io.Io.Writer, ?_n:stdgo.GoInt64) {
        if (_w != null) this._w = _w;
        if (_n != null) this._n = _n;
    }
    public function __underlying__() return stdgo.Go.toInterface(this);
...
function testWriteLogger(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {}
function testWriteLogger_errorOnWrite(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void throw ":testing.iotest.testWriteLogger_errorOnWrite is not yet implemented";
function testReadLogger(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void throw ":testing.iotest.testReadLogger is not yet implemented";
function testReadLogger_errorOnRead(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void throw ":testing.iotest.testReadLogger_errorOnRead is not yet implemented";
/**
...
**/
function testReader(_r:stdgo.io.Io.Reader, _content:stdgo.Slice<stdgo.GoByte>):stdgo.Error throw ":testing.iotest.testReader is not yet implemented";
function testOneByteReader_nonEmptyReader(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void throw ":testing.iotest.testOneByteReader_nonEmptyReader is not yet implemented";
function testOneByteReader_emptyReader(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void throw ":testing.iotest.testOneByteReader_emptyReader is not yet implemented";
function testHalfReader_nonEmptyReader(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void throw ":testing.iotest.testHalfReader_nonEmptyReader is not yet implemented";
function testHalfReader_emptyReader(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void throw ":testing.iotest.testHalfReader_emptyReader is not yet implemented";
function testTimeOutReader_nonEmptyReader(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void throw ":testing.iotest.testTimeOutReader_nonEmptyReader is not yet implemented";
function testTimeOutReader_emptyReader(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void throw ":testing.iotest.testTimeOutReader_emptyReader is not yet implemented";
function testDataErrReader_nonEmptyReader(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void throw ":testing.iotest.testDataErrReader_nonEmptyReader is not yet implemented";
function testDataErrReader_emptyReader(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void throw ":testing.iotest.testDataErrReader_emptyReader is not yet implemented";
function testErrReader(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void throw ":testing.iotest.testErrReader is not yet implemented";
function testStringsReader(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void throw ":testing.iotest.testStringsReader is not yet implemented";
/**
    // TruncateWriter returns a Writer that writes to w
    // but stops silently after n bytes.
**/
function truncateWriter(_w:stdgo.io.Io.Writer, _n:stdgo.GoInt64):stdgo.io.Io.Writer throw ":testing.iotest.truncateWriter is not yet implemented";
function testTruncateWriter(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void throw ":testing.iotest.testTruncateWriter is not yet implemented";
