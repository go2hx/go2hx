...
**/
var errTimeout = (null : Error);
/**
    
    
    
**/
private var _truncateWriterTests = (null : Slice<T__struct_0>);
/**
...
**/
function newWriteLogger(_prefix:GoString, _w:stdgo.io.Io.Writer):stdgo.io.Io.Writer throw "testing.iotest.newWriteLogger is not yet implemented";
/**
    // NewReadLogger returns a reader that behaves like r except
    // that it logs (using log.Printf) each read to standard error,
    // printing the prefix and the hexadecimal data read.
**/
function newReadLogger(_prefix:GoString, _r:stdgo.io.Io.Reader):stdgo.io.Io.Reader throw "testing.iotest.newReadLogger is not yet implemented";
function testWriteLogger(_t:Ref<stdgo.testing.Testing.T>):Void throw "testing.iotest.testWriteLogger is not yet implemented";
function testWriteLogger_errorOnWrite(_t:Ref<stdgo.testing.Testing.T>):Void throw "testing.iotest.testWriteLogger_errorOnWrite is not yet implemented";
function testReadLogger(_t:Ref<stdgo.testing.Testing.T>):Void throw "testing.iotest.testReadLogger is not yet implemented";
function testReadLogger_errorOnRead(_t:Ref<stdgo.testing.Testing.T>):Void throw "testing.iotest.testReadLogger_errorOnRead is not yet implemented";
/**
...
**/
function errReader(_err:Error):stdgo.io.Io.Reader throw "testing.iotest.errReader is not yet implemented";
/**
...
**/
function testReader(_r:stdgo.io.Io.Reader, _content:Slice<GoByte>):Error throw "testing.iotest.testReader is not yet implemented";
function testOneByteReader_nonEmptyReader(_t:Ref<stdgo.testing.Testing.T>):Void throw "testing.iotest.testOneByteReader_nonEmptyReader is not yet implemented";
function testOneByteReader_emptyReader(_t:Ref<stdgo.testing.Testing.T>):Void throw "testing.iotest.testOneByteReader_emptyReader is not yet implemented";
function testHalfReader_nonEmptyReader(_t:Ref<stdgo.testing.Testing.T>):Void throw "testing.iotest.testHalfReader_nonEmptyReader is not yet implemented";
function testHalfReader_emptyReader(_t:Ref<stdgo.testing.Testing.T>):Void throw "testing.iotest.testHalfReader_emptyReader is not yet implemented";
function testTimeOutReader_nonEmptyReader(_t:Ref<stdgo.testing.Testing.T>):Void throw "testing.iotest.testTimeOutReader_nonEmptyReader is not yet implemented";
function testTimeOutReader_emptyReader(_t:Ref<stdgo.testing.Testing.T>):Void throw "testing.iotest.testTimeOutReader_emptyReader is not yet implemented";
function testDataErrReader_nonEmptyReader(_t:Ref<stdgo.testing.Testing.T>):Void throw "testing.iotest.testDataErrReader_nonEmptyReader is not yet implemented";
function testDataErrReader_emptyReader(_t:Ref<stdgo.testing.Testing.T>):Void throw "testing.iotest.testDataErrReader_emptyReader is not yet implemented";
function testErrReader(_t:Ref<stdgo.testing.Testing.T>):Void throw "testing.iotest.testErrReader is not yet implemented";
function testStringsReader(_t:Ref<stdgo.testing.Testing.T>):Void throw "testing.iotest.testStringsReader is not yet implemented";
/**
...
function testTruncateWriter(_t:Ref<stdgo.testing.Testing.T>):Void throw "testing.iotest.testTruncateWriter is not yet implemented";
...
@:keep @:allow(stdgo.testing.iotest.Iotest.T_writeLogger_asInterface) class T_writeLogger_static_extension {
    @:keep
    static public function write( _l:Ref<T_writeLogger>, _p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } throw "testing.iotest.write is not yet implemented";
}
...
@:keep @:allow(stdgo.testing.iotest.Iotest.T_readLogger_asInterface) class T_readLogger_static_extension {
    @:keep
    static public function read( _l:Ref<T_readLogger>, _p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } throw "testing.iotest.read is not yet implemented";
}
class T_errWriter_asInterface {
    @:keep
    public dynamic function write(_0:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } return __self__.value.write(_0);
    public function new(__self__, __type__) {
        this.__self__ = __self__;
        this.__type__ = __type__;
    }
...
@:keep @:allow(stdgo.testing.iotest.Iotest.T_oneByteReader_asInterface) class T_oneByteReader_static_extension {
    @:keep
    static public function read( _r:Ref<T_oneByteReader>, _p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } throw "testing.iotest.read is not yet implemented";
}
...
@:keep @:allow(stdgo.testing.iotest.Iotest.T_halfReader_asInterface) class T_halfReader_static_extension {
    @:keep
    static public function read( _r:Ref<T_halfReader>, _p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } throw "testing.iotest.read is not yet implemented";
}
...
@:keep @:allow(stdgo.testing.iotest.Iotest.T_dataErrReader_asInterface) class T_dataErrReader_static_extension {
    @:keep
    static public function read( _r:Ref<T_dataErrReader>, _p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } throw "testing.iotest.read is not yet implemented";
}
...
@:keep @:allow(stdgo.testing.iotest.Iotest.T_timeoutReader_asInterface) class T_timeoutReader_static_extension {
    @:keep
    static public function read( _r:Ref<T_timeoutReader>, _p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } throw "testing.iotest.read is not yet implemented";
}
...
@:keep @:allow(stdgo.testing.iotest.Iotest.T_errReader_asInterface) class T_errReader_static_extension {
    @:keep
    static public function read( _r:Ref<T_errReader>, _p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } throw "testing.iotest.read is not yet implemented";
}
...
@:keep @:allow(stdgo.testing.iotest.Iotest.T_smallByteReader_asInterface) class T_smallByteReader_static_extension {
    @:keep
    static public function read( _r:Ref<T_smallByteReader>, _p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } throw "testing.iotest.read is not yet implemented";
}
...
@:keep @:allow(stdgo.testing.iotest.Iotest.T_truncateWriter_asInterface) class T_truncateWriter_static_extension {
    @:keep
    static public function write( _t:Ref<T_truncateWriter>, _p:Slice<GoByte>):{ var _0 : GoInt; var _1 : Error; } throw "testing.iotest.write is not yet implemented";
}
