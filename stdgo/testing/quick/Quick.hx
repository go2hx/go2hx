...
@:structInit @:using(Quick.Config_static_extension) abstract Config(stdgo._internal.testing.quick.Quick_config.Config) from stdgo._internal.testing.quick.Quick_config.Config to stdgo._internal.testing.quick.Quick_config.Config {
...
@:structInit @:using(Quick.CheckError_static_extension) abstract CheckError(stdgo._internal.testing.quick.Quick_checkerror.CheckError) from stdgo._internal.testing.quick.Quick_checkerror.CheckError to stdgo._internal.testing.quick.Quick_checkerror.CheckError {
...
@:structInit @:using(Quick.CheckEqualError_static_extension) abstract CheckEqualError(stdgo._internal.testing.quick.Quick_checkequalerror.CheckEqualError) from stdgo._internal.testing.quick.Quick_checkequalerror.CheckEqualError to stdgo._internal.testing.quick.Quick_checkequalerror.CheckEqualError {
...
@:structInit @:using(Quick.TestStruct_static_extension) abstract TestStruct(stdgo._internal.testing.quick.Quick_teststruct.TestStruct) from stdgo._internal.testing.quick.Quick_teststruct.TestStruct to stdgo._internal.testing.quick.Quick_teststruct.TestStruct {
...
@:structInit @:using(Quick.T_myStruct_static_extension) @:dox(hide) abstract T_myStruct(stdgo._internal.testing.quick.Quick_t_mystruct.T_myStruct) from stdgo._internal.testing.quick.Quick_t_mystruct.T_myStruct to stdgo._internal.testing.quick.Quick_t_mystruct.T_myStruct {
...
@:structInit @:using(Quick.A_static_extension) abstract A(stdgo._internal.testing.quick.Quick_a.A) from stdgo._internal.testing.quick.Quick_a.A to stdgo._internal.testing.quick.Quick_a.A {
...
@:structInit @:using(Quick.B_static_extension) abstract B(stdgo._internal.testing.quick.Quick_b.B) from stdgo._internal.testing.quick.Quick_b.B to stdgo._internal.testing.quick.Quick_b.B {
...
@:structInit @:using(Quick.T_testNonZeroSliceAndMap___localname___Q_8763_static_extension) @:dox(hide) abstract T_testNonZeroSliceAndMap___localname___Q_8763(stdgo._internal.testing.quick.Quick_t_testnonzerosliceandmap___localname___q_8763.T_testNonZeroSliceAndMap___localname___Q_8763) from stdgo._internal.testing.quick.Quick_t_testnonzerosliceandmap___localname___q_8763.T_testNonZeroSliceAndMap___localname___Q_8763 to stdgo._internal.testing.quick.Quick_t_testnonzerosliceandmap___localname___q_8763.T_testNonZeroSliceAndMap___localname___Q_8763 {
