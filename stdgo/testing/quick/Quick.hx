...
@:structInit class T_testRecursive_29___localname___R {
    ...
    public var map_ : stdgo.GoMap<stdgo.StdGoTypes.GoInt, stdgo.testing.quick.Quick.T_testRecursive_29___localname___R> = (null : stdgo.GoMap<stdgo.StdGoTypes.GoInt, stdgo.testing.quick.Quick.T_testRecursive_29___localname___R>);
    ...
    public function new(?ptr:stdgo.StdGoTypes.Ref<stdgo.testing.quick.Quick.T_testRecursive_29___localname___R>, ?sliceP:stdgo.Slice<stdgo.StdGoTypes.Ref<stdgo.testing.quick.Quick.T_testRecursive_29___localname___R>>, ?slice:stdgo.Slice<stdgo.testing.quick.Quick.T_testRecursive_29___localname___R>, ?map_:stdgo.GoMap<stdgo.StdGoTypes.GoInt, stdgo.testing.quick.Quick.T_testRecursive_29___localname___R>, ?mapP:stdgo.GoMap<stdgo.StdGoTypes.GoInt, stdgo.StdGoTypes.Ref<stdgo.testing.quick.Quick.T_testRecursive_29___localname___R>>, ?mapR:stdgo.GoMap<stdgo.StdGoTypes.Ref<stdgo.testing.quick.Quick.T_testRecursive_29___localname___R>, stdgo.StdGoTypes.Ref<stdgo.testing.quick.Quick.T_testRecursive_29___localname___R>>, ?sliceMap:stdgo.Slice<stdgo.GoMap<stdgo.StdGoTypes.GoInt, stdgo.testing.quick.Quick.T_testRecursive_29___localname___R>>) {
    ...
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() {
        return new T_testRecursive_29___localname___R(ptr, sliceP, slice, map_, mapP, mapR, sliceMap);
    }
}
/**
