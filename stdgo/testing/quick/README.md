...
- [`function _arbitraryValues(_args:stdgo.Slice<stdgo.reflect.Value>, _f:stdgo.reflect.Type, _config:stdgo.Ref<stdgo.testing.quick.Config>, _rand:stdgo.Ref<stdgo.math.rand.Rand>):stdgo.Error`](<#function-_arbitraryvalues>)
...
- [`function _reportError(_property:stdgo.GoString, _err:stdgo.Error, _t:stdgo.Ref<stdgo.testing.T>):Void`](<#function-_reporterror>)

- [`function _sizedValue(_t:stdgo.reflect.Type, _rand:stdgo.Ref<stdgo.math.rand.Rand>, _size:stdgo.GoInt):{
	_1:Bool;
	_0:stdgo.reflect.Value;
...
- [class T\_testNonZeroSliceAndMap\_30\_\_\_localname\_\_\_Q](<#class-t_testnonzerosliceandmap_30localnameq>)

  - [`function new(?m:stdgo.GoMap<stdgo.GoInt, stdgo.GoInt>, ?s:stdgo.Slice<stdgo.GoInt>):Void`](<#t_testnonzerosliceandmap_30localnameq-function-new>)

- [class T\_testRecursive\_29\_\_\_localname\_\_\_R](<#class-t_testrecursive_29localnamer>)

  - [`function new(?ptr:stdgo.Ref<stdgo.testing.quick.T_testRecursive_29___localname___R>, ?sliceP:stdgo.Slice<stdgo.Ref<stdgo.testing.quick.T_testRecursive_29___localname___R>>, ?slice:stdgo.Slice<stdgo.testing.quick.T_testRecursive_29___localname___R>, ?map:stdgo.GoMap<stdgo.GoInt, stdgo.testing.quick.T_testRecursive_29___localname___R>, ?mapP:stdgo.GoMap<stdgo.GoInt, stdgo.Ref<stdgo.testing.quick.T_testRecursive_29___localname___R>>, ?mapR:stdgo.GoMap<stdgo.Ref<stdgo.testing.quick.T_testRecursive_29___localname___R>, stdgo.Ref<stdgo.testing.quick.T_testRecursive_29___localname___R>>, ?sliceMap:stdgo.Slice<stdgo.GoMap<stdgo.GoInt, stdgo.testing.quick.T_testRecursive_29___localname___R>>):Void`](<#t_testrecursive_29localnamer-function-new>)
...
```haxe
function _arbitraryValues(_args:stdgo.Slice<stdgo.reflect.Value>, _f:stdgo.reflect.Type, _config:stdgo.Ref<stdgo.testing.quick.Config>, _rand:stdgo.Ref<stdgo.math.rand.Rand>):stdgo.Error
```
...
```haxe
function _reportError(_property:stdgo.GoString, _err:stdgo.Error, _t:stdgo.Ref<stdgo.testing.T>):Void
```
...
## class T\_testNonZeroSliceAndMap\_30\_\_\_localname\_\_\_Q
...
### T\_testNonZeroSliceAndMap\_30\_\_\_localname\_\_\_Q function new
...
## class T\_testRecursive\_29\_\_\_localname\_\_\_R


```haxe
var map:stdgo.GoMap<stdgo.GoInt, stdgo.testing.quick.T_testRecursive_29___localname___R>
```


```haxe
var mapP:stdgo.GoMap<stdgo.GoInt, stdgo.Ref<stdgo.testing.quick.T_testRecursive_29___localname___R>>
```


```haxe
var mapR:stdgo.GoMap<stdgo.Ref<stdgo.testing.quick.T_testRecursive_29___localname___R>, stdgo.Ref<stdgo.testing.quick.T_testRecursive_29___localname___R>>
```


```haxe
var ptr:stdgo.Ref<stdgo.testing.quick.T_testRecursive_29___localname___R>
```


```haxe
var slice:stdgo.Slice<stdgo.testing.quick.T_testRecursive_29___localname___R>
```


```haxe
var sliceMap:stdgo.Slice<stdgo.GoMap<stdgo.GoInt, stdgo.testing.quick.T_testRecursive_29___localname___R>>
```


```haxe
var sliceP:stdgo.Slice<stdgo.Ref<stdgo.testing.quick.T_testRecursive_29___localname___R>>
```


### T\_testRecursive\_29\_\_\_localname\_\_\_R function new


```haxe
function new(?ptr:stdgo.Ref<stdgo.testing.quick.T_testRecursive_29___localname___R>, ?sliceP:stdgo.Slice<stdgo.Ref<stdgo.testing.quick.T_testRecursive_29___localname___R>>, ?slice:stdgo.Slice<stdgo.testing.quick.T_testRecursive_29___localname___R>, ?map:stdgo.GoMap<stdgo.GoInt, stdgo.testing.quick.T_testRecursive_29___localname___R>, ?mapP:stdgo.GoMap<stdgo.GoInt, stdgo.Ref<stdgo.testing.quick.T_testRecursive_29___localname___R>>, ?mapR:stdgo.GoMap<stdgo.Ref<stdgo.testing.quick.T_testRecursive_29___localname___R>, stdgo.Ref<stdgo.testing.quick.T_testRecursive_29___localname___R>>, ?sliceMap:stdgo.Slice<stdgo.GoMap<stdgo.GoInt, stdgo.testing.quick.T_testRecursive_29___localname___R>>):Void
```
