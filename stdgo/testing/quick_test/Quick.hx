...
private var _tests:Slice<stdgo.testing.Testing.InternalTest> = (new Slice<stdgo.testing.Testing.InternalTest>(0, 0,
	(new stdgo.testing.Testing.InternalTest(("TestCheckEqual" : GoString), stdgo.testing.quick.Quick.testCheckEqual) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestCheckProperty" : GoString),
		stdgo.testing.quick.Quick.testCheckProperty) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestFailure" : GoString), stdgo.testing.quick.Quick.testFailure) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestRecursive" : GoString), stdgo.testing.quick.Quick.testRecursive) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestEmptyStruct" : GoString), stdgo.testing.quick.Quick.testEmptyStruct) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestMutuallyRecursive" : GoString),
		stdgo.testing.quick.Quick.testMutuallyRecursive) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestNonZeroSliceAndMap" : GoString),
		stdgo.testing.quick.Quick.testNonZeroSliceAndMap) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestInt64" : GoString),
		stdgo.testing.quick.Quick.testInt64) : stdgo.testing.Testing.InternalTest)) : Slice<stdgo.testing.Testing.InternalTest>);
