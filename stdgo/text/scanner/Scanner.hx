...
/**
    /|*{
    	...
    	gotoNext = 4682600
    	_ = gotoNext == 4682600
    	if !redoBreak && (s.Whitespace&(1<<uint(ch_4682498)) != 0) {
    		gotoNext = 4682636
    		_ = gotoNext == 4682636
    		ch_4682498 = s.next()
    		gotoNext = 4682600
    	...
    	_ = gotoNext == 4683197
    	tok_4683197 = ch_4682498
    	gotoNext = 4683208
    	_ = gotoNext == 4683208
    	switch {
    	case s.isIdentRune(ch_4682498, 0):
    		gotoNext = 4683218
    		_ = gotoNext == 4683218
    		if s.Mode&4 != 0 {
    			gotoNext = 4683273
    		...
    		gotoNext = 4684286
    	case isDecimal(ch_4682498):
    		gotoNext = 4683350
    		_ = gotoNext == 4683350
    		if s.Mode&24 != 0 {
    			gotoNext = 4683409
    			_ = gotoNext == 4683409
    			tok_4683197, ch_4682498 = s.scanNumber(ch_4682498, false)
    			gotoNext = 4684286
    		} else {
    			gotoNext = 4683457
    			_ = gotoNext == 4683457
    	...
    	default:
    		...
    		case 46:
    			...
    			_ = gotoNext == 4683729
    			ch_4682498 = s.next()
    			if isDecimal(ch_4682498) && s.Mode&16 != 0 {
    				gotoNext = 4683802
    				_ = gotoNext == 4683802
    				tok_4683197, ch_4682498 = s.scanNumber(ch_4682498, true)
    				gotoNext = 4684286
    			} else {
    				gotoNext = 4684286
    			}
    		...
    		case 47:
    			...
    			_ = gotoNext == 4683848
    			ch_4682498 = s.next()
    			if (ch_4682498 == 47 || ch_4682498 == 42) && s.Mode&256 != 0 {
    				gotoNext = 4683934
    				_ = gotoNext == 4683934
    				if s.Mode&512 != 0 {
    					gotoNext = 4683968
    					_ = gotoNext == 4683968
    					s.tokPos = -1
    					ch_4682498 = s.scanComment(ch_4682498)
    					gotoNext = 4682572
    					gotoNext = 4684070
    				} else {
    					gotoNext = 4684070
