...
/**
    /|*{
    	...
    	gotoNext = 4255332
    	_ = gotoNext == 4255332
    	if !redoBreak && (s.Whitespace&(1<<uint(ch_4255230)) != 0) {
    		gotoNext = 4255368
    		_ = gotoNext == 4255368
    		ch_4255230 = s.next()
    		gotoNext = 4255332
    	...
    	_ = gotoNext == 4255929
    	tok_4255929 = ch_4255230
    	gotoNext = 4255940
    	_ = gotoNext == 4255940
    	switch {
    	case s.isIdentRune(ch_4255230, 0):
    		gotoNext = 4255950
    		_ = gotoNext == 4255950
    		if s.Mode&4 != 0 {
    			gotoNext = 4256005
    		...
    		gotoNext = 4257018
    	case isDecimal(ch_4255230):
    		gotoNext = 4256082
    		_ = gotoNext == 4256082
    		if s.Mode&24 != 0 {
    			gotoNext = 4256141
    			_ = gotoNext == 4256141
    			tok_4255929, ch_4255230 = s.scanNumber(ch_4255230, false)
    			gotoNext = 4257018
    		} else {
    			gotoNext = 4256189
    			_ = gotoNext == 4256189
    	...
    	default:
    		...
    		case 46:
    			...
    			_ = gotoNext == 4256461
    			ch_4255230 = s.next()
    			if isDecimal(ch_4255230) && s.Mode&16 != 0 {
    				gotoNext = 4256534
    				_ = gotoNext == 4256534
    				tok_4255929, ch_4255230 = s.scanNumber(ch_4255230, true)
    				gotoNext = 4257018
    			} else {
    				gotoNext = 4257018
    			}
    		...
    		case 47:
    			...
    			_ = gotoNext == 4256580
    			ch_4255230 = s.next()
    			if (ch_4255230 == 47 || ch_4255230 == 42) && s.Mode&256 != 0 {
    				gotoNext = 4256666
    				_ = gotoNext == 4256666
    				if s.Mode&512 != 0 {
    					gotoNext = 4256700
    					_ = gotoNext == 4256700
    					s.tokPos = -1
    					ch_4255230 = s.scanComment(ch_4255230)
    					gotoNext = 4255304
    					gotoNext = 4256802
    				} else {
    					gotoNext = 4256802
