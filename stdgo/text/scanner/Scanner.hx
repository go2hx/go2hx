...
/**
    /|*{
    	...
    	gotoNext = 4430315
    	_ = gotoNext == 4430315
    	if !redoBreak && (s.Whitespace&(1<<uint(ch_4430213)) != 0) {
    		gotoNext = 4430351
    		_ = gotoNext == 4430351
    		ch_4430213 = s.next()
    		gotoNext = 4430315
    	...
    	_ = gotoNext == 4430912
    	tok_4430912 = ch_4430213
    	gotoNext = 4430923
    	_ = gotoNext == 4430923
    	switch {
    	case s.isIdentRune(ch_4430213, 0):
    		gotoNext = 4430933
    		_ = gotoNext == 4430933
    		if s.Mode&4 != 0 {
    			gotoNext = 4430988
    		...
    		gotoNext = 4432001
    	case isDecimal(ch_4430213):
    		gotoNext = 4431065
    		_ = gotoNext == 4431065
    		if s.Mode&24 != 0 {
    			gotoNext = 4431124
    			_ = gotoNext == 4431124
    			tok_4430912, ch_4430213 = s.scanNumber(ch_4430213, false)
    			gotoNext = 4432001
    		} else {
    			gotoNext = 4431172
    			_ = gotoNext == 4431172
    	...
    	default:
    		...
    		case 46:
    			...
    			_ = gotoNext == 4431444
    			ch_4430213 = s.next()
    			if isDecimal(ch_4430213) && s.Mode&16 != 0 {
    				gotoNext = 4431517
    				_ = gotoNext == 4431517
    				tok_4430912, ch_4430213 = s.scanNumber(ch_4430213, true)
    				gotoNext = 4432001
    			} else {
    				gotoNext = 4432001
    			}
    		...
    		case 47:
    			...
    			_ = gotoNext == 4431563
    			ch_4430213 = s.next()
    			if (ch_4430213 == 47 || ch_4430213 == 42) && s.Mode&256 != 0 {
    				gotoNext = 4431649
    				_ = gotoNext == 4431649
    				if s.Mode&512 != 0 {
    					gotoNext = 4431683
    					_ = gotoNext == 4431683
    					s.tokPos = -1
    					ch_4430213 = s.scanComment(ch_4430213)
    					gotoNext = 4430287
    					gotoNext = 4431785
    				} else {
    					gotoNext = 4431785
