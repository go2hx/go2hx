...
/**
    /|*{
    	...
    	gotoNext = 4298534
    	_ = gotoNext == 4298534
    	if !redoBreak && (s.Whitespace&(1<<uint(ch_4298432)) != 0) {
    		gotoNext = 4298570
    		_ = gotoNext == 4298570
    		ch_4298432 = s.next()
    		gotoNext = 4298534
    	...
    	_ = gotoNext == 4299131
    	tok_4299131 = ch_4298432
    	gotoNext = 4299142
    	_ = gotoNext == 4299142
    	switch {
    	case s.isIdentRune(ch_4298432, 0):
    		gotoNext = 4299152
    		_ = gotoNext == 4299152
    		if s.Mode&4 != 0 {
    			gotoNext = 4299207
    		...
    		gotoNext = 4300220
    	case isDecimal(ch_4298432):
    		gotoNext = 4299284
    		_ = gotoNext == 4299284
    		if s.Mode&24 != 0 {
    			gotoNext = 4299343
    			_ = gotoNext == 4299343
    			tok_4299131, ch_4298432 = s.scanNumber(ch_4298432, false)
    			gotoNext = 4300220
    		} else {
    			gotoNext = 4299391
    			_ = gotoNext == 4299391
    	...
    	default:
    		...
    		case 46:
    			...
    			_ = gotoNext == 4299663
    			ch_4298432 = s.next()
    			if isDecimal(ch_4298432) && s.Mode&16 != 0 {
    				gotoNext = 4299736
    				_ = gotoNext == 4299736
    				tok_4299131, ch_4298432 = s.scanNumber(ch_4298432, true)
    				gotoNext = 4300220
    			} else {
    				gotoNext = 4300220
    			}
    		...
    		case 47:
    			...
    			_ = gotoNext == 4299782
    			ch_4298432 = s.next()
    			if (ch_4298432 == 47 || ch_4298432 == 42) && s.Mode&256 != 0 {
    				gotoNext = 4299868
    				_ = gotoNext == 4299868
    				if s.Mode&512 != 0 {
    					gotoNext = 4299902
    					_ = gotoNext == 4299902
    					s.tokPos = -1
    					ch_4298432 = s.scanComment(ch_4298432)
    					gotoNext = 4298506
    					gotoNext = 4300004
    				} else {
    					gotoNext = 4300004
