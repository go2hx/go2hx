...
/**
    /|*{
    	...
    	gotoNext = 4351646
    	_ = gotoNext == 4351646
    	if !redoBreak && (s.Whitespace&(1<<uint(ch_4351544)) != 0) {
    		gotoNext = 4351682
    		_ = gotoNext == 4351682
    		ch_4351544 = s.next()
    		gotoNext = 4351646
    	...
    	_ = gotoNext == 4352243
    	tok_4352243 = ch_4351544
    	_ = 0
    	gotoNext = 4352254
    	_ = gotoNext == 4352254
    	switch {
    	case s.isIdentRune(ch_4351544, 0):
    		gotoNext = 4352264
    		_ = gotoNext == 4352264
    		if s.Mode&4 != 0 {
    			gotoNext = 4352319
    		...
    		gotoNext = 4353332
    	case isDecimal(ch_4351544):
    		gotoNext = 4352396
    		_ = gotoNext == 4352396
    		if s.Mode&24 != 0 {
    			gotoNext = 4352455
    			_ = gotoNext == 4352455
    			tok_4352243, ch_4351544 = s.scanNumber(ch_4351544, false)
    			gotoNext = 4353332
    		} else {
    			gotoNext = 4352503
    			_ = gotoNext == 4352503
    	...
    	default:
    		...
    		case 46:
    			...
    			_ = gotoNext == 4352775
    			ch_4351544 = s.next()
    			if isDecimal(ch_4351544) && s.Mode&16 != 0 {
    				gotoNext = 4352848
    				_ = gotoNext == 4352848
    				tok_4352243, ch_4351544 = s.scanNumber(ch_4351544, true)
    				gotoNext = 4353332
    			} else {
    				gotoNext = 4353332
    			}
    		...
    		case 47:
    			...
    			_ = gotoNext == 4352894
    			ch_4351544 = s.next()
    			if (ch_4351544 == 47 || ch_4351544 == 42) && s.Mode&256 != 0 {
    				gotoNext = 4352980
    				_ = gotoNext == 4352980
    				if s.Mode&512 != 0 {
    					gotoNext = 4353014
    					_ = gotoNext == 4353014
    					s.tokPos = -1
    					ch_4351544 = s.scanComment(ch_4351544)
    					gotoNext = 4351618
    					gotoNext = 4353116
    				} else {
    					gotoNext = 4353116
