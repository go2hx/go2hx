...
/**
    /|*{
    	...
    	gotoNext = 4209807
    	_ = gotoNext == 4209807
    	if !redoBreak && (s.Whitespace&(1<<uint(ch_4209705)) != 0) {
    		gotoNext = 4209843
    		_ = gotoNext == 4209843
    		ch_4209705 = s.next()
    		gotoNext = 4209807
    	...
    	_ = gotoNext == 4210404
    	tok_4210404 = ch_4209705
    	gotoNext = 4210415
    	_ = gotoNext == 4210415
    	switch {
    	case s.isIdentRune(ch_4209705, 0):
    		gotoNext = 4210425
    		_ = gotoNext == 4210425
    		if s.Mode&4 != 0 {
    			gotoNext = 4210480
    		...
    		gotoNext = 4211493
    	case isDecimal(ch_4209705):
    		gotoNext = 4210557
    		_ = gotoNext == 4210557
    		if s.Mode&24 != 0 {
    			gotoNext = 4210616
    			_ = gotoNext == 4210616
    			tok_4210404, ch_4209705 = s.scanNumber(ch_4209705, false)
    			gotoNext = 4211493
    		} else {
    			gotoNext = 4210664
    			_ = gotoNext == 4210664
    	...
    	default:
    		...
    		case 46:
    			...
    			_ = gotoNext == 4210936
    			ch_4209705 = s.next()
    			if isDecimal(ch_4209705) && s.Mode&16 != 0 {
    				gotoNext = 4211009
    				_ = gotoNext == 4211009
    				tok_4210404, ch_4209705 = s.scanNumber(ch_4209705, true)
    				gotoNext = 4211493
    			} else {
    				gotoNext = 4211493
    			}
    		...
    		case 47:
    			...
    			_ = gotoNext == 4211055
    			ch_4209705 = s.next()
    			if (ch_4209705 == 47 || ch_4209705 == 42) && s.Mode&256 != 0 {
    				gotoNext = 4211141
    				_ = gotoNext == 4211141
    				if s.Mode&512 != 0 {
    					gotoNext = 4211175
    					_ = gotoNext == 4211175
    					s.tokPos = -1
    					ch_4209705 = s.scanComment(ch_4209705)
    					gotoNext = 4209779
    					gotoNext = 4211277
    				} else {
    					gotoNext = 4211277
