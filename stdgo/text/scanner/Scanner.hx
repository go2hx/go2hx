...
/**
    /|*{
    	...
    	gotoNext = 4180309
    	_ = gotoNext == 4180309
    	if !redoBreak && (s.Whitespace&(1<<uint(ch_4180207)) != 0) {
    		gotoNext = 4180345
    		_ = gotoNext == 4180345
    		ch_4180207 = s.next()
    		gotoNext = 4180309
    	...
    	_ = gotoNext == 4180906
    	tok_4180906 = ch_4180207
    	gotoNext = 4180917
    	_ = gotoNext == 4180917
    	switch {
    	case s.isIdentRune(ch_4180207, 0):
    		gotoNext = 4180927
    		_ = gotoNext == 4180927
    		if s.Mode&4 != 0 {
    			gotoNext = 4180982
    		...
    		gotoNext = 4181995
    	case isDecimal(ch_4180207):
    		gotoNext = 4181059
    		_ = gotoNext == 4181059
    		if s.Mode&24 != 0 {
    			gotoNext = 4181118
    			_ = gotoNext == 4181118
    			tok_4180906, ch_4180207 = s.scanNumber(ch_4180207, false)
    			gotoNext = 4181995
    		} else {
    			gotoNext = 4181166
    			_ = gotoNext == 4181166
    	...
    	default:
    		...
    		case 46:
    			...
    			_ = gotoNext == 4181438
    			ch_4180207 = s.next()
    			if isDecimal(ch_4180207) && s.Mode&16 != 0 {
    				gotoNext = 4181511
    				_ = gotoNext == 4181511
    				tok_4180906, ch_4180207 = s.scanNumber(ch_4180207, true)
    				gotoNext = 4181995
    			} else {
    				gotoNext = 4181995
    			}
    		...
    		case 47:
    			...
    			_ = gotoNext == 4181557
    			ch_4180207 = s.next()
    			if (ch_4180207 == 47 || ch_4180207 == 42) && s.Mode&256 != 0 {
    				gotoNext = 4181643
    				_ = gotoNext == 4181643
    				if s.Mode&512 != 0 {
    					gotoNext = 4181677
    					_ = gotoNext == 4181677
    					s.tokPos = -1
    					ch_4180207 = s.scanComment(ch_4180207)
    					gotoNext = 4180281
    					gotoNext = 4181779
    				} else {
    					gotoNext = 4181779
