...
/**
    /|*{
    	...
    	gotoNext = 4207727
    	_ = gotoNext == 4207727
    	if !redoBreak && (s.Whitespace&(1<<uint(ch_4207625)) != 0) {
    		gotoNext = 4207763
    		_ = gotoNext == 4207763
    		ch_4207625 = s.next()
    		gotoNext = 4207727
    	...
    	_ = gotoNext == 4208324
    	tok_4208324 = ch_4207625
    	_ = 0
    	gotoNext = 4208335
    	_ = gotoNext == 4208335
    	switch {
    	case s.isIdentRune(ch_4207625, 0):
    		gotoNext = 4208345
    		_ = gotoNext == 4208345
    		if s.Mode&4 != 0 {
    			gotoNext = 4208400
    		...
    		gotoNext = 4209413
    	case isDecimal(ch_4207625):
    		gotoNext = 4208477
    		_ = gotoNext == 4208477
    		if s.Mode&24 != 0 {
    			gotoNext = 4208536
    			_ = gotoNext == 4208536
    			tok_4208324, ch_4207625 = s.scanNumber(ch_4207625, false)
    			gotoNext = 4209413
    		} else {
    			gotoNext = 4208584
    			_ = gotoNext == 4208584
    	...
    	default:
    		...
    		case 46:
    			...
    			_ = gotoNext == 4208856
    			ch_4207625 = s.next()
    			if isDecimal(ch_4207625) && s.Mode&16 != 0 {
    				gotoNext = 4208929
    				_ = gotoNext == 4208929
    				tok_4208324, ch_4207625 = s.scanNumber(ch_4207625, true)
    				gotoNext = 4209413
    			} else {
    				gotoNext = 4209413
    			}
    		...
    		case 47:
    			...
    			_ = gotoNext == 4208975
    			ch_4207625 = s.next()
    			if (ch_4207625 == 47 || ch_4207625 == 42) && s.Mode&256 != 0 {
    				gotoNext = 4209061
    				_ = gotoNext == 4209061
    				if s.Mode&512 != 0 {
    					gotoNext = 4209095
    					_ = gotoNext == 4209095
    					s.tokPos = -1
    					ch_4207625 = s.scanComment(ch_4207625)
    					gotoNext = 4207699
    					gotoNext = 4209197
    				} else {
    					gotoNext = 4209197
