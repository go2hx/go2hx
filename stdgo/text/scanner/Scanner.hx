...
/**
    /|*{
    	...
    	gotoNext = 4440672
    	_ = gotoNext == 4440672
    	if !redoBreak && (s.Whitespace&(1<<uint(ch_4440570)) != 0) {
    		gotoNext = 4440708
    		_ = gotoNext == 4440708
    		ch_4440570 = s.next()
    		gotoNext = 4440672
    	...
    	_ = gotoNext == 4441269
    	tok_4441269 = ch_4440570
    	gotoNext = 4441280
    	_ = gotoNext == 4441280
    	switch {
    	case s.isIdentRune(ch_4440570, 0):
    		gotoNext = 4441290
    		_ = gotoNext == 4441290
    		if s.Mode&4 != 0 {
    			gotoNext = 4441345
    		...
    		gotoNext = 4442358
    	case isDecimal(ch_4440570):
    		gotoNext = 4441422
    		_ = gotoNext == 4441422
    		if s.Mode&24 != 0 {
    			gotoNext = 4441481
    			_ = gotoNext == 4441481
    			tok_4441269, ch_4440570 = s.scanNumber(ch_4440570, false)
    			gotoNext = 4442358
    		} else {
    			gotoNext = 4441529
    			_ = gotoNext == 4441529
    	...
    	default:
    		...
    		case 46:
    			...
    			_ = gotoNext == 4441801
    			ch_4440570 = s.next()
    			if isDecimal(ch_4440570) && s.Mode&16 != 0 {
    				gotoNext = 4441874
    				_ = gotoNext == 4441874
    				tok_4441269, ch_4440570 = s.scanNumber(ch_4440570, true)
    				gotoNext = 4442358
    			} else {
    				gotoNext = 4442358
    			}
    		...
    		case 47:
    			...
    			_ = gotoNext == 4441920
    			ch_4440570 = s.next()
    			if (ch_4440570 == 47 || ch_4440570 == 42) && s.Mode&256 != 0 {
    				gotoNext = 4442006
    				_ = gotoNext == 4442006
    				if s.Mode&512 != 0 {
    					gotoNext = 4442040
    					_ = gotoNext == 4442040
    					s.tokPos = -1
    					ch_4440570 = s.scanComment(ch_4440570)
    					gotoNext = 4440644
    					gotoNext = 4442142
    				} else {
    					gotoNext = 4442142
