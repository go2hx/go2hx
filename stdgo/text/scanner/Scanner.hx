...
/**
    /|*{
    	...
    	gotoNext = 4248333
    	_ = gotoNext == 4248333
    	if !redoBreak && (s.Whitespace&(1<<uint(ch_4248231)) != 0) {
    		gotoNext = 4248369
    		_ = gotoNext == 4248369
    		ch_4248231 = s.next()
    		gotoNext = 4248333
    	...
    	_ = gotoNext == 4248930
    	tok_4248930 = ch_4248231
    	gotoNext = 4248941
    	_ = gotoNext == 4248941
    	switch {
    	case s.isIdentRune(ch_4248231, 0):
    		gotoNext = 4248951
    		_ = gotoNext == 4248951
    		if s.Mode&4 != 0 {
    			gotoNext = 4249006
    		...
    		gotoNext = 4250019
    	case isDecimal(ch_4248231):
    		gotoNext = 4249083
    		_ = gotoNext == 4249083
    		if s.Mode&24 != 0 {
    			gotoNext = 4249142
    			_ = gotoNext == 4249142
    			tok_4248930, ch_4248231 = s.scanNumber(ch_4248231, false)
    			gotoNext = 4250019
    		} else {
    			gotoNext = 4249190
    			_ = gotoNext == 4249190
    	...
    	default:
    		...
    		case 46:
    			...
    			_ = gotoNext == 4249462
    			ch_4248231 = s.next()
    			if isDecimal(ch_4248231) && s.Mode&16 != 0 {
    				gotoNext = 4249535
    				_ = gotoNext == 4249535
    				tok_4248930, ch_4248231 = s.scanNumber(ch_4248231, true)
    				gotoNext = 4250019
    			} else {
    				gotoNext = 4250019
    			}
    		...
    		case 47:
    			...
    			_ = gotoNext == 4249581
    			ch_4248231 = s.next()
    			if (ch_4248231 == 47 || ch_4248231 == 42) && s.Mode&256 != 0 {
    				gotoNext = 4249667
    				_ = gotoNext == 4249667
    				if s.Mode&512 != 0 {
    					gotoNext = 4249701
    					_ = gotoNext == 4249701
    					s.tokPos = -1
    					ch_4248231 = s.scanComment(ch_4248231)
    					gotoNext = 4248305
    					gotoNext = 4249803
    				} else {
    					gotoNext = 4249803
