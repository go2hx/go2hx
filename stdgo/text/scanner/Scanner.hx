...
/**
    /|*{
    	...
    	gotoNext = 4262383
    	_ = gotoNext == 4262383
    	if !redoBreak && (s.Whitespace&(1<<uint(ch_4262281)) != 0) {
    		gotoNext = 4262419
    		_ = gotoNext == 4262419
    		ch_4262281 = s.next()
    		gotoNext = 4262383
    	...
    	_ = gotoNext == 4262980
    	tok_4262980 = ch_4262281
    	gotoNext = 4262991
    	_ = gotoNext == 4262991
    	switch {
    	case s.isIdentRune(ch_4262281, 0):
    		gotoNext = 4263001
    		_ = gotoNext == 4263001
    		if s.Mode&4 != 0 {
    			gotoNext = 4263056
    		...
    		gotoNext = 4264069
    	case isDecimal(ch_4262281):
    		gotoNext = 4263133
    		_ = gotoNext == 4263133
    		if s.Mode&24 != 0 {
    			gotoNext = 4263192
    			_ = gotoNext == 4263192
    			tok_4262980, ch_4262281 = s.scanNumber(ch_4262281, false)
    			gotoNext = 4264069
    		} else {
    			gotoNext = 4263240
    			_ = gotoNext == 4263240
    	...
    	default:
    		...
    		case 46:
    			...
    			_ = gotoNext == 4263512
    			ch_4262281 = s.next()
    			if isDecimal(ch_4262281) && s.Mode&16 != 0 {
    				gotoNext = 4263585
    				_ = gotoNext == 4263585
    				tok_4262980, ch_4262281 = s.scanNumber(ch_4262281, true)
    				gotoNext = 4264069
    			} else {
    				gotoNext = 4264069
    			}
    		...
    		case 47:
    			...
    			_ = gotoNext == 4263631
    			ch_4262281 = s.next()
    			if (ch_4262281 == 47 || ch_4262281 == 42) && s.Mode&256 != 0 {
    				gotoNext = 4263717
    				_ = gotoNext == 4263717
    				if s.Mode&512 != 0 {
    					gotoNext = 4263751
    					_ = gotoNext == 4263751
    					s.tokPos = -1
    					ch_4262281 = s.scanComment(ch_4262281)
    					gotoNext = 4262355
    					gotoNext = 4263853
    				} else {
    					gotoNext = 4263853
