...
/**
    /|*{
    	...
    	gotoNext = 4336896
    	_ = gotoNext == 4336896
    	if !redoBreak && (s.Whitespace&(1<<uint(ch_4336794)) != 0) {
    		gotoNext = 4336932
    		_ = gotoNext == 4336932
    		ch_4336794 = s.next()
    		gotoNext = 4336896
    	...
    	_ = gotoNext == 4337493
    	tok_4337493 = ch_4336794
    	gotoNext = 4337504
    	_ = gotoNext == 4337504
    	switch {
    	case s.isIdentRune(ch_4336794, 0):
    		gotoNext = 4337514
    		_ = gotoNext == 4337514
    		if s.Mode&4 != 0 {
    			gotoNext = 4337569
    		...
    		gotoNext = 4338582
    	case isDecimal(ch_4336794):
    		gotoNext = 4337646
    		_ = gotoNext == 4337646
    		if s.Mode&24 != 0 {
    			gotoNext = 4337705
    			_ = gotoNext == 4337705
    			tok_4337493, ch_4336794 = s.scanNumber(ch_4336794, false)
    			gotoNext = 4338582
    		} else {
    			gotoNext = 4337753
    			_ = gotoNext == 4337753
    	...
    	default:
    		...
    		case 46:
    			...
    			_ = gotoNext == 4338025
    			ch_4336794 = s.next()
    			if isDecimal(ch_4336794) && s.Mode&16 != 0 {
    				gotoNext = 4338098
    				_ = gotoNext == 4338098
    				tok_4337493, ch_4336794 = s.scanNumber(ch_4336794, true)
    				gotoNext = 4338582
    			} else {
    				gotoNext = 4338582
    			}
    		...
    		case 47:
    			...
    			_ = gotoNext == 4338144
    			ch_4336794 = s.next()
    			if (ch_4336794 == 47 || ch_4336794 == 42) && s.Mode&256 != 0 {
    				gotoNext = 4338230
    				_ = gotoNext == 4338230
    				if s.Mode&512 != 0 {
    					gotoNext = 4338264
    					_ = gotoNext == 4338264
    					s.tokPos = -1
    					ch_4336794 = s.scanComment(ch_4336794)
    					gotoNext = 4336868
    					gotoNext = 4338366
    				} else {
    					gotoNext = 4338366
