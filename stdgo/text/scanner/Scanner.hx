...
/**
    /|*{
    	...
    	gotoNext = 4252544
    	_ = gotoNext == 4252544
    	if !redoBreak && (s.Whitespace&(1<<uint(ch_4252442)) != 0) {
    		gotoNext = 4252580
    		_ = gotoNext == 4252580
    		ch_4252442 = s.next()
    		gotoNext = 4252544
    	...
    	_ = gotoNext == 4253141
    	tok_4253141 = ch_4252442
    	gotoNext = 4253152
    	_ = gotoNext == 4253152
    	switch {
    	case s.isIdentRune(ch_4252442, 0):
    		gotoNext = 4253162
    		_ = gotoNext == 4253162
    		if s.Mode&4 != 0 {
    			gotoNext = 4253217
    		...
    		gotoNext = 4254230
    	case isDecimal(ch_4252442):
    		gotoNext = 4253294
    		_ = gotoNext == 4253294
    		if s.Mode&24 != 0 {
    			gotoNext = 4253353
    			_ = gotoNext == 4253353
    			tok_4253141, ch_4252442 = s.scanNumber(ch_4252442, false)
    			gotoNext = 4254230
    		} else {
    			gotoNext = 4253401
    			_ = gotoNext == 4253401
    	...
    	default:
    		...
    		case 46:
    			...
    			_ = gotoNext == 4253673
    			ch_4252442 = s.next()
    			if isDecimal(ch_4252442) && s.Mode&16 != 0 {
    				gotoNext = 4253746
    				_ = gotoNext == 4253746
    				tok_4253141, ch_4252442 = s.scanNumber(ch_4252442, true)
    				gotoNext = 4254230
    			} else {
    				gotoNext = 4254230
    			}
    		...
    		case 47:
    			...
    			_ = gotoNext == 4253792
    			ch_4252442 = s.next()
    			if (ch_4252442 == 47 || ch_4252442 == 42) && s.Mode&256 != 0 {
    				gotoNext = 4253878
    				_ = gotoNext == 4253878
    				if s.Mode&512 != 0 {
    					gotoNext = 4253912
    					_ = gotoNext == 4253912
    					s.tokPos = -1
    					ch_4252442 = s.scanComment(ch_4252442)
    					gotoNext = 4252516
    					gotoNext = 4254014
    				} else {
    					gotoNext = 4254014
