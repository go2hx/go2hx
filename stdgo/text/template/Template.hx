...
@:structInit @:using(Template.T_state_static_extension) @:dox(hide) abstract T_state(stdgo._internal.text.template.Template_t_state.T_state) from stdgo._internal.text.template.Template_t_state.T_state to stdgo._internal.text.template.Template_t_state.T_state {
...
@:structInit @:using(Template.T_variable_static_extension) @:dox(hide) abstract T_variable(stdgo._internal.text.template.Template_t_variable.T_variable) from stdgo._internal.text.template.Template_t_variable.T_variable to stdgo._internal.text.template.Template_t_variable.T_variable {
...
@:structInit @:using(Template.T_writeError_static_extension) @:dox(hide) abstract T_writeError(stdgo._internal.text.template.Template_t_writeerror.T_writeError) from stdgo._internal.text.template.Template_t_writeerror.T_writeError to stdgo._internal.text.template.Template_t_writeerror.T_writeError {
    public var err(get, set) : stdgo.Error;
    function get_err():stdgo.Error return this.err;
    function set_err(v:stdgo.Error):stdgo.Error {
        this.err = (v : stdgo.Error);
...
@:structInit @:using(Template.T__static_extension) @:dox(hide) abstract T_(stdgo._internal.text.template.Template_t_.T_) from stdgo._internal.text.template.Template_t_.T_ to stdgo._internal.text.template.Template_t_.T_ {
...
@:structInit @:using(Template.U_static_extension) abstract U(stdgo._internal.text.template.Template_u.U) from stdgo._internal.text.template.Template_u.U to stdgo._internal.text.template.Template_u.U {
...
@:structInit @:using(Template.V_static_extension) abstract V(stdgo._internal.text.template.Template_v.V) from stdgo._internal.text.template.Template_v.V to stdgo._internal.text.template.Template_v.V {
...
@:structInit @:using(Template.W_static_extension) abstract W(stdgo._internal.text.template.Template_w.W) from stdgo._internal.text.template.Template_w.W to stdgo._internal.text.template.Template_w.W {
...
@:structInit @:using(Template.T_execTest_static_extension) @:dox(hide) abstract T_execTest(stdgo._internal.text.template.Template_t_exectest.T_execTest) from stdgo._internal.text.template.Template_t_exectest.T_execTest to stdgo._internal.text.template.Template_t_exectest.T_execTest {
    public var _name(get, set) : String;
    function get__name():String return this._name;
    function set__name(v:String):String {
        this._name = (v : stdgo.GoString);
...
@:structInit @:using(Template.CustomError_static_extension) abstract CustomError(stdgo._internal.text.template.Template_customerror.CustomError) from stdgo._internal.text.template.Template_customerror.CustomError to stdgo._internal.text.template.Template_customerror.CustomError {
    public function new() this = new stdgo._internal.text.template.Template_customerror.CustomError();
    public function __underlying__() return stdgo.Go.toInterface(this);
    public function __copy__() return this.__copy__();
}
@:structInit @:using(Template.Tree_static_extension) abstract Tree(stdgo._internal.text.template.Template_tree.Tree) from stdgo._internal.text.template.Template_tree.Tree to stdgo._internal.text.template.Template_tree.Tree {
...
@:structInit @:using(Template.T_cmpTest_static_extension) @:dox(hide) abstract T_cmpTest(stdgo._internal.text.template.Template_t_cmptest.T_cmpTest) from stdgo._internal.text.template.Template_t_cmptest.T_cmpTest to stdgo._internal.text.template.Template_t_cmptest.T_cmpTest {
...
@:structInit @:using(Template.T_option_static_extension) @:dox(hide) abstract T_option(stdgo._internal.text.template.Template_t_option.T_option) from stdgo._internal.text.template.Template_t_option.T_option to stdgo._internal.text.template.Template_t_option.T_option {
...
@:structInit @:using(Template.T_common_static_extension) @:dox(hide) abstract T_common(stdgo._internal.text.template.Template_t_common.T_common) from stdgo._internal.text.template.Template_t_common.T_common to stdgo._internal.text.template.Template_t_common.T_common {
...
@:structInit @:using(Template.Template_static_extension) abstract Template_(stdgo._internal.text.template.Template_template.Template) from stdgo._internal.text.template.Template_template.Template to stdgo._internal.text.template.Template_template.Template {
    public var _name(get, set) : String;
    function get__name():String return this._name;
    function set__name(v:String):String {
        this._name = (v : stdgo.GoString);
