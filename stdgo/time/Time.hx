...
/**
	...
	// that package, since we can't take a dependency on either.
**/
private final _runeError:GoInt32 = (65533 : GoInt32);
		...
		Go.cfor(_i < (_layout.length), _i++, {
			{
				...
				if (_c == ((74 : GoInt))) {
					...
					if (((_layout.length >= (_i + (2 : GoInt))) && ((49 : GoUInt8) <= _layout[(_i + (1 : GoInt) : GoInt)]))
						&& (_layout[(_i + (1 : GoInt) : GoInt)] <= (54 : GoUInt8))) {
						return {_0: (_layout.__slice__((0 : GoInt),
							_i) : GoString), _1: _std0x[(_layout[(_i + (1 : GoInt) : GoInt)] - (49 : GoUInt8): GoInt)], _2: (_layout.__slice__(_i +
								(2 : GoInt)) : GoString)};
					};
					if (((_layout.length >= (_i + (3 : GoInt))) && (_layout[(_i + (1 : GoInt) : GoInt)] == (48 : GoUInt8)))
						&& (_layout[(_i + (2 : GoInt) : GoInt)] == (50 : GoUInt8))) {
					...
					if (((_layout.length >= (_i + (3 : GoInt))) && (_layout[(_i + (1 : GoInt) : GoInt)] == (95 : GoUInt8)))
						&& (_layout[(_i + (2 : GoInt) : GoInt)] == (50 : GoUInt8))) {
					...
					if (((_i + (1 : GoInt)) < _layout.length)
						&& ((_layout[(_i + (1 : GoInt) : GoInt)] == (48 : GoUInt8))
							|| (_layout[(_i + (1 : GoInt) : GoInt)] == (57 : GoUInt8)))) {
...
function _appendInt(_b:Slice<GoByte>, _x:GoInt, _width:GoInt):Slice<GoByte> {
	...
	while (_u >= ("10" : GoUInt)) {
		...
		_buf[(_i : GoInt)] = (((("48" : GoUInt) : GoUInt) + _u) - (_q * (("10" : GoUInt) : GoUInt)) : GoByte);
		_u = _q;
	};
	_i--;
	_buf[(_i : GoInt)] = (("48" : GoUInt) + _u : GoByte);
	{
...
function _formatNano(_b:Slice<GoByte>, _nanosec:GoUInt, _std:GoInt):Slice<GoByte> {
	...
	var _buf:GoArray<GoByte> = new GoArray<GoUInt8>(...[for (i in 0...9) (0 : GoUInt8)]);
	{
		...
		while (_start > (0 : GoInt)) {
			_start--;
			_buf[(_start : GoInt)] = ((_u % (("10" : GoUInt) : GoUInt)) + ("48" : GoUInt) : GoByte);
			_u = _u / (("10" : GoUInt));
		};
	};
	if (_n > (9 : GoInt)) {
	...
	if (_trim) {
		while ((_n > (0 : GoInt)) && (_buf[(_n - (1 : GoInt) : GoInt)] == (48 : GoUInt8))) {
			_n--;
		};
		if (_n == ((0 : GoInt))) {
			return _b;
...
function _getnum(_s:GoString, _fixed:Bool):{var _0:GoInt; var _1:GoString; var _2:Error;} {
	...
	return {_0: ((_s[(0 : GoInt)] - (48 : GoUInt8): GoInt) * (10 : GoInt))
		+ (_s[(1 : GoInt)] - (48 : GoUInt8): GoInt), _1: (_s.__slice__((2 : GoInt)) : GoString), _2: (null : Error)};
}
		...
		var _p:GoString = ("" : GoString);
		{
			...
			while (true) {
				if (_std & (65535 : GoInt) == ((276 : GoInt))) {
					...
					if ((((_value.length < (2:GoInt)) || !_commaOrPeriod(_value[(0 : GoInt)])) || (_value[(1 : GoInt)] < (48 : GoUInt8)))
						|| ((57 : GoUInt8) < _value[(1 : GoInt)])) {
						break;
					};
					var _i:GoInt = (0 : GoInt);
					while ((((_i < (9:GoInt)) && ((_i + (1 : GoInt)) < _value.length))
						&& ((48 : GoUInt8) <= _value[(_i + (1 : GoInt) : GoInt)]))
						&& (_value[(_i + (1 : GoInt) : GoInt)] <= (57 : GoUInt8))) {
						_i++;
					};
					{
...
function _tzsetName(_s:GoString):{var _0:GoString; var _1:GoString; var _2:Bool;} {
	...
	if (_s[(0 : GoInt)] != ((60 : GoUInt8))) {
		for (_i => _r in _s) {
			if (_r == ((48 : GoInt32)) || _r == ((49 : GoInt32)) || _r == ((50 : GoInt32)) || _r == ((51 : GoInt32)) || _r == ((52 : GoInt32))
				|| _r == ((53 : GoInt32)) || _r == ((54 : GoInt32)) || _r == ((55 : GoInt32)) || _r == ((56 : GoInt32)) || _r == ((57 : GoInt32))
				|| _r == ((44 : GoInt32)) || _r == ((45 : GoInt32)) || _r == ((43 : GoInt32))) {
				if (_i < (3:GoInt)) {
					return {_0: Go.str(), _1: Go.str(), _2: false};
				};
...
function loadLocationFromTZData(_name:GoString, _data:Slice<GoByte>):{var _0:Ref<Location>; var _1:Error;} {
	...
	var _rest = _d._rest();
	if (((_rest.length > (2 : GoInt)) && (_rest[(0 : GoInt)] == (10 : GoUInt8)))
		&& (_rest[((_rest.length) - (1 : GoInt) : GoInt)] == (10 : GoUInt8))) {
	...
	for (_i in 0..._tx.length.toBasic()) {
		if ((_tx[(_i : GoInt)]._when <= _sec)
			&& (((_i + (1 : GoInt)) == (_tx.length)) || (_sec < _tx[(_i + (1 : GoInt) : GoInt)]._when))) {
