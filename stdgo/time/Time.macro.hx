        ...
        final T_bytes:haxe.macro.Expr.ComplexType = haxe.macro.Context.toComplexType(haxe.macro.Context.typeof(__generic__0));
        {
            ...
            try {
                ...
                final f = macro function f(__generic__0:$T_bytes, _s:$T_bytes) {
                    ...
                    var __tmp__ = @:privateAccess stdgo.time.Time._leadingInt(stdgo.Go.defaultValue((cast (null) : $T_bytes)), _s), _q:stdgo.GoUInt64 = __tmp__._0, _rem:$T_bytes = __tmp__._1, _err:stdgo.Error = __tmp__._2;
                    _x = (_q : stdgo.GoInt);
                    if ((_err != null) || (_rem.length > (0 : stdgo.GoInt))) {
                        return { _0 : (0 : stdgo.GoInt), _1 : @:privateAccess stdgo.time.Time._errAtoi };
                    };
                    if (_neg) {
                        _x = -_x;
                    };
        ...
        final T_bytes:haxe.macro.Expr.ComplexType = haxe.macro.Context.toComplexType(haxe.macro.Context.typeof(__generic__0));
        {
            ...
            try {
                ...
                final f = macro function f(__generic__0:$T_bytes, _value:$T_bytes, _nbytes:stdgo.GoInt) {
                    var _ns:stdgo.GoInt = (0 : stdgo.GoInt), _rangeErrString:stdgo.GoString = ("" : stdgo.GoString), _err:stdgo.Error = (null : stdgo.Error);
                    if (!@:privateAccess stdgo.time.Time._commaOrPeriod(_value[@:param_index (0 : stdgo.GoInt)])) {
                    ...
                    {
                        {
                            var __tmp__ = @:privateAccess stdgo.time.Time._atoi(stdgo.Go.defaultValue((cast (null) : $T_bytes)), (_value.__slice__((1 : stdgo.GoInt), _nbytes) : $T_bytes));
                            _ns = __tmp__._0;
                            _err = __tmp__._1;
                        };
                        if (_err != null) {
                ...
                final f = macro function f(__generic__0:$T_bytes, _s:$T_bytes) {
                    ...
                    stdgo.Go.cfor(_i < (_s.length), _i++, {
                        ...
                        if (_x > (922337203685477580i64 : stdgo.GoUInt64)) {
                            return { _0 : (0i64 : stdgo.GoUInt64), _1 : _rem, _2 : @:privateAccess stdgo.time.Time._errLeadingInt };
                        };
...
macro function _parseRFC3339<T_bytes>(__generic__0:haxe.macro.Expr.ExprOf<T_bytes>, _s:haxe.macro.Expr.ExprOf<T_bytes>, _local:haxe.macro.Expr.ExprOf<stdgo.Ref<Location>>):haxe.macro.Expr.ExprOf<{ var _0 : Time; var _1 : Bool; }> {
        final T_bytes:haxe.macro.Expr.ComplexType = haxe.macro.Context.toComplexType(haxe.macro.Context.typeof(__generic__0));
        {
            ...
            try {
                ...
                final f = macro function f(__generic__0:$T_bytes, _s:$T_bytes, _local:stdgo.Ref<stdgo.time.Time.Location>) {
                    var _ok:Bool = true;
                    ...
                    var _month:stdgo.GoInt = _parseUint((_s.__slice__((5 : stdgo.GoInt), (7 : stdgo.GoInt)) : $T_bytes), (1 : stdgo.GoInt), (12 : stdgo.GoInt));
                    var _day:stdgo.GoInt = _parseUint((_s.__slice__((8 : stdgo.GoInt), (10 : stdgo.GoInt)) : $T_bytes), (1 : stdgo.GoInt), @:privateAccess stdgo.time.Time._daysIn((_month : stdgo.time.Time.Month), _year));
                    ...
                    if (((_s.length >= (2 : stdgo.GoInt)) && (_s[@:param_index (0 : stdgo.GoInt)] == (46 : stdgo.GoUInt8))) && @:privateAccess stdgo.time.Time._isDigit(stdgo.Go.defaultValue((cast (null) : $T_bytes)), _s, (1 : stdgo.GoInt))) {
