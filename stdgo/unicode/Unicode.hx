...
((("Armenian" : GoString))) => armenian,
((("Avestan" : GoString))) => avestan,
((("Balinese" : GoString))) => balinese,
((("Bamum" : GoString))) => bamum,
((("Bassa_Vah" : GoString))) => bassa_Vah,
((("Batak" : GoString))) => batak,
((("Bengali" : GoString))) => bengali,
((("Bhaiksuki" : GoString))) => bhaiksuki,
((("Bopomofo" : GoString))) => bopomofo,
((("Brahmi" : GoString))) => brahmi,
((("Braille" : GoString))) => braille,
((("Buginese" : GoString))) => buginese,
((("Buhid" : GoString))) => buhid,
((("Canadian_Aboriginal" : GoString))) => canadian_Aboriginal,
((("Carian" : GoString))) => carian,
((("Caucasian_Albanian" : GoString))) => caucasian_Albanian,
((("Chakma" : GoString))) => chakma,
((("Cham" : GoString))) => cham,
((("Cherokee" : GoString))) => cherokee,
((("Chorasmian" : GoString))) => chorasmian,
((("Common" : GoString))) => common,
((("Coptic" : GoString))) => coptic,
((("Cuneiform" : GoString))) => cuneiform,
((("Cypriot" : GoString))) => cypriot,
((("Cyrillic" : GoString))) => cyrillic,
((("Deseret" : GoString))) => deseret,
((("Devanagari" : GoString))) => devanagari,
((("Dives_Akuru" : GoString))) => dives_Akuru,
((("Dogra" : GoString))) => dogra,
((("Duployan" : GoString))) => duployan,
((("Egyptian_Hieroglyphs" : GoString))) => egyptian_Hieroglyphs,
((("Elbasan" : GoString))) => elbasan,
((("Elymaic" : GoString))) => elymaic,
((("Ethiopic" : GoString))) => ethiopic,
((("Georgian" : GoString))) => georgian,
((("Glagolitic" : GoString))) => glagolitic,
((("Gothic" : GoString))) => gothic,
((("Grantha" : GoString))) => grantha,
((("Greek" : GoString))) => greek,
((("Gujarati" : GoString))) => gujarati,
((("Gunjala_Gondi" : GoString))) => gunjala_Gondi,
((("Gurmukhi" : GoString))) => gurmukhi,
((("Han" : GoString))) => han,
((("Hangul" : GoString))) => hangul,
((("Hanifi_Rohingya" : GoString))) => hanifi_Rohingya,
((("Hanunoo" : GoString))) => hanunoo,
((("Hatran" : GoString))) => hatran,
((("Hebrew" : GoString))) => hebrew,
((("Hiragana" : GoString))) => hiragana,
((("Imperial_Aramaic" : GoString))) => imperial_Aramaic,
((("Inherited" : GoString))) => inherited,
((("Inscriptional_Pahlavi" : GoString))) => inscriptional_Pahlavi,
((("Inscriptional_Parthian" : GoString))) => inscriptional_Parthian,
((("Javanese" : GoString))) => javanese,
((("Kaithi" : GoString))) => kaithi,
((("Kannada" : GoString))) => kannada,
((("Katakana" : GoString))) => katakana,
((("Kayah_Li" : GoString))) => kayah_Li,
((("Kharoshthi" : GoString))) => kharoshthi,
((("Khitan_Small_Script" : GoString))) => khitan_Small_Script,
((("Khmer" : GoString))) => khmer,
((("Khojki" : GoString))) => khojki,
((("Khudawadi" : GoString))) => khudawadi,
((("Lao" : GoString))) => lao,
((("Latin" : GoString))) => latin,
((("Lepcha" : GoString))) => lepcha,
((("Limbu" : GoString))) => limbu,
((("Linear_A" : GoString))) => linear_A,
((("Linear_B" : GoString))) => linear_B,
((("Lisu" : GoString))) => lisu,
((("Lycian" : GoString))) => lycian,
((("Lydian" : GoString))) => lydian,
((("Mahajani" : GoString))) => mahajani,
((("Makasar" : GoString))) => makasar,
((("Malayalam" : GoString))) => malayalam,
((("Mandaic" : GoString))) => mandaic,
((("Manichaean" : GoString))) => manichaean,
((("Marchen" : GoString))) => marchen,
((("Masaram_Gondi" : GoString))) => masaram_Gondi,
((("Medefaidrin" : GoString))) => medefaidrin,
((("Meetei_Mayek" : GoString))) => meetei_Mayek,
((("Mende_Kikakui" : GoString))) => mende_Kikakui,
((("Meroitic_Cursive" : GoString))) => meroitic_Cursive,
((("Meroitic_Hieroglyphs" : GoString))) => meroitic_Hieroglyphs,
((("Miao" : GoString))) => miao,
((("Modi" : GoString))) => modi,
((("Mongolian" : GoString))) => mongolian,
((("Mro" : GoString))) => mro,
((("Multani" : GoString))) => multani,
((("Myanmar" : GoString))) => myanmar,
((("Nabataean" : GoString))) => nabataean,
((("Nandinagari" : GoString))) => nandinagari,
((("New_Tai_Lue" : GoString))) => new_Tai_Lue,
((("Newa" : GoString))) => newa,
((("Nko" : GoString))) => nko,
((("Nushu" : GoString))) => nushu,
((("Nyiakeng_Puachue_Hmong" : GoString))) => nyiakeng_Puachue_Hmong,
((("Ogham" : GoString))) => ogham,
((("Ol_Chiki" : GoString))) => ol_Chiki,
((("Old_Hungarian" : GoString))) => old_Hungarian,
((("Old_Italic" : GoString))) => old_Italic,
((("Old_North_Arabian" : GoString))) => old_North_Arabian,
((("Old_Permic" : GoString))) => old_Permic,
((("Old_Persian" : GoString))) => old_Persian,
((("Old_Sogdian" : GoString))) => old_Sogdian,
((("Old_South_Arabian" : GoString))) => old_South_Arabian,
((("Old_Turkic" : GoString))) => old_Turkic,
((("Oriya" : GoString))) => oriya,
((("Osage" : GoString))) => osage,
((("Osmanya" : GoString))) => osmanya,
((("Pahawh_Hmong" : GoString))) => pahawh_Hmong,
((("Palmyrene" : GoString))) => palmyrene,
((("Pau_Cin_Hau" : GoString))) => pau_Cin_Hau,
((("Phags_Pa" : GoString))) => phags_Pa,
((("Phoenician" : GoString))) => phoenician,
((("Psalter_Pahlavi" : GoString))) => psalter_Pahlavi,
((("Rejang" : GoString))) => rejang,
((("Runic" : GoString))) => runic,
((("Samaritan" : GoString))) => samaritan,
((("Saurashtra" : GoString))) => saurashtra,
((("Sharada" : GoString))) => sharada,
((("Shavian" : GoString))) => shavian,
((("Siddham" : GoString))) => siddham,
((("SignWriting" : GoString))) => signWriting,
((("Sinhala" : GoString))) => sinhala,
((("Sogdian" : GoString))) => sogdian,
((("Sora_Sompeng" : GoString))) => sora_Sompeng,
((("Soyombo" : GoString))) => soyombo,
((("Sundanese" : GoString))) => sundanese,
((("Syloti_Nagri" : GoString))) => syloti_Nagri,
((("Syriac" : GoString))) => syriac,
((("Tagalog" : GoString))) => tagalog,
((("Tagbanwa" : GoString))) => tagbanwa,
((("Tai_Le" : GoString))) => tai_Le,
((("Tai_Tham" : GoString))) => tai_Tham,
((("Tai_Viet" : GoString))) => tai_Viet,
((("Takri" : GoString))) => takri,
((("Tamil" : GoString))) => tamil,
((("Tangut" : GoString))) => tangut,
((("Telugu" : GoString))) => telugu,
((("Thaana" : GoString))) => thaana,
((("Thai" : GoString))) => thai,
((("Tibetan" : GoString))) => tibetan,
((("Tifinagh" : GoString))) => tifinagh,
((("Tirhuta" : GoString))) => tirhuta,
((("Ugaritic" : GoString))) => ugaritic,
((("Vai" : GoString))) => vai,
((("Wancho" : GoString))) => wancho,
((("Warang_Citi" : GoString))) => warang_Citi,
...
((("Diacritic" : GoString))) => diacritic,
((("Extender" : GoString))) => extender,
((("Hex_Digit" : GoString))) => hex_Digit,
((("Hyphen" : GoString))) => hyphen,
((("IDS_Binary_Operator" : GoString))) => ids_Binary_Operator,
((("IDS_Trinary_Operator" : GoString))) => ids_Trinary_Operator,
((("Ideographic" : GoString))) => ideographic,
((("Join_Control" : GoString))) => join_Control,
((("Logical_Order_Exception" : GoString))) => logical_Order_Exception,
((("Noncharacter_Code_Point" : GoString))) => noncharacter_Code_Point,
((("Other_Alphabetic" : GoString))) => other_Alphabetic,
((("Other_Default_Ignorable_Code_Point" : GoString))) => other_Default_Ignorable_Code_Point,
((("Other_Grapheme_Extend" : GoString))) => other_Grapheme_Extend,
((("Other_ID_Continue" : GoString))) => other_ID_Continue,
((("Other_ID_Start" : GoString))) => other_ID_Start,
((("Other_Lowercase" : GoString))) => other_Lowercase,
((("Other_Math" : GoString))) => other_Math,
((("Other_Uppercase" : GoString))) => other_Uppercase,
((("Pattern_Syntax" : GoString))) => pattern_Syntax,
((("Pattern_White_Space" : GoString))) => pattern_White_Space,
((("Prepended_Concatenation_Mark" : GoString))) => prepended_Concatenation_Mark,
((("Quotation_Mark" : GoString))) => quotation_Mark,
((("Radical" : GoString))) => radical,
((("Regional_Indicator" : GoString))) => regional_Indicator,
((("Sentence_Terminal" : GoString))) => sentence_Terminal,
((("STerm" : GoString))) => sentence_Terminal,
((("Soft_Dotted" : GoString))) => soft_Dotted,
((("Terminal_Punctuation" : GoString))) => terminal_Punctuation,
((("Unified_Ideograph" : GoString))) => unified_Ideograph,
((("Variation_Selector" : GoString))) => variation_Selector,
((("White_Space" : GoString))) => white_Space);
