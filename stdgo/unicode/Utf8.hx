...
abstract T_acceptRange(stdgo._internal.unicode.utf8.Utf8.T_acceptRange) from stdgo._internal.unicode.utf8.Utf8.T_acceptRange to stdgo._internal.unicode.utf8.Utf8.T_acceptRange {
...
class Utf8 {
    ...
    **/
    static public function fullRune(p:Array<StdTypes.Int>):Bool {
    ...
    **/
    static public function fullRuneInString(s:String):Bool {
    ...
    **/
    static public function decodeRune(p:Array<StdTypes.Int>):stdgo.Tuple<StdTypes.Int, StdTypes.Int> {
        final p = ([for (i in p) i] : stdgo.Slice<stdgo.GoByte>);
        return {
    ...
    /**
        ...
        value. No other validation is performed.
    **/
    static public function decodeRuneInString(s:String):stdgo.Tuple<StdTypes.Int, StdTypes.Int> {
        return {
    ...
    /**
        ...
        value. No other validation is performed.
    **/
    static public function decodeLastRune(p:Array<StdTypes.Int>):stdgo.Tuple<StdTypes.Int, StdTypes.Int> {
        final p = ([for (i in p) i] : stdgo.Slice<stdgo.GoByte>);
        return {
    ...
    /**
        ...
        value. No other validation is performed.
    **/
    static public function decodeLastRuneInString(s:String):stdgo.Tuple<StdTypes.Int, StdTypes.Int> {
        return {
    ...
    **/
    static public function runeLen(r:StdTypes.Int):StdTypes.Int {
    ...
    **/
    static public function encodeRune(p:Array<StdTypes.Int>, r:StdTypes.Int):StdTypes.Int {
        final p = ([for (i in p) i] : stdgo.Slice<stdgo.GoByte>);
    ...
    **/
    static public function appendRune(p:Array<StdTypes.Int>, r:StdTypes.Int):Array<StdTypes.Int> {
        final p = ([for (i in p) i] : stdgo.Slice<stdgo.GoByte>);
    ...
    **/
    static public function runeCount(p:Array<StdTypes.Int>):StdTypes.Int {
        final p = ([for (i in p) i] : stdgo.Slice<stdgo.GoByte>);
    ...
    **/
    static public function runeCountInString(s:String):StdTypes.Int {
    ...
    /**
        ...
        bits set to 10.
    **/
    static public function runeStart(b:StdTypes.Int):Bool {
        return stdgo._internal.unicode.utf8.Utf8.runeStart(b);
    }
    /**
        Valid reports whether p consists entirely of valid UTF-8-encoded runes.
    **/
    static public function valid(p:Array<StdTypes.Int>):Bool {
        final p = ([for (i in p) i] : stdgo.Slice<stdgo.GoByte>);
    ...
    **/
    static public function validString(s:String):Bool {
    ...
    **/
    static public function validRune(r:StdTypes.Int):Bool {
