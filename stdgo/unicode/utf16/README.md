...
=== RUN   TestEncode
--- PASS: TestEncode (0.000278949737548828)
=== RUN   TestEncodeRune
--- PASS: TestEncodeRune (3.09944152832031e-05)
=== RUN   TestDecode
--- PASS: TestDecode (0.00014805793762207)
=== RUN   TestDecodeRune
--- PASS: TestDecodeRune (1.50203704833984e-05)
=== RUN   TestIsSurrogate
--- PASS: TestIsSurrogate (1.31130218505859e-05)
```
</p>
</details>
...
```
=== RUN   TestConstants
--- PASS: TestConstants (4.8160552978515625e-05)
=== RUN   TestEncode
--- PASS: TestEncode (0.000890970230102539062)
=== RUN   TestEncodeRune
--- PASS: TestEncodeRune (0.000191926956176757812)
=== RUN   TestDecode
--- PASS: TestDecode (0.000416040420532226562)
=== RUN   TestDecodeRune
--- PASS: TestDecodeRune (5.69820404052734375e-05)
=== RUN   TestIsSurrogate
