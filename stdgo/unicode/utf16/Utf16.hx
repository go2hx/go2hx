...
final _replacementChar : GoInt32 = (("\u{FFFD}".code : GoRune));
final _surr1 : GoInt64 = ((55296 : GoUnTypedInt));
final _maxRune : GoInt32 = (("\u{0010FFFF}".code : GoRune));
/**
        ...
        Go.cfor(_i < _s.length, _i++, {
            {
                ...
                if (_r < _surr1 || _surr3 <= _r) {
                    _a[_n] = ((_r : GoRune));
                } else if (_surr1 <= _r && _r < _surr2 && _i + ((1 : GoInt)) < _s.length && _surr2 <= _s[_i + ((1 : GoInt))] && _s[_i + ((1 : GoInt))] < _surr3) {
