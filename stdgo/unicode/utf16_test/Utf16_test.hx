...
private var _encodeTests:Slice<stdgo.unicode.utf16_test.Utf16_test.T_encodeTest> = (new Slice<stdgo.unicode.utf16_test.Utf16_test.T_encodeTest>(0, 0,
	...
	(new stdgo.unicode.utf16_test.Utf16_test.T_encodeTest((new Slice<GoInt32>(0, 0, ("a".code : GoInt32), ("b".code : GoInt32), (55295 : GoInt32),
		(55296 : GoInt32), (57343 : GoInt32), (57344 : GoInt32), (1114112 : GoInt32), (-1 : GoInt32)) : Slice<GoInt32>),
		(new Slice<GoUInt16>(0, 0, ("a".code : GoUInt16), ("b".code : GoUInt16), (55295 : GoUInt16), (65533 : GoUInt16), (65533 : GoUInt16),
...
private var _decodeTests:Slice<stdgo.unicode.utf16_test.Utf16_test.T_decodeTest> = (new Slice<stdgo.unicode.utf16_test.Utf16_test.T_decodeTest>(0, 0,
	...
	(new stdgo.unicode.utf16_test.Utf16_test.T_decodeTest((new Slice<GoUInt16>(0, 0, (55296 : GoUInt16), ("a".code : GoUInt16)) : Slice<GoUInt16>),
		(new Slice<GoInt32>(0, 0, (65533 : GoInt32), ("a".code : GoInt32)) : Slice<GoInt32>)) : stdgo.unicode.utf16_test.Utf16_test.T_decodeTest),
...
function testConstants(_t:Ref<stdgo.testing.Testing.T>):Void {
	...
	if (false) {
		_t.errorf((Go.str("utf16.replacementChar is wrong: %x should be %x") : GoString), Go.toInterface((65533 : GoInt32)),
			Go.toInterface((65533 : GoInt32)));
	};
}
		...
		for (_0 => _r in _tt._in) {
			...
			if ((_r < (65536:GoInt32)) || (_r > (1114111 : GoInt32))) {
				...
				if ((_r1 != (65533 : GoInt32)) || (_r2 != (65533 : GoInt32))) {
					_t.errorf((Go.str("EncodeRune(%#x) = %#x, %#x; want 0xfffd, 0xfffd") : GoString), Go.toInterface(_r), Go.toInterface(_r1),
						Go.toInterface(_r2));
				};
				_j++;
			} else {
				...
				if ((_r1 != (_tt._out[_j] : GoRune)) || (_r2 != (_tt._out[_j + (1 : GoInt)] : GoRune))) {
					_t.errorf((Go.str("EncodeRune(%#x) = %#x, %#x; want %#x, %#x") : GoString), Go.toInterface(_r), Go.toInterface(_r1), Go.toInterface(_r2),
						Go.toInterface(_tt._out[_j]), Go.toInterface(_tt._out[_j + (1 : GoInt)]));
				};
				_j = _j + ((2 : GoInt));
				var _dec:GoInt32 = decodeRune(_r1, _r2);
				if (_dec != _r) {
					_t.errorf((Go.str("DecodeRune(%#x, %#x) = %#x; want %#x") : GoString), Go.toInterface(_r1), Go.toInterface(_r2), Go.toInterface(_dec),
						Go.toInterface(_r));
				};
			};
		};
...
function testDecodeRune(_t:Ref<stdgo.testing.Testing.T>):Void {
	for (_i => _tt in _decodeRuneTests) {
		...
		if (_got != _tt._want) {
			_t.errorf((Go.str("%d: DecodeRune(%q, %q) = %v; want %v") : GoString), Go.toInterface(_i), Go.toInterface(_tt._r1), Go.toInterface(_tt._r2),
...
function testIsSurrogate(_t:Ref<stdgo.testing.Testing.T>):Void {
	for (_i => _tt in _surrogateTests) {
		...
		if (_got != _tt._want) {
			_t.errorf((Go.str("%d: IsSurrogate(%q) = %v; want %v") : GoString), Go.toInterface(_i), Go.toInterface(_tt._r), Go.toInterface(_got),
...
function benchmarkEncodeRune(_b:Ref<stdgo.testing.Testing.B>):Void {
	{
		var _i:GoInt = (0 : GoInt);
		Go.cfor(_i < _b.n, _i++, {
			for (_0 => _u in (new Slice<GoInt32>(0, 0, ("𝓐".code : GoInt32), ("𝓑".code : GoInt32), ("𝓒".code : GoInt32), ("𝓓".code : GoInt32),
				("𝓔".code : GoInt32)) : Slice<GoInt32>)) {
				encodeRune(_u);
			};
		});
