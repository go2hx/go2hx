...
({ _r : ((57343 : stdgo.GoInt32) : stdgo.GoRune), _want : true } : T__struct_1)) : stdgo.Slice<T__struct_1>);
/**
...
function testEncode(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testAppendRune(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        for (__0 => _tt in _encodeTests) {
...
function testEncodeRune(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        for (_i => _tt in _encodeTests) {
            ...
            for (__0 => _r in _tt._in) {
                ...
                if ((_r < (65536 : stdgo.GoInt32)) || (_r > (1114111 : stdgo.GoInt32))) {
                    ...
                    if ((_r1 != (65533 : stdgo.GoInt32)) || (_r2 != (65533 : stdgo.GoInt32))) {
                    ...
                    if ((_j + (1 : stdgo.GoInt)) >= (_tt._out.length)) {
                        _t.errorf(("#%d: ran out of tt.out" : stdgo.GoString), stdgo.Go.toInterface(_i));
                        break;
                    };
                    if ((_r1 != (_tt._out[(_j : stdgo.GoInt)] : stdgo.GoRune)) || (_r2 != (_tt._out[(_j + (1 : stdgo.GoInt) : stdgo.GoInt)] : stdgo.GoRune))) {
                    ...
                    _j = _j + ((2 : stdgo.GoInt));
                    var _dec:stdgo.GoInt32 = decodeRune(_r1, _r2);
                    if (_dec != (_r)) {
...
function testAllocationsDecode(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function testDecodeRune(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
        for (_i => _tt in _decodeRuneTests) {
            var _got:stdgo.GoInt32 = decodeRune(_tt._r1, _tt._r2);
            if (_got != (_tt._want)) {
...
function testIsSurrogate(_t:stdgo.Ref<stdgo.testing.Testing.T_>):Void {
...
function benchmarkDecodeValidASCII(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _data = (new stdgo.Slice<stdgo.GoUInt16>(
11,
11,
(104 : stdgo.GoUInt16),
(101 : stdgo.GoUInt16),
...
(114 : stdgo.GoUInt16),
(108 : stdgo.GoUInt16),
(100 : stdgo.GoUInt16)) : stdgo.Slice<stdgo.GoUInt16>);
        {
...
function benchmarkDecodeValidJapaneseChars(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _data = (new stdgo.Slice<stdgo.GoUInt16>(
9,
9,
(26085 : stdgo.GoUInt16),
(26412 : stdgo.GoUInt16),
(35486 : stdgo.GoUInt16),
(26085 : stdgo.GoUInt16),
(26412 : stdgo.GoUInt16),
(35486 : stdgo.GoUInt16),
(26085 : stdgo.GoUInt16),
(26412 : stdgo.GoUInt16),
(35486 : stdgo.GoUInt16)) : stdgo.Slice<stdgo.GoUInt16>);
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
                decode(_data);
...
function benchmarkDecodeRune(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _rs = new stdgo.Slice<stdgo.GoInt32>((10 : stdgo.GoInt).toBasic(), 0).__setNumber32__();
        for (_i => _u in (new stdgo.Slice<stdgo.GoInt32>(5, 5, (120016 : stdgo.GoInt32), (120017 : stdgo.GoInt32), (120018 : stdgo.GoInt32), (120019 : stdgo.GoInt32), (120020 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>)) {
            {
                var __tmp__ = encodeRune(_u);
                _rs[((2 : stdgo.GoInt) * _i : stdgo.GoInt)] = __tmp__._0;
                _rs[(((2 : stdgo.GoInt) * _i) + (1 : stdgo.GoInt) : stdgo.GoInt)] = __tmp__._1;
            };
        };
        _b.resetTimer();
        {
            ...
            stdgo.Go.cfor(_i < _b.n, _i++, {
                {
                    ...
                    stdgo.Go.cfor(_j < (5 : stdgo.GoInt), _j++, {
                        decodeRune(_rs[((2 : stdgo.GoInt) * _j : stdgo.GoInt)], _rs[(((2 : stdgo.GoInt) * _j) + (1 : stdgo.GoInt) : stdgo.GoInt)]);
                    });
                };
            });
        };
    }
function benchmarkEncodeValidASCII(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _data = (new stdgo.Slice<stdgo.GoInt32>(5, 5, (104 : stdgo.GoInt32), (101 : stdgo.GoInt32), (108 : stdgo.GoInt32), (108 : stdgo.GoInt32), (111 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>);
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
                encode(_data);
...
function benchmarkEncodeValidJapaneseChars(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _data = (new stdgo.Slice<stdgo.GoInt32>(3, 3, (26085 : stdgo.GoInt32), (26412 : stdgo.GoInt32), (35486 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>);
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
                encode(_data);
...
function benchmarkAppendRuneValidASCII(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _data = (new stdgo.Slice<stdgo.GoInt32>(5, 5, (104 : stdgo.GoInt32), (101 : stdgo.GoInt32), (108 : stdgo.GoInt32), (108 : stdgo.GoInt32), (111 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>);
        var _a = new stdgo.Slice<stdgo.GoUInt16>((0 : stdgo.GoInt).toBasic(), (_data.length) * (2 : stdgo.GoInt)).__setNumber32__();
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
                for (__8 => _u in _data) {
...
function benchmarkAppendRuneValidJapaneseChars(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        var _data = (new stdgo.Slice<stdgo.GoInt32>(3, 3, (26085 : stdgo.GoInt32), (26412 : stdgo.GoInt32), (35486 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>);
        var _a = new stdgo.Slice<stdgo.GoUInt16>((0 : stdgo.GoInt).toBasic(), (_data.length) * (2 : stdgo.GoInt)).__setNumber32__();
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
...
function benchmarkEncodeRune(_b:stdgo.Ref<stdgo.testing.Testing.B>):Void {
        {
            var _i:stdgo.GoInt = (0 : stdgo.GoInt);
            stdgo.Go.cfor(_i < _b.n, _i++, {
                for (__8 => _u in (new stdgo.Slice<stdgo.GoInt32>(5, 5, (120016 : stdgo.GoInt32), (120017 : stdgo.GoInt32), (120018 : stdgo.GoInt32), (120019 : stdgo.GoInt32), (120020 : stdgo.GoInt32)) : stdgo.Slice<stdgo.GoInt32>)) {
                    encodeRune(_u);
                };
            });
        };
