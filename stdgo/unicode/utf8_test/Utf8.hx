...
private var _tests:Slice<stdgo.testing.Testing.InternalTest> = (new Slice<stdgo.testing.Testing.InternalTest>(0, 0,
	...
	(new stdgo.testing.Testing.InternalTest(("TestAppendRune" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestDecodeSurrogateRune" : GoString),
		stdgo.unicode.utf8_test.Utf8_test.testDecodeSurrogateRune) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestSequencing" : GoString),
		stdgo.unicode.utf8_test.Utf8_test.testSequencing) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestRuntimeConversion" : GoString),
		stdgo.unicode.utf8_test.Utf8_test.testRuntimeConversion) : stdgo.testing.Testing.InternalTest),
	(new stdgo.testing.Testing.InternalTest(("TestDecodeInvalidSequence" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestRuneCount" : GoString),
	...
	(new stdgo.testing.Testing.InternalTest(("TestValidRune" : GoString),
...
private var _examples:Slice<stdgo.testing.Testing.InternalExample> = (new Slice<stdgo.testing.Testing.InternalExample>(0, 0,
	(new stdgo.testing.Testing.InternalExample(("ExampleDecodeLastRune" : GoString), stdgo.unicode.utf8_test.Utf8_test.exampleDecodeLastRune,
		("界 3\n世 3\n  1\n, 1\no 1\nl 1\nl 1\ne 1\nH 1\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleDecodeLastRuneInString" : GoString), stdgo.unicode.utf8_test.Utf8_test.exampleDecodeLastRuneInString,
		("界 3\n世 3\n  1\n, 1\no 1\nl 1\nl 1\ne 1\nH 1\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleDecodeRune" : GoString), stdgo.unicode.utf8_test.Utf8_test.exampleDecodeRune,
		("H 1\ne 1\nl 1\nl 1\no 1\n, 1\n  1\n世 3\n界 3\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleDecodeRuneInString" : GoString), stdgo.unicode.utf8_test.Utf8_test.exampleDecodeRuneInString,
		("H 1\ne 1\nl 1\nl 1\no 1\n, 1\n  1\n世 3\n界 3\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleEncodeRune" : GoString), stdgo.unicode.utf8_test.Utf8_test.exampleEncodeRune,
		("[228 184 150]\n3\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleEncodeRune_outOfRange" : GoString), stdgo.unicode.utf8_test.Utf8_test.exampleEncodeRune_outOfRange,
		("0: [239 191 189] � 3\n1: [239 191 189] � 3\n2: [239 191 189] � 3\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleFullRune" : GoString), stdgo.unicode.utf8_test.Utf8_test.exampleFullRune,
		("true\nfalse\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleFullRuneInString" : GoString), stdgo.unicode.utf8_test.Utf8_test.exampleFullRuneInString,
		("true\nfalse\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleRuneCount" : GoString), stdgo.unicode.utf8_test.Utf8_test.exampleRuneCount,
		("bytes = 13\nrunes = 9\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleRuneCountInString" : GoString), stdgo.unicode.utf8_test.Utf8_test.exampleRuneCountInString,
		("bytes = 13\nrunes = 9\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	...
	(new stdgo.testing.Testing.InternalExample(("ExampleRuneStart" : GoString), stdgo.unicode.utf8_test.Utf8_test.exampleRuneStart,
		("true\ntrue\nfalse\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleValid" : GoString), stdgo.unicode.utf8_test.Utf8_test.exampleValid, ("true\nfalse\n" : GoString),
		false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleValidRune" : GoString), stdgo.unicode.utf8_test.Utf8_test.exampleValidRune,
		("true\nfalse\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleValidString" : GoString), stdgo.unicode.utf8_test.Utf8_test.exampleValidString,
		("true\nfalse\n" : GoString), false) : stdgo.testing.Testing.InternalExample),
	(new stdgo.testing.Testing.InternalExample(("ExampleAppendRune" : GoString), stdgo.unicode.utf8_test.Utf8_test.exampleAppendRune,
