...
((194560 : GoInt32)),
((195101 : GoInt32))) : Slice<GoInt32>));
var _notletterTest : Slice<GoInt32> = ((new Slice<GoInt32>(
0,
0,
((32 : GoInt32)),
((53 : GoInt32)),
...
var _spaceTest : Slice<GoInt32> = ((new Slice<GoInt32>(
0,
0,
((9 : GoInt32)),
((10 : GoInt32)),
...
var _simpleFoldTests : Slice<GoString> = ((new Slice<GoString>(
0,
0,
((Go.str("Aa") : GoString)),
((Go.str("δΔ") : GoString)),
...
((Go.str("Ssſ") : GoString)),
((Go.str("ρϱΡ") : GoString)),
((Go.str("ͅΙιι") : GoString)),
((Go.str("İ") : GoString)),
((Go.str("ı") : GoString)),
((Go.str("\u13b0\uab80") : GoString))) : Slice<GoString>));
var _calibrate : Pointer<Bool> = stdgo.flag.Flag.bool(((Go.str("calibrate") : GoString)), false, ((Go.str("compute crossover for linear vs. binary search") : GoString)));
...
((new stdgo.unicode_test.Unicode_test.T(((160 : GoInt32)), ((Go.str("Z") : GoString))) : stdgo.unicode_test.Unicode_test.T))) : Slice<stdgo.unicode_test.Unicode_test.T>));
...
function testTo(_t:stdgo.testing.Testing.T):Void {
        for (_0 => _c in _caseTest) {
            ...
            if (_c._out != _r) {
                _t.errorf(((Go.str("To(U+%04X, %s) = U+%04X want U+%04X") : GoString)), Go.toInterface(_c._in), Go.toInterface(_caseString(_c._cas)), Go.toInterface(_r), Go.toInterface(_c._out));
            };
        };
    }
...
function testTurkishCase(_t:stdgo.testing.Testing.T):Void {
        ...
        for (_i => _l in _lower) {
            ...
            if (turkishCase.toLower(_l) != _l) {
                _t.errorf(((Go.str("lower(U+%04X) is U+%04X not U+%04X") : GoString)), Go.toInterface(_l), Go.toInterface(turkishCase.toLower(_l)), Go.toInterface(_l));
            };
            if (turkishCase.toUpper(_u) != _u) {
                _t.errorf(((Go.str("upper(U+%04X) is U+%04X not U+%04X") : GoString)), Go.toInterface(_u), Go.toInterface(turkishCase.toUpper(_u)), Go.toInterface(_u));
            };
            if (turkishCase.toUpper(_l) != _u) {
                _t.errorf(((Go.str("upper(U+%04X) is U+%04X not U+%04X") : GoString)), Go.toInterface(_l), Go.toInterface(turkishCase.toUpper(_l)), Go.toInterface(_u));
            };
            if (turkishCase.toLower(_u) != _l) {
                _t.errorf(((Go.str("lower(U+%04X) is U+%04X not U+%04X") : GoString)), Go.toInterface(_u), Go.toInterface(turkishCase.toLower(_l)), Go.toInterface(_l));
            };
            if (turkishCase.toTitle(_u) != _u) {
                _t.errorf(((Go.str("title(U+%04X) is U+%04X not U+%04X") : GoString)), Go.toInterface(_u), Go.toInterface(turkishCase.toTitle(_u)), Go.toInterface(_u));
            };
            if (turkishCase.toTitle(_l) != _u) {
                _t.errorf(((Go.str("title(U+%04X) is U+%04X not U+%04X") : GoString)), Go.toInterface(_l), Go.toInterface(turkishCase.toTitle(_l)), Go.toInterface(_u));
            };
        };
    }
...
function _fakeTable(_n:GoInt):Slice<Range16> {
        var _r16:Slice<Range16> = ((null : Slice<Range16>));
        {
            var _i:GoInt = ((0 : GoInt));
            Go.cfor(_i < _n, _i++, {
                _r16 = (_r16 != null ? _r16.__append__(((new Range16(((((_i * ((5 : GoInt))) + ((10 : GoInt))) : GoUInt16)), ((((_i * ((5 : GoInt))) + ((12 : GoInt))) : GoUInt16)), ((1 : GoUInt16))) : Range16))) : new Slice<Range16>(0, 0, ((new Range16(((((_i * ((5 : GoInt))) + ((10 : GoInt))) : GoUInt16)), ((((_i * ((5 : GoInt))) + ((12 : GoInt))) : GoUInt16)), ((1 : GoUInt16))) : Range16))));
            });
        };
        return _r16;
    }
...
function testLatinOffset(_t:stdgo.testing.Testing.T):Void {
        var _maps:Slice<GoMap<GoString, Ref<RangeTable>>> = ((new Slice<GoMap<GoString, Ref<RangeTable>>>(0, 0, categories, foldCategory, foldScript, properties, scripts) : Slice<GoMap<GoString, Ref<RangeTable>>>));
        for (_0 => _m in _maps) {
...
function testSpecialCaseNoMapping(_t:stdgo.testing.Testing.T):Void {
        ...
        var _got:GoString = stdgo.strings.Strings.toLowerSpecial(((((new Slice<CaseRange>(0, 0, (_noChangeForCapitalA == null ? null : _noChangeForCapitalA.__copy__())) : Slice<CaseRange>)) : SpecialCase)), ((Go.str("ABC") : GoString)));
...
function testNegativeRune(_t:stdgo.testing.Testing.T):Void {
        var _nonLatin1 = ((new Slice<GoUInt32>(0, 0, ((256 : GoUInt32)), ((257 : GoUInt32)), ((453 : GoUInt32)), ((768 : GoUInt32)), ((1632 : GoUInt32)), ((894 : GoUInt32)), ((706 : GoUInt32)), ((5760 : GoUInt32))) : Slice<GoUInt32>));
        {
            var _i:GoInt = ((0 : GoInt));
