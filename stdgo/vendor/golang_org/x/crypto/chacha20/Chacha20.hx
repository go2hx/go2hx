...
@:structInit class Cipher {
    ...
    public function _xorKeyStreamBlocksGeneric(_dst:Slice<GoByte>, _src:Slice<GoByte>):Void {
        ...
        var _c0:GoUInt32 = _j0, _c1:GoUInt32 = _j1, _c2:GoUInt32 = _j2, _c3:GoUInt32 = _j3, _c4:GoUInt32 = _s.value._key[((0 : GoInt))], _c5:GoUInt32 = _s.value._key[((1 : GoInt))], _c6:GoUInt32 = _s.value._key[((2 : GoInt))], _c7:GoUInt32 = _s.value._key[((3 : GoInt))], _c8:GoUInt32 = _s.value._key[((4 : GoInt))], _c9:GoUInt32 = _s.value._key[((5 : GoInt))], _c10:GoUInt32 = _s.value._key[((6 : GoInt))], _c11:GoUInt32 = _s.value._key[((7 : GoInt))], _:GoUInt32 = _s.value._counter, _c13:GoUInt32 = _s.value._nonce[((0 : GoInt))], _c14:GoUInt32 = _s.value._nonce[((1 : GoInt))], _c15:GoUInt32 = _s.value._nonce[((2 : GoInt))];
        ...
        while (_src.length >= ((64 : GoInt)) && _dst.length >= ((64 : GoInt))) {
            var __tmp__ = _quarterRound(_c0, _c4, _c8, _s.value._counter), _fcr0:GoUInt32 = __tmp__._0, _fcr4:GoUInt32 = __tmp__._1, _fcr8:GoUInt32 = __tmp__._2, _fcr12:GoUInt32 = __tmp__._3;
            var __tmp__ = _quarterRound(_fcr0, _s.value._p5, _s.value._p10, _s.value._p15), _x0:GoUInt32 = __tmp__._0, _x5:GoUInt32 = __tmp__._1, _x10:GoUInt32 = __tmp__._2, _x15:GoUInt32 = __tmp__._3;
            var __tmp__ = _quarterRound(_s.value._p1, _s.value._p6, _s.value._p11, _fcr12), _x1:GoUInt32 = __tmp__._0, _x6:GoUInt32 = __tmp__._1, _x11:GoUInt32 = __tmp__._2, _x12:GoUInt32 = __tmp__._3;
            var __tmp__ = _quarterRound(_s.value._p2, _s.value._p7, _fcr8, _s.value._p13), _x2:GoUInt32 = __tmp__._0, _x7:GoUInt32 = __tmp__._1, _x8:GoUInt32 = __tmp__._2, _x13:GoUInt32 = __tmp__._3;
            var __tmp__ = _quarterRound(_s.value._p3, _fcr4, _s.value._p9, _s.value._p14), _x3:GoUInt32 = __tmp__._0, _x4:GoUInt32 = __tmp__._1, _x9:GoUInt32 = __tmp__._2, _x14:GoUInt32 = __tmp__._3;
            {
    ...
    public function new(?_key:GoArray<GoUInt32>, ?_counter:GoUInt32, ?_nonce:GoArray<GoUInt32>, ?_buf:GoArray<GoUInt8>, ?_len:GoInt, ?_overflow:Bool, ?_precompDone:Bool, ?_p1:GoUInt32, ?_p5:GoUInt32, ?_p9:GoUInt32, ?_p13:GoUInt32, ?_p2:GoUInt32, ?_p6:GoUInt32, ?_p10:GoUInt32, ?_p14:GoUInt32, ?_p3:GoUInt32, ?_p7:GoUInt32, ?_p11:GoUInt32, ?_p15:GoUInt32) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_key) + " " + Go.string(_counter) + " " + Go.string(_nonce) + " " + Go.string(_buf) + " " + Go.string(_len) + " " + Go.string(_overflow) + " " + Go.string(_precompDone) + " " + Go.string(_p1) + " " + Go.string(_p5) + " " + Go.string(_p9) + " " + Go.string(_p13) + " " + Go.string(_p2) + " " + Go.string(_p6) + " " + Go.string(_p10) + " " + Go.string(_p14) + " " + Go.string(_p3) + " " + Go.string(_p7) + " " + Go.string(_p11) + " " + Go.string(_p15) + "}";
    }
...
final _unaligned : Bool = stdgo.runtime.Runtime.goarch == (("386" : GoString)) || stdgo.runtime.Runtime.goarch == (("amd64" : GoString)) || stdgo.runtime.Runtime.goarch == (("arm64" : GoString)) || stdgo.runtime.Runtime.goarch == (("ppc64le" : GoString)) || stdgo.runtime.Runtime.goarch == (("s390x" : GoString));
...
function _newUnauthenticatedCipher(_c:Pointer<Cipher>, _key:Slice<GoByte>, _nonce:Slice<GoByte>):{ var _0 : Pointer<Cipher>; var _1 : Error; } {
        ...
        _c.value._key = new GoArray<GoUInt32>(stdgo.encoding.binary.Binary.littleEndian.uint32(_key.__slice__(((0 : GoInt)), ((4 : GoInt)))), stdgo.encoding.binary.Binary.littleEndian.uint32(_key.__slice__(((4 : GoInt)), ((8 : GoInt)))), stdgo.encoding.binary.Binary.littleEndian.uint32(_key.__slice__(((8 : GoInt)), ((12 : GoInt)))), stdgo.encoding.binary.Binary.littleEndian.uint32(_key.__slice__(((12 : GoInt)), ((16 : GoInt)))), stdgo.encoding.binary.Binary.littleEndian.uint32(_key.__slice__(((16 : GoInt)), ((20 : GoInt)))), stdgo.encoding.binary.Binary.littleEndian.uint32(_key.__slice__(((20 : GoInt)), ((24 : GoInt)))), stdgo.encoding.binary.Binary.littleEndian.uint32(_key.__slice__(((24 : GoInt)), ((28 : GoInt)))), stdgo.encoding.binary.Binary.littleEndian.uint32(_key.__slice__(((28 : GoInt)), ((32 : GoInt))))).copy();
        _c.value._nonce = new GoArray<GoUInt32>(stdgo.encoding.binary.Binary.littleEndian.uint32(_nonce.__slice__(((0 : GoInt)), ((4 : GoInt)))), stdgo.encoding.binary.Binary.littleEndian.uint32(_nonce.__slice__(((4 : GoInt)), ((8 : GoInt)))), stdgo.encoding.binary.Binary.littleEndian.uint32(_nonce.__slice__(((8 : GoInt)), ((12 : GoInt))))).copy();
...
**/
function _quarterRound(_a:GoUInt32, _b:GoUInt32, _c:GoUInt32, _d:GoUInt32):{ var _0 : GoUInt32; var _1 : GoUInt32; var _2 : GoUInt32; var _3 : GoUInt32; } {
        _a = _a + (_b);
        _d = _d ^ (_a);
...
function _hChaCha20(_out:Slice<GoByte>, _key:Slice<GoByte>, _nonce:Slice<GoByte>):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        ...
        var _x0:GoUInt32 = _j0, _x1:GoUInt32 = _j1, _x2:GoUInt32 = _j2, _x3:GoUInt32 = _j3;
...
class Cipher_extension_fields {
    public function setCounter(__tmp__, _counter:GoUInt32):Void __tmp__.setCounter(_counter);
    public function xorkeyStream(__tmp__, _dst:Slice<GoByte>, _src:Slice<GoByte>):Void __tmp__.xorkeyStream(_dst, _src);
    public function _xorKeyStreamBlocksGeneric(__tmp__, _dst:Slice<GoByte>, _src:Slice<GoByte>):Void __tmp__._xorKeyStreamBlocksGeneric(_dst, _src);
    public function _xorKeyStreamBlocks(__tmp__, _dst:Slice<GoByte>, _src:Slice<GoByte>):Void __tmp__._xorKeyStreamBlocks(_dst, _src);
}
