...
@:structInit class T_chacha20poly1305 {
	public function _open(_dst:Slice<GoByte>, _nonce:Slice<GoByte>, _ciphertext:Slice<GoByte>,
	...
	public function _openGeneric(_dst:Slice<GoByte>, _nonce:Slice<GoByte>, _ciphertext:Slice<GoByte>,
			_additionalData:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:Error;} {
		var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		...
		var __tmp__ = golang_org.x.crypto.chacha20.Chacha20.newUnauthenticatedCipher(_c.value._key.__slice__(0), _nonce),
			_s:Pointer<vendor.golang_org.x.crypto.chacha20.Chacha20.Cipher> = __tmp__._0,
	...
	public function _sealGeneric(_dst:Slice<GoByte>, _nonce:Slice<GoByte>, _plaintext:Slice<GoByte>, _additionalData:Slice<GoByte>):Slice<GoByte> {
		var _c = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _sliceForAppend(_dst, _plaintext.length + golang_org.x.crypto.poly1305.Poly1305.tagSize),
			_ret:Slice<GoUInt8> = __tmp__._0,
			_out:Slice<GoUInt8> = __tmp__._1;
		var _ciphertext:Slice<GoUInt8> = _out.__slice__(0, _plaintext.length),
			_tag:Slice<GoUInt8> = _out.__slice__(_plaintext.length);
	...
	public function new(?_key:GoArray<GoUInt8>)
...
@:structInit class T_xchacha20poly1305 {
	public function open(_dst:Slice<GoByte>, _nonce:Slice<GoByte>, _ciphertext:Slice<GoByte>,
		...
		var __tmp__ = golang_org.x.crypto.chacha20.Chacha20.hchaCha20(_x.value._key.__slice__(0), _nonce.__slice__(((0 : GoInt)), ((16 : GoInt)))),
			_hKey:Slice<GoUInt8> = __tmp__._0,
			_:stdgo.Error = __tmp__._1;
...
class T_chacha20poly1305_extension_fields {
	...
	public function seal(__tmp__, _dst:Slice<GoByte>, _nonce:Slice<GoByte>, _plaintext:Slice<GoByte>, _additionalData:Slice<GoByte>):Slice<GoByte>
		return __tmp__.seal(_dst, _nonce, _plaintext, _additionalData);

	public function open(__tmp__, _dst:Slice<GoByte>, _nonce:Slice<GoByte>, _ciphertext:Slice<GoByte>,
			_additionalData:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__.open(_dst, _nonce, _ciphertext, _additionalData);

	public function _sealGeneric(__tmp__, _dst:Slice<GoByte>, _nonce:Slice<GoByte>, _plaintext:Slice<GoByte>, _additionalData:Slice<GoByte>):Slice<GoByte>
		return __tmp__._sealGeneric(_dst, _nonce, _plaintext, _additionalData);

	public function _openGeneric(__tmp__, _dst:Slice<GoByte>, _nonce:Slice<GoByte>, _ciphertext:Slice<GoByte>,
			_additionalData:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__._openGeneric(_dst, _nonce, _ciphertext, _additionalData);

	public function _seal(__tmp__, _dst:Slice<GoByte>, _nonce:Slice<GoByte>, _plaintext:Slice<GoByte>, _additionalData:Slice<GoByte>):Slice<GoByte>
		return __tmp__._seal(_dst, _nonce, _plaintext, _additionalData);

	public function _open(__tmp__, _dst:Slice<GoByte>, _nonce:Slice<GoByte>, _ciphertext:Slice<GoByte>,
			_additionalData:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__._open(_dst, _nonce, _ciphertext, _additionalData);
}
