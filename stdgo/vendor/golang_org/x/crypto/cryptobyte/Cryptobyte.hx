...
@:structInit class Builder {
	...
	public function _flushChild():Void {
		...
		if (_child.value._pendingIsASN1) {
			...
			var _lenLen:GoUInt8 = ((0 : GoUInt8)),
				_lenByte:GoUInt8 = ((0 : GoUInt8));
		...
		if (_l != ((0 : GoInt))) {
			_b.value._err = stdgo.fmt.Fmt.errorf("cryptobyte: pending child length %d exceeds %d-byte length prefix", Go.toInterface(_length),
				Go.toInterface(_child.value._pendingLenLen));
			return;
		};
	...
	public function _addLengthPrefixed(_lenLen:GoInt, _isASN1:Bool, _f:BuilderContinuation):Void {
		...
		_b.value._child = Go.pointer((({
			_result: _b.value._result,
			_fixedSize: _b.value._fixedSize,
			_offset: _offset,
			_pendingLenLen: _lenLen,
			_pendingIsASN1: _isASN1,
			_inContinuation: _b.value._inContinuation,
			_err: ((null : stdgo.Error)),
			_child: new Pointer<Builder>().nil()
		} : Builder)));
	...
	public function addUint32(_v:GoUInt32):Void {
		var _b = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		_b.value._add((((_v >> ((24 : GoUnTypedInt))) : GoByte)), (((_v >> ((16 : GoUnTypedInt))) : GoByte)), (((_v >> ((8 : GoUnTypedInt))) : GoByte)),
			((_v : GoByte)));
	}
	...
	public function marshalASN1(_v:AnyInterface):Void {
		...
		var __tmp__ = stdgo.encoding.asn1.Asn1.marshal(Go.toInterface(_v)),
			_bytes:Slice<GoUInt8> = __tmp__._0,
	...
	public function new(?_err:stdgo.Error, ?_result:Slice<GoUInt8>, ?_fixedSize:Bool, ?_child:Pointer<Builder>, ?_offset:GoInt, ?_pendingLenLen:GoInt,
			?_pendingIsASN1:Bool, ?_inContinuation:Pointer<Bool>)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_err) + " " + Go.string(_result) + " " + Go.string(_fixedSize) + " " + Go.string(_child) + " " + Go.string(_offset) + " "
			+ Go.string(_pendingLenLen) + " " + Go.string(_pendingIsASN1) + " " + Go.string(_inContinuation) + "}";
	}
...
@:named class BuilderContinuation {
	...
	public function __copy__()
		return new BuilderContinuation(__t__);
}
...
@:named class String_ {
	...
	public function _readASN1(_out:Pointer<String_>, _outTag:Pointer<golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag>, _skipHeader:Bool):Bool {
		...
		var _tag:GoUInt8 = (_s.value).__t__[((0 : GoInt))],
			_lenByte:GoUInt8 = (_s.value).__t__[((1 : GoInt))];
		...
		var _length:GoUInt32 = ((0 : GoUInt32)),
			_headerLen:GoUInt32 = ((0 : GoUInt32));
		if (_lenByte & ((128 : GoUInt8)) == ((0 : GoUInt8))) {
			...
			if (_lenLen == ((0 : GoUInt8))
				|| _lenLen > ((4 : GoUInt8))
				|| _s.value.__t__.length < (((((2 : GoUInt8)) + _lenLen) : GoInt))) {
				return false;
			};
		...
		if (((_length : GoInt)) < ((0 : GoInt))
			|| !_s.value.readBytes(new Pointer<Slice<GoUInt8>>(() -> _out.value.__t__, v -> (_out.value = new String_(v)).__t__), ((_length : GoInt)))) {
			return false;
		};
	...
	public function readOptionalASN1OctetString(_out:Pointer<Slice<GoByte>>, _outPresent:Pointer<Bool>,
			_tag:golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag):Bool {
		var _s = new Pointer(() -> new String_(this.__t__), __tmp__ -> new String_(this.__t__ = __tmp__.__t__));
		var _present:Bool = false;
		var _child:String_ = new String_();
	...
	public function readOptionalASN1Integer(_out:AnyInterface, _tag:golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag, _defaultValue:AnyInterface):Bool {
		...
		if (!_present) {
			if (stdgo.reflect.Reflect.valueOf(Go.toInterface(_out))
				.elem()
				.kind()
				.__t__ == stdgo.reflect.Reflect.int.__t__ || stdgo.reflect.Reflect.valueOf(Go.toInterface(_out))
				.elem()
				.kind()
				.__t__ == stdgo.reflect.Reflect.int8.__t__ || stdgo.reflect.Reflect.valueOf(Go.toInterface(_out))
				.elem()
				.kind()
				.__t__ == stdgo.reflect.Reflect.int16.__t__ || stdgo.reflect.Reflect.valueOf(Go.toInterface(_out))
				.elem()
				.kind()
				.__t__ == stdgo.reflect.Reflect.int32.__t__ || stdgo.reflect.Reflect.valueOf(Go.toInterface(_out))
				.elem()
				.kind()
				.__t__ == stdgo.reflect.Reflect.int64.__t__ || stdgo.reflect.Reflect.valueOf(Go.toInterface(_out))
				.elem()
				.kind()
				.__t__ == stdgo.reflect.Reflect.uint.__t__ || stdgo.reflect.Reflect.valueOf(Go.toInterface(_out))
				.elem()
				.kind()
				.__t__ == stdgo.reflect.Reflect.uint8.__t__ || stdgo.reflect.Reflect.valueOf(Go.toInterface(_out))
				.elem()
				.kind()
				.__t__ == stdgo.reflect.Reflect.uint16.__t__ || stdgo.reflect.Reflect.valueOf(Go.toInterface(_out))
				.elem()
				.kind()
				.__t__ == stdgo.reflect.Reflect.uint32.__t__ || stdgo.reflect.Reflect.valueOf(Go.toInterface(_out))
				.elem()
				.kind()
				.__t__ == stdgo.reflect.Reflect.uint64.__t__) {
			...
			} else if (stdgo.reflect.Reflect.valueOf(Go.toInterface(_out))
				.elem()
				.kind()
				.__t__ == stdgo.reflect.Reflect.struct.__t__) {
				if (!(stdgo.reflect.Reflect.typeOf(Go.toInterface(_out)).elem().toString() == _bigIntType.toString())) {
					throw "invalid integer type";
				};
				if (stdgo.reflect.Reflect.typeOf(Go.toInterface(_defaultValue)).kind().__t__ != stdgo.reflect.Reflect.ptr.__t__
					|| !(stdgo.reflect.Reflect.typeOf(Go.toInterface(_defaultValue)).elem().toString() == _bigIntType.toString())) {
	...
	public function readASN1BitStringAsBytes(_out:Pointer<Slice<GoByte>>):Bool {
		...
		if (!_s.value.readASN1(Go.pointer(_bytes), golang_org.x.crypto.cryptobyte.asn1.Asn1.bit_STRING)
			|| _bytes.__t__.length == ((0 : GoInt))) {
			return false;
		};
	...
	public function readASN1BitString(_out:Pointer<stdgo.encoding.asn1.Asn1.BitString>):Bool {
		...
		if (!_s.value.readASN1(Go.pointer(_bytes), golang_org.x.crypto.cryptobyte.asn1.Asn1.bit_STRING)
			|| _bytes.__t__.length == ((0 : GoInt))
			|| _bytes.__t__.length * ((8 : GoInt)) / ((8 : GoInt)) != _bytes.__t__.length) {
			return false;
		};
		var _paddingBits:GoUInt8 = ((_bytes.__t__[((0 : GoInt))] : GoUInt8));
		_bytes = _bytes.__slice__(((1 : GoInt))).__copy__();
		if (_paddingBits > ((7 : GoUInt8))
			|| _bytes.__t__.length == ((0 : GoInt))
			&& _paddingBits != ((0 : GoUInt8))
			|| _bytes.__t__.length > ((0 : GoInt))
			&& _bytes.__t__[_bytes.__t__.length - ((1 : GoInt))] & ((((1 : GoUInt8)) << _paddingBits) - ((1 : GoUInt8))) != ((0 : GoUInt8))) {
			return false;
		};
	...
	public function readASN1UTCTime(_out:Pointer<stdgo.time.Time.Time>):Bool {
		...
		var __tmp__ = stdgo.time.Time.parse(_formatStr, _t),
			_res:stdgo.time.Time.Time = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
	...
	public function readASN1GeneralizedTime(_out:Pointer<stdgo.time.Time.Time>):Bool {
		...
		var _t:GoString = _bytes.__t__;
		var __tmp__ = stdgo.time.Time.parse(_generalizedTimeFormatStr, _t),
			_res:stdgo.time.Time.Time = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return false;
	...
	public function readASN1ObjectIdentifier(_out:Pointer<stdgo.encoding.asn1.Asn1.ObjectIdentifier>):Bool {
		var _s = new Pointer(() -> new String_(this.__t__), __tmp__ -> new String_(this.__t__ = __tmp__.__t__));
		var _bytes:String_ = new String_();
		if (!_s.value.readASN1(Go.pointer(_bytes), golang_org.x.crypto.cryptobyte.asn1.Asn1.object_IDENTIFIER)
			|| _bytes.__t__.length == ((0 : GoInt))) {
			return false;
		};
		var _components:Slice<GoInt> = new Slice<GoInt>(...[
			for (i in 0...((_bytes.__t__.length + ((1 : GoInt)):GoInt)).toBasic()) ((0 : GoInt))
		]);
	...
	public function readASN1Enum(_out:Pointer<GoInt>):Bool {
		...
		if (!_s.value.readASN1(Go.pointer(_bytes), golang_org.x.crypto.cryptobyte.asn1.Asn1.enum_)
			|| !_checkASN1Integer(_bytes.__copy__().__t__)
			|| !_asn1Signed(Go.pointer(_i), _bytes.__copy__().__t__)) {
			return false;
		};
	...
	public function readASN1Int64WithTag(_out:Pointer<GoInt64>, _tag:golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag):Bool {
		var _s = new Pointer(() -> new String_(this.__t__), __tmp__ -> new String_(this.__t__ = __tmp__.__t__));
		var _bytes:String_ = new String_();
		return _s.value.readASN1(Go.pointer(_bytes), _tag)
			&& _checkASN1Integer(_bytes.__copy__().__t__)
			&& _asn1Signed(_out, _bytes.__copy__().__t__);
	}

	public function _readASN1Uint64(_out:Pointer<GoUInt64>):Bool {
		var _s = new Pointer(() -> new String_(this.__t__), __tmp__ -> new String_(this.__t__ = __tmp__.__t__));
		var _bytes:String_ = new String_();
		if (!_s.value.readASN1(Go.pointer(_bytes), golang_org.x.crypto.cryptobyte.asn1.Asn1.integer)
			|| !_checkASN1Integer(_bytes.__copy__().__t__)
			|| !_asn1Unsigned(_out, _bytes.__copy__().__t__)) {
			return false;
		};
		return true;
	}
	...
	public function readASN1Boolean(_out:Pointer<Bool>):Bool {
		var _s = new Pointer(() -> new String_(this.__t__), __tmp__ -> new String_(this.__t__ = __tmp__.__t__));
		var _bytes:String_ = new String_();
		if (!_s.value.readASN1(Go.pointer(_bytes), golang_org.x.crypto.cryptobyte.asn1.Asn1.boolean)
			|| _bytes.__t__.length != ((1 : GoInt))) {
			return false;
		};
	...
	public function __copy__()
		return new String_(__t__);

	public function __append__(args:haxe.Rest<GoUInt8>)
		return new String_(this.__t__.__append__(...args));

	public function __slice__(low:GoInt, high:GoInt = -1)
		return new String_(this.__t__.__slice__(low, high));
}
...
var _bigIntType:stdgo.reflect.Reflect.Type = stdgo.reflect.Reflect.typeOf(Go.toInterface(((new Pointer<stdgo.math.big.Big.Int_>()
	.nil() : Pointer<stdgo.math.big.Big.Int_>))))
	.elem();
...
function _isValidOID(_oid:stdgo.encoding.asn1.Asn1.ObjectIdentifier):Bool {
	...
	if (_oid.__t__[((0 : GoInt))] > ((2 : GoInt))
		|| (_oid.__t__[((0 : GoInt))] <= ((1 : GoInt)) && _oid.__t__[((1 : GoInt))] >= ((40 : GoInt)))) {
		return false;
	};
...
function _checkASN1Integer(_bytes:Slice<GoByte>):Bool {
	...
	if (_bytes[((0 : GoInt))] == ((0 : GoUInt8))
		&& _bytes[((1 : GoInt))] & ((128 : GoUInt8)) == ((0 : GoUInt8))
			|| _bytes[((0 : GoInt))] == ((255 : GoUInt8))
			&& _bytes[((1 : GoInt))] & ((128 : GoUInt8)) == ((128 : GoUInt8))) {
		return false;
	};
	return true;
}
...
function newBuilder(_buffer:Slice<GoByte>):Pointer<Builder> {
	return Go.pointer((({
		...
		_offset: 0,
		_pendingLenLen: 0,
		_pendingIsASN1: false,
		_inContinuation: new Pointer<Bool>().nil()
	} : Builder)));
}
...
class Builder_extension_fields {
	public function addASN1Int64(__tmp__, _v:GoInt64):Void
		__tmp__.addASN1Int64(_v);

	public function addASN1Int64WithTag(__tmp__, _v:GoInt64, _tag:golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag):Void
		__tmp__.addASN1Int64WithTag(_v, _tag);

	public function addASN1Enum(__tmp__, _v:GoInt64):Void
		__tmp__.addASN1Enum(_v);

	public function _addASN1Signed(__tmp__, _tag:golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag, _v:GoInt64):Void
		__tmp__._addASN1Signed(_tag, _v);

	public function addASN1Uint64(__tmp__, _v:GoUInt64):Void
		__tmp__.addASN1Uint64(_v);

	public function addASN1BigInt(__tmp__, _n:Pointer<stdgo.math.big.Big.Int_>):Void
		__tmp__.addASN1BigInt(_n);

	public function addASN1OctetString(__tmp__, _bytes:Slice<GoByte>):Void
		__tmp__.addASN1OctetString(_bytes);

	public function addASN1GeneralizedTime(__tmp__, _t:stdgo.time.Time.Time):Void
		__tmp__.addASN1GeneralizedTime(_t);

	public function addASN1UTCTime(__tmp__, _t:stdgo.time.Time.Time):Void
		__tmp__.addASN1UTCTime(_t);

	public function addASN1BitString(__tmp__, _data:Slice<GoByte>):Void
		__tmp__.addASN1BitString(_data);

	public function _addBase128Int(__tmp__, _n:GoInt64):Void
		__tmp__._addBase128Int(_n);

	public function addASN1ObjectIdentifier(__tmp__, _oid:stdgo.encoding.asn1.Asn1.ObjectIdentifier):Void
		__tmp__.addASN1ObjectIdentifier(_oid);

	public function addASN1Boolean(__tmp__, _v:Bool):Void
		__tmp__.addASN1Boolean(_v);

	public function addASN1NULL(__tmp__):Void
		__tmp__.addASN1NULL();

	public function marshalASN1(__tmp__, _v:AnyInterface):Void
		__tmp__.marshalASN1(_v);

	public function addASN1(__tmp__, _tag:golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag, _f:BuilderContinuation):Void
		__tmp__.addASN1(_tag, _f);

	public function setError(__tmp__, _err:Error):Void
		__tmp__.setError(_err);

	public function bytes(__tmp__):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__.bytes();

	public function bytesOrPanic(__tmp__):Slice<GoByte>
		return __tmp__.bytesOrPanic();

	public function addUint8(__tmp__, _v:GoUInt8):Void
		__tmp__.addUint8(_v);

	public function addUint16(__tmp__, _v:GoUInt16):Void
		__tmp__.addUint16(_v);

	public function addUint24(__tmp__, _v:GoUInt32):Void
		__tmp__.addUint24(_v);

	public function addUint32(__tmp__, _v:GoUInt32):Void
		__tmp__.addUint32(_v);

	public function addBytes(__tmp__, _v:Slice<GoByte>):Void
		__tmp__.addBytes(_v);

	public function addUint8LengthPrefixed(__tmp__, _f:BuilderContinuation):Void
		__tmp__.addUint8LengthPrefixed(_f);

	public function addUint16LengthPrefixed(__tmp__, _f:BuilderContinuation):Void
		__tmp__.addUint16LengthPrefixed(_f);

	public function addUint24LengthPrefixed(__tmp__, _f:BuilderContinuation):Void
		__tmp__.addUint24LengthPrefixed(_f);

	public function addUint32LengthPrefixed(__tmp__, _f:BuilderContinuation):Void
		__tmp__.addUint32LengthPrefixed(_f);

	public function _callContinuation(__tmp__, _f:BuilderContinuation, _arg:Pointer<Builder>):Void
		__tmp__._callContinuation(_f, _arg);

	public function _addLengthPrefixed(__tmp__, _lenLen:GoInt, _isASN1:Bool, _f:BuilderContinuation):Void
		__tmp__._addLengthPrefixed(_lenLen, _isASN1, _f);

	public function _flushChild(__tmp__):Void
		__tmp__._flushChild();

	public function _add(__tmp__, _bytes:haxe.Rest<GoByte>):Void
		__tmp__._add(_bytes);

	public function unwrite(__tmp__, _n:GoInt):Void
		__tmp__.unwrite(_n);

	public function addValue(__tmp__, _v:MarshalingValue):Void
		__tmp__.addValue(_v);
}

class String__extension_fields {
	public function readASN1Boolean(__tmp__, _out:Pointer<Bool>):Bool
		return __tmp__.readASN1Boolean(_out);

	public function readASN1Integer(__tmp__, _out:AnyInterface):Bool
		return __tmp__.readASN1Integer(_out);

	public function _readASN1BigInt(__tmp__, _out:Pointer<stdgo.math.big.Big.Int_>):Bool
		return __tmp__._readASN1BigInt(_out);

	public function _readASN1Int64(__tmp__, _out:Pointer<GoInt64>):Bool
		return __tmp__._readASN1Int64(_out);

	public function _readASN1Uint64(__tmp__, _out:Pointer<GoUInt64>):Bool
		return __tmp__._readASN1Uint64(_out);

	public function readASN1Int64WithTag(__tmp__, _out:Pointer<GoInt64>, _tag:golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag):Bool
		return __tmp__.readASN1Int64WithTag(_out, _tag);

	public function readASN1Enum(__tmp__, _out:Pointer<GoInt>):Bool
		return __tmp__.readASN1Enum(_out);

	public function _readBase128Int(__tmp__, _out:Pointer<GoInt>):Bool
		return __tmp__._readBase128Int(_out);

	public function readASN1ObjectIdentifier(__tmp__, _out:Pointer<stdgo.encoding.asn1.Asn1.ObjectIdentifier>):Bool
		return __tmp__.readASN1ObjectIdentifier(_out);

	public function readASN1GeneralizedTime(__tmp__, _out:Pointer<stdgo.time.Time.Time>):Bool
		return __tmp__.readASN1GeneralizedTime(_out);

	public function readASN1UTCTime(__tmp__, _out:Pointer<stdgo.time.Time.Time>):Bool
		return __tmp__.readASN1UTCTime(_out);

	public function readASN1BitString(__tmp__, _out:Pointer<stdgo.encoding.asn1.Asn1.BitString>):Bool
		return __tmp__.readASN1BitString(_out);

	public function readASN1BitStringAsBytes(__tmp__, _out:Pointer<Slice<GoByte>>):Bool
		return __tmp__.readASN1BitStringAsBytes(_out);

	public function readASN1Bytes(__tmp__, _out:Pointer<Slice<GoByte>>, _tag:golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag):Bool
		return __tmp__.readASN1Bytes(_out, _tag);

	public function readASN1(__tmp__, _out:Pointer<String_>, _tag:golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag):Bool
		return __tmp__.readASN1(_out, _tag);

	public function readASN1Element(__tmp__, _out:Pointer<String_>, _tag:golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag):Bool
		return __tmp__.readASN1Element(_out, _tag);

	public function readAnyASN1(__tmp__, _out:Pointer<String_>, _outTag:Pointer<golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag>):Bool
		return __tmp__.readAnyASN1(_out, _outTag);

	public function readAnyASN1Element(__tmp__, _out:Pointer<String_>, _outTag:Pointer<golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag>):Bool
		return __tmp__.readAnyASN1Element(_out, _outTag);

	public function peekASN1Tag(__tmp__, _tag:golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag):Bool
		return __tmp__.peekASN1Tag(_tag);

	public function skipASN1(__tmp__, _tag:golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag):Bool
		return __tmp__.skipASN1(_tag);

	public function readOptionalASN1(__tmp__, _out:Pointer<String_>, _outPresent:Pointer<Bool>, _tag:golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag):Bool
		return __tmp__.readOptionalASN1(_out, _outPresent, _tag);

	public function skipOptionalASN1(__tmp__, _tag:golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag):Bool
		return __tmp__.skipOptionalASN1(_tag);

	public function readOptionalASN1Integer(__tmp__, _out:AnyInterface, _tag:golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag, _defaultValue:AnyInterface):Bool
		return __tmp__.readOptionalASN1Integer(_out, _tag, _defaultValue);

	public function readOptionalASN1OctetString(__tmp__, _out:Pointer<Slice<GoByte>>, _outPresent:Pointer<Bool>,
			_tag:golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag):Bool
		return __tmp__.readOptionalASN1OctetString(_out, _outPresent, _tag);

	public function readOptionalASN1Boolean(__tmp__, _out:Pointer<Bool>, _defaultValue:Bool):Bool
		return __tmp__.readOptionalASN1Boolean(_out, _defaultValue);

	public function _readASN1(__tmp__, _out:Pointer<String_>, _outTag:Pointer<golang_org.x.crypto.cryptobyte.asn1.Asn1.Tag>, _skipHeader:Bool):Bool
		return __tmp__._readASN1(_out, _outTag, _skipHeader);

	public function _read(__tmp__, _n:GoInt):Slice<GoByte>
		return __tmp__._read(_n);

	public function skip(__tmp__, _n:GoInt):Bool
		return __tmp__.skip(_n);

	public function readUint8(__tmp__, _out:Pointer<GoUInt8>):Bool
		return __tmp__.readUint8(_out);

	public function readUint16(__tmp__, _out:Pointer<GoUInt16>):Bool
		return __tmp__.readUint16(_out);

	public function readUint24(__tmp__, _out:Pointer<GoUInt32>):Bool
		return __tmp__.readUint24(_out);

	public function readUint32(__tmp__, _out:Pointer<GoUInt32>):Bool
		return __tmp__.readUint32(_out);

	public function _readUnsigned(__tmp__, _out:Pointer<GoUInt32>, _length:GoInt):Bool
		return __tmp__._readUnsigned(_out, _length);

	public function _readLengthPrefixed(__tmp__, _lenLen:GoInt, _outChild:Pointer<String_>):Bool
		return __tmp__._readLengthPrefixed(_lenLen, _outChild);

	public function readUint8LengthPrefixed(__tmp__, _out:Pointer<String_>):Bool
		return __tmp__.readUint8LengthPrefixed(_out);

	public function readUint16LengthPrefixed(__tmp__, _out:Pointer<String_>):Bool
		return __tmp__.readUint16LengthPrefixed(_out);

	public function readUint24LengthPrefixed(__tmp__, _out:Pointer<String_>):Bool
		return __tmp__.readUint24LengthPrefixed(_out);

	public function readBytes(__tmp__, _out:Pointer<Slice<GoByte>>, _n:GoInt):Bool
		return __tmp__.readBytes(_out, _n);

	public function copyBytes(__tmp__, _out:Slice<GoByte>):Bool
		return __tmp__.copyBytes(_out);
