...
class Tag_extension_fields {
	public function constructed(__tmp__):Tag
		return __tmp__.constructed();

	public function contextSpecific(__tmp__):Tag
		return __tmp__.contextSpecific();
}
