...
@:named class T_fieldElement {
    ...
    public function __copy__() return new T_fieldElement(__t__.copy());
...
var _basePoint : GoArray<GoUInt8> = new GoArray<GoUInt8>(
((9 : GoUInt8)),
((0 : GoUInt8)),
((0 : GoUInt8)),
((0 : GoUInt8)),
...
function _checkBasepoint():Void {
        if (stdgo.crypto.subtle.Subtle.constantTimeCompare(basepoint, new Slice<GoUInt8>(
((9 : GoUInt8)),
((0 : GoUInt8)),
((0 : GoUInt8)),
((0 : GoUInt8)),
...
function _x25519(_dst:Pointer<GoArray<GoByte>>, _scalar:Slice<GoByte>, _point:Slice<GoByte>):{ var _0 : Slice<GoByte>; var _1 : Error; } {
        var _in:GoArray<GoByte> = new GoArray<GoUInt8>(...[for (i in 0 ... 32) ((0 : GoUInt8))]);
        {
            ...
            if (_l != ((32 : GoInt))) {
                return { _0 : new Slice<GoUInt8>().nil(), _1 : stdgo.fmt.Fmt.errorf("bad scalar length: %d, expected %d", Go.toInterface(_l), Go.toInterface(((32 : GoInt)))) };
            };
        };
        {
            var _l:GoInt = _point.length;
            if (_l != ((32 : GoInt))) {
                return { _0 : new Slice<GoUInt8>().nil(), _1 : stdgo.fmt.Fmt.errorf("bad point length: %d, expected %d", Go.toInterface(_l), Go.toInterface(((32 : GoInt)))) };
            };
        };
        ...
        if (Go.pointer(_point[((0 : GoInt))]) == Go.pointer(basepoint[((0 : GoInt))])) {
            ...
            var _base:GoArray<GoByte> = new GoArray<GoUInt8>(...[for (i in 0 ... 32) ((0 : GoUInt8))]), _zero:GoArray<GoByte> = new GoArray<GoUInt8>(...[for (i in 0 ... 32) ((0 : GoUInt8))]);
...
function _feInvert(_out:Pointer<T_fieldElement>, _z:Pointer<T_fieldElement>):Void {
        var _t0:T_fieldElement = new T_fieldElement(), _t1:T_fieldElement = new T_fieldElement(), _t2:T_fieldElement = new T_fieldElement(), _t3:T_fieldElement = new T_fieldElement();
...
function _scalarMultGeneric(_out:Pointer<GoArray<GoByte>>, _in:Pointer<GoArray<GoByte>>, _base:Pointer<GoArray<GoByte>>):Void {
        ...
        var _x1:T_fieldElement = new T_fieldElement(), _x2:T_fieldElement = new T_fieldElement(), _z2:T_fieldElement = new T_fieldElement(), _x3:T_fieldElement = new T_fieldElement(), _z3:T_fieldElement = new T_fieldElement(), _tmp0:T_fieldElement = new T_fieldElement(), _tmp1:T_fieldElement = new T_fieldElement();
