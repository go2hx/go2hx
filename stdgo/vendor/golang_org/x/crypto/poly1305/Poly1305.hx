...
@:structInit class T_mac {
	...
	public function new(?_macGeneric:T_macGeneric)
	...
	public function sum(_out:Pointer<GoArray<GoUInt8>>)
		_macGeneric.sum(_0);

	public function write(_p:Slice<GoUInt8>):{var _0:Slice<GoUInt8> -> {
		var _0:GoInt;
		var _1:stdgo.Error;
...
@:structInit class MAC {
	...
	public function new(?_mac:T_mac, ?_finalized:Bool)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_macState {
	...
	public function new(?_h:GoArray<GoUInt64>, ?_r:GoArray<GoUInt64>, ?_s:GoArray<GoUInt64>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_macGeneric {
	...
	public function new(?_macState:T_macState, ?_buffer:GoArray<GoUInt8>, ?_offset:GoInt)
		stdgo.internal.Macro.initLocals();
...
function _add128(_a:T_uint128, _b:T_uint128):T_uint128 {
	var __tmp__ = _bitsAdd64(_a._lo, _b._lo, ((0 : GoUInt64))),
		_lo:GoUInt64 = __tmp__._0,
		_c:GoUInt64 = __tmp__._1;
	var __tmp__ = _bitsAdd64(_a._hi, _b._hi, _c),
		_hi:GoUInt64 = __tmp__._0,
		_c:GoUInt64 = __tmp__._1;
	if (_c != ((0 : GoUInt64))) {
...
function _updateGeneric(_state:Pointer<T_macState>, _msg:Slice<GoByte>):Void {
	var _h0:GoUInt64 = _state.value._h[((0 : GoInt))],
		_h1:GoUInt64 = _state.value._h[((1 : GoInt))],
		_h2:GoUInt64 = _state.value._h[((2 : GoInt))];
	var _r0:GoUInt64 = _state.value._r[((0 : GoInt))],
		_r1:GoUInt64 = _state.value._r[((1 : GoInt))];
	while (_msg.length > ((0 : GoInt))) {
		var _c:GoUInt64 = ((0 : GoUInt64));
		if (_msg.length >= tagSize) {
			{
				var __tmp__ = _bitsAdd64(_h0, stdgo.encoding.binary.Binary.littleEndian.uint64(_msg.__slice__(((0 : GoInt)), ((8 : GoInt)))),
					((0 : GoUInt64)));
				_h0 = __tmp__._0;
				_c = __tmp__._1;
			};
			...
			{
				var __tmp__ = _bitsAdd64(_h0, stdgo.encoding.binary.Binary.littleEndian.uint64(_buf.__slice__(((0 : GoInt)), ((8 : GoInt)))),
					((0 : GoUInt64)));
				_h0 = __tmp__._0;
				_c = __tmp__._1;
			};
		...
		var __tmp__ = _bitsAdd64(_m1._lo, _m0._hi, ((0 : GoUInt64))),
			_t1:GoUInt64 = __tmp__._0,
			_c:GoUInt64 = __tmp__._1;
		var __tmp__ = _bitsAdd64(_m2._lo, _m1._hi, _c),
			_t2:GoUInt64 = __tmp__._0,
			_c:GoUInt64 = __tmp__._1;
		var __tmp__ = _bitsAdd64(_m3._lo, _m2._hi, _c),
			_t3:GoUInt64 = __tmp__._0,
...
function _finalize(_out:Pointer<GoArray<GoByte>>, _h:Pointer<GoArray<GoUInt64>>, _s:Pointer<GoArray<GoUInt64>>):Void {
	var _h0:GoUInt64 = _h.value[((0 : GoInt))],
		_h1:GoUInt64 = _h.value[((1 : GoInt))],
		_h2:GoUInt64 = _h.value[((2 : GoInt))];
	var __tmp__ = _bitsSub64(_h0, _p0, ((0 : GoUInt64))),
		_hMinusP0:GoUInt64 = __tmp__._0,
		_b:GoUInt64 = __tmp__._1;
	var __tmp__ = _bitsSub64(_h1, _p1, _b),
		_hMinusP1:GoUInt64 = __tmp__._0,
		_b:GoUInt64 = __tmp__._1;
	{
	...
	var __tmp__ = _bitsAdd64(_h0, _s.value[((0 : GoInt))], ((0 : GoUInt64))),
		_h0:GoUInt64 = __tmp__._0,
		_c:GoUInt64 = __tmp__._1;
	{
...
class MAC_extension_fields {
	...
	public function verify(__tmp__, _expected:Slice<GoByte>):Bool
		return __tmp__.verify(_expected);
}
...
class T_macGeneric_extension_fields {
	...
	public function sum(__tmp__, _out:Pointer<GoArray<GoByte>>):Void
		__tmp__.sum(_out);
}
