...
@:named class Type {
	public function goString():GoString {
		...
		{
			var __tmp__ = _typeNames.exists(_t) ? {value: _typeNames[_t], ok: true} : {value: _typeNames.defaultValue(), ok: false},
				_n:GoString = __tmp__.value,
				_ok:Bool = __tmp__.ok;
			if (_ok) {
...
@:named class Class_ {
	public function goString():GoString {
		...
		{
			var __tmp__ = _classNames.exists(_c) ? {value: _classNames[_c], ok: true} : {value: _classNames.defaultValue(), ok: false},
				_n:GoString = __tmp__.value,
				_ok:Bool = __tmp__.ok;
			if (_ok) {
				return (("dnsmessage." : GoString)) + _n;
...
@:named class RCode {
	public function goString():GoString {
		...
		{
			var __tmp__ = _rCodeNames.exists(_r) ? {value: _rCodeNames[_r], ok: true} : {value: _rCodeNames.defaultValue(), ok: false},
				_n:GoString = __tmp__.value,
				_ok:Bool = __tmp__.ok;
			if (_ok) {
				return (("dnsmessage." : GoString)) + _n;
...
@:structInit class T_nestedError {
	...
	public function new(?_s:GoString, ?_err:stdgo.Error)
...
@:structInit class Header {
	public function goString():GoString {
		...
		return (("dnsmessage.Header{" : GoString)) + (("ID: " : GoString)) + _printUint16(_m.value.id) + ((", " : GoString)) + (("Response: " : GoString))
			+ _printBool(_m.value.response) + ((", " : GoString)) + (("OpCode: " : GoString)) + _m.value.opCode.goString() + ((", " : GoString))
			+ (("Authoritative: " : GoString)) + _printBool(_m.value.authoritative) + ((", " : GoString)) + (("Truncated: " : GoString))
			+ _printBool(_m.value.truncated) + ((", " : GoString)) + (("RecursionDesired: " : GoString)) + _printBool(_m.value.recursionDesired)
			+ ((", " : GoString)) + (("RecursionAvailable: " : GoString)) + _printBool(_m.value.recursionAvailable) + ((", " : GoString))
			+ (("RCode: " : GoString)) + _m.value.rcode.goString() + (("}" : GoString));
	}
	...
	public function new(?id:GoUInt16, ?response:Bool, ?opCode:OpCode, ?authoritative:Bool, ?truncated:Bool, ?recursionDesired:Bool, ?recursionAvailable:Bool,
			?rcode:RCode)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(id) + " " + Go.string(response) + " " + Go.string(opCode) + " " + Go.string(authoritative) + " " + Go.string(truncated) + " "
			+ Go.string(recursionDesired) + " " + Go.string(recursionAvailable) + " " + Go.string(rcode) + "}";
	}
...
@:structInit class Message {
	public function goString():GoString {
		var _m = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _s:GoString = (("dnsmessage.Message{Header: " : GoString)) + _m.value.header.goString() + ((", " : GoString))
			+ (("Questions: []dnsmessage.Question{" : GoString));
	...
	public function appendPack(_b:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:Error;} {
		...
		var _compression:GoMap<GoString, GoInt> = new GoMap<GoString,
	...
	public function pack():{var _0:Slice<GoByte>; var _1:Error;} {
		var _m = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		return _m.value.appendPack(new Slice<GoUInt8>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))])
			.setCap(((_packStartingCap : GoInt)).toBasic()));
	}
	...
	public function new(?header:Header, ?questions:Slice<Question>, ?answers:Slice<Resource>, ?authorities:Slice<Resource>, ?additionals:Slice<Resource>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_header {
	public function _header():Header {
		...
		return (({
			id: _h.value._id,
			response: (_h.value._bits & _headerBitQR) != ((0 : GoUInt16)),
			opCode: new OpCode(new OpCode((_h.value._bits >> ((11 : GoUnTypedInt)))).__t__ & ((15 : GoUInt16))),
			authoritative: (_h.value._bits & _headerBitAA) != ((0 : GoUInt16)),
			truncated: (_h.value._bits & _headerBitTC) != ((0 : GoUInt16)),
			recursionDesired: (_h.value._bits & _headerBitRD) != ((0 : GoUInt16)),
			recursionAvailable: (_h.value._bits & _headerBitRA) != ((0 : GoUInt16)),
			rcode: new RCode((_h.value._bits & ((15 : GoUInt16))))
		} : Header)).__copy__();
	}
	...
	public function new(?_id:GoUInt16, ?_bits:GoUInt16, ?_questions:GoUInt16, ?_answers:GoUInt16, ?_authorities:GoUInt16, ?_additionals:GoUInt16)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_id) + " " + Go.string(_bits) + " " + Go.string(_questions) + " " + Go.string(_answers) + " " + Go.string(_authorities) + " "
			+ Go.string(_additionals) + "}";
	}
...
@:structInit class Resource {
	public function _pack(_msg:Slice<GoByte>, _compression:GoMap<GoString, GoInt>, _compressionOff:GoInt):{var _0:Slice<GoByte>; var _1:Error;} {
		...
		var __tmp__ = _r.value.header._pack(_msg, _compression, _compressionOff),
			_msg:Slice<GoUInt8> = __tmp__._0,
			_lenOff:GoInt = __tmp__._1,
	...
	public function goString():GoString {
		var _r = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		return (("dnsmessage.Resource{" : GoString)) + (("Header: " : GoString)) + _r.value.header.goString() + ((", Body: &" : GoString))
			+ _r.value.body.goString() + (("}" : GoString));
	}

	public var header:ResourceHeader = new ResourceHeader();
	public var body:ResourceBody = ((null : ResourceBody));

	public function new(?header:ResourceHeader, ?body:ResourceBody)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Parser {
	public function unknownResource():{var _0:UnknownResource; var _1:Error;} {
		...
		var __tmp__ = _unpackUnknownResource(_p.value._resHeader.type, _p.value._msg, _p.value._off, _p.value._resHeader.length),
			_r:UnknownResource = __tmp__._0,
	...
	public function optresource():{var _0:OPTResource; var _1:Error;} {
		...
		var __tmp__ = _unpackOPTResource(_p.value._msg, _p.value._off, _p.value._resHeader.length),
			_r:OPTResource = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
	...
	public function aaaaresource():{var _0:AAAAResource; var _1:Error;} {
		...
		var __tmp__ = _unpackAAAAResource(_p.value._msg, _p.value._off),
			_r:AAAAResource = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
	...
	public function aresource():{var _0:AResource; var _1:Error;} {
		...
		var __tmp__ = _unpackAResource(_p.value._msg, _p.value._off),
			_r:AResource = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
	...
	public function srvresource():{var _0:SRVResource; var _1:Error;} {
		...
		var __tmp__ = _unpackSRVResource(_p.value._msg, _p.value._off),
			_r:SRVResource = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
	...
	public function txtresource():{var _0:TXTResource; var _1:Error;} {
		...
		var __tmp__ = _unpackTXTResource(_p.value._msg, _p.value._off, _p.value._resHeader.length),
			_r:TXTResource = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
	...
	public function soaresource():{var _0:SOAResource; var _1:Error;} {
		...
		var __tmp__ = _unpackSOAResource(_p.value._msg, _p.value._off),
			_r:SOAResource = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
	...
	public function ptrresource():{var _0:PTRResource; var _1:Error;} {
		...
		var __tmp__ = _unpackPTRResource(_p.value._msg, _p.value._off),
			_r:PTRResource = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
	...
	public function nsresource():{var _0:NSResource; var _1:Error;} {
		...
		var __tmp__ = _unpackNSResource(_p.value._msg, _p.value._off),
			_r:NSResource = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
	...
	public function mxresource():{var _0:MXResource; var _1:Error;} {
		...
		var __tmp__ = _unpackMXResource(_p.value._msg, _p.value._off),
			_r:MXResource = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
	...
	public function cnameresource():{var _0:CNAMEResource; var _1:Error;} {
		...
		var __tmp__ = _unpackCNAMEResource(_p.value._msg, _p.value._off),
			_r:CNAMEResource = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
	...
	public function allAdditionals():{var _0:Slice<Resource>; var _1:Error;} {
		...
		while (true) {
			var __tmp__ = _p.value.additional(),
				_a:Resource = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (Go.toInterface(_err) == Go.toInterface(errSectionDone)) {
	...
	public function allAuthorities():{var _0:Slice<Resource>; var _1:Error;} {
		...
		var _as:Slice<Resource> = new Slice<Resource>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) new Resource()]).setCap(((_n : GoInt)).toBasic());
		while (true) {
			var __tmp__ = _p.value.authority(),
				_a:Resource = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (Go.toInterface(_err) == Go.toInterface(errSectionDone)) {
				return {_0: _as, _1: ((null : stdgo.Error))};
	...
	public function skipQuestion():Error {
		...
		var __tmp__ = _skipName(_p.value._msg, _p.value._off),
	...
	public function allQuestions():{var _0:Slice<Question>; var _1:Error;} {
		...
		while (true) {
			var __tmp__ = _p.value.question(),
				_q:Question = __tmp__._0,
				_err:stdgo.Error = __tmp__._1;
			if (Go.toInterface(_err) == Go.toInterface(errSectionDone)) {
	...
	public function question():{var _0:Question; var _1:Error;} {
		...
		var __tmp__ = _unpackClass(_p.value._msg, _off),
			_class:Class_ = __tmp__._0,
			_off:GoInt = __tmp__._1,
			_err:stdgo.Error = __tmp__._2;
		if (_err != null) {
	...
	public function _resourceHeader(_sec:T_section):{var _0:ResourceHeader; var _1:Error;} {
		...
		var __tmp__ = _hdr._unpack(_p.value._msg, _p.value._off),
			_off:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new ResourceHeader().__copy__(), _1: _err};
	...
	public function new(?_msg:Slice<GoUInt8>, ?_header:T_header, ?_section:T_section, ?_off:GoInt, ?_index:GoInt, ?_resHeaderValid:Bool,
			?_resHeader:ResourceHeader)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_msg) + " " + Go.string(_header) + " " + Go.string(_section) + " " + Go.string(_off) + " " + Go.string(_index) + " "
			+ Go.string(_resHeaderValid) + " " + Go.string(_resHeader) + "}";
	}
...
@:structInit class Builder {
	...
	public function unknownResource(_h:ResourceHeader, _r:UnknownResource):Error {
		...
		var __tmp__ = _h._pack(_b.value._msg, _b.value._compression, _b.value._start),
			_msg:Slice<GoUInt8> = __tmp__._0,
			_lenOff:GoInt = __tmp__._1,
			_err:stdgo.Error = __tmp__._2;
		if (_err != null) {
	...
	public function question(_q:Question):Error {
		...
		var __tmp__ = _q._pack(_b.value._msg, _b.value._compression, _b.value._start),
			_msg:Slice<GoUInt8> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return _err;
	...
	public function enableCompression():Void {
		var _b = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		_b.value._compression = new GoMap<GoString,
			GoInt>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
				stdgo.reflect.Reflect.GoType.basic(int_kind))));
	}
	...
	public var _compression:GoMap<GoString, GoInt> = new GoMap<GoString,
		GoInt>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
			stdgo.reflect.Reflect.GoType.basic(int_kind)))).nil();

	public function new(?_msg:Slice<GoUInt8>, ?_section:T_section, ?_header:T_header, ?_start:GoInt, ?_compression:GoMap<GoString, GoInt>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class ResourceHeader {
	...
	public function setEDNS0(_udpPayloadLen:GoInt, _extRCode:RCode, _dnssecOK:Bool):Error {
		var _h = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		_h.value.name = (({data: new GoArray<GoUInt8>(...([((".".code : GoRune))].concat([for (i in 0...254) 0]))).copy(), length: ((1 : GoUInt8))} : Name))
			.__copy__();
	...
	public function _pack(_oldMsg:Slice<GoByte>, _compression:GoMap<GoString, GoInt>,
			_compressionOff:GoInt):{var _0:Slice<GoByte>; var _1:GoInt; var _2:Error;} {
		var _h = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _msg:Slice<GoByte> = new Slice<GoUInt8>().nil(),
			_lenOff:GoInt = ((0 : GoInt)),
	...
	public function goString():GoString {
		var _h = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		return (("dnsmessage.ResourceHeader{" : GoString)) + (("Name: " : GoString)) + _h.value.name.goString() + ((", " : GoString))
			+ (("Type: " : GoString)) + _h.value.type.goString() + ((", " : GoString)) + (("Class: " : GoString)) + _h.value.class_.goString()
			+ ((", " : GoString)) + (("TTL: " : GoString)) + _printUint32(_h.value.ttl) + ((", " : GoString)) + (("Length: " : GoString))
			+ _printUint16(_h.value.length) + (("}" : GoString));
	}
	...
	public function new(?name:Name, ?type:Type, ?class_:Class_, ?ttl:GoUInt32, ?length:GoUInt16)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Name {
	...
	public function _pack(_msg:Slice<GoByte>, _compression:GoMap<GoString, GoInt>, _compressionOff:GoInt):{var _0:Slice<GoByte>; var _1:Error;} {
		...
		};
		{
			...
			Go.cfor(_i < ((_n.value.length : GoInt)), _i++, {
				...
				if ((_i == ((0 : GoInt)) || _n.value.data[_i - ((1 : GoInt))] == ((".".code : GoRune)))
					&& _compression != null
					&& !_compression.isNil()) {
					{
						var __tmp__ = _compression.exists(((_n.value.data.__slice__(_i) : GoString))) ? {value: _compression[((_n.value.data.__slice__(_i) : GoString))],
							ok: true} : {value: _compression.defaultValue(), ok: false},
							_ptr:GoInt = __tmp__.value,
							_ok:Bool = __tmp__.ok;
						if (_ok) {
							return {_0: _msg.__append__(((((_ptr >> ((8 : GoUnTypedInt))) | ((192 : GoInt))) : GoByte)),
								((_ptr : GoByte))), _1: ((null : stdgo.Error))};
						};
					};
	...
	public function new(?data:GoArray<GoUInt8>, ?length:GoUInt8)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Question {
	public function goString():GoString {
		...
		return (("dnsmessage.Question{" : GoString)) + (("Name: " : GoString)) + _q.value.name.goString() + ((", " : GoString)) + (("Type: " : GoString))
			+ _q.value.type.goString() + ((", " : GoString)) + (("Class: " : GoString)) + _q.value.class_.goString() + (("}" : GoString));
	}

	public function _pack(_msg:Slice<GoByte>, _compression:GoMap<GoString, GoInt>, _compressionOff:GoInt):{var _0:Slice<GoByte>; var _1:Error;} {
		var _q = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var __tmp__ = _q.value.name._pack(_msg, _compression, _compressionOff),
			_msg:Slice<GoUInt8> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
	...
	public function new(?name:Name, ?type:Type, ?class_:Class_)
		stdgo.internal.Macro.initLocals();
...
@:structInit class CNAMEResource {
	...
	public function new(?cname:Name)
		stdgo.internal.Macro.initLocals();
...
@:structInit class MXResource {
	public function goString():GoString {
		var _r = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		return (("dnsmessage.MXResource{" : GoString)) + (("Pref: " : GoString)) + _printUint16(_r.value.pref) + ((", " : GoString)) + (("MX: " : GoString))
			+ _r.value.mx.goString() + (("}" : GoString));
	}
	...
	public function _pack(_msg:Slice<GoByte>, _compression:GoMap<GoString, GoInt>, _compressionOff:GoInt):{var _0:Slice<GoByte>; var _1:Error;} {
		...
		var __tmp__ = _r.value.mx._pack(_msg, _compression, _compressionOff),
			_msg:Slice<GoUInt8> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
	...
	public function new(?pref:GoUInt16, ?mx:Name)
		stdgo.internal.Macro.initLocals();
...
@:structInit class SOAResource {
	public function goString():GoString {
		var _r = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		return (("dnsmessage.SOAResource{" : GoString)) + (("NS: " : GoString)) + _r.value.ns.goString() + ((", " : GoString)) + (("MBox: " : GoString))
			+ _r.value.mbox.goString() + ((", " : GoString)) + (("Serial: " : GoString)) + _printUint32(_r.value.serial) + ((", " : GoString))
			+ (("Refresh: " : GoString)) + _printUint32(_r.value.refresh) + ((", " : GoString)) + (("Retry: " : GoString)) + _printUint32(_r.value.retry)
			+ ((", " : GoString)) + (("Expire: " : GoString)) + _printUint32(_r.value.expire) + ((", " : GoString)) + (("MinTTL: " : GoString))
			+ _printUint32(_r.value.minTTL) + (("}" : GoString));
	}

	public function _pack(_msg:Slice<GoByte>, _compression:GoMap<GoString, GoInt>, _compressionOff:GoInt):{var _0:Slice<GoByte>; var _1:Error;} {
		var _r = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		var _oldMsg:Slice<GoUInt8> = _msg;
		var __tmp__ = _r.value.ns._pack(_msg, _compression, _compressionOff),
			_msg:Slice<GoUInt8> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
	...
	public function new(?ns:Name, ?mbox:Name, ?serial:GoUInt32, ?refresh:GoUInt32, ?retry:GoUInt32, ?expire:GoUInt32, ?minTTL:GoUInt32)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(ns) + " " + Go.string(mbox) + " " + Go.string(serial) + " " + Go.string(refresh) + " " + Go.string(retry) + " "
			+ Go.string(expire) + " " + Go.string(minTTL) + "}";
	}
...
@:structInit class TXTResource {
	...
	public function new(?txt:Slice<GoString>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class SRVResource {
	public function goString():GoString {
		var _r = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		return (("dnsmessage.SRVResource{" : GoString)) + (("Priority: " : GoString)) + _printUint16(_r.value.priority) + ((", " : GoString))
			+ (("Weight: " : GoString)) + _printUint16(_r.value.weight) + ((", " : GoString)) + (("Port: " : GoString)) + _printUint16(_r.value.port)
			+ ((", " : GoString)) + (("Target: " : GoString)) + _r.value.target.goString() + (("}" : GoString));
	}
	...
	public function _pack(_msg:Slice<GoByte>, _compression:GoMap<GoString, GoInt>, _compressionOff:GoInt):{var _0:Slice<GoByte>; var _1:Error;} {
		...
		var __tmp__ = _r.value.target._pack(_msg,
			new GoMap<GoString, GoInt>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
				stdgo.reflect.Reflect.GoType.basic(int_kind)))).nil(),
			_compressionOff),
			_msg:Slice<GoUInt8> = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
	...
	public function new(?priority:GoUInt16, ?weight:GoUInt16, ?port:GoUInt16, ?target:Name)
		stdgo.internal.Macro.initLocals();
...
@:structInit class AResource {
	public function goString():GoString {
		var _r = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		return (("dnsmessage.AResource{" : GoString))
			+ (("A: [4]byte{" : GoString))
			+ _printByteSlice(_r.value.a.__slice__(0))
			+ (("}}" : GoString));
	}
	...
	public function new(?a:GoArray<GoUInt8>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class AAAAResource {
	...
	public function new(?aaaa:GoArray<GoUInt8>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class OPTResource {
	...
	public function new(?options:Slice<Option>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class Option {
	public function goString():GoString {
		...
		return (("dnsmessage.Option{" : GoString)) + (("Code: " : GoString)) + _printUint16(_o.value.code) + ((", " : GoString))
			+ (("Data: []byte{" : GoString)) + _printByteSlice(_o.value.data) + (("}}" : GoString));
	}

	public var code:GoUInt16 = ((0 : GoUInt16));
	public var data:Slice<GoUInt8> = new Slice<GoUInt8>().nil();

	public function new(?code:GoUInt16, ?data:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();
...
@:structInit class UnknownResource {
	public function goString():GoString {
		var _r = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
		return (("dnsmessage.UnknownResource{" : GoString)) + (("Type: " : GoString)) + _r.value.type.goString() + ((", " : GoString))
			+ (("Data: []byte{" : GoString)) + _printByteSlice(_r.value.data) + (("}}" : GoString));
	}
	...
	public function new(?type:Type, ?data:Slice<GoUInt8>)
		stdgo.internal.Macro.initLocals();
...
var _typeNames:GoMap<Type, GoString> = new GoMap<Type,
	GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("vendor/golang.org/x/net/dns/dnsmessage.Type",
	...
	{key: typeNS, value: "TypeNS"}, {key: typeCNAME, value: "TypeCNAME"}, {key: typeSOA, value: "TypeSOA"}, {key: typePTR, value: "TypePTR"},
	{key: typeMX, value: "TypeMX"}, {key: typeTXT, value: "TypeTXT"}, {key: typeAAAA, value: "TypeAAAA"}, {key: typeSRV, value: "TypeSRV"},
	{key: typeOPT, value: "TypeOPT"}, {key: typeWKS, value: "TypeWKS"}, {key: typeHINFO, value: "TypeHINFO"}, {key: typeMINFO, value: "TypeMINFO"},
	{key: typeAXFR, value: "TypeAXFR"}, {key: typeALL, value: "TypeALL"});
...
var _classNames:GoMap<Class_, GoString> = new GoMap<Class_,
	GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("vendor/golang.org/x/net/dns/dnsmessage.Class",
		[], stdgo.reflect.Reflect.GoType.basic(uint16_kind)),
	stdgo.reflect.Reflect.GoType.basic(string_kind))),
	{
		key: classINET,
	...
	{key: classCSNET, value: "ClassCSNET"}, {key: classCHAOS, value: "ClassCHAOS"}, {key: classHESIOD, value: "ClassHESIOD"},
	{key: classANY, value: "ClassANY"});
...
var _sectionNames:GoMap<T_section, GoString> = new GoMap<T_section,
	GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("vendor/golang.org/x/net/dns/dnsmessage.section",
		[], stdgo.reflect.Reflect.GoType.basic(uint8_kind)),
	stdgo.reflect.Reflect.GoType.basic(string_kind))),
	{
		key: _sectionHeader,
		value: "header"
	},
	{key: _sectionQuestions, value: "Question"}, {key: _sectionAnswers, value: "Answer"}, {key: _sectionAuthorities, value: "Authority"},
	{key: _sectionAdditionals, value: "Additional"});
...
var _rCodeNames:GoMap<RCode, GoString> = new GoMap<RCode,
	GoString>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.named("vendor/golang.org/x/net/dns/dnsmessage.RCode",
		[], stdgo.reflect.Reflect.GoType.basic(uint16_kind)),
	stdgo.reflect.Reflect.GoType.basic(string_kind))),
	{
		key: rcodeSuccess,
	...
	{key: rcodeFormatError, value: "RCodeFormatError"}, {key: rcodeServerFailure, value: "RCodeServerFailure"},
...
function _printPaddedUint8(_i:GoUInt8):GoString {
	...
	return ((new Slice<GoUInt8>(_b / ((100 : GoUInt8)) + (("0".code : GoRune)), _b / ((10 : GoUInt8)) % ((10 : GoUInt8)) + (("0".code : GoRune)),
		_b % ((10 : GoUInt8)) + (("0".code : GoRune))) : GoString));
}
...
function _printByteSlice(_b:Slice<GoByte>):GoString {
	...
	var _buf:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))])
		.setCap(((((5 : GoInt)) * _b.length : GoInt)).toBasic());
...
function _printString(_str:Slice<GoByte>):GoString {
	var _buf:Slice<GoUInt8> = new Slice<GoUInt8>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) ((0 : GoUInt8))]).setCap(((_str.length : GoInt))
		.toBasic());
	{
...
function _printUint32(_i:GoUInt32):GoString {
	...
	{
		var _b:Slice<GoUInt8> = _buf,
			_d:GoUInt32 = ((((1000000000 : GoUInt32)) : GoUInt32));
...
function newBuilder(_buf:Slice<GoByte>, _h:Header):Builder {
	...
	var _b:Builder = (({
		_msg: _buf,
		_start: _buf.length,
		_section: new T_section(),
		_header: new T_header(),
		_compression: new GoMap<GoString,
			GoInt>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(string_kind),
				stdgo.reflect.Reflect.GoType.basic(int_kind)))).nil()} : Builder)).__copy__();
	{
...
function _skipResource(_msg:Slice<GoByte>, _off:GoInt):{var _0:GoInt; var _1:Error;} {
	var __tmp__ = _skipName(_msg, _off),
		_newOff:GoInt = __tmp__._0,
		_err:stdgo.Error = __tmp__._1;
	if (_err != null) {
		return {_0: _off, _1: Go.pointer(new T_nestedError("Name", _err)).value};
	};
	...
	var __tmp__ = _unpackUint16(_msg, _newOff),
		_length:GoUInt16 = __tmp__._0,
		_newOff:GoInt = __tmp__._1,
		_err:stdgo.Error = __tmp__._2;
	if (_err != null) {
		return {_0: _off, _1: Go.pointer(new T_nestedError("Length", _err)).value};
	};
...
function _unpackUint16(_msg:Slice<GoByte>, _off:GoInt):{var _0:GoUInt16; var _1:GoInt; var _2:Error;} {
	...
	return {_0: (((_msg[_off] : GoUInt16)) << ((8 : GoUnTypedInt))) | ((_msg[_off + ((1 : GoInt))] : GoUInt16)), _1: _off
		+ _uint16Len, _2: ((null : stdgo.Error))};
}
...
function _packUint32(_msg:Slice<GoByte>, _field:GoUInt32):Slice<GoByte> {
	return _msg.__append__((((_field >> ((24 : GoUnTypedInt))) : GoByte)), (((_field >> ((16 : GoUnTypedInt))) : GoByte)),
		(((_field >> ((8 : GoUnTypedInt))) : GoByte)), ((_field : GoByte)));
}
...
function _unpackUint32(_msg:Slice<GoByte>, _off:GoInt):{var _0:GoUInt32; var _1:GoInt; var _2:Error;} {
	...
	var _v:GoUInt32 = (((_msg[_off] : GoUInt32)) << ((24 : GoUnTypedInt))) | (((_msg[_off + ((1 : GoInt))] : GoUInt32)) << ((16 : GoUnTypedInt))) | (((_msg[_off
		+ ((2 : GoInt))] : GoUInt32)) << ((8 : GoUnTypedInt))) | ((_msg[_off + ((3 : GoInt))] : GoUInt32));
...
function _unpackResourceBody(_msg:Slice<GoByte>, _off:GoInt, _hdr:ResourceHeader):{var _0:ResourceBody; var _1:GoInt; var _2:Error;} {
	var _r:ResourceBody = ((null : ResourceBody)),
		_err:Error = ((null : stdgo.Error)),
...
function _unpackCNAMEResource(_msg:Slice<GoByte>, _off:GoInt):{var _0:CNAMEResource; var _1:Error;} {
	...
	{
		var __tmp__ = _cname._unpack(_msg, _off),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new CNAMEResource().__copy__(), _1: _err};
...
function _unpackMXResource(_msg:Slice<GoByte>, _off:GoInt):{var _0:MXResource; var _1:Error;} {
	...
	{
		var __tmp__ = _mx._unpack(_msg, _off),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
...
function _unpackNSResource(_msg:Slice<GoByte>, _off:GoInt):{var _0:NSResource; var _1:Error;} {
	...
	{
		var __tmp__ = _ns._unpack(_msg, _off),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new NSResource().__copy__(), _1: _err};
...
function _unpackPTRResource(_msg:Slice<GoByte>, _off:GoInt):{var _0:PTRResource; var _1:Error;} {
	...
	{
		var __tmp__ = _ptr._unpack(_msg, _off),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new PTRResource().__copy__(), _1: _err};
...
function _unpackSOAResource(_msg:Slice<GoByte>, _off:GoInt):{var _0:SOAResource; var _1:Error;} {
	...
	var __tmp__ = _unpackUint32(_msg, _off),
		_serial:GoUInt32 = __tmp__._0,
		_off:GoInt = __tmp__._1,
		_err:stdgo.Error = __tmp__._2;
	if (_err != null) {
...
function _unpackTXTResource(_msg:Slice<GoByte>, _off:GoInt, _length:GoUInt16):{var _0:TXTResource; var _1:Error;} {
	var _txts:Slice<GoString> = new Slice<GoString>(...[for (i in 0...((((0 : GoInt)) : GoInt)).toBasic()) (("" : GoString))]).setCap(((((1 : GoInt)) : GoInt))
		.toBasic());
	{
...
function _unpackSRVResource(_msg:Slice<GoByte>, _off:GoInt):{var _0:SRVResource; var _1:Error;} {
	...
	{
		var __tmp__ = _target._unpackCompressed(_msg, _off, false),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
...
function _unpackAResource(_msg:Slice<GoByte>, _off:GoInt):{var _0:AResource; var _1:Error;} {
	...
	{
		var __tmp__ = _unpackBytes(_msg, _off, _a.__slice__(0)),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new AResource().__copy__(), _1: _err};
...
function _unpackAAAAResource(_msg:Slice<GoByte>, _off:GoInt):{var _0:AAAAResource; var _1:Error;} {
	...
	{
		var __tmp__ = _unpackBytes(_msg, _off, _aaaa.__slice__(0)),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new AAAAResource().__copy__(), _1: _err};
...
function _unpackUnknownResource(_recordType:Type, _msg:Slice<GoByte>, _off:GoInt, _length:GoUInt16):{var _0:UnknownResource; var _1:Error;} {
	var _parsed:UnknownResource = (({type: _recordType, data: new Slice<GoUInt8>(...[for (i in 0...((_length : GoInt))
		.toBasic()) ((0 : GoUInt8))])} : UnknownResource)).__copy__();
	{
		var __tmp__ = _unpackBytes(_msg, _off, _parsed.data),
			_:GoInt = __tmp__._0,
			_err:stdgo.Error = __tmp__._1;
		if (_err != null) {
			return {_0: new UnknownResource().__copy__(), _1: _err};
...
class Header_extension_fields {
	public function _pack(__tmp__):{var _0:GoUInt16; var _1:GoUInt16;}
		return __tmp__._pack();
...
class Message_extension_fields {
	public function unpack(__tmp__, _msg:Slice<GoByte>):Error
		return __tmp__.unpack(_msg);

	public function pack(__tmp__):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__.pack();

	public function appendPack(__tmp__, _b:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__.appendPack(_b);
...
class T_header_extension_fields {
	public function _count(__tmp__, _sec:T_section):GoUInt16
		return __tmp__._count(_sec);

	public function _pack(__tmp__, _msg:Slice<GoByte>):Slice<GoByte>
		return __tmp__._pack(_msg);

	public function _unpack(__tmp__, _msg:Slice<GoByte>, _off:GoInt):{var _0:GoInt; var _1:Error;}
		return __tmp__._unpack(_msg, _off);

	public function _header(__tmp__):Header
		return __tmp__._header();
}
...
class Resource_extension_fields {
	...
	public function _pack(__tmp__, _msg:Slice<GoByte>, _compression:GoMap<GoString, GoInt>, _compressionOff:GoInt):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__._pack(_msg, _compression, _compressionOff);
}

class Parser_extension_fields {
	public function start(__tmp__, _msg:Slice<GoByte>):{var _0:Header; var _1:Error;}
		return __tmp__.start(_msg);

	public function _checkAdvance(__tmp__, _sec:T_section):Error
		return __tmp__._checkAdvance(_sec);

	public function _resource(__tmp__, _sec:T_section):{var _0:Resource; var _1:Error;}
		return __tmp__._resource(_sec);

	public function _resourceHeader(__tmp__, _sec:T_section):{var _0:ResourceHeader; var _1:Error;}
		return __tmp__._resourceHeader(_sec);

	public function _skipResource(__tmp__, _sec:T_section):Error
		return __tmp__._skipResource(_sec);

	public function question(__tmp__):{var _0:Question; var _1:Error;}
		return __tmp__.question();

	public function allQuestions(__tmp__):{var _0:Slice<Question>; var _1:Error;}
		return __tmp__.allQuestions();

	public function skipQuestion(__tmp__):Error
		return __tmp__.skipQuestion();

	public function skipAllQuestions(__tmp__):Error
		return __tmp__.skipAllQuestions();

	public function answerHeader(__tmp__):{var _0:ResourceHeader; var _1:Error;}
		return __tmp__.answerHeader();

	public function answer(__tmp__):{var _0:Resource; var _1:Error;}
		return __tmp__.answer();

	public function allAnswers(__tmp__):{var _0:Slice<Resource>; var _1:Error;}
		return __tmp__.allAnswers();

	public function skipAnswer(__tmp__):Error
		return __tmp__.skipAnswer();

	public function skipAllAnswers(__tmp__):Error
		return __tmp__.skipAllAnswers();

	public function authorityHeader(__tmp__):{var _0:ResourceHeader; var _1:Error;}
		return __tmp__.authorityHeader();

	public function authority(__tmp__):{var _0:Resource; var _1:Error;}
		return __tmp__.authority();

	public function allAuthorities(__tmp__):{var _0:Slice<Resource>; var _1:Error;}
		return __tmp__.allAuthorities();

	public function skipAuthority(__tmp__):Error
		return __tmp__.skipAuthority();

	public function skipAllAuthorities(__tmp__):Error
		return __tmp__.skipAllAuthorities();

	public function additionalHeader(__tmp__):{var _0:ResourceHeader; var _1:Error;}
		return __tmp__.additionalHeader();

	public function additional(__tmp__):{var _0:Resource; var _1:Error;}
		return __tmp__.additional();

	public function allAdditionals(__tmp__):{var _0:Slice<Resource>; var _1:Error;}
		return __tmp__.allAdditionals();

	public function skipAdditional(__tmp__):Error
		return __tmp__.skipAdditional();

	public function skipAllAdditionals(__tmp__):Error
		return __tmp__.skipAllAdditionals();

	public function cnameresource(__tmp__):{var _0:CNAMEResource; var _1:Error;}
		return __tmp__.cnameresource();

	public function mxresource(__tmp__):{var _0:MXResource; var _1:Error;}
		return __tmp__.mxresource();

	public function nsresource(__tmp__):{var _0:NSResource; var _1:Error;}
		return __tmp__.nsresource();

	public function ptrresource(__tmp__):{var _0:PTRResource; var _1:Error;}
		return __tmp__.ptrresource();

	public function soaresource(__tmp__):{var _0:SOAResource; var _1:Error;}
		return __tmp__.soaresource();

	public function txtresource(__tmp__):{var _0:TXTResource; var _1:Error;}
		return __tmp__.txtresource();

	public function srvresource(__tmp__):{var _0:SRVResource; var _1:Error;}
		return __tmp__.srvresource();

	public function aresource(__tmp__):{var _0:AResource; var _1:Error;}
		return __tmp__.aresource();

	public function aaaaresource(__tmp__):{var _0:AAAAResource; var _1:Error;}
		return __tmp__.aaaaresource();

	public function optresource(__tmp__):{var _0:OPTResource; var _1:Error;}
		return __tmp__.optresource();

	public function unknownResource(__tmp__):{var _0:UnknownResource; var _1:Error;}
		return __tmp__.unknownResource();
}

class Builder_extension_fields {
	public function enableCompression(__tmp__):Void
		__tmp__.enableCompression();

	public function _startCheck(__tmp__, _s:T_section):Error
		return __tmp__._startCheck(_s);

	public function startQuestions(__tmp__):Error
		return __tmp__.startQuestions();

	public function startAnswers(__tmp__):Error
		return __tmp__.startAnswers();

	public function startAuthorities(__tmp__):Error
		return __tmp__.startAuthorities();

	public function startAdditionals(__tmp__):Error
		return __tmp__.startAdditionals();

	public function _incrementSectionCount(__tmp__):Error
		return __tmp__._incrementSectionCount();

	public function question(__tmp__, _q:Question):Error
		return __tmp__.question(_q);

	public function _checkResourceSection(__tmp__):Error
		return __tmp__._checkResourceSection();

	public function cnameresource(__tmp__, _h:ResourceHeader, _r:CNAMEResource):Error
		return __tmp__.cnameresource(_h, _r);

	public function mxresource(__tmp__, _h:ResourceHeader, _r:MXResource):Error
		return __tmp__.mxresource(_h, _r);

	public function nsresource(__tmp__, _h:ResourceHeader, _r:NSResource):Error
		return __tmp__.nsresource(_h, _r);

	public function ptrresource(__tmp__, _h:ResourceHeader, _r:PTRResource):Error
		return __tmp__.ptrresource(_h, _r);

	public function soaresource(__tmp__, _h:ResourceHeader, _r:SOAResource):Error
		return __tmp__.soaresource(_h, _r);

	public function txtresource(__tmp__, _h:ResourceHeader, _r:TXTResource):Error
		return __tmp__.txtresource(_h, _r);

	public function srvresource(__tmp__, _h:ResourceHeader, _r:SRVResource):Error
		return __tmp__.srvresource(_h, _r);

	public function aresource(__tmp__, _h:ResourceHeader, _r:AResource):Error
		return __tmp__.aresource(_h, _r);

	public function aaaaresource(__tmp__, _h:ResourceHeader, _r:AAAAResource):Error
		return __tmp__.aaaaresource(_h, _r);

	public function optresource(__tmp__, _h:ResourceHeader, _r:OPTResource):Error
		return __tmp__.optresource(_h, _r);

	public function unknownResource(__tmp__, _h:ResourceHeader, _r:UnknownResource):Error
		return __tmp__.unknownResource(_h, _r);

	public function finish(__tmp__):{var _0:Slice<GoByte>; var _1:Error;}
		return __tmp__.finish();
}
...
class ResourceHeader_extension_fields {
	...
	public function _pack(__tmp__, _oldMsg:Slice<GoByte>, _compression:GoMap<GoString, GoInt>,
			_compressionOff:GoInt):{var _0:Slice<GoByte>; var _1:GoInt; var _2:Error;}
		return __tmp__._pack(_oldMsg, _compression, _compressionOff);

	public function _unpack(__tmp__, _msg:Slice<GoByte>, _off:GoInt):{var _0:GoInt; var _1:Error;}
		return __tmp__._unpack(_msg, _off);

	public function _fixLen(__tmp__, _msg:Slice<GoByte>, _lenOff:GoInt, _preLen:GoInt):Error
		return __tmp__._fixLen(_msg, _lenOff, _preLen);

	public function setEDNS0(__tmp__, _udpPayloadLen:GoInt, _extRCode:RCode, _dnssecOK:Bool):Error
		return __tmp__.setEDNS0(_udpPayloadLen, _extRCode, _dnssecOK);

	public function dnssecallowed(__tmp__):Bool
		return __tmp__.dnssecallowed();

	public function extendedRCode(__tmp__, _rcode:RCode):RCode
		return __tmp__.extendedRCode(_rcode);
}
...
class Name_extension_fields {
	...
	public function _unpackCompressed(__tmp__, _msg:Slice<GoByte>, _off:GoInt, _allowCompression:Bool):{var _0:GoInt; var _1:Error;}
		return __tmp__._unpackCompressed(_msg, _off, _allowCompression);
}
...
class CNAMEResource_extension_fields {
	public function _realType(__tmp__):Type
		return __tmp__._realType();
