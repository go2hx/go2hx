...
@:structInit class T_ruleTransition {
	...
	public function new(?_next:T_ruleState, ?_mask:GoUInt16)
...
@:structInit class Transformer {
	public function _isFinal():Bool {
		...
		return _t.value._state.__t__ == _ruleLTRFinal.__t__
			|| _t.value._state.__t__ == _ruleRTLFinal.__t__
			|| _t.value._state.__t__ == _ruleInitial.__t__;
	}
	...
	public function span(_src:Slice<GoByte>, _atEOF:Bool):{var _0:GoInt; var _1:Error;} {
		...
		var __tmp__ = _t.value._advance(_src),
			_n:GoInt = __tmp__._0,
			_ok:Bool = __tmp__._1;
		{
	...
	public function transform(_dst:Slice<GoByte>, _src:Slice<GoByte>, _atEOF:Bool):{var _0:GoInt; var _1:GoInt; var _2:Error;} {
		...
		var __tmp__ = _t.value.span(_src, _atEOF),
			_n:GoInt = __tmp__._0,
	...
	public function new(?_state:T_ruleState, ?_hasRTL:Bool, ?_seen:GoUInt16)
		stdgo.internal.Macro.initLocals();
...
var _transitions:GoArray<GoArray<T_ruleTransition>> = {
	var s = new GoArray<GoArray<T_ruleTransition>>(...[
		for (i in 0...6) new GoArray<T_ruleTransition>(...[for (i in 0...2) new T_ruleTransition()])
	]);
	s[0] = new GoArray<T_ruleTransition>(new T_ruleTransition(_ruleLTRFinal, (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.l.__t__)).__copy__(),
		new T_ruleTransition(_ruleRTLFinal,
			(((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.r.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.al.__t__))
			.__copy__());
	s[1] = new GoArray<T_ruleTransition>(new T_ruleTransition(_ruleRTLFinal,
		(((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.r.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.al.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.en.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.an.__t__))
		.__copy__(),
		new T_ruleTransition(_ruleRTL,
			(((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.es.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.cs.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.et.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.on.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.bn.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.nsm.__t__))
			.__copy__());
	s[2] = new GoArray<T_ruleTransition>(new T_ruleTransition(_ruleRTLFinal,
		(((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.r.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.al.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.en.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.an.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.nsm.__t__))
		.__copy__(),
		new T_ruleTransition(_ruleRTL,
			(((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.es.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.cs.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.et.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.on.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.bn.__t__))
			.__copy__());
	s[3] = new GoArray<T_ruleTransition>(new T_ruleTransition(_ruleLTRFinal,
		(((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.l.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.en.__t__))
		.__copy__(),
		new T_ruleTransition(_ruleLTR,
			(((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.es.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.cs.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.et.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.on.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.bn.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.nsm.__t__))
			.__copy__());
	s[4] = new GoArray<T_ruleTransition>(new T_ruleTransition(_ruleLTRFinal,
		(((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.l.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.en.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.nsm.__t__))
		.__copy__(),
		new T_ruleTransition(_ruleLTR,
			(((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.es.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.cs.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.et.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.on.__t__) | (((1 : GoUnTypedInt)) << golang_org.x.text.unicode.bidi.Bidi.bn.__t__))
			.__copy__());
	s[5] = new GoArray<T_ruleTransition>(new T_ruleTransition(_ruleInvalid, ((0 : GoUInt16))).__copy__(),
		new T_ruleTransition(_ruleInvalid, ((0 : GoUInt16))).__copy__());
	s;
};
...
function direction(_b:Slice<GoByte>):golang_org.x.text.unicode.bidi.Bidi.Direction {
	{
		...
		while (_i < _b.length) {
			var __tmp__ = golang_org.x.text.unicode.bidi.Bidi.lookup(_b.__slice__(_i)),
				_e:vendor.golang_org.x.text.unicode.bidi.Bidi.Properties = __tmp__._0,
				_sz:GoInt = __tmp__._1;
			if (_sz == ((0 : GoInt))) {
				_i++;
			};
			var _c:vendor.golang_org.x.text.unicode.bidi.Bidi.Class_ = _e.class_();
			if (_c.__t__ == golang_org.x.text.unicode.bidi.Bidi.r.__t__
				|| _c.__t__ == golang_org.x.text.unicode.bidi.Bidi.al.__t__
				|| _c.__t__ == golang_org.x.text.unicode.bidi.Bidi.an.__t__) {
...
function directionString(_s:GoString):golang_org.x.text.unicode.bidi.Bidi.Direction {
	{
		var _i:GoInt = ((0 : GoInt));
		while (_i < _s.length) {
			var __tmp__ = golang_org.x.text.unicode.bidi.Bidi.lookupString(_s.__slice__(_i)),
				_e:vendor.golang_org.x.text.unicode.bidi.Bidi.Properties = __tmp__._0,
				_sz:GoInt = __tmp__._1;
			if (_sz == ((0 : GoInt))) {
				_i++;
...
function validString(_s:GoString):Bool {
	var _t:Transformer = new Transformer();
	{
		var __tmp__ = _t._advanceString(_s),
			_n:GoInt = __tmp__._0,
			_ok:Bool = __tmp__._1;
		if (!_ok || _n < _s.length) {
			return false;
	...
	try {
		{
			...
			for (_obj in _asciiTable.keyValueIterator()) {
				_i = _obj.key;
				var __tmp__ = golang_org.x.text.unicode.bidi.Bidi.lookupRune(((_i : GoRune))),
					_p:vendor.golang_org.x.text.unicode.bidi.Bidi.Properties = __tmp__._0, _:GoInt = __tmp__._1;
...
class Transformer_extension_fields {
	public function _isRTL(__tmp__):Bool
		return __tmp__._isRTL();

	public function reset(__tmp__):Void
		__tmp__.reset();

	public function transform(__tmp__, _dst:Slice<GoByte>, _src:Slice<GoByte>, _atEOF:Bool):{var _0:GoInt; var _1:GoInt; var _2:Error;}
		return __tmp__.transform(_dst, _src, _atEOF);

	public function span(__tmp__, _src:Slice<GoByte>, _atEOF:Bool):{var _0:GoInt; var _1:Error;}
		return __tmp__.span(_src, _atEOF);

	public function _advance(__tmp__, _s:Slice<GoByte>):{var _0:GoInt; var _1:Bool;}
		return __tmp__._advance(_s);

	public function _advanceString(__tmp__, _s:GoString):{var _0:GoInt; var _1:Bool;}
		return __tmp__._advanceString(_s);

	public function _isFinal(__tmp__):Bool
		return __tmp__._isFinal();
}
