...
@:structInit class Reader {
	public function read(_p:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
		...
		var _n:GoInt = ((0 : GoInt)),
			_err:stdgo.Error = ((((null : stdgo.Error)) : Error));
		while (true) {
			...
			if (_r.value._src0 != _r.value._src1 || _r.value._err != null) {
				...
				{
					var __tmp__ = _r.value._t.transform(_r.value._dst, _r.value._src.__slice__(_r.value._src0, _r.value._src1),
						Go.toInterface(_r.value._err) == Go.toInterface(stdgo.io.Io.eof));
				...
				if (_err == null) {
					...
					continue;
				} else if (Go.toInterface(_err) == Go.toInterface(errShortDst)
					&& (_r.value._dst1 != ((0 : GoInt)) || _n != ((0 : GoInt)))) {
					continue;
				} else if (Go.toInterface(_err) == Go.toInterface(errShortSrc)
					&& _r.value._src1 - _r.value._src0 != _r.value._src.length
					&& _r.value._err == null) {} else {
	...
	public function new(?_r:stdgo.io.Io.Reader, ?_t:Transformer, ?_err:stdgo.Error, ?_dst:Slice<GoUInt8>, ?_dst0:GoInt, ?_dst1:GoInt, ?_src:Slice<GoUInt8>,
			?_src0:GoInt, ?_src1:GoInt, ?_transformComplete:Bool)
		stdgo.internal.Macro.initLocals();

	public function toString() {
		return '{' + Go.string(_r) + " " + Go.string(_t) + " " + Go.string(_err) + " " + Go.string(_dst) + " " + Go.string(_dst0) + " " + Go.string(_dst1)
			+ " " + Go.string(_src) + " " + Go.string(_src0) + " " + Go.string(_src1) + " " + Go.string(_transformComplete) + "}";
	}
...
@:structInit class Writer {
	public function close():Error {
		...
		while (true) {
			var __tmp__ = _w.value._t.transform(_w.value._dst, _src, true),
				_nDst:GoInt = __tmp__._0,
				_nSrc:GoInt = __tmp__._1,
				_err:stdgo.Error = __tmp__._2;
			{
				var __tmp__ = _w.value._w.write(_w.value._dst.__slice__(0, _nDst)),
					_:GoInt = __tmp__._0,
	...
	public function write(_data:Slice<GoByte>):{var _0:GoInt; var _1:Error;} {
		...
		while (true) {
			var __tmp__ = _w.value._t.transform(_w.value._dst, _src, false),
				_nDst:GoInt = __tmp__._0,
				_nSrc:GoInt = __tmp__._1,
				_err:stdgo.Error = __tmp__._2;
			{
	...
	public function new(?_w:stdgo.io.Io.Writer, ?_t:Transformer, ?_dst:Slice<GoUInt8>, ?_src:Slice<GoUInt8>, ?_n:GoInt)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_nop {
	...
	public function new(?nopResetter:NopResetter)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_chain {
	public function transform(_dst:Slice<GoByte>, _src:Slice<GoByte>, _atEOF:Bool):{var _0:GoInt; var _1:GoInt; var _2:Error;} {
		...
		{
			var _low:GoInt = _c.value._errStart,
				_i:GoInt = _c.value._errStart,
				_high:GoInt = _c.value._link.length - ((2 : GoInt));
			while (_low <= _i && _i <= _high) {
				var _in:Pointer<T_link> = Go.pointer(_c.value._link[_i]),
					_out:Pointer<T_link> = Go.pointer(_c.value._link[_i + ((1 : GoInt))]);
				var __tmp__ = _in.value._t.transform(_out.value._dst(), _in.value._src(), _atEOF && _low == _i),
					_nDst:GoInt = __tmp__._0,
					_nSrc:GoInt = __tmp__._1,
					_err0:stdgo.Error = __tmp__._2;
				...
				};
				{
					...
					while (true) {
						if (__switchIndex__ == 0 || (__switchIndex__ == -1 && Go.toInterface(_err0) == Go.toInterface(errShortDst))) {
							...
							|| (__switchIndex__ == -1 && Go.toInterface(_err0) == Go.toInterface(errShortSrc))) {
							if (_i == ((0 : GoInt))) {
								_err = errShortSrc;
								break;
							};
	...
	public function new(?_link:Slice<T_link>, ?_err:stdgo.Error, ?_errStart:GoInt)
		stdgo.internal.Macro.initLocals();
...
@:structInit class T_link {
	...
	public function new(?_t:Transformer, ?_b:Slice<GoUInt8>, ?_p:GoInt, ?_n:GoInt)
		stdgo.internal.Macro.initLocals();
...
function newReader(_r:stdgo.io.Io.Reader, _t:Transformer):Pointer<Reader> {
	...
	return Go.pointer((({
		_r: _r,
		_t: _t,
		_dst: new Slice<GoUInt8>(...[for (i in 0...((_defaultBufSize : GoInt)).toBasic()) ((0 : GoUInt8))]),
		_src: new Slice<GoUInt8>(...[for (i in 0...((_defaultBufSize : GoInt)).toBasic()) ((0 : GoUInt8))]),
		_err: ((null : stdgo.Error)),
		_dst0: 0,
		_dst1: 0,
		_src0: 0,
...
function chain(_t:haxe.Rest<Transformer>):Transformer {
	...
	var _c:Pointer<T_chain> = Go.pointer((({_link: new Slice<T_link>(...[for (i in 0...((_t.length + ((1 : GoInt)):GoInt)).toBasic()) new T_link()]),
		_err: ((null : stdgo.Error)), _errStart: 0} : T_chain)));
	{
		var _i;
		var _tt;
	...
	var _b:Slice<GoArray<GoUInt8>> = new Slice<GoArray<GoUInt8>>(...[
		for (i in 0...((_t.length - ((1 : GoInt)):GoInt)).toBasic()) new GoArray<GoUInt8>(...[for (i in 0...4096) ((0 : GoUInt8))])
	]);
	{
		var _i;
...
function toString(_t:Transformer, _s:GoString):{var _0:GoString; var _1:GoInt; var _2:Error;} {
	...
	if (_s == (("" : GoString))) {
		{
			var __tmp__ = _t.transform(new Slice<GoUInt8>().nil(), new Slice<GoUInt8>().nil(), true),
				_:GoInt = __tmp__._0,
				_:GoInt = __tmp__._1,
				_err:stdgo.Error = __tmp__._2;
			if (_err == null) {
	...
	if ((_err == null && _pSrc == _s.length)
		|| (_err != null && Go.toInterface(_err) != Go.toInterface(errShortDst) && Go.toInterface(_err) != Go.toInterface(errShortSrc))) {
		return {_0: ((_dst.__slice__(0, _pDst) : GoString)), _1: _pSrc, _2: _err};
	};
	while (true) {
		var _n:GoInt = Go.copy(_src, _s.__slice__(_pSrc));
		var _atEOF:Bool = _pSrc + _n == _s.length;
		var __tmp__ = _t.transform(_dst.__slice__(_pDst), _src.__slice__(0, _n), _atEOF),
			_nDst:GoInt = __tmp__._0,
			_nSrc:GoInt = __tmp__._1,
			_err:stdgo.Error = __tmp__._2;
		_pDst = _pDst + (_nDst);
...
function bytes(_t:Transformer, _b:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:GoInt; var _2:Error;} {
	var _result:Slice<GoByte> = new Slice<GoUInt8>().nil(),
		_n:GoInt = ((0 : GoInt)),
		_err:Error = ((null : stdgo.Error));
...
function _doAppend(_t:Transformer, _pDst:GoInt, _dst:Slice<GoByte>, _src:Slice<GoByte>):{var _0:Slice<GoByte>; var _1:GoInt; var _2:Error;} {
	...
	while (true) {
		var __tmp__ = _t.transform(_dst.__slice__(_pDst), _src.__slice__(_pSrc), true),
			_nDst:GoInt = __tmp__._0,
			_nSrc:GoInt = __tmp__._1,
			_err:stdgo.Error = __tmp__._2;
		_pDst = _pDst + (_nDst);
...
class T_chain_extension_fields {
	public function _fatalError(__tmp__, _errIndex:GoInt, _err:Error):Void
		__tmp__._fatalError(_errIndex, _err);
...
class T_link_extension_fields {
	public function _src(__tmp__):Slice<GoByte>
		return __tmp__._src();

	public function _dst(__tmp__):Slice<GoByte>
		return __tmp__._dst();
}
