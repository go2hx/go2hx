...
@:named class Direction {
    ...
    public function __copy__() return new Direction(__t__);
}
@:structInit class T_options {
    public var _defaultDirection : Direction = new Direction();
    public function new(?_defaultDirection:Direction) stdgo.internal.Macro.initLocals();
...
@:structInit class Paragraph {
    public function line(_start:GoInt, _end:GoInt):{ var _0 : Ordering; var _1 : Error; } {
        ...
        var __tmp__ = _newParagraph(_lineTypes, _p.value._pairTypes.__slice__(_start, _end), _p.value._pairValues.__slice__(_start, _end), new T_level(-((1 : GoUnTypedInt)))), _para:Pointer<T_paragraph> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
    ...
    public function order():{ var _0 : Ordering; var _1 : Error; } {
        ...
        var __tmp__ = _newParagraph(_p.value._types, _p.value._pairTypes, _p.value._pairValues, _lvl), _para:Pointer<T_paragraph> = __tmp__._0, _err:stdgo.Error = __tmp__._1;
        if (_err != null) {
            return { _0 : new Ordering().__copy__(), _1 : _err };
        };
    ...
    public function _prepareInput():{ var _0 : GoInt; var _1 : Error; } {
        ...
        for (_r in _p.value._runes) {
            var __tmp__ = lookupRune(_r), _props:Properties = __tmp__._0, _i:GoInt = __tmp__._1;
    ...
    public function new(?_p:Slice<GoUInt8>, ?_o:Ordering, ?_opts:Slice<Option>, ?_types:Slice<Class_>, ?_pairTypes:Slice<T_bracketType>, ?_pairValues:Slice<GoInt32>, ?_runes:Slice<GoInt32>, ?_options:T_options) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_p) + " " + Go.string(_o) + " " + Go.string(_opts) + " " + Go.string(_types) + " " + Go.string(_pairTypes) + " " + Go.string(_pairValues) + " " + Go.string(_runes) + " " + Go.string(_options) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class Ordering {
    ...
    public function new(?_runes:Slice<Slice<GoInt32>>, ?_directions:Slice<Direction>, ?_startpos:Slice<GoInt>) stdgo.internal.Macro.initLocals();
    public function toString() {
...
@:structInit class Run {
    ...
    public function new(?_runes:Slice<GoInt32>, ?_direction:Direction, ?_startpos:GoInt) stdgo.internal.Macro.initLocals();
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:named class T_bracketType {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new T_bracketType(__t__);
}
@:structInit class T_bracketPair {
    ...
    public function new(?_opener:GoInt, ?_closer:GoInt) stdgo.internal.Macro.initLocals();
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:named class T_bracketPairs {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new T_bracketPairs(__t__);
    public function __append__(args:haxe.Rest<T_bracketPair>) return new T_bracketPairs(this.__t__.__append__(...args));
    public function __slice__(low:GoInt, high:GoInt = -1) return new T_bracketPairs(this.__t__.__slice__(low, high));
}
@:structInit class T_bracketPairer {
    ...
    public function _getStrongTypeN0(_index:GoInt):Class_ {
        var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        if (_p.value._codesIsolatedRun[_index].__t__ == en.__t__ || _p.value._codesIsolatedRun[_index].__t__ == an.__t__ || _p.value._codesIsolatedRun[_index].__t__ == al.__t__ || _p.value._codesIsolatedRun[_index].__t__ == r.__t__) {
            return r;
    ...
    public function new(?_sos:Class_, ?_openers:Pointer<stdgo.container.list.List.List_>, ?_pairPositions:T_bracketPairs, ?_codesIsolatedRun:Slice<Class_>, ?_indexes:Slice<GoInt>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_sos) + " " + Go.string(_openers) + " " + Go.string(_pairPositions) + " " + Go.string(_codesIsolatedRun) + " " + Go.string(_indexes) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:named class T_level {
    ...
    @:implicit
    public function toString():GoString return Go.string(__t__);
    public function __copy__() return new T_level(__t__);
}
@:structInit class T_paragraph {
    ...
    public function _isolatingRunSequence(_indexes:Slice<GoInt>):Pointer<T_isolatingRunSequence> {
        ...
        return Go.pointer((({ _p : _p, _indexes : _indexes, _types : _types, _level : _level, _sos : _typeForLevel(_maxLevel(_prevLevel, _level)), _eos : _typeForLevel(_maxLevel(_succLevel, _level)), _resolvedLevels : new Slice<T_level>().nil() } : T_isolatingRunSequence)));
    }
    public function _determineExplicitEmbeddingLevels():Void {
        var _p = new Pointer(() -> this, __tmp__ -> this.__set__(__tmp__));
        var _stack:T_directionalStatusStack = new T_directionalStatusStack();
        var _overflowIsolateCount:GoInt = ((0 : GoInt)), _overflowEmbeddingCount:GoInt = ((0 : GoInt)), _validIsolateCount:GoInt = ((0 : GoInt));
        _stack._push(_p.value._embeddingLevel, on, false);
        {
            ...
            for (_obj in _p.value._resultTypes.keyValueIterator()) {
                _i = _obj.key;
                _t = _obj.value;
                if (_t.__t__ == rle.__t__ || _t.__t__ == lre.__t__ || _t.__t__ == rlo.__t__ || _t.__t__ == lro.__t__ || _t.__t__ == rli.__t__ || _t.__t__ == lri.__t__ || _t.__t__ == fsi.__t__) {
                    ...
                    if (_isRTL) {
                        ...
                        _newLevel = new T_level((new T_level((new T_level(_stack._lastEmbeddingLevel().__t__ + ((2 : GoInt8)))).__t__ & ((1 : GoInt8)))).__t__ ^ ((-1 : GoUnTypedInt)));
                    };
                    if (_newLevel.__t__ <= _maxDepth && _overflowIsolateCount == ((0 : GoInt)) && _overflowEmbeddingCount == ((0 : GoInt))) {
                        if (_isIsolate) {
                            _validIsolateCount++;
                        };
    ...
    public function new(?_initialTypes:Slice<Class_>, ?_pairTypes:Slice<T_bracketType>, ?_pairValues:Slice<GoInt32>, ?_embeddingLevel:T_level, ?_resultTypes:Slice<Class_>, ?_resultLevels:Slice<T_level>, ?_matchingPDI:Slice<GoInt>, ?_matchingIsolateInitiator:Slice<GoInt>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_initialTypes) + " " + Go.string(_pairTypes) + " " + Go.string(_pairValues) + " " + Go.string(_embeddingLevel) + " " + Go.string(_resultTypes) + " " + Go.string(_resultLevels) + " " + Go.string(_matchingPDI) + " " + Go.string(_matchingIsolateInitiator) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class T_directionalStatusStack {
    ...
    public function new(?_stackCounter:GoInt, ?_embeddingLevelStack:GoArray<T_level>, ?_overrideStatusStack:GoArray<Class_>, ?_isolateStatusStack:GoArray<Bool>) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_stackCounter) + " " + Go.string(_embeddingLevelStack) + " " + Go.string(_overrideStatusStack) + " " + Go.string(_isolateStatusStack) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
        ...
        stdgo.internal.Macro.controlFlow({
            ...
            @:label("loop") {
                ...
                for (_obj in _s.value._types.keyValueIterator()) {
                    ...
                    stdgo.log.Log.panicf("invalid bidi code %v present in assertOnly at position %d", Go.toInterface(_t), Go.toInterface(_s.value._indexes[_i]));
                };
            };
        });
    }
...
pdi);
        {
            ...
            for (_obj in _s.value._types.keyValueIterator()) {
                _i = _obj.key;
                _t = _obj.value;
                if (_t.__t__ == ws.__t__ || _t.__t__ == on.__t__ || _t.__t__ == b.__t__ || _t.__t__ == s.__t__ || _t.__t__ == rli.__t__ || _t.__t__ == lri.__t__ || _t.__t__ == fsi.__t__ || _t.__t__ == pdi.__t__) {
                    var _runStart:GoInt = _i;
                    var _runEnd:GoInt = _s.value._findRunLimit(_runStart, b, s, ws, on, rli, lri, fsi, pdi);
                    var _leadType:Class_ = new Class_(), _trailType:Class_ = new Class_();
...
pdi);
    ...
    public function new(?_p:Pointer<T_paragraph>, ?_indexes:Slice<GoInt>, ?_types:Slice<Class_>, ?_resolvedLevels:Slice<T_level>, ?_level:T_level, ?_sos:Class_, ?_eos:Class_) stdgo.internal.Macro.initLocals();
    public function toString() {
        return '{' + Go.string(_p) + " " + Go.string(_indexes) + " " + Go.string(_types) + " " + Go.string(_resolvedLevels) + " " + Go.string(_level) + " " + Go.string(_sos) + " " + Go.string(_eos) + "}";
    }
    public function __underlying__():AnyInterface return Go.toInterface(this);
    public function __copy__() {
...
@:structInit class Properties {
    ...
    public function new(?_entry:GoUInt8, ?_last:GoUInt8) stdgo.internal.Macro.initLocals();
    public function toString() {
...
var _controlToClass : GoMap<GoInt32, Class_> = new GoMap<GoInt32, Class_>(new stdgo.reflect.Reflect._Type(stdgo.reflect.Reflect.GoType.mapType(stdgo.reflect.Reflect.GoType.basic(int32_kind), stdgo.reflect.Reflect.GoType.named("vendor/golang.org/x/text/unicode/bidi.Class", [], stdgo.reflect.Reflect.GoType.basic(uint_kind)))), { key : ((8237 : GoInt32)), value : lro }, { key : ((8238 : GoInt32)), value : rlo }, { key : ((8234 : GoInt32)), value : lre }, { key : ((8235 : GoInt32)), value : rle }, { key : ((8236 : GoInt32)), value : pdf }, { key : ((8294 : GoInt32)), value : lri }, { key : ((8295 : GoInt32)), value : rli }, { key : ((8296 : GoInt32)), value : fsi }, { key : ((8297 : GoInt32)), value : pdi });
...
var _xorMasks : Slice<GoInt32> = new Slice<GoInt32>(((0 : GoInt32)), ((1 : GoInt32)), ((6 : GoInt32)), ((7 : GoInt32)), ((3 : GoInt32)), ((15 : GoInt32)), ((29 : GoInt32)), ((63 : GoInt32)));
...
function appendReverse(_out:Slice<GoByte>, _in:Slice<GoByte>):Slice<GoByte> {
        ...
        var _inRunes:Slice<GoInt32> = stdgo.bytes.Bytes.runes(_in);
        {
            ...
            for (_obj in _inRunes.keyValueIterator()) {
                _i = _obj.key;
                _r = _obj.value;
                var __tmp__ = lookupRune(_r), _prop:Properties = __tmp__._0, _:GoInt = __tmp__._1;
                if (_prop.isBracket()) {
        ...
        {
            var _i:GoInt = ((0 : GoInt)), _j:GoInt = _inRunes.length - ((1 : GoInt));
            Go.cfor(_i < _j, {
...
function _resolvePairedBrackets(_s:Pointer<T_isolatingRunSequence>):Void {
        var _p:T_bracketPairer = (({ _sos : _s.value._sos, _openers : stdgo.container.list.List_.new_(), _codesIsolatedRun : _s.value._types, _indexes : _s.value._indexes, _pairPositions : new T_bracketPairs() } : T_bracketPairer)).__copy__();
...
**/
function _newParagraph(_types:Slice<Class_>, _pairTypes:Slice<T_bracketType>, _pairValues:Slice<GoRune>, _levels:T_level):{ var _0 : Pointer<T_paragraph>; var _1 : Error; } {
        ...
        var _p:Pointer<T_paragraph> = Go.pointer((({ _initialTypes : ((new Slice<Class_>().nil() : Slice<Class_>)).__append__(..._types.toArray()), _embeddingLevel : _levels, _pairTypes : _pairTypes, _pairValues : _pairValues, _resultTypes : ((new Slice<Class_>().nil() : Slice<Class_>)).__append__(..._types.toArray()), _resultLevels : new Slice<T_level>().nil(), _matchingPDI : new Slice<GoInt>().nil(), _matchingIsolateInitiator : new Slice<GoInt>().nil() } : T_paragraph)));
        _p.value._run();
            ...
            Go.cfor(_level.__t__ >= _lowestOddLevel.__t__, _level.__t__--, {
                {
                    ...
                    Go.cfor(_i < _levels.length, _i++, {
                        if (_levels[_i].__t__ >= _level.__t__) {
                            ...
                            {
                                var _j:GoInt = _start, _k:GoInt = _limit - ((1 : GoInt));
                                Go.cfor(_j < _k, {
...
function _isWhitespace(_c:Class_):Bool {
        if (_c.__t__ == lre.__t__ || _c.__t__ == rle.__t__ || _c.__t__ == lro.__t__ || _c.__t__ == rlo.__t__ || _c.__t__ == pdf.__t__ || _c.__t__ == lri.__t__ || _c.__t__ == rli.__t__ || _c.__t__ == fsi.__t__ || _c.__t__ == pdi.__t__ || _c.__t__ == bn.__t__ || _c.__t__ == ws.__t__) {
            return true;
        };
        return false;
    }
...
function _validateParagraphEmbeddingLevel(_embeddingLevel:T_level):Error {
        if (_embeddingLevel.__t__ != _implicitLevel.__t__ && _embeddingLevel.__t__ != ((0 : GoInt8)) && _embeddingLevel.__t__ != ((1 : GoInt8))) {
...
class Paragraph_extension_fields {
    public function _prepareInput(__tmp__):{ var _0 : GoInt; var _1 : Error; } return __tmp__._prepareInput();
    public function setBytes(__tmp__, _b:Slice<GoByte>, _opts:haxe.Rest<Option>):{ var _0 : GoInt; var _1 : Error; } return __tmp__.setBytes(_b, _opts);
    public function setString(__tmp__, _s:GoString, _opts:haxe.Rest<Option>):{ var _0 : GoInt; var _1 : Error; } return __tmp__.setString(_s, _opts);
    public function isLeftToRight(__tmp__):Bool return __tmp__.isLeftToRight();
    public function direction(__tmp__):Direction return __tmp__.direction();
    public function runAt(__tmp__, _pos:GoInt):Run return __tmp__.runAt(_pos);
    public function order(__tmp__):{ var _0 : Ordering; var _1 : Error; } return __tmp__.order();
    public function line(__tmp__, _start:GoInt, _end:GoInt):{ var _0 : Ordering; var _1 : Error; } return __tmp__.line(_start, _end);
}
class Ordering_extension_fields {
    public function direction(__tmp__):Direction return __tmp__.direction();
    public function numRuns(__tmp__):GoInt return __tmp__.numRuns();
    public function run(__tmp__, _i:GoInt):Run return __tmp__.run(_i);
}
class Run_extension_fields {
    ...
    public function direction(__tmp__):Direction return __tmp__.direction();
    public function pos(__tmp__):{ var _0 : GoInt; var _1 : GoInt; } return __tmp__.pos();
}
...
class T_bracketPairer_extension_fields {
    public function _matchOpener(__tmp__, _pairValues:Slice<GoRune>, _opener:GoInt, _closer:GoInt):Bool return __tmp__._matchOpener(_pairValues, _opener, _closer);
    public function _locateBrackets(__tmp__, _pairTypes:Slice<T_bracketType>, _pairValues:Slice<GoRune>):Void __tmp__._locateBrackets(_pairTypes, _pairValues);
    public function _getStrongTypeN0(__tmp__, _index:GoInt):Class_ return __tmp__._getStrongTypeN0(_index);
    public function _classifyPairContent(__tmp__, _loc:T_bracketPair, _dirEmbed:Class_):Class_ return __tmp__._classifyPairContent(_loc, _dirEmbed);
    public function _classBeforePair(__tmp__, _loc:T_bracketPair):Class_ return __tmp__._classBeforePair(_loc);
    public function _assignBracketType(__tmp__, _loc:T_bracketPair, _dirEmbed:Class_, _initialTypes:Slice<Class_>):Void __tmp__._assignBracketType(_loc, _dirEmbed, _initialTypes);
    public function _setBracketsToType(__tmp__, _loc:T_bracketPair, _dirPair:Class_, _initialTypes:Slice<Class_>):Void __tmp__._setBracketsToType(_loc, _dirPair, _initialTypes);
    public function _resolveBrackets(__tmp__, _dirEmbed:Class_, _initialTypes:Slice<Class_>):Void __tmp__._resolveBrackets(_dirEmbed, _initialTypes);
}
class T_paragraph_extension_fields {
    public function len(__tmp__):GoInt return __tmp__.len();
    public function _run(__tmp__):Void __tmp__._run();
    public function _determineMatchingIsolates(__tmp__):Void __tmp__._determineMatchingIsolates();
    public function _determineParagraphEmbeddingLevel(__tmp__, _start:GoInt, _end:GoInt):T_level return __tmp__._determineParagraphEmbeddingLevel(_start, _end);
    public function _determineExplicitEmbeddingLevels(__tmp__):Void __tmp__._determineExplicitEmbeddingLevels();
    public function _isolatingRunSequence(__tmp__, _indexes:Slice<GoInt>):Pointer<T_isolatingRunSequence> return __tmp__._isolatingRunSequence(_indexes);
    public function _determineLevelRuns(__tmp__):Slice<Slice<GoInt>> return __tmp__._determineLevelRuns();
    public function _determineIsolatingRunSequences(__tmp__):Slice<Pointer<T_isolatingRunSequence>> return __tmp__._determineIsolatingRunSequences();
    public function _assignLevelsToCharactersRemovedByX9(__tmp__):Void __tmp__._assignLevelsToCharactersRemovedByX9();
    public function _getLevels(__tmp__, _linebreaks:Slice<GoInt>):Slice<T_level> return __tmp__._getLevels(_linebreaks);
    public function _getReordering(__tmp__, _linebreaks:Slice<GoInt>):Slice<GoInt> return __tmp__._getReordering(_linebreaks);
}
class T_directionalStatusStack_extension_fields {
    public function _empty(__tmp__):Void __tmp__._empty();
    public function _pop(__tmp__):Void __tmp__._pop();
    public function _depth(__tmp__):GoInt return __tmp__._depth();
    public function _push(__tmp__, _level:T_level, _overrideStatus:Class_, _isolateStatus:Bool):Void __tmp__._push(_level, _overrideStatus, _isolateStatus);
    public function _lastEmbeddingLevel(__tmp__):T_level return __tmp__._lastEmbeddingLevel();
    public function _lastDirectionalOverrideStatus(__tmp__):Class_ return __tmp__._lastDirectionalOverrideStatus();
    public function _lastDirectionalIsolateStatus(__tmp__):Bool return __tmp__._lastDirectionalIsolateStatus();
}
class T_isolatingRunSequence_extension_fields {
    public function len(__tmp__):GoInt return __tmp__.len();
    public function _resolveWeakTypes(__tmp__):Void __tmp__._resolveWeakTypes();
    public function _resolveNeutralTypes(__tmp__):Void __tmp__._resolveNeutralTypes();
    public function _resolveImplicitLevels(__tmp__):Void __tmp__._resolveImplicitLevels();
    public function _applyLevelsAndTypes(__tmp__):Void __tmp__._applyLevelsAndTypes();
    public function _findRunLimit(__tmp__, _index:GoInt, _validSet:haxe.Rest<Class_>):GoInt return __tmp__._findRunLimit(_index, _validSet);
    public function _assertOnly(__tmp__, _codes:haxe.Rest<Class_>):Void __tmp__._assertOnly(_codes);
}
class Properties_extension_fields {
    public function class_(__tmp__):Class_ return __tmp__.class_();
    public function isBracket(__tmp__):Bool return __tmp__.isBracket();
    public function isOpeningBracket(__tmp__):Bool return __tmp__.isOpeningBracket();
    public function _reverseBracket(__tmp__, _r:GoRune):GoRune return __tmp__._reverseBracket(_r);
}
class T_bidiTrie_extension_fields {
    public function _lookup(__tmp__, _s:Slice<GoByte>):{ var _0 : GoUInt8; var _1 : GoInt; } return __tmp__._lookup(_s);
    public function _lookupUnsafe(__tmp__, _s:Slice<GoByte>):GoUInt8 return __tmp__._lookupUnsafe(_s);
    public function _lookupString(__tmp__, _s:GoString):{ var _0 : GoUInt8; var _1 : GoInt; } return __tmp__._lookupString(_s);
    public function _lookupStringUnsafe(__tmp__, _s:GoString):GoUInt8 return __tmp__._lookupStringUnsafe(_s);
    public function _lookupValue(__tmp__, _n:GoUInt32, _b:GoByte):GoUInt8 return __tmp__._lookupValue(_n, _b);
}
class Class__extension_fields {
    public function _in(__tmp__, _set:haxe.Rest<Class_>):Bool return __tmp__._in(_set);
}
