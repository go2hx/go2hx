...
class ProfileGen {
    ...
    function main() {
        ...
        run(outFile,file,debug,mintime,keepLines);
    }

	public static function run(outFile:String,file:String=null,debug:Bool=false,mintime:Float=0.0,keepLines:Bool=false) {
